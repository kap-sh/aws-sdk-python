...
from aws_sdk_dsql._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
...
class DSQLClient:
    ...
    def __init__(self, http_handler: BaseHandler | None = None, operation_interceptors: Iterable[Interceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, use_fips: bool | None = None, endpoint: str | None = None, region: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = DSQLClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "use_fips": use_fips, "endpoint": endpoint, "region": region, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[DSQLClientConfig] = None) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
    ...
    def list_tags_for_resource(self, resource_arn: "aws_sdk_dsql.types.arn.Arn", *, config_overrides: Optional[DSQLClientConfig] = None) -> "aws_sdk_dsql.types.list_tags_for_resource_output.ListTagsForResourceOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_dsql.types.list_tags_for_resource_input.ListTagsForResourceInput]') -> OperationResponse["aws_sdk_dsql.types.list_tags_for_resource_output.ListTagsForResourceOutput"]:
            import aws_sdk_dsql._operations.dsql.list_tags_for_resource
            output, http_response = aws_sdk_dsql._operations.dsql.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
    ...
    def tag_resource(self, resource_arn: "aws_sdk_dsql.types.arn.Arn", tags: "aws_sdk_dsql.types.tag_map.TagMap", *, config_overrides: Optional[DSQLClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_dsql.types.tag_resource_input.TagResourceInput]') -> OperationResponse[None]:
            import aws_sdk_dsql._operations.dsql.tag_resource
            output, http_response = aws_sdk_dsql._operations.dsql.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, resource_arn: "aws_sdk_dsql.types.arn.Arn", tag_keys: "aws_sdk_dsql.types.tag_key_list.TagKeyList", *, config_overrides: Optional[DSQLClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_dsql.types.untag_resource_input.UntagResourceInput]') -> OperationResponse[None]:
            import aws_sdk_dsql._operations.dsql.untag_resource
            output, http_response = aws_sdk_dsql._operations.dsql.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
