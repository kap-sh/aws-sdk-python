...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_dsql.types.delete_cluster_output.DeleteClusterOutput:
    import aws_sdk_dsql.types.delete_cluster_output
    out: aws_sdk_dsql.types.delete_cluster_output.DeleteClusterOutput = aws_sdk_dsql.types.delete_cluster_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_dsql.types.delete_cluster_input.DeleteClusterInput) -> zapros.Request:
...
def delete_cluster(options: OperationOptions, input: aws_sdk_dsql.types.delete_cluster_input.DeleteClusterInput) -> tuple[aws_sdk_dsql.types.delete_cluster_output.DeleteClusterOutput, zapros.Response]:
...
async def async_delete_cluster(options: AsyncOperationOptions, input: aws_sdk_dsql.types.delete_cluster_input.DeleteClusterInput) -> tuple[aws_sdk_dsql.types.delete_cluster_output.DeleteClusterOutput, zapros.Response]:
