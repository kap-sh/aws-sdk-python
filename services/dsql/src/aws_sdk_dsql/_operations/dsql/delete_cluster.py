...
def handle_response(
    ...
    out: aws_sdk_dsql.types.delete_cluster_output.DeleteClusterOutput = (
        aws_sdk_dsql.types.delete_cluster_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_dsql.types.delete_cluster_input.DeleteClusterInput,
) -> zapros.Request:
...
def delete_cluster(
    ...
    aws_sdk_dsql.types.delete_cluster_output.DeleteClusterOutput, zapros.Response
]:
