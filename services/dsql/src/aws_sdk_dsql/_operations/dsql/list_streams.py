...
def handle_response(
    ...
    out: aws_sdk_dsql.types.list_streams_output.ListStreamsOutput = (
        aws_sdk_dsql.types.list_streams_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dsql.types.list_streams_input.ListStreamsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    params["max-results"] = str(input_.get("max_results", 10))
...
def list_streams(
    ...
    input_: aws_sdk_dsql.types.list_streams_input.ListStreamsInput,
) -> tuple[aws_sdk_dsql.types.list_streams_output.ListStreamsOutput, zapros.Response]:
