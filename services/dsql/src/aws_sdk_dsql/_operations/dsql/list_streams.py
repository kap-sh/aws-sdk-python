...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_dsql.types.list_streams_output.ListStreamsOutput:
    import aws_sdk_dsql.types.list_streams_output
    out: aws_sdk_dsql.types.list_streams_output.ListStreamsOutput = aws_sdk_dsql.types.list_streams_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_dsql.types.list_streams_input.ListStreamsInput) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    params["max-results"] = str(input.get("max_results", 10))
...
def list_streams(options: OperationOptions, input: aws_sdk_dsql.types.list_streams_input.ListStreamsInput) -> tuple[aws_sdk_dsql.types.list_streams_output.ListStreamsOutput, zapros.Response]:
...
async def async_list_streams(options: AsyncOperationOptions, input: aws_sdk_dsql.types.list_streams_input.ListStreamsInput) -> tuple[aws_sdk_dsql.types.list_streams_output.ListStreamsOutput, zapros.Response]:
