...
def handle_response(
    ...
    out: aws_sdk_dsql.types.get_cluster_output.GetClusterOutput = (
        aws_sdk_dsql.types.get_cluster_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dsql.types.get_cluster_input.GetClusterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_cluster(
    ...
    input_: aws_sdk_dsql.types.get_cluster_input.GetClusterInput,
) -> tuple[aws_sdk_dsql.types.get_cluster_output.GetClusterOutput, zapros.Response]:
