"""Generated from Smithy shape ``com.amazonaws.dsql#GetCluster``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_dsql.types.get_cluster_output.GetClusterOutput:
    import aws_sdk_dsql.types.get_cluster_output
    out: aws_sdk_dsql.types.get_cluster_output.GetClusterOutput = aws_sdk_dsql.types.get_cluster_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_dsql.types.get_cluster_input.GetClusterInput) -> zapros.Request:
...
def get_cluster(options: OperationOptions, input: aws_sdk_dsql.types.get_cluster_input.GetClusterInput) -> tuple[aws_sdk_dsql.types.get_cluster_output.GetClusterOutput, zapros.Response]:
...
async def async_get_cluster(options: AsyncOperationOptions, input: aws_sdk_dsql.types.get_cluster_input.GetClusterInput) -> tuple[aws_sdk_dsql.types.get_cluster_output.GetClusterOutput, zapros.Response]:
