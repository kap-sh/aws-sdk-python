...
def handle_response(
    ...
    out: aws_sdk_dsql.types.get_cluster_policy_output.GetClusterPolicyOutput = (
        aws_sdk_dsql.types.get_cluster_policy_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dsql.types.get_cluster_policy_input.GetClusterPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_cluster_policy(
    ...
    aws_sdk_dsql.types.get_cluster_policy_output.GetClusterPolicyOutput, zapros.Response
]:
