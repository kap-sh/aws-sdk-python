...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_dsql.types.get_cluster_policy_output.GetClusterPolicyOutput:
    import aws_sdk_dsql.types.get_cluster_policy_output
    out: aws_sdk_dsql.types.get_cluster_policy_output.GetClusterPolicyOutput = aws_sdk_dsql.types.get_cluster_policy_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_dsql.types.get_cluster_policy_input.GetClusterPolicyInput) -> zapros.Request:
...
def get_cluster_policy(options: OperationOptions, input: aws_sdk_dsql.types.get_cluster_policy_input.GetClusterPolicyInput) -> tuple[aws_sdk_dsql.types.get_cluster_policy_output.GetClusterPolicyOutput, zapros.Response]:
...
async def async_get_cluster_policy(options: AsyncOperationOptions, input: aws_sdk_dsql.types.get_cluster_policy_input.GetClusterPolicyInput) -> tuple[aws_sdk_dsql.types.get_cluster_policy_output.GetClusterPolicyOutput, zapros.Response]:
