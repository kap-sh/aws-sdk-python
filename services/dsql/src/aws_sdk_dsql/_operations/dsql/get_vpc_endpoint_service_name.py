"""Generated from Smithy shape ``com.amazonaws.dsql#GetVpcEndpointServiceName``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_dsql.types.get_vpc_endpoint_service_name_output.GetVpcEndpointServiceNameOutput:
    import aws_sdk_dsql.types.get_vpc_endpoint_service_name_output
    out: aws_sdk_dsql.types.get_vpc_endpoint_service_name_output.GetVpcEndpointServiceNameOutput = aws_sdk_dsql.types.get_vpc_endpoint_service_name_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_dsql.types.get_vpc_endpoint_service_name_input.GetVpcEndpointServiceNameInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/clusters/{identifier}/vpc-endpoint-service-name"
...
def get_vpc_endpoint_service_name(options: OperationOptions, input: aws_sdk_dsql.types.get_vpc_endpoint_service_name_input.GetVpcEndpointServiceNameInput) -> tuple[aws_sdk_dsql.types.get_vpc_endpoint_service_name_output.GetVpcEndpointServiceNameOutput, zapros.Response]:
...
async def async_get_vpc_endpoint_service_name(options: AsyncOperationOptions, input: aws_sdk_dsql.types.get_vpc_endpoint_service_name_input.GetVpcEndpointServiceNameInput) -> tuple[aws_sdk_dsql.types.get_vpc_endpoint_service_name_output.GetVpcEndpointServiceNameOutput, zapros.Response]:
