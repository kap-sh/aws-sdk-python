...
def handle_response(
    ...
    out: aws_sdk_dsql.types.get_vpc_endpoint_service_name_output.GetVpcEndpointServiceNameOutput = aws_sdk_dsql.types.get_vpc_endpoint_service_name_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dsql.types.get_vpc_endpoint_service_name_input.GetVpcEndpointServiceNameInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_vpc_endpoint_service_name(
