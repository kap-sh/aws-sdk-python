...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_dsql.types.create_stream_output.CreateStreamOutput:
    import aws_sdk_dsql.types.create_stream_output
    out: aws_sdk_dsql.types.create_stream_output.CreateStreamOutput = aws_sdk_dsql.types.create_stream_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_dsql.types.create_stream_input.CreateStreamInput) -> zapros.Request:
    ...
    url = url.replace("{clusterIdentifier}", quote(str(input["cluster_identifier"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_dsql.types.create_stream_input
    body: bytes | None = json.dumps(aws_sdk_dsql.types.create_stream_input.serialize_json(input)).encode()
...
def create_stream(options: OperationOptions, input: aws_sdk_dsql.types.create_stream_input.CreateStreamInput) -> tuple[aws_sdk_dsql.types.create_stream_output.CreateStreamOutput, zapros.Response]:
...
async def async_create_stream(options: AsyncOperationOptions, input: aws_sdk_dsql.types.create_stream_input.CreateStreamInput) -> tuple[aws_sdk_dsql.types.create_stream_output.CreateStreamOutput, zapros.Response]:
