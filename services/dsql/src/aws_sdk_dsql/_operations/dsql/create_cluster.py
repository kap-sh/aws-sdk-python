...
def handle_response(
    ...
    out: aws_sdk_dsql.types.create_cluster_output.CreateClusterOutput = (
        aws_sdk_dsql.types.create_cluster_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dsql.types.create_cluster_input.CreateClusterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dsql.types.create_cluster_input.serialize_json(input_)
    ).encode()
...
def create_cluster(
    ...
    aws_sdk_dsql.types.create_cluster_output.CreateClusterOutput, zapros.Response
]:
