"""Generated from Smithy shape ``com.amazonaws.dsql#CreateCluster``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            ...
            raise aws_sdk_dsql.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(data)
        case _:
            raise UnknownServiceError(code=code, message=message, response=response)

def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_dsql.types.create_cluster_output.CreateClusterOutput:
    import aws_sdk_dsql.types.create_cluster_output
    out: aws_sdk_dsql.types.create_cluster_output.CreateClusterOutput = aws_sdk_dsql.types.create_cluster_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_dsql.types.create_cluster_input.CreateClusterInput) -> zapros.Request:
    ...
    import aws_sdk_dsql.types.create_cluster_input
    body: bytes | None = json.dumps(aws_sdk_dsql.types.create_cluster_input.serialize_json(input)).encode()
...
def create_cluster(options: OperationOptions, input: aws_sdk_dsql.types.create_cluster_input.CreateClusterInput) -> tuple[aws_sdk_dsql.types.create_cluster_output.CreateClusterOutput, zapros.Response]:
...
async def async_create_cluster(options: AsyncOperationOptions, input: aws_sdk_dsql.types.create_cluster_input.CreateClusterInput) -> tuple[aws_sdk_dsql.types.create_cluster_output.CreateClusterOutput, zapros.Response]:
