...
def handle_response(
    ...
    out: aws_sdk_dsql.types.put_cluster_policy_output.PutClusterPolicyOutput = (
        aws_sdk_dsql.types.put_cluster_policy_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dsql.types.put_cluster_policy_input.PutClusterPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dsql.types.put_cluster_policy_input.serialize_json(input_)
    ).encode()
...
def put_cluster_policy(
    ...
    aws_sdk_dsql.types.put_cluster_policy_output.PutClusterPolicyOutput, zapros.Response
]:
...
async def async_put_cluster_policy(
