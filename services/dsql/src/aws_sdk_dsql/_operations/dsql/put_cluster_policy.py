"""Generated from Smithy shape ``com.amazonaws.dsql#PutClusterPolicy``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_dsql.types.put_cluster_policy_output.PutClusterPolicyOutput:
    import aws_sdk_dsql.types.put_cluster_policy_output
    out: aws_sdk_dsql.types.put_cluster_policy_output.PutClusterPolicyOutput = aws_sdk_dsql.types.put_cluster_policy_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_dsql.types.put_cluster_policy_input.PutClusterPolicyInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/cluster/{identifier}/policy"
    url = url.replace("{identifier}", quote(str(input["identifier"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_dsql.types.put_cluster_policy_input
    body: bytes | None = json.dumps(aws_sdk_dsql.types.put_cluster_policy_input.serialize_json(input)).encode()
...
def put_cluster_policy(options: OperationOptions, input: aws_sdk_dsql.types.put_cluster_policy_input.PutClusterPolicyInput) -> tuple[aws_sdk_dsql.types.put_cluster_policy_output.PutClusterPolicyOutput, zapros.Response]:
...
async def async_put_cluster_policy(options: AsyncOperationOptions, input: aws_sdk_dsql.types.put_cluster_policy_input.PutClusterPolicyInput) -> tuple[aws_sdk_dsql.types.put_cluster_policy_output.PutClusterPolicyOutput, zapros.Response]:
