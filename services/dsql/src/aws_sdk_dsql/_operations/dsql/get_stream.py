...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_dsql.types.get_stream_output.GetStreamOutput:
    import aws_sdk_dsql.types.get_stream_output
    out: aws_sdk_dsql.types.get_stream_output.GetStreamOutput = aws_sdk_dsql.types.get_stream_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_dsql.types.get_stream_input.GetStreamInput) -> zapros.Request:
...
def get_stream(options: OperationOptions, input: aws_sdk_dsql.types.get_stream_input.GetStreamInput) -> tuple[aws_sdk_dsql.types.get_stream_output.GetStreamOutput, zapros.Response]:
...
async def async_get_stream(options: AsyncOperationOptions, input: aws_sdk_dsql.types.get_stream_input.GetStreamInput) -> tuple[aws_sdk_dsql.types.get_stream_output.GetStreamOutput, zapros.Response]:
