...
def handle_response(
    ...
    out: aws_sdk_dsql.types.update_cluster_output.UpdateClusterOutput = (
        aws_sdk_dsql.types.update_cluster_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_dsql.types.update_cluster_input.UpdateClusterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dsql.types.update_cluster_input.serialize_json(input_)
    ).encode()
...
def update_cluster(
    ...
    aws_sdk_dsql.types.update_cluster_output.UpdateClusterOutput, zapros.Response
]:
