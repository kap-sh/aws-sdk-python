"""Generated from Smithy shape ``com.amazonaws.dsql#UpdateCluster``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_dsql.types.update_cluster_output.UpdateClusterOutput:
    import aws_sdk_dsql.types.update_cluster_output
    out: aws_sdk_dsql.types.update_cluster_output.UpdateClusterOutput = aws_sdk_dsql.types.update_cluster_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_dsql.types.update_cluster_input.UpdateClusterInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/cluster/{identifier}"
    url = url.replace("{identifier}", quote(str(input["identifier"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_dsql.types.update_cluster_input
    body: bytes | None = json.dumps(aws_sdk_dsql.types.update_cluster_input.serialize_json(input)).encode()
...
def update_cluster(options: OperationOptions, input: aws_sdk_dsql.types.update_cluster_input.UpdateClusterInput) -> tuple[aws_sdk_dsql.types.update_cluster_output.UpdateClusterOutput, zapros.Response]:
...
async def async_update_cluster(options: AsyncOperationOptions, input: aws_sdk_dsql.types.update_cluster_input.UpdateClusterInput) -> tuple[aws_sdk_dsql.types.update_cluster_output.UpdateClusterOutput, zapros.Response]:
