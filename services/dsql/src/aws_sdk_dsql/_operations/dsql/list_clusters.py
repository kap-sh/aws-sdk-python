...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_dsql.types.list_clusters_output.ListClustersOutput:
    import aws_sdk_dsql.types.list_clusters_output
    out: aws_sdk_dsql.types.list_clusters_output.ListClustersOutput = aws_sdk_dsql.types.list_clusters_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_dsql.types.list_clusters_input.ListClustersInput) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    params["max-results"] = str(input.get("max_results", 20))
...
def list_clusters(options: OperationOptions, input: aws_sdk_dsql.types.list_clusters_input.ListClustersInput) -> tuple[aws_sdk_dsql.types.list_clusters_output.ListClustersOutput, zapros.Response]:
...
async def async_list_clusters(options: AsyncOperationOptions, input: aws_sdk_dsql.types.list_clusters_input.ListClustersInput) -> tuple[aws_sdk_dsql.types.list_clusters_output.ListClustersOutput, zapros.Response]:
