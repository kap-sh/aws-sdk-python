...
def handle_response(
    ...
    out: aws_sdk_dsql.types.list_clusters_output.ListClustersOutput = (
        aws_sdk_dsql.types.list_clusters_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_dsql.types.list_clusters_input.ListClustersInput,
) -> zapros.Request:
...
def list_clusters(
    ...
    input: aws_sdk_dsql.types.list_clusters_input.ListClustersInput,
) -> tuple[aws_sdk_dsql.types.list_clusters_output.ListClustersOutput, zapros.Response]:
