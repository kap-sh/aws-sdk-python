...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_dsql.types.tag_resource_input.TagResourceInput) -> zapros.Request:
    ...
    import aws_sdk_dsql.types.tag_resource_input
    body: bytes | None = json.dumps(aws_sdk_dsql.types.tag_resource_input.serialize_json(input)).encode()
...
def tag_resource(options: OperationOptions, input: aws_sdk_dsql.types.tag_resource_input.TagResourceInput) -> tuple[None, zapros.Response]:
...
async def async_tag_resource(options: AsyncOperationOptions, input: aws_sdk_dsql.types.tag_resource_input.TagResourceInput) -> tuple[None, zapros.Response]:
