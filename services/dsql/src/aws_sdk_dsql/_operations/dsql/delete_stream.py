...
def handle_response(
    ...
    out: aws_sdk_dsql.types.delete_stream_output.DeleteStreamOutput = (
        aws_sdk_dsql.types.delete_stream_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_dsql.types.delete_stream_input.DeleteStreamInput,
) -> zapros.Request:
...
def delete_stream(
    ...
    input: aws_sdk_dsql.types.delete_stream_input.DeleteStreamInput,
) -> tuple[aws_sdk_dsql.types.delete_stream_output.DeleteStreamOutput, zapros.Response]:
