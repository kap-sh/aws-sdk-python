...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_dsql.types.delete_stream_output.DeleteStreamOutput:
    import aws_sdk_dsql.types.delete_stream_output
    out: aws_sdk_dsql.types.delete_stream_output.DeleteStreamOutput = aws_sdk_dsql.types.delete_stream_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_dsql.types.delete_stream_input.DeleteStreamInput) -> zapros.Request:
    ...
    url = url.replace("{streamIdentifier}", quote(str(input["stream_identifier"]), safe=""))
    params: dict[str, str] = {}
    if "client_token" in input:
        params["client-token"] = str(input["client_token"])
...
def delete_stream(options: OperationOptions, input: aws_sdk_dsql.types.delete_stream_input.DeleteStreamInput) -> tuple[aws_sdk_dsql.types.delete_stream_output.DeleteStreamOutput, zapros.Response]:
...
async def async_delete_stream(options: AsyncOperationOptions, input: aws_sdk_dsql.types.delete_stream_input.DeleteStreamInput) -> tuple[aws_sdk_dsql.types.delete_stream_output.DeleteStreamOutput, zapros.Response]:
