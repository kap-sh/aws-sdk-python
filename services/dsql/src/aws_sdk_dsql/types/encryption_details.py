...
def serialize_json(value: EncryptionDetails) -> dict:
    out: dict = {}
    import aws_sdk_dsql.types.encryption_type
    out["encryptionType"] = aws_sdk_dsql.types.encryption_type.serialize_json(value["encryption_type"])
    if "kms_key_arn" in value:
        out["kmsKeyArn"] = value["kms_key_arn"]
    import aws_sdk_dsql.types.encryption_status
    out["encryptionStatus"] = aws_sdk_dsql.types.encryption_status.serialize_json(value["encryption_status"])
    return out
...
def deserialize_json(data: dict) -> EncryptionDetails:
    ...
    if "encryptionType" in data:
        import aws_sdk_dsql.types.encryption_type
        out["encryption_type"] = aws_sdk_dsql.types.encryption_type.deserialize_json(data["encryptionType"])
    else:
    ...
    if "encryptionStatus" in data:
        import aws_sdk_dsql.types.encryption_status
        out["encryption_status"] = aws_sdk_dsql.types.encryption_status.deserialize_json(data["encryptionStatus"])
    else:
