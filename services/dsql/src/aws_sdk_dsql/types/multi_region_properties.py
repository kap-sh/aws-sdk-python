...
def serialize_json(value: MultiRegionProperties) -> dict:
    ...
    if "clusters" in value:
        import aws_sdk_dsql.types.cluster_arn_list
        out["clusters"] = aws_sdk_dsql.types.cluster_arn_list.serialize_json(value["clusters"])
    return out
...
def deserialize_json(data: dict) -> MultiRegionProperties:
    ...
    if "clusters" in data:
        import aws_sdk_dsql.types.cluster_arn_list
        out["clusters"] = aws_sdk_dsql.types.cluster_arn_list.deserialize_json(data["clusters"])
    return out