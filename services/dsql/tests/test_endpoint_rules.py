...
from aws_sdk_dsql._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_3_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://dsql-fips.us-east-1.api.aws'
...
def test_4_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://dsql.us-east-1.api.aws'
...
def test_5_for_region_cn_northwest_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://dsql-fips.cn-northwest-1.api.amazonwebservices.com.cn'
...
def test_6_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://dsql.cn-northwest-1.api.amazonwebservices.com.cn'
...
def test_7_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://dsql-fips.us-gov-west-1.api.aws'
...
def test_8_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://dsql.us-gov-west-1.api.aws'
