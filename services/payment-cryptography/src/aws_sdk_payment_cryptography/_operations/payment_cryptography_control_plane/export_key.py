...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.export_key_output.ExportKeyOutput = (
        aws_sdk_payment_cryptography.types.export_key_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.export_key_input.ExportKeyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.export_key_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
