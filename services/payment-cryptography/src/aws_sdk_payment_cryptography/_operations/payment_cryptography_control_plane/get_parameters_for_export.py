...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.get_parameters_for_export_output.GetParametersForExportOutput = aws_sdk_payment_cryptography.types.get_parameters_for_export_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.get_parameters_for_export_input.GetParametersForExportInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.get_parameters_for_export_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
