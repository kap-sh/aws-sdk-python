"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#UntagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.untag_resource_input.UntagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.UntagResource"
    import aws_sdk_payment_cryptography.types.untag_resource_input

    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.untag_resource_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
