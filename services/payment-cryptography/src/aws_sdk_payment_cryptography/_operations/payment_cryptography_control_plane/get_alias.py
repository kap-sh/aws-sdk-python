"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#GetAlias``."""
...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.get_alias_output.GetAliasOutput = (
        aws_sdk_payment_cryptography.types.get_alias_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_payment_cryptography.types.get_alias_input.GetAliasInput,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.GetAlias"
    import aws_sdk_payment_cryptography.types.get_alias_input

    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.get_alias_input.serialize_aws_json_1_0(input)
    ).encode()
...
def get_alias(
    ...
    aws_sdk_payment_cryptography.types.get_alias_output.GetAliasOutput, zapros.Response
]:
