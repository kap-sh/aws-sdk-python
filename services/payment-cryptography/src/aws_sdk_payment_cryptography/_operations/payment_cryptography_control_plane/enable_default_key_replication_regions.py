"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#EnableDefaultKeyReplicationRegions``."""
...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.enable_default_key_replication_regions_output.EnableDefaultKeyReplicationRegionsOutput = aws_sdk_payment_cryptography.types.enable_default_key_replication_regions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.enable_default_key_replication_regions_input.EnableDefaultKeyReplicationRegionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_enable_default_key_replication_regions(
