"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#GetParametersForImport``."""
...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.get_parameters_for_import_output.GetParametersForImportOutput = aws_sdk_payment_cryptography.types.get_parameters_for_import_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.get_parameters_for_import_input.GetParametersForImportInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.GetParametersForImport"
    import aws_sdk_payment_cryptography.types.get_parameters_for_import_input

    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.get_parameters_for_import_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
