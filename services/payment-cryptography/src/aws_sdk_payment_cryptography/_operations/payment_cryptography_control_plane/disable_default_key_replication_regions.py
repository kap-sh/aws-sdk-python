"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#DisableDefaultKeyReplicationRegions``."""
...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.disable_default_key_replication_regions_output.DisableDefaultKeyReplicationRegionsOutput = aws_sdk_payment_cryptography.types.disable_default_key_replication_regions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.disable_default_key_replication_regions_input.DisableDefaultKeyReplicationRegionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.disable_default_key_replication_regions_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_disable_default_key_replication_regions(
