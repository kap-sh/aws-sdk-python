...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.delete_alias_output.DeleteAliasOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.delete_alias_input.DeleteAliasInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.delete_alias_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
