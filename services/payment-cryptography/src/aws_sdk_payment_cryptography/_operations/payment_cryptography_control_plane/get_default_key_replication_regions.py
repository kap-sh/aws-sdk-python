...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.get_default_key_replication_regions_output.GetDefaultKeyReplicationRegionsOutput = aws_sdk_payment_cryptography.types.get_default_key_replication_regions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.get_default_key_replication_regions_input.GetDefaultKeyReplicationRegionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
