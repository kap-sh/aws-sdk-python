"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#PutResourcePolicy``."""
...
import aws_sdk_payment_cryptography.errors.conflict_exception
import aws_sdk_payment_cryptography.errors.internal_server_exception
import aws_sdk_payment_cryptography.errors.public_policy_exception
import aws_sdk_payment_cryptography.errors.resource_not_found_exception
import aws_sdk_payment_cryptography.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_payment_cryptography.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
        ...
        case "PublicPolicyException":
            raise aws_sdk_payment_cryptography.errors.public_policy_exception.PublicPolicyException.from_aws_json_1_0(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_payment_cryptography.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.put_resource_policy_output.PutResourcePolicyOutput = aws_sdk_payment_cryptography.types.put_resource_policy_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.put_resource_policy_input.PutResourcePolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.PutResourcePolicy"
    import aws_sdk_payment_cryptography.types.put_resource_policy_input

    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.put_resource_policy_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
