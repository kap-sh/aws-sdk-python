"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#ListKeys``."""
...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.list_keys_output.ListKeysOutput = (
        aws_sdk_payment_cryptography.types.list_keys_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_payment_cryptography.types.list_keys_input.ListKeysInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.list_keys_input.serialize_aws_json_1_0(input)
    ).encode()
...
def list_keys(
    ...
    aws_sdk_payment_cryptography.types.list_keys_output.ListKeysOutput, zapros.Response
]:
