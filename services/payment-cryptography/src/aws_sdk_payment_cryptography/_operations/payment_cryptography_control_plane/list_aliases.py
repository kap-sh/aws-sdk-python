"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#ListAliases``."""
...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.list_aliases_output.ListAliasesOutput = (
        aws_sdk_payment_cryptography.types.list_aliases_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.list_aliases_input.ListAliasesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.ListAliases"
    import aws_sdk_payment_cryptography.types.list_aliases_input

    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.list_aliases_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
