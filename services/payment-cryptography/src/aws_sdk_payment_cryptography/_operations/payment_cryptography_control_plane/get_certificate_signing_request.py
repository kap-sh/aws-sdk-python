...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.get_certificate_signing_request_output.GetCertificateSigningRequestOutput = aws_sdk_payment_cryptography.types.get_certificate_signing_request_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.get_certificate_signing_request_input.GetCertificateSigningRequestInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
