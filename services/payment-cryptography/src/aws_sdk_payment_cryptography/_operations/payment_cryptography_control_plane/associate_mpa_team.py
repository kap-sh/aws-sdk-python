"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#AssociateMpaTeam``."""
...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.associate_mpa_team_output.AssociateMpaTeamOutput = aws_sdk_payment_cryptography.types.associate_mpa_team_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.associate_mpa_team_input.AssociateMpaTeamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.AssociateMpaTeam"
    import aws_sdk_payment_cryptography.types.associate_mpa_team_input

    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.associate_mpa_team_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_associate_mpa_team(
