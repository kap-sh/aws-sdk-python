...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.get_resource_policy_output.GetResourcePolicyOutput = aws_sdk_payment_cryptography.types.get_resource_policy_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.get_resource_policy_input.GetResourcePolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.get_resource_policy_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
