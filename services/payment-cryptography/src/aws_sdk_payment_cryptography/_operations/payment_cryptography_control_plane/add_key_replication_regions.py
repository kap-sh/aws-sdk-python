...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.add_key_replication_regions_output.AddKeyReplicationRegionsOutput = aws_sdk_payment_cryptography.types.add_key_replication_regions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.add_key_replication_regions_input.AddKeyReplicationRegionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.add_key_replication_regions_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
