"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#CreateAlias``."""
...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.create_alias_output.CreateAliasOutput = (
        aws_sdk_payment_cryptography.types.create_alias_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.create_alias_input.CreateAliasInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.CreateAlias"
    import aws_sdk_payment_cryptography.types.create_alias_input

    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.create_alias_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
