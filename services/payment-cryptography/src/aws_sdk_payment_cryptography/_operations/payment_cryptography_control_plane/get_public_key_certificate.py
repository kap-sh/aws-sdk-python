"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#GetPublicKeyCertificate``."""
...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.get_public_key_certificate_output.GetPublicKeyCertificateOutput = aws_sdk_payment_cryptography.types.get_public_key_certificate_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.get_public_key_certificate_input.GetPublicKeyCertificateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.GetPublicKeyCertificate"
    import aws_sdk_payment_cryptography.types.get_public_key_certificate_input

    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.get_public_key_certificate_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_public_key_certificate(
