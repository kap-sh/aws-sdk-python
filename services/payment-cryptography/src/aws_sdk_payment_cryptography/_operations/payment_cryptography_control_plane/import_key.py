"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#ImportKey``."""
...
def handle_response(
    ...
    out: aws_sdk_payment_cryptography.types.import_key_output.ImportKeyOutput = (
        aws_sdk_payment_cryptography.types.import_key_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_payment_cryptography.types.import_key_input.ImportKeyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.ImportKey"
    import aws_sdk_payment_cryptography.types.import_key_input

    body: bytes | None = json.dumps(
        aws_sdk_payment_cryptography.types.import_key_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
