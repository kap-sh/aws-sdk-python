...
from aws_sdk_payment_cryptography._services._aws_config import aws_config
...
class PaymentCryptographyClient:
    ...
    def associate_mpa_team(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.associate_mpa_team_input.AssociateMpaTeamInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.associate_mpa_team_output.AssociateMpaTeamOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.associate_mpa_team.associate_mpa_team(
    ...
    def delete_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.delete_resource_policy_input.DeleteResourcePolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.delete_resource_policy_output.DeleteResourcePolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.delete_resource_policy.delete_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disable_default_key_replication_regions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.disable_default_key_replication_regions_input.DisableDefaultKeyReplicationRegionsInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.disable_default_key_replication_regions_output.DisableDefaultKeyReplicationRegionsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.disable_default_key_replication_regions.disable_default_key_replication_regions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_mpa_team(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.disassociate_mpa_team_input.DisassociateMpaTeamInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.disassociate_mpa_team_output.DisassociateMpaTeamOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.disassociate_mpa_team.disassociate_mpa_team(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_default_key_replication_regions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.enable_default_key_replication_regions_input.EnableDefaultKeyReplicationRegionsInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.enable_default_key_replication_regions_output.EnableDefaultKeyReplicationRegionsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.enable_default_key_replication_regions.enable_default_key_replication_regions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def export_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.export_key_input.ExportKeyInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.export_key_output.ExportKeyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.export_key.export_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_certificate_signing_request(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.get_certificate_signing_request_input.GetCertificateSigningRequestInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.get_certificate_signing_request_output.GetCertificateSigningRequestOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.get_certificate_signing_request.get_certificate_signing_request(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_default_key_replication_regions(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.get_default_key_replication_regions_input.GetDefaultKeyReplicationRegionsInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.get_default_key_replication_regions_output.GetDefaultKeyReplicationRegionsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.get_default_key_replication_regions.get_default_key_replication_regions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_mpa_team_association(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.get_mpa_team_association_input.GetMpaTeamAssociationInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.get_mpa_team_association_output.GetMpaTeamAssociationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.get_mpa_team_association.get_mpa_team_association(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_parameters_for_export(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.get_parameters_for_export_input.GetParametersForExportInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.get_parameters_for_export_output.GetParametersForExportOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.get_parameters_for_export.get_parameters_for_export(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_parameters_for_import(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.get_parameters_for_import_input.GetParametersForImportInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.get_parameters_for_import_output.GetParametersForImportOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.get_parameters_for_import.get_parameters_for_import(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_public_key_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.get_public_key_certificate_input.GetPublicKeyCertificateInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.get_public_key_certificate_output.GetPublicKeyCertificateOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.get_public_key_certificate.get_public_key_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.get_resource_policy_input.GetResourcePolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.get_resource_policy_output.GetResourcePolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.get_resource_policy.get_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def import_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.import_key_input.ImportKeyInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.import_key_output.ImportKeyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.import_key.import_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_payment_cryptography.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    def put_resource_policy(
        ...
        *,
        ...
        Raises:
            ...
            aws_sdk_payment_cryptography.errors.conflict_exception.ConflictException: <p>This request can cause an inconsistent state for the resource.</p> <p>The requested operation conflicts with the current state of the resource. For example, attempting to delete a key that is currently being used, or trying to create a resource that already exists.</p>
            aws_sdk_payment_cryptography.errors.internal_server_exception.InternalServerException: <p>The request processing has failed because of an unknown error, exception, or failure.</p> <p>This indicates a server-side error within the Amazon Web Services Payment Cryptography service. If this error persists, contact support for assistance.</p>
            aws_sdk_payment_cryptography.errors.public_policy_exception.PublicPolicyException: <p>The resource-based policy would grant public access to the key.</p> <p>Modify the policy to restrict access to specific principals and resubmit the request.</p>
            aws_sdk_payment_cryptography.errors.resource_not_found_exception.ResourceNotFoundException: <p>The request was denied due to resource not found.</p> <p>The specified key, alias, or other resource does not exist in your account or region. Verify that the resource identifier is correct and that the resource exists in the expected region.</p>
            aws_sdk_payment_cryptography.errors.service_quota_exceeded_exception.ServiceQuotaExceededException: <p>This request would cause a service quota to be exceeded.</p> <p>You have reached the maximum number of keys, aliases, or other resources allowed in your account. Review your current usage and consider deleting unused resources or requesting a quota increase.</p>
            aws_sdk_payment_cryptography.errors.service_unavailable_exception.ServiceUnavailableException: <p>The service cannot complete the request.</p> <p>The Amazon Web Services Payment Cryptography service is temporarily unavailable. This is typically a temporary condition - retry your request after a brief delay.</p>
            aws_sdk_payment_cryptography.errors.throttling_exception.ThrottlingException: <p>The request was denied due to request throttling.</p> <p>You have exceeded the rate limits for Amazon Web Services Payment Cryptography API calls. Implement exponential backoff and retry logic in your application to handle throttling gracefully.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.put_resource_policy_input.PutResourcePolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.put_resource_policy_output.PutResourcePolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.put_resource_policy.put_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography._operations.payment_cryptography_control_plane.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
