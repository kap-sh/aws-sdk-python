"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#DisassociateMpaTeamOutput``."""
...
class DisassociateMpaTeamOutput(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DisassociateMpaTeamOutput) -> dict:
    out: dict = {}
    import aws_sdk_payment_cryptography.types.mpa_team_association
...
def deserialize_aws_json_1_0(data: dict) -> DisassociateMpaTeamOutput:
    ...
    if "MpaTeamAssociation" in data:
        ...
        raise DeserializationError(
            "DisassociateMpaTeamOutput.mpa_team_association required"
        )
    return out
