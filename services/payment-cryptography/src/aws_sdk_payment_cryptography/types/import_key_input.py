...
class ImportKeyInput(TypedDict):
    key_material: (
        "aws_sdk_payment_cryptography.types.import_key_material.ImportKeyMaterial"
    )
...
def serialize_aws_json_1_0(value: ImportKeyInput) -> dict:
    ...
    out["KeyMaterial"] = (
        aws_sdk_payment_cryptography.types.import_key_material.serialize_aws_json_1_0(
            value["key_material"]
        )
    )
...
def deserialize_aws_json_1_0(data: dict) -> ImportKeyInput:
    ...
    if "KeyMaterial" in data:
        ...
        out["key_material"] = (
            aws_sdk_payment_cryptography.types.import_key_material.deserialize_aws_json_1_0(
                data["KeyMaterial"]
            )
        )
    else:
