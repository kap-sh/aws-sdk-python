...
Aliases: TypeAlias = list["aws_sdk_payment_cryptography.types.alias.Alias"]
...
def serialize_aws_json_1_0(value: Aliases) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_payment_cryptography.types.alias.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> Aliases:
    ...
    for item in data:
        out.append(
            aws_sdk_payment_cryptography.types.alias.deserialize_aws_json_1_0(item)
        )
    return out
