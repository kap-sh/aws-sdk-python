...
class GetCertificateSigningRequestInput(TypedDict):
    ...
    signing_algorithm: (
        "aws_sdk_payment_cryptography.types.signing_algorithm_type.SigningAlgorithmType"
    )
...
def serialize_aws_json_1_0(value: GetCertificateSigningRequestInput) -> dict:
    ...
    out["CertificateSubject"] = (
        aws_sdk_payment_cryptography.types.certificate_subject_type.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> GetCertificateSigningRequestInput:
    ...
    if "CertificateSubject" in data:
        ...
        out["certificate_subject"] = (
            aws_sdk_payment_cryptography.types.certificate_subject_type.deserialize_aws_json_1_0(
