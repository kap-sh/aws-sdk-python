...
if TYPE_CHECKING:
    import aws_sdk_payment_cryptography.types.hex_length20_or24


class ExportDukptInitialKey(TypedDict):
    key_serial_number: (
        "aws_sdk_payment_cryptography.types.hex_length20_or24.HexLength20Or24"
    )
