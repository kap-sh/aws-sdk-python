...
if TYPE_CHECKING:
    ...
    import aws_sdk_payment_cryptography.types.wrapped_key_cryptogram


class ImportAs2805KeyCryptogram(TypedDict):
    as2805_key_variant: (
    ...
    wrapped_key_cryptogram: (
        "aws_sdk_payment_cryptography.types.wrapped_key_cryptogram.WrappedKeyCryptogram"
    )
