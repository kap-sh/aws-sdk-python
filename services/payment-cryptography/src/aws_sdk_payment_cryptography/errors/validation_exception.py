"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.paymentcryptography#ValidationException``."""
