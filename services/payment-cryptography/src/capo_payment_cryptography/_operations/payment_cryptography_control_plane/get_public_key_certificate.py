...
def handle_response(
    ...
    out: capo_payment_cryptography.types.get_public_key_certificate_output.GetPublicKeyCertificateOutput = capo_payment_cryptography.types.get_public_key_certificate_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.get_public_key_certificate_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
