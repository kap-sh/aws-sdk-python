...
def handle_response(
    ...
    out: capo_payment_cryptography.types.associate_mpa_team_output.AssociateMpaTeamOutput = capo_payment_cryptography.types.associate_mpa_team_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.associate_mpa_team_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
