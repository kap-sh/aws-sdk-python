"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#CreateKey``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.create_key_output.CreateKeyOutput = (
        capo_payment_cryptography.types.create_key_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.CreateKey"
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.create_key_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def create_key(
    ...
    capo_payment_cryptography.types.create_key_output.CreateKeyOutput, zapros.Response
]:
