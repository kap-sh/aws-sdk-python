"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#DeleteResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.delete_resource_policy_output.DeleteResourcePolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.DeleteResourcePolicy"
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.delete_resource_policy_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
