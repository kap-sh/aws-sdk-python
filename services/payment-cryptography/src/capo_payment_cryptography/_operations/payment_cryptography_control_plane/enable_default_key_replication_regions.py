...
def handle_response(
    ...
    out: capo_payment_cryptography.types.enable_default_key_replication_regions_output.EnableDefaultKeyReplicationRegionsOutput = capo_payment_cryptography.types.enable_default_key_replication_regions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.enable_default_key_replication_regions_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
