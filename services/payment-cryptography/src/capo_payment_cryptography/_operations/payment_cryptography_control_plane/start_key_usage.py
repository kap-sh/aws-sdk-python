"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#StartKeyUsage``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.start_key_usage_output.StartKeyUsageOutput = (
        capo_payment_cryptography.types.start_key_usage_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.StartKeyUsage"
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.start_key_usage_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_start_key_usage(
