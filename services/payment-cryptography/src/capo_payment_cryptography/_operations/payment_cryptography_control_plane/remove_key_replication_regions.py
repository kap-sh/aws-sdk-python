"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#RemoveKeyReplicationRegions``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.remove_key_replication_regions_output.RemoveKeyReplicationRegionsOutput = capo_payment_cryptography.types.remove_key_replication_regions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.remove_key_replication_regions_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_remove_key_replication_regions(
