...
def handle_response(
    ...
    out: capo_payment_cryptography.types.delete_key_output.DeleteKeyOutput = (
        capo_payment_cryptography.types.delete_key_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.delete_key_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def delete_key(
    ...
    capo_payment_cryptography.types.delete_key_output.DeleteKeyOutput, zapros.Response
]:
