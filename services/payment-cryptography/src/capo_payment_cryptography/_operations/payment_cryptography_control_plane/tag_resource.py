"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#TagResource``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.TagResource"
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.tag_resource_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
