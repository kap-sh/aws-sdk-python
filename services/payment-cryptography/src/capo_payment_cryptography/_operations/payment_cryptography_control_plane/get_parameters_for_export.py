"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#GetParametersForExport``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.get_parameters_for_export_output.GetParametersForExportOutput = capo_payment_cryptography.types.get_parameters_for_export_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.GetParametersForExport"
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.get_parameters_for_export_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_parameters_for_export(
