...
import capo_payment_cryptography.errors.public_policy_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PublicPolicyException":
            raise capo_payment_cryptography.errors.public_policy_exception.PublicPolicyException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.put_resource_policy_output.PutResourcePolicyOutput = capo_payment_cryptography.types.put_resource_policy_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.put_resource_policy_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
