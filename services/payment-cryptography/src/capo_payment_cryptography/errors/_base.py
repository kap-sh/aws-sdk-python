...
class PaymentCryptographyError(Exception):
    """Base class for all PaymentCryptography service errors."""


class ServiceError(PaymentCryptographyError):
...
class SerializationError(PaymentCryptographyError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PaymentCryptographyError):
...
class WaiterFailedError(PaymentCryptographyError):
...
class WaiterTimeoutError(PaymentCryptographyError):
