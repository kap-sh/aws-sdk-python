"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#ListSignalCatalogs``."""
...
import capo_iotfleetwise.types.signal_catalog_summaries
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.list_signal_catalogs_response.ListSignalCatalogsResponse = capo_iotfleetwise.types.list_signal_catalogs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/signal-catalogs"
    params: dict[str, str] = {}
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.ListSignalCatalogs"
    body: bytes | None = b""
...
async def async_list_signal_catalogs(
