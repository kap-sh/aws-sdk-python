"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#UpdateModelManifest``."""
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.update_model_manifest_response.UpdateModelManifestResponse = capo_iotfleetwise.types.update_model_manifest_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.UpdateModelManifest"
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.update_model_manifest_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_model_manifest(
