...
def handle_response(
    ...
    out: capo_iotfleetwise.types.associate_vehicle_fleet_response.AssociateVehicleFleetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.associate_vehicle_fleet_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
