...
def handle_response(
    ...
    out: capo_iotfleetwise.types.delete_model_manifest_response.DeleteModelManifestResponse = capo_iotfleetwise.types.delete_model_manifest_response.deserialize_aws_json_1_0(
