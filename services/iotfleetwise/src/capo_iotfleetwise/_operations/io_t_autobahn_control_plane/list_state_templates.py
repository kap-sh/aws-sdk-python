...
def handle_response(
    ...
    out: capo_iotfleetwise.types.list_state_templates_response.ListStateTemplatesResponse = capo_iotfleetwise.types.list_state_templates_response.deserialize_aws_json_1_0(
