...
import capo_iotfleetwise.errors.invalid_node_exception
import capo_iotfleetwise.errors.invalid_signals_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNodeException":
            raise capo_iotfleetwise.errors.invalid_node_exception.InvalidNodeException.from_aws_json_1_0(
                data
            )
        case "InvalidSignalsException":
            raise capo_iotfleetwise.errors.invalid_signals_exception.InvalidSignalsException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.update_signal_catalog_response.UpdateSignalCatalogResponse = capo_iotfleetwise.types.update_signal_catalog_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.update_signal_catalog_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
