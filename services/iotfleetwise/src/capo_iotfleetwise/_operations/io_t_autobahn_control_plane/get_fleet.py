"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#GetFleet``."""
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.get_fleet_response.GetFleetResponse = (
        capo_iotfleetwise.types.get_fleet_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.GetFleet"
    body: bytes | None = b""
...
def get_fleet(
    ...
    capo_iotfleetwise.types.get_fleet_response.GetFleetResponse, zapros.Response
]:
