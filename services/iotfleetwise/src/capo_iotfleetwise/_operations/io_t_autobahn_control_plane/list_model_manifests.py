...
def handle_response(
    ...
    out: capo_iotfleetwise.types.list_model_manifests_response.ListModelManifestsResponse = capo_iotfleetwise.types.list_model_manifests_response.deserialize_aws_json_1_0(
