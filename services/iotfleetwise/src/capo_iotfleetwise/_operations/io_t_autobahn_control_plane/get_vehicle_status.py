"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#GetVehicleStatus``."""
...
import capo_iotfleetwise.types.vehicle_status_list
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.get_vehicle_status_response.GetVehicleStatusResponse = capo_iotfleetwise.types.get_vehicle_status_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/vehicles/{vehicleName}/status"
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.GetVehicleStatus"
    body: bytes | None = b""
