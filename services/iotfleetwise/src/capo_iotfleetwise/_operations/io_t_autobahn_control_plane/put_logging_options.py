...
def handle_response(
    ...
    out: capo_iotfleetwise.types.put_logging_options_response.PutLoggingOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.put_logging_options_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
