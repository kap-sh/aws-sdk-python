...
def handle_response(
    ...
    out: capo_iotfleetwise.types.list_vehicles_in_fleet_response.ListVehiclesInFleetResponse = capo_iotfleetwise.types.list_vehicles_in_fleet_response.deserialize_aws_json_1_0(
