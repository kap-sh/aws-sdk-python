...
import capo_iotfleetwise.types.update_vehicle_errors
import capo_iotfleetwise.types.update_vehicle_request_items
import capo_iotfleetwise.types.update_vehicle_response_items
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.batch_update_vehicle_response.BatchUpdateVehicleResponse = capo_iotfleetwise.types.batch_update_vehicle_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.batch_update_vehicle_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
