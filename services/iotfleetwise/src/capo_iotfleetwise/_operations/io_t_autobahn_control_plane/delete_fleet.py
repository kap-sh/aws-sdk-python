...
def handle_response(
    ...
    out: capo_iotfleetwise.types.delete_fleet_response.DeleteFleetResponse = (
        capo_iotfleetwise.types.delete_fleet_response.deserialize_aws_json_1_0(
...
def delete_fleet(
    ...
    capo_iotfleetwise.types.delete_fleet_response.DeleteFleetResponse, zapros.Response
]:
