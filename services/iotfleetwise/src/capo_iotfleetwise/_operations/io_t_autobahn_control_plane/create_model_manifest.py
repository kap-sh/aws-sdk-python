...
def handle_response(
    ...
    out: capo_iotfleetwise.types.create_model_manifest_response.CreateModelManifestResponse = capo_iotfleetwise.types.create_model_manifest_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.create_model_manifest_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
