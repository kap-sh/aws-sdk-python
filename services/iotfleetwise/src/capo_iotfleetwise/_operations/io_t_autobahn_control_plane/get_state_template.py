...
def handle_response(
    ...
    out: capo_iotfleetwise.types.get_state_template_response.GetStateTemplateResponse = capo_iotfleetwise.types.get_state_template_response.deserialize_aws_json_1_0(
