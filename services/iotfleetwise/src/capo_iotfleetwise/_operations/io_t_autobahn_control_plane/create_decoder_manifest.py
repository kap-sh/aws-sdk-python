...
import capo_iotfleetwise.errors.decoder_manifest_validation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DecoderManifestValidationException":
            raise capo_iotfleetwise.errors.decoder_manifest_validation_exception.DecoderManifestValidationException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.create_decoder_manifest_response.CreateDecoderManifestResponse = capo_iotfleetwise.types.create_decoder_manifest_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.create_decoder_manifest_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
