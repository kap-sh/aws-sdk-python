...
def handle_response(
    ...
    out: capo_iotfleetwise.types.list_fleets_for_vehicle_response.ListFleetsForVehicleResponse = capo_iotfleetwise.types.list_fleets_for_vehicle_response.deserialize_aws_json_1_0(
