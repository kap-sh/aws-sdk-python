...
def handle_response(
    ...
    out: capo_iotfleetwise.types.get_signal_catalog_response.GetSignalCatalogResponse = capo_iotfleetwise.types.get_signal_catalog_response.deserialize_aws_json_1_0(
