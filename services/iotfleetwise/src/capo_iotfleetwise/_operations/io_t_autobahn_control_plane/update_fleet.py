...
def handle_response(
    ...
    out: capo_iotfleetwise.types.update_fleet_response.UpdateFleetResponse = (
        capo_iotfleetwise.types.update_fleet_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.update_fleet_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def update_fleet(
    ...
    capo_iotfleetwise.types.update_fleet_response.UpdateFleetResponse, zapros.Response
]:
