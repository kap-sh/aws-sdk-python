...
def handle_response(
    ...
    out: capo_iotfleetwise.types.get_model_manifest_response.GetModelManifestResponse = capo_iotfleetwise.types.get_model_manifest_response.deserialize_aws_json_1_0(
