...
def handle_response(
    ...
    out: capo_iotfleetwise.types.update_vehicle_response.UpdateVehicleResponse = (
        capo_iotfleetwise.types.update_vehicle_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.update_vehicle_request.serialize_aws_json_1_0(input_)
    ).encode()
