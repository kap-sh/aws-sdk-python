"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#GetVehicle``."""
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.get_vehicle_response.GetVehicleResponse = (
        capo_iotfleetwise.types.get_vehicle_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.GetVehicle"
    body: bytes | None = b""
...
def get_vehicle(
    ...
    capo_iotfleetwise.types.get_vehicle_response.GetVehicleResponse, zapros.Response
]:
