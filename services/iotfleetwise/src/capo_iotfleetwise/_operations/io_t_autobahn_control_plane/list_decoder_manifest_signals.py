"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#ListDecoderManifestSignals``."""
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.list_decoder_manifest_signals_response.ListDecoderManifestSignalsResponse = capo_iotfleetwise.types.list_decoder_manifest_signals_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/decoder-manifests/{name}/signals"
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.ListDecoderManifestSignals"
    body: bytes | None = b""
...
async def async_list_decoder_manifest_signals(
