...
def handle_response(
    ...
    out: capo_iotfleetwise.types.delete_decoder_manifest_response.DeleteDecoderManifestResponse = capo_iotfleetwise.types.delete_decoder_manifest_response.deserialize_aws_json_1_0(
