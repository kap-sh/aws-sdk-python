...
def handle_response(
    ...
    out: capo_iotfleetwise.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_iotfleetwise.types.list_tags_for_resource_response.deserialize_aws_json_1_0(
