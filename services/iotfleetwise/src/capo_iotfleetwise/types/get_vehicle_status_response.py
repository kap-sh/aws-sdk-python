...
class GetVehicleStatusResponse(TypedDict, closed=True):
    campaigns: NotRequired[
        "capo_iotfleetwise.types.vehicle_status_list.VehicleStatusList"
    ]
...
def serialize_aws_json_1_0(value: GetVehicleStatusResponse) -> dict:
    ...
    if "campaigns" in value:
        ...
        out["campaigns"] = (
            capo_iotfleetwise.types.vehicle_status_list.serialize_aws_json_1_0(
                value["campaigns"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> GetVehicleStatusResponse:
    ...
    if "campaigns" in data:
        ...
        out["campaigns"] = (
            capo_iotfleetwise.types.vehicle_status_list.deserialize_aws_json_1_0(
                data["campaigns"]
            )
        )
