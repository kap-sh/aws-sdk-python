...
class BatchUpdateVehicleResponse(TypedDict, closed=True):
    vehicles: NotRequired[
        "capo_iotfleetwise.types.update_vehicle_response_items.updateVehicleResponseItems"
    ]
    ...
    errors: NotRequired[
        "capo_iotfleetwise.types.update_vehicle_errors.updateVehicleErrors"
    ]
...
def serialize_aws_json_1_0(value: BatchUpdateVehicleResponse) -> dict:
    ...
    if "vehicles" in value:
        ...
        out["vehicles"] = (
            capo_iotfleetwise.types.update_vehicle_response_items.serialize_aws_json_1_0(
                value["vehicles"]
            )
        )
    if "errors" in value:
        ...
        out["errors"] = (
            capo_iotfleetwise.types.update_vehicle_errors.serialize_aws_json_1_0(
                value["errors"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> BatchUpdateVehicleResponse:
    ...
    if "vehicles" in data:
        ...
        out["vehicles"] = (
            capo_iotfleetwise.types.update_vehicle_response_items.deserialize_aws_json_1_0(
                data["vehicles"]
            )
        )
    if "errors" in data:
        ...
        out["errors"] = (
            capo_iotfleetwise.types.update_vehicle_errors.deserialize_aws_json_1_0(
                data["errors"]
            )
        )
    return out
