"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#ListSignalCatalogsRequest``."""
...
class ListSignalCatalogsRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListSignalCatalogsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_aws_json_1_0(data: dict) -> ListSignalCatalogsRequest:
    out: ListSignalCatalogsRequest = {}  # type: ignore[typeddict-item]
    return out
