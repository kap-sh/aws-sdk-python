"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotfleetwise#AccessDeniedException``."""
