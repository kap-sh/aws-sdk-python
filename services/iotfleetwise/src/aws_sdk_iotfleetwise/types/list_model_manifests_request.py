...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListModelManifestsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_aws_json_1_0(data: dict) -> ListModelManifestsRequest:
    out: ListModelManifestsRequest = {}  # type: ignore[typeddict-item]
    return out
