...
def serialize_aws_json_1_0(value: BatchUpdateVehicleRequest) -> dict:
    ...
    out["vehicles"] = (
        aws_sdk_iotfleetwise.types.update_vehicle_request_items.serialize_aws_json_1_0(
            value["vehicles"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> BatchUpdateVehicleRequest:
    ...
    if "vehicles" in data:
        ...
        out["vehicles"] = (
            aws_sdk_iotfleetwise.types.update_vehicle_request_items.deserialize_aws_json_1_0(
                data["vehicles"]
            )
        )
    else:
