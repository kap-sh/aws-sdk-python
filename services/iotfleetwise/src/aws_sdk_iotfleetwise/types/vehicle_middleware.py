...
if TYPE_CHECKING:
    import aws_sdk_iotfleetwise.types.vehicle_middleware_name
...
def serialize_aws_json_1_0(value: VehicleMiddleware) -> dict:
    ...
    out["protocolName"] = (
        aws_sdk_iotfleetwise.types.vehicle_middleware_protocol.serialize_aws_json_1_0(
            value["protocol_name"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> VehicleMiddleware:
    ...
    if "protocolName" in data:
        ...
        out["protocol_name"] = (
            aws_sdk_iotfleetwise.types.vehicle_middleware_protocol.deserialize_aws_json_1_0(
                data["protocolName"]
            )
        )
    else:
