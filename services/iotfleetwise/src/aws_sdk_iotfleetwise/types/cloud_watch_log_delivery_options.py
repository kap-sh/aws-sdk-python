...
if TYPE_CHECKING:
    import aws_sdk_iotfleetwise.types.cloud_watch_log_group_name
...
class CloudWatchLogDeliveryOptions(TypedDict, closed=True):
    ...
    log_group_name: NotRequired[
        "aws_sdk_iotfleetwise.types.cloud_watch_log_group_name.CloudWatchLogGroupName"
    ]
...
def serialize_aws_json_1_0(value: CloudWatchLogDeliveryOptions) -> dict:
    ...
    out["logType"] = aws_sdk_iotfleetwise.types.log_type.serialize_aws_json_1_0(
        value["log_type"]
    )
...
def deserialize_aws_json_1_0(data: dict) -> CloudWatchLogDeliveryOptions:
    ...
    if "logType" in data:
        ...
        out["log_type"] = aws_sdk_iotfleetwise.types.log_type.deserialize_aws_json_1_0(
            data["logType"]
        )
    else:
