...
decoderManifestSummaries: TypeAlias = list[
    "aws_sdk_iotfleetwise.types.decoder_manifest_summary.DecoderManifestSummary"
]
...
def serialize_aws_json_1_0(value: decoderManifestSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_iotfleetwise.types.decoder_manifest_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> decoderManifestSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_iotfleetwise.types.decoder_manifest_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
