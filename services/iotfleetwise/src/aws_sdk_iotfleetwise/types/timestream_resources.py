...
if TYPE_CHECKING:
    import aws_sdk_iotfleetwise.types.timestream_database_name
    import aws_sdk_iotfleetwise.types.timestream_table_name


class TimestreamResources(TypedDict):
    timestream_database_name: (
        "aws_sdk_iotfleetwise.types.timestream_database_name.TimestreamDatabaseName"
    )
    """<p>The name of the registered Amazon Timestream database.</p>"""
    timestream_table_name: (
        "aws_sdk_iotfleetwise.types.timestream_table_name.TimestreamTableName"
    )
