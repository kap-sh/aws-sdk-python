...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: CreateVehicleResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> CreateVehicleResponse:
    out: CreateVehicleResponse = {}  # type: ignore[typeddict-item]
