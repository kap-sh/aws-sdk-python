...
def serialize_aws_json_1_0(value: PrimitiveMessageDefinition) -> dict:
    if "ros2PrimitiveMessageDefinition" in value:
        ...
        return {
            "ros2PrimitiveMessageDefinition": aws_sdk_iotfleetwise.types.ros2_primitive_message_definition.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> PrimitiveMessageDefinition:
    if "ros2PrimitiveMessageDefinition" in data:
        ...
        return {
            "ros2PrimitiveMessageDefinition": aws_sdk_iotfleetwise.types.ros2_primitive_message_definition.deserialize_aws_json_1_0(
