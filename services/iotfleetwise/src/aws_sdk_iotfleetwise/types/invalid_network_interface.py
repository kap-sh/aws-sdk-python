...
class InvalidNetworkInterface(TypedDict, closed=True):
    ...
    reason: NotRequired[
        "aws_sdk_iotfleetwise.types.network_interface_failure_reason.NetworkInterfaceFailureReason"
    ]
...
def serialize_aws_json_1_0(value: InvalidNetworkInterface) -> dict:
    ...
    if "reason" in value:
        ...
        out["reason"] = (
            aws_sdk_iotfleetwise.types.network_interface_failure_reason.serialize_aws_json_1_0(
                value["reason"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> InvalidNetworkInterface:
    ...
    if "reason" in data:
        ...
        out["reason"] = (
            aws_sdk_iotfleetwise.types.network_interface_failure_reason.deserialize_aws_json_1_0(
                data["reason"]
            )
        )
    return out
