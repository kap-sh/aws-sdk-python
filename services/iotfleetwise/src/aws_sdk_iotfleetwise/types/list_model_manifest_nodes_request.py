"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#ListModelManifestNodesRequest``."""
...
class ListModelManifestNodesRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListModelManifestNodesRequest) -> dict:
    out: dict = {}
    return out


def deserialize_aws_json_1_0(data: dict) -> ListModelManifestNodesRequest:
    out: ListModelManifestNodesRequest = {}  # type: ignore[typeddict-item]
    return out
