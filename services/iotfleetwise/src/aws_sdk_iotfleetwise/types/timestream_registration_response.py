...
class TimestreamRegistrationResponse(TypedDict):
    ...
    timestream_database_arn: NotRequired["aws_sdk_iotfleetwise.types.arn.arn"]
    """<p>The Amazon Resource Name (ARN) of the Timestream database.</p>"""
    timestream_table_arn: NotRequired["aws_sdk_iotfleetwise.types.arn.arn"]
