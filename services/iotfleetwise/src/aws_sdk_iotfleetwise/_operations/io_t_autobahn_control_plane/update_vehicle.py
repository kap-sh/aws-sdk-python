"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#UpdateVehicle``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.update_vehicle_response.UpdateVehicleResponse = (
        aws_sdk_iotfleetwise.types.update_vehicle_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_iotfleetwise.types.update_vehicle_request.UpdateVehicleRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.UpdateVehicle"
    import aws_sdk_iotfleetwise.types.update_vehicle_request

    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.update_vehicle_request.serialize_aws_json_1_0(input)
    ).encode()
