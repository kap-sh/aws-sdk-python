...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.update_vehicle_request.UpdateVehicleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.update_vehicle_request.serialize_aws_json_1_0(input_)
    ).encode()
