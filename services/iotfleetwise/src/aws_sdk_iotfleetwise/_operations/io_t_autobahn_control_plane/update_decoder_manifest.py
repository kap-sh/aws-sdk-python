"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#UpdateDecoderManifest``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.update_decoder_manifest_response.UpdateDecoderManifestResponse = aws_sdk_iotfleetwise.types.update_decoder_manifest_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.update_decoder_manifest_request.UpdateDecoderManifestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.UpdateDecoderManifest"
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.update_decoder_manifest_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_decoder_manifest(
