...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.import_signal_catalog_response.ImportSignalCatalogResponse = aws_sdk_iotfleetwise.types.import_signal_catalog_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.import_signal_catalog_request.ImportSignalCatalogRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.import_signal_catalog_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
