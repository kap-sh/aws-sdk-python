"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#PutLoggingOptions``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.put_logging_options_response.PutLoggingOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.put_logging_options_request.PutLoggingOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_put_logging_options(
