...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.list_signal_catalog_nodes_response.ListSignalCatalogNodesResponse = aws_sdk_iotfleetwise.types.list_signal_catalog_nodes_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.list_signal_catalog_nodes_request.ListSignalCatalogNodesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "signal_node_type" in input_:
        params["signalNodeType"] = str(input_["signal_node_type"])
