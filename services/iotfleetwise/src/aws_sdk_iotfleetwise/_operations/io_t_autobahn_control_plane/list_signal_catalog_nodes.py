...
def build_request(
    ...
    input: aws_sdk_iotfleetwise.types.list_signal_catalog_nodes_request.ListSignalCatalogNodesRequest,
) -> zapros.Request:
    ...
    if "signal_node_type" in input:
        params["signalNodeType"] = str(input["signal_node_type"])
