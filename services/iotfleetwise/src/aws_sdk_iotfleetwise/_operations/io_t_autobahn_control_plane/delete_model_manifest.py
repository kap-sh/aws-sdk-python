"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#DeleteModelManifest``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.delete_model_manifest_response.DeleteModelManifestResponse = aws_sdk_iotfleetwise.types.delete_model_manifest_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.delete_model_manifest_request.DeleteModelManifestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.DeleteModelManifest"
    body: bytes | None = b""
...
async def async_delete_model_manifest(
