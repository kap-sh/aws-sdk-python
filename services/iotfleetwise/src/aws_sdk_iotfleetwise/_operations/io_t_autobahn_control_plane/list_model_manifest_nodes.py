...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.list_model_manifest_nodes_response.ListModelManifestNodesResponse = aws_sdk_iotfleetwise.types.list_model_manifest_nodes_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.list_model_manifest_nodes_request.ListModelManifestNodesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
