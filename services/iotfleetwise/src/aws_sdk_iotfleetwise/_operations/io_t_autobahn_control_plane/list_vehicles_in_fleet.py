"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#ListVehiclesInFleet``."""
...
if TYPE_CHECKING:
    import aws_sdk_iotfleetwise.types.list_vehicles_in_fleet_request
    import aws_sdk_iotfleetwise.types.list_vehicles_in_fleet_response
...
) -> aws_sdk_iotfleetwise.types.list_vehicles_in_fleet_response.ListVehiclesInFleetResponse:
    import aws_sdk_iotfleetwise.types.list_vehicles_in_fleet_response

    out: aws_sdk_iotfleetwise.types.list_vehicles_in_fleet_response.ListVehiclesInFleetResponse = aws_sdk_iotfleetwise.types.list_vehicles_in_fleet_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_iotfleetwise.types.list_vehicles_in_fleet_request.ListVehiclesInFleetRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/fleets/{fleetId}/vehicles"
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.ListVehiclesInFleet"
    body: bytes | None = b""
...
async def async_list_vehicles_in_fleet(
