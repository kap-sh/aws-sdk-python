"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#BatchUpdateVehicle``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.batch_update_vehicle_response.BatchUpdateVehicleResponse = aws_sdk_iotfleetwise.types.batch_update_vehicle_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.batch_update_vehicle_request.BatchUpdateVehicleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.BatchUpdateVehicle"
    import aws_sdk_iotfleetwise.types.batch_update_vehicle_request

    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.batch_update_vehicle_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_batch_update_vehicle(
