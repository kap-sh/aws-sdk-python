...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.get_fleet_response.GetFleetResponse = (
        aws_sdk_iotfleetwise.types.get_fleet_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.get_fleet_request.GetFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_fleet(
    ...
    aws_sdk_iotfleetwise.types.get_fleet_response.GetFleetResponse, zapros.Response
]:
