"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#DeleteDecoderManifest``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.delete_decoder_manifest_response.DeleteDecoderManifestResponse = aws_sdk_iotfleetwise.types.delete_decoder_manifest_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.delete_decoder_manifest_request.DeleteDecoderManifestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.DeleteDecoderManifest"
    body: bytes | None = b""
...
async def async_delete_decoder_manifest(
