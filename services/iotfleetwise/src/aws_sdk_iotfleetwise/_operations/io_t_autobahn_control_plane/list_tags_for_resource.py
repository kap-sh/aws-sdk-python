"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#ListTagsForResource``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_iotfleetwise.types.list_tags_for_resource_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.ListTagsForResource"
    body: bytes | None = b""
