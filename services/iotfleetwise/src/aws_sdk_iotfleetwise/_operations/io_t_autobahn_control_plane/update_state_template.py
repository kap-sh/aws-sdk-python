...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.update_state_template_response.UpdateStateTemplateResponse = aws_sdk_iotfleetwise.types.update_state_template_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.update_state_template_request.UpdateStateTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.update_state_template_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
