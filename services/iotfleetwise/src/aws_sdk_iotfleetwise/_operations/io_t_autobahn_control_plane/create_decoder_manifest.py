"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#CreateDecoderManifest``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.create_decoder_manifest_response.CreateDecoderManifestResponse = aws_sdk_iotfleetwise.types.create_decoder_manifest_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.create_decoder_manifest_request.CreateDecoderManifestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.CreateDecoderManifest"
    import aws_sdk_iotfleetwise.types.create_decoder_manifest_request

    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.create_decoder_manifest_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_decoder_manifest(
