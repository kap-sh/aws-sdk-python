"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#BatchCreateVehicle``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.batch_create_vehicle_response.BatchCreateVehicleResponse = aws_sdk_iotfleetwise.types.batch_create_vehicle_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.batch_create_vehicle_request.BatchCreateVehicleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.BatchCreateVehicle"
    import aws_sdk_iotfleetwise.types.batch_create_vehicle_request

    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.batch_create_vehicle_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_batch_create_vehicle(
