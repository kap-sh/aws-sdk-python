"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#UpdateFleet``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.update_fleet_response.UpdateFleetResponse = (
        aws_sdk_iotfleetwise.types.update_fleet_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_iotfleetwise.types.update_fleet_request.UpdateFleetRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.UpdateFleet"
    import aws_sdk_iotfleetwise.types.update_fleet_request

    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.update_fleet_request.serialize_aws_json_1_0(input)
    ).encode()
