...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.update_fleet_request.UpdateFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.update_fleet_request.serialize_aws_json_1_0(input_)
    ).encode()
