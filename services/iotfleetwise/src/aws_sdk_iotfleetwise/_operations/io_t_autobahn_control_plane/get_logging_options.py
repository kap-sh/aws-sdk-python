"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#GetLoggingOptions``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.get_logging_options_response.GetLoggingOptionsResponse = aws_sdk_iotfleetwise.types.get_logging_options_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.get_logging_options_request.GetLoggingOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/loggingOptions"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.GetLoggingOptions"
    body: bytes | None = b""
...
async def async_get_logging_options(
