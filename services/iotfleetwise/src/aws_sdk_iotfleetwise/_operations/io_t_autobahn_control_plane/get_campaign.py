...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.get_campaign_response.GetCampaignResponse = (
        aws_sdk_iotfleetwise.types.get_campaign_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.get_campaign_request.GetCampaignRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
