...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.tag_resource_request.serialize_aws_json_1_0(input_)
    ).encode()
