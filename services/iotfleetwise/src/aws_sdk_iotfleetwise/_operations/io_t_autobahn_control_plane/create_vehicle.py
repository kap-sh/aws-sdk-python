...
def build_request(
    ...
    input: aws_sdk_iotfleetwise.types.create_vehicle_request.CreateVehicleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.create_vehicle_request.serialize_aws_json_1_0(input)
    ).encode()
