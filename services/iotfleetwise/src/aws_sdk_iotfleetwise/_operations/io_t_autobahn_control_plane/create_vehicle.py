...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.create_vehicle_response.CreateVehicleResponse = (
        aws_sdk_iotfleetwise.types.create_vehicle_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.create_vehicle_request.CreateVehicleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.create_vehicle_request.serialize_aws_json_1_0(input_)
    ).encode()
