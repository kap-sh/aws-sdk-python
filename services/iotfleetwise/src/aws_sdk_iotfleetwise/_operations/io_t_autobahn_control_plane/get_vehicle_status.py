...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.get_vehicle_status_response.GetVehicleStatusResponse = aws_sdk_iotfleetwise.types.get_vehicle_status_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.get_vehicle_status_request.GetVehicleStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
