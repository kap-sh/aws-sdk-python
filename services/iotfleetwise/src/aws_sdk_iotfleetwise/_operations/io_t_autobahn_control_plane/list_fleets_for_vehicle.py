"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#ListFleetsForVehicle``."""
...
if TYPE_CHECKING:
    import aws_sdk_iotfleetwise.types.list_fleets_for_vehicle_request
    import aws_sdk_iotfleetwise.types.list_fleets_for_vehicle_response
...
) -> aws_sdk_iotfleetwise.types.list_fleets_for_vehicle_response.ListFleetsForVehicleResponse:
    import aws_sdk_iotfleetwise.types.list_fleets_for_vehicle_response

    out: aws_sdk_iotfleetwise.types.list_fleets_for_vehicle_response.ListFleetsForVehicleResponse = aws_sdk_iotfleetwise.types.list_fleets_for_vehicle_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_iotfleetwise.types.list_fleets_for_vehicle_request.ListFleetsForVehicleRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/vehicles/{vehicleName}/fleets"
    url = url.replace("{vehicleName}", quote(str(input["vehicle_name"]), safe=""))
    params: dict[str, str] = {}
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.ListFleetsForVehicle"
    body: bytes | None = b""
...
async def async_list_fleets_for_vehicle(
