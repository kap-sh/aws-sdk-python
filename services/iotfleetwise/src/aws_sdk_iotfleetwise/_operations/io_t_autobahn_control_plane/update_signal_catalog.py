"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#UpdateSignalCatalog``."""
...
import aws_sdk_iotfleetwise.errors.invalid_node_exception
import aws_sdk_iotfleetwise.errors.invalid_signals_exception
import aws_sdk_iotfleetwise.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNodeException":
            raise aws_sdk_iotfleetwise.errors.invalid_node_exception.InvalidNodeException.from_aws_json_1_0(
                data
            )
        ...
        case "LimitExceededException":
            raise aws_sdk_iotfleetwise.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.update_signal_catalog_response.UpdateSignalCatalogResponse = aws_sdk_iotfleetwise.types.update_signal_catalog_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.update_signal_catalog_request.UpdateSignalCatalogRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/signal-catalogs/{name}"
    url = url.replace("{name}", quote(str(input_["name"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.UpdateSignalCatalog"
    import aws_sdk_iotfleetwise.types.update_signal_catalog_request

    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.update_signal_catalog_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_signal_catalog(
