...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.register_account_response.RegisterAccountResponse = aws_sdk_iotfleetwise.types.register_account_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.register_account_request.RegisterAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.register_account_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
