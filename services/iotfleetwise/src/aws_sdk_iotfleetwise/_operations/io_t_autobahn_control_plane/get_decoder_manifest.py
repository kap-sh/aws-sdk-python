"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#GetDecoderManifest``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.get_decoder_manifest_response.GetDecoderManifestResponse = aws_sdk_iotfleetwise.types.get_decoder_manifest_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.get_decoder_manifest_request.GetDecoderManifestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.GetDecoderManifest"
    body: bytes | None = b""
...
async def async_get_decoder_manifest(
