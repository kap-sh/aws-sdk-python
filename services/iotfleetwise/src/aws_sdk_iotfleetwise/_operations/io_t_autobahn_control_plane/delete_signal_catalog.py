...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.delete_signal_catalog_response.DeleteSignalCatalogResponse = aws_sdk_iotfleetwise.types.delete_signal_catalog_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.delete_signal_catalog_request.DeleteSignalCatalogRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
