"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#GetSignalCatalog``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.get_signal_catalog_response.GetSignalCatalogResponse = aws_sdk_iotfleetwise.types.get_signal_catalog_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.get_signal_catalog_request.GetSignalCatalogRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.GetSignalCatalog"
    body: bytes | None = b""
...
async def async_get_signal_catalog(
