"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#GetStateTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.get_state_template_response.GetStateTemplateResponse = aws_sdk_iotfleetwise.types.get_state_template_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.get_state_template_request.GetStateTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.GetStateTemplate"
    body: bytes | None = b""
...
async def async_get_state_template(
