"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#ListCampaigns``."""
...
import aws_sdk_iotfleetwise.types.campaign_summaries
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.list_campaigns_response.ListCampaignsResponse = (
        aws_sdk_iotfleetwise.types.list_campaigns_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.list_campaigns_request.ListCampaignsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.ListCampaigns"
    body: bytes | None = b""
...
async def async_list_campaigns(
