"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#UpdateCampaign``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.update_campaign_response.UpdateCampaignResponse = (
        aws_sdk_iotfleetwise.types.update_campaign_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_iotfleetwise.types.update_campaign_request.UpdateCampaignRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.UpdateCampaign"
    import aws_sdk_iotfleetwise.types.update_campaign_request

    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.update_campaign_request.serialize_aws_json_1_0(input)
    ).encode()
