...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.update_campaign_request.UpdateCampaignRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.update_campaign_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
