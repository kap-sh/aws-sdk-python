...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.list_fleets_response.ListFleetsResponse = (
        aws_sdk_iotfleetwise.types.list_fleets_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.list_fleets_request.ListFleetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_fleets(
    ...
    aws_sdk_iotfleetwise.types.list_fleets_response.ListFleetsResponse, zapros.Response
]:
