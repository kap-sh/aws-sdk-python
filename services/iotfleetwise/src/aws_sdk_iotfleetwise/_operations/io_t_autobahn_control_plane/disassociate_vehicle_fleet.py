...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.disassociate_vehicle_fleet_response.DisassociateVehicleFleetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.disassociate_vehicle_fleet_request.DisassociateVehicleFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.disassociate_vehicle_fleet_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
