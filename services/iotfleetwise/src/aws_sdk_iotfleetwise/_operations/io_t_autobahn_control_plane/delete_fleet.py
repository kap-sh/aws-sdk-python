"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#DeleteFleet``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.delete_fleet_response.DeleteFleetResponse = (
        aws_sdk_iotfleetwise.types.delete_fleet_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_iotfleetwise.types.delete_fleet_request.DeleteFleetRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.DeleteFleet"
    body: bytes | None = b""
