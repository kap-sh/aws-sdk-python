"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#CreateFleet``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.create_fleet_response.CreateFleetResponse = (
        aws_sdk_iotfleetwise.types.create_fleet_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_iotfleetwise.types.create_fleet_request.CreateFleetRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/fleets/{fleetId}"
    url = url.replace("{fleetId}", quote(str(input["fleet_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.CreateFleet"
    import aws_sdk_iotfleetwise.types.create_fleet_request

    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.create_fleet_request.serialize_aws_json_1_0(input)
    ).encode()
