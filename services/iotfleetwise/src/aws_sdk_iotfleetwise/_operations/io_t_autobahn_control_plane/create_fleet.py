...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.create_fleet_request.CreateFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.create_fleet_request.serialize_aws_json_1_0(input_)
    ).encode()
