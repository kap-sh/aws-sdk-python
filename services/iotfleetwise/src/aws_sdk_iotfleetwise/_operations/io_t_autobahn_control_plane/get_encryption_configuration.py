"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#GetEncryptionConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.get_encryption_configuration_response.GetEncryptionConfigurationResponse = aws_sdk_iotfleetwise.types.get_encryption_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.get_encryption_configuration_request.GetEncryptionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/encryptionConfiguration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.GetEncryptionConfiguration"
    body: bytes | None = b""
...
async def async_get_encryption_configuration(
