...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.get_vehicle_response.GetVehicleResponse = (
        aws_sdk_iotfleetwise.types.get_vehicle_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.get_vehicle_request.GetVehicleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_vehicle(
    ...
    aws_sdk_iotfleetwise.types.get_vehicle_response.GetVehicleResponse, zapros.Response
]:
