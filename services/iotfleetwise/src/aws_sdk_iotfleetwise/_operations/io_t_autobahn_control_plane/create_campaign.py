...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.create_campaign_response.CreateCampaignResponse = (
        aws_sdk_iotfleetwise.types.create_campaign_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_iotfleetwise.types.create_campaign_request.CreateCampaignRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.create_campaign_request.serialize_aws_json_1_0(input)
    ).encode()
