...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.create_campaign_request.CreateCampaignRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.create_campaign_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
