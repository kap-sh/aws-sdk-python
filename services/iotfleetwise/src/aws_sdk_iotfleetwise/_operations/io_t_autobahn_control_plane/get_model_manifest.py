"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#GetModelManifest``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.get_model_manifest_response.GetModelManifestResponse = aws_sdk_iotfleetwise.types.get_model_manifest_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.get_model_manifest_request.GetModelManifestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.GetModelManifest"
    body: bytes | None = b""
...
async def async_get_model_manifest(
