...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.list_signal_catalogs_response.ListSignalCatalogsResponse = aws_sdk_iotfleetwise.types.list_signal_catalogs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.list_signal_catalogs_request.ListSignalCatalogsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
