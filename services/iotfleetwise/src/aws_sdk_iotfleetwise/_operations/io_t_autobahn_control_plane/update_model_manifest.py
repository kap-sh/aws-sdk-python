...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.update_model_manifest_response.UpdateModelManifestResponse = aws_sdk_iotfleetwise.types.update_model_manifest_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.update_model_manifest_request.UpdateModelManifestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.update_model_manifest_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
