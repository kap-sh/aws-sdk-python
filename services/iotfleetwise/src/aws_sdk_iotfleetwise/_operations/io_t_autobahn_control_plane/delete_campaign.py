"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#DeleteCampaign``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.delete_campaign_response.DeleteCampaignResponse = (
        aws_sdk_iotfleetwise.types.delete_campaign_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.delete_campaign_request.DeleteCampaignRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.DeleteCampaign"
    body: bytes | None = b""
