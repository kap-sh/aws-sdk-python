"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#ListDecoderManifestNetworkInterfaces``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.list_decoder_manifest_network_interfaces_response.ListDecoderManifestNetworkInterfacesResponse = aws_sdk_iotfleetwise.types.list_decoder_manifest_network_interfaces_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.list_decoder_manifest_network_interfaces_request.ListDecoderManifestNetworkInterfacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/decoder-manifests/{name}/network-interfaces"
...
async def async_list_decoder_manifest_network_interfaces(
