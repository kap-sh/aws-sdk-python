"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#ListStateTemplates``."""
...
import aws_sdk_iotfleetwise.types.state_template_summaries
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.list_state_templates_response.ListStateTemplatesResponse = aws_sdk_iotfleetwise.types.list_state_templates_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.list_state_templates_request.ListStateTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/state-templates"
    params: dict[str, str] = {}
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.ListStateTemplates"
    body: bytes | None = b""
...
async def async_list_state_templates(
