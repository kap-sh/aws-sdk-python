"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#CreateSignalCatalog``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.create_signal_catalog_response.CreateSignalCatalogResponse = aws_sdk_iotfleetwise.types.create_signal_catalog_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.create_signal_catalog_request.CreateSignalCatalogRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_signal_catalog(
