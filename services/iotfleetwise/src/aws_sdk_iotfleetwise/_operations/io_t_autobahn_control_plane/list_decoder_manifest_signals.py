...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.list_decoder_manifest_signals_response.ListDecoderManifestSignalsResponse = aws_sdk_iotfleetwise.types.list_decoder_manifest_signals_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.list_decoder_manifest_signals_request.ListDecoderManifestSignalsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
