"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#ListModelManifests``."""
...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.list_model_manifests_response.ListModelManifestsResponse = aws_sdk_iotfleetwise.types.list_model_manifests_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.list_model_manifests_request.ListModelManifestsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/model-manifests"
    params: dict[str, str] = {}
    if "signal_catalog_arn" in input_:
        params["signalCatalogArn"] = str(input_["signal_catalog_arn"])
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.ListModelManifests"
    body: bytes | None = b""
...
async def async_list_model_manifests(
