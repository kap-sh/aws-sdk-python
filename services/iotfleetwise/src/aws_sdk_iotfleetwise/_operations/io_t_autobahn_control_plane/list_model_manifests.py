...
def build_request(
    ...
    input: aws_sdk_iotfleetwise.types.list_model_manifests_request.ListModelManifestsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "signal_catalog_arn" in input:
        params["signalCatalogArn"] = str(input["signal_catalog_arn"])
