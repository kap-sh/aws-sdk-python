...
def handle_response(
    ...
    out: aws_sdk_iotfleetwise.types.put_encryption_configuration_response.PutEncryptionConfigurationResponse = aws_sdk_iotfleetwise.types.put_encryption_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_iotfleetwise.types.put_encryption_configuration_request.PutEncryptionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotfleetwise.types.put_encryption_configuration_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
