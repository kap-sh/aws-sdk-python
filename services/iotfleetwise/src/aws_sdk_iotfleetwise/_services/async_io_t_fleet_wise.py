...
from aws_sdk_iotfleetwise._services._aws_config import aaws_config
...
class AsyncIoTFleetWiseClientConfig(TypedDict, total=False):
...
class AsyncIoTFleetWiseClient:
    ...
    async def batch_create_vehicle(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotfleetwise.types.batch_create_vehicle_request.BatchCreateVehicleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotfleetwise.types.batch_create_vehicle_response.BatchCreateVehicleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotfleetwise._operations.io_t_autobahn_control_plane.batch_create_vehicle.async_batch_create_vehicle(
    ...
    async def batch_update_vehicle(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotfleetwise.types.batch_update_vehicle_request.BatchUpdateVehicleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotfleetwise.types.batch_update_vehicle_response.BatchUpdateVehicleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotfleetwise._operations.io_t_autobahn_control_plane.batch_update_vehicle.async_batch_update_vehicle(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_encryption_configuration(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotfleetwise.types.get_encryption_configuration_request.GetEncryptionConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotfleetwise.types.get_encryption_configuration_response.GetEncryptionConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotfleetwise._operations.io_t_autobahn_control_plane.get_encryption_configuration.async_get_encryption_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_logging_options(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotfleetwise.types.get_logging_options_request.GetLoggingOptionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotfleetwise.types.get_logging_options_response.GetLoggingOptionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotfleetwise._operations.io_t_autobahn_control_plane.get_logging_options.async_get_logging_options(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_register_account_status(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotfleetwise.types.get_register_account_status_request.GetRegisterAccountStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotfleetwise.types.get_register_account_status_response.GetRegisterAccountStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotfleetwise._operations.io_t_autobahn_control_plane.get_register_account_status.async_get_register_account_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_vehicle_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotfleetwise.types.get_vehicle_status_request.GetVehicleStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotfleetwise.types.get_vehicle_status_response.GetVehicleStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotfleetwise._operations.io_t_autobahn_control_plane.get_vehicle_status.async_get_vehicle_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iotfleetwise.types.vehicle_status.VehicleStatus]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotfleetwise.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotfleetwise.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotfleetwise._operations.io_t_autobahn_control_plane.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_encryption_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotfleetwise.types.put_encryption_configuration_request.PutEncryptionConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotfleetwise.types.put_encryption_configuration_response.PutEncryptionConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotfleetwise._operations.io_t_autobahn_control_plane.put_encryption_configuration.async_put_encryption_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_logging_options(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotfleetwise.types.put_logging_options_request.PutLoggingOptionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotfleetwise.types.put_logging_options_response.PutLoggingOptionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotfleetwise._operations.io_t_autobahn_control_plane.put_logging_options.async_put_logging_options(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_account(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotfleetwise.types.register_account_request.RegisterAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotfleetwise.types.register_account_response.RegisterAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotfleetwise._operations.io_t_autobahn_control_plane.register_account.async_register_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotfleetwise.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotfleetwise.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotfleetwise._operations.io_t_autobahn_control_plane.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotfleetwise.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotfleetwise.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotfleetwise._operations.io_t_autobahn_control_plane.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
