...
class InvalidNodeException_(TypedDict):
    invalid_nodes: NotRequired["aws_sdk_iotfleetwise.types.nodes.Nodes"]
...
def serialize_aws_json_1_0(value: InvalidNodeException_) -> dict:
    ...
    if "invalid_nodes" in value:
        ...
        out["invalidNodes"] = aws_sdk_iotfleetwise.types.nodes.serialize_aws_json_1_0(
            value["invalid_nodes"]
        )
    if "reason" in value:
