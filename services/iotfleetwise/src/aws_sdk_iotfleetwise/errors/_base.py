...
class IoTFleetWiseError(Exception):
    """Base class for all IoTFleetWise service errors."""


class ServiceError(IoTFleetWiseError):
...
class SerializationError(IoTFleetWiseError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IoTFleetWiseError):
...
class WaiterFailedError(IoTFleetWiseError):
...
class WaiterTimeoutError(IoTFleetWiseError):
