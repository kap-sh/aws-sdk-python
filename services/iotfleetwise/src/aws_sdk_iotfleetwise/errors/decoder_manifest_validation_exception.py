...
if TYPE_CHECKING:
    import aws_sdk_iotfleetwise.types.invalid_network_interfaces
    import aws_sdk_iotfleetwise.types.invalid_signal_decoders
    import aws_sdk_iotfleetwise.types.string


class DecoderManifestValidationException_(TypedDict):
    invalid_signals: NotRequired[
        "aws_sdk_iotfleetwise.types.invalid_signal_decoders.InvalidSignalDecoders"
    ]
    """<p>The request couldn't be completed because of invalid signals in the request.</p>"""
    invalid_network_interfaces: NotRequired[
        "aws_sdk_iotfleetwise.types.invalid_network_interfaces.InvalidNetworkInterfaces"
    ]
...
def serialize_aws_json_1_0(value: DecoderManifestValidationException_) -> dict:
    ...
    if "invalid_signals" in value:
        ...
        out["invalidSignals"] = (
            aws_sdk_iotfleetwise.types.invalid_signal_decoders.serialize_aws_json_1_0(
    ...
    if "invalid_network_interfaces" in value:
        ...
        out["invalidNetworkInterfaces"] = (
            aws_sdk_iotfleetwise.types.invalid_network_interfaces.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DecoderManifestValidationException_:
    ...
    if "invalidSignals" in data:
        ...
        out["invalid_signals"] = (
            aws_sdk_iotfleetwise.types.invalid_signal_decoders.deserialize_aws_json_1_0(
                data["invalidSignals"]
            )
        )
    if "invalidNetworkInterfaces" in data:
        ...
        out["invalid_network_interfaces"] = (
            aws_sdk_iotfleetwise.types.invalid_network_interfaces.deserialize_aws_json_1_0(
