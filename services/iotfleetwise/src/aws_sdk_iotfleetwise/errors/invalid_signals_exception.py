...
from aws_sdk_iotfleetwise.errors import ServiceError

if TYPE_CHECKING:
    import aws_sdk_iotfleetwise.types.invalid_signals
    import aws_sdk_iotfleetwise.types.string


class InvalidSignalsException_(TypedDict):
    message: NotRequired["aws_sdk_iotfleetwise.types.string.string"]
    invalid_signals: NotRequired[
        "aws_sdk_iotfleetwise.types.invalid_signals.InvalidSignals"
    ]
...
def serialize_aws_json_1_0(value: InvalidSignalsException_) -> dict:
    ...
    if "invalid_signals" in value:
        ...
        out["invalidSignals"] = (
            aws_sdk_iotfleetwise.types.invalid_signals.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> InvalidSignalsException_:
    ...
    if "invalidSignals" in data:
        ...
        out["invalid_signals"] = (
            aws_sdk_iotfleetwise.types.invalid_signals.deserialize_aws_json_1_0(
                data["invalidSignals"]
            )
        )
    return out
