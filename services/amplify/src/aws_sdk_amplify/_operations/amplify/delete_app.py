...
def handle_response(
    ...
    out: aws_sdk_amplify.types.delete_app_result.DeleteAppResult = (
        aws_sdk_amplify.types.delete_app_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.delete_app_request.DeleteAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_app(
    ...
    input_: aws_sdk_amplify.types.delete_app_request.DeleteAppRequest,
) -> tuple[aws_sdk_amplify.types.delete_app_result.DeleteAppResult, zapros.Response]:
