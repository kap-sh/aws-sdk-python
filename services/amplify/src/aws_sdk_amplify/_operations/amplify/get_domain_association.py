...
def handle_response(
    ...
    out: aws_sdk_amplify.types.get_domain_association_result.GetDomainAssociationResult = aws_sdk_amplify.types.get_domain_association_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.get_domain_association_request.GetDomainAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
