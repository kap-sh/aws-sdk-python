"""Generated from Smithy shape ``com.amazonaws.amplify#ListApps``."""
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.list_apps_result.ListAppsResult = (
        aws_sdk_amplify.types.list_apps_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.list_apps_request.ListAppsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_apps(
    ...
    input_: aws_sdk_amplify.types.list_apps_request.ListAppsRequest,
) -> tuple[aws_sdk_amplify.types.list_apps_result.ListAppsResult, zapros.Response]:
