...
def handle_response(
    ...
    out: aws_sdk_amplify.types.delete_domain_association_result.DeleteDomainAssociationResult = aws_sdk_amplify.types.delete_domain_association_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.delete_domain_association_request.DeleteDomainAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
