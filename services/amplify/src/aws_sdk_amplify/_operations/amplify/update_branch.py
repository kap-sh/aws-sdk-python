"""Generated from Smithy shape ``com.amazonaws.amplify#UpdateBranch``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DependentServiceFailureException":
            import aws_sdk_amplify.errors.dependent_service_failure_exception

            raise aws_sdk_amplify.errors.dependent_service_failure_exception.DependentServiceFailureException.from_json(
                data
            )
        ...
        case "NotFoundException":
            import aws_sdk_amplify.errors.not_found_exception

            raise aws_sdk_amplify.errors.not_found_exception.NotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.update_branch_result.UpdateBranchResult = (
        aws_sdk_amplify.types.update_branch_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplify.types.update_branch_request.UpdateBranchRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/apps/{appId}/branches/{branchName}"
    url = url.replace("{appId}", quote(str(input["app_id"]), safe=""))
    url = url.replace("{branchName}", quote(str(input["branch_name"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_amplify.types.update_branch_request

    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.update_branch_request.serialize_json(input)
    ).encode()
...
def update_branch(
    ...
    aws_sdk_amplify.types.update_branch_result.UpdateBranchResult, zapros.Response
]:
