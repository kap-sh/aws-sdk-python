...
def handle_response(
    ...
    out: aws_sdk_amplify.types.create_webhook_result.CreateWebhookResult = (
        aws_sdk_amplify.types.create_webhook_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.create_webhook_request.CreateWebhookRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.create_webhook_request.serialize_json(input_)
    ).encode()
...
def create_webhook(
    ...
    aws_sdk_amplify.types.create_webhook_result.CreateWebhookResult, zapros.Response
]:
