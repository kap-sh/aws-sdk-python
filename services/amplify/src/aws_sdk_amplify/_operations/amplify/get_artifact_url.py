...
def handle_response(
    ...
    out: aws_sdk_amplify.types.get_artifact_url_result.GetArtifactUrlResult = (
        aws_sdk_amplify.types.get_artifact_url_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplify.types.get_artifact_url_request.GetArtifactUrlRequest,
) -> zapros.Request:
    ...
    url = url.replace("{artifactId}", quote(str(input["artifact_id"]), safe=""))
    params: dict[str, str] = {}
...
def get_artifact_url(
    ...
    aws_sdk_amplify.types.get_artifact_url_result.GetArtifactUrlResult, zapros.Response
]:
