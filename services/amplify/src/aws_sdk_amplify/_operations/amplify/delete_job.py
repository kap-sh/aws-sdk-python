...
def handle_response(
    ...
    out: aws_sdk_amplify.types.delete_job_result.DeleteJobResult = (
        aws_sdk_amplify.types.delete_job_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplify.types.delete_job_request.DeleteJobRequest,
) -> zapros.Request:
...
def delete_job(
    ...
    input: aws_sdk_amplify.types.delete_job_request.DeleteJobRequest,
) -> tuple[aws_sdk_amplify.types.delete_job_result.DeleteJobResult, zapros.Response]:
