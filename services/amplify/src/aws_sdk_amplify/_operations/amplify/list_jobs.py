"""Generated from Smithy shape ``com.amazonaws.amplify#ListJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.list_jobs_result.ListJobsResult = (
        aws_sdk_amplify.types.list_jobs_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplify.types.list_jobs_request.ListJobsRequest,
) -> zapros.Request:
...
def list_jobs(
    ...
    input: aws_sdk_amplify.types.list_jobs_request.ListJobsRequest,
) -> tuple[aws_sdk_amplify.types.list_jobs_result.ListJobsResult, zapros.Response]:
