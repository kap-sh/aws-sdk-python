"""Generated from Smithy shape ``com.amazonaws.amplify#ListArtifacts``."""
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.list_artifacts_result.ListArtifactsResult = (
        aws_sdk_amplify.types.list_artifacts_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplify.types.list_artifacts_request.ListArtifactsRequest,
) -> zapros.Request:
...
def list_artifacts(
    ...
    aws_sdk_amplify.types.list_artifacts_result.ListArtifactsResult, zapros.Response
]:
