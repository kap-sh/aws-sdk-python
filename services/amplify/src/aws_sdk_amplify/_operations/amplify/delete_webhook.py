...
def handle_response(
    ...
    out: aws_sdk_amplify.types.delete_webhook_result.DeleteWebhookResult = (
        aws_sdk_amplify.types.delete_webhook_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.delete_webhook_request.DeleteWebhookRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_webhook(
    ...
    aws_sdk_amplify.types.delete_webhook_result.DeleteWebhookResult, zapros.Response
]:
