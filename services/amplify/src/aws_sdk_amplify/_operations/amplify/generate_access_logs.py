...
def build_request(
    ...
    input: aws_sdk_amplify.types.generate_access_logs_request.GenerateAccessLogsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.generate_access_logs_request.serialize_json(input)
    ).encode()
