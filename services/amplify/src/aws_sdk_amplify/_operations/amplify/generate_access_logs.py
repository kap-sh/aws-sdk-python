"""Generated from Smithy shape ``com.amazonaws.amplify#GenerateAccessLogs``."""
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.generate_access_logs_result.GenerateAccessLogsResult = (
        aws_sdk_amplify.types.generate_access_logs_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.generate_access_logs_request.GenerateAccessLogsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/apps/{appId}/accesslogs"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.generate_access_logs_request.serialize_json(input_)
    ).encode()
...
async def async_generate_access_logs(
