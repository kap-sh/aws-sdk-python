...
def handle_response(
    ...
    out: aws_sdk_amplify.types.list_webhooks_result.ListWebhooksResult = (
        aws_sdk_amplify.types.list_webhooks_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.list_webhooks_request.ListWebhooksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_webhooks(
    ...
    aws_sdk_amplify.types.list_webhooks_result.ListWebhooksResult, zapros.Response
]:
