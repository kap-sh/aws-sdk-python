...
def handle_response(
    ...
    out: aws_sdk_amplify.types.get_backend_environment_result.GetBackendEnvironmentResult = aws_sdk_amplify.types.get_backend_environment_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.get_backend_environment_request.GetBackendEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
