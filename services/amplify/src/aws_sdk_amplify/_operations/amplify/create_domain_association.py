...
def handle_response(
    ...
    out: aws_sdk_amplify.types.create_domain_association_result.CreateDomainAssociationResult = aws_sdk_amplify.types.create_domain_association_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplify.types.create_domain_association_request.CreateDomainAssociationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.create_domain_association_request.serialize_json(input)
    ).encode()
