"""Generated from Smithy shape ``com.amazonaws.amplify#UpdateWebhook``."""
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.update_webhook_result.UpdateWebhookResult = (
        aws_sdk_amplify.types.update_webhook_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.update_webhook_request.UpdateWebhookRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/webhooks/{webhookId}"
    url = url.replace("{webhookId}", quote(str(input_["webhook_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_amplify.types.update_webhook_request

    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.update_webhook_request.serialize_json(input_)
    ).encode()
...
def update_webhook(
    ...
    aws_sdk_amplify.types.update_webhook_result.UpdateWebhookResult, zapros.Response
]:
