...
def handle_response(
    ...
    out: aws_sdk_amplify.types.list_branches_result.ListBranchesResult = (
        aws_sdk_amplify.types.list_branches_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.list_branches_request.ListBranchesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_branches(
    ...
    aws_sdk_amplify.types.list_branches_result.ListBranchesResult, zapros.Response
]:
