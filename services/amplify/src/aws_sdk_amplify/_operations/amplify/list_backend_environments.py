...
def build_request(
    ...
    input: aws_sdk_amplify.types.list_backend_environments_request.ListBackendEnvironmentsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "environment_name" in input:
        params["environmentName"] = str(input["environment_name"])
