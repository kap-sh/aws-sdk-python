"""Generated from Smithy shape ``com.amazonaws.amplify#ListBackendEnvironments``."""
...
import aws_sdk_amplify.types.backend_environments
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.list_backend_environments_result.ListBackendEnvironmentsResult = aws_sdk_amplify.types.list_backend_environments_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.list_backend_environments_request.ListBackendEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "environment_name" in input_:
        params["environmentName"] = str(input_["environment_name"])
...
async def async_list_backend_environments(
