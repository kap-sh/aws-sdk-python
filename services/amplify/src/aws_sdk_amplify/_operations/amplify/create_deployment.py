"""Generated from Smithy shape ``com.amazonaws.amplify#CreateDeployment``."""
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.create_deployment_result.CreateDeploymentResult = (
        aws_sdk_amplify.types.create_deployment_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplify.types.create_deployment_request.CreateDeploymentRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/apps/{appId}/branches/{branchName}/deployments"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.create_deployment_request.serialize_json(input)
    ).encode()
