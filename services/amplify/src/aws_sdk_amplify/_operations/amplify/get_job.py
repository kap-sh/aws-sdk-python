"""Generated from Smithy shape ``com.amazonaws.amplify#GetJob``."""
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.get_job_result.GetJobResult = (
        aws_sdk_amplify.types.get_job_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplify.types.get_job_request.GetJobRequest,
) -> zapros.Request:
...
def get_job(
    ...
    input: aws_sdk_amplify.types.get_job_request.GetJobRequest,
) -> tuple[aws_sdk_amplify.types.get_job_result.GetJobResult, zapros.Response]:
