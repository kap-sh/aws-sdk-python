"""Generated from Smithy shape ``com.amazonaws.amplify#UpdateApp``."""
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.update_app_result.UpdateAppResult = (
        aws_sdk_amplify.types.update_app_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.update_app_request.UpdateAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/apps/{appId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.update_app_request.serialize_json(input_)
    ).encode()
...
def update_app(
    ...
    input_: aws_sdk_amplify.types.update_app_request.UpdateAppRequest,
) -> tuple[aws_sdk_amplify.types.update_app_result.UpdateAppResult, zapros.Response]:
