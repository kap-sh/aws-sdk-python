"""Generated from Smithy shape ``com.amazonaws.amplify#StartJob``."""
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.start_job_result.StartJobResult = (
        aws_sdk_amplify.types.start_job_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplify.types.start_job_request.StartJobRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/apps/{appId}/branches/{branchName}/jobs"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.start_job_request.serialize_json(input)
    ).encode()
...
def start_job(
    ...
    input: aws_sdk_amplify.types.start_job_request.StartJobRequest,
) -> tuple[aws_sdk_amplify.types.start_job_result.StartJobResult, zapros.Response]:
