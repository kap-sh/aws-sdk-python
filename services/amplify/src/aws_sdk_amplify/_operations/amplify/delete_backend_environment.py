...
def handle_response(
    ...
    out: aws_sdk_amplify.types.delete_backend_environment_result.DeleteBackendEnvironmentResult = aws_sdk_amplify.types.delete_backend_environment_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.delete_backend_environment_request.DeleteBackendEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
