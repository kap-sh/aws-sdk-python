...
def handle_response(
    ...
    out: aws_sdk_amplify.types.stop_job_result.StopJobResult = (
        aws_sdk_amplify.types.stop_job_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.stop_job_request.StopJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def stop_job(
    ...
    input_: aws_sdk_amplify.types.stop_job_request.StopJobRequest,
) -> tuple[aws_sdk_amplify.types.stop_job_result.StopJobResult, zapros.Response]:
