...
def handle_response(
    ...
    out: aws_sdk_amplify.types.get_webhook_result.GetWebhookResult = (
        aws_sdk_amplify.types.get_webhook_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.get_webhook_request.GetWebhookRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_webhook(
    ...
    input_: aws_sdk_amplify.types.get_webhook_request.GetWebhookRequest,
) -> tuple[aws_sdk_amplify.types.get_webhook_result.GetWebhookResult, zapros.Response]:
