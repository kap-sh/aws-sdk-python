...
def handle_response(
    ...
    out: aws_sdk_amplify.types.get_branch_result.GetBranchResult = (
        aws_sdk_amplify.types.get_branch_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.get_branch_request.GetBranchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_branch(
    ...
    input_: aws_sdk_amplify.types.get_branch_request.GetBranchRequest,
) -> tuple[aws_sdk_amplify.types.get_branch_result.GetBranchResult, zapros.Response]:
