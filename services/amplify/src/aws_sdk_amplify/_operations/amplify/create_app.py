...
def handle_response(
    ...
    out: aws_sdk_amplify.types.create_app_result.CreateAppResult = (
        aws_sdk_amplify.types.create_app_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.create_app_request.CreateAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.create_app_request.serialize_json(input_)
    ).encode()
...
def create_app(
    ...
    input_: aws_sdk_amplify.types.create_app_request.CreateAppRequest,
) -> tuple[aws_sdk_amplify.types.create_app_result.CreateAppResult, zapros.Response]:
