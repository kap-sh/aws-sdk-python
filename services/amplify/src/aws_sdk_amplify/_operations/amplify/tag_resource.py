"""Generated from Smithy shape ``com.amazonaws.amplify#TagResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            import aws_sdk_amplify.errors.resource_not_found_exception

            raise aws_sdk_amplify.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_amplify.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
