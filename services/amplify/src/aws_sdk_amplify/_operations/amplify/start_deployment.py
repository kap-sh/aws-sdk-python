"""Generated from Smithy shape ``com.amazonaws.amplify#StartDeployment``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            import aws_sdk_amplify.errors.limit_exceeded_exception

            raise aws_sdk_amplify.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.start_deployment_result.StartDeploymentResult = (
        aws_sdk_amplify.types.start_deployment_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplify.types.start_deployment_request.StartDeploymentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.start_deployment_request.serialize_json(input)
    ).encode()
...
def start_deployment(
    ...
    aws_sdk_amplify.types.start_deployment_result.StartDeploymentResult, zapros.Response
]:
