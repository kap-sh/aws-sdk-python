...
def handle_response(
    ...
    out: aws_sdk_amplify.types.create_branch_result.CreateBranchResult = (
        aws_sdk_amplify.types.create_branch_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.create_branch_request.CreateBranchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.create_branch_request.serialize_json(input_)
    ).encode()
...
def create_branch(
    ...
    aws_sdk_amplify.types.create_branch_result.CreateBranchResult, zapros.Response
]:
