...
def build_request(
    ...
    input: aws_sdk_amplify.types.update_domain_association_request.UpdateDomainAssociationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.update_domain_association_request.serialize_json(input)
    ).encode()
