...
def handle_response(
    ...
    out: aws_sdk_amplify.types.update_domain_association_result.UpdateDomainAssociationResult = aws_sdk_amplify.types.update_domain_association_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.update_domain_association_request.UpdateDomainAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.update_domain_association_request.serialize_json(input_)
    ).encode()
