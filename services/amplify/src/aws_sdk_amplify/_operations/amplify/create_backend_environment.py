"""Generated from Smithy shape ``com.amazonaws.amplify#CreateBackendEnvironment``."""
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.create_backend_environment_result.CreateBackendEnvironmentResult = aws_sdk_amplify.types.create_backend_environment_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.create_backend_environment_request.CreateBackendEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/apps/{appId}/backendenvironments"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.create_backend_environment_request.serialize_json(input_)
    ).encode()
...
async def async_create_backend_environment(
