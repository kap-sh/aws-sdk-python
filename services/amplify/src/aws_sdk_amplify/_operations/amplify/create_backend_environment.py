...
def build_request(
    ...
    input: aws_sdk_amplify.types.create_backend_environment_request.CreateBackendEnvironmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplify.types.create_backend_environment_request.serialize_json(input)
    ).encode()
