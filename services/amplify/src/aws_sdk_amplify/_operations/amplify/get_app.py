...
def handle_response(
    ...
    out: aws_sdk_amplify.types.get_app_result.GetAppResult = (
        aws_sdk_amplify.types.get_app_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplify.types.get_app_request.GetAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_app(
    ...
    input_: aws_sdk_amplify.types.get_app_request.GetAppRequest,
) -> tuple[aws_sdk_amplify.types.get_app_result.GetAppResult, zapros.Response]:
