"""Generated from Smithy shape ``com.amazonaws.amplify#DeleteBranch``."""
...
def handle_response(
    ...
    out: aws_sdk_amplify.types.delete_branch_result.DeleteBranchResult = (
        aws_sdk_amplify.types.delete_branch_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplify.types.delete_branch_request.DeleteBranchRequest,
) -> zapros.Request:
...
def delete_branch(
    ...
    aws_sdk_amplify.types.delete_branch_result.DeleteBranchResult, zapros.Response
]:
