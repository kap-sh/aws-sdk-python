...
if TYPE_CHECKING:
    ...
    import aws_sdk_amplify.types.waf_status
...
def serialize_json(value: WafConfiguration) -> dict:
    ...
    if "waf_status" in value:
        ...
        out["wafStatus"] = aws_sdk_amplify.types.waf_status.serialize_json(
            value["waf_status"]
        )
...
def deserialize_json(data: dict) -> WafConfiguration:
    ...
    if "wafStatus" in data:
        ...
        out["waf_status"] = aws_sdk_amplify.types.waf_status.deserialize_json(
            data["wafStatus"]
        )
