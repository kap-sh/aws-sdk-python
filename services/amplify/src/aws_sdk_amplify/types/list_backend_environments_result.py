...
class ListBackendEnvironmentsResult(TypedDict):
    backend_environments: (
        "aws_sdk_amplify.types.backend_environments.BackendEnvironments"
    )
...
def serialize_json(value: ListBackendEnvironmentsResult) -> dict:
    ...
    out["backendEnvironments"] = (
        aws_sdk_amplify.types.backend_environments.serialize_json(
...
def deserialize_json(data: dict) -> ListBackendEnvironmentsResult:
    ...
    if "backendEnvironments" in data:
        ...
        out["backend_environments"] = (
            aws_sdk_amplify.types.backend_environments.deserialize_json(
