...
if TYPE_CHECKING:
    import aws_sdk_amplify.types.env_key
    import aws_sdk_amplify.types.env_value

EnvironmentVariables: TypeAlias = dict[
    "aws_sdk_amplify.types.env_key.EnvKey", "aws_sdk_amplify.types.env_value.EnvValue"
]
