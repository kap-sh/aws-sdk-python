"""Generated from Smithy shape ``com.amazonaws.amplify#LimitExceededException``."""

from typing import TYPE_CHECKING

from typing_extensions import NotRequired, TypedDict

from capo_amplify.errors import ServiceError
...
class LimitExceededException_(TypedDict, closed=True):
    message: NotRequired["capo_amplify.types.error_message.ErrorMessage"]
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.amplify#LimitExceededException``."""
