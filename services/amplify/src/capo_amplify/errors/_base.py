...
class AmplifyError(Exception):
    """Base class for all Amplify service errors."""


class ServiceError(AmplifyError):
...
class SerializationError(AmplifyError):
    """Raised when a value cannot be serialized."""


class DeserializationError(AmplifyError):
...
class WaiterFailedError(AmplifyError):
...
class WaiterTimeoutError(AmplifyError):
