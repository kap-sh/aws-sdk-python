"""Generated from Smithy shape ``com.amazonaws.amplify#UpdateDomainAssociation``."""
...
def handle_response(
    ...
    out: capo_amplify.types.update_domain_association_result.UpdateDomainAssociationResult = capo_amplify.types.update_domain_association_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/apps/{appId}/domains/{domainName}"
    ...
    body: bytes | None = json.dumps(
        capo_amplify.types.update_domain_association_request.serialize_json(input_)
    ).encode()
