"""Generated from Smithy shape ``com.amazonaws.amplify#GetBranch``."""
...
def handle_response(
    ...
    out: capo_amplify.types.get_branch_result.GetBranchResult = (
        capo_amplify.types.get_branch_result.deserialize_json(
...
def get_branch(
    ...
    input_: capo_amplify.types.get_branch_request.GetBranchRequest,
) -> tuple[capo_amplify.types.get_branch_result.GetBranchResult, zapros.Response]:
