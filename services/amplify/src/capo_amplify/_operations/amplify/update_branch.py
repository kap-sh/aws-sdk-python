...
def handle_response(
    ...
    out: capo_amplify.types.update_branch_result.UpdateBranchResult = (
        capo_amplify.types.update_branch_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_amplify.types.update_branch_request.serialize_json(input_)
    ).encode()
...
def update_branch(
    ...
    input_: capo_amplify.types.update_branch_request.UpdateBranchRequest,
) -> tuple[capo_amplify.types.update_branch_result.UpdateBranchResult, zapros.Response]:
