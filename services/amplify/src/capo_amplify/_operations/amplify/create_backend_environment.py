...
def handle_response(
    ...
    out: capo_amplify.types.create_backend_environment_result.CreateBackendEnvironmentResult = capo_amplify.types.create_backend_environment_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_amplify.types.create_backend_environment_request.serialize_json(input_)
    ).encode()
