...
def handle_response(
    ...
    out: capo_amplify.types.generate_access_logs_result.GenerateAccessLogsResult = (
        capo_amplify.types.generate_access_logs_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_amplify.types.generate_access_logs_request.serialize_json(input_)
    ).encode()
