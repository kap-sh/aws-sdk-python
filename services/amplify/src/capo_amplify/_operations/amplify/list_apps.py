...
def handle_response(
    ...
    out: capo_amplify.types.list_apps_result.ListAppsResult = (
        capo_amplify.types.list_apps_result.deserialize_json(
...
def list_apps(
    ...
    input_: capo_amplify.types.list_apps_request.ListAppsRequest,
) -> tuple[capo_amplify.types.list_apps_result.ListAppsResult, zapros.Response]:
