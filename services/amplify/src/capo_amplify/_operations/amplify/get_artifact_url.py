"""Generated from Smithy shape ``com.amazonaws.amplify#GetArtifactUrl``."""
...
def handle_response(
    ...
    out: capo_amplify.types.get_artifact_url_result.GetArtifactUrlResult = (
        capo_amplify.types.get_artifact_url_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/artifacts/{artifactId}"
    url = url.replace("{artifactId}", quote(str(input_["artifact_id"]), safe=""))
    params: dict[str, str] = {}
...
def get_artifact_url(
    ...
    capo_amplify.types.get_artifact_url_result.GetArtifactUrlResult, zapros.Response
]:
...
async def async_get_artifact_url(
