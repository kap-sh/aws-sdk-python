"""Generated from Smithy shape ``com.amazonaws.amplify#UntagResource``."""
...
import capo_amplify.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_amplify.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_amplify.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_amplify.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
