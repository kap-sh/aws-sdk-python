...
def handle_response(
    ...
    out: capo_amplify.types.list_jobs_result.ListJobsResult = (
        capo_amplify.types.list_jobs_result.deserialize_json(
...
def list_jobs(
    ...
    input_: capo_amplify.types.list_jobs_request.ListJobsRequest,
) -> tuple[capo_amplify.types.list_jobs_result.ListJobsResult, zapros.Response]:
