"""Generated from Smithy shape ``com.amazonaws.amplify#GetApp``."""
...
def handle_response(
    ...
    out: capo_amplify.types.get_app_result.GetAppResult = (
        capo_amplify.types.get_app_result.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_amplify.types.get_app_result.GetAppResult = (
        capo_amplify.types.get_app_result.deserialize_json(
...
def build_request(
    ...
    input_: capo_amplify.types.get_app_request.GetAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_app(
    options: OperationOptions, input_: capo_amplify.types.get_app_request.GetAppRequest
) -> tuple[capo_amplify.types.get_app_result.GetAppResult, zapros.Response]:
