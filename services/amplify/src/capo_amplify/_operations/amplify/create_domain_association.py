"""Generated from Smithy shape ``com.amazonaws.amplify#CreateDomainAssociation``."""
...
def handle_response(
    ...
    out: capo_amplify.types.create_domain_association_result.CreateDomainAssociationResult = capo_amplify.types.create_domain_association_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_amplify.types.create_domain_association_request.serialize_json(input_)
    ).encode()
...
async def async_create_domain_association(
