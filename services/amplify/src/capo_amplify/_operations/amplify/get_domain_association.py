"""Generated from Smithy shape ``com.amazonaws.amplify#GetDomainAssociation``."""
...
def handle_response(
    ...
    out: capo_amplify.types.get_domain_association_result.GetDomainAssociationResult = (
        capo_amplify.types.get_domain_association_result.deserialize_json(
...
async def async_get_domain_association(
