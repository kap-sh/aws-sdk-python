"""Generated from Smithy shape ``com.amazonaws.amplify#GetBackendEnvironment``."""
...
def handle_response(
    ...
    out: capo_amplify.types.get_backend_environment_result.GetBackendEnvironmentResult = capo_amplify.types.get_backend_environment_result.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/apps/{appId}/backendenvironments/{environmentName}"
    )
...
async def async_get_backend_environment(
