...
def handle_response(
    ...
    out: capo_amplify.types.start_job_result.StartJobResult = (
        capo_amplify.types.start_job_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_amplify.types.start_job_request.serialize_json(input_)
    ).encode()
...
def start_job(
    ...
    input_: capo_amplify.types.start_job_request.StartJobRequest,
) -> tuple[capo_amplify.types.start_job_result.StartJobResult, zapros.Response]:
