...
def handle_response(
    ...
    out: capo_amplify.types.update_app_result.UpdateAppResult = (
        capo_amplify.types.update_app_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_amplify.types.update_app_request.serialize_json(input_)
    ).encode()
...
def update_app(
    ...
    input_: capo_amplify.types.update_app_request.UpdateAppRequest,
) -> tuple[capo_amplify.types.update_app_result.UpdateAppResult, zapros.Response]:
