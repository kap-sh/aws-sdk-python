...
def handle_response(
    ...
    out: capo_amplify.types.delete_branch_result.DeleteBranchResult = (
        capo_amplify.types.delete_branch_result.deserialize_json(
...
def delete_branch(
    ...
    input_: capo_amplify.types.delete_branch_request.DeleteBranchRequest,
) -> tuple[capo_amplify.types.delete_branch_result.DeleteBranchResult, zapros.Response]:
