...
from ._services.async_inspector2 import AsyncInspector2Client as AsyncInspector2Client
from ._services.inspector2 import Inspector2Client as Inspector2Client
