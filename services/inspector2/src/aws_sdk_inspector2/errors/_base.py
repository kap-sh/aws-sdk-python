...
class Inspector2Error(Exception):
    """Base class for all Inspector2 service errors."""


class ServiceError(Inspector2Error):
...
class SerializationError(Inspector2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(Inspector2Error):
...
class WaiterFailedError(Inspector2Error):
...
class WaiterTimeoutError(Inspector2Error):
