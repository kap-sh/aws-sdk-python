...
if TYPE_CHECKING:
    ...
    import aws_sdk_inspector2.types.architecture_list
    import aws_sdk_inspector2.types.execution_role_arn
    import aws_sdk_inspector2.types.function_name
    import aws_sdk_inspector2.types.lambda_vpc_config
    import aws_sdk_inspector2.types.layer_list
    import aws_sdk_inspector2.types.non_empty_string
    import aws_sdk_inspector2.types.package_type
    import aws_sdk_inspector2.types.runtime
    import aws_sdk_inspector2.types.version


class AwsLambdaFunctionDetails(TypedDict):
    function_name: "aws_sdk_inspector2.types.function_name.FunctionName"
    """<p>The name of the Amazon Web Services Lambda function.</p>"""
    runtime: "aws_sdk_inspector2.types.runtime.Runtime"
    """<p>The runtime environment for the Amazon Web Services Lambda function.</p>"""
    code_sha256: "aws_sdk_inspector2.types.non_empty_string.NonEmptyString"
    """<p>The SHA256 hash of the Amazon Web Services Lambda function's deployment package.</p>"""
    version: "aws_sdk_inspector2.types.version.Version"
    ...
    package_type: NotRequired["aws_sdk_inspector2.types.package_type.PackageType"]
    """<p>The type of deployment package. Set to <code>Image</code> for container image and set <code>Zip</code> for .zip file archive.</p>"""
    architectures: NotRequired[
        "aws_sdk_inspector2.types.architecture_list.ArchitectureList"
    ]
...
def serialize_json(value: AwsLambdaFunctionDetails) -> dict:
    ...
    if "layers" in value:
        ...
        out["layers"] = aws_sdk_inspector2.types.layer_list.serialize_json(
            value["layers"]
        )
    if "vpc_config" in value:
        import aws_sdk_inspector2.types.lambda_vpc_config

        out["vpcConfig"] = aws_sdk_inspector2.types.lambda_vpc_config.serialize_json(
            value["vpc_config"]
        )
    ...
    if "architectures" in value:
        ...
        out["architectures"] = (
            aws_sdk_inspector2.types.architecture_list.serialize_json(
                value["architectures"]
            )
        )
...
def deserialize_json(data: dict) -> AwsLambdaFunctionDetails:
    ...
    if "layers" in data:
        ...
        out["layers"] = aws_sdk_inspector2.types.layer_list.deserialize_json(
            data["layers"]
        )
    if "vpcConfig" in data:
        import aws_sdk_inspector2.types.lambda_vpc_config

        out["vpc_config"] = aws_sdk_inspector2.types.lambda_vpc_config.deserialize_json(
            data["vpcConfig"]
        )
    ...
    if "architectures" in data:
        ...
        out["architectures"] = (
            aws_sdk_inspector2.types.architecture_list.deserialize_json(
                data["architectures"]
            )
        )
