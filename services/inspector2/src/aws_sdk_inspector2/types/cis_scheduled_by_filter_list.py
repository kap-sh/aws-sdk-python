"""Generated from Smithy shape ``com.amazonaws.inspector2#CisScheduledByFilterList``."""
...
CisScheduledByFilterList: TypeAlias = list[
    "aws_sdk_inspector2.types.cis_string_filter.CisStringFilter"
]


# --- restJson1 ser/de ---
def serialize_json(value: CisScheduledByFilterList) -> list:
    import aws_sdk_inspector2.types.cis_string_filter
...
def deserialize_json(data: list) -> CisScheduledByFilterList:
    import aws_sdk_inspector2.types.cis_string_filter

    out: CisScheduledByFilterList = []
    for item in data:
