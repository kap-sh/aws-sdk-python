...
if TYPE_CHECKING:
    import aws_sdk_inspector2.types.code_security_scan_configuration_summaries
    import aws_sdk_inspector2.types.next_token


class ListCodeSecurityScanConfigurationsResponse(TypedDict):
    configurations: NotRequired[
        "aws_sdk_inspector2.types.code_security_scan_configuration_summaries.CodeSecurityScanConfigurationSummaries"
    ]
...
def serialize_json(value: ListCodeSecurityScanConfigurationsResponse) -> dict:
    ...
    if "configurations" in value:
        ...
        out["configurations"] = (
            aws_sdk_inspector2.types.code_security_scan_configuration_summaries.serialize_json(
...
def deserialize_json(data: dict) -> ListCodeSecurityScanConfigurationsResponse:
    ...
    if "configurations" in data:
        ...
        out["configurations"] = (
            aws_sdk_inspector2.types.code_security_scan_configuration_summaries.deserialize_json(
                data["configurations"]
            )
        )
