...
class LambdaFunctionAggregationResponse(TypedDict):
    ...
    lambda_tags: NotRequired["aws_sdk_inspector2.types.tag_map.TagMap"]
...
def serialize_json(value: LambdaFunctionAggregationResponse) -> dict:
    ...
    if "lambda_tags" in value:
        ...
        out["lambdaTags"] = aws_sdk_inspector2.types.tag_map.serialize_json(
            value["lambda_tags"]
        )
...
def deserialize_json(data: dict) -> LambdaFunctionAggregationResponse:
    ...
    if "lambdaTags" in data:
        ...
        out["lambda_tags"] = aws_sdk_inspector2.types.tag_map.deserialize_json(
            data["lambdaTags"]
        )
