...
class AwsEcrContainerAggregationResponse(TypedDict):
...
def serialize_json(value: AwsEcrContainerAggregationResponse) -> dict:
    ...
    if "image_tags" in value:
        import aws_sdk_inspector2.types.string_list
        out["imageTags"] = aws_sdk_inspector2.types.string_list.serialize_json(value["image_tags"])
...
def deserialize_json(data: dict) -> AwsEcrContainerAggregationResponse:
    ...
    if "resourceId" in data:
        ...
        raise DeserializationError("AwsEcrContainerAggregationResponse.resource_id required")
    if "imageSha" in data:
    ...
    if "imageTags" in data:
        import aws_sdk_inspector2.types.string_list
        out["image_tags"] = aws_sdk_inspector2.types.string_list.deserialize_json(data["imageTags"])
