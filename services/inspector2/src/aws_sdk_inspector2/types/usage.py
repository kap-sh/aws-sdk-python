...
if TYPE_CHECKING:
    ...
    import aws_sdk_inspector2.types.monthly_cost_estimate
    import aws_sdk_inspector2.types.usage_type
...
class Usage(TypedDict, closed=True):
    ...
    estimated_monthly_cost: (
        "aws_sdk_inspector2.types.monthly_cost_estimate.MonthlyCostEstimate"
    )
    """<p>The estimated monthly cost of Amazon Inspector.</p>"""
    currency: NotRequired["aws_sdk_inspector2.types.currency.Currency"]
