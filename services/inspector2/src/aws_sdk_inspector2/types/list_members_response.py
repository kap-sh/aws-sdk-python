...
class ListMembersResponse(TypedDict):
    members: NotRequired["aws_sdk_inspector2.types.member_list.MemberList"]
...
def serialize_json(value: ListMembersResponse) -> dict:
    ...
    if "members" in value:
        ...
        out["members"] = aws_sdk_inspector2.types.member_list.serialize_json(
            value["members"]
        )
...
def deserialize_json(data: dict) -> ListMembersResponse:
    ...
    if "members" in data:
        ...
        out["members"] = aws_sdk_inspector2.types.member_list.deserialize_json(
            data["members"]
        )
