...
class GetSbomExportResponse(TypedDict):
    ...
    format: NotRequired["aws_sdk_inspector2.types.sbom_report_format.SbomReportFormat"]
    ...
    s3_destination: NotRequired["aws_sdk_inspector2.types.destination.Destination"]
