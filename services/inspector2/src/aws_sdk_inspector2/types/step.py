...
if TYPE_CHECKING:
    import aws_sdk_inspector2.types.component
    import aws_sdk_inspector2.types.component_arn
    import aws_sdk_inspector2.types.component_type


class Step(TypedDict):
    component_id: "aws_sdk_inspector2.types.component.Component"
    """<p>The component ID.</p>"""
    component_type: "aws_sdk_inspector2.types.component_type.ComponentType"
    """<p>The component type.</p>"""
    component_arn: NotRequired["aws_sdk_inspector2.types.component_arn.ComponentArn"]
