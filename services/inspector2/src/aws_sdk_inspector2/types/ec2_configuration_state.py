...
class Ec2ConfigurationState(TypedDict):
    ...
    vm_scanner_state: NotRequired[
        "aws_sdk_inspector2.types.vm_scanner_state.VMScannerState"
    ]
...
def serialize_json(value: Ec2ConfigurationState) -> dict:
    ...
    if "scan_mode_state" in value:
        ...
        out["scanModeState"] = (
            aws_sdk_inspector2.types.ec2_scan_mode_state.serialize_json(
    ...
    if "vm_scanner_state" in value:
        ...
        out["vmScannerState"] = (
            aws_sdk_inspector2.types.vm_scanner_state.serialize_json(
...
def deserialize_json(data: dict) -> Ec2ConfigurationState:
    ...
    if "scanModeState" in data:
        ...
        out["scan_mode_state"] = (
            aws_sdk_inspector2.types.ec2_scan_mode_state.deserialize_json(
                data["scanModeState"]
            )
        )
    if "vmScannerState" in data:
        ...
        out["vm_scanner_state"] = (
            aws_sdk_inspector2.types.vm_scanner_state.deserialize_json(
                data["vmScannerState"]
            )
        )
    return out
