...
if TYPE_CHECKING:
    ...
    import aws_sdk_inspector2.types.cis_finding_arn
...
class CisScanResultDetails(TypedDict):
    ...
    status: NotRequired["aws_sdk_inspector2.types.cis_finding_status.CisFindingStatus"]
    ...
    finding_arn: NotRequired["aws_sdk_inspector2.types.cis_finding_arn.CisFindingArn"]
...
def serialize_json(value: CisScanResultDetails) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = aws_sdk_inspector2.types.cis_finding_status.serialize_json(
            value["status"]
        )
...
def deserialize_json(data: dict) -> CisScanResultDetails:
    ...
    if "status" in data:
        ...
        out["status"] = aws_sdk_inspector2.types.cis_finding_status.deserialize_json(
            data["status"]
        )
