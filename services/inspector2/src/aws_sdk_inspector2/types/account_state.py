...
def serialize_json(value: AccountState) -> dict:
    ...
    import aws_sdk_inspector2.types.resource_state
    out["resourceState"] = aws_sdk_inspector2.types.resource_state.serialize_json(value["resource_state"])
    return out
...
def deserialize_json(data: dict) -> AccountState:
    ...
    if "resourceState" in data:
        import aws_sdk_inspector2.types.resource_state
        out["resource_state"] = aws_sdk_inspector2.types.resource_state.deserialize_json(data["resourceState"])
    else:
