...
AssociateConfigurationRequestList: TypeAlias = list[
    "aws_sdk_inspector2.types.associate_configuration_request.AssociateConfigurationRequest"
]
...
def serialize_json(value: AssociateConfigurationRequestList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_inspector2.types.associate_configuration_request.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> AssociateConfigurationRequestList:
    ...
    for item in data:
        out.append(
            aws_sdk_inspector2.types.associate_configuration_request.deserialize_json(
                item
            )
        )
    return out
