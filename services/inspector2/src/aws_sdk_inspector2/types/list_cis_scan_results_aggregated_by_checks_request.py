"""Generated from Smithy shape ``com.amazonaws.inspector2#ListCisScanResultsAggregatedByChecksRequest``."""
...
class ListCisScanResultsAggregatedByChecksRequest(TypedDict, closed=True):
    ...
    sort_by: "aws_sdk_inspector2.types.cis_scan_results_aggregated_by_checks_sort_by.CisScanResultsAggregatedByChecksSortBy"
...
# --- restJson1 ser/de ---
def serialize_json(value: ListCisScanResultsAggregatedByChecksRequest) -> dict:
    out: dict = {}
    ...
    if "filter_criteria" in value:
        ...
        out["filterCriteria"] = (
            aws_sdk_inspector2.types.cis_scan_results_aggregated_by_checks_filter_criteria.serialize_json(
    ...
    out["sortBy"] = (
        aws_sdk_inspector2.types.cis_scan_results_aggregated_by_checks_sort_by.serialize_json(
...
def deserialize_json(data: dict) -> ListCisScanResultsAggregatedByChecksRequest:
    ...
    if "filterCriteria" in data:
        ...
        out["filter_criteria"] = (
            aws_sdk_inspector2.types.cis_scan_results_aggregated_by_checks_filter_criteria.deserialize_json(
                data["filterCriteria"]
            )
        )
    if "sortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_inspector2.types.cis_scan_results_aggregated_by_checks_sort_by.deserialize_json(
                data["sortBy"]
            )
        )
    else:
