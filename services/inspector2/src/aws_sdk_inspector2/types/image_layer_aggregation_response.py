...
class ImageLayerAggregationResponse(TypedDict):
    repository: "aws_sdk_inspector2.types.non_empty_string.NonEmptyString"
    ...
    layer_hash: "aws_sdk_inspector2.types.non_empty_string.NonEmptyString"
    """<p>The layer hash.</p>"""
