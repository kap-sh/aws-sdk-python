...
if TYPE_CHECKING:
    ...
    import aws_sdk_inspector2.types.permissions


class ListAccountPermissionsResponse(TypedDict):
    permissions: "aws_sdk_inspector2.types.permissions.Permissions"
...
def serialize_json(value: ListAccountPermissionsResponse) -> dict:
    ...
    out["permissions"] = aws_sdk_inspector2.types.permissions.serialize_json(
        value["permissions"]
    )
...
def deserialize_json(data: dict) -> ListAccountPermissionsResponse:
    ...
    if "permissions" in data:
        ...
        out["permissions"] = aws_sdk_inspector2.types.permissions.deserialize_json(
            data["permissions"]
        )
    else:
