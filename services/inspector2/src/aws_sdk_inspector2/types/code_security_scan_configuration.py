...
if TYPE_CHECKING:
    import aws_sdk_inspector2.types.continuous_integration_scan_configuration
    import aws_sdk_inspector2.types.periodic_scan_configuration
...
class CodeSecurityScanConfiguration(TypedDict):
    ...
    continuous_integration_scan_configuration: NotRequired[
        "aws_sdk_inspector2.types.continuous_integration_scan_configuration.ContinuousIntegrationScanConfiguration"
    ]
...
def serialize_json(value: CodeSecurityScanConfiguration) -> dict:
    ...
    if "periodic_scan_configuration" in value:
        ...
        out["periodicScanConfiguration"] = (
            aws_sdk_inspector2.types.periodic_scan_configuration.serialize_json(
    ...
    if "continuous_integration_scan_configuration" in value:
        ...
        out["continuousIntegrationScanConfiguration"] = (
            aws_sdk_inspector2.types.continuous_integration_scan_configuration.serialize_json(
...
def deserialize_json(data: dict) -> CodeSecurityScanConfiguration:
    ...
    if "periodicScanConfiguration" in data:
        ...
        out["periodic_scan_configuration"] = (
            aws_sdk_inspector2.types.periodic_scan_configuration.deserialize_json(
    ...
    if "continuousIntegrationScanConfiguration" in data:
        ...
        out["continuous_integration_scan_configuration"] = (
            aws_sdk_inspector2.types.continuous_integration_scan_configuration.deserialize_json(
