...
if TYPE_CHECKING:
    ...
    import aws_sdk_inspector2.types.evidence_rule
...
class Evidence(TypedDict, closed=True):
    ...
    evidence_detail: NotRequired[
        "aws_sdk_inspector2.types.evidence_detail.EvidenceDetail"
    ]
    """<p>The evidence details.</p>"""
    severity: NotRequired["aws_sdk_inspector2.types.evidence_severity.EvidenceSeverity"]
