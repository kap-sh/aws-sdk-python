...
class AwsEcrContainerImageDetails(TypedDict):
    ...
    pushed_at: NotRequired["aws_sdk_inspector2.types.date_time_timestamp.DateTimeTimestamp"]
    ...
    architecture: NotRequired["aws_sdk_inspector2.types.non_empty_string.NonEmptyString"]
    ...
    last_in_use_at: NotRequired["aws_sdk_inspector2.types.date_time_timestamp.DateTimeTimestamp"]
...
def serialize_json(value: AwsEcrContainerImageDetails) -> dict:
    ...
    if "image_tags" in value:
        import aws_sdk_inspector2.types.image_tag_list
        out["imageTags"] = aws_sdk_inspector2.types.image_tag_list.serialize_json(value["image_tags"])
    if "pushed_at" in value:
        import aws_sdk_inspector2.types.date_time_timestamp
        out["pushedAt"] = aws_sdk_inspector2.types.date_time_timestamp.serialize_json(value["pushed_at"])
    if "author" in value:
    ...
    if "last_in_use_at" in value:
        import aws_sdk_inspector2.types.date_time_timestamp
        out["lastInUseAt"] = aws_sdk_inspector2.types.date_time_timestamp.serialize_json(value["last_in_use_at"])
...
def deserialize_json(data: dict) -> AwsEcrContainerImageDetails:
    ...
    if "repositoryName" in data:
        ...
        raise DeserializationError("AwsEcrContainerImageDetails.repository_name required")
    if "imageTags" in data:
        import aws_sdk_inspector2.types.image_tag_list
        out["image_tags"] = aws_sdk_inspector2.types.image_tag_list.deserialize_json(data["imageTags"])
    if "pushedAt" in data:
        import aws_sdk_inspector2.types.date_time_timestamp
        out["pushed_at"] = aws_sdk_inspector2.types.date_time_timestamp.deserialize_json(data["pushedAt"])
    if "author" in data:
    ...
    if "lastInUseAt" in data:
        import aws_sdk_inspector2.types.date_time_timestamp
        out["last_in_use_at"] = aws_sdk_inspector2.types.date_time_timestamp.deserialize_json(data["lastInUseAt"])
