...
if TYPE_CHECKING:
    import aws_sdk_inspector2.types.string_comparison
    import aws_sdk_inspector2.types.string_input


class StringFilter(TypedDict, closed=True):
    comparison: "aws_sdk_inspector2.types.string_comparison.StringComparison"
    """<p>The operator to use when comparing values in the filter.</p>"""
    value: "aws_sdk_inspector2.types.string_input.StringInput"
