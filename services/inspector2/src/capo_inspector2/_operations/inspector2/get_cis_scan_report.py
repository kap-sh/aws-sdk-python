"""Generated from Smithy shape ``com.amazonaws.inspector2#GetCisScanReport``."""
...
def handle_response(
    ...
    out: capo_inspector2.types.get_cis_scan_report_response.GetCisScanReportResponse = (
        capo_inspector2.types.get_cis_scan_report_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.get_cis_scan_report_request.serialize_json(input_)
    ).encode()
...
async def async_get_cis_scan_report(
