...
def handle_response(
    ...
    out: capo_inspector2.types.get_member_response.GetMemberResponse = (
        capo_inspector2.types.get_member_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.get_member_request.serialize_json(input_)
    ).encode()
...
def get_member(
    ...
    capo_inspector2.types.get_member_response.GetMemberResponse, zapros.Response
]:
