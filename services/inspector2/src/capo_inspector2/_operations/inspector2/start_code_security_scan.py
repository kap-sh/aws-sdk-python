"""Generated from Smithy shape ``com.amazonaws.inspector2#StartCodeSecurityScan``."""
...
def handle_response(
    ...
    out: capo_inspector2.types.start_code_security_scan_response.StartCodeSecurityScanResponse = capo_inspector2.types.start_code_security_scan_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.start_code_security_scan_request.serialize_json(input_)
    ).encode()
...
async def async_start_code_security_scan(
