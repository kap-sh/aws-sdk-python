...
def handle_response(
    ...
    out: capo_inspector2.types.update_filter_response.UpdateFilterResponse = (
        capo_inspector2.types.update_filter_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.update_filter_request.serialize_json(input_)
    ).encode()
...
def update_filter(
    ...
    capo_inspector2.types.update_filter_response.UpdateFilterResponse, zapros.Response
]:
