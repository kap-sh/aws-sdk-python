...
def handle_response(
    ...
    out: capo_inspector2.types.update_org_ec2_deep_inspection_configuration_response.UpdateOrgEc2DeepInspectionConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.update_org_ec2_deep_inspection_configuration_request.serialize_json(
            input_
        )
    ).encode()
