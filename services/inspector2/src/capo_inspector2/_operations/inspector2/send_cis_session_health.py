...
def handle_response(
    ...
    out: capo_inspector2.types.send_cis_session_health_response.SendCisSessionHealthResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.send_cis_session_health_request.serialize_json(input_)
    ).encode()
