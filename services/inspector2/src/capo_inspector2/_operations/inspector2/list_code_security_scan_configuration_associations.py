...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_inspector2.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_inspector2.types.list_code_security_scan_configuration_associations_response.ListCodeSecurityScanConfigurationAssociationsResponse = capo_inspector2.types.list_code_security_scan_configuration_associations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.list_code_security_scan_configuration_associations_request.serialize_json(
            input_
        )
    ).encode()
