"""Generated from Smithy shape ``com.amazonaws.inspector2#GetEc2DeepInspectionConfiguration``."""
...
def handle_response(
    ...
    out: capo_inspector2.types.get_ec2_deep_inspection_configuration_response.GetEc2DeepInspectionConfigurationResponse = capo_inspector2.types.get_ec2_deep_inspection_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ec2deepinspectionconfiguration/get"
    params: dict[str, str] = {}
...
async def async_get_ec2_deep_inspection_configuration(
