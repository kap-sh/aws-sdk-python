...
import capo_inspector2.errors.bad_request_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BadRequestException":
            raise capo_inspector2.errors.bad_request_exception.BadRequestException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_inspector2.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_inspector2.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
