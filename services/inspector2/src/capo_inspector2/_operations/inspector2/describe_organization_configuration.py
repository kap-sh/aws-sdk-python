"""Generated from Smithy shape ``com.amazonaws.inspector2#DescribeOrganizationConfiguration``."""
...
def handle_response(
    ...
    out: capo_inspector2.types.describe_organization_configuration_response.DescribeOrganizationConfigurationResponse = capo_inspector2.types.describe_organization_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/organizationconfiguration/describe"
    params: dict[str, str] = {}
