...
def handle_response(
    ...
    out: capo_inspector2.types.get_findings_report_status_response.GetFindingsReportStatusResponse = capo_inspector2.types.get_findings_report_status_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.get_findings_report_status_request.serialize_json(input_)
    ).encode()
