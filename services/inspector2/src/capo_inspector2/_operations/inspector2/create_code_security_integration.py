...
import capo_inspector2.errors.conflict_exception
import capo_inspector2.errors.internal_server_exception
import capo_inspector2.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_inspector2.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_inspector2.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_inspector2.types.create_code_security_integration_response.CreateCodeSecurityIntegrationResponse = capo_inspector2.types.create_code_security_integration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.create_code_security_integration_request.serialize_json(
            input_
        )
    ).encode()
