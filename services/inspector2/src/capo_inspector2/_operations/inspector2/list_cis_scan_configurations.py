...
def handle_response(
    ...
    out: capo_inspector2.types.list_cis_scan_configurations_response.ListCisScanConfigurationsResponse = capo_inspector2.types.list_cis_scan_configurations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.list_cis_scan_configurations_request.serialize_json(
            input_
        )
    ).encode()
