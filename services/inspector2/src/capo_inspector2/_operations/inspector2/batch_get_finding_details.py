"""Generated from Smithy shape ``com.amazonaws.inspector2#BatchGetFindingDetails``."""
...
def handle_response(
    ...
    out: capo_inspector2.types.batch_get_finding_details_response.BatchGetFindingDetailsResponse = capo_inspector2.types.batch_get_finding_details_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.batch_get_finding_details_request.serialize_json(input_)
    ).encode()
...
async def async_batch_get_finding_details(
