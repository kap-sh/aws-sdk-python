...
def handle_response(
    ...
    out: capo_inspector2.types.get_code_security_scan_configuration_response.GetCodeSecurityScanConfigurationResponse = capo_inspector2.types.get_code_security_scan_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.get_code_security_scan_configuration_request.serialize_json(
            input_
        )
    ).encode()
