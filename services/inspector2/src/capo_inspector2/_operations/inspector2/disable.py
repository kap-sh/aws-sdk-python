...
def handle_response(
    ...
    out: capo_inspector2.types.disable_response.DisableResponse = (
        capo_inspector2.types.disable_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.disable_request.serialize_json(input_)
    ).encode()
...
def disable(
    ...
    input_: capo_inspector2.types.disable_request.DisableRequest,
) -> tuple[capo_inspector2.types.disable_response.DisableResponse, zapros.Response]:
