...
def handle_response(
    ...
    out: capo_inspector2.types.send_cis_session_telemetry_response.SendCisSessionTelemetryResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.send_cis_session_telemetry_request.serialize_json(input_)
    ).encode()
