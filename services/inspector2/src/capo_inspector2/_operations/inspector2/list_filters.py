...
def handle_response(
    ...
    out: capo_inspector2.types.list_filters_response.ListFiltersResponse = (
        capo_inspector2.types.list_filters_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.list_filters_request.serialize_json(input_)
    ).encode()
...
def list_filters(
    ...
    capo_inspector2.types.list_filters_response.ListFiltersResponse, zapros.Response
]:
