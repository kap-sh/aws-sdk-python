...
def handle_response(
    ...
    out: capo_inspector2.types.update_configuration_response.UpdateConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.update_configuration_request.serialize_json(input_)
    ).encode()
