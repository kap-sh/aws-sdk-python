...
def handle_response(
    ...
    out: capo_inspector2.types.list_members_response.ListMembersResponse = (
        capo_inspector2.types.list_members_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.list_members_request.serialize_json(input_)
    ).encode()
...
def list_members(
    ...
    capo_inspector2.types.list_members_response.ListMembersResponse, zapros.Response
]:
