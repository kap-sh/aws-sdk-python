...
if TYPE_CHECKING:
    import capo_inspector2.types.platform_version
    import capo_inspector2.types.product
    import capo_inspector2.types.vendor


class ComputePlatform(TypedDict, closed=True):
    vendor: NotRequired["capo_inspector2.types.vendor.Vendor"]
    """<p>The compute platform vendor.</p>"""
    product: NotRequired["capo_inspector2.types.product.Product"]
    """<p>The compute platform product.</p>"""
    version: NotRequired["capo_inspector2.types.platform_version.PlatformVersion"]
