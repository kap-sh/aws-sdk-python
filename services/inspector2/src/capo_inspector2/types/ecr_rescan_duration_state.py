...
if TYPE_CHECKING:
    ...
    import capo_inspector2.types.ecr_rescan_duration_status


class EcrRescanDurationState(TypedDict, closed=True):
    rescan_duration: NotRequired[
        "capo_inspector2.types.ecr_rescan_duration.EcrRescanDuration"
    ]
    """<p>The rescan duration configured for image push date. </p>"""
    status: NotRequired[
        "capo_inspector2.types.ecr_rescan_duration_status.EcrRescanDurationStatus"
    ]
