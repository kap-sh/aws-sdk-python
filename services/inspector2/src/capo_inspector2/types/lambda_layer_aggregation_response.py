...
class LambdaLayerAggregationResponse(TypedDict, closed=True):
    function_name: "capo_inspector2.types.non_empty_string.NonEmptyString"
    ...
    layer_arn: "capo_inspector2.types.non_empty_string.NonEmptyString"
