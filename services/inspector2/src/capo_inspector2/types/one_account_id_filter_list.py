"""Generated from Smithy shape ``com.amazonaws.inspector2#OneAccountIdFilterList``."""
...
OneAccountIdFilterList: TypeAlias = list[
    "capo_inspector2.types.cis_string_filter.CisStringFilter"
]


# --- restJson1 ser/de ---
def serialize_json(value: OneAccountIdFilterList) -> list:
    import capo_inspector2.types.cis_string_filter
...
def deserialize_json(data: list) -> OneAccountIdFilterList:
    import capo_inspector2.types.cis_string_filter

    out: OneAccountIdFilterList = []
    for item in data:
