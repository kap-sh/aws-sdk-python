"""Generated from Smithy shape ``com.amazonaws.dax#InvalidParameterCombinationException``."""
...
if TYPE_CHECKING:
    import capo_dax.types.aws_query_error_message


class InvalidParameterCombinationException_(TypedDict, closed=True):
    message: NotRequired["capo_dax.types.aws_query_error_message.AwsQueryErrorMessage"]
...
class InvalidParameterCombinationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.dax#InvalidParameterCombinationException``."""
