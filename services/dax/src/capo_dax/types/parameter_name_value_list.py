...
if TYPE_CHECKING:
    import capo_dax.types.parameter_name_value

ParameterNameValueList: TypeAlias = list[
    "capo_dax.types.parameter_name_value.ParameterNameValue"
]
...
def serialize_aws_json_1_1(value: ParameterNameValueList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_dax.types.parameter_name_value.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> ParameterNameValueList:
    ...
    for item in data:
        out.append(capo_dax.types.parameter_name_value.deserialize_aws_json_1_1(item))
    return out
