"""Generated from Smithy shape ``com.amazonaws.dax#SubnetGroupAlreadyExistsFault``."""
...
class SubnetGroupAlreadyExistsFault_(TypedDict):
...
class SubnetGroupAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.dax#SubnetGroupAlreadyExistsFault``."""
