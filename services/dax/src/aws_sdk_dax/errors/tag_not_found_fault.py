"""Generated from Smithy shape ``com.amazonaws.dax#TagNotFoundFault``."""
...
class TagNotFoundFault_(TypedDict):
...
class TagNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.dax#TagNotFoundFault``."""
