...
class DAXError(Exception):
    """Base class for all DAX service errors."""


class ServiceError(DAXError):
...
class SerializationError(DAXError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DAXError):
...
class WaiterFailedError(DAXError):
...
class WaiterTimeoutError(DAXError):
