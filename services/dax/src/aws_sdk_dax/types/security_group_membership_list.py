...
if TYPE_CHECKING:
    import aws_sdk_dax.types.security_group_membership

SecurityGroupMembershipList: TypeAlias = list[
    "aws_sdk_dax.types.security_group_membership.SecurityGroupMembership"
]
...
def serialize_aws_json_1_1(value: SecurityGroupMembershipList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_dax.types.security_group_membership.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> SecurityGroupMembershipList:
    ...
    for item in data:
        out.append(
            aws_sdk_dax.types.security_group_membership.deserialize_aws_json_1_1(item)
        )
    return out
