...
ParameterGroupList: TypeAlias = list["aws_sdk_dax.types.parameter_group.ParameterGroup"]
...
def serialize_aws_json_1_1(value: ParameterGroupList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_dax.types.parameter_group.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> ParameterGroupList:
    ...
    for item in data:
        out.append(aws_sdk_dax.types.parameter_group.deserialize_aws_json_1_1(item))
    return out
