...
if TYPE_CHECKING:
    import aws_sdk_dax.types.node_type_specific_value

NodeTypeSpecificValueList: TypeAlias = list[
    "aws_sdk_dax.types.node_type_specific_value.NodeTypeSpecificValue"
]
...
def serialize_aws_json_1_1(value: NodeTypeSpecificValueList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_dax.types.node_type_specific_value.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> NodeTypeSpecificValueList:
    ...
    for item in data:
        out.append(
            aws_sdk_dax.types.node_type_specific_value.deserialize_aws_json_1_1(item)
        )
    return out
