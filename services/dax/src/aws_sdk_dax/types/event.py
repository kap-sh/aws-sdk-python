...
class Event(TypedDict, closed=True):
    ...
    message: NotRequired["aws_sdk_dax.types.string.String"]
    """<p>A user-defined message associated with the event.</p>"""
    date: NotRequired["aws_sdk_dax.types.t_stamp.TStamp"]
...
def serialize_aws_json_1_1(value: Event) -> dict:
    ...
    if "date" in value:
        ...
        out["Date"] = aws_sdk_dax.types.t_stamp.serialize_aws_json_1_1(value["date"])
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Event:
    ...
    if "Date" in data:
        ...
        out["date"] = aws_sdk_dax.types.t_stamp.deserialize_aws_json_1_1(data["Date"])
    return out
