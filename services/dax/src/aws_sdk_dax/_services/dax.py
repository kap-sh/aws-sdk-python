...
from aws_sdk_dax._services._aws_config import aws_config
...
class DAXClientConfig(TypedDict, total=False):
...
class DAXClient:
    ...
    def create_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.create_cluster_request.CreateClusterRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.create_cluster_response.CreateClusterResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.create_cluster.create_cluster(
    ...
    def create_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.create_parameter_group_request.CreateParameterGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.create_parameter_group_response.CreateParameterGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.create_parameter_group.create_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_subnet_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.create_subnet_group_request.CreateSubnetGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.create_subnet_group_response.CreateSubnetGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.create_subnet_group.create_subnet_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def decrease_replication_factor(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.decrease_replication_factor_request.DecreaseReplicationFactorRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.decrease_replication_factor_response.DecreaseReplicationFactorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.decrease_replication_factor.decrease_replication_factor(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.delete_cluster_request.DeleteClusterRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.delete_cluster_response.DeleteClusterResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.delete_cluster.delete_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.delete_parameter_group_request.DeleteParameterGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.delete_parameter_group_response.DeleteParameterGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.delete_parameter_group.delete_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_subnet_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.delete_subnet_group_request.DeleteSubnetGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.delete_subnet_group_response.DeleteSubnetGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.delete_subnet_group.delete_subnet_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_clusters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.describe_clusters_request.DescribeClustersRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.describe_clusters_response.DescribeClustersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.describe_clusters.describe_clusters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_default_parameters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.describe_default_parameters_request.DescribeDefaultParametersRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.describe_default_parameters_response.DescribeDefaultParametersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.describe_default_parameters.describe_default_parameters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.describe_events_request.DescribeEventsRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.describe_events_response.DescribeEventsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.describe_events.describe_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_parameter_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.describe_parameter_groups_request.DescribeParameterGroupsRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.describe_parameter_groups_response.DescribeParameterGroupsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.describe_parameter_groups.describe_parameter_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_parameters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.describe_parameters_request.DescribeParametersRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.describe_parameters_response.DescribeParametersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.describe_parameters.describe_parameters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_subnet_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.describe_subnet_groups_request.DescribeSubnetGroupsRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.describe_subnet_groups_response.DescribeSubnetGroupsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.describe_subnet_groups.describe_subnet_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def increase_replication_factor(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.increase_replication_factor_request.IncreaseReplicationFactorRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.increase_replication_factor_response.IncreaseReplicationFactorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.increase_replication_factor.increase_replication_factor(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.list_tags_request.ListTagsRequest]",
        ) -> OperationResponse["aws_sdk_dax.types.list_tags_response.ListTagsResponse"]:
            import aws_sdk_dax._operations.amazon_daxv3.list_tags

            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.list_tags.list_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def reboot_node(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.reboot_node_request.RebootNodeRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.reboot_node_response.RebootNodeResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.reboot_node.reboot_node(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.update_cluster_request.UpdateClusterRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.update_cluster_response.UpdateClusterResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.update_cluster.update_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.update_parameter_group_request.UpdateParameterGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.update_parameter_group_response.UpdateParameterGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.update_parameter_group.update_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_subnet_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dax.types.update_subnet_group_request.UpdateSubnetGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_dax.types.update_subnet_group_response.UpdateSubnetGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dax._operations.amazon_daxv3.update_subnet_group.update_subnet_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
