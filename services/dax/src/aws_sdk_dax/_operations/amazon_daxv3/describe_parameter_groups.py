"""Generated from Smithy shape ``com.amazonaws.dax#DescribeParameterGroups``."""
...
import aws_sdk_dax.types.parameter_group_list
...
def handle_response(
    ...
    out: aws_sdk_dax.types.describe_parameter_groups_response.DescribeParameterGroupsResponse = aws_sdk_dax.types.describe_parameter_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_dax.types.describe_parameter_groups_request.DescribeParameterGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.describe_parameter_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
