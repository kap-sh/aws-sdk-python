...
def build_request(
    ...
    input_: aws_sdk_dax.types.increase_replication_factor_request.IncreaseReplicationFactorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.increase_replication_factor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
