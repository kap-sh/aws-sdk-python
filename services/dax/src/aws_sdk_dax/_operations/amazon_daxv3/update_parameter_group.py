...
def handle_response(
    ...
    out: aws_sdk_dax.types.update_parameter_group_response.UpdateParameterGroupResponse = aws_sdk_dax.types.update_parameter_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_dax.types.update_parameter_group_request.UpdateParameterGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.update_parameter_group_request.serialize_aws_json_1_1(input_)
    ).encode()
