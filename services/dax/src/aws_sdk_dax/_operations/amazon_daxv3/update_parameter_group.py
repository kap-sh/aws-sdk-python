...
def build_request(
    ...
    input: aws_sdk_dax.types.update_parameter_group_request.UpdateParameterGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.update_parameter_group_request.serialize_aws_json_1_1(input)
    ).encode()
