...
def handle_response(
    ...
    out: aws_sdk_dax.types.decrease_replication_factor_response.DecreaseReplicationFactorResponse = aws_sdk_dax.types.decrease_replication_factor_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_dax.types.decrease_replication_factor_request.DecreaseReplicationFactorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.decrease_replication_factor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
