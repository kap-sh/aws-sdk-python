...
def handle_response(
    ...
    out: aws_sdk_dax.types.describe_events_response.DescribeEventsResponse = (
        aws_sdk_dax.types.describe_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_dax.types.describe_events_request.DescribeEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.describe_events_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_events(
    ...
    aws_sdk_dax.types.describe_events_response.DescribeEventsResponse, zapros.Response
]:
