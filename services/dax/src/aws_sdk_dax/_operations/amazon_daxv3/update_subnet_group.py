...
def build_request(
    ...
    input: aws_sdk_dax.types.update_subnet_group_request.UpdateSubnetGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.update_subnet_group_request.serialize_aws_json_1_1(input)
    ).encode()
