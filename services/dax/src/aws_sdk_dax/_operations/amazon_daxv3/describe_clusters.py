"""Generated from Smithy shape ``com.amazonaws.dax#DescribeClusters``."""
...
def handle_response(
    ...
    out: aws_sdk_dax.types.describe_clusters_response.DescribeClustersResponse = (
        aws_sdk_dax.types.describe_clusters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_dax.types.describe_clusters_request.DescribeClustersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.describe_clusters_request.serialize_aws_json_1_1(input_)
    ).encode()
