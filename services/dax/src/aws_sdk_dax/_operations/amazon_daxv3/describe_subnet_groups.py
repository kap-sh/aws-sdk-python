...
def handle_response(
    ...
    out: aws_sdk_dax.types.describe_subnet_groups_response.DescribeSubnetGroupsResponse = aws_sdk_dax.types.describe_subnet_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_dax.types.describe_subnet_groups_request.DescribeSubnetGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.describe_subnet_groups_request.serialize_aws_json_1_1(input_)
    ).encode()
