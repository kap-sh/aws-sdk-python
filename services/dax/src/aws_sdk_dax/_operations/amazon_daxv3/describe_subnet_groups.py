...
def build_request(
    ...
    input: aws_sdk_dax.types.describe_subnet_groups_request.DescribeSubnetGroupsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.describe_subnet_groups_request.serialize_aws_json_1_1(input)
    ).encode()
