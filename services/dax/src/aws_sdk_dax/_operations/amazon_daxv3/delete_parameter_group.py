...
def build_request(
    ...
    input: aws_sdk_dax.types.delete_parameter_group_request.DeleteParameterGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.delete_parameter_group_request.serialize_aws_json_1_1(input)
    ).encode()
