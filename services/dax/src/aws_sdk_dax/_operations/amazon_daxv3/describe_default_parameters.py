"""Generated from Smithy shape ``com.amazonaws.dax#DescribeDefaultParameters``."""
...
def handle_response(
    ...
    out: aws_sdk_dax.types.describe_default_parameters_response.DescribeDefaultParametersResponse = aws_sdk_dax.types.describe_default_parameters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_dax.types.describe_default_parameters_request.DescribeDefaultParametersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.describe_default_parameters_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_default_parameters(
