...
def build_request(
    ...
    input: aws_sdk_dax.types.create_parameter_group_request.CreateParameterGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.create_parameter_group_request.serialize_aws_json_1_1(input)
    ).encode()
