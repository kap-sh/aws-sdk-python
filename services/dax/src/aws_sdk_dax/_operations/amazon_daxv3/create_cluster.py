...
def build_request(
    ...
    input_: aws_sdk_dax.types.create_cluster_request.CreateClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.create_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_cluster(
    ...
    aws_sdk_dax.types.create_cluster_response.CreateClusterResponse, zapros.Response
]:
