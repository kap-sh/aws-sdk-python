...
def build_request(
    ...
    input_: aws_sdk_dax.types.delete_cluster_request.DeleteClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.delete_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_cluster(
    ...
    aws_sdk_dax.types.delete_cluster_response.DeleteClusterResponse, zapros.Response
]:
