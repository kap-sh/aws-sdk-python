...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetGroupAlreadyExistsFault":
            import aws_sdk_dax.errors.subnet_group_already_exists_fault

            raise aws_sdk_dax.errors.subnet_group_already_exists_fault.SubnetGroupAlreadyExistsFault.from_aws_json_1_1(
                data
            )
        case "SubnetGroupQuotaExceededFault":
            import aws_sdk_dax.errors.subnet_group_quota_exceeded_fault

            raise aws_sdk_dax.errors.subnet_group_quota_exceeded_fault.SubnetGroupQuotaExceededFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_dax.types.create_subnet_group_response.CreateSubnetGroupResponse = (
        aws_sdk_dax.types.create_subnet_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_dax.types.create_subnet_group_request.CreateSubnetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.create_subnet_group_request.serialize_aws_json_1_1(input_)
    ).encode()
