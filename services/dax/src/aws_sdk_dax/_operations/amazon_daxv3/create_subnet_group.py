...
def build_request(
    ...
    input: aws_sdk_dax.types.create_subnet_group_request.CreateSubnetGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.create_subnet_group_request.serialize_aws_json_1_1(input)
    ).encode()
