...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidARNFault":
            import aws_sdk_dax.errors.invalid_arn_fault

            raise aws_sdk_dax.errors.invalid_arn_fault.InvalidARNFault.from_aws_json_1_1(
                data
            )
        ...
        case "TagNotFoundFault":
            import aws_sdk_dax.errors.tag_not_found_fault

            raise aws_sdk_dax.errors.tag_not_found_fault.TagNotFoundFault.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_dax.types.untag_resource_response.UntagResourceResponse = (
        aws_sdk_dax.types.untag_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_dax.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def untag_resource(
    ...
    aws_sdk_dax.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
