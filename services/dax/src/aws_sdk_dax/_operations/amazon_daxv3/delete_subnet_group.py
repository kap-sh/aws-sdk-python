"""Generated from Smithy shape ``com.amazonaws.dax#DeleteSubnetGroup``."""
...
import aws_sdk_dax.errors.subnet_group_in_use_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetGroupInUseFault":
            raise aws_sdk_dax.errors.subnet_group_in_use_fault.SubnetGroupInUseFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_dax.types.delete_subnet_group_response.DeleteSubnetGroupResponse = (
        aws_sdk_dax.types.delete_subnet_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_dax.types.delete_subnet_group_request.DeleteSubnetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.delete_subnet_group_request.serialize_aws_json_1_1(input_)
    ).encode()
