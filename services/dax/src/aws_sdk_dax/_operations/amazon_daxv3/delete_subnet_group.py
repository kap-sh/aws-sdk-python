...
def build_request(
    ...
    input: aws_sdk_dax.types.delete_subnet_group_request.DeleteSubnetGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dax.types.delete_subnet_group_request.serialize_aws_json_1_1(input)
    ).encode()
