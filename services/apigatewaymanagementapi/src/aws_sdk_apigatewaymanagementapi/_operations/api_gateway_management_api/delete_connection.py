"""Generated from Smithy shape ``com.amazonaws.apigatewaymanagementapi#DeleteConnection``."""
...
def build_request(
    ...
    input_: aws_sdk_apigatewaymanagementapi.types.delete_connection_request.DeleteConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
