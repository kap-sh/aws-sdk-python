...
def build_request(
    ...
    input_: aws_sdk_apigatewaymanagementapi.types.post_to_connection_request.PostToConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "data" in input_:
        ...
        body: bytes | None = json.dumps(
            aws_sdk_apigatewaymanagementapi.types.data.serialize_json(input_["data"])
        ).encode()
