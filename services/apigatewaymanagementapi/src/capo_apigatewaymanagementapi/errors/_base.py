...
class ApiGatewayManagementApiError(Exception):
    """Base class for all ApiGatewayManagementApi service errors."""


class ServiceError(ApiGatewayManagementApiError):
...
class SerializationError(ApiGatewayManagementApiError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ApiGatewayManagementApiError):
...
class WaiterFailedError(ApiGatewayManagementApiError):
...
class WaiterTimeoutError(ApiGatewayManagementApiError):
