...
import capo_databrew.types.create_dataset_request
import capo_databrew.types.create_dataset_response
...
) -> capo_databrew.types.create_dataset_response.CreateDatasetResponse:
    out: capo_databrew.types.create_dataset_response.CreateDatasetResponse = (
        capo_databrew.types.create_dataset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_databrew.types.create_dataset_request.serialize_json(input_)
    ).encode()
...
def create_dataset(
    ...
    capo_databrew.types.create_dataset_response.CreateDatasetResponse, zapros.Response
]:
