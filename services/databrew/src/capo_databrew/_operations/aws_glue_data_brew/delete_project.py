...
import capo_databrew.types.delete_project_request
import capo_databrew.types.delete_project_response
...
) -> capo_databrew.types.delete_project_response.DeleteProjectResponse:
    out: capo_databrew.types.delete_project_response.DeleteProjectResponse = (
        capo_databrew.types.delete_project_response.deserialize_json(
...
def delete_project(
    ...
    capo_databrew.types.delete_project_response.DeleteProjectResponse, zapros.Response
]:
