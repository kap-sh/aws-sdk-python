...
import capo_databrew.types.update_recipe_job_request
import capo_databrew.types.update_recipe_job_response
...
) -> capo_databrew.types.update_recipe_job_response.UpdateRecipeJobResponse:
    out: capo_databrew.types.update_recipe_job_response.UpdateRecipeJobResponse = (
        capo_databrew.types.update_recipe_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_databrew.types.update_recipe_job_request.serialize_json(input_)
    ).encode()
