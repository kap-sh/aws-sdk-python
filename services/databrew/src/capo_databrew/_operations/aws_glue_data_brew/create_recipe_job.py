...
import capo_databrew.types.create_recipe_job_request
import capo_databrew.types.create_recipe_job_response
...
) -> capo_databrew.types.create_recipe_job_response.CreateRecipeJobResponse:
    out: capo_databrew.types.create_recipe_job_response.CreateRecipeJobResponse = (
        capo_databrew.types.create_recipe_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_databrew.types.create_recipe_job_request.serialize_json(input_)
    ).encode()
