...
import capo_databrew.types.create_profile_job_request
import capo_databrew.types.create_profile_job_response
...
) -> capo_databrew.types.create_profile_job_response.CreateProfileJobResponse:
    out: capo_databrew.types.create_profile_job_response.CreateProfileJobResponse = (
        capo_databrew.types.create_profile_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_databrew.types.create_profile_job_request.serialize_json(input_)
    ).encode()
