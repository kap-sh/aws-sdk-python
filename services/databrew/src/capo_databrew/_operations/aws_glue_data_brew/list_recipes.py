...
import capo_databrew.types.list_recipes_request
import capo_databrew.types.list_recipes_response
...
) -> capo_databrew.types.list_recipes_response.ListRecipesResponse:
    out: capo_databrew.types.list_recipes_response.ListRecipesResponse = (
        capo_databrew.types.list_recipes_response.deserialize_json(
...
def list_recipes(
    ...
    capo_databrew.types.list_recipes_response.ListRecipesResponse, zapros.Response
]:
