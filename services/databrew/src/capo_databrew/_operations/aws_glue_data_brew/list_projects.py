"""Generated from Smithy shape ``com.amazonaws.databrew#ListProjects``."""
...
import capo_databrew.types.list_projects_request
import capo_databrew.types.list_projects_response
...
) -> capo_databrew.types.list_projects_response.ListProjectsResponse:
    out: capo_databrew.types.list_projects_response.ListProjectsResponse = (
        capo_databrew.types.list_projects_response.deserialize_json(
...
def list_projects(
    ...
    capo_databrew.types.list_projects_response.ListProjectsResponse, zapros.Response
]:
