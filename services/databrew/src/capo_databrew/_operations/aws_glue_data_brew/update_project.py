"""Generated from Smithy shape ``com.amazonaws.databrew#UpdateProject``."""
...
import capo_databrew.types.update_project_request
import capo_databrew.types.update_project_response
...
) -> capo_databrew.types.update_project_response.UpdateProjectResponse:
    out: capo_databrew.types.update_project_response.UpdateProjectResponse = (
        capo_databrew.types.update_project_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_databrew.types.update_project_request.serialize_json(input_)
    ).encode()
...
def update_project(
    ...
    capo_databrew.types.update_project_response.UpdateProjectResponse, zapros.Response
]:
