"""Generated from Smithy shape ``com.amazonaws.databrew#ListSchedules``."""
...
import capo_databrew.types.list_schedules_request
import capo_databrew.types.list_schedules_response
...
) -> capo_databrew.types.list_schedules_response.ListSchedulesResponse:
    out: capo_databrew.types.list_schedules_response.ListSchedulesResponse = (
        capo_databrew.types.list_schedules_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "job_name" in input_:
        params["jobName"] = str(input_["job_name"])
...
def list_schedules(
    ...
    capo_databrew.types.list_schedules_response.ListSchedulesResponse, zapros.Response
]:
