"""Generated from Smithy shape ``com.amazonaws.databrew#DescribeRecipe``."""
...
import capo_databrew.types.describe_recipe_request
import capo_databrew.types.describe_recipe_response
...
def handle_response(
    ...
    out: capo_databrew.types.describe_recipe_response.DescribeRecipeResponse = (
        capo_databrew.types.describe_recipe_response.deserialize_json(
...
def describe_recipe(
    ...
    capo_databrew.types.describe_recipe_response.DescribeRecipeResponse, zapros.Response
]:
...
async def async_describe_recipe(
