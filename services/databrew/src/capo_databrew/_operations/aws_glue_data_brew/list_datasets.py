"""Generated from Smithy shape ``com.amazonaws.databrew#ListDatasets``."""
...
import capo_databrew.types.list_datasets_request
import capo_databrew.types.list_datasets_response
...
) -> capo_databrew.types.list_datasets_response.ListDatasetsResponse:
    out: capo_databrew.types.list_datasets_response.ListDatasetsResponse = (
        capo_databrew.types.list_datasets_response.deserialize_json(
...
def list_datasets(
    ...
    capo_databrew.types.list_datasets_response.ListDatasetsResponse, zapros.Response
]:
