...
import capo_databrew.types.update_recipe_request
import capo_databrew.types.update_recipe_response
...
) -> capo_databrew.types.update_recipe_response.UpdateRecipeResponse:
    out: capo_databrew.types.update_recipe_response.UpdateRecipeResponse = (
        capo_databrew.types.update_recipe_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_databrew.types.update_recipe_request.serialize_json(input_)
    ).encode()
...
def update_recipe(
    ...
    capo_databrew.types.update_recipe_response.UpdateRecipeResponse, zapros.Response
]:
