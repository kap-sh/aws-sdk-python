"""Generated from Smithy shape ``com.amazonaws.databrew#StopJobRun``."""
...
import capo_databrew.types.stop_job_run_request
import capo_databrew.types.stop_job_run_response
...
) -> capo_databrew.types.stop_job_run_response.StopJobRunResponse:
    out: capo_databrew.types.stop_job_run_response.StopJobRunResponse = (
        capo_databrew.types.stop_job_run_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/jobs/{Name}/jobRun/{RunId}/stopJobRun"
...
def stop_job_run(
    ...
    capo_databrew.types.stop_job_run_response.StopJobRunResponse, zapros.Response
]:
