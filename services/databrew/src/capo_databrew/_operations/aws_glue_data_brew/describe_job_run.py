"""Generated from Smithy shape ``com.amazonaws.databrew#DescribeJobRun``."""
...
import capo_databrew.types.describe_job_run_request
import capo_databrew.types.describe_job_run_response
...
) -> capo_databrew.types.describe_job_run_response.DescribeJobRunResponse:
    out: capo_databrew.types.describe_job_run_response.DescribeJobRunResponse = (
        capo_databrew.types.describe_job_run_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/jobs/{Name}/jobRun/{RunId}"
...
async def async_describe_job_run(
