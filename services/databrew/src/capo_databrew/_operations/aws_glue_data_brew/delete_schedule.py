"""Generated from Smithy shape ``com.amazonaws.databrew#DeleteSchedule``."""
...
import capo_databrew.types.delete_schedule_request
import capo_databrew.types.delete_schedule_response
...
) -> capo_databrew.types.delete_schedule_response.DeleteScheduleResponse:
    out: capo_databrew.types.delete_schedule_response.DeleteScheduleResponse = (
        capo_databrew.types.delete_schedule_response.deserialize_json(
...
def delete_schedule(
    ...
    capo_databrew.types.delete_schedule_response.DeleteScheduleResponse, zapros.Response
]:
