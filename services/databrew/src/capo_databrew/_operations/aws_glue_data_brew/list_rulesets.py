"""Generated from Smithy shape ``com.amazonaws.databrew#ListRulesets``."""
...
import capo_databrew.types.list_rulesets_request
import capo_databrew.types.list_rulesets_response
...
) -> capo_databrew.types.list_rulesets_response.ListRulesetsResponse:
    out: capo_databrew.types.list_rulesets_response.ListRulesetsResponse = (
        capo_databrew.types.list_rulesets_response.deserialize_json(
...
def list_rulesets(
    ...
    capo_databrew.types.list_rulesets_response.ListRulesetsResponse, zapros.Response
]:
