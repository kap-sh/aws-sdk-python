...
import capo_databrew.types.delete_ruleset_request
import capo_databrew.types.delete_ruleset_response
...
) -> capo_databrew.types.delete_ruleset_response.DeleteRulesetResponse:
    out: capo_databrew.types.delete_ruleset_response.DeleteRulesetResponse = (
        capo_databrew.types.delete_ruleset_response.deserialize_json(
...
def delete_ruleset(
    ...
    capo_databrew.types.delete_ruleset_response.DeleteRulesetResponse, zapros.Response
]:
