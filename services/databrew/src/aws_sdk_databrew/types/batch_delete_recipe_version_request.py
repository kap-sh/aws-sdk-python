...
class BatchDeleteRecipeVersionRequest(TypedDict):
...
def serialize_json(value: BatchDeleteRecipeVersionRequest) -> dict:
    ...
    out["RecipeVersions"] = aws_sdk_databrew.types.recipe_version_list.serialize_json(
...
def deserialize_json(data: dict) -> BatchDeleteRecipeVersionRequest:
    ...
    if "RecipeVersions" in data:
        ...
        out["recipe_versions"] = (
            aws_sdk_databrew.types.recipe_version_list.deserialize_json(
                data["RecipeVersions"]
            )
        )
    else:
