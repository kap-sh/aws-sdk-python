...
if TYPE_CHECKING:
    ...
    import capo_invoicing.types.fees_breakdown_amount_list


class FeesBreakdown(TypedDict, closed=True):
    breakdown: NotRequired[
        "capo_invoicing.types.fees_breakdown_amount_list.FeesBreakdownAmountList"
    ]
...
def serialize_aws_json_1_0(value: FeesBreakdown) -> dict:
    ...
    if "breakdown" in value:
        ...
        out["Breakdown"] = (
            capo_invoicing.types.fees_breakdown_amount_list.serialize_aws_json_1_0(
                value["breakdown"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> FeesBreakdown:
    ...
    if "Breakdown" in data:
        ...
        out["breakdown"] = (
            capo_invoicing.types.fees_breakdown_amount_list.deserialize_aws_json_1_0(
                data["Breakdown"]
            )
        )
