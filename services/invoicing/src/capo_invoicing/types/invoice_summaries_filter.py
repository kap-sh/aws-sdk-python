...
class InvoiceSummariesFilter(TypedDict, closed=True):
    time_interval: NotRequired["capo_invoicing.types.date_interval.DateInterval"]
    ...
    invoicing_entity: NotRequired["capo_invoicing.types.basic_string.BasicString"]
...
def serialize_aws_json_1_0(value: InvoiceSummariesFilter) -> dict:
    ...
    if "time_interval" in value:
        ...
        out["TimeInterval"] = capo_invoicing.types.date_interval.serialize_aws_json_1_0(
            value["time_interval"]
        )
...
def deserialize_aws_json_1_0(data: dict) -> InvoiceSummariesFilter:
    ...
    if "TimeInterval" in data:
        ...
        out["time_interval"] = (
            capo_invoicing.types.date_interval.deserialize_aws_json_1_0(
                data["TimeInterval"]
            )
        )
