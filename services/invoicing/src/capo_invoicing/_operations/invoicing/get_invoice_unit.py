"""Generated from Smithy shape ``com.amazonaws.invoicing#GetInvoiceUnit``."""
...
def handle_response(
    ...
    out: capo_invoicing.types.get_invoice_unit_response.GetInvoiceUnitResponse = (
        capo_invoicing.types.get_invoice_unit_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Invoicing.GetInvoiceUnit"
    body: bytes | None = json.dumps(
        capo_invoicing.types.get_invoice_unit_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_get_invoice_unit(
