"""Generated from Smithy shape ``com.amazonaws.invoicing#ListInvoiceUnits``."""
...
def handle_response(
    ...
    out: capo_invoicing.types.list_invoice_units_response.ListInvoiceUnitsResponse = (
        capo_invoicing.types.list_invoice_units_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_invoicing.types.list_invoice_units_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_list_invoice_units(
