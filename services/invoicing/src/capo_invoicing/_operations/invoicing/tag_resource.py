"""Generated from Smithy shape ``com.amazonaws.invoicing#TagResource``."""
...
def handle_response(
    ...
    out: capo_invoicing.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Invoicing.TagResource"
    body: bytes | None = json.dumps(
        capo_invoicing.types.tag_resource_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_invoicing.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
