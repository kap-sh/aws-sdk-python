...
def handle_response(
    ...
    out: capo_invoicing.types.update_procurement_portal_preference_status_response.UpdateProcurementPortalPreferenceStatusResponse = capo_invoicing.types.update_procurement_portal_preference_status_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_invoicing.types.update_procurement_portal_preference_status_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
