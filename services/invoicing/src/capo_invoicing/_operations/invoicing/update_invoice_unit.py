...
def handle_response(
    ...
    out: capo_invoicing.types.update_invoice_unit_response.UpdateInvoiceUnitResponse = (
        capo_invoicing.types.update_invoice_unit_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_invoicing.types.update_invoice_unit_request.serialize_aws_json_1_0(input_)
    ).encode()
