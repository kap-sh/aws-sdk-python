...
class InvoicingError(Exception):
    """Base class for all Invoicing service errors."""


class ServiceError(InvoicingError):
...
class SerializationError(InvoicingError):
    """Raised when a value cannot be serialized."""


class DeserializationError(InvoicingError):
...
class WaiterFailedError(InvoicingError):
...
class WaiterTimeoutError(InvoicingError):
