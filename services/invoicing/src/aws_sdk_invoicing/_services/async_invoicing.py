...
from aws_sdk_invoicing._services._aws_config import aaws_config
...
class AsyncInvoicingClientConfig(TypedDict, total=False):
...
class AsyncInvoicingClient:
    ...
    async def batch_get_invoice_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.batch_get_invoice_profile_request.BatchGetInvoiceProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.batch_get_invoice_profile_response.BatchGetInvoiceProfileResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.batch_get_invoice_profile.async_batch_get_invoice_profile(
    ...
    async def create_invoice_unit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.create_invoice_unit_request.CreateInvoiceUnitRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.create_invoice_unit_response.CreateInvoiceUnitResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.create_invoice_unit.async_create_invoice_unit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_procurement_portal_preference(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.create_procurement_portal_preference_request.CreateProcurementPortalPreferenceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.create_procurement_portal_preference_response.CreateProcurementPortalPreferenceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.create_procurement_portal_preference.async_create_procurement_portal_preference(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_invoice_unit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.delete_invoice_unit_request.DeleteInvoiceUnitRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.delete_invoice_unit_response.DeleteInvoiceUnitResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.delete_invoice_unit.async_delete_invoice_unit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_procurement_portal_preference(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.delete_procurement_portal_preference_request.DeleteProcurementPortalPreferenceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.delete_procurement_portal_preference_response.DeleteProcurementPortalPreferenceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.delete_procurement_portal_preference.async_delete_procurement_portal_preference(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_invoice_pdf(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.get_invoice_pdf_request.GetInvoicePDFRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.get_invoice_pdf_response.GetInvoicePDFResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.get_invoice_pdf.async_get_invoice_pdf(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_invoice_unit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.get_invoice_unit_request.GetInvoiceUnitRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.get_invoice_unit_response.GetInvoiceUnitResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.get_invoice_unit.async_get_invoice_unit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_procurement_portal_preference(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.get_procurement_portal_preference_request.GetProcurementPortalPreferenceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.get_procurement_portal_preference_response.GetProcurementPortalPreferenceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.get_procurement_portal_preference.async_get_procurement_portal_preference(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_invoice_summaries(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.list_invoice_summaries_request.ListInvoiceSummariesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.list_invoice_summaries_response.ListInvoiceSummariesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.list_invoice_summaries.async_list_invoice_summaries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_invoicing.types.invoice_summary.InvoiceSummary]":
        _token = next_token
        while True:
    ...
    async def list_invoice_units(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.list_invoice_units_request.ListInvoiceUnitsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.list_invoice_units_response.ListInvoiceUnitsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.list_invoice_units.async_list_invoice_units(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_invoice_units(
        ...
        *,
        ...
        as_of: Optional["aws_sdk_invoicing.types.as_of_timestamp.AsOfTimestamp"] = None,
    ) -> "AsyncIterator[aws_sdk_invoicing.types.invoice_unit.InvoiceUnit]":
        _token = next_token
        while True:
    ...
    async def list_procurement_portal_preferences(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.list_procurement_portal_preferences_request.ListProcurementPortalPreferencesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.list_procurement_portal_preferences_response.ListProcurementPortalPreferencesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.list_procurement_portal_preferences.async_list_procurement_portal_preferences(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_procurement_portal_preferences(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_invoicing.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_invoicing.types.procurement_portal_preference_summary.ProcurementPortalPreferenceSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_procurement_portal_preference(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.put_procurement_portal_preference_request.PutProcurementPortalPreferenceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.put_procurement_portal_preference_response.PutProcurementPortalPreferenceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.put_procurement_portal_preference.async_put_procurement_portal_preference(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_invoice_unit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.update_invoice_unit_request.UpdateInvoiceUnitRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.update_invoice_unit_response.UpdateInvoiceUnitResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.update_invoice_unit.async_update_invoice_unit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_procurement_portal_preference_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_invoicing.types.update_procurement_portal_preference_status_request.UpdateProcurementPortalPreferenceStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_invoicing.types.update_procurement_portal_preference_status_response.UpdateProcurementPortalPreferenceStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_invoicing._operations.invoicing.update_procurement_portal_preference_status.async_update_procurement_portal_preference_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
