...
if TYPE_CHECKING:
    import aws_sdk_invoicing.types.discounts_breakdown_amount

DiscountsBreakdownAmountList: TypeAlias = list[
    "aws_sdk_invoicing.types.discounts_breakdown_amount.DiscountsBreakdownAmount"
]
...
def serialize_aws_json_1_0(value: DiscountsBreakdownAmountList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_invoicing.types.discounts_breakdown_amount.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> DiscountsBreakdownAmountList:
    ...
    for item in data:
        out.append(
            aws_sdk_invoicing.types.discounts_breakdown_amount.deserialize_aws_json_1_0(
                item
            )
        )
    return out
