...
def deserialize_aws_json_1_0(data: dict) -> CreateProcurementPortalPreferenceResponse:
    ...
    if "ProcurementPortalPreferenceArn" in data:
        out["procurement_portal_preference_arn"] = data["ProcurementPortalPreferenceArn"]
    else:
        raise DeserializationError("CreateProcurementPortalPreferenceResponse.procurement_portal_preference_arn required")
    return out