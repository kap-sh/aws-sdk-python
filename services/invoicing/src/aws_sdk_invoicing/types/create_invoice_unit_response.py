"""Generated from Smithy shape ``com.amazonaws.invoicing#CreateInvoiceUnitResponse``."""
...
class CreateInvoiceUnitResponse(TypedDict):
    invoice_unit_arn: NotRequired["aws_sdk_invoicing.types.invoice_unit_arn_string.InvoiceUnitArnString"]
    """<p> The ARN to identify an invoice unit. This information can't be modified or deleted. </p>"""

# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: CreateInvoiceUnitResponse) -> dict:
    out: dict = {}
