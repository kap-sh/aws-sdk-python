...
ProcurementPortalPreferenceSummaries: TypeAlias = list[
    "aws_sdk_invoicing.types.procurement_portal_preference_summary.ProcurementPortalPreferenceSummary"
]
...
def serialize_aws_json_1_0(value: ProcurementPortalPreferenceSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_invoicing.types.procurement_portal_preference_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ProcurementPortalPreferenceSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_invoicing.types.procurement_portal_preference_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
