...
if TYPE_CHECKING:
    ...
    import aws_sdk_invoicing.types.supplemental_document_type


class SupplementalDocument(TypedDict):
    document_type: NotRequired[
        "aws_sdk_invoicing.types.supplemental_document_type.SupplementalDocumentType"
    ]
...
def serialize_aws_json_1_0(value: SupplementalDocument) -> dict:
    ...
    if "document_type" in value:
        ...
        out["DocumentType"] = (
            aws_sdk_invoicing.types.supplemental_document_type.serialize_aws_json_1_0(
                value["document_type"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> SupplementalDocument:
    ...
    if "DocumentType" in data:
        ...
        out["document_type"] = (
            aws_sdk_invoicing.types.supplemental_document_type.deserialize_aws_json_1_0(
                data["DocumentType"]
            )
        )
