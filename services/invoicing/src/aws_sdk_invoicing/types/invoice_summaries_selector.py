...
if TYPE_CHECKING:
    import aws_sdk_invoicing.types.list_invoice_summaries_resource_type
...
def serialize_aws_json_1_0(value: InvoiceSummariesSelector) -> dict:
    ...
    out["ResourceType"] = (
        aws_sdk_invoicing.types.list_invoice_summaries_resource_type.serialize_aws_json_1_0(
            value["resource_type"]
        )
    )
...
def deserialize_aws_json_1_0(data: dict) -> InvoiceSummariesSelector:
    ...
    if "ResourceType" in data:
        ...
        out["resource_type"] = (
            aws_sdk_invoicing.types.list_invoice_summaries_resource_type.deserialize_aws_json_1_0(
                data["ResourceType"]
            )
        )
    else:
