...
def serialize_aws_json_1_0(value: AmountBreakdown) -> dict:
    ...
    if "discounts" in value:
        import aws_sdk_invoicing.types.discounts_breakdown
        out["Discounts"] = aws_sdk_invoicing.types.discounts_breakdown.serialize_aws_json_1_0(value["discounts"])
    if "taxes" in value:
        import aws_sdk_invoicing.types.taxes_breakdown
        out["Taxes"] = aws_sdk_invoicing.types.taxes_breakdown.serialize_aws_json_1_0(value["taxes"])
    if "fees" in value:
        import aws_sdk_invoicing.types.fees_breakdown
        out["Fees"] = aws_sdk_invoicing.types.fees_breakdown.serialize_aws_json_1_0(value["fees"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> AmountBreakdown:
    ...
    if "Discounts" in data:
        import aws_sdk_invoicing.types.discounts_breakdown
        out["discounts"] = aws_sdk_invoicing.types.discounts_breakdown.deserialize_aws_json_1_0(data["Discounts"])
    if "Taxes" in data:
        import aws_sdk_invoicing.types.taxes_breakdown
        out["taxes"] = aws_sdk_invoicing.types.taxes_breakdown.deserialize_aws_json_1_0(data["Taxes"])
    if "Fees" in data:
        import aws_sdk_invoicing.types.fees_breakdown
        out["fees"] = aws_sdk_invoicing.types.fees_breakdown.deserialize_aws_json_1_0(data["Fees"])
    return out