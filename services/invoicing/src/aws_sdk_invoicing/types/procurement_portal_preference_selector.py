...
class ProcurementPortalPreferenceSelector(TypedDict):
    ...
    seller_of_records: NotRequired[
        "aws_sdk_invoicing.types.seller_of_records.SellerOfRecords"
    ]
...
def serialize_aws_json_1_0(value: ProcurementPortalPreferenceSelector) -> dict:
    ...
    if "invoice_unit_arns" in value:
        ...
        out["InvoiceUnitArns"] = (
            aws_sdk_invoicing.types.invoice_unit_arns.serialize_aws_json_1_0(
    ...
    if "seller_of_records" in value:
        ...
        out["SellerOfRecords"] = (
            aws_sdk_invoicing.types.seller_of_records.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ProcurementPortalPreferenceSelector:
    ...
    if "InvoiceUnitArns" in data:
        ...
        out["invoice_unit_arns"] = (
            aws_sdk_invoicing.types.invoice_unit_arns.deserialize_aws_json_1_0(
    ...
    if "SellerOfRecords" in data:
        ...
        out["seller_of_records"] = (
            aws_sdk_invoicing.types.seller_of_records.deserialize_aws_json_1_0(
