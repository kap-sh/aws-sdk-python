...
from capo_chime_sdk_meetings._services._aws_config import aws_config
...
class ChimeSDKMeetingsClientConfig(TypedDict, total=False, closed=True):
...
class ChimeSDKMeetingsClient:
    ...
    def batch_create_attendee(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.batch_create_attendee_request.BatchCreateAttendeeRequest]",
        ) -> OperationResponse[
            "capo_chime_sdk_meetings.types.batch_create_attendee_response.BatchCreateAttendeeResponse"
        ]:
            ...
            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.batch_create_attendee.batch_create_attendee(
    ...
    def batch_update_attendee_capabilities_except(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.batch_update_attendee_capabilities_except_request.BatchUpdateAttendeeCapabilitiesExceptRequest]",
        ) -> OperationResponse[None]:
            import capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.batch_update_attendee_capabilities_except

            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.batch_update_attendee_capabilities_except.batch_update_attendee_capabilities_except(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_attendee(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.create_attendee_request.CreateAttendeeRequest]",
        ) -> OperationResponse[
            "capo_chime_sdk_meetings.types.create_attendee_response.CreateAttendeeResponse"
        ]:
            ...
            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.create_attendee.create_attendee(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_meeting(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.create_meeting_request.CreateMeetingRequest]",
        ) -> OperationResponse[
            "capo_chime_sdk_meetings.types.create_meeting_response.CreateMeetingResponse"
        ]:
            ...
            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.create_meeting.create_meeting(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_meeting_with_attendees(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.create_meeting_with_attendees_request.CreateMeetingWithAttendeesRequest]",
        ) -> OperationResponse[
            "capo_chime_sdk_meetings.types.create_meeting_with_attendees_response.CreateMeetingWithAttendeesResponse"
        ]:
            ...
            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.create_meeting_with_attendees.create_meeting_with_attendees(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_attendee(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.delete_attendee_request.DeleteAttendeeRequest]",
        ) -> OperationResponse[None]:
            import capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.delete_attendee

            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.delete_attendee.delete_attendee(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_meeting(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.delete_meeting_request.DeleteMeetingRequest]",
        ) -> OperationResponse[None]:
            import capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.delete_meeting

            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.delete_meeting.delete_meeting(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_attendee(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.get_attendee_request.GetAttendeeRequest]",
        ) -> OperationResponse[
            "capo_chime_sdk_meetings.types.get_attendee_response.GetAttendeeResponse"
        ]:
            ...
            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.get_attendee.get_attendee(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_meeting(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.get_meeting_request.GetMeetingRequest]",
        ) -> OperationResponse[
            "capo_chime_sdk_meetings.types.get_meeting_response.GetMeetingResponse"
        ]:
            ...
            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.get_meeting.get_meeting(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_attendees(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.list_attendees_request.ListAttendeesRequest]",
        ) -> OperationResponse[
            "capo_chime_sdk_meetings.types.list_attendees_response.ListAttendeesResponse"
        ]:
            ...
            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.list_attendees.list_attendees(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_chime_sdk_meetings.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_meeting_transcription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.start_meeting_transcription_request.StartMeetingTranscriptionRequest]",
        ) -> OperationResponse[None]:
            import capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.start_meeting_transcription

            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.start_meeting_transcription.start_meeting_transcription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_meeting_transcription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.stop_meeting_transcription_request.StopMeetingTranscriptionRequest]",
        ) -> OperationResponse[None]:
            import capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.stop_meeting_transcription

            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.stop_meeting_transcription.stop_meeting_transcription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_chime_sdk_meetings.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_chime_sdk_meetings.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_attendee_capabilities(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chime_sdk_meetings.types.update_attendee_capabilities_request.UpdateAttendeeCapabilitiesRequest]",
        ) -> OperationResponse[
            "capo_chime_sdk_meetings.types.update_attendee_capabilities_response.UpdateAttendeeCapabilitiesResponse"
        ]:
            ...
            output, http_response = (
                capo_chime_sdk_meetings._operations.chime_meetings_sdk_service.update_attendee_capabilities.update_attendee_capabilities(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
