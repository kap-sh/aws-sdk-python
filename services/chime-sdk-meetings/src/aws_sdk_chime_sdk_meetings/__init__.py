...
from ._services.async_chime_sdk_meetings import (
    AsyncChimeSDKMeetingsClient as AsyncChimeSDKMeetingsClient,
)
from ._services.chime_sdk_meetings import (
    ChimeSDKMeetingsClient as ChimeSDKMeetingsClient,
)
