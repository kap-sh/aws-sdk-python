...
class ChimeSDKMeetingsError(Exception):
    """Base class for all ChimeSDKMeetings service errors."""


class ServiceError(ChimeSDKMeetingsError):
...
class SerializationError(ChimeSDKMeetingsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ChimeSDKMeetingsError):
...
class WaiterFailedError(ChimeSDKMeetingsError):
...
class WaiterTimeoutError(ChimeSDKMeetingsError):
