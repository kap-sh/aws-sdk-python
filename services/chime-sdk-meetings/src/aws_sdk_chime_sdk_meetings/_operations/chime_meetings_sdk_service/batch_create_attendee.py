...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_meetings.types.batch_create_attendee_response.BatchCreateAttendeeResponse = aws_sdk_chime_sdk_meetings.types.batch_create_attendee_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_meetings.types.batch_create_attendee_request.BatchCreateAttendeeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_meetings.types.batch_create_attendee_request.serialize_json(
            input_
        )
    ).encode()
