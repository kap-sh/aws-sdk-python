...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_meetings.types.get_attendee_response.GetAttendeeResponse = (
        aws_sdk_chime_sdk_meetings.types.get_attendee_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_meetings.types.get_attendee_request.GetAttendeeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
