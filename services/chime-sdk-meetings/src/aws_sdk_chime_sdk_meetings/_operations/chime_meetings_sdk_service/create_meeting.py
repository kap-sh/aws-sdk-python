"""Generated from Smithy shape ``com.amazonaws.chimesdkmeetings#CreateMeeting``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_meetings.types.create_meeting_response.CreateMeetingResponse = aws_sdk_chime_sdk_meetings.types.create_meeting_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_meetings.types.create_meeting_request.CreateMeetingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/meetings"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_chime_sdk_meetings.types.create_meeting_request

    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_meetings.types.create_meeting_request.serialize_json(input_)
    ).encode()
