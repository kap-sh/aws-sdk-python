...
def build_request(
    ...
    input: aws_sdk_chime_sdk_meetings.types.create_meeting_request.CreateMeetingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_meetings.types.create_meeting_request.serialize_json(input)
    ).encode()
