...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_meetings.types.start_meeting_transcription_request.StartMeetingTranscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_meetings.types.start_meeting_transcription_request.serialize_json(
            input_
        )
    ).encode()
