...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_meetings.types.update_attendee_capabilities_response.UpdateAttendeeCapabilitiesResponse = aws_sdk_chime_sdk_meetings.types.update_attendee_capabilities_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_meetings.types.update_attendee_capabilities_request.UpdateAttendeeCapabilitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_meetings.types.update_attendee_capabilities_request.serialize_json(
            input_
        )
    ).encode()
