...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_meetings.types.create_attendee_request.CreateAttendeeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_meetings.types.create_attendee_request.serialize_json(input_)
    ).encode()
