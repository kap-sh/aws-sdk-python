...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_meetings.types.get_meeting_response.GetMeetingResponse = (
        aws_sdk_chime_sdk_meetings.types.get_meeting_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_meetings.types.get_meeting_request.GetMeetingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
