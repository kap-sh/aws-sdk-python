...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_meetings.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_meetings.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_meetings.types.untag_resource_request.serialize_json(input_)
    ).encode()
