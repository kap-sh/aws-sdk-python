...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_meetings.types.list_attendees_response.ListAttendeesResponse = aws_sdk_chime_sdk_meetings.types.list_attendees_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_meetings.types.list_attendees_request.ListAttendeesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
