...
from aws_sdk_chime_sdk_meetings._services._aws_config import aaws_config
...
class AsyncChimeSDKMeetingsClientConfig(TypedDict, total=False):
...
class AsyncChimeSDKMeetingsClient:
    ...
    async def batch_create_attendee(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.batch_create_attendee_request.BatchCreateAttendeeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime_sdk_meetings.types.batch_create_attendee_response.BatchCreateAttendeeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.batch_create_attendee.async_batch_create_attendee(
    ...
    async def batch_update_attendee_capabilities_except(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.batch_update_attendee_capabilities_except_request.BatchUpdateAttendeeCapabilitiesExceptRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.batch_update_attendee_capabilities_except.async_batch_update_attendee_capabilities_except(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_attendee(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.create_attendee_request.CreateAttendeeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime_sdk_meetings.types.create_attendee_response.CreateAttendeeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.create_attendee.async_create_attendee(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_meeting(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.create_meeting_request.CreateMeetingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime_sdk_meetings.types.create_meeting_response.CreateMeetingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.create_meeting.async_create_meeting(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_meeting_with_attendees(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.create_meeting_with_attendees_request.CreateMeetingWithAttendeesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime_sdk_meetings.types.create_meeting_with_attendees_response.CreateMeetingWithAttendeesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.create_meeting_with_attendees.async_create_meeting_with_attendees(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_attendee(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.delete_attendee_request.DeleteAttendeeRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.delete_attendee.async_delete_attendee(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_meeting(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.delete_meeting_request.DeleteMeetingRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.delete_meeting.async_delete_meeting(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_attendee(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.get_attendee_request.GetAttendeeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime_sdk_meetings.types.get_attendee_response.GetAttendeeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.get_attendee.async_get_attendee(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_meeting(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.get_meeting_request.GetMeetingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime_sdk_meetings.types.get_meeting_response.GetMeetingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.get_meeting.async_get_meeting(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_attendees(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.list_attendees_request.ListAttendeesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime_sdk_meetings.types.list_attendees_response.ListAttendeesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.list_attendees.async_list_attendees(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime_sdk_meetings.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_meeting_transcription(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.start_meeting_transcription_request.StartMeetingTranscriptionRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.start_meeting_transcription.async_start_meeting_transcription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_meeting_transcription(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.stop_meeting_transcription_request.StopMeetingTranscriptionRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.stop_meeting_transcription.async_stop_meeting_transcription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime_sdk_meetings.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime_sdk_meetings.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_attendee_capabilities(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_chime_sdk_meetings.types.update_attendee_capabilities_request.UpdateAttendeeCapabilitiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_chime_sdk_meetings.types.update_attendee_capabilities_response.UpdateAttendeeCapabilitiesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_chime_sdk_meetings._operations.chime_meetings_sdk_service.update_attendee_capabilities.async_update_attendee_capabilities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
