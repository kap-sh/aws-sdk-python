...
class MediaPlacement(TypedDict, closed=True):
    ...
    signaling_url: NotRequired["aws_sdk_chime_sdk_meetings.types.string.String"]
    """<p>The signaling URL.</p>"""
    turn_control_url: NotRequired["aws_sdk_chime_sdk_meetings.types.string.String"]
    ...
    screen_data_url: NotRequired["aws_sdk_chime_sdk_meetings.types.string.String"]
    ...
    screen_viewing_url: NotRequired["aws_sdk_chime_sdk_meetings.types.string.String"]
    ...
    screen_sharing_url: NotRequired["aws_sdk_chime_sdk_meetings.types.string.String"]
    ...
    event_ingestion_url: NotRequired["aws_sdk_chime_sdk_meetings.types.string.String"]
