...
if TYPE_CHECKING:
    ...
    import aws_sdk_chime_sdk_meetings.types.audio_features
    import aws_sdk_chime_sdk_meetings.types.content_features
...
class MeetingFeaturesConfiguration(TypedDict, closed=True):
    ...
    content: NotRequired[
        "aws_sdk_chime_sdk_meetings.types.content_features.ContentFeatures"
    ]
    """<p>The configuration settings for the content features available to a meeting.</p>"""
    attendee: NotRequired[
        "aws_sdk_chime_sdk_meetings.types.attendee_features.AttendeeFeatures"
    ]
...
def serialize_json(value: MeetingFeaturesConfiguration) -> dict:
    ...
    if "audio" in value:
        ...
        out["Audio"] = aws_sdk_chime_sdk_meetings.types.audio_features.serialize_json(
            value["audio"]
        )
    if "video" in value:
        import aws_sdk_chime_sdk_meetings.types.video_features

        out["Video"] = aws_sdk_chime_sdk_meetings.types.video_features.serialize_json(
            value["video"]
        )
    if "content" in value:
        import aws_sdk_chime_sdk_meetings.types.content_features
        ...
        out["Content"] = (
            aws_sdk_chime_sdk_meetings.types.content_features.serialize_json(
                value["content"]
            )
        )
    if "attendee" in value:
        ...
        out["Attendee"] = (
            aws_sdk_chime_sdk_meetings.types.attendee_features.serialize_json(
                value["attendee"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> MeetingFeaturesConfiguration:
    ...
    if "Audio" in data:
        ...
        out["audio"] = aws_sdk_chime_sdk_meetings.types.audio_features.deserialize_json(
            data["Audio"]
        )
    if "Video" in data:
        import aws_sdk_chime_sdk_meetings.types.video_features

        out["video"] = aws_sdk_chime_sdk_meetings.types.video_features.deserialize_json(
            data["Video"]
        )
    if "Content" in data:
        import aws_sdk_chime_sdk_meetings.types.content_features
        ...
        out["content"] = (
            aws_sdk_chime_sdk_meetings.types.content_features.deserialize_json(
                data["Content"]
            )
        )
    if "Attendee" in data:
        ...
        out["attendee"] = (
            aws_sdk_chime_sdk_meetings.types.attendee_features.deserialize_json(
                data["Attendee"]
            )
        )
    return out
