...
```
pip install aws-sdk-chime-sdk-meetings
```

## Usage

```python
from aws_sdk_chime_sdk_meetings import AsyncChimeSDKMeetingsClient
...
```python
from aws_sdk_chime_sdk_meetings import AsyncChimeSDKMeetingsClient
from aws_sdk_chime_sdk_meetings.error import BadRequestException
