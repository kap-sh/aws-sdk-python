"""Generated from Smithy shape ``com.amazonaws.glue#OperationNotSupportedException``."""
...
class OperationNotSupportedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.glue#OperationNotSupportedException``."""
