"""Generated from Smithy shape ``com.amazonaws.glue#GetBlueprintRun``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_blueprint_run_response.GetBlueprintRunResponse = (
        aws_sdk_glue.types.get_blueprint_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_blueprint_run_request.GetBlueprintRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetBlueprintRun"
    import aws_sdk_glue.types.get_blueprint_run_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_blueprint_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_blueprint_run(
