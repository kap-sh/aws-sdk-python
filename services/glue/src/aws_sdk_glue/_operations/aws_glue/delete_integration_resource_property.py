"""Generated from Smithy shape ``com.amazonaws.glue#DeleteIntegrationResourceProperty``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_integration_resource_property_response.DeleteIntegrationResourcePropertyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_integration_resource_property_request.DeleteIntegrationResourcePropertyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteIntegrationResourceProperty"
    import aws_sdk_glue.types.delete_integration_resource_property_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_integration_resource_property_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_integration_resource_property(
