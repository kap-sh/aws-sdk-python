"""Generated from Smithy shape ``com.amazonaws.glue#PutDataQualityProfileAnnotation``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.put_data_quality_profile_annotation_response.PutDataQualityProfileAnnotationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.put_data_quality_profile_annotation_request.PutDataQualityProfileAnnotationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.PutDataQualityProfileAnnotation"
    import aws_sdk_glue.types.put_data_quality_profile_annotation_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.put_data_quality_profile_annotation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_data_quality_profile_annotation(
