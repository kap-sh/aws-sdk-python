"""Generated from Smithy shape ``com.amazonaws.glue#StopSession``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.stop_session_response.StopSessionResponse = (
        aws_sdk_glue.types.stop_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.stop_session_request.StopSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.StopSession"
    import aws_sdk_glue.types.stop_session_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.stop_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_session(
    ...
    aws_sdk_glue.types.stop_session_response.StopSessionResponse, zapros.Response
]:
