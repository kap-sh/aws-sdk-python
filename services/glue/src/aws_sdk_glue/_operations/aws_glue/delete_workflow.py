...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_workflow_response.DeleteWorkflowResponse = (
        aws_sdk_glue.types.delete_workflow_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_workflow_request.DeleteWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_workflow_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_workflow(
    ...
    aws_sdk_glue.types.delete_workflow_response.DeleteWorkflowResponse, zapros.Response
]:
