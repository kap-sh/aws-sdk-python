...
def handle_response(
    ...
    out: aws_sdk_glue.types.stop_trigger_response.StopTriggerResponse = (
        aws_sdk_glue.types.stop_trigger_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.stop_trigger_request.StopTriggerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.stop_trigger_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_trigger(
    ...
    aws_sdk_glue.types.stop_trigger_response.StopTriggerResponse, zapros.Response
]:
