...
def build_request(
    ...
    input_: aws_sdk_glue.types.test_connection_request.TestConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.test_connection_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def test_connection(
    ...
    aws_sdk_glue.types.test_connection_response.TestConnectionResponse, zapros.Response
]:
