...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_plan_response.GetPlanResponse = (
        aws_sdk_glue.types.get_plan_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_glue.types.get_plan_request.GetPlanRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_plan_request.serialize_aws_json_1_1(input)
    ).encode()
...
def get_plan(
    options: OperationOptions, input: aws_sdk_glue.types.get_plan_request.GetPlanRequest
) -> tuple[aws_sdk_glue.types.get_plan_response.GetPlanResponse, zapros.Response]:
