"""Generated from Smithy shape ``com.amazonaws.glue#ListDataQualityRulesets``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_data_quality_rulesets_response.ListDataQualityRulesetsResponse = aws_sdk_glue.types.list_data_quality_rulesets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_data_quality_rulesets_request.ListDataQualityRulesetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListDataQualityRulesets"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_data_quality_rulesets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_data_quality_rulesets(
