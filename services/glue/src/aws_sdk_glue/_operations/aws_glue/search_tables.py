"""Generated from Smithy shape ``com.amazonaws.glue#SearchTables``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.search_tables_response.SearchTablesResponse = (
        aws_sdk_glue.types.search_tables_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.search_tables_request.SearchTablesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.search_tables_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def search_tables(
    ...
    aws_sdk_glue.types.search_tables_response.SearchTablesResponse, zapros.Response
]:
