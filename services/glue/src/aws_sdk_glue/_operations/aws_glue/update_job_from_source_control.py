"""Generated from Smithy shape ``com.amazonaws.glue#UpdateJobFromSourceControl``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_job_from_source_control_response.UpdateJobFromSourceControlResponse = aws_sdk_glue.types.update_job_from_source_control_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_job_from_source_control_request.UpdateJobFromSourceControlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateJobFromSourceControl"
    import aws_sdk_glue.types.update_job_from_source_control_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_job_from_source_control_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_job_from_source_control(
