...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_dev_endpoint_response.CreateDevEndpointResponse = (
        aws_sdk_glue.types.create_dev_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_dev_endpoint_request.CreateDevEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_dev_endpoint_request.serialize_aws_json_1_1(input_)
    ).encode()
