...
def build_request(
    ...
    input: aws_sdk_glue.types.create_dev_endpoint_request.CreateDevEndpointRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_dev_endpoint_request.serialize_aws_json_1_1(input)
    ).encode()
