"""Generated from Smithy shape ``com.amazonaws.glue#RegisterConnectionType``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.register_connection_type_response.RegisterConnectionTypeResponse = aws_sdk_glue.types.register_connection_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.register_connection_type_request.RegisterConnectionTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.RegisterConnectionType"
    import aws_sdk_glue.types.register_connection_type_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.register_connection_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_register_connection_type(
