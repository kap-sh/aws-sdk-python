"""Generated from Smithy shape ``com.amazonaws.glue#GetJobRuns``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_job_runs_response.GetJobRunsResponse = (
        aws_sdk_glue.types.get_job_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_job_runs_request.GetJobRunsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_job_runs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_job_runs(
    ...
    aws_sdk_glue.types.get_job_runs_response.GetJobRunsResponse, zapros.Response
]:
