...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_session_response.CreateSessionResponse = (
        aws_sdk_glue.types.create_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_session_request.CreateSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_session(
    ...
    aws_sdk_glue.types.create_session_response.CreateSessionResponse, zapros.Response
]:
