"""Generated from Smithy shape ``com.amazonaws.glue#GetBlueprint``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_blueprint_response.GetBlueprintResponse = (
        aws_sdk_glue.types.get_blueprint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_blueprint_request.GetBlueprintRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetBlueprint"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_blueprint_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_blueprint(
    ...
    aws_sdk_glue.types.get_blueprint_response.GetBlueprintResponse, zapros.Response
]:
