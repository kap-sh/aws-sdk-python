...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_custom_entity_type_response.GetCustomEntityTypeResponse = aws_sdk_glue.types.get_custom_entity_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_custom_entity_type_request.GetCustomEntityTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_custom_entity_type_request.serialize_aws_json_1_1(input_)
    ).encode()
