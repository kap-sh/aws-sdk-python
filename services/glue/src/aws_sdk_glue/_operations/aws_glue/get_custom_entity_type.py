...
def build_request(
    ...
    input: aws_sdk_glue.types.get_custom_entity_type_request.GetCustomEntityTypeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_custom_entity_type_request.serialize_aws_json_1_1(input)
    ).encode()
