"""Generated from Smithy shape ``com.amazonaws.glue#ListSchemas``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_schemas_response.ListSchemasResponse = (
        aws_sdk_glue.types.list_schemas_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_schemas_input.ListSchemasInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListSchemas"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_schemas_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_schemas(
    ...
    aws_sdk_glue.types.list_schemas_response.ListSchemasResponse, zapros.Response
]:
