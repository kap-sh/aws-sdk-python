...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_crawler_schedule_response.UpdateCrawlerScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_glue.types.update_crawler_schedule_request.UpdateCrawlerScheduleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_crawler_schedule_request.serialize_aws_json_1_1(input)
    ).encode()
