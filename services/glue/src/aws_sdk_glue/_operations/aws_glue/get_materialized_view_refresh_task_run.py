"""Generated from Smithy shape ``com.amazonaws.glue#GetMaterializedViewRefreshTaskRun``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_materialized_view_refresh_task_run_response.GetMaterializedViewRefreshTaskRunResponse = aws_sdk_glue.types.get_materialized_view_refresh_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_materialized_view_refresh_task_run_request.GetMaterializedViewRefreshTaskRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetMaterializedViewRefreshTaskRun"
    import aws_sdk_glue.types.get_materialized_view_refresh_task_run_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_materialized_view_refresh_task_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_materialized_view_refresh_task_run(
