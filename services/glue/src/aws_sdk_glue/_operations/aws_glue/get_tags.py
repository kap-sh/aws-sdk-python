...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_tags_response.GetTagsResponse = (
        aws_sdk_glue.types.get_tags_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_glue.types.get_tags_request.GetTagsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_tags_request.serialize_aws_json_1_1(input)
    ).encode()
...
def get_tags(
    options: OperationOptions, input: aws_sdk_glue.types.get_tags_request.GetTagsRequest
) -> tuple[aws_sdk_glue.types.get_tags_response.GetTagsResponse, zapros.Response]:
