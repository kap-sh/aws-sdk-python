...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_dataflow_graph_response.GetDataflowGraphResponse = (
        aws_sdk_glue.types.get_dataflow_graph_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_dataflow_graph_request.GetDataflowGraphRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_dataflow_graph_request.serialize_aws_json_1_1(input_)
    ).encode()
