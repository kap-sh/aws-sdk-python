"""Generated from Smithy shape ``com.amazonaws.glue#UpdateCatalog``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_catalog_response.UpdateCatalogResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_catalog_request.UpdateCatalogRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateCatalog"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_catalog_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_catalog(
    ...
    aws_sdk_glue.types.update_catalog_response.UpdateCatalogResponse, zapros.Response
]:
