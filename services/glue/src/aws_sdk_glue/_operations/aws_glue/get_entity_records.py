"""Generated from Smithy shape ``com.amazonaws.glue#GetEntityRecords``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_entity_records_response.GetEntityRecordsResponse = (
        aws_sdk_glue.types.get_entity_records_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_entity_records_request.GetEntityRecordsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetEntityRecords"
    import aws_sdk_glue.types.get_entity_records_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_entity_records_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_entity_records(
