...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_table_response.UpdateTableResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_table_request.UpdateTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_table_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_table(
    ...
    aws_sdk_glue.types.update_table_response.UpdateTableResponse, zapros.Response
]:
