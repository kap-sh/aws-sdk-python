...
def build_request(
    ...
    input: aws_sdk_glue.types.update_table_optimizer_request.UpdateTableOptimizerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_table_optimizer_request.serialize_aws_json_1_1(input)
    ).encode()
