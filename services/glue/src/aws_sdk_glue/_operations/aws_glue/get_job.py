...
def build_request(
    ...
    input: aws_sdk_glue.types.get_job_request.GetJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_job_request.serialize_aws_json_1_1(input)
    ).encode()
...
def get_job(
    options: OperationOptions, input: aws_sdk_glue.types.get_job_request.GetJobRequest
