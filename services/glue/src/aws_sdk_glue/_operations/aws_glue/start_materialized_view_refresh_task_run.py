"""Generated from Smithy shape ``com.amazonaws.glue#StartMaterializedViewRefreshTaskRun``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MaterializedViewRefreshTaskRunningException":
            import aws_sdk_glue.errors.materialized_view_refresh_task_running_exception

            raise aws_sdk_glue.errors.materialized_view_refresh_task_running_exception.MaterializedViewRefreshTaskRunningException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.start_materialized_view_refresh_task_run_response.StartMaterializedViewRefreshTaskRunResponse = aws_sdk_glue.types.start_materialized_view_refresh_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.start_materialized_view_refresh_task_run_request.StartMaterializedViewRefreshTaskRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.StartMaterializedViewRefreshTaskRun"
    import aws_sdk_glue.types.start_materialized_view_refresh_task_run_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_materialized_view_refresh_task_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_materialized_view_refresh_task_run(
