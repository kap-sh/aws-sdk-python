...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_glue_identity_center_configuration_response.UpdateGlueIdentityCenterConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_glue_identity_center_configuration_request.UpdateGlueIdentityCenterConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_glue_identity_center_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
