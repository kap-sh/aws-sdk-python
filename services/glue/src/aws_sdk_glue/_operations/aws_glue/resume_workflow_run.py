...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IllegalWorkflowStateException":
            import aws_sdk_glue.errors.illegal_workflow_state_exception

            raise aws_sdk_glue.errors.illegal_workflow_state_exception.IllegalWorkflowStateException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.resume_workflow_run_response.ResumeWorkflowRunResponse = (
        aws_sdk_glue.types.resume_workflow_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.resume_workflow_run_request.ResumeWorkflowRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.resume_workflow_run_request.serialize_aws_json_1_1(input_)
    ).encode()
