"""Generated from Smithy shape ``com.amazonaws.glue#DeleteCrawler``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CrawlerRunningException":
            import aws_sdk_glue.errors.crawler_running_exception

            raise aws_sdk_glue.errors.crawler_running_exception.CrawlerRunningException.from_aws_json_1_1(
                data
            )
        ...
        case "SchedulerTransitioningException":
            import aws_sdk_glue.errors.scheduler_transitioning_exception

            raise aws_sdk_glue.errors.scheduler_transitioning_exception.SchedulerTransitioningException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_crawler_response.DeleteCrawlerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_crawler_request.DeleteCrawlerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_crawler_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_crawler(
    ...
    aws_sdk_glue.types.delete_crawler_response.DeleteCrawlerResponse, zapros.Response
]:
...
async def async_delete_crawler(
