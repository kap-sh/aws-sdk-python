...
def build_request(
    ...
    input: aws_sdk_glue.types.get_data_quality_model_request.GetDataQualityModelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_data_quality_model_request.serialize_aws_json_1_1(input)
    ).encode()
