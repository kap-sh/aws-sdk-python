...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_data_quality_model_response.GetDataQualityModelResponse = aws_sdk_glue.types.get_data_quality_model_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_data_quality_model_request.GetDataQualityModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_data_quality_model_request.serialize_aws_json_1_1(input_)
    ).encode()
