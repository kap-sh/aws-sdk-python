...
def handle_response(
    ...
    out: aws_sdk_glue.types.start_trigger_response.StartTriggerResponse = (
        aws_sdk_glue.types.start_trigger_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.start_trigger_request.StartTriggerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_trigger_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_trigger(
    ...
    aws_sdk_glue.types.start_trigger_response.StartTriggerResponse, zapros.Response
]:
