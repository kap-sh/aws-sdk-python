"""Generated from Smithy shape ``com.amazonaws.glue#ListDevEndpoints``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_dev_endpoints_response.ListDevEndpointsResponse = (
        aws_sdk_glue.types.list_dev_endpoints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_dev_endpoints_request.ListDevEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_dev_endpoints_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_dev_endpoints(
