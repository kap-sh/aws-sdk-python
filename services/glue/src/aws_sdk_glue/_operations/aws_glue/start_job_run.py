"""Generated from Smithy shape ``com.amazonaws.glue#StartJobRun``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.start_job_run_response.StartJobRunResponse = (
        aws_sdk_glue.types.start_job_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.start_job_run_request.StartJobRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_job_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_job_run(
    ...
    aws_sdk_glue.types.start_job_run_response.StartJobRunResponse, zapros.Response
]:
