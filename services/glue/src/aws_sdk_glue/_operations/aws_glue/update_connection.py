"""Generated from Smithy shape ``com.amazonaws.glue#UpdateConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_connection_response.UpdateConnectionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_connection_request.UpdateConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_connection_request.serialize_aws_json_1_1(input_)
    ).encode()
