"""Generated from Smithy shape ``com.amazonaws.glue#BatchDeleteConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_delete_connection_response.BatchDeleteConnectionResponse = aws_sdk_glue.types.batch_delete_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_glue.types.batch_delete_connection_request.BatchDeleteConnectionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_delete_connection_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_batch_delete_connection(
