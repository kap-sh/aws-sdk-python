...
def build_request(
    ...
    input: aws_sdk_glue.types.delete_integration_request.DeleteIntegrationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_integration_request.serialize_aws_json_1_1(input)
    ).encode()
