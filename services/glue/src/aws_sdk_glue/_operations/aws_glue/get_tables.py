"""Generated from Smithy shape ``com.amazonaws.glue#GetTables``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_tables_response.GetTablesResponse = (
        aws_sdk_glue.types.get_tables_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_tables_request.GetTablesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_tables_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_tables(
    ...
    input_: aws_sdk_glue.types.get_tables_request.GetTablesRequest,
) -> tuple[aws_sdk_glue.types.get_tables_response.GetTablesResponse, zapros.Response]:
