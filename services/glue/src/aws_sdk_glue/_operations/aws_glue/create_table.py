"""Generated from Smithy shape ``com.amazonaws.glue#CreateTable``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotReadyException":
            import aws_sdk_glue.errors.resource_not_ready_exception

            raise aws_sdk_glue.errors.resource_not_ready_exception.ResourceNotReadyException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_table_response.CreateTableResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_table_request.CreateTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_table_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_table(
    ...
    aws_sdk_glue.types.create_table_response.CreateTableResponse, zapros.Response
]:
