"""Generated from Smithy shape ``com.amazonaws.glue#GetJobRun``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_job_run_response.GetJobRunResponse = (
        aws_sdk_glue.types.get_job_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_job_run_request.GetJobRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_job_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_job_run(
    ...
    input_: aws_sdk_glue.types.get_job_run_request.GetJobRunRequest,
) -> tuple[aws_sdk_glue.types.get_job_run_response.GetJobRunResponse, zapros.Response]:
