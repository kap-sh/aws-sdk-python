...
def handle_response(
    ...
    out: aws_sdk_glue.types.stop_column_statistics_task_run_schedule_response.StopColumnStatisticsTaskRunScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.stop_column_statistics_task_run_schedule_request.StopColumnStatisticsTaskRunScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.stop_column_statistics_task_run_schedule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
