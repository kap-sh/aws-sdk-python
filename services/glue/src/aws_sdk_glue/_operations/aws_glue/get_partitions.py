...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_partitions_response.GetPartitionsResponse = (
        aws_sdk_glue.types.get_partitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_partitions_request.GetPartitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_partitions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_partitions(
    ...
    aws_sdk_glue.types.get_partitions_response.GetPartitionsResponse, zapros.Response
]:
