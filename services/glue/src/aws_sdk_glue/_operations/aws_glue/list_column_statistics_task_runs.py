...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_column_statistics_task_runs_response.ListColumnStatisticsTaskRunsResponse = aws_sdk_glue.types.list_column_statistics_task_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_column_statistics_task_runs_request.ListColumnStatisticsTaskRunsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_column_statistics_task_runs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
