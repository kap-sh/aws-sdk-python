"""Generated from Smithy shape ``com.amazonaws.glue#GetMLTransform``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_ml_transform_response.GetMLTransformResponse = (
        aws_sdk_glue.types.get_ml_transform_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_ml_transform_request.GetMLTransformRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_ml_transform_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_ml_transform(
    ...
    aws_sdk_glue.types.get_ml_transform_response.GetMLTransformResponse, zapros.Response
]:
...
async def async_get_ml_transform(
