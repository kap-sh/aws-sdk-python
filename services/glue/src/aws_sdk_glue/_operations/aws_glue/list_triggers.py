...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_triggers_response.ListTriggersResponse = (
        aws_sdk_glue.types.list_triggers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_triggers_request.ListTriggersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_triggers_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_triggers(
    ...
    aws_sdk_glue.types.list_triggers_response.ListTriggersResponse, zapros.Response
]:
