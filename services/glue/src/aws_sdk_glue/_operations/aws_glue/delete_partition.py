...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_partition_response.DeletePartitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_partition_request.DeletePartitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_partition_request.serialize_aws_json_1_1(input_)
    ).encode()
