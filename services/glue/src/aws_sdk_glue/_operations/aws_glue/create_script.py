...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_script_response.CreateScriptResponse = (
        aws_sdk_glue.types.create_script_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_script_request.CreateScriptRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_script_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_script(
    ...
    aws_sdk_glue.types.create_script_response.CreateScriptResponse, zapros.Response
]:
