...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_unfiltered_partitions_metadata_response.GetUnfilteredPartitionsMetadataResponse = aws_sdk_glue.types.get_unfiltered_partitions_metadata_response.deserialize_aws_json_1_1(
