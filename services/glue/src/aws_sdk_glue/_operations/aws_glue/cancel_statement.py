"""Generated from Smithy shape ``com.amazonaws.glue#CancelStatement``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.cancel_statement_response.CancelStatementResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.cancel_statement_request.CancelStatementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CancelStatement"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.cancel_statement_request.serialize_aws_json_1_1(input_)
    ).encode()
