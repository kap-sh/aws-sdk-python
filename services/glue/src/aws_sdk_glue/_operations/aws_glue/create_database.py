"""Generated from Smithy shape ``com.amazonaws.glue#CreateDatabase``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FederatedResourceAlreadyExistsException":
            import aws_sdk_glue.errors.federated_resource_already_exists_exception

            raise aws_sdk_glue.errors.federated_resource_already_exists_exception.FederatedResourceAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_database_response.CreateDatabaseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_database_request.CreateDatabaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_database_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_database(
    ...
    aws_sdk_glue.types.create_database_response.CreateDatabaseResponse, zapros.Response
]:
