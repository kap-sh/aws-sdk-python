"""Generated from Smithy shape ``com.amazonaws.glue#ListEntities``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_entities_response.ListEntitiesResponse = (
        aws_sdk_glue.types.list_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_entities_request.ListEntitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListEntities"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_entities_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_entities(
    ...
    aws_sdk_glue.types.list_entities_response.ListEntitiesResponse, zapros.Response
]:
