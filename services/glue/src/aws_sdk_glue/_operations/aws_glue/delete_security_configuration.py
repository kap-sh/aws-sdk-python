...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_security_configuration_response.DeleteSecurityConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_security_configuration_request.DeleteSecurityConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_security_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
