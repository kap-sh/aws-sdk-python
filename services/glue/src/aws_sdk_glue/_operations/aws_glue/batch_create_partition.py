...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_create_partition_response.BatchCreatePartitionResponse = aws_sdk_glue.types.batch_create_partition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_create_partition_request.BatchCreatePartitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_create_partition_request.serialize_aws_json_1_1(input_)
    ).encode()
