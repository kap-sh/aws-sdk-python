"""Generated from Smithy shape ``com.amazonaws.glue#BatchUpdatePartition``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_update_partition_response.BatchUpdatePartitionResponse = aws_sdk_glue.types.batch_update_partition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_update_partition_request.BatchUpdatePartitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.BatchUpdatePartition"
    import aws_sdk_glue.types.batch_update_partition_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_update_partition_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_batch_update_partition(
