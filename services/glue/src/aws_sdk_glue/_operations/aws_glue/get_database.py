...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_database_response.GetDatabaseResponse = (
        aws_sdk_glue.types.get_database_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_database_request.GetDatabaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_database_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_database(
    ...
    aws_sdk_glue.types.get_database_response.GetDatabaseResponse, zapros.Response
]:
