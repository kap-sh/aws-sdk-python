"""Generated from Smithy shape ``com.amazonaws.glue#StartCrawler``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.start_crawler_response.StartCrawlerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.start_crawler_request.StartCrawlerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_crawler_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_crawler(
    ...
    aws_sdk_glue.types.start_crawler_response.StartCrawlerResponse, zapros.Response
]:
