"""Generated from Smithy shape ``com.amazonaws.glue#BatchGetJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_get_jobs_response.BatchGetJobsResponse = (
        aws_sdk_glue.types.batch_get_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_get_jobs_request.BatchGetJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_get_jobs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def batch_get_jobs(
    ...
    aws_sdk_glue.types.batch_get_jobs_response.BatchGetJobsResponse, zapros.Response
]:
...
async def async_batch_get_jobs(
