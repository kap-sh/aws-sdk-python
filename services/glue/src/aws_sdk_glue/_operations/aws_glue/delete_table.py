"""Generated from Smithy shape ``com.amazonaws.glue#DeleteTable``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_table_response.DeleteTableResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_table_request.DeleteTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_table_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_table(
    ...
    aws_sdk_glue.types.delete_table_response.DeleteTableResponse, zapros.Response
]:
