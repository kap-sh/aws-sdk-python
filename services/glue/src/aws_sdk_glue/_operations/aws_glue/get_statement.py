"""Generated from Smithy shape ``com.amazonaws.glue#GetStatement``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_statement_response.GetStatementResponse = (
        aws_sdk_glue.types.get_statement_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_statement_request.GetStatementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetStatement"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_statement_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_statement(
    ...
    aws_sdk_glue.types.get_statement_response.GetStatementResponse, zapros.Response
]:
