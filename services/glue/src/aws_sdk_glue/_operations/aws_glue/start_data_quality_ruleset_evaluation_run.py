"""Generated from Smithy shape ``com.amazonaws.glue#StartDataQualityRulesetEvaluationRun``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.start_data_quality_ruleset_evaluation_run_response.StartDataQualityRulesetEvaluationRunResponse = aws_sdk_glue.types.start_data_quality_ruleset_evaluation_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.start_data_quality_ruleset_evaluation_run_request.StartDataQualityRulesetEvaluationRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.StartDataQualityRulesetEvaluationRun"
    import aws_sdk_glue.types.start_data_quality_ruleset_evaluation_run_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_data_quality_ruleset_evaluation_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_data_quality_ruleset_evaluation_run(
