"""Generated from Smithy shape ``com.amazonaws.glue#StopColumnStatisticsTaskRun``."""
...
import aws_sdk_glue.errors.column_statistics_task_not_running_exception
import aws_sdk_glue.errors.column_statistics_task_stopping_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ColumnStatisticsTaskNotRunningException":
            raise aws_sdk_glue.errors.column_statistics_task_not_running_exception.ColumnStatisticsTaskNotRunningException.from_aws_json_1_1(
                data
            )
        case "ColumnStatisticsTaskStoppingException":
            raise aws_sdk_glue.errors.column_statistics_task_stopping_exception.ColumnStatisticsTaskStoppingException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.stop_column_statistics_task_run_response.StopColumnStatisticsTaskRunResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.stop_column_statistics_task_run_request.StopColumnStatisticsTaskRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.StopColumnStatisticsTaskRun"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.stop_column_statistics_task_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_column_statistics_task_run(
