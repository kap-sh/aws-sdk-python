...
def build_request(
    ...
    input: aws_sdk_glue.types.batch_get_partition_request.BatchGetPartitionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_get_partition_request.serialize_aws_json_1_1(input)
    ).encode()
