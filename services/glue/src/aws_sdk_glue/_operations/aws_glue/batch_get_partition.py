...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_get_partition_response.BatchGetPartitionResponse = (
        aws_sdk_glue.types.batch_get_partition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_get_partition_request.BatchGetPartitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_get_partition_request.serialize_aws_json_1_1(input_)
    ).encode()
