"""Generated from Smithy shape ``com.amazonaws.glue#BatchGetCustomEntityTypes``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_get_custom_entity_types_response.BatchGetCustomEntityTypesResponse = aws_sdk_glue.types.batch_get_custom_entity_types_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_get_custom_entity_types_request.BatchGetCustomEntityTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.BatchGetCustomEntityTypes"
    import aws_sdk_glue.types.batch_get_custom_entity_types_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_get_custom_entity_types_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_get_custom_entity_types(
