...
def build_request(
    ...
    input: aws_sdk_glue.types.batch_delete_partition_request.BatchDeletePartitionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_delete_partition_request.serialize_aws_json_1_1(input)
    ).encode()
