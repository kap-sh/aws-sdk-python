"""Generated from Smithy shape ``com.amazonaws.glue#ListSchemaVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_schema_versions_response.ListSchemaVersionsResponse = (
        aws_sdk_glue.types.list_schema_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_schema_versions_input.ListSchemaVersionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListSchemaVersions"
    import aws_sdk_glue.types.list_schema_versions_input

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_schema_versions_input.serialize_aws_json_1_1(input_)
    ).encode()
