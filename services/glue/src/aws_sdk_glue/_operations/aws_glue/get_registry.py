"""Generated from Smithy shape ``com.amazonaws.glue#GetRegistry``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_registry_response.GetRegistryResponse = (
        aws_sdk_glue.types.get_registry_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_registry_input.GetRegistryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetRegistry"
    import aws_sdk_glue.types.get_registry_input

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_registry_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_registry(
    ...
    aws_sdk_glue.types.get_registry_response.GetRegistryResponse, zapros.Response
]:
