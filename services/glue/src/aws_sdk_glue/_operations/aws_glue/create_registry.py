...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_registry_response.CreateRegistryResponse = (
        aws_sdk_glue.types.create_registry_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_registry_input.CreateRegistryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_registry_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_registry(
    ...
    aws_sdk_glue.types.create_registry_response.CreateRegistryResponse, zapros.Response
]:
