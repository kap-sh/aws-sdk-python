"""Generated from Smithy shape ``com.amazonaws.glue#GetMapping``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_mapping_response.GetMappingResponse = (
        aws_sdk_glue.types.get_mapping_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_mapping_request.GetMappingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_mapping_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_mapping(
    ...
    input_: aws_sdk_glue.types.get_mapping_request.GetMappingRequest,
) -> tuple[aws_sdk_glue.types.get_mapping_response.GetMappingResponse, zapros.Response]:
