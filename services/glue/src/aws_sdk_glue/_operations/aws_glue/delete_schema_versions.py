...
def build_request(
    ...
    input: aws_sdk_glue.types.delete_schema_versions_input.DeleteSchemaVersionsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_schema_versions_input.serialize_aws_json_1_1(input)
    ).encode()
