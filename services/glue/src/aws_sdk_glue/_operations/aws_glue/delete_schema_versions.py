"""Generated from Smithy shape ``com.amazonaws.glue#DeleteSchemaVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_schema_versions_response.DeleteSchemaVersionsResponse = aws_sdk_glue.types.delete_schema_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_schema_versions_input.DeleteSchemaVersionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteSchemaVersions"
    import aws_sdk_glue.types.delete_schema_versions_input

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_schema_versions_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_schema_versions(
