...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_dev_endpoint_response.GetDevEndpointResponse = (
        aws_sdk_glue.types.get_dev_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_dev_endpoint_request.GetDevEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_dev_endpoint_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_dev_endpoint(
    ...
    aws_sdk_glue.types.get_dev_endpoint_response.GetDevEndpointResponse, zapros.Response
]:
