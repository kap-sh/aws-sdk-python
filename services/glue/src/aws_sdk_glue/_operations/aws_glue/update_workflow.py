"""Generated from Smithy shape ``com.amazonaws.glue#UpdateWorkflow``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_workflow_response.UpdateWorkflowResponse = (
        aws_sdk_glue.types.update_workflow_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_workflow_request.UpdateWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_workflow_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_workflow(
    ...
    aws_sdk_glue.types.update_workflow_response.UpdateWorkflowResponse, zapros.Response
]:
