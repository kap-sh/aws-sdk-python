"""Generated from Smithy shape ``com.amazonaws.glue#GetSchema``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_schema_response.GetSchemaResponse = (
        aws_sdk_glue.types.get_schema_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_glue.types.get_schema_input.GetSchemaInput,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetSchema"
    import aws_sdk_glue.types.get_schema_input

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_schema_input.serialize_aws_json_1_1(input)
    ).encode()
...
def get_schema(
    options: OperationOptions, input: aws_sdk_glue.types.get_schema_input.GetSchemaInput
) -> tuple[aws_sdk_glue.types.get_schema_response.GetSchemaResponse, zapros.Response]:
