"""Generated from Smithy shape ``com.amazonaws.glue#UpdateUsageProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_usage_profile_response.UpdateUsageProfileResponse = (
        aws_sdk_glue.types.update_usage_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_usage_profile_request.UpdateUsageProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateUsageProfile"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_usage_profile_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_usage_profile(
