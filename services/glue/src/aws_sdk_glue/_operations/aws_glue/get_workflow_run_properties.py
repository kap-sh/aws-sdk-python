...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_workflow_run_properties_response.GetWorkflowRunPropertiesResponse = aws_sdk_glue.types.get_workflow_run_properties_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_workflow_run_properties_request.GetWorkflowRunPropertiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_workflow_run_properties_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
