"""Generated from Smithy shape ``com.amazonaws.glue#StartMLLabelingSetGenerationTaskRun``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.start_ml_labeling_set_generation_task_run_response.StartMLLabelingSetGenerationTaskRunResponse = aws_sdk_glue.types.start_ml_labeling_set_generation_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.start_ml_labeling_set_generation_task_run_request.StartMLLabelingSetGenerationTaskRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_ml_labeling_set_generation_task_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_ml_labeling_set_generation_task_run(
