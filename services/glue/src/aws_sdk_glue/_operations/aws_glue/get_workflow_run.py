"""Generated from Smithy shape ``com.amazonaws.glue#GetWorkflowRun``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_workflow_run_response.GetWorkflowRunResponse = (
        aws_sdk_glue.types.get_workflow_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_workflow_run_request.GetWorkflowRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_workflow_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_workflow_run(
    ...
    aws_sdk_glue.types.get_workflow_run_response.GetWorkflowRunResponse, zapros.Response
]:
