...
def build_request(
    ...
    input: aws_sdk_glue.types.create_usage_profile_request.CreateUsageProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_usage_profile_request.serialize_aws_json_1_1(input)
    ).encode()
