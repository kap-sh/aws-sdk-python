...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_blueprint_runs_response.GetBlueprintRunsResponse = (
        aws_sdk_glue.types.get_blueprint_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_blueprint_runs_request.GetBlueprintRunsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_blueprint_runs_request.serialize_aws_json_1_1(input_)
    ).encode()
