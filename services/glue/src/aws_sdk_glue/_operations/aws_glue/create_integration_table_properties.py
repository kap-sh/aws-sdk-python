...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_integration_table_properties_response.CreateIntegrationTablePropertiesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_integration_table_properties_request.CreateIntegrationTablePropertiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_integration_table_properties_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
