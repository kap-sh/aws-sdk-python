"""Generated from Smithy shape ``com.amazonaws.glue#PutWorkflowRunProperties``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.put_workflow_run_properties_response.PutWorkflowRunPropertiesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.put_workflow_run_properties_request.PutWorkflowRunPropertiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.put_workflow_run_properties_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_workflow_run_properties(
