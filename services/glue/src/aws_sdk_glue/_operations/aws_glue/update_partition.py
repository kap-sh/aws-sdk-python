"""Generated from Smithy shape ``com.amazonaws.glue#UpdatePartition``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_partition_response.UpdatePartitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_partition_request.UpdatePartitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_partition_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_partition(
