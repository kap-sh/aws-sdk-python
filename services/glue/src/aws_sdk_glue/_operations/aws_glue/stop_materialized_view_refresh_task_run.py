"""Generated from Smithy shape ``com.amazonaws.glue#StopMaterializedViewRefreshTaskRun``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MaterializedViewRefreshTaskNotRunningException":
            import aws_sdk_glue.errors.materialized_view_refresh_task_not_running_exception

            raise aws_sdk_glue.errors.materialized_view_refresh_task_not_running_exception.MaterializedViewRefreshTaskNotRunningException.from_aws_json_1_1(
                data
            )
        case "MaterializedViewRefreshTaskStoppingException":
            import aws_sdk_glue.errors.materialized_view_refresh_task_stopping_exception

            raise aws_sdk_glue.errors.materialized_view_refresh_task_stopping_exception.MaterializedViewRefreshTaskStoppingException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.stop_materialized_view_refresh_task_run_response.StopMaterializedViewRefreshTaskRunResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.stop_materialized_view_refresh_task_run_request.StopMaterializedViewRefreshTaskRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.StopMaterializedViewRefreshTaskRun"
    import aws_sdk_glue.types.stop_materialized_view_refresh_task_run_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.stop_materialized_view_refresh_task_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_materialized_view_refresh_task_run(
