...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_integration_resource_properties_response.ListIntegrationResourcePropertiesResponse = aws_sdk_glue.types.list_integration_resource_properties_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_integration_resource_properties_request.ListIntegrationResourcePropertiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_integration_resource_properties_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
