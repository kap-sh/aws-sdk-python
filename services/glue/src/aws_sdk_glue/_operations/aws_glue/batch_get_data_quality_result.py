"""Generated from Smithy shape ``com.amazonaws.glue#BatchGetDataQualityResult``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_get_data_quality_result_response.BatchGetDataQualityResultResponse = aws_sdk_glue.types.batch_get_data_quality_result_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_get_data_quality_result_request.BatchGetDataQualityResultRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.BatchGetDataQualityResult"
    import aws_sdk_glue.types.batch_get_data_quality_result_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_get_data_quality_result_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_get_data_quality_result(
