"""Generated from Smithy shape ``com.amazonaws.glue#DescribeEntity``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.describe_entity_response.DescribeEntityResponse = (
        aws_sdk_glue.types.describe_entity_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.describe_entity_request.DescribeEntityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DescribeEntity"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.describe_entity_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_entity(
    ...
    aws_sdk_glue.types.describe_entity_response.DescribeEntityResponse, zapros.Response
]:
