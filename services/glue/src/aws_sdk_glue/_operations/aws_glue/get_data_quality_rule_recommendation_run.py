...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_data_quality_rule_recommendation_run_response.GetDataQualityRuleRecommendationRunResponse = aws_sdk_glue.types.get_data_quality_rule_recommendation_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_data_quality_rule_recommendation_run_request.GetDataQualityRuleRecommendationRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_data_quality_rule_recommendation_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
