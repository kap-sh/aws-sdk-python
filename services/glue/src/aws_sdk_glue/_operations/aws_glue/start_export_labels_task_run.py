"""Generated from Smithy shape ``com.amazonaws.glue#StartExportLabelsTaskRun``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.start_export_labels_task_run_response.StartExportLabelsTaskRunResponse = aws_sdk_glue.types.start_export_labels_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.start_export_labels_task_run_request.StartExportLabelsTaskRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_export_labels_task_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_export_labels_task_run(
