"""Generated from Smithy shape ``com.amazonaws.glue#GetConnections``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_connections_response.GetConnectionsResponse = (
        aws_sdk_glue.types.get_connections_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_connections_request.GetConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_connections_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_connections(
    ...
    aws_sdk_glue.types.get_connections_response.GetConnectionsResponse, zapros.Response
]:
...
async def async_get_connections(
