"""Generated from Smithy shape ``com.amazonaws.glue#ListRegistries``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_registries_response.ListRegistriesResponse = (
        aws_sdk_glue.types.list_registries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_registries_input.ListRegistriesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListRegistries"
    import aws_sdk_glue.types.list_registries_input

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_registries_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_registries(
    ...
    aws_sdk_glue.types.list_registries_response.ListRegistriesResponse, zapros.Response
]:
