...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_get_table_optimizer_response.BatchGetTableOptimizerResponse = aws_sdk_glue.types.batch_get_table_optimizer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_get_table_optimizer_request.BatchGetTableOptimizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
