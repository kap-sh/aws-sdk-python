"""Generated from Smithy shape ``com.amazonaws.glue#DeleteSession``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_session_response.DeleteSessionResponse = (
        aws_sdk_glue.types.delete_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_session_request.DeleteSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteSession"
    import aws_sdk_glue.types.delete_session_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_session(
    ...
    aws_sdk_glue.types.delete_session_response.DeleteSessionResponse, zapros.Response
]:
