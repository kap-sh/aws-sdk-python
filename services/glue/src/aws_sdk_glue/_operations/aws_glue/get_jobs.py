...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_jobs_response.GetJobsResponse = (
        aws_sdk_glue.types.get_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_glue.types.get_jobs_request.GetJobsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_jobs_request.serialize_aws_json_1_1(input)
    ).encode()
...
def get_jobs(
    options: OperationOptions, input: aws_sdk_glue.types.get_jobs_request.GetJobsRequest
) -> tuple[aws_sdk_glue.types.get_jobs_response.GetJobsResponse, zapros.Response]:
