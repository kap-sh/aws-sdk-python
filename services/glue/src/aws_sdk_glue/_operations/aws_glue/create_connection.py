"""Generated from Smithy shape ``com.amazonaws.glue#CreateConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_connection_response.CreateConnectionResponse = (
        aws_sdk_glue.types.create_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_connection_request.CreateConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_connection_request.serialize_aws_json_1_1(input_)
    ).encode()
