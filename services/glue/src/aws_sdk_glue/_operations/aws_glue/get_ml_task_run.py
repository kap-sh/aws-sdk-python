"""Generated from Smithy shape ``com.amazonaws.glue#GetMLTaskRun``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_ml_task_run_response.GetMLTaskRunResponse = (
        aws_sdk_glue.types.get_ml_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_ml_task_run_request.GetMLTaskRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_ml_task_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_ml_task_run(
    ...
    aws_sdk_glue.types.get_ml_task_run_response.GetMLTaskRunResponse, zapros.Response
]:
...
async def async_get_ml_task_run(
