"""Generated from Smithy shape ``com.amazonaws.glue#ListStatements``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_statements_response.ListStatementsResponse = (
        aws_sdk_glue.types.list_statements_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_statements_request.ListStatementsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListStatements"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_statements_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_statements(
    ...
    aws_sdk_glue.types.list_statements_response.ListStatementsResponse, zapros.Response
]:
