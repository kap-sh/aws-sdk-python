"""Generated from Smithy shape ``com.amazonaws.glue#DeleteConnectionType``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_connection_type_response.DeleteConnectionTypeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_connection_type_request.DeleteConnectionTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteConnectionType"
    import aws_sdk_glue.types.delete_connection_type_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_connection_type_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_connection_type(
