"""Generated from Smithy shape ``com.amazonaws.glue#GetCatalog``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_catalog_response.GetCatalogResponse = (
        aws_sdk_glue.types.get_catalog_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_catalog_request.GetCatalogRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetCatalog"
    import aws_sdk_glue.types.get_catalog_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_catalog_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_catalog(
    ...
    input_: aws_sdk_glue.types.get_catalog_request.GetCatalogRequest,
) -> tuple[aws_sdk_glue.types.get_catalog_response.GetCatalogResponse, zapros.Response]:
