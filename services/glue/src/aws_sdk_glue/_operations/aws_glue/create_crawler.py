"""Generated from Smithy shape ``com.amazonaws.glue#CreateCrawler``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_crawler_response.CreateCrawlerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_crawler_request.CreateCrawlerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_crawler_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_crawler(
    ...
    aws_sdk_glue.types.create_crawler_response.CreateCrawlerResponse, zapros.Response
]:
...
async def async_create_crawler(
