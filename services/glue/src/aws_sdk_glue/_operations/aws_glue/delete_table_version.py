...
def build_request(
    ...
    input: aws_sdk_glue.types.delete_table_version_request.DeleteTableVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_table_version_request.serialize_aws_json_1_1(input)
    ).encode()
