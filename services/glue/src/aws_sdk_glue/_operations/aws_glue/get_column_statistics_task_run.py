...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_column_statistics_task_run_response.GetColumnStatisticsTaskRunResponse = aws_sdk_glue.types.get_column_statistics_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_column_statistics_task_run_request.GetColumnStatisticsTaskRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_column_statistics_task_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
