"""Generated from Smithy shape ``com.amazonaws.glue#DeleteColumnStatisticsForPartition``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_column_statistics_for_partition_response.DeleteColumnStatisticsForPartitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_column_statistics_for_partition_request.DeleteColumnStatisticsForPartitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteColumnStatisticsForPartition"
    import aws_sdk_glue.types.delete_column_statistics_for_partition_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_column_statistics_for_partition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_column_statistics_for_partition(
