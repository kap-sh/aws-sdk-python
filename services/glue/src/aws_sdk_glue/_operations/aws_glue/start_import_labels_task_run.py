...
def handle_response(
    ...
    out: aws_sdk_glue.types.start_import_labels_task_run_response.StartImportLabelsTaskRunResponse = aws_sdk_glue.types.start_import_labels_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.start_import_labels_task_run_request.StartImportLabelsTaskRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_import_labels_task_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
