"""Generated from Smithy shape ``com.amazonaws.glue#CreateSecurityConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_security_configuration_response.CreateSecurityConfigurationResponse = aws_sdk_glue.types.create_security_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_security_configuration_request.CreateSecurityConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_security_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_security_configuration(
