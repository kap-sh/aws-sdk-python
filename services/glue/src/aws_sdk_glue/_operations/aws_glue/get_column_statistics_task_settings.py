...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_column_statistics_task_settings_response.GetColumnStatisticsTaskSettingsResponse = aws_sdk_glue.types.get_column_statistics_task_settings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_column_statistics_task_settings_request.GetColumnStatisticsTaskSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_column_statistics_task_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
