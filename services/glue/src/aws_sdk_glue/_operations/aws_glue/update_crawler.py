...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_crawler_response.UpdateCrawlerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_crawler_request.UpdateCrawlerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_crawler_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_crawler(
    ...
    aws_sdk_glue.types.update_crawler_response.UpdateCrawlerResponse, zapros.Response
]:
