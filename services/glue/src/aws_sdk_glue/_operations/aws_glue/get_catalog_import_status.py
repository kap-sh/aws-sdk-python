"""Generated from Smithy shape ``com.amazonaws.glue#GetCatalogImportStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_catalog_import_status_response.GetCatalogImportStatusResponse = aws_sdk_glue.types.get_catalog_import_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_catalog_import_status_request.GetCatalogImportStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_catalog_import_status(
