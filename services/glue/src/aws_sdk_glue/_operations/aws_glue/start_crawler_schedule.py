...
def build_request(
    ...
    input: aws_sdk_glue.types.start_crawler_schedule_request.StartCrawlerScheduleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_crawler_schedule_request.serialize_aws_json_1_1(input)
    ).encode()
