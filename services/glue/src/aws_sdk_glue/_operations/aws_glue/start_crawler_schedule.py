...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoScheduleException":
            import aws_sdk_glue.errors.no_schedule_exception

            raise aws_sdk_glue.errors.no_schedule_exception.NoScheduleException.from_aws_json_1_1(
                data
            )
        ...
        case "SchedulerRunningException":
            import aws_sdk_glue.errors.scheduler_running_exception

            raise aws_sdk_glue.errors.scheduler_running_exception.SchedulerRunningException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.start_crawler_schedule_response.StartCrawlerScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.start_crawler_schedule_request.StartCrawlerScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_crawler_schedule_request.serialize_aws_json_1_1(input_)
    ).encode()
