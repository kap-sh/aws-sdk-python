"""Generated from Smithy shape ``com.amazonaws.glue#PutDataCatalogEncryptionSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.put_data_catalog_encryption_settings_response.PutDataCatalogEncryptionSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.put_data_catalog_encryption_settings_request.PutDataCatalogEncryptionSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.put_data_catalog_encryption_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_data_catalog_encryption_settings(
