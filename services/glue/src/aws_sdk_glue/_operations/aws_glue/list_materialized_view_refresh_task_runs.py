"""Generated from Smithy shape ``com.amazonaws.glue#ListMaterializedViewRefreshTaskRuns``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_materialized_view_refresh_task_runs_response.ListMaterializedViewRefreshTaskRunsResponse = aws_sdk_glue.types.list_materialized_view_refresh_task_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_materialized_view_refresh_task_runs_request.ListMaterializedViewRefreshTaskRunsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListMaterializedViewRefreshTaskRuns"
    import aws_sdk_glue.types.list_materialized_view_refresh_task_runs_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_materialized_view_refresh_task_runs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_materialized_view_refresh_task_runs(
