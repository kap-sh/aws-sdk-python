...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_data_quality_ruleset_response.UpdateDataQualityRulesetResponse = aws_sdk_glue.types.update_data_quality_ruleset_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_data_quality_ruleset_request.UpdateDataQualityRulesetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_data_quality_ruleset_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
