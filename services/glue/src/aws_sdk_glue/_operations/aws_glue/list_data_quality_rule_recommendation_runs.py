...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_data_quality_rule_recommendation_runs_response.ListDataQualityRuleRecommendationRunsResponse = aws_sdk_glue.types.list_data_quality_rule_recommendation_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_data_quality_rule_recommendation_runs_request.ListDataQualityRuleRecommendationRunsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_data_quality_rule_recommendation_runs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
