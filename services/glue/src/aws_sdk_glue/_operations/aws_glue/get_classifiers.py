...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_classifiers_response.GetClassifiersResponse = (
        aws_sdk_glue.types.get_classifiers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_classifiers_request.GetClassifiersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_classifiers_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_classifiers(
    ...
    aws_sdk_glue.types.get_classifiers_response.GetClassifiersResponse, zapros.Response
]:
