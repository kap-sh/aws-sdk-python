...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_crawlers_response.GetCrawlersResponse = (
        aws_sdk_glue.types.get_crawlers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_crawlers_request.GetCrawlersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_crawlers_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_crawlers(
    ...
    aws_sdk_glue.types.get_crawlers_response.GetCrawlersResponse, zapros.Response
]:
