"""Generated from Smithy shape ``com.amazonaws.glue#DeleteCustomEntityType``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_custom_entity_type_response.DeleteCustomEntityTypeResponse = aws_sdk_glue.types.delete_custom_entity_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_custom_entity_type_request.DeleteCustomEntityTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteCustomEntityType"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_custom_entity_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_custom_entity_type(
