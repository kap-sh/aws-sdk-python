"""Generated from Smithy shape ``com.amazonaws.glue#DeleteResourcePolicy``."""
...
import aws_sdk_glue.errors.condition_check_failure_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConditionCheckFailureException":
            raise aws_sdk_glue.errors.condition_check_failure_exception.ConditionCheckFailureException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_resource_policy_response.DeleteResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_resource_policy_request.DeleteResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_resource_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
