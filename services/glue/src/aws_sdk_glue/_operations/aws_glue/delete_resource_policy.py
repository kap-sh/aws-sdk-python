...
def build_request(
    ...
    input: aws_sdk_glue.types.delete_resource_policy_request.DeleteResourcePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_resource_policy_request.serialize_aws_json_1_1(input)
    ).encode()
