...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_integration_request.CreateIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_integration_request.serialize_aws_json_1_1(input_)
    ).encode()
