...
def build_request(
    ...
    input: aws_sdk_glue.types.create_integration_request.CreateIntegrationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_integration_request.serialize_aws_json_1_1(input)
    ).encode()
