"""Generated from Smithy shape ``com.amazonaws.glue#GetColumnStatisticsForPartition``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_column_statistics_for_partition_response.GetColumnStatisticsForPartitionResponse = aws_sdk_glue.types.get_column_statistics_for_partition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_column_statistics_for_partition_request.GetColumnStatisticsForPartitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetColumnStatisticsForPartition"
    import aws_sdk_glue.types.get_column_statistics_for_partition_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_column_statistics_for_partition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_column_statistics_for_partition(
