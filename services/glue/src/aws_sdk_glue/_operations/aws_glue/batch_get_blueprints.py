...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_get_blueprints_response.BatchGetBlueprintsResponse = (
        aws_sdk_glue.types.batch_get_blueprints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_get_blueprints_request.BatchGetBlueprintsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_get_blueprints_request.serialize_aws_json_1_1(input_)
    ).encode()
