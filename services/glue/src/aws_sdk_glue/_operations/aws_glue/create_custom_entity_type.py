"""Generated from Smithy shape ``com.amazonaws.glue#CreateCustomEntityType``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_custom_entity_type_response.CreateCustomEntityTypeResponse = aws_sdk_glue.types.create_custom_entity_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_custom_entity_type_request.CreateCustomEntityTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CreateCustomEntityType"
    import aws_sdk_glue.types.create_custom_entity_type_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_custom_entity_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_custom_entity_type(
