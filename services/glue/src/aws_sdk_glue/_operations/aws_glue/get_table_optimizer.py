"""Generated from Smithy shape ``com.amazonaws.glue#GetTableOptimizer``."""
...
import aws_sdk_glue.types.table_optimizer
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_table_optimizer_response.GetTableOptimizerResponse = (
        aws_sdk_glue.types.get_table_optimizer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_table_optimizer_request.GetTableOptimizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetTableOptimizer"
    import aws_sdk_glue.types.get_table_optimizer_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_table_optimizer_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_table_optimizer(
