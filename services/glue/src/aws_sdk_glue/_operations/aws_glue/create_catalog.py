"""Generated from Smithy shape ``com.amazonaws.glue#CreateCatalog``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_catalog_response.CreateCatalogResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_catalog_request.CreateCatalogRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CreateCatalog"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_catalog_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_catalog(
    ...
    aws_sdk_glue.types.create_catalog_response.CreateCatalogResponse, zapros.Response
]:
...
async def async_create_catalog(
