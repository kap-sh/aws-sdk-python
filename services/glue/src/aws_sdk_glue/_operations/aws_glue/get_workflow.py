...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_workflow_response.GetWorkflowResponse = (
        aws_sdk_glue.types.get_workflow_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_workflow_request.GetWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_workflow_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_workflow(
    ...
    aws_sdk_glue.types.get_workflow_response.GetWorkflowResponse, zapros.Response
]:
