...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_crawlers_response.ListCrawlersResponse = (
        aws_sdk_glue.types.list_crawlers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_crawlers_request.ListCrawlersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_crawlers_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_crawlers(
    ...
    aws_sdk_glue.types.list_crawlers_response.ListCrawlersResponse, zapros.Response
]:
