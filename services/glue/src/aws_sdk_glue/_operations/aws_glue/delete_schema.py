...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_schema_response.DeleteSchemaResponse = (
        aws_sdk_glue.types.delete_schema_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_schema_input.DeleteSchemaInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_schema_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_schema(
    ...
    aws_sdk_glue.types.delete_schema_response.DeleteSchemaResponse, zapros.Response
]:
