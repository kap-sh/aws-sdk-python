...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CrawlerNotRunningException":
            import aws_sdk_glue.errors.crawler_not_running_exception

            raise aws_sdk_glue.errors.crawler_not_running_exception.CrawlerNotRunningException.from_aws_json_1_1(
                data
            )
        case "CrawlerStoppingException":
            import aws_sdk_glue.errors.crawler_stopping_exception

            raise aws_sdk_glue.errors.crawler_stopping_exception.CrawlerStoppingException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.stop_crawler_response.StopCrawlerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.stop_crawler_request.StopCrawlerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.stop_crawler_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_crawler(
    ...
    aws_sdk_glue.types.stop_crawler_response.StopCrawlerResponse, zapros.Response
]:
