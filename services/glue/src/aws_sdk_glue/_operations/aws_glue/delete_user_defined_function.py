...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_user_defined_function_response.DeleteUserDefinedFunctionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_user_defined_function_request.DeleteUserDefinedFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_user_defined_function_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
