"""Generated from Smithy shape ``com.amazonaws.glue#CreateGlueIdentityCenterConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_glue_identity_center_configuration_response.CreateGlueIdentityCenterConfigurationResponse = aws_sdk_glue.types.create_glue_identity_center_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_glue_identity_center_configuration_request.CreateGlueIdentityCenterConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CreateGlueIdentityCenterConfiguration"
    import aws_sdk_glue.types.create_glue_identity_center_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_glue_identity_center_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_glue_identity_center_configuration(
