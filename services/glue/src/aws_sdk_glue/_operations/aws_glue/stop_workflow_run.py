...
def handle_response(
    ...
    out: aws_sdk_glue.types.stop_workflow_run_response.StopWorkflowRunResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.stop_workflow_run_request.StopWorkflowRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.stop_workflow_run_request.serialize_aws_json_1_1(input_)
    ).encode()
