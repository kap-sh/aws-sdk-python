...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_user_defined_function_response.UpdateUserDefinedFunctionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_user_defined_function_request.UpdateUserDefinedFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_user_defined_function_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
