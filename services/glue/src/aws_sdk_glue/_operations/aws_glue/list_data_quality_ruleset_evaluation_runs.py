...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_data_quality_ruleset_evaluation_runs_response.ListDataQualityRulesetEvaluationRunsResponse = aws_sdk_glue.types.list_data_quality_ruleset_evaluation_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_data_quality_ruleset_evaluation_runs_request.ListDataQualityRulesetEvaluationRunsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_data_quality_ruleset_evaluation_runs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
