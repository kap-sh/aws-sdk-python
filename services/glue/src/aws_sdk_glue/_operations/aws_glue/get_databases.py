...
import aws_sdk_glue.types.database_list
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_databases_response.GetDatabasesResponse = (
        aws_sdk_glue.types.get_databases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_databases_request.GetDatabasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_databases_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_databases(
    ...
    aws_sdk_glue.types.get_databases_response.GetDatabasesResponse, zapros.Response
]:
