...
def build_request(
    ...
    input: aws_sdk_glue.types.create_table_optimizer_request.CreateTableOptimizerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_table_optimizer_request.serialize_aws_json_1_1(input)
    ).encode()
