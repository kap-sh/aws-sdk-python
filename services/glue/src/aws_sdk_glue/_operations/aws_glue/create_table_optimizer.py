"""Generated from Smithy shape ``com.amazonaws.glue#CreateTableOptimizer``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_table_optimizer_response.CreateTableOptimizerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_table_optimizer_request.CreateTableOptimizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CreateTableOptimizer"
    import aws_sdk_glue.types.create_table_optimizer_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_table_optimizer_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_table_optimizer(
