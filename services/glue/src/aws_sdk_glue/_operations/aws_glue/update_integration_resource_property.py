...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_integration_resource_property_response.UpdateIntegrationResourcePropertyResponse = aws_sdk_glue.types.update_integration_resource_property_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_integration_resource_property_request.UpdateIntegrationResourcePropertyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_integration_resource_property_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
