...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_schema_response.UpdateSchemaResponse = (
        aws_sdk_glue.types.update_schema_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_schema_input.UpdateSchemaInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_schema_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_schema(
    ...
    aws_sdk_glue.types.update_schema_response.UpdateSchemaResponse, zapros.Response
]:
