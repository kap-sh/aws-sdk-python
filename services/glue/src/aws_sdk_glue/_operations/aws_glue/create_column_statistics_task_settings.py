"""Generated from Smithy shape ``com.amazonaws.glue#CreateColumnStatisticsTaskSettings``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ColumnStatisticsTaskRunningException":
            import aws_sdk_glue.errors.column_statistics_task_running_exception

            raise aws_sdk_glue.errors.column_statistics_task_running_exception.ColumnStatisticsTaskRunningException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_column_statistics_task_settings_response.CreateColumnStatisticsTaskSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_column_statistics_task_settings_request.CreateColumnStatisticsTaskSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CreateColumnStatisticsTaskSettings"
    import aws_sdk_glue.types.create_column_statistics_task_settings_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_column_statistics_task_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_column_statistics_task_settings(
