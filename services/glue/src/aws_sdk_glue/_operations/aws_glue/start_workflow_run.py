...
def handle_response(
    ...
    out: aws_sdk_glue.types.start_workflow_run_response.StartWorkflowRunResponse = (
        aws_sdk_glue.types.start_workflow_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.start_workflow_run_request.StartWorkflowRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_workflow_run_request.serialize_aws_json_1_1(input_)
    ).encode()
