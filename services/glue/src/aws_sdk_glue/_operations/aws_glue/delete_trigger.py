"""Generated from Smithy shape ``com.amazonaws.glue#DeleteTrigger``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_trigger_response.DeleteTriggerResponse = (
        aws_sdk_glue.types.delete_trigger_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_glue.types.delete_trigger_request.DeleteTriggerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_trigger_request.serialize_aws_json_1_1(input)
    ).encode()
...
def delete_trigger(
    ...
    aws_sdk_glue.types.delete_trigger_response.DeleteTriggerResponse, zapros.Response
]:
...
async def async_delete_trigger(
