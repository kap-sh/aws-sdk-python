"""Generated from Smithy shape ``com.amazonaws.glue#GetCrawler``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_crawler_response.GetCrawlerResponse = (
        aws_sdk_glue.types.get_crawler_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_crawler_request.GetCrawlerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_crawler_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_crawler(
    ...
    input_: aws_sdk_glue.types.get_crawler_request.GetCrawlerRequest,
) -> tuple[aws_sdk_glue.types.get_crawler_response.GetCrawlerResponse, zapros.Response]:
