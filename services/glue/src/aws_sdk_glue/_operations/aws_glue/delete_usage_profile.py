...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_usage_profile_response.DeleteUsageProfileResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_usage_profile_request.DeleteUsageProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_usage_profile_request.serialize_aws_json_1_1(input_)
    ).encode()
