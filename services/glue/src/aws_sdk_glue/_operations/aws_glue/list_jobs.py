...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_jobs_response.ListJobsResponse = (
        aws_sdk_glue.types.list_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_jobs_request.ListJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_jobs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_jobs(
    ...
    input_: aws_sdk_glue.types.list_jobs_request.ListJobsRequest,
) -> tuple[aws_sdk_glue.types.list_jobs_response.ListJobsResponse, zapros.Response]:
