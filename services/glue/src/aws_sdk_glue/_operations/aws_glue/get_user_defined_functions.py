"""Generated from Smithy shape ``com.amazonaws.glue#GetUserDefinedFunctions``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_user_defined_functions_response.GetUserDefinedFunctionsResponse = aws_sdk_glue.types.get_user_defined_functions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_user_defined_functions_request.GetUserDefinedFunctionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_user_defined_functions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_user_defined_functions(
