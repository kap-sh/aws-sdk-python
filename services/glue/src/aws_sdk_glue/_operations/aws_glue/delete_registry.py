...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_registry_response.DeleteRegistryResponse = (
        aws_sdk_glue.types.delete_registry_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_registry_input.DeleteRegistryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_registry_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_registry(
    ...
    aws_sdk_glue.types.delete_registry_response.DeleteRegistryResponse, zapros.Response
]:
