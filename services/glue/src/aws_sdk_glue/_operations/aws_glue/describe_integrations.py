...
def build_request(
    ...
    input: aws_sdk_glue.types.describe_integrations_request.DescribeIntegrationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.describe_integrations_request.serialize_aws_json_1_1(input)
    ).encode()
