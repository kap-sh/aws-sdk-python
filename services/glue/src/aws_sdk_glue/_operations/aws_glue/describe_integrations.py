"""Generated from Smithy shape ``com.amazonaws.glue#DescribeIntegrations``."""
...
import aws_sdk_glue.types.integrations_list
...
def handle_response(
    ...
    out: aws_sdk_glue.types.describe_integrations_response.DescribeIntegrationsResponse = aws_sdk_glue.types.describe_integrations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.describe_integrations_request.DescribeIntegrationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DescribeIntegrations"
    import aws_sdk_glue.types.describe_integrations_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.describe_integrations_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_integrations(
