...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_workflow_runs_response.GetWorkflowRunsResponse = (
        aws_sdk_glue.types.get_workflow_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_workflow_runs_request.GetWorkflowRunsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_workflow_runs_request.serialize_aws_json_1_1(input_)
    ).encode()
