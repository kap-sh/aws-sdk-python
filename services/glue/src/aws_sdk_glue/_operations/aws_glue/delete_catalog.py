...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_catalog_response.DeleteCatalogResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_catalog_request.DeleteCatalogRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_catalog_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_catalog(
    ...
    aws_sdk_glue.types.delete_catalog_response.DeleteCatalogResponse, zapros.Response
]:
