...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_connection_response.GetConnectionResponse = (
        aws_sdk_glue.types.get_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_connection_request.GetConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_connection_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_connection(
    ...
    aws_sdk_glue.types.get_connection_response.GetConnectionResponse, zapros.Response
]:
