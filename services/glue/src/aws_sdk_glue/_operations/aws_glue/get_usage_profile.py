"""Generated from Smithy shape ``com.amazonaws.glue#GetUsageProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_usage_profile_response.GetUsageProfileResponse = (
        aws_sdk_glue.types.get_usage_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_usage_profile_request.GetUsageProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetUsageProfile"
    import aws_sdk_glue.types.get_usage_profile_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_usage_profile_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_usage_profile(
