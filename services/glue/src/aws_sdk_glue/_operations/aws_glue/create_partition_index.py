"""Generated from Smithy shape ``com.amazonaws.glue#CreatePartitionIndex``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_partition_index_response.CreatePartitionIndexResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_partition_index_request.CreatePartitionIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CreatePartitionIndex"
    import aws_sdk_glue.types.create_partition_index_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_partition_index_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_partition_index(
