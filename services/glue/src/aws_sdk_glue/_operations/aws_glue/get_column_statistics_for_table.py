"""Generated from Smithy shape ``com.amazonaws.glue#GetColumnStatisticsForTable``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_column_statistics_for_table_response.GetColumnStatisticsForTableResponse = aws_sdk_glue.types.get_column_statistics_for_table_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_column_statistics_for_table_request.GetColumnStatisticsForTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetColumnStatisticsForTable"
    import aws_sdk_glue.types.get_column_statistics_for_table_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_column_statistics_for_table_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_column_statistics_for_table(
