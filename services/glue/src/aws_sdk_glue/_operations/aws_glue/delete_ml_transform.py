...
def build_request(
    ...
    input: aws_sdk_glue.types.delete_ml_transform_request.DeleteMLTransformRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_ml_transform_request.serialize_aws_json_1_1(input)
    ).encode()
