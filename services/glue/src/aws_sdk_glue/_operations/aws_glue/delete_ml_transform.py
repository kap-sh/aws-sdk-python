...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_ml_transform_response.DeleteMLTransformResponse = (
        aws_sdk_glue.types.delete_ml_transform_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_ml_transform_request.DeleteMLTransformRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_ml_transform_request.serialize_aws_json_1_1(input_)
    ).encode()
