"""Generated from Smithy shape ``com.amazonaws.glue#CancelDataQualityRulesetEvaluationRun``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.cancel_data_quality_ruleset_evaluation_run_response.CancelDataQualityRulesetEvaluationRunResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.cancel_data_quality_ruleset_evaluation_run_request.CancelDataQualityRulesetEvaluationRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CancelDataQualityRulesetEvaluationRun"
    import aws_sdk_glue.types.cancel_data_quality_ruleset_evaluation_run_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.cancel_data_quality_ruleset_evaluation_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_cancel_data_quality_ruleset_evaluation_run(
