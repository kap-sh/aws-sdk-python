"""Generated from Smithy shape ``com.amazonaws.glue#BatchDeleteTable``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_delete_table_response.BatchDeleteTableResponse = (
        aws_sdk_glue.types.batch_delete_table_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_delete_table_request.BatchDeleteTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_delete_table_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_batch_delete_table(
