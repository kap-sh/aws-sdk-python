...
import aws_sdk_glue.errors.illegal_session_state_exception
...
import aws_sdk_glue.errors.session_busy_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IllegalSessionStateException":
            raise aws_sdk_glue.errors.illegal_session_state_exception.IllegalSessionStateException.from_aws_json_1_1(
                data
            )
        ...
        case "SessionBusyException":
            raise aws_sdk_glue.errors.session_busy_exception.SessionBusyException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.run_statement_response.RunStatementResponse = (
        aws_sdk_glue.types.run_statement_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.run_statement_request.RunStatementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.run_statement_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def run_statement(
    ...
    aws_sdk_glue.types.run_statement_response.RunStatementResponse, zapros.Response
]:
