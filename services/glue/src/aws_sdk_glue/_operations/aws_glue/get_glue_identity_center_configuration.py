"""Generated from Smithy shape ``com.amazonaws.glue#GetGlueIdentityCenterConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_glue_identity_center_configuration_response.GetGlueIdentityCenterConfigurationResponse = aws_sdk_glue.types.get_glue_identity_center_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_glue_identity_center_configuration_request.GetGlueIdentityCenterConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetGlueIdentityCenterConfiguration"
    body: bytes | None = b""
...
async def async_get_glue_identity_center_configuration(
