...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_connection_types_response.ListConnectionTypesResponse = aws_sdk_glue.types.list_connection_types_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_connection_types_request.ListConnectionTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_connection_types_request.serialize_aws_json_1_1(input_)
    ).encode()
