...
def build_request(
    ...
    input: aws_sdk_glue.types.stop_crawler_schedule_request.StopCrawlerScheduleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.stop_crawler_schedule_request.serialize_aws_json_1_1(input)
    ).encode()
