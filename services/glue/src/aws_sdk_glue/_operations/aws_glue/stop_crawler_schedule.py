"""Generated from Smithy shape ``com.amazonaws.glue#StopCrawlerSchedule``."""
...
import aws_sdk_glue.errors.scheduler_not_running_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SchedulerNotRunningException":
            raise aws_sdk_glue.errors.scheduler_not_running_exception.SchedulerNotRunningException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.stop_crawler_schedule_response.StopCrawlerScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.stop_crawler_schedule_request.StopCrawlerScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.stop_crawler_schedule_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_stop_crawler_schedule(
