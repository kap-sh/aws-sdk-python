"""Generated from Smithy shape ``com.amazonaws.glue#CreateTrigger``."""
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_trigger_request.CreateTriggerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_trigger_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_trigger(
    ...
    aws_sdk_glue.types.create_trigger_response.CreateTriggerResponse, zapros.Response
]:
...
async def async_create_trigger(
