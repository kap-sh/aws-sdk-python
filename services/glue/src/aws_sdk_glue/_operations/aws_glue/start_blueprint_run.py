"""Generated from Smithy shape ``com.amazonaws.glue#StartBlueprintRun``."""
...
import aws_sdk_glue.errors.illegal_blueprint_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IllegalBlueprintStateException":
            raise aws_sdk_glue.errors.illegal_blueprint_state_exception.IllegalBlueprintStateException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.start_blueprint_run_response.StartBlueprintRunResponse = (
        aws_sdk_glue.types.start_blueprint_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.start_blueprint_run_request.StartBlueprintRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.StartBlueprintRun"
    import aws_sdk_glue.types.start_blueprint_run_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_blueprint_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_start_blueprint_run(
