...
def build_request(
    ...
    input: aws_sdk_glue.types.start_blueprint_run_request.StartBlueprintRunRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_blueprint_run_request.serialize_aws_json_1_1(input)
    ).encode()
