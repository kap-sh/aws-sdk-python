...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_security_configurations_response.GetSecurityConfigurationsResponse = aws_sdk_glue.types.get_security_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_security_configurations_request.GetSecurityConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_security_configurations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
