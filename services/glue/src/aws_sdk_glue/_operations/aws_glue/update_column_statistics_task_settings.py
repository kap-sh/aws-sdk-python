...
import aws_sdk_glue.errors.version_mismatch_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "VersionMismatchException":
            raise aws_sdk_glue.errors.version_mismatch_exception.VersionMismatchException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_column_statistics_task_settings_response.UpdateColumnStatisticsTaskSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_column_statistics_task_settings_request.UpdateColumnStatisticsTaskSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_column_statistics_task_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
