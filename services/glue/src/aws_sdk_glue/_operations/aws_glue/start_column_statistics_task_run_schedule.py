"""Generated from Smithy shape ``com.amazonaws.glue#StartColumnStatisticsTaskRunSchedule``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.start_column_statistics_task_run_schedule_response.StartColumnStatisticsTaskRunScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.start_column_statistics_task_run_schedule_request.StartColumnStatisticsTaskRunScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.StartColumnStatisticsTaskRunSchedule"
    import aws_sdk_glue.types.start_column_statistics_task_run_schedule_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_column_statistics_task_run_schedule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_column_statistics_task_run_schedule(
