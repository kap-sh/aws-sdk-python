"""Generated from Smithy shape ``com.amazonaws.glue#BatchGetWorkflows``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_get_workflows_response.BatchGetWorkflowsResponse = (
        aws_sdk_glue.types.batch_get_workflows_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_get_workflows_request.BatchGetWorkflowsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_get_workflows_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_batch_get_workflows(
