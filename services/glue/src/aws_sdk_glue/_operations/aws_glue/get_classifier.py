...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_classifier_response.GetClassifierResponse = (
        aws_sdk_glue.types.get_classifier_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_classifier_request.GetClassifierRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_classifier_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_classifier(
    ...
    aws_sdk_glue.types.get_classifier_response.GetClassifierResponse, zapros.Response
]:
