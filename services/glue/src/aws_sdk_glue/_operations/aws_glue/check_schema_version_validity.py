"""Generated from Smithy shape ``com.amazonaws.glue#CheckSchemaVersionValidity``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.check_schema_version_validity_response.CheckSchemaVersionValidityResponse = aws_sdk_glue.types.check_schema_version_validity_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.check_schema_version_validity_input.CheckSchemaVersionValidityInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CheckSchemaVersionValidity"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.check_schema_version_validity_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_check_schema_version_validity(
