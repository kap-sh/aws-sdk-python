"""Generated from Smithy shape ``com.amazonaws.glue#GetPartitionIndexes``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_partition_indexes_response.GetPartitionIndexesResponse = aws_sdk_glue.types.get_partition_indexes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_partition_indexes_request.GetPartitionIndexesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetPartitionIndexes"
    import aws_sdk_glue.types.get_partition_indexes_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_partition_indexes_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_partition_indexes(
