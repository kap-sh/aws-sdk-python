...
def build_request(
    ...
    input: aws_sdk_glue.types.get_partition_indexes_request.GetPartitionIndexesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_partition_indexes_request.serialize_aws_json_1_1(input)
    ).encode()
