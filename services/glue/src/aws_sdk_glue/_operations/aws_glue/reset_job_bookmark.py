"""Generated from Smithy shape ``com.amazonaws.glue#ResetJobBookmark``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.reset_job_bookmark_response.ResetJobBookmarkResponse = (
        aws_sdk_glue.types.reset_job_bookmark_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.reset_job_bookmark_request.ResetJobBookmarkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.reset_job_bookmark_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_reset_job_bookmark(
