...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_data_quality_ruleset_response.CreateDataQualityRulesetResponse = aws_sdk_glue.types.create_data_quality_ruleset_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_data_quality_ruleset_request.CreateDataQualityRulesetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_data_quality_ruleset_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
