"""Generated from Smithy shape ``com.amazonaws.glue#CancelDataQualityRuleRecommendationRun``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.cancel_data_quality_rule_recommendation_run_response.CancelDataQualityRuleRecommendationRunResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.cancel_data_quality_rule_recommendation_run_request.CancelDataQualityRuleRecommendationRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CancelDataQualityRuleRecommendationRun"
    import aws_sdk_glue.types.cancel_data_quality_rule_recommendation_run_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.cancel_data_quality_rule_recommendation_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_cancel_data_quality_rule_recommendation_run(
