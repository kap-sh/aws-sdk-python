"""Generated from Smithy shape ``com.amazonaws.glue#GetTriggers``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_triggers_response.GetTriggersResponse = (
        aws_sdk_glue.types.get_triggers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_triggers_request.GetTriggersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_triggers_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_triggers(
    ...
    aws_sdk_glue.types.get_triggers_response.GetTriggersResponse, zapros.Response
]:
