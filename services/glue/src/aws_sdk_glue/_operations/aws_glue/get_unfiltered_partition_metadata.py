"""Generated from Smithy shape ``com.amazonaws.glue#GetUnfilteredPartitionMetadata``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FederationSourceRetryableException":
            import aws_sdk_glue.errors.federation_source_retryable_exception

            raise aws_sdk_glue.errors.federation_source_retryable_exception.FederationSourceRetryableException.from_aws_json_1_1(
                data
            )
        ...
        case "PermissionTypeMismatchException":
            import aws_sdk_glue.errors.permission_type_mismatch_exception

            raise aws_sdk_glue.errors.permission_type_mismatch_exception.PermissionTypeMismatchException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_unfiltered_partition_metadata_response.GetUnfilteredPartitionMetadataResponse = aws_sdk_glue.types.get_unfiltered_partition_metadata_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_unfiltered_partition_metadata_request.GetUnfilteredPartitionMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetUnfilteredPartitionMetadata"
    import aws_sdk_glue.types.get_unfiltered_partition_metadata_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_unfiltered_partition_metadata_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_unfiltered_partition_metadata(
