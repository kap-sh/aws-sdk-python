...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_dev_endpoint_response.UpdateDevEndpointResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_dev_endpoint_request.UpdateDevEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_dev_endpoint_request.serialize_aws_json_1_1(input_)
    ).encode()
