"""Generated from Smithy shape ``com.amazonaws.glue#GetSecurityConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_security_configuration_response.GetSecurityConfigurationResponse = aws_sdk_glue.types.get_security_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_security_configuration_request.GetSecurityConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_security_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_security_configuration(
