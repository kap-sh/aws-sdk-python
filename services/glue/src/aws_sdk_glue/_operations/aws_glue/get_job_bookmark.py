...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_job_bookmark_response.GetJobBookmarkResponse = (
        aws_sdk_glue.types.get_job_bookmark_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_job_bookmark_request.GetJobBookmarkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_job_bookmark_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_job_bookmark(
    ...
    aws_sdk_glue.types.get_job_bookmark_response.GetJobBookmarkResponse, zapros.Response
]:
