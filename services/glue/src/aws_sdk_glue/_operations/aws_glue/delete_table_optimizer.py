"""Generated from Smithy shape ``com.amazonaws.glue#DeleteTableOptimizer``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_table_optimizer_response.DeleteTableOptimizerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_table_optimizer_request.DeleteTableOptimizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteTableOptimizer"
    import aws_sdk_glue.types.delete_table_optimizer_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_table_optimizer_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_table_optimizer(
