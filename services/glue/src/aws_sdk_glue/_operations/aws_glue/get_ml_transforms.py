...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_ml_transforms_response.GetMLTransformsResponse = (
        aws_sdk_glue.types.get_ml_transforms_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_ml_transforms_request.GetMLTransformsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_ml_transforms_request.serialize_aws_json_1_1(input_)
    ).encode()
