"""Generated from Smithy shape ``com.amazonaws.glue#ListDataQualityStatisticAnnotations``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_data_quality_statistic_annotations_response.ListDataQualityStatisticAnnotationsResponse = aws_sdk_glue.types.list_data_quality_statistic_annotations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_data_quality_statistic_annotations_request.ListDataQualityStatisticAnnotationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListDataQualityStatisticAnnotations"
    import aws_sdk_glue.types.list_data_quality_statistic_annotations_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_data_quality_statistic_annotations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_data_quality_statistic_annotations(
