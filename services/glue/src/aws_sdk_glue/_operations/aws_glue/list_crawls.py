"""Generated from Smithy shape ``com.amazonaws.glue#ListCrawls``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_crawls_response.ListCrawlsResponse = (
        aws_sdk_glue.types.list_crawls_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_crawls_request.ListCrawlsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListCrawls"
    import aws_sdk_glue.types.list_crawls_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_crawls_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_crawls(
    ...
    input_: aws_sdk_glue.types.list_crawls_request.ListCrawlsRequest,
) -> tuple[aws_sdk_glue.types.list_crawls_response.ListCrawlsResponse, zapros.Response]:
