...
def build_request(
    ...
    input: aws_sdk_glue.types.register_schema_version_input.RegisterSchemaVersionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.register_schema_version_input.serialize_aws_json_1_1(input)
    ).encode()
