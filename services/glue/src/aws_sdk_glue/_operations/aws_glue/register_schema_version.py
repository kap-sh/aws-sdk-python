"""Generated from Smithy shape ``com.amazonaws.glue#RegisterSchemaVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.register_schema_version_response.RegisterSchemaVersionResponse = aws_sdk_glue.types.register_schema_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.register_schema_version_input.RegisterSchemaVersionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.RegisterSchemaVersion"
    import aws_sdk_glue.types.register_schema_version_input

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.register_schema_version_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_register_schema_version(
