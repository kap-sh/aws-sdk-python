...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_schema_by_definition_response.GetSchemaByDefinitionResponse = aws_sdk_glue.types.get_schema_by_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_schema_by_definition_input.GetSchemaByDefinitionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_schema_by_definition_input.serialize_aws_json_1_1(input_)
    ).encode()
