...
def build_request(
    ...
    input: aws_sdk_glue.types.get_schema_by_definition_input.GetSchemaByDefinitionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_schema_by_definition_input.serialize_aws_json_1_1(input)
    ).encode()
