...
def handle_response(
    ...
    out: aws_sdk_glue.types.import_catalog_to_glue_response.ImportCatalogToGlueResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.import_catalog_to_glue_request.ImportCatalogToGlueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.import_catalog_to_glue_request.serialize_aws_json_1_1(input_)
    ).encode()
