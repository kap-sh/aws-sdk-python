...
def build_request(
    ...
    input: aws_sdk_glue.types.import_catalog_to_glue_request.ImportCatalogToGlueRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.import_catalog_to_glue_request.serialize_aws_json_1_1(input)
    ).encode()
