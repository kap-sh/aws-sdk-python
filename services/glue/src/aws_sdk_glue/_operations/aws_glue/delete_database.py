"""Generated from Smithy shape ``com.amazonaws.glue#DeleteDatabase``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_database_response.DeleteDatabaseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_database_request.DeleteDatabaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_database_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_database(
    ...
    aws_sdk_glue.types.delete_database_response.DeleteDatabaseResponse, zapros.Response
]:
...
async def async_delete_database(
