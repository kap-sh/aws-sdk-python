"""Generated from Smithy shape ``com.amazonaws.glue#StartMLEvaluationTaskRun``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentRunsExceededException":
            import aws_sdk_glue.errors.concurrent_runs_exceeded_exception

            raise aws_sdk_glue.errors.concurrent_runs_exceeded_exception.ConcurrentRunsExceededException.from_aws_json_1_1(
                data
            )
        ...
        case "MLTransformNotReadyException":
            import aws_sdk_glue.errors.ml_transform_not_ready_exception

            raise aws_sdk_glue.errors.ml_transform_not_ready_exception.MLTransformNotReadyException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.start_ml_evaluation_task_run_response.StartMLEvaluationTaskRunResponse = aws_sdk_glue.types.start_ml_evaluation_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.start_ml_evaluation_task_run_request.StartMLEvaluationTaskRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.start_ml_evaluation_task_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_ml_evaluation_task_run(
