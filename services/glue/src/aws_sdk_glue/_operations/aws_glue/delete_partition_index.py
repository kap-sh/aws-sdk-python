...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_partition_index_response.DeletePartitionIndexResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_partition_index_request.DeletePartitionIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_partition_index_request.serialize_aws_json_1_1(input_)
    ).encode()
