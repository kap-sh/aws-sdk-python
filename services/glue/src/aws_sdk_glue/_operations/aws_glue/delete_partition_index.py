...
def build_request(
    ...
    input: aws_sdk_glue.types.delete_partition_index_request.DeletePartitionIndexRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_partition_index_request.serialize_aws_json_1_1(input)
    ).encode()
