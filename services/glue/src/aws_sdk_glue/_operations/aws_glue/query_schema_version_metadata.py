...
def handle_response(
    ...
    out: aws_sdk_glue.types.query_schema_version_metadata_response.QuerySchemaVersionMetadataResponse = aws_sdk_glue.types.query_schema_version_metadata_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.query_schema_version_metadata_input.QuerySchemaVersionMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.query_schema_version_metadata_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
