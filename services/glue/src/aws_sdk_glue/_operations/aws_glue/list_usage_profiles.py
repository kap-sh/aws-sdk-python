...
def build_request(
    ...
    input: aws_sdk_glue.types.list_usage_profiles_request.ListUsageProfilesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_usage_profiles_request.serialize_aws_json_1_1(input)
    ).encode()
