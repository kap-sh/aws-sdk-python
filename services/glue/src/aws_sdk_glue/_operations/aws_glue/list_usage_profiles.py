"""Generated from Smithy shape ``com.amazonaws.glue#ListUsageProfiles``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_usage_profiles_response.ListUsageProfilesResponse = (
        aws_sdk_glue.types.list_usage_profiles_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_usage_profiles_request.ListUsageProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListUsageProfiles"
    import aws_sdk_glue.types.list_usage_profiles_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_usage_profiles_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_usage_profiles(
