...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_session_endpoint_response.GetSessionEndpointResponse = (
        aws_sdk_glue.types.get_session_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_session_endpoint_request.GetSessionEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_session_endpoint_request.serialize_aws_json_1_1(input_)
    ).encode()
