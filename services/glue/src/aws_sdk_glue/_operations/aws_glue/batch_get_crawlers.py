"""Generated from Smithy shape ``com.amazonaws.glue#BatchGetCrawlers``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_get_crawlers_response.BatchGetCrawlersResponse = (
        aws_sdk_glue.types.batch_get_crawlers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_get_crawlers_request.BatchGetCrawlersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_get_crawlers_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_batch_get_crawlers(
