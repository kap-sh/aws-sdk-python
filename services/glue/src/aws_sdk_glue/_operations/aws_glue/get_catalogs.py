...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_catalogs_response.GetCatalogsResponse = (
        aws_sdk_glue.types.get_catalogs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_catalogs_request.GetCatalogsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_catalogs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_catalogs(
    ...
    aws_sdk_glue.types.get_catalogs_response.GetCatalogsResponse, zapros.Response
]:
