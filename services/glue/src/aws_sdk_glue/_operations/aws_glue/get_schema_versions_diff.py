"""Generated from Smithy shape ``com.amazonaws.glue#GetSchemaVersionsDiff``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_schema_versions_diff_response.GetSchemaVersionsDiffResponse = aws_sdk_glue.types.get_schema_versions_diff_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_schema_versions_diff_input.GetSchemaVersionsDiffInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetSchemaVersionsDiff"
    import aws_sdk_glue.types.get_schema_versions_diff_input

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_schema_versions_diff_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_schema_versions_diff(
