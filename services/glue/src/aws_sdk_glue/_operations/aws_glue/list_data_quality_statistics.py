...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_data_quality_statistics_response.ListDataQualityStatisticsResponse = aws_sdk_glue.types.list_data_quality_statistics_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_data_quality_statistics_request.ListDataQualityStatisticsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_data_quality_statistics_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
