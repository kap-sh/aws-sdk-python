...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_schema_version_response.GetSchemaVersionResponse = (
        aws_sdk_glue.types.get_schema_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_schema_version_input.GetSchemaVersionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_schema_version_input.serialize_aws_json_1_1(input_)
    ).encode()
