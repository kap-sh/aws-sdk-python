"""Generated from Smithy shape ``com.amazonaws.glue#GetCrawlerMetrics``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_crawler_metrics_response.GetCrawlerMetricsResponse = (
        aws_sdk_glue.types.get_crawler_metrics_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_crawler_metrics_request.GetCrawlerMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_crawler_metrics_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_crawler_metrics(
