...
def build_request(
    ...
    input: aws_sdk_glue.types.get_crawler_metrics_request.GetCrawlerMetricsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_crawler_metrics_request.serialize_aws_json_1_1(input)
    ).encode()
