...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_column_statistics_for_partition_response.UpdateColumnStatisticsForPartitionResponse = aws_sdk_glue.types.update_column_statistics_for_partition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_column_statistics_for_partition_request.UpdateColumnStatisticsForPartitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_column_statistics_for_partition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
