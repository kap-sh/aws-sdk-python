"""Generated from Smithy shape ``com.amazonaws.glue#DeleteDevEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_dev_endpoint_response.DeleteDevEndpointResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_dev_endpoint_request.DeleteDevEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_dev_endpoint_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_dev_endpoint(
