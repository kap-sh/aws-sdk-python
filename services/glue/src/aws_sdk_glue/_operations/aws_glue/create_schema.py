"""Generated from Smithy shape ``com.amazonaws.glue#CreateSchema``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_schema_response.CreateSchemaResponse = (
        aws_sdk_glue.types.create_schema_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_schema_input.CreateSchemaInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CreateSchema"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_schema_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_schema(
    ...
    aws_sdk_glue.types.create_schema_response.CreateSchemaResponse, zapros.Response
]:
