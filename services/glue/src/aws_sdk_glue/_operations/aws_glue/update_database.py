...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_database_response.UpdateDatabaseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_database_request.UpdateDatabaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_database_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_database(
    ...
    aws_sdk_glue.types.update_database_response.UpdateDatabaseResponse, zapros.Response
]:
