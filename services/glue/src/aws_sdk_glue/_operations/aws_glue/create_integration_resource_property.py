...
def handle_response(
    ...
    out: aws_sdk_glue.types.create_integration_resource_property_response.CreateIntegrationResourcePropertyResponse = aws_sdk_glue.types.create_integration_resource_property_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.create_integration_resource_property_request.CreateIntegrationResourcePropertyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.create_integration_resource_property_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
