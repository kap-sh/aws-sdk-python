...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_get_dev_endpoints_response.BatchGetDevEndpointsResponse = aws_sdk_glue.types.batch_get_dev_endpoints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_glue.types.batch_get_dev_endpoints_request.BatchGetDevEndpointsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_get_dev_endpoints_request.serialize_aws_json_1_1(input)
    ).encode()
