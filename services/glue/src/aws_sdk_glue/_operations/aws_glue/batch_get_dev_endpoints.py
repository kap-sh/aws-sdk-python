...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_get_dev_endpoints_request.BatchGetDevEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_get_dev_endpoints_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
