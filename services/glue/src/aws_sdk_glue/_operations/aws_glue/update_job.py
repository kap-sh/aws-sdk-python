"""Generated from Smithy shape ``com.amazonaws.glue#UpdateJob``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_job_response.UpdateJobResponse = (
        aws_sdk_glue.types.update_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_job_request.UpdateJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_job(
    ...
    input_: aws_sdk_glue.types.update_job_request.UpdateJobRequest,
) -> tuple[aws_sdk_glue.types.update_job_response.UpdateJobResponse, zapros.Response]:
