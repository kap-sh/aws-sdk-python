...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_integration_resource_property_response.GetIntegrationResourcePropertyResponse = aws_sdk_glue.types.get_integration_resource_property_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_integration_resource_property_request.GetIntegrationResourcePropertyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_integration_resource_property_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
