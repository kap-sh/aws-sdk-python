...
def handle_response(
    ...
    out: aws_sdk_glue.types.delete_job_response.DeleteJobResponse = (
        aws_sdk_glue.types.delete_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.delete_job_request.DeleteJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.delete_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_job(
    ...
    input_: aws_sdk_glue.types.delete_job_request.DeleteJobRequest,
) -> tuple[aws_sdk_glue.types.delete_job_response.DeleteJobResponse, zapros.Response]:
