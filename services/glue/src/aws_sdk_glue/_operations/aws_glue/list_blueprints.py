...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_blueprints_response.ListBlueprintsResponse = (
        aws_sdk_glue.types.list_blueprints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_blueprints_request.ListBlueprintsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_blueprints_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_blueprints(
    ...
    aws_sdk_glue.types.list_blueprints_response.ListBlueprintsResponse, zapros.Response
]:
