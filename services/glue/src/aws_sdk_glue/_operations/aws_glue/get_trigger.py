...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_trigger_response.GetTriggerResponse = (
        aws_sdk_glue.types.get_trigger_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_trigger_request.GetTriggerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_trigger_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_trigger(
    ...
    input_: aws_sdk_glue.types.get_trigger_request.GetTriggerRequest,
) -> tuple[aws_sdk_glue.types.get_trigger_response.GetTriggerResponse, zapros.Response]:
