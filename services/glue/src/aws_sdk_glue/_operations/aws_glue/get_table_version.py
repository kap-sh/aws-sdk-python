"""Generated from Smithy shape ``com.amazonaws.glue#GetTableVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_table_version_response.GetTableVersionResponse = (
        aws_sdk_glue.types.get_table_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_table_version_request.GetTableVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_table_version_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_table_version(
