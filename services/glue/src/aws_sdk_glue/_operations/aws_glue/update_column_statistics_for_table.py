"""Generated from Smithy shape ``com.amazonaws.glue#UpdateColumnStatisticsForTable``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_column_statistics_for_table_response.UpdateColumnStatisticsForTableResponse = aws_sdk_glue.types.update_column_statistics_for_table_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_column_statistics_for_table_request.UpdateColumnStatisticsForTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateColumnStatisticsForTable"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_column_statistics_for_table_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_column_statistics_for_table(
