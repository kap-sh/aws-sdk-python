"""Generated from Smithy shape ``com.amazonaws.glue#ListTableOptimizerRuns``."""
...
import aws_sdk_glue.errors.throttling_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ThrottlingException":
            raise aws_sdk_glue.errors.throttling_exception.ThrottlingException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_glue.types.list_table_optimizer_runs_response.ListTableOptimizerRunsResponse = aws_sdk_glue.types.list_table_optimizer_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.list_table_optimizer_runs_request.ListTableOptimizerRunsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListTableOptimizerRuns"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.list_table_optimizer_runs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_table_optimizer_runs(
