"""Generated from Smithy shape ``com.amazonaws.glue#GetDataQualityResult``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_data_quality_result_response.GetDataQualityResultResponse = aws_sdk_glue.types.get_data_quality_result_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_glue.types.get_data_quality_result_request.GetDataQualityResultRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetDataQualityResult"
    import aws_sdk_glue.types.get_data_quality_result_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_data_quality_result_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_get_data_quality_result(
