...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_data_quality_result_request.GetDataQualityResultRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_data_quality_result_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
