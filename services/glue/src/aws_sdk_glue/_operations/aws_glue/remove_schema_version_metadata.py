...
def build_request(
    ...
    input_: aws_sdk_glue.types.remove_schema_version_metadata_input.RemoveSchemaVersionMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.remove_schema_version_metadata_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
