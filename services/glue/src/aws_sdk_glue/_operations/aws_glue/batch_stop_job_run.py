...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_stop_job_run_response.BatchStopJobRunResponse = (
        aws_sdk_glue.types.batch_stop_job_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_stop_job_run_request.BatchStopJobRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_stop_job_run_request.serialize_aws_json_1_1(input_)
    ).encode()
