"""Generated from Smithy shape ``com.amazonaws.glue#GetDashboardUrl``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_dashboard_url_response.GetDashboardUrlResponse = (
        aws_sdk_glue.types.get_dashboard_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_dashboard_url_request.GetDashboardUrlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetDashboardUrl"
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_dashboard_url_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_dashboard_url(
