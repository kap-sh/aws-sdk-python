...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_blueprint_response.UpdateBlueprintResponse = (
        aws_sdk_glue.types.update_blueprint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_blueprint_request.UpdateBlueprintRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_blueprint_request.serialize_aws_json_1_1(input_)
    ).encode()
