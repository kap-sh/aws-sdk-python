"""Generated from Smithy shape ``com.amazonaws.glue#GetResourcePolicies``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_resource_policies_response.GetResourcePoliciesResponse = aws_sdk_glue.types.get_resource_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_resource_policies_request.GetResourcePoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetResourcePolicies"
    import aws_sdk_glue.types.get_resource_policies_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_resource_policies_request.serialize_aws_json_1_1(input_)
    ).encode()
