"""Generated from Smithy shape ``com.amazonaws.glue#GetUnfilteredTableMetadata``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_unfiltered_table_metadata_response.GetUnfilteredTableMetadataResponse = aws_sdk_glue.types.get_unfiltered_table_metadata_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_unfiltered_table_metadata_request.GetUnfilteredTableMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetUnfilteredTableMetadata"
    import aws_sdk_glue.types.get_unfiltered_table_metadata_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_unfiltered_table_metadata_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_unfiltered_table_metadata(
