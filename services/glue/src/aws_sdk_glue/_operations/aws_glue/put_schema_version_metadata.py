...
def handle_response(
    ...
    out: aws_sdk_glue.types.put_schema_version_metadata_response.PutSchemaVersionMetadataResponse = aws_sdk_glue.types.put_schema_version_metadata_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.put_schema_version_metadata_input.PutSchemaVersionMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
