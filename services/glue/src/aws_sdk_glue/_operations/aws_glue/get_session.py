...
def handle_response(
    ...
    out: aws_sdk_glue.types.get_session_response.GetSessionResponse = (
        aws_sdk_glue.types.get_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.get_session_request.GetSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.get_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_session(
    ...
    input_: aws_sdk_glue.types.get_session_request.GetSessionRequest,
) -> tuple[aws_sdk_glue.types.get_session_response.GetSessionResponse, zapros.Response]:
