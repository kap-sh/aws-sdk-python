"""Generated from Smithy shape ``com.amazonaws.glue#UpdateTrigger``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.update_trigger_response.UpdateTriggerResponse = (
        aws_sdk_glue.types.update_trigger_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.update_trigger_request.UpdateTriggerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.update_trigger_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_trigger(
    ...
    aws_sdk_glue.types.update_trigger_response.UpdateTriggerResponse, zapros.Response
]:
...
async def async_update_trigger(
