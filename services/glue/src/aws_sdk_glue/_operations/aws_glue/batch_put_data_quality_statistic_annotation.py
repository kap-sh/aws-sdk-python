"""Generated from Smithy shape ``com.amazonaws.glue#BatchPutDataQualityStatisticAnnotation``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.batch_put_data_quality_statistic_annotation_response.BatchPutDataQualityStatisticAnnotationResponse = aws_sdk_glue.types.batch_put_data_quality_statistic_annotation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.batch_put_data_quality_statistic_annotation_request.BatchPutDataQualityStatisticAnnotationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.BatchPutDataQualityStatisticAnnotation"
    import aws_sdk_glue.types.batch_put_data_quality_statistic_annotation_request

    body: bytes | None = json.dumps(
        aws_sdk_glue.types.batch_put_data_quality_statistic_annotation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_put_data_quality_statistic_annotation(
