"""Generated from Smithy shape ``com.amazonaws.glue#CancelMLTaskRun``."""
...
def handle_response(
    ...
    out: aws_sdk_glue.types.cancel_ml_task_run_response.CancelMLTaskRunResponse = (
        aws_sdk_glue.types.cancel_ml_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_glue.types.cancel_ml_task_run_request.CancelMLTaskRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glue.types.cancel_ml_task_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_cancel_ml_task_run(
