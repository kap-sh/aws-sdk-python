...
if TYPE_CHECKING:
    import aws_sdk_glue.types.amazon_redshift_advanced_option

AmazonRedshiftAdvancedOptions: TypeAlias = list[
    "aws_sdk_glue.types.amazon_redshift_advanced_option.AmazonRedshiftAdvancedOption"
]
...
def serialize_aws_json_1_1(value: AmazonRedshiftAdvancedOptions) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_glue.types.amazon_redshift_advanced_option.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AmazonRedshiftAdvancedOptions:
    ...
    for item in data:
        out.append(
            aws_sdk_glue.types.amazon_redshift_advanced_option.deserialize_aws_json_1_1(
                item
            )
        )
    return out
