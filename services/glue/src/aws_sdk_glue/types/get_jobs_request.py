...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetJobsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetJobsRequest:
    out: GetJobsRequest = {}  # type: ignore[typeddict-item]
