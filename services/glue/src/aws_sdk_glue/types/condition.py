...
if TYPE_CHECKING:
    ...
    import aws_sdk_glue.types.logical_operator
    import aws_sdk_glue.types.name_string


class Condition(TypedDict):
    logical_operator: NotRequired["aws_sdk_glue.types.logical_operator.LogicalOperator"]
    ...
    state: NotRequired["aws_sdk_glue.types.job_run_state.JobRunState"]
    ...
    crawl_state: NotRequired["aws_sdk_glue.types.crawl_state.CrawlState"]
...
def serialize_aws_json_1_1(value: Condition) -> dict:
    ...
    if "logical_operator" in value:
        ...
        out["LogicalOperator"] = (
            aws_sdk_glue.types.logical_operator.serialize_aws_json_1_1(
    ...
    if "state" in value:
        ...
        out["State"] = aws_sdk_glue.types.job_run_state.serialize_aws_json_1_1(
            value["state"]
        )
    ...
    if "crawl_state" in value:
        ...
        out["CrawlState"] = aws_sdk_glue.types.crawl_state.serialize_aws_json_1_1(
            value["crawl_state"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Condition:
    ...
    if "LogicalOperator" in data:
        ...
        out["logical_operator"] = (
            aws_sdk_glue.types.logical_operator.deserialize_aws_json_1_1(
    ...
    if "State" in data:
        ...
        out["state"] = aws_sdk_glue.types.job_run_state.deserialize_aws_json_1_1(
            data["State"]
        )
    ...
    if "CrawlState" in data:
        ...
        out["crawl_state"] = aws_sdk_glue.types.crawl_state.deserialize_aws_json_1_1(
            data["CrawlState"]
        )
    return out
