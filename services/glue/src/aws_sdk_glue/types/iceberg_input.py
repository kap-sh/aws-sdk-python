...
if TYPE_CHECKING:
    import aws_sdk_glue.types.create_iceberg_table_input
    import aws_sdk_glue.types.metadata_operation
...
class IcebergInput(TypedDict):
    ...
    create_iceberg_table_input: NotRequired[
        "aws_sdk_glue.types.create_iceberg_table_input.CreateIcebergTableInput"
    ]
...
def serialize_aws_json_1_1(value: IcebergInput) -> dict:
    ...
    out["MetadataOperation"] = (
        aws_sdk_glue.types.metadata_operation.serialize_aws_json_1_1(
    ...
    if "create_iceberg_table_input" in value:
        ...
        out["CreateIcebergTableInput"] = (
            aws_sdk_glue.types.create_iceberg_table_input.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> IcebergInput:
    ...
    if "MetadataOperation" in data:
        ...
        out["metadata_operation"] = (
            aws_sdk_glue.types.metadata_operation.deserialize_aws_json_1_1(
    ...
    if "CreateIcebergTableInput" in data:
        ...
        out["create_iceberg_table_input"] = (
            aws_sdk_glue.types.create_iceberg_table_input.deserialize_aws_json_1_1(
