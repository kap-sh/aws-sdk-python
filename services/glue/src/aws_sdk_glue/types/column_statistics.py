...
if TYPE_CHECKING:
    import aws_sdk_glue.types.column_statistics_data
    import aws_sdk_glue.types.name_string
    import aws_sdk_glue.types.timestamp
    import aws_sdk_glue.types.type_string
...
class ColumnStatistics(TypedDict, closed=True):
    ...
    column_type: "aws_sdk_glue.types.type_string.TypeString"
    """<p>The data type of the column.</p>"""
    analyzed_time: "aws_sdk_glue.types.timestamp.Timestamp"
    """<p>The timestamp of when column statistics were generated.</p>"""
    statistics_data: "aws_sdk_glue.types.column_statistics_data.ColumnStatisticsData"
...
def serialize_aws_json_1_1(value: ColumnStatistics) -> dict:
    ...
    out["AnalyzedTime"] = aws_sdk_glue.types.timestamp.serialize_aws_json_1_1(
        value["analyzed_time"]
    )
    import aws_sdk_glue.types.column_statistics_data

    out["StatisticsData"] = (
        aws_sdk_glue.types.column_statistics_data.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ColumnStatistics:
    ...
    if "AnalyzedTime" in data:
        ...
        out["analyzed_time"] = aws_sdk_glue.types.timestamp.deserialize_aws_json_1_1(
            data["AnalyzedTime"]
        )
    else:
    ...
    if "StatisticsData" in data:
        ...
        out["statistics_data"] = (
            aws_sdk_glue.types.column_statistics_data.deserialize_aws_json_1_1(
                data["StatisticsData"]
            )
        )
    else:
