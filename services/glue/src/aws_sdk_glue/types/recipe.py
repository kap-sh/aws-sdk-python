...
if TYPE_CHECKING:
    ...
    import aws_sdk_glue.types.recipe_reference
    import aws_sdk_glue.types.recipe_steps
...
class Recipe(TypedDict, closed=True):
    ...
    recipe_reference: NotRequired["aws_sdk_glue.types.recipe_reference.RecipeReference"]
    """<p>A reference to the DataBrew recipe used by the node.</p>"""
    recipe_steps: NotRequired["aws_sdk_glue.types.recipe_steps.RecipeSteps"]
...
def serialize_aws_json_1_1(value: Recipe) -> dict:
    ...
    if "recipe_reference" in value:
        ...
        out["RecipeReference"] = (
            aws_sdk_glue.types.recipe_reference.serialize_aws_json_1_1(
    ...
    if "recipe_steps" in value:
        ...
        out["RecipeSteps"] = aws_sdk_glue.types.recipe_steps.serialize_aws_json_1_1(
            value["recipe_steps"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Recipe:
    ...
    if "RecipeReference" in data:
        ...
        out["recipe_reference"] = (
            aws_sdk_glue.types.recipe_reference.deserialize_aws_json_1_1(
    ...
    if "RecipeSteps" in data:
        ...
        out["recipe_steps"] = aws_sdk_glue.types.recipe_steps.deserialize_aws_json_1_1(
            data["RecipeSteps"]
        )
    return out
