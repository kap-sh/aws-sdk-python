...
if TYPE_CHECKING:
    import aws_sdk_glue.types.get_table_versions_list
    import aws_sdk_glue.types.token


class GetTableVersionsResponse(TypedDict):
    table_versions: NotRequired[
        "aws_sdk_glue.types.get_table_versions_list.GetTableVersionsList"
    ]
...
def serialize_aws_json_1_1(value: GetTableVersionsResponse) -> dict:
    ...
    if "table_versions" in value:
        ...
        out["TableVersions"] = (
            aws_sdk_glue.types.get_table_versions_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetTableVersionsResponse:
    ...
    if "TableVersions" in data:
        ...
        out["table_versions"] = (
            aws_sdk_glue.types.get_table_versions_list.deserialize_aws_json_1_1(
                data["TableVersions"]
            )
        )
