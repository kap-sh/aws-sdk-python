...
class GetTablesRequest(TypedDict):
    ...
    expression: NotRequired["aws_sdk_glue.types.filter_string.FilterString"]
...
def serialize_aws_json_1_1(value: GetTablesRequest) -> dict:
    ...
    if "attributes_to_get" in value:
        ...
        out["AttributesToGet"] = (
            aws_sdk_glue.types.table_attributes_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetTablesRequest:
    ...
    if "AttributesToGet" in data:
        ...
        out["attributes_to_get"] = (
            aws_sdk_glue.types.table_attributes_list.deserialize_aws_json_1_1(
