...
def serialize_aws_json_1_1(value: BatchGetBlueprintsRequest) -> dict:
    ...
    out["Names"] = aws_sdk_glue.types.batch_get_blueprint_names.serialize_aws_json_1_1(
        value["names"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> BatchGetBlueprintsRequest:
    ...
    if "Names" in data:
        ...
        out["names"] = (
            aws_sdk_glue.types.batch_get_blueprint_names.deserialize_aws_json_1_1(
                data["Names"]
            )
        )
    else:
