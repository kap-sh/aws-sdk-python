...
if TYPE_CHECKING:
    ...
    import aws_sdk_glue.types.view_representation_list
...
class ViewDefinition(TypedDict):
    ...
    view_version_token: NotRequired["aws_sdk_glue.types.hash_string.HashString"]
    ...
    representations: NotRequired[
        "aws_sdk_glue.types.view_representation_list.ViewRepresentationList"
    ]
...
def serialize_aws_json_1_1(value: ViewDefinition) -> dict:
    ...
    if "representations" in value:
        ...
        out["Representations"] = (
            aws_sdk_glue.types.view_representation_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ViewDefinition:
    ...
    if "Representations" in data:
        ...
        out["representations"] = (
            aws_sdk_glue.types.view_representation_list.deserialize_aws_json_1_1(
