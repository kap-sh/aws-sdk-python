...
if TYPE_CHECKING:
    import aws_sdk_glue.types.update_iceberg_table_input


class UpdateIcebergInput(TypedDict):
    update_iceberg_table_input: (
        "aws_sdk_glue.types.update_iceberg_table_input.UpdateIcebergTableInput"
    )
...
def serialize_aws_json_1_1(value: UpdateIcebergInput) -> dict:
    ...
    out["UpdateIcebergTableInput"] = (
        aws_sdk_glue.types.update_iceberg_table_input.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateIcebergInput:
    ...
    if "UpdateIcebergTableInput" in data:
        ...
        out["update_iceberg_table_input"] = (
            aws_sdk_glue.types.update_iceberg_table_input.deserialize_aws_json_1_1(
