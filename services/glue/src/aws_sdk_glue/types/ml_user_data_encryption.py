...
if TYPE_CHECKING:
    import aws_sdk_glue.types.ml_user_data_encryption_mode_string
...
def serialize_aws_json_1_1(value: MLUserDataEncryption) -> dict:
    ...
    out["MlUserDataEncryptionMode"] = (
        aws_sdk_glue.types.ml_user_data_encryption_mode_string.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> MLUserDataEncryption:
    ...
    if "MlUserDataEncryptionMode" in data:
        ...
        out["ml_user_data_encryption_mode"] = (
            aws_sdk_glue.types.ml_user_data_encryption_mode_string.deserialize_aws_json_1_1(
