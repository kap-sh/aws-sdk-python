...
if TYPE_CHECKING:
    ...
    import aws_sdk_glue.types.find_matches_task_run_properties
    import aws_sdk_glue.types.import_labels_task_run_properties
    import aws_sdk_glue.types.labeling_set_generation_task_run_properties
...
class TaskRunProperties(TypedDict, closed=True):
    ...
    import_labels_task_run_properties: NotRequired[
        "aws_sdk_glue.types.import_labels_task_run_properties.ImportLabelsTaskRunProperties"
    ]
    """<p>The configuration properties for an importing labels task run.</p>"""
    export_labels_task_run_properties: NotRequired[
        "aws_sdk_glue.types.export_labels_task_run_properties.ExportLabelsTaskRunProperties"
    ]
    """<p>The configuration properties for an exporting labels task run.</p>"""
    labeling_set_generation_task_run_properties: NotRequired[
        "aws_sdk_glue.types.labeling_set_generation_task_run_properties.LabelingSetGenerationTaskRunProperties"
    ]
    """<p>The configuration properties for a labeling set generation task run.</p>"""
    find_matches_task_run_properties: NotRequired[
        "aws_sdk_glue.types.find_matches_task_run_properties.FindMatchesTaskRunProperties"
    ]
...
def serialize_aws_json_1_1(value: TaskRunProperties) -> dict:
    ...
    if "task_type" in value:
        ...
        out["TaskType"] = aws_sdk_glue.types.task_type.serialize_aws_json_1_1(
            value["task_type"]
        )
    if "import_labels_task_run_properties" in value:
        ...
        out["ImportLabelsTaskRunProperties"] = (
            aws_sdk_glue.types.import_labels_task_run_properties.serialize_aws_json_1_1(
    ...
    if "export_labels_task_run_properties" in value:
        ...
        out["ExportLabelsTaskRunProperties"] = (
            aws_sdk_glue.types.export_labels_task_run_properties.serialize_aws_json_1_1(
    ...
    if "labeling_set_generation_task_run_properties" in value:
        ...
        out["LabelingSetGenerationTaskRunProperties"] = (
            aws_sdk_glue.types.labeling_set_generation_task_run_properties.serialize_aws_json_1_1(
    ...
    if "find_matches_task_run_properties" in value:
        ...
        out["FindMatchesTaskRunProperties"] = (
            aws_sdk_glue.types.find_matches_task_run_properties.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TaskRunProperties:
    ...
    if "TaskType" in data:
        ...
        out["task_type"] = aws_sdk_glue.types.task_type.deserialize_aws_json_1_1(
            data["TaskType"]
        )
    if "ImportLabelsTaskRunProperties" in data:
        ...
        out["import_labels_task_run_properties"] = (
            aws_sdk_glue.types.import_labels_task_run_properties.deserialize_aws_json_1_1(
    ...
    if "ExportLabelsTaskRunProperties" in data:
        ...
        out["export_labels_task_run_properties"] = (
            aws_sdk_glue.types.export_labels_task_run_properties.deserialize_aws_json_1_1(
    ...
    if "LabelingSetGenerationTaskRunProperties" in data:
        ...
        out["labeling_set_generation_task_run_properties"] = (
            aws_sdk_glue.types.labeling_set_generation_task_run_properties.deserialize_aws_json_1_1(
    ...
    if "FindMatchesTaskRunProperties" in data:
        ...
        out["find_matches_task_run_properties"] = (
            aws_sdk_glue.types.find_matches_task_run_properties.deserialize_aws_json_1_1(
