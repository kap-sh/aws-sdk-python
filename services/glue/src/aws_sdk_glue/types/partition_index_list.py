...
PartitionIndexList: TypeAlias = list[
    "aws_sdk_glue.types.partition_index.PartitionIndex"
]
...
def serialize_aws_json_1_1(value: PartitionIndexList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_glue.types.partition_index.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> PartitionIndexList:
    ...
    for item in data:
        out.append(aws_sdk_glue.types.partition_index.deserialize_aws_json_1_1(item))
    return out
