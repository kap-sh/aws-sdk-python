...
class ConfusionMatrix(TypedDict):
    ...
    num_true_negatives: NotRequired["aws_sdk_glue.types.records_count.RecordsCount"]
    ...
    num_false_negatives: NotRequired["aws_sdk_glue.types.records_count.RecordsCount"]
