...
class ListDataQualityRuleRecommendationRunsRequest(TypedDict):
    filter: NotRequired[
...
def serialize_aws_json_1_1(value: ListDataQualityRuleRecommendationRunsRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["Filter"] = (
            aws_sdk_glue.types.data_quality_rule_recommendation_run_filter.serialize_aws_json_1_1(
                value["filter"]
            )
        )
...
def deserialize_aws_json_1_1(
    ...
    if "Filter" in data:
        ...
        out["filter"] = (
            aws_sdk_glue.types.data_quality_rule_recommendation_run_filter.deserialize_aws_json_1_1(
                data["Filter"]
            )
        )
