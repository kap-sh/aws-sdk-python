...
class BatchDeleteTableVersionRequest(TypedDict):
    ...
    version_ids: (
        "aws_sdk_glue.types.batch_delete_table_version_list.BatchDeleteTableVersionList"
    )
...
def serialize_aws_json_1_1(value: BatchDeleteTableVersionRequest) -> dict:
    ...
    out["VersionIds"] = (
        aws_sdk_glue.types.batch_delete_table_version_list.serialize_aws_json_1_1(
            value["version_ids"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> BatchDeleteTableVersionRequest:
    ...
    if "VersionIds" in data:
        ...
        out["version_ids"] = (
            aws_sdk_glue.types.batch_delete_table_version_list.deserialize_aws_json_1_1(
                data["VersionIds"]
            )
        )
    else:
