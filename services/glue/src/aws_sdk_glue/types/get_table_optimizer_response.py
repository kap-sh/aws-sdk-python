...
class GetTableOptimizerResponse(TypedDict):
    ...
    table_optimizer: NotRequired["aws_sdk_glue.types.table_optimizer.TableOptimizer"]
...
def serialize_aws_json_1_1(value: GetTableOptimizerResponse) -> dict:
    ...
    if "table_optimizer" in value:
        ...
        out["TableOptimizer"] = (
            aws_sdk_glue.types.table_optimizer.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetTableOptimizerResponse:
    ...
    if "TableOptimizer" in data:
        ...
        out["table_optimizer"] = (
            aws_sdk_glue.types.table_optimizer.deserialize_aws_json_1_1(
                data["TableOptimizer"]
            )
        )
    return out
