...
class BatchPutDataQualityStatisticAnnotationRequest(TypedDict):
    inclusion_annotations: (
        "aws_sdk_glue.types.inclusion_annotation_list.InclusionAnnotationList"
    )
...
def serialize_aws_json_1_1(
    ...
    out["InclusionAnnotations"] = (
        aws_sdk_glue.types.inclusion_annotation_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "InclusionAnnotations" in data:
        ...
        out["inclusion_annotations"] = (
            aws_sdk_glue.types.inclusion_annotation_list.deserialize_aws_json_1_1(
