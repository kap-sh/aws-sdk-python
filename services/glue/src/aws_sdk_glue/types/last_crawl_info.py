...
if TYPE_CHECKING:
    ...
    import aws_sdk_glue.types.last_crawl_status
...
class LastCrawlInfo(TypedDict):
    status: NotRequired["aws_sdk_glue.types.last_crawl_status.LastCrawlStatus"]
...
def serialize_aws_json_1_1(value: LastCrawlInfo) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = aws_sdk_glue.types.last_crawl_status.serialize_aws_json_1_1(
            value["status"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> LastCrawlInfo:
    ...
    if "Status" in data:
        ...
        out["status"] = aws_sdk_glue.types.last_crawl_status.deserialize_aws_json_1_1(
            data["Status"]
        )
