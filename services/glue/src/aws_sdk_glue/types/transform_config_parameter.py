...
if TYPE_CHECKING:
    ...
    import aws_sdk_glue.types.param_type


class TransformConfigParameter(TypedDict):
    ...
    type: "aws_sdk_glue.types.param_type.ParamType"
    ...
    list_type: NotRequired["aws_sdk_glue.types.param_type.ParamType"]
    """<p>Specifies the list type of the parameter in the config file of the dynamic transform.</p>"""
    is_optional: NotRequired["aws_sdk_glue.types.boxed_boolean.BoxedBoolean"]
...
def serialize_aws_json_1_1(value: TransformConfigParameter) -> dict:
    ...
    out["Type"] = aws_sdk_glue.types.param_type.serialize_aws_json_1_1(value["type"])
    ...
    if "list_type" in value:
        ...
        out["ListType"] = aws_sdk_glue.types.param_type.serialize_aws_json_1_1(
            value["list_type"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> TransformConfigParameter:
    ...
    if "Type" in data:
        ...
        out["type"] = aws_sdk_glue.types.param_type.deserialize_aws_json_1_1(
            data["Type"]
        )
    else:
    ...
    if "ListType" in data:
        ...
        out["list_type"] = aws_sdk_glue.types.param_type.deserialize_aws_json_1_1(
            data["ListType"]
        )
