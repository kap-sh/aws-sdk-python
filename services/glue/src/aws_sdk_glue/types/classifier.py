...
if TYPE_CHECKING:
    ...
    import aws_sdk_glue.types.grok_classifier
    import aws_sdk_glue.types.json_classifier
...
class Classifier(TypedDict):
    ...
    json_classifier: NotRequired["aws_sdk_glue.types.json_classifier.JsonClassifier"]
    """<p>A classifier for JSON content.</p>"""
    csv_classifier: NotRequired["aws_sdk_glue.types.csv_classifier.CsvClassifier"]
...
def serialize_aws_json_1_1(value: Classifier) -> dict:
    ...
    if "grok_classifier" in value:
        ...
        out["GrokClassifier"] = (
            aws_sdk_glue.types.grok_classifier.serialize_aws_json_1_1(
    ...
    if "xml_classifier" in value:
        ...
        out["XMLClassifier"] = aws_sdk_glue.types.xml_classifier.serialize_aws_json_1_1(
    ...
    if "json_classifier" in value:
        ...
        out["JsonClassifier"] = (
            aws_sdk_glue.types.json_classifier.serialize_aws_json_1_1(
    ...
    if "csv_classifier" in value:
        ...
        out["CsvClassifier"] = aws_sdk_glue.types.csv_classifier.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Classifier:
    ...
    if "GrokClassifier" in data:
        ...
        out["grok_classifier"] = (
            aws_sdk_glue.types.grok_classifier.deserialize_aws_json_1_1(
                data["GrokClassifier"]
            )
        )
    if "XMLClassifier" in data:
        ...
        out["xml_classifier"] = (
            aws_sdk_glue.types.xml_classifier.deserialize_aws_json_1_1(
                data["XMLClassifier"]
            )
        )
    if "JsonClassifier" in data:
        ...
        out["json_classifier"] = (
            aws_sdk_glue.types.json_classifier.deserialize_aws_json_1_1(
                data["JsonClassifier"]
            )
        )
    if "CsvClassifier" in data:
        ...
        out["csv_classifier"] = (
            aws_sdk_glue.types.csv_classifier.deserialize_aws_json_1_1(
                data["CsvClassifier"]
            )
        )
    return out
