...
if TYPE_CHECKING:
    import aws_sdk_glue.types.sensitive_string
    import aws_sdk_glue.types.spark_connect_endpoint_url
...
class SessionEndpoint(TypedDict):
    ...
    auth_token_expiration_time: "aws_sdk_glue.types.timestamp_value.TimestampValue"
