"""Generated from Smithy shape ``com.amazonaws.glue#DirectKinesisSource``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_glue.types.kinesis_streaming_source_options
    import aws_sdk_glue.types.node_name
    import aws_sdk_glue.types.streaming_data_preview_options


class DirectKinesisSource(TypedDict, closed=True):
    name: "aws_sdk_glue.types.node_name.NodeName"
    """<p>The name of the data source.</p>"""
    window_size: NotRequired["aws_sdk_glue.types.boxed_positive_int.BoxedPositiveInt"]
    """<p>The amount of time to spend processing each micro batch.</p>"""
    detect_schema: NotRequired["aws_sdk_glue.types.boxed_boolean.BoxedBoolean"]
    """<p>Whether to automatically determine the schema from the incoming data.</p>"""
    streaming_options: NotRequired[
        "aws_sdk_glue.types.kinesis_streaming_source_options.KinesisStreamingSourceOptions"
    ]
    """<p>Additional options for the Kinesis streaming data source.</p>"""
    data_preview_options: NotRequired[
        "aws_sdk_glue.types.streaming_data_preview_options.StreamingDataPreviewOptions"
    ]
    """<p>Additional options for data preview.</p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DirectKinesisSource) -> dict:
    out: dict = {}
    out["Name"] = value["name"]
    ...
    if "streaming_options" in value:
        ...
        out["StreamingOptions"] = (
            aws_sdk_glue.types.kinesis_streaming_source_options.serialize_aws_json_1_1(
    ...
    if "data_preview_options" in value:
        ...
        out["DataPreviewOptions"] = (
            aws_sdk_glue.types.streaming_data_preview_options.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DirectKinesisSource:
    ...
    if "StreamingOptions" in data:
        ...
        out["streaming_options"] = (
            aws_sdk_glue.types.kinesis_streaming_source_options.deserialize_aws_json_1_1(
    ...
    if "DataPreviewOptions" in data:
        ...
        out["data_preview_options"] = (
            aws_sdk_glue.types.streaming_data_preview_options.deserialize_aws_json_1_1(
