...
class GetCatalogsRequest(TypedDict):
    parent_catalog_id: NotRequired[
    ...
    recursive: "aws_sdk_glue.types.boolean.Boolean"
    ...
    include_root: NotRequired["aws_sdk_glue.types.nullable_boolean.NullableBoolean"]
    ...
    has_databases: NotRequired["aws_sdk_glue.types.nullable_boolean.NullableBoolean"]
