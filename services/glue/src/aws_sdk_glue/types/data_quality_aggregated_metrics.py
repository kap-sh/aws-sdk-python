...
class DataQualityAggregatedMetrics(TypedDict):
    total_rows_processed: NotRequired[
    ...
    total_rows_passed: NotRequired["aws_sdk_glue.types.nullable_double.NullableDouble"]
    """<p>The total number of rows that passed all applicable data quality rules.</p>"""
    total_rows_failed: NotRequired["aws_sdk_glue.types.nullable_double.NullableDouble"]
    """<p>The total number of rows that failed one or more data quality rules.</p>"""
    total_rules_processed: NotRequired[
        "aws_sdk_glue.types.nullable_double.NullableDouble"
    ]
    """<p>The total number of data quality rules that were evaluated.</p>"""
    total_rules_passed: NotRequired["aws_sdk_glue.types.nullable_double.NullableDouble"]
    """<p>The total number of data quality rules that passed their evaluation criteria.</p>"""
    total_rules_failed: NotRequired["aws_sdk_glue.types.nullable_double.NullableDouble"]
