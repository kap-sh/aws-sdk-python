...
if TYPE_CHECKING:
    import aws_sdk_glue.types.backfill_errors
    import aws_sdk_glue.types.key_schema_element_list
    import aws_sdk_glue.types.name_string
    import aws_sdk_glue.types.partition_index_status


class PartitionIndexDescriptor(TypedDict):
    index_name: "aws_sdk_glue.types.name_string.NameString"
    """<p>The name of the partition index.</p>"""
    keys: "aws_sdk_glue.types.key_schema_element_list.KeySchemaElementList"
    """<p>A list of one or more keys, as <code>KeySchemaElement</code> structures, for the partition index.</p>"""
    index_status: "aws_sdk_glue.types.partition_index_status.PartitionIndexStatus"
    ...
    backfill_errors: NotRequired["aws_sdk_glue.types.backfill_errors.BackfillErrors"]
...
def serialize_aws_json_1_1(value: PartitionIndexDescriptor) -> dict:
    ...
    out["Keys"] = aws_sdk_glue.types.key_schema_element_list.serialize_aws_json_1_1(
        value["keys"]
    )
    import aws_sdk_glue.types.partition_index_status

    out["IndexStatus"] = (
        aws_sdk_glue.types.partition_index_status.serialize_aws_json_1_1(
            value["index_status"]
        )
    )
    if "backfill_errors" in value:
        ...
        out["BackfillErrors"] = (
            aws_sdk_glue.types.backfill_errors.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> PartitionIndexDescriptor:
    ...
    if "Keys" in data:
        ...
        out["keys"] = (
            aws_sdk_glue.types.key_schema_element_list.deserialize_aws_json_1_1(
                data["Keys"]
            )
        )
    else:
    ...
    if "IndexStatus" in data:
        ...
        out["index_status"] = (
            aws_sdk_glue.types.partition_index_status.deserialize_aws_json_1_1(
                data["IndexStatus"]
            )
        )
    else:
    ...
    if "BackfillErrors" in data:
        ...
        out["backfill_errors"] = (
            aws_sdk_glue.types.backfill_errors.deserialize_aws_json_1_1(
                data["BackfillErrors"]
            )
        )
    return out
