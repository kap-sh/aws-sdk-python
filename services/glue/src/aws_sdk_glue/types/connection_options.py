...
if TYPE_CHECKING:
    import aws_sdk_glue.types.option_key
    import aws_sdk_glue.types.option_value

ConnectionOptions: TypeAlias = dict[
    "aws_sdk_glue.types.option_key.OptionKey",
    "aws_sdk_glue.types.option_value.OptionValue",
]
