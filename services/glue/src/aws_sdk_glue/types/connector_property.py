...
class ConnectorProperty(TypedDict):
    ...
    allowed_values: NotRequired["aws_sdk_glue.types.list_of_string.ListOfString"]
    ...
    property_type: "aws_sdk_glue.types.property_type.PropertyType"
...
def serialize_aws_json_1_1(value: ConnectorProperty) -> dict:
    ...
    if "allowed_values" in value:
        ...
        out["AllowedValues"] = aws_sdk_glue.types.list_of_string.serialize_aws_json_1_1(
    ...
    out["PropertyType"] = aws_sdk_glue.types.property_type.serialize_aws_json_1_1(
        value["property_type"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ConnectorProperty:
    ...
    if "PropertyType" in data:
        ...
        out["property_type"] = (
            aws_sdk_glue.types.property_type.deserialize_aws_json_1_1(
                data["PropertyType"]
            )
        )
    else:
