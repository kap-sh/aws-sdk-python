...
if TYPE_CHECKING:
    import aws_sdk_glue.types.iceberg_null_order
    import aws_sdk_glue.types.iceberg_sort_direction
...
class IcebergSortField(TypedDict, closed=True):
    ...
    direction: "aws_sdk_glue.types.iceberg_sort_direction.IcebergSortDirection"
    """<p>The sort direction for this field, either ascending or descending.</p>"""
    null_order: "aws_sdk_glue.types.iceberg_null_order.IcebergNullOrder"
...
def serialize_aws_json_1_1(value: IcebergSortField) -> dict:
    ...
    out["Direction"] = aws_sdk_glue.types.iceberg_sort_direction.serialize_aws_json_1_1(
        value["direction"]
    )
    import aws_sdk_glue.types.iceberg_null_order

    out["NullOrder"] = aws_sdk_glue.types.iceberg_null_order.serialize_aws_json_1_1(
        value["null_order"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> IcebergSortField:
    ...
    if "Direction" in data:
        ...
        out["direction"] = (
            aws_sdk_glue.types.iceberg_sort_direction.deserialize_aws_json_1_1(
                data["Direction"]
            )
        )
    else:
    ...
    if "NullOrder" in data:
        ...
        out["null_order"] = (
            aws_sdk_glue.types.iceberg_null_order.deserialize_aws_json_1_1(
                data["NullOrder"]
            )
        )
    else:
