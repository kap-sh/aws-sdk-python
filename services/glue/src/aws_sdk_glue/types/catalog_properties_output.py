...
if TYPE_CHECKING:
    import aws_sdk_glue.types.data_lake_access_properties_output
    import aws_sdk_glue.types.iceberg_optimization_properties_output
    import aws_sdk_glue.types.parameters_map


class CatalogPropertiesOutput(TypedDict):
    data_lake_access_properties: NotRequired[
        "aws_sdk_glue.types.data_lake_access_properties_output.DataLakeAccessPropertiesOutput"
    ]
    ...
    iceberg_optimization_properties: NotRequired[
        "aws_sdk_glue.types.iceberg_optimization_properties_output.IcebergOptimizationPropertiesOutput"
    ]
...
def serialize_aws_json_1_1(value: CatalogPropertiesOutput) -> dict:
    ...
    if "data_lake_access_properties" in value:
        ...
        out["DataLakeAccessProperties"] = (
            aws_sdk_glue.types.data_lake_access_properties_output.serialize_aws_json_1_1(
    ...
    if "iceberg_optimization_properties" in value:
        ...
        out["IcebergOptimizationProperties"] = (
            aws_sdk_glue.types.iceberg_optimization_properties_output.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CatalogPropertiesOutput:
    ...
    if "DataLakeAccessProperties" in data:
        ...
        out["data_lake_access_properties"] = (
            aws_sdk_glue.types.data_lake_access_properties_output.deserialize_aws_json_1_1(
    ...
    if "IcebergOptimizationProperties" in data:
        ...
        out["iceberg_optimization_properties"] = (
            aws_sdk_glue.types.iceberg_optimization_properties_output.deserialize_aws_json_1_1(
