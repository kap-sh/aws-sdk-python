...
class DescribeIntegrationsResponse(TypedDict, closed=True):
    integrations: NotRequired["aws_sdk_glue.types.integrations_list.IntegrationsList"]
...
def serialize_aws_json_1_1(value: DescribeIntegrationsResponse) -> dict:
    ...
    if "integrations" in value:
        ...
        out["Integrations"] = (
            aws_sdk_glue.types.integrations_list.serialize_aws_json_1_1(
                value["integrations"]
            )
        )
    if "marker" in value:
...
def deserialize_aws_json_1_1(data: dict) -> DescribeIntegrationsResponse:
    ...
    if "Integrations" in data:
        ...
        out["integrations"] = (
            aws_sdk_glue.types.integrations_list.deserialize_aws_json_1_1(
                data["Integrations"]
            )
        )
    if "Marker" in data:
