...
if TYPE_CHECKING:
    ...
    import aws_sdk_glue.types.connection_type_variant_list
    import aws_sdk_glue.types.description
    import aws_sdk_glue.types.display_name
    import aws_sdk_glue.types.list_of_string
    import aws_sdk_glue.types.url_string
    import aws_sdk_glue.types.vendor


class ConnectionTypeBrief(TypedDict):
    connection_type: NotRequired["aws_sdk_glue.types.connection_type.ConnectionType"]
    """<p>The name of the connection type.</p>"""
    display_name: NotRequired["aws_sdk_glue.types.display_name.DisplayName"]
    """<p>The human-readable name for the connection type that is displayed in the Glue console.</p>"""
    vendor: NotRequired["aws_sdk_glue.types.vendor.Vendor"]
    ...
    categories: NotRequired["aws_sdk_glue.types.list_of_string.ListOfString"]
    ...
    logo_url: NotRequired["aws_sdk_glue.types.url_string.UrlString"]
    """<p>The URL of the logo associated with a connection type.</p>"""
    connection_type_variants: NotRequired[
        "aws_sdk_glue.types.connection_type_variant_list.ConnectionTypeVariantList"
    ]
...
def serialize_aws_json_1_1(value: ConnectionTypeBrief) -> dict:
    ...
    if "categories" in value:
        ...
        out["Categories"] = aws_sdk_glue.types.list_of_string.serialize_aws_json_1_1(
            value["categories"]
        )
    ...
    if "connection_type_variants" in value:
        ...
        out["ConnectionTypeVariants"] = (
            aws_sdk_glue.types.connection_type_variant_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ConnectionTypeBrief:
    ...
    if "Categories" in data:
        ...
        out["categories"] = aws_sdk_glue.types.list_of_string.deserialize_aws_json_1_1(
            data["Categories"]
        )
    ...
    if "ConnectionTypeVariants" in data:
        ...
        out["connection_type_variants"] = (
            aws_sdk_glue.types.connection_type_variant_list.deserialize_aws_json_1_1(
