...
if TYPE_CHECKING:
    import aws_sdk_glue.types.amazon_redshift_advanced_options
...
class AmazonRedshiftNodeData(TypedDict):
    ...
    advanced_options: NotRequired[
        "aws_sdk_glue.types.amazon_redshift_advanced_options.AmazonRedshiftAdvancedOptions"
    ]
    ...
    crawler_connection: NotRequired["aws_sdk_glue.types.generic_string.GenericString"]
...
def serialize_aws_json_1_1(value: AmazonRedshiftNodeData) -> dict:
    ...
    if "schema" in value:
        ...
        out["Schema"] = aws_sdk_glue.types.option.serialize_aws_json_1_1(
            value["schema"]
        )
    if "table" in value:
        import aws_sdk_glue.types.option

        out["Table"] = aws_sdk_glue.types.option.serialize_aws_json_1_1(value["table"])
    if "catalog_database" in value:
        import aws_sdk_glue.types.option

        out["CatalogDatabase"] = aws_sdk_glue.types.option.serialize_aws_json_1_1(
            value["catalog_database"]
        )
    if "catalog_table" in value:
        import aws_sdk_glue.types.option

        out["CatalogTable"] = aws_sdk_glue.types.option.serialize_aws_json_1_1(
            value["catalog_table"]
        )
    ...
    if "advanced_options" in value:
        ...
        out["AdvancedOptions"] = (
            aws_sdk_glue.types.amazon_redshift_advanced_options.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AmazonRedshiftNodeData:
    ...
    if "Schema" in data:
        ...
        out["schema"] = aws_sdk_glue.types.option.deserialize_aws_json_1_1(
            data["Schema"]
        )
    if "Table" in data:
        import aws_sdk_glue.types.option

        out["table"] = aws_sdk_glue.types.option.deserialize_aws_json_1_1(data["Table"])
    if "CatalogDatabase" in data:
        import aws_sdk_glue.types.option

        out["catalog_database"] = aws_sdk_glue.types.option.deserialize_aws_json_1_1(
            data["CatalogDatabase"]
        )
    if "CatalogTable" in data:
        import aws_sdk_glue.types.option

        out["catalog_table"] = aws_sdk_glue.types.option.deserialize_aws_json_1_1(
            data["CatalogTable"]
        )
    ...
    if "AdvancedOptions" in data:
        ...
        out["advanced_options"] = (
            aws_sdk_glue.types.amazon_redshift_advanced_options.deserialize_aws_json_1_1(
