...
class DescribeInboundIntegrationsRequest(TypedDict):
    integration_arn: NotRequired["aws_sdk_glue.types.string128.String128"]
    ...
    target_arn: NotRequired["aws_sdk_glue.types.string512.String512"]
