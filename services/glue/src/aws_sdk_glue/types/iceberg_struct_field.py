...
if TYPE_CHECKING:
    ...
    import aws_sdk_glue.types.iceberg_document
    import aws_sdk_glue.types.integer


class IcebergStructField(TypedDict):
    id: "aws_sdk_glue.types.integer.Integer"
    ...
    initial_default: NotRequired["aws_sdk_glue.types.iceberg_document.IcebergDocument"]
    ...
    write_default: NotRequired["aws_sdk_glue.types.iceberg_document.IcebergDocument"]
