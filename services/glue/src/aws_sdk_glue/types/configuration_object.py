...
class ConfigurationObject(TypedDict, closed=True):
    ...
    allowed_values: NotRequired[
        "aws_sdk_glue.types.allowed_values_string_list.AllowedValuesStringList"
    ]
    """<p>A list of allowed values for the parameter.</p>"""
    min_value: NotRequired["aws_sdk_glue.types.config_value_string.ConfigValueString"]
    """<p>A minimum allowed value for the parameter.</p>"""
    max_value: NotRequired["aws_sdk_glue.types.config_value_string.ConfigValueString"]
...
def serialize_aws_json_1_1(value: ConfigurationObject) -> dict:
    ...
    if "allowed_values" in value:
        ...
        out["AllowedValues"] = (
            aws_sdk_glue.types.allowed_values_string_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ConfigurationObject:
    ...
    if "AllowedValues" in data:
        ...
        out["allowed_values"] = (
            aws_sdk_glue.types.allowed_values_string_list.deserialize_aws_json_1_1(
                data["AllowedValues"]
            )
        )
    if "MinValue" in data:
