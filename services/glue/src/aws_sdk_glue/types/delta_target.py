...
class DeltaTarget(TypedDict, closed=True):
    ...
    write_manifest: NotRequired["aws_sdk_glue.types.nullable_boolean.NullableBoolean"]
...
def serialize_aws_json_1_1(value: DeltaTarget) -> dict:
    ...
    if "delta_tables" in value:
        ...
        out["DeltaTables"] = aws_sdk_glue.types.path_list.serialize_aws_json_1_1(
            value["delta_tables"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> DeltaTarget:
    ...
    if "DeltaTables" in data:
        ...
        out["delta_tables"] = aws_sdk_glue.types.path_list.deserialize_aws_json_1_1(
            data["DeltaTables"]
        )
