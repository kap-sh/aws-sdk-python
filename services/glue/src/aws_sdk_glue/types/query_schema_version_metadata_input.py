...
class QuerySchemaVersionMetadataInput(TypedDict):
    ...
    metadata_list: NotRequired["aws_sdk_glue.types.metadata_list.MetadataList"]
...
def serialize_aws_json_1_1(value: QuerySchemaVersionMetadataInput) -> dict:
    ...
    if "metadata_list" in value:
        ...
        out["MetadataList"] = aws_sdk_glue.types.metadata_list.serialize_aws_json_1_1(
            value["metadata_list"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> QuerySchemaVersionMetadataInput:
    ...
    if "MetadataList" in data:
        ...
        out["metadata_list"] = (
            aws_sdk_glue.types.metadata_list.deserialize_aws_json_1_1(
                data["MetadataList"]
            )
        )
