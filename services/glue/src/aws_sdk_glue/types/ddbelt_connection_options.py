...
if TYPE_CHECKING:
    ...
    import aws_sdk_glue.types.ddb_export_type
...
def serialize_aws_json_1_1(value: DDBELTConnectionOptions) -> dict:
    ...
    if "dynamodb_export" in value:
        ...
        out["DynamodbExport"] = (
            aws_sdk_glue.types.ddb_export_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DDBELTConnectionOptions:
    ...
    if "DynamodbExport" in data:
        ...
        out["dynamodb_export"] = (
            aws_sdk_glue.types.ddb_export_type.deserialize_aws_json_1_1(
                data["DynamodbExport"]
            )
        )
