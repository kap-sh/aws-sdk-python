...
def serialize_aws_json_1_1(value: BatchGetBlueprintsResponse) -> dict:
    ...
    if "blueprints" in value:
        ...
        out["Blueprints"] = aws_sdk_glue.types.blueprints.serialize_aws_json_1_1(
            value["blueprints"]
        )
    if "missing_blueprints" in value:
        ...
        out["MissingBlueprints"] = (
            aws_sdk_glue.types.blueprint_names.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BatchGetBlueprintsResponse:
    ...
    if "Blueprints" in data:
        ...
        out["blueprints"] = aws_sdk_glue.types.blueprints.deserialize_aws_json_1_1(
            data["Blueprints"]
        )
    if "MissingBlueprints" in data:
        ...
        out["missing_blueprints"] = (
            aws_sdk_glue.types.blueprint_names.deserialize_aws_json_1_1(
