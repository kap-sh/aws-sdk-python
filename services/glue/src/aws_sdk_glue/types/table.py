...
if TYPE_CHECKING:
    ...
    import aws_sdk_glue.types.federated_table
...
class Table(TypedDict, closed=True):
    ...
    created_by: NotRequired["aws_sdk_glue.types.name_string.NameString"]
    ...
    federated_table: NotRequired["aws_sdk_glue.types.federated_table.FederatedTable"]
    """<p>A <code>FederatedTable</code> structure that references an entity outside the Glue Data Catalog.</p>"""
    view_definition: NotRequired["aws_sdk_glue.types.view_definition.ViewDefinition"]
    ...
    status: NotRequired["aws_sdk_glue.types.table_status.TableStatus"]
...
def serialize_aws_json_1_1(value: Table) -> dict:
    ...
    if "federated_table" in value:
        ...
        out["FederatedTable"] = (
            aws_sdk_glue.types.federated_table.serialize_aws_json_1_1(
    ...
    if "view_definition" in value:
        ...
        out["ViewDefinition"] = (
            aws_sdk_glue.types.view_definition.serialize_aws_json_1_1(
    ...
    if "status" in value:
        ...
        out["Status"] = aws_sdk_glue.types.table_status.serialize_aws_json_1_1(
            value["status"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Table:
    ...
    if "FederatedTable" in data:
        ...
        out["federated_table"] = (
            aws_sdk_glue.types.federated_table.deserialize_aws_json_1_1(
                data["FederatedTable"]
            )
        )
    if "ViewDefinition" in data:
        ...
        out["view_definition"] = (
            aws_sdk_glue.types.view_definition.deserialize_aws_json_1_1(
                data["ViewDefinition"]
            )
        )
    ...
    if "Status" in data:
        ...
        out["status"] = aws_sdk_glue.types.table_status.deserialize_aws_json_1_1(
            data["Status"]
        )
    return out
