...
class GetClassifierResponse(TypedDict):
    classifier: NotRequired["aws_sdk_glue.types.classifier.Classifier"]
...
def serialize_aws_json_1_1(value: GetClassifierResponse) -> dict:
    ...
    if "classifier" in value:
        ...
        out["Classifier"] = aws_sdk_glue.types.classifier.serialize_aws_json_1_1(
            value["classifier"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetClassifierResponse:
    ...
    if "Classifier" in data:
        ...
        out["classifier"] = aws_sdk_glue.types.classifier.deserialize_aws_json_1_1(
            data["Classifier"]
        )
    return out
