...
class GlueError(Exception):
    """Base class for all Glue service errors."""


class ServiceError(GlueError):
...
class DeserializationError(GlueError):
...
class WaiterFailedError(GlueError):
...
class WaiterTimeoutError(GlueError):
