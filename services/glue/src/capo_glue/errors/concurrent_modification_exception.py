"""Generated from Smithy shape ``com.amazonaws.glue#ConcurrentModificationException``."""
...
class ConcurrentModificationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.glue#ConcurrentModificationException``."""
