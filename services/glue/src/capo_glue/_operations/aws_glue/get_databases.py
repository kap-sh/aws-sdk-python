"""Generated from Smithy shape ``com.amazonaws.glue#GetDatabases``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_databases_response.GetDatabasesResponse = (
        capo_glue.types.get_databases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_databases_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_databases(
    ...
    capo_glue.types.get_databases_response.GetDatabasesResponse, zapros.Response
]:
