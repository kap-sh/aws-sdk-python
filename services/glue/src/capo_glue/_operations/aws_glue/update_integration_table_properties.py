"""Generated from Smithy shape ``com.amazonaws.glue#UpdateIntegrationTableProperties``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_integration_table_properties_response.UpdateIntegrationTablePropertiesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateIntegrationTableProperties"
    body: bytes | None = json.dumps(
        capo_glue.types.update_integration_table_properties_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_integration_table_properties(
