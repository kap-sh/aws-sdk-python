"""Generated from Smithy shape ``com.amazonaws.glue#GetDevEndpoint``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_dev_endpoint_response.GetDevEndpointResponse = (
        capo_glue.types.get_dev_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_dev_endpoint_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_dev_endpoint(
    ...
    capo_glue.types.get_dev_endpoint_response.GetDevEndpointResponse, zapros.Response
]:
...
async def async_get_dev_endpoint(
