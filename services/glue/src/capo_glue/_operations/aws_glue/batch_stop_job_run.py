"""Generated from Smithy shape ``com.amazonaws.glue#BatchStopJobRun``."""
...
def handle_response(
    ...
    out: capo_glue.types.batch_stop_job_run_response.BatchStopJobRunResponse = (
        capo_glue.types.batch_stop_job_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.batch_stop_job_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def batch_stop_job_run(
    ...
    capo_glue.types.batch_stop_job_run_response.BatchStopJobRunResponse, zapros.Response
]:
...
async def async_batch_stop_job_run(
