"""Generated from Smithy shape ``com.amazonaws.glue#ListDataQualityStatistics``."""
...
def handle_response(
    ...
    out: capo_glue.types.list_data_quality_statistics_response.ListDataQualityStatisticsResponse = capo_glue.types.list_data_quality_statistics_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListDataQualityStatistics"
    body: bytes | None = json.dumps(
        capo_glue.types.list_data_quality_statistics_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_data_quality_statistics(
