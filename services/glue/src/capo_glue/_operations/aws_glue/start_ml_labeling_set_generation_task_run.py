...
def handle_response(
    ...
    out: capo_glue.types.start_ml_labeling_set_generation_task_run_response.StartMLLabelingSetGenerationTaskRunResponse = capo_glue.types.start_ml_labeling_set_generation_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.start_ml_labeling_set_generation_task_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
