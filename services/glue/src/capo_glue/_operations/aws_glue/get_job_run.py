...
def handle_response(
    ...
    out: capo_glue.types.get_job_run_response.GetJobRunResponse = (
        capo_glue.types.get_job_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_job_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_job_run(
    ...
    input_: capo_glue.types.get_job_run_request.GetJobRunRequest,
) -> tuple[capo_glue.types.get_job_run_response.GetJobRunResponse, zapros.Response]:
