"""Generated from Smithy shape ``com.amazonaws.glue#DeleteIntegration``."""
...
import capo_glue.errors.conflict_exception
import capo_glue.errors.entity_not_found_exception
import capo_glue.errors.integration_conflict_operation_fault
import capo_glue.errors.integration_not_found_fault
import capo_glue.errors.internal_server_exception
import capo_glue.errors.internal_service_exception
import capo_glue.errors.invalid_input_exception
import capo_glue.errors.invalid_integration_state_fault
import capo_glue.errors.invalid_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_glue.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
        ...
        case "IntegrationConflictOperationFault":
            raise capo_glue.errors.integration_conflict_operation_fault.IntegrationConflictOperationFault.from_aws_json_1_1(
                data
            )
        case "IntegrationNotFoundFault":
            raise capo_glue.errors.integration_not_found_fault.IntegrationNotFoundFault.from_aws_json_1_1(
                data
            )
        case "InternalServerException":
            raise capo_glue.errors.internal_server_exception.InternalServerException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidIntegrationStateFault":
            raise capo_glue.errors.invalid_integration_state_fault.InvalidIntegrationStateFault.from_aws_json_1_1(
                data
            )
        case "InvalidStateException":
            raise capo_glue.errors.invalid_state_exception.InvalidStateException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_glue.types.delete_integration_response.DeleteIntegrationResponse = (
        capo_glue.types.delete_integration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteIntegration"
    body: bytes | None = json.dumps(
        capo_glue.types.delete_integration_request.serialize_aws_json_1_1(input_)
    ).encode()
