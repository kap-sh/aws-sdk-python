"""Generated from Smithy shape ``com.amazonaws.glue#GetMLTaskRuns``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_ml_task_runs_response.GetMLTaskRunsResponse = (
        capo_glue.types.get_ml_task_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_ml_task_runs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_ml_task_runs(
    ...
    capo_glue.types.get_ml_task_runs_response.GetMLTaskRunsResponse, zapros.Response
]:
...
async def async_get_ml_task_runs(
