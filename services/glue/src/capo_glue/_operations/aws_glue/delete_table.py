...
def handle_response(
    ...
    out: capo_glue.types.delete_table_response.DeleteTableResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_table_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_table(
    ...
    input_: capo_glue.types.delete_table_request.DeleteTableRequest,
) -> tuple[capo_glue.types.delete_table_response.DeleteTableResponse, zapros.Response]:
