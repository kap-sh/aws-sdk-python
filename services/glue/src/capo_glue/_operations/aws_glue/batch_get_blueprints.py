"""Generated from Smithy shape ``com.amazonaws.glue#BatchGetBlueprints``."""
...
def handle_response(
    ...
    out: capo_glue.types.batch_get_blueprints_response.BatchGetBlueprintsResponse = (
        capo_glue.types.batch_get_blueprints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.BatchGetBlueprints"
    body: bytes | None = json.dumps(
        capo_glue.types.batch_get_blueprints_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_batch_get_blueprints(
