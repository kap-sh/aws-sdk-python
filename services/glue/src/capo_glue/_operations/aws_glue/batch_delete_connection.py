...
def handle_response(
    ...
    out: capo_glue.types.batch_delete_connection_response.BatchDeleteConnectionResponse = capo_glue.types.batch_delete_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.batch_delete_connection_request.serialize_aws_json_1_1(input_)
    ).encode()
