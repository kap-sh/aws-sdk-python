...
def handle_response(
    ...
    out: capo_glue.types.create_database_response.CreateDatabaseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_database_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_database(
    ...
    capo_glue.types.create_database_response.CreateDatabaseResponse, zapros.Response
]:
