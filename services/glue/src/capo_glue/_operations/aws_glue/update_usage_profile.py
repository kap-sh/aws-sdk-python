...
def handle_response(
    ...
    out: capo_glue.types.update_usage_profile_response.UpdateUsageProfileResponse = (
        capo_glue.types.update_usage_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_usage_profile_request.serialize_aws_json_1_1(input_)
    ).encode()
