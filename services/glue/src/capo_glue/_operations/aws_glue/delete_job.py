"""Generated from Smithy shape ``com.amazonaws.glue#DeleteJob``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_job_response.DeleteJobResponse = (
        capo_glue.types.delete_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_job(
    ...
    input_: capo_glue.types.delete_job_request.DeleteJobRequest,
) -> tuple[capo_glue.types.delete_job_response.DeleteJobResponse, zapros.Response]:
