...
def handle_response(
    ...
    out: capo_glue.types.update_workflow_response.UpdateWorkflowResponse = (
        capo_glue.types.update_workflow_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_workflow_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_workflow(
    ...
    capo_glue.types.update_workflow_response.UpdateWorkflowResponse, zapros.Response
]:
