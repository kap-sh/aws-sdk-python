"""Generated from Smithy shape ``com.amazonaws.glue#GetConnection``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_connection_response.GetConnectionResponse = (
        capo_glue.types.get_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_connection_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_connection(
    ...
    capo_glue.types.get_connection_response.GetConnectionResponse, zapros.Response
]:
