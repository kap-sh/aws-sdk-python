"""Generated from Smithy shape ``com.amazonaws.glue#GetTags``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_tags_response.GetTagsResponse = (
        capo_glue.types.get_tags_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_tags_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_tags(
    options: OperationOptions, input_: capo_glue.types.get_tags_request.GetTagsRequest
) -> tuple[capo_glue.types.get_tags_response.GetTagsResponse, zapros.Response]:
