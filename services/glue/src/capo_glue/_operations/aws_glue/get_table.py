"""Generated from Smithy shape ``com.amazonaws.glue#GetTable``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_table_response.GetTableResponse = (
        capo_glue.types.get_table_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_table_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_table(
    options: OperationOptions, input_: capo_glue.types.get_table_request.GetTableRequest
) -> tuple[capo_glue.types.get_table_response.GetTableResponse, zapros.Response]:
