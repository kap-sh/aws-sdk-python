"""Generated from Smithy shape ``com.amazonaws.glue#GetPartitions``."""
...
import capo_glue.errors.resource_not_ready_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotReadyException":
            raise capo_glue.errors.resource_not_ready_exception.ResourceNotReadyException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_glue.types.get_partitions_response.GetPartitionsResponse = (
        capo_glue.types.get_partitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_partitions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_partitions(
    ...
    capo_glue.types.get_partitions_response.GetPartitionsResponse, zapros.Response
]:
