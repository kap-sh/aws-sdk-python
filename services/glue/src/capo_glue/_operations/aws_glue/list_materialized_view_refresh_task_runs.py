...
import capo_glue.types.materialized_view_refresh_task_runs_list
...
def handle_response(
    ...
    out: capo_glue.types.list_materialized_view_refresh_task_runs_response.ListMaterializedViewRefreshTaskRunsResponse = capo_glue.types.list_materialized_view_refresh_task_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_materialized_view_refresh_task_runs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
