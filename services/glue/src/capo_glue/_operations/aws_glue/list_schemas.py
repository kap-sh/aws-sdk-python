...
def handle_response(
    ...
    out: capo_glue.types.list_schemas_response.ListSchemasResponse = (
        capo_glue.types.list_schemas_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_schemas_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_schemas(
    ...
    input_: capo_glue.types.list_schemas_input.ListSchemasInput,
) -> tuple[capo_glue.types.list_schemas_response.ListSchemasResponse, zapros.Response]:
