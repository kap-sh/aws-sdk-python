"""Generated from Smithy shape ``com.amazonaws.glue#DeleteUsageProfile``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_usage_profile_response.DeleteUsageProfileResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteUsageProfile"
    body: bytes | None = json.dumps(
        capo_glue.types.delete_usage_profile_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_usage_profile(
