"""Generated from Smithy shape ``com.amazonaws.glue#UpdateIntegrationResourceProperty``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_integration_resource_property_response.UpdateIntegrationResourcePropertyResponse = capo_glue.types.update_integration_resource_property_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateIntegrationResourceProperty"
    body: bytes | None = json.dumps(
        capo_glue.types.update_integration_resource_property_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_integration_resource_property(
