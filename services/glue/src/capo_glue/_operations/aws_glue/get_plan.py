"""Generated from Smithy shape ``com.amazonaws.glue#GetPlan``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_plan_response.GetPlanResponse = (
        capo_glue.types.get_plan_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_plan_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_plan(
    options: OperationOptions, input_: capo_glue.types.get_plan_request.GetPlanRequest
) -> tuple[capo_glue.types.get_plan_response.GetPlanResponse, zapros.Response]:
