...
import capo_glue.errors.illegal_blueprint_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IllegalBlueprintStateException":
            raise capo_glue.errors.illegal_blueprint_state_exception.IllegalBlueprintStateException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_glue.types.start_blueprint_run_response.StartBlueprintRunResponse = (
        capo_glue.types.start_blueprint_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.start_blueprint_run_request.serialize_aws_json_1_1(input_)
    ).encode()
