"""Generated from Smithy shape ``com.amazonaws.glue#ImportCatalogToGlue``."""
...
def handle_response(
    ...
    out: capo_glue.types.import_catalog_to_glue_response.ImportCatalogToGlueResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.import_catalog_to_glue_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_import_catalog_to_glue(
