...
import capo_glue.errors.materialized_view_refresh_task_running_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MaterializedViewRefreshTaskRunningException":
            raise capo_glue.errors.materialized_view_refresh_task_running_exception.MaterializedViewRefreshTaskRunningException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_glue.types.start_materialized_view_refresh_task_run_response.StartMaterializedViewRefreshTaskRunResponse = capo_glue.types.start_materialized_view_refresh_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.start_materialized_view_refresh_task_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
