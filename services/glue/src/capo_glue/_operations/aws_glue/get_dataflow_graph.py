"""Generated from Smithy shape ``com.amazonaws.glue#GetDataflowGraph``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_dataflow_graph_response.GetDataflowGraphResponse = (
        capo_glue.types.get_dataflow_graph_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_dataflow_graph_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_dataflow_graph(
