"""Generated from Smithy shape ``com.amazonaws.glue#GetDatabase``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_database_response.GetDatabaseResponse = (
        capo_glue.types.get_database_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_glue.types.get_database_request.GetDatabaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_database_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_database(
    ...
    input_: capo_glue.types.get_database_request.GetDatabaseRequest,
) -> tuple[capo_glue.types.get_database_response.GetDatabaseResponse, zapros.Response]:
