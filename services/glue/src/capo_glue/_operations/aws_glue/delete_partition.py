"""Generated from Smithy shape ``com.amazonaws.glue#DeletePartition``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_partition_response.DeletePartitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_partition_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_partition(
    ...
    capo_glue.types.delete_partition_response.DeletePartitionResponse, zapros.Response
]:
...
async def async_delete_partition(
