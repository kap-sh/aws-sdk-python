"""Generated from Smithy shape ``com.amazonaws.glue#UpdateColumnStatisticsTaskSettings``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_column_statistics_task_settings_response.UpdateColumnStatisticsTaskSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateColumnStatisticsTaskSettings"
    body: bytes | None = json.dumps(
        capo_glue.types.update_column_statistics_task_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_column_statistics_task_settings(
