"""Generated from Smithy shape ``com.amazonaws.glue#BatchGetTableOptimizer``."""
...
import capo_glue.errors.throttling_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ThrottlingException":
            raise capo_glue.errors.throttling_exception.ThrottlingException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_glue.types.batch_get_table_optimizer_response.BatchGetTableOptimizerResponse = capo_glue.types.batch_get_table_optimizer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.batch_get_table_optimizer_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_batch_get_table_optimizer(
