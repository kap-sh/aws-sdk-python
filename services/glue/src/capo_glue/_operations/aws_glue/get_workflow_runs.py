"""Generated from Smithy shape ``com.amazonaws.glue#GetWorkflowRuns``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_workflow_runs_response.GetWorkflowRunsResponse = (
        capo_glue.types.get_workflow_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_workflow_runs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_workflow_runs(
    ...
    capo_glue.types.get_workflow_runs_response.GetWorkflowRunsResponse, zapros.Response
]:
