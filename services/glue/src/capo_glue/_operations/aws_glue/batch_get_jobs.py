...
def handle_response(
    ...
    out: capo_glue.types.batch_get_jobs_response.BatchGetJobsResponse = (
        capo_glue.types.batch_get_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.batch_get_jobs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def batch_get_jobs(
    ...
    capo_glue.types.batch_get_jobs_response.BatchGetJobsResponse, zapros.Response
]:
