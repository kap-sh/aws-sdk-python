"""Generated from Smithy shape ``com.amazonaws.glue#GetDataQualityRuleRecommendationRun``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_data_quality_rule_recommendation_run_response.GetDataQualityRuleRecommendationRunResponse = capo_glue.types.get_data_quality_rule_recommendation_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetDataQualityRuleRecommendationRun"
    body: bytes | None = json.dumps(
        capo_glue.types.get_data_quality_rule_recommendation_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_data_quality_rule_recommendation_run(
