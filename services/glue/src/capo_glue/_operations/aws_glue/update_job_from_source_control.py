...
def handle_response(
    ...
    out: capo_glue.types.update_job_from_source_control_response.UpdateJobFromSourceControlResponse = capo_glue.types.update_job_from_source_control_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_job_from_source_control_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
