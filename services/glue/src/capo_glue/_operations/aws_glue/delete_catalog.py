"""Generated from Smithy shape ``com.amazonaws.glue#DeleteCatalog``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_catalog_response.DeleteCatalogResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteCatalog"
    body: bytes | None = json.dumps(
        capo_glue.types.delete_catalog_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_catalog(
    ...
    capo_glue.types.delete_catalog_response.DeleteCatalogResponse, zapros.Response
]:
...
async def async_delete_catalog(
