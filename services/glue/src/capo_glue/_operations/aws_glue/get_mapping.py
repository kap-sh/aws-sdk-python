...
def handle_response(
    ...
    out: capo_glue.types.get_mapping_response.GetMappingResponse = (
        capo_glue.types.get_mapping_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_mapping_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_mapping(
    ...
    input_: capo_glue.types.get_mapping_request.GetMappingRequest,
) -> tuple[capo_glue.types.get_mapping_response.GetMappingResponse, zapros.Response]:
