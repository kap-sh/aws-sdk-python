...
import capo_glue.errors.federated_resource_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FederatedResourceAlreadyExistsException":
            raise capo_glue.errors.federated_resource_already_exists_exception.FederatedResourceAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_glue.types.create_catalog_response.CreateCatalogResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_catalog_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_catalog(
    ...
    capo_glue.types.create_catalog_response.CreateCatalogResponse, zapros.Response
]:
