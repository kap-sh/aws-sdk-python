...
def handle_response(
    ...
    out: capo_glue.types.list_usage_profiles_response.ListUsageProfilesResponse = (
        capo_glue.types.list_usage_profiles_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_usage_profiles_request.serialize_aws_json_1_1(input_)
    ).encode()
