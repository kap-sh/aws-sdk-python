...
def handle_response(
    ...
    out: capo_glue.types.get_dashboard_url_response.GetDashboardUrlResponse = (
        capo_glue.types.get_dashboard_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_dashboard_url_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_dashboard_url(
    ...
    capo_glue.types.get_dashboard_url_response.GetDashboardUrlResponse, zapros.Response
]:
