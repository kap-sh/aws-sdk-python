"""Generated from Smithy shape ``com.amazonaws.glue#DeleteSecurityConfiguration``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_security_configuration_response.DeleteSecurityConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_security_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
