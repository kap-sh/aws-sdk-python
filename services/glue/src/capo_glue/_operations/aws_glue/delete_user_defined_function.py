"""Generated from Smithy shape ``com.amazonaws.glue#DeleteUserDefinedFunction``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_user_defined_function_response.DeleteUserDefinedFunctionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_user_defined_function_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_user_defined_function(
