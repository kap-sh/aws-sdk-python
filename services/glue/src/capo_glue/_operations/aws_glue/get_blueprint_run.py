...
def handle_response(
    ...
    out: capo_glue.types.get_blueprint_run_response.GetBlueprintRunResponse = (
        capo_glue.types.get_blueprint_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_blueprint_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_blueprint_run(
    ...
    capo_glue.types.get_blueprint_run_response.GetBlueprintRunResponse, zapros.Response
]:
