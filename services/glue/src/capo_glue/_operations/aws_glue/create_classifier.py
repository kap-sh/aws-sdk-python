"""Generated from Smithy shape ``com.amazonaws.glue#CreateClassifier``."""
...
def handle_response(
    ...
    out: capo_glue.types.create_classifier_response.CreateClassifierResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_classifier_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_classifier(
    ...
    capo_glue.types.create_classifier_response.CreateClassifierResponse, zapros.Response
]:
...
async def async_create_classifier(
