...
def handle_response(
    ...
    out: capo_glue.types.get_job_response.GetJobResponse = (
        capo_glue.types.get_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_glue.types.get_job_request.GetJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_job(
    options: OperationOptions, input_: capo_glue.types.get_job_request.GetJobRequest
) -> tuple[capo_glue.types.get_job_response.GetJobResponse, zapros.Response]:
