"""Generated from Smithy shape ``com.amazonaws.glue#ModifyIntegration``."""
...
def handle_response(
    ...
    out: capo_glue.types.modify_integration_response.ModifyIntegrationResponse = (
        capo_glue.types.modify_integration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ModifyIntegration"
    body: bytes | None = json.dumps(
        capo_glue.types.modify_integration_request.serialize_aws_json_1_1(input_)
    ).encode()
