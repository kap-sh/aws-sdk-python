"""Generated from Smithy shape ``com.amazonaws.glue#UpdateCrawler``."""
...
import capo_glue.errors.version_mismatch_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "VersionMismatchException":
            raise capo_glue.errors.version_mismatch_exception.VersionMismatchException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_glue.types.update_crawler_response.UpdateCrawlerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_crawler_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_crawler(
    ...
    capo_glue.types.update_crawler_response.UpdateCrawlerResponse, zapros.Response
]:
...
async def async_update_crawler(
