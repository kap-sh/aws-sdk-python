"""Generated from Smithy shape ``com.amazonaws.glue#GetMLTransforms``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_ml_transforms_response.GetMLTransformsResponse = (
        capo_glue.types.get_ml_transforms_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_ml_transforms_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_ml_transforms(
    ...
    capo_glue.types.get_ml_transforms_response.GetMLTransformsResponse, zapros.Response
]:
...
async def async_get_ml_transforms(
