"""Generated from Smithy shape ``com.amazonaws.glue#CreateRegistry``."""
...
def handle_response(
    ...
    out: capo_glue.types.create_registry_response.CreateRegistryResponse = (
        capo_glue.types.create_registry_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CreateRegistry"
    body: bytes | None = json.dumps(
        capo_glue.types.create_registry_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_registry(
    ...
    capo_glue.types.create_registry_response.CreateRegistryResponse, zapros.Response
]:
