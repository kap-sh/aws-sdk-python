...
import capo_glue.errors.crawler_running_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CrawlerRunningException":
            raise capo_glue.errors.crawler_running_exception.CrawlerRunningException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_glue.types.delete_crawler_response.DeleteCrawlerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_crawler_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_crawler(
    ...
    capo_glue.types.delete_crawler_response.DeleteCrawlerResponse, zapros.Response
]:
