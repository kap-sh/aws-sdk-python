"""Generated from Smithy shape ``com.amazonaws.glue#StartColumnStatisticsTaskRun``."""
...
import capo_glue.errors.column_statistics_task_running_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ColumnStatisticsTaskRunningException":
            raise capo_glue.errors.column_statistics_task_running_exception.ColumnStatisticsTaskRunningException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_glue.types.start_column_statistics_task_run_response.StartColumnStatisticsTaskRunResponse = capo_glue.types.start_column_statistics_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.StartColumnStatisticsTaskRun"
    body: bytes | None = json.dumps(
        capo_glue.types.start_column_statistics_task_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_column_statistics_task_run(
