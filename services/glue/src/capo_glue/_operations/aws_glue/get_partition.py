"""Generated from Smithy shape ``com.amazonaws.glue#GetPartition``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_partition_response.GetPartitionResponse = (
        capo_glue.types.get_partition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_partition_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_partition(
    ...
    capo_glue.types.get_partition_response.GetPartitionResponse, zapros.Response
]:
