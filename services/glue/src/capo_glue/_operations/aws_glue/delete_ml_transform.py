"""Generated from Smithy shape ``com.amazonaws.glue#DeleteMLTransform``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_ml_transform_response.DeleteMLTransformResponse = (
        capo_glue.types.delete_ml_transform_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_ml_transform_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_ml_transform(
