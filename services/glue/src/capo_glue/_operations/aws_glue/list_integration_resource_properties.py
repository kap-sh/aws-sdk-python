"""Generated from Smithy shape ``com.amazonaws.glue#ListIntegrationResourceProperties``."""
...
def handle_response(
    ...
    out: capo_glue.types.list_integration_resource_properties_response.ListIntegrationResourcePropertiesResponse = capo_glue.types.list_integration_resource_properties_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListIntegrationResourceProperties"
    body: bytes | None = json.dumps(
        capo_glue.types.list_integration_resource_properties_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_integration_resource_properties(
