"""Generated from Smithy shape ``com.amazonaws.glue#DeleteColumnStatisticsTaskSettings``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_column_statistics_task_settings_response.DeleteColumnStatisticsTaskSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteColumnStatisticsTaskSettings"
    body: bytes | None = json.dumps(
        capo_glue.types.delete_column_statistics_task_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_column_statistics_task_settings(
