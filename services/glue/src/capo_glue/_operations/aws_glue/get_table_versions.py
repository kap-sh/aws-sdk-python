"""Generated from Smithy shape ``com.amazonaws.glue#GetTableVersions``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_table_versions_response.GetTableVersionsResponse = (
        capo_glue.types.get_table_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_table_versions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_table_versions(
