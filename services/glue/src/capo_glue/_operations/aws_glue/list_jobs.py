"""Generated from Smithy shape ``com.amazonaws.glue#ListJobs``."""
...
def handle_response(
    ...
    out: capo_glue.types.list_jobs_response.ListJobsResponse = (
        capo_glue.types.list_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_jobs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_jobs(
    options: OperationOptions, input_: capo_glue.types.list_jobs_request.ListJobsRequest
) -> tuple[capo_glue.types.list_jobs_response.ListJobsResponse, zapros.Response]:
