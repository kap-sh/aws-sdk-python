...
def handle_response(
    ...
    out: capo_glue.types.cancel_ml_task_run_response.CancelMLTaskRunResponse = (
        capo_glue.types.cancel_ml_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.cancel_ml_task_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def cancel_ml_task_run(
    ...
    capo_glue.types.cancel_ml_task_run_response.CancelMLTaskRunResponse, zapros.Response
]:
