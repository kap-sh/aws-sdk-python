"""Generated from Smithy shape ``com.amazonaws.glue#GetDataQualityModelResult``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_data_quality_model_result_response.GetDataQualityModelResultResponse = capo_glue.types.get_data_quality_model_result_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetDataQualityModelResult"
    body: bytes | None = json.dumps(
        capo_glue.types.get_data_quality_model_result_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_data_quality_model_result(
