...
import capo_glue.errors.materialized_view_refresh_task_not_running_exception
import capo_glue.errors.materialized_view_refresh_task_stopping_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MaterializedViewRefreshTaskNotRunningException":
            raise capo_glue.errors.materialized_view_refresh_task_not_running_exception.MaterializedViewRefreshTaskNotRunningException.from_aws_json_1_1(
                data
            )
        case "MaterializedViewRefreshTaskStoppingException":
            raise capo_glue.errors.materialized_view_refresh_task_stopping_exception.MaterializedViewRefreshTaskStoppingException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_glue.types.stop_materialized_view_refresh_task_run_response.StopMaterializedViewRefreshTaskRunResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.stop_materialized_view_refresh_task_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
