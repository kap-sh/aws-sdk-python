"""Generated from Smithy shape ``com.amazonaws.glue#QuerySchemaVersionMetadata``."""
...
def handle_response(
    ...
    out: capo_glue.types.query_schema_version_metadata_response.QuerySchemaVersionMetadataResponse = capo_glue.types.query_schema_version_metadata_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.QuerySchemaVersionMetadata"
    body: bytes | None = json.dumps(
        capo_glue.types.query_schema_version_metadata_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_query_schema_version_metadata(
