"""Generated from Smithy shape ``com.amazonaws.glue#CreateIntegration``."""
...
import capo_glue.errors.integration_quota_exceeded_fault
...
import capo_glue.errors.kms_key_not_accessible_fault
import capo_glue.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IntegrationQuotaExceededFault":
            raise capo_glue.errors.integration_quota_exceeded_fault.IntegrationQuotaExceededFault.from_aws_json_1_1(
                data
            )
        ...
        case "KMSKeyNotAccessibleFault":
            raise capo_glue.errors.kms_key_not_accessible_fault.KMSKeyNotAccessibleFault.from_aws_json_1_1(
                data
            )
        case "ResourceNotFoundException":
            raise capo_glue.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_glue.types.create_integration_response.CreateIntegrationResponse = (
        capo_glue.types.create_integration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CreateIntegration"
    body: bytes | None = json.dumps(
        capo_glue.types.create_integration_request.serialize_aws_json_1_1(input_)
    ).encode()
