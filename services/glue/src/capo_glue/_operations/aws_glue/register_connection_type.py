...
def handle_response(
    ...
    out: capo_glue.types.register_connection_type_response.RegisterConnectionTypeResponse = capo_glue.types.register_connection_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.register_connection_type_request.serialize_aws_json_1_1(input_)
    ).encode()
