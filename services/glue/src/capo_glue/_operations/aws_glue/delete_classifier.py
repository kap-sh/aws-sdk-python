"""Generated from Smithy shape ``com.amazonaws.glue#DeleteClassifier``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_classifier_response.DeleteClassifierResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_classifier_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_classifier(
    ...
    capo_glue.types.delete_classifier_response.DeleteClassifierResponse, zapros.Response
]:
...
async def async_delete_classifier(
