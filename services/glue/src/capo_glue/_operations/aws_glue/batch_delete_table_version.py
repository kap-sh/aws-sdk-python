"""Generated from Smithy shape ``com.amazonaws.glue#BatchDeleteTableVersion``."""
...
def handle_response(
    ...
    out: capo_glue.types.batch_delete_table_version_response.BatchDeleteTableVersionResponse = capo_glue.types.batch_delete_table_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.batch_delete_table_version_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_delete_table_version(
