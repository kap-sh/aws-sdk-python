"""Generated from Smithy shape ``com.amazonaws.glue#StartCrawlerSchedule``."""
...
import capo_glue.errors.no_schedule_exception
import capo_glue.errors.operation_timeout_exception
import capo_glue.errors.scheduler_running_exception
import capo_glue.errors.scheduler_transitioning_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoScheduleException":
            raise capo_glue.errors.no_schedule_exception.NoScheduleException.from_aws_json_1_1(
                data
            )
        ...
        case "SchedulerRunningException":
            raise capo_glue.errors.scheduler_running_exception.SchedulerRunningException.from_aws_json_1_1(
                data
            )
        case "SchedulerTransitioningException":
            raise capo_glue.errors.scheduler_transitioning_exception.SchedulerTransitioningException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_glue.types.start_crawler_schedule_response.StartCrawlerScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.start_crawler_schedule_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_start_crawler_schedule(
