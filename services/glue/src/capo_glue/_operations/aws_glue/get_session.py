"""Generated from Smithy shape ``com.amazonaws.glue#GetSession``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_session_response.GetSessionResponse = (
        capo_glue.types.get_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_glue.types.get_session_request.GetSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetSession"
    body: bytes | None = json.dumps(
        capo_glue.types.get_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_session(
    ...
    input_: capo_glue.types.get_session_request.GetSessionRequest,
) -> tuple[capo_glue.types.get_session_response.GetSessionResponse, zapros.Response]:
