"""Generated from Smithy shape ``com.amazonaws.glue#GetIntegrationTableProperties``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_integration_table_properties_response.GetIntegrationTablePropertiesResponse = capo_glue.types.get_integration_table_properties_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetIntegrationTableProperties"
    body: bytes | None = json.dumps(
        capo_glue.types.get_integration_table_properties_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_integration_table_properties(
