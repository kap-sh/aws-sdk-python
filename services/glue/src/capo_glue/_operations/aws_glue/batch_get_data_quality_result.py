...
def handle_response(
    ...
    out: capo_glue.types.batch_get_data_quality_result_response.BatchGetDataQualityResultResponse = capo_glue.types.batch_get_data_quality_result_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.batch_get_data_quality_result_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
