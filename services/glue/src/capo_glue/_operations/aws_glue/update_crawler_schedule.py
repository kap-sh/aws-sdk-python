"""Generated from Smithy shape ``com.amazonaws.glue#UpdateCrawlerSchedule``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_crawler_schedule_response.UpdateCrawlerScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_crawler_schedule_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_crawler_schedule(
