...
import capo_glue.types.crawler_history_list
...
def handle_response(
    ...
    out: capo_glue.types.list_crawls_response.ListCrawlsResponse = (
        capo_glue.types.list_crawls_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_crawls_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_crawls(
    ...
    input_: capo_glue.types.list_crawls_request.ListCrawlsRequest,
) -> tuple[capo_glue.types.list_crawls_response.ListCrawlsResponse, zapros.Response]:
