"""Generated from Smithy shape ``com.amazonaws.glue#GetJobs``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_jobs_response.GetJobsResponse = (
        capo_glue.types.get_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_jobs_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_jobs(
    options: OperationOptions, input_: capo_glue.types.get_jobs_request.GetJobsRequest
) -> tuple[capo_glue.types.get_jobs_response.GetJobsResponse, zapros.Response]:
