"""Generated from Smithy shape ``com.amazonaws.glue#CreateUserDefinedFunction``."""
...
def handle_response(
    ...
    out: capo_glue.types.create_user_defined_function_response.CreateUserDefinedFunctionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_user_defined_function_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_user_defined_function(
