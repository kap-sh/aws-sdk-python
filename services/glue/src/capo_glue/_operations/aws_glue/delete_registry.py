"""Generated from Smithy shape ``com.amazonaws.glue#DeleteRegistry``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_registry_response.DeleteRegistryResponse = (
        capo_glue.types.delete_registry_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteRegistry"
    body: bytes | None = json.dumps(
        capo_glue.types.delete_registry_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_registry(
    ...
    capo_glue.types.delete_registry_response.DeleteRegistryResponse, zapros.Response
]:
