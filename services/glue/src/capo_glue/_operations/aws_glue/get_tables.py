...
def handle_response(
    ...
    out: capo_glue.types.get_tables_response.GetTablesResponse = (
        capo_glue.types.get_tables_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_tables_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_tables(
    ...
    input_: capo_glue.types.get_tables_request.GetTablesRequest,
) -> tuple[capo_glue.types.get_tables_response.GetTablesResponse, zapros.Response]:
