...
def handle_response(
    ...
    out: capo_glue.types.get_registry_response.GetRegistryResponse = (
        capo_glue.types.get_registry_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_registry_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_registry(
    ...
    input_: capo_glue.types.get_registry_input.GetRegistryInput,
) -> tuple[capo_glue.types.get_registry_response.GetRegistryResponse, zapros.Response]:
