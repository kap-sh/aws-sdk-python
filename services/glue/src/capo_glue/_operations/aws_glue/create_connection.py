...
def handle_response(
    ...
    out: capo_glue.types.create_connection_response.CreateConnectionResponse = (
        capo_glue.types.create_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_connection_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_connection(
    ...
    capo_glue.types.create_connection_response.CreateConnectionResponse, zapros.Response
]:
