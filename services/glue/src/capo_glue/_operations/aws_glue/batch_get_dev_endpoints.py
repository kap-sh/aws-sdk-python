"""Generated from Smithy shape ``com.amazonaws.glue#BatchGetDevEndpoints``."""
...
def handle_response(
    ...
    out: capo_glue.types.batch_get_dev_endpoints_response.BatchGetDevEndpointsResponse = capo_glue.types.batch_get_dev_endpoints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.batch_get_dev_endpoints_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_batch_get_dev_endpoints(
