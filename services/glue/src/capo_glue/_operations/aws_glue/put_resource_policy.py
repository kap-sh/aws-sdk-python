"""Generated from Smithy shape ``com.amazonaws.glue#PutResourcePolicy``."""
...
import capo_glue.errors.condition_check_failure_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConditionCheckFailureException":
            raise capo_glue.errors.condition_check_failure_exception.ConditionCheckFailureException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_glue.types.put_resource_policy_response.PutResourcePolicyResponse = (
        capo_glue.types.put_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.put_resource_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
