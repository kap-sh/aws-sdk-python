"""Generated from Smithy shape ``com.amazonaws.glue#GetClassifier``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_classifier_response.GetClassifierResponse = (
        capo_glue.types.get_classifier_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_classifier_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_classifier(
    ...
    capo_glue.types.get_classifier_response.GetClassifierResponse, zapros.Response
]:
...
async def async_get_classifier(
