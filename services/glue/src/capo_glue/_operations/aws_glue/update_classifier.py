"""Generated from Smithy shape ``com.amazonaws.glue#UpdateClassifier``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_classifier_response.UpdateClassifierResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_classifier_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_classifier(
    ...
    capo_glue.types.update_classifier_response.UpdateClassifierResponse, zapros.Response
]:
...
async def async_update_classifier(
