"""Generated from Smithy shape ``com.amazonaws.glue#CreateDevEndpoint``."""
...
def handle_response(
    ...
    out: capo_glue.types.create_dev_endpoint_response.CreateDevEndpointResponse = (
        capo_glue.types.create_dev_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_dev_endpoint_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_dev_endpoint(
