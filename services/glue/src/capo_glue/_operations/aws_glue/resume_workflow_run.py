"""Generated from Smithy shape ``com.amazonaws.glue#ResumeWorkflowRun``."""
...
import capo_glue.errors.concurrent_runs_exceeded_exception
import capo_glue.errors.entity_not_found_exception
import capo_glue.errors.illegal_workflow_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentRunsExceededException":
            raise capo_glue.errors.concurrent_runs_exceeded_exception.ConcurrentRunsExceededException.from_aws_json_1_1(
                data
            )
        ...
        case "IllegalWorkflowStateException":
            raise capo_glue.errors.illegal_workflow_state_exception.IllegalWorkflowStateException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_glue.types.resume_workflow_run_response.ResumeWorkflowRunResponse = (
        capo_glue.types.resume_workflow_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ResumeWorkflowRun"
    body: bytes | None = json.dumps(
        capo_glue.types.resume_workflow_run_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_resume_workflow_run(
