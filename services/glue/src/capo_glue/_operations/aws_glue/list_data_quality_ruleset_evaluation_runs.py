"""Generated from Smithy shape ``com.amazonaws.glue#ListDataQualityRulesetEvaluationRuns``."""
...
def handle_response(
    ...
    out: capo_glue.types.list_data_quality_ruleset_evaluation_runs_response.ListDataQualityRulesetEvaluationRunsResponse = capo_glue.types.list_data_quality_ruleset_evaluation_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListDataQualityRulesetEvaluationRuns"
    body: bytes | None = json.dumps(
        capo_glue.types.list_data_quality_ruleset_evaluation_runs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_data_quality_ruleset_evaluation_runs(
