...
def handle_response(
    ...
    out: capo_glue.types.delete_session_response.DeleteSessionResponse = (
        capo_glue.types.delete_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_glue.types.delete_session_request.DeleteSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_session(
    ...
    capo_glue.types.delete_session_response.DeleteSessionResponse, zapros.Response
]:
