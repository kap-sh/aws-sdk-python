...
def handle_response(
    ...
    out: capo_glue.types.start_column_statistics_task_run_schedule_response.StartColumnStatisticsTaskRunScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.start_column_statistics_task_run_schedule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
