...
def handle_response(
    ...
    out: capo_glue.types.put_data_quality_profile_annotation_response.PutDataQualityProfileAnnotationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.put_data_quality_profile_annotation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
