...
def handle_response(
    ...
    out: capo_glue.types.stop_session_response.StopSessionResponse = (
        capo_glue.types.stop_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_glue.types.stop_session_request.StopSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.stop_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_session(
    ...
    input_: capo_glue.types.stop_session_request.StopSessionRequest,
) -> tuple[capo_glue.types.stop_session_response.StopSessionResponse, zapros.Response]:
