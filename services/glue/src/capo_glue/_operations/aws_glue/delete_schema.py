"""Generated from Smithy shape ``com.amazonaws.glue#DeleteSchema``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_schema_response.DeleteSchemaResponse = (
        capo_glue.types.delete_schema_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteSchema"
    body: bytes | None = json.dumps(
        capo_glue.types.delete_schema_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_schema(
    ...
    capo_glue.types.delete_schema_response.DeleteSchemaResponse, zapros.Response
]:
