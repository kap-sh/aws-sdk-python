"""Generated from Smithy shape ``com.amazonaws.glue#GetSecurityConfigurations``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_security_configurations_response.GetSecurityConfigurationsResponse = capo_glue.types.get_security_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_security_configurations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_security_configurations(
