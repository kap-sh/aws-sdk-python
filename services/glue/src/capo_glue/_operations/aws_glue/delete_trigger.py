...
def handle_response(
    ...
    out: capo_glue.types.delete_trigger_response.DeleteTriggerResponse = (
        capo_glue.types.delete_trigger_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_trigger_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_trigger(
    ...
    capo_glue.types.delete_trigger_response.DeleteTriggerResponse, zapros.Response
]:
