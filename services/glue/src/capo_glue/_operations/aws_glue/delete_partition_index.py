"""Generated from Smithy shape ``com.amazonaws.glue#DeletePartitionIndex``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_partition_index_response.DeletePartitionIndexResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeletePartitionIndex"
    body: bytes | None = json.dumps(
        capo_glue.types.delete_partition_index_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_partition_index(
