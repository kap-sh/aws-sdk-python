...
import capo_glue.types.crawler_metrics_list
...
def handle_response(
    ...
    out: capo_glue.types.get_crawler_metrics_response.GetCrawlerMetricsResponse = (
        capo_glue.types.get_crawler_metrics_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_crawler_metrics_request.serialize_aws_json_1_1(input_)
    ).encode()
