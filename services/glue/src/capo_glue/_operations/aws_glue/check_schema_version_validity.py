...
def handle_response(
    ...
    out: capo_glue.types.check_schema_version_validity_response.CheckSchemaVersionValidityResponse = capo_glue.types.check_schema_version_validity_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.check_schema_version_validity_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
