...
def handle_response(
    ...
    out: capo_glue.types.update_column_statistics_for_table_response.UpdateColumnStatisticsForTableResponse = capo_glue.types.update_column_statistics_for_table_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_column_statistics_for_table_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
