...
def handle_response(
    ...
    out: capo_glue.types.start_crawler_response.StartCrawlerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.start_crawler_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_crawler(
    ...
    capo_glue.types.start_crawler_response.StartCrawlerResponse, zapros.Response
]:
