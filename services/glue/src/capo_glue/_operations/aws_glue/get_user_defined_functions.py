...
def handle_response(
    ...
    out: capo_glue.types.get_user_defined_functions_response.GetUserDefinedFunctionsResponse = capo_glue.types.get_user_defined_functions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_user_defined_functions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
