"""Generated from Smithy shape ``com.amazonaws.glue#UpdateTable``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_table_response.UpdateTableResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_table_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_table(
    ...
    input_: capo_glue.types.update_table_request.UpdateTableRequest,
) -> tuple[capo_glue.types.update_table_response.UpdateTableResponse, zapros.Response]:
