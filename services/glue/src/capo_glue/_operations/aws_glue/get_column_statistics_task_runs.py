"""Generated from Smithy shape ``com.amazonaws.glue#GetColumnStatisticsTaskRuns``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_column_statistics_task_runs_response.GetColumnStatisticsTaskRunsResponse = capo_glue.types.get_column_statistics_task_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetColumnStatisticsTaskRuns"
    body: bytes | None = json.dumps(
        capo_glue.types.get_column_statistics_task_runs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_column_statistics_task_runs(
