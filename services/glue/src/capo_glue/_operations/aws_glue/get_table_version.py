...
def handle_response(
    ...
    out: capo_glue.types.get_table_version_response.GetTableVersionResponse = (
        capo_glue.types.get_table_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_table_version_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_table_version(
    ...
    capo_glue.types.get_table_version_response.GetTableVersionResponse, zapros.Response
]:
