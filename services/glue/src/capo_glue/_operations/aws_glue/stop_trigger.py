"""Generated from Smithy shape ``com.amazonaws.glue#StopTrigger``."""
...
def handle_response(
    ...
    out: capo_glue.types.stop_trigger_response.StopTriggerResponse = (
        capo_glue.types.stop_trigger_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_glue.types.stop_trigger_request.StopTriggerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.stop_trigger_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_trigger(
    ...
    input_: capo_glue.types.stop_trigger_request.StopTriggerRequest,
) -> tuple[capo_glue.types.stop_trigger_response.StopTriggerResponse, zapros.Response]:
