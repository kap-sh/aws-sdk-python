"""Generated from Smithy shape ``com.amazonaws.glue#GetCustomEntityType``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_custom_entity_type_response.GetCustomEntityTypeResponse = (
        capo_glue.types.get_custom_entity_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetCustomEntityType"
    body: bytes | None = json.dumps(
        capo_glue.types.get_custom_entity_type_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_custom_entity_type(
