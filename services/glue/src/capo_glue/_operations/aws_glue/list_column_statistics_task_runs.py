"""Generated from Smithy shape ``com.amazonaws.glue#ListColumnStatisticsTaskRuns``."""
...
import capo_glue.types.column_statistics_task_run_id_list
...
def handle_response(
    ...
    out: capo_glue.types.list_column_statistics_task_runs_response.ListColumnStatisticsTaskRunsResponse = capo_glue.types.list_column_statistics_task_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListColumnStatisticsTaskRuns"
    body: bytes | None = json.dumps(
        capo_glue.types.list_column_statistics_task_runs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_column_statistics_task_runs(
