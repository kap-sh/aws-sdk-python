...
import capo_glue.errors.scheduler_not_running_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SchedulerNotRunningException":
            raise capo_glue.errors.scheduler_not_running_exception.SchedulerNotRunningException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_glue.types.stop_crawler_schedule_response.StopCrawlerScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.stop_crawler_schedule_request.serialize_aws_json_1_1(input_)
    ).encode()
