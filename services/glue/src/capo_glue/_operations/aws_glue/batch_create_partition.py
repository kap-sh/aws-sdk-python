"""Generated from Smithy shape ``com.amazonaws.glue#BatchCreatePartition``."""
...
def handle_response(
    ...
    out: capo_glue.types.batch_create_partition_response.BatchCreatePartitionResponse = capo_glue.types.batch_create_partition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.batch_create_partition_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_batch_create_partition(
