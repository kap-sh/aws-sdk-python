"""Generated from Smithy shape ``com.amazonaws.glue#CreateIntegrationTableProperties``."""
...
def handle_response(
    ...
    out: capo_glue.types.create_integration_table_properties_response.CreateIntegrationTablePropertiesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CreateIntegrationTableProperties"
    body: bytes | None = json.dumps(
        capo_glue.types.create_integration_table_properties_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_integration_table_properties(
