"""Generated from Smithy shape ``com.amazonaws.glue#ListMLTransforms``."""
...
import capo_glue.types.transform_id_list
...
def handle_response(
    ...
    out: capo_glue.types.list_ml_transforms_response.ListMLTransformsResponse = (
        capo_glue.types.list_ml_transforms_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListMLTransforms"
    body: bytes | None = json.dumps(
        capo_glue.types.list_ml_transforms_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_ml_transforms(
