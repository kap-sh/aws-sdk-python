"""Generated from Smithy shape ``com.amazonaws.glue#ListTriggers``."""
...
def handle_response(
    ...
    out: capo_glue.types.list_triggers_response.ListTriggersResponse = (
        capo_glue.types.list_triggers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_triggers_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_triggers(
    ...
    capo_glue.types.list_triggers_response.ListTriggersResponse, zapros.Response
]:
