...
def handle_response(
    ...
    out: capo_glue.types.update_job_response.UpdateJobResponse = (
        capo_glue.types.update_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_job_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_job(
    ...
    input_: capo_glue.types.update_job_request.UpdateJobRequest,
) -> tuple[capo_glue.types.update_job_response.UpdateJobResponse, zapros.Response]:
