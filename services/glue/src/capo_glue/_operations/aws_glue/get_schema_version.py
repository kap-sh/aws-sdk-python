"""Generated from Smithy shape ``com.amazonaws.glue#GetSchemaVersion``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_schema_version_response.GetSchemaVersionResponse = (
        capo_glue.types.get_schema_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetSchemaVersion"
    body: bytes | None = json.dumps(
        capo_glue.types.get_schema_version_input.serialize_aws_json_1_1(input_)
    ).encode()
