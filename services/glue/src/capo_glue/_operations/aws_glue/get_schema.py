...
def handle_response(
    ...
    out: capo_glue.types.get_schema_response.GetSchemaResponse = (
        capo_glue.types.get_schema_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_schema_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_schema(
    options: OperationOptions, input_: capo_glue.types.get_schema_input.GetSchemaInput
) -> tuple[capo_glue.types.get_schema_response.GetSchemaResponse, zapros.Response]:
