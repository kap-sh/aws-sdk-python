"""Generated from Smithy shape ``com.amazonaws.glue#UpdateCsvClassifierRequest``."""
...
class UpdateCsvClassifierRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateCsvClassifierRequest) -> dict:
    out: dict = {}
    out["Name"] = value["name"]
