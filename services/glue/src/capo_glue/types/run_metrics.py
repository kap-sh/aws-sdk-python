...
class RunMetrics(TypedDict, closed=True):
    ...
    number_of_dpus: NotRequired["capo_glue.types.message_string.MessageString"]
    """<p>The number of DPUs consumed by the job, rounded up to the nearest whole number.</p>"""
    job_duration_in_hour: NotRequired["capo_glue.types.message_string.MessageString"]
