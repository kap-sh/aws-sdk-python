...
class TableOptimizerConfiguration(TypedDict, closed=True):
    role_arn: NotRequired["capo_glue.types.arn_string.ArnString"]
    ...
    enabled: NotRequired["capo_glue.types.nullable_boolean.NullableBoolean"]
    """<p>Whether table optimization is enabled.</p>"""
    vpc_configuration: NotRequired[
        "capo_glue.types.table_optimizer_vpc_configuration.TableOptimizerVpcConfiguration"
    ]
    ...
    compaction_configuration: NotRequired[
        "capo_glue.types.compaction_configuration.CompactionConfiguration"
    ]
    ...
    retention_configuration: NotRequired[
        "capo_glue.types.retention_configuration.RetentionConfiguration"
    ]
    """<p>The configuration for a snapshot retention optimizer.</p>"""
    orphan_file_deletion_configuration: NotRequired[
        "capo_glue.types.orphan_file_deletion_configuration.OrphanFileDeletionConfiguration"
    ]
...
def serialize_aws_json_1_1(value: TableOptimizerConfiguration) -> dict:
    ...
    if "vpc_configuration" in value:
        ...
        out["vpcConfiguration"] = (
            capo_glue.types.table_optimizer_vpc_configuration.serialize_aws_json_1_1(
    ...
    if "compaction_configuration" in value:
        ...
        out["compactionConfiguration"] = (
            capo_glue.types.compaction_configuration.serialize_aws_json_1_1(
    ...
    if "retention_configuration" in value:
        ...
        out["retentionConfiguration"] = (
            capo_glue.types.retention_configuration.serialize_aws_json_1_1(
    ...
    if "orphan_file_deletion_configuration" in value:
        ...
        out["orphanFileDeletionConfiguration"] = (
            capo_glue.types.orphan_file_deletion_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TableOptimizerConfiguration:
    ...
    if "vpcConfiguration" in data:
        ...
        out["vpc_configuration"] = (
            capo_glue.types.table_optimizer_vpc_configuration.deserialize_aws_json_1_1(
    ...
    if "compactionConfiguration" in data:
        ...
        out["compaction_configuration"] = (
            capo_glue.types.compaction_configuration.deserialize_aws_json_1_1(
    ...
    if "retentionConfiguration" in data:
        ...
        out["retention_configuration"] = (
            capo_glue.types.retention_configuration.deserialize_aws_json_1_1(
    ...
    if "orphanFileDeletionConfiguration" in data:
        ...
        out["orphan_file_deletion_configuration"] = (
            capo_glue.types.orphan_file_deletion_configuration.deserialize_aws_json_1_1(
