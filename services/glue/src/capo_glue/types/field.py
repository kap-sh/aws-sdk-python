...
if TYPE_CHECKING:
    ...
    import capo_glue.types.field_description
    import capo_glue.types.field_filter_operators_list
    import capo_glue.types.field_label
    import capo_glue.types.list_of_string


class Field(TypedDict, closed=True):
    field_name: NotRequired["capo_glue.types.entity_field_name.EntityFieldName"]
    """<p>A unique identifier for the field.</p>"""
    label: NotRequired["capo_glue.types.field_label.FieldLabel"]
    """<p>A readable label used for the field.</p>"""
    description: NotRequired["capo_glue.types.field_description.FieldDescription"]
    """<p>A description of the field.</p>"""
    field_type: NotRequired["capo_glue.types.field_data_type.FieldDataType"]
    """<p>The type of data in the field.</p>"""
    is_primary_key: NotRequired["capo_glue.types.bool.Bool"]
...
def serialize_aws_json_1_1(value: Field) -> dict:
    ...
    if "field_type" in value:
        ...
        out["FieldType"] = capo_glue.types.field_data_type.serialize_aws_json_1_1(
            value["field_type"]
        )
    ...
    if "supported_values" in value:
        ...
        out["SupportedValues"] = capo_glue.types.list_of_string.serialize_aws_json_1_1(
    ...
    if "supported_filter_operators" in value:
        ...
        out["SupportedFilterOperators"] = (
            capo_glue.types.field_filter_operators_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Field:
    ...
    if "SupportedFilterOperators" in data:
        ...
        out["supported_filter_operators"] = (
            capo_glue.types.field_filter_operators_list.deserialize_aws_json_1_1(
