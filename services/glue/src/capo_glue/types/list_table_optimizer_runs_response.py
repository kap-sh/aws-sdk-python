...
if TYPE_CHECKING:
    ...
    import capo_glue.types.table_optimizer_runs


class ListTableOptimizerRunsResponse(TypedDict, closed=True):
    ...
    table_optimizer_runs: NotRequired[
        "capo_glue.types.table_optimizer_runs.TableOptimizerRuns"
    ]
...
def serialize_aws_json_1_1(value: ListTableOptimizerRunsResponse) -> dict:
    ...
    if "table_optimizer_runs" in value:
        ...
        out["TableOptimizerRuns"] = (
            capo_glue.types.table_optimizer_runs.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListTableOptimizerRunsResponse:
    ...
    if "TableOptimizerRuns" in data:
        ...
        out["table_optimizer_runs"] = (
            capo_glue.types.table_optimizer_runs.deserialize_aws_json_1_1(
