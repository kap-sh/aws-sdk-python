...
if TYPE_CHECKING:
    import capo_glue.types.fields_list
    import capo_glue.types.next_token


class DescribeEntityResponse(TypedDict, closed=True):
    fields: NotRequired["capo_glue.types.fields_list.FieldsList"]
...
def serialize_aws_json_1_1(value: DescribeEntityResponse) -> dict:
    ...
    if "fields" in value:
        ...
        out["Fields"] = capo_glue.types.fields_list.serialize_aws_json_1_1(
            value["fields"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeEntityResponse:
    ...
    if "Fields" in data:
        ...
        out["fields"] = capo_glue.types.fields_list.deserialize_aws_json_1_1(
            data["Fields"]
        )
