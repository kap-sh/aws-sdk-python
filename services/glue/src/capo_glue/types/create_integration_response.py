"""Generated from Smithy shape ``com.amazonaws.glue#CreateIntegrationResponse``."""
...
class CreateIntegrationResponse(TypedDict, closed=True):
    ...
    """<p>The status of the integration being created.</p> <p>The possible statuses are:</p> <ul> <li> <p>CREATING: The integration is being created.</p> </li> <li> <p>ACTIVE: The integration creation succeeds.</p> </li> <li> <p>MODIFYING: The integration is being modified.</p> </li> <li> <p>FAILED: The integration creation fails. </p> </li> <li> <p>DELETING: The integration is deleted.</p> </li> <li> <p>SYNCING: The integration is synchronizing.</p> </li> <li> <p>NEEDS_ATTENTION: The integration needs attention, such as synchronization.</p> </li> </ul>"""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateIntegrationResponse) -> dict:
    out: dict = {}
