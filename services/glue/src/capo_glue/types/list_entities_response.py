...
if TYPE_CHECKING:
    import capo_glue.types.entity_list
    import capo_glue.types.next_token


class ListEntitiesResponse(TypedDict, closed=True):
    entities: NotRequired["capo_glue.types.entity_list.EntityList"]
...
def serialize_aws_json_1_1(value: ListEntitiesResponse) -> dict:
    ...
    if "entities" in value:
        ...
        out["Entities"] = capo_glue.types.entity_list.serialize_aws_json_1_1(
            value["entities"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListEntitiesResponse:
    ...
    if "Entities" in data:
        ...
        out["entities"] = capo_glue.types.entity_list.deserialize_aws_json_1_1(
            data["Entities"]
        )
