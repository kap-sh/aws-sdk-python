...
if TYPE_CHECKING:
    ...
    import capo_glue.types.json_value
    import capo_glue.types.run_id


class JobBookmarkEntry(TypedDict, closed=True):
    job_name: NotRequired["capo_glue.types.job_name.JobName"]
    """<p>The name of the job in question.</p>"""
    version: "capo_glue.types.integer_value.IntegerValue"
    """<p>The version of the job.</p>"""
    run: "capo_glue.types.integer_value.IntegerValue"
    """<p>The run ID number.</p>"""
    attempt: "capo_glue.types.integer_value.IntegerValue"
    """<p>The attempt ID number.</p>"""
    previous_run_id: NotRequired["capo_glue.types.run_id.RunId"]
    """<p>The unique run identifier associated with the previous job run.</p>"""
    run_id: NotRequired["capo_glue.types.run_id.RunId"]
    """<p>The run ID number.</p>"""
    job_bookmark: NotRequired["capo_glue.types.json_value.JsonValue"]
