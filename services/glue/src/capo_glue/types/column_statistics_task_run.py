...
if TYPE_CHECKING:
    import capo_glue.types.account_id
    ...
    import capo_glue.types.positive_integer
...
class ColumnStatisticsTaskRun(TypedDict, closed=True):
    customer_id: NotRequired["capo_glue.types.account_id.AccountId"]
    ...
    number_of_workers: "capo_glue.types.positive_integer.PositiveInteger"
    """<p>The number of workers used to generate column statistics. The job is preconfigured to autoscale up to 25 instances.</p>"""
    worker_type: NotRequired["capo_glue.types.name_string.NameString"]
    """<p>The type of workers being used for generating stats. The default is <code>g.1x</code>.</p>"""
    computation_type: NotRequired["capo_glue.types.computation_type.ComputationType"]
    """<p>The type of column statistics computation.</p>"""
    status: NotRequired["capo_glue.types.column_statistics_state.ColumnStatisticsState"]
    ...
    end_time: NotRequired["capo_glue.types.timestamp.Timestamp"]
    """<p>The end time of the task.</p>"""
    error_message: NotRequired["capo_glue.types.description_string.DescriptionString"]
    """<p>The error message for the job.</p>"""
    dpu_seconds: "capo_glue.types.non_negative_double.NonNegativeDouble"
...
def serialize_aws_json_1_1(value: ColumnStatisticsTaskRun) -> dict:
    ...
    if "computation_type" in value:
        ...
        out["ComputationType"] = (
            capo_glue.types.computation_type.serialize_aws_json_1_1(
    ...
    if "status" in value:
        ...
        out["Status"] = capo_glue.types.column_statistics_state.serialize_aws_json_1_1(
            value["status"]
        )
    ...
    if "end_time" in value:
        ...
        out["EndTime"] = capo_glue.types.timestamp.serialize_aws_json_1_1(
            value["end_time"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ColumnStatisticsTaskRun:
    ...
    if "ComputationType" in data:
        ...
        out["computation_type"] = (
            capo_glue.types.computation_type.deserialize_aws_json_1_1(
    ...
    if "Status" in data:
        ...
        out["status"] = (
            capo_glue.types.column_statistics_state.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
