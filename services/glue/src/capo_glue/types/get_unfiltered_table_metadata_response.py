...
class GetUnfilteredTableMetadataResponse(TypedDict, closed=True):
    ...
    cell_filters: NotRequired[
        "capo_glue.types.column_row_filter_list.ColumnRowFilterList"
    ]
    """<p>A list of column row filters.</p>"""
    query_authorization_id: NotRequired["capo_glue.types.hash_string.HashString"]
    """<p>A cryptographically generated query identifier generated by Glue or Lake Formation.</p>"""
    is_multi_dialect_view: "capo_glue.types.boolean.Boolean"
    ...
    is_materialized_view: "capo_glue.types.boolean.Boolean"
    """<p>Indicates if a table is a materialized view.</p>"""
    resource_arn: NotRequired["capo_glue.types.arn_string.ArnString"]
    """<p>The resource ARN of the parent resource extracted from the request.</p>"""
    is_protected: "capo_glue.types.boolean.Boolean"
    ...
    row_filter: NotRequired["capo_glue.types.predicate_string.PredicateString"]
...
def serialize_aws_json_1_1(value: GetUnfilteredTableMetadataResponse) -> dict:
    ...
    if "cell_filters" in value:
        ...
        out["CellFilters"] = (
            capo_glue.types.column_row_filter_list.serialize_aws_json_1_1(
                value["cell_filters"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetUnfilteredTableMetadataResponse:
    ...
    if "CellFilters" in data:
        ...
        out["cell_filters"] = (
            capo_glue.types.column_row_filter_list.deserialize_aws_json_1_1(
                data["CellFilters"]
            )
        )
