...
class CatalogImportStatus(TypedDict, closed=True):
    import_completed: "capo_glue.types.boolean.Boolean"
    """<p> <code>True</code> if the migration has completed, or <code>False</code> otherwise.</p>"""
    import_time: NotRequired["capo_glue.types.timestamp.Timestamp"]
    """<p>The time that the migration was started.</p>"""
    imported_by: NotRequired["capo_glue.types.name_string.NameString"]
...
def serialize_aws_json_1_1(value: CatalogImportStatus) -> dict:
    ...
    if "import_time" in value:
        ...
        out["ImportTime"] = capo_glue.types.timestamp.serialize_aws_json_1_1(
            value["import_time"]
        )
