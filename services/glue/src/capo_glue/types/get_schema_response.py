...
if TYPE_CHECKING:
    ...
    import capo_glue.types.schema_checkpoint_number
...
class GetSchemaResponse(TypedDict, closed=True):
    ...
    schema_checkpoint: NotRequired[
        "capo_glue.types.schema_checkpoint_number.SchemaCheckpointNumber"
    ]
    ...
    schema_status: NotRequired["capo_glue.types.schema_status.SchemaStatus"]
...
def serialize_aws_json_1_1(value: GetSchemaResponse) -> dict:
    ...
    if "schema_status" in value:
        ...
        out["SchemaStatus"] = capo_glue.types.schema_status.serialize_aws_json_1_1(
            value["schema_status"]
        )
