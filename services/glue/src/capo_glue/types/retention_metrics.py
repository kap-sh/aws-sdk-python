...
class RetentionMetrics(TypedDict, closed=True):
    iceberg_metrics: NotRequired[
        "capo_glue.types.iceberg_retention_metrics.IcebergRetentionMetrics"
    ]
...
def serialize_aws_json_1_1(value: RetentionMetrics) -> dict:
    ...
    if "iceberg_metrics" in value:
        ...
        out["IcebergMetrics"] = (
            capo_glue.types.iceberg_retention_metrics.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RetentionMetrics:
    ...
    if "IcebergMetrics" in data:
        ...
        out["iceberg_metrics"] = (
            capo_glue.types.iceberg_retention_metrics.deserialize_aws_json_1_1(
                data["IcebergMetrics"]
            )
        )
    return out
