...
class CrawlerTargets(TypedDict, closed=True):
    s3_targets: NotRequired["capo_glue.types.s3_target_list.S3TargetList"]
    """<p>Specifies Amazon Simple Storage Service (Amazon S3) targets.</p>"""
    jdbc_targets: NotRequired["capo_glue.types.jdbc_target_list.JdbcTargetList"]
    """<p>Specifies JDBC targets.</p>"""
    mongo_db_targets: NotRequired[
        "capo_glue.types.mongo_db_target_list.MongoDBTargetList"
    ]
    """<p>Specifies Amazon DocumentDB or MongoDB targets.</p>"""
    dynamo_db_targets: NotRequired[
        "capo_glue.types.dynamo_db_target_list.DynamoDBTargetList"
    ]
    """<p>Specifies Amazon DynamoDB targets.</p>"""
    catalog_targets: NotRequired[
        "capo_glue.types.catalog_target_list.CatalogTargetList"
    ]
    """<p>Specifies Glue Data Catalog targets.</p>"""
    delta_targets: NotRequired["capo_glue.types.delta_target_list.DeltaTargetList"]
    """<p>Specifies Delta data store targets.</p>"""
    iceberg_targets: NotRequired[
        "capo_glue.types.iceberg_target_list.IcebergTargetList"
    ]
    """<p>Specifies Apache Iceberg data store targets.</p>"""
    hudi_targets: NotRequired["capo_glue.types.hudi_target_list.HudiTargetList"]
...
def serialize_aws_json_1_1(value: CrawlerTargets) -> dict:
    ...
    if "s3_targets" in value:
        ...
        out["S3Targets"] = capo_glue.types.s3_target_list.serialize_aws_json_1_1(
            value["s3_targets"]
        )
    if "jdbc_targets" in value:
        import capo_glue.types.jdbc_target_list

        out["JdbcTargets"] = capo_glue.types.jdbc_target_list.serialize_aws_json_1_1(
            value["jdbc_targets"]
        )
    if "mongo_db_targets" in value:
        ...
        out["MongoDBTargets"] = (
            capo_glue.types.mongo_db_target_list.serialize_aws_json_1_1(
    ...
    if "dynamo_db_targets" in value:
        ...
        out["DynamoDBTargets"] = (
            capo_glue.types.dynamo_db_target_list.serialize_aws_json_1_1(
    ...
    if "catalog_targets" in value:
        ...
        out["CatalogTargets"] = (
            capo_glue.types.catalog_target_list.serialize_aws_json_1_1(
    ...
    if "delta_targets" in value:
        ...
        out["DeltaTargets"] = capo_glue.types.delta_target_list.serialize_aws_json_1_1(
            value["delta_targets"]
        )
    if "iceberg_targets" in value:
        ...
        out["IcebergTargets"] = (
            capo_glue.types.iceberg_target_list.serialize_aws_json_1_1(
    ...
    if "hudi_targets" in value:
        ...
        out["HudiTargets"] = capo_glue.types.hudi_target_list.serialize_aws_json_1_1(
            value["hudi_targets"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CrawlerTargets:
    ...
    if "MongoDBTargets" in data:
        ...
        out["mongo_db_targets"] = (
            capo_glue.types.mongo_db_target_list.deserialize_aws_json_1_1(
                data["MongoDBTargets"]
            )
        )
    if "DynamoDBTargets" in data:
        ...
        out["dynamo_db_targets"] = (
            capo_glue.types.dynamo_db_target_list.deserialize_aws_json_1_1(
    ...
    if "CatalogTargets" in data:
        ...
        out["catalog_targets"] = (
            capo_glue.types.catalog_target_list.deserialize_aws_json_1_1(
                data["CatalogTargets"]
            )
        )
    if "DeltaTargets" in data:
        ...
        out["delta_targets"] = (
            capo_glue.types.delta_target_list.deserialize_aws_json_1_1(
                data["DeltaTargets"]
            )
        )
    if "IcebergTargets" in data:
        ...
        out["iceberg_targets"] = (
            capo_glue.types.iceberg_target_list.deserialize_aws_json_1_1(
                data["IcebergTargets"]
            )
        )
