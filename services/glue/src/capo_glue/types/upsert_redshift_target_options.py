...
class UpsertRedshiftTargetOptions(TypedDict, closed=True):
    ...
    upsert_keys: NotRequired[
        "capo_glue.types.enclosed_in_string_properties_min_one.EnclosedInStringPropertiesMinOne"
    ]
...
def serialize_aws_json_1_1(value: UpsertRedshiftTargetOptions) -> dict:
    ...
    if "upsert_keys" in value:
        ...
        out["UpsertKeys"] = (
            capo_glue.types.enclosed_in_string_properties_min_one.serialize_aws_json_1_1(
                value["upsert_keys"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UpsertRedshiftTargetOptions:
    ...
    if "UpsertKeys" in data:
        ...
        out["upsert_keys"] = (
            capo_glue.types.enclosed_in_string_properties_min_one.deserialize_aws_json_1_1(
                data["UpsertKeys"]
            )
        )
    return out
