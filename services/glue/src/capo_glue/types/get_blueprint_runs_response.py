...
if TYPE_CHECKING:
    import capo_glue.types.blueprint_runs
    import capo_glue.types.generic_string


class GetBlueprintRunsResponse(TypedDict, closed=True):
    blueprint_runs: NotRequired["capo_glue.types.blueprint_runs.BlueprintRuns"]
...
def serialize_aws_json_1_1(value: GetBlueprintRunsResponse) -> dict:
    ...
    if "blueprint_runs" in value:
        ...
        out["BlueprintRuns"] = capo_glue.types.blueprint_runs.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetBlueprintRunsResponse:
    ...
    if "BlueprintRuns" in data:
        ...
        out["blueprint_runs"] = capo_glue.types.blueprint_runs.deserialize_aws_json_1_1(
            data["BlueprintRuns"]
        )
