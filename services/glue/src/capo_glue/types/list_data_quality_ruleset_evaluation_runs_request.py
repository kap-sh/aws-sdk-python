...
class ListDataQualityRulesetEvaluationRunsRequest(TypedDict, closed=True):
    filter: NotRequired[
...
def serialize_aws_json_1_1(value: ListDataQualityRulesetEvaluationRunsRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["Filter"] = (
            capo_glue.types.data_quality_ruleset_evaluation_run_filter.serialize_aws_json_1_1(
                value["filter"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListDataQualityRulesetEvaluationRunsRequest:
    ...
    if "Filter" in data:
        ...
        out["filter"] = (
            capo_glue.types.data_quality_ruleset_evaluation_run_filter.deserialize_aws_json_1_1(
                data["Filter"]
            )
        )
