...
class OffsetConfiguration(TypedDict, closed=True):
    offset_parameter: "capo_glue.types.extracted_parameter.ExtractedParameter"
    """<p>The parameter name used to specify the starting position or offset for retrieving results.</p>"""
    limit_parameter: "capo_glue.types.extracted_parameter.ExtractedParameter"
...
def serialize_aws_json_1_1(value: OffsetConfiguration) -> dict:
    ...
    out["OffsetParameter"] = capo_glue.types.extracted_parameter.serialize_aws_json_1_1(
        value["offset_parameter"]
    )
    import capo_glue.types.extracted_parameter

    out["LimitParameter"] = capo_glue.types.extracted_parameter.serialize_aws_json_1_1(
