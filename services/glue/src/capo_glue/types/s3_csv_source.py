...
def serialize_aws_json_1_1(value: S3CsvSource) -> dict:
    ...
    out["Separator"] = capo_glue.types.separator.serialize_aws_json_1_1(
        value["separator"]
    )
    if "escaper" in value:
    ...
    out["QuoteChar"] = capo_glue.types.quote_char.serialize_aws_json_1_1(
        value["quote_char"]
    )
