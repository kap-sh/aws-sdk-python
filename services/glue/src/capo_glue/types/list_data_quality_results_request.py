...
def serialize_aws_json_1_1(value: ListDataQualityResultsRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["Filter"] = (
            capo_glue.types.data_quality_result_filter_criteria.serialize_aws_json_1_1(
                value["filter"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListDataQualityResultsRequest:
    ...
    if "Filter" in data:
        ...
        out["filter"] = (
            capo_glue.types.data_quality_result_filter_criteria.deserialize_aws_json_1_1(
                data["Filter"]
            )
        )
