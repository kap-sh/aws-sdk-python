...
class OrphanFileDeletionMetrics(TypedDict, closed=True):
    iceberg_metrics: NotRequired[
        "capo_glue.types.iceberg_orphan_file_deletion_metrics.IcebergOrphanFileDeletionMetrics"
    ]
...
def serialize_aws_json_1_1(value: OrphanFileDeletionMetrics) -> dict:
    ...
    if "iceberg_metrics" in value:
        ...
        out["IcebergMetrics"] = (
            capo_glue.types.iceberg_orphan_file_deletion_metrics.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OrphanFileDeletionMetrics:
    ...
    if "IcebergMetrics" in data:
        ...
        out["iceberg_metrics"] = (
            capo_glue.types.iceberg_orphan_file_deletion_metrics.deserialize_aws_json_1_1(
                data["IcebergMetrics"]
            )
        )
    return out
