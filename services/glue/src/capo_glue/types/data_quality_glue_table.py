...
if TYPE_CHECKING:
    ...
    import capo_glue.types.pre_processing_query_string


class DataQualityGlueTable(TypedDict, closed=True):
    ...
    pre_processing_query: NotRequired[
        "capo_glue.types.pre_processing_query_string.PreProcessingQueryString"
    ]
