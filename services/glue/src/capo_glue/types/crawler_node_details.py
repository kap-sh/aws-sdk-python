...
if TYPE_CHECKING:
    import capo_glue.types.crawl_list


class CrawlerNodeDetails(TypedDict, closed=True):
    crawls: NotRequired["capo_glue.types.crawl_list.CrawlList"]
...
def serialize_aws_json_1_1(value: CrawlerNodeDetails) -> dict:
    ...
    if "crawls" in value:
        ...
        out["Crawls"] = capo_glue.types.crawl_list.serialize_aws_json_1_1(
            value["crawls"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CrawlerNodeDetails:
    ...
    if "Crawls" in data:
        ...
        out["crawls"] = capo_glue.types.crawl_list.deserialize_aws_json_1_1(
            data["Crawls"]
        )
    return out
