"""Generated from Smithy shape ``com.amazonaws.glue#ListDataQualityStatisticsRequest``."""
...
class ListDataQualityStatisticsRequest(TypedDict, closed=True):
    ...
    """<p>The Profile ID.</p>"""
    timestamp_filter: NotRequired["capo_glue.types.timestamp_filter.TimestampFilter"]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListDataQualityStatisticsRequest) -> dict:
    out: dict = {}
    ...
    if "timestamp_filter" in value:
        ...
        out["TimestampFilter"] = (
            capo_glue.types.timestamp_filter.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListDataQualityStatisticsRequest:
    ...
    if "TimestampFilter" in data:
        ...
        out["timestamp_filter"] = (
            capo_glue.types.timestamp_filter.deserialize_aws_json_1_1(
