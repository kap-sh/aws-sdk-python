...
class MetricBasedObservation(TypedDict, closed=True):
    metric_name: NotRequired["capo_glue.types.name_string.NameString"]
    ...
    metric_values: NotRequired[
        "capo_glue.types.data_quality_metric_values.DataQualityMetricValues"
    ]
    """<p>An object of type <code>DataQualityMetricValues</code> representing the analysis of the data quality metric value.</p>"""
    new_rules: NotRequired["capo_glue.types.new_rules.NewRules"]
...
def serialize_aws_json_1_1(value: MetricBasedObservation) -> dict:
    ...
    if "metric_values" in value:
        ...
        out["MetricValues"] = (
            capo_glue.types.data_quality_metric_values.serialize_aws_json_1_1(
                value["metric_values"]
            )
        )
    if "new_rules" in value:
        ...
        out["NewRules"] = capo_glue.types.new_rules.serialize_aws_json_1_1(
            value["new_rules"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> MetricBasedObservation:
    ...
    if "MetricValues" in data:
        ...
        out["metric_values"] = (
            capo_glue.types.data_quality_metric_values.deserialize_aws_json_1_1(
                data["MetricValues"]
            )
        )
    if "NewRules" in data:
