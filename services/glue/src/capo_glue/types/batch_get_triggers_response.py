...
if TYPE_CHECKING:
    import capo_glue.types.trigger_list
    import capo_glue.types.trigger_name_list


class BatchGetTriggersResponse(TypedDict, closed=True):
    triggers: NotRequired["capo_glue.types.trigger_list.TriggerList"]
    """<p>A list of trigger definitions.</p>"""
    triggers_not_found: NotRequired["capo_glue.types.trigger_name_list.TriggerNameList"]
...
def serialize_aws_json_1_1(value: BatchGetTriggersResponse) -> dict:
    ...
    if "triggers" in value:
        ...
        out["Triggers"] = capo_glue.types.trigger_list.serialize_aws_json_1_1(
            value["triggers"]
        )
    if "triggers_not_found" in value:
        ...
        out["TriggersNotFound"] = (
            capo_glue.types.trigger_name_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BatchGetTriggersResponse:
    ...
    if "Triggers" in data:
        ...
        out["triggers"] = capo_glue.types.trigger_list.deserialize_aws_json_1_1(
            data["Triggers"]
        )
    if "TriggersNotFound" in data:
        ...
        out["triggers_not_found"] = (
            capo_glue.types.trigger_name_list.deserialize_aws_json_1_1(
