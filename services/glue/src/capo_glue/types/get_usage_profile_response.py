"""Generated from Smithy shape ``com.amazonaws.glue#GetUsageProfileResponse``."""
...
class GetUsageProfileResponse(TypedDict, closed=True):
    ...
    configuration: NotRequired[
        "capo_glue.types.profile_configuration.ProfileConfiguration"
    ]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetUsageProfileResponse) -> dict:
    out: dict = {}
    if "name" in value:
        out["Name"] = value["name"]
    ...
    if "configuration" in value:
        ...
        out["Configuration"] = (
            capo_glue.types.profile_configuration.serialize_aws_json_1_1(
                value["configuration"]
            )
        )
