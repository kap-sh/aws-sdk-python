"""Generated from Smithy shape ``com.amazonaws.glue#PostgreSQLCatalogSource``."""
...
class PostgreSQLCatalogSource(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: PostgreSQLCatalogSource) -> dict:
    out: dict = {}
    out["Name"] = value["name"]
