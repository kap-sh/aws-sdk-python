"""Generated from Smithy shape ``com.amazonaws.glue#GluePolicy``."""
...
class GluePolicy(TypedDict, closed=True):
    policy_in_json: NotRequired["capo_glue.types.policy_json_string.PolicyJsonString"]
    """<p>Contains the requested policy document, in JSON format.</p>"""
    policy_hash: NotRequired["capo_glue.types.hash_string.HashString"]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GluePolicy) -> dict:
    out: dict = {}
