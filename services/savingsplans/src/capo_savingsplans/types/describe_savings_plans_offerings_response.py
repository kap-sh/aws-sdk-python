...
class DescribeSavingsPlansOfferingsResponse(TypedDict, closed=True):
    search_results: NotRequired[
        "capo_savingsplans.types.savings_plan_offerings_list.SavingsPlanOfferingsList"
    ]
...
def serialize_json(value: DescribeSavingsPlansOfferingsResponse) -> dict:
    ...
    if "search_results" in value:
        ...
        out["searchResults"] = (
            capo_savingsplans.types.savings_plan_offerings_list.serialize_json(
...
def deserialize_json(data: dict) -> DescribeSavingsPlansOfferingsResponse:
    ...
    if "searchResults" in data:
        ...
        out["search_results"] = (
            capo_savingsplans.types.savings_plan_offerings_list.deserialize_json(
                data["searchResults"]
            )
        )
