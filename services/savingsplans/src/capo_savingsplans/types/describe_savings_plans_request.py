...
def serialize_json(value: DescribeSavingsPlansRequest) -> dict:
    ...
    if "savings_plan_arns" in value:
        ...
        out["savingsPlanArns"] = (
            capo_savingsplans.types.savings_plan_arn_list.serialize_json(
    ...
    if "savings_plan_ids" in value:
        ...
        out["savingsPlanIds"] = (
            capo_savingsplans.types.savings_plan_id_list.serialize_json(
    ...
    if "states" in value:
        ...
        out["states"] = capo_savingsplans.types.savings_plan_state_list.serialize_json(
            value["states"]
        )
    if "filters" in value:
        import capo_savingsplans.types.savings_plan_filter_list
        ...
        out["filters"] = (
            capo_savingsplans.types.savings_plan_filter_list.serialize_json(
                value["filters"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> DescribeSavingsPlansRequest:
    ...
    if "savingsPlanArns" in data:
        ...
        out["savings_plan_arns"] = (
            capo_savingsplans.types.savings_plan_arn_list.deserialize_json(
    ...
    if "savingsPlanIds" in data:
        ...
        out["savings_plan_ids"] = (
            capo_savingsplans.types.savings_plan_id_list.deserialize_json(
                data["savingsPlanIds"]
            )
        )
    ...
    if "states" in data:
        ...
        out["states"] = (
            capo_savingsplans.types.savings_plan_state_list.deserialize_json(
                data["states"]
            )
        )
    if "filters" in data:
        ...
        out["filters"] = (
            capo_savingsplans.types.savings_plan_filter_list.deserialize_json(
                data["filters"]
            )
        )
    return out
