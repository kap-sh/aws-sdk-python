...
class savingsplansError(Exception):
    """Base class for all savingsplans service errors."""


class ServiceError(savingsplansError):
...
class SerializationError(savingsplansError):
    """Raised when a value cannot be serialized."""


class DeserializationError(savingsplansError):
...
class WaiterFailedError(savingsplansError):
...
class WaiterTimeoutError(savingsplansError):
