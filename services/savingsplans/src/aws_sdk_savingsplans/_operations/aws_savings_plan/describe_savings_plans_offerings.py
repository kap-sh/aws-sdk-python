...
def handle_response(
    ...
    out: aws_sdk_savingsplans.types.describe_savings_plans_offerings_response.DescribeSavingsPlansOfferingsResponse = aws_sdk_savingsplans.types.describe_savings_plans_offerings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_savingsplans.types.describe_savings_plans_offerings_request.DescribeSavingsPlansOfferingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_savingsplans.types.describe_savings_plans_offerings_request.serialize_json(
            input_
        )
    ).encode()
