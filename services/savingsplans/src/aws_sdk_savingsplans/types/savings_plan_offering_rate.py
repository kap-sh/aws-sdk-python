...
if TYPE_CHECKING:
    import aws_sdk_savingsplans.types.parent_savings_plan_offering
    import aws_sdk_savingsplans.types.savings_plan_offering_rate_property_list
    import aws_sdk_savingsplans.types.savings_plan_product_type
    import aws_sdk_savingsplans.types.savings_plan_rate_operation
    import aws_sdk_savingsplans.types.savings_plan_rate_price_per_unit
    import aws_sdk_savingsplans.types.savings_plan_rate_service_code
    import aws_sdk_savingsplans.types.savings_plan_rate_unit
    import aws_sdk_savingsplans.types.savings_plan_rate_usage_type


class SavingsPlanOfferingRate(TypedDict):
    savings_plan_offering: NotRequired[
        "aws_sdk_savingsplans.types.parent_savings_plan_offering.ParentSavingsPlanOffering"
    ]
    """<p>The Savings Plan offering.</p>"""
    rate: NotRequired[
        "aws_sdk_savingsplans.types.savings_plan_rate_price_per_unit.SavingsPlanRatePricePerUnit"
    ]
    """<p>The Savings Plan rate.</p>"""
    unit: NotRequired[
        "aws_sdk_savingsplans.types.savings_plan_rate_unit.SavingsPlanRateUnit"
    ]
    """<p>The unit.</p>"""
    ...
    operation: NotRequired[
        "aws_sdk_savingsplans.types.savings_plan_rate_operation.SavingsPlanRateOperation"
    ]
    """<p>The specific Amazon Web Services operation for the line item in the billing report.</p>"""
    properties: NotRequired[
        "aws_sdk_savingsplans.types.savings_plan_offering_rate_property_list.SavingsPlanOfferingRatePropertyList"
    ]
    """<p>The properties.</p>"""
...
def serialize_json(value: SavingsPlanOfferingRate) -> dict:
    ...
    if "savings_plan_offering" in value:
        ...
        out["savingsPlanOffering"] = (
            aws_sdk_savingsplans.types.parent_savings_plan_offering.serialize_json(
    ...
    if "unit" in value:
        ...
        out["unit"] = aws_sdk_savingsplans.types.savings_plan_rate_unit.serialize_json(
            value["unit"]
        )
    ...
    if "properties" in value:
        ...
        out["properties"] = (
            aws_sdk_savingsplans.types.savings_plan_offering_rate_property_list.serialize_json(
                value["properties"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> SavingsPlanOfferingRate:
    ...
    if "savingsPlanOffering" in data:
        ...
        out["savings_plan_offering"] = (
            aws_sdk_savingsplans.types.parent_savings_plan_offering.deserialize_json(
    ...
    if "unit" in data:
        ...
        out["unit"] = (
            aws_sdk_savingsplans.types.savings_plan_rate_unit.deserialize_json(
                data["unit"]
            )
        )
    ...
    if "properties" in data:
        ...
        out["properties"] = (
            aws_sdk_savingsplans.types.savings_plan_offering_rate_property_list.deserialize_json(
                data["properties"]
            )
        )
    return out
