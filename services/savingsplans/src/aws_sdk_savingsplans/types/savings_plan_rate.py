...
if TYPE_CHECKING:
    ...
    import aws_sdk_savingsplans.types.savings_plan_rate_property_list
...
class SavingsPlanRate(TypedDict):
    ...
    properties: NotRequired[
        "aws_sdk_savingsplans.types.savings_plan_rate_property_list.SavingsPlanRatePropertyList"
    ]
    """<p>The properties.</p>"""
...
def serialize_json(value: SavingsPlanRate) -> dict:
    ...
    if "properties" in value:
        ...
        out["properties"] = (
            aws_sdk_savingsplans.types.savings_plan_rate_property_list.serialize_json(
                value["properties"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> SavingsPlanRate:
    ...
    if "properties" in data:
        ...
        out["properties"] = (
            aws_sdk_savingsplans.types.savings_plan_rate_property_list.deserialize_json(
                data["properties"]
            )
        )
    return out
