...
class DescribeSavingsPlanRatesRequest(TypedDict):
...
def serialize_json(value: DescribeSavingsPlanRatesRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            aws_sdk_savingsplans.types.savings_plan_rate_filter_list.serialize_json(
                value["filters"]
            )
        )
...
def deserialize_json(data: dict) -> DescribeSavingsPlanRatesRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            aws_sdk_savingsplans.types.savings_plan_rate_filter_list.deserialize_json(
                data["filters"]
            )
        )
