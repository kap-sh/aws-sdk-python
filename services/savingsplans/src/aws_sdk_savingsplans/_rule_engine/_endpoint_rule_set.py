                ...
                if p.Region is not None:
                    ...
                    if _locals["PartitionResult"] is not None:
                        if string_equals(
                            ...
                            return Endpoint(
                                url=interpolate(
                                    "https://savingsplans.global.api.aws", p, _locals
                                ),
                                properties={
                                    "authSchemes": [
                                        {
        ...
        if _locals["PartitionResult"] is not None:
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://savingsplans.amazonaws.com", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
                ...
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            return Endpoint(
                                url=interpolate(
                                    "https://savingsplans-fips.{Region}.{PartitionResult#dualStackDnsSuffix}",
                                    p,
                                    _locals,
                                ),
                                properties={},
            ...
            if p.UseFIPS is True:
                if (
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://savingsplans-fips.{Region}.{PartitionResult#dnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            return Endpoint(
                url=interpolate(
                    "https://savingsplans.{Region}.{PartitionResult#dnsSuffix}",
                    p,
                    _locals,
                ),
                properties={},
