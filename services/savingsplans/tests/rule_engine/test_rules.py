...
from capo_savingsplans._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_for_region_not_set_with_fips_disabled_an():
...
def test_commercial_region_with_custom_sdk_endpoi():
