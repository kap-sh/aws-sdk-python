...
def handle_response(
    ...
    out: aws_sdk_kafkaconnect.types.list_connector_operations_response.ListConnectorOperationsResponse = aws_sdk_kafkaconnect.types.list_connector_operations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafkaconnect.types.list_connector_operations_request.ListConnectorOperationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
