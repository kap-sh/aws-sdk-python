...
def handle_response(
    ...
    out: aws_sdk_kafkaconnect.types.list_custom_plugins_response.ListCustomPluginsResponse = aws_sdk_kafkaconnect.types.list_custom_plugins_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_kafkaconnect.types.list_custom_plugins_request.ListCustomPluginsRequest,
) -> zapros.Request:
    ...
    if "name_prefix" in input:
        params["namePrefix"] = str(input["name_prefix"])
