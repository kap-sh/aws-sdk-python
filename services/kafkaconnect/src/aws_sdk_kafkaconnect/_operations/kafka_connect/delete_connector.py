...
def handle_response(
    ...
    out: aws_sdk_kafkaconnect.types.delete_connector_response.DeleteConnectorResponse = aws_sdk_kafkaconnect.types.delete_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafkaconnect.types.delete_connector_request.DeleteConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
