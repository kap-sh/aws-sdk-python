...
def handle_response(
    ...
    out: aws_sdk_kafkaconnect.types.describe_connector_response.DescribeConnectorResponse = aws_sdk_kafkaconnect.types.describe_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafkaconnect.types.describe_connector_request.DescribeConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
