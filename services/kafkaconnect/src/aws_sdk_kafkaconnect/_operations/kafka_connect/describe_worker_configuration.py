...
def handle_response(
    ...
    out: aws_sdk_kafkaconnect.types.describe_worker_configuration_response.DescribeWorkerConfigurationResponse = aws_sdk_kafkaconnect.types.describe_worker_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafkaconnect.types.describe_worker_configuration_request.DescribeWorkerConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
