"""Generated from Smithy shape ``com.amazonaws.kafkaconnect#CreateCustomPlugin``."""
...
def handle_response(
    ...
    out: aws_sdk_kafkaconnect.types.create_custom_plugin_response.CreateCustomPluginResponse = aws_sdk_kafkaconnect.types.create_custom_plugin_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafkaconnect.types.create_custom_plugin_request.CreateCustomPluginRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafkaconnect.types.create_custom_plugin_request.serialize_json(input_)
    ).encode()
...
async def async_create_custom_plugin(
