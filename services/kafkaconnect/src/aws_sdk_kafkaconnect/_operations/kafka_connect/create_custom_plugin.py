...
def build_request(
    ...
    input: aws_sdk_kafkaconnect.types.create_custom_plugin_request.CreateCustomPluginRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafkaconnect.types.create_custom_plugin_request.serialize_json(input)
    ).encode()
