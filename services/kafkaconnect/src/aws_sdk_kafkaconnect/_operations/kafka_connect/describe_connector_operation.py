...
def handle_response(
    ...
    out: aws_sdk_kafkaconnect.types.describe_connector_operation_response.DescribeConnectorOperationResponse = aws_sdk_kafkaconnect.types.describe_connector_operation_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_kafkaconnect.types.describe_connector_operation_request.DescribeConnectorOperationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{connectorOperationArn}", quote(str(input["connector_operation_arn"]), safe="")
    )
    params: dict[str, str] = {}
