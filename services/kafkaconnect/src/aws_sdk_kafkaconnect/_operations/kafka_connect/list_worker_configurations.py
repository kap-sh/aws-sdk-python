...
def handle_response(
    ...
    out: aws_sdk_kafkaconnect.types.list_worker_configurations_response.ListWorkerConfigurationsResponse = aws_sdk_kafkaconnect.types.list_worker_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafkaconnect.types.list_worker_configurations_request.ListWorkerConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
