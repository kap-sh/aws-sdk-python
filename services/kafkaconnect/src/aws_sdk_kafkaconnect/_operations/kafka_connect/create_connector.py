...
def build_request(
    ...
    input: aws_sdk_kafkaconnect.types.create_connector_request.CreateConnectorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafkaconnect.types.create_connector_request.serialize_json(input)
    ).encode()
