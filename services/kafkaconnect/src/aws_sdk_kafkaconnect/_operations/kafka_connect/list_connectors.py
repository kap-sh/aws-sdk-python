...
def build_request(
    ...
    input: aws_sdk_kafkaconnect.types.list_connectors_request.ListConnectorsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "connector_name_prefix" in input:
        params["connectorNamePrefix"] = str(input["connector_name_prefix"])
