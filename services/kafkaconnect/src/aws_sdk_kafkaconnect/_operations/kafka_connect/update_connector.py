...
def handle_response(
    ...
    out: aws_sdk_kafkaconnect.types.update_connector_response.UpdateConnectorResponse = aws_sdk_kafkaconnect.types.update_connector_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_kafkaconnect.types.update_connector_request.UpdateConnectorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafkaconnect.types.update_connector_request.serialize_json(input)
    ).encode()
