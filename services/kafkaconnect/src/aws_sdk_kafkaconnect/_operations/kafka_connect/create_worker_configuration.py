...
import aws_sdk_kafkaconnect.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_kafkaconnect.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kafkaconnect.types.create_worker_configuration_response.CreateWorkerConfigurationResponse = aws_sdk_kafkaconnect.types.create_worker_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafkaconnect.types.create_worker_configuration_request.CreateWorkerConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafkaconnect.types.create_worker_configuration_request.serialize_json(
            input_
        )
    ).encode()
