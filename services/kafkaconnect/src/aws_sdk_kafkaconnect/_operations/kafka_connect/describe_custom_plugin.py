...
def handle_response(
    ...
    out: aws_sdk_kafkaconnect.types.describe_custom_plugin_response.DescribeCustomPluginResponse = aws_sdk_kafkaconnect.types.describe_custom_plugin_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafkaconnect.types.describe_custom_plugin_request.DescribeCustomPluginRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
