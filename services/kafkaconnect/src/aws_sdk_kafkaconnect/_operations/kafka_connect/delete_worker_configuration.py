"""Generated from Smithy shape ``com.amazonaws.kafkaconnect#DeleteWorkerConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_kafkaconnect.types.delete_worker_configuration_response.DeleteWorkerConfigurationResponse = aws_sdk_kafkaconnect.types.delete_worker_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafkaconnect.types.delete_worker_configuration_request.DeleteWorkerConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/v1/worker-configurations/{workerConfigurationArn}"
    )
    url = url.replace(
        "{workerConfigurationArn}",
        quote(str(input_["worker_configuration_arn"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_delete_worker_configuration(
