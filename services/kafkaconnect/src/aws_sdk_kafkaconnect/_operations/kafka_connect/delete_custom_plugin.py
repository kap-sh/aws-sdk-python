...
def handle_response(
    ...
    out: aws_sdk_kafkaconnect.types.delete_custom_plugin_response.DeleteCustomPluginResponse = aws_sdk_kafkaconnect.types.delete_custom_plugin_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafkaconnect.types.delete_custom_plugin_request.DeleteCustomPluginRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
