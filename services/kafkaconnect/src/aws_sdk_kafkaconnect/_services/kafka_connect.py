...
from aws_sdk_kafkaconnect._services._aws_config import aws_config
...
class KafkaConnectClientConfig(TypedDict, total=False):
...
class KafkaConnectClient:
    ...
    def create_connector(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.create_connector_request.CreateConnectorRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.create_connector_response.CreateConnectorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.create_connector.create_connector(
    ...
    def create_custom_plugin(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.create_custom_plugin_request.CreateCustomPluginRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.create_custom_plugin_response.CreateCustomPluginResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.create_custom_plugin.create_custom_plugin(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_worker_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.create_worker_configuration_request.CreateWorkerConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.create_worker_configuration_response.CreateWorkerConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.create_worker_configuration.create_worker_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_connector(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.delete_connector_request.DeleteConnectorRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.delete_connector_response.DeleteConnectorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.delete_connector.delete_connector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_custom_plugin(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.delete_custom_plugin_request.DeleteCustomPluginRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.delete_custom_plugin_response.DeleteCustomPluginResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.delete_custom_plugin.delete_custom_plugin(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_worker_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.delete_worker_configuration_request.DeleteWorkerConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.delete_worker_configuration_response.DeleteWorkerConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.delete_worker_configuration.delete_worker_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_connector(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.describe_connector_request.DescribeConnectorRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.describe_connector_response.DescribeConnectorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.describe_connector.describe_connector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_connector_operation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.describe_connector_operation_request.DescribeConnectorOperationRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.describe_connector_operation_response.DescribeConnectorOperationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.describe_connector_operation.describe_connector_operation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_custom_plugin(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.describe_custom_plugin_request.DescribeCustomPluginRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.describe_custom_plugin_response.DescribeCustomPluginResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.describe_custom_plugin.describe_custom_plugin(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_worker_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.describe_worker_configuration_request.DescribeWorkerConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.describe_worker_configuration_response.DescribeWorkerConfigurationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.describe_worker_configuration.describe_worker_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_connector_operations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.list_connector_operations_request.ListConnectorOperationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.list_connector_operations_response.ListConnectorOperationsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.list_connector_operations.list_connector_operations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_connector_operations(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_kafkaconnect.types.__string.__string"] = None,
    ) -> "Iterator[aws_sdk_kafkaconnect.types.connector_operation_summary.ConnectorOperationSummary]":
        _token = next_token
        while True:
    ...
    def list_connectors(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.list_connectors_request.ListConnectorsRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.list_connectors_response.ListConnectorsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.list_connectors.list_connectors(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_connectors(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_kafkaconnect.types.__string.__string"] = None,
    ) -> "Iterator[aws_sdk_kafkaconnect.types.connector_summary.ConnectorSummary]":
        _token = next_token
        while True:
    ...
    def list_custom_plugins(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.list_custom_plugins_request.ListCustomPluginsRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.list_custom_plugins_response.ListCustomPluginsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.list_custom_plugins.list_custom_plugins(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_custom_plugins(
        ...
        *,
        ...
        "Iterator[aws_sdk_kafkaconnect.types.custom_plugin_summary.CustomPluginSummary]"
    ):
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_worker_configurations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.list_worker_configurations_request.ListWorkerConfigurationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.list_worker_configurations_response.ListWorkerConfigurationsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.list_worker_configurations.list_worker_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_worker_configurations(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_kafkaconnect.types.__string.__string"] = None,
        name_prefix: Optional["aws_sdk_kafkaconnect.types.__string.__string"] = None,
    ) -> "Iterator[aws_sdk_kafkaconnect.types.worker_configuration_summary.WorkerConfigurationSummary]":
        _token = next_token
        while True:
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_connector(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kafkaconnect.types.update_connector_request.UpdateConnectorRequest]",
        ) -> OperationResponse[
            "aws_sdk_kafkaconnect.types.update_connector_response.UpdateConnectorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_kafkaconnect._operations.kafka_connect.update_connector.update_connector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
