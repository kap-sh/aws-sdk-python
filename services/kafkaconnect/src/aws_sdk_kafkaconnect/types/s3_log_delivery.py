"""Generated from Smithy shape ``com.amazonaws.kafkaconnect#S3LogDelivery``."""
...
class S3LogDelivery(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: S3LogDelivery) -> dict:
    out: dict = {}
    if "bucket" in value:
...
def deserialize_json(data: dict) -> S3LogDelivery:
    out: S3LogDelivery = {}  # type: ignore[typeddict-item]
    if "bucket" in data:
