...
class CreateConnectorRequest(TypedDict, closed=True):
    ...
    log_delivery: NotRequired["aws_sdk_kafkaconnect.types.log_delivery.LogDelivery"]
...
def serialize_json(value: CreateConnectorRequest) -> dict:
    ...
    out["capacity"] = aws_sdk_kafkaconnect.types.capacity.serialize_json(
        value["capacity"]
    )
    import aws_sdk_kafkaconnect.types.connector_configuration
    ...
    out["kafkaCluster"] = aws_sdk_kafkaconnect.types.kafka_cluster.serialize_json(
        value["kafka_cluster"]
    )
    import aws_sdk_kafkaconnect.types.kafka_cluster_client_authentication

    out["kafkaClusterClientAuthentication"] = (
        aws_sdk_kafkaconnect.types.kafka_cluster_client_authentication.serialize_json(
    ...
    out["kafkaClusterEncryptionInTransit"] = (
        aws_sdk_kafkaconnect.types.kafka_cluster_encryption_in_transit.serialize_json(
    ...
    if "log_delivery" in value:
        ...
        out["logDelivery"] = aws_sdk_kafkaconnect.types.log_delivery.serialize_json(
            value["log_delivery"]
        )
    ...
    out["plugins"] = aws_sdk_kafkaconnect.types.__list_of_plugin.serialize_json(
        value["plugins"]
    )
    ...
    if "worker_configuration" in value:
        ...
        out["workerConfiguration"] = (
            aws_sdk_kafkaconnect.types.worker_configuration.serialize_json(
...
def deserialize_json(data: dict) -> CreateConnectorRequest:
    ...
    if "capacity" in data:
        ...
        out["capacity"] = aws_sdk_kafkaconnect.types.capacity.deserialize_json(
            data["capacity"]
        )
    else:
    ...
    if "kafkaCluster" in data:
        ...
        out["kafka_cluster"] = (
            aws_sdk_kafkaconnect.types.kafka_cluster.deserialize_json(
                data["kafkaCluster"]
            )
        )
    else:
    ...
    if "kafkaClusterClientAuthentication" in data:
        ...
        out["kafka_cluster_client_authentication"] = (
            aws_sdk_kafkaconnect.types.kafka_cluster_client_authentication.deserialize_json(
    ...
    if "kafkaClusterEncryptionInTransit" in data:
        ...
        out["kafka_cluster_encryption_in_transit"] = (
            aws_sdk_kafkaconnect.types.kafka_cluster_encryption_in_transit.deserialize_json(
    ...
    if "logDelivery" in data:
        ...
        out["log_delivery"] = aws_sdk_kafkaconnect.types.log_delivery.deserialize_json(
            data["logDelivery"]
        )
    ...
    if "plugins" in data:
        ...
        out["plugins"] = aws_sdk_kafkaconnect.types.__list_of_plugin.deserialize_json(
            data["plugins"]
        )
    else:
    ...
    if "workerConfiguration" in data:
        ...
        out["worker_configuration"] = (
            aws_sdk_kafkaconnect.types.worker_configuration.deserialize_json(
