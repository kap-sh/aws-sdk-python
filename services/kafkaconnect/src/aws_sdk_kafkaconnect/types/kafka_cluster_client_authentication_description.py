...
class KafkaClusterClientAuthenticationDescription(TypedDict):
    authentication_type: NotRequired[
        "aws_sdk_kafkaconnect.types.kafka_cluster_client_authentication_type.KafkaClusterClientAuthenticationType"
    ]
