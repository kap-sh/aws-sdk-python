...
if TYPE_CHECKING:
    ...
    import aws_sdk_kafkaconnect.types.scale_in_policy_description
    import aws_sdk_kafkaconnect.types.scale_out_policy_description


class AutoScalingDescription(TypedDict):
    ...
    scale_in_policy: NotRequired[
        "aws_sdk_kafkaconnect.types.scale_in_policy_description.ScaleInPolicyDescription"
    ]
    """<p>The scale-in policy for the connector.</p>"""
    scale_out_policy: NotRequired[
        "aws_sdk_kafkaconnect.types.scale_out_policy_description.ScaleOutPolicyDescription"
    ]
...
def serialize_json(value: AutoScalingDescription) -> dict:
    ...
    if "scale_in_policy" in value:
        ...
        out["scaleInPolicy"] = (
            aws_sdk_kafkaconnect.types.scale_in_policy_description.serialize_json(
    ...
    if "scale_out_policy" in value:
        ...
        out["scaleOutPolicy"] = (
            aws_sdk_kafkaconnect.types.scale_out_policy_description.serialize_json(
...
def deserialize_json(data: dict) -> AutoScalingDescription:
    ...
    if "scaleInPolicy" in data:
        ...
        out["scale_in_policy"] = (
            aws_sdk_kafkaconnect.types.scale_in_policy_description.deserialize_json(
                data["scaleInPolicy"]
            )
        )
    if "scaleOutPolicy" in data:
        ...
        out["scale_out_policy"] = (
            aws_sdk_kafkaconnect.types.scale_out_policy_description.deserialize_json(
                data["scaleOutPolicy"]
            )
        )
