...
if TYPE_CHECKING:
    import aws_sdk_kafkaconnect.types.__list_of_connector_summary
    import aws_sdk_kafkaconnect.types.__string


class ListConnectorsResponse(TypedDict):
    connectors: NotRequired[
        "aws_sdk_kafkaconnect.types.__list_of_connector_summary.__listOfConnectorSummary"
    ]
...
def serialize_json(value: ListConnectorsResponse) -> dict:
    ...
    if "connectors" in value:
        ...
        out["connectors"] = (
            aws_sdk_kafkaconnect.types.__list_of_connector_summary.serialize_json(
                value["connectors"]
            )
        )
...
def deserialize_json(data: dict) -> ListConnectorsResponse:
    ...
    if "connectors" in data:
        ...
        out["connectors"] = (
            aws_sdk_kafkaconnect.types.__list_of_connector_summary.deserialize_json(
                data["connectors"]
            )
        )
