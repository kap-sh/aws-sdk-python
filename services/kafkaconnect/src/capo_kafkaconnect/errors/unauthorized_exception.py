"""Generated from Smithy shape ``com.amazonaws.kafkaconnect#UnauthorizedException``."""
...
class UnauthorizedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kafkaconnect#UnauthorizedException``."""
