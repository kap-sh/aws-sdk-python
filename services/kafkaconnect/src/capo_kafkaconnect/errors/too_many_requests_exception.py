"""Generated from Smithy shape ``com.amazonaws.kafkaconnect#TooManyRequestsException``."""
...
class TooManyRequestsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kafkaconnect#TooManyRequestsException``."""
