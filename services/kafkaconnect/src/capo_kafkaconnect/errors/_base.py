...
class KafkaConnectError(Exception):
    """Base class for all KafkaConnect service errors."""


class ServiceError(KafkaConnectError):
...
class SerializationError(KafkaConnectError):
    """Raised when a value cannot be serialized."""


class DeserializationError(KafkaConnectError):
...
class WaiterFailedError(KafkaConnectError):
...
class WaiterTimeoutError(KafkaConnectError):
