...
def build_request(
    ...
    input: aws_sdk_xray.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.list_tags_for_resource_request.serialize_json(input)
    ).encode()
