"""Generated from Smithy shape ``com.amazonaws.xray#GetTraceGraph``."""
...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_trace_graph_result.GetTraceGraphResult = (
        aws_sdk_xray.types.get_trace_graph_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.get_trace_graph_request.GetTraceGraphRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/TraceGraph"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_xray.types.get_trace_graph_request

    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_trace_graph_request.serialize_json(input_)
    ).encode()
...
def get_trace_graph(
    ...
    aws_sdk_xray.types.get_trace_graph_result.GetTraceGraphResult, zapros.Response
]:
...
async def async_get_trace_graph(
