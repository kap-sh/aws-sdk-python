...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            import aws_sdk_xray.errors.too_many_tags_exception

            raise aws_sdk_xray.errors.too_many_tags_exception.TooManyTagsException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_xray.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_xray.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_xray.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
