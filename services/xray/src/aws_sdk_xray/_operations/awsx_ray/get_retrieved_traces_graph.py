...
def build_request(
    ...
    input: aws_sdk_xray.types.get_retrieved_traces_graph_request.GetRetrievedTracesGraphRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_retrieved_traces_graph_request.serialize_json(input)
    ).encode()
