...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_retrieved_traces_graph_result.GetRetrievedTracesGraphResult = aws_sdk_xray.types.get_retrieved_traces_graph_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.get_retrieved_traces_graph_request.GetRetrievedTracesGraphRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_retrieved_traces_graph_request.serialize_json(input_)
    ).encode()
