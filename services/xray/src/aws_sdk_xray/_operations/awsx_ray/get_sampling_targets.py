"""Generated from Smithy shape ``com.amazonaws.xray#GetSamplingTargets``."""
...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_sampling_targets_result.GetSamplingTargetsResult = (
        aws_sdk_xray.types.get_sampling_targets_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.get_sampling_targets_request.GetSamplingTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/SamplingTargets"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_xray.types.get_sampling_targets_request

    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_sampling_targets_request.serialize_json(input_)
    ).encode()
...
async def async_get_sampling_targets(
