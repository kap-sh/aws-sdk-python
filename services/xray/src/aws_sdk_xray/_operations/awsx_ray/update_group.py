"""Generated from Smithy shape ``com.amazonaws.xray#UpdateGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_xray.types.update_group_result.UpdateGroupResult = (
        aws_sdk_xray.types.update_group_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.update_group_request.UpdateGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/UpdateGroup"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_xray.types.update_group_request

    body: bytes | None = json.dumps(
        aws_sdk_xray.types.update_group_request.serialize_json(input_)
    ).encode()
...
def update_group(
    ...
    input_: aws_sdk_xray.types.update_group_request.UpdateGroupRequest,
) -> tuple[aws_sdk_xray.types.update_group_result.UpdateGroupResult, zapros.Response]:
