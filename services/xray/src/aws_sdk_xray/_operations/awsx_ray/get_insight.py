...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_insight_result.GetInsightResult = (
        aws_sdk_xray.types.get_insight_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.get_insight_request.GetInsightRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_insight_request.serialize_json(input_)
    ).encode()
...
def get_insight(
    ...
    input_: aws_sdk_xray.types.get_insight_request.GetInsightRequest,
) -> tuple[aws_sdk_xray.types.get_insight_result.GetInsightResult, zapros.Response]:
