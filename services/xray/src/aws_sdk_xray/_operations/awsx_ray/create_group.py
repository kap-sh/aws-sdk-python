...
def handle_response(
    ...
    out: aws_sdk_xray.types.create_group_result.CreateGroupResult = (
        aws_sdk_xray.types.create_group_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.create_group_request.CreateGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.create_group_request.serialize_json(input_)
    ).encode()
...
def create_group(
    ...
    input_: aws_sdk_xray.types.create_group_request.CreateGroupRequest,
) -> tuple[aws_sdk_xray.types.create_group_result.CreateGroupResult, zapros.Response]:
