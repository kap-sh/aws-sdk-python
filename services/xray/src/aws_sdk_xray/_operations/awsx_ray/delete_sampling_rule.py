"""Generated from Smithy shape ``com.amazonaws.xray#DeleteSamplingRule``."""
...
def handle_response(
    ...
    out: aws_sdk_xray.types.delete_sampling_rule_result.DeleteSamplingRuleResult = (
        aws_sdk_xray.types.delete_sampling_rule_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.delete_sampling_rule_request.DeleteSamplingRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteSamplingRule"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_xray.types.delete_sampling_rule_request

    body: bytes | None = json.dumps(
        aws_sdk_xray.types.delete_sampling_rule_request.serialize_json(input_)
    ).encode()
...
async def async_delete_sampling_rule(
