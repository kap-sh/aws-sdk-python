...
def handle_response(
    ...
    out: aws_sdk_xray.types.list_resource_policies_result.ListResourcePoliciesResult = (
        aws_sdk_xray.types.list_resource_policies_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.list_resource_policies_request.ListResourcePoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.list_resource_policies_request.serialize_json(input_)
    ).encode()
