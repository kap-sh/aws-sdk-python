...
def build_request(
    ...
    input: aws_sdk_xray.types.list_resource_policies_request.ListResourcePoliciesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.list_resource_policies_request.serialize_json(input)
    ).encode()
