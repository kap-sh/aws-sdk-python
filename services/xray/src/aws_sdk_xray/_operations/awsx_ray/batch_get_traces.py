...
def handle_response(
    ...
    out: aws_sdk_xray.types.batch_get_traces_result.BatchGetTracesResult = (
        aws_sdk_xray.types.batch_get_traces_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.batch_get_traces_request.BatchGetTracesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.batch_get_traces_request.serialize_json(input_)
    ).encode()
...
def batch_get_traces(
    ...
    aws_sdk_xray.types.batch_get_traces_result.BatchGetTracesResult, zapros.Response
]:
