...
def build_request(
    ...
    input: aws_sdk_xray.types.list_retrieved_traces_request.ListRetrievedTracesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.list_retrieved_traces_request.serialize_json(input)
    ).encode()
