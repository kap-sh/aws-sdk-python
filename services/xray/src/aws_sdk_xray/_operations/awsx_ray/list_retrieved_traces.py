...
def handle_response(
    ...
    out: aws_sdk_xray.types.list_retrieved_traces_result.ListRetrievedTracesResult = (
        aws_sdk_xray.types.list_retrieved_traces_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.list_retrieved_traces_request.ListRetrievedTracesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.list_retrieved_traces_request.serialize_json(input_)
    ).encode()
