...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_time_series_service_statistics_result.GetTimeSeriesServiceStatisticsResult = aws_sdk_xray.types.get_time_series_service_statistics_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.get_time_series_service_statistics_request.GetTimeSeriesServiceStatisticsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_time_series_service_statistics_request.serialize_json(
            input_
        )
    ).encode()
