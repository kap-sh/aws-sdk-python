...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_group_result.GetGroupResult = (
        aws_sdk_xray.types.get_group_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.get_group_request.GetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_group_request.serialize_json(input_)
    ).encode()
...
def get_group(
    ...
    input_: aws_sdk_xray.types.get_group_request.GetGroupRequest,
) -> tuple[aws_sdk_xray.types.get_group_result.GetGroupResult, zapros.Response]:
