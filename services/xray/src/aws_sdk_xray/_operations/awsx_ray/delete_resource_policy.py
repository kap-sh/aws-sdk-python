...
def build_request(
    ...
    input: aws_sdk_xray.types.delete_resource_policy_request.DeleteResourcePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.delete_resource_policy_request.serialize_json(input)
    ).encode()
