"""Generated from Smithy shape ``com.amazonaws.xray#DeleteResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_xray.types.delete_resource_policy_result.DeleteResourcePolicyResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_xray.types.delete_resource_policy_request.DeleteResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.delete_resource_policy_request.serialize_json(input_)
    ).encode()
