...
def handle_response(
    ...
    out: aws_sdk_xray.types.update_trace_segment_destination_result.UpdateTraceSegmentDestinationResult = aws_sdk_xray.types.update_trace_segment_destination_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.update_trace_segment_destination_request.UpdateTraceSegmentDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.update_trace_segment_destination_request.serialize_json(
            input_
        )
    ).encode()
