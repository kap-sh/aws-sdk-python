...
def handle_response(
    ...
    out: aws_sdk_xray.types.put_trace_segments_result.PutTraceSegmentsResult = (
        aws_sdk_xray.types.put_trace_segments_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.put_trace_segments_request.PutTraceSegmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.put_trace_segments_request.serialize_json(input_)
    ).encode()
...
def put_trace_segments(
    ...
    aws_sdk_xray.types.put_trace_segments_result.PutTraceSegmentsResult, zapros.Response
]:
