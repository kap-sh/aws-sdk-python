...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_trace_summaries_result.GetTraceSummariesResult = (
        aws_sdk_xray.types.get_trace_summaries_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_xray.types.get_trace_summaries_request.GetTraceSummariesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_trace_summaries_request.serialize_json(input)
    ).encode()
