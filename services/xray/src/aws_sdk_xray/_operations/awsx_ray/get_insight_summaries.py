...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_insight_summaries_result.GetInsightSummariesResult = (
        aws_sdk_xray.types.get_insight_summaries_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.get_insight_summaries_request.GetInsightSummariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_insight_summaries_request.serialize_json(input_)
    ).encode()
