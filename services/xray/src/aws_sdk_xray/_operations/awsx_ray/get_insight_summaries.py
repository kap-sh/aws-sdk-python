...
def build_request(
    ...
    input: aws_sdk_xray.types.get_insight_summaries_request.GetInsightSummariesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_insight_summaries_request.serialize_json(input)
    ).encode()
