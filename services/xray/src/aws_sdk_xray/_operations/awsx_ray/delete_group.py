...
def handle_response(
    ...
    out: aws_sdk_xray.types.delete_group_result.DeleteGroupResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_xray.types.delete_group_request.DeleteGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.delete_group_request.serialize_json(input_)
    ).encode()
...
def delete_group(
    ...
    input_: aws_sdk_xray.types.delete_group_request.DeleteGroupRequest,
) -> tuple[aws_sdk_xray.types.delete_group_result.DeleteGroupResult, zapros.Response]:
