"""Generated from Smithy shape ``com.amazonaws.xray#GetServiceGraph``."""
...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_service_graph_result.GetServiceGraphResult = (
        aws_sdk_xray.types.get_service_graph_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.get_service_graph_request.GetServiceGraphRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ServiceGraph"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_xray.types.get_service_graph_request

    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_service_graph_request.serialize_json(input_)
    ).encode()
...
def get_service_graph(
    ...
    aws_sdk_xray.types.get_service_graph_result.GetServiceGraphResult, zapros.Response
]:
...
async def async_get_service_graph(
