...
def build_request(
    ...
    input: aws_sdk_xray.types.put_encryption_config_request.PutEncryptionConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.put_encryption_config_request.serialize_json(input)
    ).encode()
