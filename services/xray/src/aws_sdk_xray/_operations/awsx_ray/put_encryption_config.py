...
def handle_response(
    ...
    out: aws_sdk_xray.types.put_encryption_config_result.PutEncryptionConfigResult = (
        aws_sdk_xray.types.put_encryption_config_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.put_encryption_config_request.PutEncryptionConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.put_encryption_config_request.serialize_json(input_)
    ).encode()
