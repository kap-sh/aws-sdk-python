...
def build_request(
    ...
    input: aws_sdk_xray.types.cancel_trace_retrieval_request.CancelTraceRetrievalRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.cancel_trace_retrieval_request.serialize_json(input)
    ).encode()
