"""Generated from Smithy shape ``com.amazonaws.xray#CancelTraceRetrieval``."""
...
def handle_response(
    ...
    out: aws_sdk_xray.types.cancel_trace_retrieval_result.CancelTraceRetrievalResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_xray.types.cancel_trace_retrieval_request.CancelTraceRetrievalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/CancelTraceRetrieval"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_xray.types.cancel_trace_retrieval_request

    body: bytes | None = json.dumps(
        aws_sdk_xray.types.cancel_trace_retrieval_request.serialize_json(input_)
    ).encode()
...
async def async_cancel_trace_retrieval(
