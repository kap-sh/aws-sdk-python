...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_insight_events_result.GetInsightEventsResult = (
        aws_sdk_xray.types.get_insight_events_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.get_insight_events_request.GetInsightEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_insight_events_request.serialize_json(input_)
    ).encode()
...
def get_insight_events(
    ...
    aws_sdk_xray.types.get_insight_events_result.GetInsightEventsResult, zapros.Response
]:
