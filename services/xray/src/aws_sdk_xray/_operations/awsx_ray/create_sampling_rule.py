...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RuleLimitExceededException":
            import aws_sdk_xray.errors.rule_limit_exceeded_exception

            raise aws_sdk_xray.errors.rule_limit_exceeded_exception.RuleLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_xray.types.create_sampling_rule_result.CreateSamplingRuleResult = (
        aws_sdk_xray.types.create_sampling_rule_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.create_sampling_rule_request.CreateSamplingRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.create_sampling_rule_request.serialize_json(input_)
    ).encode()
