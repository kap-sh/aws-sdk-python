...
def build_request(
    ...
    input: aws_sdk_xray.types.put_telemetry_records_request.PutTelemetryRecordsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.put_telemetry_records_request.serialize_json(input)
    ).encode()
