...
def handle_response(
    ...
    out: aws_sdk_xray.types.put_telemetry_records_result.PutTelemetryRecordsResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_xray.types.put_telemetry_records_request.PutTelemetryRecordsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.put_telemetry_records_request.serialize_json(input_)
    ).encode()
