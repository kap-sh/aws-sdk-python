...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_sampling_rules_result.GetSamplingRulesResult = (
        aws_sdk_xray.types.get_sampling_rules_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.get_sampling_rules_request.GetSamplingRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_sampling_rules_request.serialize_json(input_)
    ).encode()
...
def get_sampling_rules(
    ...
    aws_sdk_xray.types.get_sampling_rules_result.GetSamplingRulesResult, zapros.Response
]:
