...
def build_request(
    ...
    input: aws_sdk_xray.types.get_insight_impact_graph_request.GetInsightImpactGraphRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_insight_impact_graph_request.serialize_json(input)
    ).encode()
