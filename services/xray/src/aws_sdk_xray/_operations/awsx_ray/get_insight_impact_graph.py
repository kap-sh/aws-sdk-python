...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_insight_impact_graph_result.GetInsightImpactGraphResult = aws_sdk_xray.types.get_insight_impact_graph_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.get_insight_impact_graph_request.GetInsightImpactGraphRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_insight_impact_graph_request.serialize_json(input_)
    ).encode()
