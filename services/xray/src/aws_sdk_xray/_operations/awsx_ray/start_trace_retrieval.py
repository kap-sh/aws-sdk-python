...
def build_request(
    ...
    input: aws_sdk_xray.types.start_trace_retrieval_request.StartTraceRetrievalRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.start_trace_retrieval_request.serialize_json(input)
    ).encode()
