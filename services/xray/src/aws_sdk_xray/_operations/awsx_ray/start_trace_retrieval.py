...
def handle_response(
    ...
    out: aws_sdk_xray.types.start_trace_retrieval_result.StartTraceRetrievalResult = (
        aws_sdk_xray.types.start_trace_retrieval_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.start_trace_retrieval_request.StartTraceRetrievalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.start_trace_retrieval_request.serialize_json(input_)
    ).encode()
