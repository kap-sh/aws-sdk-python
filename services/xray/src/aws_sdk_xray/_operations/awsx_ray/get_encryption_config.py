"""Generated from Smithy shape ``com.amazonaws.xray#GetEncryptionConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_encryption_config_result.GetEncryptionConfigResult = (
        aws_sdk_xray.types.get_encryption_config_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.get_encryption_config_request.GetEncryptionConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/EncryptionConfig"
    params: dict[str, str] = {}
...
async def async_get_encryption_config(
