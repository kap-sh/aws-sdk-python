...
def handle_response(
    ...
    out: aws_sdk_xray.types.get_groups_result.GetGroupsResult = (
        aws_sdk_xray.types.get_groups_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_xray.types.get_groups_request.GetGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_xray.types.get_groups_request.serialize_json(input_)
    ).encode()
...
def get_groups(
    ...
    input_: aws_sdk_xray.types.get_groups_request.GetGroupsRequest,
) -> tuple[aws_sdk_xray.types.get_groups_result.GetGroupsResult, zapros.Response]:
