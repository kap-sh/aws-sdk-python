...
class Http(TypedDict):
    http_url: NotRequired["aws_sdk_xray.types.string.String"]
    """<p>The request URL.</p>"""
    http_status: NotRequired["aws_sdk_xray.types.nullable_integer.NullableInteger"]
    """<p>The response status.</p>"""
    http_method: NotRequired["aws_sdk_xray.types.string.String"]
    """<p>The request method.</p>"""
    user_agent: NotRequired["aws_sdk_xray.types.string.String"]
    """<p>The request's user agent string.</p>"""
    client_ip: NotRequired["aws_sdk_xray.types.string.String"]
