...
if TYPE_CHECKING:
    ...
    import aws_sdk_xray.types.fixed_rate
    import aws_sdk_xray.types.host
    import aws_sdk_xray.types.http_method
    import aws_sdk_xray.types.priority
    import aws_sdk_xray.types.reservoir_size
    import aws_sdk_xray.types.resource_arn
    import aws_sdk_xray.types.rule_name
    import aws_sdk_xray.types.sampling_rate_boost
    import aws_sdk_xray.types.service_name
    import aws_sdk_xray.types.service_type
    import aws_sdk_xray.types.string
    import aws_sdk_xray.types.url_path
    import aws_sdk_xray.types.version


class SamplingRule(TypedDict):
    ...
    resource_arn: "aws_sdk_xray.types.resource_arn.ResourceARN"
    """<p>Matches the ARN of the Amazon Web Services resource on which the service runs.</p>"""
    priority: "aws_sdk_xray.types.priority.Priority"
    """<p>The priority of the sampling rule.</p>"""
    fixed_rate: "aws_sdk_xray.types.fixed_rate.FixedRate"
    """<p>The percentage of matching requests to instrument, after the reservoir is exhausted.</p>"""
    reservoir_size: "aws_sdk_xray.types.reservoir_size.ReservoirSize"
    ...
    service_type: "aws_sdk_xray.types.service_type.ServiceType"
    """<p>Matches the <code>origin</code> that the service uses to identify its type in segments.</p>"""
    host: "aws_sdk_xray.types.host.Host"
    """<p>Matches the hostname from a request URL.</p>"""
    http_method: "aws_sdk_xray.types.http_method.HTTPMethod"
    """<p>Matches the HTTP method of a request.</p>"""
    url_path: "aws_sdk_xray.types.url_path.URLPath"
    """<p>Matches the path from a request URL.</p>"""
    version: "aws_sdk_xray.types.version.Version"
    """<p>The version of the sampling rule format (<code>1</code>).</p>"""
    attributes: NotRequired["aws_sdk_xray.types.attribute_map.AttributeMap"]
    """<p>Matches attributes derived from the request.</p>"""
    sampling_rate_boost: NotRequired[
        "aws_sdk_xray.types.sampling_rate_boost.SamplingRateBoost"
    ]
...
def serialize_json(value: SamplingRule) -> dict:
    ...
    if "attributes" in value:
        ...
        out["Attributes"] = aws_sdk_xray.types.attribute_map.serialize_json(
            value["attributes"]
        )
    if "sampling_rate_boost" in value:
        import aws_sdk_xray.types.sampling_rate_boost

        out["SamplingRateBoost"] = (
            aws_sdk_xray.types.sampling_rate_boost.serialize_json(
...
def deserialize_json(data: dict) -> SamplingRule:
    ...
    if "Attributes" in data:
        ...
        out["attributes"] = aws_sdk_xray.types.attribute_map.deserialize_json(
            data["Attributes"]
        )
    if "SamplingRateBoost" in data:
        ...
        out["sampling_rate_boost"] = (
            aws_sdk_xray.types.sampling_rate_boost.deserialize_json(
