...
if TYPE_CHECKING:
    import aws_sdk_xray.types.insight_summary_list
    import aws_sdk_xray.types.token


class GetInsightSummariesResult(TypedDict):
    insight_summaries: NotRequired[
        "aws_sdk_xray.types.insight_summary_list.InsightSummaryList"
    ]
...
def serialize_json(value: GetInsightSummariesResult) -> dict:
    ...
    if "insight_summaries" in value:
        ...
        out["InsightSummaries"] = (
            aws_sdk_xray.types.insight_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> GetInsightSummariesResult:
    ...
    if "InsightSummaries" in data:
        ...
        out["insight_summaries"] = (
            aws_sdk_xray.types.insight_summary_list.deserialize_json(
