...
class SamplingRuleUpdate(TypedDict, closed=True):
    ...
    priority: NotRequired["aws_sdk_xray.types.nullable_integer.NullableInteger"]
    """<p>The priority of the sampling rule.</p>"""
    fixed_rate: NotRequired["aws_sdk_xray.types.nullable_double.NullableDouble"]
    """<p>The percentage of matching requests to instrument, after the reservoir is exhausted.</p>"""
    reservoir_size: NotRequired["aws_sdk_xray.types.nullable_integer.NullableInteger"]
    ...
    host: NotRequired["aws_sdk_xray.types.host.Host"]
    """<p>Matches the hostname from a request URL.</p>"""
    service_name: NotRequired["aws_sdk_xray.types.service_name.ServiceName"]
    """<p>Matches the <code>name</code> that the service uses to identify itself in segments.</p>"""
    service_type: NotRequired["aws_sdk_xray.types.service_type.ServiceType"]
    """<p>Matches the <code>origin</code> that the service uses to identify its type in segments.</p>"""
    http_method: NotRequired["aws_sdk_xray.types.http_method.HTTPMethod"]
    """<p>Matches the HTTP method of a request.</p>"""
    url_path: NotRequired["aws_sdk_xray.types.url_path.URLPath"]
