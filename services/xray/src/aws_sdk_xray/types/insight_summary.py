"""Generated from Smithy shape ``com.amazonaws.xray#InsightSummary``."""
...
class InsightSummary(TypedDict, closed=True):
    ...
    last_update_time: NotRequired["aws_sdk_xray.types.timestamp.Timestamp"]
...
def serialize_json(value: InsightSummary) -> dict:
    ...
    if "last_update_time" in value:
        ...
        out["LastUpdateTime"] = aws_sdk_xray.types.timestamp.serialize_json(
...
def deserialize_json(data: dict) -> InsightSummary:
    ...
    if "LastUpdateTime" in data:
        ...
        out["last_update_time"] = aws_sdk_xray.types.timestamp.deserialize_json(
            data["LastUpdateTime"]
        )
    return out
