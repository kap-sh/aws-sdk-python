"""Generated from Smithy shape ``com.amazonaws.xray#ErrorRootCauseEntity``."""
...
class ErrorRootCauseEntity(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ErrorRootCauseEntity) -> dict:
    out: dict = {}
    if "name" in value:
        out["Name"] = value["name"]
...
def deserialize_json(data: dict) -> ErrorRootCauseEntity:
    out: ErrorRootCauseEntity = {}  # type: ignore[typeddict-item]
    if "Name" in data:
        out["name"] = data["Name"]
