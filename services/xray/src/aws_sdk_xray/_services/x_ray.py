...
from aws_sdk_xray._services._aws_config import aws_config
...
class XRayClientConfig(TypedDict, total=False, closed=True):
...
class XRayClient:
    ...
    def batch_get_traces(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.batch_get_traces_request.BatchGetTracesRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.batch_get_traces_result.BatchGetTracesResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.batch_get_traces.batch_get_traces(
    ...
    def iter_batch_get_traces(
        ...
        *,
        config_overrides: Optional[XRayClientConfig] = None,
        next_token: Optional["aws_sdk_xray.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_xray.types.trace.Trace]":
        _token = next_token
        while True:
            _response = self.batch_get_traces(
                trace_ids,
    ...
    def cancel_trace_retrieval(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.cancel_trace_retrieval_request.CancelTraceRetrievalRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.cancel_trace_retrieval_result.CancelTraceRetrievalResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.cancel_trace_retrieval.cancel_trace_retrieval(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.create_group_request.CreateGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.create_group_result.CreateGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.create_group.create_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_sampling_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.create_sampling_rule_request.CreateSamplingRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.create_sampling_rule_result.CreateSamplingRuleResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.create_sampling_rule.create_sampling_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.delete_group_request.DeleteGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.delete_group_result.DeleteGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.delete_group.delete_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.delete_resource_policy_request.DeleteResourcePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.delete_resource_policy_result.DeleteResourcePolicyResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.delete_resource_policy.delete_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_sampling_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.delete_sampling_rule_request.DeleteSamplingRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.delete_sampling_rule_result.DeleteSamplingRuleResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.delete_sampling_rule.delete_sampling_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_encryption_config(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_encryption_config.get_encryption_config(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_group_request.GetGroupRequest]",
        ) -> OperationResponse["aws_sdk_xray.types.get_group_result.GetGroupResult"]:
            import aws_sdk_xray._operations.awsx_ray.get_group

            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_group.get_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_groups_request.GetGroupsRequest]",
        ) -> OperationResponse["aws_sdk_xray.types.get_groups_result.GetGroupsResult"]:
            import aws_sdk_xray._operations.awsx_ray.get_groups

            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_groups.get_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_xray.types.group_summary.GroupSummary]":
        _token = next_token
        while True:
            _response = self.get_groups(
                config_overrides=config_overrides,
                next_token=_token,
            )
    ...
    def get_indexing_rules(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_indexing_rules_request.GetIndexingRulesRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.get_indexing_rules_result.GetIndexingRulesResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_indexing_rules.get_indexing_rules(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_insight(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_insight_request.GetInsightRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.get_insight_result.GetInsightResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_insight.get_insight(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_insight_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_insight_events_request.GetInsightEventsRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.get_insight_events_result.GetInsightEventsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_insight_events.get_insight_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_insight_impact_graph(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_insight_impact_graph_request.GetInsightImpactGraphRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.get_insight_impact_graph_result.GetInsightImpactGraphResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_insight_impact_graph.get_insight_impact_graph(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_insight_summaries(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_insight_summaries_request.GetInsightSummariesRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.get_insight_summaries_result.GetInsightSummariesResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_insight_summaries.get_insight_summaries(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_retrieved_traces_graph(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_retrieved_traces_graph_request.GetRetrievedTracesGraphRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.get_retrieved_traces_graph_result.GetRetrievedTracesGraphResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_retrieved_traces_graph.get_retrieved_traces_graph(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_sampling_rules(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_sampling_rules_request.GetSamplingRulesRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.get_sampling_rules_result.GetSamplingRulesResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_sampling_rules.get_sampling_rules(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_get_sampling_rules(
        ...
        *,
        config_overrides: Optional[XRayClientConfig] = None,
        next_token: Optional["aws_sdk_xray.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_xray.types.sampling_rule_record.SamplingRuleRecord]":
        _token = next_token
        while True:
            _response = self.get_sampling_rules(
                config_overrides=config_overrides,
                next_token=_token,
            )
    ...
    def get_sampling_statistic_summaries(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_sampling_statistic_summaries_request.GetSamplingStatisticSummariesRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.get_sampling_statistic_summaries_result.GetSamplingStatisticSummariesResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_sampling_statistic_summaries.get_sampling_statistic_summaries(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_get_sampling_statistic_summaries(
        ...
        *,
        config_overrides: Optional[XRayClientConfig] = None,
        next_token: Optional["aws_sdk_xray.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_xray.types.sampling_statistic_summary.SamplingStatisticSummary]":
        _token = next_token
        while True:
            _response = self.get_sampling_statistic_summaries(
                config_overrides=config_overrides,
                next_token=_token,
            )
    ...
    def get_sampling_targets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_sampling_targets_request.GetSamplingTargetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.get_sampling_targets_result.GetSamplingTargetsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_sampling_targets.get_sampling_targets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_service_graph(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_service_graph_request.GetServiceGraphRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.get_service_graph_result.GetServiceGraphResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_service_graph.get_service_graph(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_get_service_graph(
        ...
        *,
        ...
        group_arn: Optional["aws_sdk_xray.types.group_arn.GroupARN"] = None,
        next_token: Optional["aws_sdk_xray.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_xray.types.service.Service]":
        _token = next_token
        while True:
            _response = self.get_service_graph(
                start_time,
                end_time,
                config_overrides=config_overrides,
    ...
    def get_time_series_service_statistics(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_time_series_service_statistics_request.GetTimeSeriesServiceStatisticsRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.get_time_series_service_statistics_result.GetTimeSeriesServiceStatisticsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_time_series_service_statistics.get_time_series_service_statistics(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_get_time_series_service_statistics(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_xray.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_xray.types.time_series_service_statistics.TimeSeriesServiceStatistics]":
        _token = next_token
        while True:
            _response = self.get_time_series_service_statistics(
                start_time,
                end_time,
                config_overrides=config_overrides,
                group_name=group_name,
    ...
    def get_trace_graph(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_trace_graph_request.GetTraceGraphRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.get_trace_graph_result.GetTraceGraphResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_trace_graph.get_trace_graph(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_get_trace_graph(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = self.get_trace_graph(
                trace_ids,
                config_overrides=config_overrides,
                next_token=_token,
            )
    ...
    def get_trace_segment_destination(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_trace_segment_destination.get_trace_segment_destination(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_trace_summaries(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.get_trace_summaries_request.GetTraceSummariesRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.get_trace_summaries_result.GetTraceSummariesResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.get_trace_summaries.get_trace_summaries(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_get_trace_summaries(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_xray.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_xray.types.trace_summary.TraceSummary]":
        _token = next_token
        while True:
            _response = self.get_trace_summaries(
                start_time,
                end_time,
                config_overrides=config_overrides,
    ...
    def list_resource_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.list_resource_policies_request.ListResourcePoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.list_resource_policies_result.ListResourcePoliciesResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.list_resource_policies.list_resource_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_xray.types.resource_policy.ResourcePolicy]":
        _token = next_token
        while True:
    ...
    def list_retrieved_traces(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.list_retrieved_traces_request.ListRetrievedTracesRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.list_retrieved_traces_result.ListRetrievedTracesResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.list_retrieved_traces.list_retrieved_traces(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_tags_for_resource(
        ...
        *,
        config_overrides: Optional[XRayClientConfig] = None,
        next_token: Optional["aws_sdk_xray.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_xray.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    def put_encryption_config(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.put_encryption_config_request.PutEncryptionConfigRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.put_encryption_config_result.PutEncryptionConfigResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.put_encryption_config.put_encryption_config(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.put_resource_policy_request.PutResourcePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.put_resource_policy_result.PutResourcePolicyResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.put_resource_policy.put_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_telemetry_records(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.put_telemetry_records_request.PutTelemetryRecordsRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.put_telemetry_records_result.PutTelemetryRecordsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.put_telemetry_records.put_telemetry_records(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_trace_segments(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.put_trace_segments_request.PutTraceSegmentsRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.put_trace_segments_result.PutTraceSegmentsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.put_trace_segments.put_trace_segments(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_trace_retrieval(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.start_trace_retrieval_request.StartTraceRetrievalRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.start_trace_retrieval_result.StartTraceRetrievalResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.start_trace_retrieval.start_trace_retrieval(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.update_group_request.UpdateGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.update_group_result.UpdateGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.update_group.update_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_indexing_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.update_indexing_rule_request.UpdateIndexingRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.update_indexing_rule_result.UpdateIndexingRuleResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.update_indexing_rule.update_indexing_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_sampling_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.update_sampling_rule_request.UpdateSamplingRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.update_sampling_rule_result.UpdateSamplingRuleResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.update_sampling_rule.update_sampling_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_trace_segment_destination(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_xray.types.update_trace_segment_destination_request.UpdateTraceSegmentDestinationRequest]",
        ) -> OperationResponse[
            "aws_sdk_xray.types.update_trace_segment_destination_result.UpdateTraceSegmentDestinationResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_xray._operations.awsx_ray.update_trace_segment_destination.update_trace_segment_destination(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
