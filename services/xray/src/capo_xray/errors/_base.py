...
class XRayError(Exception):
    """Base class for all XRay service errors."""


class ServiceError(XRayError):
...
class SerializationError(XRayError):
    """Raised when a value cannot be serialized."""


class DeserializationError(XRayError):
...
class WaiterFailedError(XRayError):
...
class WaiterTimeoutError(XRayError):
