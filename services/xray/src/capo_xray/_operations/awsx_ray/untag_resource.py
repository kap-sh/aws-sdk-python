"""Generated from Smithy shape ``com.amazonaws.xray#UntagResource``."""
...
import capo_xray.types.tag_key_list
import capo_xray.types.untag_resource_request
import capo_xray.types.untag_resource_response
...
) -> capo_xray.types.untag_resource_response.UntagResourceResponse:
    out: capo_xray.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_xray.types.untag_resource_request.serialize_json(input_)
    ).encode()
...
def untag_resource(
    ...
    capo_xray.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
