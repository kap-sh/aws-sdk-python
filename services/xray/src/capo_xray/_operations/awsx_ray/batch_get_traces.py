"""Generated from Smithy shape ``com.amazonaws.xray#BatchGetTraces``."""
...
import capo_xray.types.batch_get_traces_request
import capo_xray.types.batch_get_traces_result
...
) -> capo_xray.types.batch_get_traces_result.BatchGetTracesResult:
    out: capo_xray.types.batch_get_traces_result.BatchGetTracesResult = (
        capo_xray.types.batch_get_traces_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/Traces"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_xray.types.batch_get_traces_request.serialize_json(input_)
    ).encode()
...
def batch_get_traces(
    ...
    capo_xray.types.batch_get_traces_result.BatchGetTracesResult, zapros.Response
]:
...
async def async_batch_get_traces(
