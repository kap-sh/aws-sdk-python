"""Generated from Smithy shape ``com.amazonaws.xray#CreateGroup``."""
...
import capo_xray.types.create_group_request
import capo_xray.types.create_group_result
...
) -> capo_xray.types.create_group_result.CreateGroupResult:
    out: capo_xray.types.create_group_result.CreateGroupResult = (
        capo_xray.types.create_group_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/CreateGroup"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_xray.types.create_group_request.serialize_json(input_)
    ).encode()
...
def create_group(
    ...
    input_: capo_xray.types.create_group_request.CreateGroupRequest,
) -> tuple[capo_xray.types.create_group_result.CreateGroupResult, zapros.Response]:
