"""Generated from Smithy shape ``com.amazonaws.xray#ListResourcePolicies``."""
...
import capo_xray.types.list_resource_policies_request
import capo_xray.types.list_resource_policies_result
...
) -> capo_xray.types.list_resource_policies_result.ListResourcePoliciesResult:
    out: capo_xray.types.list_resource_policies_result.ListResourcePoliciesResult = (
        capo_xray.types.list_resource_policies_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ListResourcePolicies"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_xray.types.list_resource_policies_request.serialize_json(input_)
    ).encode()
...
async def async_list_resource_policies(
