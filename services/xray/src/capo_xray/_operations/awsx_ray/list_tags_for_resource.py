"""Generated from Smithy shape ``com.amazonaws.xray#ListTagsForResource``."""
...
import capo_xray.types.list_tags_for_resource_request
import capo_xray.types.list_tags_for_resource_response
...
) -> capo_xray.types.list_tags_for_resource_response.ListTagsForResourceResponse:
    out: capo_xray.types.list_tags_for_resource_response.ListTagsForResourceResponse = (
        capo_xray.types.list_tags_for_resource_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_xray.types.list_tags_for_resource_request.serialize_json(input_)
    ).encode()
