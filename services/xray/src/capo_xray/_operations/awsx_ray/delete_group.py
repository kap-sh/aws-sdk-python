"""Generated from Smithy shape ``com.amazonaws.xray#DeleteGroup``."""
...
import capo_xray.types.delete_group_request
import capo_xray.types.delete_group_result
...
) -> capo_xray.types.delete_group_result.DeleteGroupResult:
    out: capo_xray.types.delete_group_result.DeleteGroupResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteGroup"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_xray.types.delete_group_request.serialize_json(input_)
    ).encode()
...
def delete_group(
    ...
    input_: capo_xray.types.delete_group_request.DeleteGroupRequest,
) -> tuple[capo_xray.types.delete_group_result.DeleteGroupResult, zapros.Response]:
