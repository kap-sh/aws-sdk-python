"""Generated from Smithy shape ``com.amazonaws.xray#GetSamplingRules``."""
...
import capo_xray.types.get_sampling_rules_request
import capo_xray.types.get_sampling_rules_result
...
) -> capo_xray.types.get_sampling_rules_result.GetSamplingRulesResult:
    out: capo_xray.types.get_sampling_rules_result.GetSamplingRulesResult = (
        capo_xray.types.get_sampling_rules_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GetSamplingRules"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_xray.types.get_sampling_rules_request.serialize_json(input_)
    ).encode()
...
def get_sampling_rules(
    ...
    capo_xray.types.get_sampling_rules_result.GetSamplingRulesResult, zapros.Response
]:
...
async def async_get_sampling_rules(
