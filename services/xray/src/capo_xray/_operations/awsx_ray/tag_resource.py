"""Generated from Smithy shape ``com.amazonaws.xray#TagResource``."""
...
import capo_xray.errors.too_many_tags_exception
import capo_xray.types.tag_list
import capo_xray.types.tag_resource_request
import capo_xray.types.tag_resource_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            raise capo_xray.errors.too_many_tags_exception.TooManyTagsException.from_json(
                data
            )
        case _:
...
) -> capo_xray.types.tag_resource_response.TagResourceResponse:
    out: capo_xray.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_xray.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    input_: capo_xray.types.tag_resource_request.TagResourceRequest,
) -> tuple[capo_xray.types.tag_resource_response.TagResourceResponse, zapros.Response]:
