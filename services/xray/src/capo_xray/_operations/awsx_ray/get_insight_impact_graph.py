"""Generated from Smithy shape ``com.amazonaws.xray#GetInsightImpactGraph``."""
...
import capo_xray.types.get_insight_impact_graph_request
import capo_xray.types.get_insight_impact_graph_result
...
) -> capo_xray.types.get_insight_impact_graph_result.GetInsightImpactGraphResult:
    out: capo_xray.types.get_insight_impact_graph_result.GetInsightImpactGraphResult = (
        capo_xray.types.get_insight_impact_graph_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/InsightImpactGraph"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_xray.types.get_insight_impact_graph_request.serialize_json(input_)
    ).encode()
...
async def async_get_insight_impact_graph(
