"""Generated from Smithy shape ``com.amazonaws.xray#UpdateIndexingRule``."""
...
import capo_xray.types.update_indexing_rule_request
import capo_xray.types.update_indexing_rule_result
...
) -> capo_xray.types.update_indexing_rule_result.UpdateIndexingRuleResult:
    out: capo_xray.types.update_indexing_rule_result.UpdateIndexingRuleResult = (
        capo_xray.types.update_indexing_rule_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/UpdateIndexingRule"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_xray.types.update_indexing_rule_request.serialize_json(input_)
    ).encode()
...
async def async_update_indexing_rule(
