"""Generated from Smithy shape ``com.amazonaws.xray#GetInsightEvents``."""
...
import capo_xray.types.get_insight_events_request
import capo_xray.types.get_insight_events_result
...
) -> capo_xray.types.get_insight_events_result.GetInsightEventsResult:
    out: capo_xray.types.get_insight_events_result.GetInsightEventsResult = (
        capo_xray.types.get_insight_events_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/InsightEvents"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_xray.types.get_insight_events_request.serialize_json(input_)
    ).encode()
...
def get_insight_events(
    ...
    capo_xray.types.get_insight_events_result.GetInsightEventsResult, zapros.Response
]:
...
async def async_get_insight_events(
