"""Generated from Smithy shape ``com.amazonaws.xray#GetInsightSummaries``."""
...
import capo_xray.types.get_insight_summaries_request
import capo_xray.types.get_insight_summaries_result
...
) -> capo_xray.types.get_insight_summaries_result.GetInsightSummariesResult:
    out: capo_xray.types.get_insight_summaries_result.GetInsightSummariesResult = (
        capo_xray.types.get_insight_summaries_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/InsightSummaries"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_xray.types.get_insight_summaries_request.serialize_json(input_)
    ).encode()
...
async def async_get_insight_summaries(
