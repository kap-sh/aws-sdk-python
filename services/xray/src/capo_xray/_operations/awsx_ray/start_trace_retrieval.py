"""Generated from Smithy shape ``com.amazonaws.xray#StartTraceRetrieval``."""
...
import capo_xray.types.start_trace_retrieval_request
import capo_xray.types.start_trace_retrieval_result
...
) -> capo_xray.types.start_trace_retrieval_result.StartTraceRetrievalResult:
    out: capo_xray.types.start_trace_retrieval_result.StartTraceRetrievalResult = (
        capo_xray.types.start_trace_retrieval_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/StartTraceRetrieval"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_xray.types.start_trace_retrieval_request.serialize_json(input_)
    ).encode()
...
async def async_start_trace_retrieval(
