"""Generated from Smithy shape ``com.amazonaws.xray#ListRetrievedTraces``."""
...
import capo_xray.types.list_retrieved_traces_request
import capo_xray.types.list_retrieved_traces_result
...
) -> capo_xray.types.list_retrieved_traces_result.ListRetrievedTracesResult:
    out: capo_xray.types.list_retrieved_traces_result.ListRetrievedTracesResult = (
        capo_xray.types.list_retrieved_traces_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ListRetrievedTraces"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_xray.types.list_retrieved_traces_request.serialize_json(input_)
    ).encode()
...
async def async_list_retrieved_traces(
