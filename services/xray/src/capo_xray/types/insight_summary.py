...
class InsightSummary(TypedDict, closed=True):
    ...
    last_update_time: NotRequired["capo_xray.types.timestamp.Timestamp"]
...
def serialize_json(value: InsightSummary) -> dict:
    ...
    if "last_update_time" in value:
        ...
        out["LastUpdateTime"] = capo_xray.types.timestamp.serialize_json(
...
def deserialize_json(data: dict) -> InsightSummary:
    ...
    if "LastUpdateTime" in data:
        ...
        out["last_update_time"] = capo_xray.types.timestamp.deserialize_json(
            data["LastUpdateTime"]
        )
    return out
