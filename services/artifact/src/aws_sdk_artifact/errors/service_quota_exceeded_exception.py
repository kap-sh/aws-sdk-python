"""Generated from Smithy shape ``com.amazonaws.artifact#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.artifact#ServiceQuotaExceededException``."""
