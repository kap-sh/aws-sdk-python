...
def resolve(p: EndpointParams) -> Endpoint:  # type: ignore
    ...
    if p.Region is not None:
        ...
        if _locals["PartitionResult"] is not None:
                ...
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            return Endpoint(
                                url=interpolate(
                                    "https://artifact-fips.{PartitionResult#implicitGlobalRegion}.{PartitionResult#dualStackDnsSuffix}",
                                    p,
                                    _locals,
                                ),
                                properties={
            ...
            if p.UseFIPS is True:
                if p.UseDualStack is False:
                    if (
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://artifact-fips.{PartitionResult#implicitGlobalRegion}.{PartitionResult#dnsSuffix}",
                                p,
                                _locals,
                            ),
                            properties={
            ...
            if p.UseFIPS is False:
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://artifact.{PartitionResult#implicitGlobalRegion}.{PartitionResult#dualStackDnsSuffix}",
                                p,
                                _locals,
                            ),
                            properties={
            ...
            return Endpoint(
                url=interpolate(
                    "https://artifact.{PartitionResult#implicitGlobalRegion}.{PartitionResult#dnsSuffix}",
                    p,
                    _locals,
                ),
                properties={
