...
class ArtifactError(Exception):
    """Base class for all Artifact service errors."""


class ServiceError(ArtifactError):
...
class SerializationError(ArtifactError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ArtifactError):
...
class WaiterFailedError(ArtifactError):
...
class WaiterTimeoutError(ArtifactError):
