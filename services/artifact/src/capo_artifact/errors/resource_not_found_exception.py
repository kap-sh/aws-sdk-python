"""Generated from Smithy shape ``com.amazonaws.artifact#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.artifact#ResourceNotFoundException``."""
