...
```
pip install aws-sdk-emr-containers
```

## Usage

```python
from aws_sdk_emr_containers import AsyncEMRcontainersClient
...
```python
from aws_sdk_emr_containers import AsyncEMRcontainersClient
from aws_sdk_emr_containers.error import InternalServerException
