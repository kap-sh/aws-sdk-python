"""Generated from Smithy shape ``com.amazonaws.emrcontainers#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.emrcontainers#ResourceNotFoundException``."""
