"""Generated from Smithy shape ``com.amazonaws.emrcontainers#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.emrcontainers#ValidationException``."""
