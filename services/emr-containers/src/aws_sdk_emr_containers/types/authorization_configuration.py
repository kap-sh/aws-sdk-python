...
if TYPE_CHECKING:
    import aws_sdk_emr_containers.types.encryption_configuration
    import aws_sdk_emr_containers.types.lake_formation_configuration


class AuthorizationConfiguration(TypedDict):
    lake_formation_configuration: NotRequired[
        "aws_sdk_emr_containers.types.lake_formation_configuration.LakeFormationConfiguration"
    ]
    """<p>Lake Formation related configuration inputs for the security configuration.</p>"""
    encryption_configuration: NotRequired[
        "aws_sdk_emr_containers.types.encryption_configuration.EncryptionConfiguration"
    ]
...
def serialize_json(value: AuthorizationConfiguration) -> dict:
    ...
    if "lake_formation_configuration" in value:
        ...
        out["lakeFormationConfiguration"] = (
            aws_sdk_emr_containers.types.lake_formation_configuration.serialize_json(
    ...
    if "encryption_configuration" in value:
        ...
        out["encryptionConfiguration"] = (
            aws_sdk_emr_containers.types.encryption_configuration.serialize_json(
...
def deserialize_json(data: dict) -> AuthorizationConfiguration:
    ...
    if "lakeFormationConfiguration" in data:
        ...
        out["lake_formation_configuration"] = (
            aws_sdk_emr_containers.types.lake_formation_configuration.deserialize_json(
    ...
    if "encryptionConfiguration" in data:
        ...
        out["encryption_configuration"] = (
            aws_sdk_emr_containers.types.encryption_configuration.deserialize_json(
