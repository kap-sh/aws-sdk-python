...
if TYPE_CHECKING:
    ...
    import aws_sdk_emr_containers.types.secure_namespace_info
    import aws_sdk_emr_containers.types.session_tag_value


class LakeFormationConfiguration(TypedDict):
    authorized_session_tag_value: NotRequired[
        "aws_sdk_emr_containers.types.session_tag_value.SessionTagValue"
    ]
    """<p>The session tag to authorize Amazon EMR on EKS for API calls to Lake Formation.</p>"""
    secure_namespace_info: NotRequired[
        "aws_sdk_emr_containers.types.secure_namespace_info.SecureNamespaceInfo"
    ]
...
def serialize_json(value: LakeFormationConfiguration) -> dict:
    ...
    if "secure_namespace_info" in value:
        ...
        out["secureNamespaceInfo"] = (
            aws_sdk_emr_containers.types.secure_namespace_info.serialize_json(
...
def deserialize_json(data: dict) -> LakeFormationConfiguration:
    ...
    if "secureNamespaceInfo" in data:
        ...
        out["secure_namespace_info"] = (
            aws_sdk_emr_containers.types.secure_namespace_info.deserialize_json(
