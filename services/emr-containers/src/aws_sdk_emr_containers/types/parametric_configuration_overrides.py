...
if TYPE_CHECKING:
    ...
    import aws_sdk_emr_containers.types.parametric_monitoring_configuration


class ParametricConfigurationOverrides(TypedDict):
    ...
    monitoring_configuration: NotRequired[
        "aws_sdk_emr_containers.types.parametric_monitoring_configuration.ParametricMonitoringConfiguration"
    ]
...
def serialize_json(value: ParametricConfigurationOverrides) -> dict:
    ...
    if "monitoring_configuration" in value:
        ...
        out["monitoringConfiguration"] = (
            aws_sdk_emr_containers.types.parametric_monitoring_configuration.serialize_json(
...
def deserialize_json(data: dict) -> ParametricConfigurationOverrides:
    ...
    if "monitoringConfiguration" in data:
        ...
        out["monitoring_configuration"] = (
            aws_sdk_emr_containers.types.parametric_monitoring_configuration.deserialize_json(
