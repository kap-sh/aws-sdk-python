...
if TYPE_CHECKING:
    ...
    import aws_sdk_emr_containers.types.string_empty256

TagMap: TypeAlias = dict[
    "aws_sdk_emr_containers.types.string128.String128",
    "aws_sdk_emr_containers.types.string_empty256.StringEmpty256",
]
