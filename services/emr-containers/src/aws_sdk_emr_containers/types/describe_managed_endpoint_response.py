...
class DescribeManagedEndpointResponse(TypedDict):
    endpoint: NotRequired["aws_sdk_emr_containers.types.endpoint.Endpoint"]
...
def serialize_json(value: DescribeManagedEndpointResponse) -> dict:
    ...
    if "endpoint" in value:
        ...
        out["endpoint"] = aws_sdk_emr_containers.types.endpoint.serialize_json(
            value["endpoint"]
        )
    return out
...
def deserialize_json(data: dict) -> DescribeManagedEndpointResponse:
    ...
    if "endpoint" in data:
        ...
        out["endpoint"] = aws_sdk_emr_containers.types.endpoint.deserialize_json(
            data["endpoint"]
        )
    return out
