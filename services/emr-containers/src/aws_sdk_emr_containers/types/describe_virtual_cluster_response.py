...
class DescribeVirtualClusterResponse(TypedDict):
...
def serialize_json(value: DescribeVirtualClusterResponse) -> dict:
    ...
    if "virtual_cluster" in value:
        ...
        out["virtualCluster"] = (
            aws_sdk_emr_containers.types.virtual_cluster.serialize_json(
...
def deserialize_json(data: dict) -> DescribeVirtualClusterResponse:
    ...
    if "virtualCluster" in data:
        ...
        out["virtual_cluster"] = (
            aws_sdk_emr_containers.types.virtual_cluster.deserialize_json(
                data["virtualCluster"]
            )
        )
    return out
