...
from aws_sdk_emr_containers._services._aws_config import aaws_config
...
class AsyncEMRcontainersClientConfig(TypedDict, total=False):
...
class AsyncEMRcontainersClient:
    ...
    async def cancel_job_run(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.cancel_job_run_request.CancelJobRunRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.cancel_job_run_response.CancelJobRunResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.cancel_job_run.async_cancel_job_run(
    ...
    async def create_job_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.create_job_template_request.CreateJobTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.create_job_template_response.CreateJobTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.create_job_template.async_create_job_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_managed_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.create_managed_endpoint_request.CreateManagedEndpointRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.create_managed_endpoint_response.CreateManagedEndpointResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.create_managed_endpoint.async_create_managed_endpoint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_security_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.create_security_configuration_request.CreateSecurityConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.create_security_configuration_response.CreateSecurityConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.create_security_configuration.async_create_security_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_virtual_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.create_virtual_cluster_request.CreateVirtualClusterRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.create_virtual_cluster_response.CreateVirtualClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.create_virtual_cluster.async_create_virtual_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_job_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.delete_job_template_request.DeleteJobTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.delete_job_template_response.DeleteJobTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.delete_job_template.async_delete_job_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_managed_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.delete_managed_endpoint_request.DeleteManagedEndpointRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.delete_managed_endpoint_response.DeleteManagedEndpointResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.delete_managed_endpoint.async_delete_managed_endpoint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_virtual_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.delete_virtual_cluster_request.DeleteVirtualClusterRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.delete_virtual_cluster_response.DeleteVirtualClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.delete_virtual_cluster.async_delete_virtual_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_job_run(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.describe_job_run_request.DescribeJobRunRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.describe_job_run_response.DescribeJobRunResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.describe_job_run.async_describe_job_run(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_job_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.describe_job_template_request.DescribeJobTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.describe_job_template_response.DescribeJobTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.describe_job_template.async_describe_job_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_managed_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.describe_managed_endpoint_request.DescribeManagedEndpointRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.describe_managed_endpoint_response.DescribeManagedEndpointResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.describe_managed_endpoint.async_describe_managed_endpoint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_security_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.describe_security_configuration_request.DescribeSecurityConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.describe_security_configuration_response.DescribeSecurityConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.describe_security_configuration.async_describe_security_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_virtual_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.describe_virtual_cluster_request.DescribeVirtualClusterRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.describe_virtual_cluster_response.DescribeVirtualClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.describe_virtual_cluster.async_describe_virtual_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_managed_endpoint_session_credentials(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.get_managed_endpoint_session_credentials_request.GetManagedEndpointSessionCredentialsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.get_managed_endpoint_session_credentials_response.GetManagedEndpointSessionCredentialsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.get_managed_endpoint_session_credentials.async_get_managed_endpoint_session_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_job_runs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.list_job_runs_request.ListJobRunsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.list_job_runs_response.ListJobRunsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.list_job_runs.async_list_job_runs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_emr_containers.types.job_run.JobRun]":
        _token = next_token
        while True:
    ...
    async def list_job_templates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.list_job_templates_request.ListJobTemplatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.list_job_templates_response.ListJobTemplatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.list_job_templates.async_list_job_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_emr_containers.types.job_template.JobTemplate]":
        _token = next_token
        while True:
    ...
    async def list_managed_endpoints(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.list_managed_endpoints_request.ListManagedEndpointsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.list_managed_endpoints_response.ListManagedEndpointsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.list_managed_endpoints.async_list_managed_endpoints(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_emr_containers.types.endpoint.Endpoint]":
        _token = next_token
        while True:
    ...
    async def list_security_configurations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.list_security_configurations_request.ListSecurityConfigurationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.list_security_configurations_response.ListSecurityConfigurationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.list_security_configurations.async_list_security_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_emr_containers.types.security_configuration.SecurityConfiguration]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_virtual_clusters(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.list_virtual_clusters_request.ListVirtualClustersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.list_virtual_clusters_response.ListVirtualClustersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.list_virtual_clusters.async_list_virtual_clusters(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_emr_containers.types.virtual_cluster.VirtualCluster]":
        _token = next_token
        while True:
    ...
    async def start_job_run(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.start_job_run_request.StartJobRunRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.start_job_run_response.StartJobRunResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.start_job_run.async_start_job_run(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_containers.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_containers.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_containers._operations.aws_chicago_web_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
