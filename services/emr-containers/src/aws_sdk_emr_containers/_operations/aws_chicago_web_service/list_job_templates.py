"""Generated from Smithy shape ``com.amazonaws.emrcontainers#ListJobTemplates``."""
...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.list_job_templates_response.ListJobTemplatesResponse = aws_sdk_emr_containers.types.list_job_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.list_job_templates_request.ListJobTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
