...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.list_managed_endpoints_response.ListManagedEndpointsResponse = aws_sdk_emr_containers.types.list_managed_endpoints_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.list_managed_endpoints_request.ListManagedEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
