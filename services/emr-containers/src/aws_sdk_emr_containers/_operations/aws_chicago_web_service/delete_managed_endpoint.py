"""Generated from Smithy shape ``com.amazonaws.emrcontainers#DeleteManagedEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.delete_managed_endpoint_response.DeleteManagedEndpointResponse = aws_sdk_emr_containers.types.delete_managed_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.delete_managed_endpoint_request.DeleteManagedEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_managed_endpoint(
