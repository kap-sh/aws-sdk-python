...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.delete_virtual_cluster_response.DeleteVirtualClusterResponse = aws_sdk_emr_containers.types.delete_virtual_cluster_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.delete_virtual_cluster_request.DeleteVirtualClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
