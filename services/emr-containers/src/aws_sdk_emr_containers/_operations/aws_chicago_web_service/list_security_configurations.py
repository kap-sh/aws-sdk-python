"""Generated from Smithy shape ``com.amazonaws.emrcontainers#ListSecurityConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.list_security_configurations_response.ListSecurityConfigurationsResponse = aws_sdk_emr_containers.types.list_security_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.list_security_configurations_request.ListSecurityConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/securityconfigurations"
    params: dict[str, str] = {}
