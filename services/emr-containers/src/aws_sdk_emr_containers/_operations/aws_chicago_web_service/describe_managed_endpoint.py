"""Generated from Smithy shape ``com.amazonaws.emrcontainers#DescribeManagedEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.describe_managed_endpoint_response.DescribeManagedEndpointResponse = aws_sdk_emr_containers.types.describe_managed_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.describe_managed_endpoint_request.DescribeManagedEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/virtualclusters/{virtualClusterId}/endpoints/{id}"
    )
...
async def async_describe_managed_endpoint(
