"""Generated from Smithy shape ``com.amazonaws.emrcontainers#GetManagedEndpointSessionCredentials``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RequestThrottledException":
            import aws_sdk_emr_containers.errors.request_throttled_exception

            raise aws_sdk_emr_containers.errors.request_throttled_exception.RequestThrottledException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.get_managed_endpoint_session_credentials_response.GetManagedEndpointSessionCredentialsResponse = aws_sdk_emr_containers.types.get_managed_endpoint_session_credentials_response.deserialize_json(
