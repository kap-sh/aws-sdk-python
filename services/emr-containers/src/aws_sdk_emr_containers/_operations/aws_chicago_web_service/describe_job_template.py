...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.describe_job_template_response.DescribeJobTemplateResponse = aws_sdk_emr_containers.types.describe_job_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.describe_job_template_request.DescribeJobTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
