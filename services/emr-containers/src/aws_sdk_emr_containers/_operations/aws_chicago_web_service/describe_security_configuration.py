"""Generated from Smithy shape ``com.amazonaws.emrcontainers#DescribeSecurityConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.describe_security_configuration_response.DescribeSecurityConfigurationResponse = aws_sdk_emr_containers.types.describe_security_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.describe_security_configuration_request.DescribeSecurityConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/securityconfigurations/{id}"
