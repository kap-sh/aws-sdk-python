"""Generated from Smithy shape ``com.amazonaws.emrcontainers#CreateJobTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.create_job_template_response.CreateJobTemplateResponse = aws_sdk_emr_containers.types.create_job_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.create_job_template_request.CreateJobTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/jobtemplates"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_emr_containers.types.create_job_template_request

    body: bytes | None = json.dumps(
        aws_sdk_emr_containers.types.create_job_template_request.serialize_json(input_)
    ).encode()
...
async def async_create_job_template(
