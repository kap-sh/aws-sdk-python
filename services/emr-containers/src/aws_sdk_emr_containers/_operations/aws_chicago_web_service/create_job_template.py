...
def build_request(
    ...
    input: aws_sdk_emr_containers.types.create_job_template_request.CreateJobTemplateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr_containers.types.create_job_template_request.serialize_json(input)
    ).encode()
