...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.create_security_configuration_response.CreateSecurityConfigurationResponse = aws_sdk_emr_containers.types.create_security_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.create_security_configuration_request.CreateSecurityConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr_containers.types.create_security_configuration_request.serialize_json(
            input_
        )
    ).encode()
