"""Generated from Smithy shape ``com.amazonaws.emrcontainers#CreateManagedEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.create_managed_endpoint_response.CreateManagedEndpointResponse = aws_sdk_emr_containers.types.create_managed_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.create_managed_endpoint_request.CreateManagedEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/virtualclusters/{virtualClusterId}/endpoints"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr_containers.types.create_managed_endpoint_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_managed_endpoint(
