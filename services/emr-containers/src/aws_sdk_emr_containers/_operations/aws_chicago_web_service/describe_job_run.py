...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.describe_job_run_response.DescribeJobRunResponse = aws_sdk_emr_containers.types.describe_job_run_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.describe_job_run_request.DescribeJobRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
