"""Generated from Smithy shape ``com.amazonaws.emrcontainers#CancelJobRun``."""
...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.cancel_job_run_response.CancelJobRunResponse = (
        aws_sdk_emr_containers.types.cancel_job_run_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.cancel_job_run_request.CancelJobRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/virtualclusters/{virtualClusterId}/jobruns/{id}"
