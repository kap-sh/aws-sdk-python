...
import aws_sdk_emr_containers.errors.eks_request_throttled_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "EKSRequestThrottledException":
            raise aws_sdk_emr_containers.errors.eks_request_throttled_exception.EKSRequestThrottledException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_emr_containers.types.create_virtual_cluster_response.CreateVirtualClusterResponse = aws_sdk_emr_containers.types.create_virtual_cluster_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_containers.types.create_virtual_cluster_request.CreateVirtualClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
