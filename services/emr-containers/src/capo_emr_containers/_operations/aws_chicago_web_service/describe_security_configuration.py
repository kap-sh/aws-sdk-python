...
def handle_response(
    ...
    out: capo_emr_containers.types.describe_security_configuration_response.DescribeSecurityConfigurationResponse = capo_emr_containers.types.describe_security_configuration_response.deserialize_json(
