...
def handle_response(
    ...
    out: capo_emr_containers.types.create_managed_endpoint_response.CreateManagedEndpointResponse = capo_emr_containers.types.create_managed_endpoint_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr_containers.types.create_managed_endpoint_request.serialize_json(input_)
    ).encode()
