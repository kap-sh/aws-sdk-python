"""Generated from Smithy shape ``com.amazonaws.emrcontainers#DescribeJobRun``."""
...
def handle_response(
    ...
    out: capo_emr_containers.types.describe_job_run_response.DescribeJobRunResponse = (
        capo_emr_containers.types.describe_job_run_response.deserialize_json(
