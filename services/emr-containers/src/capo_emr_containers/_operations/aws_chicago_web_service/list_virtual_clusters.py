...
def handle_response(
    ...
    out: capo_emr_containers.types.list_virtual_clusters_response.ListVirtualClustersResponse = capo_emr_containers.types.list_virtual_clusters_response.deserialize_json(
