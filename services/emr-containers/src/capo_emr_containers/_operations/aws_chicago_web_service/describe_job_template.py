"""Generated from Smithy shape ``com.amazonaws.emrcontainers#DescribeJobTemplate``."""
...
def handle_response(
    ...
    out: capo_emr_containers.types.describe_job_template_response.DescribeJobTemplateResponse = capo_emr_containers.types.describe_job_template_response.deserialize_json(
