"""Generated from Smithy shape ``com.amazonaws.emrcontainers#CreateVirtualCluster``."""
...
import capo_emr_containers.errors.eks_request_throttled_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "EKSRequestThrottledException":
            raise capo_emr_containers.errors.eks_request_throttled_exception.EKSRequestThrottledException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_emr_containers.types.create_virtual_cluster_response.CreateVirtualClusterResponse = capo_emr_containers.types.create_virtual_cluster_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr_containers.types.create_virtual_cluster_request.serialize_json(input_)
    ).encode()
...
async def async_create_virtual_cluster(
