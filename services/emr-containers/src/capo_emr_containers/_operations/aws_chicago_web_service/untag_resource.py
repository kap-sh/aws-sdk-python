"""Generated from Smithy shape ``com.amazonaws.emrcontainers#UntagResource``."""
...
def handle_response(
    ...
    out: capo_emr_containers.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
