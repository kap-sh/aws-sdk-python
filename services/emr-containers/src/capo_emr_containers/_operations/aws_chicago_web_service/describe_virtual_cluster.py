"""Generated from Smithy shape ``com.amazonaws.emrcontainers#DescribeVirtualCluster``."""
...
def handle_response(
    ...
    out: capo_emr_containers.types.describe_virtual_cluster_response.DescribeVirtualClusterResponse = capo_emr_containers.types.describe_virtual_cluster_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/virtualclusters/{id}"
...
async def async_describe_virtual_cluster(
