...
def handle_response(
    ...
    out: capo_emr_containers.types.delete_managed_endpoint_response.DeleteManagedEndpointResponse = capo_emr_containers.types.delete_managed_endpoint_response.deserialize_json(
