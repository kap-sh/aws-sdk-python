...
def handle_response(
    ...
    out: capo_emr_containers.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_emr_containers.types.list_tags_for_resource_response.deserialize_json(
