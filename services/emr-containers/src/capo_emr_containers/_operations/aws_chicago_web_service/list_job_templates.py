...
def handle_response(
    ...
    out: capo_emr_containers.types.list_job_templates_response.ListJobTemplatesResponse = capo_emr_containers.types.list_job_templates_response.deserialize_json(
