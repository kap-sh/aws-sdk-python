...
def handle_response(
    ...
    out: capo_emr_containers.types.delete_job_template_response.DeleteJobTemplateResponse = capo_emr_containers.types.delete_job_template_response.deserialize_json(
