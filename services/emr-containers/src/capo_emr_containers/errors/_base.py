...
class EMRcontainersError(Exception):
    """Base class for all EMRcontainers service errors."""


class ServiceError(EMRcontainersError):
...
class SerializationError(EMRcontainersError):
    """Raised when a value cannot be serialized."""


class DeserializationError(EMRcontainersError):
...
class WaiterFailedError(EMRcontainersError):
...
class WaiterTimeoutError(EMRcontainersError):
