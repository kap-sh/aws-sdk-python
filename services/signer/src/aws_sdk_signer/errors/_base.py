...
class signerError(Exception):
    """Base class for all signer service errors."""


class ServiceError(signerError):
...
class SerializationError(signerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(signerError):
...
class WaiterFailedError(signerError):
...
class WaiterTimeoutError(signerError):
