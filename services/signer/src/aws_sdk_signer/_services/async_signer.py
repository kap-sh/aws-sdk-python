...
from aws_sdk_signer._services._aws_config import aaws_config
...
class AsyncsignerClientConfig(TypedDict, total=False, closed=True):
...
class AsyncsignerClient:
    ...
    def __init__(
        ...
        self._config = AsyncsignerClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncsignerClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncsignerClientConfig = config_overrides or {}
    ...
    async def add_profile_permission(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.add_profile_permission_request.AddProfilePermissionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.add_profile_permission_response.AddProfilePermissionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.add_profile_permission.async_add_profile_permission(
    ...
    async def cancel_signing_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.cancel_signing_profile_request.CancelSigningProfileRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.cancel_signing_profile.async_cancel_signing_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_signing_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.describe_signing_job_request.DescribeSigningJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.describe_signing_job_response.DescribeSigningJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.describe_signing_job.async_describe_signing_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_revocation_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.get_revocation_status_request.GetRevocationStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.get_revocation_status_response.GetRevocationStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.get_revocation_status.async_get_revocation_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_signing_platform(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.get_signing_platform_request.GetSigningPlatformRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.get_signing_platform_response.GetSigningPlatformResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.get_signing_platform.async_get_signing_platform(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_signing_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.get_signing_profile_request.GetSigningProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.get_signing_profile_response.GetSigningProfileResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.get_signing_profile.async_get_signing_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_profile_permissions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.list_profile_permissions_request.ListProfilePermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.list_profile_permissions_response.ListProfilePermissionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.list_profile_permissions.async_list_profile_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_signing_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.list_signing_jobs_request.ListSigningJobsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.list_signing_jobs_response.ListSigningJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.list_signing_jobs.async_list_signing_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_signing_platforms(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.list_signing_platforms_request.ListSigningPlatformsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.list_signing_platforms_response.ListSigningPlatformsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.list_signing_platforms.async_list_signing_platforms(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_signing_profiles(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.list_signing_profiles_request.ListSigningProfilesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.list_signing_profiles_response.ListSigningProfilesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.list_signing_profiles.async_list_signing_profiles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_signing_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.put_signing_profile_request.PutSigningProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.put_signing_profile_response.PutSigningProfileResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.put_signing_profile.async_put_signing_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_profile_permission(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.remove_profile_permission_request.RemoveProfilePermissionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.remove_profile_permission_response.RemoveProfilePermissionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.remove_profile_permission.async_remove_profile_permission(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def revoke_signature(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.revoke_signature_request.RevokeSignatureRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.revoke_signature.async_revoke_signature(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def revoke_signing_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.revoke_signing_profile_request.RevokeSigningProfileRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.revoke_signing_profile.async_revoke_signing_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def sign_payload(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.sign_payload_request.SignPayloadRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.sign_payload_response.SignPayloadResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.sign_payload.async_sign_payload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_signing_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.start_signing_job_request.StartSigningJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.start_signing_job_response.StartSigningJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.start_signing_job.async_start_signing_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_signer.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_signer.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_signer._operations.wallaby_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
