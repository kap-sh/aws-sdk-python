...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_signer.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceLimitExceededException":
            raise aws_sdk_signer.errors.service_limit_exceeded_exception.ServiceLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_signer.types.add_profile_permission_response.AddProfilePermissionResponse = aws_sdk_signer.types.add_profile_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_signer.types.add_profile_permission_request.AddProfilePermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_signer.types.add_profile_permission_request.serialize_json(input_)
    ).encode()
