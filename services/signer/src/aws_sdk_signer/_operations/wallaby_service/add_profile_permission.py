...
def build_request(
    ...
    input: aws_sdk_signer.types.add_profile_permission_request.AddProfilePermissionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_signer.types.add_profile_permission_request.serialize_json(input)
    ).encode()
