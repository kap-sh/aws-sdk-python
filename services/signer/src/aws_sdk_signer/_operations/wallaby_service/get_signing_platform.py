...
def handle_response(
    ...
    out: aws_sdk_signer.types.get_signing_platform_response.GetSigningPlatformResponse = aws_sdk_signer.types.get_signing_platform_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_signer.types.get_signing_platform_request.GetSigningPlatformRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{platformId}", quote(str(input_["platform_id"]), safe=""))
    params: dict[str, str] = {}
