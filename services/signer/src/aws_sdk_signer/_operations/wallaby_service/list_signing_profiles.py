...
def build_request(
    ...
    input: aws_sdk_signer.types.list_signing_profiles_request.ListSigningProfilesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    params["includeCanceled"] = str(input.get("include_canceled", False))
    ...
    if "statuses" in input:
        params["statuses"] = str(input["statuses"])
