"""Generated from Smithy shape ``com.amazonaws.signer#ListSigningProfiles``."""
...
def handle_response(
    ...
    out: aws_sdk_signer.types.list_signing_profiles_response.ListSigningProfilesResponse = aws_sdk_signer.types.list_signing_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_signer.types.list_signing_profiles_request.ListSigningProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/signing-profiles"
    params: dict[str, str] = {}
    params["includeCanceled"] = str(input_.get("include_canceled", False))
...
async def async_list_signing_profiles(
