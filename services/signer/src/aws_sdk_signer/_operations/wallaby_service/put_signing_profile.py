...
def build_request(
    ...
    input_: aws_sdk_signer.types.put_signing_profile_request.PutSigningProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_signer.types.put_signing_profile_request.serialize_json(input_)
    ).encode()
