...
def handle_response(
    ...
    out: aws_sdk_signer.types.get_signing_profile_response.GetSigningProfileResponse = (
        aws_sdk_signer.types.get_signing_profile_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_signer.types.get_signing_profile_request.GetSigningProfileRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "profile_owner" in input:
        params["profileOwner"] = str(input["profile_owner"])
