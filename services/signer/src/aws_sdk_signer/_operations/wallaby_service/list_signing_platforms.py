...
def handle_response(
    ...
    out: aws_sdk_signer.types.list_signing_platforms_response.ListSigningPlatformsResponse = aws_sdk_signer.types.list_signing_platforms_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_signer.types.list_signing_platforms_request.ListSigningPlatformsRequest,
) -> zapros.Request:
    ...
    if "partner" in input:
        params["partner"] = str(input["partner"])
    if "target" in input:
