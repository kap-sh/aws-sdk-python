"""Generated from Smithy shape ``com.amazonaws.signer#ListTagsForResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BadRequestException":
            import aws_sdk_signer.errors.bad_request_exception

            raise aws_sdk_signer.errors.bad_request_exception.BadRequestException.from_json(
                data
            )
        ...
        case "NotFoundException":
            import aws_sdk_signer.errors.not_found_exception

            raise aws_sdk_signer.errors.not_found_exception.NotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_signer.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_signer.types.list_tags_for_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_signer.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
