...
import aws_sdk_signer.types.blob
import aws_sdk_signer.types.metadata
...
def handle_response(
    ...
    out: aws_sdk_signer.types.sign_payload_response.SignPayloadResponse = (
        aws_sdk_signer.types.sign_payload_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_signer.types.sign_payload_request.SignPayloadRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_signer.types.sign_payload_request.serialize_json(input_)
    ).encode()
...
def sign_payload(
    ...
    aws_sdk_signer.types.sign_payload_response.SignPayloadResponse, zapros.Response
]:
