...
def handle_response(
    ...
    out: aws_sdk_signer.types.remove_profile_permission_response.RemoveProfilePermissionResponse = aws_sdk_signer.types.remove_profile_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_signer.types.remove_profile_permission_request.RemoveProfilePermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
