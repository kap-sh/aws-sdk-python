"""Generated from Smithy shape ``com.amazonaws.signer#StartSigningJob``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ThrottlingException":
            import aws_sdk_signer.errors.throttling_exception

            raise aws_sdk_signer.errors.throttling_exception.ThrottlingException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_signer.types.start_signing_job_response.StartSigningJobResponse = (
        aws_sdk_signer.types.start_signing_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_signer.types.start_signing_job_request.StartSigningJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_signer.types.start_signing_job_request.serialize_json(input_)
    ).encode()
...
async def async_start_signing_job(
