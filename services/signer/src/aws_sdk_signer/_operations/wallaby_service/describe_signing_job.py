"""Generated from Smithy shape ``com.amazonaws.signer#DescribeSigningJob``."""
...
def handle_response(
    ...
    out: aws_sdk_signer.types.describe_signing_job_response.DescribeSigningJobResponse = aws_sdk_signer.types.describe_signing_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_signer.types.describe_signing_job_request.DescribeSigningJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/signing-jobs/{jobId}"
...
async def async_describe_signing_job(
