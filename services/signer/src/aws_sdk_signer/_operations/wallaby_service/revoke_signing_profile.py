"""Generated from Smithy shape ``com.amazonaws.signer#RevokeSigningProfile``."""
...
def build_request(
    ...
    input: aws_sdk_signer.types.revoke_signing_profile_request.RevokeSigningProfileRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/signing-profiles/{profileName}/revoke"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_signer.types.revoke_signing_profile_request.serialize_json(input)
    ).encode()
...
async def async_revoke_signing_profile(
