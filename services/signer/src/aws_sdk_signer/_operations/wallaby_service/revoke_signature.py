"""Generated from Smithy shape ``com.amazonaws.signer#RevokeSignature``."""
...
def build_request(
    ...
    input_: aws_sdk_signer.types.revoke_signature_request.RevokeSignatureRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/signing-jobs/{jobId}/revoke"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_signer.types.revoke_signature_request.serialize_json(input_)
    ).encode()
...
async def async_revoke_signature(
