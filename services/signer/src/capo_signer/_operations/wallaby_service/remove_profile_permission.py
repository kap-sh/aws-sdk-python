"""Generated from Smithy shape ``com.amazonaws.signer#RemoveProfilePermission``."""
...
def handle_response(
    ...
    out: capo_signer.types.remove_profile_permission_response.RemoveProfilePermissionResponse = capo_signer.types.remove_profile_permission_response.deserialize_json(
...
async def async_remove_profile_permission(
