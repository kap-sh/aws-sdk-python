"""Generated from Smithy shape ``com.amazonaws.signer#GetSigningProfile``."""
...
def handle_response(
    ...
    out: capo_signer.types.get_signing_profile_response.GetSigningProfileResponse = (
        capo_signer.types.get_signing_profile_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "profile_owner" in input_:
        params["profileOwner"] = str(input_["profile_owner"])
...
async def async_get_signing_profile(
