...
def handle_response(
    ...
    out: capo_signer.types.list_profile_permissions_response.ListProfilePermissionsResponse = capo_signer.types.list_profile_permissions_response.deserialize_json(
