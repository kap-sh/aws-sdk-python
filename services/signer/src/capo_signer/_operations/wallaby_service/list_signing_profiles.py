...
import capo_signer.types.signing_profiles
...
def handle_response(
    ...
    out: capo_signer.types.list_signing_profiles_response.ListSigningProfilesResponse = capo_signer.types.list_signing_profiles_response.deserialize_json(
