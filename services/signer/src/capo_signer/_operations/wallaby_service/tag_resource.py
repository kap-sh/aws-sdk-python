"""Generated from Smithy shape ``com.amazonaws.signer#TagResource``."""
...
import capo_signer.errors.bad_request_exception
import capo_signer.errors.internal_service_error_exception
import capo_signer.errors.not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BadRequestException":
            raise capo_signer.errors.bad_request_exception.BadRequestException.from_json(
                data
            )
        ...
        case "NotFoundException":
            raise capo_signer.errors.not_found_exception.NotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_signer.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_signer.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_signer.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
