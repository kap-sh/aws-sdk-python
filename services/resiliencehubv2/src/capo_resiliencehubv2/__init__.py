...
from ._services.async_resiliencehubv2 import (
    Asyncresiliencehubv2Client as Asyncresiliencehubv2Client,
)
from ._services.resiliencehubv2 import resiliencehubv2Client as resiliencehubv2Client
