"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#ListSystems``."""
...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.list_systems_response.ListSystemsResponse = (
        capo_resiliencehubv2.types.list_systems_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/list-systems"
    params: dict[str, str] = {}
    if "ou_id" in input_:
