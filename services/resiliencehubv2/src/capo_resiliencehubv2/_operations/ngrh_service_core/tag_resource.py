"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#TagResource``."""
...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehubv2.types.tag_resource_request.serialize_json(input_)
    ).encode()
