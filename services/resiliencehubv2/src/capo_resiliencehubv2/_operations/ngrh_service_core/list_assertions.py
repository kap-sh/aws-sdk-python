"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#ListAssertions``."""
...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.list_assertions_response.ListAssertionsResponse = (
        capo_resiliencehubv2.types.list_assertions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/list-assertions"
    params: dict[str, str] = {}
...
async def async_list_assertions(
