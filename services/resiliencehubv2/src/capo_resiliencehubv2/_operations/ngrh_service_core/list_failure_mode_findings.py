...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.list_failure_mode_findings_response.ListFailureModeFindingsResponse = capo_resiliencehubv2.types.list_failure_mode_findings_response.deserialize_json(
