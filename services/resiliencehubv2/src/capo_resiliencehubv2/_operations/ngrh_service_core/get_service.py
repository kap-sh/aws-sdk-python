"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#GetService``."""
...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.get_service_response.GetServiceResponse = (
        capo_resiliencehubv2.types.get_service_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/get-service"
    params: dict[str, str] = {}
...
def get_service(
    ...
    capo_resiliencehubv2.types.get_service_response.GetServiceResponse, zapros.Response
]:
