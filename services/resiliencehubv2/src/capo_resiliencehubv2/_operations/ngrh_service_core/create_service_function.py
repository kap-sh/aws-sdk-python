...
import capo_resiliencehubv2.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_resiliencehubv2.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.create_service_function_response.CreateServiceFunctionResponse = capo_resiliencehubv2.types.create_service_function_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehubv2.types.create_service_function_request.serialize_json(
            input_
        )
    ).encode()
