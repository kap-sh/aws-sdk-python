...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.list_dependencies_response.ListDependenciesResponse = capo_resiliencehubv2.types.list_dependencies_response.deserialize_json(
