...
import capo_resiliencehubv2.errors.throttling_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ThrottlingException":
            raise capo_resiliencehubv2.errors.throttling_exception.ThrottlingException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.start_failure_mode_assessment_response.StartFailureModeAssessmentResponse = capo_resiliencehubv2.types.start_failure_mode_assessment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehubv2.types.start_failure_mode_assessment_request.serialize_json(
            input_
        )
    ).encode()
