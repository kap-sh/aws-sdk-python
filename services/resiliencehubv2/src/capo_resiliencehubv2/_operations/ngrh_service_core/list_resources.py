"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#ListResources``."""
...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.list_resources_response.ListResourcesResponse = (
        capo_resiliencehubv2.types.list_resources_response.deserialize_json(
