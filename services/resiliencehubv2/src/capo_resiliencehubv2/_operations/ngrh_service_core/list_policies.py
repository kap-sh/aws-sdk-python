...
import capo_resiliencehubv2.types.policy_summary_list
...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.list_policies_response.ListPoliciesResponse = (
        capo_resiliencehubv2.types.list_policies_response.deserialize_json(
