...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.delete_system_response.DeleteSystemResponse = (
        capo_resiliencehubv2.types.delete_system_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehubv2.types.delete_system_request.serialize_json(input_)
    ).encode()
