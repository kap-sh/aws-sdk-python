...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.create_system_response.CreateSystemResponse = (
        capo_resiliencehubv2.types.create_system_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehubv2.types.create_system_request.serialize_json(input_)
    ).encode()
