...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.create_service_response.CreateServiceResponse = (
        capo_resiliencehubv2.types.create_service_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehubv2.types.create_service_request.serialize_json(input_)
    ).encode()
