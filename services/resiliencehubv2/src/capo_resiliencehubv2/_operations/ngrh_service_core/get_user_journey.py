"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#GetUserJourney``."""
...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.get_user_journey_response.GetUserJourneyResponse = (
        capo_resiliencehubv2.types.get_user_journey_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/get-user-journey"
    params: dict[str, str] = {}
...
async def async_get_user_journey(
