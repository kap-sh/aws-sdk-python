...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.create_service_function_resources_response.CreateServiceFunctionResourcesResponse = capo_resiliencehubv2.types.create_service_function_resources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehubv2.types.create_service_function_resources_request.serialize_json(
            input_
        )
    ).encode()
