...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.get_policy_response.GetPolicyResponse = (
        capo_resiliencehubv2.types.get_policy_response.deserialize_json(
...
def get_policy(
    ...
    capo_resiliencehubv2.types.get_policy_response.GetPolicyResponse, zapros.Response
]:
