...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.update_assertion_response.UpdateAssertionResponse = capo_resiliencehubv2.types.update_assertion_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehubv2.types.update_assertion_request.serialize_json(input_)
    ).encode()
