"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#ListServiceFunctions``."""
...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.list_service_functions_response.ListServiceFunctionsResponse = capo_resiliencehubv2.types.list_service_functions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/list-functions"
    params: dict[str, str] = {}
...
async def async_list_service_functions(
