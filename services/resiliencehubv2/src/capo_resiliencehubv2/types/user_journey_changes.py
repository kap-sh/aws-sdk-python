...
class UserJourneyChanges(TypedDict, closed=True):
    journey_description: NotRequired[
        "capo_resiliencehubv2.types.string_change.StringChange"
    ]
    """<p>Changes to the user journey description.</p>"""
    associated_services: NotRequired[
        "capo_resiliencehubv2.types.service_reference_changes.ServiceReferenceChanges"
    ]
...
def serialize_json(value: UserJourneyChanges) -> dict:
    ...
    if "journey_description" in value:
        ...
        out["journeyDescription"] = (
            capo_resiliencehubv2.types.string_change.serialize_json(
    ...
    if "associated_services" in value:
        ...
        out["associatedServices"] = (
            capo_resiliencehubv2.types.service_reference_changes.serialize_json(
...
def deserialize_json(data: dict) -> UserJourneyChanges:
    ...
    if "journeyDescription" in data:
        ...
        out["journey_description"] = (
            capo_resiliencehubv2.types.string_change.deserialize_json(
    ...
    if "associatedServices" in data:
        ...
        out["associated_services"] = (
            capo_resiliencehubv2.types.service_reference_changes.deserialize_json(
