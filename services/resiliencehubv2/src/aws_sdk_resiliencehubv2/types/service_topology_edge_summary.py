...
if TYPE_CHECKING:
    import aws_sdk_resiliencehubv2.types.edge_property_list


class ServiceTopologyEdgeSummary(TypedDict):
    ...
    properties: NotRequired[
        "aws_sdk_resiliencehubv2.types.edge_property_list.EdgePropertyList"
    ]
...
def serialize_json(value: ServiceTopologyEdgeSummary) -> dict:
    ...
    if "properties" in value:
        ...
        out["properties"] = (
            aws_sdk_resiliencehubv2.types.edge_property_list.serialize_json(
                value["properties"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ServiceTopologyEdgeSummary:
    ...
    if "properties" in data:
        ...
        out["properties"] = (
            aws_sdk_resiliencehubv2.types.edge_property_list.deserialize_json(
                data["properties"]
            )
        )
    return out
