...
class ListServicesResponse(TypedDict, closed=True):
    service_summaries: (
        "aws_sdk_resiliencehubv2.types.service_summary_list.ServiceSummaryList"
    )
...
def serialize_json(value: ListServicesResponse) -> dict:
    ...
    out["serviceSummaries"] = (
        aws_sdk_resiliencehubv2.types.service_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListServicesResponse:
    ...
    if "serviceSummaries" in data:
        ...
        out["service_summaries"] = (
            aws_sdk_resiliencehubv2.types.service_summary_list.deserialize_json(
