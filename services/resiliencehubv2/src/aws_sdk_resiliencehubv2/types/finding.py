...
if TYPE_CHECKING:
    ...
    import aws_sdk_resiliencehubv2.types.functions_list
    import aws_sdk_resiliencehubv2.types.infrastructure_and_code_recommendations_list
    import aws_sdk_resiliencehubv2.types.observability_recommendations_list
    import aws_sdk_resiliencehubv2.types.policy_component
    import aws_sdk_resiliencehubv2.types.testing_recommendations_list
...
class Finding(TypedDict, closed=True):
    ...
    service_functions: NotRequired[
        "aws_sdk_resiliencehubv2.types.functions_list.FunctionsList"
    ]
    ...
    infrastructure_and_code_recommendations: NotRequired[
        "aws_sdk_resiliencehubv2.types.infrastructure_and_code_recommendations_list.InfrastructureAndCodeRecommendationsList"
    ]
    """<p>Infrastructure and code recommendations to address the finding.</p>"""
    observability_recommendations: NotRequired[
        "aws_sdk_resiliencehubv2.types.observability_recommendations_list.ObservabilityRecommendationsList"
    ]
    """<p>Observability recommendations to address the finding.</p>"""
    testing_recommendations: NotRequired[
        "aws_sdk_resiliencehubv2.types.testing_recommendations_list.TestingRecommendationsList"
    ]
...
def serialize_json(value: Finding) -> dict:
    ...
    if "service_functions" in value:
        ...
        out["serviceFunctions"] = (
            aws_sdk_resiliencehubv2.types.functions_list.serialize_json(
    ...
    if "infrastructure_and_code_recommendations" in value:
        ...
        out["infrastructureAndCodeRecommendations"] = (
            aws_sdk_resiliencehubv2.types.infrastructure_and_code_recommendations_list.serialize_json(
    ...
    if "observability_recommendations" in value:
        ...
        out["observabilityRecommendations"] = (
            aws_sdk_resiliencehubv2.types.observability_recommendations_list.serialize_json(
    ...
    if "testing_recommendations" in value:
        ...
        out["testingRecommendations"] = (
            aws_sdk_resiliencehubv2.types.testing_recommendations_list.serialize_json(
...
def deserialize_json(data: dict) -> Finding:
    ...
    if "serviceFunctions" in data:
        ...
        out["service_functions"] = (
            aws_sdk_resiliencehubv2.types.functions_list.deserialize_json(
    ...
    if "infrastructureAndCodeRecommendations" in data:
        ...
        out["infrastructure_and_code_recommendations"] = (
            aws_sdk_resiliencehubv2.types.infrastructure_and_code_recommendations_list.deserialize_json(
    ...
    if "observabilityRecommendations" in data:
        ...
        out["observability_recommendations"] = (
            aws_sdk_resiliencehubv2.types.observability_recommendations_list.deserialize_json(
    ...
    if "testingRecommendations" in data:
        ...
        out["testing_recommendations"] = (
            aws_sdk_resiliencehubv2.types.testing_recommendations_list.deserialize_json(
