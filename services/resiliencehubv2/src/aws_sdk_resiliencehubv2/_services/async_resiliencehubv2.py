...
class Asyncresiliencehubv2Client:
    ...
    def __init__(
        ...
        self._config = Asyncresiliencehubv2ClientConfig(
            {
        ...
        # resources
        self.iam_app_resource = AsyncIamAppResource(self)
        self.iam_policy_resource = AsyncIamPolicyResource(self)
        self.iam_resiliency_policy_resource = AsyncIamResiliencyPolicyResource(self)
        self.iam_service_resource = AsyncIamServiceResource(self)
        self.iam_system_resource = AsyncIamSystemResource(self)

    def operation_options(
        self, config_overrides: Optional[Asyncresiliencehubv2ClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: Asyncresiliencehubv2ClientConfig = config_overrides or {}
    ...
    async def create_assertion(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.create_assertion_request.CreateAssertionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.create_assertion_response.CreateAssertionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.create_assertion.async_create_assertion(
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.create_input_source.async_create_input_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.create_policy_request.CreatePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.create_policy_response.CreatePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.create_policy.async_create_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_report(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.create_report_request.CreateReportRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.create_report_response.CreateReportResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.create_report.async_create_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.create_service_request.CreateServiceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.create_service_response.CreateServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.create_service.async_create_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_service_function(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.create_service_function_request.CreateServiceFunctionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.create_service_function_response.CreateServiceFunctionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.create_service_function.async_create_service_function(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_service_function_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.create_service_function_resources_request.CreateServiceFunctionResourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.create_service_function_resources_response.CreateServiceFunctionResourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.create_service_function_resources.async_create_service_function_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_system(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.create_system_request.CreateSystemRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.create_system_response.CreateSystemResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.create_system.async_create_system(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.create_user_journey.async_create_user_journey(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_assertion(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.delete_assertion_request.DeleteAssertionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.delete_assertion_response.DeleteAssertionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.delete_assertion.async_delete_assertion(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_input_source(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.delete_input_source_request.DeleteInputSourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.delete_input_source_response.DeleteInputSourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.delete_input_source.async_delete_input_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.delete_policy.async_delete_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.delete_service.async_delete_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_service_function(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.delete_service_function_request.DeleteServiceFunctionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.delete_service_function_response.DeleteServiceFunctionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.delete_service_function.async_delete_service_function(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_service_function_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.delete_service_function_resources_request.DeleteServiceFunctionResourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.delete_service_function_resources_response.DeleteServiceFunctionResourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.delete_service_function_resources.async_delete_service_function_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.delete_system.async_delete_system(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user_journey(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.delete_user_journey_request.DeleteUserJourneyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.delete_user_journey_response.DeleteUserJourneyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.delete_user_journey.async_delete_user_journey(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_failure_mode_finding(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.get_failure_mode_finding_request.GetFailureModeFindingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.get_failure_mode_finding_response.GetFailureModeFindingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.get_failure_mode_finding.async_get_failure_mode_finding(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.get_policy.async_get_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.get_service.async_get_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.get_system.async_get_system(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_user_journey(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.get_user_journey_request.GetUserJourneyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.get_user_journey_response.GetUserJourneyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.get_user_journey.async_get_user_journey(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def import_app(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.import_app_request.ImportAppRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.import_app_response.ImportAppResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.import_app.async_import_app(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def import_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.import_policy_request.ImportPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.import_policy_response.ImportPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.import_policy.async_import_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_assertions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.list_assertions_request.ListAssertionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.list_assertions_response.ListAssertionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_assertions.async_list_assertions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_assertions(
        self,
        service_arn: "aws_sdk_resiliencehubv2.types.arn.Arn",
        *,
        config_overrides: Optional[Asyncresiliencehubv2ClientConfig] = None,
    ...
    ) -> "AsyncIterator[aws_sdk_resiliencehubv2.types.assertion.Assertion]":
        _token = next_token
        while True:
            _response = await self.list_assertions(
                service_arn,
    ...
    async def list_dependencies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.list_dependencies_request.ListDependenciesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.list_dependencies_response.ListDependenciesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_dependencies.async_list_dependencies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_dependencies(
        self,
        *,
        config_overrides: Optional[Asyncresiliencehubv2ClientConfig] = None,
        service_arn: Optional["aws_sdk_resiliencehubv2.types.arn.Arn"] = None,
    ...
    ) -> "AsyncIterator[aws_sdk_resiliencehubv2.types.dependency_summary.DependencySummary]":
        _token = next_token
        while True:
            _response = await self.list_dependencies(
                config_overrides=config_overrides,
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_failure_mode_assessments.async_list_failure_mode_assessments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_failure_mode_assessments(
        self,
        service_arn: "aws_sdk_resiliencehubv2.types.arn.Arn",
        *,
        config_overrides: Optional[Asyncresiliencehubv2ClientConfig] = None,
    ...
    ) -> "AsyncIterator[aws_sdk_resiliencehubv2.types.assessment_summary.AssessmentSummary]":
        _token = next_token
        while True:
            _response = await self.list_failure_mode_assessments(
                service_arn,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    async def list_failure_mode_findings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.list_failure_mode_findings_request.ListFailureModeFindingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.list_failure_mode_findings_response.ListFailureModeFindingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_failure_mode_findings.async_list_failure_mode_findings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_failure_mode_findings(
        self,
        service_arn: "aws_sdk_resiliencehubv2.types.arn.Arn",
        *,
        config_overrides: Optional[Asyncresiliencehubv2ClientConfig] = None,
    ...
    ) -> "AsyncIterator[aws_sdk_resiliencehubv2.types.finding_summary.FindingSummary]":
        _token = next_token
        while True:
            _response = await self.list_failure_mode_findings(
                service_arn,
                config_overrides=config_overrides,
                severity=severity,
    ...
    async def list_input_sources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.list_input_sources_request.ListInputSourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.list_input_sources_response.ListInputSourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_input_sources.async_list_input_sources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_input_sources(
        self,
        service_arn: "aws_sdk_resiliencehubv2.types.arn.Arn",
        *,
        config_overrides: Optional[Asyncresiliencehubv2ClientConfig] = None,
    ...
    ) -> "AsyncIterator[aws_sdk_resiliencehubv2.types.input_source_summary.InputSourceSummary]":
        _token = next_token
        while True:
            _response = await self.list_input_sources(
                service_arn,
                config_overrides=config_overrides,
                type=type,
                max_results=max_results,
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_policies.async_list_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_resiliencehubv2.types.policy_summary.PolicySummary]":
        _token = next_token
        while True:
    ...
    async def list_reports(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.list_reports_request.ListReportsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.list_reports_response.ListReportsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_reports.async_list_reports(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_resiliencehubv2.types.report_generation_result.ReportGenerationResult]":
        _token = next_token
        while True:
    ...
    async def list_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.list_resources_request.ListResourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.list_resources_response.ListResourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_resources.async_list_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_resources(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_resiliencehubv2.types.service_resource.ServiceResource]"
    ):
        _token = next_token
        while True:
    ...
    async def list_service_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.list_service_events_request.ListServiceEventsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.list_service_events_response.ListServiceEventsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_service_events.async_list_service_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_service_events(
        self,
        service_arn: "aws_sdk_resiliencehubv2.types.arn.Arn",
        *,
        config_overrides: Optional[Asyncresiliencehubv2ClientConfig] = None,
    ...
    ) -> "AsyncIterator[aws_sdk_resiliencehubv2.types.service_event.ServiceEvent]":
        _token = next_token
        while True:
            _response = await self.list_service_events(
                service_arn,
                config_overrides=config_overrides,
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_service_functions.async_list_service_functions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_service_functions(
        self,
        service_arn: "aws_sdk_resiliencehubv2.types.arn.Arn",
        *,
        config_overrides: Optional[Asyncresiliencehubv2ClientConfig] = None,
        ...
        "AsyncIterator[aws_sdk_resiliencehubv2.types.service_function.ServiceFunction]"
    ):
        _token = next_token
        while True:
            _response = await self.list_service_functions(
                service_arn,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    async def list_services(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.list_services_request.ListServicesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.list_services_response.ListServicesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_services.async_list_services(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_resiliencehubv2.types.service_summary.ServiceSummary]":
        _token = next_token
        while True:
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_service_topology_edges.async_list_service_topology_edges(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_service_topology_edges(
        self,
        service_arn: "aws_sdk_resiliencehubv2.types.arn.Arn",
        *,
        config_overrides: Optional[Asyncresiliencehubv2ClientConfig] = None,
    ...
    ) -> "AsyncIterator[aws_sdk_resiliencehubv2.types.service_topology_edge_summary.ServiceTopologyEdgeSummary]":
        _token = next_token
        while True:
            _response = await self.list_service_topology_edges(
                service_arn,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    async def list_system_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.list_system_events_request.ListSystemEventsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.list_system_events_response.ListSystemEventsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_system_events.async_list_system_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_system_events(
        self,
        system_arn: "aws_sdk_resiliencehubv2.types.arn.Arn",
        *,
        config_overrides: Optional[Asyncresiliencehubv2ClientConfig] = None,
    ...
    ) -> "AsyncIterator[aws_sdk_resiliencehubv2.types.system_event.SystemEvent]":
        _token = next_token
        while True:
            _response = await self.list_system_events(
                system_arn,
                config_overrides=config_overrides,
                event_types=event_types,
                start_time=start_time,
    ...
    async def list_systems(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.list_systems_request.ListSystemsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.list_systems_response.ListSystemsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_systems.async_list_systems(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_resiliencehubv2.types.system_summary.SystemSummary]":
        _token = next_token
        while True:
            _response = await self.list_systems(
                config_overrides=config_overrides,
                ou_id=ou_id,
                max_results=max_results,
                next_token=_token,
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.list_user_journeys.async_list_user_journeys(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_user_journeys(
        self,
        system_arn: "aws_sdk_resiliencehubv2.types.arn.Arn",
        *,
        config_overrides: Optional[Asyncresiliencehubv2ClientConfig] = None,
    ...
    ) -> "AsyncIterator[aws_sdk_resiliencehubv2.types.user_journey_summary.UserJourneySummary]":
        _token = next_token
        while True:
            _response = await self.list_user_journeys(
                system_arn,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.start_failure_mode_assessment.async_start_failure_mode_assessment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_assertion(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.update_assertion_request.UpdateAssertionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.update_assertion_response.UpdateAssertionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.update_assertion.async_update_assertion(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_dependency(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.update_dependency_request.UpdateDependencyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.update_dependency_response.UpdateDependencyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.update_dependency.async_update_dependency(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_failure_mode_finding(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.update_failure_mode_finding_request.UpdateFailureModeFindingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.update_failure_mode_finding_response.UpdateFailureModeFindingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.update_failure_mode_finding.async_update_failure_mode_finding(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.update_policy_request.UpdatePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.update_policy_response.UpdatePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.update_policy.async_update_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.update_service_request.UpdateServiceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.update_service_response.UpdateServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.update_service.async_update_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_service_function(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.update_service_function_request.UpdateServiceFunctionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.update_service_function_response.UpdateServiceFunctionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.update_service_function.async_update_service_function(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_system(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.update_system_request.UpdateSystemRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.update_system_response.UpdateSystemResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.update_system.async_update_system(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_user_journey(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_resiliencehubv2.types.update_user_journey_request.UpdateUserJourneyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_resiliencehubv2.types.update_user_journey_response.UpdateUserJourneyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_resiliencehubv2._operations.ngrh_service_core.update_user_journey.async_update_user_journey(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
