...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.list_assertions_response.ListAssertionsResponse = aws_sdk_resiliencehubv2.types.list_assertions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.list_assertions_request.ListAssertionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
