"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#DeleteSystem``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.delete_system_response.DeleteSystemResponse = (
        aws_sdk_resiliencehubv2.types.delete_system_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.delete_system_request.DeleteSystemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/delete-system"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehubv2.types.delete_system_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.delete_system_request.serialize_json(input_)
    ).encode()
