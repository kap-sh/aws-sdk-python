...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.import_policy_response.ImportPolicyResponse = (
        aws_sdk_resiliencehubv2.types.import_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.import_policy_request.ImportPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.import_policy_request.serialize_json(input_)
    ).encode()
