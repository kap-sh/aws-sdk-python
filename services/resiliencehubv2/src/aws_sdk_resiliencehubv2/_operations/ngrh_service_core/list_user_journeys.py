...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.list_user_journeys_response.ListUserJourneysResponse = aws_sdk_resiliencehubv2.types.list_user_journeys_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.list_user_journeys_request.ListUserJourneysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
