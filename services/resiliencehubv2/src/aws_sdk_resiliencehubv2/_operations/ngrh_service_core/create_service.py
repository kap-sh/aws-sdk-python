...
def build_request(
    ...
    input: aws_sdk_resiliencehubv2.types.create_service_request.CreateServiceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.create_service_request.serialize_json(input)
    ).encode()
