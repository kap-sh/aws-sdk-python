"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#CreateService``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.create_service_response.CreateServiceResponse = (
        aws_sdk_resiliencehubv2.types.create_service_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.create_service_request.CreateServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/create-service"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehubv2.types.create_service_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.create_service_request.serialize_json(input_)
    ).encode()
