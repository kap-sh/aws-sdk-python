"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#CreateSystem``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.create_system_response.CreateSystemResponse = (
        aws_sdk_resiliencehubv2.types.create_system_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.create_system_request.CreateSystemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/create-system"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehubv2.types.create_system_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.create_system_request.serialize_json(input_)
    ).encode()
