"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#UpdateAssertion``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.update_assertion_response.UpdateAssertionResponse = aws_sdk_resiliencehubv2.types.update_assertion_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.update_assertion_request.UpdateAssertionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/update-assertion"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehubv2.types.update_assertion_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.update_assertion_request.serialize_json(input_)
    ).encode()
...
async def async_update_assertion(
