"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#UntagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/tags/{resourceArn}"
