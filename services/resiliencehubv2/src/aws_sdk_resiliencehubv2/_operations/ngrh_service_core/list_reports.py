"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#ListReports``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.list_reports_response.ListReportsResponse = (
        aws_sdk_resiliencehubv2.types.list_reports_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.list_reports_request.ListReportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/list-reports"
    params: dict[str, str] = {}
    if "service_arn" in input_:
        params["serviceArn"] = str(input_["service_arn"])
    if "report_type" in input_:
        params["reportType"] = str(input_["report_type"])
