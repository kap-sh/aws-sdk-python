...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.import_app_response.ImportAppResponse = (
        aws_sdk_resiliencehubv2.types.import_app_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.import_app_request.ImportAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.import_app_request.serialize_json(input_)
    ).encode()
...
def import_app(
    ...
    aws_sdk_resiliencehubv2.types.import_app_response.ImportAppResponse, zapros.Response
]:
