...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.list_service_events_response.ListServiceEventsResponse = aws_sdk_resiliencehubv2.types.list_service_events_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_resiliencehubv2.types.list_service_events_request.ListServiceEventsRequest,
) -> zapros.Request:
    ...
    if "event_types" in input:
        params["eventTypes"] = str(input["event_types"])
