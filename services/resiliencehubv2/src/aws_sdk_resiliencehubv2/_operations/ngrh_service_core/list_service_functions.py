...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.list_service_functions_response.ListServiceFunctionsResponse = aws_sdk_resiliencehubv2.types.list_service_functions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.list_service_functions_request.ListServiceFunctionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
