...
def build_request(
    ...
    input: aws_sdk_resiliencehubv2.types.create_user_journey_request.CreateUserJourneyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.create_user_journey_request.serialize_json(input)
    ).encode()
