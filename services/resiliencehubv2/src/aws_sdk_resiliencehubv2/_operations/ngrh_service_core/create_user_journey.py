...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.create_user_journey_response.CreateUserJourneyResponse = aws_sdk_resiliencehubv2.types.create_user_journey_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.create_user_journey_request.CreateUserJourneyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.create_user_journey_request.serialize_json(input_)
    ).encode()
