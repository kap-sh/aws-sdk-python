...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.delete_service_function_response.DeleteServiceFunctionResponse = aws_sdk_resiliencehubv2.types.delete_service_function_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.delete_service_function_request.DeleteServiceFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.delete_service_function_request.serialize_json(
            input_
        )
    ).encode()
