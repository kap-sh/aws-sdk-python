...
def build_request(
    ...
    input: aws_sdk_resiliencehubv2.types.update_dependency_request.UpdateDependencyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.update_dependency_request.serialize_json(input)
    ).encode()
