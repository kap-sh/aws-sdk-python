...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.update_dependency_response.UpdateDependencyResponse = aws_sdk_resiliencehubv2.types.update_dependency_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.update_dependency_request.UpdateDependencyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.update_dependency_request.serialize_json(input_)
    ).encode()
