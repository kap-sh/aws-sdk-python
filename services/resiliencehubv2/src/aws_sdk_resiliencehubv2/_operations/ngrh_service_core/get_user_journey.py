...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.get_user_journey_response.GetUserJourneyResponse = aws_sdk_resiliencehubv2.types.get_user_journey_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.get_user_journey_request.GetUserJourneyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
