...
def build_request(
    ...
    input: aws_sdk_resiliencehubv2.types.list_dependencies_request.ListDependenciesRequest,
) -> zapros.Request:
    ...
    if "query_range_start_time" in input:
        params["queryRangeStartTime"] = str(input["query_range_start_time"])
    if "query_range_end_time" in input:
        params["queryRangeEndTime"] = str(input["query_range_end_time"])
    if "query_range_granularity" in input:
        params["queryRangeGranularity"] = str(input["query_range_granularity"])
