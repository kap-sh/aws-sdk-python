"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#CreateAssertion``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.create_assertion_response.CreateAssertionResponse = aws_sdk_resiliencehubv2.types.create_assertion_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_resiliencehubv2.types.create_assertion_request.CreateAssertionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.create_assertion_request.serialize_json(input)
    ).encode()
...
async def async_create_assertion(
