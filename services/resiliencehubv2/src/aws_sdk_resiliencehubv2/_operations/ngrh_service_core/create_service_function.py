"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#CreateServiceFunction``."""
...
import aws_sdk_resiliencehubv2.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_resiliencehubv2.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.create_service_function_response.CreateServiceFunctionResponse = aws_sdk_resiliencehubv2.types.create_service_function_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.create_service_function_request.CreateServiceFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/create-service-function"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.create_service_function_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_service_function(
