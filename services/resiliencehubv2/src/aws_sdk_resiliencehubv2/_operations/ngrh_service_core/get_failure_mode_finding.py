...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.get_failure_mode_finding_response.GetFailureModeFindingResponse = aws_sdk_resiliencehubv2.types.get_failure_mode_finding_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.get_failure_mode_finding_request.GetFailureModeFindingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
