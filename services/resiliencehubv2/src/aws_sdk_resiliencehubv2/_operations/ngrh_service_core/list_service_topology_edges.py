"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#ListServiceTopologyEdges``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.list_service_topology_edges_response.ListServiceTopologyEdgesResponse = aws_sdk_resiliencehubv2.types.list_service_topology_edges_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.list_service_topology_edges_request.ListServiceTopologyEdgesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/list-service-topology-edges"
    params: dict[str, str] = {}
...
async def async_list_service_topology_edges(
