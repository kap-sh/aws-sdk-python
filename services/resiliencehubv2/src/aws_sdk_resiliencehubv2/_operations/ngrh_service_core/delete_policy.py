...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.delete_policy_response.DeletePolicyResponse = (
        aws_sdk_resiliencehubv2.types.delete_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.delete_policy_request.DeletePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.delete_policy_request.serialize_json(input_)
    ).encode()
