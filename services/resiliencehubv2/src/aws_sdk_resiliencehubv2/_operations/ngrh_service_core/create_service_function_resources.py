"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#CreateServiceFunctionResources``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.create_service_function_resources_response.CreateServiceFunctionResourcesResponse = aws_sdk_resiliencehubv2.types.create_service_function_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.create_service_function_resources_request.CreateServiceFunctionResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/create-service-function-resources"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehubv2.types.create_service_function_resources_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.create_service_function_resources_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_service_function_resources(
