"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#UpdatePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.update_policy_response.UpdatePolicyResponse = (
        aws_sdk_resiliencehubv2.types.update_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.update_policy_request.UpdatePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/update-policy"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resiliencehubv2.types.update_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.update_policy_request.serialize_json(input_)
    ).encode()
