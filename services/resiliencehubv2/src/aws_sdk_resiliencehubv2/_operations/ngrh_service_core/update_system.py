...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.update_system_response.UpdateSystemResponse = (
        aws_sdk_resiliencehubv2.types.update_system_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.update_system_request.UpdateSystemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.update_system_request.serialize_json(input_)
    ).encode()
