...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.create_input_source_response.CreateInputSourceResponse = aws_sdk_resiliencehubv2.types.create_input_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.create_input_source_request.CreateInputSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.create_input_source_request.serialize_json(input_)
    ).encode()
