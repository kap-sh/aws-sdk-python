...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.update_user_journey_response.UpdateUserJourneyResponse = aws_sdk_resiliencehubv2.types.update_user_journey_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.update_user_journey_request.UpdateUserJourneyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.update_user_journey_request.serialize_json(input_)
    ).encode()
