"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#GetSystem``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.get_system_response.GetSystemResponse = (
        aws_sdk_resiliencehubv2.types.get_system_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.get_system_request.GetSystemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/get-system"
    params: dict[str, str] = {}
...
def get_system(
    ...
    aws_sdk_resiliencehubv2.types.get_system_response.GetSystemResponse, zapros.Response
]:
