...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.list_failure_mode_assessments_response.ListFailureModeAssessmentsResponse = aws_sdk_resiliencehubv2.types.list_failure_mode_assessments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.list_failure_mode_assessments_request.ListFailureModeAssessmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
