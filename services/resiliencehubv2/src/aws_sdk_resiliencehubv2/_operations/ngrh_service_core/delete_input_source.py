...
def build_request(
    ...
    input: aws_sdk_resiliencehubv2.types.delete_input_source_request.DeleteInputSourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.delete_input_source_request.serialize_json(input)
    ).encode()
