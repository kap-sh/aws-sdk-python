"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#DeleteInputSource``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.delete_input_source_response.DeleteInputSourceResponse = aws_sdk_resiliencehubv2.types.delete_input_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.delete_input_source_request.DeleteInputSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/delete-input-source"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.delete_input_source_request.serialize_json(input_)
    ).encode()
...
async def async_delete_input_source(
