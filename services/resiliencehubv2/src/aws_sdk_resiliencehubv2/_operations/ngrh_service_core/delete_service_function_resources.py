...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.delete_service_function_resources_response.DeleteServiceFunctionResourcesResponse = aws_sdk_resiliencehubv2.types.delete_service_function_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.delete_service_function_resources_request.DeleteServiceFunctionResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.delete_service_function_resources_request.serialize_json(
            input_
        )
    ).encode()
