...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.list_systems_response.ListSystemsResponse = (
        aws_sdk_resiliencehubv2.types.list_systems_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.list_systems_request.ListSystemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
