...
def build_request(
    ...
    input: aws_sdk_resiliencehubv2.types.delete_assertion_request.DeleteAssertionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.delete_assertion_request.serialize_json(input)
    ).encode()
