...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.delete_assertion_response.DeleteAssertionResponse = aws_sdk_resiliencehubv2.types.delete_assertion_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.delete_assertion_request.DeleteAssertionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.delete_assertion_request.serialize_json(input_)
    ).encode()
