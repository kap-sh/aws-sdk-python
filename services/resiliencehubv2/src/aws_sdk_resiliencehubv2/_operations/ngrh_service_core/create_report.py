...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.create_report_response.CreateReportResponse = (
        aws_sdk_resiliencehubv2.types.create_report_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.create_report_request.CreateReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.create_report_request.serialize_json(input_)
    ).encode()
