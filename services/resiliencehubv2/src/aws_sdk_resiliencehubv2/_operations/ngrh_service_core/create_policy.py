"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#CreatePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.create_policy_response.CreatePolicyResponse = (
        aws_sdk_resiliencehubv2.types.create_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.create_policy_request.CreatePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/create-policy"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.create_policy_request.serialize_json(input_)
    ).encode()
