...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.list_system_events_response.ListSystemEventsResponse = aws_sdk_resiliencehubv2.types.list_system_events_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_resiliencehubv2.types.list_system_events_request.ListSystemEventsRequest,
) -> zapros.Request:
