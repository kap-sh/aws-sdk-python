...
def build_request(
    ...
    input: aws_sdk_resiliencehubv2.types.delete_service_request.DeleteServiceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.delete_service_request.serialize_json(input)
    ).encode()
