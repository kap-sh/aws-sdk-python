"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#DeleteService``."""
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.delete_service_response.DeleteServiceResponse = (
        aws_sdk_resiliencehubv2.types.delete_service_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.delete_service_request.DeleteServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/delete-service"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_resiliencehubv2.types.delete_service_request.serialize_json(input_)
    ).encode()
