"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#ListServices``."""
...
import aws_sdk_resiliencehubv2.types.service_summary_list
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.list_services_response.ListServicesResponse = (
        aws_sdk_resiliencehubv2.types.list_services_response.deserialize_json(
