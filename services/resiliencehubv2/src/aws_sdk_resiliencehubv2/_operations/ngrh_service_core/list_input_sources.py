...
import aws_sdk_resiliencehubv2.types.input_source_summary_list
...
def handle_response(
    ...
    out: aws_sdk_resiliencehubv2.types.list_input_sources_response.ListInputSourcesResponse = aws_sdk_resiliencehubv2.types.list_input_sources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resiliencehubv2.types.list_input_sources_request.ListInputSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
