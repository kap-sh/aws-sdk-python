...
class resiliencehubv2Error(Exception):
    """Base class for all resiliencehubv2 service errors."""


class ServiceError(resiliencehubv2Error):
...
class SerializationError(resiliencehubv2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(resiliencehubv2Error):
...
class WaiterFailedError(resiliencehubv2Error):
...
class WaiterTimeoutError(resiliencehubv2Error):
