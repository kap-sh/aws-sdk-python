"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#AccessDeniedException``."""

from typing import TypedDict
from aws_sdk_resiliencehubv2.errors import DeserializationError
from aws_sdk_resiliencehubv2.errors import ServiceError
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.resiliencehubv2#AccessDeniedException``."""
