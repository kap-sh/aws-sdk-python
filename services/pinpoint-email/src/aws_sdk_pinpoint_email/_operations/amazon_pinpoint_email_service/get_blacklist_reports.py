...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.get_blacklist_reports_response.GetBlacklistReportsResponse = aws_sdk_pinpoint_email.types.get_blacklist_reports_response.deserialize_json(
