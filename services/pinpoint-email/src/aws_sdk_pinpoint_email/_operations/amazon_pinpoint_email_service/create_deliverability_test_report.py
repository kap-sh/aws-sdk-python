...
import aws_sdk_pinpoint_email.errors.concurrent_modification_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConcurrentModificationException":
            raise aws_sdk_pinpoint_email.errors.concurrent_modification_exception.ConcurrentModificationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.create_deliverability_test_report_response.CreateDeliverabilityTestReportResponse = aws_sdk_pinpoint_email.types.create_deliverability_test_report_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.create_deliverability_test_report_request.CreateDeliverabilityTestReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.create_deliverability_test_report_request.serialize_json(
            input_
        )
    ).encode()
