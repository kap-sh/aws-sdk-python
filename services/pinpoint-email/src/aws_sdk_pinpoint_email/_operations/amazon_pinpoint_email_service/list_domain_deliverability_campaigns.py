"""Generated from Smithy shape ``com.amazonaws.pinpointemail#ListDomainDeliverabilityCampaigns``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.list_domain_deliverability_campaigns_response.ListDomainDeliverabilityCampaignsResponse = aws_sdk_pinpoint_email.types.list_domain_deliverability_campaigns_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.list_domain_deliverability_campaigns_request.ListDomainDeliverabilityCampaignsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{SubscribedDomain}", quote(str(input_["subscribed_domain"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_list_domain_deliverability_campaigns(
