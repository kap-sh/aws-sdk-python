...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.put_configuration_set_tracking_options_response.PutConfigurationSetTrackingOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.put_configuration_set_tracking_options_request.PutConfigurationSetTrackingOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.put_configuration_set_tracking_options_request.serialize_json(
            input_
        )
    ).encode()
