"""Generated from Smithy shape ``com.amazonaws.pinpointemail#PutConfigurationSetDeliveryOptions``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.put_configuration_set_delivery_options_response.PutConfigurationSetDeliveryOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.put_configuration_set_delivery_options_request.PutConfigurationSetDeliveryOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.put_configuration_set_delivery_options_request.serialize_json(
            input_
        )
    ).encode()
