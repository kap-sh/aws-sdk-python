...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.put_dedicated_ip_in_pool_response.PutDedicatedIpInPoolResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.put_dedicated_ip_in_pool_request.PutDedicatedIpInPoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.put_dedicated_ip_in_pool_request.serialize_json(
            input_
        )
    ).encode()
