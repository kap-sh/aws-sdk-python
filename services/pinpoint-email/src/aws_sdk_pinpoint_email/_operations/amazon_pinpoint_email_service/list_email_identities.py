...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.list_email_identities_response.ListEmailIdentitiesResponse = aws_sdk_pinpoint_email.types.list_email_identities_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.list_email_identities_request.ListEmailIdentitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
