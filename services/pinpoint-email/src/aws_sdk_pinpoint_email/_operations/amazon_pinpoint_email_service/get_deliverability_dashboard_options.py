"""Generated from Smithy shape ``com.amazonaws.pinpointemail#GetDeliverabilityDashboardOptions``."""
...
import aws_sdk_pinpoint_email.types.deliverability_dashboard_account_status
...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.get_deliverability_dashboard_options_response.GetDeliverabilityDashboardOptionsResponse = aws_sdk_pinpoint_email.types.get_deliverability_dashboard_options_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.get_deliverability_dashboard_options_request.GetDeliverabilityDashboardOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_deliverability_dashboard_options(
