...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.put_email_identity_mail_from_attributes_response.PutEmailIdentityMailFromAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.put_email_identity_mail_from_attributes_request.PutEmailIdentityMailFromAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.put_email_identity_mail_from_attributes_request.serialize_json(
            input_
        )
    ).encode()
