...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.put_account_sending_attributes_response.PutAccountSendingAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.put_account_sending_attributes_request.PutAccountSendingAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.put_account_sending_attributes_request.serialize_json(
            input_
        )
    ).encode()
