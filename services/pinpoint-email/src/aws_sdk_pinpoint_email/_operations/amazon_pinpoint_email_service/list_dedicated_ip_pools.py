...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.list_dedicated_ip_pools_response.ListDedicatedIpPoolsResponse = aws_sdk_pinpoint_email.types.list_dedicated_ip_pools_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.list_dedicated_ip_pools_request.ListDedicatedIpPoolsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
