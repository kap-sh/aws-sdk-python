...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.delete_email_identity_response.DeleteEmailIdentityResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.delete_email_identity_request.DeleteEmailIdentityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
