"""Generated from Smithy shape ``com.amazonaws.pinpointemail#GetEmailIdentity``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.get_email_identity_response.GetEmailIdentityResponse = aws_sdk_pinpoint_email.types.get_email_identity_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.get_email_identity_request.GetEmailIdentityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
