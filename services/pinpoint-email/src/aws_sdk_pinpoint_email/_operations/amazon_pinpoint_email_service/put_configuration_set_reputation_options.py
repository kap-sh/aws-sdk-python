"""Generated from Smithy shape ``com.amazonaws.pinpointemail#PutConfigurationSetReputationOptions``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.put_configuration_set_reputation_options_response.PutConfigurationSetReputationOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.put_configuration_set_reputation_options_request.PutConfigurationSetReputationOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.put_configuration_set_reputation_options_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_configuration_set_reputation_options(
