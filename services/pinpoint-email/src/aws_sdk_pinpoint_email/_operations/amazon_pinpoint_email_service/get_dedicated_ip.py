...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.get_dedicated_ip_response.GetDedicatedIpResponse = aws_sdk_pinpoint_email.types.get_dedicated_ip_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.get_dedicated_ip_request.GetDedicatedIpRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
