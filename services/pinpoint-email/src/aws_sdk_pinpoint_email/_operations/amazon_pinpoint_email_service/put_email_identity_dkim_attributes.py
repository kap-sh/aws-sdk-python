...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.put_email_identity_dkim_attributes_response.PutEmailIdentityDkimAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.put_email_identity_dkim_attributes_request.PutEmailIdentityDkimAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.put_email_identity_dkim_attributes_request.serialize_json(
            input_
        )
    ).encode()
