"""Generated from Smithy shape ``com.amazonaws.pinpointemail#CreateDedicatedIpPool``."""
...
import aws_sdk_pinpoint_email.errors.already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AlreadyExistsException":
            raise aws_sdk_pinpoint_email.errors.already_exists_exception.AlreadyExistsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.create_dedicated_ip_pool_response.CreateDedicatedIpPoolResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.create_dedicated_ip_pool_request.CreateDedicatedIpPoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
