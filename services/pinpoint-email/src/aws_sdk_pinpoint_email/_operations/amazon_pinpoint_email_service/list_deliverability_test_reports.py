...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.list_deliverability_test_reports_response.ListDeliverabilityTestReportsResponse = aws_sdk_pinpoint_email.types.list_deliverability_test_reports_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.list_deliverability_test_reports_request.ListDeliverabilityTestReportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
