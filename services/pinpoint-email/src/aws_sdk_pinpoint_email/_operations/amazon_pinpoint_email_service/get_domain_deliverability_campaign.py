...
def build_request(
    ...
    input: aws_sdk_pinpoint_email.types.get_domain_deliverability_campaign_request.GetDomainDeliverabilityCampaignRequest,
) -> zapros.Request:
    ...
    url = url.replace("{CampaignId}", quote(str(input["campaign_id"]), safe=""))
    params: dict[str, str] = {}
