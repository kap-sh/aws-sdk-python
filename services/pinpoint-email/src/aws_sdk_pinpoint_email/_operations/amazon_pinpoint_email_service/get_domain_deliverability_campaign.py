"""Generated from Smithy shape ``com.amazonaws.pinpointemail#GetDomainDeliverabilityCampaign``."""
...
import aws_sdk_pinpoint_email.types.domain_deliverability_campaign
...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.get_domain_deliverability_campaign_response.GetDomainDeliverabilityCampaignResponse = aws_sdk_pinpoint_email.types.get_domain_deliverability_campaign_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.get_domain_deliverability_campaign_request.GetDomainDeliverabilityCampaignRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{CampaignId}", quote(str(input_["campaign_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_get_domain_deliverability_campaign(
