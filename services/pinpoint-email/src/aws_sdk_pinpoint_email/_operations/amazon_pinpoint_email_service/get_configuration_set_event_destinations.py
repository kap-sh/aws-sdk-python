...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.get_configuration_set_event_destinations_response.GetConfigurationSetEventDestinationsResponse = aws_sdk_pinpoint_email.types.get_configuration_set_event_destinations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.get_configuration_set_event_destinations_request.GetConfigurationSetEventDestinationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
