...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.get_account_response.GetAccountResponse = (
        aws_sdk_pinpoint_email.types.get_account_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.get_account_request.GetAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
