"""Generated from Smithy shape ``com.amazonaws.pinpointemail#PutEmailIdentityFeedbackAttributes``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.put_email_identity_feedback_attributes_response.PutEmailIdentityFeedbackAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.put_email_identity_feedback_attributes_request.PutEmailIdentityFeedbackAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/email/identities/{EmailIdentity}/feedback"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.put_email_identity_feedback_attributes_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_email_identity_feedback_attributes(
