"""Generated from Smithy shape ``com.amazonaws.pinpointemail#GetConfigurationSet``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.get_configuration_set_response.GetConfigurationSetResponse = aws_sdk_pinpoint_email.types.get_configuration_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.get_configuration_set_request.GetConfigurationSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_configuration_set(
