...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.list_configuration_sets_response.ListConfigurationSetsResponse = aws_sdk_pinpoint_email.types.list_configuration_sets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.list_configuration_sets_request.ListConfigurationSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
