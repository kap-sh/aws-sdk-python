...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.put_deliverability_dashboard_option_response.PutDeliverabilityDashboardOptionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.put_deliverability_dashboard_option_request.PutDeliverabilityDashboardOptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.put_deliverability_dashboard_option_request.serialize_json(
            input_
        )
    ).encode()
