...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.create_configuration_set_response.CreateConfigurationSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.create_configuration_set_request.CreateConfigurationSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.create_configuration_set_request.serialize_json(
            input_
        )
    ).encode()
