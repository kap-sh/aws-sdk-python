...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.create_email_identity_response.CreateEmailIdentityResponse = aws_sdk_pinpoint_email.types.create_email_identity_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_pinpoint_email.types.create_email_identity_request.CreateEmailIdentityRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.create_email_identity_request.serialize_json(input)
    ).encode()
