...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.create_email_identity_request.CreateEmailIdentityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.create_email_identity_request.serialize_json(
            input_
        )
    ).encode()
