"""Generated from Smithy shape ``com.amazonaws.pinpointemail#GetDedicatedIps``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.get_dedicated_ips_response.GetDedicatedIpsResponse = aws_sdk_pinpoint_email.types.get_dedicated_ips_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.get_dedicated_ips_request.GetDedicatedIpsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/email/dedicated-ips"
    params: dict[str, str] = {}
    if "pool_name" in input_:
        params["PoolName"] = str(input_["pool_name"])
...
async def async_get_dedicated_ips(
