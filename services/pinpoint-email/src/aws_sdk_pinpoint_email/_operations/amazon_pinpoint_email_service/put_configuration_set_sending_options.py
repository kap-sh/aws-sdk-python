...
def handle_response(
    ...
    out: aws_sdk_pinpoint_email.types.put_configuration_set_sending_options_response.PutConfigurationSetSendingOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pinpoint_email.types.put_configuration_set_sending_options_request.PutConfigurationSetSendingOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pinpoint_email.types.put_configuration_set_sending_options_request.serialize_json(
            input_
        )
    ).encode()
