"""Generated from Smithy shape ``com.amazonaws.pinpointemail#RawMessageData``."""
...
# --- restJson1 ser/de ---
def serialize_json(value: RawMessageData) -> str:
    return base64.b64encode(value).decode("ascii")


def deserialize_json(data: str) -> RawMessageData:
