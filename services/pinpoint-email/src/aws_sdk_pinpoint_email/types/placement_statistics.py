...
class PlacementStatistics(TypedDict, closed=True):
    ...
    missing_percentage: NotRequired[
        "aws_sdk_pinpoint_email.types.percentage.Percentage"
    ]
    """<p>The percentage of emails that didn't arrive in recipients' inboxes at all during the predictive inbox placement test.</p>"""
    spf_percentage: NotRequired["aws_sdk_pinpoint_email.types.percentage.Percentage"]
    ...
    dkim_percentage: NotRequired["aws_sdk_pinpoint_email.types.percentage.Percentage"]
