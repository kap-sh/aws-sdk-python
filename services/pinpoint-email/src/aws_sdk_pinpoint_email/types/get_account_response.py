...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint_email.types.general_enforcement_status
    import aws_sdk_pinpoint_email.types.send_quota


class GetAccountResponse(TypedDict, closed=True):
    send_quota: NotRequired["aws_sdk_pinpoint_email.types.send_quota.SendQuota"]
    ...
    dedicated_ip_auto_warmup_enabled: "aws_sdk_pinpoint_email.types.enabled.Enabled"
    ...
    enforcement_status: NotRequired[
        "aws_sdk_pinpoint_email.types.general_enforcement_status.GeneralEnforcementStatus"
    ]
    ...
    production_access_enabled: "aws_sdk_pinpoint_email.types.enabled.Enabled"
...
def serialize_json(value: GetAccountResponse) -> dict:
    ...
    if "send_quota" in value:
        ...
        out["SendQuota"] = aws_sdk_pinpoint_email.types.send_quota.serialize_json(
            value["send_quota"]
        )
...
def deserialize_json(data: dict) -> GetAccountResponse:
    ...
    if "SendQuota" in data:
        ...
        out["send_quota"] = aws_sdk_pinpoint_email.types.send_quota.deserialize_json(
            data["SendQuota"]
        )
