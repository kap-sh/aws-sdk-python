...
class GetDeliverabilityDashboardOptionsResponse(TypedDict):
    ...
    account_status: NotRequired[
        "aws_sdk_pinpoint_email.types.deliverability_dashboard_account_status.DeliverabilityDashboardAccountStatus"
    ]
...
def serialize_json(value: GetDeliverabilityDashboardOptionsResponse) -> dict:
    ...
    if "account_status" in value:
        ...
        out["AccountStatus"] = (
            aws_sdk_pinpoint_email.types.deliverability_dashboard_account_status.serialize_json(
...
def deserialize_json(data: dict) -> GetDeliverabilityDashboardOptionsResponse:
    ...
    if "AccountStatus" in data:
        ...
        out["account_status"] = (
            aws_sdk_pinpoint_email.types.deliverability_dashboard_account_status.deserialize_json(
                data["AccountStatus"]
            )
        )
