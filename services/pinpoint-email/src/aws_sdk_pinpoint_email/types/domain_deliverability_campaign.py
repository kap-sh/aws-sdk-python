...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint_email.types.esps
    import aws_sdk_pinpoint_email.types.identity
    import aws_sdk_pinpoint_email.types.image_url
    import aws_sdk_pinpoint_email.types.ip_list
    import aws_sdk_pinpoint_email.types.percentage
    import aws_sdk_pinpoint_email.types.subject
...
class DomainDeliverabilityCampaign(TypedDict):
    ...
    subject: NotRequired["aws_sdk_pinpoint_email.types.subject.Subject"]
    """<p>The subject line, or title, of the email message.</p>"""
    from_address: NotRequired["aws_sdk_pinpoint_email.types.identity.Identity"]
    """<p>The verified email address that the email message was sent from.</p>"""
    sending_ips: NotRequired["aws_sdk_pinpoint_email.types.ip_list.IpList"]
    """<p>The IP addresses that were used to send the email message.</p>"""
    first_seen_date_time: NotRequired[
    ...
    last_seen_date_time: NotRequired["aws_sdk_pinpoint_email.types.timestamp.Timestamp"]
    ...
    inbox_count: NotRequired["aws_sdk_pinpoint_email.types.volume.Volume"]
    """<p>The number of email messages that were delivered to recipients’ inboxes.</p>"""
    spam_count: NotRequired["aws_sdk_pinpoint_email.types.volume.Volume"]
    """<p>The number of email messages that were delivered to recipients' spam or junk mail folders.</p>"""
    read_rate: NotRequired["aws_sdk_pinpoint_email.types.percentage.Percentage"]
    ...
    delete_rate: NotRequired["aws_sdk_pinpoint_email.types.percentage.Percentage"]
    ...
    read_delete_rate: NotRequired["aws_sdk_pinpoint_email.types.percentage.Percentage"]
    ...
    projected_volume: NotRequired["aws_sdk_pinpoint_email.types.volume.Volume"]
    """<p>The projected number of recipients that the email message was sent to.</p>"""
    esps: NotRequired["aws_sdk_pinpoint_email.types.esps.Esps"]
...
def serialize_json(value: DomainDeliverabilityCampaign) -> dict:
    ...
    if "sending_ips" in value:
        ...
        out["SendingIps"] = aws_sdk_pinpoint_email.types.ip_list.serialize_json(
            value["sending_ips"]
        )
    if "first_seen_date_time" in value:
        import aws_sdk_pinpoint_email.types.timestamp

        out["FirstSeenDateTime"] = (
    ...
    if "last_seen_date_time" in value:
        ...
        out["LastSeenDateTime"] = aws_sdk_pinpoint_email.types.timestamp.serialize_json(
    ...
    if "esps" in value:
        ...
        out["Esps"] = aws_sdk_pinpoint_email.types.esps.serialize_json(value["esps"])
    return out
...
def deserialize_json(data: dict) -> DomainDeliverabilityCampaign:
    ...
    if "SendingIps" in data:
        ...
        out["sending_ips"] = aws_sdk_pinpoint_email.types.ip_list.deserialize_json(
            data["SendingIps"]
        )
    ...
    if "Esps" in data:
        ...
        out["esps"] = aws_sdk_pinpoint_email.types.esps.deserialize_json(data["Esps"])
    return out
