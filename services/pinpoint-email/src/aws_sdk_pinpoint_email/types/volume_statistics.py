"""Generated from Smithy shape ``com.amazonaws.pinpointemail#VolumeStatistics``."""
...
class VolumeStatistics(TypedDict, closed=True):
    inbox_raw_count: NotRequired["aws_sdk_pinpoint_email.types.volume.Volume"]
    """<p>The total number of emails that arrived in recipients' inboxes.</p>"""
    spam_raw_count: NotRequired["aws_sdk_pinpoint_email.types.volume.Volume"]
    """<p>The total number of emails that arrived in recipients' spam or junk mail folders.</p>"""
    projected_inbox: NotRequired["aws_sdk_pinpoint_email.types.volume.Volume"]
    """<p>An estimate of the percentage of emails sent from the current domain that will arrive in recipients' inboxes.</p>"""
    projected_spam: NotRequired["aws_sdk_pinpoint_email.types.volume.Volume"]
