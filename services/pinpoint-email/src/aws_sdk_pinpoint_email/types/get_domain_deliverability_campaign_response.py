"""Generated from Smithy shape ``com.amazonaws.pinpointemail#GetDomainDeliverabilityCampaignResponse``."""
...
class GetDomainDeliverabilityCampaignResponse(TypedDict):
    domain_deliverability_campaign: "aws_sdk_pinpoint_email.types.domain_deliverability_campaign.DomainDeliverabilityCampaign"
...
def serialize_json(value: GetDomainDeliverabilityCampaignResponse) -> dict:
    ...
    out["DomainDeliverabilityCampaign"] = (
        aws_sdk_pinpoint_email.types.domain_deliverability_campaign.serialize_json(
...
def deserialize_json(data: dict) -> GetDomainDeliverabilityCampaignResponse:
    ...
    if "DomainDeliverabilityCampaign" in data:
        ...
        out["domain_deliverability_campaign"] = (
            aws_sdk_pinpoint_email.types.domain_deliverability_campaign.deserialize_json(
