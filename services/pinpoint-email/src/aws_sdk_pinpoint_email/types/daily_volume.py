...
if TYPE_CHECKING:
    import aws_sdk_pinpoint_email.types.domain_isp_placements
    import aws_sdk_pinpoint_email.types.timestamp
    import aws_sdk_pinpoint_email.types.volume_statistics


class DailyVolume(TypedDict, closed=True):
    start_date: NotRequired["aws_sdk_pinpoint_email.types.timestamp.Timestamp"]
    """<p>The date that the DailyVolume metrics apply to, in Unix time.</p>"""
    volume_statistics: NotRequired[
        "aws_sdk_pinpoint_email.types.volume_statistics.VolumeStatistics"
    ]
    ...
    domain_isp_placements: NotRequired[
        "aws_sdk_pinpoint_email.types.domain_isp_placements.DomainIspPlacements"
    ]
...
def serialize_json(value: DailyVolume) -> dict:
    ...
    if "start_date" in value:
        ...
        out["StartDate"] = aws_sdk_pinpoint_email.types.timestamp.serialize_json(
            value["start_date"]
        )
    if "volume_statistics" in value:
        ...
        out["VolumeStatistics"] = (
            aws_sdk_pinpoint_email.types.volume_statistics.serialize_json(
    ...
    if "domain_isp_placements" in value:
        ...
        out["DomainIspPlacements"] = (
            aws_sdk_pinpoint_email.types.domain_isp_placements.serialize_json(
...
def deserialize_json(data: dict) -> DailyVolume:
    ...
    if "StartDate" in data:
        ...
        out["start_date"] = aws_sdk_pinpoint_email.types.timestamp.deserialize_json(
            data["StartDate"]
        )
    if "VolumeStatistics" in data:
        ...
        out["volume_statistics"] = (
            aws_sdk_pinpoint_email.types.volume_statistics.deserialize_json(
    ...
    if "DomainIspPlacements" in data:
        ...
        out["domain_isp_placements"] = (
            aws_sdk_pinpoint_email.types.domain_isp_placements.deserialize_json(
