...
class PinpointEmailError(Exception):
    """Base class for all PinpointEmail service errors."""


class ServiceError(PinpointEmailError):
...
class SerializationError(PinpointEmailError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PinpointEmailError):
...
class WaiterFailedError(PinpointEmailError):
...
class WaiterTimeoutError(PinpointEmailError):
