"""Generated from Smithy shape ``com.amazonaws.pinpointemail#BadRequestException``."""
...
class BadRequestException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.pinpointemail#BadRequestException``."""
