...
from ._services.async_pinpoint_email import (
    AsyncPinpointEmailClient as AsyncPinpointEmailClient,
)
from ._services.pinpoint_email import PinpointEmailClient as PinpointEmailClient
