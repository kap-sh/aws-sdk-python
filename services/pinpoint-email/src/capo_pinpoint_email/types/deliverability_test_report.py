...
if TYPE_CHECKING:
    ...
    import capo_pinpoint_email.types.deliverability_test_subject
...
class DeliverabilityTestReport(TypedDict, closed=True):
    report_id: NotRequired["capo_pinpoint_email.types.report_id.ReportId"]
    ...
    subject: NotRequired[
        "capo_pinpoint_email.types.deliverability_test_subject.DeliverabilityTestSubject"
    ]
    ...
    create_date: NotRequired["capo_pinpoint_email.types.timestamp.Timestamp"]
    ...
    deliverability_test_status: NotRequired[
        "capo_pinpoint_email.types.deliverability_test_status.DeliverabilityTestStatus"
    ]
...
def serialize_json(value: DeliverabilityTestReport) -> dict:
    ...
    if "create_date" in value:
        ...
        out["CreateDate"] = capo_pinpoint_email.types.timestamp.serialize_json(
            value["create_date"]
        )
    if "deliverability_test_status" in value:
        ...
        out["DeliverabilityTestStatus"] = (
            capo_pinpoint_email.types.deliverability_test_status.serialize_json(
...
def deserialize_json(data: dict) -> DeliverabilityTestReport:
    ...
    if "CreateDate" in data:
        ...
        out["create_date"] = capo_pinpoint_email.types.timestamp.deserialize_json(
            data["CreateDate"]
        )
    if "DeliverabilityTestStatus" in data:
        ...
        out["deliverability_test_status"] = (
            capo_pinpoint_email.types.deliverability_test_status.deserialize_json(
