...
if TYPE_CHECKING:
    import capo_pinpoint_email.types.template_arn
    import capo_pinpoint_email.types.template_data


class Template(TypedDict, closed=True):
    template_arn: NotRequired["capo_pinpoint_email.types.template_arn.TemplateArn"]
    """<p>The Amazon Resource Name (ARN) of the template.</p>"""
    template_data: NotRequired["capo_pinpoint_email.types.template_data.TemplateData"]
