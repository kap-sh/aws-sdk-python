"""Generated from Smithy shape ``com.amazonaws.pinpointemail#DomainIspPlacement``."""
...
if TYPE_CHECKING:
    ...
    import capo_pinpoint_email.types.volume
...
class DomainIspPlacement(TypedDict, closed=True):
    ...
    inbox_raw_count: NotRequired["capo_pinpoint_email.types.volume.Volume"]
    ...
    spam_raw_count: NotRequired["capo_pinpoint_email.types.volume.Volume"]
