...
if TYPE_CHECKING:
    import capo_pinpoint_email.types.message_tag_name
    import capo_pinpoint_email.types.message_tag_value


class MessageTag(TypedDict, closed=True):
    name: "capo_pinpoint_email.types.message_tag_name.MessageTagName"
    ...
    value: "capo_pinpoint_email.types.message_tag_value.MessageTagValue"
