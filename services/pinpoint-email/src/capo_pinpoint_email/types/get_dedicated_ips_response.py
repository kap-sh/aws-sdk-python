...
class GetDedicatedIpsResponse(TypedDict, closed=True):
    dedicated_ips: NotRequired[
        "capo_pinpoint_email.types.dedicated_ip_list.DedicatedIpList"
    ]
...
def serialize_json(value: GetDedicatedIpsResponse) -> dict:
    ...
    if "dedicated_ips" in value:
        ...
        out["DedicatedIps"] = (
            capo_pinpoint_email.types.dedicated_ip_list.serialize_json(
                value["dedicated_ips"]
            )
        )
...
def deserialize_json(data: dict) -> GetDedicatedIpsResponse:
    ...
    if "DedicatedIps" in data:
        ...
        out["dedicated_ips"] = (
            capo_pinpoint_email.types.dedicated_ip_list.deserialize_json(
                data["DedicatedIps"]
            )
        )
