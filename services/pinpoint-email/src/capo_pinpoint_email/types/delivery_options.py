...
class DeliveryOptions(TypedDict, closed=True):
    tls_policy: NotRequired["capo_pinpoint_email.types.tls_policy.TlsPolicy"]
    ...
    sending_pool_name: NotRequired["capo_pinpoint_email.types.pool_name.PoolName"]
...
def serialize_json(value: DeliveryOptions) -> dict:
    ...
    if "tls_policy" in value:
        ...
        out["TlsPolicy"] = capo_pinpoint_email.types.tls_policy.serialize_json(
            value["tls_policy"]
        )
