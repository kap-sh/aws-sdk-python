"""Generated from Smithy shape ``com.amazonaws.pinpointemail#OverallVolume``."""
...
class OverallVolume(TypedDict, closed=True):
    ...
    read_rate_percent: NotRequired["capo_pinpoint_email.types.percentage.Percentage"]
