...
if TYPE_CHECKING:
    ...
    import capo_pinpoint_email.types.last_fresh_start


class ReputationOptions(TypedDict, closed=True):
    reputation_metrics_enabled: "capo_pinpoint_email.types.enabled.Enabled"
    ...
    last_fresh_start: NotRequired[
        "capo_pinpoint_email.types.last_fresh_start.LastFreshStart"
    ]
...
def serialize_json(value: ReputationOptions) -> dict:
    ...
    if "last_fresh_start" in value:
        ...
        out["LastFreshStart"] = (
            capo_pinpoint_email.types.last_fresh_start.serialize_json(
...
def deserialize_json(data: dict) -> ReputationOptions:
    ...
    if "LastFreshStart" in data:
        ...
        out["last_fresh_start"] = (
            capo_pinpoint_email.types.last_fresh_start.deserialize_json(
                data["LastFreshStart"]
            )
        )
    return out
