...
```
pip install aws-sdk-pinpoint-email
```

## Usage

```python
from aws_sdk_pinpoint_email import AsyncPinpointEmailClient
...
```python
from aws_sdk_pinpoint_email import AsyncPinpointEmailClient
from aws_sdk_pinpoint_email.error import AlreadyExistsException
