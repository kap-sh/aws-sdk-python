...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.delete_id_namespace_output.DeleteIdNamespaceOutput = aws_sdk_entityresolution.types.delete_id_namespace_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.delete_id_namespace_input.DeleteIdNamespaceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_id_namespace(
