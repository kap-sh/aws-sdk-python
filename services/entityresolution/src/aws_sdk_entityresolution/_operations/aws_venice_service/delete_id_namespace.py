"""Generated from Smithy shape ``com.amazonaws.entityresolution#DeleteIdNamespace``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.delete_id_namespace_output.DeleteIdNamespaceOutput:
    import aws_sdk_entityresolution.types.delete_id_namespace_output
    out: aws_sdk_entityresolution.types.delete_id_namespace_output.DeleteIdNamespaceOutput = aws_sdk_entityresolution.types.delete_id_namespace_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.delete_id_namespace_input.DeleteIdNamespaceInput) -> zapros.Request:
...
def delete_id_namespace(options: OperationOptions, input: aws_sdk_entityresolution.types.delete_id_namespace_input.DeleteIdNamespaceInput) -> tuple[aws_sdk_entityresolution.types.delete_id_namespace_output.DeleteIdNamespaceOutput, zapros.Response]:
...
async def async_delete_id_namespace(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.delete_id_namespace_input.DeleteIdNamespaceInput) -> tuple[aws_sdk_entityresolution.types.delete_id_namespace_output.DeleteIdNamespaceOutput, zapros.Response]:
