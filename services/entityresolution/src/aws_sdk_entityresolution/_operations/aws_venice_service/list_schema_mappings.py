...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.list_schema_mappings_output.ListSchemaMappingsOutput = aws_sdk_entityresolution.types.list_schema_mappings_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.list_schema_mappings_input.ListSchemaMappingsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
