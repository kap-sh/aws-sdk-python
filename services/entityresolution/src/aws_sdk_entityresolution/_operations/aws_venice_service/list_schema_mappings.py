...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.list_schema_mappings_output.ListSchemaMappingsOutput:
    import aws_sdk_entityresolution.types.list_schema_mappings_output
    out: aws_sdk_entityresolution.types.list_schema_mappings_output.ListSchemaMappingsOutput = aws_sdk_entityresolution.types.list_schema_mappings_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_schema_mappings_input.ListSchemaMappingsInput) -> zapros.Request:
...
def list_schema_mappings(options: OperationOptions, input: aws_sdk_entityresolution.types.list_schema_mappings_input.ListSchemaMappingsInput) -> tuple[aws_sdk_entityresolution.types.list_schema_mappings_output.ListSchemaMappingsOutput, zapros.Response]:
...
async def async_list_schema_mappings(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_schema_mappings_input.ListSchemaMappingsInput) -> tuple[aws_sdk_entityresolution.types.list_schema_mappings_output.ListSchemaMappingsOutput, zapros.Response]:
