"""Generated from Smithy shape ``com.amazonaws.entityresolution#CreateIdMappingWorkflow``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_entityresolution.errors.conflict_exception
            raise aws_sdk_entityresolution.errors.conflict_exception.ConflictException.from_json(data)
        case "ExceedsLimitException":
            import aws_sdk_entityresolution.errors.exceeds_limit_exception
            raise aws_sdk_entityresolution.errors.exceeds_limit_exception.ExceedsLimitException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.create_id_mapping_workflow_output.CreateIdMappingWorkflowOutput:
    import aws_sdk_entityresolution.types.create_id_mapping_workflow_output
    out: aws_sdk_entityresolution.types.create_id_mapping_workflow_output.CreateIdMappingWorkflowOutput = aws_sdk_entityresolution.types.create_id_mapping_workflow_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.create_id_mapping_workflow_input.CreateIdMappingWorkflowInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/idmappingworkflows"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_entityresolution.types.create_id_mapping_workflow_input
    body: bytes | None = json.dumps(aws_sdk_entityresolution.types.create_id_mapping_workflow_input.serialize_json(input)).encode()
...
def create_id_mapping_workflow(options: OperationOptions, input: aws_sdk_entityresolution.types.create_id_mapping_workflow_input.CreateIdMappingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.create_id_mapping_workflow_output.CreateIdMappingWorkflowOutput, zapros.Response]:
...
async def async_create_id_mapping_workflow(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.create_id_mapping_workflow_input.CreateIdMappingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.create_id_mapping_workflow_output.CreateIdMappingWorkflowOutput, zapros.Response]:
