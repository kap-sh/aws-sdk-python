...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            ...
            raise aws_sdk_entityresolution.errors.conflict_exception.ConflictException.from_json(
                data
            )
        case "ExceedsLimitException":
            import aws_sdk_entityresolution.errors.exceeds_limit_exception

            raise aws_sdk_entityresolution.errors.exceeds_limit_exception.ExceedsLimitException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.create_id_mapping_workflow_output.CreateIdMappingWorkflowOutput = aws_sdk_entityresolution.types.create_id_mapping_workflow_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.create_id_mapping_workflow_input.CreateIdMappingWorkflowInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.create_id_mapping_workflow_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_id_mapping_workflow(
