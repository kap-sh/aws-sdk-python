...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.delete_policy_statement_output.DeletePolicyStatementOutput = aws_sdk_entityresolution.types.delete_policy_statement_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.delete_policy_statement_input.DeletePolicyStatementInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_policy_statement(
