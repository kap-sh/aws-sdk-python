"""Generated from Smithy shape ``com.amazonaws.entityresolution#DeletePolicyStatement``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.delete_policy_statement_output.DeletePolicyStatementOutput:
    import aws_sdk_entityresolution.types.delete_policy_statement_output
    out: aws_sdk_entityresolution.types.delete_policy_statement_output.DeletePolicyStatementOutput = aws_sdk_entityresolution.types.delete_policy_statement_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.delete_policy_statement_input.DeletePolicyStatementInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/policies/{arn}/{statementId}"
...
def delete_policy_statement(options: OperationOptions, input: aws_sdk_entityresolution.types.delete_policy_statement_input.DeletePolicyStatementInput) -> tuple[aws_sdk_entityresolution.types.delete_policy_statement_output.DeletePolicyStatementOutput, zapros.Response]:
...
async def async_delete_policy_statement(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.delete_policy_statement_input.DeletePolicyStatementInput) -> tuple[aws_sdk_entityresolution.types.delete_policy_statement_output.DeletePolicyStatementOutput, zapros.Response]:
