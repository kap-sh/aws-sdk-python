"""Generated from Smithy shape ``com.amazonaws.entityresolution#BatchDeleteUniqueId``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.batch_delete_unique_id_output.BatchDeleteUniqueIdOutput:
    import aws_sdk_entityresolution.types.batch_delete_unique_id_output
    out: aws_sdk_entityresolution.types.batch_delete_unique_id_output.BatchDeleteUniqueIdOutput = aws_sdk_entityresolution.types.batch_delete_unique_id_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.batch_delete_unique_id_input.BatchDeleteUniqueIdInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/matchingworkflows/{workflowName}/uniqueids"
    url = url.replace("{workflowName}", quote(str(input["workflow_name"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    if "input_source" in input:
        headers["inputSource"] = str(input["input_source"])
    if "unique_ids" in input:
        headers["uniqueIds"] = str(input["unique_ids"])
    body: bytes | None = b""
...
def batch_delete_unique_id(options: OperationOptions, input: aws_sdk_entityresolution.types.batch_delete_unique_id_input.BatchDeleteUniqueIdInput) -> tuple[aws_sdk_entityresolution.types.batch_delete_unique_id_output.BatchDeleteUniqueIdOutput, zapros.Response]:
...
async def async_batch_delete_unique_id(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.batch_delete_unique_id_input.BatchDeleteUniqueIdInput) -> tuple[aws_sdk_entityresolution.types.batch_delete_unique_id_output.BatchDeleteUniqueIdOutput, zapros.Response]:
