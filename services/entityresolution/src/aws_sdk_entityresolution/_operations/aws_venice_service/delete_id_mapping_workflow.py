"""Generated from Smithy shape ``com.amazonaws.entityresolution#DeleteIdMappingWorkflow``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.delete_id_mapping_workflow_output.DeleteIdMappingWorkflowOutput:
    import aws_sdk_entityresolution.types.delete_id_mapping_workflow_output
    out: aws_sdk_entityresolution.types.delete_id_mapping_workflow_output.DeleteIdMappingWorkflowOutput = aws_sdk_entityresolution.types.delete_id_mapping_workflow_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.delete_id_mapping_workflow_input.DeleteIdMappingWorkflowInput) -> zapros.Request:
...
def delete_id_mapping_workflow(options: OperationOptions, input: aws_sdk_entityresolution.types.delete_id_mapping_workflow_input.DeleteIdMappingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.delete_id_mapping_workflow_output.DeleteIdMappingWorkflowOutput, zapros.Response]:
...
async def async_delete_id_mapping_workflow(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.delete_id_mapping_workflow_input.DeleteIdMappingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.delete_id_mapping_workflow_output.DeleteIdMappingWorkflowOutput, zapros.Response]:
