...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.delete_id_mapping_workflow_output.DeleteIdMappingWorkflowOutput = aws_sdk_entityresolution.types.delete_id_mapping_workflow_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.delete_id_mapping_workflow_input.DeleteIdMappingWorkflowInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_id_mapping_workflow(
