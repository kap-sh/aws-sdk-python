...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.create_schema_mapping_output.CreateSchemaMappingOutput = aws_sdk_entityresolution.types.create_schema_mapping_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_entityresolution.types.create_schema_mapping_input.CreateSchemaMappingInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.create_schema_mapping_input.serialize_json(input)
    ).encode()
