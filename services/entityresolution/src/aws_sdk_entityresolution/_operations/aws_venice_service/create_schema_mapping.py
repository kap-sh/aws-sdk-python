...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.create_schema_mapping_output.CreateSchemaMappingOutput:
    import aws_sdk_entityresolution.types.create_schema_mapping_output
    out: aws_sdk_entityresolution.types.create_schema_mapping_output.CreateSchemaMappingOutput = aws_sdk_entityresolution.types.create_schema_mapping_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.create_schema_mapping_input.CreateSchemaMappingInput) -> zapros.Request:
    ...
    import aws_sdk_entityresolution.types.create_schema_mapping_input
    body: bytes | None = json.dumps(aws_sdk_entityresolution.types.create_schema_mapping_input.serialize_json(input)).encode()
...
def create_schema_mapping(options: OperationOptions, input: aws_sdk_entityresolution.types.create_schema_mapping_input.CreateSchemaMappingInput) -> tuple[aws_sdk_entityresolution.types.create_schema_mapping_output.CreateSchemaMappingOutput, zapros.Response]:
...
async def async_create_schema_mapping(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.create_schema_mapping_input.CreateSchemaMappingInput) -> tuple[aws_sdk_entityresolution.types.create_schema_mapping_output.CreateSchemaMappingOutput, zapros.Response]:
