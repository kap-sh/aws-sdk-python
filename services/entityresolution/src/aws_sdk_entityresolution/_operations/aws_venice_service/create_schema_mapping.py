...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.create_schema_mapping_input.CreateSchemaMappingInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.create_schema_mapping_input.serialize_json(
            input_
        )
    ).encode()
