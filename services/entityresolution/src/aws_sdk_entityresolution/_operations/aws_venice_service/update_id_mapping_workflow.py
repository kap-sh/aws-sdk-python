"""Generated from Smithy shape ``com.amazonaws.entityresolution#UpdateIdMappingWorkflow``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.update_id_mapping_workflow_output.UpdateIdMappingWorkflowOutput:
    import aws_sdk_entityresolution.types.update_id_mapping_workflow_output
    out: aws_sdk_entityresolution.types.update_id_mapping_workflow_output.UpdateIdMappingWorkflowOutput = aws_sdk_entityresolution.types.update_id_mapping_workflow_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.update_id_mapping_workflow_input.UpdateIdMappingWorkflowInput) -> zapros.Request:
    ...
    import aws_sdk_entityresolution.types.update_id_mapping_workflow_input
    body: bytes | None = json.dumps(aws_sdk_entityresolution.types.update_id_mapping_workflow_input.serialize_json(input)).encode()
...
def update_id_mapping_workflow(options: OperationOptions, input: aws_sdk_entityresolution.types.update_id_mapping_workflow_input.UpdateIdMappingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.update_id_mapping_workflow_output.UpdateIdMappingWorkflowOutput, zapros.Response]:
...
async def async_update_id_mapping_workflow(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.update_id_mapping_workflow_input.UpdateIdMappingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.update_id_mapping_workflow_output.UpdateIdMappingWorkflowOutput, zapros.Response]:
