...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.update_id_mapping_workflow_output.UpdateIdMappingWorkflowOutput = aws_sdk_entityresolution.types.update_id_mapping_workflow_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.update_id_mapping_workflow_input.UpdateIdMappingWorkflowInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.update_id_mapping_workflow_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_id_mapping_workflow(
