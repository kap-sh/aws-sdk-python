...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.get_matching_workflow_output.GetMatchingWorkflowOutput:
    import aws_sdk_entityresolution.types.get_matching_workflow_output
    out: aws_sdk_entityresolution.types.get_matching_workflow_output.GetMatchingWorkflowOutput = aws_sdk_entityresolution.types.get_matching_workflow_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_matching_workflow_input.GetMatchingWorkflowInput) -> zapros.Request:
...
def get_matching_workflow(options: OperationOptions, input: aws_sdk_entityresolution.types.get_matching_workflow_input.GetMatchingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.get_matching_workflow_output.GetMatchingWorkflowOutput, zapros.Response]:
...
async def async_get_matching_workflow(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_matching_workflow_input.GetMatchingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.get_matching_workflow_output.GetMatchingWorkflowOutput, zapros.Response]:
