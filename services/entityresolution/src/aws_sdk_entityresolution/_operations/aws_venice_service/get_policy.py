...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.get_policy_output.GetPolicyOutput = (
        aws_sdk_entityresolution.types.get_policy_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.get_policy_input.GetPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_policy(
    ...
    aws_sdk_entityresolution.types.get_policy_output.GetPolicyOutput, zapros.Response
]:
