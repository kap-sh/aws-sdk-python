...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.get_policy_output.GetPolicyOutput:
    import aws_sdk_entityresolution.types.get_policy_output
    out: aws_sdk_entityresolution.types.get_policy_output.GetPolicyOutput = aws_sdk_entityresolution.types.get_policy_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_policy_input.GetPolicyInput) -> zapros.Request:
...
def get_policy(options: OperationOptions, input: aws_sdk_entityresolution.types.get_policy_input.GetPolicyInput) -> tuple[aws_sdk_entityresolution.types.get_policy_output.GetPolicyOutput, zapros.Response]:
...
async def async_get_policy(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_policy_input.GetPolicyInput) -> tuple[aws_sdk_entityresolution.types.get_policy_output.GetPolicyOutput, zapros.Response]:
