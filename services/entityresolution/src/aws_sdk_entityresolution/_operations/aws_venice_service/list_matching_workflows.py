...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.list_matching_workflows_output.ListMatchingWorkflowsOutput:
    import aws_sdk_entityresolution.types.list_matching_workflows_output
    out: aws_sdk_entityresolution.types.list_matching_workflows_output.ListMatchingWorkflowsOutput = aws_sdk_entityresolution.types.list_matching_workflows_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_matching_workflows_input.ListMatchingWorkflowsInput) -> zapros.Request:
...
def list_matching_workflows(options: OperationOptions, input: aws_sdk_entityresolution.types.list_matching_workflows_input.ListMatchingWorkflowsInput) -> tuple[aws_sdk_entityresolution.types.list_matching_workflows_output.ListMatchingWorkflowsOutput, zapros.Response]:
...
async def async_list_matching_workflows(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_matching_workflows_input.ListMatchingWorkflowsInput) -> tuple[aws_sdk_entityresolution.types.list_matching_workflows_output.ListMatchingWorkflowsOutput, zapros.Response]:
