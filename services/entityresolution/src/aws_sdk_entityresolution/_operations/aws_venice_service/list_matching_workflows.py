...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.list_matching_workflows_output.ListMatchingWorkflowsOutput = aws_sdk_entityresolution.types.list_matching_workflows_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.list_matching_workflows_input.ListMatchingWorkflowsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
