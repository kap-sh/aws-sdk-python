...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.update_matching_workflow_output.UpdateMatchingWorkflowOutput = aws_sdk_entityresolution.types.update_matching_workflow_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.update_matching_workflow_input.UpdateMatchingWorkflowInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.update_matching_workflow_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_matching_workflow(
