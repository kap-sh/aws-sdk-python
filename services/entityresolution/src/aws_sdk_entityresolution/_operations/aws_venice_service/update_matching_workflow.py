"""Generated from Smithy shape ``com.amazonaws.entityresolution#UpdateMatchingWorkflow``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.update_matching_workflow_output.UpdateMatchingWorkflowOutput:
    import aws_sdk_entityresolution.types.update_matching_workflow_output
    out: aws_sdk_entityresolution.types.update_matching_workflow_output.UpdateMatchingWorkflowOutput = aws_sdk_entityresolution.types.update_matching_workflow_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.update_matching_workflow_input.UpdateMatchingWorkflowInput) -> zapros.Request:
    ...
    import aws_sdk_entityresolution.types.update_matching_workflow_input
    body: bytes | None = json.dumps(aws_sdk_entityresolution.types.update_matching_workflow_input.serialize_json(input)).encode()
...
def update_matching_workflow(options: OperationOptions, input: aws_sdk_entityresolution.types.update_matching_workflow_input.UpdateMatchingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.update_matching_workflow_output.UpdateMatchingWorkflowOutput, zapros.Response]:
...
async def async_update_matching_workflow(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.update_matching_workflow_input.UpdateMatchingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.update_matching_workflow_output.UpdateMatchingWorkflowOutput, zapros.Response]:
