...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.list_id_namespaces_output.ListIdNamespacesOutput:
    import aws_sdk_entityresolution.types.list_id_namespaces_output
    out: aws_sdk_entityresolution.types.list_id_namespaces_output.ListIdNamespacesOutput = aws_sdk_entityresolution.types.list_id_namespaces_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_id_namespaces_input.ListIdNamespacesInput) -> zapros.Request:
...
def list_id_namespaces(options: OperationOptions, input: aws_sdk_entityresolution.types.list_id_namespaces_input.ListIdNamespacesInput) -> tuple[aws_sdk_entityresolution.types.list_id_namespaces_output.ListIdNamespacesOutput, zapros.Response]:
...
async def async_list_id_namespaces(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_id_namespaces_input.ListIdNamespacesInput) -> tuple[aws_sdk_entityresolution.types.list_id_namespaces_output.ListIdNamespacesOutput, zapros.Response]:
