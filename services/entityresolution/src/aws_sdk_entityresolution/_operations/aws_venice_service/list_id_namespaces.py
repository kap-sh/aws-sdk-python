...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.list_id_namespaces_output.ListIdNamespacesOutput = aws_sdk_entityresolution.types.list_id_namespaces_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.list_id_namespaces_input.ListIdNamespacesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
