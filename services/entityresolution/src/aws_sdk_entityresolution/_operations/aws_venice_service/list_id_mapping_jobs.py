...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.list_id_mapping_jobs_output.ListIdMappingJobsOutput = aws_sdk_entityresolution.types.list_id_mapping_jobs_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.list_id_mapping_jobs_input.ListIdMappingJobsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_id_mapping_jobs(
