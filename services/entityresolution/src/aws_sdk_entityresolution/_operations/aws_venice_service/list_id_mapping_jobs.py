"""Generated from Smithy shape ``com.amazonaws.entityresolution#ListIdMappingJobs``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.list_id_mapping_jobs_output.ListIdMappingJobsOutput:
    import aws_sdk_entityresolution.types.list_id_mapping_jobs_output
    out: aws_sdk_entityresolution.types.list_id_mapping_jobs_output.ListIdMappingJobsOutput = aws_sdk_entityresolution.types.list_id_mapping_jobs_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_id_mapping_jobs_input.ListIdMappingJobsInput) -> zapros.Request:
...
def list_id_mapping_jobs(options: OperationOptions, input: aws_sdk_entityresolution.types.list_id_mapping_jobs_input.ListIdMappingJobsInput) -> tuple[aws_sdk_entityresolution.types.list_id_mapping_jobs_output.ListIdMappingJobsOutput, zapros.Response]:
...
async def async_list_id_mapping_jobs(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_id_mapping_jobs_input.ListIdMappingJobsInput) -> tuple[aws_sdk_entityresolution.types.list_id_mapping_jobs_output.ListIdMappingJobsOutput, zapros.Response]:
