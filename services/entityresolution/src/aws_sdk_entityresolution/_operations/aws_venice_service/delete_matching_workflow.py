...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.delete_matching_workflow_output.DeleteMatchingWorkflowOutput = aws_sdk_entityresolution.types.delete_matching_workflow_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.delete_matching_workflow_input.DeleteMatchingWorkflowInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_matching_workflow(
