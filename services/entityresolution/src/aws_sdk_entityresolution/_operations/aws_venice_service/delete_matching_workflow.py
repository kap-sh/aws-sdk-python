"""Generated from Smithy shape ``com.amazonaws.entityresolution#DeleteMatchingWorkflow``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.delete_matching_workflow_output.DeleteMatchingWorkflowOutput:
    import aws_sdk_entityresolution.types.delete_matching_workflow_output
    out: aws_sdk_entityresolution.types.delete_matching_workflow_output.DeleteMatchingWorkflowOutput = aws_sdk_entityresolution.types.delete_matching_workflow_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.delete_matching_workflow_input.DeleteMatchingWorkflowInput) -> zapros.Request:
...
def delete_matching_workflow(options: OperationOptions, input: aws_sdk_entityresolution.types.delete_matching_workflow_input.DeleteMatchingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.delete_matching_workflow_output.DeleteMatchingWorkflowOutput, zapros.Response]:
...
async def async_delete_matching_workflow(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.delete_matching_workflow_input.DeleteMatchingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.delete_matching_workflow_output.DeleteMatchingWorkflowOutput, zapros.Response]:
