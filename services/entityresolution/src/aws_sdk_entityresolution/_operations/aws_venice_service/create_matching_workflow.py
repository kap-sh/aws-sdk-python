...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.create_matching_workflow_output.CreateMatchingWorkflowOutput:
    import aws_sdk_entityresolution.types.create_matching_workflow_output
    out: aws_sdk_entityresolution.types.create_matching_workflow_output.CreateMatchingWorkflowOutput = aws_sdk_entityresolution.types.create_matching_workflow_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.create_matching_workflow_input.CreateMatchingWorkflowInput) -> zapros.Request:
    ...
    import aws_sdk_entityresolution.types.create_matching_workflow_input
    body: bytes | None = json.dumps(aws_sdk_entityresolution.types.create_matching_workflow_input.serialize_json(input)).encode()
...
def create_matching_workflow(options: OperationOptions, input: aws_sdk_entityresolution.types.create_matching_workflow_input.CreateMatchingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.create_matching_workflow_output.CreateMatchingWorkflowOutput, zapros.Response]:
...
async def async_create_matching_workflow(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.create_matching_workflow_input.CreateMatchingWorkflowInput) -> tuple[aws_sdk_entityresolution.types.create_matching_workflow_output.CreateMatchingWorkflowOutput, zapros.Response]:
