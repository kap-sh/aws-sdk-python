"""Generated from Smithy shape ``com.amazonaws.entityresolution#GenerateMatchId``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.generate_match_id_output.GenerateMatchIdOutput:
    import aws_sdk_entityresolution.types.generate_match_id_output
    out: aws_sdk_entityresolution.types.generate_match_id_output.GenerateMatchIdOutput = aws_sdk_entityresolution.types.generate_match_id_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.generate_match_id_input.GenerateMatchIdInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/matchingworkflows/{workflowName}/generateMatches"
    url = url.replace("{workflowName}", quote(str(input["workflow_name"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_entityresolution.types.generate_match_id_input
    body: bytes | None = json.dumps(aws_sdk_entityresolution.types.generate_match_id_input.serialize_json(input)).encode()
...
def generate_match_id(options: OperationOptions, input: aws_sdk_entityresolution.types.generate_match_id_input.GenerateMatchIdInput) -> tuple[aws_sdk_entityresolution.types.generate_match_id_output.GenerateMatchIdOutput, zapros.Response]:
...
async def async_generate_match_id(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.generate_match_id_input.GenerateMatchIdInput) -> tuple[aws_sdk_entityresolution.types.generate_match_id_output.GenerateMatchIdOutput, zapros.Response]:
