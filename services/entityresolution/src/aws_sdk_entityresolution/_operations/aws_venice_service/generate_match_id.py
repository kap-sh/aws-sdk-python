...
def build_request(
    ...
    input: aws_sdk_entityresolution.types.generate_match_id_input.GenerateMatchIdInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.generate_match_id_input.serialize_json(input)
    ).encode()
