...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.generate_match_id_output.GenerateMatchIdOutput = aws_sdk_entityresolution.types.generate_match_id_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.generate_match_id_input.GenerateMatchIdInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.generate_match_id_input.serialize_json(input_)
    ).encode()
...
async def async_generate_match_id(
