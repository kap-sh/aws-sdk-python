...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.get_matching_job_output.GetMatchingJobOutput = (
        aws_sdk_entityresolution.types.get_matching_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.get_matching_job_input.GetMatchingJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_matching_job(
