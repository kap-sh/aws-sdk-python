"""Generated from Smithy shape ``com.amazonaws.entityresolution#GetMatchingJob``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.get_matching_job_output.GetMatchingJobOutput:
    import aws_sdk_entityresolution.types.get_matching_job_output
    out: aws_sdk_entityresolution.types.get_matching_job_output.GetMatchingJobOutput = aws_sdk_entityresolution.types.get_matching_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_matching_job_input.GetMatchingJobInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/matchingworkflows/{workflowName}/jobs/{jobId}"
...
def get_matching_job(options: OperationOptions, input: aws_sdk_entityresolution.types.get_matching_job_input.GetMatchingJobInput) -> tuple[aws_sdk_entityresolution.types.get_matching_job_output.GetMatchingJobOutput, zapros.Response]:
...
async def async_get_matching_job(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_matching_job_input.GetMatchingJobInput) -> tuple[aws_sdk_entityresolution.types.get_matching_job_output.GetMatchingJobOutput, zapros.Response]:
