...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.put_policy_output.PutPolicyOutput = (
        aws_sdk_entityresolution.types.put_policy_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_entityresolution.types.put_policy_input.PutPolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.put_policy_input.serialize_json(input)
    ).encode()
...
def put_policy(
    ...
    aws_sdk_entityresolution.types.put_policy_output.PutPolicyOutput, zapros.Response
]:
