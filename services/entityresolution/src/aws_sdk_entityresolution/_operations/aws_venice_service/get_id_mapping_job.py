"""Generated from Smithy shape ``com.amazonaws.entityresolution#GetIdMappingJob``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.get_id_mapping_job_output.GetIdMappingJobOutput:
    import aws_sdk_entityresolution.types.get_id_mapping_job_output
    out: aws_sdk_entityresolution.types.get_id_mapping_job_output.GetIdMappingJobOutput = aws_sdk_entityresolution.types.get_id_mapping_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_id_mapping_job_input.GetIdMappingJobInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/idmappingworkflows/{workflowName}/jobs/{jobId}"
...
def get_id_mapping_job(options: OperationOptions, input: aws_sdk_entityresolution.types.get_id_mapping_job_input.GetIdMappingJobInput) -> tuple[aws_sdk_entityresolution.types.get_id_mapping_job_output.GetIdMappingJobOutput, zapros.Response]:
...
async def async_get_id_mapping_job(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_id_mapping_job_input.GetIdMappingJobInput) -> tuple[aws_sdk_entityresolution.types.get_id_mapping_job_output.GetIdMappingJobOutput, zapros.Response]:
