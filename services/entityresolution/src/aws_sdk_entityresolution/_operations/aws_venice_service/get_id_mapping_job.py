...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.get_id_mapping_job_output.GetIdMappingJobOutput = aws_sdk_entityresolution.types.get_id_mapping_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.get_id_mapping_job_input.GetIdMappingJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_id_mapping_job(
