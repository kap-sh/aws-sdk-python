...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.list_id_mapping_workflows_output.ListIdMappingWorkflowsOutput:
    import aws_sdk_entityresolution.types.list_id_mapping_workflows_output
    out: aws_sdk_entityresolution.types.list_id_mapping_workflows_output.ListIdMappingWorkflowsOutput = aws_sdk_entityresolution.types.list_id_mapping_workflows_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_id_mapping_workflows_input.ListIdMappingWorkflowsInput) -> zapros.Request:
...
def list_id_mapping_workflows(options: OperationOptions, input: aws_sdk_entityresolution.types.list_id_mapping_workflows_input.ListIdMappingWorkflowsInput) -> tuple[aws_sdk_entityresolution.types.list_id_mapping_workflows_output.ListIdMappingWorkflowsOutput, zapros.Response]:
...
async def async_list_id_mapping_workflows(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_id_mapping_workflows_input.ListIdMappingWorkflowsInput) -> tuple[aws_sdk_entityresolution.types.list_id_mapping_workflows_output.ListIdMappingWorkflowsOutput, zapros.Response]:
