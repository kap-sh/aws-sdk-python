...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.list_id_mapping_workflows_output.ListIdMappingWorkflowsOutput = aws_sdk_entityresolution.types.list_id_mapping_workflows_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.list_id_mapping_workflows_input.ListIdMappingWorkflowsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
