...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.list_tags_for_resource_output.ListTagsForResourceOutput:
    import aws_sdk_entityresolution.types.list_tags_for_resource_output
    out: aws_sdk_entityresolution.types.list_tags_for_resource_output.ListTagsForResourceOutput = aws_sdk_entityresolution.types.list_tags_for_resource_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_tags_for_resource_input.ListTagsForResourceInput) -> zapros.Request:
...
def list_tags_for_resource(options: OperationOptions, input: aws_sdk_entityresolution.types.list_tags_for_resource_input.ListTagsForResourceInput) -> tuple[aws_sdk_entityresolution.types.list_tags_for_resource_output.ListTagsForResourceOutput, zapros.Response]:
...
async def async_list_tags_for_resource(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_tags_for_resource_input.ListTagsForResourceInput) -> tuple[aws_sdk_entityresolution.types.list_tags_for_resource_output.ListTagsForResourceOutput, zapros.Response]:
