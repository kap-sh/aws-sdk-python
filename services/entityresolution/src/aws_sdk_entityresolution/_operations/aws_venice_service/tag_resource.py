"""Generated from Smithy shape ``com.amazonaws.entityresolution#TagResource``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.tag_resource_output.TagResourceOutput:
    out: aws_sdk_entityresolution.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.tag_resource_input.TagResourceInput) -> zapros.Request:
    ...
    import aws_sdk_entityresolution.types.tag_resource_input
    body: bytes | None = json.dumps(aws_sdk_entityresolution.types.tag_resource_input.serialize_json(input)).encode()
...
def tag_resource(options: OperationOptions, input: aws_sdk_entityresolution.types.tag_resource_input.TagResourceInput) -> tuple[aws_sdk_entityresolution.types.tag_resource_output.TagResourceOutput, zapros.Response]:
...
async def async_tag_resource(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.tag_resource_input.TagResourceInput) -> tuple[aws_sdk_entityresolution.types.tag_resource_output.TagResourceOutput, zapros.Response]:
