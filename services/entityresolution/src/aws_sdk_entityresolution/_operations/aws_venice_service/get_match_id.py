...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.get_match_id_output.GetMatchIdOutput = (
        aws_sdk_entityresolution.types.get_match_id_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.get_match_id_input.GetMatchIdInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.get_match_id_input.serialize_json(input_)
    ).encode()
...
def get_match_id(
    ...
    aws_sdk_entityresolution.types.get_match_id_output.GetMatchIdOutput, zapros.Response
]:
