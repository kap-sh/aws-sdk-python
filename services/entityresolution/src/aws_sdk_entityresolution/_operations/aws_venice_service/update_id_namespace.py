...
def build_request(
    ...
    input: aws_sdk_entityresolution.types.update_id_namespace_input.UpdateIdNamespaceInput,
) -> zapros.Request:
    ...
    url = url.replace(
        "{idNamespaceName}", quote(str(input["id_namespace_name"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.update_id_namespace_input.serialize_json(input)
    ).encode()
