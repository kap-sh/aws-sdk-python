"""Generated from Smithy shape ``com.amazonaws.entityresolution#UpdateIdNamespace``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.update_id_namespace_output.UpdateIdNamespaceOutput:
    import aws_sdk_entityresolution.types.update_id_namespace_output
    out: aws_sdk_entityresolution.types.update_id_namespace_output.UpdateIdNamespaceOutput = aws_sdk_entityresolution.types.update_id_namespace_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.update_id_namespace_input.UpdateIdNamespaceInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/idnamespaces/{idNamespaceName}"
    url = url.replace("{idNamespaceName}", quote(str(input["id_namespace_name"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_entityresolution.types.update_id_namespace_input
    body: bytes | None = json.dumps(aws_sdk_entityresolution.types.update_id_namespace_input.serialize_json(input)).encode()
...
def update_id_namespace(options: OperationOptions, input: aws_sdk_entityresolution.types.update_id_namespace_input.UpdateIdNamespaceInput) -> tuple[aws_sdk_entityresolution.types.update_id_namespace_output.UpdateIdNamespaceOutput, zapros.Response]:
...
async def async_update_id_namespace(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.update_id_namespace_input.UpdateIdNamespaceInput) -> tuple[aws_sdk_entityresolution.types.update_id_namespace_output.UpdateIdNamespaceOutput, zapros.Response]:
