...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.update_schema_mapping_output.UpdateSchemaMappingOutput = aws_sdk_entityresolution.types.update_schema_mapping_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_entityresolution.types.update_schema_mapping_input.UpdateSchemaMappingInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.update_schema_mapping_input.serialize_json(input)
    ).encode()
...
async def async_update_schema_mapping(
