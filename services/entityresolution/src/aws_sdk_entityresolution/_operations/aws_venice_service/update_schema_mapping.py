"""Generated from Smithy shape ``com.amazonaws.entityresolution#UpdateSchemaMapping``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.update_schema_mapping_output.UpdateSchemaMappingOutput:
    import aws_sdk_entityresolution.types.update_schema_mapping_output
    out: aws_sdk_entityresolution.types.update_schema_mapping_output.UpdateSchemaMappingOutput = aws_sdk_entityresolution.types.update_schema_mapping_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.update_schema_mapping_input.UpdateSchemaMappingInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/schemas/{schemaName}"
    url = url.replace("{schemaName}", quote(str(input["schema_name"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_entityresolution.types.update_schema_mapping_input
    body: bytes | None = json.dumps(aws_sdk_entityresolution.types.update_schema_mapping_input.serialize_json(input)).encode()
...
def update_schema_mapping(options: OperationOptions, input: aws_sdk_entityresolution.types.update_schema_mapping_input.UpdateSchemaMappingInput) -> tuple[aws_sdk_entityresolution.types.update_schema_mapping_output.UpdateSchemaMappingOutput, zapros.Response]:
...
async def async_update_schema_mapping(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.update_schema_mapping_input.UpdateSchemaMappingInput) -> tuple[aws_sdk_entityresolution.types.update_schema_mapping_output.UpdateSchemaMappingOutput, zapros.Response]:
