...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.add_policy_statement_output.AddPolicyStatementOutput = aws_sdk_entityresolution.types.add_policy_statement_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_entityresolution.types.add_policy_statement_input.AddPolicyStatementInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.add_policy_statement_input.serialize_json(input)
    ).encode()
