...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.add_policy_statement_output.AddPolicyStatementOutput:
    import aws_sdk_entityresolution.types.add_policy_statement_output
    out: aws_sdk_entityresolution.types.add_policy_statement_output.AddPolicyStatementOutput = aws_sdk_entityresolution.types.add_policy_statement_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.add_policy_statement_input.AddPolicyStatementInput) -> zapros.Request:
    ...
    import aws_sdk_entityresolution.types.add_policy_statement_input
    body: bytes | None = json.dumps(aws_sdk_entityresolution.types.add_policy_statement_input.serialize_json(input)).encode()
...
def add_policy_statement(options: OperationOptions, input: aws_sdk_entityresolution.types.add_policy_statement_input.AddPolicyStatementInput) -> tuple[aws_sdk_entityresolution.types.add_policy_statement_output.AddPolicyStatementOutput, zapros.Response]:
...
async def async_add_policy_statement(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.add_policy_statement_input.AddPolicyStatementInput) -> tuple[aws_sdk_entityresolution.types.add_policy_statement_output.AddPolicyStatementOutput, zapros.Response]:
