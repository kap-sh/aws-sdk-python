"""Generated from Smithy shape ``com.amazonaws.entityresolution#DeleteSchemaMapping``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.delete_schema_mapping_output.DeleteSchemaMappingOutput:
    import aws_sdk_entityresolution.types.delete_schema_mapping_output
    out: aws_sdk_entityresolution.types.delete_schema_mapping_output.DeleteSchemaMappingOutput = aws_sdk_entityresolution.types.delete_schema_mapping_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.delete_schema_mapping_input.DeleteSchemaMappingInput) -> zapros.Request:
...
def delete_schema_mapping(options: OperationOptions, input: aws_sdk_entityresolution.types.delete_schema_mapping_input.DeleteSchemaMappingInput) -> tuple[aws_sdk_entityresolution.types.delete_schema_mapping_output.DeleteSchemaMappingOutput, zapros.Response]:
...
async def async_delete_schema_mapping(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.delete_schema_mapping_input.DeleteSchemaMappingInput) -> tuple[aws_sdk_entityresolution.types.delete_schema_mapping_output.DeleteSchemaMappingOutput, zapros.Response]:
