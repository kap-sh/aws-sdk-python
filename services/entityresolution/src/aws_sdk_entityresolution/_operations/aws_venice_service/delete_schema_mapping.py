...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.delete_schema_mapping_output.DeleteSchemaMappingOutput = aws_sdk_entityresolution.types.delete_schema_mapping_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.delete_schema_mapping_input.DeleteSchemaMappingInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_schema_mapping(
