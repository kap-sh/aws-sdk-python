...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.get_id_mapping_workflow_output.GetIdMappingWorkflowOutput = aws_sdk_entityresolution.types.get_id_mapping_workflow_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.get_id_mapping_workflow_input.GetIdMappingWorkflowInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_id_mapping_workflow(
