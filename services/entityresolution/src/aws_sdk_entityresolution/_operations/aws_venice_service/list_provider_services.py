...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.list_provider_services_output.ListProviderServicesOutput = aws_sdk_entityresolution.types.list_provider_services_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_entityresolution.types.list_provider_services_input.ListProviderServicesInput,
) -> zapros.Request:
...
async def async_list_provider_services(
