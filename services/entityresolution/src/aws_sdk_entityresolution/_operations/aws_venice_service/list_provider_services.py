"""Generated from Smithy shape ``com.amazonaws.entityresolution#ListProviderServices``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.list_provider_services_output.ListProviderServicesOutput:
    import aws_sdk_entityresolution.types.list_provider_services_output
    out: aws_sdk_entityresolution.types.list_provider_services_output.ListProviderServicesOutput = aws_sdk_entityresolution.types.list_provider_services_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_provider_services_input.ListProviderServicesInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/providerservices"
    params: dict[str, str] = {}
    if "next_token" in input:
        params["nextToken"] = str(input["next_token"])
    if "max_results" in input:
        params["maxResults"] = str(input["max_results"])
    if "provider_name" in input:
        params["providerName"] = str(input["provider_name"])
...
def list_provider_services(options: OperationOptions, input: aws_sdk_entityresolution.types.list_provider_services_input.ListProviderServicesInput) -> tuple[aws_sdk_entityresolution.types.list_provider_services_output.ListProviderServicesOutput, zapros.Response]:
...
async def async_list_provider_services(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_provider_services_input.ListProviderServicesInput) -> tuple[aws_sdk_entityresolution.types.list_provider_services_output.ListProviderServicesOutput, zapros.Response]:
