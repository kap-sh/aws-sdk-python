"""Generated from Smithy shape ``com.amazonaws.entityresolution#GetIdNamespace``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.get_id_namespace_output.GetIdNamespaceOutput:
    import aws_sdk_entityresolution.types.get_id_namespace_output
    out: aws_sdk_entityresolution.types.get_id_namespace_output.GetIdNamespaceOutput = aws_sdk_entityresolution.types.get_id_namespace_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_id_namespace_input.GetIdNamespaceInput) -> zapros.Request:
...
def get_id_namespace(options: OperationOptions, input: aws_sdk_entityresolution.types.get_id_namespace_input.GetIdNamespaceInput) -> tuple[aws_sdk_entityresolution.types.get_id_namespace_output.GetIdNamespaceOutput, zapros.Response]:
...
async def async_get_id_namespace(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_id_namespace_input.GetIdNamespaceInput) -> tuple[aws_sdk_entityresolution.types.get_id_namespace_output.GetIdNamespaceOutput, zapros.Response]:
