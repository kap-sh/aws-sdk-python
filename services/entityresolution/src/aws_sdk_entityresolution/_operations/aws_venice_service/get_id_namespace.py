...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.get_id_namespace_output.GetIdNamespaceOutput = (
        aws_sdk_entityresolution.types.get_id_namespace_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.get_id_namespace_input.GetIdNamespaceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_id_namespace(
