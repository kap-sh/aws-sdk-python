...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.get_schema_mapping_output.GetSchemaMappingOutput = aws_sdk_entityresolution.types.get_schema_mapping_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.get_schema_mapping_input.GetSchemaMappingInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
