...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.get_schema_mapping_output.GetSchemaMappingOutput:
    import aws_sdk_entityresolution.types.get_schema_mapping_output
    out: aws_sdk_entityresolution.types.get_schema_mapping_output.GetSchemaMappingOutput = aws_sdk_entityresolution.types.get_schema_mapping_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_schema_mapping_input.GetSchemaMappingInput) -> zapros.Request:
...
def get_schema_mapping(options: OperationOptions, input: aws_sdk_entityresolution.types.get_schema_mapping_input.GetSchemaMappingInput) -> tuple[aws_sdk_entityresolution.types.get_schema_mapping_output.GetSchemaMappingOutput, zapros.Response]:
...
async def async_get_schema_mapping(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_schema_mapping_input.GetSchemaMappingInput) -> tuple[aws_sdk_entityresolution.types.get_schema_mapping_output.GetSchemaMappingOutput, zapros.Response]:
