...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.start_matching_job_output.StartMatchingJobOutput = aws_sdk_entityresolution.types.start_matching_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.start_matching_job_input.StartMatchingJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
