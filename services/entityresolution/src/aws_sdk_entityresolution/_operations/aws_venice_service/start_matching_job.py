...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.start_matching_job_output.StartMatchingJobOutput:
    import aws_sdk_entityresolution.types.start_matching_job_output
    out: aws_sdk_entityresolution.types.start_matching_job_output.StartMatchingJobOutput = aws_sdk_entityresolution.types.start_matching_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.start_matching_job_input.StartMatchingJobInput) -> zapros.Request:
...
def start_matching_job(options: OperationOptions, input: aws_sdk_entityresolution.types.start_matching_job_input.StartMatchingJobInput) -> tuple[aws_sdk_entityresolution.types.start_matching_job_output.StartMatchingJobOutput, zapros.Response]:
...
async def async_start_matching_job(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.start_matching_job_input.StartMatchingJobInput) -> tuple[aws_sdk_entityresolution.types.start_matching_job_output.StartMatchingJobOutput, zapros.Response]:
