...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.create_id_namespace_output.CreateIdNamespaceOutput:
    import aws_sdk_entityresolution.types.create_id_namespace_output
    out: aws_sdk_entityresolution.types.create_id_namespace_output.CreateIdNamespaceOutput = aws_sdk_entityresolution.types.create_id_namespace_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.create_id_namespace_input.CreateIdNamespaceInput) -> zapros.Request:
    ...
    import aws_sdk_entityresolution.types.create_id_namespace_input
    body: bytes | None = json.dumps(aws_sdk_entityresolution.types.create_id_namespace_input.serialize_json(input)).encode()
...
def create_id_namespace(options: OperationOptions, input: aws_sdk_entityresolution.types.create_id_namespace_input.CreateIdNamespaceInput) -> tuple[aws_sdk_entityresolution.types.create_id_namespace_output.CreateIdNamespaceOutput, zapros.Response]:
...
async def async_create_id_namespace(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.create_id_namespace_input.CreateIdNamespaceInput) -> tuple[aws_sdk_entityresolution.types.create_id_namespace_output.CreateIdNamespaceOutput, zapros.Response]:
