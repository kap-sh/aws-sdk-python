...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.create_id_namespace_output.CreateIdNamespaceOutput = aws_sdk_entityresolution.types.create_id_namespace_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.create_id_namespace_input.CreateIdNamespaceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.create_id_namespace_input.serialize_json(input_)
    ).encode()
