...
def build_request(
    ...
    input: aws_sdk_entityresolution.types.create_id_namespace_input.CreateIdNamespaceInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.create_id_namespace_input.serialize_json(input)
    ).encode()
