...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.list_matching_jobs_output.ListMatchingJobsOutput:
    import aws_sdk_entityresolution.types.list_matching_jobs_output
    out: aws_sdk_entityresolution.types.list_matching_jobs_output.ListMatchingJobsOutput = aws_sdk_entityresolution.types.list_matching_jobs_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_matching_jobs_input.ListMatchingJobsInput) -> zapros.Request:
...
def list_matching_jobs(options: OperationOptions, input: aws_sdk_entityresolution.types.list_matching_jobs_input.ListMatchingJobsInput) -> tuple[aws_sdk_entityresolution.types.list_matching_jobs_output.ListMatchingJobsOutput, zapros.Response]:
...
async def async_list_matching_jobs(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.list_matching_jobs_input.ListMatchingJobsInput) -> tuple[aws_sdk_entityresolution.types.list_matching_jobs_output.ListMatchingJobsOutput, zapros.Response]:
