...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.list_matching_jobs_output.ListMatchingJobsOutput = aws_sdk_entityresolution.types.list_matching_jobs_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_entityresolution.types.list_matching_jobs_input.ListMatchingJobsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
