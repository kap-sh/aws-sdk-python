"""Generated from Smithy shape ``com.amazonaws.entityresolution#StartIdMappingJob``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.start_id_mapping_job_output.StartIdMappingJobOutput:
    import aws_sdk_entityresolution.types.start_id_mapping_job_output
    out: aws_sdk_entityresolution.types.start_id_mapping_job_output.StartIdMappingJobOutput = aws_sdk_entityresolution.types.start_id_mapping_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.start_id_mapping_job_input.StartIdMappingJobInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/idmappingworkflows/{workflowName}/jobs"
    url = url.replace("{workflowName}", quote(str(input["workflow_name"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_entityresolution.types.start_id_mapping_job_input
    body: bytes | None = json.dumps(aws_sdk_entityresolution.types.start_id_mapping_job_input.serialize_json(input)).encode()
...
def start_id_mapping_job(options: OperationOptions, input: aws_sdk_entityresolution.types.start_id_mapping_job_input.StartIdMappingJobInput) -> tuple[aws_sdk_entityresolution.types.start_id_mapping_job_output.StartIdMappingJobOutput, zapros.Response]:
...
async def async_start_id_mapping_job(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.start_id_mapping_job_input.StartIdMappingJobInput) -> tuple[aws_sdk_entityresolution.types.start_id_mapping_job_output.StartIdMappingJobOutput, zapros.Response]:
