...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.start_id_mapping_job_output.StartIdMappingJobOutput = aws_sdk_entityresolution.types.start_id_mapping_job_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_entityresolution.types.start_id_mapping_job_input.StartIdMappingJobInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_entityresolution.types.start_id_mapping_job_input.serialize_json(input)
    ).encode()
...
async def async_start_id_mapping_job(
