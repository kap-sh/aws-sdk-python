...
def handle_response(
    ...
    out: aws_sdk_entityresolution.types.get_provider_service_output.GetProviderServiceOutput = aws_sdk_entityresolution.types.get_provider_service_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_entityresolution.types.get_provider_service_input.GetProviderServiceInput,
) -> zapros.Request:
    ...
    url = url.replace(
        "{providerServiceName}", quote(str(input["provider_service_name"]), safe="")
    )
    params: dict[str, str] = {}
