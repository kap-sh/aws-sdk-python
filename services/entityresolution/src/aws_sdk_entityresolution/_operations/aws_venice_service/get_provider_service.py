...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_entityresolution.types.get_provider_service_output.GetProviderServiceOutput:
    import aws_sdk_entityresolution.types.get_provider_service_output
    out: aws_sdk_entityresolution.types.get_provider_service_output.GetProviderServiceOutput = aws_sdk_entityresolution.types.get_provider_service_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_provider_service_input.GetProviderServiceInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/providerservices/{providerName}/{providerServiceName}"
    url = url.replace("{providerName}", quote(str(input["provider_name"]), safe=""))
    url = url.replace("{providerServiceName}", quote(str(input["provider_service_name"]), safe=""))
    params: dict[str, str] = {}
...
def get_provider_service(options: OperationOptions, input: aws_sdk_entityresolution.types.get_provider_service_input.GetProviderServiceInput) -> tuple[aws_sdk_entityresolution.types.get_provider_service_output.GetProviderServiceOutput, zapros.Response]:
...
async def async_get_provider_service(options: AsyncOperationOptions, input: aws_sdk_entityresolution.types.get_provider_service_input.GetProviderServiceInput) -> tuple[aws_sdk_entityresolution.types.get_provider_service_output.GetProviderServiceOutput, zapros.Response]:
