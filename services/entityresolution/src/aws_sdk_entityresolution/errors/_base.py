...
class EntityResolutionError(Exception):
    """Base class for all EntityResolution service errors."""

class ServiceError(EntityResolutionError):
...
class SerializationError(EntityResolutionError):
    """Raised when a value cannot be serialized."""

class DeserializationError(EntityResolutionError):
...
class WaiterFailedError(EntityResolutionError):
...
class WaiterTimeoutError(EntityResolutionError):
