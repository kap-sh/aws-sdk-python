...
from aws_sdk_entityresolution._auth._signers import SigV4Signer
from aws_sdk_entityresolution._auth._sigv4 import presign_sigv4
...
from aws_sdk_entityresolution._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
from aws_sdk_entityresolution.errors import ServiceError, WaiterFailedError, WaiterTimeoutError
import warnings
...
from aws_sdk_entityresolution._auth._providers import CredentialsProvider, StaticAwsCredentialsProvider
if TYPE_CHECKING:
...
class EntityResolutionClientConfig(TypedDict, total=False):
...
class EntityResolutionClient:
    ...
    def add_policy_statement(self, arn: "aws_sdk_entityresolution.types.venice_global_arn.VeniceGlobalArn", statement_id: "aws_sdk_entityresolution.types.statement_id.StatementId", effect: "aws_sdk_entityresolution.types.statement_effect.StatementEffect", action: "aws_sdk_entityresolution.types.statement_action_list.StatementActionList", principal: "aws_sdk_entityresolution.types.statement_principal_list.StatementPrincipalList", *, config_overrides: Optional[EntityResolutionClientConfig] = None, condition: Optional["aws_sdk_entityresolution.types.statement_condition.StatementCondition"] = None) -> "aws_sdk_entityresolution.types.add_policy_statement_output.AddPolicyStatementOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.add_policy_statement_input.AddPolicyStatementInput]') -> OperationResponse["aws_sdk_entityresolution.types.add_policy_statement_output.AddPolicyStatementOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.add_policy_statement
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.add_policy_statement.add_policy_statement(req.options, req.input)
    ...
    def batch_delete_unique_id(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", unique_ids: "aws_sdk_entityresolution.types.unique_id_list.UniqueIdList", *, config_overrides: Optional[EntityResolutionClientConfig] = None, input_source: Optional[str] = None) -> "aws_sdk_entityresolution.types.batch_delete_unique_id_output.BatchDeleteUniqueIdOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.batch_delete_unique_id_input.BatchDeleteUniqueIdInput]') -> OperationResponse["aws_sdk_entityresolution.types.batch_delete_unique_id_output.BatchDeleteUniqueIdOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.batch_delete_unique_id
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.batch_delete_unique_id.batch_delete_unique_id(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def create_id_mapping_workflow(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", input_source_config: "aws_sdk_entityresolution.types.id_mapping_workflow_input_source_config.IdMappingWorkflowInputSourceConfig", id_mapping_techniques: "aws_sdk_entityresolution.types.id_mapping_techniques.IdMappingTechniques", *, config_overrides: Optional[EntityResolutionClientConfig] = None, description: Optional["aws_sdk_entityresolution.types.description.Description"] = None, output_source_config: Optional["aws_sdk_entityresolution.types.id_mapping_workflow_output_source_config.IdMappingWorkflowOutputSourceConfig"] = None, incremental_run_config: Optional["aws_sdk_entityresolution.types.id_mapping_incremental_run_config.IdMappingIncrementalRunConfig"] = None, role_arn: Optional["aws_sdk_entityresolution.types.id_mapping_role_arn.IdMappingRoleArn"] = None, tags: Optional["aws_sdk_entityresolution.types.tag_map.TagMap"] = None) -> "aws_sdk_entityresolution.types.create_id_mapping_workflow_output.CreateIdMappingWorkflowOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.create_id_mapping_workflow_input.CreateIdMappingWorkflowInput]') -> OperationResponse["aws_sdk_entityresolution.types.create_id_mapping_workflow_output.CreateIdMappingWorkflowOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.create_id_mapping_workflow
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.create_id_mapping_workflow.create_id_mapping_workflow(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def create_id_namespace(self, id_namespace_name: "aws_sdk_entityresolution.types.entity_name.EntityName", type: "aws_sdk_entityresolution.types.id_namespace_type.IdNamespaceType", *, config_overrides: Optional[EntityResolutionClientConfig] = None, description: Optional["aws_sdk_entityresolution.types.description.Description"] = None, input_source_config: Optional["aws_sdk_entityresolution.types.id_namespace_input_source_config.IdNamespaceInputSourceConfig"] = None, id_mapping_workflow_properties: Optional["aws_sdk_entityresolution.types.id_namespace_id_mapping_workflow_properties_list.IdNamespaceIdMappingWorkflowPropertiesList"] = None, role_arn: Optional["aws_sdk_entityresolution.types.role_arn.RoleArn"] = None, tags: Optional["aws_sdk_entityresolution.types.tag_map.TagMap"] = None) -> "aws_sdk_entityresolution.types.create_id_namespace_output.CreateIdNamespaceOutput":
        ...
        Args:
            ...
            tags: <p>The tags used to organize, track, or control access for this resource.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.create_id_namespace_input.CreateIdNamespaceInput]') -> OperationResponse["aws_sdk_entityresolution.types.create_id_namespace_output.CreateIdNamespaceOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.create_id_namespace
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.create_id_namespace.create_id_namespace(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def create_matching_workflow(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", input_source_config: "aws_sdk_entityresolution.types.input_source_config.InputSourceConfig", output_source_config: "aws_sdk_entityresolution.types.output_source_config.OutputSourceConfig", resolution_techniques: "aws_sdk_entityresolution.types.resolution_techniques.ResolutionTechniques", role_arn: str, *, config_overrides: Optional[EntityResolutionClientConfig] = None, description: Optional["aws_sdk_entityresolution.types.description.Description"] = None, incremental_run_config: Optional["aws_sdk_entityresolution.types.incremental_run_config.IncrementalRunConfig"] = None, tags: Optional["aws_sdk_entityresolution.types.tag_map.TagMap"] = None) -> "aws_sdk_entityresolution.types.create_matching_workflow_output.CreateMatchingWorkflowOutput":
        ...
        Args:
            ...
            tags: <p>The tags used to organize, track, or control access for this resource.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.create_matching_workflow_input.CreateMatchingWorkflowInput]') -> OperationResponse["aws_sdk_entityresolution.types.create_matching_workflow_output.CreateMatchingWorkflowOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.create_matching_workflow
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.create_matching_workflow.create_matching_workflow(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def create_schema_mapping(self, schema_name: "aws_sdk_entityresolution.types.entity_name.EntityName", mapped_input_fields: "aws_sdk_entityresolution.types.schema_input_attributes.SchemaInputAttributes", *, config_overrides: Optional[EntityResolutionClientConfig] = None, description: Optional["aws_sdk_entityresolution.types.description.Description"] = None, tags: Optional["aws_sdk_entityresolution.types.tag_map.TagMap"] = None) -> "aws_sdk_entityresolution.types.create_schema_mapping_output.CreateSchemaMappingOutput":
        ...
        Args:
            ...
            tags: <p>The tags used to organize, track, or control access for this resource.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.create_schema_mapping_input.CreateSchemaMappingInput]') -> OperationResponse["aws_sdk_entityresolution.types.create_schema_mapping_output.CreateSchemaMappingOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.create_schema_mapping
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.create_schema_mapping.create_schema_mapping(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_id_mapping_workflow(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.delete_id_mapping_workflow_output.DeleteIdMappingWorkflowOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.delete_id_mapping_workflow_input.DeleteIdMappingWorkflowInput]') -> OperationResponse["aws_sdk_entityresolution.types.delete_id_mapping_workflow_output.DeleteIdMappingWorkflowOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.delete_id_mapping_workflow
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.delete_id_mapping_workflow.delete_id_mapping_workflow(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_id_namespace(self, id_namespace_name: "aws_sdk_entityresolution.types.entity_name.EntityName", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.delete_id_namespace_output.DeleteIdNamespaceOutput":
        """<p>Deletes the <code>IdNamespace</code> with a given name.</p>

        Args:
            id_namespace_name: <p>The name of the ID namespace.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.delete_id_namespace_input.DeleteIdNamespaceInput]') -> OperationResponse["aws_sdk_entityresolution.types.delete_id_namespace_output.DeleteIdNamespaceOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.delete_id_namespace
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.delete_id_namespace.delete_id_namespace(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_matching_workflow(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.delete_matching_workflow_output.DeleteMatchingWorkflowOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.delete_matching_workflow_input.DeleteMatchingWorkflowInput]') -> OperationResponse["aws_sdk_entityresolution.types.delete_matching_workflow_output.DeleteMatchingWorkflowOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.delete_matching_workflow
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.delete_matching_workflow.delete_matching_workflow(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_policy_statement(self, arn: "aws_sdk_entityresolution.types.venice_global_arn.VeniceGlobalArn", statement_id: "aws_sdk_entityresolution.types.statement_id.StatementId", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.delete_policy_statement_output.DeletePolicyStatementOutput":
        ...
        Args:
            ...
            statement_id: <p>A statement identifier that differentiates the statement from others in the same policy.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.delete_policy_statement_input.DeletePolicyStatementInput]') -> OperationResponse["aws_sdk_entityresolution.types.delete_policy_statement_output.DeletePolicyStatementOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.delete_policy_statement
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.delete_policy_statement.delete_policy_statement(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_schema_mapping(self, schema_name: "aws_sdk_entityresolution.types.entity_name.EntityName", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.delete_schema_mapping_output.DeleteSchemaMappingOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.delete_schema_mapping_input.DeleteSchemaMappingInput]') -> OperationResponse["aws_sdk_entityresolution.types.delete_schema_mapping_output.DeleteSchemaMappingOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.delete_schema_mapping
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.delete_schema_mapping.delete_schema_mapping(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def generate_match_id(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", records: "aws_sdk_entityresolution.types.record_list.RecordList", *, config_overrides: Optional[EntityResolutionClientConfig] = None, processing_type: Optional["aws_sdk_entityresolution.types.processing_type.ProcessingType"] = None) -> "aws_sdk_entityresolution.types.generate_match_id_output.GenerateMatchIdOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.generate_match_id_input.GenerateMatchIdInput]') -> OperationResponse["aws_sdk_entityresolution.types.generate_match_id_output.GenerateMatchIdOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.generate_match_id
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.generate_match_id.generate_match_id(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_id_mapping_job(self, workflow_name: "aws_sdk_entityresolution.types.entity_name_or_id_mapping_workflow_arn.EntityNameOrIdMappingWorkflowArn", job_id: "aws_sdk_entityresolution.types.job_id.JobId", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.get_id_mapping_job_output.GetIdMappingJobOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.get_id_mapping_job_input.GetIdMappingJobInput]') -> OperationResponse["aws_sdk_entityresolution.types.get_id_mapping_job_output.GetIdMappingJobOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.get_id_mapping_job
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.get_id_mapping_job.get_id_mapping_job(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_id_mapping_workflow(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.get_id_mapping_workflow_output.GetIdMappingWorkflowOutput":
        """<p>Returns the <code>IdMappingWorkflow</code> with a given name, if it exists.</p>

        Args:
            workflow_name: <p>The name of the workflow.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.get_id_mapping_workflow_input.GetIdMappingWorkflowInput]') -> OperationResponse["aws_sdk_entityresolution.types.get_id_mapping_workflow_output.GetIdMappingWorkflowOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.get_id_mapping_workflow
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.get_id_mapping_workflow.get_id_mapping_workflow(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_id_namespace(self, id_namespace_name: "aws_sdk_entityresolution.types.entity_name_or_id_namespace_arn.EntityNameOrIdNamespaceArn", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.get_id_namespace_output.GetIdNamespaceOutput":
        """<p>Returns the <code>IdNamespace</code> with a given name, if it exists.</p>

        Args:
            id_namespace_name: <p>The name of the ID namespace.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.get_id_namespace_input.GetIdNamespaceInput]') -> OperationResponse["aws_sdk_entityresolution.types.get_id_namespace_output.GetIdNamespaceOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.get_id_namespace
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.get_id_namespace.get_id_namespace(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_match_id(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", record: "aws_sdk_entityresolution.types.record_attribute_map.RecordAttributeMap", *, config_overrides: Optional[EntityResolutionClientConfig] = None, apply_normalization: Optional[bool] = None) -> "aws_sdk_entityresolution.types.get_match_id_output.GetMatchIdOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.get_match_id_input.GetMatchIdInput]') -> OperationResponse["aws_sdk_entityresolution.types.get_match_id_output.GetMatchIdOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.get_match_id
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.get_match_id.get_match_id(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_matching_job(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", job_id: "aws_sdk_entityresolution.types.job_id.JobId", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.get_matching_job_output.GetMatchingJobOutput":
        """<p>Returns the status, metrics, and errors (if there are any) that are associated with a job.</p>
        ...
        Args:
            ...
            job_id: <p>The ID of the job.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.get_matching_job_input.GetMatchingJobInput]') -> OperationResponse["aws_sdk_entityresolution.types.get_matching_job_output.GetMatchingJobOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.get_matching_job
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.get_matching_job.get_matching_job(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_matching_workflow(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.get_matching_workflow_output.GetMatchingWorkflowOutput":
        """<p>Returns the <code>MatchingWorkflow</code> with a given name, if it exists.</p>

        Args:
            workflow_name: <p>The name of the workflow.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.get_matching_workflow_input.GetMatchingWorkflowInput]') -> OperationResponse["aws_sdk_entityresolution.types.get_matching_workflow_output.GetMatchingWorkflowOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.get_matching_workflow
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.get_matching_workflow.get_matching_workflow(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_policy(self, arn: "aws_sdk_entityresolution.types.venice_global_arn.VeniceGlobalArn", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.get_policy_output.GetPolicyOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.get_policy_input.GetPolicyInput]') -> OperationResponse["aws_sdk_entityresolution.types.get_policy_output.GetPolicyOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.get_policy
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.get_policy.get_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_provider_service(self, provider_name: "aws_sdk_entityresolution.types.entity_name.EntityName", provider_service_name: "aws_sdk_entityresolution.types.provider_service_arn.ProviderServiceArn", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.get_provider_service_output.GetProviderServiceOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.get_provider_service_input.GetProviderServiceInput]') -> OperationResponse["aws_sdk_entityresolution.types.get_provider_service_output.GetProviderServiceOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.get_provider_service
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.get_provider_service.get_provider_service(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_schema_mapping(self, schema_name: "aws_sdk_entityresolution.types.entity_name.EntityName", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.get_schema_mapping_output.GetSchemaMappingOutput":
        """<p>Returns the SchemaMapping of a given name.</p>

        Args:
            schema_name: <p>The name of the schema to be retrieved.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.get_schema_mapping_input.GetSchemaMappingInput]') -> OperationResponse["aws_sdk_entityresolution.types.get_schema_mapping_output.GetSchemaMappingOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.get_schema_mapping
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.get_schema_mapping.get_schema_mapping(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def list_id_mapping_jobs(self, workflow_name: "aws_sdk_entityresolution.types.entity_name_or_id_mapping_workflow_arn.EntityNameOrIdMappingWorkflowArn", *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None) -> "aws_sdk_entityresolution.types.list_id_mapping_jobs_output.ListIdMappingJobsOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.list_id_mapping_jobs_input.ListIdMappingJobsInput]') -> OperationResponse["aws_sdk_entityresolution.types.list_id_mapping_jobs_output.ListIdMappingJobsOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.list_id_mapping_jobs
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.list_id_mapping_jobs.list_id_mapping_jobs(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_id_mapping_jobs(self, workflow_name: "aws_sdk_entityresolution.types.entity_name_or_id_mapping_workflow_arn.EntityNameOrIdMappingWorkflowArn", *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None) -> "Iterator[aws_sdk_entityresolution.types.job_summary.JobSummary]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def list_id_mapping_workflows(self, *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None) -> "aws_sdk_entityresolution.types.list_id_mapping_workflows_output.ListIdMappingWorkflowsOutput":
        ...
        Args:
            ...
            max_results: <p>The maximum number of objects returned per page.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.list_id_mapping_workflows_input.ListIdMappingWorkflowsInput]') -> OperationResponse["aws_sdk_entityresolution.types.list_id_mapping_workflows_output.ListIdMappingWorkflowsOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.list_id_mapping_workflows
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.list_id_mapping_workflows.list_id_mapping_workflows(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_id_mapping_workflows(self, *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None) -> "Iterator[aws_sdk_entityresolution.types.id_mapping_workflow_summary.IdMappingWorkflowSummary]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def list_id_namespaces(self, *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None) -> "aws_sdk_entityresolution.types.list_id_namespaces_output.ListIdNamespacesOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.list_id_namespaces_input.ListIdNamespacesInput]') -> OperationResponse["aws_sdk_entityresolution.types.list_id_namespaces_output.ListIdNamespacesOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.list_id_namespaces
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.list_id_namespaces.list_id_namespaces(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_id_namespaces(self, *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None) -> "Iterator[aws_sdk_entityresolution.types.id_namespace_summary.IdNamespaceSummary]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def list_matching_jobs(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None) -> "aws_sdk_entityresolution.types.list_matching_jobs_output.ListMatchingJobsOutput":
        ...
        Args:
            ...
            max_results: <p>The maximum number of objects returned per page.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.list_matching_jobs_input.ListMatchingJobsInput]') -> OperationResponse["aws_sdk_entityresolution.types.list_matching_jobs_output.ListMatchingJobsOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.list_matching_jobs
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.list_matching_jobs.list_matching_jobs(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_matching_jobs(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None) -> "Iterator[aws_sdk_entityresolution.types.job_summary.JobSummary]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def list_matching_workflows(self, *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None) -> "aws_sdk_entityresolution.types.list_matching_workflows_output.ListMatchingWorkflowsOutput":
        ...
        Args:
            ...
            max_results: <p>The maximum number of objects returned per page.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.list_matching_workflows_input.ListMatchingWorkflowsInput]') -> OperationResponse["aws_sdk_entityresolution.types.list_matching_workflows_output.ListMatchingWorkflowsOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.list_matching_workflows
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.list_matching_workflows.list_matching_workflows(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_matching_workflows(self, *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None) -> "Iterator[aws_sdk_entityresolution.types.matching_workflow_summary.MatchingWorkflowSummary]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def list_provider_services(self, *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None, provider_name: Optional["aws_sdk_entityresolution.types.entity_name.EntityName"] = None) -> "aws_sdk_entityresolution.types.list_provider_services_output.ListProviderServicesOutput":
        ...
        Args:
            ...
            provider_name: <p>The name of the provider. This name is typically the company name.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.list_provider_services_input.ListProviderServicesInput]') -> OperationResponse["aws_sdk_entityresolution.types.list_provider_services_output.ListProviderServicesOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.list_provider_services
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.list_provider_services.list_provider_services(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_provider_services(self, *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None, provider_name: Optional["aws_sdk_entityresolution.types.entity_name.EntityName"] = None) -> "Iterator[aws_sdk_entityresolution.types.provider_service_summary.ProviderServiceSummary]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def list_schema_mappings(self, *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None) -> "aws_sdk_entityresolution.types.list_schema_mappings_output.ListSchemaMappingsOutput":
        ...
        Args:
            ...
            max_results: <p>The maximum number of objects returned per page.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.list_schema_mappings_input.ListSchemaMappingsInput]') -> OperationResponse["aws_sdk_entityresolution.types.list_schema_mappings_output.ListSchemaMappingsOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.list_schema_mappings
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.list_schema_mappings.list_schema_mappings(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_schema_mappings(self, *, config_overrides: Optional[EntityResolutionClientConfig] = None, next_token: Optional["aws_sdk_entityresolution.types.next_token.NextToken"] = None, max_results: Optional[int] = None) -> "Iterator[aws_sdk_entityresolution.types.schema_mapping_summary.SchemaMappingSummary]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def list_tags_for_resource(self, resource_arn: "aws_sdk_entityresolution.types.venice_global_arn.VeniceGlobalArn", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.list_tags_for_resource_output.ListTagsForResourceOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.list_tags_for_resource_input.ListTagsForResourceInput]') -> OperationResponse["aws_sdk_entityresolution.types.list_tags_for_resource_output.ListTagsForResourceOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.list_tags_for_resource
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_policy(self, arn: "aws_sdk_entityresolution.types.venice_global_arn.VeniceGlobalArn", policy: "aws_sdk_entityresolution.types.policy_document.PolicyDocument", *, config_overrides: Optional[EntityResolutionClientConfig] = None, token: Optional["aws_sdk_entityresolution.types.policy_token.PolicyToken"] = None) -> "aws_sdk_entityresolution.types.put_policy_output.PutPolicyOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.put_policy_input.PutPolicyInput]') -> OperationResponse["aws_sdk_entityresolution.types.put_policy_output.PutPolicyOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.put_policy
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.put_policy.put_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def start_id_mapping_job(self, workflow_name: "aws_sdk_entityresolution.types.entity_name_or_id_mapping_workflow_arn.EntityNameOrIdMappingWorkflowArn", *, config_overrides: Optional[EntityResolutionClientConfig] = None, output_source_config: Optional["aws_sdk_entityresolution.types.id_mapping_job_output_source_config.IdMappingJobOutputSourceConfig"] = None, job_type: Optional["aws_sdk_entityresolution.types.job_type.JobType"] = None) -> "aws_sdk_entityresolution.types.start_id_mapping_job_output.StartIdMappingJobOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.start_id_mapping_job_input.StartIdMappingJobInput]') -> OperationResponse["aws_sdk_entityresolution.types.start_id_mapping_job_output.StartIdMappingJobOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.start_id_mapping_job
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.start_id_mapping_job.start_id_mapping_job(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def start_matching_job(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.start_matching_job_output.StartMatchingJobOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.start_matching_job_input.StartMatchingJobInput]') -> OperationResponse["aws_sdk_entityresolution.types.start_matching_job_output.StartMatchingJobOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.start_matching_job
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.start_matching_job.start_matching_job(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def tag_resource(self, resource_arn: "aws_sdk_entityresolution.types.venice_global_arn.VeniceGlobalArn", tags: "aws_sdk_entityresolution.types.tag_map.TagMap", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.tag_resource_output.TagResourceOutput":
        ...
        Args:
            ...
            tags: <p>The tags used to organize, track, or control access for this resource.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.tag_resource_input.TagResourceInput]') -> OperationResponse["aws_sdk_entityresolution.types.tag_resource_output.TagResourceOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.tag_resource
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, resource_arn: "aws_sdk_entityresolution.types.venice_global_arn.VeniceGlobalArn", tag_keys: "aws_sdk_entityresolution.types.tag_key_list.TagKeyList", *, config_overrides: Optional[EntityResolutionClientConfig] = None) -> "aws_sdk_entityresolution.types.untag_resource_output.UntagResourceOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.untag_resource_input.UntagResourceInput]') -> OperationResponse["aws_sdk_entityresolution.types.untag_resource_output.UntagResourceOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.untag_resource
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def update_id_mapping_workflow(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", input_source_config: "aws_sdk_entityresolution.types.id_mapping_workflow_input_source_config.IdMappingWorkflowInputSourceConfig", id_mapping_techniques: "aws_sdk_entityresolution.types.id_mapping_techniques.IdMappingTechniques", *, config_overrides: Optional[EntityResolutionClientConfig] = None, description: Optional["aws_sdk_entityresolution.types.description.Description"] = None, output_source_config: Optional["aws_sdk_entityresolution.types.id_mapping_workflow_output_source_config.IdMappingWorkflowOutputSourceConfig"] = None, incremental_run_config: Optional["aws_sdk_entityresolution.types.id_mapping_incremental_run_config.IdMappingIncrementalRunConfig"] = None, role_arn: Optional["aws_sdk_entityresolution.types.id_mapping_role_arn.IdMappingRoleArn"] = None) -> "aws_sdk_entityresolution.types.update_id_mapping_workflow_output.UpdateIdMappingWorkflowOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.update_id_mapping_workflow_input.UpdateIdMappingWorkflowInput]') -> OperationResponse["aws_sdk_entityresolution.types.update_id_mapping_workflow_output.UpdateIdMappingWorkflowOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.update_id_mapping_workflow
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.update_id_mapping_workflow.update_id_mapping_workflow(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def update_id_namespace(self, id_namespace_name: "aws_sdk_entityresolution.types.entity_name.EntityName", *, config_overrides: Optional[EntityResolutionClientConfig] = None, description: Optional["aws_sdk_entityresolution.types.description.Description"] = None, input_source_config: Optional["aws_sdk_entityresolution.types.id_namespace_input_source_config.IdNamespaceInputSourceConfig"] = None, id_mapping_workflow_properties: Optional["aws_sdk_entityresolution.types.id_namespace_id_mapping_workflow_properties_list.IdNamespaceIdMappingWorkflowPropertiesList"] = None, role_arn: Optional["aws_sdk_entityresolution.types.role_arn.RoleArn"] = None) -> "aws_sdk_entityresolution.types.update_id_namespace_output.UpdateIdNamespaceOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.update_id_namespace_input.UpdateIdNamespaceInput]') -> OperationResponse["aws_sdk_entityresolution.types.update_id_namespace_output.UpdateIdNamespaceOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.update_id_namespace
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.update_id_namespace.update_id_namespace(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def update_matching_workflow(self, workflow_name: "aws_sdk_entityresolution.types.entity_name.EntityName", input_source_config: "aws_sdk_entityresolution.types.input_source_config.InputSourceConfig", output_source_config: "aws_sdk_entityresolution.types.output_source_config.OutputSourceConfig", resolution_techniques: "aws_sdk_entityresolution.types.resolution_techniques.ResolutionTechniques", role_arn: str, *, config_overrides: Optional[EntityResolutionClientConfig] = None, description: Optional["aws_sdk_entityresolution.types.description.Description"] = None, incremental_run_config: Optional["aws_sdk_entityresolution.types.incremental_run_config.IncrementalRunConfig"] = None) -> "aws_sdk_entityresolution.types.update_matching_workflow_output.UpdateMatchingWorkflowOutput":
        ...
        Args:
            ...
            role_arn: <p>The Amazon Resource Name (ARN) of the IAM role. Entity Resolution assumes this role to create resources on your behalf as part of workflow execution.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.update_matching_workflow_input.UpdateMatchingWorkflowInput]') -> OperationResponse["aws_sdk_entityresolution.types.update_matching_workflow_output.UpdateMatchingWorkflowOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.update_matching_workflow
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.update_matching_workflow.update_matching_workflow(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def update_schema_mapping(self, schema_name: "aws_sdk_entityresolution.types.entity_name.EntityName", mapped_input_fields: "aws_sdk_entityresolution.types.schema_input_attributes.SchemaInputAttributes", *, config_overrides: Optional[EntityResolutionClientConfig] = None, description: Optional["aws_sdk_entityresolution.types.description.Description"] = None) -> "aws_sdk_entityresolution.types.update_schema_mapping_output.UpdateSchemaMappingOutput":
        ...
        Args:
            ...
            mapped_input_fields: <p>A list of <code>MappedInputFields</code>. Each <code>MappedInputField</code> corresponds to a column the source data table, and contains column name plus additional information that Entity Resolution uses for matching.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_entityresolution.types.update_schema_mapping_input.UpdateSchemaMappingInput]') -> OperationResponse["aws_sdk_entityresolution.types.update_schema_mapping_output.UpdateSchemaMappingOutput"]:
            import aws_sdk_entityresolution._operations.aws_venice_service.update_schema_mapping
            output, http_response = aws_sdk_entityresolution._operations.aws_venice_service.update_schema_mapping.update_schema_mapping(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
