...
from aws_sdk_entityresolution._services._aws_config import aws_config
...
class EntityResolutionClient:
    ...
    def add_policy_statement(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.add_policy_statement_input.AddPolicyStatementInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.add_policy_statement_output.AddPolicyStatementOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.add_policy_statement.add_policy_statement(
    ...
    def batch_delete_unique_id(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.batch_delete_unique_id_input.BatchDeleteUniqueIdInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.batch_delete_unique_id_output.BatchDeleteUniqueIdOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.batch_delete_unique_id.batch_delete_unique_id(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_id_mapping_workflow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.create_id_mapping_workflow_input.CreateIdMappingWorkflowInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.create_id_mapping_workflow_output.CreateIdMappingWorkflowOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.create_id_mapping_workflow.create_id_mapping_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_id_namespace(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.create_id_namespace_input.CreateIdNamespaceInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.create_id_namespace_output.CreateIdNamespaceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.create_id_namespace.create_id_namespace(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_matching_workflow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.create_matching_workflow_input.CreateMatchingWorkflowInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.create_matching_workflow_output.CreateMatchingWorkflowOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.create_matching_workflow.create_matching_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_schema_mapping(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.create_schema_mapping_input.CreateSchemaMappingInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.create_schema_mapping_output.CreateSchemaMappingOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.create_schema_mapping.create_schema_mapping(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_id_mapping_workflow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.delete_id_mapping_workflow_input.DeleteIdMappingWorkflowInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.delete_id_mapping_workflow_output.DeleteIdMappingWorkflowOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.delete_id_mapping_workflow.delete_id_mapping_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_id_namespace(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.delete_id_namespace_input.DeleteIdNamespaceInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.delete_id_namespace_output.DeleteIdNamespaceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.delete_id_namespace.delete_id_namespace(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_matching_workflow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.delete_matching_workflow_input.DeleteMatchingWorkflowInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.delete_matching_workflow_output.DeleteMatchingWorkflowOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.delete_matching_workflow.delete_matching_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_policy_statement(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.delete_policy_statement_input.DeletePolicyStatementInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.delete_policy_statement_output.DeletePolicyStatementOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.delete_policy_statement.delete_policy_statement(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_schema_mapping(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.delete_schema_mapping_input.DeleteSchemaMappingInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.delete_schema_mapping_output.DeleteSchemaMappingOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.delete_schema_mapping.delete_schema_mapping(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def generate_match_id(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.generate_match_id_input.GenerateMatchIdInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.generate_match_id_output.GenerateMatchIdOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.generate_match_id.generate_match_id(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_id_mapping_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.get_id_mapping_job_input.GetIdMappingJobInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.get_id_mapping_job_output.GetIdMappingJobOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.get_id_mapping_job.get_id_mapping_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_id_mapping_workflow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.get_id_mapping_workflow_input.GetIdMappingWorkflowInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.get_id_mapping_workflow_output.GetIdMappingWorkflowOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.get_id_mapping_workflow.get_id_mapping_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_id_namespace(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.get_id_namespace_input.GetIdNamespaceInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.get_id_namespace_output.GetIdNamespaceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.get_id_namespace.get_id_namespace(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_match_id(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.get_match_id_input.GetMatchIdInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.get_match_id_output.GetMatchIdOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.get_match_id.get_match_id(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_matching_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.get_matching_job_input.GetMatchingJobInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.get_matching_job_output.GetMatchingJobOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.get_matching_job.get_matching_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_matching_workflow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.get_matching_workflow_input.GetMatchingWorkflowInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.get_matching_workflow_output.GetMatchingWorkflowOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.get_matching_workflow.get_matching_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.get_policy_input.GetPolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.get_policy_output.GetPolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.get_policy.get_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_provider_service(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.get_provider_service_input.GetProviderServiceInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.get_provider_service_output.GetProviderServiceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.get_provider_service.get_provider_service(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_schema_mapping(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.get_schema_mapping_input.GetSchemaMappingInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.get_schema_mapping_output.GetSchemaMappingOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.get_schema_mapping.get_schema_mapping(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_id_mapping_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.list_id_mapping_jobs_input.ListIdMappingJobsInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.list_id_mapping_jobs_output.ListIdMappingJobsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.list_id_mapping_jobs.list_id_mapping_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_id_mapping_jobs(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[aws_sdk_entityresolution.types.job_summary.JobSummary]":
        _token = next_token
        while True:
    ...
    def list_id_mapping_workflows(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.list_id_mapping_workflows_input.ListIdMappingWorkflowsInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.list_id_mapping_workflows_output.ListIdMappingWorkflowsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.list_id_mapping_workflows.list_id_mapping_workflows(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_id_mapping_workflows(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[aws_sdk_entityresolution.types.id_mapping_workflow_summary.IdMappingWorkflowSummary]":
        _token = next_token
        while True:
    ...
    def list_id_namespaces(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.list_id_namespaces_input.ListIdNamespacesInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.list_id_namespaces_output.ListIdNamespacesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.list_id_namespaces.list_id_namespaces(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_id_namespaces(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[aws_sdk_entityresolution.types.id_namespace_summary.IdNamespaceSummary]":
        _token = next_token
        while True:
    ...
    def list_matching_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.list_matching_jobs_input.ListMatchingJobsInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.list_matching_jobs_output.ListMatchingJobsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.list_matching_jobs.list_matching_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_matching_workflows(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.list_matching_workflows_input.ListMatchingWorkflowsInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.list_matching_workflows_output.ListMatchingWorkflowsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.list_matching_workflows.list_matching_workflows(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_matching_workflows(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[aws_sdk_entityresolution.types.matching_workflow_summary.MatchingWorkflowSummary]":
        _token = next_token
        while True:
    ...
    def list_provider_services(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.list_provider_services_input.ListProviderServicesInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.list_provider_services_output.ListProviderServicesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.list_provider_services.list_provider_services(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_entityresolution.types.provider_service_summary.ProviderServiceSummary]":
        _token = next_token
        while True:
    ...
    def list_schema_mappings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.list_schema_mappings_input.ListSchemaMappingsInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.list_schema_mappings_output.ListSchemaMappingsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.list_schema_mappings.list_schema_mappings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_schema_mappings(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[aws_sdk_entityresolution.types.schema_mapping_summary.SchemaMappingSummary]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.put_policy_input.PutPolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.put_policy_output.PutPolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.put_policy.put_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_id_mapping_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.start_id_mapping_job_input.StartIdMappingJobInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.start_id_mapping_job_output.StartIdMappingJobOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.start_id_mapping_job.start_id_mapping_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_matching_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.start_matching_job_input.StartMatchingJobInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.start_matching_job_output.StartMatchingJobOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.start_matching_job.start_matching_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_id_mapping_workflow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.update_id_mapping_workflow_input.UpdateIdMappingWorkflowInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.update_id_mapping_workflow_output.UpdateIdMappingWorkflowOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.update_id_mapping_workflow.update_id_mapping_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_id_namespace(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.update_id_namespace_input.UpdateIdNamespaceInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.update_id_namespace_output.UpdateIdNamespaceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.update_id_namespace.update_id_namespace(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_matching_workflow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.update_matching_workflow_input.UpdateMatchingWorkflowInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.update_matching_workflow_output.UpdateMatchingWorkflowOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.update_matching_workflow.update_matching_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_schema_mapping(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_entityresolution.types.update_schema_mapping_input.UpdateSchemaMappingInput]",
        ) -> OperationResponse[
            "aws_sdk_entityresolution.types.update_schema_mapping_output.UpdateSchemaMappingOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_entityresolution._operations.aws_venice_service.update_schema_mapping.update_schema_mapping(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
