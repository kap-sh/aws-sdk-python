...
class ProviderComponentSchema(TypedDict, closed=True):
    ...
    provider_schema_attributes: NotRequired[
        "aws_sdk_entityresolution.types.provider_schema_attributes.ProviderSchemaAttributes"
    ]
...
def serialize_json(value: ProviderComponentSchema) -> dict:
    ...
    if "schemas" in value:
        ...
        out["schemas"] = aws_sdk_entityresolution.types.schemas.serialize_json(
            value["schemas"]
        )
    if "provider_schema_attributes" in value:
        ...
        out["providerSchemaAttributes"] = (
            aws_sdk_entityresolution.types.provider_schema_attributes.serialize_json(
...
def deserialize_json(data: dict) -> ProviderComponentSchema:
    ...
    if "schemas" in data:
        ...
        out["schemas"] = aws_sdk_entityresolution.types.schemas.deserialize_json(
            data["schemas"]
        )
    if "providerSchemaAttributes" in data:
        ...
        out["provider_schema_attributes"] = (
            aws_sdk_entityresolution.types.provider_schema_attributes.deserialize_json(
