...
class CreateIdMappingWorkflowOutput(TypedDict):
    ...
    workflow_arn: "aws_sdk_entityresolution.types.id_mapping_workflow_arn.IdMappingWorkflowArn"
...
def deserialize_json(data: dict) -> CreateIdMappingWorkflowOutput:
    ...
    if "workflowName" in data:
        ...
        raise DeserializationError("CreateIdMappingWorkflowOutput.workflow_name required")
    if "workflowArn" in data:
        out["workflow_arn"] = data["workflowArn"]
    else:
        raise DeserializationError("CreateIdMappingWorkflowOutput.workflow_arn required")
    ...
    if "inputSourceConfig" in data:
        ...
        raise DeserializationError("CreateIdMappingWorkflowOutput.input_source_config required")
    ...
    if "idMappingTechniques" in data:
        ...
        raise DeserializationError("CreateIdMappingWorkflowOutput.id_mapping_techniques required")
