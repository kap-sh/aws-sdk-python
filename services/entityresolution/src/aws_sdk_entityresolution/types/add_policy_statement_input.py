...
class AddPolicyStatementInput(TypedDict):
    ...
    condition: NotRequired["aws_sdk_entityresolution.types.statement_condition.StatementCondition"]
...
def serialize_json(value: AddPolicyStatementInput) -> dict:
    out: dict = {}
    import aws_sdk_entityresolution.types.statement_effect
    out["effect"] = aws_sdk_entityresolution.types.statement_effect.serialize_json(value["effect"])
    import aws_sdk_entityresolution.types.statement_action_list
    out["action"] = aws_sdk_entityresolution.types.statement_action_list.serialize_json(value["action"])
    import aws_sdk_entityresolution.types.statement_principal_list
    out["principal"] = aws_sdk_entityresolution.types.statement_principal_list.serialize_json(value["principal"])
...
def deserialize_json(data: dict) -> AddPolicyStatementInput:
    ...
    if "effect" in data:
        import aws_sdk_entityresolution.types.statement_effect
        out["effect"] = aws_sdk_entityresolution.types.statement_effect.deserialize_json(data["effect"])
    else:
        raise DeserializationError("AddPolicyStatementInput.effect required")
    if "action" in data:
        import aws_sdk_entityresolution.types.statement_action_list
        out["action"] = aws_sdk_entityresolution.types.statement_action_list.deserialize_json(data["action"])
    else:
        raise DeserializationError("AddPolicyStatementInput.action required")
    if "principal" in data:
        import aws_sdk_entityresolution.types.statement_principal_list
        out["principal"] = aws_sdk_entityresolution.types.statement_principal_list.deserialize_json(data["principal"])
    else:
