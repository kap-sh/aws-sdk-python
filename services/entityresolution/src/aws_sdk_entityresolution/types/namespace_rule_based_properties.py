...
if TYPE_CHECKING:
    ...
    import aws_sdk_entityresolution.types.id_mapping_workflow_rule_definition_type_list
    import aws_sdk_entityresolution.types.record_matching_model_list
    import aws_sdk_entityresolution.types.rule_list


class NamespaceRuleBasedProperties(TypedDict):
    ...
    rule_definition_types: NotRequired[
        "aws_sdk_entityresolution.types.id_mapping_workflow_rule_definition_type_list.IdMappingWorkflowRuleDefinitionTypeList"
    ]
    ...
    record_matching_models: NotRequired[
        "aws_sdk_entityresolution.types.record_matching_model_list.RecordMatchingModelList"
    ]
...
def serialize_json(value: NamespaceRuleBasedProperties) -> dict:
    ...
    if "rule_definition_types" in value:
        ...
        out["ruleDefinitionTypes"] = (
            aws_sdk_entityresolution.types.id_mapping_workflow_rule_definition_type_list.serialize_json(
    ...
    if "record_matching_models" in value:
        ...
        out["recordMatchingModels"] = (
            aws_sdk_entityresolution.types.record_matching_model_list.serialize_json(
...
def deserialize_json(data: dict) -> NamespaceRuleBasedProperties:
    ...
    if "ruleDefinitionTypes" in data:
        ...
        out["rule_definition_types"] = (
            aws_sdk_entityresolution.types.id_mapping_workflow_rule_definition_type_list.deserialize_json(
    ...
    if "recordMatchingModels" in data:
        ...
        out["record_matching_models"] = (
            aws_sdk_entityresolution.types.record_matching_model_list.deserialize_json(
