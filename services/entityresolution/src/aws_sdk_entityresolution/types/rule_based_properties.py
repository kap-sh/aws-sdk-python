...
if TYPE_CHECKING:
    ...
    import aws_sdk_entityresolution.types.match_purpose
    import aws_sdk_entityresolution.types.rule_list


class RuleBasedProperties(TypedDict):
    rules: "aws_sdk_entityresolution.types.rule_list.RuleList"
    ...
    match_purpose: NotRequired[
        "aws_sdk_entityresolution.types.match_purpose.MatchPurpose"
    ]
...
def serialize_json(value: RuleBasedProperties) -> dict:
    ...
    if "match_purpose" in value:
        ...
        out["matchPurpose"] = (
            aws_sdk_entityresolution.types.match_purpose.serialize_json(
                value["match_purpose"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> RuleBasedProperties:
    ...
    if "matchPurpose" in data:
        ...
        out["match_purpose"] = (
            aws_sdk_entityresolution.types.match_purpose.deserialize_json(
                data["matchPurpose"]
            )
        )
    return out
