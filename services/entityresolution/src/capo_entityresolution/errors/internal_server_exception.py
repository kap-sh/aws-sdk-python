"""Generated from Smithy shape ``com.amazonaws.entityresolution#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.entityresolution#InternalServerException``."""
