...
def handle_response(
    ...
    out: capo_entityresolution.types.generate_match_id_output.GenerateMatchIdOutput = (
        capo_entityresolution.types.generate_match_id_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_entityresolution.types.generate_match_id_input.serialize_json(input_)
    ).encode()
