...
def handle_response(
    ...
    out: capo_entityresolution.types.delete_id_mapping_workflow_output.DeleteIdMappingWorkflowOutput = capo_entityresolution.types.delete_id_mapping_workflow_output.deserialize_json(
