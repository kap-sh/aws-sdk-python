...
import capo_entityresolution.errors.conflict_exception
import capo_entityresolution.errors.exceeds_limit_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_entityresolution.errors.conflict_exception.ConflictException.from_json(
                data
            )
        case "ExceedsLimitException":
            raise capo_entityresolution.errors.exceeds_limit_exception.ExceedsLimitException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_entityresolution.types.create_id_mapping_workflow_output.CreateIdMappingWorkflowOutput = capo_entityresolution.types.create_id_mapping_workflow_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_entityresolution.types.create_id_mapping_workflow_input.serialize_json(
            input_
        )
    ).encode()
