...
def handle_response(
    ...
    out: capo_entityresolution.types.get_match_id_output.GetMatchIdOutput = (
        capo_entityresolution.types.get_match_id_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_entityresolution.types.get_match_id_input.serialize_json(input_)
    ).encode()
...
def get_match_id(
    ...
    capo_entityresolution.types.get_match_id_output.GetMatchIdOutput, zapros.Response
]:
