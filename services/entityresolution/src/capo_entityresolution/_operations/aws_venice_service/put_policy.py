...
def handle_response(
    ...
    out: capo_entityresolution.types.put_policy_output.PutPolicyOutput = (
        capo_entityresolution.types.put_policy_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_entityresolution.types.put_policy_input.serialize_json(input_)
    ).encode()
...
def put_policy(
    ...
    capo_entityresolution.types.put_policy_output.PutPolicyOutput, zapros.Response
]:
