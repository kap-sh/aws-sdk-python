"""Generated from Smithy shape ``com.amazonaws.entityresolution#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_entityresolution.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_entityresolution.types.list_tags_for_resource_output.deserialize_json(
