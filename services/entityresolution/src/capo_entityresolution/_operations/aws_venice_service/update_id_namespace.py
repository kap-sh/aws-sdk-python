...
def handle_response(
    ...
    out: capo_entityresolution.types.update_id_namespace_output.UpdateIdNamespaceOutput = capo_entityresolution.types.update_id_namespace_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_entityresolution.types.update_id_namespace_input.serialize_json(input_)
    ).encode()
