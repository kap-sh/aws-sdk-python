"""Generated from Smithy shape ``com.amazonaws.entityresolution#CreateSchemaMapping``."""
...
def handle_response(
    ...
    out: capo_entityresolution.types.create_schema_mapping_output.CreateSchemaMappingOutput = capo_entityresolution.types.create_schema_mapping_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/schemas"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_entityresolution.types.create_schema_mapping_input.serialize_json(input_)
    ).encode()
...
async def async_create_schema_mapping(
