...
def handle_response(
    ...
    out: capo_entityresolution.types.list_provider_services_output.ListProviderServicesOutput = capo_entityresolution.types.list_provider_services_output.deserialize_json(
