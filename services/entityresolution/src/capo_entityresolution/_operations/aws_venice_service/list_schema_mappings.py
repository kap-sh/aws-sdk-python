"""Generated from Smithy shape ``com.amazonaws.entityresolution#ListSchemaMappings``."""
...
def handle_response(
    ...
    out: capo_entityresolution.types.list_schema_mappings_output.ListSchemaMappingsOutput = capo_entityresolution.types.list_schema_mappings_output.deserialize_json(
...
async def async_list_schema_mappings(
