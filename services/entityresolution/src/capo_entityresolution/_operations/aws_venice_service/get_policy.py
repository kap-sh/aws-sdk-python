"""Generated from Smithy shape ``com.amazonaws.entityresolution#GetPolicy``."""
...
def handle_response(
    ...
    out: capo_entityresolution.types.get_policy_output.GetPolicyOutput = (
        capo_entityresolution.types.get_policy_output.deserialize_json(
...
def get_policy(
    ...
    capo_entityresolution.types.get_policy_output.GetPolicyOutput, zapros.Response
]:
