...
def handle_response(
    ...
    out: capo_entityresolution.types.update_matching_workflow_output.UpdateMatchingWorkflowOutput = capo_entityresolution.types.update_matching_workflow_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_entityresolution.types.update_matching_workflow_input.serialize_json(
            input_
        )
    ).encode()
