"""Generated from Smithy shape ``com.amazonaws.entityresolution#ListMatchingWorkflows``."""
...
def handle_response(
    ...
    out: capo_entityresolution.types.list_matching_workflows_output.ListMatchingWorkflowsOutput = capo_entityresolution.types.list_matching_workflows_output.deserialize_json(
...
async def async_list_matching_workflows(
