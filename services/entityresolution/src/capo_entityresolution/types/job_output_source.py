"""Generated from Smithy shape ``com.amazonaws.entityresolution#JobOutputSource``."""
...
class JobOutputSource(TypedDict, closed=True):
    role_arn: "capo_entityresolution.types.role_arn.RoleArn"
...
# --- restJson1 ser/de ---
def serialize_json(value: JobOutputSource) -> dict:
    out: dict = {}
