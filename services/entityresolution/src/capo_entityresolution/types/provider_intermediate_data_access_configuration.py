...
class ProviderIntermediateDataAccessConfiguration(TypedDict, closed=True):
    aws_account_ids: NotRequired[
        "capo_entityresolution.types.aws_account_id_list.AwsAccountIdList"
    ]
    ...
    required_bucket_actions: NotRequired[
        "capo_entityresolution.types.required_bucket_actions_list.RequiredBucketActionsList"
    ]
...
def serialize_json(value: ProviderIntermediateDataAccessConfiguration) -> dict:
    ...
    if "aws_account_ids" in value:
        ...
        out["awsAccountIds"] = (
            capo_entityresolution.types.aws_account_id_list.serialize_json(
    ...
    if "required_bucket_actions" in value:
        ...
        out["requiredBucketActions"] = (
            capo_entityresolution.types.required_bucket_actions_list.serialize_json(
...
def deserialize_json(data: dict) -> ProviderIntermediateDataAccessConfiguration:
    ...
    if "awsAccountIds" in data:
        ...
        out["aws_account_ids"] = (
            capo_entityresolution.types.aws_account_id_list.deserialize_json(
                data["awsAccountIds"]
            )
        )
    if "requiredBucketActions" in data:
        ...
        out["required_bucket_actions"] = (
            capo_entityresolution.types.required_bucket_actions_list.deserialize_json(
