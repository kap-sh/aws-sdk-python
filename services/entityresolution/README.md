...
```
pip install aws-sdk-entityresolution
```

## Usage

```python
from aws_sdk_entityresolution import AsyncEntityResolutionClient
...
```python
from aws_sdk_entityresolution import AsyncEntityResolutionClient
from aws_sdk_entityresolution.error import AccessDeniedException
