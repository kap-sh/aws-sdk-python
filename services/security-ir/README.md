...
```
pip install aws-sdk-security-ir
```

## Usage

```python
from aws_sdk_security_ir import AsyncSecurityIRClient


async def main():
    async with AsyncSecurityIRClient() as s3:
...
```python
from aws_sdk_security_ir import AsyncSecurityIRClient
from aws_sdk_security_ir.error import AccessDeniedException
