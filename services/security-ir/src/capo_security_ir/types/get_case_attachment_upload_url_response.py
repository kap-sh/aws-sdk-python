...
if TYPE_CHECKING:
    import capo_security_ir.types.url


class GetCaseAttachmentUploadUrlResponse(TypedDict, closed=True):
    attachment_presigned_url: "capo_security_ir.types.url.Url"
