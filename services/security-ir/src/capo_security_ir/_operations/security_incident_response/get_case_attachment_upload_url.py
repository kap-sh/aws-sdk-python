...
def handle_response(
    ...
    out: capo_security_ir.types.get_case_attachment_upload_url_response.GetCaseAttachmentUploadUrlResponse = capo_security_ir.types.get_case_attachment_upload_url_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_security_ir.types.get_case_attachment_upload_url_request.serialize_json(
            input_
        )
    ).encode()
