"""Generated from Smithy shape ``com.amazonaws.securityir#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_security_ir.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_security_ir.types.list_tags_for_resource_output.deserialize_json(
