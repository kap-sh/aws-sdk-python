"""Generated from Smithy shape ``com.amazonaws.securityir#CancelMembership``."""
...
def handle_response(
    ...
    out: capo_security_ir.types.cancel_membership_response.CancelMembershipResponse = (
        capo_security_ir.types.cancel_membership_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/membership/{membershipId}"
...
async def async_cancel_membership(
