"""Generated from Smithy shape ``com.amazonaws.securityir#GetCaseAttachmentDownloadUrl``."""
...
def handle_response(
    ...
    out: capo_security_ir.types.get_case_attachment_download_url_response.GetCaseAttachmentDownloadUrlResponse = capo_security_ir.types.get_case_attachment_download_url_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/v1/cases/{caseId}/get-presigned-url/{attachmentId}"
    )
...
async def async_get_case_attachment_download_url(
