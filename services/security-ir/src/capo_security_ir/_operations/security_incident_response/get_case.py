"""Generated from Smithy shape ``com.amazonaws.securityir#GetCase``."""
...
def handle_response(
    ...
    out: capo_security_ir.types.get_case_response.GetCaseResponse = (
        capo_security_ir.types.get_case_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/cases/{caseId}/get-case"
...
def get_case(
    ...
    input_: capo_security_ir.types.get_case_request.GetCaseRequest,
) -> tuple[capo_security_ir.types.get_case_response.GetCaseResponse, zapros.Response]:
