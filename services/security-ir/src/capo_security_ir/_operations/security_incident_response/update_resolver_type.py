...
def handle_response(
    ...
    out: capo_security_ir.types.update_resolver_type_response.UpdateResolverTypeResponse = capo_security_ir.types.update_resolver_type_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_security_ir.types.update_resolver_type_request.serialize_json(input_)
    ).encode()
