...
def handle_response(
    ...
    out: capo_security_ir.types.list_cases_response.ListCasesResponse = (
        capo_security_ir.types.list_cases_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_security_ir.types.list_cases_request.serialize_json(input_)
    ).encode()
...
def list_cases(
    ...
    capo_security_ir.types.list_cases_response.ListCasesResponse, zapros.Response
]:
