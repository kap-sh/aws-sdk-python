"""Generated from Smithy shape ``com.amazonaws.securityir#GetMembership``."""
...
def handle_response(
    ...
    out: capo_security_ir.types.get_membership_response.GetMembershipResponse = (
        capo_security_ir.types.get_membership_response.deserialize_json(
