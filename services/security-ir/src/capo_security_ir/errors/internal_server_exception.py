"""Generated from Smithy shape ``com.amazonaws.securityir#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.securityir#InternalServerException``."""
