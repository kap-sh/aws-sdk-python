"""Generated from Smithy shape ``com.amazonaws.securityir#CreateCase``."""
...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.create_case_response.CreateCaseResponse = (
        aws_sdk_security_ir.types.create_case_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_security_ir.types.create_case_request.CreateCaseRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_security_ir.types.create_case_request.serialize_json(input)
    ).encode()
...
def create_case(
    ...
    aws_sdk_security_ir.types.create_case_response.CreateCaseResponse, zapros.Response
]:
