...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.update_case_comment_response.UpdateCaseCommentResponse = aws_sdk_security_ir.types.update_case_comment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_security_ir.types.update_case_comment_request.UpdateCaseCommentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_security_ir.types.update_case_comment_request.serialize_json(input_)
    ).encode()
