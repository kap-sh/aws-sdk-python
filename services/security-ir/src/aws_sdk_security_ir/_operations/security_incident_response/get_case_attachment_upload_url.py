"""Generated from Smithy shape ``com.amazonaws.securityir#GetCaseAttachmentUploadUrl``."""
...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.get_case_attachment_upload_url_response.GetCaseAttachmentUploadUrlResponse = aws_sdk_security_ir.types.get_case_attachment_upload_url_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_security_ir.types.get_case_attachment_upload_url_request.GetCaseAttachmentUploadUrlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/cases/{caseId}/get-presigned-url"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_security_ir.types.get_case_attachment_upload_url_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_case_attachment_upload_url(
