...
def build_request(
    ...
    input: aws_sdk_security_ir.types.update_resolver_type_request.UpdateResolverTypeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_security_ir.types.update_resolver_type_request.serialize_json(input)
    ).encode()
