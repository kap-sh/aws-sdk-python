...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.batch_get_member_account_details_response.BatchGetMemberAccountDetailsResponse = aws_sdk_security_ir.types.batch_get_member_account_details_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_security_ir.types.batch_get_member_account_details_request.BatchGetMemberAccountDetailsRequest,
) -> zapros.Request:
    ...
    url = url.replace("{membershipId}", quote(str(input["membership_id"]), safe=""))
    params: dict[str, str] = {}
