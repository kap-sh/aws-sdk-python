...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.get_case_attachment_download_url_response.GetCaseAttachmentDownloadUrlResponse = aws_sdk_security_ir.types.get_case_attachment_download_url_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_security_ir.types.get_case_attachment_download_url_request.GetCaseAttachmentDownloadUrlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
