...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.get_membership_response.GetMembershipResponse = (
        aws_sdk_security_ir.types.get_membership_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_security_ir.types.get_membership_request.GetMembershipRequest,
) -> zapros.Request:
