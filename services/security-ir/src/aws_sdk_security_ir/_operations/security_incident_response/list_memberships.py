...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.list_memberships_response.ListMembershipsResponse = (
        aws_sdk_security_ir.types.list_memberships_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_security_ir.types.list_memberships_request.ListMembershipsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_security_ir.types.list_memberships_request.serialize_json(input_)
    ).encode()
