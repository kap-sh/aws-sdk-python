...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.close_case_response.CloseCaseResponse = (
        aws_sdk_security_ir.types.close_case_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_security_ir.types.close_case_request.CloseCaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def close_case(
    ...
    aws_sdk_security_ir.types.close_case_response.CloseCaseResponse, zapros.Response
]:
