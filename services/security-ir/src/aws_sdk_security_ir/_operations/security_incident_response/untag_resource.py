"""Generated from Smithy shape ``com.amazonaws.securityir#UntagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_security_ir.types.untag_resource_input.UntagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def untag_resource(
    ...
    aws_sdk_security_ir.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
