...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.create_membership_response.CreateMembershipResponse = aws_sdk_security_ir.types.create_membership_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_security_ir.types.create_membership_request.CreateMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_security_ir.types.create_membership_request.serialize_json(input_)
    ).encode()
