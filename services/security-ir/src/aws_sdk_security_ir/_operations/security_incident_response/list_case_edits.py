...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.list_case_edits_response.ListCaseEditsResponse = (
        aws_sdk_security_ir.types.list_case_edits_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_security_ir.types.list_case_edits_request.ListCaseEditsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_security_ir.types.list_case_edits_request.serialize_json(input_)
    ).encode()
