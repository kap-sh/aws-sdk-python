...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.get_case_response.GetCaseResponse = (
        aws_sdk_security_ir.types.get_case_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_security_ir.types.get_case_request.GetCaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_case(
    ...
    aws_sdk_security_ir.types.get_case_response.GetCaseResponse, zapros.Response
]:
