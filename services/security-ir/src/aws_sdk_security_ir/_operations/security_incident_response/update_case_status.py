...
def build_request(
    ...
    input: aws_sdk_security_ir.types.update_case_status_request.UpdateCaseStatusRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_security_ir.types.update_case_status_request.serialize_json(input)
    ).encode()
