...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.update_case_status_response.UpdateCaseStatusResponse = aws_sdk_security_ir.types.update_case_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_security_ir.types.update_case_status_request.UpdateCaseStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_security_ir.types.update_case_status_request.serialize_json(input_)
    ).encode()
