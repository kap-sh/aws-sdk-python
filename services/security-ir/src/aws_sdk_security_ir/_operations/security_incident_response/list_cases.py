"""Generated from Smithy shape ``com.amazonaws.securityir#ListCases``."""
...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.list_cases_response.ListCasesResponse = (
        aws_sdk_security_ir.types.list_cases_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_security_ir.types.list_cases_request.ListCasesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_security_ir.types.list_cases_request.serialize_json(input)
    ).encode()
...
def list_cases(
    ...
    aws_sdk_security_ir.types.list_cases_response.ListCasesResponse, zapros.Response
]:
