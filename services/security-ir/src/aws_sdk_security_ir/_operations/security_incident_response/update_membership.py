...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.update_membership_response.UpdateMembershipResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_security_ir.types.update_membership_request.UpdateMembershipRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_security_ir.types.update_membership_request.serialize_json(input)
    ).encode()
