...
def build_request(
    ...
    input_: aws_sdk_security_ir.types.update_membership_request.UpdateMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_security_ir.types.update_membership_request.serialize_json(input_)
    ).encode()
