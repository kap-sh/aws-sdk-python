...
import aws_sdk_security_ir.types.investigation_action_list
...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.list_investigations_response.ListInvestigationsResponse = aws_sdk_security_ir.types.list_investigations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_security_ir.types.list_investigations_request.ListInvestigationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
