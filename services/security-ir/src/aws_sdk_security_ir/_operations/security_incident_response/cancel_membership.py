...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.cancel_membership_response.CancelMembershipResponse = aws_sdk_security_ir.types.cancel_membership_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_security_ir.types.cancel_membership_request.CancelMembershipRequest,
) -> zapros.Request:
