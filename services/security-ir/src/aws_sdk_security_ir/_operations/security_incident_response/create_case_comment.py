...
def handle_response(
    ...
    out: aws_sdk_security_ir.types.create_case_comment_response.CreateCaseCommentResponse = aws_sdk_security_ir.types.create_case_comment_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_security_ir.types.create_case_comment_request.CreateCaseCommentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_security_ir.types.create_case_comment_request.serialize_json(input)
    ).encode()
