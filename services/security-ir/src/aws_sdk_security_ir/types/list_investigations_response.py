...
class ListInvestigationsResponse(TypedDict):
    ...
    investigation_actions: (
        "aws_sdk_security_ir.types.investigation_action_list.InvestigationActionList"
    )
...
def serialize_json(value: ListInvestigationsResponse) -> dict:
    ...
    out["investigationActions"] = (
        aws_sdk_security_ir.types.investigation_action_list.serialize_json(
...
def deserialize_json(data: dict) -> ListInvestigationsResponse:
    ...
    if "investigationActions" in data:
        ...
        out["investigation_actions"] = (
            aws_sdk_security_ir.types.investigation_action_list.deserialize_json(
