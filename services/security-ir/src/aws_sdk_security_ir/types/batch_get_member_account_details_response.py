...
class BatchGetMemberAccountDetailsResponse(TypedDict):
    ...
    errors: NotRequired[
        "aws_sdk_security_ir.types.get_membership_account_detail_errors.GetMembershipAccountDetailErrors"
    ]
...
def serialize_json(value: BatchGetMemberAccountDetailsResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = (
            aws_sdk_security_ir.types.get_membership_account_detail_items.serialize_json(
                value["items"]
            )
        )
    if "errors" in value:
        ...
        out["errors"] = (
            aws_sdk_security_ir.types.get_membership_account_detail_errors.serialize_json(
                value["errors"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> BatchGetMemberAccountDetailsResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_security_ir.types.get_membership_account_detail_items.deserialize_json(
                data["items"]
            )
        )
    if "errors" in data:
        ...
        out["errors"] = (
            aws_sdk_security_ir.types.get_membership_account_detail_errors.deserialize_json(
                data["errors"]
            )
        )
    return out
