...
if TYPE_CHECKING:
    ...
    import aws_sdk_security_ir.types.case_edit_action
    import aws_sdk_security_ir.types.case_edit_message


class CaseEditItem(TypedDict):
    event_timestamp: NotRequired["datetime.datetime"]
    """<p/>"""
    principal: NotRequired["str"]
    """<p/>"""
    action: NotRequired["aws_sdk_security_ir.types.case_edit_action.CaseEditAction"]
    """<p/>"""
    message: NotRequired["aws_sdk_security_ir.types.case_edit_message.CaseEditMessage"]
    """<p/>"""
