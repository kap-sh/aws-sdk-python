...
if TYPE_CHECKING:
    ...
    import aws_sdk_security_ir.types.customer_type
    import aws_sdk_security_ir.types.incident_response_team
    import aws_sdk_security_ir.types.membership_accounts_configurations
...
class GetMembershipResponse(TypedDict):
    ...
    customer_type: NotRequired["aws_sdk_security_ir.types.customer_type.CustomerType"]
    ...
    membership_accounts_configurations: NotRequired[
        "aws_sdk_security_ir.types.membership_accounts_configurations.MembershipAccountsConfigurations"
    ]
...
def serialize_json(value: GetMembershipResponse) -> dict:
    ...
    if "customer_type" in value:
        ...
        out["customerType"] = aws_sdk_security_ir.types.customer_type.serialize_json(
            value["customer_type"]
        )
    ...
    if "membership_accounts_configurations" in value:
        ...
        out["membershipAccountsConfigurations"] = (
            aws_sdk_security_ir.types.membership_accounts_configurations.serialize_json(
...
def deserialize_json(data: dict) -> GetMembershipResponse:
    ...
    if "customerType" in data:
        ...
        out["customer_type"] = aws_sdk_security_ir.types.customer_type.deserialize_json(
            data["customerType"]
        )
    ...
    if "membershipAccountsConfigurations" in data:
        ...
        out["membership_accounts_configurations"] = (
            aws_sdk_security_ir.types.membership_accounts_configurations.deserialize_json(
