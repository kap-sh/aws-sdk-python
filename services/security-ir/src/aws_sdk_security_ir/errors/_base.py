...
class SecurityIRError(Exception):
    """Base class for all SecurityIR service errors."""


class ServiceError(SecurityIRError):
...
class SerializationError(SecurityIRError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SecurityIRError):
...
class WaiterFailedError(SecurityIRError):
...
class WaiterTimeoutError(SecurityIRError):
