...
import capo_iot_jobs_data_plane.errors.terminal_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TerminalStateException":
            raise capo_iot_jobs_data_plane.errors.terminal_state_exception.TerminalStateException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_iot_jobs_data_plane.types.describe_job_execution_response.DescribeJobExecutionResponse = capo_iot_jobs_data_plane.types.describe_job_execution_response.deserialize_json(
