...
import capo_iot_jobs_data_plane.errors.conflict_exception
import capo_iot_jobs_data_plane.errors.internal_server_exception
import capo_iot_jobs_data_plane.errors.resource_not_found_exception
import capo_iot_jobs_data_plane.errors.service_quota_exceeded_exception
import capo_iot_jobs_data_plane.errors.throttling_exception
import capo_iot_jobs_data_plane.errors.validation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            raise capo_iot_jobs_data_plane.errors.conflict_exception.ConflictException.from_json(
                data
            )
        case "InternalServerException":
            raise capo_iot_jobs_data_plane.errors.internal_server_exception.InternalServerException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_iot_jobs_data_plane.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
        ...
        case "ValidationException":
            raise capo_iot_jobs_data_plane.errors.validation_exception.ValidationException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_iot_jobs_data_plane.types.start_command_execution_response.StartCommandExecutionResponse = capo_iot_jobs_data_plane.types.start_command_execution_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_jobs_data_plane.types.start_command_execution_request.serialize_json(
            input_
        )
    ).encode()
