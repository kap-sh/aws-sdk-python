...
if TYPE_CHECKING:
    import aws_sdk_iot_jobs_data_plane.types.binary_blob
...
def serialize_json(value: ThrottlingException_) -> dict:
    ...
    if "payload" in value:
        ...
        out["payload"] = aws_sdk_iot_jobs_data_plane.types.binary_blob.serialize_json(
            value["payload"]
        )
    return out
...
def deserialize_json(data: dict) -> ThrottlingException_:
    ...
    if "payload" in data:
        ...
        out["payload"] = aws_sdk_iot_jobs_data_plane.types.binary_blob.deserialize_json(
            data["payload"]
        )
    return out
