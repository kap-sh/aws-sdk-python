"""Generated from Smithy shape ``com.amazonaws.iotjobsdataplane#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotjobsdataplane#ServiceQuotaExceededException``."""
