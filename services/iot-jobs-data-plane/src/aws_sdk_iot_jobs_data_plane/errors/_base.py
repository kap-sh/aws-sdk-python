...
class IoTJobsDataPlaneError(Exception):
    """Base class for all IoTJobsDataPlane service errors."""


class ServiceError(IoTJobsDataPlaneError):
...
class SerializationError(IoTJobsDataPlaneError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IoTJobsDataPlaneError):
...
class WaiterFailedError(IoTJobsDataPlaneError):
...
class WaiterTimeoutError(IoTJobsDataPlaneError):
