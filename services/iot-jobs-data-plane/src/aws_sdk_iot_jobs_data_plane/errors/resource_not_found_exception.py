"""Generated from Smithy shape ``com.amazonaws.iotjobsdataplane#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotjobsdataplane#ResourceNotFoundException``."""
