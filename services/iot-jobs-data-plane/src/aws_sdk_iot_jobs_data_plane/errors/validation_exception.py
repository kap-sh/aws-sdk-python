"""Generated from Smithy shape ``com.amazonaws.iotjobsdataplane#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotjobsdataplane#ValidationException``."""
