...
if TYPE_CHECKING:
    import aws_sdk_iot_jobs_data_plane.types.command_execution_id


class StartCommandExecutionResponse(TypedDict):
    execution_id: NotRequired[
        "aws_sdk_iot_jobs_data_plane.types.command_execution_id.CommandExecutionId"
    ]
