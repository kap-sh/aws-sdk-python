...
from aws_sdk_iot_jobs_data_plane._services._aws_config import aaws_config
...
class AsyncIoTJobsDataPlaneClientConfig(TypedDict, total=False):
...
class AsyncIoTJobsDataPlaneClient:
    ...
    async def describe_job_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot_jobs_data_plane.types.describe_job_execution_request.DescribeJobExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot_jobs_data_plane.types.describe_job_execution_response.DescribeJobExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot_jobs_data_plane._operations.iot_laser_thing_job_manager_external_service.describe_job_execution.async_describe_job_execution(
    ...
    async def get_pending_job_executions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot_jobs_data_plane.types.get_pending_job_executions_request.GetPendingJobExecutionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot_jobs_data_plane.types.get_pending_job_executions_response.GetPendingJobExecutionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot_jobs_data_plane._operations.iot_laser_thing_job_manager_external_service.get_pending_job_executions.async_get_pending_job_executions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_command_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot_jobs_data_plane.types.start_command_execution_request.StartCommandExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot_jobs_data_plane.types.start_command_execution_response.StartCommandExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot_jobs_data_plane._operations.iot_laser_thing_job_manager_external_service.start_command_execution.async_start_command_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_next_pending_job_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot_jobs_data_plane.types.start_next_pending_job_execution_request.StartNextPendingJobExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot_jobs_data_plane.types.start_next_pending_job_execution_response.StartNextPendingJobExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot_jobs_data_plane._operations.iot_laser_thing_job_manager_external_service.start_next_pending_job_execution.async_start_next_pending_job_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_job_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot_jobs_data_plane.types.update_job_execution_request.UpdateJobExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot_jobs_data_plane.types.update_job_execution_response.UpdateJobExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot_jobs_data_plane._operations.iot_laser_thing_job_manager_external_service.update_job_execution.async_update_job_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
