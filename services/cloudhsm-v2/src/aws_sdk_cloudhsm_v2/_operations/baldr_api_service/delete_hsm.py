...
def handle_response(
    ...
    out: aws_sdk_cloudhsm_v2.types.delete_hsm_response.DeleteHsmResponse = (
        aws_sdk_cloudhsm_v2.types.delete_hsm_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudhsm_v2.types.delete_hsm_request.DeleteHsmRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudhsm_v2.types.delete_hsm_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_hsm(
    ...
    aws_sdk_cloudhsm_v2.types.delete_hsm_response.DeleteHsmResponse, zapros.Response
]:
