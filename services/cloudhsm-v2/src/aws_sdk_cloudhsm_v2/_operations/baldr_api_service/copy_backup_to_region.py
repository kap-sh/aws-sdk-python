"""Generated from Smithy shape ``com.amazonaws.cloudhsmv2#CopyBackupToRegion``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudhsm_v2.types.copy_backup_to_region_response.CopyBackupToRegionResponse = aws_sdk_cloudhsm_v2.types.copy_backup_to_region_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudhsm_v2.types.copy_backup_to_region_request.CopyBackupToRegionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudhsm_v2.types.copy_backup_to_region_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_copy_backup_to_region(
