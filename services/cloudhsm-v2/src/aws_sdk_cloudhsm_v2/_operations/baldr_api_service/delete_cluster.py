...
def build_request(
    ...
    input: aws_sdk_cloudhsm_v2.types.delete_cluster_request.DeleteClusterRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudhsm_v2.types.delete_cluster_request.serialize_aws_json_1_1(input)
    ).encode()
