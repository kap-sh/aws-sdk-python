...
def build_request(
    ...
    input: aws_sdk_cloudhsm_v2.types.restore_backup_request.RestoreBackupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudhsm_v2.types.restore_backup_request.serialize_aws_json_1_1(input)
    ).encode()
