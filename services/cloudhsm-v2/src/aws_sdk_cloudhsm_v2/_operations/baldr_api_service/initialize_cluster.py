"""Generated from Smithy shape ``com.amazonaws.cloudhsmv2#InitializeCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudhsm_v2.types.initialize_cluster_response.InitializeClusterResponse = aws_sdk_cloudhsm_v2.types.initialize_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudhsm_v2.types.initialize_cluster_request.InitializeClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudhsm_v2.types.initialize_cluster_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_initialize_cluster(
