...
def handle_response(
    ...
    out: aws_sdk_cloudhsm_v2.types.modify_cluster_response.ModifyClusterResponse = (
        aws_sdk_cloudhsm_v2.types.modify_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_cloudhsm_v2.types.modify_cluster_request.ModifyClusterRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudhsm_v2.types.modify_cluster_request.serialize_aws_json_1_1(input)
    ).encode()
