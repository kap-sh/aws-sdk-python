...
def handle_response(
    ...
    out: aws_sdk_cloudhsm_v2.types.describe_backups_response.DescribeBackupsResponse = (
        aws_sdk_cloudhsm_v2.types.describe_backups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_cloudhsm_v2.types.describe_backups_request.DescribeBackupsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudhsm_v2.types.describe_backups_request.serialize_aws_json_1_1(input)
    ).encode()
