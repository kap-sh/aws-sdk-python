...
def build_request(
    ...
    input_: aws_sdk_cloudhsm_v2.types.describe_backups_request.DescribeBackupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudhsm_v2.types.describe_backups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
