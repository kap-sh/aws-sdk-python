...
def handle_response(
    ...
    out: aws_sdk_cloudhsm_v2.types.get_resource_policy_response.GetResourcePolicyResponse = aws_sdk_cloudhsm_v2.types.get_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudhsm_v2.types.get_resource_policy_request.GetResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
