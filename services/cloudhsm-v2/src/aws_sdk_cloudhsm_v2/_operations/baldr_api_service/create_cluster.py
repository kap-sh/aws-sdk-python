"""Generated from Smithy shape ``com.amazonaws.cloudhsmv2#CreateCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudhsm_v2.types.create_cluster_response.CreateClusterResponse = (
        aws_sdk_cloudhsm_v2.types.create_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudhsm_v2.types.create_cluster_request.CreateClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudhsm_v2.types.create_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
