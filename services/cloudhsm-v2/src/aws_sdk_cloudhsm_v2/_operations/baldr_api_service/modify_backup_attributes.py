"""Generated from Smithy shape ``com.amazonaws.cloudhsmv2#ModifyBackupAttributes``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudhsm_v2.types.modify_backup_attributes_response.ModifyBackupAttributesResponse = aws_sdk_cloudhsm_v2.types.modify_backup_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudhsm_v2.types.modify_backup_attributes_request.ModifyBackupAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "BaldrApiService.ModifyBackupAttributes"
    import aws_sdk_cloudhsm_v2.types.modify_backup_attributes_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudhsm_v2.types.modify_backup_attributes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_modify_backup_attributes(
