...
class CloudHSMV2Error(Exception):
    """Base class for all CloudHSMV2 service errors."""


class ServiceError(CloudHSMV2Error):
...
class SerializationError(CloudHSMV2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(CloudHSMV2Error):
...
class WaiterFailedError(CloudHSMV2Error):
...
class WaiterTimeoutError(CloudHSMV2Error):
