...
class CreateClusterRequest(TypedDict, closed=True):
    ...
    source_backup_id: NotRequired["aws_sdk_cloudhsm_v2.types.backup_arn.BackupArn"]
...
def serialize_aws_json_1_1(value: CreateClusterRequest) -> dict:
    ...
    out["SubnetIds"] = aws_sdk_cloudhsm_v2.types.subnet_ids.serialize_aws_json_1_1(
        value["subnet_ids"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> CreateClusterRequest:
    ...
    if "SubnetIds" in data:
        ...
        out["subnet_ids"] = (
            aws_sdk_cloudhsm_v2.types.subnet_ids.deserialize_aws_json_1_1(
                data["SubnetIds"]
            )
        )
    else:
