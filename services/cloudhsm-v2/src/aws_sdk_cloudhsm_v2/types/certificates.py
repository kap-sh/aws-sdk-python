...
class Certificates(TypedDict, closed=True):
    ...
    aws_hardware_certificate: NotRequired["aws_sdk_cloudhsm_v2.types.cert.Cert"]
    """<p>The HSM hardware certificate issued (signed) by CloudHSM.</p>"""
    manufacturer_hardware_certificate: NotRequired[
        "aws_sdk_cloudhsm_v2.types.cert.Cert"
    ]
    """<p>The HSM hardware certificate issued (signed) by the hardware manufacturer.</p>"""
    cluster_certificate: NotRequired["aws_sdk_cloudhsm_v2.types.cert.Cert"]
