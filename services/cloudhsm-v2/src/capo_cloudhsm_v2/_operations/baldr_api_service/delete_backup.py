"""Generated from Smithy shape ``com.amazonaws.cloudhsmv2#DeleteBackup``."""
...
import capo_cloudhsm_v2.types.delete_backup_request
import capo_cloudhsm_v2.types.delete_backup_response
...
) -> capo_cloudhsm_v2.types.delete_backup_response.DeleteBackupResponse:
    out: capo_cloudhsm_v2.types.delete_backup_response.DeleteBackupResponse = (
        capo_cloudhsm_v2.types.delete_backup_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.delete_backup_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_backup(
    ...
    capo_cloudhsm_v2.types.delete_backup_response.DeleteBackupResponse, zapros.Response
]:
