...
import capo_cloudhsm_v2.types.restore_backup_request
import capo_cloudhsm_v2.types.restore_backup_response
...
) -> capo_cloudhsm_v2.types.restore_backup_response.RestoreBackupResponse:
    out: capo_cloudhsm_v2.types.restore_backup_response.RestoreBackupResponse = (
        capo_cloudhsm_v2.types.restore_backup_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.restore_backup_request.serialize_aws_json_1_1(input_)
    ).encode()
