"""Generated from Smithy shape ``com.amazonaws.cloudhsmv2#DeleteCluster``."""
...
import capo_cloudhsm_v2.types.delete_cluster_request
import capo_cloudhsm_v2.types.delete_cluster_response
...
) -> capo_cloudhsm_v2.types.delete_cluster_response.DeleteClusterResponse:
    out: capo_cloudhsm_v2.types.delete_cluster_response.DeleteClusterResponse = (
        capo_cloudhsm_v2.types.delete_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.delete_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
