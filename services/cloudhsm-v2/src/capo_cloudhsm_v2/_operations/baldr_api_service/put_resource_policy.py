"""Generated from Smithy shape ``com.amazonaws.cloudhsmv2#PutResourcePolicy``."""
...
import capo_cloudhsm_v2.types.put_resource_policy_request
import capo_cloudhsm_v2.types.put_resource_policy_response
...
) -> capo_cloudhsm_v2.types.put_resource_policy_response.PutResourcePolicyResponse:
    out: capo_cloudhsm_v2.types.put_resource_policy_response.PutResourcePolicyResponse = capo_cloudhsm_v2.types.put_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "BaldrApiService.PutResourcePolicy"
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.put_resource_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
