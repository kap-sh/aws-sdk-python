"""Generated from Smithy shape ``com.amazonaws.cloudhsmv2#DeleteResourcePolicy``."""
...
import capo_cloudhsm_v2.types.delete_resource_policy_request
import capo_cloudhsm_v2.types.delete_resource_policy_response
...
def handle_response(
    ...
    capo_cloudhsm_v2.types.delete_resource_policy_response.DeleteResourcePolicyResponse
):
    out: capo_cloudhsm_v2.types.delete_resource_policy_response.DeleteResourcePolicyResponse = capo_cloudhsm_v2.types.delete_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "BaldrApiService.DeleteResourcePolicy"
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.delete_resource_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
