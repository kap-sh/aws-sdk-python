"""Generated from Smithy shape ``com.amazonaws.cloudhsmv2#DescribeBackups``."""
...
import capo_cloudhsm_v2.types.describe_backups_request
import capo_cloudhsm_v2.types.describe_backups_response
...
) -> capo_cloudhsm_v2.types.describe_backups_response.DescribeBackupsResponse:
    out: capo_cloudhsm_v2.types.describe_backups_response.DescribeBackupsResponse = (
        capo_cloudhsm_v2.types.describe_backups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.describe_backups_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_backups(
