"""Generated from Smithy shape ``com.amazonaws.cloudhsmv2#TagResource``."""
...
import capo_cloudhsm_v2.errors.cloud_hsm_resource_limit_exceeded_exception
...
import capo_cloudhsm_v2.errors.cloud_hsm_tag_exception
import capo_cloudhsm_v2.types.tag_list
import capo_cloudhsm_v2.types.tag_resource_request
import capo_cloudhsm_v2.types.tag_resource_response
...
from capo_cloudhsm_v2._services._pipeline import AsyncOperationOptions, OperationOptions
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CloudHsmResourceLimitExceededException":
            raise capo_cloudhsm_v2.errors.cloud_hsm_resource_limit_exceeded_exception.CloudHsmResourceLimitExceededException.from_aws_json_1_1(
                data
            )
        ...
        case "CloudHsmTagException":
            raise capo_cloudhsm_v2.errors.cloud_hsm_tag_exception.CloudHsmTagException.from_aws_json_1_1(
                data
            )
        case _:
...
) -> capo_cloudhsm_v2.types.tag_resource_response.TagResourceResponse:
    out: capo_cloudhsm_v2.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_cloudhsm_v2._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_cloudhsm_v2.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
