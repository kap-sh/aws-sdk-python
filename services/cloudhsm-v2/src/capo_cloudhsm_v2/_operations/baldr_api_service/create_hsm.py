"""Generated from Smithy shape ``com.amazonaws.cloudhsmv2#CreateHsm``."""
...
import capo_cloudhsm_v2.types.create_hsm_request
import capo_cloudhsm_v2.types.create_hsm_response
...
) -> capo_cloudhsm_v2.types.create_hsm_response.CreateHsmResponse:
    out: capo_cloudhsm_v2.types.create_hsm_response.CreateHsmResponse = (
        capo_cloudhsm_v2.types.create_hsm_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.create_hsm_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_hsm(
    ...
    capo_cloudhsm_v2.types.create_hsm_response.CreateHsmResponse, zapros.Response
]:
