...
if TYPE_CHECKING:
    import capo_waf.types.excluded_rules
    import capo_waf.types.resource_id
    import capo_waf.types.rule_priority
    import capo_waf.types.waf_action
    import capo_waf.types.waf_override_action
    import capo_waf.types.waf_rule_type


class ActivatedRule(TypedDict, closed=True):
    priority: "capo_waf.types.rule_priority.RulePriority"
    ...
    action: NotRequired["capo_waf.types.waf_action.WafAction"]
    ...
    override_action: NotRequired["capo_waf.types.waf_override_action.WafOverrideAction"]
    ...
    type: NotRequired["capo_waf.types.waf_rule_type.WafRuleType"]
    ...
    excluded_rules: NotRequired["capo_waf.types.excluded_rules.ExcludedRules"]
...
def serialize_aws_json_1_1(value: ActivatedRule) -> dict:
    ...
    if "action" in value:
        ...
        out["Action"] = capo_waf.types.waf_action.serialize_aws_json_1_1(
            value["action"]
        )
    if "override_action" in value:
        ...
        out["OverrideAction"] = (
            capo_waf.types.waf_override_action.serialize_aws_json_1_1(
    ...
    if "type" in value:
        ...
        out["Type"] = capo_waf.types.waf_rule_type.serialize_aws_json_1_1(value["type"])
    if "excluded_rules" in value:
        import capo_waf.types.excluded_rules

        out["ExcludedRules"] = capo_waf.types.excluded_rules.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ActivatedRule:
    ...
    if "Action" in data:
        ...
        out["action"] = capo_waf.types.waf_action.deserialize_aws_json_1_1(
            data["Action"]
        )
    if "OverrideAction" in data:
        ...
        out["override_action"] = (
            capo_waf.types.waf_override_action.deserialize_aws_json_1_1(
                data["OverrideAction"]
            )
        )
    if "Type" in data:
        ...
        out["type"] = capo_waf.types.waf_rule_type.deserialize_aws_json_1_1(
            data["Type"]
        )
    if "ExcludedRules" in data:
        import capo_waf.types.excluded_rules

        out["excluded_rules"] = capo_waf.types.excluded_rules.deserialize_aws_json_1_1(
            data["ExcludedRules"]
        )
    return out
