...
if TYPE_CHECKING:
    import capo_waf.types.byte_match_target_string
    import capo_waf.types.field_to_match
    import capo_waf.types.positional_constraint
...
class ByteMatchTuple(TypedDict, closed=True):
    ...
    target_string: "capo_waf.types.byte_match_target_string.ByteMatchTargetString"
    ...
    positional_constraint: "capo_waf.types.positional_constraint.PositionalConstraint"
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ByteMatchTuple) -> dict:
    out: dict = {}
    import capo_waf.types.field_to_match
    ...
    out["TargetString"] = (
        capo_waf.types.byte_match_target_string.serialize_aws_json_1_1(
            value["target_string"]
        )
    )
    import capo_waf.types.text_transformation
    ...
    out["PositionalConstraint"] = (
        capo_waf.types.positional_constraint.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ByteMatchTuple:
    ...
    if "TargetString" in data:
        ...
        out["target_string"] = (
            capo_waf.types.byte_match_target_string.deserialize_aws_json_1_1(
                data["TargetString"]
            )
        )
    else:
    ...
    if "PositionalConstraint" in data:
        ...
        out["positional_constraint"] = (
            capo_waf.types.positional_constraint.deserialize_aws_json_1_1(
                data["PositionalConstraint"]
            )
        )
    else:
        raise DeserializationError("ByteMatchTuple.positional_constraint required")
    return out
