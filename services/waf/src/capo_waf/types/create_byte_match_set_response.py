"""Generated from Smithy shape ``com.amazonaws.waf#CreateByteMatchSetResponse``."""
...
class CreateByteMatchSetResponse(TypedDict, closed=True):
    byte_match_set: NotRequired["capo_waf.types.byte_match_set.ByteMatchSet"]
...
def serialize_aws_json_1_1(value: CreateByteMatchSetResponse) -> dict:
    ...
    if "byte_match_set" in value:
        ...
        out["ByteMatchSet"] = capo_waf.types.byte_match_set.serialize_aws_json_1_1(
