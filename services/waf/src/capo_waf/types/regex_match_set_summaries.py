...
if TYPE_CHECKING:
    import capo_waf.types.regex_match_set_summary

RegexMatchSetSummaries: TypeAlias = list[
    "capo_waf.types.regex_match_set_summary.RegexMatchSetSummary"
]
...
def serialize_aws_json_1_1(value: RegexMatchSetSummaries) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_waf.types.regex_match_set_summary.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> RegexMatchSetSummaries:
    ...
    for item in data:
        out.append(
            capo_waf.types.regex_match_set_summary.deserialize_aws_json_1_1(item)
        )
    return out
