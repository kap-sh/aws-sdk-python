...
if TYPE_CHECKING:
    import capo_waf.types.action
    import capo_waf.types.http_request
    import capo_waf.types.resource_id
    import capo_waf.types.sample_weight
    import capo_waf.types.timestamp


class SampledHTTPRequest(TypedDict, closed=True):
    request: "capo_waf.types.http_request.HTTPRequest"
    """<p>A complex type that contains detailed information about the request.</p>"""
    weight: "capo_waf.types.sample_weight.SampleWeight"
...
def serialize_aws_json_1_1(value: SampledHTTPRequest) -> dict:
    ...
    out["Request"] = capo_waf.types.http_request.serialize_aws_json_1_1(
        value["request"]
    )
    ...
    if "timestamp" in value:
        ...
        out["Timestamp"] = capo_waf.types.timestamp.serialize_aws_json_1_1(
            value["timestamp"]
        )
    if "action" in value:
...
def deserialize_aws_json_1_1(data: dict) -> SampledHTTPRequest:
    ...
    if "Request" in data:
        ...
        out["request"] = capo_waf.types.http_request.deserialize_aws_json_1_1(
            data["Request"]
        )
    else:
    ...
    if "Timestamp" in data:
        ...
        out["timestamp"] = capo_waf.types.timestamp.deserialize_aws_json_1_1(
            data["Timestamp"]
        )
    if "Action" in data:
