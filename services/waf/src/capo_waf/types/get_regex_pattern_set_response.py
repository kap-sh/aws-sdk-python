"""Generated from Smithy shape ``com.amazonaws.waf#GetRegexPatternSetResponse``."""
...
class GetRegexPatternSetResponse(TypedDict, closed=True):
    regex_pattern_set: NotRequired["capo_waf.types.regex_pattern_set.RegexPatternSet"]
...
def serialize_aws_json_1_1(value: GetRegexPatternSetResponse) -> dict:
    ...
    if "regex_pattern_set" in value:
        ...
        out["RegexPatternSet"] = (
            capo_waf.types.regex_pattern_set.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetRegexPatternSetResponse:
    ...
    if "RegexPatternSet" in data:
        ...
        out["regex_pattern_set"] = (
            capo_waf.types.regex_pattern_set.deserialize_aws_json_1_1(
