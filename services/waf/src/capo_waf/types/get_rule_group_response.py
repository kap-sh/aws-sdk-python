...
class GetRuleGroupResponse(TypedDict, closed=True):
    rule_group: NotRequired["capo_waf.types.rule_group.RuleGroup"]
...
def serialize_aws_json_1_1(value: GetRuleGroupResponse) -> dict:
    ...
    if "rule_group" in value:
        ...
        out["RuleGroup"] = capo_waf.types.rule_group.serialize_aws_json_1_1(
            value["rule_group"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetRuleGroupResponse:
    ...
    if "RuleGroup" in data:
        ...
        out["rule_group"] = capo_waf.types.rule_group.deserialize_aws_json_1_1(
            data["RuleGroup"]
        )
    return out
