...
if TYPE_CHECKING:
    import capo_waf.types.ip_set_descriptor_type
    import capo_waf.types.ip_set_descriptor_value


class IPSetDescriptor(TypedDict, closed=True):
    type: "capo_waf.types.ip_set_descriptor_type.IPSetDescriptorType"
    """<p>Specify <code>IPV4</code> or <code>IPV6</code>.</p>"""
    value: "capo_waf.types.ip_set_descriptor_value.IPSetDescriptorValue"
...
def serialize_aws_json_1_1(value: IPSetDescriptor) -> dict:
    ...
    out["Type"] = capo_waf.types.ip_set_descriptor_type.serialize_aws_json_1_1(
        value["type"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> IPSetDescriptor:
    ...
    if "Type" in data:
        ...
        out["type"] = capo_waf.types.ip_set_descriptor_type.deserialize_aws_json_1_1(
            data["Type"]
        )
    else:
