...
if TYPE_CHECKING:
    import capo_waf.types.geo_match_constraints
...
class GeoMatchSet(TypedDict, closed=True):
    ...
    geo_match_constraints: "capo_waf.types.geo_match_constraints.GeoMatchConstraints"
...
def serialize_aws_json_1_1(value: GeoMatchSet) -> dict:
    ...
    out["GeoMatchConstraints"] = (
        capo_waf.types.geo_match_constraints.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GeoMatchSet:
    ...
    if "GeoMatchConstraints" in data:
        ...
        out["geo_match_constraints"] = (
            capo_waf.types.geo_match_constraints.deserialize_aws_json_1_1(
