...
class WAFError(Exception):
    """Base class for all WAF service errors."""


class ServiceError(WAFError):
...
class SerializationError(WAFError):
    """Raised when a value cannot be serialized."""


class DeserializationError(WAFError):
...
class WaiterFailedError(WAFError):
...
class WaiterTimeoutError(WAFError):
