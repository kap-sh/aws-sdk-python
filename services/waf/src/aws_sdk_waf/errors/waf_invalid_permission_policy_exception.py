"""Generated from Smithy shape ``com.amazonaws.waf#WAFInvalidPermissionPolicyException``."""
...
class WAFInvalidPermissionPolicyException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.waf#WAFInvalidPermissionPolicyException``."""
