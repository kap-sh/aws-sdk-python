...
if TYPE_CHECKING:
    ...
    import aws_sdk_waf.types.error_reason
...
class WAFEntityMigrationException_(TypedDict, closed=True):
    ...
    migration_error_reason: NotRequired["aws_sdk_waf.types.error_reason.ErrorReason"]
...
def serialize_aws_json_1_1(value: WAFEntityMigrationException_) -> dict:
    ...
    if "migration_error_type" in value:
        ...
        out["MigrationErrorType"] = (
            aws_sdk_waf.types.migration_error_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> WAFEntityMigrationException_:
    ...
    if "MigrationErrorType" in data:
        ...
        out["migration_error_type"] = (
            aws_sdk_waf.types.migration_error_type.deserialize_aws_json_1_1(
...
class WAFEntityMigrationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.waf#WAFEntityMigrationException``."""
