...
if TYPE_CHECKING:
    import aws_sdk_waf.types.waf_override_action_type


class WafOverrideAction(TypedDict, closed=True):
    type: "aws_sdk_waf.types.waf_override_action_type.WafOverrideActionType"
...
def serialize_aws_json_1_1(value: WafOverrideAction) -> dict:
    ...
    out["Type"] = aws_sdk_waf.types.waf_override_action_type.serialize_aws_json_1_1(
        value["type"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> WafOverrideAction:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_waf.types.waf_override_action_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    else:
