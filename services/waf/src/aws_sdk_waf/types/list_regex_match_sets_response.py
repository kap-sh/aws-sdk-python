...
class ListRegexMatchSetsResponse(TypedDict):
    ...
    regex_match_sets: NotRequired[
        "aws_sdk_waf.types.regex_match_set_summaries.RegexMatchSetSummaries"
    ]
...
def serialize_aws_json_1_1(value: ListRegexMatchSetsResponse) -> dict:
    ...
    if "regex_match_sets" in value:
        ...
        out["RegexMatchSets"] = (
            aws_sdk_waf.types.regex_match_set_summaries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListRegexMatchSetsResponse:
    ...
    if "RegexMatchSets" in data:
        ...
        out["regex_match_sets"] = (
            aws_sdk_waf.types.regex_match_set_summaries.deserialize_aws_json_1_1(
                data["RegexMatchSets"]
            )
        )
    return out
