...
class UpdateGeoMatchSetRequest(TypedDict):
...
def serialize_aws_json_1_1(value: UpdateGeoMatchSetRequest) -> dict:
    ...
    out["Updates"] = aws_sdk_waf.types.geo_match_set_updates.serialize_aws_json_1_1(
        value["updates"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UpdateGeoMatchSetRequest:
    ...
    if "Updates" in data:
        ...
        out["updates"] = (
            aws_sdk_waf.types.geo_match_set_updates.deserialize_aws_json_1_1(
                data["Updates"]
            )
        )
    else:
