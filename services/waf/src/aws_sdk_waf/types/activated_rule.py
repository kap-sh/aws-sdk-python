...
if TYPE_CHECKING:
    import aws_sdk_waf.types.excluded_rules
    import aws_sdk_waf.types.resource_id
    import aws_sdk_waf.types.rule_priority
    import aws_sdk_waf.types.waf_action
    import aws_sdk_waf.types.waf_override_action
...
class ActivatedRule(TypedDict, closed=True):
    ...
    action: NotRequired["aws_sdk_waf.types.waf_action.WafAction"]
    ...
    override_action: NotRequired[
        "aws_sdk_waf.types.waf_override_action.WafOverrideAction"
    ]
    ...
    type: NotRequired["aws_sdk_waf.types.waf_rule_type.WafRuleType"]
    ...
    excluded_rules: NotRequired["aws_sdk_waf.types.excluded_rules.ExcludedRules"]
...
def serialize_aws_json_1_1(value: ActivatedRule) -> dict:
    ...
    if "action" in value:
        ...
        out["Action"] = aws_sdk_waf.types.waf_action.serialize_aws_json_1_1(
            value["action"]
        )
    if "override_action" in value:
        ...
        out["OverrideAction"] = (
            aws_sdk_waf.types.waf_override_action.serialize_aws_json_1_1(
    ...
    if "type" in value:
        ...
        out["Type"] = aws_sdk_waf.types.waf_rule_type.serialize_aws_json_1_1(
            value["type"]
        )
    if "excluded_rules" in value:
        import aws_sdk_waf.types.excluded_rules

        out["ExcludedRules"] = aws_sdk_waf.types.excluded_rules.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ActivatedRule:
    ...
    if "Action" in data:
        ...
        out["action"] = aws_sdk_waf.types.waf_action.deserialize_aws_json_1_1(
            data["Action"]
        )
    if "OverrideAction" in data:
        ...
        out["override_action"] = (
            aws_sdk_waf.types.waf_override_action.deserialize_aws_json_1_1(
                data["OverrideAction"]
            )
        )
    if "Type" in data:
        ...
        out["type"] = aws_sdk_waf.types.waf_rule_type.deserialize_aws_json_1_1(
            data["Type"]
        )
    if "ExcludedRules" in data:
        ...
        out["excluded_rules"] = (
            aws_sdk_waf.types.excluded_rules.deserialize_aws_json_1_1(
                data["ExcludedRules"]
            )
        )
    return out
