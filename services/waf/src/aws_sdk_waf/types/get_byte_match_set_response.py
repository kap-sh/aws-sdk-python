...
class GetByteMatchSetResponse(TypedDict):
    byte_match_set: NotRequired["aws_sdk_waf.types.byte_match_set.ByteMatchSet"]
...
def serialize_aws_json_1_1(value: GetByteMatchSetResponse) -> dict:
    ...
    if "byte_match_set" in value:
        ...
        out["ByteMatchSet"] = aws_sdk_waf.types.byte_match_set.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetByteMatchSetResponse:
    ...
    if "ByteMatchSet" in data:
        ...
        out["byte_match_set"] = (
            aws_sdk_waf.types.byte_match_set.deserialize_aws_json_1_1(
                data["ByteMatchSet"]
            )
        )
    return out
