...
if TYPE_CHECKING:
    import aws_sdk_waf.types.ip_set_descriptors
...
class IPSet(TypedDict):
    ...
    ip_set_descriptors: "aws_sdk_waf.types.ip_set_descriptors.IPSetDescriptors"
...
def serialize_aws_json_1_1(value: IPSet) -> dict:
    ...
    out["IPSetDescriptors"] = (
        aws_sdk_waf.types.ip_set_descriptors.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> IPSet:
    ...
    if "IPSetDescriptors" in data:
        ...
        out["ip_set_descriptors"] = (
            aws_sdk_waf.types.ip_set_descriptors.deserialize_aws_json_1_1(
