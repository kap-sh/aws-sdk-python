...
if TYPE_CHECKING:
    import aws_sdk_waf.types.comparison_operator
    import aws_sdk_waf.types.field_to_match
    import aws_sdk_waf.types.size
...
class SizeConstraint(TypedDict):
    ...
    comparison_operator: "aws_sdk_waf.types.comparison_operator.ComparisonOperator"
    ...
    size: "aws_sdk_waf.types.size.Size"
...
def serialize_aws_json_1_1(value: SizeConstraint) -> dict:
    ...
    out["ComparisonOperator"] = (
        aws_sdk_waf.types.comparison_operator.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SizeConstraint:
    ...
    if "ComparisonOperator" in data:
        ...
        out["comparison_operator"] = (
            aws_sdk_waf.types.comparison_operator.deserialize_aws_json_1_1(
