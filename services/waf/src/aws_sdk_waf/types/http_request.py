...
if TYPE_CHECKING:
    import aws_sdk_waf.types.country
    import aws_sdk_waf.types.http_headers
    import aws_sdk_waf.types.http_method
    import aws_sdk_waf.types.http_version
    import aws_sdk_waf.types.ip_string
    import aws_sdk_waf.types.uri_string


class HTTPRequest(TypedDict):
    client_ip: NotRequired["aws_sdk_waf.types.ip_string.IPString"]
    ...
    country: NotRequired["aws_sdk_waf.types.country.Country"]
    ...
    uri: NotRequired["aws_sdk_waf.types.uri_string.URIString"]
    """<p>The part of a web request that identifies the resource, for example, <code>/images/daily-ad.jpg</code>.</p>"""
    method: NotRequired["aws_sdk_waf.types.http_method.HTTPMethod"]
    ...
    http_version: NotRequired["aws_sdk_waf.types.http_version.HTTPVersion"]
    """<p>The HTTP version specified in the sampled web request, for example, <code>HTTP/1.1</code>.</p>"""
    headers: NotRequired["aws_sdk_waf.types.http_headers.HTTPHeaders"]
...
def serialize_aws_json_1_1(value: HTTPRequest) -> dict:
    ...
    if "headers" in value:
        ...
        out["Headers"] = aws_sdk_waf.types.http_headers.serialize_aws_json_1_1(
            value["headers"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> HTTPRequest:
    ...
    if "Headers" in data:
        ...
        out["headers"] = aws_sdk_waf.types.http_headers.deserialize_aws_json_1_1(
            data["Headers"]
        )
    return out
