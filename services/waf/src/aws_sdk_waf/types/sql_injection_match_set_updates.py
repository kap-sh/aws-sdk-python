...
if TYPE_CHECKING:
    import aws_sdk_waf.types.sql_injection_match_set_update

SqlInjectionMatchSetUpdates: TypeAlias = list[
    "aws_sdk_waf.types.sql_injection_match_set_update.SqlInjectionMatchSetUpdate"
]
...
def serialize_aws_json_1_1(value: SqlInjectionMatchSetUpdates) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_waf.types.sql_injection_match_set_update.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> SqlInjectionMatchSetUpdates:
    ...
    for item in data:
        out.append(
            aws_sdk_waf.types.sql_injection_match_set_update.deserialize_aws_json_1_1(
                item
            )
        )
    return out
