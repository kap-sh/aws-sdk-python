...
class Rule(TypedDict, closed=True):
    ...
    predicates: "aws_sdk_waf.types.predicates.Predicates"
...
def serialize_aws_json_1_1(value: Rule) -> dict:
    ...
    out["Predicates"] = aws_sdk_waf.types.predicates.serialize_aws_json_1_1(
        value["predicates"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Rule:
    ...
    if "Predicates" in data:
        ...
        out["predicates"] = aws_sdk_waf.types.predicates.deserialize_aws_json_1_1(
            data["Predicates"]
        )
    else:
