"""Generated from Smithy shape ``com.amazonaws.waf#CreateIPSetResponse``."""
...
class CreateIPSetResponse(TypedDict):
    ip_set: NotRequired["aws_sdk_waf.types.ip_set.IPSet"]
...
def serialize_aws_json_1_1(value: CreateIPSetResponse) -> dict:
    ...
    if "ip_set" in value:
        ...
        out["IPSet"] = aws_sdk_waf.types.ip_set.serialize_aws_json_1_1(value["ip_set"])
...
def deserialize_aws_json_1_1(data: dict) -> CreateIPSetResponse:
    ...
    if "IPSet" in data:
        ...
        out["ip_set"] = aws_sdk_waf.types.ip_set.deserialize_aws_json_1_1(data["IPSet"])
