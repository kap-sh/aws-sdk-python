"""Generated from Smithy shape ``com.amazonaws.waf#RegexMatchSetUpdate``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_waf.types.regex_match_tuple
...
class RegexMatchSetUpdate(TypedDict):
    ...
    regex_match_tuple: "aws_sdk_waf.types.regex_match_tuple.RegexMatchTuple"
...
def serialize_aws_json_1_1(value: RegexMatchSetUpdate) -> dict:
    ...
    out["RegexMatchTuple"] = aws_sdk_waf.types.regex_match_tuple.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RegexMatchSetUpdate:
    ...
    if "RegexMatchTuple" in data:
        ...
        out["regex_match_tuple"] = (
            aws_sdk_waf.types.regex_match_tuple.deserialize_aws_json_1_1(
