"""Generated from Smithy shape ``com.amazonaws.waf#CreateRuleGroupResponse``."""
...
def serialize_aws_json_1_1(value: CreateRuleGroupResponse) -> dict:
    ...
    if "rule_group" in value:
        ...
        out["RuleGroup"] = aws_sdk_waf.types.rule_group.serialize_aws_json_1_1(
            value["rule_group"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> CreateRuleGroupResponse:
    ...
    if "RuleGroup" in data:
        ...
        out["rule_group"] = aws_sdk_waf.types.rule_group.deserialize_aws_json_1_1(
            data["RuleGroup"]
        )
