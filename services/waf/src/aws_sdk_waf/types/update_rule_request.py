"""Generated from Smithy shape ``com.amazonaws.waf#UpdateRuleRequest``."""
...
def serialize_aws_json_1_1(value: UpdateRuleRequest) -> dict:
    ...
    out["Updates"] = aws_sdk_waf.types.rule_updates.serialize_aws_json_1_1(
        value["updates"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UpdateRuleRequest:
    ...
    if "Updates" in data:
        ...
        out["updates"] = aws_sdk_waf.types.rule_updates.deserialize_aws_json_1_1(
            data["Updates"]
        )
    else:
