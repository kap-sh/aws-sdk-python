"""Generated from Smithy shape ``com.amazonaws.waf#CreateGeoMatchSetResponse``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_waf.types.geo_match_set


class CreateGeoMatchSetResponse(TypedDict, closed=True):
    geo_match_set: NotRequired["aws_sdk_waf.types.geo_match_set.GeoMatchSet"]
...
def serialize_aws_json_1_1(value: CreateGeoMatchSetResponse) -> dict:
    ...
    if "geo_match_set" in value:
        ...
        out["GeoMatchSet"] = aws_sdk_waf.types.geo_match_set.serialize_aws_json_1_1(
            value["geo_match_set"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> CreateGeoMatchSetResponse:
    ...
    if "GeoMatchSet" in data:
        ...
        out["geo_match_set"] = aws_sdk_waf.types.geo_match_set.deserialize_aws_json_1_1(
            data["GeoMatchSet"]
        )
