...
if TYPE_CHECKING:
    import aws_sdk_waf.types.sql_injection_match_set_summary

SqlInjectionMatchSetSummaries: TypeAlias = list[
    "aws_sdk_waf.types.sql_injection_match_set_summary.SqlInjectionMatchSetSummary"
]
...
def serialize_aws_json_1_1(value: SqlInjectionMatchSetSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_waf.types.sql_injection_match_set_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> SqlInjectionMatchSetSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_waf.types.sql_injection_match_set_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
