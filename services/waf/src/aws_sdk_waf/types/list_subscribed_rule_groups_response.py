...
class ListSubscribedRuleGroupsResponse(TypedDict):
    ...
    rule_groups: NotRequired[
        "aws_sdk_waf.types.subscribed_rule_group_summaries.SubscribedRuleGroupSummaries"
    ]
...
def serialize_aws_json_1_1(value: ListSubscribedRuleGroupsResponse) -> dict:
    ...
    if "rule_groups" in value:
        ...
        out["RuleGroups"] = (
            aws_sdk_waf.types.subscribed_rule_group_summaries.serialize_aws_json_1_1(
                value["rule_groups"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListSubscribedRuleGroupsResponse:
    ...
    if "RuleGroups" in data:
        ...
        out["rule_groups"] = (
            aws_sdk_waf.types.subscribed_rule_group_summaries.deserialize_aws_json_1_1(
                data["RuleGroups"]
            )
        )
    return out
