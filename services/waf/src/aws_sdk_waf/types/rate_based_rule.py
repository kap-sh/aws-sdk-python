...
if TYPE_CHECKING:
    ...
    import aws_sdk_waf.types.predicates
...
class RateBasedRule(TypedDict, closed=True):
    ...
    match_predicates: "aws_sdk_waf.types.predicates.Predicates"
...
def serialize_aws_json_1_1(value: RateBasedRule) -> dict:
    ...
    out["MatchPredicates"] = aws_sdk_waf.types.predicates.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RateBasedRule:
    ...
    if "MatchPredicates" in data:
        ...
        out["match_predicates"] = aws_sdk_waf.types.predicates.deserialize_aws_json_1_1(
