"""Generated from Smithy shape ``com.amazonaws.waf#UpdateGeoMatchSetResponse``."""
...
class UpdateGeoMatchSetResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateGeoMatchSetResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UpdateGeoMatchSetResponse:
    out: UpdateGeoMatchSetResponse = {}  # type: ignore[typeddict-item]
