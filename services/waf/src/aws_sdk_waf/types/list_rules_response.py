...
class ListRulesResponse(TypedDict, closed=True):
    ...
    rules: NotRequired["aws_sdk_waf.types.rule_summaries.RuleSummaries"]
...
def serialize_aws_json_1_1(value: ListRulesResponse) -> dict:
    ...
    if "rules" in value:
        ...
        out["Rules"] = aws_sdk_waf.types.rule_summaries.serialize_aws_json_1_1(
            value["rules"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListRulesResponse:
    ...
    if "Rules" in data:
        ...
        out["rules"] = aws_sdk_waf.types.rule_summaries.deserialize_aws_json_1_1(
            data["Rules"]
        )
    return out
