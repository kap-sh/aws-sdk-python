...
class UpdateWebACLRequest(TypedDict, closed=True):
    ...
    updates: NotRequired["aws_sdk_waf.types.web_acl_updates.WebACLUpdates"]
    ...
    default_action: NotRequired["aws_sdk_waf.types.waf_action.WafAction"]
...
def serialize_aws_json_1_1(value: UpdateWebACLRequest) -> dict:
    ...
    if "updates" in value:
        ...
        out["Updates"] = aws_sdk_waf.types.web_acl_updates.serialize_aws_json_1_1(
            value["updates"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> UpdateWebACLRequest:
    ...
    if "Updates" in data:
        ...
        out["updates"] = aws_sdk_waf.types.web_acl_updates.deserialize_aws_json_1_1(
            data["Updates"]
        )
