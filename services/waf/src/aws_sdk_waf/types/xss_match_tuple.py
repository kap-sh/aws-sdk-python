"""Generated from Smithy shape ``com.amazonaws.waf#XssMatchTuple``."""
...
if TYPE_CHECKING:
    import aws_sdk_waf.types.field_to_match
...
def serialize_aws_json_1_1(value: XssMatchTuple) -> dict:
    ...
    out["FieldToMatch"] = aws_sdk_waf.types.field_to_match.serialize_aws_json_1_1(
        value["field_to_match"]
    )
    import aws_sdk_waf.types.text_transformation

    out["TextTransformation"] = (
        aws_sdk_waf.types.text_transformation.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> XssMatchTuple:
    ...
    if "FieldToMatch" in data:
        ...
        out["field_to_match"] = (
            aws_sdk_waf.types.field_to_match.deserialize_aws_json_1_1(
                data["FieldToMatch"]
            )
        )
    else:
    ...
    if "TextTransformation" in data:
        ...
        out["text_transformation"] = (
            aws_sdk_waf.types.text_transformation.deserialize_aws_json_1_1(
