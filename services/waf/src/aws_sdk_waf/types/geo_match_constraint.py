...
if TYPE_CHECKING:
    import aws_sdk_waf.types.geo_match_constraint_type
...
def serialize_aws_json_1_1(value: GeoMatchConstraint) -> dict:
    ...
    out["Type"] = aws_sdk_waf.types.geo_match_constraint_type.serialize_aws_json_1_1(
        value["type"]
    )
    import aws_sdk_waf.types.geo_match_constraint_value

    out["Value"] = aws_sdk_waf.types.geo_match_constraint_value.serialize_aws_json_1_1(
        value["value"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GeoMatchConstraint:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_waf.types.geo_match_constraint_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    else:
    ...
    if "Value" in data:
        ...
        out["value"] = (
            aws_sdk_waf.types.geo_match_constraint_value.deserialize_aws_json_1_1(
                data["Value"]
            )
        )
    else:
