...
if TYPE_CHECKING:
    import aws_sdk_waf.types.size_constraint_set_summary

SizeConstraintSetSummaries: TypeAlias = list[
    "aws_sdk_waf.types.size_constraint_set_summary.SizeConstraintSetSummary"
]
...
def serialize_aws_json_1_1(value: SizeConstraintSetSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_waf.types.size_constraint_set_summary.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> SizeConstraintSetSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_waf.types.size_constraint_set_summary.deserialize_aws_json_1_1(item)
        )
    return out
