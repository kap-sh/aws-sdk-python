...
if TYPE_CHECKING:
    import aws_sdk_waf.types.negated
    import aws_sdk_waf.types.predicate_type
    import aws_sdk_waf.types.resource_id


class Predicate(TypedDict, closed=True):
    negated: "aws_sdk_waf.types.negated.Negated"
    ...
    type: "aws_sdk_waf.types.predicate_type.PredicateType"
    """<p>The type of predicate in a <code>Rule</code>, such as <code>ByteMatch</code> or <code>IPSet</code>.</p>"""
    data_id: "aws_sdk_waf.types.resource_id.ResourceId"
...
def serialize_aws_json_1_1(value: Predicate) -> dict:
    ...
    out["Type"] = aws_sdk_waf.types.predicate_type.serialize_aws_json_1_1(value["type"])
...
def deserialize_aws_json_1_1(data: dict) -> Predicate:
    ...
    if "Type" in data:
        ...
        out["type"] = aws_sdk_waf.types.predicate_type.deserialize_aws_json_1_1(
            data["Type"]
        )
    else:
