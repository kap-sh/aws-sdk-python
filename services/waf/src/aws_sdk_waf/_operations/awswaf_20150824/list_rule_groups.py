"""Generated from Smithy shape ``com.amazonaws.waf#ListRuleGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_waf.types.list_rule_groups_response.ListRuleGroupsResponse = (
        aws_sdk_waf.types.list_rule_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.list_rule_groups_request.ListRuleGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.list_rule_groups_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_rule_groups(
    ...
    aws_sdk_waf.types.list_rule_groups_response.ListRuleGroupsResponse, zapros.Response
]:
