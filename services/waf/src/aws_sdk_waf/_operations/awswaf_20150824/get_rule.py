...
def build_request(
    ...
    input: aws_sdk_waf.types.get_rule_request.GetRuleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.get_rule_request.serialize_aws_json_1_1(input)
    ).encode()
...
def get_rule(
    options: OperationOptions, input: aws_sdk_waf.types.get_rule_request.GetRuleRequest
