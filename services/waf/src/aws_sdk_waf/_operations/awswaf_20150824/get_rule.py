"""Generated from Smithy shape ``com.amazonaws.waf#GetRule``."""
...
def handle_response(
    ...
    out: aws_sdk_waf.types.get_rule_response.GetRuleResponse = (
        aws_sdk_waf.types.get_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.get_rule_request.GetRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.get_rule_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_rule(
    options: OperationOptions, input_: aws_sdk_waf.types.get_rule_request.GetRuleRequest
) -> tuple[aws_sdk_waf.types.get_rule_response.GetRuleResponse, zapros.Response]:
