...
def build_request(
    ...
    input: aws_sdk_waf.types.get_sampled_requests_request.GetSampledRequestsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.get_sampled_requests_request.serialize_aws_json_1_1(input)
    ).encode()
