...
def handle_response(
    ...
    out: aws_sdk_waf.types.delete_regex_match_set_response.DeleteRegexMatchSetResponse = aws_sdk_waf.types.delete_regex_match_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.delete_regex_match_set_request.DeleteRegexMatchSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.delete_regex_match_set_request.serialize_aws_json_1_1(input_)
    ).encode()
