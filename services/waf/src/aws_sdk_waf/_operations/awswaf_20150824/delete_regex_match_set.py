...
def build_request(
    ...
    input: aws_sdk_waf.types.delete_regex_match_set_request.DeleteRegexMatchSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.delete_regex_match_set_request.serialize_aws_json_1_1(input)
    ).encode()
