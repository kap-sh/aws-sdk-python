...
def handle_response(
    ...
    out: aws_sdk_waf.types.delete_regex_pattern_set_response.DeleteRegexPatternSetResponse = aws_sdk_waf.types.delete_regex_pattern_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_waf.types.delete_regex_pattern_set_request.DeleteRegexPatternSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.delete_regex_pattern_set_request.serialize_aws_json_1_1(input)
    ).encode()
