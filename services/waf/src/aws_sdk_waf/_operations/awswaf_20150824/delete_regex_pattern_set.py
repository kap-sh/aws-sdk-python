...
def build_request(
    ...
    input_: aws_sdk_waf.types.delete_regex_pattern_set_request.DeleteRegexPatternSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.delete_regex_pattern_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
