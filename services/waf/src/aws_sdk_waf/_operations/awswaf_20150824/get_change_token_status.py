...
def handle_response(
    ...
    out: aws_sdk_waf.types.get_change_token_status_response.GetChangeTokenStatusResponse = aws_sdk_waf.types.get_change_token_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_waf.types.get_change_token_status_request.GetChangeTokenStatusRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.get_change_token_status_request.serialize_aws_json_1_1(input)
    ).encode()
