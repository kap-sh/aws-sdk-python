...
def build_request(
    ...
    input: aws_sdk_waf.types.update_rate_based_rule_request.UpdateRateBasedRuleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.update_rate_based_rule_request.serialize_aws_json_1_1(input)
    ).encode()
