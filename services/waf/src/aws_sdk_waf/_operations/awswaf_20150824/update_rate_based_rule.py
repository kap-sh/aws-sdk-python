...
def handle_response(
    ...
    out: aws_sdk_waf.types.update_rate_based_rule_response.UpdateRateBasedRuleResponse = aws_sdk_waf.types.update_rate_based_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.update_rate_based_rule_request.UpdateRateBasedRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.update_rate_based_rule_request.serialize_aws_json_1_1(input_)
    ).encode()
