"""Generated from Smithy shape ``com.amazonaws.waf#UpdateRuleGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_waf.types.update_rule_group_response.UpdateRuleGroupResponse = (
        aws_sdk_waf.types.update_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.update_rule_group_request.UpdateRuleGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.update_rule_group_request.serialize_aws_json_1_1(input_)
    ).encode()
