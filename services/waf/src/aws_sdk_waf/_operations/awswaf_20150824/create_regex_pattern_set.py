...
def handle_response(
    ...
    out: aws_sdk_waf.types.create_regex_pattern_set_response.CreateRegexPatternSetResponse = aws_sdk_waf.types.create_regex_pattern_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_waf.types.create_regex_pattern_set_request.CreateRegexPatternSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.create_regex_pattern_set_request.serialize_aws_json_1_1(input)
    ).encode()
