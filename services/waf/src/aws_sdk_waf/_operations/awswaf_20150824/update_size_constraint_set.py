"""Generated from Smithy shape ``com.amazonaws.waf#UpdateSizeConstraintSet``."""
...
import aws_sdk_waf.errors.waf_invalid_account_exception
import aws_sdk_waf.errors.waf_invalid_operation_exception
import aws_sdk_waf.errors.waf_invalid_parameter_exception
import aws_sdk_waf.errors.waf_limits_exceeded_exception
import aws_sdk_waf.errors.waf_nonexistent_container_exception
import aws_sdk_waf.errors.waf_nonexistent_item_exception
import aws_sdk_waf.errors.waf_referenced_item_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFInvalidAccountException":
            raise aws_sdk_waf.errors.waf_invalid_account_exception.WAFInvalidAccountException.from_aws_json_1_1(
                data
            )
        case "WAFInvalidOperationException":
            raise aws_sdk_waf.errors.waf_invalid_operation_exception.WAFInvalidOperationException.from_aws_json_1_1(
                data
            )
        ...
        case "WAFNonexistentContainerException":
            raise aws_sdk_waf.errors.waf_nonexistent_container_exception.WAFNonexistentContainerException.from_aws_json_1_1(
                data
            )
        ...
        case "WAFReferencedItemException":
            raise aws_sdk_waf.errors.waf_referenced_item_exception.WAFReferencedItemException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_waf.types.update_size_constraint_set_response.UpdateSizeConstraintSetResponse = aws_sdk_waf.types.update_size_constraint_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.update_size_constraint_set_request.UpdateSizeConstraintSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.update_size_constraint_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_size_constraint_set(
