...
def handle_response(
    ...
    out: aws_sdk_waf.types.delete_permission_policy_response.DeletePermissionPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_waf.types.delete_permission_policy_request.DeletePermissionPolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.delete_permission_policy_request.serialize_aws_json_1_1(input)
    ).encode()
