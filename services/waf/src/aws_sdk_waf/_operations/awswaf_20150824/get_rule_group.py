...
def handle_response(
    ...
    out: aws_sdk_waf.types.get_rule_group_response.GetRuleGroupResponse = (
        aws_sdk_waf.types.get_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.get_rule_group_request.GetRuleGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.get_rule_group_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_rule_group(
    ...
    aws_sdk_waf.types.get_rule_group_response.GetRuleGroupResponse, zapros.Response
]:
