...
def build_request(
    ...
    input: aws_sdk_waf.types.get_size_constraint_set_request.GetSizeConstraintSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.get_size_constraint_set_request.serialize_aws_json_1_1(input)
    ).encode()
