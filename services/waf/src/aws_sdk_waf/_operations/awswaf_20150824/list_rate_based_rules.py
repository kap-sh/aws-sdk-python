...
def build_request(
    ...
    input: aws_sdk_waf.types.list_rate_based_rules_request.ListRateBasedRulesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.list_rate_based_rules_request.serialize_aws_json_1_1(input)
    ).encode()
