...
def build_request(
    ...
    input: aws_sdk_waf.types.list_byte_match_sets_request.ListByteMatchSetsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.list_byte_match_sets_request.serialize_aws_json_1_1(input)
    ).encode()
