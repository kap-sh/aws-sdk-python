"""Generated from Smithy shape ``com.amazonaws.waf#DeleteSqlInjectionMatchSet``."""
...
import aws_sdk_waf.errors.waf_non_empty_entity_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFNonEmptyEntityException":
            raise aws_sdk_waf.errors.waf_non_empty_entity_exception.WAFNonEmptyEntityException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_waf.types.delete_sql_injection_match_set_response.DeleteSqlInjectionMatchSetResponse = aws_sdk_waf.types.delete_sql_injection_match_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.delete_sql_injection_match_set_request.DeleteSqlInjectionMatchSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.delete_sql_injection_match_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_sql_injection_match_set(
