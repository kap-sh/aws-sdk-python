...
def handle_response(
    ...
    out: aws_sdk_waf.types.delete_rule_response.DeleteRuleResponse = (
        aws_sdk_waf.types.delete_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.delete_rule_request.DeleteRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.delete_rule_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_rule(
    ...
    input_: aws_sdk_waf.types.delete_rule_request.DeleteRuleRequest,
) -> tuple[aws_sdk_waf.types.delete_rule_response.DeleteRuleResponse, zapros.Response]:
