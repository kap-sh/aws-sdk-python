...
def handle_response(
    ...
    out: aws_sdk_waf.types.delete_rule_group_response.DeleteRuleGroupResponse = (
        aws_sdk_waf.types.delete_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.delete_rule_group_request.DeleteRuleGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.delete_rule_group_request.serialize_aws_json_1_1(input_)
    ).encode()
