...
def handle_response(
    ...
    out: aws_sdk_waf.types.list_subscribed_rule_groups_response.ListSubscribedRuleGroupsResponse = aws_sdk_waf.types.list_subscribed_rule_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.list_subscribed_rule_groups_request.ListSubscribedRuleGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.list_subscribed_rule_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
