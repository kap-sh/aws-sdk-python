"""Generated from Smithy shape ``com.amazonaws.waf#PutLoggingConfiguration``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFServiceLinkedRoleErrorException":
            import aws_sdk_waf.errors.waf_service_linked_role_error_exception

            raise aws_sdk_waf.errors.waf_service_linked_role_error_exception.WAFServiceLinkedRoleErrorException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_waf.types.put_logging_configuration_response.PutLoggingConfigurationResponse = aws_sdk_waf.types.put_logging_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.put_logging_configuration_request.PutLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.put_logging_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
