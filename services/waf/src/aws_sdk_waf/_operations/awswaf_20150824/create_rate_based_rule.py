...
def build_request(
    ...
    input: aws_sdk_waf.types.create_rate_based_rule_request.CreateRateBasedRuleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.create_rate_based_rule_request.serialize_aws_json_1_1(input)
    ).encode()
