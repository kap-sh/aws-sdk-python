...
def build_request(
    ...
    input: aws_sdk_waf.types.delete_xss_match_set_request.DeleteXssMatchSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.delete_xss_match_set_request.serialize_aws_json_1_1(input)
    ).encode()
