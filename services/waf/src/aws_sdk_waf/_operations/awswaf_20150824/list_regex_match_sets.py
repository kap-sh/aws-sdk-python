...
def build_request(
    ...
    input: aws_sdk_waf.types.list_regex_match_sets_request.ListRegexMatchSetsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.list_regex_match_sets_request.serialize_aws_json_1_1(input)
    ).encode()
