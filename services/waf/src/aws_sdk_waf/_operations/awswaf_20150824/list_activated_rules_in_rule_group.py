...
def handle_response(
    ...
    out: aws_sdk_waf.types.list_activated_rules_in_rule_group_response.ListActivatedRulesInRuleGroupResponse = aws_sdk_waf.types.list_activated_rules_in_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.list_activated_rules_in_rule_group_request.ListActivatedRulesInRuleGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.list_activated_rules_in_rule_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
