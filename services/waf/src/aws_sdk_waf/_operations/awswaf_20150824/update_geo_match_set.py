...
def build_request(
    ...
    input: aws_sdk_waf.types.update_geo_match_set_request.UpdateGeoMatchSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.update_geo_match_set_request.serialize_aws_json_1_1(input)
    ).encode()
