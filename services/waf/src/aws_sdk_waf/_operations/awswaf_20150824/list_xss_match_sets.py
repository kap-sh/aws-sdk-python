...
def handle_response(
    ...
    out: aws_sdk_waf.types.list_xss_match_sets_response.ListXssMatchSetsResponse = (
        aws_sdk_waf.types.list_xss_match_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.list_xss_match_sets_request.ListXssMatchSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.list_xss_match_sets_request.serialize_aws_json_1_1(input_)
    ).encode()
