...
def handle_response(
    ...
    out: aws_sdk_waf.types.delete_ip_set_response.DeleteIPSetResponse = (
        aws_sdk_waf.types.delete_ip_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.delete_ip_set_request.DeleteIPSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.delete_ip_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_ip_set(
    ...
    aws_sdk_waf.types.delete_ip_set_response.DeleteIPSetResponse, zapros.Response
]:
