...
def handle_response(
    ...
    out: aws_sdk_waf.types.get_permission_policy_response.GetPermissionPolicyResponse = aws_sdk_waf.types.get_permission_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.get_permission_policy_request.GetPermissionPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.get_permission_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
