...
def build_request(
    ...
    input: aws_sdk_waf.types.get_permission_policy_request.GetPermissionPolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.get_permission_policy_request.serialize_aws_json_1_1(input)
    ).encode()
