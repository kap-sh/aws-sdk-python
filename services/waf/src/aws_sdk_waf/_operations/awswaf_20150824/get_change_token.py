"""Generated from Smithy shape ``com.amazonaws.waf#GetChangeToken``."""
...
def handle_response(
    ...
    out: aws_sdk_waf.types.get_change_token_response.GetChangeTokenResponse = (
        aws_sdk_waf.types.get_change_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.get_change_token_request.GetChangeTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_change_token(
    ...
    aws_sdk_waf.types.get_change_token_response.GetChangeTokenResponse, zapros.Response
]:
...
async def async_get_change_token(
