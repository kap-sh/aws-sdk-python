...
def build_request(
    ...
    input: aws_sdk_waf.types.create_geo_match_set_request.CreateGeoMatchSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.create_geo_match_set_request.serialize_aws_json_1_1(input)
    ).encode()
