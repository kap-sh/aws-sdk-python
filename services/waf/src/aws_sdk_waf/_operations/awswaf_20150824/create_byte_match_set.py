"""Generated from Smithy shape ``com.amazonaws.waf#CreateByteMatchSet``."""
...
import aws_sdk_waf.types.byte_match_set
...
def handle_response(
    ...
    out: aws_sdk_waf.types.create_byte_match_set_response.CreateByteMatchSetResponse = (
        aws_sdk_waf.types.create_byte_match_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.create_byte_match_set_request.CreateByteMatchSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.create_byte_match_set_request.serialize_aws_json_1_1(input_)
    ).encode()
