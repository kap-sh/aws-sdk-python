"""Generated from Smithy shape ``com.amazonaws.waf#CreateXssMatchSet``."""
...
def handle_response(
    ...
    out: aws_sdk_waf.types.create_xss_match_set_response.CreateXssMatchSetResponse = (
        aws_sdk_waf.types.create_xss_match_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.create_xss_match_set_request.CreateXssMatchSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.create_xss_match_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_xss_match_set(
