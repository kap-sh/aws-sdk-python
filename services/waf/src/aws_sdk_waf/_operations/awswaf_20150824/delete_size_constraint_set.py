...
def handle_response(
    ...
    out: aws_sdk_waf.types.delete_size_constraint_set_response.DeleteSizeConstraintSetResponse = aws_sdk_waf.types.delete_size_constraint_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf.types.delete_size_constraint_set_request.DeleteSizeConstraintSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf.types.delete_size_constraint_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
