...
from aws_sdk_waf._auth._zapros_handler import AuthMiddleware
from aws_sdk_waf._services._aws_config import aws_config
from aws_sdk_waf._services._pipeline import (
    Interceptor,
    OperationOptions,
    OperationRequest,
    OperationResponse,
...
if TYPE_CHECKING:
    import aws_sdk_waf.types.byte_match_set_updates
    import aws_sdk_waf.types.change_token
    import aws_sdk_waf.types.create_byte_match_set_request
    import aws_sdk_waf.types.create_byte_match_set_response
    import aws_sdk_waf.types.create_geo_match_set_request
    import aws_sdk_waf.types.create_geo_match_set_response
    import aws_sdk_waf.types.create_ip_set_request
    import aws_sdk_waf.types.create_ip_set_response
    import aws_sdk_waf.types.create_rate_based_rule_request
    import aws_sdk_waf.types.create_rate_based_rule_response
    import aws_sdk_waf.types.create_regex_match_set_request
    import aws_sdk_waf.types.create_regex_match_set_response
    import aws_sdk_waf.types.create_regex_pattern_set_request
    import aws_sdk_waf.types.create_regex_pattern_set_response
    import aws_sdk_waf.types.create_rule_group_request
    import aws_sdk_waf.types.create_rule_group_response
    import aws_sdk_waf.types.create_rule_request
    import aws_sdk_waf.types.create_rule_response
    import aws_sdk_waf.types.create_size_constraint_set_request
    import aws_sdk_waf.types.create_size_constraint_set_response
    import aws_sdk_waf.types.create_sql_injection_match_set_request
    import aws_sdk_waf.types.create_sql_injection_match_set_response
    import aws_sdk_waf.types.create_web_acl_migration_stack_request
    import aws_sdk_waf.types.create_web_acl_migration_stack_response
    import aws_sdk_waf.types.create_web_acl_request
    import aws_sdk_waf.types.create_web_acl_response
    import aws_sdk_waf.types.create_xss_match_set_request
    import aws_sdk_waf.types.create_xss_match_set_response
    import aws_sdk_waf.types.delete_byte_match_set_request
    import aws_sdk_waf.types.delete_byte_match_set_response
    import aws_sdk_waf.types.delete_geo_match_set_request
    import aws_sdk_waf.types.delete_geo_match_set_response
    import aws_sdk_waf.types.delete_ip_set_request
    import aws_sdk_waf.types.delete_ip_set_response
    import aws_sdk_waf.types.delete_logging_configuration_request
    import aws_sdk_waf.types.delete_logging_configuration_response
    import aws_sdk_waf.types.delete_permission_policy_request
    import aws_sdk_waf.types.delete_permission_policy_response
    import aws_sdk_waf.types.delete_rate_based_rule_request
    import aws_sdk_waf.types.delete_rate_based_rule_response
    import aws_sdk_waf.types.delete_regex_match_set_request
    import aws_sdk_waf.types.delete_regex_match_set_response
    import aws_sdk_waf.types.delete_regex_pattern_set_request
    import aws_sdk_waf.types.delete_regex_pattern_set_response
    import aws_sdk_waf.types.delete_rule_group_request
    import aws_sdk_waf.types.delete_rule_group_response
    import aws_sdk_waf.types.delete_rule_request
    import aws_sdk_waf.types.delete_rule_response
    import aws_sdk_waf.types.delete_size_constraint_set_request
    import aws_sdk_waf.types.delete_size_constraint_set_response
    import aws_sdk_waf.types.delete_sql_injection_match_set_request
    import aws_sdk_waf.types.delete_sql_injection_match_set_response
    import aws_sdk_waf.types.delete_web_acl_request
    import aws_sdk_waf.types.delete_web_acl_response
    import aws_sdk_waf.types.delete_xss_match_set_request
    import aws_sdk_waf.types.delete_xss_match_set_response
    import aws_sdk_waf.types.geo_match_set_updates
    import aws_sdk_waf.types.get_byte_match_set_request
    import aws_sdk_waf.types.get_byte_match_set_response
    import aws_sdk_waf.types.get_change_token_request
    import aws_sdk_waf.types.get_change_token_response
    import aws_sdk_waf.types.get_change_token_status_request
    import aws_sdk_waf.types.get_change_token_status_response
    import aws_sdk_waf.types.get_geo_match_set_request
    import aws_sdk_waf.types.get_geo_match_set_response
    import aws_sdk_waf.types.get_ip_set_request
    import aws_sdk_waf.types.get_ip_set_response
    import aws_sdk_waf.types.get_logging_configuration_request
    import aws_sdk_waf.types.get_logging_configuration_response
    import aws_sdk_waf.types.get_permission_policy_request
    import aws_sdk_waf.types.get_permission_policy_response
    import aws_sdk_waf.types.get_rate_based_rule_managed_keys_request
    import aws_sdk_waf.types.get_rate_based_rule_managed_keys_response
    import aws_sdk_waf.types.get_rate_based_rule_request
    import aws_sdk_waf.types.get_rate_based_rule_response
    import aws_sdk_waf.types.get_regex_match_set_request
    import aws_sdk_waf.types.get_regex_match_set_response
    import aws_sdk_waf.types.get_regex_pattern_set_request
    import aws_sdk_waf.types.get_regex_pattern_set_response
    import aws_sdk_waf.types.get_rule_group_request
    import aws_sdk_waf.types.get_rule_group_response
    import aws_sdk_waf.types.get_rule_request
    import aws_sdk_waf.types.get_rule_response
    import aws_sdk_waf.types.get_sampled_requests_max_items
    import aws_sdk_waf.types.get_sampled_requests_request
    import aws_sdk_waf.types.get_sampled_requests_response
    import aws_sdk_waf.types.get_size_constraint_set_request
    import aws_sdk_waf.types.get_size_constraint_set_response
    import aws_sdk_waf.types.get_sql_injection_match_set_request
    import aws_sdk_waf.types.get_sql_injection_match_set_response
    import aws_sdk_waf.types.get_web_acl_request
    import aws_sdk_waf.types.get_web_acl_response
    import aws_sdk_waf.types.get_xss_match_set_request
    import aws_sdk_waf.types.get_xss_match_set_response
    import aws_sdk_waf.types.ignore_unsupported_type
    import aws_sdk_waf.types.ip_set_updates
    import aws_sdk_waf.types.list_activated_rules_in_rule_group_request
    import aws_sdk_waf.types.list_activated_rules_in_rule_group_response
    import aws_sdk_waf.types.list_byte_match_sets_request
    import aws_sdk_waf.types.list_byte_match_sets_response
    import aws_sdk_waf.types.list_geo_match_sets_request
    import aws_sdk_waf.types.list_geo_match_sets_response
    import aws_sdk_waf.types.list_ip_sets_request
    import aws_sdk_waf.types.list_ip_sets_response
    import aws_sdk_waf.types.list_logging_configurations_request
    import aws_sdk_waf.types.list_logging_configurations_response
    import aws_sdk_waf.types.list_rate_based_rules_request
    import aws_sdk_waf.types.list_rate_based_rules_response
    import aws_sdk_waf.types.list_regex_match_sets_request
    import aws_sdk_waf.types.list_regex_match_sets_response
    import aws_sdk_waf.types.list_regex_pattern_sets_request
    import aws_sdk_waf.types.list_regex_pattern_sets_response
    import aws_sdk_waf.types.list_rule_groups_request
    import aws_sdk_waf.types.list_rule_groups_response
    import aws_sdk_waf.types.list_rules_request
    import aws_sdk_waf.types.list_rules_response
    import aws_sdk_waf.types.list_size_constraint_sets_request
    import aws_sdk_waf.types.list_size_constraint_sets_response
    import aws_sdk_waf.types.list_sql_injection_match_sets_request
    import aws_sdk_waf.types.list_sql_injection_match_sets_response
    import aws_sdk_waf.types.list_subscribed_rule_groups_request
    import aws_sdk_waf.types.list_subscribed_rule_groups_response
    import aws_sdk_waf.types.list_tags_for_resource_request
    import aws_sdk_waf.types.list_tags_for_resource_response
    import aws_sdk_waf.types.list_web_ac_ls_request
    import aws_sdk_waf.types.list_web_ac_ls_response
    import aws_sdk_waf.types.list_xss_match_sets_request
    import aws_sdk_waf.types.list_xss_match_sets_response
    ...
    import aws_sdk_waf.types.policy_string
    import aws_sdk_waf.types.put_logging_configuration_request
    import aws_sdk_waf.types.put_logging_configuration_response
    import aws_sdk_waf.types.put_permission_policy_request
    import aws_sdk_waf.types.put_permission_policy_response
    import aws_sdk_waf.types.rate_key
    import aws_sdk_waf.types.rate_limit
    import aws_sdk_waf.types.regex_match_set_updates
    import aws_sdk_waf.types.regex_pattern_set_updates
    ...
    import aws_sdk_waf.types.rule_updates
    import aws_sdk_waf.types.s3_bucket_name
    import aws_sdk_waf.types.size_constraint_set_updates
    ...
    import aws_sdk_waf.types.untag_resource_request
    import aws_sdk_waf.types.untag_resource_response
    import aws_sdk_waf.types.update_byte_match_set_request
    import aws_sdk_waf.types.update_byte_match_set_response
    import aws_sdk_waf.types.update_geo_match_set_request
    import aws_sdk_waf.types.update_geo_match_set_response
    import aws_sdk_waf.types.update_ip_set_request
    import aws_sdk_waf.types.update_ip_set_response
    import aws_sdk_waf.types.update_rate_based_rule_request
    import aws_sdk_waf.types.update_rate_based_rule_response
    import aws_sdk_waf.types.update_regex_match_set_request
    import aws_sdk_waf.types.update_regex_match_set_response
    import aws_sdk_waf.types.update_regex_pattern_set_request
    import aws_sdk_waf.types.update_regex_pattern_set_response
    import aws_sdk_waf.types.update_rule_group_request
    import aws_sdk_waf.types.update_rule_group_response
    import aws_sdk_waf.types.update_rule_request
    import aws_sdk_waf.types.update_rule_response
    import aws_sdk_waf.types.update_size_constraint_set_request
    import aws_sdk_waf.types.update_size_constraint_set_response
    import aws_sdk_waf.types.update_sql_injection_match_set_request
    import aws_sdk_waf.types.update_sql_injection_match_set_response
    import aws_sdk_waf.types.update_web_acl_request
    import aws_sdk_waf.types.update_web_acl_response
    import aws_sdk_waf.types.update_xss_match_set_request
    import aws_sdk_waf.types.update_xss_match_set_response
    import aws_sdk_waf.types.waf_action
    import aws_sdk_waf.types.web_acl_updates
    import aws_sdk_waf.types.xss_match_set_updates


class WAFClientConfig(TypedDict, total=False, closed=True):
...
class WAFClient:
    ...
    def operation_options(
        self, config_overrides: Optional[WAFClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: WAFClientConfig = config_overrides or {}
    ...
    def create_byte_match_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.create_byte_match_set_response.CreateByteMatchSetResponse":
        ...
        Raises:
            aws_sdk_waf.errors.waf_disallowed_name_exception.WAFDisallowedNameException: <p>The name specified is invalid.</p>
            aws_sdk_waf.errors.waf_internal_error_exception.WAFInternalErrorException: <p>The operation failed because of a system problem, even though the request was valid. Retry your request.</p>
            aws_sdk_waf.errors.waf_invalid_account_exception.WAFInvalidAccountException: <p>The operation failed because you tried to create, update, or delete an object by using an invalid account identifier.</p>
            aws_sdk_waf.errors.waf_invalid_parameter_exception.WAFInvalidParameterException: <p>The operation failed because AWS WAF didn't recognize a parameter in the request. For example:</p> <ul> <li> <p>You specified an invalid parameter name.</p> </li> <li> <p>You specified an invalid value.</p> </li> <li> <p>You tried to update an object (<code>ByteMatchSet</code>, <code>IPSet</code>, <code>Rule</code>, or <code>WebACL</code>) using an action other than <code>INSERT</code> or <code>DELETE</code>.</p> </li> <li> <p>You tried to create a <code>WebACL</code> with a <code>DefaultAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to create a <code>RateBasedRule</code> with a <code>RateKey</code> value other than <code>IP</code>.</p> </li> <li> <p>You tried to update a <code>WebACL</code> with a <code>WafAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>FieldToMatch</code> <code>Type</code> other than HEADER, METHOD, QUERY_STRING, URI, or BODY.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>Field</code> of <code>HEADER</code> but no value for <code>Data</code>.</p> </li> <li> <p>Your request references an ARN that is malformed, or corresponds to a resource with which a web ACL cannot be associated.</p> </li> </ul>
            aws_sdk_waf.errors.waf_limits_exceeded_exception.WAFLimitsExceededException: <p>The operation exceeds a resource limit, for example, the maximum number of <code>WebACL</code> objects that you can create for an AWS account. For more information, see <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/limits.html\">Limits</a> in the <i>AWS WAF Developer Guide</i>.</p>
            aws_sdk_waf.errors.waf_stale_data_exception.WAFStaleDataException: <p>The operation failed because you tried to create, update, or delete an object by using a change token that has already been used.</p>
            aws_sdk_waf.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.create_byte_match_set_request.CreateByteMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.create_byte_match_set_response.CreateByteMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.create_byte_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.create_byte_match_set.create_byte_match_set(
    ...
    def create_geo_match_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.create_geo_match_set_response.CreateGeoMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.create_geo_match_set_request.CreateGeoMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.create_geo_match_set_response.CreateGeoMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.create_geo_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.create_geo_match_set.create_geo_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_ip_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.create_ip_set_response.CreateIPSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.create_ip_set_request.CreateIPSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.create_ip_set_response.CreateIPSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.create_ip_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.create_ip_set.create_ip_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_rate_based_rule(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
        tags: Optional["aws_sdk_waf.types.tag_list.TagList"] = None,
    ) -> (
        "aws_sdk_waf.types.create_rate_based_rule_response.CreateRateBasedRuleResponse"
    ):
        ...
        Raises:
            aws_sdk_waf.errors.waf_bad_request_exception.WAFBadRequestException: <p></p>
            aws_sdk_waf.errors.waf_disallowed_name_exception.WAFDisallowedNameException: <p>The name specified is invalid.</p>
            aws_sdk_waf.errors.waf_internal_error_exception.WAFInternalErrorException: <p>The operation failed because of a system problem, even though the request was valid. Retry your request.</p>
            aws_sdk_waf.errors.waf_invalid_parameter_exception.WAFInvalidParameterException: <p>The operation failed because AWS WAF didn't recognize a parameter in the request. For example:</p> <ul> <li> <p>You specified an invalid parameter name.</p> </li> <li> <p>You specified an invalid value.</p> </li> <li> <p>You tried to update an object (<code>ByteMatchSet</code>, <code>IPSet</code>, <code>Rule</code>, or <code>WebACL</code>) using an action other than <code>INSERT</code> or <code>DELETE</code>.</p> </li> <li> <p>You tried to create a <code>WebACL</code> with a <code>DefaultAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to create a <code>RateBasedRule</code> with a <code>RateKey</code> value other than <code>IP</code>.</p> </li> <li> <p>You tried to update a <code>WebACL</code> with a <code>WafAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>FieldToMatch</code> <code>Type</code> other than HEADER, METHOD, QUERY_STRING, URI, or BODY.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>Field</code> of <code>HEADER</code> but no value for <code>Data</code>.</p> </li> <li> <p>Your request references an ARN that is malformed, or corresponds to a resource with which a web ACL cannot be associated.</p> </li> </ul>
            aws_sdk_waf.errors.waf_limits_exceeded_exception.WAFLimitsExceededException: <p>The operation exceeds a resource limit, for example, the maximum number of <code>WebACL</code> objects that you can create for an AWS account. For more information, see <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/limits.html\">Limits</a> in the <i>AWS WAF Developer Guide</i>.</p>
            aws_sdk_waf.errors.waf_stale_data_exception.WAFStaleDataException: <p>The operation failed because you tried to create, update, or delete an object by using a change token that has already been used.</p>
            aws_sdk_waf.errors.waf_tag_operation_exception.WAFTagOperationException: <p></p>
            aws_sdk_waf.errors.waf_tag_operation_internal_error_exception.WAFTagOperationInternalErrorException: <p></p>
            aws_sdk_waf.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.create_rate_based_rule_request.CreateRateBasedRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.create_rate_based_rule_response.CreateRateBasedRuleResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.create_rate_based_rule

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.create_rate_based_rule.create_rate_based_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_regex_match_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.create_regex_match_set_request.CreateRegexMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.create_regex_match_set_response.CreateRegexMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.create_regex_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.create_regex_match_set.create_regex_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_regex_pattern_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.create_regex_pattern_set_response.CreateRegexPatternSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.create_regex_pattern_set_request.CreateRegexPatternSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.create_regex_pattern_set_response.CreateRegexPatternSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.create_regex_pattern_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.create_regex_pattern_set.create_regex_pattern_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_rule(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
        tags: Optional["aws_sdk_waf.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_waf.types.create_rule_response.CreateRuleResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.create_rule_request.CreateRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.create_rule_response.CreateRuleResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.create_rule

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.create_rule.create_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_rule_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.create_rule_group_request.CreateRuleGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.create_rule_group_response.CreateRuleGroupResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.create_rule_group

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.create_rule_group.create_rule_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_size_constraint_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.create_size_constraint_set_response.CreateSizeConstraintSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.create_size_constraint_set_request.CreateSizeConstraintSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.create_size_constraint_set_response.CreateSizeConstraintSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.create_size_constraint_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.create_size_constraint_set.create_size_constraint_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_sql_injection_match_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.create_sql_injection_match_set_response.CreateSqlInjectionMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.create_sql_injection_match_set_request.CreateSqlInjectionMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.create_sql_injection_match_set_response.CreateSqlInjectionMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.create_sql_injection_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.create_sql_injection_match_set.create_sql_injection_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_web_acl(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
        tags: Optional["aws_sdk_waf.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_waf.types.create_web_acl_response.CreateWebACLResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.create_web_acl_request.CreateWebACLRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.create_web_acl_response.CreateWebACLResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.create_web_acl

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.create_web_acl.create_web_acl(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_web_acl_migration_stack(
        ...
        ignore_unsupported_type: "aws_sdk_waf.types.ignore_unsupported_type.IgnoreUnsupportedType",
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.create_web_acl_migration_stack_response.CreateWebACLMigrationStackResponse":
    ...
    def create_xss_match_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.create_xss_match_set_response.CreateXssMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.create_xss_match_set_request.CreateXssMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.create_xss_match_set_response.CreateXssMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.create_xss_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.create_xss_match_set.create_xss_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_byte_match_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.delete_byte_match_set_response.DeleteByteMatchSetResponse":
        ...
        Raises:
            aws_sdk_waf.errors.waf_internal_error_exception.WAFInternalErrorException: <p>The operation failed because of a system problem, even though the request was valid. Retry your request.</p>
            aws_sdk_waf.errors.waf_invalid_account_exception.WAFInvalidAccountException: <p>The operation failed because you tried to create, update, or delete an object by using an invalid account identifier.</p>
            aws_sdk_waf.errors.waf_non_empty_entity_exception.WAFNonEmptyEntityException: <p>The operation failed because you tried to delete an object that isn't empty. For example:</p> <ul> <li> <p>You tried to delete a <code>WebACL</code> that still contains one or more <code>Rule</code> objects.</p> </li> <li> <p>You tried to delete a <code>Rule</code> that still contains one or more <code>ByteMatchSet</code> objects or other predicates.</p> </li> <li> <p>You tried to delete a <code>ByteMatchSet</code> that contains one or more <code>ByteMatchTuple</code> objects.</p> </li> <li> <p>You tried to delete an <code>IPSet</code> that references one or more IP addresses.</p> </li> </ul>
            aws_sdk_waf.errors.waf_nonexistent_item_exception.WAFNonexistentItemException: <p>The operation failed because the referenced object doesn't exist.</p>
            aws_sdk_waf.errors.waf_referenced_item_exception.WAFReferencedItemException: <p>The operation failed because you tried to delete an object that is still in use. For example:</p> <ul> <li> <p>You tried to delete a <code>ByteMatchSet</code> that is still referenced by a <code>Rule</code>.</p> </li> <li> <p>You tried to delete a <code>Rule</code> that is still referenced by a <code>WebACL</code>.</p> </li> </ul>
            aws_sdk_waf.errors.waf_stale_data_exception.WAFStaleDataException: <p>The operation failed because you tried to create, update, or delete an object by using a change token that has already been used.</p>
            aws_sdk_waf.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_byte_match_set_request.DeleteByteMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_byte_match_set_response.DeleteByteMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_byte_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_byte_match_set.delete_byte_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_geo_match_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.delete_geo_match_set_response.DeleteGeoMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_geo_match_set_request.DeleteGeoMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_geo_match_set_response.DeleteGeoMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_geo_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_geo_match_set.delete_geo_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_ip_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.delete_ip_set_response.DeleteIPSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_ip_set_request.DeleteIPSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_ip_set_response.DeleteIPSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_ip_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_ip_set.delete_ip_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_logging_configuration(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.delete_logging_configuration_response.DeleteLoggingConfigurationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_logging_configuration_request.DeleteLoggingConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_logging_configuration_response.DeleteLoggingConfigurationResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_logging_configuration

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_logging_configuration.delete_logging_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_permission_policy(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.delete_permission_policy_response.DeletePermissionPolicyResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_permission_policy_request.DeletePermissionPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_permission_policy_response.DeletePermissionPolicyResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_permission_policy

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_permission_policy.delete_permission_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_rate_based_rule(
        ...
        *,
        ...
        "aws_sdk_waf.types.delete_rate_based_rule_response.DeleteRateBasedRuleResponse"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_rate_based_rule_request.DeleteRateBasedRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_rate_based_rule_response.DeleteRateBasedRuleResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_rate_based_rule

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_rate_based_rule.delete_rate_based_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_regex_match_set(
        ...
        *,
        ...
        "aws_sdk_waf.types.delete_regex_match_set_response.DeleteRegexMatchSetResponse"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_regex_match_set_request.DeleteRegexMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_regex_match_set_response.DeleteRegexMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_regex_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_regex_match_set.delete_regex_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_regex_pattern_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.delete_regex_pattern_set_response.DeleteRegexPatternSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_regex_pattern_set_request.DeleteRegexPatternSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_regex_pattern_set_response.DeleteRegexPatternSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_regex_pattern_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_regex_pattern_set.delete_regex_pattern_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_rule(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.delete_rule_response.DeleteRuleResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_rule_request.DeleteRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_rule_response.DeleteRuleResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_rule

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_rule.delete_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_rule_group(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.delete_rule_group_response.DeleteRuleGroupResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_rule_group_request.DeleteRuleGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_rule_group_response.DeleteRuleGroupResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_rule_group

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_rule_group.delete_rule_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_size_constraint_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.delete_size_constraint_set_response.DeleteSizeConstraintSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_size_constraint_set_request.DeleteSizeConstraintSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_size_constraint_set_response.DeleteSizeConstraintSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_size_constraint_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_size_constraint_set.delete_size_constraint_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_sql_injection_match_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.delete_sql_injection_match_set_response.DeleteSqlInjectionMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_sql_injection_match_set_request.DeleteSqlInjectionMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_sql_injection_match_set_response.DeleteSqlInjectionMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_sql_injection_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_sql_injection_match_set.delete_sql_injection_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_web_acl(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.delete_web_acl_response.DeleteWebACLResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_web_acl_request.DeleteWebACLRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_web_acl_response.DeleteWebACLResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_web_acl

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_web_acl.delete_web_acl(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_xss_match_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.delete_xss_match_set_response.DeleteXssMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.delete_xss_match_set_request.DeleteXssMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.delete_xss_match_set_response.DeleteXssMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.delete_xss_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.delete_xss_match_set.delete_xss_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_byte_match_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_byte_match_set_response.GetByteMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_byte_match_set_request.GetByteMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_byte_match_set_response.GetByteMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_byte_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_byte_match_set.get_byte_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_change_token(
        self, *, config_overrides: Optional[WAFClientConfig] = None
    ) -> "aws_sdk_waf.types.get_change_token_response.GetChangeTokenResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_change_token_request.GetChangeTokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_change_token_response.GetChangeTokenResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_change_token

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_change_token.get_change_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_change_token_status(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_change_token_status_response.GetChangeTokenStatusResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_change_token_status_request.GetChangeTokenStatusRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_change_token_status_response.GetChangeTokenStatusResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_change_token_status

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_change_token_status.get_change_token_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_geo_match_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_geo_match_set_response.GetGeoMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_geo_match_set_request.GetGeoMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_geo_match_set_response.GetGeoMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_geo_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_geo_match_set.get_geo_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_ip_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_ip_set_response.GetIPSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_ip_set_request.GetIPSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_ip_set_response.GetIPSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_ip_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_ip_set.get_ip_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_logging_configuration(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_logging_configuration_response.GetLoggingConfigurationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_logging_configuration_request.GetLoggingConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_logging_configuration_response.GetLoggingConfigurationResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_logging_configuration

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_logging_configuration.get_logging_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_permission_policy(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_permission_policy_response.GetPermissionPolicyResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_permission_policy_request.GetPermissionPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_permission_policy_response.GetPermissionPolicyResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_permission_policy

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_permission_policy.get_permission_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_rate_based_rule(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_rate_based_rule_response.GetRateBasedRuleResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_rate_based_rule_request.GetRateBasedRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_rate_based_rule_response.GetRateBasedRuleResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_rate_based_rule

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_rate_based_rule.get_rate_based_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_rate_based_rule_managed_keys(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
    ) -> "aws_sdk_waf.types.get_rate_based_rule_managed_keys_response.GetRateBasedRuleManagedKeysResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_rate_based_rule_managed_keys_request.GetRateBasedRuleManagedKeysRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_rate_based_rule_managed_keys_response.GetRateBasedRuleManagedKeysResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_rate_based_rule_managed_keys

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_rate_based_rule_managed_keys.get_rate_based_rule_managed_keys(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_regex_match_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_regex_match_set_response.GetRegexMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_regex_match_set_request.GetRegexMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_regex_match_set_response.GetRegexMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_regex_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_regex_match_set.get_regex_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_regex_pattern_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_regex_pattern_set_response.GetRegexPatternSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_regex_pattern_set_request.GetRegexPatternSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_regex_pattern_set_response.GetRegexPatternSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_regex_pattern_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_regex_pattern_set.get_regex_pattern_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_rule(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_rule_response.GetRuleResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_rule_request.GetRuleRequest]",
        ) -> OperationResponse["aws_sdk_waf.types.get_rule_response.GetRuleResponse"]:
            import aws_sdk_waf._operations.awswaf_20150824.get_rule

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_rule.get_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_rule_group(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_rule_group_response.GetRuleGroupResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_rule_group_request.GetRuleGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_rule_group_response.GetRuleGroupResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_rule_group

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_rule_group.get_rule_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_sampled_requests(
        ...
        web_acl_id: "aws_sdk_waf.types.resource_id.ResourceId",
        rule_id: "aws_sdk_waf.types.resource_id.ResourceId",
        time_window: "aws_sdk_waf.types.time_window.TimeWindow",
        max_items: "aws_sdk_waf.types.get_sampled_requests_max_items.GetSampledRequestsMaxItems",
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_sampled_requests_response.GetSampledRequestsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_sampled_requests_request.GetSampledRequestsRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_sampled_requests_response.GetSampledRequestsResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_sampled_requests

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_sampled_requests.get_sampled_requests(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_size_constraint_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_size_constraint_set_response.GetSizeConstraintSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_size_constraint_set_request.GetSizeConstraintSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_size_constraint_set_response.GetSizeConstraintSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_size_constraint_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_size_constraint_set.get_size_constraint_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_sql_injection_match_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_sql_injection_match_set_response.GetSqlInjectionMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_sql_injection_match_set_request.GetSqlInjectionMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_sql_injection_match_set_response.GetSqlInjectionMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_sql_injection_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_sql_injection_match_set.get_sql_injection_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_web_acl(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_web_acl_response.GetWebACLResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_web_acl_request.GetWebACLRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_web_acl_response.GetWebACLResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_web_acl

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_web_acl.get_web_acl(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_xss_match_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.get_xss_match_set_response.GetXssMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.get_xss_match_set_request.GetXssMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.get_xss_match_set_response.GetXssMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.get_xss_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.get_xss_match_set.get_xss_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_activated_rules_in_rule_group(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
        rule_group_id: Optional["aws_sdk_waf.types.resource_id.ResourceId"] = None,
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_activated_rules_in_rule_group_response.ListActivatedRulesInRuleGroupResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_activated_rules_in_rule_group_request.ListActivatedRulesInRuleGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_activated_rules_in_rule_group_response.ListActivatedRulesInRuleGroupResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_activated_rules_in_rule_group

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_activated_rules_in_rule_group.list_activated_rules_in_rule_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_byte_match_sets(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_byte_match_sets_response.ListByteMatchSetsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_byte_match_sets_request.ListByteMatchSetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_byte_match_sets_response.ListByteMatchSetsResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_byte_match_sets

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_byte_match_sets.list_byte_match_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_geo_match_sets(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_geo_match_sets_response.ListGeoMatchSetsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_geo_match_sets_request.ListGeoMatchSetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_geo_match_sets_response.ListGeoMatchSetsResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_geo_match_sets

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_geo_match_sets.list_geo_match_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_ip_sets(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_ip_sets_response.ListIPSetsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_ip_sets_request.ListIPSetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_ip_sets_response.ListIPSetsResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_ip_sets

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_ip_sets.list_ip_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_logging_configurations(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_logging_configurations_response.ListLoggingConfigurationsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_logging_configurations_request.ListLoggingConfigurationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_logging_configurations_response.ListLoggingConfigurationsResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_logging_configurations

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_logging_configurations.list_logging_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_rate_based_rules(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_rate_based_rules_response.ListRateBasedRulesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_rate_based_rules_request.ListRateBasedRulesRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_rate_based_rules_response.ListRateBasedRulesResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_rate_based_rules

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_rate_based_rules.list_rate_based_rules(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_regex_match_sets(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_regex_match_sets_response.ListRegexMatchSetsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_regex_match_sets_request.ListRegexMatchSetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_regex_match_sets_response.ListRegexMatchSetsResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_regex_match_sets

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_regex_match_sets.list_regex_match_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_regex_pattern_sets(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_regex_pattern_sets_response.ListRegexPatternSetsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_regex_pattern_sets_request.ListRegexPatternSetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_regex_pattern_sets_response.ListRegexPatternSetsResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_regex_pattern_sets

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_regex_pattern_sets.list_regex_pattern_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_rule_groups(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_rule_groups_response.ListRuleGroupsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_rule_groups_request.ListRuleGroupsRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_rule_groups_response.ListRuleGroupsResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_rule_groups

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_rule_groups.list_rule_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_rules(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_rules_response.ListRulesResponse":
        r"""<note> <p>This is <b>AWS WAF Classic</b> documentation. For more information, see <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/classic-waf-chapter.html\">AWS WAF Classic</a> in the developer guide.</p> <p> <b>For the latest version of AWS WAF</b>, use the AWS WAFV2 API and see the <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html\">AWS WAF Developer Guide</a>. With the latest version, AWS WAF has a single set of endpoints for regional and global use. </p> </note> <p>Returns an array of <a>RuleSummary</a> objects.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_rules_request.ListRulesRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_rules_response.ListRulesResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_rules

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_rules.list_rules(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_size_constraint_sets(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_size_constraint_sets_response.ListSizeConstraintSetsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_size_constraint_sets_request.ListSizeConstraintSetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_size_constraint_sets_response.ListSizeConstraintSetsResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_size_constraint_sets

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_size_constraint_sets.list_size_constraint_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_sql_injection_match_sets(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_sql_injection_match_sets_response.ListSqlInjectionMatchSetsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_sql_injection_match_sets_request.ListSqlInjectionMatchSetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_sql_injection_match_sets_response.ListSqlInjectionMatchSetsResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_sql_injection_match_sets

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_sql_injection_match_sets.list_sql_injection_match_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_subscribed_rule_groups(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_subscribed_rule_groups_response.ListSubscribedRuleGroupsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_subscribed_rule_groups_request.ListSubscribedRuleGroupsRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_subscribed_rule_groups_response.ListSubscribedRuleGroupsResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_subscribed_rule_groups

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_subscribed_rule_groups.list_subscribed_rule_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        "aws_sdk_waf.types.list_tags_for_resource_response.ListTagsForResourceResponse"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_tags_for_resource

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_web_ac_ls(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_web_ac_ls_response.ListWebACLsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_web_ac_ls_request.ListWebACLsRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_web_ac_ls_response.ListWebACLsResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_web_ac_ls

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_web_ac_ls.list_web_ac_ls(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_xss_match_sets(
        ...
        *,
        ...
        next_marker: Optional["aws_sdk_waf.types.next_marker.NextMarker"] = None,
        limit: Optional["aws_sdk_waf.types.pagination_limit.PaginationLimit"] = None,
    ) -> "aws_sdk_waf.types.list_xss_match_sets_response.ListXssMatchSetsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.list_xss_match_sets_request.ListXssMatchSetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.list_xss_match_sets_response.ListXssMatchSetsResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.list_xss_match_sets

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.list_xss_match_sets.list_xss_match_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_logging_configuration(
        self,
        logging_configuration: "aws_sdk_waf.types.logging_configuration.LoggingConfiguration",
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.put_logging_configuration_response.PutLoggingConfigurationResponse":
    ...
    def put_permission_policy(
        self,
        resource_arn: "aws_sdk_waf.types.resource_arn.ResourceArn",
        policy: "aws_sdk_waf.types.policy_string.PolicyString",
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.put_permission_policy_response.PutPermissionPolicyResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.put_permission_policy_request.PutPermissionPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.put_permission_policy_response.PutPermissionPolicyResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.put_permission_policy

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.put_permission_policy.put_permission_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        self,
        resource_arn: "aws_sdk_waf.types.resource_arn.ResourceArn",
        tags: "aws_sdk_waf.types.tag_list.TagList",
        *,
        config_overrides: Optional[WAFClientConfig] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.tag_resource_response.TagResourceResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.tag_resource

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.untag_resource_response.UntagResourceResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.untag_resource_response.UntagResourceResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.untag_resource

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_byte_match_set(
        ...
        byte_match_set_id: "aws_sdk_waf.types.resource_id.ResourceId",
        change_token: "aws_sdk_waf.types.change_token.ChangeToken",
        updates: "aws_sdk_waf.types.byte_match_set_updates.ByteMatchSetUpdates",
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.update_byte_match_set_response.UpdateByteMatchSetResponse":
        ...
        Raises:
            ...
            aws_sdk_waf.errors.waf_invalid_parameter_exception.WAFInvalidParameterException: <p>The operation failed because AWS WAF didn't recognize a parameter in the request. For example:</p> <ul> <li> <p>You specified an invalid parameter name.</p> </li> <li> <p>You specified an invalid value.</p> </li> <li> <p>You tried to update an object (<code>ByteMatchSet</code>, <code>IPSet</code>, <code>Rule</code>, or <code>WebACL</code>) using an action other than <code>INSERT</code> or <code>DELETE</code>.</p> </li> <li> <p>You tried to create a <code>WebACL</code> with a <code>DefaultAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to create a <code>RateBasedRule</code> with a <code>RateKey</code> value other than <code>IP</code>.</p> </li> <li> <p>You tried to update a <code>WebACL</code> with a <code>WafAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>FieldToMatch</code> <code>Type</code> other than HEADER, METHOD, QUERY_STRING, URI, or BODY.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>Field</code> of <code>HEADER</code> but no value for <code>Data</code>.</p> </li> <li> <p>Your request references an ARN that is malformed, or corresponds to a resource with which a web ACL cannot be associated.</p> </li> </ul>
            aws_sdk_waf.errors.waf_limits_exceeded_exception.WAFLimitsExceededException: <p>The operation exceeds a resource limit, for example, the maximum number of <code>WebACL</code> objects that you can create for an AWS account. For more information, see <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/limits.html\">Limits</a> in the <i>AWS WAF Developer Guide</i>.</p>
            aws_sdk_waf.errors.waf_nonexistent_container_exception.WAFNonexistentContainerException: <p>The operation failed because you tried to add an object to or delete an object from another object that doesn't exist. For example:</p> <ul> <li> <p>You tried to add a <code>Rule</code> to or delete a <code>Rule</code> from a <code>WebACL</code> that doesn't exist.</p> </li> <li> <p>You tried to add a <code>ByteMatchSet</code> to or delete a <code>ByteMatchSet</code> from a <code>Rule</code> that doesn't exist.</p> </li> <li> <p>You tried to add an IP address to or delete an IP address from an <code>IPSet</code> that doesn't exist.</p> </li> <li> <p>You tried to add a <code>ByteMatchTuple</code> to or delete a <code>ByteMatchTuple</code> from a <code>ByteMatchSet</code> that doesn't exist.</p> </li> </ul>
            aws_sdk_waf.errors.waf_nonexistent_item_exception.WAFNonexistentItemException: <p>The operation failed because the referenced object doesn't exist.</p>
            aws_sdk_waf.errors.waf_stale_data_exception.WAFStaleDataException: <p>The operation failed because you tried to create, update, or delete an object by using a change token that has already been used.</p>
            aws_sdk_waf.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.update_byte_match_set_request.UpdateByteMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.update_byte_match_set_response.UpdateByteMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.update_byte_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.update_byte_match_set.update_byte_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_geo_match_set(
        ...
        geo_match_set_id: "aws_sdk_waf.types.resource_id.ResourceId",
        change_token: "aws_sdk_waf.types.change_token.ChangeToken",
        updates: "aws_sdk_waf.types.geo_match_set_updates.GeoMatchSetUpdates",
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.update_geo_match_set_response.UpdateGeoMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.update_geo_match_set_request.UpdateGeoMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.update_geo_match_set_response.UpdateGeoMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.update_geo_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.update_geo_match_set.update_geo_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_ip_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.update_ip_set_response.UpdateIPSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.update_ip_set_request.UpdateIPSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.update_ip_set_response.UpdateIPSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.update_ip_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.update_ip_set.update_ip_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_rate_based_rule(
        ...
        rule_id: "aws_sdk_waf.types.resource_id.ResourceId",
        change_token: "aws_sdk_waf.types.change_token.ChangeToken",
        updates: "aws_sdk_waf.types.rule_updates.RuleUpdates",
        rate_limit: "aws_sdk_waf.types.rate_limit.RateLimit",
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> (
        "aws_sdk_waf.types.update_rate_based_rule_response.UpdateRateBasedRuleResponse"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.update_rate_based_rule_request.UpdateRateBasedRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.update_rate_based_rule_response.UpdateRateBasedRuleResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.update_rate_based_rule

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.update_rate_based_rule.update_rate_based_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_regex_match_set(
        self,
        regex_match_set_id: "aws_sdk_waf.types.resource_id.ResourceId",
        updates: "aws_sdk_waf.types.regex_match_set_updates.RegexMatchSetUpdates",
        change_token: "aws_sdk_waf.types.change_token.ChangeToken",
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> (
        "aws_sdk_waf.types.update_regex_match_set_response.UpdateRegexMatchSetResponse"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.update_regex_match_set_request.UpdateRegexMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.update_regex_match_set_response.UpdateRegexMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.update_regex_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.update_regex_match_set.update_regex_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_regex_pattern_set(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.update_regex_pattern_set_response.UpdateRegexPatternSetResponse":
        ...
        Raises:
            ...
            aws_sdk_waf.errors.waf_invalid_account_exception.WAFInvalidAccountException: <p>The operation failed because you tried to create, update, or delete an object by using an invalid account identifier.</p>
            aws_sdk_waf.errors.waf_invalid_operation_exception.WAFInvalidOperationException: <p>The operation failed because there was nothing to do. For example:</p> <ul> <li> <p>You tried to remove a <code>Rule</code> from a <code>WebACL</code>, but the <code>Rule</code> isn't in the specified <code>WebACL</code>.</p> </li> <li> <p>You tried to remove an IP address from an <code>IPSet</code>, but the IP address isn't in the specified <code>IPSet</code>.</p> </li> <li> <p>You tried to remove a <code>ByteMatchTuple</code> from a <code>ByteMatchSet</code>, but the <code>ByteMatchTuple</code> isn't in the specified <code>WebACL</code>.</p> </li> <li> <p>You tried to add a <code>Rule</code> to a <code>WebACL</code>, but the <code>Rule</code> already exists in the specified <code>WebACL</code>.</p> </li> <li> <p>You tried to add a <code>ByteMatchTuple</code> to a <code>ByteMatchSet</code>, but the <code>ByteMatchTuple</code> already exists in the specified <code>WebACL</code>.</p> </li> </ul>
            aws_sdk_waf.errors.waf_invalid_regex_pattern_exception.WAFInvalidRegexPatternException: <p>The regular expression (regex) you specified in <code>RegexPatternString</code> is invalid.</p>
            aws_sdk_waf.errors.waf_limits_exceeded_exception.WAFLimitsExceededException: <p>The operation exceeds a resource limit, for example, the maximum number of <code>WebACL</code> objects that you can create for an AWS account. For more information, see <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/limits.html\">Limits</a> in the <i>AWS WAF Developer Guide</i>.</p>
            aws_sdk_waf.errors.waf_nonexistent_container_exception.WAFNonexistentContainerException: <p>The operation failed because you tried to add an object to or delete an object from another object that doesn't exist. For example:</p> <ul> <li> <p>You tried to add a <code>Rule</code> to or delete a <code>Rule</code> from a <code>WebACL</code> that doesn't exist.</p> </li> <li> <p>You tried to add a <code>ByteMatchSet</code> to or delete a <code>ByteMatchSet</code> from a <code>Rule</code> that doesn't exist.</p> </li> <li> <p>You tried to add an IP address to or delete an IP address from an <code>IPSet</code> that doesn't exist.</p> </li> <li> <p>You tried to add a <code>ByteMatchTuple</code> to or delete a <code>ByteMatchTuple</code> from a <code>ByteMatchSet</code> that doesn't exist.</p> </li> </ul>
            aws_sdk_waf.errors.waf_nonexistent_item_exception.WAFNonexistentItemException: <p>The operation failed because the referenced object doesn't exist.</p>
            aws_sdk_waf.errors.waf_stale_data_exception.WAFStaleDataException: <p>The operation failed because you tried to create, update, or delete an object by using a change token that has already been used.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.update_regex_pattern_set_request.UpdateRegexPatternSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.update_regex_pattern_set_response.UpdateRegexPatternSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.update_regex_pattern_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.update_regex_pattern_set.update_regex_pattern_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_rule(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.update_rule_response.UpdateRuleResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.update_rule_request.UpdateRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.update_rule_response.UpdateRuleResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.update_rule

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.update_rule.update_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_rule_group(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.update_rule_group_response.UpdateRuleGroupResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.update_rule_group_request.UpdateRuleGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.update_rule_group_response.UpdateRuleGroupResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.update_rule_group

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.update_rule_group.update_rule_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_size_constraint_set(
        ...
        size_constraint_set_id: "aws_sdk_waf.types.resource_id.ResourceId",
        change_token: "aws_sdk_waf.types.change_token.ChangeToken",
        updates: "aws_sdk_waf.types.size_constraint_set_updates.SizeConstraintSetUpdates",
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.update_size_constraint_set_response.UpdateSizeConstraintSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.update_size_constraint_set_request.UpdateSizeConstraintSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.update_size_constraint_set_response.UpdateSizeConstraintSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.update_size_constraint_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.update_size_constraint_set.update_size_constraint_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_sql_injection_match_set(
        ...
        sql_injection_match_set_id: "aws_sdk_waf.types.resource_id.ResourceId",
        change_token: "aws_sdk_waf.types.change_token.ChangeToken",
        updates: "aws_sdk_waf.types.sql_injection_match_set_updates.SqlInjectionMatchSetUpdates",
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.update_sql_injection_match_set_response.UpdateSqlInjectionMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.update_sql_injection_match_set_request.UpdateSqlInjectionMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.update_sql_injection_match_set_response.UpdateSqlInjectionMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.update_sql_injection_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.update_sql_injection_match_set.update_sql_injection_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_web_acl(
        ...
        *,
        config_overrides: Optional[WAFClientConfig] = None,
        updates: Optional["aws_sdk_waf.types.web_acl_updates.WebACLUpdates"] = None,
        default_action: Optional["aws_sdk_waf.types.waf_action.WafAction"] = None,
    ) -> "aws_sdk_waf.types.update_web_acl_response.UpdateWebACLResponse":
        ...
        Raises:
            ...
            aws_sdk_waf.errors.waf_referenced_item_exception.WAFReferencedItemException: <p>The operation failed because you tried to delete an object that is still in use. For example:</p> <ul> <li> <p>You tried to delete a <code>ByteMatchSet</code> that is still referenced by a <code>Rule</code>.</p> </li> <li> <p>You tried to delete a <code>Rule</code> that is still referenced by a <code>WebACL</code>.</p> </li> </ul>
            aws_sdk_waf.errors.waf_stale_data_exception.WAFStaleDataException: <p>The operation failed because you tried to create, update, or delete an object by using a change token that has already been used.</p>
            aws_sdk_waf.errors.waf_subscription_not_found_exception.WAFSubscriptionNotFoundException: <p>The specified subscription does not exist.</p>
            aws_sdk_waf.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.update_web_acl_request.UpdateWebACLRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.update_web_acl_response.UpdateWebACLResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.update_web_acl

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.update_web_acl.update_web_acl(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_xss_match_set(
        ...
        xss_match_set_id: "aws_sdk_waf.types.resource_id.ResourceId",
        change_token: "aws_sdk_waf.types.change_token.ChangeToken",
        updates: "aws_sdk_waf.types.xss_match_set_updates.XssMatchSetUpdates",
        *,
        config_overrides: Optional[WAFClientConfig] = None,
    ) -> "aws_sdk_waf.types.update_xss_match_set_response.UpdateXssMatchSetResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_waf.types.update_xss_match_set_request.UpdateXssMatchSetRequest]",
        ) -> OperationResponse[
            "aws_sdk_waf.types.update_xss_match_set_response.UpdateXssMatchSetResponse"
        ]:
            import aws_sdk_waf._operations.awswaf_20150824.update_xss_match_set

            output, http_response = (
                aws_sdk_waf._operations.awswaf_20150824.update_xss_match_set.update_xss_match_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
