...
class MediaLiveError(Exception):
    """Base class for all MediaLive service errors."""


class ServiceError(MediaLiveError):
...
class SerializationError(MediaLiveError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MediaLiveError):
...
class WaiterFailedError(MediaLiveError):
...
class WaiterTimeoutError(MediaLiveError):
