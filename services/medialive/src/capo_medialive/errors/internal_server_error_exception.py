"""Generated from Smithy shape ``com.amazonaws.medialive#InternalServerErrorException``."""
...
class InternalServerErrorException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.medialive#InternalServerErrorException``."""
