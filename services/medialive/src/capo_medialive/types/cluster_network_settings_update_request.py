...
if TYPE_CHECKING:
    import capo_medialive.types.__list_of_interface_mapping_update_request
    import capo_medialive.types.__string


class ClusterNetworkSettingsUpdateRequest(TypedDict, closed=True):
    ...
    interface_mappings: NotRequired[
        "capo_medialive.types.__list_of_interface_mapping_update_request.__listOfInterfaceMappingUpdateRequest"
    ]
...
def serialize_json(value: ClusterNetworkSettingsUpdateRequest) -> dict:
    ...
    if "interface_mappings" in value:
        ...
        out["interfaceMappings"] = (
            capo_medialive.types.__list_of_interface_mapping_update_request.serialize_json(
...
def deserialize_json(data: dict) -> ClusterNetworkSettingsUpdateRequest:
    ...
    if "interfaceMappings" in data:
        ...
        out["interface_mappings"] = (
            capo_medialive.types.__list_of_interface_mapping_update_request.deserialize_json(
