...
class HlsCdnSettings(TypedDict, closed=True):
    hls_akamai_settings: NotRequired[
        "capo_medialive.types.hls_akamai_settings.HlsAkamaiSettings"
    ]
    hls_basic_put_settings: NotRequired[
        "capo_medialive.types.hls_basic_put_settings.HlsBasicPutSettings"
    ]
    hls_media_store_settings: NotRequired[
        "capo_medialive.types.hls_media_store_settings.HlsMediaStoreSettings"
    ]
    hls_s3_settings: NotRequired["capo_medialive.types.hls_s3_settings.HlsS3Settings"]
    hls_webdav_settings: NotRequired[
        "capo_medialive.types.hls_webdav_settings.HlsWebdavSettings"
    ]
...
def serialize_json(value: HlsCdnSettings) -> dict:
    ...
    if "hls_akamai_settings" in value:
        ...
        out["hlsAkamaiSettings"] = (
            capo_medialive.types.hls_akamai_settings.serialize_json(
    ...
    if "hls_basic_put_settings" in value:
        ...
        out["hlsBasicPutSettings"] = (
            capo_medialive.types.hls_basic_put_settings.serialize_json(
    ...
    if "hls_media_store_settings" in value:
        ...
        out["hlsMediaStoreSettings"] = (
            capo_medialive.types.hls_media_store_settings.serialize_json(
    ...
    if "hls_s3_settings" in value:
        ...
        out["hlsS3Settings"] = capo_medialive.types.hls_s3_settings.serialize_json(
    ...
    if "hls_webdav_settings" in value:
        ...
        out["hlsWebdavSettings"] = (
            capo_medialive.types.hls_webdav_settings.serialize_json(
...
def deserialize_json(data: dict) -> HlsCdnSettings:
    ...
    if "hlsAkamaiSettings" in data:
        ...
        out["hls_akamai_settings"] = (
            capo_medialive.types.hls_akamai_settings.deserialize_json(
    ...
    if "hlsBasicPutSettings" in data:
        ...
        out["hls_basic_put_settings"] = (
            capo_medialive.types.hls_basic_put_settings.deserialize_json(
    ...
    if "hlsMediaStoreSettings" in data:
        ...
        out["hls_media_store_settings"] = (
            capo_medialive.types.hls_media_store_settings.deserialize_json(
    ...
    if "hlsWebdavSettings" in data:
        ...
        out["hls_webdav_settings"] = (
            capo_medialive.types.hls_webdav_settings.deserialize_json(
