...
class Scte35DeliveryRestrictions(TypedDict, closed=True):
    archive_allowed_flag: NotRequired[
        "capo_medialive.types.scte35_archive_allowed_flag.Scte35ArchiveAllowedFlag"
    ]
    """Corresponds to SCTE-35 archive_allowed_flag."""
    device_restrictions: NotRequired[
        "capo_medialive.types.scte35_device_restrictions.Scte35DeviceRestrictions"
    ]
    """Corresponds to SCTE-35 device_restrictions parameter."""
    no_regional_blackout_flag: NotRequired[
        "capo_medialive.types.scte35_no_regional_blackout_flag.Scte35NoRegionalBlackoutFlag"
    ]
    """Corresponds to SCTE-35 no_regional_blackout_flag parameter."""
    web_delivery_allowed_flag: NotRequired[
        "capo_medialive.types.scte35_web_delivery_allowed_flag.Scte35WebDeliveryAllowedFlag"
    ]
...
def serialize_json(value: Scte35DeliveryRestrictions) -> dict:
    ...
    if "archive_allowed_flag" in value:
        ...
        out["archiveAllowedFlag"] = (
            capo_medialive.types.scte35_archive_allowed_flag.serialize_json(
    ...
    if "device_restrictions" in value:
        ...
        out["deviceRestrictions"] = (
            capo_medialive.types.scte35_device_restrictions.serialize_json(
    ...
    if "no_regional_blackout_flag" in value:
        ...
        out["noRegionalBlackoutFlag"] = (
            capo_medialive.types.scte35_no_regional_blackout_flag.serialize_json(
    ...
    if "web_delivery_allowed_flag" in value:
        ...
        out["webDeliveryAllowedFlag"] = (
            capo_medialive.types.scte35_web_delivery_allowed_flag.serialize_json(
...
def deserialize_json(data: dict) -> Scte35DeliveryRestrictions:
    ...
    if "archiveAllowedFlag" in data:
        ...
        out["archive_allowed_flag"] = (
            capo_medialive.types.scte35_archive_allowed_flag.deserialize_json(
    ...
    if "deviceRestrictions" in data:
        ...
        out["device_restrictions"] = (
            capo_medialive.types.scte35_device_restrictions.deserialize_json(
    ...
    if "noRegionalBlackoutFlag" in data:
        ...
        out["no_regional_blackout_flag"] = (
            capo_medialive.types.scte35_no_regional_blackout_flag.deserialize_json(
    ...
    if "webDeliveryAllowedFlag" in data:
        ...
        out["web_delivery_allowed_flag"] = (
            capo_medialive.types.scte35_web_delivery_allowed_flag.deserialize_json(
