...
class TransferringInputDeviceSummary(TypedDict, closed=True):
    ...
    transfer_type: NotRequired[
        "capo_medialive.types.input_device_transfer_type.InputDeviceTransferType"
    ]
...
def serialize_json(value: TransferringInputDeviceSummary) -> dict:
    ...
    if "transfer_type" in value:
        ...
        out["transferType"] = (
            capo_medialive.types.input_device_transfer_type.serialize_json(
                value["transfer_type"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> TransferringInputDeviceSummary:
    ...
    if "transferType" in data:
        ...
        out["transfer_type"] = (
            capo_medialive.types.input_device_transfer_type.deserialize_json(
                data["transferType"]
            )
        )
    return out
