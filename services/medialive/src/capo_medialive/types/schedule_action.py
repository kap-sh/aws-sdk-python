...
class ScheduleAction(TypedDict, closed=True):
    action_name: NotRequired["capo_medialive.types.__string.__string"]
    """The name of the action, must be unique within the schedule. This name provides the main reference to an action once it is added to the schedule. A name is unique if it is no longer in the schedule. The schedule is automatically cleaned up to remove actions with a start time of more than 1 hour ago (approximately) so at that point a name can be reused."""
    schedule_action_settings: NotRequired[
        "capo_medialive.types.schedule_action_settings.ScheduleActionSettings"
    ]
    """Settings for this schedule action."""
    schedule_action_start_settings: NotRequired[
        "capo_medialive.types.schedule_action_start_settings.ScheduleActionStartSettings"
    ]
...
def serialize_json(value: ScheduleAction) -> dict:
    ...
    if "schedule_action_settings" in value:
        ...
        out["scheduleActionSettings"] = (
            capo_medialive.types.schedule_action_settings.serialize_json(
    ...
    if "schedule_action_start_settings" in value:
        ...
        out["scheduleActionStartSettings"] = (
            capo_medialive.types.schedule_action_start_settings.serialize_json(
...
def deserialize_json(data: dict) -> ScheduleAction:
    ...
    if "scheduleActionSettings" in data:
        ...
        out["schedule_action_settings"] = (
            capo_medialive.types.schedule_action_settings.deserialize_json(
    ...
    if "scheduleActionStartSettings" in data:
        ...
        out["schedule_action_start_settings"] = (
            capo_medialive.types.schedule_action_start_settings.deserialize_json(
