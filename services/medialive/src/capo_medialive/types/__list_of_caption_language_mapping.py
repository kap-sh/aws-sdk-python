...
if TYPE_CHECKING:
    import capo_medialive.types.caption_language_mapping

__listOfCaptionLanguageMapping: TypeAlias = list[
    "capo_medialive.types.caption_language_mapping.CaptionLanguageMapping"
]
...
def serialize_json(value: __listOfCaptionLanguageMapping) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_medialive.types.caption_language_mapping.serialize_json(item))
    return out
