...
class Fmp4HlsSettings(TypedDict, closed=True):
    ...
    nielsen_id3_behavior: NotRequired[
        "capo_medialive.types.fmp4_nielsen_id3_behavior.Fmp4NielsenId3Behavior"
    ]
    """If set to passthrough, Nielsen inaudible tones for media tracking will be detected in the input audio and an equivalent ID3 tag will be inserted in the output."""
    timed_metadata_behavior: NotRequired[
        "capo_medialive.types.fmp4_timed_metadata_behavior.Fmp4TimedMetadataBehavior"
    ]
...
def serialize_json(value: Fmp4HlsSettings) -> dict:
    ...
    if "nielsen_id3_behavior" in value:
        ...
        out["nielsenId3Behavior"] = (
            capo_medialive.types.fmp4_nielsen_id3_behavior.serialize_json(
    ...
    if "timed_metadata_behavior" in value:
        ...
        out["timedMetadataBehavior"] = (
            capo_medialive.types.fmp4_timed_metadata_behavior.serialize_json(
...
def deserialize_json(data: dict) -> Fmp4HlsSettings:
    ...
    if "nielsenId3Behavior" in data:
        ...
        out["nielsen_id3_behavior"] = (
            capo_medialive.types.fmp4_nielsen_id3_behavior.deserialize_json(
    ...
    if "timedMetadataBehavior" in data:
        ...
        out["timed_metadata_behavior"] = (
            capo_medialive.types.fmp4_timed_metadata_behavior.deserialize_json(
