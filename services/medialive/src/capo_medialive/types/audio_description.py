...
if TYPE_CHECKING:
    ...
    import capo_medialive.types.__string_min1_max35
...
class AudioDescription(TypedDict, closed=True):
    ...
    audio_selector_name: NotRequired["capo_medialive.types.__string.__string"]
    """The name of the AudioSelector used as the source for this AudioDescription."""
    audio_type: NotRequired["capo_medialive.types.audio_type.AudioType"]
    """Applies only if audioTypeControl is useConfigured. The values for audioType are defined in ISO-IEC 13818-1."""
    audio_type_control: NotRequired[
        "capo_medialive.types.audio_description_audio_type_control.AudioDescriptionAudioTypeControl"
    ]
    """Determines how audio type is determined. followInput: If the input contains an ISO 639 audioType, then that value is passed through to the output. If the input contains no ISO 639 audioType, the value in Audio Type is included in the output. useConfigured: The value in Audio Type is included in the output. Note that this field and audioType are both ignored if inputType is broadcasterMixedAd."""
    audio_watermarking_settings: NotRequired[
        "capo_medialive.types.audio_watermark_settings.AudioWatermarkSettings"
    ]
    """Settings to configure one or more solutions that insert audio watermarks in the audio encode"""
    codec_settings: NotRequired[
        "capo_medialive.types.audio_codec_settings.AudioCodecSettings"
    ]
    """Audio codec settings."""
    language_code: NotRequired[
        "capo_medialive.types.__string_min1_max35.__stringMin1Max35"
    ]
    """RFC 5646 language code representing the language of the audio output track. Only used if languageControlMode is useConfigured, or there is no ISO 639 language code specified in the input."""
    language_code_control: NotRequired[
        "capo_medialive.types.audio_description_language_code_control.AudioDescriptionLanguageCodeControl"
    ]
    """Choosing followInput will cause the ISO 639 language code of the output to follow the ISO 639 language code of the input. The languageCode will be used when useConfigured is set, or when followInput is selected but there is no ISO 639 language code specified by the input."""
    name: NotRequired["capo_medialive.types.__string_max255.__stringMax255"]
    ...
    audio_dash_roles: NotRequired[
        "capo_medialive.types.__list_of_dash_role_audio.__listOfDashRoleAudio"
    ]
    ...
    dvb_dash_accessibility: NotRequired[
        "capo_medialive.types.dvb_dash_accessibility.DvbDashAccessibility"
    ]
...
def serialize_json(value: AudioDescription) -> dict:
    ...
    if "audio_type" in value:
        ...
        out["audioType"] = capo_medialive.types.audio_type.serialize_json(
            value["audio_type"]
        )
    if "audio_type_control" in value:
        ...
        out["audioTypeControl"] = (
            capo_medialive.types.audio_description_audio_type_control.serialize_json(
    ...
    if "audio_watermarking_settings" in value:
        ...
        out["audioWatermarkingSettings"] = (
            capo_medialive.types.audio_watermark_settings.serialize_json(
    ...
    if "codec_settings" in value:
        ...
        out["codecSettings"] = capo_medialive.types.audio_codec_settings.serialize_json(
    ...
    if "language_code_control" in value:
        ...
        out["languageCodeControl"] = (
            capo_medialive.types.audio_description_language_code_control.serialize_json(
    ...
    if "audio_dash_roles" in value:
        ...
        out["audioDashRoles"] = (
            capo_medialive.types.__list_of_dash_role_audio.serialize_json(
    ...
    if "dvb_dash_accessibility" in value:
        ...
        out["dvbDashAccessibility"] = (
            capo_medialive.types.dvb_dash_accessibility.serialize_json(
...
def deserialize_json(data: dict) -> AudioDescription:
    ...
    if "audioTypeControl" in data:
        ...
        out["audio_type_control"] = (
            capo_medialive.types.audio_description_audio_type_control.deserialize_json(
    ...
    if "audioWatermarkingSettings" in data:
        ...
        out["audio_watermarking_settings"] = (
            capo_medialive.types.audio_watermark_settings.deserialize_json(
    ...
    if "codecSettings" in data:
        ...
        out["codec_settings"] = (
            capo_medialive.types.audio_codec_settings.deserialize_json(
                data["codecSettings"]
            )
        )
    ...
    if "languageCodeControl" in data:
        ...
        out["language_code_control"] = (
            capo_medialive.types.audio_description_language_code_control.deserialize_json(
    ...
    if "audioDashRoles" in data:
        ...
        out["audio_dash_roles"] = (
            capo_medialive.types.__list_of_dash_role_audio.deserialize_json(
                data["audioDashRoles"]
            )
        )
    if "dvbDashAccessibility" in data:
        ...
        out["dvb_dash_accessibility"] = (
            capo_medialive.types.dvb_dash_accessibility.deserialize_json(
