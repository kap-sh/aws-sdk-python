"""Generated from Smithy shape ``com.amazonaws.medialive#UpdateNodeResponse``."""
...
class UpdateNodeResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateNodeResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> UpdateNodeResponse:
    out: UpdateNodeResponse = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
