...
class CaptionDestinationSettings(TypedDict, closed=True):
    arib_destination_settings: NotRequired[
        "capo_medialive.types.arib_destination_settings.AribDestinationSettings"
    ]
    burn_in_destination_settings: NotRequired[
        "capo_medialive.types.burn_in_destination_settings.BurnInDestinationSettings"
    ]
    dvb_sub_destination_settings: NotRequired[
        "capo_medialive.types.dvb_sub_destination_settings.DvbSubDestinationSettings"
    ]
    ebu_tt_d_destination_settings: NotRequired[
        "capo_medialive.types.ebu_tt_d_destination_settings.EbuTtDDestinationSettings"
    ]
    embedded_destination_settings: NotRequired[
        "capo_medialive.types.embedded_destination_settings.EmbeddedDestinationSettings"
    ]
    embedded_plus_scte20_destination_settings: NotRequired[
        "capo_medialive.types.embedded_plus_scte20_destination_settings.EmbeddedPlusScte20DestinationSettings"
    ]
    rtmp_caption_info_destination_settings: NotRequired[
        "capo_medialive.types.rtmp_caption_info_destination_settings.RtmpCaptionInfoDestinationSettings"
    ]
    scte20_plus_embedded_destination_settings: NotRequired[
        "capo_medialive.types.scte20_plus_embedded_destination_settings.Scte20PlusEmbeddedDestinationSettings"
    ]
    scte27_destination_settings: NotRequired[
        "capo_medialive.types.scte27_destination_settings.Scte27DestinationSettings"
    ]
    smpte_tt_destination_settings: NotRequired[
        "capo_medialive.types.smpte_tt_destination_settings.SmpteTtDestinationSettings"
    ]
    teletext_destination_settings: NotRequired[
        "capo_medialive.types.teletext_destination_settings.TeletextDestinationSettings"
    ]
    ttml_destination_settings: NotRequired[
        "capo_medialive.types.ttml_destination_settings.TtmlDestinationSettings"
    ]
    webvtt_destination_settings: NotRequired[
        "capo_medialive.types.webvtt_destination_settings.WebvttDestinationSettings"
    ]
...
def serialize_json(value: CaptionDestinationSettings) -> dict:
    ...
    if "arib_destination_settings" in value:
        ...
        out["aribDestinationSettings"] = (
            capo_medialive.types.arib_destination_settings.serialize_json(
    ...
    if "burn_in_destination_settings" in value:
        ...
        out["burnInDestinationSettings"] = (
            capo_medialive.types.burn_in_destination_settings.serialize_json(
    ...
    if "dvb_sub_destination_settings" in value:
        ...
        out["dvbSubDestinationSettings"] = (
            capo_medialive.types.dvb_sub_destination_settings.serialize_json(
    ...
    if "ebu_tt_d_destination_settings" in value:
        ...
        out["ebuTtDDestinationSettings"] = (
            capo_medialive.types.ebu_tt_d_destination_settings.serialize_json(
    ...
    if "embedded_destination_settings" in value:
        ...
        out["embeddedDestinationSettings"] = (
            capo_medialive.types.embedded_destination_settings.serialize_json(
    ...
    if "embedded_plus_scte20_destination_settings" in value:
        ...
        out["embeddedPlusScte20DestinationSettings"] = (
            capo_medialive.types.embedded_plus_scte20_destination_settings.serialize_json(
    ...
    if "rtmp_caption_info_destination_settings" in value:
        ...
        out["rtmpCaptionInfoDestinationSettings"] = (
            capo_medialive.types.rtmp_caption_info_destination_settings.serialize_json(
    ...
    if "scte20_plus_embedded_destination_settings" in value:
        ...
        out["scte20PlusEmbeddedDestinationSettings"] = (
            capo_medialive.types.scte20_plus_embedded_destination_settings.serialize_json(
    ...
    if "scte27_destination_settings" in value:
        ...
        out["scte27DestinationSettings"] = (
            capo_medialive.types.scte27_destination_settings.serialize_json(
    ...
    if "smpte_tt_destination_settings" in value:
        ...
        out["smpteTtDestinationSettings"] = (
            capo_medialive.types.smpte_tt_destination_settings.serialize_json(
    ...
    if "teletext_destination_settings" in value:
        ...
        out["teletextDestinationSettings"] = (
            capo_medialive.types.teletext_destination_settings.serialize_json(
    ...
    if "ttml_destination_settings" in value:
        ...
        out["ttmlDestinationSettings"] = (
            capo_medialive.types.ttml_destination_settings.serialize_json(
    ...
    if "webvtt_destination_settings" in value:
        ...
        out["webvttDestinationSettings"] = (
            capo_medialive.types.webvtt_destination_settings.serialize_json(
...
def deserialize_json(data: dict) -> CaptionDestinationSettings:
    ...
    if "aribDestinationSettings" in data:
        ...
        out["arib_destination_settings"] = (
            capo_medialive.types.arib_destination_settings.deserialize_json(
    ...
    if "burnInDestinationSettings" in data:
        ...
        out["burn_in_destination_settings"] = (
            capo_medialive.types.burn_in_destination_settings.deserialize_json(
    ...
    if "dvbSubDestinationSettings" in data:
        ...
        out["dvb_sub_destination_settings"] = (
            capo_medialive.types.dvb_sub_destination_settings.deserialize_json(
    ...
    if "ebuTtDDestinationSettings" in data:
        ...
        out["ebu_tt_d_destination_settings"] = (
            capo_medialive.types.ebu_tt_d_destination_settings.deserialize_json(
    ...
    if "embeddedDestinationSettings" in data:
        ...
        out["embedded_destination_settings"] = (
            capo_medialive.types.embedded_destination_settings.deserialize_json(
    ...
    if "embeddedPlusScte20DestinationSettings" in data:
        ...
        out["embedded_plus_scte20_destination_settings"] = (
            capo_medialive.types.embedded_plus_scte20_destination_settings.deserialize_json(
    ...
    if "rtmpCaptionInfoDestinationSettings" in data:
        ...
        out["rtmp_caption_info_destination_settings"] = (
            capo_medialive.types.rtmp_caption_info_destination_settings.deserialize_json(
    ...
    if "scte20PlusEmbeddedDestinationSettings" in data:
        ...
        out["scte20_plus_embedded_destination_settings"] = (
            capo_medialive.types.scte20_plus_embedded_destination_settings.deserialize_json(
    ...
    if "scte27DestinationSettings" in data:
        ...
        out["scte27_destination_settings"] = (
            capo_medialive.types.scte27_destination_settings.deserialize_json(
    ...
    if "smpteTtDestinationSettings" in data:
        ...
        out["smpte_tt_destination_settings"] = (
            capo_medialive.types.smpte_tt_destination_settings.deserialize_json(
    ...
    if "teletextDestinationSettings" in data:
        ...
        out["teletext_destination_settings"] = (
            capo_medialive.types.teletext_destination_settings.deserialize_json(
    ...
    if "ttmlDestinationSettings" in data:
        ...
        out["ttml_destination_settings"] = (
            capo_medialive.types.ttml_destination_settings.deserialize_json(
    ...
    if "webvttDestinationSettings" in data:
        ...
        out["webvtt_destination_settings"] = (
            capo_medialive.types.webvtt_destination_settings.deserialize_json(
