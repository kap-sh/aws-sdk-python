...
class SdiSourceMappingUpdateRequest(TypedDict, closed=True):
    card_number: NotRequired["capo_medialive.types.__integer.__integer"]
    ...
    channel_number: NotRequired["capo_medialive.types.__integer.__integer"]
    ...
    sdi_source: NotRequired["capo_medialive.types.__string.__string"]
