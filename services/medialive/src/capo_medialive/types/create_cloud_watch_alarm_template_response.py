"""Generated from Smithy shape ``com.amazonaws.medialive#CreateCloudWatchAlarmTemplateResponse``."""
...
class CreateCloudWatchAlarmTemplateResponse(TypedDict, closed=True):
    arn: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateCloudWatchAlarmTemplateResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateCloudWatchAlarmTemplateResponse:
    out: CreateCloudWatchAlarmTemplateResponse = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
