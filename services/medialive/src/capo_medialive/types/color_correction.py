...
class ColorCorrection(TypedDict, closed=True):
    input_color_space: NotRequired["capo_medialive.types.color_space.ColorSpace"]
    """The color space of the input."""
    output_color_space: NotRequired["capo_medialive.types.color_space.ColorSpace"]
    """The color space of the output."""
    uri: NotRequired["capo_medialive.types.__string.__string"]
...
def serialize_json(value: ColorCorrection) -> dict:
    ...
    if "input_color_space" in value:
        ...
        out["inputColorSpace"] = capo_medialive.types.color_space.serialize_json(
            value["input_color_space"]
        )
    if "output_color_space" in value:
        import capo_medialive.types.color_space

        out["outputColorSpace"] = capo_medialive.types.color_space.serialize_json(
