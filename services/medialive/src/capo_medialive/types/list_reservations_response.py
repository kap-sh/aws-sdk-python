...
if TYPE_CHECKING:
    import capo_medialive.types.__list_of_reservation
...
class ListReservationsResponse(TypedDict, closed=True):
    ...
    reservations: NotRequired[
        "capo_medialive.types.__list_of_reservation.__listOfReservation"
    ]
...
def serialize_json(value: ListReservationsResponse) -> dict:
    ...
    if "reservations" in value:
        ...
        out["reservations"] = capo_medialive.types.__list_of_reservation.serialize_json(
            value["reservations"]
        )
    return out
...
def deserialize_json(data: dict) -> ListReservationsResponse:
    ...
    if "reservations" in data:
        ...
        out["reservations"] = (
            capo_medialive.types.__list_of_reservation.deserialize_json(
                data["reservations"]
            )
        )
    return out
