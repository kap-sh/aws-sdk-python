...
class ListCloudWatchAlarmTemplateGroupsResponse(TypedDict, closed=True):
    cloud_watch_alarm_template_groups: NotRequired[
        "capo_medialive.types.__list_of_cloud_watch_alarm_template_group_summary.__listOfCloudWatchAlarmTemplateGroupSummary"
    ]
...
def serialize_json(value: ListCloudWatchAlarmTemplateGroupsResponse) -> dict:
    ...
    if "cloud_watch_alarm_template_groups" in value:
        ...
        out["cloudWatchAlarmTemplateGroups"] = (
            capo_medialive.types.__list_of_cloud_watch_alarm_template_group_summary.serialize_json(
...
def deserialize_json(data: dict) -> ListCloudWatchAlarmTemplateGroupsResponse:
    ...
    if "cloudWatchAlarmTemplateGroups" in data:
        ...
        out["cloud_watch_alarm_template_groups"] = (
            capo_medialive.types.__list_of_cloud_watch_alarm_template_group_summary.deserialize_json(
