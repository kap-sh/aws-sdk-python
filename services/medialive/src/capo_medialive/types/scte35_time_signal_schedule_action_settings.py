...
if TYPE_CHECKING:
    import capo_medialive.types.__list_of_scte35_descriptor


class Scte35TimeSignalScheduleActionSettings(TypedDict, closed=True):
    scte35_descriptors: NotRequired[
        "capo_medialive.types.__list_of_scte35_descriptor.__listOfScte35Descriptor"
    ]
...
def serialize_json(value: Scte35TimeSignalScheduleActionSettings) -> dict:
    ...
    if "scte35_descriptors" in value:
        ...
        out["scte35Descriptors"] = (
            capo_medialive.types.__list_of_scte35_descriptor.serialize_json(
...
def deserialize_json(data: dict) -> Scte35TimeSignalScheduleActionSettings:
    ...
    if "scte35Descriptors" in data:
        ...
        out["scte35_descriptors"] = (
            capo_medialive.types.__list_of_scte35_descriptor.deserialize_json(
