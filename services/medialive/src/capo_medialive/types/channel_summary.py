"""Generated from Smithy shape ``com.amazonaws.medialive#ChannelSummary``."""
...
class ChannelSummary(TypedDict, closed=True):
    ...
    used_channel_engine_versions: NotRequired[
...
def serialize_json(value: ChannelSummary) -> dict:
    ...
    if "used_channel_engine_versions" in value:
        import capo_medialive.types.__list_of_channel_engine_version_response

        out["usedChannelEngineVersions"] = (
            capo_medialive.types.__list_of_channel_engine_version_response.serialize_json(
                value["used_channel_engine_versions"]
            )
        )
...
def deserialize_json(data: dict) -> ChannelSummary:
    ...
    if "usedChannelEngineVersions" in data:
        import capo_medialive.types.__list_of_channel_engine_version_response

        out["used_channel_engine_versions"] = (
            capo_medialive.types.__list_of_channel_engine_version_response.deserialize_json(
                data["usedChannelEngineVersions"]
            )
        )
