...
class InputDeviceConfigurableSettings(TypedDict, closed=True):
    ...
    mediaconnect_settings: NotRequired[
        "capo_medialive.types.input_device_media_connect_configurable_settings.InputDeviceMediaConnectConfigurableSettings"
    ]
    ...
    audio_channel_pairs: NotRequired[
        "capo_medialive.types.__list_of_input_device_configurable_audio_channel_pair_config.__listOfInputDeviceConfigurableAudioChannelPairConfig"
    ]
...
def serialize_json(value: InputDeviceConfigurableSettings) -> dict:
    ...
    if "mediaconnect_settings" in value:
        ...
        out["mediaconnectSettings"] = (
            capo_medialive.types.input_device_media_connect_configurable_settings.serialize_json(
    ...
    if "audio_channel_pairs" in value:
        ...
        out["audioChannelPairs"] = (
            capo_medialive.types.__list_of_input_device_configurable_audio_channel_pair_config.serialize_json(
...
def deserialize_json(data: dict) -> InputDeviceConfigurableSettings:
    ...
    if "mediaconnectSettings" in data:
        ...
        out["mediaconnect_settings"] = (
            capo_medialive.types.input_device_media_connect_configurable_settings.deserialize_json(
    ...
    if "audioChannelPairs" in data:
        ...
        out["audio_channel_pairs"] = (
            capo_medialive.types.__list_of_input_device_configurable_audio_channel_pair_config.deserialize_json(
