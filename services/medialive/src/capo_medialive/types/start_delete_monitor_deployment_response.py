"""Generated from Smithy shape ``com.amazonaws.medialive#StartDeleteMonitorDeploymentResponse``."""
...
class StartDeleteMonitorDeploymentResponse(TypedDict, closed=True):
    arn: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: StartDeleteMonitorDeploymentResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
