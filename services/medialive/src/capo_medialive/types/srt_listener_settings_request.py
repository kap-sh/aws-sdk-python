...
if TYPE_CHECKING:
    ...
    import capo_medialive.types.srt_listener_decryption_request


class SrtListenerSettingsRequest(TypedDict, closed=True):
    decryption: NotRequired[
        "capo_medialive.types.srt_listener_decryption_request.SrtListenerDecryptionRequest"
    ]
...
def serialize_json(value: SrtListenerSettingsRequest) -> dict:
    ...
    if "decryption" in value:
        ...
        out["decryption"] = (
            capo_medialive.types.srt_listener_decryption_request.serialize_json(
                value["decryption"]
            )
        )
...
def deserialize_json(data: dict) -> SrtListenerSettingsRequest:
    ...
    if "decryption" in data:
        ...
        out["decryption"] = (
            capo_medialive.types.srt_listener_decryption_request.deserialize_json(
                data["decryption"]
            )
        )
