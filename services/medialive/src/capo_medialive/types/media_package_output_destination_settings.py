...
class MediaPackageOutputDestinationSettings(TypedDict, closed=True):
    channel_id: NotRequired["capo_medialive.types.__string_min1.__stringMin1"]
    """ID of the channel in MediaPackage that is the destination for this output group. You do not need to specify the individual inputs in MediaPackage; MediaLive will handle the connection of the two MediaLive pipelines to the two MediaPackage inputs. The MediaPackage channel and MediaLive channel must be in the same region."""
    channel_group: NotRequired["capo_medialive.types.__string_min1.__stringMin1"]
    ...
    channel_name: NotRequired["capo_medialive.types.__string_min1.__stringMin1"]
    ...
    channel_endpoint_id: NotRequired["capo_medialive.types.__string_min1.__stringMin1"]
    ...
    media_package_region_name: NotRequired[
        "capo_medialive.types.__string_min1.__stringMin1"
    ]
