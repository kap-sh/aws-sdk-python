...
class UdpGroupSettings(TypedDict, closed=True):
    input_loss_action: NotRequired[
        "capo_medialive.types.input_loss_action_for_udp_out.InputLossActionForUdpOut"
    ]
    ...
    timed_metadata_id3_frame: NotRequired[
        "capo_medialive.types.udp_timed_metadata_id3_frame.UdpTimedMetadataId3Frame"
    ]
...
def serialize_json(value: UdpGroupSettings) -> dict:
    ...
    if "input_loss_action" in value:
        ...
        out["inputLossAction"] = (
            capo_medialive.types.input_loss_action_for_udp_out.serialize_json(
    ...
    if "timed_metadata_id3_frame" in value:
        ...
        out["timedMetadataId3Frame"] = (
            capo_medialive.types.udp_timed_metadata_id3_frame.serialize_json(
...
def deserialize_json(data: dict) -> UdpGroupSettings:
    ...
    if "inputLossAction" in data:
        ...
        out["input_loss_action"] = (
            capo_medialive.types.input_loss_action_for_udp_out.deserialize_json(
    ...
    if "timedMetadataId3Frame" in data:
        ...
        out["timed_metadata_id3_frame"] = (
            capo_medialive.types.udp_timed_metadata_id3_frame.deserialize_json(
