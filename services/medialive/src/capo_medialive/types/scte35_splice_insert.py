...
class Scte35SpliceInsert(TypedDict, closed=True):
    ...
    no_regional_blackout_flag: NotRequired[
        "capo_medialive.types.scte35_splice_insert_no_regional_blackout_behavior.Scte35SpliceInsertNoRegionalBlackoutBehavior"
    ]
    """When set to ignore, Segment Descriptors with noRegionalBlackoutFlag set to 0 will no longer trigger blackouts or Ad Avail slates"""
    web_delivery_allowed_flag: NotRequired[
        "capo_medialive.types.scte35_splice_insert_web_delivery_allowed_behavior.Scte35SpliceInsertWebDeliveryAllowedBehavior"
    ]
...
def serialize_json(value: Scte35SpliceInsert) -> dict:
    ...
    if "no_regional_blackout_flag" in value:
        ...
        out["noRegionalBlackoutFlag"] = (
            capo_medialive.types.scte35_splice_insert_no_regional_blackout_behavior.serialize_json(
    ...
    if "web_delivery_allowed_flag" in value:
        ...
        out["webDeliveryAllowedFlag"] = (
            capo_medialive.types.scte35_splice_insert_web_delivery_allowed_behavior.serialize_json(
...
def deserialize_json(data: dict) -> Scte35SpliceInsert:
    ...
    if "noRegionalBlackoutFlag" in data:
        ...
        out["no_regional_blackout_flag"] = (
            capo_medialive.types.scte35_splice_insert_no_regional_blackout_behavior.deserialize_json(
    ...
    if "webDeliveryAllowedFlag" in data:
        ...
        out["web_delivery_allowed_flag"] = (
            capo_medialive.types.scte35_splice_insert_web_delivery_allowed_behavior.deserialize_json(
