"""Generated from Smithy shape ``com.amazonaws.medialive#StopMultiplexResponse``."""
...
class StopMultiplexResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: StopMultiplexResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> StopMultiplexResponse:
    out: StopMultiplexResponse = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
