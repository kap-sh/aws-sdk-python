...
if TYPE_CHECKING:
    ...
    import capo_medialive.types.__string_max256
...
class Esam(TypedDict, closed=True):
    ...
    pois_endpoint: NotRequired["capo_medialive.types.__string_max2048.__stringMax2048"]
    """The URL of the signal conditioner endpoint on the Placement Opportunity Information System (POIS). MediaLive sends SignalProcessingEvents here when SCTE-35 messages are read."""
    username: NotRequired["capo_medialive.types.__string.__string"]
    """Documentation update needed"""
    zone_identity: NotRequired["capo_medialive.types.__string_max256.__stringMax256"]
