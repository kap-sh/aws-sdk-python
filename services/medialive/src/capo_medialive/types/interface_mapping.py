"""Generated from Smithy shape ``com.amazonaws.medialive#InterfaceMapping``."""
...
class InterfaceMapping(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: InterfaceMapping) -> dict:
    out: dict = {}
