"""Generated from Smithy shape ``com.amazonaws.medialive#ListMultiplexAlertsRequest``."""
...
class ListMultiplexAlertsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListMultiplexAlertsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListMultiplexAlertsRequest:
    out: ListMultiplexAlertsRequest = {}  # type: ignore[typeddict-item]
    return out
