"""Generated from Smithy shape ``com.amazonaws.medialive#RestartChannelPipelinesResponse``."""
...
class RestartChannelPipelinesResponse(TypedDict, closed=True):
    ...
    maintenance_status: NotRequired["capo_medialive.types.__string.__string"]
...
# --- restJson1 ser/de ---
def serialize_json(value: RestartChannelPipelinesResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
    ...
    if "maintenance_status" in value:
        out["maintenanceStatus"] = value["maintenance_status"]
    if "name" in value:
        out["name"] = value["name"]
...
def deserialize_json(data: dict) -> RestartChannelPipelinesResponse:
    out: RestartChannelPipelinesResponse = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
    ...
    if "maintenanceStatus" in data:
        out["maintenance_status"] = data["maintenanceStatus"]
    if "name" in data:
        out["name"] = data["name"]
