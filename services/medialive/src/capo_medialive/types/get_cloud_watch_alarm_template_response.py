"""Generated from Smithy shape ``com.amazonaws.medialive#GetCloudWatchAlarmTemplateResponse``."""
...
class GetCloudWatchAlarmTemplateResponse(TypedDict, closed=True):
    arn: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: GetCloudWatchAlarmTemplateResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> GetCloudWatchAlarmTemplateResponse:
    out: GetCloudWatchAlarmTemplateResponse = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
