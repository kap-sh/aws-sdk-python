...
class InputAttachment(TypedDict, closed=True):
    automatic_input_failover_settings: NotRequired[
        "capo_medialive.types.automatic_input_failover_settings.AutomaticInputFailoverSettings"
    ]
    """User-specified settings for defining what the conditions are for declaring the input unhealthy and failing over to a different input."""
    input_attachment_name: NotRequired["capo_medialive.types.__string.__string"]
    """User-specified name for the attachment. This is required if the user wants to use this input in an input switch action."""
    input_id: NotRequired["capo_medialive.types.__string.__string"]
    """The ID of the input"""
    input_settings: NotRequired["capo_medialive.types.input_settings.InputSettings"]
...
def serialize_json(value: InputAttachment) -> dict:
    ...
    if "automatic_input_failover_settings" in value:
        ...
        out["automaticInputFailoverSettings"] = (
            capo_medialive.types.automatic_input_failover_settings.serialize_json(
    ...
    if "input_settings" in value:
        ...
        out["inputSettings"] = capo_medialive.types.input_settings.serialize_json(
...
def deserialize_json(data: dict) -> InputAttachment:
    ...
    if "automaticInputFailoverSettings" in data:
        ...
        out["automatic_input_failover_settings"] = (
            capo_medialive.types.automatic_input_failover_settings.deserialize_json(
