...
class FeatureActivations(TypedDict, closed=True):
    input_prepare_schedule_actions: NotRequired[
        "capo_medialive.types.feature_activations_input_prepare_schedule_actions.FeatureActivationsInputPrepareScheduleActions"
    ]
    ...
    output_static_image_overlay_schedule_actions: NotRequired[
        "capo_medialive.types.feature_activations_output_static_image_overlay_schedule_actions.FeatureActivationsOutputStaticImageOverlayScheduleActions"
    ]
...
def serialize_json(value: FeatureActivations) -> dict:
    ...
    if "input_prepare_schedule_actions" in value:
        ...
        out["inputPrepareScheduleActions"] = (
            capo_medialive.types.feature_activations_input_prepare_schedule_actions.serialize_json(
    ...
    if "output_static_image_overlay_schedule_actions" in value:
        ...
        out["outputStaticImageOverlayScheduleActions"] = (
            capo_medialive.types.feature_activations_output_static_image_overlay_schedule_actions.serialize_json(
...
def deserialize_json(data: dict) -> FeatureActivations:
    ...
    if "inputPrepareScheduleActions" in data:
        ...
        out["input_prepare_schedule_actions"] = (
            capo_medialive.types.feature_activations_input_prepare_schedule_actions.deserialize_json(
    ...
    if "outputStaticImageOverlayScheduleActions" in data:
        ...
        out["output_static_image_overlay_schedule_actions"] = (
            capo_medialive.types.feature_activations_output_static_image_overlay_schedule_actions.deserialize_json(
