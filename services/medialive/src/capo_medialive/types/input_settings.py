...
if TYPE_CHECKING:
    ...
    import capo_medialive.types.__integer_min32_max8191
...
class InputSettings(TypedDict, closed=True):
    audio_selectors: NotRequired[
        "capo_medialive.types.__list_of_audio_selector.__listOfAudioSelector"
    ]
    """Used to select the audio stream to decode for inputs that have multiple available."""
    caption_selectors: NotRequired[
        "capo_medialive.types.__list_of_caption_selector.__listOfCaptionSelector"
    ]
    """Used to select the caption input to use for inputs that have multiple available."""
    deblock_filter: NotRequired[
        "capo_medialive.types.input_deblock_filter.InputDeblockFilter"
    ]
    """Enable or disable the deblock filter when filtering."""
    denoise_filter: NotRequired[
        "capo_medialive.types.input_denoise_filter.InputDenoiseFilter"
    ]
    ...
    input_filter: NotRequired["capo_medialive.types.input_filter.InputFilter"]
    ...
    network_input_settings: NotRequired[
        "capo_medialive.types.network_input_settings.NetworkInputSettings"
    ]
    """Input settings."""
    scte35_pid: NotRequired[
        "capo_medialive.types.__integer_min32_max8191.__integerMin32Max8191"
    ]
    ...
    smpte2038_data_preference: NotRequired[
        "capo_medialive.types.smpte2038_data_preference.Smpte2038DataPreference"
    ]
    """Specifies whether to extract applicable ancillary data from a SMPTE-2038 source in this input. Applicable data types are captions, timecode, AFD, and SCTE-104 messages. - PREFER: Extract from SMPTE-2038 if present in this input, otherwise extract from another source (if any). - IGNORE: Never extract any ancillary data from SMPTE-2038."""
    source_end_behavior: NotRequired[
        "capo_medialive.types.input_source_end_behavior.InputSourceEndBehavior"
    ]
    """Loop input if it is a file. This allows a file input to be streamed indefinitely."""
    video_selector: NotRequired["capo_medialive.types.video_selector.VideoSelector"]
...
def serialize_json(value: InputSettings) -> dict:
    ...
    if "audio_selectors" in value:
        ...
        out["audioSelectors"] = (
            capo_medialive.types.__list_of_audio_selector.serialize_json(
    ...
    if "caption_selectors" in value:
        ...
        out["captionSelectors"] = (
            capo_medialive.types.__list_of_caption_selector.serialize_json(
    ...
    if "deblock_filter" in value:
        ...
        out["deblockFilter"] = capo_medialive.types.input_deblock_filter.serialize_json(
            value["deblock_filter"]
        )
    if "denoise_filter" in value:
        import capo_medialive.types.input_denoise_filter

        out["denoiseFilter"] = capo_medialive.types.input_denoise_filter.serialize_json(
    ...
    if "input_filter" in value:
        ...
        out["inputFilter"] = capo_medialive.types.input_filter.serialize_json(
            value["input_filter"]
        )
    if "network_input_settings" in value:
        ...
        out["networkInputSettings"] = (
            capo_medialive.types.network_input_settings.serialize_json(
    ...
    if "smpte2038_data_preference" in value:
        ...
        out["smpte2038DataPreference"] = (
            capo_medialive.types.smpte2038_data_preference.serialize_json(
    ...
    if "source_end_behavior" in value:
        ...
        out["sourceEndBehavior"] = (
            capo_medialive.types.input_source_end_behavior.serialize_json(
    ...
    if "video_selector" in value:
        ...
        out["videoSelector"] = capo_medialive.types.video_selector.serialize_json(
...
def deserialize_json(data: dict) -> InputSettings:
    ...
    if "audioSelectors" in data:
        ...
        out["audio_selectors"] = (
            capo_medialive.types.__list_of_audio_selector.deserialize_json(
                data["audioSelectors"]
            )
        )
    if "captionSelectors" in data:
        ...
        out["caption_selectors"] = (
            capo_medialive.types.__list_of_caption_selector.deserialize_json(
    ...
    if "deblockFilter" in data:
        ...
        out["deblock_filter"] = (
            capo_medialive.types.input_deblock_filter.deserialize_json(
                data["deblockFilter"]
            )
        )
    if "denoiseFilter" in data:
        ...
        out["denoise_filter"] = (
            capo_medialive.types.input_denoise_filter.deserialize_json(
                data["denoiseFilter"]
            )
        )
    ...
    if "networkInputSettings" in data:
        ...
        out["network_input_settings"] = (
            capo_medialive.types.network_input_settings.deserialize_json(
    ...
    if "smpte2038DataPreference" in data:
        ...
        out["smpte2038_data_preference"] = (
            capo_medialive.types.smpte2038_data_preference.deserialize_json(
    ...
    if "sourceEndBehavior" in data:
        ...
        out["source_end_behavior"] = (
            capo_medialive.types.input_source_end_behavior.deserialize_json(
