"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeNodeSummary``."""
...
class DescribeNodeSummary(TypedDict, closed=True):
    ...
    connection_state: NotRequired[
        "capo_medialive.types.node_connection_state.NodeConnectionState"
    ]
    ...
    instance_arn: NotRequired["capo_medialive.types.__string.__string"]
    """The EC2 ARN of the Instance associated with the Node."""
    managed_instance_id: NotRequired["capo_medialive.types.__string.__string"]
    ...
    state: NotRequired["capo_medialive.types.node_state.NodeState"]
    """The current state of the Node."""
    sdi_source_mappings: NotRequired[
        "capo_medialive.types.sdi_source_mappings.SdiSourceMappings"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeNodeSummary) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
    ...
    if "connection_state" in value:
        ...
        out["connectionState"] = (
            capo_medialive.types.node_connection_state.serialize_json(
    ...
    if "managed_instance_id" in value:
        out["managedInstanceId"] = value["managed_instance_id"]
    if "name" in value:
        out["name"] = value["name"]
    if "node_interface_mappings" in value:
        ...
        out["nodeInterfaceMappings"] = (
            capo_medialive.types.__list_of_node_interface_mapping.serialize_json(
    ...
    if "state" in value:
        ...
        out["state"] = capo_medialive.types.node_state.serialize_json(value["state"])
    if "sdi_source_mappings" in value:
        import capo_medialive.types.sdi_source_mappings

        out["sdiSourceMappings"] = (
            capo_medialive.types.sdi_source_mappings.serialize_json(
...
def deserialize_json(data: dict) -> DescribeNodeSummary:
    out: DescribeNodeSummary = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
    ...
    if "connectionState" in data:
        ...
        out["connection_state"] = (
            capo_medialive.types.node_connection_state.deserialize_json(
    ...
    if "managedInstanceId" in data:
        out["managed_instance_id"] = data["managedInstanceId"]
    if "name" in data:
        out["name"] = data["name"]
    if "nodeInterfaceMappings" in data:
        ...
        out["node_interface_mappings"] = (
            capo_medialive.types.__list_of_node_interface_mapping.deserialize_json(
    ...
    if "sdiSourceMappings" in data:
        ...
        out["sdi_source_mappings"] = (
            capo_medialive.types.sdi_source_mappings.deserialize_json(
