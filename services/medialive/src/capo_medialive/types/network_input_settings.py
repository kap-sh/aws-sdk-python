...
class NetworkInputSettings(TypedDict, closed=True):
    hls_input_settings: NotRequired[
        "capo_medialive.types.hls_input_settings.HlsInputSettings"
    ]
    """Specifies HLS input settings when the uri is for a HLS manifest."""
    server_validation: NotRequired[
        "capo_medialive.types.network_input_server_validation.NetworkInputServerValidation"
    ]
    """Check HTTPS server certificates. When set to checkCryptographyOnly, cryptography in the certificate will be checked, but not the server's name. Certain subdomains (notably S3 buckets that use dots in the bucket name) do not strictly match the corresponding certificate's wildcard pattern and would otherwise cause the event to error. This setting is ignored for protocols that do not use https."""
    multicast_input_settings: NotRequired[
        "capo_medialive.types.multicast_input_settings.MulticastInputSettings"
    ]
...
def serialize_json(value: NetworkInputSettings) -> dict:
    ...
    if "hls_input_settings" in value:
        ...
        out["hlsInputSettings"] = (
            capo_medialive.types.hls_input_settings.serialize_json(
    ...
    if "server_validation" in value:
        ...
        out["serverValidation"] = (
            capo_medialive.types.network_input_server_validation.serialize_json(
    ...
    if "multicast_input_settings" in value:
        ...
        out["multicastInputSettings"] = (
            capo_medialive.types.multicast_input_settings.serialize_json(
...
def deserialize_json(data: dict) -> NetworkInputSettings:
    ...
    if "hlsInputSettings" in data:
        ...
        out["hls_input_settings"] = (
            capo_medialive.types.hls_input_settings.deserialize_json(
    ...
    if "serverValidation" in data:
        ...
        out["server_validation"] = (
            capo_medialive.types.network_input_server_validation.deserialize_json(
    ...
    if "multicastInputSettings" in data:
        ...
        out["multicast_input_settings"] = (
            capo_medialive.types.multicast_input_settings.deserialize_json(
