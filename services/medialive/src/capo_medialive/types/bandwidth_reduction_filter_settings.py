...
class BandwidthReductionFilterSettings(TypedDict, closed=True):
    post_filter_sharpening: NotRequired[
        "capo_medialive.types.bandwidth_reduction_post_filter_sharpening.BandwidthReductionPostFilterSharpening"
    ]
    ...
    strength: NotRequired[
        "capo_medialive.types.bandwidth_reduction_filter_strength.BandwidthReductionFilterStrength"
    ]
...
def serialize_json(value: BandwidthReductionFilterSettings) -> dict:
    ...
    if "post_filter_sharpening" in value:
        ...
        out["postFilterSharpening"] = (
            capo_medialive.types.bandwidth_reduction_post_filter_sharpening.serialize_json(
    ...
    if "strength" in value:
        ...
        out["strength"] = (
            capo_medialive.types.bandwidth_reduction_filter_strength.serialize_json(
                value["strength"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> BandwidthReductionFilterSettings:
    ...
    if "postFilterSharpening" in data:
        ...
        out["post_filter_sharpening"] = (
            capo_medialive.types.bandwidth_reduction_post_filter_sharpening.deserialize_json(
    ...
    if "strength" in data:
        ...
        out["strength"] = (
            capo_medialive.types.bandwidth_reduction_filter_strength.deserialize_json(
                data["strength"]
            )
        )
    return out
