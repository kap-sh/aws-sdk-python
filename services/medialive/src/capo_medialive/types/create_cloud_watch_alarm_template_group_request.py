"""Generated from Smithy shape ``com.amazonaws.medialive#CreateCloudWatchAlarmTemplateGroupRequest``."""
...
class CreateCloudWatchAlarmTemplateGroupRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateCloudWatchAlarmTemplateGroupRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateCloudWatchAlarmTemplateGroupRequest:
    out: CreateCloudWatchAlarmTemplateGroupRequest = {}  # type: ignore[typeddict-item]
