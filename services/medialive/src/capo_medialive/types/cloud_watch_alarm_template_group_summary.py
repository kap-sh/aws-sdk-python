"""Generated from Smithy shape ``com.amazonaws.medialive#CloudWatchAlarmTemplateGroupSummary``."""
...
if TYPE_CHECKING:
    ...
    import capo_medialive.types.__string_pattern_arn_medialive_cloudwatch_alarm_template_group
    import capo_medialive.types.__timestamp_iso8601
    import capo_medialive.types.tag_map


class CloudWatchAlarmTemplateGroupSummary(TypedDict, closed=True):
    arn: NotRequired[
        "capo_medialive.types.__string_pattern_arn_medialive_cloudwatch_alarm_template_group.__stringPatternArnMedialiveCloudwatchAlarmTemplateGroup"
    ]
    ...
    template_count: NotRequired["capo_medialive.types.__integer.__integer"]
    """The number of templates in a group."""


# --- restJson1 ser/de ---
def serialize_json(value: CloudWatchAlarmTemplateGroupSummary) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CloudWatchAlarmTemplateGroupSummary:
    out: CloudWatchAlarmTemplateGroupSummary = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
