...
if TYPE_CHECKING:
    import capo_medialive.types.ip_pool_create_request

__listOfIpPoolCreateRequest: TypeAlias = list[
    "capo_medialive.types.ip_pool_create_request.IpPoolCreateRequest"
]
...
def serialize_json(value: __listOfIpPoolCreateRequest) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_medialive.types.ip_pool_create_request.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> __listOfIpPoolCreateRequest:
    ...
    for item in data:
        out.append(capo_medialive.types.ip_pool_create_request.deserialize_json(item))
    return out
