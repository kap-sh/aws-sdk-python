"""Generated from Smithy shape ``com.amazonaws.medialive#CreateNodeResponse``."""
...
class CreateNodeResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateNodeResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateNodeResponse:
    out: CreateNodeResponse = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
