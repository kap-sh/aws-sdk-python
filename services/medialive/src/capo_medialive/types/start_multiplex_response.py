"""Generated from Smithy shape ``com.amazonaws.medialive#StartMultiplexResponse``."""
...
class StartMultiplexResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: StartMultiplexResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
