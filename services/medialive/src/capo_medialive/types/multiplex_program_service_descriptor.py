...
class MultiplexProgramServiceDescriptor(TypedDict, closed=True):
    provider_name: NotRequired["capo_medialive.types.__string_max256.__stringMax256"]
    """Name of the provider."""
    service_name: NotRequired["capo_medialive.types.__string_max256.__stringMax256"]
    """Name of the service."""
