"""Generated from Smithy shape ``com.amazonaws.medialive#UpdateCloudWatchAlarmTemplateGroupResponse``."""
...
class UpdateCloudWatchAlarmTemplateGroupResponse(TypedDict, closed=True):
    arn: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateCloudWatchAlarmTemplateGroupResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> UpdateCloudWatchAlarmTemplateGroupResponse:
    out: UpdateCloudWatchAlarmTemplateGroupResponse = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
