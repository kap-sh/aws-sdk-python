...
class DescribeLinkedChannelSettings(TypedDict, closed=True):
    follower_channel_settings: NotRequired[
        "capo_medialive.types.describe_follower_channel_settings.DescribeFollowerChannelSettings"
    ]
    primary_channel_settings: NotRequired[
        "capo_medialive.types.describe_primary_channel_settings.DescribePrimaryChannelSettings"
    ]
...
def serialize_json(value: DescribeLinkedChannelSettings) -> dict:
    ...
    if "follower_channel_settings" in value:
        ...
        out["followerChannelSettings"] = (
            capo_medialive.types.describe_follower_channel_settings.serialize_json(
    ...
    if "primary_channel_settings" in value:
        ...
        out["primaryChannelSettings"] = (
            capo_medialive.types.describe_primary_channel_settings.serialize_json(
...
def deserialize_json(data: dict) -> DescribeLinkedChannelSettings:
    ...
    if "followerChannelSettings" in data:
        ...
        out["follower_channel_settings"] = (
            capo_medialive.types.describe_follower_channel_settings.deserialize_json(
    ...
    if "primaryChannelSettings" in data:
        ...
        out["primary_channel_settings"] = (
            capo_medialive.types.describe_primary_channel_settings.deserialize_json(
