...
from capo_medialive._services._aws_config import aaws_config
...
class AsyncMediaLiveClientConfig(TypedDict, total=False, closed=True):
...
class AsyncMediaLiveClient:
    ...
    async def accept_input_device_transfer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.accept_input_device_transfer_request.AcceptInputDeviceTransferRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.accept_input_device_transfer_response.AcceptInputDeviceTransferResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.accept_input_device_transfer.async_accept_input_device_transfer(
    ...
    async def batch_delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.batch_delete_request.BatchDeleteRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.batch_delete_response.BatchDeleteResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.batch_delete.async_batch_delete(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_start(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.batch_start_request.BatchStartRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.batch_start_response.BatchStartResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.batch_start.async_batch_start(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_stop(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.batch_stop_request.BatchStopRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.batch_stop_response.BatchStopResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.batch_stop.async_batch_stop(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_update_schedule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.batch_update_schedule_request.BatchUpdateScheduleRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.batch_update_schedule_response.BatchUpdateScheduleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.batch_update_schedule.async_batch_update_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_input_device_transfer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.cancel_input_device_transfer_request.CancelInputDeviceTransferRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.cancel_input_device_transfer_response.CancelInputDeviceTransferResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.cancel_input_device_transfer.async_cancel_input_device_transfer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def claim_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.claim_device_request.ClaimDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.claim_device_response.ClaimDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.claim_device.async_claim_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_channel_request.CreateChannelRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_channel_response.CreateChannelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_channel.async_create_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_channel_placement_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_channel_placement_group_request.CreateChannelPlacementGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_channel_placement_group_response.CreateChannelPlacementGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_channel_placement_group.async_create_channel_placement_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_cloud_watch_alarm_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_cloud_watch_alarm_template_request.CreateCloudWatchAlarmTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_cloud_watch_alarm_template_response.CreateCloudWatchAlarmTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_cloud_watch_alarm_template.async_create_cloud_watch_alarm_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_cloud_watch_alarm_template_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_cloud_watch_alarm_template_group_request.CreateCloudWatchAlarmTemplateGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_cloud_watch_alarm_template_group_response.CreateCloudWatchAlarmTemplateGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_cloud_watch_alarm_template_group.async_create_cloud_watch_alarm_template_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_cluster_request.CreateClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_cluster_response.CreateClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_cluster.async_create_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_event_bridge_rule_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_event_bridge_rule_template_request.CreateEventBridgeRuleTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_event_bridge_rule_template_response.CreateEventBridgeRuleTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_event_bridge_rule_template.async_create_event_bridge_rule_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_event_bridge_rule_template_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_event_bridge_rule_template_group_request.CreateEventBridgeRuleTemplateGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_event_bridge_rule_template_group_response.CreateEventBridgeRuleTemplateGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_event_bridge_rule_template_group.async_create_event_bridge_rule_template_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_input(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_input_request.CreateInputRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_input_response.CreateInputResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_input.async_create_input(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_input_security_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_input_security_group_request.CreateInputSecurityGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_input_security_group_response.CreateInputSecurityGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_input_security_group.async_create_input_security_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_multiplex(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_multiplex_request.CreateMultiplexRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_multiplex_response.CreateMultiplexResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_multiplex.async_create_multiplex(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_multiplex_program(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_multiplex_program_request.CreateMultiplexProgramRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_multiplex_program_response.CreateMultiplexProgramResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_multiplex_program.async_create_multiplex_program(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_network(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_network_request.CreateNetworkRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_network_response.CreateNetworkResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_network.async_create_network(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_node(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_node_request.CreateNodeRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_node_response.CreateNodeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_node.async_create_node(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_node_registration_script(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_node_registration_script_request.CreateNodeRegistrationScriptRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_node_registration_script_response.CreateNodeRegistrationScriptResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_node_registration_script.async_create_node_registration_script(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_partner_input(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_partner_input_request.CreatePartnerInputRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_partner_input_response.CreatePartnerInputResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_partner_input.async_create_partner_input(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_sdi_source(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_sdi_source_request.CreateSdiSourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_sdi_source_response.CreateSdiSourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_sdi_source.async_create_sdi_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_signal_map(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_signal_map_request.CreateSignalMapRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.create_signal_map_response.CreateSignalMapResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_signal_map.async_create_signal_map(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.create_tags_request.CreateTagsRequest]",
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.create_tags.async_create_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_channel_request.DeleteChannelRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.delete_channel_response.DeleteChannelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_channel.async_delete_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_channel_placement_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_channel_placement_group_request.DeleteChannelPlacementGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.delete_channel_placement_group_response.DeleteChannelPlacementGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_channel_placement_group.async_delete_channel_placement_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_cloud_watch_alarm_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_cloud_watch_alarm_template_request.DeleteCloudWatchAlarmTemplateRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_cloud_watch_alarm_template.async_delete_cloud_watch_alarm_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_cloud_watch_alarm_template_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_cloud_watch_alarm_template_group_request.DeleteCloudWatchAlarmTemplateGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_cloud_watch_alarm_template_group.async_delete_cloud_watch_alarm_template_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_cluster_request.DeleteClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.delete_cluster_response.DeleteClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_cluster.async_delete_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_event_bridge_rule_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_event_bridge_rule_template_request.DeleteEventBridgeRuleTemplateRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_event_bridge_rule_template.async_delete_event_bridge_rule_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_event_bridge_rule_template_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_event_bridge_rule_template_group_request.DeleteEventBridgeRuleTemplateGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_event_bridge_rule_template_group.async_delete_event_bridge_rule_template_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_input(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_input_request.DeleteInputRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.delete_input_response.DeleteInputResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_input.async_delete_input(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_input_security_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_input_security_group_request.DeleteInputSecurityGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.delete_input_security_group_response.DeleteInputSecurityGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_input_security_group.async_delete_input_security_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_multiplex(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_multiplex_request.DeleteMultiplexRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.delete_multiplex_response.DeleteMultiplexResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_multiplex.async_delete_multiplex(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_multiplex_program(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_multiplex_program_request.DeleteMultiplexProgramRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.delete_multiplex_program_response.DeleteMultiplexProgramResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_multiplex_program.async_delete_multiplex_program(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_network(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_network_request.DeleteNetworkRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.delete_network_response.DeleteNetworkResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_network.async_delete_network(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_node(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_node_request.DeleteNodeRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.delete_node_response.DeleteNodeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_node.async_delete_node(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_reservation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_reservation_request.DeleteReservationRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.delete_reservation_response.DeleteReservationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_reservation.async_delete_reservation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_schedule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_schedule_request.DeleteScheduleRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.delete_schedule_response.DeleteScheduleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_schedule.async_delete_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_sdi_source(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_sdi_source_request.DeleteSdiSourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.delete_sdi_source_response.DeleteSdiSourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_sdi_source.async_delete_sdi_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_signal_map(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_signal_map_request.DeleteSignalMapRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_signal_map.async_delete_signal_map(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.delete_tags_request.DeleteTagsRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.delete_tags.async_delete_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_configuration(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_account_configuration_request.DescribeAccountConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_account_configuration_response.DescribeAccountConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_account_configuration.async_describe_account_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_channel_request.DescribeChannelRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_channel_response.DescribeChannelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_channel.async_describe_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_channel_placement_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_channel_placement_group_request.DescribeChannelPlacementGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_channel_placement_group_response.DescribeChannelPlacementGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_channel_placement_group.async_describe_channel_placement_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_cluster_request.DescribeClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_cluster_response.DescribeClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_cluster.async_describe_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_input(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_input_request.DescribeInputRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_input_response.DescribeInputResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_input.async_describe_input(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_input_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_input_device_request.DescribeInputDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_input_device_response.DescribeInputDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_input_device.async_describe_input_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_input_device_thumbnail(
        ...
        *,
        config_overrides: Optional[AsyncMediaLiveClientConfig] = None,
    ) -> "AsyncGenerator[capo_medialive.types.describe_input_device_thumbnail_response.DescribeInputDeviceThumbnailResponse]":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_input_device_thumbnail_request.DescribeInputDeviceThumbnailRequest]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_input_device_thumbnail.async_describe_input_device_thumbnail(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_input_security_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_input_security_group_request.DescribeInputSecurityGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_input_security_group_response.DescribeInputSecurityGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_input_security_group.async_describe_input_security_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_multiplex(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_multiplex_request.DescribeMultiplexRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_multiplex_response.DescribeMultiplexResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_multiplex.async_describe_multiplex(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_multiplex_program(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_multiplex_program_request.DescribeMultiplexProgramRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_multiplex_program_response.DescribeMultiplexProgramResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_multiplex_program.async_describe_multiplex_program(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_network(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_network_request.DescribeNetworkRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_network_response.DescribeNetworkResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_network.async_describe_network(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_node(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_node_request.DescribeNodeRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_node_response.DescribeNodeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_node.async_describe_node(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_offering(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_offering_request.DescribeOfferingRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_offering_response.DescribeOfferingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_offering.async_describe_offering(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_reservation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_reservation_request.DescribeReservationRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_reservation_response.DescribeReservationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_reservation.async_describe_reservation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_schedule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_schedule_request.DescribeScheduleRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_schedule_response.DescribeScheduleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_schedule.async_describe_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_schedule(
        ...
        *,
        ...
        max_results: Optional["capo_medialive.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.schedule_action.ScheduleAction]":
        _token = next_token
        while True:
    ...
    async def describe_sdi_source(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_sdi_source_request.DescribeSdiSourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_sdi_source_response.DescribeSdiSourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_sdi_source.async_describe_sdi_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_thumbnails(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.describe_thumbnails_request.DescribeThumbnailsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.describe_thumbnails_response.DescribeThumbnailsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.describe_thumbnails.async_describe_thumbnails(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_cloud_watch_alarm_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.get_cloud_watch_alarm_template_request.GetCloudWatchAlarmTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.get_cloud_watch_alarm_template_response.GetCloudWatchAlarmTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.get_cloud_watch_alarm_template.async_get_cloud_watch_alarm_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_cloud_watch_alarm_template_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.get_cloud_watch_alarm_template_group_request.GetCloudWatchAlarmTemplateGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.get_cloud_watch_alarm_template_group_response.GetCloudWatchAlarmTemplateGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.get_cloud_watch_alarm_template_group.async_get_cloud_watch_alarm_template_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_event_bridge_rule_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.get_event_bridge_rule_template_request.GetEventBridgeRuleTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.get_event_bridge_rule_template_response.GetEventBridgeRuleTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.get_event_bridge_rule_template.async_get_event_bridge_rule_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_event_bridge_rule_template_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.get_event_bridge_rule_template_group_request.GetEventBridgeRuleTemplateGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.get_event_bridge_rule_template_group_response.GetEventBridgeRuleTemplateGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.get_event_bridge_rule_template_group.async_get_event_bridge_rule_template_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_signal_map(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.get_signal_map_request.GetSignalMapRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.get_signal_map_response.GetSignalMapResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.get_signal_map.async_get_signal_map(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_alerts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_alerts_request.ListAlertsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_alerts_response.ListAlertsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_alerts.async_list_alerts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_alerts(
        ...
        *,
        ...
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
        state_filter: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.channel_alert.ChannelAlert]":
        _token = next_token
        while True:
    ...
    async def list_channel_placement_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_channel_placement_groups_request.ListChannelPlacementGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_channel_placement_groups_response.ListChannelPlacementGroupsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_channel_placement_groups.async_list_channel_placement_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_channel_placement_groups(
        ...
        *,
        ...
        max_results: Optional["capo_medialive.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.describe_channel_placement_group_summary.DescribeChannelPlacementGroupSummary]":
        _token = next_token
        while True:
    ...
    async def list_channels(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_channels_request.ListChannelsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_channels_response.ListChannelsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_channels.async_list_channels(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_channels(
        ...
        *,
        ...
        max_results: Optional["capo_medialive.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.channel_summary.ChannelSummary]":
        _token = next_token
        while True:
    ...
    async def list_cloud_watch_alarm_template_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_cloud_watch_alarm_template_groups_request.ListCloudWatchAlarmTemplateGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_cloud_watch_alarm_template_groups_response.ListCloudWatchAlarmTemplateGroupsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_cloud_watch_alarm_template_groups.async_list_cloud_watch_alarm_template_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_medialive.types.cloud_watch_alarm_template_group_summary.CloudWatchAlarmTemplateGroupSummary]":
        _token = next_token
        while True:
    ...
    async def list_cloud_watch_alarm_templates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_cloud_watch_alarm_templates_request.ListCloudWatchAlarmTemplatesRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_cloud_watch_alarm_templates_response.ListCloudWatchAlarmTemplatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_cloud_watch_alarm_templates.async_list_cloud_watch_alarm_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_medialive.types.cloud_watch_alarm_template_summary.CloudWatchAlarmTemplateSummary]":
        _token = next_token
        while True:
    ...
    async def list_cluster_alerts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_cluster_alerts_request.ListClusterAlertsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_cluster_alerts_response.ListClusterAlertsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_cluster_alerts.async_list_cluster_alerts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_cluster_alerts(
        ...
        *,
        ...
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
        state_filter: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.cluster_alert.ClusterAlert]":
        _token = next_token
        while True:
    ...
    async def list_clusters(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_clusters_request.ListClustersRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_clusters_response.ListClustersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_clusters.async_list_clusters(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_clusters(
        ...
        *,
        ...
        max_results: Optional["capo_medialive.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.describe_cluster_summary.DescribeClusterSummary]":
        _token = next_token
        while True:
    ...
    async def list_event_bridge_rule_template_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_event_bridge_rule_template_groups_request.ListEventBridgeRuleTemplateGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_event_bridge_rule_template_groups_response.ListEventBridgeRuleTemplateGroupsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_event_bridge_rule_template_groups.async_list_event_bridge_rule_template_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_medialive.types.event_bridge_rule_template_group_summary.EventBridgeRuleTemplateGroupSummary]":
        _token = next_token
        while True:
    ...
    async def list_event_bridge_rule_templates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_event_bridge_rule_templates_request.ListEventBridgeRuleTemplatesRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_event_bridge_rule_templates_response.ListEventBridgeRuleTemplatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_event_bridge_rule_templates.async_list_event_bridge_rule_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_medialive.types.event_bridge_rule_template_summary.EventBridgeRuleTemplateSummary]":
        _token = next_token
        while True:
    ...
    async def list_input_devices(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_input_devices_request.ListInputDevicesRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_input_devices_response.ListInputDevicesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_input_devices.async_list_input_devices(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_input_devices(
        ...
        *,
        ...
        max_results: Optional["capo_medialive.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.input_device_summary.InputDeviceSummary]":
        _token = next_token
        while True:
    ...
    async def list_input_device_transfers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_input_device_transfers_request.ListInputDeviceTransfersRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_input_device_transfers_response.ListInputDeviceTransfersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_input_device_transfers.async_list_input_device_transfers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_input_device_transfers(
        ...
        *,
        ...
        max_results: Optional["capo_medialive.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.transferring_input_device_summary.TransferringInputDeviceSummary]":
        _token = next_token
        while True:
    ...
    async def list_inputs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_inputs_request.ListInputsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_inputs_response.ListInputsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_inputs.async_list_inputs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_inputs(
        ...
        *,
        ...
        max_results: Optional["capo_medialive.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.input.Input]":
        _token = next_token
        while True:
    ...
    async def list_input_security_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_input_security_groups_request.ListInputSecurityGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_input_security_groups_response.ListInputSecurityGroupsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_input_security_groups.async_list_input_security_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_input_security_groups(
        ...
        *,
        ...
        max_results: Optional["capo_medialive.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.input_security_group.InputSecurityGroup]":
        _token = next_token
        while True:
    ...
    async def list_multiplex_alerts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_multiplex_alerts_request.ListMultiplexAlertsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_multiplex_alerts_response.ListMultiplexAlertsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_multiplex_alerts.async_list_multiplex_alerts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_multiplex_alerts(
        ...
        *,
        ...
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
        state_filter: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.multiplex_alert.MultiplexAlert]":
        _token = next_token
        while True:
    ...
    async def list_multiplexes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_multiplexes_request.ListMultiplexesRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_multiplexes_response.ListMultiplexesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_multiplexes.async_list_multiplexes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_multiplexes(
        ...
        *,
        ...
        max_results: Optional["capo_medialive.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.multiplex_summary.MultiplexSummary]":
        _token = next_token
        while True:
    ...
    async def list_multiplex_programs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_multiplex_programs_request.ListMultiplexProgramsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_multiplex_programs_response.ListMultiplexProgramsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_multiplex_programs.async_list_multiplex_programs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_multiplex_programs(
        ...
        *,
        ...
        max_results: Optional["capo_medialive.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.multiplex_program_summary.MultiplexProgramSummary]":
        _token = next_token
        while True:
    ...
    async def list_networks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_networks_request.ListNetworksRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_networks_response.ListNetworksResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_networks.async_list_networks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_networks(
        ...
        *,
        ...
        max_results: Optional["capo_medialive.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.describe_network_summary.DescribeNetworkSummary]":
        _token = next_token
        while True:
    ...
    async def list_nodes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_nodes_request.ListNodesRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_nodes_response.ListNodesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_nodes.async_list_nodes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_nodes(
        ...
        *,
        ...
        "AsyncIterator[capo_medialive.types.describe_node_summary.DescribeNodeSummary]"
    ):
        _token = next_token
        while True:
    ...
    async def list_offerings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_offerings_request.ListOfferingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_offerings_response.ListOfferingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_offerings.async_list_offerings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_offerings(
        ...
        *,
        ...
        special_feature: Optional["capo_medialive.types.__string.__string"] = None,
        video_quality: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.offering.Offering]":
        _token = next_token
        while True:
    ...
    async def list_reservations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_reservations_request.ListReservationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_reservations_response.ListReservationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_reservations.async_list_reservations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_reservations(
        ...
        *,
        ...
        special_feature: Optional["capo_medialive.types.__string.__string"] = None,
        video_quality: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.reservation.Reservation]":
        _token = next_token
        while True:
    ...
    async def list_sdi_sources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_sdi_sources_request.ListSdiSourcesRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_sdi_sources_response.ListSdiSourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_sdi_sources.async_list_sdi_sources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_sdi_sources(
        ...
        *,
        ...
        max_results: Optional["capo_medialive.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.sdi_source_summary.SdiSourceSummary]":
        _token = next_token
        while True:
    ...
    async def list_signal_maps(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_signal_maps_request.ListSignalMapsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_signal_maps_response.ListSignalMapsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_signal_maps.async_list_signal_maps(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_signal_maps(
        ...
        *,
        ...
        max_results: Optional["capo_medialive.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_medialive.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_medialive.types.signal_map_summary.SignalMapSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_versions(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.list_versions_request.ListVersionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.list_versions_response.ListVersionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.list_versions.async_list_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def purchase_offering(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.purchase_offering_request.PurchaseOfferingRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.purchase_offering_response.PurchaseOfferingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.purchase_offering.async_purchase_offering(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reboot_input_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.reboot_input_device_request.RebootInputDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.reboot_input_device_response.RebootInputDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.reboot_input_device.async_reboot_input_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reject_input_device_transfer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.reject_input_device_transfer_request.RejectInputDeviceTransferRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.reject_input_device_transfer_response.RejectInputDeviceTransferResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.reject_input_device_transfer.async_reject_input_device_transfer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def restart_channel_pipelines(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.restart_channel_pipelines_request.RestartChannelPipelinesRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.restart_channel_pipelines_response.RestartChannelPipelinesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.restart_channel_pipelines.async_restart_channel_pipelines(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.start_channel_request.StartChannelRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.start_channel_response.StartChannelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.start_channel.async_start_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_delete_monitor_deployment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.start_delete_monitor_deployment_request.StartDeleteMonitorDeploymentRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.start_delete_monitor_deployment_response.StartDeleteMonitorDeploymentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.start_delete_monitor_deployment.async_start_delete_monitor_deployment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_input_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.start_input_device_request.StartInputDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.start_input_device_response.StartInputDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.start_input_device.async_start_input_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_input_device_maintenance_window(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.start_input_device_maintenance_window_request.StartInputDeviceMaintenanceWindowRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.start_input_device_maintenance_window_response.StartInputDeviceMaintenanceWindowResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.start_input_device_maintenance_window.async_start_input_device_maintenance_window(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_monitor_deployment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.start_monitor_deployment_request.StartMonitorDeploymentRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.start_monitor_deployment_response.StartMonitorDeploymentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.start_monitor_deployment.async_start_monitor_deployment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_multiplex(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.start_multiplex_request.StartMultiplexRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.start_multiplex_response.StartMultiplexResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.start_multiplex.async_start_multiplex(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_update_signal_map(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.start_update_signal_map_request.StartUpdateSignalMapRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.start_update_signal_map_response.StartUpdateSignalMapResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.start_update_signal_map.async_start_update_signal_map(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.stop_channel_request.StopChannelRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.stop_channel_response.StopChannelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.stop_channel.async_stop_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_input_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.stop_input_device_request.StopInputDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.stop_input_device_response.StopInputDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.stop_input_device.async_stop_input_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_multiplex(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.stop_multiplex_request.StopMultiplexRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.stop_multiplex_response.StopMultiplexResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.stop_multiplex.async_stop_multiplex(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def transfer_input_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.transfer_input_device_request.TransferInputDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.transfer_input_device_response.TransferInputDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.transfer_input_device.async_transfer_input_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_account_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_account_configuration_request.UpdateAccountConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_account_configuration_response.UpdateAccountConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_account_configuration.async_update_account_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_channel_request.UpdateChannelRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_channel_response.UpdateChannelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_channel.async_update_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_channel_class(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_channel_class_request.UpdateChannelClassRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_channel_class_response.UpdateChannelClassResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_channel_class.async_update_channel_class(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_channel_placement_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_channel_placement_group_request.UpdateChannelPlacementGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_channel_placement_group_response.UpdateChannelPlacementGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_channel_placement_group.async_update_channel_placement_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_cloud_watch_alarm_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_cloud_watch_alarm_template_request.UpdateCloudWatchAlarmTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_cloud_watch_alarm_template_response.UpdateCloudWatchAlarmTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_cloud_watch_alarm_template.async_update_cloud_watch_alarm_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_cloud_watch_alarm_template_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_cloud_watch_alarm_template_group_request.UpdateCloudWatchAlarmTemplateGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_cloud_watch_alarm_template_group_response.UpdateCloudWatchAlarmTemplateGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_cloud_watch_alarm_template_group.async_update_cloud_watch_alarm_template_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_cluster_request.UpdateClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_cluster_response.UpdateClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_cluster.async_update_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_event_bridge_rule_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_event_bridge_rule_template_request.UpdateEventBridgeRuleTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_event_bridge_rule_template_response.UpdateEventBridgeRuleTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_event_bridge_rule_template.async_update_event_bridge_rule_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_event_bridge_rule_template_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_event_bridge_rule_template_group_request.UpdateEventBridgeRuleTemplateGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_event_bridge_rule_template_group_response.UpdateEventBridgeRuleTemplateGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_event_bridge_rule_template_group.async_update_event_bridge_rule_template_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_input(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_input_request.UpdateInputRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_input_response.UpdateInputResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_input.async_update_input(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_input_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_input_device_request.UpdateInputDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_input_device_response.UpdateInputDeviceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_input_device.async_update_input_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_input_security_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_input_security_group_request.UpdateInputSecurityGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_input_security_group_response.UpdateInputSecurityGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_input_security_group.async_update_input_security_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_multiplex(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_multiplex_request.UpdateMultiplexRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_multiplex_response.UpdateMultiplexResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_multiplex.async_update_multiplex(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_multiplex_program(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_multiplex_program_request.UpdateMultiplexProgramRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_multiplex_program_response.UpdateMultiplexProgramResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_multiplex_program.async_update_multiplex_program(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_network(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_network_request.UpdateNetworkRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_network_response.UpdateNetworkResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_network.async_update_network(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_node(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_node_request.UpdateNodeRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_node_response.UpdateNodeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_node.async_update_node(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_node_state(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_node_state_request.UpdateNodeStateRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_node_state_response.UpdateNodeStateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_node_state.async_update_node_state(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_reservation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_reservation_request.UpdateReservationRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_reservation_response.UpdateReservationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_reservation.async_update_reservation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_sdi_source(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medialive.types.update_sdi_source_request.UpdateSdiSourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medialive.types.update_sdi_source_response.UpdateSdiSourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medialive._operations.media_live.update_sdi_source.async_update_sdi_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
