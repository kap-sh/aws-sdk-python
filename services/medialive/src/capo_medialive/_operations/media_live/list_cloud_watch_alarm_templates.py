"""Generated from Smithy shape ``com.amazonaws.medialive#ListCloudWatchAlarmTemplates``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_cloud_watch_alarm_templates_response.ListCloudWatchAlarmTemplatesResponse = capo_medialive.types.list_cloud_watch_alarm_templates_response.deserialize_json(
...
async def async_list_cloud_watch_alarm_templates(
