"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteReservation``."""
...
def handle_response(
    ...
    out: capo_medialive.types.delete_reservation_response.DeleteReservationResponse = (
        capo_medialive.types.delete_reservation_response.deserialize_json(
