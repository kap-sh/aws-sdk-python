"""Generated from Smithy shape ``com.amazonaws.medialive#ListSdiSources``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_sdi_sources_response.ListSdiSourcesResponse = (
        capo_medialive.types.list_sdi_sources_response.deserialize_json(
...
async def async_list_sdi_sources(
