"""Generated from Smithy shape ``com.amazonaws.medialive#ListInputSecurityGroups``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_input_security_groups_response.ListInputSecurityGroupsResponse = capo_medialive.types.list_input_security_groups_response.deserialize_json(
...
async def async_list_input_security_groups(
