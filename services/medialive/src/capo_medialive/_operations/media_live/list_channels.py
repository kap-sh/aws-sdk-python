"""Generated from Smithy shape ``com.amazonaws.medialive#ListChannels``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_channels_response.ListChannelsResponse = (
        capo_medialive.types.list_channels_response.deserialize_json(
...
def list_channels(
    ...
    capo_medialive.types.list_channels_response.ListChannelsResponse, zapros.Response
]:
