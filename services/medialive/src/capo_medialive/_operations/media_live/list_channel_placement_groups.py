...
def handle_response(
    ...
    out: capo_medialive.types.list_channel_placement_groups_response.ListChannelPlacementGroupsResponse = capo_medialive.types.list_channel_placement_groups_response.deserialize_json(
