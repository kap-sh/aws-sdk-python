"""Generated from Smithy shape ``com.amazonaws.medialive#ListClusterAlerts``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_cluster_alerts_response.ListClusterAlertsResponse = (
        capo_medialive.types.list_cluster_alerts_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prod/clusters/{ClusterId}/alerts"
...
async def async_list_cluster_alerts(
