"""Generated from Smithy shape ``com.amazonaws.medialive#StartChannel``."""
...
def handle_response(
    ...
    out: capo_medialive.types.start_channel_response.StartChannelResponse = (
        capo_medialive.types.start_channel_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prod/channels/{ChannelId}/start"
...
def start_channel(
    ...
    capo_medialive.types.start_channel_response.StartChannelResponse, zapros.Response
]:
