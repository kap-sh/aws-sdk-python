...
def handle_response(
    ...
    out: capo_medialive.types.update_input_device_response.UpdateInputDeviceResponse = (
        capo_medialive.types.update_input_device_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.update_input_device_request.serialize_json(input_)
    ).encode()
