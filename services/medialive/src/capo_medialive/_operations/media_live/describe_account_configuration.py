"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeAccountConfiguration``."""
...
def handle_response(
    ...
    out: capo_medialive.types.describe_account_configuration_response.DescribeAccountConfigurationResponse = capo_medialive.types.describe_account_configuration_response.deserialize_json(
...
async def async_describe_account_configuration(
