"""Generated from Smithy shape ``com.amazonaws.medialive#ListEventBridgeRuleTemplateGroups``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_event_bridge_rule_template_groups_response.ListEventBridgeRuleTemplateGroupsResponse = capo_medialive.types.list_event_bridge_rule_template_groups_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prod/eventbridge-rule-template-groups"
    params: dict[str, str] = {}
...
async def async_list_event_bridge_rule_template_groups(
