...
def handle_response(
    ...
    out: capo_medialive.types.restart_channel_pipelines_response.RestartChannelPipelinesResponse = capo_medialive.types.restart_channel_pipelines_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.restart_channel_pipelines_request.serialize_json(input_)
    ).encode()
