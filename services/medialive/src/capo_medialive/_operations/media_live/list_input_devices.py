...
import capo_medialive.types.__list_of_input_device_summary
...
def handle_response(
    ...
    out: capo_medialive.types.list_input_devices_response.ListInputDevicesResponse = (
        capo_medialive.types.list_input_devices_response.deserialize_json(
