"""Generated from Smithy shape ``com.amazonaws.medialive#ListVersions``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_versions_response.ListVersionsResponse = (
        capo_medialive.types.list_versions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prod/versions"
    params: dict[str, str] = {}
...
def list_versions(
    ...
    capo_medialive.types.list_versions_response.ListVersionsResponse, zapros.Response
]:
