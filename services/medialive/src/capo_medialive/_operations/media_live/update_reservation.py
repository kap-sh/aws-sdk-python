"""Generated from Smithy shape ``com.amazonaws.medialive#UpdateReservation``."""
...
def handle_response(
    ...
    out: capo_medialive.types.update_reservation_response.UpdateReservationResponse = (
        capo_medialive.types.update_reservation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.update_reservation_request.serialize_json(input_)
    ).encode()
