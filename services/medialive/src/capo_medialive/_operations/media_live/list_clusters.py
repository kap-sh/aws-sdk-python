"""Generated from Smithy shape ``com.amazonaws.medialive#ListClusters``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_clusters_response.ListClustersResponse = (
        capo_medialive.types.list_clusters_response.deserialize_json(
...
def list_clusters(
    ...
    capo_medialive.types.list_clusters_response.ListClustersResponse, zapros.Response
]:
