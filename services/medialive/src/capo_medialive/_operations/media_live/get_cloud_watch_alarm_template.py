"""Generated from Smithy shape ``com.amazonaws.medialive#GetCloudWatchAlarmTemplate``."""
...
def handle_response(
    ...
    out: capo_medialive.types.get_cloud_watch_alarm_template_response.GetCloudWatchAlarmTemplateResponse = capo_medialive.types.get_cloud_watch_alarm_template_response.deserialize_json(
...
async def async_get_cloud_watch_alarm_template(
