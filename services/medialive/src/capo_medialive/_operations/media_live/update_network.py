...
def handle_response(
    ...
    out: capo_medialive.types.update_network_response.UpdateNetworkResponse = (
        capo_medialive.types.update_network_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.update_network_request.serialize_json(input_)
    ).encode()
...
def update_network(
    ...
    capo_medialive.types.update_network_response.UpdateNetworkResponse, zapros.Response
]:
