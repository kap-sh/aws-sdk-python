...
import capo_medialive.types.__list_of_channel_alert
...
def handle_response(
    ...
    out: capo_medialive.types.list_alerts_response.ListAlertsResponse = (
        capo_medialive.types.list_alerts_response.deserialize_json(
...
def list_alerts(
    ...
    capo_medialive.types.list_alerts_response.ListAlertsResponse, zapros.Response
]:
