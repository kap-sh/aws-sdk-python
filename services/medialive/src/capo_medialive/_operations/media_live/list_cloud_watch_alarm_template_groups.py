...
import capo_medialive.types.__list_of_cloud_watch_alarm_template_group_summary
...
def handle_response(
    ...
    out: capo_medialive.types.list_cloud_watch_alarm_template_groups_response.ListCloudWatchAlarmTemplateGroupsResponse = capo_medialive.types.list_cloud_watch_alarm_template_groups_response.deserialize_json(
