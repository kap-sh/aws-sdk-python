...
def handle_response(
    ...
    out: capo_medialive.types.batch_start_response.BatchStartResponse = (
        capo_medialive.types.batch_start_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.batch_start_request.serialize_json(input_)
    ).encode()
...
def batch_start(
    ...
    capo_medialive.types.batch_start_response.BatchStartResponse, zapros.Response
]:
