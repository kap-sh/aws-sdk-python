...
def handle_response(
    ...
    out: capo_medialive.types.list_inputs_response.ListInputsResponse = (
        capo_medialive.types.list_inputs_response.deserialize_json(
...
def list_inputs(
    ...
    capo_medialive.types.list_inputs_response.ListInputsResponse, zapros.Response
]:
