"""Generated from Smithy shape ``com.amazonaws.medialive#ListEventBridgeRuleTemplates``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_event_bridge_rule_templates_response.ListEventBridgeRuleTemplatesResponse = capo_medialive.types.list_event_bridge_rule_templates_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prod/eventbridge-rule-templates"
    params: dict[str, str] = {}
...
async def async_list_event_bridge_rule_templates(
