"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteCluster``."""
...
def handle_response(
    ...
    out: capo_medialive.types.delete_cluster_response.DeleteClusterResponse = (
        capo_medialive.types.delete_cluster_response.deserialize_json(
...
def delete_cluster(
    ...
    capo_medialive.types.delete_cluster_response.DeleteClusterResponse, zapros.Response
]:
