...
def handle_response(
    ...
    out: capo_medialive.types.create_cluster_response.CreateClusterResponse = (
        capo_medialive.types.create_cluster_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.create_cluster_request.serialize_json(input_)
    ).encode()
...
def create_cluster(
    ...
    capo_medialive.types.create_cluster_response.CreateClusterResponse, zapros.Response
]:
