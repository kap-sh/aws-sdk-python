"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeOffering``."""
...
def handle_response(
    ...
    out: capo_medialive.types.describe_offering_response.DescribeOfferingResponse = (
        capo_medialive.types.describe_offering_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prod/offerings/{OfferingId}"
