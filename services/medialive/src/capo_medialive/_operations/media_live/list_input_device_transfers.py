"""Generated from Smithy shape ``com.amazonaws.medialive#ListInputDeviceTransfers``."""
...
import capo_medialive.types.__list_of_transferring_input_device_summary
...
def handle_response(
    ...
    out: capo_medialive.types.list_input_device_transfers_response.ListInputDeviceTransfersResponse = capo_medialive.types.list_input_device_transfers_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prod/inputDeviceTransfers"
    params: dict[str, str] = {}
    if "max_results" in input_:
        params["maxResults"] = str(input_["max_results"])
    if "next_token" in input_:
        params["nextToken"] = str(input_["next_token"])
    if "transfer_type" in input_:
        params["transferType"] = str(input_["transfer_type"])
...
async def async_list_input_device_transfers(
