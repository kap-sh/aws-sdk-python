"""Generated from Smithy shape ``com.amazonaws.medialive#CreateEventBridgeRuleTemplateGroup``."""
...
def handle_response(
    ...
    out: capo_medialive.types.create_event_bridge_rule_template_group_response.CreateEventBridgeRuleTemplateGroupResponse = capo_medialive.types.create_event_bridge_rule_template_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.create_event_bridge_rule_template_group_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_event_bridge_rule_template_group(
