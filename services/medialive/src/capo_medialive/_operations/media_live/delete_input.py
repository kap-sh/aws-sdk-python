"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteInput``."""
...
def handle_response(
    ...
    out: capo_medialive.types.delete_input_response.DeleteInputResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_input(
    ...
    capo_medialive.types.delete_input_response.DeleteInputResponse, zapros.Response
]:
