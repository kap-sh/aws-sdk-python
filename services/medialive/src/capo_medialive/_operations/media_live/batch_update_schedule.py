...
def handle_response(
    ...
    out: capo_medialive.types.batch_update_schedule_response.BatchUpdateScheduleResponse = capo_medialive.types.batch_update_schedule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.batch_update_schedule_request.serialize_json(input_)
    ).encode()
