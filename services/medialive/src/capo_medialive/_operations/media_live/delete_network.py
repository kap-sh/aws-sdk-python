"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteNetwork``."""
...
def handle_response(
    ...
    out: capo_medialive.types.delete_network_response.DeleteNetworkResponse = (
        capo_medialive.types.delete_network_response.deserialize_json(
...
def delete_network(
    ...
    capo_medialive.types.delete_network_response.DeleteNetworkResponse, zapros.Response
]:
