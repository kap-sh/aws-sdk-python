...
def handle_response(
    ...
    out: capo_medialive.types.describe_input_device_response.DescribeInputDeviceResponse = capo_medialive.types.describe_input_device_response.deserialize_json(
