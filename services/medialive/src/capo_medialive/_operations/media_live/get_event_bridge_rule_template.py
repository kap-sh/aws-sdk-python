"""Generated from Smithy shape ``com.amazonaws.medialive#GetEventBridgeRuleTemplate``."""
...
def handle_response(
    ...
    out: capo_medialive.types.get_event_bridge_rule_template_response.GetEventBridgeRuleTemplateResponse = capo_medialive.types.get_event_bridge_rule_template_response.deserialize_json(
...
async def async_get_event_bridge_rule_template(
