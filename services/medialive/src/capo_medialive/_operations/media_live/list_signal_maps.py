"""Generated from Smithy shape ``com.amazonaws.medialive#ListSignalMaps``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_signal_maps_response.ListSignalMapsResponse = (
        capo_medialive.types.list_signal_maps_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "cloud_watch_alarm_template_group_identifier" in input_:
        params["cloudWatchAlarmTemplateGroupIdentifier"] = str(
            input_["cloud_watch_alarm_template_group_identifier"]
        )
    if "event_bridge_rule_template_group_identifier" in input_:
        params["eventBridgeRuleTemplateGroupIdentifier"] = str(
...
async def async_list_signal_maps(
