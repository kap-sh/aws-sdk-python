...
def handle_response(
    ...
    out: capo_medialive.types.create_channel_placement_group_response.CreateChannelPlacementGroupResponse = capo_medialive.types.create_channel_placement_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.create_channel_placement_group_request.serialize_json(
            input_
        )
    ).encode()
