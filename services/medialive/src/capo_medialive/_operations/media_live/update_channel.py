...
def handle_response(
    ...
    out: capo_medialive.types.update_channel_response.UpdateChannelResponse = (
        capo_medialive.types.update_channel_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.update_channel_request.serialize_json(input_)
    ).encode()
...
def update_channel(
    ...
    capo_medialive.types.update_channel_response.UpdateChannelResponse, zapros.Response
]:
