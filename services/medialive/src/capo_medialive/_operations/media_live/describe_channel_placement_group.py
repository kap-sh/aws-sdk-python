"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeChannelPlacementGroup``."""
...
def handle_response(
    ...
    out: capo_medialive.types.describe_channel_placement_group_response.DescribeChannelPlacementGroupResponse = capo_medialive.types.describe_channel_placement_group_response.deserialize_json(
...
async def async_describe_channel_placement_group(
