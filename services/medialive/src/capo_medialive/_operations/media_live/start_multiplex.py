"""Generated from Smithy shape ``com.amazonaws.medialive#StartMultiplex``."""
...
def handle_response(
    ...
    out: capo_medialive.types.start_multiplex_response.StartMultiplexResponse = (
        capo_medialive.types.start_multiplex_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prod/multiplexes/{MultiplexId}/start"
...
async def async_start_multiplex(
