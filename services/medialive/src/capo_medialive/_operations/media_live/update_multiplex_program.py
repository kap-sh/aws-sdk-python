...
def handle_response(
    ...
    out: capo_medialive.types.update_multiplex_program_response.UpdateMultiplexProgramResponse = capo_medialive.types.update_multiplex_program_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.update_multiplex_program_request.serialize_json(input_)
    ).encode()
