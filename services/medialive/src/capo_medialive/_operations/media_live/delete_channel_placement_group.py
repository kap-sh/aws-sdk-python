...
def handle_response(
    ...
    out: capo_medialive.types.delete_channel_placement_group_response.DeleteChannelPlacementGroupResponse = capo_medialive.types.delete_channel_placement_group_response.deserialize_json(
