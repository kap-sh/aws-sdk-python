...
def handle_response(
    ...
    out: capo_medialive.types.update_input_security_group_response.UpdateInputSecurityGroupResponse = capo_medialive.types.update_input_security_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.update_input_security_group_request.serialize_json(input_)
    ).encode()
