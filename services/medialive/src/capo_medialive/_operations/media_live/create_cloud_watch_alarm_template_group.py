"""Generated from Smithy shape ``com.amazonaws.medialive#CreateCloudWatchAlarmTemplateGroup``."""
...
def handle_response(
    ...
    out: capo_medialive.types.create_cloud_watch_alarm_template_group_response.CreateCloudWatchAlarmTemplateGroupResponse = capo_medialive.types.create_cloud_watch_alarm_template_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.create_cloud_watch_alarm_template_group_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_cloud_watch_alarm_template_group(
