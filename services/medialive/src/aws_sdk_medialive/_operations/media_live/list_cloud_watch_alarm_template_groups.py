...
def build_request(
    ...
    input: aws_sdk_medialive.types.list_cloud_watch_alarm_template_groups_request.ListCloudWatchAlarmTemplateGroupsRequest,
) -> zapros.Request:
    ...
    if "signal_map_identifier" in input:
        params["signalMapIdentifier"] = str(input["signal_map_identifier"])
