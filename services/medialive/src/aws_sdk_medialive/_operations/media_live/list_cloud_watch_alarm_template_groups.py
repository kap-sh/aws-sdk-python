"""Generated from Smithy shape ``com.amazonaws.medialive#ListCloudWatchAlarmTemplateGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_cloud_watch_alarm_template_groups_response.ListCloudWatchAlarmTemplateGroupsResponse = aws_sdk_medialive.types.list_cloud_watch_alarm_template_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_cloud_watch_alarm_template_groups_request.ListCloudWatchAlarmTemplateGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/cloudwatch-alarm-template-groups"
    params: dict[str, str] = {}
    ...
    if "signal_map_identifier" in input_:
        params["signalMapIdentifier"] = str(input_["signal_map_identifier"])
...
async def async_list_cloud_watch_alarm_template_groups(
