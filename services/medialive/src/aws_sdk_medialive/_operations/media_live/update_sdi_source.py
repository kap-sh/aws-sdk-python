...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_sdi_source_response.UpdateSdiSourceResponse = (
        aws_sdk_medialive.types.update_sdi_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_sdi_source_request.UpdateSdiSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_sdi_source_request.serialize_json(input_)
    ).encode()
