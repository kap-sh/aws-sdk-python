...
def handle_response(
    ...
    out: aws_sdk_medialive.types.start_input_device_response.StartInputDeviceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.start_input_device_request.StartInputDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
