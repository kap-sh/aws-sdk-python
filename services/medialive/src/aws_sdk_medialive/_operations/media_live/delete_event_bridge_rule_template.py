"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteEventBridgeRuleTemplate``."""
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.delete_event_bridge_rule_template_request.DeleteEventBridgeRuleTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_event_bridge_rule_template(
