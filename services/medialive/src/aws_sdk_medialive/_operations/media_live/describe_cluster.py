"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.describe_cluster_response.DescribeClusterResponse = (
        aws_sdk_medialive.types.describe_cluster_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.describe_cluster_request.DescribeClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
