...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_channel_placement_group_response.UpdateChannelPlacementGroupResponse = aws_sdk_medialive.types.update_channel_placement_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_channel_placement_group_request.UpdateChannelPlacementGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_channel_placement_group_request.serialize_json(
            input_
        )
    ).encode()
