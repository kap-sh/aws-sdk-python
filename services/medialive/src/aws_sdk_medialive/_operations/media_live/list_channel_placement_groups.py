"""Generated from Smithy shape ``com.amazonaws.medialive#ListChannelPlacementGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_channel_placement_groups_response.ListChannelPlacementGroupsResponse = aws_sdk_medialive.types.list_channel_placement_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_channel_placement_groups_request.ListChannelPlacementGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_channel_placement_groups(
