"""Generated from Smithy shape ``com.amazonaws.medialive#CreateCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.create_cluster_response.CreateClusterResponse = (
        aws_sdk_medialive.types.create_cluster_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_cluster_request.CreateClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/clusters"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_medialive.types.create_cluster_request

    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_cluster_request.serialize_json(input_)
    ).encode()
