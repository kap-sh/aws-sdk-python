"""Generated from Smithy shape ``com.amazonaws.medialive#GetSignalMap``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.get_signal_map_response.GetSignalMapResponse = (
        aws_sdk_medialive.types.get_signal_map_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.get_signal_map_request.GetSignalMapRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/signal-maps/{Identifier}"
...
async def async_get_signal_map(
