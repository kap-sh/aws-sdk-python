...
def handle_response(
    ...
    out: aws_sdk_medialive.types.cancel_input_device_transfer_response.CancelInputDeviceTransferResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.cancel_input_device_transfer_request.CancelInputDeviceTransferRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
