...
def build_request(
    ...
    input: aws_sdk_medialive.types.start_update_signal_map_request.StartUpdateSignalMapRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.start_update_signal_map_request.serialize_json(input)
    ).encode()
