...
def handle_response(
    ...
    out: aws_sdk_medialive.types.start_update_signal_map_response.StartUpdateSignalMapResponse = aws_sdk_medialive.types.start_update_signal_map_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.start_update_signal_map_request.StartUpdateSignalMapRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.start_update_signal_map_request.serialize_json(input_)
    ).encode()
