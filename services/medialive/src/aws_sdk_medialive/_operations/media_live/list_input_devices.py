"""Generated from Smithy shape ``com.amazonaws.medialive#ListInputDevices``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_input_devices_response.ListInputDevicesResponse = aws_sdk_medialive.types.list_input_devices_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_input_devices_request.ListInputDevicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/inputDevices"
    params: dict[str, str] = {}
...
async def async_list_input_devices(
