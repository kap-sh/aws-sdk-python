...
def handle_response(
    ...
    out: aws_sdk_medialive.types.describe_account_configuration_response.DescribeAccountConfigurationResponse = aws_sdk_medialive.types.describe_account_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.describe_account_configuration_request.DescribeAccountConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
