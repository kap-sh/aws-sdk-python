...
def handle_response(
    ...
    out: aws_sdk_medialive.types.delete_input_response.DeleteInputResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.delete_input_request.DeleteInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_input(
    ...
    aws_sdk_medialive.types.delete_input_response.DeleteInputResponse, zapros.Response
]:
