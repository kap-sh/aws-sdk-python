...
def handle_response(
    ...
    out: aws_sdk_medialive.types.purchase_offering_response.PurchaseOfferingResponse = (
        aws_sdk_medialive.types.purchase_offering_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medialive.types.purchase_offering_request.PurchaseOfferingRequest,
) -> zapros.Request:
    ...
    url = url.replace("{OfferingId}", quote(str(input["offering_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_medialive.types.purchase_offering_request

    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.purchase_offering_request.serialize_json(input)
    ).encode()
