...
def build_request(
    ...
    input_: aws_sdk_medialive.types.purchase_offering_request.PurchaseOfferingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.purchase_offering_request.serialize_json(input_)
    ).encode()
