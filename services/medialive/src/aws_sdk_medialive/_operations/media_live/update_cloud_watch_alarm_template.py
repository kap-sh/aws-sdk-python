"""Generated from Smithy shape ``com.amazonaws.medialive#UpdateCloudWatchAlarmTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_cloud_watch_alarm_template_response.UpdateCloudWatchAlarmTemplateResponse = aws_sdk_medialive.types.update_cloud_watch_alarm_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_cloud_watch_alarm_template_request.UpdateCloudWatchAlarmTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/cloudwatch-alarm-templates/{Identifier}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_cloud_watch_alarm_template_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_cloud_watch_alarm_template(
