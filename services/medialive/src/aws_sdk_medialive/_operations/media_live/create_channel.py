...
def handle_response(
    ...
    out: aws_sdk_medialive.types.create_channel_response.CreateChannelResponse = (
        aws_sdk_medialive.types.create_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_channel_request.CreateChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_channel_request.serialize_json(input_)
    ).encode()
