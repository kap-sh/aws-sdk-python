...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_networks_response.ListNetworksResponse = (
        aws_sdk_medialive.types.list_networks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_networks_request.ListNetworksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_networks(
    ...
    aws_sdk_medialive.types.list_networks_response.ListNetworksResponse, zapros.Response
]:
