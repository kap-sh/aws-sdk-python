...
def handle_response(
    ...
    out: aws_sdk_medialive.types.start_delete_monitor_deployment_response.StartDeleteMonitorDeploymentResponse = aws_sdk_medialive.types.start_delete_monitor_deployment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.start_delete_monitor_deployment_request.StartDeleteMonitorDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
