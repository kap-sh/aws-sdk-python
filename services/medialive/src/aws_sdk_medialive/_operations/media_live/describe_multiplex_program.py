...
def handle_response(
    ...
    out: aws_sdk_medialive.types.describe_multiplex_program_response.DescribeMultiplexProgramResponse = aws_sdk_medialive.types.describe_multiplex_program_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.describe_multiplex_program_request.DescribeMultiplexProgramRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
