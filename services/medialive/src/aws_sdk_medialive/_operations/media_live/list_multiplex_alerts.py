...
def build_request(
    ...
    input: aws_sdk_medialive.types.list_multiplex_alerts_request.ListMultiplexAlertsRequest,
) -> zapros.Request:
    ...
    if "state_filter" in input:
        params["stateFilter"] = str(input["state_filter"])
