"""Generated from Smithy shape ``com.amazonaws.medialive#ListMultiplexAlerts``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_multiplex_alerts_response.ListMultiplexAlertsResponse = aws_sdk_medialive.types.list_multiplex_alerts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_multiplex_alerts_request.ListMultiplexAlertsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/multiplexes/{MultiplexId}/alerts"
    ...
    if "state_filter" in input_:
        params["stateFilter"] = str(input_["state_filter"])
...
async def async_list_multiplex_alerts(
