...
def build_request(
    ...
    input: aws_sdk_medialive.types.batch_update_schedule_request.BatchUpdateScheduleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.batch_update_schedule_request.serialize_json(input)
    ).encode()
