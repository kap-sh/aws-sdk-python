"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteMultiplex``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.delete_multiplex_response.DeleteMultiplexResponse = (
        aws_sdk_medialive.types.delete_multiplex_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.delete_multiplex_request.DeleteMultiplexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/multiplexes/{MultiplexId}"
...
async def async_delete_multiplex(
