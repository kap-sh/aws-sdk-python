...
def handle_response(
    ...
    out: aws_sdk_medialive.types.reject_input_device_transfer_response.RejectInputDeviceTransferResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.reject_input_device_transfer_request.RejectInputDeviceTransferRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
