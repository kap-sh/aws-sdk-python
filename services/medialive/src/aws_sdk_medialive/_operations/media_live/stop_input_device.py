"""Generated from Smithy shape ``com.amazonaws.medialive#StopInputDevice``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.stop_input_device_response.StopInputDeviceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.stop_input_device_request.StopInputDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/inputDevices/{InputDeviceId}/stop"
...
async def async_stop_input_device(
