...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_signal_maps_response.ListSignalMapsResponse = (
        aws_sdk_medialive.types.list_signal_maps_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medialive.types.list_signal_maps_request.ListSignalMapsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "cloud_watch_alarm_template_group_identifier" in input:
        params["cloudWatchAlarmTemplateGroupIdentifier"] = str(
            input["cloud_watch_alarm_template_group_identifier"]
        )
    if "event_bridge_rule_template_group_identifier" in input:
