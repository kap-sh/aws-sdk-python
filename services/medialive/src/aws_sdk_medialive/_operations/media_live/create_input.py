"""Generated from Smithy shape ``com.amazonaws.medialive#CreateInput``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.create_input_response.CreateInputResponse = (
        aws_sdk_medialive.types.create_input_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_input_request.CreateInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/inputs"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_medialive.types.create_input_request

    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_input_request.serialize_json(input_)
    ).encode()
...
def create_input(
    ...
    aws_sdk_medialive.types.create_input_response.CreateInputResponse, zapros.Response
]:
