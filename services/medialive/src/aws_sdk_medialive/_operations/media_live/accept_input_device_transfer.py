"""Generated from Smithy shape ``com.amazonaws.medialive#AcceptInputDeviceTransfer``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.accept_input_device_transfer_response.AcceptInputDeviceTransferResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.accept_input_device_transfer_request.AcceptInputDeviceTransferRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/inputDevices/{InputDeviceId}/accept"
...
async def async_accept_input_device_transfer(
