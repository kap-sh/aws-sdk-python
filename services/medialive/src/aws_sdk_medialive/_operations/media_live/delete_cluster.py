...
def handle_response(
    ...
    out: aws_sdk_medialive.types.delete_cluster_response.DeleteClusterResponse = (
        aws_sdk_medialive.types.delete_cluster_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.delete_cluster_request.DeleteClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
