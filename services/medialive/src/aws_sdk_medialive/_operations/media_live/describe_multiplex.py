...
def handle_response(
    ...
    out: aws_sdk_medialive.types.describe_multiplex_response.DescribeMultiplexResponse = aws_sdk_medialive.types.describe_multiplex_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.describe_multiplex_request.DescribeMultiplexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
