...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_clusters_response.ListClustersResponse = (
        aws_sdk_medialive.types.list_clusters_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_clusters_request.ListClustersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_clusters(
    ...
    aws_sdk_medialive.types.list_clusters_response.ListClustersResponse, zapros.Response
]:
