"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteNode``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.delete_node_response.DeleteNodeResponse = (
        aws_sdk_medialive.types.delete_node_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medialive.types.delete_node_request.DeleteNodeRequest,
) -> zapros.Request:
...
def delete_node(
    ...
    aws_sdk_medialive.types.delete_node_response.DeleteNodeResponse, zapros.Response
]:
