...
def handle_response(
    ...
    out: aws_sdk_medialive.types.create_node_registration_script_response.CreateNodeRegistrationScriptResponse = aws_sdk_medialive.types.create_node_registration_script_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_node_registration_script_request.CreateNodeRegistrationScriptRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_node_registration_script_request.serialize_json(
            input_
        )
    ).encode()
