"""Generated from Smithy shape ``com.amazonaws.medialive#CreateChannelPlacementGroup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnprocessableEntityException":
            import aws_sdk_medialive.errors.unprocessable_entity_exception

            raise aws_sdk_medialive.errors.unprocessable_entity_exception.UnprocessableEntityException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.create_channel_placement_group_response.CreateChannelPlacementGroupResponse = aws_sdk_medialive.types.create_channel_placement_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_channel_placement_group_request.CreateChannelPlacementGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/clusters/{ClusterId}/channelplacementgroups"
    url = url.replace("{ClusterId}", quote(str(input_["cluster_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_medialive.types.create_channel_placement_group_request

    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_channel_placement_group_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_channel_placement_group(
