...
def build_request(
    ...
    input: aws_sdk_medialive.types.create_channel_placement_group_request.CreateChannelPlacementGroupRequest,
) -> zapros.Request:
    ...
    url = url.replace("{ClusterId}", quote(str(input["cluster_id"]), safe=""))
    params: dict[str, str] = {}
