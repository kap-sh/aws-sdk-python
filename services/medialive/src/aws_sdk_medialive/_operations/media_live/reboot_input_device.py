...
def handle_response(
    ...
    out: aws_sdk_medialive.types.reboot_input_device_response.RebootInputDeviceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.reboot_input_device_request.RebootInputDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.reboot_input_device_request.serialize_json(input_)
    ).encode()
