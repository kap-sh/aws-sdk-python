...
def build_request(
    ...
    input: aws_sdk_medialive.types.reboot_input_device_request.RebootInputDeviceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.reboot_input_device_request.serialize_json(input)
    ).encode()
