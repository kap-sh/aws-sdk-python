"""Generated from Smithy shape ``com.amazonaws.medialive#StartInputDeviceMaintenanceWindow``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.start_input_device_maintenance_window_response.StartInputDeviceMaintenanceWindowResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.start_input_device_maintenance_window_request.StartInputDeviceMaintenanceWindowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_start_input_device_maintenance_window(
