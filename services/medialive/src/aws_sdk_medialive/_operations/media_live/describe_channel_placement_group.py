...
def handle_response(
    ...
    out: aws_sdk_medialive.types.describe_channel_placement_group_response.DescribeChannelPlacementGroupResponse = aws_sdk_medialive.types.describe_channel_placement_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.describe_channel_placement_group_request.DescribeChannelPlacementGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
