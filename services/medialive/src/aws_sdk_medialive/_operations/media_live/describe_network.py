"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeNetwork``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.describe_network_response.DescribeNetworkResponse = (
        aws_sdk_medialive.types.describe_network_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.describe_network_request.DescribeNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_network(
