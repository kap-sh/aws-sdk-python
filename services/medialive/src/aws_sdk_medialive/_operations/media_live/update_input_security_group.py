"""Generated from Smithy shape ``com.amazonaws.medialive#UpdateInputSecurityGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_input_security_group_response.UpdateInputSecurityGroupResponse = aws_sdk_medialive.types.update_input_security_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_input_security_group_request.UpdateInputSecurityGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/inputSecurityGroups/{InputSecurityGroupId}"
    url = url.replace(
        "{InputSecurityGroupId}", quote(str(input_["input_security_group_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_input_security_group_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_input_security_group(
