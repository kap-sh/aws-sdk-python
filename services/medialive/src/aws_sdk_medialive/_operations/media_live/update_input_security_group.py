...
def build_request(
    ...
    input: aws_sdk_medialive.types.update_input_security_group_request.UpdateInputSecurityGroupRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{InputSecurityGroupId}", quote(str(input["input_security_group_id"]), safe="")
    )
    params: dict[str, str] = {}
