...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_event_bridge_rule_templates_response.ListEventBridgeRuleTemplatesResponse = aws_sdk_medialive.types.list_event_bridge_rule_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_event_bridge_rule_templates_request.ListEventBridgeRuleTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
