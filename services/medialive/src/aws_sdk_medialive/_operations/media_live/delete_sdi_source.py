...
def handle_response(
    ...
    out: aws_sdk_medialive.types.delete_sdi_source_response.DeleteSdiSourceResponse = (
        aws_sdk_medialive.types.delete_sdi_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.delete_sdi_source_request.DeleteSdiSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
