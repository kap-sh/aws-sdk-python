...
def handle_response(
    ...
    out: aws_sdk_medialive.types.start_multiplex_response.StartMultiplexResponse = (
        aws_sdk_medialive.types.start_multiplex_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.start_multiplex_request.StartMultiplexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
