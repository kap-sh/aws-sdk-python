...
def handle_response(
    ...
    out: aws_sdk_medialive.types.delete_schedule_response.DeleteScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.delete_schedule_request.DeleteScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
