"""Generated from Smithy shape ``com.amazonaws.medialive#UpdateCloudWatchAlarmTemplateGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_cloud_watch_alarm_template_group_response.UpdateCloudWatchAlarmTemplateGroupResponse = aws_sdk_medialive.types.update_cloud_watch_alarm_template_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_cloud_watch_alarm_template_group_request.UpdateCloudWatchAlarmTemplateGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/prod/cloudwatch-alarm-template-groups/{Identifier}"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_cloud_watch_alarm_template_group_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_cloud_watch_alarm_template_group(
