...
def build_request(
    ...
    input: aws_sdk_medialive.types.describe_thumbnails_request.DescribeThumbnailsRequest,
) -> zapros.Request:
    ...
    if "pipeline_id" in input:
        params["pipelineId"] = str(input["pipeline_id"])
    if "thumbnail_type" in input:
        params["thumbnailType"] = str(input["thumbnail_type"])
