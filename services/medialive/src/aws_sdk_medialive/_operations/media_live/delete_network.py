...
def handle_response(
    ...
    out: aws_sdk_medialive.types.delete_network_response.DeleteNetworkResponse = (
        aws_sdk_medialive.types.delete_network_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.delete_network_request.DeleteNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
