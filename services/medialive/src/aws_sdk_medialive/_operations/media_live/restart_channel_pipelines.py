...
def build_request(
    ...
    input: aws_sdk_medialive.types.restart_channel_pipelines_request.RestartChannelPipelinesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.restart_channel_pipelines_request.serialize_json(input)
    ).encode()
