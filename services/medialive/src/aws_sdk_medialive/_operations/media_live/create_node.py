"""Generated from Smithy shape ``com.amazonaws.medialive#CreateNode``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.create_node_response.CreateNodeResponse = (
        aws_sdk_medialive.types.create_node_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_node_request.CreateNodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/clusters/{ClusterId}/nodes"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_node_request.serialize_json(input_)
    ).encode()
...
def create_node(
    ...
    aws_sdk_medialive.types.create_node_response.CreateNodeResponse, zapros.Response
]:
