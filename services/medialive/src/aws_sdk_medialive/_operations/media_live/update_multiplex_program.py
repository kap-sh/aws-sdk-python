...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_multiplex_program_request.UpdateMultiplexProgramRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_multiplex_program_request.serialize_json(input_)
    ).encode()
