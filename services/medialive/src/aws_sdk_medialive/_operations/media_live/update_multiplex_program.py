"""Generated from Smithy shape ``com.amazonaws.medialive#UpdateMultiplexProgram``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_multiplex_program_response.UpdateMultiplexProgramResponse = aws_sdk_medialive.types.update_multiplex_program_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medialive.types.update_multiplex_program_request.UpdateMultiplexProgramRequest,
) -> zapros.Request:
    ...
    url = url.replace("{MultiplexId}", quote(str(input["multiplex_id"]), safe=""))
    url = url.replace("{ProgramName}", quote(str(input["program_name"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_medialive.types.update_multiplex_program_request

    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_multiplex_program_request.serialize_json(input)
    ).encode()
...
async def async_update_multiplex_program(
