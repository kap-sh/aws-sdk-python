"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteEventBridgeRuleTemplateGroup``."""
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.delete_event_bridge_rule_template_group_request.DeleteEventBridgeRuleTemplateGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_event_bridge_rule_template_group(
