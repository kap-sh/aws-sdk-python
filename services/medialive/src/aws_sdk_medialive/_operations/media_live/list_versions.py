...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_versions_response.ListVersionsResponse = (
        aws_sdk_medialive.types.list_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_versions_request.ListVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_versions(
    ...
    aws_sdk_medialive.types.list_versions_response.ListVersionsResponse, zapros.Response
]:
