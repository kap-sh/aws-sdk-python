...
def handle_response(
    ...
    out: aws_sdk_medialive.types.describe_input_security_group_response.DescribeInputSecurityGroupResponse = aws_sdk_medialive.types.describe_input_security_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.describe_input_security_group_request.DescribeInputSecurityGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
