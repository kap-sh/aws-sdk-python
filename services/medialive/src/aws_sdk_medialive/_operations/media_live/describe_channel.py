"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.describe_channel_response.DescribeChannelResponse = (
        aws_sdk_medialive.types.describe_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.describe_channel_request.DescribeChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
