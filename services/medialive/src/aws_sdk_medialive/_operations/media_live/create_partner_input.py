...
def handle_response(
    ...
    out: aws_sdk_medialive.types.create_partner_input_response.CreatePartnerInputResponse = aws_sdk_medialive.types.create_partner_input_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_partner_input_request.CreatePartnerInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_partner_input_request.serialize_json(input_)
    ).encode()
