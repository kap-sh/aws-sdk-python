...
def build_request(
    ...
    input: aws_sdk_medialive.types.create_partner_input_request.CreatePartnerInputRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_partner_input_request.serialize_json(input)
    ).encode()
