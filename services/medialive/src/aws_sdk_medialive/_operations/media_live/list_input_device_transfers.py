...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_input_device_transfers_response.ListInputDeviceTransfersResponse = aws_sdk_medialive.types.list_input_device_transfers_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medialive.types.list_input_device_transfers_request.ListInputDeviceTransfersRequest,
) -> zapros.Request:
    ...
    if "transfer_type" in input:
        params["transferType"] = str(input["transfer_type"])
