...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_reservations_response.ListReservationsResponse = (
        aws_sdk_medialive.types.list_reservations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_reservations_request.ListReservationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
