...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_reservation_response.UpdateReservationResponse = aws_sdk_medialive.types.update_reservation_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medialive.types.update_reservation_request.UpdateReservationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_reservation_request.serialize_json(input)
    ).encode()
