...
def handle_response(
    ...
    out: aws_sdk_medialive.types.get_event_bridge_rule_template_group_response.GetEventBridgeRuleTemplateGroupResponse = aws_sdk_medialive.types.get_event_bridge_rule_template_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.get_event_bridge_rule_template_group_request.GetEventBridgeRuleTemplateGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
