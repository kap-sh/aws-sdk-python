...
def build_request(
    ...
    input: aws_sdk_medialive.types.update_channel_class_request.UpdateChannelClassRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_channel_class_request.serialize_json(input)
    ).encode()
