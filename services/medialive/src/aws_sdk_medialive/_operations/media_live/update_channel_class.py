...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_channel_class_response.UpdateChannelClassResponse = aws_sdk_medialive.types.update_channel_class_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_channel_class_request.UpdateChannelClassRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_channel_class_request.serialize_json(input_)
    ).encode()
