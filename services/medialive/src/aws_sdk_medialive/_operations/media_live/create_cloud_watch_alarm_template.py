"""Generated from Smithy shape ``com.amazonaws.medialive#CreateCloudWatchAlarmTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.create_cloud_watch_alarm_template_response.CreateCloudWatchAlarmTemplateResponse = aws_sdk_medialive.types.create_cloud_watch_alarm_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_cloud_watch_alarm_template_request.CreateCloudWatchAlarmTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/cloudwatch-alarm-templates"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_medialive.types.create_cloud_watch_alarm_template_request

    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_cloud_watch_alarm_template_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_cloud_watch_alarm_template(
