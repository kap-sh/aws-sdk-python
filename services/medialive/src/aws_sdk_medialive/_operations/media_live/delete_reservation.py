...
def handle_response(
    ...
    out: aws_sdk_medialive.types.delete_reservation_response.DeleteReservationResponse = aws_sdk_medialive.types.delete_reservation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.delete_reservation_request.DeleteReservationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
