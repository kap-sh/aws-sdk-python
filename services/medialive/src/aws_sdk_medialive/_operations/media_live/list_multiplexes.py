"""Generated from Smithy shape ``com.amazonaws.medialive#ListMultiplexes``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_multiplexes_response.ListMultiplexesResponse = (
        aws_sdk_medialive.types.list_multiplexes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_multiplexes_request.ListMultiplexesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/multiplexes"
    params: dict[str, str] = {}
...
async def async_list_multiplexes(
