...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_node_state_response.UpdateNodeStateResponse = (
        aws_sdk_medialive.types.update_node_state_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_node_state_request.UpdateNodeStateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_node_state_request.serialize_json(input_)
    ).encode()
