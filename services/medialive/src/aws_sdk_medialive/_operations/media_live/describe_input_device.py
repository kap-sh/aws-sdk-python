"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeInputDevice``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.describe_input_device_response.DescribeInputDeviceResponse = aws_sdk_medialive.types.describe_input_device_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.describe_input_device_request.DescribeInputDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_input_device(
