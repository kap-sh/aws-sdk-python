"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteCloudWatchAlarmTemplate``."""
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.delete_cloud_watch_alarm_template_request.DeleteCloudWatchAlarmTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_cloud_watch_alarm_template(
