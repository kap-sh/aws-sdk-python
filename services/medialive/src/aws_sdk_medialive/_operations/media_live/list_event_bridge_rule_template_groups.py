...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_event_bridge_rule_template_groups_response.ListEventBridgeRuleTemplateGroupsResponse = aws_sdk_medialive.types.list_event_bridge_rule_template_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_event_bridge_rule_template_groups_request.ListEventBridgeRuleTemplateGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
