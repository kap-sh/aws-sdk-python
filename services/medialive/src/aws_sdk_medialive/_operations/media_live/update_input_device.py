"""Generated from Smithy shape ``com.amazonaws.medialive#UpdateInputDevice``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_input_device_response.UpdateInputDeviceResponse = aws_sdk_medialive.types.update_input_device_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_input_device_request.UpdateInputDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/inputDevices/{InputDeviceId}"
    url = url.replace("{InputDeviceId}", quote(str(input_["input_device_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_medialive.types.update_input_device_request

    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_input_device_request.serialize_json(input_)
    ).encode()
...
async def async_update_input_device(
