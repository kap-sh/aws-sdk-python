...
def build_request(
    ...
    input: aws_sdk_medialive.types.update_input_device_request.UpdateInputDeviceRequest,
) -> zapros.Request:
    ...
    url = url.replace("{InputDeviceId}", quote(str(input["input_device_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_medialive.types.update_input_device_request

    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_input_device_request.serialize_json(input)
    ).encode()
