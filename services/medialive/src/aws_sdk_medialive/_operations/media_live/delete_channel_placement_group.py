"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteChannelPlacementGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.delete_channel_placement_group_response.DeleteChannelPlacementGroupResponse = aws_sdk_medialive.types.delete_channel_placement_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.delete_channel_placement_group_request.DeleteChannelPlacementGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["channel_placement_group_id"]), safe=""),
    )
...
async def async_delete_channel_placement_group(
