...
def build_request(
    ...
    input: aws_sdk_medialive.types.delete_channel_placement_group_request.DeleteChannelPlacementGroupRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["channel_placement_group_id"]), safe=""),
    )
