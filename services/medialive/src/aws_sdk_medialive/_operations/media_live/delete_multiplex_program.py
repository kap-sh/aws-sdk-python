...
def handle_response(
    ...
    out: aws_sdk_medialive.types.delete_multiplex_program_response.DeleteMultiplexProgramResponse = aws_sdk_medialive.types.delete_multiplex_program_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.delete_multiplex_program_request.DeleteMultiplexProgramRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
