"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeSchedule``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.describe_schedule_response.DescribeScheduleResponse = (
        aws_sdk_medialive.types.describe_schedule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.describe_schedule_request.DescribeScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
