...
def handle_response(
    ...
    out: aws_sdk_medialive.types.claim_device_response.ClaimDeviceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.claim_device_request.ClaimDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.claim_device_request.serialize_json(input_)
    ).encode()
...
def claim_device(
    ...
    aws_sdk_medialive.types.claim_device_response.ClaimDeviceResponse, zapros.Response
]:
