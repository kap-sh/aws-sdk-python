"""Generated from Smithy shape ``com.amazonaws.medialive#CreateTags``."""
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_tags_request.CreateTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_tags_request.serialize_json(input_)
    ).encode()
