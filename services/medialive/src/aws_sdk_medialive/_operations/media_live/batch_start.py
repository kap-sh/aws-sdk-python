"""Generated from Smithy shape ``com.amazonaws.medialive#BatchStart``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.batch_start_response.BatchStartResponse = (
        aws_sdk_medialive.types.batch_start_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.batch_start_request.BatchStartRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/batch/start"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_medialive.types.batch_start_request

    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.batch_start_request.serialize_json(input_)
    ).encode()
...
def batch_start(
    ...
    aws_sdk_medialive.types.batch_start_response.BatchStartResponse, zapros.Response
]:
