"""Generated from Smithy shape ``com.amazonaws.medialive#StopMultiplex``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.stop_multiplex_response.StopMultiplexResponse = (
        aws_sdk_medialive.types.stop_multiplex_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.stop_multiplex_request.StopMultiplexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/multiplexes/{MultiplexId}/stop"
...
async def async_stop_multiplex(
