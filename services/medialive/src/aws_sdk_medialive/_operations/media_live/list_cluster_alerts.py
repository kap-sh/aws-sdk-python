...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_cluster_alerts_response.ListClusterAlertsResponse = aws_sdk_medialive.types.list_cluster_alerts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_cluster_alerts_request.ListClusterAlertsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
