"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeReservation``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.describe_reservation_response.DescribeReservationResponse = aws_sdk_medialive.types.describe_reservation_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medialive.types.describe_reservation_request.DescribeReservationRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/prod/reservations/{ReservationId}"
    url = url.replace("{ReservationId}", quote(str(input["reservation_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_describe_reservation(
