"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeInputDeviceThumbnail``."""
...
def handle_response(
    ...
    if "Content-Type" in response.headers:
        ...
        out["content_type"] = aws_sdk_medialive.types.content_type.from_xml_text(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.describe_input_device_thumbnail_request.DescribeInputDeviceThumbnailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/inputDevices/{InputDeviceId}/thumbnailData"
...
async def async_describe_input_device_thumbnail(
