...
def handle_response(
    ...
    out: aws_sdk_medialive.types.describe_offering_response.DescribeOfferingResponse = (
        aws_sdk_medialive.types.describe_offering_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medialive.types.describe_offering_request.DescribeOfferingRequest,
) -> zapros.Request:
