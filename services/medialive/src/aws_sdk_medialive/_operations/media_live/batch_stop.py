...
def handle_response(
    ...
    out: aws_sdk_medialive.types.batch_stop_response.BatchStopResponse = (
        aws_sdk_medialive.types.batch_stop_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_medialive.types.batch_stop_request.BatchStopRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.batch_stop_request.serialize_json(input)
    ).encode()
...
def batch_stop(
    ...
    aws_sdk_medialive.types.batch_stop_response.BatchStopResponse, zapros.Response
]:
