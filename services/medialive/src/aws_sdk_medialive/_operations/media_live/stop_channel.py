...
def handle_response(
    ...
    out: aws_sdk_medialive.types.stop_channel_response.StopChannelResponse = (
        aws_sdk_medialive.types.stop_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.stop_channel_request.StopChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def stop_channel(
    ...
    aws_sdk_medialive.types.stop_channel_response.StopChannelResponse, zapros.Response
]:
