"""Generated from Smithy shape ``com.amazonaws.medialive#ListAlerts``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_alerts_response.ListAlertsResponse = (
        aws_sdk_medialive.types.list_alerts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_alerts_request.ListAlertsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/channels/{ChannelId}/alerts"
...
def list_alerts(
    ...
    aws_sdk_medialive.types.list_alerts_response.ListAlertsResponse, zapros.Response
]:
