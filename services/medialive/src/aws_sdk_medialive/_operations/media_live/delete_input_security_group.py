...
def handle_response(
    ...
    out: aws_sdk_medialive.types.delete_input_security_group_response.DeleteInputSecurityGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.delete_input_security_group_request.DeleteInputSecurityGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
