...
def handle_response(
    ...
    out: aws_sdk_medialive.types.batch_delete_response.BatchDeleteResponse = (
        aws_sdk_medialive.types.batch_delete_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.batch_delete_request.BatchDeleteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.batch_delete_request.serialize_json(input_)
    ).encode()
...
def batch_delete(
    ...
    aws_sdk_medialive.types.batch_delete_response.BatchDeleteResponse, zapros.Response
]:
