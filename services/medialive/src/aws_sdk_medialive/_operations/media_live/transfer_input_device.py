...
def handle_response(
    ...
    out: aws_sdk_medialive.types.transfer_input_device_response.TransferInputDeviceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.transfer_input_device_request.TransferInputDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.transfer_input_device_request.serialize_json(input_)
    ).encode()
