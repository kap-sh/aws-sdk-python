...
def build_request(
    ...
    input: aws_sdk_medialive.types.transfer_input_device_request.TransferInputDeviceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.transfer_input_device_request.serialize_json(input)
    ).encode()
