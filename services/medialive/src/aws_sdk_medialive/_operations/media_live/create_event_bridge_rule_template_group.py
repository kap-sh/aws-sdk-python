...
def handle_response(
    ...
    out: aws_sdk_medialive.types.create_event_bridge_rule_template_group_response.CreateEventBridgeRuleTemplateGroupResponse = aws_sdk_medialive.types.create_event_bridge_rule_template_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_event_bridge_rule_template_group_request.CreateEventBridgeRuleTemplateGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_event_bridge_rule_template_group_request.serialize_json(
            input_
        )
    ).encode()
