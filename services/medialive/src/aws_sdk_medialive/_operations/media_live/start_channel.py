...
def handle_response(
    ...
    out: aws_sdk_medialive.types.start_channel_response.StartChannelResponse = (
        aws_sdk_medialive.types.start_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.start_channel_request.StartChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def start_channel(
    ...
    aws_sdk_medialive.types.start_channel_response.StartChannelResponse, zapros.Response
]:
