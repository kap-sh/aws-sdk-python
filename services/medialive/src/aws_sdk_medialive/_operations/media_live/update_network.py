"""Generated from Smithy shape ``com.amazonaws.medialive#UpdateNetwork``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_network_response.UpdateNetworkResponse = (
        aws_sdk_medialive.types.update_network_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_network_request.UpdateNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/networks/{NetworkId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_network_request.serialize_json(input_)
    ).encode()
