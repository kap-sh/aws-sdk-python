...
def handle_response(
    ...
    out: aws_sdk_medialive.types.start_monitor_deployment_response.StartMonitorDeploymentResponse = aws_sdk_medialive.types.start_monitor_deployment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.start_monitor_deployment_request.StartMonitorDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.start_monitor_deployment_request.serialize_json(input_)
    ).encode()
