...
def build_request(
    ...
    input: aws_sdk_medialive.types.start_monitor_deployment_request.StartMonitorDeploymentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.start_monitor_deployment_request.serialize_json(input)
    ).encode()
