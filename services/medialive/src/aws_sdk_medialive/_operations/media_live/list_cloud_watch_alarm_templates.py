...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_cloud_watch_alarm_templates_response.ListCloudWatchAlarmTemplatesResponse = aws_sdk_medialive.types.list_cloud_watch_alarm_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_cloud_watch_alarm_templates_request.ListCloudWatchAlarmTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
