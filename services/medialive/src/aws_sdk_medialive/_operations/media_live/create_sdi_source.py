...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_sdi_source_request.CreateSdiSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_sdi_source_request.serialize_json(input_)
    ).encode()
