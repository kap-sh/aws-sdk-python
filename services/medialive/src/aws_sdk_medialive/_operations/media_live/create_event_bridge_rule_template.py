...
def handle_response(
    ...
    out: aws_sdk_medialive.types.create_event_bridge_rule_template_response.CreateEventBridgeRuleTemplateResponse = aws_sdk_medialive.types.create_event_bridge_rule_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_event_bridge_rule_template_request.CreateEventBridgeRuleTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_event_bridge_rule_template_request.serialize_json(
            input_
        )
    ).encode()
