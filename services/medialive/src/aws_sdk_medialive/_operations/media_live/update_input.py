"""Generated from Smithy shape ``com.amazonaws.medialive#UpdateInput``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_input_response.UpdateInputResponse = (
        aws_sdk_medialive.types.update_input_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_input_request.UpdateInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/inputs/{InputId}"
    url = url.replace("{InputId}", quote(str(input_["input_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_medialive.types.update_input_request

    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_input_request.serialize_json(input_)
    ).encode()
...
def update_input(
    ...
    aws_sdk_medialive.types.update_input_response.UpdateInputResponse, zapros.Response
]:
