...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_channels_response.ListChannelsResponse = (
        aws_sdk_medialive.types.list_channels_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_channels_request.ListChannelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_channels(
    ...
    aws_sdk_medialive.types.list_channels_response.ListChannelsResponse, zapros.Response
]:
