...
def handle_response(
    ...
    out: aws_sdk_medialive.types.create_multiplex_response.CreateMultiplexResponse = (
        aws_sdk_medialive.types.create_multiplex_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_multiplex_request.CreateMultiplexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_multiplex_request.serialize_json(input_)
    ).encode()
