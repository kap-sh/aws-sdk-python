...
def build_request(
    ...
    input: aws_sdk_medialive.types.create_multiplex_program_request.CreateMultiplexProgramRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_multiplex_program_request.serialize_json(input)
    ).encode()
