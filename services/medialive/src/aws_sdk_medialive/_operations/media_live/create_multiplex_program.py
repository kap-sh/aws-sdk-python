"""Generated from Smithy shape ``com.amazonaws.medialive#CreateMultiplexProgram``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.create_multiplex_program_response.CreateMultiplexProgramResponse = aws_sdk_medialive.types.create_multiplex_program_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_multiplex_program_request.CreateMultiplexProgramRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/multiplexes/{MultiplexId}/programs"
    url = url.replace("{MultiplexId}", quote(str(input_["multiplex_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_medialive.types.create_multiplex_program_request

    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_multiplex_program_request.serialize_json(input_)
    ).encode()
...
async def async_create_multiplex_program(
