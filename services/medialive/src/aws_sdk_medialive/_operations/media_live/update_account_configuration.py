...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_account_configuration_response.UpdateAccountConfigurationResponse = aws_sdk_medialive.types.update_account_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_account_configuration_request.UpdateAccountConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_account_configuration_request.serialize_json(
            input_
        )
    ).encode()
