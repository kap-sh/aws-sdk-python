...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_sdi_sources_response.ListSdiSourcesResponse = (
        aws_sdk_medialive.types.list_sdi_sources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_sdi_sources_request.ListSdiSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
