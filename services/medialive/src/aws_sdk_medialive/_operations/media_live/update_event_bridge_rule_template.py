...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_event_bridge_rule_template_response.UpdateEventBridgeRuleTemplateResponse = aws_sdk_medialive.types.update_event_bridge_rule_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_event_bridge_rule_template_request.UpdateEventBridgeRuleTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
