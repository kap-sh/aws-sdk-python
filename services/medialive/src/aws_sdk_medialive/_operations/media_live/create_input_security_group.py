...
def handle_response(
    ...
    out: aws_sdk_medialive.types.create_input_security_group_response.CreateInputSecurityGroupResponse = aws_sdk_medialive.types.create_input_security_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.create_input_security_group_request.CreateInputSecurityGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.create_input_security_group_request.serialize_json(
            input_
        )
    ).encode()
