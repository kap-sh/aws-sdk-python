"""Generated from Smithy shape ``com.amazonaws.medialive#UpdateChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.update_channel_response.UpdateChannelResponse = (
        aws_sdk_medialive.types.update_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.update_channel_request.UpdateChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/prod/channels/{ChannelId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_medialive.types.update_channel_request.serialize_json(input_)
    ).encode()
