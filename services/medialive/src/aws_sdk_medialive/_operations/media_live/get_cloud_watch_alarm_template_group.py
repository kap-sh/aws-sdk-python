"""Generated from Smithy shape ``com.amazonaws.medialive#GetCloudWatchAlarmTemplateGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_medialive.types.get_cloud_watch_alarm_template_group_response.GetCloudWatchAlarmTemplateGroupResponse = aws_sdk_medialive.types.get_cloud_watch_alarm_template_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.get_cloud_watch_alarm_template_group_request.GetCloudWatchAlarmTemplateGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_cloud_watch_alarm_template_group(
