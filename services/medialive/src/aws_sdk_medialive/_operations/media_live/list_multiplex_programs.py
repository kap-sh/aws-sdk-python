...
def handle_response(
    ...
    out: aws_sdk_medialive.types.list_multiplex_programs_response.ListMultiplexProgramsResponse = aws_sdk_medialive.types.list_multiplex_programs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.list_multiplex_programs_request.ListMultiplexProgramsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
