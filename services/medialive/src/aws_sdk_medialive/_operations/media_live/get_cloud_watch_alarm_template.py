...
def handle_response(
    ...
    out: aws_sdk_medialive.types.get_cloud_watch_alarm_template_response.GetCloudWatchAlarmTemplateResponse = aws_sdk_medialive.types.get_cloud_watch_alarm_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_medialive.types.get_cloud_watch_alarm_template_request.GetCloudWatchAlarmTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
