...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.__integer_min0_max8000000
    ...
    import aws_sdk_medialive.types.__integer_min50000_max12000000
    import aws_sdk_medialive.types.__integer_min50000_max24000000
    import aws_sdk_medialive.types.afd_signaling
    import aws_sdk_medialive.types.av1_bit_depth
    import aws_sdk_medialive.types.av1_color_space_settings
    import aws_sdk_medialive.types.av1_gop_size_units
    import aws_sdk_medialive.types.av1_level
    import aws_sdk_medialive.types.av1_look_ahead_rate_control
    import aws_sdk_medialive.types.av1_rate_control_mode
    import aws_sdk_medialive.types.av1_scene_change_detect
    import aws_sdk_medialive.types.av1_spatial_aq
    import aws_sdk_medialive.types.av1_temporal_aq
    import aws_sdk_medialive.types.av1_timecode_insertion_behavior
...
class Av1Settings(TypedDict, closed=True):
    ...
    buf_size: NotRequired[
        "aws_sdk_medialive.types.__integer_min50000_max24000000.__integerMin50000Max24000000"
    ]
    """The size of the buffer (HRD buffer model) in bits."""
    color_space_settings: NotRequired[
        "aws_sdk_medialive.types.av1_color_space_settings.Av1ColorSpaceSettings"
    ]
    ...
    gop_size: NotRequired["aws_sdk_medialive.types.__double_min0.__doubleMin0"]
    ...
    gop_size_units: NotRequired[
        "aws_sdk_medialive.types.av1_gop_size_units.Av1GopSizeUnits"
    ]
    ...
    level: NotRequired["aws_sdk_medialive.types.av1_level.Av1Level"]
    """Sets the level. This parameter is one of the properties of the encoding scheme for AV1."""
    look_ahead_rate_control: NotRequired[
        "aws_sdk_medialive.types.av1_look_ahead_rate_control.Av1LookAheadRateControl"
    ]
    ...
    max_bitrate: NotRequired[
        "aws_sdk_medialive.types.__integer_min50000_max12000000.__integerMin50000Max12000000"
    ]
    ...
    scene_change_detect: NotRequired[
        "aws_sdk_medialive.types.av1_scene_change_detect.Av1SceneChangeDetect"
    ]
    ...
    rate_control_mode: NotRequired[
        "aws_sdk_medialive.types.av1_rate_control_mode.Av1RateControlMode"
    ]
    ...
    min_bitrate: NotRequired[
        "aws_sdk_medialive.types.__integer_min0_max8000000.__integerMin0Max8000000"
    ]
    ...
    spatial_aq: NotRequired["aws_sdk_medialive.types.av1_spatial_aq.Av1SpatialAq"]
    ...
    temporal_aq: NotRequired["aws_sdk_medialive.types.av1_temporal_aq.Av1TemporalAq"]
    ...
    timecode_insertion: NotRequired[
        "aws_sdk_medialive.types.av1_timecode_insertion_behavior.Av1TimecodeInsertionBehavior"
    ]
    ...
    bit_depth: NotRequired["aws_sdk_medialive.types.av1_bit_depth.Av1BitDepth"]
...
def serialize_json(value: Av1Settings) -> dict:
    ...
    if "color_space_settings" in value:
        ...
        out["colorSpaceSettings"] = (
            aws_sdk_medialive.types.av1_color_space_settings.serialize_json(
    ...
    if "gop_size_units" in value:
        ...
        out["gopSizeUnits"] = aws_sdk_medialive.types.av1_gop_size_units.serialize_json(
            value["gop_size_units"]
        )
    if "level" in value:
        import aws_sdk_medialive.types.av1_level

        out["level"] = aws_sdk_medialive.types.av1_level.serialize_json(value["level"])
    if "look_ahead_rate_control" in value:
        import aws_sdk_medialive.types.av1_look_ahead_rate_control

        out["lookAheadRateControl"] = (
            aws_sdk_medialive.types.av1_look_ahead_rate_control.serialize_json(
    ...
    if "scene_change_detect" in value:
        ...
        out["sceneChangeDetect"] = (
            aws_sdk_medialive.types.av1_scene_change_detect.serialize_json(
    ...
    if "rate_control_mode" in value:
        ...
        out["rateControlMode"] = (
            aws_sdk_medialive.types.av1_rate_control_mode.serialize_json(
    ...
    if "spatial_aq" in value:
        ...
        out["spatialAq"] = aws_sdk_medialive.types.av1_spatial_aq.serialize_json(
            value["spatial_aq"]
        )
    if "temporal_aq" in value:
        import aws_sdk_medialive.types.av1_temporal_aq

        out["temporalAq"] = aws_sdk_medialive.types.av1_temporal_aq.serialize_json(
            value["temporal_aq"]
        )
    if "timecode_insertion" in value:
        ...
        out["timecodeInsertion"] = (
            aws_sdk_medialive.types.av1_timecode_insertion_behavior.serialize_json(
    ...
    if "bit_depth" in value:
        ...
        out["bitDepth"] = aws_sdk_medialive.types.av1_bit_depth.serialize_json(
            value["bit_depth"]
        )
    return out
...
def deserialize_json(data: dict) -> Av1Settings:
    ...
    if "colorSpaceSettings" in data:
        ...
        out["color_space_settings"] = (
            aws_sdk_medialive.types.av1_color_space_settings.deserialize_json(
    ...
    if "gopSizeUnits" in data:
        ...
        out["gop_size_units"] = (
            aws_sdk_medialive.types.av1_gop_size_units.deserialize_json(
                data["gopSizeUnits"]
            )
        )
    if "level" in data:
        ...
        out["level"] = aws_sdk_medialive.types.av1_level.deserialize_json(data["level"])
    if "lookAheadRateControl" in data:
        import aws_sdk_medialive.types.av1_look_ahead_rate_control

        out["look_ahead_rate_control"] = (
            aws_sdk_medialive.types.av1_look_ahead_rate_control.deserialize_json(
    ...
    if "sceneChangeDetect" in data:
        ...
        out["scene_change_detect"] = (
            aws_sdk_medialive.types.av1_scene_change_detect.deserialize_json(
    ...
    if "rateControlMode" in data:
        ...
        out["rate_control_mode"] = (
            aws_sdk_medialive.types.av1_rate_control_mode.deserialize_json(
    ...
    if "spatialAq" in data:
        ...
        out["spatial_aq"] = aws_sdk_medialive.types.av1_spatial_aq.deserialize_json(
            data["spatialAq"]
        )
    if "temporalAq" in data:
        import aws_sdk_medialive.types.av1_temporal_aq

        out["temporal_aq"] = aws_sdk_medialive.types.av1_temporal_aq.deserialize_json(
            data["temporalAq"]
        )
    if "timecodeInsertion" in data:
        ...
        out["timecode_insertion"] = (
            aws_sdk_medialive.types.av1_timecode_insertion_behavior.deserialize_json(
    ...
    if "bitDepth" in data:
        ...
        out["bit_depth"] = aws_sdk_medialive.types.av1_bit_depth.deserialize_json(
            data["bitDepth"]
        )
    return out
