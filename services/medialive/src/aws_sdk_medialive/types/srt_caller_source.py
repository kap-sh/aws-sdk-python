...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.srt_caller_decryption


class SrtCallerSource(TypedDict):
    decryption: NotRequired[
        "aws_sdk_medialive.types.srt_caller_decryption.SrtCallerDecryption"
    ]
...
def serialize_json(value: SrtCallerSource) -> dict:
    ...
    if "decryption" in value:
        ...
        out["decryption"] = (
            aws_sdk_medialive.types.srt_caller_decryption.serialize_json(
                value["decryption"]
            )
        )
...
def deserialize_json(data: dict) -> SrtCallerSource:
    ...
    if "decryption" in data:
        ...
        out["decryption"] = (
            aws_sdk_medialive.types.srt_caller_decryption.deserialize_json(
                data["decryption"]
            )
        )
