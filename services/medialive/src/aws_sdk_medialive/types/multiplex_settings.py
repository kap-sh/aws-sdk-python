...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.__integer_min0_max100000000
    import aws_sdk_medialive.types.__integer_min800_max3000
    import aws_sdk_medialive.types.__integer_min1000000_max100000000


class MultiplexSettings(TypedDict):
    maximum_video_buffer_delay_milliseconds: NotRequired[
        "aws_sdk_medialive.types.__integer_min800_max3000.__integerMin800Max3000"
    ]
    ...
    transport_stream_reserved_bitrate: NotRequired[
        "aws_sdk_medialive.types.__integer_min0_max100000000.__integerMin0Max100000000"
    ]
