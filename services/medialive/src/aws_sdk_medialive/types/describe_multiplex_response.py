"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeMultiplexResponse``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.__list_of_multiplex_output_destination
...
class DescribeMultiplexResponse(TypedDict, closed=True):
    ...
    destinations: NotRequired[
        "aws_sdk_medialive.types.__list_of_multiplex_output_destination.__listOfMultiplexOutputDestination"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeMultiplexResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
    ...
    if "destinations" in value:
        ...
        out["destinations"] = (
            aws_sdk_medialive.types.__list_of_multiplex_output_destination.serialize_json(
                value["destinations"]
            )
        )
    if "id" in value:
...
def deserialize_json(data: dict) -> DescribeMultiplexResponse:
    out: DescribeMultiplexResponse = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
    ...
    if "destinations" in data:
        ...
        out["destinations"] = (
            aws_sdk_medialive.types.__list_of_multiplex_output_destination.deserialize_json(
                data["destinations"]
            )
        )
    if "id" in data:
