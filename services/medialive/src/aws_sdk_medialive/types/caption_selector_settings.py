...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.arib_source_settings
    import aws_sdk_medialive.types.dvb_sub_source_settings
    import aws_sdk_medialive.types.embedded_source_settings
    import aws_sdk_medialive.types.scte20_source_settings
    import aws_sdk_medialive.types.scte27_source_settings
    import aws_sdk_medialive.types.smart_subtitle_source_settings
...
class CaptionSelectorSettings(TypedDict, closed=True):
    ...
    arib_source_settings: NotRequired[
        "aws_sdk_medialive.types.arib_source_settings.AribSourceSettings"
    ]
    dvb_sub_source_settings: NotRequired[
        "aws_sdk_medialive.types.dvb_sub_source_settings.DvbSubSourceSettings"
    ]
    embedded_source_settings: NotRequired[
        "aws_sdk_medialive.types.embedded_source_settings.EmbeddedSourceSettings"
    ]
    scte20_source_settings: NotRequired[
        "aws_sdk_medialive.types.scte20_source_settings.Scte20SourceSettings"
    ]
    scte27_source_settings: NotRequired[
        "aws_sdk_medialive.types.scte27_source_settings.Scte27SourceSettings"
    ]
    teletext_source_settings: NotRequired[
        "aws_sdk_medialive.types.teletext_source_settings.TeletextSourceSettings"
    ]
    smart_subtitle_source_settings: NotRequired[
        "aws_sdk_medialive.types.smart_subtitle_source_settings.SmartSubtitleSourceSettings"
    ]
...
def serialize_json(value: CaptionSelectorSettings) -> dict:
    ...
    if "ancillary_source_settings" in value:
        ...
        out["ancillarySourceSettings"] = (
            aws_sdk_medialive.types.ancillary_source_settings.serialize_json(
    ...
    if "arib_source_settings" in value:
        ...
        out["aribSourceSettings"] = (
            aws_sdk_medialive.types.arib_source_settings.serialize_json(
    ...
    if "dvb_sub_source_settings" in value:
        ...
        out["dvbSubSourceSettings"] = (
            aws_sdk_medialive.types.dvb_sub_source_settings.serialize_json(
    ...
    if "embedded_source_settings" in value:
        ...
        out["embeddedSourceSettings"] = (
            aws_sdk_medialive.types.embedded_source_settings.serialize_json(
    ...
    if "scte20_source_settings" in value:
        ...
        out["scte20SourceSettings"] = (
            aws_sdk_medialive.types.scte20_source_settings.serialize_json(
    ...
    if "scte27_source_settings" in value:
        ...
        out["scte27SourceSettings"] = (
            aws_sdk_medialive.types.scte27_source_settings.serialize_json(
    ...
    if "teletext_source_settings" in value:
        ...
        out["teletextSourceSettings"] = (
            aws_sdk_medialive.types.teletext_source_settings.serialize_json(
    ...
    if "smart_subtitle_source_settings" in value:
        ...
        out["smartSubtitleSourceSettings"] = (
            aws_sdk_medialive.types.smart_subtitle_source_settings.serialize_json(
...
def deserialize_json(data: dict) -> CaptionSelectorSettings:
    ...
    if "ancillarySourceSettings" in data:
        ...
        out["ancillary_source_settings"] = (
            aws_sdk_medialive.types.ancillary_source_settings.deserialize_json(
    ...
    if "aribSourceSettings" in data:
        ...
        out["arib_source_settings"] = (
            aws_sdk_medialive.types.arib_source_settings.deserialize_json(
    ...
    if "dvbSubSourceSettings" in data:
        ...
        out["dvb_sub_source_settings"] = (
            aws_sdk_medialive.types.dvb_sub_source_settings.deserialize_json(
    ...
    if "embeddedSourceSettings" in data:
        ...
        out["embedded_source_settings"] = (
            aws_sdk_medialive.types.embedded_source_settings.deserialize_json(
    ...
    if "scte20SourceSettings" in data:
        ...
        out["scte20_source_settings"] = (
            aws_sdk_medialive.types.scte20_source_settings.deserialize_json(
    ...
    if "scte27SourceSettings" in data:
        ...
        out["scte27_source_settings"] = (
            aws_sdk_medialive.types.scte27_source_settings.deserialize_json(
    ...
    if "teletextSourceSettings" in data:
        ...
        out["teletext_source_settings"] = (
            aws_sdk_medialive.types.teletext_source_settings.deserialize_json(
    ...
    if "smartSubtitleSourceSettings" in data:
        ...
        out["smart_subtitle_source_settings"] = (
            aws_sdk_medialive.types.smart_subtitle_source_settings.deserialize_json(
