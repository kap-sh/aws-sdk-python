...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.__integer_min40_max16000
    import aws_sdk_medialive.types.output_location_ref
    import aws_sdk_medialive.types.srt_encryption_type
    import aws_sdk_medialive.types.udp_container_settings


class SrtOutputSettings(TypedDict):
    ...
    container_settings: NotRequired[
        "aws_sdk_medialive.types.udp_container_settings.UdpContainerSettings"
    ]
    destination: NotRequired[
        "aws_sdk_medialive.types.output_location_ref.OutputLocationRef"
    ]
    encryption_type: NotRequired[
        "aws_sdk_medialive.types.srt_encryption_type.SrtEncryptionType"
    ]
    ...
    latency: NotRequired[
        "aws_sdk_medialive.types.__integer_min40_max16000.__integerMin40Max16000"
    ]
...
def serialize_json(value: SrtOutputSettings) -> dict:
    ...
    if "container_settings" in value:
        ...
        out["containerSettings"] = (
            aws_sdk_medialive.types.udp_container_settings.serialize_json(
    ...
    if "encryption_type" in value:
        ...
        out["encryptionType"] = (
            aws_sdk_medialive.types.srt_encryption_type.serialize_json(
...
def deserialize_json(data: dict) -> SrtOutputSettings:
    ...
    if "containerSettings" in data:
        ...
        out["container_settings"] = (
            aws_sdk_medialive.types.udp_container_settings.deserialize_json(
    ...
    if "encryptionType" in data:
        ...
        out["encryption_type"] = (
            aws_sdk_medialive.types.srt_encryption_type.deserialize_json(
                data["encryptionType"]
            )
        )
    if "latency" in data:
