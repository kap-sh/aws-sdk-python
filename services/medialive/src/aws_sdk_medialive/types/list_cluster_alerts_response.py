...
if TYPE_CHECKING:
    import aws_sdk_medialive.types.__list_of_cluster_alert
    import aws_sdk_medialive.types.__string


class ListClusterAlertsResponse(TypedDict):
    alerts: NotRequired[
        "aws_sdk_medialive.types.__list_of_cluster_alert.__listOfClusterAlert"
    ]
...
def serialize_json(value: ListClusterAlertsResponse) -> dict:
    ...
    if "alerts" in value:
        ...
        out["alerts"] = aws_sdk_medialive.types.__list_of_cluster_alert.serialize_json(
            value["alerts"]
        )
...
def deserialize_json(data: dict) -> ListClusterAlertsResponse:
    ...
    if "alerts" in data:
        ...
        out["alerts"] = (
            aws_sdk_medialive.types.__list_of_cluster_alert.deserialize_json(
                data["alerts"]
            )
        )
