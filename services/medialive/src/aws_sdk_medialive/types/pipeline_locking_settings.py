...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.pipeline_locking_method


class PipelineLockingSettings(TypedDict):
    pipeline_locking_method: NotRequired[
        "aws_sdk_medialive.types.pipeline_locking_method.PipelineLockingMethod"
    ]
...
def serialize_json(value: PipelineLockingSettings) -> dict:
    ...
    if "pipeline_locking_method" in value:
        ...
        out["pipelineLockingMethod"] = (
            aws_sdk_medialive.types.pipeline_locking_method.serialize_json(
...
def deserialize_json(data: dict) -> PipelineLockingSettings:
    ...
    if "pipelineLockingMethod" in data:
        ...
        out["pipeline_locking_method"] = (
            aws_sdk_medialive.types.pipeline_locking_method.deserialize_json(
