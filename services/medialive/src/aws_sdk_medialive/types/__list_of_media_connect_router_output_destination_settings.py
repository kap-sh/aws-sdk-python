...
if TYPE_CHECKING:
    import aws_sdk_medialive.types.media_connect_router_output_destination_settings

__listOfMediaConnectRouterOutputDestinationSettings: TypeAlias = list[
    "aws_sdk_medialive.types.media_connect_router_output_destination_settings.MediaConnectRouterOutputDestinationSettings"
]
...
def serialize_json(value: __listOfMediaConnectRouterOutputDestinationSettings) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_medialive.types.media_connect_router_output_destination_settings.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> __listOfMediaConnectRouterOutputDestinationSettings:
    ...
    for item in data:
        out.append(
            aws_sdk_medialive.types.media_connect_router_output_destination_settings.deserialize_json(
                item
            )
        )
    return out
