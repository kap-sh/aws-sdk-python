...
if TYPE_CHECKING:
    import aws_sdk_medialive.types.audio_description

__listOfAudioDescription: TypeAlias = list[
    "aws_sdk_medialive.types.audio_description.AudioDescription"
]
...
def serialize_json(value: __listOfAudioDescription) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_medialive.types.audio_description.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> __listOfAudioDescription:
    ...
    for item in data:
        out.append(aws_sdk_medialive.types.audio_description.deserialize_json(item))
    return out
