"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteMultiplexResponse``."""
...
class DeleteMultiplexResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteMultiplexResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> DeleteMultiplexResponse:
    out: DeleteMultiplexResponse = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
