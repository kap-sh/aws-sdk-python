...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.srt_listener_decryption


class SrtListenerSettings(TypedDict):
    decryption: NotRequired[
        "aws_sdk_medialive.types.srt_listener_decryption.SrtListenerDecryption"
    ]
...
def serialize_json(value: SrtListenerSettings) -> dict:
    ...
    if "decryption" in value:
        ...
        out["decryption"] = (
            aws_sdk_medialive.types.srt_listener_decryption.serialize_json(
                value["decryption"]
            )
        )
...
def deserialize_json(data: dict) -> SrtListenerSettings:
    ...
    if "decryption" in data:
        ...
        out["decryption"] = (
            aws_sdk_medialive.types.srt_listener_decryption.deserialize_json(
                data["decryption"]
            )
        )
