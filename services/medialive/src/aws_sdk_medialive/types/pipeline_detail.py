...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.media_connect_router_output_connections


class PipelineDetail(TypedDict, closed=True):
    active_input_attachment_name: NotRequired[
    ...
    active_motion_graphics_uri: NotRequired["aws_sdk_medialive.types.__string.__string"]
    ...
    media_connect_router_output_connection_map: NotRequired[
        "aws_sdk_medialive.types.media_connect_router_output_connections.MediaConnectRouterOutputConnections"
    ]
...
def serialize_json(value: PipelineDetail) -> dict:
    ...
    if "media_connect_router_output_connection_map" in value:
        ...
        out["mediaConnectRouterOutputConnectionMap"] = (
            aws_sdk_medialive.types.media_connect_router_output_connections.serialize_json(
...
def deserialize_json(data: dict) -> PipelineDetail:
    ...
    if "mediaConnectRouterOutputConnectionMap" in data:
        ...
        out["media_connect_router_output_connection_map"] = (
            aws_sdk_medialive.types.media_connect_router_output_connections.deserialize_json(
