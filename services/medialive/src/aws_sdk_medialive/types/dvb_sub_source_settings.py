...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.dvb_sub_ocr_language


class DvbSubSourceSettings(TypedDict, closed=True):
    ocr_language: NotRequired[
        "aws_sdk_medialive.types.dvb_sub_ocr_language.DvbSubOcrLanguage"
    ]
...
def serialize_json(value: DvbSubSourceSettings) -> dict:
    ...
    if "ocr_language" in value:
        ...
        out["ocrLanguage"] = (
            aws_sdk_medialive.types.dvb_sub_ocr_language.serialize_json(
                value["ocr_language"]
            )
        )
    if "pid" in value:
...
def deserialize_json(data: dict) -> DvbSubSourceSettings:
    ...
    if "ocrLanguage" in data:
        ...
        out["ocr_language"] = (
            aws_sdk_medialive.types.dvb_sub_ocr_language.deserialize_json(
                data["ocrLanguage"]
            )
        )
    if "pid" in data:
