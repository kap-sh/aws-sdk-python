...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.channel_alert_state


class ChannelAlert(TypedDict):
    ...
    state: NotRequired["aws_sdk_medialive.types.channel_alert_state.ChannelAlertState"]
...
def serialize_json(value: ChannelAlert) -> dict:
    ...
    if "state" in value:
        ...
        out["state"] = aws_sdk_medialive.types.channel_alert_state.serialize_json(
            value["state"]
        )
    return out
...
def deserialize_json(data: dict) -> ChannelAlert:
    ...
    if "state" in data:
        ...
        out["state"] = aws_sdk_medialive.types.channel_alert_state.deserialize_json(
            data["state"]
        )
    return out
