...
if TYPE_CHECKING:
    import aws_sdk_medialive.types.interface_mapping_create_request

__listOfInterfaceMappingCreateRequest: TypeAlias = list[
    "aws_sdk_medialive.types.interface_mapping_create_request.InterfaceMappingCreateRequest"
]
...
def serialize_json(value: __listOfInterfaceMappingCreateRequest) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_medialive.types.interface_mapping_create_request.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> __listOfInterfaceMappingCreateRequest:
    ...
    for item in data:
        out.append(
            aws_sdk_medialive.types.interface_mapping_create_request.deserialize_json(
                item
            )
        )
    return out
