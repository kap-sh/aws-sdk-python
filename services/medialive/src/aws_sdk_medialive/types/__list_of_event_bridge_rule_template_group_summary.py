...
__listOfEventBridgeRuleTemplateGroupSummary: TypeAlias = list[
    "aws_sdk_medialive.types.event_bridge_rule_template_group_summary.EventBridgeRuleTemplateGroupSummary"
]
...
def serialize_json(value: __listOfEventBridgeRuleTemplateGroupSummary) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_medialive.types.event_bridge_rule_template_group_summary.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> __listOfEventBridgeRuleTemplateGroupSummary:
    ...
    for item in data:
        out.append(
            aws_sdk_medialive.types.event_bridge_rule_template_group_summary.deserialize_json(
                item
            )
        )
    return out
