...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.__list_of_failover_condition
    import aws_sdk_medialive.types.__string
    import aws_sdk_medialive.types.input_preference


class AutomaticInputFailoverSettings(TypedDict):
    ...
    failover_conditions: NotRequired[
        "aws_sdk_medialive.types.__list_of_failover_condition.__listOfFailoverCondition"
    ]
    """A list of failover conditions. If any of these conditions occur, MediaLive will perform a failover to the other input."""
    input_preference: NotRequired[
        "aws_sdk_medialive.types.input_preference.InputPreference"
    ]
    """Input preference when deciding which input to make active when a previously failed input has recovered."""
    secondary_input_id: NotRequired["aws_sdk_medialive.types.__string.__string"]
...
def serialize_json(value: AutomaticInputFailoverSettings) -> dict:
    ...
    if "failover_conditions" in value:
        ...
        out["failoverConditions"] = (
            aws_sdk_medialive.types.__list_of_failover_condition.serialize_json(
    ...
    if "input_preference" in value:
        ...
        out["inputPreference"] = (
            aws_sdk_medialive.types.input_preference.serialize_json(
...
def deserialize_json(data: dict) -> AutomaticInputFailoverSettings:
    ...
    if "failoverConditions" in data:
        ...
        out["failover_conditions"] = (
            aws_sdk_medialive.types.__list_of_failover_condition.deserialize_json(
    ...
    if "inputPreference" in data:
        ...
        out["input_preference"] = (
            aws_sdk_medialive.types.input_preference.deserialize_json(
