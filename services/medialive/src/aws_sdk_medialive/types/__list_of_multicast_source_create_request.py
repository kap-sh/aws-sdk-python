...
if TYPE_CHECKING:
    import aws_sdk_medialive.types.multicast_source_create_request

__listOfMulticastSourceCreateRequest: TypeAlias = list[
    "aws_sdk_medialive.types.multicast_source_create_request.MulticastSourceCreateRequest"
]
...
def serialize_json(value: __listOfMulticastSourceCreateRequest) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_medialive.types.multicast_source_create_request.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> __listOfMulticastSourceCreateRequest:
    ...
    for item in data:
        out.append(
            aws_sdk_medialive.types.multicast_source_create_request.deserialize_json(
                item
            )
        )
    return out
