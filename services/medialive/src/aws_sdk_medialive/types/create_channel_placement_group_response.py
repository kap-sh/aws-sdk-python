"""Generated from Smithy shape ``com.amazonaws.medialive#CreateChannelPlacementGroupResponse``."""
...
class CreateChannelPlacementGroupResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateChannelPlacementGroupResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateChannelPlacementGroupResponse:
    out: CreateChannelPlacementGroupResponse = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
    if "channels" in data:
        import aws_sdk_medialive.types.__list_of__string
