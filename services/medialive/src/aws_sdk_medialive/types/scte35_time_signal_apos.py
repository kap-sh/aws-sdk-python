...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.scte35_apos_no_regional_blackout_behavior
    import aws_sdk_medialive.types.scte35_apos_web_delivery_allowed_behavior


class Scte35TimeSignalApos(TypedDict):
    ...
    no_regional_blackout_flag: NotRequired[
        "aws_sdk_medialive.types.scte35_apos_no_regional_blackout_behavior.Scte35AposNoRegionalBlackoutBehavior"
    ]
    """When set to ignore, Segment Descriptors with noRegionalBlackoutFlag set to 0 will no longer trigger blackouts or Ad Avail slates"""
    web_delivery_allowed_flag: NotRequired[
        "aws_sdk_medialive.types.scte35_apos_web_delivery_allowed_behavior.Scte35AposWebDeliveryAllowedBehavior"
    ]
...
def serialize_json(value: Scte35TimeSignalApos) -> dict:
    ...
    if "no_regional_blackout_flag" in value:
        ...
        out["noRegionalBlackoutFlag"] = (
            aws_sdk_medialive.types.scte35_apos_no_regional_blackout_behavior.serialize_json(
    ...
    if "web_delivery_allowed_flag" in value:
        ...
        out["webDeliveryAllowedFlag"] = (
            aws_sdk_medialive.types.scte35_apos_web_delivery_allowed_behavior.serialize_json(
...
def deserialize_json(data: dict) -> Scte35TimeSignalApos:
    ...
    if "noRegionalBlackoutFlag" in data:
        ...
        out["no_regional_blackout_flag"] = (
            aws_sdk_medialive.types.scte35_apos_no_regional_blackout_behavior.deserialize_json(
    ...
    if "webDeliveryAllowedFlag" in data:
        ...
        out["web_delivery_allowed_flag"] = (
            aws_sdk_medialive.types.scte35_apos_web_delivery_allowed_behavior.deserialize_json(
