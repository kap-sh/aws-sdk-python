...
if TYPE_CHECKING:
    import aws_sdk_medialive.types.__integer_min1_max800
    import aws_sdk_medialive.types.__integer_min80_max800
    import aws_sdk_medialive.types.__string
    import aws_sdk_medialive.types.__string_max1000
    import aws_sdk_medialive.types.ebu_tt_d_destination_style_control
    import aws_sdk_medialive.types.ebu_tt_d_fill_line_gap_control


class EbuTtDDestinationSettings(TypedDict):
    copyright_holder: NotRequired[
        "aws_sdk_medialive.types.__string_max1000.__stringMax1000"
    ]
    """Complete this field if you want to include the name of the copyright holder in the copyright tag in the captions metadata."""
    fill_line_gap: NotRequired[
        "aws_sdk_medialive.types.ebu_tt_d_fill_line_gap_control.EbuTtDFillLineGapControl"
    ]
    """Specifies how to handle the gap between the lines (in multi-line captions). ENABLED: Fill with the captions background color (as specified in the input captions). DISABLED: Leave the gap unfilled"""
    font_family: NotRequired["aws_sdk_medialive.types.__string.__string"]
    ...
    style_control: NotRequired[
        "aws_sdk_medialive.types.ebu_tt_d_destination_style_control.EbuTtDDestinationStyleControl"
    ]
    ...
    default_font_size: NotRequired[
        "aws_sdk_medialive.types.__integer_min1_max800.__integerMin1Max800"
    ]
    ...
    default_line_height: NotRequired[
        "aws_sdk_medialive.types.__integer_min80_max800.__integerMin80Max800"
    ]
...
def serialize_json(value: EbuTtDDestinationSettings) -> dict:
    ...
    if "fill_line_gap" in value:
        ...
        out["fillLineGap"] = (
            aws_sdk_medialive.types.ebu_tt_d_fill_line_gap_control.serialize_json(
                value["fill_line_gap"]
            )
        )
    ...
    if "style_control" in value:
        ...
        out["styleControl"] = (
            aws_sdk_medialive.types.ebu_tt_d_destination_style_control.serialize_json(
                value["style_control"]
            )
        )
...
def deserialize_json(data: dict) -> EbuTtDDestinationSettings:
    ...
    if "fillLineGap" in data:
        ...
        out["fill_line_gap"] = (
            aws_sdk_medialive.types.ebu_tt_d_fill_line_gap_control.deserialize_json(
                data["fillLineGap"]
            )
        )
    ...
    if "styleControl" in data:
        ...
        out["style_control"] = (
            aws_sdk_medialive.types.ebu_tt_d_destination_style_control.deserialize_json(
                data["styleControl"]
            )
        )
