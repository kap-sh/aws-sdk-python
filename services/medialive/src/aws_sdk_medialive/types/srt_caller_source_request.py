...
if TYPE_CHECKING:
    ...
    import aws_sdk_medialive.types.srt_caller_decryption_request


class SrtCallerSourceRequest(TypedDict):
    decryption: NotRequired[
        "aws_sdk_medialive.types.srt_caller_decryption_request.SrtCallerDecryptionRequest"
    ]
    ...
    srt_listener_address: NotRequired["aws_sdk_medialive.types.__string.__string"]
    """The IP address at the upstream system (the listener) that MediaLive (the caller) will connect to."""
    srt_listener_port: NotRequired["aws_sdk_medialive.types.__string.__string"]
...
def serialize_json(value: SrtCallerSourceRequest) -> dict:
    ...
    if "decryption" in value:
        ...
        out["decryption"] = (
            aws_sdk_medialive.types.srt_caller_decryption_request.serialize_json(
                value["decryption"]
            )
        )
...
def deserialize_json(data: dict) -> SrtCallerSourceRequest:
    ...
    if "decryption" in data:
        ...
        out["decryption"] = (
            aws_sdk_medialive.types.srt_caller_decryption_request.deserialize_json(
                data["decryption"]
            )
        )
