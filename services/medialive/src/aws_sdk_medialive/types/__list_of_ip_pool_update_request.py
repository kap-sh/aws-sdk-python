...
if TYPE_CHECKING:
    import aws_sdk_medialive.types.ip_pool_update_request

__listOfIpPoolUpdateRequest: TypeAlias = list[
    "aws_sdk_medialive.types.ip_pool_update_request.IpPoolUpdateRequest"
]
...
def serialize_json(value: __listOfIpPoolUpdateRequest) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_medialive.types.ip_pool_update_request.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> __listOfIpPoolUpdateRequest:
    ...
    for item in data:
        out.append(
            aws_sdk_medialive.types.ip_pool_update_request.deserialize_json(item)
        )
    return out
