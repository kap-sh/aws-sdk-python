"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteSdiSourceResponse``."""
...
class DeleteSdiSourceResponse(TypedDict, closed=True):
    sdi_source: NotRequired["aws_sdk_medialive.types.sdi_source.SdiSource"]
    """Settings for the SDI source."""


# --- restJson1 ser/de ---
def serialize_json(value: DeleteSdiSourceResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DeleteSdiSourceResponse:
    out: DeleteSdiSourceResponse = {}  # type: ignore[typeddict-item]
