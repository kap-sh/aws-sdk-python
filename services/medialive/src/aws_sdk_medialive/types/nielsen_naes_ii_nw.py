...
class NielsenNaesIiNw(TypedDict):
    ...
    sid: NotRequired[
        "aws_sdk_medialive.types.__double_min1_max65535.__doubleMin1Max65535"
    ]
    """Enter the Nielsen Source ID (SID) to include in the watermark"""
    timezone: NotRequired[
        "aws_sdk_medialive.types.nielsen_watermark_timezones.NielsenWatermarkTimezones"
    ]
...
def serialize_json(value: NielsenNaesIiNw) -> dict:
    ...
    if "timezone" in value:
        ...
        out["timezone"] = (
            aws_sdk_medialive.types.nielsen_watermark_timezones.serialize_json(
                value["timezone"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> NielsenNaesIiNw:
    ...
    if "timezone" in data:
        ...
        out["timezone"] = (
            aws_sdk_medialive.types.nielsen_watermark_timezones.deserialize_json(
                data["timezone"]
            )
        )
    return out
