...
from capo_rbin._services._aws_config import aws_config
...
class rbinClientConfig(TypedDict, total=False, closed=True):
...
class rbinClient:
    ...
    def create_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rbin.types.create_rule_request.CreateRuleRequest]",
        ) -> OperationResponse[
            "capo_rbin.types.create_rule_response.CreateRuleResponse"
        ]:
            ...
            output, http_response = (
                capo_rbin._operations.amazon_recycle_bin.create_rule.create_rule(
    ...
    def delete_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rbin.types.delete_rule_request.DeleteRuleRequest]",
        ) -> OperationResponse[
            "capo_rbin.types.delete_rule_response.DeleteRuleResponse"
        ]:
            ...
            output, http_response = (
                capo_rbin._operations.amazon_recycle_bin.delete_rule.delete_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rbin.types.get_rule_request.GetRuleRequest]",
        ) -> OperationResponse["capo_rbin.types.get_rule_response.GetRuleResponse"]:
            import capo_rbin._operations.amazon_recycle_bin.get_rule

            output, http_response = (
                capo_rbin._operations.amazon_recycle_bin.get_rule.get_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_rules(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rbin.types.list_rules_request.ListRulesRequest]",
        ) -> OperationResponse["capo_rbin.types.list_rules_response.ListRulesResponse"]:
            import capo_rbin._operations.amazon_recycle_bin.list_rules

            output, http_response = (
                capo_rbin._operations.amazon_recycle_bin.list_rules.list_rules(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_rbin.types.rule_summary.RuleSummary]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rbin.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_rbin.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_rbin._operations.amazon_recycle_bin.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def lock_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rbin.types.lock_rule_request.LockRuleRequest]",
        ) -> OperationResponse["capo_rbin.types.lock_rule_response.LockRuleResponse"]:
            import capo_rbin._operations.amazon_recycle_bin.lock_rule

            output, http_response = (
                capo_rbin._operations.amazon_recycle_bin.lock_rule.lock_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rbin.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_rbin.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_rbin._operations.amazon_recycle_bin.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def unlock_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rbin.types.unlock_rule_request.UnlockRuleRequest]",
        ) -> OperationResponse[
            "capo_rbin.types.unlock_rule_response.UnlockRuleResponse"
        ]:
            ...
            output, http_response = (
                capo_rbin._operations.amazon_recycle_bin.unlock_rule.unlock_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rbin.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_rbin.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_rbin._operations.amazon_recycle_bin.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rbin.types.update_rule_request.UpdateRuleRequest]",
        ) -> OperationResponse[
            "capo_rbin.types.update_rule_response.UpdateRuleResponse"
        ]:
            ...
            output, http_response = (
                capo_rbin._operations.amazon_recycle_bin.update_rule.update_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
