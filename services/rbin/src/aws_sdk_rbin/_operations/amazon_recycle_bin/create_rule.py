...
def handle_response(
    ...
    out: aws_sdk_rbin.types.create_rule_response.CreateRuleResponse = (
        aws_sdk_rbin.types.create_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rbin.types.create_rule_request.CreateRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rbin.types.create_rule_request.serialize_json(input_)
    ).encode()
...
def create_rule(
    ...
    input_: aws_sdk_rbin.types.create_rule_request.CreateRuleRequest,
) -> tuple[aws_sdk_rbin.types.create_rule_response.CreateRuleResponse, zapros.Response]:
