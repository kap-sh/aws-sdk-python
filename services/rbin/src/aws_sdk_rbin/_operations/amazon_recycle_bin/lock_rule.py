"""Generated from Smithy shape ``com.amazonaws.rbin#LockRule``."""
...
def handle_response(
    ...
    out: aws_sdk_rbin.types.lock_rule_response.LockRuleResponse = (
        aws_sdk_rbin.types.lock_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rbin.types.lock_rule_request.LockRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/rules/{Identifier}/lock"
    url = url.replace("{Identifier}", quote(str(input_["identifier"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_rbin.types.lock_rule_request.serialize_json(input_)
    ).encode()
...
def lock_rule(
    ...
    input_: aws_sdk_rbin.types.lock_rule_request.LockRuleRequest,
) -> tuple[aws_sdk_rbin.types.lock_rule_response.LockRuleResponse, zapros.Response]:
