...
def handle_response(
    ...
    out: aws_sdk_rbin.types.delete_rule_response.DeleteRuleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_rbin.types.delete_rule_request.DeleteRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_rule(
    ...
    input_: aws_sdk_rbin.types.delete_rule_request.DeleteRuleRequest,
) -> tuple[aws_sdk_rbin.types.delete_rule_response.DeleteRuleResponse, zapros.Response]:
