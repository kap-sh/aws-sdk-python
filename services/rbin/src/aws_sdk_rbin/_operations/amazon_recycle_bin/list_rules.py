...
def build_request(
    ...
    input_: aws_sdk_rbin.types.list_rules_request.ListRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rbin.types.list_rules_request.serialize_json(input_)
    ).encode()
...
def list_rules(
    ...
    input_: aws_sdk_rbin.types.list_rules_request.ListRulesRequest,
) -> tuple[aws_sdk_rbin.types.list_rules_response.ListRulesResponse, zapros.Response]:
