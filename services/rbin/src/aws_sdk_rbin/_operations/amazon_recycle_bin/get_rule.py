...
def handle_response(
    ...
    out: aws_sdk_rbin.types.get_rule_response.GetRuleResponse = (
        aws_sdk_rbin.types.get_rule_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_rbin.types.get_rule_request.GetRuleRequest,
) -> zapros.Request:
...
def get_rule(
    options: OperationOptions, input: aws_sdk_rbin.types.get_rule_request.GetRuleRequest
) -> tuple[aws_sdk_rbin.types.get_rule_response.GetRuleResponse, zapros.Response]:
