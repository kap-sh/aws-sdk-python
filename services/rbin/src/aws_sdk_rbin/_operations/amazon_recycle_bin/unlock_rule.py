...
def handle_response(
    ...
    out: aws_sdk_rbin.types.unlock_rule_response.UnlockRuleResponse = (
        aws_sdk_rbin.types.unlock_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rbin.types.unlock_rule_request.UnlockRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def unlock_rule(
    ...
    input_: aws_sdk_rbin.types.unlock_rule_request.UnlockRuleRequest,
) -> tuple[aws_sdk_rbin.types.unlock_rule_response.UnlockRuleResponse, zapros.Response]:
