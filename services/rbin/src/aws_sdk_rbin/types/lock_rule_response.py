"""Generated from Smithy shape ``com.amazonaws.rbin#LockRuleResponse``."""
...
class LockRuleResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: LockRuleResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> LockRuleResponse:
    out: LockRuleResponse = {}  # type: ignore[typeddict-item]
