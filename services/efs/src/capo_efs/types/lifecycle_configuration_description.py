...
class LifecycleConfigurationDescription(TypedDict, closed=True):
    lifecycle_policies: NotRequired[
        "capo_efs.types.lifecycle_policies.LifecyclePolicies"
    ]
...
def serialize_json(value: LifecycleConfigurationDescription) -> dict:
    ...
    if "lifecycle_policies" in value:
        ...
        out["LifecyclePolicies"] = capo_efs.types.lifecycle_policies.serialize_json(
