...
class CreateFileSystemRequest(TypedDict, closed=True):
    ...
    performance_mode: NotRequired["capo_efs.types.performance_mode.PerformanceMode"]
    ...
    backup: NotRequired["capo_efs.types.backup.Backup"]
