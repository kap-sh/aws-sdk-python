...
class DescribeReplicationConfigurationsResponse(TypedDict, closed=True):
    replications: NotRequired[
        "capo_efs.types.replication_configuration_descriptions.ReplicationConfigurationDescriptions"
    ]
...
def serialize_json(value: DescribeReplicationConfigurationsResponse) -> dict:
    ...
    if "replications" in value:
        ...
        out["Replications"] = (
            capo_efs.types.replication_configuration_descriptions.serialize_json(
                value["replications"]
            )
        )
...
def deserialize_json(data: dict) -> DescribeReplicationConfigurationsResponse:
    ...
    if "Replications" in data:
        ...
        out["replications"] = (
            capo_efs.types.replication_configuration_descriptions.deserialize_json(
                data["Replications"]
            )
        )
