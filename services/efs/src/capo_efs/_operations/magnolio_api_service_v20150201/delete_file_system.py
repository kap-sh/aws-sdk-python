...
import capo_efs.errors.file_system_in_use
import capo_efs.errors.file_system_not_found
import capo_efs.errors.internal_server_error
import capo_efs.types.delete_file_system_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FileSystemInUse":
            raise capo_efs.errors.file_system_in_use.FileSystemInUse.from_json(data)
