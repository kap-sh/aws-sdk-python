"""Generated from Smithy shape ``com.amazonaws.efs#DescribeMountTargets``."""
...
import capo_efs.types.describe_mount_targets_request
import capo_efs.types.describe_mount_targets_response
...
) -> capo_efs.types.describe_mount_targets_response.DescribeMountTargetsResponse:
    out: capo_efs.types.describe_mount_targets_response.DescribeMountTargetsResponse = (
        capo_efs.types.describe_mount_targets_response.deserialize_json(
