...
import capo_efs.errors.incorrect_mount_target_state
...
import capo_efs.types.modify_mount_target_security_groups_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IncorrectMountTargetState":
            raise capo_efs.errors.incorrect_mount_target_state.IncorrectMountTargetState.from_json(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_efs.types.modify_mount_target_security_groups_request.serialize_json(
            input_
        )
    ).encode()
