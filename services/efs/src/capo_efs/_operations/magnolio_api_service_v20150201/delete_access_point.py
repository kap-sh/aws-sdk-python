"""Generated from Smithy shape ``com.amazonaws.efs#DeleteAccessPoint``."""
...
import capo_efs.types.delete_access_point_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2015-02-01/access-points/{AccessPointId}"
