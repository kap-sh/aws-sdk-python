"""Generated from Smithy shape ``com.amazonaws.efs#TagResource``."""
...
import capo_efs.types.tag_resource_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_efs.types.tag_resource_request.serialize_json(input_)
    ).encode()
