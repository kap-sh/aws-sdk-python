...
import capo_efs.types.describe_tags_request
import capo_efs.types.describe_tags_response
...
) -> capo_efs.types.describe_tags_response.DescribeTagsResponse:
    out: capo_efs.types.describe_tags_response.DescribeTagsResponse = (
        capo_efs.types.describe_tags_response.deserialize_json(
...
def describe_tags(
    ...
    input_: capo_efs.types.describe_tags_request.DescribeTagsRequest,
) -> tuple[capo_efs.types.describe_tags_response.DescribeTagsResponse, zapros.Response]:
