"""Generated from Smithy shape ``com.amazonaws.efs#DescribeLifecycleConfiguration``."""
...
import capo_efs.types.describe_lifecycle_configuration_request
import capo_efs.types.lifecycle_configuration_description
...
def handle_response(
    ...
    capo_efs.types.lifecycle_configuration_description.LifecycleConfigurationDescription
):
    out: capo_efs.types.lifecycle_configuration_description.LifecycleConfigurationDescription = capo_efs.types.lifecycle_configuration_description.deserialize_json(
...
async def async_describe_lifecycle_configuration(
