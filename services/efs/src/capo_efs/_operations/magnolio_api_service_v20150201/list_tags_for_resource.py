"""Generated from Smithy shape ``com.amazonaws.efs#ListTagsForResource``."""
...
import capo_efs.errors.access_point_not_found
...
import capo_efs.types.list_tags_for_resource_request
import capo_efs.types.list_tags_for_resource_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessPointNotFound":
            raise capo_efs.errors.access_point_not_found.AccessPointNotFound.from_json(
                data
            )
        case "BadRequest":
...
) -> capo_efs.types.list_tags_for_resource_response.ListTagsForResourceResponse:
    out: capo_efs.types.list_tags_for_resource_response.ListTagsForResourceResponse = (
        capo_efs.types.list_tags_for_resource_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2015-02-01/resource-tags/{ResourceId}"
