...
def handle_response(
    ...
    out: aws_sdk_efs.types.describe_file_systems_response.DescribeFileSystemsResponse = aws_sdk_efs.types.describe_file_systems_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_efs.types.describe_file_systems_request.DescribeFileSystemsRequest,
) -> zapros.Request:
    ...
    if "creation_token" in input:
        params["CreationToken"] = str(input["creation_token"])
