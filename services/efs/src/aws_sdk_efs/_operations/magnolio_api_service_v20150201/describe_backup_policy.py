...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ValidationException":
            import aws_sdk_efs.errors.validation_exception

            raise aws_sdk_efs.errors.validation_exception.ValidationException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_efs.types.backup_policy_description.BackupPolicyDescription = (
        aws_sdk_efs.types.backup_policy_description.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_efs.types.describe_backup_policy_request.DescribeBackupPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_backup_policy(
    ...
    aws_sdk_efs.types.backup_policy_description.BackupPolicyDescription, zapros.Response
]:
