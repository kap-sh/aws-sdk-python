...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPolicyException":
            import aws_sdk_efs.errors.invalid_policy_exception

            raise aws_sdk_efs.errors.invalid_policy_exception.InvalidPolicyException.from_json(
                data
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_efs.types.put_file_system_policy_request.PutFileSystemPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_efs.types.put_file_system_policy_request.serialize_json(input_)
    ).encode()
