...
def build_request(
    ...
    input_: aws_sdk_efs.types.describe_account_preferences_request.DescribeAccountPreferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_efs.types.describe_account_preferences_request.serialize_json(input_)
    ).encode()
