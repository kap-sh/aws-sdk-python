...
def build_request(
    ...
    input: aws_sdk_efs.types.describe_account_preferences_request.DescribeAccountPreferencesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_efs.types.describe_account_preferences_request.serialize_json(input)
    ).encode()
