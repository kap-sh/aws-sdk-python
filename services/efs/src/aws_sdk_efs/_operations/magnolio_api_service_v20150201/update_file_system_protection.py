...
def build_request(
    ...
    input: aws_sdk_efs.types.update_file_system_protection_request.UpdateFileSystemProtectionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_efs.types.update_file_system_protection_request.serialize_json(input)
    ).encode()
