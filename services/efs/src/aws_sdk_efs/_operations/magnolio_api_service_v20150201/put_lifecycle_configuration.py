...
def build_request(
    ...
    input: aws_sdk_efs.types.put_lifecycle_configuration_request.PutLifecycleConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_efs.types.put_lifecycle_configuration_request.serialize_json(input)
    ).encode()
