...
def build_request(
    ...
    input_: aws_sdk_efs.types.delete_replication_configuration_request.DeleteReplicationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{SourceFileSystemId}", quote(str(input_["source_file_system_id"]), safe="")
    )
    params: dict[str, str] = {}
