"""Generated from Smithy shape ``com.amazonaws.efs#DeleteReplicationConfiguration``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ReplicationNotFound":
            import aws_sdk_efs.errors.replication_not_found

            raise aws_sdk_efs.errors.replication_not_found.ReplicationNotFound.from_json(
                data
            )
        case _:
...
def build_request(
    ...
    input: aws_sdk_efs.types.delete_replication_configuration_request.DeleteReplicationConfigurationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{SourceFileSystemId}", quote(str(input["source_file_system_id"]), safe="")
    )
    params: dict[str, str] = {}
    if "deletion_mode" in input:
        params["deletionMode"] = str(input["deletion_mode"])
...
async def async_delete_replication_configuration(
