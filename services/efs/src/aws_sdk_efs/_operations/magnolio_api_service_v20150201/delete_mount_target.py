...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DependencyTimeout":
            import aws_sdk_efs.errors.dependency_timeout

            raise aws_sdk_efs.errors.dependency_timeout.DependencyTimeout.from_json(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_efs.types.delete_mount_target_request.DeleteMountTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
