"""Generated from Smithy shape ``com.amazonaws.efs#DeleteFileSystem``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FileSystemInUse":
            import aws_sdk_efs.errors.file_system_in_use

            raise aws_sdk_efs.errors.file_system_in_use.FileSystemInUse.from_json(data)
...
def build_request(
    ...
    input_: aws_sdk_efs.types.delete_file_system_request.DeleteFileSystemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_file_system(
