...
def handle_response(
    ...
    out: aws_sdk_efs.types.describe_mount_target_security_groups_response.DescribeMountTargetSecurityGroupsResponse = aws_sdk_efs.types.describe_mount_target_security_groups_response.deserialize_json(
