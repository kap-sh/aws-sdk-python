...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_efs.errors.conflict_exception

            raise aws_sdk_efs.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_efs.types.replication_configuration_description.ReplicationConfigurationDescription = aws_sdk_efs.types.replication_configuration_description.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_efs.types.create_replication_configuration_request.CreateReplicationConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_efs.types.create_replication_configuration_request.serialize_json(input)
    ).encode()
