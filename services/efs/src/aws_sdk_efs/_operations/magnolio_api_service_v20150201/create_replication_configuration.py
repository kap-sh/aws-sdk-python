...
def build_request(
    ...
    input_: aws_sdk_efs.types.create_replication_configuration_request.CreateReplicationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_efs.types.create_replication_configuration_request.serialize_json(
            input_
        )
    ).encode()
