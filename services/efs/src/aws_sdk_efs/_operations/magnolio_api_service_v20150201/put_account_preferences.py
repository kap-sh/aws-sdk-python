"""Generated from Smithy shape ``com.amazonaws.efs#PutAccountPreferences``."""
...
def handle_response(
    ...
    out: aws_sdk_efs.types.put_account_preferences_response.PutAccountPreferencesResponse = aws_sdk_efs.types.put_account_preferences_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_efs.types.put_account_preferences_request.PutAccountPreferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_efs.types.put_account_preferences_request.serialize_json(input_)
    ).encode()
...
async def async_put_account_preferences(
