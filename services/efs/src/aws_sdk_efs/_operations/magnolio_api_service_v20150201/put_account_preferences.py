...
def build_request(
    ...
    input: aws_sdk_efs.types.put_account_preferences_request.PutAccountPreferencesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_efs.types.put_account_preferences_request.serialize_json(input)
    ).encode()
