...
def handle_response(
    ...
    out: aws_sdk_efs.types.describe_replication_configurations_response.DescribeReplicationConfigurationsResponse = aws_sdk_efs.types.describe_replication_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_efs.types.describe_replication_configurations_request.DescribeReplicationConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
