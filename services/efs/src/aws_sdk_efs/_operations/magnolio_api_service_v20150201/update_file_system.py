"""Generated from Smithy shape ``com.amazonaws.efs#UpdateFileSystem``."""
...
def build_request(
    ...
    input: aws_sdk_efs.types.update_file_system_request.UpdateFileSystemRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/2015-02-01/file-systems/{FileSystemId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_efs.types.update_file_system_request.serialize_json(input)
    ).encode()
