...
from aws_sdk_efs._services._aws_config import aws_config
...
class EFSClientConfig(TypedDict, total=False, closed=True):
...
class EFSClient:
    ...
    def operation_options(
        self, config_overrides: Optional[EFSClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: EFSClientConfig = config_overrides or {}
    ...
    def create_access_point(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.create_access_point_request.CreateAccessPointRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.access_point_description.AccessPointDescription"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.create_access_point.create_access_point(
    ...
    def create_file_system(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.create_file_system_request.CreateFileSystemRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.file_system_description.FileSystemDescription"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.create_file_system.create_file_system(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_mount_target(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_mount_target(file_system_id='fs-01234567', subnet_id='subnet-1234abcd')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.create_mount_target_request.CreateMountTargetRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.mount_target_description.MountTargetDescription"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.create_mount_target.create_mount_target(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_replication_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.create_replication_configuration_request.CreateReplicationConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.replication_configuration_description.ReplicationConfigurationDescription"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.create_replication_configuration.create_replication_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_tags(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_tags(file_system_id='fs-01234567', tags=[{'Key': 'Name', 'Value': 'MyFileSystem'}])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.create_tags_request.CreateTagsRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_efs._operations.magnolio_api_service_v20150201.create_tags

            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.create_tags.create_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_access_point(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.delete_access_point_request.DeleteAccessPointRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_efs._operations.magnolio_api_service_v20150201.delete_access_point

            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.delete_access_point.delete_access_point(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_file_system(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_file_system(file_system_id='fs-01234567')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.delete_file_system_request.DeleteFileSystemRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_efs._operations.magnolio_api_service_v20150201.delete_file_system

            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.delete_file_system.delete_file_system(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_file_system_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.delete_file_system_policy_request.DeleteFileSystemPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_efs._operations.magnolio_api_service_v20150201.delete_file_system_policy

            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.delete_file_system_policy.delete_file_system_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_mount_target(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_mount_target(mount_target_id='fsmt-12340abc')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.delete_mount_target_request.DeleteMountTargetRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_efs._operations.magnolio_api_service_v20150201.delete_mount_target

            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.delete_mount_target.delete_mount_target(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_replication_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.delete_replication_configuration_request.DeleteReplicationConfigurationRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_efs._operations.magnolio_api_service_v20150201.delete_replication_configuration

            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.delete_replication_configuration.delete_replication_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_tags(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_tags(file_system_id='fs-01234567', tag_keys=['Name'])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.delete_tags_request.DeleteTagsRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_efs._operations.magnolio_api_service_v20150201.delete_tags

            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.delete_tags.delete_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_access_points(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.describe_access_points_request.DescribeAccessPointsRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.describe_access_points_response.DescribeAccessPointsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.describe_access_points.describe_access_points(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_efs.types.access_point_description.AccessPointDescription]":
        _token = next_token
        while True:
            _response = self.describe_access_points(
    ...
    def describe_account_preferences(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.describe_account_preferences_request.DescribeAccountPreferencesRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.describe_account_preferences_response.DescribeAccountPreferencesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.describe_account_preferences.describe_account_preferences(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_backup_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.describe_backup_policy_request.DescribeBackupPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.backup_policy_description.BackupPolicyDescription"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.describe_backup_policy.describe_backup_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_file_system_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.describe_file_system_policy_request.DescribeFileSystemPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.file_system_policy_description.FileSystemPolicyDescription"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.describe_file_system_policy.describe_file_system_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_file_systems(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.describe_file_systems_request.DescribeFileSystemsRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.describe_file_systems_response.DescribeFileSystemsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.describe_file_systems.describe_file_systems(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_efs.types.file_system_description.FileSystemDescription]":
        _token = marker
        while True:
    ...
    def describe_lifecycle_configuration(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_lifecycle_configuration(file_system_id='fs-01234567')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.describe_lifecycle_configuration_request.DescribeLifecycleConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.lifecycle_configuration_description.LifecycleConfigurationDescription"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.describe_lifecycle_configuration.describe_lifecycle_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_mount_targets(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_mount_targets(file_system_id='fs-01234567')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.describe_mount_targets_request.DescribeMountTargetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.describe_mount_targets_response.DescribeMountTargetsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.describe_mount_targets.describe_mount_targets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_efs.types.mount_target_description.MountTargetDescription]":
        _token = marker
        while True:
            _response = self.describe_mount_targets(
                config_overrides=config_overrides,
                max_items=max_items,
                marker=_token,
                file_system_id=file_system_id,
    ...
    def describe_mount_target_security_groups(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_mount_target_security_groups(mount_target_id='fsmt-12340abc')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.describe_mount_target_security_groups_request.DescribeMountTargetSecurityGroupsRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.describe_mount_target_security_groups_response.DescribeMountTargetSecurityGroupsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.describe_mount_target_security_groups.describe_mount_target_security_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_replication_configurations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.describe_replication_configurations_request.DescribeReplicationConfigurationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.describe_replication_configurations_response.DescribeReplicationConfigurationsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.describe_replication_configurations.describe_replication_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_replication_configurations(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_efs.types.token.Token"] = None,
        max_results: Optional["aws_sdk_efs.types.max_results.MaxResults"] = None,
    ) -> "Iterator[aws_sdk_efs.types.replication_configuration_description.ReplicationConfigurationDescription]":
        _token = next_token
        while True:
            _response = self.describe_replication_configurations(
                config_overrides=config_overrides,
                file_system_id=file_system_id,
                next_token=_token,
                max_results=max_results,
    ...
    def describe_tags(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_tags(file_system_id='fs-01234567')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.describe_tags_request.DescribeTagsRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.describe_tags_response.DescribeTagsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.describe_tags.describe_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_tags(
        ...
        *,
        ...
        max_items: Optional["aws_sdk_efs.types.max_items.MaxItems"] = None,
        marker: Optional["aws_sdk_efs.types.marker.Marker"] = None,
    ) -> "Iterator[aws_sdk_efs.types.tag.Tag]":
        _token = marker
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_mount_target_security_groups(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.modify_mount_target_security_groups(mount_target_id='fsmt-12340abc', security_groups=['sg-abcd1234'])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.modify_mount_target_security_groups_request.ModifyMountTargetSecurityGroupsRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_efs._operations.magnolio_api_service_v20150201.modify_mount_target_security_groups

            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.modify_mount_target_security_groups.modify_mount_target_security_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_account_preferences(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.put_account_preferences_request.PutAccountPreferencesRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.put_account_preferences_response.PutAccountPreferencesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.put_account_preferences.put_account_preferences(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_backup_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.put_backup_policy_request.PutBackupPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.backup_policy_description.BackupPolicyDescription"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.put_backup_policy.put_backup_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_file_system_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.put_file_system_policy_request.PutFileSystemPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.file_system_policy_description.FileSystemPolicyDescription"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.put_file_system_policy.put_file_system_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_lifecycle_configuration(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.put_lifecycle_configuration(file_system_id='fs-01234567', lifecycle_policies=[{'TransitionToIA': 'AFTER_30_DAYS'}])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.put_lifecycle_configuration_request.PutLifecycleConfigurationRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.lifecycle_configuration_description.LifecycleConfigurationDescription"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.put_lifecycle_configuration.put_lifecycle_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_efs._operations.magnolio_api_service_v20150201.tag_resource

            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_efs._operations.magnolio_api_service_v20150201.untag_resource

            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_file_system(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.update_file_system_request.UpdateFileSystemRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.file_system_description.FileSystemDescription"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.update_file_system.update_file_system(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_file_system_protection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_efs.types.update_file_system_protection_request.UpdateFileSystemProtectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_efs.types.file_system_protection_description.FileSystemProtectionDescription"
        ]:
            ...
            output, http_response = (
                aws_sdk_efs._operations.magnolio_api_service_v20150201.update_file_system_protection.update_file_system_protection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
