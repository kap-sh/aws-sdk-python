...
from ._services.async_bedrock_agent_core import (
    AsyncBedrockAgentCoreClient as AsyncBedrockAgentCoreClient,
)
from ._services.bedrock_agent_core import (
    BedrockAgentCoreClient as BedrockAgentCoreClient,
)
