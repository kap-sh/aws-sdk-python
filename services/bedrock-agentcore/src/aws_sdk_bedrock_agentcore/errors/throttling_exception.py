"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockagentcore#ThrottlingException``."""
