...
class BedrockAgentCoreError(Exception):
    """Base class for all BedrockAgentCore service errors."""

class ServiceError(BedrockAgentCoreError):
...
class SerializationError(BedrockAgentCoreError):
    """Raised when a value cannot be serialized."""

class DeserializationError(BedrockAgentCoreError):
...
class WaiterFailedError(BedrockAgentCoreError):
...
class WaiterTimeoutError(BedrockAgentCoreError):
