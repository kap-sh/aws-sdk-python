...
class RegistryRecordResource:
    ...
    def search_registry_records(self, search_query: str, registry_ids: "aws_sdk_bedrock_agentcore.types.registry_id_list.RegistryIdList", *, config_overrides: Optional[BedrockAgentCoreClientConfig] = None, max_results: Optional[int] = None, filters: Optional["aws_sdk_bedrock_agentcore.types.metadata_filter_expression.MetadataFilterExpression"] = None) -> "aws_sdk_bedrock_agentcore.types.search_registry_records_response.SearchRegistryRecordsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agentcore.types.search_registry_records_request.SearchRegistryRecordsRequest]') -> OperationResponse["aws_sdk_bedrock_agentcore.types.search_registry_records_response.SearchRegistryRecordsResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.search_registry_records
            output, http_response = aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.search_registry_records.search_registry_records(req.options, req.input)
...
class AsyncRegistryRecordResource:
    def __init__(self, service: AsyncBedrockAgentCoreClient) -> None:
        self._service = service
    async def search_registry_records(self, search_query: str, registry_ids: "aws_sdk_bedrock_agentcore.types.registry_id_list.RegistryIdList", *, config_overrides: Optional[AsyncBedrockAgentCoreClientConfig] = None, max_results: Optional[int] = None, filters: Optional["aws_sdk_bedrock_agentcore.types.metadata_filter_expression.MetadataFilterExpression"] = None) -> "aws_sdk_bedrock_agentcore.types.search_registry_records_response.SearchRegistryRecordsResponse":
        """<p> Searches for registry records using semantic, lexical, or hybrid queries. Returns metadata for matching records ordered by relevance within the specified registry.</p>
        ...
        Args:
            ...
            filters: <p> A metadata filter expression to narrow search results. Uses structured JSON operators including field-level operators (<code>$eq</code>, <code>$ne</code>, <code>$in</code>) and logical operators (<code>$and</code>, <code>$or</code>) on filterable fields (<code>name</code>, <code>descriptorType</code>, <code>version</code>). For example, to filter by descriptor type: <code>{\"descriptorType\": {\"$eq\": \"MCP\"}}</code>. To combine filters: <code>{\"$and\": [{\"descriptorType\": {\"$eq\": \"MCP\"}}, {\"name\": {\"$eq\": \"my-tool\"}}]}</code>.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.search_registry_records_request.SearchRegistryRecordsRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agentcore.types.search_registry_records_response.SearchRegistryRecordsResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.search_registry_records
            output, http_response = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.search_registry_records.async_search_registry_records(req.options, req.input)
