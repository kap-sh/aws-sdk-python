...
class PaymentSessionResource:
    ...
    def create(
        ...
        *,
        ...
        limits: Optional[
            "aws_sdk_bedrock_agentcore.types.session_limits.SessionLimits"
        ] = None,
        client_token: Optional[
            "aws_sdk_bedrock_agentcore.types.client_token.ClientToken"
        ] = None,
    ) -> "aws_sdk_bedrock_agentcore.types.create_payment_session_response.CreatePaymentSessionResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.create_payment_session_request.CreatePaymentSessionRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.create_payment_session_response.CreatePaymentSessionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.create_payment_session.create_payment_session(
    ...
    def read(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agentcore.types.get_payment_session_response.GetPaymentSessionResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.get_payment_session_request.GetPaymentSessionRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_payment_session_response.GetPaymentSessionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_payment_session.get_payment_session(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        config_overrides: Optional[BedrockAgentCoreClientConfig] = None,
        user_id: Optional["aws_sdk_bedrock_agentcore.types.user_id.UserId"] = None,
    ) -> "aws_sdk_bedrock_agentcore.types.delete_payment_session_response.DeletePaymentSessionResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.delete_payment_session_request.DeletePaymentSessionRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.delete_payment_session_response.DeletePaymentSessionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.delete_payment_session.delete_payment_session(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agentcore.types.list_payment_sessions_response.ListPaymentSessionsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.list_payment_sessions_request.ListPaymentSessionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_payment_sessions_response.ListPaymentSessionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_payment_sessions.list_payment_sessions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncPaymentSessionResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.create_payment_session_request.CreatePaymentSessionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.create_payment_session_response.CreatePaymentSessionResponse"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.create_payment_session
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.create_payment_session.async_create_payment_session(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.get_payment_session_request.GetPaymentSessionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_payment_session_response.GetPaymentSessionResponse"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_payment_session
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_payment_session.async_get_payment_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.delete_payment_session_request.DeletePaymentSessionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.delete_payment_session_response.DeletePaymentSessionResponse"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.delete_payment_session
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.delete_payment_session.async_delete_payment_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.list_payment_sessions_request.ListPaymentSessionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_payment_sessions_response.ListPaymentSessionsResponse"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_payment_sessions
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_payment_sessions.async_list_payment_sessions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
