...
class BrowserSessionResource:
    ...
    def read(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agentcore.types.get_browser_session_response.GetBrowserSessionResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.get_browser_session_request.GetBrowserSessionRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_browser_session_response.GetBrowserSessionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_browser_session.get_browser_session(
    ...
    def invoke_browser(
        ...
        *,
        ...
        "aws_sdk_bedrock_agentcore.types.invoke_browser_response.InvokeBrowserResponse"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.invoke_browser_request.InvokeBrowserRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.invoke_browser_response.InvokeBrowserResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_browser.invoke_browser(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_browser_sessions(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agentcore.types.list_browser_sessions_response.ListBrowserSessionsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.list_browser_sessions_request.ListBrowserSessionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_browser_sessions_response.ListBrowserSessionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_browser_sessions.list_browser_sessions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_browser_session(
        ...
        *,
        ...
        view_port: Optional[
            "aws_sdk_bedrock_agentcore.types.view_port.ViewPort"
        ] = None,
        extensions: Optional[
    ...
    ) -> "aws_sdk_bedrock_agentcore.types.start_browser_session_response.StartBrowserSessionResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.start_browser_session_request.StartBrowserSessionRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.start_browser_session_response.StartBrowserSessionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.start_browser_session.start_browser_session(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_browser_session(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agentcore.types.stop_browser_session_response.StopBrowserSessionResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.stop_browser_session_request.StopBrowserSessionRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.stop_browser_session_response.StopBrowserSessionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.stop_browser_session.stop_browser_session(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_browser_stream(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agentcore.types.update_browser_stream_response.UpdateBrowserStreamResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.update_browser_stream_request.UpdateBrowserStreamRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.update_browser_stream_response.UpdateBrowserStreamResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.update_browser_stream.update_browser_stream(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncBrowserSessionResource:
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.get_browser_session_request.GetBrowserSessionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_browser_session_response.GetBrowserSessionResponse"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_browser_session
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_browser_session.async_get_browser_session(
                req.options, req.input
            )
    ...
    async def invoke_browser(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.invoke_browser_request.InvokeBrowserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.invoke_browser_response.InvokeBrowserResponse"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_browser
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_browser.async_invoke_browser(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_browser_sessions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.list_browser_sessions_request.ListBrowserSessionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_browser_sessions_response.ListBrowserSessionsResponse"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_browser_sessions
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_browser_sessions.async_list_browser_sessions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_browser_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.start_browser_session_request.StartBrowserSessionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.start_browser_session_response.StartBrowserSessionResponse"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.start_browser_session
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.start_browser_session.async_start_browser_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_browser_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.stop_browser_session_request.StopBrowserSessionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.stop_browser_session_response.StopBrowserSessionResponse"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.stop_browser_session
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.stop_browser_session.async_stop_browser_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_browser_stream(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.update_browser_stream_request.UpdateBrowserStreamRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.update_browser_stream_response.UpdateBrowserStreamResponse"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.update_browser_stream
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.update_browser_stream.async_update_browser_stream(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
