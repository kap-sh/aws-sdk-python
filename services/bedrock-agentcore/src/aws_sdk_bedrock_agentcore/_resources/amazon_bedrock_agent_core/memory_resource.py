...
class MemoryResource:
    ...
    def batch_create_memory_records(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.batch_create_memory_records_input.BatchCreateMemoryRecordsInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.batch_create_memory_records_output.BatchCreateMemoryRecordsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.batch_create_memory_records.batch_create_memory_records(
    ...
    def batch_delete_memory_records(
        ...
        *,
        config_overrides: Optional[BedrockAgentCoreClientConfig] = None,
    ) -> "aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_output.BatchDeleteMemoryRecordsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_input.BatchDeleteMemoryRecordsInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_output.BatchDeleteMemoryRecordsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.batch_delete_memory_records.batch_delete_memory_records(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_update_memory_records(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input.BatchUpdateMemoryRecordsInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.batch_update_memory_records_output.BatchUpdateMemoryRecordsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.batch_update_memory_records.batch_update_memory_records(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_event(
        ...
        *,
        ...
        branch: Optional["aws_sdk_bedrock_agentcore.types.branch.Branch"] = None,
        client_token: Optional[str] = None,
        metadata: Optional[
            "aws_sdk_bedrock_agentcore.types.metadata_map.MetadataMap"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.create_event_input.CreateEventInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.create_event_output.CreateEventOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.create_event.create_event(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_event(
        ...
        *,
        config_overrides: Optional[BedrockAgentCoreClientConfig] = None,
    ) -> "aws_sdk_bedrock_agentcore.types.delete_event_output.DeleteEventOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.delete_event_input.DeleteEventInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.delete_event_output.DeleteEventOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.delete_event.delete_event(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_memory_record(
        ...
        *,
        config_overrides: Optional[BedrockAgentCoreClientConfig] = None,
    ) -> "aws_sdk_bedrock_agentcore.types.delete_memory_record_output.DeleteMemoryRecordOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.delete_memory_record_input.DeleteMemoryRecordInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.delete_memory_record_output.DeleteMemoryRecordOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.delete_memory_record.delete_memory_record(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_event(
        ...
        *,
        config_overrides: Optional[BedrockAgentCoreClientConfig] = None,
    ) -> "aws_sdk_bedrock_agentcore.types.get_event_output.GetEventOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.get_event_input.GetEventInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_event_output.GetEventOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_event.get_event(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_memory_record(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.get_memory_record_input.GetMemoryRecordInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_memory_record_output.GetMemoryRecordOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_memory_record.get_memory_record(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_actors(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.list_actors_input.ListActorsInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_actors_output.ListActorsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_actors.list_actors(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_events(
        ...
        *,
        ...
        filter: Optional[
            "aws_sdk_bedrock_agentcore.types.filter_input.FilterInput"
        ] = None,
        max_results: Optional[
            "aws_sdk_bedrock_agentcore.types.max_results.MaxResults"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.list_events_input.ListEventsInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_events_output.ListEventsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_events.list_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_memory_extraction_jobs(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_output.ListMemoryExtractionJobsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_input.ListMemoryExtractionJobsInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_output.ListMemoryExtractionJobsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_memory_extraction_jobs.list_memory_extraction_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_memory_records(
        ...
        *,
        config_overrides: Optional[BedrockAgentCoreClientConfig] = None,
        namespace: Optional[
            "aws_sdk_bedrock_agentcore.types.namespace.Namespace"
        ] = None,
    ...
    ) -> "aws_sdk_bedrock_agentcore.types.list_memory_records_output.ListMemoryRecordsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.list_memory_records_input.ListMemoryRecordsInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_memory_records_output.ListMemoryRecordsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_memory_records.list_memory_records(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_sessions(
        ...
        *,
        ...
        filter: Optional[
            "aws_sdk_bedrock_agentcore.types.session_filter.SessionFilter"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.list_sessions_input.ListSessionsInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_sessions_output.ListSessionsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_sessions.list_sessions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def retrieve_memory_records(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input.RetrieveMemoryRecordsInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.retrieve_memory_records_output.RetrieveMemoryRecordsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.retrieve_memory_records.retrieve_memory_records(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_memory_extraction_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input.StartMemoryExtractionJobInput]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_output.StartMemoryExtractionJobOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.start_memory_extraction_job.start_memory_extraction_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncMemoryResource:
    ...
    async def batch_create_memory_records(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.batch_create_memory_records_input.BatchCreateMemoryRecordsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.batch_create_memory_records_output.BatchCreateMemoryRecordsOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.batch_create_memory_records
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.batch_create_memory_records.async_batch_create_memory_records(
                req.options, req.input
            )
    ...
    async def batch_delete_memory_records(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_input.BatchDeleteMemoryRecordsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_output.BatchDeleteMemoryRecordsOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.batch_delete_memory_records
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.batch_delete_memory_records.async_batch_delete_memory_records(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_update_memory_records(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input.BatchUpdateMemoryRecordsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.batch_update_memory_records_output.BatchUpdateMemoryRecordsOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.batch_update_memory_records
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.batch_update_memory_records.async_batch_update_memory_records(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_event(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.create_event_input.CreateEventInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.create_event_output.CreateEventOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.create_event
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.create_event.async_create_event(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_event(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.delete_event_input.DeleteEventInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.delete_event_output.DeleteEventOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.delete_event
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.delete_event.async_delete_event(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_memory_record(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.delete_memory_record_input.DeleteMemoryRecordInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.delete_memory_record_output.DeleteMemoryRecordOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.delete_memory_record
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.delete_memory_record.async_delete_memory_record(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_event(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.get_event_input.GetEventInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_event_output.GetEventOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_event
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_event.async_get_event(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_memory_record(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.get_memory_record_input.GetMemoryRecordInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_memory_record_output.GetMemoryRecordOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_memory_record
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_memory_record.async_get_memory_record(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_actors(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.list_actors_input.ListActorsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_actors_output.ListActorsOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_actors
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_actors.async_list_actors(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.list_events_input.ListEventsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_events_output.ListEventsOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_events
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_events.async_list_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_memory_extraction_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_input.ListMemoryExtractionJobsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_output.ListMemoryExtractionJobsOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_memory_extraction_jobs
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_memory_extraction_jobs.async_list_memory_extraction_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_memory_records(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.list_memory_records_input.ListMemoryRecordsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_memory_records_output.ListMemoryRecordsOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_memory_records
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_memory_records.async_list_memory_records(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_sessions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.list_sessions_input.ListSessionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.list_sessions_output.ListSessionsOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_sessions
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.list_sessions.async_list_sessions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def retrieve_memory_records(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input.RetrieveMemoryRecordsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.retrieve_memory_records_output.RetrieveMemoryRecordsOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.retrieve_memory_records
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.retrieve_memory_records.async_retrieve_memory_records(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_memory_extraction_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input.StartMemoryExtractionJobInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_output.StartMemoryExtractionJobOutput"
        ]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.start_memory_extraction_job
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.start_memory_extraction_job.async_start_memory_extraction_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
