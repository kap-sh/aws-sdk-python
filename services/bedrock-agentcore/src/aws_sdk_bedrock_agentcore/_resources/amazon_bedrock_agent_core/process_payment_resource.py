...
class ProcessPaymentResource:
    ...
    def create(self, payment_manager_arn: "aws_sdk_bedrock_agentcore.types.payment_manager_arn.PaymentManagerArn", payment_session_id: "aws_sdk_bedrock_agentcore.types.payment_session_id.PaymentSessionId", payment_instrument_id: "aws_sdk_bedrock_agentcore.types.payment_instrument_id.PaymentInstrumentId", payment_type: "aws_sdk_bedrock_agentcore.types.payment_type.PaymentType", payment_input: "aws_sdk_bedrock_agentcore.types.payment_input.PaymentInput", *, config_overrides: Optional[BedrockAgentCoreClientConfig] = None, user_id: Optional["aws_sdk_bedrock_agentcore.types.user_id.UserId"] = None, agent_name: Optional["aws_sdk_bedrock_agentcore.types.payment_agent_name.PaymentAgentName"] = None, client_token: Optional["aws_sdk_bedrock_agentcore.types.client_token.ClientToken"] = None) -> "aws_sdk_bedrock_agentcore.types.process_payment_response.ProcessPaymentResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agentcore.types.process_payment_request.ProcessPaymentRequest]') -> OperationResponse["aws_sdk_bedrock_agentcore.types.process_payment_response.ProcessPaymentResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.process_payment
            output, http_response = aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.process_payment.process_payment(req.options, req.input)
...
class AsyncProcessPaymentResource:
    def __init__(self, service: AsyncBedrockAgentCoreClient) -> None:
        self._service = service
    async def create(self, payment_manager_arn: "aws_sdk_bedrock_agentcore.types.payment_manager_arn.PaymentManagerArn", payment_session_id: "aws_sdk_bedrock_agentcore.types.payment_session_id.PaymentSessionId", payment_instrument_id: "aws_sdk_bedrock_agentcore.types.payment_instrument_id.PaymentInstrumentId", payment_type: "aws_sdk_bedrock_agentcore.types.payment_type.PaymentType", payment_input: "aws_sdk_bedrock_agentcore.types.payment_input.PaymentInput", *, config_overrides: Optional[AsyncBedrockAgentCoreClientConfig] = None, user_id: Optional["aws_sdk_bedrock_agentcore.types.user_id.UserId"] = None, agent_name: Optional["aws_sdk_bedrock_agentcore.types.payment_agent_name.PaymentAgentName"] = None, client_token: Optional["aws_sdk_bedrock_agentcore.types.client_token.ClientToken"] = None) -> "aws_sdk_bedrock_agentcore.types.process_payment_response.ProcessPaymentResponse":
        """<p>Processes a payment using a payment instrument within a payment session.</p>
        ...
        Args:
            ...
            client_token: <p>A unique, case-sensitive identifier that you provide to ensure the idempotency of the request.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.process_payment_request.ProcessPaymentRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agentcore.types.process_payment_response.ProcessPaymentResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.process_payment
            output, http_response = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.process_payment.async_process_payment(req.options, req.input)
