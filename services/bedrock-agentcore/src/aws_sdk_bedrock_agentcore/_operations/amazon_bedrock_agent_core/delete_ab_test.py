...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.delete_ab_test_response.DeleteABTestResponse = aws_sdk_bedrock_agentcore.types.delete_ab_test_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.delete_ab_test_request.DeleteABTestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_ab_test(
