...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_ab_test_request.DeleteABTestRequest) -> zapros.Request:
...
def delete_ab_test(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_ab_test_request.DeleteABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_ab_test_response.DeleteABTestResponse, zapros.Response]:
...
async def async_delete_ab_test(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_ab_test_request.DeleteABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_ab_test_response.DeleteABTestResponse, zapros.Response]:
