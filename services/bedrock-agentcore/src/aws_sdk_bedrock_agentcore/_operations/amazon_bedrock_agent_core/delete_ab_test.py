"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#DeleteABTest``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.delete_ab_test_response.DeleteABTestResponse:
    import aws_sdk_bedrock_agentcore.types.delete_ab_test_response
    out: aws_sdk_bedrock_agentcore.types.delete_ab_test_response.DeleteABTestResponse = aws_sdk_bedrock_agentcore.types.delete_ab_test_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_ab_test_request.DeleteABTestRequest) -> zapros.Request:
...
def delete_ab_test(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_ab_test_request.DeleteABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_ab_test_response.DeleteABTestResponse, zapros.Response]:
...
async def async_delete_ab_test(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_ab_test_request.DeleteABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_ab_test_response.DeleteABTestResponse, zapros.Response]:
