...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_response.GetPaymentInstrumentBalanceResponse = aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_request.GetPaymentInstrumentBalanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_payment_instrument_balance(
