"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#GetPaymentInstrumentBalance``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_response.GetPaymentInstrumentBalanceResponse:
    import aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_response
    out: aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_response.GetPaymentInstrumentBalanceResponse = aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_request.GetPaymentInstrumentBalanceRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/payments/getPaymentInstrumentBalance"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    if "user_id" in input:
        headers["X-Amzn-Bedrock-AgentCore-Payments-User-Id"] = str(input["user_id"])
    if "agent_name" in input:
        headers["X-Amzn-Bedrock-AgentCore-Payments-Agent-Name"] = str(input["agent_name"])
    import aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_request.serialize_json(input)).encode()
...
def get_payment_instrument_balance(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_request.GetPaymentInstrumentBalanceRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_response.GetPaymentInstrumentBalanceResponse, zapros.Response]:
...
async def async_get_payment_instrument_balance(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_request.GetPaymentInstrumentBalanceRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_response.GetPaymentInstrumentBalanceResponse, zapros.Response]:
