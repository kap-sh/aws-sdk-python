...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_request.GetPaymentInstrumentBalanceRequest) -> zapros.Request:
    ...
    if "agent_name" in input_:
        headers["X-Amzn-Bedrock-AgentCore-Payments-Agent-Name"] = str(input_["agent_name"])
    import aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_request.serialize_json(input_)).encode()
...
def get_payment_instrument_balance(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_request.GetPaymentInstrumentBalanceRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_response.GetPaymentInstrumentBalanceResponse, zapros.Response]:
...
async def async_get_payment_instrument_balance(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_request.GetPaymentInstrumentBalanceRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_payment_instrument_balance_response.GetPaymentInstrumentBalanceResponse, zapros.Response]:
