...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.start_browser_session_request.StartBrowserSessionRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.start_browser_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.start_browser_session_request.serialize_json(input)).encode()
...
def start_browser_session(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.start_browser_session_request.StartBrowserSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_browser_session_response.StartBrowserSessionResponse, zapros.Response]:
...
async def async_start_browser_session(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.start_browser_session_request.StartBrowserSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_browser_session_response.StartBrowserSessionResponse, zapros.Response]:
