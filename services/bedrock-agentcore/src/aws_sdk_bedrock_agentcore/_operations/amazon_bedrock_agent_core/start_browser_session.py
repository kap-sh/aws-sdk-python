"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#StartBrowserSession``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.start_browser_session_response.StartBrowserSessionResponse:
    import aws_sdk_bedrock_agentcore.types.start_browser_session_response
    out: aws_sdk_bedrock_agentcore.types.start_browser_session_response.StartBrowserSessionResponse = aws_sdk_bedrock_agentcore.types.start_browser_session_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.start_browser_session_request.StartBrowserSessionRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/browsers/{browserIdentifier}/sessions/start"
    ...
    import aws_sdk_bedrock_agentcore.types.start_browser_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.start_browser_session_request.serialize_json(input_)).encode()
...
def start_browser_session(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.start_browser_session_request.StartBrowserSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_browser_session_response.StartBrowserSessionResponse, zapros.Response]:
...
async def async_start_browser_session(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.start_browser_session_request.StartBrowserSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_browser_session_response.StartBrowserSessionResponse, zapros.Response]:
