...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.start_browser_session_response.StartBrowserSessionResponse = aws_sdk_bedrock_agentcore.types.start_browser_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.start_browser_session_request.StartBrowserSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{browserIdentifier}", quote(str(input_["browser_identifier"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.start_browser_session_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_browser_session(
