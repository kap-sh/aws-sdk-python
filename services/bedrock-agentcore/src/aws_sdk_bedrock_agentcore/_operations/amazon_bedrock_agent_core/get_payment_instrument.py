...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.get_payment_instrument_response.GetPaymentInstrumentResponse = aws_sdk_bedrock_agentcore.types.get_payment_instrument_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.get_payment_instrument_request.GetPaymentInstrumentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.get_payment_instrument_request.serialize_json(
            input_
        )
    ).encode()
