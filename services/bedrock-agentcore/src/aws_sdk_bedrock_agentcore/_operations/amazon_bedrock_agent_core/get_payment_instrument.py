...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_payment_instrument_request.GetPaymentInstrumentRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.get_payment_instrument_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_payment_instrument_request.serialize_json(input_)).encode()
...
def get_payment_instrument(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_payment_instrument_request.GetPaymentInstrumentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_payment_instrument_response.GetPaymentInstrumentResponse, zapros.Response]:
...
async def async_get_payment_instrument(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_payment_instrument_request.GetPaymentInstrumentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_payment_instrument_response.GetPaymentInstrumentResponse, zapros.Response]:
