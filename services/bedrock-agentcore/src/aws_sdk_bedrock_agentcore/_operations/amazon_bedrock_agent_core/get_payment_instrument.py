"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#GetPaymentInstrument``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.get_payment_instrument_response.GetPaymentInstrumentResponse:
    import aws_sdk_bedrock_agentcore.types.get_payment_instrument_response
    out: aws_sdk_bedrock_agentcore.types.get_payment_instrument_response.GetPaymentInstrumentResponse = aws_sdk_bedrock_agentcore.types.get_payment_instrument_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_payment_instrument_request.GetPaymentInstrumentRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/payments/getPaymentInstrument"
    params: dict[str, str] = {}
    ...
    import aws_sdk_bedrock_agentcore.types.get_payment_instrument_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_payment_instrument_request.serialize_json(input)).encode()
...
def get_payment_instrument(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.get_payment_instrument_request.GetPaymentInstrumentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_payment_instrument_response.GetPaymentInstrumentResponse, zapros.Response]:
...
async def async_get_payment_instrument(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_payment_instrument_request.GetPaymentInstrumentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_payment_instrument_response.GetPaymentInstrumentResponse, zapros.Response]:
