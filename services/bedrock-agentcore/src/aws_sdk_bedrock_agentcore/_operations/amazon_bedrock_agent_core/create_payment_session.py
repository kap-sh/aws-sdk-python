"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#CreatePaymentSession``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.create_payment_session_response.CreatePaymentSessionResponse:
    import aws_sdk_bedrock_agentcore.types.create_payment_session_response
    out: aws_sdk_bedrock_agentcore.types.create_payment_session_response.CreatePaymentSessionResponse = aws_sdk_bedrock_agentcore.types.create_payment_session_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.create_payment_session_request.CreatePaymentSessionRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/payments/createPaymentSession"
    params: dict[str, str] = {}
    ...
    import aws_sdk_bedrock_agentcore.types.create_payment_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.create_payment_session_request.serialize_json(input)).encode()
...
def create_payment_session(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.create_payment_session_request.CreatePaymentSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.create_payment_session_response.CreatePaymentSessionResponse, zapros.Response]:
...
async def async_create_payment_session(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.create_payment_session_request.CreatePaymentSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.create_payment_session_response.CreatePaymentSessionResponse, zapros.Response]:
