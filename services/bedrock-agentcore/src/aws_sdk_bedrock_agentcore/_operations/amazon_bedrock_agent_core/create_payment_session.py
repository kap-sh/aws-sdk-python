...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.create_payment_session_response.CreatePaymentSessionResponse = aws_sdk_bedrock_agentcore.types.create_payment_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.create_payment_session_request.CreatePaymentSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.create_payment_session_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_payment_session(
