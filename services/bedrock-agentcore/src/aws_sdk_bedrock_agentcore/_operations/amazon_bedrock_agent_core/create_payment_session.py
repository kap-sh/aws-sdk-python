...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.create_payment_session_request.CreatePaymentSessionRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.create_payment_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.create_payment_session_request.serialize_json(input_)).encode()
...
def create_payment_session(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.create_payment_session_request.CreatePaymentSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.create_payment_session_response.CreatePaymentSessionResponse, zapros.Response]:
...
async def async_create_payment_session(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.create_payment_session_request.CreatePaymentSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.create_payment_session_response.CreatePaymentSessionResponse, zapros.Response]:
