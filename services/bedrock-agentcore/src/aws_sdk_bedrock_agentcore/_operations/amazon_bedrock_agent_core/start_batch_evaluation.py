...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.start_batch_evaluation_request.StartBatchEvaluationRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.start_batch_evaluation_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.start_batch_evaluation_request.serialize_json(input)).encode()
...
def start_batch_evaluation(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.start_batch_evaluation_request.StartBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_batch_evaluation_response.StartBatchEvaluationResponse, zapros.Response]:
...
async def async_start_batch_evaluation(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.start_batch_evaluation_request.StartBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_batch_evaluation_response.StartBatchEvaluationResponse, zapros.Response]:
