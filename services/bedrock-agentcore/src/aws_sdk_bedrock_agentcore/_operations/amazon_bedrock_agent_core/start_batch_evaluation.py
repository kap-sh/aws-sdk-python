"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#StartBatchEvaluation``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.start_batch_evaluation_response.StartBatchEvaluationResponse:
    import aws_sdk_bedrock_agentcore.types.start_batch_evaluation_response
    out: aws_sdk_bedrock_agentcore.types.start_batch_evaluation_response.StartBatchEvaluationResponse = aws_sdk_bedrock_agentcore.types.start_batch_evaluation_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.start_batch_evaluation_request.StartBatchEvaluationRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/evaluations/batch-evaluate"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.start_batch_evaluation_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.start_batch_evaluation_request.serialize_json(input_)).encode()
...
def start_batch_evaluation(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.start_batch_evaluation_request.StartBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_batch_evaluation_response.StartBatchEvaluationResponse, zapros.Response]:
...
async def async_start_batch_evaluation(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.start_batch_evaluation_request.StartBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_batch_evaluation_response.StartBatchEvaluationResponse, zapros.Response]:
