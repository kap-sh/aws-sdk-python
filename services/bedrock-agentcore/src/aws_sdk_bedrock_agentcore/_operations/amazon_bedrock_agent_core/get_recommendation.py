...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.get_recommendation_response.GetRecommendationResponse:
    import aws_sdk_bedrock_agentcore.types.get_recommendation_response
    out: aws_sdk_bedrock_agentcore.types.get_recommendation_response.GetRecommendationResponse = aws_sdk_bedrock_agentcore.types.get_recommendation_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_recommendation_request.GetRecommendationRequest) -> zapros.Request:
...
def get_recommendation(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_recommendation_request.GetRecommendationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_recommendation_response.GetRecommendationResponse, zapros.Response]:
...
async def async_get_recommendation(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_recommendation_request.GetRecommendationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_recommendation_response.GetRecommendationResponse, zapros.Response]:
