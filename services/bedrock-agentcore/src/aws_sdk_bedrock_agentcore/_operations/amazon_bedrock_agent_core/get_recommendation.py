...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_recommendation_request.GetRecommendationRequest) -> zapros.Request:
...
def get_recommendation(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.get_recommendation_request.GetRecommendationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_recommendation_response.GetRecommendationResponse, zapros.Response]:
...
async def async_get_recommendation(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_recommendation_request.GetRecommendationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_recommendation_response.GetRecommendationResponse, zapros.Response]:
