...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.get_recommendation_response.GetRecommendationResponse = aws_sdk_bedrock_agentcore.types.get_recommendation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.get_recommendation_request.GetRecommendationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
