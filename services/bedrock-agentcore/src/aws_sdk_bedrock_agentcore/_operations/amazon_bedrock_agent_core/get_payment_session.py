...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_payment_session_request.GetPaymentSessionRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.get_payment_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_payment_session_request.serialize_json(input)).encode()
...
def get_payment_session(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.get_payment_session_request.GetPaymentSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_payment_session_response.GetPaymentSessionResponse, zapros.Response]:
...
async def async_get_payment_session(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_payment_session_request.GetPaymentSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_payment_session_response.GetPaymentSessionResponse, zapros.Response]:
