"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#GetPaymentSession``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.get_payment_session_response.GetPaymentSessionResponse:
    import aws_sdk_bedrock_agentcore.types.get_payment_session_response
    out: aws_sdk_bedrock_agentcore.types.get_payment_session_response.GetPaymentSessionResponse = aws_sdk_bedrock_agentcore.types.get_payment_session_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_payment_session_request.GetPaymentSessionRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/payments/getPaymentSession"
    params: dict[str, str] = {}
    ...
    import aws_sdk_bedrock_agentcore.types.get_payment_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_payment_session_request.serialize_json(input_)).encode()
...
def get_payment_session(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_payment_session_request.GetPaymentSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_payment_session_response.GetPaymentSessionResponse, zapros.Response]:
...
async def async_get_payment_session(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_payment_session_request.GetPaymentSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_payment_session_response.GetPaymentSessionResponse, zapros.Response]:
