...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_ab_tests_request.ListABTestsRequest) -> zapros.Request:
...
def list_ab_tests(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.list_ab_tests_request.ListABTestsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_ab_tests_response.ListABTestsResponse, zapros.Response]:
...
async def async_list_ab_tests(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_ab_tests_request.ListABTestsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_ab_tests_response.ListABTestsResponse, zapros.Response]:
