"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#ListABTests``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.list_ab_tests_response.ListABTestsResponse:
    import aws_sdk_bedrock_agentcore.types.list_ab_tests_response
    out: aws_sdk_bedrock_agentcore.types.list_ab_tests_response.ListABTestsResponse = aws_sdk_bedrock_agentcore.types.list_ab_tests_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_ab_tests_request.ListABTestsRequest) -> zapros.Request:
...
def list_ab_tests(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_ab_tests_request.ListABTestsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_ab_tests_response.ListABTestsResponse, zapros.Response]:
...
async def async_list_ab_tests(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_ab_tests_request.ListABTestsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_ab_tests_response.ListABTestsResponse, zapros.Response]:
