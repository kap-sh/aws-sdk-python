...
import aws_sdk_bedrock_agentcore.types.ab_test_summary_list
...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.list_ab_tests_response.ListABTestsResponse = (
        aws_sdk_bedrock_agentcore.types.list_ab_tests_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.list_ab_tests_request.ListABTestsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
