"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#ListPaymentSessions``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.list_payment_sessions_response.ListPaymentSessionsResponse:
    import aws_sdk_bedrock_agentcore.types.list_payment_sessions_response
    out: aws_sdk_bedrock_agentcore.types.list_payment_sessions_response.ListPaymentSessionsResponse = aws_sdk_bedrock_agentcore.types.list_payment_sessions_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_payment_sessions_request.ListPaymentSessionsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/payments/listPaymentSessions"
    params: dict[str, str] = {}
    ...
    import aws_sdk_bedrock_agentcore.types.list_payment_sessions_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_payment_sessions_request.serialize_json(input)).encode()
...
def list_payment_sessions(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.list_payment_sessions_request.ListPaymentSessionsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_payment_sessions_response.ListPaymentSessionsResponse, zapros.Response]:
...
async def async_list_payment_sessions(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_payment_sessions_request.ListPaymentSessionsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_payment_sessions_response.ListPaymentSessionsResponse, zapros.Response]:
