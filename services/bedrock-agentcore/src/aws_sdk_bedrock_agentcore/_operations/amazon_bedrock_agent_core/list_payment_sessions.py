...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.list_payment_sessions_response.ListPaymentSessionsResponse = aws_sdk_bedrock_agentcore.types.list_payment_sessions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.list_payment_sessions_request.ListPaymentSessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.list_payment_sessions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_payment_sessions(
