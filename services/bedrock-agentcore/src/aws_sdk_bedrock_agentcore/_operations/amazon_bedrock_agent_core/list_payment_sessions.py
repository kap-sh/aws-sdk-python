...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_payment_sessions_request.ListPaymentSessionsRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.list_payment_sessions_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_payment_sessions_request.serialize_json(input_)).encode()
...
def list_payment_sessions(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_payment_sessions_request.ListPaymentSessionsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_payment_sessions_response.ListPaymentSessionsResponse, zapros.Response]:
...
async def async_list_payment_sessions(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_payment_sessions_request.ListPaymentSessionsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_payment_sessions_response.ListPaymentSessionsResponse, zapros.Response]:
