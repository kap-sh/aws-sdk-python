...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input.BatchUpdateMemoryRecordsInput) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input.serialize_json(input_)).encode()
...
def batch_update_memory_records(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input.BatchUpdateMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.batch_update_memory_records_output.BatchUpdateMemoryRecordsOutput, zapros.Response]:
...
async def async_batch_update_memory_records(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input.BatchUpdateMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.batch_update_memory_records_output.BatchUpdateMemoryRecordsOutput, zapros.Response]:
