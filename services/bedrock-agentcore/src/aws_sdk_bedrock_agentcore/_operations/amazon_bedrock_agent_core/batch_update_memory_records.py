...
) -> aws_sdk_bedrock_agentcore.types.batch_update_memory_records_output.BatchUpdateMemoryRecordsOutput:
    out: aws_sdk_bedrock_agentcore.types.batch_update_memory_records_output.BatchUpdateMemoryRecordsOutput = aws_sdk_bedrock_agentcore.types.batch_update_memory_records_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input.BatchUpdateMemoryRecordsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_update_memory_records(
