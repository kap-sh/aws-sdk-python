"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#BatchUpdateMemoryRecords``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.batch_update_memory_records_output.BatchUpdateMemoryRecordsOutput:
    import aws_sdk_bedrock_agentcore.types.batch_update_memory_records_output
    out: aws_sdk_bedrock_agentcore.types.batch_update_memory_records_output.BatchUpdateMemoryRecordsOutput = aws_sdk_bedrock_agentcore.types.batch_update_memory_records_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input.BatchUpdateMemoryRecordsInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memories/{memoryId}/memoryRecords/batchUpdate"
    url = url.replace("{memoryId}", quote(str(input["memory_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input.serialize_json(input)).encode()
...
def batch_update_memory_records(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input.BatchUpdateMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.batch_update_memory_records_output.BatchUpdateMemoryRecordsOutput, zapros.Response]:
...
async def async_batch_update_memory_records(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.batch_update_memory_records_input.BatchUpdateMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.batch_update_memory_records_output.BatchUpdateMemoryRecordsOutput, zapros.Response]:
