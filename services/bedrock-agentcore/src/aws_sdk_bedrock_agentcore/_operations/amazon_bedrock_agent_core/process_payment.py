...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.process_payment_response.ProcessPaymentResponse:
    import aws_sdk_bedrock_agentcore.types.process_payment_response
    out: aws_sdk_bedrock_agentcore.types.process_payment_response.ProcessPaymentResponse = aws_sdk_bedrock_agentcore.types.process_payment_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.process_payment_request.ProcessPaymentRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.process_payment_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.process_payment_request.serialize_json(input_)).encode()
...
def process_payment(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.process_payment_request.ProcessPaymentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.process_payment_response.ProcessPaymentResponse, zapros.Response]:
...
async def async_process_payment(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.process_payment_request.ProcessPaymentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.process_payment_response.ProcessPaymentResponse, zapros.Response]:
