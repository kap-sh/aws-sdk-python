...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.process_payment_response.ProcessPaymentResponse = aws_sdk_bedrock_agentcore.types.process_payment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.process_payment_request.ProcessPaymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
