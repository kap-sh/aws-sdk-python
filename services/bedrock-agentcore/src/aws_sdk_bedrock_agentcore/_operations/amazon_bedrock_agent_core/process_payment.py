...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.process_payment_request.ProcessPaymentRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.process_payment_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.process_payment_request.serialize_json(input)).encode()
...
def process_payment(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.process_payment_request.ProcessPaymentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.process_payment_response.ProcessPaymentResponse, zapros.Response]:
...
async def async_process_payment(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.process_payment_request.ProcessPaymentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.process_payment_response.ProcessPaymentResponse, zapros.Response]:
