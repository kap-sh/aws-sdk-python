...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.start_recommendation_response.StartRecommendationResponse:
    import aws_sdk_bedrock_agentcore.types.start_recommendation_response
    out: aws_sdk_bedrock_agentcore.types.start_recommendation_response.StartRecommendationResponse = aws_sdk_bedrock_agentcore.types.start_recommendation_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.start_recommendation_request.StartRecommendationRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.start_recommendation_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.start_recommendation_request.serialize_json(input_)).encode()
...
def start_recommendation(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.start_recommendation_request.StartRecommendationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_recommendation_response.StartRecommendationResponse, zapros.Response]:
...
async def async_start_recommendation(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.start_recommendation_request.StartRecommendationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_recommendation_response.StartRecommendationResponse, zapros.Response]:
