...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.start_recommendation_response.StartRecommendationResponse = aws_sdk_bedrock_agentcore.types.start_recommendation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.start_recommendation_request.StartRecommendationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.start_recommendation_request.serialize_json(
            input_
        )
    ).encode()
