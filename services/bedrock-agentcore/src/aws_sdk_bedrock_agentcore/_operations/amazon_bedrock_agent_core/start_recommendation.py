...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.start_recommendation_request.StartRecommendationRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.start_recommendation_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.start_recommendation_request.serialize_json(input)).encode()
...
def start_recommendation(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.start_recommendation_request.StartRecommendationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_recommendation_response.StartRecommendationResponse, zapros.Response]:
...
async def async_start_recommendation(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.start_recommendation_request.StartRecommendationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_recommendation_response.StartRecommendationResponse, zapros.Response]:
