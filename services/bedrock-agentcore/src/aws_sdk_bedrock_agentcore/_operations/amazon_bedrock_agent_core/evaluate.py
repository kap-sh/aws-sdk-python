...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.evaluate_request.EvaluateRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.evaluate_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.evaluate_request.serialize_json(input_)).encode()
...
def evaluate(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.evaluate_request.EvaluateRequest) -> tuple[aws_sdk_bedrock_agentcore.types.evaluate_response.EvaluateResponse, zapros.Response]:
...
async def async_evaluate(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.evaluate_request.EvaluateRequest) -> tuple[aws_sdk_bedrock_agentcore.types.evaluate_response.EvaluateResponse, zapros.Response]:
