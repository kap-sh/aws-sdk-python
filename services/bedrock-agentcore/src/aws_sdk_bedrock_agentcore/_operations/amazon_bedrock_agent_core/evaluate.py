...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DuplicateIdException":
            raise aws_sdk_bedrock_agentcore.errors.duplicate_id_exception.DuplicateIdException.from_json(
                data
            )
...
) -> aws_sdk_bedrock_agentcore.types.evaluate_response.EvaluateResponse:
    out: aws_sdk_bedrock_agentcore.types.evaluate_response.EvaluateResponse = (
        aws_sdk_bedrock_agentcore.types.evaluate_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.evaluate_request.EvaluateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.evaluate_request.serialize_json(input_)
    ).encode()
...
def evaluate(
    ...
    aws_sdk_bedrock_agentcore.types.evaluate_response.EvaluateResponse, zapros.Response
]:
