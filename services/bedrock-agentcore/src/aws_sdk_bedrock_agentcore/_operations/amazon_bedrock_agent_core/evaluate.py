"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#Evaluate``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DuplicateIdException":
            import aws_sdk_bedrock_agentcore.errors.duplicate_id_exception
            raise aws_sdk_bedrock_agentcore.errors.duplicate_id_exception.DuplicateIdException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.evaluate_response.EvaluateResponse:
    import aws_sdk_bedrock_agentcore.types.evaluate_response
    out: aws_sdk_bedrock_agentcore.types.evaluate_response.EvaluateResponse = aws_sdk_bedrock_agentcore.types.evaluate_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.evaluate_request.EvaluateRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/evaluations/evaluate/{evaluatorId}"
    url = url.replace("{evaluatorId}", quote(str(input["evaluator_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.evaluate_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.evaluate_request.serialize_json(input)).encode()
...
def evaluate(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.evaluate_request.EvaluateRequest) -> tuple[aws_sdk_bedrock_agentcore.types.evaluate_response.EvaluateResponse, zapros.Response]:
...
async def async_evaluate(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.evaluate_request.EvaluateRequest) -> tuple[aws_sdk_bedrock_agentcore.types.evaluate_response.EvaluateResponse, zapros.Response]:
