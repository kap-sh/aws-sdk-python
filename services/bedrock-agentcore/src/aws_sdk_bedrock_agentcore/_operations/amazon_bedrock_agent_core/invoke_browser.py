...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.invoke_browser_response.InvokeBrowserResponse = aws_sdk_bedrock_agentcore.types.invoke_browser_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.invoke_browser_request.InvokeBrowserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_invoke_browser(
