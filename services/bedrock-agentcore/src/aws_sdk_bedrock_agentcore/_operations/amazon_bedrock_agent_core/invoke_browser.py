...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.invoke_browser_request.InvokeBrowserRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.invoke_browser_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.invoke_browser_request.serialize_json(input_)).encode()
...
def invoke_browser(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.invoke_browser_request.InvokeBrowserRequest) -> tuple[aws_sdk_bedrock_agentcore.types.invoke_browser_response.InvokeBrowserResponse, zapros.Response]:
...
async def async_invoke_browser(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.invoke_browser_request.InvokeBrowserRequest) -> tuple[aws_sdk_bedrock_agentcore.types.invoke_browser_response.InvokeBrowserResponse, zapros.Response]:
