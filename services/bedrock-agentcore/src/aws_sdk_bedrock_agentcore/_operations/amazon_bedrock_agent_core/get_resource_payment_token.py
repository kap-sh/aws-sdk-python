...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_resource_payment_token_request.GetResourcePaymentTokenRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.get_resource_payment_token_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_resource_payment_token_request.serialize_json(input)).encode()
...
def get_resource_payment_token(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.get_resource_payment_token_request.GetResourcePaymentTokenRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_resource_payment_token_response.GetResourcePaymentTokenResponse, zapros.Response]:
...
async def async_get_resource_payment_token(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_resource_payment_token_request.GetResourcePaymentTokenRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_resource_payment_token_response.GetResourcePaymentTokenResponse, zapros.Response]:
