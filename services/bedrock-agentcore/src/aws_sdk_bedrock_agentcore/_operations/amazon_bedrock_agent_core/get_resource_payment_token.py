...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.get_resource_payment_token_response.GetResourcePaymentTokenResponse:
    import aws_sdk_bedrock_agentcore.types.get_resource_payment_token_response
    out: aws_sdk_bedrock_agentcore.types.get_resource_payment_token_response.GetResourcePaymentTokenResponse = aws_sdk_bedrock_agentcore.types.get_resource_payment_token_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_resource_payment_token_request.GetResourcePaymentTokenRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.get_resource_payment_token_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_resource_payment_token_request.serialize_json(input_)).encode()
...
def get_resource_payment_token(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_resource_payment_token_request.GetResourcePaymentTokenRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_resource_payment_token_response.GetResourcePaymentTokenResponse, zapros.Response]:
...
async def async_get_resource_payment_token(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_resource_payment_token_request.GetResourcePaymentTokenRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_resource_payment_token_response.GetResourcePaymentTokenResponse, zapros.Response]:
