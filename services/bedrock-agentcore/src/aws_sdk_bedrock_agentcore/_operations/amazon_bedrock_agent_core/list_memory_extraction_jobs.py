...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_output.ListMemoryExtractionJobsOutput:
    import aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_output
    out: aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_output.ListMemoryExtractionJobsOutput = aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_input.ListMemoryExtractionJobsInput) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_input.serialize_json(input_)).encode()
...
def list_memory_extraction_jobs(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_input.ListMemoryExtractionJobsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_output.ListMemoryExtractionJobsOutput, zapros.Response]:
...
async def async_list_memory_extraction_jobs(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_input.ListMemoryExtractionJobsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_output.ListMemoryExtractionJobsOutput, zapros.Response]:
