...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_input.ListMemoryExtractionJobsInput) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_input.serialize_json(input)).encode()
...
def list_memory_extraction_jobs(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_input.ListMemoryExtractionJobsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_output.ListMemoryExtractionJobsOutput, zapros.Response]:
...
async def async_list_memory_extraction_jobs(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_input.ListMemoryExtractionJobsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_memory_extraction_jobs_output.ListMemoryExtractionJobsOutput, zapros.Response]:
