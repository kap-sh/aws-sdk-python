...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.create_payment_instrument_response.CreatePaymentInstrumentResponse:
    import aws_sdk_bedrock_agentcore.types.create_payment_instrument_response
    out: aws_sdk_bedrock_agentcore.types.create_payment_instrument_response.CreatePaymentInstrumentResponse = aws_sdk_bedrock_agentcore.types.create_payment_instrument_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.create_payment_instrument_request.CreatePaymentInstrumentRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.create_payment_instrument_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.create_payment_instrument_request.serialize_json(input_)).encode()
...
def create_payment_instrument(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.create_payment_instrument_request.CreatePaymentInstrumentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.create_payment_instrument_response.CreatePaymentInstrumentResponse, zapros.Response]:
...
async def async_create_payment_instrument(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.create_payment_instrument_request.CreatePaymentInstrumentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.create_payment_instrument_response.CreatePaymentInstrumentResponse, zapros.Response]:
