...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.create_payment_instrument_response.CreatePaymentInstrumentResponse = aws_sdk_bedrock_agentcore.types.create_payment_instrument_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.create_payment_instrument_request.CreatePaymentInstrumentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.create_payment_instrument_request.serialize_json(
            input_
        )
    ).encode()
