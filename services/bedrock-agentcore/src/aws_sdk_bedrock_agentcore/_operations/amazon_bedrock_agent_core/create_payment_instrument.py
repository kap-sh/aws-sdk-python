...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.create_payment_instrument_request.CreatePaymentInstrumentRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.create_payment_instrument_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.create_payment_instrument_request.serialize_json(input)).encode()
...
def create_payment_instrument(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.create_payment_instrument_request.CreatePaymentInstrumentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.create_payment_instrument_response.CreatePaymentInstrumentResponse, zapros.Response]:
...
async def async_create_payment_instrument(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.create_payment_instrument_request.CreatePaymentInstrumentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.create_payment_instrument_response.CreatePaymentInstrumentResponse, zapros.Response]:
