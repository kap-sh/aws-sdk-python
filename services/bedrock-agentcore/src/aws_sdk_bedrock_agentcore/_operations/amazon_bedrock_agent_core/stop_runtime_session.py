...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.stop_runtime_session_request.StopRuntimeSessionRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.stop_runtime_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.stop_runtime_session_request.serialize_json(input)).encode()
...
def stop_runtime_session(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.stop_runtime_session_request.StopRuntimeSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_runtime_session_response.StopRuntimeSessionResponse, zapros.Response]:
...
async def async_stop_runtime_session(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.stop_runtime_session_request.StopRuntimeSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_runtime_session_response.StopRuntimeSessionResponse, zapros.Response]:
