"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#StopRuntimeSession``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.stop_runtime_session_response.StopRuntimeSessionResponse:
    out: aws_sdk_bedrock_agentcore.types.stop_runtime_session_response.StopRuntimeSessionResponse = {}  # type: ignore[typeddict-item]
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.stop_runtime_session_request.StopRuntimeSessionRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.stop_runtime_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.stop_runtime_session_request.serialize_json(input_)).encode()
...
def stop_runtime_session(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.stop_runtime_session_request.StopRuntimeSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_runtime_session_response.StopRuntimeSessionResponse, zapros.Response]:
...
async def async_stop_runtime_session(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.stop_runtime_session_request.StopRuntimeSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_runtime_session_response.StopRuntimeSessionResponse, zapros.Response]:
