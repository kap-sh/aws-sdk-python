"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#StopBatchEvaluation``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_response.StopBatchEvaluationResponse:
    import aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_response
    out: aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_response.StopBatchEvaluationResponse = aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_request.StopBatchEvaluationRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/evaluations/batch-evaluate/{batchEvaluationId}/stop"
...
def stop_batch_evaluation(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_request.StopBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_response.StopBatchEvaluationResponse, zapros.Response]:
...
async def async_stop_batch_evaluation(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_request.StopBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_response.StopBatchEvaluationResponse, zapros.Response]:
