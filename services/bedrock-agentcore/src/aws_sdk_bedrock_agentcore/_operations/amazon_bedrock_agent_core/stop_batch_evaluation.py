...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_request.StopBatchEvaluationRequest) -> zapros.Request:
...
def stop_batch_evaluation(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_request.StopBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_response.StopBatchEvaluationResponse, zapros.Response]:
...
async def async_stop_batch_evaluation(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_request.StopBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_response.StopBatchEvaluationResponse, zapros.Response]:
