...
) -> aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_response.StopBatchEvaluationResponse:
    import aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_response

    out: aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_response.StopBatchEvaluationResponse = aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.stop_batch_evaluation_request.StopBatchEvaluationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_stop_batch_evaluation(
