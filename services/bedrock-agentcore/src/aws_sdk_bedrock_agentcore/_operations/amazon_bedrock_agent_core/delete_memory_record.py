...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.delete_memory_record_output.DeleteMemoryRecordOutput = aws_sdk_bedrock_agentcore.types.delete_memory_record_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.delete_memory_record_input.DeleteMemoryRecordInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
