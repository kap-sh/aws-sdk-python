...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_memory_record_input.DeleteMemoryRecordInput) -> zapros.Request:
...
def delete_memory_record(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_memory_record_input.DeleteMemoryRecordInput) -> tuple[aws_sdk_bedrock_agentcore.types.delete_memory_record_output.DeleteMemoryRecordOutput, zapros.Response]:
...
async def async_delete_memory_record(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_memory_record_input.DeleteMemoryRecordInput) -> tuple[aws_sdk_bedrock_agentcore.types.delete_memory_record_output.DeleteMemoryRecordOutput, zapros.Response]:
