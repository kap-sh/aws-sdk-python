...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.delete_memory_record_output.DeleteMemoryRecordOutput:
    import aws_sdk_bedrock_agentcore.types.delete_memory_record_output
    out: aws_sdk_bedrock_agentcore.types.delete_memory_record_output.DeleteMemoryRecordOutput = aws_sdk_bedrock_agentcore.types.delete_memory_record_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_memory_record_input.DeleteMemoryRecordInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memories/{memoryId}/memoryRecords/{memoryRecordId}"
...
def delete_memory_record(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_memory_record_input.DeleteMemoryRecordInput) -> tuple[aws_sdk_bedrock_agentcore.types.delete_memory_record_output.DeleteMemoryRecordOutput, zapros.Response]:
...
async def async_delete_memory_record(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_memory_record_input.DeleteMemoryRecordInput) -> tuple[aws_sdk_bedrock_agentcore.types.delete_memory_record_output.DeleteMemoryRecordOutput, zapros.Response]:
