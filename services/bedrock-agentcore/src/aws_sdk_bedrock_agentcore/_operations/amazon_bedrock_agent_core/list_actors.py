...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.list_actors_output.ListActorsOutput:
    import aws_sdk_bedrock_agentcore.types.list_actors_output
    out: aws_sdk_bedrock_agentcore.types.list_actors_output.ListActorsOutput = aws_sdk_bedrock_agentcore.types.list_actors_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_actors_input.ListActorsInput) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.list_actors_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_actors_input.serialize_json(input)).encode()
...
def list_actors(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.list_actors_input.ListActorsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_actors_output.ListActorsOutput, zapros.Response]:
...
async def async_list_actors(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_actors_input.ListActorsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_actors_output.ListActorsOutput, zapros.Response]:
