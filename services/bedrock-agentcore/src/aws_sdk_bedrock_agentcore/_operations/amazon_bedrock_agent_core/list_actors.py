...
) -> aws_sdk_bedrock_agentcore.types.list_actors_output.ListActorsOutput:
    import aws_sdk_bedrock_agentcore.types.list_actors_output

    out: aws_sdk_bedrock_agentcore.types.list_actors_output.ListActorsOutput = (
        aws_sdk_bedrock_agentcore.types.list_actors_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.list_actors_input.ListActorsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.list_actors_input.serialize_json(input_)
    ).encode()
...
def list_actors(
    ...
    aws_sdk_bedrock_agentcore.types.list_actors_output.ListActorsOutput, zapros.Response
]:
