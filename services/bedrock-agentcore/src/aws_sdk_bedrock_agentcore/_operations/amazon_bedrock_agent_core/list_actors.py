...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_actors_input.ListActorsInput) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.list_actors_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_actors_input.serialize_json(input_)).encode()
...
def list_actors(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_actors_input.ListActorsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_actors_output.ListActorsOutput, zapros.Response]:
...
async def async_list_actors(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_actors_input.ListActorsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_actors_output.ListActorsOutput, zapros.Response]:
