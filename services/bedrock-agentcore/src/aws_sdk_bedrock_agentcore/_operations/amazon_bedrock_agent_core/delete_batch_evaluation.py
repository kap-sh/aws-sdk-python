...
) -> aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_response.DeleteBatchEvaluationResponse:
    import aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_response

    out: aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_response.DeleteBatchEvaluationResponse = aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_request.DeleteBatchEvaluationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{batchEvaluationId}", quote(str(input_["batch_evaluation_id"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_delete_batch_evaluation(
