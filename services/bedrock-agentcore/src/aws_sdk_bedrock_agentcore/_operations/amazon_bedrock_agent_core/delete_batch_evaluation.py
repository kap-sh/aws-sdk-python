"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#DeleteBatchEvaluation``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnauthorizedException":
            ...
            raise aws_sdk_bedrock_agentcore.errors.unauthorized_exception.UnauthorizedException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_response.DeleteBatchEvaluationResponse:
    import aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_response
    out: aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_response.DeleteBatchEvaluationResponse = aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_request.DeleteBatchEvaluationRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/evaluations/batch-evaluate/{batchEvaluationId}"
    url = url.replace("{batchEvaluationId}", quote(str(input_["batch_evaluation_id"]), safe=""))
    params: dict[str, str] = {}
...
def delete_batch_evaluation(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_request.DeleteBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_response.DeleteBatchEvaluationResponse, zapros.Response]:
...
async def async_delete_batch_evaluation(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_request.DeleteBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_response.DeleteBatchEvaluationResponse, zapros.Response]:
