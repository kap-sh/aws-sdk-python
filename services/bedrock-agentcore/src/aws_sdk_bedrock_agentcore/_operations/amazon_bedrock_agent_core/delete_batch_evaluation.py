...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_request.DeleteBatchEvaluationRequest) -> zapros.Request:
    ...
    url = url.replace("{batchEvaluationId}", quote(str(input["batch_evaluation_id"]), safe=""))
    params: dict[str, str] = {}
...
def delete_batch_evaluation(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_request.DeleteBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_response.DeleteBatchEvaluationResponse, zapros.Response]:
...
async def async_delete_batch_evaluation(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_request.DeleteBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_batch_evaluation_response.DeleteBatchEvaluationResponse, zapros.Response]:
