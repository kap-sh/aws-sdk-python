...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request.CompleteResourceTokenAuthRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_complete_resource_token_auth(
