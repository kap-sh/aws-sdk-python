"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#CompleteResourceTokenAuth``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_response.CompleteResourceTokenAuthResponse:
    out: aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_response.CompleteResourceTokenAuthResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request.CompleteResourceTokenAuthRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/identities/CompleteResourceTokenAuth"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request.serialize_json(input_)).encode()
...
def complete_resource_token_auth(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request.CompleteResourceTokenAuthRequest) -> tuple[aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_response.CompleteResourceTokenAuthResponse, zapros.Response]:
...
async def async_complete_resource_token_auth(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request.CompleteResourceTokenAuthRequest) -> tuple[aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_response.CompleteResourceTokenAuthResponse, zapros.Response]:
