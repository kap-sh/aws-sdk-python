...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request.CompleteResourceTokenAuthRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request.serialize_json(input)).encode()
...
def complete_resource_token_auth(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request.CompleteResourceTokenAuthRequest) -> tuple[aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_response.CompleteResourceTokenAuthResponse, zapros.Response]:
...
async def async_complete_resource_token_auth(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request.CompleteResourceTokenAuthRequest) -> tuple[aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_response.CompleteResourceTokenAuthResponse, zapros.Response]:
