...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_input.BatchDeleteMemoryRecordsInput) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_input.serialize_json(input)).encode()
...
def batch_delete_memory_records(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_input.BatchDeleteMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_output.BatchDeleteMemoryRecordsOutput, zapros.Response]:
...
async def async_batch_delete_memory_records(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_input.BatchDeleteMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_output.BatchDeleteMemoryRecordsOutput, zapros.Response]:
