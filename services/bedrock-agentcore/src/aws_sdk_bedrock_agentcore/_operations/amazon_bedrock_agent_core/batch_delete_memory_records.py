...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_output.BatchDeleteMemoryRecordsOutput = aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.batch_delete_memory_records_input.BatchDeleteMemoryRecordsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
