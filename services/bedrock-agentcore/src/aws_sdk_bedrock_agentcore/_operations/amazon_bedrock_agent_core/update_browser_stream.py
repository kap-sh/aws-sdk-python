"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#UpdateBrowserStream``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.update_browser_stream_response.UpdateBrowserStreamResponse = aws_sdk_bedrock_agentcore.types.update_browser_stream_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.update_browser_stream_request.UpdateBrowserStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_browser_stream(
