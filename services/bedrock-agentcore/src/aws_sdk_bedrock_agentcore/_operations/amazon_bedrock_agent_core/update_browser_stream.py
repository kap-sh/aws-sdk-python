...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.update_browser_stream_response.UpdateBrowserStreamResponse:
    import aws_sdk_bedrock_agentcore.types.update_browser_stream_response
    out: aws_sdk_bedrock_agentcore.types.update_browser_stream_response.UpdateBrowserStreamResponse = aws_sdk_bedrock_agentcore.types.update_browser_stream_response.deserialize_json(json.loads(response.read()))
    return out
