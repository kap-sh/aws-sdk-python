...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.get_agent_card_response.GetAgentCardResponse = {
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.get_agent_card_request.GetAgentCardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
