"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#GetMemoryRecord``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.get_memory_record_output.GetMemoryRecordOutput:
    import aws_sdk_bedrock_agentcore.types.get_memory_record_output
    out: aws_sdk_bedrock_agentcore.types.get_memory_record_output.GetMemoryRecordOutput = aws_sdk_bedrock_agentcore.types.get_memory_record_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_memory_record_input.GetMemoryRecordInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memories/{memoryId}/memoryRecord/{memoryRecordId}"
    url = url.replace("{memoryId}", quote(str(input["memory_id"]), safe=""))
    url = url.replace("{memoryRecordId}", quote(str(input["memory_record_id"]), safe=""))
    params: dict[str, str] = {}
...
def get_memory_record(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.get_memory_record_input.GetMemoryRecordInput) -> tuple[aws_sdk_bedrock_agentcore.types.get_memory_record_output.GetMemoryRecordOutput, zapros.Response]:
...
async def async_get_memory_record(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_memory_record_input.GetMemoryRecordInput) -> tuple[aws_sdk_bedrock_agentcore.types.get_memory_record_output.GetMemoryRecordOutput, zapros.Response]:
