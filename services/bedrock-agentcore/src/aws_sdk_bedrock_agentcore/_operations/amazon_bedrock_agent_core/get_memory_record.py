...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_memory_record_input.GetMemoryRecordInput) -> zapros.Request:
    ...
    url = url.replace("{memoryRecordId}", quote(str(input_["memory_record_id"]), safe=""))
    params: dict[str, str] = {}
...
def get_memory_record(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_memory_record_input.GetMemoryRecordInput) -> tuple[aws_sdk_bedrock_agentcore.types.get_memory_record_output.GetMemoryRecordOutput, zapros.Response]:
...
async def async_get_memory_record(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_memory_record_input.GetMemoryRecordInput) -> tuple[aws_sdk_bedrock_agentcore.types.get_memory_record_output.GetMemoryRecordOutput, zapros.Response]:
