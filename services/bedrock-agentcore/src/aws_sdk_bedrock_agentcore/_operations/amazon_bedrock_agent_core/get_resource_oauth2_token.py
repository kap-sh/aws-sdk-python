...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_request.GetResourceOauth2TokenRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_request.serialize_json(input)).encode()
...
def get_resource_oauth2_token(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_request.GetResourceOauth2TokenRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_response.GetResourceOauth2TokenResponse, zapros.Response]:
...
async def async_get_resource_oauth2_token(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_request.GetResourceOauth2TokenRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_response.GetResourceOauth2TokenResponse, zapros.Response]:
