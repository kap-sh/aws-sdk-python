...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.get_ab_test_response.GetABTestResponse:
    import aws_sdk_bedrock_agentcore.types.get_ab_test_response
    out: aws_sdk_bedrock_agentcore.types.get_ab_test_response.GetABTestResponse = aws_sdk_bedrock_agentcore.types.get_ab_test_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_ab_test_request.GetABTestRequest) -> zapros.Request:
...
def get_ab_test(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.get_ab_test_request.GetABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_ab_test_response.GetABTestResponse, zapros.Response]:
...
async def async_get_ab_test(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_ab_test_request.GetABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_ab_test_response.GetABTestResponse, zapros.Response]:
