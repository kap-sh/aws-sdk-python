...
) -> aws_sdk_bedrock_agentcore.types.create_event_output.CreateEventOutput:
    import aws_sdk_bedrock_agentcore.types.create_event_output

    out: aws_sdk_bedrock_agentcore.types.create_event_output.CreateEventOutput = (
        aws_sdk_bedrock_agentcore.types.create_event_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.create_event_input.CreateEventInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.create_event_input.serialize_json(input_)
    ).encode()
