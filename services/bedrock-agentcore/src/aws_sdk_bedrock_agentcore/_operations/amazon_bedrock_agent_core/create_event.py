...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.create_event_input.CreateEventInput) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.create_event_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.create_event_input.serialize_json(input_)).encode()
...
def create_event(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.create_event_input.CreateEventInput) -> tuple[aws_sdk_bedrock_agentcore.types.create_event_output.CreateEventOutput, zapros.Response]:
...
async def async_create_event(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.create_event_input.CreateEventInput) -> tuple[aws_sdk_bedrock_agentcore.types.create_event_output.CreateEventOutput, zapros.Response]:
