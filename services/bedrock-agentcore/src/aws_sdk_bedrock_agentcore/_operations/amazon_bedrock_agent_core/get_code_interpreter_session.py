...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.get_code_interpreter_session_response.GetCodeInterpreterSessionResponse = aws_sdk_bedrock_agentcore.types.get_code_interpreter_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.get_code_interpreter_session_request.GetCodeInterpreterSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_code_interpreter_session(
