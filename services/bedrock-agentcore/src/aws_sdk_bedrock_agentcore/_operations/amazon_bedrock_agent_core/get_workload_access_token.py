"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#GetWorkloadAccessToken``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.GetWorkloadAccessTokenResponse:
    import aws_sdk_bedrock_agentcore.types.get_workload_access_token_response
    out: aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.GetWorkloadAccessTokenResponse = aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_workload_access_token_request.GetWorkloadAccessTokenRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.get_workload_access_token_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_workload_access_token_request.serialize_json(input_)).encode()
...
def get_workload_access_token(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_workload_access_token_request.GetWorkloadAccessTokenRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.GetWorkloadAccessTokenResponse, zapros.Response]:
...
async def async_get_workload_access_token(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_workload_access_token_request.GetWorkloadAccessTokenRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.GetWorkloadAccessTokenResponse, zapros.Response]:
