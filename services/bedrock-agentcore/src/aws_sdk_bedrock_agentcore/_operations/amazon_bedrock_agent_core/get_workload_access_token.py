...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.GetWorkloadAccessTokenResponse = aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.get_workload_access_token_request.GetWorkloadAccessTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_workload_access_token(
