...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_workload_access_token_request.GetWorkloadAccessTokenRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.get_workload_access_token_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_workload_access_token_request.serialize_json(input)).encode()
...
def get_workload_access_token(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.get_workload_access_token_request.GetWorkloadAccessTokenRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.GetWorkloadAccessTokenResponse, zapros.Response]:
...
async def async_get_workload_access_token(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_workload_access_token_request.GetWorkloadAccessTokenRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.GetWorkloadAccessTokenResponse, zapros.Response]:
