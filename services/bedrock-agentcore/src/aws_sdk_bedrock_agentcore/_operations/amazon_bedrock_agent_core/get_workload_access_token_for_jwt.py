...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.GetWorkloadAccessTokenForJWTResponse = aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request.GetWorkloadAccessTokenForJWTRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_workload_access_token_for_jwt(
