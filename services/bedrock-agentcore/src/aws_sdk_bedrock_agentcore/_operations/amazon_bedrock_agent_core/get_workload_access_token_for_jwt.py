"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#GetWorkloadAccessTokenForJWT``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.GetWorkloadAccessTokenForJWTResponse:
    import aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response
    out: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.GetWorkloadAccessTokenForJWTResponse = aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request.GetWorkloadAccessTokenForJWTRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/identities/GetWorkloadAccessTokenForJWT"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request.serialize_json(input_)).encode()
...
def get_workload_access_token_for_jwt(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request.GetWorkloadAccessTokenForJWTRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.GetWorkloadAccessTokenForJWTResponse, zapros.Response]:
...
async def async_get_workload_access_token_for_jwt(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request.GetWorkloadAccessTokenForJWTRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.GetWorkloadAccessTokenForJWTResponse, zapros.Response]:
