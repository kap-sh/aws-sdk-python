...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request.GetWorkloadAccessTokenForJWTRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request.serialize_json(input)).encode()
...
async def async_get_workload_access_token_for_jwt(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request.GetWorkloadAccessTokenForJWTRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.GetWorkloadAccessTokenForJWTResponse, zapros.Response]:
