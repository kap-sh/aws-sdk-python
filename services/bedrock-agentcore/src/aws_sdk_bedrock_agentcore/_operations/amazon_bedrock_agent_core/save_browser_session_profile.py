...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.save_browser_session_profile_request.SaveBrowserSessionProfileRequest) -> zapros.Request:
    ...
    url = url.replace("{profileIdentifier}", quote(str(input["profile_identifier"]), safe=""))
    params: dict[str, str] = {}
    ...
    import aws_sdk_bedrock_agentcore.types.save_browser_session_profile_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.save_browser_session_profile_request.serialize_json(input)).encode()
...
def save_browser_session_profile(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.save_browser_session_profile_request.SaveBrowserSessionProfileRequest) -> tuple[aws_sdk_bedrock_agentcore.types.save_browser_session_profile_response.SaveBrowserSessionProfileResponse, zapros.Response]:
...
async def async_save_browser_session_profile(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.save_browser_session_profile_request.SaveBrowserSessionProfileRequest) -> tuple[aws_sdk_bedrock_agentcore.types.save_browser_session_profile_response.SaveBrowserSessionProfileResponse, zapros.Response]:
