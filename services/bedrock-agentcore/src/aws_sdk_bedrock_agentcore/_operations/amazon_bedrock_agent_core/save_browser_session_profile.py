"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#SaveBrowserSessionProfile``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.save_browser_session_profile_response.SaveBrowserSessionProfileResponse:
    import aws_sdk_bedrock_agentcore.types.save_browser_session_profile_response
    out: aws_sdk_bedrock_agentcore.types.save_browser_session_profile_response.SaveBrowserSessionProfileResponse = aws_sdk_bedrock_agentcore.types.save_browser_session_profile_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.save_browser_session_profile_request.SaveBrowserSessionProfileRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/browser-profiles/{profileIdentifier}/save"
    url = url.replace("{profileIdentifier}", quote(str(input_["profile_identifier"]), safe=""))
    params: dict[str, str] = {}
    ...
    import aws_sdk_bedrock_agentcore.types.save_browser_session_profile_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.save_browser_session_profile_request.serialize_json(input_)).encode()
...
def save_browser_session_profile(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.save_browser_session_profile_request.SaveBrowserSessionProfileRequest) -> tuple[aws_sdk_bedrock_agentcore.types.save_browser_session_profile_response.SaveBrowserSessionProfileResponse, zapros.Response]:
...
async def async_save_browser_session_profile(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.save_browser_session_profile_request.SaveBrowserSessionProfileRequest) -> tuple[aws_sdk_bedrock_agentcore.types.save_browser_session_profile_response.SaveBrowserSessionProfileResponse, zapros.Response]:
