...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.delete_payment_instrument_response.DeletePaymentInstrumentResponse:
    import aws_sdk_bedrock_agentcore.types.delete_payment_instrument_response
    out: aws_sdk_bedrock_agentcore.types.delete_payment_instrument_response.DeletePaymentInstrumentResponse = aws_sdk_bedrock_agentcore.types.delete_payment_instrument_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_payment_instrument_request.DeletePaymentInstrumentRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.delete_payment_instrument_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.delete_payment_instrument_request.serialize_json(input)).encode()
...
def delete_payment_instrument(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_payment_instrument_request.DeletePaymentInstrumentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_payment_instrument_response.DeletePaymentInstrumentResponse, zapros.Response]:
...
async def async_delete_payment_instrument(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_payment_instrument_request.DeletePaymentInstrumentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_payment_instrument_response.DeletePaymentInstrumentResponse, zapros.Response]:
