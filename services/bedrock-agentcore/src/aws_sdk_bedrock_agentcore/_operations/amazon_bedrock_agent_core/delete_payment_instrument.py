...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_payment_instrument_request.DeletePaymentInstrumentRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.delete_payment_instrument_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.delete_payment_instrument_request.serialize_json(input_)).encode()
...
def delete_payment_instrument(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_payment_instrument_request.DeletePaymentInstrumentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_payment_instrument_response.DeletePaymentInstrumentResponse, zapros.Response]:
...
async def async_delete_payment_instrument(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_payment_instrument_request.DeletePaymentInstrumentRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_payment_instrument_response.DeletePaymentInstrumentResponse, zapros.Response]:
