...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse = aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.get_resource_api_key_request.GetResourceApiKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.get_resource_api_key_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_resource_api_key(
