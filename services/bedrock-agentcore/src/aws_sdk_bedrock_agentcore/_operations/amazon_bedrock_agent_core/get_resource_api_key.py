...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_resource_api_key_request.GetResourceApiKeyRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.get_resource_api_key_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_resource_api_key_request.serialize_json(input)).encode()
...
def get_resource_api_key(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.get_resource_api_key_request.GetResourceApiKeyRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse, zapros.Response]:
...
async def async_get_resource_api_key(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_resource_api_key_request.GetResourceApiKeyRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse, zapros.Response]:
