"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#GetResourceApiKey``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse:
    import aws_sdk_bedrock_agentcore.types.get_resource_api_key_response
    out: aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse = aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_resource_api_key_request.GetResourceApiKeyRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/identities/api-key"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.get_resource_api_key_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_resource_api_key_request.serialize_json(input_)).encode()
...
def get_resource_api_key(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_resource_api_key_request.GetResourceApiKeyRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse, zapros.Response]:
...
async def async_get_resource_api_key(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_resource_api_key_request.GetResourceApiKeyRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse, zapros.Response]:
