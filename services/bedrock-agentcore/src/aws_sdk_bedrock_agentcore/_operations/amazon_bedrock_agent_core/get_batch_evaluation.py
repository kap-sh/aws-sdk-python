...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_batch_evaluation_request.GetBatchEvaluationRequest) -> zapros.Request:
...
def get_batch_evaluation(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.get_batch_evaluation_request.GetBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_batch_evaluation_response.GetBatchEvaluationResponse, zapros.Response]:
...
async def async_get_batch_evaluation(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_batch_evaluation_request.GetBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_batch_evaluation_response.GetBatchEvaluationResponse, zapros.Response]:
