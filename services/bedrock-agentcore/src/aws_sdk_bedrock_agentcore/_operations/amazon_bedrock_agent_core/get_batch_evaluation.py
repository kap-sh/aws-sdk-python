"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#GetBatchEvaluation``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.get_batch_evaluation_response.GetBatchEvaluationResponse:
    import aws_sdk_bedrock_agentcore.types.get_batch_evaluation_response
    out: aws_sdk_bedrock_agentcore.types.get_batch_evaluation_response.GetBatchEvaluationResponse = aws_sdk_bedrock_agentcore.types.get_batch_evaluation_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_batch_evaluation_request.GetBatchEvaluationRequest) -> zapros.Request:
...
def get_batch_evaluation(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_batch_evaluation_request.GetBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_batch_evaluation_response.GetBatchEvaluationResponse, zapros.Response]:
...
async def async_get_batch_evaluation(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_batch_evaluation_request.GetBatchEvaluationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_batch_evaluation_response.GetBatchEvaluationResponse, zapros.Response]:
