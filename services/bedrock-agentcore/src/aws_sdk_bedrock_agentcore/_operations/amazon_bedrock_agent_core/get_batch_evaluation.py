...
) -> aws_sdk_bedrock_agentcore.types.get_batch_evaluation_response.GetBatchEvaluationResponse:
    import aws_sdk_bedrock_agentcore.types.get_batch_evaluation_response

    out: aws_sdk_bedrock_agentcore.types.get_batch_evaluation_response.GetBatchEvaluationResponse = aws_sdk_bedrock_agentcore.types.get_batch_evaluation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.get_batch_evaluation_request.GetBatchEvaluationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_batch_evaluation(
