...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_recommendations_request.ListRecommendationsRequest) -> zapros.Request:
    ...
    if "status_filter" in input:
        params["status"] = str(input["status_filter"])
...
def list_recommendations(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.list_recommendations_request.ListRecommendationsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_recommendations_response.ListRecommendationsResponse, zapros.Response]:
...
async def async_list_recommendations(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_recommendations_request.ListRecommendationsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_recommendations_response.ListRecommendationsResponse, zapros.Response]:
