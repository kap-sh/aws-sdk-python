"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#ListRecommendations``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.list_recommendations_response.ListRecommendationsResponse:
    import aws_sdk_bedrock_agentcore.types.list_recommendations_response
    out: aws_sdk_bedrock_agentcore.types.list_recommendations_response.ListRecommendationsResponse = aws_sdk_bedrock_agentcore.types.list_recommendations_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_recommendations_request.ListRecommendationsRequest) -> zapros.Request:
    ...
    if "status_filter" in input_:
        params["status"] = str(input_["status_filter"])
...
def list_recommendations(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_recommendations_request.ListRecommendationsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_recommendations_response.ListRecommendationsResponse, zapros.Response]:
...
async def async_list_recommendations(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_recommendations_request.ListRecommendationsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_recommendations_response.ListRecommendationsResponse, zapros.Response]:
