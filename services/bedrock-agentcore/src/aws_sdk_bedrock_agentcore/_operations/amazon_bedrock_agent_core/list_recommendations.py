...
) -> aws_sdk_bedrock_agentcore.types.list_recommendations_response.ListRecommendationsResponse:
    import aws_sdk_bedrock_agentcore.types.list_recommendations_response

    out: aws_sdk_bedrock_agentcore.types.list_recommendations_response.ListRecommendationsResponse = aws_sdk_bedrock_agentcore.types.list_recommendations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.list_recommendations_request.ListRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
