...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.stop_browser_session_response.StopBrowserSessionResponse = aws_sdk_bedrock_agentcore.types.stop_browser_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.stop_browser_session_request.StopBrowserSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.stop_browser_session_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_stop_browser_session(
