...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.stop_browser_session_request.StopBrowserSessionRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.stop_browser_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.stop_browser_session_request.serialize_json(input)).encode()
...
def stop_browser_session(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.stop_browser_session_request.StopBrowserSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_browser_session_response.StopBrowserSessionResponse, zapros.Response]:
...
async def async_stop_browser_session(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.stop_browser_session_request.StopBrowserSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_browser_session_response.StopBrowserSessionResponse, zapros.Response]:
