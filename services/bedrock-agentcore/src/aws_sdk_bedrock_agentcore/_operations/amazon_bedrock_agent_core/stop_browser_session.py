"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#StopBrowserSession``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.stop_browser_session_response.StopBrowserSessionResponse:
    import aws_sdk_bedrock_agentcore.types.stop_browser_session_response
    out: aws_sdk_bedrock_agentcore.types.stop_browser_session_response.StopBrowserSessionResponse = aws_sdk_bedrock_agentcore.types.stop_browser_session_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.stop_browser_session_request.StopBrowserSessionRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/browsers/{browserIdentifier}/sessions/stop"
    ...
    import aws_sdk_bedrock_agentcore.types.stop_browser_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.stop_browser_session_request.serialize_json(input_)).encode()
...
def stop_browser_session(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.stop_browser_session_request.StopBrowserSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_browser_session_response.StopBrowserSessionResponse, zapros.Response]:
...
async def async_stop_browser_session(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.stop_browser_session_request.StopBrowserSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_browser_session_response.StopBrowserSessionResponse, zapros.Response]:
