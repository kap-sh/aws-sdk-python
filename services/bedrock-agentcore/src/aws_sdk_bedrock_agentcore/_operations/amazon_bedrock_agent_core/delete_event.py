...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.delete_event_output.DeleteEventOutput:
    import aws_sdk_bedrock_agentcore.types.delete_event_output
    out: aws_sdk_bedrock_agentcore.types.delete_event_output.DeleteEventOutput = aws_sdk_bedrock_agentcore.types.delete_event_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_event_input.DeleteEventInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memories/{memoryId}/actor/{actorId}/sessions/{sessionId}/events/{eventId}"
...
def delete_event(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_event_input.DeleteEventInput) -> tuple[aws_sdk_bedrock_agentcore.types.delete_event_output.DeleteEventOutput, zapros.Response]:
...
async def async_delete_event(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_event_input.DeleteEventInput) -> tuple[aws_sdk_bedrock_agentcore.types.delete_event_output.DeleteEventOutput, zapros.Response]:
