...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.delete_event_output.DeleteEventOutput = (
        aws_sdk_bedrock_agentcore.types.delete_event_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.delete_event_input.DeleteEventInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
