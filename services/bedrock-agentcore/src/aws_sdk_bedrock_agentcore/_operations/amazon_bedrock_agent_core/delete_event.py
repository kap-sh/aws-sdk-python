...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_event_input.DeleteEventInput) -> zapros.Request:
...
def delete_event(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_event_input.DeleteEventInput) -> tuple[aws_sdk_bedrock_agentcore.types.delete_event_output.DeleteEventOutput, zapros.Response]:
...
async def async_delete_event(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_event_input.DeleteEventInput) -> tuple[aws_sdk_bedrock_agentcore.types.delete_event_output.DeleteEventOutput, zapros.Response]:
