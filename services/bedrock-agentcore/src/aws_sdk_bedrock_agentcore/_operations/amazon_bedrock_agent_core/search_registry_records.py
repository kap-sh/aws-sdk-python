"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#SearchRegistryRecords``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.search_registry_records_response.SearchRegistryRecordsResponse:
    import aws_sdk_bedrock_agentcore.types.search_registry_records_response
    out: aws_sdk_bedrock_agentcore.types.search_registry_records_response.SearchRegistryRecordsResponse = aws_sdk_bedrock_agentcore.types.search_registry_records_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.search_registry_records_request.SearchRegistryRecordsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/registry-records/search"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.search_registry_records_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.search_registry_records_request.serialize_json(input_)).encode()
...
def search_registry_records(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.search_registry_records_request.SearchRegistryRecordsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.search_registry_records_response.SearchRegistryRecordsResponse, zapros.Response]:
...
async def async_search_registry_records(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.search_registry_records_request.SearchRegistryRecordsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.search_registry_records_response.SearchRegistryRecordsResponse, zapros.Response]:
