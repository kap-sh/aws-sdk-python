...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.search_registry_records_request.SearchRegistryRecordsRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.search_registry_records_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.search_registry_records_request.serialize_json(input)).encode()
...
def search_registry_records(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.search_registry_records_request.SearchRegistryRecordsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.search_registry_records_response.SearchRegistryRecordsResponse, zapros.Response]:
...
async def async_search_registry_records(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.search_registry_records_request.SearchRegistryRecordsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.search_registry_records_response.SearchRegistryRecordsResponse, zapros.Response]:
