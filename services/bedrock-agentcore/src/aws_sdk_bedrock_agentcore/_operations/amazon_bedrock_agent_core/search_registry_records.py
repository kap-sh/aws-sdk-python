...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.search_registry_records_response.SearchRegistryRecordsResponse = aws_sdk_bedrock_agentcore.types.search_registry_records_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.search_registry_records_request.SearchRegistryRecordsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.search_registry_records_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_search_registry_records(
