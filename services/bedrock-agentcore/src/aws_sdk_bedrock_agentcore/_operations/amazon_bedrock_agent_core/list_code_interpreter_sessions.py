...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.list_code_interpreter_sessions_response.ListCodeInterpreterSessionsResponse = aws_sdk_bedrock_agentcore.types.list_code_interpreter_sessions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.list_code_interpreter_sessions_request.ListCodeInterpreterSessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.list_code_interpreter_sessions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_code_interpreter_sessions(
