...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.list_payment_instruments_response.ListPaymentInstrumentsResponse = aws_sdk_bedrock_agentcore.types.list_payment_instruments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.list_payment_instruments_request.ListPaymentInstrumentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.list_payment_instruments_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_payment_instruments(
