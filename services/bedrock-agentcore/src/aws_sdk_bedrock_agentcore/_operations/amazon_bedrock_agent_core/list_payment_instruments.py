...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_payment_instruments_request.ListPaymentInstrumentsRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.list_payment_instruments_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_payment_instruments_request.serialize_json(input_)).encode()
...
def list_payment_instruments(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_payment_instruments_request.ListPaymentInstrumentsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_payment_instruments_response.ListPaymentInstrumentsResponse, zapros.Response]:
...
async def async_list_payment_instruments(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_payment_instruments_request.ListPaymentInstrumentsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_payment_instruments_response.ListPaymentInstrumentsResponse, zapros.Response]:
