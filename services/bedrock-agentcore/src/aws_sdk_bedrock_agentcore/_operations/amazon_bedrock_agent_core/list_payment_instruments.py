"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#ListPaymentInstruments``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.list_payment_instruments_response.ListPaymentInstrumentsResponse:
    import aws_sdk_bedrock_agentcore.types.list_payment_instruments_response
    out: aws_sdk_bedrock_agentcore.types.list_payment_instruments_response.ListPaymentInstrumentsResponse = aws_sdk_bedrock_agentcore.types.list_payment_instruments_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_payment_instruments_request.ListPaymentInstrumentsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/payments/listPaymentInstruments"
    params: dict[str, str] = {}
    ...
    import aws_sdk_bedrock_agentcore.types.list_payment_instruments_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_payment_instruments_request.serialize_json(input)).encode()
...
def list_payment_instruments(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.list_payment_instruments_request.ListPaymentInstrumentsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_payment_instruments_response.ListPaymentInstrumentsResponse, zapros.Response]:
...
async def async_list_payment_instruments(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_payment_instruments_request.ListPaymentInstrumentsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_payment_instruments_response.ListPaymentInstrumentsResponse, zapros.Response]:
