...
) -> aws_sdk_bedrock_agentcore.types.batch_create_memory_records_output.BatchCreateMemoryRecordsOutput:
    import aws_sdk_bedrock_agentcore.types.batch_create_memory_records_output

    out: aws_sdk_bedrock_agentcore.types.batch_create_memory_records_output.BatchCreateMemoryRecordsOutput = aws_sdk_bedrock_agentcore.types.batch_create_memory_records_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.batch_create_memory_records_input.BatchCreateMemoryRecordsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.batch_create_memory_records_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_create_memory_records(
