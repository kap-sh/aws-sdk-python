"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#BatchCreateMemoryRecords``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.batch_create_memory_records_output.BatchCreateMemoryRecordsOutput:
    import aws_sdk_bedrock_agentcore.types.batch_create_memory_records_output
    out: aws_sdk_bedrock_agentcore.types.batch_create_memory_records_output.BatchCreateMemoryRecordsOutput = aws_sdk_bedrock_agentcore.types.batch_create_memory_records_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.batch_create_memory_records_input.BatchCreateMemoryRecordsInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memories/{memoryId}/memoryRecords/batchCreate"
    url = url.replace("{memoryId}", quote(str(input["memory_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.batch_create_memory_records_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.batch_create_memory_records_input.serialize_json(input)).encode()
...
def batch_create_memory_records(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.batch_create_memory_records_input.BatchCreateMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.batch_create_memory_records_output.BatchCreateMemoryRecordsOutput, zapros.Response]:
...
async def async_batch_create_memory_records(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.batch_create_memory_records_input.BatchCreateMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.batch_create_memory_records_output.BatchCreateMemoryRecordsOutput, zapros.Response]:
