...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input.RetrieveMemoryRecordsInput) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input.serialize_json(input_)).encode()
...
def retrieve_memory_records(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input.RetrieveMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.retrieve_memory_records_output.RetrieveMemoryRecordsOutput, zapros.Response]:
...
async def async_retrieve_memory_records(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input.RetrieveMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.retrieve_memory_records_output.RetrieveMemoryRecordsOutput, zapros.Response]:
