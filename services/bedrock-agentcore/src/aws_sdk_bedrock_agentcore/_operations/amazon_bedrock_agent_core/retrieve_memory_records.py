"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#RetrieveMemoryRecords``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidInputException":
            import aws_sdk_bedrock_agentcore.errors.invalid_input_exception
            raise aws_sdk_bedrock_agentcore.errors.invalid_input_exception.InvalidInputException.from_json(data)
        ...
        case "ServiceException":
            ...
            raise aws_sdk_bedrock_agentcore.errors.service_exception.ServiceException.from_json(data)
        ...
        case "ThrottledException":
            ...
            raise aws_sdk_bedrock_agentcore.errors.throttled_exception.ThrottledException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.retrieve_memory_records_output.RetrieveMemoryRecordsOutput:
    import aws_sdk_bedrock_agentcore.types.retrieve_memory_records_output
    out: aws_sdk_bedrock_agentcore.types.retrieve_memory_records_output.RetrieveMemoryRecordsOutput = aws_sdk_bedrock_agentcore.types.retrieve_memory_records_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input.RetrieveMemoryRecordsInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memories/{memoryId}/retrieve"
    url = url.replace("{memoryId}", quote(str(input["memory_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input.serialize_json(input)).encode()
...
def retrieve_memory_records(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input.RetrieveMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.retrieve_memory_records_output.RetrieveMemoryRecordsOutput, zapros.Response]:
...
async def async_retrieve_memory_records(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input.RetrieveMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.retrieve_memory_records_output.RetrieveMemoryRecordsOutput, zapros.Response]:
