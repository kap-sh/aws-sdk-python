...
) -> aws_sdk_bedrock_agentcore.types.retrieve_memory_records_output.RetrieveMemoryRecordsOutput:
    out: aws_sdk_bedrock_agentcore.types.retrieve_memory_records_output.RetrieveMemoryRecordsOutput = aws_sdk_bedrock_agentcore.types.retrieve_memory_records_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input.RetrieveMemoryRecordsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.retrieve_memory_records_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_retrieve_memory_records(
