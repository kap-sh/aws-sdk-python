...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.list_batch_evaluations_response.ListBatchEvaluationsResponse = aws_sdk_bedrock_agentcore.types.list_batch_evaluations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.list_batch_evaluations_request.ListBatchEvaluationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_batch_evaluations(
