"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#ListBatchEvaluations``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.list_batch_evaluations_response.ListBatchEvaluationsResponse:
    import aws_sdk_bedrock_agentcore.types.list_batch_evaluations_response
    out: aws_sdk_bedrock_agentcore.types.list_batch_evaluations_response.ListBatchEvaluationsResponse = aws_sdk_bedrock_agentcore.types.list_batch_evaluations_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_batch_evaluations_request.ListBatchEvaluationsRequest) -> zapros.Request:
...
def list_batch_evaluations(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_batch_evaluations_request.ListBatchEvaluationsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_batch_evaluations_response.ListBatchEvaluationsResponse, zapros.Response]:
...
async def async_list_batch_evaluations(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_batch_evaluations_request.ListBatchEvaluationsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_batch_evaluations_response.ListBatchEvaluationsResponse, zapros.Response]:
