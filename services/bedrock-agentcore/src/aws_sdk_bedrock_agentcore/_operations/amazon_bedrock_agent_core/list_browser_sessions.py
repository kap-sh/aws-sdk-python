...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_browser_sessions_request.ListBrowserSessionsRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.list_browser_sessions_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_browser_sessions_request.serialize_json(input)).encode()
...
def list_browser_sessions(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.list_browser_sessions_request.ListBrowserSessionsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_browser_sessions_response.ListBrowserSessionsResponse, zapros.Response]:
...
async def async_list_browser_sessions(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_browser_sessions_request.ListBrowserSessionsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_browser_sessions_response.ListBrowserSessionsResponse, zapros.Response]:
