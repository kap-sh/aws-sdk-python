"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#ListBrowserSessions``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.list_browser_sessions_response.ListBrowserSessionsResponse:
    import aws_sdk_bedrock_agentcore.types.list_browser_sessions_response
    out: aws_sdk_bedrock_agentcore.types.list_browser_sessions_response.ListBrowserSessionsResponse = aws_sdk_bedrock_agentcore.types.list_browser_sessions_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_browser_sessions_request.ListBrowserSessionsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/browsers/{browserIdentifier}/sessions/list"
    url = url.replace("{browserIdentifier}", quote(str(input_["browser_identifier"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.list_browser_sessions_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_browser_sessions_request.serialize_json(input_)).encode()
...
def list_browser_sessions(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_browser_sessions_request.ListBrowserSessionsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_browser_sessions_response.ListBrowserSessionsResponse, zapros.Response]:
...
async def async_list_browser_sessions(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_browser_sessions_request.ListBrowserSessionsRequest) -> tuple[aws_sdk_bedrock_agentcore.types.list_browser_sessions_response.ListBrowserSessionsResponse, zapros.Response]:
