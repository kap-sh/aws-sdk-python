...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_request.GetWorkloadAccessTokenForUserIdRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_request.serialize_json(input)).encode()
...
def get_workload_access_token_for_user_id(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_request.GetWorkloadAccessTokenForUserIdRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.GetWorkloadAccessTokenForUserIdResponse, zapros.Response]:
...
async def async_get_workload_access_token_for_user_id(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_request.GetWorkloadAccessTokenForUserIdRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.GetWorkloadAccessTokenForUserIdResponse, zapros.Response]:
