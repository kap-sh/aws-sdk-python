...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.GetWorkloadAccessTokenForUserIdResponse:
    import aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_response
    out: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.GetWorkloadAccessTokenForUserIdResponse = aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_request.GetWorkloadAccessTokenForUserIdRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_request.serialize_json(input_)).encode()
...
def get_workload_access_token_for_user_id(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_request.GetWorkloadAccessTokenForUserIdRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.GetWorkloadAccessTokenForUserIdResponse, zapros.Response]:
...
async def async_get_workload_access_token_for_user_id(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_request.GetWorkloadAccessTokenForUserIdRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.GetWorkloadAccessTokenForUserIdResponse, zapros.Response]:
