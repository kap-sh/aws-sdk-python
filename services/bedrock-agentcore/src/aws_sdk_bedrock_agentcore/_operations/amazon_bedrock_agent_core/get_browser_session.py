...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.get_browser_session_response.GetBrowserSessionResponse = aws_sdk_bedrock_agentcore.types.get_browser_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.get_browser_session_request.GetBrowserSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
