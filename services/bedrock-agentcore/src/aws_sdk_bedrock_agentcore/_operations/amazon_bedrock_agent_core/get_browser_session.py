...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.get_browser_session_response.GetBrowserSessionResponse:
    import aws_sdk_bedrock_agentcore.types.get_browser_session_response
    out: aws_sdk_bedrock_agentcore.types.get_browser_session_response.GetBrowserSessionResponse = aws_sdk_bedrock_agentcore.types.get_browser_session_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_browser_session_request.GetBrowserSessionRequest) -> zapros.Request:
...
def get_browser_session(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_browser_session_request.GetBrowserSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_browser_session_response.GetBrowserSessionResponse, zapros.Response]:
...
async def async_get_browser_session(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.get_browser_session_request.GetBrowserSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_browser_session_response.GetBrowserSessionResponse, zapros.Response]:
