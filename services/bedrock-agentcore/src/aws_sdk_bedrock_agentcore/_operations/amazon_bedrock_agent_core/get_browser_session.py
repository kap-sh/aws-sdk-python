...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_browser_session_request.GetBrowserSessionRequest) -> zapros.Request:
...
def get_browser_session(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.get_browser_session_request.GetBrowserSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_browser_session_response.GetBrowserSessionResponse, zapros.Response]:
...
async def async_get_browser_session(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.get_browser_session_request.GetBrowserSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.get_browser_session_response.GetBrowserSessionResponse, zapros.Response]:
