...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.delete_payment_session_response.DeletePaymentSessionResponse = aws_sdk_bedrock_agentcore.types.delete_payment_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.delete_payment_session_request.DeletePaymentSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_payment_session(
