...
) -> aws_sdk_bedrock_agentcore.types.list_events_output.ListEventsOutput:
    import aws_sdk_bedrock_agentcore.types.list_events_output

    out: aws_sdk_bedrock_agentcore.types.list_events_output.ListEventsOutput = (
        aws_sdk_bedrock_agentcore.types.list_events_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.list_events_input.ListEventsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.list_events_input.serialize_json(input_)
    ).encode()
...
def list_events(
    ...
    aws_sdk_bedrock_agentcore.types.list_events_output.ListEventsOutput, zapros.Response
]:
