"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#ListEvents``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.list_events_output.ListEventsOutput:
    import aws_sdk_bedrock_agentcore.types.list_events_output
    out: aws_sdk_bedrock_agentcore.types.list_events_output.ListEventsOutput = aws_sdk_bedrock_agentcore.types.list_events_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_events_input.ListEventsInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memories/{memoryId}/actor/{actorId}/sessions/{sessionId}"
    ...
    import aws_sdk_bedrock_agentcore.types.list_events_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_events_input.serialize_json(input)).encode()
...
def list_events(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.list_events_input.ListEventsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_events_output.ListEventsOutput, zapros.Response]:
...
async def async_list_events(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_events_input.ListEventsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_events_output.ListEventsOutput, zapros.Response]:
