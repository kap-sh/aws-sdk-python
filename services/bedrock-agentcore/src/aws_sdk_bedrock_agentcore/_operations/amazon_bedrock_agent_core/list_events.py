...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_events_input.ListEventsInput) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.list_events_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_events_input.serialize_json(input_)).encode()
...
def list_events(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_events_input.ListEventsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_events_output.ListEventsOutput, zapros.Response]:
...
async def async_list_events(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_events_input.ListEventsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_events_output.ListEventsOutput, zapros.Response]:
