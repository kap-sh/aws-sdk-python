...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.get_event_output.GetEventOutput = (
        aws_sdk_bedrock_agentcore.types.get_event_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.get_event_input.GetEventInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_event(
    ...
    aws_sdk_bedrock_agentcore.types.get_event_output.GetEventOutput, zapros.Response
]:
