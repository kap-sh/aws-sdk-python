...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.start_code_interpreter_session_request.StartCodeInterpreterSessionRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.start_code_interpreter_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.start_code_interpreter_session_request.serialize_json(input)).encode()
...
def start_code_interpreter_session(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.start_code_interpreter_session_request.StartCodeInterpreterSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_code_interpreter_session_response.StartCodeInterpreterSessionResponse, zapros.Response]:
...
async def async_start_code_interpreter_session(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.start_code_interpreter_session_request.StartCodeInterpreterSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.start_code_interpreter_session_response.StartCodeInterpreterSessionResponse, zapros.Response]:
