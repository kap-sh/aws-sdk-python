...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.update_ab_test_response.UpdateABTestResponse = aws_sdk_bedrock_agentcore.types.update_ab_test_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.update_ab_test_request.UpdateABTestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_ab_test(
