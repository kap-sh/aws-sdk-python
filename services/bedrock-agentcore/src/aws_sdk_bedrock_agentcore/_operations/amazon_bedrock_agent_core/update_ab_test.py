...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.update_ab_test_request.UpdateABTestRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.update_ab_test_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.update_ab_test_request.serialize_json(input_)).encode()
...
def update_ab_test(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.update_ab_test_request.UpdateABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.update_ab_test_response.UpdateABTestResponse, zapros.Response]:
...
async def async_update_ab_test(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.update_ab_test_request.UpdateABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.update_ab_test_response.UpdateABTestResponse, zapros.Response]:
