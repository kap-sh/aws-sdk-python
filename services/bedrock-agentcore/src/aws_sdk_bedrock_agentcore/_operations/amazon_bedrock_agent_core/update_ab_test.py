"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#UpdateABTest``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.update_ab_test_response.UpdateABTestResponse:
    import aws_sdk_bedrock_agentcore.types.update_ab_test_response
    out: aws_sdk_bedrock_agentcore.types.update_ab_test_response.UpdateABTestResponse = aws_sdk_bedrock_agentcore.types.update_ab_test_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.update_ab_test_request.UpdateABTestRequest) -> zapros.Request:
    ...
    url = url.replace("{abTestId}", quote(str(input["ab_test_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.update_ab_test_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.update_ab_test_request.serialize_json(input)).encode()
...
def update_ab_test(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.update_ab_test_request.UpdateABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.update_ab_test_response.UpdateABTestResponse, zapros.Response]:
...
async def async_update_ab_test(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.update_ab_test_request.UpdateABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.update_ab_test_response.UpdateABTestResponse, zapros.Response]:
