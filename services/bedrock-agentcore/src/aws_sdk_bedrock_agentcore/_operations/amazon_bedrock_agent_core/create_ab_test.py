...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.create_ab_test_request.CreateABTestRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.create_ab_test_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.create_ab_test_request.serialize_json(input)).encode()
...
def create_ab_test(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.create_ab_test_request.CreateABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.create_ab_test_response.CreateABTestResponse, zapros.Response]:
...
async def async_create_ab_test(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.create_ab_test_request.CreateABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.create_ab_test_response.CreateABTestResponse, zapros.Response]:
