...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.create_ab_test_request.CreateABTestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.create_ab_test_request.serialize_json(input_)
    ).encode()
...
async def async_create_ab_test(
