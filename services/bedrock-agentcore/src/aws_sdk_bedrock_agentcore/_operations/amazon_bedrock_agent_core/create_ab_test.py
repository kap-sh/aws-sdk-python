"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#CreateABTest``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.create_ab_test_response.CreateABTestResponse:
    import aws_sdk_bedrock_agentcore.types.create_ab_test_response
    out: aws_sdk_bedrock_agentcore.types.create_ab_test_response.CreateABTestResponse = aws_sdk_bedrock_agentcore.types.create_ab_test_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.create_ab_test_request.CreateABTestRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/ab-tests"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.create_ab_test_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.create_ab_test_request.serialize_json(input_)).encode()
...
def create_ab_test(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.create_ab_test_request.CreateABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.create_ab_test_response.CreateABTestResponse, zapros.Response]:
...
async def async_create_ab_test(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.create_ab_test_request.CreateABTestRequest) -> tuple[aws_sdk_bedrock_agentcore.types.create_ab_test_response.CreateABTestResponse, zapros.Response]:
