...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_request.StopCodeInterpreterSessionRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_request.serialize_json(input)).encode()
...
def stop_code_interpreter_session(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_request.StopCodeInterpreterSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_response.StopCodeInterpreterSessionResponse, zapros.Response]:
...
async def async_stop_code_interpreter_session(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_request.StopCodeInterpreterSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_response.StopCodeInterpreterSessionResponse, zapros.Response]:
