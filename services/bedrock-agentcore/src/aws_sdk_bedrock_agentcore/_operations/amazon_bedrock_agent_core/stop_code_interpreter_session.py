...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_response.StopCodeInterpreterSessionResponse = aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_request.StopCodeInterpreterSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_stop_code_interpreter_session(
