"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#StopCodeInterpreterSession``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_response.StopCodeInterpreterSessionResponse:
    import aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_response
    out: aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_response.StopCodeInterpreterSessionResponse = aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_request.StopCodeInterpreterSessionRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/code-interpreters/{codeInterpreterIdentifier}/sessions/stop"
    ...
    import aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_request.serialize_json(input_)).encode()
...
def stop_code_interpreter_session(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_request.StopCodeInterpreterSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_response.StopCodeInterpreterSessionResponse, zapros.Response]:
...
async def async_stop_code_interpreter_session(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_request.StopCodeInterpreterSessionRequest) -> tuple[aws_sdk_bedrock_agentcore.types.stop_code_interpreter_session_response.StopCodeInterpreterSessionResponse, zapros.Response]:
