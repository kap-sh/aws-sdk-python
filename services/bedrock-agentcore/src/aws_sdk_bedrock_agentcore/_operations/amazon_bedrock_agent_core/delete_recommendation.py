...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_recommendation_request.DeleteRecommendationRequest) -> zapros.Request:
    ...
    url = url.replace("{recommendationId}", quote(str(input["recommendation_id"]), safe=""))
    params: dict[str, str] = {}
...
def delete_recommendation(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_recommendation_request.DeleteRecommendationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_recommendation_response.DeleteRecommendationResponse, zapros.Response]:
...
async def async_delete_recommendation(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.delete_recommendation_request.DeleteRecommendationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_recommendation_response.DeleteRecommendationResponse, zapros.Response]:
