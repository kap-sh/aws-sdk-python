...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.delete_recommendation_response.DeleteRecommendationResponse = aws_sdk_bedrock_agentcore.types.delete_recommendation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.delete_recommendation_request.DeleteRecommendationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_recommendation(
