"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#DeleteRecommendation``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.delete_recommendation_response.DeleteRecommendationResponse:
    import aws_sdk_bedrock_agentcore.types.delete_recommendation_response
    out: aws_sdk_bedrock_agentcore.types.delete_recommendation_response.DeleteRecommendationResponse = aws_sdk_bedrock_agentcore.types.delete_recommendation_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_recommendation_request.DeleteRecommendationRequest) -> zapros.Request:
    ...
    url = url.replace("{recommendationId}", quote(str(input_["recommendation_id"]), safe=""))
    params: dict[str, str] = {}
...
def delete_recommendation(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_recommendation_request.DeleteRecommendationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_recommendation_response.DeleteRecommendationResponse, zapros.Response]:
...
async def async_delete_recommendation(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.delete_recommendation_request.DeleteRecommendationRequest) -> tuple[aws_sdk_bedrock_agentcore.types.delete_recommendation_response.DeleteRecommendationResponse, zapros.Response]:
