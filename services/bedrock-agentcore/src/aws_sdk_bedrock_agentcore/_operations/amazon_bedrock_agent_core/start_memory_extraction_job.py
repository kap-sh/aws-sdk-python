...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input.StartMemoryExtractionJobInput) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input.serialize_json(input_)).encode()
...
def start_memory_extraction_job(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input.StartMemoryExtractionJobInput) -> tuple[aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_output.StartMemoryExtractionJobOutput, zapros.Response]:
...
async def async_start_memory_extraction_job(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input.StartMemoryExtractionJobInput) -> tuple[aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_output.StartMemoryExtractionJobOutput, zapros.Response]:
