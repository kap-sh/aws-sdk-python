...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input.StartMemoryExtractionJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input.serialize_json(
            input_
        )
    ).encode()
