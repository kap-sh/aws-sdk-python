"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#StartMemoryExtractionJob``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_output.StartMemoryExtractionJobOutput:
    import aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_output
    out: aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_output.StartMemoryExtractionJobOutput = aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input.StartMemoryExtractionJobInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memories/{memoryId}/extractionJobs/start"
    url = url.replace("{memoryId}", quote(str(input["memory_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input.serialize_json(input)).encode()
...
def start_memory_extraction_job(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input.StartMemoryExtractionJobInput) -> tuple[aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_output.StartMemoryExtractionJobOutput, zapros.Response]:
...
async def async_start_memory_extraction_job(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_input.StartMemoryExtractionJobInput) -> tuple[aws_sdk_bedrock_agentcore.types.start_memory_extraction_job_output.StartMemoryExtractionJobOutput, zapros.Response]:
