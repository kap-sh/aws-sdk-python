...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.list_memory_records_output.ListMemoryRecordsOutput:
    import aws_sdk_bedrock_agentcore.types.list_memory_records_output
    out: aws_sdk_bedrock_agentcore.types.list_memory_records_output.ListMemoryRecordsOutput = aws_sdk_bedrock_agentcore.types.list_memory_records_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_memory_records_input.ListMemoryRecordsInput) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.list_memory_records_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_memory_records_input.serialize_json(input_)).encode()
...
def list_memory_records(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_memory_records_input.ListMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_memory_records_output.ListMemoryRecordsOutput, zapros.Response]:
...
async def async_list_memory_records(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_memory_records_input.ListMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_memory_records_output.ListMemoryRecordsOutput, zapros.Response]:
