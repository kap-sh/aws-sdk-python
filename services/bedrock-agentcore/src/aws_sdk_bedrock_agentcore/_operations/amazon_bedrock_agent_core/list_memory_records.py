...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore.types.list_memory_records_output.ListMemoryRecordsOutput = aws_sdk_bedrock_agentcore.types.list_memory_records_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.list_memory_records_input.ListMemoryRecordsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.list_memory_records_input.serialize_json(input_)
    ).encode()
