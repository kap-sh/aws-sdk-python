...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_memory_records_input.ListMemoryRecordsInput) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agentcore.types.list_memory_records_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_memory_records_input.serialize_json(input)).encode()
...
def list_memory_records(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.list_memory_records_input.ListMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_memory_records_output.ListMemoryRecordsOutput, zapros.Response]:
...
async def async_list_memory_records(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_memory_records_input.ListMemoryRecordsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_memory_records_output.ListMemoryRecordsOutput, zapros.Response]:
