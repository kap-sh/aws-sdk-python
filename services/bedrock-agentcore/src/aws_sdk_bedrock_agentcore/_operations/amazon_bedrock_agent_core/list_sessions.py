"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#ListSessions``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agentcore.types.list_sessions_output.ListSessionsOutput:
    import aws_sdk_bedrock_agentcore.types.list_sessions_output
    out: aws_sdk_bedrock_agentcore.types.list_sessions_output.ListSessionsOutput = aws_sdk_bedrock_agentcore.types.list_sessions_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_sessions_input.ListSessionsInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/memories/{memoryId}/actor/{actorId}/sessions"
    url = url.replace("{memoryId}", quote(str(input["memory_id"]), safe=""))
    url = url.replace("{actorId}", quote(str(input["actor_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.list_sessions_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_sessions_input.serialize_json(input)).encode()
...
def list_sessions(options: OperationOptions, input: aws_sdk_bedrock_agentcore.types.list_sessions_input.ListSessionsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_sessions_output.ListSessionsOutput, zapros.Response]:
...
async def async_list_sessions(options: AsyncOperationOptions, input: aws_sdk_bedrock_agentcore.types.list_sessions_input.ListSessionsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_sessions_output.ListSessionsOutput, zapros.Response]:
