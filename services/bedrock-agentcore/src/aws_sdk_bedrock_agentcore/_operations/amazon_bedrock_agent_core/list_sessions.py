...
import aws_sdk_bedrock_agentcore.types.session_summary_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidInputException":
            raise aws_sdk_bedrock_agentcore.errors.invalid_input_exception.InvalidInputException.from_json(
                data
            )
...
) -> aws_sdk_bedrock_agentcore.types.list_sessions_output.ListSessionsOutput:
    out: aws_sdk_bedrock_agentcore.types.list_sessions_output.ListSessionsOutput = (
        aws_sdk_bedrock_agentcore.types.list_sessions_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore.types.list_sessions_input.ListSessionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore.types.list_sessions_input.serialize_json(input_)
    ).encode()
