...
def build_request(options: OperationOptions | AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_sessions_input.ListSessionsInput) -> zapros.Request:
    ...
    url = url.replace("{actorId}", quote(str(input_["actor_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agentcore.types.list_sessions_input
    body: bytes | None = json.dumps(aws_sdk_bedrock_agentcore.types.list_sessions_input.serialize_json(input_)).encode()
...
def list_sessions(options: OperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_sessions_input.ListSessionsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_sessions_output.ListSessionsOutput, zapros.Response]:
...
async def async_list_sessions(options: AsyncOperationOptions, input_: aws_sdk_bedrock_agentcore.types.list_sessions_input.ListSessionsInput) -> tuple[aws_sdk_bedrock_agentcore.types.list_sessions_output.ListSessionsOutput, zapros.Response]:
