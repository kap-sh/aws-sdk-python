...
from aws_sdk_bedrock_agentcore._auth._signers import SigV4Signer
from aws_sdk_bedrock_agentcore._auth._sigv4 import presign_sigv4
import datetime
from collections.abc import Iterator
from collections.abc import Generator
from contextlib import contextmanager
from aws_sdk_bedrock_agentcore._pagination import resolve_path as _resolve_path
...
from aws_sdk_bedrock_agentcore._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
from aws_sdk_bedrock_agentcore.errors import ServiceError, WaiterFailedError, WaiterTimeoutError
import warnings
...
from aws_sdk_bedrock_agentcore._auth._providers import CredentialsProvider, StaticAwsCredentialsProvider
...
from aws_sdk_bedrock_agentcore._resources.amazon_bedrock_agent_core.agentic_resource import AgenticResource
from aws_sdk_bedrock_agentcore._resources.amazon_bedrock_agent_core.browser_profile_resource import BrowserProfileResource
from aws_sdk_bedrock_agentcore._resources.amazon_bedrock_agent_core.browser_session_resource import BrowserSessionResource
from aws_sdk_bedrock_agentcore._resources.amazon_bedrock_agent_core.code_interpreter_session_resource import CodeInterpreterSessionResource
from aws_sdk_bedrock_agentcore._resources.amazon_bedrock_agent_core.evaluation_resource import EvaluationResource
from aws_sdk_bedrock_agentcore._resources.amazon_bedrock_agent_core.memory_resource import MemoryResource
from aws_sdk_bedrock_agentcore._resources.amazon_bedrock_agent_core.payment_instrument_resource import PaymentInstrumentResource
from aws_sdk_bedrock_agentcore._resources.amazon_bedrock_agent_core.payment_session_resource import PaymentSessionResource
from aws_sdk_bedrock_agentcore._resources.amazon_bedrock_agent_core.process_payment_resource import ProcessPaymentResource
from aws_sdk_bedrock_agentcore._resources.amazon_bedrock_agent_core.registry_record_resource import RegistryRecordResource
if TYPE_CHECKING:
...
class BedrockAgentCoreClient:
    ...
    def operation_options(self, config_overrides: Optional[BedrockAgentCoreClientConfig] = None) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
    ...
    def complete_resource_token_auth(self, user_identifier: "aws_sdk_bedrock_agentcore.types.user_identifier.UserIdentifier", session_uri: "aws_sdk_bedrock_agentcore.types.request_uri.RequestUri", *, config_overrides: Optional[BedrockAgentCoreClientConfig] = None) -> "aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_response.CompleteResourceTokenAuthResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request.CompleteResourceTokenAuthRequest]') -> OperationResponse["aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_response.CompleteResourceTokenAuthResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.complete_resource_token_auth
            output, http_response = aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.complete_resource_token_auth.complete_resource_token_auth(req.options, req.input)
    ...
    def get_resource_api_key(self, workload_identity_token: "aws_sdk_bedrock_agentcore.types.workload_identity_token_type.WorkloadIdentityTokenType", resource_credential_provider_name: "aws_sdk_bedrock_agentcore.types.credential_provider_name.CredentialProviderName", *, config_overrides: Optional[BedrockAgentCoreClientConfig] = None) -> "aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agentcore.types.get_resource_api_key_request.GetResourceApiKeyRequest]') -> OperationResponse["aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_api_key
            output, http_response = aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_api_key.get_resource_api_key(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_oauth2_token(self, workload_identity_token: "aws_sdk_bedrock_agentcore.types.workload_identity_token_type.WorkloadIdentityTokenType", resource_credential_provider_name: "aws_sdk_bedrock_agentcore.types.credential_provider_name.CredentialProviderName", scopes: "aws_sdk_bedrock_agentcore.types.scopes_list_type.ScopesListType", oauth2_flow: "aws_sdk_bedrock_agentcore.types.oauth2_flow_type.Oauth2FlowType", *, config_overrides: Optional[BedrockAgentCoreClientConfig] = None, session_uri: Optional["aws_sdk_bedrock_agentcore.types.request_uri.RequestUri"] = None, resource_oauth2_return_url: Optional["aws_sdk_bedrock_agentcore.types.resource_oauth2_return_url_type.ResourceOauth2ReturnUrlType"] = None, force_authentication: Optional[bool] = None, custom_parameters: Optional["aws_sdk_bedrock_agentcore.types.custom_request_parameters_type.CustomRequestParametersType"] = None, custom_state: Optional["aws_sdk_bedrock_agentcore.types.state.State"] = None, resources: Optional["aws_sdk_bedrock_agentcore.types.resources_list_type.ResourcesListType"] = None, audiences: Optional["aws_sdk_bedrock_agentcore.types.audiences_list_type.AudiencesListType"] = None) -> "aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_response.GetResourceOauth2TokenResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_request.GetResourceOauth2TokenRequest]') -> OperationResponse["aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_response.GetResourceOauth2TokenResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_oauth2_token
            output, http_response = aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_oauth2_token.get_resource_oauth2_token(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_payment_token(self, workload_identity_token: "aws_sdk_bedrock_agentcore.types.workload_identity_token_type.WorkloadIdentityTokenType", resource_credential_provider_name: "aws_sdk_bedrock_agentcore.types.credential_provider_name.CredentialProviderName", payment_token_request: "aws_sdk_bedrock_agentcore.types.payment_token_request_input.PaymentTokenRequestInput", *, config_overrides: Optional[BedrockAgentCoreClientConfig] = None) -> "aws_sdk_bedrock_agentcore.types.get_resource_payment_token_response.GetResourcePaymentTokenResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agentcore.types.get_resource_payment_token_request.GetResourcePaymentTokenRequest]') -> OperationResponse["aws_sdk_bedrock_agentcore.types.get_resource_payment_token_response.GetResourcePaymentTokenResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_payment_token
            output, http_response = aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_payment_token.get_resource_payment_token(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input_, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_workload_access_token(self, workload_name: "aws_sdk_bedrock_agentcore.types.workload_identity_name_type.WorkloadIdentityNameType", *, config_overrides: Optional[BedrockAgentCoreClientConfig] = None) -> "aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.GetWorkloadAccessTokenResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agentcore.types.get_workload_access_token_request.GetWorkloadAccessTokenRequest]') -> OperationResponse["aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.GetWorkloadAccessTokenResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token
            output, http_response = aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token.get_workload_access_token(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input_, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_workload_access_token_for_jwt(self, workload_name: "aws_sdk_bedrock_agentcore.types.workload_identity_name_type.WorkloadIdentityNameType", user_token: "aws_sdk_bedrock_agentcore.types.user_token_type.UserTokenType", *, config_overrides: Optional[BedrockAgentCoreClientConfig] = None) -> "aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.GetWorkloadAccessTokenForJWTResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request.GetWorkloadAccessTokenForJWTRequest]') -> OperationResponse["aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.GetWorkloadAccessTokenForJWTResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token_for_jwt
            output, http_response = aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token_for_jwt.get_workload_access_token_for_jwt(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input_, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_workload_access_token_for_user_id(self, workload_name: "aws_sdk_bedrock_agentcore.types.workload_identity_name_type.WorkloadIdentityNameType", user_id: "aws_sdk_bedrock_agentcore.types.user_id_type.UserIdType", *, config_overrides: Optional[BedrockAgentCoreClientConfig] = None) -> "aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.GetWorkloadAccessTokenForUserIdResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_request.GetWorkloadAccessTokenForUserIdRequest]') -> OperationResponse["aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.GetWorkloadAccessTokenForUserIdResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token_for_user_id
            output, http_response = aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token_for_user_id.get_workload_access_token_for_user_id(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def invoke_code_interpreter(self, code_interpreter_identifier: str, name: "aws_sdk_bedrock_agentcore.types.tool_name.ToolName", *, config_overrides: Optional[BedrockAgentCoreClientConfig] = None, session_id: Optional["aws_sdk_bedrock_agentcore.types.code_interpreter_session_id.CodeInterpreterSessionId"] = None, trace_id: Optional[str] = None, trace_parent: Optional[str] = None, arguments: Optional["aws_sdk_bedrock_agentcore.types.tool_arguments.ToolArguments"] = None) -> "aws_sdk_bedrock_agentcore.types.invoke_code_interpreter_response.InvokeCodeInterpreterResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agentcore.types.invoke_code_interpreter_request.InvokeCodeInterpreterRequest]') -> OperationResponse["aws_sdk_bedrock_agentcore.types.invoke_code_interpreter_response.InvokeCodeInterpreterResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_code_interpreter
            output, http_response = aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_code_interpreter.invoke_code_interpreter(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def invoke_harness(self, harness_arn: "aws_sdk_bedrock_agentcore.types.harness_arn.HarnessArn", runtime_session_id: "aws_sdk_bedrock_agentcore.types.session_id.SessionId", messages: "aws_sdk_bedrock_agentcore.types.harness_messages.HarnessMessages", *, config_overrides: Optional[BedrockAgentCoreClientConfig] = None, runtime_user_id: Optional[str] = None, model: Optional["aws_sdk_bedrock_agentcore.types.harness_model_configuration.HarnessModelConfiguration"] = None, system_prompt: Optional["aws_sdk_bedrock_agentcore.types.harness_system_prompt.HarnessSystemPrompt"] = None, tools: Optional["aws_sdk_bedrock_agentcore.types.harness_tools.HarnessTools"] = None, skills: Optional["aws_sdk_bedrock_agentcore.types.harness_skills.HarnessSkills"] = None, allowed_tools: Optional["aws_sdk_bedrock_agentcore.types.harness_allowed_tools.HarnessAllowedTools"] = None, max_iterations: Optional[int] = None, max_tokens: Optional[int] = None, timeout_seconds: Optional[int] = None, actor_id: Optional[str] = None) -> "aws_sdk_bedrock_agentcore.types.invoke_harness_response.InvokeHarnessResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agentcore.types.invoke_harness_request.InvokeHarnessRequest]') -> OperationResponse["aws_sdk_bedrock_agentcore.types.invoke_harness_response.InvokeHarnessResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_harness
            output, http_response = aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_harness.invoke_harness(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
