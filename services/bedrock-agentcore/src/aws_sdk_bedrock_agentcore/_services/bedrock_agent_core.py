...
from aws_sdk_bedrock_agentcore._services._aws_config import aws_config
...
class BedrockAgentCoreClient:
    ...
    def complete_resource_token_auth(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request.CompleteResourceTokenAuthRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_response.CompleteResourceTokenAuthResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.complete_resource_token_auth.complete_resource_token_auth(
    ...
    def get_resource_api_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.get_resource_api_key_request.GetResourceApiKeyRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_api_key.get_resource_api_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_oauth2_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_request.GetResourceOauth2TokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_response.GetResourceOauth2TokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_oauth2_token.get_resource_oauth2_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_payment_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.get_resource_payment_token_request.GetResourcePaymentTokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_resource_payment_token_response.GetResourcePaymentTokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_payment_token.get_resource_payment_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_workload_access_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.get_workload_access_token_request.GetWorkloadAccessTokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.GetWorkloadAccessTokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token.get_workload_access_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_workload_access_token_for_jwt(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request.GetWorkloadAccessTokenForJWTRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.GetWorkloadAccessTokenForJWTResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token_for_jwt.get_workload_access_token_for_jwt(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_workload_access_token_for_user_id(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_request.GetWorkloadAccessTokenForUserIdRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.GetWorkloadAccessTokenForUserIdResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token_for_user_id.get_workload_access_token_for_user_id(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def invoke_code_interpreter(
        ...
        *,
    ...
    ) -> "Generator[aws_sdk_bedrock_agentcore.types.invoke_code_interpreter_response.InvokeCodeInterpreterResponse]":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.invoke_code_interpreter_request.InvokeCodeInterpreterRequest]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_code_interpreter.invoke_code_interpreter(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def invoke_harness(
        ...
        *,
    ...
    ) -> "Generator[aws_sdk_bedrock_agentcore.types.invoke_harness_response.InvokeHarnessResponse]":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore.types.invoke_harness_request.InvokeHarnessRequest]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_harness.invoke_harness(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
