...
from aws_sdk_bedrock_agentcore._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_bedrock_agentcore._async import anysleep
import time
...
class AsyncBedrockAgentCoreClient:
    ...
    async def complete_resource_token_auth(self, user_identifier: "aws_sdk_bedrock_agentcore.types.user_identifier.UserIdentifier", session_uri: "aws_sdk_bedrock_agentcore.types.request_uri.RequestUri", *, config_overrides: Optional[AsyncBedrockAgentCoreClientConfig] = None) -> "aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_response.CompleteResourceTokenAuthResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_request.CompleteResourceTokenAuthRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agentcore.types.complete_resource_token_auth_response.CompleteResourceTokenAuthResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.complete_resource_token_auth
            output, http_response = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.complete_resource_token_auth.async_complete_resource_token_auth(req.options, req.input)
    ...
    async def get_resource_api_key(self, workload_identity_token: "aws_sdk_bedrock_agentcore.types.workload_identity_token_type.WorkloadIdentityTokenType", resource_credential_provider_name: "aws_sdk_bedrock_agentcore.types.credential_provider_name.CredentialProviderName", *, config_overrides: Optional[AsyncBedrockAgentCoreClientConfig] = None) -> "aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.get_resource_api_key_request.GetResourceApiKeyRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_api_key
            output, http_response = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_api_key.async_get_resource_api_key(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_oauth2_token(self, workload_identity_token: "aws_sdk_bedrock_agentcore.types.workload_identity_token_type.WorkloadIdentityTokenType", resource_credential_provider_name: "aws_sdk_bedrock_agentcore.types.credential_provider_name.CredentialProviderName", scopes: "aws_sdk_bedrock_agentcore.types.scopes_list_type.ScopesListType", oauth2_flow: "aws_sdk_bedrock_agentcore.types.oauth2_flow_type.Oauth2FlowType", *, config_overrides: Optional[AsyncBedrockAgentCoreClientConfig] = None, session_uri: Optional["aws_sdk_bedrock_agentcore.types.request_uri.RequestUri"] = None, resource_oauth2_return_url: Optional["aws_sdk_bedrock_agentcore.types.resource_oauth2_return_url_type.ResourceOauth2ReturnUrlType"] = None, force_authentication: Optional[bool] = None, custom_parameters: Optional["aws_sdk_bedrock_agentcore.types.custom_request_parameters_type.CustomRequestParametersType"] = None, custom_state: Optional["aws_sdk_bedrock_agentcore.types.state.State"] = None, resources: Optional["aws_sdk_bedrock_agentcore.types.resources_list_type.ResourcesListType"] = None, audiences: Optional["aws_sdk_bedrock_agentcore.types.audiences_list_type.AudiencesListType"] = None) -> "aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_response.GetResourceOauth2TokenResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_request.GetResourceOauth2TokenRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agentcore.types.get_resource_oauth2_token_response.GetResourceOauth2TokenResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_oauth2_token
            output, http_response = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_oauth2_token.async_get_resource_oauth2_token(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_payment_token(self, workload_identity_token: "aws_sdk_bedrock_agentcore.types.workload_identity_token_type.WorkloadIdentityTokenType", resource_credential_provider_name: "aws_sdk_bedrock_agentcore.types.credential_provider_name.CredentialProviderName", payment_token_request: "aws_sdk_bedrock_agentcore.types.payment_token_request_input.PaymentTokenRequestInput", *, config_overrides: Optional[AsyncBedrockAgentCoreClientConfig] = None) -> "aws_sdk_bedrock_agentcore.types.get_resource_payment_token_response.GetResourcePaymentTokenResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.get_resource_payment_token_request.GetResourcePaymentTokenRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agentcore.types.get_resource_payment_token_response.GetResourcePaymentTokenResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_payment_token
            output, http_response = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_payment_token.async_get_resource_payment_token(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_workload_access_token(self, workload_name: "aws_sdk_bedrock_agentcore.types.workload_identity_name_type.WorkloadIdentityNameType", *, config_overrides: Optional[AsyncBedrockAgentCoreClientConfig] = None) -> "aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.GetWorkloadAccessTokenResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.get_workload_access_token_request.GetWorkloadAccessTokenRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agentcore.types.get_workload_access_token_response.GetWorkloadAccessTokenResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token
            output, http_response = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token.async_get_workload_access_token(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_workload_access_token_for_jwt(self, workload_name: "aws_sdk_bedrock_agentcore.types.workload_identity_name_type.WorkloadIdentityNameType", user_token: "aws_sdk_bedrock_agentcore.types.user_token_type.UserTokenType", *, config_overrides: Optional[AsyncBedrockAgentCoreClientConfig] = None) -> "aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.GetWorkloadAccessTokenForJWTResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_request.GetWorkloadAccessTokenForJWTRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.GetWorkloadAccessTokenForJWTResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token_for_jwt
            output, http_response = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token_for_jwt.async_get_workload_access_token_for_jwt(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_workload_access_token_for_user_id(self, workload_name: "aws_sdk_bedrock_agentcore.types.workload_identity_name_type.WorkloadIdentityNameType", user_id: "aws_sdk_bedrock_agentcore.types.user_id_type.UserIdType", *, config_overrides: Optional[AsyncBedrockAgentCoreClientConfig] = None) -> "aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.GetWorkloadAccessTokenForUserIdResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_request.GetWorkloadAccessTokenForUserIdRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.GetWorkloadAccessTokenForUserIdResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token_for_user_id
            output, http_response = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token_for_user_id.async_get_workload_access_token_for_user_id(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def invoke_code_interpreter(self, code_interpreter_identifier: str, name: "aws_sdk_bedrock_agentcore.types.tool_name.ToolName", *, config_overrides: Optional[AsyncBedrockAgentCoreClientConfig] = None, session_id: Optional["aws_sdk_bedrock_agentcore.types.code_interpreter_session_id.CodeInterpreterSessionId"] = None, trace_id: Optional[str] = None, trace_parent: Optional[str] = None, arguments: Optional["aws_sdk_bedrock_agentcore.types.tool_arguments.ToolArguments"] = None) -> "aws_sdk_bedrock_agentcore.types.invoke_code_interpreter_response.InvokeCodeInterpreterResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.invoke_code_interpreter_request.InvokeCodeInterpreterRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agentcore.types.invoke_code_interpreter_response.InvokeCodeInterpreterResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_code_interpreter
            output, http_response = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_code_interpreter.async_invoke_code_interpreter(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def invoke_harness(self, harness_arn: "aws_sdk_bedrock_agentcore.types.harness_arn.HarnessArn", runtime_session_id: "aws_sdk_bedrock_agentcore.types.session_id.SessionId", messages: "aws_sdk_bedrock_agentcore.types.harness_messages.HarnessMessages", *, config_overrides: Optional[AsyncBedrockAgentCoreClientConfig] = None, runtime_user_id: Optional[str] = None, model: Optional["aws_sdk_bedrock_agentcore.types.harness_model_configuration.HarnessModelConfiguration"] = None, system_prompt: Optional["aws_sdk_bedrock_agentcore.types.harness_system_prompt.HarnessSystemPrompt"] = None, tools: Optional["aws_sdk_bedrock_agentcore.types.harness_tools.HarnessTools"] = None, skills: Optional["aws_sdk_bedrock_agentcore.types.harness_skills.HarnessSkills"] = None, allowed_tools: Optional["aws_sdk_bedrock_agentcore.types.harness_allowed_tools.HarnessAllowedTools"] = None, max_iterations: Optional[int] = None, max_tokens: Optional[int] = None, timeout_seconds: Optional[int] = None, actor_id: Optional[str] = None) -> "aws_sdk_bedrock_agentcore.types.invoke_harness_response.InvokeHarnessResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agentcore.types.invoke_harness_request.InvokeHarnessRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agentcore.types.invoke_harness_response.InvokeHarnessResponse"]:
            import aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_harness
            output, http_response = await aws_sdk_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_harness.async_invoke_harness(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
