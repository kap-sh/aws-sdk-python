...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agentcore.types.embedded_crypto_wallet


class _PaymentInstrumentDetails_embeddedCryptoWallet(TypedDict):
    embeddedCryptoWallet: (
        "aws_sdk_bedrock_agentcore.types.embedded_crypto_wallet.EmbeddedCryptoWallet"
    )
...
def serialize_json(value: PaymentInstrumentDetails) -> dict:
    if "embeddedCryptoWallet" in value:
        ...
        return {
            "embeddedCryptoWallet": aws_sdk_bedrock_agentcore.types.embedded_crypto_wallet.serialize_json(
...
def deserialize_json(data: dict) -> PaymentInstrumentDetails:
    if "embeddedCryptoWallet" in data:
        ...
        return {
            "embeddedCryptoWallet": aws_sdk_bedrock_agentcore.types.embedded_crypto_wallet.deserialize_json(
