...
class SessionLimits(TypedDict, closed=True):
    max_spend_amount: "aws_sdk_bedrock_agentcore.types.amount.Amount"
...
def serialize_json(value: SessionLimits) -> dict:
    ...
    out["maxSpendAmount"] = aws_sdk_bedrock_agentcore.types.amount.serialize_json(
