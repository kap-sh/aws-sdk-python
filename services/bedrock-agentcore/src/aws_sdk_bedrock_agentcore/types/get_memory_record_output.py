...
def serialize_json(value: GetMemoryRecordOutput) -> dict:
    out: dict = {}
    import aws_sdk_bedrock_agentcore.types.memory_record
    out["memoryRecord"] = aws_sdk_bedrock_agentcore.types.memory_record.serialize_json(value["memory_record"])
    return out
...
def deserialize_json(data: dict) -> GetMemoryRecordOutput:
    ...
    if "memoryRecord" in data:
        import aws_sdk_bedrock_agentcore.types.memory_record
        out["memory_record"] = aws_sdk_bedrock_agentcore.types.memory_record.deserialize_json(data["memoryRecord"])
    else:
