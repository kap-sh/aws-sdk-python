...
def serialize_json(value: BatchUpdateMemoryRecordsInput) -> dict:
    out: dict = {}
    import aws_sdk_bedrock_agentcore.types.memory_records_update_input_list
    out["records"] = aws_sdk_bedrock_agentcore.types.memory_records_update_input_list.serialize_json(value["records"])
    return out
...
def deserialize_json(data: dict) -> BatchUpdateMemoryRecordsInput:
    ...
    if "records" in data:
        import aws_sdk_bedrock_agentcore.types.memory_records_update_input_list
        out["records"] = aws_sdk_bedrock_agentcore.types.memory_records_update_input_list.deserialize_json(data["records"])
    else:
