...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agentcore.types.tool_description_config


class ToolDescriptionInput(TypedDict):
    tool_name: "aws_sdk_bedrock_agentcore.types.recommendation_tool_name.RecommendationToolName"
    """<p>The name of the tool.</p>"""
    tool_description: (
        "aws_sdk_bedrock_agentcore.types.tool_description_config.ToolDescriptionConfig"
    )
...
def serialize_json(value: ToolDescriptionInput) -> dict:
    ...
    out["toolDescription"] = (
        aws_sdk_bedrock_agentcore.types.tool_description_config.serialize_json(
...
def deserialize_json(data: dict) -> ToolDescriptionInput:
    ...
    if "toolDescription" in data:
        ...
        out["tool_description"] = (
            aws_sdk_bedrock_agentcore.types.tool_description_config.deserialize_json(
