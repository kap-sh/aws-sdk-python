"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#AgentCardDefinition``."""
...
class AgentCardDefinition(TypedDict):
    schema_version: NotRequired["aws_sdk_bedrock_agentcore.types.schema_version.SchemaVersion"]
