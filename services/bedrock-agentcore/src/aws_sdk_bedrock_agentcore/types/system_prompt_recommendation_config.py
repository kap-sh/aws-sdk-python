...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agentcore.types.recommendation_evaluation_config
    import aws_sdk_bedrock_agentcore.types.system_prompt_config


class SystemPromptRecommendationConfig(TypedDict):
    system_prompt: (
        "aws_sdk_bedrock_agentcore.types.system_prompt_config.SystemPromptConfig"
    )
    ...
    evaluation_config: "aws_sdk_bedrock_agentcore.types.recommendation_evaluation_config.RecommendationEvaluationConfig"
...
def serialize_json(value: SystemPromptRecommendationConfig) -> dict:
    ...
    out["systemPrompt"] = (
        aws_sdk_bedrock_agentcore.types.system_prompt_config.serialize_json(
            value["system_prompt"]
        )
    )
    import aws_sdk_bedrock_agentcore.types.agent_traces_config
    ...
    out["evaluationConfig"] = (
        aws_sdk_bedrock_agentcore.types.recommendation_evaluation_config.serialize_json(
...
def deserialize_json(data: dict) -> SystemPromptRecommendationConfig:
    ...
    if "systemPrompt" in data:
        ...
        out["system_prompt"] = (
            aws_sdk_bedrock_agentcore.types.system_prompt_config.deserialize_json(
                data["systemPrompt"]
            )
        )
    else:
    ...
    if "evaluationConfig" in data:
        ...
        out["evaluation_config"] = (
            aws_sdk_bedrock_agentcore.types.recommendation_evaluation_config.deserialize_json(
