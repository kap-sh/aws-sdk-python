...
class BrowserEnterprisePolicy(TypedDict):
    ...
    type: NotRequired[
        "aws_sdk_bedrock_agentcore.types.browser_enterprise_policy_type.BrowserEnterprisePolicyType"
    ]
...
def serialize_json(value: BrowserEnterprisePolicy) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = (
            aws_sdk_bedrock_agentcore.types.browser_enterprise_policy_type.serialize_json(
                value["type"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> BrowserEnterprisePolicy:
    ...
    if "type" in data:
        ...
        out["type"] = (
            aws_sdk_bedrock_agentcore.types.browser_enterprise_policy_type.deserialize_json(
                data["type"]
            )
        )
    return out
