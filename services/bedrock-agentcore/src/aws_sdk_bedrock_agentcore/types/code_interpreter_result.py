...
class CodeInterpreterResult(TypedDict):
    ...
    structured_content: NotRequired[
        "aws_sdk_bedrock_agentcore.types.tool_result_structured_content.ToolResultStructuredContent"
    ]
...
def serialize_json(value: CodeInterpreterResult) -> dict:
    ...
    out["content"] = aws_sdk_bedrock_agentcore.types.content_block_list.serialize_json(
        value["content"]
    )
    if "structured_content" in value:
        ...
        out["structuredContent"] = (
            aws_sdk_bedrock_agentcore.types.tool_result_structured_content.serialize_json(
...
def deserialize_json(data: dict) -> CodeInterpreterResult:
    ...
    if "content" in data:
        ...
        out["content"] = (
            aws_sdk_bedrock_agentcore.types.content_block_list.deserialize_json(
                data["content"]
            )
        )
    else:
    ...
    if "structuredContent" in data:
        ...
        out["structured_content"] = (
            aws_sdk_bedrock_agentcore.types.tool_result_structured_content.deserialize_json(
