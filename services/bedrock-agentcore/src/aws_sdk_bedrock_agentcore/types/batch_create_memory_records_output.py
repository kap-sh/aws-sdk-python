...
class BatchCreateMemoryRecordsOutput(TypedDict):
...
def deserialize_json(data: dict) -> BatchCreateMemoryRecordsOutput:
    ...
    if "successfulRecords" in data:
        ...
        raise DeserializationError("BatchCreateMemoryRecordsOutput.successful_records required")
    if "failedRecords" in data:
        ...
        raise DeserializationError("BatchCreateMemoryRecordsOutput.failed_records required")
    return out