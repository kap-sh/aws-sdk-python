...
class AvailableLimits(TypedDict):
    ...
    updated_at: NotRequired["aws_sdk_bedrock_agentcore.types.date_timestamp.DateTimestamp"]
...
def serialize_json(value: AvailableLimits) -> dict:
    ...
    if "available_spend_amount" in value:
        import aws_sdk_bedrock_agentcore.types.amount
        out["availableSpendAmount"] = aws_sdk_bedrock_agentcore.types.amount.serialize_json(value["available_spend_amount"])
    if "updated_at" in value:
        import aws_sdk_bedrock_agentcore.types.date_timestamp
        out["updatedAt"] = aws_sdk_bedrock_agentcore.types.date_timestamp.serialize_json(value["updated_at"])
    return out
...
def deserialize_json(data: dict) -> AvailableLimits:
    ...
    if "availableSpendAmount" in data:
        import aws_sdk_bedrock_agentcore.types.amount
        out["available_spend_amount"] = aws_sdk_bedrock_agentcore.types.amount.deserialize_json(data["availableSpendAmount"])
    if "updatedAt" in data:
        import aws_sdk_bedrock_agentcore.types.date_timestamp
        out["updated_at"] = aws_sdk_bedrock_agentcore.types.date_timestamp.deserialize_json(data["updatedAt"])
    return out