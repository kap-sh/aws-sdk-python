...
class CloudWatchLogsTraceConfig(TypedDict):
    ...
    rule: NotRequired[
        "aws_sdk_bedrock_agentcore.types.cloud_watch_logs_rule.CloudWatchLogsRule"
    ]
...
def serialize_json(value: CloudWatchLogsTraceConfig) -> dict:
    ...
    out["logGroupArns"] = (
        aws_sdk_bedrock_agentcore.types.log_group_arn_list.serialize_json(
    ...
    out["serviceNames"] = (
        aws_sdk_bedrock_agentcore.types.service_name_list.serialize_json(
            value["service_names"]
        )
    )
    ...
    out["endTime"] = aws_sdk_bedrock_agentcore.types._prelude.timestamp.serialize_json(
        value["end_time"]
    )
    if "rule" in value:
        import aws_sdk_bedrock_agentcore.types.cloud_watch_logs_rule
        ...
        out["rule"] = (
            aws_sdk_bedrock_agentcore.types.cloud_watch_logs_rule.serialize_json(
                value["rule"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> CloudWatchLogsTraceConfig:
    ...
    if "logGroupArns" in data:
        ...
        out["log_group_arns"] = (
            aws_sdk_bedrock_agentcore.types.log_group_arn_list.deserialize_json(
                data["logGroupArns"]
            )
        )
    else:
    ...
    if "serviceNames" in data:
        ...
        out["service_names"] = (
            aws_sdk_bedrock_agentcore.types.service_name_list.deserialize_json(
                data["serviceNames"]
            )
        )
    else:
    ...
    if "rule" in data:
        ...
        out["rule"] = (
            aws_sdk_bedrock_agentcore.types.cloud_watch_logs_rule.deserialize_json(
                data["rule"]
            )
        )
    return out
