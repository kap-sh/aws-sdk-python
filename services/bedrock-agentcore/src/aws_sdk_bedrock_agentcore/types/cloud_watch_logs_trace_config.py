...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agentcore.types.cloud_watch_logs_rule
    import aws_sdk_bedrock_agentcore.types.log_group_arn_list
...
class CloudWatchLogsTraceConfig(TypedDict):
    ...
    rule: NotRequired["aws_sdk_bedrock_agentcore.types.cloud_watch_logs_rule.CloudWatchLogsRule"]
...
def serialize_json(value: CloudWatchLogsTraceConfig) -> dict:
    out: dict = {}
    import aws_sdk_bedrock_agentcore.types.log_group_arn_list
    out["logGroupArns"] = aws_sdk_bedrock_agentcore.types.log_group_arn_list.serialize_json(value["log_group_arns"])
    import aws_sdk_bedrock_agentcore.types.service_name_list
    out["serviceNames"] = aws_sdk_bedrock_agentcore.types.service_name_list.serialize_json(value["service_names"])
    import aws_sdk_bedrock_agentcore.types._prelude.timestamp
    out["startTime"] = aws_sdk_bedrock_agentcore.types._prelude.timestamp.serialize_json(value["start_time"])
    import aws_sdk_bedrock_agentcore.types._prelude.timestamp
    out["endTime"] = aws_sdk_bedrock_agentcore.types._prelude.timestamp.serialize_json(value["end_time"])
    if "rule" in value:
        import aws_sdk_bedrock_agentcore.types.cloud_watch_logs_rule
        out["rule"] = aws_sdk_bedrock_agentcore.types.cloud_watch_logs_rule.serialize_json(value["rule"])
    return out
...
def deserialize_json(data: dict) -> CloudWatchLogsTraceConfig:
    ...
    if "logGroupArns" in data:
        import aws_sdk_bedrock_agentcore.types.log_group_arn_list
        out["log_group_arns"] = aws_sdk_bedrock_agentcore.types.log_group_arn_list.deserialize_json(data["logGroupArns"])
    else:
        raise DeserializationError("CloudWatchLogsTraceConfig.log_group_arns required")
    if "serviceNames" in data:
        import aws_sdk_bedrock_agentcore.types.service_name_list
        out["service_names"] = aws_sdk_bedrock_agentcore.types.service_name_list.deserialize_json(data["serviceNames"])
    else:
        raise DeserializationError("CloudWatchLogsTraceConfig.service_names required")
    if "startTime" in data:
        import aws_sdk_bedrock_agentcore.types._prelude.timestamp
        out["start_time"] = aws_sdk_bedrock_agentcore.types._prelude.timestamp.deserialize_json(data["startTime"])
    else:
        raise DeserializationError("CloudWatchLogsTraceConfig.start_time required")
    if "endTime" in data:
        import aws_sdk_bedrock_agentcore.types._prelude.timestamp
        out["end_time"] = aws_sdk_bedrock_agentcore.types._prelude.timestamp.deserialize_json(data["endTime"])
    else:
        raise DeserializationError("CloudWatchLogsTraceConfig.end_time required")
    if "rule" in data:
        import aws_sdk_bedrock_agentcore.types.cloud_watch_logs_rule
        out["rule"] = aws_sdk_bedrock_agentcore.types.cloud_watch_logs_rule.deserialize_json(data["rule"])
    return out