...
class BrowserSessionStream(TypedDict):
    automation_stream: "aws_sdk_bedrock_agentcore.types.automation_stream.AutomationStream"
    ...
    live_view_stream: NotRequired["aws_sdk_bedrock_agentcore.types.live_view_stream.LiveViewStream"]
...
def serialize_json(value: BrowserSessionStream) -> dict:
    out: dict = {}
    import aws_sdk_bedrock_agentcore.types.automation_stream
    out["automationStream"] = aws_sdk_bedrock_agentcore.types.automation_stream.serialize_json(value["automation_stream"])
    if "live_view_stream" in value:
        import aws_sdk_bedrock_agentcore.types.live_view_stream
        out["liveViewStream"] = aws_sdk_bedrock_agentcore.types.live_view_stream.serialize_json(value["live_view_stream"])
    return out
...
def deserialize_json(data: dict) -> BrowserSessionStream:
    ...
    if "automationStream" in data:
        import aws_sdk_bedrock_agentcore.types.automation_stream
        out["automation_stream"] = aws_sdk_bedrock_agentcore.types.automation_stream.deserialize_json(data["automationStream"])
    else:
        raise DeserializationError("BrowserSessionStream.automation_stream required")
    if "liveViewStream" in data:
        import aws_sdk_bedrock_agentcore.types.live_view_stream
        out["live_view_stream"] = aws_sdk_bedrock_agentcore.types.live_view_stream.deserialize_json(data["liveViewStream"])
    return out