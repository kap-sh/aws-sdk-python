...
AgentTracesConfig: TypeAlias = _AgentTracesConfig_sessionSpans | _AgentTracesConfig_cloudwatchLogs
...
def serialize_json(value: AgentTracesConfig) -> dict:
    if "sessionSpans" in value:
        ...
        import aws_sdk_bedrock_agentcore.types.cloud_watch_logs_trace_config
        return {"cloudwatchLogs": aws_sdk_bedrock_agentcore.types.cloud_watch_logs_trace_config.serialize_json(value["cloudwatchLogs"])}
    else:
...
def deserialize_json(data: dict) -> AgentTracesConfig:
    if "sessionSpans" in data:
        ...
        import aws_sdk_bedrock_agentcore.types.cloud_watch_logs_trace_config
        return {"cloudwatchLogs": aws_sdk_bedrock_agentcore.types.cloud_watch_logs_trace_config.deserialize_json(data["cloudwatchLogs"])}
    else:
