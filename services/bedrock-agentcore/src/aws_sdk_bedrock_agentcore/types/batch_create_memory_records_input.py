...
def serialize_json(value: BatchCreateMemoryRecordsInput) -> dict:
    out: dict = {}
    import aws_sdk_bedrock_agentcore.types.memory_records_create_input_list
    out["records"] = aws_sdk_bedrock_agentcore.types.memory_records_create_input_list.serialize_json(value["records"])
...
def deserialize_json(data: dict) -> BatchCreateMemoryRecordsInput:
    ...
    if "records" in data:
        import aws_sdk_bedrock_agentcore.types.memory_records_create_input_list
        out["records"] = aws_sdk_bedrock_agentcore.types.memory_records_create_input_list.deserialize_json(data["records"])
    else:
