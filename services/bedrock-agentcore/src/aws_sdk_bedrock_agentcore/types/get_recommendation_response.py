...
class GetRecommendationResponse(TypedDict):
    ...
    recommendation_arn: "aws_sdk_bedrock_agentcore.types.recommendation_arn.RecommendationArn"
    ...
    description: NotRequired["aws_sdk_bedrock_agentcore.types.recommendation_description.RecommendationDescription"]
    ...
    recommendation_result: NotRequired["aws_sdk_bedrock_agentcore.types.recommendation_result.RecommendationResult"]
...
def serialize_json(value: GetRecommendationResponse) -> dict:
    ...
    import aws_sdk_bedrock_agentcore.types.recommendation_type
    out["type"] = aws_sdk_bedrock_agentcore.types.recommendation_type.serialize_json(value["type"])
    import aws_sdk_bedrock_agentcore.types.recommendation_config
    out["recommendationConfig"] = aws_sdk_bedrock_agentcore.types.recommendation_config.serialize_json(value["recommendation_config"])
    import aws_sdk_bedrock_agentcore.types.recommendation_status
    ...
    if "recommendation_result" in value:
        import aws_sdk_bedrock_agentcore.types.recommendation_result
        out["recommendationResult"] = aws_sdk_bedrock_agentcore.types.recommendation_result.serialize_json(value["recommendation_result"])
    return out
...
def deserialize_json(data: dict) -> GetRecommendationResponse:
    ...
    if "recommendationId" in data:
        ...
        raise DeserializationError("GetRecommendationResponse.recommendation_id required")
    if "recommendationArn" in data:
        out["recommendation_arn"] = data["recommendationArn"]
    else:
        raise DeserializationError("GetRecommendationResponse.recommendation_arn required")
    if "name" in data:
        out["name"] = data["name"]
    else:
    ...
    if "type" in data:
        import aws_sdk_bedrock_agentcore.types.recommendation_type
        out["type"] = aws_sdk_bedrock_agentcore.types.recommendation_type.deserialize_json(data["type"])
    else:
        raise DeserializationError("GetRecommendationResponse.type required")
    if "recommendationConfig" in data:
        import aws_sdk_bedrock_agentcore.types.recommendation_config
        out["recommendation_config"] = aws_sdk_bedrock_agentcore.types.recommendation_config.deserialize_json(data["recommendationConfig"])
    else:
        raise DeserializationError("GetRecommendationResponse.recommendation_config required")
    if "status" in data:
        import aws_sdk_bedrock_agentcore.types.recommendation_status
    ...
    if "recommendationResult" in data:
        import aws_sdk_bedrock_agentcore.types.recommendation_result
        out["recommendation_result"] = aws_sdk_bedrock_agentcore.types.recommendation_result.deserialize_json(data["recommendationResult"])
    return out