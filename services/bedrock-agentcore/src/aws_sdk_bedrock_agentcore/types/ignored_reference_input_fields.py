...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agentcore.types.ignored_reference_input_field

IgnoredReferenceInputFields: TypeAlias = list[
    "aws_sdk_bedrock_agentcore.types.ignored_reference_input_field.IgnoredReferenceInputField"
]
