...
class StartCodeInterpreterSessionRequest(TypedDict):
    ...
    session_timeout_seconds: "aws_sdk_bedrock_agentcore.types.code_interpreter_session_timeout.CodeInterpreterSessionTimeout"
