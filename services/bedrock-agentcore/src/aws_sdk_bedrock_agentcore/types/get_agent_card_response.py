...
class GetAgentCardResponse(TypedDict):
    runtime_session_id: NotRequired["aws_sdk_bedrock_agentcore.types.session_id.SessionId"]
    ...
    status_code: NotRequired["aws_sdk_bedrock_agentcore.types.http_response_code.HttpResponseCode"]
