...
class GroundTruthTurn(TypedDict):
    input: NotRequired["aws_sdk_bedrock_agentcore.types.ground_truth_turn_input.GroundTruthTurnInput"]
...
def serialize_json(value: GroundTruthTurn) -> dict:
    ...
    if "input" in value:
        import aws_sdk_bedrock_agentcore.types.ground_truth_turn_input
        out["input"] = aws_sdk_bedrock_agentcore.types.ground_truth_turn_input.serialize_json(value["input"])
...
def deserialize_json(data: dict) -> GroundTruthTurn:
    ...
    if "input" in data:
        import aws_sdk_bedrock_agentcore.types.ground_truth_turn_input
        out["input"] = aws_sdk_bedrock_agentcore.types.ground_truth_turn_input.deserialize_json(data["input"])
