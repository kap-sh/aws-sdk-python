...
class ContentBlock(TypedDict):
    ...
    resource: NotRequired["aws_sdk_bedrock_agentcore.types.resource_content.ResourceContent"]
...
def serialize_json(value: ContentBlock) -> dict:
    out: dict = {}
    import aws_sdk_bedrock_agentcore.types.content_block_type
    out["type"] = aws_sdk_bedrock_agentcore.types.content_block_type.serialize_json(value["type"])
    if "text" in value:
        out["text"] = value["text"]
    if "data" in value:
        import aws_sdk_bedrock_agentcore.types._prelude.blob
        out["data"] = aws_sdk_bedrock_agentcore.types._prelude.blob.serialize_json(value["data"])
    ...
    if "resource" in value:
        import aws_sdk_bedrock_agentcore.types.resource_content
        out["resource"] = aws_sdk_bedrock_agentcore.types.resource_content.serialize_json(value["resource"])
    return out
...
def deserialize_json(data: dict) -> ContentBlock:
    ...
    if "type" in data:
        import aws_sdk_bedrock_agentcore.types.content_block_type
        out["type"] = aws_sdk_bedrock_agentcore.types.content_block_type.deserialize_json(data["type"])
    else:
    ...
    if "data" in data:
        import aws_sdk_bedrock_agentcore.types._prelude.blob
        out["data"] = aws_sdk_bedrock_agentcore.types._prelude.blob.deserialize_json(data["data"])
    if "mimeType" in data:
    ...
    if "resource" in data:
        import aws_sdk_bedrock_agentcore.types.resource_content
        out["resource"] = aws_sdk_bedrock_agentcore.types.resource_content.deserialize_json(data["resource"])
    return out