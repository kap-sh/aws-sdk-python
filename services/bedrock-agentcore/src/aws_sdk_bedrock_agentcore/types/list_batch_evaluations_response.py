...
def serialize_json(value: ListBatchEvaluationsResponse) -> dict:
    ...
    out["batchEvaluations"] = (
        aws_sdk_bedrock_agentcore.types.batch_evaluation_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListBatchEvaluationsResponse:
    ...
    if "batchEvaluations" in data:
        import aws_sdk_bedrock_agentcore.types.batch_evaluation_summary_list

        out["batch_evaluations"] = (
            aws_sdk_bedrock_agentcore.types.batch_evaluation_summary_list.deserialize_json(
