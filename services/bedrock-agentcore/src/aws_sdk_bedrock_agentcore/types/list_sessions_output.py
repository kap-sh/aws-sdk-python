...
class ListSessionsOutput(TypedDict, closed=True):
    session_summaries: (
        "aws_sdk_bedrock_agentcore.types.session_summary_list.SessionSummaryList"
    )
...
def serialize_json(value: ListSessionsOutput) -> dict:
    ...
    out["sessionSummaries"] = (
        aws_sdk_bedrock_agentcore.types.session_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListSessionsOutput:
    ...
    if "sessionSummaries" in data:
        ...
        out["session_summaries"] = (
            aws_sdk_bedrock_agentcore.types.session_summary_list.deserialize_json(
