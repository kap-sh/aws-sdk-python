...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agentcore.types.ground_truth_source
...
class SessionMetadataShape(TypedDict, closed=True):
    ...
    ground_truth: NotRequired[
        "aws_sdk_bedrock_agentcore.types.ground_truth_source.GroundTruthSource"
    ]
    """<p>The ground truth data for this session, including expected responses and assertions.</p>"""
    metadata: NotRequired["aws_sdk_bedrock_agentcore.types.string_map.StringMap"]
...
def serialize_json(value: SessionMetadataShape) -> dict:
    ...
    if "ground_truth" in value:
        ...
        out["groundTruth"] = (
            aws_sdk_bedrock_agentcore.types.ground_truth_source.serialize_json(
                value["ground_truth"]
            )
        )
    if "metadata" in value:
        ...
        out["metadata"] = aws_sdk_bedrock_agentcore.types.string_map.serialize_json(
            value["metadata"]
        )
    return out
...
def deserialize_json(data: dict) -> SessionMetadataShape:
    ...
    if "groundTruth" in data:
        ...
        out["ground_truth"] = (
            aws_sdk_bedrock_agentcore.types.ground_truth_source.deserialize_json(
                data["groundTruth"]
            )
        )
    if "metadata" in data:
        ...
        out["metadata"] = aws_sdk_bedrock_agentcore.types.string_map.deserialize_json(
            data["metadata"]
        )
    return out
