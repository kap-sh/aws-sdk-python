...
class EvaluatorMetric(TypedDict):
    ...
    variant_results: (
        "aws_sdk_bedrock_agentcore.types.variant_result_list.VariantResultList"
    )
...
def serialize_json(value: EvaluatorMetric) -> dict:
    ...
    out["controlStats"] = aws_sdk_bedrock_agentcore.types.control_stats.serialize_json(
        value["control_stats"]
    )
    import aws_sdk_bedrock_agentcore.types.variant_result_list

    out["variantResults"] = (
        aws_sdk_bedrock_agentcore.types.variant_result_list.serialize_json(
...
def deserialize_json(data: dict) -> EvaluatorMetric:
    ...
    if "controlStats" in data:
        ...
        out["control_stats"] = (
            aws_sdk_bedrock_agentcore.types.control_stats.deserialize_json(
                data["controlStats"]
            )
        )
    else:
    ...
    if "variantResults" in data:
        ...
        out["variant_results"] = (
            aws_sdk_bedrock_agentcore.types.variant_result_list.deserialize_json(
                data["variantResults"]
            )
        )
    else:
