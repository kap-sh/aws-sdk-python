...
class _ABTestEvaluationConfig_onlineEvaluationConfigArn(TypedDict):
    onlineEvaluationConfigArn: "aws_sdk_bedrock_agentcore.types.online_evaluation_config_arn.OnlineEvaluationConfigArn"


class _ABTestEvaluationConfig_perVariantOnlineEvaluationConfig(TypedDict):
...
ABTestEvaluationConfig: TypeAlias = _ABTestEvaluationConfig_onlineEvaluationConfigArn | _ABTestEvaluationConfig_perVariantOnlineEvaluationConfig
...
def serialize_json(value: ABTestEvaluationConfig) -> dict:
    if "onlineEvaluationConfigArn" in value:
        ...
        import aws_sdk_bedrock_agentcore.types.per_variant_online_evaluation_config_list
        return {"perVariantOnlineEvaluationConfig": aws_sdk_bedrock_agentcore.types.per_variant_online_evaluation_config_list.serialize_json(value["perVariantOnlineEvaluationConfig"])}
    else:
...
def deserialize_json(data: dict) -> ABTestEvaluationConfig:
    if "onlineEvaluationConfigArn" in data:
        ...
        import aws_sdk_bedrock_agentcore.types.per_variant_online_evaluation_config_list
        return {"perVariantOnlineEvaluationConfig": aws_sdk_bedrock_agentcore.types.per_variant_online_evaluation_config_list.deserialize_json(data["perVariantOnlineEvaluationConfig"])}
    else:
