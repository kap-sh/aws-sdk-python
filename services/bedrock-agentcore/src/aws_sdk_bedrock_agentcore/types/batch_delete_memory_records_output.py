...
class BatchDeleteMemoryRecordsOutput(TypedDict):
...
def deserialize_json(data: dict) -> BatchDeleteMemoryRecordsOutput:
    ...
    if "successfulRecords" in data:
        ...
        raise DeserializationError("BatchDeleteMemoryRecordsOutput.successful_records required")
    if "failedRecords" in data:
        ...
        raise DeserializationError("BatchDeleteMemoryRecordsOutput.failed_records required")
    return out