...
from capo_bedrock_agentcore._services._aws_config import aaws_config
...
class AsyncBedrockAgentCoreClientConfig(TypedDict, total=False, closed=True):
...
class AsyncBedrockAgentCoreClient:
    ...
    async def complete_resource_token_auth(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bedrock_agentcore.types.complete_resource_token_auth_request.CompleteResourceTokenAuthRequest]",
        ) -> AsyncOperationResponse[
            "capo_bedrock_agentcore.types.complete_resource_token_auth_response.CompleteResourceTokenAuthResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bedrock_agentcore._operations.amazon_bedrock_agent_core.complete_resource_token_auth.async_complete_resource_token_auth(
    ...
    async def get_resource_api_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bedrock_agentcore.types.get_resource_api_key_request.GetResourceApiKeyRequest]",
        ) -> AsyncOperationResponse[
            "capo_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_api_key.async_get_resource_api_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_oauth2_token(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bedrock_agentcore.types.get_resource_oauth2_token_request.GetResourceOauth2TokenRequest]",
        ) -> AsyncOperationResponse[
            "capo_bedrock_agentcore.types.get_resource_oauth2_token_response.GetResourceOauth2TokenResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_oauth2_token.async_get_resource_oauth2_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_payment_token(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bedrock_agentcore.types.get_resource_payment_token_request.GetResourcePaymentTokenRequest]",
        ) -> AsyncOperationResponse[
            "capo_bedrock_agentcore.types.get_resource_payment_token_response.GetResourcePaymentTokenResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_resource_payment_token.async_get_resource_payment_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_workload_access_token(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bedrock_agentcore.types.get_workload_access_token_request.GetWorkloadAccessTokenRequest]",
        ) -> AsyncOperationResponse[
            "capo_bedrock_agentcore.types.get_workload_access_token_response.GetWorkloadAccessTokenResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token.async_get_workload_access_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_workload_access_token_for_jwt(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bedrock_agentcore.types.get_workload_access_token_for_jwt_request.GetWorkloadAccessTokenForJWTRequest]",
        ) -> AsyncOperationResponse[
            "capo_bedrock_agentcore.types.get_workload_access_token_for_jwt_response.GetWorkloadAccessTokenForJWTResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token_for_jwt.async_get_workload_access_token_for_jwt(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_workload_access_token_for_user_id(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bedrock_agentcore.types.get_workload_access_token_for_user_id_request.GetWorkloadAccessTokenForUserIdRequest]",
        ) -> AsyncOperationResponse[
            "capo_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.GetWorkloadAccessTokenForUserIdResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_bedrock_agentcore._operations.amazon_bedrock_agent_core.get_workload_access_token_for_user_id.async_get_workload_access_token_for_user_id(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def invoke_code_interpreter(
        ...
        *,
    ...
    ) -> "AsyncGenerator[capo_bedrock_agentcore.types.invoke_code_interpreter_response.InvokeCodeInterpreterResponse]":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bedrock_agentcore.types.invoke_code_interpreter_request.InvokeCodeInterpreterRequest]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_code_interpreter.async_invoke_code_interpreter(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def invoke_harness(
        ...
        *,
    ...
    ) -> "AsyncGenerator[capo_bedrock_agentcore.types.invoke_harness_response.InvokeHarnessResponse]":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_bedrock_agentcore.types.invoke_harness_request.InvokeHarnessRequest]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_bedrock_agentcore._operations.amazon_bedrock_agent_core.invoke_harness.async_invoke_harness(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
