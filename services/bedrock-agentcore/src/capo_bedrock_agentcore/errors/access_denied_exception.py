"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockagentcore#AccessDeniedException``."""
