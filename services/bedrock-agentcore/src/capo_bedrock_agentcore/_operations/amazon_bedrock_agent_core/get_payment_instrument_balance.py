...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.get_payment_instrument_balance_response.GetPaymentInstrumentBalanceResponse = capo_bedrock_agentcore.types.get_payment_instrument_balance_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.get_payment_instrument_balance_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
