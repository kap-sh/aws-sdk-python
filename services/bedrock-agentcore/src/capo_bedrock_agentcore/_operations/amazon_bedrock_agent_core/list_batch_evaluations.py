...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.list_batch_evaluations_response.ListBatchEvaluationsResponse = capo_bedrock_agentcore.types.list_batch_evaluations_response.deserialize_json(
