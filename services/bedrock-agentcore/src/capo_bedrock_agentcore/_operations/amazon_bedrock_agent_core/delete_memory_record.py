"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#DeleteMemoryRecord``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.delete_memory_record_output.DeleteMemoryRecordOutput = capo_bedrock_agentcore.types.delete_memory_record_output.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/memories/{memoryId}/memoryRecords/{memoryRecordId}"
    )
...
async def async_delete_memory_record(
