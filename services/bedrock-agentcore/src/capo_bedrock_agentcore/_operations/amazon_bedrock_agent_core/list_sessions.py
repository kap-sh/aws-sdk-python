...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.list_sessions_output.ListSessionsOutput = (
        capo_bedrock_agentcore.types.list_sessions_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.list_sessions_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
