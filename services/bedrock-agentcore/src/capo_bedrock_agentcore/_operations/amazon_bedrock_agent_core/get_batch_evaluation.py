...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.get_batch_evaluation_response.GetBatchEvaluationResponse = capo_bedrock_agentcore.types.get_batch_evaluation_response.deserialize_json(
