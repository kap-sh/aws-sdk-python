...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.get_payment_instrument_response.GetPaymentInstrumentResponse = capo_bedrock_agentcore.types.get_payment_instrument_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.get_payment_instrument_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_payment_instrument(
