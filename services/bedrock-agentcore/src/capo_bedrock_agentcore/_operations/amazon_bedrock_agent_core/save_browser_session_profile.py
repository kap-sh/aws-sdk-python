...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.save_browser_session_profile_response.SaveBrowserSessionProfileResponse = capo_bedrock_agentcore.types.save_browser_session_profile_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.save_browser_session_profile_request.serialize_json(
            input_
        )
    ).encode()
