...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.retrieve_memory_records_output.RetrieveMemoryRecordsOutput = capo_bedrock_agentcore.types.retrieve_memory_records_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.retrieve_memory_records_input.serialize_json(
            input_
        )
    ).encode()
