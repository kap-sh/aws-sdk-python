...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.get_code_interpreter_session_response.GetCodeInterpreterSessionResponse = capo_bedrock_agentcore.types.get_code_interpreter_session_response.deserialize_json(
