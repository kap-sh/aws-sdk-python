...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.start_batch_evaluation_response.StartBatchEvaluationResponse = capo_bedrock_agentcore.types.start_batch_evaluation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.start_batch_evaluation_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
