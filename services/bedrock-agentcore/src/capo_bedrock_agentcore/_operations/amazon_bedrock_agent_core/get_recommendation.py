"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#GetRecommendation``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.get_recommendation_response.GetRecommendationResponse = capo_bedrock_agentcore.types.get_recommendation_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/recommendations/{recommendationId}"
    url = url.replace("{recommendationId}", quote(input_["recommendation_id"], safe=""))
