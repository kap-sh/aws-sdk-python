...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.get_resource_api_key_response.GetResourceApiKeyResponse = capo_bedrock_agentcore.types.get_resource_api_key_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.get_resource_api_key_request.serialize_json(input_)
    ).encode()
