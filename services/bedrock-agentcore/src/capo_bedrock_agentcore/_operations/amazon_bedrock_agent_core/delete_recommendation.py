...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.delete_recommendation_response.DeleteRecommendationResponse = capo_bedrock_agentcore.types.delete_recommendation_response.deserialize_json(
