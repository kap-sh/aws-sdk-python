"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#GetABTest``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.get_ab_test_response.GetABTestResponse = (
        capo_bedrock_agentcore.types.get_ab_test_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ab-tests/{abTestId}"
    url = url.replace("{abTestId}", quote(input_["ab_test_id"], safe=""))
...
def get_ab_test(
    ...
    capo_bedrock_agentcore.types.get_ab_test_response.GetABTestResponse, zapros.Response
]:
