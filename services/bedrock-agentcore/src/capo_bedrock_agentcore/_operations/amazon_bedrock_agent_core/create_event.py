...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.create_event_output.CreateEventOutput = (
        capo_bedrock_agentcore.types.create_event_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.create_event_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_event(
    ...
    capo_bedrock_agentcore.types.create_event_output.CreateEventOutput, zapros.Response
]:
