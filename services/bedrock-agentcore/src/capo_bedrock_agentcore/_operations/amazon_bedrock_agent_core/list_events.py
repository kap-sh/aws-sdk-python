...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.list_events_output.ListEventsOutput = (
        capo_bedrock_agentcore.types.list_events_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.list_events_input.serialize_json(input_)
    ).encode()
...
def list_events(
    ...
    capo_bedrock_agentcore.types.list_events_output.ListEventsOutput, zapros.Response
]:
