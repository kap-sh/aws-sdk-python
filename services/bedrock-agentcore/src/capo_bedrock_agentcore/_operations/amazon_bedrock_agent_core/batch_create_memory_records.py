...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.batch_create_memory_records_output.BatchCreateMemoryRecordsOutput = capo_bedrock_agentcore.types.batch_create_memory_records_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.batch_create_memory_records_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
