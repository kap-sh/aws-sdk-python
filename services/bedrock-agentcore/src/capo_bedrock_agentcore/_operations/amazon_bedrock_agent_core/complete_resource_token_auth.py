...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.complete_resource_token_auth_response.CompleteResourceTokenAuthResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.complete_resource_token_auth_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
