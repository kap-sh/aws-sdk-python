...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.create_ab_test_response.CreateABTestResponse = (
        capo_bedrock_agentcore.types.create_ab_test_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.create_ab_test_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
