...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.start_code_interpreter_session_response.StartCodeInterpreterSessionResponse = capo_bedrock_agentcore.types.start_code_interpreter_session_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.start_code_interpreter_session_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
