...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.update_browser_stream_response.UpdateBrowserStreamResponse = capo_bedrock_agentcore.types.update_browser_stream_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.update_browser_stream_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
