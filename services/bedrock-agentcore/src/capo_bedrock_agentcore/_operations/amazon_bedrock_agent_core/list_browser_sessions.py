...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.list_browser_sessions_response.ListBrowserSessionsResponse = capo_bedrock_agentcore.types.list_browser_sessions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.list_browser_sessions_request.serialize_json(
            input_
        )
    ).encode()
