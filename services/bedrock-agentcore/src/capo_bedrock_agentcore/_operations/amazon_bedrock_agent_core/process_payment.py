"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#ProcessPayment``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.process_payment_response.ProcessPaymentResponse = capo_bedrock_agentcore.types.process_payment_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/payments/processPayment"
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.process_payment_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
