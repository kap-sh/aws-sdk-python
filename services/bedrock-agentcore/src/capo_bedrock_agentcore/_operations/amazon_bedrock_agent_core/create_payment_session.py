...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.create_payment_session_response.CreatePaymentSessionResponse = capo_bedrock_agentcore.types.create_payment_session_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.create_payment_session_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
