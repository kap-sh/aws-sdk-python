...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.stop_batch_evaluation_response.StopBatchEvaluationResponse = capo_bedrock_agentcore.types.stop_batch_evaluation_response.deserialize_json(
