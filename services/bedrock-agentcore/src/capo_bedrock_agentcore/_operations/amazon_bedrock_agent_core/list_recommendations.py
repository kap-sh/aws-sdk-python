...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.list_recommendations_response.ListRecommendationsResponse = capo_bedrock_agentcore.types.list_recommendations_response.deserialize_json(
...
def build_request(
    ...
    if "status_filter" in input_:
        params.append(
            (
                "status",
                capo_bedrock_agentcore.types.recommendation_status.serialize_json(
