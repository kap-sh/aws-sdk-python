...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.list_payment_instruments_response.ListPaymentInstrumentsResponse = capo_bedrock_agentcore.types.list_payment_instruments_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.list_payment_instruments_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
