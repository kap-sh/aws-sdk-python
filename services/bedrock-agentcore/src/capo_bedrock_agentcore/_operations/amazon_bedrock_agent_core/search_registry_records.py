...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.search_registry_records_response.SearchRegistryRecordsResponse = capo_bedrock_agentcore.types.search_registry_records_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.search_registry_records_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
