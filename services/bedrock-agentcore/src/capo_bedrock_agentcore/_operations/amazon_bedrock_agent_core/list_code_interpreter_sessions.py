...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.list_code_interpreter_sessions_response.ListCodeInterpreterSessionsResponse = capo_bedrock_agentcore.types.list_code_interpreter_sessions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.list_code_interpreter_sessions_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
