...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.start_memory_extraction_job_output.StartMemoryExtractionJobOutput = capo_bedrock_agentcore.types.start_memory_extraction_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.start_memory_extraction_job_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_memory_extraction_job(
