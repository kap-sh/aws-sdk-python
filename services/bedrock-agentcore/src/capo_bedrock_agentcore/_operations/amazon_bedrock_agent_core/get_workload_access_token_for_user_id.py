"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#GetWorkloadAccessTokenForUserId``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.GetWorkloadAccessTokenForUserIdResponse = capo_bedrock_agentcore.types.get_workload_access_token_for_user_id_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/identities/GetWorkloadAccessTokenForUserId"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.get_workload_access_token_for_user_id_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_workload_access_token_for_user_id(
