"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#GetBrowserSession``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.get_browser_session_response.GetBrowserSessionResponse = capo_bedrock_agentcore.types.get_browser_session_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/browsers/{browserIdentifier}/sessions/get"
    url = url.replace(
...
async def async_get_browser_session(
