...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.delete_batch_evaluation_response.DeleteBatchEvaluationResponse = capo_bedrock_agentcore.types.delete_batch_evaluation_response.deserialize_json(
