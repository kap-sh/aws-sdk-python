"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#DeleteEvent``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.delete_event_output.DeleteEventOutput = (
        capo_bedrock_agentcore.types.delete_event_output.deserialize_json(
...
def delete_event(
    ...
    capo_bedrock_agentcore.types.delete_event_output.DeleteEventOutput, zapros.Response
]:
