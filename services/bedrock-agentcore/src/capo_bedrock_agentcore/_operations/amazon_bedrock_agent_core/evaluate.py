...
import capo_bedrock_agentcore.errors.duplicate_id_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DuplicateIdException":
            raise capo_bedrock_agentcore.errors.duplicate_id_exception.DuplicateIdException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_bedrock_agentcore.types.evaluate_response.EvaluateResponse = (
        capo_bedrock_agentcore.types.evaluate_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore.types.evaluate_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def evaluate(
    ...
    capo_bedrock_agentcore.types.evaluate_response.EvaluateResponse, zapros.Response
]:
