...
def handle_response(
    ...
    out: aws_sdk_backup.types.describe_copy_job_output.DescribeCopyJobOutput = (
        aws_sdk_backup.types.describe_copy_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.describe_copy_job_input.DescribeCopyJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{CopyJobId}", quote(str(input_["copy_job_id"]), safe=""))
    params: dict[str, str] = {}
...
def describe_copy_job(
    ...
    aws_sdk_backup.types.describe_copy_job_output.DescribeCopyJobOutput, zapros.Response
]:
