...
def build_request(
    ...
    input_: aws_sdk_backup.types.create_legal_hold_input.CreateLegalHoldInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.create_legal_hold_input.serialize_json(input_)
    ).encode()
...
def create_legal_hold(
    ...
    aws_sdk_backup.types.create_legal_hold_output.CreateLegalHoldOutput, zapros.Response
]:
