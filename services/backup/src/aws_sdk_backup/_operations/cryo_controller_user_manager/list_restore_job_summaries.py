...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_restore_job_summaries_output.ListRestoreJobSummariesOutput = aws_sdk_backup.types.list_restore_job_summaries_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_restore_job_summaries_input.ListRestoreJobSummariesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
