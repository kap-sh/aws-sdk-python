...
def handle_response(
    ...
    out: aws_sdk_backup.types.get_backup_plan_output.GetBackupPlanOutput = (
        aws_sdk_backup.types.get_backup_plan_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_backup.types.get_backup_plan_input.GetBackupPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params["MaxScheduledRunsPreview"] = str(input.get("max_scheduled_runs_preview", 0))
...
def get_backup_plan(
    ...
    aws_sdk_backup.types.get_backup_plan_output.GetBackupPlanOutput, zapros.Response
]:
