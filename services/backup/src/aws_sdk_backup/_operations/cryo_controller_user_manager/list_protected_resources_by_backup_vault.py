...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_protected_resources_by_backup_vault_output.ListProtectedResourcesByBackupVaultOutput = aws_sdk_backup.types.list_protected_resources_by_backup_vault_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_protected_resources_by_backup_vault_input.ListProtectedResourcesByBackupVaultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
