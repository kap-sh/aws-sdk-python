...
def handle_response(
    ...
    out: aws_sdk_backup.types.update_report_plan_output.UpdateReportPlanOutput = (
        aws_sdk_backup.types.update_report_plan_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.update_report_plan_input.UpdateReportPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.update_report_plan_input.serialize_json(input_)
    ).encode()
