...
def build_request(
    ...
    input: aws_sdk_backup.types.list_copy_job_summaries_input.ListCopyJobSummariesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "message_category" in input:
        params["MessageCategory"] = str(input["message_category"])
