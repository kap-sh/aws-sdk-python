...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_copy_job_summaries_output.ListCopyJobSummariesOutput = aws_sdk_backup.types.list_copy_job_summaries_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_copy_job_summaries_input.ListCopyJobSummariesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
