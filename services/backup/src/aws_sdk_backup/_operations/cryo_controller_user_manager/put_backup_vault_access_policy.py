...
def build_request(
    ...
    input_: aws_sdk_backup.types.put_backup_vault_access_policy_input.PutBackupVaultAccessPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.put_backup_vault_access_policy_input.serialize_json(input_)
    ).encode()
