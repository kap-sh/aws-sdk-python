...
def build_request(
    ...
    input: aws_sdk_backup.types.put_backup_vault_access_policy_input.PutBackupVaultAccessPolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.put_backup_vault_access_policy_input.serialize_json(input)
    ).encode()
