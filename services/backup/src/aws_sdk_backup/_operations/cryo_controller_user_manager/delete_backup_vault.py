"""Generated from Smithy shape ``com.amazonaws.backup#DeleteBackupVault``."""
...
def build_request(
    ...
    input_: aws_sdk_backup.types.delete_backup_vault_input.DeleteBackupVaultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_backup_vault(
