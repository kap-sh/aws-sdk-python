...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_restore_testing_selections_output.ListRestoreTestingSelectionsOutput = aws_sdk_backup.types.list_restore_testing_selections_output.deserialize_json(
