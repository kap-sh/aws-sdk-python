...
def build_request(
    ...
    input: aws_sdk_backup.types.create_restore_testing_plan_input.CreateRestoreTestingPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.create_restore_testing_plan_input.serialize_json(input)
    ).encode()
