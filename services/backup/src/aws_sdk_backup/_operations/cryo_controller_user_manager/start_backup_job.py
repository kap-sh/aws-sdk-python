...
def handle_response(
    ...
    out: aws_sdk_backup.types.start_backup_job_output.StartBackupJobOutput = (
        aws_sdk_backup.types.start_backup_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.start_backup_job_input.StartBackupJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.start_backup_job_input.serialize_json(input_)
    ).encode()
...
def start_backup_job(
    ...
    aws_sdk_backup.types.start_backup_job_output.StartBackupJobOutput, zapros.Response
]:
