...
import aws_sdk_backup.types.backup_plan_versions_list
...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_backup_plan_versions_output.ListBackupPlanVersionsOutput = aws_sdk_backup.types.list_backup_plan_versions_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_backup_plan_versions_input.ListBackupPlanVersionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
