...
def handle_response(
    ...
    out: aws_sdk_backup.types.export_backup_plan_template_output.ExportBackupPlanTemplateOutput = aws_sdk_backup.types.export_backup_plan_template_output.deserialize_json(
