"""Generated from Smithy shape ``com.amazonaws.backup#CreateTieringConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_backup.types.create_tiering_configuration_output.CreateTieringConfigurationOutput = aws_sdk_backup.types.create_tiering_configuration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.create_tiering_configuration_input.CreateTieringConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/tiering-configurations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_backup.types.create_tiering_configuration_input

    body: bytes | None = json.dumps(
        aws_sdk_backup.types.create_tiering_configuration_input.serialize_json(input_)
    ).encode()
...
async def async_create_tiering_configuration(
