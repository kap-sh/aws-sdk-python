...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_legal_holds_output.ListLegalHoldsOutput = (
        aws_sdk_backup.types.list_legal_holds_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_legal_holds_input.ListLegalHoldsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_legal_holds(
    ...
    aws_sdk_backup.types.list_legal_holds_output.ListLegalHoldsOutput, zapros.Response
]:
