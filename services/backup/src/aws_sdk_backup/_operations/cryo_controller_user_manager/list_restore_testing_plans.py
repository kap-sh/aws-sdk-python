...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_restore_testing_plans_output.ListRestoreTestingPlansOutput = aws_sdk_backup.types.list_restore_testing_plans_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_restore_testing_plans_input.ListRestoreTestingPlansInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
