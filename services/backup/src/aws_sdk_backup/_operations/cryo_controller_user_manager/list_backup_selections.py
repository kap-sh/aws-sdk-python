...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_backup_selections_output.ListBackupSelectionsOutput = aws_sdk_backup.types.list_backup_selections_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_backup_selections_input.ListBackupSelectionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
