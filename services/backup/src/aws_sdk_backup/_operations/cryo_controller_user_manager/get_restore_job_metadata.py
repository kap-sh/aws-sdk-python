...
def handle_response(
    ...
    out: aws_sdk_backup.types.get_restore_job_metadata_output.GetRestoreJobMetadataOutput = aws_sdk_backup.types.get_restore_job_metadata_output.deserialize_json(
