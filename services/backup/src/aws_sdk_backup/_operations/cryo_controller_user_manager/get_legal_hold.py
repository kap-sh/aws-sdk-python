...
def handle_response(
    ...
    out: aws_sdk_backup.types.get_legal_hold_output.GetLegalHoldOutput = (
        aws_sdk_backup.types.get_legal_hold_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.get_legal_hold_input.GetLegalHoldInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_legal_hold(
    ...
    aws_sdk_backup.types.get_legal_hold_output.GetLegalHoldOutput, zapros.Response
]:
