...
def handle_response(
    ...
    out: aws_sdk_backup.types.get_restore_testing_plan_output.GetRestoreTestingPlanOutput = aws_sdk_backup.types.get_restore_testing_plan_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.get_restore_testing_plan_input.GetRestoreTestingPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
