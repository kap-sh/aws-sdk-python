...
def build_request(
    ...
    input: aws_sdk_backup.types.update_restore_testing_plan_input.UpdateRestoreTestingPlanInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.update_restore_testing_plan_input.serialize_json(input)
    ).encode()
