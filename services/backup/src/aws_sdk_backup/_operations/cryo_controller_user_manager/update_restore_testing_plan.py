"""Generated from Smithy shape ``com.amazonaws.backup#UpdateRestoreTestingPlan``."""
...
def handle_response(
    ...
    out: aws_sdk_backup.types.update_restore_testing_plan_output.UpdateRestoreTestingPlanOutput = aws_sdk_backup.types.update_restore_testing_plan_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.update_restore_testing_plan_input.UpdateRestoreTestingPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.update_restore_testing_plan_input.serialize_json(input_)
    ).encode()
...
async def async_update_restore_testing_plan(
