"""Generated from Smithy shape ``com.amazonaws.backup#DeleteRestoreTestingSelection``."""
...
def build_request(
    ...
    input_: aws_sdk_backup.types.delete_restore_testing_selection_input.DeleteRestoreTestingSelectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["restore_testing_selection_name"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_delete_restore_testing_selection(
