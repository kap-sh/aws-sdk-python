...
def build_request(
    ...
    input: aws_sdk_backup.types.delete_restore_testing_selection_input.DeleteRestoreTestingSelectionInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["restore_testing_selection_name"]), safe=""),
    )
    params: dict[str, str] = {}
