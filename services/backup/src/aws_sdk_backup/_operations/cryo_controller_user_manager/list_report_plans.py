...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_report_plans_output.ListReportPlansOutput = (
        aws_sdk_backup.types.list_report_plans_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_report_plans_input.ListReportPlansInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_report_plans(
    ...
    aws_sdk_backup.types.list_report_plans_output.ListReportPlansOutput, zapros.Response
]:
