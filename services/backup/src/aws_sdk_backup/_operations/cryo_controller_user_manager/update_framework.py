"""Generated from Smithy shape ``com.amazonaws.backup#UpdateFramework``."""
...
def handle_response(
    ...
    out: aws_sdk_backup.types.update_framework_output.UpdateFrameworkOutput = (
        aws_sdk_backup.types.update_framework_output.deserialize_json(
