"""Generated from Smithy shape ``com.amazonaws.backup#CreateFramework``."""
...
def handle_response(
    ...
    out: aws_sdk_backup.types.create_framework_output.CreateFrameworkOutput = (
        aws_sdk_backup.types.create_framework_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.create_framework_input.CreateFrameworkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/audit/frameworks"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_backup.types.create_framework_input

    body: bytes | None = json.dumps(
        aws_sdk_backup.types.create_framework_input.serialize_json(input_)
    ).encode()
...
def create_framework(
    ...
    aws_sdk_backup.types.create_framework_output.CreateFrameworkOutput, zapros.Response
]:
...
async def async_create_framework(
