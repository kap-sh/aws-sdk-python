...
import aws_sdk_backup.types.backup_vault_list
...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_backup_vaults_output.ListBackupVaultsOutput = (
        aws_sdk_backup.types.list_backup_vaults_output.deserialize_json(
