...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_restore_access_backup_vaults_output.ListRestoreAccessBackupVaultsOutput = aws_sdk_backup.types.list_restore_access_backup_vaults_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_restore_access_backup_vaults_input.ListRestoreAccessBackupVaultsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
