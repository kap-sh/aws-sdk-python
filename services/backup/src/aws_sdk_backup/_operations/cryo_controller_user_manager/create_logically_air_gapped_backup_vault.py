"""Generated from Smithy shape ``com.amazonaws.backup#CreateLogicallyAirGappedBackupVault``."""
...
def handle_response(
    ...
    out: aws_sdk_backup.types.create_logically_air_gapped_backup_vault_output.CreateLogicallyAirGappedBackupVaultOutput = aws_sdk_backup.types.create_logically_air_gapped_backup_vault_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.create_logically_air_gapped_backup_vault_input.CreateLogicallyAirGappedBackupVaultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.create_logically_air_gapped_backup_vault_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_logically_air_gapped_backup_vault(
