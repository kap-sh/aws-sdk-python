...
def handle_response(
    ...
    out: aws_sdk_backup.types.get_supported_resource_types_output.GetSupportedResourceTypesOutput = aws_sdk_backup.types.get_supported_resource_types_output.deserialize_json(
