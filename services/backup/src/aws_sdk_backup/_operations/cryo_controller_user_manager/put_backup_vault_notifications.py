...
def build_request(
    ...
    input: aws_sdk_backup.types.put_backup_vault_notifications_input.PutBackupVaultNotificationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.put_backup_vault_notifications_input.serialize_json(input)
    ).encode()
