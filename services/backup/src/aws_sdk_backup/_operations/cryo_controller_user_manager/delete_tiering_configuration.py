"""Generated from Smithy shape ``com.amazonaws.backup#DeleteTieringConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_backup.types.delete_tiering_configuration_output.DeleteTieringConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_backup.types.delete_tiering_configuration_input.DeleteTieringConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_tiering_configuration(
