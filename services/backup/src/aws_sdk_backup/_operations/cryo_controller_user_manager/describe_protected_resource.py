...
def handle_response(
    ...
    out: aws_sdk_backup.types.describe_protected_resource_output.DescribeProtectedResourceOutput = aws_sdk_backup.types.describe_protected_resource_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.describe_protected_resource_input.DescribeProtectedResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
