...
def handle_response(
    ...
    out: aws_sdk_backup.types.create_backup_selection_output.CreateBackupSelectionOutput = aws_sdk_backup.types.create_backup_selection_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_backup.types.create_backup_selection_input.CreateBackupSelectionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.create_backup_selection_input.serialize_json(input)
    ).encode()
