...
def handle_response(
    ...
    out: aws_sdk_backup.types.update_restore_testing_selection_output.UpdateRestoreTestingSelectionOutput = aws_sdk_backup.types.update_restore_testing_selection_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.update_restore_testing_selection_input.UpdateRestoreTestingSelectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.update_restore_testing_selection_input.serialize_json(
            input_
        )
    ).encode()
