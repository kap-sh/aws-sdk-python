...
def build_request(
    ...
    input: aws_sdk_backup.types.get_backup_plan_from_json_input.GetBackupPlanFromJSONInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.get_backup_plan_from_json_input.serialize_json(input)
    ).encode()
