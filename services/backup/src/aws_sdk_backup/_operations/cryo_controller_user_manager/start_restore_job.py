...
def handle_response(
    ...
    out: aws_sdk_backup.types.start_restore_job_output.StartRestoreJobOutput = (
        aws_sdk_backup.types.start_restore_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.start_restore_job_input.StartRestoreJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.start_restore_job_input.serialize_json(input_)
    ).encode()
...
def start_restore_job(
    ...
    aws_sdk_backup.types.start_restore_job_output.StartRestoreJobOutput, zapros.Response
]:
