...
def build_request(
    ...
    input: aws_sdk_backup.types.put_restore_validation_result_input.PutRestoreValidationResultInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.put_restore_validation_result_input.serialize_json(input)
    ).encode()
