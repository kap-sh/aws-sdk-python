...
def handle_response(
    ...
    out: aws_sdk_backup.types.create_backup_vault_output.CreateBackupVaultOutput = (
        aws_sdk_backup.types.create_backup_vault_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_backup.types.create_backup_vault_input.CreateBackupVaultInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.create_backup_vault_input.serialize_json(input)
    ).encode()
