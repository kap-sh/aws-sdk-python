"""Generated from Smithy shape ``com.amazonaws.backup#ListBackupPlanTemplates``."""
...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_backup_plan_templates_output.ListBackupPlanTemplatesOutput = aws_sdk_backup.types.list_backup_plan_templates_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_backup_plan_templates_input.ListBackupPlanTemplatesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/backup/template/plans"
    params: dict[str, str] = {}
...
async def async_list_backup_plan_templates(
