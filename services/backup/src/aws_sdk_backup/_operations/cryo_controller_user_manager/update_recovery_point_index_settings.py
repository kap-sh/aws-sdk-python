...
def handle_response(
    ...
    out: aws_sdk_backup.types.update_recovery_point_index_settings_output.UpdateRecoveryPointIndexSettingsOutput = aws_sdk_backup.types.update_recovery_point_index_settings_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.update_recovery_point_index_settings_input.UpdateRecoveryPointIndexSettingsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.update_recovery_point_index_settings_input.serialize_json(
            input_
        )
    ).encode()
