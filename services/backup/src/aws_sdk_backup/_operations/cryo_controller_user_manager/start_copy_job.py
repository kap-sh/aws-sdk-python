"""Generated from Smithy shape ``com.amazonaws.backup#StartCopyJob``."""
...
def handle_response(
    ...
    out: aws_sdk_backup.types.start_copy_job_output.StartCopyJobOutput = (
        aws_sdk_backup.types.start_copy_job_output.deserialize_json(
