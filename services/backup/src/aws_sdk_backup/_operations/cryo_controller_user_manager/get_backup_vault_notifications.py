...
def handle_response(
    ...
    out: aws_sdk_backup.types.get_backup_vault_notifications_output.GetBackupVaultNotificationsOutput = aws_sdk_backup.types.get_backup_vault_notifications_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.get_backup_vault_notifications_input.GetBackupVaultNotificationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
