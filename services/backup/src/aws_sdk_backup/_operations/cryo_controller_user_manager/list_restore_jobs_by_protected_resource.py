...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_restore_jobs_by_protected_resource_output.ListRestoreJobsByProtectedResourceOutput = aws_sdk_backup.types.list_restore_jobs_by_protected_resource_output.deserialize_json(
