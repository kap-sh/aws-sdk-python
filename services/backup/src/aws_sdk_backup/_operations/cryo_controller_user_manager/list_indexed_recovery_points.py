...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_indexed_recovery_points_output.ListIndexedRecoveryPointsOutput = aws_sdk_backup.types.list_indexed_recovery_points_output.deserialize_json(
