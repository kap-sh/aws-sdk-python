"""Generated from Smithy shape ``com.amazonaws.backup#UntagResource``."""
...
def build_request(
    ...
    input_: aws_sdk_backup.types.untag_resource_input.UntagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/untag/{ResourceArn}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.untag_resource_input.serialize_json(input_)
    ).encode()
