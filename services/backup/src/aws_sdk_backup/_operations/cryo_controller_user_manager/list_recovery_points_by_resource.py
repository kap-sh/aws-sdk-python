...
import aws_sdk_backup.types.recovery_point_by_resource_list
...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_recovery_points_by_resource_output.ListRecoveryPointsByResourceOutput = aws_sdk_backup.types.list_recovery_points_by_resource_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_recovery_points_by_resource_input.ListRecoveryPointsByResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params["managedByAWSBackupOnly"] = str(
        input_.get("managed_by_aws_backup_only", False)
    )
