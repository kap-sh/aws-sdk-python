...
def handle_response(
    ...
    out: aws_sdk_backup.types.describe_restore_job_output.DescribeRestoreJobOutput = (
        aws_sdk_backup.types.describe_restore_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.describe_restore_job_input.DescribeRestoreJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
