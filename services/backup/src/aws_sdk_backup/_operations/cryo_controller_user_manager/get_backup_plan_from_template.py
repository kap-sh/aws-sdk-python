...
def handle_response(
    ...
    out: aws_sdk_backup.types.get_backup_plan_from_template_output.GetBackupPlanFromTemplateOutput = aws_sdk_backup.types.get_backup_plan_from_template_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.get_backup_plan_from_template_input.GetBackupPlanFromTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
