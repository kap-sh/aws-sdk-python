"""Generated from Smithy shape ``com.amazonaws.backup#UpdateRegionSettings``."""
...
def build_request(
    ...
    input_: aws_sdk_backup.types.update_region_settings_input.UpdateRegionSettingsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.update_region_settings_input.serialize_json(input_)
    ).encode()
...
async def async_update_region_settings(
