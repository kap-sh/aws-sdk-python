...
def build_request(
    ...
    input: aws_sdk_backup.types.update_region_settings_input.UpdateRegionSettingsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.update_region_settings_input.serialize_json(input)
    ).encode()
