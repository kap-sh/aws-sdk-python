"""Generated from Smithy shape ``com.amazonaws.backup#DisassociateRecoveryPoint``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResourceStateException":
            import aws_sdk_backup.errors.invalid_resource_state_exception

            raise aws_sdk_backup.errors.invalid_resource_state_exception.InvalidResourceStateException.from_json(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_backup.types.disassociate_recovery_point_input.DisassociateRecoveryPointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disassociate_recovery_point(
