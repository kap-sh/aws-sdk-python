...
def handle_response(
    ...
    out: aws_sdk_backup.types.get_restore_testing_inferred_metadata_output.GetRestoreTestingInferredMetadataOutput = aws_sdk_backup.types.get_restore_testing_inferred_metadata_output.deserialize_json(
