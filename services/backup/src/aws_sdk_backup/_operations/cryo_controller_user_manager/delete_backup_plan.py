...
def handle_response(
    ...
    out: aws_sdk_backup.types.delete_backup_plan_output.DeleteBackupPlanOutput = (
        aws_sdk_backup.types.delete_backup_plan_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.delete_backup_plan_input.DeleteBackupPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
