...
def handle_response(
    ...
    out: aws_sdk_backup.types.describe_report_plan_output.DescribeReportPlanOutput = (
        aws_sdk_backup.types.describe_report_plan_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.describe_report_plan_input.DescribeReportPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
