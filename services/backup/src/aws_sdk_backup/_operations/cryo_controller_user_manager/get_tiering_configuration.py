...
def handle_response(
    ...
    out: aws_sdk_backup.types.get_tiering_configuration_output.GetTieringConfigurationOutput = aws_sdk_backup.types.get_tiering_configuration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.get_tiering_configuration_input.GetTieringConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
