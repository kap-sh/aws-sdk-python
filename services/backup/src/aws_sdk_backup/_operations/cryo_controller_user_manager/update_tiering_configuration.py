...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AlreadyExistsException":
            import aws_sdk_backup.errors.already_exists_exception

            raise aws_sdk_backup.errors.already_exists_exception.AlreadyExistsException.from_json(
                data
            )
        case "ConflictException":
            import aws_sdk_backup.errors.conflict_exception

            raise aws_sdk_backup.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_backup.types.update_tiering_configuration_output.UpdateTieringConfigurationOutput = aws_sdk_backup.types.update_tiering_configuration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.update_tiering_configuration_input.UpdateTieringConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.update_tiering_configuration_input.serialize_json(input_)
    ).encode()
