...
def build_request(
    ...
    input: aws_sdk_backup.types.update_tiering_configuration_input.UpdateTieringConfigurationInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["tiering_configuration_name"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.update_tiering_configuration_input.serialize_json(input)
    ).encode()
