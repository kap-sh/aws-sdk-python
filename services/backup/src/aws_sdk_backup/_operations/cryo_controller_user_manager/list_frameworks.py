...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_frameworks_output.ListFrameworksOutput = (
        aws_sdk_backup.types.list_frameworks_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_frameworks_input.ListFrameworksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_frameworks(
    ...
    aws_sdk_backup.types.list_frameworks_output.ListFrameworksOutput, zapros.Response
]:
