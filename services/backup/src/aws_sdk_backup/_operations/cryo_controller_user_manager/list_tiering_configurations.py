"""Generated from Smithy shape ``com.amazonaws.backup#ListTieringConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_tiering_configurations_output.ListTieringConfigurationsOutput = aws_sdk_backup.types.list_tiering_configurations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_tiering_configurations_input.ListTieringConfigurationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_tiering_configurations(
