...
def handle_response(
    ...
    out: aws_sdk_backup.types.start_report_job_output.StartReportJobOutput = (
        aws_sdk_backup.types.start_report_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.start_report_job_input.StartReportJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.start_report_job_input.serialize_json(input_)
    ).encode()
...
def start_report_job(
    ...
    aws_sdk_backup.types.start_report_job_output.StartReportJobOutput, zapros.Response
]:
