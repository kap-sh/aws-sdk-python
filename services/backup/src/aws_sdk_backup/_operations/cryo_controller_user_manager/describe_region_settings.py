"""Generated from Smithy shape ``com.amazonaws.backup#DescribeRegionSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_backup.types.describe_region_settings_output.DescribeRegionSettingsOutput = aws_sdk_backup.types.describe_region_settings_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.describe_region_settings_input.DescribeRegionSettingsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/account-settings"
    params: dict[str, str] = {}
...
async def async_describe_region_settings(
