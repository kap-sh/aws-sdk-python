"""Generated from Smithy shape ``com.amazonaws.backup#StopBackupJob``."""
...
def build_request(
    ...
    input_: aws_sdk_backup.types.stop_backup_job_input.StopBackupJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_stop_backup_job(
