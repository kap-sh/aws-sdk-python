...
def handle_response(
    ...
    out: aws_sdk_backup.types.get_backup_vault_access_policy_output.GetBackupVaultAccessPolicyOutput = aws_sdk_backup.types.get_backup_vault_access_policy_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.get_backup_vault_access_policy_input.GetBackupVaultAccessPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
