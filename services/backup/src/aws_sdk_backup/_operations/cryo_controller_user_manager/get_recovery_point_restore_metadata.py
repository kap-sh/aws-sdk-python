...
def handle_response(
    ...
    out: aws_sdk_backup.types.get_recovery_point_restore_metadata_output.GetRecoveryPointRestoreMetadataOutput = aws_sdk_backup.types.get_recovery_point_restore_metadata_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.get_recovery_point_restore_metadata_input.GetRecoveryPointRestoreMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
