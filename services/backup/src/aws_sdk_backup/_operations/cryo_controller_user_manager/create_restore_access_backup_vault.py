...
def handle_response(
    ...
    out: aws_sdk_backup.types.create_restore_access_backup_vault_output.CreateRestoreAccessBackupVaultOutput = aws_sdk_backup.types.create_restore_access_backup_vault_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.create_restore_access_backup_vault_input.CreateRestoreAccessBackupVaultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
