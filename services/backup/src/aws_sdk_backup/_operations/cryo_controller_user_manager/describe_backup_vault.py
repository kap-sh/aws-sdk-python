"""Generated from Smithy shape ``com.amazonaws.backup#DescribeBackupVault``."""
...
def handle_response(
    ...
    out: aws_sdk_backup.types.describe_backup_vault_output.DescribeBackupVaultOutput = (
        aws_sdk_backup.types.describe_backup_vault_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.describe_backup_vault_input.DescribeBackupVaultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_backup_vault(
