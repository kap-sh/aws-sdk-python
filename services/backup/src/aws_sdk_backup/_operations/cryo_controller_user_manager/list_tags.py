...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_tags_output.ListTagsOutput = (
        aws_sdk_backup.types.list_tags_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_backup.types.list_tags_input.ListTagsInput,
) -> zapros.Request:
...
def list_tags(
    options: OperationOptions, input: aws_sdk_backup.types.list_tags_input.ListTagsInput
) -> tuple[aws_sdk_backup.types.list_tags_output.ListTagsOutput, zapros.Response]:
