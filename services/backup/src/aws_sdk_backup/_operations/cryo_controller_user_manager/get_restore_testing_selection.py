...
def handle_response(
    ...
    out: aws_sdk_backup.types.get_restore_testing_selection_output.GetRestoreTestingSelectionOutput = aws_sdk_backup.types.get_restore_testing_selection_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.get_restore_testing_selection_input.GetRestoreTestingSelectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
