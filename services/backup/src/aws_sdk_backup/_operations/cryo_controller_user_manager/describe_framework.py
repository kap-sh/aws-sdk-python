...
def handle_response(
    ...
    out: aws_sdk_backup.types.describe_framework_output.DescribeFrameworkOutput = (
        aws_sdk_backup.types.describe_framework_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.describe_framework_input.DescribeFrameworkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
