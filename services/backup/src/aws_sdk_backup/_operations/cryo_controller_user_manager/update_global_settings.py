...
def build_request(
    ...
    input: aws_sdk_backup.types.update_global_settings_input.UpdateGlobalSettingsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_backup.types.update_global_settings_input.serialize_json(input)
    ).encode()
