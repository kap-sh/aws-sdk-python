"""Generated from Smithy shape ``com.amazonaws.backup#GetRecoveryPointIndexDetails``."""
...
def handle_response(
    ...
    out: aws_sdk_backup.types.get_recovery_point_index_details_output.GetRecoveryPointIndexDetailsOutput = aws_sdk_backup.types.get_recovery_point_index_details_output.deserialize_json(
