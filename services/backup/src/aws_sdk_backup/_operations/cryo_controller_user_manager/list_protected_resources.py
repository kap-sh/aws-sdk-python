...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_protected_resources_output.ListProtectedResourcesOutput = aws_sdk_backup.types.list_protected_resources_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_protected_resources_input.ListProtectedResourcesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
