...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_backup_job_summaries_output.ListBackupJobSummariesOutput = aws_sdk_backup.types.list_backup_job_summaries_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_backup_job_summaries_input.ListBackupJobSummariesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
