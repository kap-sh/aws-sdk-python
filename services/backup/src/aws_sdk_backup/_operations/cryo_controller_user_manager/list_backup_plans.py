"""Generated from Smithy shape ``com.amazonaws.backup#ListBackupPlans``."""
...
import aws_sdk_backup.types.backup_plans_list
...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_backup_plans_output.ListBackupPlansOutput = (
        aws_sdk_backup.types.list_backup_plans_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_backup_plans_input.ListBackupPlansInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "include_deleted" in input_:
        params["includeDeleted"] = str(input_["include_deleted"])
...
def list_backup_plans(
    ...
    aws_sdk_backup.types.list_backup_plans_output.ListBackupPlansOutput, zapros.Response
]:
...
async def async_list_backup_plans(
