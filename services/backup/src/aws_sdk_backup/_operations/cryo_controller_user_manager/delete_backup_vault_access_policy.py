"""Generated from Smithy shape ``com.amazonaws.backup#DeleteBackupVaultAccessPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_backup.types.delete_backup_vault_access_policy_input.DeleteBackupVaultAccessPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_backup_vault_access_policy(
