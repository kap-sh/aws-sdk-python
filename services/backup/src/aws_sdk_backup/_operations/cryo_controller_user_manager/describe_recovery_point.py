...
def handle_response(
    ...
    out: aws_sdk_backup.types.describe_recovery_point_output.DescribeRecoveryPointOutput = aws_sdk_backup.types.describe_recovery_point_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.describe_recovery_point_input.DescribeRecoveryPointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
