...
def handle_response(
    ...
    out: aws_sdk_backup.types.describe_report_job_output.DescribeReportJobOutput = (
        aws_sdk_backup.types.describe_report_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.describe_report_job_input.DescribeReportJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{ReportJobId}", quote(str(input_["report_job_id"]), safe=""))
    params: dict[str, str] = {}
