...
def handle_response(
    ...
    out: aws_sdk_backup.types.list_recovery_points_by_legal_hold_output.ListRecoveryPointsByLegalHoldOutput = aws_sdk_backup.types.list_recovery_points_by_legal_hold_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_backup.types.list_recovery_points_by_legal_hold_input.ListRecoveryPointsByLegalHoldInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
