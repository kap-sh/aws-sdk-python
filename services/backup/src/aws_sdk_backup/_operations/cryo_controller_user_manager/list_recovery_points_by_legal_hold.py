...
def build_request(
    ...
    input: aws_sdk_backup.types.list_recovery_points_by_legal_hold_input.ListRecoveryPointsByLegalHoldInput,
) -> zapros.Request:
    ...
    url = url.replace("{LegalHoldId}", quote(str(input["legal_hold_id"]), safe=""))
    params: dict[str, str] = {}
