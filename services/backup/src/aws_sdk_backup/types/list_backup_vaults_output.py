...
class ListBackupVaultsOutput(TypedDict):
    backup_vault_list: NotRequired[
        "aws_sdk_backup.types.backup_vault_list.BackupVaultList"
    ]
...
def serialize_json(value: ListBackupVaultsOutput) -> dict:
    ...
    if "backup_vault_list" in value:
        ...
        out["BackupVaultList"] = aws_sdk_backup.types.backup_vault_list.serialize_json(
...
def deserialize_json(data: dict) -> ListBackupVaultsOutput:
    ...
    if "BackupVaultList" in data:
        ...
        out["backup_vault_list"] = (
            aws_sdk_backup.types.backup_vault_list.deserialize_json(
