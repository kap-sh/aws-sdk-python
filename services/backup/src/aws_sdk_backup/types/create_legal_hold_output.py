...
def serialize_json(value: CreateLegalHoldOutput) -> dict:
    ...
    if "status" in value:
        import aws_sdk_backup.types.legal_hold_status
        out["Status"] = aws_sdk_backup.types.legal_hold_status.serialize_json(value["status"])
...
def deserialize_json(data: dict) -> CreateLegalHoldOutput:
    ...
    if "Status" in data:
        import aws_sdk_backup.types.legal_hold_status
        out["status"] = aws_sdk_backup.types.legal_hold_status.deserialize_json(data["Status"])
