...
class IndexedRecoveryPoint(TypedDict):
    ...
    iam_role_arn: NotRequired["aws_sdk_backup.types.arn.ARN"]
    """<p>This specifies the IAM role ARN used for this operation.</p> <p>For example, arn:aws:iam::123456789012:role/S3Access</p>"""
    backup_creation_date: NotRequired["aws_sdk_backup.types.timestamp.timestamp"]
...
def serialize_json(value: IndexedRecoveryPoint) -> dict:
    ...
    if "backup_creation_date" in value:
        ...
        out["BackupCreationDate"] = aws_sdk_backup.types.timestamp.serialize_json(
...
def deserialize_json(data: dict) -> IndexedRecoveryPoint:
    ...
    if "BackupCreationDate" in data:
        ...
        out["backup_creation_date"] = aws_sdk_backup.types.timestamp.deserialize_json(
