...
class ListBackupPlansOutput(TypedDict):
    ...
    backup_plans_list: NotRequired[
        "aws_sdk_backup.types.backup_plans_list.BackupPlansList"
    ]
...
def serialize_json(value: ListBackupPlansOutput) -> dict:
    ...
    if "backup_plans_list" in value:
        ...
        out["BackupPlansList"] = aws_sdk_backup.types.backup_plans_list.serialize_json(
...
def deserialize_json(data: dict) -> ListBackupPlansOutput:
    ...
    if "BackupPlansList" in data:
        ...
        out["backup_plans_list"] = (
            aws_sdk_backup.types.backup_plans_list.deserialize_json(
