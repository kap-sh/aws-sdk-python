...
if TYPE_CHECKING:
    ...
    import aws_sdk_backup.types.lifecycle_delete_after_event
    import aws_sdk_backup.types.long


class Lifecycle(TypedDict, closed=True):
    move_to_cold_storage_after_days: NotRequired["aws_sdk_backup.types.long.Long"]
    """<p>The number of days after creation that a recovery point is moved to cold storage.</p>"""
    delete_after_days: NotRequired["aws_sdk_backup.types.long.Long"]
    ...
    opt_in_to_archive_for_supported_resources: NotRequired[
        "aws_sdk_backup.types.boolean.Boolean"
    ]
    ...
    delete_after_event: NotRequired[
        "aws_sdk_backup.types.lifecycle_delete_after_event.LifecycleDeleteAfterEvent"
    ]
...
def serialize_json(value: Lifecycle) -> dict:
    ...
    if "delete_after_event" in value:
        ...
        out["DeleteAfterEvent"] = (
            aws_sdk_backup.types.lifecycle_delete_after_event.serialize_json(
...
def deserialize_json(data: dict) -> Lifecycle:
    ...
    if "DeleteAfterEvent" in data:
        ...
        out["delete_after_event"] = (
            aws_sdk_backup.types.lifecycle_delete_after_event.deserialize_json(
