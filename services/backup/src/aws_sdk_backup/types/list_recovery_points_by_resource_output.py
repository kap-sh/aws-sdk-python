...
class ListRecoveryPointsByResourceOutput(TypedDict):
    ...
    recovery_points: NotRequired[
        "aws_sdk_backup.types.recovery_point_by_resource_list.RecoveryPointByResourceList"
    ]
...
def serialize_json(value: ListRecoveryPointsByResourceOutput) -> dict:
    ...
    if "recovery_points" in value:
        ...
        out["RecoveryPoints"] = (
            aws_sdk_backup.types.recovery_point_by_resource_list.serialize_json(
...
def deserialize_json(data: dict) -> ListRecoveryPointsByResourceOutput:
    ...
    if "RecoveryPoints" in data:
        ...
        out["recovery_points"] = (
            aws_sdk_backup.types.recovery_point_by_resource_list.deserialize_json(
                data["RecoveryPoints"]
            )
        )
    return out
