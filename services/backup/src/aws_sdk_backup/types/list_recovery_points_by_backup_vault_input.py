...
class ListRecoveryPointsByBackupVaultInput(TypedDict):
    ...
    by_backup_plan_id: NotRequired["aws_sdk_backup.types.string.string"]
    ...
    by_parent_recovery_point_arn: NotRequired["aws_sdk_backup.types.arn.ARN"]
