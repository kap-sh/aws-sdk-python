...
class ListCopyJobsInput(TypedDict):
    ...
    by_resource_arn: NotRequired["aws_sdk_backup.types.arn.ARN"]
    """<p>Returns only copy jobs that match the specified resource Amazon Resource Name (ARN). </p>"""
    by_state: NotRequired["aws_sdk_backup.types.copy_job_state.CopyJobState"]
    """<p>Returns only copy jobs that are in the specified state.</p>"""
    by_created_before: NotRequired["aws_sdk_backup.types.timestamp.timestamp"]
    """<p>Returns only copy jobs that were created before the specified date.</p>"""
    by_created_after: NotRequired["aws_sdk_backup.types.timestamp.timestamp"]
    """<p>Returns only copy jobs that were created after the specified date.</p>"""
    by_resource_type: NotRequired["aws_sdk_backup.types.resource_type.ResourceType"]
    ...
    by_destination_vault_arn: NotRequired["aws_sdk_backup.types.string.string"]
    ...
    by_source_recovery_point_arn: NotRequired["aws_sdk_backup.types.string.string"]
