...
class ReportPlan(TypedDict):
    ...
    deployment_status: NotRequired["aws_sdk_backup.types.string.string"]
    ...
    last_attempted_execution_time: NotRequired[
    ...
    last_successful_execution_time: NotRequired[
        "aws_sdk_backup.types.timestamp.timestamp"
    ]
...
def serialize_json(value: ReportPlan) -> dict:
    ...
    if "last_attempted_execution_time" in value:
        ...
        out["LastAttemptedExecutionTime"] = (
    ...
    if "last_successful_execution_time" in value:
        ...
        out["LastSuccessfulExecutionTime"] = (
            aws_sdk_backup.types.timestamp.serialize_json(
