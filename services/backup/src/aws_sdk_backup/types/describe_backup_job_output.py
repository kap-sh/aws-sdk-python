...
class DescribeBackupJobOutput(TypedDict):
    ...
    child_jobs_in_state: NotRequired[
        "aws_sdk_backup.types.backup_job_child_jobs_in_state.BackupJobChildJobsInState"
    ]
...
def serialize_json(value: DescribeBackupJobOutput) -> dict:
    ...
    if "child_jobs_in_state" in value:
        ...
        out["ChildJobsInState"] = (
            aws_sdk_backup.types.backup_job_child_jobs_in_state.serialize_json(
...
def deserialize_json(data: dict) -> DescribeBackupJobOutput:
    ...
    if "ChildJobsInState" in data:
        ...
        out["child_jobs_in_state"] = (
            aws_sdk_backup.types.backup_job_child_jobs_in_state.deserialize_json(
