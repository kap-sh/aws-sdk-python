...
def deserialize_json(data: dict) -> CreateLogicallyAirGappedBackupVaultInput:
    ...
    if "MinRetentionDays" in data:
        ...
        raise DeserializationError("CreateLogicallyAirGappedBackupVaultInput.min_retention_days required")
    if "MaxRetentionDays" in data:
        out["max_retention_days"] = data["MaxRetentionDays"]
    else:
        raise DeserializationError("CreateLogicallyAirGappedBackupVaultInput.max_retention_days required")
