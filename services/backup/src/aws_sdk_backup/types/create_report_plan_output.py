"""Generated from Smithy shape ``com.amazonaws.backup#CreateReportPlanOutput``."""
...
class CreateReportPlanOutput(TypedDict):
    report_plan_name: NotRequired["aws_sdk_backup.types.report_plan_name.ReportPlanName"]
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateReportPlanOutput) -> dict:
    out: dict = {}
    ...
    if "creation_time" in value:
        import aws_sdk_backup.types.timestamp
        out["CreationTime"] = aws_sdk_backup.types.timestamp.serialize_json(value["creation_time"])
    return out


def deserialize_json(data: dict) -> CreateReportPlanOutput:
    out: CreateReportPlanOutput = {}  # type: ignore[typeddict-item]
    ...
    if "CreationTime" in data:
        import aws_sdk_backup.types.timestamp
        out["creation_time"] = aws_sdk_backup.types.timestamp.deserialize_json(data["CreationTime"])
    return out