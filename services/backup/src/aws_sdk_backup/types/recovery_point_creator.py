...
class RecoveryPointCreator(TypedDict):
    ...
    backup_plan_name: NotRequired["aws_sdk_backup.types.string.string"]
    ...
    backup_plan_version: NotRequired["aws_sdk_backup.types.string.string"]
    ...
    backup_rule_id: NotRequired["aws_sdk_backup.types.string.string"]
    """<p>Uniquely identifies a rule used to schedule the backup of a selection of resources.</p>"""
    backup_rule_name: NotRequired["aws_sdk_backup.types.string.string"]
    ...
    backup_rule_cron: NotRequired["aws_sdk_backup.types.string.string"]
    ...
    backup_rule_timezone: NotRequired["aws_sdk_backup.types.string.string"]
