...
class BackupPlansListMember(TypedDict):
    ...
    backup_plan_name: NotRequired["aws_sdk_backup.types.backup_plan_name.BackupPlanName"]
...
def serialize_json(value: BackupPlansListMember) -> dict:
    ...
    if "deletion_date" in value:
        import aws_sdk_backup.types.timestamp
        out["DeletionDate"] = aws_sdk_backup.types.timestamp.serialize_json(value["deletion_date"])
    ...
    if "last_execution_date" in value:
        import aws_sdk_backup.types.timestamp
        out["LastExecutionDate"] = aws_sdk_backup.types.timestamp.serialize_json(value["last_execution_date"])
...
def deserialize_json(data: dict) -> BackupPlansListMember:
    ...
    if "DeletionDate" in data:
        import aws_sdk_backup.types.timestamp
        out["deletion_date"] = aws_sdk_backup.types.timestamp.deserialize_json(data["DeletionDate"])
    ...
    if "LastExecutionDate" in data:
        import aws_sdk_backup.types.timestamp
        out["last_execution_date"] = aws_sdk_backup.types.timestamp.deserialize_json(data["LastExecutionDate"])
