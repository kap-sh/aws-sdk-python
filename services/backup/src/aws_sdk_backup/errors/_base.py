...
class BackupError(Exception):
    """Base class for all Backup service errors."""


class ServiceError(BackupError):
...
class DeserializationError(BackupError):
...
class WaiterFailedError(BackupError):
...
class WaiterTimeoutError(BackupError):
