"""Generated from Smithy shape ``com.amazonaws.backup#DeleteBackupPlan``."""
...
def handle_response(
    ...
    out: capo_backup.types.delete_backup_plan_output.DeleteBackupPlanOutput = (
        capo_backup.types.delete_backup_plan_output.deserialize_json(
...
def delete_backup_plan(
    ...
    capo_backup.types.delete_backup_plan_output.DeleteBackupPlanOutput, zapros.Response
]:
...
async def async_delete_backup_plan(
