"""Generated from Smithy shape ``com.amazonaws.backup#ListProtectedResources``."""
...
def handle_response(
    ...
    out: capo_backup.types.list_protected_resources_output.ListProtectedResourcesOutput = capo_backup.types.list_protected_resources_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/resources"
    params: dict[str, str] = {}
...
async def async_list_protected_resources(
