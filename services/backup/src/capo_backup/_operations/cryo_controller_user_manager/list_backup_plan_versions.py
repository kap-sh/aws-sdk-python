"""Generated from Smithy shape ``com.amazonaws.backup#ListBackupPlanVersions``."""
...
def handle_response(
    ...
    out: capo_backup.types.list_backup_plan_versions_output.ListBackupPlanVersionsOutput = capo_backup.types.list_backup_plan_versions_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/backup/plans/{BackupPlanId}/versions"
...
async def async_list_backup_plan_versions(
