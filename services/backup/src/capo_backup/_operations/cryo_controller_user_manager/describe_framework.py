"""Generated from Smithy shape ``com.amazonaws.backup#DescribeFramework``."""
...
def handle_response(
    ...
    out: capo_backup.types.describe_framework_output.DescribeFrameworkOutput = (
        capo_backup.types.describe_framework_output.deserialize_json(
...
def describe_framework(
    ...
    capo_backup.types.describe_framework_output.DescribeFrameworkOutput, zapros.Response
]:
...
async def async_describe_framework(
