"""Generated from Smithy shape ``com.amazonaws.backup#ListBackupJobSummaries``."""
...
def handle_response(
    ...
    out: capo_backup.types.list_backup_job_summaries_output.ListBackupJobSummariesOutput = capo_backup.types.list_backup_job_summaries_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/audit/backup-job-summaries"
    params: dict[str, str] = {}
...
async def async_list_backup_job_summaries(
