"""Generated from Smithy shape ``com.amazonaws.backup#ListBackupVaults``."""
...
def handle_response(
    ...
    out: capo_backup.types.list_backup_vaults_output.ListBackupVaultsOutput = (
        capo_backup.types.list_backup_vaults_output.deserialize_json(
...
def list_backup_vaults(
    ...
    capo_backup.types.list_backup_vaults_output.ListBackupVaultsOutput, zapros.Response
]:
