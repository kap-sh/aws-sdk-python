"""Generated from Smithy shape ``com.amazonaws.backup#CreateRestoreAccessBackupVault``."""
...
def handle_response(
    ...
    out: capo_backup.types.create_restore_access_backup_vault_output.CreateRestoreAccessBackupVaultOutput = capo_backup.types.create_restore_access_backup_vault_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.create_restore_access_backup_vault_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_restore_access_backup_vault(
