"""Generated from Smithy shape ``com.amazonaws.backup#GetTieringConfiguration``."""
...
def handle_response(
    ...
    out: capo_backup.types.get_tiering_configuration_output.GetTieringConfigurationOutput = capo_backup.types.get_tiering_configuration_output.deserialize_json(
...
async def async_get_tiering_configuration(
