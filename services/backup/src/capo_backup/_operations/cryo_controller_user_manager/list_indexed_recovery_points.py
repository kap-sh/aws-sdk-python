"""Generated from Smithy shape ``com.amazonaws.backup#ListIndexedRecoveryPoints``."""
...
def handle_response(
    ...
    out: capo_backup.types.list_indexed_recovery_points_output.ListIndexedRecoveryPointsOutput = capo_backup.types.list_indexed_recovery_points_output.deserialize_json(
