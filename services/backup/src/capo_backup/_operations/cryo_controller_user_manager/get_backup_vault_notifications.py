"""Generated from Smithy shape ``com.amazonaws.backup#GetBackupVaultNotifications``."""
...
def handle_response(
    ...
    out: capo_backup.types.get_backup_vault_notifications_output.GetBackupVaultNotificationsOutput = capo_backup.types.get_backup_vault_notifications_output.deserialize_json(
...
async def async_get_backup_vault_notifications(
