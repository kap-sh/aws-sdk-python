"""Generated from Smithy shape ``com.amazonaws.backup#GetLegalHold``."""
...
def handle_response(
    ...
    out: capo_backup.types.get_legal_hold_output.GetLegalHoldOutput = (
        capo_backup.types.get_legal_hold_output.deserialize_json(
...
def get_legal_hold(
    ...
    input_: capo_backup.types.get_legal_hold_input.GetLegalHoldInput,
) -> tuple[capo_backup.types.get_legal_hold_output.GetLegalHoldOutput, zapros.Response]:
...
async def async_get_legal_hold(
