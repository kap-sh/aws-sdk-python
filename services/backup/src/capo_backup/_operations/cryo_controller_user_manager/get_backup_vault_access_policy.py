"""Generated from Smithy shape ``com.amazonaws.backup#GetBackupVaultAccessPolicy``."""
...
def handle_response(
    ...
    out: capo_backup.types.get_backup_vault_access_policy_output.GetBackupVaultAccessPolicyOutput = capo_backup.types.get_backup_vault_access_policy_output.deserialize_json(
...
async def async_get_backup_vault_access_policy(
