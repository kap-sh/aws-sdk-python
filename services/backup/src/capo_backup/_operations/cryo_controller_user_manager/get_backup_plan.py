"""Generated from Smithy shape ``com.amazonaws.backup#GetBackupPlan``."""
...
def handle_response(
    ...
    out: capo_backup.types.get_backup_plan_output.GetBackupPlanOutput = (
        capo_backup.types.get_backup_plan_output.deserialize_json(
...
def build_request(
    ...
    params["MaxScheduledRunsPreview"] = str(input_.get("max_scheduled_runs_preview", 0))
...
def get_backup_plan(
    ...
    capo_backup.types.get_backup_plan_output.GetBackupPlanOutput, zapros.Response
]:
...
async def async_get_backup_plan(
