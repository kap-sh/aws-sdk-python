"""Generated from Smithy shape ``com.amazonaws.backup#ListBackupSelections``."""
...
def handle_response(
    ...
    out: capo_backup.types.list_backup_selections_output.ListBackupSelectionsOutput = (
        capo_backup.types.list_backup_selections_output.deserialize_json(
...
async def async_list_backup_selections(
