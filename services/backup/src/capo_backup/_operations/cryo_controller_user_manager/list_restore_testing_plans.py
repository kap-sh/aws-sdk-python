"""Generated from Smithy shape ``com.amazonaws.backup#ListRestoreTestingPlans``."""
...
import capo_backup.types.restore_testing_plans
...
def handle_response(
    ...
    out: capo_backup.types.list_restore_testing_plans_output.ListRestoreTestingPlansOutput = capo_backup.types.list_restore_testing_plans_output.deserialize_json(
...
async def async_list_restore_testing_plans(
