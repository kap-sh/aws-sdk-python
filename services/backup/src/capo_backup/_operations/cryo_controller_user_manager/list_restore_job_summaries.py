"""Generated from Smithy shape ``com.amazonaws.backup#ListRestoreJobSummaries``."""
...
import capo_backup.types.restore_job_summary_list
...
def handle_response(
    ...
    out: capo_backup.types.list_restore_job_summaries_output.ListRestoreJobSummariesOutput = capo_backup.types.list_restore_job_summaries_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/audit/restore-job-summaries"
    params: dict[str, str] = {}
...
async def async_list_restore_job_summaries(
