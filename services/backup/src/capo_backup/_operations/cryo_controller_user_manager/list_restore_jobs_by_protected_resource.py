"""Generated from Smithy shape ``com.amazonaws.backup#ListRestoreJobsByProtectedResource``."""
...
def handle_response(
    ...
    out: capo_backup.types.list_restore_jobs_by_protected_resource_output.ListRestoreJobsByProtectedResourceOutput = capo_backup.types.list_restore_jobs_by_protected_resource_output.deserialize_json(
