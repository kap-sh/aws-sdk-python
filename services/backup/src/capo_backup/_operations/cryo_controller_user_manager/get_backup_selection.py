"""Generated from Smithy shape ``com.amazonaws.backup#GetBackupSelection``."""
...
def handle_response(
    ...
    out: capo_backup.types.get_backup_selection_output.GetBackupSelectionOutput = (
        capo_backup.types.get_backup_selection_output.deserialize_json(
