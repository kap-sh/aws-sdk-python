...
def handle_response(
    ...
    out: capo_backup.types.describe_scan_job_output.DescribeScanJobOutput = (
        capo_backup.types.describe_scan_job_output.deserialize_json(
...
def describe_scan_job(
    ...
    capo_backup.types.describe_scan_job_output.DescribeScanJobOutput, zapros.Response
]:
