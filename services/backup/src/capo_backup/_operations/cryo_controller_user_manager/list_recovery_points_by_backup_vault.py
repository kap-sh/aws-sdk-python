"""Generated from Smithy shape ``com.amazonaws.backup#ListRecoveryPointsByBackupVault``."""
...
import capo_backup.types.recovery_point_by_backup_vault_list
...
def handle_response(
    ...
    out: capo_backup.types.list_recovery_points_by_backup_vault_output.ListRecoveryPointsByBackupVaultOutput = capo_backup.types.list_recovery_points_by_backup_vault_output.deserialize_json(
