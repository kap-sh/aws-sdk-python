...
def handle_response(
    ...
    out: capo_backup.types.update_recovery_point_lifecycle_output.UpdateRecoveryPointLifecycleOutput = capo_backup.types.update_recovery_point_lifecycle_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.update_recovery_point_lifecycle_input.serialize_json(input_)
    ).encode()
