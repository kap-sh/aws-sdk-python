"""Generated from Smithy shape ``com.amazonaws.backup#UpdateReportPlan``."""
...
def handle_response(
    ...
    out: capo_backup.types.update_report_plan_output.UpdateReportPlanOutput = (
        capo_backup.types.update_report_plan_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.update_report_plan_input.serialize_json(input_)
    ).encode()
...
def update_report_plan(
    ...
    capo_backup.types.update_report_plan_output.UpdateReportPlanOutput, zapros.Response
]:
...
async def async_update_report_plan(
