"""Generated from Smithy shape ``com.amazonaws.backup#DescribeReportPlan``."""
...
def handle_response(
    ...
    out: capo_backup.types.describe_report_plan_output.DescribeReportPlanOutput = (
        capo_backup.types.describe_report_plan_output.deserialize_json(
...
async def async_describe_report_plan(
