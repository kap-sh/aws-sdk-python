"""Generated from Smithy shape ``com.amazonaws.backup#StartBackupJob``."""
...
def handle_response(
    ...
    out: capo_backup.types.start_backup_job_output.StartBackupJobOutput = (
        capo_backup.types.start_backup_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.start_backup_job_input.serialize_json(input_)
    ).encode()
...
def start_backup_job(
    ...
    capo_backup.types.start_backup_job_output.StartBackupJobOutput, zapros.Response
]:
...
async def async_start_backup_job(
