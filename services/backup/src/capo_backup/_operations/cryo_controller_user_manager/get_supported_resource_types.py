"""Generated from Smithy shape ``com.amazonaws.backup#GetSupportedResourceTypes``."""
...
def handle_response(
    ...
    out: capo_backup.types.get_supported_resource_types_output.GetSupportedResourceTypesOutput = capo_backup.types.get_supported_resource_types_output.deserialize_json(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/supported-resource-types"
    params: dict[str, str] = {}
...
async def async_get_supported_resource_types(
