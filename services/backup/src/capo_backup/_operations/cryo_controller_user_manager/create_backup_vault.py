"""Generated from Smithy shape ``com.amazonaws.backup#CreateBackupVault``."""
...
def handle_response(
    ...
    out: capo_backup.types.create_backup_vault_output.CreateBackupVaultOutput = (
        capo_backup.types.create_backup_vault_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/backup-vaults/{BackupVaultName}"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.create_backup_vault_input.serialize_json(input_)
    ).encode()
...
async def async_create_backup_vault(
