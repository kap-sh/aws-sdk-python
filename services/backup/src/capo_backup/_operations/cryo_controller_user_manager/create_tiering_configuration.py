...
def handle_response(
    ...
    out: capo_backup.types.create_tiering_configuration_output.CreateTieringConfigurationOutput = capo_backup.types.create_tiering_configuration_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.create_tiering_configuration_input.serialize_json(input_)
    ).encode()
