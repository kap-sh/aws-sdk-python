"""Generated from Smithy shape ``com.amazonaws.backup#DescribeRestoreJob``."""
...
import capo_backup.errors.dependency_failure_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DependencyFailureException":
            raise capo_backup.errors.dependency_failure_exception.DependencyFailureException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_backup.types.describe_restore_job_output.DescribeRestoreJobOutput = (
        capo_backup.types.describe_restore_job_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/restore-jobs/{RestoreJobId}"
...
async def async_describe_restore_job(
