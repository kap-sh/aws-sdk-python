"""Generated from Smithy shape ``com.amazonaws.backup#ExportBackupPlanTemplate``."""
...
def handle_response(
    ...
    out: capo_backup.types.export_backup_plan_template_output.ExportBackupPlanTemplateOutput = capo_backup.types.export_backup_plan_template_output.deserialize_json(
