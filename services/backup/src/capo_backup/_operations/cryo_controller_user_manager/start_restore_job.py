"""Generated from Smithy shape ``com.amazonaws.backup#StartRestoreJob``."""
...
def handle_response(
    ...
    out: capo_backup.types.start_restore_job_output.StartRestoreJobOutput = (
        capo_backup.types.start_restore_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.start_restore_job_input.serialize_json(input_)
    ).encode()
...
def start_restore_job(
    ...
    capo_backup.types.start_restore_job_output.StartRestoreJobOutput, zapros.Response
]:
...
async def async_start_restore_job(
