"""Generated from Smithy shape ``com.amazonaws.backup#ListReportPlans``."""
...
import capo_backup.types.report_plan_list
...
def handle_response(
    ...
    out: capo_backup.types.list_report_plans_output.ListReportPlansOutput = (
        capo_backup.types.list_report_plans_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/audit/report-plans"
    params: dict[str, str] = {}
...
def list_report_plans(
    ...
    capo_backup.types.list_report_plans_output.ListReportPlansOutput, zapros.Response
]:
...
async def async_list_report_plans(
