"""Generated from Smithy shape ``com.amazonaws.backup#ListRestoreTestingSelections``."""
...
import capo_backup.types.restore_testing_selections
...
def handle_response(
    ...
    out: capo_backup.types.list_restore_testing_selections_output.ListRestoreTestingSelectionsOutput = capo_backup.types.list_restore_testing_selections_output.deserialize_json(
