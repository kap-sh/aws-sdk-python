"""Generated from Smithy shape ``com.amazonaws.backup#ListRecoveryPointsByLegalHold``."""
...
def handle_response(
    ...
    out: capo_backup.types.list_recovery_points_by_legal_hold_output.ListRecoveryPointsByLegalHoldOutput = capo_backup.types.list_recovery_points_by_legal_hold_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/legal-holds/{LegalHoldId}/recovery-points"
...
async def async_list_recovery_points_by_legal_hold(
