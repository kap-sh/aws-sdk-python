"""Generated from Smithy shape ``com.amazonaws.backup#ListLegalHolds``."""
...
def handle_response(
    ...
    out: capo_backup.types.list_legal_holds_output.ListLegalHoldsOutput = (
        capo_backup.types.list_legal_holds_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/legal-holds"
    params: dict[str, str] = {}
...
def list_legal_holds(
    ...
    capo_backup.types.list_legal_holds_output.ListLegalHoldsOutput, zapros.Response
]:
...
async def async_list_legal_holds(
