"""Generated from Smithy shape ``com.amazonaws.backup#GetRestoreTestingInferredMetadata``."""
...
def handle_response(
    ...
    out: capo_backup.types.get_restore_testing_inferred_metadata_output.GetRestoreTestingInferredMetadataOutput = capo_backup.types.get_restore_testing_inferred_metadata_output.deserialize_json(
