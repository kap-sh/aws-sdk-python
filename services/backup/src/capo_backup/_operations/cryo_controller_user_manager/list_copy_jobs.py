...
def handle_response(
    ...
    out: capo_backup.types.list_copy_jobs_output.ListCopyJobsOutput = (
        capo_backup.types.list_copy_jobs_output.deserialize_json(
...
def list_copy_jobs(
    ...
    input_: capo_backup.types.list_copy_jobs_input.ListCopyJobsInput,
) -> tuple[capo_backup.types.list_copy_jobs_output.ListCopyJobsOutput, zapros.Response]:
