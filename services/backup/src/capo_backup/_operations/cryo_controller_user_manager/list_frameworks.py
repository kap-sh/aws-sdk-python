"""Generated from Smithy shape ``com.amazonaws.backup#ListFrameworks``."""
...
def handle_response(
    ...
    out: capo_backup.types.list_frameworks_output.ListFrameworksOutput = (
        capo_backup.types.list_frameworks_output.deserialize_json(
...
def list_frameworks(
    ...
    capo_backup.types.list_frameworks_output.ListFrameworksOutput, zapros.Response
]:
...
async def async_list_frameworks(
