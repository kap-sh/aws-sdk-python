...
def handle_response(
    ...
    out: capo_backup.types.update_restore_testing_plan_output.UpdateRestoreTestingPlanOutput = capo_backup.types.update_restore_testing_plan_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.update_restore_testing_plan_input.serialize_json(input_)
    ).encode()
