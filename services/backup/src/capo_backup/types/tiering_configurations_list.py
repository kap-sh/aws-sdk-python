...
TieringConfigurationsList: TypeAlias = list[
    "capo_backup.types.tiering_configurations_list_member.TieringConfigurationsListMember"
]
...
def serialize_json(value: TieringConfigurationsList) -> list:
    ...
    for item in value:
        out.append(
            capo_backup.types.tiering_configurations_list_member.serialize_json(item)
        )
    return out
