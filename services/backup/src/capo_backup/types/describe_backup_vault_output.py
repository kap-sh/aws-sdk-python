...
class DescribeBackupVaultOutput(TypedDict, closed=True):
    backup_vault_name: NotRequired["capo_backup.types.string.string"]
    ...
    mpa_approval_team_arn: NotRequired["capo_backup.types.arn.ARN"]
    ...
    latest_mpa_approval_team_update: NotRequired[
        "capo_backup.types.latest_mpa_approval_team_update.LatestMpaApprovalTeamUpdate"
    ]
...
def serialize_json(value: DescribeBackupVaultOutput) -> dict:
    ...
    if "latest_mpa_approval_team_update" in value:
        ...
        out["LatestMpaApprovalTeamUpdate"] = (
            capo_backup.types.latest_mpa_approval_team_update.serialize_json(
...
def deserialize_json(data: dict) -> DescribeBackupVaultOutput:
    ...
    if "LatestMpaApprovalTeamUpdate" in data:
        ...
        out["latest_mpa_approval_team_update"] = (
            capo_backup.types.latest_mpa_approval_team_update.deserialize_json(
