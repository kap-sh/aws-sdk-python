...
class ReportJob(TypedDict, closed=True):
    report_job_id: NotRequired["capo_backup.types.report_job_id.ReportJobId"]
    ...
    report_template: NotRequired["capo_backup.types.string.string"]
    ...
    completion_time: NotRequired["capo_backup.types.timestamp.timestamp"]
    ...
    status: NotRequired["capo_backup.types.string.string"]
    ...
    report_destination: NotRequired[
        "capo_backup.types.report_destination.ReportDestination"
    ]
...
def serialize_json(value: ReportJob) -> dict:
    ...
    if "completion_time" in value:
        ...
        out["CompletionTime"] = capo_backup.types.timestamp.serialize_json(
    ...
    if "report_destination" in value:
        ...
        out["ReportDestination"] = capo_backup.types.report_destination.serialize_json(
...
def deserialize_json(data: dict) -> ReportJob:
    ...
    if "ReportDestination" in data:
        ...
        out["report_destination"] = (
            capo_backup.types.report_destination.deserialize_json(
