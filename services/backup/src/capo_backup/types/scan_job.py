...
class ScanJob(TypedDict, closed=True):
    account_id: "str"
    ...
    created_by: "capo_backup.types.scan_job_creator.ScanJobCreator"
    ...
    resource_type: "capo_backup.types.scan_resource_type.ScanResourceType"
    ...
    scan_result: NotRequired["capo_backup.types.scan_result_info.ScanResultInfo"]
    ...
    state: NotRequired["capo_backup.types.scan_state.ScanState"]
...
def serialize_json(value: ScanJob) -> dict:
    ...
    if "completion_date" in value:
        ...
        out["CompletionDate"] = capo_backup.types._prelude.timestamp.serialize_json(
    ...
    out["CreatedBy"] = capo_backup.types.scan_job_creator.serialize_json(
        value["created_by"]
    )
    import capo_backup.types._prelude.timestamp
    ...
    out["ResourceType"] = capo_backup.types.scan_resource_type.serialize_json(
        value["resource_type"]
    )
    ...
    if "scan_result" in value:
        ...
        out["ScanResult"] = capo_backup.types.scan_result_info.serialize_json(
            value["scan_result"]
        )
    ...
    if "state" in value:
        ...
        out["State"] = capo_backup.types.scan_state.serialize_json(value["state"])
