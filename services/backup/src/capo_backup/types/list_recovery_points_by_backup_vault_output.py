...
class ListRecoveryPointsByBackupVaultOutput(TypedDict, closed=True):
    ...
    recovery_points: NotRequired[
        "capo_backup.types.recovery_point_by_backup_vault_list.RecoveryPointByBackupVaultList"
    ]
...
def serialize_json(value: ListRecoveryPointsByBackupVaultOutput) -> dict:
    ...
    if "recovery_points" in value:
        ...
        out["RecoveryPoints"] = (
            capo_backup.types.recovery_point_by_backup_vault_list.serialize_json(
...
def deserialize_json(data: dict) -> ListRecoveryPointsByBackupVaultOutput:
    ...
    if "RecoveryPoints" in data:
        ...
        out["recovery_points"] = (
            capo_backup.types.recovery_point_by_backup_vault_list.deserialize_json(
                data["RecoveryPoints"]
            )
        )
    return out
