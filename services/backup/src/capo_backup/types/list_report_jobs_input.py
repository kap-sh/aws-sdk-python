...
class ListReportJobsInput(TypedDict, closed=True):
    ...
    by_creation_before: NotRequired["capo_backup.types.timestamp.timestamp"]
    ...
    by_creation_after: NotRequired["capo_backup.types.timestamp.timestamp"]
    ...
    by_status: NotRequired["capo_backup.types.string.string"]
