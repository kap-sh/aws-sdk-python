...
class GetLegalHoldOutput(TypedDict, closed=True):
    ...
    cancel_description: NotRequired["capo_backup.types.string.string"]
    ...
    retain_record_until: NotRequired["capo_backup.types.timestamp.timestamp"]
...
def serialize_json(value: GetLegalHoldOutput) -> dict:
    ...
    if "retain_record_until" in value:
        ...
        out["RetainRecordUntil"] = capo_backup.types.timestamp.serialize_json(
    ...
    if "recovery_point_selection" in value:
        ...
        out["RecoveryPointSelection"] = (
            capo_backup.types.recovery_point_selection.serialize_json(
...
def deserialize_json(data: dict) -> GetLegalHoldOutput:
    ...
    if "RetainRecordUntil" in data:
        ...
        out["retain_record_until"] = capo_backup.types.timestamp.deserialize_json(
    ...
    if "RecoveryPointSelection" in data:
        ...
        out["recovery_point_selection"] = (
            capo_backup.types.recovery_point_selection.deserialize_json(
