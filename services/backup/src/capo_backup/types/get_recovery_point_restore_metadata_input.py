"""Generated from Smithy shape ``com.amazonaws.backup#GetRecoveryPointRestoreMetadataInput``."""
...
class GetRecoveryPointRestoreMetadataInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetRecoveryPointRestoreMetadataInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetRecoveryPointRestoreMetadataInput:
    out: GetRecoveryPointRestoreMetadataInput = {}  # type: ignore[typeddict-item]
    return out
