...
from capo_backup._auth._identity import Credentials
from capo_backup._auth._providers import (
    CredentialsProvider,
    IdentityProvider,
    StaticAwsCredentialsProvider,
    default_aws_credentials_chain,
)
from capo_backup._auth._zapros_handler import AuthMiddleware
from capo_backup._pagination import resolve_path as _resolve_path
from capo_backup._services._aws_config import aaws_config
...
if TYPE_CHECKING:
    ...
    import capo_backup.types.associate_backup_vault_mpa_approval_team_input
    ...
    import capo_backup.types.backup_selections_list_member
    ...
    import capo_backup.types.cancel_legal_hold_input
    import capo_backup.types.cancel_legal_hold_output
    ...
    import capo_backup.types.create_backup_selection_output
    import capo_backup.types.create_backup_vault_input
    import capo_backup.types.create_backup_vault_output
    import capo_backup.types.create_framework_input
    import capo_backup.types.create_framework_output
    import capo_backup.types.create_legal_hold_input
    import capo_backup.types.create_legal_hold_output
    import capo_backup.types.create_logically_air_gapped_backup_vault_input
    import capo_backup.types.create_logically_air_gapped_backup_vault_output
    import capo_backup.types.create_report_plan_input
    import capo_backup.types.create_report_plan_output
    import capo_backup.types.create_restore_access_backup_vault_input
    import capo_backup.types.create_restore_access_backup_vault_output
    import capo_backup.types.create_restore_testing_plan_input
    import capo_backup.types.create_restore_testing_plan_output
    import capo_backup.types.create_restore_testing_selection_input
    import capo_backup.types.create_restore_testing_selection_output
    ...
    import capo_backup.types.delete_backup_vault_access_policy_input
    import capo_backup.types.delete_backup_vault_input
    import capo_backup.types.delete_backup_vault_lock_configuration_input
    import capo_backup.types.delete_backup_vault_notifications_input
    import capo_backup.types.delete_framework_input
    import capo_backup.types.delete_recovery_point_input
    import capo_backup.types.delete_report_plan_input
    import capo_backup.types.delete_restore_testing_plan_input
    ...
    import capo_backup.types.describe_backup_vault_output
    import capo_backup.types.describe_copy_job_input
    import capo_backup.types.describe_copy_job_output
    import capo_backup.types.describe_framework_input
    import capo_backup.types.describe_framework_output
    import capo_backup.types.describe_global_settings_input
    import capo_backup.types.describe_global_settings_output
    import capo_backup.types.describe_protected_resource_input
    import capo_backup.types.describe_protected_resource_output
    import capo_backup.types.describe_recovery_point_input
    import capo_backup.types.describe_recovery_point_output
    import capo_backup.types.describe_region_settings_input
    import capo_backup.types.describe_region_settings_output
    import capo_backup.types.describe_report_job_input
    import capo_backup.types.describe_report_job_output
    import capo_backup.types.describe_report_plan_input
    import capo_backup.types.describe_report_plan_output
    import capo_backup.types.describe_restore_job_input
    import capo_backup.types.describe_restore_job_output
    import capo_backup.types.describe_scan_job_input
    import capo_backup.types.describe_scan_job_output
    import capo_backup.types.disassociate_backup_vault_mpa_approval_team_input
    import capo_backup.types.disassociate_recovery_point_from_parent_input
    import capo_backup.types.disassociate_recovery_point_input
    import capo_backup.types.export_backup_plan_template_input
    import capo_backup.types.export_backup_plan_template_output
    ...
    import capo_backup.types.get_backup_plan_from_json_input
    import capo_backup.types.get_backup_plan_from_json_output
    import capo_backup.types.get_backup_plan_from_template_input
    import capo_backup.types.get_backup_plan_from_template_output
    import capo_backup.types.get_backup_plan_input
    import capo_backup.types.get_backup_plan_output
    import capo_backup.types.get_backup_selection_input
    import capo_backup.types.get_backup_selection_output
    import capo_backup.types.get_backup_vault_access_policy_input
    import capo_backup.types.get_backup_vault_access_policy_output
    import capo_backup.types.get_backup_vault_notifications_input
    import capo_backup.types.get_backup_vault_notifications_output
    import capo_backup.types.get_legal_hold_input
    import capo_backup.types.get_legal_hold_output
    import capo_backup.types.get_pitr_malware_scan_results_input
    import capo_backup.types.get_pitr_malware_scan_results_output
    import capo_backup.types.get_recovery_point_index_details_input
    import capo_backup.types.get_recovery_point_index_details_output
    import capo_backup.types.get_recovery_point_restore_metadata_input
    import capo_backup.types.get_recovery_point_restore_metadata_output
    import capo_backup.types.get_restore_job_metadata_input
    import capo_backup.types.get_restore_job_metadata_output
    import capo_backup.types.get_restore_testing_inferred_metadata_input
    import capo_backup.types.get_restore_testing_inferred_metadata_output
    import capo_backup.types.get_restore_testing_plan_input
    import capo_backup.types.get_restore_testing_plan_output
    import capo_backup.types.get_restore_testing_selection_input
    import capo_backup.types.get_restore_testing_selection_output
    import capo_backup.types.get_supported_resource_types_output
    import capo_backup.types.get_tiering_configuration_input
    import capo_backup.types.get_tiering_configuration_output
    ...
    import capo_backup.types.list_backup_plan_templates_input
    import capo_backup.types.list_backup_plan_templates_output
    import capo_backup.types.list_backup_plan_versions_input
    import capo_backup.types.list_backup_plan_versions_output
    import capo_backup.types.list_backup_plans_input
    import capo_backup.types.list_backup_plans_output
    import capo_backup.types.list_backup_selections_input
    import capo_backup.types.list_backup_selections_output
    import capo_backup.types.list_backup_vaults_input
    import capo_backup.types.list_backup_vaults_output
    import capo_backup.types.list_copy_job_summaries_input
    import capo_backup.types.list_copy_job_summaries_output
    import capo_backup.types.list_copy_jobs_input
    import capo_backup.types.list_copy_jobs_output
    import capo_backup.types.list_frameworks_input
    import capo_backup.types.list_frameworks_output
    import capo_backup.types.list_indexed_recovery_points_input
    import capo_backup.types.list_indexed_recovery_points_output
    import capo_backup.types.list_legal_holds_input
    import capo_backup.types.list_legal_holds_output
    import capo_backup.types.list_protected_resources_by_backup_vault_input
    import capo_backup.types.list_protected_resources_by_backup_vault_output
    import capo_backup.types.list_protected_resources_input
    import capo_backup.types.list_protected_resources_output
    import capo_backup.types.list_recovery_points_by_backup_vault_input
    import capo_backup.types.list_recovery_points_by_backup_vault_output
    import capo_backup.types.list_recovery_points_by_legal_hold_input
    import capo_backup.types.list_recovery_points_by_legal_hold_output
    import capo_backup.types.list_recovery_points_by_resource_input
    import capo_backup.types.list_recovery_points_by_resource_output
    import capo_backup.types.list_report_jobs_input
    import capo_backup.types.list_report_jobs_output
    import capo_backup.types.list_report_plans_input
    import capo_backup.types.list_report_plans_output
    ...
    import capo_backup.types.list_restore_job_summaries_input
    import capo_backup.types.list_restore_job_summaries_output
    import capo_backup.types.list_restore_jobs_by_protected_resource_input
    import capo_backup.types.list_restore_jobs_by_protected_resource_output
    import capo_backup.types.list_restore_jobs_input
    import capo_backup.types.list_restore_jobs_output
    import capo_backup.types.list_restore_testing_plans_input
    import capo_backup.types.list_restore_testing_plans_input_max_results_integer
    import capo_backup.types.list_restore_testing_plans_output
    import capo_backup.types.list_restore_testing_selections_input
    import capo_backup.types.list_restore_testing_selections_input_max_results_integer
    import capo_backup.types.list_restore_testing_selections_output
    ...
    import capo_backup.types.list_scan_jobs_output
    import capo_backup.types.list_tags_input
    import capo_backup.types.list_tags_output
    import capo_backup.types.list_tiering_configurations_input
    import capo_backup.types.list_tiering_configurations_output
    import capo_backup.types.long
    import capo_backup.types.malware_scanner
    import capo_backup.types.max_framework_inputs
    import capo_backup.types.max_results
    import capo_backup.types.max_scheduled_runs_preview
    ...
    import capo_backup.types.start_backup_job_input
    import capo_backup.types.start_backup_job_output
    import capo_backup.types.start_copy_job_input
    import capo_backup.types.start_copy_job_output
    import capo_backup.types.start_report_job_input
    import capo_backup.types.start_report_job_output
    import capo_backup.types.start_restore_job_input
    import capo_backup.types.start_restore_job_output
    import capo_backup.types.start_scan_job_input
    import capo_backup.types.start_scan_job_output
    import capo_backup.types.stop_backup_job_input
    ...
    import capo_backup.types.tiering_configurations_list_member
    import capo_backup.types.timestamp
    import capo_backup.types.untag_resource_input
    import capo_backup.types.update_backup_plan_input
    import capo_backup.types.update_backup_plan_output
    import capo_backup.types.update_framework_input
    import capo_backup.types.update_framework_output
    import capo_backup.types.update_global_settings_input
    ...
    import capo_backup.types.update_recovery_point_lifecycle_input
    import capo_backup.types.update_recovery_point_lifecycle_output
    import capo_backup.types.update_region_settings_input
    import capo_backup.types.update_report_plan_input
    import capo_backup.types.update_report_plan_output
    import capo_backup.types.update_restore_testing_plan_input
    import capo_backup.types.update_restore_testing_plan_output
    import capo_backup.types.update_restore_testing_selection_input
    import capo_backup.types.update_restore_testing_selection_output
    import capo_backup.types.update_tiering_configuration_input
    import capo_backup.types.update_tiering_configuration_output
    import capo_backup.types.vault_type
    import capo_backup.types.window_minutes


class AsyncBackupClientConfig(TypedDict, total=False, closed=True):
...
class AsyncBackupClient:
    ...
    async def associate_backup_vault_mpa_approval_team(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.associate_backup_vault_mpa_approval_team_input.AssociateBackupVaultMpaApprovalTeamInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.associate_backup_vault_mpa_approval_team

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.associate_backup_vault_mpa_approval_team.async_associate_backup_vault_mpa_approval_team(
    ...
    async def cancel_legal_hold(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        retain_record_in_days: Optional["capo_backup.types.long.Long"] = None,
    ) -> "capo_backup.types.cancel_legal_hold_output.CancelLegalHoldOutput":
        ...
        Raises:
            capo_backup.errors.invalid_parameter_value_exception.InvalidParameterValueException: <p>Indicates that something is wrong with a parameter's value. For example, the value is out of range.</p>
            capo_backup.errors.invalid_resource_state_exception.InvalidResourceStateException: <p>Backup is already performing an action on this recovery point. It can't perform the action you requested until the first action finishes. Try again later.</p>
            capo_backup.errors.missing_parameter_value_exception.MissingParameterValueException: <p>Indicates that a required parameter is missing.</p>
            capo_backup.errors.resource_not_found_exception.ResourceNotFoundException: <p>A resource that is required for the action doesn't exist.</p>
            capo_backup.errors.service_unavailable_exception.ServiceUnavailableException: <p>The request failed due to a temporary failure of the server.</p>
            capo_backup.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.cancel_legal_hold_input.CancelLegalHoldInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.cancel_legal_hold_output.CancelLegalHoldOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.cancel_legal_hold

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.cancel_legal_hold.async_cancel_legal_hold(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_backup_plan(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        backup_plan_tags: Optional["capo_backup.types.tags.Tags"] = None,
        creator_request_id: Optional["capo_backup.types.string.string"] = None,
    ) -> "capo_backup.types.create_backup_plan_output.CreateBackupPlanOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.create_backup_plan_input.CreateBackupPlanInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.create_backup_plan_output.CreateBackupPlanOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.create_backup_plan

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.create_backup_plan.async_create_backup_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_backup_selection(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        creator_request_id: Optional["capo_backup.types.string.string"] = None,
    ) -> "capo_backup.types.create_backup_selection_output.CreateBackupSelectionOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.create_backup_selection_input.CreateBackupSelectionInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.create_backup_selection_output.CreateBackupSelectionOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.create_backup_selection

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.create_backup_selection.async_create_backup_selection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_backup_vault(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        backup_vault_tags: Optional["capo_backup.types.tags.Tags"] = None,
        encryption_key_arn: Optional["capo_backup.types.arn.ARN"] = None,
        creator_request_id: Optional["capo_backup.types.string.string"] = None,
    ) -> "capo_backup.types.create_backup_vault_output.CreateBackupVaultOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.create_backup_vault_input.CreateBackupVaultInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.create_backup_vault_output.CreateBackupVaultOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.create_backup_vault

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.create_backup_vault.async_create_backup_vault(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_framework(
        ...
        *,
        ...
        idempotency_token: Optional["capo_backup.types.string.string"] = None,
        framework_tags: Optional["capo_backup.types.string_map.stringMap"] = None,
    ) -> "capo_backup.types.create_framework_output.CreateFrameworkOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.create_framework_input.CreateFrameworkInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.create_framework_output.CreateFrameworkOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.create_framework

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.create_framework.async_create_framework(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_legal_hold(
        self,
        title: "capo_backup.types.string.string",
        description: "capo_backup.types.string.string",
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        idempotency_token: Optional["capo_backup.types.string.string"] = None,
        recovery_point_selection: Optional[
            "capo_backup.types.recovery_point_selection.RecoveryPointSelection"
        ] = None,
        tags: Optional["capo_backup.types.tags.Tags"] = None,
    ) -> "capo_backup.types.create_legal_hold_output.CreateLegalHoldOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.create_legal_hold_input.CreateLegalHoldInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.create_legal_hold_output.CreateLegalHoldOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.create_legal_hold

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.create_legal_hold.async_create_legal_hold(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_logically_air_gapped_backup_vault(
        self,
        backup_vault_name: "capo_backup.types.backup_vault_name.BackupVaultName",
        min_retention_days: "capo_backup.types.long.Long",
        max_retention_days: "capo_backup.types.long.Long",
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        backup_vault_tags: Optional["capo_backup.types.tags.Tags"] = None,
        creator_request_id: Optional["capo_backup.types.string.string"] = None,
        encryption_key_arn: Optional["capo_backup.types.arn.ARN"] = None,
    ) -> "capo_backup.types.create_logically_air_gapped_backup_vault_output.CreateLogicallyAirGappedBackupVaultOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.create_logically_air_gapped_backup_vault_input.CreateLogicallyAirGappedBackupVaultInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.create_logically_air_gapped_backup_vault_output.CreateLogicallyAirGappedBackupVaultOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.create_logically_air_gapped_backup_vault

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.create_logically_air_gapped_backup_vault.async_create_logically_air_gapped_backup_vault(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_report_plan(
        self,
        report_plan_name: "capo_backup.types.report_plan_name.ReportPlanName",
        report_delivery_channel: "capo_backup.types.report_delivery_channel.ReportDeliveryChannel",
        report_setting: "capo_backup.types.report_setting.ReportSetting",
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        report_plan_description: Optional[
            "capo_backup.types.report_plan_description.ReportPlanDescription"
        ] = None,
        report_plan_tags: Optional["capo_backup.types.string_map.stringMap"] = None,
        idempotency_token: Optional["capo_backup.types.string.string"] = None,
    ) -> "capo_backup.types.create_report_plan_output.CreateReportPlanOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.create_report_plan_input.CreateReportPlanInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.create_report_plan_output.CreateReportPlanOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.create_report_plan

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.create_report_plan.async_create_report_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_restore_access_backup_vault(
        self,
        source_backup_vault_arn: "capo_backup.types.arn.ARN",
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ...
    ) -> "capo_backup.types.create_restore_access_backup_vault_output.CreateRestoreAccessBackupVaultOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.create_restore_access_backup_vault_input.CreateRestoreAccessBackupVaultInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.create_restore_access_backup_vault_output.CreateRestoreAccessBackupVaultOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.create_restore_access_backup_vault

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.create_restore_access_backup_vault.async_create_restore_access_backup_vault(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_restore_testing_plan(
        self,
        restore_testing_plan: "capo_backup.types.restore_testing_plan_for_create.RestoreTestingPlanForCreate",
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ...
    ) -> "capo_backup.types.create_restore_testing_plan_output.CreateRestoreTestingPlanOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.create_restore_testing_plan_input.CreateRestoreTestingPlanInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.create_restore_testing_plan_output.CreateRestoreTestingPlanOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.create_restore_testing_plan

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.create_restore_testing_plan.async_create_restore_testing_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_restore_testing_selection(
        ...
        restore_testing_selection: "capo_backup.types.restore_testing_selection_for_create.RestoreTestingSelectionForCreate",
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        creator_request_id: Optional[str] = None,
    ) -> "capo_backup.types.create_restore_testing_selection_output.CreateRestoreTestingSelectionOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.create_restore_testing_selection_input.CreateRestoreTestingSelectionInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.create_restore_testing_selection_output.CreateRestoreTestingSelectionOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.create_restore_testing_selection

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.create_restore_testing_selection.async_create_restore_testing_selection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_tiering_configuration(
        self,
        tiering_configuration: "capo_backup.types.tiering_configuration_input_for_create.TieringConfigurationInputForCreate",
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        tiering_configuration_tags: Optional["capo_backup.types.tags.Tags"] = None,
        creator_request_id: Optional[
            "capo_backup.types.creator_request_id.CreatorRequestId"
        ] = None,
    ) -> "capo_backup.types.create_tiering_configuration_output.CreateTieringConfigurationOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.create_tiering_configuration_input.CreateTieringConfigurationInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.create_tiering_configuration_output.CreateTieringConfigurationOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.create_tiering_configuration

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.create_tiering_configuration.async_create_tiering_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_backup_plan(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.delete_backup_plan_output.DeleteBackupPlanOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.delete_backup_plan_input.DeleteBackupPlanInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.delete_backup_plan_output.DeleteBackupPlanOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.delete_backup_plan

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.delete_backup_plan.async_delete_backup_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_backup_selection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.delete_backup_selection_input.DeleteBackupSelectionInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.delete_backup_selection

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.delete_backup_selection.async_delete_backup_selection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_backup_vault(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.delete_backup_vault_input.DeleteBackupVaultInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.delete_backup_vault

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.delete_backup_vault.async_delete_backup_vault(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_backup_vault_access_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.delete_backup_vault_access_policy_input.DeleteBackupVaultAccessPolicyInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.delete_backup_vault_access_policy

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.delete_backup_vault_access_policy.async_delete_backup_vault_access_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_backup_vault_lock_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.delete_backup_vault_lock_configuration_input.DeleteBackupVaultLockConfigurationInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.delete_backup_vault_lock_configuration

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.delete_backup_vault_lock_configuration.async_delete_backup_vault_lock_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_backup_vault_notifications(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.delete_backup_vault_notifications_input.DeleteBackupVaultNotificationsInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.delete_backup_vault_notifications

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.delete_backup_vault_notifications.async_delete_backup_vault_notifications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_framework(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.delete_framework_input.DeleteFrameworkInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.delete_framework

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.delete_framework.async_delete_framework(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_recovery_point(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.delete_recovery_point_input.DeleteRecoveryPointInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.delete_recovery_point

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.delete_recovery_point.async_delete_recovery_point(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_report_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.delete_report_plan_input.DeleteReportPlanInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.delete_report_plan

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.delete_report_plan.async_delete_report_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_restore_testing_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.delete_restore_testing_plan_input.DeleteRestoreTestingPlanInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.delete_restore_testing_plan

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.delete_restore_testing_plan.async_delete_restore_testing_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_restore_testing_selection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.delete_restore_testing_selection_input.DeleteRestoreTestingSelectionInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.delete_restore_testing_selection

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.delete_restore_testing_selection.async_delete_restore_testing_selection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_tiering_configuration(
        self,
        tiering_configuration_name: "capo_backup.types.tiering_configuration_name.TieringConfigurationName",
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.delete_tiering_configuration_output.DeleteTieringConfigurationOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.delete_tiering_configuration_input.DeleteTieringConfigurationInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.delete_tiering_configuration_output.DeleteTieringConfigurationOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.delete_tiering_configuration

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.delete_tiering_configuration.async_delete_tiering_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_backup_job(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.describe_backup_job_output.DescribeBackupJobOutput":
        ...
        Raises:
            capo_backup.errors.dependency_failure_exception.DependencyFailureException: <p>A dependent Amazon Web Services service or resource returned an error to the Backup service, and the action cannot be completed.</p>
            capo_backup.errors.invalid_parameter_value_exception.InvalidParameterValueException: <p>Indicates that something is wrong with a parameter's value. For example, the value is out of range.</p>
            capo_backup.errors.missing_parameter_value_exception.MissingParameterValueException: <p>Indicates that a required parameter is missing.</p>
            capo_backup.errors.resource_not_found_exception.ResourceNotFoundException: <p>A resource that is required for the action doesn't exist.</p>
            capo_backup.errors.service_unavailable_exception.ServiceUnavailableException: <p>The request failed due to a temporary failure of the server.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.describe_backup_job_input.DescribeBackupJobInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.describe_backup_job_output.DescribeBackupJobOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.describe_backup_job

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.describe_backup_job.async_describe_backup_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_backup_vault(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        backup_vault_account_id: Optional["capo_backup.types.string.string"] = None,
    ) -> "capo_backup.types.describe_backup_vault_output.DescribeBackupVaultOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.describe_backup_vault_input.DescribeBackupVaultInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.describe_backup_vault_output.DescribeBackupVaultOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.describe_backup_vault

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.describe_backup_vault.async_describe_backup_vault(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_copy_job(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.describe_copy_job_output.DescribeCopyJobOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.describe_copy_job_input.DescribeCopyJobInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.describe_copy_job_output.DescribeCopyJobOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.describe_copy_job

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.describe_copy_job.async_describe_copy_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_framework(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.describe_framework_output.DescribeFrameworkOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.describe_framework_input.DescribeFrameworkInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.describe_framework_output.DescribeFrameworkOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.describe_framework

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.describe_framework.async_describe_framework(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_global_settings(
        ...
        "capo_backup.types.describe_global_settings_output.DescribeGlobalSettingsOutput"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.describe_global_settings_input.DescribeGlobalSettingsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.describe_global_settings_output.DescribeGlobalSettingsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.describe_global_settings

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.describe_global_settings.async_describe_global_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_protected_resource(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.describe_protected_resource_output.DescribeProtectedResourceOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.describe_protected_resource_input.DescribeProtectedResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.describe_protected_resource_output.DescribeProtectedResourceOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.describe_protected_resource

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.describe_protected_resource.async_describe_protected_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_recovery_point(
        ...
        *,
        ...
        backup_vault_account_id: Optional[
            "capo_backup.types.account_id.AccountId"
        ] = None,
    ) -> "capo_backup.types.describe_recovery_point_output.DescribeRecoveryPointOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.describe_recovery_point_input.DescribeRecoveryPointInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.describe_recovery_point_output.DescribeRecoveryPointOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.describe_recovery_point

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.describe_recovery_point.async_describe_recovery_point(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_region_settings(
        ...
        "capo_backup.types.describe_region_settings_output.DescribeRegionSettingsOutput"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.describe_region_settings_input.DescribeRegionSettingsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.describe_region_settings_output.DescribeRegionSettingsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.describe_region_settings

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.describe_region_settings.async_describe_region_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_report_job(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.describe_report_job_output.DescribeReportJobOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.describe_report_job_input.DescribeReportJobInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.describe_report_job_output.DescribeReportJobOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.describe_report_job

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.describe_report_job.async_describe_report_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_report_plan(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.describe_report_plan_output.DescribeReportPlanOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.describe_report_plan_input.DescribeReportPlanInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.describe_report_plan_output.DescribeReportPlanOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.describe_report_plan

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.describe_report_plan.async_describe_report_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_restore_job(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.describe_restore_job_output.DescribeRestoreJobOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.describe_restore_job_input.DescribeRestoreJobInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.describe_restore_job_output.DescribeRestoreJobOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.describe_restore_job

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.describe_restore_job.async_describe_restore_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_scan_job(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.describe_scan_job_output.DescribeScanJobOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.describe_scan_job_input.DescribeScanJobInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.describe_scan_job_output.DescribeScanJobOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.describe_scan_job

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.describe_scan_job.async_describe_scan_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_backup_vault_mpa_approval_team(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.disassociate_backup_vault_mpa_approval_team_input.DisassociateBackupVaultMpaApprovalTeamInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.disassociate_backup_vault_mpa_approval_team

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.disassociate_backup_vault_mpa_approval_team.async_disassociate_backup_vault_mpa_approval_team(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_recovery_point(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.disassociate_recovery_point_input.DisassociateRecoveryPointInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.disassociate_recovery_point

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.disassociate_recovery_point.async_disassociate_recovery_point(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_recovery_point_from_parent(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.disassociate_recovery_point_from_parent_input.DisassociateRecoveryPointFromParentInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.disassociate_recovery_point_from_parent

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.disassociate_recovery_point_from_parent.async_disassociate_recovery_point_from_parent(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def export_backup_plan_template(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.export_backup_plan_template_output.ExportBackupPlanTemplateOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.export_backup_plan_template_input.ExportBackupPlanTemplateInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.export_backup_plan_template_output.ExportBackupPlanTemplateOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.export_backup_plan_template

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.export_backup_plan_template.async_export_backup_plan_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_backup_plan(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        version_id: Optional["capo_backup.types.string.string"] = None,
        max_scheduled_runs_preview: Optional[
            "capo_backup.types.max_scheduled_runs_preview.MaxScheduledRunsPreview"
        ] = None,
    ) -> "capo_backup.types.get_backup_plan_output.GetBackupPlanOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_backup_plan_input.GetBackupPlanInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_backup_plan_output.GetBackupPlanOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_backup_plan

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_backup_plan.async_get_backup_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_backup_plan_from_json(
        ...
        *,
        ...
        "capo_backup.types.get_backup_plan_from_json_output.GetBackupPlanFromJSONOutput"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_backup_plan_from_json_input.GetBackupPlanFromJSONInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_backup_plan_from_json_output.GetBackupPlanFromJSONOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_backup_plan_from_json

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_backup_plan_from_json.async_get_backup_plan_from_json(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_backup_plan_from_template(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.get_backup_plan_from_template_output.GetBackupPlanFromTemplateOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_backup_plan_from_template_input.GetBackupPlanFromTemplateInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_backup_plan_from_template_output.GetBackupPlanFromTemplateOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_backup_plan_from_template

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_backup_plan_from_template.async_get_backup_plan_from_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_backup_selection(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.get_backup_selection_output.GetBackupSelectionOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_backup_selection_input.GetBackupSelectionInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_backup_selection_output.GetBackupSelectionOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_backup_selection

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_backup_selection.async_get_backup_selection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_backup_vault_access_policy(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.get_backup_vault_access_policy_output.GetBackupVaultAccessPolicyOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_backup_vault_access_policy_input.GetBackupVaultAccessPolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_backup_vault_access_policy_output.GetBackupVaultAccessPolicyOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_backup_vault_access_policy

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_backup_vault_access_policy.async_get_backup_vault_access_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_backup_vault_notifications(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.get_backup_vault_notifications_output.GetBackupVaultNotificationsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_backup_vault_notifications_input.GetBackupVaultNotificationsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_backup_vault_notifications_output.GetBackupVaultNotificationsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_backup_vault_notifications

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_backup_vault_notifications.async_get_backup_vault_notifications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_legal_hold(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.get_legal_hold_output.GetLegalHoldOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_legal_hold_input.GetLegalHoldInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_legal_hold_output.GetLegalHoldOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_legal_hold

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_legal_hold.async_get_legal_hold(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_pitr_malware_scan_results(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.get_pitr_malware_scan_results_output.GetPITRMalwareScanResultsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_pitr_malware_scan_results_input.GetPITRMalwareScanResultsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_pitr_malware_scan_results_output.GetPITRMalwareScanResultsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_pitr_malware_scan_results

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_pitr_malware_scan_results.async_get_pitr_malware_scan_results(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_recovery_point_index_details(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.get_recovery_point_index_details_output.GetRecoveryPointIndexDetailsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_recovery_point_index_details_input.GetRecoveryPointIndexDetailsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_recovery_point_index_details_output.GetRecoveryPointIndexDetailsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_recovery_point_index_details

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_recovery_point_index_details.async_get_recovery_point_index_details(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_recovery_point_restore_metadata(
        ...
        *,
    ...
    ) -> "capo_backup.types.get_recovery_point_restore_metadata_output.GetRecoveryPointRestoreMetadataOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_recovery_point_restore_metadata_input.GetRecoveryPointRestoreMetadataInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_recovery_point_restore_metadata_output.GetRecoveryPointRestoreMetadataOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_recovery_point_restore_metadata

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_recovery_point_restore_metadata.async_get_recovery_point_restore_metadata(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_restore_job_metadata(
        ...
        *,
        ...
        "capo_backup.types.get_restore_job_metadata_output.GetRestoreJobMetadataOutput"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_restore_job_metadata_input.GetRestoreJobMetadataInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_restore_job_metadata_output.GetRestoreJobMetadataOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_restore_job_metadata

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_restore_job_metadata.async_get_restore_job_metadata(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_restore_testing_inferred_metadata(
        ...
        *,
    ...
    ) -> "capo_backup.types.get_restore_testing_inferred_metadata_output.GetRestoreTestingInferredMetadataOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_restore_testing_inferred_metadata_input.GetRestoreTestingInferredMetadataInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_restore_testing_inferred_metadata_output.GetRestoreTestingInferredMetadataOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_restore_testing_inferred_metadata

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_restore_testing_inferred_metadata.async_get_restore_testing_inferred_metadata(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_restore_testing_plan(
        ...
        *,
        ...
        "capo_backup.types.get_restore_testing_plan_output.GetRestoreTestingPlanOutput"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_restore_testing_plan_input.GetRestoreTestingPlanInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_restore_testing_plan_output.GetRestoreTestingPlanOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_restore_testing_plan

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_restore_testing_plan.async_get_restore_testing_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_restore_testing_selection(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.get_restore_testing_selection_output.GetRestoreTestingSelectionOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_restore_testing_selection_input.GetRestoreTestingSelectionInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_restore_testing_selection_output.GetRestoreTestingSelectionOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_restore_testing_selection

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_restore_testing_selection.async_get_restore_testing_selection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_supported_resource_types(
        self, *, config_overrides: Optional[AsyncBackupClientConfig] = None
    ) -> "capo_backup.types.get_supported_resource_types_output.GetSupportedResourceTypesOutput":
        ...
        async def _handler(
            ...
            import capo_backup._operations.cryo_controller_user_manager.get_supported_resource_types

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_supported_resource_types.async_get_supported_resource_types(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_tiering_configuration(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.get_tiering_configuration_output.GetTieringConfigurationOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.get_tiering_configuration_input.GetTieringConfigurationInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.get_tiering_configuration_output.GetTieringConfigurationOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.get_tiering_configuration

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.get_tiering_configuration.async_get_tiering_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_backup_jobs(
        ...
        *,
        ...
        by_resource_arn: Optional["capo_backup.types.arn.ARN"] = None,
        by_state: Optional["capo_backup.types.backup_job_state.BackupJobState"] = None,
        by_backup_vault_name: Optional[
            "capo_backup.types.backup_vault_name.BackupVaultName"
        ] = None,
        by_created_before: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_created_after: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_resource_type: Optional[
            "capo_backup.types.resource_type.ResourceType"
        ] = None,
        by_account_id: Optional["capo_backup.types.account_id.AccountId"] = None,
        by_complete_after: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_complete_before: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_parent_job_id: Optional["capo_backup.types.string.string"] = None,
        by_message_category: Optional["capo_backup.types.string.string"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_backup_jobs_input.ListBackupJobsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_backup_jobs_output.ListBackupJobsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_backup_jobs

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_backup_jobs.async_list_backup_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_backup_jobs(
        ...
        *,
        ...
        by_parent_job_id: Optional["capo_backup.types.string.string"] = None,
        by_message_category: Optional["capo_backup.types.string.string"] = None,
    ) -> "AsyncIterator[capo_backup.types.backup_job.BackupJob]":
        _token = next_token
        while True:
    ...
    async def list_backup_job_summaries(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_backup_job_summaries_input.ListBackupJobSummariesInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_backup_job_summaries_output.ListBackupJobSummariesOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_backup_job_summaries

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_backup_job_summaries.async_list_backup_job_summaries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_backup_plans(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
        include_deleted: Optional["capo_backup.types.boolean.Boolean"] = None,
    ) -> "capo_backup.types.list_backup_plans_output.ListBackupPlansOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_backup_plans_input.ListBackupPlansInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_backup_plans_output.ListBackupPlansOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_backup_plans

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_backup_plans.async_list_backup_plans(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_backup_plans(
        ...
        *,
        ...
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
        include_deleted: Optional["capo_backup.types.boolean.Boolean"] = None,
    ) -> "AsyncIterator[capo_backup.types.backup_plans_list_member.BackupPlansListMember]":
        _token = next_token
        while True:
    ...
    async def list_backup_plan_templates(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "capo_backup.types.list_backup_plan_templates_output.ListBackupPlanTemplatesOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_backup_plan_templates_input.ListBackupPlanTemplatesInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_backup_plan_templates_output.ListBackupPlanTemplatesOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_backup_plan_templates

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_backup_plan_templates.async_list_backup_plan_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_backup_plan_templates(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_backup.types.backup_plan_templates_list_member.BackupPlanTemplatesListMember]":
        _token = next_token
        while True:
    ...
    async def list_backup_plan_versions(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "capo_backup.types.list_backup_plan_versions_output.ListBackupPlanVersionsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_backup_plan_versions_input.ListBackupPlanVersionsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_backup_plan_versions_output.ListBackupPlanVersionsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_backup_plan_versions

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_backup_plan_versions.async_list_backup_plan_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_backup_selections(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "capo_backup.types.list_backup_selections_output.ListBackupSelectionsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_backup_selections_input.ListBackupSelectionsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_backup_selections_output.ListBackupSelectionsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_backup_selections

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_backup_selections.async_list_backup_selections(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_backup_selections(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_backup.types.backup_selections_list_member.BackupSelectionsListMember]":
        _token = next_token
        while True:
    ...
    async def list_backup_vaults(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        by_vault_type: Optional["capo_backup.types.vault_type.VaultType"] = None,
        by_shared: Optional["capo_backup.types.boolean2.Boolean2"] = None,
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "capo_backup.types.list_backup_vaults_output.ListBackupVaultsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_backup_vaults_input.ListBackupVaultsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_backup_vaults_output.ListBackupVaultsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_backup_vaults

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_backup_vaults.async_list_backup_vaults(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_backup_vaults(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_backup.types.backup_vault_list_member.BackupVaultListMember]":
        _token = next_token
        while True:
    ...
    async def list_copy_jobs(
        ...
        *,
        ...
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
        by_resource_arn: Optional["capo_backup.types.arn.ARN"] = None,
        by_state: Optional["capo_backup.types.copy_job_state.CopyJobState"] = None,
        by_created_before: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_created_after: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_resource_type: Optional[
            "capo_backup.types.resource_type.ResourceType"
        ] = None,
        by_destination_vault_arn: Optional["capo_backup.types.string.string"] = None,
        by_account_id: Optional["capo_backup.types.account_id.AccountId"] = None,
        by_complete_before: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_complete_after: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_parent_job_id: Optional["capo_backup.types.string.string"] = None,
        ...
        by_source_recovery_point_arn: Optional[
            "capo_backup.types.string.string"
        ] = None,
    ) -> "capo_backup.types.list_copy_jobs_output.ListCopyJobsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_copy_jobs_input.ListCopyJobsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_copy_jobs_output.ListCopyJobsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_copy_jobs

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_copy_jobs.async_list_copy_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_backup.types.copy_job.CopyJob]":
        _token = next_token
        while True:
    ...
    async def list_copy_job_summaries(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_copy_job_summaries_input.ListCopyJobSummariesInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_copy_job_summaries_output.ListCopyJobSummariesOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_copy_job_summaries

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_copy_job_summaries.async_list_copy_job_summaries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_frameworks(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
    ) -> "capo_backup.types.list_frameworks_output.ListFrameworksOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_frameworks_input.ListFrameworksInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_frameworks_output.ListFrameworksOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_frameworks

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_frameworks.async_list_frameworks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_indexed_recovery_points(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
        source_resource_arn: Optional["capo_backup.types.arn.ARN"] = None,
        created_before: Optional["capo_backup.types.timestamp.timestamp"] = None,
        created_after: Optional["capo_backup.types.timestamp.timestamp"] = None,
        resource_type: Optional["capo_backup.types.resource_type.ResourceType"] = None,
        index_status: Optional["capo_backup.types.index_status.IndexStatus"] = None,
    ) -> "capo_backup.types.list_indexed_recovery_points_output.ListIndexedRecoveryPointsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_indexed_recovery_points_input.ListIndexedRecoveryPointsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_indexed_recovery_points_output.ListIndexedRecoveryPointsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_indexed_recovery_points

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_indexed_recovery_points.async_list_indexed_recovery_points(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_indexed_recovery_points(
        ...
        *,
        ...
        resource_type: Optional["capo_backup.types.resource_type.ResourceType"] = None,
        index_status: Optional["capo_backup.types.index_status.IndexStatus"] = None,
    ) -> "AsyncIterator[capo_backup.types.indexed_recovery_point.IndexedRecoveryPoint]":
        _token = next_token
        while True:
    ...
    async def list_legal_holds(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "capo_backup.types.list_legal_holds_output.ListLegalHoldsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_legal_holds_input.ListLegalHoldsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_legal_holds_output.ListLegalHoldsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_legal_holds

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_legal_holds.async_list_legal_holds(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_legal_holds(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_backup.types.legal_hold.LegalHold]":
        _token = next_token
        while True:
    ...
    async def list_protected_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_protected_resources_input.ListProtectedResourcesInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_protected_resources_output.ListProtectedResourcesOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_protected_resources

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_protected_resources.async_list_protected_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_protected_resources(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_backup.types.protected_resource.ProtectedResource]":
        _token = next_token
        while True:
    ...
    async def list_protected_resources_by_backup_vault(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "capo_backup.types.list_protected_resources_by_backup_vault_output.ListProtectedResourcesByBackupVaultOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_protected_resources_by_backup_vault_input.ListProtectedResourcesByBackupVaultInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_protected_resources_by_backup_vault_output.ListProtectedResourcesByBackupVaultOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_protected_resources_by_backup_vault

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_protected_resources_by_backup_vault.async_list_protected_resources_by_backup_vault(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_recovery_points_by_backup_vault(
        ...
        *,
        ...
        by_backup_plan_id: Optional["capo_backup.types.string.string"] = None,
        by_created_before: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_created_after: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_parent_recovery_point_arn: Optional["capo_backup.types.arn.ARN"] = None,
    ) -> "capo_backup.types.list_recovery_points_by_backup_vault_output.ListRecoveryPointsByBackupVaultOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_recovery_points_by_backup_vault_input.ListRecoveryPointsByBackupVaultInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_recovery_points_by_backup_vault_output.ListRecoveryPointsByBackupVaultOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_recovery_points_by_backup_vault

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_recovery_points_by_backup_vault.async_list_recovery_points_by_backup_vault(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_recovery_points_by_backup_vault(
        ...
        *,
        ...
        by_created_after: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_parent_recovery_point_arn: Optional["capo_backup.types.arn.ARN"] = None,
    ) -> "AsyncIterator[capo_backup.types.recovery_point_by_backup_vault.RecoveryPointByBackupVault]":
        _token = next_token
        while True:
    ...
    async def list_recovery_points_by_legal_hold(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "capo_backup.types.list_recovery_points_by_legal_hold_output.ListRecoveryPointsByLegalHoldOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_recovery_points_by_legal_hold_input.ListRecoveryPointsByLegalHoldInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_recovery_points_by_legal_hold_output.ListRecoveryPointsByLegalHoldOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_recovery_points_by_legal_hold

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_recovery_points_by_legal_hold.async_list_recovery_points_by_legal_hold(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_recovery_points_by_legal_hold(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_backup.types.recovery_point_member.RecoveryPointMember]":
        _token = next_token
        while True:
    ...
    async def list_recovery_points_by_resource(
        ...
        *,
        ...
        managed_by_aws_backup_only: Optional[
            "capo_backup.types.boolean2.Boolean2"
        ] = None,
    ) -> "capo_backup.types.list_recovery_points_by_resource_output.ListRecoveryPointsByResourceOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_recovery_points_by_resource_input.ListRecoveryPointsByResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_recovery_points_by_resource_output.ListRecoveryPointsByResourceOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_recovery_points_by_resource

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_recovery_points_by_resource.async_list_recovery_points_by_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_backup.types.recovery_point_by_resource.RecoveryPointByResource]":
        _token = next_token
        while True:
    ...
    async def list_report_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_report_jobs_input.ListReportJobsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_report_jobs_output.ListReportJobsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_report_jobs

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_report_jobs.async_list_report_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_report_plans(
        ...
        *,
        ...
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_backup.types.string.string"] = None,
    ) -> "capo_backup.types.list_report_plans_output.ListReportPlansOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_report_plans_input.ListReportPlansInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_report_plans_output.ListReportPlansOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_report_plans

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_report_plans.async_list_report_plans(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_restore_access_backup_vaults(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_restore_access_backup_vaults_input.ListRestoreAccessBackupVaultsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_restore_access_backup_vaults_output.ListRestoreAccessBackupVaultsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_restore_access_backup_vaults

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_restore_access_backup_vaults.async_list_restore_access_backup_vaults(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_restore_access_backup_vaults(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_backup.types.restore_access_backup_vault_list_member.RestoreAccessBackupVaultListMember]":
        _token = next_token
        while True:
    ...
    async def list_restore_jobs(
        ...
        *,
        ...
        by_created_after: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_status: Optional[
            "capo_backup.types.restore_job_status.RestoreJobStatus"
        ] = None,
        by_complete_before: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_complete_after: Optional["capo_backup.types.timestamp.timestamp"] = None,
        by_restore_testing_plan_arn: Optional["capo_backup.types.arn.ARN"] = None,
        by_parent_job_id: Optional["capo_backup.types.string.string"] = None,
    ) -> "capo_backup.types.list_restore_jobs_output.ListRestoreJobsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_restore_jobs_input.ListRestoreJobsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_restore_jobs_output.ListRestoreJobsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_restore_jobs

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_restore_jobs.async_list_restore_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_restore_jobs(
        ...
        *,
        ...
        by_restore_testing_plan_arn: Optional["capo_backup.types.arn.ARN"] = None,
        by_parent_job_id: Optional["capo_backup.types.string.string"] = None,
    ) -> "AsyncIterator[capo_backup.types.restore_jobs_list_member.RestoreJobsListMember]":
        _token = next_token
        while True:
    ...
    async def list_restore_jobs_by_protected_resource(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "capo_backup.types.list_restore_jobs_by_protected_resource_output.ListRestoreJobsByProtectedResourceOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_restore_jobs_by_protected_resource_input.ListRestoreJobsByProtectedResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_restore_jobs_by_protected_resource_output.ListRestoreJobsByProtectedResourceOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_restore_jobs_by_protected_resource

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_restore_jobs_by_protected_resource.async_list_restore_jobs_by_protected_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_restore_job_summaries(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_restore_job_summaries_input.ListRestoreJobSummariesInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_restore_job_summaries_output.ListRestoreJobSummariesOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_restore_job_summaries

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_restore_job_summaries.async_list_restore_job_summaries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_restore_testing_plans(
        ...
        *,
    ...
    ) -> "capo_backup.types.list_restore_testing_plans_output.ListRestoreTestingPlansOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_restore_testing_plans_input.ListRestoreTestingPlansInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_restore_testing_plans_output.ListRestoreTestingPlansOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_restore_testing_plans

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_restore_testing_plans.async_list_restore_testing_plans(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_restore_testing_plans(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[capo_backup.types.restore_testing_plan_for_list.RestoreTestingPlanForList]":
        _token = next_token
        while True:
    ...
    async def list_restore_testing_selections(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "capo_backup.types.list_restore_testing_selections_output.ListRestoreTestingSelectionsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_restore_testing_selections_input.ListRestoreTestingSelectionsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_restore_testing_selections_output.ListRestoreTestingSelectionsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_restore_testing_selections

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_restore_testing_selections.async_list_restore_testing_selections(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_restore_testing_selections(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[capo_backup.types.restore_testing_selection_for_list.RestoreTestingSelectionForList]":
        _token = next_token
        while True:
    ...
    async def list_scan_jobs(
        ...
        *,
        ...
        by_malware_scanner: Optional[
            "capo_backup.types.malware_scanner.MalwareScanner"
        ] = None,
        ...
        by_state: Optional["capo_backup.types.scan_state.ScanState"] = None,
        max_results: Optional[
            "capo_backup.types.list_scan_jobs_input_max_results_integer.ListScanJobsInputMaxResultsInteger"
        ] = None,
        next_token: Optional[str] = None,
    ) -> "capo_backup.types.list_scan_jobs_output.ListScanJobsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_scan_jobs_input.ListScanJobsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_scan_jobs_output.ListScanJobsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_scan_jobs

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_scan_jobs.async_list_scan_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_scan_jobs(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[capo_backup.types.scan_job.ScanJob]":
        _token = next_token
        while True:
    ...
    async def list_scan_job_summaries(
        ...
        *,
        ...
        state: Optional["capo_backup.types.scan_job_status.ScanJobStatus"] = None,
        aggregation_period: Optional[
            "capo_backup.types.aggregation_period.AggregationPeriod"
        ] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_scan_job_summaries_input.ListScanJobSummariesInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_scan_job_summaries_output.ListScanJobSummariesOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_scan_job_summaries

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_scan_job_summaries.async_list_scan_job_summaries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_scan_job_summaries(
        ...
        *,
        ...
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_backup.types.string.string"] = None,
    ) -> "AsyncIterator[capo_backup.types.scan_job_summary.ScanJobSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags(
        ...
        *,
        ...
        next_token: Optional["capo_backup.types.string.string"] = None,
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
    ) -> "capo_backup.types.list_tags_output.ListTagsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_tags_input.ListTagsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_tags_output.ListTagsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_tags

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_tags.async_list_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tiering_configurations(
        ...
        *,
        ...
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_backup.types.string.string"] = None,
    ) -> "capo_backup.types.list_tiering_configurations_output.ListTieringConfigurationsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.list_tiering_configurations_input.ListTieringConfigurationsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.list_tiering_configurations_output.ListTieringConfigurationsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.list_tiering_configurations

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.list_tiering_configurations.async_list_tiering_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_tiering_configurations(
        ...
        *,
        ...
        max_results: Optional["capo_backup.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_backup.types.string.string"] = None,
    ) -> "AsyncIterator[capo_backup.types.tiering_configurations_list_member.TieringConfigurationsListMember]":
        _token = next_token
        while True:
    ...
    async def put_backup_vault_access_policy(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        policy: Optional["capo_backup.types.iam_policy.IAMPolicy"] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.put_backup_vault_access_policy_input.PutBackupVaultAccessPolicyInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.put_backup_vault_access_policy

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.put_backup_vault_access_policy.async_put_backup_vault_access_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_backup_vault_lock_configuration(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        min_retention_days: Optional["capo_backup.types.long.Long"] = None,
        max_retention_days: Optional["capo_backup.types.long.Long"] = None,
        changeable_for_days: Optional["capo_backup.types.long.Long"] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.put_backup_vault_lock_configuration_input.PutBackupVaultLockConfigurationInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.put_backup_vault_lock_configuration

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.put_backup_vault_lock_configuration.async_put_backup_vault_lock_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_backup_vault_notifications(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.put_backup_vault_notifications_input.PutBackupVaultNotificationsInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.put_backup_vault_notifications

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.put_backup_vault_notifications.async_put_backup_vault_notifications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_restore_validation_result(
        self,
        restore_job_id: "capo_backup.types.restore_job_id.RestoreJobId",
        validation_status: "capo_backup.types.restore_validation_status.RestoreValidationStatus",
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        validation_status_message: Optional["capo_backup.types.string.string"] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.put_restore_validation_result_input.PutRestoreValidationResultInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.put_restore_validation_result

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.put_restore_validation_result.async_put_restore_validation_result(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def revoke_restore_access_backup_vault(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.revoke_restore_access_backup_vault_input.RevokeRestoreAccessBackupVaultInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.revoke_restore_access_backup_vault

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.revoke_restore_access_backup_vault.async_revoke_restore_access_backup_vault(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_backup_job(
        ...
        *,
        ...
        logically_air_gapped_backup_vault_arn: Optional[
            "capo_backup.types.arn.ARN"
        ] = None,
        idempotency_token: Optional["capo_backup.types.string.string"] = None,
        start_window_minutes: Optional[
            "capo_backup.types.window_minutes.WindowMinutes"
        ] = None,
        complete_window_minutes: Optional[
            "capo_backup.types.window_minutes.WindowMinutes"
        ] = None,
        lifecycle: Optional["capo_backup.types.lifecycle.Lifecycle"] = None,
        recovery_point_tags: Optional["capo_backup.types.tags.Tags"] = None,
        backup_options: Optional[
            "capo_backup.types.backup_options.BackupOptions"
        ] = None,
        index: Optional["capo_backup.types.index.Index"] = None,
    ) -> "capo_backup.types.start_backup_job_output.StartBackupJobOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.start_backup_job_input.StartBackupJobInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.start_backup_job_output.StartBackupJobOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.start_backup_job

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.start_backup_job.async_start_backup_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_copy_job(
        ...
        *,
        ...
        idempotency_token: Optional["capo_backup.types.string.string"] = None,
        lifecycle: Optional["capo_backup.types.lifecycle.Lifecycle"] = None,
    ) -> "capo_backup.types.start_copy_job_output.StartCopyJobOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.start_copy_job_input.StartCopyJobInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.start_copy_job_output.StartCopyJobOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.start_copy_job

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.start_copy_job.async_start_copy_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_report_job(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        idempotency_token: Optional["capo_backup.types.string.string"] = None,
    ) -> "capo_backup.types.start_report_job_output.StartReportJobOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.start_report_job_input.StartReportJobInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.start_report_job_output.StartReportJobOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.start_report_job

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.start_report_job.async_start_report_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_restore_job(
        self,
        recovery_point_arn: "capo_backup.types.arn.ARN",
        metadata: "capo_backup.types.metadata.Metadata",
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        iam_role_arn: Optional["capo_backup.types.iam_role_arn.IAMRoleArn"] = None,
        idempotency_token: Optional["capo_backup.types.string.string"] = None,
        resource_type: Optional["capo_backup.types.resource_type.ResourceType"] = None,
        copy_source_tags_to_restored_resource: Optional[
            "capo_backup.types.boolean2.Boolean2"
        ] = None,
    ) -> "capo_backup.types.start_restore_job_output.StartRestoreJobOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.start_restore_job_input.StartRestoreJobInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.start_restore_job_output.StartRestoreJobOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.start_restore_job

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.start_restore_job.async_start_restore_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_scan_job(
        ...
        *,
    ...
    ) -> "capo_backup.types.start_scan_job_output.StartScanJobOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.start_scan_job_input.StartScanJobInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.start_scan_job_output.StartScanJobOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.start_scan_job

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.start_scan_job.async_start_scan_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_backup_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.stop_backup_job_input.StopBackupJobInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.stop_backup_job

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.stop_backup_job.async_stop_backup_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.tag_resource_input.TagResourceInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.tag_resource

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.untag_resource

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_backup_plan(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.update_backup_plan_output.UpdateBackupPlanOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.update_backup_plan_input.UpdateBackupPlanInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.update_backup_plan_output.UpdateBackupPlanOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.update_backup_plan

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.update_backup_plan.async_update_backup_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_framework(
        ...
        *,
        ...
        idempotency_token: Optional["capo_backup.types.string.string"] = None,
    ) -> "capo_backup.types.update_framework_output.UpdateFrameworkOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.update_framework_input.UpdateFrameworkInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.update_framework_output.UpdateFrameworkOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.update_framework

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.update_framework.async_update_framework(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_global_settings(
        ...
        *,
        ...
        global_settings: Optional[
            "capo_backup.types.global_settings.GlobalSettings"
        ] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.update_global_settings_input.UpdateGlobalSettingsInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.update_global_settings

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.update_global_settings.async_update_global_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_recovery_point_index_settings(
        ...
        backup_vault_name: "capo_backup.types.backup_vault_name.BackupVaultName",
        recovery_point_arn: "capo_backup.types.arn.ARN",
        index: "capo_backup.types.index.Index",
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        iam_role_arn: Optional["capo_backup.types.iam_role_arn.IAMRoleArn"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.update_recovery_point_index_settings_input.UpdateRecoveryPointIndexSettingsInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.update_recovery_point_index_settings_output.UpdateRecoveryPointIndexSettingsOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.update_recovery_point_index_settings

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.update_recovery_point_index_settings.async_update_recovery_point_index_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_recovery_point_lifecycle(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
        lifecycle: Optional["capo_backup.types.lifecycle.Lifecycle"] = None,
    ) -> "capo_backup.types.update_recovery_point_lifecycle_output.UpdateRecoveryPointLifecycleOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.update_recovery_point_lifecycle_input.UpdateRecoveryPointLifecycleInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.update_recovery_point_lifecycle_output.UpdateRecoveryPointLifecycleOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.update_recovery_point_lifecycle

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.update_recovery_point_lifecycle.async_update_recovery_point_lifecycle(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_region_settings(
        ...
        *,
        ...
        resource_type_opt_in_preference: Optional[
            "capo_backup.types.resource_type_opt_in_preference.ResourceTypeOptInPreference"
        ] = None,
        resource_type_management_preference: Optional[
            "capo_backup.types.resource_type_management_preference.ResourceTypeManagementPreference"
        ] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.update_region_settings_input.UpdateRegionSettingsInput]",
        ) -> AsyncOperationResponse[None]:
            import capo_backup._operations.cryo_controller_user_manager.update_region_settings

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.update_region_settings.async_update_region_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_report_plan(
        ...
        *,
        ...
        report_setting: Optional[
            "capo_backup.types.report_setting.ReportSetting"
        ] = None,
        idempotency_token: Optional["capo_backup.types.string.string"] = None,
    ) -> "capo_backup.types.update_report_plan_output.UpdateReportPlanOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.update_report_plan_input.UpdateReportPlanInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.update_report_plan_output.UpdateReportPlanOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.update_report_plan

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.update_report_plan.async_update_report_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_restore_testing_plan(
        self,
        restore_testing_plan: "capo_backup.types.restore_testing_plan_for_update.RestoreTestingPlanForUpdate",
        restore_testing_plan_name: str,
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.update_restore_testing_plan_output.UpdateRestoreTestingPlanOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.update_restore_testing_plan_input.UpdateRestoreTestingPlanInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.update_restore_testing_plan_output.UpdateRestoreTestingPlanOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.update_restore_testing_plan

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.update_restore_testing_plan.async_update_restore_testing_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_restore_testing_selection(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.update_restore_testing_selection_output.UpdateRestoreTestingSelectionOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.update_restore_testing_selection_input.UpdateRestoreTestingSelectionInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.update_restore_testing_selection_output.UpdateRestoreTestingSelectionOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.update_restore_testing_selection

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.update_restore_testing_selection.async_update_restore_testing_selection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_tiering_configuration(
        ...
        *,
        config_overrides: Optional[AsyncBackupClientConfig] = None,
    ) -> "capo_backup.types.update_tiering_configuration_output.UpdateTieringConfigurationOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_backup.types.update_tiering_configuration_input.UpdateTieringConfigurationInput]",
        ) -> AsyncOperationResponse[
            "capo_backup.types.update_tiering_configuration_output.UpdateTieringConfigurationOutput"
        ]:
            import capo_backup._operations.cryo_controller_user_manager.update_tiering_configuration

            (
                output,
                http_response,
            ) = await capo_backup._operations.cryo_controller_user_manager.update_tiering_configuration.async_update_tiering_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
