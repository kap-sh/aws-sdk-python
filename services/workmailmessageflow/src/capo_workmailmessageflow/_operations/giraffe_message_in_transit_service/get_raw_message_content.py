"""Generated from Smithy shape ``com.amazonaws.workmailmessageflow#GetRawMessageContent``."""
...
def handle_response(
    ...
    out: capo_workmailmessageflow.types.get_raw_message_content_response.GetRawMessageContentResponse = {
        "message_content": _iter
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_workmailmessageflow._auth._sigv4.build_sigv4_auth_scheme(
...
async def async_get_raw_message_content(
