...
if TYPE_CHECKING:
    import aws_sdk_workmailmessageflow.types.s3_bucket_id_type
    import aws_sdk_workmailmessageflow.types.s3_key_id_type
...
class S3Reference(TypedDict):
    ...
    object_version: NotRequired[
        "aws_sdk_workmailmessageflow.types.s3_version_type.s3VersionType"
    ]
