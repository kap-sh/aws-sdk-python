...
class WorkMailMessageFlowError(Exception):
    """Base class for all WorkMailMessageFlow service errors."""


class ServiceError(WorkMailMessageFlowError):
...
class SerializationError(WorkMailMessageFlowError):
    """Raised when a value cannot be serialized."""


class DeserializationError(WorkMailMessageFlowError):
...
class WaiterFailedError(WorkMailMessageFlowError):
...
class WaiterTimeoutError(WorkMailMessageFlowError):
