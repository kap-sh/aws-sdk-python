...
class InspectorScanError(Exception):
    """Base class for all InspectorScan service errors."""


class ServiceError(InspectorScanError):
...
class SerializationError(InspectorScanError):
    """Raised when a value cannot be serialized."""


class DeserializationError(InspectorScanError):
...
class WaiterFailedError(InspectorScanError):
...
class WaiterTimeoutError(InspectorScanError):
