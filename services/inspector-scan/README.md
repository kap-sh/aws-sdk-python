...
```
pip install aws-sdk-inspector-scan
```

## Usage

```python
from aws_sdk_inspector_scan import AsyncInspectorScanClient
...
```python
from aws_sdk_inspector_scan import AsyncInspectorScanClient
from aws_sdk_inspector_scan.error import AccessDeniedException
