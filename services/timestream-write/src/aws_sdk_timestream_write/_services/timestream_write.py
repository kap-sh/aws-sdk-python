...
from aws_sdk_timestream_write._services._aws_config import aws_config
...
class TimestreamWriteClientConfig(TypedDict, total=False):
...
class TimestreamWriteClient:
    ...
    def create_batch_load_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.create_batch_load_task_request.CreateBatchLoadTaskRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.create_batch_load_task_response.CreateBatchLoadTaskResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.create_batch_load_task.create_batch_load_task(
    ...
    def create_database(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.create_database_request.CreateDatabaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.create_database_response.CreateDatabaseResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.create_database.create_database(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_table(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.create_table_request.CreateTableRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.create_table_response.CreateTableResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.create_table.create_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_database(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.delete_database_request.DeleteDatabaseRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_timestream_write._operations.timestream_20181101.delete_database

            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.delete_database.delete_database(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_table(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.delete_table_request.DeleteTableRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_timestream_write._operations.timestream_20181101.delete_table

            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.delete_table.delete_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_batch_load_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.describe_batch_load_task_request.DescribeBatchLoadTaskRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.describe_batch_load_task_response.DescribeBatchLoadTaskResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.describe_batch_load_task.describe_batch_load_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_database(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.describe_database_request.DescribeDatabaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.describe_database_response.DescribeDatabaseResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.describe_database.describe_database(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_endpoints(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.describe_endpoints.describe_endpoints(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_table(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.describe_table_request.DescribeTableRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.describe_table_response.DescribeTableResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.describe_table.describe_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_batch_load_tasks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.list_batch_load_tasks_request.ListBatchLoadTasksRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.list_batch_load_tasks_response.ListBatchLoadTasksResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.list_batch_load_tasks.list_batch_load_tasks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_databases(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.list_databases_request.ListDatabasesRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.list_databases_response.ListDatabasesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.list_databases.list_databases(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tables(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.list_tables_request.ListTablesRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.list_tables_response.ListTablesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.list_tables.list_tables(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def resume_batch_load_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.resume_batch_load_task_request.ResumeBatchLoadTaskRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.resume_batch_load_task_response.ResumeBatchLoadTaskResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.resume_batch_load_task.resume_batch_load_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_database(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.update_database_request.UpdateDatabaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.update_database_response.UpdateDatabaseResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.update_database.update_database(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_table(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.update_table_request.UpdateTableRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.update_table_response.UpdateTableResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.update_table.update_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def write_records(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_write.types.write_records_request.WriteRecordsRequest]",
        ) -> OperationResponse[
            "aws_sdk_timestream_write.types.write_records_response.WriteRecordsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_write._operations.timestream_20181101.write_records.write_records(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
