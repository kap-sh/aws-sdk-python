        ...
        if _locals["PartitionResult"] is not None:
                    ...
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            if string_equals(
                                ...
                                return Endpoint(
                                    url=interpolate(
                                        "https://timestream-ingest-fips.{Region}.api.aws",
                                        p,
                                        _locals,
                                    ),
                                    properties={},
                            ...
                            if string_equals(
                                ...
                                return Endpoint(
                                    url=interpolate(
                                        "https://timestream-ingest.{Region}.api.aws",
                                        p,
                                        _locals,
                                    ),
                                    properties={},
                            ...
                            return Endpoint(
                                url=interpolate(
                                    "https://ingest.timestream-fips.{Region}.{PartitionResult#dualStackDnsSuffix}",
                                    p,
                                    _locals,
                                ),
                                properties={},
            ...
            if p.UseFIPS is True:
                if (
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://ingest.timestream-fips.{Region}.{PartitionResult#dnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            if p.UseDualStack is True:
                if True is get_attr(
                    ...
                    if string_equals(
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://timestream-ingest.{Region}.api.aws", p, _locals
                            ),
                            properties={},
                            headers={},
                        )
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://ingest.timestream.{Region}.{PartitionResult#dualStackDnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            return Endpoint(
                url=interpolate(
                    "https://ingest.timestream.{Region}.{PartitionResult#dnsSuffix}",
                    p,
                    _locals,
                ),
                properties={},
