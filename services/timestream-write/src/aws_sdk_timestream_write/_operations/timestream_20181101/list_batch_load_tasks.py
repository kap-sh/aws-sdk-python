"""Generated from Smithy shape ``com.amazonaws.timestreamwrite#ListBatchLoadTasks``."""
...
def handle_response(
    ...
    out: aws_sdk_timestream_write.types.list_batch_load_tasks_response.ListBatchLoadTasksResponse = aws_sdk_timestream_write.types.list_batch_load_tasks_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_timestream_write.types.list_batch_load_tasks_request.ListBatchLoadTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.ListBatchLoadTasks"
    import aws_sdk_timestream_write.types.list_batch_load_tasks_request

    body: bytes | None = json.dumps(
        aws_sdk_timestream_write.types.list_batch_load_tasks_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_batch_load_tasks(
