"""Generated from Smithy shape ``com.amazonaws.timestreamwrite#CreateTable``."""
...
import aws_sdk_timestream_write.errors.conflict_exception
...
import aws_sdk_timestream_write.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_timestream_write.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_timestream_write.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_timestream_write.types.create_table_response.CreateTableResponse = (
        aws_sdk_timestream_write.types.create_table_response.deserialize_aws_json_1_0(
...
def get_signer(
...
) -> aws_sdk_timestream_write._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_timestream_write._auth._sigv4.build_sigv4_auth_scheme(
                "timestream", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_timestream_write._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_timestream_write.types.create_table_request.CreateTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.CreateTable"
    import aws_sdk_timestream_write.types.create_table_request

    body: bytes | None = json.dumps(
        aws_sdk_timestream_write.types.create_table_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
