...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RejectedRecordsException":
            import aws_sdk_timestream_write.errors.rejected_records_exception

            raise aws_sdk_timestream_write.errors.rejected_records_exception.RejectedRecordsException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_timestream_write.types.write_records_response.WriteRecordsResponse = (
        aws_sdk_timestream_write.types.write_records_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_timestream_write.types.write_records_request.WriteRecordsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_timestream_write.types.write_records_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
