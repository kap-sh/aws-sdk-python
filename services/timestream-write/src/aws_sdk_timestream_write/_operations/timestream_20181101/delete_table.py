"""Generated from Smithy shape ``com.amazonaws.timestreamwrite#DeleteTable``."""
...
def build_request(
    ...
    input_: aws_sdk_timestream_write.types.delete_table_request.DeleteTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.DeleteTable"
    body: bytes | None = json.dumps(
        aws_sdk_timestream_write.types.delete_table_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
