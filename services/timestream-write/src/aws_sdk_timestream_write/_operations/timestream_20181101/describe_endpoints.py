...
def handle_response(
    ...
    out: aws_sdk_timestream_write.types.describe_endpoints_response.DescribeEndpointsResponse = aws_sdk_timestream_write.types.describe_endpoints_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_timestream_write.types.describe_endpoints_request.DescribeEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
