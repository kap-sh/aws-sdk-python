"""Generated from Smithy shape ``com.amazonaws.timestreamwrite#DescribeBatchLoadTask``."""
...
def handle_response(
    ...
    out: aws_sdk_timestream_write.types.describe_batch_load_task_response.DescribeBatchLoadTaskResponse = aws_sdk_timestream_write.types.describe_batch_load_task_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_timestream_write.types.describe_batch_load_task_request.DescribeBatchLoadTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.DescribeBatchLoadTask"
    import aws_sdk_timestream_write.types.describe_batch_load_task_request

    body: bytes | None = json.dumps(
        aws_sdk_timestream_write.types.describe_batch_load_task_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_describe_batch_load_task(
