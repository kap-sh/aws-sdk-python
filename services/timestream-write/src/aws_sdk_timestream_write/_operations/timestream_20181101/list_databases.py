...
def handle_response(
    ...
    out: aws_sdk_timestream_write.types.list_databases_response.ListDatabasesResponse = aws_sdk_timestream_write.types.list_databases_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_timestream_write.types.list_databases_request.ListDatabasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_timestream_write.types.list_databases_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
