"""Generated from Smithy shape ``com.amazonaws.timestreamwrite#DeleteDatabase``."""
...
def build_request(
    ...
    input_: aws_sdk_timestream_write.types.delete_database_request.DeleteDatabaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.DeleteDatabase"
    import aws_sdk_timestream_write.types.delete_database_request

    body: bytes | None = json.dumps(
        aws_sdk_timestream_write.types.delete_database_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
