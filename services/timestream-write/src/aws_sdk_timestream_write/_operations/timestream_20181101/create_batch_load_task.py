...
def handle_response(
    ...
    out: aws_sdk_timestream_write.types.create_batch_load_task_response.CreateBatchLoadTaskResponse = aws_sdk_timestream_write.types.create_batch_load_task_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_timestream_write.types.create_batch_load_task_request.CreateBatchLoadTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_timestream_write.types.create_batch_load_task_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
