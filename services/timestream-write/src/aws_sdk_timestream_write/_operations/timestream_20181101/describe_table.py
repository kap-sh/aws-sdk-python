...
def build_request(
    ...
    input_: aws_sdk_timestream_write.types.describe_table_request.DescribeTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_timestream_write.types.describe_table_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
