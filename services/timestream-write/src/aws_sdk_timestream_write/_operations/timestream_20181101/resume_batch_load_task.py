...
def handle_response(
    ...
    out: aws_sdk_timestream_write.types.resume_batch_load_task_response.ResumeBatchLoadTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_timestream_write.types.resume_batch_load_task_request.ResumeBatchLoadTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_timestream_write.types.resume_batch_load_task_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
