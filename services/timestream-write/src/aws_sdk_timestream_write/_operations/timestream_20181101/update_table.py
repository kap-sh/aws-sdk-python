...
def handle_response(
    ...
    out: aws_sdk_timestream_write.types.update_table_response.UpdateTableResponse = (
        aws_sdk_timestream_write.types.update_table_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_timestream_write.types.update_table_request.UpdateTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_timestream_write.types.update_table_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
