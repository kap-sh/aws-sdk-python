...
if TYPE_CHECKING:
    ...
    import aws_sdk_timestream_write.types.rejected_records


class RejectedRecordsException_(TypedDict):
    message: NotRequired["aws_sdk_timestream_write.types.error_message.ErrorMessage"]
    rejected_records: NotRequired[
        "aws_sdk_timestream_write.types.rejected_records.RejectedRecords"
    ]
    """<p> </p>"""
...
def serialize_aws_json_1_0(value: RejectedRecordsException_) -> dict:
    ...
    if "rejected_records" in value:
        ...
        out["RejectedRecords"] = (
            aws_sdk_timestream_write.types.rejected_records.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> RejectedRecordsException_:
    ...
    if "RejectedRecords" in data:
        ...
        out["rejected_records"] = (
            aws_sdk_timestream_write.types.rejected_records.deserialize_aws_json_1_0(
