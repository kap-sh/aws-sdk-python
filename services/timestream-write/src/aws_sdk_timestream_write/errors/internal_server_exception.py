"""Generated from Smithy shape ``com.amazonaws.timestreamwrite#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.timestreamwrite#InternalServerException``."""
