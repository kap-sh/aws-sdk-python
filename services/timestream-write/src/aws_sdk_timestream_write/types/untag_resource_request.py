"""Generated from Smithy shape ``com.amazonaws.timestreamwrite#UntagResourceRequest``."""
...
def serialize_aws_json_1_0(value: UntagResourceRequest) -> dict:
    ...
    out["TagKeys"] = aws_sdk_timestream_write.types.tag_key_list.serialize_aws_json_1_0(
        value["tag_keys"]
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> UntagResourceRequest:
    ...
    if "TagKeys" in data:
        ...
        out["tag_keys"] = (
            aws_sdk_timestream_write.types.tag_key_list.deserialize_aws_json_1_0(
                data["TagKeys"]
            )
        )
    else:
