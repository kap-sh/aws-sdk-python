...
if TYPE_CHECKING:
    ...
    import aws_sdk_timestream_write.types.measure_values
...
class Record(TypedDict):
    ...
    version: NotRequired["aws_sdk_timestream_write.types.record_version.RecordVersion"]
    ...
    measure_values: NotRequired[
        "aws_sdk_timestream_write.types.measure_values.MeasureValues"
    ]
...
def serialize_aws_json_1_0(value: Record) -> dict:
    ...
    if "dimensions" in value:
        ...
        out["Dimensions"] = (
            aws_sdk_timestream_write.types.dimensions.serialize_aws_json_1_0(
                value["dimensions"]
            )
        )
    ...
    if "measure_values" in value:
        ...
        out["MeasureValues"] = (
            aws_sdk_timestream_write.types.measure_values.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Record:
    ...
    if "Dimensions" in data:
        ...
        out["dimensions"] = (
            aws_sdk_timestream_write.types.dimensions.deserialize_aws_json_1_0(
                data["Dimensions"]
            )
        )
    ...
    if "MeasureValues" in data:
        ...
        out["measure_values"] = (
            aws_sdk_timestream_write.types.measure_values.deserialize_aws_json_1_0(
                data["MeasureValues"]
            )
        )
    return out
