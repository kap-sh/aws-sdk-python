...
if TYPE_CHECKING:
    import aws_sdk_timestream_write.types.partition_key_list


class Schema(TypedDict):
    composite_partition_key: NotRequired[
        "aws_sdk_timestream_write.types.partition_key_list.PartitionKeyList"
    ]
...
def serialize_aws_json_1_0(value: Schema) -> dict:
    ...
    if "composite_partition_key" in value:
        ...
        out["CompositePartitionKey"] = (
            aws_sdk_timestream_write.types.partition_key_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Schema:
    ...
    if "CompositePartitionKey" in data:
        ...
        out["composite_partition_key"] = (
            aws_sdk_timestream_write.types.partition_key_list.deserialize_aws_json_1_0(
