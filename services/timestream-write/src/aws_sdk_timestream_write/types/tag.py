"""Generated from Smithy shape ``com.amazonaws.timestreamwrite#Tag``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_timestream_write.types.tag_value


class Tag(TypedDict, closed=True):
    key: "aws_sdk_timestream_write.types.tag_key.TagKey"
    """<p> The key of the tag. Tag keys are case sensitive. </p>"""
    value: "aws_sdk_timestream_write.types.tag_value.TagValue"
