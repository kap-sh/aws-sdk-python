...
class TimestreamWriteError(Exception):
    """Base class for all TimestreamWrite service errors."""


class ServiceError(TimestreamWriteError):
...
class SerializationError(TimestreamWriteError):
    """Raised when a value cannot be serialized."""


class DeserializationError(TimestreamWriteError):
...
class WaiterFailedError(TimestreamWriteError):
...
class WaiterTimeoutError(TimestreamWriteError):
