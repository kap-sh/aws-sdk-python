...
if TYPE_CHECKING:
    import capo_timestream_write.types.integer


class RecordsIngested(TypedDict, closed=True):
    total: "capo_timestream_write.types.integer.Integer"
    """<p>Total count of successfully ingested records.</p>"""
    memory_store: "capo_timestream_write.types.integer.Integer"
    """<p>Count of records ingested into the memory store.</p>"""
    magnetic_store: "capo_timestream_write.types.integer.Integer"
