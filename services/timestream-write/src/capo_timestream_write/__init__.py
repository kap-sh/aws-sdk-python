...
from ._services.async_timestream_write import (
    AsyncTimestreamWriteClient as AsyncTimestreamWriteClient,
)
from ._services.timestream_write import TimestreamWriteClient as TimestreamWriteClient
