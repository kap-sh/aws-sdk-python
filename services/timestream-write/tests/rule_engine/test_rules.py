import pytest
from aws_sdk_timestream_write._rule_engine._endpoint_rule_set import EndpointParams, resolve
from aws_sdk_timestream_write._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_1_for_region_ap_northeast_1_with_fips_disa():
    ...
    assert result.url == 'https://ingest.timestream.ap-northeast-1.amazonaws.com'
...
def test_2_for_region_ap_northeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://timestream-ingest.ap-northeast-1.api.aws'
...
def test_3_for_region_ap_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://ingest.timestream.ap-south-1.amazonaws.com'
...
def test_4_for_region_ap_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://timestream-ingest.ap-south-1.api.aws'
...
def test_5_for_region_ap_southeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://ingest.timestream.ap-southeast-2.amazonaws.com'
...
def test_6_for_region_ap_southeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://timestream-ingest.ap-southeast-2.api.aws'
...
def test_7_for_region_eu_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://ingest.timestream.eu-central-1.amazonaws.com'
...
def test_8_for_region_eu_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://timestream-ingest.eu-central-1.api.aws'
...
def test_9_for_region_eu_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://ingest.timestream.eu-west-1.amazonaws.com'
...
def test_10_for_region_eu_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://timestream-ingest.eu-west-1.api.aws'

def test_11_for_region_us_east_1_with_fips_disabled_():
    """For region us-east-1 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://ingest.timestream.us-east-1.amazonaws.com'
...
def test_12_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://timestream-ingest.us-east-1.api.aws'

def test_13_for_region_us_east_1_with_fips_enabled_a():
    """For region us-east-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://timestream-ingest-fips.us-east-1.api.aws'
...
def test_14_for_region_us_east_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://ingest.timestream.us-east-2.amazonaws.com'

def test_15_for_region_us_east_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://timestream-ingest.us-east-2.api.aws'

def test_16_for_region_us_east_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://timestream-ingest-fips.us-east-2.api.aws'

def test_17_for_region_us_west_2_with_fips_disabled_():
    """For region us-west-2 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-west-2', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://ingest.timestream.us-west-2.amazonaws.com'

def test_18_for_region_us_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://timestream-ingest.us-west-2.api.aws'

def test_19_for_region_us_west_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://timestream-ingest-fips.us-west-2.api.aws'
...
def test_20_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://ingest.timestream-fips.us-east-1.amazonaws.com'

def test_21_for_region_cn_north_1_with_fips_enabled_():
    """For region cn-north-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='cn-north-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://ingest.timestream-fips.cn-north-1.api.amazonwebservices.com.cn'

def test_22_for_region_cn_north_1_with_fips_enabled_():
    """For region cn-north-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='cn-north-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://ingest.timestream-fips.cn-north-1.amazonaws.com.cn'

def test_23_for_region_cn_north_1_with_fips_disabled():
    """For region cn-north-1 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='cn-north-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://ingest.timestream.cn-north-1.api.amazonwebservices.com.cn'
...
def test_24_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://ingest.timestream.cn-north-1.amazonaws.com.cn'
...
def test_25_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://ingest.timestream.us-gov-west-1.amazonaws.com'

def test_26_for_region_us_gov_west_1_with_fips_enabl():
...
def test_27_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://timestream-ingest.us-gov-west-1.api.aws'

def test_28_for_region_us_gov_west_1_with_fips_enabl():
...
def test_29_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://timestream-ingest.us-gov-east-1.api.aws'
...
def test_30_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://ingest.timestream.us-gov-east-1.amazonaws.com'
...
def test_33_for_region_us_iso_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://ingest.timestream-fips.us-iso-east-1.c2s.ic.gov'
...
def test_34_for_region_us_iso_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://ingest.timestream.us-iso-east-1.c2s.ic.gov'
...
def test_35_for_region_us_isob_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://ingest.timestream-fips.us-isob-east-1.sc2s.sgov.gov'
...
def test_36_for_region_us_isob_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://ingest.timestream.us-isob-east-1.sc2s.sgov.gov'
