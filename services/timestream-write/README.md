...
```
pip install aws-sdk-timestream-write
```

## Usage

```python
from aws_sdk_timestream_write import AsyncTimestreamWriteClient
...
```python
from aws_sdk_timestream_write import AsyncTimestreamWriteClient
from aws_sdk_timestream_write.error import AccessDeniedException
