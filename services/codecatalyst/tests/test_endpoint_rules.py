...
from aws_sdk_codecatalyst._rule_engine._endpoint_runtime import EndpointError
import re
import zapros


def test_1_override_endpoint():
    """Override endpoint"""
...
def test_2_default_endpoint__region_not_set_():
...
def test_3_default_fips_endpoint__region_not_set_():
...
def test_4_default_endpoint__region__aws_global_():
...
def test_5_default_fips_endpoint__region__aws_global_():
...
def test_6_default_endpoint_for_a_valid_home_region():
...
def test_7_default_fips_endpoint_for_a_valid_home_r():
...
def test_8_default_endpoint_for_an_unavailable_home():
...
def test_9_default_fips_endpoint_for_an_unavailable():
