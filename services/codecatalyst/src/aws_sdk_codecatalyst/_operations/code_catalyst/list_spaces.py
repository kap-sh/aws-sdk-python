...
def handle_response(
    ...
    out: aws_sdk_codecatalyst.types.list_spaces_response.ListSpacesResponse = (
        aws_sdk_codecatalyst.types.list_spaces_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.list_spaces_request.ListSpacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.list_spaces_request.serialize_json(input_)
    ).encode()
...
def list_spaces(
    ...
    aws_sdk_codecatalyst.types.list_spaces_response.ListSpacesResponse, zapros.Response
]:
