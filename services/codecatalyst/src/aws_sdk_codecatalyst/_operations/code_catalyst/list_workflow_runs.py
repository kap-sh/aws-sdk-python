...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.list_workflow_runs_request.ListWorkflowRunsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.list_workflow_runs_request.serialize_json(input_)
    ).encode()
