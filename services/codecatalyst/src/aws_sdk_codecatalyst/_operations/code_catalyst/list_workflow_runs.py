"""Generated from Smithy shape ``com.amazonaws.codecatalyst#ListWorkflowRuns``."""
...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.list_workflow_runs_request
    import aws_sdk_codecatalyst.types.list_workflow_runs_response
...
) -> aws_sdk_codecatalyst.types.list_workflow_runs_response.ListWorkflowRunsResponse:
    import aws_sdk_codecatalyst.types.list_workflow_runs_response

    out: aws_sdk_codecatalyst.types.list_workflow_runs_response.ListWorkflowRunsResponse = aws_sdk_codecatalyst.types.list_workflow_runs_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_codecatalyst.types.list_workflow_runs_request.ListWorkflowRunsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.list_workflow_runs_request.serialize_json(input)
    ).encode()
