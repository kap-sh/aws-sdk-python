...
def handle_response(
    ...
    out: aws_sdk_codecatalyst.types.delete_access_token_response.DeleteAccessTokenResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.delete_access_token_request.DeleteAccessTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
