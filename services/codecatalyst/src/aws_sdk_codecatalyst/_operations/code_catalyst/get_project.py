...
import aws_sdk_codecatalyst.types.get_project_request
import aws_sdk_codecatalyst.types.get_project_response
...
) -> aws_sdk_codecatalyst.types.get_project_response.GetProjectResponse:
    out: aws_sdk_codecatalyst.types.get_project_response.GetProjectResponse = (
        aws_sdk_codecatalyst.types.get_project_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.get_project_request.GetProjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_project(
    ...
    aws_sdk_codecatalyst.types.get_project_response.GetProjectResponse, zapros.Response
]:
