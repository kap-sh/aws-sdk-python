...
import aws_sdk_codecatalyst.types.stop_dev_environment_session_request
import aws_sdk_codecatalyst.types.stop_dev_environment_session_response
...
) -> aws_sdk_codecatalyst.types.stop_dev_environment_session_response.StopDevEnvironmentSessionResponse:
    out: aws_sdk_codecatalyst.types.stop_dev_environment_session_response.StopDevEnvironmentSessionResponse = aws_sdk_codecatalyst.types.stop_dev_environment_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.stop_dev_environment_session_request.StopDevEnvironmentSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
