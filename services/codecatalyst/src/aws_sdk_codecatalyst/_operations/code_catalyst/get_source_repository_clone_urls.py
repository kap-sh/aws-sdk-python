...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.get_source_repository_clone_urls_request
    import aws_sdk_codecatalyst.types.get_source_repository_clone_urls_response
...
) -> aws_sdk_codecatalyst.types.get_source_repository_clone_urls_response.GetSourceRepositoryCloneUrlsResponse:
    import aws_sdk_codecatalyst.types.get_source_repository_clone_urls_response

    out: aws_sdk_codecatalyst.types.get_source_repository_clone_urls_response.GetSourceRepositoryCloneUrlsResponse = aws_sdk_codecatalyst.types.get_source_repository_clone_urls_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.get_source_repository_clone_urls_request.GetSourceRepositoryCloneUrlsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
