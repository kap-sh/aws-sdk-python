...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.list_event_logs_request
    import aws_sdk_codecatalyst.types.list_event_logs_response
...
) -> aws_sdk_codecatalyst.types.list_event_logs_response.ListEventLogsResponse:
    import aws_sdk_codecatalyst.types.list_event_logs_response

    out: aws_sdk_codecatalyst.types.list_event_logs_response.ListEventLogsResponse = (
        aws_sdk_codecatalyst.types.list_event_logs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.list_event_logs_request.ListEventLogsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.list_event_logs_request.serialize_json(input_)
    ).encode()
