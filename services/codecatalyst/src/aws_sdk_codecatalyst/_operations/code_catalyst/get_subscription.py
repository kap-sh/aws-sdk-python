...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.get_subscription_request
    import aws_sdk_codecatalyst.types.get_subscription_response
...
) -> aws_sdk_codecatalyst.types.get_subscription_response.GetSubscriptionResponse:
    import aws_sdk_codecatalyst.types.get_subscription_response

    out: aws_sdk_codecatalyst.types.get_subscription_response.GetSubscriptionResponse = aws_sdk_codecatalyst.types.get_subscription_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.get_subscription_request.GetSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
