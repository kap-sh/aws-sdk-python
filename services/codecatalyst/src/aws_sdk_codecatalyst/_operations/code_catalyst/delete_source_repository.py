"""Generated from Smithy shape ``com.amazonaws.codecatalyst#DeleteSourceRepository``."""
...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.delete_source_repository_request
    import aws_sdk_codecatalyst.types.delete_source_repository_response
...
) -> aws_sdk_codecatalyst.types.delete_source_repository_response.DeleteSourceRepositoryResponse:
    import aws_sdk_codecatalyst.types.delete_source_repository_response

    out: aws_sdk_codecatalyst.types.delete_source_repository_response.DeleteSourceRepositoryResponse = aws_sdk_codecatalyst.types.delete_source_repository_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.delete_source_repository_request.DeleteSourceRepositoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_source_repository(
