...
def build_request(
    ...
    input: aws_sdk_codecatalyst.types.list_access_tokens_request.ListAccessTokensRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.list_access_tokens_request.serialize_json(input)
    ).encode()
