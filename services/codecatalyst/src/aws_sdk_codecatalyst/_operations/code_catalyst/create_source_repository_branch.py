...
if TYPE_CHECKING:
    ...
    import aws_sdk_codecatalyst.types.create_source_repository_branch_response
...
def handle_response(
    ...
    out: aws_sdk_codecatalyst.types.create_source_repository_branch_response.CreateSourceRepositoryBranchResponse = aws_sdk_codecatalyst.types.create_source_repository_branch_response.deserialize_json(
