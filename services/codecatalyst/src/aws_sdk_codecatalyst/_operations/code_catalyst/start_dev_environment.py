"""Generated from Smithy shape ``com.amazonaws.codecatalyst#StartDevEnvironment``."""
...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.start_dev_environment_request
    import aws_sdk_codecatalyst.types.start_dev_environment_response
...
) -> aws_sdk_codecatalyst.types.start_dev_environment_response.StartDevEnvironmentResponse:
    import aws_sdk_codecatalyst.types.start_dev_environment_response

    out: aws_sdk_codecatalyst.types.start_dev_environment_response.StartDevEnvironmentResponse = aws_sdk_codecatalyst.types.start_dev_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.start_dev_environment_request.StartDevEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.start_dev_environment_request.serialize_json(input_)
    ).encode()
...
async def async_start_dev_environment(
