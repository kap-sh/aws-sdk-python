...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.get_source_repository_request
    import aws_sdk_codecatalyst.types.get_source_repository_response
...
) -> aws_sdk_codecatalyst.types.get_source_repository_response.GetSourceRepositoryResponse:
    import aws_sdk_codecatalyst.types.get_source_repository_response

    out: aws_sdk_codecatalyst.types.get_source_repository_response.GetSourceRepositoryResponse = aws_sdk_codecatalyst.types.get_source_repository_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.get_source_repository_request.GetSourceRepositoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
