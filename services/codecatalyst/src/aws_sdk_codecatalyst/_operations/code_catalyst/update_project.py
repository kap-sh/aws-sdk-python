"""Generated from Smithy shape ``com.amazonaws.codecatalyst#UpdateProject``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_codecatalyst.types.update_project_response
...
def handle_response(
    ...
    out: aws_sdk_codecatalyst.types.update_project_response.UpdateProjectResponse = (
        aws_sdk_codecatalyst.types.update_project_response.deserialize_json(
