...
def build_request(
    ...
    input: aws_sdk_codecatalyst.types.create_access_token_request.CreateAccessTokenRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.create_access_token_request.serialize_json(input)
    ).encode()
