...
def handle_response(
    ...
    out: aws_sdk_codecatalyst.types.create_access_token_response.CreateAccessTokenResponse = aws_sdk_codecatalyst.types.create_access_token_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.create_access_token_request.CreateAccessTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.create_access_token_request.serialize_json(input_)
    ).encode()
