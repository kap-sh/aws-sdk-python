"""Generated from Smithy shape ``com.amazonaws.codecatalyst#ListProjects``."""
...
import aws_sdk_codecatalyst.types.list_projects_request
import aws_sdk_codecatalyst.types.list_projects_response
import aws_sdk_codecatalyst.types.project_list_filters
...
) -> aws_sdk_codecatalyst.types.list_projects_response.ListProjectsResponse:
    out: aws_sdk_codecatalyst.types.list_projects_response.ListProjectsResponse = (
        aws_sdk_codecatalyst.types.list_projects_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.list_projects_request.ListProjectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/spaces/{spaceName}/projects"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.list_projects_request.serialize_json(input_)
    ).encode()
