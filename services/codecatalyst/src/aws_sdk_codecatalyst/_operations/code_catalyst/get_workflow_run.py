...
import aws_sdk_codecatalyst.types.get_workflow_run_request
import aws_sdk_codecatalyst.types.get_workflow_run_response
...
) -> aws_sdk_codecatalyst.types.get_workflow_run_response.GetWorkflowRunResponse:
    out: aws_sdk_codecatalyst.types.get_workflow_run_response.GetWorkflowRunResponse = (
        aws_sdk_codecatalyst.types.get_workflow_run_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.get_workflow_run_request.GetWorkflowRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
