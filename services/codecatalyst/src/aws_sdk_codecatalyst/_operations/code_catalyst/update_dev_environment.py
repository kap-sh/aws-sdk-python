...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.update_dev_environment_request
    import aws_sdk_codecatalyst.types.update_dev_environment_response
...
) -> aws_sdk_codecatalyst.types.update_dev_environment_response.UpdateDevEnvironmentResponse:
    import aws_sdk_codecatalyst.types.update_dev_environment_response

    out: aws_sdk_codecatalyst.types.update_dev_environment_response.UpdateDevEnvironmentResponse = aws_sdk_codecatalyst.types.update_dev_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.update_dev_environment_request.UpdateDevEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.update_dev_environment_request.serialize_json(input_)
    ).encode()
