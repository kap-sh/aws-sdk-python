...
def build_request(
    ...
    input: aws_sdk_codecatalyst.types.update_dev_environment_request.UpdateDevEnvironmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.update_dev_environment_request.serialize_json(input)
    ).encode()
