...
if TYPE_CHECKING:
    ...
    import aws_sdk_codecatalyst.types.list_source_repositories_response
...
) -> aws_sdk_codecatalyst.types.list_source_repositories_response.ListSourceRepositoriesResponse:
    import aws_sdk_codecatalyst.types.list_source_repositories_response

    out: aws_sdk_codecatalyst.types.list_source_repositories_response.ListSourceRepositoriesResponse = aws_sdk_codecatalyst.types.list_source_repositories_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.list_source_repositories_request.ListSourceRepositoriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
