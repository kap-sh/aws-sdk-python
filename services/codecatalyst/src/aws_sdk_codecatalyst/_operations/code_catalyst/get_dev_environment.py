...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.get_dev_environment_request
    import aws_sdk_codecatalyst.types.get_dev_environment_response
...
) -> aws_sdk_codecatalyst.types.get_dev_environment_response.GetDevEnvironmentResponse:
    import aws_sdk_codecatalyst.types.get_dev_environment_response

    out: aws_sdk_codecatalyst.types.get_dev_environment_response.GetDevEnvironmentResponse = aws_sdk_codecatalyst.types.get_dev_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.get_dev_environment_request.GetDevEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
