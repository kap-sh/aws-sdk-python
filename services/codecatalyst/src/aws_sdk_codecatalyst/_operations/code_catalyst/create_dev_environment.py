"""Generated from Smithy shape ``com.amazonaws.codecatalyst#CreateDevEnvironment``."""
...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.create_dev_environment_request
    import aws_sdk_codecatalyst.types.create_dev_environment_response
...
) -> aws_sdk_codecatalyst.types.create_dev_environment_response.CreateDevEnvironmentResponse:
    import aws_sdk_codecatalyst.types.create_dev_environment_response

    out: aws_sdk_codecatalyst.types.create_dev_environment_response.CreateDevEnvironmentResponse = aws_sdk_codecatalyst.types.create_dev_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.create_dev_environment_request.CreateDevEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.create_dev_environment_request.serialize_json(input_)
    ).encode()
...
async def async_create_dev_environment(
