...
def build_request(
    ...
    input: aws_sdk_codecatalyst.types.list_dev_environments_request.ListDevEnvironmentsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.list_dev_environments_request.serialize_json(input)
    ).encode()
