"""Generated from Smithy shape ``com.amazonaws.codecatalyst#ListDevEnvironments``."""
...
import aws_sdk_codecatalyst.types.dev_environment_summary_list
...
def handle_response(
    ...
    out: aws_sdk_codecatalyst.types.list_dev_environments_response.ListDevEnvironmentsResponse = aws_sdk_codecatalyst.types.list_dev_environments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.list_dev_environments_request.ListDevEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/spaces/{spaceName}/devEnvironments"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.list_dev_environments_request.serialize_json(input_)
    ).encode()
...
async def async_list_dev_environments(
