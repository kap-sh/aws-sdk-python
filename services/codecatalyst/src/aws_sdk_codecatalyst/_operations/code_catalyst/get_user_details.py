...
def handle_response(
    ...
    out: aws_sdk_codecatalyst.types.get_user_details_response.GetUserDetailsResponse = (
        aws_sdk_codecatalyst.types.get_user_details_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_codecatalyst.types.get_user_details_request.GetUserDetailsRequest,
) -> zapros.Request:
    ...
    if "user_name" in input:
        params["userName"] = str(input["user_name"])
