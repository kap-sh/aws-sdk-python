...
import aws_sdk_codecatalyst.types.get_workflow_request
import aws_sdk_codecatalyst.types.get_workflow_response
...
) -> aws_sdk_codecatalyst.types.get_workflow_response.GetWorkflowResponse:
    out: aws_sdk_codecatalyst.types.get_workflow_response.GetWorkflowResponse = (
        aws_sdk_codecatalyst.types.get_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.get_workflow_request.GetWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
