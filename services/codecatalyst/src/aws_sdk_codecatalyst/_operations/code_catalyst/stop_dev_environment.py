...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.stop_dev_environment_request
    import aws_sdk_codecatalyst.types.stop_dev_environment_response
...
def handle_response(
    ...
    aws_sdk_codecatalyst.types.stop_dev_environment_response.StopDevEnvironmentResponse
):
    import aws_sdk_codecatalyst.types.stop_dev_environment_response

    out: aws_sdk_codecatalyst.types.stop_dev_environment_response.StopDevEnvironmentResponse = aws_sdk_codecatalyst.types.stop_dev_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.stop_dev_environment_request.StopDevEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
