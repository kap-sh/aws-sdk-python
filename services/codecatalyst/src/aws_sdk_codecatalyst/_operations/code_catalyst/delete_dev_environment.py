"""Generated from Smithy shape ``com.amazonaws.codecatalyst#DeleteDevEnvironment``."""
...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.delete_dev_environment_request
    import aws_sdk_codecatalyst.types.delete_dev_environment_response
...
) -> aws_sdk_codecatalyst.types.delete_dev_environment_response.DeleteDevEnvironmentResponse:
    import aws_sdk_codecatalyst.types.delete_dev_environment_response

    out: aws_sdk_codecatalyst.types.delete_dev_environment_response.DeleteDevEnvironmentResponse = aws_sdk_codecatalyst.types.delete_dev_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.delete_dev_environment_request.DeleteDevEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_dev_environment(
