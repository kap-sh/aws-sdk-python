"""Generated from Smithy shape ``com.amazonaws.codecatalyst#ListDevEnvironmentSessions``."""
...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.list_dev_environment_sessions_request
    import aws_sdk_codecatalyst.types.list_dev_environment_sessions_response
...
) -> aws_sdk_codecatalyst.types.list_dev_environment_sessions_response.ListDevEnvironmentSessionsResponse:
    import aws_sdk_codecatalyst.types.list_dev_environment_sessions_response

    out: aws_sdk_codecatalyst.types.list_dev_environment_sessions_response.ListDevEnvironmentSessionsResponse = aws_sdk_codecatalyst.types.list_dev_environment_sessions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.list_dev_environment_sessions_request.ListDevEnvironmentSessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{devEnvironmentId}", quote(str(input_["dev_environment_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.list_dev_environment_sessions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_dev_environment_sessions(
