...
def build_request(
    ...
    input: aws_sdk_codecatalyst.types.list_dev_environment_sessions_request.ListDevEnvironmentSessionsRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{devEnvironmentId}", quote(str(input["dev_environment_id"]), safe="")
    )
    params: dict[str, str] = {}
