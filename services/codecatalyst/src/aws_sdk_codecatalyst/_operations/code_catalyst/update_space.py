"""Generated from Smithy shape ``com.amazonaws.codecatalyst#UpdateSpace``."""
...
def handle_response(
    ...
    out: aws_sdk_codecatalyst.types.update_space_response.UpdateSpaceResponse = (
        aws_sdk_codecatalyst.types.update_space_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.update_space_request.UpdateSpaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.update_space_request.serialize_json(input_)
    ).encode()
