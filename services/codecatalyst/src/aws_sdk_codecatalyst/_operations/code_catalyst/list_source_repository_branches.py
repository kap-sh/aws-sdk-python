...
import aws_sdk_codecatalyst.types.list_source_repository_branches_request
import aws_sdk_codecatalyst.types.list_source_repository_branches_response
...
) -> aws_sdk_codecatalyst.types.list_source_repository_branches_response.ListSourceRepositoryBranchesResponse:
    out: aws_sdk_codecatalyst.types.list_source_repository_branches_response.ListSourceRepositoryBranchesResponse = aws_sdk_codecatalyst.types.list_source_repository_branches_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_codecatalyst.types.list_source_repository_branches_request.ListSourceRepositoryBranchesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecatalyst.types.list_source_repository_branches_request.serialize_json(
            input_
        )
    ).encode()
