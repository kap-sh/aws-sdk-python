...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.access_token_summaries


class ListAccessTokensResponse(TypedDict):
    items: "aws_sdk_codecatalyst.types.access_token_summaries.AccessTokenSummaries"
...
def serialize_json(value: ListAccessTokensResponse) -> dict:
    ...
    out["items"] = aws_sdk_codecatalyst.types.access_token_summaries.serialize_json(
        value["items"]
    )
...
def deserialize_json(data: dict) -> ListAccessTokensResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_codecatalyst.types.access_token_summaries.deserialize_json(
                data["items"]
            )
        )
    else:
