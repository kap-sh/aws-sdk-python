...
class ListDevEnvironmentsResponse(TypedDict):
    items: "aws_sdk_codecatalyst.types.dev_environment_summary_list.DevEnvironmentSummaryList"
...
def serialize_json(value: ListDevEnvironmentsResponse) -> dict:
    ...
    out["items"] = (
        aws_sdk_codecatalyst.types.dev_environment_summary_list.serialize_json(
            value["items"]
        )
    )
...
def deserialize_json(data: dict) -> ListDevEnvironmentsResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_codecatalyst.types.dev_environment_summary_list.deserialize_json(
                data["items"]
            )
        )
    else:
