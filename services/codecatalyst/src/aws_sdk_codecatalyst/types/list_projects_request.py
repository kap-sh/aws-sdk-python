...
class ListProjectsRequest(TypedDict, closed=True):
    ...
    filters: NotRequired[
        "aws_sdk_codecatalyst.types.project_list_filters.ProjectListFilters"
    ]
...
def serialize_json(value: ListProjectsRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = aws_sdk_codecatalyst.types.project_list_filters.serialize_json(
            value["filters"]
        )
    return out
...
def deserialize_json(data: dict) -> ListProjectsRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            aws_sdk_codecatalyst.types.project_list_filters.deserialize_json(
                data["filters"]
            )
        )
    return out
