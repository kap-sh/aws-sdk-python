...
if TYPE_CHECKING:
    import aws_sdk_codecatalyst.types.dev_environment_access_details
...
def serialize_json(value: StartDevEnvironmentSessionResponse) -> dict:
    ...
    out["accessDetails"] = (
        aws_sdk_codecatalyst.types.dev_environment_access_details.serialize_json(
...
def deserialize_json(data: dict) -> StartDevEnvironmentSessionResponse:
    ...
    if "accessDetails" in data:
        ...
        out["access_details"] = (
            aws_sdk_codecatalyst.types.dev_environment_access_details.deserialize_json(
                data["accessDetails"]
            )
        )
    else:
