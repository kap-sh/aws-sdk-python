...
class CodeCatalystError(Exception):
    """Base class for all CodeCatalyst service errors."""


class ServiceError(CodeCatalystError):
...
class SerializationError(CodeCatalystError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CodeCatalystError):
...
class WaiterFailedError(CodeCatalystError):
...
class WaiterTimeoutError(CodeCatalystError):
