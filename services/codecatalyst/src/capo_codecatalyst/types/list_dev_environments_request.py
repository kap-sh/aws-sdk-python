...
class ListDevEnvironmentsRequest(TypedDict, closed=True):
    ...
    filters: NotRequired["capo_codecatalyst.types.filters.Filters"]
...
def serialize_json(value: ListDevEnvironmentsRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = capo_codecatalyst.types.filters.serialize_json(
            value["filters"]
        )
