...
def handle_response(
    ...
    out: capo_codecatalyst.types.list_access_tokens_response.ListAccessTokensResponse = capo_codecatalyst.types.list_access_tokens_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.list_access_tokens_request.serialize_json(input_)
    ).encode()
