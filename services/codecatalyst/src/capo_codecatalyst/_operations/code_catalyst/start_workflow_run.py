"""Generated from Smithy shape ``com.amazonaws.codecatalyst#StartWorkflowRun``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.start_workflow_run_response.StartWorkflowRunResponse = capo_codecatalyst.types.start_workflow_run_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.start_workflow_run_request.serialize_json(input_)
    ).encode()
