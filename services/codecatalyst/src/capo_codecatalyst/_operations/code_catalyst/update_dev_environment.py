"""Generated from Smithy shape ``com.amazonaws.codecatalyst#UpdateDevEnvironment``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.update_dev_environment_response.UpdateDevEnvironmentResponse = capo_codecatalyst.types.update_dev_environment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.update_dev_environment_request.serialize_json(input_)
    ).encode()
...
async def async_update_dev_environment(
