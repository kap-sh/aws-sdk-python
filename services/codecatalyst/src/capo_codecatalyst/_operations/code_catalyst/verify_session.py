"""Generated from Smithy shape ``com.amazonaws.codecatalyst#VerifySession``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.verify_session_response.VerifySessionResponse = (
        capo_codecatalyst.types.verify_session_response.deserialize_json(
...
async def async_verify_session(
