...
import capo_codecatalyst.types.project_summaries
...
def handle_response(
    ...
    out: capo_codecatalyst.types.list_projects_response.ListProjectsResponse = (
        capo_codecatalyst.types.list_projects_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.list_projects_request.serialize_json(input_)
    ).encode()
...
def list_projects(
    ...
    capo_codecatalyst.types.list_projects_response.ListProjectsResponse, zapros.Response
]:
