...
import capo_codecatalyst.types.dev_environment_sessions_summary_list
...
def handle_response(
    ...
    out: capo_codecatalyst.types.list_dev_environment_sessions_response.ListDevEnvironmentSessionsResponse = capo_codecatalyst.types.list_dev_environment_sessions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.list_dev_environment_sessions_request.serialize_json(
            input_
        )
    ).encode()
