...
def handle_response(
    ...
    out: capo_codecatalyst.types.update_space_response.UpdateSpaceResponse = (
        capo_codecatalyst.types.update_space_response.deserialize_json(
...
def update_space(
    ...
    capo_codecatalyst.types.update_space_response.UpdateSpaceResponse, zapros.Response
]:
