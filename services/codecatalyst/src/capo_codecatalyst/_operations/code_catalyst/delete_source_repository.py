...
def handle_response(
    ...
    out: capo_codecatalyst.types.delete_source_repository_response.DeleteSourceRepositoryResponse = capo_codecatalyst.types.delete_source_repository_response.deserialize_json(
