"""Generated from Smithy shape ``com.amazonaws.codecatalyst#GetSourceRepository``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.get_source_repository_response.GetSourceRepositoryResponse = capo_codecatalyst.types.get_source_repository_response.deserialize_json(
...
async def async_get_source_repository(
