"""Generated from Smithy shape ``com.amazonaws.codecatalyst#CreateSourceRepositoryBranch``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.create_source_repository_branch_response.CreateSourceRepositoryBranchResponse = capo_codecatalyst.types.create_source_repository_branch_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.create_source_repository_branch_request.serialize_json(
            input_
        )
    ).encode()
