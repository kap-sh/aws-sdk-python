"""Generated from Smithy shape ``com.amazonaws.codecatalyst#CreateProject``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.create_project_response.CreateProjectResponse = (
        capo_codecatalyst.types.create_project_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.create_project_request.serialize_json(input_)
    ).encode()
