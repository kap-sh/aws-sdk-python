"""Generated from Smithy shape ``com.amazonaws.codecatalyst#DeleteSpace``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.delete_space_response.DeleteSpaceResponse = (
        capo_codecatalyst.types.delete_space_response.deserialize_json(
...
def delete_space(
    ...
    capo_codecatalyst.types.delete_space_response.DeleteSpaceResponse, zapros.Response
]:
