"""Generated from Smithy shape ``com.amazonaws.codecatalyst#ListSourceRepositories``."""
...
import capo_codecatalyst.types.list_source_repositories_items
...
def handle_response(
    ...
    out: capo_codecatalyst.types.list_source_repositories_response.ListSourceRepositoriesResponse = capo_codecatalyst.types.list_source_repositories_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.list_source_repositories_request.serialize_json(input_)
    ).encode()
...
async def async_list_source_repositories(
