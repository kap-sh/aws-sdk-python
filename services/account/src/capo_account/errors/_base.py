...
class AccountError(Exception):
    """Base class for all Account service errors."""


class ServiceError(AccountError):
...
class SerializationError(AccountError):
    """Raised when a value cannot be serialized."""


class DeserializationError(AccountError):
...
class WaiterFailedError(AccountError):
...
class WaiterTimeoutError(AccountError):
