    ...
    def get_gov_cloud_account_information(
        ...
        *,
        ...
        Raises:
            ...
            aws_sdk_account.errors.resource_unavailable_exception.ResourceUnavailableException: <p>The operation failed because it specified a resource that is not currently available.</p>
