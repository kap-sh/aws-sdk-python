"""Generated from Smithy shape ``com.amazonaws.account#GetPrimaryEmail``."""
...
def handle_response(
    ...
    out: aws_sdk_account.types.get_primary_email_response.GetPrimaryEmailResponse = (
        aws_sdk_account.types.get_primary_email_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_account.types.get_primary_email_request.GetPrimaryEmailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/getPrimaryEmail"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_account.types.get_primary_email_request

    body: bytes | None = json.dumps(
        aws_sdk_account.types.get_primary_email_request.serialize_json(input_)
    ).encode()
...
async def async_get_primary_email(
