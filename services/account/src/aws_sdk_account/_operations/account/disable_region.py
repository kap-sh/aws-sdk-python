"""Generated from Smithy shape ``com.amazonaws.account#DisableRegion``."""
...
def build_request(
    ...
    input_: aws_sdk_account.types.disable_region_request.DisableRegionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/disableRegion"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_account.types.disable_region_request

    body: bytes | None = json.dumps(
        aws_sdk_account.types.disable_region_request.serialize_json(input_)
    ).encode()
...
async def async_disable_region(
