...
def build_request(
    ...
    input_: aws_sdk_account.types.put_alternate_contact_request.PutAlternateContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_account.types.put_alternate_contact_request.serialize_json(input_)
    ).encode()
