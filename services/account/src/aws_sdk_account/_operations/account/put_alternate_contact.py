...
def build_request(
    ...
    input: aws_sdk_account.types.put_alternate_contact_request.PutAlternateContactRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_account.types.put_alternate_contact_request.serialize_json(input)
    ).encode()
