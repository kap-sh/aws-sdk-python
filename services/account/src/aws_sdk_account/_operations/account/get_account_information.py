"""Generated from Smithy shape ``com.amazonaws.account#GetAccountInformation``."""
...
def handle_response(
    ...
    out: aws_sdk_account.types.get_account_information_response.GetAccountInformationResponse = aws_sdk_account.types.get_account_information_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_account.types.get_account_information_request.GetAccountInformationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/getAccountInformation"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_account.types.get_account_information_request

    body: bytes | None = json.dumps(
        aws_sdk_account.types.get_account_information_request.serialize_json(input_)
    ).encode()
...
async def async_get_account_information(
