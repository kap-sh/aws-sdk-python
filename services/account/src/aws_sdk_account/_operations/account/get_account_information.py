...
def build_request(
    ...
    input: aws_sdk_account.types.get_account_information_request.GetAccountInformationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_account.types.get_account_information_request.serialize_json(input)
    ).encode()
