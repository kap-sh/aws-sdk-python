...
def build_request(
    ...
    input: aws_sdk_account.types.get_contact_information_request.GetContactInformationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_account.types.get_contact_information_request.serialize_json(input)
    ).encode()
