...
def build_request(
    ...
    input: aws_sdk_account.types.get_alternate_contact_request.GetAlternateContactRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_account.types.get_alternate_contact_request.serialize_json(input)
    ).encode()
