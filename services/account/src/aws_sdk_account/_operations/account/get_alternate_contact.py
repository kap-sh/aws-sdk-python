"""Generated from Smithy shape ``com.amazonaws.account#GetAlternateContact``."""
...
def handle_response(
    ...
    out: aws_sdk_account.types.get_alternate_contact_response.GetAlternateContactResponse = aws_sdk_account.types.get_alternate_contact_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_account.types.get_alternate_contact_request.GetAlternateContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/getAlternateContact"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_account.types.get_alternate_contact_request.serialize_json(input_)
    ).encode()
...
async def async_get_alternate_contact(
