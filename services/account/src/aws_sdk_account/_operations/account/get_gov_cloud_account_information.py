...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceUnavailableException":
            import aws_sdk_account.errors.resource_unavailable_exception

            raise aws_sdk_account.errors.resource_unavailable_exception.ResourceUnavailableException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_account.types.get_gov_cloud_account_information_response.GetGovCloudAccountInformationResponse = aws_sdk_account.types.get_gov_cloud_account_information_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_account.types.get_gov_cloud_account_information_request.GetGovCloudAccountInformationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_account.types.get_gov_cloud_account_information_request.serialize_json(
            input_
        )
    ).encode()
