...
def build_request(
    ...
    input: aws_sdk_account.types.put_contact_information_request.PutContactInformationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_account.types.put_contact_information_request.serialize_json(input)
    ).encode()
