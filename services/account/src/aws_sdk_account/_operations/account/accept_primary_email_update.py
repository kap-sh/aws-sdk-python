...
def handle_response(
    ...
    out: aws_sdk_account.types.accept_primary_email_update_response.AcceptPrimaryEmailUpdateResponse = aws_sdk_account.types.accept_primary_email_update_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_account.types.accept_primary_email_update_request.AcceptPrimaryEmailUpdateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_account.types.accept_primary_email_update_request.serialize_json(input_)
    ).encode()
