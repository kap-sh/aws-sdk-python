...
def build_request(
    ...
    input: aws_sdk_account.types.accept_primary_email_update_request.AcceptPrimaryEmailUpdateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_account.types.accept_primary_email_update_request.serialize_json(input)
    ).encode()
