"""Generated from Smithy shape ``com.amazonaws.account#GetRegionOptStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_account.types.get_region_opt_status_response.GetRegionOptStatusResponse = aws_sdk_account.types.get_region_opt_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_account.types.get_region_opt_status_request.GetRegionOptStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/getRegionOptStatus"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_account.types.get_region_opt_status_request

    body: bytes | None = json.dumps(
        aws_sdk_account.types.get_region_opt_status_request.serialize_json(input_)
    ).encode()
...
async def async_get_region_opt_status(
