...
def build_request(
    ...
    input: aws_sdk_account.types.get_region_opt_status_request.GetRegionOptStatusRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_account.types.get_region_opt_status_request.serialize_json(input)
    ).encode()
