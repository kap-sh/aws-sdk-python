...
def handle_response(
    ...
    out: aws_sdk_account.types.list_regions_response.ListRegionsResponse = (
        aws_sdk_account.types.list_regions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_account.types.list_regions_request.ListRegionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_account.types.list_regions_request.serialize_json(input_)
    ).encode()
...
def list_regions(
    ...
    aws_sdk_account.types.list_regions_response.ListRegionsResponse, zapros.Response
]:
