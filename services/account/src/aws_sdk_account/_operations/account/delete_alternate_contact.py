...
def build_request(
    ...
    input_: aws_sdk_account.types.delete_alternate_contact_request.DeleteAlternateContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_account.types.delete_alternate_contact_request.serialize_json(input_)
    ).encode()
