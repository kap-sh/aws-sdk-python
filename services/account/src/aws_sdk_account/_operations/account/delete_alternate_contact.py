...
def build_request(
    ...
    input: aws_sdk_account.types.delete_alternate_contact_request.DeleteAlternateContactRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_account.types.delete_alternate_contact_request.serialize_json(input)
    ).encode()
