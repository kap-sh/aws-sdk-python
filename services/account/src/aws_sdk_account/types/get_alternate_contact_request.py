"""Generated from Smithy shape ``com.amazonaws.account#GetAlternateContactRequest``."""
...
class GetAlternateContactRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetAlternateContactRequest) -> dict:
    out: dict = {}
