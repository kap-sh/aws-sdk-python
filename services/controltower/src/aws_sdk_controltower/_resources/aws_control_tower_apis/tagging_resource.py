...
class TaggingResource:
    ...
    def list(
        ...
        *,
        ...
        input: aws_sdk_controltower.types.list_tags_for_resource_input.ListTagsForResourceInput = {}  # type: ignore[typeddict-item]
    ...
    def tag_resource(
        ...
        *,
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_controltower.types.tag_resource_input.TagResourceInput = {}  # type: ignore[typeddict-item]
        input["resource_arn"] = resource_arn
        input["tags"] = tags
    ...
    def untag_resource(
        ...
        *,
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_controltower.types.untag_resource_input.UntagResourceInput = {}  # type: ignore[typeddict-item]
        input["resource_arn"] = resource_arn
