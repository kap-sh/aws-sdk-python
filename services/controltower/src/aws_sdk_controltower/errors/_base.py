...
class ControlTowerError(Exception):
    """Base class for all ControlTower service errors."""


class ServiceError(ControlTowerError):
...
class SerializationError(ControlTowerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ControlTowerError):
...
class WaiterFailedError(ControlTowerError):
...
class WaiterTimeoutError(ControlTowerError):
