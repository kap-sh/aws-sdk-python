...
class ListLandingZoneOperationsOutput(TypedDict):
    landing_zone_operations: (
        "aws_sdk_controltower.types.landing_zone_operations.LandingZoneOperations"
    )
...
def serialize_json(value: ListLandingZoneOperationsOutput) -> dict:
    ...
    out["landingZoneOperations"] = (
        aws_sdk_controltower.types.landing_zone_operations.serialize_json(
...
def deserialize_json(data: dict) -> ListLandingZoneOperationsOutput:
    ...
    if "landingZoneOperations" in data:
        ...
        out["landing_zone_operations"] = (
            aws_sdk_controltower.types.landing_zone_operations.deserialize_json(
