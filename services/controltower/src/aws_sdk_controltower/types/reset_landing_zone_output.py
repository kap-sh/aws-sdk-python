"""Generated from Smithy shape ``com.amazonaws.controltower#ResetLandingZoneOutput``."""
...
class ResetLandingZoneOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ResetLandingZoneOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ResetLandingZoneOutput:
    ...
    if "operationIdentifier" in data:
        ...
        raise DeserializationError(
            "ResetLandingZoneOutput.operation_identifier required"
        )
    return out
