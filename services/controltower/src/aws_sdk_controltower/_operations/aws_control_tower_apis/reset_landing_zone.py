...
def build_request(
    ...
    input: aws_sdk_controltower.types.reset_landing_zone_input.ResetLandingZoneInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.reset_landing_zone_input.serialize_json(input)
    ).encode()
