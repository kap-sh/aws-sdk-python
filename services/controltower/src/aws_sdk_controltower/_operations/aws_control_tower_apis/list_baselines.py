...
def handle_response(
    ...
    out: aws_sdk_controltower.types.list_baselines_output.ListBaselinesOutput = (
        aws_sdk_controltower.types.list_baselines_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.list_baselines_input.ListBaselinesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.list_baselines_input.serialize_json(input_)
    ).encode()
