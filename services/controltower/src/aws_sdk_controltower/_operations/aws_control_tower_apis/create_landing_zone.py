"""Generated from Smithy shape ``com.amazonaws.controltower#CreateLandingZone``."""
...
def handle_response(
    ...
    out: aws_sdk_controltower.types.create_landing_zone_output.CreateLandingZoneOutput = aws_sdk_controltower.types.create_landing_zone_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.create_landing_zone_input.CreateLandingZoneInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/create-landingzone"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_controltower.types.create_landing_zone_input

    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.create_landing_zone_input.serialize_json(input_)
    ).encode()
...
async def async_create_landing_zone(
