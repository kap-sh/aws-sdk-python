...
def handle_response(
    ...
    out: aws_sdk_controltower.types.enable_baseline_output.EnableBaselineOutput = (
        aws_sdk_controltower.types.enable_baseline_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.enable_baseline_input.EnableBaselineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.enable_baseline_input.serialize_json(input_)
    ).encode()
