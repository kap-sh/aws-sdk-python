"""Generated from Smithy shape ``com.amazonaws.controltower#ListLandingZones``."""
...
def handle_response(
    ...
    out: aws_sdk_controltower.types.list_landing_zones_output.ListLandingZonesOutput = (
        aws_sdk_controltower.types.list_landing_zones_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.list_landing_zones_input.ListLandingZonesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-landingzones"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.list_landing_zones_input.serialize_json(input_)
    ).encode()
...
async def async_list_landing_zones(
