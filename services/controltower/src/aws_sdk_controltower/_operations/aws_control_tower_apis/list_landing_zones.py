...
def build_request(
    ...
    input: aws_sdk_controltower.types.list_landing_zones_input.ListLandingZonesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.list_landing_zones_input.serialize_json(input)
    ).encode()
