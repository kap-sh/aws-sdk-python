...
def build_request(
    ...
    input: aws_sdk_controltower.types.get_control_operation_input.GetControlOperationInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.get_control_operation_input.serialize_json(input)
    ).encode()
