"""Generated from Smithy shape ``com.amazonaws.controltower#EnableControl``."""
...
def handle_response(
    ...
    out: aws_sdk_controltower.types.enable_control_output.EnableControlOutput = (
        aws_sdk_controltower.types.enable_control_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.enable_control_input.EnableControlInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/enable-control"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_controltower.types.enable_control_input

    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.enable_control_input.serialize_json(input_)
    ).encode()
...
async def async_enable_control(
