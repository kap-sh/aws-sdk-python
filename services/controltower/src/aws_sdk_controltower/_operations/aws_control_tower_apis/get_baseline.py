"""Generated from Smithy shape ``com.amazonaws.controltower#GetBaseline``."""
...
def handle_response(
    ...
    out: aws_sdk_controltower.types.get_baseline_output.GetBaselineOutput = (
        aws_sdk_controltower.types.get_baseline_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.get_baseline_input.GetBaselineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/get-baseline"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_controltower.types.get_baseline_input

    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.get_baseline_input.serialize_json(input_)
    ).encode()
...
def get_baseline(
    ...
    aws_sdk_controltower.types.get_baseline_output.GetBaselineOutput, zapros.Response
]:
