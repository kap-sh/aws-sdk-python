...
def handle_response(
    ...
    out: aws_sdk_controltower.types.get_enabled_baseline_output.GetEnabledBaselineOutput = aws_sdk_controltower.types.get_enabled_baseline_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_controltower.types.get_enabled_baseline_input.GetEnabledBaselineInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.get_enabled_baseline_input.serialize_json(input)
    ).encode()
