...
def handle_response(
    ...
    out: aws_sdk_controltower.types.update_landing_zone_output.UpdateLandingZoneOutput = aws_sdk_controltower.types.update_landing_zone_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.update_landing_zone_input.UpdateLandingZoneInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.update_landing_zone_input.serialize_json(input_)
    ).encode()
