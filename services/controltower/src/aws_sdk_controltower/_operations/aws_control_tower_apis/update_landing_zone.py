...
def build_request(
    ...
    input: aws_sdk_controltower.types.update_landing_zone_input.UpdateLandingZoneInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.update_landing_zone_input.serialize_json(input)
    ).encode()
