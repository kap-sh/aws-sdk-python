...
def handle_response(
    ...
    out: aws_sdk_controltower.types.reset_enabled_baseline_output.ResetEnabledBaselineOutput = aws_sdk_controltower.types.reset_enabled_baseline_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.reset_enabled_baseline_input.ResetEnabledBaselineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.reset_enabled_baseline_input.serialize_json(input_)
    ).encode()
