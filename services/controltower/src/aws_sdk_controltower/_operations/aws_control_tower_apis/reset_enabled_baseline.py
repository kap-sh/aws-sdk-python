...
def build_request(
    ...
    input: aws_sdk_controltower.types.reset_enabled_baseline_input.ResetEnabledBaselineInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.reset_enabled_baseline_input.serialize_json(input)
    ).encode()
