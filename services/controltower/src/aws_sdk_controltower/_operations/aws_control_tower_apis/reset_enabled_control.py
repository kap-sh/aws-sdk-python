"""Generated from Smithy shape ``com.amazonaws.controltower#ResetEnabledControl``."""
...
def handle_response(
    ...
    out: aws_sdk_controltower.types.reset_enabled_control_output.ResetEnabledControlOutput = aws_sdk_controltower.types.reset_enabled_control_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.reset_enabled_control_input.ResetEnabledControlInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/reset-enabled-control"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_controltower.types.reset_enabled_control_input

    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.reset_enabled_control_input.serialize_json(input_)
    ).encode()
...
async def async_reset_enabled_control(
