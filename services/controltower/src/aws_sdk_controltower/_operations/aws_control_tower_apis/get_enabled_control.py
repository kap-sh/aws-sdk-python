...
def handle_response(
    ...
    out: aws_sdk_controltower.types.get_enabled_control_output.GetEnabledControlOutput = aws_sdk_controltower.types.get_enabled_control_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.get_enabled_control_input.GetEnabledControlInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.get_enabled_control_input.serialize_json(input_)
    ).encode()
