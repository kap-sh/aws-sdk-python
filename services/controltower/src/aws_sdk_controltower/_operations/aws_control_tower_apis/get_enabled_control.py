...
def build_request(
    ...
    input: aws_sdk_controltower.types.get_enabled_control_input.GetEnabledControlInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.get_enabled_control_input.serialize_json(input)
    ).encode()
