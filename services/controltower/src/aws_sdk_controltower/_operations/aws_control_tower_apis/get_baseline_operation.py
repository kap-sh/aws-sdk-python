...
def build_request(
    ...
    input: aws_sdk_controltower.types.get_baseline_operation_input.GetBaselineOperationInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.get_baseline_operation_input.serialize_json(input)
    ).encode()
