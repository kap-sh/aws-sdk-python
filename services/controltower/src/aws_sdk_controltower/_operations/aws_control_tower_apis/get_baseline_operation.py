...
def handle_response(
    ...
    out: aws_sdk_controltower.types.get_baseline_operation_output.GetBaselineOperationOutput = aws_sdk_controltower.types.get_baseline_operation_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.get_baseline_operation_input.GetBaselineOperationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.get_baseline_operation_input.serialize_json(input_)
    ).encode()
