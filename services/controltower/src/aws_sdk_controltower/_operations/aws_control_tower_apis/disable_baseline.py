"""Generated from Smithy shape ``com.amazonaws.controltower#DisableBaseline``."""
...
def handle_response(
    ...
    out: aws_sdk_controltower.types.disable_baseline_output.DisableBaselineOutput = (
        aws_sdk_controltower.types.disable_baseline_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.disable_baseline_input.DisableBaselineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/disable-baseline"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_controltower.types.disable_baseline_input

    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.disable_baseline_input.serialize_json(input_)
    ).encode()
...
async def async_disable_baseline(
