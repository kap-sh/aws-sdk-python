...
def build_request(
    ...
    input: aws_sdk_controltower.types.list_enabled_controls_input.ListEnabledControlsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.list_enabled_controls_input.serialize_json(input)
    ).encode()
