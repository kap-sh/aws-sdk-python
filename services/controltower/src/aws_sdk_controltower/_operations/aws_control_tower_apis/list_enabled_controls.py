...
def handle_response(
    ...
    out: aws_sdk_controltower.types.list_enabled_controls_output.ListEnabledControlsOutput = aws_sdk_controltower.types.list_enabled_controls_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.list_enabled_controls_input.ListEnabledControlsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.list_enabled_controls_input.serialize_json(input_)
    ).encode()
