...
import aws_sdk_controltower.types.landing_zone_operations
...
def handle_response(
    ...
    out: aws_sdk_controltower.types.list_landing_zone_operations_output.ListLandingZoneOperationsOutput = aws_sdk_controltower.types.list_landing_zone_operations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.list_landing_zone_operations_input.ListLandingZoneOperationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.list_landing_zone_operations_input.serialize_json(
            input_
        )
    ).encode()
