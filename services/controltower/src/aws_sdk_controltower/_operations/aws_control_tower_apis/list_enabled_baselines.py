"""Generated from Smithy shape ``com.amazonaws.controltower#ListEnabledBaselines``."""
...
def handle_response(
    ...
    out: aws_sdk_controltower.types.list_enabled_baselines_output.ListEnabledBaselinesOutput = aws_sdk_controltower.types.list_enabled_baselines_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.list_enabled_baselines_input.ListEnabledBaselinesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-enabled-baselines"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_controltower.types.list_enabled_baselines_input

    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.list_enabled_baselines_input.serialize_json(input_)
    ).encode()
...
async def async_list_enabled_baselines(
