"""Generated from Smithy shape ``com.amazonaws.controltower#TagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_controltower.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.tag_resource_input.TagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.tag_resource_input.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_controltower.types.tag_resource_output.TagResourceOutput, zapros.Response
]:
