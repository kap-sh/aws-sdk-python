...
def handle_response(
    ...
    out: aws_sdk_controltower.types.list_control_operations_output.ListControlOperationsOutput = aws_sdk_controltower.types.list_control_operations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.list_control_operations_input.ListControlOperationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.list_control_operations_input.serialize_json(input_)
    ).encode()
