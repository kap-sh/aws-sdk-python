...
def build_request(
    ...
    input: aws_sdk_controltower.types.list_control_operations_input.ListControlOperationsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.list_control_operations_input.serialize_json(input)
    ).encode()
