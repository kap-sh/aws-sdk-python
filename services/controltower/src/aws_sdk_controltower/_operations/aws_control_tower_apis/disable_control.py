...
def handle_response(
    ...
    out: aws_sdk_controltower.types.disable_control_output.DisableControlOutput = (
        aws_sdk_controltower.types.disable_control_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_controltower.types.disable_control_input.DisableControlInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.disable_control_input.serialize_json(input_)
    ).encode()
