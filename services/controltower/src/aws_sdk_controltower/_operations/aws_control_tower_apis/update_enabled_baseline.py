...
def build_request(
    ...
    input: aws_sdk_controltower.types.update_enabled_baseline_input.UpdateEnabledBaselineInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.update_enabled_baseline_input.serialize_json(input)
    ).encode()
