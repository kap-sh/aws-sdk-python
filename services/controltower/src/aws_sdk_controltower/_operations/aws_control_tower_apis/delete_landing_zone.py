...
def build_request(
    ...
    input_: aws_sdk_controltower.types.delete_landing_zone_input.DeleteLandingZoneInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.delete_landing_zone_input.serialize_json(input_)
    ).encode()
