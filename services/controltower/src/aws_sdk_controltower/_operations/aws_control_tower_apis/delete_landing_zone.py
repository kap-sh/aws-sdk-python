...
def build_request(
    ...
    input: aws_sdk_controltower.types.delete_landing_zone_input.DeleteLandingZoneInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_controltower.types.delete_landing_zone_input.serialize_json(input)
    ).encode()
