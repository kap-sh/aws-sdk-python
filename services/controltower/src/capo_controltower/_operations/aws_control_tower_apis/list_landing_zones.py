...
def handle_response(
    ...
    out: capo_controltower.types.list_landing_zones_output.ListLandingZonesOutput = (
        capo_controltower.types.list_landing_zones_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_controltower.types.list_landing_zones_input.serialize_json(input_)
    ).encode()
