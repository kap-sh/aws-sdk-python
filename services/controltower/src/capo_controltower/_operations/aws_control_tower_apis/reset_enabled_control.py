...
def handle_response(
    ...
    out: capo_controltower.types.reset_enabled_control_output.ResetEnabledControlOutput = capo_controltower.types.reset_enabled_control_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_controltower.types.reset_enabled_control_input.serialize_json(input_)
    ).encode()
