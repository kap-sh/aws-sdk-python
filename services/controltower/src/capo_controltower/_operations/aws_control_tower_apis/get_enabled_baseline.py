"""Generated from Smithy shape ``com.amazonaws.controltower#GetEnabledBaseline``."""
...
def handle_response(
    ...
    out: capo_controltower.types.get_enabled_baseline_output.GetEnabledBaselineOutput = capo_controltower.types.get_enabled_baseline_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_controltower.types.get_enabled_baseline_input.serialize_json(input_)
    ).encode()
...
async def async_get_enabled_baseline(
