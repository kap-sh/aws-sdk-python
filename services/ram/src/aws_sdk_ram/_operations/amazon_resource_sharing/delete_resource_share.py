...
def handle_response(
    ...
    out: aws_sdk_ram.types.delete_resource_share_response.DeleteResourceShareResponse = aws_sdk_ram.types.delete_resource_share_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_ram.types.delete_resource_share_request.DeleteResourceShareRequest,
) -> zapros.Request:
