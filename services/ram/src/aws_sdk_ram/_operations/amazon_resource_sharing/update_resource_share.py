...
def handle_response(
    ...
    out: aws_sdk_ram.types.update_resource_share_response.UpdateResourceShareResponse = aws_sdk_ram.types.update_resource_share_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.update_resource_share_request.UpdateResourceShareRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.update_resource_share_request.serialize_json(input_)
    ).encode()
