...
def build_request(
    ...
    input: aws_sdk_ram.types.replace_permission_associations_request.ReplacePermissionAssociationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.replace_permission_associations_request.serialize_json(input)
    ).encode()
