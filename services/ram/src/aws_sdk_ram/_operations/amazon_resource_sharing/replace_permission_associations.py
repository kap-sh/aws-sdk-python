...
def build_request(
    ...
    input_: aws_sdk_ram.types.replace_permission_associations_request.ReplacePermissionAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.replace_permission_associations_request.serialize_json(input_)
    ).encode()
