...
def build_request(
    ...
    input: aws_sdk_ram.types.list_permission_versions_request.ListPermissionVersionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.list_permission_versions_request.serialize_json(input)
    ).encode()
