...
def build_request(
    ...
    input: aws_sdk_ram.types.reject_resource_share_invitation_request.RejectResourceShareInvitationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.reject_resource_share_invitation_request.serialize_json(input)
    ).encode()
