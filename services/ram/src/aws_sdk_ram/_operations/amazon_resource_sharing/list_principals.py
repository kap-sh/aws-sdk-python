...
def handle_response(
    ...
    out: aws_sdk_ram.types.list_principals_response.ListPrincipalsResponse = (
        aws_sdk_ram.types.list_principals_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.list_principals_request.ListPrincipalsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.list_principals_request.serialize_json(input_)
    ).encode()
...
def list_principals(
    ...
    aws_sdk_ram.types.list_principals_response.ListPrincipalsResponse, zapros.Response
]:
