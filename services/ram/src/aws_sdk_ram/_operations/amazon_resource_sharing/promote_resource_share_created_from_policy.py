...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnmatchedPolicyPermissionException":
            import aws_sdk_ram.errors.unmatched_policy_permission_exception

            raise aws_sdk_ram.errors.unmatched_policy_permission_exception.UnmatchedPolicyPermissionException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ram.types.promote_resource_share_created_from_policy_response.PromoteResourceShareCreatedFromPolicyResponse = aws_sdk_ram.types.promote_resource_share_created_from_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_ram.types.promote_resource_share_created_from_policy_request.PromoteResourceShareCreatedFromPolicyRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "resource_share_arn" in input:
        params["resourceShareArn"] = str(input["resource_share_arn"])
