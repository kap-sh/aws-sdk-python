"""Generated from Smithy shape ``com.amazonaws.ram#ListPermissionAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_ram.types.list_permission_associations_response.ListPermissionAssociationsResponse = aws_sdk_ram.types.list_permission_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.list_permission_associations_request.ListPermissionAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/listpermissionassociations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.list_permission_associations_request.serialize_json(input_)
    ).encode()
...
async def async_list_permission_associations(
