"""Generated from Smithy shape ``com.amazonaws.ram#TagResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceArnNotFoundException":
            import aws_sdk_ram.errors.resource_arn_not_found_exception

            raise aws_sdk_ram.errors.resource_arn_not_found_exception.ResourceArnNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ram.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ram.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_ram.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
