"""Generated from Smithy shape ``com.amazonaws.ram#ListResources``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResourceTypeException":
            import aws_sdk_ram.errors.invalid_resource_type_exception

            raise aws_sdk_ram.errors.invalid_resource_type_exception.InvalidResourceTypeException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ram.types.list_resources_response.ListResourcesResponse = (
        aws_sdk_ram.types.list_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.list_resources_request.ListResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.list_resources_request.serialize_json(input_)
    ).encode()
...
def list_resources(
    ...
    aws_sdk_ram.types.list_resources_response.ListResourcesResponse, zapros.Response
]:
