...
def build_request(
    ...
    input: aws_sdk_ram.types.get_resource_share_associations_request.GetResourceShareAssociationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.get_resource_share_associations_request.serialize_json(input)
    ).encode()
