...
def handle_response(
    ...
    out: aws_sdk_ram.types.get_resource_share_associations_response.GetResourceShareAssociationsResponse = aws_sdk_ram.types.get_resource_share_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.get_resource_share_associations_request.GetResourceShareAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.get_resource_share_associations_request.serialize_json(input_)
    ).encode()
