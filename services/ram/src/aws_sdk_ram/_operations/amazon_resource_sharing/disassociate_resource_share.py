"""Generated from Smithy shape ``com.amazonaws.ram#DisassociateResourceShare``."""
...
def handle_response(
    ...
    out: aws_sdk_ram.types.disassociate_resource_share_response.DisassociateResourceShareResponse = aws_sdk_ram.types.disassociate_resource_share_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.disassociate_resource_share_request.DisassociateResourceShareRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/disassociateresourceshare"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.disassociate_resource_share_request.serialize_json(input_)
    ).encode()
...
async def async_disassociate_resource_share(
