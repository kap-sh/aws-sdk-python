"""Generated from Smithy shape ``com.amazonaws.ram#AssociateResourceSharePermission``."""
...
def handle_response(
    ...
    out: aws_sdk_ram.types.associate_resource_share_permission_response.AssociateResourceSharePermissionResponse = aws_sdk_ram.types.associate_resource_share_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.associate_resource_share_permission_request.AssociateResourceSharePermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_associate_resource_share_permission(
