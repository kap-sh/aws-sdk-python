...
def handle_response(
    ...
    out: aws_sdk_ram.types.enable_sharing_with_aws_organization_response.EnableSharingWithAwsOrganizationResponse = aws_sdk_ram.types.enable_sharing_with_aws_organization_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.enable_sharing_with_aws_organization_request.EnableSharingWithAwsOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
