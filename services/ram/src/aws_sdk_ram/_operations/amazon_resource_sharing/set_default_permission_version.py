...
def handle_response(
    ...
    out: aws_sdk_ram.types.set_default_permission_version_response.SetDefaultPermissionVersionResponse = aws_sdk_ram.types.set_default_permission_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.set_default_permission_version_request.SetDefaultPermissionVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.set_default_permission_version_request.serialize_json(input_)
    ).encode()
