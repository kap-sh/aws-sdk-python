...
def build_request(
    ...
    input: aws_sdk_ram.types.set_default_permission_version_request.SetDefaultPermissionVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.set_default_permission_version_request.serialize_json(input)
    ).encode()
