...
def build_request(
    ...
    input: aws_sdk_ram.types.list_source_associations_request.ListSourceAssociationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.list_source_associations_request.serialize_json(input)
    ).encode()
