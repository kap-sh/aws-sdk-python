...
def handle_response(
    ...
    out: aws_sdk_ram.types.list_source_associations_response.ListSourceAssociationsResponse = aws_sdk_ram.types.list_source_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.list_source_associations_request.ListSourceAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.list_source_associations_request.serialize_json(input_)
    ).encode()
