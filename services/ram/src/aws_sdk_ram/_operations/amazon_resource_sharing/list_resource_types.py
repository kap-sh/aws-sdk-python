...
def handle_response(
    ...
    out: aws_sdk_ram.types.list_resource_types_response.ListResourceTypesResponse = (
        aws_sdk_ram.types.list_resource_types_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.list_resource_types_request.ListResourceTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.list_resource_types_request.serialize_json(input_)
    ).encode()
