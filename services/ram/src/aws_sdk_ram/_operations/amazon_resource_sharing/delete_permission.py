"""Generated from Smithy shape ``com.amazonaws.ram#DeletePermission``."""
...
def handle_response(
    ...
    out: aws_sdk_ram.types.delete_permission_response.DeletePermissionResponse = (
        aws_sdk_ram.types.delete_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.delete_permission_request.DeletePermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/deletepermission"
    params: dict[str, str] = {}
...
async def async_delete_permission(
