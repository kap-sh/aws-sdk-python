"""Generated from Smithy shape ``com.amazonaws.ram#GetResourcePolicies``."""
...
def handle_response(
    ...
    out: aws_sdk_ram.types.get_resource_policies_response.GetResourcePoliciesResponse = aws_sdk_ram.types.get_resource_policies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.get_resource_policies_request.GetResourcePoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.get_resource_policies_request.serialize_json(input_)
    ).encode()
