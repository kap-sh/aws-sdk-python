"""Generated from Smithy shape ``com.amazonaws.ram#GetPermission``."""
...
def handle_response(
    ...
    out: aws_sdk_ram.types.get_permission_response.GetPermissionResponse = (
        aws_sdk_ram.types.get_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.get_permission_request.GetPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/getpermission"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ram.types.get_permission_request

    body: bytes | None = json.dumps(
        aws_sdk_ram.types.get_permission_request.serialize_json(input_)
    ).encode()
...
def get_permission(
    ...
    aws_sdk_ram.types.get_permission_response.GetPermissionResponse, zapros.Response
]:
