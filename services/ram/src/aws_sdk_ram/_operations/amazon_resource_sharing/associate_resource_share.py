...
def build_request(
    ...
    input: aws_sdk_ram.types.associate_resource_share_request.AssociateResourceShareRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.associate_resource_share_request.serialize_json(input)
    ).encode()
