...
def handle_response(
    ...
    out: aws_sdk_ram.types.associate_resource_share_response.AssociateResourceShareResponse = aws_sdk_ram.types.associate_resource_share_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.associate_resource_share_request.AssociateResourceShareRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.associate_resource_share_request.serialize_json(input_)
    ).encode()
