...
def handle_response(
    ...
    out: aws_sdk_ram.types.list_replace_permission_associations_work_response.ListReplacePermissionAssociationsWorkResponse = aws_sdk_ram.types.list_replace_permission_associations_work_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.list_replace_permission_associations_work_request.ListReplacePermissionAssociationsWorkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.list_replace_permission_associations_work_request.serialize_json(
            input_
        )
    ).encode()
