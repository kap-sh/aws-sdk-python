"""Generated from Smithy shape ``com.amazonaws.ram#DisassociateResourceSharePermission``."""
...
def handle_response(
    ...
    out: aws_sdk_ram.types.disassociate_resource_share_permission_response.DisassociateResourceSharePermissionResponse = aws_sdk_ram.types.disassociate_resource_share_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.disassociate_resource_share_permission_request.DisassociateResourceSharePermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/disassociateresourcesharepermission"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.disassociate_resource_share_permission_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_disassociate_resource_share_permission(
