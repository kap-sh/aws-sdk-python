...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PermissionVersionsLimitExceededException":
            import aws_sdk_ram.errors.permission_versions_limit_exceeded_exception

            raise aws_sdk_ram.errors.permission_versions_limit_exceeded_exception.PermissionVersionsLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ram.types.create_permission_version_response.CreatePermissionVersionResponse = aws_sdk_ram.types.create_permission_version_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_ram.types.create_permission_version_request.CreatePermissionVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.create_permission_version_request.serialize_json(input)
    ).encode()
