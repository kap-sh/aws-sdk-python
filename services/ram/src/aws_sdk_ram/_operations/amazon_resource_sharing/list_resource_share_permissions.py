...
def handle_response(
    ...
    out: aws_sdk_ram.types.list_resource_share_permissions_response.ListResourceSharePermissionsResponse = aws_sdk_ram.types.list_resource_share_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ram.types.list_resource_share_permissions_request.ListResourceSharePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.list_resource_share_permissions_request.serialize_json(input_)
    ).encode()
