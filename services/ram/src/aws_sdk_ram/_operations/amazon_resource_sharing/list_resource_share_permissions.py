...
def build_request(
    ...
    input: aws_sdk_ram.types.list_resource_share_permissions_request.ListResourceSharePermissionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ram.types.list_resource_share_permissions_request.serialize_json(input)
    ).encode()
