...
class GetResourceSharesResponse(TypedDict):
    resource_shares: NotRequired[
        "aws_sdk_ram.types.resource_share_list.ResourceShareList"
    ]
...
def serialize_json(value: GetResourceSharesResponse) -> dict:
    ...
    if "resource_shares" in value:
        ...
        out["resourceShares"] = aws_sdk_ram.types.resource_share_list.serialize_json(
...
def deserialize_json(data: dict) -> GetResourceSharesResponse:
    ...
    if "resourceShares" in data:
        ...
        out["resource_shares"] = aws_sdk_ram.types.resource_share_list.deserialize_json(
            data["resourceShares"]
        )
