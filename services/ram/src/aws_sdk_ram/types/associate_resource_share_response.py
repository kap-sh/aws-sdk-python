"""Generated from Smithy shape ``com.amazonaws.ram#AssociateResourceShareResponse``."""
...
class AssociateResourceShareResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: AssociateResourceShareResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> AssociateResourceShareResponse:
    out: AssociateResourceShareResponse = {}  # type: ignore[typeddict-item]
