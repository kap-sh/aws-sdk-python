...
if TYPE_CHECKING:
    import aws_sdk_ram.types.associated_source_list
    import aws_sdk_ram.types.string


class ListSourceAssociationsResponse(TypedDict):
    source_associations: NotRequired[
        "aws_sdk_ram.types.associated_source_list.AssociatedSourceList"
    ]
...
def serialize_json(value: ListSourceAssociationsResponse) -> dict:
    ...
    if "source_associations" in value:
        ...
        out["sourceAssociations"] = (
            aws_sdk_ram.types.associated_source_list.serialize_json(
...
def deserialize_json(data: dict) -> ListSourceAssociationsResponse:
    ...
    if "sourceAssociations" in data:
        ...
        out["source_associations"] = (
            aws_sdk_ram.types.associated_source_list.deserialize_json(
