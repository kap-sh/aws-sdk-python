"""Generated from Smithy shape ``com.amazonaws.ram#ListResourceTypesRequest``."""
...
class ListResourceTypesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListResourceTypesRequest) -> dict:
    out: dict = {}
    ...
    if "resource_region_scope" in value:
        ...
        out["resourceRegionScope"] = (
            capo_ram.types.resource_region_scope_filter.serialize_json(
...
def deserialize_json(data: dict) -> ListResourceTypesRequest:
    ...
    if "resourceRegionScope" in data:
        ...
        out["resource_region_scope"] = (
            capo_ram.types.resource_region_scope_filter.deserialize_json(
