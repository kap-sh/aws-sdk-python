...
class ListPrincipalsResponse(TypedDict, closed=True):
    principals: NotRequired["capo_ram.types.principal_list.PrincipalList"]
...
def serialize_json(value: ListPrincipalsResponse) -> dict:
    ...
    if "principals" in value:
        ...
        out["principals"] = capo_ram.types.principal_list.serialize_json(
            value["principals"]
        )
