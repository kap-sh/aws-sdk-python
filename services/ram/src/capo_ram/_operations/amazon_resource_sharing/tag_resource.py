...
import capo_ram.errors.resource_arn_not_found_exception
import capo_ram.errors.server_internal_exception
import capo_ram.errors.service_unavailable_exception
import capo_ram.errors.tag_limit_exceeded_exception
import capo_ram.errors.tag_policy_violation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceArnNotFoundException":
            raise capo_ram.errors.resource_arn_not_found_exception.ResourceArnNotFoundException.from_json(
                data
            )
        ...
        case "TagLimitExceededException":
            raise capo_ram.errors.tag_limit_exceeded_exception.TagLimitExceededException.from_json(
                data
            )
        case "TagPolicyViolationException":
            raise capo_ram.errors.tag_policy_violation_exception.TagPolicyViolationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_ram.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: capo_ram.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    input_: capo_ram.types.tag_resource_request.TagResourceRequest,
) -> tuple[capo_ram.types.tag_resource_response.TagResourceResponse, zapros.Response]:
