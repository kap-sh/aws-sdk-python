...
def handle_response(
    ...
    out: capo_ram.types.associate_resource_share_permission_response.AssociateResourceSharePermissionResponse = capo_ram.types.associate_resource_share_permission_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.associate_resource_share_permission_request.serialize_json(
            input_
        )
    ).encode()
