...
def handle_response(
    ...
    out: capo_ram.types.disassociate_resource_share_permission_response.DisassociateResourceSharePermissionResponse = capo_ram.types.disassociate_resource_share_permission_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.disassociate_resource_share_permission_request.serialize_json(
            input_
        )
    ).encode()
