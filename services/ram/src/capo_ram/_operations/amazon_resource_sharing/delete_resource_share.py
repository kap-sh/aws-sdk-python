"""Generated from Smithy shape ``com.amazonaws.ram#DeleteResourceShare``."""
...
def handle_response(
    ...
    out: capo_ram.types.delete_resource_share_response.DeleteResourceShareResponse = (
        capo_ram.types.delete_resource_share_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/deleteresourceshare"
    params: dict[str, str] = {}
...
async def async_delete_resource_share(
