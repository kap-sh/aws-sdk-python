...
def handle_response(
    ...
    out: capo_ram.types.list_permissions_response.ListPermissionsResponse = (
        capo_ram.types.list_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.list_permissions_request.serialize_json(input_)
    ).encode()
...
def list_permissions(
    ...
    capo_ram.types.list_permissions_response.ListPermissionsResponse, zapros.Response
]:
