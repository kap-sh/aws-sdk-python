"""Generated from Smithy shape ``com.amazonaws.ram#PromoteResourceShareCreatedFromPolicy``."""
...
import capo_ram.errors.missing_required_parameter_exception
...
import capo_ram.errors.unmatched_policy_permission_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MissingRequiredParameterException":
            raise capo_ram.errors.missing_required_parameter_exception.MissingRequiredParameterException.from_json(
                data
            )
        ...
        case "UnmatchedPolicyPermissionException":
            raise capo_ram.errors.unmatched_policy_permission_exception.UnmatchedPolicyPermissionException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_ram.types.promote_resource_share_created_from_policy_response.PromoteResourceShareCreatedFromPolicyResponse = capo_ram.types.promote_resource_share_created_from_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/promoteresourcesharecreatedfrompolicy"
    params: dict[str, str] = {}
    if "resource_share_arn" in input_:
        params["resourceShareArn"] = str(input_["resource_share_arn"])
...
async def async_promote_resource_share_created_from_policy(
