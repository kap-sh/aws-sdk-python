"""Generated from Smithy shape ``com.amazonaws.ram#CreatePermission``."""
...
import capo_ram.errors.invalid_policy_exception
import capo_ram.errors.malformed_policy_template_exception
import capo_ram.errors.operation_not_permitted_exception
import capo_ram.errors.permission_already_exists_exception
import capo_ram.errors.permission_limit_exceeded_exception
...
import capo_ram.types.resource_share_permission_summary
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPolicyException":
            raise capo_ram.errors.invalid_policy_exception.InvalidPolicyException.from_json(
                data
            )
        case "MalformedPolicyTemplateException":
            raise capo_ram.errors.malformed_policy_template_exception.MalformedPolicyTemplateException.from_json(
                data
            )
        ...
        case "PermissionAlreadyExistsException":
            raise capo_ram.errors.permission_already_exists_exception.PermissionAlreadyExistsException.from_json(
                data
            )
        case "PermissionLimitExceededException":
            raise capo_ram.errors.permission_limit_exceeded_exception.PermissionLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_ram.types.create_permission_response.CreatePermissionResponse = (
        capo_ram.types.create_permission_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/createpermission"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_ram.types.create_permission_request.serialize_json(input_)
    ).encode()
...
def create_permission(
    ...
    capo_ram.types.create_permission_response.CreatePermissionResponse, zapros.Response
]:
...
async def async_create_permission(
