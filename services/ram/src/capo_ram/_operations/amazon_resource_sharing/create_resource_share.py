...
def handle_response(
    ...
    out: capo_ram.types.create_resource_share_response.CreateResourceShareResponse = (
        capo_ram.types.create_resource_share_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.create_resource_share_request.serialize_json(input_)
    ).encode()
