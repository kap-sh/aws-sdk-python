...
def handle_response(
    ...
    out: capo_ram.types.list_permission_versions_response.ListPermissionVersionsResponse = capo_ram.types.list_permission_versions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.list_permission_versions_request.serialize_json(input_)
    ).encode()
