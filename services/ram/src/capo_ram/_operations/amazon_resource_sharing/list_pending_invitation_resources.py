...
def handle_response(
    ...
    out: capo_ram.types.list_pending_invitation_resources_response.ListPendingInvitationResourcesResponse = capo_ram.types.list_pending_invitation_resources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.list_pending_invitation_resources_request.serialize_json(input_)
    ).encode()
