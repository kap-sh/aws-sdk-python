...
import capo_ram.errors.invalid_resource_type_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResourceTypeException":
            raise capo_ram.errors.invalid_resource_type_exception.InvalidResourceTypeException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_ram.types.list_resources_response.ListResourcesResponse = (
        capo_ram.types.list_resources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.list_resources_request.serialize_json(input_)
    ).encode()
...
def list_resources(
    ...
    capo_ram.types.list_resources_response.ListResourcesResponse, zapros.Response
]:
