...
def handle_response(
    ...
    out: capo_ram.types.disassociate_resource_share_response.DisassociateResourceShareResponse = capo_ram.types.disassociate_resource_share_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.disassociate_resource_share_request.serialize_json(input_)
    ).encode()
