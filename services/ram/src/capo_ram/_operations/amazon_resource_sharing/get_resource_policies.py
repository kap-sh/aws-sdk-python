...
def handle_response(
    ...
    out: capo_ram.types.get_resource_policies_response.GetResourcePoliciesResponse = (
        capo_ram.types.get_resource_policies_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.get_resource_policies_request.serialize_json(input_)
    ).encode()
