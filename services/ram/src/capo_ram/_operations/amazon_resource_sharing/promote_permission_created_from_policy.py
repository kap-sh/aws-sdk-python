"""Generated from Smithy shape ``com.amazonaws.ram#PromotePermissionCreatedFromPolicy``."""
...
def handle_response(
    ...
    out: capo_ram.types.promote_permission_created_from_policy_response.PromotePermissionCreatedFromPolicyResponse = capo_ram.types.promote_permission_created_from_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.promote_permission_created_from_policy_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_promote_permission_created_from_policy(
