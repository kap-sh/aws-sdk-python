"""Generated from Smithy shape ``com.amazonaws.ram#CreatePermissionVersion``."""
...
import capo_ram.errors.permission_versions_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PermissionVersionsLimitExceededException":
            raise capo_ram.errors.permission_versions_limit_exceeded_exception.PermissionVersionsLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_ram.types.create_permission_version_response.CreatePermissionVersionResponse = capo_ram.types.create_permission_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.create_permission_version_request.serialize_json(input_)
    ).encode()
...
async def async_create_permission_version(
