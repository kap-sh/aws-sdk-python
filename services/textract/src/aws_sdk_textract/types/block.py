...
if TYPE_CHECKING:
    import aws_sdk_textract.types.block_type
    import aws_sdk_textract.types.entity_types
...
class Block(TypedDict, closed=True):
    ...
    text_type: NotRequired["aws_sdk_textract.types.text_type.TextType"]
    """<p>The kind of text that Amazon Textract has detected. Can check for handwritten text and printed text.</p>"""
    row_index: NotRequired["aws_sdk_textract.types.u_integer.UInteger"]
    ...
    column_index: NotRequired["aws_sdk_textract.types.u_integer.UInteger"]
    ...
    row_span: NotRequired["aws_sdk_textract.types.u_integer.UInteger"]
    ...
    column_span: NotRequired["aws_sdk_textract.types.u_integer.UInteger"]
    ...
    id: NotRequired["aws_sdk_textract.types.non_empty_string.NonEmptyString"]
    """<p>The identifier for the recognized text. The identifier is only unique for a single operation. </p>"""
    relationships: NotRequired[
        "aws_sdk_textract.types.relationship_list.RelationshipList"
    ]
    ...
    entity_types: NotRequired["aws_sdk_textract.types.entity_types.EntityTypes"]
    ...
    query: NotRequired["aws_sdk_textract.types.query.Query"]
    """<p></p>"""
...
def serialize_aws_json_1_1(value: Block) -> dict:
    ...
    if "block_type" in value:
        ...
        out["BlockType"] = aws_sdk_textract.types.block_type.serialize_aws_json_1_1(
            value["block_type"]
        )
    ...
    if "text_type" in value:
        ...
        out["TextType"] = aws_sdk_textract.types.text_type.serialize_aws_json_1_1(
            value["text_type"]
        )
    ...
    if "relationships" in value:
        ...
        out["Relationships"] = (
            aws_sdk_textract.types.relationship_list.serialize_aws_json_1_1(
                value["relationships"]
            )
        )
    if "entity_types" in value:
        ...
        out["EntityTypes"] = aws_sdk_textract.types.entity_types.serialize_aws_json_1_1(
            value["entity_types"]
        )
    ...
    if "query" in value:
        ...
        out["Query"] = aws_sdk_textract.types.query.serialize_aws_json_1_1(
            value["query"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Block:
    ...
    if "BlockType" in data:
        ...
        out["block_type"] = aws_sdk_textract.types.block_type.deserialize_aws_json_1_1(
            data["BlockType"]
        )
    ...
    if "TextType" in data:
        ...
        out["text_type"] = aws_sdk_textract.types.text_type.deserialize_aws_json_1_1(
            data["TextType"]
        )
    if "RowIndex" in data:
    ...
    if "Relationships" in data:
        ...
        out["relationships"] = (
            aws_sdk_textract.types.relationship_list.deserialize_aws_json_1_1(
                data["Relationships"]
            )
        )
    if "EntityTypes" in data:
        ...
        out["entity_types"] = (
            aws_sdk_textract.types.entity_types.deserialize_aws_json_1_1(
                data["EntityTypes"]
            )
        )
    ...
    if "Query" in data:
        ...
        out["query"] = aws_sdk_textract.types.query.deserialize_aws_json_1_1(
            data["Query"]
        )
    return out
