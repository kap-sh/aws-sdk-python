...
if TYPE_CHECKING:
    import aws_sdk_textract.types.expense_group_property

ExpenseGroupPropertyList: TypeAlias = list[
    "aws_sdk_textract.types.expense_group_property.ExpenseGroupProperty"
]
...
def serialize_aws_json_1_1(value: ExpenseGroupPropertyList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_textract.types.expense_group_property.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ExpenseGroupPropertyList:
    ...
    for item in data:
        out.append(
            aws_sdk_textract.types.expense_group_property.deserialize_aws_json_1_1(item)
        )
    return out
