...
def serialize_aws_json_1_1(value: Relationship) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = aws_sdk_textract.types.relationship_type.serialize_aws_json_1_1(
            value["type"]
        )
    if "ids" in value:
        import aws_sdk_textract.types.id_list

        out["Ids"] = aws_sdk_textract.types.id_list.serialize_aws_json_1_1(value["ids"])
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Relationship:
    ...
    if "Type" in data:
        ...
        out["type"] = aws_sdk_textract.types.relationship_type.deserialize_aws_json_1_1(
            data["Type"]
        )
    if "Ids" in data:
        import aws_sdk_textract.types.id_list

        out["ids"] = aws_sdk_textract.types.id_list.deserialize_aws_json_1_1(
            data["Ids"]
        )
    return out
