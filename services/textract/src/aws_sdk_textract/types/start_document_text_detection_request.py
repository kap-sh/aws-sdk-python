"""Generated from Smithy shape ``com.amazonaws.textract#StartDocumentTextDetectionRequest``."""
...
class StartDocumentTextDetectionRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StartDocumentTextDetectionRequest) -> dict:
    out: dict = {}
    import aws_sdk_textract.types.document_location
...
def deserialize_aws_json_1_1(data: dict) -> StartDocumentTextDetectionRequest:
    out: StartDocumentTextDetectionRequest = {}  # type: ignore[typeddict-item]
    if "DocumentLocation" in data:
        ...
        raise DeserializationError(
            "StartDocumentTextDetectionRequest.document_location required"
        )
