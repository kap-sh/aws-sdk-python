...
if TYPE_CHECKING:
    import aws_sdk_textract.types.flow_definition_arn
    import aws_sdk_textract.types.human_loop_data_attributes
...
class HumanLoopConfig(TypedDict, closed=True):
    ...
    data_attributes: NotRequired[
        "aws_sdk_textract.types.human_loop_data_attributes.HumanLoopDataAttributes"
    ]
...
def serialize_aws_json_1_1(value: HumanLoopConfig) -> dict:
    ...
    if "data_attributes" in value:
        ...
        out["DataAttributes"] = (
            aws_sdk_textract.types.human_loop_data_attributes.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> HumanLoopConfig:
    ...
    if "DataAttributes" in data:
        ...
        out["data_attributes"] = (
            aws_sdk_textract.types.human_loop_data_attributes.deserialize_aws_json_1_1(
                data["DataAttributes"]
            )
        )
    return out
