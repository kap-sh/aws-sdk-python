...
if TYPE_CHECKING:
    ...
    import aws_sdk_textract.types.line_item_group_list
...
class ExpenseDocument(TypedDict, closed=True):
    ...
    line_item_groups: NotRequired[
        "aws_sdk_textract.types.line_item_group_list.LineItemGroupList"
    ]
...
def serialize_aws_json_1_1(value: ExpenseDocument) -> dict:
    ...
    if "line_item_groups" in value:
        ...
        out["LineItemGroups"] = (
            aws_sdk_textract.types.line_item_group_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ExpenseDocument:
    ...
    if "LineItemGroups" in data:
        ...
        out["line_item_groups"] = (
            aws_sdk_textract.types.line_item_group_list.deserialize_aws_json_1_1(
                data["LineItemGroups"]
            )
        )
    if "Blocks" in data:
