...
def handle_response(
    ...
    out: aws_sdk_textract.types.get_expense_analysis_response.GetExpenseAnalysisResponse = aws_sdk_textract.types.get_expense_analysis_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_textract.types.get_expense_analysis_request.GetExpenseAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_textract.types.get_expense_analysis_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
