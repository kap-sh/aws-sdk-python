...
def handle_response(
    ...
    out: aws_sdk_textract.types.delete_adapter_version_response.DeleteAdapterVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_textract.types.delete_adapter_version_request.DeleteAdapterVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_textract.types.delete_adapter_version_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
