"""Generated from Smithy shape ``com.amazonaws.textract#AnalyzeID``."""
...
def handle_response(
    ...
    out: aws_sdk_textract.types.analyze_id_response.AnalyzeIDResponse = (
        aws_sdk_textract.types.analyze_id_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_textract.types.analyze_id_request.AnalyzeIDRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_textract.types.analyze_id_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def analyze_id(
    ...
    aws_sdk_textract.types.analyze_id_response.AnalyzeIDResponse, zapros.Response
]:
