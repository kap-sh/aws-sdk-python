...
def handle_response(
    ...
    out: aws_sdk_textract.types.update_adapter_response.UpdateAdapterResponse = (
        aws_sdk_textract.types.update_adapter_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_textract.types.update_adapter_request.UpdateAdapterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_textract.types.update_adapter_request.serialize_aws_json_1_1(input_)
    ).encode()
