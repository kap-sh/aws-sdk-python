...
def build_request(
    ...
    input_: aws_sdk_textract.types.analyze_document_request.AnalyzeDocumentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_textract.types.analyze_document_request.serialize_aws_json_1_1(input_)
    ).encode()
