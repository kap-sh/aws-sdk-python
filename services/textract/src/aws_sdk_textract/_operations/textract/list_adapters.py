...
def build_request(
    ...
    input_: aws_sdk_textract.types.list_adapters_request.ListAdaptersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_textract.types.list_adapters_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_adapters(
    ...
    aws_sdk_textract.types.list_adapters_response.ListAdaptersResponse, zapros.Response
]:
