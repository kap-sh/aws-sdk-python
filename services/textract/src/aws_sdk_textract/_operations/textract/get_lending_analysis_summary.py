...
def handle_response(
    ...
    out: aws_sdk_textract.types.get_lending_analysis_summary_response.GetLendingAnalysisSummaryResponse = aws_sdk_textract.types.get_lending_analysis_summary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_textract.types.get_lending_analysis_summary_request.GetLendingAnalysisSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_textract.types.get_lending_analysis_summary_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
