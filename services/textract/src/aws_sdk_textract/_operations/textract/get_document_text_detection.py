...
def handle_response(
    ...
    out: aws_sdk_textract.types.get_document_text_detection_response.GetDocumentTextDetectionResponse = aws_sdk_textract.types.get_document_text_detection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_textract.types.get_document_text_detection_request.GetDocumentTextDetectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_textract.types.get_document_text_detection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
