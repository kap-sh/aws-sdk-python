"""Generated from Smithy shape ``com.amazonaws.textract#AnalyzeExpense``."""
...
def handle_response(
    ...
    out: aws_sdk_textract.types.analyze_expense_response.AnalyzeExpenseResponse = (
        aws_sdk_textract.types.analyze_expense_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_textract.types.analyze_expense_request.AnalyzeExpenseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_textract.types.analyze_expense_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_analyze_expense(
