...
def handle_response(
    ...
    out: aws_sdk_textract.types.get_document_analysis_response.GetDocumentAnalysisResponse = aws_sdk_textract.types.get_document_analysis_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_textract.types.get_document_analysis_request.GetDocumentAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_textract.types.get_document_analysis_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
