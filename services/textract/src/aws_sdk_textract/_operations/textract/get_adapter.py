"""Generated from Smithy shape ``com.amazonaws.textract#GetAdapter``."""
...
def handle_response(
    ...
    out: aws_sdk_textract.types.get_adapter_response.GetAdapterResponse = (
        aws_sdk_textract.types.get_adapter_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_textract.types.get_adapter_request.GetAdapterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Textract.GetAdapter"
    import aws_sdk_textract.types.get_adapter_request

    body: bytes | None = json.dumps(
        aws_sdk_textract.types.get_adapter_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_adapter(
    ...
    aws_sdk_textract.types.get_adapter_response.GetAdapterResponse, zapros.Response
]:
