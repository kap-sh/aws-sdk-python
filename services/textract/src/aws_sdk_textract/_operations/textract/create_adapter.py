"""Generated from Smithy shape ``com.amazonaws.textract#CreateAdapter``."""
...
import aws_sdk_textract.errors.conflict_exception
import aws_sdk_textract.errors.idempotent_parameter_mismatch_exception
import aws_sdk_textract.errors.internal_server_error
import aws_sdk_textract.errors.invalid_parameter_exception
import aws_sdk_textract.errors.limit_exceeded_exception
import aws_sdk_textract.errors.provisioned_throughput_exceeded_exception
import aws_sdk_textract.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_textract.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
        case "IdempotentParameterMismatchException":
            raise aws_sdk_textract.errors.idempotent_parameter_mismatch_exception.IdempotentParameterMismatchException.from_aws_json_1_1(
                data
            )
        ...
        case "LimitExceededException":
            raise aws_sdk_textract.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_textract.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_textract.types.create_adapter_response.CreateAdapterResponse = (
        aws_sdk_textract.types.create_adapter_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_textract.types.create_adapter_request.CreateAdapterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Textract.CreateAdapter"
    import aws_sdk_textract.types.create_adapter_request

    body: bytes | None = json.dumps(
        aws_sdk_textract.types.create_adapter_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_adapter(
