...
def build_request(
    ...
    input_: aws_sdk_textract.types.get_adapter_version_request.GetAdapterVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_textract.types.get_adapter_version_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
