...
def handle_response(
    ...
    out: aws_sdk_textract.types.get_adapter_version_response.GetAdapterVersionResponse = aws_sdk_textract.types.get_adapter_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_textract.types.get_adapter_version_request.GetAdapterVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_textract.types.get_adapter_version_request.serialize_aws_json_1_1(input)
    ).encode()
