"""Generated from Smithy shape ``com.amazonaws.textract#DeleteAdapter``."""
...
def handle_response(
    ...
    out: aws_sdk_textract.types.delete_adapter_response.DeleteAdapterResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_textract.types.delete_adapter_request.DeleteAdapterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Textract.DeleteAdapter"
    import aws_sdk_textract.types.delete_adapter_request

    body: bytes | None = json.dumps(
        aws_sdk_textract.types.delete_adapter_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_adapter(
