"""Generated from Smithy shape ``com.amazonaws.textract#TagResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            import aws_sdk_textract.errors.resource_not_found_exception

            raise aws_sdk_textract.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_textract.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_textract.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Textract.TagResource"
    import aws_sdk_textract.types.tag_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_textract.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_textract.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
