"""Generated from Smithy shape ``com.amazonaws.textract#ListAdapterVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_textract.types.list_adapter_versions_response.ListAdapterVersionsResponse = aws_sdk_textract.types.list_adapter_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_textract.types.list_adapter_versions_request.ListAdapterVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Textract.ListAdapterVersions"
    import aws_sdk_textract.types.list_adapter_versions_request

    body: bytes | None = json.dumps(
        aws_sdk_textract.types.list_adapter_versions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_adapter_versions(
