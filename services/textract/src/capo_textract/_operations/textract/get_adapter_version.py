"""Generated from Smithy shape ``com.amazonaws.textract#GetAdapterVersion``."""
...
def handle_response(
    ...
    out: capo_textract.types.get_adapter_version_response.GetAdapterVersionResponse = (
        capo_textract.types.get_adapter_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Textract.GetAdapterVersion"
    body: bytes | None = json.dumps(
        capo_textract.types.get_adapter_version_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_adapter_version(
