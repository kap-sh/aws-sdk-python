...
def handle_response(
    ...
    out: capo_textract.types.detect_document_text_response.DetectDocumentTextResponse = capo_textract.types.detect_document_text_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_textract.types.detect_document_text_request.serialize_aws_json_1_1(input_)
    ).encode()
