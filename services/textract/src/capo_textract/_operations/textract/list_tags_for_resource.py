"""Generated from Smithy shape ``com.amazonaws.textract#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_textract.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_textract.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Textract.ListTagsForResource"
    body: bytes | None = json.dumps(
        capo_textract.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
