"""Generated from Smithy shape ``com.amazonaws.textract#GetDocumentTextDetection``."""
...
def handle_response(
    ...
    out: capo_textract.types.get_document_text_detection_response.GetDocumentTextDetectionResponse = capo_textract.types.get_document_text_detection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_textract.types.get_document_text_detection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_document_text_detection(
