"""Generated from Smithy shape ``com.amazonaws.textract#UpdateAdapter``."""
...
import capo_textract.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_textract.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_textract.types.update_adapter_response.UpdateAdapterResponse = (
        capo_textract.types.update_adapter_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Textract.UpdateAdapter"
    body: bytes | None = json.dumps(
        capo_textract.types.update_adapter_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_adapter(
    ...
    capo_textract.types.update_adapter_response.UpdateAdapterResponse, zapros.Response
]:
...
async def async_update_adapter(
