...
import capo_textract.errors.conflict_exception
...
import capo_textract.errors.service_quota_exceeded_exception
import capo_textract.errors.throttling_exception
import capo_textract.errors.validation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_textract.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_textract.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data
            )
        ...
        case "ValidationException":
            raise capo_textract.errors.validation_exception.ValidationException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_textract.types.create_adapter_response.CreateAdapterResponse = (
        capo_textract.types.create_adapter_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_textract.types.create_adapter_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_adapter(
    ...
    capo_textract.types.create_adapter_response.CreateAdapterResponse, zapros.Response
]:
