"""Generated from Smithy shape ``com.amazonaws.textract#GetExpenseAnalysis``."""
...
def handle_response(
    ...
    out: capo_textract.types.get_expense_analysis_response.GetExpenseAnalysisResponse = capo_textract.types.get_expense_analysis_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Textract.GetExpenseAnalysis"
    body: bytes | None = json.dumps(
        capo_textract.types.get_expense_analysis_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_expense_analysis(
