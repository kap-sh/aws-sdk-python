"""Generated from Smithy shape ``com.amazonaws.textract#ListAdapters``."""
...
def handle_response(
    ...
    out: capo_textract.types.list_adapters_response.ListAdaptersResponse = (
        capo_textract.types.list_adapters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Textract.ListAdapters"
    body: bytes | None = json.dumps(
        capo_textract.types.list_adapters_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_adapters(
    ...
    capo_textract.types.list_adapters_response.ListAdaptersResponse, zapros.Response
]:
