"""Generated from Smithy shape ``com.amazonaws.textract#GetLendingAnalysisSummary``."""
...
import capo_textract.errors.invalid_job_id_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidJobIdException":
            raise capo_textract.errors.invalid_job_id_exception.InvalidJobIdException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_textract.types.get_lending_analysis_summary_response.GetLendingAnalysisSummaryResponse = capo_textract.types.get_lending_analysis_summary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Textract.GetLendingAnalysisSummary"
    body: bytes | None = json.dumps(
        capo_textract.types.get_lending_analysis_summary_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_lending_analysis_summary(
