"""Generated from Smithy shape ``com.amazonaws.textract#StartLendingAnalysis``."""
...
def handle_response(
    ...
    out: capo_textract.types.start_lending_analysis_response.StartLendingAnalysisResponse = capo_textract.types.start_lending_analysis_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Textract.StartLendingAnalysis"
    body: bytes | None = json.dumps(
        capo_textract.types.start_lending_analysis_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_lending_analysis(
