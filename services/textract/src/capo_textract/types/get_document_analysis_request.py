"""Generated from Smithy shape ``com.amazonaws.textract#GetDocumentAnalysisRequest``."""
...
class GetDocumentAnalysisRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetDocumentAnalysisRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetDocumentAnalysisRequest:
    out: GetDocumentAnalysisRequest = {}  # type: ignore[typeddict-item]
    if "JobId" in data:
        out["job_id"] = data["JobId"]
    else:
        raise DeserializationError("GetDocumentAnalysisRequest.job_id required")
