...
class TextractError(Exception):
    """Base class for all Textract service errors."""


class ServiceError(TextractError):
...
class SerializationError(TextractError):
    """Raised when a value cannot be serialized."""


class DeserializationError(TextractError):
...
class WaiterFailedError(TextractError):
...
class WaiterTimeoutError(TextractError):
