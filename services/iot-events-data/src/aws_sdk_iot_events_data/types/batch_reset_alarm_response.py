"""Generated from Smithy shape ``com.amazonaws.ioteventsdata#BatchResetAlarmResponse``."""
...
class BatchResetAlarmResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: BatchResetAlarmResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> BatchResetAlarmResponse:
    out: BatchResetAlarmResponse = {}  # type: ignore[typeddict-item]
