"""Generated from Smithy shape ``com.amazonaws.ioteventsdata#ResetAlarmActionRequest``."""
...
class ResetAlarmActionRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ResetAlarmActionRequest) -> dict:
    out: dict = {}
