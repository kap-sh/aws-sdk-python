...
from aws_sdk_iot_events_data._services._aws_config import aws_config
...
class IoTEventsDataClientConfig(TypedDict, total=False):
...
class IoTEventsDataClient:
    ...
    def batch_acknowledge_alarm(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_events_data.types.batch_acknowledge_alarm_request.BatchAcknowledgeAlarmRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_events_data.types.batch_acknowledge_alarm_response.BatchAcknowledgeAlarmResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_events_data._operations.iot_columbo_data_service.batch_acknowledge_alarm.batch_acknowledge_alarm(
    ...
    def batch_delete_detector(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_events_data.types.batch_delete_detector_request.BatchDeleteDetectorRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_events_data.types.batch_delete_detector_response.BatchDeleteDetectorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_events_data._operations.iot_columbo_data_service.batch_delete_detector.batch_delete_detector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_disable_alarm(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_events_data.types.batch_disable_alarm_request.BatchDisableAlarmRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_events_data.types.batch_disable_alarm_response.BatchDisableAlarmResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_events_data._operations.iot_columbo_data_service.batch_disable_alarm.batch_disable_alarm(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_enable_alarm(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_events_data.types.batch_enable_alarm_request.BatchEnableAlarmRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_events_data.types.batch_enable_alarm_response.BatchEnableAlarmResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_events_data._operations.iot_columbo_data_service.batch_enable_alarm.batch_enable_alarm(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_put_message(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_events_data.types.batch_put_message_request.BatchPutMessageRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_events_data.types.batch_put_message_response.BatchPutMessageResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_events_data._operations.iot_columbo_data_service.batch_put_message.batch_put_message(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_reset_alarm(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_events_data.types.batch_reset_alarm_request.BatchResetAlarmRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_events_data.types.batch_reset_alarm_response.BatchResetAlarmResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_events_data._operations.iot_columbo_data_service.batch_reset_alarm.batch_reset_alarm(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_snooze_alarm(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_events_data.types.batch_snooze_alarm_request.BatchSnoozeAlarmRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_events_data.types.batch_snooze_alarm_response.BatchSnoozeAlarmResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_events_data._operations.iot_columbo_data_service.batch_snooze_alarm.batch_snooze_alarm(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_update_detector(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_events_data.types.batch_update_detector_request.BatchUpdateDetectorRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_events_data.types.batch_update_detector_response.BatchUpdateDetectorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_events_data._operations.iot_columbo_data_service.batch_update_detector.batch_update_detector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_alarm(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_events_data.types.describe_alarm_request.DescribeAlarmRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_events_data.types.describe_alarm_response.DescribeAlarmResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_events_data._operations.iot_columbo_data_service.describe_alarm.describe_alarm(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_detector(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_events_data.types.describe_detector_request.DescribeDetectorRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_events_data.types.describe_detector_response.DescribeDetectorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_events_data._operations.iot_columbo_data_service.describe_detector.describe_detector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_alarms(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_events_data.types.list_alarms_request.ListAlarmsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_events_data.types.list_alarms_response.ListAlarmsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_events_data._operations.iot_columbo_data_service.list_alarms.list_alarms(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_detectors(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_events_data.types.list_detectors_request.ListDetectorsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_events_data.types.list_detectors_response.ListDetectorsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iot_events_data._operations.iot_columbo_data_service.list_detectors.list_detectors(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
