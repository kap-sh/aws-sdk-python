...
def handle_response(
    ...
    out: aws_sdk_iot_events_data.types.list_detectors_response.ListDetectorsResponse = (
        aws_sdk_iot_events_data.types.list_detectors_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot_events_data.types.list_detectors_request.ListDetectorsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "state_name" in input:
        params["stateName"] = str(input["state_name"])
