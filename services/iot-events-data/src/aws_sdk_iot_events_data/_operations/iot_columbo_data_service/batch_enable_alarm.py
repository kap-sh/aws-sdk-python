...
def handle_response(
    ...
    out: aws_sdk_iot_events_data.types.batch_enable_alarm_response.BatchEnableAlarmResponse = aws_sdk_iot_events_data.types.batch_enable_alarm_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events_data.types.batch_enable_alarm_request.BatchEnableAlarmRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events_data.types.batch_enable_alarm_request.serialize_json(input_)
    ).encode()
