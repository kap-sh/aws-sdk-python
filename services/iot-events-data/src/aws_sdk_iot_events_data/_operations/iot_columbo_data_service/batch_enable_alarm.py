...
def build_request(
    ...
    input: aws_sdk_iot_events_data.types.batch_enable_alarm_request.BatchEnableAlarmRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events_data.types.batch_enable_alarm_request.serialize_json(input)
    ).encode()
