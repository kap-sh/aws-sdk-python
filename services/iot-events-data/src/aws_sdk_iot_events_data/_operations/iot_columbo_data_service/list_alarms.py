...
def handle_response(
    ...
    out: aws_sdk_iot_events_data.types.list_alarms_response.ListAlarmsResponse = (
        aws_sdk_iot_events_data.types.list_alarms_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events_data.types.list_alarms_request.ListAlarmsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
