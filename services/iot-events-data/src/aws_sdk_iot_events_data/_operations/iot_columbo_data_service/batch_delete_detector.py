...
def handle_response(
    ...
    out: aws_sdk_iot_events_data.types.batch_delete_detector_response.BatchDeleteDetectorResponse = aws_sdk_iot_events_data.types.batch_delete_detector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events_data.types.batch_delete_detector_request.BatchDeleteDetectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events_data.types.batch_delete_detector_request.serialize_json(
            input_
        )
    ).encode()
