...
def handle_response(
    ...
    out: aws_sdk_iot_events_data.types.batch_put_message_response.BatchPutMessageResponse = aws_sdk_iot_events_data.types.batch_put_message_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events_data.types.batch_put_message_request.BatchPutMessageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events_data.types.batch_put_message_request.serialize_json(input_)
    ).encode()
