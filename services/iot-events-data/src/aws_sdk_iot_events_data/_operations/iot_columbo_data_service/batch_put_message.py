...
def build_request(
    ...
    input: aws_sdk_iot_events_data.types.batch_put_message_request.BatchPutMessageRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events_data.types.batch_put_message_request.serialize_json(input)
    ).encode()
