...
def handle_response(
    ...
    out: aws_sdk_iot_events_data.types.describe_alarm_response.DescribeAlarmResponse = (
        aws_sdk_iot_events_data.types.describe_alarm_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events_data.types.describe_alarm_request.DescribeAlarmRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
