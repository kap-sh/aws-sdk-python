...
def build_request(
    ...
    input: aws_sdk_iot_events_data.types.batch_disable_alarm_request.BatchDisableAlarmRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events_data.types.batch_disable_alarm_request.serialize_json(input)
    ).encode()
