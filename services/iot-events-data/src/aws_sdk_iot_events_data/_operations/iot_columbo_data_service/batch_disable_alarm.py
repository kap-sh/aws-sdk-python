...
def handle_response(
    ...
    out: aws_sdk_iot_events_data.types.batch_disable_alarm_response.BatchDisableAlarmResponse = aws_sdk_iot_events_data.types.batch_disable_alarm_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events_data.types.batch_disable_alarm_request.BatchDisableAlarmRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events_data.types.batch_disable_alarm_request.serialize_json(input_)
    ).encode()
