...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            import aws_sdk_iot_events_data.errors.resource_not_found_exception

            raise aws_sdk_iot_events_data.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_iot_events_data.types.describe_detector_response.DescribeDetectorResponse = aws_sdk_iot_events_data.types.describe_detector_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot_events_data.types.describe_detector_request.DescribeDetectorRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "key_value" in input:
        params["keyValue"] = str(input["key_value"])
