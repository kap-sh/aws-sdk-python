"""Generated from Smithy shape ``com.amazonaws.ioteventsdata#BatchResetAlarm``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_events_data.types.batch_reset_alarm_response.BatchResetAlarmResponse = aws_sdk_iot_events_data.types.batch_reset_alarm_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot_events_data.types.batch_reset_alarm_request.BatchResetAlarmRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events_data.types.batch_reset_alarm_request.serialize_json(input)
    ).encode()
...
async def async_batch_reset_alarm(
