...
def build_request(
    ...
    input: aws_sdk_iot_events_data.types.batch_snooze_alarm_request.BatchSnoozeAlarmRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events_data.types.batch_snooze_alarm_request.serialize_json(input)
    ).encode()
