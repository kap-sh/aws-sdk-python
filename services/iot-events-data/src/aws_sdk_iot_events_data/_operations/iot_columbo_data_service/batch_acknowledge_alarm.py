...
def handle_response(
    ...
    out: aws_sdk_iot_events_data.types.batch_acknowledge_alarm_response.BatchAcknowledgeAlarmResponse = aws_sdk_iot_events_data.types.batch_acknowledge_alarm_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_events_data.types.batch_acknowledge_alarm_request.BatchAcknowledgeAlarmRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_events_data.types.batch_acknowledge_alarm_request.serialize_json(
            input_
        )
    ).encode()
