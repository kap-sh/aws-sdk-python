"""Generated from Smithy shape ``com.amazonaws.ioteventsdata#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ioteventsdata#ResourceNotFoundException``."""
