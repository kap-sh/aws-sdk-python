"""Generated from Smithy shape ``com.amazonaws.ioteventsdata#BatchAcknowledgeAlarmResponse``."""
...
class BatchAcknowledgeAlarmResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: BatchAcknowledgeAlarmResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> BatchAcknowledgeAlarmResponse:
    out: BatchAcknowledgeAlarmResponse = {}  # type: ignore[typeddict-item]
