...
class ListAlarmsResponse(TypedDict, closed=True):
    alarm_summaries: NotRequired[
        "capo_iot_events_data.types.alarm_summaries.AlarmSummaries"
    ]
...
def serialize_json(value: ListAlarmsResponse) -> dict:
    ...
    if "alarm_summaries" in value:
        ...
        out["alarmSummaries"] = (
            capo_iot_events_data.types.alarm_summaries.serialize_json(
...
def deserialize_json(data: dict) -> ListAlarmsResponse:
    ...
    if "alarmSummaries" in data:
        ...
        out["alarm_summaries"] = (
            capo_iot_events_data.types.alarm_summaries.deserialize_json(
                data["alarmSummaries"]
            )
        )
