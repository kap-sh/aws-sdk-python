...
class IoTEventsDataError(Exception):
    """Base class for all IoTEventsData service errors."""


class ServiceError(IoTEventsDataError):
...
class SerializationError(IoTEventsDataError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IoTEventsDataError):
...
class WaiterFailedError(IoTEventsDataError):
...
class WaiterTimeoutError(IoTEventsDataError):
