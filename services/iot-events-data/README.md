...
```
pip install aws-sdk-iot-events-data
```

## Usage

```python
from aws_sdk_iot_events_data import AsyncIoTEventsDataClient
...
```python
from aws_sdk_iot_events_data import AsyncIoTEventsDataClient
from aws_sdk_iot_events_data.error import InternalFailureException
