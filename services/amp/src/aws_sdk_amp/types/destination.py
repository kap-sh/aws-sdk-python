...
if TYPE_CHECKING:
    import aws_sdk_amp.types.amp_configuration


class _Destination_ampConfiguration(TypedDict):
    ampConfiguration: "aws_sdk_amp.types.amp_configuration.AmpConfiguration"
...
def serialize_json(value: Destination) -> dict:
    if "ampConfiguration" in value:
        ...
        return {
            "ampConfiguration": aws_sdk_amp.types.amp_configuration.serialize_json(
...
def deserialize_json(data: dict) -> Destination:
    if "ampConfiguration" in data:
        ...
        return {
            "ampConfiguration": aws_sdk_amp.types.amp_configuration.deserialize_json(
