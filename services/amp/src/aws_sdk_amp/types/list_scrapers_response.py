...
if TYPE_CHECKING:
    ...
    import aws_sdk_amp.types.scraper_summary_list


class ListScrapersResponse(TypedDict):
    scrapers: "aws_sdk_amp.types.scraper_summary_list.ScraperSummaryList"
...
def serialize_json(value: ListScrapersResponse) -> dict:
    ...
    out["scrapers"] = aws_sdk_amp.types.scraper_summary_list.serialize_json(
        value["scrapers"]
    )
...
def deserialize_json(data: dict) -> ListScrapersResponse:
    ...
    if "scrapers" in data:
        ...
        out["scrapers"] = aws_sdk_amp.types.scraper_summary_list.deserialize_json(
            data["scrapers"]
        )
    else:
