"""Generated from Smithy shape ``com.amazonaws.amp#UpdateLoggingConfiguration``."""
...
if TYPE_CHECKING:
    import aws_sdk_amp.types.update_logging_configuration_request
    import aws_sdk_amp.types.update_logging_configuration_response
...
) -> aws_sdk_amp.types.update_logging_configuration_response.UpdateLoggingConfigurationResponse:
    import aws_sdk_amp.types.update_logging_configuration_response

    out: aws_sdk_amp.types.update_logging_configuration_response.UpdateLoggingConfigurationResponse = aws_sdk_amp.types.update_logging_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.update_logging_configuration_request.UpdateLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.update_logging_configuration_request.serialize_json(input_)
    ).encode()
