...
def build_request(
    ...
    input: aws_sdk_amp.types.update_logging_configuration_request.UpdateLoggingConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.update_logging_configuration_request.serialize_json(input)
    ).encode()
