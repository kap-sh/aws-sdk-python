...
def build_request(
    ...
    input: aws_sdk_amp.types.describe_scraper_logging_configuration_request.DescribeScraperLoggingConfigurationRequest,
) -> zapros.Request:
    ...
    url = url.replace("{scraperId}", quote(str(input["scraper_id"]), safe=""))
    params: dict[str, str] = {}
