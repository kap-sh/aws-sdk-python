...
if TYPE_CHECKING:
    import aws_sdk_amp.types.describe_scraper_logging_configuration_request
    import aws_sdk_amp.types.describe_scraper_logging_configuration_response
...
) -> aws_sdk_amp.types.describe_scraper_logging_configuration_response.DescribeScraperLoggingConfigurationResponse:
    import aws_sdk_amp.types.describe_scraper_logging_configuration_response

    out: aws_sdk_amp.types.describe_scraper_logging_configuration_response.DescribeScraperLoggingConfigurationResponse = aws_sdk_amp.types.describe_scraper_logging_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.describe_scraper_logging_configuration_request.DescribeScraperLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
