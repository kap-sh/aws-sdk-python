...
if TYPE_CHECKING:
    import aws_sdk_amp.types.delete_alert_manager_definition_request
...
def build_request(
    ...
    input_: aws_sdk_amp.types.delete_alert_manager_definition_request.DeleteAlertManagerDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
