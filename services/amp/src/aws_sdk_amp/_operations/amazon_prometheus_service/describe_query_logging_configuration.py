...
import aws_sdk_amp.types.describe_query_logging_configuration_request
import aws_sdk_amp.types.describe_query_logging_configuration_response
...
) -> aws_sdk_amp.types.describe_query_logging_configuration_response.DescribeQueryLoggingConfigurationResponse:
    out: aws_sdk_amp.types.describe_query_logging_configuration_response.DescribeQueryLoggingConfigurationResponse = aws_sdk_amp.types.describe_query_logging_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.describe_query_logging_configuration_request.DescribeQueryLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
