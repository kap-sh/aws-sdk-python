...
def build_request(
    ...
    input: aws_sdk_amp.types.create_rule_groups_namespace_request.CreateRuleGroupsNamespaceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.create_rule_groups_namespace_request.serialize_json(input)
    ).encode()
