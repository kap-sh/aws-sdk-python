...
if TYPE_CHECKING:
    import aws_sdk_amp.types.create_rule_groups_namespace_request
    import aws_sdk_amp.types.create_rule_groups_namespace_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_amp.errors.service_quota_exceeded_exception

            raise aws_sdk_amp.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
) -> aws_sdk_amp.types.create_rule_groups_namespace_response.CreateRuleGroupsNamespaceResponse:
    import aws_sdk_amp.types.create_rule_groups_namespace_response

    out: aws_sdk_amp.types.create_rule_groups_namespace_response.CreateRuleGroupsNamespaceResponse = aws_sdk_amp.types.create_rule_groups_namespace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.create_rule_groups_namespace_request.CreateRuleGroupsNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.create_rule_groups_namespace_request.serialize_json(input_)
    ).encode()
