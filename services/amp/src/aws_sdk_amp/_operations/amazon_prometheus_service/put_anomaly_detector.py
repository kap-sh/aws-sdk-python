...
if TYPE_CHECKING:
    import aws_sdk_amp.types.put_anomaly_detector_request
    import aws_sdk_amp.types.put_anomaly_detector_response
...
) -> aws_sdk_amp.types.put_anomaly_detector_response.PutAnomalyDetectorResponse:
    import aws_sdk_amp.types.put_anomaly_detector_response

    out: aws_sdk_amp.types.put_anomaly_detector_response.PutAnomalyDetectorResponse = (
        aws_sdk_amp.types.put_anomaly_detector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.put_anomaly_detector_request.PutAnomalyDetectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.put_anomaly_detector_request.serialize_json(input_)
    ).encode()
