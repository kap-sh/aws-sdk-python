...
def build_request(
    ...
    input: aws_sdk_amp.types.put_anomaly_detector_request.PutAnomalyDetectorRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{anomalyDetectorId}", quote(str(input["anomaly_detector_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.put_anomaly_detector_request.serialize_json(input)
    ).encode()
