...
def handle_response(
    ...
    out: aws_sdk_amp.types.create_scraper_response.CreateScraperResponse = (
        aws_sdk_amp.types.create_scraper_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.create_scraper_request.CreateScraperRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.create_scraper_request.serialize_json(input_)
    ).encode()
...
def create_scraper(
    ...
    aws_sdk_amp.types.create_scraper_response.CreateScraperResponse, zapros.Response
]:
