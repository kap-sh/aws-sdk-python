...
def handle_response(
    ...
    out: aws_sdk_amp.types.delete_scraper_response.DeleteScraperResponse = (
        aws_sdk_amp.types.delete_scraper_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.delete_scraper_request.DeleteScraperRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_scraper(
    ...
    aws_sdk_amp.types.delete_scraper_response.DeleteScraperResponse, zapros.Response
]:
