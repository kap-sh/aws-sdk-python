...
if TYPE_CHECKING:
    import aws_sdk_amp.types.delete_rule_groups_namespace_request
...
def build_request(
    ...
    input_: aws_sdk_amp.types.delete_rule_groups_namespace_request.DeleteRuleGroupsNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
