"""Generated from Smithy shape ``com.amazonaws.amp#UpdateScraper``."""
...
def handle_response(
    ...
    out: aws_sdk_amp.types.update_scraper_response.UpdateScraperResponse = (
        aws_sdk_amp.types.update_scraper_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.update_scraper_request.UpdateScraperRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.update_scraper_request.serialize_json(input_)
    ).encode()
...
def update_scraper(
    ...
    aws_sdk_amp.types.update_scraper_response.UpdateScraperResponse, zapros.Response
]:
...
async def async_update_scraper(
