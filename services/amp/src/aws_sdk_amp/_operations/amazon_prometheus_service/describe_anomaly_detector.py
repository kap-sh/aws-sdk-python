"""Generated from Smithy shape ``com.amazonaws.amp#DescribeAnomalyDetector``."""
...
if TYPE_CHECKING:
    import aws_sdk_amp.types.describe_anomaly_detector_request
    import aws_sdk_amp.types.describe_anomaly_detector_response
...
def handle_response(
    ...
    aws_sdk_amp.types.describe_anomaly_detector_response.DescribeAnomalyDetectorResponse
):
    import aws_sdk_amp.types.describe_anomaly_detector_response

    out: aws_sdk_amp.types.describe_anomaly_detector_response.DescribeAnomalyDetectorResponse = aws_sdk_amp.types.describe_anomaly_detector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.describe_anomaly_detector_request.DescribeAnomalyDetectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_anomaly_detector(
