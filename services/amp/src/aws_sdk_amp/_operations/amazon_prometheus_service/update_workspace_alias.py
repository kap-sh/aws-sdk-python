...
def build_request(
    ...
    input_: aws_sdk_amp.types.update_workspace_alias_request.UpdateWorkspaceAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.update_workspace_alias_request.serialize_json(input_)
    ).encode()
