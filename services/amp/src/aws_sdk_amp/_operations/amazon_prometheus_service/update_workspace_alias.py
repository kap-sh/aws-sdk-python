...
def build_request(
    ...
    input: aws_sdk_amp.types.update_workspace_alias_request.UpdateWorkspaceAliasRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.update_workspace_alias_request.serialize_json(input)
    ).encode()
