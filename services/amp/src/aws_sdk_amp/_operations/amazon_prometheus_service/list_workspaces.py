...
def handle_response(
    ...
    out: aws_sdk_amp.types.list_workspaces_response.ListWorkspacesResponse = (
        aws_sdk_amp.types.list_workspaces_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.list_workspaces_request.ListWorkspacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_workspaces(
    ...
    aws_sdk_amp.types.list_workspaces_response.ListWorkspacesResponse, zapros.Response
]:
