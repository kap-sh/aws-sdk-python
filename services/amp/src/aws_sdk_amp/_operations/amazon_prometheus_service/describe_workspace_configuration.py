...
if TYPE_CHECKING:
    import aws_sdk_amp.types.describe_workspace_configuration_request
    import aws_sdk_amp.types.describe_workspace_configuration_response
...
) -> aws_sdk_amp.types.describe_workspace_configuration_response.DescribeWorkspaceConfigurationResponse:
    import aws_sdk_amp.types.describe_workspace_configuration_response

    out: aws_sdk_amp.types.describe_workspace_configuration_response.DescribeWorkspaceConfigurationResponse = aws_sdk_amp.types.describe_workspace_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.describe_workspace_configuration_request.DescribeWorkspaceConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
