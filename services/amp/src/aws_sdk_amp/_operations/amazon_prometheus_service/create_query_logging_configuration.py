...
if TYPE_CHECKING:
    import aws_sdk_amp.types.create_query_logging_configuration_request
    import aws_sdk_amp.types.create_query_logging_configuration_response
...
) -> aws_sdk_amp.types.create_query_logging_configuration_response.CreateQueryLoggingConfigurationResponse:
    import aws_sdk_amp.types.create_query_logging_configuration_response

    out: aws_sdk_amp.types.create_query_logging_configuration_response.CreateQueryLoggingConfigurationResponse = aws_sdk_amp.types.create_query_logging_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.create_query_logging_configuration_request.CreateQueryLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.create_query_logging_configuration_request.serialize_json(
            input_
        )
    ).encode()
