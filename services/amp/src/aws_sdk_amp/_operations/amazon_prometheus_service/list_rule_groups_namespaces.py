"""Generated from Smithy shape ``com.amazonaws.amp#ListRuleGroupsNamespaces``."""
...
if TYPE_CHECKING:
    import aws_sdk_amp.types.list_rule_groups_namespaces_request
    import aws_sdk_amp.types.list_rule_groups_namespaces_response
...
) -> aws_sdk_amp.types.list_rule_groups_namespaces_response.ListRuleGroupsNamespacesResponse:
    import aws_sdk_amp.types.list_rule_groups_namespaces_response

    out: aws_sdk_amp.types.list_rule_groups_namespaces_response.ListRuleGroupsNamespacesResponse = aws_sdk_amp.types.list_rule_groups_namespaces_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.list_rule_groups_namespaces_request.ListRuleGroupsNamespacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_rule_groups_namespaces(
