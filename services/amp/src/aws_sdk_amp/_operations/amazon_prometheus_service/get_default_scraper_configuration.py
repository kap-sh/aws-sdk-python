...
def handle_response(
    ...
    out: aws_sdk_amp.types.get_default_scraper_configuration_response.GetDefaultScraperConfigurationResponse = aws_sdk_amp.types.get_default_scraper_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.get_default_scraper_configuration_request.GetDefaultScraperConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
