...
def handle_response(
    ...
    out: aws_sdk_amp.types.list_scrapers_response.ListScrapersResponse = (
        aws_sdk_amp.types.list_scrapers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.list_scrapers_request.ListScrapersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_scrapers(
    ...
    aws_sdk_amp.types.list_scrapers_response.ListScrapersResponse, zapros.Response
]:
