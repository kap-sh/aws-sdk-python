"""Generated from Smithy shape ``com.amazonaws.amp#DeleteScraperLoggingConfiguration``."""
...
if TYPE_CHECKING:
    import aws_sdk_amp.types.delete_scraper_logging_configuration_request
...
def build_request(
    ...
    input_: aws_sdk_amp.types.delete_scraper_logging_configuration_request.DeleteScraperLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_scraper_logging_configuration(
