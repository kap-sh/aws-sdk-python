...
def build_request(
    ...
    input: aws_sdk_amp.types.create_logging_configuration_request.CreateLoggingConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.create_logging_configuration_request.serialize_json(input)
    ).encode()
