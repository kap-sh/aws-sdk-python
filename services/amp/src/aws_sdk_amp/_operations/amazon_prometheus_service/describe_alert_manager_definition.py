...
import aws_sdk_amp.types.describe_alert_manager_definition_request
import aws_sdk_amp.types.describe_alert_manager_definition_response
...
) -> aws_sdk_amp.types.describe_alert_manager_definition_response.DescribeAlertManagerDefinitionResponse:
    out: aws_sdk_amp.types.describe_alert_manager_definition_response.DescribeAlertManagerDefinitionResponse = aws_sdk_amp.types.describe_alert_manager_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.describe_alert_manager_definition_request.DescribeAlertManagerDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
