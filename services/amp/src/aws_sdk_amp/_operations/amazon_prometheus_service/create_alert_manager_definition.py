...
import aws_sdk_amp.types.create_alert_manager_definition_request
import aws_sdk_amp.types.create_alert_manager_definition_response
...
) -> aws_sdk_amp.types.create_alert_manager_definition_response.CreateAlertManagerDefinitionResponse:
    out: aws_sdk_amp.types.create_alert_manager_definition_response.CreateAlertManagerDefinitionResponse = aws_sdk_amp.types.create_alert_manager_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.create_alert_manager_definition_request.CreateAlertManagerDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.create_alert_manager_definition_request.serialize_json(input_)
    ).encode()
