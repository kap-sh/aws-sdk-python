...
def handle_response(
    ...
    out: aws_sdk_amp.types.describe_scraper_response.DescribeScraperResponse = (
        aws_sdk_amp.types.describe_scraper_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.describe_scraper_request.DescribeScraperRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_scraper(
    ...
    aws_sdk_amp.types.describe_scraper_response.DescribeScraperResponse, zapros.Response
]:
