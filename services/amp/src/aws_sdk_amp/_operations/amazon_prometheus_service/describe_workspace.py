...
def handle_response(
    ...
    out: aws_sdk_amp.types.describe_workspace_response.DescribeWorkspaceResponse = (
        aws_sdk_amp.types.describe_workspace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.describe_workspace_request.DescribeWorkspaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
