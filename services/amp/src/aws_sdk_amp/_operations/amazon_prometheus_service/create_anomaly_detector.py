...
def build_request(
    ...
    input: aws_sdk_amp.types.create_anomaly_detector_request.CreateAnomalyDetectorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.create_anomaly_detector_request.serialize_json(input)
    ).encode()
