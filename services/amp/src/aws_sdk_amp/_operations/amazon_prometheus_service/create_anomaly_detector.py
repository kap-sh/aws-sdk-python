"""Generated from Smithy shape ``com.amazonaws.amp#CreateAnomalyDetector``."""
...
import aws_sdk_amp.types.create_anomaly_detector_request
import aws_sdk_amp.types.create_anomaly_detector_response
...
) -> aws_sdk_amp.types.create_anomaly_detector_response.CreateAnomalyDetectorResponse:
    out: aws_sdk_amp.types.create_anomaly_detector_response.CreateAnomalyDetectorResponse = aws_sdk_amp.types.create_anomaly_detector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.create_anomaly_detector_request.CreateAnomalyDetectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}/anomalydetectors"
    url = url.replace("{workspaceId}", quote(str(input_["workspace_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.create_anomaly_detector_request.serialize_json(input_)
    ).encode()
...
async def async_create_anomaly_detector(
