...
if TYPE_CHECKING:
    import aws_sdk_amp.types.delete_query_logging_configuration_request
...
def build_request(
    ...
    input_: aws_sdk_amp.types.delete_query_logging_configuration_request.DeleteQueryLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
