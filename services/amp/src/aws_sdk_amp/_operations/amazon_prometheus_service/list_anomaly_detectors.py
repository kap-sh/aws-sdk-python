...
if TYPE_CHECKING:
    import aws_sdk_amp.types.list_anomaly_detectors_request
    import aws_sdk_amp.types.list_anomaly_detectors_response
...
) -> aws_sdk_amp.types.list_anomaly_detectors_response.ListAnomalyDetectorsResponse:
    import aws_sdk_amp.types.list_anomaly_detectors_response

    out: aws_sdk_amp.types.list_anomaly_detectors_response.ListAnomalyDetectorsResponse = aws_sdk_amp.types.list_anomaly_detectors_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.list_anomaly_detectors_request.ListAnomalyDetectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
