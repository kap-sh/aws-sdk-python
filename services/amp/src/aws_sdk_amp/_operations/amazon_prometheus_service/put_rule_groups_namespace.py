"""Generated from Smithy shape ``com.amazonaws.amp#PutRuleGroupsNamespace``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_amp.types.put_rule_groups_namespace_response
...
def handle_response(
    ...
    aws_sdk_amp.types.put_rule_groups_namespace_response.PutRuleGroupsNamespaceResponse
):
    import aws_sdk_amp.types.put_rule_groups_namespace_response

    out: aws_sdk_amp.types.put_rule_groups_namespace_response.PutRuleGroupsNamespaceResponse = aws_sdk_amp.types.put_rule_groups_namespace_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amp.types.put_rule_groups_namespace_request.PutRuleGroupsNamespaceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.put_rule_groups_namespace_request.serialize_json(input)
    ).encode()
...
async def async_put_rule_groups_namespace(
