...
def build_request(
    ...
    input: aws_sdk_amp.types.update_workspace_configuration_request.UpdateWorkspaceConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.update_workspace_configuration_request.serialize_json(input)
    ).encode()
