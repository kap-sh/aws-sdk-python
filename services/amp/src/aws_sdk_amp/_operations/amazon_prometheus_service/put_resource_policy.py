...
if TYPE_CHECKING:
    import aws_sdk_amp.types.put_resource_policy_request
    import aws_sdk_amp.types.put_resource_policy_response
...
) -> aws_sdk_amp.types.put_resource_policy_response.PutResourcePolicyResponse:
    import aws_sdk_amp.types.put_resource_policy_response

    out: aws_sdk_amp.types.put_resource_policy_response.PutResourcePolicyResponse = (
        aws_sdk_amp.types.put_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.put_resource_policy_request.PutResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.put_resource_policy_request.serialize_json(input_)
    ).encode()
