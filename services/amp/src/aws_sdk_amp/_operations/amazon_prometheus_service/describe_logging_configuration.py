...
import aws_sdk_amp.types.describe_logging_configuration_request
import aws_sdk_amp.types.describe_logging_configuration_response
import aws_sdk_amp.types.logging_configuration_metadata
...
) -> aws_sdk_amp.types.describe_logging_configuration_response.DescribeLoggingConfigurationResponse:
    out: aws_sdk_amp.types.describe_logging_configuration_response.DescribeLoggingConfigurationResponse = aws_sdk_amp.types.describe_logging_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.describe_logging_configuration_request.DescribeLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
