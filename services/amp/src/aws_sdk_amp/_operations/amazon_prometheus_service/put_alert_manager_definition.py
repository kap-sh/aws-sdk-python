...
if TYPE_CHECKING:
    import aws_sdk_amp.types.put_alert_manager_definition_request
    import aws_sdk_amp.types.put_alert_manager_definition_response
...
) -> aws_sdk_amp.types.put_alert_manager_definition_response.PutAlertManagerDefinitionResponse:
    import aws_sdk_amp.types.put_alert_manager_definition_response

    out: aws_sdk_amp.types.put_alert_manager_definition_response.PutAlertManagerDefinitionResponse = aws_sdk_amp.types.put_alert_manager_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.put_alert_manager_definition_request.PutAlertManagerDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.put_alert_manager_definition_request.serialize_json(input_)
    ).encode()
