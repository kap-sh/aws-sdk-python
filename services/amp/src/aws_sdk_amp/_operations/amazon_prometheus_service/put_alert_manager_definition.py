...
def build_request(
    ...
    input: aws_sdk_amp.types.put_alert_manager_definition_request.PutAlertManagerDefinitionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amp.types.put_alert_manager_definition_request.serialize_json(input)
    ).encode()
