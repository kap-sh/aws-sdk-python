...
if TYPE_CHECKING:
    import aws_sdk_amp.types.describe_resource_policy_request
    import aws_sdk_amp.types.describe_resource_policy_response
...
) -> aws_sdk_amp.types.describe_resource_policy_response.DescribeResourcePolicyResponse:
    import aws_sdk_amp.types.describe_resource_policy_response

    out: aws_sdk_amp.types.describe_resource_policy_response.DescribeResourcePolicyResponse = aws_sdk_amp.types.describe_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amp.types.describe_resource_policy_request.DescribeResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
