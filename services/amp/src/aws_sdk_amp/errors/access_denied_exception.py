"""Generated from Smithy shape ``com.amazonaws.amp#AccessDeniedException``."""

from typing import TypedDict
from aws_sdk_amp.errors import DeserializationError
from aws_sdk_amp.errors import ServiceError
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.amp#AccessDeniedException``."""
