...
class ampError(Exception):
    """Base class for all amp service errors."""


class ServiceError(ampError):
...
class DeserializationError(ampError):
...
class WaiterFailedError(ampError):
...
class WaiterTimeoutError(ampError):
