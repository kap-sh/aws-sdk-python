...
if TYPE_CHECKING:
    import aws_sdk_amp.types.create_workspace_request
    import aws_sdk_amp.types.create_workspace_response
    import aws_sdk_amp.types.delete_workspace_request
    import aws_sdk_amp.types.describe_workspace_request
    import aws_sdk_amp.types.describe_workspace_response
    import aws_sdk_amp.types.idempotency_token
    import aws_sdk_amp.types.kms_key_arn
    import aws_sdk_amp.types.list_workspaces_request
    import aws_sdk_amp.types.list_workspaces_response
    import aws_sdk_amp.types.pagination_token
    import aws_sdk_amp.types.tag_map
    import aws_sdk_amp.types.update_workspace_alias_request
...
class Workspace:
    ...
    def create(
        ...
        *,
        ...
        alias: Optional["aws_sdk_amp.types.workspace_alias.WorkspaceAlias"] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amp.types.create_workspace_request.CreateWorkspaceRequest]",
        ) -> OperationResponse[
            "aws_sdk_amp.types.create_workspace_response.CreateWorkspaceResponse"
        ]:
            import aws_sdk_amp._operations.amazon_prometheus_service.create_workspace

            output, http_response = (
                aws_sdk_amp._operations.amazon_prometheus_service.create_workspace.create_workspace(
    ...
    def read(
        ...
        *,
        config_overrides: Optional[ampClientConfig] = None,
    ) -> "aws_sdk_amp.types.describe_workspace_response.DescribeWorkspaceResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amp.types.describe_workspace_request.DescribeWorkspaceRequest]",
        ) -> OperationResponse[
            "aws_sdk_amp.types.describe_workspace_response.DescribeWorkspaceResponse"
        ]:
            import aws_sdk_amp._operations.amazon_prometheus_service.describe_workspace

            output, http_response = (
                aws_sdk_amp._operations.amazon_prometheus_service.describe_workspace.describe_workspace(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amp.types.update_workspace_alias_request.UpdateWorkspaceAliasRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_amp._operations.amazon_prometheus_service.update_workspace_alias

            output, http_response = (
                aws_sdk_amp._operations.amazon_prometheus_service.update_workspace_alias.update_workspace_alias(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amp.types.delete_workspace_request.DeleteWorkspaceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_amp._operations.amazon_prometheus_service.delete_workspace

            output, http_response = (
                aws_sdk_amp._operations.amazon_prometheus_service.delete_workspace.delete_workspace(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_amp.types.list_workspaces_response.ListWorkspacesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_amp.types.list_workspaces_request.ListWorkspacesRequest]",
        ) -> OperationResponse[
            "aws_sdk_amp.types.list_workspaces_response.ListWorkspacesResponse"
        ]:
            import aws_sdk_amp._operations.amazon_prometheus_service.list_workspaces

            output, http_response = (
                aws_sdk_amp._operations.amazon_prometheus_service.list_workspaces.list_workspaces(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncWorkspace:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_amp.types.create_workspace_request.CreateWorkspaceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_amp.types.create_workspace_response.CreateWorkspaceResponse"
        ]:
            import aws_sdk_amp._operations.amazon_prometheus_service.create_workspace
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_amp._operations.amazon_prometheus_service.create_workspace.async_create_workspace(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_amp.types.describe_workspace_request.DescribeWorkspaceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_amp.types.describe_workspace_response.DescribeWorkspaceResponse"
        ]:
            import aws_sdk_amp._operations.amazon_prometheus_service.describe_workspace
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_amp._operations.amazon_prometheus_service.describe_workspace.async_describe_workspace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_amp.types.update_workspace_alias_request.UpdateWorkspaceAliasRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_amp._operations.amazon_prometheus_service.update_workspace_alias.async_update_workspace_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_amp.types.delete_workspace_request.DeleteWorkspaceRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_amp._operations.amazon_prometheus_service.delete_workspace
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_amp._operations.amazon_prometheus_service.delete_workspace.async_delete_workspace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_amp.types.list_workspaces_request.ListWorkspacesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_amp.types.list_workspaces_response.ListWorkspacesResponse"
        ]:
            import aws_sdk_amp._operations.amazon_prometheus_service.list_workspaces
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_amp._operations.amazon_prometheus_service.list_workspaces.async_list_workspaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
