...
from aws_sdk_amp._services._aws_config import aaws_config
...
class AsyncampClientConfig(TypedDict, total=False):
...
class AsyncampClient:
    ...
    async def get_default_scraper_configuration(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_amp.types.get_default_scraper_configuration_request.GetDefaultScraperConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_amp.types.get_default_scraper_configuration_response.GetDefaultScraperConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_amp._operations.amazon_prometheus_service.get_default_scraper_configuration.async_get_default_scraper_configuration(
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_amp.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_amp.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_amp._operations.amazon_prometheus_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_amp.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_amp.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_amp._operations.amazon_prometheus_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_amp.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_amp.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_amp._operations.amazon_prometheus_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
