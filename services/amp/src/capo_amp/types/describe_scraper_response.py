...
class DescribeScraperResponse(TypedDict, closed=True):
    scraper: "capo_amp.types.scraper_description.ScraperDescription"
...
def serialize_json(value: DescribeScraperResponse) -> dict:
    ...
    out["scraper"] = capo_amp.types.scraper_description.serialize_json(value["scraper"])
    return out
