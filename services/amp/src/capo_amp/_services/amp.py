...
class ampClient:
    ...
    def get_default_scraper_configuration(
        ...
        input_: capo_amp.types.get_default_scraper_configuration_request.GetDefaultScraperConfigurationRequest = {}  # type: ignore[typeddict-item]
    ...
    def list_tags_for_resource(
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_amp.types.list_tags_for_resource_request.ListTagsForResourceRequest = {}  # type: ignore[typeddict-item]
    ...
    def tag_resource(
        ...
        *,
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_amp.types.tag_resource_request.TagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        input_["tags"] = tags
    ...
    def untag_resource(
        ...
        *,
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_amp.types.untag_resource_request.UntagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
