"""Generated from Smithy shape ``com.amazonaws.comprehend#DescribeDominantLanguageDetectionJob``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.describe_dominant_language_detection_job_response.DescribeDominantLanguageDetectionJobResponse = capo_comprehend.types.describe_dominant_language_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.DescribeDominantLanguageDetectionJob"
    body: bytes | None = json.dumps(
        capo_comprehend.types.describe_dominant_language_detection_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_dominant_language_detection_job(
