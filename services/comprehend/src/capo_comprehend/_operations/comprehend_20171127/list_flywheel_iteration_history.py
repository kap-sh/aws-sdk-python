...
import capo_comprehend.errors.invalid_filter_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidFilterException":
            raise capo_comprehend.errors.invalid_filter_exception.InvalidFilterException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_comprehend.types.list_flywheel_iteration_history_response.ListFlywheelIterationHistoryResponse = capo_comprehend.types.list_flywheel_iteration_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_flywheel_iteration_history_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
