...
def handle_response(
    ...
    out: capo_comprehend.types.describe_key_phrases_detection_job_response.DescribeKeyPhrasesDetectionJobResponse = capo_comprehend.types.describe_key_phrases_detection_job_response.deserialize_aws_json_1_1(
