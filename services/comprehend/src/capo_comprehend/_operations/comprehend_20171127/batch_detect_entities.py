"""Generated from Smithy shape ``com.amazonaws.comprehend#BatchDetectEntities``."""
...
import capo_comprehend.types.list_of_detect_entities_result
...
def handle_response(
    ...
    out: capo_comprehend.types.batch_detect_entities_response.BatchDetectEntitiesResponse = capo_comprehend.types.batch_detect_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.batch_detect_entities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_detect_entities(
