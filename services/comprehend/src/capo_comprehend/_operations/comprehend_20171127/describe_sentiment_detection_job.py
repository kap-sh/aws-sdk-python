"""Generated from Smithy shape ``com.amazonaws.comprehend#DescribeSentimentDetectionJob``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.describe_sentiment_detection_job_response.DescribeSentimentDetectionJobResponse = capo_comprehend.types.describe_sentiment_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.describe_sentiment_detection_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_sentiment_detection_job(
