"""Generated from Smithy shape ``com.amazonaws.comprehend#ListTopicsDetectionJobs``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.list_topics_detection_jobs_response.ListTopicsDetectionJobsResponse = capo_comprehend.types.list_topics_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_topics_detection_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_topics_detection_jobs(
