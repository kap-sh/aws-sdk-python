"""Generated from Smithy shape ``com.amazonaws.comprehend#StartEventsDetectionJob``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.start_events_detection_job_response.StartEventsDetectionJobResponse = capo_comprehend.types.start_events_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.StartEventsDetectionJob"
    body: bytes | None = json.dumps(
        capo_comprehend.types.start_events_detection_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_events_detection_job(
