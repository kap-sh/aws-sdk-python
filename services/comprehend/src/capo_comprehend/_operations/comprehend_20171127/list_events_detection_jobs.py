"""Generated from Smithy shape ``com.amazonaws.comprehend#ListEventsDetectionJobs``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.list_events_detection_jobs_response.ListEventsDetectionJobsResponse = capo_comprehend.types.list_events_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.ListEventsDetectionJobs"
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_events_detection_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_events_detection_jobs(
