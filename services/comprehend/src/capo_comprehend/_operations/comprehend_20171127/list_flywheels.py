...
def handle_response(
    ...
    out: capo_comprehend.types.list_flywheels_response.ListFlywheelsResponse = (
        capo_comprehend.types.list_flywheels_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_flywheels_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_flywheels(
    ...
    capo_comprehend.types.list_flywheels_response.ListFlywheelsResponse, zapros.Response
]:
