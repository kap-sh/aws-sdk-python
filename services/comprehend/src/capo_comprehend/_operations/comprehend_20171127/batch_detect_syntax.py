"""Generated from Smithy shape ``com.amazonaws.comprehend#BatchDetectSyntax``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.batch_detect_syntax_response.BatchDetectSyntaxResponse = capo_comprehend.types.batch_detect_syntax_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.batch_detect_syntax_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_batch_detect_syntax(
