...
def handle_response(
    ...
    out: capo_comprehend.types.list_endpoints_response.ListEndpointsResponse = (
        capo_comprehend.types.list_endpoints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_endpoints_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_endpoints(
    ...
    capo_comprehend.types.list_endpoints_response.ListEndpointsResponse, zapros.Response
]:
