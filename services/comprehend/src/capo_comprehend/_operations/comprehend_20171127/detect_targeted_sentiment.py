"""Generated from Smithy shape ``com.amazonaws.comprehend#DetectTargetedSentiment``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.detect_targeted_sentiment_response.DetectTargetedSentimentResponse = capo_comprehend.types.detect_targeted_sentiment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.DetectTargetedSentiment"
    body: bytes | None = json.dumps(
        capo_comprehend.types.detect_targeted_sentiment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_detect_targeted_sentiment(
