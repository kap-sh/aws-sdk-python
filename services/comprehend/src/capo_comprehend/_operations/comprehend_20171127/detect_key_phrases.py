"""Generated from Smithy shape ``com.amazonaws.comprehend#DetectKeyPhrases``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.detect_key_phrases_response.DetectKeyPhrasesResponse = (
        capo_comprehend.types.detect_key_phrases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.detect_key_phrases_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_detect_key_phrases(
