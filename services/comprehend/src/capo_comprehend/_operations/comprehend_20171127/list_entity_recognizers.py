"""Generated from Smithy shape ``com.amazonaws.comprehend#ListEntityRecognizers``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.list_entity_recognizers_response.ListEntityRecognizersResponse = capo_comprehend.types.list_entity_recognizers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_entity_recognizers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_entity_recognizers(
