...
def handle_response(
    ...
    out: capo_comprehend.types.list_document_classifier_summaries_response.ListDocumentClassifierSummariesResponse = capo_comprehend.types.list_document_classifier_summaries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_document_classifier_summaries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
