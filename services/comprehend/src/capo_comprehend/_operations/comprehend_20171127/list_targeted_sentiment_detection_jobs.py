...
def handle_response(
    ...
    out: capo_comprehend.types.list_targeted_sentiment_detection_jobs_response.ListTargetedSentimentDetectionJobsResponse = capo_comprehend.types.list_targeted_sentiment_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_targeted_sentiment_detection_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
