"""Generated from Smithy shape ``com.amazonaws.comprehend#ClassifyDocument``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.classify_document_response.ClassifyDocumentResponse = (
        capo_comprehend.types.classify_document_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.classify_document_request.serialize_aws_json_1_1(input_)
    ).encode()
