...
import capo_comprehend.errors.kms_key_validation_exception
import capo_comprehend.errors.resource_in_use_exception
import capo_comprehend.errors.resource_limit_exceeded_exception
import capo_comprehend.errors.resource_not_found_exception
import capo_comprehend.errors.resource_unavailable_exception
import capo_comprehend.errors.too_many_requests_exception
import capo_comprehend.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "KmsKeyValidationException":
            raise capo_comprehend.errors.kms_key_validation_exception.KmsKeyValidationException.from_aws_json_1_1(
                data
            )
        case "ResourceInUseException":
            raise capo_comprehend.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data
            )
        case "ResourceLimitExceededException":
            raise capo_comprehend.errors.resource_limit_exceeded_exception.ResourceLimitExceededException.from_aws_json_1_1(
                data
            )
        case "ResourceNotFoundException":
            raise capo_comprehend.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
        case "ResourceUnavailableException":
            raise capo_comprehend.errors.resource_unavailable_exception.ResourceUnavailableException.from_aws_json_1_1(
                data
            )
        ...
        case "TooManyTagsException":
            raise capo_comprehend.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_comprehend.types.create_flywheel_response.CreateFlywheelResponse = (
        capo_comprehend.types.create_flywheel_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.create_flywheel_request.serialize_aws_json_1_1(input_)
    ).encode()
