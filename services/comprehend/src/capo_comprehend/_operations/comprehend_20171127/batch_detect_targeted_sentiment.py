"""Generated from Smithy shape ``com.amazonaws.comprehend#BatchDetectTargetedSentiment``."""
...
import capo_comprehend.errors.batch_size_limit_exceeded_exception
...
import capo_comprehend.types.list_of_detect_targeted_sentiment_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BatchSizeLimitExceededException":
            raise capo_comprehend.errors.batch_size_limit_exceeded_exception.BatchSizeLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_comprehend.types.batch_detect_targeted_sentiment_response.BatchDetectTargetedSentimentResponse = capo_comprehend.types.batch_detect_targeted_sentiment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.BatchDetectTargetedSentiment"
    body: bytes | None = json.dumps(
        capo_comprehend.types.batch_detect_targeted_sentiment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_detect_targeted_sentiment(
