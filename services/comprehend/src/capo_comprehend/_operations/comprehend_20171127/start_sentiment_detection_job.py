...
def handle_response(
    ...
    out: capo_comprehend.types.start_sentiment_detection_job_response.StartSentimentDetectionJobResponse = capo_comprehend.types.start_sentiment_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.start_sentiment_detection_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
