...
def handle_response(
    ...
    out: capo_comprehend.types.detect_pii_entities_response.DetectPiiEntitiesResponse = capo_comprehend.types.detect_pii_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.detect_pii_entities_request.serialize_aws_json_1_1(input_)
    ).encode()
