"""Generated from Smithy shape ``com.amazonaws.comprehend#UntagResource``."""
...
import capo_comprehend.errors.concurrent_modification_exception
...
import capo_comprehend.errors.too_many_tag_keys_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentModificationException":
            raise capo_comprehend.errors.concurrent_modification_exception.ConcurrentModificationException.from_aws_json_1_1(
                data
            )
        ...
        case "TooManyTagKeysException":
            raise capo_comprehend.errors.too_many_tag_keys_exception.TooManyTagKeysException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_comprehend.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def untag_resource(
    ...
    capo_comprehend.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
