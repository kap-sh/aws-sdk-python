...
def handle_response(
    ...
    out: capo_comprehend.types.stop_training_document_classifier_response.StopTrainingDocumentClassifierResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.stop_training_document_classifier_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
