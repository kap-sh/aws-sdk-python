"""Generated from Smithy shape ``com.amazonaws.comprehend#DescribeFlywheelIteration``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.describe_flywheel_iteration_response.DescribeFlywheelIterationResponse = capo_comprehend.types.describe_flywheel_iteration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.DescribeFlywheelIteration"
    body: bytes | None = json.dumps(
        capo_comprehend.types.describe_flywheel_iteration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_flywheel_iteration(
