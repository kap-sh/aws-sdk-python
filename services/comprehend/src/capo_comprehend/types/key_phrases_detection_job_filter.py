"""Generated from Smithy shape ``com.amazonaws.comprehend#KeyPhrasesDetectionJobFilter``."""
...
class KeyPhrasesDetectionJobFilter(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: KeyPhrasesDetectionJobFilter) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> KeyPhrasesDetectionJobFilter:
    out: KeyPhrasesDetectionJobFilter = {}  # type: ignore[typeddict-item]
    if "JobName" in data:
