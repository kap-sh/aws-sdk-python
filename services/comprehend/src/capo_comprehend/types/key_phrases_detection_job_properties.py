"""Generated from Smithy shape ``com.amazonaws.comprehend#KeyPhrasesDetectionJobProperties``."""
...
class KeyPhrasesDetectionJobProperties(TypedDict, closed=True):
    ...
    r"""<p> Configuration parameters for a private Virtual Private Cloud (VPC) containing the resources you are using for your key phrases detection job. For more information, see <a href=\"https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html\">Amazon VPC</a>. </p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: KeyPhrasesDetectionJobProperties) -> dict:
    out: dict = {}
    if "job_id" in value:
...
def deserialize_aws_json_1_1(data: dict) -> KeyPhrasesDetectionJobProperties:
    out: KeyPhrasesDetectionJobProperties = {}  # type: ignore[typeddict-item]
    if "JobId" in data:
