"""Generated from Smithy shape ``com.amazonaws.comprehend#StartTargetedSentimentDetectionJobResponse``."""
...
class StartTargetedSentimentDetectionJobResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StartTargetedSentimentDetectionJobResponse) -> dict:
    out: dict = {}
    if "job_id" in value:
...
def deserialize_aws_json_1_1(data: dict) -> StartTargetedSentimentDetectionJobResponse:
    out: StartTargetedSentimentDetectionJobResponse = {}  # type: ignore[typeddict-item]
    if "JobId" in data:
