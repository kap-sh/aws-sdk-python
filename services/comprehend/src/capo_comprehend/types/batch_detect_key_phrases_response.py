...
if TYPE_CHECKING:
    ...
    import capo_comprehend.types.list_of_detect_key_phrases_result


class BatchDetectKeyPhrasesResponse(TypedDict, closed=True):
    result_list: "capo_comprehend.types.list_of_detect_key_phrases_result.ListOfDetectKeyPhrasesResult"
...
def serialize_aws_json_1_1(value: BatchDetectKeyPhrasesResponse) -> dict:
    ...
    out["ResultList"] = (
        capo_comprehend.types.list_of_detect_key_phrases_result.serialize_aws_json_1_1(
            value["result_list"]
        )
    )
    import capo_comprehend.types.batch_item_error_list
...
def deserialize_aws_json_1_1(data: dict) -> BatchDetectKeyPhrasesResponse:
    ...
    if "ResultList" in data:
        ...
        out["result_list"] = (
            capo_comprehend.types.list_of_detect_key_phrases_result.deserialize_aws_json_1_1(
                data["ResultList"]
            )
        )
    else:
