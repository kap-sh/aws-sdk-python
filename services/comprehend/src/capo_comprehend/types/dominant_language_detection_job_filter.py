"""Generated from Smithy shape ``com.amazonaws.comprehend#DominantLanguageDetectionJobFilter``."""
...
class DominantLanguageDetectionJobFilter(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DominantLanguageDetectionJobFilter) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DominantLanguageDetectionJobFilter:
    out: DominantLanguageDetectionJobFilter = {}  # type: ignore[typeddict-item]
    if "JobName" in data:
