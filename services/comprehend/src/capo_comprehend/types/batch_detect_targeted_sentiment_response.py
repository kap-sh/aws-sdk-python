...
class BatchDetectTargetedSentimentResponse(TypedDict, closed=True):
    result_list: "capo_comprehend.types.list_of_detect_targeted_sentiment_result.ListOfDetectTargetedSentimentResult"
...
def serialize_aws_json_1_1(value: BatchDetectTargetedSentimentResponse) -> dict:
    ...
    out["ResultList"] = (
        capo_comprehend.types.list_of_detect_targeted_sentiment_result.serialize_aws_json_1_1(
            value["result_list"]
        )
    )
    import capo_comprehend.types.batch_item_error_list
...
def deserialize_aws_json_1_1(data: dict) -> BatchDetectTargetedSentimentResponse:
    ...
    if "ResultList" in data:
        ...
        out["result_list"] = (
            capo_comprehend.types.list_of_detect_targeted_sentiment_result.deserialize_aws_json_1_1(
                data["ResultList"]
            )
        )
    else:
