...
from ._services.async_comprehend import AsyncComprehendClient as AsyncComprehendClient
from ._services.comprehend import ComprehendClient as ComprehendClient
