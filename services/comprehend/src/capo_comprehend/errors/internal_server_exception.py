"""Generated from Smithy shape ``com.amazonaws.comprehend#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.comprehend#InternalServerException``."""
