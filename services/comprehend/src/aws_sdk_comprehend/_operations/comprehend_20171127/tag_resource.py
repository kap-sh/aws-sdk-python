"""Generated from Smithy shape ``com.amazonaws.comprehend#TagResource``."""
...
import aws_sdk_comprehend.errors.concurrent_modification_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentModificationException":
            raise aws_sdk_comprehend.errors.concurrent_modification_exception.ConcurrentModificationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_comprehend.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
