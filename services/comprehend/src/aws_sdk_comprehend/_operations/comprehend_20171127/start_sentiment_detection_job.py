"""Generated from Smithy shape ``com.amazonaws.comprehend#StartSentimentDetectionJob``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.start_sentiment_detection_job_response.StartSentimentDetectionJobResponse = aws_sdk_comprehend.types.start_sentiment_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.start_sentiment_detection_job_request.StartSentimentDetectionJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.start_sentiment_detection_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_sentiment_detection_job(
