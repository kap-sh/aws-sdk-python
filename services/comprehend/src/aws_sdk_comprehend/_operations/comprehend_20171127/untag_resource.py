...
import aws_sdk_comprehend.errors.too_many_tag_keys_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagKeysException":
            raise aws_sdk_comprehend.errors.too_many_tag_keys_exception.TooManyTagKeysException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
