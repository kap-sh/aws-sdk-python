"""Generated from Smithy shape ``com.amazonaws.comprehend#DescribeEventsDetectionJob``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.describe_events_detection_job_response.DescribeEventsDetectionJobResponse = aws_sdk_comprehend.types.describe_events_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.describe_events_detection_job_request.DescribeEventsDetectionJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.DescribeEventsDetectionJob"
    import aws_sdk_comprehend.types.describe_events_detection_job_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.describe_events_detection_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_events_detection_job(
