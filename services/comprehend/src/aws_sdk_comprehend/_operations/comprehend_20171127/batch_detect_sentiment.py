...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.batch_detect_sentiment_response.BatchDetectSentimentResponse = aws_sdk_comprehend.types.batch_detect_sentiment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.batch_detect_sentiment_request.BatchDetectSentimentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.batch_detect_sentiment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
