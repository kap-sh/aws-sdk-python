"""Generated from Smithy shape ``com.amazonaws.comprehend#DetectToxicContent``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.detect_toxic_content_response.DetectToxicContentResponse = aws_sdk_comprehend.types.detect_toxic_content_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.detect_toxic_content_request.DetectToxicContentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.DetectToxicContent"
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.detect_toxic_content_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_detect_toxic_content(
