...
import aws_sdk_comprehend.types.sentiment_detection_job_properties_list
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_sentiment_detection_jobs_response.ListSentimentDetectionJobsResponse = aws_sdk_comprehend.types.list_sentiment_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_sentiment_detection_jobs_request.ListSentimentDetectionJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_sentiment_detection_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
