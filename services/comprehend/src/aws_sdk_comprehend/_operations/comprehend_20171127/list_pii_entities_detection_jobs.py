"""Generated from Smithy shape ``com.amazonaws.comprehend#ListPiiEntitiesDetectionJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_pii_entities_detection_jobs_response.ListPiiEntitiesDetectionJobsResponse = aws_sdk_comprehend.types.list_pii_entities_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_pii_entities_detection_jobs_request.ListPiiEntitiesDetectionJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.ListPiiEntitiesDetectionJobs"
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_pii_entities_detection_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_pii_entities_detection_jobs(
