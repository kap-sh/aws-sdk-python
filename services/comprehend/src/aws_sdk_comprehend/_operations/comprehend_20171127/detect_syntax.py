...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.detect_syntax_response.DetectSyntaxResponse = (
        aws_sdk_comprehend.types.detect_syntax_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.detect_syntax_request.DetectSyntaxRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.detect_syntax_request.serialize_aws_json_1_1(input_)
    ).encode()
