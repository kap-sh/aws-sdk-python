"""Generated from Smithy shape ``com.amazonaws.comprehend#ContainsPiiEntities``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.contains_pii_entities_response.ContainsPiiEntitiesResponse = aws_sdk_comprehend.types.contains_pii_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.contains_pii_entities_request.ContainsPiiEntitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.ContainsPiiEntities"
    import aws_sdk_comprehend.types.contains_pii_entities_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.contains_pii_entities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_contains_pii_entities(
