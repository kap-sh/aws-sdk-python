"""Generated from Smithy shape ``com.amazonaws.comprehend#ListTargetedSentimentDetectionJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_targeted_sentiment_detection_jobs_response.ListTargetedSentimentDetectionJobsResponse = aws_sdk_comprehend.types.list_targeted_sentiment_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_targeted_sentiment_detection_jobs_request.ListTargetedSentimentDetectionJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.ListTargetedSentimentDetectionJobs"
    import aws_sdk_comprehend.types.list_targeted_sentiment_detection_jobs_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_targeted_sentiment_detection_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_targeted_sentiment_detection_jobs(
