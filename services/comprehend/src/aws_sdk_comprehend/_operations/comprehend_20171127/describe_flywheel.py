"""Generated from Smithy shape ``com.amazonaws.comprehend#DescribeFlywheel``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.describe_flywheel_response.DescribeFlywheelResponse = aws_sdk_comprehend.types.describe_flywheel_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_comprehend.types.describe_flywheel_request.DescribeFlywheelRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.DescribeFlywheel"
    import aws_sdk_comprehend.types.describe_flywheel_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.describe_flywheel_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_describe_flywheel(
