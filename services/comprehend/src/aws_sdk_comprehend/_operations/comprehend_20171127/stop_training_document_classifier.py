"""Generated from Smithy shape ``com.amazonaws.comprehend#StopTrainingDocumentClassifier``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.stop_training_document_classifier_response.StopTrainingDocumentClassifierResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.stop_training_document_classifier_request.StopTrainingDocumentClassifierRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.StopTrainingDocumentClassifier"
    import aws_sdk_comprehend.types.stop_training_document_classifier_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.stop_training_document_classifier_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_training_document_classifier(
