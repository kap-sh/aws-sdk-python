...
def build_request(
    ...
    input: aws_sdk_comprehend.types.update_flywheel_request.UpdateFlywheelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.update_flywheel_request.serialize_aws_json_1_1(input)
    ).encode()
