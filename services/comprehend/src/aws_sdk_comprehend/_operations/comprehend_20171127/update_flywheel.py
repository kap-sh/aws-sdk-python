"""Generated from Smithy shape ``com.amazonaws.comprehend#UpdateFlywheel``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.update_flywheel_response.UpdateFlywheelResponse = (
        aws_sdk_comprehend.types.update_flywheel_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.update_flywheel_request.UpdateFlywheelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.UpdateFlywheel"
    import aws_sdk_comprehend.types.update_flywheel_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.update_flywheel_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_flywheel(
