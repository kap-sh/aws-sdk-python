...
def build_request(
    ...
    input: aws_sdk_comprehend.types.describe_dataset_request.DescribeDatasetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.describe_dataset_request.serialize_aws_json_1_1(input)
    ).encode()
