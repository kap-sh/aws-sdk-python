"""Generated from Smithy shape ``com.amazonaws.comprehend#DescribeDocumentClassifier``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.describe_document_classifier_response.DescribeDocumentClassifierResponse = aws_sdk_comprehend.types.describe_document_classifier_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.describe_document_classifier_request.DescribeDocumentClassifierRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.describe_document_classifier_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_document_classifier(
