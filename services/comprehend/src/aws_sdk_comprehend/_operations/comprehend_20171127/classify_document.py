...
def build_request(
    ...
    input: aws_sdk_comprehend.types.classify_document_request.ClassifyDocumentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.classify_document_request.serialize_aws_json_1_1(input)
    ).encode()
