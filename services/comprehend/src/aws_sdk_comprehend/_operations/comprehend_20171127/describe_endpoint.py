"""Generated from Smithy shape ``com.amazonaws.comprehend#DescribeEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.describe_endpoint_response.DescribeEndpointResponse = aws_sdk_comprehend.types.describe_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_comprehend.types.describe_endpoint_request.DescribeEndpointRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.describe_endpoint_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_describe_endpoint(
