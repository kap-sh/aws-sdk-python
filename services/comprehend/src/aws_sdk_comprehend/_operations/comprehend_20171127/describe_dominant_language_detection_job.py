...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.describe_dominant_language_detection_job_response.DescribeDominantLanguageDetectionJobResponse = aws_sdk_comprehend.types.describe_dominant_language_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.describe_dominant_language_detection_job_request.DescribeDominantLanguageDetectionJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.describe_dominant_language_detection_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
