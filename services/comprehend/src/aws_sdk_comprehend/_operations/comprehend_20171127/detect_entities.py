...
def build_request(
    ...
    input: aws_sdk_comprehend.types.detect_entities_request.DetectEntitiesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.detect_entities_request.serialize_aws_json_1_1(input)
    ).encode()
