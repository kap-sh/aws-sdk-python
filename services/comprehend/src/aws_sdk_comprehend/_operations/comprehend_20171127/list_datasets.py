"""Generated from Smithy shape ``com.amazonaws.comprehend#ListDatasets``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_datasets_response.ListDatasetsResponse = (
        aws_sdk_comprehend.types.list_datasets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_datasets_request.ListDatasetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.ListDatasets"
    import aws_sdk_comprehend.types.list_datasets_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_datasets_request.serialize_aws_json_1_1(input_)
    ).encode()
