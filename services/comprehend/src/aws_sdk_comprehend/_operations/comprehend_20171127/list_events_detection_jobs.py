...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_events_detection_jobs_response.ListEventsDetectionJobsResponse = aws_sdk_comprehend.types.list_events_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_events_detection_jobs_request.ListEventsDetectionJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_events_detection_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
