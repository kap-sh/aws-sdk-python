...
def build_request(
    ...
    input: aws_sdk_comprehend.types.detect_sentiment_request.DetectSentimentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.detect_sentiment_request.serialize_aws_json_1_1(input)
    ).encode()
