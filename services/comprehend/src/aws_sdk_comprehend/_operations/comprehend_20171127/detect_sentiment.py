"""Generated from Smithy shape ``com.amazonaws.comprehend#DetectSentiment``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.detect_sentiment_response.DetectSentimentResponse = (
        aws_sdk_comprehend.types.detect_sentiment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.detect_sentiment_request.DetectSentimentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.detect_sentiment_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_detect_sentiment(
