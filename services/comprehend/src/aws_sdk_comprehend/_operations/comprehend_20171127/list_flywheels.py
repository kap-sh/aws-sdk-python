...
def build_request(
    ...
    input: aws_sdk_comprehend.types.list_flywheels_request.ListFlywheelsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_flywheels_request.serialize_aws_json_1_1(input)
    ).encode()
