"""Generated from Smithy shape ``com.amazonaws.comprehend#ListFlywheels``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_flywheels_response.ListFlywheelsResponse = (
        aws_sdk_comprehend.types.list_flywheels_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_flywheels_request.ListFlywheelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.ListFlywheels"
    import aws_sdk_comprehend.types.list_flywheels_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_flywheels_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_flywheels(
