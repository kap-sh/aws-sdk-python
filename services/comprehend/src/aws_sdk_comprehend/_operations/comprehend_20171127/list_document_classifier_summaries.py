"""Generated from Smithy shape ``com.amazonaws.comprehend#ListDocumentClassifierSummaries``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_document_classifier_summaries_response.ListDocumentClassifierSummariesResponse = aws_sdk_comprehend.types.list_document_classifier_summaries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_document_classifier_summaries_request.ListDocumentClassifierSummariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.ListDocumentClassifierSummaries"
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_document_classifier_summaries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_document_classifier_summaries(
