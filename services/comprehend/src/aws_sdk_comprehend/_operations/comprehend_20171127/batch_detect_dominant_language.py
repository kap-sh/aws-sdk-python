...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.batch_detect_dominant_language_response.BatchDetectDominantLanguageResponse = aws_sdk_comprehend.types.batch_detect_dominant_language_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.batch_detect_dominant_language_request.BatchDetectDominantLanguageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.batch_detect_dominant_language_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
