"""Generated from Smithy shape ``com.amazonaws.comprehend#ListDocumentClassificationJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_document_classification_jobs_response.ListDocumentClassificationJobsResponse = aws_sdk_comprehend.types.list_document_classification_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_document_classification_jobs_request.ListDocumentClassificationJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.ListDocumentClassificationJobs"
    import aws_sdk_comprehend.types.list_document_classification_jobs_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_document_classification_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_document_classification_jobs(
