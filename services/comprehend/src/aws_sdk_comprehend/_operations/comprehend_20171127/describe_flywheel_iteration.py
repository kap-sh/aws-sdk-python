...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.describe_flywheel_iteration_response.DescribeFlywheelIterationResponse = aws_sdk_comprehend.types.describe_flywheel_iteration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.describe_flywheel_iteration_request.DescribeFlywheelIterationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.describe_flywheel_iteration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
