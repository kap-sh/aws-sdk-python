...
def build_request(
    ...
    input: aws_sdk_comprehend.types.create_endpoint_request.CreateEndpointRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.create_endpoint_request.serialize_aws_json_1_1(input)
    ).encode()
