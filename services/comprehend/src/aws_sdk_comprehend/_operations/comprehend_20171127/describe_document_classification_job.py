...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.describe_document_classification_job_response.DescribeDocumentClassificationJobResponse = aws_sdk_comprehend.types.describe_document_classification_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.describe_document_classification_job_request.DescribeDocumentClassificationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.describe_document_classification_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
