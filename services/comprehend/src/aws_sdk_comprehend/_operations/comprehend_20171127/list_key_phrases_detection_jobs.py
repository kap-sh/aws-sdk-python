"""Generated from Smithy shape ``com.amazonaws.comprehend#ListKeyPhrasesDetectionJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_key_phrases_detection_jobs_response.ListKeyPhrasesDetectionJobsResponse = aws_sdk_comprehend.types.list_key_phrases_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_key_phrases_detection_jobs_request.ListKeyPhrasesDetectionJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_key_phrases_detection_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_key_phrases_detection_jobs(
