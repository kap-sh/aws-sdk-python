...
def build_request(
    ...
    input: aws_sdk_comprehend.types.update_endpoint_request.UpdateEndpointRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.update_endpoint_request.serialize_aws_json_1_1(input)
    ).encode()
