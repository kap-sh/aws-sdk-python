...
import aws_sdk_comprehend.types.document_classifier_properties_list
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_document_classifiers_response.ListDocumentClassifiersResponse = aws_sdk_comprehend.types.list_document_classifiers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_document_classifiers_request.ListDocumentClassifiersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_document_classifiers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
