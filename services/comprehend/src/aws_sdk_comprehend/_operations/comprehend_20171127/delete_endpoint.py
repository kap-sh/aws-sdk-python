...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.delete_endpoint_response.DeleteEndpointResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.delete_endpoint_request.DeleteEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.delete_endpoint_request.serialize_aws_json_1_1(input_)
    ).encode()
