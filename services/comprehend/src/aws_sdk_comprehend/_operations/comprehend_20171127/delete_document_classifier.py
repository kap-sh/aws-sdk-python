"""Generated from Smithy shape ``com.amazonaws.comprehend#DeleteDocumentClassifier``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.delete_document_classifier_response.DeleteDocumentClassifierResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.delete_document_classifier_request.DeleteDocumentClassifierRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.delete_document_classifier_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_document_classifier(
