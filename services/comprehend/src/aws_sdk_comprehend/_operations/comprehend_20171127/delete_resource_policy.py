"""Generated from Smithy shape ``com.amazonaws.comprehend#DeleteResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.delete_resource_policy_response.DeleteResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.delete_resource_policy_request.DeleteResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.DeleteResourcePolicy"
    import aws_sdk_comprehend.types.delete_resource_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.delete_resource_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
