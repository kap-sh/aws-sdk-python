"""Generated from Smithy shape ``com.amazonaws.comprehend#DeleteEntityRecognizer``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.delete_entity_recognizer_response.DeleteEntityRecognizerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.delete_entity_recognizer_request.DeleteEntityRecognizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.delete_entity_recognizer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_entity_recognizer(
