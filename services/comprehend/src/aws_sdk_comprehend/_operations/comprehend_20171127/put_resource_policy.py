"""Generated from Smithy shape ``com.amazonaws.comprehend#PutResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.put_resource_policy_response.PutResourcePolicyResponse = aws_sdk_comprehend.types.put_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.put_resource_policy_request.PutResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
