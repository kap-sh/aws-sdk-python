"""Generated from Smithy shape ``com.amazonaws.comprehend#StartFlywheelIteration``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.start_flywheel_iteration_response.StartFlywheelIterationResponse = aws_sdk_comprehend.types.start_flywheel_iteration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.start_flywheel_iteration_request.StartFlywheelIterationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.StartFlywheelIteration"
    import aws_sdk_comprehend.types.start_flywheel_iteration_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.start_flywheel_iteration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_flywheel_iteration(
