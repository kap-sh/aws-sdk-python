...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_entity_recognizers_response.ListEntityRecognizersResponse = aws_sdk_comprehend.types.list_entity_recognizers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_entity_recognizers_request.ListEntityRecognizersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_entity_recognizers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
