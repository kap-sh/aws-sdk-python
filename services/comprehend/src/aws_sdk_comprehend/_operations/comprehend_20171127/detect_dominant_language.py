"""Generated from Smithy shape ``com.amazonaws.comprehend#DetectDominantLanguage``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.detect_dominant_language_response.DetectDominantLanguageResponse = aws_sdk_comprehend.types.detect_dominant_language_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.detect_dominant_language_request.DetectDominantLanguageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.detect_dominant_language_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_detect_dominant_language(
