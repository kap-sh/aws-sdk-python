"""Generated from Smithy shape ``com.amazonaws.comprehend#DescribeTargetedSentimentDetectionJob``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.describe_targeted_sentiment_detection_job_response.DescribeTargetedSentimentDetectionJobResponse = aws_sdk_comprehend.types.describe_targeted_sentiment_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.describe_targeted_sentiment_detection_job_request.DescribeTargetedSentimentDetectionJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_targeted_sentiment_detection_job(
