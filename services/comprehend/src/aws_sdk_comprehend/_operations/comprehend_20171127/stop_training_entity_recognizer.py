"""Generated from Smithy shape ``com.amazonaws.comprehend#StopTrainingEntityRecognizer``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.stop_training_entity_recognizer_response.StopTrainingEntityRecognizerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.stop_training_entity_recognizer_request.StopTrainingEntityRecognizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.stop_training_entity_recognizer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_training_entity_recognizer(
