"""Generated from Smithy shape ``com.amazonaws.comprehend#ListEndpoints``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_endpoints_response.ListEndpointsResponse = (
        aws_sdk_comprehend.types.list_endpoints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_endpoints_request.ListEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_endpoints_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_endpoints(
