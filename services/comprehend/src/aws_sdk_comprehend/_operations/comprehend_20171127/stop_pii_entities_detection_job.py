"""Generated from Smithy shape ``com.amazonaws.comprehend#StopPiiEntitiesDetectionJob``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.stop_pii_entities_detection_job_response.StopPiiEntitiesDetectionJobResponse = aws_sdk_comprehend.types.stop_pii_entities_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.stop_pii_entities_detection_job_request.StopPiiEntitiesDetectionJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.StopPiiEntitiesDetectionJob"
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.stop_pii_entities_detection_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_pii_entities_detection_job(
