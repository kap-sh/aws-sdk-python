...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.batch_detect_entities_response.BatchDetectEntitiesResponse = aws_sdk_comprehend.types.batch_detect_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.batch_detect_entities_request.BatchDetectEntitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.batch_detect_entities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
