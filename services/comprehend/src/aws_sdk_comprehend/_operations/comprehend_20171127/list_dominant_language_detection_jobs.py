"""Generated from Smithy shape ``com.amazonaws.comprehend#ListDominantLanguageDetectionJobs``."""
...
import aws_sdk_comprehend.types.dominant_language_detection_job_properties_list
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_dominant_language_detection_jobs_response.ListDominantLanguageDetectionJobsResponse = aws_sdk_comprehend.types.list_dominant_language_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_dominant_language_detection_jobs_request.ListDominantLanguageDetectionJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.ListDominantLanguageDetectionJobs"
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_dominant_language_detection_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_dominant_language_detection_jobs(
