"""Generated from Smithy shape ``com.amazonaws.comprehend#DescribeTopicsDetectionJob``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.describe_topics_detection_job_response.DescribeTopicsDetectionJobResponse = aws_sdk_comprehend.types.describe_topics_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.describe_topics_detection_job_request.DescribeTopicsDetectionJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.describe_topics_detection_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_topics_detection_job(
