...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.detect_key_phrases_response.DetectKeyPhrasesResponse = aws_sdk_comprehend.types.detect_key_phrases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.detect_key_phrases_request.DetectKeyPhrasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.detect_key_phrases_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
