"""Generated from Smithy shape ``com.amazonaws.comprehend#DeleteFlywheel``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.delete_flywheel_response.DeleteFlywheelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.delete_flywheel_request.DeleteFlywheelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.DeleteFlywheel"
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.delete_flywheel_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_flywheel(
