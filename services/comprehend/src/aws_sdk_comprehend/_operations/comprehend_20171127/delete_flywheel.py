...
def build_request(
    ...
    input: aws_sdk_comprehend.types.delete_flywheel_request.DeleteFlywheelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.delete_flywheel_request.serialize_aws_json_1_1(input)
    ).encode()
