...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.batch_detect_syntax_response.BatchDetectSyntaxResponse = aws_sdk_comprehend.types.batch_detect_syntax_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.batch_detect_syntax_request.BatchDetectSyntaxRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.batch_detect_syntax_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
