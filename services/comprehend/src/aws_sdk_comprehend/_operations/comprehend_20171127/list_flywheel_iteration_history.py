"""Generated from Smithy shape ``com.amazonaws.comprehend#ListFlywheelIterationHistory``."""
...
import aws_sdk_comprehend.errors.invalid_filter_exception
...
import aws_sdk_comprehend.types.flywheel_iteration_properties_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidFilterException":
            raise aws_sdk_comprehend.errors.invalid_filter_exception.InvalidFilterException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_flywheel_iteration_history_response.ListFlywheelIterationHistoryResponse = aws_sdk_comprehend.types.list_flywheel_iteration_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_flywheel_iteration_history_request.ListFlywheelIterationHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.ListFlywheelIterationHistory"
    import aws_sdk_comprehend.types.list_flywheel_iteration_history_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_flywheel_iteration_history_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_flywheel_iteration_history(
