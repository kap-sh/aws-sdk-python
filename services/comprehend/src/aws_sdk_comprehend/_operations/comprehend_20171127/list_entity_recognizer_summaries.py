...
def handle_response(
    ...
    out: aws_sdk_comprehend.types.list_entity_recognizer_summaries_response.ListEntityRecognizerSummariesResponse = aws_sdk_comprehend.types.list_entity_recognizer_summaries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehend.types.list_entity_recognizer_summaries_request.ListEntityRecognizerSummariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehend.types.list_entity_recognizer_summaries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
