...
class ComprehendError(Exception):
    """Base class for all Comprehend service errors."""


class ServiceError(ComprehendError):
...
class SerializationError(ComprehendError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ComprehendError):
...
class WaiterFailedError(ComprehendError):
...
class WaiterTimeoutError(ComprehendError):
