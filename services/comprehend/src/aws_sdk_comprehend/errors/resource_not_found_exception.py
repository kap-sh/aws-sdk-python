"""Generated from Smithy shape ``com.amazonaws.comprehend#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.comprehend#ResourceNotFoundException``."""
