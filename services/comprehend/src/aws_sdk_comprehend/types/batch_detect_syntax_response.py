...
def serialize_aws_json_1_1(value: BatchDetectSyntaxResponse) -> dict:
    ...
    out["ResultList"] = (
        aws_sdk_comprehend.types.list_of_detect_syntax_result.serialize_aws_json_1_1(
            value["result_list"]
        )
    )
    import aws_sdk_comprehend.types.batch_item_error_list
...
def deserialize_aws_json_1_1(data: dict) -> BatchDetectSyntaxResponse:
    ...
    if "ResultList" in data:
        ...
        out["result_list"] = (
            aws_sdk_comprehend.types.list_of_detect_syntax_result.deserialize_aws_json_1_1(
                data["ResultList"]
            )
        )
    else:
