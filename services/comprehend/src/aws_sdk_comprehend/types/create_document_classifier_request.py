...
class CreateDocumentClassifierRequest(TypedDict):
...
def serialize_aws_json_1_1(value: CreateDocumentClassifierRequest) -> dict:
    ...
    out["InputDataConfig"] = (
        aws_sdk_comprehend.types.document_classifier_input_data_config.serialize_aws_json_1_1(
    ...
    if "output_data_config" in value:
        ...
        out["OutputDataConfig"] = (
            aws_sdk_comprehend.types.document_classifier_output_data_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CreateDocumentClassifierRequest:
    ...
    if "InputDataConfig" in data:
        ...
        out["input_data_config"] = (
            aws_sdk_comprehend.types.document_classifier_input_data_config.deserialize_aws_json_1_1(
    ...
    if "OutputDataConfig" in data:
        ...
        out["output_data_config"] = (
            aws_sdk_comprehend.types.document_classifier_output_data_config.deserialize_aws_json_1_1(
