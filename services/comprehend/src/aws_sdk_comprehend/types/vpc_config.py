...
if TYPE_CHECKING:
    import aws_sdk_comprehend.types.security_group_ids
...
def serialize_aws_json_1_1(value: VpcConfig) -> dict:
    ...
    out["SecurityGroupIds"] = (
        aws_sdk_comprehend.types.security_group_ids.serialize_aws_json_1_1(
            value["security_group_ids"]
        )
    )
    import aws_sdk_comprehend.types.subnets

    out["Subnets"] = aws_sdk_comprehend.types.subnets.serialize_aws_json_1_1(
        value["subnets"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> VpcConfig:
    ...
    if "SecurityGroupIds" in data:
        ...
        out["security_group_ids"] = (
            aws_sdk_comprehend.types.security_group_ids.deserialize_aws_json_1_1(
    ...
    if "Subnets" in data:
        ...
        out["subnets"] = aws_sdk_comprehend.types.subnets.deserialize_aws_json_1_1(
            data["Subnets"]
        )
    else:
