...
class ClassifierEvaluationMetrics(TypedDict, closed=True):
    ...
    micro_precision: NotRequired["aws_sdk_comprehend.types.double.Double"]
    ...
    micro_recall: NotRequired["aws_sdk_comprehend.types.double.Double"]
    ...
    micro_f1_score: NotRequired["aws_sdk_comprehend.types.double.Double"]
    ...
    hamming_loss: NotRequired["aws_sdk_comprehend.types.double.Double"]
