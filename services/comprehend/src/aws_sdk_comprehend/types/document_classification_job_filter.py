"""Generated from Smithy shape ``com.amazonaws.comprehend#DocumentClassificationJobFilter``."""
...
class DocumentClassificationJobFilter(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DocumentClassificationJobFilter) -> dict:
    out: dict = {}
