"""Generated from Smithy shape ``com.amazonaws.comprehend#PiiEntitiesDetectionJobFilter``."""
...
class PiiEntitiesDetectionJobFilter(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: PiiEntitiesDetectionJobFilter) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> PiiEntitiesDetectionJobFilter:
    out: PiiEntitiesDetectionJobFilter = {}  # type: ignore[typeddict-item]
    if "JobName" in data:
