...
if TYPE_CHECKING:
    import aws_sdk_comprehend.types.entity_recognizer_summary

EntityRecognizerSummariesList: TypeAlias = list[
    "aws_sdk_comprehend.types.entity_recognizer_summary.EntityRecognizerSummary"
]
...
def serialize_aws_json_1_1(value: EntityRecognizerSummariesList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_comprehend.types.entity_recognizer_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> EntityRecognizerSummariesList:
    ...
    for item in data:
        out.append(
            aws_sdk_comprehend.types.entity_recognizer_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
