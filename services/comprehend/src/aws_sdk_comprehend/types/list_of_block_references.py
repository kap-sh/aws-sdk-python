...
if TYPE_CHECKING:
    import aws_sdk_comprehend.types.block_reference

ListOfBlockReferences: TypeAlias = list[
    "aws_sdk_comprehend.types.block_reference.BlockReference"
]
...
def serialize_aws_json_1_1(value: ListOfBlockReferences) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_comprehend.types.block_reference.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ListOfBlockReferences:
    ...
    for item in data:
        out.append(
            aws_sdk_comprehend.types.block_reference.deserialize_aws_json_1_1(item)
        )
    return out
