...
if TYPE_CHECKING:
    ...
    import aws_sdk_comprehend.types.classifier_metadata
...
class DocumentClassifierProperties(TypedDict):
    ...
    input_data_config: NotRequired[
        "aws_sdk_comprehend.types.document_classifier_input_data_config.DocumentClassifierInputDataConfig"
    ]
    ...
    classifier_metadata: NotRequired[
        "aws_sdk_comprehend.types.classifier_metadata.ClassifierMetadata"
    ]
...
def serialize_aws_json_1_1(value: DocumentClassifierProperties) -> dict:
    ...
    if "classifier_metadata" in value:
        ...
        out["ClassifierMetadata"] = (
            aws_sdk_comprehend.types.classifier_metadata.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DocumentClassifierProperties:
    ...
    if "ClassifierMetadata" in data:
        ...
        out["classifier_metadata"] = (
            aws_sdk_comprehend.types.classifier_metadata.deserialize_aws_json_1_1(
