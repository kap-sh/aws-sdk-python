...
class ListEntitiesDetectionJobsRequest(TypedDict):
    filter: NotRequired[
...
def serialize_aws_json_1_1(value: ListEntitiesDetectionJobsRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["Filter"] = (
            aws_sdk_comprehend.types.entities_detection_job_filter.serialize_aws_json_1_1(
                value["filter"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListEntitiesDetectionJobsRequest:
    ...
    if "Filter" in data:
        ...
        out["filter"] = (
            aws_sdk_comprehend.types.entities_detection_job_filter.deserialize_aws_json_1_1(
                data["Filter"]
            )
        )
