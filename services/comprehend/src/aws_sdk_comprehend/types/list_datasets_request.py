...
class ListDatasetsRequest(TypedDict, closed=True):
    ...
    filter: NotRequired["aws_sdk_comprehend.types.dataset_filter.DatasetFilter"]
...
def serialize_aws_json_1_1(value: ListDatasetsRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["Filter"] = aws_sdk_comprehend.types.dataset_filter.serialize_aws_json_1_1(
            value["filter"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListDatasetsRequest:
    ...
    if "Filter" in data:
        ...
        out["filter"] = (
            aws_sdk_comprehend.types.dataset_filter.deserialize_aws_json_1_1(
                data["Filter"]
            )
        )
