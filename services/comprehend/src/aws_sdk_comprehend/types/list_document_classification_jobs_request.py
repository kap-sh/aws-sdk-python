...
class ListDocumentClassificationJobsRequest(TypedDict):
    filter: NotRequired[
...
def serialize_aws_json_1_1(value: ListDocumentClassificationJobsRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["Filter"] = (
            aws_sdk_comprehend.types.document_classification_job_filter.serialize_aws_json_1_1(
                value["filter"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListDocumentClassificationJobsRequest:
    ...
    if "Filter" in data:
        ...
        out["filter"] = (
            aws_sdk_comprehend.types.document_classification_job_filter.deserialize_aws_json_1_1(
                data["Filter"]
            )
        )
