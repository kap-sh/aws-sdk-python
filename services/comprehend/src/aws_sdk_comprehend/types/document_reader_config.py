...
if TYPE_CHECKING:
    import aws_sdk_comprehend.types.document_read_action
    import aws_sdk_comprehend.types.document_read_mode
    import aws_sdk_comprehend.types.list_of_document_read_feature_types


class DocumentReaderConfig(TypedDict):
    document_read_action: (
        "aws_sdk_comprehend.types.document_read_action.DocumentReadAction"
    )
    ...
    document_read_mode: NotRequired[
        "aws_sdk_comprehend.types.document_read_mode.DocumentReadMode"
    ]
    ...
    feature_types: NotRequired[
        "aws_sdk_comprehend.types.list_of_document_read_feature_types.ListOfDocumentReadFeatureTypes"
    ]
...
def serialize_aws_json_1_1(value: DocumentReaderConfig) -> dict:
    ...
    out["DocumentReadAction"] = (
        aws_sdk_comprehend.types.document_read_action.serialize_aws_json_1_1(
    ...
    if "document_read_mode" in value:
        ...
        out["DocumentReadMode"] = (
            aws_sdk_comprehend.types.document_read_mode.serialize_aws_json_1_1(
    ...
    if "feature_types" in value:
        ...
        out["FeatureTypes"] = (
            aws_sdk_comprehend.types.list_of_document_read_feature_types.serialize_aws_json_1_1(
                value["feature_types"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DocumentReaderConfig:
    ...
    if "DocumentReadAction" in data:
        ...
        out["document_read_action"] = (
            aws_sdk_comprehend.types.document_read_action.deserialize_aws_json_1_1(
    ...
    if "DocumentReadMode" in data:
        ...
        out["document_read_mode"] = (
            aws_sdk_comprehend.types.document_read_mode.deserialize_aws_json_1_1(
    ...
    if "FeatureTypes" in data:
        ...
        out["feature_types"] = (
            aws_sdk_comprehend.types.list_of_document_read_feature_types.deserialize_aws_json_1_1(
                data["FeatureTypes"]
            )
        )
    return out
