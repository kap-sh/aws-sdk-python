...
```
pip install aws-sdk-comprehend
```

## Usage

```python
from aws_sdk_comprehend import AsyncComprehendClient
...
```python
from aws_sdk_comprehend import AsyncComprehendClient
from aws_sdk_comprehend.error import BatchSizeLimitExceededException
