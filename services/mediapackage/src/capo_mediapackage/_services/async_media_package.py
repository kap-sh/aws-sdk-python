...
from capo_mediapackage._services._aws_config import aaws_config
...
class AsyncMediaPackageClient:
    ...
    async def configure_logs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.configure_logs_request.ConfigureLogsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.configure_logs_response.ConfigureLogsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.configure_logs.async_configure_logs(
    ...
    async def create_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.create_channel_request.CreateChannelRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.create_channel_response.CreateChannelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.create_channel.async_create_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_harvest_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.create_harvest_job_request.CreateHarvestJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.create_harvest_job_response.CreateHarvestJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.create_harvest_job.async_create_harvest_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_origin_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.create_origin_endpoint_request.CreateOriginEndpointRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.create_origin_endpoint_response.CreateOriginEndpointResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.create_origin_endpoint.async_create_origin_endpoint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.delete_channel_request.DeleteChannelRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.delete_channel_response.DeleteChannelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.delete_channel.async_delete_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_origin_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.delete_origin_endpoint_request.DeleteOriginEndpointRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.delete_origin_endpoint_response.DeleteOriginEndpointResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.delete_origin_endpoint.async_delete_origin_endpoint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.describe_channel_request.DescribeChannelRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.describe_channel_response.DescribeChannelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.describe_channel.async_describe_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_harvest_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.describe_harvest_job_request.DescribeHarvestJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.describe_harvest_job_response.DescribeHarvestJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.describe_harvest_job.async_describe_harvest_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_origin_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.describe_origin_endpoint_request.DescribeOriginEndpointRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.describe_origin_endpoint_response.DescribeOriginEndpointResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.describe_origin_endpoint.async_describe_origin_endpoint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_channels(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.list_channels_request.ListChannelsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.list_channels_response.ListChannelsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.list_channels.async_list_channels(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_channels(
        ...
        *,
        ...
        max_results: Optional["capo_mediapackage.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_mediapackage.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_mediapackage.types.channel.Channel]":
        _token = next_token
        while True:
    ...
    async def list_harvest_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.list_harvest_jobs_request.ListHarvestJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.list_harvest_jobs_response.ListHarvestJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.list_harvest_jobs.async_list_harvest_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_harvest_jobs(
        ...
        *,
        ...
        max_results: Optional["capo_mediapackage.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_mediapackage.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_mediapackage.types.harvest_job.HarvestJob]":
        _token = next_token
        while True:
    ...
    async def list_origin_endpoints(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.list_origin_endpoints_request.ListOriginEndpointsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.list_origin_endpoints_response.ListOriginEndpointsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.list_origin_endpoints.async_list_origin_endpoints(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_origin_endpoints(
        ...
        *,
        ...
        max_results: Optional["capo_mediapackage.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_mediapackage.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_mediapackage.types.origin_endpoint.OriginEndpoint]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def rotate_channel_credentials(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.rotate_channel_credentials_request.RotateChannelCredentialsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.rotate_channel_credentials_response.RotateChannelCredentialsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.rotate_channel_credentials.async_rotate_channel_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def rotate_ingest_endpoint_credentials(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.rotate_ingest_endpoint_credentials_request.RotateIngestEndpointCredentialsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.rotate_ingest_endpoint_credentials_response.RotateIngestEndpointCredentialsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.rotate_ingest_endpoint_credentials.async_rotate_ingest_endpoint_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.update_channel_request.UpdateChannelRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.update_channel_response.UpdateChannelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.update_channel.async_update_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_origin_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackage.types.update_origin_endpoint_request.UpdateOriginEndpointRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackage.types.update_origin_endpoint_response.UpdateOriginEndpointResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackage._operations.media_package.update_origin_endpoint.async_update_origin_endpoint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
