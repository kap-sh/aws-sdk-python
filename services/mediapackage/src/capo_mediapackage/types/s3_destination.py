...
class S3Destination(TypedDict, closed=True):
    bucket_name: NotRequired["capo_mediapackage.types.__string.__string"]
    """The name of an S3 bucket within which harvested content will be exported"""
    manifest_key: NotRequired["capo_mediapackage.types.__string.__string"]
    """The key in the specified S3 bucket where the harvested top-level manifest will be placed."""
    role_arn: NotRequired["capo_mediapackage.types.__string.__string"]
