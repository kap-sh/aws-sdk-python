"""Generated from Smithy shape ``com.amazonaws.mediapackage#ServiceUnavailableException``."""
...
class ServiceUnavailableException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.mediapackage#ServiceUnavailableException``."""
