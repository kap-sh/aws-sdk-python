"""Generated from Smithy shape ``com.amazonaws.mediapackage#InternalServerErrorException``."""

from typing import TYPE_CHECKING

from typing_extensions import NotRequired, TypedDict

from capo_mediapackage.errors import ServiceError
...
class InternalServerErrorException_(TypedDict, closed=True):
    message: NotRequired["capo_mediapackage.types.__string.__string"]
...
class InternalServerErrorException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.mediapackage#InternalServerErrorException``."""
