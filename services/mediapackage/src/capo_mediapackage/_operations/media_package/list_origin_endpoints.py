"""Generated from Smithy shape ``com.amazonaws.mediapackage#ListOriginEndpoints``."""
...
def handle_response(
    ...
    out: capo_mediapackage.types.list_origin_endpoints_response.ListOriginEndpointsResponse = capo_mediapackage.types.list_origin_endpoints_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "channel_id" in input_:
        params["channelId"] = str(input_["channel_id"])
...
async def async_list_origin_endpoints(
