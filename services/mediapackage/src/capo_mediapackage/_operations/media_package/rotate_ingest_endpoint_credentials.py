...
def handle_response(
    ...
    out: capo_mediapackage.types.rotate_ingest_endpoint_credentials_response.RotateIngestEndpointCredentialsResponse = capo_mediapackage.types.rotate_ingest_endpoint_credentials_response.deserialize_json(
