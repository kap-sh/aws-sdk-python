"""Generated from Smithy shape ``com.amazonaws.mediapackage#ListChannels``."""
...
def handle_response(
    ...
    out: capo_mediapackage.types.list_channels_response.ListChannelsResponse = (
        capo_mediapackage.types.list_channels_response.deserialize_json(
...
def list_channels(
    ...
    capo_mediapackage.types.list_channels_response.ListChannelsResponse, zapros.Response
]:
