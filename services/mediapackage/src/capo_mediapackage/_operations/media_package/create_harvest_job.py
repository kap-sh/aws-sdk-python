"""Generated from Smithy shape ``com.amazonaws.mediapackage#CreateHarvestJob``."""
...
def handle_response(
    ...
    out: capo_mediapackage.types.create_harvest_job_response.CreateHarvestJobResponse = capo_mediapackage.types.create_harvest_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediapackage.types.create_harvest_job_request.serialize_json(input_)
    ).encode()
