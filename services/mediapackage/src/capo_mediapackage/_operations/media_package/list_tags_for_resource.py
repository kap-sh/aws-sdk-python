"""Generated from Smithy shape ``com.amazonaws.mediapackage#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_mediapackage.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_mediapackage.types.list_tags_for_resource_response.deserialize_json(
