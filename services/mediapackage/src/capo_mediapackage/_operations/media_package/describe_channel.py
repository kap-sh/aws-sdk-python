"""Generated from Smithy shape ``com.amazonaws.mediapackage#DescribeChannel``."""
...
def handle_response(
    ...
    out: capo_mediapackage.types.describe_channel_response.DescribeChannelResponse = (
        capo_mediapackage.types.describe_channel_response.deserialize_json(
