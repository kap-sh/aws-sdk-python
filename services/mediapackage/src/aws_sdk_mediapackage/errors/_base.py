...
class MediaPackageError(Exception):
    """Base class for all MediaPackage service errors."""


class ServiceError(MediaPackageError):
...
class SerializationError(MediaPackageError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MediaPackageError):
...
class WaiterFailedError(MediaPackageError):
...
class WaiterTimeoutError(MediaPackageError):
