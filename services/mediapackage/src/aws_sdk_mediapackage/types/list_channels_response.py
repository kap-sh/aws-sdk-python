...
class ListChannelsResponse(TypedDict, closed=True):
    channels: NotRequired[
        "aws_sdk_mediapackage.types.__list_of_channel.__listOfChannel"
    ]
...
def serialize_json(value: ListChannelsResponse) -> dict:
    ...
    if "channels" in value:
        ...
        out["channels"] = aws_sdk_mediapackage.types.__list_of_channel.serialize_json(
            value["channels"]
        )
...
def deserialize_json(data: dict) -> ListChannelsResponse:
    ...
    if "channels" in data:
        ...
        out["channels"] = aws_sdk_mediapackage.types.__list_of_channel.deserialize_json(
            data["channels"]
        )
