"""Generated from Smithy shape ``com.amazonaws.mediapackage#OriginEndpoint``."""
...
class OriginEndpoint(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: OriginEndpoint) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> OriginEndpoint:
    out: OriginEndpoint = {}  # type: ignore[typeddict-item]
    if "arn" in data:
        out["arn"] = data["arn"]
