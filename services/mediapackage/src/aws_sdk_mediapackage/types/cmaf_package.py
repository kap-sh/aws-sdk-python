"""Generated from Smithy shape ``com.amazonaws.mediapackage#CmafPackage``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediapackage.types.__list_of_hls_manifest
...
def serialize_json(value: CmafPackage) -> dict:
    ...
    if "hls_manifests" in value:
        ...
        out["hlsManifests"] = (
            aws_sdk_mediapackage.types.__list_of_hls_manifest.serialize_json(
                value["hls_manifests"]
            )
        )
...
def deserialize_json(data: dict) -> CmafPackage:
    ...
    if "hlsManifests" in data:
        ...
        out["hls_manifests"] = (
            aws_sdk_mediapackage.types.__list_of_hls_manifest.deserialize_json(
                data["hlsManifests"]
            )
        )
