...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediapackage.types.encryption_method
...
class HlsEncryption(TypedDict, closed=True):
    ...
    encryption_method: NotRequired[
        "aws_sdk_mediapackage.types.encryption_method.EncryptionMethod"
    ]
    ...
    repeat_ext_x_key: NotRequired["aws_sdk_mediapackage.types.__boolean.__boolean"]
...
def serialize_json(value: HlsEncryption) -> dict:
    ...
    if "encryption_method" in value:
        ...
        out["encryptionMethod"] = (
            aws_sdk_mediapackage.types.encryption_method.serialize_json(
...
def deserialize_json(data: dict) -> HlsEncryption:
    ...
    if "encryptionMethod" in data:
        ...
        out["encryption_method"] = (
            aws_sdk_mediapackage.types.encryption_method.deserialize_json(
