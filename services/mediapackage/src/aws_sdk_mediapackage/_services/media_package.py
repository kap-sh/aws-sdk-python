...
from aws_sdk_mediapackage._services._aws_config import aws_config
...
class MediaPackageClientConfig(TypedDict, total=False):
...
class MediaPackageClient:
    ...
    def configure_logs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.configure_logs_request.ConfigureLogsRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.configure_logs_response.ConfigureLogsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.configure_logs.configure_logs(
    ...
    def create_channel(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.create_channel_request.CreateChannelRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.create_channel_response.CreateChannelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.create_channel.create_channel(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_harvest_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.create_harvest_job_request.CreateHarvestJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.create_harvest_job_response.CreateHarvestJobResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.create_harvest_job.create_harvest_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_origin_endpoint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.create_origin_endpoint_request.CreateOriginEndpointRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.create_origin_endpoint_response.CreateOriginEndpointResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.create_origin_endpoint.create_origin_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_channel(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.delete_channel_request.DeleteChannelRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.delete_channel_response.DeleteChannelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.delete_channel.delete_channel(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_origin_endpoint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.delete_origin_endpoint_request.DeleteOriginEndpointRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.delete_origin_endpoint_response.DeleteOriginEndpointResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.delete_origin_endpoint.delete_origin_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_channel(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.describe_channel_request.DescribeChannelRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.describe_channel_response.DescribeChannelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.describe_channel.describe_channel(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_harvest_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.describe_harvest_job_request.DescribeHarvestJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.describe_harvest_job_response.DescribeHarvestJobResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.describe_harvest_job.describe_harvest_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_origin_endpoint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.describe_origin_endpoint_request.DescribeOriginEndpointRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.describe_origin_endpoint_response.DescribeOriginEndpointResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.describe_origin_endpoint.describe_origin_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_channels(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.list_channels_request.ListChannelsRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.list_channels_response.ListChannelsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.list_channels.list_channels(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_channels(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_mediapackage.types.__string.__string"] = None,
    ) -> "Iterator[aws_sdk_mediapackage.types.channel.Channel]":
        _token = next_token
        while True:
    ...
    def list_harvest_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.list_harvest_jobs_request.ListHarvestJobsRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.list_harvest_jobs_response.ListHarvestJobsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.list_harvest_jobs.list_harvest_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_harvest_jobs(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_mediapackage.types.__string.__string"] = None,
    ) -> "Iterator[aws_sdk_mediapackage.types.harvest_job.HarvestJob]":
        _token = next_token
        while True:
    ...
    def list_origin_endpoints(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.list_origin_endpoints_request.ListOriginEndpointsRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.list_origin_endpoints_response.ListOriginEndpointsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.list_origin_endpoints.list_origin_endpoints(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_origin_endpoints(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_mediapackage.types.__string.__string"] = None,
    ) -> "Iterator[aws_sdk_mediapackage.types.origin_endpoint.OriginEndpoint]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def rotate_channel_credentials(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.rotate_channel_credentials_request.RotateChannelCredentialsRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.rotate_channel_credentials_response.RotateChannelCredentialsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.rotate_channel_credentials.rotate_channel_credentials(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def rotate_ingest_endpoint_credentials(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.rotate_ingest_endpoint_credentials_request.RotateIngestEndpointCredentialsRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.rotate_ingest_endpoint_credentials_response.RotateIngestEndpointCredentialsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.rotate_ingest_endpoint_credentials.rotate_ingest_endpoint_credentials(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_mediapackage._operations.media_package.tag_resource

            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_mediapackage._operations.media_package.untag_resource

            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_channel(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.update_channel_request.UpdateChannelRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.update_channel_response.UpdateChannelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.update_channel.update_channel(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_origin_endpoint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediapackage.types.update_origin_endpoint_request.UpdateOriginEndpointRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediapackage.types.update_origin_endpoint_response.UpdateOriginEndpointResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediapackage._operations.media_package.update_origin_endpoint.update_origin_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
