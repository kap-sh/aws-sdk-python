...
```
pip install aws-sdk-cloudsearch-domain
```

## Usage

```python
from aws_sdk_cloudsearch_domain import AsyncCloudSearchDomainClient
...
```python
from aws_sdk_cloudsearch_domain import AsyncCloudSearchDomainClient
from aws_sdk_cloudsearch_domain.error import SearchException
