...
class CloudSearchDomainError(Exception):
    """Base class for all CloudSearchDomain service errors."""


class ServiceError(CloudSearchDomainError):
...
class SerializationError(CloudSearchDomainError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CloudSearchDomainError):
...
class WaiterFailedError(CloudSearchDomainError):
...
class WaiterTimeoutError(CloudSearchDomainError):
