...
class Hits(TypedDict, closed=True):
    ...
    cursor: NotRequired["aws_sdk_cloudsearch_domain.types.string.String"]
    ...
    hit: NotRequired["aws_sdk_cloudsearch_domain.types.hit_list.HitList"]
...
def serialize_json(value: Hits) -> dict:
    ...
    if "hit" in value:
        ...
        out["hit"] = aws_sdk_cloudsearch_domain.types.hit_list.serialize_json(
            value["hit"]
        )
    return out
...
def deserialize_json(data: dict) -> Hits:
    ...
    if "hit" in data:
        ...
        out["hit"] = aws_sdk_cloudsearch_domain.types.hit_list.deserialize_json(
            data["hit"]
        )
    return out
