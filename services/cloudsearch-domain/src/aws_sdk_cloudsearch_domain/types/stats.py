...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudsearch_domain.types.field_stats

Stats: TypeAlias = dict[
    "aws_sdk_cloudsearch_domain.types.string.String",
    "aws_sdk_cloudsearch_domain.types.field_stats.FieldStats",
]
...
def serialize_json(input_to_serialize: Stats) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_cloudsearch_domain.types.field_stats.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> Stats:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_cloudsearch_domain.types.field_stats.deserialize_json(value)
    return out
