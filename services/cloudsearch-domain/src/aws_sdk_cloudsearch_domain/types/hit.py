...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudsearch_domain.types.fields
    import aws_sdk_cloudsearch_domain.types.highlights
...
class Hit(TypedDict):
    ...
    exprs: NotRequired["aws_sdk_cloudsearch_domain.types.exprs.Exprs"]
    """<p>The expressions returned from a document that matches the search request.</p>"""
    highlights: NotRequired["aws_sdk_cloudsearch_domain.types.highlights.Highlights"]
...
def serialize_json(value: Hit) -> dict:
    ...
    if "fields" in value:
        ...
        out["fields"] = aws_sdk_cloudsearch_domain.types.fields.serialize_json(
            value["fields"]
        )
    if "exprs" in value:
        import aws_sdk_cloudsearch_domain.types.exprs

        out["exprs"] = aws_sdk_cloudsearch_domain.types.exprs.serialize_json(
            value["exprs"]
        )
    if "highlights" in value:
        import aws_sdk_cloudsearch_domain.types.highlights

        out["highlights"] = aws_sdk_cloudsearch_domain.types.highlights.serialize_json(
            value["highlights"]
        )
    return out
...
def deserialize_json(data: dict) -> Hit:
    ...
    if "fields" in data:
        ...
        out["fields"] = aws_sdk_cloudsearch_domain.types.fields.deserialize_json(
            data["fields"]
        )
    if "exprs" in data:
        import aws_sdk_cloudsearch_domain.types.exprs

        out["exprs"] = aws_sdk_cloudsearch_domain.types.exprs.deserialize_json(
            data["exprs"]
        )
    if "highlights" in data:
        ...
        out["highlights"] = (
            aws_sdk_cloudsearch_domain.types.highlights.deserialize_json(
                data["highlights"]
            )
        )
    return out
