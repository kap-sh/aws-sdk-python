...
def serialize_json(value: UploadDocumentsResponse) -> dict:
    ...
    if "warnings" in value:
        ...
        out["warnings"] = (
            capo_cloudsearch_domain.types.document_service_warnings.serialize_json(
                value["warnings"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> UploadDocumentsResponse:
    ...
    if "warnings" in data:
        ...
        out["warnings"] = (
            capo_cloudsearch_domain.types.document_service_warnings.deserialize_json(
                data["warnings"]
            )
        )
    return out
