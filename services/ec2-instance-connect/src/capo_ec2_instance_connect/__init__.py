...
from ._services.async_ec2_instance_connect import (
    AsyncEC2InstanceConnectClient as AsyncEC2InstanceConnectClient,
)
from ._services.ec2_instance_connect import (
    EC2InstanceConnectClient as EC2InstanceConnectClient,
)
