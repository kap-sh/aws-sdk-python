...
import capo_ec2_instance_connect.errors.ec2_instance_type_invalid_exception
...
import capo_ec2_instance_connect.errors.serial_console_access_disabled_exception
import capo_ec2_instance_connect.errors.serial_console_session_limit_exceeded_exception
import capo_ec2_instance_connect.errors.serial_console_session_unavailable_exception
import capo_ec2_instance_connect.errors.serial_console_session_unsupported_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EC2InstanceTypeInvalidException":
            raise capo_ec2_instance_connect.errors.ec2_instance_type_invalid_exception.EC2InstanceTypeInvalidException.from_aws_json_1_1(
                data
            )
        ...
        case "SerialConsoleAccessDisabledException":
            raise capo_ec2_instance_connect.errors.serial_console_access_disabled_exception.SerialConsoleAccessDisabledException.from_aws_json_1_1(
                data
            )
        case "SerialConsoleSessionLimitExceededException":
            raise capo_ec2_instance_connect.errors.serial_console_session_limit_exceeded_exception.SerialConsoleSessionLimitExceededException.from_aws_json_1_1(
                data
            )
        case "SerialConsoleSessionUnavailableException":
            raise capo_ec2_instance_connect.errors.serial_console_session_unavailable_exception.SerialConsoleSessionUnavailableException.from_aws_json_1_1(
                data
            )
        case "SerialConsoleSessionUnsupportedException":
            raise capo_ec2_instance_connect.errors.serial_console_session_unsupported_exception.SerialConsoleSessionUnsupportedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_ec2_instance_connect.types.send_serial_console_ssh_public_key_response.SendSerialConsoleSSHPublicKeyResponse = capo_ec2_instance_connect.types.send_serial_console_ssh_public_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ec2_instance_connect.types.send_serial_console_ssh_public_key_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
