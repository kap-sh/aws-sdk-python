...
def handle_response(
    ...
    out: aws_sdk_ec2_instance_connect.types.send_ssh_public_key_response.SendSSHPublicKeyResponse = aws_sdk_ec2_instance_connect.types.send_ssh_public_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ec2_instance_connect.types.send_ssh_public_key_request.SendSSHPublicKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ec2_instance_connect.types.send_ssh_public_key_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
