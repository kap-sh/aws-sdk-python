"""Generated from Smithy shape ``com.amazonaws.ec2instanceconnect#ServiceException``."""
...
class ServiceException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ec2instanceconnect#ServiceException``."""
