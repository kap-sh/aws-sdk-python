...
class EC2InstanceConnectError(Exception):
    """Base class for all EC2InstanceConnect service errors."""


class ServiceError(EC2InstanceConnectError):
...
class SerializationError(EC2InstanceConnectError):
    """Raised when a value cannot be serialized."""


class DeserializationError(EC2InstanceConnectError):
...
class WaiterFailedError(EC2InstanceConnectError):
...
class WaiterTimeoutError(EC2InstanceConnectError):
