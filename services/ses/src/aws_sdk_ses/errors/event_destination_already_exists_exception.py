...
class EventDestinationAlreadyExistsException_(TypedDict):
...
class EventDestinationAlreadyExistsException(ServiceError):
    ...
    def __init__(self, data: EventDestinationAlreadyExistsException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_query(cls, el: Element) -> "EventDestinationAlreadyExistsException":
