...
class SendBulkTemplatedEmailRequest(TypedDict, closed=True):
    ...
    default_tags: NotRequired["aws_sdk_ses.types.message_tag_list.MessageTagList"]
    ...
    destinations: (
        "aws_sdk_ses.types.bulk_email_destination_list.BulkEmailDestinationList"
    )
...
def serialize_query(
    ...
    aws_sdk_ses.types.bulk_email_destination_list.serialize_query(
...
def deserialize_query(el: Element) -> SendBulkTemplatedEmailRequest:
    ...
    if child_default_tags is not None:
        ...
        out["default_tags"] = aws_sdk_ses.types.message_tag_list.deserialize_query(
            child_default_tags
        )
    ...
    if child_destinations is not None:
        ...
        out["destinations"] = (
            aws_sdk_ses.types.bulk_email_destination_list.deserialize_query(
                child_destinations
            )
        )
    else:
