...
if TYPE_CHECKING:
    ...
    import aws_sdk_ses.types.diagnostic_code
    import aws_sdk_ses.types.dsn_action
    import aws_sdk_ses.types.dsn_status
    import aws_sdk_ses.types.extension_field_list
    import aws_sdk_ses.types.last_attempt_date
...
def serialize_query(
    ...
    aws_sdk_ses.types.dsn_action.serialize_query(
    ...
    if "last_attempt_date" in value:
        ...
        aws_sdk_ses.types.last_attempt_date.serialize_query(
...
def deserialize_query(el: Element) -> RecipientDsnFields:
    ...
    if child_action is not None:
        ...
        out["action"] = aws_sdk_ses.types.dsn_action.deserialize_query(child_action)
    else:
    ...
    if child_last_attempt_date is not None:
        ...
        out["last_attempt_date"] = (
            aws_sdk_ses.types.last_attempt_date.deserialize_query(
