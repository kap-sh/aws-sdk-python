...
if TYPE_CHECKING:
    ...
    import aws_sdk_ses.types.receipt_actions_list
    import aws_sdk_ses.types.receipt_rule_name
    import aws_sdk_ses.types.recipients_list
...
class ReceiptRule(TypedDict, closed=True):
    ...
    recipients: NotRequired["aws_sdk_ses.types.recipients_list.RecipientsList"]
    ...
    actions: NotRequired["aws_sdk_ses.types.receipt_actions_list.ReceiptActionsList"]
    ...
    scan_enabled: "aws_sdk_ses.types.enabled.Enabled"
...
def serialize_query(
    ...
    if "recipients" in value:
        ...
        aws_sdk_ses.types.recipients_list.serialize_query(
            value["recipients"], pairs, f"{prefix}.Recipients"
        )
    if "actions" in value:
        import aws_sdk_ses.types.receipt_actions_list

        aws_sdk_ses.types.receipt_actions_list.serialize_query(
...
def deserialize_query(el: Element) -> ReceiptRule:
    ...
    if child_recipients is not None:
        ...
        out["recipients"] = aws_sdk_ses.types.recipients_list.deserialize_query(
            child_recipients
        )
    ...
    if child_actions is not None:
        ...
        out["actions"] = aws_sdk_ses.types.receipt_actions_list.deserialize_query(
            child_actions
        )
