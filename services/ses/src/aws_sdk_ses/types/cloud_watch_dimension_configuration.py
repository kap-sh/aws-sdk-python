...
if TYPE_CHECKING:
    import aws_sdk_ses.types.default_dimension_value
    import aws_sdk_ses.types.dimension_name
...
class CloudWatchDimensionConfiguration(TypedDict, closed=True):
    ...
    dimension_value_source: (
        "aws_sdk_ses.types.dimension_value_source.DimensionValueSource"
    )
    ...
    default_dimension_value: (
        "aws_sdk_ses.types.default_dimension_value.DefaultDimensionValue"
    )
...
def serialize_query(
    ...
    aws_sdk_ses.types.dimension_value_source.serialize_query(
...
def deserialize_query(el: Element) -> CloudWatchDimensionConfiguration:
    ...
    if child_dimension_value_source is not None:
        ...
        out["dimension_value_source"] = (
            aws_sdk_ses.types.dimension_value_source.deserialize_query(
