...
class SendRawEmailRequest(TypedDict):
    ...
    from_arn: NotRequired["aws_sdk_ses.types.amazon_resource_name.AmazonResourceName"]
...
def serialize_query(
    ...
    aws_sdk_ses.types.raw_message.serialize_query(
...
def deserialize_query(el: Element) -> SendRawEmailRequest:
    ...
    if child_destinations is not None:
        ...
        out["destinations"] = aws_sdk_ses.types.address_list.deserialize_query(
            child_destinations
        )
    ...
    if child_raw_message is not None:
        ...
        out["raw_message"] = aws_sdk_ses.types.raw_message.deserialize_query(
            child_raw_message
        )
    else:
