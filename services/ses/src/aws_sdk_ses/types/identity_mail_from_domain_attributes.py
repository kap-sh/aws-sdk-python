...
if TYPE_CHECKING:
    ...
    import aws_sdk_ses.types.custom_mail_from_status
    import aws_sdk_ses.types.mail_from_domain_name


class IdentityMailFromDomainAttributes(TypedDict):
    mail_from_domain: "aws_sdk_ses.types.mail_from_domain_name.MailFromDomainName"
    """<p>The custom MAIL FROM domain that the identity is configured to use.</p>"""
    mail_from_domain_status: (
        "aws_sdk_ses.types.custom_mail_from_status.CustomMailFromStatus"
    )
...
def serialize_query(
    ...
    aws_sdk_ses.types.custom_mail_from_status.serialize_query(
...
def deserialize_query(el: Element) -> IdentityMailFromDomainAttributes:
    ...
    if child_mail_from_domain_status is not None:
        ...
        out["mail_from_domain_status"] = (
            aws_sdk_ses.types.custom_mail_from_status.deserialize_query(
