...
if TYPE_CHECKING:
    import aws_sdk_ses.types.cloud_watch_destination
    import aws_sdk_ses.types.enabled
    import aws_sdk_ses.types.event_destination_name
    import aws_sdk_ses.types.event_types
    import aws_sdk_ses.types.kinesis_firehose_destination
...
class EventDestination(TypedDict, closed=True):
    ...
    matching_event_types: "aws_sdk_ses.types.event_types.EventTypes"
    ...
    kinesis_firehose_destination: NotRequired[
        "aws_sdk_ses.types.kinesis_firehose_destination.KinesisFirehoseDestination"
    ]
    ...
    cloud_watch_destination: NotRequired[
        "aws_sdk_ses.types.cloud_watch_destination.CloudWatchDestination"
    ]
    ...
    sns_destination: NotRequired["aws_sdk_ses.types.sns_destination.SNSDestination"]
...
def serialize_query(
    ...
    aws_sdk_ses.types.event_types.serialize_query(
        value["matching_event_types"], pairs, f"{prefix}.MatchingEventTypes"
    )
    if "kinesis_firehose_destination" in value:
        import aws_sdk_ses.types.kinesis_firehose_destination

        aws_sdk_ses.types.kinesis_firehose_destination.serialize_query(
    ...
    if "cloud_watch_destination" in value:
        ...
        aws_sdk_ses.types.cloud_watch_destination.serialize_query(
            value["cloud_watch_destination"], pairs, f"{prefix}.CloudWatchDestination"
        )
    if "sns_destination" in value:
        import aws_sdk_ses.types.sns_destination

        aws_sdk_ses.types.sns_destination.serialize_query(
...
def deserialize_query(el: Element) -> EventDestination:
    ...
    if child_matching_event_types is not None:
        ...
        out["matching_event_types"] = aws_sdk_ses.types.event_types.deserialize_query(
    ...
    if child_kinesis_firehose_destination is not None:
        ...
        out["kinesis_firehose_destination"] = (
            aws_sdk_ses.types.kinesis_firehose_destination.deserialize_query(
    ...
    if child_cloud_watch_destination is not None:
        ...
        out["cloud_watch_destination"] = (
            aws_sdk_ses.types.cloud_watch_destination.deserialize_query(
    ...
    if child_sns_destination is not None:
        ...
        out["sns_destination"] = aws_sdk_ses.types.sns_destination.deserialize_query(
