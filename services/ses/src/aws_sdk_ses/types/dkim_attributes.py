...
if TYPE_CHECKING:
    ...
    import aws_sdk_ses.types.identity_dkim_attributes

DkimAttributes: TypeAlias = dict[
    "aws_sdk_ses.types.identity.Identity",
    "aws_sdk_ses.types.identity_dkim_attributes.IdentityDkimAttributes",
]
...
def serialize_query(
    ...
    for n, (key, value) in enumerate(input_to_serialize.items(), 1):
        ...
        aws_sdk_ses.types.identity_dkim_attributes.serialize_query(
...
def deserialize_query(el: Element) -> DkimAttributes:
    ...
    for entry in el.findall("entry"):
        ...
        value = aws_sdk_ses.types.identity_dkim_attributes.deserialize_query(
            value_element
        )
        out[key] = value
    return out
