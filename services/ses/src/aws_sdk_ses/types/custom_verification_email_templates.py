...
if TYPE_CHECKING:
    import aws_sdk_ses.types.custom_verification_email_template

CustomVerificationEmailTemplates: TypeAlias = list[
    "aws_sdk_ses.types.custom_verification_email_template.CustomVerificationEmailTemplate"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_ses.types.custom_verification_email_template.serialize_query(
...
def deserialize_query(el: Element) -> CustomVerificationEmailTemplates:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_ses.types.custom_verification_email_template.deserialize_query(
                child
            )
        )
    return out
