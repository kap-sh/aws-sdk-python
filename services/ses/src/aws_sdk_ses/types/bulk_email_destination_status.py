...
if TYPE_CHECKING:
    import aws_sdk_ses.types.bulk_email_status
    import aws_sdk_ses.types.error
    import aws_sdk_ses.types.message_id


class BulkEmailDestinationStatus(TypedDict):
    status: NotRequired["aws_sdk_ses.types.bulk_email_status.BulkEmailStatus"]
    ...
    error: NotRequired["aws_sdk_ses.types.error.Error"]
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_ses.types.bulk_email_status.serialize_query(
...
def deserialize_query(el: Element) -> BulkEmailDestinationStatus:
    ...
    if child_status is not None:
        ...
        out["status"] = aws_sdk_ses.types.bulk_email_status.deserialize_query(
            child_status
        )
