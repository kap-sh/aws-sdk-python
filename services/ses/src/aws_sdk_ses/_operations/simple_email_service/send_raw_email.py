...
def build_request(
    ...
    input_: aws_sdk_ses.types.send_raw_email_request.SendRawEmailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.send_raw_email_request.serialize_query(input_, pairs, "")
...
def send_raw_email(
    ...
    aws_sdk_ses.types.send_raw_email_response.SendRawEmailResponse, zapros.Response
]:
