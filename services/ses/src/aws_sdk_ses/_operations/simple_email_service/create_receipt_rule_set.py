...
def handle_response(
    ...
    out: aws_sdk_ses.types.create_receipt_rule_set_response.CreateReceiptRuleSetResponse = aws_sdk_ses.types.create_receipt_rule_set_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.create_receipt_rule_set_request.CreateReceiptRuleSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.create_receipt_rule_set_request.serialize_query(input_, pairs, "")
