...
def build_request(
    ...
    input: aws_sdk_ses.types.create_receipt_rule_set_request.CreateReceiptRuleSetRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.create_receipt_rule_set_request.serialize_query(input, pairs, "")
