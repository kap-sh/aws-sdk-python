...
def build_request(
    ...
    input_: aws_sdk_ses.types.create_receipt_rule_request.CreateReceiptRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.create_receipt_rule_request.serialize_query(input_, pairs, "")
