...
def handle_response(
    ...
    out: aws_sdk_ses.types.list_identities_response.ListIdentitiesResponse = (
        aws_sdk_ses.types.list_identities_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.list_identities_request.ListIdentitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.list_identities_request.serialize_query(input_, pairs, "")
...
def list_identities(
    ...
    aws_sdk_ses.types.list_identities_response.ListIdentitiesResponse, zapros.Response
]:
