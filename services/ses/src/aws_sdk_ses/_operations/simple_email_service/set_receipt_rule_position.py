...
def handle_response(
    ...
    out: aws_sdk_ses.types.set_receipt_rule_position_response.SetReceiptRulePositionResponse = aws_sdk_ses.types.set_receipt_rule_position_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.set_receipt_rule_position_request.SetReceiptRulePositionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.set_receipt_rule_position_request.serialize_query(
        input_, pairs, ""
    )
