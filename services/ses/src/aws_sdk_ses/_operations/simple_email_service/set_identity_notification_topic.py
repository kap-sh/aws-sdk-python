...
def handle_response(
    ...
    out: aws_sdk_ses.types.set_identity_notification_topic_response.SetIdentityNotificationTopicResponse = aws_sdk_ses.types.set_identity_notification_topic_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.set_identity_notification_topic_request.SetIdentityNotificationTopicRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.set_identity_notification_topic_request.serialize_query(
        input_, pairs, ""
    )
