...
def handle_response(
    ...
    out: aws_sdk_ses.types.delete_receipt_filter_response.DeleteReceiptFilterResponse = aws_sdk_ses.types.delete_receipt_filter_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.delete_receipt_filter_request.DeleteReceiptFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.delete_receipt_filter_request.serialize_query(input_, pairs, "")
