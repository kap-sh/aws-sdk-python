...
def build_request(
    ...
    input: aws_sdk_ses.types.delete_receipt_filter_request.DeleteReceiptFilterRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.delete_receipt_filter_request.serialize_query(input, pairs, "")
