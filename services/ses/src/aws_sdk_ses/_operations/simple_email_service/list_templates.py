...
def handle_response(
    ...
    out: aws_sdk_ses.types.list_templates_response.ListTemplatesResponse = (
        aws_sdk_ses.types.list_templates_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.list_templates_request.ListTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.list_templates_request.serialize_query(input_, pairs, "")
...
def list_templates(
    ...
    aws_sdk_ses.types.list_templates_response.ListTemplatesResponse, zapros.Response
]:
