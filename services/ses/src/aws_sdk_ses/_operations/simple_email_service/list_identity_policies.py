"""Generated from Smithy shape ``com.amazonaws.ses#ListIdentityPolicies``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListIdentityPoliciesResult")
    out: aws_sdk_ses.types.list_identity_policies_response.ListIdentityPoliciesResponse = aws_sdk_ses.types.list_identity_policies_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.list_identity_policies_request.ListIdentityPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListIdentityPolicies"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_ses.types.list_identity_policies_request

    aws_sdk_ses.types.list_identity_policies_request.serialize_query(input_, pairs, "")
...
async def async_list_identity_policies(
