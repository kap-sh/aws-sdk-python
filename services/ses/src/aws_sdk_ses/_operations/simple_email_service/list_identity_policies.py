...
def build_request(
    ...
    input: aws_sdk_ses.types.list_identity_policies_request.ListIdentityPoliciesRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.list_identity_policies_request.serialize_query(input, pairs, "")
