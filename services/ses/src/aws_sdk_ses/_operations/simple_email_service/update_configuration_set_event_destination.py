...
def handle_response(
    ...
    out: aws_sdk_ses.types.update_configuration_set_event_destination_response.UpdateConfigurationSetEventDestinationResponse = aws_sdk_ses.types.update_configuration_set_event_destination_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.update_configuration_set_event_destination_request.UpdateConfigurationSetEventDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.update_configuration_set_event_destination_request.serialize_query(
        input_, pairs, ""
    )
