...
def handle_response(
    ...
    out: aws_sdk_ses.types.list_receipt_rule_sets_response.ListReceiptRuleSetsResponse = aws_sdk_ses.types.list_receipt_rule_sets_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_ses.types.list_receipt_rule_sets_request.ListReceiptRuleSetsRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.list_receipt_rule_sets_request.serialize_query(input, pairs, "")
