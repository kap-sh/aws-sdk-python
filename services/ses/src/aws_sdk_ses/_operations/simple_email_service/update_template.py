"""Generated from Smithy shape ``com.amazonaws.ses#UpdateTemplate``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("UpdateTemplateResult")
    out: aws_sdk_ses.types.update_template_response.UpdateTemplateResponse = (
        aws_sdk_ses.types.update_template_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.update_template_request.UpdateTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UpdateTemplate"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_ses.types.update_template_request

    aws_sdk_ses.types.update_template_request.serialize_query(input_, pairs, "")
...
def update_template(
    ...
    aws_sdk_ses.types.update_template_response.UpdateTemplateResponse, zapros.Response
]:
