...
def handle_response(
    ...
    out: aws_sdk_ses.types.set_identity_dkim_enabled_response.SetIdentityDkimEnabledResponse = aws_sdk_ses.types.set_identity_dkim_enabled_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.set_identity_dkim_enabled_request.SetIdentityDkimEnabledRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.set_identity_dkim_enabled_request.serialize_query(
        input_, pairs, ""
    )
