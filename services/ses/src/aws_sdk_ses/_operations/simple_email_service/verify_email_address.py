...
def build_request(
    ...
    input: aws_sdk_ses.types.verify_email_address_request.VerifyEmailAddressRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.verify_email_address_request.serialize_query(input, pairs, "")
