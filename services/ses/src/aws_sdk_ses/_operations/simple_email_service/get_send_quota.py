...
def handle_response(
    ...
    out: aws_sdk_ses.types.get_send_quota_response.GetSendQuotaResponse = (
        aws_sdk_ses.types.get_send_quota_response.deserialize_query(
...
def get_send_quota(
    ...
    aws_sdk_ses.types.get_send_quota_response.GetSendQuotaResponse, zapros.Response
]:
