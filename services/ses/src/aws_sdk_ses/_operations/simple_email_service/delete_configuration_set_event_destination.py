...
import aws_sdk_ses.errors.event_destination_does_not_exist_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EventDestinationDoesNotExistException":
            raise aws_sdk_ses.errors.event_destination_does_not_exist_exception.EventDestinationDoesNotExistException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ses.types.delete_configuration_set_event_destination_response.DeleteConfigurationSetEventDestinationResponse = aws_sdk_ses.types.delete_configuration_set_event_destination_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.delete_configuration_set_event_destination_request.DeleteConfigurationSetEventDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.delete_configuration_set_event_destination_request.serialize_query(
        input_, pairs, ""
    )
