...
def handle_response(
    ...
    out: aws_sdk_ses.types.send_bounce_response.SendBounceResponse = (
        aws_sdk_ses.types.send_bounce_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.send_bounce_request.SendBounceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.send_bounce_request.serialize_query(input_, pairs, "")
...
def send_bounce(
    ...
    input_: aws_sdk_ses.types.send_bounce_request.SendBounceRequest,
) -> tuple[aws_sdk_ses.types.send_bounce_response.SendBounceResponse, zapros.Response]:
