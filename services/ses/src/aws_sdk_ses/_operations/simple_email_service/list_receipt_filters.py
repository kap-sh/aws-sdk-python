...
def handle_response(
    ...
    out: aws_sdk_ses.types.list_receipt_filters_response.ListReceiptFiltersResponse = (
        aws_sdk_ses.types.list_receipt_filters_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.list_receipt_filters_request.ListReceiptFiltersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.list_receipt_filters_request.serialize_query(input_, pairs, "")
