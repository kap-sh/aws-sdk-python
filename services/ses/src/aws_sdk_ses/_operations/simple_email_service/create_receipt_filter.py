...
def build_request(
    ...
    input: aws_sdk_ses.types.create_receipt_filter_request.CreateReceiptFilterRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.create_receipt_filter_request.serialize_query(input, pairs, "")
