"""Generated from Smithy shape ``com.amazonaws.ses#CreateReceiptFilter``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateReceiptFilterResult")
    out: aws_sdk_ses.types.create_receipt_filter_response.CreateReceiptFilterResponse = aws_sdk_ses.types.create_receipt_filter_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.create_receipt_filter_request.CreateReceiptFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateReceiptFilter"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_ses.types.create_receipt_filter_request

    aws_sdk_ses.types.create_receipt_filter_request.serialize_query(input_, pairs, "")
...
async def async_create_receipt_filter(
