...
def handle_response(
    ...
    out: aws_sdk_ses.types.get_custom_verification_email_template_response.GetCustomVerificationEmailTemplateResponse = aws_sdk_ses.types.get_custom_verification_email_template_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.get_custom_verification_email_template_request.GetCustomVerificationEmailTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.get_custom_verification_email_template_request.serialize_query(
        input_, pairs, ""
    )
