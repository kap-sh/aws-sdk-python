...
def build_request(
    ...
    input_: aws_sdk_ses.types.create_configuration_set_request.CreateConfigurationSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.create_configuration_set_request.serialize_query(
        input_, pairs, ""
    )
