...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConfigurationSetAlreadyExistsException":
            import aws_sdk_ses.errors.configuration_set_already_exists_exception

            raise aws_sdk_ses.errors.configuration_set_already_exists_exception.ConfigurationSetAlreadyExistsException.from_query(
                root
            )
        case "InvalidConfigurationSetException":
            import aws_sdk_ses.errors.invalid_configuration_set_exception

            raise aws_sdk_ses.errors.invalid_configuration_set_exception.InvalidConfigurationSetException.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_ses.types.create_configuration_set_response.CreateConfigurationSetResponse = aws_sdk_ses.types.create_configuration_set_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_ses.types.create_configuration_set_request.CreateConfigurationSetRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.create_configuration_set_request.serialize_query(input, pairs, "")
