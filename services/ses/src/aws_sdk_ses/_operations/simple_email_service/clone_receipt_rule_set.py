"""Generated from Smithy shape ``com.amazonaws.ses#CloneReceiptRuleSet``."""
...
def build_request(
    ...
    input: aws_sdk_ses.types.clone_receipt_rule_set_request.CloneReceiptRuleSetRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.clone_receipt_rule_set_request.serialize_query(input, pairs, "")
...
async def async_clone_receipt_rule_set(
