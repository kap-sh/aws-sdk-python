...
def handle_response(
    ...
    out: aws_sdk_ses.types.get_identity_dkim_attributes_response.GetIdentityDkimAttributesResponse = aws_sdk_ses.types.get_identity_dkim_attributes_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.get_identity_dkim_attributes_request.GetIdentityDkimAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.get_identity_dkim_attributes_request.serialize_query(
        input_, pairs, ""
    )
