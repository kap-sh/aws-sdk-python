...
def build_request(
    ...
    input: aws_sdk_ses.types.delete_receipt_rule_set_request.DeleteReceiptRuleSetRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.delete_receipt_rule_set_request.serialize_query(input, pairs, "")
