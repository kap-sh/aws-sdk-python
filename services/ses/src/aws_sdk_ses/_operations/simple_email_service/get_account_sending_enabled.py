"""Generated from Smithy shape ``com.amazonaws.ses#GetAccountSendingEnabled``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetAccountSendingEnabledResult")
    out: aws_sdk_ses.types.get_account_sending_enabled_response.GetAccountSendingEnabledResponse = aws_sdk_ses.types.get_account_sending_enabled_response.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "GetAccountSendingEnabled"))
...
async def async_get_account_sending_enabled(
