...
def build_request(
    ...
    input: aws_sdk_ses.types.list_configuration_sets_request.ListConfigurationSetsRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.list_configuration_sets_request.serialize_query(input, pairs, "")
