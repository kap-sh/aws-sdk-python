...
import aws_sdk_ses.types.configuration_sets
...
def handle_response(
    ...
    out: aws_sdk_ses.types.list_configuration_sets_response.ListConfigurationSetsResponse = aws_sdk_ses.types.list_configuration_sets_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.list_configuration_sets_request.ListConfigurationSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.list_configuration_sets_request.serialize_query(input_, pairs, "")
