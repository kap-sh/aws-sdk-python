...
def handle_response(
    ...
    out: aws_sdk_ses.types.send_templated_email_response.SendTemplatedEmailResponse = (
        aws_sdk_ses.types.send_templated_email_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.send_templated_email_request.SendTemplatedEmailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.send_templated_email_request.serialize_query(input_, pairs, "")
