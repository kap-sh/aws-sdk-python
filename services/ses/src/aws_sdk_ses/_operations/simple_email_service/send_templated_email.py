...
def build_request(
    ...
    input: aws_sdk_ses.types.send_templated_email_request.SendTemplatedEmailRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.send_templated_email_request.serialize_query(input, pairs, "")
