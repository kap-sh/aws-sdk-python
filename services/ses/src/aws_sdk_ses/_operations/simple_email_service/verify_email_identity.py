...
def build_request(
    ...
    input: aws_sdk_ses.types.verify_email_identity_request.VerifyEmailIdentityRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.verify_email_identity_request.serialize_query(input, pairs, "")
