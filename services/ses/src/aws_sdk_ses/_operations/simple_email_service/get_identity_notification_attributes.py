...
def handle_response(
    ...
    out: aws_sdk_ses.types.get_identity_notification_attributes_response.GetIdentityNotificationAttributesResponse = aws_sdk_ses.types.get_identity_notification_attributes_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.get_identity_notification_attributes_request.GetIdentityNotificationAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.get_identity_notification_attributes_request.serialize_query(
        input_, pairs, ""
    )
