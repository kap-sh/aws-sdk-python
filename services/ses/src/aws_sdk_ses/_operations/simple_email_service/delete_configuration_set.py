...
def handle_response(
    ...
    out: aws_sdk_ses.types.delete_configuration_set_response.DeleteConfigurationSetResponse = aws_sdk_ses.types.delete_configuration_set_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_ses.types.delete_configuration_set_request.DeleteConfigurationSetRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.delete_configuration_set_request.serialize_query(input, pairs, "")
