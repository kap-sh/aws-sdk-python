...
def handle_response(
    ...
    out: aws_sdk_ses.types.get_identity_mail_from_domain_attributes_response.GetIdentityMailFromDomainAttributesResponse = aws_sdk_ses.types.get_identity_mail_from_domain_attributes_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.get_identity_mail_from_domain_attributes_request.GetIdentityMailFromDomainAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.get_identity_mail_from_domain_attributes_request.serialize_query(
        input_, pairs, ""
    )
