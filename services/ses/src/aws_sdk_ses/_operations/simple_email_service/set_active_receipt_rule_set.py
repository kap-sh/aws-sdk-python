...
def handle_response(
    ...
    out: aws_sdk_ses.types.set_active_receipt_rule_set_response.SetActiveReceiptRuleSetResponse = aws_sdk_ses.types.set_active_receipt_rule_set_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.set_active_receipt_rule_set_request.SetActiveReceiptRuleSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.set_active_receipt_rule_set_request.serialize_query(
        input_, pairs, ""
    )
