...
def handle_response(
    ...
    out: aws_sdk_ses.types.describe_active_receipt_rule_set_response.DescribeActiveReceiptRuleSetResponse = aws_sdk_ses.types.describe_active_receipt_rule_set_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.describe_active_receipt_rule_set_request.DescribeActiveReceiptRuleSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
