...
def build_request(
    ...
    input: aws_sdk_ses.types.get_identity_policies_request.GetIdentityPoliciesRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.get_identity_policies_request.serialize_query(input, pairs, "")
