...
def handle_response(
    ...
    out: aws_sdk_ses.types.get_identity_policies_response.GetIdentityPoliciesResponse = aws_sdk_ses.types.get_identity_policies_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.get_identity_policies_request.GetIdentityPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.get_identity_policies_request.serialize_query(input_, pairs, "")
