"""Generated from Smithy shape ``com.amazonaws.ses#DeleteCustomVerificationEmailTemplate``."""
...
def build_request(
    ...
    input_: aws_sdk_ses.types.delete_custom_verification_email_template_request.DeleteCustomVerificationEmailTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
