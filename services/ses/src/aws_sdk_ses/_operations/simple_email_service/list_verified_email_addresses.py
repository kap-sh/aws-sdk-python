...
def handle_response(
    ...
    out: aws_sdk_ses.types.list_verified_email_addresses_response.ListVerifiedEmailAddressesResponse = aws_sdk_ses.types.list_verified_email_addresses_response.deserialize_query(
