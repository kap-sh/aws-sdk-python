...
def handle_response(
    ...
    out: aws_sdk_ses.types.set_identity_headers_in_notifications_enabled_response.SetIdentityHeadersInNotificationsEnabledResponse = aws_sdk_ses.types.set_identity_headers_in_notifications_enabled_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.set_identity_headers_in_notifications_enabled_request.SetIdentityHeadersInNotificationsEnabledRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.set_identity_headers_in_notifications_enabled_request.serialize_query(
        input_, pairs, ""
    )
