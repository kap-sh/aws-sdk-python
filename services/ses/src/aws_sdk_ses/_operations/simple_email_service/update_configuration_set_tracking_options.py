...
def handle_response(
    ...
    out: aws_sdk_ses.types.update_configuration_set_tracking_options_response.UpdateConfigurationSetTrackingOptionsResponse = aws_sdk_ses.types.update_configuration_set_tracking_options_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.update_configuration_set_tracking_options_request.UpdateConfigurationSetTrackingOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
