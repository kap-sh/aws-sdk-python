...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDeliveryOptionsException":
            import aws_sdk_ses.errors.invalid_delivery_options_exception

            raise aws_sdk_ses.errors.invalid_delivery_options_exception.InvalidDeliveryOptionsException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ses.types.put_configuration_set_delivery_options_response.PutConfigurationSetDeliveryOptionsResponse = aws_sdk_ses.types.put_configuration_set_delivery_options_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.put_configuration_set_delivery_options_request.PutConfigurationSetDeliveryOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
