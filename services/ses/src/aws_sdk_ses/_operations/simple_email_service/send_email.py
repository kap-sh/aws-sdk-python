"""Generated from Smithy shape ``com.amazonaws.ses#SendEmail``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("SendEmailResult")
    out: aws_sdk_ses.types.send_email_response.SendEmailResponse = (
        aws_sdk_ses.types.send_email_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.send_email_request.SendEmailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "SendEmail"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_ses.types.send_email_request

    aws_sdk_ses.types.send_email_request.serialize_query(input_, pairs, "")
...
def send_email(
    ...
    input_: aws_sdk_ses.types.send_email_request.SendEmailRequest,
) -> tuple[aws_sdk_ses.types.send_email_response.SendEmailResponse, zapros.Response]:
