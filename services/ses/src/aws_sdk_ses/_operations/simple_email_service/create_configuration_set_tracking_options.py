"""Generated from Smithy shape ``com.amazonaws.ses#CreateConfigurationSetTrackingOptions``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTrackingOptionsException":
            import aws_sdk_ses.errors.invalid_tracking_options_exception

            raise aws_sdk_ses.errors.invalid_tracking_options_exception.InvalidTrackingOptionsException.from_query(
                root
            )
        case "TrackingOptionsAlreadyExistsException":
            import aws_sdk_ses.errors.tracking_options_already_exists_exception

            raise aws_sdk_ses.errors.tracking_options_already_exists_exception.TrackingOptionsAlreadyExistsException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateConfigurationSetTrackingOptionsResult")
    out: aws_sdk_ses.types.create_configuration_set_tracking_options_response.CreateConfigurationSetTrackingOptionsResponse = aws_sdk_ses.types.create_configuration_set_tracking_options_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.create_configuration_set_tracking_options_request.CreateConfigurationSetTrackingOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateConfigurationSetTrackingOptions"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_ses.types.create_configuration_set_tracking_options_request

    aws_sdk_ses.types.create_configuration_set_tracking_options_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_configuration_set_tracking_options(
