"""Generated from Smithy shape ``com.amazonaws.ses#DeleteConfigurationSetTrackingOptions``."""
...
import aws_sdk_ses.errors.tracking_options_does_not_exist_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TrackingOptionsDoesNotExistException":
            raise aws_sdk_ses.errors.tracking_options_does_not_exist_exception.TrackingOptionsDoesNotExistException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteConfigurationSetTrackingOptionsResult")
    out: aws_sdk_ses.types.delete_configuration_set_tracking_options_response.DeleteConfigurationSetTrackingOptionsResponse = aws_sdk_ses.types.delete_configuration_set_tracking_options_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.delete_configuration_set_tracking_options_request.DeleteConfigurationSetTrackingOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteConfigurationSetTrackingOptions"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_ses.types.delete_configuration_set_tracking_options_request

    aws_sdk_ses.types.delete_configuration_set_tracking_options_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_configuration_set_tracking_options(
