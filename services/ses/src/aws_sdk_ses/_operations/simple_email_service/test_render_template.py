"""Generated from Smithy shape ``com.amazonaws.ses#TestRenderTemplate``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidRenderingParameterException":
            import aws_sdk_ses.errors.invalid_rendering_parameter_exception

            raise aws_sdk_ses.errors.invalid_rendering_parameter_exception.InvalidRenderingParameterException.from_query(
                root
            )
        case "MissingRenderingAttributeException":
            import aws_sdk_ses.errors.missing_rendering_attribute_exception

            raise aws_sdk_ses.errors.missing_rendering_attribute_exception.MissingRenderingAttributeException.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("TestRenderTemplateResult")
    out: aws_sdk_ses.types.test_render_template_response.TestRenderTemplateResponse = (
        aws_sdk_ses.types.test_render_template_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.test_render_template_request.TestRenderTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "TestRenderTemplate"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_ses.types.test_render_template_request

    aws_sdk_ses.types.test_render_template_request.serialize_query(input_, pairs, "")
...
async def async_test_render_template(
