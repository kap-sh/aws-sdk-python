...
def build_request(
    ...
    input: aws_sdk_ses.types.test_render_template_request.TestRenderTemplateRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.test_render_template_request.serialize_query(input, pairs, "")
