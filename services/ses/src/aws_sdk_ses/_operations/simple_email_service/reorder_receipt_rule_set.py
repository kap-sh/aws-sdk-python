...
def handle_response(
    ...
    out: aws_sdk_ses.types.reorder_receipt_rule_set_response.ReorderReceiptRuleSetResponse = aws_sdk_ses.types.reorder_receipt_rule_set_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_ses.types.reorder_receipt_rule_set_request.ReorderReceiptRuleSetRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.reorder_receipt_rule_set_request.serialize_query(input, pairs, "")
