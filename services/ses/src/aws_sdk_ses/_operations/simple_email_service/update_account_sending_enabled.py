...
def build_request(
    ...
    input_: aws_sdk_ses.types.update_account_sending_enabled_request.UpdateAccountSendingEnabledRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.update_account_sending_enabled_request.serialize_query(
        input_, pairs, ""
    )
