"""Generated from Smithy shape ``com.amazonaws.ses#DeleteTemplate``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteTemplateResult")
    out: aws_sdk_ses.types.delete_template_response.DeleteTemplateResponse = (
        aws_sdk_ses.types.delete_template_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_ses.types.delete_template_request.DeleteTemplateRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.delete_template_request.serialize_query(input, pairs, "")
...
def delete_template(
    ...
    aws_sdk_ses.types.delete_template_response.DeleteTemplateResponse, zapros.Response
]:
