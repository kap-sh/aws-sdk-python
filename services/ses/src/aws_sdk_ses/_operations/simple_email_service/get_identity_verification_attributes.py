...
def handle_response(
    ...
    out: aws_sdk_ses.types.get_identity_verification_attributes_response.GetIdentityVerificationAttributesResponse = aws_sdk_ses.types.get_identity_verification_attributes_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.get_identity_verification_attributes_request.GetIdentityVerificationAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.get_identity_verification_attributes_request.serialize_query(
        input_, pairs, ""
    )
