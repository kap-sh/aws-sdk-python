"""Generated from Smithy shape ``com.amazonaws.ses#GetTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_ses.types.get_template_response.GetTemplateResponse = (
        aws_sdk_ses.types.get_template_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.get_template_request.GetTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.get_template_request.serialize_query(input_, pairs, "")
...
def get_template(
    ...
    aws_sdk_ses.types.get_template_response.GetTemplateResponse, zapros.Response
]:
