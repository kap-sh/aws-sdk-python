"""Generated from Smithy shape ``com.amazonaws.ses#DeleteIdentityPolicy``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteIdentityPolicyResult")
    out: aws_sdk_ses.types.delete_identity_policy_response.DeleteIdentityPolicyResponse = aws_sdk_ses.types.delete_identity_policy_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.delete_identity_policy_request.DeleteIdentityPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteIdentityPolicy"))
    pairs.append(("Version", "2010-12-01"))
    aws_sdk_ses.types.delete_identity_policy_request.serialize_query(input_, pairs, "")
...
async def async_delete_identity_policy(
