...
def build_request(
    ...
    input: aws_sdk_ses.types.delete_identity_policy_request.DeleteIdentityPolicyRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.delete_identity_policy_request.serialize_query(input, pairs, "")
