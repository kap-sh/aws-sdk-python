"""Generated from Smithy shape ``com.amazonaws.ses#SetIdentityFeedbackForwardingEnabled``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("SetIdentityFeedbackForwardingEnabledResult")
    out: aws_sdk_ses.types.set_identity_feedback_forwarding_enabled_response.SetIdentityFeedbackForwardingEnabledResponse = aws_sdk_ses.types.set_identity_feedback_forwarding_enabled_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.set_identity_feedback_forwarding_enabled_request.SetIdentityFeedbackForwardingEnabledRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "SetIdentityFeedbackForwardingEnabled"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_ses.types.set_identity_feedback_forwarding_enabled_request

    aws_sdk_ses.types.set_identity_feedback_forwarding_enabled_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_set_identity_feedback_forwarding_enabled(
