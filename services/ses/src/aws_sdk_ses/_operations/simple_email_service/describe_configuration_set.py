"""Generated from Smithy shape ``com.amazonaws.ses#DescribeConfigurationSet``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeConfigurationSetResult")
    out: aws_sdk_ses.types.describe_configuration_set_response.DescribeConfigurationSetResponse = aws_sdk_ses.types.describe_configuration_set_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.describe_configuration_set_request.DescribeConfigurationSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeConfigurationSet"))
    pairs.append(("Version", "2010-12-01"))
    import aws_sdk_ses.types.describe_configuration_set_request

    aws_sdk_ses.types.describe_configuration_set_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_configuration_set(
