...
def handle_response(
    ...
    out: aws_sdk_ses.types.delete_identity_response.DeleteIdentityResponse = (
        aws_sdk_ses.types.delete_identity_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.delete_identity_request.DeleteIdentityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.delete_identity_request.serialize_query(input_, pairs, "")
...
def delete_identity(
    ...
    aws_sdk_ses.types.delete_identity_response.DeleteIdentityResponse, zapros.Response
]:
