...
def handle_response(
    ...
    out: aws_sdk_ses.types.delete_receipt_rule_response.DeleteReceiptRuleResponse = (
        aws_sdk_ses.types.delete_receipt_rule_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.delete_receipt_rule_request.DeleteReceiptRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.delete_receipt_rule_request.serialize_query(input_, pairs, "")
