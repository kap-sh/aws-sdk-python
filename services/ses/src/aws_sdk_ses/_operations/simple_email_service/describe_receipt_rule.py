...
def build_request(
    ...
    input: aws_sdk_ses.types.describe_receipt_rule_request.DescribeReceiptRuleRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.describe_receipt_rule_request.serialize_query(input, pairs, "")
