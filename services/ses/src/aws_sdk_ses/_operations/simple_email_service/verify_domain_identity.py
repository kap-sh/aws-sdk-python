...
def handle_response(
    ...
    out: aws_sdk_ses.types.verify_domain_identity_response.VerifyDomainIdentityResponse = aws_sdk_ses.types.verify_domain_identity_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.verify_domain_identity_request.VerifyDomainIdentityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.verify_domain_identity_request.serialize_query(input_, pairs, "")
