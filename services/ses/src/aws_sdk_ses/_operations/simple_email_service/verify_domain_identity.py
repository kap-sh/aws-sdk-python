...
def build_request(
    ...
    input: aws_sdk_ses.types.verify_domain_identity_request.VerifyDomainIdentityRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.verify_domain_identity_request.serialize_query(input, pairs, "")
