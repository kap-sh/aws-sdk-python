"""Generated from Smithy shape ``com.amazonaws.ses#PutIdentityPolicy``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidPolicyException":
            import aws_sdk_ses.errors.invalid_policy_exception

            raise aws_sdk_ses.errors.invalid_policy_exception.InvalidPolicyException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("PutIdentityPolicyResult")
    out: aws_sdk_ses.types.put_identity_policy_response.PutIdentityPolicyResponse = (
        aws_sdk_ses.types.put_identity_policy_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_ses.types.put_identity_policy_request.PutIdentityPolicyRequest,
) -> zapros.Request:
    ...
    aws_sdk_ses.types.put_identity_policy_request.serialize_query(input, pairs, "")
...
async def async_put_identity_policy(
