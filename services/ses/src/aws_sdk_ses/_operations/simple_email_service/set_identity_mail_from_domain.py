...
def handle_response(
    ...
    out: aws_sdk_ses.types.set_identity_mail_from_domain_response.SetIdentityMailFromDomainResponse = aws_sdk_ses.types.set_identity_mail_from_domain_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_ses.types.set_identity_mail_from_domain_request.SetIdentityMailFromDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ses.types.set_identity_mail_from_domain_request.serialize_query(
        input_, pairs, ""
    )
