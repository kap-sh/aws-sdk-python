"""Generated from Smithy shape ``com.amazonaws.ses#GetSendStatistics``."""
...
import capo_ses.types.get_send_statistics_response
...
) -> capo_ses.types.get_send_statistics_response.GetSendStatisticsResponse:
    root = fromstring(response.read())
    result = root.find("GetSendStatisticsResult")
    out: capo_ses.types.get_send_statistics_response.GetSendStatisticsResponse = (
        capo_ses.types.get_send_statistics_response.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "GetSendStatistics"))
...
async def async_get_send_statistics(
