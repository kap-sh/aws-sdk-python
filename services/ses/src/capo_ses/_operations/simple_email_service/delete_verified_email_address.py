"""Generated from Smithy shape ``com.amazonaws.ses#DeleteVerifiedEmailAddress``."""
...
import capo_ses.types.delete_verified_email_address_request
...
def build_request(
    ...
    input_: capo_ses.types.delete_verified_email_address_request.DeleteVerifiedEmailAddressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    capo_ses.types.delete_verified_email_address_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_verified_email_address(
