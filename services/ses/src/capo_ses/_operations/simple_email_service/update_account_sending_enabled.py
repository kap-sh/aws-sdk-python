"""Generated from Smithy shape ``com.amazonaws.ses#UpdateAccountSendingEnabled``."""
...
import capo_ses.types.update_account_sending_enabled_request
...
def build_request(
    ...
    input_: capo_ses.types.update_account_sending_enabled_request.UpdateAccountSendingEnabledRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UpdateAccountSendingEnabled"))
    pairs.append(("Version", "2010-12-01"))
    capo_ses.types.update_account_sending_enabled_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_update_account_sending_enabled(
