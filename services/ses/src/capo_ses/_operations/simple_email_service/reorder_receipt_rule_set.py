"""Generated from Smithy shape ``com.amazonaws.ses#ReorderReceiptRuleSet``."""
...
import capo_ses.types.reorder_receipt_rule_set_request
import capo_ses.types.reorder_receipt_rule_set_response
...
) -> capo_ses.types.reorder_receipt_rule_set_response.ReorderReceiptRuleSetResponse:
    root = fromstring(response.read())
    result = root.find("ReorderReceiptRuleSetResult")
    out: capo_ses.types.reorder_receipt_rule_set_response.ReorderReceiptRuleSetResponse = capo_ses.types.reorder_receipt_rule_set_response.deserialize_query(
...
def build_request(
    ...
    input_: capo_ses.types.reorder_receipt_rule_set_request.ReorderReceiptRuleSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    capo_ses.types.reorder_receipt_rule_set_request.serialize_query(input_, pairs, "")
...
async def async_reorder_receipt_rule_set(
