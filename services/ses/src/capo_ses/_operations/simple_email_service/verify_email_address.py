"""Generated from Smithy shape ``com.amazonaws.ses#VerifyEmailAddress``."""
...
import capo_ses.types.verify_email_address_request
...
def build_request(
    ...
    input_: capo_ses.types.verify_email_address_request.VerifyEmailAddressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    capo_ses.types.verify_email_address_request.serialize_query(input_, pairs, "")
...
async def async_verify_email_address(
