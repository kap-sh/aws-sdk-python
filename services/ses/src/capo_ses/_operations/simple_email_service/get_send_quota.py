"""Generated from Smithy shape ``com.amazonaws.ses#GetSendQuota``."""
...
import capo_ses.types.get_send_quota_response
...
) -> capo_ses.types.get_send_quota_response.GetSendQuotaResponse:
    root = fromstring(response.read())
    result = root.find("GetSendQuotaResult")
    out: capo_ses.types.get_send_quota_response.GetSendQuotaResponse = (
        capo_ses.types.get_send_quota_response.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "GetSendQuota"))
...
def get_send_quota(
    ...
    capo_ses.types.get_send_quota_response.GetSendQuotaResponse, zapros.Response
]:
...
async def async_get_send_quota(
