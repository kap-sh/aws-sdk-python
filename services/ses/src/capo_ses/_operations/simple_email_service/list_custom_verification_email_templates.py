"""Generated from Smithy shape ``com.amazonaws.ses#ListCustomVerificationEmailTemplates``."""
...
import capo_ses.types.list_custom_verification_email_templates_request
import capo_ses.types.list_custom_verification_email_templates_response
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListCustomVerificationEmailTemplatesResult")
    out: capo_ses.types.list_custom_verification_email_templates_response.ListCustomVerificationEmailTemplatesResponse = capo_ses.types.list_custom_verification_email_templates_response.deserialize_query(
...
def build_request(
    ...
    input_: capo_ses.types.list_custom_verification_email_templates_request.ListCustomVerificationEmailTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    capo_ses.types.list_custom_verification_email_templates_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_custom_verification_email_templates(
