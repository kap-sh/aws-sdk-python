"""Generated from Smithy shape ``com.amazonaws.ses#DeleteReceiptRule``."""
...
import capo_ses.types.delete_receipt_rule_request
import capo_ses.types.delete_receipt_rule_response
...
) -> capo_ses.types.delete_receipt_rule_response.DeleteReceiptRuleResponse:
    root = fromstring(response.read())
    result = root.find("DeleteReceiptRuleResult")
    out: capo_ses.types.delete_receipt_rule_response.DeleteReceiptRuleResponse = (
        capo_ses.types.delete_receipt_rule_response.deserialize_query(
...
def build_request(
    ...
    input_: capo_ses.types.delete_receipt_rule_request.DeleteReceiptRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteReceiptRule"))
    pairs.append(("Version", "2010-12-01"))
    capo_ses.types.delete_receipt_rule_request.serialize_query(input_, pairs, "")
...
async def async_delete_receipt_rule(
