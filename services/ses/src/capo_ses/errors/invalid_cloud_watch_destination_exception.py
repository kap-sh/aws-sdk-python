"""Generated from Smithy shape ``com.amazonaws.ses#InvalidCloudWatchDestinationException``."""
...
class InvalidCloudWatchDestinationException_(TypedDict, closed=True):
    ...
    event_destination_name: NotRequired[
        "capo_ses.types.event_destination_name.EventDestinationName"
    ]
...
# --- awsQuery ser/de ---
def serialize_query(
    value: InvalidCloudWatchDestinationException_,
...
def deserialize_query(el: Element) -> InvalidCloudWatchDestinationException_:
    out: InvalidCloudWatchDestinationException_ = {}  # type: ignore[typeddict-item]
...
class InvalidCloudWatchDestinationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ses#InvalidCloudWatchDestinationException``."""
