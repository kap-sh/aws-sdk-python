"""Generated from Smithy shape ``com.amazonaws.ses#InvalidSNSDestinationException``."""
...
class InvalidSNSDestinationException_(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: InvalidSNSDestinationException_, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> InvalidSNSDestinationException_:
    out: InvalidSNSDestinationException_ = {}  # type: ignore[typeddict-item]
...
class InvalidSNSDestinationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ses#InvalidSNSDestinationException``."""
