...
class SESError(Exception):
    """Base class for all SES service errors."""


class ServiceError(SESError):
...
class DeserializationError(SESError):
...
class WaiterFailedError(SESError):
...
class WaiterTimeoutError(SESError):
