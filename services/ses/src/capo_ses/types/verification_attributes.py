...
if TYPE_CHECKING:
    ...
    import capo_ses.types.identity_verification_attributes

VerificationAttributes: TypeAlias = dict[
    "capo_ses.types.identity.Identity",
    "capo_ses.types.identity_verification_attributes.IdentityVerificationAttributes",
]
...
def serialize_query(
    ...
    for n, (key, value) in enumerate(input_to_serialize.items(), 1):
        ...
        capo_ses.types.identity_verification_attributes.serialize_query(
...
def deserialize_query(el: Element) -> VerificationAttributes:
    ...
    for entry in el.findall("entry"):
        ...
        value = capo_ses.types.identity_verification_attributes.deserialize_query(
            value_element
        )
        out[key] = value
    return out
