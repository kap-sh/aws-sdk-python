...
class ReceiptAction(TypedDict, closed=True):
    s3_action: NotRequired["capo_ses.types.s3_action.S3Action"]
    ...
    bounce_action: NotRequired["capo_ses.types.bounce_action.BounceAction"]
    ...
    workmail_action: NotRequired["capo_ses.types.workmail_action.WorkmailAction"]
    """<p>Calls Amazon WorkMail and, optionally, publishes a notification to Amazon Amazon SNS.</p>"""
    lambda_action: NotRequired["capo_ses.types.lambda_action.LambdaAction"]
    """<p>Calls an Amazon Web Services Lambda function, and optionally, publishes a notification to Amazon SNS.</p>"""
    stop_action: NotRequired["capo_ses.types.stop_action.StopAction"]
    """<p>Terminates the evaluation of the receipt rule set and optionally publishes a notification to Amazon SNS.</p>"""
    add_header_action: NotRequired["capo_ses.types.add_header_action.AddHeaderAction"]
    """<p>Adds a header to the received email.</p>"""
    sns_action: NotRequired["capo_ses.types.sns_action.SNSAction"]
    """<p>Publishes the email content within a notification to Amazon SNS.</p>"""
    connect_action: NotRequired["capo_ses.types.connect_action.ConnectAction"]
...
def deserialize_query(el: Element) -> ReceiptAction:
    ...
    if child_s3_action is not None:
        ...
        out["s3_action"] = capo_ses.types.s3_action.deserialize_query(child_s3_action)
    child_bounce_action = el.find("BounceAction")
    if child_bounce_action is not None:
        import capo_ses.types.bounce_action

        out["bounce_action"] = capo_ses.types.bounce_action.deserialize_query(
            child_bounce_action
        )
    ...
    if child_workmail_action is not None:
        ...
        out["workmail_action"] = capo_ses.types.workmail_action.deserialize_query(
    ...
    if child_lambda_action is not None:
        ...
        out["lambda_action"] = capo_ses.types.lambda_action.deserialize_query(
            child_lambda_action
        )
    ...
    if child_stop_action is not None:
        ...
        out["stop_action"] = capo_ses.types.stop_action.deserialize_query(
            child_stop_action
        )
    ...
    if child_add_header_action is not None:
        ...
        out["add_header_action"] = capo_ses.types.add_header_action.deserialize_query(
    ...
    if child_sns_action is not None:
        ...
        out["sns_action"] = capo_ses.types.sns_action.deserialize_query(
            child_sns_action
        )
    ...
    if child_connect_action is not None:
        ...
        out["connect_action"] = capo_ses.types.connect_action.deserialize_query(
