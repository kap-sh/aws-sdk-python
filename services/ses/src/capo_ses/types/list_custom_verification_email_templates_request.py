...
if TYPE_CHECKING:
    import capo_ses.types.max_results
    import capo_ses.types.next_token


class ListCustomVerificationEmailTemplatesRequest(TypedDict, closed=True):
    ...
    max_results: NotRequired["capo_ses.types.max_results.MaxResults"]
