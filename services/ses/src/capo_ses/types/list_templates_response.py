...
class ListTemplatesResponse(TypedDict, closed=True):
    templates_metadata: NotRequired[
        "capo_ses.types.template_metadata_list.TemplateMetadataList"
    ]
...
def serialize_query(
    ...
    if "templates_metadata" in value:
        ...
        capo_ses.types.template_metadata_list.serialize_query(
            value["templates_metadata"], pairs, f"{key_prefix}TemplatesMetadata"
        )
...
def deserialize_query(el: Element) -> ListTemplatesResponse:
    ...
    if child_templates_metadata is not None:
        ...
        out["templates_metadata"] = (
            capo_ses.types.template_metadata_list.deserialize_query(
