...
class ReputationOptions(TypedDict, closed=True):
    sending_enabled: "capo_ses.types.enabled.Enabled"
    ...
    reputation_metrics_enabled: "capo_ses.types.enabled.Enabled"
    ...
    last_fresh_start: NotRequired["capo_ses.types.last_fresh_start.LastFreshStart"]
...
def deserialize_query(el: Element) -> ReputationOptions:
    ...
    if child_last_fresh_start is not None:
        ...
        out["last_fresh_start"] = capo_ses.types.last_fresh_start.deserialize_query(
