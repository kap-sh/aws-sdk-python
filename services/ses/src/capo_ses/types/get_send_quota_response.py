...
if TYPE_CHECKING:
    import capo_ses.types.max24_hour_send
    import capo_ses.types.max_send_rate
    import capo_ses.types.sent_last24_hours


class GetSendQuotaResponse(TypedDict, closed=True):
    max24_hour_send: "capo_ses.types.max24_hour_send.Max24HourSend"
    ...
    max_send_rate: "capo_ses.types.max_send_rate.MaxSendRate"
    ...
    sent_last24_hours: "capo_ses.types.sent_last24_hours.SentLast24Hours"
