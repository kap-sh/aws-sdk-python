...
if TYPE_CHECKING:
    ...
    import capo_ses.types.bounce_message
    import capo_ses.types.bounce_smtp_reply_code
    import capo_ses.types.bounce_status_code
