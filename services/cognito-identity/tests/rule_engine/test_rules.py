import pytest
from aws_sdk_cognito_identity._rule_engine._endpoint_rule_set import EndpointParams, resolve
from aws_sdk_cognito_identity._rule_engine._endpoint_runtime import EndpointError
import re
import zapros

def test_1_for_region_us_east_1_with_fips_disabled_():
    """For region us-east-1 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://cognito-identity.us-east-1.amazonaws.com'
...
def test_2_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity-fips.us-east-1.amazonaws.com'

def test_3_for_region_us_east_1_with_fips_disabled_():
...
def test_5_for_region_us_east_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity.us-east-2.amazonaws.com'

def test_6_for_region_us_east_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity-fips.us-east-2.amazonaws.com'
...
def test_9_for_region_us_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity.us-west-1.amazonaws.com'

def test_10_for_region_us_west_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity-fips.us-west-1.amazonaws.com'
...
def test_12_for_region_us_west_1_with_fips_enabled_a():
...
def test_13_for_region_us_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity.us-west-2.amazonaws.com'
...
def test_14_for_region_us_west_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity-fips.us-west-2.amazonaws.com'
...
def test_16_for_region_us_west_2_with_fips_enabled_a():
...
def test_17_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity.cn-north-1.amazonaws.com.cn'
...
def test_18_for_region_cn_north_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity-fips.cn-north-1.api.amazonwebservices.com.cn'
...
def test_19_for_region_cn_north_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity-fips.cn-north-1.amazonaws.com.cn'
...
def test_20_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity.cn-north-1.api.amazonwebservices.com.cn'
...
def test_21_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity.us-gov-west-1.amazonaws.com'
...
def test_22_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity-fips.us-gov-west-1.amazonaws.com'
...
def test_23_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity-fips.us-gov-east-1.api.aws'
...
def test_24_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity-fips.us-gov-east-1.amazonaws.com'
...
def test_25_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity.us-gov-east-1.api.aws'
...
def test_26_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity.us-gov-east-1.amazonaws.com'
...
def test_27_for_region_us_iso_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity-fips.us-iso-east-1.c2s.ic.gov'
...
def test_28_for_region_us_iso_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity.us-iso-east-1.c2s.ic.gov'
...
def test_29_for_region_us_isob_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity-fips.us-isob-east-1.sc2s.sgov.gov'
...
def test_30_for_region_us_isob_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://cognito-identity.us-isob-east-1.sc2s.sgov.gov'
