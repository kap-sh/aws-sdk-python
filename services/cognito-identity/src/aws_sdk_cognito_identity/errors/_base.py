...
class CognitoIdentityError(Exception):
    """Base class for all CognitoIdentity service errors."""


class ServiceError(CognitoIdentityError):
...
class SerializationError(CognitoIdentityError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CognitoIdentityError):
...
class WaiterFailedError(CognitoIdentityError):
...
class WaiterTimeoutError(CognitoIdentityError):
