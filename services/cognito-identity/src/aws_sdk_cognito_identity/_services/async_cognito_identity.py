...
from aws_sdk_cognito_identity._services._aws_config import aaws_config
...
class AsyncCognitoIdentityClientConfig(TypedDict, total=False):
...
class AsyncCognitoIdentityClient:
    ...
    async def create_identity_pool(
        ...
        *,
        ...
        Raises:
            aws_sdk_cognito_identity.errors.internal_error_exception.InternalErrorException: <p>Thrown when the service encounters an error during processing the request.</p>
            aws_sdk_cognito_identity.errors.invalid_parameter_exception.InvalidParameterException: <p>Thrown for missing or bad input parameter(s).</p>
            aws_sdk_cognito_identity.errors.limit_exceeded_exception.LimitExceededException: <p>Thrown when the total number of user pools has exceeded a preset limit.</p>
            aws_sdk_cognito_identity.errors.not_authorized_exception.NotAuthorizedException: <p>Thrown when a user is not authorized to access the requested resource.</p>
            aws_sdk_cognito_identity.errors.resource_conflict_exception.ResourceConflictException: <p>Thrown when a user tries to use a login which is already linked to another account.</p>
            aws_sdk_cognito_identity.errors.too_many_requests_exception.TooManyRequestsException: <p>Thrown when a request is throttled.</p>
            aws_sdk_cognito_identity.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.create_identity_pool_input.CreateIdentityPoolInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.identity_pool.IdentityPool"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.create_identity_pool.async_create_identity_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.create_identity_pool_input.CreateIdentityPoolInput = {}  # type: ignore[typeddict-item]
        input_["identity_pool_name"] = identity_pool_name
        input_["allow_unauthenticated_identities"] = allow_unauthenticated_identities
    ...
    async def delete_identities(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.delete_identities_input.DeleteIdentitiesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.delete_identities_response.DeleteIdentitiesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.delete_identities.async_delete_identities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.delete_identities_input.DeleteIdentitiesInput = {}  # type: ignore[typeddict-item]
        input_["identity_ids_to_delete"] = identity_ids_to_delete
    ...
    async def delete_identity_pool(
        ...
        *,
        ...
        Raises:
            ...
            aws_sdk_cognito_identity.errors.invalid_parameter_exception.InvalidParameterException: <p>Thrown for missing or bad input parameter(s).</p>
            aws_sdk_cognito_identity.errors.not_authorized_exception.NotAuthorizedException: <p>Thrown when a user is not authorized to access the requested resource.</p>
            aws_sdk_cognito_identity.errors.resource_not_found_exception.ResourceNotFoundException: <p>Thrown when the requested resource (for example, a dataset or record) does not exist.</p>
            aws_sdk_cognito_identity.errors.too_many_requests_exception.TooManyRequestsException: <p>Thrown when a request is throttled.</p>
            aws_sdk_cognito_identity.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.delete_identity_pool_input.DeleteIdentityPoolInput]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.delete_identity_pool.async_delete_identity_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.delete_identity_pool_input.DeleteIdentityPoolInput = {}  # type: ignore[typeddict-item]
    ...
    async def describe_identity(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.describe_identity_input.DescribeIdentityInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.identity_description.IdentityDescription"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.describe_identity.async_describe_identity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.describe_identity_input.DescribeIdentityInput = {}  # type: ignore[typeddict-item]
    ...
    async def describe_identity_pool(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.describe_identity_pool_input.DescribeIdentityPoolInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.identity_pool.IdentityPool"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.describe_identity_pool.async_describe_identity_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.describe_identity_pool_input.DescribeIdentityPoolInput = {}  # type: ignore[typeddict-item]
        input_["identity_pool_id"] = identity_pool_id
    ...
    async def get_credentials_for_identity(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.get_credentials_for_identity_input.GetCredentialsForIdentityInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.get_credentials_for_identity_response.GetCredentialsForIdentityResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.get_credentials_for_identity.async_get_credentials_for_identity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.get_credentials_for_identity_input.GetCredentialsForIdentityInput = {}  # type: ignore[typeddict-item]
        input_["identity_id"] = identity_id
    ...
    async def get_id(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.get_id_input.GetIdInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.get_id_response.GetIdResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.get_id.async_get_id(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.get_id_input.GetIdInput = {}  # type: ignore[typeddict-item]
    ...
    async def get_identity_pool_roles(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.get_identity_pool_roles_input.GetIdentityPoolRolesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.get_identity_pool_roles_response.GetIdentityPoolRolesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.get_identity_pool_roles.async_get_identity_pool_roles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.get_identity_pool_roles_input.GetIdentityPoolRolesInput = {}  # type: ignore[typeddict-item]
        input_["identity_pool_id"] = identity_pool_id
    ...
    async def get_open_id_token(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.get_open_id_token_input.GetOpenIdTokenInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.get_open_id_token_response.GetOpenIdTokenResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.get_open_id_token.async_get_open_id_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.get_open_id_token_input.GetOpenIdTokenInput = {}  # type: ignore[typeddict-item]
        input_["identity_id"] = identity_id
        if logins is not None:
            input_["logins"] = logins
    ...
    async def get_open_id_token_for_developer_identity(
        ...
        *,
        ...
        Raises:
            aws_sdk_cognito_identity.errors.developer_user_already_registered_exception.DeveloperUserAlreadyRegisteredException: <p>The provided developer user identifier is already registered with Cognito under a different identity ID.</p>
            aws_sdk_cognito_identity.errors.internal_error_exception.InternalErrorException: <p>Thrown when the service encounters an error during processing the request.</p>
            aws_sdk_cognito_identity.errors.invalid_parameter_exception.InvalidParameterException: <p>Thrown for missing or bad input parameter(s).</p>
            aws_sdk_cognito_identity.errors.not_authorized_exception.NotAuthorizedException: <p>Thrown when a user is not authorized to access the requested resource.</p>
            aws_sdk_cognito_identity.errors.resource_conflict_exception.ResourceConflictException: <p>Thrown when a user tries to use a login which is already linked to another account.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.get_open_id_token_for_developer_identity_input.GetOpenIdTokenForDeveloperIdentityInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.get_open_id_token_for_developer_identity_response.GetOpenIdTokenForDeveloperIdentityResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.get_open_id_token_for_developer_identity.async_get_open_id_token_for_developer_identity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.get_open_id_token_for_developer_identity_input.GetOpenIdTokenForDeveloperIdentityInput = {}  # type: ignore[typeddict-item]
        input_["identity_pool_id"] = identity_pool_id
    ...
    async def get_principal_tag_attribute_map(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.get_principal_tag_attribute_map_input.GetPrincipalTagAttributeMapInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.get_principal_tag_attribute_map_response.GetPrincipalTagAttributeMapResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.get_principal_tag_attribute_map.async_get_principal_tag_attribute_map(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.get_principal_tag_attribute_map_input.GetPrincipalTagAttributeMapInput = {}  # type: ignore[typeddict-item]
        input_["identity_pool_id"] = identity_pool_id
    ...
    async def list_identities(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.list_identities_input.ListIdentitiesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.list_identities_response.ListIdentitiesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.list_identities.async_list_identities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.list_identities_input.ListIdentitiesInput = {}  # type: ignore[typeddict-item]
        input_["identity_pool_id"] = identity_pool_id
    ...
    async def list_identity_pools(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.list_identity_pools_input.ListIdentityPoolsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.list_identity_pools_response.ListIdentityPoolsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.list_identity_pools.async_list_identity_pools(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.list_identity_pools_input.ListIdentityPoolsInput = {}  # type: ignore[typeddict-item]
        input_["max_results"] = max_results
        if next_token is not None:
            input_["next_token"] = next_token
    ...
    ) -> "AsyncIterator[aws_sdk_cognito_identity.types.identity_pool_short_description.IdentityPoolShortDescription]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.list_tags_for_resource_input.ListTagsForResourceInput = {}  # type: ignore[typeddict-item]
    ...
    async def lookup_developer_identity(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.lookup_developer_identity_input.LookupDeveloperIdentityInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.lookup_developer_identity_response.LookupDeveloperIdentityResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.lookup_developer_identity.async_lookup_developer_identity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.lookup_developer_identity_input.LookupDeveloperIdentityInput = {}  # type: ignore[typeddict-item]
        input_["identity_pool_id"] = identity_pool_id
        if identity_id is not None:
            input_["identity_id"] = identity_id
    ...
    async def merge_developer_identities(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.merge_developer_identities_input.MergeDeveloperIdentitiesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.merge_developer_identities_response.MergeDeveloperIdentitiesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.merge_developer_identities.async_merge_developer_identities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.merge_developer_identities_input.MergeDeveloperIdentitiesInput = {}  # type: ignore[typeddict-item]
        input_["source_user_identifier"] = source_user_identifier
        input_["destination_user_identifier"] = destination_user_identifier
        input_["developer_provider_name"] = developer_provider_name
        input_["identity_pool_id"] = identity_pool_id
    ...
    async def set_identity_pool_roles(
        ...
        *,
        ...
        Raises:
            aws_sdk_cognito_identity.errors.concurrent_modification_exception.ConcurrentModificationException: <p>Thrown if there are parallel requests to modify a resource.</p>
            aws_sdk_cognito_identity.errors.internal_error_exception.InternalErrorException: <p>Thrown when the service encounters an error during processing the request.</p>
            aws_sdk_cognito_identity.errors.invalid_parameter_exception.InvalidParameterException: <p>Thrown for missing or bad input parameter(s).</p>
            aws_sdk_cognito_identity.errors.not_authorized_exception.NotAuthorizedException: <p>Thrown when a user is not authorized to access the requested resource.</p>
            aws_sdk_cognito_identity.errors.resource_conflict_exception.ResourceConflictException: <p>Thrown when a user tries to use a login which is already linked to another account.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.set_identity_pool_roles_input.SetIdentityPoolRolesInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.set_identity_pool_roles.async_set_identity_pool_roles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.set_identity_pool_roles_input.SetIdentityPoolRolesInput = {}  # type: ignore[typeddict-item]
        input_["identity_pool_id"] = identity_pool_id
        input_["roles"] = roles
    ...
    async def set_principal_tag_attribute_map(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.set_principal_tag_attribute_map_input.SetPrincipalTagAttributeMapInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.set_principal_tag_attribute_map_response.SetPrincipalTagAttributeMapResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.set_principal_tag_attribute_map.async_set_principal_tag_attribute_map(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.set_principal_tag_attribute_map_input.SetPrincipalTagAttributeMapInput = {}  # type: ignore[typeddict-item]
        input_["identity_pool_id"] = identity_pool_id
        input_["identity_provider_name"] = identity_provider_name
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.tag_resource_input.TagResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.tag_resource_input.TagResourceInput = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        input_["tags"] = tags
    ...
    async def unlink_developer_identity(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.unlink_developer_identity_input.UnlinkDeveloperIdentityInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.unlink_developer_identity.async_unlink_developer_identity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.unlink_developer_identity_input.UnlinkDeveloperIdentityInput = {}  # type: ignore[typeddict-item]
        input_["identity_id"] = identity_id
        input_["identity_pool_id"] = identity_pool_id
        input_["developer_provider_name"] = developer_provider_name
        input_["developer_user_identifier"] = developer_user_identifier
    ...
    async def unlink_identity(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.unlink_identity_input.UnlinkIdentityInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.unlink_identity.async_unlink_identity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.unlink_identity_input.UnlinkIdentityInput = {}  # type: ignore[typeddict-item]
        input_["identity_id"] = identity_id
        input_["logins"] = logins
        input_["logins_to_remove"] = logins_to_remove
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.untag_resource_input.UntagResourceInput = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
    ...
    async def update_identity_pool(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_cognito_identity.types.identity_pool.IdentityPool]",
        ) -> AsyncOperationResponse[
            "aws_sdk_cognito_identity.types.identity_pool.IdentityPool"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_cognito_identity._operations.aws_cognito_identity_service.update_identity_pool.async_update_identity_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_cognito_identity.types.identity_pool.IdentityPool = {}  # type: ignore[typeddict-item]
        input_["identity_pool_id"] = identity_pool_id
        input_["identity_pool_name"] = identity_pool_name
        input_["allow_unauthenticated_identities"] = allow_unauthenticated_identities
        if allow_classic_flow is not None:
