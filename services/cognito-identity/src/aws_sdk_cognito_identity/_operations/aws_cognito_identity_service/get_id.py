...
def handle_response(
    ...
    out: aws_sdk_cognito_identity.types.get_id_response.GetIdResponse = (
        aws_sdk_cognito_identity.types.get_id_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity.types.get_id_input.GetIdInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.get_id_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_id(
    ...
    aws_sdk_cognito_identity.types.get_id_response.GetIdResponse, zapros.Response
]:
