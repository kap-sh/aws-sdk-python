"""Generated from Smithy shape ``com.amazonaws.cognitoidentity#GetOpenIdTokenForDeveloperIdentity``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DeveloperUserAlreadyRegisteredException":
            import aws_sdk_cognito_identity.errors.developer_user_already_registered_exception

            raise aws_sdk_cognito_identity.errors.developer_user_already_registered_exception.DeveloperUserAlreadyRegisteredException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity.types.get_open_id_token_for_developer_identity_response.GetOpenIdTokenForDeveloperIdentityResponse = aws_sdk_cognito_identity.types.get_open_id_token_for_developer_identity_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity.types.get_open_id_token_for_developer_identity_input.GetOpenIdTokenForDeveloperIdentityInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.get_open_id_token_for_developer_identity_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_open_id_token_for_developer_identity(
