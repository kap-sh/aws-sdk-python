...
def handle_response(
    ...
    out: aws_sdk_cognito_identity.types.merge_developer_identities_response.MergeDeveloperIdentitiesResponse = aws_sdk_cognito_identity.types.merge_developer_identities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity.types.merge_developer_identities_input.MergeDeveloperIdentitiesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.merge_developer_identities_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
