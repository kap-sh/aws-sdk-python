...
import aws_sdk_cognito_identity.errors.invalid_identity_pool_configuration_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidIdentityPoolConfigurationException":
            raise aws_sdk_cognito_identity.errors.invalid_identity_pool_configuration_exception.InvalidIdentityPoolConfigurationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity.types.get_credentials_for_identity_response.GetCredentialsForIdentityResponse = aws_sdk_cognito_identity.types.get_credentials_for_identity_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity.types.get_credentials_for_identity_input.GetCredentialsForIdentityInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.get_credentials_for_identity_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
