...
def handle_response(
    ...
    out: aws_sdk_cognito_identity.types.list_identity_pools_response.ListIdentityPoolsResponse = aws_sdk_cognito_identity.types.list_identity_pools_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity.types.list_identity_pools_input.ListIdentityPoolsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.list_identity_pools_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
