...
def handle_response(
    ...
    out: aws_sdk_cognito_identity.types.lookup_developer_identity_response.LookupDeveloperIdentityResponse = aws_sdk_cognito_identity.types.lookup_developer_identity_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity.types.lookup_developer_identity_input.LookupDeveloperIdentityInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.lookup_developer_identity_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
