...
def build_request(
    ...
    input: aws_sdk_cognito_identity.types.tag_resource_input.TagResourceInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.tag_resource_input.serialize_aws_json_1_1(input)
    ).encode()
