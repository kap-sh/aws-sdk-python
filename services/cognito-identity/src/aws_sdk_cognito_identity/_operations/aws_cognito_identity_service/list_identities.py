"""Generated from Smithy shape ``com.amazonaws.cognitoidentity#ListIdentities``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity.types.list_identities_response.ListIdentitiesResponse = aws_sdk_cognito_identity.types.list_identities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity.types.list_identities_input.ListIdentitiesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.list_identities_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_identities(
