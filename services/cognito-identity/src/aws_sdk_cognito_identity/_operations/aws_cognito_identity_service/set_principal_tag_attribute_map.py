...
def handle_response(
    ...
    out: aws_sdk_cognito_identity.types.set_principal_tag_attribute_map_response.SetPrincipalTagAttributeMapResponse = aws_sdk_cognito_identity.types.set_principal_tag_attribute_map_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity.types.set_principal_tag_attribute_map_input.SetPrincipalTagAttributeMapInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.set_principal_tag_attribute_map_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
