...
def build_request(
    ...
    input_: aws_sdk_cognito_identity.types.set_identity_pool_roles_input.SetIdentityPoolRolesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.set_identity_pool_roles_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
