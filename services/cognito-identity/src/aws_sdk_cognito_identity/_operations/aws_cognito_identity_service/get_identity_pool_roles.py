...
def handle_response(
    ...
    out: aws_sdk_cognito_identity.types.get_identity_pool_roles_response.GetIdentityPoolRolesResponse = aws_sdk_cognito_identity.types.get_identity_pool_roles_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity.types.get_identity_pool_roles_input.GetIdentityPoolRolesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.get_identity_pool_roles_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
