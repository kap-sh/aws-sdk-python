...
def build_request(
    ...
    input_: aws_sdk_cognito_identity.types.create_identity_pool_input.CreateIdentityPoolInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.create_identity_pool_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
