"""Generated from Smithy shape ``com.amazonaws.cognitoidentity#DescribeIdentity``."""
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity.types.describe_identity_input.DescribeIdentityInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.describe_identity_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_identity(
