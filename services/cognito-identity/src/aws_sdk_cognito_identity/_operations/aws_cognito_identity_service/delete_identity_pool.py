...
def build_request(
    ...
    input_: aws_sdk_cognito_identity.types.delete_identity_pool_input.DeleteIdentityPoolInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity.types.delete_identity_pool_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
