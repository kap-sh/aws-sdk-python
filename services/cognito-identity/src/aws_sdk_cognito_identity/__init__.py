...
from ._services.async_cognito_identity import (
    AsyncCognitoIdentityClient as AsyncCognitoIdentityClient,
)
from ._services.cognito_identity import CognitoIdentityClient as CognitoIdentityClient
