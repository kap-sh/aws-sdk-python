...
class ListIdentityPoolsResponse(TypedDict, closed=True):
    identity_pools: NotRequired[
        "capo_cognito_identity.types.identity_pools_list.IdentityPoolsList"
    ]
...
def serialize_aws_json_1_1(value: ListIdentityPoolsResponse) -> dict:
    ...
    if "identity_pools" in value:
        ...
        out["IdentityPools"] = (
            capo_cognito_identity.types.identity_pools_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListIdentityPoolsResponse:
    ...
    if "IdentityPools" in data:
        ...
        out["identity_pools"] = (
            capo_cognito_identity.types.identity_pools_list.deserialize_aws_json_1_1(
                data["IdentityPools"]
            )
        )
