...
if TYPE_CHECKING:
    import capo_cognito_identity.types.unprocessed_identity_id

UnprocessedIdentityIdList: TypeAlias = list[
    "capo_cognito_identity.types.unprocessed_identity_id.UnprocessedIdentityId"
]
...
def serialize_aws_json_1_1(value: UnprocessedIdentityIdList) -> list:
    ...
    for item in value:
        out.append(
            capo_cognito_identity.types.unprocessed_identity_id.serialize_aws_json_1_1(
                item
            )
        )
    return out
