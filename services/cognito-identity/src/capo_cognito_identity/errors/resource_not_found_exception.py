"""Generated from Smithy shape ``com.amazonaws.cognitoidentity#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cognitoidentity#ResourceNotFoundException``."""
