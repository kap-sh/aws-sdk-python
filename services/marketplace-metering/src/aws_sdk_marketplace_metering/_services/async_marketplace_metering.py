...
class AsyncMarketplaceMeteringClientConfig(TypedDict, total=False):
...
class AsyncMarketplaceMeteringClient:
    ...
    def __init__(
        ...
        self.config = AsyncMarketplaceMeteringClientConfig(
            {
    ...
    async def batch_meter_usage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_metering.types.batch_meter_usage_request.BatchMeterUsageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_metering.types.batch_meter_usage_result.BatchMeterUsageResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_metering._operations.awsmp_metering_service.batch_meter_usage.async_batch_meter_usage(
    ...
    async def meter_usage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_metering.types.meter_usage_request.MeterUsageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_metering.types.meter_usage_result.MeterUsageResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_metering._operations.awsmp_metering_service.meter_usage.async_meter_usage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_usage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_metering.types.register_usage_request.RegisterUsageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_metering.types.register_usage_result.RegisterUsageResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_metering._operations.awsmp_metering_service.register_usage.async_register_usage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def resolve_customer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_metering.types.resolve_customer_request.ResolveCustomerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_metering.types.resolve_customer_result.ResolveCustomerResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_metering._operations.awsmp_metering_service.resolve_customer.async_resolve_customer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
