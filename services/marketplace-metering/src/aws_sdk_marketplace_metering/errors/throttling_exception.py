"""Generated from Smithy shape ``com.amazonaws.marketplacemetering#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.marketplacemetering#ThrottlingException``."""
