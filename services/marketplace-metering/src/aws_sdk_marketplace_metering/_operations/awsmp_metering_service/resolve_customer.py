"""Generated from Smithy shape ``com.amazonaws.marketplacemetering#ResolveCustomer``."""
...
import aws_sdk_marketplace_metering.errors.expired_token_exception
import aws_sdk_marketplace_metering.errors.internal_service_error_exception
import aws_sdk_marketplace_metering.errors.invalid_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ExpiredTokenException":
            raise aws_sdk_marketplace_metering.errors.expired_token_exception.ExpiredTokenException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidTokenException":
            raise aws_sdk_marketplace_metering.errors.invalid_token_exception.InvalidTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_marketplace_metering.types.resolve_customer_result.ResolveCustomerResult = aws_sdk_marketplace_metering.types.resolve_customer_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_marketplace_metering.types.resolve_customer_request.ResolveCustomerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_marketplace_metering.types.resolve_customer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_resolve_customer(
