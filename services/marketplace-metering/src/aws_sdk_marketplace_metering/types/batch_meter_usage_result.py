...
class BatchMeterUsageResult(TypedDict):
    results: NotRequired[
        "aws_sdk_marketplace_metering.types.usage_record_result_list.UsageRecordResultList"
    ]
...
def serialize_aws_json_1_1(value: BatchMeterUsageResult) -> dict:
    ...
    if "results" in value:
        ...
        out["Results"] = (
            aws_sdk_marketplace_metering.types.usage_record_result_list.serialize_aws_json_1_1(
                value["results"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> BatchMeterUsageResult:
    ...
    if "Results" in data:
        ...
        out["results"] = (
            aws_sdk_marketplace_metering.types.usage_record_result_list.deserialize_aws_json_1_1(
                data["Results"]
            )
        )
