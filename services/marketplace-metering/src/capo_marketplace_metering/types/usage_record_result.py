...
class UsageRecordResult(TypedDict, closed=True):
    ...
    status: NotRequired[
        "capo_marketplace_metering.types.usage_record_result_status.UsageRecordResultStatus"
    ]
...
def serialize_aws_json_1_1(value: UsageRecordResult) -> dict:
    ...
    if "usage_record" in value:
        ...
        out["UsageRecord"] = (
            capo_marketplace_metering.types.usage_record.serialize_aws_json_1_1(
                value["usage_record"]
            )
        )
    ...
    if "status" in value:
        ...
        out["Status"] = (
            capo_marketplace_metering.types.usage_record_result_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UsageRecordResult:
    ...
    if "UsageRecord" in data:
        ...
        out["usage_record"] = (
            capo_marketplace_metering.types.usage_record.deserialize_aws_json_1_1(
                data["UsageRecord"]
            )
        )
    ...
    if "Status" in data:
        ...
        out["status"] = (
            capo_marketplace_metering.types.usage_record_result_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
    return out
