...
class MarketplaceMeteringError(Exception):
    """Base class for all MarketplaceMetering service errors."""


class ServiceError(MarketplaceMeteringError):
...
class SerializationError(MarketplaceMeteringError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MarketplaceMeteringError):
...
class WaiterFailedError(MarketplaceMeteringError):
...
class WaiterTimeoutError(MarketplaceMeteringError):
