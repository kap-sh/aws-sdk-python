...
class SageMakerRuntimeError(Exception):
    """Base class for all SageMakerRuntime service errors."""


class ServiceError(SageMakerRuntimeError):
...
class SerializationError(SageMakerRuntimeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SageMakerRuntimeError):
...
class WaiterFailedError(SageMakerRuntimeError):
...
class WaiterTimeoutError(SageMakerRuntimeError):
