...
from capo_sagemaker_runtime._protocol.eventstream import HeaderValue, Message
from capo_sagemaker_runtime.errors import ServiceError

if TYPE_CHECKING:
    import capo_sagemaker_runtime.types.error_code
...
class ModelStreamError_(TypedDict, closed=True):
    ...
    error_code: NotRequired["capo_sagemaker_runtime.types.error_code.ErrorCode"]
