"""Generated from Smithy shape ``com.amazonaws.sagemakerruntime#ValidationError``."""
...
class ValidationError(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.sagemakerruntime#ValidationError``."""
