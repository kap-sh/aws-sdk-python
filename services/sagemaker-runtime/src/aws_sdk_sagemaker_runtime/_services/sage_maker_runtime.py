...
from aws_sdk_sagemaker_runtime._services._aws_config import aws_config
...
class SageMakerRuntimeClient:
    ...
    ) -> "Generator[aws_sdk_sagemaker_runtime.types.invoke_endpoint_with_response_stream_output.InvokeEndpointWithResponseStreamOutput]":
