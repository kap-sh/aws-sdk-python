...
from aws_sdk_sagemaker_runtime._services._aws_config import aaws_config
...
class AsyncSageMakerRuntimeClientConfig(TypedDict, total=False):
...
class AsyncSageMakerRuntimeClient:
    ...
    async def invoke_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sagemaker_runtime.types.invoke_endpoint_input.InvokeEndpointInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sagemaker_runtime.types.invoke_endpoint_output.InvokeEndpointOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sagemaker_runtime._operations.amazon_sage_maker_runtime.invoke_endpoint.async_invoke_endpoint(
    ...
    async def invoke_endpoint_async(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sagemaker_runtime.types.invoke_endpoint_async_input.InvokeEndpointAsyncInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sagemaker_runtime.types.invoke_endpoint_async_output.InvokeEndpointAsyncOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sagemaker_runtime._operations.amazon_sage_maker_runtime.invoke_endpoint_async.async_invoke_endpoint_async(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def invoke_endpoint_with_response_stream(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sagemaker_runtime.types.invoke_endpoint_with_response_stream_input.InvokeEndpointWithResponseStreamInput]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sagemaker_runtime._operations.amazon_sage_maker_runtime.invoke_endpoint_with_response_stream.async_invoke_endpoint_with_response_stream(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
