...
from ._services.async_sage_maker_runtime import (
    AsyncSageMakerRuntimeClient as AsyncSageMakerRuntimeClient,
)
from ._services.sage_maker_runtime import (
    SageMakerRuntimeClient as SageMakerRuntimeClient,
)
