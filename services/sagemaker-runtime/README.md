...
```
pip install aws-sdk-sagemaker-runtime
```

## Usage

```python
from aws_sdk_sagemaker_runtime import AsyncSageMakerRuntimeClient
...
```python
from aws_sdk_sagemaker_runtime import AsyncSageMakerRuntimeClient
from aws_sdk_sagemaker_runtime.error import InternalDependencyException
