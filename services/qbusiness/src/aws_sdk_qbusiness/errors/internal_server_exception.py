"""Generated from Smithy shape ``com.amazonaws.qbusiness#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.qbusiness#InternalServerException``."""
