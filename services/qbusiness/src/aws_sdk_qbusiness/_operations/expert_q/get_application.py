...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.get_application_response.GetApplicationResponse = (
        aws_sdk_qbusiness.types.get_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.get_application_request.GetApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
