...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.create_anonymous_web_experience_url_response.CreateAnonymousWebExperienceUrlResponse = aws_sdk_qbusiness.types.create_anonymous_web_experience_url_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.create_anonymous_web_experience_url_request.CreateAnonymousWebExperienceUrlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_anonymous_web_experience_url_request.serialize_json(
            input_
        )
    ).encode()
