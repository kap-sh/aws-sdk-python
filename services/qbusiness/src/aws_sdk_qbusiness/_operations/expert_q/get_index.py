...
import aws_sdk_qbusiness.types.get_index_request
import aws_sdk_qbusiness.types.get_index_response
...
) -> aws_sdk_qbusiness.types.get_index_response.GetIndexResponse:
    out: aws_sdk_qbusiness.types.get_index_response.GetIndexResponse = (
        aws_sdk_qbusiness.types.get_index_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.get_index_request.GetIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_index(
    ...
    aws_sdk_qbusiness.types.get_index_response.GetIndexResponse, zapros.Response
]:
