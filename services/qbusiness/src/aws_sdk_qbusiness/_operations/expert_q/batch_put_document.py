"""Generated from Smithy shape ``com.amazonaws.qbusiness#BatchPutDocument``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.batch_put_document_response.BatchPutDocumentResponse = aws_sdk_qbusiness.types.batch_put_document_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.batch_put_document_request.BatchPutDocumentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.batch_put_document_request.serialize_json(input)
    ).encode()
...
async def async_batch_put_document(
