"""Generated from Smithy shape ``com.amazonaws.qbusiness#DeletePlugin``."""
...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.delete_plugin_request
    import aws_sdk_qbusiness.types.delete_plugin_response
...
) -> aws_sdk_qbusiness.types.delete_plugin_response.DeletePluginResponse:
    out: aws_sdk_qbusiness.types.delete_plugin_response.DeletePluginResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.delete_plugin_request.DeletePluginRequest,
) -> zapros.Request:
...
def delete_plugin(
    ...
    aws_sdk_qbusiness.types.delete_plugin_response.DeletePluginResponse, zapros.Response
]:
