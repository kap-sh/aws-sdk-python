...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.list_messages_response.ListMessagesResponse = (
        aws_sdk_qbusiness.types.list_messages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_messages_request.ListMessagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_messages(
    ...
    aws_sdk_qbusiness.types.list_messages_response.ListMessagesResponse, zapros.Response
]:
