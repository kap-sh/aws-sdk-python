...
import aws_sdk_qbusiness.types.create_data_source_request
import aws_sdk_qbusiness.types.create_data_source_response
...
) -> aws_sdk_qbusiness.types.create_data_source_response.CreateDataSourceResponse:
    out: aws_sdk_qbusiness.types.create_data_source_response.CreateDataSourceResponse = aws_sdk_qbusiness.types.create_data_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.create_data_source_request.CreateDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_data_source_request.serialize_json(input_)
    ).encode()
