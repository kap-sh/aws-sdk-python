...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.create_data_source_request.CreateDataSourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_data_source_request.serialize_json(input)
    ).encode()
