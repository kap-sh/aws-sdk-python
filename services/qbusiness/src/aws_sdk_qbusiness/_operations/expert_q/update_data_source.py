...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.update_data_source_request.UpdateDataSourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.update_data_source_request.serialize_json(input)
    ).encode()
