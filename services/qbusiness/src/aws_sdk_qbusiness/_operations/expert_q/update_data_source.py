...
import aws_sdk_qbusiness.types.update_data_source_request
import aws_sdk_qbusiness.types.update_data_source_response
...
) -> aws_sdk_qbusiness.types.update_data_source_response.UpdateDataSourceResponse:
    out: aws_sdk_qbusiness.types.update_data_source_response.UpdateDataSourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.update_data_source_request.UpdateDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.update_data_source_request.serialize_json(input_)
    ).encode()
