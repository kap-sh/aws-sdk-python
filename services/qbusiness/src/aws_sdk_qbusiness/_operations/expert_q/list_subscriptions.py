...
import aws_sdk_qbusiness.types.subscriptions
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.list_subscriptions_response.ListSubscriptionsResponse = aws_sdk_qbusiness.types.list_subscriptions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_subscriptions_request.ListSubscriptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
