"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListRetrievers``."""
...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.list_retrievers_request
    import aws_sdk_qbusiness.types.list_retrievers_response
...
) -> aws_sdk_qbusiness.types.list_retrievers_response.ListRetrieversResponse:
    import aws_sdk_qbusiness.types.list_retrievers_response

    out: aws_sdk_qbusiness.types.list_retrievers_response.ListRetrieversResponse = (
        aws_sdk_qbusiness.types.list_retrievers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_retrievers_request.ListRetrieversRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{applicationId}/retrievers"
...
async def async_list_retrievers(
