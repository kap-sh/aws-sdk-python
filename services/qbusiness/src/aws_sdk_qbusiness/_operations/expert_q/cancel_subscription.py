"""Generated from Smithy shape ``com.amazonaws.qbusiness#CancelSubscription``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.cancel_subscription_response.CancelSubscriptionResponse = aws_sdk_qbusiness.types.cancel_subscription_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.cancel_subscription_request.CancelSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
