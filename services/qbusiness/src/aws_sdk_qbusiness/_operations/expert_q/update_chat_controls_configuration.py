...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.update_chat_controls_configuration_response.UpdateChatControlsConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.update_chat_controls_configuration_request.UpdateChatControlsConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.update_chat_controls_configuration_request.serialize_json(
            input_
        )
    ).encode()
