...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.create_user_response.CreateUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.create_user_request.CreateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_user_request.serialize_json(input_)
    ).encode()
...
def create_user(
    ...
    aws_sdk_qbusiness.types.create_user_response.CreateUserResponse, zapros.Response
]:
