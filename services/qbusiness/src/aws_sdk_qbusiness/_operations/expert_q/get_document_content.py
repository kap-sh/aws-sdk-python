...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.get_document_content_response.GetDocumentContentResponse = aws_sdk_qbusiness.types.get_document_content_response.deserialize_json(
