"""Generated from Smithy shape ``com.amazonaws.qbusiness#CreateDataAccessor``."""
...
import aws_sdk_qbusiness.types.create_data_accessor_request
import aws_sdk_qbusiness.types.create_data_accessor_response
...
) -> aws_sdk_qbusiness.types.create_data_accessor_response.CreateDataAccessorResponse:
    out: aws_sdk_qbusiness.types.create_data_accessor_response.CreateDataAccessorResponse = aws_sdk_qbusiness.types.create_data_accessor_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.create_data_accessor_request.CreateDataAccessorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{applicationId}/dataaccessors"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_data_accessor_request.serialize_json(input_)
    ).encode()
...
async def async_create_data_accessor(
