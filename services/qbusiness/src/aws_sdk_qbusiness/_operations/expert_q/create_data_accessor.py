...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.create_data_accessor_request.CreateDataAccessorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_data_accessor_request.serialize_json(input)
    ).encode()
