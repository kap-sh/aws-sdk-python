"""Generated from Smithy shape ``com.amazonaws.qbusiness#UpdateDataAccessor``."""
...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.update_data_accessor_request
    import aws_sdk_qbusiness.types.update_data_accessor_response
...
) -> aws_sdk_qbusiness.types.update_data_accessor_response.UpdateDataAccessorResponse:
    out: aws_sdk_qbusiness.types.update_data_accessor_response.UpdateDataAccessorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.update_data_accessor_request.UpdateDataAccessorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{dataAccessorId}", quote(str(input_["data_accessor_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.update_data_accessor_request.serialize_json(input_)
    ).encode()
...
async def async_update_data_accessor(
