...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.update_data_accessor_request.UpdateDataAccessorRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{dataAccessorId}", quote(str(input["data_accessor_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.update_data_accessor_request.serialize_json(input)
    ).encode()
