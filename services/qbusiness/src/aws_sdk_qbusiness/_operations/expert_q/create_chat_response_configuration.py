...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.create_chat_response_configuration_response.CreateChatResponseConfigurationResponse = aws_sdk_qbusiness.types.create_chat_response_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.create_chat_response_configuration_request.CreateChatResponseConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
