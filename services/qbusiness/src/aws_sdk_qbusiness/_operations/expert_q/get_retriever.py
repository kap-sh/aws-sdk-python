...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.get_retriever_request
    import aws_sdk_qbusiness.types.get_retriever_response
...
) -> aws_sdk_qbusiness.types.get_retriever_response.GetRetrieverResponse:
    import aws_sdk_qbusiness.types.get_retriever_response

    out: aws_sdk_qbusiness.types.get_retriever_response.GetRetrieverResponse = (
        aws_sdk_qbusiness.types.get_retriever_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.get_retriever_request.GetRetrieverRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_retriever(
    ...
    aws_sdk_qbusiness.types.get_retriever_response.GetRetrieverResponse, zapros.Response
]:
