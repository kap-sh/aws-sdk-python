"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetChatResponseConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.get_chat_response_configuration_response.GetChatResponseConfigurationResponse = aws_sdk_qbusiness.types.get_chat_response_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.get_chat_response_configuration_request.GetChatResponseConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_chat_response_configuration(
