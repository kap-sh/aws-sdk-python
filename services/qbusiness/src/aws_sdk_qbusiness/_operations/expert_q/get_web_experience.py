...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.get_web_experience_request
    import aws_sdk_qbusiness.types.get_web_experience_response
...
) -> aws_sdk_qbusiness.types.get_web_experience_response.GetWebExperienceResponse:
    import aws_sdk_qbusiness.types.get_web_experience_response

    out: aws_sdk_qbusiness.types.get_web_experience_response.GetWebExperienceResponse = aws_sdk_qbusiness.types.get_web_experience_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.get_web_experience_request.GetWebExperienceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
