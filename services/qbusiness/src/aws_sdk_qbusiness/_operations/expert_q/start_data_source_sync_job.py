...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.start_data_source_sync_job_response.StartDataSourceSyncJobResponse = aws_sdk_qbusiness.types.start_data_source_sync_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.start_data_source_sync_job_request.StartDataSourceSyncJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
