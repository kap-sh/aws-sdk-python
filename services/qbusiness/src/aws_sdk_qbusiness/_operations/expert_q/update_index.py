...
import aws_sdk_qbusiness.types.update_index_request
import aws_sdk_qbusiness.types.update_index_response
...
) -> aws_sdk_qbusiness.types.update_index_response.UpdateIndexResponse:
    out: aws_sdk_qbusiness.types.update_index_response.UpdateIndexResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.update_index_request.UpdateIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.update_index_request.serialize_json(input_)
    ).encode()
...
def update_index(
    ...
    aws_sdk_qbusiness.types.update_index_response.UpdateIndexResponse, zapros.Response
]:
