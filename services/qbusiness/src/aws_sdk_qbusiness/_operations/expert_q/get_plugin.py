"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetPlugin``."""
...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.get_plugin_request
    import aws_sdk_qbusiness.types.get_plugin_response
...
) -> aws_sdk_qbusiness.types.get_plugin_response.GetPluginResponse:
    import aws_sdk_qbusiness.types.get_plugin_response

    out: aws_sdk_qbusiness.types.get_plugin_response.GetPluginResponse = (
        aws_sdk_qbusiness.types.get_plugin_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.get_plugin_request.GetPluginRequest,
) -> zapros.Request:
...
def get_plugin(
    ...
    aws_sdk_qbusiness.types.get_plugin_response.GetPluginResponse, zapros.Response
]:
