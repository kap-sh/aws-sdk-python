...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.list_indices_request
    import aws_sdk_qbusiness.types.list_indices_response
...
) -> aws_sdk_qbusiness.types.list_indices_response.ListIndicesResponse:
    import aws_sdk_qbusiness.types.list_indices_response

    out: aws_sdk_qbusiness.types.list_indices_response.ListIndicesResponse = (
        aws_sdk_qbusiness.types.list_indices_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_indices_request.ListIndicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_indices(
    ...
    aws_sdk_qbusiness.types.list_indices_response.ListIndicesResponse, zapros.Response
]:
