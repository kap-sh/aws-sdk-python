"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListPluginTypeActions``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.list_plugin_type_actions_response.ListPluginTypeActionsResponse = aws_sdk_qbusiness.types.list_plugin_type_actions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_plugin_type_actions_request.ListPluginTypeActionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/pluginTypes/{pluginType}/actions"
    url = url.replace("{pluginType}", quote(str(input_["plugin_type"]), safe=""))
    params: dict[str, str] = {}
...
async def async_list_plugin_type_actions(
