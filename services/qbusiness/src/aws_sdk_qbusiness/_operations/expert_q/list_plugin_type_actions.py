...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.list_plugin_type_actions_request.ListPluginTypeActionsRequest,
) -> zapros.Request:
    ...
    url = url.replace("{pluginType}", quote(str(input["plugin_type"]), safe=""))
    params: dict[str, str] = {}
