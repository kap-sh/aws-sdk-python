"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListConversations``."""
...
import aws_sdk_qbusiness.types.conversations
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.list_conversations_response.ListConversationsResponse = aws_sdk_qbusiness.types.list_conversations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_conversations_request.ListConversationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
