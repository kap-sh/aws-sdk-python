"""Generated from Smithy shape ``com.amazonaws.qbusiness#SearchRelevantContent``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.search_relevant_content_response.SearchRelevantContentResponse = aws_sdk_qbusiness.types.search_relevant_content_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.search_relevant_content_request.SearchRelevantContentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{applicationId}/relevant-content"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.search_relevant_content_request.serialize_json(input_)
    ).encode()
...
async def async_search_relevant_content(
