...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.search_relevant_content_request.SearchRelevantContentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.search_relevant_content_request.serialize_json(input)
    ).encode()
