...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.list_attachments_response.ListAttachmentsResponse = (
        aws_sdk_qbusiness.types.list_attachments_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.list_attachments_request.ListAttachmentsRequest,
) -> zapros.Request:
    ...
    if "conversation_id" in input:
        params["conversationId"] = str(input["conversation_id"])
    if "user_id" in input:
