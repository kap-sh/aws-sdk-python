...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.associate_permission_request.AssociatePermissionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.associate_permission_request.serialize_json(input)
    ).encode()
