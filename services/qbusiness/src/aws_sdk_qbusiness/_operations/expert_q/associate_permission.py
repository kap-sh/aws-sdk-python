"""Generated from Smithy shape ``com.amazonaws.qbusiness#AssociatePermission``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.associate_permission_response.AssociatePermissionResponse = aws_sdk_qbusiness.types.associate_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.associate_permission_request.AssociatePermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.associate_permission_request.serialize_json(input_)
    ).encode()
...
async def async_associate_permission(
