...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.disassociate_permission_response.DisassociatePermissionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.disassociate_permission_request.DisassociatePermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
