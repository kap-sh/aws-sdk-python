...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.create_index_request
    import aws_sdk_qbusiness.types.create_index_response
...
) -> aws_sdk_qbusiness.types.create_index_response.CreateIndexResponse:
    import aws_sdk_qbusiness.types.create_index_response

    out: aws_sdk_qbusiness.types.create_index_response.CreateIndexResponse = (
        aws_sdk_qbusiness.types.create_index_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.create_index_request.CreateIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_index_request.serialize_json(input_)
    ).encode()
...
def create_index(
    ...
    aws_sdk_qbusiness.types.create_index_response.CreateIndexResponse, zapros.Response
]:
