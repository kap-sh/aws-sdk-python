...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.delete_conversation_response.DeleteConversationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.delete_conversation_request.DeleteConversationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
