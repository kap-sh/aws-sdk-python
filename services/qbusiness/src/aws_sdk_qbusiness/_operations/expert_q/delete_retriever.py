"""Generated from Smithy shape ``com.amazonaws.qbusiness#DeleteRetriever``."""
...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.delete_retriever_request
    import aws_sdk_qbusiness.types.delete_retriever_response
...
) -> aws_sdk_qbusiness.types.delete_retriever_response.DeleteRetrieverResponse:
    out: aws_sdk_qbusiness.types.delete_retriever_response.DeleteRetrieverResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.delete_retriever_request.DeleteRetrieverRequest,
) -> zapros.Request:
    ...
    url = url.replace("{retrieverId}", quote(str(input["retriever_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_delete_retriever(
