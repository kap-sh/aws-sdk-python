"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListDataSourceSyncJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.list_data_source_sync_jobs_response.ListDataSourceSyncJobsResponse = aws_sdk_qbusiness.types.list_data_source_sync_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_data_source_sync_jobs_request.ListDataSourceSyncJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "status_filter" in input_:
        params["syncStatus"] = str(input_["status_filter"])
