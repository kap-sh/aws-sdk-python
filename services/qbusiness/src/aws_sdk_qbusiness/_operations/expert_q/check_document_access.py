...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.check_document_access_response.CheckDocumentAccessResponse = aws_sdk_qbusiness.types.check_document_access_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.check_document_access_request.CheckDocumentAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
