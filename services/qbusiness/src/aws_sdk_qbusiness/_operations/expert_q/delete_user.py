...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.delete_user_response.DeleteUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.delete_user_request.DeleteUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_user(
    ...
    aws_sdk_qbusiness.types.delete_user_response.DeleteUserResponse, zapros.Response
]:
