"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetUser``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.get_user_response.GetUserResponse = (
        aws_sdk_qbusiness.types.get_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.get_user_request.GetUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_user(
    ...
    input_: aws_sdk_qbusiness.types.get_user_request.GetUserRequest,
) -> tuple[aws_sdk_qbusiness.types.get_user_response.GetUserResponse, zapros.Response]:
