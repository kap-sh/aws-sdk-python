...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.get_policy_response.GetPolicyResponse = (
        aws_sdk_qbusiness.types.get_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.get_policy_request.GetPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_policy(
    ...
    aws_sdk_qbusiness.types.get_policy_response.GetPolicyResponse, zapros.Response
]:
