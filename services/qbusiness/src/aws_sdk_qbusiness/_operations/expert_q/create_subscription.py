...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.create_subscription_request.CreateSubscriptionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_subscription_request.serialize_json(input)
    ).encode()
