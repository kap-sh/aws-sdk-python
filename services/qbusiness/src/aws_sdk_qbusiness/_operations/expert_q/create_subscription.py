"""Generated from Smithy shape ``com.amazonaws.qbusiness#CreateSubscription``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.create_subscription_response.CreateSubscriptionResponse = aws_sdk_qbusiness.types.create_subscription_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.create_subscription_request.CreateSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{applicationId}/subscriptions"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_subscription_request.serialize_json(input_)
    ).encode()
