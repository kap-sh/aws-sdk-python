"""Generated from Smithy shape ``com.amazonaws.qbusiness#DeleteChatControlsConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.delete_chat_controls_configuration_response.DeleteChatControlsConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.delete_chat_controls_configuration_request.DeleteChatControlsConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_chat_controls_configuration(
