...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.list_data_accessors_request
    import aws_sdk_qbusiness.types.list_data_accessors_response
...
) -> aws_sdk_qbusiness.types.list_data_accessors_response.ListDataAccessorsResponse:
    import aws_sdk_qbusiness.types.list_data_accessors_response

    out: aws_sdk_qbusiness.types.list_data_accessors_response.ListDataAccessorsResponse = aws_sdk_qbusiness.types.list_data_accessors_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_data_accessors_request.ListDataAccessorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
