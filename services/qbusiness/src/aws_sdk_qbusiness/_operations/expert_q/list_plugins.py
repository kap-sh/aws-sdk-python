...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.list_plugins_request
    import aws_sdk_qbusiness.types.list_plugins_response
...
) -> aws_sdk_qbusiness.types.list_plugins_response.ListPluginsResponse:
    import aws_sdk_qbusiness.types.list_plugins_response

    out: aws_sdk_qbusiness.types.list_plugins_response.ListPluginsResponse = (
        aws_sdk_qbusiness.types.list_plugins_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_plugins_request.ListPluginsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_plugins(
    ...
    aws_sdk_qbusiness.types.list_plugins_response.ListPluginsResponse, zapros.Response
]:
