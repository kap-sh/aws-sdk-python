...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.delete_data_accessor_request
    import aws_sdk_qbusiness.types.delete_data_accessor_response
...
) -> aws_sdk_qbusiness.types.delete_data_accessor_response.DeleteDataAccessorResponse:
    out: aws_sdk_qbusiness.types.delete_data_accessor_response.DeleteDataAccessorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.delete_data_accessor_request.DeleteDataAccessorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
