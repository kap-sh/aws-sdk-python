"""Generated from Smithy shape ``com.amazonaws.qbusiness#DeleteWebExperience``."""
...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.delete_web_experience_request
    import aws_sdk_qbusiness.types.delete_web_experience_response
...
) -> aws_sdk_qbusiness.types.delete_web_experience_response.DeleteWebExperienceResponse:
    out: aws_sdk_qbusiness.types.delete_web_experience_response.DeleteWebExperienceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.delete_web_experience_request.DeleteWebExperienceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{webExperienceId}", quote(str(input_["web_experience_id"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_delete_web_experience(
