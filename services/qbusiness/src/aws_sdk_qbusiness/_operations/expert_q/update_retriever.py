...
if TYPE_CHECKING:
    ...
    import aws_sdk_qbusiness.types.update_retriever_response
...
) -> aws_sdk_qbusiness.types.update_retriever_response.UpdateRetrieverResponse:
    out: aws_sdk_qbusiness.types.update_retriever_response.UpdateRetrieverResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.update_retriever_request.UpdateRetrieverRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.update_retriever_request.serialize_json(input)
    ).encode()
