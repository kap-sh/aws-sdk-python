...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.update_subscription_request.UpdateSubscriptionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.update_subscription_request.serialize_json(input)
    ).encode()
