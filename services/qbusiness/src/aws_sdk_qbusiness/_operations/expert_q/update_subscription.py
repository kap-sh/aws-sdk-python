"""Generated from Smithy shape ``com.amazonaws.qbusiness#UpdateSubscription``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.update_subscription_response.UpdateSubscriptionResponse = aws_sdk_qbusiness.types.update_subscription_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.update_subscription_request.UpdateSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.update_subscription_request.serialize_json(input_)
    ).encode()
