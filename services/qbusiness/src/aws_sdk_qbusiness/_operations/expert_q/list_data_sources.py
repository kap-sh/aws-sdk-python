...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.list_data_sources_request
    import aws_sdk_qbusiness.types.list_data_sources_response
...
) -> aws_sdk_qbusiness.types.list_data_sources_response.ListDataSourcesResponse:
    import aws_sdk_qbusiness.types.list_data_sources_response

    out: aws_sdk_qbusiness.types.list_data_sources_response.ListDataSourcesResponse = (
        aws_sdk_qbusiness.types.list_data_sources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_data_sources_request.ListDataSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
