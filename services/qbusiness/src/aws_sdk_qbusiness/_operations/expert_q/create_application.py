...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.create_application_request.CreateApplicationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_application_request.serialize_json(input)
    ).encode()
