...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.create_application_response.CreateApplicationResponse = aws_sdk_qbusiness.types.create_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.create_application_request.CreateApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_application_request.serialize_json(input_)
    ).encode()
