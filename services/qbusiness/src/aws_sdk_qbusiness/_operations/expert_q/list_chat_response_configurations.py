...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.list_chat_response_configurations_response.ListChatResponseConfigurationsResponse = aws_sdk_qbusiness.types.list_chat_response_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_chat_response_configurations_request.ListChatResponseConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
