"""Generated from Smithy shape ``com.amazonaws.qbusiness#DeleteIndex``."""
...
import aws_sdk_qbusiness.types.delete_index_request
import aws_sdk_qbusiness.types.delete_index_response
...
) -> aws_sdk_qbusiness.types.delete_index_response.DeleteIndexResponse:
    out: aws_sdk_qbusiness.types.delete_index_response.DeleteIndexResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.delete_index_request.DeleteIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{applicationId}/indices/{indexId}"
...
def delete_index(
    ...
    aws_sdk_qbusiness.types.delete_index_response.DeleteIndexResponse, zapros.Response
]:
