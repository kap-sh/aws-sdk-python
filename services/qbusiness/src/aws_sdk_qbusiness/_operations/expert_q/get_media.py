"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetMedia``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MediaTooLargeException":
            import aws_sdk_qbusiness.errors.media_too_large_exception

            raise aws_sdk_qbusiness.errors.media_too_large_exception.MediaTooLargeException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.get_media_response.GetMediaResponse = (
        aws_sdk_qbusiness.types.get_media_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.get_media_request.GetMediaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{mediaId}", quote(str(input_["media_id"]), safe=""))
    params: dict[str, str] = {}
...
def get_media(
    ...
    aws_sdk_qbusiness.types.get_media_response.GetMediaResponse, zapros.Response
]:
