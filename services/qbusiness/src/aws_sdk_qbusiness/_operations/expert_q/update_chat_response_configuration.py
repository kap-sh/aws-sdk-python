...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.update_chat_response_configuration_request.UpdateChatResponseConfigurationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["chat_response_configuration_id"]), safe=""),
    )
    params: dict[str, str] = {}
