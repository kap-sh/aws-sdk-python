"""Generated from Smithy shape ``com.amazonaws.qbusiness#UpdateChatResponseConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.update_chat_response_configuration_response.UpdateChatResponseConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.update_chat_response_configuration_request.UpdateChatResponseConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["chat_response_configuration_id"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.update_chat_response_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_chat_response_configuration(
