"""Generated from Smithy shape ``com.amazonaws.qbusiness#DeleteDataSource``."""
...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.delete_data_source_request
    import aws_sdk_qbusiness.types.delete_data_source_response
...
) -> aws_sdk_qbusiness.types.delete_data_source_response.DeleteDataSourceResponse:
    out: aws_sdk_qbusiness.types.delete_data_source_response.DeleteDataSourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.delete_data_source_request.DeleteDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
