"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListDocuments``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.list_documents_response.ListDocumentsResponse = (
        aws_sdk_qbusiness.types.list_documents_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_documents_request.ListDocumentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "data_source_ids" in input_:
        params["dataSourceIds"] = str(input_["data_source_ids"])
