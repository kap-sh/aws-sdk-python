...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.get_chat_controls_configuration_response.GetChatControlsConfigurationResponse = aws_sdk_qbusiness.types.get_chat_controls_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.get_chat_controls_configuration_request.GetChatControlsConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
