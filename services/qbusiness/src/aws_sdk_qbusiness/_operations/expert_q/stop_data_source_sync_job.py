"""Generated from Smithy shape ``com.amazonaws.qbusiness#StopDataSourceSyncJob``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.stop_data_source_sync_job_response.StopDataSourceSyncJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.stop_data_source_sync_job_request.StopDataSourceSyncJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_stop_data_source_sync_job(
