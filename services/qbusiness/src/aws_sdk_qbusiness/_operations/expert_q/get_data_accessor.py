"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetDataAccessor``."""
...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.get_data_accessor_request
    import aws_sdk_qbusiness.types.get_data_accessor_response
...
) -> aws_sdk_qbusiness.types.get_data_accessor_response.GetDataAccessorResponse:
    import aws_sdk_qbusiness.types.get_data_accessor_response

    out: aws_sdk_qbusiness.types.get_data_accessor_response.GetDataAccessorResponse = (
        aws_sdk_qbusiness.types.get_data_accessor_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.get_data_accessor_request.GetDataAccessorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_data_accessor(
