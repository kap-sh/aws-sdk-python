"""Generated from Smithy shape ``com.amazonaws.qbusiness#CreatePlugin``."""
...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.create_plugin_request
    import aws_sdk_qbusiness.types.create_plugin_response
...
) -> aws_sdk_qbusiness.types.create_plugin_response.CreatePluginResponse:
    import aws_sdk_qbusiness.types.create_plugin_response

    out: aws_sdk_qbusiness.types.create_plugin_response.CreatePluginResponse = (
        aws_sdk_qbusiness.types.create_plugin_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.create_plugin_request.CreatePluginRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{applicationId}/plugins"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_plugin_request.serialize_json(input_)
    ).encode()
...
def create_plugin(
    ...
    aws_sdk_qbusiness.types.create_plugin_response.CreatePluginResponse, zapros.Response
]:
