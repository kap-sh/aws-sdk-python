"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetDataSource``."""
...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.get_data_source_request
    import aws_sdk_qbusiness.types.get_data_source_response
...
) -> aws_sdk_qbusiness.types.get_data_source_response.GetDataSourceResponse:
    import aws_sdk_qbusiness.types.get_data_source_response

    out: aws_sdk_qbusiness.types.get_data_source_response.GetDataSourceResponse = (
        aws_sdk_qbusiness.types.get_data_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.get_data_source_request.GetDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
