...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.batch_delete_document_request.BatchDeleteDocumentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.batch_delete_document_request.serialize_json(input)
    ).encode()
