...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.batch_delete_document_response.BatchDeleteDocumentResponse = aws_sdk_qbusiness.types.batch_delete_document_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.batch_delete_document_request.BatchDeleteDocumentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.batch_delete_document_request.serialize_json(input_)
    ).encode()
