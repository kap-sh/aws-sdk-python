...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.get_group_response.GetGroupResponse = (
        aws_sdk_qbusiness.types.get_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.get_group_request.GetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_group(
    ...
    aws_sdk_qbusiness.types.get_group_response.GetGroupResponse, zapros.Response
]:
