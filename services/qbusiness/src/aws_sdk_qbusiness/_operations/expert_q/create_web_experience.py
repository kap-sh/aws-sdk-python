...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.create_web_experience_request.CreateWebExperienceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_web_experience_request.serialize_json(input)
    ).encode()
