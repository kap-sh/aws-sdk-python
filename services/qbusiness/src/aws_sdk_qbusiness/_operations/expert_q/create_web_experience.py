"""Generated from Smithy shape ``com.amazonaws.qbusiness#CreateWebExperience``."""
...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.create_web_experience_request
    import aws_sdk_qbusiness.types.create_web_experience_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_qbusiness.errors.service_quota_exceeded_exception

            raise aws_sdk_qbusiness.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
) -> aws_sdk_qbusiness.types.create_web_experience_response.CreateWebExperienceResponse:
    import aws_sdk_qbusiness.types.create_web_experience_response

    out: aws_sdk_qbusiness.types.create_web_experience_response.CreateWebExperienceResponse = aws_sdk_qbusiness.types.create_web_experience_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.create_web_experience_request.CreateWebExperienceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{applicationId}/experiences"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_web_experience_request.serialize_json(input_)
    ).encode()
...
async def async_create_web_experience(
