...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.list_plugin_type_metadata_response.ListPluginTypeMetadataResponse = aws_sdk_qbusiness.types.list_plugin_type_metadata_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_plugin_type_metadata_request.ListPluginTypeMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
