...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.put_group_response.PutGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.put_group_request.PutGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.put_group_request.serialize_json(input_)
    ).encode()
...
def put_group(
    ...
    aws_sdk_qbusiness.types.put_group_response.PutGroupResponse, zapros.Response
]:
