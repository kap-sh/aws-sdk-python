"""Generated from Smithy shape ``com.amazonaws.qbusiness#DeleteChatResponseConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.delete_chat_response_configuration_response.DeleteChatResponseConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.delete_chat_response_configuration_request.DeleteChatResponseConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_chat_response_configuration(
