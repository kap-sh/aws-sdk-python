"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.list_groups_response.ListGroupsResponse = (
        aws_sdk_qbusiness.types.list_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_groups_request.ListGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "updated_earlier_than" in input_:
        params["updatedEarlierThan"] = str(input_["updated_earlier_than"])
...
def list_groups(
    ...
    aws_sdk_qbusiness.types.list_groups_response.ListGroupsResponse, zapros.Response
]:
