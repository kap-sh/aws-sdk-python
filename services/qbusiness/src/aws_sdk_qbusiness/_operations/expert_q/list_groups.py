...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.list_groups_request.ListGroupsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "updated_earlier_than" in input:
        params["updatedEarlierThan"] = str(input["updated_earlier_than"])
