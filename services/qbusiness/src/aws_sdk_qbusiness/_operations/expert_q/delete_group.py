"""Generated from Smithy shape ``com.amazonaws.qbusiness#DeleteGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.delete_group_response.DeleteGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.delete_group_request.DeleteGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_group(
    ...
    aws_sdk_qbusiness.types.delete_group_response.DeleteGroupResponse, zapros.Response
]:
