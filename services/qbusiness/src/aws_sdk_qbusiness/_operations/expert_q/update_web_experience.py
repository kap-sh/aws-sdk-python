...
def build_request(
    ...
    input: aws_sdk_qbusiness.types.update_web_experience_request.UpdateWebExperienceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.update_web_experience_request.serialize_json(input)
    ).encode()
