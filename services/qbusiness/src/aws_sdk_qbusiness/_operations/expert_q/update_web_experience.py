...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.update_web_experience_request
    import aws_sdk_qbusiness.types.update_web_experience_response
...
) -> aws_sdk_qbusiness.types.update_web_experience_response.UpdateWebExperienceResponse:
    out: aws_sdk_qbusiness.types.update_web_experience_response.UpdateWebExperienceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.update_web_experience_request.UpdateWebExperienceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.update_web_experience_request.serialize_json(input_)
    ).encode()
