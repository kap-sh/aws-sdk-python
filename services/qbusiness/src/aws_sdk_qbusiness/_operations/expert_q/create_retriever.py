...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.create_retriever_request
    import aws_sdk_qbusiness.types.create_retriever_response
...
) -> aws_sdk_qbusiness.types.create_retriever_response.CreateRetrieverResponse:
    import aws_sdk_qbusiness.types.create_retriever_response

    out: aws_sdk_qbusiness.types.create_retriever_response.CreateRetrieverResponse = (
        aws_sdk_qbusiness.types.create_retriever_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.create_retriever_request.CreateRetrieverRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.create_retriever_request.serialize_json(input_)
    ).encode()
