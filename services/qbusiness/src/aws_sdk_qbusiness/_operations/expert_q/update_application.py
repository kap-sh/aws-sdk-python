"""Generated from Smithy shape ``com.amazonaws.qbusiness#UpdateApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.update_application_response.UpdateApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.update_application_request.UpdateApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_qbusiness.types.update_application_request.serialize_json(input_)
    ).encode()
