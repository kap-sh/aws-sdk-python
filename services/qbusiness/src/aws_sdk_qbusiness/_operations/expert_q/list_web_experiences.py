...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.list_web_experiences_request
    import aws_sdk_qbusiness.types.list_web_experiences_response
...
) -> aws_sdk_qbusiness.types.list_web_experiences_response.ListWebExperiencesResponse:
    import aws_sdk_qbusiness.types.list_web_experiences_response

    out: aws_sdk_qbusiness.types.list_web_experiences_response.ListWebExperiencesResponse = aws_sdk_qbusiness.types.list_web_experiences_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_web_experiences_request.ListWebExperiencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
