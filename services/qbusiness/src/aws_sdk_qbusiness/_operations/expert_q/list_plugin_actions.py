...
def handle_response(
    ...
    out: aws_sdk_qbusiness.types.list_plugin_actions_response.ListPluginActionsResponse = aws_sdk_qbusiness.types.list_plugin_actions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_qbusiness.types.list_plugin_actions_request.ListPluginActionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
