...
class CreateRetrieverRequest(TypedDict):
    ...
    configuration: "aws_sdk_qbusiness.types.retriever_configuration.RetrieverConfiguration"
...
def serialize_json(value: CreateRetrieverRequest) -> dict:
    ...
    import aws_sdk_qbusiness.types.retriever_configuration
    out["configuration"] = aws_sdk_qbusiness.types.retriever_configuration.serialize_json(value["configuration"])
...
def deserialize_json(data: dict) -> CreateRetrieverRequest:
    ...
    if "type" in data:
        import aws_sdk_qbusiness.types.retriever_type
        out["type"] = aws_sdk_qbusiness.types.retriever_type.deserialize_json(data["type"])
    else:
    ...
    if "configuration" in data:
        import aws_sdk_qbusiness.types.retriever_configuration
        out["configuration"] = aws_sdk_qbusiness.types.retriever_configuration.deserialize_json(data["configuration"])
    else:
