...
class AudioExtractionConfiguration(TypedDict):
    audio_extraction_status: "aws_sdk_qbusiness.types.audio_extraction_status.AudioExtractionStatus"
...
def serialize_json(value: AudioExtractionConfiguration) -> dict:
    out: dict = {}
    import aws_sdk_qbusiness.types.audio_extraction_status
    out["audioExtractionStatus"] = aws_sdk_qbusiness.types.audio_extraction_status.serialize_json(value["audio_extraction_status"])
    return out
...
def deserialize_json(data: dict) -> AudioExtractionConfiguration:
    ...
    if "audioExtractionStatus" in data:
        import aws_sdk_qbusiness.types.audio_extraction_status
        out["audio_extraction_status"] = aws_sdk_qbusiness.types.audio_extraction_status.deserialize_json(data["audioExtractionStatus"])
    else:
        raise DeserializationError("AudioExtractionConfiguration.audio_extraction_status required")
    return out