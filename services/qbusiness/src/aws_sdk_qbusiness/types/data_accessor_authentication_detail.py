...
class DataAccessorAuthenticationDetail(TypedDict):
    ...
    authentication_configuration: NotRequired["aws_sdk_qbusiness.types.data_accessor_authentication_configuration.DataAccessorAuthenticationConfiguration"]
    """<p>The specific authentication configuration based on the authentication type.</p>"""
    external_ids: NotRequired["aws_sdk_qbusiness.types.data_accessor_external_ids.DataAccessorExternalIds"]
...
def serialize_json(value: DataAccessorAuthenticationDetail) -> dict:
    out: dict = {}
    import aws_sdk_qbusiness.types.data_accessor_authentication_type
    out["authenticationType"] = aws_sdk_qbusiness.types.data_accessor_authentication_type.serialize_json(value["authentication_type"])
    if "authentication_configuration" in value:
        import aws_sdk_qbusiness.types.data_accessor_authentication_configuration
        out["authenticationConfiguration"] = aws_sdk_qbusiness.types.data_accessor_authentication_configuration.serialize_json(value["authentication_configuration"])
    if "external_ids" in value:
        import aws_sdk_qbusiness.types.data_accessor_external_ids
        out["externalIds"] = aws_sdk_qbusiness.types.data_accessor_external_ids.serialize_json(value["external_ids"])
    return out
...
def deserialize_json(data: dict) -> DataAccessorAuthenticationDetail:
    ...
    if "authenticationType" in data:
        import aws_sdk_qbusiness.types.data_accessor_authentication_type
        out["authentication_type"] = aws_sdk_qbusiness.types.data_accessor_authentication_type.deserialize_json(data["authenticationType"])
    else:
        raise DeserializationError("DataAccessorAuthenticationDetail.authentication_type required")
    if "authenticationConfiguration" in data:
        import aws_sdk_qbusiness.types.data_accessor_authentication_configuration
        out["authentication_configuration"] = aws_sdk_qbusiness.types.data_accessor_authentication_configuration.deserialize_json(data["authenticationConfiguration"])
    if "externalIds" in data:
        import aws_sdk_qbusiness.types.data_accessor_external_ids
        out["external_ids"] = aws_sdk_qbusiness.types.data_accessor_external_ids.deserialize_json(data["externalIds"])
    return out