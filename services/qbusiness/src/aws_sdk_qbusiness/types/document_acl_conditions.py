...
DocumentAclConditions: TypeAlias = list["aws_sdk_qbusiness.types.document_acl_condition.DocumentAclCondition"]
...
def deserialize_json(data: list) -> DocumentAclConditions:
    ...
    for item in data:
        out.append(aws_sdk_qbusiness.types.document_acl_condition.deserialize_json(item))
    return out