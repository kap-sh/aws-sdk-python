...
def serialize_json(value: CustomPluginConfiguration) -> dict:
    ...
    out["apiSchemaType"] = aws_sdk_qbusiness.types.api_schema_type.serialize_json(
        value["api_schema_type"]
    )
    if "api_schema" in value:
        import aws_sdk_qbusiness.types.api_schema

        out["apiSchema"] = aws_sdk_qbusiness.types.api_schema.serialize_json(
            value["api_schema"]
        )
    return out
...
def deserialize_json(data: dict) -> CustomPluginConfiguration:
    ...
    if "apiSchemaType" in data:
        ...
        out["api_schema_type"] = (
            aws_sdk_qbusiness.types.api_schema_type.deserialize_json(
                data["apiSchemaType"]
            )
        )
    else:
    ...
    if "apiSchema" in data:
        ...
        out["api_schema"] = aws_sdk_qbusiness.types.api_schema.deserialize_json(
            data["apiSchema"]
        )
    return out
