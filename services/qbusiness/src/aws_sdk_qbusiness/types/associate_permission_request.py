...
class AssociatePermissionRequest(TypedDict, closed=True):
...
def serialize_json(value: AssociatePermissionRequest) -> dict:
    ...
    out["actions"] = aws_sdk_qbusiness.types.q_iam_actions.serialize_json(
        value["actions"]
    )
    if "conditions" in value:
        ...
        out["conditions"] = (
            aws_sdk_qbusiness.types.permission_conditions.serialize_json(
                value["conditions"]
            )
        )
...
def deserialize_json(data: dict) -> AssociatePermissionRequest:
    ...
    if "actions" in data:
        ...
        out["actions"] = aws_sdk_qbusiness.types.q_iam_actions.deserialize_json(
            data["actions"]
        )
    else:
    ...
    if "conditions" in data:
        ...
        out["conditions"] = (
            aws_sdk_qbusiness.types.permission_conditions.deserialize_json(
                data["conditions"]
            )
        )
