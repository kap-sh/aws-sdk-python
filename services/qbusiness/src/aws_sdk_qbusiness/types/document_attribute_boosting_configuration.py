...
def serialize_json(value: DocumentAttributeBoostingConfiguration) -> dict:
    if "numberConfiguration" in value:
        ...
        return {
            "numberConfiguration": aws_sdk_qbusiness.types.number_attribute_boosting_configuration.serialize_json(
        ...
        return {
            "stringConfiguration": aws_sdk_qbusiness.types.string_attribute_boosting_configuration.serialize_json(
        ...
        return {
            "dateConfiguration": aws_sdk_qbusiness.types.date_attribute_boosting_configuration.serialize_json(
        ...
        return {
            "stringListConfiguration": aws_sdk_qbusiness.types.string_list_attribute_boosting_configuration.serialize_json(
...
def deserialize_json(data: dict) -> DocumentAttributeBoostingConfiguration:
    if "numberConfiguration" in data:
        ...
        return {
            "numberConfiguration": aws_sdk_qbusiness.types.number_attribute_boosting_configuration.deserialize_json(
        ...
        return {
            "stringConfiguration": aws_sdk_qbusiness.types.string_attribute_boosting_configuration.deserialize_json(
        ...
        return {
            "dateConfiguration": aws_sdk_qbusiness.types.date_attribute_boosting_configuration.deserialize_json(
        ...
        return {
            "stringListConfiguration": aws_sdk_qbusiness.types.string_list_attribute_boosting_configuration.deserialize_json(
