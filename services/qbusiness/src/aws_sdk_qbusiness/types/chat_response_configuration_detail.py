...
class ChatResponseConfigurationDetail(TypedDict):
    response_configurations: NotRequired["aws_sdk_qbusiness.types.response_configurations.ResponseConfigurations"]
    ...
    response_configuration_summary: NotRequired["aws_sdk_qbusiness.types.string.String"]
    ...
    status: NotRequired["aws_sdk_qbusiness.types.chat_response_configuration_status.ChatResponseConfigurationStatus"]
...
def serialize_json(value: ChatResponseConfigurationDetail) -> dict:
    ...
    if "status" in value:
        import aws_sdk_qbusiness.types.chat_response_configuration_status
        out["status"] = aws_sdk_qbusiness.types.chat_response_configuration_status.serialize_json(value["status"])
    if "error" in value:
        import aws_sdk_qbusiness.types.error_detail
...
def deserialize_json(data: dict) -> ChatResponseConfigurationDetail:
    ...
    if "status" in data:
        import aws_sdk_qbusiness.types.chat_response_configuration_status
        out["status"] = aws_sdk_qbusiness.types.chat_response_configuration_status.deserialize_json(data["status"])
    if "error" in data:
        import aws_sdk_qbusiness.types.error_detail
