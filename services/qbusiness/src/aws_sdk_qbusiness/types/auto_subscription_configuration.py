...
class AutoSubscriptionConfiguration(TypedDict):
    auto_subscribe: "aws_sdk_qbusiness.types.auto_subscription_status.AutoSubscriptionStatus"
    ...
    default_subscription_type: NotRequired["aws_sdk_qbusiness.types.subscription_type.SubscriptionType"]
...
def serialize_json(value: AutoSubscriptionConfiguration) -> dict:
    out: dict = {}
    import aws_sdk_qbusiness.types.auto_subscription_status
    out["autoSubscribe"] = aws_sdk_qbusiness.types.auto_subscription_status.serialize_json(value["auto_subscribe"])
    if "default_subscription_type" in value:
        import aws_sdk_qbusiness.types.subscription_type
        out["defaultSubscriptionType"] = aws_sdk_qbusiness.types.subscription_type.serialize_json(value["default_subscription_type"])
    return out
...
def deserialize_json(data: dict) -> AutoSubscriptionConfiguration:
    ...
    if "autoSubscribe" in data:
        import aws_sdk_qbusiness.types.auto_subscription_status
        out["auto_subscribe"] = aws_sdk_qbusiness.types.auto_subscription_status.deserialize_json(data["autoSubscribe"])
    else:
        raise DeserializationError("AutoSubscriptionConfiguration.auto_subscribe required")
    if "defaultSubscriptionType" in data:
        import aws_sdk_qbusiness.types.subscription_type
        out["default_subscription_type"] = aws_sdk_qbusiness.types.subscription_type.deserialize_json(data["defaultSubscriptionType"])
    return out