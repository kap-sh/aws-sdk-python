...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.chat_response_configurations
    import aws_sdk_qbusiness.types.next_token


class ListChatResponseConfigurationsResponse(TypedDict):
    chat_response_configurations: NotRequired[
        "aws_sdk_qbusiness.types.chat_response_configurations.ChatResponseConfigurations"
    ]
...
def serialize_json(value: ListChatResponseConfigurationsResponse) -> dict:
    ...
    if "chat_response_configurations" in value:
        ...
        out["chatResponseConfigurations"] = (
            aws_sdk_qbusiness.types.chat_response_configurations.serialize_json(
...
def deserialize_json(data: dict) -> ListChatResponseConfigurationsResponse:
    ...
    if "chatResponseConfigurations" in data:
        ...
        out["chat_response_configurations"] = (
            aws_sdk_qbusiness.types.chat_response_configurations.deserialize_json(
