...
class _ChatModeConfiguration_pluginConfiguration(TypedDict):
    pluginConfiguration: (
        "aws_sdk_qbusiness.types.plugin_configuration.PluginConfiguration"
    )
...
def serialize_json(value: ChatModeConfiguration) -> dict:
    if "pluginConfiguration" in value:
        ...
        return {
            "pluginConfiguration": aws_sdk_qbusiness.types.plugin_configuration.serialize_json(
...
def deserialize_json(data: dict) -> ChatModeConfiguration:
    if "pluginConfiguration" in data:
        ...
        return {
            "pluginConfiguration": aws_sdk_qbusiness.types.plugin_configuration.deserialize_json(
