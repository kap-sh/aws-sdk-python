...
def serialize_json(value: AccessConfiguration) -> dict:
    out: dict = {}
    import aws_sdk_qbusiness.types.access_controls
    out["accessControls"] = aws_sdk_qbusiness.types.access_controls.serialize_json(value["access_controls"])
...
def deserialize_json(data: dict) -> AccessConfiguration:
    ...
    if "accessControls" in data:
        import aws_sdk_qbusiness.types.access_controls
        out["access_controls"] = aws_sdk_qbusiness.types.access_controls.deserialize_json(data["accessControls"])
    else:
