...
def deserialize_json(data: dict) -> CreateChatResponseConfigurationResponse:
    ...
    if "chatResponseConfigurationId" in data:
        ...
        raise DeserializationError("CreateChatResponseConfigurationResponse.chat_response_configuration_id required")
    if "chatResponseConfigurationArn" in data:
        out["chat_response_configuration_arn"] = data["chatResponseConfigurationArn"]
    else:
        raise DeserializationError("CreateChatResponseConfigurationResponse.chat_response_configuration_arn required")
    return out