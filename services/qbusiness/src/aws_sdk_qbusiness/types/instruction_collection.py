...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.instruction


class InstructionCollection(TypedDict, closed=True):
    response_length: NotRequired["aws_sdk_qbusiness.types.instruction.Instruction"]
    ...
    target_audience: NotRequired["aws_sdk_qbusiness.types.instruction.Instruction"]
    ...
    perspective: NotRequired["aws_sdk_qbusiness.types.instruction.Instruction"]
    ...
    output_style: NotRequired["aws_sdk_qbusiness.types.instruction.Instruction"]
    ...
    identity: NotRequired["aws_sdk_qbusiness.types.instruction.Instruction"]
    ...
    tone: NotRequired["aws_sdk_qbusiness.types.instruction.Instruction"]
    ...
    custom_instructions: NotRequired["aws_sdk_qbusiness.types.instruction.Instruction"]
    ...
    examples: NotRequired["aws_sdk_qbusiness.types.instruction.Instruction"]
