...
ChatResponseConfigurations: TypeAlias = list[
    "aws_sdk_qbusiness.types.chat_response_configuration.ChatResponseConfiguration"
]
...
def serialize_json(value: ChatResponseConfigurations) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_qbusiness.types.chat_response_configuration.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> ChatResponseConfigurations:
    ...
    for item in data:
        out.append(
            aws_sdk_qbusiness.types.chat_response_configuration.deserialize_json(item)
        )
    return out
