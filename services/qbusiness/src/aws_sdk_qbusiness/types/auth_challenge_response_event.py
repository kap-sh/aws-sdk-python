...
class AuthChallengeResponseEvent(TypedDict):
    response_map: "aws_sdk_qbusiness.types.authorization_response_map.AuthorizationResponseMap"
...
def serialize_json(value: AuthChallengeResponseEvent) -> dict:
    out: dict = {}
    import aws_sdk_qbusiness.types.authorization_response_map
    out["responseMap"] = aws_sdk_qbusiness.types.authorization_response_map.serialize_json(value["response_map"])
    return out
...
def deserialize_json(data: dict) -> AuthChallengeResponseEvent:
    ...
    if "responseMap" in data:
        import aws_sdk_qbusiness.types.authorization_response_map
        out["response_map"] = aws_sdk_qbusiness.types.authorization_response_map.deserialize_json(data["responseMap"])
    else:
