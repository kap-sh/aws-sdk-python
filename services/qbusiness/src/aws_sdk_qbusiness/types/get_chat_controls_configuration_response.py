...
if TYPE_CHECKING:
    ...
    import aws_sdk_qbusiness.types.applied_orchestration_configuration
    import aws_sdk_qbusiness.types.blocked_phrases_configuration
...
class GetChatControlsConfigurationResponse(TypedDict):
    ...
    creator_mode_configuration: NotRequired[
        "aws_sdk_qbusiness.types.applied_creator_mode_configuration.AppliedCreatorModeConfiguration"
    ]
...
def serialize_json(value: GetChatControlsConfigurationResponse) -> dict:
    ...
    if "orchestration_configuration" in value:
        ...
        out["orchestrationConfiguration"] = (
            aws_sdk_qbusiness.types.applied_orchestration_configuration.serialize_json(
    ...
    if "blocked_phrases" in value:
        ...
        out["blockedPhrases"] = (
            aws_sdk_qbusiness.types.blocked_phrases_configuration.serialize_json(
    ...
    if "creator_mode_configuration" in value:
        ...
        out["creatorModeConfiguration"] = (
            aws_sdk_qbusiness.types.applied_creator_mode_configuration.serialize_json(
...
def deserialize_json(data: dict) -> GetChatControlsConfigurationResponse:
    ...
    if "orchestrationConfiguration" in data:
        ...
        out["orchestration_configuration"] = (
            aws_sdk_qbusiness.types.applied_orchestration_configuration.deserialize_json(
    ...
    if "blockedPhrases" in data:
        ...
        out["blocked_phrases"] = (
            aws_sdk_qbusiness.types.blocked_phrases_configuration.deserialize_json(
                data["blockedPhrases"]
            )
        )
    ...
    if "creatorModeConfiguration" in data:
        ...
        out["creator_mode_configuration"] = (
            aws_sdk_qbusiness.types.applied_creator_mode_configuration.deserialize_json(
