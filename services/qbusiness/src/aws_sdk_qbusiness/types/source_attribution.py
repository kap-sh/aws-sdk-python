...
if TYPE_CHECKING:
    ...
    import aws_sdk_qbusiness.types.text_segment_list
...
class SourceAttribution(TypedDict):
    ...
    url: NotRequired["aws_sdk_qbusiness.types.string.String"]
    """<p>The URL of the document which is the source for the Amazon Q Business generated response. </p>"""
    citation_number: NotRequired["aws_sdk_qbusiness.types.integer.Integer"]
    ...
    text_message_segments: NotRequired[
        "aws_sdk_qbusiness.types.text_segment_list.TextSegmentList"
    ]
    """<p>A text extract from a source document that is used for source attribution.</p>"""
    document_id: NotRequired["aws_sdk_qbusiness.types.string.String"]
...
def serialize_json(value: SourceAttribution) -> dict:
    ...
    if "text_message_segments" in value:
        ...
        out["textMessageSegments"] = (
            aws_sdk_qbusiness.types.text_segment_list.serialize_json(
...
def deserialize_json(data: dict) -> SourceAttribution:
    ...
    if "textMessageSegments" in data:
        ...
        out["text_message_segments"] = (
            aws_sdk_qbusiness.types.text_segment_list.deserialize_json(
