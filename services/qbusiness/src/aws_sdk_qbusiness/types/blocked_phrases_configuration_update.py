...
class BlockedPhrasesConfigurationUpdate(TypedDict):
    blocked_phrases_to_create_or_update: NotRequired["aws_sdk_qbusiness.types.blocked_phrases.BlockedPhrases"]
    """<p>Creates or updates a blocked phrases configuration in your Amazon Q Business application.</p>"""
    blocked_phrases_to_delete: NotRequired["aws_sdk_qbusiness.types.blocked_phrases.BlockedPhrases"]
...
def serialize_json(value: BlockedPhrasesConfigurationUpdate) -> dict:
    ...
    if "blocked_phrases_to_create_or_update" in value:
        import aws_sdk_qbusiness.types.blocked_phrases
        out["blockedPhrasesToCreateOrUpdate"] = aws_sdk_qbusiness.types.blocked_phrases.serialize_json(value["blocked_phrases_to_create_or_update"])
    if "blocked_phrases_to_delete" in value:
        import aws_sdk_qbusiness.types.blocked_phrases
        out["blockedPhrasesToDelete"] = aws_sdk_qbusiness.types.blocked_phrases.serialize_json(value["blocked_phrases_to_delete"])
...
def deserialize_json(data: dict) -> BlockedPhrasesConfigurationUpdate:
    ...
    if "blockedPhrasesToCreateOrUpdate" in data:
        import aws_sdk_qbusiness.types.blocked_phrases
        out["blocked_phrases_to_create_or_update"] = aws_sdk_qbusiness.types.blocked_phrases.deserialize_json(data["blockedPhrasesToCreateOrUpdate"])
    if "blockedPhrasesToDelete" in data:
        import aws_sdk_qbusiness.types.blocked_phrases
        out["blocked_phrases_to_delete"] = aws_sdk_qbusiness.types.blocked_phrases.deserialize_json(data["blockedPhrasesToDelete"])
