...
class DateAttributeBoostingConfiguration(TypedDict):
    ...
    boosting_duration_in_seconds: NotRequired["aws_sdk_qbusiness.types.boosting_duration_in_seconds.BoostingDurationInSeconds"]
...
def serialize_json(value: DateAttributeBoostingConfiguration) -> dict:
    out: dict = {}
    import aws_sdk_qbusiness.types.document_attribute_boosting_level
    out["boostingLevel"] = aws_sdk_qbusiness.types.document_attribute_boosting_level.serialize_json(value["boosting_level"])
...
def deserialize_json(data: dict) -> DateAttributeBoostingConfiguration:
    ...
    if "boostingLevel" in data:
        import aws_sdk_qbusiness.types.document_attribute_boosting_level
        out["boosting_level"] = aws_sdk_qbusiness.types.document_attribute_boosting_level.deserialize_json(data["boostingLevel"])
    else:
        raise DeserializationError("DateAttributeBoostingConfiguration.boosting_level required")
