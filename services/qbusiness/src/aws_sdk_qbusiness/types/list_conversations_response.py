...
class ListConversationsResponse(TypedDict):
    ...
    conversations: NotRequired["aws_sdk_qbusiness.types.conversations.Conversations"]
...
def serialize_json(value: ListConversationsResponse) -> dict:
    ...
    if "conversations" in value:
        ...
        out["conversations"] = aws_sdk_qbusiness.types.conversations.serialize_json(
            value["conversations"]
        )
    return out
...
def deserialize_json(data: dict) -> ListConversationsResponse:
    ...
    if "conversations" in data:
        ...
        out["conversations"] = aws_sdk_qbusiness.types.conversations.deserialize_json(
            data["conversations"]
        )
    return out
