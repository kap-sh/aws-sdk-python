...
class AttachmentsConfiguration(TypedDict):
    attachments_control_mode: "aws_sdk_qbusiness.types.attachments_control_mode.AttachmentsControlMode"
...
def deserialize_json(data: dict) -> AttachmentsConfiguration:
    ...
    if "attachmentsControlMode" in data:
        ...
        raise DeserializationError("AttachmentsConfiguration.attachments_control_mode required")
    return out