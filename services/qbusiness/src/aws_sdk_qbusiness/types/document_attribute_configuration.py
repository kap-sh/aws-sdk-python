...
class DocumentAttributeConfiguration(TypedDict):
    name: NotRequired["aws_sdk_qbusiness.types.document_metadata_configuration_name.DocumentMetadataConfigurationName"]
...
def serialize_json(value: DocumentAttributeConfiguration) -> dict:
    ...
    if "type" in value:
        import aws_sdk_qbusiness.types.attribute_type
        out["type"] = aws_sdk_qbusiness.types.attribute_type.serialize_json(value["type"])
    if "search" in value:
        import aws_sdk_qbusiness.types.status
...
def deserialize_json(data: dict) -> DocumentAttributeConfiguration:
    ...
    if "type" in data:
        import aws_sdk_qbusiness.types.attribute_type
        out["type"] = aws_sdk_qbusiness.types.attribute_type.deserialize_json(data["type"])
    if "search" in data:
        import aws_sdk_qbusiness.types.status
