...
def serialize_json(value: AppliedOrchestrationConfiguration) -> dict:
    out: dict = {}
    import aws_sdk_qbusiness.types.orchestration_control
    out["control"] = aws_sdk_qbusiness.types.orchestration_control.serialize_json(value["control"])
    return out
...
def deserialize_json(data: dict) -> AppliedOrchestrationConfiguration:
    ...
    if "control" in data:
        import aws_sdk_qbusiness.types.orchestration_control
        out["control"] = aws_sdk_qbusiness.types.orchestration_control.deserialize_json(data["control"])
    else:
