...
DocumentAttributeBoostingOverrideMap: TypeAlias = dict[
    "aws_sdk_qbusiness.types.document_attribute_key.DocumentAttributeKey",
    "aws_sdk_qbusiness.types.document_attribute_boosting_configuration.DocumentAttributeBoostingConfiguration",
]
...
def serialize_json(input_to_serialize: DocumentAttributeBoostingOverrideMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = (
            aws_sdk_qbusiness.types.document_attribute_boosting_configuration.serialize_json(
                value
            )
        )
    return out
...
def deserialize_json(data: dict) -> DocumentAttributeBoostingOverrideMap:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            aws_sdk_qbusiness.types.document_attribute_boosting_configuration.deserialize_json(
                value
            )
        )
    return out
