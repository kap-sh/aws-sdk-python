...
class DataAccessorIdcTrustedTokenIssuerConfiguration(TypedDict):
    idc_trusted_token_issuer_arn: "aws_sdk_qbusiness.types.idc_trusted_token_issuer_arn.IdcTrustedTokenIssuerArn"
...
def deserialize_json(data: dict) -> DataAccessorIdcTrustedTokenIssuerConfiguration:
    ...
    if "idcTrustedTokenIssuerArn" in data:
        ...
        raise DeserializationError("DataAccessorIdcTrustedTokenIssuerConfiguration.idc_trusted_token_issuer_arn required")
    return out