...
class ListSubscriptionsResponse(TypedDict, closed=True):
    ...
    subscriptions: NotRequired["aws_sdk_qbusiness.types.subscriptions.Subscriptions"]
...
def serialize_json(value: ListSubscriptionsResponse) -> dict:
    ...
    if "subscriptions" in value:
        ...
        out["subscriptions"] = aws_sdk_qbusiness.types.subscriptions.serialize_json(
            value["subscriptions"]
        )
    return out
...
def deserialize_json(data: dict) -> ListSubscriptionsResponse:
    ...
    if "subscriptions" in data:
        ...
        out["subscriptions"] = aws_sdk_qbusiness.types.subscriptions.deserialize_json(
            data["subscriptions"]
        )
    return out
