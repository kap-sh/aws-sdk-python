...
if TYPE_CHECKING:
    ...
    import aws_sdk_qbusiness.types.max_results_integer_for_list_indices
    import aws_sdk_qbusiness.types.next_token


class ListIndicesRequest(TypedDict):
    ...
    max_results: NotRequired[
        "aws_sdk_qbusiness.types.max_results_integer_for_list_indices.MaxResultsIntegerForListIndices"
    ]
