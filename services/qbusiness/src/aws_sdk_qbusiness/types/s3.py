...
if TYPE_CHECKING:
    ...
    import aws_sdk_qbusiness.types.s3_object_key


class S3(TypedDict, closed=True):
    bucket: "aws_sdk_qbusiness.types.s3_bucket_name.S3BucketName"
    """<p>The name of the S3 bucket that contains the file.</p>"""
    key: "aws_sdk_qbusiness.types.s3_object_key.S3ObjectKey"
