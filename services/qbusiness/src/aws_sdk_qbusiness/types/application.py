...
class Application(TypedDict):
    display_name: NotRequired["aws_sdk_qbusiness.types.application_name.ApplicationName"]
    ...
    quick_sight_configuration: NotRequired["aws_sdk_qbusiness.types.quick_sight_configuration.QuickSightConfiguration"]
...
def serialize_json(value: Application) -> dict:
    ...
    if "status" in value:
        import aws_sdk_qbusiness.types.application_status
        out["status"] = aws_sdk_qbusiness.types.application_status.serialize_json(value["status"])
    if "identity_type" in value:
        import aws_sdk_qbusiness.types.identity_type
        out["identityType"] = aws_sdk_qbusiness.types.identity_type.serialize_json(value["identity_type"])
    if "quick_sight_configuration" in value:
        import aws_sdk_qbusiness.types.quick_sight_configuration
        out["quickSightConfiguration"] = aws_sdk_qbusiness.types.quick_sight_configuration.serialize_json(value["quick_sight_configuration"])
    return out
...
def deserialize_json(data: dict) -> Application:
    ...
    if "status" in data:
        import aws_sdk_qbusiness.types.application_status
        out["status"] = aws_sdk_qbusiness.types.application_status.deserialize_json(data["status"])
    if "identityType" in data:
        import aws_sdk_qbusiness.types.identity_type
        out["identity_type"] = aws_sdk_qbusiness.types.identity_type.deserialize_json(data["identityType"])
    if "quickSightConfiguration" in data:
        import aws_sdk_qbusiness.types.quick_sight_configuration
        out["quick_sight_configuration"] = aws_sdk_qbusiness.types.quick_sight_configuration.deserialize_json(data["quickSightConfiguration"])
    return out