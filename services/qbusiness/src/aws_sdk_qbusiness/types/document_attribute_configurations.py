...
DocumentAttributeConfigurations: TypeAlias = list[
    "aws_sdk_qbusiness.types.document_attribute_configuration.DocumentAttributeConfiguration"
]
...
def serialize_json(value: DocumentAttributeConfigurations) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_qbusiness.types.document_attribute_configuration.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> DocumentAttributeConfigurations:
    ...
    for item in data:
        out.append(
            aws_sdk_qbusiness.types.document_attribute_configuration.deserialize_json(
                item
            )
        )
    return out
