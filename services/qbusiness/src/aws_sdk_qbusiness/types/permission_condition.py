...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.permission_condition_key
    import aws_sdk_qbusiness.types.permission_condition_operator
...
class PermissionCondition(TypedDict, closed=True):
    ...
    condition_key: (
        "aws_sdk_qbusiness.types.permission_condition_key.PermissionConditionKey"
    )
    """<p>The key for the condition. This identifies the attribute that the condition applies to.</p>"""
    condition_values: (
        "aws_sdk_qbusiness.types.permission_condition_values.PermissionConditionValues"
    )
...
def serialize_json(value: PermissionCondition) -> dict:
    ...
    out["conditionOperator"] = (
        aws_sdk_qbusiness.types.permission_condition_operator.serialize_json(
    ...
    out["conditionValues"] = (
        aws_sdk_qbusiness.types.permission_condition_values.serialize_json(
...
def deserialize_json(data: dict) -> PermissionCondition:
    ...
    if "conditionOperator" in data:
        ...
        out["condition_operator"] = (
            aws_sdk_qbusiness.types.permission_condition_operator.deserialize_json(
    ...
    if "conditionValues" in data:
        ...
        out["condition_values"] = (
            aws_sdk_qbusiness.types.permission_condition_values.deserialize_json(
