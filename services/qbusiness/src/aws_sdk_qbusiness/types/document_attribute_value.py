...
if TYPE_CHECKING:
    import aws_sdk_qbusiness.types.document_attribute_string_list_value
    import aws_sdk_qbusiness.types.timestamp
    import aws_sdk_qbusiness.types.long
    import aws_sdk_qbusiness.types.document_attribute_string_value
...
DocumentAttributeValue: TypeAlias = _DocumentAttributeValue_stringValue | _DocumentAttributeValue_stringListValue | _DocumentAttributeValue_longValue | _DocumentAttributeValue_dateValue
...
def serialize_json(value: DocumentAttributeValue) -> dict:
    if "stringValue" in value:
        ...
        import aws_sdk_qbusiness.types.document_attribute_string_list_value
        return {"stringListValue": aws_sdk_qbusiness.types.document_attribute_string_list_value.serialize_json(value["stringListValue"])}
    elif "longValue" in value:
        return {"longValue": value["longValue"]}
    elif "dateValue" in value:
        import aws_sdk_qbusiness.types.timestamp
        return {"dateValue": aws_sdk_qbusiness.types.timestamp.serialize_json(value["dateValue"])}
    else:
...
def deserialize_json(data: dict) -> DocumentAttributeValue:
    if "stringValue" in data:
        ...
        import aws_sdk_qbusiness.types.document_attribute_string_list_value
        return {"stringListValue": aws_sdk_qbusiness.types.document_attribute_string_list_value.deserialize_json(data["stringListValue"])}
    elif "longValue" in data:
        return {"longValue": data["longValue"]}
    elif "dateValue" in data:
        import aws_sdk_qbusiness.types.timestamp
        return {"dateValue": aws_sdk_qbusiness.types.timestamp.deserialize_json(data["dateValue"])}
    else:
