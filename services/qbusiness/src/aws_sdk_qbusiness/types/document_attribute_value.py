...
def serialize_json(value: DocumentAttributeValue) -> dict:
    if "stringValue" in value:
        ...
        return {
            "stringListValue": aws_sdk_qbusiness.types.document_attribute_string_list_value.serialize_json(
        ...
        return {
            "dateValue": aws_sdk_qbusiness.types.timestamp.serialize_json(
                value["dateValue"]
            )
        }
    else:
...
def deserialize_json(data: dict) -> DocumentAttributeValue:
    if "stringValue" in data:
        ...
        return {
            "stringListValue": aws_sdk_qbusiness.types.document_attribute_string_list_value.deserialize_json(
        ...
        return {
            "dateValue": aws_sdk_qbusiness.types.timestamp.deserialize_json(
                data["dateValue"]
            )
        }
    else:
