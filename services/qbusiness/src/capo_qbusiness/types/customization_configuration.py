...
if TYPE_CHECKING:
    import capo_qbusiness.types.custom_css_url
    import capo_qbusiness.types.favicon_url
    import capo_qbusiness.types.font_url
    import capo_qbusiness.types.logo_url


class CustomizationConfiguration(TypedDict, closed=True):
    custom_css_url: NotRequired["capo_qbusiness.types.custom_css_url.CustomCSSUrl"]
    """<p>Provides the URL where the custom CSS file is hosted for an Amazon Q web experience.</p>"""
    logo_url: NotRequired["capo_qbusiness.types.logo_url.LogoUrl"]
    """<p>Provides the URL where the custom logo file is hosted for an Amazon Q web experience.</p>"""
    font_url: NotRequired["capo_qbusiness.types.font_url.FontUrl"]
    """<p>Provides the URL where the custom font file is hosted for an Amazon Q web experience.</p>"""
    favicon_url: NotRequired["capo_qbusiness.types.favicon_url.FaviconUrl"]
