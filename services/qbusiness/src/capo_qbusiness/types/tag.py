...
if TYPE_CHECKING:
    import capo_qbusiness.types.tag_key
    import capo_qbusiness.types.tag_value


class Tag(TypedDict, closed=True):
    key: "capo_qbusiness.types.tag_key.TagKey"
    ...
    value: "capo_qbusiness.types.tag_value.TagValue"
