...
class OAuth2ClientCredentialConfiguration(TypedDict, closed=True):
    ...
    authorization_url: NotRequired["capo_qbusiness.types.url.Url"]
    ...
    token_url: NotRequired["capo_qbusiness.types.url.Url"]
