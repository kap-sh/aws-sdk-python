"""Generated from Smithy shape ``com.amazonaws.qbusiness#CancelSubscriptionResponse``."""
...
class CancelSubscriptionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CancelSubscriptionResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CancelSubscriptionResponse:
    out: CancelSubscriptionResponse = {}  # type: ignore[typeddict-item]
