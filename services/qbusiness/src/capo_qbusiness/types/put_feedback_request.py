...
class PutFeedbackRequest(TypedDict, closed=True):
    ...
    message_copied_at: NotRequired["capo_qbusiness.types.timestamp.Timestamp"]
...
def serialize_json(value: PutFeedbackRequest) -> dict:
    ...
    if "message_copied_at" in value:
        ...
        out["messageCopiedAt"] = capo_qbusiness.types.timestamp.serialize_json(
    ...
    if "message_usefulness" in value:
        ...
        out["messageUsefulness"] = (
            capo_qbusiness.types.message_usefulness_feedback.serialize_json(
...
def deserialize_json(data: dict) -> PutFeedbackRequest:
    ...
    if "messageUsefulness" in data:
        ...
        out["message_usefulness"] = (
            capo_qbusiness.types.message_usefulness_feedback.deserialize_json(
