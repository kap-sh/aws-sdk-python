...
def handle_response(
    ...
    out: capo_qbusiness.types.delete_index_response.DeleteIndexResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_index(
    ...
    capo_qbusiness.types.delete_index_response.DeleteIndexResponse, zapros.Response
]:
