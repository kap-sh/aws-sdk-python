...
import capo_qbusiness.types.retrievers
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_retrievers_response.ListRetrieversResponse = (
        capo_qbusiness.types.list_retrievers_response.deserialize_json(
