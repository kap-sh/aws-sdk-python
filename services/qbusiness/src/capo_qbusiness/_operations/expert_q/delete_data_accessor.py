"""Generated from Smithy shape ``com.amazonaws.qbusiness#DeleteDataAccessor``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.delete_data_accessor_response.DeleteDataAccessorResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_data_accessor(
