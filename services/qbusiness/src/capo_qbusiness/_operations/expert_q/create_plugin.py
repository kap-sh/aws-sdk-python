...
import capo_qbusiness.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_qbusiness.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_qbusiness.types.create_plugin_response.CreatePluginResponse = (
        capo_qbusiness.types.create_plugin_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.create_plugin_request.serialize_json(input_)
    ).encode()
...
def create_plugin(
    ...
    capo_qbusiness.types.create_plugin_response.CreatePluginResponse, zapros.Response
]:
