"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetGroup``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.get_group_response.GetGroupResponse = (
        capo_qbusiness.types.get_group_response.deserialize_json(
...
def get_group(
    ...
    input_: capo_qbusiness.types.get_group_request.GetGroupRequest,
) -> tuple[capo_qbusiness.types.get_group_response.GetGroupResponse, zapros.Response]:
