...
def handle_response(
    ...
    out: capo_qbusiness.types.create_subscription_response.CreateSubscriptionResponse = capo_qbusiness.types.create_subscription_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.create_subscription_request.serialize_json(input_)
    ).encode()
