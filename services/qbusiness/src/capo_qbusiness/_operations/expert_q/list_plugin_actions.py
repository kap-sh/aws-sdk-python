"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListPluginActions``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_plugin_actions_response.ListPluginActionsResponse = (
        capo_qbusiness.types.list_plugin_actions_response.deserialize_json(
...
async def async_list_plugin_actions(
