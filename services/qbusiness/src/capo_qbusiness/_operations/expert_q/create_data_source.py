"""Generated from Smithy shape ``com.amazonaws.qbusiness#CreateDataSource``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.create_data_source_response.CreateDataSourceResponse = (
        capo_qbusiness.types.create_data_source_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.create_data_source_request.serialize_json(input_)
    ).encode()
