...
def handle_response(
    ...
    out: capo_qbusiness.types.update_subscription_response.UpdateSubscriptionResponse = capo_qbusiness.types.update_subscription_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.update_subscription_request.serialize_json(input_)
    ).encode()
