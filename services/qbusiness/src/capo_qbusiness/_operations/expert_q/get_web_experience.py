"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetWebExperience``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.get_web_experience_response.GetWebExperienceResponse = (
        capo_qbusiness.types.get_web_experience_response.deserialize_json(
...
async def async_get_web_experience(
