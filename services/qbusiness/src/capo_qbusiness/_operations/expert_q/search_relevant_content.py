...
def handle_response(
    ...
    out: capo_qbusiness.types.search_relevant_content_response.SearchRelevantContentResponse = capo_qbusiness.types.search_relevant_content_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.search_relevant_content_request.serialize_json(input_)
    ).encode()
