...
def handle_response(
    ...
    out: capo_qbusiness.types.batch_put_document_response.BatchPutDocumentResponse = (
        capo_qbusiness.types.batch_put_document_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.batch_put_document_request.serialize_json(input_)
    ).encode()
