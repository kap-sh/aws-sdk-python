...
def handle_response(
    ...
    out: capo_qbusiness.types.update_data_accessor_response.UpdateDataAccessorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.update_data_accessor_request.serialize_json(input_)
    ).encode()
