"""Generated from Smithy shape ``com.amazonaws.qbusiness#UpdateWebExperience``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.update_web_experience_response.UpdateWebExperienceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.update_web_experience_request.serialize_json(input_)
    ).encode()
...
async def async_update_web_experience(
