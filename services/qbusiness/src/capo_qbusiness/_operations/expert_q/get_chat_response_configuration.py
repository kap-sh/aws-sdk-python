...
def handle_response(
    ...
    out: capo_qbusiness.types.get_chat_response_configuration_response.GetChatResponseConfigurationResponse = capo_qbusiness.types.get_chat_response_configuration_response.deserialize_json(
