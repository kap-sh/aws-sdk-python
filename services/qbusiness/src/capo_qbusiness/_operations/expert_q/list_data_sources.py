"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListDataSources``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_data_sources_response.ListDataSourcesResponse = (
        capo_qbusiness.types.list_data_sources_response.deserialize_json(
