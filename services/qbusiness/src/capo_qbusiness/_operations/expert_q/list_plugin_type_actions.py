...
import capo_qbusiness.types.actions
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_plugin_type_actions_response.ListPluginTypeActionsResponse = capo_qbusiness.types.list_plugin_type_actions_response.deserialize_json(
