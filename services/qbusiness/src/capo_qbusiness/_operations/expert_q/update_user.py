...
def handle_response(
    ...
    out: capo_qbusiness.types.update_user_response.UpdateUserResponse = (
        capo_qbusiness.types.update_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.update_user_request.serialize_json(input_)
    ).encode()
...
def update_user(
    ...
    capo_qbusiness.types.update_user_response.UpdateUserResponse, zapros.Response
]:
