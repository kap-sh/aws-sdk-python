"""Generated from Smithy shape ``com.amazonaws.qbusiness#DeleteConversation``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.delete_conversation_response.DeleteConversationResponse = {}  # type: ignore[typeddict-item]
    return out
