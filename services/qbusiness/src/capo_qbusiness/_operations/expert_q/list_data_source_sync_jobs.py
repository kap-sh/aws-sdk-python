...
def handle_response(
    ...
    out: capo_qbusiness.types.list_data_source_sync_jobs_response.ListDataSourceSyncJobsResponse = capo_qbusiness.types.list_data_source_sync_jobs_response.deserialize_json(
