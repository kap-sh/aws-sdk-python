"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_qbusiness.types.list_tags_for_resource_response.deserialize_json(
