"""Generated from Smithy shape ``com.amazonaws.qbusiness#UpdateIndex``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.update_index_response.UpdateIndexResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.update_index_request.serialize_json(input_)
    ).encode()
...
def update_index(
    ...
    capo_qbusiness.types.update_index_response.UpdateIndexResponse, zapros.Response
]:
