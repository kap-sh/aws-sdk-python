...
def handle_response(
    ...
    out: capo_qbusiness.types.associate_permission_response.AssociatePermissionResponse = capo_qbusiness.types.associate_permission_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.associate_permission_request.serialize_json(input_)
    ).encode()
