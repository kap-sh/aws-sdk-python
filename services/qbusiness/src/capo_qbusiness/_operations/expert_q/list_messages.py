"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListMessages``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_messages_response.ListMessagesResponse = (
        capo_qbusiness.types.list_messages_response.deserialize_json(
...
def list_messages(
    ...
    capo_qbusiness.types.list_messages_response.ListMessagesResponse, zapros.Response
]:
