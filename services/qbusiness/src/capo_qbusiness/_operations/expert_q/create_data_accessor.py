...
def handle_response(
    ...
    out: capo_qbusiness.types.create_data_accessor_response.CreateDataAccessorResponse = capo_qbusiness.types.create_data_accessor_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.create_data_accessor_request.serialize_json(input_)
    ).encode()
