"""Generated from Smithy shape ``com.amazonaws.qbusiness#DeleteUser``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.delete_user_response.DeleteUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_user(
    ...
    capo_qbusiness.types.delete_user_response.DeleteUserResponse, zapros.Response
]:
