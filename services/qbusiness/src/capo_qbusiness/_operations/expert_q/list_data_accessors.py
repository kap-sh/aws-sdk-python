"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListDataAccessors``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_data_accessors_response.ListDataAccessorsResponse = (
        capo_qbusiness.types.list_data_accessors_response.deserialize_json(
...
async def async_list_data_accessors(
