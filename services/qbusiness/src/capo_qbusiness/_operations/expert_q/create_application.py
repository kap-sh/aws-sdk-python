"""Generated from Smithy shape ``com.amazonaws.qbusiness#CreateApplication``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.create_application_response.CreateApplicationResponse = (
        capo_qbusiness.types.create_application_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.create_application_request.serialize_json(input_)
    ).encode()
