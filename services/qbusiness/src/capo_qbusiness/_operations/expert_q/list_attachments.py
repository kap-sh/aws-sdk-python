"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListAttachments``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_attachments_response.ListAttachmentsResponse = (
        capo_qbusiness.types.list_attachments_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{applicationId}/attachments"
