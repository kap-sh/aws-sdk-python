"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListChatResponseConfigurations``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_chat_response_configurations_response.ListChatResponseConfigurationsResponse = capo_qbusiness.types.list_chat_response_configurations_response.deserialize_json(
...
async def async_list_chat_response_configurations(
