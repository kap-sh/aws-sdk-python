"""Generated from Smithy shape ``com.amazonaws.qbusiness#PutGroup``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.put_group_response.PutGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.put_group_request.serialize_json(input_)
    ).encode()
...
def put_group(
    ...
    input_: capo_qbusiness.types.put_group_request.PutGroupRequest,
) -> tuple[capo_qbusiness.types.put_group_response.PutGroupResponse, zapros.Response]:
