"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetIndex``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.get_index_response.GetIndexResponse = (
        capo_qbusiness.types.get_index_response.deserialize_json(
...
def get_index(
    ...
    input_: capo_qbusiness.types.get_index_request.GetIndexRequest,
) -> tuple[capo_qbusiness.types.get_index_response.GetIndexResponse, zapros.Response]:
