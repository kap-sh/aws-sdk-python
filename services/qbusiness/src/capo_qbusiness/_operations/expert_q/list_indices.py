"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListIndices``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_indices_response.ListIndicesResponse = (
        capo_qbusiness.types.list_indices_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{applicationId}/indices"
...
def list_indices(
    ...
    capo_qbusiness.types.list_indices_response.ListIndicesResponse, zapros.Response
]:
