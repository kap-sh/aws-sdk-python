"""Generated from Smithy shape ``com.amazonaws.qbusiness#CreateChatResponseConfiguration``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.create_chat_response_configuration_response.CreateChatResponseConfigurationResponse = capo_qbusiness.types.create_chat_response_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.create_chat_response_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_chat_response_configuration(
