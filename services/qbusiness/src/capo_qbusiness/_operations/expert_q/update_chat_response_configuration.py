...
def handle_response(
    ...
    out: capo_qbusiness.types.update_chat_response_configuration_response.UpdateChatResponseConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.update_chat_response_configuration_request.serialize_json(
            input_
        )
    ).encode()
