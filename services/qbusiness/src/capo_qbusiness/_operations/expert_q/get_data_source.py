...
def handle_response(
    ...
    out: capo_qbusiness.types.get_data_source_response.GetDataSourceResponse = (
        capo_qbusiness.types.get_data_source_response.deserialize_json(
...
def get_data_source(
    ...
    capo_qbusiness.types.get_data_source_response.GetDataSourceResponse, zapros.Response
]:
