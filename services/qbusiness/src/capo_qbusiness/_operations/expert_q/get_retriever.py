"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetRetriever``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.get_retriever_response.GetRetrieverResponse = (
        capo_qbusiness.types.get_retriever_response.deserialize_json(
...
def get_retriever(
    ...
    capo_qbusiness.types.get_retriever_response.GetRetrieverResponse, zapros.Response
]:
