"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListWebExperiences``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_web_experiences_response.ListWebExperiencesResponse = capo_qbusiness.types.list_web_experiences_response.deserialize_json(
...
async def async_list_web_experiences(
