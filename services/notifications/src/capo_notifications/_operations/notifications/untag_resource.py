"""Generated from Smithy shape ``com.amazonaws.notifications#UntagResource``."""
...
def handle_response(
    ...
    out: capo_notifications.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
