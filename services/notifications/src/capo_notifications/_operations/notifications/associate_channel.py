...
def handle_response(
    ...
    out: capo_notifications.types.associate_channel_response.AssociateChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_notifications.types.associate_channel_request.serialize_json(input_)
    ).encode()
