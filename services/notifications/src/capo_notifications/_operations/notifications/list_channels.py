"""Generated from Smithy shape ``com.amazonaws.notifications#ListChannels``."""
...
def handle_response(
    ...
    out: capo_notifications.types.list_channels_response.ListChannelsResponse = (
        capo_notifications.types.list_channels_response.deserialize_json(
