"""Generated from Smithy shape ``com.amazonaws.notifications#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_notifications.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_notifications.types.list_tags_for_resource_response.deserialize_json(
