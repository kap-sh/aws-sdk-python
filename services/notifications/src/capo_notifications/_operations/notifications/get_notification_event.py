"""Generated from Smithy shape ``com.amazonaws.notifications#GetNotificationEvent``."""
...
import capo_notifications.types.notification_event_schema
...
def handle_response(
    ...
    out: capo_notifications.types.get_notification_event_response.GetNotificationEventResponse = capo_notifications.types.get_notification_event_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/notification-events/{arn}"
...
async def async_get_notification_event(
