"""Generated from Smithy shape ``com.amazonaws.notifications#GetManagedNotificationConfiguration``."""
...
def handle_response(
    ...
    out: capo_notifications.types.get_managed_notification_configuration_response.GetManagedNotificationConfigurationResponse = capo_notifications.types.get_managed_notification_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/managed-notification-configurations/{arn}"
...
async def async_get_managed_notification_configuration(
