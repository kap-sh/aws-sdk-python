"""Generated from Smithy shape ``com.amazonaws.notifications#GetNotificationConfiguration``."""
...
def handle_response(
    ...
    out: capo_notifications.types.get_notification_configuration_response.GetNotificationConfigurationResponse = capo_notifications.types.get_notification_configuration_response.deserialize_json(
