"""Generated from Smithy shape ``com.amazonaws.notifications#ListManagedNotificationConfigurations``."""
...
def handle_response(
    ...
    out: capo_notifications.types.list_managed_notification_configurations_response.ListManagedNotificationConfigurationsResponse = capo_notifications.types.list_managed_notification_configurations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/managed-notification-configurations"
    params: dict[str, str] = {}
    if "channel_identifier" in input_:
        params["channelIdentifier"] = str(input_["channel_identifier"])
...
async def async_list_managed_notification_configurations(
