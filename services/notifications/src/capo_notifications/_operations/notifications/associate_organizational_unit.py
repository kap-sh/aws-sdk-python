"""Generated from Smithy shape ``com.amazonaws.notifications#AssociateOrganizationalUnit``."""
...
def handle_response(
    ...
    out: capo_notifications.types.associate_organizational_unit_response.AssociateOrganizationalUnitResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_notifications.types.associate_organizational_unit_request.serialize_json(
            input_
        )
    ).encode()
