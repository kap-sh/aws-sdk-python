"""Generated from Smithy shape ``com.amazonaws.notifications#GetEventRule``."""
...
def handle_response(
    ...
    out: capo_notifications.types.get_event_rule_response.GetEventRuleResponse = (
        capo_notifications.types.get_event_rule_response.deserialize_json(
...
async def async_get_event_rule(
