"""Generated from Smithy shape ``com.amazonaws.notifications#DisableNotificationsAccessForOrganization``."""
...
def handle_response(
    ...
    out: capo_notifications.types.disable_notifications_access_for_organization_response.DisableNotificationsAccessForOrganizationResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disable_notifications_access_for_organization(
