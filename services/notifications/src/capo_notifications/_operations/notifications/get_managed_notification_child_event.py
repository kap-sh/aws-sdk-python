"""Generated from Smithy shape ``com.amazonaws.notifications#GetManagedNotificationChildEvent``."""
...
def handle_response(
    ...
    out: capo_notifications.types.get_managed_notification_child_event_response.GetManagedNotificationChildEventResponse = capo_notifications.types.get_managed_notification_child_event_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/managed-notification-child-events/{arn}"
...
async def async_get_managed_notification_child_event(
