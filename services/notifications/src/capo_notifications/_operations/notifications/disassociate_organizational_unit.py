"""Generated from Smithy shape ``com.amazonaws.notifications#DisassociateOrganizationalUnit``."""
...
def handle_response(
    ...
    out: capo_notifications.types.disassociate_organizational_unit_response.DisassociateOrganizationalUnitResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_notifications.types.disassociate_organizational_unit_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_disassociate_organizational_unit(
