...
def handle_response(
    ...
    out: capo_notifications.types.create_event_rule_response.CreateEventRuleResponse = (
        capo_notifications.types.create_event_rule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_notifications.types.create_event_rule_request.serialize_json(input_)
    ).encode()
