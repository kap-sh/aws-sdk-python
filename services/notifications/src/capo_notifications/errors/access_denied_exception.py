"""Generated from Smithy shape ``com.amazonaws.notifications#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.notifications#AccessDeniedException``."""
