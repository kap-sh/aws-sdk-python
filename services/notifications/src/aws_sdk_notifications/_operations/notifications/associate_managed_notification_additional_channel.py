"""Generated from Smithy shape ``com.amazonaws.notifications#AssociateManagedNotificationAdditionalChannel``."""
...
import aws_sdk_notifications.errors.conflict_exception
import aws_sdk_notifications.errors.internal_server_exception
import aws_sdk_notifications.errors.resource_not_found_exception
import aws_sdk_notifications.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_notifications.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ResourceNotFoundException":
            raise aws_sdk_notifications.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
        case "ServiceQuotaExceededException":
            raise aws_sdk_notifications.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_notifications.types.associate_managed_notification_additional_channel_response.AssociateManagedNotificationAdditionalChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.associate_managed_notification_additional_channel_request.AssociateManagedNotificationAdditionalChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_notifications.types.associate_managed_notification_additional_channel_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_associate_managed_notification_additional_channel(
