...
def handle_response(
    ...
    out: aws_sdk_notifications.types.disassociate_channel_response.DisassociateChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.disassociate_channel_request.DisassociateChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_notifications.types.disassociate_channel_request.serialize_json(input_)
    ).encode()
