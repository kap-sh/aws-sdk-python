...
def build_request(
    ...
    input: aws_sdk_notifications.types.disassociate_channel_request.DisassociateChannelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_notifications.types.disassociate_channel_request.serialize_json(input)
    ).encode()
