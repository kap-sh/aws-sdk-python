...
def handle_response(
    ...
    out: aws_sdk_notifications.types.list_managed_notification_channel_associations_response.ListManagedNotificationChannelAssociationsResponse = aws_sdk_notifications.types.list_managed_notification_channel_associations_response.deserialize_json(
