...
def build_request(
    ...
    input_: aws_sdk_notifications.types.list_notification_events_request.ListNotificationEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "include_child_events" in input_:
        params["includeChildEvents"] = str(input_["include_child_events"])
