...
def handle_response(
    ...
    out: aws_sdk_notifications.types.list_notification_events_response.ListNotificationEventsResponse = aws_sdk_notifications.types.list_notification_events_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_notifications.types.list_notification_events_request.ListNotificationEventsRequest,
) -> zapros.Request:
    ...
    if "include_child_events" in input:
        params["includeChildEvents"] = str(input["include_child_events"])
    if "aggregate_notification_event_arn" in input:
        params["aggregateNotificationEventArn"] = str(
            input["aggregate_notification_event_arn"]
        )
