...
def handle_response(
    ...
    out: aws_sdk_notifications.types.get_managed_notification_configuration_response.GetManagedNotificationConfigurationResponse = aws_sdk_notifications.types.get_managed_notification_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.get_managed_notification_configuration_request.GetManagedNotificationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
