...
def handle_response(
    ...
    out: aws_sdk_notifications.types.list_notification_hubs_response.ListNotificationHubsResponse = aws_sdk_notifications.types.list_notification_hubs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.list_notification_hubs_request.ListNotificationHubsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
