"""Generated from Smithy shape ``com.amazonaws.notifications#DeregisterNotificationHub``."""
...
def handle_response(
    ...
    out: aws_sdk_notifications.types.deregister_notification_hub_response.DeregisterNotificationHubResponse = aws_sdk_notifications.types.deregister_notification_hub_response.deserialize_json(
