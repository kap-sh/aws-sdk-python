"""Generated from Smithy shape ``com.amazonaws.notifications#DisassociateManagedNotificationAccountContact``."""
...
def handle_response(
    ...
    out: aws_sdk_notifications.types.disassociate_managed_notification_account_contact_response.DisassociateManagedNotificationAccountContactResponse = {}  # type: ignore[typeddict-item]
    return out
