"""Generated from Smithy shape ``com.amazonaws.notifications#ListEventRules``."""
...
def handle_response(
    ...
    out: aws_sdk_notifications.types.list_event_rules_response.ListEventRulesResponse = aws_sdk_notifications.types.list_event_rules_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_notifications.types.list_event_rules_request.ListEventRulesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "notification_configuration_arn" in input:
        params["notificationConfigurationArn"] = str(
            input["notification_configuration_arn"]
        )
...
async def async_list_event_rules(
