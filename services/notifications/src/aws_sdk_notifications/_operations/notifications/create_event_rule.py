...
def build_request(
    ...
    input: aws_sdk_notifications.types.create_event_rule_request.CreateEventRuleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_notifications.types.create_event_rule_request.serialize_json(input)
    ).encode()
