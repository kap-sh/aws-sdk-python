"""Generated from Smithy shape ``com.amazonaws.notifications#CreateEventRule``."""
...
def handle_response(
    ...
    out: aws_sdk_notifications.types.create_event_rule_response.CreateEventRuleResponse = aws_sdk_notifications.types.create_event_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.create_event_rule_request.CreateEventRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/event-rules"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_notifications.types.create_event_rule_request

    body: bytes | None = json.dumps(
        aws_sdk_notifications.types.create_event_rule_request.serialize_json(input_)
    ).encode()
...
async def async_create_event_rule(
