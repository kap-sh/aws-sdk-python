...
def handle_response(
    ...
    out: aws_sdk_notifications.types.update_event_rule_response.UpdateEventRuleResponse = aws_sdk_notifications.types.update_event_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.update_event_rule_request.UpdateEventRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_notifications.types.update_event_rule_request.serialize_json(input_)
    ).encode()
