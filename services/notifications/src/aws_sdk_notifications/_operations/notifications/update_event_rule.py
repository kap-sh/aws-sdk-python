...
def build_request(
    ...
    input: aws_sdk_notifications.types.update_event_rule_request.UpdateEventRuleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_notifications.types.update_event_rule_request.serialize_json(input)
    ).encode()
