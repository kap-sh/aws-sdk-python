"""Generated from Smithy shape ``com.amazonaws.notifications#RegisterNotificationHub``."""
...
def handle_response(
    ...
    out: aws_sdk_notifications.types.register_notification_hub_response.RegisterNotificationHubResponse = aws_sdk_notifications.types.register_notification_hub_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.register_notification_hub_request.RegisterNotificationHubRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_notifications.types.register_notification_hub_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_register_notification_hub(
