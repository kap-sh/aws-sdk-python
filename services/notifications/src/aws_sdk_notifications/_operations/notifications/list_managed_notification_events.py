"""Generated from Smithy shape ``com.amazonaws.notifications#ListManagedNotificationEvents``."""
...
def handle_response(
    ...
    out: aws_sdk_notifications.types.list_managed_notification_events_response.ListManagedNotificationEventsResponse = aws_sdk_notifications.types.list_managed_notification_events_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_notifications.types.list_managed_notification_events_request.ListManagedNotificationEventsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/managed-notification-events"
    params: dict[str, str] = {}
...
async def async_list_managed_notification_events(
