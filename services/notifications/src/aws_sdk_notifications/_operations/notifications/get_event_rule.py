...
def handle_response(
    ...
    out: aws_sdk_notifications.types.get_event_rule_response.GetEventRuleResponse = (
        aws_sdk_notifications.types.get_event_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.get_event_rule_request.GetEventRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
