...
def handle_response(
    ...
    out: aws_sdk_notifications.types.list_member_accounts_response.ListMemberAccountsResponse = aws_sdk_notifications.types.list_member_accounts_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_notifications.types.list_member_accounts_request.ListMemberAccountsRequest,
) -> zapros.Request:
    ...
    if "member_account" in input:
        params["memberAccount"] = str(input["member_account"])
    if "status" in input:
