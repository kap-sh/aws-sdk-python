...
def handle_response(
    ...
    out: aws_sdk_notifications.types.delete_event_rule_response.DeleteEventRuleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.delete_event_rule_request.DeleteEventRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
