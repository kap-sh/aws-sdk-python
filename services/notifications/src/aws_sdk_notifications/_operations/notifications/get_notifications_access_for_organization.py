"""Generated from Smithy shape ``com.amazonaws.notifications#GetNotificationsAccessForOrganization``."""
...
def handle_response(
    ...
    out: aws_sdk_notifications.types.get_notifications_access_for_organization_response.GetNotificationsAccessForOrganizationResponse = aws_sdk_notifications.types.get_notifications_access_for_organization_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.get_notifications_access_for_organization_request.GetNotificationsAccessForOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_notifications_access_for_organization(
