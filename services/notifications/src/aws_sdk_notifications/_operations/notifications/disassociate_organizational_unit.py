...
def handle_response(
    ...
    out: aws_sdk_notifications.types.disassociate_organizational_unit_response.DisassociateOrganizationalUnitResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.disassociate_organizational_unit_request.DisassociateOrganizationalUnitRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_notifications.types.disassociate_organizational_unit_request.serialize_json(
            input_
        )
    ).encode()
