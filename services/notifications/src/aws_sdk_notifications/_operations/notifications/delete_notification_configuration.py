"""Generated from Smithy shape ``com.amazonaws.notifications#DeleteNotificationConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_notifications.types.delete_notification_configuration_response.DeleteNotificationConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.delete_notification_configuration_request.DeleteNotificationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_notification_configuration(
