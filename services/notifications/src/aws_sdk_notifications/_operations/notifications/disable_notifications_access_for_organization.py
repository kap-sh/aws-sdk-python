...
def handle_response(
    ...
    out: aws_sdk_notifications.types.disable_notifications_access_for_organization_response.DisableNotificationsAccessForOrganizationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.disable_notifications_access_for_organization_request.DisableNotificationsAccessForOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
