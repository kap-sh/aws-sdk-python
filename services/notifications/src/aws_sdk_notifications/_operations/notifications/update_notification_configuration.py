"""Generated from Smithy shape ``com.amazonaws.notifications#UpdateNotificationConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_notifications.types.update_notification_configuration_response.UpdateNotificationConfigurationResponse = aws_sdk_notifications.types.update_notification_configuration_response.deserialize_json(
