...
def handle_response(
    ...
    out: aws_sdk_notifications.types.list_organizational_units_response.ListOrganizationalUnitsResponse = aws_sdk_notifications.types.list_organizational_units_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.list_organizational_units_request.ListOrganizationalUnitsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
