"""Generated from Smithy shape ``com.amazonaws.notifications#DisassociateManagedNotificationAdditionalChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_notifications.types.disassociate_managed_notification_additional_channel_response.DisassociateManagedNotificationAdditionalChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.disassociate_managed_notification_additional_channel_request.DisassociateManagedNotificationAdditionalChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disassociate_managed_notification_additional_channel(
