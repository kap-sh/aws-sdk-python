...
def handle_response(
    ...
    out: aws_sdk_notifications.types.get_managed_notification_child_event_response.GetManagedNotificationChildEventResponse = aws_sdk_notifications.types.get_managed_notification_child_event_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.get_managed_notification_child_event_request.GetManagedNotificationChildEventRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
