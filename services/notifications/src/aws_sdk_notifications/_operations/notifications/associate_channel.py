"""Generated from Smithy shape ``com.amazonaws.notifications#AssociateChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_notifications.types.associate_channel_response.AssociateChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.associate_channel_request.AssociateChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/channels/associate/{arn}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_notifications.types.associate_channel_request.serialize_json(input_)
    ).encode()
...
async def async_associate_channel(
