...
def handle_response(
    ...
    out: aws_sdk_notifications.types.list_managed_notification_configurations_response.ListManagedNotificationConfigurationsResponse = aws_sdk_notifications.types.list_managed_notification_configurations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_notifications.types.list_managed_notification_configurations_request.ListManagedNotificationConfigurationsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "channel_identifier" in input:
        params["channelIdentifier"] = str(input["channel_identifier"])
