"""Generated from Smithy shape ``com.amazonaws.notifications#GetManagedNotificationEvent``."""
...
def handle_response(
    ...
    out: aws_sdk_notifications.types.get_managed_notification_event_response.GetManagedNotificationEventResponse = aws_sdk_notifications.types.get_managed_notification_event_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_notifications.types.get_managed_notification_event_request.GetManagedNotificationEventRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/managed-notification-events/{arn}"
...
async def async_get_managed_notification_event(
