...
def handle_response(
    ...
    out: aws_sdk_notifications.types.get_notification_event_response.GetNotificationEventResponse = aws_sdk_notifications.types.get_notification_event_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_notifications.types.get_notification_event_request.GetNotificationEventRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
