...
class ManagedNotificationEventResource:
    ...
    def read(
        ...
        *,
        ...
        input: aws_sdk_notifications.types.get_managed_notification_event_request.GetManagedNotificationEventRequest = {}  # type: ignore[typeddict-item]
        input["arn"] = arn
    ...
    def list(
        ...
        *,
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_notifications.types.list_managed_notification_events_request.ListManagedNotificationEventsRequest = {}  # type: ignore[typeddict-item]
