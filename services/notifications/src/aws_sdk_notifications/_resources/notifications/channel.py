...
class Channel:
    ...
    def put(
        ...
        *,
        ...
        input: aws_sdk_notifications.types.associate_channel_request.AssociateChannelRequest = {}  # type: ignore[typeddict-item]
        input["arn"] = arn
    ...
    def delete(
        ...
        *,
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_notifications.types.disassociate_channel_request.DisassociateChannelRequest = {}  # type: ignore[typeddict-item]
        input["arn"] = arn
        input["notification_configuration_arn"] = notification_configuration_arn
    ...
    def list(
        ...
        *,
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_notifications.types.list_channels_request.ListChannelsRequest = {}  # type: ignore[typeddict-item]
        input["notification_configuration_arn"] = notification_configuration_arn
