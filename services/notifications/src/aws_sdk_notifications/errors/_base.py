...
class NotificationsError(Exception):
    """Base class for all Notifications service errors."""


class ServiceError(NotificationsError):
...
class SerializationError(NotificationsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(NotificationsError):
...
class WaiterFailedError(NotificationsError):
...
class WaiterTimeoutError(NotificationsError):
