...
class ListNotificationEventsResponse(TypedDict):
    ...
    notification_events: "aws_sdk_notifications.types.notification_events.NotificationEvents"
...
def serialize_json(value: ListNotificationEventsResponse) -> dict:
    ...
    import aws_sdk_notifications.types.notification_events
    out["notificationEvents"] = aws_sdk_notifications.types.notification_events.serialize_json(value["notification_events"])
    return out
...
def deserialize_json(data: dict) -> ListNotificationEventsResponse:
    ...
    if "notificationEvents" in data:
        import aws_sdk_notifications.types.notification_events
        out["notification_events"] = aws_sdk_notifications.types.notification_events.deserialize_json(data["notificationEvents"])
    else:
        raise DeserializationError("ListNotificationEventsResponse.notification_events required")
    return out