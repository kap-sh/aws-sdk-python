...
class DisassociateManagedNotificationAdditionalChannelRequest(TypedDict):
...
# --- restJson1 ser/de ---
def serialize_json(value: DisassociateManagedNotificationAdditionalChannelRequest) -> dict:
    out: dict = {}
    out["managedNotificationConfigurationArn"] = value["managed_notification_configuration_arn"]
    return out


def deserialize_json(data: dict) -> DisassociateManagedNotificationAdditionalChannelRequest:
    ...
    if "managedNotificationConfigurationArn" in data:
        ...
        raise DeserializationError("DisassociateManagedNotificationAdditionalChannelRequest.managed_notification_configuration_arn required")
    return out