...
def deserialize_json(data: dict) -> DisassociateManagedNotificationAccountContactRequest:
    ...
    if "managedNotificationConfigurationArn" in data:
        ...
        raise DeserializationError("DisassociateManagedNotificationAccountContactRequest.managed_notification_configuration_arn required")
    return out