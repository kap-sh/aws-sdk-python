...
class ListOrganizationalUnitsResponse(TypedDict):
    organizational_units: "aws_sdk_notifications.types.organizational_units.OrganizationalUnits"
...
def serialize_json(value: ListOrganizationalUnitsResponse) -> dict:
    out: dict = {}
    import aws_sdk_notifications.types.organizational_units
    out["organizationalUnits"] = aws_sdk_notifications.types.organizational_units.serialize_json(value["organizational_units"])
...
def deserialize_json(data: dict) -> ListOrganizationalUnitsResponse:
    ...
    if "organizationalUnits" in data:
        import aws_sdk_notifications.types.organizational_units
        out["organizational_units"] = aws_sdk_notifications.types.organizational_units.deserialize_json(data["organizationalUnits"])
    else:
        raise DeserializationError("ListOrganizationalUnitsResponse.organizational_units required")
