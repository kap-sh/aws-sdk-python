...
def serialize_json(value: ListEventRulesResponse) -> dict:
    ...
    import aws_sdk_notifications.types.event_rules
    out["eventRules"] = aws_sdk_notifications.types.event_rules.serialize_json(value["event_rules"])
    return out
...
def deserialize_json(data: dict) -> ListEventRulesResponse:
    ...
    if "eventRules" in data:
        import aws_sdk_notifications.types.event_rules
        out["event_rules"] = aws_sdk_notifications.types.event_rules.deserialize_json(data["eventRules"])
    else:
