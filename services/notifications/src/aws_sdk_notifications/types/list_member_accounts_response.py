...
def serialize_json(value: ListMemberAccountsResponse) -> dict:
    out: dict = {}
    import aws_sdk_notifications.types.member_accounts
    out["memberAccounts"] = aws_sdk_notifications.types.member_accounts.serialize_json(value["member_accounts"])
...
def deserialize_json(data: dict) -> ListMemberAccountsResponse:
    ...
    if "memberAccounts" in data:
        import aws_sdk_notifications.types.member_accounts
        out["member_accounts"] = aws_sdk_notifications.types.member_accounts.deserialize_json(data["memberAccounts"])
    else:
        raise DeserializationError("ListMemberAccountsResponse.member_accounts required")
