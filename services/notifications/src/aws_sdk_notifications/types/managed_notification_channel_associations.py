...
ManagedNotificationChannelAssociations: TypeAlias = list[
    "aws_sdk_notifications.types.managed_notification_channel_association_summary.ManagedNotificationChannelAssociationSummary"
]
...
def serialize_json(value: ManagedNotificationChannelAssociations) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_notifications.types.managed_notification_channel_association_summary.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> ManagedNotificationChannelAssociations:
    ...
    for item in data:
        out.append(
            aws_sdk_notifications.types.managed_notification_channel_association_summary.deserialize_json(
                item
            )
        )
    return out
