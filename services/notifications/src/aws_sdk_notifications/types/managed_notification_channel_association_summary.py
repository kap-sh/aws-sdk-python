...
if TYPE_CHECKING:
    import aws_sdk_notifications.types.channel_association_override_option
...
class ManagedNotificationChannelAssociationSummary(TypedDict):
    ...
    override_option: NotRequired["aws_sdk_notifications.types.channel_association_override_option.ChannelAssociationOverrideOption"]
...
def deserialize_json(data: dict) -> ManagedNotificationChannelAssociationSummary:
    ...
    if "channelIdentifier" in data:
        ...
        raise DeserializationError("ManagedNotificationChannelAssociationSummary.channel_identifier required")
    if "channelType" in data:
        out["channel_type"] = data["channelType"]
    else:
        raise DeserializationError("ManagedNotificationChannelAssociationSummary.channel_type required")
