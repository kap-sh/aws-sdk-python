...
# --- restJson1 ser/de ---
def serialize_json(value: DisassociateManagedNotificationAccountContactResponse) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DisassociateManagedNotificationAccountContactResponse:
