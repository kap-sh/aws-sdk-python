...
def deserialize_json(data: dict) -> AssociateManagedNotificationAdditionalChannelRequest:
    ...
    if "managedNotificationConfigurationArn" in data:
        ...
        raise DeserializationError("AssociateManagedNotificationAdditionalChannelRequest.managed_notification_configuration_arn required")
    return out