...
if TYPE_CHECKING:
    ...
    import aws_sdk_notifications.types.aggregation_detail
...
class ManagedNotificationChildEvent(TypedDict):
    ...
    aggregation_detail: NotRequired[
        "aws_sdk_notifications.types.aggregation_detail.AggregationDetail"
    ]
...
def serialize_json(value: ManagedNotificationChildEvent) -> dict:
    ...
    if "aggregation_detail" in value:
        ...
        out["aggregationDetail"] = (
            aws_sdk_notifications.types.aggregation_detail.serialize_json(
...
def deserialize_json(data: dict) -> ManagedNotificationChildEvent:
    ...
    if "aggregationDetail" in data:
        ...
        out["aggregation_detail"] = (
            aws_sdk_notifications.types.aggregation_detail.deserialize_json(
