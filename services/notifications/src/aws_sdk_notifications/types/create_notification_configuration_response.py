...
def deserialize_json(data: dict) -> CreateNotificationConfigurationResponse:
    ...
    if "arn" in data:
        ...
        raise DeserializationError("CreateNotificationConfigurationResponse.arn required")
    if "status" in data:
        out["status"] = data["status"]
    else:
        raise DeserializationError("CreateNotificationConfigurationResponse.status required")
    return out