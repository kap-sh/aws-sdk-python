...
if TYPE_CHECKING:
    ...
    import aws_sdk_notifications.types.managed_source_event_metadata_summary
    import aws_sdk_notifications.types.message_components_summary
    import aws_sdk_notifications.types.notification_type
    import aws_sdk_notifications.types.schema_version


class ManagedNotificationEventSummary(TypedDict):
    ...
    message_components: "aws_sdk_notifications.types.message_components_summary.MessageComponentsSummary"
    event_status: "aws_sdk_notifications.types.event_status.EventStatus"
...
def serialize_json(value: ManagedNotificationEventSummary) -> dict:
    ...
    out["sourceEventMetadata"] = (
        aws_sdk_notifications.types.managed_source_event_metadata_summary.serialize_json(
    ...
    out["messageComponents"] = (
        aws_sdk_notifications.types.message_components_summary.serialize_json(
...
def deserialize_json(data: dict) -> ManagedNotificationEventSummary:
    ...
    if "sourceEventMetadata" in data:
        ...
        out["source_event_metadata"] = (
            aws_sdk_notifications.types.managed_source_event_metadata_summary.deserialize_json(
    ...
    if "messageComponents" in data:
        ...
        out["message_components"] = (
            aws_sdk_notifications.types.message_components_summary.deserialize_json(
