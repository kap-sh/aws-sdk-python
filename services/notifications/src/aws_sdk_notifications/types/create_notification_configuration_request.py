...
def deserialize_json(data: dict) -> CreateNotificationConfigurationRequest:
    ...
    if "name" in data:
        ...
        raise DeserializationError("CreateNotificationConfigurationRequest.name required")
    if "description" in data:
        out["description"] = data["description"]
    else:
        raise DeserializationError("CreateNotificationConfigurationRequest.description required")
