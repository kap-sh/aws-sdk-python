...
if TYPE_CHECKING:
    ...
    import aws_sdk_notifications.types.resources
    import aws_sdk_notifications.types.source


class SourceEventMetadata(TypedDict):
    ...
    related_resources: "aws_sdk_notifications.types.resources.Resources"
...
def serialize_json(value: SourceEventMetadata) -> dict:
    ...
    out["relatedResources"] = aws_sdk_notifications.types.resources.serialize_json(
...
def deserialize_json(data: dict) -> SourceEventMetadata:
    ...
    if "relatedResources" in data:
        ...
        out["related_resources"] = (
            aws_sdk_notifications.types.resources.deserialize_json(
