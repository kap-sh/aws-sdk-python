...
def deserialize_json(data: dict) -> GetEventRuleResponse:
    ...
    if "notificationConfigurationArn" in data:
        ...
        raise DeserializationError("GetEventRuleResponse.notification_configuration_arn required")
    ...
    if "statusSummaryByRegion" in data:
        ...
        raise DeserializationError("GetEventRuleResponse.status_summary_by_region required")
    return out