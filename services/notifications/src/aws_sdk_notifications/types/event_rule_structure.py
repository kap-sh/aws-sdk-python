...
class EventRuleStructure(TypedDict):
    ...
    event_pattern: "aws_sdk_notifications.types.event_rule_event_pattern.EventRuleEventPattern"
...
def serialize_json(value: EventRuleStructure) -> dict:
    ...
    import aws_sdk_notifications.types.regions
    out["regions"] = aws_sdk_notifications.types.regions.serialize_json(value["regions"])
    import aws_sdk_notifications.types.managed_rule_arns
    out["managedRules"] = aws_sdk_notifications.types.managed_rule_arns.serialize_json(value["managed_rules"])
    import aws_sdk_notifications.types.status_summary_by_region
...
def deserialize_json(data: dict) -> EventRuleStructure:
    ...
    if "notificationConfigurationArn" in data:
        ...
        raise DeserializationError("EventRuleStructure.notification_configuration_arn required")
    ...
    if "regions" in data:
        import aws_sdk_notifications.types.regions
        out["regions"] = aws_sdk_notifications.types.regions.deserialize_json(data["regions"])
    else:
        raise DeserializationError("EventRuleStructure.regions required")
    if "managedRules" in data:
        import aws_sdk_notifications.types.managed_rule_arns
        out["managed_rules"] = aws_sdk_notifications.types.managed_rule_arns.deserialize_json(data["managedRules"])
    else:
    ...
    if "statusSummaryByRegion" in data:
        ...
        raise DeserializationError("EventRuleStructure.status_summary_by_region required")
    return out