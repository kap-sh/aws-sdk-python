...
class CreateEventRuleResponse(TypedDict):
    ...
    status_summary_by_region: "aws_sdk_notifications.types.status_summary_by_region.StatusSummaryByRegion"
...
def serialize_json(value: CreateEventRuleResponse) -> dict:
    ...
    import aws_sdk_notifications.types.status_summary_by_region
    out["statusSummaryByRegion"] = aws_sdk_notifications.types.status_summary_by_region.serialize_json(value["status_summary_by_region"])
    return out
...
def deserialize_json(data: dict) -> CreateEventRuleResponse:
    ...
    if "notificationConfigurationArn" in data:
        ...
        raise DeserializationError("CreateEventRuleResponse.notification_configuration_arn required")
    if "statusSummaryByRegion" in data:
        import aws_sdk_notifications.types.status_summary_by_region
        out["status_summary_by_region"] = aws_sdk_notifications.types.status_summary_by_region.deserialize_json(data["statusSummaryByRegion"])
    else:
        raise DeserializationError("CreateEventRuleResponse.status_summary_by_region required")
    return out