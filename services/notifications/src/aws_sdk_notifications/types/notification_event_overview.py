...
if TYPE_CHECKING:
    ...
    import aws_sdk_notifications.types.notification_event_summary
...
class NotificationEventOverview(TypedDict):
    ...
    notification_event: "aws_sdk_notifications.types.notification_event_summary.NotificationEventSummary"
...
def serialize_json(value: NotificationEventOverview) -> dict:
    ...
    out["notificationEvent"] = (
        aws_sdk_notifications.types.notification_event_summary.serialize_json(
...
def deserialize_json(data: dict) -> NotificationEventOverview:
    ...
    if "notificationEvent" in data:
        ...
        out["notification_event"] = (
            aws_sdk_notifications.types.notification_event_summary.deserialize_json(
