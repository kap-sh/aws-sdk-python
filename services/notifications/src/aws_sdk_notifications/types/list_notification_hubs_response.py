...
def serialize_json(value: ListNotificationHubsResponse) -> dict:
    out: dict = {}
    import aws_sdk_notifications.types.notification_hubs
    out["notificationHubs"] = aws_sdk_notifications.types.notification_hubs.serialize_json(value["notification_hubs"])
...
def deserialize_json(data: dict) -> ListNotificationHubsResponse:
    ...
    if "notificationHubs" in data:
        import aws_sdk_notifications.types.notification_hubs
        out["notification_hubs"] = aws_sdk_notifications.types.notification_hubs.deserialize_json(data["notificationHubs"])
    else:
        raise DeserializationError("ListNotificationHubsResponse.notification_hubs required")
