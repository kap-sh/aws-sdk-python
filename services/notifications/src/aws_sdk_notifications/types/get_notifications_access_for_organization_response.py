...
def serialize_json(value: GetNotificationsAccessForOrganizationResponse) -> dict:
    out: dict = {}
    import aws_sdk_notifications.types.notifications_access_for_organization
    out["notificationsAccessForOrganization"] = aws_sdk_notifications.types.notifications_access_for_organization.serialize_json(value["notifications_access_for_organization"])
    return out
...
def deserialize_json(data: dict) -> GetNotificationsAccessForOrganizationResponse:
    ...
    if "notificationsAccessForOrganization" in data:
        import aws_sdk_notifications.types.notifications_access_for_organization
        out["notifications_access_for_organization"] = aws_sdk_notifications.types.notifications_access_for_organization.deserialize_json(data["notificationsAccessForOrganization"])
    else:
        raise DeserializationError("GetNotificationsAccessForOrganizationResponse.notifications_access_for_organization required")
    return out