...
class AsyncS3FilesClient:
    ...
    async def create_access_point(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.create_access_point_request.CreateAccessPointRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.create_access_point_response.CreateAccessPointResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.create_access_point.async_create_access_point(
    ...
    async def create_file_system(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.create_file_system_request.CreateFileSystemRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.create_file_system_response.CreateFileSystemResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.create_file_system.async_create_file_system(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_mount_target(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.create_mount_target_request.CreateMountTargetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.create_mount_target_response.CreateMountTargetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.create_mount_target.async_create_mount_target(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_access_point(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.delete_access_point_request.DeleteAccessPointRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.delete_access_point.async_delete_access_point(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_file_system(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.delete_file_system_request.DeleteFileSystemRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.delete_file_system.async_delete_file_system(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_file_system_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.delete_file_system_policy_request.DeleteFileSystemPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.delete_file_system_policy.async_delete_file_system_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_mount_target(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.delete_mount_target_request.DeleteMountTargetRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.delete_mount_target.async_delete_mount_target(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_access_point(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.get_access_point_request.GetAccessPointRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.get_access_point_response.GetAccessPointResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.get_access_point.async_get_access_point(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_file_system(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.get_file_system_request.GetFileSystemRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.get_file_system_response.GetFileSystemResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.get_file_system.async_get_file_system(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_file_system_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.get_file_system_policy_request.GetFileSystemPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.get_file_system_policy_response.GetFileSystemPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.get_file_system_policy.async_get_file_system_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_mount_target(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.get_mount_target_request.GetMountTargetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.get_mount_target_response.GetMountTargetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.get_mount_target.async_get_mount_target(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_synchronization_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.get_synchronization_configuration_request.GetSynchronizationConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.get_synchronization_configuration_response.GetSynchronizationConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.get_synchronization_configuration.async_get_synchronization_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_access_points(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.list_access_points_request.ListAccessPointsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.list_access_points_response.ListAccessPointsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.list_access_points.async_list_access_points(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_access_points(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_s3files.types.list_access_points_description.ListAccessPointsDescription]":
        _token = next_token
        while True:
    ...
    async def list_file_systems(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.list_file_systems_request.ListFileSystemsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.list_file_systems_response.ListFileSystemsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.list_file_systems.async_list_file_systems(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_file_systems(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_s3files.types.list_file_systems_description.ListFileSystemsDescription]":
        _token = next_token
        while True:
    ...
    async def list_mount_targets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.list_mount_targets_request.ListMountTargetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.list_mount_targets_response.ListMountTargetsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.list_mount_targets.async_list_mount_targets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_mount_targets(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_s3files.types.list_mount_targets_description.ListMountTargetsDescription]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_tags_for_resource(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_s3files.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    async def put_file_system_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.put_file_system_policy_request.PutFileSystemPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.put_file_system_policy_response.PutFileSystemPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.put_file_system_policy.async_put_file_system_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_synchronization_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.put_synchronization_configuration_request.PutSynchronizationConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.put_synchronization_configuration_response.PutSynchronizationConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.put_synchronization_configuration.async_put_synchronization_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_mount_target(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_s3files.types.update_mount_target_request.UpdateMountTargetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_s3files.types.update_mount_target_response.UpdateMountTargetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_s3files._operations.s3_files.update_mount_target.async_update_mount_target(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
