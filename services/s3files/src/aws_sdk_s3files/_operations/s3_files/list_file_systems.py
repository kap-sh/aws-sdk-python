...
def handle_response(
    ...
    out: aws_sdk_s3files.types.list_file_systems_response.ListFileSystemsResponse = (
        aws_sdk_s3files.types.list_file_systems_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3files.types.list_file_systems_request.ListFileSystemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
