"""Generated from Smithy shape ``com.amazonaws.s3files#ListAccessPoints``."""
...
def handle_response(
    ...
    out: aws_sdk_s3files.types.list_access_points_response.ListAccessPointsResponse = (
        aws_sdk_s3files.types.list_access_points_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3files.types.list_access_points_request.ListAccessPointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
