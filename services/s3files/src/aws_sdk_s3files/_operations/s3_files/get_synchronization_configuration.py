"""Generated from Smithy shape ``com.amazonaws.s3files#GetSynchronizationConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_s3files.types.get_synchronization_configuration_response.GetSynchronizationConfigurationResponse = aws_sdk_s3files.types.get_synchronization_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3files.types.get_synchronization_configuration_request.GetSynchronizationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_synchronization_configuration(
