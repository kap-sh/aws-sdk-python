...
def handle_response(
    ...
    out: aws_sdk_s3files.types.create_mount_target_response.CreateMountTargetResponse = aws_sdk_s3files.types.create_mount_target_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3files.types.create_mount_target_request.CreateMountTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3files.types.create_mount_target_request.serialize_json(input_)
    ).encode()
