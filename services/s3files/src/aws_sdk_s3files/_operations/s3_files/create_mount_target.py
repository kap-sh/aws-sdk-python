...
def build_request(
    ...
    input: aws_sdk_s3files.types.create_mount_target_request.CreateMountTargetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3files.types.create_mount_target_request.serialize_json(input)
    ).encode()
