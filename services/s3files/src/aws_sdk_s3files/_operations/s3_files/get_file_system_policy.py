...
def handle_response(
    ...
    out: aws_sdk_s3files.types.get_file_system_policy_response.GetFileSystemPolicyResponse = aws_sdk_s3files.types.get_file_system_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3files.types.get_file_system_policy_request.GetFileSystemPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
