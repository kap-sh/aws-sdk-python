...
def build_request(
    ...
    input: aws_sdk_s3files.types.put_file_system_policy_request.PutFileSystemPolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3files.types.put_file_system_policy_request.serialize_json(input)
    ).encode()
