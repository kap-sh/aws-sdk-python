...
def handle_response(
    ...
    out: aws_sdk_s3files.types.put_file_system_policy_response.PutFileSystemPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_s3files.types.put_file_system_policy_request.PutFileSystemPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3files.types.put_file_system_policy_request.serialize_json(input_)
    ).encode()
