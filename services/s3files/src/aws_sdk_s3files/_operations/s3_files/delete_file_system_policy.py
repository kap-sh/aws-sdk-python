"""Generated from Smithy shape ``com.amazonaws.s3files#DeleteFileSystemPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_s3files.types.delete_file_system_policy_request.DeleteFileSystemPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_file_system_policy(
