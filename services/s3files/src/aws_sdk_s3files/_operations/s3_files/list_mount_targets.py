...
def handle_response(
    ...
    out: aws_sdk_s3files.types.list_mount_targets_response.ListMountTargetsResponse = (
        aws_sdk_s3files.types.list_mount_targets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3files.types.list_mount_targets_request.ListMountTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
