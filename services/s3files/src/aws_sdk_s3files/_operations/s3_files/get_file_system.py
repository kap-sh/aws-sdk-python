"""Generated from Smithy shape ``com.amazonaws.s3files#GetFileSystem``."""
...
def handle_response(
    ...
    out: aws_sdk_s3files.types.get_file_system_response.GetFileSystemResponse = (
        aws_sdk_s3files.types.get_file_system_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3files.types.get_file_system_request.GetFileSystemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/file-systems/{fileSystemId}"
...
async def async_get_file_system(
