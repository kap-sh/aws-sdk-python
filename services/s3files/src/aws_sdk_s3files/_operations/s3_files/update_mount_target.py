...
def handle_response(
    ...
    out: aws_sdk_s3files.types.update_mount_target_response.UpdateMountTargetResponse = aws_sdk_s3files.types.update_mount_target_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3files.types.update_mount_target_request.UpdateMountTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3files.types.update_mount_target_request.serialize_json(input_)
    ).encode()
