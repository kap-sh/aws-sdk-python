...
def handle_response(
    ...
    out: aws_sdk_s3files.types.create_access_point_response.CreateAccessPointResponse = aws_sdk_s3files.types.create_access_point_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_s3files.types.create_access_point_request.CreateAccessPointRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3files.types.create_access_point_request.serialize_json(input)
    ).encode()
