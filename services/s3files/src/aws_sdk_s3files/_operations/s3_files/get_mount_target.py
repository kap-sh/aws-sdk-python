"""Generated from Smithy shape ``com.amazonaws.s3files#GetMountTarget``."""
...
def handle_response(
    ...
    out: aws_sdk_s3files.types.get_mount_target_response.GetMountTargetResponse = (
        aws_sdk_s3files.types.get_mount_target_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3files.types.get_mount_target_request.GetMountTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_mount_target(
