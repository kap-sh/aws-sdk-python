...
def handle_response(
    ...
    out: capo_s3files.types.create_file_system_response.CreateFileSystemResponse = (
        capo_s3files.types.create_file_system_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_s3files.types.create_file_system_request.serialize_json(input_)
    ).encode()
