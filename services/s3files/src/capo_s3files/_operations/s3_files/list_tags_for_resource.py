"""Generated from Smithy shape ``com.amazonaws.s3files#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_s3files.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_s3files.types.list_tags_for_resource_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/resource-tags/{resourceId}"
