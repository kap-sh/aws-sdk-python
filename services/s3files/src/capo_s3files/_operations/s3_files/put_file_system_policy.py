"""Generated from Smithy shape ``com.amazonaws.s3files#PutFileSystemPolicy``."""
...
def handle_response(
    ...
    out: capo_s3files.types.put_file_system_policy_response.PutFileSystemPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_s3files.types.put_file_system_policy_request.serialize_json(input_)
    ).encode()
