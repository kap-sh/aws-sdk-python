"""Generated from Smithy shape ``com.amazonaws.s3files#PutSynchronizationConfiguration``."""
...
def handle_response(
    ...
    out: capo_s3files.types.put_synchronization_configuration_response.PutSynchronizationConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_s3files.types.put_synchronization_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_synchronization_configuration(
