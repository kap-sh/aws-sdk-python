...
from capo_s3files._services._aws_config import aws_config
...
class S3FilesClientConfig(TypedDict, total=False, closed=True):
...
class S3FilesClient:
    ...
    def __init__(
        ...
        self._config = S3FilesClientConfig(
            {
    ...
    def create_access_point(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.create_access_point_request.CreateAccessPointRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.create_access_point_response.CreateAccessPointResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.create_access_point.create_access_point(
    ...
    def create_file_system(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.create_file_system_request.CreateFileSystemRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.create_file_system_response.CreateFileSystemResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.create_file_system.create_file_system(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_mount_target(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.create_mount_target_request.CreateMountTargetRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.create_mount_target_response.CreateMountTargetResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.create_mount_target.create_mount_target(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_access_point(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.delete_access_point_request.DeleteAccessPointRequest]",
        ) -> OperationResponse[None]:
            import capo_s3files._operations.s3_files.delete_access_point

            output, http_response = (
                capo_s3files._operations.s3_files.delete_access_point.delete_access_point(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_file_system(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.delete_file_system_request.DeleteFileSystemRequest]",
        ) -> OperationResponse[None]:
            import capo_s3files._operations.s3_files.delete_file_system

            output, http_response = (
                capo_s3files._operations.s3_files.delete_file_system.delete_file_system(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_file_system_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.delete_file_system_policy_request.DeleteFileSystemPolicyRequest]",
        ) -> OperationResponse[None]:
            import capo_s3files._operations.s3_files.delete_file_system_policy

            output, http_response = (
                capo_s3files._operations.s3_files.delete_file_system_policy.delete_file_system_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_mount_target(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.delete_mount_target_request.DeleteMountTargetRequest]",
        ) -> OperationResponse[None]:
            import capo_s3files._operations.s3_files.delete_mount_target

            output, http_response = (
                capo_s3files._operations.s3_files.delete_mount_target.delete_mount_target(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_point(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.get_access_point_request.GetAccessPointRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.get_access_point_response.GetAccessPointResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.get_access_point.get_access_point(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_file_system(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.get_file_system_request.GetFileSystemRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.get_file_system_response.GetFileSystemResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.get_file_system.get_file_system(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_file_system_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.get_file_system_policy_request.GetFileSystemPolicyRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.get_file_system_policy_response.GetFileSystemPolicyResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.get_file_system_policy.get_file_system_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_mount_target(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.get_mount_target_request.GetMountTargetRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.get_mount_target_response.GetMountTargetResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.get_mount_target.get_mount_target(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_synchronization_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.get_synchronization_configuration_request.GetSynchronizationConfigurationRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.get_synchronization_configuration_response.GetSynchronizationConfigurationResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.get_synchronization_configuration.get_synchronization_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_access_points(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.list_access_points_request.ListAccessPointsRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.list_access_points_response.ListAccessPointsResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.list_access_points.list_access_points(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_access_points(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_s3files.types.list_access_points_description.ListAccessPointsDescription]":
        _token = next_token
        while True:
    ...
    def list_file_systems(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.list_file_systems_request.ListFileSystemsRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.list_file_systems_response.ListFileSystemsResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.list_file_systems.list_file_systems(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_file_systems(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_s3files.types.list_file_systems_description.ListFileSystemsDescription]":
        _token = next_token
        while True:
    ...
    def list_mount_targets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.list_mount_targets_request.ListMountTargetsRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.list_mount_targets_response.ListMountTargetsResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.list_mount_targets.list_mount_targets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_mount_targets(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_s3files.types.list_mount_targets_description.ListMountTargetsDescription]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_tags_for_resource(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_s3files.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    def put_file_system_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.put_file_system_policy_request.PutFileSystemPolicyRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.put_file_system_policy_response.PutFileSystemPolicyResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.put_file_system_policy.put_file_system_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_synchronization_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.put_synchronization_configuration_request.PutSynchronizationConfigurationRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.put_synchronization_configuration_response.PutSynchronizationConfigurationResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.put_synchronization_configuration.put_synchronization_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[None]:
            import capo_s3files._operations.s3_files.tag_resource

            output, http_response = (
                capo_s3files._operations.s3_files.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[None]:
            import capo_s3files._operations.s3_files.untag_resource

            output, http_response = (
                capo_s3files._operations.s3_files.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_mount_target(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_s3files.types.update_mount_target_request.UpdateMountTargetRequest]",
        ) -> OperationResponse[
            "capo_s3files.types.update_mount_target_response.UpdateMountTargetResponse"
        ]:
            ...
            output, http_response = (
                capo_s3files._operations.s3_files.update_mount_target.update_mount_target(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
