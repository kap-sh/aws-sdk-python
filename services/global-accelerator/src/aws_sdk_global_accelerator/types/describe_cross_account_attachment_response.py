"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DescribeCrossAccountAttachmentResponse``."""
...
class DescribeCrossAccountAttachmentResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeCrossAccountAttachmentResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DescribeCrossAccountAttachmentResponse:
    out: DescribeCrossAccountAttachmentResponse = {}  # type: ignore[typeddict-item]
