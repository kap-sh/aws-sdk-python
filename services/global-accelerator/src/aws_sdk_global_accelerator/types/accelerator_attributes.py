"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#AcceleratorAttributes``."""
...
class AcceleratorAttributes(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AcceleratorAttributes) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> AcceleratorAttributes:
    out: AcceleratorAttributes = {}  # type: ignore[typeddict-item]
