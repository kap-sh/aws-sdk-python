"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DescribeListenerRequest``."""
...
class DescribeListenerRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeListenerRequest) -> dict:
    out: dict = {}
