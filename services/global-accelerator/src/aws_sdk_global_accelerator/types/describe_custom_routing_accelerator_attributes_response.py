"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DescribeCustomRoutingAcceleratorAttributesResponse``."""
...
class DescribeCustomRoutingAcceleratorAttributesResponse(TypedDict, closed=True):
...
def serialize_aws_json_1_1(
    value: DescribeCustomRoutingAcceleratorAttributesResponse,
) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(
    ...
    out: DescribeCustomRoutingAcceleratorAttributesResponse = {}  # type: ignore[typeddict-item]
