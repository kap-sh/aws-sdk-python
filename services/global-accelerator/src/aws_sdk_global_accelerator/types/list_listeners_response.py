...
class ListListenersResponse(TypedDict):
    listeners: NotRequired["aws_sdk_global_accelerator.types.listeners.Listeners"]
...
def serialize_aws_json_1_1(value: ListListenersResponse) -> dict:
    ...
    if "listeners" in value:
        ...
        out["Listeners"] = (
            aws_sdk_global_accelerator.types.listeners.serialize_aws_json_1_1(
                value["listeners"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListListenersResponse:
    ...
    if "Listeners" in data:
        ...
        out["listeners"] = (
            aws_sdk_global_accelerator.types.listeners.deserialize_aws_json_1_1(
                data["Listeners"]
            )
        )
