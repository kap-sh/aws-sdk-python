...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListAcceleratorsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListAcceleratorsRequest:
    out: ListAcceleratorsRequest = {}  # type: ignore[typeddict-item]
