...
if TYPE_CHECKING:
    import aws_sdk_global_accelerator.types.endpoint_groups
    import aws_sdk_global_accelerator.types.generic_string


class ListEndpointGroupsResponse(TypedDict):
    endpoint_groups: NotRequired[
        "aws_sdk_global_accelerator.types.endpoint_groups.EndpointGroups"
    ]
...
def serialize_aws_json_1_1(value: ListEndpointGroupsResponse) -> dict:
    ...
    if "endpoint_groups" in value:
        ...
        out["EndpointGroups"] = (
            aws_sdk_global_accelerator.types.endpoint_groups.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListEndpointGroupsResponse:
    ...
    if "EndpointGroups" in data:
        ...
        out["endpoint_groups"] = (
            aws_sdk_global_accelerator.types.endpoint_groups.deserialize_aws_json_1_1(
                data["EndpointGroups"]
            )
        )
