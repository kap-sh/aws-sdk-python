...
if TYPE_CHECKING:
    import aws_sdk_global_accelerator.types.accelerator_events
    import aws_sdk_global_accelerator.types.accelerator_status
...
class Accelerator(TypedDict, closed=True):
    ...
    status: NotRequired[
        "aws_sdk_global_accelerator.types.accelerator_status.AcceleratorStatus"
    ]
    ...
    events: NotRequired[
        "aws_sdk_global_accelerator.types.accelerator_events.AcceleratorEvents"
    ]
...
def serialize_aws_json_1_1(value: Accelerator) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_global_accelerator.types.accelerator_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
    ...
    if "events" in value:
        ...
        out["Events"] = (
            aws_sdk_global_accelerator.types.accelerator_events.serialize_aws_json_1_1(
                value["events"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Accelerator:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_global_accelerator.types.accelerator_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
    ...
    if "Events" in data:
        ...
        out["events"] = (
            aws_sdk_global_accelerator.types.accelerator_events.deserialize_aws_json_1_1(
                data["Events"]
            )
        )
    return out
