"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.globalaccelerator#ConflictException``."""
