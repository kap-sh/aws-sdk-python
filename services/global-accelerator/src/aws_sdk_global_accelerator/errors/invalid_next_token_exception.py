"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#InvalidNextTokenException``."""
...
class InvalidNextTokenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.globalaccelerator#InvalidNextTokenException``."""
