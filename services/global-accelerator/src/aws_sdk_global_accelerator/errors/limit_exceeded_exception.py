"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.globalaccelerator#LimitExceededException``."""
