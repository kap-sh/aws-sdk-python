...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.allow_custom_routing_traffic_request.AllowCustomRoutingTrafficRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.allow_custom_routing_traffic_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
