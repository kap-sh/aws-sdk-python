...
import aws_sdk_global_accelerator.errors.invalid_next_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNextTokenException":
            raise aws_sdk_global_accelerator.errors.invalid_next_token_exception.InvalidNextTokenException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.list_cross_account_attachments_response.ListCrossAccountAttachmentsResponse = aws_sdk_global_accelerator.types.list_cross_account_attachments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.list_cross_account_attachments_request.ListCrossAccountAttachmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.list_cross_account_attachments_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
