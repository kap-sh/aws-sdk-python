"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DescribeAcceleratorAttributes``."""
...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.describe_accelerator_attributes_response.DescribeAcceleratorAttributesResponse = aws_sdk_global_accelerator.types.describe_accelerator_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.describe_accelerator_attributes_request.DescribeAcceleratorAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.describe_accelerator_attributes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_accelerator_attributes(
