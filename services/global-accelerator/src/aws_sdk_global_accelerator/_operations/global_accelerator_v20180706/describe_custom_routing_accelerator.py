...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.describe_custom_routing_accelerator_response.DescribeCustomRoutingAcceleratorResponse = aws_sdk_global_accelerator.types.describe_custom_routing_accelerator_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.describe_custom_routing_accelerator_request.DescribeCustomRoutingAcceleratorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
