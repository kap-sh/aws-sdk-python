"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ListListeners``."""
...
import aws_sdk_global_accelerator.types.listeners
...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.list_listeners_response.ListListenersResponse = aws_sdk_global_accelerator.types.list_listeners_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.list_listeners_request.ListListenersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.list_listeners_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
