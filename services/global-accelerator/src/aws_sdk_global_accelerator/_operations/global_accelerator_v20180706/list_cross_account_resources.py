"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ListCrossAccountResources``."""
...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.list_cross_account_resources_response.ListCrossAccountResourcesResponse = aws_sdk_global_accelerator.types.list_cross_account_resources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.list_cross_account_resources_request.ListCrossAccountResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.ListCrossAccountResources"
    import aws_sdk_global_accelerator.types.list_cross_account_resources_request

    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.list_cross_account_resources_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_cross_account_resources(
