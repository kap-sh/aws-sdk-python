...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.list_custom_routing_listeners_response.ListCustomRoutingListenersResponse = aws_sdk_global_accelerator.types.list_custom_routing_listeners_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.list_custom_routing_listeners_request.ListCustomRoutingListenersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.list_custom_routing_listeners_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
