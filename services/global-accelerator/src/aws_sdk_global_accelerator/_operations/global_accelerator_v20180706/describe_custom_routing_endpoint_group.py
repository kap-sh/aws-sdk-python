"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DescribeCustomRoutingEndpointGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.describe_custom_routing_endpoint_group_response.DescribeCustomRoutingEndpointGroupResponse = aws_sdk_global_accelerator.types.describe_custom_routing_endpoint_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.describe_custom_routing_endpoint_group_request.DescribeCustomRoutingEndpointGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.describe_custom_routing_endpoint_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_custom_routing_endpoint_group(
