...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.update_accelerator_response.UpdateAcceleratorResponse = aws_sdk_global_accelerator.types.update_accelerator_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.update_accelerator_request.UpdateAcceleratorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.update_accelerator_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
