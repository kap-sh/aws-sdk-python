"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#AddCustomRoutingEndpoints``."""
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.add_custom_routing_endpoints_request.AddCustomRoutingEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.AddCustomRoutingEndpoints"
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.add_custom_routing_endpoints_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_add_custom_routing_endpoints(
