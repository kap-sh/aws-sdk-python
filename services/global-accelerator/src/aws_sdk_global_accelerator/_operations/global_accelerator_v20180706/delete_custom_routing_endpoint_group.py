"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DeleteCustomRoutingEndpointGroup``."""
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.delete_custom_routing_endpoint_group_request.DeleteCustomRoutingEndpointGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_custom_routing_endpoint_group(
