...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.list_custom_routing_endpoint_groups_response.ListCustomRoutingEndpointGroupsResponse = aws_sdk_global_accelerator.types.list_custom_routing_endpoint_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.list_custom_routing_endpoint_groups_request.ListCustomRoutingEndpointGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.list_custom_routing_endpoint_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
