...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.delete_cross_account_attachment_request.DeleteCrossAccountAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.delete_cross_account_attachment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
