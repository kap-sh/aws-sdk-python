"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ProvisionByoipCidr``."""
...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.provision_byoip_cidr_response.ProvisionByoipCidrResponse = aws_sdk_global_accelerator.types.provision_byoip_cidr_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.provision_byoip_cidr_request.ProvisionByoipCidrRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.ProvisionByoipCidr"
    import aws_sdk_global_accelerator.types.provision_byoip_cidr_request

    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.provision_byoip_cidr_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
