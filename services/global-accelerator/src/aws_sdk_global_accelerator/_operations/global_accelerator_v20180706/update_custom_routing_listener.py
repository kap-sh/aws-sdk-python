"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#UpdateCustomRoutingListener``."""
...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.update_custom_routing_listener_response.UpdateCustomRoutingListenerResponse = aws_sdk_global_accelerator.types.update_custom_routing_listener_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.update_custom_routing_listener_request.UpdateCustomRoutingListenerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.UpdateCustomRoutingListener"
    import aws_sdk_global_accelerator.types.update_custom_routing_listener_request

    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.update_custom_routing_listener_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_custom_routing_listener(
