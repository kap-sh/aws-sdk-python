...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.list_byoip_cidrs_response.ListByoipCidrsResponse = aws_sdk_global_accelerator.types.list_byoip_cidrs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.list_byoip_cidrs_request.ListByoipCidrsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.list_byoip_cidrs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
