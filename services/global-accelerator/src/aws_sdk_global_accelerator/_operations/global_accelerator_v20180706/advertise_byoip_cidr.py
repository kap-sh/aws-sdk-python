"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#AdvertiseByoipCidr``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ByoipCidrNotFoundException":
            import aws_sdk_global_accelerator.errors.byoip_cidr_not_found_exception

            raise aws_sdk_global_accelerator.errors.byoip_cidr_not_found_exception.ByoipCidrNotFoundException.from_aws_json_1_1(
                data
            )
        case "IncorrectCidrStateException":
            import aws_sdk_global_accelerator.errors.incorrect_cidr_state_exception

            raise aws_sdk_global_accelerator.errors.incorrect_cidr_state_exception.IncorrectCidrStateException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.advertise_byoip_cidr_response.AdvertiseByoipCidrResponse = aws_sdk_global_accelerator.types.advertise_byoip_cidr_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.advertise_byoip_cidr_request.AdvertiseByoipCidrRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.AdvertiseByoipCidr"
    import aws_sdk_global_accelerator.types.advertise_byoip_cidr_request

    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.advertise_byoip_cidr_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
