...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EndpointNotFoundException":
            import aws_sdk_global_accelerator.errors.endpoint_not_found_exception

            raise aws_sdk_global_accelerator.errors.endpoint_not_found_exception.EndpointNotFoundException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.remove_custom_routing_endpoints_request.RemoveCustomRoutingEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.remove_custom_routing_endpoints_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
