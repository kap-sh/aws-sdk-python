"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ListCustomRoutingAccelerators``."""
...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.list_custom_routing_accelerators_response.ListCustomRoutingAcceleratorsResponse = aws_sdk_global_accelerator.types.list_custom_routing_accelerators_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.list_custom_routing_accelerators_request.ListCustomRoutingAcceleratorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.list_custom_routing_accelerators_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_custom_routing_accelerators(
