...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.update_cross_account_attachment_response.UpdateCrossAccountAttachmentResponse = aws_sdk_global_accelerator.types.update_cross_account_attachment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.update_cross_account_attachment_request.UpdateCrossAccountAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.update_cross_account_attachment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
