...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EndpointGroupAlreadyExistsException":
            import aws_sdk_global_accelerator.errors.endpoint_group_already_exists_exception

            raise aws_sdk_global_accelerator.errors.endpoint_group_already_exists_exception.EndpointGroupAlreadyExistsException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidPortRangeException":
            import aws_sdk_global_accelerator.errors.invalid_port_range_exception

            raise aws_sdk_global_accelerator.errors.invalid_port_range_exception.InvalidPortRangeException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.create_custom_routing_endpoint_group_response.CreateCustomRoutingEndpointGroupResponse = aws_sdk_global_accelerator.types.create_custom_routing_endpoint_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.create_custom_routing_endpoint_group_request.CreateCustomRoutingEndpointGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.create_custom_routing_endpoint_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
