...
def handle_response(
    ...
    out: aws_sdk_global_accelerator.types.describe_listener_response.DescribeListenerResponse = aws_sdk_global_accelerator.types.describe_listener_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_global_accelerator.types.describe_listener_request.DescribeListenerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_global_accelerator.types.describe_listener_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
