...
class CreateCustomRoutingAcceleratorRequest(TypedDict, closed=True):
    ...
    r"""<p>Create tags for an accelerator.</p> <p>For more information, see <a href=\"https://docs.aws.amazon.com/global-accelerator/latest/dg/tagging-in-global-accelerator.html\">Tagging in Global Accelerator</a> in the <i>Global Accelerator Developer Guide</i>.</p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateCustomRoutingAcceleratorRequest) -> dict:
    out: dict = {}
    out["Name"] = value["name"]
