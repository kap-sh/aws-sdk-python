...
if TYPE_CHECKING:
    import capo_global_accelerator.types.custom_routing_destination_descriptions
...
class CustomRoutingEndpointGroup(TypedDict, closed=True):
    ...
    destination_descriptions: NotRequired[
        "capo_global_accelerator.types.custom_routing_destination_descriptions.CustomRoutingDestinationDescriptions"
    ]
...
def serialize_aws_json_1_1(value: CustomRoutingEndpointGroup) -> dict:
    ...
    if "destination_descriptions" in value:
        ...
        out["DestinationDescriptions"] = (
            capo_global_accelerator.types.custom_routing_destination_descriptions.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CustomRoutingEndpointGroup:
    ...
    if "DestinationDescriptions" in data:
        ...
        out["destination_descriptions"] = (
            capo_global_accelerator.types.custom_routing_destination_descriptions.deserialize_aws_json_1_1(
