...
class DestinationPortMapping(TypedDict, closed=True):
    ...
    accelerator_socket_addresses: NotRequired[
        "capo_global_accelerator.types.socket_addresses.SocketAddresses"
    ]
    ...
    destination_traffic_state: NotRequired[
        "capo_global_accelerator.types.custom_routing_destination_traffic_state.CustomRoutingDestinationTrafficState"
    ]
...
def serialize_aws_json_1_1(value: DestinationPortMapping) -> dict:
    ...
    if "accelerator_socket_addresses" in value:
        ...
        out["AcceleratorSocketAddresses"] = (
            capo_global_accelerator.types.socket_addresses.serialize_aws_json_1_1(
    ...
    if "destination_socket_address" in value:
        ...
        out["DestinationSocketAddress"] = (
            capo_global_accelerator.types.socket_address.serialize_aws_json_1_1(
    ...
    if "destination_traffic_state" in value:
        ...
        out["DestinationTrafficState"] = (
            capo_global_accelerator.types.custom_routing_destination_traffic_state.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DestinationPortMapping:
    ...
    if "AcceleratorSocketAddresses" in data:
        ...
        out["accelerator_socket_addresses"] = (
            capo_global_accelerator.types.socket_addresses.deserialize_aws_json_1_1(
    ...
    if "DestinationSocketAddress" in data:
        ...
        out["destination_socket_address"] = (
            capo_global_accelerator.types.socket_address.deserialize_aws_json_1_1(
    ...
    if "DestinationTrafficState" in data:
        ...
        out["destination_traffic_state"] = (
            capo_global_accelerator.types.custom_routing_destination_traffic_state.deserialize_aws_json_1_1(
