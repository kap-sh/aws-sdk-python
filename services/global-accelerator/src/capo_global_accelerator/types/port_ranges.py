...
if TYPE_CHECKING:
    import capo_global_accelerator.types.port_range

PortRanges: TypeAlias = list["capo_global_accelerator.types.port_range.PortRange"]
...
def serialize_aws_json_1_1(value: PortRanges) -> list:
    ...
    for item in value:
        out.append(
            capo_global_accelerator.types.port_range.serialize_aws_json_1_1(item)
        )
    return out
