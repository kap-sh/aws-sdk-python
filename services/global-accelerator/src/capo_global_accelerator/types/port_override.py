...
class PortOverride(TypedDict, closed=True):
    listener_port: NotRequired["capo_global_accelerator.types.port_number.PortNumber"]
    ...
    endpoint_port: NotRequired["capo_global_accelerator.types.port_number.PortNumber"]
