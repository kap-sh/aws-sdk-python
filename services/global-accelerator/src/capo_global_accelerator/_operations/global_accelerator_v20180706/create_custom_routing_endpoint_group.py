"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#CreateCustomRoutingEndpointGroup``."""
...
import capo_global_accelerator.errors.access_denied_exception
import capo_global_accelerator.errors.endpoint_group_already_exists_exception
...
import capo_global_accelerator.errors.invalid_port_range_exception
import capo_global_accelerator.errors.limit_exceeded_exception
import capo_global_accelerator.errors.listener_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AccessDeniedException":
            raise capo_global_accelerator.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data
            )
        case "EndpointGroupAlreadyExistsException":
            raise capo_global_accelerator.errors.endpoint_group_already_exists_exception.EndpointGroupAlreadyExistsException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidPortRangeException":
            raise capo_global_accelerator.errors.invalid_port_range_exception.InvalidPortRangeException.from_aws_json_1_1(
                data
            )
        case "LimitExceededException":
            raise capo_global_accelerator.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data
            )
        case "ListenerNotFoundException":
            raise capo_global_accelerator.errors.listener_not_found_exception.ListenerNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_global_accelerator.types.create_custom_routing_endpoint_group_response.CreateCustomRoutingEndpointGroupResponse = capo_global_accelerator.types.create_custom_routing_endpoint_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.create_custom_routing_endpoint_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_custom_routing_endpoint_group(
