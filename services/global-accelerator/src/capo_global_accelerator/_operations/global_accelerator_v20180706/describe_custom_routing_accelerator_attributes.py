"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DescribeCustomRoutingAcceleratorAttributes``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.describe_custom_routing_accelerator_attributes_response.DescribeCustomRoutingAcceleratorAttributesResponse = capo_global_accelerator.types.describe_custom_routing_accelerator_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.describe_custom_routing_accelerator_attributes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_custom_routing_accelerator_attributes(
