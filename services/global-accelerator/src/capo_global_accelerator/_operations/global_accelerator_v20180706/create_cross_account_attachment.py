"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#CreateCrossAccountAttachment``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.create_cross_account_attachment_response.CreateCrossAccountAttachmentResponse = capo_global_accelerator.types.create_cross_account_attachment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.CreateCrossAccountAttachment"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.create_cross_account_attachment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_cross_account_attachment(
