"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DescribeCustomRoutingListener``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.describe_custom_routing_listener_response.DescribeCustomRoutingListenerResponse = capo_global_accelerator.types.describe_custom_routing_listener_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.describe_custom_routing_listener_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_custom_routing_listener(
