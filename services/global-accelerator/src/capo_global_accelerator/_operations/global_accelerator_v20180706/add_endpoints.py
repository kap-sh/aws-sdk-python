"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#AddEndpoints``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.add_endpoints_response.AddEndpointsResponse = (
        capo_global_accelerator.types.add_endpoints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.AddEndpoints"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.add_endpoints_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
