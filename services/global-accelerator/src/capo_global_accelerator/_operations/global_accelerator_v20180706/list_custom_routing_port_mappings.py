"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ListCustomRoutingPortMappings``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.list_custom_routing_port_mappings_response.ListCustomRoutingPortMappingsResponse = capo_global_accelerator.types.list_custom_routing_port_mappings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.list_custom_routing_port_mappings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_custom_routing_port_mappings(
