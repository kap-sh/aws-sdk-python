"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ListCrossAccountAttachments``."""
...
import capo_global_accelerator.errors.invalid_next_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNextTokenException":
            raise capo_global_accelerator.errors.invalid_next_token_exception.InvalidNextTokenException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_global_accelerator.types.list_cross_account_attachments_response.ListCrossAccountAttachmentsResponse = capo_global_accelerator.types.list_cross_account_attachments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.ListCrossAccountAttachments"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.list_cross_account_attachments_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_cross_account_attachments(
