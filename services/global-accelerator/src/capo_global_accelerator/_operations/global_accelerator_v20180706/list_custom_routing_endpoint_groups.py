"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ListCustomRoutingEndpointGroups``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.list_custom_routing_endpoint_groups_response.ListCustomRoutingEndpointGroupsResponse = capo_global_accelerator.types.list_custom_routing_endpoint_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.list_custom_routing_endpoint_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_custom_routing_endpoint_groups(
