"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DeleteCrossAccountAttachment``."""
...
import capo_global_accelerator.errors.attachment_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AttachmentNotFoundException":
            raise capo_global_accelerator.errors.attachment_not_found_exception.AttachmentNotFoundException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.DeleteCrossAccountAttachment"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.delete_cross_account_attachment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_cross_account_attachment(
