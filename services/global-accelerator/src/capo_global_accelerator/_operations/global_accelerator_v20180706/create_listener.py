"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#CreateListener``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.create_listener_response.CreateListenerResponse = capo_global_accelerator.types.create_listener_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.create_listener_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
