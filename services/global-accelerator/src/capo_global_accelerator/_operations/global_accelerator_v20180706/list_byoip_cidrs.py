"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ListByoipCidrs``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.list_byoip_cidrs_response.ListByoipCidrsResponse = capo_global_accelerator.types.list_byoip_cidrs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.ListByoipCidrs"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.list_byoip_cidrs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_byoip_cidrs(
