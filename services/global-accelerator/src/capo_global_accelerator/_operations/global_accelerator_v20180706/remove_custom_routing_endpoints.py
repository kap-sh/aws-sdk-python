"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#RemoveCustomRoutingEndpoints``."""
...
import capo_global_accelerator.errors.conflict_exception
import capo_global_accelerator.errors.endpoint_group_not_found_exception
import capo_global_accelerator.errors.endpoint_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_global_accelerator.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
        case "EndpointGroupNotFoundException":
            raise capo_global_accelerator.errors.endpoint_group_not_found_exception.EndpointGroupNotFoundException.from_aws_json_1_1(
                data
            )
        case "EndpointNotFoundException":
            raise capo_global_accelerator.errors.endpoint_not_found_exception.EndpointNotFoundException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.RemoveCustomRoutingEndpoints"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.remove_custom_routing_endpoints_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_remove_custom_routing_endpoints(
