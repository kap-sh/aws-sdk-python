"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#WithdrawByoipCidr``."""
...
import capo_global_accelerator.errors.byoip_cidr_not_found_exception
import capo_global_accelerator.errors.incorrect_cidr_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ByoipCidrNotFoundException":
            raise capo_global_accelerator.errors.byoip_cidr_not_found_exception.ByoipCidrNotFoundException.from_aws_json_1_1(
                data
            )
        case "IncorrectCidrStateException":
            raise capo_global_accelerator.errors.incorrect_cidr_state_exception.IncorrectCidrStateException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_global_accelerator.types.withdraw_byoip_cidr_response.WithdrawByoipCidrResponse = capo_global_accelerator.types.withdraw_byoip_cidr_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.WithdrawByoipCidr"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.withdraw_byoip_cidr_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
