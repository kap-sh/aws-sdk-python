"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#UpdateEndpointGroup``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.update_endpoint_group_response.UpdateEndpointGroupResponse = capo_global_accelerator.types.update_endpoint_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.update_endpoint_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_endpoint_group(
