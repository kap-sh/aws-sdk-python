"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#UpdateAcceleratorAttributes``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.update_accelerator_attributes_response.UpdateAcceleratorAttributesResponse = capo_global_accelerator.types.update_accelerator_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.UpdateAcceleratorAttributes"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.update_accelerator_attributes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_accelerator_attributes(
