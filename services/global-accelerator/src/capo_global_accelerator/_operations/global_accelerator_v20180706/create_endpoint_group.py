"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#CreateEndpointGroup``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.create_endpoint_group_response.CreateEndpointGroupResponse = capo_global_accelerator.types.create_endpoint_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.create_endpoint_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_endpoint_group(
