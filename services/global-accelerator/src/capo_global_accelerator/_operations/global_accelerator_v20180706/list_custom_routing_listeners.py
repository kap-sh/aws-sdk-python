"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ListCustomRoutingListeners``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.list_custom_routing_listeners_response.ListCustomRoutingListenersResponse = capo_global_accelerator.types.list_custom_routing_listeners_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.ListCustomRoutingListeners"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.list_custom_routing_listeners_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_custom_routing_listeners(
