"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DeleteEndpointGroup``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.delete_endpoint_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_endpoint_group(
