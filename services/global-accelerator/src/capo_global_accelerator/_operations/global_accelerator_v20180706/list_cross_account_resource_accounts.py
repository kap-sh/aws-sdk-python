"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ListCrossAccountResourceAccounts``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.list_cross_account_resource_accounts_response.ListCrossAccountResourceAccountsResponse = capo_global_accelerator.types.list_cross_account_resource_accounts_response.deserialize_aws_json_1_1(
...
async def async_list_cross_account_resource_accounts(
