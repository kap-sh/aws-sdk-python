"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DescribeEndpointGroup``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.describe_endpoint_group_response.DescribeEndpointGroupResponse = capo_global_accelerator.types.describe_endpoint_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.describe_endpoint_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_endpoint_group(
