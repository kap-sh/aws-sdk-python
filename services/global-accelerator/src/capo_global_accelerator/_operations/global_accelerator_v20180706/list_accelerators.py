"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ListAccelerators``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.list_accelerators_response.ListAcceleratorsResponse = capo_global_accelerator.types.list_accelerators_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.list_accelerators_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_accelerators(
