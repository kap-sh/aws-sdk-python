"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DeleteCustomRoutingListener``."""
...
import capo_global_accelerator.errors.associated_endpoint_group_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AssociatedEndpointGroupFoundException":
            raise capo_global_accelerator.errors.associated_endpoint_group_found_exception.AssociatedEndpointGroupFoundException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.DeleteCustomRoutingListener"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.delete_custom_routing_listener_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_custom_routing_listener(
