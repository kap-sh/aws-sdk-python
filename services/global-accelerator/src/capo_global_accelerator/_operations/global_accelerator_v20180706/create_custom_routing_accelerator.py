"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#CreateCustomRoutingAccelerator``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.create_custom_routing_accelerator_response.CreateCustomRoutingAcceleratorResponse = capo_global_accelerator.types.create_custom_routing_accelerator_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.create_custom_routing_accelerator_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_custom_routing_accelerator(
