"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DenyCustomRoutingTraffic``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.DenyCustomRoutingTraffic"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.deny_custom_routing_traffic_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_deny_custom_routing_traffic(
