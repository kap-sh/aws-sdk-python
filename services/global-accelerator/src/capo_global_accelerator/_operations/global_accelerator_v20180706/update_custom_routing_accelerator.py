"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#UpdateCustomRoutingAccelerator``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.update_custom_routing_accelerator_response.UpdateCustomRoutingAcceleratorResponse = capo_global_accelerator.types.update_custom_routing_accelerator_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.update_custom_routing_accelerator_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_custom_routing_accelerator(
