...
def handle_response(
    ...
    out: capo_global_accelerator.types.list_listeners_response.ListListenersResponse = (
        capo_global_accelerator.types.list_listeners_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.list_listeners_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
