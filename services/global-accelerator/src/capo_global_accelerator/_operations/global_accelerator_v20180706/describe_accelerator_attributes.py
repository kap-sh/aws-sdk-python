...
def handle_response(
    ...
    out: capo_global_accelerator.types.describe_accelerator_attributes_response.DescribeAcceleratorAttributesResponse = capo_global_accelerator.types.describe_accelerator_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.describe_accelerator_attributes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
