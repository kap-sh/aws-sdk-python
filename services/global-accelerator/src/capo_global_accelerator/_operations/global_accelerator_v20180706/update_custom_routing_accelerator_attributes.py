"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#UpdateCustomRoutingAcceleratorAttributes``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.update_custom_routing_accelerator_attributes_response.UpdateCustomRoutingAcceleratorAttributesResponse = capo_global_accelerator.types.update_custom_routing_accelerator_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.update_custom_routing_accelerator_attributes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_custom_routing_accelerator_attributes(
