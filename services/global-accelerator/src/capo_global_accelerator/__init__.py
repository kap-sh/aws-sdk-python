...
from ._services.async_global_accelerator import (
    AsyncGlobalAcceleratorClient as AsyncGlobalAcceleratorClient,
)
from ._services.global_accelerator import (
    GlobalAcceleratorClient as GlobalAcceleratorClient,
)
