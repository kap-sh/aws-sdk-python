...
class GlobalAcceleratorError(Exception):
    """Base class for all GlobalAccelerator service errors."""


class ServiceError(GlobalAcceleratorError):
...
class SerializationError(GlobalAcceleratorError):
    """Raised when a value cannot be serialized."""


class DeserializationError(GlobalAcceleratorError):
...
class WaiterFailedError(GlobalAcceleratorError):
...
class WaiterTimeoutError(GlobalAcceleratorError):
