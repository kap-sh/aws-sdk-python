...
def handle_response(
    ...
    out: capo_eventbridge.types.start_replay_response.StartReplayResponse = (
        capo_eventbridge.types.start_replay_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.start_replay_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def start_replay(
    ...
    capo_eventbridge.types.start_replay_response.StartReplayResponse, zapros.Response
]:
