...
import capo_eventbridge.types.rule_name_list
...
def handle_response(
    ...
    out: capo_eventbridge.types.list_rule_names_by_target_response.ListRuleNamesByTargetResponse = capo_eventbridge.types.list_rule_names_by_target_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.list_rule_names_by_target_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
