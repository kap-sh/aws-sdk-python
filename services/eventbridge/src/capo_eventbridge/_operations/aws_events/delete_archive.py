...
def handle_response(
    ...
    out: capo_eventbridge.types.delete_archive_response.DeleteArchiveResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.delete_archive_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
