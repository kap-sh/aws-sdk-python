"""Generated from Smithy shape ``com.amazonaws.eventbridge#PutRule``."""
...
import capo_eventbridge.errors.managed_rule_exception
...
def handle_response(
    ...
    out: capo_eventbridge.types.put_rule_response.PutRuleResponse = (
        capo_eventbridge.types.put_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_eventbridge.types.put_rule_request.PutRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.put_rule_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def put_rule(
    ...
    input_: capo_eventbridge.types.put_rule_request.PutRuleRequest,
) -> tuple[capo_eventbridge.types.put_rule_response.PutRuleResponse, zapros.Response]:
