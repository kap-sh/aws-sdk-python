"""Generated from Smithy shape ``com.amazonaws.eventbridge#CreatePartnerEventSource``."""
...
import capo_eventbridge.errors.resource_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceAlreadyExistsException":
            raise capo_eventbridge.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_eventbridge.types.create_partner_event_source_response.CreatePartnerEventSourceResponse = capo_eventbridge.types.create_partner_event_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.create_partner_event_source_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_partner_event_source(
