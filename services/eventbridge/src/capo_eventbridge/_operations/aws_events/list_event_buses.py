...
import capo_eventbridge.types.event_bus_list
...
def handle_response(
    ...
    out: capo_eventbridge.types.list_event_buses_response.ListEventBusesResponse = (
        capo_eventbridge.types.list_event_buses_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.list_event_buses_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
