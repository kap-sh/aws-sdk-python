...
def handle_response(
    ...
    out: capo_eventbridge.types.put_targets_response.PutTargetsResponse = (
        capo_eventbridge.types.put_targets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.put_targets_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def put_targets(
    ...
    capo_eventbridge.types.put_targets_response.PutTargetsResponse, zapros.Response
]:
