"""Generated from Smithy shape ``com.amazonaws.eventbridge#ListEndpoints``."""
...
def handle_response(
    ...
    out: capo_eventbridge.types.list_endpoints_response.ListEndpointsResponse = (
        capo_eventbridge.types.list_endpoints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSEvents.ListEndpoints"
    body: bytes | None = json.dumps(
        capo_eventbridge.types.list_endpoints_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
