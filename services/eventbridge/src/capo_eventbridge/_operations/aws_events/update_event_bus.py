"""Generated from Smithy shape ``com.amazonaws.eventbridge#UpdateEventBus``."""
...
def handle_response(
    ...
    out: capo_eventbridge.types.update_event_bus_response.UpdateEventBusResponse = (
        capo_eventbridge.types.update_event_bus_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSEvents.UpdateEventBus"
    body: bytes | None = json.dumps(
        capo_eventbridge.types.update_event_bus_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_event_bus(
