...
def handle_response(
    ...
    out: capo_eventbridge.types.describe_rule_response.DescribeRuleResponse = (
        capo_eventbridge.types.describe_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.describe_rule_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_rule(
    ...
    capo_eventbridge.types.describe_rule_response.DescribeRuleResponse, zapros.Response
]:
