...
import capo_eventbridge.errors.illegal_status_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IllegalStatusException":
            raise capo_eventbridge.errors.illegal_status_exception.IllegalStatusException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_eventbridge.types.cancel_replay_response.CancelReplayResponse = (
        capo_eventbridge.types.cancel_replay_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.cancel_replay_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def cancel_replay(
    ...
    capo_eventbridge.types.cancel_replay_response.CancelReplayResponse, zapros.Response
]:
