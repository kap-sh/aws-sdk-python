"""Generated from Smithy shape ``com.amazonaws.eventbridge#ListReplays``."""
...
def handle_response(
    ...
    out: capo_eventbridge.types.list_replays_response.ListReplaysResponse = (
        capo_eventbridge.types.list_replays_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.list_replays_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_replays(
    ...
    capo_eventbridge.types.list_replays_response.ListReplaysResponse, zapros.Response
]:
