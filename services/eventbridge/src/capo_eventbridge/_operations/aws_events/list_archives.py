...
def handle_response(
    ...
    out: capo_eventbridge.types.list_archives_response.ListArchivesResponse = (
        capo_eventbridge.types.list_archives_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.list_archives_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_archives(
    ...
    capo_eventbridge.types.list_archives_response.ListArchivesResponse, zapros.Response
]:
