...
def handle_response(
    ...
    out: capo_eventbridge.types.create_api_destination_response.CreateApiDestinationResponse = capo_eventbridge.types.create_api_destination_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.create_api_destination_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
