...
def handle_response(
    ...
    out: capo_eventbridge.types.list_targets_by_rule_response.ListTargetsByRuleResponse = capo_eventbridge.types.list_targets_by_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.list_targets_by_rule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
