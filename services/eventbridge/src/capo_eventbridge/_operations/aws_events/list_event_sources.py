"""Generated from Smithy shape ``com.amazonaws.eventbridge#ListEventSources``."""
...
def handle_response(
    ...
    out: capo_eventbridge.types.list_event_sources_response.ListEventSourcesResponse = (
        capo_eventbridge.types.list_event_sources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.list_event_sources_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_event_sources(
