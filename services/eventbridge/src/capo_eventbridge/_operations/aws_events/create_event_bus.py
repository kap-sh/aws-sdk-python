"""Generated from Smithy shape ``com.amazonaws.eventbridge#CreateEventBus``."""
...
def handle_response(
    ...
    out: capo_eventbridge.types.create_event_bus_response.CreateEventBusResponse = (
        capo_eventbridge.types.create_event_bus_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.create_event_bus_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
