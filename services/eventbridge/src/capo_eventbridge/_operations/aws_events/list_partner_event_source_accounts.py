"""Generated from Smithy shape ``com.amazonaws.eventbridge#ListPartnerEventSourceAccounts``."""
...
def handle_response(
    ...
    out: capo_eventbridge.types.list_partner_event_source_accounts_response.ListPartnerEventSourceAccountsResponse = capo_eventbridge.types.list_partner_event_source_accounts_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.list_partner_event_source_accounts_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_partner_event_source_accounts(
