...
def handle_response(
    ...
    out: capo_eventbridge.types.create_connection_response.CreateConnectionResponse = (
        capo_eventbridge.types.create_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.create_connection_request.serialize_aws_json_1_1(input_)
    ).encode()
