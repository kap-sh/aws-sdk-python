"""Generated from Smithy shape ``com.amazonaws.eventbridge#PutEvents``."""
...
def handle_response(
    ...
    out: capo_eventbridge.types.put_events_response.PutEventsResponse = (
        capo_eventbridge.types.put_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.put_events_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_events(
    ...
    capo_eventbridge.types.put_events_response.PutEventsResponse, zapros.Response
]:
