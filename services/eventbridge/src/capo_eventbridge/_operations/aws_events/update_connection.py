...
import capo_eventbridge.errors.access_denied_exception
...
import capo_eventbridge.errors.throttling_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_eventbridge.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data
            )
        ...
        case "ThrottlingException":
            raise capo_eventbridge.errors.throttling_exception.ThrottlingException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_eventbridge.types.update_connection_response.UpdateConnectionResponse = (
        capo_eventbridge.types.update_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.update_connection_request.serialize_aws_json_1_1(input_)
    ).encode()
