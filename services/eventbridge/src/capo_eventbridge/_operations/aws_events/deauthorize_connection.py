"""Generated from Smithy shape ``com.amazonaws.eventbridge#DeauthorizeConnection``."""
...
def handle_response(
    ...
    out: capo_eventbridge.types.deauthorize_connection_response.DeauthorizeConnectionResponse = capo_eventbridge.types.deauthorize_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.deauthorize_connection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
