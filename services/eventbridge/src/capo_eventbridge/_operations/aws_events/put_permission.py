...
import capo_eventbridge.errors.policy_length_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyLengthExceededException":
            raise capo_eventbridge.errors.policy_length_exceeded_exception.PolicyLengthExceededException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.put_permission_request.serialize_aws_json_1_1(input_)
    ).encode()
