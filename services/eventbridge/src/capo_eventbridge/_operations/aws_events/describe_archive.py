...
def handle_response(
    ...
    out: capo_eventbridge.types.describe_archive_response.DescribeArchiveResponse = (
        capo_eventbridge.types.describe_archive_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.describe_archive_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
