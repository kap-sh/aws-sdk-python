...
def handle_response(
    ...
    out: capo_eventbridge.types.put_partner_events_response.PutPartnerEventsResponse = (
        capo_eventbridge.types.put_partner_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.put_partner_events_request.serialize_aws_json_1_1(input_)
    ).encode()
