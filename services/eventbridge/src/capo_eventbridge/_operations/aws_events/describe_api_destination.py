"""Generated from Smithy shape ``com.amazonaws.eventbridge#DescribeApiDestination``."""
...
def handle_response(
    ...
    out: capo_eventbridge.types.describe_api_destination_response.DescribeApiDestinationResponse = capo_eventbridge.types.describe_api_destination_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSEvents.DescribeApiDestination"
...
async def async_describe_api_destination(
