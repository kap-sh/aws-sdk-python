"""Generated from Smithy shape ``com.amazonaws.eventbridge#CreateEndpoint``."""
...
def handle_response(
    ...
    out: capo_eventbridge.types.create_endpoint_response.CreateEndpointResponse = (
        capo_eventbridge.types.create_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSEvents.CreateEndpoint"
    body: bytes | None = json.dumps(
        capo_eventbridge.types.create_endpoint_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
