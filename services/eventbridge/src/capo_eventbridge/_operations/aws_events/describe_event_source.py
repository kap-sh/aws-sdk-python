"""Generated from Smithy shape ``com.amazonaws.eventbridge#DescribeEventSource``."""
...
def handle_response(
    ...
    out: capo_eventbridge.types.describe_event_source_response.DescribeEventSourceResponse = capo_eventbridge.types.describe_event_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eventbridge.types.describe_event_source_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_event_source(
