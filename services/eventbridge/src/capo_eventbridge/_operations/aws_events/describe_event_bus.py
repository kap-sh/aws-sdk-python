...
def handle_response(
    ...
    out: capo_eventbridge.types.describe_event_bus_response.DescribeEventBusResponse = (
        capo_eventbridge.types.describe_event_bus_response.deserialize_aws_json_1_1(
