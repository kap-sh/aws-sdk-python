...
def serialize_aws_json_1_1(value: PutPermissionRequest) -> dict:
    ...
    if "condition" in value:
        ...
        out["Condition"] = capo_eventbridge.types.condition.serialize_aws_json_1_1(
            value["condition"]
        )
    if "policy" in value:
...
def deserialize_aws_json_1_1(data: dict) -> PutPermissionRequest:
    ...
    if "Condition" in data:
        ...
        out["condition"] = capo_eventbridge.types.condition.deserialize_aws_json_1_1(
            data["Condition"]
        )
    if "Policy" in data:
