...
class CreateConnectionOAuthClientRequestParameters(TypedDict, closed=True):
    client_id: "capo_eventbridge.types.auth_header_parameters.AuthHeaderParameters"
    """<p>The client ID to use for OAuth authorization for the connection.</p>"""
    client_secret: "capo_eventbridge.types.auth_header_parameters_sensitive.AuthHeaderParametersSensitive"
