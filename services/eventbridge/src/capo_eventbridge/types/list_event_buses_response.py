...
class ListEventBusesResponse(TypedDict, closed=True):
    event_buses: NotRequired["capo_eventbridge.types.event_bus_list.EventBusList"]
...
def serialize_aws_json_1_1(value: ListEventBusesResponse) -> dict:
    ...
    if "event_buses" in value:
        ...
        out["EventBuses"] = (
            capo_eventbridge.types.event_bus_list.serialize_aws_json_1_1(
                value["event_buses"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListEventBusesResponse:
    ...
    if "EventBuses" in data:
        ...
        out["event_buses"] = (
            capo_eventbridge.types.event_bus_list.deserialize_aws_json_1_1(
                data["EventBuses"]
            )
        )
