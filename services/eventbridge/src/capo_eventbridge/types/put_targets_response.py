...
if TYPE_CHECKING:
    ...
    import capo_eventbridge.types.put_targets_result_entry_list
...
class PutTargetsResponse(TypedDict, closed=True):
    ...
    failed_entries: NotRequired[
        "capo_eventbridge.types.put_targets_result_entry_list.PutTargetsResultEntryList"
    ]
...
def serialize_aws_json_1_1(value: PutTargetsResponse) -> dict:
    ...
    if "failed_entries" in value:
        ...
        out["FailedEntries"] = (
            capo_eventbridge.types.put_targets_result_entry_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> PutTargetsResponse:
    ...
    if "FailedEntries" in data:
        ...
        out["failed_entries"] = (
            capo_eventbridge.types.put_targets_result_entry_list.deserialize_aws_json_1_1(
                data["FailedEntries"]
            )
        )
    return out
