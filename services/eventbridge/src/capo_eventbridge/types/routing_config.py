...
class RoutingConfig(TypedDict, closed=True):
    failover_config: "capo_eventbridge.types.failover_config.FailoverConfig"
...
def serialize_aws_json_1_1(value: RoutingConfig) -> dict:
    ...
    out["FailoverConfig"] = (
        capo_eventbridge.types.failover_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RoutingConfig:
    ...
    if "FailoverConfig" in data:
        ...
        out["failover_config"] = (
            capo_eventbridge.types.failover_config.deserialize_aws_json_1_1(
                data["FailoverConfig"]
            )
        )
    else:
