...
if TYPE_CHECKING:
    ...
    import capo_eventbridge.types.header_value_sensitive


class ConnectionHeaderParameter(TypedDict, closed=True):
    key: NotRequired["capo_eventbridge.types.header_key.HeaderKey"]
    """<p>The key for the parameter.</p>"""
    value: NotRequired[
        "capo_eventbridge.types.header_value_sensitive.HeaderValueSensitive"
    ]
