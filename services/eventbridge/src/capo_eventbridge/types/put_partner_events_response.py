...
if TYPE_CHECKING:
    ...
    import capo_eventbridge.types.put_partner_events_result_entry_list
...
class PutPartnerEventsResponse(TypedDict, closed=True):
    ...
    entries: NotRequired[
        "capo_eventbridge.types.put_partner_events_result_entry_list.PutPartnerEventsResultEntryList"
    ]
...
def serialize_aws_json_1_1(value: PutPartnerEventsResponse) -> dict:
    ...
    if "entries" in value:
        ...
        out["Entries"] = (
            capo_eventbridge.types.put_partner_events_result_entry_list.serialize_aws_json_1_1(
                value["entries"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> PutPartnerEventsResponse:
    ...
    if "Entries" in data:
        ...
        out["entries"] = (
            capo_eventbridge.types.put_partner_events_result_entry_list.deserialize_aws_json_1_1(
                data["Entries"]
            )
        )
    return out
