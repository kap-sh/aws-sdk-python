...
if TYPE_CHECKING:
    import capo_eventbridge.types.put_events_request_entry

PutEventsRequestEntryList: TypeAlias = list[
    "capo_eventbridge.types.put_events_request_entry.PutEventsRequestEntry"
]
...
def serialize_aws_json_1_1(value: PutEventsRequestEntryList) -> list:
    ...
    for item in value:
        out.append(
            capo_eventbridge.types.put_events_request_entry.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> PutEventsRequestEntryList:
    ...
    for item in data:
        out.append(
            capo_eventbridge.types.put_events_request_entry.deserialize_aws_json_1_1(
                item
            )
        )
    return out
