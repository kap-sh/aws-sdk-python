...
class InputTransformer(TypedDict, closed=True):
    ...
    input_template: "capo_eventbridge.types.transformer_input.TransformerInput"
...
def serialize_aws_json_1_1(value: InputTransformer) -> dict:
    ...
    if "input_paths_map" in value:
        ...
        out["InputPathsMap"] = (
            capo_eventbridge.types.transformer_paths.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InputTransformer:
    ...
    if data.get("InputPathsMap") is not None:
        ...
        out["input_paths_map"] = (
            capo_eventbridge.types.transformer_paths.deserialize_aws_json_1_1(
                data["InputPathsMap"]
            )
        )
