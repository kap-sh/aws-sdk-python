...
class ListRuleNamesByTargetResponse(TypedDict, closed=True):
    rule_names: NotRequired["capo_eventbridge.types.rule_name_list.RuleNameList"]
...
def serialize_aws_json_1_1(value: ListRuleNamesByTargetResponse) -> dict:
    ...
    if "rule_names" in value:
        ...
        out["RuleNames"] = capo_eventbridge.types.rule_name_list.serialize_aws_json_1_1(
            value["rule_names"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListRuleNamesByTargetResponse:
    ...
    if data.get("RuleNames") is not None:
        ...
        out["rule_names"] = (
            capo_eventbridge.types.rule_name_list.deserialize_aws_json_1_1(
                data["RuleNames"]
            )
        )
