...
class ListRulesResponse(TypedDict, closed=True):
    rules: NotRequired["capo_eventbridge.types.rule_response_list.RuleResponseList"]
...
def serialize_aws_json_1_1(value: ListRulesResponse) -> dict:
    ...
    if "rules" in value:
        ...
        out["Rules"] = capo_eventbridge.types.rule_response_list.serialize_aws_json_1_1(
            value["rules"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListRulesResponse:
    ...
    if data.get("Rules") is not None:
        ...
        out["rules"] = (
            capo_eventbridge.types.rule_response_list.deserialize_aws_json_1_1(
                data["Rules"]
            )
        )
