...
from ._services.async_event_bridge import (
    AsyncEventBridgeClient as AsyncEventBridgeClient,
)
from ._services.event_bridge import EventBridgeClient as EventBridgeClient
