"""Generated from Smithy shape ``com.amazonaws.eventbridge#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.eventbridge#AccessDeniedException``."""
