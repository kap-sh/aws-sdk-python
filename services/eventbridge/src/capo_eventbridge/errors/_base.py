...
class EventBridgeError(Exception):
    """Base class for all EventBridge service errors."""


class ServiceError(EventBridgeError):
...
class SerializationError(EventBridgeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(EventBridgeError):
...
class WaiterFailedError(EventBridgeError):
...
class WaiterTimeoutError(EventBridgeError):
