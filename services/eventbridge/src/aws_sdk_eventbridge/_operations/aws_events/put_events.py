...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.put_events_response.PutEventsResponse = (
        aws_sdk_eventbridge.types.put_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.put_events_request.PutEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.put_events_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_events(
    ...
    aws_sdk_eventbridge.types.put_events_response.PutEventsResponse, zapros.Response
]:
