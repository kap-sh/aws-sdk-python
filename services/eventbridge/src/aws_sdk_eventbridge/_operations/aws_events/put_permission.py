...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.put_permission_request.PutPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.put_permission_request.serialize_aws_json_1_1(input_)
    ).encode()
