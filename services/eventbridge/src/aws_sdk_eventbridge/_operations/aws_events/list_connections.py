"""Generated from Smithy shape ``com.amazonaws.eventbridge#ListConnections``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.list_connections_response.ListConnectionsResponse = (
        aws_sdk_eventbridge.types.list_connections_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_eventbridge.types.list_connections_request.ListConnectionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.list_connections_request.serialize_aws_json_1_1(input)
    ).encode()
