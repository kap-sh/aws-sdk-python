...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.list_connections_request.ListConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.list_connections_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
