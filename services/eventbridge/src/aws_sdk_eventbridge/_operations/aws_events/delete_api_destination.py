"""Generated from Smithy shape ``com.amazonaws.eventbridge#DeleteApiDestination``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.delete_api_destination_response.DeleteApiDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.delete_api_destination_request.DeleteApiDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.delete_api_destination_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
