"""Generated from Smithy shape ``com.amazonaws.eventbridge#DescribeArchive``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.describe_archive_response.DescribeArchiveResponse = (
        aws_sdk_eventbridge.types.describe_archive_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_eventbridge.types.describe_archive_request.DescribeArchiveRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.describe_archive_request.serialize_aws_json_1_1(input)
    ).encode()
