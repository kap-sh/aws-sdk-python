...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.describe_archive_request.DescribeArchiveRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.describe_archive_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
