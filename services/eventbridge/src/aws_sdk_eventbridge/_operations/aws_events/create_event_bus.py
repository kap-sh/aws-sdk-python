...
def build_request(
    ...
    input: aws_sdk_eventbridge.types.create_event_bus_request.CreateEventBusRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.create_event_bus_request.serialize_aws_json_1_1(input)
    ).encode()
