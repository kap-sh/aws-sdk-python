...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.create_event_bus_request.CreateEventBusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.create_event_bus_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
