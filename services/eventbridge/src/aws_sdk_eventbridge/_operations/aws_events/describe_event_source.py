...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.describe_event_source_response.DescribeEventSourceResponse = aws_sdk_eventbridge.types.describe_event_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.describe_event_source_request.DescribeEventSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.describe_event_source_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
