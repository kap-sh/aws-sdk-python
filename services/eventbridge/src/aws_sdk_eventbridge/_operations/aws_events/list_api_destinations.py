"""Generated from Smithy shape ``com.amazonaws.eventbridge#ListApiDestinations``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.list_api_destinations_response.ListApiDestinationsResponse = aws_sdk_eventbridge.types.list_api_destinations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.list_api_destinations_request.ListApiDestinationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.list_api_destinations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
