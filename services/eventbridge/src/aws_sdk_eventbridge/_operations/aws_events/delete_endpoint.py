...
def build_request(
    ...
    input: aws_sdk_eventbridge.types.delete_endpoint_request.DeleteEndpointRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.delete_endpoint_request.serialize_aws_json_1_1(input)
    ).encode()
