"""Generated from Smithy shape ``com.amazonaws.eventbridge#StartReplay``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.start_replay_response.StartReplayResponse = (
        aws_sdk_eventbridge.types.start_replay_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.start_replay_request.StartReplayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.start_replay_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_replay(
    ...
    aws_sdk_eventbridge.types.start_replay_response.StartReplayResponse, zapros.Response
]:
