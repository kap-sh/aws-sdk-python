"""Generated from Smithy shape ``com.amazonaws.eventbridge#ActivateEventSource``."""
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.activate_event_source_request.ActivateEventSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.activate_event_source_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
