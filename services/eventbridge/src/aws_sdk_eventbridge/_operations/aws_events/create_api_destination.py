"""Generated from Smithy shape ``com.amazonaws.eventbridge#CreateApiDestination``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.create_api_destination_response.CreateApiDestinationResponse = aws_sdk_eventbridge.types.create_api_destination_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.create_api_destination_request.CreateApiDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.create_api_destination_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
