...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.list_partner_event_source_accounts_response.ListPartnerEventSourceAccountsResponse = aws_sdk_eventbridge.types.list_partner_event_source_accounts_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.list_partner_event_source_accounts_request.ListPartnerEventSourceAccountsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.list_partner_event_source_accounts_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
