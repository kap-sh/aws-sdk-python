...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.update_event_bus_response.UpdateEventBusResponse = (
        aws_sdk_eventbridge.types.update_event_bus_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_eventbridge.types.update_event_bus_request.UpdateEventBusRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.update_event_bus_request.serialize_aws_json_1_1(input)
    ).encode()
