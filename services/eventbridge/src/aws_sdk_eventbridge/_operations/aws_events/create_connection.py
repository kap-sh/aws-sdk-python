"""Generated from Smithy shape ``com.amazonaws.eventbridge#CreateConnection``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            import aws_sdk_eventbridge.errors.access_denied_exception

            raise aws_sdk_eventbridge.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data
            )
        ...
        case "ThrottlingException":
            import aws_sdk_eventbridge.errors.throttling_exception

            raise aws_sdk_eventbridge.errors.throttling_exception.ThrottlingException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.create_connection_response.CreateConnectionResponse = aws_sdk_eventbridge.types.create_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.create_connection_request.CreateConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSEvents.CreateConnection"
    import aws_sdk_eventbridge.types.create_connection_request

    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.create_connection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
