"""Generated from Smithy shape ``com.amazonaws.eventbridge#DescribeRule``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.describe_rule_response.DescribeRuleResponse = (
        aws_sdk_eventbridge.types.describe_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.describe_rule_request.DescribeRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.describe_rule_request.serialize_aws_json_1_1(input_)
    ).encode()
