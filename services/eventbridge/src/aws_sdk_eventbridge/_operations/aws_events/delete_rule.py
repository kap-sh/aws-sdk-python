"""Generated from Smithy shape ``com.amazonaws.eventbridge#DeleteRule``."""
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.delete_rule_request.DeleteRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.delete_rule_request.serialize_aws_json_1_1(input_)
    ).encode()
