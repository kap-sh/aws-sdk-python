"""Generated from Smithy shape ``com.amazonaws.eventbridge#DeletePartnerEventSource``."""
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.delete_partner_event_source_request.DeletePartnerEventSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.delete_partner_event_source_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
