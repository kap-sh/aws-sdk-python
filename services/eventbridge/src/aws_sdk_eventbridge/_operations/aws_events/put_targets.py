"""Generated from Smithy shape ``com.amazonaws.eventbridge#PutTargets``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.put_targets_response.PutTargetsResponse = (
        aws_sdk_eventbridge.types.put_targets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.put_targets_request.PutTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.put_targets_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_targets(
    ...
    aws_sdk_eventbridge.types.put_targets_response.PutTargetsResponse, zapros.Response
]:
