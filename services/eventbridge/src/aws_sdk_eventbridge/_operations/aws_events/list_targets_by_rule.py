"""Generated from Smithy shape ``com.amazonaws.eventbridge#ListTargetsByRule``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.list_targets_by_rule_response.ListTargetsByRuleResponse = aws_sdk_eventbridge.types.list_targets_by_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.list_targets_by_rule_request.ListTargetsByRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.list_targets_by_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
