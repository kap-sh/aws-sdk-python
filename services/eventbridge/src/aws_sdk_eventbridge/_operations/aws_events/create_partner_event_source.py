...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.create_partner_event_source_response.CreatePartnerEventSourceResponse = aws_sdk_eventbridge.types.create_partner_event_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.create_partner_event_source_request.CreatePartnerEventSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.create_partner_event_source_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
