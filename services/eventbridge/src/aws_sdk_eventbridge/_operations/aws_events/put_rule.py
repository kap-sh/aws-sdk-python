...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.put_rule_response.PutRuleResponse = (
        aws_sdk_eventbridge.types.put_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.put_rule_request.PutRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.put_rule_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_rule(
    ...
    aws_sdk_eventbridge.types.put_rule_response.PutRuleResponse, zapros.Response
]:
