"""Generated from Smithy shape ``com.amazonaws.eventbridge#DeleteConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.delete_connection_response.DeleteConnectionResponse = aws_sdk_eventbridge.types.delete_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.delete_connection_request.DeleteConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.delete_connection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
