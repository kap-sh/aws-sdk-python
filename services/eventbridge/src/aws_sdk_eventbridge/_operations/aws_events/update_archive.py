"""Generated from Smithy shape ``com.amazonaws.eventbridge#UpdateArchive``."""
...
import aws_sdk_eventbridge.errors.invalid_event_pattern_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidEventPatternException":
            raise aws_sdk_eventbridge.errors.invalid_event_pattern_exception.InvalidEventPatternException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.update_archive_response.UpdateArchiveResponse = (
        aws_sdk_eventbridge.types.update_archive_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.update_archive_request.UpdateArchiveRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.update_archive_request.serialize_aws_json_1_1(input_)
    ).encode()
