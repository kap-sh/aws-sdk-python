...
def build_request(
    ...
    input: aws_sdk_eventbridge.types.update_archive_request.UpdateArchiveRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.update_archive_request.serialize_aws_json_1_1(input)
    ).encode()
