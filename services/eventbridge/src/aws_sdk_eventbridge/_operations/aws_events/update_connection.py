"""Generated from Smithy shape ``com.amazonaws.eventbridge#UpdateConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.update_connection_response.UpdateConnectionResponse = aws_sdk_eventbridge.types.update_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.update_connection_request.UpdateConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.update_connection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
