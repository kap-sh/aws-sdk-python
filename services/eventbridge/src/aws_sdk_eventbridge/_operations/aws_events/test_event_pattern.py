...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.test_event_pattern_response.TestEventPatternResponse = aws_sdk_eventbridge.types.test_event_pattern_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.test_event_pattern_request.TestEventPatternRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.test_event_pattern_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
