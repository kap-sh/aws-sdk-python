"""Generated from Smithy shape ``com.amazonaws.eventbridge#CancelReplay``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IllegalStatusException":
            import aws_sdk_eventbridge.errors.illegal_status_exception

            raise aws_sdk_eventbridge.errors.illegal_status_exception.IllegalStatusException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.cancel_replay_response.CancelReplayResponse = (
        aws_sdk_eventbridge.types.cancel_replay_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.cancel_replay_request.CancelReplayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.cancel_replay_request.serialize_aws_json_1_1(input_)
    ).encode()
