"""Generated from Smithy shape ``com.amazonaws.eventbridge#DeleteEventBus``."""
...
def build_request(
    ...
    input: aws_sdk_eventbridge.types.delete_event_bus_request.DeleteEventBusRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.delete_event_bus_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_delete_event_bus(
