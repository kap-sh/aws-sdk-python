"""Generated from Smithy shape ``com.amazonaws.eventbridge#ListArchives``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.list_archives_response.ListArchivesResponse = (
        aws_sdk_eventbridge.types.list_archives_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.list_archives_request.ListArchivesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.list_archives_request.serialize_aws_json_1_1(input_)
    ).encode()
