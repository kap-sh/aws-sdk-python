"""Generated from Smithy shape ``com.amazonaws.eventbridge#DisableRule``."""
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.disable_rule_request.DisableRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.disable_rule_request.serialize_aws_json_1_1(input_)
    ).encode()
