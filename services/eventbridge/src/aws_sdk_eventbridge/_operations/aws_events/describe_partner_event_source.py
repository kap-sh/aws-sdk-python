"""Generated from Smithy shape ``com.amazonaws.eventbridge#DescribePartnerEventSource``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.describe_partner_event_source_response.DescribePartnerEventSourceResponse = aws_sdk_eventbridge.types.describe_partner_event_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.describe_partner_event_source_request.DescribePartnerEventSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.describe_partner_event_source_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_partner_event_source(
