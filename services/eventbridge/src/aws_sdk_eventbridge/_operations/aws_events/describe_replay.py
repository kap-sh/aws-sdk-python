...
def build_request(
    ...
    input: aws_sdk_eventbridge.types.describe_replay_request.DescribeReplayRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.describe_replay_request.serialize_aws_json_1_1(input)
    ).encode()
