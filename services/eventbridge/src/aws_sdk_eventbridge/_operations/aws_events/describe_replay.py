"""Generated from Smithy shape ``com.amazonaws.eventbridge#DescribeReplay``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.describe_replay_response.DescribeReplayResponse = (
        aws_sdk_eventbridge.types.describe_replay_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.describe_replay_request.DescribeReplayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.describe_replay_request.serialize_aws_json_1_1(input_)
    ).encode()
