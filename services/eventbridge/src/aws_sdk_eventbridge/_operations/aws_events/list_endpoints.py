...
def build_request(
    ...
    input: aws_sdk_eventbridge.types.list_endpoints_request.ListEndpointsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.list_endpoints_request.serialize_aws_json_1_1(input)
    ).encode()
