"""Generated from Smithy shape ``com.amazonaws.eventbridge#ListRuleNamesByTarget``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.list_rule_names_by_target_response.ListRuleNamesByTargetResponse = aws_sdk_eventbridge.types.list_rule_names_by_target_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.list_rule_names_by_target_request.ListRuleNamesByTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.list_rule_names_by_target_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_rule_names_by_target(
