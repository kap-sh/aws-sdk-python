...
def build_request(
    ...
    input: aws_sdk_eventbridge.types.remove_targets_request.RemoveTargetsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.remove_targets_request.serialize_aws_json_1_1(input)
    ).encode()
