"""Generated from Smithy shape ``com.amazonaws.eventbridge#EnableRule``."""
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.enable_rule_request.EnableRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.enable_rule_request.serialize_aws_json_1_1(input_)
    ).encode()
