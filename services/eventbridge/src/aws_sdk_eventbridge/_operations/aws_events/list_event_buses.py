"""Generated from Smithy shape ``com.amazonaws.eventbridge#ListEventBuses``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.list_event_buses_response.ListEventBusesResponse = (
        aws_sdk_eventbridge.types.list_event_buses_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_eventbridge.types.list_event_buses_request.ListEventBusesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.list_event_buses_request.serialize_aws_json_1_1(input)
    ).encode()
