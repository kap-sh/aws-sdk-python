"""Generated from Smithy shape ``com.amazonaws.eventbridge#RemovePermission``."""
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.remove_permission_request.RemovePermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.remove_permission_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
