"""Generated from Smithy shape ``com.amazonaws.eventbridge#CreateArchive``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.create_archive_response.CreateArchiveResponse = (
        aws_sdk_eventbridge.types.create_archive_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.create_archive_request.CreateArchiveRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.create_archive_request.serialize_aws_json_1_1(input_)
    ).encode()
