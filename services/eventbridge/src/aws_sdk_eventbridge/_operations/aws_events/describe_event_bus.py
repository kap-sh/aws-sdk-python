"""Generated from Smithy shape ``com.amazonaws.eventbridge#DescribeEventBus``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.describe_event_bus_response.DescribeEventBusResponse = aws_sdk_eventbridge.types.describe_event_bus_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.describe_event_bus_request.DescribeEventBusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.describe_event_bus_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
