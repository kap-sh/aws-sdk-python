"""Generated from Smithy shape ``com.amazonaws.eventbridge#DescribeEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.describe_endpoint_response.DescribeEndpointResponse = aws_sdk_eventbridge.types.describe_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.describe_endpoint_request.DescribeEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSEvents.DescribeEndpoint"
    import aws_sdk_eventbridge.types.describe_endpoint_request

    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.describe_endpoint_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
