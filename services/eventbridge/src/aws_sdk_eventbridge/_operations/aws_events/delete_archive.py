"""Generated from Smithy shape ``com.amazonaws.eventbridge#DeleteArchive``."""
...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.delete_archive_response.DeleteArchiveResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.delete_archive_request.DeleteArchiveRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSEvents.DeleteArchive"
    import aws_sdk_eventbridge.types.delete_archive_request

    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.delete_archive_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_archive(
