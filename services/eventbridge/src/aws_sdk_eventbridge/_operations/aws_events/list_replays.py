...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.list_replays_response.ListReplaysResponse = (
        aws_sdk_eventbridge.types.list_replays_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.list_replays_request.ListReplaysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.list_replays_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_replays(
    ...
    aws_sdk_eventbridge.types.list_replays_response.ListReplaysResponse, zapros.Response
]:
