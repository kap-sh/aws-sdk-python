...
def handle_response(
    ...
    out: aws_sdk_eventbridge.types.deauthorize_connection_response.DeauthorizeConnectionResponse = aws_sdk_eventbridge.types.deauthorize_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_eventbridge.types.deauthorize_connection_request.DeauthorizeConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_eventbridge.types.deauthorize_connection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
