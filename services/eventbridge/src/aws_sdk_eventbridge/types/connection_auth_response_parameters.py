...
if TYPE_CHECKING:
    import aws_sdk_eventbridge.types.connection_api_key_auth_response_parameters
    import aws_sdk_eventbridge.types.connection_basic_auth_response_parameters
    import aws_sdk_eventbridge.types.connection_http_parameters
    import aws_sdk_eventbridge.types.connection_o_auth_response_parameters
...
class ConnectionAuthResponseParameters(TypedDict):
    basic_auth_parameters: NotRequired[
        "aws_sdk_eventbridge.types.connection_basic_auth_response_parameters.ConnectionBasicAuthResponseParameters"
    ]
    """<p>The authorization parameters for Basic authorization.</p>"""
    o_auth_parameters: NotRequired[
        "aws_sdk_eventbridge.types.connection_o_auth_response_parameters.ConnectionOAuthResponseParameters"
    ]
    """<p>The OAuth parameters to use for authorization.</p>"""
    api_key_auth_parameters: NotRequired[
        "aws_sdk_eventbridge.types.connection_api_key_auth_response_parameters.ConnectionApiKeyAuthResponseParameters"
    ]
...
def serialize_aws_json_1_1(value: ConnectionAuthResponseParameters) -> dict:
    ...
    if "basic_auth_parameters" in value:
        ...
        out["BasicAuthParameters"] = (
            aws_sdk_eventbridge.types.connection_basic_auth_response_parameters.serialize_aws_json_1_1(
    ...
    if "o_auth_parameters" in value:
        ...
        out["OAuthParameters"] = (
            aws_sdk_eventbridge.types.connection_o_auth_response_parameters.serialize_aws_json_1_1(
    ...
    if "api_key_auth_parameters" in value:
        ...
        out["ApiKeyAuthParameters"] = (
            aws_sdk_eventbridge.types.connection_api_key_auth_response_parameters.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ConnectionAuthResponseParameters:
    ...
    if "BasicAuthParameters" in data:
        ...
        out["basic_auth_parameters"] = (
            aws_sdk_eventbridge.types.connection_basic_auth_response_parameters.deserialize_aws_json_1_1(
    ...
    if "OAuthParameters" in data:
        ...
        out["o_auth_parameters"] = (
            aws_sdk_eventbridge.types.connection_o_auth_response_parameters.deserialize_aws_json_1_1(
    ...
    if "ApiKeyAuthParameters" in data:
        ...
        out["api_key_auth_parameters"] = (
            aws_sdk_eventbridge.types.connection_api_key_auth_response_parameters.deserialize_aws_json_1_1(
