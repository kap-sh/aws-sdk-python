...
if TYPE_CHECKING:
    import aws_sdk_eventbridge.types.connection_query_string_parameter

ConnectionQueryStringParametersList: TypeAlias = list[
    "aws_sdk_eventbridge.types.connection_query_string_parameter.ConnectionQueryStringParameter"
]
...
def serialize_aws_json_1_1(value: ConnectionQueryStringParametersList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_eventbridge.types.connection_query_string_parameter.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ConnectionQueryStringParametersList:
    ...
    for item in data:
        out.append(
            aws_sdk_eventbridge.types.connection_query_string_parameter.deserialize_aws_json_1_1(
                item
            )
        )
    return out
