...
if TYPE_CHECKING:
    import aws_sdk_eventbridge.types.placement_constraint_expression
    import aws_sdk_eventbridge.types.placement_constraint_type


class PlacementConstraint(TypedDict):
    type: NotRequired[
        "aws_sdk_eventbridge.types.placement_constraint_type.PlacementConstraintType"
    ]
...
def serialize_aws_json_1_1(value: PlacementConstraint) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = (
            aws_sdk_eventbridge.types.placement_constraint_type.serialize_aws_json_1_1(
                value["type"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> PlacementConstraint:
    ...
    if "type" in data:
        ...
        out["type"] = (
            aws_sdk_eventbridge.types.placement_constraint_type.deserialize_aws_json_1_1(
                data["type"]
            )
        )
