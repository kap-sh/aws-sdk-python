...
def serialize_aws_json_1_1(value: UpdateConnectionRequest) -> dict:
    ...
    if "auth_parameters" in value:
        ...
        out["AuthParameters"] = (
            aws_sdk_eventbridge.types.update_connection_auth_request_parameters.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateConnectionRequest:
    ...
    if "AuthParameters" in data:
        ...
        out["auth_parameters"] = (
            aws_sdk_eventbridge.types.update_connection_auth_request_parameters.deserialize_aws_json_1_1(
                data["AuthParameters"]
            )
        )
