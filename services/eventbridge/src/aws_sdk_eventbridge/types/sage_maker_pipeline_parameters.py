...
if TYPE_CHECKING:
    import aws_sdk_eventbridge.types.sage_maker_pipeline_parameter_list


class SageMakerPipelineParameters(TypedDict, closed=True):
    pipeline_parameter_list: NotRequired[
        "aws_sdk_eventbridge.types.sage_maker_pipeline_parameter_list.SageMakerPipelineParameterList"
    ]
...
def serialize_aws_json_1_1(value: SageMakerPipelineParameters) -> dict:
    ...
    if "pipeline_parameter_list" in value:
        ...
        out["PipelineParameterList"] = (
            aws_sdk_eventbridge.types.sage_maker_pipeline_parameter_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SageMakerPipelineParameters:
    ...
    if "PipelineParameterList" in data:
        ...
        out["pipeline_parameter_list"] = (
            aws_sdk_eventbridge.types.sage_maker_pipeline_parameter_list.deserialize_aws_json_1_1(
