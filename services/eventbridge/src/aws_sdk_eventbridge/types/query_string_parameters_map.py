...
if TYPE_CHECKING:
    ...
    import aws_sdk_eventbridge.types.query_string_value

QueryStringParametersMap: TypeAlias = dict[
    "aws_sdk_eventbridge.types.query_string_key.QueryStringKey",
    "aws_sdk_eventbridge.types.query_string_value.QueryStringValue",
]
