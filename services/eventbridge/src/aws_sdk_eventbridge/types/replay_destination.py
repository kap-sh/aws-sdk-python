...
if TYPE_CHECKING:
    ...
    import aws_sdk_eventbridge.types.replay_destination_filters


class ReplayDestination(TypedDict, closed=True):
    arn: "aws_sdk_eventbridge.types.arn.Arn"
    ...
    filter_arns: NotRequired[
        "aws_sdk_eventbridge.types.replay_destination_filters.ReplayDestinationFilters"
    ]
...
def serialize_aws_json_1_1(value: ReplayDestination) -> dict:
    ...
    if "filter_arns" in value:
        ...
        out["FilterArns"] = (
            aws_sdk_eventbridge.types.replay_destination_filters.serialize_aws_json_1_1(
                value["filter_arns"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ReplayDestination:
    ...
    if "FilterArns" in data:
        ...
        out["filter_arns"] = (
            aws_sdk_eventbridge.types.replay_destination_filters.deserialize_aws_json_1_1(
                data["FilterArns"]
            )
        )
    return out
