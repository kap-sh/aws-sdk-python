...
if TYPE_CHECKING:
    import aws_sdk_eventbridge.types.connection

ConnectionResponseList: TypeAlias = list[
    "aws_sdk_eventbridge.types.connection.Connection"
]
...
def serialize_aws_json_1_1(value: ConnectionResponseList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_eventbridge.types.connection.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> ConnectionResponseList:
    ...
    for item in data:
        out.append(aws_sdk_eventbridge.types.connection.deserialize_aws_json_1_1(item))
    return out
