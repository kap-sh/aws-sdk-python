"""Generated from Smithy shape ``com.amazonaws.eventbridge#CapacityProviderStrategyItem``."""
...
if TYPE_CHECKING:
    import aws_sdk_eventbridge.types.capacity_provider
    import aws_sdk_eventbridge.types.capacity_provider_strategy_item_base
    import aws_sdk_eventbridge.types.capacity_provider_strategy_item_weight


class CapacityProviderStrategyItem(TypedDict, closed=True):
    capacity_provider: "aws_sdk_eventbridge.types.capacity_provider.CapacityProvider"
    """<p>The short name of the capacity provider.</p>"""
    weight: "aws_sdk_eventbridge.types.capacity_provider_strategy_item_weight.CapacityProviderStrategyItemWeight"
    ...
    base: "aws_sdk_eventbridge.types.capacity_provider_strategy_item_base.CapacityProviderStrategyItemBase"
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CapacityProviderStrategyItem) -> dict:
    out: dict = {}
