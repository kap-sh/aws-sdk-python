...
if TYPE_CHECKING:
    ...
    import aws_sdk_eventbridge.types.connection_o_auth_client_response_parameters
...
class ConnectionOAuthResponseParameters(TypedDict):
    client_parameters: NotRequired[
        "aws_sdk_eventbridge.types.connection_o_auth_client_response_parameters.ConnectionOAuthClientResponseParameters"
    ]
...
def serialize_aws_json_1_1(value: ConnectionOAuthResponseParameters) -> dict:
    ...
    if "client_parameters" in value:
        ...
        out["ClientParameters"] = (
            aws_sdk_eventbridge.types.connection_o_auth_client_response_parameters.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ConnectionOAuthResponseParameters:
    ...
    if "ClientParameters" in data:
        ...
        out["client_parameters"] = (
            aws_sdk_eventbridge.types.connection_o_auth_client_response_parameters.deserialize_aws_json_1_1(
