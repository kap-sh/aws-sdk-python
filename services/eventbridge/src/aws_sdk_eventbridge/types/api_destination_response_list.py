...
if TYPE_CHECKING:
    import aws_sdk_eventbridge.types.api_destination

ApiDestinationResponseList: TypeAlias = list[
    "aws_sdk_eventbridge.types.api_destination.ApiDestination"
]
...
def serialize_aws_json_1_1(value: ApiDestinationResponseList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_eventbridge.types.api_destination.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ApiDestinationResponseList:
    ...
    for item in data:
        out.append(
            aws_sdk_eventbridge.types.api_destination.deserialize_aws_json_1_1(item)
        )
    return out
