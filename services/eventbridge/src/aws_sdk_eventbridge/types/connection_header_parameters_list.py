...
if TYPE_CHECKING:
    import aws_sdk_eventbridge.types.connection_header_parameter

ConnectionHeaderParametersList: TypeAlias = list[
    "aws_sdk_eventbridge.types.connection_header_parameter.ConnectionHeaderParameter"
]
...
def serialize_aws_json_1_1(value: ConnectionHeaderParametersList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_eventbridge.types.connection_header_parameter.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ConnectionHeaderParametersList:
    ...
    for item in data:
        out.append(
            aws_sdk_eventbridge.types.connection_header_parameter.deserialize_aws_json_1_1(
                item
            )
        )
    return out
