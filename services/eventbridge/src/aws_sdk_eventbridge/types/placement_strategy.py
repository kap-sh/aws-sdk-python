...
class PlacementStrategy(TypedDict):
    ...
    field: NotRequired[
        "aws_sdk_eventbridge.types.placement_strategy_field.PlacementStrategyField"
    ]
...
def serialize_aws_json_1_1(value: PlacementStrategy) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = (
            aws_sdk_eventbridge.types.placement_strategy_type.serialize_aws_json_1_1(
                value["type"]
            )
        )
    if "field" in value:
...
def deserialize_aws_json_1_1(data: dict) -> PlacementStrategy:
    ...
    if "type" in data:
        ...
        out["type"] = (
            aws_sdk_eventbridge.types.placement_strategy_type.deserialize_aws_json_1_1(
                data["type"]
            )
        )
    if "field" in data:
