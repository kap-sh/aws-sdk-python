...
if TYPE_CHECKING:
    ...
    import aws_sdk_eventbridge.types.sensitive_string
    import aws_sdk_eventbridge.types.string


class ConnectionBodyParameter(TypedDict):
    key: NotRequired["aws_sdk_eventbridge.types.string.String"]
    """<p>The key for the parameter.</p>"""
    value: NotRequired["aws_sdk_eventbridge.types.sensitive_string.SensitiveString"]
