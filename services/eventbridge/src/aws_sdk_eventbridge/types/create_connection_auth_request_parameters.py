...
if TYPE_CHECKING:
    ...
    import aws_sdk_eventbridge.types.create_connection_api_key_auth_request_parameters
    import aws_sdk_eventbridge.types.create_connection_basic_auth_request_parameters
    import aws_sdk_eventbridge.types.create_connection_o_auth_request_parameters


class CreateConnectionAuthRequestParameters(TypedDict):
    basic_auth_parameters: NotRequired[
        "aws_sdk_eventbridge.types.create_connection_basic_auth_request_parameters.CreateConnectionBasicAuthRequestParameters"
    ]
    """<p>The Basic authorization parameters to use for the connection.</p>"""
    o_auth_parameters: NotRequired[
        "aws_sdk_eventbridge.types.create_connection_o_auth_request_parameters.CreateConnectionOAuthRequestParameters"
    ]
    """<p>The OAuth authorization parameters to use for the connection.</p>"""
    api_key_auth_parameters: NotRequired[
        "aws_sdk_eventbridge.types.create_connection_api_key_auth_request_parameters.CreateConnectionApiKeyAuthRequestParameters"
    ]
...
def serialize_aws_json_1_1(value: CreateConnectionAuthRequestParameters) -> dict:
    ...
    if "basic_auth_parameters" in value:
        ...
        out["BasicAuthParameters"] = (
            aws_sdk_eventbridge.types.create_connection_basic_auth_request_parameters.serialize_aws_json_1_1(
    ...
    if "o_auth_parameters" in value:
        ...
        out["OAuthParameters"] = (
            aws_sdk_eventbridge.types.create_connection_o_auth_request_parameters.serialize_aws_json_1_1(
    ...
    if "api_key_auth_parameters" in value:
        ...
        out["ApiKeyAuthParameters"] = (
            aws_sdk_eventbridge.types.create_connection_api_key_auth_request_parameters.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CreateConnectionAuthRequestParameters:
    ...
    if "BasicAuthParameters" in data:
        ...
        out["basic_auth_parameters"] = (
            aws_sdk_eventbridge.types.create_connection_basic_auth_request_parameters.deserialize_aws_json_1_1(
    ...
    if "OAuthParameters" in data:
        ...
        out["o_auth_parameters"] = (
            aws_sdk_eventbridge.types.create_connection_o_auth_request_parameters.deserialize_aws_json_1_1(
    ...
    if "ApiKeyAuthParameters" in data:
        ...
        out["api_key_auth_parameters"] = (
            aws_sdk_eventbridge.types.create_connection_api_key_auth_request_parameters.deserialize_aws_json_1_1(
