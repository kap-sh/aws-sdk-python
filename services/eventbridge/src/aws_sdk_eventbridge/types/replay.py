...
class Replay(TypedDict):
    ...
    event_start_time: NotRequired["aws_sdk_eventbridge.types.timestamp.Timestamp"]
    ...
    event_end_time: NotRequired["aws_sdk_eventbridge.types.timestamp.Timestamp"]
    ...
    event_last_replayed_time: NotRequired[
        "aws_sdk_eventbridge.types.timestamp.Timestamp"
    ]
    ...
    replay_end_time: NotRequired["aws_sdk_eventbridge.types.timestamp.Timestamp"]
