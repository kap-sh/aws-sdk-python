...
if TYPE_CHECKING:
    ...
    import aws_sdk_eventbridge.types.create_connection_o_auth_client_request_parameters
...
class CreateConnectionOAuthRequestParameters(TypedDict):
    ...
    http_method: "aws_sdk_eventbridge.types.connection_o_auth_http_method.ConnectionOAuthHttpMethod"
...
def serialize_aws_json_1_1(value: CreateConnectionOAuthRequestParameters) -> dict:
    ...
    out["ClientParameters"] = (
        aws_sdk_eventbridge.types.create_connection_o_auth_client_request_parameters.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CreateConnectionOAuthRequestParameters:
    ...
    if "ClientParameters" in data:
        ...
        out["client_parameters"] = (
            aws_sdk_eventbridge.types.create_connection_o_auth_client_request_parameters.deserialize_aws_json_1_1(
