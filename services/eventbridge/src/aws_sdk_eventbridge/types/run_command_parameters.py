...
if TYPE_CHECKING:
    import aws_sdk_eventbridge.types.run_command_targets


class RunCommandParameters(TypedDict, closed=True):
    run_command_targets: (
        "aws_sdk_eventbridge.types.run_command_targets.RunCommandTargets"
    )
...
def serialize_aws_json_1_1(value: RunCommandParameters) -> dict:
    ...
    out["RunCommandTargets"] = (
        aws_sdk_eventbridge.types.run_command_targets.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RunCommandParameters:
    ...
    if "RunCommandTargets" in data:
        ...
        out["run_command_targets"] = (
            aws_sdk_eventbridge.types.run_command_targets.deserialize_aws_json_1_1(
