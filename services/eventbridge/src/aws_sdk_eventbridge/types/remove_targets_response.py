...
class RemoveTargetsResponse(TypedDict):
    failed_entry_count: "aws_sdk_eventbridge.types.integer.Integer"
    """<p>The number of failed entries.</p>"""
    failed_entries: NotRequired[
        "aws_sdk_eventbridge.types.remove_targets_result_entry_list.RemoveTargetsResultEntryList"
    ]
...
def serialize_aws_json_1_1(value: RemoveTargetsResponse) -> dict:
    ...
    if "failed_entries" in value:
        ...
        out["FailedEntries"] = (
            aws_sdk_eventbridge.types.remove_targets_result_entry_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RemoveTargetsResponse:
    ...
    if "FailedEntries" in data:
        ...
        out["failed_entries"] = (
            aws_sdk_eventbridge.types.remove_targets_result_entry_list.deserialize_aws_json_1_1(
                data["FailedEntries"]
            )
        )
    return out
