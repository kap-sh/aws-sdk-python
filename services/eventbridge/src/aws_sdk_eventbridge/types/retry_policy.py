"""Generated from Smithy shape ``com.amazonaws.eventbridge#RetryPolicy``."""
...
if TYPE_CHECKING:
    import aws_sdk_eventbridge.types.maximum_event_age_in_seconds
    import aws_sdk_eventbridge.types.maximum_retry_attempts


class RetryPolicy(TypedDict):
    maximum_retry_attempts: NotRequired[
        "aws_sdk_eventbridge.types.maximum_retry_attempts.MaximumRetryAttempts"
    ]
    ...
    maximum_event_age_in_seconds: NotRequired[
        "aws_sdk_eventbridge.types.maximum_event_age_in_seconds.MaximumEventAgeInSeconds"
    ]
