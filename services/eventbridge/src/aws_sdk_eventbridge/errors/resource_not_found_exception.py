"""Generated from Smithy shape ``com.amazonaws.eventbridge#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.eventbridge#ResourceNotFoundException``."""
