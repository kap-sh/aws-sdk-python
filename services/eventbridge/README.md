...
```
pip install aws-sdk-eventbridge
```

## Usage

```python
from aws_sdk_eventbridge import AsyncEventBridgeClient


async def main():
    async with AsyncEventBridgeClient() as s3:
...
```python
from aws_sdk_eventbridge import AsyncEventBridgeClient
from aws_sdk_eventbridge.error import ConcurrentModificationException
