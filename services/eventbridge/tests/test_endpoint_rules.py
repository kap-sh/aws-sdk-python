...
def test_53_valid_endpointid_with_custom_sdk_endpoint():
...
def test_57_dualstack_non_fips_endpoint___us_gov_east_1():
...
def test_61_dualstack_non_fips_endpoint___us_gov_west_1():
