...
from aws_sdk_eventbridge._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_1_for_region_af_south_1_with_fips_disabled():
    ...
    assert result.url == 'https://events.af-south-1.amazonaws.com'
...
def test_2_for_region_ap_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://events.ap-east-1.amazonaws.com'
...
def test_3_for_region_ap_northeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://events.ap-northeast-1.amazonaws.com'
...
def test_4_for_region_ap_northeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://events.ap-northeast-2.amazonaws.com'
...
def test_5_for_region_ap_northeast_3_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://events.ap-northeast-3.amazonaws.com'
...
def test_6_for_region_ap_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://events.ap-south-1.amazonaws.com'
...
def test_7_for_region_ap_southeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://events.ap-southeast-1.amazonaws.com'
...
def test_8_for_region_ap_southeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://events.ap-southeast-2.amazonaws.com'
...
def test_9_for_region_ap_southeast_3_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://events.ap-southeast-3.amazonaws.com'
...
def test_10_for_region_ca_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://events.ca-central-1.amazonaws.com'
...
def test_11_for_region_eu_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://events.eu-central-1.amazonaws.com'
...
def test_12_for_region_eu_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://events.eu-north-1.amazonaws.com'
...
def test_13_for_region_eu_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://events.eu-south-1.amazonaws.com'
...
def test_14_for_region_eu_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://events.eu-west-1.amazonaws.com'
...
def test_15_for_region_eu_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://events.eu-west-2.amazonaws.com'
...
def test_16_for_region_eu_west_3_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://events.eu-west-3.amazonaws.com'
...
def test_17_for_region_me_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://events.me-south-1.amazonaws.com'
...
def test_18_for_region_sa_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://events.sa-east-1.amazonaws.com'
...
def test_19_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://events.us-east-1.amazonaws.com'
...
def test_20_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://events-fips.us-east-1.amazonaws.com'
...
def test_21_for_region_us_east_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://events.us-east-2.amazonaws.com'
...
def test_22_for_region_us_east_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://events-fips.us-east-2.amazonaws.com'
...
def test_23_for_region_us_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://events.us-west-1.amazonaws.com'
...
def test_24_for_region_us_west_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://events-fips.us-west-1.amazonaws.com'
...
def test_25_for_region_us_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://events.us-west-2.amazonaws.com'
...
def test_26_for_region_us_west_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://events-fips.us-west-2.amazonaws.com'
...
def test_27_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://events-fips.us-east-1.api.aws'
...
def test_28_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://events.us-east-1.api.aws'
...
def test_29_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://events.cn-north-1.amazonaws.com.cn'
...
def test_30_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://events.cn-northwest-1.amazonaws.com.cn'
...
def test_31_for_region_cn_north_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://events-fips.cn-north-1.api.amazonwebservices.com.cn'
...
def test_32_for_region_cn_north_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://events-fips.cn-north-1.amazonaws.com.cn'
...
def test_33_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://events.cn-north-1.api.amazonwebservices.com.cn'
...
def test_34_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://events.us-gov-east-1.amazonaws.com'

def test_35_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://events.us-gov-west-1.amazonaws.com'
...
def test_36_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://events.us-gov-east-1.api.aws'

def test_37_for_region_us_iso_east_1_with_fips_disab():
    """For region us-iso-east-1 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-iso-east-1', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://events.us-iso-east-1.c2s.ic.gov'

def test_38_for_region_us_iso_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://events.us-iso-west-1.c2s.ic.gov'

def test_39_for_region_us_iso_east_1_with_fips_enabl():
    """For region us-iso-east-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='us-iso-east-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://events-fips.us-iso-east-1.c2s.ic.gov'

def test_40_for_region_us_isob_east_1_with_fips_disa():
    """For region us-isob-east-1 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-isob-east-1', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://events.us-isob-east-1.sc2s.sgov.gov'

def test_41_for_region_us_isob_east_1_with_fips_enab():
    """For region us-isob-east-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='us-isob-east-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://events-fips.us-isob-east-1.sc2s.sgov.gov'

def test_42_for_custom_endpoint_with_region_set_and_():
    """For custom endpoint with region set and fips disabled and dualstack disabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=False, UseDualStack=False, Endpoint='https://example.com')
    result = resolve(params)
    assert result.url == 'https://example.com'

def test_43_for_custom_endpoint_with_region_not_set_():
    """For custom endpoint with region not set and fips disabled and dualstack disabled"""
    params = EndpointParams(UseFIPS=False, UseDualStack=False, Endpoint='https://example.com')
    result = resolve(params)
    assert result.url == 'https://example.com'

def test_44_for_custom_endpoint_with_fips_enabled_an():
...
def test_45_for_custom_endpoint_with_fips_disabled_a():
...
def test_47_valid_endpointid_with_fips_disabled_and_():
    ...
    result = resolve(params)
    assert result.url == 'https://abc123.456def.endpoint.events.amazonaws.com'

def test_48_valid_endpointid_with_dualstack_disabled():
    """Valid EndpointId with dualstack disabled and fips enabled"""
    params = EndpointParams(EndpointId='abc123.456def', UseDualStack=False, UseFIPS=True, Region='us-east-1')
    with pytest.raises(EndpointError, match=re.escape('Invalid Configuration: FIPS is not supported with EventBridge multi-region endpoints.')):
        resolve(params)

def test_49_valid_endpointid_with_dualstack_enabled_():
    """Valid EndpointId with dualstack enabled and fips enabled"""
    params = EndpointParams(EndpointId='abc123.456def', UseDualStack=True, UseFIPS=True, Region='us-east-1')
    with pytest.raises(EndpointError, match=re.escape('Invalid Configuration: FIPS is not supported with EventBridge multi-region endpoints.')):
        resolve(params)

def test_50_invalid_endpointid():
    """Invalid EndpointId"""
    params = EndpointParams(EndpointId='badactor.com?foo=bar', UseDualStack=False, UseFIPS=False, Region='us-east-1')
    with pytest.raises(EndpointError, match=re.escape('EndpointId must be a valid host label.')):
        resolve(params)

def test_51_invalid_endpointid__empty_():
    """Invalid EndpointId (empty)"""
    params = EndpointParams(EndpointId='', UseDualStack=False, UseFIPS=False, Region='us-east-1')
    with pytest.raises(EndpointError, match=re.escape('EndpointId must be a valid host label.')):
        resolve(params)

def test_52_valid_endpointid_with_fips_disabled_and_():
    """Valid endpointId with fips disabled and dualstack true"""
    params = EndpointParams(EndpointId='abc123.456def', UseDualStack=True, UseFIPS=False, Region='us-east-1')
    result = resolve(params)
    assert result.url == 'https://abc123.456def.endpoint.events.api.aws'

def test_53_valid_endpointid_with_custom_sdk_endpoin():
    """Valid endpointId with custom sdk endpoint"""
    params = EndpointParams(EndpointId='abc123.456def', UseDualStack=True, UseFIPS=False, Region='us-east-1', Endpoint='https://example.com')
    result = resolve(params)
    assert result.url == 'https://example.com'

def test_54_legacy_fips_endpoint___us_gov_east_1():
    """legacy fips endpoint @ us-gov-east-1"""
    params = EndpointParams(Region='us-gov-east-1', UseDualStack=False, UseFIPS=True)
    result = resolve(params)
    assert result.url == 'https://events.us-gov-east-1.amazonaws.com'

def test_55_legacy_non_fips_endpoint___us_gov_east_1():
    """legacy non-fips endpoint @ us-gov-east-1"""
    params = EndpointParams(Region='us-gov-east-1', UseDualStack=False, UseFIPS=False)
    result = resolve(params)
    assert result.url == 'https://events.us-gov-east-1.amazonaws.com'

def test_56_dualstack_fips_endpoint___us_gov_east_1():
    """Dualstack fips endpoint @ us-gov-east-1"""
    params = EndpointParams(Region='us-gov-east-1', UseDualStack=True, UseFIPS=True)
    result = resolve(params)
    assert result.url == 'https://events.us-gov-east-1.api.aws'

def test_57_dualstack_non_fips_endpoint___us_gov_eas():
    """Dualstack non-fips endpoint @ us-gov-east-1"""
    params = EndpointParams(Region='us-gov-east-1', UseDualStack=True, UseFIPS=False)
    result = resolve(params)
    assert result.url == 'https://events.us-gov-east-1.api.aws'

def test_58_legacy_fips_endpoint___us_gov_west_1():
    """legacy fips endpoint @ us-gov-west-1"""
    params = EndpointParams(Region='us-gov-west-1', UseDualStack=False, UseFIPS=True)
    result = resolve(params)
    assert result.url == 'https://events.us-gov-west-1.amazonaws.com'

def test_59_legacy_non_fips_endpoint___us_gov_west_1():
    """legacy non-fips endpoint @ us-gov-west-1"""
    params = EndpointParams(Region='us-gov-west-1', UseDualStack=False, UseFIPS=False)
    result = resolve(params)
    assert result.url == 'https://events.us-gov-west-1.amazonaws.com'

def test_60_dualstack_fips_endpoint___us_gov_west_1():
    """Dualstack fips endpoint @ us-gov-west-1"""
    params = EndpointParams(Region='us-gov-west-1', UseDualStack=True, UseFIPS=True)
    result = resolve(params)
    assert result.url == 'https://events.us-gov-west-1.api.aws'

def test_61_dualstack_non_fips_endpoint___us_gov_wes():
    """Dualstack non-fips endpoint @ us-gov-west-1"""
    params = EndpointParams(Region='us-gov-west-1', UseDualStack=True, UseFIPS=False)
    result = resolve(params)
    assert result.url == 'https://events.us-gov-west-1.api.aws'