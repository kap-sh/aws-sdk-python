...
def test_valid_endpointid_with_fips_disabled_and_():
...
def test_valid_endpointid_with_dualstack_disabled():
...
def test_valid_endpointid_with_dualstack_enabled_():
...
def test_dualstack_non_fips_endpoint___us_gov_wes():
