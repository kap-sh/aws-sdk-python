...
class evsError(Exception):
    """Base class for all evs service errors."""

class ServiceError(evsError):
...
class SerializationError(evsError):
    """Raised when a value cannot be serialized."""

class DeserializationError(evsError):
...
class WaiterFailedError(evsError):
...
class WaiterTimeoutError(evsError):
