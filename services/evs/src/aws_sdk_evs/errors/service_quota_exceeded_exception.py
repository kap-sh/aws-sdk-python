"""Generated from Smithy shape ``com.amazonaws.evs#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.evs#ServiceQuotaExceededException``."""
