...
def serialize_aws_json_1_0(value: EnvironmentSummaryList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_evs.types.environment_summary.serialize_aws_json_1_0(item))
    return out
...
def deserialize_aws_json_1_0(data: list) -> EnvironmentSummaryList:
    ...
    for item in data:
        out.append(aws_sdk_evs.types.environment_summary.deserialize_aws_json_1_0(item))
    return out
