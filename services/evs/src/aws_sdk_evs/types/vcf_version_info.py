...
if TYPE_CHECKING:
    import aws_sdk_evs.types.instance_type_list
...
def serialize_aws_json_1_0(value: VcfVersionInfo) -> dict:
    ...
    out["instanceTypes"] = aws_sdk_evs.types.instance_type_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> VcfVersionInfo:
    ...
    if "instanceTypes" in data:
        ...
        out["instance_types"] = (
            aws_sdk_evs.types.instance_type_list.deserialize_aws_json_1_0(
                data["instanceTypes"]
            )
        )
    else:
