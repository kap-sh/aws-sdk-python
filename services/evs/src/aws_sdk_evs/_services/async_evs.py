...
from aws_sdk_evs._auth._signers import SigV4Signer
from aws_sdk_evs._auth._sigv4 import presign_sigv4
...
from aws_sdk_evs._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_evs._async import anysleep
import time
from aws_sdk_evs.errors import ServiceError, WaiterFailedError, WaiterTimeoutError
import warnings
from aws_sdk_evs._auth._identity import Credentials
from aws_sdk_evs._auth._providers import CredentialsProvider, StaticAwsCredentialsProvider
if TYPE_CHECKING:
...
class AsyncevsClient:
    ...
    async def get_versions(self, *, config_overrides: Optional[AsyncevsClientConfig] = None) -> "aws_sdk_evs.types.get_versions_response.GetVersionsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_evs.types.get_versions_request.GetVersionsRequest]') -> AsyncOperationResponse["aws_sdk_evs.types.get_versions_response.GetVersionsResponse"]:
            import aws_sdk_evs._operations.amazon_elastic_v_mware_service.get_versions
            output, http_response = await aws_sdk_evs._operations.amazon_elastic_v_mware_service.get_versions.async_get_versions(req.options, req.input)
    ...
    async def list_tags_for_resource(self, resource_arn: "aws_sdk_evs.types.arn.Arn", *, config_overrides: Optional[AsyncevsClientConfig] = None) -> "aws_sdk_evs.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_evs.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> AsyncOperationResponse["aws_sdk_evs.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_evs._operations.amazon_elastic_v_mware_service.list_tags_for_resource
            output, http_response = await aws_sdk_evs._operations.amazon_elastic_v_mware_service.list_tags_for_resource.async_list_tags_for_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def tag_resource(self, resource_arn: "aws_sdk_evs.types.arn.Arn", tags: "aws_sdk_evs.types.request_tag_map.RequestTagMap", *, config_overrides: Optional[AsyncevsClientConfig] = None) -> "aws_sdk_evs.types.tag_resource_response.TagResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_evs.types.tag_resource_request.TagResourceRequest]') -> AsyncOperationResponse["aws_sdk_evs.types.tag_resource_response.TagResourceResponse"]:
            import aws_sdk_evs._operations.amazon_elastic_v_mware_service.tag_resource
            output, http_response = await aws_sdk_evs._operations.amazon_elastic_v_mware_service.tag_resource.async_tag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_resource(self, resource_arn: "aws_sdk_evs.types.arn.Arn", tag_keys: "aws_sdk_evs.types.tag_keys.TagKeys", *, config_overrides: Optional[AsyncevsClientConfig] = None) -> "aws_sdk_evs.types.untag_resource_response.UntagResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_evs.types.untag_resource_request.UntagResourceRequest]') -> AsyncOperationResponse["aws_sdk_evs.types.untag_resource_response.UntagResourceResponse"]:
            import aws_sdk_evs._operations.amazon_elastic_v_mware_service.untag_resource
            output, http_response = await aws_sdk_evs._operations.amazon_elastic_v_mware_service.untag_resource.async_untag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
