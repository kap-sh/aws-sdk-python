...
class InitialVlans(TypedDict, closed=True):
    vmk_management: "capo_evs.types.initial_vlan_info.InitialVlanInfo"
    ...
    v_tep: "capo_evs.types.initial_vlan_info.InitialVlanInfo"
    ...
    edge_v_tep: "capo_evs.types.initial_vlan_info.InitialVlanInfo"
    ...
    nsx_uplink: "capo_evs.types.initial_vlan_info.InitialVlanInfo"
    """<p> The NSX uplink VLAN subnet. This VLAN subnet allows connectivity to the NSX overlay network.</p>"""
    hcx: "capo_evs.types.initial_vlan_info.InitialVlanInfo"
    ...
    expansion_vlan1: "capo_evs.types.initial_vlan_info.InitialVlanInfo"
    ...
    expansion_vlan2: "capo_evs.types.initial_vlan_info.InitialVlanInfo"
    """<p>An additional VLAN subnet that can be used to extend VCF capabilities once configured. For example, you can configure an expansion VLAN subnet to use NSX Federation for centralized management and synchronization of multiple NSX deployments across different locations.</p>"""
    is_hcx_public: "bool"
    """<p>Determines if the HCX VLAN that Amazon EVS provisions is public or private.</p>"""
    hcx_network_acl_id: NotRequired["capo_evs.types.network_acl_id.NetworkAclId"]
...
def serialize_aws_json_1_0(value: InitialVlans) -> dict:
    ...
    out["vmkManagement"] = capo_evs.types.initial_vlan_info.serialize_aws_json_1_0(
        value["vmk_management"]
    )
    import capo_evs.types.initial_vlan_info

    out["vmManagement"] = capo_evs.types.initial_vlan_info.serialize_aws_json_1_0(
        value["vm_management"]
    )
    import capo_evs.types.initial_vlan_info

    out["vMotion"] = capo_evs.types.initial_vlan_info.serialize_aws_json_1_0(
        value["v_motion"]
    )
    import capo_evs.types.initial_vlan_info

    out["vSan"] = capo_evs.types.initial_vlan_info.serialize_aws_json_1_0(
        value["v_san"]
    )
    import capo_evs.types.initial_vlan_info

    out["vTep"] = capo_evs.types.initial_vlan_info.serialize_aws_json_1_0(
        value["v_tep"]
    )
    import capo_evs.types.initial_vlan_info

    out["edgeVTep"] = capo_evs.types.initial_vlan_info.serialize_aws_json_1_0(
        value["edge_v_tep"]
    )
    import capo_evs.types.initial_vlan_info

    out["nsxUplink"] = capo_evs.types.initial_vlan_info.serialize_aws_json_1_0(
        value["nsx_uplink"]
    )
    import capo_evs.types.initial_vlan_info

    out["hcx"] = capo_evs.types.initial_vlan_info.serialize_aws_json_1_0(value["hcx"])
    import capo_evs.types.initial_vlan_info

    out["expansionVlan1"] = capo_evs.types.initial_vlan_info.serialize_aws_json_1_0(
        value["expansion_vlan1"]
    )
    import capo_evs.types.initial_vlan_info

    out["expansionVlan2"] = capo_evs.types.initial_vlan_info.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> InitialVlans:
    ...
    if "vmkManagement" in data:
        ...
        out["vmk_management"] = (
            capo_evs.types.initial_vlan_info.deserialize_aws_json_1_0(
                data["vmkManagement"]
            )
        )
    else:
