...
ConnectorList: TypeAlias = list["capo_evs.types.connector.Connector"]
...
def serialize_aws_json_1_0(value: ConnectorList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_evs.types.connector.serialize_aws_json_1_0(item))
    return out
...
def deserialize_aws_json_1_0(data: list) -> ConnectorList:
    ...
    out: ConnectorList = []
    for item in data:
        out.append(capo_evs.types.connector.deserialize_aws_json_1_0(item))
    return out
