...
if TYPE_CHECKING:
    import capo_evs.types.security_groups


class ServiceAccessSecurityGroups(TypedDict, closed=True):
    security_groups: NotRequired["capo_evs.types.security_groups.SecurityGroups"]
...
def serialize_aws_json_1_0(value: ServiceAccessSecurityGroups) -> dict:
    ...
    if "security_groups" in value:
        ...
        out["securityGroups"] = capo_evs.types.security_groups.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ServiceAccessSecurityGroups:
    ...
    if "securityGroups" in data:
        ...
        out["security_groups"] = (
            capo_evs.types.security_groups.deserialize_aws_json_1_0(
                data["securityGroups"]
            )
        )
    return out
