...
if TYPE_CHECKING:
    ...
    from capo_evs._services.async_evs import AsyncevsClient, AsyncevsClientConfig
    from capo_evs._services.evs import evsClient, evsClientConfig
...
class EnvironmentResource:
    ...
    def create(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.create_environment_request.CreateEnvironmentRequest]",
        ) -> OperationResponse[
            "capo_evs.types.create_environment_response.CreateEnvironmentResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.create_environment.create_environment(
    ...
    def read(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.get_environment_request.GetEnvironmentRequest]",
        ) -> OperationResponse[
            "capo_evs.types.get_environment_response.GetEnvironmentResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.get_environment.get_environment(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.delete_environment_request.DeleteEnvironmentRequest]",
        ) -> OperationResponse[
            "capo_evs.types.delete_environment_response.DeleteEnvironmentResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.delete_environment.delete_environment(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.list_environments_request.ListEnvironmentsRequest]",
        ) -> OperationResponse[
            "capo_evs.types.list_environments_response.ListEnvironmentsResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.list_environments.list_environments(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def associate_eip_to_vlan(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.associate_eip_to_vlan_request.AssociateEipToVlanRequest]",
        ) -> OperationResponse[
            "capo_evs.types.associate_eip_to_vlan_response.AssociateEipToVlanResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.associate_eip_to_vlan.associate_eip_to_vlan(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_entitlement(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.create_entitlement_request.CreateEntitlementRequest]",
        ) -> OperationResponse[
            "capo_evs.types.create_entitlement_response.CreateEntitlementResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.create_entitlement.create_entitlement(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_environment_connector(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.create_environment_connector_request.CreateEnvironmentConnectorRequest]",
        ) -> OperationResponse[
            "capo_evs.types.create_environment_connector_response.CreateEnvironmentConnectorResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.create_environment_connector.create_environment_connector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_environment_host(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.create_environment_host_request.CreateEnvironmentHostRequest]",
        ) -> OperationResponse[
            "capo_evs.types.create_environment_host_response.CreateEnvironmentHostResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.create_environment_host.create_environment_host(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_entitlement(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.delete_entitlement_request.DeleteEntitlementRequest]",
        ) -> OperationResponse[
            "capo_evs.types.delete_entitlement_response.DeleteEntitlementResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.delete_entitlement.delete_entitlement(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_environment_connector(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.delete_environment_connector_request.DeleteEnvironmentConnectorRequest]",
        ) -> OperationResponse[
            "capo_evs.types.delete_environment_connector_response.DeleteEnvironmentConnectorResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.delete_environment_connector.delete_environment_connector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_environment_host(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.delete_environment_host_request.DeleteEnvironmentHostRequest]",
        ) -> OperationResponse[
            "capo_evs.types.delete_environment_host_response.DeleteEnvironmentHostResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.delete_environment_host.delete_environment_host(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_eip_from_vlan(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.disassociate_eip_from_vlan_request.DisassociateEipFromVlanRequest]",
        ) -> OperationResponse[
            "capo_evs.types.disassociate_eip_from_vlan_response.DisassociateEipFromVlanResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.disassociate_eip_from_vlan.disassociate_eip_from_vlan(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_depot_url(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.get_depot_url_request.GetDepotUrlRequest]",
        ) -> OperationResponse[
            "capo_evs.types.get_depot_url_response.GetDepotUrlResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.get_depot_url.get_depot_url(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_environment_connectors(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.list_environment_connectors_request.ListEnvironmentConnectorsRequest]",
        ) -> OperationResponse[
            "capo_evs.types.list_environment_connectors_response.ListEnvironmentConnectorsResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.list_environment_connectors.list_environment_connectors(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_environment_hosts(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.list_environment_hosts_request.ListEnvironmentHostsRequest]",
        ) -> OperationResponse[
            "capo_evs.types.list_environment_hosts_response.ListEnvironmentHostsResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.list_environment_hosts.list_environment_hosts(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_environment_vlans(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.list_environment_vlans_request.ListEnvironmentVlansRequest]",
        ) -> OperationResponse[
            "capo_evs.types.list_environment_vlans_response.ListEnvironmentVlansResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.list_environment_vlans.list_environment_vlans(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_vm_entitlements(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.list_vm_entitlements_request.ListVmEntitlementsRequest]",
        ) -> OperationResponse[
            "capo_evs.types.list_vm_entitlements_response.ListVmEntitlementsResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.list_vm_entitlements.list_vm_entitlements(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_environment_connector(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.update_environment_connector_request.UpdateEnvironmentConnectorRequest]",
        ) -> OperationResponse[
            "capo_evs.types.update_environment_connector_response.UpdateEnvironmentConnectorResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.update_environment_connector.update_environment_connector(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
