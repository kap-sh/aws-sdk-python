...
from capo_evs._services._aws_config import aws_config
...
class evsClientConfig(TypedDict, total=False, closed=True):
...
class evsClient:
    ...
    def get_versions(
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.get_versions_request.GetVersionsRequest]",
        ) -> OperationResponse[
            "capo_evs.types.get_versions_response.GetVersionsResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.get_versions.get_versions(
        ...
        input_: capo_evs.types.get_versions_request.GetVersionsRequest = {}  # type: ignore[typeddict-item]
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_evs.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_evs.types.list_tags_for_resource_request.ListTagsForResourceRequest = {}  # type: ignore[typeddict-item]
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_evs.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_evs.types.tag_resource_request.TagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        input_["tags"] = tags
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_evs.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_evs.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_evs._operations.amazon_elastic_v_mware_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_evs.types.untag_resource_request.UntagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
