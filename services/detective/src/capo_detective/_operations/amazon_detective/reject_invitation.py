"""Generated from Smithy shape ``com.amazonaws.detective#RejectInvitation``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/invitation/removal"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_detective.types.reject_invitation_request.serialize_json(input_)
    ).encode()
