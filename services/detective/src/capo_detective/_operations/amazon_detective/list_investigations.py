...
def handle_response(
    ...
    out: capo_detective.types.list_investigations_response.ListInvestigationsResponse = capo_detective.types.list_investigations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_detective.types.list_investigations_request.serialize_json(input_)
    ).encode()
