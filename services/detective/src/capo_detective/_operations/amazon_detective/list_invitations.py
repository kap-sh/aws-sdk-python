...
def handle_response(
    ...
    out: capo_detective.types.list_invitations_response.ListInvitationsResponse = (
        capo_detective.types.list_invitations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_detective.types.list_invitations_request.serialize_json(input_)
    ).encode()
