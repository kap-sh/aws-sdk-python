...
def handle_response(
    ...
    out: capo_detective.types.list_organization_admin_accounts_response.ListOrganizationAdminAccountsResponse = capo_detective.types.list_organization_admin_accounts_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_detective.types.list_organization_admin_accounts_request.serialize_json(
            input_
        )
    ).encode()
