"""Generated from Smithy shape ``com.amazonaws.detective#EnableOrganizationAdminAccount``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/orgs/enableAdminAccount"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_detective.types.enable_organization_admin_account_request.serialize_json(
            input_
        )
    ).encode()
