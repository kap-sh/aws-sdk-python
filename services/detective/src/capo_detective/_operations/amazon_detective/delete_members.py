...
import capo_detective.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_detective.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_detective.types.delete_members_response.DeleteMembersResponse = (
        capo_detective.types.delete_members_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_detective.types.delete_members_request.serialize_json(input_)
    ).encode()
...
def delete_members(
    ...
    capo_detective.types.delete_members_response.DeleteMembersResponse, zapros.Response
]:
