"""Generated from Smithy shape ``com.amazonaws.detective#DescribeOrganizationConfiguration``."""
...
import capo_detective.errors.too_many_requests_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyRequestsException":
            raise capo_detective.errors.too_many_requests_exception.TooManyRequestsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_detective.types.describe_organization_configuration_response.DescribeOrganizationConfigurationResponse = capo_detective.types.describe_organization_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/orgs/describeOrganizationConfiguration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_detective.types.describe_organization_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_describe_organization_configuration(
