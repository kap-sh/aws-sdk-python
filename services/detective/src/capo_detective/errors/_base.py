...
class DetectiveError(Exception):
    """Base class for all Detective service errors."""


class ServiceError(DetectiveError):
...
class SerializationError(DetectiveError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DetectiveError):
...
class WaiterFailedError(DetectiveError):
...
class WaiterTimeoutError(DetectiveError):
