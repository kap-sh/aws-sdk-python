...
if TYPE_CHECKING:
    import capo_detective.types.hourly_time_delta
...
class ImpossibleTravelDetail(TypedDict, closed=True):
    starting_ip_address: NotRequired["capo_detective.types.ip_address.IpAddress"]
    """<p>IP address where the resource was first used in the impossible travel.</p>"""
    ending_ip_address: NotRequired["capo_detective.types.ip_address.IpAddress"]
    """<p>IP address where the resource was last used in the impossible travel.</p>"""
    starting_location: NotRequired["capo_detective.types.location.Location"]
    """<p>Location where the resource was first used in the impossible travel.</p>"""
    ending_location: NotRequired["capo_detective.types.location.Location"]
    """<p>Location where the resource was last used in the impossible travel.</p>"""
    hourly_time_delta: NotRequired[
        "capo_detective.types.hourly_time_delta.HourlyTimeDelta"
    ]
