...
if TYPE_CHECKING:
    ...
    import aws_sdk_detective.types.datasource_package_ingest_detail

DatasourcePackageIngestDetails: TypeAlias = dict[
    "aws_sdk_detective.types.datasource_package.DatasourcePackage",
    "aws_sdk_detective.types.datasource_package_ingest_detail.DatasourcePackageIngestDetail",
]
...
def serialize_json(input_to_serialize: DatasourcePackageIngestDetails) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[aws_sdk_detective.types.datasource_package.serialize_json(key)] = (
            aws_sdk_detective.types.datasource_package_ingest_detail.serialize_json(
                value
            )
        )
    return out
...
def deserialize_json(data: dict) -> DatasourcePackageIngestDetails:
    ...
    for key, value in data.items():
        ...
        out[aws_sdk_detective.types.datasource_package.deserialize_json(key)] = (
            aws_sdk_detective.types.datasource_package_ingest_detail.deserialize_json(
                value
            )
        )
    return out
