...
if TYPE_CHECKING:
    ...
    import aws_sdk_detective.types.datasource_package_usage_info

VolumeUsageByDatasourcePackage: TypeAlias = dict[
    "aws_sdk_detective.types.datasource_package.DatasourcePackage",
    "aws_sdk_detective.types.datasource_package_usage_info.DatasourcePackageUsageInfo",
]
...
def serialize_json(input_to_serialize: VolumeUsageByDatasourcePackage) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[aws_sdk_detective.types.datasource_package.serialize_json(key)] = (
            aws_sdk_detective.types.datasource_package_usage_info.serialize_json(value)
        )
    return out
...
def deserialize_json(data: dict) -> VolumeUsageByDatasourcePackage:
    ...
    for key, value in data.items():
        ...
        out[aws_sdk_detective.types.datasource_package.deserialize_json(key)] = (
            aws_sdk_detective.types.datasource_package_usage_info.deserialize_json(
                value
            )
        )
    return out
