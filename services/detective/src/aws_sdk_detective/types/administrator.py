...
class Administrator(TypedDict):
    ...
    delegation_time: NotRequired["aws_sdk_detective.types.timestamp.Timestamp"]
...
def serialize_json(value: Administrator) -> dict:
    ...
    if "delegation_time" in value:
        ...
        out["DelegationTime"] = aws_sdk_detective.types.timestamp.serialize_json(
...
def deserialize_json(data: dict) -> Administrator:
    ...
    if "DelegationTime" in data:
        ...
        out["delegation_time"] = aws_sdk_detective.types.timestamp.deserialize_json(
            data["DelegationTime"]
        )
    return out
