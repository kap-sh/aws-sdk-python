...
from aws_sdk_detective._services._aws_config import aaws_config
...
class AsyncDetectiveClientConfig(TypedDict, total=False):
...
class AsyncDetectiveClient:
    ...
    async def accept_invitation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.accept_invitation_request.AcceptInvitationRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.accept_invitation.async_accept_invitation(
    ...
    async def batch_get_graph_member_datasources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.batch_get_graph_member_datasources_request.BatchGetGraphMemberDatasourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.batch_get_graph_member_datasources_response.BatchGetGraphMemberDatasourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.batch_get_graph_member_datasources.async_batch_get_graph_member_datasources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_get_membership_datasources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.batch_get_membership_datasources_request.BatchGetMembershipDatasourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.batch_get_membership_datasources_response.BatchGetMembershipDatasourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.batch_get_membership_datasources.async_batch_get_membership_datasources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_graph(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.create_graph_request.CreateGraphRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.create_graph_response.CreateGraphResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.create_graph.async_create_graph(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_members(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.create_members_request.CreateMembersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.create_members_response.CreateMembersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.create_members.async_create_members(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_graph(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.delete_graph_request.DeleteGraphRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.delete_graph.async_delete_graph(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_members(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.delete_members_request.DeleteMembersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.delete_members_response.DeleteMembersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.delete_members.async_delete_members(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_organization_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.describe_organization_configuration_request.DescribeOrganizationConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.describe_organization_configuration_response.DescribeOrganizationConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.describe_organization_configuration.async_describe_organization_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_organization_admin_account(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.disable_organization_admin_account.async_disable_organization_admin_account(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_membership(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.disassociate_membership_request.DisassociateMembershipRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.disassociate_membership.async_disassociate_membership(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_organization_admin_account(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.enable_organization_admin_account_request.EnableOrganizationAdminAccountRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.enable_organization_admin_account.async_enable_organization_admin_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_investigation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.get_investigation_request.GetInvestigationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.get_investigation_response.GetInvestigationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.get_investigation.async_get_investigation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_members(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.get_members_request.GetMembersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.get_members_response.GetMembersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.get_members.async_get_members(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_datasource_packages(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.list_datasource_packages_request.ListDatasourcePackagesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.list_datasource_packages_response.ListDatasourcePackagesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.list_datasource_packages.async_list_datasource_packages(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_graphs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.list_graphs_request.ListGraphsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.list_graphs_response.ListGraphsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.list_graphs.async_list_graphs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_indicators(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.list_indicators_request.ListIndicatorsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.list_indicators_response.ListIndicatorsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.list_indicators.async_list_indicators(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_investigations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.list_investigations_request.ListInvestigationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.list_investigations_response.ListInvestigationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.list_investigations.async_list_investigations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_invitations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.list_invitations_request.ListInvitationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.list_invitations_response.ListInvitationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.list_invitations.async_list_invitations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_members(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.list_members_request.ListMembersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.list_members_response.ListMembersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.list_members.async_list_members(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_organization_admin_accounts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.list_organization_admin_accounts_request.ListOrganizationAdminAccountsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.list_organization_admin_accounts_response.ListOrganizationAdminAccountsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.list_organization_admin_accounts.async_list_organization_admin_accounts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reject_invitation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.reject_invitation_request.RejectInvitationRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.reject_invitation.async_reject_invitation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_investigation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.start_investigation_request.StartInvestigationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.start_investigation_response.StartInvestigationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.start_investigation.async_start_investigation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_monitoring_member(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.start_monitoring_member_request.StartMonitoringMemberRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.start_monitoring_member.async_start_monitoring_member(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_detective.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_datasource_packages(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.update_datasource_packages_request.UpdateDatasourcePackagesRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.update_datasource_packages.async_update_datasource_packages(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_investigation_state(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.update_investigation_state_request.UpdateInvestigationStateRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.update_investigation_state.async_update_investigation_state(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_organization_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_detective.types.update_organization_configuration_request.UpdateOrganizationConfigurationRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_detective._operations.amazon_detective.update_organization_configuration.async_update_organization_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
