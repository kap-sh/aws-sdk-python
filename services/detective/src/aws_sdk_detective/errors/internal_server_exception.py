"""Generated from Smithy shape ``com.amazonaws.detective#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.detective#InternalServerException``."""
