...
from ._services.async_bedrock_agent_runtime import (
    AsyncBedrockAgentRuntimeClient as AsyncBedrockAgentRuntimeClient,
)
from ._services.bedrock_agent_runtime import (
    BedrockAgentRuntimeClient as BedrockAgentRuntimeClient,
)
