...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.create_invocation_response.CreateInvocationResponse = capo_bedrock_agent_runtime.types.create_invocation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent_runtime.types.create_invocation_request.serialize_json(
            input_
        )
    ).encode()
