"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#ListFlowExecutions``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.list_flow_executions_response.ListFlowExecutionsResponse = capo_bedrock_agent_runtime.types.list_flow_executions_response.deserialize_json(
...
def build_request(
    ...
    if "flow_alias_identifier" in input_:
        params.append(("flowAliasIdentifier", input_["flow_alias_identifier"]))
