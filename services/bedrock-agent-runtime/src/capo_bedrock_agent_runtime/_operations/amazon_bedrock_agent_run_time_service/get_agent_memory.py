...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.get_agent_memory_response.GetAgentMemoryResponse = capo_bedrock_agent_runtime.types.get_agent_memory_response.deserialize_json(
