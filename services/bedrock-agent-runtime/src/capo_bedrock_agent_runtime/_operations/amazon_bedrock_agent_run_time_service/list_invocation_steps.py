...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.list_invocation_steps_response.ListInvocationStepsResponse = capo_bedrock_agent_runtime.types.list_invocation_steps_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent_runtime.types.list_invocation_steps_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
