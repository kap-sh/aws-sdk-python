...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.start_flow_execution_response.StartFlowExecutionResponse = capo_bedrock_agent_runtime.types.start_flow_execution_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent_runtime.types.start_flow_execution_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
