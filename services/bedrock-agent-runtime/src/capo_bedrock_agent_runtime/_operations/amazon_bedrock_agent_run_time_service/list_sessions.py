"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#ListSessions``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.list_sessions_response.ListSessionsResponse = capo_bedrock_agent_runtime.types.list_sessions_response.deserialize_json(
