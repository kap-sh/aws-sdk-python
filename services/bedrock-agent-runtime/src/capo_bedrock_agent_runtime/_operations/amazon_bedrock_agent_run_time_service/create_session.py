"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#CreateSession``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.create_session_response.CreateSessionResponse = capo_bedrock_agent_runtime.types.create_session_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent_runtime.types.create_session_request.serialize_json(input_)
    ).encode()
