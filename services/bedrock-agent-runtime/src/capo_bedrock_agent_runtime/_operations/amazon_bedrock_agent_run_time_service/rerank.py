"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#Rerank``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.rerank_response.RerankResponse = (
        capo_bedrock_agent_runtime.types.rerank_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent_runtime.types.rerank_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def rerank(
    ...
    capo_bedrock_agent_runtime.types.rerank_response.RerankResponse, zapros.Response
]:
