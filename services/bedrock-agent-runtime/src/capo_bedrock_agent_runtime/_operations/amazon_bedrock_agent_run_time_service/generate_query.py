...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.generate_query_response.GenerateQueryResponse = capo_bedrock_agent_runtime.types.generate_query_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent_runtime.types.generate_query_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
