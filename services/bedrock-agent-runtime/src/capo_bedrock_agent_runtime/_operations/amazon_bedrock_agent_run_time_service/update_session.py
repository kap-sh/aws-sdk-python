...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.update_session_response.UpdateSessionResponse = capo_bedrock_agent_runtime.types.update_session_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent_runtime.types.update_session_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
