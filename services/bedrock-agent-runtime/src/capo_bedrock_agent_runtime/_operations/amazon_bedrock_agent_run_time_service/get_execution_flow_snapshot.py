"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#GetExecutionFlowSnapshot``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.get_execution_flow_snapshot_response.GetExecutionFlowSnapshotResponse = capo_bedrock_agent_runtime.types.get_execution_flow_snapshot_response.deserialize_json(
...
async def async_get_execution_flow_snapshot(
