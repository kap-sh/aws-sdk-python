"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#GetSession``."""
...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.get_session_response.GetSessionResponse = (
        capo_bedrock_agent_runtime.types.get_session_response.deserialize_json(
