...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.retrieve_response.RetrieveResponse = (
        capo_bedrock_agent_runtime.types.retrieve_response.deserialize_json(
...
def retrieve(
    ...
    capo_bedrock_agent_runtime.types.retrieve_response.RetrieveResponse, zapros.Response
]:
