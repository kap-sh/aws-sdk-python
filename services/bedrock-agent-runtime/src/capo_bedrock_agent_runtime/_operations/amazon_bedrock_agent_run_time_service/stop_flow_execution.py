...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.stop_flow_execution_response.StopFlowExecutionResponse = capo_bedrock_agent_runtime.types.stop_flow_execution_response.deserialize_json(
