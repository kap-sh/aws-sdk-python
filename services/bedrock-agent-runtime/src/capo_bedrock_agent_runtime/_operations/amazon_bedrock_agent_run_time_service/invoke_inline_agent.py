...
def handle_response(
    ...
    _union_deser = capo_bedrock_agent_runtime.types.inline_agent_response_stream.deserialize_event_json
    _iter = cast(Any, response.iter_bytes())
    out: capo_bedrock_agent_runtime.types.invoke_inline_agent_response.InvokeInlineAgentResponse = {
        "completion": cast(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent_runtime.types.invoke_inline_agent_request.serialize_json(
            input_
        )
    ).encode()
