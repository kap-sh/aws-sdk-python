...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.put_invocation_step_response.PutInvocationStepResponse = capo_bedrock_agent_runtime.types.put_invocation_step_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agent_runtime.types.put_invocation_step_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
