...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.list_invocations_response.ListInvocationsResponse = capo_bedrock_agent_runtime.types.list_invocations_response.deserialize_json(
