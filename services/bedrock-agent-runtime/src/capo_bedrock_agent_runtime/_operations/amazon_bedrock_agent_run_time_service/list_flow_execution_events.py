"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#ListFlowExecutionEvents``."""
...
import capo_bedrock_agent_runtime.types.flow_execution_events
...
def handle_response(
    ...
    out: capo_bedrock_agent_runtime.types.list_flow_execution_events_response.ListFlowExecutionEventsResponse = capo_bedrock_agent_runtime.types.list_flow_execution_events_response.deserialize_json(
...
def build_request(
    ...
    if "event_type" in input_:
        params.append(
            (
                "eventType",
                capo_bedrock_agent_runtime.types.flow_execution_event_type.serialize_json(
                    input_["event_type"]
                ),
            )
        )
...
async def async_list_flow_execution_events(
