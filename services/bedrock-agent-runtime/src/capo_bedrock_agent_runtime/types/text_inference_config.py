...
if TYPE_CHECKING:
    import capo_bedrock_agent_runtime.types.max_tokens
...
class TextInferenceConfig(TypedDict, closed=True):
    ...
    max_tokens: NotRequired["capo_bedrock_agent_runtime.types.max_tokens.MaxTokens"]
    ...
    stop_sequences: NotRequired[
        "capo_bedrock_agent_runtime.types.rag_stop_sequences.RAGStopSequences"
    ]
...
def serialize_json(value: TextInferenceConfig) -> dict:
    ...
    if "stop_sequences" in value:
        ...
        out["stopSequences"] = (
            capo_bedrock_agent_runtime.types.rag_stop_sequences.serialize_json(
...
def deserialize_json(data: dict) -> TextInferenceConfig:
    ...
    if "stopSequences" in data:
        ...
        out["stop_sequences"] = (
            capo_bedrock_agent_runtime.types.rag_stop_sequences.deserialize_json(
                data["stopSequences"]
            )
        )
    return out
