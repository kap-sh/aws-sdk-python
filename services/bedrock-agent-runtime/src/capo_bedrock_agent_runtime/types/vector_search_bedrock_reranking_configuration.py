...
if TYPE_CHECKING:
    ...
    import capo_bedrock_agent_runtime.types.vector_search_bedrock_reranking_model_configuration


class VectorSearchBedrockRerankingConfiguration(TypedDict, closed=True):
    model_configuration: "capo_bedrock_agent_runtime.types.vector_search_bedrock_reranking_model_configuration.VectorSearchBedrockRerankingModelConfiguration"
...
def serialize_json(value: VectorSearchBedrockRerankingConfiguration) -> dict:
    ...
    out["modelConfiguration"] = (
        capo_bedrock_agent_runtime.types.vector_search_bedrock_reranking_model_configuration.serialize_json(
...
def deserialize_json(data: dict) -> VectorSearchBedrockRerankingConfiguration:
    ...
    if "modelConfiguration" in data:
        ...
        out["model_configuration"] = (
            capo_bedrock_agent_runtime.types.vector_search_bedrock_reranking_model_configuration.deserialize_json(
