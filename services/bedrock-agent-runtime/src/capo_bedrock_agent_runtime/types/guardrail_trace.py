...
class GuardrailTrace(TypedDict, closed=True):
    action: NotRequired[
        "capo_bedrock_agent_runtime.types.guardrail_action.GuardrailAction"
    ]
    ...
    input_assessments: NotRequired[
        "capo_bedrock_agent_runtime.types.guardrail_assessment_list.GuardrailAssessmentList"
    ]
...
def serialize_json(value: GuardrailTrace) -> dict:
    ...
    if "action" in value:
        ...
        out["action"] = (
            capo_bedrock_agent_runtime.types.guardrail_action.serialize_json(
                value["action"]
            )
        )
    ...
    if "input_assessments" in value:
        ...
        out["inputAssessments"] = (
            capo_bedrock_agent_runtime.types.guardrail_assessment_list.serialize_json(
...
def deserialize_json(data: dict) -> GuardrailTrace:
    ...
    if "inputAssessments" in data:
        ...
        out["input_assessments"] = (
            capo_bedrock_agent_runtime.types.guardrail_assessment_list.deserialize_json(
