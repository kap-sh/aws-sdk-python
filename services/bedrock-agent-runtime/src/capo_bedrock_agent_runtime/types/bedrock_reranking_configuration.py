...
class BedrockRerankingConfiguration(TypedDict, closed=True):
    ...
    model_configuration: "capo_bedrock_agent_runtime.types.bedrock_reranking_model_configuration.BedrockRerankingModelConfiguration"
...
def serialize_json(value: BedrockRerankingConfiguration) -> dict:
    ...
    out["modelConfiguration"] = (
        capo_bedrock_agent_runtime.types.bedrock_reranking_model_configuration.serialize_json(
...
def deserialize_json(data: dict) -> BedrockRerankingConfiguration:
    ...
    if "modelConfiguration" in data:
        ...
        out["model_configuration"] = (
            capo_bedrock_agent_runtime.types.bedrock_reranking_model_configuration.deserialize_json(
