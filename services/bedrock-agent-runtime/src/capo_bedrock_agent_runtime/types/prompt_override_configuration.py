...
if TYPE_CHECKING:
    ...
    import capo_bedrock_agent_runtime.types.prompt_configurations
...
def serialize_json(value: PromptOverrideConfiguration) -> dict:
    ...
    out["promptConfigurations"] = (
        capo_bedrock_agent_runtime.types.prompt_configurations.serialize_json(
...
def deserialize_json(data: dict) -> PromptOverrideConfiguration:
    ...
    if "promptConfigurations" in data:
        ...
        out["prompt_configurations"] = (
            capo_bedrock_agent_runtime.types.prompt_configurations.deserialize_json(
