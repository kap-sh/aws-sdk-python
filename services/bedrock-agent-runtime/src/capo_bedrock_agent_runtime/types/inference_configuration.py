...
if TYPE_CHECKING:
    import capo_bedrock_agent_runtime.types.maximum_length
    import capo_bedrock_agent_runtime.types.stop_sequences
    import capo_bedrock_agent_runtime.types.temperature
    import capo_bedrock_agent_runtime.types.top_k
    import capo_bedrock_agent_runtime.types.top_p


class InferenceConfiguration(TypedDict, closed=True):
    temperature: NotRequired["capo_bedrock_agent_runtime.types.temperature.Temperature"]
    ...
    top_p: NotRequired["capo_bedrock_agent_runtime.types.top_p.TopP"]
    ...
    top_k: NotRequired["capo_bedrock_agent_runtime.types.top_k.TopK"]
    ...
    maximum_length: NotRequired[
        "capo_bedrock_agent_runtime.types.maximum_length.MaximumLength"
    ]
    """<p>The maximum number of tokens allowed in the generated response.</p>"""
    stop_sequences: NotRequired[
        "capo_bedrock_agent_runtime.types.stop_sequences.StopSequences"
    ]
...
def serialize_json(value: InferenceConfiguration) -> dict:
    ...
    if "stop_sequences" in value:
        ...
        out["stopSequences"] = (
            capo_bedrock_agent_runtime.types.stop_sequences.serialize_json(
...
def deserialize_json(data: dict) -> InferenceConfiguration:
    ...
    if "stopSequences" in data:
        ...
        out["stop_sequences"] = (
            capo_bedrock_agent_runtime.types.stop_sequences.deserialize_json(
                data["stopSequences"]
            )
        )
    return out
