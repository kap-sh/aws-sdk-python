...
class AgentActionGroup(TypedDict, closed=True):
    action_group_name: "capo_bedrock_agent_runtime.types.resource_name.ResourceName"
    ...
    parent_action_group_signature: NotRequired[
        "capo_bedrock_agent_runtime.types.action_group_signature.ActionGroupSignature"
    ]
    ...
    action_group_executor: NotRequired[
        "capo_bedrock_agent_runtime.types.action_group_executor.ActionGroupExecutor"
    ]
    ...
    api_schema: NotRequired["capo_bedrock_agent_runtime.types.api_schema.APISchema"]
    ...
    function_schema: NotRequired[
        "capo_bedrock_agent_runtime.types.function_schema.FunctionSchema"
    ]
    ...
    parent_action_group_signature_params: NotRequired[
        "capo_bedrock_agent_runtime.types.action_group_signature_params.ActionGroupSignatureParams"
    ]
...
def serialize_json(value: AgentActionGroup) -> dict:
    ...
    if "parent_action_group_signature" in value:
        ...
        out["parentActionGroupSignature"] = (
            capo_bedrock_agent_runtime.types.action_group_signature.serialize_json(
    ...
    if "action_group_executor" in value:
        ...
        out["actionGroupExecutor"] = (
            capo_bedrock_agent_runtime.types.action_group_executor.serialize_json(
    ...
    if "api_schema" in value:
        ...
        out["apiSchema"] = capo_bedrock_agent_runtime.types.api_schema.serialize_json(
            value["api_schema"]
        )
    if "function_schema" in value:
        ...
        out["functionSchema"] = (
            capo_bedrock_agent_runtime.types.function_schema.serialize_json(
    ...
    if "parent_action_group_signature_params" in value:
        ...
        out["parentActionGroupSignatureParams"] = (
            capo_bedrock_agent_runtime.types.action_group_signature_params.serialize_json(
...
def deserialize_json(data: dict) -> AgentActionGroup:
    ...
    if data.get("parentActionGroupSignature") is not None:
        ...
        out["parent_action_group_signature"] = (
            capo_bedrock_agent_runtime.types.action_group_signature.deserialize_json(
    ...
    if data.get("actionGroupExecutor") is not None:
        ...
        out["action_group_executor"] = (
            capo_bedrock_agent_runtime.types.action_group_executor.deserialize_json(
    ...
    if data.get("apiSchema") is not None:
        ...
        out["api_schema"] = (
            capo_bedrock_agent_runtime.types.api_schema.deserialize_json(
                data["apiSchema"]
            )
        )
    if data.get("functionSchema") is not None:
        ...
        out["function_schema"] = (
            capo_bedrock_agent_runtime.types.function_schema.deserialize_json(
                data["functionSchema"]
            )
        )
    if data.get("parentActionGroupSignatureParams") is not None:
        ...
        out["parent_action_group_signature_params"] = (
            capo_bedrock_agent_runtime.types.action_group_signature_params.deserialize_json(
