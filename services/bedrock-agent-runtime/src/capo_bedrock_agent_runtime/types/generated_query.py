...
class GeneratedQuery(TypedDict, closed=True):
    type: NotRequired[
        "capo_bedrock_agent_runtime.types.generated_query_type.GeneratedQueryType"
    ]
...
def serialize_json(value: GeneratedQuery) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = (
            capo_bedrock_agent_runtime.types.generated_query_type.serialize_json(
                value["type"]
            )
        )
    if "sql" in value:
...
def deserialize_json(data: dict) -> GeneratedQuery:
    ...
    if "type" in data:
        ...
        out["type"] = (
            capo_bedrock_agent_runtime.types.generated_query_type.deserialize_json(
                data["type"]
            )
        )
    if "sql" in data:
