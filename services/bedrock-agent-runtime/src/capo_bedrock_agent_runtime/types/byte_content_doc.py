...
if TYPE_CHECKING:
    ...
    import capo_bedrock_agent_runtime.types.content_type
    import capo_bedrock_agent_runtime.types.identifier


class ByteContentDoc(TypedDict, closed=True):
    identifier: "capo_bedrock_agent_runtime.types.identifier.Identifier"
    """<p>The file name of the document contained in the wrapper object.</p>"""
    content_type: "capo_bedrock_agent_runtime.types.content_type.ContentType"
