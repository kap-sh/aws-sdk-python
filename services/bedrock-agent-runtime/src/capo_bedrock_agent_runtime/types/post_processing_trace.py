...
class _PostProcessingTrace_modelInvocationOutput(TypedDict, closed=True):
    modelInvocationOutput: "capo_bedrock_agent_runtime.types.post_processing_model_invocation_output.PostProcessingModelInvocationOutput"
...
def serialize_json(value: PostProcessingTrace) -> dict:
    if "modelInvocationInput" in value:
        ...
        return {
            "modelInvocationOutput": capo_bedrock_agent_runtime.types.post_processing_model_invocation_output.serialize_json(
...
def deserialize_json(data: dict) -> PostProcessingTrace:
    if "modelInvocationInput" in data:
        ...
        return {
            "modelInvocationOutput": capo_bedrock_agent_runtime.types.post_processing_model_invocation_output.deserialize_json(
