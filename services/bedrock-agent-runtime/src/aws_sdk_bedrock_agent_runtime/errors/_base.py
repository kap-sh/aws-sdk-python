...
class BedrockAgentRuntimeError(Exception):
    """Base class for all BedrockAgentRuntime service errors."""

class ServiceError(BedrockAgentRuntimeError):
...
class SerializationError(BedrockAgentRuntimeError):
    """Raised when a value cannot be serialized."""

class DeserializationError(BedrockAgentRuntimeError):
...
class WaiterFailedError(BedrockAgentRuntimeError):
...
class WaiterTimeoutError(BedrockAgentRuntimeError):
