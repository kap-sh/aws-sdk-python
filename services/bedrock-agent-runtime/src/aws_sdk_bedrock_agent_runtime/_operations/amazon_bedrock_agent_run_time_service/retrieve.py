...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.retrieve_response.RetrieveResponse = (
        aws_sdk_bedrock_agent_runtime.types.retrieve_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.retrieve_request.RetrieveRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agent_runtime.types.retrieve_request.serialize_json(input_)
    ).encode()
