"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#Retrieve``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.retrieve_response.RetrieveResponse:
    import aws_sdk_bedrock_agent_runtime.types.retrieve_response
    out: aws_sdk_bedrock_agent_runtime.types.retrieve_response.RetrieveResponse = aws_sdk_bedrock_agent_runtime.types.retrieve_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.retrieve_request.RetrieveRequest) -> zapros.Request:
    ...
    url = url.replace("{knowledgeBaseId}", quote(str(input["knowledge_base_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agent_runtime.types.retrieve_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agent_runtime.types.retrieve_request.serialize_json(input)).encode()
...
def retrieve(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.retrieve_request.RetrieveRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.retrieve_response.RetrieveResponse, zapros.Response]:
...
async def async_retrieve(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.retrieve_request.RetrieveRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.retrieve_response.RetrieveResponse, zapros.Response]:
