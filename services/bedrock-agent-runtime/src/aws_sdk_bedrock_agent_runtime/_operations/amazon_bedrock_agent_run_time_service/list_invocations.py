"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#ListInvocations``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent_runtime.types.list_invocations_request
    import aws_sdk_bedrock_agent_runtime.types.list_invocations_response
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.list_invocations_response.ListInvocationsResponse:
    import aws_sdk_bedrock_agent_runtime.types.list_invocations_response
    out: aws_sdk_bedrock_agent_runtime.types.list_invocations_response.ListInvocationsResponse = aws_sdk_bedrock_agent_runtime.types.list_invocations_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_invocations_request.ListInvocationsRequest) -> zapros.Request:
...
def list_invocations(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_invocations_request.ListInvocationsRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.list_invocations_response.ListInvocationsResponse, zapros.Response]:
...
async def async_list_invocations(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_invocations_request.ListInvocationsRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.list_invocations_response.ListInvocationsResponse, zapros.Response]:
