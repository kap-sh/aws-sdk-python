...
) -> aws_sdk_bedrock_agent_runtime.types.list_invocations_response.ListInvocationsResponse:
    import aws_sdk_bedrock_agent_runtime.types.list_invocations_response

    out: aws_sdk_bedrock_agent_runtime.types.list_invocations_response.ListInvocationsResponse = aws_sdk_bedrock_agent_runtime.types.list_invocations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.list_invocations_request.ListInvocationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{sessionIdentifier}", quote(str(input_["session_identifier"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_list_invocations(
