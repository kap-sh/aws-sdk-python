"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#DeleteSession``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.delete_session_response.DeleteSessionResponse:
    out: aws_sdk_bedrock_agent_runtime.types.delete_session_response.DeleteSessionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.delete_session_request.DeleteSessionRequest) -> zapros.Request:
...
def delete_session(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.delete_session_request.DeleteSessionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.delete_session_response.DeleteSessionResponse, zapros.Response]:
...
async def async_delete_session(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.delete_session_request.DeleteSessionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.delete_session_response.DeleteSessionResponse, zapros.Response]:
