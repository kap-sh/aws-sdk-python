...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent_runtime.types.get_invocation_step_request
    import aws_sdk_bedrock_agent_runtime.types.get_invocation_step_response
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.get_invocation_step_response.GetInvocationStepResponse:
    import aws_sdk_bedrock_agent_runtime.types.get_invocation_step_response
    out: aws_sdk_bedrock_agent_runtime.types.get_invocation_step_response.GetInvocationStepResponse = aws_sdk_bedrock_agent_runtime.types.get_invocation_step_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_invocation_step_request.GetInvocationStepRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/sessions/{sessionIdentifier}/invocationSteps/{invocationStepId}"
    url = url.replace("{invocationStepId}", quote(str(input["invocation_step_id"]), safe=""))
    url = url.replace("{sessionIdentifier}", quote(str(input["session_identifier"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agent_runtime.types.get_invocation_step_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agent_runtime.types.get_invocation_step_request.serialize_json(input)).encode()
...
def get_invocation_step(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_invocation_step_request.GetInvocationStepRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.get_invocation_step_response.GetInvocationStepResponse, zapros.Response]:
...
async def async_get_invocation_step(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_invocation_step_request.GetInvocationStepRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.get_invocation_step_response.GetInvocationStepResponse, zapros.Response]:
