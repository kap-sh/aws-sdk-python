...
) -> aws_sdk_bedrock_agent_runtime.types.get_invocation_step_response.GetInvocationStepResponse:
    import aws_sdk_bedrock_agent_runtime.types.get_invocation_step_response

    out: aws_sdk_bedrock_agent_runtime.types.get_invocation_step_response.GetInvocationStepResponse = aws_sdk_bedrock_agent_runtime.types.get_invocation_step_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_bedrock_agent_runtime.types.get_invocation_step_request.GetInvocationStepRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{invocationStepId}", quote(str(input["invocation_step_id"]), safe="")
    )
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agent_runtime.types.get_invocation_step_request.serialize_json(
            input
        )
    ).encode()
