...
) -> aws_sdk_bedrock_agent_runtime.types.put_invocation_step_response.PutInvocationStepResponse:
    out: aws_sdk_bedrock_agent_runtime.types.put_invocation_step_response.PutInvocationStepResponse = aws_sdk_bedrock_agent_runtime.types.put_invocation_step_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.put_invocation_step_request.PutInvocationStepRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agent_runtime.types.put_invocation_step_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_invocation_step(
