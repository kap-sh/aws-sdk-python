...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.list_sessions_response.ListSessionsResponse = aws_sdk_bedrock_agent_runtime.types.list_sessions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.list_sessions_request.ListSessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
