...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.list_sessions_response.ListSessionsResponse:
    import aws_sdk_bedrock_agent_runtime.types.list_sessions_response
    out: aws_sdk_bedrock_agent_runtime.types.list_sessions_response.ListSessionsResponse = aws_sdk_bedrock_agent_runtime.types.list_sessions_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_sessions_request.ListSessionsRequest) -> zapros.Request:
...
def list_sessions(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_sessions_request.ListSessionsRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.list_sessions_response.ListSessionsResponse, zapros.Response]:
...
async def async_list_sessions(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_sessions_request.ListSessionsRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.list_sessions_response.ListSessionsResponse, zapros.Response]:
