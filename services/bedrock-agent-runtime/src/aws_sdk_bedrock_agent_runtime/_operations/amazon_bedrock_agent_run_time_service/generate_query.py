...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.generate_query_response.GenerateQueryResponse = aws_sdk_bedrock_agent_runtime.types.generate_query_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_bedrock_agent_runtime.types.generate_query_request.GenerateQueryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agent_runtime.types.generate_query_request.serialize_json(input)
    ).encode()
