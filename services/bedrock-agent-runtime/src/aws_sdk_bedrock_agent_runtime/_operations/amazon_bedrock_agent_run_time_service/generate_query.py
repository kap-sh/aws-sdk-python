...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.generate_query_request.GenerateQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agent_runtime.types.generate_query_request.serialize_json(
            input_
        )
    ).encode()
