"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#GenerateQuery``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.generate_query_response.GenerateQueryResponse:
    import aws_sdk_bedrock_agent_runtime.types.generate_query_response
    out: aws_sdk_bedrock_agent_runtime.types.generate_query_response.GenerateQueryResponse = aws_sdk_bedrock_agent_runtime.types.generate_query_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.generate_query_request.GenerateQueryRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/generateQuery"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agent_runtime.types.generate_query_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agent_runtime.types.generate_query_request.serialize_json(input)).encode()
...
def generate_query(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.generate_query_request.GenerateQueryRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.generate_query_response.GenerateQueryResponse, zapros.Response]:
...
async def async_generate_query(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.generate_query_request.GenerateQueryRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.generate_query_response.GenerateQueryResponse, zapros.Response]:
