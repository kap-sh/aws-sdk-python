"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#StopFlowExecution``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.stop_flow_execution_response.StopFlowExecutionResponse:
    import aws_sdk_bedrock_agent_runtime.types.stop_flow_execution_response
    out: aws_sdk_bedrock_agent_runtime.types.stop_flow_execution_response.StopFlowExecutionResponse = aws_sdk_bedrock_agent_runtime.types.stop_flow_execution_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.stop_flow_execution_request.StopFlowExecutionRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/flows/{flowIdentifier}/aliases/{flowAliasIdentifier}/executions/{executionIdentifier}/stop"
...
def stop_flow_execution(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.stop_flow_execution_request.StopFlowExecutionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.stop_flow_execution_response.StopFlowExecutionResponse, zapros.Response]:
...
async def async_stop_flow_execution(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.stop_flow_execution_request.StopFlowExecutionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.stop_flow_execution_response.StopFlowExecutionResponse, zapros.Response]:
