...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.stop_flow_execution_response.StopFlowExecutionResponse = aws_sdk_bedrock_agent_runtime.types.stop_flow_execution_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.stop_flow_execution_request.StopFlowExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_stop_flow_execution(
