"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#StartFlowExecution``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BadGatewayException":
            ...
            raise aws_sdk_bedrock_agent_runtime.errors.bad_gateway_exception.BadGatewayException.from_json(data)
        ...
        case "DependencyFailedException":
            ...
            raise aws_sdk_bedrock_agent_runtime.errors.dependency_failed_exception.DependencyFailedException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.start_flow_execution_response.StartFlowExecutionResponse:
    import aws_sdk_bedrock_agent_runtime.types.start_flow_execution_response
    out: aws_sdk_bedrock_agent_runtime.types.start_flow_execution_response.StartFlowExecutionResponse = aws_sdk_bedrock_agent_runtime.types.start_flow_execution_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.start_flow_execution_request.StartFlowExecutionRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/flows/{flowIdentifier}/aliases/{flowAliasIdentifier}/executions"
    url = url.replace("{flowIdentifier}", quote(str(input["flow_identifier"]), safe=""))
    url = url.replace("{flowAliasIdentifier}", quote(str(input["flow_alias_identifier"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agent_runtime.types.start_flow_execution_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agent_runtime.types.start_flow_execution_request.serialize_json(input)).encode()
...
def start_flow_execution(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.start_flow_execution_request.StartFlowExecutionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.start_flow_execution_response.StartFlowExecutionResponse, zapros.Response]:
...
async def async_start_flow_execution(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.start_flow_execution_request.StartFlowExecutionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.start_flow_execution_response.StartFlowExecutionResponse, zapros.Response]:
