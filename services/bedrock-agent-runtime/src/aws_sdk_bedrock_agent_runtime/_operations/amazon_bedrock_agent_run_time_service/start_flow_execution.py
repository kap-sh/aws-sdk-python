...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.start_flow_execution_response.StartFlowExecutionResponse = aws_sdk_bedrock_agent_runtime.types.start_flow_execution_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.start_flow_execution_request.StartFlowExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agent_runtime.types.start_flow_execution_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_flow_execution(
