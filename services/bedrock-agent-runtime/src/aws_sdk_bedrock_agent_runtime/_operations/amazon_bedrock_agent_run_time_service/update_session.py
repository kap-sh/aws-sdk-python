"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#UpdateSession``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.update_session_response.UpdateSessionResponse:
    import aws_sdk_bedrock_agent_runtime.types.update_session_response
    out: aws_sdk_bedrock_agent_runtime.types.update_session_response.UpdateSessionResponse = aws_sdk_bedrock_agent_runtime.types.update_session_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.update_session_request.UpdateSessionRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/sessions/{sessionIdentifier}/"
    url = url.replace("{sessionIdentifier}", quote(str(input["session_identifier"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock_agent_runtime.types.update_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agent_runtime.types.update_session_request.serialize_json(input)).encode()
...
def update_session(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.update_session_request.UpdateSessionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.update_session_response.UpdateSessionResponse, zapros.Response]:
...
async def async_update_session(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.update_session_request.UpdateSessionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.update_session_response.UpdateSessionResponse, zapros.Response]:
