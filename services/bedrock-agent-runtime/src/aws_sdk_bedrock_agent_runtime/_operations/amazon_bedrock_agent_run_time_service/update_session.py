...
def build_request(
    ...
    input: aws_sdk_bedrock_agent_runtime.types.update_session_request.UpdateSessionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agent_runtime.types.update_session_request.serialize_json(input)
    ).encode()
