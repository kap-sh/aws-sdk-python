...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.update_session_response.UpdateSessionResponse = aws_sdk_bedrock_agent_runtime.types.update_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.update_session_request.UpdateSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agent_runtime.types.update_session_request.serialize_json(
            input_
        )
    ).encode()
