"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#DeleteAgentMemory``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.delete_agent_memory_response.DeleteAgentMemoryResponse:
    out: aws_sdk_bedrock_agent_runtime.types.delete_agent_memory_response.DeleteAgentMemoryResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.delete_agent_memory_request.DeleteAgentMemoryRequest) -> zapros.Request:
...
def delete_agent_memory(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.delete_agent_memory_request.DeleteAgentMemoryRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.delete_agent_memory_response.DeleteAgentMemoryResponse, zapros.Response]:
...
async def async_delete_agent_memory(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.delete_agent_memory_request.DeleteAgentMemoryRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.delete_agent_memory_response.DeleteAgentMemoryResponse, zapros.Response]:
