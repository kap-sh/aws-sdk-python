...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_response.RetrieveAndGenerateResponse:
    import aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_response
    out: aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_response.RetrieveAndGenerateResponse = aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_request.RetrieveAndGenerateRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_request.serialize_json(input)).encode()
...
def retrieve_and_generate(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_request.RetrieveAndGenerateRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_response.RetrieveAndGenerateResponse, zapros.Response]:
...
async def async_retrieve_and_generate(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_request.RetrieveAndGenerateRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_response.RetrieveAndGenerateResponse, zapros.Response]:
