...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_response.RetrieveAndGenerateResponse = aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_request.RetrieveAndGenerateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_request.serialize_json(
            input_
        )
    ).encode()
