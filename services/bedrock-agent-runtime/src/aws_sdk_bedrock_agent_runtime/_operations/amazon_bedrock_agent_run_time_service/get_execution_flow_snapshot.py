...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.get_execution_flow_snapshot_response.GetExecutionFlowSnapshotResponse:
    import aws_sdk_bedrock_agent_runtime.types.get_execution_flow_snapshot_response
    out: aws_sdk_bedrock_agent_runtime.types.get_execution_flow_snapshot_response.GetExecutionFlowSnapshotResponse = aws_sdk_bedrock_agent_runtime.types.get_execution_flow_snapshot_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_execution_flow_snapshot_request.GetExecutionFlowSnapshotRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/flows/{flowIdentifier}/aliases/{flowAliasIdentifier}/executions/{executionIdentifier}/flowsnapshot"
    ...
    url = url.replace("{executionIdentifier}", quote(str(input["execution_identifier"]), safe=""))
    params: dict[str, str] = {}
...
def get_execution_flow_snapshot(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_execution_flow_snapshot_request.GetExecutionFlowSnapshotRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.get_execution_flow_snapshot_response.GetExecutionFlowSnapshotResponse, zapros.Response]:
...
async def async_get_execution_flow_snapshot(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_execution_flow_snapshot_request.GetExecutionFlowSnapshotRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.get_execution_flow_snapshot_response.GetExecutionFlowSnapshotResponse, zapros.Response]:
