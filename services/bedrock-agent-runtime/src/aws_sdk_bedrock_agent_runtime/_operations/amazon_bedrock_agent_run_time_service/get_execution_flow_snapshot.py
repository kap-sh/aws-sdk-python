...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.get_execution_flow_snapshot_response.GetExecutionFlowSnapshotResponse = aws_sdk_bedrock_agent_runtime.types.get_execution_flow_snapshot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.get_execution_flow_snapshot_request.GetExecutionFlowSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
