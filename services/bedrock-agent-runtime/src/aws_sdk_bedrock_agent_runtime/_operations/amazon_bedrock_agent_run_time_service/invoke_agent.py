...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ModelNotReadyException":
            raise aws_sdk_bedrock_agent_runtime.errors.model_not_ready_exception.ModelNotReadyException.from_json(
                data
            )
...
def handle_response(
    ...
    _union_deser = (
        aws_sdk_bedrock_agent_runtime.types.response_stream.deserialize_event_json
    )
    _iter = cast(Any, response.iter_bytes())
    out: aws_sdk_bedrock_agent_runtime.types.invoke_agent_response.InvokeAgentResponse = {
        "completion": cast(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.invoke_agent_request.InvokeAgentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
