...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.list_flow_execution_events_response.ListFlowExecutionEventsResponse:
    import aws_sdk_bedrock_agent_runtime.types.list_flow_execution_events_response
    out: aws_sdk_bedrock_agent_runtime.types.list_flow_execution_events_response.ListFlowExecutionEventsResponse = aws_sdk_bedrock_agent_runtime.types.list_flow_execution_events_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_flow_execution_events_request.ListFlowExecutionEventsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/flows/{flowIdentifier}/aliases/{flowAliasIdentifier}/executions/{executionIdentifier}/events"
...
def list_flow_execution_events(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_flow_execution_events_request.ListFlowExecutionEventsRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.list_flow_execution_events_response.ListFlowExecutionEventsResponse, zapros.Response]:
...
async def async_list_flow_execution_events(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_flow_execution_events_request.ListFlowExecutionEventsRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.list_flow_execution_events_response.ListFlowExecutionEventsResponse, zapros.Response]:
