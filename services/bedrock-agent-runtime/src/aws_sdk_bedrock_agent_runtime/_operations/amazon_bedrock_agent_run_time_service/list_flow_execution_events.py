...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.list_flow_execution_events_response.ListFlowExecutionEventsResponse = aws_sdk_bedrock_agent_runtime.types.list_flow_execution_events_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.list_flow_execution_events_request.ListFlowExecutionEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
