...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.list_flow_executions_response.ListFlowExecutionsResponse = aws_sdk_bedrock_agent_runtime.types.list_flow_executions_response.deserialize_json(
