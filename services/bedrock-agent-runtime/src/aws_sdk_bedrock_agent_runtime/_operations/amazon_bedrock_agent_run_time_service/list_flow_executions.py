...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.list_flow_executions_response.ListFlowExecutionsResponse:
    import aws_sdk_bedrock_agent_runtime.types.list_flow_executions_response
    out: aws_sdk_bedrock_agent_runtime.types.list_flow_executions_response.ListFlowExecutionsResponse = aws_sdk_bedrock_agent_runtime.types.list_flow_executions_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_flow_executions_request.ListFlowExecutionsRequest) -> zapros.Request:
...
def list_flow_executions(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_flow_executions_request.ListFlowExecutionsRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.list_flow_executions_response.ListFlowExecutionsResponse, zapros.Response]:
...
async def async_list_flow_executions(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_flow_executions_request.ListFlowExecutionsRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.list_flow_executions_response.ListFlowExecutionsResponse, zapros.Response]:
