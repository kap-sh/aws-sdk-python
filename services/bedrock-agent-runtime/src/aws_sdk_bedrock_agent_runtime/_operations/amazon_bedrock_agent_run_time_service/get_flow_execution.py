...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.get_flow_execution_response.GetFlowExecutionResponse = aws_sdk_bedrock_agent_runtime.types.get_flow_execution_response.deserialize_json(
