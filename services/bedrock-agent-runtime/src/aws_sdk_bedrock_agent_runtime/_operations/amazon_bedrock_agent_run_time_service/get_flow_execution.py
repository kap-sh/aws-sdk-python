...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.get_flow_execution_response.GetFlowExecutionResponse:
    import aws_sdk_bedrock_agent_runtime.types.get_flow_execution_response
    out: aws_sdk_bedrock_agent_runtime.types.get_flow_execution_response.GetFlowExecutionResponse = aws_sdk_bedrock_agent_runtime.types.get_flow_execution_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_flow_execution_request.GetFlowExecutionRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/flows/{flowIdentifier}/aliases/{flowAliasIdentifier}/executions/{executionIdentifier}"
...
def get_flow_execution(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_flow_execution_request.GetFlowExecutionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.get_flow_execution_response.GetFlowExecutionResponse, zapros.Response]:
...
async def async_get_flow_execution(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_flow_execution_request.GetFlowExecutionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.get_flow_execution_response.GetFlowExecutionResponse, zapros.Response]:
