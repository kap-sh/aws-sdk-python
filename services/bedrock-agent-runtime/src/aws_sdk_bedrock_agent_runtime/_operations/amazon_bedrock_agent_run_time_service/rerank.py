...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.rerank_response.RerankResponse = (
        aws_sdk_bedrock_agent_runtime.types.rerank_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_bedrock_agent_runtime.types.rerank_request.RerankRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agent_runtime.types.rerank_request.serialize_json(input)
    ).encode()
...
def rerank(
    ...
    aws_sdk_bedrock_agent_runtime.types.rerank_response.RerankResponse, zapros.Response
]:
