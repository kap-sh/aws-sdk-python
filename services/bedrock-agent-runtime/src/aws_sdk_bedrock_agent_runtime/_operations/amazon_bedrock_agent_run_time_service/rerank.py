...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.rerank_response.RerankResponse:
    import aws_sdk_bedrock_agent_runtime.types.rerank_response
    out: aws_sdk_bedrock_agent_runtime.types.rerank_response.RerankResponse = aws_sdk_bedrock_agent_runtime.types.rerank_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.rerank_request.RerankRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agent_runtime.types.rerank_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agent_runtime.types.rerank_request.serialize_json(input)).encode()
...
def rerank(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.rerank_request.RerankRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.rerank_response.RerankResponse, zapros.Response]:
...
async def async_rerank(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.rerank_request.RerankRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.rerank_response.RerankResponse, zapros.Response]:
