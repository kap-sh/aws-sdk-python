...
def handle_response(
    ...
    _union_deser = aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_stream_response_output.deserialize_event_json
    _iter = cast(Any, response.iter_bytes())
    out: aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_stream_response.RetrieveAndGenerateStreamResponse = {
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_stream_request.RetrieveAndGenerateStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_stream_request.serialize_json(
            input_
        )
    ).encode()
