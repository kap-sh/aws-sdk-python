...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.end_session_response.EndSessionResponse = (
        aws_sdk_bedrock_agent_runtime.types.end_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.end_session_request.EndSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
