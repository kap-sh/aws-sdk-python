"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#EndSession``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.end_session_response.EndSessionResponse:
    import aws_sdk_bedrock_agent_runtime.types.end_session_response
    out: aws_sdk_bedrock_agent_runtime.types.end_session_response.EndSessionResponse = aws_sdk_bedrock_agent_runtime.types.end_session_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.end_session_request.EndSessionRequest) -> zapros.Request:
...
def end_session(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.end_session_request.EndSessionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.end_session_response.EndSessionResponse, zapros.Response]:
...
async def async_end_session(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.end_session_request.EndSessionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.end_session_response.EndSessionResponse, zapros.Response]:
