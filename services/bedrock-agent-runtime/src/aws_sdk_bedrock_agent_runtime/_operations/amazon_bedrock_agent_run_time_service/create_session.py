...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.create_session_response.CreateSessionResponse = aws_sdk_bedrock_agent_runtime.types.create_session_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_bedrock_agent_runtime.types.create_session_request.CreateSessionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agent_runtime.types.create_session_request.serialize_json(input)
    ).encode()
