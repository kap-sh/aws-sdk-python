...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.create_session_response.CreateSessionResponse:
    import aws_sdk_bedrock_agent_runtime.types.create_session_response
    out: aws_sdk_bedrock_agent_runtime.types.create_session_response.CreateSessionResponse = aws_sdk_bedrock_agent_runtime.types.create_session_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.create_session_request.CreateSessionRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agent_runtime.types.create_session_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agent_runtime.types.create_session_request.serialize_json(input)).encode()
...
def create_session(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.create_session_request.CreateSessionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.create_session_response.CreateSessionResponse, zapros.Response]:
...
async def async_create_session(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.create_session_request.CreateSessionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.create_session_response.CreateSessionResponse, zapros.Response]:
