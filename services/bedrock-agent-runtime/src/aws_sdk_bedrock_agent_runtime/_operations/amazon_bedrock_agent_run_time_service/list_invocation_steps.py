...
) -> aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_response.ListInvocationStepsResponse:
    import aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_response

    out: aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_response.ListInvocationStepsResponse = aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_request.ListInvocationStepsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_invocation_steps(
