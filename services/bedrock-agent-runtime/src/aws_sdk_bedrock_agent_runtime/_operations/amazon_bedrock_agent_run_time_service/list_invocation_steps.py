"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#ListInvocationSteps``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_response
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_response.ListInvocationStepsResponse:
    import aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_response
    out: aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_response.ListInvocationStepsResponse = aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_request.ListInvocationStepsRequest) -> zapros.Request:
    ...
    import aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_request
    body: bytes | None = json.dumps(aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_request.serialize_json(input)).encode()
...
def list_invocation_steps(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_request.ListInvocationStepsRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_response.ListInvocationStepsResponse, zapros.Response]:
...
async def async_list_invocation_steps(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_request.ListInvocationStepsRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.list_invocation_steps_response.ListInvocationStepsResponse, zapros.Response]:
