...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.get_session_response.GetSessionResponse:
    import aws_sdk_bedrock_agent_runtime.types.get_session_response
    out: aws_sdk_bedrock_agent_runtime.types.get_session_response.GetSessionResponse = aws_sdk_bedrock_agent_runtime.types.get_session_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_session_request.GetSessionRequest) -> zapros.Request:
...
def get_session(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_session_request.GetSessionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.get_session_response.GetSessionResponse, zapros.Response]:
...
async def async_get_session(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_session_request.GetSessionRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.get_session_response.GetSessionResponse, zapros.Response]:
