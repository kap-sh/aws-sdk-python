...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.get_session_response.GetSessionResponse = (
        aws_sdk_bedrock_agent_runtime.types.get_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agent_runtime.types.get_session_request.GetSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
