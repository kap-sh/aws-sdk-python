"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#GetAgentMemory``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bedrock_agent_runtime.types.get_agent_memory_response.GetAgentMemoryResponse:
    import aws_sdk_bedrock_agent_runtime.types.get_agent_memory_response
    out: aws_sdk_bedrock_agent_runtime.types.get_agent_memory_response.GetAgentMemoryResponse = aws_sdk_bedrock_agent_runtime.types.get_agent_memory_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_agent_memory_request.GetAgentMemoryRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/agents/{agentId}/agentAliases/{agentAliasId}/memories"
    ...
    if "memory_type" in input:
        params["memoryType"] = str(input["memory_type"])
    if "memory_id" in input:
        params["memoryId"] = str(input["memory_id"])
...
def get_agent_memory(options: OperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_agent_memory_request.GetAgentMemoryRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.get_agent_memory_response.GetAgentMemoryResponse, zapros.Response]:
...
async def async_get_agent_memory(options: AsyncOperationOptions, input: aws_sdk_bedrock_agent_runtime.types.get_agent_memory_request.GetAgentMemoryRequest) -> tuple[aws_sdk_bedrock_agent_runtime.types.get_agent_memory_response.GetAgentMemoryResponse, zapros.Response]:
