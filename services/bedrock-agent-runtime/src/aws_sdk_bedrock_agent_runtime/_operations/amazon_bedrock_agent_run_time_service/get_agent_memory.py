...
def handle_response(
    ...
    out: aws_sdk_bedrock_agent_runtime.types.get_agent_memory_response.GetAgentMemoryResponse = aws_sdk_bedrock_agent_runtime.types.get_agent_memory_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_bedrock_agent_runtime.types.get_agent_memory_request.GetAgentMemoryRequest,
) -> zapros.Request:
...
async def async_get_agent_memory(
