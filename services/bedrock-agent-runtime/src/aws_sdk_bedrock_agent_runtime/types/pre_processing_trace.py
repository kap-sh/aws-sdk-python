...
def serialize_json(value: PreProcessingTrace) -> dict:
    if "modelInvocationInput" in value:
        ...
        return {
            "modelInvocationOutput": aws_sdk_bedrock_agent_runtime.types.pre_processing_model_invocation_output.serialize_json(
...
def deserialize_json(data: dict) -> PreProcessingTrace:
    if "modelInvocationInput" in data:
        ...
        return {
            "modelInvocationOutput": aws_sdk_bedrock_agent_runtime.types.pre_processing_model_invocation_output.deserialize_json(
