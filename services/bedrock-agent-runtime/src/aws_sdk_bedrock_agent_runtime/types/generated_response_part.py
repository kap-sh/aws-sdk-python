...
class GeneratedResponsePart(TypedDict):
    text_response_part: NotRequired["aws_sdk_bedrock_agent_runtime.types.text_response_part.TextResponsePart"]
...
def serialize_json(value: GeneratedResponsePart) -> dict:
    ...
    if "text_response_part" in value:
        import aws_sdk_bedrock_agent_runtime.types.text_response_part
        out["textResponsePart"] = aws_sdk_bedrock_agent_runtime.types.text_response_part.serialize_json(value["text_response_part"])
    return out
...
def deserialize_json(data: dict) -> GeneratedResponsePart:
    ...
    if "textResponsePart" in data:
        import aws_sdk_bedrock_agent_runtime.types.text_response_part
        out["text_response_part"] = aws_sdk_bedrock_agent_runtime.types.text_response_part.deserialize_json(data["textResponsePart"])
    return out