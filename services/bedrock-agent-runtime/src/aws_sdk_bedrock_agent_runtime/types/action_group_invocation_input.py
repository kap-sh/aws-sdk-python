...
class ActionGroupInvocationInput(TypedDict):
    action_group_name: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.action_group_name.ActionGroupName"
    ]
    ...
    request_body: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.request_body.RequestBody"
    ]
...
def serialize_json(value: ActionGroupInvocationInput) -> dict:
    ...
    if "parameters" in value:
        ...
        out["parameters"] = (
            aws_sdk_bedrock_agent_runtime.types.parameters.serialize_json(
                value["parameters"]
            )
        )
    if "request_body" in value:
        ...
        out["requestBody"] = (
            aws_sdk_bedrock_agent_runtime.types.request_body.serialize_json(
                value["request_body"]
            )
        )
    ...
    if "execution_type" in value:
        ...
        out["executionType"] = (
            aws_sdk_bedrock_agent_runtime.types.execution_type.serialize_json(
...
def deserialize_json(data: dict) -> ActionGroupInvocationInput:
    ...
    if "parameters" in data:
        ...
        out["parameters"] = (
            aws_sdk_bedrock_agent_runtime.types.parameters.deserialize_json(
                data["parameters"]
            )
        )
    if "requestBody" in data:
        ...
        out["request_body"] = (
            aws_sdk_bedrock_agent_runtime.types.request_body.deserialize_json(
                data["requestBody"]
            )
        )
    if "function" in data:
    ...
    if "executionType" in data:
        ...
        out["execution_type"] = (
            aws_sdk_bedrock_agent_runtime.types.execution_type.deserialize_json(
                data["executionType"]
            )
        )
