...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent_runtime.types.external_sources_retrieve_and_generate_configuration
    import aws_sdk_bedrock_agent_runtime.types.knowledge_base_retrieve_and_generate_configuration
...
class RetrieveAndGenerateConfiguration(TypedDict):
    ...
    knowledge_base_configuration: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.knowledge_base_retrieve_and_generate_configuration.KnowledgeBaseRetrieveAndGenerateConfiguration"
    ]
    ...
    external_sources_configuration: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.external_sources_retrieve_and_generate_configuration.ExternalSourcesRetrieveAndGenerateConfiguration"
    ]
...
def serialize_json(value: RetrieveAndGenerateConfiguration) -> dict:
    ...
    out["type"] = (
        aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_type.serialize_json(
            value["type"]
        )
    )
    if "knowledge_base_configuration" in value:
        ...
        out["knowledgeBaseConfiguration"] = (
            aws_sdk_bedrock_agent_runtime.types.knowledge_base_retrieve_and_generate_configuration.serialize_json(
    ...
    if "external_sources_configuration" in value:
        ...
        out["externalSourcesConfiguration"] = (
            aws_sdk_bedrock_agent_runtime.types.external_sources_retrieve_and_generate_configuration.serialize_json(
...
def deserialize_json(data: dict) -> RetrieveAndGenerateConfiguration:
    ...
    if "type" in data:
        ...
        out["type"] = (
            aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_type.deserialize_json(
                data["type"]
            )
        )
    else:
    ...
    if "knowledgeBaseConfiguration" in data:
        ...
        out["knowledge_base_configuration"] = (
            aws_sdk_bedrock_agent_runtime.types.knowledge_base_retrieve_and_generate_configuration.deserialize_json(
    ...
    if "externalSourcesConfiguration" in data:
        ...
        out["external_sources_configuration"] = (
            aws_sdk_bedrock_agent_runtime.types.external_sources_retrieve_and_generate_configuration.deserialize_json(
