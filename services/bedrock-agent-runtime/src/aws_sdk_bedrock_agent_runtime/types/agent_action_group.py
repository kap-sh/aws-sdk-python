...
class AgentActionGroup(TypedDict, closed=True):
    ...
    parent_action_group_signature: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.action_group_signature.ActionGroupSignature"
    ]
    ...
    action_group_executor: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.action_group_executor.ActionGroupExecutor"
    ]
    ...
    function_schema: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.function_schema.FunctionSchema"
    ]
    ...
    parent_action_group_signature_params: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.action_group_signature_params.ActionGroupSignatureParams"
    ]
...
def serialize_json(value: AgentActionGroup) -> dict:
    ...
    if "parent_action_group_signature" in value:
        ...
        out["parentActionGroupSignature"] = (
            aws_sdk_bedrock_agent_runtime.types.action_group_signature.serialize_json(
    ...
    if "action_group_executor" in value:
        ...
        out["actionGroupExecutor"] = (
            aws_sdk_bedrock_agent_runtime.types.action_group_executor.serialize_json(
    ...
    if "api_schema" in value:
        ...
        out["apiSchema"] = (
            aws_sdk_bedrock_agent_runtime.types.api_schema.serialize_json(
                value["api_schema"]
            )
        )
    if "function_schema" in value:
        ...
        out["functionSchema"] = (
            aws_sdk_bedrock_agent_runtime.types.function_schema.serialize_json(
    ...
    if "parent_action_group_signature_params" in value:
        ...
        out["parentActionGroupSignatureParams"] = (
            aws_sdk_bedrock_agent_runtime.types.action_group_signature_params.serialize_json(
...
def deserialize_json(data: dict) -> AgentActionGroup:
    ...
    if "parentActionGroupSignature" in data:
        ...
        out["parent_action_group_signature"] = (
            aws_sdk_bedrock_agent_runtime.types.action_group_signature.deserialize_json(
    ...
    if "actionGroupExecutor" in data:
        ...
        out["action_group_executor"] = (
            aws_sdk_bedrock_agent_runtime.types.action_group_executor.deserialize_json(
    ...
    if "apiSchema" in data:
        ...
        out["api_schema"] = (
            aws_sdk_bedrock_agent_runtime.types.api_schema.deserialize_json(
                data["apiSchema"]
            )
        )
    if "functionSchema" in data:
        ...
        out["function_schema"] = (
            aws_sdk_bedrock_agent_runtime.types.function_schema.deserialize_json(
                data["functionSchema"]
            )
        )
    if "parentActionGroupSignatureParams" in data:
        ...
        out["parent_action_group_signature_params"] = (
            aws_sdk_bedrock_agent_runtime.types.action_group_signature_params.deserialize_json(
