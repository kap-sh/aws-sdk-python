...
class FunctionResult(TypedDict):
    ...
    confirmation_state: NotRequired["aws_sdk_bedrock_agent_runtime.types.confirmation_state.ConfirmationState"]
    ...
    response_body: NotRequired["aws_sdk_bedrock_agent_runtime.types.response_body.ResponseBody"]
    ...
    response_state: NotRequired["aws_sdk_bedrock_agent_runtime.types.response_state.ResponseState"]
...
def serialize_json(value: FunctionResult) -> dict:
    ...
    if "confirmation_state" in value:
        import aws_sdk_bedrock_agent_runtime.types.confirmation_state
        out["confirmationState"] = aws_sdk_bedrock_agent_runtime.types.confirmation_state.serialize_json(value["confirmation_state"])
    if "function" in value:
        out["function"] = value["function"]
    if "response_body" in value:
        import aws_sdk_bedrock_agent_runtime.types.response_body
        out["responseBody"] = aws_sdk_bedrock_agent_runtime.types.response_body.serialize_json(value["response_body"])
    if "response_state" in value:
        import aws_sdk_bedrock_agent_runtime.types.response_state
        out["responseState"] = aws_sdk_bedrock_agent_runtime.types.response_state.serialize_json(value["response_state"])
...
def deserialize_json(data: dict) -> FunctionResult:
    ...
    if "confirmationState" in data:
        import aws_sdk_bedrock_agent_runtime.types.confirmation_state
        out["confirmation_state"] = aws_sdk_bedrock_agent_runtime.types.confirmation_state.deserialize_json(data["confirmationState"])
    if "function" in data:
        out["function"] = data["function"]
    if "responseBody" in data:
        import aws_sdk_bedrock_agent_runtime.types.response_body
        out["response_body"] = aws_sdk_bedrock_agent_runtime.types.response_body.deserialize_json(data["responseBody"])
    if "responseState" in data:
        import aws_sdk_bedrock_agent_runtime.types.response_state
        out["response_state"] = aws_sdk_bedrock_agent_runtime.types.response_state.deserialize_json(data["responseState"])
    if "agentId" in data:
