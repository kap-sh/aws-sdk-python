...
def serialize_json(value: FlowTrace) -> dict:
    if "nodeInputTrace" in value:
        ...
        return {
            "nodeInputTrace": aws_sdk_bedrock_agent_runtime.types.flow_trace_node_input_event.serialize_json(
        ...
        return {
            "nodeOutputTrace": aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_event.serialize_json(
        ...
        return {
            "conditionNodeResultTrace": aws_sdk_bedrock_agent_runtime.types.flow_trace_condition_node_result_event.serialize_json(
        ...
        return {
            "nodeActionTrace": aws_sdk_bedrock_agent_runtime.types.flow_trace_node_action_event.serialize_json(
        ...
        return {
            "nodeDependencyTrace": aws_sdk_bedrock_agent_runtime.types.flow_trace_dependency_event.serialize_json(
...
def deserialize_json(data: dict) -> FlowTrace:
    if "nodeInputTrace" in data:
        ...
        return {
            "nodeInputTrace": aws_sdk_bedrock_agent_runtime.types.flow_trace_node_input_event.deserialize_json(
                data["nodeInputTrace"]
            )
        }
        ...
        return {
            "nodeOutputTrace": aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_event.deserialize_json(
        ...
        return {
            "conditionNodeResultTrace": aws_sdk_bedrock_agent_runtime.types.flow_trace_condition_node_result_event.deserialize_json(
        ...
        return {
            "nodeActionTrace": aws_sdk_bedrock_agent_runtime.types.flow_trace_node_action_event.deserialize_json(
        ...
        return {
            "nodeDependencyTrace": aws_sdk_bedrock_agent_runtime.types.flow_trace_dependency_event.deserialize_json(
