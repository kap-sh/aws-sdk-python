...
class InvokeAgentRequest(TypedDict):
...
def serialize_json(value: InvokeAgentRequest) -> dict:
    ...
    if "session_state" in value:
        ...
        out["sessionState"] = (
            aws_sdk_bedrock_agent_runtime.types.session_state.serialize_json(
                value["session_state"]
            )
        )
    ...
    if "bedrock_model_configurations" in value:
        ...
        out["bedrockModelConfigurations"] = (
            aws_sdk_bedrock_agent_runtime.types.bedrock_model_configurations.serialize_json(
...
def deserialize_json(data: dict) -> InvokeAgentRequest:
    ...
    if "sessionState" in data:
        ...
        out["session_state"] = (
            aws_sdk_bedrock_agent_runtime.types.session_state.deserialize_json(
                data["sessionState"]
            )
        )
    ...
    if "bedrockModelConfigurations" in data:
        ...
        out["bedrock_model_configurations"] = (
            aws_sdk_bedrock_agent_runtime.types.bedrock_model_configurations.deserialize_json(
