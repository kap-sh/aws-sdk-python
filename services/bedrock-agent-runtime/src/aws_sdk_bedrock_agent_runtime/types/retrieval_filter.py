...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent_runtime.types.filter_attribute
...
def serialize_json(value: RetrievalFilter) -> dict:
    if "equals" in value:
        ...
        return {
            "equals": aws_sdk_bedrock_agent_runtime.types.filter_attribute.serialize_json(
                value["equals"]
            )
        }
        ...
        return {
            "notEquals": aws_sdk_bedrock_agent_runtime.types.filter_attribute.serialize_json(
                value["notEquals"]
            )
        }
        ...
        return {
            "greaterThan": aws_sdk_bedrock_agent_runtime.types.filter_attribute.serialize_json(
                value["greaterThan"]
            )
        }
        ...
        return {
            "greaterThanOrEquals": aws_sdk_bedrock_agent_runtime.types.filter_attribute.serialize_json(
        ...
        return {
            "lessThan": aws_sdk_bedrock_agent_runtime.types.filter_attribute.serialize_json(
                value["lessThan"]
            )
        }
        ...
        return {
            "lessThanOrEquals": aws_sdk_bedrock_agent_runtime.types.filter_attribute.serialize_json(
        ...
        return {
            "in": aws_sdk_bedrock_agent_runtime.types.filter_attribute.serialize_json(
                value["in"]
            )
        }
    elif "notIn" in value:
        ...
        return {
            "notIn": aws_sdk_bedrock_agent_runtime.types.filter_attribute.serialize_json(
                value["notIn"]
            )
        }
        ...
        return {
            "startsWith": aws_sdk_bedrock_agent_runtime.types.filter_attribute.serialize_json(
                value["startsWith"]
            )
        }
        ...
        return {
            "listContains": aws_sdk_bedrock_agent_runtime.types.filter_attribute.serialize_json(
                value["listContains"]
            )
        }
        ...
        return {
            "stringContains": aws_sdk_bedrock_agent_runtime.types.filter_attribute.serialize_json(
        ...
        return {
            "andAll": aws_sdk_bedrock_agent_runtime.types.retrieval_filter_list.serialize_json(
                value["andAll"]
            )
        }
    elif "orAll" in value:
        ...
        return {
            "orAll": aws_sdk_bedrock_agent_runtime.types.retrieval_filter_list.serialize_json(
                value["orAll"]
            )
        }
    else:
...
def deserialize_json(data: dict) -> RetrievalFilter:
    if "equals" in data:
        ...
        return {
            "equals": aws_sdk_bedrock_agent_runtime.types.filter_attribute.deserialize_json(
                data["equals"]
            )
        }
        ...
        return {
            "notEquals": aws_sdk_bedrock_agent_runtime.types.filter_attribute.deserialize_json(
                data["notEquals"]
            )
        }
        ...
        return {
            "greaterThan": aws_sdk_bedrock_agent_runtime.types.filter_attribute.deserialize_json(
                data["greaterThan"]
            )
        }
        ...
        return {
            "greaterThanOrEquals": aws_sdk_bedrock_agent_runtime.types.filter_attribute.deserialize_json(
        ...
        return {
            "lessThan": aws_sdk_bedrock_agent_runtime.types.filter_attribute.deserialize_json(
                data["lessThan"]
            )
        }
        ...
        return {
            "lessThanOrEquals": aws_sdk_bedrock_agent_runtime.types.filter_attribute.deserialize_json(
        ...
        return {
            "in": aws_sdk_bedrock_agent_runtime.types.filter_attribute.deserialize_json(
                data["in"]
            )
        }
    elif "notIn" in data:
        ...
        return {
            "notIn": aws_sdk_bedrock_agent_runtime.types.filter_attribute.deserialize_json(
                data["notIn"]
            )
        }
        ...
        return {
            "startsWith": aws_sdk_bedrock_agent_runtime.types.filter_attribute.deserialize_json(
                data["startsWith"]
            )
        }
        ...
        return {
            "listContains": aws_sdk_bedrock_agent_runtime.types.filter_attribute.deserialize_json(
                data["listContains"]
            )
        }
        ...
        return {
            "stringContains": aws_sdk_bedrock_agent_runtime.types.filter_attribute.deserialize_json(
                data["stringContains"]
            )
        }
    elif "andAll" in data:
        ...
        return {
            "andAll": aws_sdk_bedrock_agent_runtime.types.retrieval_filter_list.deserialize_json(
                data["andAll"]
            )
        }
    elif "orAll" in data:
        ...
        return {
            "orAll": aws_sdk_bedrock_agent_runtime.types.retrieval_filter_list.deserialize_json(
                data["orAll"]
            )
        }
    else:
