...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent_runtime.types.performance_config_latency


class PerformanceConfiguration(TypedDict, closed=True):
    latency: "aws_sdk_bedrock_agent_runtime.types.performance_config_latency.PerformanceConfigLatency"
...
def serialize_json(value: PerformanceConfiguration) -> dict:
    ...
    out["latency"] = (
        aws_sdk_bedrock_agent_runtime.types.performance_config_latency.serialize_json(
...
def deserialize_json(data: dict) -> PerformanceConfiguration:
    ...
    if "latency" in data:
        ...
        out["latency"] = (
            aws_sdk_bedrock_agent_runtime.types.performance_config_latency.deserialize_json(
                data["latency"]
            )
        )
    else:
