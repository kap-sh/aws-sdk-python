...
def serialize_json(value: FlowExecutionEvent) -> dict:
    if "flowInputEvent" in value:
        ...
        return {
            "flowInputEvent": aws_sdk_bedrock_agent_runtime.types.flow_execution_input_event.serialize_json(
        ...
        return {
            "flowOutputEvent": aws_sdk_bedrock_agent_runtime.types.flow_execution_output_event.serialize_json(
        ...
        return {
            "nodeInputEvent": aws_sdk_bedrock_agent_runtime.types.node_input_event.serialize_json(
        ...
        return {
            "nodeOutputEvent": aws_sdk_bedrock_agent_runtime.types.node_output_event.serialize_json(
        ...
        return {
            "conditionResultEvent": aws_sdk_bedrock_agent_runtime.types.condition_result_event.serialize_json(
        ...
        return {
            "nodeFailureEvent": aws_sdk_bedrock_agent_runtime.types.node_failure_event.serialize_json(
        ...
        return {
            "flowFailureEvent": aws_sdk_bedrock_agent_runtime.types.flow_failure_event.serialize_json(
        ...
        return {
            "nodeActionEvent": aws_sdk_bedrock_agent_runtime.types.node_action_event.serialize_json(
        ...
        return {
            "nodeDependencyEvent": aws_sdk_bedrock_agent_runtime.types.node_dependency_event.serialize_json(
...
def deserialize_json(data: dict) -> FlowExecutionEvent:
    if "flowInputEvent" in data:
        ...
        return {
            "flowInputEvent": aws_sdk_bedrock_agent_runtime.types.flow_execution_input_event.deserialize_json(
                data["flowInputEvent"]
            )
        }
        ...
        return {
            "flowOutputEvent": aws_sdk_bedrock_agent_runtime.types.flow_execution_output_event.deserialize_json(
        ...
        return {
            "nodeInputEvent": aws_sdk_bedrock_agent_runtime.types.node_input_event.deserialize_json(
                data["nodeInputEvent"]
            )
        }
        ...
        return {
            "nodeOutputEvent": aws_sdk_bedrock_agent_runtime.types.node_output_event.deserialize_json(
        ...
        return {
            "conditionResultEvent": aws_sdk_bedrock_agent_runtime.types.condition_result_event.deserialize_json(
        ...
        return {
            "nodeFailureEvent": aws_sdk_bedrock_agent_runtime.types.node_failure_event.deserialize_json(
        ...
        return {
            "flowFailureEvent": aws_sdk_bedrock_agent_runtime.types.flow_failure_event.deserialize_json(
        ...
        return {
            "nodeActionEvent": aws_sdk_bedrock_agent_runtime.types.node_action_event.deserialize_json(
        ...
        return {
            "nodeDependencyEvent": aws_sdk_bedrock_agent_runtime.types.node_dependency_event.deserialize_json(
