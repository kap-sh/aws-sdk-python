...
FlowTraceConditions: TypeAlias = list[
    "aws_sdk_bedrock_agent_runtime.types.flow_trace_condition.FlowTraceCondition"
]
...
def serialize_json(value: FlowTraceConditions) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_bedrock_agent_runtime.types.flow_trace_condition.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> FlowTraceConditions:
    ...
    for item in data:
        out.append(
            aws_sdk_bedrock_agent_runtime.types.flow_trace_condition.deserialize_json(
                item
            )
        )
    return out
