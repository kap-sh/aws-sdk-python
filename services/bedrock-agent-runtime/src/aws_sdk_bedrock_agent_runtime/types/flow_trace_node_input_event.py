...
class FlowTraceNodeInputEvent(TypedDict):
...
def serialize_json(value: FlowTraceNodeInputEvent) -> dict:
    ...
    import aws_sdk_bedrock_agent_runtime.types.flow_trace_node_input_fields
    out["fields"] = aws_sdk_bedrock_agent_runtime.types.flow_trace_node_input_fields.serialize_json(value["fields"])
    return out
...
def deserialize_json(data: dict) -> FlowTraceNodeInputEvent:
    ...
    if "fields" in data:
        import aws_sdk_bedrock_agent_runtime.types.flow_trace_node_input_fields
        out["fields"] = aws_sdk_bedrock_agent_runtime.types.flow_trace_node_input_fields.deserialize_json(data["fields"])
    else:
