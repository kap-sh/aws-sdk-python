...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agent_runtime.types.search_type
...
def serialize_json(value: KnowledgeBaseVectorSearchConfiguration) -> dict:
    ...
    if "override_search_type" in value:
        ...
        out["overrideSearchType"] = (
            aws_sdk_bedrock_agent_runtime.types.search_type.serialize_json(
    ...
    if "filter" in value:
        ...
        out["filter"] = (
            aws_sdk_bedrock_agent_runtime.types.retrieval_filter.serialize_json(
                value["filter"]
            )
        )
    if "reranking_configuration" in value:
        ...
        out["rerankingConfiguration"] = (
            aws_sdk_bedrock_agent_runtime.types.vector_search_reranking_configuration.serialize_json(
    ...
    if "implicit_filter_configuration" in value:
        ...
        out["implicitFilterConfiguration"] = (
            aws_sdk_bedrock_agent_runtime.types.implicit_filter_configuration.serialize_json(
...
def deserialize_json(data: dict) -> KnowledgeBaseVectorSearchConfiguration:
    ...
    if "overrideSearchType" in data:
        ...
        out["override_search_type"] = (
            aws_sdk_bedrock_agent_runtime.types.search_type.deserialize_json(
    ...
    if "filter" in data:
        ...
        out["filter"] = (
            aws_sdk_bedrock_agent_runtime.types.retrieval_filter.deserialize_json(
                data["filter"]
            )
        )
    if "rerankingConfiguration" in data:
        ...
        out["reranking_configuration"] = (
            aws_sdk_bedrock_agent_runtime.types.vector_search_reranking_configuration.deserialize_json(
    ...
    if "implicitFilterConfiguration" in data:
        ...
        out["implicit_filter_configuration"] = (
            aws_sdk_bedrock_agent_runtime.types.implicit_filter_configuration.deserialize_json(
