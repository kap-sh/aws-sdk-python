...
def serialize_json(value: Memory) -> dict:
    if "sessionSummary" in value:
        ...
        return {
            "sessionSummary": aws_sdk_bedrock_agent_runtime.types.memory_session_summary.serialize_json(
...
def deserialize_json(data: dict) -> Memory:
    if "sessionSummary" in data:
        ...
        return {
            "sessionSummary": aws_sdk_bedrock_agent_runtime.types.memory_session_summary.deserialize_json(
                data["sessionSummary"]
            )
        }
    else:
