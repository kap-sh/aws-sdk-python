...
class BedrockRerankingConfiguration(TypedDict):
...
def serialize_json(value: BedrockRerankingConfiguration) -> dict:
    ...
    import aws_sdk_bedrock_agent_runtime.types.bedrock_reranking_model_configuration
    out["modelConfiguration"] = aws_sdk_bedrock_agent_runtime.types.bedrock_reranking_model_configuration.serialize_json(value["model_configuration"])
    return out
...
def deserialize_json(data: dict) -> BedrockRerankingConfiguration:
    ...
    if "modelConfiguration" in data:
        import aws_sdk_bedrock_agent_runtime.types.bedrock_reranking_model_configuration
        out["model_configuration"] = aws_sdk_bedrock_agent_runtime.types.bedrock_reranking_model_configuration.deserialize_json(data["modelConfiguration"])
    else:
        raise DeserializationError("BedrockRerankingConfiguration.model_configuration required")
    return out