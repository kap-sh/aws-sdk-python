...
class GuardrailTrace(TypedDict):
    action: NotRequired["aws_sdk_bedrock_agent_runtime.types.guardrail_action.GuardrailAction"]
    ...
    input_assessments: NotRequired["aws_sdk_bedrock_agent_runtime.types.guardrail_assessment_list.GuardrailAssessmentList"]
    """<p>The details of the input assessments used in the Guardrail Trace.</p>"""
    output_assessments: NotRequired["aws_sdk_bedrock_agent_runtime.types.guardrail_assessment_list.GuardrailAssessmentList"]
...
def serialize_json(value: GuardrailTrace) -> dict:
    ...
    if "action" in value:
        import aws_sdk_bedrock_agent_runtime.types.guardrail_action
        out["action"] = aws_sdk_bedrock_agent_runtime.types.guardrail_action.serialize_json(value["action"])
    if "trace_id" in value:
        out["traceId"] = value["trace_id"]
    if "input_assessments" in value:
        import aws_sdk_bedrock_agent_runtime.types.guardrail_assessment_list
        out["inputAssessments"] = aws_sdk_bedrock_agent_runtime.types.guardrail_assessment_list.serialize_json(value["input_assessments"])
    if "output_assessments" in value:
        import aws_sdk_bedrock_agent_runtime.types.guardrail_assessment_list
        out["outputAssessments"] = aws_sdk_bedrock_agent_runtime.types.guardrail_assessment_list.serialize_json(value["output_assessments"])
...
def deserialize_json(data: dict) -> GuardrailTrace:
    ...
    if "action" in data:
        import aws_sdk_bedrock_agent_runtime.types.guardrail_action
        out["action"] = aws_sdk_bedrock_agent_runtime.types.guardrail_action.deserialize_json(data["action"])
    if "traceId" in data:
        out["trace_id"] = data["traceId"]
    if "inputAssessments" in data:
        import aws_sdk_bedrock_agent_runtime.types.guardrail_assessment_list
        out["input_assessments"] = aws_sdk_bedrock_agent_runtime.types.guardrail_assessment_list.deserialize_json(data["inputAssessments"])
    if "outputAssessments" in data:
        import aws_sdk_bedrock_agent_runtime.types.guardrail_assessment_list
        out["output_assessments"] = aws_sdk_bedrock_agent_runtime.types.guardrail_assessment_list.deserialize_json(data["outputAssessments"])
    if "metadata" in data:
        import aws_sdk_bedrock_agent_runtime.types.metadata
