...
def serialize_json(value: CreateSessionRequest) -> dict:
    ...
    if "tags" in value:
        import aws_sdk_bedrock_agent_runtime.types.tags_map
        out["tags"] = aws_sdk_bedrock_agent_runtime.types.tags_map.serialize_json(value["tags"])
    return out
...
def deserialize_json(data: dict) -> CreateSessionRequest:
    ...
    if "tags" in data:
        import aws_sdk_bedrock_agent_runtime.types.tags_map
        out["tags"] = aws_sdk_bedrock_agent_runtime.types.tags_map.deserialize_json(data["tags"])
    return out