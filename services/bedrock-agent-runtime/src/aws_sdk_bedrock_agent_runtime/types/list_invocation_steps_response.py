...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent_runtime.types.invocation_step_summaries
    import aws_sdk_bedrock_agent_runtime.types.next_token


class ListInvocationStepsResponse(TypedDict):
    invocation_step_summaries: "aws_sdk_bedrock_agent_runtime.types.invocation_step_summaries.InvocationStepSummaries"
...
def serialize_json(value: ListInvocationStepsResponse) -> dict:
    ...
    out["invocationStepSummaries"] = (
        aws_sdk_bedrock_agent_runtime.types.invocation_step_summaries.serialize_json(
...
def deserialize_json(data: dict) -> ListInvocationStepsResponse:
    ...
    if "invocationStepSummaries" in data:
        ...
        out["invocation_step_summaries"] = (
            aws_sdk_bedrock_agent_runtime.types.invocation_step_summaries.deserialize_json(
