...
class FlowTraceNodeOutputField(TypedDict):
    node_output_name: "aws_sdk_bedrock_agent_runtime.types.node_output_name.NodeOutputName"
    ...
    next: NotRequired["aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_next_list.FlowTraceNodeOutputNextList"]
...
def serialize_json(value: FlowTraceNodeOutputField) -> dict:
    ...
    import aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_content
    out["content"] = aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_content.serialize_json(value["content"])
    if "next" in value:
        import aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_next_list
        out["next"] = aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_next_list.serialize_json(value["next"])
    if "type" in value:
        import aws_sdk_bedrock_agent_runtime.types.flow_node_io_data_type
...
def deserialize_json(data: dict) -> FlowTraceNodeOutputField:
    ...
    if "content" in data:
        import aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_content
        out["content"] = aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_content.deserialize_json(data["content"])
    else:
        raise DeserializationError("FlowTraceNodeOutputField.content required")
    if "next" in data:
        import aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_next_list
        out["next"] = aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_next_list.deserialize_json(data["next"])
    if "type" in data:
        import aws_sdk_bedrock_agent_runtime.types.flow_node_io_data_type
