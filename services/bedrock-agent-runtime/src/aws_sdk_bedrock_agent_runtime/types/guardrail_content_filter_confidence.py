...
GuardrailContentFilterConfidence: TypeAlias = Literal["NONE", "LOW", "MEDIUM", "HIGH",]


# --- restJson1 ser/de ---
_VALUES: frozenset[str] = frozenset(("NONE", "LOW", "MEDIUM", "HIGH",))
...
def deserialize_json(data: str) -> GuardrailContentFilterConfidence:
    if data not in _VALUES:
        raise DeserializationError(f"unknown GuardrailContentFilterConfidence value: {data!r}")
