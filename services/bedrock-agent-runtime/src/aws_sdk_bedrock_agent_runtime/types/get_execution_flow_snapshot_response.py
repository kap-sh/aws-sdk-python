...
class GetExecutionFlowSnapshotResponse(TypedDict):
    ...
    customer_encryption_key_arn: NotRequired["aws_sdk_bedrock_agent_runtime.types.kms_key_arn.KmsKeyArn"]
...
def deserialize_json(data: dict) -> GetExecutionFlowSnapshotResponse:
    ...
    if "flowIdentifier" in data:
        ...
        raise DeserializationError("GetExecutionFlowSnapshotResponse.flow_identifier required")
    if "flowAliasIdentifier" in data:
        out["flow_alias_identifier"] = data["flowAliasIdentifier"]
    else:
        raise DeserializationError("GetExecutionFlowSnapshotResponse.flow_alias_identifier required")
    if "flowVersion" in data:
        out["flow_version"] = data["flowVersion"]
    else:
        raise DeserializationError("GetExecutionFlowSnapshotResponse.flow_version required")
    if "executionRoleArn" in data:
        out["execution_role_arn"] = data["executionRoleArn"]
    else:
        raise DeserializationError("GetExecutionFlowSnapshotResponse.execution_role_arn required")
    if "definition" in data:
        out["definition"] = data["definition"]
    else:
        raise DeserializationError("GetExecutionFlowSnapshotResponse.definition required")
