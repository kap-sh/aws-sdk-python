...
class GuardrailWordPolicyAssessment(TypedDict, closed=True):
    custom_words: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.guardrail_custom_word_list.GuardrailCustomWordList"
    ]
    """<p>The custom word details for words defined in the Guardrail filter.</p>"""
    managed_word_lists: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.guardrail_managed_word_list.GuardrailManagedWordList"
    ]
...
def serialize_json(value: GuardrailWordPolicyAssessment) -> dict:
    ...
    if "custom_words" in value:
        ...
        out["customWords"] = (
            aws_sdk_bedrock_agent_runtime.types.guardrail_custom_word_list.serialize_json(
                value["custom_words"]
            )
        )
    if "managed_word_lists" in value:
        ...
        out["managedWordLists"] = (
            aws_sdk_bedrock_agent_runtime.types.guardrail_managed_word_list.serialize_json(
...
def deserialize_json(data: dict) -> GuardrailWordPolicyAssessment:
    ...
    if "customWords" in data:
        ...
        out["custom_words"] = (
            aws_sdk_bedrock_agent_runtime.types.guardrail_custom_word_list.deserialize_json(
                data["customWords"]
            )
        )
    if "managedWordLists" in data:
        ...
        out["managed_word_lists"] = (
            aws_sdk_bedrock_agent_runtime.types.guardrail_managed_word_list.deserialize_json(
