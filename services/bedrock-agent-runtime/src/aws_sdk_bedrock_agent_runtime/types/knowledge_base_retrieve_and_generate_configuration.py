...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agent_runtime.types.generation_configuration
    ...
    import aws_sdk_bedrock_agent_runtime.types.orchestration_configuration


class KnowledgeBaseRetrieveAndGenerateConfiguration(TypedDict):
    knowledge_base_id: (
    ...
    generation_configuration: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.generation_configuration.GenerationConfiguration"
    ]
    ...
    orchestration_configuration: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.orchestration_configuration.OrchestrationConfiguration"
    ]
...
def serialize_json(value: KnowledgeBaseRetrieveAndGenerateConfiguration) -> dict:
    ...
    if "generation_configuration" in value:
        ...
        out["generationConfiguration"] = (
            aws_sdk_bedrock_agent_runtime.types.generation_configuration.serialize_json(
    ...
    if "orchestration_configuration" in value:
        ...
        out["orchestrationConfiguration"] = (
            aws_sdk_bedrock_agent_runtime.types.orchestration_configuration.serialize_json(
...
def deserialize_json(data: dict) -> KnowledgeBaseRetrieveAndGenerateConfiguration:
    ...
    if "generationConfiguration" in data:
        ...
        out["generation_configuration"] = (
            aws_sdk_bedrock_agent_runtime.types.generation_configuration.deserialize_json(
    ...
    if "orchestrationConfiguration" in data:
        ...
        out["orchestration_configuration"] = (
            aws_sdk_bedrock_agent_runtime.types.orchestration_configuration.deserialize_json(
