...
class GetInvocationStepResponse(TypedDict):
    invocation_step: "aws_sdk_bedrock_agent_runtime.types.invocation_step.InvocationStep"
...
def serialize_json(value: GetInvocationStepResponse) -> dict:
    out: dict = {}
    import aws_sdk_bedrock_agent_runtime.types.invocation_step
    out["invocationStep"] = aws_sdk_bedrock_agent_runtime.types.invocation_step.serialize_json(value["invocation_step"])
    return out
...
def deserialize_json(data: dict) -> GetInvocationStepResponse:
    ...
    if "invocationStep" in data:
        import aws_sdk_bedrock_agent_runtime.types.invocation_step
        out["invocation_step"] = aws_sdk_bedrock_agent_runtime.types.invocation_step.deserialize_json(data["invocationStep"])
    else:
