...
def serialize_json(value: FlowOutputEvent) -> dict:
    ...
    import aws_sdk_bedrock_agent_runtime.types.flow_output_content
    out["content"] = aws_sdk_bedrock_agent_runtime.types.flow_output_content.serialize_json(value["content"])
    return out
...
def deserialize_json(data: dict) -> FlowOutputEvent:
    ...
    if "content" in data:
        import aws_sdk_bedrock_agent_runtime.types.flow_output_content
        out["content"] = aws_sdk_bedrock_agent_runtime.types.flow_output_content.deserialize_json(data["content"])
    else:
