...
class GuardrailPiiEntityFilter(TypedDict):
    type: NotRequired["aws_sdk_bedrock_agent_runtime.types.guardrail_pii_entity_type.GuardrailPiiEntityType"]
...
def serialize_json(value: GuardrailPiiEntityFilter) -> dict:
    ...
    if "type" in value:
        import aws_sdk_bedrock_agent_runtime.types.guardrail_pii_entity_type
        out["type"] = aws_sdk_bedrock_agent_runtime.types.guardrail_pii_entity_type.serialize_json(value["type"])
    if "match" in value:
...
def deserialize_json(data: dict) -> GuardrailPiiEntityFilter:
    ...
    if "type" in data:
        import aws_sdk_bedrock_agent_runtime.types.guardrail_pii_entity_type
        out["type"] = aws_sdk_bedrock_agent_runtime.types.guardrail_pii_entity_type.deserialize_json(data["type"])
    if "match" in data:
