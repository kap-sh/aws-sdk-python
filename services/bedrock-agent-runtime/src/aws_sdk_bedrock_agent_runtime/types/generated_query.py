...
class GeneratedQuery(TypedDict):
    type: NotRequired["aws_sdk_bedrock_agent_runtime.types.generated_query_type.GeneratedQueryType"]
...
def serialize_json(value: GeneratedQuery) -> dict:
    ...
    if "type" in value:
        import aws_sdk_bedrock_agent_runtime.types.generated_query_type
        out["type"] = aws_sdk_bedrock_agent_runtime.types.generated_query_type.serialize_json(value["type"])
    if "sql" in value:
        out["sql"] = value["sql"]
    return out
...
def deserialize_json(data: dict) -> GeneratedQuery:
    ...
    if "type" in data:
        import aws_sdk_bedrock_agent_runtime.types.generated_query_type
        out["type"] = aws_sdk_bedrock_agent_runtime.types.generated_query_type.deserialize_json(data["type"])
    if "sql" in data:
        out["sql"] = data["sql"]
    return out