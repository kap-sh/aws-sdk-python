...
class ExternalSourcesRetrieveAndGenerateConfiguration(TypedDict, closed=True):
    ...
    generation_configuration: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.external_sources_generation_configuration.ExternalSourcesGenerationConfiguration"
    ]
...
def serialize_json(value: ExternalSourcesRetrieveAndGenerateConfiguration) -> dict:
    ...
    out["sources"] = (
        aws_sdk_bedrock_agent_runtime.types.external_sources.serialize_json(
            value["sources"]
        )
    )
    if "generation_configuration" in value:
        ...
        out["generationConfiguration"] = (
            aws_sdk_bedrock_agent_runtime.types.external_sources_generation_configuration.serialize_json(
...
def deserialize_json(data: dict) -> ExternalSourcesRetrieveAndGenerateConfiguration:
    ...
    if "sources" in data:
        ...
        out["sources"] = (
            aws_sdk_bedrock_agent_runtime.types.external_sources.deserialize_json(
                data["sources"]
            )
        )
    else:
    ...
    if "generationConfiguration" in data:
        ...
        out["generation_configuration"] = (
            aws_sdk_bedrock_agent_runtime.types.external_sources_generation_configuration.deserialize_json(
