"""Generated from Smithy shape ``com.amazonaws.bedrockagentruntime#S3Identifier``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent_runtime.types.s3_bucket_name
    import aws_sdk_bedrock_agent_runtime.types.s3_object_key


class S3Identifier(TypedDict, closed=True):
    s3_bucket_name: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.s3_bucket_name.S3BucketName"
    ]
    """<p> The name of the S3 bucket. </p>"""
    s3_object_key: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.s3_object_key.S3ObjectKey"
    ]
