...
AgentTraces: TypeAlias = list["aws_sdk_bedrock_agent_runtime.types.trace_part.TracePart"]
...
def deserialize_json(data: list) -> AgentTraces:
    ...
    out: AgentTraces = []
    for item in data:
        out.append(aws_sdk_bedrock_agent_runtime.types.trace_part.deserialize_json(item))
    return out