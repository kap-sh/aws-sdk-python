...
def serialize_json(value: ConversationHistory) -> dict:
    ...
    if "messages" in value:
        import aws_sdk_bedrock_agent_runtime.types.messages
        out["messages"] = aws_sdk_bedrock_agent_runtime.types.messages.serialize_json(value["messages"])
    return out
...
def deserialize_json(data: dict) -> ConversationHistory:
    ...
    if "messages" in data:
        import aws_sdk_bedrock_agent_runtime.types.messages
        out["messages"] = aws_sdk_bedrock_agent_runtime.types.messages.deserialize_json(data["messages"])
    return out