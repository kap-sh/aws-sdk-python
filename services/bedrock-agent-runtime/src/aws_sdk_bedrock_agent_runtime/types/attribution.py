...
def serialize_json(value: Attribution) -> dict:
    ...
    if "citations" in value:
        import aws_sdk_bedrock_agent_runtime.types.citations
        out["citations"] = aws_sdk_bedrock_agent_runtime.types.citations.serialize_json(value["citations"])
    return out
...
def deserialize_json(data: dict) -> Attribution:
    ...
    if "citations" in data:
        import aws_sdk_bedrock_agent_runtime.types.citations
        out["citations"] = aws_sdk_bedrock_agent_runtime.types.citations.deserialize_json(data["citations"])
    return out