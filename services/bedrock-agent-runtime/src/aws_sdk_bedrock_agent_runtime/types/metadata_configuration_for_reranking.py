...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent_runtime.types.reranking_metadata_selection_mode
...
class MetadataConfigurationForReranking(TypedDict, closed=True):
    ...
    selective_mode_configuration: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.reranking_metadata_selective_mode_configuration.RerankingMetadataSelectiveModeConfiguration"
    ]
...
def serialize_json(value: MetadataConfigurationForReranking) -> dict:
    ...
    out["selectionMode"] = (
        aws_sdk_bedrock_agent_runtime.types.reranking_metadata_selection_mode.serialize_json(
    ...
    if "selective_mode_configuration" in value:
        ...
        out["selectiveModeConfiguration"] = (
            aws_sdk_bedrock_agent_runtime.types.reranking_metadata_selective_mode_configuration.serialize_json(
...
def deserialize_json(data: dict) -> MetadataConfigurationForReranking:
    ...
    if "selectionMode" in data:
        ...
        out["selection_mode"] = (
            aws_sdk_bedrock_agent_runtime.types.reranking_metadata_selection_mode.deserialize_json(
                data["selectionMode"]
            )
        )
    else:
    ...
    if "selectiveModeConfiguration" in data:
        ...
        out["selective_mode_configuration"] = (
            aws_sdk_bedrock_agent_runtime.types.reranking_metadata_selective_mode_configuration.deserialize_json(
