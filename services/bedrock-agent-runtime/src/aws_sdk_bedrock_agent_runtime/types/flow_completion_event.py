...
def serialize_json(value: FlowCompletionEvent) -> dict:
    out: dict = {}
    import aws_sdk_bedrock_agent_runtime.types.flow_completion_reason
    out["completionReason"] = aws_sdk_bedrock_agent_runtime.types.flow_completion_reason.serialize_json(value["completion_reason"])
    return out
...
def deserialize_json(data: dict) -> FlowCompletionEvent:
    ...
    if "completionReason" in data:
        import aws_sdk_bedrock_agent_runtime.types.flow_completion_reason
        out["completion_reason"] = aws_sdk_bedrock_agent_runtime.types.flow_completion_reason.deserialize_json(data["completionReason"])
    else:
