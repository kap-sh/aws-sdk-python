...
class GetInvocationStepRequest(TypedDict):
    invocation_identifier: "aws_sdk_bedrock_agent_runtime.types.invocation_identifier.InvocationIdentifier"
...
def deserialize_json(data: dict) -> GetInvocationStepRequest:
    ...
    if "invocationIdentifier" in data:
        ...
        raise DeserializationError("GetInvocationStepRequest.invocation_identifier required")
    return out