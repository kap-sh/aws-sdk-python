...
class GenerationConfiguration(TypedDict):
    prompt_template: NotRequired["aws_sdk_bedrock_agent_runtime.types.prompt_template.PromptTemplate"]
    ...
    guardrail_configuration: NotRequired["aws_sdk_bedrock_agent_runtime.types.guardrail_configuration.GuardrailConfiguration"]
    """<p>The configuration details for the guardrail.</p>"""
    inference_config: NotRequired["aws_sdk_bedrock_agent_runtime.types.inference_config.InferenceConfig"]
    ...
    additional_model_request_fields: NotRequired["aws_sdk_bedrock_agent_runtime.types.additional_model_request_fields.AdditionalModelRequestFields"]
...
def serialize_json(value: GenerationConfiguration) -> dict:
    ...
    if "prompt_template" in value:
        import aws_sdk_bedrock_agent_runtime.types.prompt_template
        out["promptTemplate"] = aws_sdk_bedrock_agent_runtime.types.prompt_template.serialize_json(value["prompt_template"])
    if "guardrail_configuration" in value:
        import aws_sdk_bedrock_agent_runtime.types.guardrail_configuration
        out["guardrailConfiguration"] = aws_sdk_bedrock_agent_runtime.types.guardrail_configuration.serialize_json(value["guardrail_configuration"])
    if "inference_config" in value:
        import aws_sdk_bedrock_agent_runtime.types.inference_config
        out["inferenceConfig"] = aws_sdk_bedrock_agent_runtime.types.inference_config.serialize_json(value["inference_config"])
    if "additional_model_request_fields" in value:
        import aws_sdk_bedrock_agent_runtime.types.additional_model_request_fields
        out["additionalModelRequestFields"] = aws_sdk_bedrock_agent_runtime.types.additional_model_request_fields.serialize_json(value["additional_model_request_fields"])
...
def deserialize_json(data: dict) -> GenerationConfiguration:
    ...
    if "promptTemplate" in data:
        import aws_sdk_bedrock_agent_runtime.types.prompt_template
        out["prompt_template"] = aws_sdk_bedrock_agent_runtime.types.prompt_template.deserialize_json(data["promptTemplate"])
    if "guardrailConfiguration" in data:
        import aws_sdk_bedrock_agent_runtime.types.guardrail_configuration
        out["guardrail_configuration"] = aws_sdk_bedrock_agent_runtime.types.guardrail_configuration.deserialize_json(data["guardrailConfiguration"])
    if "inferenceConfig" in data:
        import aws_sdk_bedrock_agent_runtime.types.inference_config
        out["inference_config"] = aws_sdk_bedrock_agent_runtime.types.inference_config.deserialize_json(data["inferenceConfig"])
    if "additionalModelRequestFields" in data:
        import aws_sdk_bedrock_agent_runtime.types.additional_model_request_fields
        out["additional_model_request_fields"] = aws_sdk_bedrock_agent_runtime.types.additional_model_request_fields.deserialize_json(data["additionalModelRequestFields"])
