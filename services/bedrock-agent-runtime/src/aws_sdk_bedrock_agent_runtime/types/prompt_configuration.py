...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agent_runtime.types.base_prompt_template
    ...
    import aws_sdk_bedrock_agent_runtime.types.prompt_state
    import aws_sdk_bedrock_agent_runtime.types.prompt_type


class PromptConfiguration(TypedDict):
    prompt_type: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.prompt_type.PromptType"
    ]
    ...
    prompt_state: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.prompt_state.PromptState"
    ]
    ...
    base_prompt_template: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.base_prompt_template.BasePromptTemplate"
    ]
...
def serialize_json(value: PromptConfiguration) -> dict:
    ...
    if "prompt_type" in value:
        ...
        out["promptType"] = (
            aws_sdk_bedrock_agent_runtime.types.prompt_type.serialize_json(
                value["prompt_type"]
            )
        )
    ...
    if "prompt_state" in value:
        ...
        out["promptState"] = (
            aws_sdk_bedrock_agent_runtime.types.prompt_state.serialize_json(
                value["prompt_state"]
            )
        )
...
def deserialize_json(data: dict) -> PromptConfiguration:
    ...
    if "promptType" in data:
        ...
        out["prompt_type"] = (
            aws_sdk_bedrock_agent_runtime.types.prompt_type.deserialize_json(
                data["promptType"]
            )
        )
    ...
    if "promptState" in data:
        ...
        out["prompt_state"] = (
            aws_sdk_bedrock_agent_runtime.types.prompt_state.deserialize_json(
                data["promptState"]
            )
        )
