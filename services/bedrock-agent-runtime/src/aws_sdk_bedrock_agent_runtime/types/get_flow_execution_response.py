...
class GetFlowExecutionResponse(TypedDict, closed=True):
    ...
    errors: NotRequired[
        "aws_sdk_bedrock_agent_runtime.types.flow_execution_errors.FlowExecutionErrors"
    ]
...
def serialize_json(value: GetFlowExecutionResponse) -> dict:
    ...
    if "errors" in value:
        ...
        out["errors"] = (
            aws_sdk_bedrock_agent_runtime.types.flow_execution_errors.serialize_json(
                value["errors"]
            )
        )
...
def deserialize_json(data: dict) -> GetFlowExecutionResponse:
    ...
    if "errors" in data:
        ...
        out["errors"] = (
            aws_sdk_bedrock_agent_runtime.types.flow_execution_errors.deserialize_json(
                data["errors"]
            )
        )
