...
class ApiRequestBody(TypedDict):
    content: NotRequired["aws_sdk_bedrock_agent_runtime.types.api_content_map.ApiContentMap"]
...
def serialize_json(value: ApiRequestBody) -> dict:
    ...
    if "content" in value:
        import aws_sdk_bedrock_agent_runtime.types.api_content_map
        out["content"] = aws_sdk_bedrock_agent_runtime.types.api_content_map.serialize_json(value["content"])
    return out
...
def deserialize_json(data: dict) -> ApiRequestBody:
    ...
    if "content" in data:
        import aws_sdk_bedrock_agent_runtime.types.api_content_map
        out["content"] = aws_sdk_bedrock_agent_runtime.types.api_content_map.deserialize_json(data["content"])
    return out