...
def serialize_json(value: FlowTraceNodeOutputEvent) -> dict:
    ...
    import aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_fields
    out["fields"] = aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_fields.serialize_json(value["fields"])
    return out
...
def deserialize_json(data: dict) -> FlowTraceNodeOutputEvent:
    ...
    if "fields" in data:
        import aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_fields
        out["fields"] = aws_sdk_bedrock_agent_runtime.types.flow_trace_node_output_fields.deserialize_json(data["fields"])
    else:
