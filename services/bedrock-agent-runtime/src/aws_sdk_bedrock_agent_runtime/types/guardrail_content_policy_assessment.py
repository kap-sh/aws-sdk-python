...
class GuardrailContentPolicyAssessment(TypedDict):
    filters: NotRequired["aws_sdk_bedrock_agent_runtime.types.guardrail_content_filter_list.GuardrailContentFilterList"]
...
def serialize_json(value: GuardrailContentPolicyAssessment) -> dict:
    ...
    if "filters" in value:
        import aws_sdk_bedrock_agent_runtime.types.guardrail_content_filter_list
        out["filters"] = aws_sdk_bedrock_agent_runtime.types.guardrail_content_filter_list.serialize_json(value["filters"])
    return out
...
def deserialize_json(data: dict) -> GuardrailContentPolicyAssessment:
    ...
    if "filters" in data:
        import aws_sdk_bedrock_agent_runtime.types.guardrail_content_filter_list
        out["filters"] = aws_sdk_bedrock_agent_runtime.types.guardrail_content_filter_list.deserialize_json(data["filters"])
    return out