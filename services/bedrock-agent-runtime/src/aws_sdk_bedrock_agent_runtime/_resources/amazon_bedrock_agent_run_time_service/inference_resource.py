    ...
    def invoke_agent(
        ...
        *,
        ...
        bedrock_model_configurations: Optional[
            "aws_sdk_bedrock_agent_runtime.types.bedrock_model_configurations.BedrockModelConfigurations"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent_runtime.types.invoke_agent_request.InvokeAgentRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agent_runtime.types.invoke_agent_response.InvokeAgentResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.invoke_agent.invoke_agent(
...
class AsyncInferenceResource:
    ...
    async def invoke_agent(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent_runtime.types.invoke_agent_request.InvokeAgentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent_runtime.types.invoke_agent_response.InvokeAgentResponse"
        ]:
            import aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.invoke_agent
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.invoke_agent.async_invoke_agent(
                req.options, req.input
            )
