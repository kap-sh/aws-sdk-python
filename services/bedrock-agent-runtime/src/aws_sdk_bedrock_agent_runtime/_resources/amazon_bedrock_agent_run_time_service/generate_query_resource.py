...
class GenerateQueryResource:
    ...
    def generate_query(self, query_generation_input: "aws_sdk_bedrock_agent_runtime.types.query_generation_input.QueryGenerationInput", transformation_configuration: "aws_sdk_bedrock_agent_runtime.types.transformation_configuration.TransformationConfiguration", *, config_overrides: Optional[BedrockAgentRuntimeClientConfig] = None) -> "aws_sdk_bedrock_agent_runtime.types.generate_query_response.GenerateQueryResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agent_runtime.types.generate_query_request.GenerateQueryRequest]') -> OperationResponse["aws_sdk_bedrock_agent_runtime.types.generate_query_response.GenerateQueryResponse"]:
            import aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.generate_query
            output, http_response = aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.generate_query.generate_query(req.options, req.input)
...
class AsyncGenerateQueryResource:
    def __init__(self, service: AsyncBedrockAgentRuntimeClient) -> None:
        self._service = service
    async def generate_query(self, query_generation_input: "aws_sdk_bedrock_agent_runtime.types.query_generation_input.QueryGenerationInput", transformation_configuration: "aws_sdk_bedrock_agent_runtime.types.transformation_configuration.TransformationConfiguration", *, config_overrides: Optional[AsyncBedrockAgentRuntimeClientConfig] = None) -> "aws_sdk_bedrock_agent_runtime.types.generate_query_response.GenerateQueryResponse":
        """<p>Generates an SQL query from a natural language query. For more information, see <a href=\"https://docs.aws.amazon.com/bedrock/latest/userguide/knowledge-base-generate-query.html\">Generate a query for structured data</a> in the Amazon Bedrock User Guide.</p>
        ...
        Args:
            ...
            transformation_configuration: <p>Specifies configurations for transforming the natural language query into SQL.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agent_runtime.types.generate_query_request.GenerateQueryRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agent_runtime.types.generate_query_response.GenerateQueryResponse"]:
            import aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.generate_query
            output, http_response = await aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.generate_query.async_generate_query(req.options, req.input)
