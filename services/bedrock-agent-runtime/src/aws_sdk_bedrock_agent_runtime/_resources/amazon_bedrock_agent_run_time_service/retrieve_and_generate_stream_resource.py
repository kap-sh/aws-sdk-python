...
class RetrieveAndGenerateStreamResource:
    ...
    def retrieve_and_generate_stream(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_stream_request.RetrieveAndGenerateStreamRequest]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.retrieve_and_generate_stream.retrieve_and_generate_stream(
...
class AsyncRetrieveAndGenerateStreamResource:
    ...
    async def retrieve_and_generate_stream(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_stream_request.RetrieveAndGenerateStreamRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_stream_response.RetrieveAndGenerateStreamResponse"
        ]:
            import aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.retrieve_and_generate_stream
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.retrieve_and_generate_stream.async_retrieve_and_generate_stream(
                req.options, req.input
            )
