...
class OptimizePromptResource:
    ...
    def optimize_prompt(self, input: "aws_sdk_bedrock_agent_runtime.types.input_prompt.InputPrompt", target_model_id: str, *, config_overrides: Optional[BedrockAgentRuntimeClientConfig] = None) -> "aws_sdk_bedrock_agent_runtime.types.optimize_prompt_response.OptimizePromptResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agent_runtime.types.optimize_prompt_request.OptimizePromptRequest]') -> OperationResponse["aws_sdk_bedrock_agent_runtime.types.optimize_prompt_response.OptimizePromptResponse"]:
            import aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.optimize_prompt
            output, http_response = aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.optimize_prompt.optimize_prompt(req.options, req.input)
...
class AsyncOptimizePromptResource:
    def __init__(self, service: AsyncBedrockAgentRuntimeClient) -> None:
        self._service = service
    async def optimize_prompt(self, input: "aws_sdk_bedrock_agent_runtime.types.input_prompt.InputPrompt", target_model_id: str, *, config_overrides: Optional[AsyncBedrockAgentRuntimeClientConfig] = None) -> "aws_sdk_bedrock_agent_runtime.types.optimize_prompt_response.OptimizePromptResponse":
        """<p>Optimizes a prompt for the task that you specify. For more information, see <a href=\"https://docs.aws.amazon.com/bedrock/latest/userguide/prompt-management-optimize.html\">Optimize a prompt</a> in the <a href=\"https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html\">Amazon Bedrock User Guide</a>.</p>
        ...
        Args:
            ...
            target_model_id: <p>The unique identifier of the model that you want to optimize the prompt for.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agent_runtime.types.optimize_prompt_request.OptimizePromptRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agent_runtime.types.optimize_prompt_response.OptimizePromptResponse"]:
            import aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.optimize_prompt
            output, http_response = await aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.optimize_prompt.async_optimize_prompt(req.options, req.input)
