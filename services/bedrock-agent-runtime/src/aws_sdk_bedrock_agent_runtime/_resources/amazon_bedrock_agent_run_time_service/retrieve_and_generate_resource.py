...
class RetrieveAndGenerateResource:
    ...
    def retrieve_and_generate(self, input: "aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_input.RetrieveAndGenerateInput", *, config_overrides: Optional[BedrockAgentRuntimeClientConfig] = None, session_id: Optional["aws_sdk_bedrock_agent_runtime.types.session_id.SessionId"] = None, retrieve_and_generate_configuration: Optional["aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_configuration.RetrieveAndGenerateConfiguration"] = None, session_configuration: Optional["aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_session_configuration.RetrieveAndGenerateSessionConfiguration"] = None) -> "aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_response.RetrieveAndGenerateResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_request.RetrieveAndGenerateRequest]') -> OperationResponse["aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_response.RetrieveAndGenerateResponse"]:
            import aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.retrieve_and_generate
            output, http_response = aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.retrieve_and_generate.retrieve_and_generate(req.options, req.input)
            return OperationResponse(output=output, response=http_response)

        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_request.RetrieveAndGenerateRequest = {}  # type: ignore[typeddict-item]
...
class AsyncRetrieveAndGenerateResource:
    ...
    async def retrieve_and_generate(self, input: "aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_input.RetrieveAndGenerateInput", *, config_overrides: Optional[AsyncBedrockAgentRuntimeClientConfig] = None, session_id: Optional["aws_sdk_bedrock_agent_runtime.types.session_id.SessionId"] = None, retrieve_and_generate_configuration: Optional["aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_configuration.RetrieveAndGenerateConfiguration"] = None, session_configuration: Optional["aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_session_configuration.RetrieveAndGenerateSessionConfiguration"] = None) -> "aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_response.RetrieveAndGenerateResponse":
        ...
        Args:
            ...
            session_configuration: <p>Contains details about the session with the knowledge base.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_request.RetrieveAndGenerateRequest]') -> AsyncOperationResponse["aws_sdk_bedrock_agent_runtime.types.retrieve_and_generate_response.RetrieveAndGenerateResponse"]:
            import aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.retrieve_and_generate
            output, http_response = await aws_sdk_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.retrieve_and_generate.async_retrieve_and_generate(req.options, req.input)
