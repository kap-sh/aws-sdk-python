...
class GlacierError(Exception):
    """Base class for all Glacier service errors."""


class ServiceError(GlacierError):
...
class SerializationError(GlacierError):
    """Raised when a value cannot be serialized."""


class DeserializationError(GlacierError):
...
class WaiterFailedError(GlacierError):
...
class WaiterTimeoutError(GlacierError):
