"""Generated from Smithy shape ``com.amazonaws.glacier#MissingParameterValueException``."""
...
class MissingParameterValueException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.glacier#MissingParameterValueException``."""
