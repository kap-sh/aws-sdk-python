...
def handle_response(
    ...
    out: capo_glacier.types.describe_vault_output.DescribeVaultOutput = (
        capo_glacier.types.describe_vault_output.deserialize_json(
...
def describe_vault(
    ...
    capo_glacier.types.describe_vault_output.DescribeVaultOutput, zapros.Response
]:
