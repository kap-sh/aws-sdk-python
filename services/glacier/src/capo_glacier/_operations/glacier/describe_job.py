"""Generated from Smithy shape ``com.amazonaws.glacier#DescribeJob``."""
...
def handle_response(
    ...
    out: capo_glacier.types.glacier_job_description.GlacierJobDescription = (
        capo_glacier.types.glacier_job_description.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/{accountId}/vaults/{vaultName}/jobs/{jobId}"
...
def describe_job(
    ...
    capo_glacier.types.glacier_job_description.GlacierJobDescription, zapros.Response
]:
