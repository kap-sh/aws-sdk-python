"""Generated from Smithy shape ``com.amazonaws.glacier#GetVaultNotifications``."""
...
def handle_response(
    ...
    out: capo_glacier.types.get_vault_notifications_output.GetVaultNotificationsOutput = {
        "vault_notification_config": capo_glacier.types.vault_notification_config.deserialize_json(
...
async def async_get_vault_notifications(
