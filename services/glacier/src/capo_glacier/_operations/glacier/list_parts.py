"""Generated from Smithy shape ``com.amazonaws.glacier#ListParts``."""
...
def handle_response(
    ...
    out: capo_glacier.types.list_parts_output.ListPartsOutput = (
        capo_glacier.types.list_parts_output.deserialize_json(
...
def list_parts(
    ...
    input_: capo_glacier.types.list_parts_input.ListPartsInput,
) -> tuple[capo_glacier.types.list_parts_output.ListPartsOutput, zapros.Response]:
