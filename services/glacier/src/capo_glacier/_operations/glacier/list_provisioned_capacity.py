"""Generated from Smithy shape ``com.amazonaws.glacier#ListProvisionedCapacity``."""
...
def handle_response(
    ...
    out: capo_glacier.types.list_provisioned_capacity_output.ListProvisionedCapacityOutput = capo_glacier.types.list_provisioned_capacity_output.deserialize_json(
...
async def async_list_provisioned_capacity(
