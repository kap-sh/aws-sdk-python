...
def handle_response(
    ...
    out: capo_glacier.types.list_vaults_output.ListVaultsOutput = (
        capo_glacier.types.list_vaults_output.deserialize_json(
...
def list_vaults(
    ...
    input_: capo_glacier.types.list_vaults_input.ListVaultsInput,
) -> tuple[capo_glacier.types.list_vaults_output.ListVaultsOutput, zapros.Response]:
