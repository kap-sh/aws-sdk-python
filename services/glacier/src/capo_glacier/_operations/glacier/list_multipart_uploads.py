"""Generated from Smithy shape ``com.amazonaws.glacier#ListMultipartUploads``."""
...
def handle_response(
    ...
    out: capo_glacier.types.list_multipart_uploads_output.ListMultipartUploadsOutput = (
        capo_glacier.types.list_multipart_uploads_output.deserialize_json(
