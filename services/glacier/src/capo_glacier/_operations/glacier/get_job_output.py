"""Generated from Smithy shape ``com.amazonaws.glacier#GetJobOutput``."""
...
def handle_response(
    ...
    out: capo_glacier.types.get_job_output_output.GetJobOutputOutput = {"body": _iter}  # type: ignore[reportAssignmentType]
...
def get_job_output(
    ...
    capo_glacier.types.get_job_output_output.GetJobOutputOutput, zapros.Response
]:
