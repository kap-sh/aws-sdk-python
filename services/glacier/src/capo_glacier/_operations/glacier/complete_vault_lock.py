"""Generated from Smithy shape ``com.amazonaws.glacier#CompleteVaultLock``."""
...
def build_request(
    ...
    url = url.replace("{lockId}", quote(str(input_["lock_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_complete_vault_lock(
