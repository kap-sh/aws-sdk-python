...
class Encryption(TypedDict, closed=True):
    encryption_type: NotRequired["capo_glacier.types.encryption_type.EncryptionType"]
    ...
    kms_key_id: NotRequired["capo_glacier.types.string.string"]
    ...
    kms_context: NotRequired["capo_glacier.types.string.string"]
...
def serialize_json(value: Encryption) -> dict:
    ...
    if "encryption_type" in value:
        ...
        out["EncryptionType"] = capo_glacier.types.encryption_type.serialize_json(
