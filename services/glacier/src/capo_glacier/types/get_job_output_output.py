...
if TYPE_CHECKING:
    import capo_glacier.types.httpstatus
...
class GetJobOutputOutput(TypedDict, closed=True):
    ...
    accept_ranges: NotRequired["capo_glacier.types.string.string"]
    ...
    content_type: NotRequired["capo_glacier.types.string.string"]
