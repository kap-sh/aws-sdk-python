"""Generated from Smithy shape ``com.amazonaws.glacier#GetJobOutputInput``."""
...
class GetJobOutputInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetJobOutputInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetJobOutputInput:
    out: GetJobOutputInput = {}  # type: ignore[typeddict-item]
    return out
