...
def build_request(
    ...
    input: aws_sdk_glacier.types.set_vault_notifications_input.SetVaultNotificationsInput,
) -> zapros.Request:
    ...
    if "vault_notification_config" in input:
        ...
        body: bytes | None = json.dumps(
            aws_sdk_glacier.types.vault_notification_config.serialize_json(
                input["vault_notification_config"]
            )
        ).encode()
