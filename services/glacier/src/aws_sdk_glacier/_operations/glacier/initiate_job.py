...
def build_request(
    ...
    input: aws_sdk_glacier.types.initiate_job_input.InitiateJobInput,
) -> zapros.Request:
    ...
    if "job_parameters" in input:
        import aws_sdk_glacier.types.job_parameters

        body: bytes | None = json.dumps(
            aws_sdk_glacier.types.job_parameters.serialize_json(input["job_parameters"])
        ).encode()
