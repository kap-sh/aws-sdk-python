"""Generated from Smithy shape ``com.amazonaws.glacier#ListTagsForVault``."""
...
def handle_response(
    ...
    out: aws_sdk_glacier.types.list_tags_for_vault_output.ListTagsForVaultOutput = (
        aws_sdk_glacier.types.list_tags_for_vault_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.list_tags_for_vault_input.ListTagsForVaultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{accountId}/vaults/{vaultName}/tags"
...
async def async_list_tags_for_vault(
