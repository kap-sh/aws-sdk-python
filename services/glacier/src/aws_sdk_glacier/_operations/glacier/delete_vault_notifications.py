"""Generated from Smithy shape ``com.amazonaws.glacier#DeleteVaultNotifications``."""
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.delete_vault_notifications_input.DeleteVaultNotificationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_vault_notifications(
