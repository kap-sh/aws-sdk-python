...
def handle_response(
    ...
    out: aws_sdk_glacier.types.get_data_retrieval_policy_output.GetDataRetrievalPolicyOutput = aws_sdk_glacier.types.get_data_retrieval_policy_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.get_data_retrieval_policy_input.GetDataRetrievalPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
