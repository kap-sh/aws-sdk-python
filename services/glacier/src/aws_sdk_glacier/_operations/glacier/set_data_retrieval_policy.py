"""Generated from Smithy shape ``com.amazonaws.glacier#SetDataRetrievalPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.set_data_retrieval_policy_input.SetDataRetrievalPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{accountId}/policies/data-retrieval"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glacier.types.set_data_retrieval_policy_input.serialize_json(input_)
    ).encode()
...
async def async_set_data_retrieval_policy(
