...
def build_request(
    ...
    input: aws_sdk_glacier.types.set_data_retrieval_policy_input.SetDataRetrievalPolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glacier.types.set_data_retrieval_policy_input.serialize_json(input)
    ).encode()
