...
def handle_response(
    ...
    out: aws_sdk_glacier.types.list_multipart_uploads_output.ListMultipartUploadsOutput = aws_sdk_glacier.types.list_multipart_uploads_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.list_multipart_uploads_input.ListMultipartUploadsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
