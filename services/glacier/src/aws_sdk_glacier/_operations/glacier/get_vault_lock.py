"""Generated from Smithy shape ``com.amazonaws.glacier#GetVaultLock``."""
...
def handle_response(
    ...
    out: aws_sdk_glacier.types.get_vault_lock_output.GetVaultLockOutput = (
        aws_sdk_glacier.types.get_vault_lock_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.get_vault_lock_input.GetVaultLockInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{accountId}/vaults/{vaultName}/lock-policy"
...
def get_vault_lock(
    ...
    aws_sdk_glacier.types.get_vault_lock_output.GetVaultLockOutput, zapros.Response
]:
...
async def async_get_vault_lock(
