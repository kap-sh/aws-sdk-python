...
def handle_response(
    ...
    out: aws_sdk_glacier.types.create_vault_output.CreateVaultOutput = {}  # type: ignore[typeddict-item]
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.create_vault_input.CreateVaultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def create_vault(
    ...
    aws_sdk_glacier.types.create_vault_output.CreateVaultOutput, zapros.Response
]:
