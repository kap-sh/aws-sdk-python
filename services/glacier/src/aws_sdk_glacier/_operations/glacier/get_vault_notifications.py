...
def handle_response(
    ...
    out: aws_sdk_glacier.types.get_vault_notifications_output.GetVaultNotificationsOutput = {
        "vault_notification_config": aws_sdk_glacier.types.vault_notification_config.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.get_vault_notifications_input.GetVaultNotificationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
