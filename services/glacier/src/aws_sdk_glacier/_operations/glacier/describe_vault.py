"""Generated from Smithy shape ``com.amazonaws.glacier#DescribeVault``."""
...
def handle_response(
    ...
    out: aws_sdk_glacier.types.describe_vault_output.DescribeVaultOutput = (
        aws_sdk_glacier.types.describe_vault_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.describe_vault_input.DescribeVaultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_vault(
    ...
    aws_sdk_glacier.types.describe_vault_output.DescribeVaultOutput, zapros.Response
]:
...
async def async_describe_vault(
