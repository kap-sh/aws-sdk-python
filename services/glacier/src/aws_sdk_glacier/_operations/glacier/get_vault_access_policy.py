"""Generated from Smithy shape ``com.amazonaws.glacier#GetVaultAccessPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_glacier.types.get_vault_access_policy_output.GetVaultAccessPolicyOutput = {
        "policy": aws_sdk_glacier.types.vault_access_policy.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.get_vault_access_policy_input.GetVaultAccessPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_vault_access_policy(
