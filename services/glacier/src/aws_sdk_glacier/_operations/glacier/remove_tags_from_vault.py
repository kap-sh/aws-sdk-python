...
def build_request(
    ...
    input: aws_sdk_glacier.types.remove_tags_from_vault_input.RemoveTagsFromVaultInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glacier.types.remove_tags_from_vault_input.serialize_json(input)
    ).encode()
