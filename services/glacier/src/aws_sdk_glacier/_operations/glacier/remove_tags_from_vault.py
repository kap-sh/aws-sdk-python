...
def build_request(
    ...
    input_: aws_sdk_glacier.types.remove_tags_from_vault_input.RemoveTagsFromVaultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_glacier.types.remove_tags_from_vault_input.serialize_json(input_)
    ).encode()
