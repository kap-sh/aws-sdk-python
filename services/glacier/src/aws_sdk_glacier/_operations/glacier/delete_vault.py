"""Generated from Smithy shape ``com.amazonaws.glacier#DeleteVault``."""
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.delete_vault_input.DeleteVaultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
