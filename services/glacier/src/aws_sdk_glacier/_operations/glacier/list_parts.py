...
def handle_response(
    ...
    out: aws_sdk_glacier.types.list_parts_output.ListPartsOutput = (
        aws_sdk_glacier.types.list_parts_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.list_parts_input.ListPartsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_parts(
    ...
    input_: aws_sdk_glacier.types.list_parts_input.ListPartsInput,
) -> tuple[aws_sdk_glacier.types.list_parts_output.ListPartsOutput, zapros.Response]:
