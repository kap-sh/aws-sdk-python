"""Generated from Smithy shape ``com.amazonaws.glacier#DeleteVaultAccessPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.delete_vault_access_policy_input.DeleteVaultAccessPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_vault_access_policy(
