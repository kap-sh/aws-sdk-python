"""Generated from Smithy shape ``com.amazonaws.glacier#DeleteArchive``."""
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.delete_archive_input.DeleteArchiveInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{archiveId}", quote(str(input_["archive_id"]), safe=""))
    params: dict[str, str] = {}
