...
def handle_response(
    ...
    out: aws_sdk_glacier.types.list_jobs_output.ListJobsOutput = (
        aws_sdk_glacier.types.list_jobs_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_glacier.types.list_jobs_input.ListJobsInput,
) -> zapros.Request:
    ...
    if "statuscode" in input:
        params["statuscode"] = str(input["statuscode"])
    if "completed" in input:
        params["completed"] = str(input["completed"])
...
def list_jobs(
    ...
    input: aws_sdk_glacier.types.list_jobs_input.ListJobsInput,
) -> tuple[aws_sdk_glacier.types.list_jobs_output.ListJobsOutput, zapros.Response]:
