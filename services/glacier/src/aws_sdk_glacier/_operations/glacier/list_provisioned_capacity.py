...
def handle_response(
    ...
    out: aws_sdk_glacier.types.list_provisioned_capacity_output.ListProvisionedCapacityOutput = aws_sdk_glacier.types.list_provisioned_capacity_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.list_provisioned_capacity_input.ListProvisionedCapacityInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
