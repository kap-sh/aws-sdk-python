"""Generated from Smithy shape ``com.amazonaws.glacier#ListVaults``."""
...
def handle_response(
    ...
    out: aws_sdk_glacier.types.list_vaults_output.ListVaultsOutput = (
        aws_sdk_glacier.types.list_vaults_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.list_vaults_input.ListVaultsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{accountId}/vaults"
...
def list_vaults(
    ...
    input_: aws_sdk_glacier.types.list_vaults_input.ListVaultsInput,
) -> tuple[aws_sdk_glacier.types.list_vaults_output.ListVaultsOutput, zapros.Response]:
