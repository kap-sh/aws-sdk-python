...
def handle_response(
    ...
    out: aws_sdk_glacier.types.glacier_job_description.GlacierJobDescription = (
        aws_sdk_glacier.types.glacier_job_description.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_glacier.types.describe_job_input.DescribeJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_job(
    ...
    aws_sdk_glacier.types.glacier_job_description.GlacierJobDescription, zapros.Response
]:
