...
class DescribeVaultOutput(TypedDict):
    vault_arn: NotRequired["aws_sdk_glacier.types.string.string"]
    """<p>The Amazon Resource Name (ARN) of the vault.</p>"""
    vault_name: NotRequired["aws_sdk_glacier.types.string.string"]
    ...
    last_inventory_date: NotRequired["aws_sdk_glacier.types.string.string"]
    ...
    number_of_archives: "aws_sdk_glacier.types.long.long"
    ...
    size_in_bytes: "aws_sdk_glacier.types.long.long"
