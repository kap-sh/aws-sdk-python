...
if TYPE_CHECKING:
    ...
    import aws_sdk_glacier.types.part_list
...
class ListPartsOutput(TypedDict, closed=True):
    ...
    parts: NotRequired["aws_sdk_glacier.types.part_list.PartList"]
...
def serialize_json(value: ListPartsOutput) -> dict:
    ...
    if "parts" in value:
        ...
        out["Parts"] = aws_sdk_glacier.types.part_list.serialize_json(value["parts"])
    if "marker" in value:
...
def deserialize_json(data: dict) -> ListPartsOutput:
    ...
    if "Parts" in data:
        ...
        out["parts"] = aws_sdk_glacier.types.part_list.deserialize_json(data["Parts"])
    if "Marker" in data:
