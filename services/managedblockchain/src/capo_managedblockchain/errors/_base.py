...
class ManagedBlockchainError(Exception):
    """Base class for all ManagedBlockchain service errors."""


class ServiceError(ManagedBlockchainError):
...
class SerializationError(ManagedBlockchainError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ManagedBlockchainError):
...
class WaiterFailedError(ManagedBlockchainError):
...
class WaiterTimeoutError(ManagedBlockchainError):
