"""Generated from Smithy shape ``com.amazonaws.managedblockchain#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.managedblockchain#AccessDeniedException``."""
