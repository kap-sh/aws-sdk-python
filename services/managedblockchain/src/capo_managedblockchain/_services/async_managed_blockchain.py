...
from capo_managedblockchain._services._aws_config import aaws_config
...
class AsyncManagedBlockchainClientConfig(TypedDict, total=False, closed=True):
...
class AsyncManagedBlockchainClient:
    ...
    async def create_accessor(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.create_accessor_input.CreateAccessorInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.create_accessor_output.CreateAccessorOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.create_accessor.async_create_accessor(
    ...
    async def create_member(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.create_member_input.CreateMemberInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.create_member_output.CreateMemberOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.create_member.async_create_member(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_network(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.create_network_input.CreateNetworkInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.create_network_output.CreateNetworkOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.create_network.async_create_network(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_node(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.create_node_input.CreateNodeInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.create_node_output.CreateNodeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.create_node.async_create_node(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_proposal(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.create_proposal_input.CreateProposalInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.create_proposal_output.CreateProposalOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.create_proposal.async_create_proposal(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_accessor(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.delete_accessor_input.DeleteAccessorInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.delete_accessor_output.DeleteAccessorOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.delete_accessor.async_delete_accessor(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_member(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.delete_member_input.DeleteMemberInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.delete_member_output.DeleteMemberOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.delete_member.async_delete_member(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_node(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.delete_node_input.DeleteNodeInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.delete_node_output.DeleteNodeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.delete_node.async_delete_node(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_accessor(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.get_accessor_input.GetAccessorInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.get_accessor_output.GetAccessorOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.get_accessor.async_get_accessor(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_member(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.get_member_input.GetMemberInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.get_member_output.GetMemberOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.get_member.async_get_member(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_network(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.get_network_input.GetNetworkInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.get_network_output.GetNetworkOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.get_network.async_get_network(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_node(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.get_node_input.GetNodeInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.get_node_output.GetNodeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.get_node.async_get_node(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_proposal(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.get_proposal_input.GetProposalInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.get_proposal_output.GetProposalOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.get_proposal.async_get_proposal(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_accessors(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.list_accessors_input.ListAccessorsInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.list_accessors_output.ListAccessorsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.list_accessors.async_list_accessors(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_managedblockchain.types.accessor_summary.AccessorSummary]":
        _token = next_token
        while True:
    ...
    async def list_invitations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.list_invitations_input.ListInvitationsInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.list_invitations_output.ListInvitationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.list_invitations.async_list_invitations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_members(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.list_members_input.ListMembersInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.list_members_output.ListMembersOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.list_members.async_list_members(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_networks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.list_networks_input.ListNetworksInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.list_networks_output.ListNetworksOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.list_networks.async_list_networks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_nodes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.list_nodes_input.ListNodesInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.list_nodes_output.ListNodesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.list_nodes.async_list_nodes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_proposals(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.list_proposals_input.ListProposalsInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.list_proposals_output.ListProposalsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.list_proposals.async_list_proposals(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_proposal_votes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.list_proposal_votes_input.ListProposalVotesInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.list_proposal_votes_output.ListProposalVotesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.list_proposal_votes.async_list_proposal_votes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reject_invitation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.reject_invitation_input.RejectInvitationInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.reject_invitation_output.RejectInvitationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.reject_invitation.async_reject_invitation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_member(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.update_member_input.UpdateMemberInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.update_member_output.UpdateMemberOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.update_member.async_update_member(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_node(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.update_node_input.UpdateNodeInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.update_node_output.UpdateNodeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.update_node.async_update_node(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def vote_on_proposal(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_managedblockchain.types.vote_on_proposal_input.VoteOnProposalInput]",
        ) -> AsyncOperationResponse[
            "capo_managedblockchain.types.vote_on_proposal_output.VoteOnProposalOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_managedblockchain._operations.taiga_web_service.vote_on_proposal.async_vote_on_proposal(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
