"""Generated from Smithy shape ``com.amazonaws.managedblockchain#ListProposalsInput``."""
...
class ListProposalsInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListProposalsInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListProposalsInput:
    out: ListProposalsInput = {}  # type: ignore[typeddict-item]
    return out
