"""Generated from Smithy shape ``com.amazonaws.managedblockchain#CreateNetwork``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.create_network_output.CreateNetworkOutput = (
        capo_managedblockchain.types.create_network_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_managedblockchain.types.create_network_input.serialize_json(input_)
    ).encode()
...
async def async_create_network(
