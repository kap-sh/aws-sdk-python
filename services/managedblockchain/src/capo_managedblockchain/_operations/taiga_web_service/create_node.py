"""Generated from Smithy shape ``com.amazonaws.managedblockchain#CreateNode``."""
...
import capo_managedblockchain.errors.resource_already_exists_exception
import capo_managedblockchain.errors.resource_limit_exceeded_exception
import capo_managedblockchain.errors.resource_not_found_exception
import capo_managedblockchain.errors.resource_not_ready_exception
import capo_managedblockchain.errors.throttling_exception
import capo_managedblockchain.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceAlreadyExistsException":
            raise capo_managedblockchain.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_json(
                data
            )
        case "ResourceLimitExceededException":
            raise capo_managedblockchain.errors.resource_limit_exceeded_exception.ResourceLimitExceededException.from_json(
                data
            )
        case "ResourceNotFoundException":
            raise capo_managedblockchain.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
        case "ResourceNotReadyException":
            raise capo_managedblockchain.errors.resource_not_ready_exception.ResourceNotReadyException.from_json(
                data
            )
        ...
        case "TooManyTagsException":
            raise capo_managedblockchain.errors.too_many_tags_exception.TooManyTagsException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_managedblockchain.types.create_node_output.CreateNodeOutput = (
        capo_managedblockchain.types.create_node_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_managedblockchain.types.create_node_input.serialize_json(input_)
    ).encode()
...
def create_node(
    ...
    capo_managedblockchain.types.create_node_output.CreateNodeOutput, zapros.Response
]:
