"""Generated from Smithy shape ``com.amazonaws.managedblockchain#RejectInvitation``."""
...
import capo_managedblockchain.errors.illegal_action_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IllegalActionException":
            raise capo_managedblockchain.errors.illegal_action_exception.IllegalActionException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_managedblockchain.types.reject_invitation_output.RejectInvitationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/invitations/{InvitationId}"
    url = url.replace("{InvitationId}", quote(str(input_["invitation_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_reject_invitation(
