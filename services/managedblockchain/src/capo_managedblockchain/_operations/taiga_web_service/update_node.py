"""Generated from Smithy shape ``com.amazonaws.managedblockchain#UpdateNode``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.update_node_output.UpdateNodeOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/networks/{NetworkId}/nodes/{NodeId}"
    ...
    body: bytes | None = json.dumps(
        capo_managedblockchain.types.update_node_input.serialize_json(input_)
    ).encode()
...
def update_node(
    ...
    capo_managedblockchain.types.update_node_output.UpdateNodeOutput, zapros.Response
]:
