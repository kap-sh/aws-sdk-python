"""Generated from Smithy shape ``com.amazonaws.managedblockchain#DeleteAccessor``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.delete_accessor_output.DeleteAccessorOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_accessor(
