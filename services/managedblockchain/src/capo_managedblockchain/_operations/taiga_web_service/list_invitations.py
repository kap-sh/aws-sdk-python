"""Generated from Smithy shape ``com.amazonaws.managedblockchain#ListInvitations``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.list_invitations_output.ListInvitationsOutput = (
        capo_managedblockchain.types.list_invitations_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/invitations"
    params: dict[str, str] = {}
