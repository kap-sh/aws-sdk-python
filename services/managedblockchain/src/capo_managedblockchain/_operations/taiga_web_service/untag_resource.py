"""Generated from Smithy shape ``com.amazonaws.managedblockchain#UntagResource``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
