"""Generated from Smithy shape ``com.amazonaws.managedblockchain#ListProposals``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.list_proposals_output.ListProposalsOutput = (
        capo_managedblockchain.types.list_proposals_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/networks/{NetworkId}/proposals"
