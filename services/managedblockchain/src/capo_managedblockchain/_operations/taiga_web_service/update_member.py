"""Generated from Smithy shape ``com.amazonaws.managedblockchain#UpdateMember``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.update_member_output.UpdateMemberOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_managedblockchain.types.update_member_input.serialize_json(input_)
    ).encode()
