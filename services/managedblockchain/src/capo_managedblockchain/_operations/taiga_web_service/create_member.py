...
def handle_response(
    ...
    out: capo_managedblockchain.types.create_member_output.CreateMemberOutput = (
        capo_managedblockchain.types.create_member_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_managedblockchain.types.create_member_input.serialize_json(input_)
    ).encode()
