"""Generated from Smithy shape ``com.amazonaws.managedblockchain#ListProposalVotes``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.list_proposal_votes_output.ListProposalVotesOutput = capo_managedblockchain.types.list_proposal_votes_output.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/networks/{NetworkId}/proposals/{ProposalId}/votes"
    )
...
async def async_list_proposal_votes(
