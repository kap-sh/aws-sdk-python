"""Generated from Smithy shape ``com.amazonaws.managedblockchain#GetAccessor``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.get_accessor_output.GetAccessorOutput = (
        capo_managedblockchain.types.get_accessor_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accessors/{AccessorId}"
    url = url.replace("{AccessorId}", quote(str(input_["accessor_id"]), safe=""))
    params: dict[str, str] = {}
...
def get_accessor(
    ...
    capo_managedblockchain.types.get_accessor_output.GetAccessorOutput, zapros.Response
]:
