"""Generated from Smithy shape ``com.amazonaws.managedblockchain#GetProposal``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.get_proposal_output.GetProposalOutput = (
        capo_managedblockchain.types.get_proposal_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/networks/{NetworkId}/proposals/{ProposalId}"
...
def get_proposal(
    ...
    capo_managedblockchain.types.get_proposal_output.GetProposalOutput, zapros.Response
]:
