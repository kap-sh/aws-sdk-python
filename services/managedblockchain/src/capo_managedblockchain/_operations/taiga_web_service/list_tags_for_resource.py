"""Generated from Smithy shape ``com.amazonaws.managedblockchain#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_managedblockchain.types.list_tags_for_resource_response.deserialize_json(
