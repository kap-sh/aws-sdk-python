...
if TYPE_CHECKING:
    ...
    import aws_sdk_managedblockchain.types.member_framework_attributes
...
class Member(TypedDict, closed=True):
    ...
    framework_attributes: NotRequired[
        "aws_sdk_managedblockchain.types.member_framework_attributes.MemberFrameworkAttributes"
    ]
...
def serialize_json(value: Member) -> dict:
    ...
    if "framework_attributes" in value:
        ...
        out["FrameworkAttributes"] = (
            aws_sdk_managedblockchain.types.member_framework_attributes.serialize_json(
...
def deserialize_json(data: dict) -> Member:
    ...
    if "FrameworkAttributes" in data:
        ...
        out["framework_attributes"] = (
            aws_sdk_managedblockchain.types.member_framework_attributes.deserialize_json(
