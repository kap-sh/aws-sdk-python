...
class MemberFabricAttributes(TypedDict):
    admin_username: NotRequired[
        "aws_sdk_managedblockchain.types.username_string.UsernameString"
    ]
    """<p>The user name for the initial administrator user for the member.</p>"""
    ca_endpoint: NotRequired["aws_sdk_managedblockchain.types.string.String"]
