...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.get_network_output.GetNetworkOutput = (
        aws_sdk_managedblockchain.types.get_network_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.get_network_input.GetNetworkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_network(
    ...
    aws_sdk_managedblockchain.types.get_network_output.GetNetworkOutput, zapros.Response
]:
