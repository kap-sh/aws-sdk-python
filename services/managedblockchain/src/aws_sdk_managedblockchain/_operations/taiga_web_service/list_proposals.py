...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.list_proposals_output.ListProposalsOutput = (
        aws_sdk_managedblockchain.types.list_proposals_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.list_proposals_input.ListProposalsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
