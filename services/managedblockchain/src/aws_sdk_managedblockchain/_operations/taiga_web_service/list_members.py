"""Generated from Smithy shape ``com.amazonaws.managedblockchain#ListMembers``."""
...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.list_members_output.ListMembersOutput = (
        aws_sdk_managedblockchain.types.list_members_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.list_members_input.ListMembersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
