...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.get_proposal_output.GetProposalOutput = (
        aws_sdk_managedblockchain.types.get_proposal_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_managedblockchain.types.get_proposal_input.GetProposalInput,
) -> zapros.Request:
    ...
    url = url.replace("{ProposalId}", quote(str(input["proposal_id"]), safe=""))
    params: dict[str, str] = {}
