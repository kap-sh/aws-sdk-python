...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IllegalActionException":
            import aws_sdk_managedblockchain.errors.illegal_action_exception

            raise aws_sdk_managedblockchain.errors.illegal_action_exception.IllegalActionException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.reject_invitation_output.RejectInvitationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.reject_invitation_input.RejectInvitationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
