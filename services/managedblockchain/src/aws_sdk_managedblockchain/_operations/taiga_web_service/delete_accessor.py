...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.delete_accessor_output.DeleteAccessorOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_managedblockchain.types.delete_accessor_input.DeleteAccessorInput,
) -> zapros.Request:
