...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.list_accessors_output.ListAccessorsOutput = (
        aws_sdk_managedblockchain.types.list_accessors_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.list_accessors_input.ListAccessorsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "network_type" in input_:
        params["networkType"] = str(input_["network_type"])
