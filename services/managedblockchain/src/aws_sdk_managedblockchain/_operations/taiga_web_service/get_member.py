...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.get_member_input.GetMemberInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_member(
    ...
    aws_sdk_managedblockchain.types.get_member_output.GetMemberOutput, zapros.Response
]:
