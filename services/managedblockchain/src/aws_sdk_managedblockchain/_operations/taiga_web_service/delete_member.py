"""Generated from Smithy shape ``com.amazonaws.managedblockchain#DeleteMember``."""
...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.delete_member_output.DeleteMemberOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.delete_member_input.DeleteMemberInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
