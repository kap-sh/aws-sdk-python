...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.update_member_output.UpdateMemberOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.update_member_input.UpdateMemberInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_managedblockchain.types.update_member_input.serialize_json(input_)
    ).encode()
