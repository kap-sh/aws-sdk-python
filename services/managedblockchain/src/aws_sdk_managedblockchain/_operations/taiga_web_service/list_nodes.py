...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.list_nodes_output.ListNodesOutput = (
        aws_sdk_managedblockchain.types.list_nodes_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_managedblockchain.types.list_nodes_input.ListNodesInput,
) -> zapros.Request:
    ...
    if "member_id" in input:
        params["memberId"] = str(input["member_id"])
    if "status" in input:
...
def list_nodes(
    ...
    aws_sdk_managedblockchain.types.list_nodes_output.ListNodesOutput, zapros.Response
]:
