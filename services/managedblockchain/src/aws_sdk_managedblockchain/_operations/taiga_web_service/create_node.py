...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.create_node_output.CreateNodeOutput = (
        aws_sdk_managedblockchain.types.create_node_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.create_node_input.CreateNodeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_managedblockchain.types.create_node_input.serialize_json(input_)
    ).encode()
...
def create_node(
    ...
    aws_sdk_managedblockchain.types.create_node_output.CreateNodeOutput, zapros.Response
]:
