...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.delete_node_output.DeleteNodeOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.delete_node_input.DeleteNodeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_node(
    ...
    aws_sdk_managedblockchain.types.delete_node_output.DeleteNodeOutput, zapros.Response
]:
