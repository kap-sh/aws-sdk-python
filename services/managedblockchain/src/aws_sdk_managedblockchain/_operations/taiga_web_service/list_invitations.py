...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.list_invitations_output.ListInvitationsOutput = aws_sdk_managedblockchain.types.list_invitations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.list_invitations_input.ListInvitationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
