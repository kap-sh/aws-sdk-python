...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.get_accessor_output.GetAccessorOutput = (
        aws_sdk_managedblockchain.types.get_accessor_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_managedblockchain.types.get_accessor_input.GetAccessorInput,
) -> zapros.Request:
    ...
    url = url.replace("{AccessorId}", quote(str(input["accessor_id"]), safe=""))
    params: dict[str, str] = {}
