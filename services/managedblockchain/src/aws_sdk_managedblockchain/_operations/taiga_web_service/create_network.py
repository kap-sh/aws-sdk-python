...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.create_network_output.CreateNetworkOutput = (
        aws_sdk_managedblockchain.types.create_network_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.create_network_input.CreateNetworkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_managedblockchain.types.create_network_input.serialize_json(input_)
    ).encode()
