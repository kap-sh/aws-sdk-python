...
def build_request(
    ...
    input: aws_sdk_managedblockchain.types.create_network_input.CreateNetworkInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_managedblockchain.types.create_network_input.serialize_json(input)
    ).encode()
