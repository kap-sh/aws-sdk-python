"""Generated from Smithy shape ``com.amazonaws.managedblockchain#CreateAccessor``."""
...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.create_accessor_output.CreateAccessorOutput = (
        aws_sdk_managedblockchain.types.create_accessor_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_managedblockchain.types.create_accessor_input.CreateAccessorInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_managedblockchain.types.create_accessor_input.serialize_json(input)
    ).encode()
...
async def async_create_accessor(
