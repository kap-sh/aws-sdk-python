...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.get_node_output.GetNodeOutput = (
        aws_sdk_managedblockchain.types.get_node_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.get_node_input.GetNodeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_node(
    ...
    aws_sdk_managedblockchain.types.get_node_output.GetNodeOutput, zapros.Response
]:
