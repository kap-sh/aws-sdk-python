...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.update_node_output.UpdateNodeOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_managedblockchain.types.update_node_input.UpdateNodeInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_managedblockchain.types.update_node_input.serialize_json(input)
    ).encode()
...
def update_node(
    ...
    aws_sdk_managedblockchain.types.update_node_output.UpdateNodeOutput, zapros.Response
]:
