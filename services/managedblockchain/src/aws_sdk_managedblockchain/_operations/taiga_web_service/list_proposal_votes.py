...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.list_proposal_votes_output.ListProposalVotesOutput = aws_sdk_managedblockchain.types.list_proposal_votes_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.list_proposal_votes_input.ListProposalVotesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
