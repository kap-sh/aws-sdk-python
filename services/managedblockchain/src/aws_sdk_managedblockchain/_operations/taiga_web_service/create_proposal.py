...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.create_proposal_output.CreateProposalOutput = (
        aws_sdk_managedblockchain.types.create_proposal_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_managedblockchain.types.create_proposal_input.CreateProposalInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_managedblockchain.types.create_proposal_input.serialize_json(input_)
    ).encode()
