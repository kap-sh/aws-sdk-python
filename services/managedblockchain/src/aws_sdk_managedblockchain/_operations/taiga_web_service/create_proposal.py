...
def build_request(
    ...
    input: aws_sdk_managedblockchain.types.create_proposal_input.CreateProposalInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_managedblockchain.types.create_proposal_input.serialize_json(input)
    ).encode()
