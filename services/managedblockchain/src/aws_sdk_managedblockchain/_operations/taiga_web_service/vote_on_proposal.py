...
def handle_response(
    ...
    out: aws_sdk_managedblockchain.types.vote_on_proposal_output.VoteOnProposalOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_managedblockchain.types.vote_on_proposal_input.VoteOnProposalInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_managedblockchain.types.vote_on_proposal_input.serialize_json(input)
    ).encode()
