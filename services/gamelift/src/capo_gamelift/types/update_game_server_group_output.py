"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateGameServerGroupOutput``."""
...
class UpdateGameServerGroupOutput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateGameServerGroupOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UpdateGameServerGroupOutput:
    out: UpdateGameServerGroupOutput = {}  # type: ignore[typeddict-item]
