...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StartFleetActionsOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> StartFleetActionsOutput:
    out: StartFleetActionsOutput = {}  # type: ignore[typeddict-item]
    if "FleetId" in data:
