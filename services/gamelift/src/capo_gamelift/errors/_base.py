...
class GameLiftError(Exception):
    """Base class for all GameLift service errors."""


class ServiceError(GameLiftError):
...
class SerializationError(GameLiftError):
    """Raised when a value cannot be serialized."""


class DeserializationError(GameLiftError):
...
class WaiterFailedError(GameLiftError):
...
class WaiterTimeoutError(GameLiftError):
