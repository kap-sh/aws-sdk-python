...
def handle_response(
    ...
    out: capo_gamelift.types.delete_matchmaking_rule_set_output.DeleteMatchmakingRuleSetOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.delete_matchmaking_rule_set_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
