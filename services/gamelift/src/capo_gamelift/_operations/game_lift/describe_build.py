"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeBuild``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.describe_build_output.DescribeBuildOutput = (
        capo_gamelift.types.describe_build_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_build_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_build(
    ...
    capo_gamelift.types.describe_build_output.DescribeBuildOutput, zapros.Response
]:
...
async def async_describe_build(
