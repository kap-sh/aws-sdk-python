...
def handle_response(
    ...
    out: capo_gamelift.types.describe_fleet_attributes_output.DescribeFleetAttributesOutput = capo_gamelift.types.describe_fleet_attributes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_fleet_attributes_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
