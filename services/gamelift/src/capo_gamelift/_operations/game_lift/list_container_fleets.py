"""Generated from Smithy shape ``com.amazonaws.gamelift#ListContainerFleets``."""
...
import capo_gamelift.types.container_fleet_list
...
def handle_response(
    ...
    out: capo_gamelift.types.list_container_fleets_output.ListContainerFleetsOutput = (
        capo_gamelift.types.list_container_fleets_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.ListContainerFleets"
    body: bytes | None = json.dumps(
        capo_gamelift.types.list_container_fleets_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_container_fleets(
