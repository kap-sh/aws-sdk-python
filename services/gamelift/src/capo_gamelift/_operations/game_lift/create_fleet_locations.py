...
def handle_response(
    ...
    out: capo_gamelift.types.create_fleet_locations_output.CreateFleetLocationsOutput = capo_gamelift.types.create_fleet_locations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_fleet_locations_input.serialize_aws_json_1_1(input_)
    ).encode()
