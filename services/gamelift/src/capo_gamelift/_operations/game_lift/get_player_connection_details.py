"""Generated from Smithy shape ``com.amazonaws.gamelift#GetPlayerConnectionDetails``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.get_player_connection_details_output.GetPlayerConnectionDetailsOutput = capo_gamelift.types.get_player_connection_details_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.get_player_connection_details_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_player_connection_details(
