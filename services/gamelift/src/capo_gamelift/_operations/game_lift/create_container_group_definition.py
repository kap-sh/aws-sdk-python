"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateContainerGroupDefinition``."""
...
import capo_gamelift.errors.tagging_failed_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TaggingFailedException":
            raise capo_gamelift.errors.tagging_failed_exception.TaggingFailedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_gamelift.types.create_container_group_definition_output.CreateContainerGroupDefinitionOutput = capo_gamelift.types.create_container_group_definition_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.CreateContainerGroupDefinition"
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_container_group_definition_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_container_group_definition(
