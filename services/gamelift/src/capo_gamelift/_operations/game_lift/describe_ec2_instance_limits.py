...
def handle_response(
    ...
    out: capo_gamelift.types.describe_ec2_instance_limits_output.DescribeEC2InstanceLimitsOutput = capo_gamelift.types.describe_ec2_instance_limits_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_ec2_instance_limits_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
