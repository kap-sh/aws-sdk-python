"""Generated from Smithy shape ``com.amazonaws.gamelift#SuspendGameServerGroup``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.suspend_game_server_group_output.SuspendGameServerGroupOutput = capo_gamelift.types.suspend_game_server_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.SuspendGameServerGroup"
    body: bytes | None = json.dumps(
        capo_gamelift.types.suspend_game_server_group_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_suspend_game_server_group(
