...
def handle_response(
    ...
    out: capo_gamelift.types.create_vpc_peering_authorization_output.CreateVpcPeeringAuthorizationOutput = capo_gamelift.types.create_vpc_peering_authorization_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_vpc_peering_authorization_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
