"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateFleet``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NotReadyException":
            raise capo_gamelift.errors.not_ready_exception.NotReadyException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_gamelift.types.create_fleet_output.CreateFleetOutput = (
        capo_gamelift.types.create_fleet_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_fleet_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_fleet(
    ...
    input_: capo_gamelift.types.create_fleet_input.CreateFleetInput,
) -> tuple[capo_gamelift.types.create_fleet_output.CreateFleetOutput, zapros.Response]:
