...
def handle_response(
    ...
    out: capo_gamelift.types.describe_fleet_location_utilization_output.DescribeFleetLocationUtilizationOutput = capo_gamelift.types.describe_fleet_location_utilization_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_fleet_location_utilization_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
