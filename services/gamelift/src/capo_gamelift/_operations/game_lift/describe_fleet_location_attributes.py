"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeFleetLocationAttributes``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.describe_fleet_location_attributes_output.DescribeFleetLocationAttributesOutput = capo_gamelift.types.describe_fleet_location_attributes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.DescribeFleetLocationAttributes"
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_fleet_location_attributes_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_fleet_location_attributes(
