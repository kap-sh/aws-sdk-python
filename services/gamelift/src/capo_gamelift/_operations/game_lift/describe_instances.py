"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeInstances``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.describe_instances_output.DescribeInstancesOutput = (
        capo_gamelift.types.describe_instances_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_instances_input.serialize_aws_json_1_1(input_)
    ).encode()
