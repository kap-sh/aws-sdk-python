...
def handle_response(
    ...
    out: capo_gamelift.types.request_upload_credentials_output.RequestUploadCredentialsOutput = capo_gamelift.types.request_upload_credentials_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.request_upload_credentials_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
