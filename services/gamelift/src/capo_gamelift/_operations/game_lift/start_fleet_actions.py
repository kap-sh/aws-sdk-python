"""Generated from Smithy shape ``com.amazonaws.gamelift#StartFleetActions``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.start_fleet_actions_output.StartFleetActionsOutput = (
        capo_gamelift.types.start_fleet_actions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.start_fleet_actions_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_start_fleet_actions(
