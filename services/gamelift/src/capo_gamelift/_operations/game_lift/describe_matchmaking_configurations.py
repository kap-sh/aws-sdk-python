"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeMatchmakingConfigurations``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.describe_matchmaking_configurations_output.DescribeMatchmakingConfigurationsOutput = capo_gamelift.types.describe_matchmaking_configurations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_matchmaking_configurations_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_matchmaking_configurations(
