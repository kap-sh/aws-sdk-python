...
def handle_response(
    ...
    out: capo_gamelift.types.validate_matchmaking_rule_set_output.ValidateMatchmakingRuleSetOutput = capo_gamelift.types.validate_matchmaking_rule_set_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.validate_matchmaking_rule_set_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
