...
def handle_response(
    ...
    out: capo_gamelift.types.put_scaling_policy_output.PutScalingPolicyOutput = (
        capo_gamelift.types.put_scaling_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.put_scaling_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
