"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateMatchmakingConfiguration``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.update_matchmaking_configuration_output.UpdateMatchmakingConfigurationOutput = capo_gamelift.types.update_matchmaking_configuration_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.update_matchmaking_configuration_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_matchmaking_configuration(
