"""Generated from Smithy shape ``com.amazonaws.gamelift#DeleteGameSessionQueue``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.delete_game_session_queue_output.DeleteGameSessionQueueOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.delete_game_session_queue_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_game_session_queue(
