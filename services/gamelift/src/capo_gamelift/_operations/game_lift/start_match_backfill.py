"""Generated from Smithy shape ``com.amazonaws.gamelift#StartMatchBackfill``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.start_match_backfill_output.StartMatchBackfillOutput = (
        capo_gamelift.types.start_match_backfill_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.start_match_backfill_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_start_match_backfill(
