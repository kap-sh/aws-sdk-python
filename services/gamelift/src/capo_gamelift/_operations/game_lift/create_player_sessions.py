...
import capo_gamelift.errors.game_session_full_exception
import capo_gamelift.errors.internal_service_exception
import capo_gamelift.errors.invalid_game_session_status_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "GameSessionFullException":
            raise capo_gamelift.errors.game_session_full_exception.GameSessionFullException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidGameSessionStatusException":
            raise capo_gamelift.errors.invalid_game_session_status_exception.InvalidGameSessionStatusException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_gamelift.types.create_player_sessions_output.CreatePlayerSessionsOutput = capo_gamelift.types.create_player_sessions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_player_sessions_input.serialize_aws_json_1_1(input_)
    ).encode()
