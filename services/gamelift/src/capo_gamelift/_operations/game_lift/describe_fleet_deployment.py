"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeFleetDeployment``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.describe_fleet_deployment_output.DescribeFleetDeploymentOutput = capo_gamelift.types.describe_fleet_deployment_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.DescribeFleetDeployment"
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_fleet_deployment_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_fleet_deployment(
