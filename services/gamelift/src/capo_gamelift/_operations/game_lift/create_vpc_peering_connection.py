...
def handle_response(
    ...
    out: capo_gamelift.types.create_vpc_peering_connection_output.CreateVpcPeeringConnectionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_vpc_peering_connection_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
