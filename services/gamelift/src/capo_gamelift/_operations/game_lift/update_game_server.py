"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateGameServer``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.update_game_server_output.UpdateGameServerOutput = (
        capo_gamelift.types.update_game_server_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.UpdateGameServer"
    body: bytes | None = json.dumps(
        capo_gamelift.types.update_game_server_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_game_server(
