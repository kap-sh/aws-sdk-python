"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateFleetCapacity``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.update_fleet_capacity_output.UpdateFleetCapacityOutput = (
        capo_gamelift.types.update_fleet_capacity_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.update_fleet_capacity_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_fleet_capacity(
