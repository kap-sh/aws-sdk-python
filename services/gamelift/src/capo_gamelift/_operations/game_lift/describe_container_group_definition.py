...
def handle_response(
    ...
    out: capo_gamelift.types.describe_container_group_definition_output.DescribeContainerGroupDefinitionOutput = capo_gamelift.types.describe_container_group_definition_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_container_group_definition_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
