"""Generated from Smithy shape ``com.amazonaws.gamelift#ListFleetDeployments``."""
...
import capo_gamelift.types.fleet_deployments
...
def handle_response(
    ...
    out: capo_gamelift.types.list_fleet_deployments_output.ListFleetDeploymentsOutput = capo_gamelift.types.list_fleet_deployments_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.ListFleetDeployments"
    body: bytes | None = json.dumps(
        capo_gamelift.types.list_fleet_deployments_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_fleet_deployments(
