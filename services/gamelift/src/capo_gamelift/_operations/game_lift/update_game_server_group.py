...
def handle_response(
    ...
    out: capo_gamelift.types.update_game_server_group_output.UpdateGameServerGroupOutput = capo_gamelift.types.update_game_server_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.update_game_server_group_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
