"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeCompute``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.describe_compute_output.DescribeComputeOutput = (
        capo_gamelift.types.describe_compute_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.DescribeCompute"
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_compute_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_compute(
    ...
    capo_gamelift.types.describe_compute_output.DescribeComputeOutput, zapros.Response
]:
...
async def async_describe_compute(
