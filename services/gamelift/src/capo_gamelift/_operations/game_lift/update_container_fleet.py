...
def handle_response(
    ...
    out: capo_gamelift.types.update_container_fleet_output.UpdateContainerFleetOutput = capo_gamelift.types.update_container_fleet_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.update_container_fleet_input.serialize_aws_json_1_1(input_)
    ).encode()
