"""Generated from Smithy shape ``com.amazonaws.gamelift#ClaimGameServer``."""
...
import capo_gamelift.errors.out_of_capacity_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OutOfCapacityException":
            raise capo_gamelift.errors.out_of_capacity_exception.OutOfCapacityException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_gamelift.types.claim_game_server_output.ClaimGameServerOutput = (
        capo_gamelift.types.claim_game_server_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.ClaimGameServer"
    body: bytes | None = json.dumps(
        capo_gamelift.types.claim_game_server_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def claim_game_server(
    ...
    capo_gamelift.types.claim_game_server_output.ClaimGameServerOutput, zapros.Response
]:
...
async def async_claim_game_server(
