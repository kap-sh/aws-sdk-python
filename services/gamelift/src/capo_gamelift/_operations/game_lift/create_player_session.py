"""Generated from Smithy shape ``com.amazonaws.gamelift#CreatePlayerSession``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.create_player_session_output.CreatePlayerSessionOutput = (
        capo_gamelift.types.create_player_session_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_player_session_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_player_session(
