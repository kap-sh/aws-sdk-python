"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateScript``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.update_script_output.UpdateScriptOutput = (
        capo_gamelift.types.update_script_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.update_script_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_script(
    ...
    capo_gamelift.types.update_script_output.UpdateScriptOutput, zapros.Response
]:
