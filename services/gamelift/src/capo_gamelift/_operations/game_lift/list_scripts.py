...
def handle_response(
    ...
    out: capo_gamelift.types.list_scripts_output.ListScriptsOutput = (
        capo_gamelift.types.list_scripts_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.list_scripts_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_scripts(
    ...
    input_: capo_gamelift.types.list_scripts_input.ListScriptsInput,
) -> tuple[capo_gamelift.types.list_scripts_output.ListScriptsOutput, zapros.Response]:
