...
def handle_response(
    ...
    out: capo_gamelift.types.deregister_compute_output.DeregisterComputeOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.deregister_compute_input.serialize_aws_json_1_1(input_)
    ).encode()
