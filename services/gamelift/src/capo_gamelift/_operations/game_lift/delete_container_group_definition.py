...
def handle_response(
    ...
    out: capo_gamelift.types.delete_container_group_definition_output.DeleteContainerGroupDefinitionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.delete_container_group_definition_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
