...
import capo_gamelift.types.fleet_id_list
...
def handle_response(
    ...
    out: capo_gamelift.types.list_fleets_output.ListFleetsOutput = (
        capo_gamelift.types.list_fleets_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.list_fleets_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_fleets(
    ...
    input_: capo_gamelift.types.list_fleets_input.ListFleetsInput,
) -> tuple[capo_gamelift.types.list_fleets_output.ListFleetsOutput, zapros.Response]:
