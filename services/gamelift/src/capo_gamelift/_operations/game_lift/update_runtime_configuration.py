"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateRuntimeConfiguration``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.update_runtime_configuration_output.UpdateRuntimeConfigurationOutput = capo_gamelift.types.update_runtime_configuration_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.update_runtime_configuration_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_runtime_configuration(
