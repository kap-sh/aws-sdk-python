...
class GetInstanceAccessOutput(TypedDict):
    instance_access: NotRequired[
        "aws_sdk_gamelift.types.instance_access.InstanceAccess"
    ]
...
def serialize_aws_json_1_1(value: GetInstanceAccessOutput) -> dict:
    ...
    if "instance_access" in value:
        ...
        out["InstanceAccess"] = (
            aws_sdk_gamelift.types.instance_access.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetInstanceAccessOutput:
    ...
    if "InstanceAccess" in data:
        ...
        out["instance_access"] = (
            aws_sdk_gamelift.types.instance_access.deserialize_aws_json_1_1(
                data["InstanceAccess"]
            )
        )
    return out
