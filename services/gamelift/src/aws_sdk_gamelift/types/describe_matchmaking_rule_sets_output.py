...
class DescribeMatchmakingRuleSetsOutput(TypedDict):
    rule_sets: NotRequired[
        "aws_sdk_gamelift.types.matchmaking_rule_set_list.MatchmakingRuleSetList"
    ]
...
def serialize_aws_json_1_1(value: DescribeMatchmakingRuleSetsOutput) -> dict:
    ...
    if "rule_sets" in value:
        ...
        out["RuleSets"] = (
            aws_sdk_gamelift.types.matchmaking_rule_set_list.serialize_aws_json_1_1(
                value["rule_sets"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeMatchmakingRuleSetsOutput:
    ...
    if "RuleSets" in data:
        ...
        out["rule_sets"] = (
            aws_sdk_gamelift.types.matchmaking_rule_set_list.deserialize_aws_json_1_1(
                data["RuleSets"]
            )
        )
