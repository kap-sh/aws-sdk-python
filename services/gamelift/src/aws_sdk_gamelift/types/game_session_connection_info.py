...
if TYPE_CHECKING:
    ...
    import aws_sdk_gamelift.types.matched_player_session_list
    import aws_sdk_gamelift.types.player_gateway_status
    import aws_sdk_gamelift.types.positive_integer


class GameSessionConnectionInfo(TypedDict):
    ...
    matched_player_sessions: NotRequired[
        "aws_sdk_gamelift.types.matched_player_session_list.MatchedPlayerSessionList"
    ]
...
def serialize_aws_json_1_1(value: GameSessionConnectionInfo) -> dict:
    ...
    if "matched_player_sessions" in value:
        ...
        out["MatchedPlayerSessions"] = (
            aws_sdk_gamelift.types.matched_player_session_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GameSessionConnectionInfo:
    ...
    if "MatchedPlayerSessions" in data:
        ...
        out["matched_player_sessions"] = (
            aws_sdk_gamelift.types.matched_player_session_list.deserialize_aws_json_1_1(
