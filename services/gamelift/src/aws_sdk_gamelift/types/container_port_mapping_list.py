...
if TYPE_CHECKING:
    import aws_sdk_gamelift.types.container_port_mapping

ContainerPortMappingList: TypeAlias = list[
    "aws_sdk_gamelift.types.container_port_mapping.ContainerPortMapping"
]
...
def serialize_aws_json_1_1(value: ContainerPortMappingList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_gamelift.types.container_port_mapping.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ContainerPortMappingList:
    ...
    for item in data:
        out.append(
            aws_sdk_gamelift.types.container_port_mapping.deserialize_aws_json_1_1(item)
        )
    return out
