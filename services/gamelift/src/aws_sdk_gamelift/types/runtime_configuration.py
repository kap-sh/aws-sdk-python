...
if TYPE_CHECKING:
    import aws_sdk_gamelift.types.game_session_activation_timeout_seconds
    import aws_sdk_gamelift.types.max_concurrent_game_session_activations
    import aws_sdk_gamelift.types.server_process_list


class RuntimeConfiguration(TypedDict, closed=True):
    server_processes: NotRequired[
        "aws_sdk_gamelift.types.server_process_list.ServerProcessList"
    ]
    ...
    max_concurrent_game_session_activations: NotRequired[
        "aws_sdk_gamelift.types.max_concurrent_game_session_activations.MaxConcurrentGameSessionActivations"
    ]
    ...
    game_session_activation_timeout_seconds: NotRequired[
        "aws_sdk_gamelift.types.game_session_activation_timeout_seconds.GameSessionActivationTimeoutSeconds"
    ]
...
def serialize_aws_json_1_1(value: RuntimeConfiguration) -> dict:
    ...
    if "server_processes" in value:
        ...
        out["ServerProcesses"] = (
            aws_sdk_gamelift.types.server_process_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RuntimeConfiguration:
    ...
    if "ServerProcesses" in data:
        ...
        out["server_processes"] = (
            aws_sdk_gamelift.types.server_process_list.deserialize_aws_json_1_1(
