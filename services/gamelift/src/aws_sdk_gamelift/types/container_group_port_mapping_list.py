...
if TYPE_CHECKING:
    import aws_sdk_gamelift.types.container_group_port_mapping

ContainerGroupPortMappingList: TypeAlias = list[
    "aws_sdk_gamelift.types.container_group_port_mapping.ContainerGroupPortMapping"
]
...
def serialize_aws_json_1_1(value: ContainerGroupPortMappingList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_gamelift.types.container_group_port_mapping.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ContainerGroupPortMappingList:
    ...
    for item in data:
        out.append(
            aws_sdk_gamelift.types.container_group_port_mapping.deserialize_aws_json_1_1(
                item
            )
        )
    return out
