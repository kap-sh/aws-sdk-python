...
if TYPE_CHECKING:
    ...
    import aws_sdk_gamelift.types.game_session_placement_state
    ...
    import aws_sdk_gamelift.types.placed_player_session_list
...
class GameSessionPlacement(TypedDict):
    ...
    status: NotRequired[
        "aws_sdk_gamelift.types.game_session_placement_state.GameSessionPlacementState"
    ]
    ...
    placed_player_sessions: NotRequired[
        "aws_sdk_gamelift.types.placed_player_session_list.PlacedPlayerSessionList"
    ]
...
def serialize_aws_json_1_1(value: GameSessionPlacement) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_gamelift.types.game_session_placement_state.serialize_aws_json_1_1(
                value["status"]
            )
        )
    ...
    if "placed_player_sessions" in value:
        ...
        out["PlacedPlayerSessions"] = (
            aws_sdk_gamelift.types.placed_player_session_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GameSessionPlacement:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_gamelift.types.game_session_placement_state.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
    ...
    if "PlacedPlayerSessions" in data:
        ...
        out["placed_player_sessions"] = (
            aws_sdk_gamelift.types.placed_player_session_list.deserialize_aws_json_1_1(
