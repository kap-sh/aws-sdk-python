...
class ContainerDependency(TypedDict, closed=True):
    ...
    condition: NotRequired[
        "aws_sdk_gamelift.types.container_dependency_condition.ContainerDependencyCondition"
    ]
...
def serialize_aws_json_1_1(value: ContainerDependency) -> dict:
    ...
    if "condition" in value:
        ...
        out["Condition"] = (
            aws_sdk_gamelift.types.container_dependency_condition.serialize_aws_json_1_1(
                value["condition"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ContainerDependency:
    ...
    if "Condition" in data:
        ...
        out["condition"] = (
            aws_sdk_gamelift.types.container_dependency_condition.deserialize_aws_json_1_1(
                data["Condition"]
            )
        )
    return out
