...
class DescribeInstancesOutput(TypedDict):
    instances: NotRequired["aws_sdk_gamelift.types.instance_list.InstanceList"]
...
def serialize_aws_json_1_1(value: DescribeInstancesOutput) -> dict:
    ...
    if "instances" in value:
        ...
        out["Instances"] = aws_sdk_gamelift.types.instance_list.serialize_aws_json_1_1(
            value["instances"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeInstancesOutput:
    ...
    if "Instances" in data:
        ...
        out["instances"] = (
            aws_sdk_gamelift.types.instance_list.deserialize_aws_json_1_1(
                data["Instances"]
            )
        )
