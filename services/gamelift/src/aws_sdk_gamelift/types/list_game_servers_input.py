...
class ListGameServersInput(TypedDict):
    ...
    sort_order: NotRequired["aws_sdk_gamelift.types.sort_order.SortOrder"]
...
def serialize_aws_json_1_1(value: ListGameServersInput) -> dict:
    ...
    if "sort_order" in value:
        ...
        out["SortOrder"] = aws_sdk_gamelift.types.sort_order.serialize_aws_json_1_1(
            value["sort_order"]
        )
    if "limit" in value:
...
def deserialize_aws_json_1_1(data: dict) -> ListGameServersInput:
    ...
    if "SortOrder" in data:
        ...
        out["sort_order"] = aws_sdk_gamelift.types.sort_order.deserialize_aws_json_1_1(
            data["SortOrder"]
        )
    if "Limit" in data:
