...
if TYPE_CHECKING:
    ...
    import aws_sdk_gamelift.types.priority_type_list


class PriorityConfiguration(TypedDict):
    priority_order: NotRequired[
        "aws_sdk_gamelift.types.priority_type_list.PriorityTypeList"
    ]
    ...
    location_order: NotRequired["aws_sdk_gamelift.types.location_list.LocationList"]
...
def serialize_aws_json_1_1(value: PriorityConfiguration) -> dict:
    ...
    if "priority_order" in value:
        ...
        out["PriorityOrder"] = (
            aws_sdk_gamelift.types.priority_type_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> PriorityConfiguration:
    ...
    if "PriorityOrder" in data:
        ...
        out["priority_order"] = (
            aws_sdk_gamelift.types.priority_type_list.deserialize_aws_json_1_1(
                data["PriorityOrder"]
            )
        )
