...
if TYPE_CHECKING:
    import aws_sdk_gamelift.types.vpc_peering_connection

VpcPeeringConnectionList: TypeAlias = list[
    "aws_sdk_gamelift.types.vpc_peering_connection.VpcPeeringConnection"
]
...
def serialize_aws_json_1_1(value: VpcPeeringConnectionList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_gamelift.types.vpc_peering_connection.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> VpcPeeringConnectionList:
    ...
    for item in data:
        out.append(
            aws_sdk_gamelift.types.vpc_peering_connection.deserialize_aws_json_1_1(item)
        )
    return out
