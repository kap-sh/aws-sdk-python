...
if TYPE_CHECKING:
    import aws_sdk_gamelift.types.ec2_instance_limit

EC2InstanceLimitList: TypeAlias = list[
    "aws_sdk_gamelift.types.ec2_instance_limit.EC2InstanceLimit"
]
...
def serialize_aws_json_1_1(value: EC2InstanceLimitList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_gamelift.types.ec2_instance_limit.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> EC2InstanceLimitList:
    ...
    for item in data:
        out.append(
            aws_sdk_gamelift.types.ec2_instance_limit.deserialize_aws_json_1_1(item)
        )
    return out
