...
class ListGameServersOutput(TypedDict):
    game_servers: NotRequired["aws_sdk_gamelift.types.game_servers.GameServers"]
...
def serialize_aws_json_1_1(value: ListGameServersOutput) -> dict:
    ...
    if "game_servers" in value:
        ...
        out["GameServers"] = aws_sdk_gamelift.types.game_servers.serialize_aws_json_1_1(
            value["game_servers"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListGameServersOutput:
    ...
    if "GameServers" in data:
        ...
        out["game_servers"] = (
            aws_sdk_gamelift.types.game_servers.deserialize_aws_json_1_1(
                data["GameServers"]
            )
        )
