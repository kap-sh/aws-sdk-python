...
if TYPE_CHECKING:
    import aws_sdk_gamelift.types.certificate_type


class CertificateConfiguration(TypedDict):
    certificate_type: NotRequired[
        "aws_sdk_gamelift.types.certificate_type.CertificateType"
    ]
...
def serialize_aws_json_1_1(value: CertificateConfiguration) -> dict:
    ...
    if "certificate_type" in value:
        ...
        out["CertificateType"] = (
            aws_sdk_gamelift.types.certificate_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CertificateConfiguration:
    ...
    if "CertificateType" in data:
        ...
        out["certificate_type"] = (
            aws_sdk_gamelift.types.certificate_type.deserialize_aws_json_1_1(
