"""Generated from Smithy shape ``com.amazonaws.gamelift#EventCode``."""
...
def serialize_aws_json_1_1(value: EventCode) -> str:
    return value


def deserialize_aws_json_1_1(data: str) -> EventCode:
    if data not in _VALUES:
        raise DeserializationError(f"unknown EventCode value: {data!r}")
    return cast(EventCode, data)
