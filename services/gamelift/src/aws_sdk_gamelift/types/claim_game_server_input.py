...
class ClaimGameServerInput(TypedDict):
...
def serialize_aws_json_1_1(value: ClaimGameServerInput) -> dict:
    ...
    if "filter_option" in value:
        ...
        out["FilterOption"] = (
            aws_sdk_gamelift.types.claim_filter_option.serialize_aws_json_1_1(
                value["filter_option"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ClaimGameServerInput:
    ...
    if "FilterOption" in data:
        ...
        out["filter_option"] = (
            aws_sdk_gamelift.types.claim_filter_option.deserialize_aws_json_1_1(
                data["FilterOption"]
            )
        )
    return out
