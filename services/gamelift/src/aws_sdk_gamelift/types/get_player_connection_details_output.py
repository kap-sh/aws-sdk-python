...
if TYPE_CHECKING:
    ...
    import aws_sdk_gamelift.types.player_connection_detail_list


class GetPlayerConnectionDetailsOutput(TypedDict):
    ...
    player_connection_details: NotRequired[
        "aws_sdk_gamelift.types.player_connection_detail_list.PlayerConnectionDetailList"
    ]
...
def serialize_aws_json_1_1(value: GetPlayerConnectionDetailsOutput) -> dict:
    ...
    if "player_connection_details" in value:
        ...
        out["PlayerConnectionDetails"] = (
            aws_sdk_gamelift.types.player_connection_detail_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetPlayerConnectionDetailsOutput:
    ...
    if "PlayerConnectionDetails" in data:
        ...
        out["player_connection_details"] = (
            aws_sdk_gamelift.types.player_connection_detail_list.deserialize_aws_json_1_1(
