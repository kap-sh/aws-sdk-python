...
if TYPE_CHECKING:
    import aws_sdk_gamelift.types.desired_player_session

DesiredPlayerSessionList: TypeAlias = list[
    "aws_sdk_gamelift.types.desired_player_session.DesiredPlayerSession"
]
...
def serialize_aws_json_1_1(value: DesiredPlayerSessionList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_gamelift.types.desired_player_session.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> DesiredPlayerSessionList:
    ...
    for item in data:
        out.append(
            aws_sdk_gamelift.types.desired_player_session.deserialize_aws_json_1_1(item)
        )
    return out
