...
if TYPE_CHECKING:
    import aws_sdk_gamelift.types.launch_template_id
    import aws_sdk_gamelift.types.launch_template_name
    import aws_sdk_gamelift.types.launch_template_version


class LaunchTemplateSpecification(TypedDict, closed=True):
    launch_template_id: NotRequired[
        "aws_sdk_gamelift.types.launch_template_id.LaunchTemplateId"
    ]
    """<p>A unique identifier for an existing Amazon EC2 launch template.</p>"""
    launch_template_name: NotRequired[
        "aws_sdk_gamelift.types.launch_template_name.LaunchTemplateName"
    ]
    """<p>A readable identifier for an existing Amazon EC2 launch template. </p>"""
    version: NotRequired[
        "aws_sdk_gamelift.types.launch_template_version.LaunchTemplateVersion"
    ]
