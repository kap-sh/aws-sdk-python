...
class DescribeGameSessionQueuesInput(TypedDict):
    names: NotRequired[
...
def serialize_aws_json_1_1(value: DescribeGameSessionQueuesInput) -> dict:
    ...
    if "names" in value:
        ...
        out["Names"] = (
            aws_sdk_gamelift.types.game_session_queue_name_or_arn_list.serialize_aws_json_1_1(
                value["names"]
            )
        )
    if "limit" in value:
...
def deserialize_aws_json_1_1(data: dict) -> DescribeGameSessionQueuesInput:
    ...
    if "Names" in data:
        ...
        out["names"] = (
            aws_sdk_gamelift.types.game_session_queue_name_or_arn_list.deserialize_aws_json_1_1(
                data["Names"]
            )
        )
    if "Limit" in data:
