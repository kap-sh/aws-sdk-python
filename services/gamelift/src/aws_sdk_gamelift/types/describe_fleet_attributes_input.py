"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeFleetAttributesInput``."""
...
class DescribeFleetAttributesInput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeFleetAttributesInput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DescribeFleetAttributesInput:
    out: DescribeFleetAttributesInput = {}  # type: ignore[typeddict-item]
    if "FleetIds" in data:
        import aws_sdk_gamelift.types.fleet_id_or_arn_list
