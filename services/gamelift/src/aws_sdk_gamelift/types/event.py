...
if TYPE_CHECKING:
    import aws_sdk_gamelift.types.event_code
    import aws_sdk_gamelift.types.event_count
...
class Event(TypedDict):
    ...
    event_code: NotRequired["aws_sdk_gamelift.types.event_code.EventCode"]
    ...
    event_time: NotRequired["aws_sdk_gamelift.types.timestamp.Timestamp"]
    ...
    count: NotRequired["aws_sdk_gamelift.types.event_count.EventCount"]
...
def serialize_aws_json_1_1(value: Event) -> dict:
    ...
    if "event_code" in value:
        ...
        out["EventCode"] = aws_sdk_gamelift.types.event_code.serialize_aws_json_1_1(
            value["event_code"]
        )
    if "message" in value:
    ...
    if "event_time" in value:
        ...
        out["EventTime"] = aws_sdk_gamelift.types.timestamp.serialize_aws_json_1_1(
            value["event_time"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> Event:
    ...
    if "EventCode" in data:
        ...
        out["event_code"] = aws_sdk_gamelift.types.event_code.deserialize_aws_json_1_1(
            data["EventCode"]
        )
    if "Message" in data:
    ...
    if "EventTime" in data:
        ...
        out["event_time"] = aws_sdk_gamelift.types.timestamp.deserialize_aws_json_1_1(
            data["EventTime"]
        )
