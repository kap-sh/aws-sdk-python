...
if TYPE_CHECKING:
    ...
    import aws_sdk_gamelift.types.compute_auth_token
...
class GetComputeAuthTokenOutput(TypedDict):
    ...
    auth_token: NotRequired[
        "aws_sdk_gamelift.types.compute_auth_token.ComputeAuthToken"
    ]
    """<p>A valid temporary authentication token.</p>"""
    expiration_timestamp: NotRequired["aws_sdk_gamelift.types.timestamp.Timestamp"]
