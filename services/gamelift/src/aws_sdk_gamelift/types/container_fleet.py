...
if TYPE_CHECKING:
    ...
    import aws_sdk_gamelift.types.container_fleet_location_attributes_list
    import aws_sdk_gamelift.types.container_fleet_status
    ...
    import aws_sdk_gamelift.types.deployment_details
    ...
    import aws_sdk_gamelift.types.maximum_game_server_container_groups_per_instance
...
class ContainerFleet(TypedDict):
    ...
    maximum_game_server_container_groups_per_instance: NotRequired[
        "aws_sdk_gamelift.types.maximum_game_server_container_groups_per_instance.MaximumGameServerContainerGroupsPerInstance"
    ]
    ...
    status: NotRequired[
        "aws_sdk_gamelift.types.container_fleet_status.ContainerFleetStatus"
    ]
    ...
    deployment_details: NotRequired[
        "aws_sdk_gamelift.types.deployment_details.DeploymentDetails"
    ]
    ...
    location_attributes: NotRequired[
        "aws_sdk_gamelift.types.container_fleet_location_attributes_list.ContainerFleetLocationAttributesList"
    ]
...
def serialize_aws_json_1_1(value: ContainerFleet) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_gamelift.types.container_fleet_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
    if "deployment_details" in value:
        ...
        out["DeploymentDetails"] = (
            aws_sdk_gamelift.types.deployment_details.serialize_aws_json_1_1(
    ...
    if "location_attributes" in value:
        ...
        out["LocationAttributes"] = (
            aws_sdk_gamelift.types.container_fleet_location_attributes_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ContainerFleet:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_gamelift.types.container_fleet_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
    if "DeploymentDetails" in data:
        ...
        out["deployment_details"] = (
            aws_sdk_gamelift.types.deployment_details.deserialize_aws_json_1_1(
    ...
    if "LocationAttributes" in data:
        ...
        out["location_attributes"] = (
            aws_sdk_gamelift.types.container_fleet_location_attributes_list.deserialize_aws_json_1_1(
