...
class CreateGameServerGroupInput(TypedDict):
    ...
    min_size: NotRequired["aws_sdk_gamelift.types.whole_number.WholeNumber"]
    ...
    max_size: NotRequired["aws_sdk_gamelift.types.positive_integer.PositiveInteger"]
    ...
    launch_template: NotRequired[
        "aws_sdk_gamelift.types.launch_template_specification.LaunchTemplateSpecification"
    ]
    ...
    vpc_subnets: NotRequired["aws_sdk_gamelift.types.vpc_subnets.VpcSubnets"]
...
def serialize_aws_json_1_1(value: CreateGameServerGroupInput) -> dict:
    ...
    if "launch_template" in value:
        ...
        out["LaunchTemplate"] = (
            aws_sdk_gamelift.types.launch_template_specification.serialize_aws_json_1_1(
    ...
    if "auto_scaling_policy" in value:
        ...
        out["AutoScalingPolicy"] = (
            aws_sdk_gamelift.types.game_server_group_auto_scaling_policy.serialize_aws_json_1_1(
    ...
    if "vpc_subnets" in value:
        ...
        out["VpcSubnets"] = aws_sdk_gamelift.types.vpc_subnets.serialize_aws_json_1_1(
            value["vpc_subnets"]
        )
    if "tags" in value:
        import aws_sdk_gamelift.types.tag_list
...
def deserialize_aws_json_1_1(data: dict) -> CreateGameServerGroupInput:
    ...
    if "LaunchTemplate" in data:
        ...
        out["launch_template"] = (
            aws_sdk_gamelift.types.launch_template_specification.deserialize_aws_json_1_1(
                data["LaunchTemplate"]
            )
        )
    ...
    if "AutoScalingPolicy" in data:
        ...
        out["auto_scaling_policy"] = (
            aws_sdk_gamelift.types.game_server_group_auto_scaling_policy.deserialize_aws_json_1_1(
    ...
    if "VpcSubnets" in data:
        ...
        out["vpc_subnets"] = (
            aws_sdk_gamelift.types.vpc_subnets.deserialize_aws_json_1_1(
                data["VpcSubnets"]
            )
        )
    if "Tags" in data:
