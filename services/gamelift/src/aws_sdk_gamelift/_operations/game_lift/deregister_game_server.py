"""Generated from Smithy shape ``com.amazonaws.gamelift#DeregisterGameServer``."""
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.deregister_game_server_input.DeregisterGameServerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.DeregisterGameServer"
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.deregister_game_server_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_deregister_game_server(
