"""Generated from Smithy shape ``com.amazonaws.gamelift#StopFleetActions``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.stop_fleet_actions_output.StopFleetActionsOutput = (
        aws_sdk_gamelift.types.stop_fleet_actions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.stop_fleet_actions_input.StopFleetActionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.stop_fleet_actions_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_stop_fleet_actions(
