...
import aws_sdk_gamelift.errors.out_of_capacity_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OutOfCapacityException":
            raise aws_sdk_gamelift.errors.out_of_capacity_exception.OutOfCapacityException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.claim_game_server_output.ClaimGameServerOutput = (
        aws_sdk_gamelift.types.claim_game_server_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.claim_game_server_input.ClaimGameServerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.claim_game_server_input.serialize_aws_json_1_1(input_)
    ).encode()
