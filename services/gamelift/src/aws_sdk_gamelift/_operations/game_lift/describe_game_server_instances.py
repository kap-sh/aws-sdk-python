"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeGameServerInstances``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_game_server_instances_output.DescribeGameServerInstancesOutput = aws_sdk_gamelift.types.describe_game_server_instances_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_game_server_instances_input.DescribeGameServerInstancesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.DescribeGameServerInstances"
    import aws_sdk_gamelift.types.describe_game_server_instances_input

    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_game_server_instances_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_game_server_instances(
