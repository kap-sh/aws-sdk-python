"""Generated from Smithy shape ``com.amazonaws.gamelift#TerminateGameSession``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidGameSessionStatusException":
            import aws_sdk_gamelift.errors.invalid_game_session_status_exception

            raise aws_sdk_gamelift.errors.invalid_game_session_status_exception.InvalidGameSessionStatusException.from_aws_json_1_1(
                data
            )
        ...
        case "NotReadyException":
            import aws_sdk_gamelift.errors.not_ready_exception

            raise aws_sdk_gamelift.errors.not_ready_exception.NotReadyException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.terminate_game_session_output.TerminateGameSessionOutput = aws_sdk_gamelift.types.terminate_game_session_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.terminate_game_session_input.TerminateGameSessionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.TerminateGameSession"
    import aws_sdk_gamelift.types.terminate_game_session_input

    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.terminate_game_session_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_terminate_game_session(
