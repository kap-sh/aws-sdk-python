...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.get_compute_auth_token_output.GetComputeAuthTokenOutput = aws_sdk_gamelift.types.get_compute_auth_token_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.get_compute_auth_token_input.GetComputeAuthTokenInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.get_compute_auth_token_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
