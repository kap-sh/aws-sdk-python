...
def build_request(
    ...
    input: aws_sdk_gamelift.types.search_game_sessions_input.SearchGameSessionsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.search_game_sessions_input.serialize_aws_json_1_1(input)
    ).encode()
