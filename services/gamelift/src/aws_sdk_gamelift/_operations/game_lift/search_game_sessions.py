"""Generated from Smithy shape ``com.amazonaws.gamelift#SearchGameSessions``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.search_game_sessions_output.SearchGameSessionsOutput = (
        aws_sdk_gamelift.types.search_game_sessions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.search_game_sessions_input.SearchGameSessionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.search_game_sessions_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_search_game_sessions(
