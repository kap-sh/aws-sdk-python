...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.list_locations_output.ListLocationsOutput = (
        aws_sdk_gamelift.types.list_locations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.list_locations_input.ListLocationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.list_locations_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_locations(
    ...
    aws_sdk_gamelift.types.list_locations_output.ListLocationsOutput, zapros.Response
]:
