...
def build_request(
    ...
    input: aws_sdk_gamelift.types.start_match_backfill_input.StartMatchBackfillInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.start_match_backfill_input.serialize_aws_json_1_1(input)
    ).encode()
