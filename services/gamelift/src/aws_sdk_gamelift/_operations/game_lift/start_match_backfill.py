...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.start_match_backfill_output.StartMatchBackfillOutput = (
        aws_sdk_gamelift.types.start_match_backfill_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.start_match_backfill_input.StartMatchBackfillInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.start_match_backfill_input.serialize_aws_json_1_1(input_)
    ).encode()
