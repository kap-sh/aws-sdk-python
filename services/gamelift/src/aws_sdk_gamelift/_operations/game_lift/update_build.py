...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.update_build_output.UpdateBuildOutput = (
        aws_sdk_gamelift.types.update_build_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.update_build_input.UpdateBuildInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.update_build_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_build(
    ...
    aws_sdk_gamelift.types.update_build_output.UpdateBuildOutput, zapros.Response
]:
