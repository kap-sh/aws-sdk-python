...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_vpc_peering_authorizations_output.DescribeVpcPeeringAuthorizationsOutput = aws_sdk_gamelift.types.describe_vpc_peering_authorizations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_vpc_peering_authorizations_input.DescribeVpcPeeringAuthorizationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
