...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_fleet_location_attributes_output.DescribeFleetLocationAttributesOutput = aws_sdk_gamelift.types.describe_fleet_location_attributes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_fleet_location_attributes_input.DescribeFleetLocationAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_fleet_location_attributes_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
