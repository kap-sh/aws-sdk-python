"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateBuild``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_build_output.CreateBuildOutput = (
        aws_sdk_gamelift.types.create_build_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_build_input.CreateBuildInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_build_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_build(
    ...
    aws_sdk_gamelift.types.create_build_output.CreateBuildOutput, zapros.Response
]:
