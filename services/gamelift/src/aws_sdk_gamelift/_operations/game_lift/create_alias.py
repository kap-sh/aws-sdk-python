"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateAlias``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_alias_output.CreateAliasOutput = (
        aws_sdk_gamelift.types.create_alias_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_alias_input.CreateAliasInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_alias_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_alias(
    ...
    aws_sdk_gamelift.types.create_alias_output.CreateAliasOutput, zapros.Response
]:
