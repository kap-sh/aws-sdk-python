...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_player_sessions_output.DescribePlayerSessionsOutput = aws_sdk_gamelift.types.describe_player_sessions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_player_sessions_input.DescribePlayerSessionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_player_sessions_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
