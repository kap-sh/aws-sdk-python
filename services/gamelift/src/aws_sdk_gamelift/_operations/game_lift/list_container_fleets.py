...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.list_container_fleets_input.ListContainerFleetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.list_container_fleets_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
