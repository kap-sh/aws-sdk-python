...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.list_container_fleets_output.ListContainerFleetsOutput = aws_sdk_gamelift.types.list_container_fleets_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_gamelift.types.list_container_fleets_input.ListContainerFleetsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.list_container_fleets_input.serialize_aws_json_1_1(input)
    ).encode()
