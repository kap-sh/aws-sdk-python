"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeVpcPeeringConnections``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_vpc_peering_connections_output.DescribeVpcPeeringConnectionsOutput = aws_sdk_gamelift.types.describe_vpc_peering_connections_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_vpc_peering_connections_input.DescribeVpcPeeringConnectionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
