...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.update_runtime_configuration_output.UpdateRuntimeConfigurationOutput = aws_sdk_gamelift.types.update_runtime_configuration_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.update_runtime_configuration_input.UpdateRuntimeConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
