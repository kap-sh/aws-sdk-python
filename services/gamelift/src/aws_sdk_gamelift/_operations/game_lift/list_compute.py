"""Generated from Smithy shape ``com.amazonaws.gamelift#ListCompute``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.list_compute_output.ListComputeOutput = (
        aws_sdk_gamelift.types.list_compute_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.list_compute_input.ListComputeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.ListCompute"
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.list_compute_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_compute(
    ...
    aws_sdk_gamelift.types.list_compute_output.ListComputeOutput, zapros.Response
]:
