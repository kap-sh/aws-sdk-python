"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateGameServerGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.update_game_server_group_output.UpdateGameServerGroupOutput = aws_sdk_gamelift.types.update_game_server_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.update_game_server_group_input.UpdateGameServerGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.UpdateGameServerGroup"
    import aws_sdk_gamelift.types.update_game_server_group_input

    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.update_game_server_group_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_game_server_group(
