"""Generated from Smithy shape ``com.amazonaws.gamelift#ListScripts``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.list_scripts_output.ListScriptsOutput = (
        aws_sdk_gamelift.types.list_scripts_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.list_scripts_input.ListScriptsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.list_scripts_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_scripts(
    ...
    aws_sdk_gamelift.types.list_scripts_output.ListScriptsOutput, zapros.Response
]:
