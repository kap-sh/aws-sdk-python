"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeMatchmakingRuleSets``."""
...
import aws_sdk_gamelift.types.matchmaking_rule_set_list
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_matchmaking_rule_sets_output.DescribeMatchmakingRuleSetsOutput = aws_sdk_gamelift.types.describe_matchmaking_rule_sets_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_matchmaking_rule_sets_input.DescribeMatchmakingRuleSetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_matchmaking_rule_sets_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_matchmaking_rule_sets(
