...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.resolve_alias_output.ResolveAliasOutput = (
        aws_sdk_gamelift.types.resolve_alias_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.resolve_alias_input.ResolveAliasInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.resolve_alias_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def resolve_alias(
    ...
    aws_sdk_gamelift.types.resolve_alias_output.ResolveAliasOutput, zapros.Response
]:
