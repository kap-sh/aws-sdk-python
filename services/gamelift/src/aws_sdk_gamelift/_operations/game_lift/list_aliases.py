"""Generated from Smithy shape ``com.amazonaws.gamelift#ListAliases``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.list_aliases_output.ListAliasesOutput = (
        aws_sdk_gamelift.types.list_aliases_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.list_aliases_input.ListAliasesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.list_aliases_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_aliases(
    ...
    aws_sdk_gamelift.types.list_aliases_output.ListAliasesOutput, zapros.Response
]:
