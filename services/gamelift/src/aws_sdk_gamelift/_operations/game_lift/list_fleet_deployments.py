...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.list_fleet_deployments_output.ListFleetDeploymentsOutput = aws_sdk_gamelift.types.list_fleet_deployments_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.list_fleet_deployments_input.ListFleetDeploymentsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.list_fleet_deployments_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
