...
def build_request(
    ...
    input: aws_sdk_gamelift.types.deregister_compute_input.DeregisterComputeInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.deregister_compute_input.serialize_aws_json_1_1(input)
    ).encode()
