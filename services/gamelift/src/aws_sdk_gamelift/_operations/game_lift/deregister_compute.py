"""Generated from Smithy shape ``com.amazonaws.gamelift#DeregisterCompute``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.deregister_compute_output.DeregisterComputeOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.deregister_compute_input.DeregisterComputeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.DeregisterCompute"
    import aws_sdk_gamelift.types.deregister_compute_input

    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.deregister_compute_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_deregister_compute(
