...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_container_group_definition_output.CreateContainerGroupDefinitionOutput = aws_sdk_gamelift.types.create_container_group_definition_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_container_group_definition_input.CreateContainerGroupDefinitionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_container_group_definition_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
