...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_matchmaking_configurations_output.DescribeMatchmakingConfigurationsOutput = aws_sdk_gamelift.types.describe_matchmaking_configurations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_matchmaking_configurations_input.DescribeMatchmakingConfigurationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_matchmaking_configurations_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
