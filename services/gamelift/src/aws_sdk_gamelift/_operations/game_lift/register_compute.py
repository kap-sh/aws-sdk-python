"""Generated from Smithy shape ``com.amazonaws.gamelift#RegisterCompute``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.register_compute_output.RegisterComputeOutput = (
        aws_sdk_gamelift.types.register_compute_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.register_compute_input.RegisterComputeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.RegisterCompute"
    import aws_sdk_gamelift.types.register_compute_input

    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.register_compute_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_register_compute(
