"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateVpcPeeringAuthorization``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_vpc_peering_authorization_output.CreateVpcPeeringAuthorizationOutput = aws_sdk_gamelift.types.create_vpc_peering_authorization_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_vpc_peering_authorization_input.CreateVpcPeeringAuthorizationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_vpc_peering_authorization_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_vpc_peering_authorization(
