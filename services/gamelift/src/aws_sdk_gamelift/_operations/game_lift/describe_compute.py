...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_compute_output.DescribeComputeOutput = (
        aws_sdk_gamelift.types.describe_compute_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_compute_input.DescribeComputeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_compute_input.serialize_aws_json_1_1(input_)
    ).encode()
