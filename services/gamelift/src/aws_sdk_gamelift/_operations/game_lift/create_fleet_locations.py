"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateFleetLocations``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_fleet_locations_output.CreateFleetLocationsOutput = aws_sdk_gamelift.types.create_fleet_locations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_fleet_locations_input.CreateFleetLocationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.CreateFleetLocations"
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_fleet_locations_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_fleet_locations(
