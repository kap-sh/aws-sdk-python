...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_fleet_output.CreateFleetOutput = (
        aws_sdk_gamelift.types.create_fleet_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_gamelift.types.create_fleet_input.CreateFleetInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_fleet_input.serialize_aws_json_1_1(input)
    ).encode()
...
def create_fleet(
    ...
    aws_sdk_gamelift.types.create_fleet_output.CreateFleetOutput, zapros.Response
]:
