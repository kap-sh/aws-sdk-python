"""Generated from Smithy shape ``com.amazonaws.gamelift#ListGameServers``."""
...
import aws_sdk_gamelift.types.game_servers
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.list_game_servers_output.ListGameServersOutput = (
        aws_sdk_gamelift.types.list_game_servers_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.list_game_servers_input.ListGameServersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.ListGameServers"
    import aws_sdk_gamelift.types.list_game_servers_input

    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.list_game_servers_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_game_servers(
