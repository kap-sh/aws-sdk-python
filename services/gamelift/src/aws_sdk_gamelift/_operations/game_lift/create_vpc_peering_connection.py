"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateVpcPeeringConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_vpc_peering_connection_output.CreateVpcPeeringConnectionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_vpc_peering_connection_input.CreateVpcPeeringConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_vpc_peering_connection_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
