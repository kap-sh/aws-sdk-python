...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.update_game_server_output.UpdateGameServerOutput = (
        aws_sdk_gamelift.types.update_game_server_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.update_game_server_input.UpdateGameServerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.update_game_server_input.serialize_aws_json_1_1(input_)
    ).encode()
