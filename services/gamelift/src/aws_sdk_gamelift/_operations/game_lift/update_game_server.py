...
def build_request(
    ...
    input: aws_sdk_gamelift.types.update_game_server_input.UpdateGameServerInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.update_game_server_input.serialize_aws_json_1_1(input)
    ).encode()
