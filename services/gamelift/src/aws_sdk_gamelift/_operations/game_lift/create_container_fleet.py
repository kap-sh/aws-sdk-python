...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_container_fleet_output.CreateContainerFleetOutput = aws_sdk_gamelift.types.create_container_fleet_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_container_fleet_input.CreateContainerFleetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_container_fleet_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
