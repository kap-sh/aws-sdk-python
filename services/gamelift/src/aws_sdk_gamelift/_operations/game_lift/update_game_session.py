...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.update_game_session_output.UpdateGameSessionOutput = (
        aws_sdk_gamelift.types.update_game_session_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.update_game_session_input.UpdateGameSessionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.update_game_session_input.serialize_aws_json_1_1(input_)
    ).encode()
