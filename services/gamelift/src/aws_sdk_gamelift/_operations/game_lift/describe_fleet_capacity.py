"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeFleetCapacity``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_fleet_capacity_output.DescribeFleetCapacityOutput = aws_sdk_gamelift.types.describe_fleet_capacity_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_fleet_capacity_input.DescribeFleetCapacityInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_fleet_capacity_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_fleet_capacity(
