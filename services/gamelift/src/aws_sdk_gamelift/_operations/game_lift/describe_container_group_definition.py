"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeContainerGroupDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_container_group_definition_output.DescribeContainerGroupDefinitionOutput = aws_sdk_gamelift.types.describe_container_group_definition_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_container_group_definition_input.DescribeContainerGroupDefinitionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.DescribeContainerGroupDefinition"
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_container_group_definition_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_container_group_definition(
