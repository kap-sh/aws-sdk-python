"""Generated from Smithy shape ``com.amazonaws.gamelift#RequestUploadCredentials``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.request_upload_credentials_output.RequestUploadCredentialsOutput = aws_sdk_gamelift.types.request_upload_credentials_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.request_upload_credentials_input.RequestUploadCredentialsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.request_upload_credentials_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_request_upload_credentials(
