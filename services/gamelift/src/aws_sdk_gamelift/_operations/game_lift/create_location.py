"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateLocation``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_location_output.CreateLocationOutput = (
        aws_sdk_gamelift.types.create_location_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_location_input.CreateLocationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.CreateLocation"
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_location_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_location(
    ...
    aws_sdk_gamelift.types.create_location_output.CreateLocationOutput, zapros.Response
]:
