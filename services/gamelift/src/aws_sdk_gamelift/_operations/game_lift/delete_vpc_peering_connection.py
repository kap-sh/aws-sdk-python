"""Generated from Smithy shape ``com.amazonaws.gamelift#DeleteVpcPeeringConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.delete_vpc_peering_connection_output.DeleteVpcPeeringConnectionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.delete_vpc_peering_connection_input.DeleteVpcPeeringConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.delete_vpc_peering_connection_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
