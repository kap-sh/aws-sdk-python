"""Generated from Smithy shape ``com.amazonaws.gamelift#AcceptMatch``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.accept_match_output.AcceptMatchOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.accept_match_input.AcceptMatchInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.accept_match_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def accept_match(
    ...
    aws_sdk_gamelift.types.accept_match_output.AcceptMatchOutput, zapros.Response
]:
