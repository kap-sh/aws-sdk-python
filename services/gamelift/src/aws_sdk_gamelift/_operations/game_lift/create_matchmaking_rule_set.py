...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_matchmaking_rule_set_output.CreateMatchmakingRuleSetOutput = aws_sdk_gamelift.types.create_matchmaking_rule_set_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_matchmaking_rule_set_input.CreateMatchmakingRuleSetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_matchmaking_rule_set_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
