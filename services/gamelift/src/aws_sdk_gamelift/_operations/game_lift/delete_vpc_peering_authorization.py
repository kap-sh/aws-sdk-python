"""Generated from Smithy shape ``com.amazonaws.gamelift#DeleteVpcPeeringAuthorization``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.delete_vpc_peering_authorization_output.DeleteVpcPeeringAuthorizationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.delete_vpc_peering_authorization_input.DeleteVpcPeeringAuthorizationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.delete_vpc_peering_authorization_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_vpc_peering_authorization(
