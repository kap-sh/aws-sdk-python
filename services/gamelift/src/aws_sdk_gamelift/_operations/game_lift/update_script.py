...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.update_script_output.UpdateScriptOutput = (
        aws_sdk_gamelift.types.update_script_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.update_script_input.UpdateScriptInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.update_script_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_script(
    ...
    aws_sdk_gamelift.types.update_script_output.UpdateScriptOutput, zapros.Response
]:
