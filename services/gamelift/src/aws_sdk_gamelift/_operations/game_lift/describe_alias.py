"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeAlias``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_alias_output.DescribeAliasOutput = (
        aws_sdk_gamelift.types.describe_alias_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_alias_input.DescribeAliasInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_alias_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_alias(
    ...
    aws_sdk_gamelift.types.describe_alias_output.DescribeAliasOutput, zapros.Response
]:
...
async def async_describe_alias(
