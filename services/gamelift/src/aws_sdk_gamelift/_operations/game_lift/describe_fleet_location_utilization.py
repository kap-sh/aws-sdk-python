"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeFleetLocationUtilization``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_fleet_location_utilization_output.DescribeFleetLocationUtilizationOutput = aws_sdk_gamelift.types.describe_fleet_location_utilization_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_fleet_location_utilization_input.DescribeFleetLocationUtilizationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.DescribeFleetLocationUtilization"
    import aws_sdk_gamelift.types.describe_fleet_location_utilization_input

    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_fleet_location_utilization_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_fleet_location_utilization(
