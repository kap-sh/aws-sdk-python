...
import aws_sdk_gamelift.types.instance_list
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_instances_output.DescribeInstancesOutput = (
        aws_sdk_gamelift.types.describe_instances_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_instances_input.DescribeInstancesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_instances_input.serialize_aws_json_1_1(input_)
    ).encode()
