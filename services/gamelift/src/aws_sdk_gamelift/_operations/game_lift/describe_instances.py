...
def build_request(
    ...
    input: aws_sdk_gamelift.types.describe_instances_input.DescribeInstancesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_instances_input.serialize_aws_json_1_1(input)
    ).encode()
