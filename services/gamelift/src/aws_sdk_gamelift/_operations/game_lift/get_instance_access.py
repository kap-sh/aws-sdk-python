...
def build_request(
    ...
    input: aws_sdk_gamelift.types.get_instance_access_input.GetInstanceAccessInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.get_instance_access_input.serialize_aws_json_1_1(input)
    ).encode()
