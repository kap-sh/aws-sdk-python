"""Generated from Smithy shape ``com.amazonaws.gamelift#GetInstanceAccess``."""
...
import aws_sdk_gamelift.types.instance_access
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.get_instance_access_output.GetInstanceAccessOutput = (
        aws_sdk_gamelift.types.get_instance_access_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.get_instance_access_input.GetInstanceAccessInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.get_instance_access_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_instance_access(
