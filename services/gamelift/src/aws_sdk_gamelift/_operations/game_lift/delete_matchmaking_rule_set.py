"""Generated from Smithy shape ``com.amazonaws.gamelift#DeleteMatchmakingRuleSet``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.delete_matchmaking_rule_set_output.DeleteMatchmakingRuleSetOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.delete_matchmaking_rule_set_input.DeleteMatchmakingRuleSetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.delete_matchmaking_rule_set_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_matchmaking_rule_set(
