...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.resume_game_server_group_output.ResumeGameServerGroupOutput = aws_sdk_gamelift.types.resume_game_server_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.resume_game_server_group_input.ResumeGameServerGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.resume_game_server_group_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
