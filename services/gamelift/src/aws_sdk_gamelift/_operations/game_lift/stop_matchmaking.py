"""Generated from Smithy shape ``com.amazonaws.gamelift#StopMatchmaking``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.stop_matchmaking_output.StopMatchmakingOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.stop_matchmaking_input.StopMatchmakingInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.stop_matchmaking_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_stop_matchmaking(
