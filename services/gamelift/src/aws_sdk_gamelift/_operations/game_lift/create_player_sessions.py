"""Generated from Smithy shape ``com.amazonaws.gamelift#CreatePlayerSessions``."""
...
import aws_sdk_gamelift.errors.game_session_full_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "GameSessionFullException":
            raise aws_sdk_gamelift.errors.game_session_full_exception.GameSessionFullException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_player_sessions_output.CreatePlayerSessionsOutput = aws_sdk_gamelift.types.create_player_sessions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_player_sessions_input.CreatePlayerSessionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_player_sessions_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_player_sessions(
