...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.get_game_session_log_url_output.GetGameSessionLogUrlOutput = aws_sdk_gamelift.types.get_game_session_log_url_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.get_game_session_log_url_input.GetGameSessionLogUrlInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.get_game_session_log_url_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
