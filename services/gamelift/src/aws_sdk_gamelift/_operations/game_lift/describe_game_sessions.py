"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeGameSessions``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_game_sessions_output.DescribeGameSessionsOutput = aws_sdk_gamelift.types.describe_game_sessions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_game_sessions_input.DescribeGameSessionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_game_sessions_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_game_sessions(
