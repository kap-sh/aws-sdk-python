"""Generated from Smithy shape ``com.amazonaws.gamelift#GetComputeAccess``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.get_compute_access_output.GetComputeAccessOutput = (
        aws_sdk_gamelift.types.get_compute_access_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.get_compute_access_input.GetComputeAccessInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.GetComputeAccess"
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.get_compute_access_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_compute_access(
