"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateAlias``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.update_alias_output.UpdateAliasOutput = (
        aws_sdk_gamelift.types.update_alias_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.update_alias_input.UpdateAliasInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.update_alias_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_alias(
    ...
    aws_sdk_gamelift.types.update_alias_output.UpdateAliasOutput, zapros.Response
]:
