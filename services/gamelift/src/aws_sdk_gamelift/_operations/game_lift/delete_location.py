"""Generated from Smithy shape ``com.amazonaws.gamelift#DeleteLocation``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.delete_location_output.DeleteLocationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.delete_location_input.DeleteLocationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.DeleteLocation"
    import aws_sdk_gamelift.types.delete_location_input

    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.delete_location_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_location(
    ...
    aws_sdk_gamelift.types.delete_location_output.DeleteLocationOutput, zapros.Response
]:
