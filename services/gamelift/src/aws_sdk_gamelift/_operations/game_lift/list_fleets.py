"""Generated from Smithy shape ``com.amazonaws.gamelift#ListFleets``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.list_fleets_output.ListFleetsOutput = (
        aws_sdk_gamelift.types.list_fleets_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.list_fleets_input.ListFleetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.list_fleets_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_fleets(
    ...
    input_: aws_sdk_gamelift.types.list_fleets_input.ListFleetsInput,
) -> tuple[aws_sdk_gamelift.types.list_fleets_output.ListFleetsOutput, zapros.Response]:
