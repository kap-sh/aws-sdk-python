"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeEC2InstanceLimits``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_ec2_instance_limits_output.DescribeEC2InstanceLimitsOutput = aws_sdk_gamelift.types.describe_ec2_instance_limits_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_ec2_instance_limits_input.DescribeEC2InstanceLimitsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_ec2_instance_limits(
