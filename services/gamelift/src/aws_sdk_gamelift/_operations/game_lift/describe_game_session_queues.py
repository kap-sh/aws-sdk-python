...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_game_session_queues_output.DescribeGameSessionQueuesOutput = aws_sdk_gamelift.types.describe_game_session_queues_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_game_session_queues_input.DescribeGameSessionQueuesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_game_session_queues_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
