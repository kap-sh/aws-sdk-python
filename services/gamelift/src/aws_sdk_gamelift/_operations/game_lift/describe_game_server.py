...
def build_request(
    ...
    input: aws_sdk_gamelift.types.describe_game_server_input.DescribeGameServerInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_game_server_input.serialize_aws_json_1_1(input)
    ).encode()
