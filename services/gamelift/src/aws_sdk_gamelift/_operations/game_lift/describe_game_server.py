"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeGameServer``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_game_server_output.DescribeGameServerOutput = (
        aws_sdk_gamelift.types.describe_game_server_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_game_server_input.DescribeGameServerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.DescribeGameServer"
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_game_server_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_game_server(
