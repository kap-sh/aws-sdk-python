"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateGameSessionQueue``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_game_session_queue_output.CreateGameSessionQueueOutput = aws_sdk_gamelift.types.create_game_session_queue_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_game_session_queue_input.CreateGameSessionQueueInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_game_session_queue_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_game_session_queue(
