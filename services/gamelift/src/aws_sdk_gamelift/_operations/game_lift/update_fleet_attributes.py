"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateFleetAttributes``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.update_fleet_attributes_output.UpdateFleetAttributesOutput = aws_sdk_gamelift.types.update_fleet_attributes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.update_fleet_attributes_input.UpdateFleetAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.update_fleet_attributes_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_fleet_attributes(
