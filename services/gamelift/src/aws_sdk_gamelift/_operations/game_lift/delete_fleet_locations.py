...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.delete_fleet_locations_output.DeleteFleetLocationsOutput = aws_sdk_gamelift.types.delete_fleet_locations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.delete_fleet_locations_input.DeleteFleetLocationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.delete_fleet_locations_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
