"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeGameServerGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_game_server_group_output.DescribeGameServerGroupOutput = aws_sdk_gamelift.types.describe_game_server_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_game_server_group_input.DescribeGameServerGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.DescribeGameServerGroup"
    import aws_sdk_gamelift.types.describe_game_server_group_input

    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_game_server_group_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_game_server_group(
