"""Generated from Smithy shape ``com.amazonaws.gamelift#ValidateMatchmakingRuleSet``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.validate_matchmaking_rule_set_output.ValidateMatchmakingRuleSetOutput = aws_sdk_gamelift.types.validate_matchmaking_rule_set_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.validate_matchmaking_rule_set_input.ValidateMatchmakingRuleSetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.validate_matchmaking_rule_set_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_validate_matchmaking_rule_set(
