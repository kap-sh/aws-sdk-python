"""Generated from Smithy shape ``com.amazonaws.gamelift#DeleteContainerGroupDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.delete_container_group_definition_output.DeleteContainerGroupDefinitionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.delete_container_group_definition_input.DeleteContainerGroupDefinitionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.DeleteContainerGroupDefinition"
    import aws_sdk_gamelift.types.delete_container_group_definition_input

    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.delete_container_group_definition_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_container_group_definition(
