...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_player_session_input.CreatePlayerSessionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_player_session_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
