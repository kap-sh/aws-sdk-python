...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_player_session_output.CreatePlayerSessionOutput = aws_sdk_gamelift.types.create_player_session_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_gamelift.types.create_player_session_input.CreatePlayerSessionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_player_session_input.serialize_aws_json_1_1(input)
    ).encode()
