"""Generated from Smithy shape ``com.amazonaws.gamelift#DeleteScalingPolicy``."""
...
def build_request(
    ...
    input: aws_sdk_gamelift.types.delete_scaling_policy_input.DeleteScalingPolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.delete_scaling_policy_input.serialize_aws_json_1_1(input)
    ).encode()
