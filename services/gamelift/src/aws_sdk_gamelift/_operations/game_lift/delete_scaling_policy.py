...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.delete_scaling_policy_input.DeleteScalingPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.delete_scaling_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
