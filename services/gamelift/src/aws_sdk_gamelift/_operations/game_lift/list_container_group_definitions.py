...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.list_container_group_definitions_output.ListContainerGroupDefinitionsOutput = aws_sdk_gamelift.types.list_container_group_definitions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.list_container_group_definitions_input.ListContainerGroupDefinitionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.list_container_group_definitions_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
