...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.update_fleet_capacity_output.UpdateFleetCapacityOutput = aws_sdk_gamelift.types.update_fleet_capacity_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_gamelift.types.update_fleet_capacity_input.UpdateFleetCapacityInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.update_fleet_capacity_input.serialize_aws_json_1_1(input)
    ).encode()
