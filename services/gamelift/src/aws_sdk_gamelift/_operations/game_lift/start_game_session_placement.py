"""Generated from Smithy shape ``com.amazonaws.gamelift#StartGameSessionPlacement``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.start_game_session_placement_output.StartGameSessionPlacementOutput = aws_sdk_gamelift.types.start_game_session_placement_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.start_game_session_placement_input.StartGameSessionPlacementInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.start_game_session_placement_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_game_session_placement(
