...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.delete_game_session_queue_output.DeleteGameSessionQueueOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.delete_game_session_queue_input.DeleteGameSessionQueueInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.delete_game_session_queue_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
