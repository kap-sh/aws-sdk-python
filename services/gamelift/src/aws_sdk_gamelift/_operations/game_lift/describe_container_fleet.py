"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeContainerFleet``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_container_fleet_output.DescribeContainerFleetOutput = aws_sdk_gamelift.types.describe_container_fleet_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_container_fleet_input.DescribeContainerFleetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.DescribeContainerFleet"
    import aws_sdk_gamelift.types.describe_container_fleet_input

    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_container_fleet_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_container_fleet(
