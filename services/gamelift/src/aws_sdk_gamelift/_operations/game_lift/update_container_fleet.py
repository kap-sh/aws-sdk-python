"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateContainerFleet``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.update_container_fleet_output.UpdateContainerFleetOutput = aws_sdk_gamelift.types.update_container_fleet_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.update_container_fleet_input.UpdateContainerFleetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.UpdateContainerFleet"
    import aws_sdk_gamelift.types.update_container_fleet_input

    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.update_container_fleet_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_container_fleet(
