...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_game_server_group_output.CreateGameServerGroupOutput = aws_sdk_gamelift.types.create_game_server_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_game_server_group_input.CreateGameServerGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_game_server_group_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
