...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.list_builds_output.ListBuildsOutput = (
        aws_sdk_gamelift.types.list_builds_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.list_builds_input.ListBuildsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.list_builds_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_builds(
    ...
    input_: aws_sdk_gamelift.types.list_builds_input.ListBuildsInput,
) -> tuple[aws_sdk_gamelift.types.list_builds_output.ListBuildsOutput, zapros.Response]:
