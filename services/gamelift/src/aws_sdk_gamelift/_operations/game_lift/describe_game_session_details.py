...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_game_session_details_output.DescribeGameSessionDetailsOutput = aws_sdk_gamelift.types.describe_game_session_details_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_game_session_details_input.DescribeGameSessionDetailsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_game_session_details_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
