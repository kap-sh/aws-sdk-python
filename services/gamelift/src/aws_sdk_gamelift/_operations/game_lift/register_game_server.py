...
def build_request(
    ...
    input: aws_sdk_gamelift.types.register_game_server_input.RegisterGameServerInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.register_game_server_input.serialize_aws_json_1_1(input)
    ).encode()
