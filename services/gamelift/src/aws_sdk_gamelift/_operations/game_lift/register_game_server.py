...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.register_game_server_output.RegisterGameServerOutput = (
        aws_sdk_gamelift.types.register_game_server_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.register_game_server_input.RegisterGameServerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.register_game_server_input.serialize_aws_json_1_1(input_)
    ).encode()
