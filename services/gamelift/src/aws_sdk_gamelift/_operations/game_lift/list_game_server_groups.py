...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.list_game_server_groups_output.ListGameServerGroupsOutput = aws_sdk_gamelift.types.list_game_server_groups_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.list_game_server_groups_input.ListGameServerGroupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.list_game_server_groups_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
