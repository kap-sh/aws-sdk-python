...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.get_player_connection_details_output.GetPlayerConnectionDetailsOutput = aws_sdk_gamelift.types.get_player_connection_details_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.get_player_connection_details_input.GetPlayerConnectionDetailsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
