"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateScript``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.create_script_output.CreateScriptOutput = (
        aws_sdk_gamelift.types.create_script_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.create_script_input.CreateScriptInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.create_script_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_script(
    ...
    aws_sdk_gamelift.types.create_script_output.CreateScriptOutput, zapros.Response
]:
