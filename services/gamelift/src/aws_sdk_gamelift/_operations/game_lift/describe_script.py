"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeScript``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_script_output.DescribeScriptOutput = (
        aws_sdk_gamelift.types.describe_script_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.describe_script_input.DescribeScriptInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_script_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_script(
    ...
    aws_sdk_gamelift.types.describe_script_output.DescribeScriptOutput, zapros.Response
]:
...
async def async_describe_script(
