...
def build_request(
    ...
    input: aws_sdk_gamelift.types.put_scaling_policy_input.PutScalingPolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.put_scaling_policy_input.serialize_aws_json_1_1(input)
    ).encode()
