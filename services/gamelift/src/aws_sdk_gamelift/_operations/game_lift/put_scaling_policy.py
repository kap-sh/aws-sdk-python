"""Generated from Smithy shape ``com.amazonaws.gamelift#PutScalingPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.put_scaling_policy_output.PutScalingPolicyOutput = (
        aws_sdk_gamelift.types.put_scaling_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.put_scaling_policy_input.PutScalingPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.put_scaling_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
