...
def build_request(
    ...
    input: aws_sdk_gamelift.types.describe_matchmaking_input.DescribeMatchmakingInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_matchmaking_input.serialize_aws_json_1_1(input)
    ).encode()
