...
def build_request(
    ...
    input: aws_sdk_gamelift.types.start_fleet_actions_input.StartFleetActionsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.start_fleet_actions_input.serialize_aws_json_1_1(input)
    ).encode()
