"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeFleetEvents``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.describe_fleet_events_output.DescribeFleetEventsOutput = aws_sdk_gamelift.types.describe_fleet_events_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_gamelift.types.describe_fleet_events_input.DescribeFleetEventsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.describe_fleet_events_input.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_describe_fleet_events(
