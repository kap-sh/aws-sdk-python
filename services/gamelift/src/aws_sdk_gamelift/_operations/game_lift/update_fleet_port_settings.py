"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateFleetPortSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.update_fleet_port_settings_output.UpdateFleetPortSettingsOutput = aws_sdk_gamelift.types.update_fleet_port_settings_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.update_fleet_port_settings_input.UpdateFleetPortSettingsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.update_fleet_port_settings_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_fleet_port_settings(
