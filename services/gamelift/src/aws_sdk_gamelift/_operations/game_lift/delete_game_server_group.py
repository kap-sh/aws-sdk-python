"""Generated from Smithy shape ``com.amazonaws.gamelift#DeleteGameServerGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_gamelift.types.delete_game_server_group_output.DeleteGameServerGroupOutput = aws_sdk_gamelift.types.delete_game_server_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_gamelift.types.delete_game_server_group_input.DeleteGameServerGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "GameLift.DeleteGameServerGroup"
    import aws_sdk_gamelift.types.delete_game_server_group_input

    body: bytes | None = json.dumps(
        aws_sdk_gamelift.types.delete_game_server_group_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_game_server_group(
