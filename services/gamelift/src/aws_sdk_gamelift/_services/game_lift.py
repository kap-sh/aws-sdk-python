...
from aws_sdk_gamelift._auth._zapros_handler import AuthMiddleware
from aws_sdk_gamelift._pagination import resolve_path as _resolve_path
from aws_sdk_gamelift._services._pipeline import (
    Interceptor,
    OperationOptions,
    OperationRequest,
    OperationResponse,
...
if TYPE_CHECKING:
    import aws_sdk_gamelift.types.accept_match_input
    import aws_sdk_gamelift.types.accept_match_output
    ...
    import aws_sdk_gamelift.types.claim_filter_option
    import aws_sdk_gamelift.types.claim_game_server_input
    import aws_sdk_gamelift.types.claim_game_server_output
    ...
    import aws_sdk_gamelift.types.create_alias_input
    import aws_sdk_gamelift.types.create_alias_output
    import aws_sdk_gamelift.types.create_build_input
    import aws_sdk_gamelift.types.create_build_output
    import aws_sdk_gamelift.types.create_container_fleet_input
    import aws_sdk_gamelift.types.create_container_fleet_output
    import aws_sdk_gamelift.types.create_container_group_definition_input
    import aws_sdk_gamelift.types.create_container_group_definition_output
    import aws_sdk_gamelift.types.create_fleet_input
    import aws_sdk_gamelift.types.create_fleet_locations_input
    import aws_sdk_gamelift.types.create_fleet_locations_output
    import aws_sdk_gamelift.types.create_fleet_output
    import aws_sdk_gamelift.types.create_game_server_group_input
    import aws_sdk_gamelift.types.create_game_server_group_output
    import aws_sdk_gamelift.types.create_game_session_input
    import aws_sdk_gamelift.types.create_game_session_output
    import aws_sdk_gamelift.types.create_game_session_queue_input
    import aws_sdk_gamelift.types.create_game_session_queue_output
    import aws_sdk_gamelift.types.create_location_input
    import aws_sdk_gamelift.types.create_location_output
    import aws_sdk_gamelift.types.create_matchmaking_configuration_input
    import aws_sdk_gamelift.types.create_matchmaking_configuration_output
    import aws_sdk_gamelift.types.create_matchmaking_rule_set_input
    import aws_sdk_gamelift.types.create_matchmaking_rule_set_output
    import aws_sdk_gamelift.types.create_player_session_input
    import aws_sdk_gamelift.types.create_player_session_output
    import aws_sdk_gamelift.types.create_player_sessions_input
    import aws_sdk_gamelift.types.create_player_sessions_output
    import aws_sdk_gamelift.types.create_script_input
    import aws_sdk_gamelift.types.create_script_output
    import aws_sdk_gamelift.types.create_vpc_peering_authorization_input
    import aws_sdk_gamelift.types.create_vpc_peering_authorization_output
    import aws_sdk_gamelift.types.create_vpc_peering_connection_input
    import aws_sdk_gamelift.types.create_vpc_peering_connection_output
    ...
    import aws_sdk_gamelift.types.delete_alias_input
    import aws_sdk_gamelift.types.delete_build_input
    import aws_sdk_gamelift.types.delete_container_fleet_input
    import aws_sdk_gamelift.types.delete_container_fleet_output
    import aws_sdk_gamelift.types.delete_container_group_definition_input
    import aws_sdk_gamelift.types.delete_container_group_definition_output
    import aws_sdk_gamelift.types.delete_fleet_input
    import aws_sdk_gamelift.types.delete_fleet_locations_input
    import aws_sdk_gamelift.types.delete_fleet_locations_output
    import aws_sdk_gamelift.types.delete_game_server_group_input
    import aws_sdk_gamelift.types.delete_game_server_group_output
    import aws_sdk_gamelift.types.delete_game_session_queue_input
    import aws_sdk_gamelift.types.delete_game_session_queue_output
    import aws_sdk_gamelift.types.delete_location_input
    import aws_sdk_gamelift.types.delete_location_output
    import aws_sdk_gamelift.types.delete_matchmaking_configuration_input
    import aws_sdk_gamelift.types.delete_matchmaking_configuration_output
    import aws_sdk_gamelift.types.delete_matchmaking_rule_set_input
    import aws_sdk_gamelift.types.delete_matchmaking_rule_set_output
    import aws_sdk_gamelift.types.delete_scaling_policy_input
    import aws_sdk_gamelift.types.delete_script_input
    import aws_sdk_gamelift.types.delete_vpc_peering_authorization_input
    import aws_sdk_gamelift.types.delete_vpc_peering_authorization_output
    import aws_sdk_gamelift.types.delete_vpc_peering_connection_input
    import aws_sdk_gamelift.types.delete_vpc_peering_connection_output
    import aws_sdk_gamelift.types.deployment_configuration
    import aws_sdk_gamelift.types.deployment_id
    import aws_sdk_gamelift.types.deregister_compute_input
    import aws_sdk_gamelift.types.deregister_compute_output
    import aws_sdk_gamelift.types.deregister_game_server_input
    import aws_sdk_gamelift.types.describe_alias_input
    import aws_sdk_gamelift.types.describe_alias_output
    import aws_sdk_gamelift.types.describe_build_input
    import aws_sdk_gamelift.types.describe_build_output
    import aws_sdk_gamelift.types.describe_compute_input
    import aws_sdk_gamelift.types.describe_compute_output
    import aws_sdk_gamelift.types.describe_container_fleet_input
    import aws_sdk_gamelift.types.describe_container_fleet_output
    import aws_sdk_gamelift.types.describe_container_group_definition_input
    import aws_sdk_gamelift.types.describe_container_group_definition_output
    import aws_sdk_gamelift.types.describe_container_group_port_mappings_input
    import aws_sdk_gamelift.types.describe_container_group_port_mappings_output
    import aws_sdk_gamelift.types.describe_ec2_instance_limits_input
    import aws_sdk_gamelift.types.describe_ec2_instance_limits_output
    import aws_sdk_gamelift.types.describe_fleet_attributes_input
    import aws_sdk_gamelift.types.describe_fleet_attributes_output
    import aws_sdk_gamelift.types.describe_fleet_capacity_input
    import aws_sdk_gamelift.types.describe_fleet_capacity_output
    import aws_sdk_gamelift.types.describe_fleet_deployment_input
    import aws_sdk_gamelift.types.describe_fleet_deployment_output
    import aws_sdk_gamelift.types.describe_fleet_events_input
    import aws_sdk_gamelift.types.describe_fleet_events_output
    import aws_sdk_gamelift.types.describe_fleet_location_attributes_input
    import aws_sdk_gamelift.types.describe_fleet_location_attributes_output
    import aws_sdk_gamelift.types.describe_fleet_location_capacity_input
    import aws_sdk_gamelift.types.describe_fleet_location_capacity_output
    import aws_sdk_gamelift.types.describe_fleet_location_utilization_input
    import aws_sdk_gamelift.types.describe_fleet_location_utilization_output
    import aws_sdk_gamelift.types.describe_fleet_port_settings_input
    import aws_sdk_gamelift.types.describe_fleet_port_settings_output
    import aws_sdk_gamelift.types.describe_fleet_utilization_input
    import aws_sdk_gamelift.types.describe_fleet_utilization_output
    import aws_sdk_gamelift.types.describe_game_server_group_input
    import aws_sdk_gamelift.types.describe_game_server_group_output
    import aws_sdk_gamelift.types.describe_game_server_input
    import aws_sdk_gamelift.types.describe_game_server_instances_input
    import aws_sdk_gamelift.types.describe_game_server_instances_output
    import aws_sdk_gamelift.types.describe_game_server_output
    import aws_sdk_gamelift.types.describe_game_session_details_input
    import aws_sdk_gamelift.types.describe_game_session_details_output
    import aws_sdk_gamelift.types.describe_game_session_placement_input
    import aws_sdk_gamelift.types.describe_game_session_placement_output
    import aws_sdk_gamelift.types.describe_game_session_queues_input
    import aws_sdk_gamelift.types.describe_game_session_queues_output
    import aws_sdk_gamelift.types.describe_game_sessions_input
    import aws_sdk_gamelift.types.describe_game_sessions_output
    import aws_sdk_gamelift.types.describe_instances_input
    import aws_sdk_gamelift.types.describe_instances_output
    import aws_sdk_gamelift.types.describe_matchmaking_configurations_input
    import aws_sdk_gamelift.types.describe_matchmaking_configurations_output
    import aws_sdk_gamelift.types.describe_matchmaking_input
    import aws_sdk_gamelift.types.describe_matchmaking_output
    import aws_sdk_gamelift.types.describe_matchmaking_rule_sets_input
    import aws_sdk_gamelift.types.describe_matchmaking_rule_sets_output
    import aws_sdk_gamelift.types.describe_player_sessions_input
    import aws_sdk_gamelift.types.describe_player_sessions_output
    import aws_sdk_gamelift.types.describe_runtime_configuration_input
    import aws_sdk_gamelift.types.describe_runtime_configuration_output
    import aws_sdk_gamelift.types.describe_scaling_policies_input
    import aws_sdk_gamelift.types.describe_scaling_policies_output
    import aws_sdk_gamelift.types.describe_script_input
    import aws_sdk_gamelift.types.describe_script_output
    import aws_sdk_gamelift.types.describe_vpc_peering_authorizations_input
    import aws_sdk_gamelift.types.describe_vpc_peering_authorizations_output
    import aws_sdk_gamelift.types.describe_vpc_peering_connections_input
    import aws_sdk_gamelift.types.describe_vpc_peering_connections_output
    ...
    import aws_sdk_gamelift.types.game_server_group_auto_scaling_policy
    ...
    import aws_sdk_gamelift.types.game_session_queue_name_or_arn_list
    import aws_sdk_gamelift.types.get_compute_access_input
    import aws_sdk_gamelift.types.get_compute_access_output
    import aws_sdk_gamelift.types.get_compute_auth_token_input
    import aws_sdk_gamelift.types.get_compute_auth_token_output
    import aws_sdk_gamelift.types.get_game_session_log_url_input
    import aws_sdk_gamelift.types.get_game_session_log_url_output
    import aws_sdk_gamelift.types.get_instance_access_input
    import aws_sdk_gamelift.types.get_instance_access_output
    import aws_sdk_gamelift.types.get_player_connection_details_input
    import aws_sdk_gamelift.types.get_player_connection_details_output
    import aws_sdk_gamelift.types.iam_role_arn
    import aws_sdk_gamelift.types.id_string_model
    import aws_sdk_gamelift.types.instance
    ...
    import aws_sdk_gamelift.types.launch_template_specification
    import aws_sdk_gamelift.types.list_aliases_input
    import aws_sdk_gamelift.types.list_aliases_output
    import aws_sdk_gamelift.types.list_builds_input
    import aws_sdk_gamelift.types.list_builds_output
    import aws_sdk_gamelift.types.list_compute_input
    import aws_sdk_gamelift.types.list_compute_input_status
    import aws_sdk_gamelift.types.list_compute_output
    import aws_sdk_gamelift.types.list_container_fleets_input
    import aws_sdk_gamelift.types.list_container_fleets_output
    import aws_sdk_gamelift.types.list_container_group_definition_versions_input
    import aws_sdk_gamelift.types.list_container_group_definition_versions_limit
    import aws_sdk_gamelift.types.list_container_group_definition_versions_output
    import aws_sdk_gamelift.types.list_container_group_definitions_input
    import aws_sdk_gamelift.types.list_container_group_definitions_limit
    import aws_sdk_gamelift.types.list_container_group_definitions_output
    import aws_sdk_gamelift.types.list_fleet_deployments_input
    import aws_sdk_gamelift.types.list_fleet_deployments_output
    import aws_sdk_gamelift.types.list_fleets_input
    import aws_sdk_gamelift.types.list_fleets_output
    import aws_sdk_gamelift.types.list_game_server_groups_input
    import aws_sdk_gamelift.types.list_game_server_groups_output
    import aws_sdk_gamelift.types.list_game_servers_input
    import aws_sdk_gamelift.types.list_game_servers_output
    import aws_sdk_gamelift.types.list_locations_input
    import aws_sdk_gamelift.types.list_locations_limit
    import aws_sdk_gamelift.types.list_locations_output
    import aws_sdk_gamelift.types.list_scripts_input
    import aws_sdk_gamelift.types.list_scripts_output
    import aws_sdk_gamelift.types.list_tags_for_resource_request
    import aws_sdk_gamelift.types.list_tags_for_resource_response
    ...
    import aws_sdk_gamelift.types.put_scaling_policy_input
    import aws_sdk_gamelift.types.put_scaling_policy_output
    ...
    import aws_sdk_gamelift.types.register_compute_input
    import aws_sdk_gamelift.types.register_compute_output
    import aws_sdk_gamelift.types.register_game_server_input
    import aws_sdk_gamelift.types.register_game_server_output
    import aws_sdk_gamelift.types.request_upload_credentials_input
    import aws_sdk_gamelift.types.request_upload_credentials_output
    import aws_sdk_gamelift.types.resolve_alias_input
    import aws_sdk_gamelift.types.resolve_alias_output
    import aws_sdk_gamelift.types.resource_creation_limit_policy
    import aws_sdk_gamelift.types.resume_game_server_group_input
    import aws_sdk_gamelift.types.resume_game_server_group_output
    ...
    import aws_sdk_gamelift.types.search_game_sessions_input
    import aws_sdk_gamelift.types.search_game_sessions_output
    import aws_sdk_gamelift.types.server_sdk_version
    import aws_sdk_gamelift.types.sns_arn_string_model
    import aws_sdk_gamelift.types.sort_order
    import aws_sdk_gamelift.types.start_fleet_actions_input
    import aws_sdk_gamelift.types.start_fleet_actions_output
    import aws_sdk_gamelift.types.start_game_session_placement_input
    import aws_sdk_gamelift.types.start_game_session_placement_output
    import aws_sdk_gamelift.types.start_match_backfill_input
    import aws_sdk_gamelift.types.start_match_backfill_output
    import aws_sdk_gamelift.types.start_matchmaking_input
    import aws_sdk_gamelift.types.start_matchmaking_output
    import aws_sdk_gamelift.types.stop_fleet_actions_input
    import aws_sdk_gamelift.types.stop_fleet_actions_output
    import aws_sdk_gamelift.types.stop_game_session_placement_input
    import aws_sdk_gamelift.types.stop_game_session_placement_output
    import aws_sdk_gamelift.types.stop_matchmaking_input
    import aws_sdk_gamelift.types.stop_matchmaking_output
    import aws_sdk_gamelift.types.string_list
    import aws_sdk_gamelift.types.support_container_definition_input_list
    import aws_sdk_gamelift.types.suspend_game_server_group_input
    import aws_sdk_gamelift.types.suspend_game_server_group_output
    import aws_sdk_gamelift.types.tag_key_list
    import aws_sdk_gamelift.types.tag_list
    import aws_sdk_gamelift.types.tag_resource_request
    import aws_sdk_gamelift.types.tag_resource_response
    import aws_sdk_gamelift.types.target_configuration
    import aws_sdk_gamelift.types.terminate_game_session_input
    import aws_sdk_gamelift.types.terminate_game_session_output
    import aws_sdk_gamelift.types.termination_mode
    import aws_sdk_gamelift.types.timestamp
    import aws_sdk_gamelift.types.untag_resource_request
    import aws_sdk_gamelift.types.untag_resource_response
    import aws_sdk_gamelift.types.update_alias_input
    import aws_sdk_gamelift.types.update_alias_output
    import aws_sdk_gamelift.types.update_build_input
    import aws_sdk_gamelift.types.update_build_output
    import aws_sdk_gamelift.types.update_container_fleet_input
    import aws_sdk_gamelift.types.update_container_fleet_output
    import aws_sdk_gamelift.types.update_container_group_definition_input
    import aws_sdk_gamelift.types.update_container_group_definition_output
    import aws_sdk_gamelift.types.update_fleet_attributes_input
    import aws_sdk_gamelift.types.update_fleet_attributes_output
    import aws_sdk_gamelift.types.update_fleet_capacity_input
    import aws_sdk_gamelift.types.update_fleet_capacity_output
    import aws_sdk_gamelift.types.update_fleet_port_settings_input
    import aws_sdk_gamelift.types.update_fleet_port_settings_output
    import aws_sdk_gamelift.types.update_game_server_group_input
    import aws_sdk_gamelift.types.update_game_server_group_output
    import aws_sdk_gamelift.types.update_game_server_input
    import aws_sdk_gamelift.types.update_game_server_output
    import aws_sdk_gamelift.types.update_game_session_input
    import aws_sdk_gamelift.types.update_game_session_output
    import aws_sdk_gamelift.types.update_game_session_queue_input
    import aws_sdk_gamelift.types.update_game_session_queue_output
    import aws_sdk_gamelift.types.update_matchmaking_configuration_input
    import aws_sdk_gamelift.types.update_matchmaking_configuration_output
    import aws_sdk_gamelift.types.update_runtime_configuration_input
    import aws_sdk_gamelift.types.update_runtime_configuration_output
    import aws_sdk_gamelift.types.update_script_input
    import aws_sdk_gamelift.types.update_script_output
    import aws_sdk_gamelift.types.validate_matchmaking_rule_set_input
    import aws_sdk_gamelift.types.validate_matchmaking_rule_set_output
    import aws_sdk_gamelift.types.vpc_subnets
    import aws_sdk_gamelift.types.whole_number
    import aws_sdk_gamelift.types.zip_blob


class GameLiftClientConfig(TypedDict, total=False):
...
class GameLiftClient:
    ...
    def __init__(
        ...
        self.config = GameLiftClientConfig(
            {
    ...
    def operation_options(
        ...
        overrides: GameLiftClientConfig = config_overrides or {}
    ...
    def accept_match(
        self,
        ticket_id: "aws_sdk_gamelift.types.matchmaking_id_string_model.MatchmakingIdStringModel",
        player_ids: "aws_sdk_gamelift.types.player_ids_for_accept_match.PlayerIdsForAcceptMatch",
        acceptance_type: "aws_sdk_gamelift.types.acceptance_type.AcceptanceType",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.accept_match_output.AcceptMatchOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.accept_match_input.AcceptMatchInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.accept_match_output.AcceptMatchOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.accept_match

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.accept_match.accept_match(
    ...
    def claim_game_server(
        self,
        game_server_group_name: "aws_sdk_gamelift.types.game_server_group_name_or_arn.GameServerGroupNameOrArn",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        game_server_id: Optional[
            "aws_sdk_gamelift.types.game_server_id.GameServerId"
        ] = None,
        game_server_data: Optional[
            "aws_sdk_gamelift.types.game_server_data.GameServerData"
        ] = None,
        filter_option: Optional[
            "aws_sdk_gamelift.types.claim_filter_option.ClaimFilterOption"
        ] = None,
    ) -> "aws_sdk_gamelift.types.claim_game_server_output.ClaimGameServerOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.claim_game_server_input.ClaimGameServerInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.claim_game_server_output.ClaimGameServerOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.claim_game_server

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.claim_game_server.claim_game_server(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_alias(
        self,
        name: "aws_sdk_gamelift.types.non_blank_and_length_constraint_string.NonBlankAndLengthConstraintString",
        routing_strategy: "aws_sdk_gamelift.types.routing_strategy.RoutingStrategy",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        description: Optional[
            "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString"
        ] = None,
        tags: Optional["aws_sdk_gamelift.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_gamelift.types.create_alias_output.CreateAliasOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_alias_input.CreateAliasInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_alias_output.CreateAliasOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_alias

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_alias.create_alias(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_build(
        ...
        *,
        ...
        storage_location: Optional[
            "aws_sdk_gamelift.types.s3_location.S3Location"
        ] = None,
    ...
    ) -> "aws_sdk_gamelift.types.create_build_output.CreateBuildOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_build_input.CreateBuildInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_build_output.CreateBuildOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_build

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_build.create_build(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_container_fleet(
        self,
        fleet_role_arn: "aws_sdk_gamelift.types.iam_role_arn.IamRoleArn",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        description: Optional[
            "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString"
    ...
    ) -> "aws_sdk_gamelift.types.create_container_fleet_output.CreateContainerFleetOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_container_fleet_input.CreateContainerFleetInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_container_fleet_output.CreateContainerFleetOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_container_fleet

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_container_fleet.create_container_fleet(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_container_group_definition(
        self,
        name: "aws_sdk_gamelift.types.container_group_definition_name.ContainerGroupDefinitionName",
        total_memory_limit_mebibytes: "aws_sdk_gamelift.types.container_total_memory_limit.ContainerTotalMemoryLimit",
        total_vcpu_limit: "aws_sdk_gamelift.types.container_total_vcpu_limit.ContainerTotalVcpuLimit",
        operating_system: "aws_sdk_gamelift.types.container_operating_system.ContainerOperatingSystem",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        ...
        tags: Optional["aws_sdk_gamelift.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_gamelift.types.create_container_group_definition_output.CreateContainerGroupDefinitionOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_container_group_definition_input.CreateContainerGroupDefinitionInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_container_group_definition_output.CreateContainerGroupDefinitionOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_container_group_definition

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_container_group_definition.create_container_group_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_fleet(
        self,
        name: "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        description: Optional[
            "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString"
        ...
        build_id: Optional[
            "aws_sdk_gamelift.types.build_id_or_arn.BuildIdOrArn"
        ] = None,
        script_id: Optional[
            "aws_sdk_gamelift.types.script_id_or_arn.ScriptIdOrArn"
        ] = None,
        ...
        log_paths: Optional["aws_sdk_gamelift.types.string_list.StringList"] = None,
        ...
        fleet_type: Optional["aws_sdk_gamelift.types.fleet_type.FleetType"] = None,
        ...
        compute_type: Optional[
            "aws_sdk_gamelift.types.compute_type.ComputeType"
        ] = None,
    ...
    ) -> "aws_sdk_gamelift.types.create_fleet_output.CreateFleetOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_fleet_input.CreateFleetInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_fleet_output.CreateFleetOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_fleet

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_fleet.create_fleet(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_fleet_locations(
        self,
        fleet_id: "aws_sdk_gamelift.types.fleet_id_or_arn.FleetIdOrArn",
        locations: "aws_sdk_gamelift.types.location_configuration_list.LocationConfigurationList",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.create_fleet_locations_output.CreateFleetLocationsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_fleet_locations_input.CreateFleetLocationsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_fleet_locations_output.CreateFleetLocationsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_fleet_locations

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_fleet_locations.create_fleet_locations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_game_server_group(
        self,
        game_server_group_name: "aws_sdk_gamelift.types.game_server_group_name.GameServerGroupName",
        role_arn: "aws_sdk_gamelift.types.iam_role_arn.IamRoleArn",
        min_size: "aws_sdk_gamelift.types.whole_number.WholeNumber",
        max_size: "aws_sdk_gamelift.types.positive_integer.PositiveInteger",
        launch_template: "aws_sdk_gamelift.types.launch_template_specification.LaunchTemplateSpecification",
        instance_definitions: "aws_sdk_gamelift.types.instance_definitions.InstanceDefinitions",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        auto_scaling_policy: Optional[
            "aws_sdk_gamelift.types.game_server_group_auto_scaling_policy.GameServerGroupAutoScalingPolicy"
        ] = None,
        ...
        vpc_subnets: Optional["aws_sdk_gamelift.types.vpc_subnets.VpcSubnets"] = None,
        tags: Optional["aws_sdk_gamelift.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_gamelift.types.create_game_server_group_output.CreateGameServerGroupOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_game_server_group_input.CreateGameServerGroupInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_game_server_group_output.CreateGameServerGroupOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_game_server_group

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_game_server_group.create_game_server_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_game_session(
        self,
        maximum_player_session_count: "aws_sdk_gamelift.types.whole_number.WholeNumber",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        fleet_id: Optional[
            "aws_sdk_gamelift.types.fleet_id_or_arn.FleetIdOrArn"
        ] = None,
        alias_id: Optional[
            "aws_sdk_gamelift.types.alias_id_or_arn.AliasIdOrArn"
        ] = None,
        name: Optional[
            "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_game_session_input.CreateGameSessionInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_game_session_output.CreateGameSessionOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_game_session

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_game_session.create_game_session(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_game_session_queue(
        self,
        name: "aws_sdk_gamelift.types.game_session_queue_name.GameSessionQueueName",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        ...
        tags: Optional["aws_sdk_gamelift.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_gamelift.types.create_game_session_queue_output.CreateGameSessionQueueOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_game_session_queue_input.CreateGameSessionQueueInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_game_session_queue_output.CreateGameSessionQueueOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_game_session_queue

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_game_session_queue.create_game_session_queue(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_location(
        self,
        location_name: "aws_sdk_gamelift.types.custom_input_location_string_model.CustomInputLocationStringModel",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        tags: Optional["aws_sdk_gamelift.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_gamelift.types.create_location_output.CreateLocationOutput":
        """<p> <b>This API works with the following fleet types:</b> Anywhere</p> <p>Creates a custom location for use in an Anywhere fleet.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_location_input.CreateLocationInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_location_output.CreateLocationOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_location

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_location.create_location(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_matchmaking_configuration(
        self,
        name: "aws_sdk_gamelift.types.matchmaking_id_string_model.MatchmakingIdStringModel",
        request_timeout_seconds: "aws_sdk_gamelift.types.matchmaking_request_timeout_integer.MatchmakingRequestTimeoutInteger",
        acceptance_required: "aws_sdk_gamelift.types.boolean_model.BooleanModel",
        rule_set_name: "aws_sdk_gamelift.types.matchmaking_rule_set_name.MatchmakingRuleSetName",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        description: Optional[
            "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString"
        ...
        backfill_mode: Optional[
            "aws_sdk_gamelift.types.backfill_mode.BackfillMode"
        ] = None,
        flex_match_mode: Optional[
            "aws_sdk_gamelift.types.flex_match_mode.FlexMatchMode"
        ] = None,
        tags: Optional["aws_sdk_gamelift.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_gamelift.types.create_matchmaking_configuration_output.CreateMatchmakingConfigurationOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_matchmaking_configuration_input.CreateMatchmakingConfigurationInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_matchmaking_configuration_output.CreateMatchmakingConfigurationOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_matchmaking_configuration

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_matchmaking_configuration.create_matchmaking_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_matchmaking_rule_set(
        self,
        name: "aws_sdk_gamelift.types.matchmaking_id_string_model.MatchmakingIdStringModel",
        rule_set_body: "aws_sdk_gamelift.types.rule_set_body.RuleSetBody",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        tags: Optional["aws_sdk_gamelift.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_gamelift.types.create_matchmaking_rule_set_output.CreateMatchmakingRuleSetOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_matchmaking_rule_set_input.CreateMatchmakingRuleSetInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_matchmaking_rule_set_output.CreateMatchmakingRuleSetOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_matchmaking_rule_set

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_matchmaking_rule_set.create_matchmaking_rule_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_player_session(
        self,
        game_session_id: "aws_sdk_gamelift.types.arn_string_model.ArnStringModel",
        player_id: "aws_sdk_gamelift.types.player_id.PlayerId",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        player_data: Optional["aws_sdk_gamelift.types.player_data.PlayerData"] = None,
    ) -> (
        "aws_sdk_gamelift.types.create_player_session_output.CreatePlayerSessionOutput"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_player_session_input.CreatePlayerSessionInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_player_session_output.CreatePlayerSessionOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_player_session

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_player_session.create_player_session(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_player_sessions(
        self,
        game_session_id: "aws_sdk_gamelift.types.arn_string_model.ArnStringModel",
        player_ids: "aws_sdk_gamelift.types.player_id_list.PlayerIdList",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        player_data_map: Optional[
            "aws_sdk_gamelift.types.player_data_map.PlayerDataMap"
        ] = None,
    ) -> "aws_sdk_gamelift.types.create_player_sessions_output.CreatePlayerSessionsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_player_sessions_input.CreatePlayerSessionsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_player_sessions_output.CreatePlayerSessionsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_player_sessions

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_player_sessions.create_player_sessions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_script(
        ...
        *,
        ...
        zip_file: Optional["aws_sdk_gamelift.types.zip_blob.ZipBlob"] = None,
        tags: Optional["aws_sdk_gamelift.types.tag_list.TagList"] = None,
        node_js_version: Optional[
            "aws_sdk_gamelift.types.node_js_version.NodeJsVersion"
        ] = None,
    ) -> "aws_sdk_gamelift.types.create_script_output.CreateScriptOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_script_input.CreateScriptInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_script_output.CreateScriptOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_script

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_script.create_script(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_vpc_peering_authorization(
        self,
        game_lift_aws_account_id: "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString",
        peer_vpc_id: "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.create_vpc_peering_authorization_output.CreateVpcPeeringAuthorizationOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_vpc_peering_authorization_input.CreateVpcPeeringAuthorizationInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_vpc_peering_authorization_output.CreateVpcPeeringAuthorizationOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_vpc_peering_authorization

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_vpc_peering_authorization.create_vpc_peering_authorization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_vpc_peering_connection(
        self,
        fleet_id: "aws_sdk_gamelift.types.fleet_id.FleetId",
        peer_vpc_aws_account_id: "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString",
        peer_vpc_id: "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.create_vpc_peering_connection_output.CreateVpcPeeringConnectionOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.create_vpc_peering_connection_input.CreateVpcPeeringConnectionInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.create_vpc_peering_connection_output.CreateVpcPeeringConnectionOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.create_vpc_peering_connection

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.create_vpc_peering_connection.create_vpc_peering_connection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_alias(
        self,
        alias_id: "aws_sdk_gamelift.types.alias_id_or_arn.AliasIdOrArn",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> None:
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_alias_input.DeleteAliasInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_gamelift._operations.game_lift.delete_alias

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_alias.delete_alias(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_build(
        self,
        build_id: "aws_sdk_gamelift.types.build_id_or_arn.BuildIdOrArn",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> None:
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_build_input.DeleteBuildInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_gamelift._operations.game_lift.delete_build

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_build.delete_build(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_container_fleet(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.delete_container_fleet_output.DeleteContainerFleetOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_container_fleet_input.DeleteContainerFleetInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.delete_container_fleet_output.DeleteContainerFleetOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.delete_container_fleet

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_container_fleet.delete_container_fleet(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_container_group_definition(
        self,
        name: "aws_sdk_gamelift.types.container_group_definition_name_or_arn.ContainerGroupDefinitionNameOrArn",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ...
    ) -> "aws_sdk_gamelift.types.delete_container_group_definition_output.DeleteContainerGroupDefinitionOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_container_group_definition_input.DeleteContainerGroupDefinitionInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.delete_container_group_definition_output.DeleteContainerGroupDefinitionOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.delete_container_group_definition

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_container_group_definition.delete_container_group_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_fleet(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_fleet_input.DeleteFleetInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_gamelift._operations.game_lift.delete_fleet

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_fleet.delete_fleet(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_fleet_locations(
        self,
        fleet_id: "aws_sdk_gamelift.types.fleet_id_or_arn.FleetIdOrArn",
        locations: "aws_sdk_gamelift.types.location_list.LocationList",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.delete_fleet_locations_output.DeleteFleetLocationsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_fleet_locations_input.DeleteFleetLocationsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.delete_fleet_locations_output.DeleteFleetLocationsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.delete_fleet_locations

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_fleet_locations.delete_fleet_locations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_game_server_group(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.delete_game_server_group_output.DeleteGameServerGroupOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_game_server_group_input.DeleteGameServerGroupInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.delete_game_server_group_output.DeleteGameServerGroupOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.delete_game_server_group

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_game_server_group.delete_game_server_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_game_session_queue(
        self,
        name: "aws_sdk_gamelift.types.game_session_queue_name_or_arn.GameSessionQueueNameOrArn",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.delete_game_session_queue_output.DeleteGameSessionQueueOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_game_session_queue_input.DeleteGameSessionQueueInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.delete_game_session_queue_output.DeleteGameSessionQueueOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.delete_game_session_queue

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_game_session_queue.delete_game_session_queue(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_location(
        self,
        location_name: "aws_sdk_gamelift.types.custom_location_name_or_arn_model.CustomLocationNameOrArnModel",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.delete_location_output.DeleteLocationOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_location_input.DeleteLocationInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.delete_location_output.DeleteLocationOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.delete_location

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_location.delete_location(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_matchmaking_configuration(
        self,
        name: "aws_sdk_gamelift.types.matchmaking_configuration_name.MatchmakingConfigurationName",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.delete_matchmaking_configuration_output.DeleteMatchmakingConfigurationOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_matchmaking_configuration_input.DeleteMatchmakingConfigurationInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.delete_matchmaking_configuration_output.DeleteMatchmakingConfigurationOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.delete_matchmaking_configuration

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_matchmaking_configuration.delete_matchmaking_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_matchmaking_rule_set(
        self,
        name: "aws_sdk_gamelift.types.matchmaking_rule_set_name.MatchmakingRuleSetName",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.delete_matchmaking_rule_set_output.DeleteMatchmakingRuleSetOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_matchmaking_rule_set_input.DeleteMatchmakingRuleSetInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.delete_matchmaking_rule_set_output.DeleteMatchmakingRuleSetOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.delete_matchmaking_rule_set

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_matchmaking_rule_set.delete_matchmaking_rule_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_scaling_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_scaling_policy_input.DeleteScalingPolicyInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_gamelift._operations.game_lift.delete_scaling_policy

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_scaling_policy.delete_scaling_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_script(
        self,
        script_id: "aws_sdk_gamelift.types.script_id_or_arn.ScriptIdOrArn",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> None:
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_script_input.DeleteScriptInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_gamelift._operations.game_lift.delete_script

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_script.delete_script(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_vpc_peering_authorization(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.delete_vpc_peering_authorization_output.DeleteVpcPeeringAuthorizationOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_vpc_peering_authorization_input.DeleteVpcPeeringAuthorizationInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.delete_vpc_peering_authorization_output.DeleteVpcPeeringAuthorizationOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.delete_vpc_peering_authorization

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_vpc_peering_authorization.delete_vpc_peering_authorization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_vpc_peering_connection(
        self,
        fleet_id: "aws_sdk_gamelift.types.fleet_id.FleetId",
        vpc_peering_connection_id: "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.delete_vpc_peering_connection_output.DeleteVpcPeeringConnectionOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.delete_vpc_peering_connection_input.DeleteVpcPeeringConnectionInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.delete_vpc_peering_connection_output.DeleteVpcPeeringConnectionOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.delete_vpc_peering_connection

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.delete_vpc_peering_connection.delete_vpc_peering_connection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deregister_compute(
        self,
        fleet_id: "aws_sdk_gamelift.types.fleet_id_or_arn.FleetIdOrArn",
        compute_name: "aws_sdk_gamelift.types.compute_name_or_arn.ComputeNameOrArn",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.deregister_compute_output.DeregisterComputeOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.deregister_compute_input.DeregisterComputeInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.deregister_compute_output.DeregisterComputeOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.deregister_compute

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.deregister_compute.deregister_compute(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deregister_game_server(
        self,
        game_server_group_name: "aws_sdk_gamelift.types.game_server_group_name_or_arn.GameServerGroupNameOrArn",
        game_server_id: "aws_sdk_gamelift.types.game_server_id.GameServerId",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> None:
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.deregister_game_server_input.DeregisterGameServerInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_gamelift._operations.game_lift.deregister_game_server

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.deregister_game_server.deregister_game_server(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_alias(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.describe_alias_output.DescribeAliasOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_alias_input.DescribeAliasInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_alias_output.DescribeAliasOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_alias

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_alias.describe_alias(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_build(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.describe_build_output.DescribeBuildOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_build_input.DescribeBuildInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_build_output.DescribeBuildOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_build

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_build.describe_build(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_compute(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.describe_compute_output.DescribeComputeOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_compute_input.DescribeComputeInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_compute_output.DescribeComputeOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_compute

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_compute.describe_compute(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_container_fleet(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.describe_container_fleet_output.DescribeContainerFleetOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_container_fleet_input.DescribeContainerFleetInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_container_fleet_output.DescribeContainerFleetOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_container_fleet

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_container_fleet.describe_container_fleet(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_container_group_definition(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.describe_container_group_definition_output.DescribeContainerGroupDefinitionOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_container_group_definition_input.DescribeContainerGroupDefinitionInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_container_group_definition_output.DescribeContainerGroupDefinitionOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_container_group_definition

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_container_group_definition.describe_container_group_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_container_group_port_mappings(
        self,
        fleet_id: "aws_sdk_gamelift.types.fleet_id_or_arn.FleetIdOrArn",
        container_group_type: "aws_sdk_gamelift.types.container_group_type.ContainerGroupType",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        compute_name: Optional[
            "aws_sdk_gamelift.types.compute_name_or_arn.ComputeNameOrArn"
        ] = None,
        instance_id: Optional["aws_sdk_gamelift.types.instance_id.InstanceId"] = None,
        container_name: Optional[
            "aws_sdk_gamelift.types.non_zero_and128_max_ascii_string.NonZeroAnd128MaxAsciiString"
        ] = None,
    ) -> "aws_sdk_gamelift.types.describe_container_group_port_mappings_output.DescribeContainerGroupPortMappingsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_container_group_port_mappings_input.DescribeContainerGroupPortMappingsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_container_group_port_mappings_output.DescribeContainerGroupPortMappingsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_container_group_port_mappings

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_container_group_port_mappings.describe_container_group_port_mappings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_ec2_instance_limits(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.describe_ec2_instance_limits_output.DescribeEC2InstanceLimitsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_ec2_instance_limits_input.DescribeEC2InstanceLimitsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_ec2_instance_limits_output.DescribeEC2InstanceLimitsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_ec2_instance_limits

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_ec2_instance_limits.describe_ec2_instance_limits(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_fleet_attributes(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.describe_fleet_attributes_output.DescribeFleetAttributesOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_fleet_attributes_input.DescribeFleetAttributesInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_fleet_attributes_output.DescribeFleetAttributesOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_fleet_attributes

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_fleet_attributes.describe_fleet_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.fleet_attributes.FleetAttributes]":
        _token = next_token
        while True:
            _response = self.describe_fleet_attributes(
    ...
    def describe_fleet_capacity(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.describe_fleet_capacity_output.DescribeFleetCapacityOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_fleet_capacity_input.DescribeFleetCapacityInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_fleet_capacity_output.DescribeFleetCapacityOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_fleet_capacity

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_fleet_capacity.describe_fleet_capacity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.fleet_capacity.FleetCapacity]":
        _token = next_token
        while True:
            _response = self.describe_fleet_capacity(
                config_overrides=config_overrides,
                fleet_ids=fleet_ids,
                limit=limit,
                next_token=_token,
    ...
    def describe_fleet_deployment(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.describe_fleet_deployment_output.DescribeFleetDeploymentOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_fleet_deployment_input.DescribeFleetDeploymentInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_fleet_deployment_output.DescribeFleetDeploymentOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_fleet_deployment

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_fleet_deployment.describe_fleet_deployment(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_fleet_events(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        start_time: Optional["aws_sdk_gamelift.types.timestamp.Timestamp"] = None,
        end_time: Optional["aws_sdk_gamelift.types.timestamp.Timestamp"] = None,
        limit: Optional[
            "aws_sdk_gamelift.types.positive_integer.PositiveInteger"
        ] = None,
        next_token: Optional[
        ...
        "aws_sdk_gamelift.types.describe_fleet_events_output.DescribeFleetEventsOutput"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_fleet_events_input.DescribeFleetEventsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_fleet_events_output.DescribeFleetEventsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_fleet_events

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_fleet_events.describe_fleet_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.event.Event]":
        _token = next_token
        while True:
            _response = self.describe_fleet_events(
                fleet_id,
                config_overrides=config_overrides,
    ...
    def describe_fleet_location_attributes(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        locations: Optional["aws_sdk_gamelift.types.location_list.LocationList"] = None,
        limit: Optional[
            "aws_sdk_gamelift.types.positive_integer.PositiveInteger"
        ] = None,
        next_token: Optional[
    ...
    ) -> "aws_sdk_gamelift.types.describe_fleet_location_attributes_output.DescribeFleetLocationAttributesOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_fleet_location_attributes_input.DescribeFleetLocationAttributesInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_fleet_location_attributes_output.DescribeFleetLocationAttributesOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_fleet_location_attributes

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_fleet_location_attributes.describe_fleet_location_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_fleet_location_capacity(
        self,
        fleet_id: "aws_sdk_gamelift.types.fleet_id_or_arn.FleetIdOrArn",
        location: "aws_sdk_gamelift.types.location_string_model.LocationStringModel",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.describe_fleet_location_capacity_output.DescribeFleetLocationCapacityOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_fleet_location_capacity_input.DescribeFleetLocationCapacityInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_fleet_location_capacity_output.DescribeFleetLocationCapacityOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_fleet_location_capacity

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_fleet_location_capacity.describe_fleet_location_capacity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_fleet_location_utilization(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.describe_fleet_location_utilization_output.DescribeFleetLocationUtilizationOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_fleet_location_utilization_input.DescribeFleetLocationUtilizationInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_fleet_location_utilization_output.DescribeFleetLocationUtilizationOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_fleet_location_utilization

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_fleet_location_utilization.describe_fleet_location_utilization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_fleet_port_settings(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.describe_fleet_port_settings_output.DescribeFleetPortSettingsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_fleet_port_settings_input.DescribeFleetPortSettingsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_fleet_port_settings_output.DescribeFleetPortSettingsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_fleet_port_settings

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_fleet_port_settings.describe_fleet_port_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_fleet_utilization(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.describe_fleet_utilization_output.DescribeFleetUtilizationOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_fleet_utilization_input.DescribeFleetUtilizationInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_fleet_utilization_output.DescribeFleetUtilizationOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_fleet_utilization

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_fleet_utilization.describe_fleet_utilization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.fleet_utilization.FleetUtilization]":
        _token = next_token
        while True:
            _response = self.describe_fleet_utilization(
                config_overrides=config_overrides,
                fleet_ids=fleet_ids,
                limit=limit,
                next_token=_token,
    ...
    def describe_game_server(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.describe_game_server_output.DescribeGameServerOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_game_server_input.DescribeGameServerInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_game_server_output.DescribeGameServerOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_game_server

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_game_server.describe_game_server(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_game_server_group(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.describe_game_server_group_output.DescribeGameServerGroupOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_game_server_group_input.DescribeGameServerGroupInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_game_server_group_output.DescribeGameServerGroupOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_game_server_group

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_game_server_group.describe_game_server_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_game_server_instances(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.describe_game_server_instances_output.DescribeGameServerInstancesOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_game_server_instances_input.DescribeGameServerInstancesInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_game_server_instances_output.DescribeGameServerInstancesOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_game_server_instances

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_game_server_instances.describe_game_server_instances(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.game_server_instance.GameServerInstance]":
        _token = next_token
        while True:
            _response = self.describe_game_server_instances(
    ...
    def describe_game_session_details(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.describe_game_session_details_output.DescribeGameSessionDetailsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_game_session_details_input.DescribeGameSessionDetailsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_game_session_details_output.DescribeGameSessionDetailsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_game_session_details

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_game_session_details.describe_game_session_details(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.game_session_detail.GameSessionDetail]":
        _token = next_token
        while True:
            _response = self.describe_game_session_details(
                config_overrides=config_overrides,
                fleet_id=fleet_id,
    ...
    def describe_game_session_placement(
        self,
        placement_id: "aws_sdk_gamelift.types.id_string_model.IdStringModel",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.describe_game_session_placement_output.DescribeGameSessionPlacementOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_game_session_placement_input.DescribeGameSessionPlacementInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_game_session_placement_output.DescribeGameSessionPlacementOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_game_session_placement

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_game_session_placement.describe_game_session_placement(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_game_session_queues(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        names: Optional[
            "aws_sdk_gamelift.types.game_session_queue_name_or_arn_list.GameSessionQueueNameOrArnList"
        ] = None,
        limit: Optional[
            "aws_sdk_gamelift.types.positive_integer.PositiveInteger"
        ] = None,
    ...
    ) -> "aws_sdk_gamelift.types.describe_game_session_queues_output.DescribeGameSessionQueuesOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_game_session_queues_input.DescribeGameSessionQueuesInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_game_session_queues_output.DescribeGameSessionQueuesOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_game_session_queues

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_game_session_queues.describe_game_session_queues(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.game_session_queue.GameSessionQueue]":
        _token = next_token
        while True:
            _response = self.describe_game_session_queues(
                config_overrides=config_overrides,
                names=names,
                limit=limit,
                next_token=_token,
    ...
    def describe_game_sessions(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.describe_game_sessions_output.DescribeGameSessionsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_game_sessions_input.DescribeGameSessionsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_game_sessions_output.DescribeGameSessionsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_game_sessions

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_game_sessions.describe_game_sessions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.game_session.GameSession]":
        _token = next_token
        while True:
            _response = self.describe_game_sessions(
                config_overrides=config_overrides,
                fleet_id=fleet_id,
                game_session_id=game_session_id,
                alias_id=alias_id,
    ...
    def describe_instances(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.describe_instances_output.DescribeInstancesOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_instances_input.DescribeInstancesInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_instances_output.DescribeInstancesOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_instances

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_instances.describe_instances(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.instance.Instance]":
        _token = next_token
        while True:
            _response = self.describe_instances(
                fleet_id,
                config_overrides=config_overrides,
    ...
    def describe_matchmaking(
        self,
        ticket_ids: "aws_sdk_gamelift.types.matchmaking_id_list.MatchmakingIdList",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.describe_matchmaking_output.DescribeMatchmakingOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_matchmaking_input.DescribeMatchmakingInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_matchmaking_output.DescribeMatchmakingOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_matchmaking

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_matchmaking.describe_matchmaking(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_matchmaking_configurations(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.describe_matchmaking_configurations_output.DescribeMatchmakingConfigurationsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_matchmaking_configurations_input.DescribeMatchmakingConfigurationsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_matchmaking_configurations_output.DescribeMatchmakingConfigurationsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_matchmaking_configurations

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_matchmaking_configurations.describe_matchmaking_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.matchmaking_configuration.MatchmakingConfiguration]":
        _token = next_token
        while True:
            _response = self.describe_matchmaking_configurations(
                config_overrides=config_overrides,
                names=names,
    ...
    def describe_matchmaking_rule_sets(
        ...
        *,
        ...
        limit: Optional["aws_sdk_gamelift.types.rule_set_limit.RuleSetLimit"] = None,
        next_token: Optional[
            "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString"
        ] = None,
    ) -> "aws_sdk_gamelift.types.describe_matchmaking_rule_sets_output.DescribeMatchmakingRuleSetsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_matchmaking_rule_sets_input.DescribeMatchmakingRuleSetsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_matchmaking_rule_sets_output.DescribeMatchmakingRuleSetsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_matchmaking_rule_sets

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_matchmaking_rule_sets.describe_matchmaking_rule_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.matchmaking_rule_set.MatchmakingRuleSet]":
        _token = next_token
        while True:
            _response = self.describe_matchmaking_rule_sets(
                config_overrides=config_overrides,
                names=names,
                limit=limit,
                next_token=_token,
    ...
    def describe_player_sessions(
        ...
        *,
        ...
        player_id: Optional["aws_sdk_gamelift.types.player_id.PlayerId"] = None,
    ...
    ) -> "aws_sdk_gamelift.types.describe_player_sessions_output.DescribePlayerSessionsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_player_sessions_input.DescribePlayerSessionsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_player_sessions_output.DescribePlayerSessionsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_player_sessions

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_player_sessions.describe_player_sessions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.player_session.PlayerSession]":
        _token = next_token
        while True:
            _response = self.describe_player_sessions(
                config_overrides=config_overrides,
                game_session_id=game_session_id,
                player_id=player_id,
    ...
    def describe_runtime_configuration(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.describe_runtime_configuration_output.DescribeRuntimeConfigurationOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_runtime_configuration_input.DescribeRuntimeConfigurationInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_runtime_configuration_output.DescribeRuntimeConfigurationOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_runtime_configuration

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_runtime_configuration.describe_runtime_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_scaling_policies(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.describe_scaling_policies_output.DescribeScalingPoliciesOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_scaling_policies_input.DescribeScalingPoliciesInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_scaling_policies_output.DescribeScalingPoliciesOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_scaling_policies

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_scaling_policies.describe_scaling_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.scaling_policy.ScalingPolicy]":
        _token = next_token
        while True:
    ...
    def describe_script(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.describe_script_output.DescribeScriptOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_script_input.DescribeScriptInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_script_output.DescribeScriptOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_script

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_script.describe_script(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_vpc_peering_authorizations(
        ...
        def _handler(
            ...
            import aws_sdk_gamelift._operations.game_lift.describe_vpc_peering_authorizations

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_vpc_peering_authorizations.describe_vpc_peering_authorizations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_vpc_peering_connections(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        fleet_id: Optional["aws_sdk_gamelift.types.fleet_id.FleetId"] = None,
    ) -> "aws_sdk_gamelift.types.describe_vpc_peering_connections_output.DescribeVpcPeeringConnectionsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.describe_vpc_peering_connections_input.DescribeVpcPeeringConnectionsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.describe_vpc_peering_connections_output.DescribeVpcPeeringConnectionsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.describe_vpc_peering_connections

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.describe_vpc_peering_connections.describe_vpc_peering_connections(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_compute_access(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.get_compute_access_output.GetComputeAccessOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.get_compute_access_input.GetComputeAccessInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.get_compute_access_output.GetComputeAccessOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.get_compute_access

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.get_compute_access.get_compute_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_compute_auth_token(
        ...
        *,
        ...
        "aws_sdk_gamelift.types.get_compute_auth_token_output.GetComputeAuthTokenOutput"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.get_compute_auth_token_input.GetComputeAuthTokenInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.get_compute_auth_token_output.GetComputeAuthTokenOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.get_compute_auth_token

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.get_compute_auth_token.get_compute_auth_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_game_session_log_url(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.get_game_session_log_url_output.GetGameSessionLogUrlOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.get_game_session_log_url_input.GetGameSessionLogUrlInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.get_game_session_log_url_output.GetGameSessionLogUrlOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.get_game_session_log_url

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.get_game_session_log_url.get_game_session_log_url(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_instance_access(
        self,
        fleet_id: "aws_sdk_gamelift.types.fleet_id_or_arn.FleetIdOrArn",
        instance_id: "aws_sdk_gamelift.types.instance_id.InstanceId",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.get_instance_access_output.GetInstanceAccessOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.get_instance_access_input.GetInstanceAccessInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.get_instance_access_output.GetInstanceAccessOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.get_instance_access

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.get_instance_access.get_instance_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_player_connection_details(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.get_player_connection_details_output.GetPlayerConnectionDetailsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.get_player_connection_details_input.GetPlayerConnectionDetailsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.get_player_connection_details_output.GetPlayerConnectionDetailsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.get_player_connection_details

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.get_player_connection_details.get_player_connection_details(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_aliases(
        ...
        *,
        ...
        name: Optional["aws_sdk_gamelift.types.non_empty_string.NonEmptyString"] = None,
        limit: Optional[
            "aws_sdk_gamelift.types.positive_integer.PositiveInteger"
        ] = None,
        next_token: Optional[
    ...
    ) -> "aws_sdk_gamelift.types.list_aliases_output.ListAliasesOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.list_aliases_input.ListAliasesInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.list_aliases_output.ListAliasesOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.list_aliases

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.list_aliases.list_aliases(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.alias.Alias]":
        _token = next_token
        while True:
    ...
    def list_builds(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        status: Optional["aws_sdk_gamelift.types.build_status.BuildStatus"] = None,
        limit: Optional[
            "aws_sdk_gamelift.types.positive_integer.PositiveInteger"
        ] = None,
        next_token: Optional[
    ...
    ) -> "aws_sdk_gamelift.types.list_builds_output.ListBuildsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.list_builds_input.ListBuildsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.list_builds_output.ListBuildsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.list_builds

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.list_builds.list_builds(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.build.Build]":
        _token = next_token
        while True:
            _response = self.list_builds(
                config_overrides=config_overrides,
                status=status,
                limit=limit,
                next_token=_token,
    ...
    def list_compute(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.list_compute_output.ListComputeOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.list_compute_input.ListComputeInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.list_compute_output.ListComputeOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.list_compute

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.list_compute.list_compute(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.compute.Compute]":
        _token = next_token
        while True:
            _response = self.list_compute(
                fleet_id,
                config_overrides=config_overrides,
                location=location,
    ...
    def list_container_fleets(
        ...
        *,
        ...
        "aws_sdk_gamelift.types.list_container_fleets_output.ListContainerFleetsOutput"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.list_container_fleets_input.ListContainerFleetsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.list_container_fleets_output.ListContainerFleetsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.list_container_fleets

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.list_container_fleets.list_container_fleets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.container_fleet.ContainerFleet]":
        _token = next_token
        while True:
            _response = self.list_container_fleets(
                config_overrides=config_overrides,
                container_group_definition_name=container_group_definition_name,
                limit=limit,
                next_token=_token,
    ...
    def list_container_group_definitions(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.list_container_group_definitions_output.ListContainerGroupDefinitionsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.list_container_group_definitions_input.ListContainerGroupDefinitionsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.list_container_group_definitions_output.ListContainerGroupDefinitionsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.list_container_group_definitions

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.list_container_group_definitions.list_container_group_definitions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.container_group_definition.ContainerGroupDefinition]":
        _token = next_token
        while True:
            _response = self.list_container_group_definitions(
                config_overrides=config_overrides,
    ...
    def list_container_group_definition_versions(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.list_container_group_definition_versions_output.ListContainerGroupDefinitionVersionsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.list_container_group_definition_versions_input.ListContainerGroupDefinitionVersionsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.list_container_group_definition_versions_output.ListContainerGroupDefinitionVersionsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.list_container_group_definition_versions

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.list_container_group_definition_versions.list_container_group_definition_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_container_group_definition_versions(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = self.list_container_group_definition_versions(
                name,
                config_overrides=config_overrides,
                limit=limit,
                next_token=_token,
    ...
    def list_fleet_deployments(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.list_fleet_deployments_output.ListFleetDeploymentsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.list_fleet_deployments_input.ListFleetDeploymentsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.list_fleet_deployments_output.ListFleetDeploymentsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.list_fleet_deployments

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.list_fleet_deployments.list_fleet_deployments(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.fleet_deployment.FleetDeployment]":
        _token = next_token
        while True:
            _response = self.list_fleet_deployments(
                config_overrides=config_overrides,
                fleet_id=fleet_id,
                limit=limit,
                next_token=_token,
    ...
    def list_fleets(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.list_fleets_output.ListFleetsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.list_fleets_input.ListFleetsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.list_fleets_output.ListFleetsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.list_fleets

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.list_fleets.list_fleets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.fleet_id.FleetId]":
        _token = next_token
        while True:
    ...
    def list_game_server_groups(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.list_game_server_groups_output.ListGameServerGroupsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.list_game_server_groups_input.ListGameServerGroupsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.list_game_server_groups_output.ListGameServerGroupsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.list_game_server_groups

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.list_game_server_groups.list_game_server_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.game_server_group.GameServerGroup]":
        _token = next_token
        while True:
            _response = self.list_game_server_groups(
                config_overrides=config_overrides,
                limit=limit,
                next_token=_token,
            )
    ...
    def list_game_servers(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        sort_order: Optional["aws_sdk_gamelift.types.sort_order.SortOrder"] = None,
        limit: Optional[
            "aws_sdk_gamelift.types.positive_integer.PositiveInteger"
        ] = None,
        next_token: Optional[
    ...
    ) -> "aws_sdk_gamelift.types.list_game_servers_output.ListGameServersOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.list_game_servers_input.ListGameServersInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.list_game_servers_output.ListGameServersOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.list_game_servers

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.list_game_servers.list_game_servers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.game_server.GameServer]":
        _token = next_token
        while True:
            _response = self.list_game_servers(
                game_server_group_name,
                config_overrides=config_overrides,
    ...
    def list_locations(
        ...
        *,
        ...
        limit: Optional[
            "aws_sdk_gamelift.types.list_locations_limit.ListLocationsLimit"
        ] = None,
        next_token: Optional[
            "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString"
        ] = None,
    ) -> "aws_sdk_gamelift.types.list_locations_output.ListLocationsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.list_locations_input.ListLocationsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.list_locations_output.ListLocationsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.list_locations

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.list_locations.list_locations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.location_model.LocationModel]":
        _token = next_token
        while True:
    ...
    def list_scripts(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.list_scripts_output.ListScriptsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.list_scripts_input.ListScriptsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.list_scripts_output.ListScriptsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.list_scripts

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.list_scripts.list_scripts(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_gamelift.types.script.Script]":
        _token = next_token
        while True:
            _response = self.list_scripts(
                config_overrides=config_overrides,
                limit=limit,
                next_token=_token,
            )
    ...
    def list_tags_for_resource(
        self,
        resource_arn: "aws_sdk_gamelift.types.amazon_resource_name.AmazonResourceName",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_gamelift._operations.game_lift.list_tags_for_resource

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_scaling_policy(
        ...
        name: "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString",
        fleet_id: "aws_sdk_gamelift.types.fleet_id_or_arn.FleetIdOrArn",
        metric_name: "aws_sdk_gamelift.types.metric_name.MetricName",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        scaling_adjustment: Optional["aws_sdk_gamelift.types.integer.Integer"] = None,
        scaling_adjustment_type: Optional[
            "aws_sdk_gamelift.types.scaling_adjustment_type.ScalingAdjustmentType"
        ] = None,
        threshold: Optional["aws_sdk_gamelift.types.double.Double"] = None,
        ...
        policy_type: Optional["aws_sdk_gamelift.types.policy_type.PolicyType"] = None,
        target_configuration: Optional[
            "aws_sdk_gamelift.types.target_configuration.TargetConfiguration"
        ] = None,
    ) -> "aws_sdk_gamelift.types.put_scaling_policy_output.PutScalingPolicyOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.put_scaling_policy_input.PutScalingPolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.put_scaling_policy_output.PutScalingPolicyOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.put_scaling_policy

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.put_scaling_policy.put_scaling_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_compute(
        self,
        fleet_id: "aws_sdk_gamelift.types.fleet_id_or_arn.FleetIdOrArn",
        compute_name: "aws_sdk_gamelift.types.compute_name.ComputeName",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        certificate_path: Optional[
            "aws_sdk_gamelift.types.non_zero_and_max_string.NonZeroAndMaxString"
        ] = None,
        dns_name: Optional["aws_sdk_gamelift.types.dns_name_input.DnsNameInput"] = None,
        ip_address: Optional["aws_sdk_gamelift.types.ip_address.IpAddress"] = None,
        location: Optional[
            "aws_sdk_gamelift.types.location_string_model.LocationStringModel"
        ] = None,
    ) -> "aws_sdk_gamelift.types.register_compute_output.RegisterComputeOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.register_compute_input.RegisterComputeInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.register_compute_output.RegisterComputeOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.register_compute

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.register_compute.register_compute(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_game_server(
        ...
        game_server_group_name: "aws_sdk_gamelift.types.game_server_group_name_or_arn.GameServerGroupNameOrArn",
        game_server_id: "aws_sdk_gamelift.types.game_server_id.GameServerId",
        instance_id: "aws_sdk_gamelift.types.game_server_instance_id.GameServerInstanceId",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ...
    ) -> "aws_sdk_gamelift.types.register_game_server_output.RegisterGameServerOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.register_game_server_input.RegisterGameServerInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.register_game_server_output.RegisterGameServerOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.register_game_server

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.register_game_server.register_game_server(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def request_upload_credentials(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.request_upload_credentials_output.RequestUploadCredentialsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.request_upload_credentials_input.RequestUploadCredentialsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.request_upload_credentials_output.RequestUploadCredentialsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.request_upload_credentials

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.request_upload_credentials.request_upload_credentials(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def resolve_alias(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.resolve_alias_output.ResolveAliasOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.resolve_alias_input.ResolveAliasInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.resolve_alias_output.ResolveAliasOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.resolve_alias

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.resolve_alias.resolve_alias(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def resume_game_server_group(
        self,
        game_server_group_name: "aws_sdk_gamelift.types.game_server_group_name_or_arn.GameServerGroupNameOrArn",
        resume_actions: "aws_sdk_gamelift.types.game_server_group_actions.GameServerGroupActions",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.resume_game_server_group_output.ResumeGameServerGroupOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.resume_game_server_group_input.ResumeGameServerGroupInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.resume_game_server_group_output.ResumeGameServerGroupOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.resume_game_server_group

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.resume_game_server_group.resume_game_server_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def search_game_sessions(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.search_game_sessions_output.SearchGameSessionsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.search_game_sessions_input.SearchGameSessionsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.search_game_sessions_output.SearchGameSessionsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.search_game_sessions

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.search_game_sessions.search_game_sessions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_search_game_sessions(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = self.search_game_sessions(
                config_overrides=config_overrides,
                fleet_id=fleet_id,
                alias_id=alias_id,
                location=location,
    ...
    def start_fleet_actions(
        self,
        fleet_id: "aws_sdk_gamelift.types.fleet_id_or_arn.FleetIdOrArn",
        actions: "aws_sdk_gamelift.types.fleet_action_list.FleetActionList",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        location: Optional[
            "aws_sdk_gamelift.types.location_string_model.LocationStringModel"
        ] = None,
    ) -> "aws_sdk_gamelift.types.start_fleet_actions_output.StartFleetActionsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.start_fleet_actions_input.StartFleetActionsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.start_fleet_actions_output.StartFleetActionsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.start_fleet_actions

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.start_fleet_actions.start_fleet_actions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_game_session_placement(
        self,
        placement_id: "aws_sdk_gamelift.types.id_string_model.IdStringModel",
        game_session_queue_name: "aws_sdk_gamelift.types.game_session_queue_name_or_arn.GameSessionQueueNameOrArn",
        maximum_player_session_count: "aws_sdk_gamelift.types.whole_number.WholeNumber",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        game_properties: Optional[
    ...
    ) -> "aws_sdk_gamelift.types.start_game_session_placement_output.StartGameSessionPlacementOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.start_game_session_placement_input.StartGameSessionPlacementInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.start_game_session_placement_output.StartGameSessionPlacementOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.start_game_session_placement

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.start_game_session_placement.start_game_session_placement(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_match_backfill(
        self,
        configuration_name: "aws_sdk_gamelift.types.matchmaking_configuration_name.MatchmakingConfigurationName",
        players: "aws_sdk_gamelift.types.player_list.PlayerList",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        ticket_id: Optional[
    ...
    ) -> "aws_sdk_gamelift.types.start_match_backfill_output.StartMatchBackfillOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.start_match_backfill_input.StartMatchBackfillInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.start_match_backfill_output.StartMatchBackfillOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.start_match_backfill

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.start_match_backfill.start_match_backfill(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_matchmaking(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.start_matchmaking_output.StartMatchmakingOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.start_matchmaking_input.StartMatchmakingInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.start_matchmaking_output.StartMatchmakingOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.start_matchmaking

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.start_matchmaking.start_matchmaking(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_fleet_actions(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.stop_fleet_actions_output.StopFleetActionsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.stop_fleet_actions_input.StopFleetActionsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.stop_fleet_actions_output.StopFleetActionsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.stop_fleet_actions

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.stop_fleet_actions.stop_fleet_actions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_game_session_placement(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.stop_game_session_placement_output.StopGameSessionPlacementOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.stop_game_session_placement_input.StopGameSessionPlacementInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.stop_game_session_placement_output.StopGameSessionPlacementOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.stop_game_session_placement

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.stop_game_session_placement.stop_game_session_placement(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_matchmaking(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.stop_matchmaking_output.StopMatchmakingOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.stop_matchmaking_input.StopMatchmakingInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.stop_matchmaking_output.StopMatchmakingOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.stop_matchmaking

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.stop_matchmaking.stop_matchmaking(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def suspend_game_server_group(
        self,
        game_server_group_name: "aws_sdk_gamelift.types.game_server_group_name_or_arn.GameServerGroupNameOrArn",
        suspend_actions: "aws_sdk_gamelift.types.game_server_group_actions.GameServerGroupActions",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.suspend_game_server_group_output.SuspendGameServerGroupOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.suspend_game_server_group_input.SuspendGameServerGroupInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.suspend_game_server_group_output.SuspendGameServerGroupOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.suspend_game_server_group

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.suspend_game_server_group.suspend_game_server_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        self,
        resource_arn: "aws_sdk_gamelift.types.amazon_resource_name.AmazonResourceName",
        tags: "aws_sdk_gamelift.types.tag_list.TagList",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.tag_resource_response.TagResourceResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.tag_resource_response.TagResourceResponse"
        ]:
            import aws_sdk_gamelift._operations.game_lift.tag_resource

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def terminate_game_session(
        self,
        game_session_id: "aws_sdk_gamelift.types.arn_string_model.ArnStringModel",
        termination_mode: "aws_sdk_gamelift.types.termination_mode.TerminationMode",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.terminate_game_session_output.TerminateGameSessionOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.terminate_game_session_input.TerminateGameSessionInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.terminate_game_session_output.TerminateGameSessionOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.terminate_game_session

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.terminate_game_session.terminate_game_session(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        self,
        resource_arn: "aws_sdk_gamelift.types.amazon_resource_name.AmazonResourceName",
        tag_keys: "aws_sdk_gamelift.types.tag_key_list.TagKeyList",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.untag_resource_response.UntagResourceResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.untag_resource_response.UntagResourceResponse"
        ]:
            import aws_sdk_gamelift._operations.game_lift.untag_resource

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_alias(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.update_alias_output.UpdateAliasOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_alias_input.UpdateAliasInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_alias_output.UpdateAliasOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_alias

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_alias.update_alias(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_build(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.update_build_output.UpdateBuildOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_build_input.UpdateBuildInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_build_output.UpdateBuildOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_build

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_build.update_build(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_container_fleet(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.update_container_fleet_output.UpdateContainerFleetOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_container_fleet_input.UpdateContainerFleetInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_container_fleet_output.UpdateContainerFleetOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_container_fleet

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_container_fleet.update_container_fleet(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_container_group_definition(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.update_container_group_definition_output.UpdateContainerGroupDefinitionOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_container_group_definition_input.UpdateContainerGroupDefinitionInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_container_group_definition_output.UpdateContainerGroupDefinitionOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_container_group_definition

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_container_group_definition.update_container_group_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_fleet_attributes(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.update_fleet_attributes_output.UpdateFleetAttributesOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_fleet_attributes_input.UpdateFleetAttributesInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_fleet_attributes_output.UpdateFleetAttributesOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_fleet_attributes

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_fleet_attributes.update_fleet_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_fleet_capacity(
        ...
        *,
        ...
        min_size: Optional["aws_sdk_gamelift.types.whole_number.WholeNumber"] = None,
        max_size: Optional["aws_sdk_gamelift.types.whole_number.WholeNumber"] = None,
        location: Optional[
            "aws_sdk_gamelift.types.location_string_model.LocationStringModel"
        ] = None,
        ...
        "aws_sdk_gamelift.types.update_fleet_capacity_output.UpdateFleetCapacityOutput"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_fleet_capacity_input.UpdateFleetCapacityInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_fleet_capacity_output.UpdateFleetCapacityOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_fleet_capacity

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_fleet_capacity.update_fleet_capacity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_fleet_port_settings(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.update_fleet_port_settings_output.UpdateFleetPortSettingsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_fleet_port_settings_input.UpdateFleetPortSettingsInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_fleet_port_settings_output.UpdateFleetPortSettingsOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_fleet_port_settings

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_fleet_port_settings.update_fleet_port_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_game_server(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.update_game_server_output.UpdateGameServerOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_game_server_input.UpdateGameServerInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_game_server_output.UpdateGameServerOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_game_server

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_game_server.update_game_server(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_game_server_group(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
        role_arn: Optional["aws_sdk_gamelift.types.iam_role_arn.IamRoleArn"] = None,
    ...
    ) -> "aws_sdk_gamelift.types.update_game_server_group_output.UpdateGameServerGroupOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_game_server_group_input.UpdateGameServerGroupInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_game_server_group_output.UpdateGameServerGroupOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_game_server_group

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_game_server_group.update_game_server_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_game_session(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.update_game_session_output.UpdateGameSessionOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_game_session_input.UpdateGameSessionInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_game_session_output.UpdateGameSessionOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_game_session

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_game_session.update_game_session(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_game_session_queue(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.update_game_session_queue_output.UpdateGameSessionQueueOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_game_session_queue_input.UpdateGameSessionQueueInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_game_session_queue_output.UpdateGameSessionQueueOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_game_session_queue

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_game_session_queue.update_game_session_queue(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_matchmaking_configuration(
        ...
        *,
    ...
    ) -> "aws_sdk_gamelift.types.update_matchmaking_configuration_output.UpdateMatchmakingConfigurationOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_matchmaking_configuration_input.UpdateMatchmakingConfigurationInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_matchmaking_configuration_output.UpdateMatchmakingConfigurationOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_matchmaking_configuration

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_matchmaking_configuration.update_matchmaking_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_runtime_configuration(
        self,
        fleet_id: "aws_sdk_gamelift.types.fleet_id_or_arn.FleetIdOrArn",
        runtime_configuration: "aws_sdk_gamelift.types.runtime_configuration.RuntimeConfiguration",
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.update_runtime_configuration_output.UpdateRuntimeConfigurationOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_runtime_configuration_input.UpdateRuntimeConfigurationInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_runtime_configuration_output.UpdateRuntimeConfigurationOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_runtime_configuration

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_runtime_configuration.update_runtime_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_script(
        ...
        *,
        ...
        zip_file: Optional["aws_sdk_gamelift.types.zip_blob.ZipBlob"] = None,
    ) -> "aws_sdk_gamelift.types.update_script_output.UpdateScriptOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.update_script_input.UpdateScriptInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.update_script_output.UpdateScriptOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.update_script

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.update_script.update_script(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def validate_matchmaking_rule_set(
        ...
        *,
        config_overrides: Optional[GameLiftClientConfig] = None,
    ) -> "aws_sdk_gamelift.types.validate_matchmaking_rule_set_output.ValidateMatchmakingRuleSetOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gamelift.types.validate_matchmaking_rule_set_input.ValidateMatchmakingRuleSetInput]",
        ) -> OperationResponse[
            "aws_sdk_gamelift.types.validate_matchmaking_rule_set_output.ValidateMatchmakingRuleSetOutput"
        ]:
            import aws_sdk_gamelift._operations.game_lift.validate_matchmaking_rule_set

            output, http_response = (
                aws_sdk_gamelift._operations.game_lift.validate_matchmaking_rule_set.validate_matchmaking_rule_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
