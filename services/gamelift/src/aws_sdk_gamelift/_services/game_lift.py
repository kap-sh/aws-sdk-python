...
from aws_sdk_gamelift._services._aws_config import aws_config
...
class GameLiftClientConfig(TypedDict, total=False, closed=True):
...
class GameLiftClient:
    ...
    def __init__(
        ...
        self._config = GameLiftClientConfig(
            {
