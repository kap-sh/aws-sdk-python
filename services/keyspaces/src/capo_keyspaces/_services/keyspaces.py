...
from capo_keyspaces._services._aws_config import aws_config
...
class KeyspacesClientConfig(TypedDict, total=False, closed=True):
...
class KeyspacesClient:
    ...
    def __init__(
        ...
        self._config = KeyspacesClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[KeyspacesClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: KeyspacesClientConfig = config_overrides or {}
    ...
    def create_keyspace(
        ...
        *,
        config_overrides: Optional[KeyspacesClientConfig] = None,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.create_keyspace_request.CreateKeyspaceRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.create_keyspace_response.CreateKeyspaceResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.create_keyspace.create_keyspace(
    ...
    def create_table(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.create_table_request.CreateTableRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.create_table_response.CreateTableResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.create_table.create_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.create_type_request.CreateTypeRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.create_type_response.CreateTypeResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.create_type.create_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_keyspace(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.delete_keyspace_request.DeleteKeyspaceRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.delete_keyspace_response.DeleteKeyspaceResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.delete_keyspace.delete_keyspace(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_table(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.delete_table_request.DeleteTableRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.delete_table_response.DeleteTableResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.delete_table.delete_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.delete_type_request.DeleteTypeRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.delete_type_response.DeleteTypeResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.delete_type.delete_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_keyspace(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.get_keyspace_request.GetKeyspaceRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.get_keyspace_response.GetKeyspaceResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.get_keyspace.get_keyspace(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_table(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.get_table_request.GetTableRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.get_table_response.GetTableResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.get_table.get_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_table_auto_scaling_settings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.get_table_auto_scaling_settings_request.GetTableAutoScalingSettingsRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.get_table_auto_scaling_settings_response.GetTableAutoScalingSettingsResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.get_table_auto_scaling_settings.get_table_auto_scaling_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.get_type_request.GetTypeRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.get_type_response.GetTypeResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.get_type.get_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_keyspaces(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.list_keyspaces_request.ListKeyspacesRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.list_keyspaces_response.ListKeyspacesResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.list_keyspaces.list_keyspaces(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_keyspaces(
        ...
        *,
        ...
        next_token: Optional["capo_keyspaces.types.next_token.NextToken"] = None,
        max_results: Optional["capo_keyspaces.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_keyspaces.types.keyspace_summary.KeyspaceSummary]":
        _token = next_token
        while True:
            _response = self.list_keyspaces(
    ...
    def list_tables(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.list_tables_request.ListTablesRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.list_tables_response.ListTablesResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.list_tables.list_tables(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_tables(
        ...
        *,
        ...
        next_token: Optional["capo_keyspaces.types.next_token.NextToken"] = None,
        max_results: Optional["capo_keyspaces.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_keyspaces.types.table_summary.TableSummary]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_tags_for_resource(
        ...
        *,
        ...
        next_token: Optional["capo_keyspaces.types.next_token.NextToken"] = None,
        max_results: Optional["capo_keyspaces.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_keyspaces.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    def list_types(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.list_types_request.ListTypesRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.list_types_response.ListTypesResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.list_types.list_types(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_types(
        ...
        *,
        ...
        next_token: Optional["capo_keyspaces.types.next_token.NextToken"] = None,
        max_results: Optional["capo_keyspaces.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_keyspaces.types.type_name.TypeName]":
        _token = next_token
        while True:
    ...
    def restore_table(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.restore_table_request.RestoreTableRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.restore_table_response.RestoreTableResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.restore_table.restore_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_keyspace(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.update_keyspace_request.UpdateKeyspaceRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.update_keyspace_response.UpdateKeyspaceResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.update_keyspace.update_keyspace(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_table(
        ...
        *,
        ...
        r"""<p>Adds new columns to the table or updates one of the table's settings, for example capacity mode, auto scaling, encryption, point-in-time recovery, or ttl settings. Note that you can only update one specific table setting per update operation.</p>
        ...
        def _handler(
            req: "OperationRequest[capo_keyspaces.types.update_table_request.UpdateTableRequest]",
        ) -> OperationResponse[
            "capo_keyspaces.types.update_table_response.UpdateTableResponse"
        ]:
            ...
            output, http_response = (
                capo_keyspaces._operations.keyspaces_service.update_table.update_table(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
