...
class KeyspacesError(Exception):
    """Base class for all Keyspaces service errors."""


class ServiceError(KeyspacesError):
...
class SerializationError(KeyspacesError):
    """Raised when a value cannot be serialized."""


class DeserializationError(KeyspacesError):
...
class WaiterFailedError(KeyspacesError):
...
class WaiterTimeoutError(KeyspacesError):
