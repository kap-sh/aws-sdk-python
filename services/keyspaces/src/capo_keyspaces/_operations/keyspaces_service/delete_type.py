"""Generated from Smithy shape ``com.amazonaws.keyspaces#DeleteType``."""
...
def handle_response(
    ...
    out: capo_keyspaces.types.delete_type_response.DeleteTypeResponse = (
        capo_keyspaces.types.delete_type_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_keyspaces.types.delete_type_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def delete_type(
    ...
    capo_keyspaces.types.delete_type_response.DeleteTypeResponse, zapros.Response
]:
