"""Generated from Smithy shape ``com.amazonaws.keyspaces#CreateKeyspace``."""
...
def handle_response(
    ...
    out: capo_keyspaces.types.create_keyspace_response.CreateKeyspaceResponse = (
        capo_keyspaces.types.create_keyspace_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KeyspacesService.CreateKeyspace"
    body: bytes | None = json.dumps(
        capo_keyspaces.types.create_keyspace_request.serialize_aws_json_1_0(input_)
    ).encode()
