"""Generated from Smithy shape ``com.amazonaws.keyspaces#CreateTable``."""
...
def handle_response(
    ...
    out: capo_keyspaces.types.create_table_response.CreateTableResponse = (
        capo_keyspaces.types.create_table_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KeyspacesService.CreateTable"
    body: bytes | None = json.dumps(
        capo_keyspaces.types.create_table_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def create_table(
    ...
    capo_keyspaces.types.create_table_response.CreateTableResponse, zapros.Response
]:
