...
def handle_response(
    ...
    out: capo_keyspaces.types.list_tables_response.ListTablesResponse = (
        capo_keyspaces.types.list_tables_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_keyspaces.types.list_tables_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_tables(
    ...
    capo_keyspaces.types.list_tables_response.ListTablesResponse, zapros.Response
]:
