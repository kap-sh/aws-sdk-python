"""Generated from Smithy shape ``com.amazonaws.keyspaces#ListTypes``."""
...
def handle_response(
    ...
    out: capo_keyspaces.types.list_types_response.ListTypesResponse = (
        capo_keyspaces.types.list_types_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KeyspacesService.ListTypes"
    body: bytes | None = json.dumps(
        capo_keyspaces.types.list_types_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_types(
    ...
    input_: capo_keyspaces.types.list_types_request.ListTypesRequest,
) -> tuple[capo_keyspaces.types.list_types_response.ListTypesResponse, zapros.Response]:
