"""Generated from Smithy shape ``com.amazonaws.keyspaces#CreateType``."""
...
import capo_keyspaces.errors.conflict_exception
...
from capo_keyspaces._services._pipeline import AsyncOperationOptions, OperationOptions
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_keyspaces.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_keyspaces.types.create_type_response.CreateTypeResponse = (
        capo_keyspaces.types.create_type_response.deserialize_aws_json_1_0(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_keyspaces._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KeyspacesService.CreateType"
    body: bytes | None = json.dumps(
        capo_keyspaces.types.create_type_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def create_type(
    ...
    capo_keyspaces.types.create_type_response.CreateTypeResponse, zapros.Response
]:
