...
def handle_response(
    ...
    out: capo_keyspaces.types.get_keyspace_response.GetKeyspaceResponse = (
        capo_keyspaces.types.get_keyspace_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_keyspaces.types.get_keyspace_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_keyspace(
    ...
    capo_keyspaces.types.get_keyspace_response.GetKeyspaceResponse, zapros.Response
]:
