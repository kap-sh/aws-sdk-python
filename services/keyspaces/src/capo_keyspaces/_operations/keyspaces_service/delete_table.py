...
def handle_response(
    ...
    out: capo_keyspaces.types.delete_table_response.DeleteTableResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_keyspaces.types.delete_table_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def delete_table(
    ...
    capo_keyspaces.types.delete_table_response.DeleteTableResponse, zapros.Response
]:
