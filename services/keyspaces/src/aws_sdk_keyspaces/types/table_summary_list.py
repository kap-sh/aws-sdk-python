...
TableSummaryList: TypeAlias = list["aws_sdk_keyspaces.types.table_summary.TableSummary"]
...
def serialize_aws_json_1_0(value: TableSummaryList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_keyspaces.types.table_summary.serialize_aws_json_1_0(item))
    return out
...
def deserialize_aws_json_1_0(data: list) -> TableSummaryList:
    ...
    for item in data:
        out.append(aws_sdk_keyspaces.types.table_summary.deserialize_aws_json_1_0(item))
    return out
