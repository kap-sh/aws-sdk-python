...
if TYPE_CHECKING:
    import aws_sdk_keyspaces.types.column_definition

ColumnDefinitionList: TypeAlias = list[
    "aws_sdk_keyspaces.types.column_definition.ColumnDefinition"
]
...
def serialize_aws_json_1_0(value: ColumnDefinitionList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_keyspaces.types.column_definition.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ColumnDefinitionList:
    ...
    for item in data:
        out.append(
            aws_sdk_keyspaces.types.column_definition.deserialize_aws_json_1_0(item)
        )
    return out
