...
if TYPE_CHECKING:
    import aws_sdk_keyspaces.types.replica_specification_summary

ReplicaSpecificationSummaryList: TypeAlias = list[
    "aws_sdk_keyspaces.types.replica_specification_summary.ReplicaSpecificationSummary"
]
...
def serialize_aws_json_1_0(value: ReplicaSpecificationSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_keyspaces.types.replica_specification_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ReplicaSpecificationSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_keyspaces.types.replica_specification_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
