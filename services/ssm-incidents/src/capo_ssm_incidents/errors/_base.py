...
class SSMIncidentsError(Exception):
    """Base class for all SSMIncidents service errors."""


class ServiceError(SSMIncidentsError):
...
class SerializationError(SSMIncidentsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SSMIncidentsError):
...
class WaiterFailedError(SSMIncidentsError):
...
class WaiterTimeoutError(SSMIncidentsError):
