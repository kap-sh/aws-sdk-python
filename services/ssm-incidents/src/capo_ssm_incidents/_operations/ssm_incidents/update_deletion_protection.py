...
def handle_response(
    ...
    out: capo_ssm_incidents.types.update_deletion_protection_output.UpdateDeletionProtectionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_incidents.types.update_deletion_protection_input.serialize_json(input_)
    ).encode()
