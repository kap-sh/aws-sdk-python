"""Generated from Smithy shape ``com.amazonaws.ssmincidents#DeleteResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_ssm_incidents.types.delete_resource_policy_output.DeleteResourcePolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_incidents.types.delete_resource_policy_input.serialize_json(input_)
    ).encode()
