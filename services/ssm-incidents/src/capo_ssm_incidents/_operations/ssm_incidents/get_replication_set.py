"""Generated from Smithy shape ``com.amazonaws.ssmincidents#GetReplicationSet``."""
...
def handle_response(
    ...
    out: capo_ssm_incidents.types.get_replication_set_output.GetReplicationSetOutput = (
        capo_ssm_incidents.types.get_replication_set_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/getReplicationSet"
    params: dict[str, str] = {}
    if "arn" in input_:
...
async def async_get_replication_set(
