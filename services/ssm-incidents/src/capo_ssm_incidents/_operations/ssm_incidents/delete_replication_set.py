"""Generated from Smithy shape ``com.amazonaws.ssmincidents#DeleteReplicationSet``."""
...
def handle_response(
    ...
    out: capo_ssm_incidents.types.delete_replication_set_output.DeleteReplicationSetOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/deleteReplicationSet"
    params: dict[str, str] = {}
    if "arn" in input_:
...
async def async_delete_replication_set(
