"""Generated from Smithy shape ``com.amazonaws.ssmincidents#GetResponsePlan``."""
...
def handle_response(
    ...
    out: capo_ssm_incidents.types.get_response_plan_output.GetResponsePlanOutput = (
        capo_ssm_incidents.types.get_response_plan_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/getResponsePlan"
    params: dict[str, str] = {}
    if "arn" in input_:
...
async def async_get_response_plan(
