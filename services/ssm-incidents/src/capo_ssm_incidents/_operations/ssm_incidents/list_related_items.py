...
def handle_response(
    ...
    out: capo_ssm_incidents.types.list_related_items_output.ListRelatedItemsOutput = (
        capo_ssm_incidents.types.list_related_items_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_incidents.types.list_related_items_input.serialize_json(input_)
    ).encode()
