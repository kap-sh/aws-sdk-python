...
import capo_ssm_incidents.types.finding_summary_list
...
def handle_response(
    ...
    out: capo_ssm_incidents.types.list_incident_findings_output.ListIncidentFindingsOutput = capo_ssm_incidents.types.list_incident_findings_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_incidents.types.list_incident_findings_input.serialize_json(input_)
    ).encode()
