"""Generated from Smithy shape ``com.amazonaws.ssmincidents#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_ssm_incidents.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_ssm_incidents.types.list_tags_for_resource_response.deserialize_json(
