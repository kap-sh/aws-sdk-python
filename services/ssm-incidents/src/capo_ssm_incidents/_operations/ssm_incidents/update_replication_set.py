...
def handle_response(
    ...
    out: capo_ssm_incidents.types.update_replication_set_output.UpdateReplicationSetOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_incidents.types.update_replication_set_input.serialize_json(input_)
    ).encode()
