...
def handle_response(
    ...
    out: capo_ssm_incidents.types.put_resource_policy_output.PutResourcePolicyOutput = (
        capo_ssm_incidents.types.put_resource_policy_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_incidents.types.put_resource_policy_input.serialize_json(input_)
    ).encode()
