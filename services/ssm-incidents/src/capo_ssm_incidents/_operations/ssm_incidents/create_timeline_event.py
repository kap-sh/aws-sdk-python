...
def handle_response(
    ...
    out: capo_ssm_incidents.types.create_timeline_event_output.CreateTimelineEventOutput = capo_ssm_incidents.types.create_timeline_event_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_incidents.types.create_timeline_event_input.serialize_json(input_)
    ).encode()
