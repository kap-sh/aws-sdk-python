"""Generated from Smithy shape ``com.amazonaws.ssmincidents#UntagResource``."""
...
def handle_response(
    ...
    out: capo_ssm_incidents.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
