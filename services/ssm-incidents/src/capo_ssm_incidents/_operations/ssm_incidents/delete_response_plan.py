...
def handle_response(
    ...
    out: capo_ssm_incidents.types.delete_response_plan_output.DeleteResponsePlanOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_incidents.types.delete_response_plan_input.serialize_json(input_)
    ).encode()
