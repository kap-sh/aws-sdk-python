...
class ListReplicationSetsOutput(TypedDict):
    replication_set_arns: (
        "aws_sdk_ssm_incidents.types.replication_set_arn_list.ReplicationSetArnList"
    )
...
def serialize_json(value: ListReplicationSetsOutput) -> dict:
    ...
    out["replicationSetArns"] = (
        aws_sdk_ssm_incidents.types.replication_set_arn_list.serialize_json(
...
def deserialize_json(data: dict) -> ListReplicationSetsOutput:
    ...
    if "replicationSetArns" in data:
        ...
        out["replication_set_arns"] = (
            aws_sdk_ssm_incidents.types.replication_set_arn_list.deserialize_json(
