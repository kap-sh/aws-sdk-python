...
if TYPE_CHECKING:
    import aws_sdk_ssm_incidents.types.event_summary_list
    import aws_sdk_ssm_incidents.types.next_token


class ListTimelineEventsOutput(TypedDict):
    event_summaries: "aws_sdk_ssm_incidents.types.event_summary_list.EventSummaryList"
...
def serialize_json(value: ListTimelineEventsOutput) -> dict:
    ...
    out["eventSummaries"] = (
        aws_sdk_ssm_incidents.types.event_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListTimelineEventsOutput:
    ...
    if "eventSummaries" in data:
        ...
        out["event_summaries"] = (
            aws_sdk_ssm_incidents.types.event_summary_list.deserialize_json(
                data["eventSummaries"]
            )
        )
    else:
