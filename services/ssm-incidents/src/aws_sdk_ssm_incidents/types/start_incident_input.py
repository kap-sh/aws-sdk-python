...
class StartIncidentInput(TypedDict):
...
def serialize_json(value: StartIncidentInput) -> dict:
    ...
    if "trigger_details" in value:
        ...
        out["triggerDetails"] = (
            aws_sdk_ssm_incidents.types.trigger_details.serialize_json(
    ...
    if "related_items" in value:
        ...
        out["relatedItems"] = (
            aws_sdk_ssm_incidents.types.related_item_list.serialize_json(
                value["related_items"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> StartIncidentInput:
    ...
    if "triggerDetails" in data:
        ...
        out["trigger_details"] = (
            aws_sdk_ssm_incidents.types.trigger_details.deserialize_json(
                data["triggerDetails"]
            )
        )
