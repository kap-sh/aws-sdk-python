...
from aws_sdk_ssm_incidents._services._aws_config import aws_config
...
class SSMIncidentsClientConfig(TypedDict, total=False):
...
class SSMIncidentsClient:
    ...
    def batch_get_incident_findings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.batch_get_incident_findings_input.BatchGetIncidentFindingsInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.batch_get_incident_findings_output.BatchGetIncidentFindingsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.batch_get_incident_findings.batch_get_incident_findings(
    ...
    def create_replication_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.create_replication_set_input.CreateReplicationSetInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.create_replication_set_output.CreateReplicationSetOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.create_replication_set.create_replication_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_response_plan(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.create_response_plan_input.CreateResponsePlanInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.create_response_plan_output.CreateResponsePlanOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.create_response_plan.create_response_plan(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_timeline_event(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.create_timeline_event_input.CreateTimelineEventInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.create_timeline_event_output.CreateTimelineEventOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.create_timeline_event.create_timeline_event(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_incident_record(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.delete_incident_record_input.DeleteIncidentRecordInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.delete_incident_record_output.DeleteIncidentRecordOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.delete_incident_record.delete_incident_record(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_replication_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.delete_replication_set_input.DeleteReplicationSetInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.delete_replication_set_output.DeleteReplicationSetOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.delete_replication_set.delete_replication_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.delete_resource_policy_input.DeleteResourcePolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.delete_resource_policy_output.DeleteResourcePolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.delete_resource_policy.delete_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_response_plan(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.delete_response_plan_input.DeleteResponsePlanInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.delete_response_plan_output.DeleteResponsePlanOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.delete_response_plan.delete_response_plan(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_timeline_event(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.delete_timeline_event_input.DeleteTimelineEventInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.delete_timeline_event_output.DeleteTimelineEventOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.delete_timeline_event.delete_timeline_event(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_incident_record(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.get_incident_record_input.GetIncidentRecordInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.get_incident_record_output.GetIncidentRecordOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.get_incident_record.get_incident_record(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_replication_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.get_replication_set_input.GetReplicationSetInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.get_replication_set_output.GetReplicationSetOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.get_replication_set.get_replication_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.get_resource_policies_input.GetResourcePoliciesInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.get_resource_policies_output.GetResourcePoliciesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.get_resource_policies.get_resource_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_get_resource_policies(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_ssm_incidents.types.resource_policy.ResourcePolicy]":
        _token = next_token
        while True:
    ...
    def get_response_plan(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.get_response_plan_input.GetResponsePlanInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.get_response_plan_output.GetResponsePlanOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.get_response_plan.get_response_plan(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_timeline_event(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.get_timeline_event_input.GetTimelineEventInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.get_timeline_event_output.GetTimelineEventOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.get_timeline_event.get_timeline_event(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_incident_findings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.list_incident_findings_input.ListIncidentFindingsInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.list_incident_findings_output.ListIncidentFindingsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.list_incident_findings.list_incident_findings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_incident_findings(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional["aws_sdk_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_ssm_incidents.types.finding_summary.FindingSummary]":
        _token = next_token
        while True:
    ...
    def list_incident_records(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.list_incident_records_input.ListIncidentRecordsInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.list_incident_records_output.ListIncidentRecordsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.list_incident_records.list_incident_records(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_incident_records(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_ssm_incidents.types.incident_record_summary.IncidentRecordSummary]":
        _token = next_token
        while True:
    ...
    def list_related_items(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.list_related_items_input.ListRelatedItemsInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.list_related_items_output.ListRelatedItemsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.list_related_items.list_related_items(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_related_items(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_ssm_incidents.types.related_item.RelatedItem]":
        _token = next_token
        while True:
    ...
    def list_replication_sets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.list_replication_sets_input.ListReplicationSetsInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.list_replication_sets_output.ListReplicationSetsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.list_replication_sets.list_replication_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_replication_sets(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_ssm_incidents.types.arn.Arn]":
        _token = next_token
        while True:
    ...
    def list_response_plans(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.list_response_plans_input.ListResponsePlansInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.list_response_plans_output.ListResponsePlansOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.list_response_plans.list_response_plans(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_response_plans(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_ssm_incidents.types.response_plan_summary.ResponsePlanSummary]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_timeline_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.list_timeline_events_input.ListTimelineEventsInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.list_timeline_events_output.ListTimelineEventsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.list_timeline_events.list_timeline_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_timeline_events(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_ssm_incidents.types.event_summary.EventSummary]":
        _token = next_token
        while True:
    ...
    def put_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.put_resource_policy_input.PutResourcePolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.put_resource_policy_output.PutResourcePolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.put_resource_policy.put_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_incident(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.start_incident_input.StartIncidentInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.start_incident_output.StartIncidentOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.start_incident.start_incident(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_deletion_protection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.update_deletion_protection_input.UpdateDeletionProtectionInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.update_deletion_protection_output.UpdateDeletionProtectionOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.update_deletion_protection.update_deletion_protection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_incident_record(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.update_incident_record_input.UpdateIncidentRecordInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.update_incident_record_output.UpdateIncidentRecordOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.update_incident_record.update_incident_record(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_related_items(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.update_related_items_input.UpdateRelatedItemsInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.update_related_items_output.UpdateRelatedItemsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.update_related_items.update_related_items(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_replication_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.update_replication_set_input.UpdateReplicationSetInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.update_replication_set_output.UpdateReplicationSetOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.update_replication_set.update_replication_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_response_plan(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.update_response_plan_input.UpdateResponsePlanInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.update_response_plan_output.UpdateResponsePlanOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.update_response_plan.update_response_plan(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_timeline_event(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_incidents.types.update_timeline_event_input.UpdateTimelineEventInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_incidents.types.update_timeline_event_output.UpdateTimelineEventOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_incidents._operations.ssm_incidents.update_timeline_event.update_timeline_event(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
