...
```
pip install aws-sdk-ssm-incidents
```

## Usage

```python
from aws_sdk_ssm_incidents import AsyncSSMIncidentsClient
...
```python
from aws_sdk_ssm_incidents import AsyncSSMIncidentsClient
from aws_sdk_ssm_incidents.error import AccessDeniedException
