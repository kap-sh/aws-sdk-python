...
```
pip install aws-sdk-resource-explorer-2
```

## Usage

```python
from aws_sdk_resource_explorer_2 import AsyncResourceExplorer2Client
...
```python
from aws_sdk_resource_explorer_2 import AsyncResourceExplorer2Client
from aws_sdk_resource_explorer_2.error import AccessDeniedException
