...
from ._services.async_resource_explorer2 import (
    AsyncResourceExplorer2Client as AsyncResourceExplorer2Client,
)
from ._services.resource_explorer2 import (
    ResourceExplorer2Client as ResourceExplorer2Client,
)
