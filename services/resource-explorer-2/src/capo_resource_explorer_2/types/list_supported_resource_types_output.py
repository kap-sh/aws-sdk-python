...
class ListSupportedResourceTypesOutput(TypedDict, closed=True):
    resource_types: NotRequired[
        "capo_resource_explorer_2.types.resource_type_list.ResourceTypeList"
    ]
...
def serialize_json(value: ListSupportedResourceTypesOutput) -> dict:
    ...
    if "resource_types" in value:
        ...
        out["ResourceTypes"] = (
            capo_resource_explorer_2.types.resource_type_list.serialize_json(
...
def deserialize_json(data: dict) -> ListSupportedResourceTypesOutput:
    ...
    if "ResourceTypes" in data:
        ...
        out["resource_types"] = (
            capo_resource_explorer_2.types.resource_type_list.deserialize_json(
                data["ResourceTypes"]
            )
        )
