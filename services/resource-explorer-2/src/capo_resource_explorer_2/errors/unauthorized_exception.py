"""Generated from Smithy shape ``com.amazonaws.resourceexplorer2#UnauthorizedException``."""
...
class UnauthorizedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.resourceexplorer2#UnauthorizedException``."""
