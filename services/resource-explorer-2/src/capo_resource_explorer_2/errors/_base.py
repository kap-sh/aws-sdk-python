...
class ResourceExplorer2Error(Exception):
    """Base class for all ResourceExplorer2 service errors."""


class ServiceError(ResourceExplorer2Error):
...
class SerializationError(ResourceExplorer2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(ResourceExplorer2Error):
...
class WaiterFailedError(ResourceExplorer2Error):
...
class WaiterTimeoutError(ResourceExplorer2Error):
