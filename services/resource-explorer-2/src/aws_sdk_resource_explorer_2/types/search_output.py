"""Generated from Smithy shape ``com.amazonaws.resourceexplorer2#SearchOutput``."""
...
if TYPE_CHECKING:
    import aws_sdk_resource_explorer_2.types.resource_count
...
# --- restJson1 ser/de ---
def serialize_json(value: SearchOutput) -> dict:
    out: dict = {}
    ...
    if "count" in value:
        ...
        out["Count"] = aws_sdk_resource_explorer_2.types.resource_count.serialize_json(
            value["count"]
        )
    return out
...
def deserialize_json(data: dict) -> SearchOutput:
    ...
    if "Count" in data:
        ...
        out["count"] = (
            aws_sdk_resource_explorer_2.types.resource_count.deserialize_json(
                data["Count"]
            )
        )
    return out
