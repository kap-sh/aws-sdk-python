...
class GetResourceExplorerSetupOutput(TypedDict):
    regions: NotRequired[
        "aws_sdk_resource_explorer_2.types.region_status_list.RegionStatusList"
    ]
...
def serialize_json(value: GetResourceExplorerSetupOutput) -> dict:
    ...
    if "regions" in value:
        ...
        out["Regions"] = (
            aws_sdk_resource_explorer_2.types.region_status_list.serialize_json(
                value["regions"]
            )
        )
...
def deserialize_json(data: dict) -> GetResourceExplorerSetupOutput:
    ...
    if "Regions" in data:
        ...
        out["regions"] = (
            aws_sdk_resource_explorer_2.types.region_status_list.deserialize_json(
                data["Regions"]
            )
        )
