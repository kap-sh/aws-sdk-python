...
from capo_route_53_domains._async import anysleep
from capo_route_53_domains.errors import ServiceError

if TYPE_CHECKING:
    from capo_route_53_domains._auth._identity import Credentials
    from capo_route_53_domains._auth._providers import IdentityProvider
