"""Generated from Smithy shape ``com.amazonaws.route53domains#RegisterDomain``."""
...
import capo_route_53_domains.types.register_domain_request
import capo_route_53_domains.types.register_domain_response
...
) -> capo_route_53_domains.types.register_domain_response.RegisterDomainResponse:
    out: capo_route_53_domains.types.register_domain_response.RegisterDomainResponse = (
        capo_route_53_domains.types.register_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.register_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_register_domain(
