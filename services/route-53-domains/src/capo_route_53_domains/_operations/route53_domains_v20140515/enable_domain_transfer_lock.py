"""Generated from Smithy shape ``com.amazonaws.route53domains#EnableDomainTransferLock``."""
...
import capo_route_53_domains.types.enable_domain_transfer_lock_request
import capo_route_53_domains.types.enable_domain_transfer_lock_response
...
) -> capo_route_53_domains.types.enable_domain_transfer_lock_response.EnableDomainTransferLockResponse:
    out: capo_route_53_domains.types.enable_domain_transfer_lock_response.EnableDomainTransferLockResponse = capo_route_53_domains.types.enable_domain_transfer_lock_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.enable_domain_transfer_lock_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_enable_domain_transfer_lock(
