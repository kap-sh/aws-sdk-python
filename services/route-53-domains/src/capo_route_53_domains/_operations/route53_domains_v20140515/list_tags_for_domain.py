"""Generated from Smithy shape ``com.amazonaws.route53domains#ListTagsForDomain``."""
...
import capo_route_53_domains.types.list_tags_for_domain_request
import capo_route_53_domains.types.list_tags_for_domain_response
...
def handle_response(
    ...
    capo_route_53_domains.types.list_tags_for_domain_response.ListTagsForDomainResponse
):
    out: capo_route_53_domains.types.list_tags_for_domain_response.ListTagsForDomainResponse = capo_route_53_domains.types.list_tags_for_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.list_tags_for_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_tags_for_domain(
