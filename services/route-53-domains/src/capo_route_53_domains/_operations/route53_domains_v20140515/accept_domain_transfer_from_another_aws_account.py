"""Generated from Smithy shape ``com.amazonaws.route53domains#AcceptDomainTransferFromAnotherAwsAccount``."""
...
import capo_route_53_domains.errors.domain_limit_exceeded
...
import capo_route_53_domains.types.accept_domain_transfer_from_another_aws_account_request
import capo_route_53_domains.types.accept_domain_transfer_from_another_aws_account_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DomainLimitExceeded":
            raise capo_route_53_domains.errors.domain_limit_exceeded.DomainLimitExceeded.from_aws_json_1_1(
                data
            )
        case "InvalidInput":
...
) -> capo_route_53_domains.types.accept_domain_transfer_from_another_aws_account_response.AcceptDomainTransferFromAnotherAwsAccountResponse:
    out: capo_route_53_domains.types.accept_domain_transfer_from_another_aws_account_response.AcceptDomainTransferFromAnotherAwsAccountResponse = capo_route_53_domains.types.accept_domain_transfer_from_another_aws_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.accept_domain_transfer_from_another_aws_account_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_accept_domain_transfer_from_another_aws_account(
