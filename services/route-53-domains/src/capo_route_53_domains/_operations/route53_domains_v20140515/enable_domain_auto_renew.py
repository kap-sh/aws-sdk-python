"""Generated from Smithy shape ``com.amazonaws.route53domains#EnableDomainAutoRenew``."""
...
import capo_route_53_domains.types.enable_domain_auto_renew_request
import capo_route_53_domains.types.enable_domain_auto_renew_response
...
) -> capo_route_53_domains.types.enable_domain_auto_renew_response.EnableDomainAutoRenewResponse:
    out: capo_route_53_domains.types.enable_domain_auto_renew_response.EnableDomainAutoRenewResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.enable_domain_auto_renew_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_enable_domain_auto_renew(
