"""Generated from Smithy shape ``com.amazonaws.route53domains#CancelDomainTransferToAnotherAwsAccount``."""
...
import capo_route_53_domains.types.cancel_domain_transfer_to_another_aws_account_request
import capo_route_53_domains.types.cancel_domain_transfer_to_another_aws_account_response
...
) -> capo_route_53_domains.types.cancel_domain_transfer_to_another_aws_account_response.CancelDomainTransferToAnotherAwsAccountResponse:
    out: capo_route_53_domains.types.cancel_domain_transfer_to_another_aws_account_response.CancelDomainTransferToAnotherAwsAccountResponse = capo_route_53_domains.types.cancel_domain_transfer_to_another_aws_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.cancel_domain_transfer_to_another_aws_account_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_cancel_domain_transfer_to_another_aws_account(
