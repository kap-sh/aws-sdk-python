"""Generated from Smithy shape ``com.amazonaws.route53domains#GetContactReachabilityStatus``."""
...
import capo_route_53_domains.types.get_contact_reachability_status_request
import capo_route_53_domains.types.get_contact_reachability_status_response
...
) -> capo_route_53_domains.types.get_contact_reachability_status_response.GetContactReachabilityStatusResponse:
    out: capo_route_53_domains.types.get_contact_reachability_status_response.GetContactReachabilityStatusResponse = capo_route_53_domains.types.get_contact_reachability_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.get_contact_reachability_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_contact_reachability_status(
