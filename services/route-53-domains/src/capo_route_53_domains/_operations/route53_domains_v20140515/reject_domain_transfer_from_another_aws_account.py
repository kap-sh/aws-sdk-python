"""Generated from Smithy shape ``com.amazonaws.route53domains#RejectDomainTransferFromAnotherAwsAccount``."""
...
import capo_route_53_domains.types.reject_domain_transfer_from_another_aws_account_request
import capo_route_53_domains.types.reject_domain_transfer_from_another_aws_account_response
...
) -> capo_route_53_domains.types.reject_domain_transfer_from_another_aws_account_response.RejectDomainTransferFromAnotherAwsAccountResponse:
    out: capo_route_53_domains.types.reject_domain_transfer_from_another_aws_account_response.RejectDomainTransferFromAnotherAwsAccountResponse = capo_route_53_domains.types.reject_domain_transfer_from_another_aws_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.reject_domain_transfer_from_another_aws_account_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_reject_domain_transfer_from_another_aws_account(
