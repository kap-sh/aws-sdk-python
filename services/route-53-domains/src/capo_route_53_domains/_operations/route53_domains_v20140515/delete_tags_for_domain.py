"""Generated from Smithy shape ``com.amazonaws.route53domains#DeleteTagsForDomain``."""
...
import capo_route_53_domains.types.delete_tags_for_domain_request
import capo_route_53_domains.types.delete_tags_for_domain_response
...
) -> capo_route_53_domains.types.delete_tags_for_domain_response.DeleteTagsForDomainResponse:
    out: capo_route_53_domains.types.delete_tags_for_domain_response.DeleteTagsForDomainResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.delete_tags_for_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_tags_for_domain(
