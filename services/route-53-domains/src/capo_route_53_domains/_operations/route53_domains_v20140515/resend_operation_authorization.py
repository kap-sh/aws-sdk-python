"""Generated from Smithy shape ``com.amazonaws.route53domains#ResendOperationAuthorization``."""
...
import capo_route_53_domains.types.resend_operation_authorization_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Domains_v20140515.ResendOperationAuthorization"
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.resend_operation_authorization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_resend_operation_authorization(
