"""Generated from Smithy shape ``com.amazonaws.route53domains#AssociateDelegationSignerToDomain``."""
...
import capo_route_53_domains.errors.dnssec_limit_exceeded
...
import capo_route_53_domains.types.associate_delegation_signer_to_domain_request
import capo_route_53_domains.types.associate_delegation_signer_to_domain_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DnssecLimitExceeded":
            raise capo_route_53_domains.errors.dnssec_limit_exceeded.DnssecLimitExceeded.from_aws_json_1_1(
                data
            )
...
) -> capo_route_53_domains.types.associate_delegation_signer_to_domain_response.AssociateDelegationSignerToDomainResponse:
    out: capo_route_53_domains.types.associate_delegation_signer_to_domain_response.AssociateDelegationSignerToDomainResponse = capo_route_53_domains.types.associate_delegation_signer_to_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.associate_delegation_signer_to_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_delegation_signer_to_domain(
