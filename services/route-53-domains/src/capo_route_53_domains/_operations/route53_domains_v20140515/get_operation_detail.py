"""Generated from Smithy shape ``com.amazonaws.route53domains#GetOperationDetail``."""
...
import capo_route_53_domains.types.get_operation_detail_request
import capo_route_53_domains.types.get_operation_detail_response
...
def handle_response(
    ...
    capo_route_53_domains.types.get_operation_detail_response.GetOperationDetailResponse
):
    out: capo_route_53_domains.types.get_operation_detail_response.GetOperationDetailResponse = capo_route_53_domains.types.get_operation_detail_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.get_operation_detail_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_operation_detail(
