"""Generated from Smithy shape ``com.amazonaws.route53domains#UpdateTagsForDomain``."""
...
import capo_route_53_domains.types.update_tags_for_domain_request
import capo_route_53_domains.types.update_tags_for_domain_response
...
) -> capo_route_53_domains.types.update_tags_for_domain_response.UpdateTagsForDomainResponse:
    out: capo_route_53_domains.types.update_tags_for_domain_response.UpdateTagsForDomainResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.update_tags_for_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_tags_for_domain(
