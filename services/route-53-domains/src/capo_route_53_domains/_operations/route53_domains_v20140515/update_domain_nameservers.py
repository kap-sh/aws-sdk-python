...
import capo_route_53_domains.types.update_domain_nameservers_request
import capo_route_53_domains.types.update_domain_nameservers_response
...
) -> capo_route_53_domains.types.update_domain_nameservers_response.UpdateDomainNameserversResponse:
    out: capo_route_53_domains.types.update_domain_nameservers_response.UpdateDomainNameserversResponse = capo_route_53_domains.types.update_domain_nameservers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.update_domain_nameservers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
