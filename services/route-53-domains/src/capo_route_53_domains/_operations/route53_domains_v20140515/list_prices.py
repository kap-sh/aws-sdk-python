"""Generated from Smithy shape ``com.amazonaws.route53domains#ListPrices``."""
...
import capo_route_53_domains.types.list_prices_request
import capo_route_53_domains.types.list_prices_response
...
) -> capo_route_53_domains.types.list_prices_response.ListPricesResponse:
    out: capo_route_53_domains.types.list_prices_response.ListPricesResponse = (
        capo_route_53_domains.types.list_prices_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.list_prices_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_prices(
    ...
    capo_route_53_domains.types.list_prices_response.ListPricesResponse, zapros.Response
]:
