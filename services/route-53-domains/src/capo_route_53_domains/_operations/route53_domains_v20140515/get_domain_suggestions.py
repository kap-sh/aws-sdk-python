"""Generated from Smithy shape ``com.amazonaws.route53domains#GetDomainSuggestions``."""
...
import capo_route_53_domains.types.get_domain_suggestions_request
import capo_route_53_domains.types.get_domain_suggestions_response
...
) -> capo_route_53_domains.types.get_domain_suggestions_response.GetDomainSuggestionsResponse:
    out: capo_route_53_domains.types.get_domain_suggestions_response.GetDomainSuggestionsResponse = capo_route_53_domains.types.get_domain_suggestions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.get_domain_suggestions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_domain_suggestions(
