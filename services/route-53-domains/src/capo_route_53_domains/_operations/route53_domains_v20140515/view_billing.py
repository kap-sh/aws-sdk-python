"""Generated from Smithy shape ``com.amazonaws.route53domains#ViewBilling``."""
...
import capo_route_53_domains.types.view_billing_request
import capo_route_53_domains.types.view_billing_response
...
) -> capo_route_53_domains.types.view_billing_response.ViewBillingResponse:
    out: capo_route_53_domains.types.view_billing_response.ViewBillingResponse = (
        capo_route_53_domains.types.view_billing_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.view_billing_request.serialize_aws_json_1_1(input_)
    ).encode()
