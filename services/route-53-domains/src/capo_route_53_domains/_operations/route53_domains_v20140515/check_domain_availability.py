"""Generated from Smithy shape ``com.amazonaws.route53domains#CheckDomainAvailability``."""
...
import capo_route_53_domains.errors.tld_in_maintenance
import capo_route_53_domains.errors.unsupported_tld
import capo_route_53_domains.types.check_domain_availability_request
import capo_route_53_domains.types.check_domain_availability_response
import capo_route_53_domains.types.domain_availability
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TLDInMaintenance":
            raise capo_route_53_domains.errors.tld_in_maintenance.TLDInMaintenance.from_aws_json_1_1(
                data
            )
        case "UnsupportedTLD":
...
) -> capo_route_53_domains.types.check_domain_availability_response.CheckDomainAvailabilityResponse:
    out: capo_route_53_domains.types.check_domain_availability_response.CheckDomainAvailabilityResponse = capo_route_53_domains.types.check_domain_availability_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.check_domain_availability_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_check_domain_availability(
