...
class Route53DomainsError(Exception):
    """Base class for all Route53Domains service errors."""


class ServiceError(Route53DomainsError):
...
class SerializationError(Route53DomainsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(Route53DomainsError):
...
class WaiterFailedError(Route53DomainsError):
...
class WaiterTimeoutError(Route53DomainsError):
