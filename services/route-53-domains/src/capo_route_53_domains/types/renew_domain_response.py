"""Generated from Smithy shape ``com.amazonaws.route53domains#RenewDomainResponse``."""
...
class RenewDomainResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: RenewDomainResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> RenewDomainResponse:
    out: RenewDomainResponse = {}  # type: ignore[typeddict-item]
