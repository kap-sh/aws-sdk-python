"""Generated from Smithy shape ``com.amazonaws.route53domains#TransferDomainResponse``."""
...
class TransferDomainResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: TransferDomainResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> TransferDomainResponse:
    out: TransferDomainResponse = {}  # type: ignore[typeddict-item]
