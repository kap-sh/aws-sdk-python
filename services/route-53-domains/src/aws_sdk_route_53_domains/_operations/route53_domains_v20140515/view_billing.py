...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.view_billing_response.ViewBillingResponse = (
        aws_sdk_route_53_domains.types.view_billing_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.view_billing_request.ViewBillingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.view_billing_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
