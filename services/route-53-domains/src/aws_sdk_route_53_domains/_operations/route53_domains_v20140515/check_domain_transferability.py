"""Generated from Smithy shape ``com.amazonaws.route53domains#CheckDomainTransferability``."""
...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.check_domain_transferability_response.CheckDomainTransferabilityResponse = aws_sdk_route_53_domains.types.check_domain_transferability_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.check_domain_transferability_request.CheckDomainTransferabilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.check_domain_transferability_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_check_domain_transferability(
