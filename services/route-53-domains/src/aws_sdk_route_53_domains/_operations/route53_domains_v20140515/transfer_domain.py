"""Generated from Smithy shape ``com.amazonaws.route53domains#TransferDomain``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DomainLimitExceeded":
            import aws_sdk_route_53_domains.errors.domain_limit_exceeded

            raise aws_sdk_route_53_domains.errors.domain_limit_exceeded.DomainLimitExceeded.from_aws_json_1_1(
                data
            )
        ...
        case "TLDRulesViolation":
            import aws_sdk_route_53_domains.errors.tld_rules_violation

            raise aws_sdk_route_53_domains.errors.tld_rules_violation.TLDRulesViolation.from_aws_json_1_1(
                data
            )
        case "UnsupportedTLD":
...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.transfer_domain_response.TransferDomainResponse = aws_sdk_route_53_domains.types.transfer_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.transfer_domain_request.TransferDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.transfer_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_transfer_domain(
