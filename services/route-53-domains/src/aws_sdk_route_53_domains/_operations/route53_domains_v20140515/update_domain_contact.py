...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.update_domain_contact_response.UpdateDomainContactResponse = aws_sdk_route_53_domains.types.update_domain_contact_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.update_domain_contact_request.UpdateDomainContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.update_domain_contact_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
