...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.register_domain_response.RegisterDomainResponse = aws_sdk_route_53_domains.types.register_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.register_domain_request.RegisterDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.register_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
