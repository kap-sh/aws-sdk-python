...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.cancel_domain_transfer_to_another_aws_account_response.CancelDomainTransferToAnotherAwsAccountResponse = aws_sdk_route_53_domains.types.cancel_domain_transfer_to_another_aws_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.cancel_domain_transfer_to_another_aws_account_request.CancelDomainTransferToAnotherAwsAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
