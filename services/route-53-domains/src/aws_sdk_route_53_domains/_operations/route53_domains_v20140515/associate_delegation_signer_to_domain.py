...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DnssecLimitExceeded":
            import aws_sdk_route_53_domains.errors.dnssec_limit_exceeded

            raise aws_sdk_route_53_domains.errors.dnssec_limit_exceeded.DnssecLimitExceeded.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.associate_delegation_signer_to_domain_response.AssociateDelegationSignerToDomainResponse = aws_sdk_route_53_domains.types.associate_delegation_signer_to_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.associate_delegation_signer_to_domain_request.AssociateDelegationSignerToDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.associate_delegation_signer_to_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
