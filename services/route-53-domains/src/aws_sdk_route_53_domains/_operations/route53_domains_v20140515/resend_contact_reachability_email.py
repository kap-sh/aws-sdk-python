"""Generated from Smithy shape ``com.amazonaws.route53domains#ResendContactReachabilityEmail``."""
...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.resend_contact_reachability_email_response.ResendContactReachabilityEmailResponse = aws_sdk_route_53_domains.types.resend_contact_reachability_email_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.resend_contact_reachability_email_request.ResendContactReachabilityEmailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.resend_contact_reachability_email_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_resend_contact_reachability_email(
