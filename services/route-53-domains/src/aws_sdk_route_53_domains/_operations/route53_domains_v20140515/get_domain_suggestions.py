...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.get_domain_suggestions_response.GetDomainSuggestionsResponse = aws_sdk_route_53_domains.types.get_domain_suggestions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.get_domain_suggestions_request.GetDomainSuggestionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.get_domain_suggestions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
