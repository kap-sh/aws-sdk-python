...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.enable_domain_auto_renew_response.EnableDomainAutoRenewResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.enable_domain_auto_renew_request.EnableDomainAutoRenewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.enable_domain_auto_renew_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
