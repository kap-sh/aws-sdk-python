...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.renew_domain_response.RenewDomainResponse = (
        aws_sdk_route_53_domains.types.renew_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.renew_domain_request.RenewDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
