...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.check_domain_availability_response.CheckDomainAvailabilityResponse = aws_sdk_route_53_domains.types.check_domain_availability_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.check_domain_availability_request.CheckDomainAvailabilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.check_domain_availability_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
