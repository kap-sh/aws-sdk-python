...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.get_contact_reachability_status_response.GetContactReachabilityStatusResponse = aws_sdk_route_53_domains.types.get_contact_reachability_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.get_contact_reachability_status_request.GetContactReachabilityStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.get_contact_reachability_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
