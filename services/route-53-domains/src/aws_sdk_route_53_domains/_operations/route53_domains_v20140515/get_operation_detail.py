...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.get_operation_detail_response.GetOperationDetailResponse = aws_sdk_route_53_domains.types.get_operation_detail_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.get_operation_detail_request.GetOperationDetailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
