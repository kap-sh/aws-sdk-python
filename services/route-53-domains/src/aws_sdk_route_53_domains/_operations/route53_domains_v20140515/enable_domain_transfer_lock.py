...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.enable_domain_transfer_lock_response.EnableDomainTransferLockResponse = aws_sdk_route_53_domains.types.enable_domain_transfer_lock_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.enable_domain_transfer_lock_request.EnableDomainTransferLockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
