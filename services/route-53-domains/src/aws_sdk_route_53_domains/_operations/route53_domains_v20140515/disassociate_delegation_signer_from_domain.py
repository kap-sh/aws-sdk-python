...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.disassociate_delegation_signer_from_domain_response.DisassociateDelegationSignerFromDomainResponse = aws_sdk_route_53_domains.types.disassociate_delegation_signer_from_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.disassociate_delegation_signer_from_domain_request.DisassociateDelegationSignerFromDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
