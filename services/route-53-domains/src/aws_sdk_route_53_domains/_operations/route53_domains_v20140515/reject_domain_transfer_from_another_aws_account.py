...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.reject_domain_transfer_from_another_aws_account_response.RejectDomainTransferFromAnotherAwsAccountResponse = aws_sdk_route_53_domains.types.reject_domain_transfer_from_another_aws_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.reject_domain_transfer_from_another_aws_account_request.RejectDomainTransferFromAnotherAwsAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
