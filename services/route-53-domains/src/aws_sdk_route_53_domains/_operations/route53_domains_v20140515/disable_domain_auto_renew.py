...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.disable_domain_auto_renew_response.DisableDomainAutoRenewResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.disable_domain_auto_renew_request.DisableDomainAutoRenewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.disable_domain_auto_renew_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
