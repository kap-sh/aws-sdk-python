...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.list_operations_response.ListOperationsResponse = aws_sdk_route_53_domains.types.list_operations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.list_operations_request.ListOperationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.list_operations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
