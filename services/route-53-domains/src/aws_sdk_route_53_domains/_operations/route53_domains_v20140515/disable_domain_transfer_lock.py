"""Generated from Smithy shape ``com.amazonaws.route53domains#DisableDomainTransferLock``."""
...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.disable_domain_transfer_lock_response.DisableDomainTransferLockResponse = aws_sdk_route_53_domains.types.disable_domain_transfer_lock_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.disable_domain_transfer_lock_request.DisableDomainTransferLockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.disable_domain_transfer_lock_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disable_domain_transfer_lock(
