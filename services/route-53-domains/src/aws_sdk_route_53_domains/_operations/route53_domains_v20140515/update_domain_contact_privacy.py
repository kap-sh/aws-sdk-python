"""Generated from Smithy shape ``com.amazonaws.route53domains#UpdateDomainContactPrivacy``."""
...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.update_domain_contact_privacy_response.UpdateDomainContactPrivacyResponse = aws_sdk_route_53_domains.types.update_domain_contact_privacy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.update_domain_contact_privacy_request.UpdateDomainContactPrivacyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_domain_contact_privacy(
