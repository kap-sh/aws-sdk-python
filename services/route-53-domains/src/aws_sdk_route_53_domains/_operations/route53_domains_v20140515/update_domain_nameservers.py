"""Generated from Smithy shape ``com.amazonaws.route53domains#UpdateDomainNameservers``."""
...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.update_domain_nameservers_response.UpdateDomainNameserversResponse = aws_sdk_route_53_domains.types.update_domain_nameservers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.update_domain_nameservers_request.UpdateDomainNameserversRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.update_domain_nameservers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_domain_nameservers(
