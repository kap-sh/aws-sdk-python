...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.accept_domain_transfer_from_another_aws_account_response.AcceptDomainTransferFromAnotherAwsAccountResponse = aws_sdk_route_53_domains.types.accept_domain_transfer_from_another_aws_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.accept_domain_transfer_from_another_aws_account_request.AcceptDomainTransferFromAnotherAwsAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.accept_domain_transfer_from_another_aws_account_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
