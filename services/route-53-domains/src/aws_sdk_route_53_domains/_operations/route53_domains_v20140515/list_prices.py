...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.list_prices_response.ListPricesResponse = (
        aws_sdk_route_53_domains.types.list_prices_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_route_53_domains.types.list_prices_request.ListPricesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.list_prices_request.serialize_aws_json_1_1(input)
    ).encode()
