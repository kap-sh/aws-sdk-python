"""Generated from Smithy shape ``com.amazonaws.route53domains#ListDomains``."""
...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.list_domains_response.ListDomainsResponse = (
        aws_sdk_route_53_domains.types.list_domains_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.list_domains_request.ListDomainsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.list_domains_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
