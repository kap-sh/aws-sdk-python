...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.update_tags_for_domain_response.UpdateTagsForDomainResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.update_tags_for_domain_request.UpdateTagsForDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.update_tags_for_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
