...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.resend_operation_authorization_request.ResendOperationAuthorizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.resend_operation_authorization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
