...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.delete_tags_for_domain_response.DeleteTagsForDomainResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.delete_tags_for_domain_request.DeleteTagsForDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.delete_tags_for_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
