...
def build_request(
    ...
    input: aws_sdk_route_53_domains.types.push_domain_request.PushDomainRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.push_domain_request.serialize_aws_json_1_1(input)
    ).encode()
