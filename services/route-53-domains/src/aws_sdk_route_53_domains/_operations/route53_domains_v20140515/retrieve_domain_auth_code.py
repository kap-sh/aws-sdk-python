...
def handle_response(
    ...
    out: aws_sdk_route_53_domains.types.retrieve_domain_auth_code_response.RetrieveDomainAuthCodeResponse = aws_sdk_route_53_domains.types.retrieve_domain_auth_code_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route_53_domains.types.retrieve_domain_auth_code_request.RetrieveDomainAuthCodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route_53_domains.types.retrieve_domain_auth_code_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
