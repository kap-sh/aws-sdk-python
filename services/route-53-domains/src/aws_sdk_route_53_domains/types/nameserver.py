...
if TYPE_CHECKING:
    import aws_sdk_route_53_domains.types.glue_ip_list
...
def serialize_aws_json_1_1(value: Nameserver) -> dict:
    ...
    if "glue_ips" in value:
        ...
        out["GlueIps"] = (
            aws_sdk_route_53_domains.types.glue_ip_list.serialize_aws_json_1_1(
                value["glue_ips"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Nameserver:
    ...
    if "GlueIps" in data:
        ...
        out["glue_ips"] = (
            aws_sdk_route_53_domains.types.glue_ip_list.deserialize_aws_json_1_1(
                data["GlueIps"]
            )
        )
    return out
