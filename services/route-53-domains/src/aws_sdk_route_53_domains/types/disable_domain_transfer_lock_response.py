"""Generated from Smithy shape ``com.amazonaws.route53domains#DisableDomainTransferLockResponse``."""
...
class DisableDomainTransferLockResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DisableDomainTransferLockResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DisableDomainTransferLockResponse:
    out: DisableDomainTransferLockResponse = {}  # type: ignore[typeddict-item]
