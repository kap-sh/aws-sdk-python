...
if TYPE_CHECKING:
    import aws_sdk_route_53_domains.types.domain_price_list
    import aws_sdk_route_53_domains.types.page_marker


class ListPricesResponse(TypedDict):
    prices: NotRequired[
        "aws_sdk_route_53_domains.types.domain_price_list.DomainPriceList"
    ]
...
def serialize_aws_json_1_1(value: ListPricesResponse) -> dict:
    ...
    if "prices" in value:
        ...
        out["Prices"] = (
            aws_sdk_route_53_domains.types.domain_price_list.serialize_aws_json_1_1(
                value["prices"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListPricesResponse:
    ...
    if "Prices" in data:
        ...
        out["prices"] = (
            aws_sdk_route_53_domains.types.domain_price_list.deserialize_aws_json_1_1(
                data["Prices"]
            )
        )
