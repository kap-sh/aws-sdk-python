...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateDomainNameserversResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UpdateDomainNameserversResponse:
    out: UpdateDomainNameserversResponse = {}  # type: ignore[typeddict-item]
