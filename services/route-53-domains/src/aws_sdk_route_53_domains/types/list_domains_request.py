...
def serialize_aws_json_1_1(value: ListDomainsRequest) -> dict:
    ...
    if "filter_conditions" in value:
        ...
        out["FilterConditions"] = (
            aws_sdk_route_53_domains.types.filter_conditions.serialize_aws_json_1_1(
    ...
    if "sort_condition" in value:
        ...
        out["SortCondition"] = (
            aws_sdk_route_53_domains.types.sort_condition.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListDomainsRequest:
    ...
    if "FilterConditions" in data:
        ...
        out["filter_conditions"] = (
            aws_sdk_route_53_domains.types.filter_conditions.deserialize_aws_json_1_1(
    ...
    if "SortCondition" in data:
        ...
        out["sort_condition"] = (
            aws_sdk_route_53_domains.types.sort_condition.deserialize_aws_json_1_1(
                data["SortCondition"]
            )
        )
    if "Marker" in data:
