...
if TYPE_CHECKING:
    import capo_budgets.types.resource_tag_key
    import capo_budgets.types.resource_tag_value


class ResourceTag(TypedDict, closed=True):
    key: "capo_budgets.types.resource_tag_key.ResourceTagKey"
    """<p>The key that's associated with the tag.</p>"""
    value: "capo_budgets.types.resource_tag_value.ResourceTagValue"
