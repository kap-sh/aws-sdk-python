...
class HealthStatus(TypedDict, closed=True):
    status: NotRequired["capo_budgets.types.health_status_value.HealthStatusValue"]
    """<p>The current status of the billing view resource.</p>"""
    status_reason: NotRequired[
        "capo_budgets.types.health_status_reason.HealthStatusReason"
    ]
    ...
    last_updated_time: NotRequired[
        "capo_budgets.types.generic_timestamp.GenericTimestamp"
    ]
...
def serialize_aws_json_1_1(value: HealthStatus) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = capo_budgets.types.health_status_value.serialize_aws_json_1_1(
            value["status"]
        )
    if "status_reason" in value:
        ...
        out["StatusReason"] = (
            capo_budgets.types.health_status_reason.serialize_aws_json_1_1(
                value["status_reason"]
            )
        )
    if "last_updated_time" in value:
        ...
        out["LastUpdatedTime"] = (
            capo_budgets.types.generic_timestamp.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> HealthStatus:
    ...
    if "StatusReason" in data:
        ...
        out["status_reason"] = (
            capo_budgets.types.health_status_reason.deserialize_aws_json_1_1(
                data["StatusReason"]
            )
        )
