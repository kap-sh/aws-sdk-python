...
class TimePeriod(TypedDict, closed=True):
    start: NotRequired["capo_budgets.types.generic_timestamp.GenericTimestamp"]
    ...
    end: NotRequired["capo_budgets.types.generic_timestamp.GenericTimestamp"]
...
def serialize_aws_json_1_1(value: TimePeriod) -> dict:
    ...
    if "start" in value:
        ...
        out["Start"] = capo_budgets.types.generic_timestamp.serialize_aws_json_1_1(
            value["start"]
        )
    if "end" in value:
        import capo_budgets.types.generic_timestamp

        out["End"] = capo_budgets.types.generic_timestamp.serialize_aws_json_1_1(
            value["end"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> TimePeriod:
    ...
    if "Start" in data:
        ...
        out["start"] = capo_budgets.types.generic_timestamp.deserialize_aws_json_1_1(
            data["Start"]
        )
    if "End" in data:
        import capo_budgets.types.generic_timestamp

        out["end"] = capo_budgets.types.generic_timestamp.deserialize_aws_json_1_1(
            data["End"]
        )
    return out
