"""Generated from Smithy shape ``com.amazonaws.budgets#InvalidNextTokenException``."""
...
class InvalidNextTokenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.budgets#InvalidNextTokenException``."""
