"""Generated from Smithy shape ``com.amazonaws.budgets#InvalidParameterException``."""
...
class InvalidParameterException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.budgets#InvalidParameterException``."""
