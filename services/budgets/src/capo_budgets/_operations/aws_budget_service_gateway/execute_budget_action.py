"""Generated from Smithy shape ``com.amazonaws.budgets#ExecuteBudgetAction``."""
...
import capo_budgets.errors.resource_locked_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceLockedException":
            raise capo_budgets.errors.resource_locked_exception.ResourceLockedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_budgets.types.execute_budget_action_response.ExecuteBudgetActionResponse = capo_budgets.types.execute_budget_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBudgetServiceGateway.ExecuteBudgetAction"
    body: bytes | None = json.dumps(
        capo_budgets.types.execute_budget_action_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_execute_budget_action(
