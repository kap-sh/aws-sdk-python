"""Generated from Smithy shape ``com.amazonaws.budgets#DeleteBudget``."""
...
def handle_response(
    ...
    out: capo_budgets.types.delete_budget_response.DeleteBudgetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_budgets.types.delete_budget_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_budget(
    ...
    capo_budgets.types.delete_budget_response.DeleteBudgetResponse, zapros.Response
]:
