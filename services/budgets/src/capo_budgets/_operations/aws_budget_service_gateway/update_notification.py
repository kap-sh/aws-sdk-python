"""Generated from Smithy shape ``com.amazonaws.budgets#UpdateNotification``."""
...
def handle_response(
    ...
    out: capo_budgets.types.update_notification_response.UpdateNotificationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_budgets.types.update_notification_request.serialize_aws_json_1_1(input_)
    ).encode()
