"""Generated from Smithy shape ``com.amazonaws.budgets#DescribeBudgetNotificationsForAccount``."""
...
def handle_response(
    ...
    out: capo_budgets.types.describe_budget_notifications_for_account_response.DescribeBudgetNotificationsForAccountResponse = capo_budgets.types.describe_budget_notifications_for_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_budgets.types.describe_budget_notifications_for_account_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_budget_notifications_for_account(
