"""Generated from Smithy shape ``com.amazonaws.budgets#DescribeBudgetAction``."""
...
def handle_response(
    ...
    out: capo_budgets.types.describe_budget_action_response.DescribeBudgetActionResponse = capo_budgets.types.describe_budget_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBudgetServiceGateway.DescribeBudgetAction"
    body: bytes | None = json.dumps(
        capo_budgets.types.describe_budget_action_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_budget_action(
