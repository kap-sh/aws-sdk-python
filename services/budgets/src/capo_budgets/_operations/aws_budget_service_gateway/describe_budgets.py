"""Generated from Smithy shape ``com.amazonaws.budgets#DescribeBudgets``."""
...
def handle_response(
    ...
    out: capo_budgets.types.describe_budgets_response.DescribeBudgetsResponse = (
        capo_budgets.types.describe_budgets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_budgets.types.describe_budgets_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_budgets(
