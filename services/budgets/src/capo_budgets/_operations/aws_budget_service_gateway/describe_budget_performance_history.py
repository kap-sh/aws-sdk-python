"""Generated from Smithy shape ``com.amazonaws.budgets#DescribeBudgetPerformanceHistory``."""
...
import capo_budgets.errors.expired_next_token_exception
import capo_budgets.errors.internal_error_exception
import capo_budgets.errors.invalid_next_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ExpiredNextTokenException":
            raise capo_budgets.errors.expired_next_token_exception.ExpiredNextTokenException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidNextTokenException":
            raise capo_budgets.errors.invalid_next_token_exception.InvalidNextTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_budgets.types.describe_budget_performance_history_response.DescribeBudgetPerformanceHistoryResponse = capo_budgets.types.describe_budget_performance_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBudgetServiceGateway.DescribeBudgetPerformanceHistory"
    body: bytes | None = json.dumps(
        capo_budgets.types.describe_budget_performance_history_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_budget_performance_history(
