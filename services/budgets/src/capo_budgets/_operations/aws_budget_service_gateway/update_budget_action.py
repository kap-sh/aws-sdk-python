"""Generated from Smithy shape ``com.amazonaws.budgets#UpdateBudgetAction``."""
...
def handle_response(
    ...
    out: capo_budgets.types.update_budget_action_response.UpdateBudgetActionResponse = (
        capo_budgets.types.update_budget_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_budgets.types.update_budget_action_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_budget_action(
