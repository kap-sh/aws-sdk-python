"""Generated from Smithy shape ``com.amazonaws.budgets#DescribeBudgetActionHistories``."""
...
def handle_response(
    ...
    out: capo_budgets.types.describe_budget_action_histories_response.DescribeBudgetActionHistoriesResponse = capo_budgets.types.describe_budget_action_histories_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBudgetServiceGateway.DescribeBudgetActionHistories"
    body: bytes | None = json.dumps(
        capo_budgets.types.describe_budget_action_histories_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_budget_action_histories(
