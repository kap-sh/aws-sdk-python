"""Generated from Smithy shape ``com.amazonaws.budgets#UpdateBudget``."""
...
def handle_response(
    ...
    out: capo_budgets.types.update_budget_response.UpdateBudgetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_budgets.types.update_budget_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_budget(
    ...
    capo_budgets.types.update_budget_response.UpdateBudgetResponse, zapros.Response
]:
