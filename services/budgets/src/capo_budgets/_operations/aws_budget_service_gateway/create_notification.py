...
def handle_response(
    ...
    out: capo_budgets.types.create_notification_response.CreateNotificationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_budgets.types.create_notification_request.serialize_aws_json_1_1(input_)
    ).encode()
