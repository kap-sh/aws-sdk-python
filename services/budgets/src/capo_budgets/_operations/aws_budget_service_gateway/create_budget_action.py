"""Generated from Smithy shape ``com.amazonaws.budgets#CreateBudgetAction``."""
...
def handle_response(
    ...
    out: capo_budgets.types.create_budget_action_response.CreateBudgetActionResponse = (
        capo_budgets.types.create_budget_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBudgetServiceGateway.CreateBudgetAction"
    body: bytes | None = json.dumps(
        capo_budgets.types.create_budget_action_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_budget_action(
