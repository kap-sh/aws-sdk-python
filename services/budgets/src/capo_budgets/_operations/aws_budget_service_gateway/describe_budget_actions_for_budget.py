"""Generated from Smithy shape ``com.amazonaws.budgets#DescribeBudgetActionsForBudget``."""
...
def handle_response(
    ...
    out: capo_budgets.types.describe_budget_actions_for_budget_response.DescribeBudgetActionsForBudgetResponse = capo_budgets.types.describe_budget_actions_for_budget_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBudgetServiceGateway.DescribeBudgetActionsForBudget"
    body: bytes | None = json.dumps(
        capo_budgets.types.describe_budget_actions_for_budget_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_budget_actions_for_budget(
