"""Generated from Smithy shape ``com.amazonaws.budgets#DescribeNotificationsForBudget``."""
...
def handle_response(
    ...
    out: capo_budgets.types.describe_notifications_for_budget_response.DescribeNotificationsForBudgetResponse = capo_budgets.types.describe_notifications_for_budget_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBudgetServiceGateway.DescribeNotificationsForBudget"
    body: bytes | None = json.dumps(
        capo_budgets.types.describe_notifications_for_budget_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_notifications_for_budget(
