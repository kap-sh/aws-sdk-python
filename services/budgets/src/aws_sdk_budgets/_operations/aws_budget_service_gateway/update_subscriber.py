...
def handle_response(
    ...
    out: aws_sdk_budgets.types.update_subscriber_response.UpdateSubscriberResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_budgets.types.update_subscriber_request.UpdateSubscriberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.update_subscriber_request.serialize_aws_json_1_1(input_)
    ).encode()
