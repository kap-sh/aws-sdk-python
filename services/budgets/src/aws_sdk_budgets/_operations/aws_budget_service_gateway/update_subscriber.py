...
def build_request(
    ...
    input: aws_sdk_budgets.types.update_subscriber_request.UpdateSubscriberRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.update_subscriber_request.serialize_aws_json_1_1(input)
    ).encode()
