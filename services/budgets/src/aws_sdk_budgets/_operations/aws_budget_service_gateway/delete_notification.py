...
def handle_response(
    ...
    out: aws_sdk_budgets.types.delete_notification_response.DeleteNotificationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_budgets.types.delete_notification_request.DeleteNotificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.delete_notification_request.serialize_aws_json_1_1(input_)
    ).encode()
