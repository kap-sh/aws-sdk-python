...
def handle_response(
    ...
    out: aws_sdk_budgets.types.update_budget_response.UpdateBudgetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_budgets.types.update_budget_request.UpdateBudgetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.update_budget_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_budget(
    ...
    aws_sdk_budgets.types.update_budget_response.UpdateBudgetResponse, zapros.Response
]:
