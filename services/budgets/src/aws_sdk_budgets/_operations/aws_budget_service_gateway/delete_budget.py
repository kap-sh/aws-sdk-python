...
def handle_response(
    ...
    out: aws_sdk_budgets.types.delete_budget_response.DeleteBudgetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_budgets.types.delete_budget_request.DeleteBudgetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.delete_budget_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_budget(
    ...
    aws_sdk_budgets.types.delete_budget_response.DeleteBudgetResponse, zapros.Response
]:
