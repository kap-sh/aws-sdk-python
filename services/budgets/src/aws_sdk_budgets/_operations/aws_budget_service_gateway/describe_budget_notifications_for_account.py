...
import aws_sdk_budgets.errors.expired_next_token_exception
import aws_sdk_budgets.errors.internal_error_exception
import aws_sdk_budgets.errors.invalid_next_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ExpiredNextTokenException":
            raise aws_sdk_budgets.errors.expired_next_token_exception.ExpiredNextTokenException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidNextTokenException":
            raise aws_sdk_budgets.errors.invalid_next_token_exception.InvalidNextTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_budgets.types.describe_budget_notifications_for_account_response.DescribeBudgetNotificationsForAccountResponse = aws_sdk_budgets.types.describe_budget_notifications_for_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_budgets.types.describe_budget_notifications_for_account_request.DescribeBudgetNotificationsForAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
