...
def handle_response(
    ...
    out: aws_sdk_budgets.types.describe_budget_actions_for_account_response.DescribeBudgetActionsForAccountResponse = aws_sdk_budgets.types.describe_budget_actions_for_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_budgets.types.describe_budget_actions_for_account_request.DescribeBudgetActionsForAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.describe_budget_actions_for_account_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
