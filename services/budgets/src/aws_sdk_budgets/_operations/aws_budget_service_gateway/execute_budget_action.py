...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceLockedException":
            import aws_sdk_budgets.errors.resource_locked_exception

            raise aws_sdk_budgets.errors.resource_locked_exception.ResourceLockedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_budgets.types.execute_budget_action_response.ExecuteBudgetActionResponse = aws_sdk_budgets.types.execute_budget_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_budgets.types.execute_budget_action_request.ExecuteBudgetActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.execute_budget_action_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
