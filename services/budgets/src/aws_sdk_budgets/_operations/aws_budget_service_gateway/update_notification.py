...
def build_request(
    ...
    input: aws_sdk_budgets.types.update_notification_request.UpdateNotificationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.update_notification_request.serialize_aws_json_1_1(input)
    ).encode()
