...
def handle_response(
    ...
    out: aws_sdk_budgets.types.update_notification_response.UpdateNotificationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_budgets.types.update_notification_request.UpdateNotificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.update_notification_request.serialize_aws_json_1_1(input_)
    ).encode()
