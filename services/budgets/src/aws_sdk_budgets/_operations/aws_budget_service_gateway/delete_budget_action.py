...
def handle_response(
    ...
    out: aws_sdk_budgets.types.delete_budget_action_response.DeleteBudgetActionResponse = aws_sdk_budgets.types.delete_budget_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_budgets.types.delete_budget_action_request.DeleteBudgetActionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.delete_budget_action_request.serialize_aws_json_1_1(input)
    ).encode()
