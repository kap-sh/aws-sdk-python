...
def build_request(
    ...
    input_: aws_sdk_budgets.types.delete_budget_action_request.DeleteBudgetActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.delete_budget_action_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
