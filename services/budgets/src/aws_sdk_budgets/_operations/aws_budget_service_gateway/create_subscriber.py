...
def build_request(
    ...
    input: aws_sdk_budgets.types.create_subscriber_request.CreateSubscriberRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.create_subscriber_request.serialize_aws_json_1_1(input)
    ).encode()
