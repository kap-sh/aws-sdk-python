"""Generated from Smithy shape ``com.amazonaws.budgets#CreateSubscriber``."""
...
def handle_response(
    ...
    out: aws_sdk_budgets.types.create_subscriber_response.CreateSubscriberResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_budgets.types.create_subscriber_request.CreateSubscriberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.create_subscriber_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_subscriber(
