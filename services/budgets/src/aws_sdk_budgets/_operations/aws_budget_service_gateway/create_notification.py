...
def build_request(
    ...
    input: aws_sdk_budgets.types.create_notification_request.CreateNotificationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.create_notification_request.serialize_aws_json_1_1(input)
    ).encode()
