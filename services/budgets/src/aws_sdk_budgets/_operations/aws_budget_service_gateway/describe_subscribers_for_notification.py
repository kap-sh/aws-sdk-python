...
def handle_response(
    ...
    out: aws_sdk_budgets.types.describe_subscribers_for_notification_response.DescribeSubscribersForNotificationResponse = aws_sdk_budgets.types.describe_subscribers_for_notification_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_budgets.types.describe_subscribers_for_notification_request.DescribeSubscribersForNotificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.describe_subscribers_for_notification_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
