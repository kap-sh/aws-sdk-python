...
def build_request(
    ...
    input: aws_sdk_budgets.types.describe_budgets_request.DescribeBudgetsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.describe_budgets_request.serialize_aws_json_1_1(input)
    ).encode()
