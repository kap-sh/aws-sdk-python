...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BillingViewHealthStatusException":
            import aws_sdk_budgets.errors.billing_view_health_status_exception

            raise aws_sdk_budgets.errors.billing_view_health_status_exception.BillingViewHealthStatusException.from_aws_json_1_1(
                data
            )
        case "CreationLimitExceededException":
            import aws_sdk_budgets.errors.creation_limit_exceeded_exception

            raise aws_sdk_budgets.errors.creation_limit_exceeded_exception.CreationLimitExceededException.from_aws_json_1_1(
                data
            )
        case "DuplicateRecordException":
            import aws_sdk_budgets.errors.duplicate_record_exception

            raise aws_sdk_budgets.errors.duplicate_record_exception.DuplicateRecordException.from_aws_json_1_1(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_budgets.errors.service_quota_exceeded_exception

            raise aws_sdk_budgets.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_budgets.types.create_budget_response.CreateBudgetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_budgets.types.create_budget_request.CreateBudgetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.create_budget_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_budget(
    ...
    aws_sdk_budgets.types.create_budget_response.CreateBudgetResponse, zapros.Response
]:
