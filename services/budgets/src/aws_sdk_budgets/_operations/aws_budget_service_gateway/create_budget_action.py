...
def handle_response(
    ...
    out: aws_sdk_budgets.types.create_budget_action_response.CreateBudgetActionResponse = aws_sdk_budgets.types.create_budget_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_budgets.types.create_budget_action_request.CreateBudgetActionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.create_budget_action_request.serialize_aws_json_1_1(input)
    ).encode()
