...
def build_request(
    ...
    input_: aws_sdk_budgets.types.delete_subscriber_request.DeleteSubscriberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_budgets.types.delete_subscriber_request.serialize_aws_json_1_1(input_)
    ).encode()
