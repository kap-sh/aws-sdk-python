...
if TYPE_CHECKING:
    import aws_sdk_budgets.types.policy_id
...
def serialize_aws_json_1_1(value: ScpActionDefinition) -> dict:
    ...
    out["TargetIds"] = aws_sdk_budgets.types.target_ids.serialize_aws_json_1_1(
        value["target_ids"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ScpActionDefinition:
    ...
    if "TargetIds" in data:
        ...
        out["target_ids"] = aws_sdk_budgets.types.target_ids.deserialize_aws_json_1_1(
            data["TargetIds"]
        )
    else:
