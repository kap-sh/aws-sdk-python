...
if TYPE_CHECKING:
    import aws_sdk_budgets.types.comparison_operator
    import aws_sdk_budgets.types.notification_state
...
class Notification(TypedDict, closed=True):
    ...
    threshold: "aws_sdk_budgets.types.notification_threshold.NotificationThreshold"
    ...
    threshold_type: NotRequired["aws_sdk_budgets.types.threshold_type.ThresholdType"]
    ...
    notification_state: NotRequired[
        "aws_sdk_budgets.types.notification_state.NotificationState"
    ]
...
def serialize_aws_json_1_1(value: Notification) -> dict:
    ...
    out["ComparisonOperator"] = (
        aws_sdk_budgets.types.comparison_operator.serialize_aws_json_1_1(
    ...
    if "notification_state" in value:
        ...
        out["NotificationState"] = (
            aws_sdk_budgets.types.notification_state.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Notification:
    ...
    if "ComparisonOperator" in data:
        ...
        out["comparison_operator"] = (
            aws_sdk_budgets.types.comparison_operator.deserialize_aws_json_1_1(
    ...
    if "NotificationState" in data:
        ...
        out["notification_state"] = (
            aws_sdk_budgets.types.notification_state.deserialize_aws_json_1_1(
