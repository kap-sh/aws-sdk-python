...
BudgetNotificationsForAccountList: TypeAlias = list[
    "aws_sdk_budgets.types.budget_notifications_for_account.BudgetNotificationsForAccount"
]
...
def serialize_aws_json_1_1(value: BudgetNotificationsForAccountList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_budgets.types.budget_notifications_for_account.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> BudgetNotificationsForAccountList:
    ...
    for item in data:
        out.append(
            aws_sdk_budgets.types.budget_notifications_for_account.deserialize_aws_json_1_1(
                item
            )
        )
    return out
