...
if TYPE_CHECKING:
    ...
    import aws_sdk_budgets.types.action_status
...
class Action(TypedDict, closed=True):
    ...
    status: "aws_sdk_budgets.types.action_status.ActionStatus"
...
def serialize_aws_json_1_1(value: Action) -> dict:
    ...
    out["Status"] = aws_sdk_budgets.types.action_status.serialize_aws_json_1_1(
        value["status"]
    )
    import aws_sdk_budgets.types.subscribers
...
def deserialize_aws_json_1_1(data: dict) -> Action:
    ...
    if "Status" in data:
        ...
        out["status"] = aws_sdk_budgets.types.action_status.deserialize_aws_json_1_1(
            data["Status"]
        )
    else:
