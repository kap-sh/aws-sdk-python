...
class BudgetsError(Exception):
    """Base class for all Budgets service errors."""


class ServiceError(BudgetsError):
...
class SerializationError(BudgetsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(BudgetsError):
...
class WaiterFailedError(BudgetsError):
...
class WaiterTimeoutError(BudgetsError):
