"""Generated from Smithy shape ``com.amazonaws.budgets#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.budgets#ServiceQuotaExceededException``."""
