...
def resolve(p: EndpointParams) -> Endpoint:  # type: ignore
    ...
    if p.Region is not None:
        ...
        if _locals["PartitionResult"] is not None:
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is True:
                        return Endpoint(
                            url=interpolate(
                                "https://budgets.us-east-1.api.aws", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://budgets.global.sc2s.sgov.gov", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://budgets.global.cloud.adc-e.uk", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://budgets.global.csp.hci.ic.gov", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
                ...
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            return Endpoint(
                                url=interpolate(
                                    "https://budgets-fips.{PartitionResult#dualStackDnsSuffix}",
                                    p,
                                    _locals,
                                ),
                                properties={
            ...
            if p.UseFIPS is True:
                if p.UseDualStack is False:
                    if (
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://budgets-fips.{PartitionResult#dnsSuffix}",
                                p,
                                _locals,
                            ),
                            properties={
            ...
            if p.UseFIPS is False:
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://budgets.{PartitionResult#dualStackDnsSuffix}",
                                p,
                                _locals,
                            ),
                            properties={
            ...
            return Endpoint(
                url=interpolate(
                    "https://budgets.{PartitionResult#dnsSuffix}", p, _locals
                ),
                properties={
                    "authSchemes": [
                        {
