import pytest
from aws_sdk_iotsecuretunneling._rule_engine._endpoint_rule_set import EndpointParams, resolve
from aws_sdk_iotsecuretunneling._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_1_for_region_ap_east_1_with_fips_disabled_():
    ...
    assert result.url == 'https://api.tunneling.iot.ap-east-1.amazonaws.com'
...
def test_2_for_region_ap_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.ap-east-1.api.aws'
...
def test_3_for_region_ap_northeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.ap-northeast-1.amazonaws.com'

def test_4_for_region_ap_northeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.ap-northeast-1.api.aws'

def test_5_for_region_ap_northeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.ap-northeast-2.amazonaws.com'

def test_6_for_region_ap_northeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.ap-northeast-2.api.aws'

def test_7_for_region_ap_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.ap-south-1.amazonaws.com'

def test_8_for_region_ap_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.ap-south-1.api.aws'

def test_9_for_region_ap_southeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.ap-southeast-1.amazonaws.com'

def test_10_for_region_ap_southeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.ap-southeast-1.api.aws'

def test_11_for_region_ap_southeast_2_with_fips_disa():
    """For region ap-southeast-2 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='ap-southeast-2', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.ap-southeast-2.amazonaws.com'

def test_12_for_region_ap_southeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.ap-southeast-2.api.aws'

def test_13_for_region_ca_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.ca-central-1.amazonaws.com'

def test_14_for_region_ca_central_1_with_fips_enable():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot-fips.ca-central-1.amazonaws.com'
...
def test_15_for_region_ca_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.ca-central-1.api.aws'

def test_16_for_region_ca_central_1_with_fips_enable():
    """For region ca-central-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='ca-central-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling-fips.ca-central-1.api.aws'
...
def test_17_for_region_eu_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.eu-central-1.amazonaws.com'
...
def test_18_for_region_eu_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.eu-central-1.api.aws'
...
def test_19_for_region_eu_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.eu-north-1.amazonaws.com'
...
def test_20_for_region_eu_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.eu-north-1.api.aws'

def test_21_for_region_eu_west_1_with_fips_disabled_():
    """For region eu-west-1 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='eu-west-1', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.eu-west-1.amazonaws.com'

def test_22_for_region_eu_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.eu-west-1.api.aws'

def test_23_for_region_eu_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.eu-west-2.amazonaws.com'

def test_24_for_region_eu_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.eu-west-2.api.aws'

def test_25_for_region_eu_west_3_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.eu-west-3.amazonaws.com'

def test_26_for_region_eu_west_3_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.eu-west-3.api.aws'

def test_27_for_region_me_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.me-central-1.amazonaws.com'

def test_28_for_region_me_central_1_with_fips_disabl():
    """For region me-central-1 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='me-central-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.me-central-1.api.aws'
...
def test_29_for_region_me_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.me-south-1.amazonaws.com'
...
def test_30_for_region_me_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.me-south-1.api.aws'
...
def test_31_for_region_sa_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.sa-east-1.amazonaws.com'
...
def test_32_for_region_sa_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.sa-east-1.api.aws'
...
def test_33_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.us-east-1.amazonaws.com'

def test_34_for_region_us_east_1_with_fips_enabled_a():
    """For region us-east-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot-fips.us-east-1.amazonaws.com'

def test_35_for_region_us_east_1_with_fips_disabled_():
    """For region us-east-1 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.us-east-1.api.aws'

def test_36_for_region_us_east_1_with_fips_enabled_a():
    """For region us-east-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling-fips.us-east-1.api.aws'

def test_37_for_region_us_east_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.us-east-2.amazonaws.com'

def test_38_for_region_us_east_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot-fips.us-east-2.amazonaws.com'
...
def test_39_for_region_us_east_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.us-east-2.api.aws'

def test_40_for_region_us_east_2_with_fips_enabled_a():
    """For region us-east-2 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='us-east-2', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling-fips.us-east-2.api.aws'
...
def test_41_for_region_us_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.us-west-1.amazonaws.com'
...
def test_42_for_region_us_west_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot-fips.us-west-1.amazonaws.com'

def test_43_for_region_us_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.us-west-1.api.aws'

def test_44_for_region_us_west_1_with_fips_enabled_a():
    """For region us-west-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='us-west-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling-fips.us-west-1.api.aws'

def test_45_for_region_us_west_2_with_fips_disabled_():
    """For region us-west-2 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-west-2', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.us-west-2.amazonaws.com'

def test_46_for_region_us_west_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot-fips.us-west-2.amazonaws.com'

def test_47_for_region_us_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.us-west-2.api.aws'

def test_48_for_region_us_west_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling-fips.us-west-2.api.aws'

def test_49_for_region_cn_north_1_with_fips_disabled():
    """For region cn-north-1 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='cn-north-1', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.cn-north-1.amazonaws.com.cn'

def test_50_for_region_cn_north_1_with_fips_disabled():
    """For region cn-north-1 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='cn-north-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.cn-north-1.api.amazonwebservices.com.cn'

def test_51_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.cn-northwest-1.amazonaws.com.cn'

def test_52_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.cn-northwest-1.api.amazonwebservices.com.cn'

def test_53_for_region_cn_north_1_with_fips_enabled_():
    """For region cn-north-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='cn-north-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling-fips.cn-north-1.api.amazonwebservices.com.cn'

def test_54_for_region_cn_north_1_with_fips_enabled_():
    """For region cn-north-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='cn-north-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot-fips.cn-north-1.amazonaws.com.cn'

def test_55_for_region_us_gov_east_1_with_fips_disab():
    """For region us-gov-east-1 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-gov-east-1', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.us-gov-east-1.amazonaws.com'

def test_56_for_region_us_gov_east_1_with_fips_enabl():
    """For region us-gov-east-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='us-gov-east-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot-fips.us-gov-east-1.amazonaws.com'

def test_57_for_region_us_gov_east_1_with_fips_disab():
    """For region us-gov-east-1 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='us-gov-east-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.us-gov-east-1.api.aws'

def test_58_for_region_us_gov_east_1_with_fips_enabl():
    """For region us-gov-east-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='us-gov-east-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling-fips.us-gov-east-1.api.aws'

def test_59_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.us-gov-west-1.amazonaws.com'

def test_60_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot-fips.us-gov-west-1.amazonaws.com'

def test_61_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling.us-gov-west-1.api.aws'

def test_62_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://api.iot-tunneling-fips.us-gov-west-1.api.aws'

def test_63_for_region_us_iso_east_1_with_fips_disab():
    """For region us-iso-east-1 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-iso-east-1', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.us-iso-east-1.c2s.ic.gov'

def test_64_for_region_us_iso_east_1_with_fips_enabl():
    """For region us-iso-east-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='us-iso-east-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot-fips.us-iso-east-1.c2s.ic.gov'

def test_65_for_region_us_isob_east_1_with_fips_disa():
    """For region us-isob-east-1 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-isob-east-1', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot.us-isob-east-1.sc2s.sgov.gov'

def test_66_for_region_us_isob_east_1_with_fips_enab():
    """For region us-isob-east-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='us-isob-east-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://api.tunneling.iot-fips.us-isob-east-1.sc2s.sgov.gov'

def test_67_for_custom_endpoint_with_region_set_and_():
    """For custom endpoint with region set and fips disabled and dualstack disabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=False, UseDualStack=False, Endpoint='https://example.com')
    result = resolve(params)
    assert result.url == 'https://example.com'

def test_68_for_custom_endpoint_with_region_not_set_():
    """For custom endpoint with region not set and fips disabled and dualstack disabled"""
    params = EndpointParams(UseFIPS=False, UseDualStack=False, Endpoint='https://example.com')
    result = resolve(params)
    assert result.url == 'https://example.com'

def test_69_for_custom_endpoint_with_fips_enabled_an():
...
def test_70_for_custom_endpoint_with_fips_disabled_a():
