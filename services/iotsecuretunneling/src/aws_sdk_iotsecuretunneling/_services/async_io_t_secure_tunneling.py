...
from aws_sdk_iotsecuretunneling._services._aws_config import aaws_config
...
class AsyncIoTSecureTunnelingClientConfig(TypedDict, total=False):
...
class AsyncIoTSecureTunnelingClient:
    ...
    async def close_tunnel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotsecuretunneling.types.close_tunnel_request.CloseTunnelRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotsecuretunneling.types.close_tunnel_response.CloseTunnelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotsecuretunneling._operations.io_t_secured_tunneling.close_tunnel.async_close_tunnel(
    ...
    async def describe_tunnel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotsecuretunneling.types.describe_tunnel_request.DescribeTunnelRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotsecuretunneling.types.describe_tunnel_response.DescribeTunnelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotsecuretunneling._operations.io_t_secured_tunneling.describe_tunnel.async_describe_tunnel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotsecuretunneling.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotsecuretunneling.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotsecuretunneling._operations.io_t_secured_tunneling.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tunnels(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotsecuretunneling.types.list_tunnels_request.ListTunnelsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotsecuretunneling.types.list_tunnels_response.ListTunnelsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotsecuretunneling._operations.io_t_secured_tunneling.list_tunnels.async_list_tunnels(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def open_tunnel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotsecuretunneling.types.open_tunnel_request.OpenTunnelRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotsecuretunneling.types.open_tunnel_response.OpenTunnelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotsecuretunneling._operations.io_t_secured_tunneling.open_tunnel.async_open_tunnel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def rotate_tunnel_access_token(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotsecuretunneling.types.rotate_tunnel_access_token_request.RotateTunnelAccessTokenRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotsecuretunneling.types.rotate_tunnel_access_token_response.RotateTunnelAccessTokenResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotsecuretunneling._operations.io_t_secured_tunneling.rotate_tunnel_access_token.async_rotate_tunnel_access_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotsecuretunneling.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotsecuretunneling.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotsecuretunneling._operations.io_t_secured_tunneling.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iotsecuretunneling.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iotsecuretunneling.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iotsecuretunneling._operations.io_t_secured_tunneling.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
