...
class IoTSecureTunnelingError(Exception):
    """Base class for all IoTSecureTunneling service errors."""


class ServiceError(IoTSecureTunnelingError):
...
class SerializationError(IoTSecureTunnelingError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IoTSecureTunnelingError):
...
class WaiterFailedError(IoTSecureTunnelingError):
...
class WaiterTimeoutError(IoTSecureTunnelingError):
