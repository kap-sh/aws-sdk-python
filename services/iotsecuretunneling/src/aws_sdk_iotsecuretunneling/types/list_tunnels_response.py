...
if TYPE_CHECKING:
    ...
    import aws_sdk_iotsecuretunneling.types.tunnel_summary_list


class ListTunnelsResponse(TypedDict):
    tunnel_summaries: NotRequired[
        "aws_sdk_iotsecuretunneling.types.tunnel_summary_list.TunnelSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListTunnelsResponse) -> dict:
    ...
    if "tunnel_summaries" in value:
        ...
        out["tunnelSummaries"] = (
            aws_sdk_iotsecuretunneling.types.tunnel_summary_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListTunnelsResponse:
    ...
    if "tunnelSummaries" in data:
        ...
        out["tunnel_summaries"] = (
            aws_sdk_iotsecuretunneling.types.tunnel_summary_list.deserialize_aws_json_1_1(
