...
class IoTSecureTunnelingClientConfig(TypedDict, total=False, closed=True):
...
class IoTSecureTunnelingClient:
    ...
    def __init__(
        ...
        self._config = IoTSecureTunnelingClientConfig(
            {
    ...
    def close_tunnel(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_iotsecuretunneling.types.close_tunnel_request.CloseTunnelRequest]",
        ) -> OperationResponse[
            "capo_iotsecuretunneling.types.close_tunnel_response.CloseTunnelResponse"
        ]:
            ...
            output, http_response = (
                capo_iotsecuretunneling._operations.io_t_secured_tunneling.close_tunnel.close_tunnel(
    ...
    def describe_tunnel(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_iotsecuretunneling.types.describe_tunnel_request.DescribeTunnelRequest]",
        ) -> OperationResponse[
            "capo_iotsecuretunneling.types.describe_tunnel_response.DescribeTunnelResponse"
        ]:
            ...
            output, http_response = (
                capo_iotsecuretunneling._operations.io_t_secured_tunneling.describe_tunnel.describe_tunnel(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_iotsecuretunneling.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_iotsecuretunneling.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_iotsecuretunneling._operations.io_t_secured_tunneling.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tunnels(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_iotsecuretunneling.types.list_tunnels_request.ListTunnelsRequest]",
        ) -> OperationResponse[
            "capo_iotsecuretunneling.types.list_tunnels_response.ListTunnelsResponse"
        ]:
            ...
            output, http_response = (
                capo_iotsecuretunneling._operations.io_t_secured_tunneling.list_tunnels.list_tunnels(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def open_tunnel(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_iotsecuretunneling.types.open_tunnel_request.OpenTunnelRequest]",
        ) -> OperationResponse[
            "capo_iotsecuretunneling.types.open_tunnel_response.OpenTunnelResponse"
        ]:
            ...
            output, http_response = (
                capo_iotsecuretunneling._operations.io_t_secured_tunneling.open_tunnel.open_tunnel(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def rotate_tunnel_access_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_iotsecuretunneling.types.rotate_tunnel_access_token_request.RotateTunnelAccessTokenRequest]",
        ) -> OperationResponse[
            "capo_iotsecuretunneling.types.rotate_tunnel_access_token_response.RotateTunnelAccessTokenResponse"
        ]:
            ...
            output, http_response = (
                capo_iotsecuretunneling._operations.io_t_secured_tunneling.rotate_tunnel_access_token.rotate_tunnel_access_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_iotsecuretunneling.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_iotsecuretunneling.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_iotsecuretunneling._operations.io_t_secured_tunneling.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_iotsecuretunneling.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_iotsecuretunneling.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_iotsecuretunneling._operations.io_t_secured_tunneling.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
