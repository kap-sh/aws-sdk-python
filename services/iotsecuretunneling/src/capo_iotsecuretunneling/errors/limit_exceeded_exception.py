"""Generated from Smithy shape ``com.amazonaws.iotsecuretunneling#LimitExceededException``."""

from typing import TYPE_CHECKING

from typing_extensions import NotRequired, TypedDict

from capo_iotsecuretunneling.errors import ServiceError

if TYPE_CHECKING:
    import capo_iotsecuretunneling.types.error_message


class LimitExceededException_(TypedDict, closed=True):
    message: NotRequired["capo_iotsecuretunneling.types.error_message.ErrorMessage"]
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotsecuretunneling#LimitExceededException``."""
