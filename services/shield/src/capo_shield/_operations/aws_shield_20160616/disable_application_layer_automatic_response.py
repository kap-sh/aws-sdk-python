"""Generated from Smithy shape ``com.amazonaws.shield#DisableApplicationLayerAutomaticResponse``."""
...
def handle_response(
    ...
    out: capo_shield.types.disable_application_layer_automatic_response_response.DisableApplicationLayerAutomaticResponseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.disable_application_layer_automatic_response_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disable_application_layer_automatic_response(
