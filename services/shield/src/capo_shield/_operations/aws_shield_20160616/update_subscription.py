"""Generated from Smithy shape ``com.amazonaws.shield#UpdateSubscription``."""
...
import capo_shield.errors.locked_subscription_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LockedSubscriptionException":
            raise capo_shield.errors.locked_subscription_exception.LockedSubscriptionException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_shield.types.update_subscription_response.UpdateSubscriptionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.update_subscription_request.serialize_aws_json_1_1(input_)
    ).encode()
