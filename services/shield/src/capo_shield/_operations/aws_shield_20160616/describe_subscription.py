"""Generated from Smithy shape ``com.amazonaws.shield#DescribeSubscription``."""
...
def handle_response(
    ...
    out: capo_shield.types.describe_subscription_response.DescribeSubscriptionResponse = capo_shield.types.describe_subscription_response.deserialize_aws_json_1_1(
...
async def async_describe_subscription(
