"""Generated from Smithy shape ``com.amazonaws.shield#UpdateProtectionGroup``."""
...
def handle_response(
    ...
    out: capo_shield.types.update_protection_group_response.UpdateProtectionGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSShield_20160616.UpdateProtectionGroup"
    body: bytes | None = json.dumps(
        capo_shield.types.update_protection_group_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_protection_group(
