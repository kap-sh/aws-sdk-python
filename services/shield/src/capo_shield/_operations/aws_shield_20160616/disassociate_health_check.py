...
def handle_response(
    ...
    out: capo_shield.types.disassociate_health_check_response.DisassociateHealthCheckResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.disassociate_health_check_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
