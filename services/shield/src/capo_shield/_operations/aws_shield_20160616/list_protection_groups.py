...
import capo_shield.types.protection_groups
...
def handle_response(
    ...
    out: capo_shield.types.list_protection_groups_response.ListProtectionGroupsResponse = capo_shield.types.list_protection_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.list_protection_groups_request.serialize_aws_json_1_1(input_)
    ).encode()
