"""Generated from Smithy shape ``com.amazonaws.shield#ListProtections``."""
...
def handle_response(
    ...
    out: capo_shield.types.list_protections_response.ListProtectionsResponse = (
        capo_shield.types.list_protections_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.list_protections_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_protections(
    ...
    capo_shield.types.list_protections_response.ListProtectionsResponse, zapros.Response
]:
...
async def async_list_protections(
