"""Generated from Smithy shape ``com.amazonaws.shield#DeleteSubscription``."""
...
def handle_response(
    ...
    out: capo_shield.types.delete_subscription_response.DeleteSubscriptionResponse = {}  # type: ignore[typeddict-item]
    return out
