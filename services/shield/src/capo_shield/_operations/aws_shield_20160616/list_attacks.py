"""Generated from Smithy shape ``com.amazonaws.shield#ListAttacks``."""
...
import capo_shield.types.attack_summaries
...
def handle_response(
    ...
    out: capo_shield.types.list_attacks_response.ListAttacksResponse = (
        capo_shield.types.list_attacks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.list_attacks_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_attacks(
    ...
    capo_shield.types.list_attacks_response.ListAttacksResponse, zapros.Response
]:
