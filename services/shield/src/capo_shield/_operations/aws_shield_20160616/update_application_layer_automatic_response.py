"""Generated from Smithy shape ``com.amazonaws.shield#UpdateApplicationLayerAutomaticResponse``."""
...
def handle_response(
    ...
    out: capo_shield.types.update_application_layer_automatic_response_response.UpdateApplicationLayerAutomaticResponseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.update_application_layer_automatic_response_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_application_layer_automatic_response(
