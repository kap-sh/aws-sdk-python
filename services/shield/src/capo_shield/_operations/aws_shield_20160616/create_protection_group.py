"""Generated from Smithy shape ``com.amazonaws.shield#CreateProtectionGroup``."""
...
import capo_shield.errors.resource_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceAlreadyExistsException":
            raise capo_shield.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_shield.types.create_protection_group_response.CreateProtectionGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSShield_20160616.CreateProtectionGroup"
    body: bytes | None = json.dumps(
        capo_shield.types.create_protection_group_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_protection_group(
