"""Generated from Smithy shape ``com.amazonaws.shield#UpdateEmergencyContactSettings``."""
...
def handle_response(
    ...
    out: capo_shield.types.update_emergency_contact_settings_response.UpdateEmergencyContactSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.update_emergency_contact_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_emergency_contact_settings(
