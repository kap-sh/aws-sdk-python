...
def handle_response(
    ...
    out: capo_shield.types.describe_protection_response.DescribeProtectionResponse = (
        capo_shield.types.describe_protection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.describe_protection_request.serialize_aws_json_1_1(input_)
    ).encode()
