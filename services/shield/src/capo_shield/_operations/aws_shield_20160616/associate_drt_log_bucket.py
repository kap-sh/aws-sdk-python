"""Generated from Smithy shape ``com.amazonaws.shield#AssociateDRTLogBucket``."""
...
import capo_shield.errors.access_denied_for_dependency_exception
import capo_shield.errors.internal_error_exception
import capo_shield.errors.invalid_operation_exception
import capo_shield.errors.invalid_parameter_exception
import capo_shield.errors.limits_exceeded_exception
import capo_shield.errors.no_associated_role_exception
import capo_shield.errors.optimistic_lock_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedForDependencyException":
            raise capo_shield.errors.access_denied_for_dependency_exception.AccessDeniedForDependencyException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidOperationException":
            raise capo_shield.errors.invalid_operation_exception.InvalidOperationException.from_aws_json_1_1(
                data
            )
        case "InvalidParameterException":
            raise capo_shield.errors.invalid_parameter_exception.InvalidParameterException.from_aws_json_1_1(
                data
            )
        case "LimitsExceededException":
            raise capo_shield.errors.limits_exceeded_exception.LimitsExceededException.from_aws_json_1_1(
                data
            )
        case "NoAssociatedRoleException":
            raise capo_shield.errors.no_associated_role_exception.NoAssociatedRoleException.from_aws_json_1_1(
                data
            )
        case "OptimisticLockException":
            raise capo_shield.errors.optimistic_lock_exception.OptimisticLockException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_shield.types.associate_drt_log_bucket_response.AssociateDRTLogBucketResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.associate_drt_log_bucket_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_drt_log_bucket(
