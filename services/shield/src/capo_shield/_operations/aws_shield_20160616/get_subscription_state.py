"""Generated from Smithy shape ``com.amazonaws.shield#GetSubscriptionState``."""
...
def handle_response(
    ...
    out: capo_shield.types.get_subscription_state_response.GetSubscriptionStateResponse = capo_shield.types.get_subscription_state_response.deserialize_aws_json_1_1(
...
async def async_get_subscription_state(
