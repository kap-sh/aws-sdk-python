"""Generated from Smithy shape ``com.amazonaws.shield#DescribeAttack``."""
...
import capo_shield.errors.access_denied_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_shield.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_shield.types.describe_attack_response.DescribeAttackResponse = (
        capo_shield.types.describe_attack_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.describe_attack_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_attack(
    ...
    capo_shield.types.describe_attack_response.DescribeAttackResponse, zapros.Response
]:
...
async def async_describe_attack(
