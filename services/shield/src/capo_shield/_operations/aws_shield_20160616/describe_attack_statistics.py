"""Generated from Smithy shape ``com.amazonaws.shield#DescribeAttackStatistics``."""
...
def handle_response(
    ...
    out: capo_shield.types.describe_attack_statistics_response.DescribeAttackStatisticsResponse = capo_shield.types.describe_attack_statistics_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSShield_20160616.DescribeAttackStatistics"
    body: bytes | None = b""
...
async def async_describe_attack_statistics(
