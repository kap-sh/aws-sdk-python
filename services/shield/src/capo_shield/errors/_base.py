...
class ShieldError(Exception):
    """Base class for all Shield service errors."""


class ServiceError(ShieldError):
...
class SerializationError(ShieldError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ShieldError):
...
class WaiterFailedError(ShieldError):
...
class WaiterTimeoutError(ShieldError):
