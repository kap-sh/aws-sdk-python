...
def handle_response(
    ...
    out: aws_sdk_shield.types.delete_subscription_response.DeleteSubscriptionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.delete_subscription_request.DeleteSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
