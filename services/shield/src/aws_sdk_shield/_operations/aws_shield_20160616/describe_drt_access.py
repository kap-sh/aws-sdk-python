...
def handle_response(
    ...
    out: aws_sdk_shield.types.describe_drt_access_response.DescribeDRTAccessResponse = (
        aws_sdk_shield.types.describe_drt_access_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.describe_drt_access_request.DescribeDRTAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
