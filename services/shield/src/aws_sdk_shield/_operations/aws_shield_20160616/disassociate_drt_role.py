...
def handle_response(
    ...
    out: aws_sdk_shield.types.disassociate_drt_role_response.DisassociateDRTRoleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.disassociate_drt_role_request.DisassociateDRTRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
