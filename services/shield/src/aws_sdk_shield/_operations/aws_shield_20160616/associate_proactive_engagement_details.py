"""Generated from Smithy shape ``com.amazonaws.shield#AssociateProactiveEngagementDetails``."""
...
def build_request(
    ...
    input_: aws_sdk_shield.types.associate_proactive_engagement_details_request.AssociateProactiveEngagementDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSShield_20160616.AssociateProactiveEngagementDetails"
    import aws_sdk_shield.types.associate_proactive_engagement_details_request

    body: bytes | None = json.dumps(
        aws_sdk_shield.types.associate_proactive_engagement_details_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_proactive_engagement_details(
