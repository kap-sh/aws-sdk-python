...
def handle_response(
    ...
    out: aws_sdk_shield.types.delete_protection_response.DeleteProtectionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.delete_protection_request.DeleteProtectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.delete_protection_request.serialize_aws_json_1_1(input_)
    ).encode()
