...
def build_request(
    ...
    input: aws_sdk_shield.types.delete_protection_request.DeleteProtectionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.delete_protection_request.serialize_aws_json_1_1(input)
    ).encode()
