...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            import aws_sdk_shield.errors.access_denied_exception

            raise aws_sdk_shield.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_shield.types.describe_attack_response.DescribeAttackResponse = (
        aws_sdk_shield.types.describe_attack_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.describe_attack_request.DescribeAttackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.describe_attack_request.serialize_aws_json_1_1(input_)
    ).encode()
