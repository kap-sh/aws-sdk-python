...
def handle_response(
    ...
    out: aws_sdk_shield.types.disable_application_layer_automatic_response_response.DisableApplicationLayerAutomaticResponseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.disable_application_layer_automatic_response_request.DisableApplicationLayerAutomaticResponseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.disable_application_layer_automatic_response_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
