"""Generated from Smithy shape ``com.amazonaws.shield#AssociateHealthCheck``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResourceException":
            import aws_sdk_shield.errors.invalid_resource_exception

            raise aws_sdk_shield.errors.invalid_resource_exception.InvalidResourceException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_shield.types.associate_health_check_response.AssociateHealthCheckResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.associate_health_check_request.AssociateHealthCheckRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSShield_20160616.AssociateHealthCheck"
    import aws_sdk_shield.types.associate_health_check_request

    body: bytes | None = json.dumps(
        aws_sdk_shield.types.associate_health_check_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_health_check(
