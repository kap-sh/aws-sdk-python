...
def handle_response(
    ...
    out: aws_sdk_shield.types.update_emergency_contact_settings_response.UpdateEmergencyContactSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.update_emergency_contact_settings_request.UpdateEmergencyContactSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.update_emergency_contact_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
