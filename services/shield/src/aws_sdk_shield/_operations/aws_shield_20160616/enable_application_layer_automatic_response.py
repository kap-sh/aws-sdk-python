...
def handle_response(
    ...
    out: aws_sdk_shield.types.enable_application_layer_automatic_response_response.EnableApplicationLayerAutomaticResponseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.enable_application_layer_automatic_response_request.EnableApplicationLayerAutomaticResponseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
