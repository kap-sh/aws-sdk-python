...
def build_request(
    ...
    input: aws_sdk_shield.types.update_subscription_request.UpdateSubscriptionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.update_subscription_request.serialize_aws_json_1_1(input)
    ).encode()
