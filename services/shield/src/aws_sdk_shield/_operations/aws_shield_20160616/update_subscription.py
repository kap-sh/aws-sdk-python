...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LockedSubscriptionException":
            import aws_sdk_shield.errors.locked_subscription_exception

            raise aws_sdk_shield.errors.locked_subscription_exception.LockedSubscriptionException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_shield.types.update_subscription_response.UpdateSubscriptionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.update_subscription_request.UpdateSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.update_subscription_request.serialize_aws_json_1_1(input_)
    ).encode()
