...
def handle_response(
    ...
    out: aws_sdk_shield.types.list_attacks_response.ListAttacksResponse = (
        aws_sdk_shield.types.list_attacks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.list_attacks_request.ListAttacksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.list_attacks_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_attacks(
    ...
    aws_sdk_shield.types.list_attacks_response.ListAttacksResponse, zapros.Response
]:
