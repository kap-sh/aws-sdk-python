...
def handle_response(
    ...
    out: aws_sdk_shield.types.get_subscription_state_response.GetSubscriptionStateResponse = aws_sdk_shield.types.get_subscription_state_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.get_subscription_state_request.GetSubscriptionStateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
