...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedForDependencyException":
            import aws_sdk_shield.errors.access_denied_for_dependency_exception

            raise aws_sdk_shield.errors.access_denied_for_dependency_exception.AccessDeniedForDependencyException.from_aws_json_1_1(
                data
            )
        ...
        case "LimitsExceededException":
            import aws_sdk_shield.errors.limits_exceeded_exception

            raise aws_sdk_shield.errors.limits_exceeded_exception.LimitsExceededException.from_aws_json_1_1(
                data
            )
        case "NoAssociatedRoleException":
            import aws_sdk_shield.errors.no_associated_role_exception

            raise aws_sdk_shield.errors.no_associated_role_exception.NoAssociatedRoleException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_shield.types.associate_drt_log_bucket_response.AssociateDRTLogBucketResponse = {}  # type: ignore[typeddict-item]
    return out
...
def get_signer(
...
) -> aws_sdk_shield._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_shield._auth._sigv4.build_sigv4_auth_scheme(
                "shield", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_shield._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.associate_drt_log_bucket_request.AssociateDRTLogBucketRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.associate_drt_log_bucket_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
