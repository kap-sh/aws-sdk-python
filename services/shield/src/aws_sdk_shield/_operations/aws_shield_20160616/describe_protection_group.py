"""Generated from Smithy shape ``com.amazonaws.shield#DescribeProtectionGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_shield.types.describe_protection_group_response.DescribeProtectionGroupResponse = aws_sdk_shield.types.describe_protection_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.describe_protection_group_request.DescribeProtectionGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSShield_20160616.DescribeProtectionGroup"
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.describe_protection_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_protection_group(
