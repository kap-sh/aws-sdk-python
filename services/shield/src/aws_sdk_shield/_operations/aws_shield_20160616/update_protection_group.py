...
def handle_response(
    ...
    out: aws_sdk_shield.types.update_protection_group_response.UpdateProtectionGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.update_protection_group_request.UpdateProtectionGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.update_protection_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
