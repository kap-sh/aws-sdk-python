...
def build_request(
    ...
    input: aws_sdk_shield.types.create_protection_request.CreateProtectionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.create_protection_request.serialize_aws_json_1_1(input)
    ).encode()
