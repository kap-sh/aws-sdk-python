...
def handle_response(
    ...
    out: aws_sdk_shield.types.create_protection_response.CreateProtectionResponse = (
        aws_sdk_shield.types.create_protection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.create_protection_request.CreateProtectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.create_protection_request.serialize_aws_json_1_1(input_)
    ).encode()
