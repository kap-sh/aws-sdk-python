...
def handle_response(
    ...
    out: aws_sdk_shield.types.describe_subscription_response.DescribeSubscriptionResponse = aws_sdk_shield.types.describe_subscription_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.describe_subscription_request.DescribeSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
