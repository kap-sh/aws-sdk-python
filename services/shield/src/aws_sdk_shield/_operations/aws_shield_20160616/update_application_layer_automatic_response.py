...
def handle_response(
    ...
    out: aws_sdk_shield.types.update_application_layer_automatic_response_response.UpdateApplicationLayerAutomaticResponseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.update_application_layer_automatic_response_request.UpdateApplicationLayerAutomaticResponseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.update_application_layer_automatic_response_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
