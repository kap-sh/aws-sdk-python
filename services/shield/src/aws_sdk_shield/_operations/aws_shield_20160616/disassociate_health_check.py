"""Generated from Smithy shape ``com.amazonaws.shield#DisassociateHealthCheck``."""
...
def handle_response(
    ...
    out: aws_sdk_shield.types.disassociate_health_check_response.DisassociateHealthCheckResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.disassociate_health_check_request.DisassociateHealthCheckRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSShield_20160616.DisassociateHealthCheck"
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.disassociate_health_check_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_health_check(
