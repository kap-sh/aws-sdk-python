...
def handle_response(
    ...
    out: aws_sdk_shield.types.list_protections_response.ListProtectionsResponse = (
        aws_sdk_shield.types.list_protections_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.list_protections_request.ListProtectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.list_protections_request.serialize_aws_json_1_1(input_)
    ).encode()
