...
def handle_response(
    ...
    out: aws_sdk_shield.types.describe_attack_statistics_response.DescribeAttackStatisticsResponse = aws_sdk_shield.types.describe_attack_statistics_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.describe_attack_statistics_request.DescribeAttackStatisticsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
