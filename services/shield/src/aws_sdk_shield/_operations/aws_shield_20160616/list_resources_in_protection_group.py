...
def handle_response(
    ...
    out: aws_sdk_shield.types.list_resources_in_protection_group_response.ListResourcesInProtectionGroupResponse = aws_sdk_shield.types.list_resources_in_protection_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.list_resources_in_protection_group_request.ListResourcesInProtectionGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
