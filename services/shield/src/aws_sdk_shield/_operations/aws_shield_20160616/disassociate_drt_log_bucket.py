"""Generated from Smithy shape ``com.amazonaws.shield#DisassociateDRTLogBucket``."""
...
def handle_response(
    ...
    out: aws_sdk_shield.types.disassociate_drt_log_bucket_response.DisassociateDRTLogBucketResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.disassociate_drt_log_bucket_request.DisassociateDRTLogBucketRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.disassociate_drt_log_bucket_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_drt_log_bucket(
