"""Generated from Smithy shape ``com.amazonaws.shield#AssociateDRTRole``."""
...
def handle_response(
    ...
    out: aws_sdk_shield.types.associate_drt_role_response.AssociateDRTRoleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.associate_drt_role_request.AssociateDRTRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.associate_drt_role_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_associate_drt_role(
