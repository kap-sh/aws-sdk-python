...
def build_request(
    ...
    input: aws_sdk_shield.types.associate_drt_role_request.AssociateDRTRoleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.associate_drt_role_request.serialize_aws_json_1_1(input)
    ).encode()
