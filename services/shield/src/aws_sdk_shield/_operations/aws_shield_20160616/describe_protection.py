...
def build_request(
    ...
    input: aws_sdk_shield.types.describe_protection_request.DescribeProtectionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.describe_protection_request.serialize_aws_json_1_1(input)
    ).encode()
