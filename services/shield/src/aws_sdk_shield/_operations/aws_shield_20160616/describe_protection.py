"""Generated from Smithy shape ``com.amazonaws.shield#DescribeProtection``."""
...
def handle_response(
    ...
    out: aws_sdk_shield.types.describe_protection_response.DescribeProtectionResponse = aws_sdk_shield.types.describe_protection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.describe_protection_request.DescribeProtectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_shield.types.describe_protection_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_protection(
