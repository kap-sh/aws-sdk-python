"""Generated from Smithy shape ``com.amazonaws.shield#ListProtectionGroups``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPaginationTokenException":
            import aws_sdk_shield.errors.invalid_pagination_token_exception

            raise aws_sdk_shield.errors.invalid_pagination_token_exception.InvalidPaginationTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_shield.types.list_protection_groups_response.ListProtectionGroupsResponse = aws_sdk_shield.types.list_protection_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.list_protection_groups_request.ListProtectionGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSShield_20160616.ListProtectionGroups"
    import aws_sdk_shield.types.list_protection_groups_request

    body: bytes | None = json.dumps(
        aws_sdk_shield.types.list_protection_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_protection_groups(
