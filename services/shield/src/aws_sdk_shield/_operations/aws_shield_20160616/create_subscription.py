...
def handle_response(
    ...
    out: aws_sdk_shield.types.create_subscription_response.CreateSubscriptionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.create_subscription_request.CreateSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
