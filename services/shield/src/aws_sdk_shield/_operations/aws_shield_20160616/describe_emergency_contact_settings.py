...
def handle_response(
    ...
    out: aws_sdk_shield.types.describe_emergency_contact_settings_response.DescribeEmergencyContactSettingsResponse = aws_sdk_shield.types.describe_emergency_contact_settings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_shield.types.describe_emergency_contact_settings_request.DescribeEmergencyContactSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
