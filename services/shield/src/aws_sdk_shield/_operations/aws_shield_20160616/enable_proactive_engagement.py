...
def handle_response(
    ...
    out: aws_sdk_shield.types.enable_proactive_engagement_response.EnableProactiveEngagementResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.enable_proactive_engagement_request.EnableProactiveEngagementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
