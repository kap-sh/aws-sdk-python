...
def handle_response(
    ...
    out: aws_sdk_shield.types.disable_proactive_engagement_response.DisableProactiveEngagementResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_shield.types.disable_proactive_engagement_request.DisableProactiveEngagementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
