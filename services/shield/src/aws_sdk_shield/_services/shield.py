...
from aws_sdk_shield._services._aws_config import aws_config
...
class ShieldClientConfig(TypedDict, total=False):
...
class ShieldClient:
    ...
    def associate_drt_log_bucket(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.associate_drt_log_bucket_request.AssociateDRTLogBucketRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.associate_drt_log_bucket_response.AssociateDRTLogBucketResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.associate_drt_log_bucket.associate_drt_log_bucket(
    ...
    def associate_drt_role(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.associate_drt_role_request.AssociateDRTRoleRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.associate_drt_role_response.AssociateDRTRoleResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.associate_drt_role.associate_drt_role(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def associate_health_check(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.associate_health_check_request.AssociateHealthCheckRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.associate_health_check_response.AssociateHealthCheckResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.associate_health_check.associate_health_check(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def associate_proactive_engagement_details(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.associate_proactive_engagement_details_request.AssociateProactiveEngagementDetailsRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.associate_proactive_engagement_details_response.AssociateProactiveEngagementDetailsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.associate_proactive_engagement_details.associate_proactive_engagement_details(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_protection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.create_protection_request.CreateProtectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.create_protection_response.CreateProtectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.create_protection.create_protection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_protection_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.create_protection_group_request.CreateProtectionGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.create_protection_group_response.CreateProtectionGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.create_protection_group.create_protection_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_subscription(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.create_subscription.create_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_protection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.delete_protection_request.DeleteProtectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.delete_protection_response.DeleteProtectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.delete_protection.delete_protection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_protection_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.delete_protection_group_request.DeleteProtectionGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.delete_protection_group_response.DeleteProtectionGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.delete_protection_group.delete_protection_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_subscription(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.delete_subscription.delete_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_attack(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.describe_attack_request.DescribeAttackRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.describe_attack_response.DescribeAttackResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.describe_attack.describe_attack(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_attack_statistics(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.describe_attack_statistics.describe_attack_statistics(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_drt_access(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.describe_drt_access.describe_drt_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_emergency_contact_settings(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.describe_emergency_contact_settings.describe_emergency_contact_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_protection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.describe_protection_request.DescribeProtectionRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.describe_protection_response.DescribeProtectionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.describe_protection.describe_protection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_protection_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.describe_protection_group_request.DescribeProtectionGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.describe_protection_group_response.DescribeProtectionGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.describe_protection_group.describe_protection_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_subscription(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.describe_subscription.describe_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disable_application_layer_automatic_response(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.disable_application_layer_automatic_response_request.DisableApplicationLayerAutomaticResponseRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.disable_application_layer_automatic_response_response.DisableApplicationLayerAutomaticResponseResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.disable_application_layer_automatic_response.disable_application_layer_automatic_response(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disable_proactive_engagement(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.disable_proactive_engagement.disable_proactive_engagement(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_drt_log_bucket(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.disassociate_drt_log_bucket_request.DisassociateDRTLogBucketRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.disassociate_drt_log_bucket_response.DisassociateDRTLogBucketResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.disassociate_drt_log_bucket.disassociate_drt_log_bucket(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_drt_role(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.disassociate_drt_role.disassociate_drt_role(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_health_check(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.disassociate_health_check_request.DisassociateHealthCheckRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.disassociate_health_check_response.DisassociateHealthCheckResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.disassociate_health_check.disassociate_health_check(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_application_layer_automatic_response(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.enable_application_layer_automatic_response_request.EnableApplicationLayerAutomaticResponseRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.enable_application_layer_automatic_response_response.EnableApplicationLayerAutomaticResponseResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.enable_application_layer_automatic_response.enable_application_layer_automatic_response(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_proactive_engagement(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.enable_proactive_engagement.enable_proactive_engagement(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_subscription_state(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.get_subscription_state.get_subscription_state(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_attacks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.list_attacks_request.ListAttacksRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.list_attacks_response.ListAttacksResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.list_attacks.list_attacks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_attacks(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_shield.types.token.Token"] = None,
        max_results: Optional["aws_sdk_shield.types.max_results.MaxResults"] = None,
    ) -> "Iterator[aws_sdk_shield.types.attack_summary.AttackSummary]":
        _token = next_token
        while True:
    ...
    def list_protection_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.list_protection_groups_request.ListProtectionGroupsRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.list_protection_groups_response.ListProtectionGroupsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.list_protection_groups.list_protection_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_protections(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.list_protections_request.ListProtectionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.list_protections_response.ListProtectionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.list_protections.list_protections(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_shield.types.protection.Protection]":
        _token = next_token
        while True:
    ...
    def list_resources_in_protection_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.list_resources_in_protection_group_request.ListResourcesInProtectionGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.list_resources_in_protection_group_response.ListResourcesInProtectionGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.list_resources_in_protection_group.list_resources_in_protection_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_application_layer_automatic_response(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.update_application_layer_automatic_response_request.UpdateApplicationLayerAutomaticResponseRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.update_application_layer_automatic_response_response.UpdateApplicationLayerAutomaticResponseResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.update_application_layer_automatic_response.update_application_layer_automatic_response(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_emergency_contact_settings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.update_emergency_contact_settings_request.UpdateEmergencyContactSettingsRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.update_emergency_contact_settings_response.UpdateEmergencyContactSettingsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.update_emergency_contact_settings.update_emergency_contact_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_protection_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.update_protection_group_request.UpdateProtectionGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.update_protection_group_response.UpdateProtectionGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.update_protection_group.update_protection_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_subscription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_shield.types.update_subscription_request.UpdateSubscriptionRequest]",
        ) -> OperationResponse[
            "aws_sdk_shield.types.update_subscription_response.UpdateSubscriptionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_shield._operations.aws_shield_20160616.update_subscription.update_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
