        ...
        if _locals["PartitionResult"] is not None:
            if string_equals(
                ...
                if p.UseFIPS is False:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://shield.us-east-1.amazonaws.com", p, _locals
                            ),
                            properties={
                                "authSchemes": [
                                    {
            ...
            if string_equals(
                ...
                if p.UseFIPS is True:
                    if p.UseDualStack is False:
                        return Endpoint(
                            url=interpolate(
                                "https://shield-fips.us-east-1.amazonaws.com",
                                p,
                                _locals,
                            ),
                            properties={
                ...
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            return Endpoint(
                                url=interpolate(
                                    "https://shield-fips.{Region}.{PartitionResult#dualStackDnsSuffix}",
                                    p,
                                    _locals,
                                ),
                                properties={},
            ...
            if p.UseFIPS is True:
                if (
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://shield-fips.{Region}.{PartitionResult#dnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            if p.UseDualStack is True:
                if True is get_attr(
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://shield.{Region}.{PartitionResult#dualStackDnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            return Endpoint(
                url=interpolate(
                    "https://shield.{Region}.{PartitionResult#dnsSuffix}", p, _locals
                ),
                properties={},
                headers={},
            )
