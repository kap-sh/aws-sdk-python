...
if TYPE_CHECKING:
    import aws_sdk_shield.types.summarized_counter

SummarizedCounterList: TypeAlias = list[
    "aws_sdk_shield.types.summarized_counter.SummarizedCounter"
]
...
def serialize_aws_json_1_1(value: SummarizedCounterList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_shield.types.summarized_counter.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> SummarizedCounterList:
    ...
    for item in data:
        out.append(
            aws_sdk_shield.types.summarized_counter.deserialize_aws_json_1_1(item)
        )
    return out
