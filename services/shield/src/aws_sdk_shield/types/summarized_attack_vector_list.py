...
if TYPE_CHECKING:
    import aws_sdk_shield.types.summarized_attack_vector

SummarizedAttackVectorList: TypeAlias = list[
    "aws_sdk_shield.types.summarized_attack_vector.SummarizedAttackVector"
]
...
def serialize_aws_json_1_1(value: SummarizedAttackVectorList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_shield.types.summarized_attack_vector.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> SummarizedAttackVectorList:
    ...
    for item in data:
        out.append(
            aws_sdk_shield.types.summarized_attack_vector.deserialize_aws_json_1_1(item)
        )
    return out
