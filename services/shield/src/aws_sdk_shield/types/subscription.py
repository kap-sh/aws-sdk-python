...
if TYPE_CHECKING:
    ...
    import aws_sdk_shield.types.duration_in_seconds
    import aws_sdk_shield.types.limits
    import aws_sdk_shield.types.proactive_engagement_status
    import aws_sdk_shield.types.resource_arn
    import aws_sdk_shield.types.subscription_limits
    import aws_sdk_shield.types.timestamp


class Subscription(TypedDict, closed=True):
    start_time: NotRequired["aws_sdk_shield.types.timestamp.Timestamp"]
    """<p>The start time of the subscription, in Unix time in seconds. </p>"""
    end_time: NotRequired["aws_sdk_shield.types.timestamp.Timestamp"]
    """<p>The date and time your subscription will end.</p>"""
    time_commitment_in_seconds: (
        "aws_sdk_shield.types.duration_in_seconds.DurationInSeconds"
    )
    ...
    limits: NotRequired["aws_sdk_shield.types.limits.Limits"]
    """<p>Specifies how many protections of a given type you can create.</p>"""
    proactive_engagement_status: NotRequired[
        "aws_sdk_shield.types.proactive_engagement_status.ProactiveEngagementStatus"
    ]
    ...
    subscription_limits: "aws_sdk_shield.types.subscription_limits.SubscriptionLimits"
    """<p>Limits settings for your subscription. </p>"""
    subscription_arn: NotRequired["aws_sdk_shield.types.resource_arn.ResourceArn"]
...
def serialize_aws_json_1_1(value: Subscription) -> dict:
    ...
    if "start_time" in value:
        ...
        out["StartTime"] = aws_sdk_shield.types.timestamp.serialize_aws_json_1_1(
            value["start_time"]
        )
    if "end_time" in value:
        import aws_sdk_shield.types.timestamp

        out["EndTime"] = aws_sdk_shield.types.timestamp.serialize_aws_json_1_1(
            value["end_time"]
        )
    ...
    if "limits" in value:
        ...
        out["Limits"] = aws_sdk_shield.types.limits.serialize_aws_json_1_1(
            value["limits"]
        )
    if "proactive_engagement_status" in value:
        ...
        out["ProactiveEngagementStatus"] = (
            aws_sdk_shield.types.proactive_engagement_status.serialize_aws_json_1_1(
    ...
    out["SubscriptionLimits"] = (
        aws_sdk_shield.types.subscription_limits.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Subscription:
    ...
    if "StartTime" in data:
        ...
        out["start_time"] = aws_sdk_shield.types.timestamp.deserialize_aws_json_1_1(
            data["StartTime"]
        )
    if "EndTime" in data:
        import aws_sdk_shield.types.timestamp

        out["end_time"] = aws_sdk_shield.types.timestamp.deserialize_aws_json_1_1(
            data["EndTime"]
        )
    ...
    if "Limits" in data:
        ...
        out["limits"] = aws_sdk_shield.types.limits.deserialize_aws_json_1_1(
            data["Limits"]
        )
    if "ProactiveEngagementStatus" in data:
        ...
        out["proactive_engagement_status"] = (
            aws_sdk_shield.types.proactive_engagement_status.deserialize_aws_json_1_1(
    ...
    if "SubscriptionLimits" in data:
        ...
        out["subscription_limits"] = (
            aws_sdk_shield.types.subscription_limits.deserialize_aws_json_1_1(
