...
if TYPE_CHECKING:
    ...
    import aws_sdk_shield.types.health_check_ids
...
class Protection(TypedDict):
    ...
    health_check_ids: NotRequired[
        "aws_sdk_shield.types.health_check_ids.HealthCheckIds"
    ]
    """<p>The unique identifier (ID) for the Route 53 health check that's associated with the protection. </p>"""
    protection_arn: NotRequired["aws_sdk_shield.types.resource_arn.ResourceArn"]
    """<p>The ARN (Amazon Resource Name) of the protection.</p>"""
    application_layer_automatic_response_configuration: NotRequired[
        "aws_sdk_shield.types.application_layer_automatic_response_configuration.ApplicationLayerAutomaticResponseConfiguration"
    ]
...
def serialize_aws_json_1_1(value: Protection) -> dict:
    ...
    if "health_check_ids" in value:
        ...
        out["HealthCheckIds"] = (
            aws_sdk_shield.types.health_check_ids.serialize_aws_json_1_1(
    ...
    if "application_layer_automatic_response_configuration" in value:
        ...
        out["ApplicationLayerAutomaticResponseConfiguration"] = (
            aws_sdk_shield.types.application_layer_automatic_response_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Protection:
    ...
    if "HealthCheckIds" in data:
        ...
        out["health_check_ids"] = (
            aws_sdk_shield.types.health_check_ids.deserialize_aws_json_1_1(
                data["HealthCheckIds"]
            )
        )
    ...
    if "ApplicationLayerAutomaticResponseConfiguration" in data:
        ...
        out["application_layer_automatic_response_configuration"] = (
            aws_sdk_shield.types.application_layer_automatic_response_configuration.deserialize_aws_json_1_1(
