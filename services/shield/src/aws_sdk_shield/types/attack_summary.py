...
if TYPE_CHECKING:
    ...
    import aws_sdk_shield.types.attack_vector_description_list
    import aws_sdk_shield.types.string


class AttackSummary(TypedDict):
    attack_id: NotRequired["aws_sdk_shield.types.string.String"]
    """<p>The unique identifier (ID) of the attack.</p>"""
    resource_arn: NotRequired["aws_sdk_shield.types.string.String"]
    ...
    attack_vectors: NotRequired[
        "aws_sdk_shield.types.attack_vector_description_list.AttackVectorDescriptionList"
    ]
...
def serialize_aws_json_1_1(value: AttackSummary) -> dict:
    ...
    if "attack_vectors" in value:
        ...
        out["AttackVectors"] = (
            aws_sdk_shield.types.attack_vector_description_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AttackSummary:
    ...
    if "AttackVectors" in data:
        ...
        out["attack_vectors"] = (
            aws_sdk_shield.types.attack_vector_description_list.deserialize_aws_json_1_1(
                data["AttackVectors"]
            )
        )
    return out
