import pytest
from capo_service_catalog_appregistry._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_service_catalog_appregistry._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
