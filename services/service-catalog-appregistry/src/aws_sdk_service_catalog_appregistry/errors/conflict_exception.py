"""Generated from Smithy shape ``com.amazonaws.servicecatalogappregistry#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.servicecatalogappregistry#ConflictException``."""
