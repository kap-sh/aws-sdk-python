...
if TYPE_CHECKING:
    import aws_sdk_service_catalog_appregistry.types.tag_key_config


class TagQueryConfiguration(TypedDict):
    tag_key: NotRequired[
        "aws_sdk_service_catalog_appregistry.types.tag_key_config.TagKeyConfig"
    ]
