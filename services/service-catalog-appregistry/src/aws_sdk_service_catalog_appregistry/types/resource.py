...
if TYPE_CHECKING:
    ...
    import aws_sdk_service_catalog_appregistry.types.resource_integrations
...
class Resource(TypedDict):
    ...
    integrations: NotRequired[
        "aws_sdk_service_catalog_appregistry.types.resource_integrations.ResourceIntegrations"
    ]
...
def serialize_json(value: Resource) -> dict:
    ...
    if "integrations" in value:
        ...
        out["integrations"] = (
            aws_sdk_service_catalog_appregistry.types.resource_integrations.serialize_json(
                value["integrations"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> Resource:
    ...
    if "integrations" in data:
        ...
        out["integrations"] = (
            aws_sdk_service_catalog_appregistry.types.resource_integrations.deserialize_json(
                data["integrations"]
            )
        )
    return out
