...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.sync_resource_response.SyncResourceResponse = aws_sdk_service_catalog_appregistry.types.sync_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog_appregistry.types.sync_resource_request.SyncResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
