...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.get_configuration_response.GetConfigurationResponse = aws_sdk_service_catalog_appregistry.types.get_configuration_response.deserialize_json(
