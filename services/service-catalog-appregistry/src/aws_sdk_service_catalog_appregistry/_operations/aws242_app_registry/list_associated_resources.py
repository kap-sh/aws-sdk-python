...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.list_associated_resources_response.ListAssociatedResourcesResponse = aws_sdk_service_catalog_appregistry.types.list_associated_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog_appregistry.types.list_associated_resources_request.ListAssociatedResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
