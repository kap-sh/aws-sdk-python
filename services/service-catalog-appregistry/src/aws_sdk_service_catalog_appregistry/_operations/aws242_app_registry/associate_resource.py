...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.associate_resource_response.AssociateResourceResponse = aws_sdk_service_catalog_appregistry.types.associate_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog_appregistry.types.associate_resource_request.AssociateResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog_appregistry.types.associate_resource_request.serialize_json(
            input_
        )
    ).encode()
