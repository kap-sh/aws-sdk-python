"""Generated from Smithy shape ``com.amazonaws.servicecatalogappregistry#GetAttributeGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.get_attribute_group_response.GetAttributeGroupResponse = aws_sdk_service_catalog_appregistry.types.get_attribute_group_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_service_catalog_appregistry.types.get_attribute_group_request.GetAttributeGroupRequest,
) -> zapros.Request:
...
async def async_get_attribute_group(
