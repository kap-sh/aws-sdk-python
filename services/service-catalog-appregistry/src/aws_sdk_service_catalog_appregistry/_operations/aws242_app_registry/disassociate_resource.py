...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.disassociate_resource_response.DisassociateResourceResponse = aws_sdk_service_catalog_appregistry.types.disassociate_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog_appregistry.types.disassociate_resource_request.DisassociateResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
