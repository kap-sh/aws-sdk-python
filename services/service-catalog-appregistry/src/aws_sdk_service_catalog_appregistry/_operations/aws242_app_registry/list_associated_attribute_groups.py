...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.list_associated_attribute_groups_response.ListAssociatedAttributeGroupsResponse = aws_sdk_service_catalog_appregistry.types.list_associated_attribute_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog_appregistry.types.list_associated_attribute_groups_request.ListAssociatedAttributeGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
