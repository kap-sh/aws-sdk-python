"""Generated from Smithy shape ``com.amazonaws.servicecatalogappregistry#UpdateAttributeGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.update_attribute_group_response.UpdateAttributeGroupResponse = aws_sdk_service_catalog_appregistry.types.update_attribute_group_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_service_catalog_appregistry.types.update_attribute_group_request.UpdateAttributeGroupRequest,
) -> zapros.Request:
    ...
    url = url.replace("{attributeGroup}", quote(str(input["attribute_group"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_service_catalog_appregistry.types.update_attribute_group_request

    body: bytes | None = json.dumps(
        aws_sdk_service_catalog_appregistry.types.update_attribute_group_request.serialize_json(
            input
        )
    ).encode()
...
async def async_update_attribute_group(
