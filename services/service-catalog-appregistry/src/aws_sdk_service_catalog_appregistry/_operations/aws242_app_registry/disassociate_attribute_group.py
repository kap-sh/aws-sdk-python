...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.disassociate_attribute_group_response.DisassociateAttributeGroupResponse = aws_sdk_service_catalog_appregistry.types.disassociate_attribute_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog_appregistry.types.disassociate_attribute_group_request.DisassociateAttributeGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
