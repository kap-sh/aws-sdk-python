...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.list_attribute_groups_response.ListAttributeGroupsResponse = aws_sdk_service_catalog_appregistry.types.list_attribute_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog_appregistry.types.list_attribute_groups_request.ListAttributeGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
