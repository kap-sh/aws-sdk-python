...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.create_attribute_group_response.CreateAttributeGroupResponse = aws_sdk_service_catalog_appregistry.types.create_attribute_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog_appregistry.types.create_attribute_group_request.CreateAttributeGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog_appregistry.types.create_attribute_group_request.serialize_json(
            input_
        )
    ).encode()
