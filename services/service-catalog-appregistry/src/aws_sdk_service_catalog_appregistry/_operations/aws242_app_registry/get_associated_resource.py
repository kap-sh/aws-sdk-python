...
def build_request(
    ...
    input: aws_sdk_service_catalog_appregistry.types.get_associated_resource_request.GetAssociatedResourceRequest,
) -> zapros.Request:
    ...
    if "resource_tag_status" in input:
        params["resourceTagStatus"] = str(input["resource_tag_status"])
