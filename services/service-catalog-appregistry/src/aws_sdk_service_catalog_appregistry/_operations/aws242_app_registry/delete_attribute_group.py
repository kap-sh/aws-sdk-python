...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.delete_attribute_group_response.DeleteAttributeGroupResponse = aws_sdk_service_catalog_appregistry.types.delete_attribute_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog_appregistry.types.delete_attribute_group_request.DeleteAttributeGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
