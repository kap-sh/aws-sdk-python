...
import aws_sdk_service_catalog_appregistry.errors.conflict_exception
import aws_sdk_service_catalog_appregistry.errors.internal_server_exception
import aws_sdk_service_catalog_appregistry.errors.service_quota_exceeded_exception
import aws_sdk_service_catalog_appregistry.errors.throttling_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            raise aws_sdk_service_catalog_appregistry.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_service_catalog_appregistry.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
        case "ThrottlingException":
            raise aws_sdk_service_catalog_appregistry.errors.throttling_exception.ThrottlingException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.create_application_response.CreateApplicationResponse = aws_sdk_service_catalog_appregistry.types.create_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog_appregistry.types.create_application_request.CreateApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_service_catalog_appregistry.types.create_application_request.serialize_json(
            input_
        )
    ).encode()
