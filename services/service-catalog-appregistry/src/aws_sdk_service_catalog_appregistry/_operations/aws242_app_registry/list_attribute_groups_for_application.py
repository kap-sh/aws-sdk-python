...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.list_attribute_groups_for_application_response.ListAttributeGroupsForApplicationResponse = aws_sdk_service_catalog_appregistry.types.list_attribute_groups_for_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog_appregistry.types.list_attribute_groups_for_application_request.ListAttributeGroupsForApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
