...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.associate_attribute_group_response.AssociateAttributeGroupResponse = aws_sdk_service_catalog_appregistry.types.associate_attribute_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog_appregistry.types.associate_attribute_group_request.AssociateAttributeGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
