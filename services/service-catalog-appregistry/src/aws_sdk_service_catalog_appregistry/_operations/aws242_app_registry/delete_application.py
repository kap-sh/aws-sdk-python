...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.delete_application_response.DeleteApplicationResponse = aws_sdk_service_catalog_appregistry.types.delete_application_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_service_catalog_appregistry.types.delete_application_request.DeleteApplicationRequest,
) -> zapros.Request:
