...
def handle_response(
    ...
    out: aws_sdk_service_catalog_appregistry.types.list_applications_response.ListApplicationsResponse = aws_sdk_service_catalog_appregistry.types.list_applications_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_service_catalog_appregistry.types.list_applications_request.ListApplicationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
