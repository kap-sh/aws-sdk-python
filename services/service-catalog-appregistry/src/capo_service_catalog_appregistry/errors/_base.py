...
class ServiceCatalogAppRegistryError(Exception):
    """Base class for all ServiceCatalogAppRegistry service errors."""


class ServiceError(ServiceCatalogAppRegistryError):
...
class SerializationError(ServiceCatalogAppRegistryError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ServiceCatalogAppRegistryError):
...
class WaiterFailedError(ServiceCatalogAppRegistryError):
...
class WaiterTimeoutError(ServiceCatalogAppRegistryError):
