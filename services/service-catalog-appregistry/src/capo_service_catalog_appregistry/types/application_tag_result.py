...
class ApplicationTagResult(TypedDict, closed=True):
    application_tag_status: NotRequired[
        "capo_service_catalog_appregistry.types.application_tag_status.ApplicationTagStatus"
    ]
    ...
    resources: NotRequired[
        "capo_service_catalog_appregistry.types.resources_list.ResourcesList"
    ]
...
def serialize_json(value: ApplicationTagResult) -> dict:
    ...
    if "application_tag_status" in value:
        ...
        out["applicationTagStatus"] = (
            capo_service_catalog_appregistry.types.application_tag_status.serialize_json(
    ...
    if "resources" in value:
        ...
        out["resources"] = (
            capo_service_catalog_appregistry.types.resources_list.serialize_json(
                value["resources"]
            )
        )
...
def deserialize_json(data: dict) -> ApplicationTagResult:
    ...
    if "applicationTagStatus" in data:
        ...
        out["application_tag_status"] = (
            capo_service_catalog_appregistry.types.application_tag_status.deserialize_json(
    ...
    if "resources" in data:
        ...
        out["resources"] = (
            capo_service_catalog_appregistry.types.resources_list.deserialize_json(
                data["resources"]
            )
        )
