...
if TYPE_CHECKING:
    ...
    from capo_geo_routes._services.async_geo_routes import (
        AsyncGeoRoutesClient,
        AsyncGeoRoutesClientConfig,
    )
    from capo_geo_routes._services.geo_routes import (
        GeoRoutesClient,
...
class ProviderResource:
    ...
    def calculate_isolines(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_geo_routes.types.calculate_isolines_request.CalculateIsolinesRequest]",
        ) -> OperationResponse[
            "capo_geo_routes.types.calculate_isolines_response.CalculateIsolinesResponse"
        ]:
            ...
            output, http_response = (
                capo_geo_routes._operations.routes_service.calculate_isolines.calculate_isolines(
    ...
    def calculate_route_matrix(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_geo_routes.types.calculate_route_matrix_request.CalculateRouteMatrixRequest]",
        ) -> OperationResponse[
            "capo_geo_routes.types.calculate_route_matrix_response.CalculateRouteMatrixResponse"
        ]:
            ...
            output, http_response = (
                capo_geo_routes._operations.routes_service.calculate_route_matrix.calculate_route_matrix(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def calculate_routes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_geo_routes.types.calculate_routes_request.CalculateRoutesRequest]",
        ) -> OperationResponse[
            "capo_geo_routes.types.calculate_routes_response.CalculateRoutesResponse"
        ]:
            ...
            output, http_response = (
                capo_geo_routes._operations.routes_service.calculate_routes.calculate_routes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def optimize_waypoints(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_geo_routes.types.optimize_waypoints_request.OptimizeWaypointsRequest]",
        ) -> OperationResponse[
            "capo_geo_routes.types.optimize_waypoints_response.OptimizeWaypointsResponse"
        ]:
            ...
            output, http_response = (
                capo_geo_routes._operations.routes_service.optimize_waypoints.optimize_waypoints(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def snap_to_roads(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_geo_routes.types.snap_to_roads_request.SnapToRoadsRequest]",
        ) -> OperationResponse[
            "capo_geo_routes.types.snap_to_roads_response.SnapToRoadsResponse"
        ]:
            ...
            output, http_response = (
                capo_geo_routes._operations.routes_service.snap_to_roads.snap_to_roads(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
