"""Generated from Smithy shape ``com.amazonaws.georoutes#RouteUTurnStepDetails``."""
...
class RouteUTurnStepDetails(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: RouteUTurnStepDetails) -> dict:
    out: dict = {}
    import capo_geo_routes.types.localized_string_list
...
def deserialize_json(data: dict) -> RouteUTurnStepDetails:
    out: RouteUTurnStepDetails = {}  # type: ignore[typeddict-item]
    if "Intersection" in data:
        ...
        raise DeserializationError("RouteUTurnStepDetails.intersection required")
