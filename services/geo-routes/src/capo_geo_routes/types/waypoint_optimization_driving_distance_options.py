...
if TYPE_CHECKING:
    import capo_geo_routes.types.waypoint_optimization_driving_distance


class WaypointOptimizationDrivingDistanceOptions(TypedDict, closed=True):
    driving_distance: "capo_geo_routes.types.waypoint_optimization_driving_distance.WaypointOptimizationDrivingDistance"
