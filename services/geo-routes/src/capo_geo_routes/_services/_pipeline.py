...
from capo_geo_routes._async import anysleep
from capo_geo_routes.errors import ServiceError

if TYPE_CHECKING:
    from capo_geo_routes._auth._identity import Credentials
    from capo_geo_routes._auth._providers import IdentityProvider
