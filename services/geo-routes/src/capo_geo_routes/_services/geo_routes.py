...
from capo_geo_routes._resources.routes_service.provider_resource import ProviderResource
from capo_geo_routes._services._aws_config import aws_config
...
class GeoRoutesClientConfig(TypedDict, total=False, closed=True):
...
class GeoRoutesClient:
    ...
    def __init__(
        ...
        self._config = GeoRoutesClientConfig(
            {
    ...
    def operation_options(
        ...
        overrides: GeoRoutesClientConfig = config_overrides or {}
