...
class GeoRoutesError(Exception):
    """Base class for all GeoRoutes service errors."""


class ServiceError(GeoRoutesError):
...
class SerializationError(GeoRoutesError):
    """Raised when a value cannot be serialized."""


class DeserializationError(GeoRoutesError):
...
class WaiterFailedError(GeoRoutesError):
...
class WaiterTimeoutError(GeoRoutesError):
