...
if TYPE_CHECKING:
    ...
    import aws_sdk_geo_routes.types.route_ferry_travel_step_type
    import aws_sdk_geo_routes.types.sensitive_string


class RouteFerryTravelStep(TypedDict):
    ...
    type: (
        "aws_sdk_geo_routes.types.route_ferry_travel_step_type.RouteFerryTravelStepType"
    )
...
def serialize_json(value: RouteFerryTravelStep) -> dict:
    ...
    out["Type"] = aws_sdk_geo_routes.types.route_ferry_travel_step_type.serialize_json(
        value["type"]
    )
    return out
...
def deserialize_json(data: dict) -> RouteFerryTravelStep:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_geo_routes.types.route_ferry_travel_step_type.deserialize_json(
                data["Type"]
            )
        )
    else:
