...
if TYPE_CHECKING:
    ...
    import aws_sdk_geo_routes.types.route_rental_travel_step_type
...
class RouteRentalTravelStep(TypedDict):
    ...
    type: "aws_sdk_geo_routes.types.route_rental_travel_step_type.RouteRentalTravelStepType"
...
def serialize_json(value: RouteRentalTravelStep) -> dict:
    ...
    out["Type"] = aws_sdk_geo_routes.types.route_rental_travel_step_type.serialize_json(
        value["type"]
    )
...
def deserialize_json(data: dict) -> RouteRentalTravelStep:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_geo_routes.types.route_rental_travel_step_type.deserialize_json(
                data["Type"]
            )
        )
    else:
