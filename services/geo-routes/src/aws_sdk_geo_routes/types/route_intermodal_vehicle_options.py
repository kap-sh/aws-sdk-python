"""Generated from Smithy shape ``com.amazonaws.georoutes#RouteIntermodalVehicleOptions``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_geo_routes.types.route_vehicle_mode_list


class RouteIntermodalVehicleOptions(TypedDict, closed=True):
    allowed_modes: NotRequired[
        "aws_sdk_geo_routes.types.route_vehicle_mode_list.RouteVehicleModeList"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: RouteIntermodalVehicleOptions) -> dict:
    out: dict = {}
    if "allowed_modes" in value:
        import aws_sdk_geo_routes.types.route_vehicle_mode_list

        out["AllowedModes"] = (
            aws_sdk_geo_routes.types.route_vehicle_mode_list.serialize_json(
                value["allowed_modes"]
            )
        )
...
def deserialize_json(data: dict) -> RouteIntermodalVehicleOptions:
    out: RouteIntermodalVehicleOptions = {}  # type: ignore[typeddict-item]
    if "AllowedModes" in data:
        import aws_sdk_geo_routes.types.route_vehicle_mode_list

        out["allowed_modes"] = (
            aws_sdk_geo_routes.types.route_vehicle_mode_list.deserialize_json(
                data["AllowedModes"]
            )
        )
