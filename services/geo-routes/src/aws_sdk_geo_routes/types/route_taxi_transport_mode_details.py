...
class RouteTaxiTransportModeDetails(TypedDict):
    ...
    mode: "aws_sdk_geo_routes.types.route_taxi_mode.RouteTaxiMode"
...
def serialize_json(value: RouteTaxiTransportModeDetails) -> dict:
    ...
    out["Mode"] = aws_sdk_geo_routes.types.route_taxi_mode.serialize_json(value["mode"])
    if "model" in value:
...
def deserialize_json(data: dict) -> RouteTaxiTransportModeDetails:
    ...
    if "Mode" in data:
        ...
        out["mode"] = aws_sdk_geo_routes.types.route_taxi_mode.deserialize_json(
            data["Mode"]
        )
    else:
