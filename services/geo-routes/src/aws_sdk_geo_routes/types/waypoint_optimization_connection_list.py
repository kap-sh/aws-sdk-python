...
if TYPE_CHECKING:
    import aws_sdk_geo_routes.types.waypoint_optimization_connection

WaypointOptimizationConnectionList: TypeAlias = list[
    "aws_sdk_geo_routes.types.waypoint_optimization_connection.WaypointOptimizationConnection"
]
...
def serialize_json(value: WaypointOptimizationConnectionList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_geo_routes.types.waypoint_optimization_connection.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> WaypointOptimizationConnectionList:
    ...
    for item in data:
        out.append(
            aws_sdk_geo_routes.types.waypoint_optimization_connection.deserialize_json(
                item
            )
        )
    return out
