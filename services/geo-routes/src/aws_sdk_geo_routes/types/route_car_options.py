"""Generated from Smithy shape ``com.amazonaws.georoutes#RouteCarOptions``."""
...
class RouteCarOptions(TypedDict):
...
# --- restJson1 ser/de ---
def serialize_json(value: RouteCarOptions) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> RouteCarOptions:
    out: RouteCarOptions = {}  # type: ignore[typeddict-item]
