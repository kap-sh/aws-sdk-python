...
if TYPE_CHECKING:
    ...
    import aws_sdk_geo_routes.types.route_transit_after_travel_step_list
    import aws_sdk_geo_routes.types.route_transit_agency
    import aws_sdk_geo_routes.types.route_transit_arrival
    import aws_sdk_geo_routes.types.route_transit_before_travel_step_list
    import aws_sdk_geo_routes.types.route_transit_departure
    import aws_sdk_geo_routes.types.route_transit_incident_list
    import aws_sdk_geo_routes.types.route_transit_intermediate_stop_list
    import aws_sdk_geo_routes.types.route_transit_next_departure_list
    import aws_sdk_geo_routes.types.route_transit_notice_list
    import aws_sdk_geo_routes.types.route_transit_span_list
    import aws_sdk_geo_routes.types.route_transit_summary
    import aws_sdk_geo_routes.types.route_transit_transport_mode_details
    import aws_sdk_geo_routes.types.route_transit_travel_step_list
    import aws_sdk_geo_routes.types.route_web_link_list


class RouteTransitLegDetails(TypedDict):
    after_travel_steps: "aws_sdk_geo_routes.types.route_transit_after_travel_step_list.RouteTransitAfterTravelStepList"
    """<p>Steps of a leg that must be performed after the travel portion of the leg.</p>"""
    agency: NotRequired[
        "aws_sdk_geo_routes.types.route_transit_agency.RouteTransitAgency"
    ]
    """<p>Details about the transit agency.</p>"""
    arrival: "aws_sdk_geo_routes.types.route_transit_arrival.RouteTransitArrival"
    ...
    before_travel_steps: "aws_sdk_geo_routes.types.route_transit_before_travel_step_list.RouteTransitBeforeTravelStepList"
    ...
    incidents: (
        "aws_sdk_geo_routes.types.route_transit_incident_list.RouteTransitIncidentList"
    )
    """<p>Incidents affecting this leg of the transit route.</p>"""
    intermediate_stops: "aws_sdk_geo_routes.types.route_transit_intermediate_stop_list.RouteTransitIntermediateStopList"
    """<p>Intermediate stops between departure and destination of the transit route.</p>"""
    next_departures: "aws_sdk_geo_routes.types.route_transit_next_departure_list.RouteTransitNextDepartureList"
    """<p>List of next departures that cover the same section of the route.</p>"""
    notices: "aws_sdk_geo_routes.types.route_transit_notice_list.RouteTransitNoticeList"
    ...
    spans: "aws_sdk_geo_routes.types.route_transit_span_list.RouteTransitSpanList"
    ...
    summary: NotRequired[
        "aws_sdk_geo_routes.types.route_transit_summary.RouteTransitSummary"
    ]
    """<p>Summary of the transit leg.</p>"""
    transport: "aws_sdk_geo_routes.types.route_transit_transport_mode_details.RouteTransitTransportModeDetails"
    """<p>Transport mode details for the transit leg.</p>"""
    travel_steps: "aws_sdk_geo_routes.types.route_transit_travel_step_list.RouteTransitTravelStepList"
...
def serialize_json(value: RouteTransitLegDetails) -> dict:
    ...
    out["AfterTravelSteps"] = (
        aws_sdk_geo_routes.types.route_transit_after_travel_step_list.serialize_json(
    ...
    if "agency" in value:
        ...
        out["Agency"] = aws_sdk_geo_routes.types.route_transit_agency.serialize_json(
            value["agency"]
        )
    import aws_sdk_geo_routes.types.route_transit_arrival

    out["Arrival"] = aws_sdk_geo_routes.types.route_transit_arrival.serialize_json(
        value["arrival"]
    )
    import aws_sdk_geo_routes.types.route_attribution_list
    ...
    out["BeforeTravelSteps"] = (
        aws_sdk_geo_routes.types.route_transit_before_travel_step_list.serialize_json(
    ...
    out["Incidents"] = (
        aws_sdk_geo_routes.types.route_transit_incident_list.serialize_json(
            value["incidents"]
        )
    )
    import aws_sdk_geo_routes.types.route_transit_intermediate_stop_list
    ...
    out["IntermediateStops"] = (
        aws_sdk_geo_routes.types.route_transit_intermediate_stop_list.serialize_json(
    ...
    out["NextDepartures"] = (
        aws_sdk_geo_routes.types.route_transit_next_departure_list.serialize_json(
            value["next_departures"]
        )
    )
    import aws_sdk_geo_routes.types.route_transit_notice_list

    out["Notices"] = aws_sdk_geo_routes.types.route_transit_notice_list.serialize_json(
        value["notices"]
    )
    import aws_sdk_geo_routes.types.route_pass_through_waypoint_list
    ...
    out["Spans"] = aws_sdk_geo_routes.types.route_transit_span_list.serialize_json(
        value["spans"]
    )
    if "summary" in value:
        import aws_sdk_geo_routes.types.route_transit_summary

        out["Summary"] = aws_sdk_geo_routes.types.route_transit_summary.serialize_json(
            value["summary"]
        )
    import aws_sdk_geo_routes.types.route_transit_transport_mode_details
    ...
    out["TravelSteps"] = (
        aws_sdk_geo_routes.types.route_transit_travel_step_list.serialize_json(
            value["travel_steps"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> RouteTransitLegDetails:
    ...
    if "AfterTravelSteps" in data:
        ...
        out["after_travel_steps"] = (
            aws_sdk_geo_routes.types.route_transit_after_travel_step_list.deserialize_json(
    ...
    if "Agency" in data:
        ...
        out["agency"] = aws_sdk_geo_routes.types.route_transit_agency.deserialize_json(
            data["Agency"]
        )
    if "Arrival" in data:
        import aws_sdk_geo_routes.types.route_transit_arrival
        ...
        out["arrival"] = (
            aws_sdk_geo_routes.types.route_transit_arrival.deserialize_json(
                data["Arrival"]
            )
        )
    else:
    ...
    if "BeforeTravelSteps" in data:
        ...
        out["before_travel_steps"] = (
            aws_sdk_geo_routes.types.route_transit_before_travel_step_list.deserialize_json(
    ...
    if "Incidents" in data:
        ...
        out["incidents"] = (
            aws_sdk_geo_routes.types.route_transit_incident_list.deserialize_json(
                data["Incidents"]
            )
        )
    else:
    ...
    if "IntermediateStops" in data:
        ...
        out["intermediate_stops"] = (
            aws_sdk_geo_routes.types.route_transit_intermediate_stop_list.deserialize_json(
    ...
    if "NextDepartures" in data:
        ...
        out["next_departures"] = (
            aws_sdk_geo_routes.types.route_transit_next_departure_list.deserialize_json(
                data["NextDepartures"]
            )
        )
    else:
    ...
    if "Notices" in data:
        ...
        out["notices"] = (
            aws_sdk_geo_routes.types.route_transit_notice_list.deserialize_json(
                data["Notices"]
            )
        )
    else:
    ...
    if "Spans" in data:
        ...
        out["spans"] = (
            aws_sdk_geo_routes.types.route_transit_span_list.deserialize_json(
                data["Spans"]
            )
        )
    else:
    ...
    if "Summary" in data:
        ...
        out["summary"] = (
            aws_sdk_geo_routes.types.route_transit_summary.deserialize_json(
                data["Summary"]
            )
        )
    ...
    if "TravelSteps" in data:
        ...
        out["travel_steps"] = (
            aws_sdk_geo_routes.types.route_transit_travel_step_list.deserialize_json(
                data["TravelSteps"]
            )
        )
    else:
