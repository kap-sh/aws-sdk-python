"""Generated from Smithy shape ``com.amazonaws.georoutes#RouteTurnStepDetails``."""
...
class RouteTurnStepDetails(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: RouteTurnStepDetails) -> dict:
    out: dict = {}
    import aws_sdk_geo_routes.types.localized_string_list
...
def deserialize_json(data: dict) -> RouteTurnStepDetails:
    out: RouteTurnStepDetails = {}  # type: ignore[typeddict-item]
    if "Intersection" in data:
        ...
        raise DeserializationError("RouteTurnStepDetails.intersection required")
