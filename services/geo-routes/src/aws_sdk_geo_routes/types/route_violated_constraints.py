...
if TYPE_CHECKING:
    ...
    import aws_sdk_geo_routes.types.route_notice_detail_range
    import aws_sdk_geo_routes.types.route_truck_type
    import aws_sdk_geo_routes.types.route_weight_constraint
...
class RouteViolatedConstraints(TypedDict, closed=True):
    ...
    axle_count: NotRequired[
        "aws_sdk_geo_routes.types.route_notice_detail_range.RouteNoticeDetailRange"
    ]
    """<p>Total number of axles of the vehicle.</p>"""
    hazardous_cargos: "aws_sdk_geo_routes.types.route_hazardous_cargo_type_list.RouteHazardousCargoTypeList"
    """<p>List of Hazardous cargo contained in the vehicle.</p>"""
    max_height: "aws_sdk_geo_routes.types.dimension_centimeters.DimensionCentimeters"
    ...
    max_length: "aws_sdk_geo_routes.types.dimension_centimeters.DimensionCentimeters"
    """<p>The maximum length of the vehicle.</p>"""
    max_payload_capacity: "aws_sdk_geo_routes.types.weight_kilograms.WeightKilograms"
    """<p>The maximum load capacity of the vehicle.</p> <p> <b>Unit</b>: <code>kilograms</code> </p>"""
    max_weight: NotRequired[
        "aws_sdk_geo_routes.types.route_weight_constraint.RouteWeightConstraint"
    ]
    """<p>The maximum weight of the route.</p> <p> <b>Unit</b>: <code>kilograms</code> </p>"""
    max_weight_per_axle: "aws_sdk_geo_routes.types.weight_kilograms.WeightKilograms"
    ...
    max_width: "aws_sdk_geo_routes.types.dimension_centimeters.DimensionCentimeters"
...
def serialize_json(value: RouteViolatedConstraints) -> dict:
    ...
    if "axle_count" in value:
        ...
        out["AxleCount"] = (
            aws_sdk_geo_routes.types.route_notice_detail_range.serialize_json(
                value["axle_count"]
            )
        )
    import aws_sdk_geo_routes.types.route_hazardous_cargo_type_list
    ...
    if "max_weight" in value:
        ...
        out["MaxWeight"] = (
            aws_sdk_geo_routes.types.route_weight_constraint.serialize_json(
                value["max_weight"]
            )
        )
...
def deserialize_json(data: dict) -> RouteViolatedConstraints:
    ...
    if "AxleCount" in data:
        ...
        out["axle_count"] = (
            aws_sdk_geo_routes.types.route_notice_detail_range.deserialize_json(
                data["AxleCount"]
            )
        )
    ...
    if "MaxWeight" in data:
        ...
        out["max_weight"] = (
            aws_sdk_geo_routes.types.route_weight_constraint.deserialize_json(
                data["MaxWeight"]
            )
        )
