...
class RouteTollPass(TypedDict):
    ...
    trip_count: NotRequired[
        "aws_sdk_geo_routes.types.sensitive_integer.SensitiveInteger"
    ]
    """<p>Number of trips the pass is valid for.</p>"""
    validity_period: NotRequired[
        "aws_sdk_geo_routes.types.route_toll_pass_validity_period.RouteTollPassValidityPeriod"
    ]
...
def serialize_json(value: RouteTollPass) -> dict:
    ...
    if "validity_period" in value:
        ...
        out["ValidityPeriod"] = (
            aws_sdk_geo_routes.types.route_toll_pass_validity_period.serialize_json(
...
def deserialize_json(data: dict) -> RouteTollPass:
    ...
    if "ValidityPeriod" in data:
        ...
        out["validity_period"] = (
            aws_sdk_geo_routes.types.route_toll_pass_validity_period.deserialize_json(
                data["ValidityPeriod"]
            )
        )
    return out
