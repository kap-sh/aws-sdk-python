...
if TYPE_CHECKING:
    ...
    import aws_sdk_geo_routes.types.route_matrix_hazardous_cargo_type_list
    import aws_sdk_geo_routes.types.route_matrix_trailer_options
    import aws_sdk_geo_routes.types.route_matrix_truck_type
...
class RouteMatrixTruckOptions(TypedDict):
    ...
    hazardous_cargos: NotRequired[
        "aws_sdk_geo_routes.types.route_matrix_hazardous_cargo_type_list.RouteMatrixHazardousCargoTypeList"
    ]
    ...
    trailer: NotRequired[
        "aws_sdk_geo_routes.types.route_matrix_trailer_options.RouteMatrixTrailerOptions"
    ]
    """<p>Trailer options corresponding to the vehicle.</p>"""
    truck_type: NotRequired[
        "aws_sdk_geo_routes.types.route_matrix_truck_type.RouteMatrixTruckType"
    ]
...
def serialize_json(value: RouteMatrixTruckOptions) -> dict:
    ...
    if "hazardous_cargos" in value:
        ...
        out["HazardousCargos"] = (
            aws_sdk_geo_routes.types.route_matrix_hazardous_cargo_type_list.serialize_json(
    ...
    if "trailer" in value:
        ...
        out["Trailer"] = (
            aws_sdk_geo_routes.types.route_matrix_trailer_options.serialize_json(
                value["trailer"]
            )
        )
    if "truck_type" in value:
        ...
        out["TruckType"] = (
            aws_sdk_geo_routes.types.route_matrix_truck_type.serialize_json(
                value["truck_type"]
            )
        )
...
def deserialize_json(data: dict) -> RouteMatrixTruckOptions:
    ...
    if "HazardousCargos" in data:
        ...
        out["hazardous_cargos"] = (
            aws_sdk_geo_routes.types.route_matrix_hazardous_cargo_type_list.deserialize_json(
    ...
    if "Trailer" in data:
        ...
        out["trailer"] = (
            aws_sdk_geo_routes.types.route_matrix_trailer_options.deserialize_json(
                data["Trailer"]
            )
        )
    if "TruckType" in data:
        ...
        out["truck_type"] = (
            aws_sdk_geo_routes.types.route_matrix_truck_type.deserialize_json(
                data["TruckType"]
            )
        )
