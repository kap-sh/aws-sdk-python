...
class RouteTransitPlace(TypedDict):
    ...
    type: NotRequired[
        "aws_sdk_geo_routes.types.route_transit_place_type.RouteTransitPlaceType"
    ]
...
def serialize_json(value: RouteTransitPlace) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = aws_sdk_geo_routes.types.route_transit_place_type.serialize_json(
            value["type"]
        )
...
def deserialize_json(data: dict) -> RouteTransitPlace:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_geo_routes.types.route_transit_place_type.deserialize_json(
                data["Type"]
            )
        )
