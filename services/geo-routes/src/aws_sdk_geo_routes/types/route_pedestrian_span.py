...
if TYPE_CHECKING:
    ...
    import aws_sdk_geo_routes.types.route_span_pedestrian_access_attribute_list
...
class RoutePedestrianSpan(TypedDict):
    ...
    pedestrian_access: NotRequired[
        "aws_sdk_geo_routes.types.route_span_pedestrian_access_attribute_list.RouteSpanPedestrianAccessAttributeList"
    ]
...
def serialize_json(value: RoutePedestrianSpan) -> dict:
    ...
    if "pedestrian_access" in value:
        ...
        out["PedestrianAccess"] = (
            aws_sdk_geo_routes.types.route_span_pedestrian_access_attribute_list.serialize_json(
...
def deserialize_json(data: dict) -> RoutePedestrianSpan:
    ...
    if "PedestrianAccess" in data:
        ...
        out["pedestrian_access"] = (
            aws_sdk_geo_routes.types.route_span_pedestrian_access_attribute_list.deserialize_json(
