...
# --- restJson1 ser/de ---
def serialize_json(value: RouteMatrixOriginOptions) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> RouteMatrixOriginOptions:
    out: RouteMatrixOriginOptions = {}  # type: ignore[typeddict-item]
