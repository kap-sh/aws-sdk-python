...
if TYPE_CHECKING:
    ...
    import aws_sdk_geo_routes.types.route_rental_place_type
...
class RouteRentalPlace(TypedDict):
    ...
    type: NotRequired[
        "aws_sdk_geo_routes.types.route_rental_place_type.RouteRentalPlaceType"
    ]
...
def serialize_json(value: RouteRentalPlace) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = aws_sdk_geo_routes.types.route_rental_place_type.serialize_json(
            value["type"]
        )
...
def deserialize_json(data: dict) -> RouteRentalPlace:
    ...
    if "Type" in data:
        ...
        out["type"] = aws_sdk_geo_routes.types.route_rental_place_type.deserialize_json(
            data["Type"]
        )
