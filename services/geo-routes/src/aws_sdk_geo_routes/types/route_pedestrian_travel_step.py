...
if TYPE_CHECKING:
    ...
    import aws_sdk_geo_routes.types.route_pedestrian_travel_step_type
...
class RoutePedestrianTravelStep(TypedDict, closed=True):
    ...
    type: "aws_sdk_geo_routes.types.route_pedestrian_travel_step_type.RoutePedestrianTravelStepType"
...
def serialize_json(value: RoutePedestrianTravelStep) -> dict:
    ...
    out["Type"] = (
        aws_sdk_geo_routes.types.route_pedestrian_travel_step_type.serialize_json(
            value["type"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> RoutePedestrianTravelStep:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_geo_routes.types.route_pedestrian_travel_step_type.deserialize_json(
                data["Type"]
            )
        )
    else:
