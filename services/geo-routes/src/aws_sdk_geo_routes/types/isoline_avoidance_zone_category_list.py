...
if TYPE_CHECKING:
    import aws_sdk_geo_routes.types.isoline_avoidance_zone_category

IsolineAvoidanceZoneCategoryList: TypeAlias = list[
    "aws_sdk_geo_routes.types.isoline_avoidance_zone_category.IsolineAvoidanceZoneCategory"
]
...
def serialize_json(value: IsolineAvoidanceZoneCategoryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_geo_routes.types.isoline_avoidance_zone_category.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> IsolineAvoidanceZoneCategoryList:
    ...
    for item in data:
        out.append(
            aws_sdk_geo_routes.types.isoline_avoidance_zone_category.deserialize_json(
                item
            )
        )
    return out
