...
if TYPE_CHECKING:
    import aws_sdk_geo_routes.types.isoline_avoidance_area_list
    import aws_sdk_geo_routes.types.isoline_avoidance_zone_category_list
    import aws_sdk_geo_routes.types.sensitive_boolean
    import aws_sdk_geo_routes.types.truck_road_type_list


class IsolineAvoidanceOptions(TypedDict):
    areas: NotRequired[
        "aws_sdk_geo_routes.types.isoline_avoidance_area_list.IsolineAvoidanceAreaList"
    ]
    ...
    zone_categories: NotRequired[
        "aws_sdk_geo_routes.types.isoline_avoidance_zone_category_list.IsolineAvoidanceZoneCategoryList"
    ]
...
def serialize_json(value: IsolineAvoidanceOptions) -> dict:
    ...
    if "areas" in value:
        ...
        out["Areas"] = (
            aws_sdk_geo_routes.types.isoline_avoidance_area_list.serialize_json(
                value["areas"]
            )
        )
    ...
    if "zone_categories" in value:
        ...
        out["ZoneCategories"] = (
            aws_sdk_geo_routes.types.isoline_avoidance_zone_category_list.serialize_json(
...
def deserialize_json(data: dict) -> IsolineAvoidanceOptions:
    ...
    if "Areas" in data:
        ...
        out["areas"] = (
            aws_sdk_geo_routes.types.isoline_avoidance_area_list.deserialize_json(
                data["Areas"]
            )
        )
    ...
    if "ZoneCategories" in data:
        ...
        out["zone_categories"] = (
            aws_sdk_geo_routes.types.isoline_avoidance_zone_category_list.deserialize_json(
                data["ZoneCategories"]
            )
        )
    return out
