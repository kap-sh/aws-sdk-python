...
if TYPE_CHECKING:
    ...
    import aws_sdk_geo_routes.types.route_ferry_leg_details
    import aws_sdk_geo_routes.types.route_leg_geometry
    import aws_sdk_geo_routes.types.route_leg_travel_mode
    import aws_sdk_geo_routes.types.route_leg_type
    import aws_sdk_geo_routes.types.route_pedestrian_leg_details
    import aws_sdk_geo_routes.types.route_rental_leg_details
    import aws_sdk_geo_routes.types.route_taxi_leg_details
    import aws_sdk_geo_routes.types.route_transit_leg_details
    import aws_sdk_geo_routes.types.route_vehicle_leg_details
...
class RouteLeg(TypedDict):
    ...
    travel_mode: "aws_sdk_geo_routes.types.route_leg_travel_mode.RouteLegTravelMode"
    ...
    type: "aws_sdk_geo_routes.types.route_leg_type.RouteLegType"
    """<p>Type of the leg.</p>"""
    vehicle_leg_details: NotRequired[
        "aws_sdk_geo_routes.types.route_vehicle_leg_details.RouteVehicleLegDetails"
    ]
...
def serialize_json(value: RouteLeg) -> dict:
    ...
    if "ferry_leg_details" in value:
        ...
        out["FerryLegDetails"] = (
            aws_sdk_geo_routes.types.route_ferry_leg_details.serialize_json(
                value["ferry_leg_details"]
            )
        )
    import aws_sdk_geo_routes.types.route_leg_geometry

    out["Geometry"] = aws_sdk_geo_routes.types.route_leg_geometry.serialize_json(
        value["geometry"]
    )
    ...
    if "pedestrian_leg_details" in value:
        ...
        out["PedestrianLegDetails"] = (
            aws_sdk_geo_routes.types.route_pedestrian_leg_details.serialize_json(
                value["pedestrian_leg_details"]
            )
        )
    import aws_sdk_geo_routes.types.route_leg_travel_mode

    out["TravelMode"] = aws_sdk_geo_routes.types.route_leg_travel_mode.serialize_json(
        value["travel_mode"]
    )
    import aws_sdk_geo_routes.types.route_leg_type

    out["Type"] = aws_sdk_geo_routes.types.route_leg_type.serialize_json(value["type"])
    if "vehicle_leg_details" in value:
        import aws_sdk_geo_routes.types.route_vehicle_leg_details

        out["VehicleLegDetails"] = (
            aws_sdk_geo_routes.types.route_vehicle_leg_details.serialize_json(
    ...
    if "rental_leg_details" in value:
        ...
        out["RentalLegDetails"] = (
            aws_sdk_geo_routes.types.route_rental_leg_details.serialize_json(
    ...
    if "taxi_leg_details" in value:
        ...
        out["TaxiLegDetails"] = (
            aws_sdk_geo_routes.types.route_taxi_leg_details.serialize_json(
    ...
    if "transit_leg_details" in value:
        ...
        out["TransitLegDetails"] = (
            aws_sdk_geo_routes.types.route_transit_leg_details.serialize_json(
...
def deserialize_json(data: dict) -> RouteLeg:
    ...
    if "FerryLegDetails" in data:
        ...
        out["ferry_leg_details"] = (
            aws_sdk_geo_routes.types.route_ferry_leg_details.deserialize_json(
    ...
    if "Geometry" in data:
        ...
        out["geometry"] = aws_sdk_geo_routes.types.route_leg_geometry.deserialize_json(
            data["Geometry"]
        )
    else:
    ...
    if "PedestrianLegDetails" in data:
        ...
        out["pedestrian_leg_details"] = (
            aws_sdk_geo_routes.types.route_pedestrian_leg_details.deserialize_json(
    ...
    if "TravelMode" in data:
        ...
        out["travel_mode"] = (
            aws_sdk_geo_routes.types.route_leg_travel_mode.deserialize_json(
                data["TravelMode"]
            )
        )
    else:
    ...
    if "Type" in data:
        ...
        out["type"] = aws_sdk_geo_routes.types.route_leg_type.deserialize_json(
            data["Type"]
        )
    else:
    ...
    if "VehicleLegDetails" in data:
        ...
        out["vehicle_leg_details"] = (
            aws_sdk_geo_routes.types.route_vehicle_leg_details.deserialize_json(
    ...
    if "RentalLegDetails" in data:
        ...
        out["rental_leg_details"] = (
            aws_sdk_geo_routes.types.route_rental_leg_details.deserialize_json(
    ...
    if "TaxiLegDetails" in data:
        ...
        out["taxi_leg_details"] = (
            aws_sdk_geo_routes.types.route_taxi_leg_details.deserialize_json(
                data["TaxiLegDetails"]
            )
        )
    if "TransitLegDetails" in data:
        ...
        out["transit_leg_details"] = (
            aws_sdk_geo_routes.types.route_transit_leg_details.deserialize_json(
