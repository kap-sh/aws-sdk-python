"""Generated from Smithy shape ``com.amazonaws.georoutes#RouteKeepStepDetails``."""
...
class RouteKeepStepDetails(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: RouteKeepStepDetails) -> dict:
    out: dict = {}
    import aws_sdk_geo_routes.types.localized_string_list
