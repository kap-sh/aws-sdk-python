...
if TYPE_CHECKING:
    ...
    import aws_sdk_geo_routes.types.route_rental_mode_list


class RouteIntermodalRentalOptions(TypedDict):
    allowed_modes: NotRequired[
        "aws_sdk_geo_routes.types.route_rental_mode_list.RouteRentalModeList"
    ]
...
def serialize_json(value: RouteIntermodalRentalOptions) -> dict:
    ...
    if "allowed_modes" in value:
        ...
        out["AllowedModes"] = (
            aws_sdk_geo_routes.types.route_rental_mode_list.serialize_json(
                value["allowed_modes"]
            )
        )
...
def deserialize_json(data: dict) -> RouteIntermodalRentalOptions:
    ...
    if "AllowedModes" in data:
        ...
        out["allowed_modes"] = (
            aws_sdk_geo_routes.types.route_rental_mode_list.deserialize_json(
                data["AllowedModes"]
            )
        )
