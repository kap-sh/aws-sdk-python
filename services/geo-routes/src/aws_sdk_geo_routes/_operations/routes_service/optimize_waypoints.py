...
def build_request(
    ...
    input: aws_sdk_geo_routes.types.optimize_waypoints_request.OptimizeWaypointsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_geo_routes.types.optimize_waypoints_request.serialize_json(input)
    ).encode()
