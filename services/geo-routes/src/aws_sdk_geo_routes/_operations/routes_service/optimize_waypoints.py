...
def handle_response(
    ...
    out: aws_sdk_geo_routes.types.optimize_waypoints_response.OptimizeWaypointsResponse = aws_sdk_geo_routes.types.optimize_waypoints_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_geo_routes.types.optimize_waypoints_request.OptimizeWaypointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_geo_routes.types.optimize_waypoints_request.serialize_json(input_)
    ).encode()
