...
def handle_response(
    ...
    out: aws_sdk_geo_routes.types.calculate_isolines_response.CalculateIsolinesResponse = aws_sdk_geo_routes.types.calculate_isolines_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_geo_routes.types.calculate_isolines_request.CalculateIsolinesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_geo_routes.types.calculate_isolines_request.serialize_json(input_)
    ).encode()
