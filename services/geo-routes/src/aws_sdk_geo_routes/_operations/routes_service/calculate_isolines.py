...
def build_request(
    ...
    input: aws_sdk_geo_routes.types.calculate_isolines_request.CalculateIsolinesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_geo_routes.types.calculate_isolines_request.serialize_json(input)
    ).encode()
