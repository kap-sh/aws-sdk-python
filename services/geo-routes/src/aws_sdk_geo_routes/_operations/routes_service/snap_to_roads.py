...
def handle_response(
    ...
    out: aws_sdk_geo_routes.types.snap_to_roads_response.SnapToRoadsResponse = (
        aws_sdk_geo_routes.types.snap_to_roads_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_geo_routes.types.snap_to_roads_request.SnapToRoadsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_geo_routes.types.snap_to_roads_request.serialize_json(input_)
    ).encode()
...
def snap_to_roads(
    ...
    aws_sdk_geo_routes.types.snap_to_roads_response.SnapToRoadsResponse, zapros.Response
]:
