...
def build_request(
    ...
    input: aws_sdk_geo_routes.types.calculate_route_matrix_request.CalculateRouteMatrixRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_geo_routes.types.calculate_route_matrix_request.serialize_json(input)
    ).encode()
