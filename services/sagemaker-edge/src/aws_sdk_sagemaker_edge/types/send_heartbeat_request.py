...
class SendHeartbeatRequest(TypedDict, closed=True):
    ...
    agent_version: NotRequired["aws_sdk_sagemaker_edge.types.version.Version"]
...
def serialize_json(value: SendHeartbeatRequest) -> dict:
    ...
    if "agent_metrics" in value:
        ...
        out["AgentMetrics"] = aws_sdk_sagemaker_edge.types.edge_metrics.serialize_json(
            value["agent_metrics"]
        )
    if "models" in value:
        import aws_sdk_sagemaker_edge.types.models

        out["Models"] = aws_sdk_sagemaker_edge.types.models.serialize_json(
            value["models"]
        )
    ...
    if "deployment_result" in value:
        ...
        out["DeploymentResult"] = (
            aws_sdk_sagemaker_edge.types.deployment_result.serialize_json(
...
def deserialize_json(data: dict) -> SendHeartbeatRequest:
    ...
    if "Models" in data:
        ...
        out["models"] = aws_sdk_sagemaker_edge.types.models.deserialize_json(
            data["Models"]
        )
    ...
    if "DeploymentResult" in data:
        ...
        out["deployment_result"] = (
            aws_sdk_sagemaker_edge.types.deployment_result.deserialize_json(
