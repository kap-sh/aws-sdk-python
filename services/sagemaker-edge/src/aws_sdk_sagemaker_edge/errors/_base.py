...
class SagemakerEdgeError(Exception):
    """Base class for all SagemakerEdge service errors."""


class ServiceError(SagemakerEdgeError):
...
class SerializationError(SagemakerEdgeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SagemakerEdgeError):
...
class WaiterFailedError(SagemakerEdgeError):
...
class WaiterTimeoutError(SagemakerEdgeError):
