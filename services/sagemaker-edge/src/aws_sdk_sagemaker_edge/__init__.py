...
from ._services.async_sagemaker_edge import (
    AsyncSagemakerEdgeClient as AsyncSagemakerEdgeClient,
)
from ._services.sagemaker_edge import SagemakerEdgeClient as SagemakerEdgeClient
