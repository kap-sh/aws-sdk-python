...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.change_set_hook_target_details
    import aws_sdk_cloudformation.types.hook_failure_mode
    import aws_sdk_cloudformation.types.hook_invocation_point
    import aws_sdk_cloudformation.types.hook_type_configuration_version_id
    import aws_sdk_cloudformation.types.hook_type_name
    import aws_sdk_cloudformation.types.hook_type_version_id


class ChangeSetHook(TypedDict):
    ...
    type_name: NotRequired["aws_sdk_cloudformation.types.hook_type_name.HookTypeName"]
    ...
    type_version_id: NotRequired[
        "aws_sdk_cloudformation.types.hook_type_version_id.HookTypeVersionId"
    ]
    """<p>The version ID of the type specified.</p>"""
    type_configuration_version_id: NotRequired[
        "aws_sdk_cloudformation.types.hook_type_configuration_version_id.HookTypeConfigurationVersionId"
    ]
    """<p>The version ID of the type configuration.</p>"""
    target_details: NotRequired[
        "aws_sdk_cloudformation.types.change_set_hook_target_details.ChangeSetHookTargetDetails"
    ]
...
def serialize_query(
    ...
    if "target_details" in value:
        ...
        aws_sdk_cloudformation.types.change_set_hook_target_details.serialize_query(
...
def deserialize_query(el: Element) -> ChangeSetHook:
    ...
    if child_target_details is not None:
        ...
        out["target_details"] = (
            aws_sdk_cloudformation.types.change_set_hook_target_details.deserialize_query(
