...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudformation.types.metadata
    ...
    import aws_sdk_cloudformation.types.version
    import aws_sdk_cloudformation.types.warnings


class GetTemplateSummaryOutput(TypedDict):
    parameters: NotRequired[
        "aws_sdk_cloudformation.types.parameter_declarations.ParameterDeclarations"
    ]
    ...
    version: NotRequired["aws_sdk_cloudformation.types.version.Version"]
    """<p>The Amazon Web Services template format version, which identifies the capabilities of the template.</p>"""
    metadata: NotRequired["aws_sdk_cloudformation.types.metadata.Metadata"]
    ...
    resource_identifier_summaries: NotRequired[
        "aws_sdk_cloudformation.types.resource_identifier_summaries.ResourceIdentifierSummaries"
    ]
    ...
    warnings: NotRequired["aws_sdk_cloudformation.types.warnings.Warnings"]
...
def serialize_query(
    ...
    if "parameters" in value:
        ...
        aws_sdk_cloudformation.types.parameter_declarations.serialize_query(
    ...
    if "resource_identifier_summaries" in value:
        ...
        aws_sdk_cloudformation.types.resource_identifier_summaries.serialize_query(
    ...
    if "warnings" in value:
        ...
        aws_sdk_cloudformation.types.warnings.serialize_query(
...
def deserialize_query(el: Element) -> GetTemplateSummaryOutput:
    ...
    if child_parameters is not None:
        ...
        out["parameters"] = (
            aws_sdk_cloudformation.types.parameter_declarations.deserialize_query(
                child_parameters
            )
        )
    ...
    if child_resource_identifier_summaries is not None:
        ...
        out["resource_identifier_summaries"] = (
            aws_sdk_cloudformation.types.resource_identifier_summaries.deserialize_query(
    ...
    if child_warnings is not None:
        ...
        out["warnings"] = aws_sdk_cloudformation.types.warnings.deserialize_query(
            child_warnings
        )
    return out
