...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.stack_instance_detailed_status


class StackInstanceComprehensiveStatus(TypedDict):
    detailed_status: NotRequired[
        "aws_sdk_cloudformation.types.stack_instance_detailed_status.StackInstanceDetailedStatus"
    ]
...
def serialize_query(
    ...
    if "detailed_status" in value:
        ...
        aws_sdk_cloudformation.types.stack_instance_detailed_status.serialize_query(
...
def deserialize_query(el: Element) -> StackInstanceComprehensiveStatus:
    ...
    if child_detailed_status is not None:
        ...
        out["detailed_status"] = (
            aws_sdk_cloudformation.types.stack_instance_detailed_status.deserialize_query(
