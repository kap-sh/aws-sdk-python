...
class ActivateTypeInput(TypedDict):
    ...
    version_bump: NotRequired["aws_sdk_cloudformation.types.version_bump.VersionBump"]
...
def serialize_query(
    ...
    if "version_bump" in value:
        ...
        aws_sdk_cloudformation.types.version_bump.serialize_query(
...
def deserialize_query(el: Element) -> ActivateTypeInput:
    ...
    if child_version_bump is not None:
        ...
        out["version_bump"] = (
            aws_sdk_cloudformation.types.version_bump.deserialize_query(
                child_version_bump
            )
        )
