...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.drifted_stack_instances_count
    import aws_sdk_cloudformation.types.failed_stack_instances_count
    import aws_sdk_cloudformation.types.in_progress_stack_instances_count
    import aws_sdk_cloudformation.types.in_sync_stack_instances_count
    import aws_sdk_cloudformation.types.stack_set_drift_detection_status
    import aws_sdk_cloudformation.types.stack_set_drift_status
    import aws_sdk_cloudformation.types.timestamp
    import aws_sdk_cloudformation.types.total_stack_instances_count


class StackSetDriftDetectionDetails(TypedDict):
    drift_status: NotRequired[
        "aws_sdk_cloudformation.types.stack_set_drift_status.StackSetDriftStatus"
    ]
    ...
    drift_detection_status: NotRequired[
        "aws_sdk_cloudformation.types.stack_set_drift_detection_status.StackSetDriftDetectionStatus"
    ]
    ...
    total_stack_instances_count: NotRequired[
        "aws_sdk_cloudformation.types.total_stack_instances_count.TotalStackInstancesCount"
    ]
    ...
    drifted_stack_instances_count: NotRequired[
        "aws_sdk_cloudformation.types.drifted_stack_instances_count.DriftedStackInstancesCount"
    ]
    ...
    in_sync_stack_instances_count: NotRequired[
        "aws_sdk_cloudformation.types.in_sync_stack_instances_count.InSyncStackInstancesCount"
    ]
    ...
    in_progress_stack_instances_count: NotRequired[
        "aws_sdk_cloudformation.types.in_progress_stack_instances_count.InProgressStackInstancesCount"
    ]
...
def serialize_query(
    ...
    if "drift_status" in value:
        ...
        aws_sdk_cloudformation.types.stack_set_drift_status.serialize_query(
            value["drift_status"], pairs, f"{prefix}.DriftStatus"
        )
    if "drift_detection_status" in value:
        import aws_sdk_cloudformation.types.stack_set_drift_detection_status

        aws_sdk_cloudformation.types.stack_set_drift_detection_status.serialize_query(
...
def deserialize_query(el: Element) -> StackSetDriftDetectionDetails:
    ...
    if child_drift_status is not None:
        ...
        out["drift_status"] = (
            aws_sdk_cloudformation.types.stack_set_drift_status.deserialize_query(
                child_drift_status
            )
        )
    ...
    if child_drift_detection_status is not None:
        ...
        out["drift_detection_status"] = (
            aws_sdk_cloudformation.types.stack_set_drift_detection_status.deserialize_query(
