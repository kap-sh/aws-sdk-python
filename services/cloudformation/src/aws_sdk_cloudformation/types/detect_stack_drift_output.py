"""Generated from Smithy shape ``com.amazonaws.cloudformation#DetectStackDriftOutput``."""
...
class DetectStackDriftOutput(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> DetectStackDriftOutput:
    out: DetectStackDriftOutput = {}  # type: ignore[typeddict-item]
