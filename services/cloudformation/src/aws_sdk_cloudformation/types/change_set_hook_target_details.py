...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.change_set_hook_resource_target_details
    import aws_sdk_cloudformation.types.hook_target_type


class ChangeSetHookTargetDetails(TypedDict):
    target_type: NotRequired[
        "aws_sdk_cloudformation.types.hook_target_type.HookTargetType"
    ]
    """<p>The Hook target type.</p>"""
    resource_target_details: NotRequired[
        "aws_sdk_cloudformation.types.change_set_hook_resource_target_details.ChangeSetHookResourceTargetDetails"
    ]
...
def serialize_query(
    ...
    if "target_type" in value:
        ...
        aws_sdk_cloudformation.types.hook_target_type.serialize_query(
            value["target_type"], pairs, f"{prefix}.TargetType"
        )
    if "resource_target_details" in value:
        import aws_sdk_cloudformation.types.change_set_hook_resource_target_details

        aws_sdk_cloudformation.types.change_set_hook_resource_target_details.serialize_query(
...
def deserialize_query(el: Element) -> ChangeSetHookTargetDetails:
    ...
    if child_target_type is not None:
        ...
        out["target_type"] = (
            aws_sdk_cloudformation.types.hook_target_type.deserialize_query(
                child_target_type
            )
        )
    ...
    if child_resource_target_details is not None:
        ...
        out["resource_target_details"] = (
            aws_sdk_cloudformation.types.change_set_hook_resource_target_details.deserialize_query(
