...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudformation.types.stack_instance_summaries


class ListStackInstancesOutput(TypedDict):
    summaries: NotRequired[
        "aws_sdk_cloudformation.types.stack_instance_summaries.StackInstanceSummaries"
    ]
...
def serialize_query(
    ...
    if "summaries" in value:
        ...
        aws_sdk_cloudformation.types.stack_instance_summaries.serialize_query(
...
def deserialize_query(el: Element) -> ListStackInstancesOutput:
    ...
    if child_summaries is not None:
        ...
        out["summaries"] = (
            aws_sdk_cloudformation.types.stack_instance_summaries.deserialize_query(
                child_summaries
            )
        )
