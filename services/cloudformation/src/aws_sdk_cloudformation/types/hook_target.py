...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.hook_target_action
    import aws_sdk_cloudformation.types.hook_target_id
    import aws_sdk_cloudformation.types.hook_target_type
    import aws_sdk_cloudformation.types.hook_target_type_name


class HookTarget(TypedDict):
    ...
    target_id: NotRequired["aws_sdk_cloudformation.types.hook_target_id.HookTargetId"]
    """<p>The unique identifier of the Hook invocation target.</p>"""
    action: NotRequired[
        "aws_sdk_cloudformation.types.hook_target_action.HookTargetAction"
    ]
...
def serialize_query(
    ...
    if "action" in value:
        ...
        aws_sdk_cloudformation.types.hook_target_action.serialize_query(
...
def deserialize_query(el: Element) -> HookTarget:
    ...
    if child_action is not None:
        ...
        out["action"] = (
            aws_sdk_cloudformation.types.hook_target_action.deserialize_query(
                child_action
            )
        )
    return out
