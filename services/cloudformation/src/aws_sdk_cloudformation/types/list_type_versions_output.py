...
class ListTypeVersionsOutput(TypedDict):
    type_version_summaries: NotRequired[
        "aws_sdk_cloudformation.types.type_version_summaries.TypeVersionSummaries"
    ]
...
def serialize_query(
    ...
    if "type_version_summaries" in value:
        ...
        aws_sdk_cloudformation.types.type_version_summaries.serialize_query(
...
def deserialize_query(el: Element) -> ListTypeVersionsOutput:
    ...
    if child_type_version_summaries is not None:
        ...
        out["type_version_summaries"] = (
            aws_sdk_cloudformation.types.type_version_summaries.deserialize_query(
