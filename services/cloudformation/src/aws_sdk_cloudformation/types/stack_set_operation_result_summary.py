...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudformation.types.account_gate_result
...
class StackSetOperationResultSummary(TypedDict):
    ...
    status: NotRequired[
        "aws_sdk_cloudformation.types.stack_set_operation_result_status.StackSetOperationResultStatus"
    ]
    ...
    account_gate_result: NotRequired[
        "aws_sdk_cloudformation.types.account_gate_result.AccountGateResult"
    ]
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_cloudformation.types.stack_set_operation_result_status.serialize_query(
    ...
    if "account_gate_result" in value:
        ...
        aws_sdk_cloudformation.types.account_gate_result.serialize_query(
...
def deserialize_query(el: Element) -> StackSetOperationResultSummary:
    ...
    if child_status is not None:
        ...
        out["status"] = (
            aws_sdk_cloudformation.types.stack_set_operation_result_status.deserialize_query(
                child_status
            )
        )
    ...
    if child_account_gate_result is not None:
        ...
        out["account_gate_result"] = (
            aws_sdk_cloudformation.types.account_gate_result.deserialize_query(
