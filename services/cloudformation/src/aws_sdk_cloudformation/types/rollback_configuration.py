...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.monitoring_time_in_minutes
    import aws_sdk_cloudformation.types.rollback_triggers


class RollbackConfiguration(TypedDict, closed=True):
    rollback_triggers: NotRequired[
        "aws_sdk_cloudformation.types.rollback_triggers.RollbackTriggers"
    ]
    ...
    monitoring_time_in_minutes: NotRequired[
        "aws_sdk_cloudformation.types.monitoring_time_in_minutes.MonitoringTimeInMinutes"
    ]
...
def serialize_query(
    ...
    if "rollback_triggers" in value:
        ...
        aws_sdk_cloudformation.types.rollback_triggers.serialize_query(
...
def deserialize_query(el: Element) -> RollbackConfiguration:
    ...
    if child_rollback_triggers is not None:
        ...
        out["rollback_triggers"] = (
            aws_sdk_cloudformation.types.rollback_triggers.deserialize_query(
