"""Generated from Smithy shape ``com.amazonaws.cloudformation#DescribeStackSetOperationInput``."""
...
class DescribeStackSetOperationInput(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeStackSetOperationInput, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DescribeStackSetOperationInput:
    out: DescribeStackSetOperationInput = {}  # type: ignore[typeddict-item]
