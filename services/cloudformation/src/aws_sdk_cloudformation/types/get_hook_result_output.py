...
class GetHookResultOutput(TypedDict):
    ...
    original_type_name: NotRequired[
        "aws_sdk_cloudformation.types.hook_type_name.HookTypeName"
    ]
    ...
    invoked_at: NotRequired["aws_sdk_cloudformation.types.timestamp.Timestamp"]
    """<p>The timestamp when the Hook was invoked.</p>"""
    target: NotRequired["aws_sdk_cloudformation.types.hook_target.HookTarget"]
    """<p>Information about the target of the Hook invocation.</p>"""
    annotations: NotRequired[
        "aws_sdk_cloudformation.types.annotation_list.AnnotationList"
    ]
...
def serialize_query(
    ...
    if "target" in value:
        ...
        aws_sdk_cloudformation.types.hook_target.serialize_query(
            value["target"], pairs, f"{prefix}.Target"
        )
    if "annotations" in value:
        import aws_sdk_cloudformation.types.annotation_list

        aws_sdk_cloudformation.types.annotation_list.serialize_query(
...
def deserialize_query(el: Element) -> GetHookResultOutput:
    ...
    if child_invoked_at is not None:
        ...
        out["invoked_at"] = aws_sdk_cloudformation.types.timestamp.deserialize_query(
            child_invoked_at
        )
    ...
    if child_target is not None:
        ...
        out["target"] = aws_sdk_cloudformation.types.hook_target.deserialize_query(
            child_target
        )
    ...
    if child_annotations is not None:
        ...
        out["annotations"] = (
            aws_sdk_cloudformation.types.annotation_list.deserialize_query(
                child_annotations
            )
        )
    return out
