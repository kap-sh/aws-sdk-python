...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.account_gate_status
    import aws_sdk_cloudformation.types.account_gate_status_reason


class AccountGateResult(TypedDict):
    status: NotRequired[
        "aws_sdk_cloudformation.types.account_gate_status.AccountGateStatus"
    ]
    ...
    status_reason: NotRequired[
        "aws_sdk_cloudformation.types.account_gate_status_reason.AccountGateStatusReason"
    ]
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_cloudformation.types.account_gate_status.serialize_query(
...
def deserialize_query(el: Element) -> AccountGateResult:
    ...
    if child_status is not None:
        ...
        out["status"] = (
            aws_sdk_cloudformation.types.account_gate_status.deserialize_query(
                child_status
            )
        )
