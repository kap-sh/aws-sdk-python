...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.batch_describe_type_configurations_errors
    import aws_sdk_cloudformation.types.type_configuration_details_list
...
class BatchDescribeTypeConfigurationsOutput(TypedDict, closed=True):
    ...
    unprocessed_type_configurations: NotRequired[
        "aws_sdk_cloudformation.types.unprocessed_type_configurations.UnprocessedTypeConfigurations"
    ]
    ...
    type_configurations: NotRequired[
        "aws_sdk_cloudformation.types.type_configuration_details_list.TypeConfigurationDetailsList"
    ]
...
def serialize_query(
    ...
    if "errors" in value:
        ...
        aws_sdk_cloudformation.types.batch_describe_type_configurations_errors.serialize_query(
            value["errors"], pairs, f"{prefix}.Errors"
        )
    if "unprocessed_type_configurations" in value:
        import aws_sdk_cloudformation.types.unprocessed_type_configurations

        aws_sdk_cloudformation.types.unprocessed_type_configurations.serialize_query(
    ...
    if "type_configurations" in value:
        ...
        aws_sdk_cloudformation.types.type_configuration_details_list.serialize_query(
...
def deserialize_query(el: Element) -> BatchDescribeTypeConfigurationsOutput:
    ...
    if child_errors is not None:
        ...
        out["errors"] = (
            aws_sdk_cloudformation.types.batch_describe_type_configurations_errors.deserialize_query(
                child_errors
            )
        )
    ...
    if child_unprocessed_type_configurations is not None:
        ...
        out["unprocessed_type_configurations"] = (
            aws_sdk_cloudformation.types.unprocessed_type_configurations.deserialize_query(
    ...
    if child_type_configurations is not None:
        ...
        out["type_configurations"] = (
            aws_sdk_cloudformation.types.type_configuration_details_list.deserialize_query(
