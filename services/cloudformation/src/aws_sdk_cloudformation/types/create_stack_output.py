"""Generated from Smithy shape ``com.amazonaws.cloudformation#CreateStackOutput``."""
...
class CreateStackOutput(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: CreateStackOutput, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> CreateStackOutput:
    out: CreateStackOutput = {}  # type: ignore[typeddict-item]
