...
class ListHookResultsOutput(TypedDict):
    ...
    hook_results: NotRequired[
        "aws_sdk_cloudformation.types.hook_result_summaries.HookResultSummaries"
    ]
...
def serialize_query(
    ...
    if "hook_results" in value:
        ...
        aws_sdk_cloudformation.types.hook_result_summaries.serialize_query(
...
def deserialize_query(el: Element) -> ListHookResultsOutput:
    ...
    if child_hook_results is not None:
        ...
        out["hook_results"] = (
            aws_sdk_cloudformation.types.hook_result_summaries.deserialize_query(
                child_hook_results
            )
        )
