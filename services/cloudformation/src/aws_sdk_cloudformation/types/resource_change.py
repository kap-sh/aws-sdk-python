...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.after_context
    import aws_sdk_cloudformation.types.before_context
    ...
    import aws_sdk_cloudformation.types.policy_action
    import aws_sdk_cloudformation.types.previous_deployment_context
    import aws_sdk_cloudformation.types.replacement
    import aws_sdk_cloudformation.types.resource_change_details
    import aws_sdk_cloudformation.types.resource_drift_ignored_attributes
    import aws_sdk_cloudformation.types.resource_type
    import aws_sdk_cloudformation.types.scope
    import aws_sdk_cloudformation.types.stack_resource_drift_status


class ResourceChange(TypedDict, closed=True):
    policy_action: NotRequired[
        "aws_sdk_cloudformation.types.policy_action.PolicyAction"
    ]
    ...
    action: NotRequired["aws_sdk_cloudformation.types.change_action.ChangeAction"]
    ...
    replacement: NotRequired["aws_sdk_cloudformation.types.replacement.Replacement"]
    ...
    scope: NotRequired["aws_sdk_cloudformation.types.scope.Scope"]
    ...
    resource_drift_ignored_attributes: NotRequired[
        "aws_sdk_cloudformation.types.resource_drift_ignored_attributes.ResourceDriftIgnoredAttributes"
    ]
    """<p>List of resource attributes for which drift was ignored.</p>"""
    details: NotRequired[
        "aws_sdk_cloudformation.types.resource_change_details.ResourceChangeDetails"
    ]
    ...
    before_context: NotRequired[
        "aws_sdk_cloudformation.types.before_context.BeforeContext"
    ]
    """<p>An encoded JSON string that contains the context of the resource before the change is executed.</p>"""
    after_context: NotRequired[
        "aws_sdk_cloudformation.types.after_context.AfterContext"
    ]
    ...
    previous_deployment_context: NotRequired[
        "aws_sdk_cloudformation.types.previous_deployment_context.PreviousDeploymentContext"
    ]
...
def serialize_query(
    ...
    if "policy_action" in value:
        ...
        aws_sdk_cloudformation.types.policy_action.serialize_query(
    ...
    if "replacement" in value:
        ...
        aws_sdk_cloudformation.types.replacement.serialize_query(
            value["replacement"], pairs, f"{prefix}.Replacement"
        )
    if "scope" in value:
        import aws_sdk_cloudformation.types.scope

        aws_sdk_cloudformation.types.scope.serialize_query(
    ...
    if "resource_drift_ignored_attributes" in value:
        ...
        aws_sdk_cloudformation.types.resource_drift_ignored_attributes.serialize_query(
    ...
    if "details" in value:
        ...
        aws_sdk_cloudformation.types.resource_change_details.serialize_query(
...
def deserialize_query(el: Element) -> ResourceChange:
    ...
    if child_policy_action is not None:
        ...
        out["policy_action"] = (
            aws_sdk_cloudformation.types.policy_action.deserialize_query(
                child_policy_action
            )
        )
    ...
    if child_action is not None:
        ...
        out["action"] = aws_sdk_cloudformation.types.change_action.deserialize_query(
            child_action
        )
    ...
    if child_replacement is not None:
        ...
        out["replacement"] = aws_sdk_cloudformation.types.replacement.deserialize_query(
            child_replacement
        )
    ...
    if child_scope is not None:
        ...
        out["scope"] = aws_sdk_cloudformation.types.scope.deserialize_query(child_scope)
    ...
    if child_resource_drift_ignored_attributes is not None:
        ...
        out["resource_drift_ignored_attributes"] = (
            aws_sdk_cloudformation.types.resource_drift_ignored_attributes.deserialize_query(
    ...
    if child_details is not None:
        ...
        out["details"] = (
            aws_sdk_cloudformation.types.resource_change_details.deserialize_query(
                child_details
            )
        )
