...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.failed_stack_instances_count


class StackSetOperationStatusDetails(TypedDict):
    failed_stack_instances_count: NotRequired[
        "aws_sdk_cloudformation.types.failed_stack_instances_count.FailedStackInstancesCount"
    ]
