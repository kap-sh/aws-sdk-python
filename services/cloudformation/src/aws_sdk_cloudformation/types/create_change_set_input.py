...
class CreateChangeSetInput(TypedDict):
    ...
    client_token: NotRequired["aws_sdk_cloudformation.types.client_token.ClientToken"]
...
def serialize_query(
    ...
    if "change_set_type" in value:
        ...
        aws_sdk_cloudformation.types.change_set_type.serialize_query(
            value["change_set_type"], pairs, f"{prefix}.ChangeSetType"
        )
    if "resources_to_import" in value:
        import aws_sdk_cloudformation.types.resources_to_import

        aws_sdk_cloudformation.types.resources_to_import.serialize_query(
...
def deserialize_query(el: Element) -> CreateChangeSetInput:
    ...
    if child_change_set_type is not None:
        ...
        out["change_set_type"] = (
            aws_sdk_cloudformation.types.change_set_type.deserialize_query(
    ...
    if child_resources_to_import is not None:
        ...
        out["resources_to_import"] = (
            aws_sdk_cloudformation.types.resources_to_import.deserialize_query(
