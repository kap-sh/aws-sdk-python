...
Exports: TypeAlias = list["aws_sdk_cloudformation.types.export.Export"]
...
def serialize_query(value: Exports, pairs: list[tuple[str, str]], prefix: str) -> None:
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_cloudformation.types.export.serialize_query(
...
def deserialize_query(el: Element) -> Exports:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_cloudformation.types.export.deserialize_query(child))
    return out
