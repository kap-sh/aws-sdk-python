...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.concurrency_mode
    import aws_sdk_cloudformation.types.failure_tolerance_count
    import aws_sdk_cloudformation.types.failure_tolerance_percentage
    import aws_sdk_cloudformation.types.max_concurrent_count
    import aws_sdk_cloudformation.types.max_concurrent_percentage
    import aws_sdk_cloudformation.types.region_concurrency_type
    import aws_sdk_cloudformation.types.region_list


class StackSetOperationPreferences(TypedDict):
    region_concurrency_type: NotRequired[
        "aws_sdk_cloudformation.types.region_concurrency_type.RegionConcurrencyType"
    ]
    """<p>The concurrency type of deploying StackSets operations in Regions, could be in parallel or one Region at a time.</p>"""
    region_order: NotRequired["aws_sdk_cloudformation.types.region_list.RegionList"]
    """<p>The order of the Regions where you want to perform the stack operation.</p>"""
    failure_tolerance_count: NotRequired[
        "aws_sdk_cloudformation.types.failure_tolerance_count.FailureToleranceCount"
    ]
    ...
    failure_tolerance_percentage: NotRequired[
        "aws_sdk_cloudformation.types.failure_tolerance_percentage.FailureTolerancePercentage"
    ]
    ...
    max_concurrent_count: NotRequired[
        "aws_sdk_cloudformation.types.max_concurrent_count.MaxConcurrentCount"
    ]
    ...
    max_concurrent_percentage: NotRequired[
        "aws_sdk_cloudformation.types.max_concurrent_percentage.MaxConcurrentPercentage"
    ]
    ...
    concurrency_mode: NotRequired[
        "aws_sdk_cloudformation.types.concurrency_mode.ConcurrencyMode"
    ]
...
def serialize_query(
    ...
    if "region_concurrency_type" in value:
        ...
        aws_sdk_cloudformation.types.region_concurrency_type.serialize_query(
    ...
    if "concurrency_mode" in value:
        ...
        aws_sdk_cloudformation.types.concurrency_mode.serialize_query(
...
def deserialize_query(el: Element) -> StackSetOperationPreferences:
    ...
    if child_region_concurrency_type is not None:
        ...
        out["region_concurrency_type"] = (
            aws_sdk_cloudformation.types.region_concurrency_type.deserialize_query(
    ...
    if child_region_order is not None:
        ...
        out["region_order"] = (
            aws_sdk_cloudformation.types.region_list.deserialize_query(
                child_region_order
            )
        )
    ...
    if child_concurrency_mode is not None:
        ...
        out["concurrency_mode"] = (
            aws_sdk_cloudformation.types.concurrency_mode.deserialize_query(
