...
class SignalResourceInput(TypedDict):
    ...
    unique_id: NotRequired[
        "aws_sdk_cloudformation.types.resource_signal_unique_id.ResourceSignalUniqueId"
    ]
    ...
    status: NotRequired[
        "aws_sdk_cloudformation.types.resource_signal_status.ResourceSignalStatus"
    ]
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_cloudformation.types.resource_signal_status.serialize_query(
...
def deserialize_query(el: Element) -> SignalResourceInput:
    ...
    if child_status is not None:
        ...
        out["status"] = (
            aws_sdk_cloudformation.types.resource_signal_status.deserialize_query(
                child_status
            )
        )
    return out
