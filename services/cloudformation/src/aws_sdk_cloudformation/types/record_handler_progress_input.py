...
def serialize_query(
    ...
    if "operation_status" in value:
        ...
        aws_sdk_cloudformation.types.operation_status.serialize_query(
    ...
    if "error_code" in value:
        ...
        aws_sdk_cloudformation.types.handler_error_code.serialize_query(
...
def deserialize_query(el: Element) -> RecordHandlerProgressInput:
    ...
    if child_operation_status is not None:
        ...
        out["operation_status"] = (
            aws_sdk_cloudformation.types.operation_status.deserialize_query(
    ...
    if child_error_code is not None:
        ...
        out["error_code"] = (
            aws_sdk_cloudformation.types.handler_error_code.deserialize_query(
                child_error_code
            )
        )
