...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudformation.types.resources_read
    import aws_sdk_cloudformation.types.resources_scanned
    import aws_sdk_cloudformation.types.scan_filters
    import aws_sdk_cloudformation.types.timestamp


class DescribeResourceScanOutput(TypedDict):
    ...
    resources_scanned: NotRequired[
        "aws_sdk_cloudformation.types.resources_scanned.ResourcesScanned"
    ]
    ...
    resources_read: NotRequired[
        "aws_sdk_cloudformation.types.resources_read.ResourcesRead"
    ]
