...
class ListStackInstancesInput(TypedDict):
...
def serialize_query(
    ...
    if "filters" in value:
        ...
        aws_sdk_cloudformation.types.stack_instance_filters.serialize_query(
...
def deserialize_query(el: Element) -> ListStackInstancesInput:
    ...
    if child_filters is not None:
        ...
        out["filters"] = (
            aws_sdk_cloudformation.types.stack_instance_filters.deserialize_query(
                child_filters
            )
        )
