"""Generated from Smithy shape ``com.amazonaws.cloudformation#ListStackSetOperationResultsInput``."""
...
class ListStackSetOperationResultsInput(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListStackSetOperationResultsInput, pairs: list[tuple[str, str]], prefix: str
) -> None:
    ...
    if "filters" in value:
        ...
        aws_sdk_cloudformation.types.operation_result_filters.serialize_query(
            value["filters"], pairs, f"{prefix}.Filters"
        )


def deserialize_query(el: Element) -> ListStackSetOperationResultsInput:
    out: ListStackSetOperationResultsInput = {}  # type: ignore[typeddict-item]
    ...
    if child_filters is not None:
        ...
        out["filters"] = (
            aws_sdk_cloudformation.types.operation_result_filters.deserialize_query(
                child_filters
            )
        )
    return out
