...
StackSummaries: TypeAlias = list[
    "aws_sdk_cloudformation.types.stack_summary.StackSummary"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_cloudformation.types.stack_summary.serialize_query(
...
def deserialize_query(el: Element) -> StackSummaries:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_cloudformation.types.stack_summary.deserialize_query(child))
    return out
