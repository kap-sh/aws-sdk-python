...
class GetTemplateOutput(TypedDict):
    ...
    stages_available: NotRequired["aws_sdk_cloudformation.types.stage_list.StageList"]
...
def serialize_query(
    ...
    if "stages_available" in value:
        ...
        aws_sdk_cloudformation.types.stage_list.serialize_query(
...
def deserialize_query(el: Element) -> GetTemplateOutput:
    ...
    if child_stages_available is not None:
        ...
        out["stages_available"] = (
            aws_sdk_cloudformation.types.stage_list.deserialize_query(
