...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudformation.types.stack_resource_drift_information
    import aws_sdk_cloudformation.types.timestamp


class StackResourceDetail(TypedDict):
...
def serialize_query(
    ...
    if "drift_information" in value:
        ...
        aws_sdk_cloudformation.types.stack_resource_drift_information.serialize_query(
...
def deserialize_query(el: Element) -> StackResourceDetail:
    ...
    if child_drift_information is not None:
        ...
        out["drift_information"] = (
            aws_sdk_cloudformation.types.stack_resource_drift_information.deserialize_query(
