...
class ListGeneratedTemplatesOutput(TypedDict):
    summaries: NotRequired[
        "aws_sdk_cloudformation.types.template_summaries.TemplateSummaries"
    ]
...
def serialize_query(
    ...
    if "summaries" in value:
        ...
        aws_sdk_cloudformation.types.template_summaries.serialize_query(
...
def deserialize_query(el: Element) -> ListGeneratedTemplatesOutput:
    ...
    if child_summaries is not None:
        ...
        out["summaries"] = (
            aws_sdk_cloudformation.types.template_summaries.deserialize_query(
                child_summaries
            )
        )
