...
class ListStackRefactorActionsOutput(TypedDict):
    stack_refactor_actions: NotRequired[
        "aws_sdk_cloudformation.types.stack_refactor_actions.StackRefactorActions"
    ]
...
def serialize_query(
    ...
    if "stack_refactor_actions" in value:
        ...
        aws_sdk_cloudformation.types.stack_refactor_actions.serialize_query(
...
def deserialize_query(el: Element) -> ListStackRefactorActionsOutput:
    ...
    if child_stack_refactor_actions is not None:
        ...
        out["stack_refactor_actions"] = (
            aws_sdk_cloudformation.types.stack_refactor_actions.deserialize_query(
