...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.resource_identifier_property_key

ResourceIdentifiers: TypeAlias = list[
    "aws_sdk_cloudformation.types.resource_identifier_property_key.ResourceIdentifierPropertyKey"
]
