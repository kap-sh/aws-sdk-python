...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.account_filter_type
    import aws_sdk_cloudformation.types.account_list
    import aws_sdk_cloudformation.types.accounts_url
...
class DeploymentTargets(TypedDict, closed=True):
    ...
    account_filter_type: NotRequired[
        "aws_sdk_cloudformation.types.account_filter_type.AccountFilterType"
    ]
...
def serialize_query(
    ...
    if "account_filter_type" in value:
        ...
        aws_sdk_cloudformation.types.account_filter_type.serialize_query(
...
def deserialize_query(el: Element) -> DeploymentTargets:
    ...
    if child_account_filter_type is not None:
        ...
        out["account_filter_type"] = (
            aws_sdk_cloudformation.types.account_filter_type.deserialize_query(
