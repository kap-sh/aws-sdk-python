...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudformation.types.resource_identifiers
    import aws_sdk_cloudformation.types.resource_type


class ResourceIdentifierSummary(TypedDict):
    ...
    resource_identifiers: NotRequired[
        "aws_sdk_cloudformation.types.resource_identifiers.ResourceIdentifiers"
    ]
...
def serialize_query(
    ...
    if "logical_resource_ids" in value:
        ...
        aws_sdk_cloudformation.types.logical_resource_ids.serialize_query(
            value["logical_resource_ids"], pairs, f"{prefix}.LogicalResourceIds"
        )
    if "resource_identifiers" in value:
        import aws_sdk_cloudformation.types.resource_identifiers

        aws_sdk_cloudformation.types.resource_identifiers.serialize_query(
...
def deserialize_query(el: Element) -> ResourceIdentifierSummary:
    ...
    if child_logical_resource_ids is not None:
        ...
        out["logical_resource_ids"] = (
            aws_sdk_cloudformation.types.logical_resource_ids.deserialize_query(
    ...
    if child_resource_identifiers is not None:
        ...
        out["resource_identifiers"] = (
            aws_sdk_cloudformation.types.resource_identifiers.deserialize_query(
