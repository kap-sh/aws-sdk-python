...
TemplateSummaries: TypeAlias = list[
    "aws_sdk_cloudformation.types.template_summary.TemplateSummary"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_cloudformation.types.template_summary.serialize_query(
...
def deserialize_query(el: Element) -> TemplateSummaries:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_cloudformation.types.template_summary.deserialize_query(child)
        )
    return out
