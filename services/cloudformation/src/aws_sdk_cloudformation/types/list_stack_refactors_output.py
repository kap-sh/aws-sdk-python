...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudformation.types.stack_refactor_summaries


class ListStackRefactorsOutput(TypedDict):
    stack_refactor_summaries: NotRequired[
        "aws_sdk_cloudformation.types.stack_refactor_summaries.StackRefactorSummaries"
    ]
...
def serialize_query(
    ...
    if "stack_refactor_summaries" in value:
        ...
        aws_sdk_cloudformation.types.stack_refactor_summaries.serialize_query(
...
def deserialize_query(el: Element) -> ListStackRefactorsOutput:
    ...
    if child_stack_refactor_summaries is not None:
        ...
        out["stack_refactor_summaries"] = (
            aws_sdk_cloudformation.types.stack_refactor_summaries.deserialize_query(
