...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.jazz_resource_identifier_property_key
    import aws_sdk_cloudformation.types.jazz_resource_identifier_property_value

JazzResourceIdentifierProperties: TypeAlias = dict[
    "aws_sdk_cloudformation.types.jazz_resource_identifier_property_key.JazzResourceIdentifierPropertyKey",
    "aws_sdk_cloudformation.types.jazz_resource_identifier_property_value.JazzResourceIdentifierPropertyValue",
]
