...
def serialize_query(
    ...
    if "type" in value:
        ...
        aws_sdk_cloudformation.types.warning_type.serialize_query(
            value["type"], pairs, f"{prefix}.Type"
        )
    if "properties" in value:
        import aws_sdk_cloudformation.types.warning_properties

        aws_sdk_cloudformation.types.warning_properties.serialize_query(
...
def deserialize_query(el: Element) -> WarningDetail:
    ...
    if child_type is not None:
        ...
        out["type"] = aws_sdk_cloudformation.types.warning_type.deserialize_query(
            child_type
        )
    ...
    if child_properties is not None:
        ...
        out["properties"] = (
            aws_sdk_cloudformation.types.warning_properties.deserialize_query(
                child_properties
            )
        )
    return out
