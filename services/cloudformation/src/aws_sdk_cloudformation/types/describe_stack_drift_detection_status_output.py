...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.boxed_integer
    import aws_sdk_cloudformation.types.stack_drift_detection_id
    import aws_sdk_cloudformation.types.stack_drift_detection_status
    import aws_sdk_cloudformation.types.stack_drift_detection_status_reason
...
class DescribeStackDriftDetectionStatusOutput(TypedDict):
    ...
    detection_status: NotRequired[
        "aws_sdk_cloudformation.types.stack_drift_detection_status.StackDriftDetectionStatus"
    ]
    ...
    detection_status_reason: NotRequired[
        "aws_sdk_cloudformation.types.stack_drift_detection_status_reason.StackDriftDetectionStatusReason"
    ]
    """<p>The reason the stack drift detection operation has its current status.</p>"""
    drifted_stack_resource_count: NotRequired[
        "aws_sdk_cloudformation.types.boxed_integer.BoxedInteger"
    ]
...
def serialize_query(
    ...
    if "detection_status" in value:
        ...
        aws_sdk_cloudformation.types.stack_drift_detection_status.serialize_query(
...
def deserialize_query(el: Element) -> DescribeStackDriftDetectionStatusOutput:
    ...
    if child_detection_status is not None:
        ...
        out["detection_status"] = (
            aws_sdk_cloudformation.types.stack_drift_detection_status.deserialize_query(
