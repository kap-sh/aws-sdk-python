...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudformation.types.publisher_profile
    import aws_sdk_cloudformation.types.publisher_status


class DescribePublisherOutput(TypedDict):
    ...
    publisher_status: NotRequired[
        "aws_sdk_cloudformation.types.publisher_status.PublisherStatus"
    ]
    ...
    publisher_profile: NotRequired[
        "aws_sdk_cloudformation.types.publisher_profile.PublisherProfile"
    ]
...
def serialize_query(
    ...
    if "publisher_status" in value:
        ...
        aws_sdk_cloudformation.types.publisher_status.serialize_query(
...
def deserialize_query(el: Element) -> DescribePublisherOutput:
    ...
    if child_publisher_status is not None:
        ...
        out["publisher_status"] = (
            aws_sdk_cloudformation.types.publisher_status.deserialize_query(
