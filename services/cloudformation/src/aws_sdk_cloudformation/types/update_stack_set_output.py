"""Generated from Smithy shape ``com.amazonaws.cloudformation#UpdateStackSetOutput``."""
...
class UpdateStackSetOutput(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> UpdateStackSetOutput:
    out: UpdateStackSetOutput = {}  # type: ignore[typeddict-item]
