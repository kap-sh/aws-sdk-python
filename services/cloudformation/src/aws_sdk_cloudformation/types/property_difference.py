...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.difference_type
    import aws_sdk_cloudformation.types.property_path
...
class PropertyDifference(TypedDict):
    ...
    expected_value: NotRequired[
        "aws_sdk_cloudformation.types.property_value.PropertyValue"
    ]
    ...
    difference_type: NotRequired[
        "aws_sdk_cloudformation.types.difference_type.DifferenceType"
    ]
...
def serialize_query(
    ...
    if "difference_type" in value:
        ...
        aws_sdk_cloudformation.types.difference_type.serialize_query(
...
def deserialize_query(el: Element) -> PropertyDifference:
    ...
    if child_difference_type is not None:
        ...
        out["difference_type"] = (
            aws_sdk_cloudformation.types.difference_type.deserialize_query(
