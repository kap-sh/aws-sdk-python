...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudformation.types.resource_details
    import aws_sdk_cloudformation.types.stack_id
    import aws_sdk_cloudformation.types.template_configuration
    import aws_sdk_cloudformation.types.template_progress
    import aws_sdk_cloudformation.types.template_status_reason
    import aws_sdk_cloudformation.types.total_warnings


class DescribeGeneratedTemplateOutput(TypedDict):
    ...
    resources: NotRequired[
        "aws_sdk_cloudformation.types.resource_details.ResourceDetails"
    ]
    ...
    status_reason: NotRequired[
        "aws_sdk_cloudformation.types.template_status_reason.TemplateStatusReason"
    ]
    ...
    progress: NotRequired[
        "aws_sdk_cloudformation.types.template_progress.TemplateProgress"
    ]
    ...
    total_warnings: NotRequired[
        "aws_sdk_cloudformation.types.total_warnings.TotalWarnings"
    ]
...
def serialize_query(
    ...
    if "resources" in value:
        ...
        aws_sdk_cloudformation.types.resource_details.serialize_query(
    ...
    if "progress" in value:
        ...
        aws_sdk_cloudformation.types.template_progress.serialize_query(
...
def deserialize_query(el: Element) -> DescribeGeneratedTemplateOutput:
    ...
    if child_resources is not None:
        ...
        out["resources"] = (
            aws_sdk_cloudformation.types.resource_details.deserialize_query(
                child_resources
            )
        )
    ...
    if child_progress is not None:
        ...
        out["progress"] = (
            aws_sdk_cloudformation.types.template_progress.deserialize_query(
                child_progress
            )
        )
