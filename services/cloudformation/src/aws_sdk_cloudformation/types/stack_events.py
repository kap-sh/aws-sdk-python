...
StackEvents: TypeAlias = list["aws_sdk_cloudformation.types.stack_event.StackEvent"]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_cloudformation.types.stack_event.serialize_query(
...
def deserialize_query(el: Element) -> StackEvents:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_cloudformation.types.stack_event.deserialize_query(child))
    return out
