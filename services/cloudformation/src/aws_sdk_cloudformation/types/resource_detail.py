...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.generated_template_resource_status
    ...
    import aws_sdk_cloudformation.types.warning_details
...
class ResourceDetail(TypedDict, closed=True):
    ...
    warnings: NotRequired["aws_sdk_cloudformation.types.warning_details.WarningDetails"]
...
def serialize_query(
    ...
    if "resource_status" in value:
        ...
        aws_sdk_cloudformation.types.generated_template_resource_status.serialize_query(
    ...
    if "warnings" in value:
        ...
        aws_sdk_cloudformation.types.warning_details.serialize_query(
...
def deserialize_query(el: Element) -> ResourceDetail:
    ...
    if child_resource_status is not None:
        ...
        out["resource_status"] = (
            aws_sdk_cloudformation.types.generated_template_resource_status.deserialize_query(
    ...
    if child_warnings is not None:
        ...
        out["warnings"] = (
            aws_sdk_cloudformation.types.warning_details.deserialize_query(
                child_warnings
            )
        )
    return out
