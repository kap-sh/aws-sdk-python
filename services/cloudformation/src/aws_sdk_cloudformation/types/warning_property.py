...
if TYPE_CHECKING:
    import aws_sdk_cloudformation.types.property_description
    import aws_sdk_cloudformation.types.property_path
    import aws_sdk_cloudformation.types.required_property


class WarningProperty(TypedDict):
    ...
    required: NotRequired[
        "aws_sdk_cloudformation.types.required_property.RequiredProperty"
    ]
    """<p>If <code>true</code>, the specified property is required.</p>"""
    description: NotRequired[
        "aws_sdk_cloudformation.types.property_description.PropertyDescription"
    ]
