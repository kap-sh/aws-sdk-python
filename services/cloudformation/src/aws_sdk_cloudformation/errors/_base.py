...
class CloudFormationError(Exception):
    """Base class for all CloudFormation service errors."""


class ServiceError(CloudFormationError):
...
class SerializationError(CloudFormationError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CloudFormationError):
...
class WaiterFailedError(CloudFormationError):
...
class WaiterTimeoutError(CloudFormationError):
