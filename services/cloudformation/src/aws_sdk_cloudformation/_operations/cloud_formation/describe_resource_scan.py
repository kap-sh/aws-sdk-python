...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_resource_scan_output.DescribeResourceScanOutput = aws_sdk_cloudformation.types.describe_resource_scan_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_resource_scan_input.DescribeResourceScanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.describe_resource_scan_input.serialize_query(
        input_, pairs, ""
    )
