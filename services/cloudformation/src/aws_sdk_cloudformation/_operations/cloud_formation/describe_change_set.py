"""Generated from Smithy shape ``com.amazonaws.cloudformation#DescribeChangeSet``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeChangeSetResult")
    out: aws_sdk_cloudformation.types.describe_change_set_output.DescribeChangeSetOutput = aws_sdk_cloudformation.types.describe_change_set_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_change_set_input.DescribeChangeSetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeChangeSet"))
    pairs.append(("Version", "2010-05-15"))
    import aws_sdk_cloudformation.types.describe_change_set_input

    aws_sdk_cloudformation.types.describe_change_set_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_change_set(
