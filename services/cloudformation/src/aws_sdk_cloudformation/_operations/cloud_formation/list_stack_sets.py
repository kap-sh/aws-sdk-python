...
def build_request(
    ...
    input: aws_sdk_cloudformation.types.list_stack_sets_input.ListStackSetsInput,
) -> zapros.Request:
    ...
    aws_sdk_cloudformation.types.list_stack_sets_input.serialize_query(input, pairs, "")
