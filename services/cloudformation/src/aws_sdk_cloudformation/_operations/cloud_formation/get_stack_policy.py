"""Generated from Smithy shape ``com.amazonaws.cloudformation#GetStackPolicy``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetStackPolicyResult")
    out: aws_sdk_cloudformation.types.get_stack_policy_output.GetStackPolicyOutput = (
        aws_sdk_cloudformation.types.get_stack_policy_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.get_stack_policy_input.GetStackPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetStackPolicy"))
    pairs.append(("Version", "2010-05-15"))
    import aws_sdk_cloudformation.types.get_stack_policy_input

    aws_sdk_cloudformation.types.get_stack_policy_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_stack_policy(
