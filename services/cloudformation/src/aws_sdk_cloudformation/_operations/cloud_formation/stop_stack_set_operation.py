"""Generated from Smithy shape ``com.amazonaws.cloudformation#StopStackSetOperation``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("StopStackSetOperationResult")
    out: aws_sdk_cloudformation.types.stop_stack_set_operation_output.StopStackSetOperationOutput = aws_sdk_cloudformation.types.stop_stack_set_operation_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.stop_stack_set_operation_input.StopStackSetOperationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_stop_stack_set_operation(
