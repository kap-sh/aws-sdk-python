"""Generated from Smithy shape ``com.amazonaws.cloudformation#SetStackPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.set_stack_policy_input.SetStackPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "SetStackPolicy"))
    pairs.append(("Version", "2010-05-15"))
    import aws_sdk_cloudformation.types.set_stack_policy_input

    aws_sdk_cloudformation.types.set_stack_policy_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_set_stack_policy(
