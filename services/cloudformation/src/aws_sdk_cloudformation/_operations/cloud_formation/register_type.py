...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.register_type_output.RegisterTypeOutput = (
        aws_sdk_cloudformation.types.register_type_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.register_type_input.RegisterTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.register_type_input.serialize_query(input_, pairs, "")
