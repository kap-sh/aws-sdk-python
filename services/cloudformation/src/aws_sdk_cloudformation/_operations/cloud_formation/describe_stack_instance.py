...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_stack_instance_output.DescribeStackInstanceOutput = aws_sdk_cloudformation.types.describe_stack_instance_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_stack_instance_input.DescribeStackInstanceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.describe_stack_instance_input.serialize_query(
        input_, pairs, ""
    )
