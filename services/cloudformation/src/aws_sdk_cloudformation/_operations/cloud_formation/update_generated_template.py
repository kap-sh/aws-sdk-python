...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.update_generated_template_output.UpdateGeneratedTemplateOutput = aws_sdk_cloudformation.types.update_generated_template_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.update_generated_template_input.UpdateGeneratedTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.update_generated_template_input.serialize_query(
        input_, pairs, ""
    )
