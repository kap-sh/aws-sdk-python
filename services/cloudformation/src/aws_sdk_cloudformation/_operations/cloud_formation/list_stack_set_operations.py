...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_stack_set_operations_output.ListStackSetOperationsOutput = aws_sdk_cloudformation.types.list_stack_set_operations_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_stack_set_operations_input.ListStackSetOperationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_stack_set_operations_input.serialize_query(
        input_, pairs, ""
    )
