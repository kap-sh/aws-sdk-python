...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_imports_output.ListImportsOutput = (
        aws_sdk_cloudformation.types.list_imports_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_imports_input.ListImportsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_imports_input.serialize_query(input_, pairs, "")
...
def list_imports(
    ...
    aws_sdk_cloudformation.types.list_imports_output.ListImportsOutput, zapros.Response
]:
