"""Generated from Smithy shape ``com.amazonaws.cloudformation#DeleteStackInstances``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteStackInstancesResult")
    out: aws_sdk_cloudformation.types.delete_stack_instances_output.DeleteStackInstancesOutput = aws_sdk_cloudformation.types.delete_stack_instances_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.delete_stack_instances_input.DeleteStackInstancesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteStackInstances"))
    pairs.append(("Version", "2010-05-15"))
    import aws_sdk_cloudformation.types.delete_stack_instances_input

    aws_sdk_cloudformation.types.delete_stack_instances_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_stack_instances(
