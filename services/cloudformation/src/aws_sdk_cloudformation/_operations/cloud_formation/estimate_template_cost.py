...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.estimate_template_cost_output.EstimateTemplateCostOutput = aws_sdk_cloudformation.types.estimate_template_cost_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.estimate_template_cost_input.EstimateTemplateCostInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.estimate_template_cost_input.serialize_query(
        input_, pairs, ""
    )
