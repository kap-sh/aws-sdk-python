...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_stack_drift_detection_status_output.DescribeStackDriftDetectionStatusOutput = aws_sdk_cloudformation.types.describe_stack_drift_detection_status_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_stack_drift_detection_status_input.DescribeStackDriftDetectionStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
