...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_organizations_access_output.DescribeOrganizationsAccessOutput = aws_sdk_cloudformation.types.describe_organizations_access_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_organizations_access_input.DescribeOrganizationsAccessInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.describe_organizations_access_input.serialize_query(
        input_, pairs, ""
    )
