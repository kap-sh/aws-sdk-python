...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.activate_type_output.ActivateTypeOutput = (
        aws_sdk_cloudformation.types.activate_type_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.activate_type_input.ActivateTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.activate_type_input.serialize_query(input_, pairs, "")
