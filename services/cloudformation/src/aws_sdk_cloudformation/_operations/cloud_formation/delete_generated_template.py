...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.delete_generated_template_input.DeleteGeneratedTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.delete_generated_template_input.serialize_query(
        input_, pairs, ""
    )
