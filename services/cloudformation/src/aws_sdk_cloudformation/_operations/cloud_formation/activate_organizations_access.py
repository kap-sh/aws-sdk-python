"""Generated from Smithy shape ``com.amazonaws.cloudformation#ActivateOrganizationsAccess``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ActivateOrganizationsAccessResult")
    out: aws_sdk_cloudformation.types.activate_organizations_access_output.ActivateOrganizationsAccessOutput = aws_sdk_cloudformation.types.activate_organizations_access_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.activate_organizations_access_input.ActivateOrganizationsAccessInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ActivateOrganizationsAccess"))
    pairs.append(("Version", "2010-05-15"))
    import aws_sdk_cloudformation.types.activate_organizations_access_input

    aws_sdk_cloudformation.types.activate_organizations_access_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_activate_organizations_access(
