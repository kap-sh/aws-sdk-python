...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.update_stack_instances_input.UpdateStackInstancesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.update_stack_instances_input.serialize_query(
        input_, pairs, ""
    )
