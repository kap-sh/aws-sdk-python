"""Generated from Smithy shape ``com.amazonaws.cloudformation#DeregisterType``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeregisterTypeResult")
    out: aws_sdk_cloudformation.types.deregister_type_output.DeregisterTypeOutput = (
        aws_sdk_cloudformation.types.deregister_type_output.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_cloudformation.types.deregister_type_input.DeregisterTypeInput,
) -> zapros.Request:
    ...
    pairs.append(("Action", "DeregisterType"))
    pairs.append(("Version", "2010-05-15"))
    import aws_sdk_cloudformation.types.deregister_type_input

    aws_sdk_cloudformation.types.deregister_type_input.serialize_query(input, pairs, "")
...
async def async_deregister_type(
