...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.detect_stack_drift_output.DetectStackDriftOutput = aws_sdk_cloudformation.types.detect_stack_drift_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.detect_stack_drift_input.DetectStackDriftInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.detect_stack_drift_input.serialize_query(
        input_, pairs, ""
    )
