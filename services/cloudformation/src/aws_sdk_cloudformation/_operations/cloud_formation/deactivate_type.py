...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.deactivate_type_output.DeactivateTypeOutput = (
        aws_sdk_cloudformation.types.deactivate_type_output.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_cloudformation.types.deactivate_type_input.DeactivateTypeInput,
) -> zapros.Request:
    ...
    aws_sdk_cloudformation.types.deactivate_type_input.serialize_query(input, pairs, "")
