...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.rollback_stack_output.RollbackStackOutput = (
        aws_sdk_cloudformation.types.rollback_stack_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.rollback_stack_input.RollbackStackInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.rollback_stack_input.serialize_query(input_, pairs, "")
