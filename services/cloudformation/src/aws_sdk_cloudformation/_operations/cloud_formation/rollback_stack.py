...
def build_request(
    ...
    input: aws_sdk_cloudformation.types.rollback_stack_input.RollbackStackInput,
) -> zapros.Request:
    ...
    aws_sdk_cloudformation.types.rollback_stack_input.serialize_query(input, pairs, "")
