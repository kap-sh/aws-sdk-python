...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.execute_change_set_output.ExecuteChangeSetOutput = aws_sdk_cloudformation.types.execute_change_set_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.execute_change_set_input.ExecuteChangeSetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.execute_change_set_input.serialize_query(
        input_, pairs, ""
    )
