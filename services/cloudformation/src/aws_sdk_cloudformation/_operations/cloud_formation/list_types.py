...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_types_output.ListTypesOutput = (
        aws_sdk_cloudformation.types.list_types_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_types_input.ListTypesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_types_input.serialize_query(input_, pairs, "")
...
def list_types(
    ...
    aws_sdk_cloudformation.types.list_types_output.ListTypesOutput, zapros.Response
]:
