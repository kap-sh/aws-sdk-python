...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.create_generated_template_output.CreateGeneratedTemplateOutput = aws_sdk_cloudformation.types.create_generated_template_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.create_generated_template_input.CreateGeneratedTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.create_generated_template_input.serialize_query(
        input_, pairs, ""
    )
