...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.register_publisher_output.RegisterPublisherOutput = aws_sdk_cloudformation.types.register_publisher_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.register_publisher_input.RegisterPublisherInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
