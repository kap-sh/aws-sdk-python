...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.detect_stack_resource_drift_output.DetectStackResourceDriftOutput = aws_sdk_cloudformation.types.detect_stack_resource_drift_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.detect_stack_resource_drift_input.DetectStackResourceDriftInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.detect_stack_resource_drift_input.serialize_query(
        input_, pairs, ""
    )
