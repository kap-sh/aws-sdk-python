...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_stack_set_auto_deployment_targets_output.ListStackSetAutoDeploymentTargetsOutput = aws_sdk_cloudformation.types.list_stack_set_auto_deployment_targets_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_stack_set_auto_deployment_targets_input.ListStackSetAutoDeploymentTargetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_stack_set_auto_deployment_targets_input.serialize_query(
        input_, pairs, ""
    )
