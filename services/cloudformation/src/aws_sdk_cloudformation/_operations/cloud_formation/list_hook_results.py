...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_hook_results_output.ListHookResultsOutput = (
        aws_sdk_cloudformation.types.list_hook_results_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_hook_results_input.ListHookResultsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_hook_results_input.serialize_query(
        input_, pairs, ""
    )
