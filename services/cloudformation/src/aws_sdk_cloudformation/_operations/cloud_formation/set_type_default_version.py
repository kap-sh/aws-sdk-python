...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.set_type_default_version_output.SetTypeDefaultVersionOutput = aws_sdk_cloudformation.types.set_type_default_version_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.set_type_default_version_input.SetTypeDefaultVersionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.set_type_default_version_input.serialize_query(
        input_, pairs, ""
    )
