"""Generated from Smithy shape ``com.amazonaws.cloudformation#DescribeChangeSetHooks``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeChangeSetHooksResult")
    out: aws_sdk_cloudformation.types.describe_change_set_hooks_output.DescribeChangeSetHooksOutput = aws_sdk_cloudformation.types.describe_change_set_hooks_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_change_set_hooks_input.DescribeChangeSetHooksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeChangeSetHooks"))
    pairs.append(("Version", "2010-05-15"))
    import aws_sdk_cloudformation.types.describe_change_set_hooks_input

    aws_sdk_cloudformation.types.describe_change_set_hooks_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_change_set_hooks(
