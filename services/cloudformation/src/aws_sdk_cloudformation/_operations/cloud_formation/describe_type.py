...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_type_input.DescribeTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.describe_type_input.serialize_query(input_, pairs, "")
