...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_stack_set_operation_results_output.ListStackSetOperationResultsOutput = aws_sdk_cloudformation.types.list_stack_set_operation_results_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_stack_set_operation_results_input.ListStackSetOperationResultsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_stack_set_operation_results_input.serialize_query(
        input_, pairs, ""
    )
