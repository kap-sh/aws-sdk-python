...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.create_stack_instances_output.CreateStackInstancesOutput = aws_sdk_cloudformation.types.create_stack_instances_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.create_stack_instances_input.CreateStackInstancesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.create_stack_instances_input.serialize_query(
        input_, pairs, ""
    )
