...
def build_request(
    ...
    input: aws_sdk_cloudformation.types.get_hook_result_input.GetHookResultInput,
) -> zapros.Request:
    ...
    aws_sdk_cloudformation.types.get_hook_result_input.serialize_query(input, pairs, "")
