...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_change_sets_output.ListChangeSetsOutput = (
        aws_sdk_cloudformation.types.list_change_sets_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_change_sets_input.ListChangeSetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_change_sets_input.serialize_query(
        input_, pairs, ""
    )
