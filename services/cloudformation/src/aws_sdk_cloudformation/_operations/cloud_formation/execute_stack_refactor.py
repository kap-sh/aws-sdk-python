...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.execute_stack_refactor_input.ExecuteStackRefactorInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.execute_stack_refactor_input.serialize_query(
        input_, pairs, ""
    )
