...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_stack_resources_output.DescribeStackResourcesOutput = aws_sdk_cloudformation.types.describe_stack_resources_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_stack_resources_input.DescribeStackResourcesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.describe_stack_resources_input.serialize_query(
        input_, pairs, ""
    )
