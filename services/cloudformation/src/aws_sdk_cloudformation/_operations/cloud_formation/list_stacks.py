...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_stacks_output.ListStacksOutput = (
        aws_sdk_cloudformation.types.list_stacks_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_stacks_input.ListStacksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_stacks_input.serialize_query(input_, pairs, "")
...
def list_stacks(
    ...
    aws_sdk_cloudformation.types.list_stacks_output.ListStacksOutput, zapros.Response
]:
