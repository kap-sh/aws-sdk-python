...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.detect_stack_set_drift_output.DetectStackSetDriftOutput = aws_sdk_cloudformation.types.detect_stack_set_drift_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.detect_stack_set_drift_input.DetectStackSetDriftInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.detect_stack_set_drift_input.serialize_query(
        input_, pairs, ""
    )
