"""Generated from Smithy shape ``com.amazonaws.cloudformation#UpdateTerminationProtection``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("UpdateTerminationProtectionResult")
    out: aws_sdk_cloudformation.types.update_termination_protection_output.UpdateTerminationProtectionOutput = aws_sdk_cloudformation.types.update_termination_protection_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.update_termination_protection_input.UpdateTerminationProtectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_termination_protection(
