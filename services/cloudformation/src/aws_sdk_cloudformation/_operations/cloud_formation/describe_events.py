...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_events_output.DescribeEventsOutput = (
        aws_sdk_cloudformation.types.describe_events_output.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_cloudformation.types.describe_events_input.DescribeEventsInput,
) -> zapros.Request:
    ...
    aws_sdk_cloudformation.types.describe_events_input.serialize_query(input, pairs, "")
