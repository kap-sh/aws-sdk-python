...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_stack_events_output.DescribeStackEventsOutput = aws_sdk_cloudformation.types.describe_stack_events_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_stack_events_input.DescribeStackEventsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.describe_stack_events_input.serialize_query(
        input_, pairs, ""
    )
