...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_stack_resource_output.DescribeStackResourceOutput = aws_sdk_cloudformation.types.describe_stack_resource_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_stack_resource_input.DescribeStackResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
