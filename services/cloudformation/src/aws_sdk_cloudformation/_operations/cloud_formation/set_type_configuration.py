...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.set_type_configuration_output.SetTypeConfigurationOutput = aws_sdk_cloudformation.types.set_type_configuration_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.set_type_configuration_input.SetTypeConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.set_type_configuration_input.serialize_query(
        input_, pairs, ""
    )
