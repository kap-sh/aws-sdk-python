...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.update_stack_set_output.UpdateStackSetOutput = (
        aws_sdk_cloudformation.types.update_stack_set_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.update_stack_set_input.UpdateStackSetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.update_stack_set_input.serialize_query(
        input_, pairs, ""
    )
