...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.update_stack_input.UpdateStackInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.update_stack_input.serialize_query(input_, pairs, "")
...
def update_stack(
    ...
    aws_sdk_cloudformation.types.update_stack_output.UpdateStackOutput, zapros.Response
]:
