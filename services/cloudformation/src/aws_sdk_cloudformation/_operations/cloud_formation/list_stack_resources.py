...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_stack_resources_output.ListStackResourcesOutput = aws_sdk_cloudformation.types.list_stack_resources_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_stack_resources_input.ListStackResourcesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_stack_resources_input.serialize_query(
        input_, pairs, ""
    )
