...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_type_registration_output.DescribeTypeRegistrationOutput = aws_sdk_cloudformation.types.describe_type_registration_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_type_registration_input.DescribeTypeRegistrationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.describe_type_registration_input.serialize_query(
        input_, pairs, ""
    )
