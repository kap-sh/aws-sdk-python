...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.get_template_input.GetTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.get_template_input.serialize_query(input_, pairs, "")
...
def get_template(
    ...
    aws_sdk_cloudformation.types.get_template_output.GetTemplateOutput, zapros.Response
]:
