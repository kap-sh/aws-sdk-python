"""Generated from Smithy shape ``com.amazonaws.cloudformation#ValidateTemplate``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ValidateTemplateResult")
    out: aws_sdk_cloudformation.types.validate_template_output.ValidateTemplateOutput = aws_sdk_cloudformation.types.validate_template_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.validate_template_input.ValidateTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ValidateTemplate"))
    pairs.append(("Version", "2010-05-15"))
    import aws_sdk_cloudformation.types.validate_template_input

    aws_sdk_cloudformation.types.validate_template_input.serialize_query(
        input_, pairs, ""
    )
