"""Generated from Smithy shape ``com.amazonaws.cloudformation#DescribeGeneratedTemplate``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeGeneratedTemplateResult")
    out: aws_sdk_cloudformation.types.describe_generated_template_output.DescribeGeneratedTemplateOutput = aws_sdk_cloudformation.types.describe_generated_template_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_generated_template_input.DescribeGeneratedTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeGeneratedTemplate"))
    pairs.append(("Version", "2010-05-15"))
    aws_sdk_cloudformation.types.describe_generated_template_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_generated_template(
