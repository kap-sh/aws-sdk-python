...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.create_stack_output.CreateStackOutput = (
        aws_sdk_cloudformation.types.create_stack_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.create_stack_input.CreateStackInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.create_stack_input.serialize_query(input_, pairs, "")
...
def create_stack(
    ...
    aws_sdk_cloudformation.types.create_stack_output.CreateStackOutput, zapros.Response
]:
