...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_stacks_output.DescribeStacksOutput = (
        aws_sdk_cloudformation.types.describe_stacks_output.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_cloudformation.types.describe_stacks_input.DescribeStacksInput,
) -> zapros.Request:
    ...
    aws_sdk_cloudformation.types.describe_stacks_input.serialize_query(input, pairs, "")
