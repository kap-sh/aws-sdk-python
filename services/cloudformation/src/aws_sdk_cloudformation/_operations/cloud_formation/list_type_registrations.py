...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_type_registrations_output.ListTypeRegistrationsOutput = aws_sdk_cloudformation.types.list_type_registrations_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_type_registrations_input.ListTypeRegistrationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_type_registrations_input.serialize_query(
        input_, pairs, ""
    )
