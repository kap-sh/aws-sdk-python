...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_exports_output.ListExportsOutput = (
        aws_sdk_cloudformation.types.list_exports_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_exports_input.ListExportsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_exports_input.serialize_query(input_, pairs, "")
...
def list_exports(
    ...
    aws_sdk_cloudformation.types.list_exports_output.ListExportsOutput, zapros.Response
]:
