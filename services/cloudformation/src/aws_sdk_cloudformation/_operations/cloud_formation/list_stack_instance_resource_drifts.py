...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_stack_instance_resource_drifts_output.ListStackInstanceResourceDriftsOutput = aws_sdk_cloudformation.types.list_stack_instance_resource_drifts_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_stack_instance_resource_drifts_input.ListStackInstanceResourceDriftsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_stack_instance_resource_drifts_input.serialize_query(
        input_, pairs, ""
    )
