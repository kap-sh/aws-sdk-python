"""Generated from Smithy shape ``com.amazonaws.cloudformation#TestType``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("TestTypeResult")
    out: aws_sdk_cloudformation.types.test_type_output.TestTypeOutput = (
        aws_sdk_cloudformation.types.test_type_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.test_type_input.TestTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "TestType"))
    pairs.append(("Version", "2010-05-15"))
    import aws_sdk_cloudformation.types.test_type_input

    aws_sdk_cloudformation.types.test_type_input.serialize_query(input_, pairs, "")
...
def test_type(
    ...
    aws_sdk_cloudformation.types.test_type_output.TestTypeOutput, zapros.Response
]:
