...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_stack_set_operation_output.DescribeStackSetOperationOutput = aws_sdk_cloudformation.types.describe_stack_set_operation_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_stack_set_operation_input.DescribeStackSetOperationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.describe_stack_set_operation_input.serialize_query(
        input_, pairs, ""
    )
