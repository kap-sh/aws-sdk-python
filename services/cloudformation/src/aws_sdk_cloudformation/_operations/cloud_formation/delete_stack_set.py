...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "StackSetNotEmptyException":
            import aws_sdk_cloudformation.errors.stack_set_not_empty_exception

            raise aws_sdk_cloudformation.errors.stack_set_not_empty_exception.StackSetNotEmptyException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.delete_stack_set_output.DeleteStackSetOutput = (
        aws_sdk_cloudformation.types.delete_stack_set_output.deserialize_query(
