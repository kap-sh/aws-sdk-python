"""Generated from Smithy shape ``com.amazonaws.cloudformation#SignalResource``."""
...
def build_request(
    ...
    input: aws_sdk_cloudformation.types.signal_resource_input.SignalResourceInput,
) -> zapros.Request:
    ...
    pairs.append(("Action", "SignalResource"))
    pairs.append(("Version", "2010-05-15"))
    import aws_sdk_cloudformation.types.signal_resource_input

    aws_sdk_cloudformation.types.signal_resource_input.serialize_query(input, pairs, "")
...
async def async_signal_resource(
