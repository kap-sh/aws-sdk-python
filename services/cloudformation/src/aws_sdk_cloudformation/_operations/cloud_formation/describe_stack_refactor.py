...
import aws_sdk_cloudformation.errors.stack_refactor_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "StackRefactorNotFoundException":
            raise aws_sdk_cloudformation.errors.stack_refactor_not_found_exception.StackRefactorNotFoundException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_stack_refactor_output.DescribeStackRefactorOutput = aws_sdk_cloudformation.types.describe_stack_refactor_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_stack_refactor_input.DescribeStackRefactorInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.describe_stack_refactor_input.serialize_query(
        input_, pairs, ""
    )
