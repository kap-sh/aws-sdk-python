...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.create_stack_refactor_output.CreateStackRefactorOutput = aws_sdk_cloudformation.types.create_stack_refactor_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.create_stack_refactor_input.CreateStackRefactorInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.create_stack_refactor_input.serialize_query(
        input_, pairs, ""
    )
