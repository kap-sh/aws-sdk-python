...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.get_template_summary_input.GetTemplateSummaryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.get_template_summary_input.serialize_query(
        input_, pairs, ""
    )
