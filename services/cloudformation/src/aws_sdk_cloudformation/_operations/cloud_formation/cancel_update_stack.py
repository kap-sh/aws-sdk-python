...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.cancel_update_stack_input.CancelUpdateStackInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.cancel_update_stack_input.serialize_query(
        input_, pairs, ""
    )
