...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_stack_refactors_output.ListStackRefactorsOutput = aws_sdk_cloudformation.types.list_stack_refactors_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_stack_refactors_input.ListStackRefactorsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_stack_refactors_input.serialize_query(
        input_, pairs, ""
    )
