...
import aws_sdk_cloudformation.types.stack_refactor_actions
...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_stack_refactor_actions_output.ListStackRefactorActionsOutput = aws_sdk_cloudformation.types.list_stack_refactor_actions_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_stack_refactor_actions_input.ListStackRefactorActionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_stack_refactor_actions_input.serialize_query(
        input_, pairs, ""
    )
