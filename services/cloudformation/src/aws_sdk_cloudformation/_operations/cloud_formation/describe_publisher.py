...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_publisher_output.DescribePublisherOutput = aws_sdk_cloudformation.types.describe_publisher_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_publisher_input.DescribePublisherInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.describe_publisher_input.serialize_query(
        input_, pairs, ""
    )
