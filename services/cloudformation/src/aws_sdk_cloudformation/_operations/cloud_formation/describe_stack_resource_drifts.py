...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.describe_stack_resource_drifts_output.DescribeStackResourceDriftsOutput = aws_sdk_cloudformation.types.describe_stack_resource_drifts_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.describe_stack_resource_drifts_input.DescribeStackResourceDriftsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.describe_stack_resource_drifts_input.serialize_query(
        input_, pairs, ""
    )
