...
import aws_sdk_cloudformation.errors.operation_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OperationNotFoundException":
            raise aws_sdk_cloudformation.errors.operation_not_found_exception.OperationNotFoundException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.deactivate_organizations_access_output.DeactivateOrganizationsAccessOutput = aws_sdk_cloudformation.types.deactivate_organizations_access_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.deactivate_organizations_access_input.DeactivateOrganizationsAccessInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.deactivate_organizations_access_input.serialize_query(
        input_, pairs, ""
    )
