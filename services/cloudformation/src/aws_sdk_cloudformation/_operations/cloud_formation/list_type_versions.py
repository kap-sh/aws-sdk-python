...
import aws_sdk_cloudformation.types.type_version_summaries
...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_type_versions_output.ListTypeVersionsOutput = aws_sdk_cloudformation.types.list_type_versions_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_type_versions_input.ListTypeVersionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_type_versions_input.serialize_query(
        input_, pairs, ""
    )
