...
import aws_sdk_cloudformation.types.template_summaries
...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.list_generated_templates_output.ListGeneratedTemplatesOutput = aws_sdk_cloudformation.types.list_generated_templates_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.list_generated_templates_input.ListGeneratedTemplatesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_cloudformation.types.list_generated_templates_input.serialize_query(
        input_, pairs, ""
    )
