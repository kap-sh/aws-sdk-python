...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TypeConfigurationNotFoundException":
            import aws_sdk_cloudformation.errors.type_configuration_not_found_exception

            raise aws_sdk_cloudformation.errors.type_configuration_not_found_exception.TypeConfigurationNotFoundException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_cloudformation.types.batch_describe_type_configurations_output.BatchDescribeTypeConfigurationsOutput = aws_sdk_cloudformation.types.batch_describe_type_configurations_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudformation.types.batch_describe_type_configurations_input.BatchDescribeTypeConfigurationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
