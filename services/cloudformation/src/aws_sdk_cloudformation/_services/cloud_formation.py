...
class CloudFormationClientConfig(TypedDict, total=False):
...
class CloudFormationClient:
    ...
    def __init__(
        ...
        self.config = CloudFormationClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[CloudFormationClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: CloudFormationClientConfig = config_overrides or {}
    ...
    def activate_organizations_access(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.activate_organizations_access_input.ActivateOrganizationsAccessInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.activate_organizations_access_output.ActivateOrganizationsAccessOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.activate_organizations_access.activate_organizations_access(
    ...
    def activate_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.activate_type_input.ActivateTypeInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.activate_type_output.ActivateTypeOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.activate_type.activate_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_describe_type_configurations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.batch_describe_type_configurations_input.BatchDescribeTypeConfigurationsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.batch_describe_type_configurations_output.BatchDescribeTypeConfigurationsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.batch_describe_type_configurations.batch_describe_type_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def cancel_update_stack(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.cancel_update_stack_input.CancelUpdateStackInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_cloudformation._operations.cloud_formation.cancel_update_stack

            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.cancel_update_stack.cancel_update_stack(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def continue_update_rollback(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.continue_update_rollback_input.ContinueUpdateRollbackInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.continue_update_rollback_output.ContinueUpdateRollbackOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.continue_update_rollback.continue_update_rollback(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_change_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.create_change_set_input.CreateChangeSetInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.create_change_set_output.CreateChangeSetOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.create_change_set.create_change_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_generated_template(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_generated_template(resources=[{'ResourceType': 'AWS::S3::Bucket', 'ResourceIdentifier': {'BucketName': 'jazz-bucket'}}, {'ResourceType': 'AWS::EC2::DHCPOptions', 'ResourceIdentifier': {'DhcpOptionsId': 'random-id123'}}], generated_template_name='JazzyTemplate')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.create_generated_template_input.CreateGeneratedTemplateInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.create_generated_template_output.CreateGeneratedTemplateOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.create_generated_template.create_generated_template(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_stack(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.create_stack_input.CreateStackInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.create_stack_output.CreateStackOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.create_stack.create_stack(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_stack_instances(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.create_stack_instances_input.CreateStackInstancesInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.create_stack_instances_output.CreateStackInstancesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.create_stack_instances.create_stack_instances(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_stack_refactor(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.create_stack_refactor_input.CreateStackRefactorInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.create_stack_refactor_output.CreateStackRefactorOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.create_stack_refactor.create_stack_refactor(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_stack_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.create_stack_set_input.CreateStackSetInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.create_stack_set_output.CreateStackSetOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.create_stack_set.create_stack_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deactivate_organizations_access(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.deactivate_organizations_access_input.DeactivateOrganizationsAccessInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.deactivate_organizations_access_output.DeactivateOrganizationsAccessOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.deactivate_organizations_access.deactivate_organizations_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deactivate_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.deactivate_type_input.DeactivateTypeInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.deactivate_type_output.DeactivateTypeOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.deactivate_type.deactivate_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_change_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.delete_change_set_input.DeleteChangeSetInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.delete_change_set_output.DeleteChangeSetOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.delete_change_set.delete_change_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_generated_template(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_generated_template(generated_template_name='JazzyTemplate')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.delete_generated_template_input.DeleteGeneratedTemplateInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_cloudformation._operations.cloud_formation.delete_generated_template

            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.delete_generated_template.delete_generated_template(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_stack(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.delete_stack_input.DeleteStackInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_cloudformation._operations.cloud_formation.delete_stack

            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.delete_stack.delete_stack(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_stack_instances(
        ...
        *,
        ...
        """<p>Deletes stack instances for the specified accounts, in the specified Amazon Web Services Regions.</p> <note> <p>The maximum number of organizational unit (OUs) supported by a <code>DeleteStackInstances</code> operation is 50.</p> <p>If you need more than 50, consider the following options:</p> <ul> <li> <p> <i>Batch processing:</i> If you don't want to expose your OU hierarchy, split up the operations into multiple calls with less than 50 OUs each.</p> </li> <li> <p> <i>Parent OU strategy:</i> If you don't mind exposing the OU hierarchy, target a parent OU that contains all desired child OUs.</p> </li> </ul> </note>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.delete_stack_instances_input.DeleteStackInstancesInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.delete_stack_instances_output.DeleteStackInstancesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.delete_stack_instances.delete_stack_instances(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_stack_set(
        ...
        *,
        ...
        """<p>Deletes a StackSet. Before you can delete a StackSet, all its member stack instances must be deleted. For more information about how to complete this, see <a>DeleteStackInstances</a>.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.delete_stack_set_input.DeleteStackSetInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.delete_stack_set_output.DeleteStackSetOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.delete_stack_set.delete_stack_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deregister_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.deregister_type_input.DeregisterTypeInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.deregister_type_output.DeregisterTypeOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.deregister_type.deregister_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_account_limits(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_account_limits_input.DescribeAccountLimitsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_account_limits_output.DescribeAccountLimitsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_account_limits.describe_account_limits(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.account_limit.AccountLimit]":
        _token = next_token
        while True:
    ...
    def describe_change_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_change_set_input.DescribeChangeSetInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_change_set_output.DescribeChangeSetOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_change_set.describe_change_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.change.Change]":
        _token = next_token
        while True:
    ...
    def describe_change_set_hooks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_change_set_hooks_input.DescribeChangeSetHooksInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_change_set_hooks_output.DescribeChangeSetHooksOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_change_set_hooks.describe_change_set_hooks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_events_input.DescribeEventsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_events_output.DescribeEventsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_events.describe_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.operation_event.OperationEvent]":
        _token = next_token
        while True:
    ...
    def describe_generated_template(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_generated_template_input.DescribeGeneratedTemplateInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_generated_template_output.DescribeGeneratedTemplateOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_generated_template.describe_generated_template(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_organizations_access(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_organizations_access_input.DescribeOrganizationsAccessInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_organizations_access_output.DescribeOrganizationsAccessOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_organizations_access.describe_organizations_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_publisher(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_publisher_input.DescribePublisherInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_publisher_output.DescribePublisherOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_publisher.describe_publisher(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_resource_scan(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_resource_scan_input.DescribeResourceScanInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_resource_scan_output.DescribeResourceScanOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_resource_scan.describe_resource_scan(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_stack_drift_detection_status(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_stack_drift_detection_status_input.DescribeStackDriftDetectionStatusInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_stack_drift_detection_status_output.DescribeStackDriftDetectionStatusOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_stack_drift_detection_status.describe_stack_drift_detection_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_stack_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_stack_events_input.DescribeStackEventsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_stack_events_output.DescribeStackEventsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_stack_events.describe_stack_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.stack_event.StackEvent]":
        _token = next_token
        while True:
    ...
    def describe_stack_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_stack_instance_input.DescribeStackInstanceInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_stack_instance_output.DescribeStackInstanceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_stack_instance.describe_stack_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_stack_refactor(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_stack_refactor_input.DescribeStackRefactorInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_stack_refactor_output.DescribeStackRefactorOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_stack_refactor.describe_stack_refactor(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_stack_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_stack_resource_input.DescribeStackResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_stack_resource_output.DescribeStackResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_stack_resource.describe_stack_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_stack_resource_drifts(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_stack_resource_drifts_input.DescribeStackResourceDriftsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_stack_resource_drifts_output.DescribeStackResourceDriftsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_stack_resource_drifts.describe_stack_resource_drifts(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_stack_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_stack_resources_input.DescribeStackResourcesInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_stack_resources_output.DescribeStackResourcesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_stack_resources.describe_stack_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_stacks(
        ...
        *,
        ...
        """<p>Returns the description for the specified stack; if no stack name was specified, then it returns the description for all the stacks created. For more information about a stack's event history, see <a href=\"https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stack-resource-configuration-complete.html\">Understand CloudFormation stack creation events</a> in the <i>CloudFormation User Guide</i>.</p> <note> <p>If the stack doesn't exist, a <code>ValidationError</code> is returned.</p> </note>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_stacks_input.DescribeStacksInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_stacks_output.DescribeStacksOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_stacks.describe_stacks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.stack.Stack]":
        _token = next_token
        while True:
            _response = self.describe_stacks(
                config_overrides=config_overrides,
                stack_name=stack_name,
                next_token=_token,
            )
    ...
    def wait_stack_exists(
        ...
        *,
        ...
        while True:
            ...
            try:
                op_output = self.describe_stacks(  # noqa: F841
                    config_overrides=config_overrides,
                    stack_name=stack_name,
    ...
    def describe_stack_set(
        ...
        *,
        ...
        """<p>Returns the description of the specified StackSet.</p> <note> <p>This API provides <i>strongly consistent</i> reads meaning it will always return the most up-to-date data.</p> </note>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_stack_set_input.DescribeStackSetInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_stack_set_output.DescribeStackSetOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_stack_set.describe_stack_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_stack_set_operation(
        ...
        *,
        ...
        """<p>Returns the description of the specified StackSet operation.</p> <note> <p>This API provides <i>strongly consistent</i> reads meaning it will always return the most up-to-date data.</p> </note>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_stack_set_operation_input.DescribeStackSetOperationInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_stack_set_operation_output.DescribeStackSetOperationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_stack_set_operation.describe_stack_set_operation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_type_input.DescribeTypeInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_type_output.DescribeTypeOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_type.describe_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_type_registration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.describe_type_registration_input.DescribeTypeRegistrationInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.describe_type_registration_output.DescribeTypeRegistrationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.describe_type_registration.describe_type_registration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def detect_stack_drift(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.detect_stack_drift_input.DetectStackDriftInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.detect_stack_drift_output.DetectStackDriftOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.detect_stack_drift.detect_stack_drift(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def detect_stack_resource_drift(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.detect_stack_resource_drift_input.DetectStackResourceDriftInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.detect_stack_resource_drift_output.DetectStackResourceDriftOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.detect_stack_resource_drift.detect_stack_resource_drift(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def detect_stack_set_drift(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.detect_stack_set_drift_input.DetectStackSetDriftInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.detect_stack_set_drift_output.DetectStackSetDriftOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.detect_stack_set_drift.detect_stack_set_drift(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def estimate_template_cost(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.estimate_template_cost_input.EstimateTemplateCostInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.estimate_template_cost_output.EstimateTemplateCostOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.estimate_template_cost.estimate_template_cost(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def execute_change_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.execute_change_set_input.ExecuteChangeSetInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.execute_change_set_output.ExecuteChangeSetOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.execute_change_set.execute_change_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def execute_stack_refactor(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.execute_stack_refactor_input.ExecuteStackRefactorInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_cloudformation._operations.cloud_formation.execute_stack_refactor

            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.execute_stack_refactor.execute_stack_refactor(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_generated_template(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_generated_template(generated_template_name='JazzyTemplate')
            To get a generated template in YAML format
            This example gets a generated template in YAML format.

            >>> client.get_generated_template(generated_template_name='JazzyTemplate', format='YAML')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.get_generated_template_input.GetGeneratedTemplateInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.get_generated_template_output.GetGeneratedTemplateOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.get_generated_template.get_generated_template(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_hook_result(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.get_hook_result_input.GetHookResultInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.get_hook_result_output.GetHookResultOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.get_hook_result.get_hook_result(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_stack_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.get_stack_policy_input.GetStackPolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.get_stack_policy_output.GetStackPolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.get_stack_policy.get_stack_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_template(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.get_template_input.GetTemplateInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.get_template_output.GetTemplateOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.get_template.get_template(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_template_summary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.get_template_summary_input.GetTemplateSummaryInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.get_template_summary_output.GetTemplateSummaryOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.get_template_summary.get_template_summary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def import_stacks_to_stack_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.import_stacks_to_stack_set_input.ImportStacksToStackSetInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.import_stacks_to_stack_set_output.ImportStacksToStackSetOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.import_stacks_to_stack_set.import_stacks_to_stack_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_change_sets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_change_sets_input.ListChangeSetsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_change_sets_output.ListChangeSetsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_change_sets.list_change_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.change_set_summary.ChangeSetSummary]":
        _token = next_token
        while True:
    ...
    def list_exports(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_exports_input.ListExportsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_exports_output.ListExportsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_exports.list_exports(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.export.Export]":
        _token = next_token
        while True:
    ...
    def list_generated_templates(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_generated_templates_input.ListGeneratedTemplatesInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_generated_templates_output.ListGeneratedTemplatesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_generated_templates.list_generated_templates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_generated_templates(
        self,
        *,
        config_overrides: Optional[CloudFormationClientConfig] = None,
        next_token: Optional[
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.template_summary.TemplateSummary]":
        _token = next_token
        while True:
            _response = self.list_generated_templates(
                config_overrides=config_overrides,
                next_token=_token,
    ...
    def list_hook_results(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_hook_results_input.ListHookResultsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_hook_results_output.ListHookResultsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_hook_results.list_hook_results(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_imports(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_imports_input.ListImportsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_imports_output.ListImportsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_imports.list_imports(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.stack_name.StackName]":
        _token = next_token
        while True:
    ...
    def list_resource_scan_related_resources(
        ...
        *,
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_resource_scan_related_resources.list_resource_scan_related_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.scanned_resource.ScannedResource]":
        _token = next_token
        while True:
    ...
    def list_resource_scan_resources(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_resource_scan_resources(resource_scan_id='arn:aws:cloudformation:us-east-1:123456789012:resourceScan/c19304f6-c4f1-4ff8-8e1f-35162e41d7e1')
            ...
            >>> client.list_resource_scan_resources(resource_scan_id='arn:aws:cloudformation:us-east-1:123456789012:resourceScan/c19304f6-c4f1-4ff8-8e1f-35162e41d7e1', resource_type_prefix='AWS::S3')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_resource_scan_resources_input.ListResourceScanResourcesInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_resource_scan_resources_output.ListResourceScanResourcesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_resource_scan_resources.list_resource_scan_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_resource_scans(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_resource_scans_input.ListResourceScansInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_resource_scans_output.ListResourceScansOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_resource_scans.list_resource_scans(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.resource_scan_summary.ResourceScanSummary]":
        _token = next_token
        while True:
            _response = self.list_resource_scans(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def list_stack_instance_resource_drifts(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_stack_instance_resource_drifts_input.ListStackInstanceResourceDriftsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_stack_instance_resource_drifts_output.ListStackInstanceResourceDriftsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_stack_instance_resource_drifts.list_stack_instance_resource_drifts(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_stack_instances(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_stack_instances_input.ListStackInstancesInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_stack_instances_output.ListStackInstancesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_stack_instances.list_stack_instances(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_stack_instances(
        ...
        *,
        ...
        call_as: Optional["aws_sdk_cloudformation.types.call_as.CallAs"] = None,
    ) -> "Iterator[aws_sdk_cloudformation.types.stack_instance_summary.StackInstanceSummary]":
        _token = next_token
        while True:
    ...
    def list_stack_refactor_actions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_stack_refactor_actions_input.ListStackRefactorActionsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_stack_refactor_actions_output.ListStackRefactorActionsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_stack_refactor_actions.list_stack_refactor_actions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.stack_refactor_action.StackRefactorAction]":
        _token = next_token
        while True:
    ...
    def list_stack_refactors(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_stack_refactors_input.ListStackRefactorsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_stack_refactors_output.ListStackRefactorsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_stack_refactors.list_stack_refactors(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.stack_refactor_summary.StackRefactorSummary]":
        _token = next_token
        while True:
            _response = self.list_stack_refactors(
                config_overrides=config_overrides,
    ...
    def list_stack_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_stack_resources_input.ListStackResourcesInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_stack_resources_output.ListStackResourcesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_stack_resources.list_stack_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.stack_resource_summary.StackResourceSummary]":
        _token = next_token
        while True:
    ...
    def list_stacks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_stacks_input.ListStacksInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_stacks_output.ListStacksOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_stacks.list_stacks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.stack_summary.StackSummary]":
        _token = next_token
        while True:
            _response = self.list_stacks(
                config_overrides=config_overrides,
                next_token=_token,
    ...
    def list_stack_set_auto_deployment_targets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_stack_set_auto_deployment_targets_input.ListStackSetAutoDeploymentTargetsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_stack_set_auto_deployment_targets_output.ListStackSetAutoDeploymentTargetsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_stack_set_auto_deployment_targets.list_stack_set_auto_deployment_targets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_stack_set_operation_results(
        ...
        *,
        ...
        """<p>Returns summary information about the results of a StackSet operation.</p> <note> <p>This API provides <i>eventually consistent</i> reads meaning it may take some time but will eventually return the most up-to-date data.</p> </note>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_stack_set_operation_results_input.ListStackSetOperationResultsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_stack_set_operation_results_output.ListStackSetOperationResultsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_stack_set_operation_results.list_stack_set_operation_results(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.stack_set_operation_result_summary.StackSetOperationResultSummary]":
        _token = next_token
        while True:
    ...
    def list_stack_set_operations(
        ...
        *,
        ...
        """<p>Returns summary information about operations performed on a StackSet.</p> <note> <p>This API provides <i>eventually consistent</i> reads meaning it may take some time but will eventually return the most up-to-date data.</p> </note>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_stack_set_operations_input.ListStackSetOperationsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_stack_set_operations_output.ListStackSetOperationsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_stack_set_operations.list_stack_set_operations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_stack_set_operations(
        ...
        *,
        ...
        call_as: Optional["aws_sdk_cloudformation.types.call_as.CallAs"] = None,
    ) -> "Iterator[aws_sdk_cloudformation.types.stack_set_operation_summary.StackSetOperationSummary]":
        _token = next_token
        while True:
    ...
    def list_stack_sets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_stack_sets_input.ListStackSetsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_stack_sets_output.ListStackSetsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_stack_sets.list_stack_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_stack_sets(
        ...
        *,
        ...
        call_as: Optional["aws_sdk_cloudformation.types.call_as.CallAs"] = None,
    ) -> "Iterator[aws_sdk_cloudformation.types.stack_set_summary.StackSetSummary]":
        _token = next_token
        while True:
            _response = self.list_stack_sets(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
                status=status,
    ...
    def list_type_registrations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_type_registrations_input.ListTypeRegistrationsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_type_registrations_output.ListTypeRegistrationsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_type_registrations.list_type_registrations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_types(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_types_input.ListTypesInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_types_output.ListTypesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_types.list_types(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_cloudformation.types.type_summary.TypeSummary]":
        _token = next_token
        while True:
    ...
    def list_type_versions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.list_type_versions_input.ListTypeVersionsInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.list_type_versions_output.ListTypeVersionsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.list_type_versions.list_type_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def publish_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.publish_type_input.PublishTypeInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.publish_type_output.PublishTypeOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.publish_type.publish_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def record_handler_progress(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.record_handler_progress_input.RecordHandlerProgressInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.record_handler_progress_output.RecordHandlerProgressOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.record_handler_progress.record_handler_progress(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_publisher(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.register_publisher_input.RegisterPublisherInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.register_publisher_output.RegisterPublisherOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.register_publisher.register_publisher(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.register_type_input.RegisterTypeInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.register_type_output.RegisterTypeOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.register_type.register_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def rollback_stack(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.rollback_stack_input.RollbackStackInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.rollback_stack_output.RollbackStackOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.rollback_stack.rollback_stack(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_stack_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.set_stack_policy_input.SetStackPolicyInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_cloudformation._operations.cloud_formation.set_stack_policy

            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.set_stack_policy.set_stack_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_type_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.set_type_configuration_input.SetTypeConfigurationInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.set_type_configuration_output.SetTypeConfigurationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.set_type_configuration.set_type_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_type_default_version(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.set_type_default_version_input.SetTypeDefaultVersionInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.set_type_default_version_output.SetTypeDefaultVersionOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.set_type_default_version.set_type_default_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def signal_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.signal_resource_input.SignalResourceInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_cloudformation._operations.cloud_formation.signal_resource

            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.signal_resource.signal_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_resource_scan(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.start_resource_scan_input.StartResourceScanInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.start_resource_scan_output.StartResourceScanOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.start_resource_scan.start_resource_scan(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_stack_set_operation(
        ...
        *,
        ...
        """<p>Stops an in-progress operation on a StackSet and its associated stack instances. StackSets will cancel all the unstarted stack instance deployments and wait for those are in-progress to complete.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.stop_stack_set_operation_input.StopStackSetOperationInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.stop_stack_set_operation_output.StopStackSetOperationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.stop_stack_set_operation.stop_stack_set_operation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def test_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.test_type_input.TestTypeInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.test_type_output.TestTypeOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.test_type.test_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_generated_template(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_generated_template(generated_template_name='JazzyTemplate', add_resources=[{'ResourceType': 'AWS::S3::Bucket', 'ResourceIdentifier': {'BucketName': 'jazz-bucket'}}, {'ResourceType': 'AWS::EC2::DHCPOptions', 'ResourceIdentifier': {'DhcpOptionsId': 'random-id123'}}])
            To update a generated template's name
            This example updates a generated template with a new name.

            >>> client.update_generated_template(generated_template_name='JazzyTemplate', new_generated_template_name='JazzierTemplate')
            To remove resources from a generated template
            This example removes resources from a generated template

            >>> client.update_generated_template(generated_template_name='JazzyTemplate', remove_resources=['LogicalResourceId1', 'LogicalResourceId2'])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.update_generated_template_input.UpdateGeneratedTemplateInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.update_generated_template_output.UpdateGeneratedTemplateOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.update_generated_template.update_generated_template(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_stack(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.update_stack_input.UpdateStackInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.update_stack_output.UpdateStackOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.update_stack.update_stack(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_stack_instances(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.update_stack_instances_input.UpdateStackInstancesInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.update_stack_instances_output.UpdateStackInstancesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.update_stack_instances.update_stack_instances(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_stack_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.update_stack_set_input.UpdateStackSetInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.update_stack_set_output.UpdateStackSetOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.update_stack_set.update_stack_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_termination_protection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.update_termination_protection_input.UpdateTerminationProtectionInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.update_termination_protection_output.UpdateTerminationProtectionOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.update_termination_protection.update_termination_protection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def validate_template(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cloudformation.types.validate_template_input.ValidateTemplateInput]",
        ) -> OperationResponse[
            "aws_sdk_cloudformation.types.validate_template_output.ValidateTemplateOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_cloudformation._operations.cloud_formation.validate_template.validate_template(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
