...
from aws_sdk_cloudformation._services._aws_config import aws_config
...
class CloudFormationClientConfig(TypedDict, total=False, closed=True):
...
class CloudFormationClient:
    ...
    def __init__(
        ...
        self._config = CloudFormationClientConfig(
            {
