"""Generated from Smithy shape ``com.amazonaws.cloudformation#ConcurrentResourcesLimitExceededException``."""
...
class ConcurrentResourcesLimitExceededException_(TypedDict, closed=True):
    message: NotRequired["capo_cloudformation.types.error_message.ErrorMessage"]


# --- awsQuery ser/de ---
def serialize_query(
    value: ConcurrentResourcesLimitExceededException_,
...
def deserialize_query(el: Element) -> ConcurrentResourcesLimitExceededException_:
    out: ConcurrentResourcesLimitExceededException_ = {}  # type: ignore[typeddict-item]
...
class ConcurrentResourcesLimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudformation#ConcurrentResourcesLimitExceededException``."""
