...
if TYPE_CHECKING:
    import capo_cloudformation.types.log_group_name
    import capo_cloudformation.types.role_arn2


class LoggingConfig(TypedDict, closed=True):
    log_role_arn: NotRequired["capo_cloudformation.types.role_arn2.RoleARN2"]
    ...
    log_group_name: NotRequired["capo_cloudformation.types.log_group_name.LogGroupName"]
