...
if TYPE_CHECKING:
    ...
    import capo_cloudformation.types.export_value
    import capo_cloudformation.types.stack_id


class Export(TypedDict, closed=True):
    exporting_stack_id: NotRequired["capo_cloudformation.types.stack_id.StackId"]
    """<p>The stack that contains the exported output name and value.</p>"""
    name: NotRequired["capo_cloudformation.types.export_name.ExportName"]
    ...
    value: NotRequired["capo_cloudformation.types.export_value.ExportValue"]
