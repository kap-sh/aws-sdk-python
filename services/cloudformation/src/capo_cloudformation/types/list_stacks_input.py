...
def serialize_query(
    ...
    if "stack_status_filter" in value:
        ...
        capo_cloudformation.types.stack_status_filter.serialize_query(
            value["stack_status_filter"], pairs, f"{key_prefix}StackStatusFilter"
        )
...
def deserialize_query(el: Element) -> ListStacksInput:
    ...
    if child_stack_status_filter is not None:
        ...
        out["stack_status_filter"] = (
            capo_cloudformation.types.stack_status_filter.deserialize_query(
