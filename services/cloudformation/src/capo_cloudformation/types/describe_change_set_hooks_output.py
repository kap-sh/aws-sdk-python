...
class DescribeChangeSetHooksOutput(TypedDict, closed=True):
    ...
    hooks: NotRequired["capo_cloudformation.types.change_set_hooks.ChangeSetHooks"]
...
def deserialize_query(el: Element) -> DescribeChangeSetHooksOutput:
    ...
    if child_hooks is not None:
        ...
        out["hooks"] = capo_cloudformation.types.change_set_hooks.deserialize_query(
            child_hooks
        )
    ...
    if child_status is not None:
        ...
        out["status"] = (
            capo_cloudformation.types.change_set_hooks_status.deserialize_query(
                child_status
            )
        )
