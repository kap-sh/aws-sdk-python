"""Generated from Smithy shape ``com.amazonaws.cloudformation#RollbackStackOutput``."""
...
class RollbackStackOutput(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: RollbackStackOutput, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> RollbackStackOutput:
    out: RollbackStackOutput = {}  # type: ignore[typeddict-item]
