"""Generated from Smithy shape ``com.amazonaws.cloudformation#DeleteStackInstancesOutput``."""
...
class DeleteStackInstancesOutput(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DeleteStackInstancesOutput, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DeleteStackInstancesOutput:
    out: DeleteStackInstancesOutput = {}  # type: ignore[typeddict-item]
