"""Generated from Smithy shape ``com.amazonaws.cloudformation#EstimateTemplateCostInput``."""
...
class EstimateTemplateCostInput(TypedDict, closed=True):
    template_body: NotRequired["capo_cloudformation.types.template_body.TemplateBody"]
    """<p>Structure that contains the template body with a minimum length of 1 byte and a maximum length of 51,200 bytes.</p> <p>Conditional: You must pass <code>TemplateBody</code> or <code>TemplateURL</code>. If both are passed, only <code>TemplateBody</code> is used.</p>"""
...
def deserialize_query(el: Element) -> EstimateTemplateCostInput:
    out: EstimateTemplateCostInput = {}  # type: ignore[typeddict-item]
