...
if TYPE_CHECKING:
    import capo_cloudformation.types.treat_unrecognized_resource_types_as_warnings


class TemplateSummaryConfig(TypedDict, closed=True):
    treat_unrecognized_resource_types_as_warnings: NotRequired[
        "capo_cloudformation.types.treat_unrecognized_resource_types_as_warnings.TreatUnrecognizedResourceTypesAsWarnings"
    ]
