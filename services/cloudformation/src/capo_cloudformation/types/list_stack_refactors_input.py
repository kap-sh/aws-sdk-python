...
if TYPE_CHECKING:
    ...
    import capo_cloudformation.types.stack_refactor_execution_status_filter


class ListStackRefactorsInput(TypedDict, closed=True):
    execution_status_filter: NotRequired[
        "capo_cloudformation.types.stack_refactor_execution_status_filter.StackRefactorExecutionStatusFilter"
    ]
...
def serialize_query(
    ...
    if "execution_status_filter" in value:
        ...
        capo_cloudformation.types.stack_refactor_execution_status_filter.serialize_query(
            value["execution_status_filter"],
            pairs,
            f"{key_prefix}ExecutionStatusFilter",
        )
...
def deserialize_query(el: Element) -> ListStackRefactorsInput:
    ...
    if child_execution_status_filter is not None:
        ...
        out["execution_status_filter"] = (
            capo_cloudformation.types.stack_refactor_execution_status_filter.deserialize_query(
