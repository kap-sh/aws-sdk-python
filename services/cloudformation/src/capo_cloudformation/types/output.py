...
if TYPE_CHECKING:
    ...
    import capo_cloudformation.types.output_key
    import capo_cloudformation.types.output_value


class Output(TypedDict, closed=True):
    output_key: NotRequired["capo_cloudformation.types.output_key.OutputKey"]
    """<p>The key associated with the output.</p>"""
    output_value: NotRequired["capo_cloudformation.types.output_value.OutputValue"]
