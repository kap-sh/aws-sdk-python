...
class ListTypesOutput(TypedDict, closed=True):
    type_summaries: NotRequired[
        "capo_cloudformation.types.type_summaries.TypeSummaries"
    ]
...
def serialize_query(
    ...
    if "type_summaries" in value:
        ...
        capo_cloudformation.types.type_summaries.serialize_query(
            value["type_summaries"], pairs, f"{key_prefix}TypeSummaries"
        )
...
def deserialize_query(el: Element) -> ListTypesOutput:
    ...
    if child_type_summaries is not None:
        ...
        out["type_summaries"] = (
            capo_cloudformation.types.type_summaries.deserialize_query(
