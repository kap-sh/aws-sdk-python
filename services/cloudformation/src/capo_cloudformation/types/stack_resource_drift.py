...
if TYPE_CHECKING:
    ...
    import capo_cloudformation.types.properties
    ...
    import capo_cloudformation.types.stack_resource_drift_status_reason
...
class StackResourceDrift(TypedDict, closed=True):
    ...
    expected_properties: NotRequired["capo_cloudformation.types.properties.Properties"]
    ...
    actual_properties: NotRequired["capo_cloudformation.types.properties.Properties"]
    ...
    drift_status_reason: NotRequired[
        "capo_cloudformation.types.stack_resource_drift_status_reason.StackResourceDriftStatusReason"
    ]
...
def serialize_query(
    ...
    if "expected_properties" in value:
        pairs.append(
            (f"{key_prefix}ExpectedProperties", str(value["expected_properties"]))
        )
    if "actual_properties" in value:
        pairs.append((f"{key_prefix}ActualProperties", str(value["actual_properties"])))
    ...
    if "drift_status_reason" in value:
        pairs.append(
            (f"{key_prefix}DriftStatusReason", str(value["drift_status_reason"]))
        )
