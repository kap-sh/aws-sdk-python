"""Generated from Smithy shape ``com.amazonaws.cloudformation#ScannedResources``."""
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ScannedResources, pairs: list[tuple[str, str]], prefix: str
) -> None:
    import capo_cloudformation.types.scanned_resource
...
def deserialize_query(el: Element) -> ScannedResources:
    import capo_cloudformation.types.scanned_resource
...
def deserialize_query_flat(parent: Element, tag: str) -> ScannedResources:
    import capo_cloudformation.types.scanned_resource
