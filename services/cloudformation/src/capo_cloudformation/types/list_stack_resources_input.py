...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListStackResourcesInput, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ListStackResourcesInput:
    out: ListStackResourcesInput = {}  # type: ignore[typeddict-item]
