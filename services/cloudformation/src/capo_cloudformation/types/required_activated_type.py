...
def deserialize_query(el: Element) -> RequiredActivatedType:
    ...
    if child_supported_major_versions is not None:
        ...
        out["supported_major_versions"] = (
            capo_cloudformation.types.supported_major_versions.deserialize_query(
