...
class ListTypesInput(TypedDict, closed=True):
    ...
    filters: NotRequired["capo_cloudformation.types.type_filters.TypeFilters"]
...
def serialize_query(
    ...
    if "filters" in value:
        ...
        capo_cloudformation.types.type_filters.serialize_query(
...
def deserialize_query(el: Element) -> ListTypesInput:
    ...
    if child_filters is not None:
        ...
        out["filters"] = capo_cloudformation.types.type_filters.deserialize_query(
            child_filters
        )
