...
if TYPE_CHECKING:
    ...
    import capo_cloudformation.types.event_id
    ...
    import capo_cloudformation.types.hook_type
    ...
    import capo_cloudformation.types.resource_properties
    ...
    import capo_cloudformation.types.validation_name
    import capo_cloudformation.types.validation_path
    import capo_cloudformation.types.validation_status
    import capo_cloudformation.types.validation_status_reason


class OperationEvent(TypedDict, closed=True):
    event_id: NotRequired["capo_cloudformation.types.event_id.EventId"]
    ...
    operation_status: NotRequired[
        "capo_cloudformation.types.beacon_stack_operation_status.BeaconStackOperationStatus"
    ]
    """<p>The current status of the operation.</p>"""
    event_type: NotRequired["capo_cloudformation.types.event_type.EventType"]
    ...
    resource_properties: NotRequired[
        "capo_cloudformation.types.resource_properties.ResourceProperties"
    ]
    ...
    hook_type: NotRequired["capo_cloudformation.types.hook_type.HookType"]
    """<p>The type name of the Hook that was invoked.</p>"""
    hook_status: NotRequired["capo_cloudformation.types.hook_status.HookStatus"]
    ...
    validation_name: NotRequired[
        "capo_cloudformation.types.validation_name.ValidationName"
    ]
    """<p>The name of the validation that was performed.</p>"""
    validation_status: NotRequired[
        "capo_cloudformation.types.validation_status.ValidationStatus"
    ]
    """<p>The status of the validation.</p>"""
    validation_status_reason: NotRequired[
        "capo_cloudformation.types.validation_status_reason.ValidationStatusReason"
    ]
    """<p>Additional information about the validation status.</p>"""
    validation_path: NotRequired[
        "capo_cloudformation.types.validation_path.ValidationPath"
    ]
...
def deserialize_query(el: Element) -> OperationEvent:
    ...
    if child_operation_status is not None:
        ...
        out["operation_status"] = (
            capo_cloudformation.types.beacon_stack_operation_status.deserialize_query(
    ...
    if child_event_type is not None:
        ...
        out["event_type"] = capo_cloudformation.types.event_type.deserialize_query(
            child_event_type
        )
    ...
    if child_hook_status is not None:
        ...
        out["hook_status"] = capo_cloudformation.types.hook_status.deserialize_query(
            child_hook_status
        )
    ...
    if child_validation_status is not None:
        ...
        out["validation_status"] = (
            capo_cloudformation.types.validation_status.deserialize_query(
