"""Generated from Smithy shape ``com.amazonaws.cloudformation#DeleteGeneratedTemplateInput``."""
...
class DeleteGeneratedTemplateInput(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> DeleteGeneratedTemplateInput:
    out: DeleteGeneratedTemplateInput = {}  # type: ignore[typeddict-item]
