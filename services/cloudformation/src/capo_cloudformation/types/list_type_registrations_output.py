...
if TYPE_CHECKING:
    ...
    import capo_cloudformation.types.registration_token_list


class ListTypeRegistrationsOutput(TypedDict, closed=True):
    registration_token_list: NotRequired[
        "capo_cloudformation.types.registration_token_list.RegistrationTokenList"
    ]
...
def serialize_query(
    ...
    if "registration_token_list" in value:
        ...
        capo_cloudformation.types.registration_token_list.serialize_query(
            value["registration_token_list"],
            pairs,
            f"{key_prefix}RegistrationTokenList",
        )
...
def deserialize_query(el: Element) -> ListTypeRegistrationsOutput:
    ...
    if child_registration_token_list is not None:
        ...
        out["registration_token_list"] = (
            capo_cloudformation.types.registration_token_list.deserialize_query(
