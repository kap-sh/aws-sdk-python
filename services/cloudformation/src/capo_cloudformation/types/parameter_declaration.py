...
if TYPE_CHECKING:
    ...
    import capo_cloudformation.types.parameter_type
...
class ParameterDeclaration(TypedDict, closed=True):
    ...
    parameter_type: NotRequired[
        "capo_cloudformation.types.parameter_type.ParameterType"
    ]
...
def deserialize_query(el: Element) -> ParameterDeclaration:
    ...
    if child_parameter_constraints is not None:
        ...
        out["parameter_constraints"] = (
            capo_cloudformation.types.parameter_constraints.deserialize_query(
