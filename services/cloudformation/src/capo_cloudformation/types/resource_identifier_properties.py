...
if TYPE_CHECKING:
    ...
    import capo_cloudformation.types.resource_identifier_property_value
...
ResourceIdentifierProperties: TypeAlias = dict[
    ...
    "capo_cloudformation.types.resource_identifier_property_value.ResourceIdentifierPropertyValue",
]
