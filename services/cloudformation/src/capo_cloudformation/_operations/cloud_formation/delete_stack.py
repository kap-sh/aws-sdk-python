"""Generated from Smithy shape ``com.amazonaws.cloudformation#DeleteStack``."""
...
def build_request(
    ...
    pairs.append(("Action", "DeleteStack"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.delete_stack_input.serialize_query(input_, pairs, "")
