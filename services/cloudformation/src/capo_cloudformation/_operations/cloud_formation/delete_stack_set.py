"""Generated from Smithy shape ``com.amazonaws.cloudformation#DeleteStackSet``."""
...
import capo_cloudformation.errors.stack_set_not_empty_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "StackSetNotEmptyException":
            raise capo_cloudformation.errors.stack_set_not_empty_exception.StackSetNotEmptyException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteStackSetResult")
    out: capo_cloudformation.types.delete_stack_set_output.DeleteStackSetOutput = (
        capo_cloudformation.types.delete_stack_set_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteStackSet"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.delete_stack_set_input.serialize_query(input_, pairs, "")
