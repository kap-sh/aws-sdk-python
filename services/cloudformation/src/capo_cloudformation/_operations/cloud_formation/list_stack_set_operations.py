"""Generated from Smithy shape ``com.amazonaws.cloudformation#ListStackSetOperations``."""
...
import capo_cloudformation.types.list_stack_set_operations_input
import capo_cloudformation.types.list_stack_set_operations_output
import capo_cloudformation.types.stack_set_operation_summaries
...
) -> capo_cloudformation.types.list_stack_set_operations_output.ListStackSetOperationsOutput:
    root = fromstring(response.read())
    result = root.find("ListStackSetOperationsResult")
    out: capo_cloudformation.types.list_stack_set_operations_output.ListStackSetOperationsOutput = capo_cloudformation.types.list_stack_set_operations_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListStackSetOperations"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.list_stack_set_operations_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_stack_set_operations(
