"""Generated from Smithy shape ``com.amazonaws.cloudformation#ListChangeSets``."""
...
import capo_cloudformation.types.list_change_sets_input
import capo_cloudformation.types.list_change_sets_output
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListChangeSetsResult")
    out: capo_cloudformation.types.list_change_sets_output.ListChangeSetsOutput = (
        capo_cloudformation.types.list_change_sets_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListChangeSets"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.list_change_sets_input.serialize_query(input_, pairs, "")
...
async def async_list_change_sets(
