"""Generated from Smithy shape ``com.amazonaws.cloudformation#DescribeAccountLimits``."""
...
import capo_cloudformation.types.describe_account_limits_input
import capo_cloudformation.types.describe_account_limits_output
...
def handle_response(
    ...
    capo_cloudformation.types.describe_account_limits_output.DescribeAccountLimitsOutput
):
    root = fromstring(response.read())
    result = root.find("DescribeAccountLimitsResult")
    out: capo_cloudformation.types.describe_account_limits_output.DescribeAccountLimitsOutput = capo_cloudformation.types.describe_account_limits_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.describe_account_limits_input.serialize_query(
        input_, pairs, ""
    )
