"""Generated from Smithy shape ``com.amazonaws.cloudformation#CreateGeneratedTemplate``."""
...
import capo_cloudformation.types.create_generated_template_input
import capo_cloudformation.types.create_generated_template_output
...
) -> capo_cloudformation.types.create_generated_template_output.CreateGeneratedTemplateOutput:
    root = fromstring(response.read())
    result = root.find("CreateGeneratedTemplateResult")
    out: capo_cloudformation.types.create_generated_template_output.CreateGeneratedTemplateOutput = capo_cloudformation.types.create_generated_template_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateGeneratedTemplate"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.create_generated_template_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_generated_template(
