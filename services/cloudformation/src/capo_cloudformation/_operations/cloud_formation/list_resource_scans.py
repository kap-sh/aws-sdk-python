"""Generated from Smithy shape ``com.amazonaws.cloudformation#ListResourceScans``."""
...
import capo_cloudformation.types.list_resource_scans_input
import capo_cloudformation.types.list_resource_scans_output
import capo_cloudformation.types.resource_scan_summaries
...
) -> capo_cloudformation.types.list_resource_scans_output.ListResourceScansOutput:
    root = fromstring(response.read())
    result = root.find("ListResourceScansResult")
    out: capo_cloudformation.types.list_resource_scans_output.ListResourceScansOutput = capo_cloudformation.types.list_resource_scans_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.list_resource_scans_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_resource_scans(
