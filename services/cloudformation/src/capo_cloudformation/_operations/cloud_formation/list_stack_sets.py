...
import capo_cloudformation.types.list_stack_sets_input
import capo_cloudformation.types.list_stack_sets_output
...
) -> capo_cloudformation.types.list_stack_sets_output.ListStackSetsOutput:
    root = fromstring(response.read())
    result = root.find("ListStackSetsResult")
    out: capo_cloudformation.types.list_stack_sets_output.ListStackSetsOutput = (
        capo_cloudformation.types.list_stack_sets_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.list_stack_sets_input.serialize_query(input_, pairs, "")
