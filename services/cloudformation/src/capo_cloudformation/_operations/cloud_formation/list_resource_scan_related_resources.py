...
import capo_cloudformation.types.list_resource_scan_related_resources_input
import capo_cloudformation.types.list_resource_scan_related_resources_output
...
) -> capo_cloudformation.types.list_resource_scan_related_resources_output.ListResourceScanRelatedResourcesOutput:
    root = fromstring(response.read())
    result = root.find("ListResourceScanRelatedResourcesResult")
    out: capo_cloudformation.types.list_resource_scan_related_resources_output.ListResourceScanRelatedResourcesOutput = capo_cloudformation.types.list_resource_scan_related_resources_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.list_resource_scan_related_resources_input.serialize_query(
        input_, pairs, ""
    )
