"""Generated from Smithy shape ``com.amazonaws.cloudformation#DeactivateType``."""
...
import capo_cloudformation.types.deactivate_type_input
import capo_cloudformation.types.deactivate_type_output
...
) -> capo_cloudformation.types.deactivate_type_output.DeactivateTypeOutput:
    root = fromstring(response.read())
    result = root.find("DeactivateTypeResult")
    out: capo_cloudformation.types.deactivate_type_output.DeactivateTypeOutput = (
        capo_cloudformation.types.deactivate_type_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.deactivate_type_input.serialize_query(input_, pairs, "")
...
async def async_deactivate_type(
