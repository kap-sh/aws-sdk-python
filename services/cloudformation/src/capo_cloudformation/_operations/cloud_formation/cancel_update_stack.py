"""Generated from Smithy shape ``com.amazonaws.cloudformation#CancelUpdateStack``."""
...
import capo_cloudformation.types.cancel_update_stack_input
...
def build_request(
    ...
    pairs.append(("Action", "CancelUpdateStack"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.cancel_update_stack_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_cancel_update_stack(
