"""Generated from Smithy shape ``com.amazonaws.cloudformation#GetTemplateSummary``."""
...
import capo_cloudformation.types.get_template_summary_input
import capo_cloudformation.types.get_template_summary_output
...
) -> capo_cloudformation.types.get_template_summary_output.GetTemplateSummaryOutput:
    root = fromstring(response.read())
    result = root.find("GetTemplateSummaryResult")
    out: capo_cloudformation.types.get_template_summary_output.GetTemplateSummaryOutput = capo_cloudformation.types.get_template_summary_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetTemplateSummary"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.get_template_summary_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_template_summary(
