"""Generated from Smithy shape ``com.amazonaws.cloudformation#DescribeOrganizationsAccess``."""
...
import capo_cloudformation.types.describe_organizations_access_input
import capo_cloudformation.types.describe_organizations_access_output
...
) -> capo_cloudformation.types.describe_organizations_access_output.DescribeOrganizationsAccessOutput:
    root = fromstring(response.read())
    result = root.find("DescribeOrganizationsAccessResult")
    out: capo_cloudformation.types.describe_organizations_access_output.DescribeOrganizationsAccessOutput = capo_cloudformation.types.describe_organizations_access_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeOrganizationsAccess"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.describe_organizations_access_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_organizations_access(
