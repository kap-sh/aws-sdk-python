"""Generated from Smithy shape ``com.amazonaws.cloudformation#ListTypes``."""
...
import capo_cloudformation.types.list_types_input
import capo_cloudformation.types.list_types_output
import capo_cloudformation.types.provisioning_type
import capo_cloudformation.types.registry_type
import capo_cloudformation.types.type_filters
import capo_cloudformation.types.type_summaries
...
) -> capo_cloudformation.types.list_types_output.ListTypesOutput:
    root = fromstring(response.read())
    result = root.find("ListTypesResult")
    out: capo_cloudformation.types.list_types_output.ListTypesOutput = (
        capo_cloudformation.types.list_types_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListTypes"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.list_types_input.serialize_query(input_, pairs, "")
...
def list_types(
    ...
    capo_cloudformation.types.list_types_output.ListTypesOutput, zapros.Response
]:
