"""Generated from Smithy shape ``com.amazonaws.cloudformation#DescribeStackSetOperation``."""
...
import capo_cloudformation.types.describe_stack_set_operation_input
import capo_cloudformation.types.describe_stack_set_operation_output
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeStackSetOperationResult")
    out: capo_cloudformation.types.describe_stack_set_operation_output.DescribeStackSetOperationOutput = capo_cloudformation.types.describe_stack_set_operation_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeStackSetOperation"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.describe_stack_set_operation_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_stack_set_operation(
