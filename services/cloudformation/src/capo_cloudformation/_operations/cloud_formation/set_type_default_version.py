"""Generated from Smithy shape ``com.amazonaws.cloudformation#SetTypeDefaultVersion``."""
...
import capo_cloudformation.types.set_type_default_version_input
import capo_cloudformation.types.set_type_default_version_output
...
) -> capo_cloudformation.types.set_type_default_version_output.SetTypeDefaultVersionOutput:
    root = fromstring(response.read())
    result = root.find("SetTypeDefaultVersionResult")
    out: capo_cloudformation.types.set_type_default_version_output.SetTypeDefaultVersionOutput = capo_cloudformation.types.set_type_default_version_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "SetTypeDefaultVersion"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.set_type_default_version_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_set_type_default_version(
