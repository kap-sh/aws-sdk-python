"""Generated from Smithy shape ``com.amazonaws.cloudformation#ActivateType``."""
...
import capo_cloudformation.types.activate_type_input
import capo_cloudformation.types.activate_type_output
...
) -> capo_cloudformation.types.activate_type_output.ActivateTypeOutput:
    root = fromstring(response.read())
    result = root.find("ActivateTypeResult")
    out: capo_cloudformation.types.activate_type_output.ActivateTypeOutput = (
        capo_cloudformation.types.activate_type_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ActivateType"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.activate_type_input.serialize_query(input_, pairs, "")
...
def activate_type(
    ...
    capo_cloudformation.types.activate_type_output.ActivateTypeOutput, zapros.Response
]:
