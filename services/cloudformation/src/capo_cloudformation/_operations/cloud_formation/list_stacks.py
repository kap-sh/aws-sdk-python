"""Generated from Smithy shape ``com.amazonaws.cloudformation#ListStacks``."""
...
import capo_cloudformation.types.list_stacks_input
import capo_cloudformation.types.list_stacks_output
import capo_cloudformation.types.stack_status_filter
...
) -> capo_cloudformation.types.list_stacks_output.ListStacksOutput:
    root = fromstring(response.read())
    result = root.find("ListStacksResult")
    out: capo_cloudformation.types.list_stacks_output.ListStacksOutput = (
        capo_cloudformation.types.list_stacks_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListStacks"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.list_stacks_input.serialize_query(input_, pairs, "")
...
def list_stacks(
    ...
    capo_cloudformation.types.list_stacks_output.ListStacksOutput, zapros.Response
]:
