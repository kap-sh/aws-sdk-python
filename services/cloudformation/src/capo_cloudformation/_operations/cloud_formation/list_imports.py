"""Generated from Smithy shape ``com.amazonaws.cloudformation#ListImports``."""
...
import capo_cloudformation.types.list_imports_input
import capo_cloudformation.types.list_imports_output
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListImportsResult")
    out: capo_cloudformation.types.list_imports_output.ListImportsOutput = (
        capo_cloudformation.types.list_imports_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListImports"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.list_imports_input.serialize_query(input_, pairs, "")
...
def list_imports(
    ...
    capo_cloudformation.types.list_imports_output.ListImportsOutput, zapros.Response
]:
