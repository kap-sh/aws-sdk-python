"""Generated from Smithy shape ``com.amazonaws.cloudformation#RegisterType``."""
...
import capo_cloudformation.types.register_type_input
import capo_cloudformation.types.register_type_output
...
) -> capo_cloudformation.types.register_type_output.RegisterTypeOutput:
    root = fromstring(response.read())
    result = root.find("RegisterTypeResult")
    out: capo_cloudformation.types.register_type_output.RegisterTypeOutput = (
        capo_cloudformation.types.register_type_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "RegisterType"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.register_type_input.serialize_query(input_, pairs, "")
...
def register_type(
    ...
    capo_cloudformation.types.register_type_output.RegisterTypeOutput, zapros.Response
]:
