"""Generated from Smithy shape ``com.amazonaws.cloudformation#UpdateGeneratedTemplate``."""
...
import capo_cloudformation.types.update_generated_template_input
import capo_cloudformation.types.update_generated_template_output
...
) -> capo_cloudformation.types.update_generated_template_output.UpdateGeneratedTemplateOutput:
    root = fromstring(response.read())
    result = root.find("UpdateGeneratedTemplateResult")
    out: capo_cloudformation.types.update_generated_template_output.UpdateGeneratedTemplateOutput = capo_cloudformation.types.update_generated_template_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "UpdateGeneratedTemplate"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.update_generated_template_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_update_generated_template(
