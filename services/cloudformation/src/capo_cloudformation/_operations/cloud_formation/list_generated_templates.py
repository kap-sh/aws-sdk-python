"""Generated from Smithy shape ``com.amazonaws.cloudformation#ListGeneratedTemplates``."""
...
import capo_cloudformation.types.list_generated_templates_input
import capo_cloudformation.types.list_generated_templates_output
...
) -> capo_cloudformation.types.list_generated_templates_output.ListGeneratedTemplatesOutput:
    root = fromstring(response.read())
    result = root.find("ListGeneratedTemplatesResult")
    out: capo_cloudformation.types.list_generated_templates_output.ListGeneratedTemplatesOutput = capo_cloudformation.types.list_generated_templates_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListGeneratedTemplates"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.list_generated_templates_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_generated_templates(
