"""Generated from Smithy shape ``com.amazonaws.cloudformation#DeleteGeneratedTemplate``."""
...
def build_request(
    ...
    capo_cloudformation.types.delete_generated_template_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_generated_template(
