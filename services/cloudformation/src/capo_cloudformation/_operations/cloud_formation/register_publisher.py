"""Generated from Smithy shape ``com.amazonaws.cloudformation#RegisterPublisher``."""
...
import capo_cloudformation.types.register_publisher_input
import capo_cloudformation.types.register_publisher_output
...
) -> capo_cloudformation.types.register_publisher_output.RegisterPublisherOutput:
    root = fromstring(response.read())
    result = root.find("RegisterPublisherResult")
    out: capo_cloudformation.types.register_publisher_output.RegisterPublisherOutput = (
        capo_cloudformation.types.register_publisher_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.register_publisher_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_register_publisher(
