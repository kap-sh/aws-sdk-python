...
from capo_cloudhsm._services._aws_config import aaws_config
...
class AsyncCloudHSMClientConfig(TypedDict, total=False, closed=True):
...
class AsyncCloudHSMClient:
    ...
    def __init__(
        ...
        self._config = AsyncCloudHSMClientConfig(
            {
    ...
    async def add_tags_to_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.add_tags_to_resource_request.AddTagsToResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.add_tags_to_resource_response.AddTagsToResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.add_tags_to_resource.async_add_tags_to_resource(
    ...
    async def create_hapg(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.create_hapg_request.CreateHapgRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.create_hapg_response.CreateHapgResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.create_hapg.async_create_hapg(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_hsm(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.create_hsm_request.CreateHsmRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.create_hsm_response.CreateHsmResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.create_hsm.async_create_hsm(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_luna_client(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.create_luna_client_request.CreateLunaClientRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.create_luna_client_response.CreateLunaClientResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.create_luna_client.async_create_luna_client(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_hapg(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.delete_hapg_request.DeleteHapgRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.delete_hapg_response.DeleteHapgResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.delete_hapg.async_delete_hapg(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_hsm(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.delete_hsm_request.DeleteHsmRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.delete_hsm_response.DeleteHsmResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.delete_hsm.async_delete_hsm(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_luna_client(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.delete_luna_client_request.DeleteLunaClientRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.delete_luna_client_response.DeleteLunaClientResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.delete_luna_client.async_delete_luna_client(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_hapg(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.describe_hapg_request.DescribeHapgRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.describe_hapg_response.DescribeHapgResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.describe_hapg.async_describe_hapg(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_hsm(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.describe_hsm_request.DescribeHsmRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.describe_hsm_response.DescribeHsmResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.describe_hsm.async_describe_hsm(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_luna_client(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.describe_luna_client_request.DescribeLunaClientRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.describe_luna_client_response.DescribeLunaClientResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.describe_luna_client.async_describe_luna_client(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.get_config_request.GetConfigRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.get_config_response.GetConfigResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.get_config.async_get_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_available_zones(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.list_available_zones_request.ListAvailableZonesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.list_available_zones_response.ListAvailableZonesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.list_available_zones.async_list_available_zones(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_hapgs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.list_hapgs_request.ListHapgsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.list_hapgs_response.ListHapgsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.list_hapgs.async_list_hapgs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_hsms(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.list_hsms_request.ListHsmsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.list_hsms_response.ListHsmsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.list_hsms.async_list_hsms(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_luna_clients(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.list_luna_clients_request.ListLunaClientsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.list_luna_clients_response.ListLunaClientsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.list_luna_clients.async_list_luna_clients(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_hapg(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.modify_hapg_request.ModifyHapgRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.modify_hapg_response.ModifyHapgResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.modify_hapg.async_modify_hapg(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_hsm(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.modify_hsm_request.ModifyHsmRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.modify_hsm_response.ModifyHsmResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.modify_hsm.async_modify_hsm(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def modify_luna_client(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.modify_luna_client_request.ModifyLunaClientRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.modify_luna_client_response.ModifyLunaClientResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.modify_luna_client.async_modify_luna_client(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_tags_from_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudhsm.types.remove_tags_from_resource_request.RemoveTagsFromResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudhsm.types.remove_tags_from_resource_response.RemoveTagsFromResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudhsm._operations.cloud_hsm_frontend_service.remove_tags_from_resource.async_remove_tags_from_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
