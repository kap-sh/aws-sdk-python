...
if TYPE_CHECKING:
    import capo_cloudhsm.types.az
    import capo_cloudhsm.types.eni_id
    ...
    import capo_cloudhsm.types.timestamp
    import capo_cloudhsm.types.vpc_id


class DescribeHsmResponse(TypedDict, closed=True):
    hsm_arn: NotRequired["capo_cloudhsm.types.hsm_arn.HsmArn"]
    """<p>The ARN of the HSM.</p>"""
    status: NotRequired["capo_cloudhsm.types.hsm_status.HsmStatus"]
    """<p>The status of the HSM.</p>"""
    status_details: NotRequired["capo_cloudhsm.types.string.String"]
    """<p>Contains additional information about the status of the HSM.</p>"""
    availability_zone: NotRequired["capo_cloudhsm.types.az.AZ"]
    """<p>The Availability Zone that the HSM is in.</p>"""
    eni_id: NotRequired["capo_cloudhsm.types.eni_id.EniId"]
    """<p>The identifier of the elastic network interface (ENI) attached to the HSM.</p>"""
    eni_ip: NotRequired["capo_cloudhsm.types.ip_address.IpAddress"]
    """<p>The IP address assigned to the HSM's ENI.</p>"""
    subscription_type: NotRequired[
        "capo_cloudhsm.types.subscription_type.SubscriptionType"
    ]
    subscription_start_date: NotRequired["capo_cloudhsm.types.timestamp.Timestamp"]
    """<p>The subscription start date.</p>"""
    subscription_end_date: NotRequired["capo_cloudhsm.types.timestamp.Timestamp"]
    """<p>The subscription end date.</p>"""
    vpc_id: NotRequired["capo_cloudhsm.types.vpc_id.VpcId"]
    """<p>The identifier of the VPC that the HSM is in.</p>"""
    subnet_id: NotRequired["capo_cloudhsm.types.subnet_id.SubnetId"]
    """<p>The identifier of the subnet that the HSM is in.</p>"""
    iam_role_arn: NotRequired["capo_cloudhsm.types.iam_role_arn.IamRoleArn"]
    """<p>The ARN of the IAM role assigned to the HSM.</p>"""
    serial_number: NotRequired["capo_cloudhsm.types.hsm_serial_number.HsmSerialNumber"]
    """<p>The serial number of the HSM.</p>"""
    vendor_name: NotRequired["capo_cloudhsm.types.string.String"]
    """<p>The name of the HSM vendor.</p>"""
    hsm_type: NotRequired["capo_cloudhsm.types.string.String"]
    """<p>The HSM model type.</p>"""
    software_version: NotRequired["capo_cloudhsm.types.string.String"]
    """<p>The HSM software version.</p>"""
    ssh_public_key: NotRequired["capo_cloudhsm.types.ssh_key.SshKey"]
    """<p>The public SSH key.</p>"""
    ssh_key_last_updated: NotRequired["capo_cloudhsm.types.timestamp.Timestamp"]
    """<p>The date and time that the SSH key was last updated.</p>"""
    server_cert_uri: NotRequired["capo_cloudhsm.types.string.String"]
    """<p>The URI of the certificate server.</p>"""
    server_cert_last_updated: NotRequired["capo_cloudhsm.types.timestamp.Timestamp"]
    """<p>The date and time that the server certificate was last updated.</p>"""
    partitions: NotRequired["capo_cloudhsm.types.partition_list.PartitionList"]
...
def serialize_aws_json_1_1(value: DescribeHsmResponse) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = capo_cloudhsm.types.hsm_status.serialize_aws_json_1_1(
            value["status"]
        )
    ...
    if "subscription_type" in value:
        ...
        out["SubscriptionType"] = (
            capo_cloudhsm.types.subscription_type.serialize_aws_json_1_1(
    ...
    if "partitions" in value:
        ...
        out["Partitions"] = capo_cloudhsm.types.partition_list.serialize_aws_json_1_1(
            value["partitions"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeHsmResponse:
    ...
    if "SubscriptionType" in data:
        ...
        out["subscription_type"] = (
            capo_cloudhsm.types.subscription_type.deserialize_aws_json_1_1(
