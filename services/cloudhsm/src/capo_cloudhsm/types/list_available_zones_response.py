...
class ListAvailableZonesResponse(TypedDict, closed=True):
    az_list: NotRequired["capo_cloudhsm.types.az_list.AZList"]
...
def serialize_aws_json_1_1(value: ListAvailableZonesResponse) -> dict:
    ...
    if "az_list" in value:
        ...
        out["AZList"] = capo_cloudhsm.types.az_list.serialize_aws_json_1_1(
            value["az_list"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListAvailableZonesResponse:
    ...
    if "AZList" in data:
        ...
        out["az_list"] = capo_cloudhsm.types.az_list.deserialize_aws_json_1_1(
            data["AZList"]
        )
    return out
