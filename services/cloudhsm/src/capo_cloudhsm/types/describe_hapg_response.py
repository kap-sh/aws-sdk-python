...
class DescribeHapgResponse(TypedDict, closed=True):
    ...
    hapg_serial: NotRequired["capo_cloudhsm.types.string.String"]
    """<p>The serial number of the high-availability partition group.</p>"""
    hsms_last_action_failed: NotRequired["capo_cloudhsm.types.hsm_list.HsmList"]
    """<p></p>"""
    hsms_pending_deletion: NotRequired["capo_cloudhsm.types.hsm_list.HsmList"]
    """<p></p>"""
    hsms_pending_registration: NotRequired["capo_cloudhsm.types.hsm_list.HsmList"]
    """<p></p>"""
    label: NotRequired["capo_cloudhsm.types.label.Label"]
    """<p>The label for the high-availability partition group.</p>"""
    last_modified_timestamp: NotRequired["capo_cloudhsm.types.timestamp.Timestamp"]
    ...
    state: NotRequired["capo_cloudhsm.types.cloud_hsm_object_state.CloudHsmObjectState"]
...
def serialize_aws_json_1_1(value: DescribeHapgResponse) -> dict:
    ...
    if "hsms_last_action_failed" in value:
        ...
        out["HsmsLastActionFailed"] = (
            capo_cloudhsm.types.hsm_list.serialize_aws_json_1_1(
    ...
    if "state" in value:
        ...
        out["State"] = (
            capo_cloudhsm.types.cloud_hsm_object_state.serialize_aws_json_1_1(
                value["state"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeHapgResponse:
    ...
    if "HsmsLastActionFailed" in data:
        ...
        out["hsms_last_action_failed"] = (
            capo_cloudhsm.types.hsm_list.deserialize_aws_json_1_1(
    ...
    if "State" in data:
        ...
        out["state"] = (
            capo_cloudhsm.types.cloud_hsm_object_state.deserialize_aws_json_1_1(
                data["State"]
            )
        )
    return out
