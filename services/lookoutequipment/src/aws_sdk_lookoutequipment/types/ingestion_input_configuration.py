...
if TYPE_CHECKING:
    import aws_sdk_lookoutequipment.types.ingestion_s3_input_configuration


class IngestionInputConfiguration(TypedDict):
    s3_input_configuration: "aws_sdk_lookoutequipment.types.ingestion_s3_input_configuration.IngestionS3InputConfiguration"
...
def serialize_aws_json_1_0(value: IngestionInputConfiguration) -> dict:
    ...
    out["S3InputConfiguration"] = (
        aws_sdk_lookoutequipment.types.ingestion_s3_input_configuration.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> IngestionInputConfiguration:
    ...
    if "S3InputConfiguration" in data:
        ...
        out["s3_input_configuration"] = (
            aws_sdk_lookoutequipment.types.ingestion_s3_input_configuration.deserialize_aws_json_1_0(
