"""Generated from Smithy shape ``com.amazonaws.lookoutequipment#StopRetrainingSchedulerResponse``."""
...
class StopRetrainingSchedulerResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: StopRetrainingSchedulerResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> StopRetrainingSchedulerResponse:
    out: StopRetrainingSchedulerResponse = {}  # type: ignore[typeddict-item]
