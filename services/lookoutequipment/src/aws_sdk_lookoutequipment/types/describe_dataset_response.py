...
class DescribeDatasetResponse(TypedDict, closed=True):
    ...
    last_updated_at: NotRequired["aws_sdk_lookoutequipment.types.timestamp.Timestamp"]
    ...
    data_quality_summary: NotRequired[
        "aws_sdk_lookoutequipment.types.data_quality_summary.DataQualitySummary"
    ]
    ...
    ingested_files_summary: NotRequired[
        "aws_sdk_lookoutequipment.types.ingested_files_summary.IngestedFilesSummary"
    ]
    ...
    source_dataset_arn: NotRequired[
        "aws_sdk_lookoutequipment.types.dataset_arn.DatasetArn"
    ]
...
def serialize_aws_json_1_0(value: DescribeDatasetResponse) -> dict:
    ...
    if "data_quality_summary" in value:
        ...
        out["DataQualitySummary"] = (
            aws_sdk_lookoutequipment.types.data_quality_summary.serialize_aws_json_1_0(
    ...
    if "ingested_files_summary" in value:
        ...
        out["IngestedFilesSummary"] = (
            aws_sdk_lookoutequipment.types.ingested_files_summary.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DescribeDatasetResponse:
    ...
    if "DataQualitySummary" in data:
        ...
        out["data_quality_summary"] = (
            aws_sdk_lookoutequipment.types.data_quality_summary.deserialize_aws_json_1_0(
    ...
    if "IngestedFilesSummary" in data:
        ...
        out["ingested_files_summary"] = (
            aws_sdk_lookoutequipment.types.ingested_files_summary.deserialize_aws_json_1_0(
