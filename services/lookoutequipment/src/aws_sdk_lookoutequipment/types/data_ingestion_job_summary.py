...
class DataIngestionJobSummary(TypedDict):
    job_id: NotRequired[
    ...
    ingestion_input_configuration: NotRequired[
        "aws_sdk_lookoutequipment.types.ingestion_input_configuration.IngestionInputConfiguration"
    ]
...
def serialize_aws_json_1_0(value: DataIngestionJobSummary) -> dict:
    ...
    if "ingestion_input_configuration" in value:
        ...
        out["IngestionInputConfiguration"] = (
            aws_sdk_lookoutequipment.types.ingestion_input_configuration.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DataIngestionJobSummary:
    ...
    if "IngestionInputConfiguration" in data:
        ...
        out["ingestion_input_configuration"] = (
            aws_sdk_lookoutequipment.types.ingestion_input_configuration.deserialize_aws_json_1_0(
