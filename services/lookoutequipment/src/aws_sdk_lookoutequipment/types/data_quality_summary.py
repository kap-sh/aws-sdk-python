...
if TYPE_CHECKING:
    import aws_sdk_lookoutequipment.types.duplicate_timestamps
    import aws_sdk_lookoutequipment.types.insufficient_sensor_data
    import aws_sdk_lookoutequipment.types.invalid_sensor_data
    import aws_sdk_lookoutequipment.types.missing_sensor_data
    import aws_sdk_lookoutequipment.types.unsupported_timestamps


class DataQualitySummary(TypedDict, closed=True):
    insufficient_sensor_data: (
        "aws_sdk_lookoutequipment.types.insufficient_sensor_data.InsufficientSensorData"
    )
    ...
    missing_sensor_data: (
        "aws_sdk_lookoutequipment.types.missing_sensor_data.MissingSensorData"
    )
    """<p> Parameter that gives information about data that is missing over all the sensors in the input data. </p>"""
    invalid_sensor_data: (
        "aws_sdk_lookoutequipment.types.invalid_sensor_data.InvalidSensorData"
    )
    ...
    unsupported_timestamps: (
        "aws_sdk_lookoutequipment.types.unsupported_timestamps.UnsupportedTimestamps"
    )
    """<p> Parameter that gives information about unsupported timestamps in the input data. </p>"""
    duplicate_timestamps: (
        "aws_sdk_lookoutequipment.types.duplicate_timestamps.DuplicateTimestamps"
    )
...
def serialize_aws_json_1_0(value: DataQualitySummary) -> dict:
    ...
    out["InsufficientSensorData"] = (
        aws_sdk_lookoutequipment.types.insufficient_sensor_data.serialize_aws_json_1_0(
    ...
    out["MissingSensorData"] = (
        aws_sdk_lookoutequipment.types.missing_sensor_data.serialize_aws_json_1_0(
    ...
    out["InvalidSensorData"] = (
        aws_sdk_lookoutequipment.types.invalid_sensor_data.serialize_aws_json_1_0(
    ...
    out["UnsupportedTimestamps"] = (
        aws_sdk_lookoutequipment.types.unsupported_timestamps.serialize_aws_json_1_0(
    ...
    out["DuplicateTimestamps"] = (
        aws_sdk_lookoutequipment.types.duplicate_timestamps.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DataQualitySummary:
    ...
    if "InsufficientSensorData" in data:
        ...
        out["insufficient_sensor_data"] = (
            aws_sdk_lookoutequipment.types.insufficient_sensor_data.deserialize_aws_json_1_0(
    ...
    if "MissingSensorData" in data:
        ...
        out["missing_sensor_data"] = (
            aws_sdk_lookoutequipment.types.missing_sensor_data.deserialize_aws_json_1_0(
    ...
    if "InvalidSensorData" in data:
        ...
        out["invalid_sensor_data"] = (
            aws_sdk_lookoutequipment.types.invalid_sensor_data.deserialize_aws_json_1_0(
    ...
    if "UnsupportedTimestamps" in data:
        ...
        out["unsupported_timestamps"] = (
            aws_sdk_lookoutequipment.types.unsupported_timestamps.deserialize_aws_json_1_0(
    ...
    if "DuplicateTimestamps" in data:
        ...
        out["duplicate_timestamps"] = (
            aws_sdk_lookoutequipment.types.duplicate_timestamps.deserialize_aws_json_1_0(
