...
if TYPE_CHECKING:
    import aws_sdk_lookoutequipment.types.event_duration_in_seconds
...
class InferenceEventSummary(TypedDict):
    ...
    event_start_time: NotRequired["aws_sdk_lookoutequipment.types.timestamp.Timestamp"]
    """<p>Indicates the starting time of an inference event. </p>"""
    event_end_time: NotRequired["aws_sdk_lookoutequipment.types.timestamp.Timestamp"]
    ...
    event_duration_in_seconds: NotRequired[
        "aws_sdk_lookoutequipment.types.event_duration_in_seconds.EventDurationInSeconds"
    ]
