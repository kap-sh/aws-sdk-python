...
class LookoutEquipmentError(Exception):
    """Base class for all LookoutEquipment service errors."""


class ServiceError(LookoutEquipmentError):
...
class SerializationError(LookoutEquipmentError):
    """Raised when a value cannot be serialized."""


class DeserializationError(LookoutEquipmentError):
...
class WaiterFailedError(LookoutEquipmentError):
...
class WaiterTimeoutError(LookoutEquipmentError):
