"""Generated from Smithy shape ``com.amazonaws.lookoutequipment#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.lookoutequipment#ConflictException``."""
