...
from aws_sdk_lookoutequipment._services._aws_config import aws_config
...
class LookoutEquipmentClientConfig(TypedDict, total=False, closed=True):
...
class LookoutEquipmentClient:
    ...
    def __init__(
        ...
        self._config = LookoutEquipmentClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[LookoutEquipmentClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: LookoutEquipmentClientConfig = config_overrides or {}
    ...
    def create_dataset(
        ...
        *,
        config_overrides: Optional[LookoutEquipmentClientConfig] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.create_dataset_request.CreateDatasetRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.create_dataset_response.CreateDatasetResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.create_dataset.create_dataset(
    ...
    def create_inference_scheduler(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.create_inference_scheduler_request.CreateInferenceSchedulerRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.create_inference_scheduler_response.CreateInferenceSchedulerResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.create_inference_scheduler.create_inference_scheduler(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_label(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.create_label_request.CreateLabelRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.create_label_response.CreateLabelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.create_label.create_label(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_label_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.create_label_group_request.CreateLabelGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.create_label_group_response.CreateLabelGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.create_label_group.create_label_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_model(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.create_model_request.CreateModelRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.create_model_response.CreateModelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.create_model.create_model(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_retraining_scheduler(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_retraining_scheduler(model_name='sample-model', retraining_start_date='2024-01-01T00:00:00Z', retraining_frequency='P1M', lookback_window='P360D', client_token='sample-client-token')
            Creates a retraining scheduler with manual promote mode

            >>> client.create_retraining_scheduler(model_name='sample-model', retraining_frequency='P1M', lookback_window='P360D', promote_mode='MANUAL', client_token='sample-client-token')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.create_retraining_scheduler_request.CreateRetrainingSchedulerRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.create_retraining_scheduler_response.CreateRetrainingSchedulerResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.create_retraining_scheduler.create_retraining_scheduler(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_dataset(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.delete_dataset_request.DeleteDatasetRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_dataset

            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_dataset.delete_dataset(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_inference_scheduler(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.delete_inference_scheduler_request.DeleteInferenceSchedulerRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_inference_scheduler

            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_inference_scheduler.delete_inference_scheduler(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_label(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.delete_label_request.DeleteLabelRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_label

            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_label.delete_label(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_label_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.delete_label_group_request.DeleteLabelGroupRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_label_group

            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_label_group.delete_label_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_model(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.delete_model_request.DeleteModelRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_model

            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_model.delete_model(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.delete_resource_policy_request.DeleteResourcePolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_resource_policy

            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_resource_policy.delete_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_retraining_scheduler(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_retraining_scheduler(model_name='sample-model')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.delete_retraining_scheduler_request.DeleteRetrainingSchedulerRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_retraining_scheduler

            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.delete_retraining_scheduler.delete_retraining_scheduler(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_data_ingestion_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.describe_data_ingestion_job_request.DescribeDataIngestionJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.describe_data_ingestion_job_response.DescribeDataIngestionJobResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.describe_data_ingestion_job.describe_data_ingestion_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_dataset(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.describe_dataset_request.DescribeDatasetRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.describe_dataset_response.DescribeDatasetResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.describe_dataset.describe_dataset(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_inference_scheduler(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.describe_inference_scheduler_request.DescribeInferenceSchedulerRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.describe_inference_scheduler_response.DescribeInferenceSchedulerResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.describe_inference_scheduler.describe_inference_scheduler(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_label(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.describe_label_request.DescribeLabelRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.describe_label_response.DescribeLabelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.describe_label.describe_label(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_label_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.describe_label_group_request.DescribeLabelGroupRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.describe_label_group_response.DescribeLabelGroupResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.describe_label_group.describe_label_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_model(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.describe_model_request.DescribeModelRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.describe_model_response.DescribeModelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.describe_model.describe_model(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_model_version(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.describe_model_version_request.DescribeModelVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.describe_model_version_response.DescribeModelVersionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.describe_model_version.describe_model_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.describe_resource_policy_request.DescribeResourcePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.describe_resource_policy_response.DescribeResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.describe_resource_policy.describe_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_retraining_scheduler(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_retraining_scheduler(model_name='sample-model')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.describe_retraining_scheduler_request.DescribeRetrainingSchedulerRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.describe_retraining_scheduler_response.DescribeRetrainingSchedulerResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.describe_retraining_scheduler.describe_retraining_scheduler(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def import_dataset(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.import_dataset_request.ImportDatasetRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.import_dataset_response.ImportDatasetResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.import_dataset.import_dataset(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def import_model_version(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.import_model_version_request.ImportModelVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.import_model_version_response.ImportModelVersionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.import_model_version.import_model_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_data_ingestion_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.list_data_ingestion_jobs_request.ListDataIngestionJobsRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.list_data_ingestion_jobs_response.ListDataIngestionJobsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.list_data_ingestion_jobs.list_data_ingestion_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_datasets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.list_datasets_request.ListDatasetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.list_datasets_response.ListDatasetsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.list_datasets.list_datasets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_inference_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.list_inference_events_request.ListInferenceEventsRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.list_inference_events_response.ListInferenceEventsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.list_inference_events.list_inference_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_inference_executions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.list_inference_executions_request.ListInferenceExecutionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.list_inference_executions_response.ListInferenceExecutionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.list_inference_executions.list_inference_executions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_inference_schedulers(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.list_inference_schedulers_request.ListInferenceSchedulersRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.list_inference_schedulers_response.ListInferenceSchedulersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.list_inference_schedulers.list_inference_schedulers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_label_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.list_label_groups_request.ListLabelGroupsRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.list_label_groups_response.ListLabelGroupsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.list_label_groups.list_label_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_labels(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.list_labels_request.ListLabelsRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.list_labels_response.ListLabelsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.list_labels.list_labels(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_models(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.list_models_request.ListModelsRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.list_models_response.ListModelsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.list_models.list_models(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_model_versions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.list_model_versions_request.ListModelVersionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.list_model_versions_response.ListModelVersionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.list_model_versions.list_model_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_retraining_schedulers(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_retraining_schedulers(max_results=50)
        """

        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.list_retraining_schedulers_request.ListRetrainingSchedulersRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.list_retraining_schedulers_response.ListRetrainingSchedulersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.list_retraining_schedulers.list_retraining_schedulers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_sensor_statistics(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.list_sensor_statistics_request.ListSensorStatisticsRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.list_sensor_statistics_response.ListSensorStatisticsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.list_sensor_statistics.list_sensor_statistics(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.put_resource_policy_request.PutResourcePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.put_resource_policy_response.PutResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.put_resource_policy.put_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_data_ingestion_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.start_data_ingestion_job_request.StartDataIngestionJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.start_data_ingestion_job_response.StartDataIngestionJobResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.start_data_ingestion_job.start_data_ingestion_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_inference_scheduler(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.start_inference_scheduler_request.StartInferenceSchedulerRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.start_inference_scheduler_response.StartInferenceSchedulerResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.start_inference_scheduler.start_inference_scheduler(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_retraining_scheduler(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.start_retraining_scheduler(model_name='sample-model')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.start_retraining_scheduler_request.StartRetrainingSchedulerRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.start_retraining_scheduler_response.StartRetrainingSchedulerResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.start_retraining_scheduler.start_retraining_scheduler(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_inference_scheduler(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.stop_inference_scheduler_request.StopInferenceSchedulerRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.stop_inference_scheduler_response.StopInferenceSchedulerResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.stop_inference_scheduler.stop_inference_scheduler(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_retraining_scheduler(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.stop_retraining_scheduler(model_name='sample-model')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.stop_retraining_scheduler_request.StopRetrainingSchedulerRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.stop_retraining_scheduler_response.StopRetrainingSchedulerResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.stop_retraining_scheduler.stop_retraining_scheduler(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_active_model_version(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.update_active_model_version_request.UpdateActiveModelVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_lookoutequipment.types.update_active_model_version_response.UpdateActiveModelVersionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.update_active_model_version.update_active_model_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_inference_scheduler(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.update_inference_scheduler_request.UpdateInferenceSchedulerRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.update_inference_scheduler

            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.update_inference_scheduler.update_inference_scheduler(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_label_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.update_label_group_request.UpdateLabelGroupRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.update_label_group

            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.update_label_group.update_label_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_model(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_model(model_name='sample-model', labels_input_configuration={'LabelGroupName': 'sample-label-group'})
        """

        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.update_model_request.UpdateModelRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.update_model

            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.update_model.update_model(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_retraining_scheduler(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_retraining_scheduler(model_name='sample-model', retraining_start_date='2024-01-01T00:00:00Z', retraining_frequency='P1Y')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_lookoutequipment.types.update_retraining_scheduler_request.UpdateRetrainingSchedulerRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.update_retraining_scheduler

            output, http_response = (
                aws_sdk_lookoutequipment._operations.aws_lookout_equipment_frontend_service.update_retraining_scheduler.update_retraining_scheduler(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
