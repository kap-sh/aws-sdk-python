...
class InferenceExecutionSummary(TypedDict, closed=True):
    ...
    scheduled_start_time: NotRequired["capo_lookoutequipment.types.timestamp.Timestamp"]
...
def serialize_aws_json_1_0(value: InferenceExecutionSummary) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            capo_lookoutequipment.types.inference_execution_status.serialize_aws_json_1_0(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> InferenceExecutionSummary:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            capo_lookoutequipment.types.inference_execution_status.deserialize_aws_json_1_0(
                data["Status"]
            )
        )
