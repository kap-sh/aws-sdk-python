...
if TYPE_CHECKING:
    import capo_lookoutequipment.types.boolean
    import capo_lookoutequipment.types.categorical_values
    import capo_lookoutequipment.types.component_name
    ...
    import capo_lookoutequipment.types.sensor_name
...
class SensorStatisticsSummary(TypedDict, closed=True):
    ...
    categorical_values: NotRequired[
        "capo_lookoutequipment.types.categorical_values.CategoricalValues"
    ]
    ...
    multiple_operating_modes: NotRequired[
        "capo_lookoutequipment.types.multiple_operating_modes.MultipleOperatingModes"
    ]
    ...
    large_timestamp_gaps: NotRequired[
        "capo_lookoutequipment.types.large_timestamp_gaps.LargeTimestampGaps"
    ]
    ...
    monotonic_values: NotRequired[
        "capo_lookoutequipment.types.monotonic_values.MonotonicValues"
    ]
...
def serialize_aws_json_1_0(value: SensorStatisticsSummary) -> dict:
    ...
    if "missing_values" in value:
        ...
        out["MissingValues"] = (
            capo_lookoutequipment.types.count_percent.serialize_aws_json_1_0(
    ...
    if "categorical_values" in value:
        ...
        out["CategoricalValues"] = (
            capo_lookoutequipment.types.categorical_values.serialize_aws_json_1_0(
    ...
    if "multiple_operating_modes" in value:
        ...
        out["MultipleOperatingModes"] = (
            capo_lookoutequipment.types.multiple_operating_modes.serialize_aws_json_1_0(
    ...
    if "large_timestamp_gaps" in value:
        ...
        out["LargeTimestampGaps"] = (
            capo_lookoutequipment.types.large_timestamp_gaps.serialize_aws_json_1_0(
    ...
    if "monotonic_values" in value:
        ...
        out["MonotonicValues"] = (
            capo_lookoutequipment.types.monotonic_values.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> SensorStatisticsSummary:
    ...
    if "MissingValues" in data:
        ...
        out["missing_values"] = (
            capo_lookoutequipment.types.count_percent.deserialize_aws_json_1_0(
                data["MissingValues"]
            )
        )
    ...
    if "CategoricalValues" in data:
        ...
        out["categorical_values"] = (
            capo_lookoutequipment.types.categorical_values.deserialize_aws_json_1_0(
    ...
    if "MultipleOperatingModes" in data:
        ...
        out["multiple_operating_modes"] = (
            capo_lookoutequipment.types.multiple_operating_modes.deserialize_aws_json_1_0(
    ...
    if "LargeTimestampGaps" in data:
        ...
        out["large_timestamp_gaps"] = (
            capo_lookoutequipment.types.large_timestamp_gaps.deserialize_aws_json_1_0(
    ...
    if "MonotonicValues" in data:
        ...
        out["monotonic_values"] = (
            capo_lookoutequipment.types.monotonic_values.deserialize_aws_json_1_0(
