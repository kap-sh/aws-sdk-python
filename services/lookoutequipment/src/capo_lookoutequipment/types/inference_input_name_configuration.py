...
if TYPE_CHECKING:
    import capo_lookoutequipment.types.component_timestamp_delimiter
    import capo_lookoutequipment.types.file_name_timestamp_format


class InferenceInputNameConfiguration(TypedDict, closed=True):
    timestamp_format: NotRequired[
        "capo_lookoutequipment.types.file_name_timestamp_format.FileNameTimestampFormat"
    ]
    ...
    component_timestamp_delimiter: NotRequired[
        "capo_lookoutequipment.types.component_timestamp_delimiter.ComponentTimestampDelimiter"
    ]
