...
ListOfDiscardedFiles: TypeAlias = list["capo_lookoutequipment.types.s3_object.S3Object"]
...
def serialize_aws_json_1_0(value: ListOfDiscardedFiles) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_lookoutequipment.types.s3_object.serialize_aws_json_1_0(item))
    return out
...
def deserialize_aws_json_1_0(data: list) -> ListOfDiscardedFiles:
    ...
    for item in data:
        out.append(capo_lookoutequipment.types.s3_object.deserialize_aws_json_1_0(item))
    return out
