...
class ReactStartCodegenJobData(TypedDict, closed=True):
    module: NotRequired["capo_amplifyuibuilder.types.js_module.JSModule"]
    """<p>The JavaScript module type.</p>"""
    target: NotRequired["capo_amplifyuibuilder.types.js_target.JSTarget"]
    """<p>The ECMAScript specification to use.</p>"""
    script: NotRequired["capo_amplifyuibuilder.types.js_script.JSScript"]
    ...
    api_configuration: NotRequired[
        "capo_amplifyuibuilder.types.api_configuration.ApiConfiguration"
    ]
    """<p>The API configuration for the code generation job.</p>"""
    dependencies: NotRequired[
        "capo_amplifyuibuilder.types.react_codegen_dependencies.ReactCodegenDependencies"
    ]
...
def serialize_json(value: ReactStartCodegenJobData) -> dict:
    ...
    if "module" in value:
        ...
        out["module"] = capo_amplifyuibuilder.types.js_module.serialize_json(
            value["module"]
        )
    if "target" in value:
        import capo_amplifyuibuilder.types.js_target

        out["target"] = capo_amplifyuibuilder.types.js_target.serialize_json(
            value["target"]
        )
    if "script" in value:
        import capo_amplifyuibuilder.types.js_script

        out["script"] = capo_amplifyuibuilder.types.js_script.serialize_json(
            value["script"]
        )
    ...
    if "api_configuration" in value:
        ...
        out["apiConfiguration"] = (
            capo_amplifyuibuilder.types.api_configuration.serialize_json(
    ...
    if "dependencies" in value:
        ...
        out["dependencies"] = (
            capo_amplifyuibuilder.types.react_codegen_dependencies.serialize_json(
                value["dependencies"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ReactStartCodegenJobData:
    ...
    if "apiConfiguration" in data:
        ...
        out["api_configuration"] = (
            capo_amplifyuibuilder.types.api_configuration.deserialize_json(
    ...
    if "dependencies" in data:
        ...
        out["dependencies"] = (
            capo_amplifyuibuilder.types.react_codegen_dependencies.deserialize_json(
                data["dependencies"]
            )
        )
    return out
