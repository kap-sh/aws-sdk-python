...
if TYPE_CHECKING:
    import capo_amplifyuibuilder.types.form_input_binding_properties_value_properties
...
class FormInputBindingPropertiesValue(TypedDict, closed=True):
    ...
    binding_properties: NotRequired[
        "capo_amplifyuibuilder.types.form_input_binding_properties_value_properties.FormInputBindingPropertiesValueProperties"
    ]
...
def serialize_json(value: FormInputBindingPropertiesValue) -> dict:
    ...
    if "binding_properties" in value:
        ...
        out["bindingProperties"] = (
            capo_amplifyuibuilder.types.form_input_binding_properties_value_properties.serialize_json(
...
def deserialize_json(data: dict) -> FormInputBindingPropertiesValue:
    ...
    if "bindingProperties" in data:
        ...
        out["binding_properties"] = (
            capo_amplifyuibuilder.types.form_input_binding_properties_value_properties.deserialize_json(
