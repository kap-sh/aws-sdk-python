...
def handle_response(
    ...
    out: capo_amplifyuibuilder.types.exchange_code_for_token_response.ExchangeCodeForTokenResponse = capo_amplifyuibuilder.types.exchange_code_for_token_response.deserialize_json(
...
def build_request(
    ...
    if "request" in input_:
        body: bytes | None = json.dumps(
            capo_amplifyuibuilder.types.exchange_code_for_token_request_body.serialize_json(
                input_["request"]
            )
        ).encode()
