"""Generated from Smithy shape ``com.amazonaws.amplifyuibuilder#UnauthorizedException``."""
...
class UnauthorizedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.amplifyuibuilder#UnauthorizedException``."""
