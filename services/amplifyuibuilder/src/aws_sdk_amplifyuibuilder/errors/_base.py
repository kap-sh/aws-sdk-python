...
class AmplifyUIBuilderError(Exception):
    """Base class for all AmplifyUIBuilder service errors."""

class ServiceError(AmplifyUIBuilderError):
...
class SerializationError(AmplifyUIBuilderError):
    """Raised when a value cannot be serialized."""

class DeserializationError(AmplifyUIBuilderError):
...
class WaiterFailedError(AmplifyUIBuilderError):
...
class WaiterTimeoutError(AmplifyUIBuilderError):
