...
CodegenGenericDataModels: TypeAlias = dict[
    "str",
    "aws_sdk_amplifyuibuilder.types.codegen_generic_data_model.CodegenGenericDataModel",
]
...
def serialize_json(input_to_serialize: CodegenGenericDataModels) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = (
            aws_sdk_amplifyuibuilder.types.codegen_generic_data_model.serialize_json(
                value
            )
        )
    return out
...
def deserialize_json(data: dict) -> CodegenGenericDataModels:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            aws_sdk_amplifyuibuilder.types.codegen_generic_data_model.deserialize_json(
                value
            )
        )
    return out
