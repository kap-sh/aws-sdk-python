...
CodegenGenericDataEnums: TypeAlias = dict[
    "str",
    "aws_sdk_amplifyuibuilder.types.codegen_generic_data_enum.CodegenGenericDataEnum",
]
...
def serialize_json(input_to_serialize: CodegenGenericDataEnums) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = (
            aws_sdk_amplifyuibuilder.types.codegen_generic_data_enum.serialize_json(
                value
            )
        )
    return out
...
def deserialize_json(data: dict) -> CodegenGenericDataEnums:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            aws_sdk_amplifyuibuilder.types.codegen_generic_data_enum.deserialize_json(
                value
            )
        )
    return out
