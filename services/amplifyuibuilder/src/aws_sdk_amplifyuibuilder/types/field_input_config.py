...
if TYPE_CHECKING:
    import aws_sdk_amplifyuibuilder.types.file_uploader_field_config
    import aws_sdk_amplifyuibuilder.types.value_mappings


class FieldInputConfig(TypedDict):
    type: "str"
    ...
    value_mappings: NotRequired[
        "aws_sdk_amplifyuibuilder.types.value_mappings.ValueMappings"
    ]
    ...
    file_uploader_config: NotRequired[
        "aws_sdk_amplifyuibuilder.types.file_uploader_field_config.FileUploaderFieldConfig"
    ]
...
def serialize_json(value: FieldInputConfig) -> dict:
    ...
    if "value_mappings" in value:
        ...
        out["valueMappings"] = (
            aws_sdk_amplifyuibuilder.types.value_mappings.serialize_json(
    ...
    if "file_uploader_config" in value:
        ...
        out["fileUploaderConfig"] = (
            aws_sdk_amplifyuibuilder.types.file_uploader_field_config.serialize_json(
...
def deserialize_json(data: dict) -> FieldInputConfig:
    ...
    if "valueMappings" in data:
        ...
        out["value_mappings"] = (
            aws_sdk_amplifyuibuilder.types.value_mappings.deserialize_json(
                data["valueMappings"]
            )
        )
    if "name" in data:
    ...
    if "fileUploaderConfig" in data:
        ...
        out["file_uploader_config"] = (
            aws_sdk_amplifyuibuilder.types.file_uploader_field_config.deserialize_json(
