...
def serialize_json(value: CodegenGenericDataNonModel) -> dict:
    out: dict = {}
    import aws_sdk_amplifyuibuilder.types.codegen_generic_data_non_model_fields
    out["fields"] = aws_sdk_amplifyuibuilder.types.codegen_generic_data_non_model_fields.serialize_json(value["fields"])
    return out
...
def deserialize_json(data: dict) -> CodegenGenericDataNonModel:
    ...
    if "fields" in data:
        import aws_sdk_amplifyuibuilder.types.codegen_generic_data_non_model_fields
        out["fields"] = aws_sdk_amplifyuibuilder.types.codegen_generic_data_non_model_fields.deserialize_json(data["fields"])
    else:
