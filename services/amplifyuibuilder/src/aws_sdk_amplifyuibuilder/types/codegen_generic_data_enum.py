...
def serialize_json(value: CodegenGenericDataEnum) -> dict:
    out: dict = {}
    import aws_sdk_amplifyuibuilder.types.codegen_generic_data_enum_values_list
    out["values"] = aws_sdk_amplifyuibuilder.types.codegen_generic_data_enum_values_list.serialize_json(value["values"])
    return out
...
def deserialize_json(data: dict) -> CodegenGenericDataEnum:
    ...
    if "values" in data:
        import aws_sdk_amplifyuibuilder.types.codegen_generic_data_enum_values_list
        out["values"] = aws_sdk_amplifyuibuilder.types.codegen_generic_data_enum_values_list.deserialize_json(data["values"])
    else:
