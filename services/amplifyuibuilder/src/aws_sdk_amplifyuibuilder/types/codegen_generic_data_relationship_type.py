...
class CodegenGenericDataRelationshipType(TypedDict):
    ...
    related_model_fields: NotRequired["aws_sdk_amplifyuibuilder.types.related_model_fields_list.RelatedModelFieldsList"]
    ...
    associated_fields: NotRequired["aws_sdk_amplifyuibuilder.types.associated_fields_list.AssociatedFieldsList"]
...
def serialize_json(value: CodegenGenericDataRelationshipType) -> dict:
    out: dict = {}
    import aws_sdk_amplifyuibuilder.types.generic_data_relationship_type
    out["type"] = aws_sdk_amplifyuibuilder.types.generic_data_relationship_type.serialize_json(value["type"])
    out["relatedModelName"] = value["related_model_name"]
    if "related_model_fields" in value:
        import aws_sdk_amplifyuibuilder.types.related_model_fields_list
        out["relatedModelFields"] = aws_sdk_amplifyuibuilder.types.related_model_fields_list.serialize_json(value["related_model_fields"])
    ...
    if "associated_fields" in value:
        import aws_sdk_amplifyuibuilder.types.associated_fields_list
        out["associatedFields"] = aws_sdk_amplifyuibuilder.types.associated_fields_list.serialize_json(value["associated_fields"])
...
def deserialize_json(data: dict) -> CodegenGenericDataRelationshipType:
    ...
    if "type" in data:
        import aws_sdk_amplifyuibuilder.types.generic_data_relationship_type
        out["type"] = aws_sdk_amplifyuibuilder.types.generic_data_relationship_type.deserialize_json(data["type"])
    else:
    ...
    if "relatedModelName" in data:
        ...
        raise DeserializationError("CodegenGenericDataRelationshipType.related_model_name required")
    if "relatedModelFields" in data:
        import aws_sdk_amplifyuibuilder.types.related_model_fields_list
        out["related_model_fields"] = aws_sdk_amplifyuibuilder.types.related_model_fields_list.deserialize_json(data["relatedModelFields"])
    ...
    if "associatedFields" in data:
        import aws_sdk_amplifyuibuilder.types.associated_fields_list
        out["associated_fields"] = aws_sdk_amplifyuibuilder.types.associated_fields_list.deserialize_json(data["associatedFields"])
