...
if TYPE_CHECKING:
    import aws_sdk_amplifyuibuilder.types.storage_access_level
    import aws_sdk_amplifyuibuilder.types.str_values


class FileUploaderFieldConfig(TypedDict):
    access_level: (
...
def serialize_json(value: FileUploaderFieldConfig) -> dict:
    ...
    out["accessLevel"] = (
        aws_sdk_amplifyuibuilder.types.storage_access_level.serialize_json(
            value["access_level"]
        )
    )
    import aws_sdk_amplifyuibuilder.types.str_values

    out["acceptedFileTypes"] = aws_sdk_amplifyuibuilder.types.str_values.serialize_json(
...
def deserialize_json(data: dict) -> FileUploaderFieldConfig:
    ...
    if "accessLevel" in data:
        ...
        out["access_level"] = (
            aws_sdk_amplifyuibuilder.types.storage_access_level.deserialize_json(
                data["accessLevel"]
            )
        )
    else:
    ...
    if "acceptedFileTypes" in data:
        ...
        out["accepted_file_types"] = (
            aws_sdk_amplifyuibuilder.types.str_values.deserialize_json(
