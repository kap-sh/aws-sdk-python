...
class StartCodegenJobResponse(TypedDict):
    entity: NotRequired["aws_sdk_amplifyuibuilder.types.codegen_job.CodegenJob"]
...
def serialize_json(value: StartCodegenJobResponse) -> dict:
    ...
    if "entity" in value:
        ...
        out["entity"] = aws_sdk_amplifyuibuilder.types.codegen_job.serialize_json(
            value["entity"]
        )
    return out
...
def deserialize_json(data: dict) -> StartCodegenJobResponse:
    ...
    if "entity" in data:
        ...
        out["entity"] = aws_sdk_amplifyuibuilder.types.codegen_job.deserialize_json(
            data["entity"]
        )
    return out
