...
if TYPE_CHECKING:
    ...
    import aws_sdk_amplifyuibuilder.types.component_property_binding_properties
    import aws_sdk_amplifyuibuilder.types.component_property_list
...
class ComponentProperty(TypedDict, closed=True):
    ...
    binding_properties: NotRequired[
        "aws_sdk_amplifyuibuilder.types.component_property_binding_properties.ComponentPropertyBindingProperties"
    ]
    ...
    bindings: NotRequired["aws_sdk_amplifyuibuilder.types.form_bindings.FormBindings"]
    ...
    concat: NotRequired[
        "aws_sdk_amplifyuibuilder.types.component_property_list.ComponentPropertyList"
    ]
    ...
    condition: NotRequired[
        "aws_sdk_amplifyuibuilder.types.component_condition_property.ComponentConditionProperty"
    ]
...
def serialize_json(value: ComponentProperty) -> dict:
    ...
    if "binding_properties" in value:
        ...
        out["bindingProperties"] = (
            aws_sdk_amplifyuibuilder.types.component_property_binding_properties.serialize_json(
    ...
    if "bindings" in value:
        ...
        out["bindings"] = aws_sdk_amplifyuibuilder.types.form_bindings.serialize_json(
            value["bindings"]
        )
    if "event" in value:
    ...
    if "concat" in value:
        ...
        out["concat"] = (
            aws_sdk_amplifyuibuilder.types.component_property_list.serialize_json(
                value["concat"]
            )
        )
    if "condition" in value:
        ...
        out["condition"] = (
            aws_sdk_amplifyuibuilder.types.component_condition_property.serialize_json(
                value["condition"]
            )
        )
...
def deserialize_json(data: dict) -> ComponentProperty:
    ...
    if "bindingProperties" in data:
        ...
        out["binding_properties"] = (
            aws_sdk_amplifyuibuilder.types.component_property_binding_properties.deserialize_json(
    ...
    if "bindings" in data:
        ...
        out["bindings"] = aws_sdk_amplifyuibuilder.types.form_bindings.deserialize_json(
            data["bindings"]
        )
    if "event" in data:
    ...
    if "concat" in data:
        ...
        out["concat"] = (
            aws_sdk_amplifyuibuilder.types.component_property_list.deserialize_json(
                data["concat"]
            )
        )
    if "condition" in data:
        ...
        out["condition"] = (
            aws_sdk_amplifyuibuilder.types.component_condition_property.deserialize_json(
                data["condition"]
            )
        )
