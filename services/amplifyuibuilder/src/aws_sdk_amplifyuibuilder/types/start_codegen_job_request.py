...
class StartCodegenJobRequest(TypedDict):
    ...
    codegen_job_to_create: (
        "aws_sdk_amplifyuibuilder.types.start_codegen_job_data.StartCodegenJobData"
    )
...
def deserialize_json(data: dict) -> StartCodegenJobRequest:
    ...
    if "codegenJobToCreate" in data:
        ...
        out["codegen_job_to_create"] = (
            aws_sdk_amplifyuibuilder.types.start_codegen_job_data.deserialize_json(
