...
from aws_sdk_amplifyuibuilder._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
...
class AmplifyUIBuilderClient:
    ...
    def __init__(self, http_handler: BaseHandler | None = None, operation_interceptors: Iterable[Interceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, region: str | None = None, use_dual_stack: bool | None = None, use_fips: bool | None = None, endpoint: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = AmplifyUIBuilderClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "region": region, "use_dual_stack": use_dual_stack, "use_fips": use_fips, "endpoint": endpoint, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[AmplifyUIBuilderClientConfig] = None) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
    ...
    def exchange_code_for_token(self, provider: "aws_sdk_amplifyuibuilder.types.token_providers.TokenProviders", request: "aws_sdk_amplifyuibuilder.types.exchange_code_for_token_request_body.ExchangeCodeForTokenRequestBody", *, config_overrides: Optional[AmplifyUIBuilderClientConfig] = None) -> "aws_sdk_amplifyuibuilder.types.exchange_code_for_token_response.ExchangeCodeForTokenResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_amplifyuibuilder.types.exchange_code_for_token_request.ExchangeCodeForTokenRequest]') -> OperationResponse["aws_sdk_amplifyuibuilder.types.exchange_code_for_token_response.ExchangeCodeForTokenResponse"]:
            import aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.exchange_code_for_token
            output, http_response = aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.exchange_code_for_token.exchange_code_for_token(req.options, req.input)
    ...
    def get_metadata(self, app_id: str, environment_name: str, *, config_overrides: Optional[AmplifyUIBuilderClientConfig] = None) -> "aws_sdk_amplifyuibuilder.types.get_metadata_response.GetMetadataResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_amplifyuibuilder.types.get_metadata_request.GetMetadataRequest]') -> OperationResponse["aws_sdk_amplifyuibuilder.types.get_metadata_response.GetMetadataResponse"]:
            import aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.get_metadata
            output, http_response = aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.get_metadata.get_metadata(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def list_tags_for_resource(self, resource_arn: str, *, config_overrides: Optional[AmplifyUIBuilderClientConfig] = None) -> "aws_sdk_amplifyuibuilder.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_amplifyuibuilder.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> OperationResponse["aws_sdk_amplifyuibuilder.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.list_tags_for_resource
            output, http_response = aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_metadata_flag(self, app_id: str, environment_name: str, feature_name: str, body: "aws_sdk_amplifyuibuilder.types.put_metadata_flag_body.PutMetadataFlagBody", *, config_overrides: Optional[AmplifyUIBuilderClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_amplifyuibuilder.types.put_metadata_flag_request.PutMetadataFlagRequest]') -> OperationResponse[None]:
            import aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.put_metadata_flag
            output, http_response = aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.put_metadata_flag.put_metadata_flag(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def refresh_token(self, provider: "aws_sdk_amplifyuibuilder.types.token_providers.TokenProviders", refresh_token_body: "aws_sdk_amplifyuibuilder.types.refresh_token_request_body.RefreshTokenRequestBody", *, config_overrides: Optional[AmplifyUIBuilderClientConfig] = None) -> "aws_sdk_amplifyuibuilder.types.refresh_token_response.RefreshTokenResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_amplifyuibuilder.types.refresh_token_request.RefreshTokenRequest]') -> OperationResponse["aws_sdk_amplifyuibuilder.types.refresh_token_response.RefreshTokenResponse"]:
            import aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.refresh_token
            output, http_response = aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.refresh_token.refresh_token(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def tag_resource(self, resource_arn: str, tags: "aws_sdk_amplifyuibuilder.types.tags.Tags", *, config_overrides: Optional[AmplifyUIBuilderClientConfig] = None) -> "aws_sdk_amplifyuibuilder.types.tag_resource_response.TagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_amplifyuibuilder.types.tag_resource_request.TagResourceRequest]') -> OperationResponse["aws_sdk_amplifyuibuilder.types.tag_resource_response.TagResourceResponse"]:
            import aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.tag_resource
            output, http_response = aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, resource_arn: str, tag_keys: "aws_sdk_amplifyuibuilder.types.tag_key_list.TagKeyList", *, config_overrides: Optional[AmplifyUIBuilderClientConfig] = None) -> "aws_sdk_amplifyuibuilder.types.untag_resource_response.UntagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_amplifyuibuilder.types.untag_resource_request.UntagResourceRequest]') -> OperationResponse["aws_sdk_amplifyuibuilder.types.untag_resource_response.UntagResourceResponse"]:
            import aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.untag_resource
            output, http_response = aws_sdk_amplifyuibuilder._operations.amplify_ui_builder.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
