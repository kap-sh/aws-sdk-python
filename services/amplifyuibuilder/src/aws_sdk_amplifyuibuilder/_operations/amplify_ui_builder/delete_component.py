...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.delete_component_request.DeleteComponentRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/app/{appId}/environment/{environmentName}/components/{id}"
...
def delete_component(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.delete_component_request.DeleteComponentRequest) -> tuple[None, zapros.Response]:
...
async def async_delete_component(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.delete_component_request.DeleteComponentRequest) -> tuple[None, zapros.Response]:
