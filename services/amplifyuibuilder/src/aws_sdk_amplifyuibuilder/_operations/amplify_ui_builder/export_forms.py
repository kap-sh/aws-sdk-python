"""Generated from Smithy shape ``com.amazonaws.amplifyuibuilder#ExportForms``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.export_forms_response.ExportFormsResponse:
    import aws_sdk_amplifyuibuilder.types.export_forms_response
    out: aws_sdk_amplifyuibuilder.types.export_forms_response.ExportFormsResponse = aws_sdk_amplifyuibuilder.types.export_forms_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.export_forms_request.ExportFormsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/export/app/{appId}/environment/{environmentName}/forms"
...
def export_forms(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.export_forms_request.ExportFormsRequest) -> tuple[aws_sdk_amplifyuibuilder.types.export_forms_response.ExportFormsResponse, zapros.Response]:
...
async def async_export_forms(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.export_forms_request.ExportFormsRequest) -> tuple[aws_sdk_amplifyuibuilder.types.export_forms_response.ExportFormsResponse, zapros.Response]:
