...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.export_forms_response.ExportFormsResponse = (
        aws_sdk_amplifyuibuilder.types.export_forms_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.export_forms_request.ExportFormsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
