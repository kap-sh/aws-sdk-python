...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.get_metadata_response.GetMetadataResponse = (
        aws_sdk_amplifyuibuilder.types.get_metadata_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.get_metadata_request.GetMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/app/{appId}/environment/{environmentName}/metadata"
    )
