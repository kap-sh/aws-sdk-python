"""Generated from Smithy shape ``com.amazonaws.amplifyuibuilder#GetMetadata``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.get_metadata_response.GetMetadataResponse:
    import aws_sdk_amplifyuibuilder.types.get_metadata_response
    out: aws_sdk_amplifyuibuilder.types.get_metadata_response.GetMetadataResponse = aws_sdk_amplifyuibuilder.types.get_metadata_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.get_metadata_request.GetMetadataRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/app/{appId}/environment/{environmentName}/metadata"
...
def get_metadata(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.get_metadata_request.GetMetadataRequest) -> tuple[aws_sdk_amplifyuibuilder.types.get_metadata_response.GetMetadataResponse, zapros.Response]:
...
async def async_get_metadata(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.get_metadata_request.GetMetadataRequest) -> tuple[aws_sdk_amplifyuibuilder.types.get_metadata_response.GetMetadataResponse, zapros.Response]:
