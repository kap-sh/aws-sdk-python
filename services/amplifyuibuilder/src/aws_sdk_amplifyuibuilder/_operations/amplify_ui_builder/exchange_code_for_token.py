...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.exchange_code_for_token_response.ExchangeCodeForTokenResponse:
    import aws_sdk_amplifyuibuilder.types.exchange_code_for_token_response
    out: aws_sdk_amplifyuibuilder.types.exchange_code_for_token_response.ExchangeCodeForTokenResponse = aws_sdk_amplifyuibuilder.types.exchange_code_for_token_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.exchange_code_for_token_request.ExchangeCodeForTokenRequest) -> zapros.Request:
    ...
    if "request" in input:
        ...
        body: bytes | None = json.dumps(aws_sdk_amplifyuibuilder.types.exchange_code_for_token_request_body.serialize_json(input["request"])).encode()
...
def exchange_code_for_token(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.exchange_code_for_token_request.ExchangeCodeForTokenRequest) -> tuple[aws_sdk_amplifyuibuilder.types.exchange_code_for_token_response.ExchangeCodeForTokenResponse, zapros.Response]:
...
async def async_exchange_code_for_token(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.exchange_code_for_token_request.ExchangeCodeForTokenRequest) -> tuple[aws_sdk_amplifyuibuilder.types.exchange_code_for_token_response.ExchangeCodeForTokenResponse, zapros.Response]:
