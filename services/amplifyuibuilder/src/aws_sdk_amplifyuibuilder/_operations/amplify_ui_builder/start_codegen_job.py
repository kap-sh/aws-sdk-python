...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.start_codegen_job_response.StartCodegenJobResponse:
    import aws_sdk_amplifyuibuilder.types.codegen_job
    out: aws_sdk_amplifyuibuilder.types.start_codegen_job_response.StartCodegenJobResponse = {"entity": aws_sdk_amplifyuibuilder.types.codegen_job.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.start_codegen_job_request.StartCodegenJobRequest) -> zapros.Request:
    ...
    if "codegen_job_to_create" in input:
        import aws_sdk_amplifyuibuilder.types.start_codegen_job_data
        body: bytes | None = json.dumps(aws_sdk_amplifyuibuilder.types.start_codegen_job_data.serialize_json(input["codegen_job_to_create"])).encode()
...
def start_codegen_job(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.start_codegen_job_request.StartCodegenJobRequest) -> tuple[aws_sdk_amplifyuibuilder.types.start_codegen_job_response.StartCodegenJobResponse, zapros.Response]:
...
async def async_start_codegen_job(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.start_codegen_job_request.StartCodegenJobRequest) -> tuple[aws_sdk_amplifyuibuilder.types.start_codegen_job_response.StartCodegenJobResponse, zapros.Response]:
