...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.start_codegen_job_response.StartCodegenJobResponse = {
        "entity": aws_sdk_amplifyuibuilder.types.codegen_job.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplifyuibuilder.types.start_codegen_job_request.StartCodegenJobRequest,
) -> zapros.Request:
    ...
    if "codegen_job_to_create" in input:
        ...
        body: bytes | None = json.dumps(
            aws_sdk_amplifyuibuilder.types.start_codegen_job_data.serialize_json(
                input["codegen_job_to_create"]
            )
        ).encode()
