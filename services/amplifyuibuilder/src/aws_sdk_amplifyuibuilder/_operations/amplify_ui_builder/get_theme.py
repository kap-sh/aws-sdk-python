"""Generated from Smithy shape ``com.amazonaws.amplifyuibuilder#GetTheme``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.get_theme_response.GetThemeResponse:
    import aws_sdk_amplifyuibuilder.types.theme
    out: aws_sdk_amplifyuibuilder.types.get_theme_response.GetThemeResponse = {"theme": aws_sdk_amplifyuibuilder.types.theme.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.get_theme_request.GetThemeRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/app/{appId}/environment/{environmentName}/themes/{id}"
...
def get_theme(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.get_theme_request.GetThemeRequest) -> tuple[aws_sdk_amplifyuibuilder.types.get_theme_response.GetThemeResponse, zapros.Response]:
...
async def async_get_theme(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.get_theme_request.GetThemeRequest) -> tuple[aws_sdk_amplifyuibuilder.types.get_theme_response.GetThemeResponse, zapros.Response]:
