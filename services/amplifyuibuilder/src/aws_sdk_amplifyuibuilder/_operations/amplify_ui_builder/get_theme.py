...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.get_theme_response.GetThemeResponse = {
        "theme": aws_sdk_amplifyuibuilder.types.theme.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.get_theme_request.GetThemeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_theme(
    ...
    aws_sdk_amplifyuibuilder.types.get_theme_response.GetThemeResponse, zapros.Response
]:
