...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.get_codegen_job_response.GetCodegenJobResponse = {
        "job": aws_sdk_amplifyuibuilder.types.codegen_job.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.get_codegen_job_request.GetCodegenJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
