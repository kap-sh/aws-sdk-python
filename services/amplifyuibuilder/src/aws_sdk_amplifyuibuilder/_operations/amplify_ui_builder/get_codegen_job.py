...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.get_codegen_job_response.GetCodegenJobResponse:
    import aws_sdk_amplifyuibuilder.types.codegen_job
    out: aws_sdk_amplifyuibuilder.types.get_codegen_job_response.GetCodegenJobResponse = {"job": aws_sdk_amplifyuibuilder.types.codegen_job.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.get_codegen_job_request.GetCodegenJobRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/app/{appId}/environment/{environmentName}/codegen-jobs/{id}"
...
def get_codegen_job(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.get_codegen_job_request.GetCodegenJobRequest) -> tuple[aws_sdk_amplifyuibuilder.types.get_codegen_job_response.GetCodegenJobResponse, zapros.Response]:
...
async def async_get_codegen_job(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.get_codegen_job_request.GetCodegenJobRequest) -> tuple[aws_sdk_amplifyuibuilder.types.get_codegen_job_response.GetCodegenJobResponse, zapros.Response]:
