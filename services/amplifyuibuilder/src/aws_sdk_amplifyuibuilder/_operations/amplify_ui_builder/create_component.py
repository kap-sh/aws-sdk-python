...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.create_component_response.CreateComponentResponse:
    import aws_sdk_amplifyuibuilder.types.component
    out: aws_sdk_amplifyuibuilder.types.create_component_response.CreateComponentResponse = {"entity": aws_sdk_amplifyuibuilder.types.component.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.create_component_request.CreateComponentRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/app/{appId}/environment/{environmentName}/components"
    ...
    if "component_to_create" in input:
        import aws_sdk_amplifyuibuilder.types.create_component_data
        body: bytes | None = json.dumps(aws_sdk_amplifyuibuilder.types.create_component_data.serialize_json(input["component_to_create"])).encode()
...
def create_component(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.create_component_request.CreateComponentRequest) -> tuple[aws_sdk_amplifyuibuilder.types.create_component_response.CreateComponentResponse, zapros.Response]:
...
async def async_create_component(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.create_component_request.CreateComponentRequest) -> tuple[aws_sdk_amplifyuibuilder.types.create_component_response.CreateComponentResponse, zapros.Response]:
