...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.update_component_response.UpdateComponentResponse:
    import aws_sdk_amplifyuibuilder.types.component
    out: aws_sdk_amplifyuibuilder.types.update_component_response.UpdateComponentResponse = {"entity": aws_sdk_amplifyuibuilder.types.component.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.update_component_request.UpdateComponentRequest) -> zapros.Request:
    ...
    if "updated_component" in input:
        import aws_sdk_amplifyuibuilder.types.update_component_data
        body: bytes | None = json.dumps(aws_sdk_amplifyuibuilder.types.update_component_data.serialize_json(input["updated_component"])).encode()
...
def update_component(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.update_component_request.UpdateComponentRequest) -> tuple[aws_sdk_amplifyuibuilder.types.update_component_response.UpdateComponentResponse, zapros.Response]:
...
async def async_update_component(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.update_component_request.UpdateComponentRequest) -> tuple[aws_sdk_amplifyuibuilder.types.update_component_response.UpdateComponentResponse, zapros.Response]:
