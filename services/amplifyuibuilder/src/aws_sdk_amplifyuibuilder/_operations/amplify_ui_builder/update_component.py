...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.update_component_response.UpdateComponentResponse = {
...
def build_request(
    ...
    input: aws_sdk_amplifyuibuilder.types.update_component_request.UpdateComponentRequest,
) -> zapros.Request:
