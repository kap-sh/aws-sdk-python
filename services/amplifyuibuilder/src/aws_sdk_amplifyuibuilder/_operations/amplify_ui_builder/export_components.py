...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.export_components_response.ExportComponentsResponse = aws_sdk_amplifyuibuilder.types.export_components_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.export_components_request.ExportComponentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
