...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.export_components_response.ExportComponentsResponse:
    import aws_sdk_amplifyuibuilder.types.export_components_response
    out: aws_sdk_amplifyuibuilder.types.export_components_response.ExportComponentsResponse = aws_sdk_amplifyuibuilder.types.export_components_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.export_components_request.ExportComponentsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/export/app/{appId}/environment/{environmentName}/components"
...
def export_components(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.export_components_request.ExportComponentsRequest) -> tuple[aws_sdk_amplifyuibuilder.types.export_components_response.ExportComponentsResponse, zapros.Response]:
...
async def async_export_components(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.export_components_request.ExportComponentsRequest) -> tuple[aws_sdk_amplifyuibuilder.types.export_components_response.ExportComponentsResponse, zapros.Response]:
