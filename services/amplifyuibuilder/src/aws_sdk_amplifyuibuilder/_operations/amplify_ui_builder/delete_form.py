...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.delete_form_request.DeleteFormRequest) -> zapros.Request:
...
def delete_form(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.delete_form_request.DeleteFormRequest) -> tuple[None, zapros.Response]:
...
async def async_delete_form(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.delete_form_request.DeleteFormRequest) -> tuple[None, zapros.Response]:
