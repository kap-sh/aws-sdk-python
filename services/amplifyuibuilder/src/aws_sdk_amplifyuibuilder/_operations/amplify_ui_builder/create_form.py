...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.create_form_response.CreateFormResponse = {
        "entity": aws_sdk_amplifyuibuilder.types.form.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_amplifyuibuilder.types.create_form_request.CreateFormRequest,
) -> zapros.Request:
