...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.create_form_response.CreateFormResponse:
    import aws_sdk_amplifyuibuilder.types.form
    out: aws_sdk_amplifyuibuilder.types.create_form_response.CreateFormResponse = {"entity": aws_sdk_amplifyuibuilder.types.form.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.create_form_request.CreateFormRequest) -> zapros.Request:
    ...
    if "form_to_create" in input:
        import aws_sdk_amplifyuibuilder.types.create_form_data
        body: bytes | None = json.dumps(aws_sdk_amplifyuibuilder.types.create_form_data.serialize_json(input["form_to_create"])).encode()
...
def create_form(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.create_form_request.CreateFormRequest) -> tuple[aws_sdk_amplifyuibuilder.types.create_form_response.CreateFormResponse, zapros.Response]:
...
async def async_create_form(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.create_form_request.CreateFormRequest) -> tuple[aws_sdk_amplifyuibuilder.types.create_form_response.CreateFormResponse, zapros.Response]:
