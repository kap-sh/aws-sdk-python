...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.get_component_response.GetComponentResponse:
    import aws_sdk_amplifyuibuilder.types.component
    out: aws_sdk_amplifyuibuilder.types.get_component_response.GetComponentResponse = {"component": aws_sdk_amplifyuibuilder.types.component.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.get_component_request.GetComponentRequest) -> zapros.Request:
...
def get_component(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.get_component_request.GetComponentRequest) -> tuple[aws_sdk_amplifyuibuilder.types.get_component_response.GetComponentResponse, zapros.Response]:
...
async def async_get_component(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.get_component_request.GetComponentRequest) -> tuple[aws_sdk_amplifyuibuilder.types.get_component_response.GetComponentResponse, zapros.Response]:
