...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.get_component_response.GetComponentResponse = {
        "component": aws_sdk_amplifyuibuilder.types.component.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.get_component_request.GetComponentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
