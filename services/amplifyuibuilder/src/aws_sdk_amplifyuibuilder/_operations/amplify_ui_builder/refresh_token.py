...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.refresh_token_response.RefreshTokenResponse:
    import aws_sdk_amplifyuibuilder.types.refresh_token_response
    out: aws_sdk_amplifyuibuilder.types.refresh_token_response.RefreshTokenResponse = aws_sdk_amplifyuibuilder.types.refresh_token_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.refresh_token_request.RefreshTokenRequest) -> zapros.Request:
    ...
    if "refresh_token_body" in input:
        ...
        body: bytes | None = json.dumps(aws_sdk_amplifyuibuilder.types.refresh_token_request_body.serialize_json(input["refresh_token_body"])).encode()
...
def refresh_token(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.refresh_token_request.RefreshTokenRequest) -> tuple[aws_sdk_amplifyuibuilder.types.refresh_token_response.RefreshTokenResponse, zapros.Response]:
...
async def async_refresh_token(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.refresh_token_request.RefreshTokenRequest) -> tuple[aws_sdk_amplifyuibuilder.types.refresh_token_response.RefreshTokenResponse, zapros.Response]:
