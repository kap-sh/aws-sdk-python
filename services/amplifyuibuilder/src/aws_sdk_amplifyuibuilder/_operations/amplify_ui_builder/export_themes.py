...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.export_themes_response.ExportThemesResponse = (
        aws_sdk_amplifyuibuilder.types.export_themes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.export_themes_request.ExportThemesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
