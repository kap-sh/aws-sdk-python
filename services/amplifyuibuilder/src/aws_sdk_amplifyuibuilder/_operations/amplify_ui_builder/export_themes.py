...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.export_themes_response.ExportThemesResponse:
    import aws_sdk_amplifyuibuilder.types.export_themes_response
    out: aws_sdk_amplifyuibuilder.types.export_themes_response.ExportThemesResponse = aws_sdk_amplifyuibuilder.types.export_themes_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.export_themes_request.ExportThemesRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/export/app/{appId}/environment/{environmentName}/themes"
...
def export_themes(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.export_themes_request.ExportThemesRequest) -> tuple[aws_sdk_amplifyuibuilder.types.export_themes_response.ExportThemesResponse, zapros.Response]:
...
async def async_export_themes(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.export_themes_request.ExportThemesRequest) -> tuple[aws_sdk_amplifyuibuilder.types.export_themes_response.ExportThemesResponse, zapros.Response]:
