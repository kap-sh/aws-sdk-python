...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.list_forms_response.ListFormsResponse = (
        aws_sdk_amplifyuibuilder.types.list_forms_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.list_forms_request.ListFormsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
