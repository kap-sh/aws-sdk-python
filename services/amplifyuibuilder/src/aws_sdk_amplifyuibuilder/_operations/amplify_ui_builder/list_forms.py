"""Generated from Smithy shape ``com.amazonaws.amplifyuibuilder#ListForms``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.list_forms_response.ListFormsResponse:
    import aws_sdk_amplifyuibuilder.types.list_forms_response
    out: aws_sdk_amplifyuibuilder.types.list_forms_response.ListFormsResponse = aws_sdk_amplifyuibuilder.types.list_forms_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.list_forms_request.ListFormsRequest) -> zapros.Request:
...
def list_forms(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.list_forms_request.ListFormsRequest) -> tuple[aws_sdk_amplifyuibuilder.types.list_forms_response.ListFormsResponse, zapros.Response]:
...
async def async_list_forms(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.list_forms_request.ListFormsRequest) -> tuple[aws_sdk_amplifyuibuilder.types.list_forms_response.ListFormsResponse, zapros.Response]:
