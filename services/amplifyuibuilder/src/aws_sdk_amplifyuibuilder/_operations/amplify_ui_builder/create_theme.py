...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.create_theme_response.CreateThemeResponse = {
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.create_theme_request.CreateThemeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
