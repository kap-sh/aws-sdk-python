...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.list_themes_response.ListThemesResponse:
    import aws_sdk_amplifyuibuilder.types.list_themes_response
    out: aws_sdk_amplifyuibuilder.types.list_themes_response.ListThemesResponse = aws_sdk_amplifyuibuilder.types.list_themes_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.list_themes_request.ListThemesRequest) -> zapros.Request:
...
def list_themes(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.list_themes_request.ListThemesRequest) -> tuple[aws_sdk_amplifyuibuilder.types.list_themes_response.ListThemesResponse, zapros.Response]:
...
async def async_list_themes(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.list_themes_request.ListThemesRequest) -> tuple[aws_sdk_amplifyuibuilder.types.list_themes_response.ListThemesResponse, zapros.Response]:
