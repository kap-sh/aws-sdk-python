...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.list_themes_response.ListThemesResponse = (
        aws_sdk_amplifyuibuilder.types.list_themes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.list_themes_request.ListThemesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
