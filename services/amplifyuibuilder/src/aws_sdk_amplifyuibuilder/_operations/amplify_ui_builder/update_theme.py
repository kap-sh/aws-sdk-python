...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.update_theme_response.UpdateThemeResponse:
    import aws_sdk_amplifyuibuilder.types.theme
    out: aws_sdk_amplifyuibuilder.types.update_theme_response.UpdateThemeResponse = {"entity": aws_sdk_amplifyuibuilder.types.theme.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.update_theme_request.UpdateThemeRequest) -> zapros.Request:
    ...
    if "updated_theme" in input:
        import aws_sdk_amplifyuibuilder.types.update_theme_data
        body: bytes | None = json.dumps(aws_sdk_amplifyuibuilder.types.update_theme_data.serialize_json(input["updated_theme"])).encode()
...
def update_theme(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.update_theme_request.UpdateThemeRequest) -> tuple[aws_sdk_amplifyuibuilder.types.update_theme_response.UpdateThemeResponse, zapros.Response]:
...
async def async_update_theme(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.update_theme_request.UpdateThemeRequest) -> tuple[aws_sdk_amplifyuibuilder.types.update_theme_response.UpdateThemeResponse, zapros.Response]:
