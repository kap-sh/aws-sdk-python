...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.update_theme_response.UpdateThemeResponse = {
        "entity": aws_sdk_amplifyuibuilder.types.theme.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.update_theme_request.UpdateThemeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
