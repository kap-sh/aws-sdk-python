...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.list_components_response.ListComponentsResponse:
    import aws_sdk_amplifyuibuilder.types.list_components_response
    out: aws_sdk_amplifyuibuilder.types.list_components_response.ListComponentsResponse = aws_sdk_amplifyuibuilder.types.list_components_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.list_components_request.ListComponentsRequest) -> zapros.Request:
...
def list_components(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.list_components_request.ListComponentsRequest) -> tuple[aws_sdk_amplifyuibuilder.types.list_components_response.ListComponentsResponse, zapros.Response]:
...
async def async_list_components(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.list_components_request.ListComponentsRequest) -> tuple[aws_sdk_amplifyuibuilder.types.list_components_response.ListComponentsResponse, zapros.Response]:
