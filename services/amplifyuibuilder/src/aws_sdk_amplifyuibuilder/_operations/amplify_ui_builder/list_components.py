...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.list_components_response.ListComponentsResponse = aws_sdk_amplifyuibuilder.types.list_components_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.list_components_request.ListComponentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
