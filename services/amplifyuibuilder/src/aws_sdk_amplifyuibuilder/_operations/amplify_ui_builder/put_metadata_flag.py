"""Generated from Smithy shape ``com.amazonaws.amplifyuibuilder#PutMetadataFlag``."""
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.put_metadata_flag_request.PutMetadataFlagRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/app/{appId}/environment/{environmentName}/metadata/features/{featureName}"
    ...
    if "body" in input:
        ...
        body: bytes | None = json.dumps(aws_sdk_amplifyuibuilder.types.put_metadata_flag_body.serialize_json(input["body"])).encode()
...
def put_metadata_flag(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.put_metadata_flag_request.PutMetadataFlagRequest) -> tuple[None, zapros.Response]:
...
async def async_put_metadata_flag(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.put_metadata_flag_request.PutMetadataFlagRequest) -> tuple[None, zapros.Response]:
