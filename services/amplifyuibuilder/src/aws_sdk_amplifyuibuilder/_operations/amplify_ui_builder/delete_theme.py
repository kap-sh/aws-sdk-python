...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.delete_theme_request.DeleteThemeRequest) -> zapros.Request:
...
def delete_theme(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.delete_theme_request.DeleteThemeRequest) -> tuple[None, zapros.Response]:
...
async def async_delete_theme(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.delete_theme_request.DeleteThemeRequest) -> tuple[None, zapros.Response]:
