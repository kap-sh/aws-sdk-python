...
def handle_response(
    ...
    out: aws_sdk_amplifyuibuilder.types.get_form_response.GetFormResponse = {
        "form": aws_sdk_amplifyuibuilder.types.form.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.get_form_request.GetFormRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_form(
    ...
    aws_sdk_amplifyuibuilder.types.get_form_response.GetFormResponse, zapros.Response
]:
