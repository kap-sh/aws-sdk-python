...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.get_form_response.GetFormResponse:
    import aws_sdk_amplifyuibuilder.types.form
    out: aws_sdk_amplifyuibuilder.types.get_form_response.GetFormResponse = {"form": aws_sdk_amplifyuibuilder.types.form.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.get_form_request.GetFormRequest) -> zapros.Request:
...
def get_form(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.get_form_request.GetFormRequest) -> tuple[aws_sdk_amplifyuibuilder.types.get_form_response.GetFormResponse, zapros.Response]:
...
async def async_get_form(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.get_form_request.GetFormRequest) -> tuple[aws_sdk_amplifyuibuilder.types.get_form_response.GetFormResponse, zapros.Response]:
