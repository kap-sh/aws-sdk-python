...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            ...
            raise aws_sdk_amplifyuibuilder.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
        case "ThrottlingException":
            import aws_sdk_amplifyuibuilder.errors.throttling_exception

            raise aws_sdk_amplifyuibuilder.errors.throttling_exception.ThrottlingException.from_json(
                data
            )
        case "UnauthorizedException":
            import aws_sdk_amplifyuibuilder.errors.unauthorized_exception

            raise aws_sdk_amplifyuibuilder.errors.unauthorized_exception.UnauthorizedException.from_json(
                data
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_amplifyuibuilder.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_amplifyuibuilder.types.tag_resource_request.serialize_json(input_)
    ).encode()
