"""Generated from Smithy shape ``com.amazonaws.amplifyuibuilder#TagResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            import aws_sdk_amplifyuibuilder.errors.resource_not_found_exception
            raise aws_sdk_amplifyuibuilder.errors.resource_not_found_exception.ResourceNotFoundException.from_json(data)
        case "ThrottlingException":
            import aws_sdk_amplifyuibuilder.errors.throttling_exception
            raise aws_sdk_amplifyuibuilder.errors.throttling_exception.ThrottlingException.from_json(data)
        case "UnauthorizedException":
            import aws_sdk_amplifyuibuilder.errors.unauthorized_exception
            raise aws_sdk_amplifyuibuilder.errors.unauthorized_exception.UnauthorizedException.from_json(data)
        case _:
            raise UnknownServiceError(code=code, message=message, response=response)

def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_amplifyuibuilder.types.tag_resource_response.TagResourceResponse:
    out: aws_sdk_amplifyuibuilder.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.tag_resource_request.TagResourceRequest) -> zapros.Request:
    ...
    import aws_sdk_amplifyuibuilder.types.tag_resource_request
    body: bytes | None = json.dumps(aws_sdk_amplifyuibuilder.types.tag_resource_request.serialize_json(input)).encode()
...
def tag_resource(options: OperationOptions, input: aws_sdk_amplifyuibuilder.types.tag_resource_request.TagResourceRequest) -> tuple[aws_sdk_amplifyuibuilder.types.tag_resource_response.TagResourceResponse, zapros.Response]:
...
async def async_tag_resource(options: AsyncOperationOptions, input: aws_sdk_amplifyuibuilder.types.tag_resource_request.TagResourceRequest) -> tuple[aws_sdk_amplifyuibuilder.types.tag_resource_response.TagResourceResponse, zapros.Response]:
