...
class SESv2Error(Exception):
    """Base class for all SESv2 service errors."""


class ServiceError(SESv2Error):
...
class SerializationError(SESv2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(SESv2Error):
...
class WaiterFailedError(SESv2Error):
...
class WaiterTimeoutError(SESv2Error):
