...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.create_tenant_response.CreateTenantResponse = (
        aws_sdk_sesv2.types.create_tenant_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.create_tenant_request.CreateTenantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_tenant_request.serialize_json(input_)
    ).encode()
...
def create_tenant(
    ...
    aws_sdk_sesv2.types.create_tenant_response.CreateTenantResponse, zapros.Response
]:
