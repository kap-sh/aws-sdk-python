"""Generated from Smithy shape ``com.amazonaws.sesv2#ListDomainDeliverabilityCampaigns``."""
...
import aws_sdk_sesv2.types.domain_deliverability_campaign_list
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_domain_deliverability_campaigns_response.ListDomainDeliverabilityCampaignsResponse = aws_sdk_sesv2.types.list_domain_deliverability_campaigns_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_domain_deliverability_campaigns_request.ListDomainDeliverabilityCampaignsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
