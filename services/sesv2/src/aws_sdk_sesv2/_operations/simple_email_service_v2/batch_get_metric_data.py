...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InternalServiceErrorException":
            import aws_sdk_sesv2.errors.internal_service_error_exception

            raise aws_sdk_sesv2.errors.internal_service_error_exception.InternalServiceErrorException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.batch_get_metric_data_response.BatchGetMetricDataResponse = aws_sdk_sesv2.types.batch_get_metric_data_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.batch_get_metric_data_request.BatchGetMetricDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.batch_get_metric_data_request.serialize_json(input_)
    ).encode()
