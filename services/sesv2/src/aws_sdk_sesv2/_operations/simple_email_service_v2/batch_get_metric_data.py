...
def build_request(
    ...
    input: aws_sdk_sesv2.types.batch_get_metric_data_request.BatchGetMetricDataRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.batch_get_metric_data_request.serialize_json(input)
    ).encode()
