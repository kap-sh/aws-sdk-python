...
def build_request(
    ...
    input: aws_sdk_sesv2.types.put_account_vdm_attributes_request.PutAccountVdmAttributesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_account_vdm_attributes_request.serialize_json(input)
    ).encode()
