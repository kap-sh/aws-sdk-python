...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_account_vdm_attributes_response.PutAccountVdmAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.put_account_vdm_attributes_request.PutAccountVdmAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_account_vdm_attributes_request.serialize_json(input_)
    ).encode()
