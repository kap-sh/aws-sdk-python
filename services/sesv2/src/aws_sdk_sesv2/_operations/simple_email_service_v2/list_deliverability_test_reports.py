"""Generated from Smithy shape ``com.amazonaws.sesv2#ListDeliverabilityTestReports``."""
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_deliverability_test_reports_request.ListDeliverabilityTestReportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/deliverability-dashboard/test-reports"
    params: dict[str, str] = {}
...
async def async_list_deliverability_test_reports(
