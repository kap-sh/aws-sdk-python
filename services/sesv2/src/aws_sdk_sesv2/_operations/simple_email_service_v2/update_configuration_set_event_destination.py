"""Generated from Smithy shape ``com.amazonaws.sesv2#UpdateConfigurationSetEventDestination``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.update_configuration_set_event_destination_response.UpdateConfigurationSetEventDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.update_configuration_set_event_destination_request.UpdateConfigurationSetEventDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.update_configuration_set_event_destination_request.serialize_json(
            input_
        )
    ).encode()
