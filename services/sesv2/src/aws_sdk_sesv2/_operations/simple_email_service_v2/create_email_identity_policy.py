...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.create_email_identity_policy_response.CreateEmailIdentityPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.create_email_identity_policy_request.CreateEmailIdentityPolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_email_identity_policy_request.serialize_json(input)
    ).encode()
