...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.create_deliverability_test_report_response.CreateDeliverabilityTestReportResponse = aws_sdk_sesv2.types.create_deliverability_test_report_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.create_deliverability_test_report_request.CreateDeliverabilityTestReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
