"""Generated from Smithy shape ``com.amazonaws.sesv2#PutEmailIdentityDkimAttributes``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_email_identity_dkim_attributes_response.PutEmailIdentityDkimAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.put_email_identity_dkim_attributes_request.PutEmailIdentityDkimAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/identities/{EmailIdentity}/dkim"
