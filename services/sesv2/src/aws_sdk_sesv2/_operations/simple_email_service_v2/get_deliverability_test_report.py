...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_deliverability_test_report_response.GetDeliverabilityTestReportResponse = aws_sdk_sesv2.types.get_deliverability_test_report_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_deliverability_test_report_request.GetDeliverabilityTestReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
