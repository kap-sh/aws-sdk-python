"""Generated from Smithy shape ``com.amazonaws.sesv2#PutDeliverabilityDashboardOption``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_deliverability_dashboard_option_response.PutDeliverabilityDashboardOptionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.put_deliverability_dashboard_option_request.PutDeliverabilityDashboardOptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/deliverability-dashboard"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_deliverability_dashboard_option_request.serialize_json(
            input_
        )
    ).encode()
