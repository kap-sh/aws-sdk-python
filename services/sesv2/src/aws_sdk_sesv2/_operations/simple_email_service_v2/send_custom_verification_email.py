"""Generated from Smithy shape ``com.amazonaws.sesv2#SendCustomVerificationEmail``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.send_custom_verification_email_response.SendCustomVerificationEmailResponse = aws_sdk_sesv2.types.send_custom_verification_email_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.send_custom_verification_email_request.SendCustomVerificationEmailRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.send_custom_verification_email_request.serialize_json(input)
    ).encode()
