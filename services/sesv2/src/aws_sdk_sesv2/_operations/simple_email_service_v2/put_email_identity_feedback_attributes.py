...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_email_identity_feedback_attributes_response.PutEmailIdentityFeedbackAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.put_email_identity_feedback_attributes_request.PutEmailIdentityFeedbackAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_email_identity_feedback_attributes_request.serialize_json(
            input_
        )
    ).encode()
