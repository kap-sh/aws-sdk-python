...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_dedicated_ip_pool_response.GetDedicatedIpPoolResponse = aws_sdk_sesv2.types.get_dedicated_ip_pool_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.get_dedicated_ip_pool_request.GetDedicatedIpPoolRequest,
) -> zapros.Request:
