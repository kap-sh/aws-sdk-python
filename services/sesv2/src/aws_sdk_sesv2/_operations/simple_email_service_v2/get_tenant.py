"""Generated from Smithy shape ``com.amazonaws.sesv2#GetTenant``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_tenant_response.GetTenantResponse = (
        aws_sdk_sesv2.types.get_tenant_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_tenant_request.GetTenantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/tenants/get"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.get_tenant_request.serialize_json(input_)
    ).encode()
...
def get_tenant(
    ...
    input_: aws_sdk_sesv2.types.get_tenant_request.GetTenantRequest,
) -> tuple[aws_sdk_sesv2.types.get_tenant_response.GetTenantResponse, zapros.Response]:
