...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.create_tenant_resource_association_request.CreateTenantResourceAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_tenant_resource_association_request.serialize_json(
            input_
        )
    ).encode()
