"""Generated from Smithy shape ``com.amazonaws.sesv2#SendEmail``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.send_email_response.SendEmailResponse = (
        aws_sdk_sesv2.types.send_email_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.send_email_request.SendEmailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/outbound-emails"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.send_email_request.serialize_json(input_)
    ).encode()
...
def send_email(
    ...
    input_: aws_sdk_sesv2.types.send_email_request.SendEmailRequest,
) -> tuple[aws_sdk_sesv2.types.send_email_response.SendEmailResponse, zapros.Response]:
