"""Generated from Smithy shape ``com.amazonaws.sesv2#DeleteEmailIdentityPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.delete_email_identity_policy_response.DeleteEmailIdentityPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.delete_email_identity_policy_request.DeleteEmailIdentityPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_email_identity_policy(
