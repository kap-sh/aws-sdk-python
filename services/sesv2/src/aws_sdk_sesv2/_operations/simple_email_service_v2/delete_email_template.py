...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.delete_email_template_response.DeleteEmailTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.delete_email_template_request.DeleteEmailTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
