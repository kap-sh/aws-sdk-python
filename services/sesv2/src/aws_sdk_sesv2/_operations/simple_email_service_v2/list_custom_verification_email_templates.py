...
import aws_sdk_sesv2.types.custom_verification_email_templates_list
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_custom_verification_email_templates_response.ListCustomVerificationEmailTemplatesResponse = aws_sdk_sesv2.types.list_custom_verification_email_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_custom_verification_email_templates_request.ListCustomVerificationEmailTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
