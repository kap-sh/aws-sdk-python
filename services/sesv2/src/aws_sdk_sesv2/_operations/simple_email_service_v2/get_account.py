"""Generated from Smithy shape ``com.amazonaws.sesv2#GetAccount``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_account_response.GetAccountResponse = (
        aws_sdk_sesv2.types.get_account_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_account_request.GetAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/account"
    params: dict[str, str] = {}
...
def get_account(
    ...
    aws_sdk_sesv2.types.get_account_response.GetAccountResponse, zapros.Response
]:
