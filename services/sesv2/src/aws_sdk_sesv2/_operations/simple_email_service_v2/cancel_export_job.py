...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.cancel_export_job_response.CancelExportJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.cancel_export_job_request.CancelExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
