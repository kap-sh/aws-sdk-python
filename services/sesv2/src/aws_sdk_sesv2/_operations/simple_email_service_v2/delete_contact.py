...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.delete_contact_response.DeleteContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.delete_contact_request.DeleteContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_contact(
    ...
    aws_sdk_sesv2.types.delete_contact_response.DeleteContactResponse, zapros.Response
]:
