"""Generated from Smithy shape ``com.amazonaws.sesv2#PutEmailIdentityConfigurationSetAttributes``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_email_identity_configuration_set_attributes_response.PutEmailIdentityConfigurationSetAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.put_email_identity_configuration_set_attributes_request.PutEmailIdentityConfigurationSetAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_email_identity_configuration_set_attributes_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_email_identity_configuration_set_attributes(
