...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.create_custom_verification_email_template_response.CreateCustomVerificationEmailTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.create_custom_verification_email_template_request.CreateCustomVerificationEmailTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_custom_verification_email_template_request.serialize_json(
            input_
        )
    ).encode()
