...
import aws_sdk_sesv2.errors.invalid_next_token_exception
...
import aws_sdk_sesv2.types.suppressed_destination_summaries
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNextTokenException":
            raise aws_sdk_sesv2.errors.invalid_next_token_exception.InvalidNextTokenException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_suppressed_destinations_response.ListSuppressedDestinationsResponse = aws_sdk_sesv2.types.list_suppressed_destinations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_suppressed_destinations_request.ListSuppressedDestinationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "reasons" in input_:
        params["Reason"] = str(input_["reasons"])
