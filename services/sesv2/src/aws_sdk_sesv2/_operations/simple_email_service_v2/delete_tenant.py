...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.delete_tenant_response.DeleteTenantResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.delete_tenant_request.DeleteTenantRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.delete_tenant_request.serialize_json(input)
    ).encode()
...
def delete_tenant(
    ...
    aws_sdk_sesv2.types.delete_tenant_response.DeleteTenantResponse, zapros.Response
]:
