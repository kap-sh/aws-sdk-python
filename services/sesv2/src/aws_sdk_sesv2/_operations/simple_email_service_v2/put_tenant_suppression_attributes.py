...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_tenant_suppression_attributes_response.PutTenantSuppressionAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.put_tenant_suppression_attributes_request.PutTenantSuppressionAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_tenant_suppression_attributes_request.serialize_json(
            input_
        )
    ).encode()
