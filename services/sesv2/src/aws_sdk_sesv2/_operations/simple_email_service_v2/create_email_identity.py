...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.create_email_identity_response.CreateEmailIdentityResponse = aws_sdk_sesv2.types.create_email_identity_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.create_email_identity_request.CreateEmailIdentityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_email_identity_request.serialize_json(input_)
    ).encode()
