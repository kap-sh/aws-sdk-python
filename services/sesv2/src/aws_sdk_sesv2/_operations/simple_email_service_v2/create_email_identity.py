...
def build_request(
    ...
    input: aws_sdk_sesv2.types.create_email_identity_request.CreateEmailIdentityRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_email_identity_request.serialize_json(input)
    ).encode()
