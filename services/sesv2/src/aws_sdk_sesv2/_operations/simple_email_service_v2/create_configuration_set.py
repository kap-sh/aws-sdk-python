...
def build_request(
    ...
    input: aws_sdk_sesv2.types.create_configuration_set_request.CreateConfigurationSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_configuration_set_request.serialize_json(input)
    ).encode()
