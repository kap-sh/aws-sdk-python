...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_dedicated_ip_pool_scaling_attributes_response.PutDedicatedIpPoolScalingAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.put_dedicated_ip_pool_scaling_attributes_request.PutDedicatedIpPoolScalingAttributesRequest,
) -> zapros.Request:
    ...
    url = url.replace("{PoolName}", quote(str(input["pool_name"]), safe=""))
    params: dict[str, str] = {}
