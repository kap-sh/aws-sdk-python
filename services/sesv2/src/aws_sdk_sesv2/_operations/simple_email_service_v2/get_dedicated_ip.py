...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_dedicated_ip_response.GetDedicatedIpResponse = (
        aws_sdk_sesv2.types.get_dedicated_ip_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.get_dedicated_ip_request.GetDedicatedIpRequest,
) -> zapros.Request:
