...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_email_address_insights_response.GetEmailAddressInsightsResponse = aws_sdk_sesv2.types.get_email_address_insights_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.get_email_address_insights_request.GetEmailAddressInsightsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.get_email_address_insights_request.serialize_json(input)
    ).encode()
