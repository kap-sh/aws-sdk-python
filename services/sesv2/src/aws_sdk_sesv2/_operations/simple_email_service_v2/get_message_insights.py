...
import aws_sdk_sesv2.types.email_insights_list
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_message_insights_response.GetMessageInsightsResponse = aws_sdk_sesv2.types.get_message_insights_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_message_insights_request.GetMessageInsightsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
