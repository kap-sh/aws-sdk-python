...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.update_contact_response.UpdateContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.update_contact_request.UpdateContactRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.update_contact_request.serialize_json(input)
    ).encode()
...
def update_contact(
    ...
    aws_sdk_sesv2.types.update_contact_response.UpdateContactResponse, zapros.Response
]:
