"""Generated from Smithy shape ``com.amazonaws.sesv2#ListEmailTemplates``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_email_templates_response.ListEmailTemplatesResponse = aws_sdk_sesv2.types.list_email_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_email_templates_request.ListEmailTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_email_templates(
