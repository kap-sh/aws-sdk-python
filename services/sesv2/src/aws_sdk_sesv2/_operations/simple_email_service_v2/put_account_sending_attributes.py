...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_account_sending_attributes_response.PutAccountSendingAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.put_account_sending_attributes_request.PutAccountSendingAttributesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_account_sending_attributes_request.serialize_json(input)
    ).encode()
