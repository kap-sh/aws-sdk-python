...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.put_account_sending_attributes_request.PutAccountSendingAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_account_sending_attributes_request.serialize_json(
            input_
        )
    ).encode()
