...
import aws_sdk_sesv2.types.blacklist_report
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_blacklist_reports_response.GetBlacklistReportsResponse = aws_sdk_sesv2.types.get_blacklist_reports_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_blacklist_reports_request.GetBlacklistReportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
