...
def build_request(
    ...
    input: aws_sdk_sesv2.types.test_render_email_template_request.TestRenderEmailTemplateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.test_render_email_template_request.serialize_json(input)
    ).encode()
