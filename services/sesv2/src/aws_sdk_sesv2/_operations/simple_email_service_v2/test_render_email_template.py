...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.test_render_email_template_response.TestRenderEmailTemplateResponse = aws_sdk_sesv2.types.test_render_email_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.test_render_email_template_request.TestRenderEmailTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.test_render_email_template_request.serialize_json(input_)
    ).encode()
