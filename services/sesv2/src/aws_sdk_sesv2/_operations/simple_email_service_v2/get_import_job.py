...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_import_job_response.GetImportJobResponse = (
        aws_sdk_sesv2.types.get_import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_import_job_request.GetImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_import_job(
    ...
    aws_sdk_sesv2.types.get_import_job_response.GetImportJobResponse, zapros.Response
]:
