"""Generated from Smithy shape ``com.amazonaws.sesv2#DeleteSuppressedDestination``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.delete_suppressed_destination_response.DeleteSuppressedDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.delete_suppressed_destination_request.DeleteSuppressedDestinationRequest,
) -> zapros.Request:
    ...
    url = url.replace("{EmailAddress}", quote(str(input["email_address"]), safe=""))
    params: dict[str, str] = {}
    if "tenant_name" in input:
        params["TenantName"] = str(input["tenant_name"])
...
async def async_delete_suppressed_destination(
