...
import aws_sdk_sesv2.types.daily_volumes
...
import aws_sdk_sesv2.types.overall_volume
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_domain_statistics_report_response.GetDomainStatisticsReportResponse = aws_sdk_sesv2.types.get_domain_statistics_report_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_domain_statistics_report_request.GetDomainStatisticsReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
