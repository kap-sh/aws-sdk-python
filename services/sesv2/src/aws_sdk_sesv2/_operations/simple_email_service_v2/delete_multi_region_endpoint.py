"""Generated from Smithy shape ``com.amazonaws.sesv2#DeleteMultiRegionEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.delete_multi_region_endpoint_response.DeleteMultiRegionEndpointResponse = aws_sdk_sesv2.types.delete_multi_region_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.delete_multi_region_endpoint_request.DeleteMultiRegionEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/multi-region-endpoints/{EndpointName}"
...
async def async_delete_multi_region_endpoint(
