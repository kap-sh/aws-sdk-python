"""Generated from Smithy shape ``com.amazonaws.sesv2#ListRecommendations``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_recommendations_response.ListRecommendationsResponse = aws_sdk_sesv2.types.list_recommendations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_recommendations_request.ListRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/vdm/recommendations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_sesv2.types.list_recommendations_request

    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.list_recommendations_request.serialize_json(input_)
    ).encode()
