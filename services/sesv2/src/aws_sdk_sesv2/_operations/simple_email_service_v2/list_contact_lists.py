...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_contact_lists_response.ListContactListsResponse = (
        aws_sdk_sesv2.types.list_contact_lists_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_contact_lists_request.ListContactListsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
