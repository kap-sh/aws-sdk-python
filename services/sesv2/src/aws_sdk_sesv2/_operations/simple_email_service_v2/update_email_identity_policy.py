...
def build_request(
    ...
    input: aws_sdk_sesv2.types.update_email_identity_policy_request.UpdateEmailIdentityPolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.update_email_identity_policy_request.serialize_json(input)
    ).encode()
