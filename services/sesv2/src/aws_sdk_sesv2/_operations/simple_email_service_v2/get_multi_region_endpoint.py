...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_multi_region_endpoint_response.GetMultiRegionEndpointResponse = aws_sdk_sesv2.types.get_multi_region_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_multi_region_endpoint_request.GetMultiRegionEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
