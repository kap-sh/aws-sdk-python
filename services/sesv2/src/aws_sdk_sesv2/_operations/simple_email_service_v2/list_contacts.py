...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_contacts_response.ListContactsResponse = (
        aws_sdk_sesv2.types.list_contacts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_contacts_request.ListContactsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.list_contacts_request.serialize_json(input_)
    ).encode()
...
def list_contacts(
    ...
    aws_sdk_sesv2.types.list_contacts_response.ListContactsResponse, zapros.Response
]:
