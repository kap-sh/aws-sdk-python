...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_dedicated_ips_response.GetDedicatedIpsResponse = (
        aws_sdk_sesv2.types.get_dedicated_ips_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_dedicated_ips_request.GetDedicatedIpsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
