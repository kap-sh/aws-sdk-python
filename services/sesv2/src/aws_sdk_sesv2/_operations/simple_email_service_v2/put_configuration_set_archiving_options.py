...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_configuration_set_archiving_options_response.PutConfigurationSetArchivingOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.put_configuration_set_archiving_options_request.PutConfigurationSetArchivingOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_configuration_set_archiving_options_request.serialize_json(
            input_
        )
    ).encode()
