"""Generated from Smithy shape ``com.amazonaws.sesv2#DeleteCustomVerificationEmailTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.delete_custom_verification_email_template_response.DeleteCustomVerificationEmailTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.delete_custom_verification_email_template_request.DeleteCustomVerificationEmailTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_custom_verification_email_template(
