...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_dedicated_ip_warmup_attributes_response.PutDedicatedIpWarmupAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.put_dedicated_ip_warmup_attributes_request.PutDedicatedIpWarmupAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_dedicated_ip_warmup_attributes_request.serialize_json(
            input_
        )
    ).encode()
