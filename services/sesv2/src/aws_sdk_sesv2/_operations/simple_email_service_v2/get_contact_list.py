"""Generated from Smithy shape ``com.amazonaws.sesv2#GetContactList``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_contact_list_response.GetContactListResponse = (
        aws_sdk_sesv2.types.get_contact_list_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_contact_list_request.GetContactListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_contact_list(
