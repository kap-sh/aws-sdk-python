...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_import_jobs_response.ListImportJobsResponse = (
        aws_sdk_sesv2.types.list_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_import_jobs_request.ListImportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.list_import_jobs_request.serialize_json(input_)
    ).encode()
