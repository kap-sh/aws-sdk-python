...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_suppressed_destination_response.PutSuppressedDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.put_suppressed_destination_request.PutSuppressedDestinationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_suppressed_destination_request.serialize_json(input)
    ).encode()
