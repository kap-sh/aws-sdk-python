...
def build_request(
    ...
    input: aws_sdk_sesv2.types.update_email_template_request.UpdateEmailTemplateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.update_email_template_request.serialize_json(input)
    ).encode()
