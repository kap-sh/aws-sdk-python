...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.update_reputation_entity_policy_response.UpdateReputationEntityPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.update_reputation_entity_policy_request.UpdateReputationEntityPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.update_reputation_entity_policy_request.serialize_json(
            input_
        )
    ).encode()
