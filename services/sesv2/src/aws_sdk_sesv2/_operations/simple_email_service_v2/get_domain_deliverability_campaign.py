...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_domain_deliverability_campaign_response.GetDomainDeliverabilityCampaignResponse = aws_sdk_sesv2.types.get_domain_deliverability_campaign_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_domain_deliverability_campaign_request.GetDomainDeliverabilityCampaignRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
