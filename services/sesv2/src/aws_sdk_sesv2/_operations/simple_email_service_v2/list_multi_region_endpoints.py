...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_multi_region_endpoints_response.ListMultiRegionEndpointsResponse = aws_sdk_sesv2.types.list_multi_region_endpoints_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_multi_region_endpoints_request.ListMultiRegionEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
