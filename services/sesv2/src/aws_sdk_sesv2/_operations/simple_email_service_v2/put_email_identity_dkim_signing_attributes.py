...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_email_identity_dkim_signing_attributes_response.PutEmailIdentityDkimSigningAttributesResponse = aws_sdk_sesv2.types.put_email_identity_dkim_signing_attributes_response.deserialize_json(
