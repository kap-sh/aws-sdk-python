...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_tenant_resources_response.ListTenantResourcesResponse = aws_sdk_sesv2.types.list_tenant_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_tenant_resources_request.ListTenantResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.list_tenant_resources_request.serialize_json(input_)
    ).encode()
