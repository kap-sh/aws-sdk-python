...
def build_request(
    ...
    input: aws_sdk_sesv2.types.list_tenant_resources_request.ListTenantResourcesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.list_tenant_resources_request.serialize_json(input)
    ).encode()
