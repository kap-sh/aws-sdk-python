...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.create_export_job_response.CreateExportJobResponse = (
        aws_sdk_sesv2.types.create_export_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.create_export_job_request.CreateExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_export_job_request.serialize_json(input_)
    ).encode()
