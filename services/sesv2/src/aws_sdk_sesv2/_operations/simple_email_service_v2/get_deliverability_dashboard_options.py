...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_deliverability_dashboard_options_response.GetDeliverabilityDashboardOptionsResponse = aws_sdk_sesv2.types.get_deliverability_dashboard_options_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_deliverability_dashboard_options_request.GetDeliverabilityDashboardOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
