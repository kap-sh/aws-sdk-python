...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.delete_configuration_set_response.DeleteConfigurationSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.delete_configuration_set_request.DeleteConfigurationSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
