...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_email_identity_policies_response.GetEmailIdentityPoliciesResponse = aws_sdk_sesv2.types.get_email_identity_policies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_email_identity_policies_request.GetEmailIdentityPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
