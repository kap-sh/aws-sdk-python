...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_dedicated_ip_in_pool_response.PutDedicatedIpInPoolResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.put_dedicated_ip_in_pool_request.PutDedicatedIpInPoolRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_dedicated_ip_in_pool_request.serialize_json(input)
    ).encode()
