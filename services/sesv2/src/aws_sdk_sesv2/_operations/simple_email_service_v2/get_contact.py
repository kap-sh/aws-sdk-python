...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_contact_response.GetContactResponse = (
        aws_sdk_sesv2.types.get_contact_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_contact_request.GetContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_contact(
    ...
    aws_sdk_sesv2.types.get_contact_response.GetContactResponse, zapros.Response
]:
