"""Generated from Smithy shape ``com.amazonaws.sesv2#ListExportJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_export_jobs_response.ListExportJobsResponse = (
        aws_sdk_sesv2.types.list_export_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_export_jobs_request.ListExportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/list-export-jobs"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.list_export_jobs_request.serialize_json(input_)
    ).encode()
...
async def async_list_export_jobs(
