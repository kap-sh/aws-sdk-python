"""Generated from Smithy shape ``com.amazonaws.sesv2#ListTenants``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_tenants_response.ListTenantsResponse = (
        aws_sdk_sesv2.types.list_tenants_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_tenants_request.ListTenantsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/tenants/list"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_sesv2.types.list_tenants_request

    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.list_tenants_request.serialize_json(input_)
    ).encode()
...
def list_tenants(
    ...
    aws_sdk_sesv2.types.list_tenants_response.ListTenantsResponse, zapros.Response
]:
