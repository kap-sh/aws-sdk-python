...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_email_template_response.GetEmailTemplateResponse = (
        aws_sdk_sesv2.types.get_email_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_email_template_request.GetEmailTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
