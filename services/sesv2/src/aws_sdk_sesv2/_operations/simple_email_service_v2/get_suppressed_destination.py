...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_suppressed_destination_response.GetSuppressedDestinationResponse = aws_sdk_sesv2.types.get_suppressed_destination_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.get_suppressed_destination_request.GetSuppressedDestinationRequest,
) -> zapros.Request:
