...
def build_request(
    ...
    input: aws_sdk_sesv2.types.create_dedicated_ip_pool_request.CreateDedicatedIpPoolRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_dedicated_ip_pool_request.serialize_json(input)
    ).encode()
