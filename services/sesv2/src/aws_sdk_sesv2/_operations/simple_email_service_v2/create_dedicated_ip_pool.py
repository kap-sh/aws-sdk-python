...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.create_dedicated_ip_pool_response.CreateDedicatedIpPoolResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.create_dedicated_ip_pool_request.CreateDedicatedIpPoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_dedicated_ip_pool_request.serialize_json(input_)
    ).encode()
