...
def build_request(
    ...
    input: aws_sdk_sesv2.types.list_resource_tenants_request.ListResourceTenantsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.list_resource_tenants_request.serialize_json(input)
    ).encode()
