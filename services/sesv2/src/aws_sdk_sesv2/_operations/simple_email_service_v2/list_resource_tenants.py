...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_resource_tenants_response.ListResourceTenantsResponse = aws_sdk_sesv2.types.list_resource_tenants_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_resource_tenants_request.ListResourceTenantsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.list_resource_tenants_request.serialize_json(input_)
    ).encode()
