...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.create_email_template_response.CreateEmailTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.create_email_template_request.CreateEmailTemplateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_email_template_request.serialize_json(input)
    ).encode()
