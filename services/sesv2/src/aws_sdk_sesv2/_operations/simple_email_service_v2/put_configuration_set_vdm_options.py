"""Generated from Smithy shape ``com.amazonaws.sesv2#PutConfigurationSetVdmOptions``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_configuration_set_vdm_options_response.PutConfigurationSetVdmOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.put_configuration_set_vdm_options_request.PutConfigurationSetVdmOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_configuration_set_vdm_options_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_configuration_set_vdm_options(
