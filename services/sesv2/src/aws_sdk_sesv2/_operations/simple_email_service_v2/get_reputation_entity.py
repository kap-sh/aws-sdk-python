...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_reputation_entity_response.GetReputationEntityResponse = aws_sdk_sesv2.types.get_reputation_entity_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_reputation_entity_request.GetReputationEntityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
