"""Generated from Smithy shape ``com.amazonaws.sesv2#UpdateReputationEntityCustomerManagedStatus``."""
...
import aws_sdk_sesv2.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_sesv2.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.update_reputation_entity_customer_managed_status_response.UpdateReputationEntityCustomerManagedStatusResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.update_reputation_entity_customer_managed_status_request.UpdateReputationEntityCustomerManagedStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.update_reputation_entity_customer_managed_status_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_reputation_entity_customer_managed_status(
