...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.get_custom_verification_email_template_response.GetCustomVerificationEmailTemplateResponse = aws_sdk_sesv2.types.get_custom_verification_email_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.get_custom_verification_email_template_request.GetCustomVerificationEmailTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
