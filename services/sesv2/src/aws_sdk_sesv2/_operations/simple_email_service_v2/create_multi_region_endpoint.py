"""Generated from Smithy shape ``com.amazonaws.sesv2#CreateMultiRegionEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.create_multi_region_endpoint_response.CreateMultiRegionEndpointResponse = aws_sdk_sesv2.types.create_multi_region_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.create_multi_region_endpoint_request.CreateMultiRegionEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/multi-region-endpoints"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_sesv2.types.create_multi_region_endpoint_request

    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_multi_region_endpoint_request.serialize_json(input_)
    ).encode()
...
async def async_create_multi_region_endpoint(
