...
def build_request(
    ...
    input: aws_sdk_sesv2.types.create_multi_region_endpoint_request.CreateMultiRegionEndpointRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_multi_region_endpoint_request.serialize_json(input)
    ).encode()
