...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.update_contact_list_response.UpdateContactListResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.update_contact_list_request.UpdateContactListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.update_contact_list_request.serialize_json(input_)
    ).encode()
