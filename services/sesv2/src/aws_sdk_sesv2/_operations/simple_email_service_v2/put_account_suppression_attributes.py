"""Generated from Smithy shape ``com.amazonaws.sesv2#PutAccountSuppressionAttributes``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.put_account_suppression_attributes_response.PutAccountSuppressionAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.put_account_suppression_attributes_request.PutAccountSuppressionAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/account/suppression"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_sesv2.types.put_account_suppression_attributes_request

    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.put_account_suppression_attributes_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_account_suppression_attributes(
