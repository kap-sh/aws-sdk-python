"""Generated from Smithy shape ``com.amazonaws.sesv2#CreateImportJob``."""
...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.create_import_job_response.CreateImportJobResponse = (
        aws_sdk_sesv2.types.create_import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.create_import_job_request.CreateImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/import-jobs"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.create_import_job_request.serialize_json(input_)
    ).encode()
...
async def async_create_import_job(
