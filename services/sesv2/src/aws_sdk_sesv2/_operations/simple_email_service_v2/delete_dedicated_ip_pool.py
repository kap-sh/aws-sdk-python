...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.delete_dedicated_ip_pool_response.DeleteDedicatedIpPoolResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sesv2.types.delete_dedicated_ip_pool_request.DeleteDedicatedIpPoolRequest,
) -> zapros.Request:
