...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.delete_tenant_resource_association_response.DeleteTenantResourceAssociationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.delete_tenant_resource_association_request.DeleteTenantResourceAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.delete_tenant_resource_association_request.serialize_json(
            input_
        )
    ).encode()
