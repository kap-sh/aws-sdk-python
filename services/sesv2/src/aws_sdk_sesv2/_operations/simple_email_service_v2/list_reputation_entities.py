...
def build_request(
    ...
    input: aws_sdk_sesv2.types.list_reputation_entities_request.ListReputationEntitiesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.list_reputation_entities_request.serialize_json(input)
    ).encode()
