...
def handle_response(
    ...
    out: aws_sdk_sesv2.types.list_reputation_entities_response.ListReputationEntitiesResponse = aws_sdk_sesv2.types.list_reputation_entities_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sesv2.types.list_reputation_entities_request.ListReputationEntitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sesv2.types.list_reputation_entities_request.serialize_json(input_)
    ).encode()
