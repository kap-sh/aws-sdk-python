...
class SendBulkEmailRequest(TypedDict):
    ...
    default_email_tags: NotRequired[
...
def serialize_json(value: SendBulkEmailRequest) -> dict:
    ...
    if "default_email_tags" in value:
        ...
        out["DefaultEmailTags"] = aws_sdk_sesv2.types.message_tag_list.serialize_json(
            value["default_email_tags"]
        )
    import aws_sdk_sesv2.types.bulk_email_content

    out["DefaultContent"] = aws_sdk_sesv2.types.bulk_email_content.serialize_json(
        value["default_content"]
    )
    import aws_sdk_sesv2.types.bulk_email_entry_list

    out["BulkEmailEntries"] = aws_sdk_sesv2.types.bulk_email_entry_list.serialize_json(
...
def deserialize_json(data: dict) -> SendBulkEmailRequest:
    ...
    if "DefaultEmailTags" in data:
        ...
        out["default_email_tags"] = (
            aws_sdk_sesv2.types.message_tag_list.deserialize_json(
    ...
    if "DefaultContent" in data:
        ...
        out["default_content"] = (
            aws_sdk_sesv2.types.bulk_email_content.deserialize_json(
                data["DefaultContent"]
            )
        )
    else:
    ...
    if "BulkEmailEntries" in data:
        ...
        out["bulk_email_entries"] = (
            aws_sdk_sesv2.types.bulk_email_entry_list.deserialize_json(
