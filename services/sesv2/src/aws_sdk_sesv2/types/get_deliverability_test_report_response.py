...
if TYPE_CHECKING:
    ...
    import aws_sdk_sesv2.types.isp_placements
    import aws_sdk_sesv2.types.message_content
...
class GetDeliverabilityTestReportResponse(TypedDict):
    ...
    overall_placement: "aws_sdk_sesv2.types.placement_statistics.PlacementStatistics"
    ...
    isp_placements: "aws_sdk_sesv2.types.isp_placements.IspPlacements"
    ...
    message: NotRequired["aws_sdk_sesv2.types.message_content.MessageContent"]
...
def serialize_json(value: GetDeliverabilityTestReportResponse) -> dict:
    ...
    out["DeliverabilityTestReport"] = (
        aws_sdk_sesv2.types.deliverability_test_report.serialize_json(
            value["deliverability_test_report"]
        )
    )
    import aws_sdk_sesv2.types.placement_statistics

    out["OverallPlacement"] = aws_sdk_sesv2.types.placement_statistics.serialize_json(
        value["overall_placement"]
    )
    import aws_sdk_sesv2.types.isp_placements

    out["IspPlacements"] = aws_sdk_sesv2.types.isp_placements.serialize_json(
...
def deserialize_json(data: dict) -> GetDeliverabilityTestReportResponse:
    ...
    if "DeliverabilityTestReport" in data:
        ...
        out["deliverability_test_report"] = (
            aws_sdk_sesv2.types.deliverability_test_report.deserialize_json(
    ...
    if "IspPlacements" in data:
        ...
        out["isp_placements"] = aws_sdk_sesv2.types.isp_placements.deserialize_json(
            data["IspPlacements"]
        )
    else:
        raise DeserializationError(
