...
class GetBlacklistReportsResponse(TypedDict, closed=True):
    blacklist_report: "aws_sdk_sesv2.types.blacklist_report.BlacklistReport"
...
def serialize_json(value: GetBlacklistReportsResponse) -> dict:
    ...
    out["BlacklistReport"] = aws_sdk_sesv2.types.blacklist_report.serialize_json(
...
def deserialize_json(data: dict) -> GetBlacklistReportsResponse:
    ...
    if "BlacklistReport" in data:
        ...
        out["blacklist_report"] = aws_sdk_sesv2.types.blacklist_report.deserialize_json(
