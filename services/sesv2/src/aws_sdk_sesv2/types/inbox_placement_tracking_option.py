...
if TYPE_CHECKING:
    ...
    import aws_sdk_sesv2.types.isp_name_list
...
def serialize_json(value: InboxPlacementTrackingOption) -> dict:
    ...
    if "tracked_isps" in value:
        ...
        out["TrackedIsps"] = aws_sdk_sesv2.types.isp_name_list.serialize_json(
            value["tracked_isps"]
        )
    return out
...
def deserialize_json(data: dict) -> InboxPlacementTrackingOption:
    ...
    if "TrackedIsps" in data:
        ...
        out["tracked_isps"] = aws_sdk_sesv2.types.isp_name_list.deserialize_json(
            data["TrackedIsps"]
        )
    return out
