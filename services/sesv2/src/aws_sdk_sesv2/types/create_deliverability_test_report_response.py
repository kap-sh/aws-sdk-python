"""Generated from Smithy shape ``com.amazonaws.sesv2#CreateDeliverabilityTestReportResponse``."""
...
class CreateDeliverabilityTestReportResponse(TypedDict):
    report_id: "aws_sdk_sesv2.types.report_id.ReportId"
    """<p>A unique string that identifies the predictive inbox placement test.</p>"""
    deliverability_test_status: (
        "aws_sdk_sesv2.types.deliverability_test_status.DeliverabilityTestStatus"
    )
...
def serialize_json(value: CreateDeliverabilityTestReportResponse) -> dict:
    ...
    out["DeliverabilityTestStatus"] = (
        aws_sdk_sesv2.types.deliverability_test_status.serialize_json(
...
def deserialize_json(data: dict) -> CreateDeliverabilityTestReportResponse:
    ...
    if "DeliverabilityTestStatus" in data:
        ...
        out["deliverability_test_status"] = (
            aws_sdk_sesv2.types.deliverability_test_status.deserialize_json(
