"""Generated from Smithy shape ``com.amazonaws.sesv2#CloudWatchDestination``."""
...
if TYPE_CHECKING:
    import aws_sdk_sesv2.types.cloud_watch_dimension_configurations


class CloudWatchDestination(TypedDict):
    dimension_configurations: "aws_sdk_sesv2.types.cloud_watch_dimension_configurations.CloudWatchDimensionConfigurations"
...
def serialize_json(value: CloudWatchDestination) -> dict:
    ...
    out["DimensionConfigurations"] = (
        aws_sdk_sesv2.types.cloud_watch_dimension_configurations.serialize_json(
...
def deserialize_json(data: dict) -> CloudWatchDestination:
    ...
    if "DimensionConfigurations" in data:
        ...
        out["dimension_configurations"] = (
            aws_sdk_sesv2.types.cloud_watch_dimension_configurations.deserialize_json(
