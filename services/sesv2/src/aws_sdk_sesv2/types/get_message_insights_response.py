...
if TYPE_CHECKING:
    ...
    import aws_sdk_sesv2.types.email_subject
...
class GetMessageInsightsResponse(TypedDict):
...
def serialize_json(value: GetMessageInsightsResponse) -> dict:
    ...
    if "insights" in value:
        ...
        out["Insights"] = aws_sdk_sesv2.types.email_insights_list.serialize_json(
            value["insights"]
        )
    return out
...
def deserialize_json(data: dict) -> GetMessageInsightsResponse:
    ...
    if "Insights" in data:
        ...
        out["insights"] = aws_sdk_sesv2.types.email_insights_list.deserialize_json(
            data["Insights"]
        )
    return out
