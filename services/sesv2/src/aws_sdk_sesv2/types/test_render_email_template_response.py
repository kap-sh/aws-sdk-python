...
if TYPE_CHECKING:
    import aws_sdk_sesv2.types.rendered_email_template


class TestRenderEmailTemplateResponse(TypedDict):
    rendered_template: (
        "aws_sdk_sesv2.types.rendered_email_template.RenderedEmailTemplate"
    )
