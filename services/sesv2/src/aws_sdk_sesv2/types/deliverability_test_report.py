...
if TYPE_CHECKING:
    ...
    import aws_sdk_sesv2.types.deliverability_test_subject
...
class DeliverabilityTestReport(TypedDict):
    ...
    subject: NotRequired[
        "aws_sdk_sesv2.types.deliverability_test_subject.DeliverabilityTestSubject"
    ]
    ...
    create_date: NotRequired["aws_sdk_sesv2.types.timestamp.Timestamp"]
...
def serialize_json(value: DeliverabilityTestReport) -> dict:
    ...
    if "create_date" in value:
        ...
        out["CreateDate"] = aws_sdk_sesv2.types.timestamp.serialize_json(
            value["create_date"]
        )
...
def deserialize_json(data: dict) -> DeliverabilityTestReport:
    ...
    if "CreateDate" in data:
        ...
        out["create_date"] = aws_sdk_sesv2.types.timestamp.deserialize_json(
            data["CreateDate"]
        )
