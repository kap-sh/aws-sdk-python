...
if TYPE_CHECKING:
    import aws_sdk_sesv2.types.import_job_summary_list
    import aws_sdk_sesv2.types.next_token


class ListImportJobsResponse(TypedDict):
    import_jobs: NotRequired[
        "aws_sdk_sesv2.types.import_job_summary_list.ImportJobSummaryList"
    ]
...
def serialize_json(value: ListImportJobsResponse) -> dict:
    ...
    if "import_jobs" in value:
        ...
        out["ImportJobs"] = aws_sdk_sesv2.types.import_job_summary_list.serialize_json(
            value["import_jobs"]
        )
...
def deserialize_json(data: dict) -> ListImportJobsResponse:
    ...
    if "ImportJobs" in data:
        ...
        out["import_jobs"] = (
            aws_sdk_sesv2.types.import_job_summary_list.deserialize_json(
                data["ImportJobs"]
            )
        )
