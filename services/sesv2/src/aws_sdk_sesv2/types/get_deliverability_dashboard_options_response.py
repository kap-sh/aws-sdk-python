...
class GetDeliverabilityDashboardOptionsResponse(TypedDict, closed=True):
    ...
    account_status: NotRequired[
        "aws_sdk_sesv2.types.deliverability_dashboard_account_status.DeliverabilityDashboardAccountStatus"
    ]
...
def serialize_json(value: GetDeliverabilityDashboardOptionsResponse) -> dict:
    ...
    if "subscription_expiry_date" in value:
        ...
        out["SubscriptionExpiryDate"] = aws_sdk_sesv2.types.timestamp.serialize_json(
    ...
    if "account_status" in value:
        ...
        out["AccountStatus"] = (
            aws_sdk_sesv2.types.deliverability_dashboard_account_status.serialize_json(
    ...
    if "active_subscribed_domains" in value:
        ...
        out["ActiveSubscribedDomains"] = (
            aws_sdk_sesv2.types.domain_deliverability_tracking_options.serialize_json(
...
def deserialize_json(data: dict) -> GetDeliverabilityDashboardOptionsResponse:
    ...
    if "AccountStatus" in data:
        ...
        out["account_status"] = (
            aws_sdk_sesv2.types.deliverability_dashboard_account_status.deserialize_json(
                data["AccountStatus"]
            )
        )
    if "ActiveSubscribedDomains" in data:
        ...
        out["active_subscribed_domains"] = (
            aws_sdk_sesv2.types.domain_deliverability_tracking_options.deserialize_json(
