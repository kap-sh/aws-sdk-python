...
class ListDomainDeliverabilityCampaignsResponse(TypedDict):
    domain_deliverability_campaigns: "aws_sdk_sesv2.types.domain_deliverability_campaign_list.DomainDeliverabilityCampaignList"
...
def serialize_json(value: ListDomainDeliverabilityCampaignsResponse) -> dict:
    ...
    out["DomainDeliverabilityCampaigns"] = (
        aws_sdk_sesv2.types.domain_deliverability_campaign_list.serialize_json(
...
def deserialize_json(data: dict) -> ListDomainDeliverabilityCampaignsResponse:
    ...
    if "DomainDeliverabilityCampaigns" in data:
        ...
        out["domain_deliverability_campaigns"] = (
            aws_sdk_sesv2.types.domain_deliverability_campaign_list.deserialize_json(
