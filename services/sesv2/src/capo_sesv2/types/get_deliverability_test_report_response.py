"""Generated from Smithy shape ``com.amazonaws.sesv2#GetDeliverabilityTestReportResponse``."""
...
if TYPE_CHECKING:
    ...
    import capo_sesv2.types.message_content
    import capo_sesv2.types.placement_statistics
    import capo_sesv2.types.tag_list


class GetDeliverabilityTestReportResponse(TypedDict, closed=True):
    ...
    overall_placement: "capo_sesv2.types.placement_statistics.PlacementStatistics"
    ...
    isp_placements: "capo_sesv2.types.isp_placements.IspPlacements"
    ...
    message: NotRequired["capo_sesv2.types.message_content.MessageContent"]
...
def serialize_json(value: GetDeliverabilityTestReportResponse) -> dict:
    ...
    out["DeliverabilityTestReport"] = (
        capo_sesv2.types.deliverability_test_report.serialize_json(
            value["deliverability_test_report"]
        )
    )
    import capo_sesv2.types.placement_statistics

    out["OverallPlacement"] = capo_sesv2.types.placement_statistics.serialize_json(
        value["overall_placement"]
    )
    import capo_sesv2.types.isp_placements

    out["IspPlacements"] = capo_sesv2.types.isp_placements.serialize_json(
...
def deserialize_json(data: dict) -> GetDeliverabilityTestReportResponse:
    ...
    if "DeliverabilityTestReport" in data:
        ...
        out["deliverability_test_report"] = (
            capo_sesv2.types.deliverability_test_report.deserialize_json(
