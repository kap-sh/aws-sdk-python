"""Generated from Smithy shape ``com.amazonaws.sesv2#PutConfigurationSetSendingOptionsRequest``."""
...
class PutConfigurationSetSendingOptionsRequest(TypedDict, closed=True):
