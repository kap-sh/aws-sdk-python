...
if TYPE_CHECKING:
    import capo_sesv2.types.list_of_contacts
    import capo_sesv2.types.next_token


class ListContactsResponse(TypedDict, closed=True):
    contacts: NotRequired["capo_sesv2.types.list_of_contacts.ListOfContacts"]
...
def serialize_json(value: ListContactsResponse) -> dict:
    ...
    if "contacts" in value:
        ...
        out["Contacts"] = capo_sesv2.types.list_of_contacts.serialize_json(
            value["contacts"]
        )
...
def deserialize_json(data: dict) -> ListContactsResponse:
    ...
    if "Contacts" in data:
        ...
        out["contacts"] = capo_sesv2.types.list_of_contacts.deserialize_json(
            data["Contacts"]
        )
