...
InboxPlacementTrackingOption = TypedDict(
    ...
    {
        "global": "capo_sesv2.types.enabled.Enabled",
        "tracked_isps": NotRequired["capo_sesv2.types.isp_name_list.IspNameList"],
    },
    closed=True,
)
...
def serialize_json(value: InboxPlacementTrackingOption) -> dict:
    ...
    if "tracked_isps" in value:
        ...
        out["TrackedIsps"] = capo_sesv2.types.isp_name_list.serialize_json(
            value["tracked_isps"]
        )
    return out
