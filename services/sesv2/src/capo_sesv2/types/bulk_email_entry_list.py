...
if TYPE_CHECKING:
    import capo_sesv2.types.bulk_email_entry

BulkEmailEntryList: TypeAlias = list["capo_sesv2.types.bulk_email_entry.BulkEmailEntry"]
...
def serialize_json(value: BulkEmailEntryList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_sesv2.types.bulk_email_entry.serialize_json(item))
    return out
