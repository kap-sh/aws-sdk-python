...
if TYPE_CHECKING:
    import capo_sesv2.types.complaint_feedback_type
    import capo_sesv2.types.complaint_sub_type


class Complaint(TypedDict, closed=True):
    complaint_sub_type: NotRequired[
        "capo_sesv2.types.complaint_sub_type.ComplaintSubType"
    ]
    ...
    complaint_feedback_type: NotRequired[
        "capo_sesv2.types.complaint_feedback_type.ComplaintFeedbackType"
    ]
