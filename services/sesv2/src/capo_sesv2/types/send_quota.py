...
if TYPE_CHECKING:
    import capo_sesv2.types.max24_hour_send
    import capo_sesv2.types.max_send_rate
    import capo_sesv2.types.sent_last24_hours


class SendQuota(TypedDict, closed=True):
    max24_hour_send: "capo_sesv2.types.max24_hour_send.Max24HourSend"
    ...
    max_send_rate: "capo_sesv2.types.max_send_rate.MaxSendRate"
    ...
    sent_last24_hours: "capo_sesv2.types.sent_last24_hours.SentLast24Hours"
