...
if TYPE_CHECKING:
    ...
    import capo_sesv2.types.failed_records_s3_url


class FailureInfo(TypedDict, closed=True):
    failed_records_s3_url: NotRequired[
        "capo_sesv2.types.failed_records_s3_url.FailedRecordsS3Url"
    ]
    """<p>An Amazon S3 pre-signed URL that contains all the failed records and related information.</p>"""
    error_message: NotRequired["capo_sesv2.types.error_message.ErrorMessage"]
