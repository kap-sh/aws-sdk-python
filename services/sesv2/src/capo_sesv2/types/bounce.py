...
if TYPE_CHECKING:
    import capo_sesv2.types.bounce_sub_type
    import capo_sesv2.types.bounce_type
    import capo_sesv2.types.diagnostic_code


class Bounce(TypedDict, closed=True):
    bounce_type: NotRequired["capo_sesv2.types.bounce_type.BounceType"]
    ...
    bounce_sub_type: NotRequired["capo_sesv2.types.bounce_sub_type.BounceSubType"]
    """<p>The subtype of the bounce, as determined by SES.</p>"""
    diagnostic_code: NotRequired["capo_sesv2.types.diagnostic_code.DiagnosticCode"]
...
def serialize_json(value: Bounce) -> dict:
    ...
    if "bounce_type" in value:
        ...
        out["BounceType"] = capo_sesv2.types.bounce_type.serialize_json(
            value["bounce_type"]
        )
