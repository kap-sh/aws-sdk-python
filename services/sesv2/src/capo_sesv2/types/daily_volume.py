...
class DailyVolume(TypedDict, closed=True):
    ...
    volume_statistics: NotRequired[
        "capo_sesv2.types.volume_statistics.VolumeStatistics"
    ]
    ...
    domain_isp_placements: NotRequired[
        "capo_sesv2.types.domain_isp_placements.DomainIspPlacements"
    ]
...
def serialize_json(value: DailyVolume) -> dict:
    ...
    if "start_date" in value:
        ...
        out["StartDate"] = capo_sesv2.types.timestamp.serialize_json(
            value["start_date"]
        )
    if "volume_statistics" in value:
        import capo_sesv2.types.volume_statistics

        out["VolumeStatistics"] = capo_sesv2.types.volume_statistics.serialize_json(
    ...
    if "domain_isp_placements" in value:
        ...
        out["DomainIspPlacements"] = (
            capo_sesv2.types.domain_isp_placements.serialize_json(
...
def deserialize_json(data: dict) -> DailyVolume:
    ...
    if "DomainIspPlacements" in data:
        ...
        out["domain_isp_placements"] = (
            capo_sesv2.types.domain_isp_placements.deserialize_json(
