"""Generated from Smithy shape ``com.amazonaws.sesv2#SuppressionOptions``."""
...
if TYPE_CHECKING:
    ...
    import capo_sesv2.types.suppression_validation_options


class SuppressionOptions(TypedDict, closed=True):
    ...
    validation_options: NotRequired[
        "capo_sesv2.types.suppression_validation_options.SuppressionValidationOptions"
    ]


# --- restJson1 ser/de ---
def serialize_json(value: SuppressionOptions) -> dict:
    out: dict = {}
    ...
    if "validation_options" in value:
        ...
        out["ValidationOptions"] = (
            capo_sesv2.types.suppression_validation_options.serialize_json(
...
def deserialize_json(data: dict) -> SuppressionOptions:
    out: SuppressionOptions = {}  # type: ignore[typeddict-item]
    ...
    if "ValidationOptions" in data:
        ...
        out["validation_options"] = (
            capo_sesv2.types.suppression_validation_options.deserialize_json(
