"""Generated from Smithy shape ``com.amazonaws.sesv2#GetReputationEntity``."""
...
import capo_sesv2.types.get_reputation_entity_request
import capo_sesv2.types.get_reputation_entity_response
...
) -> capo_sesv2.types.get_reputation_entity_response.GetReputationEntityResponse:
    out: capo_sesv2.types.get_reputation_entity_response.GetReputationEntityResponse = (
        capo_sesv2.types.get_reputation_entity_response.deserialize_json(
...
async def async_get_reputation_entity(
