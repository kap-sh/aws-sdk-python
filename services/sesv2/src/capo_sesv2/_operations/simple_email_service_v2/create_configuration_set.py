"""Generated from Smithy shape ``com.amazonaws.sesv2#CreateConfigurationSet``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.create_configuration_set_response.CreateConfigurationSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.create_configuration_set_request.serialize_json(input_)
    ).encode()
