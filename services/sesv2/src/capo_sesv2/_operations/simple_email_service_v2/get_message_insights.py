"""Generated from Smithy shape ``com.amazonaws.sesv2#GetMessageInsights``."""
...
import capo_sesv2.types.get_message_insights_request
import capo_sesv2.types.get_message_insights_response
...
) -> capo_sesv2.types.get_message_insights_response.GetMessageInsightsResponse:
    out: capo_sesv2.types.get_message_insights_response.GetMessageInsightsResponse = (
        capo_sesv2.types.get_message_insights_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/insights/{MessageId}"
...
async def async_get_message_insights(
