"""Generated from Smithy shape ``com.amazonaws.sesv2#DeleteDedicatedIpPool``."""
...
import capo_sesv2.types.delete_dedicated_ip_pool_request
import capo_sesv2.types.delete_dedicated_ip_pool_response
...
) -> capo_sesv2.types.delete_dedicated_ip_pool_response.DeleteDedicatedIpPoolResponse:
    out: capo_sesv2.types.delete_dedicated_ip_pool_response.DeleteDedicatedIpPoolResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/dedicated-ip-pools/{PoolName}"
