"""Generated from Smithy shape ``com.amazonaws.sesv2#GetEmailTemplate``."""
...
import capo_sesv2.types.get_email_template_request
import capo_sesv2.types.get_email_template_response
...
) -> capo_sesv2.types.get_email_template_response.GetEmailTemplateResponse:
    out: capo_sesv2.types.get_email_template_response.GetEmailTemplateResponse = (
        capo_sesv2.types.get_email_template_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/templates/{TemplateName}"
...
async def async_get_email_template(
