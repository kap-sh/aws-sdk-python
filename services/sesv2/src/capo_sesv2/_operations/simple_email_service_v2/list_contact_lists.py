"""Generated from Smithy shape ``com.amazonaws.sesv2#ListContactLists``."""
...
import capo_sesv2.types.list_contact_lists_request
import capo_sesv2.types.list_contact_lists_response
...
def handle_response(
    ...
    out: capo_sesv2.types.list_contact_lists_response.ListContactListsResponse = (
        capo_sesv2.types.list_contact_lists_response.deserialize_json(
...
async def async_list_contact_lists(
