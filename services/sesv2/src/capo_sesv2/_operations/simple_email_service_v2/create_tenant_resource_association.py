"""Generated from Smithy shape ``com.amazonaws.sesv2#CreateTenantResourceAssociation``."""
...
import capo_sesv2.types.create_tenant_resource_association_request
import capo_sesv2.types.create_tenant_resource_association_response
...
) -> capo_sesv2.types.create_tenant_resource_association_response.CreateTenantResourceAssociationResponse:
    out: capo_sesv2.types.create_tenant_resource_association_response.CreateTenantResourceAssociationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/tenants/resources"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_sesv2.types.create_tenant_resource_association_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_tenant_resource_association(
