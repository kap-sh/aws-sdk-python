"""Generated from Smithy shape ``com.amazonaws.sesv2#GetDedicatedIpPool``."""
...
import capo_sesv2.types.get_dedicated_ip_pool_request
import capo_sesv2.types.get_dedicated_ip_pool_response
...
) -> capo_sesv2.types.get_dedicated_ip_pool_response.GetDedicatedIpPoolResponse:
    out: capo_sesv2.types.get_dedicated_ip_pool_response.GetDedicatedIpPoolResponse = (
        capo_sesv2.types.get_dedicated_ip_pool_response.deserialize_json(
...
async def async_get_dedicated_ip_pool(
