"""Generated from Smithy shape ``com.amazonaws.sesv2#GetEmailIdentityPolicies``."""
...
import capo_sesv2.types.get_email_identity_policies_request
import capo_sesv2.types.get_email_identity_policies_response
...
def handle_response(
    ...
    out: capo_sesv2.types.get_email_identity_policies_response.GetEmailIdentityPoliciesResponse = capo_sesv2.types.get_email_identity_policies_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/identities/{EmailIdentity}/policies"
...
async def async_get_email_identity_policies(
