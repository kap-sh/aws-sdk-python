"""Generated from Smithy shape ``com.amazonaws.sesv2#PutSuppressedDestination``."""
...
import capo_sesv2.types.put_suppressed_destination_request
import capo_sesv2.types.put_suppressed_destination_response
...
) -> capo_sesv2.types.put_suppressed_destination_response.PutSuppressedDestinationResponse:
    out: capo_sesv2.types.put_suppressed_destination_response.PutSuppressedDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.put_suppressed_destination_request.serialize_json(input_)
    ).encode()
...
async def async_put_suppressed_destination(
