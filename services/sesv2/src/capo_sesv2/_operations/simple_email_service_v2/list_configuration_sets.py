"""Generated from Smithy shape ``com.amazonaws.sesv2#ListConfigurationSets``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.list_configuration_sets_response.ListConfigurationSetsResponse = capo_sesv2.types.list_configuration_sets_response.deserialize_json(
