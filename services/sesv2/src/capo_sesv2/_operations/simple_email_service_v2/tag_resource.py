"""Generated from Smithy shape ``com.amazonaws.sesv2#TagResource``."""
...
import capo_sesv2.types.tag_resource_request
import capo_sesv2.types.tag_resource_response
...
) -> capo_sesv2.types.tag_resource_response.TagResourceResponse:
    out: capo_sesv2.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/tags"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_sesv2.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    input_: capo_sesv2.types.tag_resource_request.TagResourceRequest,
) -> tuple[capo_sesv2.types.tag_resource_response.TagResourceResponse, zapros.Response]:
