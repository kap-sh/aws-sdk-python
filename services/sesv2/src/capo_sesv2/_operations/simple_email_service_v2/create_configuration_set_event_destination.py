"""Generated from Smithy shape ``com.amazonaws.sesv2#CreateConfigurationSetEventDestination``."""
...
import capo_sesv2.types.create_configuration_set_event_destination_request
import capo_sesv2.types.create_configuration_set_event_destination_response
...
) -> capo_sesv2.types.create_configuration_set_event_destination_response.CreateConfigurationSetEventDestinationResponse:
    out: capo_sesv2.types.create_configuration_set_event_destination_response.CreateConfigurationSetEventDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.create_configuration_set_event_destination_request.serialize_json(
            input_
        )
    ).encode()
