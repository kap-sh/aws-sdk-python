"""Generated from Smithy shape ``com.amazonaws.sesv2#PutEmailIdentityDkimSigningAttributes``."""
...
import capo_sesv2.types.put_email_identity_dkim_signing_attributes_request
import capo_sesv2.types.put_email_identity_dkim_signing_attributes_response
...
def handle_response(
    ...
    out: capo_sesv2.types.put_email_identity_dkim_signing_attributes_response.PutEmailIdentityDkimSigningAttributesResponse = capo_sesv2.types.put_email_identity_dkim_signing_attributes_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.put_email_identity_dkim_signing_attributes_request.serialize_json(
            input_
        )
    ).encode()
