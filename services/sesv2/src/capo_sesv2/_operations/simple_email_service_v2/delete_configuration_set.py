"""Generated from Smithy shape ``com.amazonaws.sesv2#DeleteConfigurationSet``."""
...
import capo_sesv2.types.delete_configuration_set_request
import capo_sesv2.types.delete_configuration_set_response
...
) -> capo_sesv2.types.delete_configuration_set_response.DeleteConfigurationSetResponse:
    out: capo_sesv2.types.delete_configuration_set_response.DeleteConfigurationSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/v2/email/configuration-sets/{ConfigurationSetName}"
    )
    url = url.replace(
