...
import capo_sesv2.errors.account_suspended_exception
import capo_sesv2.errors.bad_request_exception
import capo_sesv2.errors.limit_exceeded_exception
import capo_sesv2.errors.mail_from_domain_not_verified_exception
import capo_sesv2.errors.message_rejected
...
import capo_sesv2.types.send_email_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccountSuspendedException":
            raise capo_sesv2.errors.account_suspended_exception.AccountSuspendedException.from_json(
                data
            )
        ...
        case "LimitExceededException":
            raise capo_sesv2.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
        case "MailFromDomainNotVerifiedException":
            raise capo_sesv2.errors.mail_from_domain_not_verified_exception.MailFromDomainNotVerifiedException.from_json(
                data
            )
        case "MessageRejected":
            raise capo_sesv2.errors.message_rejected.MessageRejected.from_json(data)
        case "NotFoundException":
            raise capo_sesv2.errors.not_found_exception.NotFoundException.from_json(
                data
            )
        case "SendingPausedException":
            raise capo_sesv2.errors.sending_paused_exception.SendingPausedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_sesv2.types.send_email_response.SendEmailResponse = (
        capo_sesv2.types.send_email_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.send_email_request.serialize_json(input_)
    ).encode()
...
def send_email(
    ...
    input_: capo_sesv2.types.send_email_request.SendEmailRequest,
) -> tuple[capo_sesv2.types.send_email_response.SendEmailResponse, zapros.Response]:
