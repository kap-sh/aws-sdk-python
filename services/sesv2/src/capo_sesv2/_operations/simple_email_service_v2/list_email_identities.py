"""Generated from Smithy shape ``com.amazonaws.sesv2#ListEmailIdentities``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.list_email_identities_response.ListEmailIdentitiesResponse = (
        capo_sesv2.types.list_email_identities_response.deserialize_json(
...
async def async_list_email_identities(
