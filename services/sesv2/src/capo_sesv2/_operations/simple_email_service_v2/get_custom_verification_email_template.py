"""Generated from Smithy shape ``com.amazonaws.sesv2#GetCustomVerificationEmailTemplate``."""
...
import capo_sesv2.types.get_custom_verification_email_template_request
import capo_sesv2.types.get_custom_verification_email_template_response
...
def handle_response(
    ...
    out: capo_sesv2.types.get_custom_verification_email_template_response.GetCustomVerificationEmailTemplateResponse = capo_sesv2.types.get_custom_verification_email_template_response.deserialize_json(
