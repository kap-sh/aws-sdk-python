"""Generated from Smithy shape ``com.amazonaws.sesv2#CreateEmailIdentityPolicy``."""
...
import capo_sesv2.types.create_email_identity_policy_request
import capo_sesv2.types.create_email_identity_policy_response
...
def handle_response(
    ...
    out: capo_sesv2.types.create_email_identity_policy_response.CreateEmailIdentityPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.create_email_identity_policy_request.serialize_json(input_)
    ).encode()
...
async def async_create_email_identity_policy(
