"""Generated from Smithy shape ``com.amazonaws.sesv2#PutConfigurationSetReputationOptions``."""
...
import capo_sesv2.types.put_configuration_set_reputation_options_request
import capo_sesv2.types.put_configuration_set_reputation_options_response
...
) -> capo_sesv2.types.put_configuration_set_reputation_options_response.PutConfigurationSetReputationOptionsResponse:
    out: capo_sesv2.types.put_configuration_set_reputation_options_response.PutConfigurationSetReputationOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.put_configuration_set_reputation_options_request.serialize_json(
            input_
        )
    ).encode()
