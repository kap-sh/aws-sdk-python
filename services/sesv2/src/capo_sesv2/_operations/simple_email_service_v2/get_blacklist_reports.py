"""Generated from Smithy shape ``com.amazonaws.sesv2#GetBlacklistReports``."""
...
import capo_sesv2.types.get_blacklist_reports_request
import capo_sesv2.types.get_blacklist_reports_response
...
) -> capo_sesv2.types.get_blacklist_reports_response.GetBlacklistReportsResponse:
    out: capo_sesv2.types.get_blacklist_reports_response.GetBlacklistReportsResponse = (
        capo_sesv2.types.get_blacklist_reports_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/v2/email/deliverability-dashboard/blacklist-report"
    )
    params: dict[str, str] = {}
