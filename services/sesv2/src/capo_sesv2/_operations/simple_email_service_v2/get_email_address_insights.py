"""Generated from Smithy shape ``com.amazonaws.sesv2#GetEmailAddressInsights``."""
...
import capo_sesv2.types.get_email_address_insights_request
import capo_sesv2.types.get_email_address_insights_response
...
def handle_response(
    ...
    capo_sesv2.types.get_email_address_insights_response.GetEmailAddressInsightsResponse
):
    out: capo_sesv2.types.get_email_address_insights_response.GetEmailAddressInsightsResponse = capo_sesv2.types.get_email_address_insights_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.get_email_address_insights_request.serialize_json(input_)
    ).encode()
...
async def async_get_email_address_insights(
