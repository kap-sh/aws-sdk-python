"""Generated from Smithy shape ``com.amazonaws.sesv2#UpdateEmailTemplate``."""
...
import capo_sesv2.types.update_email_template_request
import capo_sesv2.types.update_email_template_response
...
def handle_response(
    ...
    out: capo_sesv2.types.update_email_template_response.UpdateEmailTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.update_email_template_request.serialize_json(input_)
    ).encode()
