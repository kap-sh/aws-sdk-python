"""Generated from Smithy shape ``com.amazonaws.sesv2#GetDedicatedIps``."""
...
import capo_sesv2.types.get_dedicated_ips_request
import capo_sesv2.types.get_dedicated_ips_response
...
) -> capo_sesv2.types.get_dedicated_ips_response.GetDedicatedIpsResponse:
    out: capo_sesv2.types.get_dedicated_ips_response.GetDedicatedIpsResponse = (
        capo_sesv2.types.get_dedicated_ips_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/dedicated-ips"
    params: dict[str, str] = {}
...
def get_dedicated_ips(
    ...
    capo_sesv2.types.get_dedicated_ips_response.GetDedicatedIpsResponse, zapros.Response
]:
