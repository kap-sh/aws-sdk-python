"""Generated from Smithy shape ``com.amazonaws.sesv2#PutConfigurationSetArchivingOptions``."""
...
import capo_sesv2.types.put_configuration_set_archiving_options_request
import capo_sesv2.types.put_configuration_set_archiving_options_response
...
) -> capo_sesv2.types.put_configuration_set_archiving_options_response.PutConfigurationSetArchivingOptionsResponse:
    out: capo_sesv2.types.put_configuration_set_archiving_options_response.PutConfigurationSetArchivingOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.put_configuration_set_archiving_options_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_configuration_set_archiving_options(
