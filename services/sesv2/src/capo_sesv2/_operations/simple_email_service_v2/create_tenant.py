"""Generated from Smithy shape ``com.amazonaws.sesv2#CreateTenant``."""
...
import capo_sesv2.types.create_tenant_request
import capo_sesv2.types.create_tenant_response
...
) -> capo_sesv2.types.create_tenant_response.CreateTenantResponse:
    out: capo_sesv2.types.create_tenant_response.CreateTenantResponse = (
        capo_sesv2.types.create_tenant_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/tenants"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_sesv2.types.create_tenant_request.serialize_json(input_)
    ).encode()
...
def create_tenant(
    ...
    capo_sesv2.types.create_tenant_response.CreateTenantResponse, zapros.Response
]:
