"""Generated from Smithy shape ``com.amazonaws.sesv2#UpdateCustomVerificationEmailTemplate``."""
...
import capo_sesv2.types.update_custom_verification_email_template_request
import capo_sesv2.types.update_custom_verification_email_template_response
...
def handle_response(
    ...
    out: capo_sesv2.types.update_custom_verification_email_template_response.UpdateCustomVerificationEmailTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.update_custom_verification_email_template_request.serialize_json(
            input_
        )
    ).encode()
