"""Generated from Smithy shape ``com.amazonaws.sesv2#GetDedicatedIp``."""
...
import capo_sesv2.types.dedicated_ip
import capo_sesv2.types.get_dedicated_ip_request
import capo_sesv2.types.get_dedicated_ip_response
...
) -> capo_sesv2.types.get_dedicated_ip_response.GetDedicatedIpResponse:
    out: capo_sesv2.types.get_dedicated_ip_response.GetDedicatedIpResponse = (
        capo_sesv2.types.get_dedicated_ip_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/dedicated-ips/{Ip}"
...
def get_dedicated_ip(
    ...
    capo_sesv2.types.get_dedicated_ip_response.GetDedicatedIpResponse, zapros.Response
]:
...
async def async_get_dedicated_ip(
