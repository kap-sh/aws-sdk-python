"""Generated from Smithy shape ``com.amazonaws.sesv2#DeleteTenant``."""
...
import capo_sesv2.types.delete_tenant_request
import capo_sesv2.types.delete_tenant_response
...
) -> capo_sesv2.types.delete_tenant_response.DeleteTenantResponse:
    out: capo_sesv2.types.delete_tenant_response.DeleteTenantResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.delete_tenant_request.serialize_json(input_)
    ).encode()
...
def delete_tenant(
    ...
    capo_sesv2.types.delete_tenant_response.DeleteTenantResponse, zapros.Response
]:
