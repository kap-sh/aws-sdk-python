"""Generated from Smithy shape ``com.amazonaws.sesv2#CreateCustomVerificationEmailTemplate``."""
...
import capo_sesv2.types.create_custom_verification_email_template_request
import capo_sesv2.types.create_custom_verification_email_template_response
...
def handle_response(
    ...
    out: capo_sesv2.types.create_custom_verification_email_template_response.CreateCustomVerificationEmailTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/custom-verification-email-templates"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_sesv2.types.create_custom_verification_email_template_request.serialize_json(
            input_
        )
    ).encode()
