"""Generated from Smithy shape ``com.amazonaws.sesv2#GetDomainStatisticsReport``."""
...
import capo_sesv2.types.get_domain_statistics_report_request
import capo_sesv2.types.get_domain_statistics_report_response
...
) -> capo_sesv2.types.get_domain_statistics_report_response.GetDomainStatisticsReportResponse:
    out: capo_sesv2.types.get_domain_statistics_report_response.GetDomainStatisticsReportResponse = capo_sesv2.types.get_domain_statistics_report_response.deserialize_json(
