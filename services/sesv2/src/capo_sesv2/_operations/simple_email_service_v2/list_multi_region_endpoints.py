"""Generated from Smithy shape ``com.amazonaws.sesv2#ListMultiRegionEndpoints``."""
...
import capo_sesv2.types.list_multi_region_endpoints_request
import capo_sesv2.types.list_multi_region_endpoints_response
...
) -> capo_sesv2.types.list_multi_region_endpoints_response.ListMultiRegionEndpointsResponse:
    out: capo_sesv2.types.list_multi_region_endpoints_response.ListMultiRegionEndpointsResponse = capo_sesv2.types.list_multi_region_endpoints_response.deserialize_json(
...
async def async_list_multi_region_endpoints(
