...
import capo_sesv2.types.send_custom_verification_email_request
import capo_sesv2.types.send_custom_verification_email_response
...
def handle_response(
    ...
    out: capo_sesv2.types.send_custom_verification_email_response.SendCustomVerificationEmailResponse = capo_sesv2.types.send_custom_verification_email_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.send_custom_verification_email_request.serialize_json(input_)
    ).encode()
