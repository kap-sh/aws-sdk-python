"""Generated from Smithy shape ``com.amazonaws.sesv2#ListImportJobs``."""
...
import capo_sesv2.types.list_import_jobs_request
import capo_sesv2.types.list_import_jobs_response
...
) -> capo_sesv2.types.list_import_jobs_response.ListImportJobsResponse:
    out: capo_sesv2.types.list_import_jobs_response.ListImportJobsResponse = (
        capo_sesv2.types.list_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/import-jobs/list"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_sesv2.types.list_import_jobs_request.serialize_json(input_)
    ).encode()
...
def list_import_jobs(
    ...
    capo_sesv2.types.list_import_jobs_response.ListImportJobsResponse, zapros.Response
]:
