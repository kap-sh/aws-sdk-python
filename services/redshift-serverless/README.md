...
```
pip install aws-sdk-redshift-serverless
```

## Usage

```python
from aws_sdk_redshift_serverless import AsyncRedshiftServerlessClient
...
```python
from aws_sdk_redshift_serverless import AsyncRedshiftServerlessClient
from aws_sdk_redshift_serverless.error import AccessDeniedException
