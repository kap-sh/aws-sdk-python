"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#CreateCustomDomainAssociation``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.create_custom_domain_association_response.CreateCustomDomainAssociationResponse = capo_redshift_serverless.types.create_custom_domain_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.CreateCustomDomainAssociation"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.create_custom_domain_association_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_custom_domain_association(
