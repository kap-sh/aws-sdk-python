"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#DeleteResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.delete_resource_policy_response.DeleteResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.DeleteResourcePolicy"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.delete_resource_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
