"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#RestoreFromSnapshot``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.restore_from_snapshot_response.RestoreFromSnapshotResponse = capo_redshift_serverless.types.restore_from_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.RestoreFromSnapshot"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.restore_from_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_restore_from_snapshot(
