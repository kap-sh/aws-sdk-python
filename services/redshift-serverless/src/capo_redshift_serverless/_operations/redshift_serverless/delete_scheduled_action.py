"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#DeleteScheduledAction``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.delete_scheduled_action_response.DeleteScheduledActionResponse = capo_redshift_serverless.types.delete_scheduled_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.DeleteScheduledAction"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.delete_scheduled_action_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_scheduled_action(
