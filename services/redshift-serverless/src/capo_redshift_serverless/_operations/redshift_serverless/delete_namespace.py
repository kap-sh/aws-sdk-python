"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#DeleteNamespace``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.delete_namespace_response.DeleteNamespaceResponse = capo_redshift_serverless.types.delete_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.DeleteNamespace"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.delete_namespace_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
