"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#CreateReservation``."""
...
import capo_redshift_serverless.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_redshift_serverless.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.create_reservation_response.CreateReservationResponse = capo_redshift_serverless.types.create_reservation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.CreateReservation"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.create_reservation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
