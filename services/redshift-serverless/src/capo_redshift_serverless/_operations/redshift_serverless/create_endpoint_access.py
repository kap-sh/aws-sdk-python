"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#CreateEndpointAccess``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.create_endpoint_access_response.CreateEndpointAccessResponse = capo_redshift_serverless.types.create_endpoint_access_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.CreateEndpointAccess"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.create_endpoint_access_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
