"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ListWorkgroups``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.list_workgroups_response.ListWorkgroupsResponse = capo_redshift_serverless.types.list_workgroups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.ListWorkgroups"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.list_workgroups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_workgroups(
