"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetTrack``."""
...
import capo_redshift_serverless.errors.dry_run_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DryRunException":
            raise capo_redshift_serverless.errors.dry_run_exception.DryRunException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.get_track_response.GetTrackResponse = (
        capo_redshift_serverless.types.get_track_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.get_track_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_track(
    ...
    capo_redshift_serverless.types.get_track_response.GetTrackResponse, zapros.Response
]:
