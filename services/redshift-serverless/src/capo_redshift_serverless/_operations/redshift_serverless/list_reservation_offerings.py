...
def handle_response(
    ...
    out: capo_redshift_serverless.types.list_reservation_offerings_response.ListReservationOfferingsResponse = capo_redshift_serverless.types.list_reservation_offerings_response.deserialize_aws_json_1_1(
