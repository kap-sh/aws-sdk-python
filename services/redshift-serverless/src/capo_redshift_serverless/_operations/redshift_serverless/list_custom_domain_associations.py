"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ListCustomDomainAssociations``."""
...
import capo_redshift_serverless.errors.access_denied_exception
import capo_redshift_serverless.errors.internal_server_exception
import capo_redshift_serverless.errors.invalid_pagination_exception
import capo_redshift_serverless.errors.throttling_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_redshift_serverless.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidPaginationException":
            raise capo_redshift_serverless.errors.invalid_pagination_exception.InvalidPaginationException.from_aws_json_1_1(
                data
            )
        case "ThrottlingException":
            raise capo_redshift_serverless.errors.throttling_exception.ThrottlingException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.list_custom_domain_associations_response.ListCustomDomainAssociationsResponse = capo_redshift_serverless.types.list_custom_domain_associations_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_redshift_serverless._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.ListCustomDomainAssociations"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.list_custom_domain_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_custom_domain_associations(
