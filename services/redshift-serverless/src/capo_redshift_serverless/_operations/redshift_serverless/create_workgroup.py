"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#CreateWorkgroup``."""
...
import capo_redshift_serverless.errors.insufficient_capacity_exception
import capo_redshift_serverless.errors.internal_server_exception
import capo_redshift_serverless.errors.ipv6_cidr_block_not_found_exception
import capo_redshift_serverless.errors.resource_not_found_exception
import capo_redshift_serverless.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InsufficientCapacityException":
            raise capo_redshift_serverless.errors.insufficient_capacity_exception.InsufficientCapacityException.from_aws_json_1_1(
                data
            )
        ...
        case "Ipv6CidrBlockNotFoundException":
            raise capo_redshift_serverless.errors.ipv6_cidr_block_not_found_exception.Ipv6CidrBlockNotFoundException.from_aws_json_1_1(
                data
            )
        ...
        case "TooManyTagsException":
            raise capo_redshift_serverless.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.create_workgroup_response.CreateWorkgroupResponse = capo_redshift_serverless.types.create_workgroup_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.CreateWorkgroup"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.create_workgroup_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_workgroup(
