"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ListSnapshotCopyConfigurations``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.list_snapshot_copy_configurations_response.ListSnapshotCopyConfigurationsResponse = capo_redshift_serverless.types.list_snapshot_copy_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.ListSnapshotCopyConfigurations"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.list_snapshot_copy_configurations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_snapshot_copy_configurations(
