...
def handle_response(
    ...
    out: capo_redshift_serverless.types.get_custom_domain_association_response.GetCustomDomainAssociationResponse = capo_redshift_serverless.types.get_custom_domain_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.get_custom_domain_association_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
