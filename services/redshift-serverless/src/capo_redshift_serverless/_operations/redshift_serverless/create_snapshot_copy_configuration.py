...
def handle_response(
    ...
    out: capo_redshift_serverless.types.create_snapshot_copy_configuration_response.CreateSnapshotCopyConfigurationResponse = capo_redshift_serverless.types.create_snapshot_copy_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.create_snapshot_copy_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
