"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#DeleteWorkgroup``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.delete_workgroup_response.DeleteWorkgroupResponse = capo_redshift_serverless.types.delete_workgroup_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.DeleteWorkgroup"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.delete_workgroup_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_workgroup(
