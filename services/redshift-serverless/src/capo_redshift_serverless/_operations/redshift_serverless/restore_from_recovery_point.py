...
def handle_response(
    ...
    out: capo_redshift_serverless.types.restore_from_recovery_point_response.RestoreFromRecoveryPointResponse = capo_redshift_serverless.types.restore_from_recovery_point_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.restore_from_recovery_point_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
