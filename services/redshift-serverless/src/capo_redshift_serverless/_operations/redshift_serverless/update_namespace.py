"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#UpdateNamespace``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.update_namespace_response.UpdateNamespaceResponse = capo_redshift_serverless.types.update_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.UpdateNamespace"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.update_namespace_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_namespace(
