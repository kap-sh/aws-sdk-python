"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#PutResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.put_resource_policy_response.PutResourcePolicyResponse = capo_redshift_serverless.types.put_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.PutResourcePolicy"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.put_resource_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
