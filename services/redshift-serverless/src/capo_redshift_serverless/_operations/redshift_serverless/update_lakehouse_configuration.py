"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#UpdateLakehouseConfiguration``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.update_lakehouse_configuration_response.UpdateLakehouseConfigurationResponse = capo_redshift_serverless.types.update_lakehouse_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.UpdateLakehouseConfiguration"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.update_lakehouse_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_lakehouse_configuration(
