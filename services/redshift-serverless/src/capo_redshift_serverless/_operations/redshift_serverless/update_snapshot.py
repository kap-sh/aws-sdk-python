"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#UpdateSnapshot``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.update_snapshot_response.UpdateSnapshotResponse = capo_redshift_serverless.types.update_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.UpdateSnapshot"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.update_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
