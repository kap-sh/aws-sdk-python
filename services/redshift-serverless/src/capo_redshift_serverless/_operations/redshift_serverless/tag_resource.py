"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#TagResource``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.TagResource"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.tag_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
