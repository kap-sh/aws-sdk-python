"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetReservation``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.get_reservation_response.GetReservationResponse = capo_redshift_serverless.types.get_reservation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.GetReservation"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.get_reservation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
