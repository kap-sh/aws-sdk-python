"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#CreateUsageLimitResponse``."""
...
class CreateUsageLimitResponse(TypedDict, closed=True):
    usage_limit: NotRequired["capo_redshift_serverless.types.usage_limit.UsageLimit"]
    """<p>The returned usage limit object.</p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateUsageLimitResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> CreateUsageLimitResponse:
    out: CreateUsageLimitResponse = {}  # type: ignore[typeddict-item]
