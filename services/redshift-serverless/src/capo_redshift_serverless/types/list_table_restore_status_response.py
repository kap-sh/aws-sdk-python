...
if TYPE_CHECKING:
    ...
    import capo_redshift_serverless.types.table_restore_status_list


class ListTableRestoreStatusResponse(TypedDict, closed=True):
    ...
    table_restore_statuses: NotRequired[
        "capo_redshift_serverless.types.table_restore_status_list.TableRestoreStatusList"
    ]
...
def serialize_aws_json_1_1(value: ListTableRestoreStatusResponse) -> dict:
    ...
    if "table_restore_statuses" in value:
        ...
        out["tableRestoreStatuses"] = (
            capo_redshift_serverless.types.table_restore_status_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListTableRestoreStatusResponse:
    ...
    if "tableRestoreStatuses" in data:
        ...
        out["table_restore_statuses"] = (
            capo_redshift_serverless.types.table_restore_status_list.deserialize_aws_json_1_1(
