...
TrackList: TypeAlias = list[
    "capo_redshift_serverless.types.serverless_track.ServerlessTrack"
]
...
def serialize_aws_json_1_1(value: TrackList) -> list:
    ...
    for item in value:
        out.append(
            capo_redshift_serverless.types.serverless_track.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> TrackList:
    ...
    for item in data:
        out.append(
            capo_redshift_serverless.types.serverless_track.deserialize_aws_json_1_1(
                item
            )
        )
    return out
