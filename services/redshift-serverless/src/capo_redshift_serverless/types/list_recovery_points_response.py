...
class ListRecoveryPointsResponse(TypedDict, closed=True):
    recovery_points: NotRequired[
        "capo_redshift_serverless.types.recovery_point_list.RecoveryPointList"
    ]
...
def serialize_aws_json_1_1(value: ListRecoveryPointsResponse) -> dict:
    ...
    if "recovery_points" in value:
        ...
        out["recoveryPoints"] = (
            capo_redshift_serverless.types.recovery_point_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListRecoveryPointsResponse:
    ...
    if "recoveryPoints" in data:
        ...
        out["recovery_points"] = (
            capo_redshift_serverless.types.recovery_point_list.deserialize_aws_json_1_1(
                data["recoveryPoints"]
            )
        )
