...
SnapshotList: TypeAlias = list["capo_redshift_serverless.types.snapshot.Snapshot"]
...
def serialize_aws_json_1_1(value: SnapshotList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_redshift_serverless.types.snapshot.serialize_aws_json_1_1(item))
    return out
