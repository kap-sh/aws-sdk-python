...
class EndpointAccess(TypedDict, closed=True):
    ...
    vpc_security_groups: NotRequired[
        "capo_redshift_serverless.types.vpc_security_group_membership_list.VpcSecurityGroupMembershipList"
    ]
    """<p>The security groups associated with the endpoint.</p>"""
    vpc_endpoint: NotRequired["capo_redshift_serverless.types.vpc_endpoint.VpcEndpoint"]
...
def serialize_aws_json_1_1(value: EndpointAccess) -> dict:
    ...
    if "vpc_security_groups" in value:
        ...
        out["vpcSecurityGroups"] = (
            capo_redshift_serverless.types.vpc_security_group_membership_list.serialize_aws_json_1_1(
    ...
    if "vpc_endpoint" in value:
        ...
        out["vpcEndpoint"] = (
            capo_redshift_serverless.types.vpc_endpoint.serialize_aws_json_1_1(
                value["vpc_endpoint"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> EndpointAccess:
    ...
    if "vpcSecurityGroups" in data:
        ...
        out["vpc_security_groups"] = (
            capo_redshift_serverless.types.vpc_security_group_membership_list.deserialize_aws_json_1_1(
    ...
    if "vpcEndpoint" in data:
        ...
        out["vpc_endpoint"] = (
            capo_redshift_serverless.types.vpc_endpoint.deserialize_aws_json_1_1(
                data["vpcEndpoint"]
            )
        )
