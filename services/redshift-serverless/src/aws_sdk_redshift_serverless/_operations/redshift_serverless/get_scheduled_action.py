"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetScheduledAction``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.get_scheduled_action_response.GetScheduledActionResponse = aws_sdk_redshift_serverless.types.get_scheduled_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_scheduled_action_request.GetScheduledActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.GetScheduledAction"
    import aws_sdk_redshift_serverless.types.get_scheduled_action_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.get_scheduled_action_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_scheduled_action(
