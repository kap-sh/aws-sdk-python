...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.list_snapshot_copy_configurations_response.ListSnapshotCopyConfigurationsResponse = aws_sdk_redshift_serverless.types.list_snapshot_copy_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.list_snapshot_copy_configurations_request.ListSnapshotCopyConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.list_snapshot_copy_configurations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
