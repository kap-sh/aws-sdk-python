"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetCustomDomainAssociation``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ThrottlingException":
            import aws_sdk_redshift_serverless.errors.throttling_exception

            raise aws_sdk_redshift_serverless.errors.throttling_exception.ThrottlingException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.get_custom_domain_association_response.GetCustomDomainAssociationResponse = aws_sdk_redshift_serverless.types.get_custom_domain_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_custom_domain_association_request.GetCustomDomainAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.GetCustomDomainAssociation"
    import aws_sdk_redshift_serverless.types.get_custom_domain_association_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.get_custom_domain_association_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_custom_domain_association(
