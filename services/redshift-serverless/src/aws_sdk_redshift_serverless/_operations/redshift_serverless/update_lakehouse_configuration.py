...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DryRunException":
            import aws_sdk_redshift_serverless.errors.dry_run_exception

            raise aws_sdk_redshift_serverless.errors.dry_run_exception.DryRunException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.update_lakehouse_configuration_response.UpdateLakehouseConfigurationResponse = aws_sdk_redshift_serverless.types.update_lakehouse_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.update_lakehouse_configuration_request.UpdateLakehouseConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.update_lakehouse_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
