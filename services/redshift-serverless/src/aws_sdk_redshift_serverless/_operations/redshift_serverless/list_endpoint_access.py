"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ListEndpointAccess``."""
...
import aws_sdk_redshift_serverless.types.endpoint_access_list
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.list_endpoint_access_response.ListEndpointAccessResponse = aws_sdk_redshift_serverless.types.list_endpoint_access_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.list_endpoint_access_request.ListEndpointAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.ListEndpointAccess"
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.list_endpoint_access_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_endpoint_access(
