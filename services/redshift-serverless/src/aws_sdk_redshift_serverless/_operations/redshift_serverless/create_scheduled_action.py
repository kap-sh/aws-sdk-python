"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#CreateScheduledAction``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.create_scheduled_action_response.CreateScheduledActionResponse = aws_sdk_redshift_serverless.types.create_scheduled_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.create_scheduled_action_request.CreateScheduledActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.CreateScheduledAction"
    import aws_sdk_redshift_serverless.types.create_scheduled_action_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.create_scheduled_action_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_scheduled_action(
