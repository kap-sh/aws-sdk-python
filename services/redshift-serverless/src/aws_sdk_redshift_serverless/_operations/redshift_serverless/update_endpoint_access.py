"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#UpdateEndpointAccess``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.update_endpoint_access_response.UpdateEndpointAccessResponse = aws_sdk_redshift_serverless.types.update_endpoint_access_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.update_endpoint_access_request.UpdateEndpointAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.UpdateEndpointAccess"
    import aws_sdk_redshift_serverless.types.update_endpoint_access_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.update_endpoint_access_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_endpoint_access(
