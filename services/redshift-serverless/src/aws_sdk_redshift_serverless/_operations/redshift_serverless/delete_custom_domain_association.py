"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#DeleteCustomDomainAssociation``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.delete_custom_domain_association_response.DeleteCustomDomainAssociationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.delete_custom_domain_association_request.DeleteCustomDomainAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.DeleteCustomDomainAssociation"
    import aws_sdk_redshift_serverless.types.delete_custom_domain_association_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.delete_custom_domain_association_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_custom_domain_association(
