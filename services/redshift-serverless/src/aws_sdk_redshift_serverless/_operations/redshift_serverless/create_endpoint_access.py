...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.create_endpoint_access_response.CreateEndpointAccessResponse = aws_sdk_redshift_serverless.types.create_endpoint_access_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.create_endpoint_access_request.CreateEndpointAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.create_endpoint_access_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
