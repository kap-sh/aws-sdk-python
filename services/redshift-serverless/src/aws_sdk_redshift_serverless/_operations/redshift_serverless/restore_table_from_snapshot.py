"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#RestoreTableFromSnapshot``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.restore_table_from_snapshot_response.RestoreTableFromSnapshotResponse = aws_sdk_redshift_serverless.types.restore_table_from_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.restore_table_from_snapshot_request.RestoreTableFromSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.RestoreTableFromSnapshot"
    import aws_sdk_redshift_serverless.types.restore_table_from_snapshot_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.restore_table_from_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_restore_table_from_snapshot(
