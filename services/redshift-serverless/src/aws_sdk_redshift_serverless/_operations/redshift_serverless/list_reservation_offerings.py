"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ListReservationOfferings``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.list_reservation_offerings_response.ListReservationOfferingsResponse = aws_sdk_redshift_serverless.types.list_reservation_offerings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.list_reservation_offerings_request.ListReservationOfferingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.ListReservationOfferings"
    body: bytes | None = b""
...
async def async_list_reservation_offerings(
