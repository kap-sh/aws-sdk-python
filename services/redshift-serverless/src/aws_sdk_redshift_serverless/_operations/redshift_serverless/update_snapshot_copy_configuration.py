"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#UpdateSnapshotCopyConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.update_snapshot_copy_configuration_response.UpdateSnapshotCopyConfigurationResponse = aws_sdk_redshift_serverless.types.update_snapshot_copy_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.update_snapshot_copy_configuration_request.UpdateSnapshotCopyConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.UpdateSnapshotCopyConfiguration"
    import aws_sdk_redshift_serverless.types.update_snapshot_copy_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.update_snapshot_copy_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_snapshot_copy_configuration(
