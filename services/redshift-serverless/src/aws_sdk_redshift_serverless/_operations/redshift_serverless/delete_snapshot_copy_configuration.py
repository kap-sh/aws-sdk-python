...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.delete_snapshot_copy_configuration_response.DeleteSnapshotCopyConfigurationResponse = aws_sdk_redshift_serverless.types.delete_snapshot_copy_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.delete_snapshot_copy_configuration_request.DeleteSnapshotCopyConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.delete_snapshot_copy_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
