...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.update_usage_limit_response.UpdateUsageLimitResponse = aws_sdk_redshift_serverless.types.update_usage_limit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.update_usage_limit_request.UpdateUsageLimitRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.update_usage_limit_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
