"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#CreateNamespace``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.create_namespace_response.CreateNamespaceResponse = aws_sdk_redshift_serverless.types.create_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.create_namespace_request.CreateNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.CreateNamespace"
    import aws_sdk_redshift_serverless.types.create_namespace_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.create_namespace_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
