...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.get_reservation_response.GetReservationResponse = aws_sdk_redshift_serverless.types.get_reservation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_reservation_request.GetReservationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.get_reservation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
