...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_recovery_point_request.GetRecoveryPointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.get_recovery_point_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
