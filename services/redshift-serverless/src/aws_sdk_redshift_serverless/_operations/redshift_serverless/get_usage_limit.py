...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.get_usage_limit_response.GetUsageLimitResponse = aws_sdk_redshift_serverless.types.get_usage_limit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_usage_limit_request.GetUsageLimitRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.get_usage_limit_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
