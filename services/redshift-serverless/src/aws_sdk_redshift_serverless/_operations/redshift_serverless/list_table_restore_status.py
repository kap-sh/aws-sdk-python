"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ListTableRestoreStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.list_table_restore_status_response.ListTableRestoreStatusResponse = aws_sdk_redshift_serverless.types.list_table_restore_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.list_table_restore_status_request.ListTableRestoreStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_table_restore_status(
