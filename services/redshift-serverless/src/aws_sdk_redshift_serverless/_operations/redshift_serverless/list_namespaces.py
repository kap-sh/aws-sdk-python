"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ListNamespaces``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.list_namespaces_response.ListNamespacesResponse = aws_sdk_redshift_serverless.types.list_namespaces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.list_namespaces_request.ListNamespacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.ListNamespaces"
    body: bytes | None = b""
