"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ConvertRecoveryPointToSnapshot``."""
...
import aws_sdk_redshift_serverless.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            raise aws_sdk_redshift_serverless.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.convert_recovery_point_to_snapshot_response.ConvertRecoveryPointToSnapshotResponse = aws_sdk_redshift_serverless.types.convert_recovery_point_to_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.convert_recovery_point_to_snapshot_request.ConvertRecoveryPointToSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.ConvertRecoveryPointToSnapshot"
    import aws_sdk_redshift_serverless.types.convert_recovery_point_to_snapshot_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.convert_recovery_point_to_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_convert_recovery_point_to_snapshot(
