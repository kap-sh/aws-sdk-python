"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#UpdateScheduledAction``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.update_scheduled_action_response.UpdateScheduledActionResponse = aws_sdk_redshift_serverless.types.update_scheduled_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.update_scheduled_action_request.UpdateScheduledActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.UpdateScheduledAction"
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.update_scheduled_action_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
