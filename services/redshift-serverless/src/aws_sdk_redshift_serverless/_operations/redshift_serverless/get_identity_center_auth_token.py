...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.get_identity_center_auth_token_response.GetIdentityCenterAuthTokenResponse = aws_sdk_redshift_serverless.types.get_identity_center_auth_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_identity_center_auth_token_request.GetIdentityCenterAuthTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
