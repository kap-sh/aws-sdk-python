"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ListUsageLimits``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.list_usage_limits_response.ListUsageLimitsResponse = aws_sdk_redshift_serverless.types.list_usage_limits_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.list_usage_limits_request.ListUsageLimitsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.ListUsageLimits"
    import aws_sdk_redshift_serverless.types.list_usage_limits_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.list_usage_limits_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_usage_limits(
