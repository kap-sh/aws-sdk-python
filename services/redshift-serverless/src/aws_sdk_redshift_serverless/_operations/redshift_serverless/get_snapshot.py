...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.get_snapshot_response.GetSnapshotResponse = aws_sdk_redshift_serverless.types.get_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_snapshot_request.GetSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.get_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
