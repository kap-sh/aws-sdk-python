"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#CreateSnapshot``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.create_snapshot_response.CreateSnapshotResponse = aws_sdk_redshift_serverless.types.create_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.create_snapshot_request.CreateSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.CreateSnapshot"
    import aws_sdk_redshift_serverless.types.create_snapshot_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.create_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
