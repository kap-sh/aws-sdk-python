...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.get_track_response.GetTrackResponse = (
        aws_sdk_redshift_serverless.types.get_track_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_track_request.GetTrackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
