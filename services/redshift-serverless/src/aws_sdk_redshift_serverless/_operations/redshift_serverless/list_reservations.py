"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ListReservations``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.list_reservations_response.ListReservationsResponse = aws_sdk_redshift_serverless.types.list_reservations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.list_reservations_request.ListReservationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.ListReservations"
    body: bytes | None = b""
