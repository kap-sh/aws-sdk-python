...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.list_scheduled_actions_response.ListScheduledActionsResponse = aws_sdk_redshift_serverless.types.list_scheduled_actions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.list_scheduled_actions_request.ListScheduledActionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.list_scheduled_actions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
