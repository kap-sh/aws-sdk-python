"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#UpdateWorkgroup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InsufficientCapacityException":
            import aws_sdk_redshift_serverless.errors.insufficient_capacity_exception

            raise aws_sdk_redshift_serverless.errors.insufficient_capacity_exception.InsufficientCapacityException.from_aws_json_1_1(
                data
            )
        ...
        case "Ipv6CidrBlockNotFoundException":
            import aws_sdk_redshift_serverless.errors.ipv6_cidr_block_not_found_exception

            raise aws_sdk_redshift_serverless.errors.ipv6_cidr_block_not_found_exception.Ipv6CidrBlockNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.update_workgroup_response.UpdateWorkgroupResponse = aws_sdk_redshift_serverless.types.update_workgroup_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.update_workgroup_request.UpdateWorkgroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.UpdateWorkgroup"
    import aws_sdk_redshift_serverless.types.update_workgroup_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.update_workgroup_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_workgroup(
