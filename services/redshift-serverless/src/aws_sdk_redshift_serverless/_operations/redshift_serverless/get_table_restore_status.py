"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetTableRestoreStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.get_table_restore_status_response.GetTableRestoreStatusResponse = aws_sdk_redshift_serverless.types.get_table_restore_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_table_restore_status_request.GetTableRestoreStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.GetTableRestoreStatus"
    import aws_sdk_redshift_serverless.types.get_table_restore_status_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.get_table_restore_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_table_restore_status(
