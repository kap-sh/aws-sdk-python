"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#CreateSnapshotCopyConfiguration``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            import aws_sdk_redshift_serverless.errors.access_denied_exception

            raise aws_sdk_redshift_serverless.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_redshift_serverless.errors.service_quota_exceeded_exception

            raise aws_sdk_redshift_serverless.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.create_snapshot_copy_configuration_response.CreateSnapshotCopyConfigurationResponse = aws_sdk_redshift_serverless.types.create_snapshot_copy_configuration_response.deserialize_aws_json_1_1(
...
def get_signer(
...
) -> aws_sdk_redshift_serverless._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_redshift_serverless._auth._sigv4.build_sigv4_auth_scheme(
                "redshift-serverless", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_redshift_serverless._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.create_snapshot_copy_configuration_request.CreateSnapshotCopyConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.CreateSnapshotCopyConfiguration"
    import aws_sdk_redshift_serverless.types.create_snapshot_copy_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.create_snapshot_copy_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_snapshot_copy_configuration(
