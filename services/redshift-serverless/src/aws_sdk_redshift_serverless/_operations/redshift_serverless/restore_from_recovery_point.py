"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#RestoreFromRecoveryPoint``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.restore_from_recovery_point_response.RestoreFromRecoveryPointResponse = aws_sdk_redshift_serverless.types.restore_from_recovery_point_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.restore_from_recovery_point_request.RestoreFromRecoveryPointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.RestoreFromRecoveryPoint"
    import aws_sdk_redshift_serverless.types.restore_from_recovery_point_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.restore_from_recovery_point_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_restore_from_recovery_point(
