...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.delete_snapshot_response.DeleteSnapshotResponse = aws_sdk_redshift_serverless.types.delete_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.delete_snapshot_request.DeleteSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.delete_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
