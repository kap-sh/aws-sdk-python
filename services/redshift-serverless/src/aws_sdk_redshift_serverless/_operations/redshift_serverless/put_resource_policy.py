...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.put_resource_policy_response.PutResourcePolicyResponse = aws_sdk_redshift_serverless.types.put_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.put_resource_policy_request.PutResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.put_resource_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
