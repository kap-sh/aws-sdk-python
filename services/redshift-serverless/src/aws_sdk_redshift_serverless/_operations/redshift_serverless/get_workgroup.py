...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.get_workgroup_response.GetWorkgroupResponse = aws_sdk_redshift_serverless.types.get_workgroup_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_workgroup_request.GetWorkgroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.get_workgroup_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
