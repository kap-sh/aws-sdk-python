...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.create_custom_domain_association_response.CreateCustomDomainAssociationResponse = aws_sdk_redshift_serverless.types.create_custom_domain_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.create_custom_domain_association_request.CreateCustomDomainAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.create_custom_domain_association_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
