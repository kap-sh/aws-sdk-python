"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetEndpointAccess``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.get_endpoint_access_response.GetEndpointAccessResponse = aws_sdk_redshift_serverless.types.get_endpoint_access_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_endpoint_access_request.GetEndpointAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.GetEndpointAccess"
    import aws_sdk_redshift_serverless.types.get_endpoint_access_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.get_endpoint_access_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_endpoint_access(
