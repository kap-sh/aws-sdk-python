"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetNamespace``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.get_namespace_response.GetNamespaceResponse = aws_sdk_redshift_serverless.types.get_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_namespace_request.GetNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.GetNamespace"
    import aws_sdk_redshift_serverless.types.get_namespace_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.get_namespace_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
