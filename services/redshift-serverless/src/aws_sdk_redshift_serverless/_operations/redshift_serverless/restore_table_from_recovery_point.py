...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.restore_table_from_recovery_point_response.RestoreTableFromRecoveryPointResponse = aws_sdk_redshift_serverless.types.restore_table_from_recovery_point_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.restore_table_from_recovery_point_request.RestoreTableFromRecoveryPointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.restore_table_from_recovery_point_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
