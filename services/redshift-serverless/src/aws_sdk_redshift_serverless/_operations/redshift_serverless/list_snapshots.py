"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ListSnapshots``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.list_snapshots_response.ListSnapshotsResponse = aws_sdk_redshift_serverless.types.list_snapshots_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.list_snapshots_request.ListSnapshotsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.ListSnapshots"
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.list_snapshots_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
