"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#DeleteUsageLimit``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.delete_usage_limit_response.DeleteUsageLimitResponse = aws_sdk_redshift_serverless.types.delete_usage_limit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.delete_usage_limit_request.DeleteUsageLimitRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.DeleteUsageLimit"
    import aws_sdk_redshift_serverless.types.delete_usage_limit_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.delete_usage_limit_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_usage_limit(
