"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetReservationOffering``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.get_reservation_offering_response.GetReservationOfferingResponse = aws_sdk_redshift_serverless.types.get_reservation_offering_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_reservation_offering_request.GetReservationOfferingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.GetReservationOffering"
    import aws_sdk_redshift_serverless.types.get_reservation_offering_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.get_reservation_offering_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_reservation_offering(
