"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetCredentials``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.get_credentials_response.GetCredentialsResponse = aws_sdk_redshift_serverless.types.get_credentials_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.get_credentials_request.GetCredentialsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.GetCredentials"
    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.get_credentials_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
