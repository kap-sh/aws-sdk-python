"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ListRecoveryPoints``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift_serverless.types.list_recovery_points_response.ListRecoveryPointsResponse = aws_sdk_redshift_serverless.types.list_recovery_points_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_redshift_serverless.types.list_recovery_points_request.ListRecoveryPointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.ListRecoveryPoints"
    import aws_sdk_redshift_serverless.types.list_recovery_points_request

    body: bytes | None = json.dumps(
        aws_sdk_redshift_serverless.types.list_recovery_points_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_recovery_points(
