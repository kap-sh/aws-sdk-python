"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#CreateCustomDomainAssociationResponse``."""
...
class CreateCustomDomainAssociationResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateCustomDomainAssociationResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> CreateCustomDomainAssociationResponse:
    out: CreateCustomDomainAssociationResponse = {}  # type: ignore[typeddict-item]
