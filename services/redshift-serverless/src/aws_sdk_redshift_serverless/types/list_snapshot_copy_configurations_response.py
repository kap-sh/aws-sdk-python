...
if TYPE_CHECKING:
    ...
    import aws_sdk_redshift_serverless.types.snapshot_copy_configurations


class ListSnapshotCopyConfigurationsResponse(TypedDict):
    ...
    snapshot_copy_configurations: "aws_sdk_redshift_serverless.types.snapshot_copy_configurations.SnapshotCopyConfigurations"
...
def serialize_aws_json_1_1(value: ListSnapshotCopyConfigurationsResponse) -> dict:
    ...
    out["snapshotCopyConfigurations"] = (
        aws_sdk_redshift_serverless.types.snapshot_copy_configurations.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListSnapshotCopyConfigurationsResponse:
    ...
    if "snapshotCopyConfigurations" in data:
        ...
        out["snapshot_copy_configurations"] = (
            aws_sdk_redshift_serverless.types.snapshot_copy_configurations.deserialize_aws_json_1_1(
