...
if TYPE_CHECKING:
    ...
    import aws_sdk_redshift_serverless.types.currency_code
    import aws_sdk_redshift_serverless.types.duration
...
class ReservationOffering(TypedDict):
    ...
    upfront_charge: "aws_sdk_redshift_serverless.types.charge.Charge"
    """<p>The up-front price you are charged for the reservation.</p>"""
    hourly_charge: "aws_sdk_redshift_serverless.types.charge.Charge"
    """<p>The rate you are charged for each hour the reservation is active.</p>"""
    currency_code: NotRequired[
        "aws_sdk_redshift_serverless.types.currency_code.CurrencyCode"
    ]
    """<p>The currency code for the offering.</p>"""
    offering_type: NotRequired[
        "aws_sdk_redshift_serverless.types.offering_type.OfferingType"
    ]
