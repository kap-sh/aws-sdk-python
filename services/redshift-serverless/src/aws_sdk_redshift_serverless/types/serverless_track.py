...
class ServerlessTrack(TypedDict, closed=True):
    ...
    update_targets: NotRequired[
        "aws_sdk_redshift_serverless.types.update_targets_list.UpdateTargetsList"
    ]
...
def serialize_aws_json_1_1(value: ServerlessTrack) -> dict:
    ...
    if "update_targets" in value:
        ...
        out["updateTargets"] = (
            aws_sdk_redshift_serverless.types.update_targets_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ServerlessTrack:
    ...
    if "updateTargets" in data:
        ...
        out["update_targets"] = (
            aws_sdk_redshift_serverless.types.update_targets_list.deserialize_aws_json_1_1(
                data["updateTargets"]
            )
        )
    return out
