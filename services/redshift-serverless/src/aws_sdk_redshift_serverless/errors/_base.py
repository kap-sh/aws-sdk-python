...
class RedshiftServerlessError(Exception):
    """Base class for all RedshiftServerless service errors."""


class ServiceError(RedshiftServerlessError):
...
class SerializationError(RedshiftServerlessError):
    """Raised when a value cannot be serialized."""


class DeserializationError(RedshiftServerlessError):
...
class WaiterFailedError(RedshiftServerlessError):
...
class WaiterTimeoutError(RedshiftServerlessError):
