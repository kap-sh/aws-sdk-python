"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshiftserverless#ConflictException``."""
