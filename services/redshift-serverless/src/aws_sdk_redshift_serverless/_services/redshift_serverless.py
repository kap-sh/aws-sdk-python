...
from aws_sdk_redshift_serverless._services._aws_config import aws_config
...
class RedshiftServerlessClientConfig(TypedDict, total=False, closed=True):
...
class RedshiftServerlessClient:
    ...
    def __init__(
        ...
        self._config = RedshiftServerlessClientConfig(
            {
    ...
    def operation_options(
        ...
        overrides: RedshiftServerlessClientConfig = config_overrides or {}
    ...
    def create_custom_domain_association(
        ...
        *,
        ...
        Raises:
            ...
            aws_sdk_redshift_serverless.errors.throttling_exception.ThrottlingException: <p>The request was denied due to request throttling.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.create_custom_domain_association_request.CreateCustomDomainAssociationRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.create_custom_domain_association_response.CreateCustomDomainAssociationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.create_custom_domain_association.create_custom_domain_association(
    ...
    def delete_custom_domain_association(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.delete_custom_domain_association_request.DeleteCustomDomainAssociationRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.delete_custom_domain_association_response.DeleteCustomDomainAssociationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.delete_custom_domain_association.delete_custom_domain_association(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.delete_resource_policy_request.DeleteResourcePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.delete_resource_policy_response.DeleteResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.delete_resource_policy.delete_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_credentials(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.get_credentials_request.GetCredentialsRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.get_credentials_response.GetCredentialsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.get_credentials.get_credentials(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_custom_domain_association(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.get_custom_domain_association_request.GetCustomDomainAssociationRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.get_custom_domain_association_response.GetCustomDomainAssociationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.get_custom_domain_association.get_custom_domain_association(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_identity_center_auth_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.get_identity_center_auth_token_request.GetIdentityCenterAuthTokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.get_identity_center_auth_token_response.GetIdentityCenterAuthTokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.get_identity_center_auth_token.get_identity_center_auth_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.get_resource_policy_request.GetResourcePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.get_resource_policy_response.GetResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.get_resource_policy.get_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_track(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.get_track_request.GetTrackRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.get_track_response.GetTrackResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.get_track.get_track(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_custom_domain_associations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.list_custom_domain_associations_request.ListCustomDomainAssociationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.list_custom_domain_associations_response.ListCustomDomainAssociationsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.list_custom_domain_associations.list_custom_domain_associations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_custom_domain_associations(
        self,
        *,
        config_overrides: Optional[RedshiftServerlessClientConfig] = None,
        next_token: Optional[
    ...
    ) -> "Iterator[aws_sdk_redshift_serverless.types.association.Association]":
        _token = next_token
        while True:
            _response = self.list_custom_domain_associations(
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tracks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.list_tracks_request.ListTracksRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.list_tracks_response.ListTracksResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.list_tracks.list_tracks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_tracks(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[aws_sdk_redshift_serverless.types.serverless_track.ServerlessTrack]":
        _token = next_token
        while True:
            _response = self.list_tracks(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    def put_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.put_resource_policy_request.PutResourcePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.put_resource_policy_response.PutResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.put_resource_policy.put_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_custom_domain_association(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_redshift_serverless.types.update_custom_domain_association_request.UpdateCustomDomainAssociationRequest]",
        ) -> OperationResponse[
            "aws_sdk_redshift_serverless.types.update_custom_domain_association_response.UpdateCustomDomainAssociationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_redshift_serverless._operations.redshift_serverless.update_custom_domain_association.update_custom_domain_association(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
