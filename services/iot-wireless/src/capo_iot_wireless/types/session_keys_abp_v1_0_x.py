...
if TYPE_CHECKING:
    import capo_iot_wireless.types.app_s_key
    import capo_iot_wireless.types.nwk_s_key


class SessionKeysAbpV1_0_x(TypedDict, closed=True):
    nwk_s_key: NotRequired["capo_iot_wireless.types.nwk_s_key.NwkSKey"]
    """<p>The NwkSKey value.</p>"""
    app_s_key: NotRequired["capo_iot_wireless.types.app_s_key.AppSKey"]
