...
class LoRaWANUpdateDevice(TypedDict, closed=True):
    ...
    abp_v1_1: NotRequired["capo_iot_wireless.types.update_abp_v1_1.UpdateAbpV1_1"]
    """<p>ABP device object for update APIs for v1.1</p>"""
    abp_v1_0_x: NotRequired["capo_iot_wireless.types.update_abp_v1_0_x.UpdateAbpV1_0_x"]
    """<p>ABP device object for update APIs for v1.0.x</p>"""
    f_ports: NotRequired["capo_iot_wireless.types.update_f_ports.UpdateFPorts"]
...
def serialize_json(value: LoRaWANUpdateDevice) -> dict:
    ...
    if "abp_v1_1" in value:
        ...
        out["AbpV1_1"] = capo_iot_wireless.types.update_abp_v1_1.serialize_json(
            value["abp_v1_1"]
        )
    if "abp_v1_0_x" in value:
        import capo_iot_wireless.types.update_abp_v1_0_x

        out["AbpV1_0_x"] = capo_iot_wireless.types.update_abp_v1_0_x.serialize_json(
            value["abp_v1_0_x"]
        )
    if "f_ports" in value:
        import capo_iot_wireless.types.update_f_ports

        out["FPorts"] = capo_iot_wireless.types.update_f_ports.serialize_json(
            value["f_ports"]
        )
    return out
