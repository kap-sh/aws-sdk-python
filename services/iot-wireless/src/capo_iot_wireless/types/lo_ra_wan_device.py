...
if TYPE_CHECKING:
    import capo_iot_wireless.types.abp_v1_0_x
    import capo_iot_wireless.types.abp_v1_1
    import capo_iot_wireless.types.dev_eui
    import capo_iot_wireless.types.device_profile_id
    import capo_iot_wireless.types.f_ports
    import capo_iot_wireless.types.otaa_v1_0_x
    import capo_iot_wireless.types.otaa_v1_1
...
class LoRaWANDevice(TypedDict, closed=True):
    ...
    otaa_v1_1: NotRequired["capo_iot_wireless.types.otaa_v1_1.OtaaV1_1"]
    """<p>OTAA device object for v1.1 for create APIs</p>"""
    otaa_v1_0_x: NotRequired["capo_iot_wireless.types.otaa_v1_0_x.OtaaV1_0_x"]
    """<p>OTAA device object for create APIs for v1.0.x</p>"""
    abp_v1_1: NotRequired["capo_iot_wireless.types.abp_v1_1.AbpV1_1"]
    """<p>ABP device object for create APIs for v1.1</p>"""
    abp_v1_0_x: NotRequired["capo_iot_wireless.types.abp_v1_0_x.AbpV1_0_x"]
    """<p>LoRaWAN object for create APIs</p>"""
    f_ports: NotRequired["capo_iot_wireless.types.f_ports.FPorts"]
...
def serialize_json(value: LoRaWANDevice) -> dict:
    ...
    if "otaa_v1_1" in value:
        ...
        out["OtaaV1_1"] = capo_iot_wireless.types.otaa_v1_1.serialize_json(
            value["otaa_v1_1"]
        )
    if "otaa_v1_0_x" in value:
        import capo_iot_wireless.types.otaa_v1_0_x

        out["OtaaV1_0_x"] = capo_iot_wireless.types.otaa_v1_0_x.serialize_json(
            value["otaa_v1_0_x"]
        )
    if "abp_v1_1" in value:
        import capo_iot_wireless.types.abp_v1_1

        out["AbpV1_1"] = capo_iot_wireless.types.abp_v1_1.serialize_json(
            value["abp_v1_1"]
        )
    if "abp_v1_0_x" in value:
        import capo_iot_wireless.types.abp_v1_0_x

        out["AbpV1_0_x"] = capo_iot_wireless.types.abp_v1_0_x.serialize_json(
            value["abp_v1_0_x"]
        )
    if "f_ports" in value:
        import capo_iot_wireless.types.f_ports

        out["FPorts"] = capo_iot_wireless.types.f_ports.serialize_json(value["f_ports"])
    return out
...
def deserialize_json(data: dict) -> LoRaWANDevice:
    ...
    if "OtaaV1_1" in data:
        ...
        out["otaa_v1_1"] = capo_iot_wireless.types.otaa_v1_1.deserialize_json(
            data["OtaaV1_1"]
        )
    if "OtaaV1_0_x" in data:
        import capo_iot_wireless.types.otaa_v1_0_x

        out["otaa_v1_0_x"] = capo_iot_wireless.types.otaa_v1_0_x.deserialize_json(
            data["OtaaV1_0_x"]
        )
    if "AbpV1_1" in data:
        import capo_iot_wireless.types.abp_v1_1

        out["abp_v1_1"] = capo_iot_wireless.types.abp_v1_1.deserialize_json(
            data["AbpV1_1"]
        )
    if "AbpV1_0_x" in data:
        import capo_iot_wireless.types.abp_v1_0_x

        out["abp_v1_0_x"] = capo_iot_wireless.types.abp_v1_0_x.deserialize_json(
            data["AbpV1_0_x"]
        )
    if "FPorts" in data:
        import capo_iot_wireless.types.f_ports

        out["f_ports"] = capo_iot_wireless.types.f_ports.deserialize_json(
            data["FPorts"]
        )
    return out
