...
if TYPE_CHECKING:
    import capo_iot_wireless.types.class_b_timeout
    import capo_iot_wireless.types.class_c_timeout
    import capo_iot_wireless.types.factory_preset_freqs_list
    import capo_iot_wireless.types.mac_version
    import capo_iot_wireless.types.max_duty_cycle
    import capo_iot_wireless.types.max_eirp
    import capo_iot_wireless.types.ping_slot_dr
    import capo_iot_wireless.types.ping_slot_freq
    import capo_iot_wireless.types.ping_slot_period
    import capo_iot_wireless.types.reg_params_revision
    import capo_iot_wireless.types.rf_region
    import capo_iot_wireless.types.rx_data_rate2
    import capo_iot_wireless.types.rx_delay1
    import capo_iot_wireless.types.rx_dr_offset1
    import capo_iot_wireless.types.rx_freq2
    import capo_iot_wireless.types.supports32_bit_f_cnt
    import capo_iot_wireless.types.supports_class_b
    import capo_iot_wireless.types.supports_class_c
    import capo_iot_wireless.types.supports_join


class LoRaWANDeviceProfile(TypedDict, closed=True):
    supports_class_b: "capo_iot_wireless.types.supports_class_b.SupportsClassB"
    ...
    ping_slot_dr: NotRequired["capo_iot_wireless.types.ping_slot_dr.PingSlotDr"]
    """<p>The PingSlotDR value.</p>"""
    ping_slot_freq: NotRequired["capo_iot_wireless.types.ping_slot_freq.PingSlotFreq"]
    """<p>The PingSlotFreq value.</p>"""
    supports_class_c: "capo_iot_wireless.types.supports_class_c.SupportsClassC"
    """<p>The SupportsClassC value.</p>"""
    class_c_timeout: NotRequired[
        "capo_iot_wireless.types.class_c_timeout.ClassCTimeout"
    ]
    """<p>The ClassCTimeout value.</p>"""
    mac_version: NotRequired["capo_iot_wireless.types.mac_version.MacVersion"]
    """<p>The MAC version (such as OTAA 1.1 or OTAA 1.0.3) to use with this device profile.</p>"""
    reg_params_revision: NotRequired[
        "capo_iot_wireless.types.reg_params_revision.RegParamsRevision"
    ]
    """<p>The version of regional parameters.</p>"""
    rx_delay1: NotRequired["capo_iot_wireless.types.rx_delay1.RxDelay1"]
    """<p>The RXDelay1 value.</p>"""
    rx_dr_offset1: NotRequired["capo_iot_wireless.types.rx_dr_offset1.RxDrOffset1"]
    """<p>The RXDROffset1 value.</p>"""
    rx_data_rate2: NotRequired["capo_iot_wireless.types.rx_data_rate2.RxDataRate2"]
    """<p>The RXDataRate2 value.</p>"""
    rx_freq2: NotRequired["capo_iot_wireless.types.rx_freq2.RxFreq2"]
    """<p>The RXFreq2 value.</p>"""
    factory_preset_freqs_list: NotRequired[
        "capo_iot_wireless.types.factory_preset_freqs_list.FactoryPresetFreqsList"
    ]
    """<p>The list of values that make up the FactoryPresetFreqs value.</p>"""
    max_eirp: NotRequired["capo_iot_wireless.types.max_eirp.MaxEirp"]
    """<p>The MaxEIRP value.</p>"""
    max_duty_cycle: NotRequired["capo_iot_wireless.types.max_duty_cycle.MaxDutyCycle"]
    ...
    supports_join: NotRequired["capo_iot_wireless.types.supports_join.SupportsJoin"]
    """<p>The SupportsJoin value.</p>"""
    supports32_bit_f_cnt: (
        "capo_iot_wireless.types.supports32_bit_f_cnt.Supports32BitFCnt"
    )
...
def serialize_json(value: LoRaWANDeviceProfile) -> dict:
    ...
    if "factory_preset_freqs_list" in value:
        ...
        out["FactoryPresetFreqsList"] = (
            capo_iot_wireless.types.factory_preset_freqs_list.serialize_json(
...
def deserialize_json(data: dict) -> LoRaWANDeviceProfile:
    ...
    if "FactoryPresetFreqsList" in data:
        ...
        out["factory_preset_freqs_list"] = (
            capo_iot_wireless.types.factory_preset_freqs_list.deserialize_json(
