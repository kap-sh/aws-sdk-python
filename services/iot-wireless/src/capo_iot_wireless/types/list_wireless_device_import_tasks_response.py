...
if TYPE_CHECKING:
    ...
    import capo_iot_wireless.types.wireless_device_import_task_list


class ListWirelessDeviceImportTasksResponse(TypedDict, closed=True):
    ...
    wireless_device_import_task_list: NotRequired[
        "capo_iot_wireless.types.wireless_device_import_task_list.WirelessDeviceImportTaskList"
    ]
...
def serialize_json(value: ListWirelessDeviceImportTasksResponse) -> dict:
    ...
    if "wireless_device_import_task_list" in value:
        ...
        out["WirelessDeviceImportTaskList"] = (
            capo_iot_wireless.types.wireless_device_import_task_list.serialize_json(
...
def deserialize_json(data: dict) -> ListWirelessDeviceImportTasksResponse:
    ...
    if "WirelessDeviceImportTaskList" in data:
        ...
        out["wireless_device_import_task_list"] = (
            capo_iot_wireless.types.wireless_device_import_task_list.deserialize_json(
