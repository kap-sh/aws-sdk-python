...
class PositionConfigurationItem(TypedDict, closed=True):
    resource_identifier: NotRequired[
        "capo_iot_wireless.types.position_resource_identifier.PositionResourceIdentifier"
    ]
    ...
    solvers: NotRequired[
        "capo_iot_wireless.types.position_solver_details.PositionSolverDetails"
    ]
...
def serialize_json(value: PositionConfigurationItem) -> dict:
    ...
    if "resource_type" in value:
        ...
        out["ResourceType"] = (
            capo_iot_wireless.types.position_resource_type.serialize_json(
                value["resource_type"]
            )
        )
    if "solvers" in value:
        ...
        out["Solvers"] = capo_iot_wireless.types.position_solver_details.serialize_json(
            value["solvers"]
        )
...
def deserialize_json(data: dict) -> PositionConfigurationItem:
    ...
    if "ResourceType" in data:
        ...
        out["resource_type"] = (
            capo_iot_wireless.types.position_resource_type.deserialize_json(
                data["ResourceType"]
            )
        )
    if "Solvers" in data:
        ...
        out["solvers"] = (
            capo_iot_wireless.types.position_solver_details.deserialize_json(
                data["Solvers"]
            )
        )
