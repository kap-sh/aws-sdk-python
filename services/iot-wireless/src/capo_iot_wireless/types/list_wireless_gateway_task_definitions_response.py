...
class ListWirelessGatewayTaskDefinitionsResponse(TypedDict, closed=True):
    next_token: NotRequired["capo_iot_wireless.types.next_token.NextToken"]
    """<p>The token to use to get the next set of results, or <b>null</b> if there are no additional results.</p>"""
    task_definitions: NotRequired[
        "capo_iot_wireless.types.wireless_gateway_task_definition_list.WirelessGatewayTaskDefinitionList"
    ]
...
def serialize_json(value: ListWirelessGatewayTaskDefinitionsResponse) -> dict:
    ...
    if "task_definitions" in value:
        ...
        out["TaskDefinitions"] = (
            capo_iot_wireless.types.wireless_gateway_task_definition_list.serialize_json(
...
def deserialize_json(data: dict) -> ListWirelessGatewayTaskDefinitionsResponse:
    ...
    if "TaskDefinitions" in data:
        ...
        out["task_definitions"] = (
            capo_iot_wireless.types.wireless_gateway_task_definition_list.deserialize_json(
