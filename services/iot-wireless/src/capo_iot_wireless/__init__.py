...
from ._services.async_io_t_wireless import (
    AsyncIoTWirelessClient as AsyncIoTWirelessClient,
)
from ._services.io_t_wireless import IoTWirelessClient as IoTWirelessClient
