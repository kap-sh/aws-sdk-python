"""Generated from Smithy shape ``com.amazonaws.iotwireless#ListFuotaTasks``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.list_fuota_tasks_response.ListFuotaTasksResponse = (
        capo_iot_wireless.types.list_fuota_tasks_response.deserialize_json(
...
async def async_list_fuota_tasks(
