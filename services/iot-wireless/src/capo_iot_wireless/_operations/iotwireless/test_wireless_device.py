"""Generated from Smithy shape ``com.amazonaws.iotwireless#TestWirelessDevice``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.test_wireless_device_response.TestWirelessDeviceResponse = capo_iot_wireless.types.test_wireless_device_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/wireless-devices/{Id}/test"
...
async def async_test_wireless_device(
