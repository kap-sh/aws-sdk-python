"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetWirelessGatewayCertificate``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_wireless_gateway_certificate_response.GetWirelessGatewayCertificateResponse = capo_iot_wireless.types.get_wireless_gateway_certificate_response.deserialize_json(
...
async def async_get_wireless_gateway_certificate(
