"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetWirelessDevice``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_wireless_device_response.GetWirelessDeviceResponse = capo_iot_wireless.types.get_wireless_device_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/wireless-devices/{Identifier}"
...
async def async_get_wireless_device(
