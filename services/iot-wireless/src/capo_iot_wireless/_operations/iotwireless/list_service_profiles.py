"""Generated from Smithy shape ``com.amazonaws.iotwireless#ListServiceProfiles``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.list_service_profiles_response.ListServiceProfilesResponse = capo_iot_wireless.types.list_service_profiles_response.deserialize_json(
...
async def async_list_service_profiles(
