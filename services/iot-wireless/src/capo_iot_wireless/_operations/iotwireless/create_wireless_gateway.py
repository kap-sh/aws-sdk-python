...
def handle_response(
    ...
    out: capo_iot_wireless.types.create_wireless_gateway_response.CreateWirelessGatewayResponse = capo_iot_wireless.types.create_wireless_gateway_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.create_wireless_gateway_request.serialize_json(input_)
    ).encode()
