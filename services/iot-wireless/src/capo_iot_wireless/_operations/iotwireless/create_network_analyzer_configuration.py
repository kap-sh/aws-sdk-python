...
def handle_response(
    ...
    out: capo_iot_wireless.types.create_network_analyzer_configuration_response.CreateNetworkAnalyzerConfigurationResponse = capo_iot_wireless.types.create_network_analyzer_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.create_network_analyzer_configuration_request.serialize_json(
            input_
        )
    ).encode()
