"""Generated from Smithy shape ``com.amazonaws.iotwireless#CreateWirelessDevice``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.create_wireless_device_response.CreateWirelessDeviceResponse = capo_iot_wireless.types.create_wireless_device_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.create_wireless_device_request.serialize_json(input_)
    ).encode()
...
async def async_create_wireless_device(
