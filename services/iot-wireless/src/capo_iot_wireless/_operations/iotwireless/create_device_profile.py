...
def handle_response(
    ...
    out: capo_iot_wireless.types.create_device_profile_response.CreateDeviceProfileResponse = capo_iot_wireless.types.create_device_profile_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.create_device_profile_request.serialize_json(input_)
    ).encode()
