"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetMulticastGroup``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_multicast_group_response.GetMulticastGroupResponse = capo_iot_wireless.types.get_multicast_group_response.deserialize_json(
...
async def async_get_multicast_group(
