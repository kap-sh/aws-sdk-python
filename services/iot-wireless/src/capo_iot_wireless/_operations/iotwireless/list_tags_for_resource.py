"""Generated from Smithy shape ``com.amazonaws.iotwireless#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_iot_wireless.types.list_tags_for_resource_response.deserialize_json(
