...
def handle_response(
    ...
    out: capo_iot_wireless.types.start_fuota_task_response.StartFuotaTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.start_fuota_task_request.serialize_json(input_)
    ).encode()
