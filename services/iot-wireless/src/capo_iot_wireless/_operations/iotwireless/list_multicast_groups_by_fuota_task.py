...
def handle_response(
    ...
    out: capo_iot_wireless.types.list_multicast_groups_by_fuota_task_response.ListMulticastGroupsByFuotaTaskResponse = capo_iot_wireless.types.list_multicast_groups_by_fuota_task_response.deserialize_json(
