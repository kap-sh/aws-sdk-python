"""Generated from Smithy shape ``com.amazonaws.iotwireless#DeleteQueuedMessages``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.delete_queued_messages_response.DeleteQueuedMessagesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "message_id" in input_:
        params["messageId"] = str(input_["message_id"])
...
async def async_delete_queued_messages(
