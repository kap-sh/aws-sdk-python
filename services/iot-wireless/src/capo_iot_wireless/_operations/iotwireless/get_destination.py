"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetDestination``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_destination_response.GetDestinationResponse = (
        capo_iot_wireless.types.get_destination_response.deserialize_json(
