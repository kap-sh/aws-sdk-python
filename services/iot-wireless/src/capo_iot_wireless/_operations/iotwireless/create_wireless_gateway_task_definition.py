...
def handle_response(
    ...
    out: capo_iot_wireless.types.create_wireless_gateway_task_definition_response.CreateWirelessGatewayTaskDefinitionResponse = capo_iot_wireless.types.create_wireless_gateway_task_definition_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.create_wireless_gateway_task_definition_request.serialize_json(
            input_
        )
    ).encode()
