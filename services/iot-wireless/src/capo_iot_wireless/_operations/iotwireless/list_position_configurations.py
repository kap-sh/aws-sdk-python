"""Generated from Smithy shape ``com.amazonaws.iotwireless#ListPositionConfigurations``."""
...
import capo_iot_wireless.types.position_configuration_list
...
def handle_response(
    ...
    out: capo_iot_wireless.types.list_position_configurations_response.ListPositionConfigurationsResponse = capo_iot_wireless.types.list_position_configurations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/position-configurations"
    params: dict[str, str] = {}
...
async def async_list_position_configurations(
