"""Generated from Smithy shape ``com.amazonaws.iotwireless#UpdateEventConfigurationByResourceTypes``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.update_event_configuration_by_resource_types_response.UpdateEventConfigurationByResourceTypesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.update_event_configuration_by_resource_types_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_event_configuration_by_resource_types(
