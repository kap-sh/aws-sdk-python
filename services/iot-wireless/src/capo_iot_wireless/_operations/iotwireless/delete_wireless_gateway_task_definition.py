"""Generated from Smithy shape ``com.amazonaws.iotwireless#DeleteWirelessGatewayTaskDefinition``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.delete_wireless_gateway_task_definition_response.DeleteWirelessGatewayTaskDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_wireless_gateway_task_definition(
