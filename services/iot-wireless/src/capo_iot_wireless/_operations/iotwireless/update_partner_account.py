...
def handle_response(
    ...
    out: capo_iot_wireless.types.update_partner_account_response.UpdatePartnerAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.update_partner_account_request.serialize_json(input_)
    ).encode()
