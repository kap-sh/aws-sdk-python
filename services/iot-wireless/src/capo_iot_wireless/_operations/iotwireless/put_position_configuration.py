"""Generated from Smithy shape ``com.amazonaws.iotwireless#PutPositionConfiguration``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.put_position_configuration_response.PutPositionConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.put_position_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_position_configuration(
