...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_partner_account_response.GetPartnerAccountResponse = capo_iot_wireless.types.get_partner_account_response.deserialize_json(
