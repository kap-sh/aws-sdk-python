...
import capo_iot_wireless.types.wireless_gateway_task_definition_list
...
def handle_response(
    ...
    out: capo_iot_wireless.types.list_wireless_gateway_task_definitions_response.ListWirelessGatewayTaskDefinitionsResponse = capo_iot_wireless.types.list_wireless_gateway_task_definitions_response.deserialize_json(
