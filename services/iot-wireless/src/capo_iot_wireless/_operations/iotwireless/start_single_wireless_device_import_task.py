...
def handle_response(
    ...
    out: capo_iot_wireless.types.start_single_wireless_device_import_task_response.StartSingleWirelessDeviceImportTaskResponse = capo_iot_wireless.types.start_single_wireless_device_import_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.start_single_wireless_device_import_task_request.serialize_json(
            input_
        )
    ).encode()
