...
def handle_response(
    ...
    out: capo_iot_wireless.types.list_partner_accounts_response.ListPartnerAccountsResponse = capo_iot_wireless.types.list_partner_accounts_response.deserialize_json(
