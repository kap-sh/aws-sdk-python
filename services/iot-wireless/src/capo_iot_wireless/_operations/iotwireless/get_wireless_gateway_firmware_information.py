...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_wireless_gateway_firmware_information_response.GetWirelessGatewayFirmwareInformationResponse = capo_iot_wireless.types.get_wireless_gateway_firmware_information_response.deserialize_json(
