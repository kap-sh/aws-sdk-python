...
def handle_response(
    ...
    out: capo_iot_wireless.types.start_multicast_group_session_response.StartMulticastGroupSessionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.start_multicast_group_session_request.serialize_json(
            input_
        )
    ).encode()
