"""Generated from Smithy shape ``com.amazonaws.iotwireless#DeleteWirelessGateway``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.delete_wireless_gateway_response.DeleteWirelessGatewayResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_wireless_gateway(
