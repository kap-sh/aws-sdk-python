"""Generated from Smithy shape ``com.amazonaws.iotwireless#ListMulticastGroups``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.list_multicast_groups_response.ListMulticastGroupsResponse = capo_iot_wireless.types.list_multicast_groups_response.deserialize_json(
...
async def async_list_multicast_groups(
