"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetNetworkAnalyzerConfiguration``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_network_analyzer_configuration_response.GetNetworkAnalyzerConfigurationResponse = capo_iot_wireless.types.get_network_analyzer_configuration_response.deserialize_json(
...
async def async_get_network_analyzer_configuration(
