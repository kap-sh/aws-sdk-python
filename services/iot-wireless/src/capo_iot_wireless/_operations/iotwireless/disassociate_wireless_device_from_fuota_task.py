"""Generated from Smithy shape ``com.amazonaws.iotwireless#DisassociateWirelessDeviceFromFuotaTask``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.disassociate_wireless_device_from_fuota_task_response.DisassociateWirelessDeviceFromFuotaTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disassociate_wireless_device_from_fuota_task(
