"""Generated from Smithy shape ``com.amazonaws.iotwireless#DisassociateWirelessDeviceFromThing``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.disassociate_wireless_device_from_thing_response.DisassociateWirelessDeviceFromThingResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disassociate_wireless_device_from_thing(
