"""Generated from Smithy shape ``com.amazonaws.iotwireless#DeleteDestination``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.delete_destination_response.DeleteDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
