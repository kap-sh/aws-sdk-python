"""Generated from Smithy shape ``com.amazonaws.iotwireless#DisassociateWirelessDeviceFromMulticastGroup``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.disassociate_wireless_device_from_multicast_group_response.DisassociateWirelessDeviceFromMulticastGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace(
        "{WirelessDeviceId}", quote(str(input_["wireless_device_id"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_disassociate_wireless_device_from_multicast_group(
