"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetWirelessGatewayTask``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_wireless_gateway_task_response.GetWirelessGatewayTaskResponse = capo_iot_wireless.types.get_wireless_gateway_task_response.deserialize_json(
...
async def async_get_wireless_gateway_task(
