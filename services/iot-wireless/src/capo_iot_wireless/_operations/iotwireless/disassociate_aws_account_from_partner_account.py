"""Generated from Smithy shape ``com.amazonaws.iotwireless#DisassociateAwsAccountFromPartnerAccount``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.disassociate_aws_account_from_partner_account_response.DisassociateAwsAccountFromPartnerAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disassociate_aws_account_from_partner_account(
