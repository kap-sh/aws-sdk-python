"""Generated from Smithy shape ``com.amazonaws.iotwireless#ListDevicesForWirelessDeviceImportTask``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.list_devices_for_wireless_device_import_task_response.ListDevicesForWirelessDeviceImportTaskResponse = capo_iot_wireless.types.list_devices_for_wireless_device_import_task_response.deserialize_json(
...
async def async_list_devices_for_wireless_device_import_task(
