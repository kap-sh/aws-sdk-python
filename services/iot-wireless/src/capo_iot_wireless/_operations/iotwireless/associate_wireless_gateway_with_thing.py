...
def handle_response(
    ...
    out: capo_iot_wireless.types.associate_wireless_gateway_with_thing_response.AssociateWirelessGatewayWithThingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.associate_wireless_gateway_with_thing_request.serialize_json(
            input_
        )
    ).encode()
