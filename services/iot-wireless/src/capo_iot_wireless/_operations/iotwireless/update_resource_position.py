"""Generated from Smithy shape ``com.amazonaws.iotwireless#UpdateResourcePosition``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.update_resource_position_response.UpdateResourcePositionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    if "geo_json_payload" in input_:
        body: bytes | None = json.dumps(
            capo_iot_wireless.types.geo_json_payload.serialize_json(
