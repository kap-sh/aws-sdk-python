"""Generated from Smithy shape ``com.amazonaws.iotwireless#CancelMulticastGroupSession``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.cancel_multicast_group_session_response.CancelMulticastGroupSessionResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_cancel_multicast_group_session(
