"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetDeviceProfile``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_device_profile_response.GetDeviceProfileResponse = capo_iot_wireless.types.get_device_profile_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/device-profiles/{Id}"
