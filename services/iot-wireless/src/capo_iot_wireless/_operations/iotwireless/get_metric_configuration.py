...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_metric_configuration_response.GetMetricConfigurationResponse = capo_iot_wireless.types.get_metric_configuration_response.deserialize_json(
