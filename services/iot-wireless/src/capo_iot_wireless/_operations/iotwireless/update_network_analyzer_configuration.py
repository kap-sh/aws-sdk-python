...
def handle_response(
    ...
    out: capo_iot_wireless.types.update_network_analyzer_configuration_response.UpdateNetworkAnalyzerConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.update_network_analyzer_configuration_request.serialize_json(
            input_
        )
    ).encode()
