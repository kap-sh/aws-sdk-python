...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_resource_log_level_response.GetResourceLogLevelResponse = capo_iot_wireless.types.get_resource_log_level_response.deserialize_json(
