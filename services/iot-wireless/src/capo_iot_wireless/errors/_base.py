...
class IoTWirelessError(Exception):
    """Base class for all IoTWireless service errors."""


class ServiceError(IoTWirelessError):
...
class SerializationError(IoTWirelessError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IoTWirelessError):
...
class WaiterFailedError(IoTWirelessError):
...
class WaiterTimeoutError(IoTWirelessError):
