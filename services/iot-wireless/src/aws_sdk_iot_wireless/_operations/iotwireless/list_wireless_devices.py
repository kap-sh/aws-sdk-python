...
def handle_response(
    ...
    out: aws_sdk_iot_wireless.types.list_wireless_devices_response.ListWirelessDevicesResponse = aws_sdk_iot_wireless.types.list_wireless_devices_response.deserialize_json(
