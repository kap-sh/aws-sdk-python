...
if TYPE_CHECKING:
    import aws_sdk_iot_wireless.types.gateway_list_multicast
    import aws_sdk_iot_wireless.types.transmission_interval_multicast


class ParticipatingGatewaysMulticast(TypedDict):
    gateway_list: NotRequired[
        "aws_sdk_iot_wireless.types.gateway_list_multicast.GatewayListMulticast"
    ]
    ...
    transmission_interval: NotRequired[
        "aws_sdk_iot_wireless.types.transmission_interval_multicast.TransmissionIntervalMulticast"
    ]
...
def serialize_json(value: ParticipatingGatewaysMulticast) -> dict:
    ...
    if "gateway_list" in value:
        ...
        out["GatewayList"] = (
            aws_sdk_iot_wireless.types.gateway_list_multicast.serialize_json(
                value["gateway_list"]
            )
        )
...
def deserialize_json(data: dict) -> ParticipatingGatewaysMulticast:
    ...
    if "GatewayList" in data:
        ...
        out["gateway_list"] = (
            aws_sdk_iot_wireless.types.gateway_list_multicast.deserialize_json(
                data["GatewayList"]
            )
        )
