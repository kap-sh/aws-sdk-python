...
def serialize_json(value: JoinEventConfiguration) -> dict:
    ...
    if "lo_ra_wan" in value:
        ...
        out["LoRaWAN"] = (
            aws_sdk_iot_wireless.types.lo_ra_wan_join_event_notification_configurations.serialize_json(
                value["lo_ra_wan"]
            )
        )
...
def deserialize_json(data: dict) -> JoinEventConfiguration:
    ...
    if "LoRaWAN" in data:
        ...
        out["lo_ra_wan"] = (
            aws_sdk_iot_wireless.types.lo_ra_wan_join_event_notification_configurations.deserialize_json(
                data["LoRaWAN"]
            )
        )
