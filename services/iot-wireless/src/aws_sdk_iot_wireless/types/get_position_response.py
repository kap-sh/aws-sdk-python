...
class GetPositionResponse(TypedDict):
    ...
    accuracy: NotRequired["aws_sdk_iot_wireless.types.accuracy.Accuracy"]
    ...
    solver_version: NotRequired[
        "aws_sdk_iot_wireless.types.position_solver_version.PositionSolverVersion"
    ]
...
def serialize_json(value: GetPositionResponse) -> dict:
    ...
    if "accuracy" in value:
        ...
        out["Accuracy"] = aws_sdk_iot_wireless.types.accuracy.serialize_json(
            value["accuracy"]
        )
    if "solver_type" in value:
        ...
        out["SolverType"] = (
            aws_sdk_iot_wireless.types.position_solver_type.serialize_json(
                value["solver_type"]
            )
        )
...
def deserialize_json(data: dict) -> GetPositionResponse:
    ...
    if "Accuracy" in data:
        ...
        out["accuracy"] = aws_sdk_iot_wireless.types.accuracy.deserialize_json(
            data["Accuracy"]
        )
    if "SolverType" in data:
        ...
        out["solver_type"] = (
            aws_sdk_iot_wireless.types.position_solver_type.deserialize_json(
                data["SolverType"]
            )
        )
