"""Generated from Smithy shape ``com.amazonaws.iotwireless#LoRaWANJoinResourceTypeEventConfiguration``."""
...
class LoRaWANJoinResourceTypeEventConfiguration(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: LoRaWANJoinResourceTypeEventConfiguration) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> LoRaWANJoinResourceTypeEventConfiguration:
    out: LoRaWANJoinResourceTypeEventConfiguration = {}  # type: ignore[typeddict-item]
