...
class Beaconing(TypedDict, closed=True):
    ...
    frequencies: NotRequired[
        "aws_sdk_iot_wireless.types.beaconing_frequencies.BeaconingFrequencies"
    ]
...
def serialize_json(value: Beaconing) -> dict:
    ...
    if "frequencies" in value:
        ...
        out["Frequencies"] = (
            aws_sdk_iot_wireless.types.beaconing_frequencies.serialize_json(
                value["frequencies"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> Beaconing:
    ...
    if "Frequencies" in data:
        ...
        out["frequencies"] = (
            aws_sdk_iot_wireless.types.beaconing_frequencies.deserialize_json(
                data["Frequencies"]
            )
        )
    return out
