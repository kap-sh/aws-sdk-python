...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot_wireless.types.channel_mask
    import aws_sdk_iot_wireless.types.dev_status_req_freq
    import aws_sdk_iot_wireless.types.dl_bucket_size
    import aws_sdk_iot_wireless.types.dl_rate
    import aws_sdk_iot_wireless.types.dl_rate_policy
    import aws_sdk_iot_wireless.types.dr_max
    import aws_sdk_iot_wireless.types.dr_min
    import aws_sdk_iot_wireless.types.hr_allowed
    import aws_sdk_iot_wireless.types.min_gw_diversity
    import aws_sdk_iot_wireless.types.nb_trans_max
    import aws_sdk_iot_wireless.types.nb_trans_min
    import aws_sdk_iot_wireless.types.nwk_geo_loc
    import aws_sdk_iot_wireless.types.pr_allowed
    import aws_sdk_iot_wireless.types.ra_allowed
    import aws_sdk_iot_wireless.types.report_dev_status_battery
    import aws_sdk_iot_wireless.types.report_dev_status_margin
    import aws_sdk_iot_wireless.types.target_per
    import aws_sdk_iot_wireless.types.tx_power_index_max
    import aws_sdk_iot_wireless.types.tx_power_index_min
    import aws_sdk_iot_wireless.types.ul_bucket_size
    import aws_sdk_iot_wireless.types.ul_rate
...
class LoRaWANGetServiceProfileInfo(TypedDict, closed=True):
    ...
    ul_bucket_size: NotRequired[
        "aws_sdk_iot_wireless.types.ul_bucket_size.UlBucketSize"
    ]
    """<p>The ULBucketSize value.</p>"""
    ul_rate_policy: NotRequired[
        "aws_sdk_iot_wireless.types.ul_rate_policy.UlRatePolicy"
    ]
    """<p>The ULRatePolicy value.</p>"""
    dl_rate: NotRequired["aws_sdk_iot_wireless.types.dl_rate.DlRate"]
    """<p>The DLRate value.</p>"""
    dl_bucket_size: NotRequired[
        "aws_sdk_iot_wireless.types.dl_bucket_size.DlBucketSize"
    ]
    """<p>The DLBucketSize value.</p>"""
    dl_rate_policy: NotRequired[
        "aws_sdk_iot_wireless.types.dl_rate_policy.DlRatePolicy"
    ]
    """<p>The DLRatePolicy value.</p>"""
    add_gw_metadata: "aws_sdk_iot_wireless.types.add_gw_metadata.AddGwMetadata"
    """<p>The AddGWMetaData value.</p>"""
    dev_status_req_freq: NotRequired[
        "aws_sdk_iot_wireless.types.dev_status_req_freq.DevStatusReqFreq"
    ]
    """<p>The DevStatusReqFreq value.</p>"""
    report_dev_status_battery: (
        "aws_sdk_iot_wireless.types.report_dev_status_battery.ReportDevStatusBattery"
    )
    """<p>The ReportDevStatusBattery value.</p>"""
    report_dev_status_margin: (
        "aws_sdk_iot_wireless.types.report_dev_status_margin.ReportDevStatusMargin"
    )
    """<p>The ReportDevStatusMargin value.</p>"""
    dr_min: "aws_sdk_iot_wireless.types.dr_min.DrMin"
    """<p>The DRMin value.</p>"""
    dr_max: "aws_sdk_iot_wireless.types.dr_max.DrMax"
    """<p>The DRMax value.</p>"""
    channel_mask: NotRequired["aws_sdk_iot_wireless.types.channel_mask.ChannelMask"]
    """<p>The ChannelMask value.</p>"""
    pr_allowed: "aws_sdk_iot_wireless.types.pr_allowed.PrAllowed"
    """<p>The PRAllowed value that describes whether passive roaming is allowed.</p>"""
    hr_allowed: "aws_sdk_iot_wireless.types.hr_allowed.HrAllowed"
    """<p>The HRAllowed value that describes whether handover roaming is allowed.</p>"""
    ra_allowed: "aws_sdk_iot_wireless.types.ra_allowed.RaAllowed"
    """<p>The RAAllowed value that describes whether roaming activation is allowed.</p>"""
    nwk_geo_loc: "aws_sdk_iot_wireless.types.nwk_geo_loc.NwkGeoLoc"
    """<p>The NwkGeoLoc value.</p>"""
    target_per: "aws_sdk_iot_wireless.types.target_per.TargetPer"
    """<p>The TargetPER value.</p>"""
    min_gw_diversity: NotRequired[
        "aws_sdk_iot_wireless.types.min_gw_diversity.MinGwDiversity"
    ]
    """<p>The MinGwDiversity value.</p>"""
    tx_power_index_min: NotRequired[
        "aws_sdk_iot_wireless.types.tx_power_index_min.TxPowerIndexMin"
    ]
    """<p>The Transmit Power Index minimum value.</p> <p>Default: <code>0</code> </p>"""
    tx_power_index_max: NotRequired[
        "aws_sdk_iot_wireless.types.tx_power_index_max.TxPowerIndexMax"
    ]
    """<p>The Transmit Power Index maximum value.</p> <p>Default: <code>15</code> </p>"""
    nb_trans_min: NotRequired["aws_sdk_iot_wireless.types.nb_trans_min.NbTransMin"]
    """<p>The minimum number of transmissions.</p> <p>Default: <code>0</code> </p>"""
    nb_trans_max: NotRequired["aws_sdk_iot_wireless.types.nb_trans_max.NbTransMax"]
