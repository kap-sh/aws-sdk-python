...
class ListFuotaTasksResponse(TypedDict):
    ...
    fuota_task_list: NotRequired[
        "aws_sdk_iot_wireless.types.fuota_task_list.FuotaTaskList"
    ]
...
def serialize_json(value: ListFuotaTasksResponse) -> dict:
    ...
    if "fuota_task_list" in value:
        ...
        out["FuotaTaskList"] = (
            aws_sdk_iot_wireless.types.fuota_task_list.serialize_json(
...
def deserialize_json(data: dict) -> ListFuotaTasksResponse:
    ...
    if "FuotaTaskList" in data:
        ...
        out["fuota_task_list"] = (
            aws_sdk_iot_wireless.types.fuota_task_list.deserialize_json(
                data["FuotaTaskList"]
            )
        )
    return out
