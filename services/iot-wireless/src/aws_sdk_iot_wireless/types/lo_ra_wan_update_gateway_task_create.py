...
if TYPE_CHECKING:
    import aws_sdk_iot_wireless.types.crc
    import aws_sdk_iot_wireless.types.lo_ra_wan_gateway_version
    import aws_sdk_iot_wireless.types.update_signature


class LoRaWANUpdateGatewayTaskCreate(TypedDict):
    update_signature: NotRequired[
        "aws_sdk_iot_wireless.types.update_signature.UpdateSignature"
    ]
    """<p>The signature used to verify the update firmware.</p>"""
    sig_key_crc: NotRequired["aws_sdk_iot_wireless.types.crc.Crc"]
