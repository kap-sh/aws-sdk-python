...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot_wireless.types.wireless_device_statistics_list


class ListWirelessDevicesResponse(TypedDict):
    ...
    wireless_device_list: NotRequired[
        "aws_sdk_iot_wireless.types.wireless_device_statistics_list.WirelessDeviceStatisticsList"
    ]
...
def serialize_json(value: ListWirelessDevicesResponse) -> dict:
    ...
    if "wireless_device_list" in value:
        ...
        out["WirelessDeviceList"] = (
            aws_sdk_iot_wireless.types.wireless_device_statistics_list.serialize_json(
...
def deserialize_json(data: dict) -> ListWirelessDevicesResponse:
    ...
    if "WirelessDeviceList" in data:
        ...
        out["wireless_device_list"] = (
            aws_sdk_iot_wireless.types.wireless_device_statistics_list.deserialize_json(
