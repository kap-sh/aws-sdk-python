...
if TYPE_CHECKING:
    import aws_sdk_iot_wireless.types.model
    import aws_sdk_iot_wireless.types.package_version
    import aws_sdk_iot_wireless.types.station


class LoRaWANGatewayVersion(TypedDict):
    package_version: NotRequired[
        "aws_sdk_iot_wireless.types.package_version.PackageVersion"
    ]
    """<p>The version of the wireless gateway firmware.</p>"""
    model: NotRequired["aws_sdk_iot_wireless.types.model.Model"]
    """<p>The model number of the wireless gateway.</p>"""
    station: NotRequired["aws_sdk_iot_wireless.types.station.Station"]
