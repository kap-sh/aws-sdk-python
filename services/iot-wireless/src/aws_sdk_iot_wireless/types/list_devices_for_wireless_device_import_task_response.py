...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot_wireless.types.imported_wireless_device_list
    import aws_sdk_iot_wireless.types.next_token
    import aws_sdk_iot_wireless.types.positioning_config_status
    import aws_sdk_iot_wireless.types.sidewalk_list_devices_for_import_info


class ListDevicesForWirelessDeviceImportTaskResponse(TypedDict):
    ...
    sidewalk: NotRequired[
        "aws_sdk_iot_wireless.types.sidewalk_list_devices_for_import_info.SidewalkListDevicesForImportInfo"
    ]
    """<p>The Sidewalk object containing Sidewalk-related device information.</p>"""
    imported_wireless_device_list: NotRequired[
        "aws_sdk_iot_wireless.types.imported_wireless_device_list.ImportedWirelessDeviceList"
    ]
...
def serialize_json(value: ListDevicesForWirelessDeviceImportTaskResponse) -> dict:
    ...
    if "sidewalk" in value:
        ...
        out["Sidewalk"] = (
            aws_sdk_iot_wireless.types.sidewalk_list_devices_for_import_info.serialize_json(
                value["sidewalk"]
            )
        )
    if "imported_wireless_device_list" in value:
        ...
        out["ImportedWirelessDeviceList"] = (
            aws_sdk_iot_wireless.types.imported_wireless_device_list.serialize_json(
...
def deserialize_json(data: dict) -> ListDevicesForWirelessDeviceImportTaskResponse:
    ...
    if "Sidewalk" in data:
        ...
        out["sidewalk"] = (
            aws_sdk_iot_wireless.types.sidewalk_list_devices_for_import_info.deserialize_json(
                data["Sidewalk"]
            )
        )
    if "ImportedWirelessDeviceList" in data:
        ...
        out["imported_wireless_device_list"] = (
            aws_sdk_iot_wireless.types.imported_wireless_device_list.deserialize_json(
