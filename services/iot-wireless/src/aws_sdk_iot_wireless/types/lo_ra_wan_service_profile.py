...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot_wireless.types.dr_max_box
    import aws_sdk_iot_wireless.types.dr_min_box
...
class LoRaWANServiceProfile(TypedDict):
    add_gw_metadata: "aws_sdk_iot_wireless.types.add_gw_metadata.AddGwMetadata"
    """<p>The AddGWMetaData value.</p>"""
    dr_min: NotRequired["aws_sdk_iot_wireless.types.dr_min_box.DrMinBox"]
    """<p>The DrMin value.</p>"""
    dr_max: NotRequired["aws_sdk_iot_wireless.types.dr_max_box.DrMaxBox"]
    """<p>The DrMax value.</p>"""
