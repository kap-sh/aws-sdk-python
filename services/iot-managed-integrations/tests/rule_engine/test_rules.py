import pytest
from capo_iot_managed_integrations._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_iot_managed_integrations._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
