...
```
pip install aws-sdk-iot-managed-integrations
```

## Usage

```python
from aws_sdk_iot_managed_integrations import AsyncIoTManagedIntegrationsClient
...
```python
from aws_sdk_iot_managed_integrations import AsyncIoTManagedIntegrationsClient
from aws_sdk_iot_managed_integrations.error import AccessDeniedException
