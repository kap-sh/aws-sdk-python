...
from capo_iot_managed_integrations._services._aws_config import aws_config
...
class IoTManagedIntegrationsClientConfig(TypedDict, total=False, closed=True):
...
class IoTManagedIntegrationsClient:
    ...
    def get_custom_endpoint(
        ...
        def _handler(
            req: "OperationRequest[capo_iot_managed_integrations.types.get_custom_endpoint_request.GetCustomEndpointRequest]",
        ) -> OperationResponse[
            "capo_iot_managed_integrations.types.get_custom_endpoint_response.GetCustomEndpointResponse"
        ]:
            ...
            output, http_response = (
                capo_iot_managed_integrations._operations.iot_managed_integrations.get_custom_endpoint.get_custom_endpoint(
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_iot_managed_integrations.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_iot_managed_integrations.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_iot_managed_integrations._operations.iot_managed_integrations.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_custom_endpoint(
        ...
        def _handler(
            req: "OperationRequest[capo_iot_managed_integrations.types.register_custom_endpoint_request.RegisterCustomEndpointRequest]",
        ) -> OperationResponse[
            "capo_iot_managed_integrations.types.register_custom_endpoint_response.RegisterCustomEndpointResponse"
        ]:
            ...
            output, http_response = (
                capo_iot_managed_integrations._operations.iot_managed_integrations.register_custom_endpoint.register_custom_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def send_connector_event(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_iot_managed_integrations.types.send_connector_event_request.SendConnectorEventRequest]",
        ) -> OperationResponse[
            "capo_iot_managed_integrations.types.send_connector_event_response.SendConnectorEventResponse"
        ]:
            ...
            output, http_response = (
                capo_iot_managed_integrations._operations.iot_managed_integrations.send_connector_event.send_connector_event(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_iot_managed_integrations.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_iot_managed_integrations.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_iot_managed_integrations._operations.iot_managed_integrations.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_iot_managed_integrations.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_iot_managed_integrations.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_iot_managed_integrations._operations.iot_managed_integrations.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
