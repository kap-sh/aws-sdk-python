...
class TaskProcessingDetails(TypedDict, closed=True):
    ...
    processing_targets: NotRequired["capo_iot_managed_integrations.types.target.Target"]
...
def serialize_json(value: TaskProcessingDetails) -> dict:
    ...
    if "processing_targets" in value:
        ...
        out["processingTargets"] = (
            capo_iot_managed_integrations.types.target.serialize_json(
...
def deserialize_json(data: dict) -> TaskProcessingDetails:
    ...
    if "processingTargets" in data:
        ...
        out["processing_targets"] = (
            capo_iot_managed_integrations.types.target.deserialize_json(
