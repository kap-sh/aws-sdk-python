...
class SendConnectorEventRequest(TypedDict, closed=True):
    ...
    trace_id: NotRequired["capo_iot_managed_integrations.types.trace_id.TraceId"]
    ...
    devices: NotRequired["capo_iot_managed_integrations.types.devices.Devices"]
...
def serialize_json(value: SendConnectorEventRequest) -> dict:
    ...
    out["Operation"] = (
        capo_iot_managed_integrations.types.connector_event_operation.serialize_json(
            value["operation"]
        )
    )
    ...
    if "devices" in value:
        ...
        out["Devices"] = capo_iot_managed_integrations.types.devices.serialize_json(
            value["devices"]
        )
    if "matter_endpoint" in value:
        ...
        out["MatterEndpoint"] = (
            capo_iot_managed_integrations.types.matter_endpoint.serialize_json(
...
def deserialize_json(data: dict) -> SendConnectorEventRequest:
    ...
    if "Operation" in data:
        ...
        out["operation"] = (
            capo_iot_managed_integrations.types.connector_event_operation.deserialize_json(
                data["Operation"]
            )
        )
    else:
    ...
    if "MatterEndpoint" in data:
        ...
        out["matter_endpoint"] = (
            capo_iot_managed_integrations.types.matter_endpoint.deserialize_json(
                data["MatterEndpoint"]
            )
        )
    return out
