...
if TYPE_CHECKING:
    import capo_iot_managed_integrations.types.enable_as_provisionee
    import capo_iot_managed_integrations.types.enable_as_provisioner
    import capo_iot_managed_integrations.types.timeout_in_minutes


class WiFiSimpleSetupConfiguration(TypedDict, closed=True):
    enable_as_provisioner: NotRequired[
        "capo_iot_managed_integrations.types.enable_as_provisioner.EnableAsProvisioner"
    ]
    ...
    enable_as_provisionee: NotRequired[
        "capo_iot_managed_integrations.types.enable_as_provisionee.EnableAsProvisionee"
    ]
    ...
    timeout_in_minutes: NotRequired[
        "capo_iot_managed_integrations.types.timeout_in_minutes.TimeoutInMinutes"
    ]
