...
import capo_iot_managed_integrations.types.notification_configuration_list_definition
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_notification_configurations_response.ListNotificationConfigurationsResponse = capo_iot_managed_integrations.types.list_notification_configurations_response.deserialize_json(
