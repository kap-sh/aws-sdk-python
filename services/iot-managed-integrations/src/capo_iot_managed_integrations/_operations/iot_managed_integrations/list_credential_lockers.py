"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListCredentialLockers``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_credential_lockers_response.ListCredentialLockersResponse = capo_iot_managed_integrations.types.list_credential_lockers_response.deserialize_json(
...
async def async_list_credential_lockers(
