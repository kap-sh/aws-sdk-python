"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetManagedThingMetaData``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_managed_thing_meta_data_response.GetManagedThingMetaDataResponse = capo_iot_managed_integrations.types.get_managed_thing_meta_data_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/managed-things-metadata/{Identifier}"
...
async def async_get_managed_thing_meta_data(
