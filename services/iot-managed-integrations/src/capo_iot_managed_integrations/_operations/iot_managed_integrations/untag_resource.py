"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#UntagResource``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
