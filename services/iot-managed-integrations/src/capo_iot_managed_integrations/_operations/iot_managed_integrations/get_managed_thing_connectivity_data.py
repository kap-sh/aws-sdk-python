"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetManagedThingConnectivityData``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_managed_thing_connectivity_data_response.GetManagedThingConnectivityDataResponse = capo_iot_managed_integrations.types.get_managed_thing_connectivity_data_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/managed-things-connectivity-data/{Identifier}"
...
async def async_get_managed_thing_connectivity_data(
