...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_schema_versions_response.ListSchemaVersionsResponse = capo_iot_managed_integrations.types.list_schema_versions_response.deserialize_json(
