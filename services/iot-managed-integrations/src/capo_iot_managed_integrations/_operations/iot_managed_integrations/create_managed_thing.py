"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#CreateManagedThing``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.create_managed_thing_response.CreateManagedThingResponse = capo_iot_managed_integrations.types.create_managed_thing_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.create_managed_thing_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_managed_thing(
