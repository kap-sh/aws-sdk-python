"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#RegisterCustomEndpoint``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.register_custom_endpoint_response.RegisterCustomEndpointResponse = capo_iot_managed_integrations.types.register_custom_endpoint_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/custom-endpoint"
    params: dict[str, str] = {}
...
async def async_register_custom_endpoint(
