...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_ota_task_response.GetOtaTaskResponse = capo_iot_managed_integrations.types.get_ota_task_response.deserialize_json(
