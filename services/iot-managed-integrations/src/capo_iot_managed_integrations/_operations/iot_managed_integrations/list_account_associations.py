"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListAccountAssociations``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_account_associations_response.ListAccountAssociationsResponse = capo_iot_managed_integrations.types.list_account_associations_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "connector_destination_id" in input_:
        params["ConnectorDestinationId"] = str(input_["connector_destination_id"])
