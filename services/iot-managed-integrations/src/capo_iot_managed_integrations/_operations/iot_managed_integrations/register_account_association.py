"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#RegisterAccountAssociation``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.register_account_association_response.RegisterAccountAssociationResponse = capo_iot_managed_integrations.types.register_account_association_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/managed-thing-associations/register"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.register_account_association_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_register_account_association(
