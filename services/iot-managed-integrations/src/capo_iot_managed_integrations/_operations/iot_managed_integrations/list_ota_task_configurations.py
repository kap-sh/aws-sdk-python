...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_ota_task_configurations_response.ListOtaTaskConfigurationsResponse = capo_iot_managed_integrations.types.list_ota_task_configurations_response.deserialize_json(
