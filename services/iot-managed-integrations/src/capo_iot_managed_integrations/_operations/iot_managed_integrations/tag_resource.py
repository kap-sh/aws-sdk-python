...
import capo_iot_managed_integrations.errors.invalid_request_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidRequestException":
            raise capo_iot_managed_integrations.errors.invalid_request_exception.InvalidRequestException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.tag_resource_request.serialize_json(input_)
    ).encode()
