"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListOtaTasks``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_ota_tasks_response.ListOtaTasksResponse = capo_iot_managed_integrations.types.list_ota_tasks_response.deserialize_json(
...
async def async_list_ota_tasks(
