"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListManagedThingAccountAssociations``."""
...
import capo_iot_managed_integrations.types.managed_thing_association_list
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_managed_thing_account_associations_response.ListManagedThingAccountAssociationsResponse = capo_iot_managed_integrations.types.list_managed_thing_account_associations_response.deserialize_json(
