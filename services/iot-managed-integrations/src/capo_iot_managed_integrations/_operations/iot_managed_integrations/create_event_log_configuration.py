...
import capo_iot_managed_integrations.errors.conflict_exception
import capo_iot_managed_integrations.errors.internal_server_exception
import capo_iot_managed_integrations.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_iot_managed_integrations.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_iot_managed_integrations.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.create_event_log_configuration_response.CreateEventLogConfigurationResponse = capo_iot_managed_integrations.types.create_event_log_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.create_event_log_configuration_request.serialize_json(
            input_
        )
    ).encode()
