"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#UpdateConnectorDestination``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.update_connector_destination_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_connector_destination(
