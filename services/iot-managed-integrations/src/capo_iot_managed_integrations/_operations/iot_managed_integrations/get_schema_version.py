...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_schema_version_response.GetSchemaVersionResponse = capo_iot_managed_integrations.types.get_schema_version_response.deserialize_json(
