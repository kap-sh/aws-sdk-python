"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetOtaTaskConfiguration``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_ota_task_configuration_response.GetOtaTaskConfigurationResponse = capo_iot_managed_integrations.types.get_ota_task_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ota-task-configurations/{Identifier}"
...
async def async_get_ota_task_configuration(
