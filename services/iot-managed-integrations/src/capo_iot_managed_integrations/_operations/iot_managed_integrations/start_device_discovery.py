"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#StartDeviceDiscovery``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.start_device_discovery_response.StartDeviceDiscoveryResponse = capo_iot_managed_integrations.types.start_device_discovery_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.start_device_discovery_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_device_discovery(
