...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_device_discovery_response.GetDeviceDiscoveryResponse = capo_iot_managed_integrations.types.get_device_discovery_response.deserialize_json(
