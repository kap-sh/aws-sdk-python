"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_iot_managed_integrations.types.list_tags_for_resource_response.deserialize_json(
