"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#UpdateDestination``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.update_destination_request.serialize_json(
            input_
        )
    ).encode()
