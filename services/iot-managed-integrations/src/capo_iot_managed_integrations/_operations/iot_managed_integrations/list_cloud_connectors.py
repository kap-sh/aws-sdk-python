"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListCloudConnectors``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_cloud_connectors_response.ListCloudConnectorsResponse = capo_iot_managed_integrations.types.list_cloud_connectors_response.deserialize_json(
...
def build_request(
    ...
    if "lambda_arn" in input_:
        params["LambdaArn"] = str(input_["lambda_arn"])
...
async def async_list_cloud_connectors(
