...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_credential_locker_response.GetCredentialLockerResponse = capo_iot_managed_integrations.types.get_credential_locker_response.deserialize_json(
