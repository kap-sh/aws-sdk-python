"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetCustomEndpoint``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_custom_endpoint_response.GetCustomEndpointResponse = capo_iot_managed_integrations.types.get_custom_endpoint_response.deserialize_json(
...
async def async_get_custom_endpoint(
