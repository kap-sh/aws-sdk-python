...
class IoTManagedIntegrationsError(Exception):
    """Base class for all IoTManagedIntegrations service errors."""


class ServiceError(IoTManagedIntegrationsError):
...
class SerializationError(IoTManagedIntegrationsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IoTManagedIntegrationsError):
...
class WaiterFailedError(IoTManagedIntegrationsError):
...
class WaiterTimeoutError(IoTManagedIntegrationsError):
