"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotmanagedintegrations#InternalServerException``."""
