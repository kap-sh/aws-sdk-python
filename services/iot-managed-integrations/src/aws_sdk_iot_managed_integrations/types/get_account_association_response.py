...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot_managed_integrations.types.account_association_error_message
...
class GetAccountAssociationResponse(TypedDict):
    ...
    error_message: NotRequired[
        "aws_sdk_iot_managed_integrations.types.account_association_error_message.AccountAssociationErrorMessage"
    ]
