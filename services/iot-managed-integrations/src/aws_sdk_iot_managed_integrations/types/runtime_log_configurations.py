...
if TYPE_CHECKING:
    import aws_sdk_iot_managed_integrations.types.delete_local_store_after_upload
    import aws_sdk_iot_managed_integrations.types.local_store_file_rotation_max_bytes
    import aws_sdk_iot_managed_integrations.types.local_store_file_rotation_max_files
    import aws_sdk_iot_managed_integrations.types.local_store_location
    import aws_sdk_iot_managed_integrations.types.log_level
    import aws_sdk_iot_managed_integrations.types.upload_log
    import aws_sdk_iot_managed_integrations.types.upload_period_minutes


class RuntimeLogConfigurations(TypedDict):
    log_level: NotRequired["aws_sdk_iot_managed_integrations.types.log_level.LogLevel"]
    ...
    local_store_location: NotRequired[
        "aws_sdk_iot_managed_integrations.types.local_store_location.LocalStoreLocation"
    ]
    """<p>Configuration of where to store runtime logs in the device.</p>"""
    local_store_file_rotation_max_files: NotRequired[
        "aws_sdk_iot_managed_integrations.types.local_store_file_rotation_max_files.LocalStoreFileRotationMaxFiles"
    ]
    ...
    local_store_file_rotation_max_bytes: NotRequired[
        "aws_sdk_iot_managed_integrations.types.local_store_file_rotation_max_bytes.LocalStoreFileRotationMaxBytes"
    ]
    ...
    upload_log: NotRequired[
        "aws_sdk_iot_managed_integrations.types.upload_log.UploadLog"
    ]
    """<p>Configuration to enable or disable uploading of runtime logs to the cloud.</p>"""
    upload_period_minutes: NotRequired[
        "aws_sdk_iot_managed_integrations.types.upload_period_minutes.UploadPeriodMinutes"
    ]
    ...
    delete_local_store_after_upload: NotRequired[
        "aws_sdk_iot_managed_integrations.types.delete_local_store_after_upload.DeleteLocalStoreAfterUpload"
    ]
