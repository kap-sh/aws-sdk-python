...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot_managed_integrations.types.device_metadata
    import aws_sdk_iot_managed_integrations.types.matter_capability_report
...
class Device(TypedDict, closed=True):
    ...
    capability_report: "aws_sdk_iot_managed_integrations.types.matter_capability_report.MatterCapabilityReport"
    ...
    device_metadata: NotRequired[
        "aws_sdk_iot_managed_integrations.types.device_metadata.DeviceMetadata"
    ]
...
def serialize_json(value: Device) -> dict:
    ...
    out["CapabilityReport"] = (
        aws_sdk_iot_managed_integrations.types.matter_capability_report.serialize_json(
...
def deserialize_json(data: dict) -> Device:
    ...
    if "CapabilityReport" in data:
        ...
        out["capability_report"] = (
            aws_sdk_iot_managed_integrations.types.matter_capability_report.deserialize_json(
