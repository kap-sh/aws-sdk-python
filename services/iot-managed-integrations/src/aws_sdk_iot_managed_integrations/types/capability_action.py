...
if TYPE_CHECKING:
    import aws_sdk_iot_managed_integrations.types.action_reference
    import aws_sdk_iot_managed_integrations.types.action_trace_id
    import aws_sdk_iot_managed_integrations.types.capability_action_name
    import aws_sdk_iot_managed_integrations.types.capability_properties


class CapabilityAction(TypedDict):
    name: "aws_sdk_iot_managed_integrations.types.capability_action_name.CapabilityActionName"
    """<p>Describe a capability action with a name.</p>"""
    ref: NotRequired[
        "aws_sdk_iot_managed_integrations.types.action_reference.ActionReference"
    ]
    """<p>Describe a capability action with an reference.</p>"""
    action_trace_id: NotRequired[
        "aws_sdk_iot_managed_integrations.types.action_trace_id.ActionTraceId"
    ]
