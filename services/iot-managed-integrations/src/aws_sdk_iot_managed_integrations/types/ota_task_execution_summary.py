...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot_managed_integrations.types.ota_task_execution_status
    import aws_sdk_iot_managed_integrations.types.queued_at
    import aws_sdk_iot_managed_integrations.types.retry_attempt
...
class OtaTaskExecutionSummary(TypedDict, closed=True):
    ...
    queued_at: NotRequired["aws_sdk_iot_managed_integrations.types.queued_at.QueuedAt"]
    ...
    retry_attempt: NotRequired[
        "aws_sdk_iot_managed_integrations.types.retry_attempt.RetryAttempt"
    ]
    ...
    started_at: NotRequired[
        "aws_sdk_iot_managed_integrations.types.started_at.StartedAt"
    ]
    """<p>The timestamp value of when the over-the-air (OTA) task execution summary started.</p>"""
    status: NotRequired[
        "aws_sdk_iot_managed_integrations.types.ota_task_execution_status.OtaTaskExecutionStatus"
    ]
...
def serialize_json(value: OtaTaskExecutionSummary) -> dict:
    ...
    if "queued_at" in value:
        ...
        out["QueuedAt"] = (
            aws_sdk_iot_managed_integrations.types.queued_at.serialize_json(
                value["queued_at"]
            )
        )
    ...
    if "started_at" in value:
        ...
        out["StartedAt"] = (
            aws_sdk_iot_managed_integrations.types.started_at.serialize_json(
                value["started_at"]
            )
        )
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_iot_managed_integrations.types.ota_task_execution_status.serialize_json(
                value["status"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> OtaTaskExecutionSummary:
    ...
    if "QueuedAt" in data:
        ...
        out["queued_at"] = (
            aws_sdk_iot_managed_integrations.types.queued_at.deserialize_json(
                data["QueuedAt"]
            )
        )
    ...
    if "StartedAt" in data:
        ...
        out["started_at"] = (
            aws_sdk_iot_managed_integrations.types.started_at.deserialize_json(
                data["StartedAt"]
            )
        )
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_iot_managed_integrations.types.ota_task_execution_status.deserialize_json(
                data["Status"]
            )
        )
    return out
