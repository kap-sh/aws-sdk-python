...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot_managed_integrations.types.device_discovery_arn
    ...
    import aws_sdk_iot_managed_integrations.types.discovery_finished_at
...
class GetDeviceDiscoveryResponse(TypedDict):
    ...
    arn: (
        "aws_sdk_iot_managed_integrations.types.device_discovery_arn.DeviceDiscoveryArn"
    )
    ...
    status: "aws_sdk_iot_managed_integrations.types.device_discovery_status.DeviceDiscoveryStatus"
    ...
    finished_at: NotRequired[
        "aws_sdk_iot_managed_integrations.types.discovery_finished_at.DiscoveryFinishedAt"
    ]
...
def serialize_json(value: GetDeviceDiscoveryResponse) -> dict:
    ...
    if "finished_at" in value:
        ...
        out["FinishedAt"] = (
            aws_sdk_iot_managed_integrations.types.discovery_finished_at.serialize_json(
                value["finished_at"]
            )
        )
    if "tags" in value:
...
def deserialize_json(data: dict) -> GetDeviceDiscoveryResponse:
    ...
    if "FinishedAt" in data:
        ...
        out["finished_at"] = (
            aws_sdk_iot_managed_integrations.types.discovery_finished_at.deserialize_json(
                data["FinishedAt"]
            )
        )
    if "Tags" in data:
