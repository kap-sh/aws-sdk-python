...
if TYPE_CHECKING:
    import aws_sdk_iot_managed_integrations.types.exponential_rollout_rate
    import aws_sdk_iot_managed_integrations.types.maximum_per_minute


class OtaTaskExecutionRolloutConfig(TypedDict):
    exponential_rollout_rate: NotRequired[
        "aws_sdk_iot_managed_integrations.types.exponential_rollout_rate.ExponentialRolloutRate"
    ]
    """<p>Structure representing exponential rate of rollout for an over-the-air (OTA) task.</p>"""
    maximum_per_minute: NotRequired[
        "aws_sdk_iot_managed_integrations.types.maximum_per_minute.MaximumPerMinute"
    ]
...
def serialize_json(value: OtaTaskExecutionRolloutConfig) -> dict:
    ...
    if "exponential_rollout_rate" in value:
        ...
        out["ExponentialRolloutRate"] = (
            aws_sdk_iot_managed_integrations.types.exponential_rollout_rate.serialize_json(
...
def deserialize_json(data: dict) -> OtaTaskExecutionRolloutConfig:
    ...
    if "ExponentialRolloutRate" in data:
        ...
        out["exponential_rollout_rate"] = (
            aws_sdk_iot_managed_integrations.types.exponential_rollout_rate.deserialize_json(
