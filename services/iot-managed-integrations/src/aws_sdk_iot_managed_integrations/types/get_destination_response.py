...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot_managed_integrations.types.destination_created_at
    ...
    import aws_sdk_iot_managed_integrations.types.destination_updated_at
...
class GetDestinationResponse(TypedDict, closed=True):
    ...
    created_at: NotRequired[
        "aws_sdk_iot_managed_integrations.types.destination_created_at.DestinationCreatedAt"
    ]
    """<p>The timestamp value of when the destination creation requset occurred.</p>"""
    updated_at: NotRequired[
        "aws_sdk_iot_managed_integrations.types.destination_updated_at.DestinationUpdatedAt"
    ]
...
def serialize_json(value: GetDestinationResponse) -> dict:
    ...
    if "created_at" in value:
        ...
        out["CreatedAt"] = (
            aws_sdk_iot_managed_integrations.types.destination_created_at.serialize_json(
                value["created_at"]
            )
        )
    if "updated_at" in value:
        ...
        out["UpdatedAt"] = (
            aws_sdk_iot_managed_integrations.types.destination_updated_at.serialize_json(
                value["updated_at"]
            )
        )
    if "tags" in value:
...
def deserialize_json(data: dict) -> GetDestinationResponse:
    ...
    if "CreatedAt" in data:
        ...
        out["created_at"] = (
            aws_sdk_iot_managed_integrations.types.destination_created_at.deserialize_json(
                data["CreatedAt"]
            )
        )
    if "UpdatedAt" in data:
        ...
        out["updated_at"] = (
            aws_sdk_iot_managed_integrations.types.destination_updated_at.deserialize_json(
                data["UpdatedAt"]
            )
        )
    if "Tags" in data:
