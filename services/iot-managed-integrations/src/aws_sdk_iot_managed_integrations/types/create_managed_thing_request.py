...
class CreateManagedThingRequest(TypedDict):
    ...
    authentication_material_type: (
        "aws_sdk_iot_managed_integrations.types.auth_material_type.AuthMaterialType"
    )
...
def serialize_json(value: CreateManagedThingRequest) -> dict:
    ...
    out["AuthenticationMaterialType"] = (
        aws_sdk_iot_managed_integrations.types.auth_material_type.serialize_json(
...
def deserialize_json(data: dict) -> CreateManagedThingRequest:
    ...
    if "AuthenticationMaterialType" in data:
        ...
        out["authentication_material_type"] = (
            aws_sdk_iot_managed_integrations.types.auth_material_type.deserialize_json(
