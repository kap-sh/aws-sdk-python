...
if TYPE_CHECKING:
    import aws_sdk_iot_managed_integrations.types.account_association_list_definition
    import aws_sdk_iot_managed_integrations.types.next_token


class ListAccountAssociationsResponse(TypedDict):
    items: NotRequired[
        "aws_sdk_iot_managed_integrations.types.account_association_list_definition.AccountAssociationListDefinition"
    ]
...
def serialize_json(value: ListAccountAssociationsResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["Items"] = (
            aws_sdk_iot_managed_integrations.types.account_association_list_definition.serialize_json(
                value["items"]
            )
        )
...
def deserialize_json(data: dict) -> ListAccountAssociationsResponse:
    ...
    if "Items" in data:
        ...
        out["items"] = (
            aws_sdk_iot_managed_integrations.types.account_association_list_definition.deserialize_json(
                data["Items"]
            )
        )
