...
if TYPE_CHECKING:
    import aws_sdk_iot_managed_integrations.types.auth_url
    import aws_sdk_iot_managed_integrations.types.proactive_refresh_token_renewal
    import aws_sdk_iot_managed_integrations.types.token_endpoint_authentication_scheme
...
class OAuthConfig(TypedDict):
    ...
    token_endpoint_authentication_scheme: "aws_sdk_iot_managed_integrations.types.token_endpoint_authentication_scheme.TokenEndpointAuthenticationScheme"
...
def serialize_json(value: OAuthConfig) -> dict:
    ...
    out["tokenEndpointAuthenticationScheme"] = (
        aws_sdk_iot_managed_integrations.types.token_endpoint_authentication_scheme.serialize_json(
...
def deserialize_json(data: dict) -> OAuthConfig:
    ...
    if "tokenEndpointAuthenticationScheme" in data:
        ...
        out["token_endpoint_authentication_scheme"] = (
            aws_sdk_iot_managed_integrations.types.token_endpoint_authentication_scheme.deserialize_json(
