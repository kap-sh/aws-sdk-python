...
class GetHubConfigurationResponse(TypedDict):
    ...
    updated_at: NotRequired[
        "aws_sdk_iot_managed_integrations.types.hub_configuration_updated_at.HubConfigurationUpdatedAt"
    ]
...
def serialize_json(value: GetHubConfigurationResponse) -> dict:
    ...
    if "updated_at" in value:
        ...
        out["UpdatedAt"] = (
            aws_sdk_iot_managed_integrations.types.hub_configuration_updated_at.serialize_json(
                value["updated_at"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> GetHubConfigurationResponse:
    ...
    if "UpdatedAt" in data:
        ...
        out["updated_at"] = (
            aws_sdk_iot_managed_integrations.types.hub_configuration_updated_at.deserialize_json(
                data["UpdatedAt"]
            )
        )
    return out
