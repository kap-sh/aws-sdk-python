"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotmanagedintegrations#LimitExceededException``."""
