...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_destinations_response.ListDestinationsResponse = aws_sdk_iot_managed_integrations.types.list_destinations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.list_destinations_request.ListDestinationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
