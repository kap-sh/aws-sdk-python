...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_runtime_log_configuration_response.GetRuntimeLogConfigurationResponse = aws_sdk_iot_managed_integrations.types.get_runtime_log_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_runtime_log_configuration_request.GetRuntimeLogConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
