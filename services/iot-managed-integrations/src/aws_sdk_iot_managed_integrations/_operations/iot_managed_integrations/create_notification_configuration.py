...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.create_notification_configuration_response.CreateNotificationConfigurationResponse = aws_sdk_iot_managed_integrations.types.create_notification_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.create_notification_configuration_request.CreateNotificationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.create_notification_configuration_request.serialize_json(
            input_
        )
    ).encode()
