"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#CreateEventLogConfiguration``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_iot_managed_integrations.errors.conflict_exception

            raise aws_sdk_iot_managed_integrations.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_iot_managed_integrations.errors.service_quota_exceeded_exception

            raise aws_sdk_iot_managed_integrations.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.create_event_log_configuration_response.CreateEventLogConfigurationResponse = aws_sdk_iot_managed_integrations.types.create_event_log_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.create_event_log_configuration_request.CreateEventLogConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/event-log-configurations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iot_managed_integrations.types.create_event_log_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.create_event_log_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_event_log_configuration(
