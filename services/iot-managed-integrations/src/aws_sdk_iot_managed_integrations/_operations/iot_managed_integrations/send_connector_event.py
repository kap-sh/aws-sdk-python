...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.send_connector_event_response.SendConnectorEventResponse = aws_sdk_iot_managed_integrations.types.send_connector_event_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.send_connector_event_request.SendConnectorEventRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.send_connector_event_request.serialize_json(
            input_
        )
    ).encode()
