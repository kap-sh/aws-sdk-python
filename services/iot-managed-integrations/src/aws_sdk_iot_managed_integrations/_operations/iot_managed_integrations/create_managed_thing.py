...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.create_managed_thing_response.CreateManagedThingResponse = aws_sdk_iot_managed_integrations.types.create_managed_thing_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.create_managed_thing_request.CreateManagedThingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.create_managed_thing_request.serialize_json(
            input_
        )
    ).encode()
