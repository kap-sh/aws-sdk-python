"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#CreateDestination``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.create_destination_response.CreateDestinationResponse = aws_sdk_iot_managed_integrations.types.create_destination_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.create_destination_request.CreateDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.create_destination_request.serialize_json(
            input_
        )
    ).encode()
