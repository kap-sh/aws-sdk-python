...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.start_device_discovery_response.StartDeviceDiscoveryResponse = aws_sdk_iot_managed_integrations.types.start_device_discovery_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.start_device_discovery_request.StartDeviceDiscoveryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.start_device_discovery_request.serialize_json(
            input_
        )
    ).encode()
