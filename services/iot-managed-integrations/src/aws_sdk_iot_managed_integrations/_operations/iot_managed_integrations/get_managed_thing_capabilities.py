...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_managed_thing_capabilities_response.GetManagedThingCapabilitiesResponse = aws_sdk_iot_managed_integrations.types.get_managed_thing_capabilities_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_managed_thing_capabilities_request.GetManagedThingCapabilitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
