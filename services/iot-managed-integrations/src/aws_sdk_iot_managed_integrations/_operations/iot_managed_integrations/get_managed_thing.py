"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetManagedThing``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_managed_thing_response.GetManagedThingResponse = aws_sdk_iot_managed_integrations.types.get_managed_thing_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_managed_thing_request.GetManagedThingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_managed_thing(
