"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#CreateAccountAssociation``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.create_account_association_response.CreateAccountAssociationResponse = aws_sdk_iot_managed_integrations.types.create_account_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.create_account_association_request.CreateAccountAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/account-associations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iot_managed_integrations.types.create_account_association_request

    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.create_account_association_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_account_association(
