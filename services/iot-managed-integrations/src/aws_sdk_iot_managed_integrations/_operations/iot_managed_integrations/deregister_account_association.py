"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#DeregisterAccountAssociation``."""
...
import aws_sdk_iot_managed_integrations.types.deregister_account_association_request
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.deregister_account_association_request.DeregisterAccountAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/managed-thing-associations/deregister"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.deregister_account_association_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_deregister_account_association(
