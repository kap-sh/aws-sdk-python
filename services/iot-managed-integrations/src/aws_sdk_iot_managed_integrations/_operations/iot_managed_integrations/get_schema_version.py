...
def build_request(
    ...
    input: aws_sdk_iot_managed_integrations.types.get_schema_version_request.GetSchemaVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{SchemaVersionedId}", quote(str(input["schema_versioned_id"]), safe="")
    )
    params: dict[str, str] = {}
    if "format" in input:
