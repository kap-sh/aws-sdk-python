"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#TagResource``."""
...
import aws_sdk_iot_managed_integrations.errors.invalid_request_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidRequestException":
            raise aws_sdk_iot_managed_integrations.errors.invalid_request_exception.InvalidRequestException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.tag_resource_request.serialize_json(
            input_
        )
    ).encode()
