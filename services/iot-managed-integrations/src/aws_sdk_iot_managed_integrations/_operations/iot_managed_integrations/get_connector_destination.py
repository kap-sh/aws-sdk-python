...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_connector_destination_response.GetConnectorDestinationResponse = aws_sdk_iot_managed_integrations.types.get_connector_destination_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_connector_destination_request.GetConnectorDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
