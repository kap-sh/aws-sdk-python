"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#DeleteOtaTaskConfiguration``."""
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.delete_ota_task_configuration_request.DeleteOtaTaskConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_ota_task_configuration(
