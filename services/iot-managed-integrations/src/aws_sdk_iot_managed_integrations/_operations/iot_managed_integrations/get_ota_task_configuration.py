...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_ota_task_configuration_response.GetOtaTaskConfigurationResponse = aws_sdk_iot_managed_integrations.types.get_ota_task_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_ota_task_configuration_request.GetOtaTaskConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
