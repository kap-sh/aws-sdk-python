"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#DeleteDestination``."""
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.delete_destination_request.DeleteDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
