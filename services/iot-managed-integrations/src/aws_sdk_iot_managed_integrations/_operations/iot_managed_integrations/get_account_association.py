...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_account_association_response.GetAccountAssociationResponse = aws_sdk_iot_managed_integrations.types.get_account_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_account_association_request.GetAccountAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
