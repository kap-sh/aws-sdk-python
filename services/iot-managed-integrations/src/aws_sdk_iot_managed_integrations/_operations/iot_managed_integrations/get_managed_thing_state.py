"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetManagedThingState``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_managed_thing_state_response.GetManagedThingStateResponse = aws_sdk_iot_managed_integrations.types.get_managed_thing_state_response.deserialize_json(
