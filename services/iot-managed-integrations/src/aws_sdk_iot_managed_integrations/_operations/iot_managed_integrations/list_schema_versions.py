"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListSchemaVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_schema_versions_response.ListSchemaVersionsResponse = aws_sdk_iot_managed_integrations.types.list_schema_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.list_schema_versions_request.ListSchemaVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/schema-versions/{Type}"
    ...
    if "schema_id" in input_:
        params["SchemaIdFilter"] = str(input_["schema_id"])
    if "namespace" in input_:
        params["NamespaceFilter"] = str(input_["namespace"])
    if "visibility" in input_:
        params["VisibilityFilter"] = str(input_["visibility"])
    if "semantic_version" in input_:
        params["SemanticVersionFilter"] = str(input_["semantic_version"])
...
async def async_list_schema_versions(
