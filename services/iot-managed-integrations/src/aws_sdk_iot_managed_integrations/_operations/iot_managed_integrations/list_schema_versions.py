...
def build_request(
    ...
    input: aws_sdk_iot_managed_integrations.types.list_schema_versions_request.ListSchemaVersionsRequest,
) -> zapros.Request:
    ...
    if "schema_id" in input:
        params["SchemaIdFilter"] = str(input["schema_id"])
    if "namespace" in input:
        params["NamespaceFilter"] = str(input["namespace"])
    if "visibility" in input:
        params["VisibilityFilter"] = str(input["visibility"])
    if "semantic_version" in input:
        params["SemanticVersionFilter"] = str(input["semantic_version"])
