"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#DeleteConnectorDestination``."""
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.delete_connector_destination_request.DeleteConnectorDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/connector-destinations/{Identifier}"
...
async def async_delete_connector_destination(
