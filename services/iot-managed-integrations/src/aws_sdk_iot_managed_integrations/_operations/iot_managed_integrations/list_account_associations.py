...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_account_associations_response.ListAccountAssociationsResponse = aws_sdk_iot_managed_integrations.types.list_account_associations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot_managed_integrations.types.list_account_associations_request.ListAccountAssociationsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "connector_destination_id" in input:
        params["ConnectorDestinationId"] = str(input["connector_destination_id"])
