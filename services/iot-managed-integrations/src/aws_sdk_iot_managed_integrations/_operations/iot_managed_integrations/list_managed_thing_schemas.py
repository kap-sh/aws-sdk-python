...
def build_request(
    ...
    input: aws_sdk_iot_managed_integrations.types.list_managed_thing_schemas_request.ListManagedThingSchemasRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "endpoint_id_filter" in input:
        params["EndpointIdFilter"] = str(input["endpoint_id_filter"])
    if "capability_id_filter" in input:
        params["CapabilityIdFilter"] = str(input["capability_id_filter"])
