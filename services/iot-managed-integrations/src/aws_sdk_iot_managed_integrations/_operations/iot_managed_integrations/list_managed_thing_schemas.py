"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListManagedThingSchemas``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_managed_thing_schemas_response.ListManagedThingSchemasResponse = aws_sdk_iot_managed_integrations.types.list_managed_thing_schemas_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.list_managed_thing_schemas_request.ListManagedThingSchemasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/managed-thing-schemas/{Identifier}"
    url = url.replace("{Identifier}", quote(str(input_["identifier"]), safe=""))
    params: dict[str, str] = {}
    if "endpoint_id_filter" in input_:
        params["EndpointIdFilter"] = str(input_["endpoint_id_filter"])
    if "capability_id_filter" in input_:
        params["CapabilityIdFilter"] = str(input_["capability_id_filter"])
...
async def async_list_managed_thing_schemas(
