"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#DeleteOtaTask``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            import aws_sdk_iot_managed_integrations.errors.limit_exceeded_exception

            raise aws_sdk_iot_managed_integrations.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.delete_ota_task_request.DeleteOtaTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ota-tasks/{Identifier}"
...
async def async_delete_ota_task(
