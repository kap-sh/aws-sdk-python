"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListOtaTaskConfigurations``."""
...
import aws_sdk_iot_managed_integrations.types.ota_task_configuration_list_definition
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_ota_task_configurations_response.ListOtaTaskConfigurationsResponse = aws_sdk_iot_managed_integrations.types.list_ota_task_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.list_ota_task_configurations_request.ListOtaTaskConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ota-task-configurations"
    params: dict[str, str] = {}
...
async def async_list_ota_task_configurations(
