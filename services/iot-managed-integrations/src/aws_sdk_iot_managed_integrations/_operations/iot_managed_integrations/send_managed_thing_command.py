...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.send_managed_thing_command_response.SendManagedThingCommandResponse = aws_sdk_iot_managed_integrations.types.send_managed_thing_command_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.send_managed_thing_command_request.SendManagedThingCommandRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.send_managed_thing_command_request.serialize_json(
            input_
        )
    ).encode()
