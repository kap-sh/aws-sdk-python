"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListOtaTaskExecutions``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_ota_task_executions_response.ListOtaTaskExecutionsResponse = aws_sdk_iot_managed_integrations.types.list_ota_task_executions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.list_ota_task_executions_request.ListOtaTaskExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ota-tasks/{Identifier}/devices"
...
async def async_list_ota_task_executions(
