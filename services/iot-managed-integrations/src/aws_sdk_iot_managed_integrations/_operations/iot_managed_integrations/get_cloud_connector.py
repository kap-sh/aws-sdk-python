"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetCloudConnector``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_cloud_connector_response.GetCloudConnectorResponse = aws_sdk_iot_managed_integrations.types.get_cloud_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_cloud_connector_request.GetCloudConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_cloud_connector(
