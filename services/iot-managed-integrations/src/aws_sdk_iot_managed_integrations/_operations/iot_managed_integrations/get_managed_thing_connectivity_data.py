...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_managed_thing_connectivity_data_response.GetManagedThingConnectivityDataResponse = aws_sdk_iot_managed_integrations.types.get_managed_thing_connectivity_data_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_managed_thing_connectivity_data_request.GetManagedThingConnectivityDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
