...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.register_account_association_response.RegisterAccountAssociationResponse = aws_sdk_iot_managed_integrations.types.register_account_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.register_account_association_request.RegisterAccountAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.register_account_association_request.serialize_json(
            input_
        )
    ).encode()
