...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_cloud_connectors_response.ListCloudConnectorsResponse = aws_sdk_iot_managed_integrations.types.list_cloud_connectors_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot_managed_integrations.types.list_cloud_connectors_request.ListCloudConnectorsRequest,
) -> zapros.Request:
    ...
    if "lambda_arn" in input:
        params["LambdaArn"] = str(input["lambda_arn"])
