...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.create_provisioning_profile_response.CreateProvisioningProfileResponse = aws_sdk_iot_managed_integrations.types.create_provisioning_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.create_provisioning_profile_request.CreateProvisioningProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.create_provisioning_profile_request.serialize_json(
            input_
        )
    ).encode()
