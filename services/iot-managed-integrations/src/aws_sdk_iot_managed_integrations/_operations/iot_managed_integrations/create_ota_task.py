...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.create_ota_task_response.CreateOtaTaskResponse = aws_sdk_iot_managed_integrations.types.create_ota_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.create_ota_task_request.CreateOtaTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.create_ota_task_request.serialize_json(
            input_
        )
    ).encode()
