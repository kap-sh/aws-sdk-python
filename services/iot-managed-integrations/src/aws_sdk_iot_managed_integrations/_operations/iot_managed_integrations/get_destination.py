"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetDestination``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_destination_response.GetDestinationResponse = aws_sdk_iot_managed_integrations.types.get_destination_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_destination_request.GetDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
