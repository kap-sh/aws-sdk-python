...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_ota_tasks_response.ListOtaTasksResponse = aws_sdk_iot_managed_integrations.types.list_ota_tasks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.list_ota_tasks_request.ListOtaTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
