...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.register_custom_endpoint_response.RegisterCustomEndpointResponse = aws_sdk_iot_managed_integrations.types.register_custom_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.register_custom_endpoint_request.RegisterCustomEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
