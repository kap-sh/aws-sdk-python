"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ResetRuntimeLogConfiguration``."""
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.reset_runtime_log_configuration_request.ResetRuntimeLogConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_reset_runtime_log_configuration(
