"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetDeviceDiscovery``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_device_discovery_response.GetDeviceDiscoveryResponse = aws_sdk_iot_managed_integrations.types.get_device_discovery_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_device_discovery_request.GetDeviceDiscoveryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/device-discoveries/{Identifier}"
...
async def async_get_device_discovery(
