...
def build_request(
    ...
    input: aws_sdk_iot_managed_integrations.types.list_connector_destinations_request.ListConnectorDestinationsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "cloud_connector_id" in input:
        params["CloudConnectorId"] = str(input["cloud_connector_id"])
