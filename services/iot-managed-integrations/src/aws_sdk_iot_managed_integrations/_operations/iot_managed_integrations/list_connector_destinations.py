"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListConnectorDestinations``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_connector_destinations_response.ListConnectorDestinationsResponse = aws_sdk_iot_managed_integrations.types.list_connector_destinations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.list_connector_destinations_request.ListConnectorDestinationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "cloud_connector_id" in input_:
        params["CloudConnectorId"] = str(input_["cloud_connector_id"])
...
async def async_list_connector_destinations(
