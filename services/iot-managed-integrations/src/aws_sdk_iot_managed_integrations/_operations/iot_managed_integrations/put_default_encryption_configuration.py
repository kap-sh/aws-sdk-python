"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#PutDefaultEncryptionConfiguration``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InternalFailureException":
            import aws_sdk_iot_managed_integrations.errors.internal_failure_exception

            raise aws_sdk_iot_managed_integrations.errors.internal_failure_exception.InternalFailureException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.put_default_encryption_configuration_response.PutDefaultEncryptionConfigurationResponse = aws_sdk_iot_managed_integrations.types.put_default_encryption_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.put_default_encryption_configuration_request.PutDefaultEncryptionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_put_default_encryption_configuration(
