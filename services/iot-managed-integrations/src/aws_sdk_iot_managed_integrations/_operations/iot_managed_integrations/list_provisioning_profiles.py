...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_provisioning_profiles_response.ListProvisioningProfilesResponse = aws_sdk_iot_managed_integrations.types.list_provisioning_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.list_provisioning_profiles_request.ListProvisioningProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
