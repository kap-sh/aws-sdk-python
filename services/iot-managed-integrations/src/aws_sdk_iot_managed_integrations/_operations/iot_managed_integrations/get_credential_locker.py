"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetCredentialLocker``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_credential_locker_response.GetCredentialLockerResponse = aws_sdk_iot_managed_integrations.types.get_credential_locker_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_credential_locker_request.GetCredentialLockerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/credential-lockers/{Identifier}"
...
async def async_get_credential_locker(
