"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#UpdateNotificationConfiguration``."""
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.update_notification_configuration_request.UpdateNotificationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.update_notification_configuration_request.serialize_json(
            input_
        )
    ).encode()
