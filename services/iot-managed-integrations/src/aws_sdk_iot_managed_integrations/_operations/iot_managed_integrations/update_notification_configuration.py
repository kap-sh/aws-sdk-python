...
def build_request(
    ...
    input: aws_sdk_iot_managed_integrations.types.update_notification_configuration_request.UpdateNotificationConfigurationRequest,
) -> zapros.Request:
    ...
    url = url.replace("{EventType}", quote(str(input["event_type"]), safe=""))
    params: dict[str, str] = {}
