"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetOtaTask``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_ota_task_response.GetOtaTaskResponse = aws_sdk_iot_managed_integrations.types.get_ota_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_ota_task_request.GetOtaTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
