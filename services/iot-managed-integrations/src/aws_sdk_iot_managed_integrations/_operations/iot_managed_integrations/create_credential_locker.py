"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#CreateCredentialLocker``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.create_credential_locker_response.CreateCredentialLockerResponse = aws_sdk_iot_managed_integrations.types.create_credential_locker_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.create_credential_locker_request.CreateCredentialLockerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/credential-lockers"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iot_managed_integrations.types.create_credential_locker_request

    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.create_credential_locker_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_credential_locker(
