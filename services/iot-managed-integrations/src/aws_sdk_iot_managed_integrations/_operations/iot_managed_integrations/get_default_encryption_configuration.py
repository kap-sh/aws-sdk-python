...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_default_encryption_configuration_response.GetDefaultEncryptionConfigurationResponse = aws_sdk_iot_managed_integrations.types.get_default_encryption_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_default_encryption_configuration_request.GetDefaultEncryptionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
