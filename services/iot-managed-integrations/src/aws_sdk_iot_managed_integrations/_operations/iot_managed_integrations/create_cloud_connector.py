"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#CreateCloudConnector``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.create_cloud_connector_response.CreateCloudConnectorResponse = aws_sdk_iot_managed_integrations.types.create_cloud_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.create_cloud_connector_request.CreateCloudConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/cloud-connectors"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iot_managed_integrations.types.create_cloud_connector_request

    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.create_cloud_connector_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_cloud_connector(
