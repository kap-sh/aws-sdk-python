...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_managed_thing_account_associations_response.ListManagedThingAccountAssociationsResponse = aws_sdk_iot_managed_integrations.types.list_managed_thing_account_associations_response.deserialize_json(
