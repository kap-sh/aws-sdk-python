...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_custom_endpoint_response.GetCustomEndpointResponse = aws_sdk_iot_managed_integrations.types.get_custom_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_custom_endpoint_request.GetCustomEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
