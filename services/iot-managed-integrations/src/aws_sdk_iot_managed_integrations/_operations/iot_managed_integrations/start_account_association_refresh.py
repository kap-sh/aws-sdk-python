...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.start_account_association_refresh_response.StartAccountAssociationRefreshResponse = aws_sdk_iot_managed_integrations.types.start_account_association_refresh_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.start_account_association_refresh_request.StartAccountAssociationRefreshRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
