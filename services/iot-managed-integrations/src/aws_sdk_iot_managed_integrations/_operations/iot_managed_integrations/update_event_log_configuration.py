...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.update_event_log_configuration_request.UpdateEventLogConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.update_event_log_configuration_request.serialize_json(
            input_
        )
    ).encode()
