"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#UpdateOtaTask``."""
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.update_ota_task_request.UpdateOtaTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.update_ota_task_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_ota_task(
