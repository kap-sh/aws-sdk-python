"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#CreateConnectorDestination``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.create_connector_destination_response.CreateConnectorDestinationResponse = aws_sdk_iot_managed_integrations.types.create_connector_destination_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.create_connector_destination_request.CreateConnectorDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/connector-destinations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iot_managed_integrations.types.create_connector_destination_request

    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.create_connector_destination_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_connector_destination(
