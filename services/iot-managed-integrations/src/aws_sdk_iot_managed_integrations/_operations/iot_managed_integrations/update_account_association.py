...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.update_account_association_request.UpdateAccountAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.update_account_association_request.serialize_json(
            input_
        )
    ).encode()
