"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListNotificationConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_notification_configurations_response.ListNotificationConfigurationsResponse = aws_sdk_iot_managed_integrations.types.list_notification_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.list_notification_configurations_request.ListNotificationConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
