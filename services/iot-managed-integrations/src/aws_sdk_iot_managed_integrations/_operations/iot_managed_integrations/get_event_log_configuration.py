"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetEventLogConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_event_log_configuration_response.GetEventLogConfigurationResponse = aws_sdk_iot_managed_integrations.types.get_event_log_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_event_log_configuration_request.GetEventLogConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/event-log-configurations/{Id}"
...
async def async_get_event_log_configuration(
