...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_provisioning_profile_response.GetProvisioningProfileResponse = aws_sdk_iot_managed_integrations.types.get_provisioning_profile_response.deserialize_json(
