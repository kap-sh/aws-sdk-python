"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetManagedThingCertificate``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_managed_thing_certificate_response.GetManagedThingCertificateResponse = aws_sdk_iot_managed_integrations.types.get_managed_thing_certificate_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_managed_thing_certificate_request.GetManagedThingCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/managed-things-certificate/{Identifier}"
...
async def async_get_managed_thing_certificate(
