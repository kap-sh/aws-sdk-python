...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.get_managed_thing_meta_data_response.GetManagedThingMetaDataResponse = aws_sdk_iot_managed_integrations.types.get_managed_thing_meta_data_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.get_managed_thing_meta_data_request.GetManagedThingMetaDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
