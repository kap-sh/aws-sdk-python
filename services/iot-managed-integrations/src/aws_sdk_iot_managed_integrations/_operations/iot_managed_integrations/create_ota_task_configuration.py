...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.create_ota_task_configuration_response.CreateOtaTaskConfigurationResponse = aws_sdk_iot_managed_integrations.types.create_ota_task_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.create_ota_task_configuration_request.CreateOtaTaskConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.create_ota_task_configuration_request.serialize_json(
            input_
        )
    ).encode()
