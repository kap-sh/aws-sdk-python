...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_event_log_configurations_response.ListEventLogConfigurationsResponse = aws_sdk_iot_managed_integrations.types.list_event_log_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.list_event_log_configurations_request.ListEventLogConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
