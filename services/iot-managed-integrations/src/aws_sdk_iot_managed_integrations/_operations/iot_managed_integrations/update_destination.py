...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.update_destination_request.UpdateDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot_managed_integrations.types.update_destination_request.serialize_json(
            input_
        )
    ).encode()
