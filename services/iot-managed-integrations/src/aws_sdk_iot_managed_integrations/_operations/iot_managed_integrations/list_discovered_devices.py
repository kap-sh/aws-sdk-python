"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListDiscoveredDevices``."""
...
def handle_response(
    ...
    out: aws_sdk_iot_managed_integrations.types.list_discovered_devices_response.ListDiscoveredDevicesResponse = aws_sdk_iot_managed_integrations.types.list_discovered_devices_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot_managed_integrations.types.list_discovered_devices_request.ListDiscoveredDevicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/device-discoveries/{Identifier}/devices"
...
async def async_list_discovered_devices(
