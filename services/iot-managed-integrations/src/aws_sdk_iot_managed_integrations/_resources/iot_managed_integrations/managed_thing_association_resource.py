...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot_managed_integrations.types.list_managed_thing_account_associations_request
    import aws_sdk_iot_managed_integrations.types.list_managed_thing_account_associations_response
    ...
    import aws_sdk_iot_managed_integrations.types.register_account_association_request
    import aws_sdk_iot_managed_integrations.types.register_account_association_response
...
class ManagedThingAssociationResource:
    ...
    def deregister_account_association(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_managed_integrations.types.deregister_account_association_request.DeregisterAccountAssociationRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_iot_managed_integrations._operations.iot_managed_integrations.deregister_account_association

            output, http_response = (
                aws_sdk_iot_managed_integrations._operations.iot_managed_integrations.deregister_account_association.deregister_account_association(
    ...
    def list_managed_thing_account_associations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_managed_integrations.types.list_managed_thing_account_associations_request.ListManagedThingAccountAssociationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_managed_integrations.types.list_managed_thing_account_associations_response.ListManagedThingAccountAssociationsResponse"
        ]:
            import aws_sdk_iot_managed_integrations._operations.iot_managed_integrations.list_managed_thing_account_associations

            output, http_response = (
                aws_sdk_iot_managed_integrations._operations.iot_managed_integrations.list_managed_thing_account_associations.list_managed_thing_account_associations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_account_association(
        ...
        managed_thing_id: "aws_sdk_iot_managed_integrations.types.managed_thing_id.ManagedThingId",
        account_association_id: "aws_sdk_iot_managed_integrations.types.account_association_id.AccountAssociationId",
        device_discovery_id: "aws_sdk_iot_managed_integrations.types.device_discovery_id.DeviceDiscoveryId",
        *,
        config_overrides: Optional[IoTManagedIntegrationsClientConfig] = None,
    ) -> "aws_sdk_iot_managed_integrations.types.register_account_association_response.RegisterAccountAssociationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iot_managed_integrations.types.register_account_association_request.RegisterAccountAssociationRequest]",
        ) -> OperationResponse[
            "aws_sdk_iot_managed_integrations.types.register_account_association_response.RegisterAccountAssociationResponse"
        ]:
            import aws_sdk_iot_managed_integrations._operations.iot_managed_integrations.register_account_association

            output, http_response = (
                aws_sdk_iot_managed_integrations._operations.iot_managed_integrations.register_account_association.register_account_association(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncManagedThingAssociationResource:
    ...
    async def deregister_account_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot_managed_integrations.types.deregister_account_association_request.DeregisterAccountAssociationRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot_managed_integrations._operations.iot_managed_integrations.deregister_account_association.async_deregister_account_association(
                req.options, req.input
            )
    ...
    async def list_managed_thing_account_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot_managed_integrations.types.list_managed_thing_account_associations_request.ListManagedThingAccountAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot_managed_integrations.types.list_managed_thing_account_associations_response.ListManagedThingAccountAssociationsResponse"
        ]:
            import aws_sdk_iot_managed_integrations._operations.iot_managed_integrations.list_managed_thing_account_associations
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot_managed_integrations._operations.iot_managed_integrations.list_managed_thing_account_associations.async_list_managed_thing_account_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_account_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot_managed_integrations.types.register_account_association_request.RegisterAccountAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot_managed_integrations.types.register_account_association_response.RegisterAccountAssociationResponse"
        ]:
            import aws_sdk_iot_managed_integrations._operations.iot_managed_integrations.register_account_association
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot_managed_integrations._operations.iot_managed_integrations.register_account_association.async_register_account_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
