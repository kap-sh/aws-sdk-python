"""Generated from Smithy shape ``com.amazonaws.sns#TopicAttributesMap``."""
...
TopicAttributesMap: TypeAlias = dict[
...
# --- awsQuery ser/de ---
def serialize_query(
    input_to_serialize: TopicAttributesMap, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> TopicAttributesMap:
    out: TopicAttributesMap = {}
...
def deserialize_query_flat(parent: Element, tag: str) -> TopicAttributesMap:
    out: TopicAttributesMap = {}
