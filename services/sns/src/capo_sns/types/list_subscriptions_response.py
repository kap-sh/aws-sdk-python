"""Generated from Smithy shape ``com.amazonaws.sns#ListSubscriptionsResponse``."""
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ListSubscriptionsResponse, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ListSubscriptionsResponse:
