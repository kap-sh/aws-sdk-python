"""Generated from Smithy shape ``com.amazonaws.sns#ConfirmSubscription``."""
...
import capo_sns.errors.filter_policy_limit_exceeded_exception
...
import capo_sns.errors.replay_limit_exceeded_exception
import capo_sns.errors.subscription_limit_exceeded_exception
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ConfirmSubscriptionResult")
    out: capo_sns.types.confirm_subscription_response.ConfirmSubscriptionResponse = (
        capo_sns.types.confirm_subscription_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ConfirmSubscription"))
    pairs.append(("Version", "2010-03-31"))
    capo_sns.types.confirm_subscription_input.serialize_query(input_, pairs, "")
...
async def async_confirm_subscription(
