...
import capo_sns.errors.invalid_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidState":
            raise capo_sns.errors.invalid_state_exception.InvalidStateException.from_query(
                error_el, message
            )
        case "NotFound":
...
def build_request(
    ...
    capo_sns.types.delete_topic_input.serialize_query(input_, pairs, "")
