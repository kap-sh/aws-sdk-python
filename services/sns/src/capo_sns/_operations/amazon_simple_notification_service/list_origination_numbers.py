...
def handle_response(
    ...
    out: capo_sns.types.list_origination_numbers_result.ListOriginationNumbersResult = (
        capo_sns.types.list_origination_numbers_result.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.list_origination_numbers_request.serialize_query(input_, pairs, "")
