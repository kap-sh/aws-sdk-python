...
def handle_response(
    ...
    out: capo_sns.types.tag_resource_response.TagResourceResponse = (
        capo_sns.types.tag_resource_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.tag_resource_request.serialize_query(input_, pairs, "")
...
def tag_resource(
    ...
    input_: capo_sns.types.tag_resource_request.TagResourceRequest,
) -> tuple[capo_sns.types.tag_resource_response.TagResourceResponse, zapros.Response]:
