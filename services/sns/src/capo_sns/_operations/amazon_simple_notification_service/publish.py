"""Generated from Smithy shape ``com.amazonaws.sns#Publish``."""
...
def handle_response(
    ...
    out: capo_sns.types.publish_response.PublishResponse = (
        capo_sns.types.publish_response.deserialize_query(
...
def build_request(
    ...
    input_: capo_sns.types.publish_input.PublishInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    capo_sns.types.publish_input.serialize_query(input_, pairs, "")
...
def publish(
    options: OperationOptions, input_: capo_sns.types.publish_input.PublishInput
) -> tuple[capo_sns.types.publish_response.PublishResponse, zapros.Response]:
...
async def async_publish(
    options: AsyncOperationOptions, input_: capo_sns.types.publish_input.PublishInput
) -> tuple[capo_sns.types.publish_response.PublishResponse, zapros.Response]:
