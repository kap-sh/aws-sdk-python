"""Generated from Smithy shape ``com.amazonaws.sns#CheckIfPhoneNumberIsOptedOut``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CheckIfPhoneNumberIsOptedOutResult")
    out: capo_sns.types.check_if_phone_number_is_opted_out_response.CheckIfPhoneNumberIsOptedOutResponse = capo_sns.types.check_if_phone_number_is_opted_out_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CheckIfPhoneNumberIsOptedOut"))
    pairs.append(("Version", "2010-03-31"))
    capo_sns.types.check_if_phone_number_is_opted_out_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_check_if_phone_number_is_opted_out(
