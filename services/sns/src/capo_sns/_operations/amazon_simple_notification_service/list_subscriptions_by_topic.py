...
def handle_response(
    ...
    out: capo_sns.types.list_subscriptions_by_topic_response.ListSubscriptionsByTopicResponse = capo_sns.types.list_subscriptions_by_topic_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.list_subscriptions_by_topic_input.serialize_query(input_, pairs, "")
