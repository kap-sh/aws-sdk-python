"""Generated from Smithy shape ``com.amazonaws.sns#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_sns.types.list_tags_for_resource_response.ListTagsForResourceResponse = (
        capo_sns.types.list_tags_for_resource_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.list_tags_for_resource_request.serialize_query(input_, pairs, "")
