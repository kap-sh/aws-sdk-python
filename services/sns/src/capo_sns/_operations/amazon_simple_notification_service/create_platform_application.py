"""Generated from Smithy shape ``com.amazonaws.sns#CreatePlatformApplication``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreatePlatformApplicationResult")
    out: capo_sns.types.create_platform_application_response.CreatePlatformApplicationResponse = capo_sns.types.create_platform_application_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreatePlatformApplication"))
    pairs.append(("Version", "2010-03-31"))
    capo_sns.types.create_platform_application_input.serialize_query(input_, pairs, "")
...
async def async_create_platform_application(
