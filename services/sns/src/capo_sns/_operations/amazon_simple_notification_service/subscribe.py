...
def handle_response(
    ...
    out: capo_sns.types.subscribe_response.SubscribeResponse = (
        capo_sns.types.subscribe_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.subscribe_input.serialize_query(input_, pairs, "")
...
def subscribe(
    options: OperationOptions, input_: capo_sns.types.subscribe_input.SubscribeInput
) -> tuple[capo_sns.types.subscribe_response.SubscribeResponse, zapros.Response]:
