...
def handle_response(
    ...
    out: capo_sns.types.create_endpoint_response.CreateEndpointResponse = (
        capo_sns.types.create_endpoint_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.create_platform_endpoint_input.serialize_query(input_, pairs, "")
...
def create_platform_endpoint(
    ...
    capo_sns.types.create_endpoint_response.CreateEndpointResponse, zapros.Response
]:
