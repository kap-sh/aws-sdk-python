...
def handle_response(
    ...
    out: capo_sns.types.untag_resource_response.UntagResourceResponse = (
        capo_sns.types.untag_resource_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.untag_resource_request.serialize_query(input_, pairs, "")
...
def untag_resource(
    ...
    capo_sns.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
