...
import capo_sns.errors.verification_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "VerificationException":
            raise capo_sns.errors.verification_exception.VerificationException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_sns.types.verify_sms_sandbox_phone_number_result.VerifySMSSandboxPhoneNumberResult = capo_sns.types.verify_sms_sandbox_phone_number_result.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.verify_sms_sandbox_phone_number_input.serialize_query(
        input_, pairs, ""
    )
