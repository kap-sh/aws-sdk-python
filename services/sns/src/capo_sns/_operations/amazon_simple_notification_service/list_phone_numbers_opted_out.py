"""Generated from Smithy shape ``com.amazonaws.sns#ListPhoneNumbersOptedOut``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListPhoneNumbersOptedOutResult")
    out: capo_sns.types.list_phone_numbers_opted_out_response.ListPhoneNumbersOptedOutResponse = capo_sns.types.list_phone_numbers_opted_out_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.list_phone_numbers_opted_out_input.serialize_query(input_, pairs, "")
...
async def async_list_phone_numbers_opted_out(
