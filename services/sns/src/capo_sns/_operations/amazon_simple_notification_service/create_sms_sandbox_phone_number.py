...
import capo_sns.errors.opted_out_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OptedOutException":
            raise capo_sns.errors.opted_out_exception.OptedOutException.from_query(root)
...
def handle_response(
    ...
    out: capo_sns.types.create_sms_sandbox_phone_number_result.CreateSMSSandboxPhoneNumberResult = capo_sns.types.create_sms_sandbox_phone_number_result.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.create_sms_sandbox_phone_number_input.serialize_query(
        input_, pairs, ""
    )
