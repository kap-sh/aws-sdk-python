...
def handle_response(
    ...
    out: capo_sns.types.get_topic_attributes_response.GetTopicAttributesResponse = (
        capo_sns.types.get_topic_attributes_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.get_topic_attributes_input.serialize_query(input_, pairs, "")
