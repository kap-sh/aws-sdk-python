"""Generated from Smithy shape ``com.amazonaws.sns#ListEndpointsByPlatformApplication``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListEndpointsByPlatformApplicationResult")
    out: capo_sns.types.list_endpoints_by_platform_application_response.ListEndpointsByPlatformApplicationResponse = capo_sns.types.list_endpoints_by_platform_application_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.list_endpoints_by_platform_application_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_endpoints_by_platform_application(
