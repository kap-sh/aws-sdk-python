...
def handle_response(
    ...
    out: capo_sns.types.list_sms_sandbox_phone_numbers_result.ListSMSSandboxPhoneNumbersResult = capo_sns.types.list_sms_sandbox_phone_numbers_result.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.list_sms_sandbox_phone_numbers_input.serialize_query(
        input_, pairs, ""
    )
