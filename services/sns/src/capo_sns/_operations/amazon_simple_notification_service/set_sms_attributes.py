...
def handle_response(
    ...
    out: capo_sns.types.set_sms_attributes_response.SetSMSAttributesResponse = (
        capo_sns.types.set_sms_attributes_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.set_sms_attributes_input.serialize_query(input_, pairs, "")
...
def set_sms_attributes(
    ...
    capo_sns.types.set_sms_attributes_response.SetSMSAttributesResponse, zapros.Response
]:
