...
import capo_sns.errors.resource_not_found_exception
import capo_sns.errors.throttled_exception
import capo_sns.errors.user_error_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFound":
            raise capo_sns.errors.resource_not_found_exception.ResourceNotFoundException.from_query(
                error_el, message
            )
        case "Throttled":
        ...
        case "UserError":
            raise capo_sns.errors.user_error_exception.UserErrorException.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_sns.types.delete_sms_sandbox_phone_number_result.DeleteSMSSandboxPhoneNumberResult = capo_sns.types.delete_sms_sandbox_phone_number_result.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.delete_sms_sandbox_phone_number_input.serialize_query(
        input_, pairs, ""
    )
