...
def handle_response(
    ...
    out: capo_sns.types.list_subscriptions_response.ListSubscriptionsResponse = (
        capo_sns.types.list_subscriptions_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.list_subscriptions_input.serialize_query(input_, pairs, "")
