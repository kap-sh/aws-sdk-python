...
def handle_response(
    ...
    out: capo_sns.types.get_subscription_attributes_response.GetSubscriptionAttributesResponse = capo_sns.types.get_subscription_attributes_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.get_subscription_attributes_input.serialize_query(input_, pairs, "")
