...
def handle_response(
    ...
    out: capo_sns.types.get_platform_application_attributes_response.GetPlatformApplicationAttributesResponse = capo_sns.types.get_platform_application_attributes_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.get_platform_application_attributes_input.serialize_query(
        input_, pairs, ""
    )
