"""Generated from Smithy shape ``com.amazonaws.sns#SetEndpointAttributes``."""
...
def build_request(
    ...
    pairs.append(("Action", "SetEndpointAttributes"))
    pairs.append(("Version", "2010-03-31"))
    capo_sns.types.set_endpoint_attributes_input.serialize_query(input_, pairs, "")
...
async def async_set_endpoint_attributes(
