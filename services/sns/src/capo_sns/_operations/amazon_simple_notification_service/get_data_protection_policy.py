...
def handle_response(
    ...
    out: capo_sns.types.get_data_protection_policy_response.GetDataProtectionPolicyResponse = capo_sns.types.get_data_protection_policy_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.get_data_protection_policy_input.serialize_query(input_, pairs, "")
