...
def handle_response(
    ...
    out: capo_sns.types.list_platform_applications_response.ListPlatformApplicationsResponse = capo_sns.types.list_platform_applications_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.list_platform_applications_input.serialize_query(input_, pairs, "")
