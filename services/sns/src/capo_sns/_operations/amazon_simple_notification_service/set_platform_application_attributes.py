"""Generated from Smithy shape ``com.amazonaws.sns#SetPlatformApplicationAttributes``."""
...
def build_request(
    ...
    pairs.append(("Action", "SetPlatformApplicationAttributes"))
    pairs.append(("Version", "2010-03-31"))
    capo_sns.types.set_platform_application_attributes_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_set_platform_application_attributes(
