...
def handle_response(
    ...
    out: capo_sns.types.get_sms_sandbox_account_status_result.GetSMSSandboxAccountStatusResult = capo_sns.types.get_sms_sandbox_account_status_result.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.get_sms_sandbox_account_status_input.serialize_query(
        input_, pairs, ""
    )
