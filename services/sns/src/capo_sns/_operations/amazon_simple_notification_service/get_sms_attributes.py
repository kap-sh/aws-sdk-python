...
def handle_response(
    ...
    out: capo_sns.types.get_sms_attributes_response.GetSMSAttributesResponse = (
        capo_sns.types.get_sms_attributes_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.get_sms_attributes_input.serialize_query(input_, pairs, "")
...
def get_sms_attributes(
    ...
    capo_sns.types.get_sms_attributes_response.GetSMSAttributesResponse, zapros.Response
]:
