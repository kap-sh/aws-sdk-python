...
def handle_response(
    ...
    out: capo_sns.types.list_topics_response.ListTopicsResponse = (
        capo_sns.types.list_topics_response.deserialize_query(
...
def build_request(
    ...
    capo_sns.types.list_topics_input.serialize_query(input_, pairs, "")
...
def list_topics(
    options: OperationOptions, input_: capo_sns.types.list_topics_input.ListTopicsInput
) -> tuple[capo_sns.types.list_topics_response.ListTopicsResponse, zapros.Response]:
