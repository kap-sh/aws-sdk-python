"""Generated from Smithy shape ``com.amazonaws.sns#ListTopics``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListTopicsResult")
    out: aws_sdk_sns.types.list_topics_response.ListTopicsResponse = (
        aws_sdk_sns.types.list_topics_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.list_topics_input.ListTopicsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListTopics"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.list_topics_input

    aws_sdk_sns.types.list_topics_input.serialize_query(input_, pairs, "")
...
def list_topics(
    ...
    input_: aws_sdk_sns.types.list_topics_input.ListTopicsInput,
) -> tuple[aws_sdk_sns.types.list_topics_response.ListTopicsResponse, zapros.Response]:
