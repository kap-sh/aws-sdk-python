...
def handle_response(
    ...
    out: aws_sdk_sns.types.check_if_phone_number_is_opted_out_response.CheckIfPhoneNumberIsOptedOutResponse = aws_sdk_sns.types.check_if_phone_number_is_opted_out_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.check_if_phone_number_is_opted_out_input.CheckIfPhoneNumberIsOptedOutInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sns.types.check_if_phone_number_is_opted_out_input.serialize_query(
        input_, pairs, ""
    )
