"""Generated from Smithy shape ``com.amazonaws.sns#ListOriginationNumbers``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListOriginationNumbersResult")
    out: aws_sdk_sns.types.list_origination_numbers_result.ListOriginationNumbersResult = aws_sdk_sns.types.list_origination_numbers_result.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_sns.types.list_origination_numbers_request.ListOriginationNumbersRequest,
) -> zapros.Request:
    ...
    aws_sdk_sns.types.list_origination_numbers_request.serialize_query(input, pairs, "")
...
async def async_list_origination_numbers(
