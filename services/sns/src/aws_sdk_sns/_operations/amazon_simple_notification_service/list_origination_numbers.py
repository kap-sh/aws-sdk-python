...
def build_request(
    ...
    input_: aws_sdk_sns.types.list_origination_numbers_request.ListOriginationNumbersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sns.types.list_origination_numbers_request.serialize_query(
        input_, pairs, ""
    )
