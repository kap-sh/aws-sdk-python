...
def handle_response(
    ...
    out: aws_sdk_sns.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_sns.types.list_tags_for_resource_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sns.types.list_tags_for_resource_request.serialize_query(input_, pairs, "")
