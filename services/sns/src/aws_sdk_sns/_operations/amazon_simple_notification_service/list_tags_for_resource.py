...
def build_request(
    ...
    input: aws_sdk_sns.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    ...
    aws_sdk_sns.types.list_tags_for_resource_request.serialize_query(input, pairs, "")
