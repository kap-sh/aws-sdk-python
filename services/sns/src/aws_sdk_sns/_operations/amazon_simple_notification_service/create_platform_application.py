...
def handle_response(
    ...
    out: aws_sdk_sns.types.create_platform_application_response.CreatePlatformApplicationResponse = aws_sdk_sns.types.create_platform_application_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.create_platform_application_input.CreatePlatformApplicationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sns.types.create_platform_application_input.serialize_query(
        input_, pairs, ""
    )
