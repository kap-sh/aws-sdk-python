"""Generated from Smithy shape ``com.amazonaws.sns#ListSMSSandboxPhoneNumbers``."""
...
import aws_sdk_sns.types.sms_sandbox_phone_number_list
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListSMSSandboxPhoneNumbersResult")
    out: aws_sdk_sns.types.list_sms_sandbox_phone_numbers_result.ListSMSSandboxPhoneNumbersResult = aws_sdk_sns.types.list_sms_sandbox_phone_numbers_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.list_sms_sandbox_phone_numbers_input.ListSMSSandboxPhoneNumbersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListSMSSandboxPhoneNumbers"))
    pairs.append(("Version", "2010-03-31"))
    aws_sdk_sns.types.list_sms_sandbox_phone_numbers_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_sms_sandbox_phone_numbers(
