"""Generated from Smithy shape ``com.amazonaws.sns#CreatePlatformEndpoint``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreatePlatformEndpointResult")
    out: aws_sdk_sns.types.create_endpoint_response.CreateEndpointResponse = (
        aws_sdk_sns.types.create_endpoint_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.create_platform_endpoint_input.CreatePlatformEndpointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreatePlatformEndpoint"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.create_platform_endpoint_input

    aws_sdk_sns.types.create_platform_endpoint_input.serialize_query(input_, pairs, "")
...
def create_platform_endpoint(
    ...
    aws_sdk_sns.types.create_endpoint_response.CreateEndpointResponse, zapros.Response
]:
...
async def async_create_platform_endpoint(
