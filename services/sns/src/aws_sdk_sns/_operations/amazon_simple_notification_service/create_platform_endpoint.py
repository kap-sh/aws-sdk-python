...
def build_request(
    ...
    input: aws_sdk_sns.types.create_platform_endpoint_input.CreatePlatformEndpointInput,
) -> zapros.Request:
    ...
    aws_sdk_sns.types.create_platform_endpoint_input.serialize_query(input, pairs, "")
