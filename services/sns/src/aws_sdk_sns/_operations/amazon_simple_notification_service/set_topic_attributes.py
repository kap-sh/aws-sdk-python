"""Generated from Smithy shape ``com.amazonaws.sns#SetTopicAttributes``."""
...
def build_request(
    ...
    input_: aws_sdk_sns.types.set_topic_attributes_input.SetTopicAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "SetTopicAttributes"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.set_topic_attributes_input

    aws_sdk_sns.types.set_topic_attributes_input.serialize_query(input_, pairs, "")
...
async def async_set_topic_attributes(
