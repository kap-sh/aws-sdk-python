"""Generated from Smithy shape ``com.amazonaws.sns#DeleteTopic``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidStateException":
            import aws_sdk_sns.errors.invalid_state_exception

            raise aws_sdk_sns.errors.invalid_state_exception.InvalidStateException.from_query(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_sns.types.delete_topic_input.DeleteTopicInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteTopic"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.delete_topic_input

    aws_sdk_sns.types.delete_topic_input.serialize_query(input_, pairs, "")
