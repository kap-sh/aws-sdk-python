"""Generated from Smithy shape ``com.amazonaws.sns#DeletePlatformApplication``."""
...
def build_request(
    ...
    input_: aws_sdk_sns.types.delete_platform_application_input.DeletePlatformApplicationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeletePlatformApplication"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.delete_platform_application_input

    aws_sdk_sns.types.delete_platform_application_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_platform_application(
