...
def handle_response(
    ...
    out: aws_sdk_sns.types.list_phone_numbers_opted_out_response.ListPhoneNumbersOptedOutResponse = aws_sdk_sns.types.list_phone_numbers_opted_out_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.list_phone_numbers_opted_out_input.ListPhoneNumbersOptedOutInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
