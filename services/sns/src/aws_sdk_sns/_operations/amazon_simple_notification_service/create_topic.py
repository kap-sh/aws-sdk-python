...
import aws_sdk_sns.errors.topic_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TopicLimitExceededException":
            raise aws_sdk_sns.errors.topic_limit_exceeded_exception.TopicLimitExceededException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_sns.types.create_topic_response.CreateTopicResponse = (
        aws_sdk_sns.types.create_topic_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.create_topic_input.CreateTopicInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sns.types.create_topic_input.serialize_query(input_, pairs, "")
...
def create_topic(
    ...
    aws_sdk_sns.types.create_topic_response.CreateTopicResponse, zapros.Response
]:
