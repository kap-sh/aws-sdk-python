...
def build_request(
    ...
    input_: aws_sdk_sns.types.set_platform_application_attributes_input.SetPlatformApplicationAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sns.types.set_platform_application_attributes_input.serialize_query(
        input_, pairs, ""
    )
