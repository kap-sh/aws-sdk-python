...
def handle_response(
    ...
    out: aws_sdk_sns.types.opt_in_phone_number_response.OptInPhoneNumberResponse = (
        aws_sdk_sns.types.opt_in_phone_number_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.opt_in_phone_number_input.OptInPhoneNumberInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sns.types.opt_in_phone_number_input.serialize_query(input_, pairs, "")
