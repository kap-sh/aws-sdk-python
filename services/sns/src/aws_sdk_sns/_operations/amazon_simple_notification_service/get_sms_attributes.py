"""Generated from Smithy shape ``com.amazonaws.sns#GetSMSAttributes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetSMSAttributesResult")
    out: aws_sdk_sns.types.get_sms_attributes_response.GetSMSAttributesResponse = (
        aws_sdk_sns.types.get_sms_attributes_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.get_sms_attributes_input.GetSMSAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sns.types.get_sms_attributes_input.serialize_query(input_, pairs, "")
...
async def async_get_sms_attributes(
