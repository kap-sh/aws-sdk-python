"""Generated from Smithy shape ``com.amazonaws.sns#GetDataProtectionPolicy``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetDataProtectionPolicyResult")
    out: aws_sdk_sns.types.get_data_protection_policy_response.GetDataProtectionPolicyResponse = aws_sdk_sns.types.get_data_protection_policy_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_sns.types.get_data_protection_policy_input.GetDataProtectionPolicyInput,
) -> zapros.Request:
    ...
    pairs.append(("Action", "GetDataProtectionPolicy"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.get_data_protection_policy_input

    aws_sdk_sns.types.get_data_protection_policy_input.serialize_query(input, pairs, "")
