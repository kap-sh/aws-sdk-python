...
def build_request(
    ...
    input_: aws_sdk_sns.types.get_data_protection_policy_input.GetDataProtectionPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sns.types.get_data_protection_policy_input.serialize_query(
        input_, pairs, ""
    )
