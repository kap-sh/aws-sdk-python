"""Generated from Smithy shape ``com.amazonaws.sns#GetSMSSandboxAccountStatus``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetSMSSandboxAccountStatusResult")
    out: aws_sdk_sns.types.get_sms_sandbox_account_status_result.GetSMSSandboxAccountStatusResult = aws_sdk_sns.types.get_sms_sandbox_account_status_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.get_sms_sandbox_account_status_input.GetSMSSandboxAccountStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetSMSSandboxAccountStatus"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.get_sms_sandbox_account_status_input

    aws_sdk_sns.types.get_sms_sandbox_account_status_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_sms_sandbox_account_status(
