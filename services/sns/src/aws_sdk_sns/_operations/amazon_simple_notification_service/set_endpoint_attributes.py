...
def build_request(
    ...
    input_: aws_sdk_sns.types.set_endpoint_attributes_input.SetEndpointAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sns.types.set_endpoint_attributes_input.serialize_query(input_, pairs, "")
