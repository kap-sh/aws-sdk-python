...
def build_request(
    ...
    input: aws_sdk_sns.types.set_endpoint_attributes_input.SetEndpointAttributesInput,
) -> zapros.Request:
    ...
    aws_sdk_sns.types.set_endpoint_attributes_input.serialize_query(input, pairs, "")
