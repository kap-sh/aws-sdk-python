"""Generated from Smithy shape ``com.amazonaws.sns#GetPlatformApplicationAttributes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetPlatformApplicationAttributesResult")
    out: aws_sdk_sns.types.get_platform_application_attributes_response.GetPlatformApplicationAttributesResponse = aws_sdk_sns.types.get_platform_application_attributes_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.get_platform_application_attributes_input.GetPlatformApplicationAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetPlatformApplicationAttributes"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.get_platform_application_attributes_input

    aws_sdk_sns.types.get_platform_application_attributes_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_platform_application_attributes(
