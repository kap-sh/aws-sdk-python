"""Generated from Smithy shape ``com.amazonaws.sns#GetTopicAttributes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetTopicAttributesResult")
    out: aws_sdk_sns.types.get_topic_attributes_response.GetTopicAttributesResponse = (
        aws_sdk_sns.types.get_topic_attributes_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.get_topic_attributes_input.GetTopicAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetTopicAttributes"))
    pairs.append(("Version", "2010-03-31"))
    aws_sdk_sns.types.get_topic_attributes_input.serialize_query(input_, pairs, "")
...
async def async_get_topic_attributes(
