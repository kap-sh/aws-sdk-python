"""Generated from Smithy shape ``com.amazonaws.sns#ListSubscriptionsByTopic``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListSubscriptionsByTopicResult")
    out: aws_sdk_sns.types.list_subscriptions_by_topic_response.ListSubscriptionsByTopicResponse = aws_sdk_sns.types.list_subscriptions_by_topic_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.list_subscriptions_by_topic_input.ListSubscriptionsByTopicInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListSubscriptionsByTopic"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.list_subscriptions_by_topic_input

    aws_sdk_sns.types.list_subscriptions_by_topic_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_subscriptions_by_topic(
