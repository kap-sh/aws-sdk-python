"""Generated from Smithy shape ``com.amazonaws.sns#VerifySMSSandboxPhoneNumber``."""
...
import aws_sdk_sns.errors.verification_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "VerificationException":
            raise aws_sdk_sns.errors.verification_exception.VerificationException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("VerifySMSSandboxPhoneNumberResult")
    out: aws_sdk_sns.types.verify_sms_sandbox_phone_number_result.VerifySMSSandboxPhoneNumberResult = aws_sdk_sns.types.verify_sms_sandbox_phone_number_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.verify_sms_sandbox_phone_number_input.VerifySMSSandboxPhoneNumberInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_verify_sms_sandbox_phone_number(
