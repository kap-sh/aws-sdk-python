...
def build_request(
    ...
    input_: aws_sdk_sns.types.publish_input.PublishInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sns.types.publish_input.serialize_query(input_, pairs, "")
...
def publish(
    options: OperationOptions, input_: aws_sdk_sns.types.publish_input.PublishInput
) -> tuple[aws_sdk_sns.types.publish_response.PublishResponse, zapros.Response]:
...
async def async_publish(
    options: AsyncOperationOptions, input_: aws_sdk_sns.types.publish_input.PublishInput
) -> tuple[aws_sdk_sns.types.publish_response.PublishResponse, zapros.Response]:
