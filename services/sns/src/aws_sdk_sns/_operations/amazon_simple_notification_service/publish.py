...
def build_request(
    ...
    input: aws_sdk_sns.types.publish_input.PublishInput,
) -> zapros.Request:
    ...
    aws_sdk_sns.types.publish_input.serialize_query(input, pairs, "")
...
def publish(
    options: OperationOptions, input: aws_sdk_sns.types.publish_input.PublishInput
...
async def async_publish(
    options: AsyncOperationOptions, input: aws_sdk_sns.types.publish_input.PublishInput
) -> tuple[aws_sdk_sns.types.publish_response.PublishResponse, zapros.Response]:
