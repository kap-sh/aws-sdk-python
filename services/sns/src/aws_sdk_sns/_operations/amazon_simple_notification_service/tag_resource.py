"""Generated from Smithy shape ``com.amazonaws.sns#TagResource``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("TagResourceResult")
    out: aws_sdk_sns.types.tag_resource_response.TagResourceResponse = (
        aws_sdk_sns.types.tag_resource_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_sns.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    ...
    aws_sdk_sns.types.tag_resource_request.serialize_query(input, pairs, "")
...
def tag_resource(
    ...
    aws_sdk_sns.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
