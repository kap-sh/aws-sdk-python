"""Generated from Smithy shape ``com.amazonaws.sns#DeleteEndpoint``."""
...
def build_request(
    ...
    input: aws_sdk_sns.types.delete_endpoint_input.DeleteEndpointInput,
) -> zapros.Request:
    ...
    aws_sdk_sns.types.delete_endpoint_input.serialize_query(input, pairs, "")
