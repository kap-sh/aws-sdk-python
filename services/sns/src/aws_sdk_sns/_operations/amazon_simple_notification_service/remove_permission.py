"""Generated from Smithy shape ``com.amazonaws.sns#RemovePermission``."""
...
def build_request(
    ...
    input: aws_sdk_sns.types.remove_permission_input.RemovePermissionInput,
) -> zapros.Request:
    ...
    aws_sdk_sns.types.remove_permission_input.serialize_query(input, pairs, "")
