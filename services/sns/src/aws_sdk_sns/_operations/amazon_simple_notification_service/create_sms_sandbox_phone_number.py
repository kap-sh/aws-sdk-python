"""Generated from Smithy shape ``com.amazonaws.sns#CreateSMSSandboxPhoneNumber``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OptedOutException":
            import aws_sdk_sns.errors.opted_out_exception

            raise aws_sdk_sns.errors.opted_out_exception.OptedOutException.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateSMSSandboxPhoneNumberResult")
    out: aws_sdk_sns.types.create_sms_sandbox_phone_number_result.CreateSMSSandboxPhoneNumberResult = aws_sdk_sns.types.create_sms_sandbox_phone_number_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.create_sms_sandbox_phone_number_input.CreateSMSSandboxPhoneNumberInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateSMSSandboxPhoneNumber"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.create_sms_sandbox_phone_number_input

    aws_sdk_sns.types.create_sms_sandbox_phone_number_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_sms_sandbox_phone_number(
