"""Generated from Smithy shape ``com.amazonaws.sns#ListPlatformApplications``."""
...
import aws_sdk_sns.types.list_of_platform_applications
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListPlatformApplicationsResult")
    out: aws_sdk_sns.types.list_platform_applications_response.ListPlatformApplicationsResponse = aws_sdk_sns.types.list_platform_applications_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.list_platform_applications_input.ListPlatformApplicationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListPlatformApplications"))
    pairs.append(("Version", "2010-03-31"))
    aws_sdk_sns.types.list_platform_applications_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_platform_applications(
