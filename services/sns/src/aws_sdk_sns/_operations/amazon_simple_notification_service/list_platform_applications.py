...
def build_request(
    ...
    input: aws_sdk_sns.types.list_platform_applications_input.ListPlatformApplicationsInput,
) -> zapros.Request:
    ...
    aws_sdk_sns.types.list_platform_applications_input.serialize_query(input, pairs, "")
