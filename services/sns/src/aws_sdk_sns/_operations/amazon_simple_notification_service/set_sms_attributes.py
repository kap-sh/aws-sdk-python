"""Generated from Smithy shape ``com.amazonaws.sns#SetSMSAttributes``."""
...
def build_request(
    ...
    input_: aws_sdk_sns.types.set_sms_attributes_input.SetSMSAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "SetSMSAttributes"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.set_sms_attributes_input

    aws_sdk_sns.types.set_sms_attributes_input.serialize_query(input_, pairs, "")
...
async def async_set_sms_attributes(
