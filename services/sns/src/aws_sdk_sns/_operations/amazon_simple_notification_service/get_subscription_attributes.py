"""Generated from Smithy shape ``com.amazonaws.sns#GetSubscriptionAttributes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetSubscriptionAttributesResult")
    out: aws_sdk_sns.types.get_subscription_attributes_response.GetSubscriptionAttributesResponse = aws_sdk_sns.types.get_subscription_attributes_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.get_subscription_attributes_input.GetSubscriptionAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetSubscriptionAttributes"))
    pairs.append(("Version", "2010-03-31"))
    aws_sdk_sns.types.get_subscription_attributes_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_subscription_attributes(
