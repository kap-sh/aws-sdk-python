"""Generated from Smithy shape ``com.amazonaws.sns#PutDataProtectionPolicy``."""
...
def build_request(
    ...
    input: aws_sdk_sns.types.put_data_protection_policy_input.PutDataProtectionPolicyInput,
) -> zapros.Request:
    ...
    aws_sdk_sns.types.put_data_protection_policy_input.serialize_query(input, pairs, "")
