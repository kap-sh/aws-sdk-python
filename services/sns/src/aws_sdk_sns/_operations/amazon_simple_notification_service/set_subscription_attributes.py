"""Generated from Smithy shape ``com.amazonaws.sns#SetSubscriptionAttributes``."""
...
def build_request(
    ...
    input_: aws_sdk_sns.types.set_subscription_attributes_input.SetSubscriptionAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_set_subscription_attributes(
