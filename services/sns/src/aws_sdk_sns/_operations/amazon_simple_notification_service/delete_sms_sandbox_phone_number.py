"""Generated from Smithy shape ``com.amazonaws.sns#DeleteSMSSandboxPhoneNumber``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UserErrorException":
            import aws_sdk_sns.errors.user_error_exception

            raise aws_sdk_sns.errors.user_error_exception.UserErrorException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteSMSSandboxPhoneNumberResult")
    out: aws_sdk_sns.types.delete_sms_sandbox_phone_number_result.DeleteSMSSandboxPhoneNumberResult = aws_sdk_sns.types.delete_sms_sandbox_phone_number_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.delete_sms_sandbox_phone_number_input.DeleteSMSSandboxPhoneNumberInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteSMSSandboxPhoneNumber"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.delete_sms_sandbox_phone_number_input

    aws_sdk_sns.types.delete_sms_sandbox_phone_number_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_sms_sandbox_phone_number(
