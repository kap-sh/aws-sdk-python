"""Generated from Smithy shape ``com.amazonaws.sns#GetEndpointAttributes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetEndpointAttributesResult")
    out: aws_sdk_sns.types.get_endpoint_attributes_response.GetEndpointAttributesResponse = aws_sdk_sns.types.get_endpoint_attributes_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.get_endpoint_attributes_input.GetEndpointAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetEndpointAttributes"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.get_endpoint_attributes_input

    aws_sdk_sns.types.get_endpoint_attributes_input.serialize_query(input_, pairs, "")
...
async def async_get_endpoint_attributes(
