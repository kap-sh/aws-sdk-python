...
def build_request(
    ...
    input: aws_sdk_sns.types.get_endpoint_attributes_input.GetEndpointAttributesInput,
) -> zapros.Request:
    ...
    aws_sdk_sns.types.get_endpoint_attributes_input.serialize_query(input, pairs, "")
