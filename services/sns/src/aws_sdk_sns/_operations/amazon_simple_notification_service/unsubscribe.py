"""Generated from Smithy shape ``com.amazonaws.sns#Unsubscribe``."""
...
def build_request(
    ...
    input_: aws_sdk_sns.types.unsubscribe_input.UnsubscribeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "Unsubscribe"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.unsubscribe_input

    aws_sdk_sns.types.unsubscribe_input.serialize_query(input_, pairs, "")
