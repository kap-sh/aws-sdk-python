"""Generated from Smithy shape ``com.amazonaws.sns#ListSubscriptions``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListSubscriptionsResult")
    out: aws_sdk_sns.types.list_subscriptions_response.ListSubscriptionsResponse = (
        aws_sdk_sns.types.list_subscriptions_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.list_subscriptions_input.ListSubscriptionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListSubscriptions"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.list_subscriptions_input

    aws_sdk_sns.types.list_subscriptions_input.serialize_query(input_, pairs, "")
