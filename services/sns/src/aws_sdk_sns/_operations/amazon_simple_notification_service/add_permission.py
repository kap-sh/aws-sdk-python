"""Generated from Smithy shape ``com.amazonaws.sns#AddPermission``."""
...
def build_request(
    ...
    input_: aws_sdk_sns.types.add_permission_input.AddPermissionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AddPermission"))
    pairs.append(("Version", "2010-03-31"))
    import aws_sdk_sns.types.add_permission_input

    aws_sdk_sns.types.add_permission_input.serialize_query(input_, pairs, "")
