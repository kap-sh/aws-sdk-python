...
def build_request(
    ...
    input: aws_sdk_sns.types.subscribe_input.SubscribeInput,
) -> zapros.Request:
    ...
    aws_sdk_sns.types.subscribe_input.serialize_query(input, pairs, "")
...
def subscribe(
    options: OperationOptions, input: aws_sdk_sns.types.subscribe_input.SubscribeInput
