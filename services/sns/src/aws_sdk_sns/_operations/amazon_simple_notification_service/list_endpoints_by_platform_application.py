...
def handle_response(
    ...
    out: aws_sdk_sns.types.list_endpoints_by_platform_application_response.ListEndpointsByPlatformApplicationResponse = aws_sdk_sns.types.list_endpoints_by_platform_application_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.list_endpoints_by_platform_application_input.ListEndpointsByPlatformApplicationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
