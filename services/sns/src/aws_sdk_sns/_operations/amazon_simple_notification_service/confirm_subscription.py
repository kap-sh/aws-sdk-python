...
def handle_response(
    ...
    out: aws_sdk_sns.types.confirm_subscription_response.ConfirmSubscriptionResponse = (
        aws_sdk_sns.types.confirm_subscription_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_sns.types.confirm_subscription_input.ConfirmSubscriptionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_sns.types.confirm_subscription_input.serialize_query(input_, pairs, "")
