"""Generated from Smithy shape ``com.amazonaws.sns#MapStringToString``."""
...
MapStringToString: TypeAlias = dict[
    "aws_sdk_sns.types.string.String", "aws_sdk_sns.types.string.String"
]


# --- awsQuery ser/de ---
def serialize_query(
    input_to_serialize: MapStringToString, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> MapStringToString:
...
def deserialize_query_flat(parent: Element, tag: str) -> MapStringToString:
    out: MapStringToString = {}
