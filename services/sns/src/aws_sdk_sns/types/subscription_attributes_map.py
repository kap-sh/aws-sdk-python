"""Generated from Smithy shape ``com.amazonaws.sns#SubscriptionAttributesMap``."""
...
SubscriptionAttributesMap: TypeAlias = dict[
    "aws_sdk_sns.types.attribute_name.attributeName",
...
# --- awsQuery ser/de ---
def serialize_query(
    input_to_serialize: SubscriptionAttributesMap,
...
def deserialize_query(el: Element) -> SubscriptionAttributesMap:
    out: SubscriptionAttributesMap = {}
...
def deserialize_query_flat(parent: Element, tag: str) -> SubscriptionAttributesMap:
    out: SubscriptionAttributesMap = {}
