...
PhoneNumberInformationList: TypeAlias = list[
    "aws_sdk_sns.types.phone_number_information.PhoneNumberInformation"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_sns.types.phone_number_information.serialize_query(
...
def deserialize_query(el: Element) -> PhoneNumberInformationList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_sns.types.phone_number_information.deserialize_query(child))
    return out
