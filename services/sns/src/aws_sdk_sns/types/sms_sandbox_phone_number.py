...
class SMSSandboxPhoneNumber(TypedDict):
    ...
    status: NotRequired[
        "aws_sdk_sns.types.sms_sandbox_phone_number_verification_status.SMSSandboxPhoneNumberVerificationStatus"
    ]
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_sns.types.sms_sandbox_phone_number_verification_status.serialize_query(
...
def deserialize_query(el: Element) -> SMSSandboxPhoneNumber:
    ...
    if child_status is not None:
        ...
        out["status"] = (
            aws_sdk_sns.types.sms_sandbox_phone_number_verification_status.deserialize_query(
                child_status
            )
        )
    return out
