...
class PublishInput(TypedDict):
    ...
    target_arn: NotRequired["aws_sdk_sns.types.string.String"]
    ...
    message_deduplication_id: NotRequired["aws_sdk_sns.types.string.String"]
    ...
    message_group_id: NotRequired["aws_sdk_sns.types.string.String"]
...
def serialize_query(
    ...
    if "message_attributes" in value:
        ...
        aws_sdk_sns.types.message_attribute_map.serialize_query(
...
def deserialize_query(el: Element) -> PublishInput:
    ...
    if child_message_attributes is not None:
        ...
        out["message_attributes"] = (
            aws_sdk_sns.types.message_attribute_map.deserialize_query(
