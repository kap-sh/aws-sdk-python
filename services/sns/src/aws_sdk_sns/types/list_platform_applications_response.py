...
class ListPlatformApplicationsResponse(TypedDict):
    platform_applications: NotRequired[
        "aws_sdk_sns.types.list_of_platform_applications.ListOfPlatformApplications"
    ]
...
def serialize_query(
    ...
    if "platform_applications" in value:
        ...
        aws_sdk_sns.types.list_of_platform_applications.serialize_query(
...
def deserialize_query(el: Element) -> ListPlatformApplicationsResponse:
    ...
    if child_platform_applications is not None:
        ...
        out["platform_applications"] = (
            aws_sdk_sns.types.list_of_platform_applications.deserialize_query(
