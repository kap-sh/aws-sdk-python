...
class GetSubscriptionAttributesResponse(TypedDict):
...
def serialize_query(
    ...
    if "attributes" in value:
        ...
        aws_sdk_sns.types.subscription_attributes_map.serialize_query(
...
def deserialize_query(el: Element) -> GetSubscriptionAttributesResponse:
    ...
    if child_attributes is not None:
        ...
        out["attributes"] = (
            aws_sdk_sns.types.subscription_attributes_map.deserialize_query(
                child_attributes
            )
        )
    return out
