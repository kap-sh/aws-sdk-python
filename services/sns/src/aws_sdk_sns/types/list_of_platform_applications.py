...
ListOfPlatformApplications: TypeAlias = list[
    "aws_sdk_sns.types.platform_application.PlatformApplication"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_sns.types.platform_application.serialize_query(
...
def deserialize_query(el: Element) -> ListOfPlatformApplications:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_sns.types.platform_application.deserialize_query(child))
    return out
