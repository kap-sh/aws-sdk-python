...
import capo_acm_pca.errors.invalid_args_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidArgsException":
            raise capo_acm_pca.errors.invalid_args_exception.InvalidArgsException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm_pca.types.update_certificate_authority_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
