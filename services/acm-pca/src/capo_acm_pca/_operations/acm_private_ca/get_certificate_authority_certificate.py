"""Generated from Smithy shape ``com.amazonaws.acmpca#GetCertificateAuthorityCertificate``."""
...
def handle_response(
    ...
    out: capo_acm_pca.types.get_certificate_authority_certificate_response.GetCertificateAuthorityCertificateResponse = capo_acm_pca.types.get_certificate_authority_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm_pca.types.get_certificate_authority_certificate_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_certificate_authority_certificate(
