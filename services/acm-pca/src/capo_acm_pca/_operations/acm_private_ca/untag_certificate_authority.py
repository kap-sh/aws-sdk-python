"""Generated from Smithy shape ``com.amazonaws.acmpca#UntagCertificateAuthority``."""
...
import capo_acm_pca.errors.invalid_tag_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTagException":
            raise capo_acm_pca.errors.invalid_tag_exception.InvalidTagException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm_pca.types.untag_certificate_authority_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_untag_certificate_authority(
