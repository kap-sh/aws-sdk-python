"""Generated from Smithy shape ``com.amazonaws.acmpca#ImportCertificateAuthorityCertificate``."""
...
import capo_acm_pca.errors.certificate_mismatch_exception
...
import capo_acm_pca.errors.malformed_certificate_exception
import capo_acm_pca.errors.request_failed_exception
import capo_acm_pca.errors.request_in_progress_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CertificateMismatchException":
            raise capo_acm_pca.errors.certificate_mismatch_exception.CertificateMismatchException.from_aws_json_1_1(
                data
            )
        ...
        case "MalformedCertificateException":
            raise capo_acm_pca.errors.malformed_certificate_exception.MalformedCertificateException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ACMPrivateCA.ImportCertificateAuthorityCertificate"
    body: bytes | None = json.dumps(
        capo_acm_pca.types.import_certificate_authority_certificate_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_import_certificate_authority_certificate(
