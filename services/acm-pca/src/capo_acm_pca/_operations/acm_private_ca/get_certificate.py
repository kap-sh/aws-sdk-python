...
def handle_response(
    ...
    out: capo_acm_pca.types.get_certificate_response.GetCertificateResponse = (
        capo_acm_pca.types.get_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm_pca.types.get_certificate_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_certificate(
    ...
    capo_acm_pca.types.get_certificate_response.GetCertificateResponse, zapros.Response
]:
