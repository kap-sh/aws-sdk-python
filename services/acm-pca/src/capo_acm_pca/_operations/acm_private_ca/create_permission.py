"""Generated from Smithy shape ``com.amazonaws.acmpca#CreatePermission``."""
...
import capo_acm_pca.errors.limit_exceeded_exception
import capo_acm_pca.errors.permission_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PermissionAlreadyExistsException":
            raise capo_acm_pca.errors.permission_already_exists_exception.PermissionAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm_pca.types.create_permission_request.serialize_aws_json_1_1(input_)
    ).encode()
