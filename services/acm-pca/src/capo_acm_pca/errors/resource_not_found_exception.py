"""Generated from Smithy shape ``com.amazonaws.acmpca#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.acmpca#ResourceNotFoundException``."""
