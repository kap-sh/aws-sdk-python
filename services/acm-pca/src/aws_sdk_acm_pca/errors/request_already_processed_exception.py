...
class RequestAlreadyProcessedException_(TypedDict):
...
class RequestAlreadyProcessedException(ServiceError):
    ...
    def __init__(self, data: RequestAlreadyProcessedException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "RequestAlreadyProcessedException":
