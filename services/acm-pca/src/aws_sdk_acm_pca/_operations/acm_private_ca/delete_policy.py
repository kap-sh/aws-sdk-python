"""Generated from Smithy shape ``com.amazonaws.acmpca#DeletePolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.delete_policy_request.DeletePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ACMPrivateCA.DeletePolicy"
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.delete_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
