...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.untag_certificate_authority_request.UntagCertificateAuthorityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.untag_certificate_authority_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
