...
def handle_response(
    ...
    out: aws_sdk_acm_pca.types.list_certificate_authorities_response.ListCertificateAuthoritiesResponse = aws_sdk_acm_pca.types.list_certificate_authorities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.list_certificate_authorities_request.ListCertificateAuthoritiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.list_certificate_authorities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
