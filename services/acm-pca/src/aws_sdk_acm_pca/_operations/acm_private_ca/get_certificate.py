"""Generated from Smithy shape ``com.amazonaws.acmpca#GetCertificate``."""
...
def handle_response(
    ...
    out: aws_sdk_acm_pca.types.get_certificate_response.GetCertificateResponse = (
        aws_sdk_acm_pca.types.get_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.get_certificate_request.GetCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.get_certificate_request.serialize_aws_json_1_1(input_)
    ).encode()
