...
def handle_response(
    ...
    out: aws_sdk_acm_pca.types.describe_certificate_authority_audit_report_response.DescribeCertificateAuthorityAuditReportResponse = aws_sdk_acm_pca.types.describe_certificate_authority_audit_report_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.describe_certificate_authority_audit_report_request.DescribeCertificateAuthorityAuditReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.describe_certificate_authority_audit_report_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
