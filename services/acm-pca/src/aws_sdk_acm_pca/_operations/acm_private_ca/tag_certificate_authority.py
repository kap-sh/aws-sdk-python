...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            import aws_sdk_acm_pca.errors.too_many_tags_exception

            raise aws_sdk_acm_pca.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.tag_certificate_authority_request.TagCertificateAuthorityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.tag_certificate_authority_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
