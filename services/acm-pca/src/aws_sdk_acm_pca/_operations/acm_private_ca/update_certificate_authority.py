"""Generated from Smithy shape ``com.amazonaws.acmpca#UpdateCertificateAuthority``."""
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.update_certificate_authority_request.UpdateCertificateAuthorityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.update_certificate_authority_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_certificate_authority(
