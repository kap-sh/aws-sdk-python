...
def build_request(
    ...
    input: aws_sdk_acm_pca.types.list_permissions_request.ListPermissionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.list_permissions_request.serialize_aws_json_1_1(input)
    ).encode()
