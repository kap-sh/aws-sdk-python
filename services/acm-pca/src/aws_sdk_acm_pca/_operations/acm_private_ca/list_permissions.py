"""Generated from Smithy shape ``com.amazonaws.acmpca#ListPermissions``."""
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.list_permissions_request.ListPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.list_permissions_request.serialize_aws_json_1_1(input_)
    ).encode()
