"""Generated from Smithy shape ``com.amazonaws.acmpca#RevokeCertificate``."""
...
import aws_sdk_acm_pca.errors.invalid_request_exception
import aws_sdk_acm_pca.errors.invalid_state_exception
import aws_sdk_acm_pca.errors.limit_exceeded_exception
import aws_sdk_acm_pca.errors.request_already_processed_exception
import aws_sdk_acm_pca.errors.request_failed_exception
import aws_sdk_acm_pca.errors.request_in_progress_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidRequestException":
            raise aws_sdk_acm_pca.errors.invalid_request_exception.InvalidRequestException.from_aws_json_1_1(
                data
            )
        ...
        case "LimitExceededException":
            raise aws_sdk_acm_pca.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data
            )
        case "RequestAlreadyProcessedException":
            raise aws_sdk_acm_pca.errors.request_already_processed_exception.RequestAlreadyProcessedException.from_aws_json_1_1(
                data
            )
        ...
        case "RequestInProgressException":
            raise aws_sdk_acm_pca.errors.request_in_progress_exception.RequestInProgressException.from_aws_json_1_1(
                data
            )
...
def get_signer(
...
) -> aws_sdk_acm_pca._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_acm_pca._auth._sigv4.build_sigv4_auth_scheme(
                "acm-pca", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_acm_pca._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.revoke_certificate_request.RevokeCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.revoke_certificate_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_revoke_certificate(
