...
def build_request(
    ...
    input: aws_sdk_acm_pca.types.revoke_certificate_request.RevokeCertificateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.revoke_certificate_request.serialize_aws_json_1_1(input)
    ).encode()
