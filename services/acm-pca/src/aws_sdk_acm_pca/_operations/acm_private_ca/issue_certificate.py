"""Generated from Smithy shape ``com.amazonaws.acmpca#IssueCertificate``."""
...
import aws_sdk_acm_pca.errors.malformed_csr_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MalformedCSRException":
            raise aws_sdk_acm_pca.errors.malformed_csr_exception.MalformedCSRException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_acm_pca.types.issue_certificate_response.IssueCertificateResponse = (
        aws_sdk_acm_pca.types.issue_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.issue_certificate_request.IssueCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.issue_certificate_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_issue_certificate(
