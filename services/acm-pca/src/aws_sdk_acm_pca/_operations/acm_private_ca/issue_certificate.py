...
def build_request(
    ...
    input: aws_sdk_acm_pca.types.issue_certificate_request.IssueCertificateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.issue_certificate_request.serialize_aws_json_1_1(input)
    ).encode()
