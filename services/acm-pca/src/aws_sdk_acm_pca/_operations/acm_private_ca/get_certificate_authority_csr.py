"""Generated from Smithy shape ``com.amazonaws.acmpca#GetCertificateAuthorityCsr``."""
...
def handle_response(
    ...
    out: aws_sdk_acm_pca.types.get_certificate_authority_csr_response.GetCertificateAuthorityCsrResponse = aws_sdk_acm_pca.types.get_certificate_authority_csr_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.get_certificate_authority_csr_request.GetCertificateAuthorityCsrRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.get_certificate_authority_csr_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_certificate_authority_csr(
