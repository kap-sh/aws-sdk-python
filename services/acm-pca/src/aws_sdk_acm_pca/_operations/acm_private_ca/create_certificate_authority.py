...
import aws_sdk_acm_pca.errors.invalid_tag_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTagException":
            raise aws_sdk_acm_pca.errors.invalid_tag_exception.InvalidTagException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_acm_pca.types.create_certificate_authority_response.CreateCertificateAuthorityResponse = aws_sdk_acm_pca.types.create_certificate_authority_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.create_certificate_authority_request.CreateCertificateAuthorityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.create_certificate_authority_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
