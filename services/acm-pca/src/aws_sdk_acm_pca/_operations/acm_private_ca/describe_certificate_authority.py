...
def handle_response(
    ...
    out: aws_sdk_acm_pca.types.describe_certificate_authority_response.DescribeCertificateAuthorityResponse = aws_sdk_acm_pca.types.describe_certificate_authority_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.describe_certificate_authority_request.DescribeCertificateAuthorityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.describe_certificate_authority_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
