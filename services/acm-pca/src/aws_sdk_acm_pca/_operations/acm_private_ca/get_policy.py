...
def handle_response(
    ...
    out: aws_sdk_acm_pca.types.get_policy_response.GetPolicyResponse = (
        aws_sdk_acm_pca.types.get_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.get_policy_request.GetPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.get_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_policy(
    ...
    aws_sdk_acm_pca.types.get_policy_response.GetPolicyResponse, zapros.Response
]:
