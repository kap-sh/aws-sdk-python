...
import aws_sdk_acm_pca.errors.permission_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PermissionAlreadyExistsException":
            raise aws_sdk_acm_pca.errors.permission_already_exists_exception.PermissionAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.create_permission_request.CreatePermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm_pca.types.create_permission_request.serialize_aws_json_1_1(input_)
    ).encode()
