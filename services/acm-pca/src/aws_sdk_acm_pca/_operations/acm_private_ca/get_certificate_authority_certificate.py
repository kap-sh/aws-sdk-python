...
def handle_response(
    ...
    out: aws_sdk_acm_pca.types.get_certificate_authority_certificate_response.GetCertificateAuthorityCertificateResponse = aws_sdk_acm_pca.types.get_certificate_authority_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_acm_pca.types.get_certificate_authority_certificate_request.GetCertificateAuthorityCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
