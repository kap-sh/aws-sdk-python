...
class ImportCertificateAuthorityCertificateRequest(TypedDict):
...
def serialize_aws_json_1_1(value: ImportCertificateAuthorityCertificateRequest) -> dict:
    ...
    out["Certificate"] = (
        aws_sdk_acm_pca.types.certificate_body_blob.serialize_aws_json_1_1(
            value["certificate"]
        )
    )
    if "certificate_chain" in value:
        ...
        out["CertificateChain"] = (
            aws_sdk_acm_pca.types.certificate_chain_blob.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "Certificate" in data:
        ...
        out["certificate"] = (
            aws_sdk_acm_pca.types.certificate_body_blob.deserialize_aws_json_1_1(
                data["Certificate"]
            )
        )
    else:
    ...
    if "CertificateChain" in data:
        ...
        out["certificate_chain"] = (
            aws_sdk_acm_pca.types.certificate_chain_blob.deserialize_aws_json_1_1(
