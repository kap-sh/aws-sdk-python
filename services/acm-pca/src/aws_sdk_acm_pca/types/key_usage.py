...
class KeyUsage(TypedDict, closed=True):
    ...
    key_encipherment: "aws_sdk_acm_pca.types.boolean.Boolean"
    """<p>Key can be used to encipher data.</p>"""
    data_encipherment: "aws_sdk_acm_pca.types.boolean.Boolean"
    """<p>Key can be used to decipher data.</p>"""
    key_agreement: "aws_sdk_acm_pca.types.boolean.Boolean"
    """<p>Key can be used in a key-agreement protocol.</p>"""
    key_cert_sign: "aws_sdk_acm_pca.types.boolean.Boolean"
    """<p>Key can be used to sign certificates.</p>"""
    crl_sign: "aws_sdk_acm_pca.types.boolean.Boolean"
    """<p>Key can be used to sign CRLs.</p>"""
    encipher_only: "aws_sdk_acm_pca.types.boolean.Boolean"
    """<p>Key can be used only to encipher data.</p>"""
    decipher_only: "aws_sdk_acm_pca.types.boolean.Boolean"
