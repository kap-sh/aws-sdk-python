...
if TYPE_CHECKING:
    ...
    import aws_sdk_acm_pca.types.crl_distribution_point_extension_configuration
    import aws_sdk_acm_pca.types.crl_path_string
    import aws_sdk_acm_pca.types.crl_type
    import aws_sdk_acm_pca.types.integer1_to5000
    import aws_sdk_acm_pca.types.s3_bucket_name3_to255
...
class CrlConfiguration(TypedDict):
    ...
    expiration_in_days: NotRequired[
        "aws_sdk_acm_pca.types.integer1_to5000.Integer1To5000"
    ]
    """<p>Validity period of the CRL in days.</p>"""
    custom_cname: NotRequired["aws_sdk_acm_pca.types.cname_string.CnameString"]
    ...
    s3_bucket_name: NotRequired[
        "aws_sdk_acm_pca.types.s3_bucket_name3_to255.S3BucketName3To255"
    ]
    ...
    s3_object_acl: NotRequired["aws_sdk_acm_pca.types.s3_object_acl.S3ObjectAcl"]
    ...
    crl_distribution_point_extension_configuration: NotRequired[
        "aws_sdk_acm_pca.types.crl_distribution_point_extension_configuration.CrlDistributionPointExtensionConfiguration"
    ]
    ...
    crl_type: NotRequired["aws_sdk_acm_pca.types.crl_type.CrlType"]
    ...
    custom_path: NotRequired["aws_sdk_acm_pca.types.crl_path_string.CrlPathString"]
...
def serialize_aws_json_1_1(value: CrlConfiguration) -> dict:
    ...
    if "s3_object_acl" in value:
        ...
        out["S3ObjectAcl"] = aws_sdk_acm_pca.types.s3_object_acl.serialize_aws_json_1_1(
            value["s3_object_acl"]
        )
    if "crl_distribution_point_extension_configuration" in value:
        ...
        out["CrlDistributionPointExtensionConfiguration"] = (
            aws_sdk_acm_pca.types.crl_distribution_point_extension_configuration.serialize_aws_json_1_1(
    ...
    if "crl_type" in value:
        ...
        out["CrlType"] = aws_sdk_acm_pca.types.crl_type.serialize_aws_json_1_1(
            value["crl_type"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> CrlConfiguration:
    ...
    if "S3ObjectAcl" in data:
        ...
        out["s3_object_acl"] = (
            aws_sdk_acm_pca.types.s3_object_acl.deserialize_aws_json_1_1(
                data["S3ObjectAcl"]
            )
        )
    if "CrlDistributionPointExtensionConfiguration" in data:
        ...
        out["crl_distribution_point_extension_configuration"] = (
            aws_sdk_acm_pca.types.crl_distribution_point_extension_configuration.deserialize_aws_json_1_1(
    ...
    if "CrlType" in data:
        ...
        out["crl_type"] = aws_sdk_acm_pca.types.crl_type.deserialize_aws_json_1_1(
            data["CrlType"]
        )
