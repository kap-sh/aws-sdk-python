...
if TYPE_CHECKING:
    import aws_sdk_acm_pca.types.access_description

AccessDescriptionList: TypeAlias = list[
    "aws_sdk_acm_pca.types.access_description.AccessDescription"
]
...
def serialize_aws_json_1_1(value: AccessDescriptionList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_acm_pca.types.access_description.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AccessDescriptionList:
    ...
    for item in data:
        out.append(
            aws_sdk_acm_pca.types.access_description.deserialize_aws_json_1_1(item)
        )
    return out
