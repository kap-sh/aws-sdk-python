...
import capo_internetmonitor.errors.limit_exceeded_exception
import capo_internetmonitor.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_internetmonitor.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
        case "ResourceNotFoundException":
            raise capo_internetmonitor.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_internetmonitor.types.update_monitor_output.UpdateMonitorOutput = (
        capo_internetmonitor.types.update_monitor_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_internetmonitor.types.update_monitor_input.serialize_json(input_)
    ).encode()
