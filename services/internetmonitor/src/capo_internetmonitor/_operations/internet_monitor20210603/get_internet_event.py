"""Generated from Smithy shape ``com.amazonaws.internetmonitor#GetInternetEvent``."""
...
def handle_response(
    ...
    out: capo_internetmonitor.types.get_internet_event_output.GetInternetEventOutput = (
        capo_internetmonitor.types.get_internet_event_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20210603/InternetEvents/{EventId}"
...
async def async_get_internet_event(
