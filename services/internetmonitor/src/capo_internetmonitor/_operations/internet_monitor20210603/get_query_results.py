"""Generated from Smithy shape ``com.amazonaws.internetmonitor#GetQueryResults``."""
...
def handle_response(
    ...
    out: capo_internetmonitor.types.get_query_results_output.GetQueryResultsOutput = (
        capo_internetmonitor.types.get_query_results_output.deserialize_json(
