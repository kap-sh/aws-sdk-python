"""Generated from Smithy shape ``com.amazonaws.internetmonitor#StopQuery``."""
...
def handle_response(
    ...
    out: capo_internetmonitor.types.stop_query_output.StopQueryOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/v20210603/Monitors/{MonitorName}/Queries/{QueryId}"
    )
...
def stop_query(
    ...
    capo_internetmonitor.types.stop_query_output.StopQueryOutput, zapros.Response
]:
