"""Generated from Smithy shape ``com.amazonaws.internetmonitor#ListTagsForResource``."""
...
import capo_internetmonitor.errors.bad_request_exception
import capo_internetmonitor.errors.internal_server_error_exception
import capo_internetmonitor.errors.not_found_exception
import capo_internetmonitor.errors.too_many_requests_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BadRequestException":
            raise capo_internetmonitor.errors.bad_request_exception.BadRequestException.from_json(
                data
            )
        case "InternalServerErrorException":
            raise capo_internetmonitor.errors.internal_server_error_exception.InternalServerErrorException.from_json(
                data
            )
        case "NotFoundException":
            raise capo_internetmonitor.errors.not_found_exception.NotFoundException.from_json(
                data
            )
        case "TooManyRequestsException":
            raise capo_internetmonitor.errors.too_many_requests_exception.TooManyRequestsException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_internetmonitor.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_internetmonitor.types.list_tags_for_resource_output.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_internetmonitor._auth._sigv4.build_sigv4_auth_scheme(
