...
def handle_response(
    ...
    out: aws_sdk_internetmonitor.types.delete_monitor_output.DeleteMonitorOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_internetmonitor.types.delete_monitor_input.DeleteMonitorInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
