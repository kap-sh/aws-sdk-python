...
def handle_response(
    ...
    out: aws_sdk_internetmonitor.types.list_internet_events_output.ListInternetEventsOutput = aws_sdk_internetmonitor.types.list_internet_events_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_internetmonitor.types.list_internet_events_input.ListInternetEventsInput,
) -> zapros.Request:
    ...
    if "max_results" in input:
        params["InternetEventMaxResults"] = str(input["max_results"])
    if "start_time" in input:
        params["StartTime"] = str(input["start_time"])
    if "end_time" in input:
        params["EndTime"] = str(input["end_time"])
    if "event_status" in input:
        params["EventStatus"] = str(input["event_status"])
    if "event_type" in input:
        params["EventType"] = str(input["event_type"])
