...
def build_request(
    ...
    input_: aws_sdk_internetmonitor.types.list_internet_events_input.ListInternetEventsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "max_results" in input_:
        params["InternetEventMaxResults"] = str(input_["max_results"])
    ...
    if "event_status" in input_:
        params["EventStatus"] = str(input_["event_status"])
