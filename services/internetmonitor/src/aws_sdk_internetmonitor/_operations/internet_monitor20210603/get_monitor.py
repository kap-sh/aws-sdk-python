"""Generated from Smithy shape ``com.amazonaws.internetmonitor#GetMonitor``."""
...
def handle_response(
    ...
    out: aws_sdk_internetmonitor.types.get_monitor_output.GetMonitorOutput = (
        aws_sdk_internetmonitor.types.get_monitor_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_internetmonitor.types.get_monitor_input.GetMonitorInput,
) -> zapros.Request:
...
def get_monitor(
    ...
    aws_sdk_internetmonitor.types.get_monitor_output.GetMonitorOutput, zapros.Response
]:
