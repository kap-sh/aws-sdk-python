...
import aws_sdk_internetmonitor.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_internetmonitor.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_internetmonitor.types.create_monitor_output.CreateMonitorOutput = (
        aws_sdk_internetmonitor.types.create_monitor_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_internetmonitor.types.create_monitor_input.CreateMonitorInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_internetmonitor.types.create_monitor_input.serialize_json(input_)
    ).encode()
