...
def build_request(
    ...
    input_: aws_sdk_internetmonitor.types.get_health_event_input.GetHealthEventInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "linked_account_id" in input_:
        params["LinkedAccountId"] = str(input_["linked_account_id"])
