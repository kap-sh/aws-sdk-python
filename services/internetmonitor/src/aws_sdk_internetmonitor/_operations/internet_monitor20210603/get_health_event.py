"""Generated from Smithy shape ``com.amazonaws.internetmonitor#GetHealthEvent``."""
...
if TYPE_CHECKING:
    import aws_sdk_internetmonitor.types.get_health_event_input
    import aws_sdk_internetmonitor.types.get_health_event_output
...
) -> aws_sdk_internetmonitor.types.get_health_event_output.GetHealthEventOutput:
    import aws_sdk_internetmonitor.types.get_health_event_output

    out: aws_sdk_internetmonitor.types.get_health_event_output.GetHealthEventOutput = (
        aws_sdk_internetmonitor.types.get_health_event_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_internetmonitor.types.get_health_event_input.GetHealthEventInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "linked_account_id" in input:
        params["LinkedAccountId"] = str(input["linked_account_id"])
...
async def async_get_health_event(
