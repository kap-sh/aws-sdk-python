...
def handle_response(
    ...
    out: aws_sdk_internetmonitor.types.stop_query_output.StopQueryOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_internetmonitor.types.stop_query_input.StopQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def stop_query(
    ...
    aws_sdk_internetmonitor.types.stop_query_output.StopQueryOutput, zapros.Response
]:
