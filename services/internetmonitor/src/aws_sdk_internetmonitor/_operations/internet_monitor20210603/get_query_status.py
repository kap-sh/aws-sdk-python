...
def handle_response(
    ...
    out: aws_sdk_internetmonitor.types.get_query_status_output.GetQueryStatusOutput = (
        aws_sdk_internetmonitor.types.get_query_status_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_internetmonitor.types.get_query_status_input.GetQueryStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
