...
import aws_sdk_internetmonitor.types.monitor_list
...
def build_request(
    ...
    input_: aws_sdk_internetmonitor.types.list_monitors_input.ListMonitorsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "include_linked_accounts" in input_:
        params["IncludeLinkedAccounts"] = str(input_["include_linked_accounts"])
