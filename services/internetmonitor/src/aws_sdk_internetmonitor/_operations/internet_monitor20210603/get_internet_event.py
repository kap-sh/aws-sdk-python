...
def handle_response(
    ...
    out: aws_sdk_internetmonitor.types.get_internet_event_output.GetInternetEventOutput = aws_sdk_internetmonitor.types.get_internet_event_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_internetmonitor.types.get_internet_event_input.GetInternetEventInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
