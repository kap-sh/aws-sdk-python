"""Generated from Smithy shape ``com.amazonaws.internetmonitor#UpdateMonitor``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            import aws_sdk_internetmonitor.errors.limit_exceeded_exception

            raise aws_sdk_internetmonitor.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
        case "ResourceNotFoundException":
            import aws_sdk_internetmonitor.errors.resource_not_found_exception

            raise aws_sdk_internetmonitor.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_internetmonitor.types.update_monitor_output.UpdateMonitorOutput = (
        aws_sdk_internetmonitor.types.update_monitor_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_internetmonitor.types.update_monitor_input.UpdateMonitorInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v20210603/Monitors/{MonitorName}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_internetmonitor.types.update_monitor_input.serialize_json(input)
    ).encode()
