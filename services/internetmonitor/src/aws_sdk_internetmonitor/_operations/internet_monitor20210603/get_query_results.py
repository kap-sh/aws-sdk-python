...
def handle_response(
    ...
    out: aws_sdk_internetmonitor.types.get_query_results_output.GetQueryResultsOutput = aws_sdk_internetmonitor.types.get_query_results_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_internetmonitor.types.get_query_results_input.GetQueryResultsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
