"""Generated from Smithy shape ``com.amazonaws.internetmonitor#StartQuery``."""
...
def handle_response(
    ...
    out: aws_sdk_internetmonitor.types.start_query_output.StartQueryOutput = (
        aws_sdk_internetmonitor.types.start_query_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_internetmonitor.types.start_query_input.StartQueryInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v20210603/Monitors/{MonitorName}/Queries"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_internetmonitor.types.start_query_input.serialize_json(input)
    ).encode()
...
def start_query(
    ...
    aws_sdk_internetmonitor.types.start_query_output.StartQueryOutput, zapros.Response
]:
