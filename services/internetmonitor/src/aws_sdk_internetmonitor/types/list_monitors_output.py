...
class ListMonitorsOutput(TypedDict):
    monitors: "aws_sdk_internetmonitor.types.monitor_list.MonitorList"
...
def serialize_json(value: ListMonitorsOutput) -> dict:
    ...
    out["Monitors"] = aws_sdk_internetmonitor.types.monitor_list.serialize_json(
        value["monitors"]
    )
...
def deserialize_json(data: dict) -> ListMonitorsOutput:
    ...
    if "Monitors" in data:
        ...
        out["monitors"] = aws_sdk_internetmonitor.types.monitor_list.deserialize_json(
            data["Monitors"]
        )
    else:
