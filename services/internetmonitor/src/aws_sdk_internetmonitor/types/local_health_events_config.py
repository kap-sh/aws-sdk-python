...
if TYPE_CHECKING:
    import aws_sdk_internetmonitor.types.local_health_events_config_status
    import aws_sdk_internetmonitor.types.percentage


class LocalHealthEventsConfig(TypedDict):
    status: NotRequired[
        "aws_sdk_internetmonitor.types.local_health_events_config_status.LocalHealthEventsConfigStatus"
    ]
    ...
    min_traffic_impact: "aws_sdk_internetmonitor.types.percentage.Percentage"
