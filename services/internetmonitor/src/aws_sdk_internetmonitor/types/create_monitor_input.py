...
class CreateMonitorInput(TypedDict):
    ...
    max_city_networks_to_monitor: NotRequired["aws_sdk_internetmonitor.types.max_city_networks_to_monitor.MaxCityNetworksToMonitor"]
    ...
    internet_measurements_log_delivery: NotRequired["aws_sdk_internetmonitor.types.internet_measurements_log_delivery.InternetMeasurementsLogDelivery"]
    """<p>Publish internet measurements for Internet Monitor to an Amazon S3 bucket in addition to CloudWatch Logs.</p>"""
    traffic_percentage_to_monitor: NotRequired["aws_sdk_internetmonitor.types.traffic_percentage_to_monitor.TrafficPercentageToMonitor"]
    ...
    health_events_config: NotRequired["aws_sdk_internetmonitor.types.health_events_config.HealthEventsConfig"]
...
def serialize_json(value: CreateMonitorInput) -> dict:
    ...
    if "resources" in value:
        import aws_sdk_internetmonitor.types.set_of_ar_ns
        out["Resources"] = aws_sdk_internetmonitor.types.set_of_ar_ns.serialize_json(value["resources"])
    ...
    if "internet_measurements_log_delivery" in value:
        import aws_sdk_internetmonitor.types.internet_measurements_log_delivery
        out["InternetMeasurementsLogDelivery"] = aws_sdk_internetmonitor.types.internet_measurements_log_delivery.serialize_json(value["internet_measurements_log_delivery"])
    ...
    if "health_events_config" in value:
        import aws_sdk_internetmonitor.types.health_events_config
        out["HealthEventsConfig"] = aws_sdk_internetmonitor.types.health_events_config.serialize_json(value["health_events_config"])
    return out
...
def deserialize_json(data: dict) -> CreateMonitorInput:
    ...
    if "Resources" in data:
        import aws_sdk_internetmonitor.types.set_of_ar_ns
        out["resources"] = aws_sdk_internetmonitor.types.set_of_ar_ns.deserialize_json(data["Resources"])
    if "ClientToken" in data:
        out["client_token"] = data["ClientToken"]
    if "Tags" in data:
        import aws_sdk_internetmonitor.types.tag_map
        out["tags"] = aws_sdk_internetmonitor.types.tag_map.deserialize_json(data["Tags"])
    ...
    if "InternetMeasurementsLogDelivery" in data:
        import aws_sdk_internetmonitor.types.internet_measurements_log_delivery
        out["internet_measurements_log_delivery"] = aws_sdk_internetmonitor.types.internet_measurements_log_delivery.deserialize_json(data["InternetMeasurementsLogDelivery"])
    ...
    if "HealthEventsConfig" in data:
        import aws_sdk_internetmonitor.types.health_events_config
        out["health_events_config"] = aws_sdk_internetmonitor.types.health_events_config.deserialize_json(data["HealthEventsConfig"])
    return out