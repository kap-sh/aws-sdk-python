...
from ._services.async_internet_monitor import (
    AsyncInternetMonitorClient as AsyncInternetMonitorClient,
)
from ._services.internet_monitor import InternetMonitorClient as InternetMonitorClient
