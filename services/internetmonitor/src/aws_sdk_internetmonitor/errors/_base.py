...
class InternetMonitorError(Exception):
    """Base class for all InternetMonitor service errors."""


class ServiceError(InternetMonitorError):
...
class SerializationError(InternetMonitorError):
    """Raised when a value cannot be serialized."""


class DeserializationError(InternetMonitorError):
...
class WaiterFailedError(InternetMonitorError):
...
class WaiterTimeoutError(InternetMonitorError):
