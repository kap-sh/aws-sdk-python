"""Generated from Smithy shape ``com.amazonaws.codeconnections#ListConnectionsInput``."""
...
class ListConnectionsInput(TypedDict, closed=True):
    ...
    host_arn_filter: NotRequired["capo_codeconnections.types.host_arn.HostArn"]
    """<p>Filters the list of connections to those associated with a specified host.</p>"""
    max_results: "capo_codeconnections.types.max_results.MaxResults"
