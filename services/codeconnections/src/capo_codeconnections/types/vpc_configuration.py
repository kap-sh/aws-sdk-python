...
if TYPE_CHECKING:
    ...
    import capo_codeconnections.types.tls_certificate
    import capo_codeconnections.types.vpc_id


class VpcConfiguration(TypedDict, closed=True):
    vpc_id: "capo_codeconnections.types.vpc_id.VpcId"
    """<p>The ID of the Amazon VPC connected to the infrastructure where your provider type is installed.</p>"""
    subnet_ids: "capo_codeconnections.types.subnet_ids.SubnetIds"
    ...
    security_group_ids: "capo_codeconnections.types.security_group_ids.SecurityGroupIds"
    ...
    tls_certificate: NotRequired[
        "capo_codeconnections.types.tls_certificate.TlsCertificate"
    ]
...
def serialize_aws_json_1_0(value: VpcConfiguration) -> dict:
    ...
    out["SubnetIds"] = capo_codeconnections.types.subnet_ids.serialize_aws_json_1_0(
        value["subnet_ids"]
    )
    import capo_codeconnections.types.security_group_ids

    out["SecurityGroupIds"] = (
        capo_codeconnections.types.security_group_ids.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> VpcConfiguration:
    ...
    if "SubnetIds" in data:
        ...
        out["subnet_ids"] = (
            capo_codeconnections.types.subnet_ids.deserialize_aws_json_1_0(
                data["SubnetIds"]
            )
        )
    else:
    ...
    if "SecurityGroupIds" in data:
        ...
        out["security_group_ids"] = (
            capo_codeconnections.types.security_group_ids.deserialize_aws_json_1_0(
