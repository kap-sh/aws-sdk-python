"""Generated from Smithy shape ``com.amazonaws.codeconnections#ResourceSyncAttempt``."""
...
if TYPE_CHECKING:
    import aws_sdk_codeconnections.types.resource_sync_event_list
    import aws_sdk_codeconnections.types.resource_sync_status
    import aws_sdk_codeconnections.types.revision
    import aws_sdk_codeconnections.types.target
    import aws_sdk_codeconnections.types.timestamp


class ResourceSyncAttempt(TypedDict):
    events: (
        "aws_sdk_codeconnections.types.resource_sync_event_list.ResourceSyncEventList"
    )
    """<p>The events related to a resource sync attempt.</p>"""
    initial_revision: "aws_sdk_codeconnections.types.revision.Revision"
    """<p>The current state of the resource as defined in the resource's <code>config-file</code> in the linked repository.</p>"""
    started_at: "aws_sdk_codeconnections.types.timestamp.Timestamp"
    """<p>The start time for a resource sync attempt.</p>"""
    status: "aws_sdk_codeconnections.types.resource_sync_status.ResourceSyncStatus"
    ...
    target_revision: "aws_sdk_codeconnections.types.revision.Revision"
    ...
    target: "aws_sdk_codeconnections.types.target.Target"
...
def serialize_aws_json_1_0(value: ResourceSyncAttempt) -> dict:
    ...
    out["Events"] = (
        aws_sdk_codeconnections.types.resource_sync_event_list.serialize_aws_json_1_0(
            value["events"]
        )
    )
    import aws_sdk_codeconnections.types.revision
    ...
    out["StartedAt"] = aws_sdk_codeconnections.types.timestamp.serialize_aws_json_1_0(
        value["started_at"]
    )
    import aws_sdk_codeconnections.types.resource_sync_status

    out["Status"] = (
        aws_sdk_codeconnections.types.resource_sync_status.serialize_aws_json_1_0(
            value["status"]
        )
    )
    import aws_sdk_codeconnections.types.revision
...
def deserialize_aws_json_1_0(data: dict) -> ResourceSyncAttempt:
    ...
    if "Events" in data:
        ...
        out["events"] = (
            aws_sdk_codeconnections.types.resource_sync_event_list.deserialize_aws_json_1_0(
                data["Events"]
            )
        )
    else:
    ...
    if "StartedAt" in data:
        ...
        out["started_at"] = (
            aws_sdk_codeconnections.types.timestamp.deserialize_aws_json_1_0(
                data["StartedAt"]
            )
        )
    else:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_codeconnections.types.resource_sync_status.deserialize_aws_json_1_0(
                data["Status"]
            )
        )
    else:
