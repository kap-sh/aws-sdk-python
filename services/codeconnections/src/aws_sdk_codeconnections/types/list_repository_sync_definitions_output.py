...
class ListRepositorySyncDefinitionsOutput(TypedDict):
    repository_sync_definitions: "aws_sdk_codeconnections.types.repository_sync_definition_list.RepositorySyncDefinitionList"
...
def serialize_aws_json_1_0(value: ListRepositorySyncDefinitionsOutput) -> dict:
    ...
    out["RepositorySyncDefinitions"] = (
        aws_sdk_codeconnections.types.repository_sync_definition_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListRepositorySyncDefinitionsOutput:
    ...
    if "RepositorySyncDefinitions" in data:
        ...
        out["repository_sync_definitions"] = (
            aws_sdk_codeconnections.types.repository_sync_definition_list.deserialize_aws_json_1_0(
