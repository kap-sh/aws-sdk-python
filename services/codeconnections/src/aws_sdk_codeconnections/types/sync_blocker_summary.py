"""Generated from Smithy shape ``com.amazonaws.codeconnections#SyncBlockerSummary``."""
...
if TYPE_CHECKING:
    import aws_sdk_codeconnections.types.latest_sync_blocker_list
    import aws_sdk_codeconnections.types.resource_name


class SyncBlockerSummary(TypedDict):
    ...
    parent_resource_name: NotRequired[
        "aws_sdk_codeconnections.types.resource_name.ResourceName"
    ]
    """<p>The parent resource name for a sync blocker summary.</p>"""
    latest_blockers: NotRequired[
        "aws_sdk_codeconnections.types.latest_sync_blocker_list.LatestSyncBlockerList"
    ]
...
def serialize_aws_json_1_0(value: SyncBlockerSummary) -> dict:
    ...
    if "latest_blockers" in value:
        ...
        out["LatestBlockers"] = (
            aws_sdk_codeconnections.types.latest_sync_blocker_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> SyncBlockerSummary:
    ...
    if "LatestBlockers" in data:
        ...
        out["latest_blockers"] = (
            aws_sdk_codeconnections.types.latest_sync_blocker_list.deserialize_aws_json_1_0(
                data["LatestBlockers"]
            )
        )
    return out
