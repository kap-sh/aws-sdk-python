...
LatestSyncBlockerList: TypeAlias = list[
    "aws_sdk_codeconnections.types.sync_blocker.SyncBlocker"
]
...
def serialize_aws_json_1_0(value: LatestSyncBlockerList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_codeconnections.types.sync_blocker.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> LatestSyncBlockerList:
    ...
    for item in data:
        out.append(
            aws_sdk_codeconnections.types.sync_blocker.deserialize_aws_json_1_0(item)
        )
    return out
