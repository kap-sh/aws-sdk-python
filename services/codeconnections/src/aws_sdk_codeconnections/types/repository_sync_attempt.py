...
if TYPE_CHECKING:
    import aws_sdk_codeconnections.types.repository_sync_event_list
    import aws_sdk_codeconnections.types.repository_sync_status
...
class RepositorySyncAttempt(TypedDict):
    ...
    status: "aws_sdk_codeconnections.types.repository_sync_status.RepositorySyncStatus"
    ...
    events: "aws_sdk_codeconnections.types.repository_sync_event_list.RepositorySyncEventList"
...
def serialize_aws_json_1_0(value: RepositorySyncAttempt) -> dict:
    ...
    out["Status"] = (
        aws_sdk_codeconnections.types.repository_sync_status.serialize_aws_json_1_0(
            value["status"]
        )
    )
    import aws_sdk_codeconnections.types.repository_sync_event_list
    ...
    out["Events"] = (
        aws_sdk_codeconnections.types.repository_sync_event_list.serialize_aws_json_1_0(
            value["events"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> RepositorySyncAttempt:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_codeconnections.types.repository_sync_status.deserialize_aws_json_1_0(
                data["Status"]
            )
        )
    else:
    ...
    if "Events" in data:
        ...
        out["events"] = (
            aws_sdk_codeconnections.types.repository_sync_event_list.deserialize_aws_json_1_0(
                data["Events"]
            )
        )
    else:
