...
class Connection(TypedDict, closed=True):
    connection_name: NotRequired[
        "aws_sdk_codeconnections.types.connection_name.ConnectionName"
    ]
    ...
    owner_account_id: NotRequired["aws_sdk_codeconnections.types.account_id.AccountId"]
    ...
    connection_status: NotRequired[
        "aws_sdk_codeconnections.types.connection_status.ConnectionStatus"
    ]
...
def serialize_aws_json_1_0(value: Connection) -> dict:
    ...
    if "connection_status" in value:
        ...
        out["ConnectionStatus"] = (
            aws_sdk_codeconnections.types.connection_status.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Connection:
    ...
    if "ConnectionStatus" in data:
        ...
        out["connection_status"] = (
            aws_sdk_codeconnections.types.connection_status.deserialize_aws_json_1_0(
