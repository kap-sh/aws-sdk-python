...
class UpdateSyncBlockerOutput(TypedDict):
    ...
    sync_blocker: "aws_sdk_codeconnections.types.sync_blocker.SyncBlocker"
...
def serialize_aws_json_1_0(value: UpdateSyncBlockerOutput) -> dict:
    ...
    out["SyncBlocker"] = (
        aws_sdk_codeconnections.types.sync_blocker.serialize_aws_json_1_0(
            value["sync_blocker"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> UpdateSyncBlockerOutput:
    ...
    if "SyncBlocker" in data:
        ...
        out["sync_blocker"] = (
            aws_sdk_codeconnections.types.sync_blocker.deserialize_aws_json_1_0(
                data["SyncBlocker"]
            )
        )
    else:
