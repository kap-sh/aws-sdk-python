...
if TYPE_CHECKING:
    ...
    import aws_sdk_codeconnections.types.host_status
    import aws_sdk_codeconnections.types.host_status_message
...
class Host(TypedDict, closed=True):
    name: NotRequired["aws_sdk_codeconnections.types.host_name.HostName"]
    ...
    status: NotRequired["aws_sdk_codeconnections.types.host_status.HostStatus"]
    ...
    status_message: NotRequired[
        "aws_sdk_codeconnections.types.host_status_message.HostStatusMessage"
    ]
