...
class ListHostsOutput(TypedDict):
    hosts: NotRequired["aws_sdk_codeconnections.types.host_list.HostList"]
...
def serialize_aws_json_1_0(value: ListHostsOutput) -> dict:
    ...
    if "hosts" in value:
        ...
        out["Hosts"] = aws_sdk_codeconnections.types.host_list.serialize_aws_json_1_0(
            value["hosts"]
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListHostsOutput:
    ...
    if "Hosts" in data:
        ...
        out["hosts"] = aws_sdk_codeconnections.types.host_list.deserialize_aws_json_1_0(
            data["Hosts"]
        )
