...
class GetConnectionOutput(TypedDict, closed=True):
    connection: NotRequired["aws_sdk_codeconnections.types.connection.Connection"]
...
def serialize_aws_json_1_0(value: GetConnectionOutput) -> dict:
    ...
    if "connection" in value:
        ...
        out["Connection"] = (
            aws_sdk_codeconnections.types.connection.serialize_aws_json_1_0(
                value["connection"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> GetConnectionOutput:
    ...
    if "Connection" in data:
        ...
        out["connection"] = (
            aws_sdk_codeconnections.types.connection.deserialize_aws_json_1_0(
                data["Connection"]
            )
        )
    return out
