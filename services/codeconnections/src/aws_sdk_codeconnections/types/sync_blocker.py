...
if TYPE_CHECKING:
    import aws_sdk_codeconnections.types.blocker_status
    import aws_sdk_codeconnections.types.blocker_type
    import aws_sdk_codeconnections.types.created_reason
    import aws_sdk_codeconnections.types.id
    import aws_sdk_codeconnections.types.resolved_reason
    import aws_sdk_codeconnections.types.sync_blocker_context_list
...
class SyncBlocker(TypedDict):
    ...
    status: "aws_sdk_codeconnections.types.blocker_status.BlockerStatus"
    """<p>The status for a specific sync blocker.</p>"""
    created_reason: "aws_sdk_codeconnections.types.created_reason.CreatedReason"
    """<p>The provided reason for a specific sync blocker.</p>"""
    created_at: "aws_sdk_codeconnections.types.timestamp.Timestamp"
    """<p>The creation time for a specific sync blocker.</p>"""
    contexts: NotRequired[
        "aws_sdk_codeconnections.types.sync_blocker_context_list.SyncBlockerContextList"
    ]
    """<p>The contexts for a specific sync blocker.</p>"""
    resolved_reason: NotRequired[
        "aws_sdk_codeconnections.types.resolved_reason.ResolvedReason"
    ]
    """<p>The resolved reason for a specific sync blocker.</p>"""
    resolved_at: NotRequired["aws_sdk_codeconnections.types.timestamp.Timestamp"]
...
def serialize_aws_json_1_0(value: SyncBlocker) -> dict:
    ...
    out["Type"] = aws_sdk_codeconnections.types.blocker_type.serialize_aws_json_1_0(
        value["type"]
    )
    import aws_sdk_codeconnections.types.blocker_status

    out["Status"] = aws_sdk_codeconnections.types.blocker_status.serialize_aws_json_1_0(
        value["status"]
    )
    out["CreatedReason"] = value["created_reason"]
    import aws_sdk_codeconnections.types.timestamp

    out["CreatedAt"] = aws_sdk_codeconnections.types.timestamp.serialize_aws_json_1_0(
        value["created_at"]
    )
    if "contexts" in value:
        ...
        out["Contexts"] = (
            aws_sdk_codeconnections.types.sync_blocker_context_list.serialize_aws_json_1_0(
                value["contexts"]
            )
        )
    ...
    if "resolved_at" in value:
        ...
        out["ResolvedAt"] = (
            aws_sdk_codeconnections.types.timestamp.serialize_aws_json_1_0(
                value["resolved_at"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> SyncBlocker:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_codeconnections.types.blocker_type.deserialize_aws_json_1_0(
                data["Type"]
            )
        )
    else:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_codeconnections.types.blocker_status.deserialize_aws_json_1_0(
                data["Status"]
            )
        )
    else:
    ...
    if "Contexts" in data:
        ...
        out["contexts"] = (
            aws_sdk_codeconnections.types.sync_blocker_context_list.deserialize_aws_json_1_0(
                data["Contexts"]
            )
        )
