"""Generated from Smithy shape ``com.amazonaws.codeconnections#ListRepositorySyncDefinitions``."""
...
import aws_sdk_codeconnections.types.repository_sync_definition_list
...
def handle_response(
    ...
    out: aws_sdk_codeconnections.types.list_repository_sync_definitions_output.ListRepositorySyncDefinitionsOutput = aws_sdk_codeconnections.types.list_repository_sync_definitions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codeconnections.types.list_repository_sync_definitions_input.ListRepositorySyncDefinitionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeConnections_20231201.ListRepositorySyncDefinitions"
    body: bytes | None = json.dumps(
        aws_sdk_codeconnections.types.list_repository_sync_definitions_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_repository_sync_definitions(
