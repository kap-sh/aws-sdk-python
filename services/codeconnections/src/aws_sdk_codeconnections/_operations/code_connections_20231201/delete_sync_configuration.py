"""Generated from Smithy shape ``com.amazonaws.codeconnections#DeleteSyncConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_codeconnections.types.delete_sync_configuration_output.DeleteSyncConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodeConnections_20231201.DeleteSyncConfiguration"
