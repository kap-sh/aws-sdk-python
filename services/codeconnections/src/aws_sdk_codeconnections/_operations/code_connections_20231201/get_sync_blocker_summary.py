"""Generated from Smithy shape ``com.amazonaws.codeconnections#GetSyncBlockerSummary``."""
...
def handle_response(
    ...
    out: aws_sdk_codeconnections.types.get_sync_blocker_summary_output.GetSyncBlockerSummaryOutput = aws_sdk_codeconnections.types.get_sync_blocker_summary_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codeconnections.types.get_sync_blocker_summary_input.GetSyncBlockerSummaryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeConnections_20231201.GetSyncBlockerSummary"
    import aws_sdk_codeconnections.types.get_sync_blocker_summary_input

    body: bytes | None = json.dumps(
        aws_sdk_codeconnections.types.get_sync_blocker_summary_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
