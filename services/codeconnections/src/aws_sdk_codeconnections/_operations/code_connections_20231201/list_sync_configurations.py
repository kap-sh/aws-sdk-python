...
def handle_response(
    ...
    out: aws_sdk_codeconnections.types.list_sync_configurations_output.ListSyncConfigurationsOutput = aws_sdk_codeconnections.types.list_sync_configurations_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codeconnections.types.list_sync_configurations_input.ListSyncConfigurationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeconnections.types.list_sync_configurations_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
