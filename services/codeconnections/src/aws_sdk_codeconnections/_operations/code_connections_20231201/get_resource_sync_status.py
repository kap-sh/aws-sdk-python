...
def handle_response(
    ...
    out: aws_sdk_codeconnections.types.get_resource_sync_status_output.GetResourceSyncStatusOutput = aws_sdk_codeconnections.types.get_resource_sync_status_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codeconnections.types.get_resource_sync_status_input.GetResourceSyncStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeconnections.types.get_resource_sync_status_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
