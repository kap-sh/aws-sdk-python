...
def build_request(
    ...
    input_: aws_sdk_codeconnections.types.update_sync_blocker_input.UpdateSyncBlockerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeconnections.types.update_sync_blocker_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
