...
def handle_response(
    ...
    out: aws_sdk_codeconnections.types.get_sync_configuration_output.GetSyncConfigurationOutput = aws_sdk_codeconnections.types.get_sync_configuration_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_codeconnections.types.get_sync_configuration_input.GetSyncConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codeconnections.types.get_sync_configuration_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
