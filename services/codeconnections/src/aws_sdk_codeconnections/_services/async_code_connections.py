...
from aws_sdk_codeconnections._services._aws_config import aaws_config
...
class AsyncCodeConnectionsClientConfig(TypedDict, total=False):
...
class AsyncCodeConnectionsClient:
    ...
    async def create_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.create_connection_input.CreateConnectionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.create_connection_output.CreateConnectionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.create_connection.async_create_connection(
    ...
    async def create_host(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.create_host_input.CreateHostInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.create_host_output.CreateHostOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.create_host.async_create_host(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_repository_link(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.create_repository_link_input.CreateRepositoryLinkInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.create_repository_link_output.CreateRepositoryLinkOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.create_repository_link.async_create_repository_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_sync_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.create_sync_configuration_input.CreateSyncConfigurationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.create_sync_configuration_output.CreateSyncConfigurationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.create_sync_configuration.async_create_sync_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.delete_connection_input.DeleteConnectionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.delete_connection_output.DeleteConnectionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.delete_connection.async_delete_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_host(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.delete_host_input.DeleteHostInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.delete_host_output.DeleteHostOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.delete_host.async_delete_host(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_repository_link(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.delete_repository_link_input.DeleteRepositoryLinkInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.delete_repository_link_output.DeleteRepositoryLinkOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.delete_repository_link.async_delete_repository_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_sync_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.delete_sync_configuration_input.DeleteSyncConfigurationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.delete_sync_configuration_output.DeleteSyncConfigurationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.delete_sync_configuration.async_delete_sync_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.get_connection_input.GetConnectionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.get_connection_output.GetConnectionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.get_connection.async_get_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_host(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.get_host_input.GetHostInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.get_host_output.GetHostOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.get_host.async_get_host(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_repository_link(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.get_repository_link_input.GetRepositoryLinkInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.get_repository_link_output.GetRepositoryLinkOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.get_repository_link.async_get_repository_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_repository_sync_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.get_repository_sync_status_input.GetRepositorySyncStatusInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.get_repository_sync_status_output.GetRepositorySyncStatusOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.get_repository_sync_status.async_get_repository_sync_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_sync_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.get_resource_sync_status_input.GetResourceSyncStatusInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.get_resource_sync_status_output.GetResourceSyncStatusOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.get_resource_sync_status.async_get_resource_sync_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sync_blocker_summary(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.get_sync_blocker_summary_input.GetSyncBlockerSummaryInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.get_sync_blocker_summary_output.GetSyncBlockerSummaryOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.get_sync_blocker_summary.async_get_sync_blocker_summary(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sync_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.get_sync_configuration_input.GetSyncConfigurationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.get_sync_configuration_output.GetSyncConfigurationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.get_sync_configuration.async_get_sync_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_connections(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.list_connections_input.ListConnectionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.list_connections_output.ListConnectionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.list_connections.async_list_connections(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_hosts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.list_hosts_input.ListHostsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.list_hosts_output.ListHostsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.list_hosts.async_list_hosts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_repository_links(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.list_repository_links_input.ListRepositoryLinksInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.list_repository_links_output.ListRepositoryLinksOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.list_repository_links.async_list_repository_links(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_repository_sync_definitions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.list_repository_sync_definitions_input.ListRepositorySyncDefinitionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.list_repository_sync_definitions_output.ListRepositorySyncDefinitionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.list_repository_sync_definitions.async_list_repository_sync_definitions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_sync_configurations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.list_sync_configurations_input.ListSyncConfigurationsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.list_sync_configurations_output.ListSyncConfigurationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.list_sync_configurations.async_list_sync_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.tag_resource_input.TagResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_host(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.update_host_input.UpdateHostInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.update_host_output.UpdateHostOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.update_host.async_update_host(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_repository_link(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.update_repository_link_input.UpdateRepositoryLinkInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.update_repository_link_output.UpdateRepositoryLinkOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.update_repository_link.async_update_repository_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_sync_blocker(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.update_sync_blocker_input.UpdateSyncBlockerInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.update_sync_blocker_output.UpdateSyncBlockerOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.update_sync_blocker.async_update_sync_blocker(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_sync_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codeconnections.types.update_sync_configuration_input.UpdateSyncConfigurationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codeconnections.types.update_sync_configuration_output.UpdateSyncConfigurationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_codeconnections._operations.code_connections_20231201.update_sync_configuration.async_update_sync_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
