...
class CodeConnectionsError(Exception):
    """Base class for all CodeConnections service errors."""


class ServiceError(CodeConnectionsError):
...
class SerializationError(CodeConnectionsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CodeConnectionsError):
...
class WaiterFailedError(CodeConnectionsError):
...
class WaiterTimeoutError(CodeConnectionsError):
