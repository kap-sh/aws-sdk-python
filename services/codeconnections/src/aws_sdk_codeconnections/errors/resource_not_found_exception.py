"""Generated from Smithy shape ``com.amazonaws.codeconnections#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codeconnections#ResourceNotFoundException``."""
