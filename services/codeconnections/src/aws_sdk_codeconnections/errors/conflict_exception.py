"""Generated from Smithy shape ``com.amazonaws.codeconnections#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codeconnections#ConflictException``."""
