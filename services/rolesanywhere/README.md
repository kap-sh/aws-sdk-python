...
```
pip install aws-sdk-rolesanywhere
```

## Usage

```python
from aws_sdk_rolesanywhere import AsyncRolesAnywhereClient


async def main():
    async with AsyncRolesAnywhereClient() as s3:
...
```python
from aws_sdk_rolesanywhere import AsyncRolesAnywhereClient
from aws_sdk_rolesanywhere.error import AccessDeniedException
