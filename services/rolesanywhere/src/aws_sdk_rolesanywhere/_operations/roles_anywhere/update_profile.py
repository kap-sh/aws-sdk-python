"""Generated from Smithy shape ``com.amazonaws.rolesanywhere#UpdateProfile``."""
...
def build_request(
    ...
    input: aws_sdk_rolesanywhere.types.update_profile_request.UpdateProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rolesanywhere.types.update_profile_request.serialize_json(input)
    ).encode()
