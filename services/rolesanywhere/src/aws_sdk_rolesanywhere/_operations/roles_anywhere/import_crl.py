"""Generated from Smithy shape ``com.amazonaws.rolesanywhere#ImportCrl``."""
...
def build_request(
    ...
    input_: aws_sdk_rolesanywhere.types.import_crl_request.ImportCrlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rolesanywhere.types.import_crl_request.serialize_json(input_)
    ).encode()
