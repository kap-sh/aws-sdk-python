"""Generated from Smithy shape ``com.amazonaws.rolesanywhere#ListProfiles``."""
...
import aws_sdk_rolesanywhere.types.profile_details
...
def handle_response(
    ...
    out: aws_sdk_rolesanywhere.types.list_profiles_response.ListProfilesResponse = (
        aws_sdk_rolesanywhere.types.list_profiles_response.deserialize_json(
