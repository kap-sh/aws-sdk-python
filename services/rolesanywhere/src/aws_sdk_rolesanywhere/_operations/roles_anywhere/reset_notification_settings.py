...
def handle_response(
    ...
    out: aws_sdk_rolesanywhere.types.reset_notification_settings_response.ResetNotificationSettingsResponse = aws_sdk_rolesanywhere.types.reset_notification_settings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rolesanywhere.types.reset_notification_settings_request.ResetNotificationSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rolesanywhere.types.reset_notification_settings_request.serialize_json(
            input_
        )
    ).encode()
