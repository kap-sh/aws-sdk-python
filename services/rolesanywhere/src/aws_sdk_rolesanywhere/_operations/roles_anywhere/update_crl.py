...
def handle_response(
    ...
    out: aws_sdk_rolesanywhere.types.crl_detail_response.CrlDetailResponse = (
        aws_sdk_rolesanywhere.types.crl_detail_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rolesanywhere.types.update_crl_request.UpdateCrlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rolesanywhere.types.update_crl_request.serialize_json(input_)
    ).encode()
...
def update_crl(
    ...
    aws_sdk_rolesanywhere.types.crl_detail_response.CrlDetailResponse, zapros.Response
]:
