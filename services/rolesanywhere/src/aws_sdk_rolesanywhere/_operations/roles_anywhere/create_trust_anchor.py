...
def build_request(
    ...
    input: aws_sdk_rolesanywhere.types.create_trust_anchor_request.CreateTrustAnchorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rolesanywhere.types.create_trust_anchor_request.serialize_json(input)
    ).encode()
