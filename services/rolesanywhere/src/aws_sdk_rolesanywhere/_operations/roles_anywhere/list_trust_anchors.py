...
def handle_response(
    ...
    out: aws_sdk_rolesanywhere.types.list_trust_anchors_response.ListTrustAnchorsResponse = aws_sdk_rolesanywhere.types.list_trust_anchors_response.deserialize_json(
