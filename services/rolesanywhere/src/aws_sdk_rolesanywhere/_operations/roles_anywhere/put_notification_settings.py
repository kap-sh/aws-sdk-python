...
def handle_response(
    ...
    out: aws_sdk_rolesanywhere.types.put_notification_settings_response.PutNotificationSettingsResponse = aws_sdk_rolesanywhere.types.put_notification_settings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rolesanywhere.types.put_notification_settings_request.PutNotificationSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rolesanywhere.types.put_notification_settings_request.serialize_json(
            input_
        )
    ).encode()
