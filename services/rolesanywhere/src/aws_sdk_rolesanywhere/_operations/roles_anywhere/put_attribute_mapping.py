...
def build_request(
    ...
    input_: aws_sdk_rolesanywhere.types.put_attribute_mapping_request.PutAttributeMappingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rolesanywhere.types.put_attribute_mapping_request.serialize_json(input_)
    ).encode()
