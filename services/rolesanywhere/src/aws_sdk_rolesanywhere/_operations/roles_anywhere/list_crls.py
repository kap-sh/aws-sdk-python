...
def handle_response(
    ...
    out: aws_sdk_rolesanywhere.types.list_crls_response.ListCrlsResponse = (
        aws_sdk_rolesanywhere.types.list_crls_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rolesanywhere.types.list_request.ListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_crls(
    ...
    aws_sdk_rolesanywhere.types.list_crls_response.ListCrlsResponse, zapros.Response
]:
