...
def handle_response(
    ...
    out: aws_sdk_rolesanywhere.types.trust_anchor_detail_response.TrustAnchorDetailResponse = aws_sdk_rolesanywhere.types.trust_anchor_detail_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rolesanywhere.types.update_trust_anchor_request.UpdateTrustAnchorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rolesanywhere.types.update_trust_anchor_request.serialize_json(input_)
    ).encode()
