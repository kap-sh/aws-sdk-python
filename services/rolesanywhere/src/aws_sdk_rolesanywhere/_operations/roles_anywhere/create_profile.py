...
def build_request(
    ...
    input_: aws_sdk_rolesanywhere.types.create_profile_request.CreateProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rolesanywhere.types.create_profile_request.serialize_json(input_)
    ).encode()
