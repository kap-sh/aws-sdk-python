...
if TYPE_CHECKING:
    import aws_sdk_rolesanywhere.types.subject_summaries


class ListSubjectsResponse(TypedDict):
    subjects: NotRequired[
        "aws_sdk_rolesanywhere.types.subject_summaries.SubjectSummaries"
    ]
...
def serialize_json(value: ListSubjectsResponse) -> dict:
    ...
    if "subjects" in value:
        ...
        out["subjects"] = aws_sdk_rolesanywhere.types.subject_summaries.serialize_json(
            value["subjects"]
        )
...
def deserialize_json(data: dict) -> ListSubjectsResponse:
    ...
    if "subjects" in data:
        ...
        out["subjects"] = (
            aws_sdk_rolesanywhere.types.subject_summaries.deserialize_json(
                data["subjects"]
            )
        )
