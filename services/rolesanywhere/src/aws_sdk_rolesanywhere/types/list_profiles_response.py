...
class ListProfilesResponse(TypedDict, closed=True):
    ...
    profiles: NotRequired["aws_sdk_rolesanywhere.types.profile_details.ProfileDetails"]
...
def serialize_json(value: ListProfilesResponse) -> dict:
    ...
    if "profiles" in value:
        ...
        out["profiles"] = aws_sdk_rolesanywhere.types.profile_details.serialize_json(
            value["profiles"]
        )
    return out
...
def deserialize_json(data: dict) -> ListProfilesResponse:
    ...
    if "profiles" in data:
        ...
        out["profiles"] = aws_sdk_rolesanywhere.types.profile_details.deserialize_json(
            data["profiles"]
        )
    return out
