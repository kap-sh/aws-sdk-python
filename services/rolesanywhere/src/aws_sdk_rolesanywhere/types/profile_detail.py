...
if TYPE_CHECKING:
    ...
    import aws_sdk_rolesanywhere.types.attribute_mappings
    import aws_sdk_rolesanywhere.types.managed_policy_list
    import aws_sdk_rolesanywhere.types.profile_arn
...
class ProfileDetail(TypedDict, closed=True):
    profile_id: NotRequired["aws_sdk_rolesanywhere.types.uuid.Uuid"]
    """<p>The unique identifier of the profile.</p>"""
    profile_arn: NotRequired["aws_sdk_rolesanywhere.types.profile_arn.ProfileArn"]
    ...
    attribute_mappings: NotRequired[
        "aws_sdk_rolesanywhere.types.attribute_mappings.AttributeMappings"
    ]
...
def serialize_json(value: ProfileDetail) -> dict:
    ...
    if "attribute_mappings" in value:
        ...
        out["attributeMappings"] = (
            aws_sdk_rolesanywhere.types.attribute_mappings.serialize_json(
...
def deserialize_json(data: dict) -> ProfileDetail:
    ...
    if "attributeMappings" in data:
        ...
        out["attribute_mappings"] = (
            aws_sdk_rolesanywhere.types.attribute_mappings.deserialize_json(
