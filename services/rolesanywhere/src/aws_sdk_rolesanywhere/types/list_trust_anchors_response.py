...
if TYPE_CHECKING:
    import aws_sdk_rolesanywhere.types.trust_anchor_details


class ListTrustAnchorsResponse(TypedDict):
    ...
    trust_anchors: NotRequired[
        "aws_sdk_rolesanywhere.types.trust_anchor_details.TrustAnchorDetails"
    ]
...
def serialize_json(value: ListTrustAnchorsResponse) -> dict:
    ...
    if "trust_anchors" in value:
        ...
        out["trustAnchors"] = (
            aws_sdk_rolesanywhere.types.trust_anchor_details.serialize_json(
                value["trust_anchors"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ListTrustAnchorsResponse:
    ...
    if "trustAnchors" in data:
        ...
        out["trust_anchors"] = (
            aws_sdk_rolesanywhere.types.trust_anchor_details.deserialize_json(
                data["trustAnchors"]
            )
        )
    return out
