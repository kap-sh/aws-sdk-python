...
CredentialSummaries: TypeAlias = list["aws_sdk_rolesanywhere.types.credential_summary.CredentialSummary"]
...
def deserialize_json(data: list) -> CredentialSummaries:
    ...
    for item in data:
        out.append(aws_sdk_rolesanywhere.types.credential_summary.deserialize_json(item))
    return out