"""Generated from Smithy shape ``com.amazonaws.rolesanywhere#TooManyTagsException``."""
...
class TooManyTagsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rolesanywhere#TooManyTagsException``."""
