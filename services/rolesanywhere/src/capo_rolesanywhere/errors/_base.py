...
class RolesAnywhereError(Exception):
    """Base class for all RolesAnywhere service errors."""


class ServiceError(RolesAnywhereError):
...
class SerializationError(RolesAnywhereError):
    """Raised when a value cannot be serialized."""


class DeserializationError(RolesAnywhereError):
...
class WaiterFailedError(RolesAnywhereError):
...
class WaiterTimeoutError(RolesAnywhereError):
