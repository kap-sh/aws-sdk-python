...
from capo_rolesanywhere._resources.roles_anywhere.crl import Crl
from capo_rolesanywhere._resources.roles_anywhere.profile import Profile
from capo_rolesanywhere._resources.roles_anywhere.subject import Subject
from capo_rolesanywhere._resources.roles_anywhere.trust_anchor import TrustAnchor
from capo_rolesanywhere._services._aws_config import aws_config
...
class RolesAnywhereClientConfig(TypedDict, total=False, closed=True):
...
class RolesAnywhereClient:
    ...
    def __init__(
        ...
        self._config = RolesAnywhereClientConfig(
            {
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rolesanywhere.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_rolesanywhere.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_rolesanywhere._operations.roles_anywhere.list_tags_for_resource.list_tags_for_resource(
    ...
    def put_notification_settings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rolesanywhere.types.put_notification_settings_request.PutNotificationSettingsRequest]",
        ) -> OperationResponse[
            "capo_rolesanywhere.types.put_notification_settings_response.PutNotificationSettingsResponse"
        ]:
            ...
            output, http_response = (
                capo_rolesanywhere._operations.roles_anywhere.put_notification_settings.put_notification_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def reset_notification_settings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rolesanywhere.types.reset_notification_settings_request.ResetNotificationSettingsRequest]",
        ) -> OperationResponse[
            "capo_rolesanywhere.types.reset_notification_settings_response.ResetNotificationSettingsResponse"
        ]:
            ...
            output, http_response = (
                capo_rolesanywhere._operations.roles_anywhere.reset_notification_settings.reset_notification_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rolesanywhere.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_rolesanywhere.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_rolesanywhere._operations.roles_anywhere.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rolesanywhere.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_rolesanywhere.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_rolesanywhere._operations.roles_anywhere.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
