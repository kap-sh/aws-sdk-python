...
from ._services.async_ssm_contacts import (
    AsyncSSMContactsClient as AsyncSSMContactsClient,
)
from ._services.ssm_contacts import SSMContactsClient as SSMContactsClient
