...
class SSMContactsError(Exception):
    """Base class for all SSMContacts service errors."""


class ServiceError(SSMContactsError):
...
class SerializationError(SSMContactsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SSMContactsError):
...
class WaiterFailedError(SSMContactsError):
...
class WaiterTimeoutError(SSMContactsError):
