"""Generated from Smithy shape ``com.amazonaws.ssmcontacts#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException_(TypedDict, closed=True):
    ...
    resource_id: NotRequired["aws_sdk_ssm_contacts.types.string.String"]
    """Identifier of the resource affected"""
    resource_type: NotRequired["aws_sdk_ssm_contacts.types.string.String"]
    """Type of the resource affected"""
    quota_code: "aws_sdk_ssm_contacts.types.string.String"
    """Service Quotas requirement to identify originating service"""
    service_code: "aws_sdk_ssm_contacts.types.string.String"
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ssmcontacts#ServiceQuotaExceededException``."""
