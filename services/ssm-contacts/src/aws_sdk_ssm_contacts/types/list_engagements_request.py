...
class ListEngagementsRequest(TypedDict, closed=True):
    ...
    time_range_value: NotRequired["aws_sdk_ssm_contacts.types.time_range.TimeRange"]
...
def serialize_aws_json_1_1(value: ListEngagementsRequest) -> dict:
    ...
    if "time_range_value" in value:
        ...
        out["TimeRangeValue"] = (
            aws_sdk_ssm_contacts.types.time_range.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListEngagementsRequest:
    ...
    if "TimeRangeValue" in data:
        ...
        out["time_range_value"] = (
            aws_sdk_ssm_contacts.types.time_range.deserialize_aws_json_1_1(
                data["TimeRangeValue"]
            )
        )
    return out
