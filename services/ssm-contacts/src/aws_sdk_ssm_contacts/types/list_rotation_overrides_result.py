...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm_contacts.types.rotation_overrides


class ListRotationOverridesResult(TypedDict):
    rotation_overrides: NotRequired[
        "aws_sdk_ssm_contacts.types.rotation_overrides.RotationOverrides"
    ]
...
def serialize_aws_json_1_1(value: ListRotationOverridesResult) -> dict:
    ...
    if "rotation_overrides" in value:
        ...
        out["RotationOverrides"] = (
            aws_sdk_ssm_contacts.types.rotation_overrides.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListRotationOverridesResult:
    ...
    if "RotationOverrides" in data:
        ...
        out["rotation_overrides"] = (
            aws_sdk_ssm_contacts.types.rotation_overrides.deserialize_aws_json_1_1(
