...
class ListEngagementsResult(TypedDict):
    next_token: NotRequired[
        "aws_sdk_ssm_contacts.types.pagination_token.PaginationToken"
    ]
    """<p>The pagination token to continue to the next page of results.</p>"""
    engagements: "aws_sdk_ssm_contacts.types.engagements_list.EngagementsList"
...
def serialize_aws_json_1_1(value: ListEngagementsResult) -> dict:
    ...
    out["Engagements"] = (
        aws_sdk_ssm_contacts.types.engagements_list.serialize_aws_json_1_1(
            value["engagements"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListEngagementsResult:
    ...
    if "Engagements" in data:
        ...
        out["engagements"] = (
            aws_sdk_ssm_contacts.types.engagements_list.deserialize_aws_json_1_1(
                data["Engagements"]
            )
        )
    else:
