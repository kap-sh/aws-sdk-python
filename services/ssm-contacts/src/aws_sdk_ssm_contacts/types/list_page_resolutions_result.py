...
class ListPageResolutionsResult(TypedDict):
    next_token: NotRequired[
        "aws_sdk_ssm_contacts.types.pagination_token.PaginationToken"
    ]
    """<p>The token for the next set of items to return. Use this token to get the next set of results.</p>"""
    page_resolutions: "aws_sdk_ssm_contacts.types.resolution_list.ResolutionList"
...
def serialize_aws_json_1_1(value: ListPageResolutionsResult) -> dict:
    ...
    out["PageResolutions"] = (
        aws_sdk_ssm_contacts.types.resolution_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListPageResolutionsResult:
    ...
    if "PageResolutions" in data:
        ...
        out["page_resolutions"] = (
            aws_sdk_ssm_contacts.types.resolution_list.deserialize_aws_json_1_1(
