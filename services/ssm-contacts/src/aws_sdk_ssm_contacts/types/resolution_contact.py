...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm_contacts.types.stage_index


class ResolutionContact(TypedDict):
    ...
    stage_index: NotRequired["aws_sdk_ssm_contacts.types.stage_index.StageIndex"]
