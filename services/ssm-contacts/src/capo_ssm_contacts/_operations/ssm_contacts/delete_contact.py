...
def handle_response(
    ...
    out: capo_ssm_contacts.types.delete_contact_result.DeleteContactResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.delete_contact_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_contact(
    ...
    capo_ssm_contacts.types.delete_contact_result.DeleteContactResult, zapros.Response
]:
