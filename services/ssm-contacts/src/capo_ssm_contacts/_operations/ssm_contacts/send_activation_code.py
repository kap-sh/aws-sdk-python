"""Generated from Smithy shape ``com.amazonaws.ssmcontacts#SendActivationCode``."""
...
def handle_response(
    ...
    out: capo_ssm_contacts.types.send_activation_code_result.SendActivationCodeResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SSMContacts.SendActivationCode"
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.send_activation_code_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_send_activation_code(
