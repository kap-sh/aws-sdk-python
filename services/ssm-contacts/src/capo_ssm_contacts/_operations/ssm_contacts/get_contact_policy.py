"""Generated from Smithy shape ``com.amazonaws.ssmcontacts#GetContactPolicy``."""
...
def handle_response(
    ...
    out: capo_ssm_contacts.types.get_contact_policy_result.GetContactPolicyResult = (
        capo_ssm_contacts.types.get_contact_policy_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SSMContacts.GetContactPolicy"
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.get_contact_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_contact_policy(
