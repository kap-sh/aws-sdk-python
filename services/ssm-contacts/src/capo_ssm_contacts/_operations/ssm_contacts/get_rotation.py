...
def handle_response(
    ...
    out: capo_ssm_contacts.types.get_rotation_result.GetRotationResult = (
        capo_ssm_contacts.types.get_rotation_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.get_rotation_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_rotation(
    ...
    capo_ssm_contacts.types.get_rotation_result.GetRotationResult, zapros.Response
]:
