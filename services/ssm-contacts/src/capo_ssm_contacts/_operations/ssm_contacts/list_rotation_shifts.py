...
def handle_response(
    ...
    out: capo_ssm_contacts.types.list_rotation_shifts_result.ListRotationShiftsResult = capo_ssm_contacts.types.list_rotation_shifts_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.list_rotation_shifts_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
