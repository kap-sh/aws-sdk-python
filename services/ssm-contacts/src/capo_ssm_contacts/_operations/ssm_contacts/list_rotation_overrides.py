"""Generated from Smithy shape ``com.amazonaws.ssmcontacts#ListRotationOverrides``."""
...
def handle_response(
    ...
    out: capo_ssm_contacts.types.list_rotation_overrides_result.ListRotationOverridesResult = capo_ssm_contacts.types.list_rotation_overrides_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SSMContacts.ListRotationOverrides"
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.list_rotation_overrides_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_rotation_overrides(
