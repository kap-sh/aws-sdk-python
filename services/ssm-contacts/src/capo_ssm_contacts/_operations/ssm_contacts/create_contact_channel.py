"""Generated from Smithy shape ``com.amazonaws.ssmcontacts#CreateContactChannel``."""
...
import capo_ssm_contacts.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_ssm_contacts.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_ssm_contacts.types.create_contact_channel_result.CreateContactChannelResult = capo_ssm_contacts.types.create_contact_channel_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SSMContacts.CreateContactChannel"
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.create_contact_channel_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_contact_channel(
