...
def handle_response(
    ...
    out: capo_ssm_contacts.types.get_contact_result.GetContactResult = (
        capo_ssm_contacts.types.get_contact_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.get_contact_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_contact(
    ...
    capo_ssm_contacts.types.get_contact_result.GetContactResult, zapros.Response
]:
