...
def handle_response(
    ...
    out: capo_ssm_contacts.types.list_page_resolutions_result.ListPageResolutionsResult = capo_ssm_contacts.types.list_page_resolutions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.list_page_resolutions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
