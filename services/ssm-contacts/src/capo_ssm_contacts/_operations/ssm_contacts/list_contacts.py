...
def handle_response(
    ...
    out: capo_ssm_contacts.types.list_contacts_result.ListContactsResult = (
        capo_ssm_contacts.types.list_contacts_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.list_contacts_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_contacts(
    ...
    capo_ssm_contacts.types.list_contacts_result.ListContactsResult, zapros.Response
]:
