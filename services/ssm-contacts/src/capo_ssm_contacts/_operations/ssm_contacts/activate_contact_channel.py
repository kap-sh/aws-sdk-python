"""Generated from Smithy shape ``com.amazonaws.ssmcontacts#ActivateContactChannel``."""
...
def handle_response(
    ...
    out: capo_ssm_contacts.types.activate_contact_channel_result.ActivateContactChannelResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SSMContacts.ActivateContactChannel"
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.activate_contact_channel_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_activate_contact_channel(
