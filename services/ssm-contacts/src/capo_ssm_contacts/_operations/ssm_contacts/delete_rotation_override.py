"""Generated from Smithy shape ``com.amazonaws.ssmcontacts#DeleteRotationOverride``."""
...
def handle_response(
    ...
    out: capo_ssm_contacts.types.delete_rotation_override_result.DeleteRotationOverrideResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SSMContacts.DeleteRotationOverride"
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.delete_rotation_override_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_rotation_override(
