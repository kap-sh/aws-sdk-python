"""Generated from Smithy shape ``com.amazonaws.ssmcontacts#GetRotationOverride``."""
...
def handle_response(
    ...
    out: capo_ssm_contacts.types.get_rotation_override_result.GetRotationOverrideResult = capo_ssm_contacts.types.get_rotation_override_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SSMContacts.GetRotationOverride"
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.get_rotation_override_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_rotation_override(
