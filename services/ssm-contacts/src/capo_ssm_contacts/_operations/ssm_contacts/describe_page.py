...
def handle_response(
    ...
    out: capo_ssm_contacts.types.describe_page_result.DescribePageResult = (
        capo_ssm_contacts.types.describe_page_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.describe_page_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_page(
    ...
    capo_ssm_contacts.types.describe_page_result.DescribePageResult, zapros.Response
]:
