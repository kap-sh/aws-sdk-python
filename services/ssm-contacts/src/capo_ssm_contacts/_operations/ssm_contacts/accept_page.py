...
def handle_response(
    ...
    out: capo_ssm_contacts.types.accept_page_result.AcceptPageResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.accept_page_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def accept_page(
    ...
    capo_ssm_contacts.types.accept_page_result.AcceptPageResult, zapros.Response
]:
