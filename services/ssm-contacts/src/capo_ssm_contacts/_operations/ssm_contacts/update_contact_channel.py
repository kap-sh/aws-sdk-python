"""Generated from Smithy shape ``com.amazonaws.ssmcontacts#UpdateContactChannel``."""
...
def handle_response(
    ...
    out: capo_ssm_contacts.types.update_contact_channel_result.UpdateContactChannelResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SSMContacts.UpdateContactChannel"
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.update_contact_channel_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_contact_channel(
