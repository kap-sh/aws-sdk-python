...
import capo_ssm_contacts.errors.data_encryption_exception
import capo_ssm_contacts.errors.internal_server_exception
import capo_ssm_contacts.errors.resource_not_found_exception
import capo_ssm_contacts.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DataEncryptionException":
            raise capo_ssm_contacts.errors.data_encryption_exception.DataEncryptionException.from_aws_json_1_1(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_ssm_contacts.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_ssm_contacts.types.update_contact_result.UpdateContactResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.update_contact_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_contact(
    ...
    capo_ssm_contacts.types.update_contact_result.UpdateContactResult, zapros.Response
]:
