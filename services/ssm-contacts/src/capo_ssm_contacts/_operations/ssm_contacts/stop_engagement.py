...
def handle_response(
    ...
    out: capo_ssm_contacts.types.stop_engagement_result.StopEngagementResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.stop_engagement_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_engagement(
    ...
    capo_ssm_contacts.types.stop_engagement_result.StopEngagementResult, zapros.Response
]:
