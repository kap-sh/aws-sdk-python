...
def handle_response(
    ...
    out: capo_ssm_contacts.types.deactivate_contact_channel_result.DeactivateContactChannelResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.deactivate_contact_channel_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
