...
class ServiceQuotaExceededException_(TypedDict, closed=True):
    ...
    resource_id: NotRequired["capo_ssm_contacts.types.string.String"]
    """Identifier of the resource affected"""
    resource_type: NotRequired["capo_ssm_contacts.types.string.String"]
    """Type of the resource affected"""
    quota_code: "capo_ssm_contacts.types.string.String"
    """Service Quotas requirement to identify originating service"""
    service_code: "capo_ssm_contacts.types.string.String"
