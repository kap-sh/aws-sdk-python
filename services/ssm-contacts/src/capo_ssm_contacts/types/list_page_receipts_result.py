...
class ListPageReceiptsResult(TypedDict, closed=True):
    ...
    receipts: NotRequired["capo_ssm_contacts.types.receipts_list.ReceiptsList"]
...
def serialize_aws_json_1_1(value: ListPageReceiptsResult) -> dict:
    ...
    if "receipts" in value:
        ...
        out["Receipts"] = capo_ssm_contacts.types.receipts_list.serialize_aws_json_1_1(
            value["receipts"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListPageReceiptsResult:
    ...
    if "Receipts" in data:
        ...
        out["receipts"] = (
            capo_ssm_contacts.types.receipts_list.deserialize_aws_json_1_1(
                data["Receipts"]
            )
        )
    return out
