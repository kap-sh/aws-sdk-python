...
class GetRotationOverrideResult(TypedDict, closed=True):
    rotation_override_id: NotRequired["capo_ssm_contacts.types.uuid.Uuid"]
    """<p>The Amazon Resource Name (ARN) of the override to an on-call rotation.</p>"""
    rotation_arn: NotRequired["capo_ssm_contacts.types.ssm_contacts_arn.SsmContactsArn"]
    ...
    create_time: NotRequired["capo_ssm_contacts.types.date_time.DateTime"]
