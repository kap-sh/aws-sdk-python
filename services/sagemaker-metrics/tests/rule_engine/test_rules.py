import pytest
from aws_sdk_sagemaker_metrics._rule_engine._endpoint_rule_set import EndpointParams, resolve
from aws_sdk_sagemaker_metrics._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_13_for_region_ca_central_1_with_fips_enable():
...
def test_14_for_region_ca_west_1_with_fips_disabled_():
...
def test_15_for_region_ca_west_1_with_fips_enabled_a():
...
def test_16_for_region_eu_central_1_with_fips_disabl():
...
def test_17_for_region_eu_central_2_with_fips_disabl():
...
def test_18_for_region_eu_north_1_with_fips_disabled():
...
def test_19_for_region_eu_south_1_with_fips_disabled():
...
def test_20_for_region_eu_south_2_with_fips_disabled():
...
def test_22_for_region_eu_west_2_with_fips_disabled_():
...
def test_23_for_region_eu_west_3_with_fips_disabled_():
...
def test_24_for_region_il_central_1_with_fips_disabl():
...
def test_25_for_region_me_central_1_with_fips_disabl():
...
def test_26_for_region_me_south_1_with_fips_disabled():
...
def test_30_for_region_us_east_2_with_fips_disabled_():
...
def test_34_for_region_us_west_2_with_fips_disabled_():
...
def test_35_for_region_us_west_2_with_fips_enabled_a():
...
def test_40_for_region_cn_north_1_with_fips_disabled():
...
def test_46_for_region_us_iso_east_1_with_fips_enabl():
...
def test_47_for_region_us_iso_east_1_with_fips_disab():
...
def test_48_for_region_us_isob_east_1_with_fips_enab():
...
def test_49_for_region_us_isob_east_1_with_fips_disa():
