...
from aws_sdk_sagemaker_metrics._services._aws_config import aws_config
...
class SageMakerMetricsClientConfig(TypedDict, total=False):
...
class SageMakerMetricsClient:
    ...
    def batch_get_metrics(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sagemaker_metrics.types.batch_get_metrics_request.BatchGetMetricsRequest]",
        ) -> OperationResponse[
            "aws_sdk_sagemaker_metrics.types.batch_get_metrics_response.BatchGetMetricsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sagemaker_metrics._operations.sage_maker_metrics_service.batch_get_metrics.batch_get_metrics(
    ...
    def batch_put_metrics(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sagemaker_metrics.types.batch_put_metrics_request.BatchPutMetricsRequest]",
        ) -> OperationResponse[
            "aws_sdk_sagemaker_metrics.types.batch_put_metrics_response.BatchPutMetricsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sagemaker_metrics._operations.sage_maker_metrics_service.batch_put_metrics.batch_put_metrics(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
