...
class SageMakerMetricsError(Exception):
    """Base class for all SageMakerMetrics service errors."""


class ServiceError(SageMakerMetricsError):
...
class SerializationError(SageMakerMetricsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SageMakerMetricsError):
...
class WaiterFailedError(SageMakerMetricsError):
...
class WaiterTimeoutError(SageMakerMetricsError):
