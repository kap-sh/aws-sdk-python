...
class UpdateDeploymentOutput(TypedDict):
...
def serialize_json(value: UpdateDeploymentOutput) -> dict:
    ...
    if "deployment" in value:
        ...
        out["deployment"] = (
            aws_sdk_launch_wizard.types.deployment_data_summary.serialize_json(
                value["deployment"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> UpdateDeploymentOutput:
    ...
    if "deployment" in data:
        ...
        out["deployment"] = (
            aws_sdk_launch_wizard.types.deployment_data_summary.deserialize_json(
                data["deployment"]
            )
        )
    return out
