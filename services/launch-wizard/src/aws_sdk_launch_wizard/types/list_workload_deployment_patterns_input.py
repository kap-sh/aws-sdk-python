...
if TYPE_CHECKING:
    import aws_sdk_launch_wizard.types.max_workload_deployment_pattern_results
    import aws_sdk_launch_wizard.types.next_token
    import aws_sdk_launch_wizard.types.workload_name


class ListWorkloadDeploymentPatternsInput(TypedDict):
    workload_name: "aws_sdk_launch_wizard.types.workload_name.WorkloadName"
    """<p>The name of the workload.</p>"""
    max_results: NotRequired[
        "aws_sdk_launch_wizard.types.max_workload_deployment_pattern_results.MaxWorkloadDeploymentPatternResults"
    ]
