...
class DeploymentSpecificationsField(TypedDict, closed=True):
    ...
    allowed_values: NotRequired[
        "aws_sdk_launch_wizard.types.allowed_values.AllowedValues"
    ]
    ...
    conditionals: NotRequired[
        "aws_sdk_launch_wizard.types.specifications_conditional_data.SpecificationsConditionalData"
    ]
...
def serialize_json(value: DeploymentSpecificationsField) -> dict:
    ...
    if "allowed_values" in value:
        ...
        out["allowedValues"] = (
            aws_sdk_launch_wizard.types.allowed_values.serialize_json(
    ...
    if "conditionals" in value:
        ...
        out["conditionals"] = (
            aws_sdk_launch_wizard.types.specifications_conditional_data.serialize_json(
                value["conditionals"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> DeploymentSpecificationsField:
    ...
    if "allowedValues" in data:
        ...
        out["allowed_values"] = (
            aws_sdk_launch_wizard.types.allowed_values.deserialize_json(
                data["allowedValues"]
            )
        )
    if "required" in data:
    ...
    if "conditionals" in data:
        ...
        out["conditionals"] = (
            aws_sdk_launch_wizard.types.specifications_conditional_data.deserialize_json(
                data["conditionals"]
            )
        )
    return out
