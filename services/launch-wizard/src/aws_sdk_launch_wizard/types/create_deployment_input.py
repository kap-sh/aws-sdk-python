...
def serialize_json(value: CreateDeploymentInput) -> dict:
    ...
    out["name"] = value["name"]
    import aws_sdk_launch_wizard.types.deployment_specifications
    out["specifications"] = aws_sdk_launch_wizard.types.deployment_specifications.serialize_json(value["specifications"])
...
def deserialize_json(data: dict) -> CreateDeploymentInput:
    ...
    if "deploymentPatternName" in data:
        ...
        raise DeserializationError("CreateDeploymentInput.deployment_pattern_name required")
    if "name" in data:
        out["name"] = data["name"]
    else:
    ...
    if "specifications" in data:
        import aws_sdk_launch_wizard.types.deployment_specifications
        out["specifications"] = aws_sdk_launch_wizard.types.deployment_specifications.deserialize_json(data["specifications"])
    else:
