...
from aws_sdk_launch_wizard._resources.launch_wizard.deployment import Deployment
from aws_sdk_launch_wizard._resources.launch_wizard.settings_set import SettingsSet
from aws_sdk_launch_wizard._resources.launch_wizard.workload import Workload
from aws_sdk_launch_wizard._services._aws_config import aws_config
...
class LaunchWizardClientConfig(TypedDict, total=False):
...
class LaunchWizardClient:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_launch_wizard.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_launch_wizard.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_launch_wizard._operations.launch_wizard.list_tags_for_resource.list_tags_for_resource(
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_launch_wizard.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_launch_wizard.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_launch_wizard._operations.launch_wizard.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_launch_wizard.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_launch_wizard.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_launch_wizard._operations.launch_wizard.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
