...
import capo_launch_wizard.errors.resource_limit_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceLimitException":
            raise capo_launch_wizard.errors.resource_limit_exception.ResourceLimitException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_launch_wizard.types.delete_deployment_output.DeleteDeploymentOutput = (
        capo_launch_wizard.types.delete_deployment_output.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_launch_wizard._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_launch_wizard.types.delete_deployment_input.serialize_json(input_)
    ).encode()
