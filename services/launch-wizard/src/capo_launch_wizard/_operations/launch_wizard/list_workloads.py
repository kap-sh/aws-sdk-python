"""Generated from Smithy shape ``com.amazonaws.launchwizard#ListWorkloads``."""
...
import capo_launch_wizard.types.workload_data_summary_list
...
def handle_response(
    ...
    out: capo_launch_wizard.types.list_workloads_output.ListWorkloadsOutput = (
        capo_launch_wizard.types.list_workloads_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_launch_wizard.types.list_workloads_input.serialize_json(input_)
    ).encode()
...
def list_workloads(
    ...
    capo_launch_wizard.types.list_workloads_output.ListWorkloadsOutput, zapros.Response
]:
