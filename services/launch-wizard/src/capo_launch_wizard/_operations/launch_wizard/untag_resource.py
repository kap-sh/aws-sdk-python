...
def handle_response(
    ...
    out: capo_launch_wizard.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_launch_wizard.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
