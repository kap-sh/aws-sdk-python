...
class LaunchWizardError(Exception):
    """Base class for all LaunchWizard service errors."""


class ServiceError(LaunchWizardError):
...
class SerializationError(LaunchWizardError):
    """Raised when a value cannot be serialized."""


class DeserializationError(LaunchWizardError):
...
class WaiterFailedError(LaunchWizardError):
...
class WaiterTimeoutError(LaunchWizardError):
