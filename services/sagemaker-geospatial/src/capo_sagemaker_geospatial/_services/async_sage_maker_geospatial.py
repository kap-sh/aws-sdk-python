...
class AsyncSageMakerGeospatialClientConfig(TypedDict, total=False, closed=True):
...
class AsyncSageMakerGeospatialClient:
    ...
    def __init__(
        ...
        self._config = AsyncSageMakerGeospatialClientConfig(
            {
        ...
        # resources
        self.earth_observation_job = AsyncEarthObservationJob(self)
        self.raster_data_collection = AsyncRasterDataCollection(self)
        self.vector_enrichment_job = AsyncVectorEnrichmentJob(self)

    def operation_options(
        self, config_overrides: Optional[AsyncSageMakerGeospatialClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncSageMakerGeospatialClientConfig = config_overrides or {}
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sagemaker_geospatial.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_sagemaker_geospatial.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sagemaker_geospatial._operations.sage_maker_geospatial.list_tags_for_resource.async_list_tags_for_resource(
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sagemaker_geospatial.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_sagemaker_geospatial.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sagemaker_geospatial._operations.sage_maker_geospatial.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sagemaker_geospatial.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_sagemaker_geospatial.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sagemaker_geospatial._operations.sage_maker_geospatial.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
