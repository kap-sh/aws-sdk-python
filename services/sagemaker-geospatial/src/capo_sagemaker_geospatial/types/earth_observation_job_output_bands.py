...
if TYPE_CHECKING:
    import capo_sagemaker_geospatial.types.output_band

EarthObservationJobOutputBands: TypeAlias = list[
    "capo_sagemaker_geospatial.types.output_band.OutputBand"
]
...
def serialize_json(value: EarthObservationJobOutputBands) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_sagemaker_geospatial.types.output_band.serialize_json(item))
    return out
