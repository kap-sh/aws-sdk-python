...
if TYPE_CHECKING:
    import capo_sagemaker_geospatial.types.earth_observation_job_error_type


class EarthObservationJobErrorDetails(TypedDict, closed=True):
    type: NotRequired[
        "capo_sagemaker_geospatial.types.earth_observation_job_error_type.EarthObservationJobErrorType"
    ]
