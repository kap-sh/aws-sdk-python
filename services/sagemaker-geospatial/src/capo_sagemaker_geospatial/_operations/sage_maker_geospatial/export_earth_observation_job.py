"""Generated from Smithy shape ``com.amazonaws.sagemakergeospatial#ExportEarthObservationJob``."""
...
import capo_sagemaker_geospatial.errors.conflict_exception
...
import capo_sagemaker_geospatial.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_sagemaker_geospatial.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_sagemaker_geospatial.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_sagemaker_geospatial.types.export_earth_observation_job_output.ExportEarthObservationJobOutput = capo_sagemaker_geospatial.types.export_earth_observation_job_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/export-earth-observation-job"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_sagemaker_geospatial.types.export_earth_observation_job_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_export_earth_observation_job(
