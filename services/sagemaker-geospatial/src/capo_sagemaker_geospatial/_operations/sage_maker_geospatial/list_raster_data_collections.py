...
import capo_sagemaker_geospatial.types.data_collections_list
...
def handle_response(
    ...
    out: capo_sagemaker_geospatial.types.list_raster_data_collections_output.ListRasterDataCollectionsOutput = capo_sagemaker_geospatial.types.list_raster_data_collections_output.deserialize_json(
