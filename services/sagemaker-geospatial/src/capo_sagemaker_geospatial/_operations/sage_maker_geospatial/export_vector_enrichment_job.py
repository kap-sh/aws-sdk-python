"""Generated from Smithy shape ``com.amazonaws.sagemakergeospatial#ExportVectorEnrichmentJob``."""
...
def handle_response(
    ...
    out: capo_sagemaker_geospatial.types.export_vector_enrichment_job_output.ExportVectorEnrichmentJobOutput = capo_sagemaker_geospatial.types.export_vector_enrichment_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker_geospatial.types.export_vector_enrichment_job_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_export_vector_enrichment_job(
