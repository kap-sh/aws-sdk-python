"""Generated from Smithy shape ``com.amazonaws.sagemakergeospatial#GetRasterDataCollection``."""
...
def handle_response(
    ...
    out: capo_sagemaker_geospatial.types.get_raster_data_collection_output.GetRasterDataCollectionOutput = capo_sagemaker_geospatial.types.get_raster_data_collection_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/raster-data-collection/{Arn}"
...
async def async_get_raster_data_collection(
