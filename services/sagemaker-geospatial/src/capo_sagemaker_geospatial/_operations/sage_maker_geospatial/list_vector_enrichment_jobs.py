...
def handle_response(
    ...
    out: capo_sagemaker_geospatial.types.list_vector_enrichment_job_output.ListVectorEnrichmentJobOutput = capo_sagemaker_geospatial.types.list_vector_enrichment_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker_geospatial.types.list_vector_enrichment_job_input.serialize_json(
            input_
        )
    ).encode()
