"""Generated from Smithy shape ``com.amazonaws.sagemakergeospatial#TagResource``."""
...
def handle_response(
    ...
    out: capo_sagemaker_geospatial.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker_geospatial.types.tag_resource_request.serialize_json(input_)
    ).encode()
