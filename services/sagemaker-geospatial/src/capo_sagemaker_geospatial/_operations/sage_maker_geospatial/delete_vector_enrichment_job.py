"""Generated from Smithy shape ``com.amazonaws.sagemakergeospatial#DeleteVectorEnrichmentJob``."""
...
def handle_response(
    ...
    out: capo_sagemaker_geospatial.types.delete_vector_enrichment_job_output.DeleteVectorEnrichmentJobOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/vector-enrichment-jobs/{Arn}"
...
async def async_delete_vector_enrichment_job(
