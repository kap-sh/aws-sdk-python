"""Generated from Smithy shape ``com.amazonaws.sagemakergeospatial#UntagResource``."""
...
def handle_response(
    ...
    out: capo_sagemaker_geospatial.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
