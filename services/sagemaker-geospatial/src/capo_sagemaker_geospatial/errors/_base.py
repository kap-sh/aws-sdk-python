...
class SageMakerGeospatialError(Exception):
    """Base class for all SageMakerGeospatial service errors."""


class ServiceError(SageMakerGeospatialError):
...
class SerializationError(SageMakerGeospatialError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SageMakerGeospatialError):
...
class WaiterFailedError(SageMakerGeospatialError):
...
class WaiterTimeoutError(SageMakerGeospatialError):
