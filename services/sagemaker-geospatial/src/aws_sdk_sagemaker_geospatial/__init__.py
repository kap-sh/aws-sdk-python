...
from ._services.async_sage_maker_geospatial import (
    AsyncSageMakerGeospatialClient as AsyncSageMakerGeospatialClient,
)
from ._services.sage_maker_geospatial import (
    SageMakerGeospatialClient as SageMakerGeospatialClient,
)
