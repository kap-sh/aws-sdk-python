...
def handle_response(
    ...
    out: aws_sdk_sagemaker_geospatial.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sagemaker_geospatial.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker_geospatial.types.tag_resource_request.serialize_json(input_)
    ).encode()
