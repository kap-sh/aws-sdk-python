...
def handle_response(
    ...
    out: aws_sdk_sagemaker_geospatial.types.search_raster_data_collection_output.SearchRasterDataCollectionOutput = aws_sdk_sagemaker_geospatial.types.search_raster_data_collection_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker_geospatial.types.search_raster_data_collection_input.SearchRasterDataCollectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker_geospatial.types.search_raster_data_collection_input.serialize_json(
            input_
        )
    ).encode()
