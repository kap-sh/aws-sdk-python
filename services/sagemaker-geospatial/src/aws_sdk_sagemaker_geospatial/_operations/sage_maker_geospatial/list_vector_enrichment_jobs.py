"""Generated from Smithy shape ``com.amazonaws.sagemakergeospatial#ListVectorEnrichmentJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_sagemaker_geospatial.types.list_vector_enrichment_job_output.ListVectorEnrichmentJobOutput = aws_sdk_sagemaker_geospatial.types.list_vector_enrichment_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker_geospatial.types.list_vector_enrichment_job_input.ListVectorEnrichmentJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-vector-enrichment-jobs"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_sagemaker_geospatial.types.list_vector_enrichment_job_input

    body: bytes | None = json.dumps(
        aws_sdk_sagemaker_geospatial.types.list_vector_enrichment_job_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_vector_enrichment_jobs(
