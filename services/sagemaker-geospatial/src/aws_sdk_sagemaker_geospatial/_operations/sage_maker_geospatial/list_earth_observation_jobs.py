...
def handle_response(
    ...
    out: aws_sdk_sagemaker_geospatial.types.list_earth_observation_job_output.ListEarthObservationJobOutput = aws_sdk_sagemaker_geospatial.types.list_earth_observation_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker_geospatial.types.list_earth_observation_job_input.ListEarthObservationJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker_geospatial.types.list_earth_observation_job_input.serialize_json(
            input_
        )
    ).encode()
