...
def handle_response(
    ...
    out: aws_sdk_sagemaker_geospatial.types.get_vector_enrichment_job_output.GetVectorEnrichmentJobOutput = aws_sdk_sagemaker_geospatial.types.get_vector_enrichment_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker_geospatial.types.get_vector_enrichment_job_input.GetVectorEnrichmentJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
