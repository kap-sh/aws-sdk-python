...
def handle_response(
    ...
    out: aws_sdk_sagemaker_geospatial.types.stop_vector_enrichment_job_output.StopVectorEnrichmentJobOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sagemaker_geospatial.types.stop_vector_enrichment_job_input.StopVectorEnrichmentJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker_geospatial.types.stop_vector_enrichment_job_input.serialize_json(
            input_
        )
    ).encode()
