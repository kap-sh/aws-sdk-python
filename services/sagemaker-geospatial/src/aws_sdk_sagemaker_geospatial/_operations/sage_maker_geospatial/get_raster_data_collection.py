...
def handle_response(
    ...
    out: aws_sdk_sagemaker_geospatial.types.get_raster_data_collection_output.GetRasterDataCollectionOutput = aws_sdk_sagemaker_geospatial.types.get_raster_data_collection_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker_geospatial.types.get_raster_data_collection_input.GetRasterDataCollectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
