...
def handle_response(
    ...
    out: aws_sdk_sagemaker_geospatial.types.start_vector_enrichment_job_output.StartVectorEnrichmentJobOutput = aws_sdk_sagemaker_geospatial.types.start_vector_enrichment_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker_geospatial.types.start_vector_enrichment_job_input.StartVectorEnrichmentJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemaker_geospatial.types.start_vector_enrichment_job_input.serialize_json(
            input_
        )
    ).encode()
