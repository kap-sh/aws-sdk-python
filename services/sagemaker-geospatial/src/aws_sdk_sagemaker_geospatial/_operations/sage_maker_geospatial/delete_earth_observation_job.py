"""Generated from Smithy shape ``com.amazonaws.sagemakergeospatial#DeleteEarthObservationJob``."""
...
def handle_response(
    ...
    out: aws_sdk_sagemaker_geospatial.types.delete_earth_observation_job_output.DeleteEarthObservationJobOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sagemaker_geospatial.types.delete_earth_observation_job_input.DeleteEarthObservationJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_earth_observation_job(
