"""Generated from Smithy shape ``com.amazonaws.sagemakergeospatial#ListRasterDataCollections``."""
...
def handle_response(
    ...
    out: aws_sdk_sagemaker_geospatial.types.list_raster_data_collections_output.ListRasterDataCollectionsOutput = aws_sdk_sagemaker_geospatial.types.list_raster_data_collections_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker_geospatial.types.list_raster_data_collections_input.ListRasterDataCollectionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/raster-data-collections"
    params: dict[str, str] = {}
...
async def async_list_raster_data_collections(
