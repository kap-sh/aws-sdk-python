"""Generated from Smithy shape ``com.amazonaws.sagemakergeospatial#GetEarthObservationJob``."""
...
def handle_response(
    ...
    out: aws_sdk_sagemaker_geospatial.types.get_earth_observation_job_output.GetEarthObservationJobOutput = aws_sdk_sagemaker_geospatial.types.get_earth_observation_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sagemaker_geospatial.types.get_earth_observation_job_input.GetEarthObservationJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/earth-observation-jobs/{Arn}"
...
async def async_get_earth_observation_job(
