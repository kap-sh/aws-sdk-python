...
def serialize_json(value: ExportEarthObservationJobInput) -> dict:
    ...
    import aws_sdk_sagemaker_geospatial.types.output_config_input
    out["OutputConfig"] = aws_sdk_sagemaker_geospatial.types.output_config_input.serialize_json(value["output_config"])
...
def deserialize_json(data: dict) -> ExportEarthObservationJobInput:
    ...
    if "ExecutionRoleArn" in data:
        ...
        raise DeserializationError("ExportEarthObservationJobInput.execution_role_arn required")
    if "OutputConfig" in data:
        import aws_sdk_sagemaker_geospatial.types.output_config_input
        out["output_config"] = aws_sdk_sagemaker_geospatial.types.output_config_input.deserialize_json(data["OutputConfig"])
    else:
        raise DeserializationError("ExportEarthObservationJobInput.output_config required")
