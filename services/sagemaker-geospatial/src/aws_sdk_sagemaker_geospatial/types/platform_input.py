...
if TYPE_CHECKING:
    import aws_sdk_sagemaker_geospatial.types.comparison_operator


class PlatformInput(TypedDict):
    value: "str"
    """<p>The value of the platform.</p>"""
    comparison_operator: NotRequired[
        "aws_sdk_sagemaker_geospatial.types.comparison_operator.ComparisonOperator"
    ]
