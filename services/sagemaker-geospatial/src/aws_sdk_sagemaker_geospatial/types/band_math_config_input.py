...
class BandMathConfigInput(TypedDict):
    predefined_indices: NotRequired["aws_sdk_sagemaker_geospatial.types.string_list_input.StringListInput"]
    ...
    custom_indices: NotRequired["aws_sdk_sagemaker_geospatial.types.custom_indices_input.CustomIndicesInput"]
...
def serialize_json(value: BandMathConfigInput) -> dict:
    ...
    if "predefined_indices" in value:
        import aws_sdk_sagemaker_geospatial.types.string_list_input
        out["PredefinedIndices"] = aws_sdk_sagemaker_geospatial.types.string_list_input.serialize_json(value["predefined_indices"])
    if "custom_indices" in value:
        import aws_sdk_sagemaker_geospatial.types.custom_indices_input
        out["CustomIndices"] = aws_sdk_sagemaker_geospatial.types.custom_indices_input.serialize_json(value["custom_indices"])
    return out
...
def deserialize_json(data: dict) -> BandMathConfigInput:
    ...
    if "PredefinedIndices" in data:
        import aws_sdk_sagemaker_geospatial.types.string_list_input
        out["predefined_indices"] = aws_sdk_sagemaker_geospatial.types.string_list_input.deserialize_json(data["PredefinedIndices"])
    if "CustomIndices" in data:
        import aws_sdk_sagemaker_geospatial.types.custom_indices_input
        out["custom_indices"] = aws_sdk_sagemaker_geospatial.types.custom_indices_input.deserialize_json(data["CustomIndices"])
    return out