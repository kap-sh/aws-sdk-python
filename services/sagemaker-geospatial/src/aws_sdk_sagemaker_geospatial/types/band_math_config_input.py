...
class BandMathConfigInput(TypedDict, closed=True):
    ...
    custom_indices: NotRequired[
        "aws_sdk_sagemaker_geospatial.types.custom_indices_input.CustomIndicesInput"
    ]
...
def serialize_json(value: BandMathConfigInput) -> dict:
    ...
    if "custom_indices" in value:
        ...
        out["CustomIndices"] = (
            aws_sdk_sagemaker_geospatial.types.custom_indices_input.serialize_json(
...
def deserialize_json(data: dict) -> BandMathConfigInput:
    ...
    if "CustomIndices" in data:
        ...
        out["custom_indices"] = (
            aws_sdk_sagemaker_geospatial.types.custom_indices_input.deserialize_json(
                data["CustomIndices"]
            )
        )
    return out
