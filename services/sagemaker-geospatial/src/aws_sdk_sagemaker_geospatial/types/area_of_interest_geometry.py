...
class _AreaOfInterestGeometry_PolygonGeometry(TypedDict):
    PolygonGeometry: "aws_sdk_sagemaker_geospatial.types.polygon_geometry_input.PolygonGeometryInput"
...
AreaOfInterestGeometry: TypeAlias = _AreaOfInterestGeometry_PolygonGeometry | _AreaOfInterestGeometry_MultiPolygonGeometry

# --- restJson1 ser/de ---
def serialize_json(value: AreaOfInterestGeometry) -> dict:
    if "PolygonGeometry" in value:
        import aws_sdk_sagemaker_geospatial.types.polygon_geometry_input
        return {"PolygonGeometry": aws_sdk_sagemaker_geospatial.types.polygon_geometry_input.serialize_json(value["PolygonGeometry"])}
    elif "MultiPolygonGeometry" in value:
        import aws_sdk_sagemaker_geospatial.types.multi_polygon_geometry_input
        return {"MultiPolygonGeometry": aws_sdk_sagemaker_geospatial.types.multi_polygon_geometry_input.serialize_json(value["MultiPolygonGeometry"])}
    else:
...
def deserialize_json(data: dict) -> AreaOfInterestGeometry:
    if "PolygonGeometry" in data:
        import aws_sdk_sagemaker_geospatial.types.polygon_geometry_input
        return {"PolygonGeometry": aws_sdk_sagemaker_geospatial.types.polygon_geometry_input.deserialize_json(data["PolygonGeometry"])}
    elif "MultiPolygonGeometry" in data:
        import aws_sdk_sagemaker_geospatial.types.multi_polygon_geometry_input
        return {"MultiPolygonGeometry": aws_sdk_sagemaker_geospatial.types.multi_polygon_geometry_input.deserialize_json(data["MultiPolygonGeometry"])}
    else:
