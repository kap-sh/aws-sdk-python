...
```
pip install aws-sdk-sagemaker-geospatial
```

## Usage

```python
from aws_sdk_sagemaker_geospatial import AsyncSageMakerGeospatialClient


async def main():
    async with AsyncSageMakerGeospatialClient() as s3:
...
```python
from aws_sdk_sagemaker_geospatial import AsyncSageMakerGeospatialClient
from aws_sdk_sagemaker_geospatial.error import AccessDeniedException
