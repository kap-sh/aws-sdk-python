"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteClusterSubnetGroup``."""
...
import aws_sdk_redshift.errors.invalid_cluster_subnet_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidClusterSubnetStateFault":
            raise aws_sdk_redshift.errors.invalid_cluster_subnet_state_fault.InvalidClusterSubnetStateFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_cluster_subnet_group_message.DeleteClusterSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteClusterSubnetGroup"))
    pairs.append(("Version", "2012-12-01"))
    aws_sdk_redshift.types.delete_cluster_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_cluster_subnet_group(
