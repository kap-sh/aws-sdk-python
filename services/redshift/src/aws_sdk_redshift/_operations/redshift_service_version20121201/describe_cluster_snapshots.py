...
def handle_response(
    ...
    out: aws_sdk_redshift.types.snapshot_message.SnapshotMessage = (
        aws_sdk_redshift.types.snapshot_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_cluster_snapshots_message.DescribeClusterSnapshotsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_cluster_snapshots_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_cluster_snapshots(
    ...
    input_: aws_sdk_redshift.types.describe_cluster_snapshots_message.DescribeClusterSnapshotsMessage,
) -> tuple[aws_sdk_redshift.types.snapshot_message.SnapshotMessage, zapros.Response]:
