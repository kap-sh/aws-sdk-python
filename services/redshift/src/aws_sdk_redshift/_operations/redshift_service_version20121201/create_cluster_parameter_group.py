"""Generated from Smithy shape ``com.amazonaws.redshift#CreateClusterParameterGroup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ClusterParameterGroupAlreadyExistsFault":
            import aws_sdk_redshift.errors.cluster_parameter_group_already_exists_fault

            raise aws_sdk_redshift.errors.cluster_parameter_group_already_exists_fault.ClusterParameterGroupAlreadyExistsFault.from_query(
                root
            )
        case "ClusterParameterGroupQuotaExceededFault":
            import aws_sdk_redshift.errors.cluster_parameter_group_quota_exceeded_fault

            raise aws_sdk_redshift.errors.cluster_parameter_group_quota_exceeded_fault.ClusterParameterGroupQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateClusterParameterGroupResult")
    out: aws_sdk_redshift.types.create_cluster_parameter_group_result.CreateClusterParameterGroupResult = aws_sdk_redshift.types.create_cluster_parameter_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.create_cluster_parameter_group_message.CreateClusterParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateClusterParameterGroup"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.create_cluster_parameter_group_message

    aws_sdk_redshift.types.create_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_cluster_parameter_group(
