...
def handle_response(
    ...
    out: aws_sdk_redshift.types.pause_cluster_result.PauseClusterResult = (
        aws_sdk_redshift.types.pause_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.pause_cluster_message.PauseClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.pause_cluster_message.serialize_query(input_, pairs, "")
...
def pause_cluster(
    ...
    aws_sdk_redshift.types.pause_cluster_result.PauseClusterResult, zapros.Response
]:
