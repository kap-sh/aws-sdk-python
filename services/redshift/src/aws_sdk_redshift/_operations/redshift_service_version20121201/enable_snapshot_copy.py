...
import aws_sdk_redshift.errors.copy_to_region_disabled_fault
import aws_sdk_redshift.errors.dependent_service_request_throttling_fault
import aws_sdk_redshift.errors.incompatible_orderable_options
...
import aws_sdk_redshift.errors.snapshot_copy_already_enabled_fault
import aws_sdk_redshift.errors.snapshot_copy_grant_not_found_fault
import aws_sdk_redshift.errors.unauthorized_operation
import aws_sdk_redshift.errors.unknown_snapshot_copy_region_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CopyToRegionDisabledFault":
            raise aws_sdk_redshift.errors.copy_to_region_disabled_fault.CopyToRegionDisabledFault.from_query(
                root
            )
        ...
        case "IncompatibleOrderableOptions":
            raise aws_sdk_redshift.errors.incompatible_orderable_options.IncompatibleOrderableOptions.from_query(
                root
            )
        ...
        case "SnapshotCopyAlreadyEnabledFault":
            raise aws_sdk_redshift.errors.snapshot_copy_already_enabled_fault.SnapshotCopyAlreadyEnabledFault.from_query(
                root
            )
        case "SnapshotCopyGrantNotFoundFault":
            raise aws_sdk_redshift.errors.snapshot_copy_grant_not_found_fault.SnapshotCopyGrantNotFoundFault.from_query(
                root
            )
        ...
        case "UnknownSnapshotCopyRegionFault":
            raise aws_sdk_redshift.errors.unknown_snapshot_copy_region_fault.UnknownSnapshotCopyRegionFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.enable_snapshot_copy_result.EnableSnapshotCopyResult = (
        aws_sdk_redshift.types.enable_snapshot_copy_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.enable_snapshot_copy_message.EnableSnapshotCopyMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.enable_snapshot_copy_message.serialize_query(
        input_, pairs, ""
    )
