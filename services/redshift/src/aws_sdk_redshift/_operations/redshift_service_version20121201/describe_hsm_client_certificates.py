...
import aws_sdk_redshift.types.hsm_client_certificate_list
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.hsm_client_certificate_message.HsmClientCertificateMessage = aws_sdk_redshift.types.hsm_client_certificate_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_hsm_client_certificates_message.DescribeHsmClientCertificatesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
