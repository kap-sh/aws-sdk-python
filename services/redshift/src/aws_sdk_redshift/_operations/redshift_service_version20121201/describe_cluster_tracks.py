...
def handle_response(
    ...
    out: aws_sdk_redshift.types.track_list_message.TrackListMessage = (
        aws_sdk_redshift.types.track_list_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_cluster_tracks_message.DescribeClusterTracksMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_cluster_tracks_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_cluster_tracks(
    ...
    input_: aws_sdk_redshift.types.describe_cluster_tracks_message.DescribeClusterTracksMessage,
) -> tuple[aws_sdk_redshift.types.track_list_message.TrackListMessage, zapros.Response]:
