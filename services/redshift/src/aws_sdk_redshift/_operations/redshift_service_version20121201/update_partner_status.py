...
import aws_sdk_redshift.errors.partner_not_found_fault
import aws_sdk_redshift.errors.unauthorized_partner_integration_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PartnerNotFoundFault":
            raise aws_sdk_redshift.errors.partner_not_found_fault.PartnerNotFoundFault.from_query(
                root
            )
        case "UnauthorizedPartnerIntegrationFault":
            raise aws_sdk_redshift.errors.unauthorized_partner_integration_fault.UnauthorizedPartnerIntegrationFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.partner_integration_output_message.PartnerIntegrationOutputMessage = aws_sdk_redshift.types.partner_integration_output_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.update_partner_status_input_message.UpdatePartnerStatusInputMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.update_partner_status_input_message.serialize_query(
        input_, pairs, ""
    )
