...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SnapshotCopyAlreadyDisabledFault":
            import aws_sdk_redshift.errors.snapshot_copy_already_disabled_fault

            raise aws_sdk_redshift.errors.snapshot_copy_already_disabled_fault.SnapshotCopyAlreadyDisabledFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.disable_snapshot_copy_result.DisableSnapshotCopyResult = aws_sdk_redshift.types.disable_snapshot_copy_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.disable_snapshot_copy_message.DisableSnapshotCopyMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.disable_snapshot_copy_message.serialize_query(
        input_, pairs, ""
    )
