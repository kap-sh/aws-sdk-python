...
def build_request(
    ...
    input: aws_sdk_redshift.types.describe_clusters_message.DescribeClustersMessage,
) -> zapros.Request:
    ...
    aws_sdk_redshift.types.describe_clusters_message.serialize_query(input, pairs, "")
