...
def handle_response(
    ...
    out: aws_sdk_redshift.types.clusters_message.ClustersMessage = (
        aws_sdk_redshift.types.clusters_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_clusters_message.DescribeClustersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_clusters_message.serialize_query(input_, pairs, "")
...
def describe_clusters(
    ...
    input_: aws_sdk_redshift.types.describe_clusters_message.DescribeClustersMessage,
) -> tuple[aws_sdk_redshift.types.clusters_message.ClustersMessage, zapros.Response]:
