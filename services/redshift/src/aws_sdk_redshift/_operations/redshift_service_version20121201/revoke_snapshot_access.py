"""Generated from Smithy shape ``com.amazonaws.redshift#RevokeSnapshotAccess``."""
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.revoke_snapshot_access_message.RevokeSnapshotAccessMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RevokeSnapshotAccess"))
    pairs.append(("Version", "2012-12-01"))
    aws_sdk_redshift.types.revoke_snapshot_access_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_revoke_snapshot_access(
