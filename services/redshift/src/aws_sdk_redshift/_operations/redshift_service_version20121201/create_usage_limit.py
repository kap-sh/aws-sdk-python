...
def build_request(
    ...
    input: aws_sdk_redshift.types.create_usage_limit_message.CreateUsageLimitMessage,
) -> zapros.Request:
    ...
    aws_sdk_redshift.types.create_usage_limit_message.serialize_query(input, pairs, "")
