...
import aws_sdk_redshift.errors.invalid_usage_limit_fault
...
import aws_sdk_redshift.errors.usage_limit_already_exists_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidUsageLimitFault":
            raise aws_sdk_redshift.errors.invalid_usage_limit_fault.InvalidUsageLimitFault.from_query(
                root
            )
        ...
        case "UsageLimitAlreadyExistsFault":
            raise aws_sdk_redshift.errors.usage_limit_already_exists_fault.UsageLimitAlreadyExistsFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.usage_limit.UsageLimit = (
        aws_sdk_redshift.types.usage_limit.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.create_usage_limit_message.CreateUsageLimitMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.create_usage_limit_message.serialize_query(input_, pairs, "")
...
def create_usage_limit(
    ...
    input_: aws_sdk_redshift.types.create_usage_limit_message.CreateUsageLimitMessage,
) -> tuple[aws_sdk_redshift.types.usage_limit.UsageLimit, zapros.Response]:
