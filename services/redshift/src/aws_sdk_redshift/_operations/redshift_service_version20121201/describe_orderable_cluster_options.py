"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeOrderableClusterOptions``."""
...
import aws_sdk_redshift.types.orderable_cluster_options_list
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeOrderableClusterOptionsResult")
    out: aws_sdk_redshift.types.orderable_cluster_options_message.OrderableClusterOptionsMessage = aws_sdk_redshift.types.orderable_cluster_options_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_orderable_cluster_options_message.DescribeOrderableClusterOptionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_orderable_cluster_options(
