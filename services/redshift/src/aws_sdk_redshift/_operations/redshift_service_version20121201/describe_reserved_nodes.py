...
def handle_response(
    ...
    out: aws_sdk_redshift.types.reserved_nodes_message.ReservedNodesMessage = (
        aws_sdk_redshift.types.reserved_nodes_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_reserved_nodes_message.DescribeReservedNodesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_reserved_nodes_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_reserved_nodes(
    ...
    aws_sdk_redshift.types.reserved_nodes_message.ReservedNodesMessage, zapros.Response
]:
