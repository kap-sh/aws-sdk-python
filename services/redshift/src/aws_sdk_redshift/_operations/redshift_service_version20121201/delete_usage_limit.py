"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteUsageLimit``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UsageLimitNotFoundFault":
            import aws_sdk_redshift.errors.usage_limit_not_found_fault

            raise aws_sdk_redshift.errors.usage_limit_not_found_fault.UsageLimitNotFoundFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_usage_limit_message.DeleteUsageLimitMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteUsageLimit"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.delete_usage_limit_message

    aws_sdk_redshift.types.delete_usage_limit_message.serialize_query(input_, pairs, "")
