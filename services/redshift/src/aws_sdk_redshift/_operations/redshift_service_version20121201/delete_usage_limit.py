...
def build_request(
    ...
    input: aws_sdk_redshift.types.delete_usage_limit_message.DeleteUsageLimitMessage,
) -> zapros.Request:
    ...
    aws_sdk_redshift.types.delete_usage_limit_message.serialize_query(input, pairs, "")
