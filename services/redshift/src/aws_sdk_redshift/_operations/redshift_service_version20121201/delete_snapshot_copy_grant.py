...
import aws_sdk_redshift.errors.invalid_snapshot_copy_grant_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidSnapshotCopyGrantStateFault":
            raise aws_sdk_redshift.errors.invalid_snapshot_copy_grant_state_fault.InvalidSnapshotCopyGrantStateFault.from_query(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_snapshot_copy_grant_message.DeleteSnapshotCopyGrantMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
