...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RedshiftInvalidParameterFault":
            import aws_sdk_redshift.errors.redshift_invalid_parameter_fault

            raise aws_sdk_redshift.errors.redshift_invalid_parameter_fault.RedshiftInvalidParameterFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.get_identity_center_auth_token_response.GetIdentityCenterAuthTokenResponse = aws_sdk_redshift.types.get_identity_center_auth_token_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.get_identity_center_auth_token_request.GetIdentityCenterAuthTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
