"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeEventCategories``."""
...
import aws_sdk_redshift.types.event_categories_map_list
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.event_categories_message.EventCategoriesMessage = (
        aws_sdk_redshift.types.event_categories_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_event_categories_message.DescribeEventCategoriesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_event_categories_message.serialize_query(
        input_, pairs, ""
    )
