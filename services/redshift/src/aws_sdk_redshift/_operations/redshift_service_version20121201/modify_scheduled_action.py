...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_scheduled_action_message.ModifyScheduledActionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.modify_scheduled_action_message.serialize_query(
        input_, pairs, ""
    )
