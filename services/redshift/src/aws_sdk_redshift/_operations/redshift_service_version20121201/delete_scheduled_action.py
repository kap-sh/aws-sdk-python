"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteScheduledAction``."""
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_scheduled_action_message.DeleteScheduledActionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.delete_scheduled_action_message.serialize_query(
        input_, pairs, ""
    )
