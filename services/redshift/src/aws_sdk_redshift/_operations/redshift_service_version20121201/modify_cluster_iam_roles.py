...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_cluster_iam_roles_message.ModifyClusterIamRolesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.modify_cluster_iam_roles_message.serialize_query(
        input_, pairs, ""
    )
