"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyClusterSubnetGroup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ClusterSubnetQuotaExceededFault":
            import aws_sdk_redshift.errors.cluster_subnet_quota_exceeded_fault

            raise aws_sdk_redshift.errors.cluster_subnet_quota_exceeded_fault.ClusterSubnetQuotaExceededFault.from_query(
                root
            )
        ...
        case "SubnetAlreadyInUse":
            import aws_sdk_redshift.errors.subnet_already_in_use

            raise aws_sdk_redshift.errors.subnet_already_in_use.SubnetAlreadyInUse.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyClusterSubnetGroupResult")
    out: aws_sdk_redshift.types.modify_cluster_subnet_group_result.ModifyClusterSubnetGroupResult = aws_sdk_redshift.types.modify_cluster_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_cluster_subnet_group_message.ModifyClusterSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyClusterSubnetGroup"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.modify_cluster_subnet_group_message

    aws_sdk_redshift.types.modify_cluster_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_cluster_subnet_group(
