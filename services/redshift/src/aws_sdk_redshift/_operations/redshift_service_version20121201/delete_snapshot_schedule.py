...
import aws_sdk_redshift.errors.invalid_cluster_snapshot_schedule_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidClusterSnapshotScheduleStateFault":
            raise aws_sdk_redshift.errors.invalid_cluster_snapshot_schedule_state_fault.InvalidClusterSnapshotScheduleStateFault.from_query(
                root
            )
