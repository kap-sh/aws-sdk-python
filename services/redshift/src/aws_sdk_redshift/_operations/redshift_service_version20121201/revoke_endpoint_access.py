...
def build_request(
    ...
    input_: aws_sdk_redshift.types.revoke_endpoint_access_message.RevokeEndpointAccessMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.revoke_endpoint_access_message.serialize_query(
        input_, pairs, ""
    )
