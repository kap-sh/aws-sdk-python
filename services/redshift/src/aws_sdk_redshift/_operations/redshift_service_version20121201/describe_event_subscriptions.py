...
def handle_response(
    ...
    out: aws_sdk_redshift.types.event_subscriptions_message.EventSubscriptionsMessage = aws_sdk_redshift.types.event_subscriptions_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_event_subscriptions_message.DescribeEventSubscriptionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
