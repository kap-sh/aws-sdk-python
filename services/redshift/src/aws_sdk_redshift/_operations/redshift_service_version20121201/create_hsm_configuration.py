...
def build_request(
    ...
    input_: aws_sdk_redshift.types.create_hsm_configuration_message.CreateHsmConfigurationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.create_hsm_configuration_message.serialize_query(
        input_, pairs, ""
    )
