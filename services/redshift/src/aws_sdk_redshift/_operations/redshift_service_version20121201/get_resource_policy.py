...
def handle_response(
    ...
    out: aws_sdk_redshift.types.get_resource_policy_result.GetResourcePolicyResult = (
        aws_sdk_redshift.types.get_resource_policy_result.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_redshift.types.get_resource_policy_message.GetResourcePolicyMessage,
) -> zapros.Request:
    ...
    aws_sdk_redshift.types.get_resource_policy_message.serialize_query(input, pairs, "")
