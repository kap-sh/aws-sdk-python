...
def handle_response(
    ...
    out: aws_sdk_redshift.types.describe_data_shares_for_producer_result.DescribeDataSharesForProducerResult = aws_sdk_redshift.types.describe_data_shares_for_producer_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_data_shares_for_producer_message.DescribeDataSharesForProducerMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
