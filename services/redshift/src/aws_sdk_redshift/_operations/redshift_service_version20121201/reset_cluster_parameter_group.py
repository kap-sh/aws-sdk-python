"""Generated from Smithy shape ``com.amazonaws.redshift#ResetClusterParameterGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ResetClusterParameterGroupResult")
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.reset_cluster_parameter_group_message.ResetClusterParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ResetClusterParameterGroup"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.reset_cluster_parameter_group_message

    aws_sdk_redshift.types.reset_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_reset_cluster_parameter_group(
