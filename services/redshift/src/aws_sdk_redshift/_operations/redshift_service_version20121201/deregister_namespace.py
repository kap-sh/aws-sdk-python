...
def handle_response(
    ...
    out: aws_sdk_redshift.types.deregister_namespace_output_message.DeregisterNamespaceOutputMessage = aws_sdk_redshift.types.deregister_namespace_output_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.deregister_namespace_input_message.DeregisterNamespaceInputMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.deregister_namespace_input_message.serialize_query(
        input_, pairs, ""
    )
