...
def handle_response(
    ...
    out: aws_sdk_redshift.types.rotate_encryption_key_result.RotateEncryptionKeyResult = aws_sdk_redshift.types.rotate_encryption_key_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.rotate_encryption_key_message.RotateEncryptionKeyMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.rotate_encryption_key_message.serialize_query(
        input_, pairs, ""
    )
