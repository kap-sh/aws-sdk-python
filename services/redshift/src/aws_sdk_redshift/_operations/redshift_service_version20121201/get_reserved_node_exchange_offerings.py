...
def handle_response(
    ...
    out: aws_sdk_redshift.types.get_reserved_node_exchange_offerings_output_message.GetReservedNodeExchangeOfferingsOutputMessage = aws_sdk_redshift.types.get_reserved_node_exchange_offerings_output_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.get_reserved_node_exchange_offerings_input_message.GetReservedNodeExchangeOfferingsInputMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.get_reserved_node_exchange_offerings_input_message.serialize_query(
        input_, pairs, ""
    )
