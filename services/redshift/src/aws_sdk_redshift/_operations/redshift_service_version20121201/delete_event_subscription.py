"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteEventSubscription``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidSubscriptionStateFault":
            import aws_sdk_redshift.errors.invalid_subscription_state_fault

            raise aws_sdk_redshift.errors.invalid_subscription_state_fault.InvalidSubscriptionStateFault.from_query(
                root
            )
        case "SubscriptionNotFoundFault":
            import aws_sdk_redshift.errors.subscription_not_found_fault

            raise aws_sdk_redshift.errors.subscription_not_found_fault.SubscriptionNotFoundFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_event_subscription_message.DeleteEventSubscriptionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.delete_event_subscription_message.serialize_query(
        input_, pairs, ""
    )
