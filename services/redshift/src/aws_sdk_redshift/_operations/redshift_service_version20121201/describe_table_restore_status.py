...
import aws_sdk_redshift.errors.table_restore_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TableRestoreNotFoundFault":
            raise aws_sdk_redshift.errors.table_restore_not_found_fault.TableRestoreNotFoundFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.table_restore_status_message.TableRestoreStatusMessage = aws_sdk_redshift.types.table_restore_status_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_table_restore_status_message.DescribeTableRestoreStatusMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_table_restore_status_message.serialize_query(
        input_, pairs, ""
    )
