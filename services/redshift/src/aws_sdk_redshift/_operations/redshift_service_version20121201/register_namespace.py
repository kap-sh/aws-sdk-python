"""Generated from Smithy shape ``com.amazonaws.redshift#RegisterNamespace``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("RegisterNamespaceResult")
    out: aws_sdk_redshift.types.register_namespace_output_message.RegisterNamespaceOutputMessage = aws_sdk_redshift.types.register_namespace_output_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.register_namespace_input_message.RegisterNamespaceInputMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RegisterNamespace"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.register_namespace_input_message

    aws_sdk_redshift.types.register_namespace_input_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_register_namespace(
