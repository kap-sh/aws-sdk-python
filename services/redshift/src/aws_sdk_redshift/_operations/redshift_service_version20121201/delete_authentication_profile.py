...
def handle_response(
    ...
    out: aws_sdk_redshift.types.delete_authentication_profile_result.DeleteAuthenticationProfileResult = aws_sdk_redshift.types.delete_authentication_profile_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_authentication_profile_message.DeleteAuthenticationProfileMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.delete_authentication_profile_message.serialize_query(
        input_, pairs, ""
    )
