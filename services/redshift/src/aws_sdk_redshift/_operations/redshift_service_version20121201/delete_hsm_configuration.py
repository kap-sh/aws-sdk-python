...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_hsm_configuration_message.DeleteHsmConfigurationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.delete_hsm_configuration_message.serialize_query(
        input_, pairs, ""
    )
