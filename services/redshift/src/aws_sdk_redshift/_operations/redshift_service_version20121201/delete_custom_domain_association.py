"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteCustomDomainAssociation``."""
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_custom_domain_association_message.DeleteCustomDomainAssociationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
