...
def handle_response(
    ...
    out: aws_sdk_redshift.types.cluster_versions_message.ClusterVersionsMessage = (
        aws_sdk_redshift.types.cluster_versions_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_cluster_versions_message.DescribeClusterVersionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
