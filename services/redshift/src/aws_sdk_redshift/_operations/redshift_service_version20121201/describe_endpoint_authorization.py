...
def handle_response(
    ...
    out: aws_sdk_redshift.types.endpoint_authorization_list.EndpointAuthorizationList = aws_sdk_redshift.types.endpoint_authorization_list.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_endpoint_authorization_message.DescribeEndpointAuthorizationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_endpoint_authorization_message.serialize_query(
        input_, pairs, ""
    )
