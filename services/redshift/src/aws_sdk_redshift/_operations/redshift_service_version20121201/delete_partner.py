...
def build_request(
    ...
    input_: aws_sdk_redshift.types.partner_integration_input_message.PartnerIntegrationInputMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.partner_integration_input_message.serialize_query(
        input_, pairs, ""
    )
