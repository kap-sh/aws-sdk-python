"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeInboundIntegrations``."""
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_inbound_integrations_message.DescribeInboundIntegrationsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeInboundIntegrations"))
    pairs.append(("Version", "2012-12-01"))
    aws_sdk_redshift.types.describe_inbound_integrations_message.serialize_query(
        input_, pairs, ""
    )
