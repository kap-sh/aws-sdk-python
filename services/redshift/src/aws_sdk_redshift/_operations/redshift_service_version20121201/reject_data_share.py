...
def build_request(
    ...
    input: aws_sdk_redshift.types.reject_data_share_message.RejectDataShareMessage,
) -> zapros.Request:
    ...
    aws_sdk_redshift.types.reject_data_share_message.serialize_query(input, pairs, "")
