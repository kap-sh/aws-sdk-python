...
def handle_response(
    ...
    out: aws_sdk_redshift.types.cluster_parameter_group_details.ClusterParameterGroupDetails = aws_sdk_redshift.types.cluster_parameter_group_details.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_cluster_parameters_message.DescribeClusterParametersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_cluster_parameters_message.serialize_query(
        input_, pairs, ""
    )
