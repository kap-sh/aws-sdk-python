"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyClusterMaintenance``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyClusterMaintenanceResult")
    out: aws_sdk_redshift.types.modify_cluster_maintenance_result.ModifyClusterMaintenanceResult = aws_sdk_redshift.types.modify_cluster_maintenance_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_cluster_maintenance_message.ModifyClusterMaintenanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyClusterMaintenance"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.modify_cluster_maintenance_message

    aws_sdk_redshift.types.modify_cluster_maintenance_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_cluster_maintenance(
