...
def handle_response(
    ...
    out: aws_sdk_redshift.types.custom_domain_associations_message.CustomDomainAssociationsMessage = aws_sdk_redshift.types.custom_domain_associations_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_custom_domain_associations_message.DescribeCustomDomainAssociationsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_custom_domain_associations_message.serialize_query(
        input_, pairs, ""
    )
