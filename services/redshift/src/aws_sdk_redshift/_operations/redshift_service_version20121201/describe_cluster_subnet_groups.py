...
def handle_response(
    ...
    out: aws_sdk_redshift.types.cluster_subnet_group_message.ClusterSubnetGroupMessage = aws_sdk_redshift.types.cluster_subnet_group_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_cluster_subnet_groups_message.DescribeClusterSubnetGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_cluster_subnet_groups_message.serialize_query(
        input_, pairs, ""
    )
