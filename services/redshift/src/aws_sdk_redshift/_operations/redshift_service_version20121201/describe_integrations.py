...
def handle_response(
    ...
    out: aws_sdk_redshift.types.integrations_message.IntegrationsMessage = (
        aws_sdk_redshift.types.integrations_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_integrations_message.DescribeIntegrationsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_integrations_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_integrations(
    ...
    aws_sdk_redshift.types.integrations_message.IntegrationsMessage, zapros.Response
]:
