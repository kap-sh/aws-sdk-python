...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_logging_status_message.DescribeLoggingStatusMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_logging_status_message.serialize_query(
        input_, pairs, ""
    )
