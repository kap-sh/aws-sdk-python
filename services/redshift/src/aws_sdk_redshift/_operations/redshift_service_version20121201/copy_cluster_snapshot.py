"""Generated from Smithy shape ``com.amazonaws.redshift#CopyClusterSnapshot``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CopyClusterSnapshotResult")
    out: aws_sdk_redshift.types.copy_cluster_snapshot_result.CopyClusterSnapshotResult = aws_sdk_redshift.types.copy_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.copy_cluster_snapshot_message.CopyClusterSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CopyClusterSnapshot"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.copy_cluster_snapshot_message

    aws_sdk_redshift.types.copy_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
