...
def handle_response(
    ...
    out: aws_sdk_redshift.types.list_recommendations_result.ListRecommendationsResult = aws_sdk_redshift.types.list_recommendations_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.list_recommendations_message.ListRecommendationsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.list_recommendations_message.serialize_query(
        input_, pairs, ""
    )
