...
def handle_response(
    ...
    out: aws_sdk_redshift.types.delete_cluster_result.DeleteClusterResult = (
        aws_sdk_redshift.types.delete_cluster_result.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_redshift.types.delete_cluster_message.DeleteClusterMessage,
) -> zapros.Request:
    ...
    aws_sdk_redshift.types.delete_cluster_message.serialize_query(input, pairs, "")
...
def delete_cluster(
    ...
    aws_sdk_redshift.types.delete_cluster_result.DeleteClusterResult, zapros.Response
]:
