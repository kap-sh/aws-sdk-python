...
def handle_response(
    ...
    out: aws_sdk_redshift.types.endpoint_access_list.EndpointAccessList = (
        aws_sdk_redshift.types.endpoint_access_list.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_endpoint_access_message.DescribeEndpointAccessMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_endpoint_access_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_endpoint_access(
    ...
    aws_sdk_redshift.types.endpoint_access_list.EndpointAccessList, zapros.Response
]:
