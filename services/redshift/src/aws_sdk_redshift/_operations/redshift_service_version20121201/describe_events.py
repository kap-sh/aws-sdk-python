"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeEvents``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.events_message.EventsMessage = (
        aws_sdk_redshift.types.events_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_events_message.DescribeEventsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_events_message.serialize_query(input_, pairs, "")
...
def describe_events(
    ...
    input_: aws_sdk_redshift.types.describe_events_message.DescribeEventsMessage,
) -> tuple[aws_sdk_redshift.types.events_message.EventsMessage, zapros.Response]:
