...
def handle_response(
    ...
    out: aws_sdk_redshift.types.authorize_cluster_security_group_ingress_result.AuthorizeClusterSecurityGroupIngressResult = aws_sdk_redshift.types.authorize_cluster_security_group_ingress_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.authorize_cluster_security_group_ingress_message.AuthorizeClusterSecurityGroupIngressMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.authorize_cluster_security_group_ingress_message.serialize_query(
        input_, pairs, ""
    )
