...
def build_request(
    ...
    input_: aws_sdk_redshift.types.disassociate_data_share_consumer_message.DisassociateDataShareConsumerMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.disassociate_data_share_consumer_message.serialize_query(
        input_, pairs, ""
    )
