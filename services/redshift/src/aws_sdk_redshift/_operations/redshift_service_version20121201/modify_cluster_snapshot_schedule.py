...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_cluster_snapshot_schedule_message.ModifyClusterSnapshotScheduleMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.modify_cluster_snapshot_schedule_message.serialize_query(
        input_, pairs, ""
    )
