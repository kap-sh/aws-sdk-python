...
def handle_response(
    ...
    out: aws_sdk_redshift.types.cluster_extended_credentials.ClusterExtendedCredentials = aws_sdk_redshift.types.cluster_extended_credentials.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.get_cluster_credentials_with_iam_message.GetClusterCredentialsWithIAMMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
