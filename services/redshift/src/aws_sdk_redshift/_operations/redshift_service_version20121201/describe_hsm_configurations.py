"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeHsmConfigurations``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeHsmConfigurationsResult")
    out: aws_sdk_redshift.types.hsm_configuration_message.HsmConfigurationMessage = (
        aws_sdk_redshift.types.hsm_configuration_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_hsm_configurations_message.DescribeHsmConfigurationsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeHsmConfigurations"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.describe_hsm_configurations_message

    aws_sdk_redshift.types.describe_hsm_configurations_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_hsm_configurations(
