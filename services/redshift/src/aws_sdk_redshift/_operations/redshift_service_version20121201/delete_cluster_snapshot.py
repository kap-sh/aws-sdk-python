...
def handle_response(
    ...
    out: aws_sdk_redshift.types.delete_cluster_snapshot_result.DeleteClusterSnapshotResult = aws_sdk_redshift.types.delete_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_cluster_snapshot_message.DeleteClusterSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
