"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyClusterParameterGroup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidClusterParameterGroupStateFault":
            import aws_sdk_redshift.errors.invalid_cluster_parameter_group_state_fault

            raise aws_sdk_redshift.errors.invalid_cluster_parameter_group_state_fault.InvalidClusterParameterGroupStateFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyClusterParameterGroupResult")
    out: aws_sdk_redshift.types.cluster_parameter_group_name_message.ClusterParameterGroupNameMessage = aws_sdk_redshift.types.cluster_parameter_group_name_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_cluster_parameter_group_message.ModifyClusterParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyClusterParameterGroup"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.modify_cluster_parameter_group_message

    aws_sdk_redshift.types.modify_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_cluster_parameter_group(
