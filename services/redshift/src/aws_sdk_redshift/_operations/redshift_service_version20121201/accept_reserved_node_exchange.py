...
def handle_response(
    ...
    out: aws_sdk_redshift.types.accept_reserved_node_exchange_output_message.AcceptReservedNodeExchangeOutputMessage = aws_sdk_redshift.types.accept_reserved_node_exchange_output_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.accept_reserved_node_exchange_input_message.AcceptReservedNodeExchangeInputMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.accept_reserved_node_exchange_input_message.serialize_query(
        input_, pairs, ""
    )
