...
def handle_response(
    ...
    out: aws_sdk_redshift.types.describe_partners_output_message.DescribePartnersOutputMessage = aws_sdk_redshift.types.describe_partners_output_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_partners_input_message.DescribePartnersInputMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_partners_input_message.serialize_query(
        input_, pairs, ""
    )
