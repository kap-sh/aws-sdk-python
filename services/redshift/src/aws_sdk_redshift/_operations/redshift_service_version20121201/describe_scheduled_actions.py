...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_scheduled_actions_message.DescribeScheduledActionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_scheduled_actions_message.serialize_query(
        input_, pairs, ""
    )
