"""Generated from Smithy shape ``com.amazonaws.redshift#CreateEndpointAccess``."""
...
import aws_sdk_redshift.errors.access_to_cluster_denied_fault
...
import aws_sdk_redshift.errors.endpoint_already_exists_fault
import aws_sdk_redshift.errors.endpoints_per_authorization_limit_exceeded_fault
import aws_sdk_redshift.errors.endpoints_per_cluster_limit_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessToClusterDeniedFault":
            raise aws_sdk_redshift.errors.access_to_cluster_denied_fault.AccessToClusterDeniedFault.from_query(
                root
            )
        ...
        case "EndpointAlreadyExistsFault":
            raise aws_sdk_redshift.errors.endpoint_already_exists_fault.EndpointAlreadyExistsFault.from_query(
                root
            )
        case "EndpointsPerAuthorizationLimitExceededFault":
            raise aws_sdk_redshift.errors.endpoints_per_authorization_limit_exceeded_fault.EndpointsPerAuthorizationLimitExceededFault.from_query(
                root
            )
        case "EndpointsPerClusterLimitExceededFault":
            raise aws_sdk_redshift.errors.endpoints_per_cluster_limit_exceeded_fault.EndpointsPerClusterLimitExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateEndpointAccessResult")
    out: aws_sdk_redshift.types.endpoint_access.EndpointAccess = (
        aws_sdk_redshift.types.endpoint_access.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.create_endpoint_access_message.CreateEndpointAccessMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateEndpointAccess"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.create_endpoint_access_message

    aws_sdk_redshift.types.create_endpoint_access_message.serialize_query(
        input_, pairs, ""
    )
...
def create_endpoint_access(
    ...
    input_: aws_sdk_redshift.types.create_endpoint_access_message.CreateEndpointAccessMessage,
) -> tuple[aws_sdk_redshift.types.endpoint_access.EndpointAccess, zapros.Response]:
...
async def async_create_endpoint_access(
