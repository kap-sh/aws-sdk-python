...
def handle_response(
    ...
    out: aws_sdk_redshift.types.describe_data_shares_for_consumer_result.DescribeDataSharesForConsumerResult = aws_sdk_redshift.types.describe_data_shares_for_consumer_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_data_shares_for_consumer_message.DescribeDataSharesForConsumerMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_data_shares_for_consumer_message.serialize_query(
        input_, pairs, ""
    )
