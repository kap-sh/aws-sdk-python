...
def build_request(
    ...
    input: aws_sdk_redshift.types.modify_aqua_input_message.ModifyAquaInputMessage,
) -> zapros.Request:
    ...
    aws_sdk_redshift.types.modify_aqua_input_message.serialize_query(input, pairs, "")
