"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyAquaConfiguration``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyAquaConfigurationResult")
    out: aws_sdk_redshift.types.modify_aqua_output_message.ModifyAquaOutputMessage = (
        aws_sdk_redshift.types.modify_aqua_output_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_aqua_input_message.ModifyAquaInputMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyAquaConfiguration"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.modify_aqua_input_message

    aws_sdk_redshift.types.modify_aqua_input_message.serialize_query(input_, pairs, "")
...
async def async_modify_aqua_configuration(
