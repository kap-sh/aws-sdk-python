...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_resource_policy_message.DeleteResourcePolicyMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.delete_resource_policy_message.serialize_query(
        input_, pairs, ""
    )
