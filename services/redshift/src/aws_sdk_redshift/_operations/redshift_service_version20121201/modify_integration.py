...
def build_request(
    ...
    input: aws_sdk_redshift.types.modify_integration_message.ModifyIntegrationMessage,
) -> zapros.Request:
    ...
    aws_sdk_redshift.types.modify_integration_message.serialize_query(input, pairs, "")
