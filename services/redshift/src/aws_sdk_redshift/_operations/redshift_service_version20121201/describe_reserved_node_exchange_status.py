...
import aws_sdk_redshift.errors.reserved_node_exchange_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ReservedNodeExchangeNotFoundFault":
            raise aws_sdk_redshift.errors.reserved_node_exchange_not_found_fault.ReservedNodeExchangeNotFoundFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.describe_reserved_node_exchange_status_output_message.DescribeReservedNodeExchangeStatusOutputMessage = aws_sdk_redshift.types.describe_reserved_node_exchange_status_output_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_reserved_node_exchange_status_input_message.DescribeReservedNodeExchangeStatusInputMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_reserved_node_exchange_status_input_message.serialize_query(
        input_, pairs, ""
    )
