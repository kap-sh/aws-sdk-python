"""Generated from Smithy shape ``com.amazonaws.redshift#BatchModifyClusterSnapshots``."""
...
import aws_sdk_redshift.errors.batch_modify_cluster_snapshots_limit_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BatchModifyClusterSnapshotsLimitExceededFault":
            raise aws_sdk_redshift.errors.batch_modify_cluster_snapshots_limit_exceeded_fault.BatchModifyClusterSnapshotsLimitExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("BatchModifyClusterSnapshotsResult")
    out: aws_sdk_redshift.types.batch_modify_cluster_snapshots_output_message.BatchModifyClusterSnapshotsOutputMessage = aws_sdk_redshift.types.batch_modify_cluster_snapshots_output_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.batch_modify_cluster_snapshots_message.BatchModifyClusterSnapshotsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "BatchModifyClusterSnapshots"))
    pairs.append(("Version", "2012-12-01"))
    aws_sdk_redshift.types.batch_modify_cluster_snapshots_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_batch_modify_cluster_snapshots(
