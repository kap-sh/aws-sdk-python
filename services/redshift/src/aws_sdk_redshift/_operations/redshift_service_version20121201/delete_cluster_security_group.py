...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_cluster_security_group_message.DeleteClusterSecurityGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.delete_cluster_security_group_message.serialize_query(
        input_, pairs, ""
    )
