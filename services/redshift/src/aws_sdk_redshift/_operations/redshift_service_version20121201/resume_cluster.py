...
def handle_response(
    ...
    out: aws_sdk_redshift.types.resume_cluster_result.ResumeClusterResult = (
        aws_sdk_redshift.types.resume_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.resume_cluster_message.ResumeClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.resume_cluster_message.serialize_query(input_, pairs, "")
...
def resume_cluster(
    ...
    aws_sdk_redshift.types.resume_cluster_result.ResumeClusterResult, zapros.Response
]:
