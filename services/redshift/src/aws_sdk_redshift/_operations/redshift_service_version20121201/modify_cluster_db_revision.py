...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ClusterOnLatestRevisionFault":
            import aws_sdk_redshift.errors.cluster_on_latest_revision_fault

            raise aws_sdk_redshift.errors.cluster_on_latest_revision_fault.ClusterOnLatestRevisionFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.modify_cluster_db_revision_result.ModifyClusterDbRevisionResult = aws_sdk_redshift.types.modify_cluster_db_revision_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_cluster_db_revision_message.ModifyClusterDbRevisionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
