"""Generated from Smithy shape ``com.amazonaws.redshift#CreateSnapshotCopyGrant``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SnapshotCopyGrantAlreadyExistsFault":
            import aws_sdk_redshift.errors.snapshot_copy_grant_already_exists_fault

            raise aws_sdk_redshift.errors.snapshot_copy_grant_already_exists_fault.SnapshotCopyGrantAlreadyExistsFault.from_query(
                root
            )
        case "SnapshotCopyGrantQuotaExceededFault":
            import aws_sdk_redshift.errors.snapshot_copy_grant_quota_exceeded_fault

            raise aws_sdk_redshift.errors.snapshot_copy_grant_quota_exceeded_fault.SnapshotCopyGrantQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateSnapshotCopyGrantResult")
    out: aws_sdk_redshift.types.create_snapshot_copy_grant_result.CreateSnapshotCopyGrantResult = aws_sdk_redshift.types.create_snapshot_copy_grant_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.create_snapshot_copy_grant_message.CreateSnapshotCopyGrantMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateSnapshotCopyGrant"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.create_snapshot_copy_grant_message

    aws_sdk_redshift.types.create_snapshot_copy_grant_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_snapshot_copy_grant(
