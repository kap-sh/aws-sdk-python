...
def build_request(
    ...
    input_: aws_sdk_redshift.types.create_redshift_idc_application_message.CreateRedshiftIdcApplicationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.create_redshift_idc_application_message.serialize_query(
        input_, pairs, ""
    )
