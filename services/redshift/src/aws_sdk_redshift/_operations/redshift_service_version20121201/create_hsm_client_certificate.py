...
def build_request(
    ...
    input_: aws_sdk_redshift.types.create_hsm_client_certificate_message.CreateHsmClientCertificateMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.create_hsm_client_certificate_message.serialize_query(
        input_, pairs, ""
    )
