"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeTags``."""
...
import aws_sdk_redshift.types.tagged_resource_list
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.tagged_resource_list_message.TaggedResourceListMessage = aws_sdk_redshift.types.tagged_resource_list_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_tags_message.DescribeTagsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_tags_message.serialize_query(input_, pairs, "")
