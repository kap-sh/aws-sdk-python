...
def handle_response(
    ...
    out: aws_sdk_redshift.types.cluster_db_revisions_message.ClusterDbRevisionsMessage = aws_sdk_redshift.types.cluster_db_revisions_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_cluster_db_revisions_message.DescribeClusterDbRevisionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_cluster_db_revisions_message.serialize_query(
        input_, pairs, ""
    )
