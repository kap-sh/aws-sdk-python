"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeSnapshotSchedules``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeSnapshotSchedulesResult")
    out: aws_sdk_redshift.types.describe_snapshot_schedules_output_message.DescribeSnapshotSchedulesOutputMessage = aws_sdk_redshift.types.describe_snapshot_schedules_output_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_snapshot_schedules_message.DescribeSnapshotSchedulesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeSnapshotSchedules"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.describe_snapshot_schedules_message

    aws_sdk_redshift.types.describe_snapshot_schedules_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_snapshot_schedules(
