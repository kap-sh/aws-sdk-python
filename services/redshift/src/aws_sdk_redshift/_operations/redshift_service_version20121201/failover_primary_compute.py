...
def handle_response(
    ...
    out: aws_sdk_redshift.types.failover_primary_compute_result.FailoverPrimaryComputeResult = aws_sdk_redshift.types.failover_primary_compute_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.failover_primary_compute_input_message.FailoverPrimaryComputeInputMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.failover_primary_compute_input_message.serialize_query(
        input_, pairs, ""
    )
