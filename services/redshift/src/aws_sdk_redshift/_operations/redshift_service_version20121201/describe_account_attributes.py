"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeAccountAttributes``."""
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.account_attribute_list.AccountAttributeList = (
        aws_sdk_redshift.types.account_attribute_list.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_account_attributes_message.DescribeAccountAttributesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_account_attributes_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_account_attributes(
    ...
    aws_sdk_redshift.types.account_attribute_list.AccountAttributeList, zapros.Response
]:
