...
def handle_response(
    ...
    out: aws_sdk_redshift.types.create_custom_domain_association_result.CreateCustomDomainAssociationResult = aws_sdk_redshift.types.create_custom_domain_association_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.create_custom_domain_association_message.CreateCustomDomainAssociationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.create_custom_domain_association_message.serialize_query(
        input_, pairs, ""
    )
