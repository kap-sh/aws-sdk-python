...
def handle_response(
    ...
    out: aws_sdk_redshift.types.get_reserved_node_exchange_configuration_options_output_message.GetReservedNodeExchangeConfigurationOptionsOutputMessage = aws_sdk_redshift.types.get_reserved_node_exchange_configuration_options_output_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.get_reserved_node_exchange_configuration_options_input_message.GetReservedNodeExchangeConfigurationOptionsInputMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
