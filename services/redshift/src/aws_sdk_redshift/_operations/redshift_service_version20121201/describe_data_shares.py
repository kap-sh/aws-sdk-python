...
def handle_response(
    ...
    out: aws_sdk_redshift.types.describe_data_shares_result.DescribeDataSharesResult = (
        aws_sdk_redshift.types.describe_data_shares_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_data_shares_message.DescribeDataSharesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_data_shares_message.serialize_query(
        input_, pairs, ""
    )
