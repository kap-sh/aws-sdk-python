"""Generated from Smithy shape ``com.amazonaws.redshift#AddPartner``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("AddPartnerResult")
...
def build_request(
    ...
    pairs.append(("Action", "AddPartner"))
