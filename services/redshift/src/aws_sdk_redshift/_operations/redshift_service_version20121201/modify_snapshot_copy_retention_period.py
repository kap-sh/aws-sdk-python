...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SnapshotCopyDisabledFault":
            import aws_sdk_redshift.errors.snapshot_copy_disabled_fault

            raise aws_sdk_redshift.errors.snapshot_copy_disabled_fault.SnapshotCopyDisabledFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.modify_snapshot_copy_retention_period_result.ModifySnapshotCopyRetentionPeriodResult = aws_sdk_redshift.types.modify_snapshot_copy_retention_period_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_snapshot_copy_retention_period_message.ModifySnapshotCopyRetentionPeriodMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.modify_snapshot_copy_retention_period_message.serialize_query(
        input_, pairs, ""
    )
