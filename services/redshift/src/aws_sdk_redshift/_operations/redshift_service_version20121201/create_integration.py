...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IntegrationQuotaExceededFault":
            import aws_sdk_redshift.errors.integration_quota_exceeded_fault

            raise aws_sdk_redshift.errors.integration_quota_exceeded_fault.IntegrationQuotaExceededFault.from_query(
                root
            )
        case "IntegrationSourceNotFoundFault":
            import aws_sdk_redshift.errors.integration_source_not_found_fault

            raise aws_sdk_redshift.errors.integration_source_not_found_fault.IntegrationSourceNotFoundFault.from_query(
                root
            )
        case "IntegrationTargetNotFoundFault":
            import aws_sdk_redshift.errors.integration_target_not_found_fault

            raise aws_sdk_redshift.errors.integration_target_not_found_fault.IntegrationTargetNotFoundFault.from_query(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.create_integration_message.CreateIntegrationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.create_integration_message.serialize_query(input_, pairs, "")
