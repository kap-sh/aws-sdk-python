...
def build_request(
    ...
    input: aws_sdk_redshift.types.create_integration_message.CreateIntegrationMessage,
) -> zapros.Request:
    ...
    aws_sdk_redshift.types.create_integration_message.serialize_query(input, pairs, "")
