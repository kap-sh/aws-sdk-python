...
def build_request(
    ...
    input_: aws_sdk_redshift.types.authorize_data_share_message.AuthorizeDataShareMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.authorize_data_share_message.serialize_query(
        input_, pairs, ""
    )
