...
def handle_response(
    ...
    out: aws_sdk_redshift.types.modify_redshift_idc_application_result.ModifyRedshiftIdcApplicationResult = aws_sdk_redshift.types.modify_redshift_idc_application_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_redshift_idc_application_message.ModifyRedshiftIdcApplicationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.modify_redshift_idc_application_message.serialize_query(
        input_, pairs, ""
    )
