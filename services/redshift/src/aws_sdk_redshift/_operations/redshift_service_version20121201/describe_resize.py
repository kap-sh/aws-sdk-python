...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_resize_message.DescribeResizeMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_resize_message.serialize_query(input_, pairs, "")
