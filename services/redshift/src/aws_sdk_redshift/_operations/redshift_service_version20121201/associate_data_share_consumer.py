"""Generated from Smithy shape ``com.amazonaws.redshift#AssociateDataShareConsumer``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("AssociateDataShareConsumerResult")
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.associate_data_share_consumer_message.AssociateDataShareConsumerMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AssociateDataShareConsumer"))
    pairs.append(("Version", "2012-12-01"))
    aws_sdk_redshift.types.associate_data_share_consumer_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_associate_data_share_consumer(
