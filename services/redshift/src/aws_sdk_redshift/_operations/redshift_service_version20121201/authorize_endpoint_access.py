...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EndpointAuthorizationAlreadyExistsFault":
            import aws_sdk_redshift.errors.endpoint_authorization_already_exists_fault

            raise aws_sdk_redshift.errors.endpoint_authorization_already_exists_fault.EndpointAuthorizationAlreadyExistsFault.from_query(
                root
            )
        case "EndpointAuthorizationsPerClusterLimitExceededFault":
            import aws_sdk_redshift.errors.endpoint_authorizations_per_cluster_limit_exceeded_fault

            raise aws_sdk_redshift.errors.endpoint_authorizations_per_cluster_limit_exceeded_fault.EndpointAuthorizationsPerClusterLimitExceededFault.from_query(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.authorize_endpoint_access_message.AuthorizeEndpointAccessMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.authorize_endpoint_access_message.serialize_query(
        input_, pairs, ""
    )
...
def authorize_endpoint_access(
    ...
    aws_sdk_redshift.types.endpoint_authorization.EndpointAuthorization, zapros.Response
]:
