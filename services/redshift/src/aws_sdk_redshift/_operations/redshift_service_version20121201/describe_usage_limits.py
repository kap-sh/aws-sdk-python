...
import aws_sdk_redshift.types.usage_limits
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.usage_limit_list.UsageLimitList = (
        aws_sdk_redshift.types.usage_limit_list.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_usage_limits_message.DescribeUsageLimitsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_usage_limits_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_usage_limits(
    ...
    input_: aws_sdk_redshift.types.describe_usage_limits_message.DescribeUsageLimitsMessage,
) -> tuple[aws_sdk_redshift.types.usage_limit_list.UsageLimitList, zapros.Response]:
