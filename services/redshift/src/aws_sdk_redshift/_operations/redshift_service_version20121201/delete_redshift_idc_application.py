"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteRedshiftIdcApplication``."""
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_redshift_idc_application_message.DeleteRedshiftIdcApplicationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteRedshiftIdcApplication"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.delete_redshift_idc_application_message

    aws_sdk_redshift.types.delete_redshift_idc_application_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_redshift_idc_application(
