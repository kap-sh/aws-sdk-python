"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeNodeConfigurationOptions``."""
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_node_configuration_options_message.DescribeNodeConfigurationOptionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeNodeConfigurationOptions"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.describe_node_configuration_options_message

    aws_sdk_redshift.types.describe_node_configuration_options_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_node_configuration_options(
