...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_custom_domain_association_message.ModifyCustomDomainAssociationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.modify_custom_domain_association_message.serialize_query(
        input_, pairs, ""
    )
