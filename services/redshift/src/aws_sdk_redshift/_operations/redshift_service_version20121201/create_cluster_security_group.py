"""Generated from Smithy shape ``com.amazonaws.redshift#CreateClusterSecurityGroup``."""
...
import aws_sdk_redshift.errors.cluster_security_group_already_exists_fault
import aws_sdk_redshift.errors.cluster_security_group_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ClusterSecurityGroupAlreadyExistsFault":
            raise aws_sdk_redshift.errors.cluster_security_group_already_exists_fault.ClusterSecurityGroupAlreadyExistsFault.from_query(
                root
            )
        case "ClusterSecurityGroupQuotaExceededFault":
            raise aws_sdk_redshift.errors.cluster_security_group_quota_exceeded_fault.ClusterSecurityGroupQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateClusterSecurityGroupResult")
    out: aws_sdk_redshift.types.create_cluster_security_group_result.CreateClusterSecurityGroupResult = aws_sdk_redshift.types.create_cluster_security_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.create_cluster_security_group_message.CreateClusterSecurityGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_cluster_security_group(
