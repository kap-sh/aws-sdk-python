...
def handle_response(
    ...
    out: aws_sdk_redshift.types.reboot_cluster_result.RebootClusterResult = (
        aws_sdk_redshift.types.reboot_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.reboot_cluster_message.RebootClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.reboot_cluster_message.serialize_query(input_, pairs, "")
...
def reboot_cluster(
    ...
    aws_sdk_redshift.types.reboot_cluster_result.RebootClusterResult, zapros.Response
]:
