"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteHsmClientCertificate``."""
...
import aws_sdk_redshift.errors.invalid_hsm_client_certificate_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidHsmClientCertificateStateFault":
            raise aws_sdk_redshift.errors.invalid_hsm_client_certificate_state_fault.InvalidHsmClientCertificateStateFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_hsm_client_certificate_message.DeleteHsmClientCertificateMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteHsmClientCertificate"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.delete_hsm_client_certificate_message

    aws_sdk_redshift.types.delete_hsm_client_certificate_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_hsm_client_certificate(
