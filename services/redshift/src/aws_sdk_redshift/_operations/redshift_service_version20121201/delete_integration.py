...
def build_request(
    ...
    input: aws_sdk_redshift.types.delete_integration_message.DeleteIntegrationMessage,
) -> zapros.Request:
    ...
    aws_sdk_redshift.types.delete_integration_message.serialize_query(input, pairs, "")
