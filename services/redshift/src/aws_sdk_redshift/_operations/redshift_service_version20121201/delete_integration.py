...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_integration_message.DeleteIntegrationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.delete_integration_message.serialize_query(input_, pairs, "")
