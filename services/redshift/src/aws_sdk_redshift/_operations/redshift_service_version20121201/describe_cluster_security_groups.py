...
import aws_sdk_redshift.types.cluster_security_groups
...
def handle_response(
    ...
    out: aws_sdk_redshift.types.cluster_security_group_message.ClusterSecurityGroupMessage = aws_sdk_redshift.types.cluster_security_group_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_cluster_security_groups_message.DescribeClusterSecurityGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_cluster_security_groups_message.serialize_query(
        input_, pairs, ""
    )
