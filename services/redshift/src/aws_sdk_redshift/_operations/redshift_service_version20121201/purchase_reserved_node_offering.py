...
def build_request(
    ...
    input_: aws_sdk_redshift.types.purchase_reserved_node_offering_message.PurchaseReservedNodeOfferingMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.purchase_reserved_node_offering_message.serialize_query(
        input_, pairs, ""
    )
