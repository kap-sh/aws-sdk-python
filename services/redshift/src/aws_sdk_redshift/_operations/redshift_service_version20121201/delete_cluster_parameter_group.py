...
def build_request(
    ...
    input_: aws_sdk_redshift.types.delete_cluster_parameter_group_message.DeleteClusterParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.delete_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
