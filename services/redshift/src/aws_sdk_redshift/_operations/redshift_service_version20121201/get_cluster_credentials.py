...
def handle_response(
    ...
    out: aws_sdk_redshift.types.cluster_credentials.ClusterCredentials = (
        aws_sdk_redshift.types.cluster_credentials.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.get_cluster_credentials_message.GetClusterCredentialsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.get_cluster_credentials_message.serialize_query(
        input_, pairs, ""
    )
...
def get_cluster_credentials(
    ...
    aws_sdk_redshift.types.cluster_credentials.ClusterCredentials, zapros.Response
]:
