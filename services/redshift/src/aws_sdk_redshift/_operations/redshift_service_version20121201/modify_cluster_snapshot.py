"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyClusterSnapshot``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyClusterSnapshotResult")
    out: aws_sdk_redshift.types.modify_cluster_snapshot_result.ModifyClusterSnapshotResult = aws_sdk_redshift.types.modify_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_cluster_snapshot_message.ModifyClusterSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyClusterSnapshot"))
    pairs.append(("Version", "2012-12-01"))
    import aws_sdk_redshift.types.modify_cluster_snapshot_message

    aws_sdk_redshift.types.modify_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_cluster_snapshot(
