...
def handle_response(
    ...
    out: aws_sdk_redshift.types.describe_redshift_idc_applications_result.DescribeRedshiftIdcApplicationsResult = aws_sdk_redshift.types.describe_redshift_idc_applications_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_redshift_idc_applications_message.DescribeRedshiftIdcApplicationsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_redshift_idc_applications_message.serialize_query(
        input_, pairs, ""
    )
