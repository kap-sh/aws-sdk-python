...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_snapshot_schedule_message.ModifySnapshotScheduleMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.modify_snapshot_schedule_message.serialize_query(
        input_, pairs, ""
    )
