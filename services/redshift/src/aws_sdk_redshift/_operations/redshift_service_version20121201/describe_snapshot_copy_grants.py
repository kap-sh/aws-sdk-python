...
def handle_response(
    ...
    out: aws_sdk_redshift.types.snapshot_copy_grant_message.SnapshotCopyGrantMessage = (
        aws_sdk_redshift.types.snapshot_copy_grant_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_redshift.types.describe_snapshot_copy_grants_message.DescribeSnapshotCopyGrantsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.describe_snapshot_copy_grants_message.serialize_query(
        input_, pairs, ""
    )
