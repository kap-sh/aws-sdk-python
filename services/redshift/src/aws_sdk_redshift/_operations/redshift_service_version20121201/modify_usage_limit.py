...
def build_request(
    ...
    input_: aws_sdk_redshift.types.modify_usage_limit_message.ModifyUsageLimitMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_redshift.types.modify_usage_limit_message.serialize_query(input_, pairs, "")
