...
def build_request(
    ...
    input: aws_sdk_redshift.types.modify_usage_limit_message.ModifyUsageLimitMessage,
) -> zapros.Request:
    ...
    aws_sdk_redshift.types.modify_usage_limit_message.serialize_query(input, pairs, "")
