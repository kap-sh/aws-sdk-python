"""Generated from Smithy shape ``com.amazonaws.redshift#ResumeClusterResult``."""
...
class ResumeClusterResult(TypedDict, closed=True):
    cluster: NotRequired["aws_sdk_redshift.types.cluster.Cluster"]


# --- awsQuery ser/de ---
def serialize_query(
    value: ResumeClusterResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "cluster" in value:
        import aws_sdk_redshift.types.cluster
...
def deserialize_query(el: Element) -> ResumeClusterResult:
    out: ResumeClusterResult = {}  # type: ignore[typeddict-item]
