...
if TYPE_CHECKING:
    import aws_sdk_redshift.types.revision_target

RevisionTargetsList: TypeAlias = list[
    "aws_sdk_redshift.types.revision_target.RevisionTarget"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_redshift.types.revision_target.serialize_query(
...
def deserialize_query(el: Element) -> RevisionTargetsList:
    ...
    for child in el.findall("RevisionTarget"):
        out.append(aws_sdk_redshift.types.revision_target.deserialize_query(child))
    return out
