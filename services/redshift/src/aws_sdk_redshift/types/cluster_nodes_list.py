...
if TYPE_CHECKING:
    import aws_sdk_redshift.types.cluster_node

ClusterNodesList: TypeAlias = list["aws_sdk_redshift.types.cluster_node.ClusterNode"]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_redshift.types.cluster_node.serialize_query(
...
def deserialize_query(el: Element) -> ClusterNodesList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_redshift.types.cluster_node.deserialize_query(child))
    return out
