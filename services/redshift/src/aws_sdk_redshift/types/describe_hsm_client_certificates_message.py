"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeHsmClientCertificatesMessage``."""
...
class DescribeHsmClientCertificatesMessage(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeHsmClientCertificatesMessage,
...
def deserialize_query(el: Element) -> DescribeHsmClientCertificatesMessage:
    out: DescribeHsmClientCertificatesMessage = {}  # type: ignore[typeddict-item]
