...
class TableRestoreStatus(TypedDict, closed=True):
    ...
    status: NotRequired[
        "aws_sdk_redshift.types.table_restore_status_type.TableRestoreStatusType"
    ]
    ...
    source_database_name: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The name of the source database that contains the table being restored.</p>"""
    source_schema_name: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The name of the source schema that contains the table being restored.</p>"""
    source_table_name: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The name of the source table being restored.</p>"""
    target_database_name: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The name of the database to restore the table to.</p>"""
    target_schema_name: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The name of the schema to restore the table to.</p>"""
    new_table_name: NotRequired["aws_sdk_redshift.types.string.String"]
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_redshift.types.table_restore_status_type.serialize_query(
...
def deserialize_query(el: Element) -> TableRestoreStatus:
    ...
    if child_status is not None:
        ...
        out["status"] = (
            aws_sdk_redshift.types.table_restore_status_type.deserialize_query(
                child_status
            )
        )
