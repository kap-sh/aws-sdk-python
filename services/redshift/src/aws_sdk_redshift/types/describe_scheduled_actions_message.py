...
class DescribeScheduledActionsMessage(TypedDict):
    ...
    active: NotRequired["aws_sdk_redshift.types.boolean_optional.BooleanOptional"]
...
def serialize_query(
    ...
    if "target_action_type" in value:
        ...
        aws_sdk_redshift.types.scheduled_action_type_values.serialize_query(
    ...
    if "filters" in value:
        ...
        aws_sdk_redshift.types.scheduled_action_filter_list.serialize_query(
...
def deserialize_query(el: Element) -> DescribeScheduledActionsMessage:
    ...
    if child_target_action_type is not None:
        ...
        out["target_action_type"] = (
            aws_sdk_redshift.types.scheduled_action_type_values.deserialize_query(
    ...
    if child_filters is not None:
        ...
        out["filters"] = (
            aws_sdk_redshift.types.scheduled_action_filter_list.deserialize_query(
                child_filters
            )
        )
