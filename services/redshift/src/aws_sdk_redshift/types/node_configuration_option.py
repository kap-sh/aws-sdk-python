...
if TYPE_CHECKING:
    ...
    import aws_sdk_redshift.types.mode
...
class NodeConfigurationOption(TypedDict):
    ...
    mode: NotRequired["aws_sdk_redshift.types.mode.Mode"]
...
def serialize_query(
    ...
    if "mode" in value:
        ...
        aws_sdk_redshift.types.mode.serialize_query(
...
def deserialize_query(el: Element) -> NodeConfigurationOption:
    ...
    if child_mode is not None:
        ...
        out["mode"] = aws_sdk_redshift.types.mode.deserialize_query(child_mode)
    return out
