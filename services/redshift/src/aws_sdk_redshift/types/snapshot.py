...
if TYPE_CHECKING:
    import aws_sdk_redshift.types.accounts_with_restore_access_list
    ...
    import aws_sdk_redshift.types.restorable_node_type_list
...
class Snapshot(TypedDict):
    ...
    encrypted_with_hsm: NotRequired["aws_sdk_redshift.types.boolean.Boolean"]
    ...
    accounts_with_restore_access: NotRequired[
        "aws_sdk_redshift.types.accounts_with_restore_access_list.AccountsWithRestoreAccessList"
    ]
    ...
    backup_progress_in_mega_bytes: NotRequired["aws_sdk_redshift.types.double.Double"]
    ...
    estimated_seconds_to_completion: NotRequired["aws_sdk_redshift.types.long.Long"]
    ...
    source_region: NotRequired["aws_sdk_redshift.types.string.String"]
    ...
    restorable_node_types: NotRequired[
        "aws_sdk_redshift.types.restorable_node_type_list.RestorableNodeTypeList"
    ]
    ...
    snapshot_retention_start_time: NotRequired["aws_sdk_redshift.types.t_stamp.TStamp"]
...
def serialize_query(value: Snapshot, pairs: list[tuple[str, str]], prefix: str) -> None:
    ...
    if "engine_full_version" in value:
        pairs.append((f"{prefix}.EngineFullVersion", str(value["engine_full_version"])))
    ...
    if "accounts_with_restore_access" in value:
        ...
        aws_sdk_redshift.types.accounts_with_restore_access_list.serialize_query(
            value["accounts_with_restore_access"],
            pairs,
            f"{prefix}.AccountsWithRestoreAccess",
        )
    ...
    if "actual_incremental_backup_size_in_mega_bytes" in value:
        pairs.append(
            (
                f"{prefix}.ActualIncrementalBackupSizeInMegaBytes",
    ...
    if "backup_progress_in_mega_bytes" in value:
        pairs.append(
            (
                f"{prefix}.BackupProgressInMegaBytes",
    ...
    if "current_backup_rate_in_mega_bytes_per_second" in value:
        pairs.append(
            (
                f"{prefix}.CurrentBackupRateInMegaBytesPerSecond",
    ...
    if "estimated_seconds_to_completion" in value:
        pairs.append(
            (
                f"{prefix}.EstimatedSecondsToCompletion",
    ...
    if "restorable_node_types" in value:
        ...
        aws_sdk_redshift.types.restorable_node_type_list.serialize_query(
            value["restorable_node_types"], pairs, f"{prefix}.RestorableNodeTypes"
        )
    ...
    if "manual_snapshot_remaining_days" in value:
        pairs.append(
            (
                f"{prefix}.ManualSnapshotRemainingDays",
    ...
    if "snapshot_retention_start_time" in value:
        ...
        aws_sdk_redshift.types.t_stamp.serialize_query(
            ...
            pairs,
            f"{prefix}.SnapshotRetentionStartTime",
        )
...
def deserialize_query(el: Element) -> Snapshot:
    ...
    if child_snapshot_create_time is not None:
        ...
        out["snapshot_create_time"] = aws_sdk_redshift.types.t_stamp.deserialize_query(
    ...
    if child_accounts_with_restore_access is not None:
        ...
        out["accounts_with_restore_access"] = (
            aws_sdk_redshift.types.accounts_with_restore_access_list.deserialize_query(
    ...
    if child_restorable_node_types is not None:
        ...
        out["restorable_node_types"] = (
            aws_sdk_redshift.types.restorable_node_type_list.deserialize_query(
