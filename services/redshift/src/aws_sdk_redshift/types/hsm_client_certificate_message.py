...
class HsmClientCertificateMessage(TypedDict):
    ...
    hsm_client_certificates: NotRequired[
        "aws_sdk_redshift.types.hsm_client_certificate_list.HsmClientCertificateList"
    ]
...
def serialize_query(
    ...
    if "hsm_client_certificates" in value:
        ...
        aws_sdk_redshift.types.hsm_client_certificate_list.serialize_query(
...
def deserialize_query(el: Element) -> HsmClientCertificateMessage:
    ...
    if child_hsm_client_certificates is not None:
        ...
        out["hsm_client_certificates"] = (
            aws_sdk_redshift.types.hsm_client_certificate_list.deserialize_query(
