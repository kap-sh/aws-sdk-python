...
class TaggedResource(TypedDict):
    tag: NotRequired["aws_sdk_redshift.types.tag.Tag"]
...
def serialize_query(
    ...
    if "tag" in value:
        ...
        aws_sdk_redshift.types.tag.serialize_query(value["tag"], pairs, f"{prefix}.Tag")
...
def deserialize_query(el: Element) -> TaggedResource:
    ...
    if child_tag is not None:
        ...
        out["tag"] = aws_sdk_redshift.types.tag.deserialize_query(child_tag)
