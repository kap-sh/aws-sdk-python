...
class OrderableClusterOptionsMessage(TypedDict):
    orderable_cluster_options: NotRequired[
        "aws_sdk_redshift.types.orderable_cluster_options_list.OrderableClusterOptionsList"
    ]
...
def serialize_query(
    ...
    if "orderable_cluster_options" in value:
        ...
        aws_sdk_redshift.types.orderable_cluster_options_list.serialize_query(
...
def deserialize_query(el: Element) -> OrderableClusterOptionsMessage:
    ...
    if child_orderable_cluster_options is not None:
        ...
        out["orderable_cluster_options"] = (
            aws_sdk_redshift.types.orderable_cluster_options_list.deserialize_query(
