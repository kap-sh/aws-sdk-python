"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeClusterSubnetGroupsMessage``."""
...
class DescribeClusterSubnetGroupsMessage(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> DescribeClusterSubnetGroupsMessage:
    out: DescribeClusterSubnetGroupsMessage = {}  # type: ignore[typeddict-item]
