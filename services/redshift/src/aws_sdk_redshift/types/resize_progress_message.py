...
if TYPE_CHECKING:
    import aws_sdk_redshift.types.double_optional
...
class ResizeProgressMessage(TypedDict):
    target_node_type: NotRequired["aws_sdk_redshift.types.string.String"]
    ...
    target_cluster_type: NotRequired["aws_sdk_redshift.types.string.String"]
    ...
    import_tables_completed: NotRequired[
        "aws_sdk_redshift.types.import_tables_completed.ImportTablesCompleted"
    ]
    ...
    import_tables_in_progress: NotRequired[
        "aws_sdk_redshift.types.import_tables_in_progress.ImportTablesInProgress"
    ]
    ...
    import_tables_not_started: NotRequired[
        "aws_sdk_redshift.types.import_tables_not_started.ImportTablesNotStarted"
    ]
    ...
    avg_resize_rate_in_mega_bytes_per_second: NotRequired[
        "aws_sdk_redshift.types.double_optional.DoubleOptional"
    ]
    ...
    target_encryption_type: NotRequired["aws_sdk_redshift.types.string.String"]
...
def serialize_query(
    ...
    if "import_tables_completed" in value:
        ...
        aws_sdk_redshift.types.import_tables_completed.serialize_query(
            value["import_tables_completed"], pairs, f"{prefix}.ImportTablesCompleted"
        )
    if "import_tables_in_progress" in value:
        import aws_sdk_redshift.types.import_tables_in_progress

        aws_sdk_redshift.types.import_tables_in_progress.serialize_query(
    ...
    if "import_tables_not_started" in value:
        ...
        aws_sdk_redshift.types.import_tables_not_started.serialize_query(
...
def deserialize_query(el: Element) -> ResizeProgressMessage:
    ...
    if child_import_tables_completed is not None:
        ...
        out["import_tables_completed"] = (
            aws_sdk_redshift.types.import_tables_completed.deserialize_query(
    ...
    if child_import_tables_in_progress is not None:
        ...
        out["import_tables_in_progress"] = (
            aws_sdk_redshift.types.import_tables_in_progress.deserialize_query(
    ...
    if child_import_tables_not_started is not None:
        ...
        out["import_tables_not_started"] = (
            aws_sdk_redshift.types.import_tables_not_started.deserialize_query(
