...
class ClusterSecurityGroupMessage(TypedDict):
    ...
    cluster_security_groups: NotRequired[
        "aws_sdk_redshift.types.cluster_security_groups.ClusterSecurityGroups"
    ]
...
def serialize_query(
    ...
    if "cluster_security_groups" in value:
        ...
        aws_sdk_redshift.types.cluster_security_groups.serialize_query(
...
def deserialize_query(el: Element) -> ClusterSecurityGroupMessage:
    ...
    if child_cluster_security_groups is not None:
        ...
        out["cluster_security_groups"] = (
            aws_sdk_redshift.types.cluster_security_groups.deserialize_query(
