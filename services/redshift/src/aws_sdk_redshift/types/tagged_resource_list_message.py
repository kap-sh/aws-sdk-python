...
class TaggedResourceListMessage(TypedDict):
    tagged_resources: NotRequired[
        "aws_sdk_redshift.types.tagged_resource_list.TaggedResourceList"
    ]
...
def serialize_query(
    ...
    if "tagged_resources" in value:
        ...
        aws_sdk_redshift.types.tagged_resource_list.serialize_query(
...
def deserialize_query(el: Element) -> TaggedResourceListMessage:
    ...
    if child_tagged_resources is not None:
        ...
        out["tagged_resources"] = (
            aws_sdk_redshift.types.tagged_resource_list.deserialize_query(
