...
class EndpointAccess(TypedDict):
    ...
    endpoint_status: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The status of the endpoint.</p>"""
    endpoint_name: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The name of the endpoint.</p>"""
    endpoint_create_time: NotRequired["aws_sdk_redshift.types.t_stamp.TStamp"]
    ...
    vpc_endpoint: NotRequired["aws_sdk_redshift.types.vpc_endpoint.VpcEndpoint"]
...
def deserialize_query(el: Element) -> EndpointAccess:
    ...
    if child_endpoint_create_time is not None:
        ...
        out["endpoint_create_time"] = aws_sdk_redshift.types.t_stamp.deserialize_query(
    ...
    if child_vpc_endpoint is not None:
        ...
        out["vpc_endpoint"] = aws_sdk_redshift.types.vpc_endpoint.deserialize_query(
            child_vpc_endpoint
        )
    return out
