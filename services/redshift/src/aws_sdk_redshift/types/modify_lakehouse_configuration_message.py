...
class ModifyLakehouseConfigurationMessage(TypedDict):
...
def serialize_query(
    ...
    if "lakehouse_registration" in value:
        ...
        aws_sdk_redshift.types.lakehouse_registration.serialize_query(
    ...
    if "lakehouse_idc_registration" in value:
        ...
        aws_sdk_redshift.types.lakehouse_idc_registration.serialize_query(
...
def deserialize_query(el: Element) -> ModifyLakehouseConfigurationMessage:
    ...
    if child_lakehouse_registration is not None:
        ...
        out["lakehouse_registration"] = (
            aws_sdk_redshift.types.lakehouse_registration.deserialize_query(
    ...
    if child_lakehouse_idc_registration is not None:
        ...
        out["lakehouse_idc_registration"] = (
            aws_sdk_redshift.types.lakehouse_idc_registration.deserialize_query(
