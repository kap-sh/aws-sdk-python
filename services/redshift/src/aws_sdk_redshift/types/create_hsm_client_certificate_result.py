...
class CreateHsmClientCertificateResult(TypedDict):
    hsm_client_certificate: NotRequired[
        "aws_sdk_redshift.types.hsm_client_certificate.HsmClientCertificate"
    ]
...
def serialize_query(
    ...
    if "hsm_client_certificate" in value:
        ...
        aws_sdk_redshift.types.hsm_client_certificate.serialize_query(
...
def deserialize_query(el: Element) -> CreateHsmClientCertificateResult:
    ...
    if child_hsm_client_certificate is not None:
        ...
        out["hsm_client_certificate"] = (
            aws_sdk_redshift.types.hsm_client_certificate.deserialize_query(
