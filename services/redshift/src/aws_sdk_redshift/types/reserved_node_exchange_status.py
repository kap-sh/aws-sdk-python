...
if TYPE_CHECKING:
    ...
    import aws_sdk_redshift.types.reserved_node_exchange_status_type
    import aws_sdk_redshift.types.string
    import aws_sdk_redshift.types.t_stamp


class ReservedNodeExchangeStatus(TypedDict):
    ...
    status: NotRequired[
        "aws_sdk_redshift.types.reserved_node_exchange_status_type.ReservedNodeExchangeStatusType"
    ]
    """<p>The status of the reserved-node exchange request. Statuses include in-progress and requested.</p>"""
    request_time: NotRequired["aws_sdk_redshift.types.t_stamp.TStamp"]
    """<p>A date and time that indicate when the reserved-node exchange was requested.</p>"""
    source_reserved_node_id: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The identifier of the source reserved node.</p>"""
    source_reserved_node_type: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The source reserved-node type, for example ra3.4xlarge.</p>"""
    source_reserved_node_count: NotRequired["aws_sdk_redshift.types.integer.Integer"]
    """<p>The source reserved-node count in the cluster.</p>"""
    target_reserved_node_offering_id: NotRequired[
        "aws_sdk_redshift.types.string.String"
    ]
    """<p>The identifier of the target reserved node offering.</p>"""
    target_reserved_node_type: NotRequired["aws_sdk_redshift.types.string.String"]
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_redshift.types.reserved_node_exchange_status_type.serialize_query(
...
def deserialize_query(el: Element) -> ReservedNodeExchangeStatus:
    ...
    if child_status is not None:
        ...
        out["status"] = (
            aws_sdk_redshift.types.reserved_node_exchange_status_type.deserialize_query(
                child_status
            )
        )
    ...
    if child_request_time is not None:
        ...
        out["request_time"] = aws_sdk_redshift.types.t_stamp.deserialize_query(
            child_request_time
        )
