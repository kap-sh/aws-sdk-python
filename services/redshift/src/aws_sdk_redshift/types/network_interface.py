...
class NetworkInterface(TypedDict, closed=True):
    network_interface_id: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The network interface identifier. </p>"""
    subnet_id: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The subnet identifier. </p>"""
    private_ip_address: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The IPv4 address of the network interface within the subnet. </p>"""
    availability_zone: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The Availability Zone. </p>"""
    ipv6_address: NotRequired["aws_sdk_redshift.types.string.String"]
