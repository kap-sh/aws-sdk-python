...
class SnapshotErrorMessage(TypedDict):
    ...
    failure_code: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The failure code for the error.</p>"""
    failure_reason: NotRequired["aws_sdk_redshift.types.string.String"]
