...
class DescribeDataSharesForProducerMessage(TypedDict):
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_redshift.types.data_share_status_for_producer.serialize_query(
...
def deserialize_query(el: Element) -> DescribeDataSharesForProducerMessage:
    ...
    if child_status is not None:
        ...
        out["status"] = (
            aws_sdk_redshift.types.data_share_status_for_producer.deserialize_query(
                child_status
            )
        )
