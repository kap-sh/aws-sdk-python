"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyAuthenticationProfileResult``."""
...
class ModifyAuthenticationProfileResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ModifyAuthenticationProfileResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ModifyAuthenticationProfileResult:
    out: ModifyAuthenticationProfileResult = {}  # type: ignore[typeddict-item]
