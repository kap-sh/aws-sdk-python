...
if TYPE_CHECKING:
    import aws_sdk_redshift.types.cluster_parameter_status

ClusterParameterStatusList: TypeAlias = list[
    "aws_sdk_redshift.types.cluster_parameter_status.ClusterParameterStatus"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_redshift.types.cluster_parameter_status.serialize_query(
...
def deserialize_query(el: Element) -> ClusterParameterStatusList:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_redshift.types.cluster_parameter_status.deserialize_query(child)
        )
    return out
