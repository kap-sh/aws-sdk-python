...
if TYPE_CHECKING:
    import aws_sdk_redshift.types.attribute_value_target

AttributeValueList: TypeAlias = list[
    "aws_sdk_redshift.types.attribute_value_target.AttributeValueTarget"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_redshift.types.attribute_value_target.serialize_query(
...
def deserialize_query(el: Element) -> AttributeValueList:
    ...
    for child in el.findall("AttributeValueTarget"):
        out.append(
            aws_sdk_redshift.types.attribute_value_target.deserialize_query(child)
        )
    return out
