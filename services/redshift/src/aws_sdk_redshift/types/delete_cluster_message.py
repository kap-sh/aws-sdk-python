...
class DeleteClusterMessage(TypedDict):
    ...
    skip_final_cluster_snapshot: NotRequired["aws_sdk_redshift.types.boolean.Boolean"]
    ...
    final_cluster_snapshot_identifier: NotRequired[
