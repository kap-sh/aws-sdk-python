"""Generated from Smithy shape ``com.amazonaws.redshift#EnableSnapshotCopyResult``."""
...
class EnableSnapshotCopyResult(TypedDict, closed=True):
    cluster: NotRequired["aws_sdk_redshift.types.cluster.Cluster"]


# --- awsQuery ser/de ---
def serialize_query(
    value: EnableSnapshotCopyResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "cluster" in value:
        import aws_sdk_redshift.types.cluster
...
def deserialize_query(el: Element) -> EnableSnapshotCopyResult:
    out: EnableSnapshotCopyResult = {}  # type: ignore[typeddict-item]
