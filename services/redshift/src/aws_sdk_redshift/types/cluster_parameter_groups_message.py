...
if TYPE_CHECKING:
    import aws_sdk_redshift.types.parameter_group_list
    import aws_sdk_redshift.types.string


class ClusterParameterGroupsMessage(TypedDict):
    ...
    parameter_groups: NotRequired[
        "aws_sdk_redshift.types.parameter_group_list.ParameterGroupList"
    ]
...
def serialize_query(
    ...
    if "parameter_groups" in value:
        ...
        aws_sdk_redshift.types.parameter_group_list.serialize_query(
...
def deserialize_query(el: Element) -> ClusterParameterGroupsMessage:
    ...
    if child_parameter_groups is not None:
        ...
        out["parameter_groups"] = (
            aws_sdk_redshift.types.parameter_group_list.deserialize_query(
