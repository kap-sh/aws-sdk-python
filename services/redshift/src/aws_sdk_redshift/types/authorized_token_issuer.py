...
if TYPE_CHECKING:
    import aws_sdk_redshift.types.authorized_audience_list
    import aws_sdk_redshift.types.string


class AuthorizedTokenIssuer(TypedDict):
    trusted_token_issuer_arn: NotRequired["aws_sdk_redshift.types.string.String"]
    ...
    authorized_audiences_list: NotRequired[
        "aws_sdk_redshift.types.authorized_audience_list.AuthorizedAudienceList"
    ]
...
def serialize_query(
    ...
    if "authorized_audiences_list" in value:
        ...
        aws_sdk_redshift.types.authorized_audience_list.serialize_query(
...
def deserialize_query(el: Element) -> AuthorizedTokenIssuer:
    ...
    if child_authorized_audiences_list is not None:
        ...
        out["authorized_audiences_list"] = (
            aws_sdk_redshift.types.authorized_audience_list.deserialize_query(
