...
if TYPE_CHECKING:
    import aws_sdk_redshift.types.ec2_security_group_list
    import aws_sdk_redshift.types.ip_range_list
    import aws_sdk_redshift.types.string
    import aws_sdk_redshift.types.tag_list


class ClusterSecurityGroup(TypedDict):
    ...
    ec2_security_groups: NotRequired[
        "aws_sdk_redshift.types.ec2_security_group_list.EC2SecurityGroupList"
    ]
    """<p>A list of EC2 security groups that are permitted to access clusters associated with this cluster security group.</p>"""
    ip_ranges: NotRequired["aws_sdk_redshift.types.ip_range_list.IPRangeList"]
...
def serialize_query(
    ...
    if "ec2_security_groups" in value:
        ...
        aws_sdk_redshift.types.ec2_security_group_list.serialize_query(
            value["ec2_security_groups"], pairs, f"{prefix}.EC2SecurityGroups"
        )
    if "ip_ranges" in value:
        import aws_sdk_redshift.types.ip_range_list

        aws_sdk_redshift.types.ip_range_list.serialize_query(
...
def deserialize_query(el: Element) -> ClusterSecurityGroup:
    ...
    if child_ec2_security_groups is not None:
        ...
        out["ec2_security_groups"] = (
            aws_sdk_redshift.types.ec2_security_group_list.deserialize_query(
    ...
    if child_ip_ranges is not None:
        ...
        out["ip_ranges"] = aws_sdk_redshift.types.ip_range_list.deserialize_query(
            child_ip_ranges
        )
