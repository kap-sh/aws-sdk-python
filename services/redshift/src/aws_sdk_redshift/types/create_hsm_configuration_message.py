...
class CreateHsmConfigurationMessage(TypedDict):
    ...
    hsm_partition_password: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The password required to access the HSM partition.</p>"""
    hsm_server_public_certificate: NotRequired["aws_sdk_redshift.types.string.String"]
