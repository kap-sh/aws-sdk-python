...
class BatchDeleteClusterSnapshotsResult(TypedDict):
    ...
    errors: NotRequired[
        "aws_sdk_redshift.types.batch_snapshot_operation_error_list.BatchSnapshotOperationErrorList"
    ]
...
def serialize_query(
    ...
    if "errors" in value:
        ...
        aws_sdk_redshift.types.batch_snapshot_operation_error_list.serialize_query(
...
def deserialize_query(el: Element) -> BatchDeleteClusterSnapshotsResult:
    ...
    if child_errors is not None:
        ...
        out["errors"] = (
            aws_sdk_redshift.types.batch_snapshot_operation_error_list.deserialize_query(
                child_errors
            )
        )
    return out
