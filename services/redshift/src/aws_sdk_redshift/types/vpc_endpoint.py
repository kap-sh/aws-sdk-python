...
if TYPE_CHECKING:
    import aws_sdk_redshift.types.network_interface_list
    import aws_sdk_redshift.types.string


class VpcEndpoint(TypedDict):
    vpc_endpoint_id: NotRequired["aws_sdk_redshift.types.string.String"]
    ...
    network_interfaces: NotRequired[
        "aws_sdk_redshift.types.network_interface_list.NetworkInterfaceList"
    ]
...
def serialize_query(
    ...
    if "network_interfaces" in value:
        ...
        aws_sdk_redshift.types.network_interface_list.serialize_query(
...
def deserialize_query(el: Element) -> VpcEndpoint:
    ...
    if child_network_interfaces is not None:
        ...
        out["network_interfaces"] = (
            aws_sdk_redshift.types.network_interface_list.deserialize_query(
