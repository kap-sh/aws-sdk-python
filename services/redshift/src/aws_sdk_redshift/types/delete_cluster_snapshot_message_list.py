...
DeleteClusterSnapshotMessageList: TypeAlias = list[
    "aws_sdk_redshift.types.delete_cluster_snapshot_message.DeleteClusterSnapshotMessage"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_redshift.types.delete_cluster_snapshot_message.serialize_query(
...
def deserialize_query(el: Element) -> DeleteClusterSnapshotMessageList:
    ...
    for child in el.findall("DeleteClusterSnapshotMessage"):
        out.append(
            aws_sdk_redshift.types.delete_cluster_snapshot_message.deserialize_query(
                child
            )
        )
    return out
