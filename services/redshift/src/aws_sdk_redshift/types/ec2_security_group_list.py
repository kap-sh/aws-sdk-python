...
if TYPE_CHECKING:
    import aws_sdk_redshift.types.ec2_security_group

EC2SecurityGroupList: TypeAlias = list[
    "aws_sdk_redshift.types.ec2_security_group.EC2SecurityGroup"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_redshift.types.ec2_security_group.serialize_query(
...
def deserialize_query(el: Element) -> EC2SecurityGroupList:
    ...
    for child in el.findall("EC2SecurityGroup"):
        out.append(aws_sdk_redshift.types.ec2_security_group.deserialize_query(child))
    return out
