...
if TYPE_CHECKING:
    ...
    import aws_sdk_redshift.types.subnet_list
...
class ClusterSubnetGroup(TypedDict):
    ...
    subnet_group_status: NotRequired["aws_sdk_redshift.types.string.String"]
    ...
    subnets: NotRequired["aws_sdk_redshift.types.subnet_list.SubnetList"]
    ...
    supported_cluster_ip_address_types: NotRequired[
        "aws_sdk_redshift.types.value_string_list.ValueStringList"
    ]
...
def serialize_query(
    ...
    if "subnets" in value:
        ...
        aws_sdk_redshift.types.subnet_list.serialize_query(
...
def deserialize_query(el: Element) -> ClusterSubnetGroup:
    ...
    if child_subnets is not None:
        ...
        out["subnets"] = aws_sdk_redshift.types.subnet_list.deserialize_query(
            child_subnets
        )
    ...
    if child_supported_cluster_ip_address_types is not None:
        ...
        out["supported_cluster_ip_address_types"] = (
            aws_sdk_redshift.types.value_string_list.deserialize_query(
