"""Generated from Smithy shape ``com.amazonaws.redshift#Subnet``."""
...
if TYPE_CHECKING:
    import aws_sdk_redshift.types.availability_zone
    import aws_sdk_redshift.types.string


class Subnet(TypedDict, closed=True):
    subnet_identifier: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The identifier of the subnet.</p>"""
    subnet_availability_zone: NotRequired[
        "aws_sdk_redshift.types.availability_zone.AvailabilityZone"
    ]
    """<p></p>"""
    subnet_status: NotRequired["aws_sdk_redshift.types.string.String"]
...
def serialize_query(value: Subnet, pairs: list[tuple[str, str]], prefix: str) -> None:
    ...
    if "subnet_availability_zone" in value:
        ...
        aws_sdk_redshift.types.availability_zone.serialize_query(
...
def deserialize_query(el: Element) -> Subnet:
    ...
    if child_subnet_availability_zone is not None:
        ...
        out["subnet_availability_zone"] = (
            aws_sdk_redshift.types.availability_zone.deserialize_query(
