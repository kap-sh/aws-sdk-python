"""Generated from Smithy shape ``com.amazonaws.redshift#CreateAuthenticationProfileMessage``."""
...
class CreateAuthenticationProfileMessage(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: CreateAuthenticationProfileMessage, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> CreateAuthenticationProfileMessage:
    out: CreateAuthenticationProfileMessage = {}  # type: ignore[typeddict-item]
