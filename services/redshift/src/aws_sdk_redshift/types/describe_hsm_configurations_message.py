...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeHsmConfigurationsMessage, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DescribeHsmConfigurationsMessage:
    out: DescribeHsmConfigurationsMessage = {}  # type: ignore[typeddict-item]
