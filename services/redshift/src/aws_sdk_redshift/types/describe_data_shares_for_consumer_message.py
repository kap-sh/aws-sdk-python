...
class DescribeDataSharesForConsumerMessage(TypedDict):
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_redshift.types.data_share_status_for_consumer.serialize_query(
...
def deserialize_query(el: Element) -> DescribeDataSharesForConsumerMessage:
    ...
    if child_status is not None:
        ...
        out["status"] = (
            aws_sdk_redshift.types.data_share_status_for_consumer.deserialize_query(
                child_status
            )
        )
