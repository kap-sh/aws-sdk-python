...
class EndpointAuthorization(TypedDict):
    grantor: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The Amazon Web Services account ID of the cluster owner.</p>"""
    grantee: NotRequired["aws_sdk_redshift.types.string.String"]
    ...
    authorize_time: NotRequired["aws_sdk_redshift.types.t_stamp.TStamp"]
    """<p>The time (UTC) when the authorization was created.</p>"""
    cluster_status: NotRequired["aws_sdk_redshift.types.string.String"]
    """<p>The status of the cluster.</p>"""
    status: NotRequired[
        "aws_sdk_redshift.types.authorization_status.AuthorizationStatus"
    ]
    """<p>The status of the authorization action.</p>"""
    allowed_all_vp_cs: NotRequired["aws_sdk_redshift.types.boolean.Boolean"]
    ...
    endpoint_count: NotRequired["aws_sdk_redshift.types.integer.Integer"]
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_redshift.types.authorization_status.serialize_query(
...
def deserialize_query(el: Element) -> EndpointAuthorization:
    ...
    if child_authorize_time is not None:
        ...
        out["authorize_time"] = aws_sdk_redshift.types.t_stamp.deserialize_query(
    ...
    if child_status is not None:
        ...
        out["status"] = aws_sdk_redshift.types.authorization_status.deserialize_query(
            child_status
        )
    ...
    if child_allowed_vp_cs is not None:
        ...
        out["allowed_vp_cs"] = (
            aws_sdk_redshift.types.vpc_identifier_list.deserialize_query(
                child_allowed_vp_cs
            )
        )
