...
class ScheduledAction(TypedDict):
    ...
    """<p>A JSON format string of the Amazon Redshift API operation with input parameters. </p> <p>\"<code>{\\"ResizeCluster\\":{\\"NodeType\\":\\"ra3.4xlarge\\",\\"ClusterIdentifier\\":\\"my-test-cluster\\",\\"NumberOfNodes\\":3}}</code>\". </p>"""
