"""Generated from Smithy shape ``com.amazonaws.redshift#ClusterSubnetGroupAlreadyExistsFault``."""
...
class ClusterSubnetGroupAlreadyExistsFault_(TypedDict, closed=True):
    message: NotRequired["aws_sdk_redshift.types.exception_message.ExceptionMessage"]


# --- awsQuery ser/de ---
def serialize_query(
    value: ClusterSubnetGroupAlreadyExistsFault_,
...
def deserialize_query(el: Element) -> ClusterSubnetGroupAlreadyExistsFault_:
    out: ClusterSubnetGroupAlreadyExistsFault_ = {}  # type: ignore[typeddict-item]
...
class ClusterSubnetGroupAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#ClusterSubnetGroupAlreadyExistsFault``."""
