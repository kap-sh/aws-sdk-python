"""Generated from Smithy shape ``com.amazonaws.redshift#IntegrationConflictOperationFault``."""
...
class IntegrationConflictOperationFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#IntegrationConflictOperationFault``."""
    ...
    @classmethod
    def from_query(cls, el: Element) -> "IntegrationConflictOperationFault":
