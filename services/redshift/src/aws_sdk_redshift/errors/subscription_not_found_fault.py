"""Generated from Smithy shape ``com.amazonaws.redshift#SubscriptionNotFoundFault``."""
...
class SubscriptionNotFoundFault_(TypedDict):
...
class SubscriptionNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#SubscriptionNotFoundFault``."""
