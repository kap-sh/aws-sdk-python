"""Generated from Smithy shape ``com.amazonaws.redshift#ScheduledActionTypeUnsupportedFault``."""
...
class ScheduledActionTypeUnsupportedFault_(TypedDict, closed=True):
    message: NotRequired["aws_sdk_redshift.types.exception_message.ExceptionMessage"]


# --- awsQuery ser/de ---
def serialize_query(
    value: ScheduledActionTypeUnsupportedFault_,
...
def deserialize_query(el: Element) -> ScheduledActionTypeUnsupportedFault_:
    out: ScheduledActionTypeUnsupportedFault_ = {}  # type: ignore[typeddict-item]
...
class ScheduledActionTypeUnsupportedFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#ScheduledActionTypeUnsupportedFault``."""
