...
class RedshiftError(Exception):
    """Base class for all Redshift service errors."""


class ServiceError(RedshiftError):
...
class SerializationError(RedshiftError):
    """Raised when a value cannot be serialized."""


class DeserializationError(RedshiftError):
...
class WaiterFailedError(RedshiftError):
...
class WaiterTimeoutError(RedshiftError):
