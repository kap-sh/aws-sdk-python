"""Generated from Smithy shape ``com.amazonaws.redshift#CopyClusterSnapshotResult``."""
...
class CopyClusterSnapshotResult(TypedDict, closed=True):
    snapshot: NotRequired["capo_redshift.types.snapshot.Snapshot"]


# --- awsQuery ser/de ---
def serialize_query(
    value: CopyClusterSnapshotResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> CopyClusterSnapshotResult:
    out: CopyClusterSnapshotResult = {}  # type: ignore[typeddict-item]
