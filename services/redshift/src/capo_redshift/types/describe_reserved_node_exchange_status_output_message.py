...
class DescribeReservedNodeExchangeStatusOutputMessage(TypedDict, closed=True):
    reserved_node_exchange_status_details: NotRequired[
        "capo_redshift.types.reserved_node_exchange_status_list.ReservedNodeExchangeStatusList"
    ]
...
def serialize_query(
    ...
    if "reserved_node_exchange_status_details" in value:
        ...
        capo_redshift.types.reserved_node_exchange_status_list.serialize_query(
            value["reserved_node_exchange_status_details"],
            pairs,
            f"{key_prefix}ReservedNodeExchangeStatusDetails",
        )
    if "marker" in value:
...
def deserialize_query(el: Element) -> DescribeReservedNodeExchangeStatusOutputMessage:
    ...
    if child_reserved_node_exchange_status_details is not None:
        ...
        out["reserved_node_exchange_status_details"] = (
            capo_redshift.types.reserved_node_exchange_status_list.deserialize_query(
