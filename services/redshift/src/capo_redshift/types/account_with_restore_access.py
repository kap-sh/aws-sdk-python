...
class AccountWithRestoreAccess(TypedDict, closed=True):
    account_id: NotRequired["capo_redshift.types.string.String"]
    """<p>The identifier of an Amazon Web Services account authorized to restore a snapshot.</p>"""
    account_alias: NotRequired["capo_redshift.types.string.String"]
