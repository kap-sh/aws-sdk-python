"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeDataSharesForConsumerResult``."""
...
class DescribeDataSharesForConsumerResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeDataSharesForConsumerResult,
...
def deserialize_query(el: Element) -> DescribeDataSharesForConsumerResult:
    out: DescribeDataSharesForConsumerResult = {}  # type: ignore[typeddict-item]
