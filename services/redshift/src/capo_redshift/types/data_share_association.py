...
class DataShareAssociation(TypedDict, closed=True):
    ...
    status: NotRequired["capo_redshift.types.data_share_status.DataShareStatus"]
    """<p>The status of the datashare that is associated.</p>"""
    consumer_region: NotRequired["capo_redshift.types.string.String"]
    """<p>The Amazon Web Services Region of the consumer accounts that have an association with a producer datashare.</p>"""
    created_date: NotRequired["capo_redshift.types.t_stamp.TStamp"]
    """<p>The creation date of the datashare that is associated.</p>"""
    status_change_date: NotRequired["capo_redshift.types.t_stamp.TStamp"]
...
def deserialize_query(el: Element) -> DataShareAssociation:
    ...
    if child_status is not None:
        ...
        out["status"] = capo_redshift.types.data_share_status.deserialize_query(
            child_status
        )
    ...
    if child_created_date is not None:
        ...
        out["created_date"] = capo_redshift.types.t_stamp.deserialize_query(
            child_created_date
        )
    ...
    if child_status_change_date is not None:
        ...
        out["status_change_date"] = capo_redshift.types.t_stamp.deserialize_query(
