...
class CopyClusterSnapshotMessage(TypedDict, closed=True):
    source_snapshot_identifier: NotRequired["capo_redshift.types.string.String"]
    ...
    source_snapshot_cluster_identifier: NotRequired["capo_redshift.types.string.String"]
    ...
    target_snapshot_identifier: NotRequired["capo_redshift.types.string.String"]
