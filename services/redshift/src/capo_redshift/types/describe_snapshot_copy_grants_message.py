"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeSnapshotCopyGrantsMessage``."""
...
class DescribeSnapshotCopyGrantsMessage(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeSnapshotCopyGrantsMessage, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DescribeSnapshotCopyGrantsMessage:
    out: DescribeSnapshotCopyGrantsMessage = {}  # type: ignore[typeddict-item]
