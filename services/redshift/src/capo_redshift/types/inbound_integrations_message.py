...
if TYPE_CHECKING:
    import capo_redshift.types.inbound_integration_list
    import capo_redshift.types.string


class InboundIntegrationsMessage(TypedDict, closed=True):
    ...
    inbound_integrations: NotRequired[
        "capo_redshift.types.inbound_integration_list.InboundIntegrationList"
    ]
...
def serialize_query(
    ...
    if "inbound_integrations" in value:
        ...
        capo_redshift.types.inbound_integration_list.serialize_query(
            value["inbound_integrations"], pairs, f"{key_prefix}InboundIntegrations"
        )
...
def deserialize_query(el: Element) -> InboundIntegrationsMessage:
    ...
    if child_inbound_integrations is not None:
        ...
        out["inbound_integrations"] = (
            capo_redshift.types.inbound_integration_list.deserialize_query(
