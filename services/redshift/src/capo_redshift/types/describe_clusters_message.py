...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeClustersMessage, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DescribeClustersMessage:
    out: DescribeClustersMessage = {}  # type: ignore[typeddict-item]
