...
class ModifySnapshotCopyRetentionPeriodMessage(TypedDict, closed=True):
    ...
    retention_period: NotRequired["capo_redshift.types.integer.Integer"]
    ...
    manual: NotRequired["capo_redshift.types.boolean.Boolean"]
