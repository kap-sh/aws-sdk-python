...
class NodeConfigurationOptionsFilter(TypedDict, closed=True):
    name: NotRequired[
        "capo_redshift.types.node_configuration_options_filter_name.NodeConfigurationOptionsFilterName"
    ]
    """<p>The name of the element to filter.</p>"""
    operator: NotRequired["capo_redshift.types.operator_type.OperatorType"]
...
def deserialize_query(el: Element) -> NodeConfigurationOptionsFilter:
    ...
    if child_name is not None:
        ...
        out["name"] = (
            capo_redshift.types.node_configuration_options_filter_name.deserialize_query(
                child_name
            )
        )
    ...
    if child_operator is not None:
        ...
        out["operator"] = capo_redshift.types.operator_type.deserialize_query(
            child_operator
        )
