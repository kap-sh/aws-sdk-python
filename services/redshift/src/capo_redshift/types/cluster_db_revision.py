...
class ClusterDbRevision(TypedDict, closed=True):
    ...
    current_database_revision: NotRequired["capo_redshift.types.string.String"]
    ...
    revision_targets: NotRequired[
        "capo_redshift.types.revision_targets_list.RevisionTargetsList"
    ]
...
def deserialize_query(el: Element) -> ClusterDbRevision:
    ...
    if child_revision_targets is not None:
        ...
        out["revision_targets"] = (
            capo_redshift.types.revision_targets_list.deserialize_query(
