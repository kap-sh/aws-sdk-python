...
class Subnet(TypedDict, closed=True):
    subnet_identifier: NotRequired["capo_redshift.types.string.String"]
    """<p>The identifier of the subnet.</p>"""
    subnet_availability_zone: NotRequired[
        "capo_redshift.types.availability_zone.AvailabilityZone"
    ]
    """<p></p>"""
    subnet_status: NotRequired["capo_redshift.types.string.String"]
...
def deserialize_query(el: Element) -> Subnet:
    ...
    if child_subnet_availability_zone is not None:
        ...
        out["subnet_availability_zone"] = (
            capo_redshift.types.availability_zone.deserialize_query(
