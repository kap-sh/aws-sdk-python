...
if TYPE_CHECKING:
    import capo_redshift.types.eligible_tracks_to_update_list
    import capo_redshift.types.string


class MaintenanceTrack(TypedDict, closed=True):
    ...
    database_version: NotRequired["capo_redshift.types.string.String"]
    """<p>The version number for the cluster release.</p>"""
    update_targets: NotRequired[
        "capo_redshift.types.eligible_tracks_to_update_list.EligibleTracksToUpdateList"
    ]
...
def serialize_query(
    ...
    if "update_targets" in value:
        ...
        capo_redshift.types.eligible_tracks_to_update_list.serialize_query(
            value["update_targets"], pairs, f"{key_prefix}UpdateTargets"
        )
...
def deserialize_query(el: Element) -> MaintenanceTrack:
    ...
    if child_update_targets is not None:
        ...
        out["update_targets"] = (
            capo_redshift.types.eligible_tracks_to_update_list.deserialize_query(
