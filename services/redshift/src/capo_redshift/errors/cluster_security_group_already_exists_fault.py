"""Generated from Smithy shape ``com.amazonaws.redshift#ClusterSecurityGroupAlreadyExistsFault``."""
...
class ClusterSecurityGroupAlreadyExistsFault_(TypedDict, closed=True):
    message: NotRequired["capo_redshift.types.exception_message.ExceptionMessage"]


# --- awsQuery ser/de ---
def serialize_query(
    value: ClusterSecurityGroupAlreadyExistsFault_,
...
def deserialize_query(el: Element) -> ClusterSecurityGroupAlreadyExistsFault_:
    out: ClusterSecurityGroupAlreadyExistsFault_ = {}  # type: ignore[typeddict-item]
...
class ClusterSecurityGroupAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#ClusterSecurityGroupAlreadyExistsFault``."""
