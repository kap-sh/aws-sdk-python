"""Generated from Smithy shape ``com.amazonaws.redshift#AuthorizationQuotaExceededFault``."""
...
class AuthorizationQuotaExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#AuthorizationQuotaExceededFault``."""

    code: str | None = "AuthorizationQuotaExceededFault"

    def __init__(self, data: AuthorizationQuotaExceededFault_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_query(cls, el: Element) -> "AuthorizationQuotaExceededFault":
