"""Generated from Smithy shape ``com.amazonaws.redshift#AuthenticationProfileNotFoundFault``."""
...
class AuthenticationProfileNotFoundFault_(TypedDict, closed=True):
    message: NotRequired["capo_redshift.types.exception_message.ExceptionMessage"]


# --- awsQuery ser/de ---
def serialize_query(
    value: AuthenticationProfileNotFoundFault_,
...
def deserialize_query(el: Element) -> AuthenticationProfileNotFoundFault_:
    out: AuthenticationProfileNotFoundFault_ = {}  # type: ignore[typeddict-item]
...
class AuthenticationProfileNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#AuthenticationProfileNotFoundFault``."""
