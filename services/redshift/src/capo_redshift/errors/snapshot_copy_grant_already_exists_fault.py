"""Generated from Smithy shape ``com.amazonaws.redshift#SnapshotCopyGrantAlreadyExistsFault``."""
...
class SnapshotCopyGrantAlreadyExistsFault_(TypedDict, closed=True):
    message: NotRequired["capo_redshift.types.exception_message.ExceptionMessage"]


# --- awsQuery ser/de ---
def serialize_query(
    value: SnapshotCopyGrantAlreadyExistsFault_,
...
def deserialize_query(el: Element) -> SnapshotCopyGrantAlreadyExistsFault_:
    out: SnapshotCopyGrantAlreadyExistsFault_ = {}  # type: ignore[typeddict-item]
...
class SnapshotCopyGrantAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#SnapshotCopyGrantAlreadyExistsFault``."""
