"""Generated from Smithy shape ``com.amazonaws.redshift#GetIdentityCenterAuthToken``."""
...
import capo_redshift.errors.redshift_invalid_parameter_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RedshiftInvalidParameterFault":
            raise capo_redshift.errors.redshift_invalid_parameter_fault.RedshiftInvalidParameterFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetIdentityCenterAuthTokenResult")
    out: capo_redshift.types.get_identity_center_auth_token_response.GetIdentityCenterAuthTokenResponse = capo_redshift.types.get_identity_center_auth_token_response.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.get_identity_center_auth_token_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_identity_center_auth_token(
