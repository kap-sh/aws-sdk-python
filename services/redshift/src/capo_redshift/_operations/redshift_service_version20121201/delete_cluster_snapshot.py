"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteClusterSnapshot``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteClusterSnapshotResult")
    out: capo_redshift.types.delete_cluster_snapshot_result.DeleteClusterSnapshotResult = capo_redshift.types.delete_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteClusterSnapshot"))
