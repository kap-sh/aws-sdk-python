"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyEndpointAccess``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyEndpointAccessResult")
...
def build_request(
    ...
    capo_redshift.types.modify_endpoint_access_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_endpoint_access(
