"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteSnapshotSchedule``."""
...
def build_request(
    ...
    pairs.append(("Action", "DeleteSnapshotSchedule"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.delete_snapshot_schedule_message.serialize_query(
        input_, pairs, ""
    )
