"""Generated from Smithy shape ``com.amazonaws.redshift#GetResourcePolicy``."""
...
import capo_redshift.errors.invalid_policy_fault
import capo_redshift.errors.resource_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidPolicyFault":
            raise capo_redshift.errors.invalid_policy_fault.InvalidPolicyFault.from_query(
                root
            )
        case "ResourceNotFoundFault":
            raise capo_redshift.errors.resource_not_found_fault.ResourceNotFoundFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetResourcePolicyResult")
    out: capo_redshift.types.get_resource_policy_result.GetResourcePolicyResult = (
        capo_redshift.types.get_resource_policy_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.get_resource_policy_message.serialize_query(input_, pairs, "")
