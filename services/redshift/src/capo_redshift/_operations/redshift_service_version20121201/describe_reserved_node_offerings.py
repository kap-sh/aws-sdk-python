...
def handle_response(
    ...
    out: capo_redshift.types.reserved_node_offerings_message.ReservedNodeOfferingsMessage = capo_redshift.types.reserved_node_offerings_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_reserved_node_offerings_message.serialize_query(
        input_, pairs, ""
    )
