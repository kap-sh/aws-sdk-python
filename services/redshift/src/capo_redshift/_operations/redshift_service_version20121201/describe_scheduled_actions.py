"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeScheduledActions``."""
...
def handle_response(
    ...
    out: capo_redshift.types.scheduled_actions_message.ScheduledActionsMessage = (
        capo_redshift.types.scheduled_actions_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_scheduled_actions_message.serialize_query(
        input_, pairs, ""
    )
