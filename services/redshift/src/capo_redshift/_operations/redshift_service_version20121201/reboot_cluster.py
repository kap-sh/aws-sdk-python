"""Generated from Smithy shape ``com.amazonaws.redshift#RebootCluster``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("RebootClusterResult")
    out: capo_redshift.types.reboot_cluster_result.RebootClusterResult = (
        capo_redshift.types.reboot_cluster_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "RebootCluster"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.reboot_cluster_message.serialize_query(input_, pairs, "")
...
def reboot_cluster(
    ...
    capo_redshift.types.reboot_cluster_result.RebootClusterResult, zapros.Response
]:
...
async def async_reboot_cluster(
