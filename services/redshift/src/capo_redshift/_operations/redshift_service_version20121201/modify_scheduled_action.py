"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyScheduledAction``."""
...
import capo_redshift.errors.invalid_scheduled_action_fault
import capo_redshift.errors.scheduled_action_not_found_fault
import capo_redshift.errors.scheduled_action_type_unsupported_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidScheduledActionFault":
            raise capo_redshift.errors.invalid_scheduled_action_fault.InvalidScheduledActionFault.from_query(
                root
            )
        ...
        case "ScheduledActionNotFoundFault":
            raise capo_redshift.errors.scheduled_action_not_found_fault.ScheduledActionNotFoundFault.from_query(
                root
            )
        case "ScheduledActionTypeUnsupportedFault":
            raise capo_redshift.errors.scheduled_action_type_unsupported_fault.ScheduledActionTypeUnsupportedFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyScheduledActionResult")
    out: capo_redshift.types.scheduled_action.ScheduledAction = (
        capo_redshift.types.scheduled_action.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyScheduledAction"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.modify_scheduled_action_message.serialize_query(
        input_, pairs, ""
    )
...
def modify_scheduled_action(
    ...
    input_: capo_redshift.types.modify_scheduled_action_message.ModifyScheduledActionMessage,
) -> tuple[capo_redshift.types.scheduled_action.ScheduledAction, zapros.Response]:
...
async def async_modify_scheduled_action(
