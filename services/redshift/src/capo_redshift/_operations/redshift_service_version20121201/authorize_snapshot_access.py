...
def handle_response(
    ...
    out: capo_redshift.types.authorize_snapshot_access_result.AuthorizeSnapshotAccessResult = capo_redshift.types.authorize_snapshot_access_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.authorize_snapshot_access_message.serialize_query(
        input_, pairs, ""
    )
