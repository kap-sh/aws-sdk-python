"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeEndpointAccess``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeEndpointAccessResult")
    out: capo_redshift.types.endpoint_access_list.EndpointAccessList = (
        capo_redshift.types.endpoint_access_list.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeEndpointAccess"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_endpoint_access_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_endpoint_access(
    ...
    capo_redshift.types.endpoint_access_list.EndpointAccessList, zapros.Response
]:
...
async def async_describe_endpoint_access(
