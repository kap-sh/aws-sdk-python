"""Generated from Smithy shape ``com.amazonaws.redshift#CreateHsmClientCertificate``."""
...
import capo_redshift.errors.hsm_client_certificate_already_exists_fault
import capo_redshift.errors.hsm_client_certificate_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "HsmClientCertificateAlreadyExistsFault":
            raise capo_redshift.errors.hsm_client_certificate_already_exists_fault.HsmClientCertificateAlreadyExistsFault.from_query(
                root
            )
        case "HsmClientCertificateQuotaExceededFault":
            raise capo_redshift.errors.hsm_client_certificate_quota_exceeded_fault.HsmClientCertificateQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_redshift.types.create_hsm_client_certificate_result.CreateHsmClientCertificateResult = capo_redshift.types.create_hsm_client_certificate_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateHsmClientCertificate"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.create_hsm_client_certificate_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_hsm_client_certificate(
