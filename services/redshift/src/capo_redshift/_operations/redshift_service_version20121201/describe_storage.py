"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeStorage``."""
...
def handle_response(
    ...
    out: capo_redshift.types.customer_storage_message.CustomerStorageMessage = (
        capo_redshift.types.customer_storage_message.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "DescribeStorage"))
...
def describe_storage(
    ...
    capo_redshift.types.customer_storage_message.CustomerStorageMessage, zapros.Response
]:
...
async def async_describe_storage(
