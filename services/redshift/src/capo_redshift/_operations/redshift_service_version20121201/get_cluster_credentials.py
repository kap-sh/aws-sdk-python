"""Generated from Smithy shape ``com.amazonaws.redshift#GetClusterCredentials``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetClusterCredentialsResult")
    out: capo_redshift.types.cluster_credentials.ClusterCredentials = (
        capo_redshift.types.cluster_credentials.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetClusterCredentials"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.get_cluster_credentials_message.serialize_query(
        input_, pairs, ""
    )
...
def get_cluster_credentials(
    ...
    input_: capo_redshift.types.get_cluster_credentials_message.GetClusterCredentialsMessage,
) -> tuple[capo_redshift.types.cluster_credentials.ClusterCredentials, zapros.Response]:
...
async def async_get_cluster_credentials(
