"""Generated from Smithy shape ``com.amazonaws.redshift#PurchaseReservedNodeOffering``."""
...
import capo_redshift.errors.reserved_node_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ReservedNodeQuotaExceededFault":
            raise capo_redshift.errors.reserved_node_quota_exceeded_fault.ReservedNodeQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_redshift.types.purchase_reserved_node_offering_result.PurchaseReservedNodeOfferingResult = capo_redshift.types.purchase_reserved_node_offering_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "PurchaseReservedNodeOffering"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.purchase_reserved_node_offering_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_purchase_reserved_node_offering(
