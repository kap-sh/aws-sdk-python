"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteEndpointAccess``."""
...
import capo_redshift.errors.endpoint_not_found_fault
...
import capo_redshift.errors.invalid_endpoint_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EndpointNotFoundFault":
            raise capo_redshift.errors.endpoint_not_found_fault.EndpointNotFoundFault.from_query(
                root
            )
        ...
        case "InvalidEndpointStateFault":
            raise capo_redshift.errors.invalid_endpoint_state_fault.InvalidEndpointStateFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteEndpointAccessResult")
...
def build_request(
    ...
    capo_redshift.types.delete_endpoint_access_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_endpoint_access(
