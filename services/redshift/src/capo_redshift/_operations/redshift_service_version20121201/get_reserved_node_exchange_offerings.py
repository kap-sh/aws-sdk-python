"""Generated from Smithy shape ``com.amazonaws.redshift#GetReservedNodeExchangeOfferings``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetReservedNodeExchangeOfferingsResult")
    out: capo_redshift.types.get_reserved_node_exchange_offerings_output_message.GetReservedNodeExchangeOfferingsOutputMessage = capo_redshift.types.get_reserved_node_exchange_offerings_output_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetReservedNodeExchangeOfferings"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.get_reserved_node_exchange_offerings_input_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_reserved_node_exchange_offerings(
