"""Generated from Smithy shape ``com.amazonaws.redshift#CreateRedshiftIdcApplication``."""
...
import capo_redshift.errors.redshift_idc_application_already_exists_fault
import capo_redshift.errors.redshift_idc_application_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RedshiftIdcApplicationAlreadyExistsFault":
            raise capo_redshift.errors.redshift_idc_application_already_exists_fault.RedshiftIdcApplicationAlreadyExistsFault.from_query(
                root
            )
        case "RedshiftIdcApplicationQuotaExceededFault":
            raise capo_redshift.errors.redshift_idc_application_quota_exceeded_fault.RedshiftIdcApplicationQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_redshift.types.create_redshift_idc_application_result.CreateRedshiftIdcApplicationResult = capo_redshift.types.create_redshift_idc_application_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateRedshiftIdcApplication"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.create_redshift_idc_application_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_redshift_idc_application(
