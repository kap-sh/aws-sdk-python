"""Generated from Smithy shape ``com.amazonaws.redshift#AcceptReservedNodeExchange``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("AcceptReservedNodeExchangeResult")
    out: capo_redshift.types.accept_reserved_node_exchange_output_message.AcceptReservedNodeExchangeOutputMessage = capo_redshift.types.accept_reserved_node_exchange_output_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "AcceptReservedNodeExchange"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.accept_reserved_node_exchange_input_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_accept_reserved_node_exchange(
