"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyClusterDbRevision``."""
...
import capo_redshift.errors.cluster_on_latest_revision_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ClusterOnLatestRevisionFault":
            raise capo_redshift.errors.cluster_on_latest_revision_fault.ClusterOnLatestRevisionFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyClusterDbRevisionResult")
    out: capo_redshift.types.modify_cluster_db_revision_result.ModifyClusterDbRevisionResult = capo_redshift.types.modify_cluster_db_revision_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.modify_cluster_db_revision_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_cluster_db_revision(
