"""Generated from Smithy shape ``com.amazonaws.redshift#AuthorizeDataShare``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("AuthorizeDataShareResult")
...
def build_request(
    ...
    pairs.append(("Action", "AuthorizeDataShare"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.authorize_data_share_message.serialize_query(input_, pairs, "")
...
async def async_authorize_data_share(
