"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeDataSharesForProducer``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeDataSharesForProducerResult")
    out: capo_redshift.types.describe_data_shares_for_producer_result.DescribeDataSharesForProducerResult = capo_redshift.types.describe_data_shares_for_producer_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_data_shares_for_producer_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_data_shares_for_producer(
