"""Generated from Smithy shape ``com.amazonaws.redshift#ModifySnapshotSchedule``."""
...
import capo_redshift.errors.snapshot_schedule_update_in_progress_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SnapshotScheduleUpdateInProgressFault":
            raise capo_redshift.errors.snapshot_schedule_update_in_progress_fault.SnapshotScheduleUpdateInProgressFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    pairs.append(("Action", "ModifySnapshotSchedule"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.modify_snapshot_schedule_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_snapshot_schedule(
