...
import capo_redshift.errors.access_to_cluster_denied_fault
import capo_redshift.errors.cluster_not_found_fault
import capo_redshift.errors.cluster_subnet_group_not_found_fault
import capo_redshift.errors.endpoint_already_exists_fault
import capo_redshift.errors.endpoints_per_authorization_limit_exceeded_fault
import capo_redshift.errors.endpoints_per_cluster_limit_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessToClusterDeniedFault":
            raise capo_redshift.errors.access_to_cluster_denied_fault.AccessToClusterDeniedFault.from_query(
                root
            )
        ...
        case "EndpointAlreadyExistsFault":
            raise capo_redshift.errors.endpoint_already_exists_fault.EndpointAlreadyExistsFault.from_query(
                root
            )
        case "EndpointsPerAuthorizationLimitExceededFault":
            raise capo_redshift.errors.endpoints_per_authorization_limit_exceeded_fault.EndpointsPerAuthorizationLimitExceededFault.from_query(
                root
            )
        case "EndpointsPerClusterLimitExceededFault":
            raise capo_redshift.errors.endpoints_per_cluster_limit_exceeded_fault.EndpointsPerClusterLimitExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_redshift.types.endpoint_access.EndpointAccess = (
        capo_redshift.types.endpoint_access.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.create_endpoint_access_message.serialize_query(
        input_, pairs, ""
    )
...
def create_endpoint_access(
    ...
    input_: capo_redshift.types.create_endpoint_access_message.CreateEndpointAccessMessage,
) -> tuple[capo_redshift.types.endpoint_access.EndpointAccess, zapros.Response]:
