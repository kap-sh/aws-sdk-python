"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeClusterSnapshots``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeClusterSnapshotsResult")
    out: capo_redshift.types.snapshot_message.SnapshotMessage = (
        capo_redshift.types.snapshot_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeClusterSnapshots"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_cluster_snapshots_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_cluster_snapshots(
    ...
    input_: capo_redshift.types.describe_cluster_snapshots_message.DescribeClusterSnapshotsMessage,
) -> tuple[capo_redshift.types.snapshot_message.SnapshotMessage, zapros.Response]:
...
async def async_describe_cluster_snapshots(
