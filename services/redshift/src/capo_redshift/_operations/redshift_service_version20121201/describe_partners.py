"""Generated from Smithy shape ``com.amazonaws.redshift#DescribePartners``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribePartnersResult")
    out: capo_redshift.types.describe_partners_output_message.DescribePartnersOutputMessage = capo_redshift.types.describe_partners_output_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribePartners"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_partners_input_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_partners(
