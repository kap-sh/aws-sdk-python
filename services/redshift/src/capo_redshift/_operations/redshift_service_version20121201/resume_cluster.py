"""Generated from Smithy shape ``com.amazonaws.redshift#ResumeCluster``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ResumeClusterResult")
    out: capo_redshift.types.resume_cluster_result.ResumeClusterResult = (
        capo_redshift.types.resume_cluster_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ResumeCluster"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.resume_cluster_message.serialize_query(input_, pairs, "")
...
def resume_cluster(
    ...
    capo_redshift.types.resume_cluster_result.ResumeClusterResult, zapros.Response
]:
...
async def async_resume_cluster(
