"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteHsmConfiguration``."""
...
import capo_redshift.errors.invalid_hsm_configuration_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidHsmConfigurationStateFault":
            raise capo_redshift.errors.invalid_hsm_configuration_state_fault.InvalidHsmConfigurationStateFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    pairs.append(("Action", "DeleteHsmConfiguration"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.delete_hsm_configuration_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_hsm_configuration(
