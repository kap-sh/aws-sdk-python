"""Generated from Smithy shape ``com.amazonaws.redshift#CreateEventSubscription``."""
...
import capo_redshift.errors.event_subscription_quota_exceeded_fault
...
import capo_redshift.errors.subscription_already_exist_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "EventSubscriptionQuotaExceededFault":
            raise capo_redshift.errors.event_subscription_quota_exceeded_fault.EventSubscriptionQuotaExceededFault.from_query(
                root
            )
        ...
        case "SubscriptionAlreadyExistFault":
            raise capo_redshift.errors.subscription_already_exist_fault.SubscriptionAlreadyExistFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_redshift.types.create_event_subscription_result.CreateEventSubscriptionResult = capo_redshift.types.create_event_subscription_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.create_event_subscription_message.serialize_query(
        input_, pairs, ""
    )
