"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyClusterIamRoles``."""
...
def handle_response(
    ...
    out: capo_redshift.types.modify_cluster_iam_roles_result.ModifyClusterIamRolesResult = capo_redshift.types.modify_cluster_iam_roles_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyClusterIamRoles"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.modify_cluster_iam_roles_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_cluster_iam_roles(
