"""Generated from Smithy shape ``com.amazonaws.redshift#CreateClusterSnapshot``."""
...
import capo_redshift.errors.cluster_snapshot_already_exists_fault
import capo_redshift.errors.cluster_snapshot_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ClusterSnapshotAlreadyExistsFault":
            raise capo_redshift.errors.cluster_snapshot_already_exists_fault.ClusterSnapshotAlreadyExistsFault.from_query(
                root
            )
        case "ClusterSnapshotQuotaExceededFault":
            raise capo_redshift.errors.cluster_snapshot_quota_exceeded_fault.ClusterSnapshotQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateClusterSnapshotResult")
    out: capo_redshift.types.create_cluster_snapshot_result.CreateClusterSnapshotResult = capo_redshift.types.create_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateClusterSnapshot"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.create_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
