"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeHsmClientCertificates``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeHsmClientCertificatesResult")
    out: capo_redshift.types.hsm_client_certificate_message.HsmClientCertificateMessage = capo_redshift.types.hsm_client_certificate_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_hsm_client_certificates_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_hsm_client_certificates(
