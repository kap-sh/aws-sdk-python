"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeCustomDomainAssociations``."""
...
import capo_redshift.errors.custom_domain_association_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CustomDomainAssociationNotFoundFault":
            raise capo_redshift.errors.custom_domain_association_not_found_fault.CustomDomainAssociationNotFoundFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeCustomDomainAssociationsResult")
    out: capo_redshift.types.custom_domain_associations_message.CustomDomainAssociationsMessage = capo_redshift.types.custom_domain_associations_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCustomDomainAssociations"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_custom_domain_associations_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_custom_domain_associations(
