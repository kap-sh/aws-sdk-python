"""Generated from Smithy shape ``com.amazonaws.redshift#GetClusterCredentialsWithIAM``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetClusterCredentialsWithIAMResult")
    out: capo_redshift.types.cluster_extended_credentials.ClusterExtendedCredentials = (
        capo_redshift.types.cluster_extended_credentials.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.get_cluster_credentials_with_iam_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_cluster_credentials_with_iam(
