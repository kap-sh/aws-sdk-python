"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeDataSharesForConsumer``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeDataSharesForConsumerResult")
    out: capo_redshift.types.describe_data_shares_for_consumer_result.DescribeDataSharesForConsumerResult = capo_redshift.types.describe_data_shares_for_consumer_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeDataSharesForConsumer"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_data_shares_for_consumer_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_data_shares_for_consumer(
