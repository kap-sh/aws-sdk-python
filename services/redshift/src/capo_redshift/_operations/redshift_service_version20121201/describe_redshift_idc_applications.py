"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeRedshiftIdcApplications``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeRedshiftIdcApplicationsResult")
    out: capo_redshift.types.describe_redshift_idc_applications_result.DescribeRedshiftIdcApplicationsResult = capo_redshift.types.describe_redshift_idc_applications_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeRedshiftIdcApplications"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_redshift_idc_applications_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_redshift_idc_applications(
