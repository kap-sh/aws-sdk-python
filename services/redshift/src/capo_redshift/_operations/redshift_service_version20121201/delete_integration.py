"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteIntegration``."""
...
import capo_redshift.errors.integration_conflict_state_fault
import capo_redshift.errors.integration_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IntegrationConflictStateFault":
            raise capo_redshift.errors.integration_conflict_state_fault.IntegrationConflictStateFault.from_query(
                root
            )
        case "IntegrationNotFoundFault":
            raise capo_redshift.errors.integration_not_found_fault.IntegrationNotFoundFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteIntegrationResult")
...
def build_request(
    ...
    pairs.append(("Action", "DeleteIntegration"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.delete_integration_message.serialize_query(input_, pairs, "")
