"""Generated from Smithy shape ``com.amazonaws.redshift#DeregisterNamespace``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeregisterNamespaceResult")
    out: capo_redshift.types.deregister_namespace_output_message.DeregisterNamespaceOutputMessage = capo_redshift.types.deregister_namespace_output_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeregisterNamespace"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.deregister_namespace_input_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_deregister_namespace(
