"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeEventSubscriptions``."""
...
def handle_response(
    ...
    out: capo_redshift.types.event_subscriptions_message.EventSubscriptionsMessage = (
        capo_redshift.types.event_subscriptions_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_event_subscriptions_message.serialize_query(
        input_, pairs, ""
    )
