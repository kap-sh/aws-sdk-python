"""Generated from Smithy shape ``com.amazonaws.redshift#DisableLogging``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DisableLoggingResult")
    out: capo_redshift.types.logging_status.LoggingStatus = (
        capo_redshift.types.logging_status.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableLogging"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.disable_logging_message.serialize_query(input_, pairs, "")
...
async def async_disable_logging(
