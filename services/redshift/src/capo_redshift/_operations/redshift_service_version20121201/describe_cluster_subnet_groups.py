"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeClusterSubnetGroups``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeClusterSubnetGroupsResult")
    out: capo_redshift.types.cluster_subnet_group_message.ClusterSubnetGroupMessage = (
        capo_redshift.types.cluster_subnet_group_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeClusterSubnetGroups"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_cluster_subnet_groups_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_cluster_subnet_groups(
