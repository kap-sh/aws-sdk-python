"""Generated from Smithy shape ``com.amazonaws.redshift#BatchDeleteClusterSnapshots``."""
...
import capo_redshift.errors.batch_delete_request_size_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BatchDeleteRequestSizeExceededFault":
            raise capo_redshift.errors.batch_delete_request_size_exceeded_fault.BatchDeleteRequestSizeExceededFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_redshift.types.batch_delete_cluster_snapshots_result.BatchDeleteClusterSnapshotsResult = capo_redshift.types.batch_delete_cluster_snapshots_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.batch_delete_cluster_snapshots_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_batch_delete_cluster_snapshots(
