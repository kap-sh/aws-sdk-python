"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteCluster``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteClusterResult")
    out: capo_redshift.types.delete_cluster_result.DeleteClusterResult = (
        capo_redshift.types.delete_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.delete_cluster_message.serialize_query(input_, pairs, "")
...
def delete_cluster(
    ...
    capo_redshift.types.delete_cluster_result.DeleteClusterResult, zapros.Response
]:
