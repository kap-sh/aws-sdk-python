"""Generated from Smithy shape ``com.amazonaws.redshift#EnableSnapshotCopy``."""
...
import capo_redshift.errors.copy_to_region_disabled_fault
import capo_redshift.errors.dependent_service_request_throttling_fault
import capo_redshift.errors.incompatible_orderable_options
...
import capo_redshift.errors.snapshot_copy_already_enabled_fault
import capo_redshift.errors.snapshot_copy_grant_not_found_fault
import capo_redshift.errors.unauthorized_operation
import capo_redshift.errors.unknown_snapshot_copy_region_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CopyToRegionDisabledFault":
            raise capo_redshift.errors.copy_to_region_disabled_fault.CopyToRegionDisabledFault.from_query(
                root
            )
        ...
        case "IncompatibleOrderableOptions":
            raise capo_redshift.errors.incompatible_orderable_options.IncompatibleOrderableOptions.from_query(
                root
            )
        ...
        case "SnapshotCopyAlreadyEnabledFault":
            raise capo_redshift.errors.snapshot_copy_already_enabled_fault.SnapshotCopyAlreadyEnabledFault.from_query(
                root
            )
        case "SnapshotCopyGrantNotFoundFault":
            raise capo_redshift.errors.snapshot_copy_grant_not_found_fault.SnapshotCopyGrantNotFoundFault.from_query(
                root
            )
        ...
        case "UnknownSnapshotCopyRegionFault":
            raise capo_redshift.errors.unknown_snapshot_copy_region_fault.UnknownSnapshotCopyRegionFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("EnableSnapshotCopyResult")
    out: capo_redshift.types.enable_snapshot_copy_result.EnableSnapshotCopyResult = (
        capo_redshift.types.enable_snapshot_copy_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "EnableSnapshotCopy"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.enable_snapshot_copy_message.serialize_query(input_, pairs, "")
...
async def async_enable_snapshot_copy(
