...
def handle_response(
    ...
    out: capo_redshift.types.describe_default_cluster_parameters_result.DescribeDefaultClusterParametersResult = capo_redshift.types.describe_default_cluster_parameters_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_default_cluster_parameters_message.serialize_query(
        input_, pairs, ""
    )
