"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteClusterParameterGroup``."""
...
import capo_redshift.errors.invalid_cluster_parameter_group_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidClusterParameterGroupStateFault":
            raise capo_redshift.errors.invalid_cluster_parameter_group_state_fault.InvalidClusterParameterGroupStateFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    pairs.append(("Action", "DeleteClusterParameterGroup"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.delete_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_cluster_parameter_group(
