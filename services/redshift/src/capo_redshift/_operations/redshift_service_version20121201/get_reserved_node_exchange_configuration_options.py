"""Generated from Smithy shape ``com.amazonaws.redshift#GetReservedNodeExchangeConfigurationOptions``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetReservedNodeExchangeConfigurationOptionsResult")
    out: capo_redshift.types.get_reserved_node_exchange_configuration_options_output_message.GetReservedNodeExchangeConfigurationOptionsOutputMessage = capo_redshift.types.get_reserved_node_exchange_configuration_options_output_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.get_reserved_node_exchange_configuration_options_input_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_reserved_node_exchange_configuration_options(
