"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeClusters``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeClustersResult")
    out: capo_redshift.types.clusters_message.ClustersMessage = (
        capo_redshift.types.clusters_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeClusters"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_clusters_message.serialize_query(input_, pairs, "")
...
def describe_clusters(
    ...
    input_: capo_redshift.types.describe_clusters_message.DescribeClustersMessage,
) -> tuple[capo_redshift.types.clusters_message.ClustersMessage, zapros.Response]:
