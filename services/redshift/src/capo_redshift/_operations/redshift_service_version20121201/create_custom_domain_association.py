"""Generated from Smithy shape ``com.amazonaws.redshift#CreateCustomDomainAssociation``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateCustomDomainAssociationResult")
    out: capo_redshift.types.create_custom_domain_association_result.CreateCustomDomainAssociationResult = capo_redshift.types.create_custom_domain_association_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateCustomDomainAssociation"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.create_custom_domain_association_message.serialize_query(
        input_, pairs, ""
    )
