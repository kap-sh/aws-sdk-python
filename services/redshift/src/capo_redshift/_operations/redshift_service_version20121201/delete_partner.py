"""Generated from Smithy shape ``com.amazonaws.redshift#DeletePartner``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeletePartnerResult")
...
def build_request(
    ...
    pairs.append(("Action", "DeletePartner"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.partner_integration_input_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_partner(
