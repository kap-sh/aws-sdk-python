"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeEndpointAuthorization``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeEndpointAuthorizationResult")
    out: capo_redshift.types.endpoint_authorization_list.EndpointAuthorizationList = (
        capo_redshift.types.endpoint_authorization_list.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeEndpointAuthorization"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_endpoint_authorization_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_endpoint_authorization(
