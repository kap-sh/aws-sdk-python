"""Generated from Smithy shape ``com.amazonaws.redshift#UpdatePartnerStatus``."""
...
import capo_redshift.errors.partner_not_found_fault
import capo_redshift.errors.unauthorized_partner_integration_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PartnerNotFoundFault":
            raise capo_redshift.errors.partner_not_found_fault.PartnerNotFoundFault.from_query(
                root
            )
        case "UnauthorizedPartnerIntegrationFault":
            raise capo_redshift.errors.unauthorized_partner_integration_fault.UnauthorizedPartnerIntegrationFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("UpdatePartnerStatusResult")
    out: capo_redshift.types.partner_integration_output_message.PartnerIntegrationOutputMessage = capo_redshift.types.partner_integration_output_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "UpdatePartnerStatus"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.update_partner_status_input_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_update_partner_status(
