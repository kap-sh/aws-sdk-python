"""Generated from Smithy shape ``com.amazonaws.redshift#CreateClusterSubnetGroup``."""
...
import capo_redshift.errors.cluster_subnet_group_already_exists_fault
import capo_redshift.errors.cluster_subnet_group_quota_exceeded_fault
import capo_redshift.errors.cluster_subnet_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ClusterSubnetGroupAlreadyExistsFault":
            raise capo_redshift.errors.cluster_subnet_group_already_exists_fault.ClusterSubnetGroupAlreadyExistsFault.from_query(
                root
            )
        case "ClusterSubnetGroupQuotaExceededFault":
            raise capo_redshift.errors.cluster_subnet_group_quota_exceeded_fault.ClusterSubnetGroupQuotaExceededFault.from_query(
                root
            )
        case "ClusterSubnetQuotaExceededFault":
            raise capo_redshift.errors.cluster_subnet_quota_exceeded_fault.ClusterSubnetQuotaExceededFault.from_query(
                root
            )
        ...
        case "InvalidSubnet":
            raise capo_redshift.errors.invalid_subnet.InvalidSubnet.from_query(root)
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateClusterSubnetGroupResult")
    out: capo_redshift.types.create_cluster_subnet_group_result.CreateClusterSubnetGroupResult = capo_redshift.types.create_cluster_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateClusterSubnetGroup"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.create_cluster_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_cluster_subnet_group(
