"""Generated from Smithy shape ``com.amazonaws.redshift#ModifySnapshotCopyRetentionPeriod``."""
...
import capo_redshift.errors.snapshot_copy_disabled_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SnapshotCopyDisabledFault":
            raise capo_redshift.errors.snapshot_copy_disabled_fault.SnapshotCopyDisabledFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifySnapshotCopyRetentionPeriodResult")
    out: capo_redshift.types.modify_snapshot_copy_retention_period_result.ModifySnapshotCopyRetentionPeriodResult = capo_redshift.types.modify_snapshot_copy_retention_period_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifySnapshotCopyRetentionPeriod"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.modify_snapshot_copy_retention_period_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_snapshot_copy_retention_period(
