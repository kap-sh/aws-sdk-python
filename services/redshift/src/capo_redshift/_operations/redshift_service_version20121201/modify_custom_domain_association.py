"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyCustomDomainAssociation``."""
...
def handle_response(
    ...
    out: capo_redshift.types.modify_custom_domain_association_result.ModifyCustomDomainAssociationResult = capo_redshift.types.modify_custom_domain_association_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyCustomDomainAssociation"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.modify_custom_domain_association_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_custom_domain_association(
