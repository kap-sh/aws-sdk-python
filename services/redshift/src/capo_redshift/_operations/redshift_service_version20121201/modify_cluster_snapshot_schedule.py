"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyClusterSnapshotSchedule``."""
...
import capo_redshift.errors.invalid_cluster_snapshot_schedule_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidClusterSnapshotScheduleStateFault":
            raise capo_redshift.errors.invalid_cluster_snapshot_schedule_state_fault.InvalidClusterSnapshotScheduleStateFault.from_query(
                root
            )
...
def build_request(
    ...
    pairs.append(("Action", "ModifyClusterSnapshotSchedule"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.modify_cluster_snapshot_schedule_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_cluster_snapshot_schedule(
