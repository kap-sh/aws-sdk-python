"""Generated from Smithy shape ``com.amazonaws.redshift#PauseCluster``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("PauseClusterResult")
    out: capo_redshift.types.pause_cluster_result.PauseClusterResult = (
        capo_redshift.types.pause_cluster_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "PauseCluster"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.pause_cluster_message.serialize_query(input_, pairs, "")
...
def pause_cluster(
    ...
    capo_redshift.types.pause_cluster_result.PauseClusterResult, zapros.Response
]:
