"""Generated from Smithy shape ``com.amazonaws.redshift#FailoverPrimaryCompute``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("FailoverPrimaryComputeResult")
    out: capo_redshift.types.failover_primary_compute_result.FailoverPrimaryComputeResult = capo_redshift.types.failover_primary_compute_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "FailoverPrimaryCompute"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.failover_primary_compute_input_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_failover_primary_compute(
