"""Generated from Smithy shape ``com.amazonaws.acm#GetCertificate``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RequestInProgressException":
            raise capo_acm.errors.request_in_progress_exception.RequestInProgressException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_acm.types.get_certificate_response.GetCertificateResponse = (
        capo_acm.types.get_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm.types.get_certificate_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_certificate(
    ...
    capo_acm.types.get_certificate_response.GetCertificateResponse, zapros.Response
]:
