"""Generated from Smithy shape ``com.amazonaws.acm#ExportCertificate``."""
...
def handle_response(
    ...
    out: capo_acm.types.export_certificate_response.ExportCertificateResponse = (
        capo_acm.types.export_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm.types.export_certificate_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_export_certificate(
