...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidStateException":
            raise capo_acm.errors.invalid_state_exception.InvalidStateException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm.types.update_certificate_options_request.serialize_aws_json_1_1(input_)
    ).encode()
