"""Generated from Smithy shape ``com.amazonaws.acm#ImportCertificate``."""
...
def handle_response(
    ...
    out: capo_acm.types.import_certificate_response.ImportCertificateResponse = (
        capo_acm.types.import_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm.types.import_certificate_request.serialize_aws_json_1_1(input_)
    ).encode()
