"""Generated from Smithy shape ``com.amazonaws.acm#ListCertificates``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidArgsException":
            raise capo_acm.errors.invalid_args_exception.InvalidArgsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_acm.types.list_certificates_response.ListCertificatesResponse = (
        capo_acm.types.list_certificates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm.types.list_certificates_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_certificates(
    ...
    capo_acm.types.list_certificates_response.ListCertificatesResponse, zapros.Response
]:
