"""Generated from Smithy shape ``com.amazonaws.acm#AddTagsToCertificate``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm.types.add_tags_to_certificate_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_add_tags_to_certificate(
