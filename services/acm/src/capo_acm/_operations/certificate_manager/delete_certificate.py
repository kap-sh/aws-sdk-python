"""Generated from Smithy shape ``com.amazonaws.acm#DeleteCertificate``."""
...
import capo_acm.errors.access_denied_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_acm.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data
            )
        ...
        case "ResourceInUseException":
            raise capo_acm.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm.types.delete_certificate_request.serialize_aws_json_1_1(input_)
    ).encode()
