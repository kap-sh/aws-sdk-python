"""Generated from Smithy shape ``com.amazonaws.acm#UpdateCertificateOptions``."""
...
def build_request(
    ...
    input_: aws_sdk_acm.types.update_certificate_options_request.UpdateCertificateOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm.types.update_certificate_options_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_certificate_options(
