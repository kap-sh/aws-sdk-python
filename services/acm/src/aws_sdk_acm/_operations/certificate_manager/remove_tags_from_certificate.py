"""Generated from Smithy shape ``com.amazonaws.acm#RemoveTagsFromCertificate``."""
...
def build_request(
    ...
    input_: aws_sdk_acm.types.remove_tags_from_certificate_request.RemoveTagsFromCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm.types.remove_tags_from_certificate_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_remove_tags_from_certificate(
