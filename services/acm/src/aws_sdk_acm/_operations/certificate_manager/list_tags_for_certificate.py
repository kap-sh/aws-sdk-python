...
def handle_response(
    ...
    out: aws_sdk_acm.types.list_tags_for_certificate_response.ListTagsForCertificateResponse = aws_sdk_acm.types.list_tags_for_certificate_response.deserialize_aws_json_1_1(
