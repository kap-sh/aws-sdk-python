...
def handle_response(
    ...
    out: aws_sdk_acm.types.request_certificate_response.RequestCertificateResponse = (
        aws_sdk_acm.types.request_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_acm.types.request_certificate_request.RequestCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm.types.request_certificate_request.serialize_aws_json_1_1(input_)
    ).encode()
