"""Generated from Smithy shape ``com.amazonaws.acm#GetAccountConfiguration``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            import aws_sdk_acm.errors.access_denied_exception

            raise aws_sdk_acm.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_acm.types.get_account_configuration_response.GetAccountConfigurationResponse = aws_sdk_acm.types.get_account_configuration_response.deserialize_aws_json_1_1(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "CertificateManager.GetAccountConfiguration"
    body: bytes | None = b""
...
async def async_get_account_configuration(
