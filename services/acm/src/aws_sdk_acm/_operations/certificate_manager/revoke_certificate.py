...
import aws_sdk_acm.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise aws_sdk_acm.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_acm.types.revoke_certificate_response.RevokeCertificateResponse = (
        aws_sdk_acm.types.revoke_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_acm.types.revoke_certificate_request.RevokeCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm.types.revoke_certificate_request.serialize_aws_json_1_1(input_)
    ).encode()
