"""Generated from Smithy shape ``com.amazonaws.acm#ResendValidationEmail``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDomainValidationOptionsException":
            import aws_sdk_acm.errors.invalid_domain_validation_options_exception

            raise aws_sdk_acm.errors.invalid_domain_validation_options_exception.InvalidDomainValidationOptionsException.from_aws_json_1_1(
                data
            )
        case "InvalidStateException":
            import aws_sdk_acm.errors.invalid_state_exception

            raise aws_sdk_acm.errors.invalid_state_exception.InvalidStateException.from_aws_json_1_1(
                data
            )
...
def get_signer(
...
) -> aws_sdk_acm._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_acm._auth._sigv4.build_sigv4_auth_scheme("acm", options.region)
        )
        if sigv4_config is not None:
            return aws_sdk_acm._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_acm.types.resend_validation_email_request.ResendValidationEmailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm.types.resend_validation_email_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_resend_validation_email(
