...
def build_request(
    ...
    input: aws_sdk_acm.types.resend_validation_email_request.ResendValidationEmailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm.types.resend_validation_email_request.serialize_aws_json_1_1(input)
    ).encode()
