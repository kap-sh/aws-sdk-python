...
def build_request(
    ...
    input: aws_sdk_acm.types.describe_certificate_request.DescribeCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_acm.types.describe_certificate_request.serialize_aws_json_1_1(input)
    ).encode()
