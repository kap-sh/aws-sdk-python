...
class SearchCertificatesRequest(TypedDict):
    ...
    max_results: "aws_sdk_acm.types.search_max_results.SearchMaxResults"
    ...
    sort_by: "aws_sdk_acm.types.search_certificates_sort_by.SearchCertificatesSortBy"
...
def serialize_aws_json_1_1(value: SearchCertificatesRequest) -> dict:
    ...
    if "filter_statement" in value:
        ...
        out["FilterStatement"] = (
            aws_sdk_acm.types.certificate_filter_statement.serialize_aws_json_1_1(
    ...
    out["SortBy"] = (
        aws_sdk_acm.types.search_certificates_sort_by.serialize_aws_json_1_1(
    ...
    out["SortOrder"] = (
        aws_sdk_acm.types.search_certificates_sort_order.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SearchCertificatesRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_acm.types.search_certificates_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
    else:
    ...
    if "SortOrder" in data:
        ...
        out["sort_order"] = (
            aws_sdk_acm.types.search_certificates_sort_order.deserialize_aws_json_1_1(
                data["SortOrder"]
            )
        )
    else:
