...
if TYPE_CHECKING:
    import aws_sdk_acm.types.custom_attribute_list
    import aws_sdk_acm.types.domain_component_list
    import aws_sdk_acm.types.string


class DistinguishedName(TypedDict, closed=True):
    common_name: NotRequired["aws_sdk_acm.types.string.String"]
    """<p>The common name (CN) attribute.</p>"""
    domain_components: NotRequired[
        "aws_sdk_acm.types.domain_component_list.DomainComponentList"
    ]
    """<p>The domain component attributes.</p>"""
    country: NotRequired["aws_sdk_acm.types.string.String"]
    """<p>The country (C) attribute.</p>"""
    custom_attributes: NotRequired[
        "aws_sdk_acm.types.custom_attribute_list.CustomAttributeList"
    ]
    ...
    distinguished_name_qualifier: NotRequired["aws_sdk_acm.types.string.String"]
    """<p>The distinguished name qualifier attribute.</p>"""
    generation_qualifier: NotRequired["aws_sdk_acm.types.string.String"]
    """<p>The generation qualifier attribute.</p>"""
    given_name: NotRequired["aws_sdk_acm.types.string.String"]
    """<p>The given name attribute.</p>"""
    initials: NotRequired["aws_sdk_acm.types.string.String"]
    """<p>The initials attribute.</p>"""
    locality: NotRequired["aws_sdk_acm.types.string.String"]
    """<p>The locality (L) attribute.</p>"""
    organization: NotRequired["aws_sdk_acm.types.string.String"]
    """<p>The organization (O) attribute.</p>"""
    organizational_unit: NotRequired["aws_sdk_acm.types.string.String"]
    """<p>The organizational unit (OU) attribute.</p>"""
    pseudonym: NotRequired["aws_sdk_acm.types.string.String"]
    """<p>The pseudonym attribute.</p>"""
    serial_number: NotRequired["aws_sdk_acm.types.string.String"]
    """<p>The serial number attribute.</p>"""
    state: NotRequired["aws_sdk_acm.types.string.String"]
    """<p>The state or province (ST) attribute.</p>"""
    surname: NotRequired["aws_sdk_acm.types.string.String"]
    """<p>The surname attribute.</p>"""
    title: NotRequired["aws_sdk_acm.types.string.String"]
...
def serialize_aws_json_1_1(value: DistinguishedName) -> dict:
    ...
    if "domain_components" in value:
        ...
        out["DomainComponents"] = (
            aws_sdk_acm.types.domain_component_list.serialize_aws_json_1_1(
    ...
    if "custom_attributes" in value:
        ...
        out["CustomAttributes"] = (
            aws_sdk_acm.types.custom_attribute_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DistinguishedName:
    ...
    if "DomainComponents" in data:
        ...
        out["domain_components"] = (
            aws_sdk_acm.types.domain_component_list.deserialize_aws_json_1_1(
    ...
    if "CustomAttributes" in data:
        ...
        out["custom_attributes"] = (
            aws_sdk_acm.types.custom_attribute_list.deserialize_aws_json_1_1(
