"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#PutSellingSystemSettingsResponse``."""
...
if TYPE_CHECKING:
    ...
    import capo_partnercentral_selling.types.resource_snapshot_job_role_arn


class PutSellingSystemSettingsResponse(TypedDict, closed=True):
    ...
    resource_snapshot_job_role_arn: NotRequired[
        "capo_partnercentral_selling.types.resource_snapshot_job_role_arn.ResourceSnapshotJobRoleArn"
    ]
    """<p>Specifies the ARN of the IAM Role used for resource snapshot job executions.</p>"""


# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: PutSellingSystemSettingsResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> PutSellingSystemSettingsResponse:
    out: PutSellingSystemSettingsResponse = {}  # type: ignore[typeddict-item]
    if "Catalog" in data:
        out["catalog"] = data["Catalog"]
    else:
        raise DeserializationError("PutSellingSystemSettingsResponse.catalog required")
