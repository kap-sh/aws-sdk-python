...
if TYPE_CHECKING:
    import capo_partnercentral_selling.types.aws_marketplace_offer_set_identifier

AwsMarketplaceOfferSetIdentifiers: TypeAlias = list[
    "capo_partnercentral_selling.types.aws_marketplace_offer_set_identifier.AwsMarketplaceOfferSetIdentifier"
]
