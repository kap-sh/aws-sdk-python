...
class Marketing(TypedDict, closed=True):
    ...
    source: NotRequired[
        "capo_partnercentral_selling.types.marketing_source.MarketingSource"
    ]
    ...
    use_cases: NotRequired["capo_partnercentral_selling.types.use_cases.UseCases"]
    ...
    channels: NotRequired["capo_partnercentral_selling.types.channels.Channels"]
    ...
    aws_funding_used: NotRequired[
        "capo_partnercentral_selling.types.aws_funding_used.AwsFundingUsed"
    ]
...
def serialize_aws_json_1_0(value: Marketing) -> dict:
    ...
    if "source" in value:
        ...
        out["Source"] = (
            capo_partnercentral_selling.types.marketing_source.serialize_aws_json_1_0(
                value["source"]
            )
        )
    if "use_cases" in value:
        ...
        out["UseCases"] = (
            capo_partnercentral_selling.types.use_cases.serialize_aws_json_1_0(
                value["use_cases"]
            )
        )
    if "channels" in value:
        ...
        out["Channels"] = (
            capo_partnercentral_selling.types.channels.serialize_aws_json_1_0(
                value["channels"]
            )
        )
    if "aws_funding_used" in value:
        ...
        out["AwsFundingUsed"] = (
            capo_partnercentral_selling.types.aws_funding_used.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Marketing:
    ...
    if "Source" in data:
        ...
        out["source"] = (
            capo_partnercentral_selling.types.marketing_source.deserialize_aws_json_1_0(
                data["Source"]
            )
        )
    if "UseCases" in data:
        ...
        out["use_cases"] = (
            capo_partnercentral_selling.types.use_cases.deserialize_aws_json_1_0(
                data["UseCases"]
            )
        )
    if "Channels" in data:
        ...
        out["channels"] = (
            capo_partnercentral_selling.types.channels.deserialize_aws_json_1_0(
                data["Channels"]
            )
        )
    if "AwsFundingUsed" in data:
        ...
        out["aws_funding_used"] = (
            capo_partnercentral_selling.types.aws_funding_used.deserialize_aws_json_1_0(
                data["AwsFundingUsed"]
            )
        )
    return out
