...
class ListOpportunityFromEngagementTasksResponse(TypedDict, closed=True):
    task_summaries: NotRequired[
        "capo_partnercentral_selling.types.list_opportunity_from_engagement_task_summaries.ListOpportunityFromEngagementTaskSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListOpportunityFromEngagementTasksResponse) -> dict:
    ...
    if "task_summaries" in value:
        ...
        out["TaskSummaries"] = (
            capo_partnercentral_selling.types.list_opportunity_from_engagement_task_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListOpportunityFromEngagementTasksResponse:
    ...
    if "TaskSummaries" in data:
        ...
        out["task_summaries"] = (
            capo_partnercentral_selling.types.list_opportunity_from_engagement_task_summaries.deserialize_aws_json_1_0(
                data["TaskSummaries"]
            )
        )
