...
if TYPE_CHECKING:
    import capo_partnercentral_selling.types.primary_need_from_aws

PrimaryNeedsFromAws: TypeAlias = list[
    "capo_partnercentral_selling.types.primary_need_from_aws.PrimaryNeedFromAws"
]
...
def serialize_aws_json_1_0(value: PrimaryNeedsFromAws) -> list:
    ...
    for item in value:
        out.append(
            capo_partnercentral_selling.types.primary_need_from_aws.serialize_aws_json_1_0(
                item
            )
        )
    return out
