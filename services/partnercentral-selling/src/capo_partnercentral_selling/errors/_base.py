...
class PartnerCentralSellingError(Exception):
    """Base class for all PartnerCentralSelling service errors."""


class ServiceError(PartnerCentralSellingError):
...
class SerializationError(PartnerCentralSellingError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PartnerCentralSellingError):
...
class WaiterFailedError(PartnerCentralSellingError):
...
class WaiterTimeoutError(PartnerCentralSellingError):
