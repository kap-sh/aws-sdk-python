...
import capo_partnercentral_selling.types.resource_snapshot_job_summary_list
...
def handle_response(
    ...
    out: capo_partnercentral_selling.types.list_resource_snapshot_jobs_response.ListResourceSnapshotJobsResponse = capo_partnercentral_selling.types.list_resource_snapshot_jobs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_selling.types.list_resource_snapshot_jobs_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
