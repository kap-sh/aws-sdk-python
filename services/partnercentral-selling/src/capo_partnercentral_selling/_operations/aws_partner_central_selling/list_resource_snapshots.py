...
def handle_response(
    ...
    out: capo_partnercentral_selling.types.list_resource_snapshots_response.ListResourceSnapshotsResponse = capo_partnercentral_selling.types.list_resource_snapshots_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_selling.types.list_resource_snapshots_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
