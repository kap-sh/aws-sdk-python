...
def handle_response(
    ...
    out: capo_partnercentral_selling.types.get_aws_opportunity_summary_response.GetAwsOpportunitySummaryResponse = capo_partnercentral_selling.types.get_aws_opportunity_summary_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_selling.types.get_aws_opportunity_summary_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
