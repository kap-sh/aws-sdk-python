...
def handle_response(
    ...
    out: capo_partnercentral_selling.types.create_opportunity_response.CreateOpportunityResponse = capo_partnercentral_selling.types.create_opportunity_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_selling.types.create_opportunity_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
