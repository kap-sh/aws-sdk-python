...
def handle_response(
    ...
    out: capo_partnercentral_selling.types.list_engagements_response.ListEngagementsResponse = capo_partnercentral_selling.types.list_engagements_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_selling.types.list_engagements_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
