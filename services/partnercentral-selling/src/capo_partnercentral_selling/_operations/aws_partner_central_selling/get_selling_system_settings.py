"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#GetSellingSystemSettings``."""
...
def handle_response(
    ...
    out: capo_partnercentral_selling.types.get_selling_system_settings_response.GetSellingSystemSettingsResponse = capo_partnercentral_selling.types.get_selling_system_settings_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GetSellingSystemSettings"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "AWSPartnerCentralSelling.GetSellingSystemSettings"
    body: bytes | None = json.dumps(
        capo_partnercentral_selling.types.get_selling_system_settings_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_selling_system_settings(
