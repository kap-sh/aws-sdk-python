...
def handle_response(
    ...
    out: capo_partnercentral_selling.types.list_solutions_response.ListSolutionsResponse = capo_partnercentral_selling.types.list_solutions_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_selling.types.list_solutions_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
