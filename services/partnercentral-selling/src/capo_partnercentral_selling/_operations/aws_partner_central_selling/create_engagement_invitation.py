...
import capo_partnercentral_selling.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_partnercentral_selling.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_partnercentral_selling.types.create_engagement_invitation_response.CreateEngagementInvitationResponse = capo_partnercentral_selling.types.create_engagement_invitation_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_selling.types.create_engagement_invitation_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
