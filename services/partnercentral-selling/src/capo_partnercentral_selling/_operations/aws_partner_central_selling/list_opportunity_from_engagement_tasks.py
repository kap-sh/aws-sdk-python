"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#ListOpportunityFromEngagementTasks``."""
...
import capo_partnercentral_selling.types.list_opportunity_from_engagement_task_summaries
...
def handle_response(
    ...
    out: capo_partnercentral_selling.types.list_opportunity_from_engagement_tasks_response.ListOpportunityFromEngagementTasksResponse = capo_partnercentral_selling.types.list_opportunity_from_engagement_tasks_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ListOpportunityFromEngagementTasks"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_selling.types.list_opportunity_from_engagement_tasks_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_opportunity_from_engagement_tasks(
