...
class EngagementByAcceptingInvitationTask:
    ...
    def create(
        ...
        *,
        ...
        input: aws_sdk_partnercentral_selling.types.start_engagement_by_accepting_invitation_task_request.StartEngagementByAcceptingInvitationTaskRequest = {}  # type: ignore[typeddict-item]
    ...
    def list(
        ...
        *,
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_partnercentral_selling.types.list_engagement_by_accepting_invitation_tasks_request.ListEngagementByAcceptingInvitationTasksRequest = {}  # type: ignore[typeddict-item]
        ...
        if engagement_invitation_identifier is not None:
            input["engagement_invitation_identifier"] = engagement_invitation_identifier
