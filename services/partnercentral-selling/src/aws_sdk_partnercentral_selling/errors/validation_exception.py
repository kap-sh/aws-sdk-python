...
from aws_sdk_partnercentral_selling.errors import DeserializationError, ServiceError

if TYPE_CHECKING:
    import aws_sdk_partnercentral_selling.types.validation_exception_error_list
    import aws_sdk_partnercentral_selling.types.validation_exception_reason


class ValidationException_(TypedDict, closed=True):
    message: "str"
    reason: "aws_sdk_partnercentral_selling.types.validation_exception_reason.ValidationExceptionReason"
    ...
    error_list: NotRequired[
        "aws_sdk_partnercentral_selling.types.validation_exception_error_list.ValidationExceptionErrorList"
    ]
...
def serialize_aws_json_1_0(value: ValidationException_) -> dict:
    ...
    out["Reason"] = (
        aws_sdk_partnercentral_selling.types.validation_exception_reason.serialize_aws_json_1_0(
            value["reason"]
        )
    )
    if "error_list" in value:
        ...
        out["ErrorList"] = (
            aws_sdk_partnercentral_selling.types.validation_exception_error_list.serialize_aws_json_1_0(
                value["error_list"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ValidationException_:
    ...
    if "Reason" in data:
        ...
        out["reason"] = (
            aws_sdk_partnercentral_selling.types.validation_exception_reason.deserialize_aws_json_1_0(
                data["Reason"]
            )
        )
    else:
    ...
    if "ErrorList" in data:
        ...
        out["error_list"] = (
            aws_sdk_partnercentral_selling.types.validation_exception_error_list.deserialize_aws_json_1_0(
                data["ErrorList"]
            )
        )
    return out
