...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.start_engagement_by_accepting_invitation_task_response.StartEngagementByAcceptingInvitationTaskResponse = aws_sdk_partnercentral_selling.types.start_engagement_by_accepting_invitation_task_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.start_engagement_by_accepting_invitation_task_request.StartEngagementByAcceptingInvitationTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
