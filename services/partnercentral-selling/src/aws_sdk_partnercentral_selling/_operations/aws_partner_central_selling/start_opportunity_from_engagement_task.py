"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#StartOpportunityFromEngagementTask``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_partnercentral_selling.errors.conflict_exception

            raise aws_sdk_partnercentral_selling.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_partnercentral_selling.errors.service_quota_exceeded_exception

            raise aws_sdk_partnercentral_selling.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.start_opportunity_from_engagement_task_response.StartOpportunityFromEngagementTaskResponse = aws_sdk_partnercentral_selling.types.start_opportunity_from_engagement_task_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.start_opportunity_from_engagement_task_request.StartOpportunityFromEngagementTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/StartOpportunityFromEngagementTask"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.start_opportunity_from_engagement_task_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_start_opportunity_from_engagement_task(
