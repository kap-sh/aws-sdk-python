...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.get_resource_snapshot_response.GetResourceSnapshotResponse = aws_sdk_partnercentral_selling.types.get_resource_snapshot_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.get_resource_snapshot_request.GetResourceSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.get_resource_snapshot_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
