...
import aws_sdk_partnercentral_selling.types.resource_snapshot_summary_list
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.list_resource_snapshots_request.ListResourceSnapshotsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
