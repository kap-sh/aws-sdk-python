...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.update_opportunity_response.UpdateOpportunityResponse = aws_sdk_partnercentral_selling.types.update_opportunity_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.update_opportunity_request.UpdateOpportunityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.update_opportunity_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
