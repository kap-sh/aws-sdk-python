"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#ListOpportunities``."""
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.list_opportunities_response.ListOpportunitiesResponse = aws_sdk_partnercentral_selling.types.list_opportunities_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.list_opportunities_request.ListOpportunitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListOpportunities"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "AWSPartnerCentralSelling.ListOpportunities"
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.list_opportunities_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_opportunities(
