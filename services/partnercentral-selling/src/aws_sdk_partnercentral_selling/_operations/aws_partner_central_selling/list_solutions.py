"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#ListSolutions``."""
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.list_solutions_response.ListSolutionsResponse = aws_sdk_partnercentral_selling.types.list_solutions_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.list_solutions_request.ListSolutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListSolutions"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "AWSPartnerCentralSelling.ListSolutions"
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.list_solutions_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
