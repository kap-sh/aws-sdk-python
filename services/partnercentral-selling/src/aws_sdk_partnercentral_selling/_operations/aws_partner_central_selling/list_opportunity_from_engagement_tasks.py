...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.list_opportunity_from_engagement_tasks_response.ListOpportunityFromEngagementTasksResponse = aws_sdk_partnercentral_selling.types.list_opportunity_from_engagement_tasks_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.list_opportunity_from_engagement_tasks_request.ListOpportunityFromEngagementTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.list_opportunity_from_engagement_tasks_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
