...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.delete_resource_snapshot_job_request.DeleteResourceSnapshotJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.delete_resource_snapshot_job_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
