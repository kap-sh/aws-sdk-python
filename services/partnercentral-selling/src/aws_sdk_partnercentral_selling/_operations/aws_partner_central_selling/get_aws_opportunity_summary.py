"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#GetAwsOpportunitySummary``."""
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.get_aws_opportunity_summary_response.GetAwsOpportunitySummaryResponse = aws_sdk_partnercentral_selling.types.get_aws_opportunity_summary_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.get_aws_opportunity_summary_request.GetAwsOpportunitySummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetAwsOpportunitySummary"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "AWSPartnerCentralSelling.GetAwsOpportunitySummary"
    import aws_sdk_partnercentral_selling.types.get_aws_opportunity_summary_request

    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.get_aws_opportunity_summary_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_aws_opportunity_summary(
