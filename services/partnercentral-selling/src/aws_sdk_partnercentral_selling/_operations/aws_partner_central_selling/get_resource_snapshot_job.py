...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.get_resource_snapshot_job_response.GetResourceSnapshotJobResponse = aws_sdk_partnercentral_selling.types.get_resource_snapshot_job_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.get_resource_snapshot_job_request.GetResourceSnapshotJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.get_resource_snapshot_job_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
