...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.list_engagement_by_accepting_invitation_tasks_response.ListEngagementByAcceptingInvitationTasksResponse = aws_sdk_partnercentral_selling.types.list_engagement_by_accepting_invitation_tasks_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.list_engagement_by_accepting_invitation_tasks_request.ListEngagementByAcceptingInvitationTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.list_engagement_by_accepting_invitation_tasks_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
