"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#ListResourceSnapshotJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.list_resource_snapshot_jobs_response.ListResourceSnapshotJobsResponse = aws_sdk_partnercentral_selling.types.list_resource_snapshot_jobs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.list_resource_snapshot_jobs_request.ListResourceSnapshotJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListResourceSnapshotJobs"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "AWSPartnerCentralSelling.ListResourceSnapshotJobs"
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.list_resource_snapshot_jobs_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_resource_snapshot_jobs(
