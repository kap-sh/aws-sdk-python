...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.start_engagement_from_opportunity_task_response.StartEngagementFromOpportunityTaskResponse = aws_sdk_partnercentral_selling.types.start_engagement_from_opportunity_task_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.start_engagement_from_opportunity_task_request.StartEngagementFromOpportunityTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.start_engagement_from_opportunity_task_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
