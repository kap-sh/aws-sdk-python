...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.accept_engagement_invitation_request.AcceptEngagementInvitationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.accept_engagement_invitation_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
