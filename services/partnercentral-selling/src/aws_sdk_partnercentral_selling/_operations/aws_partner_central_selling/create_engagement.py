"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#CreateEngagement``."""
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.create_engagement_response.CreateEngagementResponse = aws_sdk_partnercentral_selling.types.create_engagement_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.create_engagement_request.CreateEngagementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/CreateEngagement"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "AWSPartnerCentralSelling.CreateEngagement"
    import aws_sdk_partnercentral_selling.types.create_engagement_request

    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.create_engagement_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_engagement(
