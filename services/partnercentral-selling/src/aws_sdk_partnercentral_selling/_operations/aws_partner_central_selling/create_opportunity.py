"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#CreateOpportunity``."""
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.create_opportunity_response.CreateOpportunityResponse = aws_sdk_partnercentral_selling.types.create_opportunity_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.create_opportunity_request.CreateOpportunityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/CreateOpportunity"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "AWSPartnerCentralSelling.CreateOpportunity"
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.create_opportunity_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_opportunity(
