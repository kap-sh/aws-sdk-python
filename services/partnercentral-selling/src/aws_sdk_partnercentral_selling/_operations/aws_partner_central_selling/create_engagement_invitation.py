"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#CreateEngagementInvitation``."""
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.create_engagement_invitation_response.CreateEngagementInvitationResponse = aws_sdk_partnercentral_selling.types.create_engagement_invitation_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.create_engagement_invitation_request.CreateEngagementInvitationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/CreateEngagementInvitation"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "AWSPartnerCentralSelling.CreateEngagementInvitation"
    import aws_sdk_partnercentral_selling.types.create_engagement_invitation_request

    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.create_engagement_invitation_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_engagement_invitation(
