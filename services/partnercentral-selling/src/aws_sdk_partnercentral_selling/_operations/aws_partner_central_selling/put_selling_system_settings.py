...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.put_selling_system_settings_response.PutSellingSystemSettingsResponse = aws_sdk_partnercentral_selling.types.put_selling_system_settings_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.put_selling_system_settings_request.PutSellingSystemSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.put_selling_system_settings_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
