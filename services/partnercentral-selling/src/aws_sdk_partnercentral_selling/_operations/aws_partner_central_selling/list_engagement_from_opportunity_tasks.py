...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.list_engagement_from_opportunity_tasks_response.ListEngagementFromOpportunityTasksResponse = aws_sdk_partnercentral_selling.types.list_engagement_from_opportunity_tasks_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.list_engagement_from_opportunity_tasks_request.ListEngagementFromOpportunityTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
