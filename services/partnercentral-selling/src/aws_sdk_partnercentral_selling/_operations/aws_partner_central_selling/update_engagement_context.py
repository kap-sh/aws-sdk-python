...
def handle_response(
    ...
    out: aws_sdk_partnercentral_selling.types.update_engagement_context_response.UpdateEngagementContextResponse = aws_sdk_partnercentral_selling.types.update_engagement_context_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_selling.types.update_engagement_context_request.UpdateEngagementContextRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_selling.types.update_engagement_context_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
