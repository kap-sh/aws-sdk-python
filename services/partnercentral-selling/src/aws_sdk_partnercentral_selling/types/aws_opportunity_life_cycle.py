...
if TYPE_CHECKING:
    ...
    import aws_sdk_partnercentral_selling.types.aws_opportunity_stage
...
class AwsOpportunityLifeCycle(TypedDict, closed=True):
    ...
    closed_lost_reason: NotRequired[
        "aws_sdk_partnercentral_selling.types.aws_closed_lost_reason.AwsClosedLostReason"
    ]
    ...
    stage: NotRequired[
        "aws_sdk_partnercentral_selling.types.aws_opportunity_stage.AwsOpportunityStage"
    ]
    ...
    next_steps_history: NotRequired[
        "aws_sdk_partnercentral_selling.types.profile_next_steps_histories.ProfileNextStepsHistories"
    ]
...
def serialize_aws_json_1_0(value: AwsOpportunityLifeCycle) -> dict:
    ...
    if "closed_lost_reason" in value:
        ...
        out["ClosedLostReason"] = (
            aws_sdk_partnercentral_selling.types.aws_closed_lost_reason.serialize_aws_json_1_0(
    ...
    if "stage" in value:
        ...
        out["Stage"] = (
            aws_sdk_partnercentral_selling.types.aws_opportunity_stage.serialize_aws_json_1_0(
                value["stage"]
            )
        )
    ...
    if "next_steps_history" in value:
        ...
        out["NextStepsHistory"] = (
            aws_sdk_partnercentral_selling.types.profile_next_steps_histories.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> AwsOpportunityLifeCycle:
    ...
    if "ClosedLostReason" in data:
        ...
        out["closed_lost_reason"] = (
            aws_sdk_partnercentral_selling.types.aws_closed_lost_reason.deserialize_aws_json_1_0(
    ...
    if "Stage" in data:
        ...
        out["stage"] = (
            aws_sdk_partnercentral_selling.types.aws_opportunity_stage.deserialize_aws_json_1_0(
                data["Stage"]
            )
        )
    ...
    if "NextStepsHistory" in data:
        ...
        out["next_steps_history"] = (
            aws_sdk_partnercentral_selling.types.profile_next_steps_histories.deserialize_aws_json_1_0(
