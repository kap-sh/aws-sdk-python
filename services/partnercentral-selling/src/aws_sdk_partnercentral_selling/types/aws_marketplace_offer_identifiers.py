...
if TYPE_CHECKING:
    import aws_sdk_partnercentral_selling.types.aws_marketplace_offer_identifier

AwsMarketplaceOfferIdentifiers: TypeAlias = list[
    "aws_sdk_partnercentral_selling.types.aws_marketplace_offer_identifier.AwsMarketplaceOfferIdentifier"
]
