...
ListOpportunityFromEngagementTaskSummaries: TypeAlias = list[
    "aws_sdk_partnercentral_selling.types.list_opportunity_from_engagement_task_summary.ListOpportunityFromEngagementTaskSummary"
]
...
def serialize_aws_json_1_0(value: ListOpportunityFromEngagementTaskSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_partnercentral_selling.types.list_opportunity_from_engagement_task_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ListOpportunityFromEngagementTaskSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_partnercentral_selling.types.list_opportunity_from_engagement_task_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
