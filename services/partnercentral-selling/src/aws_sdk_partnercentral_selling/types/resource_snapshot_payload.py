...
if TYPE_CHECKING:
    import aws_sdk_partnercentral_selling.types.aws_opportunity_summary_full_view
...
def serialize_aws_json_1_0(value: ResourceSnapshotPayload) -> dict:
    if "OpportunitySummary" in value:
        ...
        return {
            "OpportunitySummary": aws_sdk_partnercentral_selling.types.opportunity_summary_view.serialize_aws_json_1_0(
        ...
        return {
            "AwsOpportunitySummaryFullView": aws_sdk_partnercentral_selling.types.aws_opportunity_summary_full_view.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ResourceSnapshotPayload:
    if "OpportunitySummary" in data:
        ...
        return {
            "OpportunitySummary": aws_sdk_partnercentral_selling.types.opportunity_summary_view.deserialize_aws_json_1_0(
        ...
        return {
            "AwsOpportunitySummaryFullView": aws_sdk_partnercentral_selling.types.aws_opportunity_summary_full_view.deserialize_aws_json_1_0(
