...
EngagementResourceAssociationSummaryList: TypeAlias = list[
    "aws_sdk_partnercentral_selling.types.engagement_resource_association_summary.EngagementResourceAssociationSummary"
]
...
def serialize_aws_json_1_0(value: EngagementResourceAssociationSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_partnercentral_selling.types.engagement_resource_association_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> EngagementResourceAssociationSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_partnercentral_selling.types.engagement_resource_association_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
