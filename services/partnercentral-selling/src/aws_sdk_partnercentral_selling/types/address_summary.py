...
if TYPE_CHECKING:
    import aws_sdk_partnercentral_selling.types.address_part
    import aws_sdk_partnercentral_selling.types.country_code


class AddressSummary(TypedDict, closed=True):
    city: NotRequired["aws_sdk_partnercentral_selling.types.address_part.AddressPart"]
    """<p>Specifies the end <code>Customer</code>'s city associated with the <code>Opportunity</code>.</p>"""
    postal_code: NotRequired[
        "aws_sdk_partnercentral_selling.types.address_part.AddressPart"
    ]
    ...
    country_code: NotRequired[
        "aws_sdk_partnercentral_selling.types.country_code.CountryCode"
    ]
...
def serialize_aws_json_1_0(value: AddressSummary) -> dict:
    ...
    if "country_code" in value:
        ...
        out["CountryCode"] = (
            aws_sdk_partnercentral_selling.types.country_code.serialize_aws_json_1_0(
                value["country_code"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> AddressSummary:
    ...
    if "CountryCode" in data:
        ...
        out["country_code"] = (
            aws_sdk_partnercentral_selling.types.country_code.deserialize_aws_json_1_0(
                data["CountryCode"]
            )
        )
    return out
