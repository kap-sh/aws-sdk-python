...
ResourceSnapshotJobSummaryList: TypeAlias = list[
    "aws_sdk_partnercentral_selling.types.resource_snapshot_job_summary.ResourceSnapshotJobSummary"
]
...
def serialize_aws_json_1_0(value: ResourceSnapshotJobSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_partnercentral_selling.types.resource_snapshot_job_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ResourceSnapshotJobSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_partnercentral_selling.types.resource_snapshot_job_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
