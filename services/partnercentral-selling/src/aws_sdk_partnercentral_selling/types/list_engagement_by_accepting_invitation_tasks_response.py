...
def serialize_aws_json_1_0(
    ...
    if "task_summaries" in value:
        ...
        out["TaskSummaries"] = (
            aws_sdk_partnercentral_selling.types.list_engagement_by_accepting_invitation_task_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(
    ...
    if "TaskSummaries" in data:
        ...
        out["task_summaries"] = (
            aws_sdk_partnercentral_selling.types.list_engagement_by_accepting_invitation_task_summaries.deserialize_aws_json_1_0(
                data["TaskSummaries"]
            )
        )
