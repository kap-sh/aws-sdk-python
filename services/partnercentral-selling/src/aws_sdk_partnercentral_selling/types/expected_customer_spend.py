...
if TYPE_CHECKING:
    import aws_sdk_partnercentral_selling.types.amount
    import aws_sdk_partnercentral_selling.types.currency_code
    import aws_sdk_partnercentral_selling.types.estimation_url
...
class ExpectedCustomerSpend(TypedDict):
    ...
    estimation_url: NotRequired[
        "aws_sdk_partnercentral_selling.types.estimation_url.EstimationUrl"
    ]
...
def serialize_aws_json_1_0(value: ExpectedCustomerSpend) -> dict:
    ...
    out["Frequency"] = (
        aws_sdk_partnercentral_selling.types.payment_frequency.serialize_aws_json_1_0(
            value["frequency"]
        )
    )
...
def deserialize_aws_json_1_0(data: dict) -> ExpectedCustomerSpend:
    ...
    if "Frequency" in data:
        ...
        out["frequency"] = (
            aws_sdk_partnercentral_selling.types.payment_frequency.deserialize_aws_json_1_0(
                data["Frequency"]
            )
        )
    else:
