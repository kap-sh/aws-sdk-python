...
if TYPE_CHECKING:
    import aws_sdk_partnercentral_selling.types.aws_member_business_title
    import aws_sdk_partnercentral_selling.types.email
    import aws_sdk_partnercentral_selling.types.name


class AwsTeamMember(TypedDict):
    ...
    business_title: NotRequired[
        "aws_sdk_partnercentral_selling.types.aws_member_business_title.AwsMemberBusinessTitle"
    ]
...
def serialize_aws_json_1_0(value: AwsTeamMember) -> dict:
    ...
    if "business_title" in value:
        ...
        out["BusinessTitle"] = (
            aws_sdk_partnercentral_selling.types.aws_member_business_title.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> AwsTeamMember:
    ...
    if "BusinessTitle" in data:
        ...
        out["business_title"] = (
            aws_sdk_partnercentral_selling.types.aws_member_business_title.deserialize_aws_json_1_0(
                data["BusinessTitle"]
            )
        )
    return out
