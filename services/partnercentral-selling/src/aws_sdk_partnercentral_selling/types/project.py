...
if TYPE_CHECKING:
    ...
    import aws_sdk_partnercentral_selling.types.competitor_name
...
class Project(TypedDict, closed=True):
    ...
    title: NotRequired["aws_sdk_partnercentral_selling.types.pii_string.PiiString"]
    """<p>Specifies the <code>Opportunity</code>'s title or name.</p>"""
    apn_programs: NotRequired[
        "aws_sdk_partnercentral_selling.types.apn_programs.ApnPrograms"
    ]
    ...
    customer_business_problem: NotRequired[
        "aws_sdk_partnercentral_selling.types.pii_string.PiiString"
    ]
    ...
    sales_activities: NotRequired[
        "aws_sdk_partnercentral_selling.types.sales_activities.SalesActivities"
    ]
    ...
    competitor_name: NotRequired[
        "aws_sdk_partnercentral_selling.types.competitor_name.CompetitorName"
    ]
...
def serialize_aws_json_1_0(value: Project) -> dict:
    ...
    if "apn_programs" in value:
        ...
        out["ApnPrograms"] = (
            aws_sdk_partnercentral_selling.types.apn_programs.serialize_aws_json_1_0(
                value["apn_programs"]
            )
        )
    ...
    if "sales_activities" in value:
        ...
        out["SalesActivities"] = (
            aws_sdk_partnercentral_selling.types.sales_activities.serialize_aws_json_1_0(
    ...
    if "competitor_name" in value:
        ...
        out["CompetitorName"] = (
            aws_sdk_partnercentral_selling.types.competitor_name.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Project:
    ...
    if "ApnPrograms" in data:
        ...
        out["apn_programs"] = (
            aws_sdk_partnercentral_selling.types.apn_programs.deserialize_aws_json_1_0(
                data["ApnPrograms"]
            )
        )
    ...
    if "SalesActivities" in data:
        ...
        out["sales_activities"] = (
            aws_sdk_partnercentral_selling.types.sales_activities.deserialize_aws_json_1_0(
    ...
    if "CompetitorName" in data:
        ...
        out["competitor_name"] = (
            aws_sdk_partnercentral_selling.types.competitor_name.deserialize_aws_json_1_0(
                data["CompetitorName"]
            )
        )
