...
if TYPE_CHECKING:
    ...
    import aws_sdk_partnercentral_selling.types.solution_arn
...
class SolutionBase(TypedDict, closed=True):
    ...
    arn: NotRequired["aws_sdk_partnercentral_selling.types.solution_arn.SolutionArn"]
    """<p> The SolutionBase structure provides essential information about a solution. </p>"""
    name: "str"
    """<p>Specifies the solution name.</p>"""
    status: "aws_sdk_partnercentral_selling.types.solution_status.SolutionStatus"
