...
class ListResourceSnapshotsResponse(TypedDict):
    resource_snapshot_summaries: "aws_sdk_partnercentral_selling.types.resource_snapshot_summary_list.ResourceSnapshotSummaryList"
...
def serialize_aws_json_1_0(value: ListResourceSnapshotsResponse) -> dict:
    ...
    out["ResourceSnapshotSummaries"] = (
        aws_sdk_partnercentral_selling.types.resource_snapshot_summary_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListResourceSnapshotsResponse:
    ...
    if "ResourceSnapshotSummaries" in data:
        ...
        out["resource_snapshot_summaries"] = (
            aws_sdk_partnercentral_selling.types.resource_snapshot_summary_list.deserialize_aws_json_1_0(
