...
if TYPE_CHECKING:
    import aws_sdk_partnercentral_selling.types.amount_map
    import aws_sdk_partnercentral_selling.types.aws_products_list
...
class AwsProductInsights(TypedDict):
    ...
    total_amount_by_category: (
        "aws_sdk_partnercentral_selling.types.amount_map.AmountMap"
    )
    """<p>Spend amounts mapped to AWS programs and modernization pathways.</p>"""
    aws_products: (
        "aws_sdk_partnercentral_selling.types.aws_products_list.AwsProductsList"
    )
...
def serialize_aws_json_1_0(value: AwsProductInsights) -> dict:
    ...
    out["TotalAmountByCategory"] = (
        aws_sdk_partnercentral_selling.types.amount_map.serialize_aws_json_1_0(
    ...
    out["AwsProducts"] = (
        aws_sdk_partnercentral_selling.types.aws_products_list.serialize_aws_json_1_0(
            value["aws_products"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> AwsProductInsights:
    ...
    if "TotalAmountByCategory" in data:
        ...
        out["total_amount_by_category"] = (
            aws_sdk_partnercentral_selling.types.amount_map.deserialize_aws_json_1_0(
    ...
    if "AwsProducts" in data:
        ...
        out["aws_products"] = (
            aws_sdk_partnercentral_selling.types.aws_products_list.deserialize_aws_json_1_0(
                data["AwsProducts"]
            )
        )
    else:
