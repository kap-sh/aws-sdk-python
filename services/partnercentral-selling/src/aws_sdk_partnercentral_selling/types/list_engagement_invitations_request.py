...
class ListEngagementInvitationsRequest(TypedDict):
...
def serialize_aws_json_1_0(value: ListEngagementInvitationsRequest) -> dict:
    ...
    if "sort" in value:
        ...
        out["Sort"] = (
            aws_sdk_partnercentral_selling.types.opportunity_engagement_invitation_sort.serialize_aws_json_1_0(
                value["sort"]
            )
        )
    if "payload_type" in value:
        ...
        out["PayloadType"] = (
            aws_sdk_partnercentral_selling.types.engagement_invitations_payload_type.serialize_aws_json_1_0(
                value["payload_type"]
            )
        )
    import aws_sdk_partnercentral_selling.types.participant_type
    ...
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_partnercentral_selling.types.invitation_status_list.serialize_aws_json_1_0(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListEngagementInvitationsRequest:
    ...
    if "Sort" in data:
        ...
        out["sort"] = (
            aws_sdk_partnercentral_selling.types.opportunity_engagement_invitation_sort.deserialize_aws_json_1_0(
                data["Sort"]
            )
        )
    if "PayloadType" in data:
        ...
        out["payload_type"] = (
            aws_sdk_partnercentral_selling.types.engagement_invitations_payload_type.deserialize_aws_json_1_0(
                data["PayloadType"]
            )
        )
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_partnercentral_selling.types.invitation_status_list.deserialize_aws_json_1_0(
                data["Status"]
            )
        )
