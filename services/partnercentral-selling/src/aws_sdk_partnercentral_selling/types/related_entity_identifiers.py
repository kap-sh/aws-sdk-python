...
if TYPE_CHECKING:
    import aws_sdk_partnercentral_selling.types.aws_marketplace_offer_identifiers
    import aws_sdk_partnercentral_selling.types.aws_marketplace_offer_set_identifiers
...
class RelatedEntityIdentifiers(TypedDict):
    aws_marketplace_offers: NotRequired[
        "aws_sdk_partnercentral_selling.types.aws_marketplace_offer_identifiers.AwsMarketplaceOfferIdentifiers"
    ]
    ...
    aws_marketplace_offer_sets: NotRequired[
        "aws_sdk_partnercentral_selling.types.aws_marketplace_offer_set_identifiers.AwsMarketplaceOfferSetIdentifiers"
    ]
...
def serialize_aws_json_1_0(value: RelatedEntityIdentifiers) -> dict:
    ...
    if "aws_marketplace_offers" in value:
        ...
        out["AwsMarketplaceOffers"] = (
            aws_sdk_partnercentral_selling.types.aws_marketplace_offer_identifiers.serialize_aws_json_1_0(
    ...
    if "aws_marketplace_offer_sets" in value:
        ...
        out["AwsMarketplaceOfferSets"] = (
            aws_sdk_partnercentral_selling.types.aws_marketplace_offer_set_identifiers.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> RelatedEntityIdentifiers:
    ...
    if "AwsMarketplaceOffers" in data:
        ...
        out["aws_marketplace_offers"] = (
            aws_sdk_partnercentral_selling.types.aws_marketplace_offer_identifiers.deserialize_aws_json_1_0(
    ...
    if "AwsMarketplaceOfferSets" in data:
        ...
        out["aws_marketplace_offer_sets"] = (
            aws_sdk_partnercentral_selling.types.aws_marketplace_offer_set_identifiers.deserialize_aws_json_1_0(
