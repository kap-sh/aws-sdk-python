...
class EngagementCustomer(TypedDict):
    industry: "aws_sdk_partnercentral_selling.types.industry.Industry"
    ...
    country_code: "aws_sdk_partnercentral_selling.types.country_code.CountryCode"
