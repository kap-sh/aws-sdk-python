...
class ListSolutionsRequest(TypedDict, closed=True):
    ...
    sort: NotRequired["aws_sdk_partnercentral_selling.types.solution_sort.SolutionSort"]
    ...
    category: NotRequired["aws_sdk_partnercentral_selling.types.string_list.StringList"]
...
def serialize_aws_json_1_0(value: ListSolutionsRequest) -> dict:
    ...
    if "sort" in value:
        ...
        out["Sort"] = (
            aws_sdk_partnercentral_selling.types.solution_sort.serialize_aws_json_1_0(
                value["sort"]
            )
        )
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_partnercentral_selling.types.filter_status.serialize_aws_json_1_0(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListSolutionsRequest:
    ...
    if "Sort" in data:
        ...
        out["sort"] = (
            aws_sdk_partnercentral_selling.types.solution_sort.deserialize_aws_json_1_0(
                data["Sort"]
            )
        )
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_partnercentral_selling.types.filter_status.deserialize_aws_json_1_0(
                data["Status"]
            )
        )
