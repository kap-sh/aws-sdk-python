...
EngagementMembers: TypeAlias = list[
    "aws_sdk_partnercentral_selling.types.engagement_member.EngagementMember"
]
...
def serialize_aws_json_1_0(value: EngagementMembers) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_partnercentral_selling.types.engagement_member.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> EngagementMembers:
    ...
    for item in data:
        out.append(
            aws_sdk_partnercentral_selling.types.engagement_member.deserialize_aws_json_1_0(
                item
            )
        )
    return out
