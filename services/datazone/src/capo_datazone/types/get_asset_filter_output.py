"""Generated from Smithy shape ``com.amazonaws.datazone#GetAssetFilterOutput``."""
...
class GetAssetFilterOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetAssetFilterOutput) -> dict:
    out: dict = {}
    out["id"] = value["id"]
