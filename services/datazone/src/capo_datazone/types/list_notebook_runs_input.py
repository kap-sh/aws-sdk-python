...
class ListNotebookRunsInput(TypedDict, closed=True):
    ...
    notebook_identifier: NotRequired["capo_datazone.types.notebook_id.NotebookId"]
    """<p>The identifier of the notebook to filter runs by.</p>"""
    status: NotRequired["capo_datazone.types.notebook_run_status.NotebookRunStatus"]
