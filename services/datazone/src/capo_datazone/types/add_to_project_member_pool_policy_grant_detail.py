"""Generated from Smithy shape ``com.amazonaws.datazone#AddToProjectMemberPoolPolicyGrantDetail``."""

from typing_extensions import NotRequired, TypedDict


class AddToProjectMemberPoolPolicyGrantDetail(TypedDict, closed=True):
...
def deserialize_json(data: dict) -> AddToProjectMemberPoolPolicyGrantDetail:
    out: AddToProjectMemberPoolPolicyGrantDetail = {}  # type: ignore[typeddict-item]
