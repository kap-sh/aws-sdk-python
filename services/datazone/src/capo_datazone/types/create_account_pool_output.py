...
# --- restJson1 ser/de ---
def serialize_json(value: CreateAccountPoolOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateAccountPoolOutput:
    out: CreateAccountPoolOutput = {}  # type: ignore[typeddict-item]
    if "domainId" in data:
    ...
    if "accountSource" in data:
        ...
        raise DeserializationError("CreateAccountPoolOutput.account_source required")
    if "createdBy" in data:
        out["created_by"] = data["createdBy"]
    else:
        raise DeserializationError("CreateAccountPoolOutput.created_by required")
