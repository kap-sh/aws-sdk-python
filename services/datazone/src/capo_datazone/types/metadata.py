...
if TYPE_CHECKING:
    import capo_datazone.types.metadata_key
    import capo_datazone.types.metadata_value

Metadata: TypeAlias = dict[
    "capo_datazone.types.metadata_key.MetadataKey",
    "capo_datazone.types.metadata_value.MetadataValue",
]
