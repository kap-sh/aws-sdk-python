...
def handle_response(
    ...
    out: capo_datazone.types.get_account_pool_output.GetAccountPoolOutput = (
        capo_datazone.types.get_account_pool_output.deserialize_json(
...
def get_account_pool(
    ...
    capo_datazone.types.get_account_pool_output.GetAccountPoolOutput, zapros.Response
]:
