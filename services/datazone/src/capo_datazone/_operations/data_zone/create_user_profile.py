...
def handle_response(
    ...
    out: capo_datazone.types.create_user_profile_output.CreateUserProfileOutput = (
        capo_datazone.types.create_user_profile_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_user_profile_input.serialize_json(input_)
    ).encode()
