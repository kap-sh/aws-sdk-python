"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateDataSource``."""
...
def handle_response(
    ...
    out: capo_datazone.types.update_data_source_output.UpdateDataSourceOutput = (
        capo_datazone.types.update_data_source_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_data_source_input.serialize_json(input_)
    ).encode()
