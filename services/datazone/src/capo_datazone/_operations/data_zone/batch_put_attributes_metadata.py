"""Generated from Smithy shape ``com.amazonaws.datazone#BatchPutAttributesMetadata``."""
...
def handle_response(
    ...
    out: capo_datazone.types.batch_put_attributes_metadata_output.BatchPutAttributesMetadataOutput = capo_datazone.types.batch_put_attributes_metadata_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.batch_put_attributes_metadata_input.serialize_json(input_)
    ).encode()
...
async def async_batch_put_attributes_metadata(
