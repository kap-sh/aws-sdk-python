"""Generated from Smithy shape ``com.amazonaws.datazone#CreateProjectMembership``."""
...
def handle_response(
    ...
    out: capo_datazone.types.create_project_membership_output.CreateProjectMembershipOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_project_membership_input.serialize_json(input_)
    ).encode()
...
async def async_create_project_membership(
