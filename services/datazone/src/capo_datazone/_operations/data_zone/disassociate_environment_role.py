"""Generated from Smithy shape ``com.amazonaws.datazone#DisassociateEnvironmentRole``."""
...
def handle_response(
    ...
    out: capo_datazone.types.disassociate_environment_role_output.DisassociateEnvironmentRoleOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disassociate_environment_role(
