"""Generated from Smithy shape ``com.amazonaws.datazone#ListPolicyGrants``."""
...
def handle_response(
    ...
    out: capo_datazone.types.list_policy_grants_output.ListPolicyGrantsOutput = (
        capo_datazone.types.list_policy_grants_output.deserialize_json(
