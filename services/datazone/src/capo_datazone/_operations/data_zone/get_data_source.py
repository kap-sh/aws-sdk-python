"""Generated from Smithy shape ``com.amazonaws.datazone#GetDataSource``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_data_source_output.GetDataSourceOutput = (
        capo_datazone.types.get_data_source_output.deserialize_json(
...
def get_data_source(
    ...
    capo_datazone.types.get_data_source_output.GetDataSourceOutput, zapros.Response
]:
