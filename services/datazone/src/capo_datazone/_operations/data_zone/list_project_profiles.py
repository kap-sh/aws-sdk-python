"""Generated from Smithy shape ``com.amazonaws.datazone#ListProjectProfiles``."""
...
import capo_datazone.types.project_profile_summaries
...
def handle_response(
    ...
    out: capo_datazone.types.list_project_profiles_output.ListProjectProfilesOutput = (
        capo_datazone.types.list_project_profiles_output.deserialize_json(
...
async def async_list_project_profiles(
