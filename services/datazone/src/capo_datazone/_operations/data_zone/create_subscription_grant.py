"""Generated from Smithy shape ``com.amazonaws.datazone#CreateSubscriptionGrant``."""
...
def handle_response(
    ...
    out: capo_datazone.types.create_subscription_grant_output.CreateSubscriptionGrantOutput = capo_datazone.types.create_subscription_grant_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_subscription_grant_input.serialize_json(input_)
    ).encode()
...
async def async_create_subscription_grant(
