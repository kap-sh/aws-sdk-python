"""Generated from Smithy shape ``com.amazonaws.datazone#GetGroupProfile``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_group_profile_output.GetGroupProfileOutput = (
        capo_datazone.types.get_group_profile_output.deserialize_json(
...
def get_group_profile(
    ...
    capo_datazone.types.get_group_profile_output.GetGroupProfileOutput, zapros.Response
]:
...
async def async_get_group_profile(
