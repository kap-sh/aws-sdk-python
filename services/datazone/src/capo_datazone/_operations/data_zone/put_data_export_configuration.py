"""Generated from Smithy shape ``com.amazonaws.datazone#PutDataExportConfiguration``."""
...
def handle_response(
    ...
    out: capo_datazone.types.put_data_export_configuration_output.PutDataExportConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.put_data_export_configuration_input.serialize_json(input_)
    ).encode()
...
async def async_put_data_export_configuration(
