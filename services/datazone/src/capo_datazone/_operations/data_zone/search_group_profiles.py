...
import capo_datazone.types.group_profile_summaries
...
def handle_response(
    ...
    out: capo_datazone.types.search_group_profiles_output.SearchGroupProfilesOutput = (
        capo_datazone.types.search_group_profiles_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.search_group_profiles_input.serialize_json(input_)
    ).encode()
