...
def handle_response(
    ...
    out: capo_datazone.types.remove_entity_owner_output.RemoveEntityOwnerOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.remove_entity_owner_input.serialize_json(input_)
    ).encode()
