...
def handle_response(
    ...
    out: capo_datazone.types.list_subscription_grants_output.ListSubscriptionGrantsOutput = capo_datazone.types.list_subscription_grants_output.deserialize_json(
