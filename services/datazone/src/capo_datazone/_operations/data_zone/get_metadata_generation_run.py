"""Generated from Smithy shape ``com.amazonaws.datazone#GetMetadataGenerationRun``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_metadata_generation_run_output.GetMetadataGenerationRunOutput = capo_datazone.types.get_metadata_generation_run_output.deserialize_json(
...
async def async_get_metadata_generation_run(
