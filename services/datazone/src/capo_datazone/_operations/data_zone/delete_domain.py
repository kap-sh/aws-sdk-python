"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteDomain``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_domain_output.DeleteDomainOutput = (
        capo_datazone.types.delete_domain_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/domains/{identifier}"
    ...
    if "skip_deletion_check" in input_:
        params["skipDeletionCheck"] = str(input_["skip_deletion_check"])
...
def delete_domain(
    ...
    capo_datazone.types.delete_domain_output.DeleteDomainOutput, zapros.Response
]:
