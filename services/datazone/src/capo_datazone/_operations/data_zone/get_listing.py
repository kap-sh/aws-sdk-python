"""Generated from Smithy shape ``com.amazonaws.datazone#GetListing``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_listing_output.GetListingOutput = (
        capo_datazone.types.get_listing_output.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    params["listingRevision"] = str(input_.get("listing_revision", "latest"))
...
def get_listing(
    ...
    input_: capo_datazone.types.get_listing_input.GetListingInput,
) -> tuple[capo_datazone.types.get_listing_output.GetListingOutput, zapros.Response]:
