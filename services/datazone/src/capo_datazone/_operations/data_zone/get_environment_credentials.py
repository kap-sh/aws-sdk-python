"""Generated from Smithy shape ``com.amazonaws.datazone#GetEnvironmentCredentials``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_environment_credentials_output.GetEnvironmentCredentialsOutput = capo_datazone.types.get_environment_credentials_output.deserialize_json(
...
async def async_get_environment_credentials(
