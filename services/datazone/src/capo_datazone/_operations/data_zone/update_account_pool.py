"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateAccountPool``."""
...
def handle_response(
    ...
    out: capo_datazone.types.update_account_pool_output.UpdateAccountPoolOutput = (
        capo_datazone.types.update_account_pool_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_account_pool_input.serialize_json(input_)
    ).encode()
...
async def async_update_account_pool(
