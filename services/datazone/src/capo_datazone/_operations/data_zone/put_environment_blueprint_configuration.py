"""Generated from Smithy shape ``com.amazonaws.datazone#PutEnvironmentBlueprintConfiguration``."""
...
def handle_response(
    ...
    out: capo_datazone.types.put_environment_blueprint_configuration_output.PutEnvironmentBlueprintConfigurationOutput = capo_datazone.types.put_environment_blueprint_configuration_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.put_environment_blueprint_configuration_input.serialize_json(
            input_
        )
    ).encode()
