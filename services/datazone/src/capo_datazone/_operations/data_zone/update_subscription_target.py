"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateSubscriptionTarget``."""
...
def handle_response(
    ...
    out: capo_datazone.types.update_subscription_target_output.UpdateSubscriptionTargetOutput = capo_datazone.types.update_subscription_target_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_subscription_target_input.serialize_json(input_)
    ).encode()
...
async def async_update_subscription_target(
