"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteFormType``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_form_type_output.DeleteFormTypeOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_form_type(
    ...
    capo_datazone.types.delete_form_type_output.DeleteFormTypeOutput, zapros.Response
]:
...
async def async_delete_form_type(
