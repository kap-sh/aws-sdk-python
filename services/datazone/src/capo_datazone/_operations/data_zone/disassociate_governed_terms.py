"""Generated from Smithy shape ``com.amazonaws.datazone#DisassociateGovernedTerms``."""
...
def handle_response(
    ...
    out: capo_datazone.types.disassociate_governed_terms_output.DisassociateGovernedTermsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.disassociate_governed_terms_input.serialize_json(input_)
    ).encode()
...
async def async_disassociate_governed_terms(
