"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateEnvironment``."""
...
def handle_response(
    ...
    out: capo_datazone.types.update_environment_output.UpdateEnvironmentOutput = (
        capo_datazone.types.update_environment_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_environment_input.serialize_json(input_)
    ).encode()
