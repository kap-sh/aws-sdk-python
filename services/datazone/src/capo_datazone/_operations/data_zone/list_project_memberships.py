...
def handle_response(
    ...
    out: capo_datazone.types.list_project_memberships_output.ListProjectMembershipsOutput = capo_datazone.types.list_project_memberships_output.deserialize_json(
