"""Generated from Smithy shape ``com.amazonaws.datazone#GetProjectProfile``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_project_profile_output.GetProjectProfileOutput = (
        capo_datazone.types.get_project_profile_output.deserialize_json(
...
async def async_get_project_profile(
