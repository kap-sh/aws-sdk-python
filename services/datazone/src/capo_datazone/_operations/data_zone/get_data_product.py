...
def handle_response(
    ...
    out: capo_datazone.types.get_data_product_output.GetDataProductOutput = (
        capo_datazone.types.get_data_product_output.deserialize_json(
...
def get_data_product(
    ...
    capo_datazone.types.get_data_product_output.GetDataProductOutput, zapros.Response
]:
