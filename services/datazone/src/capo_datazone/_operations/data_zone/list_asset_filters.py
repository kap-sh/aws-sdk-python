"""Generated from Smithy shape ``com.amazonaws.datazone#ListAssetFilters``."""
...
import capo_datazone.types.asset_filters
...
def handle_response(
    ...
    out: capo_datazone.types.list_asset_filters_output.ListAssetFiltersOutput = (
        capo_datazone.types.list_asset_filters_output.deserialize_json(
...
async def async_list_asset_filters(
