"""Generated from Smithy shape ``com.amazonaws.datazone#CreateEnvironmentBlueprint``."""
...
def handle_response(
    ...
    out: capo_datazone.types.create_environment_blueprint_output.CreateEnvironmentBlueprintOutput = capo_datazone.types.create_environment_blueprint_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_environment_blueprint_input.serialize_json(input_)
    ).encode()
...
async def async_create_environment_blueprint(
