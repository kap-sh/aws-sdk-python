"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteDomainUnit``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_domain_unit_output.DeleteDomainUnitOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_domain_unit(
