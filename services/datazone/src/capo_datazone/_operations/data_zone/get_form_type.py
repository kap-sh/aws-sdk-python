...
def handle_response(
    ...
    out: capo_datazone.types.get_form_type_output.GetFormTypeOutput = (
        capo_datazone.types.get_form_type_output.deserialize_json(
...
def get_form_type(
    ...
    input_: capo_datazone.types.get_form_type_input.GetFormTypeInput,
) -> tuple[capo_datazone.types.get_form_type_output.GetFormTypeOutput, zapros.Response]:
