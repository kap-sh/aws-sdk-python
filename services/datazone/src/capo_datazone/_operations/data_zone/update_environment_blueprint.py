"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateEnvironmentBlueprint``."""
...
def handle_response(
    ...
    out: capo_datazone.types.update_environment_blueprint_output.UpdateEnvironmentBlueprintOutput = capo_datazone.types.update_environment_blueprint_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_environment_blueprint_input.serialize_json(input_)
    ).encode()
...
async def async_update_environment_blueprint(
