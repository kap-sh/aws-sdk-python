"""Generated from Smithy shape ``com.amazonaws.datazone#GetGlossaryTerm``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_glossary_term_output.GetGlossaryTermOutput = (
        capo_datazone.types.get_glossary_term_output.deserialize_json(
...
def get_glossary_term(
    ...
    capo_datazone.types.get_glossary_term_output.GetGlossaryTermOutput, zapros.Response
]:
...
async def async_get_glossary_term(
