...
def handle_response(
    ...
    out: capo_datazone.types.search_user_profiles_output.SearchUserProfilesOutput = (
        capo_datazone.types.search_user_profiles_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.search_user_profiles_input.serialize_json(input_)
    ).encode()
