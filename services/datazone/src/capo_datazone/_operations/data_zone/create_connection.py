"""Generated from Smithy shape ``com.amazonaws.datazone#CreateConnection``."""
...
def handle_response(
    ...
    out: capo_datazone.types.create_connection_output.CreateConnectionOutput = (
        capo_datazone.types.create_connection_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_connection_input.serialize_json(input_)
    ).encode()
...
def create_connection(
    ...
    capo_datazone.types.create_connection_output.CreateConnectionOutput, zapros.Response
]:
