"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteAssetType``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_asset_type_output.DeleteAssetTypeOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_asset_type(
    ...
    capo_datazone.types.delete_asset_type_output.DeleteAssetTypeOutput, zapros.Response
]:
...
async def async_delete_asset_type(
