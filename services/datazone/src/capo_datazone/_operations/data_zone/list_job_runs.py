"""Generated from Smithy shape ``com.amazonaws.datazone#ListJobRuns``."""
...
import capo_datazone.types.job_run_summaries
...
def handle_response(
    ...
    out: capo_datazone.types.list_job_runs_output.ListJobRunsOutput = (
        capo_datazone.types.list_job_runs_output.deserialize_json(
...
def list_job_runs(
    ...
    input_: capo_datazone.types.list_job_runs_input.ListJobRunsInput,
) -> tuple[capo_datazone.types.list_job_runs_output.ListJobRunsOutput, zapros.Response]:
