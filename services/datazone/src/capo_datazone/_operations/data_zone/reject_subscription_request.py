"""Generated from Smithy shape ``com.amazonaws.datazone#RejectSubscriptionRequest``."""
...
def handle_response(
    ...
    out: capo_datazone.types.reject_subscription_request_output.RejectSubscriptionRequestOutput = capo_datazone.types.reject_subscription_request_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.reject_subscription_request_input.serialize_json(input_)
    ).encode()
...
async def async_reject_subscription_request(
