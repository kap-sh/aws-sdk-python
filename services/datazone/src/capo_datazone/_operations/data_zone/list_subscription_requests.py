"""Generated from Smithy shape ``com.amazonaws.datazone#ListSubscriptionRequests``."""
...
import capo_datazone.types.subscription_requests
...
def handle_response(
    ...
    out: capo_datazone.types.list_subscription_requests_output.ListSubscriptionRequestsOutput = capo_datazone.types.list_subscription_requests_output.deserialize_json(
...
async def async_list_subscription_requests(
