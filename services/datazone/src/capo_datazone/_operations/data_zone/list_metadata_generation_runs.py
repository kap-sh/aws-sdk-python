"""Generated from Smithy shape ``com.amazonaws.datazone#ListMetadataGenerationRuns``."""
...
def handle_response(
    ...
    out: capo_datazone.types.list_metadata_generation_runs_output.ListMetadataGenerationRunsOutput = capo_datazone.types.list_metadata_generation_runs_output.deserialize_json(
...
def build_request(
    ...
    if "target_identifier" in input_:
        params["targetIdentifier"] = str(input_["target_identifier"])
...
async def async_list_metadata_generation_runs(
