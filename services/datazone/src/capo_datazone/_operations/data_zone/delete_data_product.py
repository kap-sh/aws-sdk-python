"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteDataProduct``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_data_product_output.DeleteDataProductOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_data_product(
