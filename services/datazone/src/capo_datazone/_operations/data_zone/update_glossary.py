"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateGlossary``."""
...
def handle_response(
    ...
    out: capo_datazone.types.update_glossary_output.UpdateGlossaryOutput = (
        capo_datazone.types.update_glossary_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_glossary_input.serialize_json(input_)
    ).encode()
...
def update_glossary(
    ...
    capo_datazone.types.update_glossary_output.UpdateGlossaryOutput, zapros.Response
]:
...
async def async_update_glossary(
