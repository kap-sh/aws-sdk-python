"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteSubscriptionGrant``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_subscription_grant_output.DeleteSubscriptionGrantOutput = capo_datazone.types.delete_subscription_grant_output.deserialize_json(
...
async def async_delete_subscription_grant(
