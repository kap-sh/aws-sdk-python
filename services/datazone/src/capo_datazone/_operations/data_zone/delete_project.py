...
def handle_response(
    ...
    out: capo_datazone.types.delete_project_output.DeleteProjectOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_project(
    ...
    capo_datazone.types.delete_project_output.DeleteProjectOutput, zapros.Response
]:
