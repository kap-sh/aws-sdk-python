"""Generated from Smithy shape ``com.amazonaws.datazone#CreateSubscriptionTarget``."""
...
def handle_response(
    ...
    out: capo_datazone.types.create_subscription_target_output.CreateSubscriptionTargetOutput = capo_datazone.types.create_subscription_target_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_subscription_target_input.serialize_json(input_)
    ).encode()
...
async def async_create_subscription_target(
