"""Generated from Smithy shape ``com.amazonaws.datazone#RevokeSubscription``."""
...
def handle_response(
    ...
    out: capo_datazone.types.revoke_subscription_output.RevokeSubscriptionOutput = (
        capo_datazone.types.revoke_subscription_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.revoke_subscription_input.serialize_json(input_)
    ).encode()
...
async def async_revoke_subscription(
