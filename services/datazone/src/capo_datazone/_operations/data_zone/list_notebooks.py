"""Generated from Smithy shape ``com.amazonaws.datazone#ListNotebooks``."""
...
def handle_response(
    ...
    out: capo_datazone.types.list_notebooks_output.ListNotebooksOutput = (
        capo_datazone.types.list_notebooks_output.deserialize_json(
...
def list_notebooks(
    ...
    capo_datazone.types.list_notebooks_output.ListNotebooksOutput, zapros.Response
]:
...
async def async_list_notebooks(
