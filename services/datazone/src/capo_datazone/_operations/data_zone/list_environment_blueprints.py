...
def handle_response(
    ...
    out: capo_datazone.types.list_environment_blueprints_output.ListEnvironmentBlueprintsOutput = capo_datazone.types.list_environment_blueprints_output.deserialize_json(
