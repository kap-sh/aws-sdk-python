"""Generated from Smithy shape ``com.amazonaws.datazone#CreateEnvironment``."""
...
def handle_response(
    ...
    out: capo_datazone.types.create_environment_output.CreateEnvironmentOutput = (
        capo_datazone.types.create_environment_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_environment_input.serialize_json(input_)
    ).encode()
