"""Generated from Smithy shape ``com.amazonaws.datazone#CreateDataSource``."""
...
def handle_response(
    ...
    out: capo_datazone.types.create_data_source_output.CreateDataSourceOutput = (
        capo_datazone.types.create_data_source_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_data_source_input.serialize_json(input_)
    ).encode()
