"""Generated from Smithy shape ``com.amazonaws.datazone#GetDomain``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_domain_output.GetDomainOutput = (
        capo_datazone.types.get_domain_output.deserialize_json(
...
def get_domain(
    ...
    input_: capo_datazone.types.get_domain_input.GetDomainInput,
) -> tuple[capo_datazone.types.get_domain_output.GetDomainOutput, zapros.Response]:
