...
def handle_response(
    ...
    out: capo_datazone.types.list_data_product_revisions_output.ListDataProductRevisionsOutput = capo_datazone.types.list_data_product_revisions_output.deserialize_json(
