...
def handle_response(
    ...
    out: capo_datazone.types.update_asset_filter_output.UpdateAssetFilterOutput = (
        capo_datazone.types.update_asset_filter_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_asset_filter_input.serialize_json(input_)
    ).encode()
