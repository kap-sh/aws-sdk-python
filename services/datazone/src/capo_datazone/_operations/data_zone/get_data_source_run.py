"""Generated from Smithy shape ``com.amazonaws.datazone#GetDataSourceRun``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_data_source_run_output.GetDataSourceRunOutput = (
        capo_datazone.types.get_data_source_run_output.deserialize_json(
...
async def async_get_data_source_run(
