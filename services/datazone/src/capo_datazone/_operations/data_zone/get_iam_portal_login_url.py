"""Generated from Smithy shape ``com.amazonaws.datazone#GetIamPortalLoginUrl``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_iam_portal_login_url_output.GetIamPortalLoginUrlOutput = capo_datazone.types.get_iam_portal_login_url_output.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/v2/domains/{domainIdentifier}/get-portal-login-url"
    )
    url = url.replace(
...
async def async_get_iam_portal_login_url(
