"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteDataExportConfiguration``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_data_export_configuration_output.DeleteDataExportConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_data_export_configuration(
