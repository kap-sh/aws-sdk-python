"""Generated from Smithy shape ``com.amazonaws.datazone#ListDataSources``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_datazone.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_datazone.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_datazone.types.list_data_sources_output.ListDataSourcesOutput = (
        capo_datazone.types.list_data_sources_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/domains/{domainIdentifier}/data-sources"
    url = url.replace(
    ...
    if "connection_identifier" in input_:
        params["connectionIdentifier"] = str(input_["connection_identifier"])
    if "type" in input_:
...
def list_data_sources(
    ...
    capo_datazone.types.list_data_sources_output.ListDataSourcesOutput, zapros.Response
]:
...
async def async_list_data_sources(
