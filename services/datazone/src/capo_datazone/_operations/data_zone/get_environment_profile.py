"""Generated from Smithy shape ``com.amazonaws.datazone#GetEnvironmentProfile``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_environment_profile_output.GetEnvironmentProfileOutput = capo_datazone.types.get_environment_profile_output.deserialize_json(
...
async def async_get_environment_profile(
