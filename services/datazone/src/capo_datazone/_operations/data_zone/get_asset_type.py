"""Generated from Smithy shape ``com.amazonaws.datazone#GetAssetType``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_asset_type_output.GetAssetTypeOutput = (
        capo_datazone.types.get_asset_type_output.deserialize_json(
...
def get_asset_type(
    ...
    capo_datazone.types.get_asset_type_output.GetAssetTypeOutput, zapros.Response
]:
...
async def async_get_asset_type(
