"""Generated from Smithy shape ``com.amazonaws.datazone#GetEnvironmentAction``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_environment_action_output.GetEnvironmentActionOutput = capo_datazone.types.get_environment_action_output.deserialize_json(
...
async def async_get_environment_action(
