"""Generated from Smithy shape ``com.amazonaws.datazone#StartNotebookImport``."""
...
def handle_response(
    ...
    out: capo_datazone.types.start_notebook_import_output.StartNotebookImportOutput = (
        capo_datazone.types.start_notebook_import_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/domains/{domainIdentifier}/notebook-imports"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.start_notebook_import_input.serialize_json(input_)
    ).encode()
...
async def async_start_notebook_import(
