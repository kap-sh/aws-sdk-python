"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateProject``."""
...
def handle_response(
    ...
    out: capo_datazone.types.update_project_output.UpdateProjectOutput = (
        capo_datazone.types.update_project_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_project_input.serialize_json(input_)
    ).encode()
...
def update_project(
    ...
    capo_datazone.types.update_project_output.UpdateProjectOutput, zapros.Response
]:
