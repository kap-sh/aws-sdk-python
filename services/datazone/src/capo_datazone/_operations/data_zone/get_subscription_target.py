...
def handle_response(
    ...
    out: capo_datazone.types.get_subscription_target_output.GetSubscriptionTargetOutput = capo_datazone.types.get_subscription_target_output.deserialize_json(
