...
class DataZoneError(Exception):
    """Base class for all DataZone service errors."""


class ServiceError(DataZoneError):
...
class SerializationError(DataZoneError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DataZoneError):
...
class WaiterFailedError(DataZoneError):
...
class WaiterTimeoutError(DataZoneError):
