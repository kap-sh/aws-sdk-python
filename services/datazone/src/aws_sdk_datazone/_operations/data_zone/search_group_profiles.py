"""Generated from Smithy shape ``com.amazonaws.datazone#SearchGroupProfiles``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.search_group_profiles_output.SearchGroupProfilesOutput = aws_sdk_datazone.types.search_group_profiles_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.search_group_profiles_input.SearchGroupProfilesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.search_group_profiles_input.serialize_json(input_)
    ).encode()
...
async def async_search_group_profiles(
