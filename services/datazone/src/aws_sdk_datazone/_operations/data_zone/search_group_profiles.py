...
def build_request(
    ...
    input: aws_sdk_datazone.types.search_group_profiles_input.SearchGroupProfilesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.search_group_profiles_input.serialize_json(input)
    ).encode()
