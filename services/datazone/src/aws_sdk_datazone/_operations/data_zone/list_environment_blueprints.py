"""Generated from Smithy shape ``com.amazonaws.datazone#ListEnvironmentBlueprints``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_environment_blueprints_output.ListEnvironmentBlueprintsOutput = aws_sdk_datazone.types.list_environment_blueprints_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_environment_blueprints_input.ListEnvironmentBlueprintsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "managed" in input_:
        params["managed"] = str(input_["managed"])
...
async def async_list_environment_blueprints(
