...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_group_profile_output.GetGroupProfileOutput = (
        aws_sdk_datazone.types.get_group_profile_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_group_profile_input.GetGroupProfileInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
