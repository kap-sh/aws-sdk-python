...
def build_request(
    ...
    input_: aws_sdk_datazone.types.accept_subscription_request_input.AcceptSubscriptionRequestInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.accept_subscription_request_input.serialize_json(input_)
    ).encode()
