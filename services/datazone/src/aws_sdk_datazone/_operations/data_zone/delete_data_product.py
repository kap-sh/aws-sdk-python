...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_data_product_output.DeleteDataProductOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_data_product_input.DeleteDataProductInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
