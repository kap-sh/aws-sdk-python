...
def build_request(
    ...
    input: aws_sdk_datazone.types.reject_subscription_request_input.RejectSubscriptionRequestInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.reject_subscription_request_input.serialize_json(input)
    ).encode()
