...
def handle_response(
    ...
    out: aws_sdk_datazone.types.reject_subscription_request_output.RejectSubscriptionRequestOutput = aws_sdk_datazone.types.reject_subscription_request_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.reject_subscription_request_input.RejectSubscriptionRequestInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.reject_subscription_request_input.serialize_json(input_)
    ).encode()
