...
def build_request(
    ...
    input: aws_sdk_datazone.types.update_project_profile_input.UpdateProjectProfileInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_project_profile_input.serialize_json(input)
    ).encode()
