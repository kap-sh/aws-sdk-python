...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_project_profile_output.UpdateProjectProfileOutput = aws_sdk_datazone.types.update_project_profile_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_project_profile_input.UpdateProjectProfileInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_project_profile_input.serialize_json(input_)
    ).encode()
