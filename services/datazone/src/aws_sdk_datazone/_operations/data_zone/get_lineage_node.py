...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_lineage_node_output.GetLineageNodeOutput = (
        aws_sdk_datazone.types.get_lineage_node_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.get_lineage_node_input.GetLineageNodeInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "event_timestamp" in input:
        params["timestamp"] = str(input["event_timestamp"])
...
def get_lineage_node(
    ...
    aws_sdk_datazone.types.get_lineage_node_output.GetLineageNodeOutput, zapros.Response
]:
