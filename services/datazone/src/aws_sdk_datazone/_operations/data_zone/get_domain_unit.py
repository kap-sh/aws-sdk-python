"""Generated from Smithy shape ``com.amazonaws.datazone#GetDomainUnit``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_domain_unit_output.GetDomainUnitOutput = (
        aws_sdk_datazone.types.get_domain_unit_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_domain_unit_input.GetDomainUnitInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_domain_unit(
    ...
    aws_sdk_datazone.types.get_domain_unit_output.GetDomainUnitOutput, zapros.Response
]:
...
async def async_get_domain_unit(
