...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_glossary_output.UpdateGlossaryOutput = (
        aws_sdk_datazone.types.update_glossary_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_glossary_input.UpdateGlossaryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_glossary_input.serialize_json(input_)
    ).encode()
...
def update_glossary(
    ...
    aws_sdk_datazone.types.update_glossary_output.UpdateGlossaryOutput, zapros.Response
]:
