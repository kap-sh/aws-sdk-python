...
def handle_response(
    ...
    out: aws_sdk_datazone.types.search_output.SearchOutput = (
        aws_sdk_datazone.types.search_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.search_input.SearchInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.search_input.serialize_json(input_)
    ).encode()
...
def search(
    options: OperationOptions, input_: aws_sdk_datazone.types.search_input.SearchInput
) -> tuple[aws_sdk_datazone.types.search_output.SearchOutput, zapros.Response]:
