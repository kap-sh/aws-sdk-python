...
def build_request(
    ...
    input: aws_sdk_datazone.types.search_input.SearchInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.search_input.serialize_json(input)
    ).encode()
...
def search(
    options: OperationOptions, input: aws_sdk_datazone.types.search_input.SearchInput
