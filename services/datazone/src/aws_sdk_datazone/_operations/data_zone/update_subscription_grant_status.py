"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateSubscriptionGrantStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_subscription_grant_status_output.UpdateSubscriptionGrantStatusOutput = aws_sdk_datazone.types.update_subscription_grant_status_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.update_subscription_grant_status_input.UpdateSubscriptionGrantStatusInput,
) -> zapros.Request:
    ...
    url = url.replace(
        "{assetIdentifier}", quote(str(input["asset_identifier"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_subscription_grant_status_input.serialize_json(
            input
        )
    ).encode()
...
async def async_update_subscription_grant_status(
