...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_data_export_configuration_output.DeleteDataExportConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_data_export_configuration_input.DeleteDataExportConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
