...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_domain_output.UpdateDomainOutput = (
        aws_sdk_datazone.types.update_domain_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.update_domain_input.UpdateDomainInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_domain_input.serialize_json(input)
    ).encode()
...
def update_domain(
    ...
    aws_sdk_datazone.types.update_domain_output.UpdateDomainOutput, zapros.Response
]:
