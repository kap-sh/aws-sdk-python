...
def build_request(
    ...
    input: aws_sdk_datazone.types.list_subscription_grants_input.ListSubscriptionGrantsInput,
) -> zapros.Request:
    ...
    if "subscription_target_id" in input:
        params["subscriptionTargetId"] = str(input["subscription_target_id"])
    if "subscribed_listing_id" in input:
        params["subscribedListingId"] = str(input["subscribed_listing_id"])
    if "subscription_id" in input:
        params["subscriptionId"] = str(input["subscription_id"])
