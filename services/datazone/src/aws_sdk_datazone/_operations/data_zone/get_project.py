...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_project_output.GetProjectOutput = (
        aws_sdk_datazone.types.get_project_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_project_input.GetProjectInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_project(
    ...
    input_: aws_sdk_datazone.types.get_project_input.GetProjectInput,
) -> tuple[aws_sdk_datazone.types.get_project_output.GetProjectOutput, zapros.Response]:
