...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_data_source_output.GetDataSourceOutput = (
        aws_sdk_datazone.types.get_data_source_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_data_source_input.GetDataSourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_data_source(
    ...
    aws_sdk_datazone.types.get_data_source_output.GetDataSourceOutput, zapros.Response
]:
