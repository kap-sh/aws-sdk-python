...
def build_request(
    ...
    input: aws_sdk_datazone.types.list_environments_input.ListEnvironmentsInput,
) -> zapros.Request:
    ...
    if "environment_profile_identifier" in input:
        params["environmentProfileIdentifier"] = str(
            input["environment_profile_identifier"]
        )
