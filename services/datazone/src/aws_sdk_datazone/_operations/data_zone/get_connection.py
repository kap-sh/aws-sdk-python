...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_connection_output.GetConnectionOutput = (
        aws_sdk_datazone.types.get_connection_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.get_connection_input.GetConnectionInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "with_secret" in input:
        params["withSecret"] = str(input["with_secret"])
...
def get_connection(
    ...
    aws_sdk_datazone.types.get_connection_output.GetConnectionOutput, zapros.Response
]:
