...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_asset_output.DeleteAssetOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_asset_input.DeleteAssetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_asset(
    ...
    aws_sdk_datazone.types.delete_asset_output.DeleteAssetOutput, zapros.Response
]:
