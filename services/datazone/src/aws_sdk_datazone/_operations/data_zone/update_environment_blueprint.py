...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_environment_blueprint_output.UpdateEnvironmentBlueprintOutput = aws_sdk_datazone.types.update_environment_blueprint_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_environment_blueprint_input.UpdateEnvironmentBlueprintInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_environment_blueprint_input.serialize_json(input_)
    ).encode()
