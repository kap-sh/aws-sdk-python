...
def build_request(
    ...
    input: aws_sdk_datazone.types.update_environment_blueprint_input.UpdateEnvironmentBlueprintInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_environment_blueprint_input.serialize_json(input)
    ).encode()
