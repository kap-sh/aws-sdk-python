"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteAssetFilter``."""
...
def build_request(
    ...
    input: aws_sdk_datazone.types.delete_asset_filter_input.DeleteAssetFilterInput,
) -> zapros.Request:
...
async def async_delete_asset_filter(
