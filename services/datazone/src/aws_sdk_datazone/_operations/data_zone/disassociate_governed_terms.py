...
def handle_response(
    ...
    out: aws_sdk_datazone.types.disassociate_governed_terms_output.DisassociateGovernedTermsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_datazone.types.disassociate_governed_terms_input.DisassociateGovernedTermsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.disassociate_governed_terms_input.serialize_json(input)
    ).encode()
