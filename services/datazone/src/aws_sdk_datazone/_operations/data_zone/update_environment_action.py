"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateEnvironmentAction``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_environment_action_output.UpdateEnvironmentActionOutput = aws_sdk_datazone.types.update_environment_action_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_environment_action_input.UpdateEnvironmentActionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_environment_action_input.serialize_json(input_)
    ).encode()
...
async def async_update_environment_action(
