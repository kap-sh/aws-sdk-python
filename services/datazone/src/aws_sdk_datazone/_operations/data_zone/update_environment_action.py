...
def build_request(
    ...
    input: aws_sdk_datazone.types.update_environment_action_input.UpdateEnvironmentActionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_environment_action_input.serialize_json(input)
    ).encode()
