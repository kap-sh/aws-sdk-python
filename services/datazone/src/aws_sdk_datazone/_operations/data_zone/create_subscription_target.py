...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_subscription_target_output.CreateSubscriptionTargetOutput = aws_sdk_datazone.types.create_subscription_target_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_subscription_target_input.CreateSubscriptionTargetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_subscription_target_input.serialize_json(input_)
    ).encode()
