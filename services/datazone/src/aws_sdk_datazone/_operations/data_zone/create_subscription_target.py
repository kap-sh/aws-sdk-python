...
def build_request(
    ...
    input: aws_sdk_datazone.types.create_subscription_target_input.CreateSubscriptionTargetInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_subscription_target_input.serialize_json(input)
    ).encode()
