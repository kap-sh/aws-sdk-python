...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_lineage_events_output.ListLineageEventsOutput = (
        aws_sdk_datazone.types.list_lineage_events_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.list_lineage_events_input.ListLineageEventsInput,
) -> zapros.Request:
    ...
    if "timestamp_after" in input:
        params["timestampAfter"] = str(input["timestamp_after"])
    if "timestamp_before" in input:
        params["timestampBefore"] = str(input["timestamp_before"])
    if "processing_status" in input:
        params["processingStatus"] = str(input["processing_status"])
