...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_asset_type_output.DeleteAssetTypeOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_asset_type_input.DeleteAssetTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
