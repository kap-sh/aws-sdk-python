"""Generated from Smithy shape ``com.amazonaws.datazone#GetDataProduct``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_data_product_output.GetDataProductOutput = (
        aws_sdk_datazone.types.get_data_product_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_data_product_input.GetDataProductInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_data_product(
    ...
    aws_sdk_datazone.types.get_data_product_output.GetDataProductOutput, zapros.Response
]:
...
async def async_get_data_product(
