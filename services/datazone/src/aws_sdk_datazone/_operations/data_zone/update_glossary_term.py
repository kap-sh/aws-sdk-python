"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateGlossaryTerm``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_glossary_term_output.UpdateGlossaryTermOutput = (
        aws_sdk_datazone.types.update_glossary_term_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_glossary_term_input.UpdateGlossaryTermInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_glossary_term_input.serialize_json(input_)
    ).encode()
...
async def async_update_glossary_term(
