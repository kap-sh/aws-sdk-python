...
def handle_response(
    ...
    out: aws_sdk_datazone.types.cancel_metadata_generation_run_output.CancelMetadataGenerationRunOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.cancel_metadata_generation_run_input.CancelMetadataGenerationRunInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
