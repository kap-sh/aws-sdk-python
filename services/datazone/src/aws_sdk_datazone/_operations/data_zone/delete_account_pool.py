"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteAccountPool``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_account_pool_output.DeleteAccountPoolOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_account_pool_input.DeleteAccountPoolInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_account_pool(
