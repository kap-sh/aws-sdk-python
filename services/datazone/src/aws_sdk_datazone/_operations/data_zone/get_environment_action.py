...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_environment_action_output.GetEnvironmentActionOutput = aws_sdk_datazone.types.get_environment_action_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_environment_action_input.GetEnvironmentActionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
