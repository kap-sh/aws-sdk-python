...
def build_request(
    ...
    input: aws_sdk_datazone.types.update_environment_profile_input.UpdateEnvironmentProfileInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_environment_profile_input.serialize_json(input)
    ).encode()
