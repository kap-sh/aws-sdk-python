...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_environment_profile_output.UpdateEnvironmentProfileOutput = aws_sdk_datazone.types.update_environment_profile_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_environment_profile_input.UpdateEnvironmentProfileInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_environment_profile_input.serialize_json(input_)
    ).encode()
