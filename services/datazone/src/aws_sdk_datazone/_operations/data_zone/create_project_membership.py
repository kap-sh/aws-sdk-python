...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_project_membership_output.CreateProjectMembershipOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_project_membership_input.CreateProjectMembershipInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_project_membership_input.serialize_json(input_)
    ).encode()
