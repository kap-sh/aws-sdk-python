"""Generated from Smithy shape ``com.amazonaws.datazone#ListEnvironmentBlueprintConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_environment_blueprint_configurations_output.ListEnvironmentBlueprintConfigurationsOutput = aws_sdk_datazone.types.list_environment_blueprint_configurations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_environment_blueprint_configurations_input.ListEnvironmentBlueprintConfigurationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_environment_blueprint_configurations(
