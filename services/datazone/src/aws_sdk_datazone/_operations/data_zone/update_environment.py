...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_environment_output.UpdateEnvironmentOutput = (
        aws_sdk_datazone.types.update_environment_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_environment_input.UpdateEnvironmentInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_environment_input.serialize_json(input_)
    ).encode()
