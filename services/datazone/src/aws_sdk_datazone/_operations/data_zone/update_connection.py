...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_connection_output.UpdateConnectionOutput = (
        aws_sdk_datazone.types.update_connection_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_connection_input.UpdateConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_connection_input.serialize_json(input_)
    ).encode()
