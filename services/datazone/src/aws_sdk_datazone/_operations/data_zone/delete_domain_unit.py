...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_domain_unit_output.DeleteDomainUnitOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_domain_unit_input.DeleteDomainUnitInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
