...
def build_request(
    ...
    input: aws_sdk_datazone.types.start_notebook_export_input.StartNotebookExportInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.start_notebook_export_input.serialize_json(input)
    ).encode()
