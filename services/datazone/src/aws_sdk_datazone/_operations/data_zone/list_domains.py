...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_domains_output.ListDomainsOutput = (
        aws_sdk_datazone.types.list_domains_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_domains_input.ListDomainsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_domains(
    ...
    aws_sdk_datazone.types.list_domains_output.ListDomainsOutput, zapros.Response
]:
