...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_data_sources_output.ListDataSourcesOutput = (
        aws_sdk_datazone.types.list_data_sources_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.list_data_sources_input.ListDataSourcesInput,
) -> zapros.Request:
    ...
    if "connection_identifier" in input:
        params["connectionIdentifier"] = str(input["connection_identifier"])
    if "type" in input:
