...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_environment_profiles_output.ListEnvironmentProfilesOutput = aws_sdk_datazone.types.list_environment_profiles_output.deserialize_json(
