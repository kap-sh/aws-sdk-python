...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_rule_output.CreateRuleOutput = (
        aws_sdk_datazone.types.create_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_rule_input.CreateRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_rule_input.serialize_json(input_)
    ).encode()
...
def create_rule(
    ...
    input_: aws_sdk_datazone.types.create_rule_input.CreateRuleInput,
) -> tuple[aws_sdk_datazone.types.create_rule_output.CreateRuleOutput, zapros.Response]:
