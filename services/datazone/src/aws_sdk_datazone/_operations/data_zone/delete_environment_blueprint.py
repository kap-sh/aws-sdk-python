"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteEnvironmentBlueprint``."""
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_environment_blueprint_input.DeleteEnvironmentBlueprintInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_environment_blueprint(
