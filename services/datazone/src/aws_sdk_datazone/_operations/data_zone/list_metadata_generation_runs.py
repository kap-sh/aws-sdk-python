...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_metadata_generation_runs_output.ListMetadataGenerationRunsOutput = aws_sdk_datazone.types.list_metadata_generation_runs_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.list_metadata_generation_runs_input.ListMetadataGenerationRunsInput,
) -> zapros.Request:
    ...
    if "target_identifier" in input:
        params["targetIdentifier"] = str(input["target_identifier"])
