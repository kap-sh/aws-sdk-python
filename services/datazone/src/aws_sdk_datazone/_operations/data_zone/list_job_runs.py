...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_job_runs_output.ListJobRunsOutput = (
        aws_sdk_datazone.types.list_job_runs_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_job_runs_input.ListJobRunsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_job_runs(
    ...
    aws_sdk_datazone.types.list_job_runs_output.ListJobRunsOutput, zapros.Response
]:
