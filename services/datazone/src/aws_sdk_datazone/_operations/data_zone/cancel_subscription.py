"""Generated from Smithy shape ``com.amazonaws.datazone#CancelSubscription``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.cancel_subscription_output.CancelSubscriptionOutput = (
        aws_sdk_datazone.types.cancel_subscription_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.cancel_subscription_input.CancelSubscriptionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
