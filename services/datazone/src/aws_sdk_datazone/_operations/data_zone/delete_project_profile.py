...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_project_profile_output.DeleteProjectProfileOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_project_profile_input.DeleteProjectProfileInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
