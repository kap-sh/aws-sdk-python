...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_glossary_output.DeleteGlossaryOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_glossary_input.DeleteGlossaryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_glossary(
    ...
    aws_sdk_datazone.types.delete_glossary_output.DeleteGlossaryOutput, zapros.Response
]:
