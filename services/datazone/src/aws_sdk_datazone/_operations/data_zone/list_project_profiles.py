...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_project_profiles_output.ListProjectProfilesOutput = aws_sdk_datazone.types.list_project_profiles_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_project_profiles_input.ListProjectProfilesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
