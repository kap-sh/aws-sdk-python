...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_data_export_configuration_output.GetDataExportConfigurationOutput = aws_sdk_datazone.types.get_data_export_configuration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_data_export_configuration_input.GetDataExportConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
