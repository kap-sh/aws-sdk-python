...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_form_type_output.CreateFormTypeOutput = (
        aws_sdk_datazone.types.create_form_type_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_form_type_input.CreateFormTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_form_type_input.serialize_json(input_)
    ).encode()
...
def create_form_type(
    ...
    aws_sdk_datazone.types.create_form_type_output.CreateFormTypeOutput, zapros.Response
]:
