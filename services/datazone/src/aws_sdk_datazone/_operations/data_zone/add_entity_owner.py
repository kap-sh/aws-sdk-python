"""Generated from Smithy shape ``com.amazonaws.datazone#AddEntityOwner``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.add_entity_owner_output.AddEntityOwnerOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.add_entity_owner_input.AddEntityOwnerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.add_entity_owner_input.serialize_json(input_)
    ).encode()
...
def add_entity_owner(
    ...
    aws_sdk_datazone.types.add_entity_owner_output.AddEntityOwnerOutput, zapros.Response
]:
...
async def async_add_entity_owner(
