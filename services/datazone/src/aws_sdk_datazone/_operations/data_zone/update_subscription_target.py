...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_subscription_target_output.UpdateSubscriptionTargetOutput = aws_sdk_datazone.types.update_subscription_target_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_subscription_target_input.UpdateSubscriptionTargetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_subscription_target_input.serialize_json(input_)
    ).encode()
