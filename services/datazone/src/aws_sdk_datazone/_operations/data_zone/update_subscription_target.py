...
def build_request(
    ...
    input: aws_sdk_datazone.types.update_subscription_target_input.UpdateSubscriptionTargetInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_subscription_target_input.serialize_json(input)
    ).encode()
