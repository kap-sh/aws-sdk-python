...
def handle_response(
    ...
    out: aws_sdk_datazone.types.batch_put_attributes_metadata_output.BatchPutAttributesMetadataOutput = aws_sdk_datazone.types.batch_put_attributes_metadata_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.batch_put_attributes_metadata_input.BatchPutAttributesMetadataInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.batch_put_attributes_metadata_input.serialize_json(input)
    ).encode()
