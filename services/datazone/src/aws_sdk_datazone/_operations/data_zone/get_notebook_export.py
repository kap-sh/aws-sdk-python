...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_notebook_export_output.GetNotebookExportOutput = (
        aws_sdk_datazone.types.get_notebook_export_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_notebook_export_input.GetNotebookExportInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
