...
def build_request(
    ...
    input: aws_sdk_datazone.types.create_environment_profile_input.CreateEnvironmentProfileInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_environment_profile_input.serialize_json(input)
    ).encode()
