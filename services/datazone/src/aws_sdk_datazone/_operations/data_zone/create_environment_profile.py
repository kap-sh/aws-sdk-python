"""Generated from Smithy shape ``com.amazonaws.datazone#CreateEnvironmentProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_environment_profile_output.CreateEnvironmentProfileOutput = aws_sdk_datazone.types.create_environment_profile_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_environment_profile_input.CreateEnvironmentProfileInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_environment_profile_input.serialize_json(input_)
    ).encode()
...
async def async_create_environment_profile(
