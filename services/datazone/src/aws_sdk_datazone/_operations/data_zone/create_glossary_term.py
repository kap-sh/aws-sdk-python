...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_glossary_term_output.CreateGlossaryTermOutput = (
        aws_sdk_datazone.types.create_glossary_term_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_glossary_term_input.CreateGlossaryTermInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_glossary_term_input.serialize_json(input_)
    ).encode()
