...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_account_pool_output.CreateAccountPoolOutput = (
        aws_sdk_datazone.types.create_account_pool_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_account_pool_input.CreateAccountPoolInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_account_pool_input.serialize_json(input_)
    ).encode()
