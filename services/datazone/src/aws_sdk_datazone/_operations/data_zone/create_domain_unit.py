...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_domain_unit_output.CreateDomainUnitOutput = (
        aws_sdk_datazone.types.create_domain_unit_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_domain_unit_input.CreateDomainUnitInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_domain_unit_input.serialize_json(input_)
    ).encode()
