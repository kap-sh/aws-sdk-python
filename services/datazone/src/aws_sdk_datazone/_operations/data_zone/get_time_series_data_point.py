"""Generated from Smithy shape ``com.amazonaws.datazone#GetTimeSeriesDataPoint``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_time_series_data_point_output.GetTimeSeriesDataPointOutput = aws_sdk_datazone.types.get_time_series_data_point_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_time_series_data_point_input.GetTimeSeriesDataPointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_time_series_data_point(
