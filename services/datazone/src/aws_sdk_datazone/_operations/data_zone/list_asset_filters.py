...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_asset_filters_output.ListAssetFiltersOutput = (
        aws_sdk_datazone.types.list_asset_filters_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_asset_filters_input.ListAssetFiltersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
