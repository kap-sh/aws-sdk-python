"""Generated from Smithy shape ``com.amazonaws.datazone#ListProjectMemberships``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_project_memberships_output.ListProjectMembershipsOutput = aws_sdk_datazone.types.list_project_memberships_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_project_memberships_input.ListProjectMembershipsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_project_memberships(
