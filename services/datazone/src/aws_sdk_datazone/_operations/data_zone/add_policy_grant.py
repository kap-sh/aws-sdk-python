...
def handle_response(
    ...
    out: aws_sdk_datazone.types.add_policy_grant_output.AddPolicyGrantOutput = (
        aws_sdk_datazone.types.add_policy_grant_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.add_policy_grant_input.AddPolicyGrantInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.add_policy_grant_input.serialize_json(input_)
    ).encode()
...
def add_policy_grant(
    ...
    aws_sdk_datazone.types.add_policy_grant_output.AddPolicyGrantOutput, zapros.Response
]:
