...
def build_request(
    ...
    input_: aws_sdk_datazone.types.put_data_export_configuration_input.PutDataExportConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.put_data_export_configuration_input.serialize_json(
            input_
        )
    ).encode()
