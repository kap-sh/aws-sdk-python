...
def handle_response(
    ...
    out: aws_sdk_datazone.types.put_data_export_configuration_output.PutDataExportConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_datazone.types.put_data_export_configuration_input.PutDataExportConfigurationInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.put_data_export_configuration_input.serialize_json(input)
    ).encode()
