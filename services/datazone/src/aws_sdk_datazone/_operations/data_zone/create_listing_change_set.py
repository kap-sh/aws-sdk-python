...
def build_request(
    ...
    input: aws_sdk_datazone.types.create_listing_change_set_input.CreateListingChangeSetInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_listing_change_set_input.serialize_json(input)
    ).encode()
