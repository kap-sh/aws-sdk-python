...
def build_request(
    ...
    input: aws_sdk_datazone.types.create_data_product_revision_input.CreateDataProductRevisionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_data_product_revision_input.serialize_json(input)
    ).encode()
