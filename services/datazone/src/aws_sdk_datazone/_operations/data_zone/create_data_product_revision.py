...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_data_product_revision_output.CreateDataProductRevisionOutput = aws_sdk_datazone.types.create_data_product_revision_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_data_product_revision_input.CreateDataProductRevisionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_data_product_revision_input.serialize_json(input_)
    ).encode()
