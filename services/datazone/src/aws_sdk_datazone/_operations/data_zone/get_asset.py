...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_asset_output.GetAssetOutput = (
        aws_sdk_datazone.types.get_asset_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_asset_input.GetAssetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_asset(
    ...
    input_: aws_sdk_datazone.types.get_asset_input.GetAssetInput,
) -> tuple[aws_sdk_datazone.types.get_asset_output.GetAssetOutput, zapros.Response]:
