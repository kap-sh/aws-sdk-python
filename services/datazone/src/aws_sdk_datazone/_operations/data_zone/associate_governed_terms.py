...
def build_request(
    ...
    input: aws_sdk_datazone.types.associate_governed_terms_input.AssociateGovernedTermsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.associate_governed_terms_input.serialize_json(input)
    ).encode()
