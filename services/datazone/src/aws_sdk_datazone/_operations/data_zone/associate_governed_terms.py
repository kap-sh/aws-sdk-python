"""Generated from Smithy shape ``com.amazonaws.datazone#AssociateGovernedTerms``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.associate_governed_terms_output.AssociateGovernedTermsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.associate_governed_terms_input.AssociateGovernedTermsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.associate_governed_terms_input.serialize_json(input_)
    ).encode()
...
async def async_associate_governed_terms(
