"""Generated from Smithy shape ``com.amazonaws.datazone#AcceptPredictions``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.accept_predictions_output.AcceptPredictionsOutput = (
        aws_sdk_datazone.types.accept_predictions_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.accept_predictions_input.AcceptPredictionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.accept_predictions_input.serialize_json(input_)
    ).encode()
...
async def async_accept_predictions(
