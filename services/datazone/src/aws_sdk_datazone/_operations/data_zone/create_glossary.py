"""Generated from Smithy shape ``com.amazonaws.datazone#CreateGlossary``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_glossary_output.CreateGlossaryOutput = (
        aws_sdk_datazone.types.create_glossary_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_glossary_input.CreateGlossaryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/domains/{domainIdentifier}/glossaries"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_glossary_input.serialize_json(input_)
    ).encode()
...
def create_glossary(
    ...
    aws_sdk_datazone.types.create_glossary_output.CreateGlossaryOutput, zapros.Response
]:
...
async def async_create_glossary(
