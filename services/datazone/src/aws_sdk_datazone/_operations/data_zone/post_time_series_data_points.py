...
def handle_response(
    ...
    out: aws_sdk_datazone.types.post_time_series_data_points_output.PostTimeSeriesDataPointsOutput = aws_sdk_datazone.types.post_time_series_data_points_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.post_time_series_data_points_input.PostTimeSeriesDataPointsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.post_time_series_data_points_input.serialize_json(input_)
    ).encode()
