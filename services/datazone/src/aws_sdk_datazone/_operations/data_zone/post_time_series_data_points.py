...
def build_request(
    ...
    input: aws_sdk_datazone.types.post_time_series_data_points_input.PostTimeSeriesDataPointsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.post_time_series_data_points_input.serialize_json(input)
    ).encode()
