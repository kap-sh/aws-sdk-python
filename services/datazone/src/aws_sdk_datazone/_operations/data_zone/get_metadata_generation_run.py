...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_metadata_generation_run_output.GetMetadataGenerationRunOutput = aws_sdk_datazone.types.get_metadata_generation_run_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_metadata_generation_run_input.GetMetadataGenerationRunInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
