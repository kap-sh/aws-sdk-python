...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_subscription_grant_output.CreateSubscriptionGrantOutput = aws_sdk_datazone.types.create_subscription_grant_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_subscription_grant_input.CreateSubscriptionGrantInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_subscription_grant_input.serialize_json(input_)
    ).encode()
