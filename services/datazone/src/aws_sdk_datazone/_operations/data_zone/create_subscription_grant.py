...
def build_request(
    ...
    input: aws_sdk_datazone.types.create_subscription_grant_input.CreateSubscriptionGrantInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_subscription_grant_input.serialize_json(input)
    ).encode()
