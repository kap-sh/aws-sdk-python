...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_connection_output.CreateConnectionOutput = (
        aws_sdk_datazone.types.create_connection_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_connection_input.CreateConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_connection_input.serialize_json(input_)
    ).encode()
