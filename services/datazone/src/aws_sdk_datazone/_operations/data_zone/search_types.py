...
def handle_response(
    ...
    out: aws_sdk_datazone.types.search_types_output.SearchTypesOutput = (
        aws_sdk_datazone.types.search_types_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.search_types_input.SearchTypesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.search_types_input.serialize_json(input_)
    ).encode()
...
def search_types(
    ...
    aws_sdk_datazone.types.search_types_output.SearchTypesOutput, zapros.Response
]:
