"""Generated from Smithy shape ``com.amazonaws.datazone#GetSubscription``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_subscription_output.GetSubscriptionOutput = (
        aws_sdk_datazone.types.get_subscription_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_subscription_input.GetSubscriptionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
