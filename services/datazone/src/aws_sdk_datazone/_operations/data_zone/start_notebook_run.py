"""Generated from Smithy shape ``com.amazonaws.datazone#StartNotebookRun``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.start_notebook_run_output.StartNotebookRunOutput = (
        aws_sdk_datazone.types.start_notebook_run_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.start_notebook_run_input.StartNotebookRunInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.start_notebook_run_input.serialize_json(input_)
    ).encode()
...
async def async_start_notebook_run(
