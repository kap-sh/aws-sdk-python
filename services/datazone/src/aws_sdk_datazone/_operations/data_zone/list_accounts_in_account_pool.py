...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_accounts_in_account_pool_output.ListAccountsInAccountPoolOutput = aws_sdk_datazone.types.list_accounts_in_account_pool_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_accounts_in_account_pool_input.ListAccountsInAccountPoolInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
