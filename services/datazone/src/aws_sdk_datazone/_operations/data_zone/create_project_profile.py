...
def build_request(
    ...
    input: aws_sdk_datazone.types.create_project_profile_input.CreateProjectProfileInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_project_profile_input.serialize_json(input)
    ).encode()
