...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_notebook_output.UpdateNotebookOutput = (
        aws_sdk_datazone.types.update_notebook_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_notebook_input.UpdateNotebookInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_notebook_input.serialize_json(input_)
    ).encode()
...
def update_notebook(
    ...
    aws_sdk_datazone.types.update_notebook_output.UpdateNotebookOutput, zapros.Response
]:
