...
def handle_response(
    ...
    out: aws_sdk_datazone.types.query_graph_output.QueryGraphOutput = (
        aws_sdk_datazone.types.query_graph_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.query_graph_input.QueryGraphInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.query_graph_input.serialize_json(input_)
    ).encode()
...
def query_graph(
    ...
    input_: aws_sdk_datazone.types.query_graph_input.QueryGraphInput,
) -> tuple[aws_sdk_datazone.types.query_graph_output.QueryGraphOutput, zapros.Response]:
