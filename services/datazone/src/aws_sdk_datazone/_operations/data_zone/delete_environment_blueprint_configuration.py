"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteEnvironmentBlueprintConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_environment_blueprint_configuration_output.DeleteEnvironmentBlueprintConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_environment_blueprint_configuration_input.DeleteEnvironmentBlueprintConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_environment_blueprint_configuration(
