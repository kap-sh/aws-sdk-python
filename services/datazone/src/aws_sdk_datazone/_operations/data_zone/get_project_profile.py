...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_project_profile_output.GetProjectProfileOutput = (
        aws_sdk_datazone.types.get_project_profile_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_project_profile_input.GetProjectProfileInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
