"""Generated from Smithy shape ``com.amazonaws.datazone#GetAccountPool``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_account_pool_output.GetAccountPoolOutput = (
        aws_sdk_datazone.types.get_account_pool_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_account_pool_input.GetAccountPoolInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_account_pool(
    ...
    aws_sdk_datazone.types.get_account_pool_output.GetAccountPoolOutput, zapros.Response
]:
...
async def async_get_account_pool(
