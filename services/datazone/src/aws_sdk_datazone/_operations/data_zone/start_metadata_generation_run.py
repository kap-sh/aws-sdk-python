...
def build_request(
    ...
    input_: aws_sdk_datazone.types.start_metadata_generation_run_input.StartMetadataGenerationRunInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.start_metadata_generation_run_input.serialize_json(
            input_
        )
    ).encode()
