...
def handle_response(
    ...
    out: aws_sdk_datazone.types.start_metadata_generation_run_output.StartMetadataGenerationRunOutput = aws_sdk_datazone.types.start_metadata_generation_run_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.start_metadata_generation_run_input.StartMetadataGenerationRunInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.start_metadata_generation_run_input.serialize_json(input)
    ).encode()
