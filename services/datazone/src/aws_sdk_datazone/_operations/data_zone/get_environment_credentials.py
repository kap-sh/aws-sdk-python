...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_environment_credentials_output.GetEnvironmentCredentialsOutput = aws_sdk_datazone.types.get_environment_credentials_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_environment_credentials_input.GetEnvironmentCredentialsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
