"""Generated from Smithy shape ``com.amazonaws.datazone#ListLineageNodeHistory``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_lineage_node_history_output.ListLineageNodeHistoryOutput = aws_sdk_datazone.types.list_lineage_node_history_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_lineage_node_history_input.ListLineageNodeHistoryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "direction" in input_:
        params["direction"] = str(input_["direction"])
    if "event_timestamp_gte" in input_:
        params["timestampGTE"] = str(input_["event_timestamp_gte"])
    if "event_timestamp_lte" in input_:
        params["timestampLTE"] = str(input_["event_timestamp_lte"])
...
async def async_list_lineage_node_history(
