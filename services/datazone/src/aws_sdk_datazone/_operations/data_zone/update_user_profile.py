...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_user_profile_output.UpdateUserProfileOutput = (
        aws_sdk_datazone.types.update_user_profile_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.update_user_profile_input.UpdateUserProfileInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_user_profile_input.serialize_json(input)
    ).encode()
