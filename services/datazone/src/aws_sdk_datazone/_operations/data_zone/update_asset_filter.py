"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateAssetFilter``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_asset_filter_output.UpdateAssetFilterOutput = (
        aws_sdk_datazone.types.update_asset_filter_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.update_asset_filter_input.UpdateAssetFilterInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_asset_filter_input.serialize_json(input)
    ).encode()
...
async def async_update_asset_filter(
