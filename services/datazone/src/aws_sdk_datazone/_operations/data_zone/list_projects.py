...
def build_request(
    ...
    input: aws_sdk_datazone.types.list_projects_input.ListProjectsInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "user_identifier" in input:
        params["userIdentifier"] = str(input["user_identifier"])
    if "group_identifier" in input:
        params["groupIdentifier"] = str(input["group_identifier"])
    if "name" in input:
        params["name"] = str(input["name"])
    if "project_category" in input:
        params["projectCategory"] = str(input["project_category"])
