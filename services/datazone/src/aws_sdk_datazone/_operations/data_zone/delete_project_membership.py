...
def build_request(
    ...
    input: aws_sdk_datazone.types.delete_project_membership_input.DeleteProjectMembershipInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.delete_project_membership_input.serialize_json(input)
    ).encode()
