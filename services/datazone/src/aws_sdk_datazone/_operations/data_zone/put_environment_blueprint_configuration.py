...
def handle_response(
    ...
    out: aws_sdk_datazone.types.put_environment_blueprint_configuration_output.PutEnvironmentBlueprintConfigurationOutput = aws_sdk_datazone.types.put_environment_blueprint_configuration_output.deserialize_json(
