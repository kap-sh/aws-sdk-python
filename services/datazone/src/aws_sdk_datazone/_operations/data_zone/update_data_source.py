...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_data_source_output.UpdateDataSourceOutput = (
        aws_sdk_datazone.types.update_data_source_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_data_source_input.UpdateDataSourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_data_source_input.serialize_json(input_)
    ).encode()
