"""Generated from Smithy shape ``com.amazonaws.datazone#CreateDomain``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_domain_output.CreateDomainOutput = (
        aws_sdk_datazone.types.create_domain_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_domain_input.CreateDomainInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/domains"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_datazone.types.create_domain_input

    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_domain_input.serialize_json(input_)
    ).encode()
...
def create_domain(
    ...
    aws_sdk_datazone.types.create_domain_output.CreateDomainOutput, zapros.Response
]:
