...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_data_source_output.CreateDataSourceOutput = (
        aws_sdk_datazone.types.create_data_source_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_data_source_input.CreateDataSourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_data_source_input.serialize_json(input_)
    ).encode()
