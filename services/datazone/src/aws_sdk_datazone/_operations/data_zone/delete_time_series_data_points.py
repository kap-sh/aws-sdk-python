"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteTimeSeriesDataPoints``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_time_series_data_points_output.DeleteTimeSeriesDataPointsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_time_series_data_points_input.DeleteTimeSeriesDataPointsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_time_series_data_points(
