...
def build_request(
    ...
    input: aws_sdk_datazone.types.start_data_source_run_input.StartDataSourceRunInput,
) -> zapros.Request:
    ...
    url = url.replace(
        "{dataSourceIdentifier}", quote(str(input["data_source_identifier"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.start_data_source_run_input.serialize_json(input)
    ).encode()
