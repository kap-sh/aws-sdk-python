...
def handle_response(
    ...
    out: aws_sdk_datazone.types.search_listings_output.SearchListingsOutput = (
        aws_sdk_datazone.types.search_listings_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.search_listings_input.SearchListingsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.search_listings_input.serialize_json(input_)
    ).encode()
...
def search_listings(
    ...
    aws_sdk_datazone.types.search_listings_output.SearchListingsOutput, zapros.Response
]:
