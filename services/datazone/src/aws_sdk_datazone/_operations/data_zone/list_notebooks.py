...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_notebooks_output.ListNotebooksOutput = (
        aws_sdk_datazone.types.list_notebooks_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_notebooks_input.ListNotebooksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_notebooks(
    ...
    aws_sdk_datazone.types.list_notebooks_output.ListNotebooksOutput, zapros.Response
]:
