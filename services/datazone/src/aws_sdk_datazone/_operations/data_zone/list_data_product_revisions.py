"""Generated from Smithy shape ``com.amazonaws.datazone#ListDataProductRevisions``."""
...
import aws_sdk_datazone.types.data_product_revisions
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_data_product_revisions_output.ListDataProductRevisionsOutput = aws_sdk_datazone.types.list_data_product_revisions_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_data_product_revisions_input.ListDataProductRevisionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_data_product_revisions(
