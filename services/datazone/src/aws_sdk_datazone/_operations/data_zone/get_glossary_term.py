...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_glossary_term_output.GetGlossaryTermOutput = (
        aws_sdk_datazone.types.get_glossary_term_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_glossary_term_input.GetGlossaryTermInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
