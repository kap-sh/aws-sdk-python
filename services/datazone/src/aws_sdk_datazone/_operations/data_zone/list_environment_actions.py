...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_environment_actions_output.ListEnvironmentActionsOutput = aws_sdk_datazone.types.list_environment_actions_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_environment_actions_input.ListEnvironmentActionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
