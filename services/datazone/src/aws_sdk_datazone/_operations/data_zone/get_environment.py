"""Generated from Smithy shape ``com.amazonaws.datazone#GetEnvironment``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_environment_output.GetEnvironmentOutput = (
        aws_sdk_datazone.types.get_environment_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_environment_input.GetEnvironmentInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_environment(
    ...
    aws_sdk_datazone.types.get_environment_output.GetEnvironmentOutput, zapros.Response
]:
