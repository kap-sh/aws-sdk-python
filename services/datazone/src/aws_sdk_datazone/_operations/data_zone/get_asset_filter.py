...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_asset_filter_output.GetAssetFilterOutput = (
        aws_sdk_datazone.types.get_asset_filter_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.get_asset_filter_input.GetAssetFilterInput,
) -> zapros.Request:
...
def get_asset_filter(
    ...
    aws_sdk_datazone.types.get_asset_filter_output.GetAssetFilterOutput, zapros.Response
]:
