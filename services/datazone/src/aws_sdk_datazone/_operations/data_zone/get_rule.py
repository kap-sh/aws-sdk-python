...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_rule_output.GetRuleOutput = (
        aws_sdk_datazone.types.get_rule_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.get_rule_input.GetRuleInput,
) -> zapros.Request:
...
def get_rule(
    options: OperationOptions, input: aws_sdk_datazone.types.get_rule_input.GetRuleInput
) -> tuple[aws_sdk_datazone.types.get_rule_output.GetRuleOutput, zapros.Response]:
