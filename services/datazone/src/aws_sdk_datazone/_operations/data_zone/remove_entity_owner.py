"""Generated from Smithy shape ``com.amazonaws.datazone#RemoveEntityOwner``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.remove_entity_owner_output.RemoveEntityOwnerOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.remove_entity_owner_input.RemoveEntityOwnerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.remove_entity_owner_input.serialize_json(input_)
    ).encode()
...
async def async_remove_entity_owner(
