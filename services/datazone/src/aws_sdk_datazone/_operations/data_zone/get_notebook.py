...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_notebook_output.GetNotebookOutput = (
        aws_sdk_datazone.types.get_notebook_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_notebook_input.GetNotebookInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_notebook(
    ...
    aws_sdk_datazone.types.get_notebook_output.GetNotebookOutput, zapros.Response
]:
