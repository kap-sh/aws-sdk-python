...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_domain_units_for_parent_output.ListDomainUnitsForParentOutput = aws_sdk_datazone.types.list_domain_units_for_parent_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.list_domain_units_for_parent_input.ListDomainUnitsForParentInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "parent_domain_unit_identifier" in input:
        params["parentDomainUnitIdentifier"] = str(
            input["parent_domain_unit_identifier"]
        )
