"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteGlossaryTerm``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_glossary_term_output.DeleteGlossaryTermOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_glossary_term_input.DeleteGlossaryTermInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_glossary_term(
