"""Generated from Smithy shape ``com.amazonaws.datazone#ListDataSourceRunActivities``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_data_source_run_activities_output.ListDataSourceRunActivitiesOutput = aws_sdk_datazone.types.list_data_source_run_activities_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_data_source_run_activities_input.ListDataSourceRunActivitiesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_data_source_run_activities(
