...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_account_pool_output.UpdateAccountPoolOutput = (
        aws_sdk_datazone.types.update_account_pool_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_account_pool_input.UpdateAccountPoolInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_account_pool_input.serialize_json(input_)
    ).encode()
