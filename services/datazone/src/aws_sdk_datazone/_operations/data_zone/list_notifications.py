"""Generated from Smithy shape ``com.amazonaws.datazone#ListNotifications``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_notifications_output.ListNotificationsOutput = (
        aws_sdk_datazone.types.list_notifications_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_notifications_input.ListNotificationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/domains/{domainIdentifier}/notifications"
    url = url.replace(
    ...
    if "after_timestamp" in input_:
        params["afterTimestamp"] = str(input_["after_timestamp"])
    if "before_timestamp" in input_:
        params["beforeTimestamp"] = str(input_["before_timestamp"])
    if "subjects" in input_:
        params["subjects"] = str(input_["subjects"])
