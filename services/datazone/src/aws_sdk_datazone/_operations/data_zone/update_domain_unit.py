"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateDomainUnit``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_domain_unit_output.UpdateDomainUnitOutput = (
        aws_sdk_datazone.types.update_domain_unit_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_domain_unit_input.UpdateDomainUnitInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_domain_unit_input.serialize_json(input_)
    ).encode()
...
async def async_update_domain_unit(
