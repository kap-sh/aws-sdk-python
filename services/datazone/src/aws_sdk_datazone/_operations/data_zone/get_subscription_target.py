"""Generated from Smithy shape ``com.amazonaws.datazone#GetSubscriptionTarget``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_subscription_target_output.GetSubscriptionTargetOutput = aws_sdk_datazone.types.get_subscription_target_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_subscription_target_input.GetSubscriptionTargetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_subscription_target(
