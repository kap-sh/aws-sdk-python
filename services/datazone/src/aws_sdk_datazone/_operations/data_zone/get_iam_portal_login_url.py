...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_iam_portal_login_url_output.GetIamPortalLoginUrlOutput = aws_sdk_datazone.types.get_iam_portal_login_url_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_iam_portal_login_url_input.GetIamPortalLoginUrlInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
