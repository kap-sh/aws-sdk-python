...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_environment_blueprint_output.GetEnvironmentBlueprintOutput = aws_sdk_datazone.types.get_environment_blueprint_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_environment_blueprint_input.GetEnvironmentBlueprintInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
