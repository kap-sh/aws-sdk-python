...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_listing_output.GetListingOutput = (
        aws_sdk_datazone.types.get_listing_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.get_listing_input.GetListingInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    params["listingRevision"] = str(input.get("listing_revision", "latest"))
...
def get_listing(
    ...
    input: aws_sdk_datazone.types.get_listing_input.GetListingInput,
) -> tuple[aws_sdk_datazone.types.get_listing_output.GetListingOutput, zapros.Response]:
