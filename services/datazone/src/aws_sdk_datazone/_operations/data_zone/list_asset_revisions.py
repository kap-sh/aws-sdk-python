...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_asset_revisions_output.ListAssetRevisionsOutput = (
        aws_sdk_datazone.types.list_asset_revisions_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_asset_revisions_input.ListAssetRevisionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
