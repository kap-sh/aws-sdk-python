...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_project_output.CreateProjectOutput = (
        aws_sdk_datazone.types.create_project_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_project_input.CreateProjectInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_project_input.serialize_json(input_)
    ).encode()
...
def create_project(
    ...
    aws_sdk_datazone.types.create_project_output.CreateProjectOutput, zapros.Response
]:
