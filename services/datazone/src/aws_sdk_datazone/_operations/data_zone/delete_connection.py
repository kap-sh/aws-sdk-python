"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_connection_output.DeleteConnectionOutput = (
        aws_sdk_datazone.types.delete_connection_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_connection_input.DeleteConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
