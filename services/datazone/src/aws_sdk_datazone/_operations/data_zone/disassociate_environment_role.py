...
def handle_response(
    ...
    out: aws_sdk_datazone.types.disassociate_environment_role_output.DisassociateEnvironmentRoleOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.disassociate_environment_role_input.DisassociateEnvironmentRoleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
