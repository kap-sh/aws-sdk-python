...
def handle_response(
    ...
    out: aws_sdk_datazone.types.revoke_subscription_output.RevokeSubscriptionOutput = (
        aws_sdk_datazone.types.revoke_subscription_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.revoke_subscription_input.RevokeSubscriptionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.revoke_subscription_input.serialize_json(input_)
    ).encode()
