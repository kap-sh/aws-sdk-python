"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteEnvironmentProfile``."""
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_environment_profile_input.DeleteEnvironmentProfileInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_environment_profile(
