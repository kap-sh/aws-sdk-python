"""Generated from Smithy shape ``com.amazonaws.datazone#CreateAssetRevision``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_asset_revision_output.CreateAssetRevisionOutput = aws_sdk_datazone.types.create_asset_revision_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_asset_revision_input.CreateAssetRevisionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_asset_revision_input.serialize_json(input_)
    ).encode()
...
async def async_create_asset_revision(
