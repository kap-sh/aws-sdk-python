...
def build_request(
    ...
    input: aws_sdk_datazone.types.create_asset_revision_input.CreateAssetRevisionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_asset_revision_input.serialize_json(input)
    ).encode()
