...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_group_profile_output.UpdateGroupProfileOutput = (
        aws_sdk_datazone.types.update_group_profile_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_group_profile_input.UpdateGroupProfileInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_group_profile_input.serialize_json(input_)
    ).encode()
