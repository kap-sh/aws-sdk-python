...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_listing_output.DeleteListingOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_listing_input.DeleteListingInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_listing(
    ...
    aws_sdk_datazone.types.delete_listing_output.DeleteListingOutput, zapros.Response
]:
