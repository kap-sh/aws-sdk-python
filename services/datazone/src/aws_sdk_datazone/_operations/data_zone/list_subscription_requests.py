...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_subscription_requests_output.ListSubscriptionRequestsOutput = aws_sdk_datazone.types.list_subscription_requests_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_subscription_requests_input.ListSubscriptionRequestsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
