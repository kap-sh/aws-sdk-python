...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_environment_profile_output.GetEnvironmentProfileOutput = aws_sdk_datazone.types.get_environment_profile_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_environment_profile_input.GetEnvironmentProfileInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
