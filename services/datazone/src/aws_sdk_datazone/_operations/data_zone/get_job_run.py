...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_job_run_output.GetJobRunOutput = (
        aws_sdk_datazone.types.get_job_run_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_job_run_input.GetJobRunInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_job_run(
    ...
    input_: aws_sdk_datazone.types.get_job_run_input.GetJobRunInput,
) -> tuple[aws_sdk_datazone.types.get_job_run_output.GetJobRunOutput, zapros.Response]:
