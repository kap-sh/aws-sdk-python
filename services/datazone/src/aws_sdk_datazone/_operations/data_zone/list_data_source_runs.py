"""Generated from Smithy shape ``com.amazonaws.datazone#ListDataSourceRuns``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_data_source_runs_output.ListDataSourceRunsOutput = aws_sdk_datazone.types.list_data_source_runs_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_data_source_runs_input.ListDataSourceRunsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_data_source_runs(
