...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_subscription_request_details_output.GetSubscriptionRequestDetailsOutput = aws_sdk_datazone.types.get_subscription_request_details_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_subscription_request_details_input.GetSubscriptionRequestDetailsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
