...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_form_type_output.DeleteFormTypeOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_form_type_input.DeleteFormTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_form_type(
    ...
    aws_sdk_datazone.types.delete_form_type_output.DeleteFormTypeOutput, zapros.Response
]:
