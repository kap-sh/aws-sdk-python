"""Generated from Smithy shape ``com.amazonaws.datazone#ListEntityOwners``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_entity_owners_output.ListEntityOwnersOutput = (
        aws_sdk_datazone.types.list_entity_owners_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_entity_owners_input.ListEntityOwnersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_entity_owners(
