...
def build_request(
    ...
    input: aws_sdk_datazone.types.delete_project_input.DeleteProjectInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "skip_deletion_check" in input:
        params["skipDeletionCheck"] = str(input["skip_deletion_check"])
