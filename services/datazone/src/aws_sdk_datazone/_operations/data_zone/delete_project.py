"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteProject``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_project_output.DeleteProjectOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_project_input.DeleteProjectInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_project(
    ...
    aws_sdk_datazone.types.delete_project_output.DeleteProjectOutput, zapros.Response
]:
