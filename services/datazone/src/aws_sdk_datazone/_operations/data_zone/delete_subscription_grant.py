...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_subscription_grant_output.DeleteSubscriptionGrantOutput = aws_sdk_datazone.types.delete_subscription_grant_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_subscription_grant_input.DeleteSubscriptionGrantInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
