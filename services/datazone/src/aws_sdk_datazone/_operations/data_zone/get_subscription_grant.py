"""Generated from Smithy shape ``com.amazonaws.datazone#GetSubscriptionGrant``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_subscription_grant_output.GetSubscriptionGrantOutput = aws_sdk_datazone.types.get_subscription_grant_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_subscription_grant_input.GetSubscriptionGrantInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_subscription_grant(
