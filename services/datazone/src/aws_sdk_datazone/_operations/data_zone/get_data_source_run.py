...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_data_source_run_output.GetDataSourceRunOutput = (
        aws_sdk_datazone.types.get_data_source_run_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_data_source_run_input.GetDataSourceRunInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
