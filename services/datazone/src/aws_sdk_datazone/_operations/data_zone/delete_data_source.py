...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_data_source_output.DeleteDataSourceOutput = (
        aws_sdk_datazone.types.delete_data_source_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_datazone.types.delete_data_source_input.DeleteDataSourceInput,
) -> zapros.Request:
    ...
    if "retain_permissions_on_revoke_failure" in input:
        params["retainPermissionsOnRevokeFailure"] = str(
