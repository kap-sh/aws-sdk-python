...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_environment_blueprint_configuration_output.GetEnvironmentBlueprintConfigurationOutput = aws_sdk_datazone.types.get_environment_blueprint_configuration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_environment_blueprint_configuration_input.GetEnvironmentBlueprintConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
