...
def handle_response(
    ...
    out: aws_sdk_datazone.types.reject_predictions_output.RejectPredictionsOutput = (
        aws_sdk_datazone.types.reject_predictions_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.reject_predictions_input.RejectPredictionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.reject_predictions_input.serialize_json(input_)
    ).encode()
