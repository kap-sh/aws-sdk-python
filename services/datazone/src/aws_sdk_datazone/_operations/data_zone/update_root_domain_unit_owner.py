"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateRootDomainUnitOwner``."""
...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_root_domain_unit_owner_output.UpdateRootDomainUnitOwnerOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_datazone.types.update_root_domain_unit_owner_input.UpdateRootDomainUnitOwnerInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_root_domain_unit_owner_input.serialize_json(input)
    ).encode()
...
async def async_update_root_domain_unit_owner(
