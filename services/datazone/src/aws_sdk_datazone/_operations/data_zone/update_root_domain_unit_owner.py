...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_root_domain_unit_owner_input.UpdateRootDomainUnitOwnerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_root_domain_unit_owner_input.serialize_json(
            input_
        )
    ).encode()
