...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_subscription_targets_output.ListSubscriptionTargetsOutput = aws_sdk_datazone.types.list_subscription_targets_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_subscription_targets_input.ListSubscriptionTargetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
