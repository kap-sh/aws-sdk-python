...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_notebook_output.DeleteNotebookOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_notebook_input.DeleteNotebookInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_notebook(
    ...
    aws_sdk_datazone.types.delete_notebook_output.DeleteNotebookOutput, zapros.Response
]:
