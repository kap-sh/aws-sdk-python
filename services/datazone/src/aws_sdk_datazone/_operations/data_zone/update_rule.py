...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_rule_output.UpdateRuleOutput = (
        aws_sdk_datazone.types.update_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_rule_input.UpdateRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_rule_input.serialize_json(input_)
    ).encode()
...
def update_rule(
    ...
    input_: aws_sdk_datazone.types.update_rule_input.UpdateRuleInput,
) -> tuple[aws_sdk_datazone.types.update_rule_output.UpdateRuleOutput, zapros.Response]:
