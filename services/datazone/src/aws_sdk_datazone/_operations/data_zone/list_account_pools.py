...
def handle_response(
    ...
    out: aws_sdk_datazone.types.list_account_pools_output.ListAccountPoolsOutput = (
        aws_sdk_datazone.types.list_account_pools_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.list_account_pools_input.ListAccountPoolsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
