...
def handle_response(
    ...
    out: aws_sdk_datazone.types.start_notebook_import_output.StartNotebookImportOutput = aws_sdk_datazone.types.start_notebook_import_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.start_notebook_import_input.StartNotebookImportInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.start_notebook_import_input.serialize_json(input_)
    ).encode()
