...
def build_request(
    ...
    input: aws_sdk_datazone.types.start_notebook_import_input.StartNotebookImportInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.start_notebook_import_input.serialize_json(input)
    ).encode()
