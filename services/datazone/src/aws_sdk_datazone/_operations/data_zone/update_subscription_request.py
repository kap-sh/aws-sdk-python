...
def handle_response(
    ...
    out: aws_sdk_datazone.types.update_subscription_request_output.UpdateSubscriptionRequestOutput = aws_sdk_datazone.types.update_subscription_request_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.update_subscription_request_input.UpdateSubscriptionRequestInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_subscription_request_input.serialize_json(input_)
    ).encode()
