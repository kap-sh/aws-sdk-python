...
def build_request(
    ...
    input: aws_sdk_datazone.types.update_subscription_request_input.UpdateSubscriptionRequestInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.update_subscription_request_input.serialize_json(input)
    ).encode()
