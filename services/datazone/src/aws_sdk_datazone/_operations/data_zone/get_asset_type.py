...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_asset_type_output.GetAssetTypeOutput = (
        aws_sdk_datazone.types.get_asset_type_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_asset_type_input.GetAssetTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_asset_type(
    ...
    aws_sdk_datazone.types.get_asset_type_output.GetAssetTypeOutput, zapros.Response
]:
