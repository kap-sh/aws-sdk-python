...
def handle_response(
    ...
    out: aws_sdk_datazone.types.delete_rule_output.DeleteRuleOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.delete_rule_input.DeleteRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_rule(
    ...
    input_: aws_sdk_datazone.types.delete_rule_input.DeleteRuleInput,
) -> tuple[aws_sdk_datazone.types.delete_rule_output.DeleteRuleOutput, zapros.Response]:
