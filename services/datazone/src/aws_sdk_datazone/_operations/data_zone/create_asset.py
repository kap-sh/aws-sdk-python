...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_asset_output.CreateAssetOutput = (
        aws_sdk_datazone.types.create_asset_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_asset_input.CreateAssetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_asset_input.serialize_json(input_)
    ).encode()
...
def create_asset(
    ...
    aws_sdk_datazone.types.create_asset_output.CreateAssetOutput, zapros.Response
]:
