...
def handle_response(
    ...
    out: aws_sdk_datazone.types.create_asset_filter_output.CreateAssetFilterOutput = (
        aws_sdk_datazone.types.create_asset_filter_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.create_asset_filter_input.CreateAssetFilterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_datazone.types.create_asset_filter_input.serialize_json(input_)
    ).encode()
