"""Generated from Smithy shape ``com.amazonaws.datazone#GetLineageEvent``."""
...
def handle_response(
    ...
    if "Processing-Status" in response.headers:
        ...
        out["processing_status"] = (
            aws_sdk_datazone.types.lineage_event_processing_status.from_xml_text(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_lineage_event_input.GetLineageEventInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_lineage_event(
