...
def handle_response(
    ...
    out: aws_sdk_datazone.types.get_glossary_output.GetGlossaryOutput = (
        aws_sdk_datazone.types.get_glossary_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_datazone.types.get_glossary_input.GetGlossaryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_glossary(
    ...
    aws_sdk_datazone.types.get_glossary_output.GetGlossaryOutput, zapros.Response
]:
