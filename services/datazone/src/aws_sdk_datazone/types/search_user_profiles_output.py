...
class SearchUserProfilesOutput(TypedDict):
    items: NotRequired[
        "aws_sdk_datazone.types.user_profile_summaries.UserProfileSummaries"
    ]
...
def serialize_json(value: SearchUserProfilesOutput) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = aws_sdk_datazone.types.user_profile_summaries.serialize_json(
            value["items"]
        )
...
def deserialize_json(data: dict) -> SearchUserProfilesOutput:
    ...
    if "items" in data:
        ...
        out["items"] = aws_sdk_datazone.types.user_profile_summaries.deserialize_json(
            data["items"]
        )
