"""Generated from Smithy shape ``com.amazonaws.datazone#ListAssetRevisionsInput``."""
...
class ListAssetRevisionsInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListAssetRevisionsInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListAssetRevisionsInput:
    out: ListAssetRevisionsInput = {}  # type: ignore[typeddict-item]
    return out
