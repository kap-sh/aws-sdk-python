...
class AcceptSubscriptionRequestOutput(TypedDict):
    ...
    status: "aws_sdk_datazone.types.subscription_request_status.SubscriptionRequestStatus"
    ...
    subscribed_principals: "aws_sdk_datazone.types.subscribed_principals.SubscribedPrincipals"
    ...
    existing_subscription_id: NotRequired["aws_sdk_datazone.types.subscription_id.SubscriptionId"]
...
def serialize_json(value: AcceptSubscriptionRequestOutput) -> dict:
    ...
    import aws_sdk_datazone.types.subscription_request_status
    out["status"] = aws_sdk_datazone.types.subscription_request_status.serialize_json(value["status"])
    import aws_sdk_datazone.types.created_at
    ...
    import aws_sdk_datazone.types.subscribed_principals
    out["subscribedPrincipals"] = aws_sdk_datazone.types.subscribed_principals.serialize_json(value["subscribed_principals"])
    import aws_sdk_datazone.types.subscribed_listings
    out["subscribedListings"] = aws_sdk_datazone.types.subscribed_listings.serialize_json(value["subscribed_listings"])
    ...
    if "metadata_forms" in value:
        import aws_sdk_datazone.types.metadata_forms
        out["metadataForms"] = aws_sdk_datazone.types.metadata_forms.serialize_json(value["metadata_forms"])
    return out
...
def deserialize_json(data: dict) -> AcceptSubscriptionRequestOutput:
    ...
    if "createdBy" in data:
        ...
        raise DeserializationError("AcceptSubscriptionRequestOutput.created_by required")
    ...
    if "status" in data:
        import aws_sdk_datazone.types.subscription_request_status
        out["status"] = aws_sdk_datazone.types.subscription_request_status.deserialize_json(data["status"])
    else:
    ...
    if "createdAt" in data:
        ...
        raise DeserializationError("AcceptSubscriptionRequestOutput.created_at required")
    if "updatedAt" in data:
        import aws_sdk_datazone.types.updated_at
        out["updated_at"] = aws_sdk_datazone.types.updated_at.deserialize_json(data["updatedAt"])
    else:
        raise DeserializationError("AcceptSubscriptionRequestOutput.updated_at required")
    if "requestReason" in data:
        out["request_reason"] = data["requestReason"]
    else:
        raise DeserializationError("AcceptSubscriptionRequestOutput.request_reason required")
    if "subscribedPrincipals" in data:
        import aws_sdk_datazone.types.subscribed_principals
        out["subscribed_principals"] = aws_sdk_datazone.types.subscribed_principals.deserialize_json(data["subscribedPrincipals"])
    else:
        raise DeserializationError("AcceptSubscriptionRequestOutput.subscribed_principals required")
    if "subscribedListings" in data:
        import aws_sdk_datazone.types.subscribed_listings
        out["subscribed_listings"] = aws_sdk_datazone.types.subscribed_listings.deserialize_json(data["subscribedListings"])
    else:
        raise DeserializationError("AcceptSubscriptionRequestOutput.subscribed_listings required")
    ...
    if "metadataForms" in data:
        import aws_sdk_datazone.types.metadata_forms
        out["metadata_forms"] = aws_sdk_datazone.types.metadata_forms.deserialize_json(data["metadataForms"])
    return out