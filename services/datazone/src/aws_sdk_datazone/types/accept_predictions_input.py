...
def serialize_json(value: AcceptPredictionsInput) -> dict:
    ...
    if "accept_rule" in value:
        ...
        out["acceptRule"] = aws_sdk_datazone.types.accept_rule.serialize_json(
            value["accept_rule"]
        )
    if "accept_choices" in value:
        import aws_sdk_datazone.types.accept_choices

        out["acceptChoices"] = aws_sdk_datazone.types.accept_choices.serialize_json(
...
def deserialize_json(data: dict) -> AcceptPredictionsInput:
    ...
    if "acceptRule" in data:
        ...
        out["accept_rule"] = aws_sdk_datazone.types.accept_rule.deserialize_json(
            data["acceptRule"]
        )
    if "acceptChoices" in data:
        import aws_sdk_datazone.types.accept_choices

        out["accept_choices"] = aws_sdk_datazone.types.accept_choices.deserialize_json(
            data["acceptChoices"]
        )
