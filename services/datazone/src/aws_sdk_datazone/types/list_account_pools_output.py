...
if TYPE_CHECKING:
    import aws_sdk_datazone.types.account_pool_summaries
    import aws_sdk_datazone.types.pagination_token


class ListAccountPoolsOutput(TypedDict):
    items: NotRequired[
        "aws_sdk_datazone.types.account_pool_summaries.AccountPoolSummaries"
    ]
...
def serialize_json(value: ListAccountPoolsOutput) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = aws_sdk_datazone.types.account_pool_summaries.serialize_json(
            value["items"]
        )
...
def deserialize_json(data: dict) -> ListAccountPoolsOutput:
    ...
    if "items" in data:
        ...
        out["items"] = aws_sdk_datazone.types.account_pool_summaries.deserialize_json(
            data["items"]
        )
