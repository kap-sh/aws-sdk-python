"""Generated from Smithy shape ``com.amazonaws.datazone#ListEnvironmentBlueprintsInput``."""
...
class ListEnvironmentBlueprintsInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListEnvironmentBlueprintsInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListEnvironmentBlueprintsInput:
    out: ListEnvironmentBlueprintsInput = {}  # type: ignore[typeddict-item]
    return out
