...
class ListSubscriptionGrantsOutput(TypedDict):
    items: "aws_sdk_datazone.types.subscription_grants.SubscriptionGrants"
...
def serialize_json(value: ListSubscriptionGrantsOutput) -> dict:
    ...
    out["items"] = aws_sdk_datazone.types.subscription_grants.serialize_json(
        value["items"]
    )
...
def deserialize_json(data: dict) -> ListSubscriptionGrantsOutput:
    ...
    if "items" in data:
        ...
        out["items"] = aws_sdk_datazone.types.subscription_grants.deserialize_json(
            data["items"]
        )
    else:
