"""Generated from Smithy shape ``com.amazonaws.datazone#AmazonQPropertiesInput``."""
...
class AmazonQPropertiesInput(TypedDict, closed=True):
    is_enabled: "bool"
...
# --- restJson1 ser/de ---
def serialize_json(value: AmazonQPropertiesInput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> AmazonQPropertiesInput:
    out: AmazonQPropertiesInput = {}  # type: ignore[typeddict-item]
    if "isEnabled" in data:
        out["is_enabled"] = data["isEnabled"]
    else:
        raise DeserializationError("AmazonQPropertiesInput.is_enabled required")
