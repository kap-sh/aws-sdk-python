...
if TYPE_CHECKING:
    import aws_sdk_datazone.types.prediction_choices


class RejectChoice(TypedDict):
    ...
    prediction_choices: NotRequired[
        "aws_sdk_datazone.types.prediction_choices.PredictionChoices"
    ]
...
def serialize_json(value: RejectChoice) -> dict:
    ...
    if "prediction_choices" in value:
        ...
        out["predictionChoices"] = (
            aws_sdk_datazone.types.prediction_choices.serialize_json(
...
def deserialize_json(data: dict) -> RejectChoice:
    ...
    if "predictionChoices" in data:
        ...
        out["prediction_choices"] = (
            aws_sdk_datazone.types.prediction_choices.deserialize_json(
