...
if TYPE_CHECKING:
    ...
    import aws_sdk_datazone.types.lineage_node_reference_list
...
class GetLineageNodeOutput(TypedDict):
    ...
    upstream_nodes: NotRequired[
        "aws_sdk_datazone.types.lineage_node_reference_list.LineageNodeReferenceList"
    ]
...
def serialize_json(value: GetLineageNodeOutput) -> dict:
    ...
    if "upstream_nodes" in value:
        ...
        out["upstreamNodes"] = (
            aws_sdk_datazone.types.lineage_node_reference_list.serialize_json(
...
def deserialize_json(data: dict) -> GetLineageNodeOutput:
    ...
    if "upstreamNodes" in data:
        ...
        out["upstream_nodes"] = (
            aws_sdk_datazone.types.lineage_node_reference_list.deserialize_json(
                data["upstreamNodes"]
            )
        )
