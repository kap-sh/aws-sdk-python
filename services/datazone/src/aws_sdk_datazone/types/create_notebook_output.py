"""Generated from Smithy shape ``com.amazonaws.datazone#CreateNotebookOutput``."""
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateNotebookOutput) -> dict:
    out: dict = {}
    out["id"] = value["id"]
    out["name"] = value["name"]
...
def deserialize_json(data: dict) -> CreateNotebookOutput:
    out: CreateNotebookOutput = {}  # type: ignore[typeddict-item]
    if "id" in data:
        out["id"] = data["id"]
    else:
        raise DeserializationError("CreateNotebookOutput.id required")
    if "name" in data:
        out["name"] = data["name"]
    else:
        raise DeserializationError("CreateNotebookOutput.name required")
    if "owningProjectId" in data:
        out["owning_project_id"] = data["owningProjectId"]
    else:
        raise DeserializationError("CreateNotebookOutput.owning_project_id required")
    if "domainId" in data:
        out["domain_id"] = data["domainId"]
    else:
        raise DeserializationError("CreateNotebookOutput.domain_id required")
    if "cellOrder" in data:
        ...
        raise DeserializationError("CreateNotebookOutput.cell_order required")
    if "status" in data:
        import aws_sdk_datazone.types.notebook_status
        ...
        raise DeserializationError("CreateNotebookOutput.status required")
