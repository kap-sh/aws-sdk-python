...
if TYPE_CHECKING:
    import aws_sdk_datazone.types.required_metadata_form_list


class MetadataFormEnforcementDetail(TypedDict):
    required_metadata_forms: NotRequired[
        "aws_sdk_datazone.types.required_metadata_form_list.RequiredMetadataFormList"
    ]
...
def serialize_json(value: MetadataFormEnforcementDetail) -> dict:
    ...
    if "required_metadata_forms" in value:
        ...
        out["requiredMetadataForms"] = (
            aws_sdk_datazone.types.required_metadata_form_list.serialize_json(
...
def deserialize_json(data: dict) -> MetadataFormEnforcementDetail:
    ...
    if "requiredMetadataForms" in data:
        ...
        out["required_metadata_forms"] = (
            aws_sdk_datazone.types.required_metadata_form_list.deserialize_json(
