"""Generated from Smithy shape ``com.amazonaws.datazone#SubscriptionSummary``."""
...
def deserialize_json(data: dict) -> SubscriptionSummary:
    ...
    if "id" in data:
        ...
        raise DeserializationError("SubscriptionSummary.id required")
    if "createdBy" in data:
        out["created_by"] = data["createdBy"]
    else:
        raise DeserializationError("SubscriptionSummary.created_by required")
    if "updatedBy" in data:
        out["updated_by"] = data["updatedBy"]
    if "domainId" in data:
        out["domain_id"] = data["domainId"]
    else:
        raise DeserializationError("SubscriptionSummary.domain_id required")
    if "status" in data:
        import aws_sdk_datazone.types.subscription_status
    ...
    if "subscribedPrincipal" in data:
        ...
        raise DeserializationError("SubscriptionSummary.subscribed_principal required")
    if "subscribedListing" in data:
        ...
        raise DeserializationError("SubscriptionSummary.subscribed_listing required")
