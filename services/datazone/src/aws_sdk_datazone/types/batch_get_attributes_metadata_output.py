...
class BatchGetAttributesMetadataOutput(TypedDict, closed=True):
    attributes: NotRequired[
        "aws_sdk_datazone.types.batch_get_attribute_items.BatchGetAttributeItems"
    ]
...
def serialize_json(value: BatchGetAttributesMetadataOutput) -> dict:
    ...
    if "attributes" in value:
        ...
        out["attributes"] = (
            aws_sdk_datazone.types.batch_get_attribute_items.serialize_json(
                value["attributes"]
            )
        )
    import aws_sdk_datazone.types.attributes_errors
...
def deserialize_json(data: dict) -> BatchGetAttributesMetadataOutput:
    ...
    if "attributes" in data:
        ...
        out["attributes"] = (
            aws_sdk_datazone.types.batch_get_attribute_items.deserialize_json(
                data["attributes"]
            )
        )
    if "errors" in data:
