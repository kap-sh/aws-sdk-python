"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateUserProfileOutput``."""
...
class UpdateUserProfileOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateUserProfileOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateUserProfileOutput:
    out: UpdateUserProfileOutput = {}  # type: ignore[typeddict-item]
    if "domainId" in data:
