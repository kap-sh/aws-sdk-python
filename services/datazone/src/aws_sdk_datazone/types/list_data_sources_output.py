...
if TYPE_CHECKING:
    import aws_sdk_datazone.types.data_source_summaries
    import aws_sdk_datazone.types.pagination_token


class ListDataSourcesOutput(TypedDict):
    items: "aws_sdk_datazone.types.data_source_summaries.DataSourceSummaries"
...
def serialize_json(value: ListDataSourcesOutput) -> dict:
    ...
    out["items"] = aws_sdk_datazone.types.data_source_summaries.serialize_json(
        value["items"]
    )
...
def deserialize_json(data: dict) -> ListDataSourcesOutput:
    ...
    if "items" in data:
        ...
        out["items"] = aws_sdk_datazone.types.data_source_summaries.deserialize_json(
            data["items"]
        )
    else:
