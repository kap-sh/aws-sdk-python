...
# --- restJson1 ser/de ---
def serialize_json(value: ListEnvironmentBlueprintConfigurationsInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListEnvironmentBlueprintConfigurationsInput:
    out: ListEnvironmentBlueprintConfigurationsInput = {}  # type: ignore[typeddict-item]
    return out
