...
if TYPE_CHECKING:
    ...
    import aws_sdk_datazone.types.data_product_item_additional_attributes
...
class DataProductResultItem(TypedDict):
    ...
    additional_attributes: NotRequired[
        "aws_sdk_datazone.types.data_product_item_additional_attributes.DataProductItemAdditionalAttributes"
    ]
...
def serialize_json(value: DataProductResultItem) -> dict:
    ...
    if "additional_attributes" in value:
        ...
        out["additionalAttributes"] = (
            aws_sdk_datazone.types.data_product_item_additional_attributes.serialize_json(
...
def deserialize_json(data: dict) -> DataProductResultItem:
    ...
    if "additionalAttributes" in data:
        ...
        out["additional_attributes"] = (
            aws_sdk_datazone.types.data_product_item_additional_attributes.deserialize_json(
