...
if TYPE_CHECKING:
    import aws_sdk_datazone.types.environment_configuration_user_parameter

EnvironmentConfigurationUserParametersList: TypeAlias = list[
    "aws_sdk_datazone.types.environment_configuration_user_parameter.EnvironmentConfigurationUserParameter"
]
...
def serialize_json(value: EnvironmentConfigurationUserParametersList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_datazone.types.environment_configuration_user_parameter.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> EnvironmentConfigurationUserParametersList:
    ...
    for item in data:
        out.append(
            aws_sdk_datazone.types.environment_configuration_user_parameter.deserialize_json(
                item
            )
        )
    return out
