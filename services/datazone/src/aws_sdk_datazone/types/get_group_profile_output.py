"""Generated from Smithy shape ``com.amazonaws.datazone#GetGroupProfileOutput``."""
...
class GetGroupProfileOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetGroupProfileOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetGroupProfileOutput:
    out: GetGroupProfileOutput = {}  # type: ignore[typeddict-item]
    if "domainId" in data:
