...
class AggregationOutputItem(TypedDict):
    value: NotRequired[
        "aws_sdk_datazone.types.aggregation_attribute_value.AggregationAttributeValue"
    ]
    ...
    display_value: NotRequired[
        "aws_sdk_datazone.types.aggregation_attribute_display_value.AggregationAttributeDisplayValue"
    ]
