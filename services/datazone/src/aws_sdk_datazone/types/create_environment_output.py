"""Generated from Smithy shape ``com.amazonaws.datazone#CreateEnvironmentOutput``."""
...
def deserialize_json(data: dict) -> CreateEnvironmentOutput:
    ...
    if "projectId" in data:
        ...
        raise DeserializationError("CreateEnvironmentOutput.project_id required")
    if "id" in data:
        out["id"] = data["id"]
    if "domainId" in data:
        out["domain_id"] = data["domainId"]
    else:
        raise DeserializationError("CreateEnvironmentOutput.domain_id required")
    if "createdBy" in data:
        out["created_by"] = data["createdBy"]
    else:
        raise DeserializationError("CreateEnvironmentOutput.created_by required")
    ...
    if "name" in data:
        ...
        raise DeserializationError("CreateEnvironmentOutput.name required")
    ...
    if "provider" in data:
        ...
        raise DeserializationError("CreateEnvironmentOutput.provider required")
