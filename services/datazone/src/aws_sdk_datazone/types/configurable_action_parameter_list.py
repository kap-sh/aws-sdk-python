...
ConfigurableActionParameterList: TypeAlias = list["aws_sdk_datazone.types.configurable_action_parameter.ConfigurableActionParameter"]
...
def serialize_json(value: ConfigurableActionParameterList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_datazone.types.configurable_action_parameter.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> ConfigurableActionParameterList:
    ...
    for item in data:
        out.append(aws_sdk_datazone.types.configurable_action_parameter.deserialize_json(item))
    return out