...
def serialize_json(value: AssetTypeItem) -> dict:
    ...
    import aws_sdk_datazone.types.forms_output_map
    out["formsOutput"] = aws_sdk_datazone.types.forms_output_map.serialize_json(value["forms_output"])
...
def deserialize_json(data: dict) -> AssetTypeItem:
    ...
    if "formsOutput" in data:
        import aws_sdk_datazone.types.forms_output_map
        out["forms_output"] = aws_sdk_datazone.types.forms_output_map.deserialize_json(data["formsOutput"])
    else:
