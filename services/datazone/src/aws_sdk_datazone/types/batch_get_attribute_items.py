...
BatchGetAttributeItems: TypeAlias = list[
    "aws_sdk_datazone.types.batch_get_attribute_output.BatchGetAttributeOutput"
]
...
def serialize_json(value: BatchGetAttributeItems) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_datazone.types.batch_get_attribute_output.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> BatchGetAttributeItems:
    ...
    for item in data:
        out.append(
            aws_sdk_datazone.types.batch_get_attribute_output.deserialize_json(item)
        )
    return out
