...
def serialize_json(value: AddEntityOwnerInput) -> dict:
    out: dict = {}
    import aws_sdk_datazone.types.owner_properties
    out["owner"] = aws_sdk_datazone.types.owner_properties.serialize_json(value["owner"])
...
def deserialize_json(data: dict) -> AddEntityOwnerInput:
    ...
    if "owner" in data:
        import aws_sdk_datazone.types.owner_properties
        out["owner"] = aws_sdk_datazone.types.owner_properties.deserialize_json(data["owner"])
    else:
