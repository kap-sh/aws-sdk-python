...
if TYPE_CHECKING:
    import aws_sdk_datazone.types.environment_configuration_parameter_name


class EnvironmentConfigurationParameter(TypedDict):
    name: NotRequired[
        "aws_sdk_datazone.types.environment_configuration_parameter_name.EnvironmentConfigurationParameterName"
    ]
