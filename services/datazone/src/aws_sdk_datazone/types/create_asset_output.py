"""Generated from Smithy shape ``com.amazonaws.datazone#CreateAssetOutput``."""
...
class CreateAssetOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateAssetOutput) -> dict:
    out: dict = {}
    out["id"] = value["id"]
    out["name"] = value["name"]
