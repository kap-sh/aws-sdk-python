...
if TYPE_CHECKING:
    import aws_sdk_s3vectors.types.non_filterable_metadata_keys
...
def serialize_json(value: MetadataConfiguration) -> dict:
    ...
    out["nonFilterableMetadataKeys"] = (
        aws_sdk_s3vectors.types.non_filterable_metadata_keys.serialize_json(
...
def deserialize_json(data: dict) -> MetadataConfiguration:
    ...
    if "nonFilterableMetadataKeys" in data:
        ...
        out["non_filterable_metadata_keys"] = (
            aws_sdk_s3vectors.types.non_filterable_metadata_keys.deserialize_json(
