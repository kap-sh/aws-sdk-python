"""Generated from Smithy shape ``com.amazonaws.s3vectors#DeleteVectorBucketInput``."""
...
class DeleteVectorBucketInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteVectorBucketInput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DeleteVectorBucketInput:
    out: DeleteVectorBucketInput = {}  # type: ignore[typeddict-item]
