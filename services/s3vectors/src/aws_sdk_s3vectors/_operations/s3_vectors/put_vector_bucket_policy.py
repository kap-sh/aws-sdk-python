...
def build_request(
    ...
    input: aws_sdk_s3vectors.types.put_vector_bucket_policy_input.PutVectorBucketPolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.put_vector_bucket_policy_input.serialize_json(input)
    ).encode()
