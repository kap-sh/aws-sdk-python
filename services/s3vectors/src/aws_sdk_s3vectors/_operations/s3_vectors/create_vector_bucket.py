...
def handle_response(
    ...
    out: aws_sdk_s3vectors.types.create_vector_bucket_output.CreateVectorBucketOutput = aws_sdk_s3vectors.types.create_vector_bucket_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3vectors.types.create_vector_bucket_input.CreateVectorBucketInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.create_vector_bucket_input.serialize_json(input_)
    ).encode()
