...
def build_request(
    ...
    input: aws_sdk_s3vectors.types.create_vector_bucket_input.CreateVectorBucketInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.create_vector_bucket_input.serialize_json(input)
    ).encode()
