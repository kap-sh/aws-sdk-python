...
def handle_response(
    ...
    out: aws_sdk_s3vectors.types.delete_vector_bucket_policy_output.DeleteVectorBucketPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_s3vectors.types.delete_vector_bucket_policy_input.DeleteVectorBucketPolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.delete_vector_bucket_policy_input.serialize_json(input)
    ).encode()
