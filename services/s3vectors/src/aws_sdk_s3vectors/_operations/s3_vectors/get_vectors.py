...
import aws_sdk_s3vectors.types.get_vectors_input
import aws_sdk_s3vectors.types.get_vectors_input_list
import aws_sdk_s3vectors.types.get_vectors_output
...
) -> aws_sdk_s3vectors.types.get_vectors_output.GetVectorsOutput:
    out: aws_sdk_s3vectors.types.get_vectors_output.GetVectorsOutput = (
        aws_sdk_s3vectors.types.get_vectors_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3vectors.types.get_vectors_input.GetVectorsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.get_vectors_input.serialize_json(input_)
    ).encode()
...
def get_vectors(
    ...
    aws_sdk_s3vectors.types.get_vectors_output.GetVectorsOutput, zapros.Response
]:
