"""Generated from Smithy shape ``com.amazonaws.s3vectors#GetIndex``."""
...
import aws_sdk_s3vectors.types.get_index_input
import aws_sdk_s3vectors.types.get_index_output
...
) -> aws_sdk_s3vectors.types.get_index_output.GetIndexOutput:
    out: aws_sdk_s3vectors.types.get_index_output.GetIndexOutput = (
        aws_sdk_s3vectors.types.get_index_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3vectors.types.get_index_input.GetIndexInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetIndex"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.get_index_input.serialize_json(input_)
    ).encode()
...
def get_index(
    ...
    input_: aws_sdk_s3vectors.types.get_index_input.GetIndexInput,
) -> tuple[aws_sdk_s3vectors.types.get_index_output.GetIndexOutput, zapros.Response]:
