...
def build_request(
    ...
    input: aws_sdk_s3vectors.types.delete_vector_bucket_input.DeleteVectorBucketInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.delete_vector_bucket_input.serialize_json(input)
    ).encode()
