...
def handle_response(
    ...
    out: aws_sdk_s3vectors.types.delete_vector_bucket_output.DeleteVectorBucketOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_s3vectors.types.delete_vector_bucket_input.DeleteVectorBucketInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.delete_vector_bucket_input.serialize_json(input_)
    ).encode()
