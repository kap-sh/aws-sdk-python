...
if TYPE_CHECKING:
    import aws_sdk_s3vectors.types.create_index_input
    import aws_sdk_s3vectors.types.create_index_output
...
) -> aws_sdk_s3vectors.types.create_index_output.CreateIndexOutput:
    import aws_sdk_s3vectors.types.create_index_output

    out: aws_sdk_s3vectors.types.create_index_output.CreateIndexOutput = (
        aws_sdk_s3vectors.types.create_index_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3vectors.types.create_index_input.CreateIndexInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.create_index_input.serialize_json(input_)
    ).encode()
...
def create_index(
    ...
    aws_sdk_s3vectors.types.create_index_output.CreateIndexOutput, zapros.Response
]:
