...
if TYPE_CHECKING:
    import aws_sdk_s3vectors.types.list_vectors_input
    import aws_sdk_s3vectors.types.list_vectors_output
...
) -> aws_sdk_s3vectors.types.list_vectors_output.ListVectorsOutput:
    import aws_sdk_s3vectors.types.list_vectors_output

    out: aws_sdk_s3vectors.types.list_vectors_output.ListVectorsOutput = (
        aws_sdk_s3vectors.types.list_vectors_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3vectors.types.list_vectors_input.ListVectorsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.list_vectors_input.serialize_json(input_)
    ).encode()
...
def list_vectors(
    ...
    aws_sdk_s3vectors.types.list_vectors_output.ListVectorsOutput, zapros.Response
]:
