...
if TYPE_CHECKING:
    import aws_sdk_s3vectors.types.query_vectors_input
    import aws_sdk_s3vectors.types.query_vectors_output
...
) -> aws_sdk_s3vectors.types.query_vectors_output.QueryVectorsOutput:
    import aws_sdk_s3vectors.types.query_vectors_output

    out: aws_sdk_s3vectors.types.query_vectors_output.QueryVectorsOutput = (
        aws_sdk_s3vectors.types.query_vectors_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3vectors.types.query_vectors_input.QueryVectorsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.query_vectors_input.serialize_json(input_)
    ).encode()
...
def query_vectors(
    ...
    aws_sdk_s3vectors.types.query_vectors_output.QueryVectorsOutput, zapros.Response
]:
