"""Generated from Smithy shape ``com.amazonaws.s3vectors#ListIndexes``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3vectors.types.list_indexes_input
    import aws_sdk_s3vectors.types.list_indexes_output
...
) -> aws_sdk_s3vectors.types.list_indexes_output.ListIndexesOutput:
    import aws_sdk_s3vectors.types.list_indexes_output

    out: aws_sdk_s3vectors.types.list_indexes_output.ListIndexesOutput = (
        aws_sdk_s3vectors.types.list_indexes_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3vectors.types.list_indexes_input.ListIndexesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.list_indexes_input.serialize_json(input_)
    ).encode()
...
def list_indexes(
    ...
    aws_sdk_s3vectors.types.list_indexes_output.ListIndexesOutput, zapros.Response
]:
