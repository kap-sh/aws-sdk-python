...
def handle_response(
    ...
    out: aws_sdk_s3vectors.types.list_vector_buckets_output.ListVectorBucketsOutput = (
        aws_sdk_s3vectors.types.list_vector_buckets_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3vectors.types.list_vector_buckets_input.ListVectorBucketsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.list_vector_buckets_input.serialize_json(input_)
    ).encode()
