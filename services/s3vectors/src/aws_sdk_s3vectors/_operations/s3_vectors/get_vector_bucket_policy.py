...
def handle_response(
    ...
    out: aws_sdk_s3vectors.types.get_vector_bucket_policy_output.GetVectorBucketPolicyOutput = aws_sdk_s3vectors.types.get_vector_bucket_policy_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3vectors.types.get_vector_bucket_policy_input.GetVectorBucketPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3vectors.types.get_vector_bucket_policy_input.serialize_json(input_)
    ).encode()
