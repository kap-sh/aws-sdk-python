"""Generated from Smithy shape ``com.amazonaws.s3vectors#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.s3vectors#ServiceQuotaExceededException``."""
