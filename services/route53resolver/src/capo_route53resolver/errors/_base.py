...
class Route53ResolverError(Exception):
    """Base class for all Route53Resolver service errors."""


class ServiceError(Route53ResolverError):
...
class SerializationError(Route53ResolverError):
    """Raised when a value cannot be serialized."""


class DeserializationError(Route53ResolverError):
...
class WaiterFailedError(Route53ResolverError):
...
class WaiterTimeoutError(Route53ResolverError):
