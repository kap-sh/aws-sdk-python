"""Generated from Smithy shape ``com.amazonaws.route53resolver#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.route53resolver#ConflictException``."""
