"""Generated from Smithy shape ``com.amazonaws.route53resolver#DisassociateResolverEndpointIpAddress``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.disassociate_resolver_endpoint_ip_address_response.DisassociateResolverEndpointIpAddressResponse = capo_route53resolver.types.disassociate_resolver_endpoint_ip_address_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.disassociate_resolver_endpoint_ip_address_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_resolver_endpoint_ip_address(
