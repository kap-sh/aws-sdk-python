"""Generated from Smithy shape ``com.amazonaws.route53resolver#CreateFirewallDomainList``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.create_firewall_domain_list_response.CreateFirewallDomainListResponse = capo_route53resolver.types.create_firewall_domain_list_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.CreateFirewallDomainList"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.create_firewall_domain_list_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_firewall_domain_list(
