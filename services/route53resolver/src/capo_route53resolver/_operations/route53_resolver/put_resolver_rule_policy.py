...
def handle_response(
    ...
    out: capo_route53resolver.types.put_resolver_rule_policy_response.PutResolverRulePolicyResponse = capo_route53resolver.types.put_resolver_rule_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.put_resolver_rule_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
