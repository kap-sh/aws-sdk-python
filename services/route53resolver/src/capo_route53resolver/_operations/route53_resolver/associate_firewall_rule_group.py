"""Generated from Smithy shape ``com.amazonaws.route53resolver#AssociateFirewallRuleGroup``."""
...
import capo_route53resolver.errors.conflict_exception
...
import capo_route53resolver.errors.validation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_route53resolver.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
        ...
        case "ValidationException":
            raise capo_route53resolver.errors.validation_exception.ValidationException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_route53resolver.types.associate_firewall_rule_group_response.AssociateFirewallRuleGroupResponse = capo_route53resolver.types.associate_firewall_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.AssociateFirewallRuleGroup"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.associate_firewall_rule_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_firewall_rule_group(
