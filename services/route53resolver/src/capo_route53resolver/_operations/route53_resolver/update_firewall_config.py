"""Generated from Smithy shape ``com.amazonaws.route53resolver#UpdateFirewallConfig``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.update_firewall_config_response.UpdateFirewallConfigResponse = capo_route53resolver.types.update_firewall_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.UpdateFirewallConfig"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.update_firewall_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_firewall_config(
