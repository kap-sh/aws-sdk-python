"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListResolverConfigs``."""
...
import capo_route53resolver.errors.invalid_next_token_exception
...
import capo_route53resolver.types.resolver_config_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNextTokenException":
            raise capo_route53resolver.errors.invalid_next_token_exception.InvalidNextTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_resolver_configs_response.ListResolverConfigsResponse = capo_route53resolver.types.list_resolver_configs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.ListResolverConfigs"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_resolver_configs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_resolver_configs(
