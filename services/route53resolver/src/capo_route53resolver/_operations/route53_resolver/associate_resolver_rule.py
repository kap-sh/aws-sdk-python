"""Generated from Smithy shape ``com.amazonaws.route53resolver#AssociateResolverRule``."""
...
import capo_route53resolver.errors.resource_unavailable_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceUnavailableException":
            raise capo_route53resolver.errors.resource_unavailable_exception.ResourceUnavailableException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_route53resolver.types.associate_resolver_rule_response.AssociateResolverRuleResponse = capo_route53resolver.types.associate_resolver_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.associate_resolver_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_resolver_rule(
