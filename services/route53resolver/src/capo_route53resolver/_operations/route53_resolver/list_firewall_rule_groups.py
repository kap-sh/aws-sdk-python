"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListFirewallRuleGroups``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_firewall_rule_groups_response.ListFirewallRuleGroupsResponse = capo_route53resolver.types.list_firewall_rule_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.ListFirewallRuleGroups"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_firewall_rule_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_firewall_rule_groups(
