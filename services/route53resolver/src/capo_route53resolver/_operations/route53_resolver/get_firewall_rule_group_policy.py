"""Generated from Smithy shape ``com.amazonaws.route53resolver#GetFirewallRuleGroupPolicy``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.get_firewall_rule_group_policy_response.GetFirewallRuleGroupPolicyResponse = capo_route53resolver.types.get_firewall_rule_group_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.GetFirewallRuleGroupPolicy"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.get_firewall_rule_group_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_firewall_rule_group_policy(
