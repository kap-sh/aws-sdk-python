"""Generated from Smithy shape ``com.amazonaws.route53resolver#GetResolverRule``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.get_resolver_rule_response.GetResolverRuleResponse = capo_route53resolver.types.get_resolver_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.get_resolver_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_resolver_rule(
