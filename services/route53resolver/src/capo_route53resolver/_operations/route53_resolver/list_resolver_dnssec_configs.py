"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListResolverDnssecConfigs``."""
...
import capo_route53resolver.types.resolver_dnssec_config_list
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_resolver_dnssec_configs_response.ListResolverDnssecConfigsResponse = capo_route53resolver.types.list_resolver_dnssec_configs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.ListResolverDnssecConfigs"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_resolver_dnssec_configs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_resolver_dnssec_configs(
