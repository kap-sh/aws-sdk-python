"""Generated from Smithy shape ``com.amazonaws.route53resolver#UpdateFirewallRule``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.update_firewall_rule_response.UpdateFirewallRuleResponse = capo_route53resolver.types.update_firewall_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.UpdateFirewallRule"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.update_firewall_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_firewall_rule(
