...
def handle_response(
    ...
    out: capo_route53resolver.types.create_resolver_rule_response.CreateResolverRuleResponse = capo_route53resolver.types.create_resolver_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.create_resolver_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
