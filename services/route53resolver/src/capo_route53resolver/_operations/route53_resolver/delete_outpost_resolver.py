"""Generated from Smithy shape ``com.amazonaws.route53resolver#DeleteOutpostResolver``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.delete_outpost_resolver_response.DeleteOutpostResolverResponse = capo_route53resolver.types.delete_outpost_resolver_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.DeleteOutpostResolver"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.delete_outpost_resolver_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_outpost_resolver(
