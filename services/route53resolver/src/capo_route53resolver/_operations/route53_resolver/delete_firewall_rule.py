...
def handle_response(
    ...
    out: capo_route53resolver.types.delete_firewall_rule_response.DeleteFirewallRuleResponse = capo_route53resolver.types.delete_firewall_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.delete_firewall_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
