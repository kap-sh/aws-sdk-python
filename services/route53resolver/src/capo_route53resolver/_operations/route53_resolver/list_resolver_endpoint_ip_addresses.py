"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListResolverEndpointIpAddresses``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_resolver_endpoint_ip_addresses_response.ListResolverEndpointIpAddressesResponse = capo_route53resolver.types.list_resolver_endpoint_ip_addresses_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_resolver_endpoint_ip_addresses_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_resolver_endpoint_ip_addresses(
