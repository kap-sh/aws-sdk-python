"""Generated from Smithy shape ``com.amazonaws.route53resolver#DeleteResolverEndpoint``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.delete_resolver_endpoint_response.DeleteResolverEndpointResponse = capo_route53resolver.types.delete_resolver_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.delete_resolver_endpoint_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_resolver_endpoint(
