"""Generated from Smithy shape ``com.amazonaws.route53resolver#GetResolverConfig``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.get_resolver_config_response.GetResolverConfigResponse = capo_route53resolver.types.get_resolver_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.GetResolverConfig"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.get_resolver_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_resolver_config(
