"""Generated from Smithy shape ``com.amazonaws.route53resolver#TagResource``."""
...
import capo_route53resolver.errors.invalid_tag_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTagException":
            raise capo_route53resolver.errors.invalid_tag_exception.InvalidTagException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_route53resolver.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
