...
def handle_response(
    ...
    out: capo_route53resolver.types.get_resolver_query_log_config_policy_response.GetResolverQueryLogConfigPolicyResponse = capo_route53resolver.types.get_resolver_query_log_config_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.get_resolver_query_log_config_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
