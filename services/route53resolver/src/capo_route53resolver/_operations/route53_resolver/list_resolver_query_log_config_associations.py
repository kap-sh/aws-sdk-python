"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListResolverQueryLogConfigAssociations``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_resolver_query_log_config_associations_response.ListResolverQueryLogConfigAssociationsResponse = capo_route53resolver.types.list_resolver_query_log_config_associations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.ListResolverQueryLogConfigAssociations"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_resolver_query_log_config_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_resolver_query_log_config_associations(
