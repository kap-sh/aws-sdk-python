"""Generated from Smithy shape ``com.amazonaws.route53resolver#CreateFirewallRuleGroup``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.create_firewall_rule_group_response.CreateFirewallRuleGroupResponse = capo_route53resolver.types.create_firewall_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.CreateFirewallRuleGroup"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.create_firewall_rule_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_firewall_rule_group(
