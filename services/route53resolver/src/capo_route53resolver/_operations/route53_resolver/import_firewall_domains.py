"""Generated from Smithy shape ``com.amazonaws.route53resolver#ImportFirewallDomains``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.import_firewall_domains_response.ImportFirewallDomainsResponse = capo_route53resolver.types.import_firewall_domains_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.import_firewall_domains_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_import_firewall_domains(
