"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListFirewallRuleTypes``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_firewall_rule_types_response.ListFirewallRuleTypesResponse = capo_route53resolver.types.list_firewall_rule_types_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.ListFirewallRuleTypes"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_firewall_rule_types_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_firewall_rule_types(
