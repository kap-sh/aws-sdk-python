"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListFirewallDomainLists``."""
...
import capo_route53resolver.types.firewall_domain_list_metadata_list
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_firewall_domain_lists_response.ListFirewallDomainListsResponse = capo_route53resolver.types.list_firewall_domain_lists_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.ListFirewallDomainLists"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_firewall_domain_lists_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_firewall_domain_lists(
