"""Generated from Smithy shape ``com.amazonaws.route53resolver#GetOutpostResolver``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.get_outpost_resolver_response.GetOutpostResolverResponse = capo_route53resolver.types.get_outpost_resolver_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.GetOutpostResolver"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.get_outpost_resolver_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_outpost_resolver(
