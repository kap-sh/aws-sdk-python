"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListFirewallRules``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_firewall_rules_response.ListFirewallRulesResponse = capo_route53resolver.types.list_firewall_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.ListFirewallRules"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_firewall_rules_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
