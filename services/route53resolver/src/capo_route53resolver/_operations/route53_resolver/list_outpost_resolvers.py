"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListOutpostResolvers``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_outpost_resolvers_response.ListOutpostResolversResponse = capo_route53resolver.types.list_outpost_resolvers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.ListOutpostResolvers"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_outpost_resolvers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_outpost_resolvers(
