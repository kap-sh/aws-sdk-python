"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListFirewallConfigs``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_firewall_configs_response.ListFirewallConfigsResponse = capo_route53resolver.types.list_firewall_configs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.ListFirewallConfigs"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_firewall_configs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_firewall_configs(
