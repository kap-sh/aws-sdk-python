"""Generated from Smithy shape ``com.amazonaws.route53resolver#UpdateResolverEndpoint``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.update_resolver_endpoint_response.UpdateResolverEndpointResponse = capo_route53resolver.types.update_resolver_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.update_resolver_endpoint_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_resolver_endpoint(
