"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListFirewallDomains``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_firewall_domains_response.ListFirewallDomainsResponse = capo_route53resolver.types.list_firewall_domains_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.ListFirewallDomains"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_firewall_domains_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_firewall_domains(
