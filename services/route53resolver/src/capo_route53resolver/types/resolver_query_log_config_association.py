...
if TYPE_CHECKING:
    ...
    import capo_route53resolver.types.resolver_query_log_config_association_error_message
...
class ResolverQueryLogConfigAssociation(TypedDict, closed=True):
    ...
    status: NotRequired[
        "capo_route53resolver.types.resolver_query_log_config_association_status.ResolverQueryLogConfigAssociationStatus"
    ]
    ...
    error: NotRequired[
        "capo_route53resolver.types.resolver_query_log_config_association_error.ResolverQueryLogConfigAssociationError"
    ]
    ...
    error_message: NotRequired[
        "capo_route53resolver.types.resolver_query_log_config_association_error_message.ResolverQueryLogConfigAssociationErrorMessage"
    ]
...
def serialize_aws_json_1_1(value: ResolverQueryLogConfigAssociation) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            capo_route53resolver.types.resolver_query_log_config_association_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
    if "error" in value:
        ...
        out["Error"] = (
            capo_route53resolver.types.resolver_query_log_config_association_error.serialize_aws_json_1_1(
                value["error"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ResolverQueryLogConfigAssociation:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            capo_route53resolver.types.resolver_query_log_config_association_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
    if "Error" in data:
        ...
        out["error"] = (
            capo_route53resolver.types.resolver_query_log_config_association_error.deserialize_aws_json_1_1(
                data["Error"]
            )
        )
