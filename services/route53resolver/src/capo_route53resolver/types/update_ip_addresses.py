...
if TYPE_CHECKING:
    import capo_route53resolver.types.update_ip_address

UpdateIpAddresses: TypeAlias = list[
    "capo_route53resolver.types.update_ip_address.UpdateIpAddress"
]
...
def serialize_aws_json_1_1(value: UpdateIpAddresses) -> list:
    ...
    for item in value:
        out.append(
            capo_route53resolver.types.update_ip_address.serialize_aws_json_1_1(item)
        )
    return out
