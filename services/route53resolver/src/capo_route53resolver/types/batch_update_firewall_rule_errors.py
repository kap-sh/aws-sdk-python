...
if TYPE_CHECKING:
    import capo_route53resolver.types.batch_update_firewall_rule_error
...
def serialize_aws_json_1_1(value: BatchUpdateFirewallRuleErrors) -> list:
    ...
    for item in value:
        out.append(
            capo_route53resolver.types.batch_update_firewall_rule_error.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> BatchUpdateFirewallRuleErrors:
    ...
    for item in data:
        out.append(
            capo_route53resolver.types.batch_update_firewall_rule_error.deserialize_aws_json_1_1(
                item
            )
        )
    return out
