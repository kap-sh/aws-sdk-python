...
class ListResolverEndpointIpAddressesResponse(TypedDict, closed=True):
    ...
    ip_addresses: NotRequired[
        "capo_route53resolver.types.ip_addresses_response.IpAddressesResponse"
    ]
...
def serialize_aws_json_1_1(value: ListResolverEndpointIpAddressesResponse) -> dict:
    ...
    if "ip_addresses" in value:
        ...
        out["IpAddresses"] = (
            capo_route53resolver.types.ip_addresses_response.serialize_aws_json_1_1(
                value["ip_addresses"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListResolverEndpointIpAddressesResponse:
    ...
    if "IpAddresses" in data:
        ...
        out["ip_addresses"] = (
            capo_route53resolver.types.ip_addresses_response.deserialize_aws_json_1_1(
                data["IpAddresses"]
            )
        )
    return out
