...
class ResolverConfig(TypedDict, closed=True):
    ...
    autodefined_reverse: NotRequired[
        "capo_route53resolver.types.resolver_autodefined_reverse_status.ResolverAutodefinedReverseStatus"
    ]
...
def serialize_aws_json_1_1(value: ResolverConfig) -> dict:
    ...
    if "autodefined_reverse" in value:
        ...
        out["AutodefinedReverse"] = (
            capo_route53resolver.types.resolver_autodefined_reverse_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ResolverConfig:
    ...
    if "AutodefinedReverse" in data:
        ...
        out["autodefined_reverse"] = (
            capo_route53resolver.types.resolver_autodefined_reverse_status.deserialize_aws_json_1_1(
