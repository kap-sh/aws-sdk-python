...
class BatchCreateFirewallRuleResponse(TypedDict, closed=True):
    ...
    create_errors: NotRequired[
        "capo_route53resolver.types.batch_create_firewall_rule_errors.BatchCreateFirewallRuleErrors"
    ]
...
def serialize_aws_json_1_1(value: BatchCreateFirewallRuleResponse) -> dict:
    ...
    if "create_errors" in value:
        ...
        out["CreateErrors"] = (
            capo_route53resolver.types.batch_create_firewall_rule_errors.serialize_aws_json_1_1(
                value["create_errors"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> BatchCreateFirewallRuleResponse:
    ...
    if "CreateErrors" in data:
        ...
        out["create_errors"] = (
            capo_route53resolver.types.batch_create_firewall_rule_errors.deserialize_aws_json_1_1(
                data["CreateErrors"]
            )
        )
    return out
