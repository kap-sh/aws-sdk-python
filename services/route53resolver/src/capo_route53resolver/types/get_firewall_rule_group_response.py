"""Generated from Smithy shape ``com.amazonaws.route53resolver#GetFirewallRuleGroupResponse``."""
...
class GetFirewallRuleGroupResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetFirewallRuleGroupResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetFirewallRuleGroupResponse:
    out: GetFirewallRuleGroupResponse = {}  # type: ignore[typeddict-item]
