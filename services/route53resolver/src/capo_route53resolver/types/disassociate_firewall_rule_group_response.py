"""Generated from Smithy shape ``com.amazonaws.route53resolver#DisassociateFirewallRuleGroupResponse``."""
...
class DisassociateFirewallRuleGroupResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DisassociateFirewallRuleGroupResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DisassociateFirewallRuleGroupResponse:
    out: DisassociateFirewallRuleGroupResponse = {}  # type: ignore[typeddict-item]
