...
class GetResolverQueryLogConfigPolicyResponse(TypedDict, closed=True):
    resolver_query_log_config_policy: NotRequired[
        "capo_route53resolver.types.resolver_query_log_config_policy.ResolverQueryLogConfigPolicy"
    ]
