...
class UpdateResolverConfigResponse(TypedDict, closed=True):
...
def serialize_aws_json_1_1(value: UpdateResolverConfigResponse) -> dict:
    ...
    if "resolver_config" in value:
        ...
        out["ResolverConfig"] = (
            capo_route53resolver.types.resolver_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateResolverConfigResponse:
    ...
    if "ResolverConfig" in data:
        ...
        out["resolver_config"] = (
            capo_route53resolver.types.resolver_config.deserialize_aws_json_1_1(
                data["ResolverConfig"]
            )
        )
    return out
