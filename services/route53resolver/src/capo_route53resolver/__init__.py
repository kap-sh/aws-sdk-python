...
from ._services.async_route53_resolver import (
    AsyncRoute53ResolverClient as AsyncRoute53ResolverClient,
)
from ._services.route53_resolver import Route53ResolverClient as Route53ResolverClient
