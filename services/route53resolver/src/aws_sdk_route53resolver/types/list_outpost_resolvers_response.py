...
class ListOutpostResolversResponse(TypedDict):
    outpost_resolvers: NotRequired[
        "aws_sdk_route53resolver.types.outpost_resolver_list.OutpostResolverList"
    ]
...
def serialize_aws_json_1_1(value: ListOutpostResolversResponse) -> dict:
    ...
    if "outpost_resolvers" in value:
        ...
        out["OutpostResolvers"] = (
            aws_sdk_route53resolver.types.outpost_resolver_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListOutpostResolversResponse:
    ...
    if "OutpostResolvers" in data:
        ...
        out["outpost_resolvers"] = (
            aws_sdk_route53resolver.types.outpost_resolver_list.deserialize_aws_json_1_1(
