...
if TYPE_CHECKING:
    ...
    import aws_sdk_route53resolver.types.firewall_rule_group_status
...
class FirewallRuleGroup(TypedDict):
    ...
    rule_count: NotRequired["aws_sdk_route53resolver.types.unsigned.Unsigned"]
    """<p>The number of rules in the rule group.</p>"""
    status: NotRequired[
        "aws_sdk_route53resolver.types.firewall_rule_group_status.FirewallRuleGroupStatus"
    ]
...
def serialize_aws_json_1_1(value: FirewallRuleGroup) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_route53resolver.types.firewall_rule_group_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> FirewallRuleGroup:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_route53resolver.types.firewall_rule_group_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
