...
FirewallRuleTypeDefinitions: TypeAlias = list[
    "aws_sdk_route53resolver.types.firewall_rule_type_definition.FirewallRuleTypeDefinition"
]
...
def serialize_aws_json_1_1(value: FirewallRuleTypeDefinitions) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_route53resolver.types.firewall_rule_type_definition.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> FirewallRuleTypeDefinitions:
    ...
    for item in data:
        out.append(
            aws_sdk_route53resolver.types.firewall_rule_type_definition.deserialize_aws_json_1_1(
                item
            )
        )
    return out
