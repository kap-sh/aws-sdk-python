...
if TYPE_CHECKING:
    import aws_sdk_route53resolver.types.firewall_advanced_content_category_value


class FirewallAdvancedContentCategoryConfig(TypedDict):
    category: "aws_sdk_route53resolver.types.firewall_advanced_content_category_value.FirewallAdvancedContentCategoryValue"
