...
class ListFirewallRuleTypesResponse(TypedDict):
    firewall_rule_types: NotRequired[
        "aws_sdk_route53resolver.types.firewall_rule_type_definitions.FirewallRuleTypeDefinitions"
    ]
...
def serialize_aws_json_1_1(value: ListFirewallRuleTypesResponse) -> dict:
    ...
    if "firewall_rule_types" in value:
        ...
        out["FirewallRuleTypes"] = (
            aws_sdk_route53resolver.types.firewall_rule_type_definitions.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListFirewallRuleTypesResponse:
    ...
    if "FirewallRuleTypes" in data:
        ...
        out["firewall_rule_types"] = (
            aws_sdk_route53resolver.types.firewall_rule_type_definitions.deserialize_aws_json_1_1(
