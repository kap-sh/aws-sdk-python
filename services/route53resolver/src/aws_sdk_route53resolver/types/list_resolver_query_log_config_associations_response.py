...
class ListResolverQueryLogConfigAssociationsResponse(TypedDict):
    ...
    resolver_query_log_config_associations: NotRequired[
        "aws_sdk_route53resolver.types.resolver_query_log_config_association_list.ResolverQueryLogConfigAssociationList"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "resolver_query_log_config_associations" in value:
        ...
        out["ResolverQueryLogConfigAssociations"] = (
            aws_sdk_route53resolver.types.resolver_query_log_config_association_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "ResolverQueryLogConfigAssociations" in data:
        ...
        out["resolver_query_log_config_associations"] = (
            aws_sdk_route53resolver.types.resolver_query_log_config_association_list.deserialize_aws_json_1_1(
