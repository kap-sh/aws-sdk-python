...
class ListFirewallConfigsResponse(TypedDict):
    ...
    firewall_configs: NotRequired[
        "aws_sdk_route53resolver.types.firewall_config_list.FirewallConfigList"
    ]
...
def serialize_aws_json_1_1(value: ListFirewallConfigsResponse) -> dict:
    ...
    if "firewall_configs" in value:
        ...
        out["FirewallConfigs"] = (
            aws_sdk_route53resolver.types.firewall_config_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListFirewallConfigsResponse:
    ...
    if "FirewallConfigs" in data:
        ...
        out["firewall_configs"] = (
            aws_sdk_route53resolver.types.firewall_config_list.deserialize_aws_json_1_1(
