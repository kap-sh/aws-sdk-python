"""Generated from Smithy shape ``com.amazonaws.route53resolver#UpdateFirewallRuleEntry``."""
...
class UpdateFirewallRuleEntry(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateFirewallRuleEntry) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UpdateFirewallRuleEntry:
    out: UpdateFirewallRuleEntry = {}  # type: ignore[typeddict-item]
    if "FirewallRuleGroupId" in data:
        out["firewall_rule_group_id"] = data["FirewallRuleGroupId"]
    else:
        raise DeserializationError(
            "UpdateFirewallRuleEntry.firewall_rule_group_id required"
        )
