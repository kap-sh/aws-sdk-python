...
FirewallRuleGroupMetadataList: TypeAlias = list[
    "aws_sdk_route53resolver.types.firewall_rule_group_metadata.FirewallRuleGroupMetadata"
]
...
def serialize_aws_json_1_1(value: FirewallRuleGroupMetadataList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_route53resolver.types.firewall_rule_group_metadata.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> FirewallRuleGroupMetadataList:
    ...
    for item in data:
        out.append(
            aws_sdk_route53resolver.types.firewall_rule_group_metadata.deserialize_aws_json_1_1(
                item
            )
        )
    return out
