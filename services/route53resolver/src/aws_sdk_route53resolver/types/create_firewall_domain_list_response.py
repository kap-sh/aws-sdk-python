"""Generated from Smithy shape ``com.amazonaws.route53resolver#CreateFirewallDomainListResponse``."""
...
class CreateFirewallDomainListResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateFirewallDomainListResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> CreateFirewallDomainListResponse:
    out: CreateFirewallDomainListResponse = {}  # type: ignore[typeddict-item]
