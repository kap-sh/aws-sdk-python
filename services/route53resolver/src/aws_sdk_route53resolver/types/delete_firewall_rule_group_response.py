"""Generated from Smithy shape ``com.amazonaws.route53resolver#DeleteFirewallRuleGroupResponse``."""
...
class DeleteFirewallRuleGroupResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteFirewallRuleGroupResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteFirewallRuleGroupResponse:
    out: DeleteFirewallRuleGroupResponse = {}  # type: ignore[typeddict-item]
