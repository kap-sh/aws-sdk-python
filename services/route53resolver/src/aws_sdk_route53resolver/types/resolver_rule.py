...
if TYPE_CHECKING:
    ...
    import aws_sdk_route53resolver.types.resolver_rule_status
...
class ResolverRule(TypedDict):
    ...
    status: NotRequired[
        "aws_sdk_route53resolver.types.resolver_rule_status.ResolverRuleStatus"
    ]
    ...
    rule_type: NotRequired[
        "aws_sdk_route53resolver.types.rule_type_option.RuleTypeOption"
    ]
...
def serialize_aws_json_1_1(value: ResolverRule) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_route53resolver.types.resolver_rule_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ResolverRule:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_route53resolver.types.resolver_rule_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
