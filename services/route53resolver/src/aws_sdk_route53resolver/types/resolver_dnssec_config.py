...
if TYPE_CHECKING:
    ...
    import aws_sdk_route53resolver.types.resolver_dnssec_validation_status
...
class ResolverDnssecConfig(TypedDict, closed=True):
    ...
    validation_status: NotRequired[
        "aws_sdk_route53resolver.types.resolver_dnssec_validation_status.ResolverDNSSECValidationStatus"
    ]
...
def serialize_aws_json_1_1(value: ResolverDnssecConfig) -> dict:
    ...
    if "validation_status" in value:
        ...
        out["ValidationStatus"] = (
            aws_sdk_route53resolver.types.resolver_dnssec_validation_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ResolverDnssecConfig:
    ...
    if "ValidationStatus" in data:
        ...
        out["validation_status"] = (
            aws_sdk_route53resolver.types.resolver_dnssec_validation_status.deserialize_aws_json_1_1(
