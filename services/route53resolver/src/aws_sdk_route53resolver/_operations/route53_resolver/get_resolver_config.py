...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.get_resolver_config_response.GetResolverConfigResponse = aws_sdk_route53resolver.types.get_resolver_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.get_resolver_config_request.GetResolverConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.get_resolver_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
