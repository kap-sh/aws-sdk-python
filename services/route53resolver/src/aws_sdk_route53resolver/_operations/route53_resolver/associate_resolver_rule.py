...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.associate_resolver_rule_response.AssociateResolverRuleResponse = aws_sdk_route53resolver.types.associate_resolver_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.associate_resolver_rule_request.AssociateResolverRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.associate_resolver_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
