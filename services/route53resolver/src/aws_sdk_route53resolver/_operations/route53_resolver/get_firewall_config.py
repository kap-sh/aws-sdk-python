"""Generated from Smithy shape ``com.amazonaws.route53resolver#GetFirewallConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.get_firewall_config_response.GetFirewallConfigResponse = aws_sdk_route53resolver.types.get_firewall_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.get_firewall_config_request.GetFirewallConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.GetFirewallConfig"
    import aws_sdk_route53resolver.types.get_firewall_config_request

    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.get_firewall_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_firewall_config(
