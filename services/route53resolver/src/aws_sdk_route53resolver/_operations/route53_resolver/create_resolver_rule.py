"""Generated from Smithy shape ``com.amazonaws.route53resolver#CreateResolverRule``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceUnavailableException":
            import aws_sdk_route53resolver.errors.resource_unavailable_exception

            raise aws_sdk_route53resolver.errors.resource_unavailable_exception.ResourceUnavailableException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.create_resolver_rule_response.CreateResolverRuleResponse = aws_sdk_route53resolver.types.create_resolver_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.create_resolver_rule_request.CreateResolverRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.create_resolver_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_resolver_rule(
