...
import aws_sdk_route53resolver.types.firewall_rule_type_definitions
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.list_firewall_rule_types_response.ListFirewallRuleTypesResponse = aws_sdk_route53resolver.types.list_firewall_rule_types_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.list_firewall_rule_types_request.ListFirewallRuleTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.list_firewall_rule_types_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
