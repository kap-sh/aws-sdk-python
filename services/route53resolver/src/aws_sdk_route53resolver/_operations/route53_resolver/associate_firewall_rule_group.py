...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_route53resolver.errors.conflict_exception

            raise aws_sdk_route53resolver.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.associate_firewall_rule_group_response.AssociateFirewallRuleGroupResponse = aws_sdk_route53resolver.types.associate_firewall_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.associate_firewall_rule_group_request.AssociateFirewallRuleGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.associate_firewall_rule_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
