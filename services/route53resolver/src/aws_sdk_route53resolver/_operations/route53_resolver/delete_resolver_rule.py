...
import aws_sdk_route53resolver.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise aws_sdk_route53resolver.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.delete_resolver_rule_response.DeleteResolverRuleResponse = aws_sdk_route53resolver.types.delete_resolver_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.delete_resolver_rule_request.DeleteResolverRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.delete_resolver_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
