"""Generated from Smithy shape ``com.amazonaws.route53resolver#AssociateResolverQueryLogConfig``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            import aws_sdk_route53resolver.errors.limit_exceeded_exception

            raise aws_sdk_route53resolver.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data
            )
        case "ResourceExistsException":
            import aws_sdk_route53resolver.errors.resource_exists_exception

            raise aws_sdk_route53resolver.errors.resource_exists_exception.ResourceExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.associate_resolver_query_log_config_response.AssociateResolverQueryLogConfigResponse = aws_sdk_route53resolver.types.associate_resolver_query_log_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.associate_resolver_query_log_config_request.AssociateResolverQueryLogConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.AssociateResolverQueryLogConfig"
    import aws_sdk_route53resolver.types.associate_resolver_query_log_config_request

    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.associate_resolver_query_log_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_resolver_query_log_config(
