...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.list_resolver_configs_response.ListResolverConfigsResponse = aws_sdk_route53resolver.types.list_resolver_configs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.list_resolver_configs_request.ListResolverConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.list_resolver_configs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
