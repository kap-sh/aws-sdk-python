...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.list_firewall_domain_lists_response.ListFirewallDomainListsResponse = aws_sdk_route53resolver.types.list_firewall_domain_lists_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.list_firewall_domain_lists_request.ListFirewallDomainListsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.list_firewall_domain_lists_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
