...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.get_resolver_rule_association_response.GetResolverRuleAssociationResponse = aws_sdk_route53resolver.types.get_resolver_rule_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.get_resolver_rule_association_request.GetResolverRuleAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.get_resolver_rule_association_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
