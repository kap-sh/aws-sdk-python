"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListFirewallRuleGroupAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.list_firewall_rule_group_associations_response.ListFirewallRuleGroupAssociationsResponse = aws_sdk_route53resolver.types.list_firewall_rule_group_associations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.list_firewall_rule_group_associations_request.ListFirewallRuleGroupAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.ListFirewallRuleGroupAssociations"
    import aws_sdk_route53resolver.types.list_firewall_rule_group_associations_request

    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.list_firewall_rule_group_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_firewall_rule_group_associations(
