"""Generated from Smithy shape ``com.amazonaws.route53resolver#UpdateOutpostResolver``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_route53resolver.errors.service_quota_exceeded_exception

            raise aws_sdk_route53resolver.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.update_outpost_resolver_response.UpdateOutpostResolverResponse = aws_sdk_route53resolver.types.update_outpost_resolver_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.update_outpost_resolver_request.UpdateOutpostResolverRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.UpdateOutpostResolver"
    import aws_sdk_route53resolver.types.update_outpost_resolver_request

    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.update_outpost_resolver_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_outpost_resolver(
