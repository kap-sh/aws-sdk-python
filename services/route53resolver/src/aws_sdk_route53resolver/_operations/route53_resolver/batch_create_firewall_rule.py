"""Generated from Smithy shape ``com.amazonaws.route53resolver#BatchCreateFirewallRule``."""
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.batch_create_firewall_rule_response.BatchCreateFirewallRuleResponse = aws_sdk_route53resolver.types.batch_create_firewall_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.batch_create_firewall_rule_request.BatchCreateFirewallRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.BatchCreateFirewallRule"
    import aws_sdk_route53resolver.types.batch_create_firewall_rule_request

    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.batch_create_firewall_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_create_firewall_rule(
