"""Generated from Smithy shape ``com.amazonaws.route53resolver#CreateResolverQueryLogConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.create_resolver_query_log_config_response.CreateResolverQueryLogConfigResponse = aws_sdk_route53resolver.types.create_resolver_query_log_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.create_resolver_query_log_config_request.CreateResolverQueryLogConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.CreateResolverQueryLogConfig"
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.create_resolver_query_log_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_resolver_query_log_config(
