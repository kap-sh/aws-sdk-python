"""Generated from Smithy shape ``com.amazonaws.route53resolver#UpdateResolverConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.update_resolver_config_response.UpdateResolverConfigResponse = aws_sdk_route53resolver.types.update_resolver_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.update_resolver_config_request.UpdateResolverConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.UpdateResolverConfig"
    import aws_sdk_route53resolver.types.update_resolver_config_request

    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.update_resolver_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_resolver_config(
