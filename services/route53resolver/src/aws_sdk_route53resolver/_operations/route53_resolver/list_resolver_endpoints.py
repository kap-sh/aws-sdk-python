"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListResolverEndpoints``."""
...
import aws_sdk_route53resolver.types.resolver_endpoints
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.list_resolver_endpoints_response.ListResolverEndpointsResponse = aws_sdk_route53resolver.types.list_resolver_endpoints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.list_resolver_endpoints_request.ListResolverEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.list_resolver_endpoints_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_resolver_endpoints(
