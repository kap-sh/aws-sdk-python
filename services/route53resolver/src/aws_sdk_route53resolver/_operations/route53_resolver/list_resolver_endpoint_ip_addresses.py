...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.list_resolver_endpoint_ip_addresses_response.ListResolverEndpointIpAddressesResponse = aws_sdk_route53resolver.types.list_resolver_endpoint_ip_addresses_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.list_resolver_endpoint_ip_addresses_request.ListResolverEndpointIpAddressesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.list_resolver_endpoint_ip_addresses_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
