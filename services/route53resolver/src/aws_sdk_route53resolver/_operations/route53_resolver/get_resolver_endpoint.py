"""Generated from Smithy shape ``com.amazonaws.route53resolver#GetResolverEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.get_resolver_endpoint_response.GetResolverEndpointResponse = aws_sdk_route53resolver.types.get_resolver_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.get_resolver_endpoint_request.GetResolverEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.get_resolver_endpoint_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_resolver_endpoint(
