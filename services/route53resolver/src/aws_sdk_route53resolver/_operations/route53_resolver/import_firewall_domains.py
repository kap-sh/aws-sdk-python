...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.import_firewall_domains_response.ImportFirewallDomainsResponse = aws_sdk_route53resolver.types.import_firewall_domains_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.import_firewall_domains_request.ImportFirewallDomainsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
