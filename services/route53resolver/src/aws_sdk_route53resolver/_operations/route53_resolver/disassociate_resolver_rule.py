...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.disassociate_resolver_rule_response.DisassociateResolverRuleResponse = aws_sdk_route53resolver.types.disassociate_resolver_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.disassociate_resolver_rule_request.DisassociateResolverRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.disassociate_resolver_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
