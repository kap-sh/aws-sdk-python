...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.update_resolver_endpoint_response.UpdateResolverEndpointResponse = aws_sdk_route53resolver.types.update_resolver_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.update_resolver_endpoint_request.UpdateResolverEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.update_resolver_endpoint_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
