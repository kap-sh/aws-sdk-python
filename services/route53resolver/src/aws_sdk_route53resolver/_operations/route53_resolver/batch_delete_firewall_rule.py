"""Generated from Smithy shape ``com.amazonaws.route53resolver#BatchDeleteFirewallRule``."""
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.batch_delete_firewall_rule_response.BatchDeleteFirewallRuleResponse = aws_sdk_route53resolver.types.batch_delete_firewall_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.batch_delete_firewall_rule_request.BatchDeleteFirewallRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.BatchDeleteFirewallRule"
    import aws_sdk_route53resolver.types.batch_delete_firewall_rule_request

    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.batch_delete_firewall_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_delete_firewall_rule(
