...
import aws_sdk_route53resolver.types.firewall_config_list
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.list_firewall_configs_response.ListFirewallConfigsResponse = aws_sdk_route53resolver.types.list_firewall_configs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.list_firewall_configs_request.ListFirewallConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.list_firewall_configs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
