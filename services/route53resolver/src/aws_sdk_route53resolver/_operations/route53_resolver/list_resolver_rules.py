...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.list_resolver_rules_response.ListResolverRulesResponse = aws_sdk_route53resolver.types.list_resolver_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.list_resolver_rules_request.ListResolverRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.list_resolver_rules_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
