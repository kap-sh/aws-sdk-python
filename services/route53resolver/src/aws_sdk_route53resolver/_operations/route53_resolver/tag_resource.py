...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTagException":
            import aws_sdk_route53resolver.errors.invalid_tag_exception

            raise aws_sdk_route53resolver.errors.invalid_tag_exception.InvalidTagException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_route53resolver.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.tag_resource_request.serialize_aws_json_1_1(input)
    ).encode()
