"""Generated from Smithy shape ``com.amazonaws.route53resolver#GetResolverQueryLogConfigPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.get_resolver_query_log_config_policy_response.GetResolverQueryLogConfigPolicyResponse = aws_sdk_route53resolver.types.get_resolver_query_log_config_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.get_resolver_query_log_config_policy_request.GetResolverQueryLogConfigPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.GetResolverQueryLogConfigPolicy"
    import aws_sdk_route53resolver.types.get_resolver_query_log_config_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.get_resolver_query_log_config_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_resolver_query_log_config_policy(
