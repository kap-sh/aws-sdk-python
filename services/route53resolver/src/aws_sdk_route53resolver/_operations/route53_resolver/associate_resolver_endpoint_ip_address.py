...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.associate_resolver_endpoint_ip_address_response.AssociateResolverEndpointIpAddressResponse = aws_sdk_route53resolver.types.associate_resolver_endpoint_ip_address_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.associate_resolver_endpoint_ip_address_request.AssociateResolverEndpointIpAddressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.associate_resolver_endpoint_ip_address_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
