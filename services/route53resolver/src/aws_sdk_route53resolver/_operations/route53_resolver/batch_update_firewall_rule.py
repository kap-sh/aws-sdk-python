...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.batch_update_firewall_rule_response.BatchUpdateFirewallRuleResponse = aws_sdk_route53resolver.types.batch_update_firewall_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.batch_update_firewall_rule_request.BatchUpdateFirewallRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.batch_update_firewall_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
