"""Generated from Smithy shape ``com.amazonaws.route53resolver#GetResolverDnssecConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.get_resolver_dnssec_config_response.GetResolverDnssecConfigResponse = aws_sdk_route53resolver.types.get_resolver_dnssec_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.get_resolver_dnssec_config_request.GetResolverDnssecConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.GetResolverDnssecConfig"
    import aws_sdk_route53resolver.types.get_resolver_dnssec_config_request

    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.get_resolver_dnssec_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_resolver_dnssec_config(
