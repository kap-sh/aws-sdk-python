...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.update_resolver_rule_response.UpdateResolverRuleResponse = aws_sdk_route53resolver.types.update_resolver_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.update_resolver_rule_request.UpdateResolverRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.update_resolver_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
