...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.delete_resolver_query_log_config_response.DeleteResolverQueryLogConfigResponse = aws_sdk_route53resolver.types.delete_resolver_query_log_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.delete_resolver_query_log_config_request.DeleteResolverQueryLogConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.delete_resolver_query_log_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
