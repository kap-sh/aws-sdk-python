...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.create_firewall_rule_response.CreateFirewallRuleResponse = aws_sdk_route53resolver.types.create_firewall_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.create_firewall_rule_request.CreateFirewallRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.create_firewall_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
