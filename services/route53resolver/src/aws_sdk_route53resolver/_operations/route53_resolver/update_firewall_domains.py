...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.update_firewall_domains_response.UpdateFirewallDomainsResponse = aws_sdk_route53resolver.types.update_firewall_domains_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.update_firewall_domains_request.UpdateFirewallDomainsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
