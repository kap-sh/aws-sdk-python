...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.create_resolver_endpoint_response.CreateResolverEndpointResponse = aws_sdk_route53resolver.types.create_resolver_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.create_resolver_endpoint_request.CreateResolverEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.create_resolver_endpoint_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
