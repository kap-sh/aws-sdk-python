"""Generated from Smithy shape ``com.amazonaws.route53resolver#DisassociateFirewallRuleGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.disassociate_firewall_rule_group_response.DisassociateFirewallRuleGroupResponse = aws_sdk_route53resolver.types.disassociate_firewall_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.disassociate_firewall_rule_group_request.DisassociateFirewallRuleGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.DisassociateFirewallRuleGroup"
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.disassociate_firewall_rule_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_firewall_rule_group(
