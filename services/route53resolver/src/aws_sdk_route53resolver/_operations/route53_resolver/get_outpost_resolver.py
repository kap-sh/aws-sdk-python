...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.get_outpost_resolver_response.GetOutpostResolverResponse = aws_sdk_route53resolver.types.get_outpost_resolver_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.get_outpost_resolver_request.GetOutpostResolverRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.get_outpost_resolver_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
