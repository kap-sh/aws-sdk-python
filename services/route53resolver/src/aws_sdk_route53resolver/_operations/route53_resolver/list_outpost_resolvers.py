...
import aws_sdk_route53resolver.types.outpost_resolver_list
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.list_outpost_resolvers_response.ListOutpostResolversResponse = aws_sdk_route53resolver.types.list_outpost_resolvers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.list_outpost_resolvers_request.ListOutpostResolversRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.list_outpost_resolvers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
