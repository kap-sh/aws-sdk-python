...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.put_firewall_rule_group_policy_response.PutFirewallRuleGroupPolicyResponse = aws_sdk_route53resolver.types.put_firewall_rule_group_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.put_firewall_rule_group_policy_request.PutFirewallRuleGroupPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.put_firewall_rule_group_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
