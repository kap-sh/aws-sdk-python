"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListResolverRuleAssociations``."""
...
import aws_sdk_route53resolver.errors.invalid_next_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNextTokenException":
            raise aws_sdk_route53resolver.errors.invalid_next_token_exception.InvalidNextTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.list_resolver_rule_associations_response.ListResolverRuleAssociationsResponse = aws_sdk_route53resolver.types.list_resolver_rule_associations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.list_resolver_rule_associations_request.ListResolverRuleAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.list_resolver_rule_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_resolver_rule_associations(
