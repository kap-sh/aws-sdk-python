...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.get_resolver_rule_response.GetResolverRuleResponse = aws_sdk_route53resolver.types.get_resolver_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.get_resolver_rule_request.GetResolverRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.get_resolver_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
