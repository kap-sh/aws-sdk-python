...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.delete_firewall_domain_list_response.DeleteFirewallDomainListResponse = aws_sdk_route53resolver.types.delete_firewall_domain_list_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.delete_firewall_domain_list_request.DeleteFirewallDomainListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.delete_firewall_domain_list_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
