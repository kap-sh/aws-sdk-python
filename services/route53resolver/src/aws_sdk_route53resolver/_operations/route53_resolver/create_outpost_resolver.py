"""Generated from Smithy shape ``com.amazonaws.route53resolver#CreateOutpostResolver``."""
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.create_outpost_resolver_response.CreateOutpostResolverResponse = aws_sdk_route53resolver.types.create_outpost_resolver_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.create_outpost_resolver_request.CreateOutpostResolverRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.CreateOutpostResolver"
    import aws_sdk_route53resolver.types.create_outpost_resolver_request

    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.create_outpost_resolver_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_outpost_resolver(
