"""Generated from Smithy shape ``com.amazonaws.route53resolver#PutResolverRulePolicy``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPolicyDocument":
            import aws_sdk_route53resolver.errors.invalid_policy_document

            raise aws_sdk_route53resolver.errors.invalid_policy_document.InvalidPolicyDocument.from_aws_json_1_1(
                data
            )
        case "UnknownResourceException":
            import aws_sdk_route53resolver.errors.unknown_resource_exception

            raise aws_sdk_route53resolver.errors.unknown_resource_exception.UnknownResourceException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_route53resolver.types.put_resolver_rule_policy_response.PutResolverRulePolicyResponse = aws_sdk_route53resolver.types.put_resolver_rule_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_route53resolver.types.put_resolver_rule_policy_request.PutResolverRulePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53resolver.types.put_resolver_rule_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_resolver_rule_policy(
