...
```
pip install aws-sdk-route53resolver
```

## Usage

```python
from aws_sdk_route53resolver import AsyncRoute53ResolverClient
...
```python
from aws_sdk_route53resolver import AsyncRoute53ResolverClient
from aws_sdk_route53resolver.error import AccessDeniedException
