...
class DevOpsGuruError(Exception):
    """Base class for all DevOpsGuru service errors."""


class ServiceError(DevOpsGuruError):
...
class SerializationError(DevOpsGuruError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DevOpsGuruError):
...
class WaiterFailedError(DevOpsGuruError):
...
class WaiterTimeoutError(DevOpsGuruError):
