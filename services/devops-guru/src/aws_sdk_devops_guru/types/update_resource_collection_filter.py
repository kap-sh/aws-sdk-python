"""Generated from Smithy shape ``com.amazonaws.devopsguru#UpdateResourceCollectionFilter``."""
...
if TYPE_CHECKING:
    import aws_sdk_devops_guru.types.update_cloud_formation_collection_filter
    import aws_sdk_devops_guru.types.update_tag_collection_filters


class UpdateResourceCollectionFilter(TypedDict, closed=True):
    cloud_formation: NotRequired[
        "aws_sdk_devops_guru.types.update_cloud_formation_collection_filter.UpdateCloudFormationCollectionFilter"
    ]
...
def serialize_json(value: UpdateResourceCollectionFilter) -> dict:
    ...
    if "tags" in value:
        ...
        out["Tags"] = (
            aws_sdk_devops_guru.types.update_tag_collection_filters.serialize_json(
                value["tags"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> UpdateResourceCollectionFilter:
    ...
    if "CloudFormation" in data:
        ...
        out["cloud_formation"] = (
            aws_sdk_devops_guru.types.update_cloud_formation_collection_filter.deserialize_json(
                data["CloudFormation"]
            )
        )
    if "Tags" in data:
        ...
        out["tags"] = (
            aws_sdk_devops_guru.types.update_tag_collection_filters.deserialize_json(
                data["Tags"]
            )
        )
    return out
