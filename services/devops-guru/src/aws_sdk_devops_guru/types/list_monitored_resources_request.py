...
class ListMonitoredResourcesRequest(TypedDict):
    filters: NotRequired[
...
def serialize_json(value: ListMonitoredResourcesRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            aws_sdk_devops_guru.types.list_monitored_resources_filters.serialize_json(
                value["filters"]
            )
        )
...
def deserialize_json(data: dict) -> ListMonitoredResourcesRequest:
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_devops_guru.types.list_monitored_resources_filters.deserialize_json(
                data["Filters"]
            )
        )
