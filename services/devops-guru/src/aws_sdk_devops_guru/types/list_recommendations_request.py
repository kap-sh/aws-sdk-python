...
class ListRecommendationsRequest(TypedDict, closed=True):
    ...
    locale: NotRequired["aws_sdk_devops_guru.types.locale.Locale"]
...
def serialize_json(value: ListRecommendationsRequest) -> dict:
    ...
    if "locale" in value:
        ...
        out["Locale"] = aws_sdk_devops_guru.types.locale.serialize_json(value["locale"])
...
def deserialize_json(data: dict) -> ListRecommendationsRequest:
    ...
    if "Locale" in data:
        ...
        out["locale"] = aws_sdk_devops_guru.types.locale.deserialize_json(
            data["Locale"]
        )
