...
def serialize_json(value: CostEstimationResourceCollectionFilter) -> dict:
    ...
    if "cloud_formation" in value:
        ...
        out["CloudFormation"] = (
            aws_sdk_devops_guru.types.cloud_formation_cost_estimation_resource_collection_filter.serialize_json(
    ...
    if "tags" in value:
        ...
        out["Tags"] = (
            aws_sdk_devops_guru.types.tag_cost_estimation_resource_collection_filters.serialize_json(
                value["tags"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> CostEstimationResourceCollectionFilter:
    ...
    if "CloudFormation" in data:
        ...
        out["cloud_formation"] = (
            aws_sdk_devops_guru.types.cloud_formation_cost_estimation_resource_collection_filter.deserialize_json(
                data["CloudFormation"]
            )
        )
    if "Tags" in data:
        ...
        out["tags"] = (
            aws_sdk_devops_guru.types.tag_cost_estimation_resource_collection_filters.deserialize_json(
                data["Tags"]
            )
        )
    return out
