...
if TYPE_CHECKING:
    import aws_sdk_devops_guru.types.performance_insights_metric_dimension_group
    import aws_sdk_devops_guru.types.performance_insights_metric_filter_map
    import aws_sdk_devops_guru.types.performance_insights_metric_name


class PerformanceInsightsMetricQuery(TypedDict, closed=True):
    metric: NotRequired[
        "aws_sdk_devops_guru.types.performance_insights_metric_name.PerformanceInsightsMetricName"
    ]
    ...
    group_by: NotRequired[
        "aws_sdk_devops_guru.types.performance_insights_metric_dimension_group.PerformanceInsightsMetricDimensionGroup"
    ]
    ...
    filter: NotRequired[
        "aws_sdk_devops_guru.types.performance_insights_metric_filter_map.PerformanceInsightsMetricFilterMap"
    ]
...
def serialize_json(value: PerformanceInsightsMetricQuery) -> dict:
    ...
    if "group_by" in value:
        ...
        out["GroupBy"] = (
            aws_sdk_devops_guru.types.performance_insights_metric_dimension_group.serialize_json(
                value["group_by"]
            )
        )
    if "filter" in value:
        ...
        out["Filter"] = (
            aws_sdk_devops_guru.types.performance_insights_metric_filter_map.serialize_json(
                value["filter"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> PerformanceInsightsMetricQuery:
    ...
    if "GroupBy" in data:
        ...
        out["group_by"] = (
            aws_sdk_devops_guru.types.performance_insights_metric_dimension_group.deserialize_json(
                data["GroupBy"]
            )
        )
    if "Filter" in data:
        ...
        out["filter"] = (
            aws_sdk_devops_guru.types.performance_insights_metric_filter_map.deserialize_json(
                data["Filter"]
            )
        )
    return out
