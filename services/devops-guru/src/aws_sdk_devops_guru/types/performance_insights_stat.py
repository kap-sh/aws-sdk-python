...
if TYPE_CHECKING:
    import aws_sdk_devops_guru.types.performance_insights_stat_type
    import aws_sdk_devops_guru.types.performance_insights_value_double


class PerformanceInsightsStat(TypedDict):
    type: NotRequired[
        "aws_sdk_devops_guru.types.performance_insights_stat_type.PerformanceInsightsStatType"
    ]
