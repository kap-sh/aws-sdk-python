...
if TYPE_CHECKING:
    ...
    import aws_sdk_devops_guru.types.tag_values


class TagCollectionFilter(TypedDict):
    ...
    tag_values: "aws_sdk_devops_guru.types.tag_values.TagValues"
...
def serialize_json(value: TagCollectionFilter) -> dict:
    ...
    out["TagValues"] = aws_sdk_devops_guru.types.tag_values.serialize_json(
        value["tag_values"]
    )
    return out
...
def deserialize_json(data: dict) -> TagCollectionFilter:
    ...
    if "TagValues" in data:
        ...
        out["tag_values"] = aws_sdk_devops_guru.types.tag_values.deserialize_json(
            data["TagValues"]
        )
    else:
