"""Generated from Smithy shape ``com.amazonaws.devopsguru#DescribeAccountHealthResponse``."""
...
class DescribeAccountHealthResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeAccountHealthResponse) -> dict:
    out: dict = {}
