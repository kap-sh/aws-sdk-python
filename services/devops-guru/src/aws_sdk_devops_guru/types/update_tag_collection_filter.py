...
if TYPE_CHECKING:
    ...
    import aws_sdk_devops_guru.types.update_tag_values


class UpdateTagCollectionFilter(TypedDict):
    ...
    tag_values: "aws_sdk_devops_guru.types.update_tag_values.UpdateTagValues"
...
def serialize_json(value: UpdateTagCollectionFilter) -> dict:
    ...
    out["TagValues"] = aws_sdk_devops_guru.types.update_tag_values.serialize_json(
        value["tag_values"]
    )
    return out
...
def deserialize_json(data: dict) -> UpdateTagCollectionFilter:
    ...
    if "TagValues" in data:
        ...
        out["tag_values"] = (
            aws_sdk_devops_guru.types.update_tag_values.deserialize_json(
                data["TagValues"]
            )
        )
    else:
