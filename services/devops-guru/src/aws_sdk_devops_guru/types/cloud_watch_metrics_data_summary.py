...
class CloudWatchMetricsDataSummary(TypedDict, closed=True):
    ...
    status_code: NotRequired[
        "aws_sdk_devops_guru.types.cloud_watch_metric_data_status_code.CloudWatchMetricDataStatusCode"
    ]
...
def serialize_json(value: CloudWatchMetricsDataSummary) -> dict:
    ...
    if "timestamp_metric_value_pair_list" in value:
        ...
        out["TimestampMetricValuePairList"] = (
            aws_sdk_devops_guru.types.timestamp_metric_value_pair_list.serialize_json(
    ...
    if "status_code" in value:
        ...
        out["StatusCode"] = (
            aws_sdk_devops_guru.types.cloud_watch_metric_data_status_code.serialize_json(
                value["status_code"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> CloudWatchMetricsDataSummary:
    ...
    if "TimestampMetricValuePairList" in data:
        ...
        out["timestamp_metric_value_pair_list"] = (
            aws_sdk_devops_guru.types.timestamp_metric_value_pair_list.deserialize_json(
    ...
    if "StatusCode" in data:
        ...
        out["status_code"] = (
            aws_sdk_devops_guru.types.cloud_watch_metric_data_status_code.deserialize_json(
                data["StatusCode"]
            )
        )
    return out
