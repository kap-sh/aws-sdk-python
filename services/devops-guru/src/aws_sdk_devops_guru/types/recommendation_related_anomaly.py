...
if TYPE_CHECKING:
    ...
    import aws_sdk_devops_guru.types.recommendation_related_anomaly_resources
...
class RecommendationRelatedAnomaly(TypedDict, closed=True):
    ...
    source_details: NotRequired[
        "aws_sdk_devops_guru.types.related_anomaly_source_details.RelatedAnomalySourceDetails"
    ]
    ...
    anomaly_id: NotRequired["aws_sdk_devops_guru.types.anomaly_id.AnomalyId"]
...
def serialize_json(value: RecommendationRelatedAnomaly) -> dict:
    ...
    if "resources" in value:
        ...
        out["Resources"] = (
            aws_sdk_devops_guru.types.recommendation_related_anomaly_resources.serialize_json(
                value["resources"]
            )
        )
    if "source_details" in value:
        ...
        out["SourceDetails"] = (
            aws_sdk_devops_guru.types.related_anomaly_source_details.serialize_json(
...
def deserialize_json(data: dict) -> RecommendationRelatedAnomaly:
    ...
    if "Resources" in data:
        ...
        out["resources"] = (
            aws_sdk_devops_guru.types.recommendation_related_anomaly_resources.deserialize_json(
                data["Resources"]
            )
        )
    if "SourceDetails" in data:
        ...
        out["source_details"] = (
            aws_sdk_devops_guru.types.related_anomaly_source_details.deserialize_json(
                data["SourceDetails"]
            )
        )
