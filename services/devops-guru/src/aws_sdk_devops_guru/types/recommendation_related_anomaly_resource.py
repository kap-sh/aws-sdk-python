...
if TYPE_CHECKING:
    import aws_sdk_devops_guru.types.recommendation_related_anomaly_resource_name
    import aws_sdk_devops_guru.types.recommendation_related_anomaly_resource_type


class RecommendationRelatedAnomalyResource(TypedDict):
    name: NotRequired[
        "aws_sdk_devops_guru.types.recommendation_related_anomaly_resource_name.RecommendationRelatedAnomalyResourceName"
    ]
    """<p> The name of the resource. </p>"""
    type: NotRequired[
        "aws_sdk_devops_guru.types.recommendation_related_anomaly_resource_type.RecommendationRelatedAnomalyResourceType"
    ]
