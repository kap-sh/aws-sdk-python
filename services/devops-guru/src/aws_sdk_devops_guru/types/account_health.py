...
class AccountHealth(TypedDict):
    ...
    insight: NotRequired[
        "aws_sdk_devops_guru.types.account_insight_health.AccountInsightHealth"
    ]
...
def serialize_json(value: AccountHealth) -> dict:
    ...
    if "insight" in value:
        ...
        out["Insight"] = (
            aws_sdk_devops_guru.types.account_insight_health.serialize_json(
                value["insight"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> AccountHealth:
    ...
    if "Insight" in data:
        ...
        out["insight"] = (
            aws_sdk_devops_guru.types.account_insight_health.deserialize_json(
                data["Insight"]
            )
        )
    return out
