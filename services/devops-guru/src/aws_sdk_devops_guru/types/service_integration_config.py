...
if TYPE_CHECKING:
    import aws_sdk_devops_guru.types.kms_server_side_encryption_integration
    import aws_sdk_devops_guru.types.logs_anomaly_detection_integration
    import aws_sdk_devops_guru.types.ops_center_integration


class ServiceIntegrationConfig(TypedDict):
    ops_center: NotRequired[
        "aws_sdk_devops_guru.types.ops_center_integration.OpsCenterIntegration"
    ]
    ...
    logs_anomaly_detection: NotRequired[
        "aws_sdk_devops_guru.types.logs_anomaly_detection_integration.LogsAnomalyDetectionIntegration"
    ]
    ...
    kms_server_side_encryption: NotRequired[
        "aws_sdk_devops_guru.types.kms_server_side_encryption_integration.KMSServerSideEncryptionIntegration"
    ]
...
def serialize_json(value: ServiceIntegrationConfig) -> dict:
    ...
    if "ops_center" in value:
        ...
        out["OpsCenter"] = (
            aws_sdk_devops_guru.types.ops_center_integration.serialize_json(
                value["ops_center"]
            )
        )
    if "logs_anomaly_detection" in value:
        ...
        out["LogsAnomalyDetection"] = (
            aws_sdk_devops_guru.types.logs_anomaly_detection_integration.serialize_json(
    ...
    if "kms_server_side_encryption" in value:
        ...
        out["KMSServerSideEncryption"] = (
            aws_sdk_devops_guru.types.kms_server_side_encryption_integration.serialize_json(
...
def deserialize_json(data: dict) -> ServiceIntegrationConfig:
    ...
    if "OpsCenter" in data:
        ...
        out["ops_center"] = (
            aws_sdk_devops_guru.types.ops_center_integration.deserialize_json(
                data["OpsCenter"]
            )
        )
    if "LogsAnomalyDetection" in data:
        ...
        out["logs_anomaly_detection"] = (
            aws_sdk_devops_guru.types.logs_anomaly_detection_integration.deserialize_json(
    ...
    if "KMSServerSideEncryption" in data:
        ...
        out["kms_server_side_encryption"] = (
            aws_sdk_devops_guru.types.kms_server_side_encryption_integration.deserialize_json(
