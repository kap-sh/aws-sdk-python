...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.list_events_response.ListEventsResponse = (
        aws_sdk_devops_guru.types.list_events_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.list_events_request.ListEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.list_events_request.serialize_json(input_)
    ).encode()
...
def list_events(
    ...
    aws_sdk_devops_guru.types.list_events_response.ListEventsResponse, zapros.Response
]:
