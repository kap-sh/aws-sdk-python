"""Generated from Smithy shape ``com.amazonaws.devopsguru#DescribeAccountHealth``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.describe_account_health_response.DescribeAccountHealthResponse = aws_sdk_devops_guru.types.describe_account_health_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.describe_account_health_request.DescribeAccountHealthRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/health"
    params: dict[str, str] = {}
...
async def async_describe_account_health(
