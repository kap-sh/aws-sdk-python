...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.describe_organization_resource_collection_health_response.DescribeOrganizationResourceCollectionHealthResponse = aws_sdk_devops_guru.types.describe_organization_resource_collection_health_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.describe_organization_resource_collection_health_request.DescribeOrganizationResourceCollectionHealthRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.describe_organization_resource_collection_health_request.serialize_json(
            input_
        )
    ).encode()
