...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.list_monitored_resources_response.ListMonitoredResourcesResponse = aws_sdk_devops_guru.types.list_monitored_resources_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_devops_guru.types.list_monitored_resources_request.ListMonitoredResourcesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.list_monitored_resources_request.serialize_json(input)
    ).encode()
