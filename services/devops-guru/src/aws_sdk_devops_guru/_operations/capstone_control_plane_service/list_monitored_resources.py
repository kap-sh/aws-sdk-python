...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.list_monitored_resources_request.ListMonitoredResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.list_monitored_resources_request.serialize_json(
            input_
        )
    ).encode()
