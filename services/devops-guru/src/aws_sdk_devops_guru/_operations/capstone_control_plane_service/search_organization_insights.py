"""Generated from Smithy shape ``com.amazonaws.devopsguru#SearchOrganizationInsights``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.search_organization_insights_response.SearchOrganizationInsightsResponse = aws_sdk_devops_guru.types.search_organization_insights_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.search_organization_insights_request.SearchOrganizationInsightsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/organization/insights/search"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_devops_guru.types.search_organization_insights_request

    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.search_organization_insights_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_search_organization_insights(
