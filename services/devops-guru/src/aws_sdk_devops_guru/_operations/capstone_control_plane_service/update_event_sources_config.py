...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.update_event_sources_config_response.UpdateEventSourcesConfigResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.update_event_sources_config_request.UpdateEventSourcesConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.update_event_sources_config_request.serialize_json(
            input_
        )
    ).encode()
