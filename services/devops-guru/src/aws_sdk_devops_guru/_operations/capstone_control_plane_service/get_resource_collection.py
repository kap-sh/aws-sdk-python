...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.get_resource_collection_response.GetResourceCollectionResponse = aws_sdk_devops_guru.types.get_resource_collection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.get_resource_collection_request.GetResourceCollectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
