...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.list_organization_insights_response.ListOrganizationInsightsResponse = aws_sdk_devops_guru.types.list_organization_insights_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.list_organization_insights_request.ListOrganizationInsightsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.list_organization_insights_request.serialize_json(
            input_
        )
    ).encode()
