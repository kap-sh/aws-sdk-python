"""Generated from Smithy shape ``com.amazonaws.devopsguru#UpdateResourceCollection``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.update_resource_collection_response.UpdateResourceCollectionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.update_resource_collection_request.UpdateResourceCollectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_resource_collection(
