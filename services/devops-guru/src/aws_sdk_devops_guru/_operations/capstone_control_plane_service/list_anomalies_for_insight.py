...
def build_request(
    ...
    input: aws_sdk_devops_guru.types.list_anomalies_for_insight_request.ListAnomaliesForInsightRequest,
) -> zapros.Request:
    ...
    url = url.replace("{InsightId}", quote(str(input["insight_id"]), safe=""))
    params: dict[str, str] = {}
