...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.get_cost_estimation_response.GetCostEstimationResponse = aws_sdk_devops_guru.types.get_cost_estimation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.get_cost_estimation_request.GetCostEstimationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
