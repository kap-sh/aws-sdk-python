...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.list_anomalous_log_groups_response.ListAnomalousLogGroupsResponse = aws_sdk_devops_guru.types.list_anomalous_log_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.list_anomalous_log_groups_request.ListAnomalousLogGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.list_anomalous_log_groups_request.serialize_json(
            input_
        )
    ).encode()
