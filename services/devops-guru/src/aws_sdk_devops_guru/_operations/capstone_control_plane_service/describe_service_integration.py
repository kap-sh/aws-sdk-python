...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.describe_service_integration_response.DescribeServiceIntegrationResponse = aws_sdk_devops_guru.types.describe_service_integration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.describe_service_integration_request.DescribeServiceIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
