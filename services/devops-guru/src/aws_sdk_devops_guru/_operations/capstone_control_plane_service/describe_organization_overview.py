...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.describe_organization_overview_response.DescribeOrganizationOverviewResponse = aws_sdk_devops_guru.types.describe_organization_overview_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.describe_organization_overview_request.DescribeOrganizationOverviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.describe_organization_overview_request.serialize_json(
            input_
        )
    ).encode()
