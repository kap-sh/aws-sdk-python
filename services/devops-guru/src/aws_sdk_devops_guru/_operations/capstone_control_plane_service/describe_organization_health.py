...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.describe_organization_health_response.DescribeOrganizationHealthResponse = aws_sdk_devops_guru.types.describe_organization_health_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.describe_organization_health_request.DescribeOrganizationHealthRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.describe_organization_health_request.serialize_json(
            input_
        )
    ).encode()
