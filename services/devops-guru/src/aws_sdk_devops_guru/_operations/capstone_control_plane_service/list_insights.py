"""Generated from Smithy shape ``com.amazonaws.devopsguru#ListInsights``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.list_insights_response.ListInsightsResponse = (
        aws_sdk_devops_guru.types.list_insights_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.list_insights_request.ListInsightsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.list_insights_request.serialize_json(input_)
    ).encode()
