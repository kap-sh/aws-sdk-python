...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.list_notification_channels_response.ListNotificationChannelsResponse = aws_sdk_devops_guru.types.list_notification_channels_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.list_notification_channels_request.ListNotificationChannelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.list_notification_channels_request.serialize_json(
            input_
        )
    ).encode()
