...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.describe_anomaly_response.DescribeAnomalyResponse = (
        aws_sdk_devops_guru.types.describe_anomaly_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.describe_anomaly_request.DescribeAnomalyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
