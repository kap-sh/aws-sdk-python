"""Generated from Smithy shape ``com.amazonaws.devopsguru#DescribeResourceCollectionHealth``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.describe_resource_collection_health_response.DescribeResourceCollectionHealthResponse = aws_sdk_devops_guru.types.describe_resource_collection_health_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.describe_resource_collection_health_request.DescribeResourceCollectionHealthRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_resource_collection_health(
