...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.describe_account_overview_response.DescribeAccountOverviewResponse = aws_sdk_devops_guru.types.describe_account_overview_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.describe_account_overview_request.DescribeAccountOverviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.describe_account_overview_request.serialize_json(
            input_
        )
    ).encode()
