"""Generated from Smithy shape ``com.amazonaws.devopsguru#AddNotificationChannel``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_devops_guru.errors.conflict_exception

            raise aws_sdk_devops_guru.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ResourceNotFoundException":
            import aws_sdk_devops_guru.errors.resource_not_found_exception

            raise aws_sdk_devops_guru.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
        case "ServiceQuotaExceededException":
            import aws_sdk_devops_guru.errors.service_quota_exceeded_exception

            raise aws_sdk_devops_guru.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.add_notification_channel_response.AddNotificationChannelResponse = aws_sdk_devops_guru.types.add_notification_channel_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_devops_guru.types.add_notification_channel_request.AddNotificationChannelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.add_notification_channel_request.serialize_json(input)
    ).encode()
...
async def async_add_notification_channel(
