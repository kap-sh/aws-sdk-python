...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.delete_insight_response.DeleteInsightResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.delete_insight_request.DeleteInsightRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
