...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.start_cost_estimation_response.StartCostEstimationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_devops_guru.types.start_cost_estimation_request.StartCostEstimationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.start_cost_estimation_request.serialize_json(input)
    ).encode()
