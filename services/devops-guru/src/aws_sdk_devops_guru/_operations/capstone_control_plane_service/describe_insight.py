"""Generated from Smithy shape ``com.amazonaws.devopsguru#DescribeInsight``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.describe_insight_response.DescribeInsightResponse = (
        aws_sdk_devops_guru.types.describe_insight_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.describe_insight_request.DescribeInsightRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_insight(
