...
def build_request(
    ...
    input: aws_sdk_devops_guru.types.describe_feedback_request.DescribeFeedbackRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.describe_feedback_request.serialize_json(input)
    ).encode()
