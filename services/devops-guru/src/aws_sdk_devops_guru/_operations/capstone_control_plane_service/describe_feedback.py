...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.describe_feedback_response.DescribeFeedbackResponse = aws_sdk_devops_guru.types.describe_feedback_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.describe_feedback_request.DescribeFeedbackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.describe_feedback_request.serialize_json(input_)
    ).encode()
