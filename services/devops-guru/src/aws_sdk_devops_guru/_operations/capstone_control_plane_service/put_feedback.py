"""Generated from Smithy shape ``com.amazonaws.devopsguru#PutFeedback``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.put_feedback_response.PutFeedbackResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.put_feedback_request.PutFeedbackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_guru.types.put_feedback_request.serialize_json(input_)
    ).encode()
...
def put_feedback(
    ...
    aws_sdk_devops_guru.types.put_feedback_response.PutFeedbackResponse, zapros.Response
]:
