...
def handle_response(
    ...
    out: aws_sdk_devops_guru.types.remove_notification_channel_response.RemoveNotificationChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_devops_guru.types.remove_notification_channel_request.RemoveNotificationChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
