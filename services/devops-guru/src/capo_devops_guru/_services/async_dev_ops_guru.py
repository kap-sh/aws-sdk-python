...
from capo_devops_guru._services._aws_config import aaws_config
...
class AsyncDevOpsGuruClientConfig(TypedDict, total=False, closed=True):
...
class AsyncDevOpsGuruClient:
    ...
    def __init__(
        ...
        self._config = AsyncDevOpsGuruClientConfig(
            {
    ...
    def operation_options(
        ...
        overrides: AsyncDevOpsGuruClientConfig = config_overrides or {}
    ...
    async def add_notification_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.add_notification_channel_request.AddNotificationChannelRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.add_notification_channel_response.AddNotificationChannelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.add_notification_channel.async_add_notification_channel(
    ...
    async def delete_insight(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.delete_insight_request.DeleteInsightRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.delete_insight_response.DeleteInsightResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.delete_insight.async_delete_insight(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_health(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.describe_account_health_request.DescribeAccountHealthRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.describe_account_health_response.DescribeAccountHealthResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.describe_account_health.async_describe_account_health(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_overview(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.describe_account_overview_request.DescribeAccountOverviewRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.describe_account_overview_response.DescribeAccountOverviewResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.describe_account_overview.async_describe_account_overview(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_anomaly(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.describe_anomaly_request.DescribeAnomalyRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.describe_anomaly_response.DescribeAnomalyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.describe_anomaly.async_describe_anomaly(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_event_sources_config(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.describe_event_sources_config_request.DescribeEventSourcesConfigRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.describe_event_sources_config_response.DescribeEventSourcesConfigResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.describe_event_sources_config.async_describe_event_sources_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_feedback(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.describe_feedback_request.DescribeFeedbackRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.describe_feedback_response.DescribeFeedbackResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.describe_feedback.async_describe_feedback(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_insight(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.describe_insight_request.DescribeInsightRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.describe_insight_response.DescribeInsightResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.describe_insight.async_describe_insight(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_organization_health(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.describe_organization_health_request.DescribeOrganizationHealthRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.describe_organization_health_response.DescribeOrganizationHealthResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.describe_organization_health.async_describe_organization_health(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_organization_overview(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.describe_organization_overview_request.DescribeOrganizationOverviewRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.describe_organization_overview_response.DescribeOrganizationOverviewResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.describe_organization_overview.async_describe_organization_overview(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_organization_resource_collection_health(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.describe_organization_resource_collection_health_request.DescribeOrganizationResourceCollectionHealthRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.describe_organization_resource_collection_health_response.DescribeOrganizationResourceCollectionHealthResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.describe_organization_resource_collection_health.async_describe_organization_resource_collection_health(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_resource_collection_health(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.describe_resource_collection_health_request.DescribeResourceCollectionHealthRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.describe_resource_collection_health_response.DescribeResourceCollectionHealthResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.describe_resource_collection_health.async_describe_resource_collection_health(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_service_integration(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.describe_service_integration_request.DescribeServiceIntegrationRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.describe_service_integration_response.DescribeServiceIntegrationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.describe_service_integration.async_describe_service_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_cost_estimation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.get_cost_estimation_request.GetCostEstimationRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.get_cost_estimation_response.GetCostEstimationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.get_cost_estimation.async_get_cost_estimation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_collection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.get_resource_collection_request.GetResourceCollectionRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.get_resource_collection_response.GetResourceCollectionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.get_resource_collection.async_get_resource_collection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_anomalies_for_insight(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.list_anomalies_for_insight_request.ListAnomaliesForInsightRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.list_anomalies_for_insight_response.ListAnomaliesForInsightResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.list_anomalies_for_insight.async_list_anomalies_for_insight(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_anomalous_log_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.list_anomalous_log_groups_request.ListAnomalousLogGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.list_anomalous_log_groups_response.ListAnomalousLogGroupsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.list_anomalous_log_groups.async_list_anomalous_log_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.list_events_request.ListEventsRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.list_events_response.ListEventsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.list_events.async_list_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_devops_guru.types.event.Event]":
        _token = next_token
        while True:
            _response = await self.list_events(
                filters,
    ...
    async def list_insights(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.list_insights_request.ListInsightsRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.list_insights_response.ListInsightsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.list_insights.async_list_insights(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_monitored_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.list_monitored_resources_request.ListMonitoredResourcesRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.list_monitored_resources_response.ListMonitoredResourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.list_monitored_resources.async_list_monitored_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_notification_channels(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.list_notification_channels_request.ListNotificationChannelsRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.list_notification_channels_response.ListNotificationChannelsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.list_notification_channels.async_list_notification_channels(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_notification_channels(
        ...
        *,
        ...
        "AsyncIterator[capo_devops_guru.types.notification_channel.NotificationChannel]"
    ):
        _token = next_token
        while True:
            _response = await self.list_notification_channels(
                config_overrides=config_overrides,
                next_token=_token,
            )
    ...
    async def list_organization_insights(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.list_organization_insights_request.ListOrganizationInsightsRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.list_organization_insights_response.ListOrganizationInsightsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.list_organization_insights.async_list_organization_insights(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.list_recommendations_request.ListRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.list_recommendations_response.ListRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.list_recommendations.async_list_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_devops_guru.types.recommendation.Recommendation]":
        _token = next_token
        while True:
    ...
    async def put_feedback(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.put_feedback_request.PutFeedbackRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.put_feedback_response.PutFeedbackResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.put_feedback.async_put_feedback(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_notification_channel(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.remove_notification_channel_request.RemoveNotificationChannelRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.remove_notification_channel_response.RemoveNotificationChannelResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.remove_notification_channel.async_remove_notification_channel(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_insights(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.search_insights_request.SearchInsightsRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.search_insights_response.SearchInsightsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.search_insights.async_search_insights(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_organization_insights(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.search_organization_insights_request.SearchOrganizationInsightsRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.search_organization_insights_response.SearchOrganizationInsightsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.search_organization_insights.async_search_organization_insights(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_cost_estimation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.start_cost_estimation_request.StartCostEstimationRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.start_cost_estimation_response.StartCostEstimationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.start_cost_estimation.async_start_cost_estimation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_event_sources_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.update_event_sources_config_request.UpdateEventSourcesConfigRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.update_event_sources_config_response.UpdateEventSourcesConfigResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.update_event_sources_config.async_update_event_sources_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_resource_collection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.update_resource_collection_request.UpdateResourceCollectionRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.update_resource_collection_response.UpdateResourceCollectionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.update_resource_collection.async_update_resource_collection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_service_integration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_devops_guru.types.update_service_integration_request.UpdateServiceIntegrationRequest]",
        ) -> AsyncOperationResponse[
            "capo_devops_guru.types.update_service_integration_response.UpdateServiceIntegrationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_devops_guru._operations.capstone_control_plane_service.update_service_integration.async_update_service_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
