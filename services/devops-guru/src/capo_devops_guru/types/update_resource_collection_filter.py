...
class UpdateResourceCollectionFilter(TypedDict, closed=True):
    cloud_formation: NotRequired[
        "capo_devops_guru.types.update_cloud_formation_collection_filter.UpdateCloudFormationCollectionFilter"
    ]
    ...
    tags: NotRequired[
        "capo_devops_guru.types.update_tag_collection_filters.UpdateTagCollectionFilters"
    ]
...
def serialize_json(value: UpdateResourceCollectionFilter) -> dict:
    ...
    if "cloud_formation" in value:
        ...
        out["CloudFormation"] = (
            capo_devops_guru.types.update_cloud_formation_collection_filter.serialize_json(
    ...
    if "tags" in value:
        ...
        out["Tags"] = (
            capo_devops_guru.types.update_tag_collection_filters.serialize_json(
                value["tags"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> UpdateResourceCollectionFilter:
    ...
    if "CloudFormation" in data:
        ...
        out["cloud_formation"] = (
            capo_devops_guru.types.update_cloud_formation_collection_filter.deserialize_json(
                data["CloudFormation"]
            )
        )
    if "Tags" in data:
        ...
        out["tags"] = (
            capo_devops_guru.types.update_tag_collection_filters.deserialize_json(
                data["Tags"]
            )
        )
    return out
