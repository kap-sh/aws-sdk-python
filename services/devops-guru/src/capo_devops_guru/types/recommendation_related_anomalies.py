...
if TYPE_CHECKING:
    import capo_devops_guru.types.recommendation_related_anomaly

RecommendationRelatedAnomalies: TypeAlias = list[
    "capo_devops_guru.types.recommendation_related_anomaly.RecommendationRelatedAnomaly"
]
...
def serialize_json(value: RecommendationRelatedAnomalies) -> list:
    ...
    for item in value:
        out.append(
            capo_devops_guru.types.recommendation_related_anomaly.serialize_json(item)
        )
    return out
