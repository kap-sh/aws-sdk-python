...
class DescribeOrganizationResourceCollectionHealthResponse(TypedDict, closed=True):
    cloud_formation: NotRequired[
        "capo_devops_guru.types.cloud_formation_healths.CloudFormationHealths"
    ]
    ...
    service: NotRequired["capo_devops_guru.types.service_healths.ServiceHealths"]
    ...
    account: NotRequired["capo_devops_guru.types.account_healths.AccountHealths"]
    ...
    tags: NotRequired["capo_devops_guru.types.tag_healths.TagHealths"]
...
def serialize_json(value: DescribeOrganizationResourceCollectionHealthResponse) -> dict:
    ...
    if "cloud_formation" in value:
        ...
        out["CloudFormation"] = (
            capo_devops_guru.types.cloud_formation_healths.serialize_json(
    ...
    if "service" in value:
        ...
        out["Service"] = capo_devops_guru.types.service_healths.serialize_json(
            value["service"]
        )
    if "account" in value:
        import capo_devops_guru.types.account_healths

        out["Account"] = capo_devops_guru.types.account_healths.serialize_json(
            value["account"]
        )
    ...
    if "tags" in value:
        ...
        out["Tags"] = capo_devops_guru.types.tag_healths.serialize_json(value["tags"])
    return out
...
def deserialize_json(
    ...
    if "CloudFormation" in data:
        ...
        out["cloud_formation"] = (
            capo_devops_guru.types.cloud_formation_healths.deserialize_json(
                data["CloudFormation"]
            )
        )
    if "Service" in data:
