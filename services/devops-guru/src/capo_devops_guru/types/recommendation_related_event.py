...
if TYPE_CHECKING:
    import capo_devops_guru.types.recommendation_related_event_name
...
class RecommendationRelatedEvent(TypedDict, closed=True):
    name: NotRequired[
        "capo_devops_guru.types.recommendation_related_event_name.RecommendationRelatedEventName"
    ]
    """<p> The name of the event. This corresponds to the <code>Name</code> field in an <code>Event</code> object. </p>"""
    resources: NotRequired[
        "capo_devops_guru.types.recommendation_related_event_resources.RecommendationRelatedEventResources"
    ]
...
def serialize_json(value: RecommendationRelatedEvent) -> dict:
    ...
    if "resources" in value:
        ...
        out["Resources"] = (
            capo_devops_guru.types.recommendation_related_event_resources.serialize_json(
                value["resources"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> RecommendationRelatedEvent:
    ...
    if "Resources" in data:
        ...
        out["resources"] = (
            capo_devops_guru.types.recommendation_related_event_resources.deserialize_json(
                data["Resources"]
            )
        )
    return out
