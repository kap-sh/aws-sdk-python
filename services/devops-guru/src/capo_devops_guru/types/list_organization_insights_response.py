...
if TYPE_CHECKING:
    import capo_devops_guru.types.proactive_organization_insights
    import capo_devops_guru.types.reactive_organization_insights
...
class ListOrganizationInsightsResponse(TypedDict, closed=True):
    proactive_insights: NotRequired[
        "capo_devops_guru.types.proactive_organization_insights.ProactiveOrganizationInsights"
    ]
    ...
    reactive_insights: NotRequired[
        "capo_devops_guru.types.reactive_organization_insights.ReactiveOrganizationInsights"
    ]
...
def serialize_json(value: ListOrganizationInsightsResponse) -> dict:
    ...
    if "proactive_insights" in value:
        ...
        out["ProactiveInsights"] = (
            capo_devops_guru.types.proactive_organization_insights.serialize_json(
    ...
    if "reactive_insights" in value:
        ...
        out["ReactiveInsights"] = (
            capo_devops_guru.types.reactive_organization_insights.serialize_json(
...
def deserialize_json(data: dict) -> ListOrganizationInsightsResponse:
    ...
    if "ProactiveInsights" in data:
        ...
        out["proactive_insights"] = (
            capo_devops_guru.types.proactive_organization_insights.deserialize_json(
    ...
    if "ReactiveInsights" in data:
        ...
        out["reactive_insights"] = (
            capo_devops_guru.types.reactive_organization_insights.deserialize_json(
