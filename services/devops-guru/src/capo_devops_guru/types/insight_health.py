...
class InsightHealth(TypedDict, closed=True):
    ...
    mean_time_to_recover_in_milliseconds: NotRequired[
        "capo_devops_guru.types.mean_time_to_recover_in_milliseconds.MeanTimeToRecoverInMilliseconds"
    ]
