"""Generated from Smithy shape ``com.amazonaws.mediastoredata#DeleteObject``."""
...
def handle_response(
    ...
    out: capo_mediastore_data.types.delete_object_response.DeleteObjectResponse = {}  # type: ignore[typeddict-item]
    return out
