...
class MediaStoreDataError(Exception):
    """Base class for all MediaStoreData service errors."""


class ServiceError(MediaStoreDataError):
...
class SerializationError(MediaStoreDataError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MediaStoreDataError):
...
class WaiterFailedError(MediaStoreDataError):
...
class WaiterTimeoutError(MediaStoreDataError):
