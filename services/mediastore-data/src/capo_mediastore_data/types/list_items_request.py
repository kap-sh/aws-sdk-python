...
class ListItemsRequest(TypedDict, closed=True):
    path: NotRequired["capo_mediastore_data.types.list_path_naming.ListPathNaming"]
    """<p>The path in the container from which to retrieve items. Format: <folder name>/<folder name>/<file name></p>"""
    max_results: NotRequired["capo_mediastore_data.types.list_limit.ListLimit"]
