"""Generated from Smithy shape ``com.amazonaws.mediastoredata#GetObjectRequest``."""
...
class GetObjectRequest(TypedDict, closed=True):
    ...
    range: NotRequired["capo_mediastore_data.types.range_pattern.RangePattern"]
    r"""<p>The range bytes of an object to retrieve. For more information about the <code>Range</code> header, see <a href=\"http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.35\">http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.35</a>. AWS Elemental MediaStore ignores this header for partially uploaded objects that have streaming upload availability.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: GetObjectRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetObjectRequest:
