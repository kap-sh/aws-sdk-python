...
def handle_response(
    ...
    out: aws_sdk_mediastore_data.types.list_items_response.ListItemsResponse = (
        aws_sdk_mediastore_data.types.list_items_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediastore_data.types.list_items_request.ListItemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_items(
    ...
    aws_sdk_mediastore_data.types.list_items_response.ListItemsResponse, zapros.Response
]:
