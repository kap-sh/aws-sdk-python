...
def handle_response(
    ...
    out: aws_sdk_mediastore_data.types.put_object_response.PutObjectResponse = (
        aws_sdk_mediastore_data.types.put_object_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediastore_data.types.put_object_request.PutObjectRequest,
) -> zapros.Request:
    ...
    if "upload_availability" in input:
        headers["x-amz-upload-availability"] = str(input["upload_availability"])
    body = input["body"]
...
def put_object(
    ...
    aws_sdk_mediastore_data.types.put_object_response.PutObjectResponse, zapros.Response
]:
