...
def handle_response(
    ...
    out: aws_sdk_mediastore_data.types.delete_object_response.DeleteObjectResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mediastore_data.types.delete_object_request.DeleteObjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
