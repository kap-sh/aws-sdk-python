...
RecommendedActions: TypeAlias = list[
    "aws_sdk_bcm_recommended_actions.types.recommended_action.RecommendedAction"
]
...
def serialize_aws_json_1_0(value: RecommendedActions) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_bcm_recommended_actions.types.recommended_action.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> RecommendedActions:
    ...
    for item in data:
        out.append(
            aws_sdk_bcm_recommended_actions.types.recommended_action.deserialize_aws_json_1_0(
                item
            )
        )
    return out
