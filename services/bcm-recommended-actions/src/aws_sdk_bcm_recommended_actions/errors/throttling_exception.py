"""Generated from Smithy shape ``com.amazonaws.bcmrecommendedactions#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bcmrecommendedactions#ThrottlingException``."""
