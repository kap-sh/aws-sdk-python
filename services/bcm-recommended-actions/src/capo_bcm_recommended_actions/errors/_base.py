...
class BCMRecommendedActionsError(Exception):
    """Base class for all BCMRecommendedActions service errors."""


class ServiceError(BCMRecommendedActionsError):
...
class SerializationError(BCMRecommendedActionsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(BCMRecommendedActionsError):
...
class WaiterFailedError(BCMRecommendedActionsError):
...
class WaiterTimeoutError(BCMRecommendedActionsError):
