...
```
pip install capo-bcm-recommended-actions
```

## Usage

```python
from capo_bcm_recommended_actions import AsyncBCMRecommendedActionsClient
...
```python
from capo_bcm_recommended_actions import AsyncBCMRecommendedActionsClient
from capo_bcm_recommended_actions.error import AccessDeniedException
