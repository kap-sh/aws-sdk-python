import pytest
from capo_bcm_recommended_actions._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_bcm_recommended_actions._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
