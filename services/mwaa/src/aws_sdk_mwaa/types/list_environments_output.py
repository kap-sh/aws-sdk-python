...
def serialize_json(value: ListEnvironmentsOutput) -> dict:
    out: dict = {}
    import aws_sdk_mwaa.types.environment_list
    out["Environments"] = aws_sdk_mwaa.types.environment_list.serialize_json(value["environments"])
...
def deserialize_json(data: dict) -> ListEnvironmentsOutput:
    ...
    if "Environments" in data:
        import aws_sdk_mwaa.types.environment_list
        out["environments"] = aws_sdk_mwaa.types.environment_list.deserialize_json(data["Environments"])
    else:
