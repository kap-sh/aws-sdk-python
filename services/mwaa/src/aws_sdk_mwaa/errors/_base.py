...
class MWAAError(Exception):
    """Base class for all MWAA service errors."""

class ServiceError(MWAAError):
...
class SerializationError(MWAAError):
    """Raised when a value cannot be serialized."""

class DeserializationError(MWAAError):
...
class WaiterFailedError(MWAAError):
...
class WaiterTimeoutError(MWAAError):
