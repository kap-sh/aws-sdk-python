"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListSessionAnalyticsData``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_session_analytics_data_response.ListSessionAnalyticsDataResponse = aws_sdk_lex_models_v2.types.list_session_analytics_data_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_session_analytics_data_request.ListSessionAnalyticsDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/bots/{botId}/analytics/sessions"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_session_analytics_data_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_session_analytics_data(
