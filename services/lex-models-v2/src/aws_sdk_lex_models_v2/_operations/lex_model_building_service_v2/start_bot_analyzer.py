...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.start_bot_analyzer_request.StartBotAnalyzerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.start_bot_analyzer_request.serialize_json(input)
    ).encode()
