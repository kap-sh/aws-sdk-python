...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.start_bot_analyzer_response.StartBotAnalyzerResponse = aws_sdk_lex_models_v2.types.start_bot_analyzer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.start_bot_analyzer_request.StartBotAnalyzerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.start_bot_analyzer_request.serialize_json(input_)
    ).encode()
