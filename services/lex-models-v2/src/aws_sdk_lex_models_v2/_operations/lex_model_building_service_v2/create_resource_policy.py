...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.create_resource_policy_request.CreateResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.create_resource_policy_request.serialize_json(
            input_
        )
    ).encode()
