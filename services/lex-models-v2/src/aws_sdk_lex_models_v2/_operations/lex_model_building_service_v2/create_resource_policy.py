"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#CreateResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.create_resource_policy_response.CreateResourcePolicyResponse = aws_sdk_lex_models_v2.types.create_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.create_resource_policy_request.CreateResourcePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.create_resource_policy_request.serialize_json(input)
    ).encode()
...
async def async_create_resource_policy(
