...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.update_test_set_request.UpdateTestSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.update_test_set_request.serialize_json(input)
    ).encode()
