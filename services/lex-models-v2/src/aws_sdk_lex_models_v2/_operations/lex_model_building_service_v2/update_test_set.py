...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.update_test_set_response.UpdateTestSetResponse = (
        aws_sdk_lex_models_v2.types.update_test_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.update_test_set_request.UpdateTestSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.update_test_set_request.serialize_json(input_)
    ).encode()
