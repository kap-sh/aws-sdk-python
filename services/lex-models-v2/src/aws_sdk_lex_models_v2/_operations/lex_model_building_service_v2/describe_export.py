...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_export_response.DescribeExportResponse = (
        aws_sdk_lex_models_v2.types.describe_export_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_export_request.DescribeExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
