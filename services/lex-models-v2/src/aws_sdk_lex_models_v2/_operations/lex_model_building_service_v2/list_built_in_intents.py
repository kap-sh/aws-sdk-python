...
import aws_sdk_lex_models_v2.types.built_in_intent_summary_list
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_built_in_intents_response.ListBuiltInIntentsResponse = aws_sdk_lex_models_v2.types.list_built_in_intents_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_built_in_intents_request.ListBuiltInIntentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_built_in_intents_request.serialize_json(input_)
    ).encode()
