...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.list_built_in_intents_request.ListBuiltInIntentsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_built_in_intents_request.serialize_json(input)
    ).encode()
