...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.create_slot_response.CreateSlotResponse = (
        aws_sdk_lex_models_v2.types.create_slot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.create_slot_request.CreateSlotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.create_slot_request.serialize_json(input_)
    ).encode()
...
def create_slot(
    ...
    aws_sdk_lex_models_v2.types.create_slot_response.CreateSlotResponse, zapros.Response
]:
