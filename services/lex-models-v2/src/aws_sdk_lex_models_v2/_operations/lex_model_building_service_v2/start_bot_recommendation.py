...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.start_bot_recommendation_response.StartBotRecommendationResponse = aws_sdk_lex_models_v2.types.start_bot_recommendation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.start_bot_recommendation_request.StartBotRecommendationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
