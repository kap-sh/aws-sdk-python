...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_bot_aliases_response.ListBotAliasesResponse = aws_sdk_lex_models_v2.types.list_bot_aliases_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_bot_aliases_request.ListBotAliasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_bot_aliases_request.serialize_json(input_)
    ).encode()
