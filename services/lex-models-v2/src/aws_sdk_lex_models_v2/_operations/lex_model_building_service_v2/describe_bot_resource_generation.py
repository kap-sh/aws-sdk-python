...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_bot_resource_generation_response.DescribeBotResourceGenerationResponse = aws_sdk_lex_models_v2.types.describe_bot_resource_generation_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.describe_bot_resource_generation_request.DescribeBotResourceGenerationRequest,
) -> zapros.Request:
    ...
    url = url.replace("{generationId}", quote(str(input["generation_id"]), safe=""))
    params: dict[str, str] = {}
