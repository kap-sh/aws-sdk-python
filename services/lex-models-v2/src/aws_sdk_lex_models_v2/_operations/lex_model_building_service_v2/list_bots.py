"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListBots``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_bots_response.ListBotsResponse = (
        aws_sdk_lex_models_v2.types.list_bots_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_bots_request.ListBotsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/bots"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_lex_models_v2.types.list_bots_request

    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_bots_request.serialize_json(input_)
    ).encode()
...
def list_bots(
    ...
    aws_sdk_lex_models_v2.types.list_bots_response.ListBotsResponse, zapros.Response
]:
