"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DeleteCustomVocabulary``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.delete_custom_vocabulary_response.DeleteCustomVocabularyResponse = aws_sdk_lex_models_v2.types.delete_custom_vocabulary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.delete_custom_vocabulary_request.DeleteCustomVocabularyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_custom_vocabulary(
