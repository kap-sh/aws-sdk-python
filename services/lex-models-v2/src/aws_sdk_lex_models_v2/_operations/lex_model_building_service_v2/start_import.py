"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#StartImport``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.start_import_response.StartImportResponse = (
        aws_sdk_lex_models_v2.types.start_import_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.start_import_request.StartImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/imports"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_lex_models_v2.types.start_import_request

    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.start_import_request.serialize_json(input_)
    ).encode()
