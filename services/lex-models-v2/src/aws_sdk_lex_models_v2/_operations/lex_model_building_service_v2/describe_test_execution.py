"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeTestExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_test_execution_response.DescribeTestExecutionResponse = aws_sdk_lex_models_v2.types.describe_test_execution_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_test_execution_request.DescribeTestExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/testexecutions/{testExecutionId}"
    url = url.replace(
...
async def async_describe_test_execution(
