"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#CreateTestSetDiscrepancyReport``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.create_test_set_discrepancy_report_response.CreateTestSetDiscrepancyReportResponse = aws_sdk_lex_models_v2.types.create_test_set_discrepancy_report_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.create_test_set_discrepancy_report_request.CreateTestSetDiscrepancyReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/testsets/{testSetId}/testsetdiscrepancy"
...
async def async_create_test_set_discrepancy_report(
