"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#UpdateResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.update_resource_policy_response.UpdateResourcePolicyResponse = aws_sdk_lex_models_v2.types.update_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.update_resource_policy_request.UpdateResourcePolicyRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/policy/{resourceArn}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.update_resource_policy_request.serialize_json(input)
    ).encode()
...
async def async_update_resource_policy(
