"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#BatchDeleteCustomVocabularyItem``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.batch_delete_custom_vocabulary_item_response.BatchDeleteCustomVocabularyItemResponse = aws_sdk_lex_models_v2.types.batch_delete_custom_vocabulary_item_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.batch_delete_custom_vocabulary_item_request.BatchDeleteCustomVocabularyItemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.batch_delete_custom_vocabulary_item_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_delete_custom_vocabulary_item(
