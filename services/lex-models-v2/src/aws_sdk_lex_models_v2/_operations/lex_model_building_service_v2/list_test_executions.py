...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.list_test_executions_request.ListTestExecutionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_test_executions_request.serialize_json(input)
    ).encode()
