...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_test_executions_response.ListTestExecutionsResponse = aws_sdk_lex_models_v2.types.list_test_executions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_test_executions_request.ListTestExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_test_executions_request.serialize_json(input_)
    ).encode()
