...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.update_bot_alias_response.UpdateBotAliasResponse = aws_sdk_lex_models_v2.types.update_bot_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.update_bot_alias_request.UpdateBotAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.update_bot_alias_request.serialize_json(input_)
    ).encode()
