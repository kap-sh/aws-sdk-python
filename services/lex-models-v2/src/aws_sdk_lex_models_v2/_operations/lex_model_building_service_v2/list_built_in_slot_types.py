...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_built_in_slot_types_response.ListBuiltInSlotTypesResponse = aws_sdk_lex_models_v2.types.list_built_in_slot_types_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_built_in_slot_types_request.ListBuiltInSlotTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_built_in_slot_types_request.serialize_json(
            input_
        )
    ).encode()
