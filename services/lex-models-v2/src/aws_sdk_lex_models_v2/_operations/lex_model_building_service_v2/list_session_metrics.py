"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListSessionMetrics``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_session_metrics_response.ListSessionMetricsResponse = aws_sdk_lex_models_v2.types.list_session_metrics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_session_metrics_request.ListSessionMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/bots/{botId}/analytics/sessionmetrics"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_session_metrics_request.serialize_json(input_)
    ).encode()
...
async def async_list_session_metrics(
