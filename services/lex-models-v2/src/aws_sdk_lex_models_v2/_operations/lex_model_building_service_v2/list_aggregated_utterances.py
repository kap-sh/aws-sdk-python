...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_aggregated_utterances_response.ListAggregatedUtterancesResponse = aws_sdk_lex_models_v2.types.list_aggregated_utterances_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_aggregated_utterances_request.ListAggregatedUtterancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_aggregated_utterances_request.serialize_json(
            input_
        )
    ).encode()
