...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.get_test_execution_artifacts_url_request.GetTestExecutionArtifactsUrlRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{testExecutionId}", quote(str(input["test_execution_id"]), safe="")
    )
    params: dict[str, str] = {}
