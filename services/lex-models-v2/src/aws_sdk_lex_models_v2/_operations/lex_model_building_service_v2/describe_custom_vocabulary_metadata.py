...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_custom_vocabulary_metadata_response.DescribeCustomVocabularyMetadataResponse = aws_sdk_lex_models_v2.types.describe_custom_vocabulary_metadata_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_custom_vocabulary_metadata_request.DescribeCustomVocabularyMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
