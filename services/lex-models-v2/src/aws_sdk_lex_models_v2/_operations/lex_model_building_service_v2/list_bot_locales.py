"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListBotLocales``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_bot_locales_response.ListBotLocalesResponse = aws_sdk_lex_models_v2.types.list_bot_locales_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_bot_locales_request.ListBotLocalesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_bot_locales_request.serialize_json(input_)
    ).encode()
...
async def async_list_bot_locales(
