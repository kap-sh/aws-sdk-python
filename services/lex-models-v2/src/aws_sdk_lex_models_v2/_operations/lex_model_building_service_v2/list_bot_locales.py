...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.list_bot_locales_request.ListBotLocalesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_bot_locales_request.serialize_json(input)
    ).encode()
