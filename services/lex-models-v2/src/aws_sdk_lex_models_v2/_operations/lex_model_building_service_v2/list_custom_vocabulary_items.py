...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_custom_vocabulary_items_response.ListCustomVocabularyItemsResponse = aws_sdk_lex_models_v2.types.list_custom_vocabulary_items_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_custom_vocabulary_items_request.ListCustomVocabularyItemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_custom_vocabulary_items_request.serialize_json(
            input_
        )
    ).encode()
