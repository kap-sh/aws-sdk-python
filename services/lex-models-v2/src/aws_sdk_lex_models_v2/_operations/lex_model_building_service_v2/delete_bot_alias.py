"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DeleteBotAlias``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.delete_bot_alias_response.DeleteBotAliasResponse = aws_sdk_lex_models_v2.types.delete_bot_alias_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.delete_bot_alias_request.DeleteBotAliasRequest,
) -> zapros.Request:
...
async def async_delete_bot_alias(
