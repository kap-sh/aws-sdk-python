...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_slot_response.DescribeSlotResponse = (
        aws_sdk_lex_models_v2.types.describe_slot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_slot_request.DescribeSlotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
