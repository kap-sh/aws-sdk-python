"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeTestSet``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_test_set_response.DescribeTestSetResponse = aws_sdk_lex_models_v2.types.describe_test_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_test_set_request.DescribeTestSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_test_set(
