"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListBotAnalyzerHistory``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_bot_analyzer_history_response.ListBotAnalyzerHistoryResponse = aws_sdk_lex_models_v2.types.list_bot_analyzer_history_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_bot_analyzer_history_request.ListBotAnalyzerHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/bots/{botId}/botanalyzer/history"
...
async def async_list_bot_analyzer_history(
