"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DeleteBotReplica``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.delete_bot_replica_response.DeleteBotReplicaResponse = aws_sdk_lex_models_v2.types.delete_bot_replica_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.delete_bot_replica_request.DeleteBotReplicaRequest,
) -> zapros.Request:
...
async def async_delete_bot_replica(
