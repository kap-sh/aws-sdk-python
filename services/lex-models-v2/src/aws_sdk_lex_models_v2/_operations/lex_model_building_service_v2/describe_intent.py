"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeIntent``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_intent_response.DescribeIntentResponse = (
        aws_sdk_lex_models_v2.types.describe_intent_response.deserialize_json(
