...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.delete_bot_response.DeleteBotResponse = (
        aws_sdk_lex_models_v2.types.delete_bot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.delete_bot_request.DeleteBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_bot(
    ...
    aws_sdk_lex_models_v2.types.delete_bot_response.DeleteBotResponse, zapros.Response
]:
