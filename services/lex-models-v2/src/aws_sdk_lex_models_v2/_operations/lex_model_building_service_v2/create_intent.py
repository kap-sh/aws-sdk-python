...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.create_intent_response.CreateIntentResponse = (
        aws_sdk_lex_models_v2.types.create_intent_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.create_intent_request.CreateIntentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.create_intent_request.serialize_json(input_)
    ).encode()
