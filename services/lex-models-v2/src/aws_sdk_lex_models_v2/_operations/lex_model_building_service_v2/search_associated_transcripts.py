"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#SearchAssociatedTranscripts``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.search_associated_transcripts_response.SearchAssociatedTranscriptsResponse = aws_sdk_lex_models_v2.types.search_associated_transcripts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.search_associated_transcripts_request.SearchAssociatedTranscriptsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{botRecommendationId}", quote(str(input_["bot_recommendation_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.search_associated_transcripts_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_search_associated_transcripts(
