...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.search_associated_transcripts_request.SearchAssociatedTranscriptsRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{botRecommendationId}", quote(str(input["bot_recommendation_id"]), safe="")
    )
    params: dict[str, str] = {}
