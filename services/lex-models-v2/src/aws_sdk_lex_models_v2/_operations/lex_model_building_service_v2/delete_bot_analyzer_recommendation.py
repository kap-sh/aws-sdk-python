...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.delete_bot_analyzer_recommendation_request.DeleteBotAnalyzerRecommendationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{botAnalyzerRequestId}", quote(str(input["bot_analyzer_request_id"]), safe="")
    )
    params: dict[str, str] = {}
