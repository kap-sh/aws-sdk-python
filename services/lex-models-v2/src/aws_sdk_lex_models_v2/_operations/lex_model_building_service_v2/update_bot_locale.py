...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.update_bot_locale_request.UpdateBotLocaleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.update_bot_locale_request.serialize_json(input)
    ).encode()
