...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.describe_test_set_generation_request.DescribeTestSetGenerationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{testSetGenerationId}", quote(str(input["test_set_generation_id"]), safe="")
    )
    params: dict[str, str] = {}
