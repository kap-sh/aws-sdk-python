"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeTestSetGeneration``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_test_set_generation_response.DescribeTestSetGenerationResponse = aws_sdk_lex_models_v2.types.describe_test_set_generation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_test_set_generation_request.DescribeTestSetGenerationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/testsetgenerations/{testSetGenerationId}"
    url = url.replace(
        "{testSetGenerationId}", quote(str(input_["test_set_generation_id"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_describe_test_set_generation(
