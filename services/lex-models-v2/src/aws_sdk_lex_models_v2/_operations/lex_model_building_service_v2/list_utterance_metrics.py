"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListUtteranceMetrics``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_utterance_metrics_response.ListUtteranceMetricsResponse = aws_sdk_lex_models_v2.types.list_utterance_metrics_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.list_utterance_metrics_request.ListUtteranceMetricsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/bots/{botId}/analytics/utterancemetrics"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_utterance_metrics_request.serialize_json(input)
    ).encode()
...
async def async_list_utterance_metrics(
