...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_utterance_metrics_request.ListUtteranceMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_utterance_metrics_request.serialize_json(
            input_
        )
    ).encode()
