"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListBotResourceGenerations``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_bot_resource_generations_response.ListBotResourceGenerationsResponse = aws_sdk_lex_models_v2.types.list_bot_resource_generations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_bot_resource_generations_request.ListBotResourceGenerationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_bot_resource_generations_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_bot_resource_generations(
