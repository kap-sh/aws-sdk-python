"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#GenerateBotElement``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.generate_bot_element_response.GenerateBotElementResponse = aws_sdk_lex_models_v2.types.generate_bot_element_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.generate_bot_element_request.GenerateBotElementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.generate_bot_element_request.serialize_json(input_)
    ).encode()
...
async def async_generate_bot_element(
