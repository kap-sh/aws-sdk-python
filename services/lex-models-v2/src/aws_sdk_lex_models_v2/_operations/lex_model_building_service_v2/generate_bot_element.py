...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.generate_bot_element_request.GenerateBotElementRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.generate_bot_element_request.serialize_json(input)
    ).encode()
