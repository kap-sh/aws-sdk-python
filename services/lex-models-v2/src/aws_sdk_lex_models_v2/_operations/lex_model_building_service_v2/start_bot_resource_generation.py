...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.start_bot_resource_generation_response.StartBotResourceGenerationResponse = aws_sdk_lex_models_v2.types.start_bot_resource_generation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.start_bot_resource_generation_request.StartBotResourceGenerationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.start_bot_resource_generation_request.serialize_json(
            input_
        )
    ).encode()
