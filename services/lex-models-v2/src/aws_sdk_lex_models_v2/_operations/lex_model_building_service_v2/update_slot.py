...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.update_slot_request.UpdateSlotRequest,
) -> zapros.Request:
    ...
    url = url.replace("{slotId}", quote(str(input["slot_id"]), safe=""))
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.update_slot_request.serialize_json(input)
    ).encode()
