"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#UpdateSlot``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.update_slot_response.UpdateSlotResponse = (
        aws_sdk_lex_models_v2.types.update_slot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.update_slot_request.UpdateSlotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{slotId}", quote(str(input_["slot_id"]), safe=""))
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.update_slot_request.serialize_json(input_)
    ).encode()
...
def update_slot(
    ...
    aws_sdk_lex_models_v2.types.update_slot_response.UpdateSlotResponse, zapros.Response
]:
