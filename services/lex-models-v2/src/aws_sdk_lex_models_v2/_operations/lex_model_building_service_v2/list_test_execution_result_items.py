...
import aws_sdk_lex_models_v2.types.test_execution_result_items
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_test_execution_result_items_response.ListTestExecutionResultItemsResponse = aws_sdk_lex_models_v2.types.list_test_execution_result_items_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_test_execution_result_items_request.ListTestExecutionResultItemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
