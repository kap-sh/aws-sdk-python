"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListBotReplicas``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_bot_replicas_response.ListBotReplicasResponse = aws_sdk_lex_models_v2.types.list_bot_replicas_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_bot_replicas_request.ListBotReplicasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_bot_replicas(
