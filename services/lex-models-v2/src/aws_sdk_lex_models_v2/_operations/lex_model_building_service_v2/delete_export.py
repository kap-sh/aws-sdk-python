...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.delete_export_response.DeleteExportResponse = (
        aws_sdk_lex_models_v2.types.delete_export_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.delete_export_request.DeleteExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
