...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.create_export_response.CreateExportResponse = (
        aws_sdk_lex_models_v2.types.create_export_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.create_export_request.CreateExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.create_export_request.serialize_json(input_)
    ).encode()
