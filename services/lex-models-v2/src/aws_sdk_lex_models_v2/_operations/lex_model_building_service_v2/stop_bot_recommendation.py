"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#StopBotRecommendation``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.stop_bot_recommendation_response.StopBotRecommendationResponse = aws_sdk_lex_models_v2.types.stop_bot_recommendation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.stop_bot_recommendation_request.StopBotRecommendationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_stop_bot_recommendation(
