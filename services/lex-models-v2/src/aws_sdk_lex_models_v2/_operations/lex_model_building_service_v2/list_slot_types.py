...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_slot_types_response.ListSlotTypesResponse = (
        aws_sdk_lex_models_v2.types.list_slot_types_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_slot_types_request.ListSlotTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_slot_types_request.serialize_json(input_)
    ).encode()
