...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.list_slot_types_request.ListSlotTypesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_slot_types_request.serialize_json(input)
    ).encode()
