...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.update_slot_type_response.UpdateSlotTypeResponse = aws_sdk_lex_models_v2.types.update_slot_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.update_slot_type_request.UpdateSlotTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.update_slot_type_request.serialize_json(input_)
    ).encode()
