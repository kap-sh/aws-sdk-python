"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListBotVersionReplicas``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_bot_version_replicas_response.ListBotVersionReplicasResponse = aws_sdk_lex_models_v2.types.list_bot_version_replicas_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.list_bot_version_replicas_request.ListBotVersionReplicasRequest,
) -> zapros.Request:
    ...
    url = (
        endpoint.url.rstrip("/") + "/bots/{botId}/replicas/{replicaRegion}/botversions"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_bot_version_replicas_request.serialize_json(
            input
        )
    ).encode()
...
async def async_list_bot_version_replicas(
