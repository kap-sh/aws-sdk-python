"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DeleteBotLocale``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.delete_bot_locale_response.DeleteBotLocaleResponse = aws_sdk_lex_models_v2.types.delete_bot_locale_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.delete_bot_locale_request.DeleteBotLocaleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_bot_locale(
