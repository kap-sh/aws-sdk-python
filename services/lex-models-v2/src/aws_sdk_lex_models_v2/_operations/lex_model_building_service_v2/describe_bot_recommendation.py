"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeBotRecommendation``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_bot_recommendation_response.DescribeBotRecommendationResponse = aws_sdk_lex_models_v2.types.describe_bot_recommendation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_bot_recommendation_request.DescribeBotRecommendationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_bot_recommendation(
