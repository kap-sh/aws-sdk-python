"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeBotVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_bot_version_response.DescribeBotVersionResponse = aws_sdk_lex_models_v2.types.describe_bot_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_bot_version_request.DescribeBotVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/bots/{botId}/botversions/{botVersion}"
...
async def async_describe_bot_version(
