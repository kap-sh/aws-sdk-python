...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_import_response.DescribeImportResponse = (
        aws_sdk_lex_models_v2.types.describe_import_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_import_request.DescribeImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
