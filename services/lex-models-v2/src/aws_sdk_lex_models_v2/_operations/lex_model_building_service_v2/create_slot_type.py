...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.create_slot_type_request.CreateSlotTypeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.create_slot_type_request.serialize_json(input)
    ).encode()
