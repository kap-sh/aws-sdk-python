"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#CreateSlotType``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.create_slot_type_response.CreateSlotTypeResponse = aws_sdk_lex_models_v2.types.create_slot_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.create_slot_type_request.CreateSlotTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.create_slot_type_request.serialize_json(input_)
    ).encode()
...
async def async_create_slot_type(
