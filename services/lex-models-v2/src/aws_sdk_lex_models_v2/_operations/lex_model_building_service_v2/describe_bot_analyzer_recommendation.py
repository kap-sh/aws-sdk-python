...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_bot_analyzer_recommendation_response.DescribeBotAnalyzerRecommendationResponse = aws_sdk_lex_models_v2.types.describe_bot_analyzer_recommendation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_bot_analyzer_recommendation_request.DescribeBotAnalyzerRecommendationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.describe_bot_analyzer_recommendation_request.serialize_json(
            input_
        )
    ).encode()
