"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DeleteUtterances``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.delete_utterances_response.DeleteUtterancesResponse = {}  # type: ignore[typeddict-item]
    return out
