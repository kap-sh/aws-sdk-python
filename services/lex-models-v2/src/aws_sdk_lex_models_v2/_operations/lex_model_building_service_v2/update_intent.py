"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#UpdateIntent``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.update_intent_response.UpdateIntentResponse = (
        aws_sdk_lex_models_v2.types.update_intent_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.update_intent_request.UpdateIntentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.update_intent_request.serialize_json(input_)
    ).encode()
