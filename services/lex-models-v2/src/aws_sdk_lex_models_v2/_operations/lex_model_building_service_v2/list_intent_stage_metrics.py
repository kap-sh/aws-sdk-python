...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_intent_stage_metrics_response.ListIntentStageMetricsResponse = aws_sdk_lex_models_v2.types.list_intent_stage_metrics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_intent_stage_metrics_request.ListIntentStageMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_intent_stage_metrics_request.serialize_json(
            input_
        )
    ).encode()
