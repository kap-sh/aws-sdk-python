...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_bot_response.DescribeBotResponse = (
        aws_sdk_lex_models_v2.types.describe_bot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_bot_request.DescribeBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
