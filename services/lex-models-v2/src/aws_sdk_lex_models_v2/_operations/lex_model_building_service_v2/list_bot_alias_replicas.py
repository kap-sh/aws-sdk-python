...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_bot_alias_replicas_response.ListBotAliasReplicasResponse = aws_sdk_lex_models_v2.types.list_bot_alias_replicas_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_bot_alias_replicas_request.ListBotAliasReplicasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
