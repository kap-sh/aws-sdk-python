"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListBotRecommendations``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_bot_recommendations_response.ListBotRecommendationsResponse = aws_sdk_lex_models_v2.types.list_bot_recommendations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_bot_recommendations_request.ListBotRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_bot_recommendations_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_bot_recommendations(
