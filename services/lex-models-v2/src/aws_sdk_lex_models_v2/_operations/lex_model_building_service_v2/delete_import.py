"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DeleteImport``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.delete_import_response.DeleteImportResponse = (
        aws_sdk_lex_models_v2.types.delete_import_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.delete_import_request.DeleteImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/imports/{importId}"
    url = url.replace("{importId}", quote(str(input_["import_id"]), safe=""))
    params: dict[str, str] = {}
