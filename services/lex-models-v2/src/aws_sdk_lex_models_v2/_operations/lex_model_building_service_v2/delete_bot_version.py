...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.delete_bot_version_response.DeleteBotVersionResponse = aws_sdk_lex_models_v2.types.delete_bot_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.delete_bot_version_request.DeleteBotVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
