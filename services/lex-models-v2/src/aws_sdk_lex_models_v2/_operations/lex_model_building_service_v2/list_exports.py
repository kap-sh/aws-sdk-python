...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_exports_response.ListExportsResponse = (
        aws_sdk_lex_models_v2.types.list_exports_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_exports_request.ListExportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_exports_request.serialize_json(input_)
    ).encode()
