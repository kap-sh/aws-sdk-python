"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DeleteResourcePolicyStatement``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.delete_resource_policy_statement_response.DeleteResourcePolicyStatementResponse = aws_sdk_lex_models_v2.types.delete_resource_policy_statement_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.delete_resource_policy_statement_request.DeleteResourcePolicyStatementRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/policy/{resourceArn}/statements/{statementId}"
...
async def async_delete_resource_policy_statement(
