...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.stop_bot_analyzer_response.StopBotAnalyzerResponse = aws_sdk_lex_models_v2.types.stop_bot_analyzer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.stop_bot_analyzer_request.StopBotAnalyzerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
