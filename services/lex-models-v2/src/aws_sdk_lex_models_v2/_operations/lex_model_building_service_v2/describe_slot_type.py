"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeSlotType``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_slot_type_response.DescribeSlotTypeResponse = aws_sdk_lex_models_v2.types.describe_slot_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_slot_type_request.DescribeSlotTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{slotTypeId}", quote(str(input_["slot_type_id"]), safe=""))
...
async def async_describe_slot_type(
