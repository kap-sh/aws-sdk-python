"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#UpdateBotRecommendation``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.update_bot_recommendation_response.UpdateBotRecommendationResponse = aws_sdk_lex_models_v2.types.update_bot_recommendation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.update_bot_recommendation_request.UpdateBotRecommendationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_bot_recommendation(
