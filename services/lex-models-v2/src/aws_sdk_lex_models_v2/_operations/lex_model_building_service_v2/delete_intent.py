"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DeleteIntent``."""
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.delete_intent_request.DeleteIntentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
