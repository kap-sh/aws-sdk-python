...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.start_test_set_generation_response.StartTestSetGenerationResponse = aws_sdk_lex_models_v2.types.start_test_set_generation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.start_test_set_generation_request.StartTestSetGenerationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.start_test_set_generation_request.serialize_json(
            input_
        )
    ).encode()
