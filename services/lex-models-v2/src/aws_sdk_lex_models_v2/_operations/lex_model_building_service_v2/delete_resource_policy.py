"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DeleteResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.delete_resource_policy_response.DeleteResourcePolicyResponse = aws_sdk_lex_models_v2.types.delete_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.delete_resource_policy_request.DeleteResourcePolicyRequest,
) -> zapros.Request:
