...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_slots_response.ListSlotsResponse = (
        aws_sdk_lex_models_v2.types.list_slots_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.list_slots_request.ListSlotsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_slots_request.serialize_json(input)
    ).encode()
...
def list_slots(
    ...
    aws_sdk_lex_models_v2.types.list_slots_response.ListSlotsResponse, zapros.Response
]:
