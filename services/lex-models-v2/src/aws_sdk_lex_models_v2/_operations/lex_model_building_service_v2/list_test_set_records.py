...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_test_set_records_response.ListTestSetRecordsResponse = aws_sdk_lex_models_v2.types.list_test_set_records_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_test_set_records_request.ListTestSetRecordsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_test_set_records_request.serialize_json(input_)
    ).encode()
