"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#CreateUploadUrl``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.create_upload_url_response.CreateUploadUrlResponse = aws_sdk_lex_models_v2.types.create_upload_url_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.create_upload_url_request.CreateUploadUrlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/createuploadurl"
    params: dict[str, str] = {}
...
async def async_create_upload_url(
