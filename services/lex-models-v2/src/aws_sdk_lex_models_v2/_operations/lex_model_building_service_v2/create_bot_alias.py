...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.create_bot_alias_request.CreateBotAliasRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.create_bot_alias_request.serialize_json(input)
    ).encode()
