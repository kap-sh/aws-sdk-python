...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_bot_alias_response.DescribeBotAliasResponse = aws_sdk_lex_models_v2.types.describe_bot_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_bot_alias_request.DescribeBotAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
