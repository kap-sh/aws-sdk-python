"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#BuildBotLocale``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.build_bot_locale_response.BuildBotLocaleResponse = aws_sdk_lex_models_v2.types.build_bot_locale_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.build_bot_locale_request.BuildBotLocaleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_build_bot_locale(
