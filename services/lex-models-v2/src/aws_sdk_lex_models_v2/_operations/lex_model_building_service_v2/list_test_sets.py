...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_test_sets_response.ListTestSetsResponse = (
        aws_sdk_lex_models_v2.types.list_test_sets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_test_sets_request.ListTestSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_test_sets_request.serialize_json(input_)
    ).encode()
