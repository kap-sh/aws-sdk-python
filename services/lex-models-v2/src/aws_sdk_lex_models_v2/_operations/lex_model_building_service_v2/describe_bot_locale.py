"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeBotLocale``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_bot_locale_response.DescribeBotLocaleResponse = aws_sdk_lex_models_v2.types.describe_bot_locale_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_bot_locale_request.DescribeBotLocaleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_bot_locale(
