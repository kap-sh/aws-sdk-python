"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#CreateBotLocale``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.create_bot_locale_response.CreateBotLocaleResponse = aws_sdk_lex_models_v2.types.create_bot_locale_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.create_bot_locale_request.CreateBotLocaleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/bots/{botId}/botversions/{botVersion}/botlocales"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.create_bot_locale_request.serialize_json(input_)
    ).encode()
...
async def async_create_bot_locale(
