"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_resource_policy_response.DescribeResourcePolicyResponse = aws_sdk_lex_models_v2.types.describe_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_resource_policy_request.DescribeResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
