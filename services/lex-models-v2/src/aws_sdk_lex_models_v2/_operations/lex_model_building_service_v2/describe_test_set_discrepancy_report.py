"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeTestSetDiscrepancyReport``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.describe_test_set_discrepancy_report_response.DescribeTestSetDiscrepancyReportResponse = aws_sdk_lex_models_v2.types.describe_test_set_discrepancy_report_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.describe_test_set_discrepancy_report_request.DescribeTestSetDiscrepancyReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/testsetdiscrepancy/{testSetDiscrepancyReportId}"
    url = url.replace(
        "{testSetDiscrepancyReportId}",
        quote(str(input_["test_set_discrepancy_report_id"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_describe_test_set_discrepancy_report(
