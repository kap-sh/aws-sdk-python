...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.describe_test_set_discrepancy_report_request.DescribeTestSetDiscrepancyReportRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["test_set_discrepancy_report_id"]), safe=""),
    )
    params: dict[str, str] = {}
