...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.update_bot_response.UpdateBotResponse = (
        aws_sdk_lex_models_v2.types.update_bot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.update_bot_request.UpdateBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.update_bot_request.serialize_json(input_)
    ).encode()
...
def update_bot(
    ...
    aws_sdk_lex_models_v2.types.update_bot_response.UpdateBotResponse, zapros.Response
]:
