...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.list_intent_paths_request.ListIntentPathsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_intent_paths_request.serialize_json(input)
    ).encode()
