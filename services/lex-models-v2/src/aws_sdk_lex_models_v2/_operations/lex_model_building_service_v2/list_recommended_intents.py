"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListRecommendedIntents``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_models_v2.types.list_recommended_intents_response.ListRecommendedIntentsResponse = aws_sdk_lex_models_v2.types.list_recommended_intents_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_models_v2.types.list_recommended_intents_request.ListRecommendedIntentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_recommended_intents_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_recommended_intents(
