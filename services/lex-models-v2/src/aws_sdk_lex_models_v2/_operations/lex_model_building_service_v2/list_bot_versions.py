...
def build_request(
    ...
    input: aws_sdk_lex_models_v2.types.list_bot_versions_request.ListBotVersionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_models_v2.types.list_bot_versions_request.serialize_json(input)
    ).encode()
