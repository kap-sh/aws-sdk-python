...
if TYPE_CHECKING:
    ...
    import aws_sdk_lex_models_v2.types.specifications

SubSlotSpecificationMap: TypeAlias = dict[
    "aws_sdk_lex_models_v2.types.name.Name",
    "aws_sdk_lex_models_v2.types.specifications.Specifications",
]
...
def serialize_json(input_to_serialize: SubSlotSpecificationMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_lex_models_v2.types.specifications.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> SubSlotSpecificationMap:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_lex_models_v2.types.specifications.deserialize_json(value)
    return out
