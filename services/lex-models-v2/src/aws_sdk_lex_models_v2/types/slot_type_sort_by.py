...
if TYPE_CHECKING:
    import aws_sdk_lex_models_v2.types.slot_type_sort_attribute
    import aws_sdk_lex_models_v2.types.sort_order


class SlotTypeSortBy(TypedDict):
    attribute: (
        "aws_sdk_lex_models_v2.types.slot_type_sort_attribute.SlotTypeSortAttribute"
    )
...
def serialize_json(value: SlotTypeSortBy) -> dict:
    ...
    out["attribute"] = (
        aws_sdk_lex_models_v2.types.slot_type_sort_attribute.serialize_json(
            value["attribute"]
        )
    )
    import aws_sdk_lex_models_v2.types.sort_order
...
def deserialize_json(data: dict) -> SlotTypeSortBy:
    ...
    if "attribute" in data:
        ...
        out["attribute"] = (
            aws_sdk_lex_models_v2.types.slot_type_sort_attribute.deserialize_json(
                data["attribute"]
            )
        )
    else:
