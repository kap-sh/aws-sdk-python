"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeTestSetResponse``."""
...
class DescribeTestSetResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeTestSetResponse) -> dict:
    out: dict = {}
