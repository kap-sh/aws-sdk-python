...
if TYPE_CHECKING:
    ...
    import aws_sdk_lex_models_v2.types.still_waiting_response_frequency
...
class StillWaitingResponseSpecification(TypedDict, closed=True):
    ...
    timeout_in_seconds: "aws_sdk_lex_models_v2.types.still_waiting_response_timeout.StillWaitingResponseTimeout"
