...
if TYPE_CHECKING:
    ...
    import aws_sdk_lex_models_v2.types.dialog_action_type
...
def serialize_json(value: DialogAction) -> dict:
    ...
    out["type"] = aws_sdk_lex_models_v2.types.dialog_action_type.serialize_json(
        value["type"]
    )
...
def deserialize_json(data: dict) -> DialogAction:
    ...
    if "type" in data:
        ...
        out["type"] = aws_sdk_lex_models_v2.types.dialog_action_type.deserialize_json(
            data["type"]
        )
    else:
