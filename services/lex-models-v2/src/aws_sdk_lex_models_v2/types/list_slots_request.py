...
class ListSlotsRequest(TypedDict):
    ...
    sort_by: NotRequired["aws_sdk_lex_models_v2.types.slot_sort_by.SlotSortBy"]
    ...
    filters: NotRequired["aws_sdk_lex_models_v2.types.slot_filters.SlotFilters"]
...
def serialize_json(value: ListSlotsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["sortBy"] = aws_sdk_lex_models_v2.types.slot_sort_by.serialize_json(
            value["sort_by"]
        )
    if "filters" in value:
        import aws_sdk_lex_models_v2.types.slot_filters

        out["filters"] = aws_sdk_lex_models_v2.types.slot_filters.serialize_json(
            value["filters"]
        )
...
def deserialize_json(data: dict) -> ListSlotsRequest:
    ...
    if "sortBy" in data:
        ...
        out["sort_by"] = aws_sdk_lex_models_v2.types.slot_sort_by.deserialize_json(
            data["sortBy"]
        )
    if "filters" in data:
        import aws_sdk_lex_models_v2.types.slot_filters

        out["filters"] = aws_sdk_lex_models_v2.types.slot_filters.deserialize_json(
            data["filters"]
        )
