...
if TYPE_CHECKING:
    import aws_sdk_lex_models_v2.types.bot_version_locale_details
    import aws_sdk_lex_models_v2.types.locale_id

BotVersionLocaleSpecification: TypeAlias = dict[
    "aws_sdk_lex_models_v2.types.locale_id.LocaleId",
    "aws_sdk_lex_models_v2.types.bot_version_locale_details.BotVersionLocaleDetails",
]
...
def serialize_json(input_to_serialize: BotVersionLocaleSpecification) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = (
            aws_sdk_lex_models_v2.types.bot_version_locale_details.serialize_json(value)
        )
    return out
...
def deserialize_json(data: dict) -> BotVersionLocaleSpecification:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            aws_sdk_lex_models_v2.types.bot_version_locale_details.deserialize_json(
                value
            )
        )
    return out
