...
if TYPE_CHECKING:
    import aws_sdk_lex_models_v2.types.attachment_title
    import aws_sdk_lex_models_v2.types.attachment_url
...
class ImageResponseCard(TypedDict):
    ...
    subtitle: NotRequired[
        "aws_sdk_lex_models_v2.types.attachment_title.AttachmentTitle"
    ]
    ...
    image_url: NotRequired["aws_sdk_lex_models_v2.types.attachment_url.AttachmentUrl"]
    ...
    buttons: NotRequired["aws_sdk_lex_models_v2.types.buttons_list.ButtonsList"]
...
def serialize_json(value: ImageResponseCard) -> dict:
    ...
    if "buttons" in value:
        ...
        out["buttons"] = aws_sdk_lex_models_v2.types.buttons_list.serialize_json(
            value["buttons"]
        )
    return out
...
def deserialize_json(data: dict) -> ImageResponseCard:
    ...
    if "buttons" in data:
        ...
        out["buttons"] = aws_sdk_lex_models_v2.types.buttons_list.deserialize_json(
            data["buttons"]
        )
    return out
