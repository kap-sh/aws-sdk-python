...
if TYPE_CHECKING:
    import aws_sdk_lex_models_v2.types.slot_resolution_strategy


class SlotResolutionSetting(TypedDict):
    slot_resolution_strategy: (
        "aws_sdk_lex_models_v2.types.slot_resolution_strategy.SlotResolutionStrategy"
    )
...
def serialize_json(value: SlotResolutionSetting) -> dict:
    ...
    out["slotResolutionStrategy"] = (
        aws_sdk_lex_models_v2.types.slot_resolution_strategy.serialize_json(
...
def deserialize_json(data: dict) -> SlotResolutionSetting:
    ...
    if "slotResolutionStrategy" in data:
        ...
        out["slot_resolution_strategy"] = (
            aws_sdk_lex_models_v2.types.slot_resolution_strategy.deserialize_json(
