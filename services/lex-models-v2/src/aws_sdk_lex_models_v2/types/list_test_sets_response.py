...
if TYPE_CHECKING:
    ...
    import aws_sdk_lex_models_v2.types.test_set_summary_list


class ListTestSetsResponse(TypedDict):
    test_sets: NotRequired[
        "aws_sdk_lex_models_v2.types.test_set_summary_list.TestSetSummaryList"
    ]
...
def serialize_json(value: ListTestSetsResponse) -> dict:
    ...
    if "test_sets" in value:
        ...
        out["testSets"] = (
            aws_sdk_lex_models_v2.types.test_set_summary_list.serialize_json(
                value["test_sets"]
            )
        )
...
def deserialize_json(data: dict) -> ListTestSetsResponse:
    ...
    if "testSets" in data:
        ...
        out["test_sets"] = (
            aws_sdk_lex_models_v2.types.test_set_summary_list.deserialize_json(
                data["testSets"]
            )
        )
