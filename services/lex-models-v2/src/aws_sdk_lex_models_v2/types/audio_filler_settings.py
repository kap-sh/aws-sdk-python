...
if TYPE_CHECKING:
    ...
    import aws_sdk_lex_models_v2.types.audio_filler_delivery_delay_in_milliseconds
    import aws_sdk_lex_models_v2.types.audio_filler_duration_in_milliseconds
    import aws_sdk_lex_models_v2.types.audio_filler_type
...
class AudioFillerSettings(TypedDict):
    ...
    audio_type: NotRequired[
        "aws_sdk_lex_models_v2.types.audio_filler_type.AudioFillerType"
    ]
    ...
    start_delay_in_milliseconds: NotRequired[
        "aws_sdk_lex_models_v2.types.audio_filler_delay_in_milliseconds.AudioFillerDelayInMilliseconds"
    ]
    ...
    minimum_play_duration_in_milliseconds: NotRequired[
        "aws_sdk_lex_models_v2.types.audio_filler_duration_in_milliseconds.AudioFillerDurationInMilliseconds"
    ]
    ...
    response_delivery_delay_in_milliseconds: NotRequired[
        "aws_sdk_lex_models_v2.types.audio_filler_delivery_delay_in_milliseconds.AudioFillerDeliveryDelayInMilliseconds"
    ]
...
def serialize_json(value: AudioFillerSettings) -> dict:
    ...
    if "audio_type" in value:
        ...
        out["audioType"] = aws_sdk_lex_models_v2.types.audio_filler_type.serialize_json(
            value["audio_type"]
        )
...
def deserialize_json(data: dict) -> AudioFillerSettings:
    ...
    if "audioType" in data:
        ...
        out["audio_type"] = (
            aws_sdk_lex_models_v2.types.audio_filler_type.deserialize_json(
                data["audioType"]
            )
        )
