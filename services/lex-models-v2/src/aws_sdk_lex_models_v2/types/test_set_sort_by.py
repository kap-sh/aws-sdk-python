...
if TYPE_CHECKING:
    ...
    import aws_sdk_lex_models_v2.types.test_set_sort_attribute


class TestSetSortBy(TypedDict):
    attribute: (
        "aws_sdk_lex_models_v2.types.test_set_sort_attribute.TestSetSortAttribute"
    )
...
def serialize_json(value: TestSetSortBy) -> dict:
    ...
    out["attribute"] = (
        aws_sdk_lex_models_v2.types.test_set_sort_attribute.serialize_json(
            value["attribute"]
        )
    )
    import aws_sdk_lex_models_v2.types.sort_order
...
def deserialize_json(data: dict) -> TestSetSortBy:
    ...
    if "attribute" in data:
        ...
        out["attribute"] = (
            aws_sdk_lex_models_v2.types.test_set_sort_attribute.deserialize_json(
                data["attribute"]
            )
        )
    else:
