"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeIntentResponse``."""
...
class DescribeIntentResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeIntentResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DescribeIntentResponse:
    out: DescribeIntentResponse = {}  # type: ignore[typeddict-item]
    if "intentId" in data:
