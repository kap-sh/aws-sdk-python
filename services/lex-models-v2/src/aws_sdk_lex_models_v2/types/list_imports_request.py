...
class ListImportsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired["aws_sdk_lex_models_v2.types.import_sort_by.ImportSortBy"]
    ...
    filters: NotRequired["aws_sdk_lex_models_v2.types.import_filters.ImportFilters"]
...
def serialize_json(value: ListImportsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["sortBy"] = aws_sdk_lex_models_v2.types.import_sort_by.serialize_json(
            value["sort_by"]
        )
    if "filters" in value:
        import aws_sdk_lex_models_v2.types.import_filters

        out["filters"] = aws_sdk_lex_models_v2.types.import_filters.serialize_json(
            value["filters"]
        )
...
def deserialize_json(data: dict) -> ListImportsRequest:
    ...
    if "sortBy" in data:
        ...
        out["sort_by"] = aws_sdk_lex_models_v2.types.import_sort_by.deserialize_json(
            data["sortBy"]
        )
    if "filters" in data:
        import aws_sdk_lex_models_v2.types.import_filters

        out["filters"] = aws_sdk_lex_models_v2.types.import_filters.deserialize_json(
            data["filters"]
        )
