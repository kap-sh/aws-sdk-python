...
if TYPE_CHECKING:
    import aws_sdk_lex_models_v2.types.conversation_logs_data_source


class TestSetGenerationDataSource(TypedDict):
    conversation_logs_data_source: NotRequired[
        "aws_sdk_lex_models_v2.types.conversation_logs_data_source.ConversationLogsDataSource"
    ]
...
def serialize_json(value: TestSetGenerationDataSource) -> dict:
    ...
    if "conversation_logs_data_source" in value:
        ...
        out["conversationLogsDataSource"] = (
            aws_sdk_lex_models_v2.types.conversation_logs_data_source.serialize_json(
...
def deserialize_json(data: dict) -> TestSetGenerationDataSource:
    ...
    if "conversationLogsDataSource" in data:
        ...
        out["conversation_logs_data_source"] = (
            aws_sdk_lex_models_v2.types.conversation_logs_data_source.deserialize_json(
