...
if TYPE_CHECKING:
    import aws_sdk_lex_models_v2.types.audio_log_settings_list
    import aws_sdk_lex_models_v2.types.text_log_settings_list


class ConversationLogSettings(TypedDict):
    text_log_settings: NotRequired[
        "aws_sdk_lex_models_v2.types.text_log_settings_list.TextLogSettingsList"
    ]
    """<p>The Amazon CloudWatch Logs settings for logging text and metadata.</p>"""
    audio_log_settings: NotRequired[
        "aws_sdk_lex_models_v2.types.audio_log_settings_list.AudioLogSettingsList"
    ]
...
def serialize_json(value: ConversationLogSettings) -> dict:
    ...
    if "text_log_settings" in value:
        ...
        out["textLogSettings"] = (
            aws_sdk_lex_models_v2.types.text_log_settings_list.serialize_json(
    ...
    if "audio_log_settings" in value:
        ...
        out["audioLogSettings"] = (
            aws_sdk_lex_models_v2.types.audio_log_settings_list.serialize_json(
...
def deserialize_json(data: dict) -> ConversationLogSettings:
    ...
    if "textLogSettings" in data:
        ...
        out["text_log_settings"] = (
            aws_sdk_lex_models_v2.types.text_log_settings_list.deserialize_json(
    ...
    if "audioLogSettings" in data:
        ...
        out["audio_log_settings"] = (
            aws_sdk_lex_models_v2.types.audio_log_settings_list.deserialize_json(
