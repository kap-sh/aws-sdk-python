...
if TYPE_CHECKING:
    import aws_sdk_lex_models_v2.types.plain_text_message_value


class PlainTextMessage(TypedDict):
    value: "aws_sdk_lex_models_v2.types.plain_text_message_value.PlainTextMessageValue"
