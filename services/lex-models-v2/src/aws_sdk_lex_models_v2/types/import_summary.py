...
if TYPE_CHECKING:
    ...
    import aws_sdk_lex_models_v2.types.import_resource_type
    import aws_sdk_lex_models_v2.types.import_status
    import aws_sdk_lex_models_v2.types.imported_resource_id
...
class ImportSummary(TypedDict, closed=True):
    ...
    imported_resource_id: NotRequired[
        "aws_sdk_lex_models_v2.types.imported_resource_id.ImportedResourceId"
    ]
    """<p>The unique identifier that Amazon Lex assigned to the imported resource.</p>"""
    imported_resource_name: NotRequired["aws_sdk_lex_models_v2.types.name.Name"]
    ...
    imported_resource_type: NotRequired[
        "aws_sdk_lex_models_v2.types.import_resource_type.ImportResourceType"
    ]
...
def serialize_json(value: ImportSummary) -> dict:
    ...
    if "imported_resource_type" in value:
        ...
        out["importedResourceType"] = (
            aws_sdk_lex_models_v2.types.import_resource_type.serialize_json(
...
def deserialize_json(data: dict) -> ImportSummary:
    ...
    if "importedResourceType" in data:
        ...
        out["imported_resource_type"] = (
            aws_sdk_lex_models_v2.types.import_resource_type.deserialize_json(
