...
if TYPE_CHECKING:
    import aws_sdk_lex_models_v2.types.aggregated_utterances_summary_list
...
class ListAggregatedUtterancesResponse(TypedDict):
    ...
    aggregation_duration: NotRequired[
        "aws_sdk_lex_models_v2.types.utterance_aggregation_duration.UtteranceAggregationDuration"
    ]
    ...
    aggregated_utterances_summaries: NotRequired[
        "aws_sdk_lex_models_v2.types.aggregated_utterances_summary_list.AggregatedUtterancesSummaryList"
    ]
...
def serialize_json(value: ListAggregatedUtterancesResponse) -> dict:
    ...
    if "aggregated_utterances_summaries" in value:
        ...
        out["aggregatedUtterancesSummaries"] = (
            aws_sdk_lex_models_v2.types.aggregated_utterances_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListAggregatedUtterancesResponse:
    ...
    if "aggregatedUtterancesSummaries" in data:
        ...
        out["aggregated_utterances_summaries"] = (
            aws_sdk_lex_models_v2.types.aggregated_utterances_summary_list.deserialize_json(
