...
if TYPE_CHECKING:
    import aws_sdk_lex_models_v2.types.runtime_hint_values_list
    import aws_sdk_lex_models_v2.types.slot_hints_slot_map


class RuntimeHintDetails(TypedDict, closed=True):
    runtime_hint_values: NotRequired[
        "aws_sdk_lex_models_v2.types.runtime_hint_values_list.RuntimeHintValuesList"
    ]
    ...
    sub_slot_hints: NotRequired[
        "aws_sdk_lex_models_v2.types.slot_hints_slot_map.SlotHintsSlotMap"
    ]
...
def serialize_json(value: RuntimeHintDetails) -> dict:
    ...
    if "runtime_hint_values" in value:
        ...
        out["runtimeHintValues"] = (
            aws_sdk_lex_models_v2.types.runtime_hint_values_list.serialize_json(
    ...
    if "sub_slot_hints" in value:
        ...
        out["subSlotHints"] = (
            aws_sdk_lex_models_v2.types.slot_hints_slot_map.serialize_json(
...
def deserialize_json(data: dict) -> RuntimeHintDetails:
    ...
    if "runtimeHintValues" in data:
        ...
        out["runtime_hint_values"] = (
            aws_sdk_lex_models_v2.types.runtime_hint_values_list.deserialize_json(
    ...
    if "subSlotHints" in data:
        ...
        out["sub_slot_hints"] = (
            aws_sdk_lex_models_v2.types.slot_hints_slot_map.deserialize_json(
                data["subSlotHints"]
            )
        )
    return out
