...
class BatchUpdateCustomVocabularyItemRequest(TypedDict):
...
def serialize_json(value: BatchUpdateCustomVocabularyItemRequest) -> dict:
    ...
    out["customVocabularyItemList"] = (
        aws_sdk_lex_models_v2.types.update_custom_vocabulary_items_list.serialize_json(
...
def deserialize_json(data: dict) -> BatchUpdateCustomVocabularyItemRequest:
    ...
    if "customVocabularyItemList" in data:
        ...
        out["custom_vocabulary_item_list"] = (
            aws_sdk_lex_models_v2.types.update_custom_vocabulary_items_list.deserialize_json(
