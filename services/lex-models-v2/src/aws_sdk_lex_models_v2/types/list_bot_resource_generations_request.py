...
class ListBotResourceGenerationsRequest(TypedDict):
...
def serialize_json(value: ListBotResourceGenerationsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["sortBy"] = aws_sdk_lex_models_v2.types.generation_sort_by.serialize_json(
            value["sort_by"]
        )
...
def deserialize_json(data: dict) -> ListBotResourceGenerationsRequest:
    ...
    if "sortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_lex_models_v2.types.generation_sort_by.deserialize_json(
                data["sortBy"]
            )
        )
