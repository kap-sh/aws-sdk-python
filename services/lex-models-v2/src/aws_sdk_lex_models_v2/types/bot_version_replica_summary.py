...
if TYPE_CHECKING:
    ...
    import aws_sdk_lex_models_v2.types.bot_version_replication_status
...
class BotVersionReplicaSummary(TypedDict):
    ...
    bot_version_replication_status: NotRequired[
        "aws_sdk_lex_models_v2.types.bot_version_replication_status.BotVersionReplicationStatus"
    ]
...
def serialize_json(value: BotVersionReplicaSummary) -> dict:
    ...
    if "bot_version_replication_status" in value:
        ...
        out["botVersionReplicationStatus"] = (
            aws_sdk_lex_models_v2.types.bot_version_replication_status.serialize_json(
...
def deserialize_json(data: dict) -> BotVersionReplicaSummary:
    ...
    if "botVersionReplicationStatus" in data:
        ...
        out["bot_version_replication_status"] = (
            aws_sdk_lex_models_v2.types.bot_version_replication_status.deserialize_json(
