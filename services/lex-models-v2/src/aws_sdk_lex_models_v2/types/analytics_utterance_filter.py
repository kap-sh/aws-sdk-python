...
if TYPE_CHECKING:
    ...
    import aws_sdk_lex_models_v2.types.analytics_utterance_filter_name


class AnalyticsUtteranceFilter(TypedDict):
    name: "aws_sdk_lex_models_v2.types.analytics_utterance_filter_name.AnalyticsUtteranceFilterName"
...
def serialize_json(value: AnalyticsUtteranceFilter) -> dict:
    ...
    out["name"] = (
        aws_sdk_lex_models_v2.types.analytics_utterance_filter_name.serialize_json(
            value["name"]
        )
    )
    import aws_sdk_lex_models_v2.types.analytics_filter_operator
...
def deserialize_json(data: dict) -> AnalyticsUtteranceFilter:
    ...
    if "name" in data:
        ...
        out["name"] = (
            aws_sdk_lex_models_v2.types.analytics_utterance_filter_name.deserialize_json(
                data["name"]
            )
        )
    else:
