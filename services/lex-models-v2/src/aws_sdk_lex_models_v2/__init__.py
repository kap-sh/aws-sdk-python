...
from ._services.async_lex_models_v2 import (
    AsyncLexModelsV2Client as AsyncLexModelsV2Client,
)
from ._services.lex_models_v2 import LexModelsV2Client as LexModelsV2Client
