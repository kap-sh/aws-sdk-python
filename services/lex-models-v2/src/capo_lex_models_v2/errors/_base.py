...
class LexModelsV2Error(Exception):
    """Base class for all LexModelsV2 service errors."""


class ServiceError(LexModelsV2Error):
...
class SerializationError(LexModelsV2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(LexModelsV2Error):
...
class WaiterFailedError(LexModelsV2Error):
...
class WaiterTimeoutError(LexModelsV2Error):
