...
def handle_response(
    ...
    out: capo_lex_models_v2.types.create_resource_policy_response.CreateResourcePolicyResponse = capo_lex_models_v2.types.create_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.create_resource_policy_request.serialize_json(input_)
    ).encode()
