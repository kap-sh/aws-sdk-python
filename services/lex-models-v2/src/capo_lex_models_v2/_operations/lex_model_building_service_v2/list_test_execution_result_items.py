"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListTestExecutionResultItems``."""
...
import capo_lex_models_v2.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_lex_models_v2.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_test_execution_result_items_response.ListTestExecutionResultItemsResponse = capo_lex_models_v2.types.list_test_execution_result_items_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/testexecutions/{testExecutionId}/results"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_test_execution_result_items_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_test_execution_result_items(
