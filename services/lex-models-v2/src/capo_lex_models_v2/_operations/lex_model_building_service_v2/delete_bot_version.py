"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DeleteBotVersion``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.delete_bot_version_response.DeleteBotVersionResponse = capo_lex_models_v2.types.delete_bot_version_response.deserialize_json(
...
async def async_delete_bot_version(
