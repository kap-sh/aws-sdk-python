...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_bot_recommendation_response.DescribeBotRecommendationResponse = capo_lex_models_v2.types.describe_bot_recommendation_response.deserialize_json(
