"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#UpdateTestSet``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.update_test_set_response.UpdateTestSetResponse = (
        capo_lex_models_v2.types.update_test_set_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.update_test_set_request.serialize_json(input_)
    ).encode()
...
async def async_update_test_set(
