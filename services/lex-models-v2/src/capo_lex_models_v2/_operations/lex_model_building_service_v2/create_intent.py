"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#CreateIntent``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.create_intent_response.CreateIntentResponse = (
        capo_lex_models_v2.types.create_intent_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.create_intent_request.serialize_json(input_)
    ).encode()
