"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeBotResourceGeneration``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_bot_resource_generation_response.DescribeBotResourceGenerationResponse = capo_lex_models_v2.types.describe_bot_resource_generation_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{generationId}", quote(str(input_["generation_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_describe_bot_resource_generation(
