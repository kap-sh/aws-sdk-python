"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_lex_models_v2.types.list_tags_for_resource_response.deserialize_json(
