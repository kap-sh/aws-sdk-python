...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_bot_replica_response.DescribeBotReplicaResponse = capo_lex_models_v2.types.describe_bot_replica_response.deserialize_json(
