"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#UpdateBotLocale``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.update_bot_locale_response.UpdateBotLocaleResponse = (
        capo_lex_models_v2.types.update_bot_locale_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.update_bot_locale_request.serialize_json(input_)
    ).encode()
...
async def async_update_bot_locale(
