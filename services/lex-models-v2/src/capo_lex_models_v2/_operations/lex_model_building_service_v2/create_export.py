"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#CreateExport``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.create_export_response.CreateExportResponse = (
        capo_lex_models_v2.types.create_export_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.create_export_request.serialize_json(input_)
    ).encode()
