...
def handle_response(
    ...
    out: capo_lex_models_v2.types.create_resource_policy_statement_response.CreateResourcePolicyStatementResponse = capo_lex_models_v2.types.create_resource_policy_statement_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.create_resource_policy_statement_request.serialize_json(
            input_
        )
    ).encode()
