...
def handle_response(
    ...
    out: capo_lex_models_v2.types.create_slot_type_response.CreateSlotTypeResponse = (
        capo_lex_models_v2.types.create_slot_type_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.create_slot_type_request.serialize_json(input_)
    ).encode()
