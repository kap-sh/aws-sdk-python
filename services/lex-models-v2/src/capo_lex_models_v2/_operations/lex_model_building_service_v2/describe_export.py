"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeExport``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_export_response.DescribeExportResponse = (
        capo_lex_models_v2.types.describe_export_response.deserialize_json(
