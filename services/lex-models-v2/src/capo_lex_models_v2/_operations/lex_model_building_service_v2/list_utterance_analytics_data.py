...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_utterance_analytics_data_response.ListUtteranceAnalyticsDataResponse = capo_lex_models_v2.types.list_utterance_analytics_data_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_utterance_analytics_data_request.serialize_json(
            input_
        )
    ).encode()
