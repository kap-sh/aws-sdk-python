...
import capo_lex_models_v2.types.bot_locale_summary_list
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_bot_locales_response.ListBotLocalesResponse = (
        capo_lex_models_v2.types.list_bot_locales_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_bot_locales_request.serialize_json(input_)
    ).encode()
