...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_test_execution_response.DescribeTestExecutionResponse = capo_lex_models_v2.types.describe_test_execution_response.deserialize_json(
