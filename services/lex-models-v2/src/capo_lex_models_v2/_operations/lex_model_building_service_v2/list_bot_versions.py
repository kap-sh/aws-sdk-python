...
import capo_lex_models_v2.types.bot_version_summary_list
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_bot_versions_response.ListBotVersionsResponse = (
        capo_lex_models_v2.types.list_bot_versions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_bot_versions_request.serialize_json(input_)
    ).encode()
