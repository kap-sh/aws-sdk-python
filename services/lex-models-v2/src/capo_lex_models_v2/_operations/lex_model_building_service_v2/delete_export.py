"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DeleteExport``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.delete_export_response.DeleteExportResponse = (
        capo_lex_models_v2.types.delete_export_response.deserialize_json(
