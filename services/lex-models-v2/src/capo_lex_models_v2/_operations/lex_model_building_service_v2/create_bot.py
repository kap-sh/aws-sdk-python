...
def handle_response(
    ...
    out: capo_lex_models_v2.types.create_bot_response.CreateBotResponse = (
        capo_lex_models_v2.types.create_bot_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.create_bot_request.serialize_json(input_)
    ).encode()
...
def create_bot(
    ...
    capo_lex_models_v2.types.create_bot_response.CreateBotResponse, zapros.Response
]:
