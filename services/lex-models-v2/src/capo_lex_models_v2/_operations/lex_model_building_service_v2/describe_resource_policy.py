...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_resource_policy_response.DescribeResourcePolicyResponse = capo_lex_models_v2.types.describe_resource_policy_response.deserialize_json(
