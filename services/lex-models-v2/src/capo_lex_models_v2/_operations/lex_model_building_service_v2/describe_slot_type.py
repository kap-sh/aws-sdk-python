...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_slot_type_response.DescribeSlotTypeResponse = capo_lex_models_v2.types.describe_slot_type_response.deserialize_json(
