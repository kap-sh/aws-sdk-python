...
def handle_response(
    ...
    out: capo_lex_models_v2.types.update_bot_recommendation_response.UpdateBotRecommendationResponse = capo_lex_models_v2.types.update_bot_recommendation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.update_bot_recommendation_request.serialize_json(
            input_
        )
    ).encode()
