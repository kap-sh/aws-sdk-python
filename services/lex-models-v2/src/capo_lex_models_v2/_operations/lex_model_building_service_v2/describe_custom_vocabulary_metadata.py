"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeCustomVocabularyMetadata``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_custom_vocabulary_metadata_response.DescribeCustomVocabularyMetadataResponse = capo_lex_models_v2.types.describe_custom_vocabulary_metadata_response.deserialize_json(
...
async def async_describe_custom_vocabulary_metadata(
