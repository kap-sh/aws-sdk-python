"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeBotAlias``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_bot_alias_response.DescribeBotAliasResponse = capo_lex_models_v2.types.describe_bot_alias_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/bots/{botId}/botaliases/{botAliasId}"
...
async def async_describe_bot_alias(
