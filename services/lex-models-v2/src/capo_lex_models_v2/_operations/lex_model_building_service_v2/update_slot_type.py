"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#UpdateSlotType``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.update_slot_type_response.UpdateSlotTypeResponse = (
        capo_lex_models_v2.types.update_slot_type_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.update_slot_type_request.serialize_json(input_)
    ).encode()
