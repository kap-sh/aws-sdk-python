...
import capo_lex_models_v2.types.analytics_session_results
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_session_metrics_response.ListSessionMetricsResponse = capo_lex_models_v2.types.list_session_metrics_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_session_metrics_request.serialize_json(input_)
    ).encode()
