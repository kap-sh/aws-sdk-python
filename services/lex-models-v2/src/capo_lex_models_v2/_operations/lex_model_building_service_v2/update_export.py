...
def handle_response(
    ...
    out: capo_lex_models_v2.types.update_export_response.UpdateExportResponse = (
        capo_lex_models_v2.types.update_export_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.update_export_request.serialize_json(input_)
    ).encode()
