"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListBotAliases``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_bot_aliases_response.ListBotAliasesResponse = (
        capo_lex_models_v2.types.list_bot_aliases_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_bot_aliases_request.serialize_json(input_)
    ).encode()
...
async def async_list_bot_aliases(
