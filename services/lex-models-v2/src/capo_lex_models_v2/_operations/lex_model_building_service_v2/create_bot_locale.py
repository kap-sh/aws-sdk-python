...
def handle_response(
    ...
    out: capo_lex_models_v2.types.create_bot_locale_response.CreateBotLocaleResponse = (
        capo_lex_models_v2.types.create_bot_locale_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.create_bot_locale_request.serialize_json(input_)
    ).encode()
