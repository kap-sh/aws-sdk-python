"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListImports``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_imports_response.ListImportsResponse = (
        capo_lex_models_v2.types.list_imports_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_imports_request.serialize_json(input_)
    ).encode()
...
def list_imports(
    ...
    capo_lex_models_v2.types.list_imports_response.ListImportsResponse, zapros.Response
]:
