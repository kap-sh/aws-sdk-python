...
def handle_response(
    ...
    out: capo_lex_models_v2.types.delete_resource_policy_response.DeleteResourcePolicyResponse = capo_lex_models_v2.types.delete_resource_policy_response.deserialize_json(
