...
def handle_response(
    ...
    out: capo_lex_models_v2.types.delete_custom_vocabulary_response.DeleteCustomVocabularyResponse = capo_lex_models_v2.types.delete_custom_vocabulary_response.deserialize_json(
