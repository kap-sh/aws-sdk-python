...
class AnalyticsIntentStageMetricResult(TypedDict, closed=True):
    name: NotRequired[
        "capo_lex_models_v2.types.analytics_intent_stage_metric_name.AnalyticsIntentStageMetricName"
    ]
