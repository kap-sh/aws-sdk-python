...
if TYPE_CHECKING:
    import capo_lex_models_v2.types.built_in_slot_type_summary_list
    import capo_lex_models_v2.types.locale_id
    import capo_lex_models_v2.types.next_token


class ListBuiltInSlotTypesResponse(TypedDict, closed=True):
    built_in_slot_type_summaries: NotRequired[
        "capo_lex_models_v2.types.built_in_slot_type_summary_list.BuiltInSlotTypeSummaryList"
    ]
...
def serialize_json(value: ListBuiltInSlotTypesResponse) -> dict:
    ...
    if "built_in_slot_type_summaries" in value:
        ...
        out["builtInSlotTypeSummaries"] = (
            capo_lex_models_v2.types.built_in_slot_type_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListBuiltInSlotTypesResponse:
    ...
    if "builtInSlotTypeSummaries" in data:
        ...
        out["built_in_slot_type_summaries"] = (
            capo_lex_models_v2.types.built_in_slot_type_summary_list.deserialize_json(
