...
class FulfillmentCodeHookSettings(TypedDict, closed=True):
    ...
    post_fulfillment_status_specification: NotRequired[
        "capo_lex_models_v2.types.post_fulfillment_status_specification.PostFulfillmentStatusSpecification"
    ]
    ...
    fulfillment_updates_specification: NotRequired[
        "capo_lex_models_v2.types.fulfillment_updates_specification.FulfillmentUpdatesSpecification"
    ]
...
def serialize_json(value: FulfillmentCodeHookSettings) -> dict:
    ...
    if "post_fulfillment_status_specification" in value:
        ...
        out["postFulfillmentStatusSpecification"] = (
            capo_lex_models_v2.types.post_fulfillment_status_specification.serialize_json(
    ...
    if "fulfillment_updates_specification" in value:
        ...
        out["fulfillmentUpdatesSpecification"] = (
            capo_lex_models_v2.types.fulfillment_updates_specification.serialize_json(
...
def deserialize_json(data: dict) -> FulfillmentCodeHookSettings:
    ...
    if "postFulfillmentStatusSpecification" in data:
        ...
        out["post_fulfillment_status_specification"] = (
            capo_lex_models_v2.types.post_fulfillment_status_specification.deserialize_json(
    ...
    if "fulfillmentUpdatesSpecification" in data:
        ...
        out["fulfillment_updates_specification"] = (
            capo_lex_models_v2.types.fulfillment_updates_specification.deserialize_json(
