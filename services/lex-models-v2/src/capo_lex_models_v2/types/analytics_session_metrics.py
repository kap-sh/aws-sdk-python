...
if TYPE_CHECKING:
    import capo_lex_models_v2.types.analytics_session_metric

AnalyticsSessionMetrics: TypeAlias = list[
    "capo_lex_models_v2.types.analytics_session_metric.AnalyticsSessionMetric"
]
...
def serialize_json(value: AnalyticsSessionMetrics) -> list:
    ...
    for item in value:
        out.append(
            capo_lex_models_v2.types.analytics_session_metric.serialize_json(item)
        )
    return out
