...
if TYPE_CHECKING:
    import capo_lex_models_v2.types.test_set_slot_discrepancy_item

TestSetSlotDiscrepancyList: TypeAlias = list[
    "capo_lex_models_v2.types.test_set_slot_discrepancy_item.TestSetSlotDiscrepancyItem"
]
...
def serialize_json(value: TestSetSlotDiscrepancyList) -> list:
    ...
    for item in value:
        out.append(
            capo_lex_models_v2.types.test_set_slot_discrepancy_item.serialize_json(item)
        )
    return out
