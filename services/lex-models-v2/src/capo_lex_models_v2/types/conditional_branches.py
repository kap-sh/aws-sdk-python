...
if TYPE_CHECKING:
    import capo_lex_models_v2.types.conditional_branch

ConditionalBranches: TypeAlias = list[
    "capo_lex_models_v2.types.conditional_branch.ConditionalBranch"
]
...
def serialize_json(value: ConditionalBranches) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_lex_models_v2.types.conditional_branch.serialize_json(item))
    return out
