...
if TYPE_CHECKING:
    import capo_lex_models_v2.types.slot_resolution_test_result_item

SlotResolutionTestResultItems: TypeAlias = list[
    "capo_lex_models_v2.types.slot_resolution_test_result_item.SlotResolutionTestResultItem"
]
...
def serialize_json(value: SlotResolutionTestResultItems) -> list:
    ...
    for item in value:
        out.append(
            capo_lex_models_v2.types.slot_resolution_test_result_item.serialize_json(
                item
            )
        )
    return out
