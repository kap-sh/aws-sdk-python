...
class ListTestSetRecordsResponse(TypedDict, closed=True):
    test_set_records: NotRequired[
        "capo_lex_models_v2.types.test_set_turn_record_list.TestSetTurnRecordList"
    ]
...
def serialize_json(value: ListTestSetRecordsResponse) -> dict:
    ...
    if "test_set_records" in value:
        ...
        out["testSetRecords"] = (
            capo_lex_models_v2.types.test_set_turn_record_list.serialize_json(
...
def deserialize_json(data: dict) -> ListTestSetRecordsResponse:
    ...
    if "testSetRecords" in data:
        ...
        out["test_set_records"] = (
            capo_lex_models_v2.types.test_set_turn_record_list.deserialize_json(
                data["testSetRecords"]
            )
        )
