"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeSlotTypeResponse``."""
...
class DescribeSlotTypeResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeSlotTypeResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DescribeSlotTypeResponse:
    out: DescribeSlotTypeResponse = {}  # type: ignore[typeddict-item]
