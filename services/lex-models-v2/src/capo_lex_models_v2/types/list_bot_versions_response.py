...
class ListBotVersionsResponse(TypedDict, closed=True):
    ...
    bot_version_summaries: NotRequired[
        "capo_lex_models_v2.types.bot_version_summary_list.BotVersionSummaryList"
    ]
...
def serialize_json(value: ListBotVersionsResponse) -> dict:
    ...
    if "bot_version_summaries" in value:
        ...
        out["botVersionSummaries"] = (
            capo_lex_models_v2.types.bot_version_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListBotVersionsResponse:
    ...
    if "botVersionSummaries" in data:
        ...
        out["bot_version_summaries"] = (
            capo_lex_models_v2.types.bot_version_summary_list.deserialize_json(
