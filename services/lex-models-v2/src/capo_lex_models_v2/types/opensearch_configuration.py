...
if TYPE_CHECKING:
    ...
    import capo_lex_models_v2.types.domain_endpoint
    import capo_lex_models_v2.types.exact_response_fields
    import capo_lex_models_v2.types.os_include_fields
    import capo_lex_models_v2.types.os_index_name


class OpensearchConfiguration(TypedDict, closed=True):
    domain_endpoint: "capo_lex_models_v2.types.domain_endpoint.DomainEndpoint"
    """<p>The endpoint of the Amazon OpenSearch Service domain.</p>"""
    index_name: "capo_lex_models_v2.types.os_index_name.OSIndexName"
    ...
    exact_response_fields: NotRequired[
        "capo_lex_models_v2.types.exact_response_fields.ExactResponseFields"
    ]
    """<p>Contains the names of the fields used for an exact response to the user.</p>"""
    include_fields: NotRequired[
        "capo_lex_models_v2.types.os_include_fields.OSIncludeFields"
    ]
...
def serialize_json(value: OpensearchConfiguration) -> dict:
    ...
    if "exact_response_fields" in value:
        ...
        out["exactResponseFields"] = (
            capo_lex_models_v2.types.exact_response_fields.serialize_json(
    ...
    if "include_fields" in value:
        ...
        out["includeFields"] = (
            capo_lex_models_v2.types.os_include_fields.serialize_json(
...
def deserialize_json(data: dict) -> OpensearchConfiguration:
    ...
    if "exactResponseFields" in data:
        ...
        out["exact_response_fields"] = (
            capo_lex_models_v2.types.exact_response_fields.deserialize_json(
    ...
    if "includeFields" in data:
        ...
        out["include_fields"] = (
            capo_lex_models_v2.types.os_include_fields.deserialize_json(
                data["includeFields"]
            )
        )
    return out
