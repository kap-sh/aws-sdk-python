...
if TYPE_CHECKING:
    import capo_lex_models_v2.types.transcript


class AssociatedTranscript(TypedDict, closed=True):
    transcript: NotRequired["capo_lex_models_v2.types.transcript.Transcript"]
