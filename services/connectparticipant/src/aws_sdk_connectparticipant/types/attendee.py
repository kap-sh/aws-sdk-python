...
if TYPE_CHECKING:
    import aws_sdk_connectparticipant.types.attendee_id
    import aws_sdk_connectparticipant.types.join_token


class Attendee(TypedDict):
    attendee_id: NotRequired["aws_sdk_connectparticipant.types.attendee_id.AttendeeId"]
    """<p>The Amazon Chime SDK attendee ID.</p>"""
    join_token: NotRequired["aws_sdk_connectparticipant.types.join_token.JoinToken"]
