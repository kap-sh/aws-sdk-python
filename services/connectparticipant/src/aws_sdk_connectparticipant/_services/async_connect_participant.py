...
class AsyncConnectParticipantClientConfig(TypedDict, total=False):
...
class AsyncConnectParticipantClient:
    ...
    def __init__(
        ...
        self.config = AsyncConnectParticipantClientConfig(
            {
    ...
    async def cancel_participant_authentication(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_connectparticipant.types.cancel_participant_authentication_request.CancelParticipantAuthenticationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_connectparticipant.types.cancel_participant_authentication_response.CancelParticipantAuthenticationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_connectparticipant._operations.amazon_connect_participant_service_lambda.cancel_participant_authentication.async_cancel_participant_authentication(
    ...
    async def complete_attachment_upload(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_connectparticipant.types.complete_attachment_upload_request.CompleteAttachmentUploadRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_connectparticipant.types.complete_attachment_upload_response.CompleteAttachmentUploadResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_connectparticipant._operations.amazon_connect_participant_service_lambda.complete_attachment_upload.async_complete_attachment_upload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_participant_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_connectparticipant.types.create_participant_connection_request.CreateParticipantConnectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_connectparticipant.types.create_participant_connection_response.CreateParticipantConnectionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_connectparticipant._operations.amazon_connect_participant_service_lambda.create_participant_connection.async_create_participant_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_view(
        ...
        *,
        ...
        """<p>Retrieves the view for the specified view token.</p> <p>For security recommendations, see <a href=\"https://docs.aws.amazon.com/connect/latest/adminguide/security-best-practices.html#bp-security-chat\">Connect Customer Chat security best practices</a>. </p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_connectparticipant.types.describe_view_request.DescribeViewRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_connectparticipant.types.describe_view_response.DescribeViewResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_connectparticipant._operations.amazon_connect_participant_service_lambda.describe_view.async_describe_view(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disconnect_participant(
        ...
        *,
        ...
        """<p>Disconnects a participant. </p> <p>For security recommendations, see <a href=\"https://docs.aws.amazon.com/connect/latest/adminguide/security-best-practices.html#bp-security-chat\">Connect Customer Chat security best practices</a>. </p> <note> <p> <code>ConnectionToken</code> is used for invoking this API instead of <code>ParticipantToken</code>.</p> </note> <p>The Amazon Connect Participant Service APIs do not use <a href=\"https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html\">Signature Version 4 authentication</a>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_connectparticipant.types.disconnect_participant_request.DisconnectParticipantRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_connectparticipant.types.disconnect_participant_response.DisconnectParticipantResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_connectparticipant._operations.amazon_connect_participant_service_lambda.disconnect_participant.async_disconnect_participant(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_attachment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_connectparticipant.types.get_attachment_request.GetAttachmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_connectparticipant.types.get_attachment_response.GetAttachmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_connectparticipant._operations.amazon_connect_participant_service_lambda.get_attachment.async_get_attachment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_authentication_url(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_connectparticipant.types.get_authentication_url_request.GetAuthenticationUrlRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_connectparticipant.types.get_authentication_url_response.GetAuthenticationUrlResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_connectparticipant._operations.amazon_connect_participant_service_lambda.get_authentication_url.async_get_authentication_url(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_transcript(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_connectparticipant.types.get_transcript_request.GetTranscriptRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_connectparticipant.types.get_transcript_response.GetTranscriptResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_connectparticipant._operations.amazon_connect_participant_service_lambda.get_transcript.async_get_transcript(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def send_event(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_connectparticipant.types.send_event_request.SendEventRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_connectparticipant.types.send_event_response.SendEventResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_connectparticipant._operations.amazon_connect_participant_service_lambda.send_event.async_send_event(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def send_message(
        ...
        *,
        ...
        """<p>Sends a message.</p> <p>For security recommendations, see <a href=\"https://docs.aws.amazon.com/connect/latest/adminguide/security-best-practices.html#bp-security-chat\">Connect Customer Chat security best practices</a>. </p> <note> <p> <code>ConnectionToken</code> is used for invoking this API instead of <code>ParticipantToken</code>.</p> </note> <p>The Amazon Connect Participant Service APIs do not use <a href=\"https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html\">Signature Version 4 authentication</a>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_connectparticipant.types.send_message_request.SendMessageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_connectparticipant.types.send_message_response.SendMessageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_connectparticipant._operations.amazon_connect_participant_service_lambda.send_message.async_send_message(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_attachment_upload(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_connectparticipant.types.start_attachment_upload_request.StartAttachmentUploadRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_connectparticipant.types.start_attachment_upload_response.StartAttachmentUploadResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_connectparticipant._operations.amazon_connect_participant_service_lambda.start_attachment_upload.async_start_attachment_upload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
