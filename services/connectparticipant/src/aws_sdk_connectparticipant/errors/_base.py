...
class ConnectParticipantError(Exception):
    """Base class for all ConnectParticipant service errors."""


class ServiceError(ConnectParticipantError):
...
class SerializationError(ConnectParticipantError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ConnectParticipantError):
...
class WaiterFailedError(ConnectParticipantError):
...
class WaiterTimeoutError(ConnectParticipantError):
