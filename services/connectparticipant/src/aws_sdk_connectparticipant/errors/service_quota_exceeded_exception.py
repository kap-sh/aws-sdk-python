"""Generated from Smithy shape ``com.amazonaws.connectparticipant#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.connectparticipant#ServiceQuotaExceededException``."""
