...
```
pip install aws-sdk-connectparticipant
```

## Usage

```python
from aws_sdk_connectparticipant import AsyncConnectParticipantClient
...
```python
from aws_sdk_connectparticipant import AsyncConnectParticipantClient
from aws_sdk_connectparticipant.error import AccessDeniedException
