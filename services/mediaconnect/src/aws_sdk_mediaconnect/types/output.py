...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconnect.types.__list_of_media_stream_output_configuration
...
class Output(TypedDict):
    ...
    media_stream_output_configurations: NotRequired[
        "aws_sdk_mediaconnect.types.__list_of_media_stream_output_configuration.__listOfMediaStreamOutputConfiguration"
    ]
    ...
    bridge_ports: NotRequired[
        "aws_sdk_mediaconnect.types.__list_of_integer.__listOfInteger"
    ]
...
def serialize_json(value: Output) -> dict:
    ...
    if "media_stream_output_configurations" in value:
        ...
        out["mediaStreamOutputConfigurations"] = (
            aws_sdk_mediaconnect.types.__list_of_media_stream_output_configuration.serialize_json(
    ...
    if "bridge_ports" in value:
        ...
        out["bridgePorts"] = (
            aws_sdk_mediaconnect.types.__list_of_integer.serialize_json(
                value["bridge_ports"]
            )
        )
...
def deserialize_json(data: dict) -> Output:
    ...
    if "mediaStreamOutputConfigurations" in data:
        ...
        out["media_stream_output_configurations"] = (
            aws_sdk_mediaconnect.types.__list_of_media_stream_output_configuration.deserialize_json(
    ...
    if "bridgePorts" in data:
        ...
        out["bridge_ports"] = (
            aws_sdk_mediaconnect.types.__list_of_integer.deserialize_json(
                data["bridgePorts"]
            )
        )
