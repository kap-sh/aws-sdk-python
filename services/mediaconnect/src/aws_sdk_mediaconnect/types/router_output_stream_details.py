...
class _RouterOutputStreamDetails_Standard(TypedDict):
    Standard: "aws_sdk_mediaconnect.types.standard_router_output_stream_details.StandardRouterOutputStreamDetails"


class _RouterOutputStreamDetails_MediaConnectFlow(TypedDict):
...
class _RouterOutputStreamDetails_MediaLiveInput(TypedDict):
