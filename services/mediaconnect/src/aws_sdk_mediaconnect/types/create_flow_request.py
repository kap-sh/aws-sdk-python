...
class CreateFlowRequest(TypedDict):
    ...
    entitlements: NotRequired["aws_sdk_mediaconnect.types.__list_of_grant_entitlement_request.__listOfGrantEntitlementRequest"]
    ...
    source: NotRequired["aws_sdk_mediaconnect.types.set_source_request.SetSourceRequest"]
    ...
    maintenance: NotRequired["aws_sdk_mediaconnect.types.add_maintenance.AddMaintenance"]
    """<p> The maintenance settings you want to use for the flow. </p>"""
    source_monitoring_config: NotRequired["aws_sdk_mediaconnect.types.monitoring_config.MonitoringConfig"]
    ...
    encoding_config: NotRequired["aws_sdk_mediaconnect.types.encoding_config.EncodingConfig"]
    flow_tags: NotRequired["aws_sdk_mediaconnect.types.__map_of_string.__mapOfString"]
...
def serialize_json(value: CreateFlowRequest) -> dict:
    ...
    if "entitlements" in value:
        import aws_sdk_mediaconnect.types.__list_of_grant_entitlement_request
        out["entitlements"] = aws_sdk_mediaconnect.types.__list_of_grant_entitlement_request.serialize_json(value["entitlements"])
    ...
    if "source" in value:
        import aws_sdk_mediaconnect.types.set_source_request
        out["source"] = aws_sdk_mediaconnect.types.set_source_request.serialize_json(value["source"])
    ...
    if "maintenance" in value:
        import aws_sdk_mediaconnect.types.add_maintenance
        out["maintenance"] = aws_sdk_mediaconnect.types.add_maintenance.serialize_json(value["maintenance"])
    if "source_monitoring_config" in value:
        import aws_sdk_mediaconnect.types.monitoring_config
        out["sourceMonitoringConfig"] = aws_sdk_mediaconnect.types.monitoring_config.serialize_json(value["source_monitoring_config"])
    if "flow_size" in value:
        import aws_sdk_mediaconnect.types.flow_size
        out["flowSize"] = aws_sdk_mediaconnect.types.flow_size.serialize_json(value["flow_size"])
    if "ndi_config" in value:
        import aws_sdk_mediaconnect.types.ndi_config
        out["ndiConfig"] = aws_sdk_mediaconnect.types.ndi_config.serialize_json(value["ndi_config"])
    if "encoding_config" in value:
        import aws_sdk_mediaconnect.types.encoding_config
        out["encodingConfig"] = aws_sdk_mediaconnect.types.encoding_config.serialize_json(value["encoding_config"])
    if "flow_tags" in value:
        import aws_sdk_mediaconnect.types.__map_of_string
        out["flowTags"] = aws_sdk_mediaconnect.types.__map_of_string.serialize_json(value["flow_tags"])
    return out
...
def deserialize_json(data: dict) -> CreateFlowRequest:
    ...
    if "entitlements" in data:
        import aws_sdk_mediaconnect.types.__list_of_grant_entitlement_request
        out["entitlements"] = aws_sdk_mediaconnect.types.__list_of_grant_entitlement_request.deserialize_json(data["entitlements"])
    ...
    if "source" in data:
        import aws_sdk_mediaconnect.types.set_source_request
        out["source"] = aws_sdk_mediaconnect.types.set_source_request.deserialize_json(data["source"])
    ...
    if "maintenance" in data:
        import aws_sdk_mediaconnect.types.add_maintenance
        out["maintenance"] = aws_sdk_mediaconnect.types.add_maintenance.deserialize_json(data["maintenance"])
    if "sourceMonitoringConfig" in data:
        import aws_sdk_mediaconnect.types.monitoring_config
        out["source_monitoring_config"] = aws_sdk_mediaconnect.types.monitoring_config.deserialize_json(data["sourceMonitoringConfig"])
    if "flowSize" in data:
        import aws_sdk_mediaconnect.types.flow_size
        out["flow_size"] = aws_sdk_mediaconnect.types.flow_size.deserialize_json(data["flowSize"])
    if "ndiConfig" in data:
        import aws_sdk_mediaconnect.types.ndi_config
        out["ndi_config"] = aws_sdk_mediaconnect.types.ndi_config.deserialize_json(data["ndiConfig"])
    if "encodingConfig" in data:
        import aws_sdk_mediaconnect.types.encoding_config
        out["encoding_config"] = aws_sdk_mediaconnect.types.encoding_config.deserialize_json(data["encodingConfig"])
    if "flowTags" in data:
        import aws_sdk_mediaconnect.types.__map_of_string
        out["flow_tags"] = aws_sdk_mediaconnect.types.__map_of_string.deserialize_json(data["flowTags"])
    return out