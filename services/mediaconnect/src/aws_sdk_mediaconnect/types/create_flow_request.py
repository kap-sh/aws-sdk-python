...
def serialize_json(value: CreateFlowRequest) -> dict:
    ...
    if "source" in value:
        ...
        out["source"] = aws_sdk_mediaconnect.types.set_source_request.serialize_json(
            value["source"]
        )
    ...
    if "maintenance" in value:
        ...
        out["maintenance"] = aws_sdk_mediaconnect.types.add_maintenance.serialize_json(
            value["maintenance"]
        )
    ...
    if "flow_tags" in value:
        ...
        out["flowTags"] = aws_sdk_mediaconnect.types.__map_of_string.serialize_json(
            value["flow_tags"]
        )
    return out
...
def deserialize_json(data: dict) -> CreateFlowRequest:
    ...
    if "source" in data:
        ...
        out["source"] = aws_sdk_mediaconnect.types.set_source_request.deserialize_json(
            data["source"]
        )
    ...
    if "maintenance" in data:
        ...
        out["maintenance"] = (
            aws_sdk_mediaconnect.types.add_maintenance.deserialize_json(
                data["maintenance"]
            )
        )
    ...
    if "flowTags" in data:
        ...
        out["flow_tags"] = aws_sdk_mediaconnect.types.__map_of_string.deserialize_json(
            data["flowTags"]
        )
    return out
