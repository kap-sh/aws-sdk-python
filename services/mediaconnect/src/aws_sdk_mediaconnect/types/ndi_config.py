...
class NdiConfig(TypedDict, closed=True):
    ...
    ndi_discovery_servers: NotRequired[
        "aws_sdk_mediaconnect.types.__list_of_ndi_discovery_server_config.__listOfNdiDiscoveryServerConfig"
    ]
...
def serialize_json(value: NdiConfig) -> dict:
    ...
    if "ndi_state" in value:
        ...
        out["ndiState"] = aws_sdk_mediaconnect.types.ndi_state.serialize_json(
            value["ndi_state"]
        )
    ...
    if "ndi_discovery_servers" in value:
        ...
        out["ndiDiscoveryServers"] = (
            aws_sdk_mediaconnect.types.__list_of_ndi_discovery_server_config.serialize_json(
...
def deserialize_json(data: dict) -> NdiConfig:
    ...
    if "ndiState" in data:
        ...
        out["ndi_state"] = aws_sdk_mediaconnect.types.ndi_state.deserialize_json(
            data["ndiState"]
        )
    ...
    if "ndiDiscoveryServers" in data:
        ...
        out["ndi_discovery_servers"] = (
            aws_sdk_mediaconnect.types.__list_of_ndi_discovery_server_config.deserialize_json(
