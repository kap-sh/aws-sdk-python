...
class AddOutputRequest(TypedDict):
    cidr_allow_list: NotRequired["aws_sdk_mediaconnect.types.__list_of_string.__listOfString"]
    ...
    media_stream_output_configurations: NotRequired["aws_sdk_mediaconnect.types.__list_of_media_stream_output_configuration_request.__listOfMediaStreamOutputConfigurationRequest"]
    ...
    vpc_interface_attachment: NotRequired["aws_sdk_mediaconnect.types.vpc_interface_attachment.VpcInterfaceAttachment"]
    ...
    router_integration_transit_encryption: NotRequired["aws_sdk_mediaconnect.types.flow_transit_encryption.FlowTransitEncryption"]
    ndi_output_timecode_source: NotRequired["aws_sdk_mediaconnect.types.ndi_output_timecode_source.NdiOutputTimecodeSource"]
...
def serialize_json(value: AddOutputRequest) -> dict:
    ...
    if "cidr_allow_list" in value:
        import aws_sdk_mediaconnect.types.__list_of_string
        out["cidrAllowList"] = aws_sdk_mediaconnect.types.__list_of_string.serialize_json(value["cidr_allow_list"])
    ...
    if "encryption" in value:
        import aws_sdk_mediaconnect.types.encryption
        out["encryption"] = aws_sdk_mediaconnect.types.encryption.serialize_json(value["encryption"])
    if "max_latency" in value:
        out["maxLatency"] = value["max_latency"]
    if "media_stream_output_configurations" in value:
        import aws_sdk_mediaconnect.types.__list_of_media_stream_output_configuration_request
        out["mediaStreamOutputConfigurations"] = aws_sdk_mediaconnect.types.__list_of_media_stream_output_configuration_request.serialize_json(value["media_stream_output_configurations"])
    ...
    if "vpc_interface_attachment" in value:
        import aws_sdk_mediaconnect.types.vpc_interface_attachment
        out["vpcInterfaceAttachment"] = aws_sdk_mediaconnect.types.vpc_interface_attachment.serialize_json(value["vpc_interface_attachment"])
    if "output_status" in value:
        import aws_sdk_mediaconnect.types.output_status
        out["outputStatus"] = aws_sdk_mediaconnect.types.output_status.serialize_json(value["output_status"])
    ...
    if "output_tags" in value:
        import aws_sdk_mediaconnect.types.__map_of_string
        out["outputTags"] = aws_sdk_mediaconnect.types.__map_of_string.serialize_json(value["output_tags"])
    if "router_integration_state" in value:
        import aws_sdk_mediaconnect.types.state
        out["routerIntegrationState"] = aws_sdk_mediaconnect.types.state.serialize_json(value["router_integration_state"])
    if "router_integration_transit_encryption" in value:
        import aws_sdk_mediaconnect.types.flow_transit_encryption
        out["routerIntegrationTransitEncryption"] = aws_sdk_mediaconnect.types.flow_transit_encryption.serialize_json(value["router_integration_transit_encryption"])
    if "ndi_output_timecode_source" in value:
        import aws_sdk_mediaconnect.types.ndi_output_timecode_source
        out["ndiOutputTimecodeSource"] = aws_sdk_mediaconnect.types.ndi_output_timecode_source.serialize_json(value["ndi_output_timecode_source"])
    return out
...
def deserialize_json(data: dict) -> AddOutputRequest:
    ...
    if "cidrAllowList" in data:
        import aws_sdk_mediaconnect.types.__list_of_string
        out["cidr_allow_list"] = aws_sdk_mediaconnect.types.__list_of_string.deserialize_json(data["cidrAllowList"])
    ...
    if "encryption" in data:
        import aws_sdk_mediaconnect.types.encryption
        out["encryption"] = aws_sdk_mediaconnect.types.encryption.deserialize_json(data["encryption"])
    if "maxLatency" in data:
        out["max_latency"] = data["maxLatency"]
    if "mediaStreamOutputConfigurations" in data:
        import aws_sdk_mediaconnect.types.__list_of_media_stream_output_configuration_request
        out["media_stream_output_configurations"] = aws_sdk_mediaconnect.types.__list_of_media_stream_output_configuration_request.deserialize_json(data["mediaStreamOutputConfigurations"])
    ...
    if "vpcInterfaceAttachment" in data:
        import aws_sdk_mediaconnect.types.vpc_interface_attachment
        out["vpc_interface_attachment"] = aws_sdk_mediaconnect.types.vpc_interface_attachment.deserialize_json(data["vpcInterfaceAttachment"])
    if "outputStatus" in data:
        import aws_sdk_mediaconnect.types.output_status
        out["output_status"] = aws_sdk_mediaconnect.types.output_status.deserialize_json(data["outputStatus"])
    ...
    if "outputTags" in data:
        import aws_sdk_mediaconnect.types.__map_of_string
        out["output_tags"] = aws_sdk_mediaconnect.types.__map_of_string.deserialize_json(data["outputTags"])
    if "routerIntegrationState" in data:
        import aws_sdk_mediaconnect.types.state
        out["router_integration_state"] = aws_sdk_mediaconnect.types.state.deserialize_json(data["routerIntegrationState"])
    if "routerIntegrationTransitEncryption" in data:
        import aws_sdk_mediaconnect.types.flow_transit_encryption
        out["router_integration_transit_encryption"] = aws_sdk_mediaconnect.types.flow_transit_encryption.deserialize_json(data["routerIntegrationTransitEncryption"])
    if "ndiOutputTimecodeSource" in data:
        import aws_sdk_mediaconnect.types.ndi_output_timecode_source
        out["ndi_output_timecode_source"] = aws_sdk_mediaconnect.types.ndi_output_timecode_source.deserialize_json(data["ndiOutputTimecodeSource"])
    return out