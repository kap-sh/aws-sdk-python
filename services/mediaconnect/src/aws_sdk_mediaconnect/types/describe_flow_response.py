...
def serialize_json(value: DescribeFlowResponse) -> dict:
    ...
    if "messages" in value:
        import aws_sdk_mediaconnect.types.messages
        out["messages"] = aws_sdk_mediaconnect.types.messages.serialize_json(value["messages"])
    return out
...
def deserialize_json(data: dict) -> DescribeFlowResponse:
    ...
    if "messages" in data:
        import aws_sdk_mediaconnect.types.messages
        out["messages"] = aws_sdk_mediaconnect.types.messages.deserialize_json(data["messages"])
    return out