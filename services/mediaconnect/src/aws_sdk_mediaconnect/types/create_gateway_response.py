...
def serialize_json(value: CreateGatewayResponse) -> dict:
    ...
    if "gateway" in value:
        import aws_sdk_mediaconnect.types.gateway
        out["gateway"] = aws_sdk_mediaconnect.types.gateway.serialize_json(value["gateway"])
    return out
...
def deserialize_json(data: dict) -> CreateGatewayResponse:
    ...
    if "gateway" in data:
        import aws_sdk_mediaconnect.types.gateway
        out["gateway"] = aws_sdk_mediaconnect.types.gateway.deserialize_json(data["gateway"])
    return out