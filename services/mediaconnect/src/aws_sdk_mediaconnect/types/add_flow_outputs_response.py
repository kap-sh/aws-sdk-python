...
def serialize_json(value: AddFlowOutputsResponse) -> dict:
    ...
    if "outputs" in value:
        import aws_sdk_mediaconnect.types.__list_of_output
        out["outputs"] = aws_sdk_mediaconnect.types.__list_of_output.serialize_json(value["outputs"])
    return out
...
def deserialize_json(data: dict) -> AddFlowOutputsResponse:
    ...
    if "outputs" in data:
        import aws_sdk_mediaconnect.types.__list_of_output
        out["outputs"] = aws_sdk_mediaconnect.types.__list_of_output.deserialize_json(data["outputs"])
    return out