...
def serialize_json(value: BatchGetRouterNetworkInterfaceResponse) -> dict:
    ...
    out["routerNetworkInterfaces"] = (
        aws_sdk_mediaconnect.types.router_network_interface_list.serialize_json(
    ...
    out["errors"] = (
        aws_sdk_mediaconnect.types.batch_get_router_network_interface_error_list.serialize_json(
            value["errors"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> BatchGetRouterNetworkInterfaceResponse:
    ...
    if "routerNetworkInterfaces" in data:
        ...
        out["router_network_interfaces"] = (
            aws_sdk_mediaconnect.types.router_network_interface_list.deserialize_json(
    ...
    if "errors" in data:
        ...
        out["errors"] = (
            aws_sdk_mediaconnect.types.batch_get_router_network_interface_error_list.deserialize_json(
                data["errors"]
            )
        )
    else:
