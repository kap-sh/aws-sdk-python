"""Generated from Smithy shape ``com.amazonaws.mediaconnect#SetGatewayBridgeSourceRequest``."""
...
class SetGatewayBridgeSourceRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: SetGatewayBridgeSourceRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> SetGatewayBridgeSourceRequest:
    out: SetGatewayBridgeSourceRequest = {}  # type: ignore[typeddict-item]
