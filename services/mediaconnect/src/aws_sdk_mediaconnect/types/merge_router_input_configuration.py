...
if TYPE_CHECKING:
    import aws_sdk_mediaconnect.types.merge_router_input_protocol_configuration_list
...
def serialize_json(value: MergeRouterInputConfiguration) -> dict:
    ...
    out["protocolConfigurations"] = (
        aws_sdk_mediaconnect.types.merge_router_input_protocol_configuration_list.serialize_json(
...
def deserialize_json(data: dict) -> MergeRouterInputConfiguration:
    ...
    if "protocolConfigurations" in data:
        ...
        out["protocol_configurations"] = (
            aws_sdk_mediaconnect.types.merge_router_input_protocol_configuration_list.deserialize_json(
