...
class AddBridgeOutputRequest(TypedDict):
    network_output: NotRequired["aws_sdk_mediaconnect.types.add_bridge_network_output_request.AddBridgeNetworkOutputRequest"]
...
def serialize_json(value: AddBridgeOutputRequest) -> dict:
    ...
    if "network_output" in value:
        import aws_sdk_mediaconnect.types.add_bridge_network_output_request
        out["networkOutput"] = aws_sdk_mediaconnect.types.add_bridge_network_output_request.serialize_json(value["network_output"])
    return out
...
def deserialize_json(data: dict) -> AddBridgeOutputRequest:
    ...
    if "networkOutput" in data:
        import aws_sdk_mediaconnect.types.add_bridge_network_output_request
        out["network_output"] = aws_sdk_mediaconnect.types.add_bridge_network_output_request.deserialize_json(data["networkOutput"])
    return out