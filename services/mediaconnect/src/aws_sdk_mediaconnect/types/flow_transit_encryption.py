...
if TYPE_CHECKING:
    import aws_sdk_mediaconnect.types.flow_transit_encryption_key_configuration
    import aws_sdk_mediaconnect.types.flow_transit_encryption_key_type


class FlowTransitEncryption(TypedDict):
    encryption_key_type: NotRequired[
        "aws_sdk_mediaconnect.types.flow_transit_encryption_key_type.FlowTransitEncryptionKeyType"
    ]
    """<p>The type of encryption key to use for flow transit encryption.</p>"""
    encryption_key_configuration: "aws_sdk_mediaconnect.types.flow_transit_encryption_key_configuration.FlowTransitEncryptionKeyConfiguration"
...
def serialize_json(value: FlowTransitEncryption) -> dict:
    ...
    if "encryption_key_type" in value:
        ...
        out["encryptionKeyType"] = (
            aws_sdk_mediaconnect.types.flow_transit_encryption_key_type.serialize_json(
    ...
    out["encryptionKeyConfiguration"] = (
        aws_sdk_mediaconnect.types.flow_transit_encryption_key_configuration.serialize_json(
...
def deserialize_json(data: dict) -> FlowTransitEncryption:
    ...
    if "encryptionKeyType" in data:
        ...
        out["encryption_key_type"] = (
            aws_sdk_mediaconnect.types.flow_transit_encryption_key_type.deserialize_json(
    ...
    if "encryptionKeyConfiguration" in data:
        ...
        out["encryption_key_configuration"] = (
            aws_sdk_mediaconnect.types.flow_transit_encryption_key_configuration.deserialize_json(
