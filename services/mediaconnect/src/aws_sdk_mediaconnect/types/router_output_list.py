...
RouterOutputList: TypeAlias = list[
    "aws_sdk_mediaconnect.types.router_output.RouterOutput"
]
...
def serialize_json(value: RouterOutputList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_mediaconnect.types.router_output.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> RouterOutputList:
    ...
    for item in data:
        out.append(aws_sdk_mediaconnect.types.router_output.deserialize_json(item))
    return out
