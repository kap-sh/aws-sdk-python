...
class CreateRouterInputResponse(TypedDict):
...
def serialize_json(value: CreateRouterInputResponse) -> dict:
    out: dict = {}
    import aws_sdk_mediaconnect.types.router_input
    out["routerInput"] = aws_sdk_mediaconnect.types.router_input.serialize_json(value["router_input"])
    return out
...
def deserialize_json(data: dict) -> CreateRouterInputResponse:
    ...
    if "routerInput" in data:
        import aws_sdk_mediaconnect.types.router_input
        out["router_input"] = aws_sdk_mediaconnect.types.router_input.deserialize_json(data["routerInput"])
    else:
