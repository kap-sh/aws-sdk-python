...
BatchGetRouterInputErrorList: TypeAlias = list[
    "aws_sdk_mediaconnect.types.batch_get_router_input_error.BatchGetRouterInputError"
]
...
def serialize_json(value: BatchGetRouterInputErrorList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_mediaconnect.types.batch_get_router_input_error.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> BatchGetRouterInputErrorList:
    ...
    for item in data:
        out.append(
            aws_sdk_mediaconnect.types.batch_get_router_input_error.deserialize_json(
                item
            )
        )
    return out
