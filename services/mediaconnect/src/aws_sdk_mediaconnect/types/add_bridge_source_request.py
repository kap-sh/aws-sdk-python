...
class AddBridgeSourceRequest(TypedDict):
    flow_source: NotRequired[
        "aws_sdk_mediaconnect.types.add_bridge_flow_source_request.AddBridgeFlowSourceRequest"
    ]
    """<p> The source of the flow. </p>"""
    network_source: NotRequired[
        "aws_sdk_mediaconnect.types.add_bridge_network_source_request.AddBridgeNetworkSourceRequest"
    ]
...
def serialize_json(value: AddBridgeSourceRequest) -> dict:
    ...
    if "flow_source" in value:
        ...
        out["flowSource"] = (
            aws_sdk_mediaconnect.types.add_bridge_flow_source_request.serialize_json(
                value["flow_source"]
            )
        )
    if "network_source" in value:
        ...
        out["networkSource"] = (
            aws_sdk_mediaconnect.types.add_bridge_network_source_request.serialize_json(
...
def deserialize_json(data: dict) -> AddBridgeSourceRequest:
    ...
    if "flowSource" in data:
        ...
        out["flow_source"] = (
            aws_sdk_mediaconnect.types.add_bridge_flow_source_request.deserialize_json(
                data["flowSource"]
            )
        )
    if "networkSource" in data:
        ...
        out["network_source"] = (
            aws_sdk_mediaconnect.types.add_bridge_network_source_request.deserialize_json(
                data["networkSource"]
            )
        )
    return out
