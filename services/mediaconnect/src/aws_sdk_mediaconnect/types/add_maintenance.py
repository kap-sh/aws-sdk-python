...
class AddMaintenance(TypedDict):
    maintenance_day: NotRequired["aws_sdk_mediaconnect.types.maintenance_day.MaintenanceDay"]
...
def serialize_json(value: AddMaintenance) -> dict:
    ...
    if "maintenance_day" in value:
        import aws_sdk_mediaconnect.types.maintenance_day
        out["maintenanceDay"] = aws_sdk_mediaconnect.types.maintenance_day.serialize_json(value["maintenance_day"])
...
def deserialize_json(data: dict) -> AddMaintenance:
    ...
    if "maintenanceDay" in data:
        import aws_sdk_mediaconnect.types.maintenance_day
        out["maintenance_day"] = aws_sdk_mediaconnect.types.maintenance_day.deserialize_json(data["maintenanceDay"])
