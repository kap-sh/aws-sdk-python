...
class CreateRouterInputRequest(TypedDict):
    name: "str"
    ...
    transit_encryption: NotRequired["aws_sdk_mediaconnect.types.router_input_transit_encryption.RouterInputTransitEncryption"]
    """<p>The transit encryption settings for the router input.</p>"""
    maintenance_configuration: NotRequired["aws_sdk_mediaconnect.types.maintenance_configuration.MaintenanceConfiguration"]
...
def serialize_json(value: CreateRouterInputRequest) -> dict:
    ...
    out["name"] = value["name"]
    import aws_sdk_mediaconnect.types.router_input_configuration
    out["configuration"] = aws_sdk_mediaconnect.types.router_input_configuration.serialize_json(value["configuration"])
    out["maximumBitrate"] = value["maximum_bitrate"]
    import aws_sdk_mediaconnect.types.routing_scope
    out["routingScope"] = aws_sdk_mediaconnect.types.routing_scope.serialize_json(value["routing_scope"])
    import aws_sdk_mediaconnect.types.router_input_tier
    out["tier"] = aws_sdk_mediaconnect.types.router_input_tier.serialize_json(value["tier"])
    ...
    if "transit_encryption" in value:
        import aws_sdk_mediaconnect.types.router_input_transit_encryption
        out["transitEncryption"] = aws_sdk_mediaconnect.types.router_input_transit_encryption.serialize_json(value["transit_encryption"])
    if "maintenance_configuration" in value:
        import aws_sdk_mediaconnect.types.maintenance_configuration
        out["maintenanceConfiguration"] = aws_sdk_mediaconnect.types.maintenance_configuration.serialize_json(value["maintenance_configuration"])
    if "tags" in value:
        import aws_sdk_mediaconnect.types.__map_of_string
        out["tags"] = aws_sdk_mediaconnect.types.__map_of_string.serialize_json(value["tags"])
...
def deserialize_json(data: dict) -> CreateRouterInputRequest:
    ...
    if "configuration" in data:
        import aws_sdk_mediaconnect.types.router_input_configuration
        out["configuration"] = aws_sdk_mediaconnect.types.router_input_configuration.deserialize_json(data["configuration"])
    else:
    ...
    if "routingScope" in data:
        import aws_sdk_mediaconnect.types.routing_scope
        out["routing_scope"] = aws_sdk_mediaconnect.types.routing_scope.deserialize_json(data["routingScope"])
    else:
        raise DeserializationError("CreateRouterInputRequest.routing_scope required")
    if "tier" in data:
        import aws_sdk_mediaconnect.types.router_input_tier
        out["tier"] = aws_sdk_mediaconnect.types.router_input_tier.deserialize_json(data["tier"])
    else:
    ...
    if "transitEncryption" in data:
        import aws_sdk_mediaconnect.types.router_input_transit_encryption
        out["transit_encryption"] = aws_sdk_mediaconnect.types.router_input_transit_encryption.deserialize_json(data["transitEncryption"])
    if "maintenanceConfiguration" in data:
        import aws_sdk_mediaconnect.types.maintenance_configuration
        out["maintenance_configuration"] = aws_sdk_mediaconnect.types.maintenance_configuration.deserialize_json(data["maintenanceConfiguration"])
    if "tags" in data:
        import aws_sdk_mediaconnect.types.__map_of_string
        out["tags"] = aws_sdk_mediaconnect.types.__map_of_string.deserialize_json(data["tags"])
