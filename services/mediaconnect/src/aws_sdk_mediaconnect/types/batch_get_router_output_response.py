...
def serialize_json(value: BatchGetRouterOutputResponse) -> dict:
    out: dict = {}
    import aws_sdk_mediaconnect.types.router_output_list
    out["routerOutputs"] = aws_sdk_mediaconnect.types.router_output_list.serialize_json(value["router_outputs"])
    import aws_sdk_mediaconnect.types.batch_get_router_output_error_list
    out["errors"] = aws_sdk_mediaconnect.types.batch_get_router_output_error_list.serialize_json(value["errors"])
    return out
...
def deserialize_json(data: dict) -> BatchGetRouterOutputResponse:
    ...
    if "routerOutputs" in data:
        import aws_sdk_mediaconnect.types.router_output_list
        out["router_outputs"] = aws_sdk_mediaconnect.types.router_output_list.deserialize_json(data["routerOutputs"])
    else:
        raise DeserializationError("BatchGetRouterOutputResponse.router_outputs required")
    if "errors" in data:
        import aws_sdk_mediaconnect.types.batch_get_router_output_error_list
        out["errors"] = aws_sdk_mediaconnect.types.batch_get_router_output_error_list.deserialize_json(data["errors"])
    else:
