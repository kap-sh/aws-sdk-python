...
__listOfOffering: TypeAlias = list["aws_sdk_mediaconnect.types.offering.Offering"]
...
def serialize_json(value: __listOfOffering) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_mediaconnect.types.offering.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> __listOfOffering:
    ...
    for item in data:
        out.append(aws_sdk_mediaconnect.types.offering.deserialize_json(item))
    return out
