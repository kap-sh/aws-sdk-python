...
class ListOfferingsResponse(TypedDict, closed=True):
    ...
    offerings: NotRequired[
        "aws_sdk_mediaconnect.types.__list_of_offering.__listOfOffering"
    ]
...
def serialize_json(value: ListOfferingsResponse) -> dict:
    ...
    if "offerings" in value:
        ...
        out["offerings"] = aws_sdk_mediaconnect.types.__list_of_offering.serialize_json(
            value["offerings"]
        )
    return out
...
def deserialize_json(data: dict) -> ListOfferingsResponse:
    ...
    if "offerings" in data:
        ...
        out["offerings"] = (
            aws_sdk_mediaconnect.types.__list_of_offering.deserialize_json(
                data["offerings"]
            )
        )
    return out
