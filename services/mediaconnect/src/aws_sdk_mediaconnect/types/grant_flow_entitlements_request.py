...
class GrantFlowEntitlementsRequest(TypedDict):
...
def serialize_json(value: GrantFlowEntitlementsRequest) -> dict:
    ...
    if "entitlements" in value:
        ...
        out["entitlements"] = (
            aws_sdk_mediaconnect.types.__list_of_grant_entitlement_request.serialize_json(
                value["entitlements"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> GrantFlowEntitlementsRequest:
    ...
    if "entitlements" in data:
        ...
        out["entitlements"] = (
            aws_sdk_mediaconnect.types.__list_of_grant_entitlement_request.deserialize_json(
                data["entitlements"]
            )
        )
    return out
