...
class CreateBridgeRequest(TypedDict):
    egress_gateway_bridge: NotRequired["aws_sdk_mediaconnect.types.add_egress_gateway_bridge_request.AddEgressGatewayBridgeRequest"]
    ...
    ingress_gateway_bridge: NotRequired["aws_sdk_mediaconnect.types.add_ingress_gateway_bridge_request.AddIngressGatewayBridgeRequest"]
...
def serialize_json(value: CreateBridgeRequest) -> dict:
    ...
    if "egress_gateway_bridge" in value:
        import aws_sdk_mediaconnect.types.add_egress_gateway_bridge_request
        out["egressGatewayBridge"] = aws_sdk_mediaconnect.types.add_egress_gateway_bridge_request.serialize_json(value["egress_gateway_bridge"])
    if "ingress_gateway_bridge" in value:
        import aws_sdk_mediaconnect.types.add_ingress_gateway_bridge_request
        out["ingressGatewayBridge"] = aws_sdk_mediaconnect.types.add_ingress_gateway_bridge_request.serialize_json(value["ingress_gateway_bridge"])
    if "name" in value:
        out["name"] = value["name"]
    if "outputs" in value:
        import aws_sdk_mediaconnect.types.__list_of_add_bridge_output_request
...
def deserialize_json(data: dict) -> CreateBridgeRequest:
    ...
    if "egressGatewayBridge" in data:
        import aws_sdk_mediaconnect.types.add_egress_gateway_bridge_request
        out["egress_gateway_bridge"] = aws_sdk_mediaconnect.types.add_egress_gateway_bridge_request.deserialize_json(data["egressGatewayBridge"])
    if "ingressGatewayBridge" in data:
        import aws_sdk_mediaconnect.types.add_ingress_gateway_bridge_request
        out["ingress_gateway_bridge"] = aws_sdk_mediaconnect.types.add_ingress_gateway_bridge_request.deserialize_json(data["ingressGatewayBridge"])
    if "name" in data:
        out["name"] = data["name"]
    if "outputs" in data:
        import aws_sdk_mediaconnect.types.__list_of_add_bridge_output_request
