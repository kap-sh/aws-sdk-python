...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateFlowOutputRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateFlowOutputRequest:
    out: UpdateFlowOutputRequest = {}  # type: ignore[typeddict-item]
