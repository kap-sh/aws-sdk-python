...
if TYPE_CHECKING:
    import aws_sdk_mediaconnect.types.input_configuration

__listOfInputConfiguration: TypeAlias = list[
    "aws_sdk_mediaconnect.types.input_configuration.InputConfiguration"
]
...
def serialize_json(value: __listOfInputConfiguration) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_mediaconnect.types.input_configuration.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> __listOfInputConfiguration:
    ...
    for item in data:
        out.append(
            aws_sdk_mediaconnect.types.input_configuration.deserialize_json(item)
        )
    return out
