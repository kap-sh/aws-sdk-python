...
def serialize_json(value: CreateRouterOutputRequest) -> dict:
    ...
    out["name"] = value["name"]
    import aws_sdk_mediaconnect.types.router_output_configuration
    out["configuration"] = aws_sdk_mediaconnect.types.router_output_configuration.serialize_json(value["configuration"])
    ...
    import aws_sdk_mediaconnect.types.router_output_tier
    out["tier"] = aws_sdk_mediaconnect.types.router_output_tier.serialize_json(value["tier"])
...
def deserialize_json(data: dict) -> CreateRouterOutputRequest:
    ...
    if "configuration" in data:
        import aws_sdk_mediaconnect.types.router_output_configuration
        out["configuration"] = aws_sdk_mediaconnect.types.router_output_configuration.deserialize_json(data["configuration"])
    else:
    ...
    if "tier" in data:
        import aws_sdk_mediaconnect.types.router_output_tier
        out["tier"] = aws_sdk_mediaconnect.types.router_output_tier.deserialize_json(data["tier"])
    else:
