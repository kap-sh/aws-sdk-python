...
def serialize_json(value: CreateRouterNetworkInterfaceRequest) -> dict:
    ...
    out["name"] = value["name"]
    import aws_sdk_mediaconnect.types.router_network_interface_configuration
    out["configuration"] = aws_sdk_mediaconnect.types.router_network_interface_configuration.serialize_json(value["configuration"])
...
def deserialize_json(data: dict) -> CreateRouterNetworkInterfaceRequest:
    ...
    if "configuration" in data:
        import aws_sdk_mediaconnect.types.router_network_interface_configuration
        out["configuration"] = aws_sdk_mediaconnect.types.router_network_interface_configuration.deserialize_json(data["configuration"])
    else:
        raise DeserializationError("CreateRouterNetworkInterfaceRequest.configuration required")
