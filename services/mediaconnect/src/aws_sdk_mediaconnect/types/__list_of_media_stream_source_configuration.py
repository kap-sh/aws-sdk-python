...
if TYPE_CHECKING:
    import aws_sdk_mediaconnect.types.media_stream_source_configuration

__listOfMediaStreamSourceConfiguration: TypeAlias = list[
    "aws_sdk_mediaconnect.types.media_stream_source_configuration.MediaStreamSourceConfiguration"
]
...
def serialize_json(value: __listOfMediaStreamSourceConfiguration) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_mediaconnect.types.media_stream_source_configuration.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> __listOfMediaStreamSourceConfiguration:
    ...
    for item in data:
        out.append(
            aws_sdk_mediaconnect.types.media_stream_source_configuration.deserialize_json(
                item
            )
        )
    return out
