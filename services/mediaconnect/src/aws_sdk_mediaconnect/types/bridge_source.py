...
class BridgeSource(TypedDict, closed=True):
    flow_source: NotRequired[
        "aws_sdk_mediaconnect.types.bridge_flow_source.BridgeFlowSource"
    ]
    """<p> The source of the associated flow. </p>"""
    network_source: NotRequired[
        "aws_sdk_mediaconnect.types.bridge_network_source.BridgeNetworkSource"
    ]
...
def serialize_json(value: BridgeSource) -> dict:
    ...
    if "flow_source" in value:
        ...
        out["flowSource"] = (
            aws_sdk_mediaconnect.types.bridge_flow_source.serialize_json(
                value["flow_source"]
            )
        )
    if "network_source" in value:
        ...
        out["networkSource"] = (
            aws_sdk_mediaconnect.types.bridge_network_source.serialize_json(
...
def deserialize_json(data: dict) -> BridgeSource:
    ...
    if "flowSource" in data:
        ...
        out["flow_source"] = (
            aws_sdk_mediaconnect.types.bridge_flow_source.deserialize_json(
                data["flowSource"]
            )
        )
    if "networkSource" in data:
        ...
        out["network_source"] = (
            aws_sdk_mediaconnect.types.bridge_network_source.deserialize_json(
                data["networkSource"]
            )
        )
    return out
