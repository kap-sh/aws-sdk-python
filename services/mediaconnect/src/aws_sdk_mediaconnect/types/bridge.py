...
class Bridge(TypedDict):
    ...
    egress_gateway_bridge: NotRequired[
        "aws_sdk_mediaconnect.types.egress_gateway_bridge.EgressGatewayBridge"
    ]
    ...
    ingress_gateway_bridge: NotRequired[
        "aws_sdk_mediaconnect.types.ingress_gateway_bridge.IngressGatewayBridge"
    ]
    ...
    outputs: NotRequired[
        "aws_sdk_mediaconnect.types.__list_of_bridge_output.__listOfBridgeOutput"
    ]
...
def serialize_json(value: Bridge) -> dict:
    ...
    if "bridge_state" in value:
        ...
        out["bridgeState"] = aws_sdk_mediaconnect.types.bridge_state.serialize_json(
            value["bridge_state"]
        )
    if "egress_gateway_bridge" in value:
        ...
        out["egressGatewayBridge"] = (
            aws_sdk_mediaconnect.types.egress_gateway_bridge.serialize_json(
    ...
    if "ingress_gateway_bridge" in value:
        ...
        out["ingressGatewayBridge"] = (
            aws_sdk_mediaconnect.types.ingress_gateway_bridge.serialize_json(
    ...
    if "outputs" in value:
        ...
        out["outputs"] = (
            aws_sdk_mediaconnect.types.__list_of_bridge_output.serialize_json(
                value["outputs"]
            )
        )
...
def deserialize_json(data: dict) -> Bridge:
    ...
    if "bridgeState" in data:
        ...
        out["bridge_state"] = aws_sdk_mediaconnect.types.bridge_state.deserialize_json(
            data["bridgeState"]
        )
    if "egressGatewayBridge" in data:
        ...
        out["egress_gateway_bridge"] = (
            aws_sdk_mediaconnect.types.egress_gateway_bridge.deserialize_json(
    ...
    if "ingressGatewayBridge" in data:
        ...
        out["ingress_gateway_bridge"] = (
            aws_sdk_mediaconnect.types.ingress_gateway_bridge.deserialize_json(
    ...
    if "outputs" in data:
        ...
        out["outputs"] = (
            aws_sdk_mediaconnect.types.__list_of_bridge_output.deserialize_json(
                data["outputs"]
            )
        )
