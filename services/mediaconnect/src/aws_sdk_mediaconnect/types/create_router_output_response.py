...
class CreateRouterOutputResponse(TypedDict):
...
def serialize_json(value: CreateRouterOutputResponse) -> dict:
    out: dict = {}
    import aws_sdk_mediaconnect.types.router_output
    out["routerOutput"] = aws_sdk_mediaconnect.types.router_output.serialize_json(value["router_output"])
    return out
...
def deserialize_json(data: dict) -> CreateRouterOutputResponse:
    ...
    if "routerOutput" in data:
        import aws_sdk_mediaconnect.types.router_output
        out["router_output"] = aws_sdk_mediaconnect.types.router_output.deserialize_json(data["routerOutput"])
    else:
