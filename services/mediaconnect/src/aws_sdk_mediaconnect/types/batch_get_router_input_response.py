...
class BatchGetRouterInputResponse(TypedDict):
...
def serialize_json(value: BatchGetRouterInputResponse) -> dict:
    out: dict = {}
    import aws_sdk_mediaconnect.types.router_input_list
    out["routerInputs"] = aws_sdk_mediaconnect.types.router_input_list.serialize_json(value["router_inputs"])
    import aws_sdk_mediaconnect.types.batch_get_router_input_error_list
    out["errors"] = aws_sdk_mediaconnect.types.batch_get_router_input_error_list.serialize_json(value["errors"])
    return out
...
def deserialize_json(data: dict) -> BatchGetRouterInputResponse:
    ...
    if "routerInputs" in data:
        import aws_sdk_mediaconnect.types.router_input_list
        out["router_inputs"] = aws_sdk_mediaconnect.types.router_input_list.deserialize_json(data["routerInputs"])
    else:
        raise DeserializationError("BatchGetRouterInputResponse.router_inputs required")
    if "errors" in data:
        import aws_sdk_mediaconnect.types.batch_get_router_input_error_list
        out["errors"] = aws_sdk_mediaconnect.types.batch_get_router_input_error_list.deserialize_json(data["errors"])
    else:
