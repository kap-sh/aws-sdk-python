"""Generated from Smithy shape ``com.amazonaws.mediaconnect#InternalServerErrorException``."""
...
class InternalServerErrorException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.mediaconnect#InternalServerErrorException``."""
