"""Generated from Smithy shape ``com.amazonaws.mediaconnect#RevokeFlowEntitlement``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.revoke_flow_entitlement_response.RevokeFlowEntitlementResponse = aws_sdk_mediaconnect.types.revoke_flow_entitlement_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.revoke_flow_entitlement_request.RevokeFlowEntitlementRequest,
) -> zapros.Request:
...
async def async_revoke_flow_entitlement(
