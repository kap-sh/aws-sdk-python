...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.create_router_network_interface_request.CreateRouterNetworkInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.create_router_network_interface_request.serialize_json(
            input_
        )
    ).encode()
