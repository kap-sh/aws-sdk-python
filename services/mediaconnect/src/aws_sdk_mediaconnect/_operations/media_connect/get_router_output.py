"""Generated from Smithy shape ``com.amazonaws.mediaconnect#GetRouterOutput``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.get_router_output_response.GetRouterOutputResponse = aws_sdk_mediaconnect.types.get_router_output_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.get_router_output_request.GetRouterOutputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_router_output(
