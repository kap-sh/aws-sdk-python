...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.describe_flow_source_thumbnail_response.DescribeFlowSourceThumbnailResponse = aws_sdk_mediaconnect.types.describe_flow_source_thumbnail_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.describe_flow_source_thumbnail_request.DescribeFlowSourceThumbnailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
