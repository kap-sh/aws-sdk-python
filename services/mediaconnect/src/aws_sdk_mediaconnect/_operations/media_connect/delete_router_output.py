...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.delete_router_output_response.DeleteRouterOutputResponse = aws_sdk_mediaconnect.types.delete_router_output_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.delete_router_output_request.DeleteRouterOutputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
