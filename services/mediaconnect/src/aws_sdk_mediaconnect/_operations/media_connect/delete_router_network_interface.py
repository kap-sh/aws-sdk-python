...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.delete_router_network_interface_response.DeleteRouterNetworkInterfaceResponse = aws_sdk_mediaconnect.types.delete_router_network_interface_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.delete_router_network_interface_request.DeleteRouterNetworkInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
