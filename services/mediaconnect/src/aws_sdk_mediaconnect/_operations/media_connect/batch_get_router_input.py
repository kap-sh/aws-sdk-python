...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.batch_get_router_input_response.BatchGetRouterInputResponse = aws_sdk_mediaconnect.types.batch_get_router_input_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.batch_get_router_input_request.BatchGetRouterInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
