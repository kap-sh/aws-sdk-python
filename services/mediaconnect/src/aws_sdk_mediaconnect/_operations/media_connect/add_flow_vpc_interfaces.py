...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.add_flow_vpc_interfaces_request.AddFlowVpcInterfacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.add_flow_vpc_interfaces_request.serialize_json(
            input_
        )
    ).encode()
