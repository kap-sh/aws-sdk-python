"""Generated from Smithy shape ``com.amazonaws.mediaconnect#AddFlowVpcInterfaces``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.add_flow_vpc_interfaces_response.AddFlowVpcInterfacesResponse = aws_sdk_mediaconnect.types.add_flow_vpc_interfaces_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.add_flow_vpc_interfaces_request.AddFlowVpcInterfacesRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/flows/{FlowArn}/vpcInterfaces"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.add_flow_vpc_interfaces_request.serialize_json(input)
    ).encode()
...
async def async_add_flow_vpc_interfaces(
