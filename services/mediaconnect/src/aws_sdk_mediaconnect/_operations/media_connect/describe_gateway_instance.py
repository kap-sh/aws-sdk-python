"""Generated from Smithy shape ``com.amazonaws.mediaconnect#DescribeGatewayInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.describe_gateway_instance_response.DescribeGatewayInstanceResponse = aws_sdk_mediaconnect.types.describe_gateway_instance_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.describe_gateway_instance_request.DescribeGatewayInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_gateway_instance(
