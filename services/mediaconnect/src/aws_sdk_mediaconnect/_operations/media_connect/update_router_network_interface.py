...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.update_router_network_interface_response.UpdateRouterNetworkInterfaceResponse = aws_sdk_mediaconnect.types.update_router_network_interface_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.update_router_network_interface_request.UpdateRouterNetworkInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_router_network_interface_request.serialize_json(
            input_
        )
    ).encode()
