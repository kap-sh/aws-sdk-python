"""Generated from Smithy shape ``com.amazonaws.mediaconnect#StartRouterInput``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.start_router_input_response.StartRouterInputResponse = aws_sdk_mediaconnect.types.start_router_input_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.start_router_input_request.StartRouterInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/routerInput/start/{Arn}"
...
async def async_start_router_input(
