...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.add_flow_sources_request.AddFlowSourcesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.add_flow_sources_request.serialize_json(input)
    ).encode()
