...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.update_bridge_response.UpdateBridgeResponse = (
        aws_sdk_mediaconnect.types.update_bridge_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.update_bridge_request.UpdateBridgeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_bridge_request.serialize_json(input_)
    ).encode()
