...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.take_router_input_request.TakeRouterInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.take_router_input_request.serialize_json(input_)
    ).encode()
