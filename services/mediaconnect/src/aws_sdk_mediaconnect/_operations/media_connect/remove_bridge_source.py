...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.remove_bridge_source_request.RemoveBridgeSourceRequest,
) -> zapros.Request:
    ...
    url = url.replace("{BridgeArn}", quote(str(input["bridge_arn"]), safe=""))
    url = url.replace("{SourceName}", quote(str(input["source_name"]), safe=""))
    params: dict[str, str] = {}
