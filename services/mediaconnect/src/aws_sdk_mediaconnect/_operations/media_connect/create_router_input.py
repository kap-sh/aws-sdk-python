...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.create_router_input_request.CreateRouterInputRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.create_router_input_request.serialize_json(input)
    ).encode()
