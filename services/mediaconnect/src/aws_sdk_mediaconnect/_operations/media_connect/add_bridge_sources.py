...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.add_bridge_sources_request.AddBridgeSourcesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.add_bridge_sources_request.serialize_json(input)
    ).encode()
