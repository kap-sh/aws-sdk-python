...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.add_bridge_sources_response.AddBridgeSourcesResponse = aws_sdk_mediaconnect.types.add_bridge_sources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.add_bridge_sources_request.AddBridgeSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.add_bridge_sources_request.serialize_json(input_)
    ).encode()
