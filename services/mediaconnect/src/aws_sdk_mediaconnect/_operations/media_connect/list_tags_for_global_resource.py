"""Generated from Smithy shape ``com.amazonaws.mediaconnect#ListTagsForGlobalResource``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.list_tags_for_global_resource_response.ListTagsForGlobalResourceResponse = aws_sdk_mediaconnect.types.list_tags_for_global_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.list_tags_for_global_resource_request.ListTagsForGlobalResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_tags_for_global_resource(
