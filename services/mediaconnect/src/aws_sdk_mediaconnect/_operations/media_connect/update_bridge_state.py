"""Generated from Smithy shape ``com.amazonaws.mediaconnect#UpdateBridgeState``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.update_bridge_state_response.UpdateBridgeStateResponse = aws_sdk_mediaconnect.types.update_bridge_state_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.update_bridge_state_request.UpdateBridgeStateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/bridges/{BridgeArn}/state"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_bridge_state_request.serialize_json(input_)
    ).encode()
...
async def async_update_bridge_state(
