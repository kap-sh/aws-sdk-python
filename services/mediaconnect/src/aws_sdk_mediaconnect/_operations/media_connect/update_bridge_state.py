...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.update_bridge_state_request.UpdateBridgeStateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_bridge_state_request.serialize_json(input)
    ).encode()
