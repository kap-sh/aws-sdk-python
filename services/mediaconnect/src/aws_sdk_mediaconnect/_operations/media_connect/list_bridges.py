...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.list_bridges_response.ListBridgesResponse = (
        aws_sdk_mediaconnect.types.list_bridges_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.list_bridges_request.ListBridgesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
