"""Generated from Smithy shape ``com.amazonaws.mediaconnect#ListFlows``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.list_flows_response.ListFlowsResponse = (
        aws_sdk_mediaconnect.types.list_flows_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.list_flows_request.ListFlowsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_flows(
    ...
    aws_sdk_mediaconnect.types.list_flows_response.ListFlowsResponse, zapros.Response
]:
