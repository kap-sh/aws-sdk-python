...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.list_offerings_response.ListOfferingsResponse = (
        aws_sdk_mediaconnect.types.list_offerings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.list_offerings_request.ListOfferingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
