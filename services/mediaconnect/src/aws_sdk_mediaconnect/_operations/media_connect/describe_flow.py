...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.describe_flow_response.DescribeFlowResponse = (
        aws_sdk_mediaconnect.types.describe_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.describe_flow_request.DescribeFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
