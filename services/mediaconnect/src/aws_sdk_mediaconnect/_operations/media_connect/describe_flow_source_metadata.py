"""Generated from Smithy shape ``com.amazonaws.mediaconnect#DescribeFlowSourceMetadata``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.describe_flow_source_metadata_response.DescribeFlowSourceMetadataResponse = aws_sdk_mediaconnect.types.describe_flow_source_metadata_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.describe_flow_source_metadata_request.DescribeFlowSourceMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/flows/{FlowArn}/source-metadata"
...
async def async_describe_flow_source_metadata(
