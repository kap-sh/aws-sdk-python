...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.start_flow_response.StartFlowResponse = (
        aws_sdk_mediaconnect.types.start_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.start_flow_request.StartFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def start_flow(
    ...
    aws_sdk_mediaconnect.types.start_flow_response.StartFlowResponse, zapros.Response
]:
