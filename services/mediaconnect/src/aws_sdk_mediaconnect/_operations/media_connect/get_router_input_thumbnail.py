...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.get_router_input_thumbnail_response.GetRouterInputThumbnailResponse = aws_sdk_mediaconnect.types.get_router_input_thumbnail_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.get_router_input_thumbnail_request.GetRouterInputThumbnailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
