...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.get_router_network_interface_response.GetRouterNetworkInterfaceResponse = aws_sdk_mediaconnect.types.get_router_network_interface_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.get_router_network_interface_request.GetRouterNetworkInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
