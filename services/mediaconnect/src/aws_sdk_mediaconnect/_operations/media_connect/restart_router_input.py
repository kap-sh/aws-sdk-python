...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.restart_router_input_response.RestartRouterInputResponse = aws_sdk_mediaconnect.types.restart_router_input_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.restart_router_input_request.RestartRouterInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
