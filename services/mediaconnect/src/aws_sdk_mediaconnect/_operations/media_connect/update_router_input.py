...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.update_router_input_response.UpdateRouterInputResponse = aws_sdk_mediaconnect.types.update_router_input_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.update_router_input_request.UpdateRouterInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_router_input_request.serialize_json(input_)
    ).encode()
