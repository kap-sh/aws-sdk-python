...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.update_router_input_request.UpdateRouterInputRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_router_input_request.serialize_json(input)
    ).encode()
