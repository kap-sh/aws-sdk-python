...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CreateBridge420Exception":
            import aws_sdk_mediaconnect.errors.create_bridge420_exception

            raise aws_sdk_mediaconnect.errors.create_bridge420_exception.CreateBridge420Exception.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.create_bridge_response.CreateBridgeResponse = (
        aws_sdk_mediaconnect.types.create_bridge_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.create_bridge_request.CreateBridgeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.create_bridge_request.serialize_json(input_)
    ).encode()
