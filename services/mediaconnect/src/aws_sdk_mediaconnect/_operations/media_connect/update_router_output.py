...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.update_router_output_request.UpdateRouterOutputRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_router_output_request.serialize_json(input)
    ).encode()
