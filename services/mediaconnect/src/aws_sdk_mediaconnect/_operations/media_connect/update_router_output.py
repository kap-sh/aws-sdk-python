"""Generated from Smithy shape ``com.amazonaws.mediaconnect#UpdateRouterOutput``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.update_router_output_response.UpdateRouterOutputResponse = aws_sdk_mediaconnect.types.update_router_output_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.update_router_output_request.UpdateRouterOutputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/routerOutput/{Arn}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_router_output_request.serialize_json(input_)
    ).encode()
...
async def async_update_router_output(
