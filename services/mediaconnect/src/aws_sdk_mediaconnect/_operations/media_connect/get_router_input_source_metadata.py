"""Generated from Smithy shape ``com.amazonaws.mediaconnect#GetRouterInputSourceMetadata``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.get_router_input_source_metadata_response.GetRouterInputSourceMetadataResponse = aws_sdk_mediaconnect.types.get_router_input_source_metadata_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.get_router_input_source_metadata_request.GetRouterInputSourceMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/routerInput/{Arn}/source-metadata"
...
async def async_get_router_input_source_metadata(
