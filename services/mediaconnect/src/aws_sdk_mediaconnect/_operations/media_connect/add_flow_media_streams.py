...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.add_flow_media_streams_request.AddFlowMediaStreamsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.add_flow_media_streams_request.serialize_json(input)
    ).encode()
