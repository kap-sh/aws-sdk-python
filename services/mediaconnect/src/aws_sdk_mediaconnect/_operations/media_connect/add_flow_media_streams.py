"""Generated from Smithy shape ``com.amazonaws.mediaconnect#AddFlowMediaStreams``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.add_flow_media_streams_response.AddFlowMediaStreamsResponse = aws_sdk_mediaconnect.types.add_flow_media_streams_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.add_flow_media_streams_request.AddFlowMediaStreamsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/flows/{FlowArn}/mediaStreams"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.add_flow_media_streams_request.serialize_json(input_)
    ).encode()
...
async def async_add_flow_media_streams(
