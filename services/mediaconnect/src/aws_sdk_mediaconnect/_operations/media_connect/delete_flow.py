"""Generated from Smithy shape ``com.amazonaws.mediaconnect#DeleteFlow``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.delete_flow_response.DeleteFlowResponse = (
        aws_sdk_mediaconnect.types.delete_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.delete_flow_request.DeleteFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/flows/{FlowArn}"
...
def delete_flow(
    ...
    aws_sdk_mediaconnect.types.delete_flow_response.DeleteFlowResponse, zapros.Response
]:
