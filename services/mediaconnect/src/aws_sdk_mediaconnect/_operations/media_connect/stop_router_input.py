...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.stop_router_input_response.StopRouterInputResponse = aws_sdk_mediaconnect.types.stop_router_input_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.stop_router_input_request.StopRouterInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
