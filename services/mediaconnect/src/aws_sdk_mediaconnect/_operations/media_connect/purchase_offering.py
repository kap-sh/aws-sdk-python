...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.purchase_offering_response.PurchaseOfferingResponse = aws_sdk_mediaconnect.types.purchase_offering_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.purchase_offering_request.PurchaseOfferingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.purchase_offering_request.serialize_json(input)
    ).encode()
