"""Generated from Smithy shape ``com.amazonaws.mediaconnect#BatchGetRouterOutput``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.batch_get_router_output_response.BatchGetRouterOutputResponse = aws_sdk_mediaconnect.types.batch_get_router_output_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.batch_get_router_output_request.BatchGetRouterOutputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_batch_get_router_output(
