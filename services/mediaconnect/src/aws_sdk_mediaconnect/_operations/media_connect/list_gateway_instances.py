...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.list_gateway_instances_request.ListGatewayInstancesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "filter_arn" in input:
        params["filterArn"] = str(input["filter_arn"])
