"""Generated from Smithy shape ``com.amazonaws.mediaconnect#ListEntitlements``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.list_entitlements_response.ListEntitlementsResponse = aws_sdk_mediaconnect.types.list_entitlements_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.list_entitlements_request.ListEntitlementsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/entitlements"
    params: dict[str, str] = {}
