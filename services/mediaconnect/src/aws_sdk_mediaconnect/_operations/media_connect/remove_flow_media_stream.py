...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.remove_flow_media_stream_response.RemoveFlowMediaStreamResponse = aws_sdk_mediaconnect.types.remove_flow_media_stream_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.remove_flow_media_stream_request.RemoveFlowMediaStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
