...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.restart_router_output_response.RestartRouterOutputResponse = aws_sdk_mediaconnect.types.restart_router_output_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.restart_router_output_request.RestartRouterOutputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
