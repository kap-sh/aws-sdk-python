"""Generated from Smithy shape ``com.amazonaws.mediaconnect#DeleteGateway``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.delete_gateway_response.DeleteGatewayResponse = (
        aws_sdk_mediaconnect.types.delete_gateway_response.deserialize_json(
