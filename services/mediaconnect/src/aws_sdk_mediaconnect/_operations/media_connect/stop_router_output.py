"""Generated from Smithy shape ``com.amazonaws.mediaconnect#StopRouterOutput``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.stop_router_output_response.StopRouterOutputResponse = aws_sdk_mediaconnect.types.stop_router_output_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.stop_router_output_request.StopRouterOutputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/routerOutput/stop/{Arn}"
...
async def async_stop_router_output(
