...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.update_bridge_output_response.UpdateBridgeOutputResponse = aws_sdk_mediaconnect.types.update_bridge_output_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.update_bridge_output_request.UpdateBridgeOutputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_bridge_output_request.serialize_json(input_)
    ).encode()
