...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.update_bridge_output_request.UpdateBridgeOutputRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_bridge_output_request.serialize_json(input)
    ).encode()
