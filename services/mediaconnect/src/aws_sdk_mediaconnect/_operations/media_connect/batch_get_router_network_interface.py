"""Generated from Smithy shape ``com.amazonaws.mediaconnect#BatchGetRouterNetworkInterface``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.batch_get_router_network_interface_response.BatchGetRouterNetworkInterfaceResponse = aws_sdk_mediaconnect.types.batch_get_router_network_interface_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.batch_get_router_network_interface_request.BatchGetRouterNetworkInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_batch_get_router_network_interface(
