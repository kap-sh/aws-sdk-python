...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.update_gateway_instance_request.UpdateGatewayInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_gateway_instance_request.serialize_json(
            input_
        )
    ).encode()
