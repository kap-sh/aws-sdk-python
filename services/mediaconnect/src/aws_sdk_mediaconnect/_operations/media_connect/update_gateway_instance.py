...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.update_gateway_instance_response.UpdateGatewayInstanceResponse = aws_sdk_mediaconnect.types.update_gateway_instance_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.update_gateway_instance_request.UpdateGatewayInstanceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_gateway_instance_request.serialize_json(input)
    ).encode()
