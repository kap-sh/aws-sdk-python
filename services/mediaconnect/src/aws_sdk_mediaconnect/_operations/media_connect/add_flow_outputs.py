"""Generated from Smithy shape ``com.amazonaws.mediaconnect#AddFlowOutputs``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AddFlowOutputs420Exception":
            import aws_sdk_mediaconnect.errors.add_flow_outputs420_exception

            raise aws_sdk_mediaconnect.errors.add_flow_outputs420_exception.AddFlowOutputs420Exception.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.add_flow_outputs_response.AddFlowOutputsResponse = (
        aws_sdk_mediaconnect.types.add_flow_outputs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.add_flow_outputs_request.AddFlowOutputsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/flows/{FlowArn}/outputs"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.add_flow_outputs_request.serialize_json(input_)
    ).encode()
...
async def async_add_flow_outputs(
