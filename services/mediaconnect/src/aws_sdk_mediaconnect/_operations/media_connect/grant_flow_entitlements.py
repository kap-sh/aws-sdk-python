...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.grant_flow_entitlements_request.GrantFlowEntitlementsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.grant_flow_entitlements_request.serialize_json(
            input_
        )
    ).encode()
