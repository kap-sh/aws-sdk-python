...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "GrantFlowEntitlements420Exception":
            import aws_sdk_mediaconnect.errors.grant_flow_entitlements420_exception

            raise aws_sdk_mediaconnect.errors.grant_flow_entitlements420_exception.GrantFlowEntitlements420Exception.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.grant_flow_entitlements_response.GrantFlowEntitlementsResponse = aws_sdk_mediaconnect.types.grant_flow_entitlements_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.grant_flow_entitlements_request.GrantFlowEntitlementsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.grant_flow_entitlements_request.serialize_json(input)
    ).encode()
