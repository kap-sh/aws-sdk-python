...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.tag_global_resource_request.TagGlobalResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.tag_global_resource_request.serialize_json(input)
    ).encode()
