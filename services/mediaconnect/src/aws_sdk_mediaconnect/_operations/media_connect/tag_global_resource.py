...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.tag_global_resource_request.TagGlobalResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.tag_global_resource_request.serialize_json(input_)
    ).encode()
