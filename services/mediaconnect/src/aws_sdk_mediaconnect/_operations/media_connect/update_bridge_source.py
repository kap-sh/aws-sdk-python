...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.update_bridge_source_response.UpdateBridgeSourceResponse = aws_sdk_mediaconnect.types.update_bridge_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.update_bridge_source_request.UpdateBridgeSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_bridge_source_request.serialize_json(input_)
    ).encode()
