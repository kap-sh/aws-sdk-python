...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.update_bridge_source_request.UpdateBridgeSourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_bridge_source_request.serialize_json(input)
    ).encode()
