"""Generated from Smithy shape ``com.amazonaws.mediaconnect#ListReservations``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.list_reservations_response.ListReservationsResponse = aws_sdk_mediaconnect.types.list_reservations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.list_reservations_request.ListReservationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/reservations"
    params: dict[str, str] = {}
