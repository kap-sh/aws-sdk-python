...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RouterOutputServiceQuotaExceededException":
            import aws_sdk_mediaconnect.errors.router_output_service_quota_exceeded_exception

            raise aws_sdk_mediaconnect.errors.router_output_service_quota_exceeded_exception.RouterOutputServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.create_router_output_response.CreateRouterOutputResponse = aws_sdk_mediaconnect.types.create_router_output_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.create_router_output_request.CreateRouterOutputRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.create_router_output_request.serialize_json(input)
    ).encode()
