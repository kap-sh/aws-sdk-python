...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.remove_flow_vpc_interface_request.RemoveFlowVpcInterfaceRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{VpcInterfaceName}", quote(str(input["vpc_interface_name"]), safe="")
    )
    params: dict[str, str] = {}
