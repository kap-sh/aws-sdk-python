"""Generated from Smithy shape ``com.amazonaws.mediaconnect#DescribeBridge``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.describe_bridge_response.DescribeBridgeResponse = (
        aws_sdk_mediaconnect.types.describe_bridge_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.describe_bridge_request.DescribeBridgeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/bridges/{BridgeArn}"
...
async def async_describe_bridge(
