...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.describe_reservation_response.DescribeReservationResponse = aws_sdk_mediaconnect.types.describe_reservation_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.describe_reservation_request.DescribeReservationRequest,
) -> zapros.Request:
    ...
    url = url.replace("{ReservationArn}", quote(str(input["reservation_arn"]), safe=""))
    params: dict[str, str] = {}
