...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.list_router_inputs_request.ListRouterInputsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.list_router_inputs_request.serialize_json(input)
    ).encode()
