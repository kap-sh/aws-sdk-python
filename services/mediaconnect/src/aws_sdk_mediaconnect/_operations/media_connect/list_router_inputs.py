...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.list_router_inputs_response.ListRouterInputsResponse = aws_sdk_mediaconnect.types.list_router_inputs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.list_router_inputs_request.ListRouterInputsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.list_router_inputs_request.serialize_json(input_)
    ).encode()
