"""Generated from Smithy shape ``com.amazonaws.mediaconnect#RemoveFlowSource``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.remove_flow_source_response.RemoveFlowSourceResponse = aws_sdk_mediaconnect.types.remove_flow_source_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.remove_flow_source_request.RemoveFlowSourceRequest,
) -> zapros.Request:
...
async def async_remove_flow_source(
