...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.update_flow_entitlement_request.UpdateFlowEntitlementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{EntitlementArn}", quote(str(input_["entitlement_arn"]), safe="")
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_flow_entitlement_request.serialize_json(
            input_
        )
    ).encode()
