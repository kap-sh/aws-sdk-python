"""Generated from Smithy shape ``com.amazonaws.mediaconnect#UpdateFlowEntitlement``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.update_flow_entitlement_response.UpdateFlowEntitlementResponse = aws_sdk_mediaconnect.types.update_flow_entitlement_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.update_flow_entitlement_request.UpdateFlowEntitlementRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/flows/{FlowArn}/entitlements/{EntitlementArn}"
    url = url.replace("{EntitlementArn}", quote(str(input["entitlement_arn"]), safe=""))
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.update_flow_entitlement_request.serialize_json(input)
    ).encode()
...
async def async_update_flow_entitlement(
