"""Generated from Smithy shape ``com.amazonaws.mediaconnect#ListRouterNetworkInterfaces``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.list_router_network_interfaces_response.ListRouterNetworkInterfacesResponse = aws_sdk_mediaconnect.types.list_router_network_interfaces_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.list_router_network_interfaces_request.ListRouterNetworkInterfacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/routerNetworkInterfaces"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.list_router_network_interfaces_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_router_network_interfaces(
