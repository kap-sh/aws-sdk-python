...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.delete_bridge_response.DeleteBridgeResponse = (
        aws_sdk_mediaconnect.types.delete_bridge_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.delete_bridge_request.DeleteBridgeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
