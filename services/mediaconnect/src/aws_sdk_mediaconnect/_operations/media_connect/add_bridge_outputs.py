"""Generated from Smithy shape ``com.amazonaws.mediaconnect#AddBridgeOutputs``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.add_bridge_outputs_response.AddBridgeOutputsResponse = aws_sdk_mediaconnect.types.add_bridge_outputs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.add_bridge_outputs_request.AddBridgeOutputsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/bridges/{BridgeArn}/outputs"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.add_bridge_outputs_request.serialize_json(input_)
    ).encode()
...
async def async_add_bridge_outputs(
