...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.get_router_input_response.GetRouterInputResponse = (
        aws_sdk_mediaconnect.types.get_router_input_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.get_router_input_request.GetRouterInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
