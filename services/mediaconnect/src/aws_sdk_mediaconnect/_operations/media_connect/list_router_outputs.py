...
def build_request(
    ...
    input: aws_sdk_mediaconnect.types.list_router_outputs_request.ListRouterOutputsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.list_router_outputs_request.serialize_json(input)
    ).encode()
