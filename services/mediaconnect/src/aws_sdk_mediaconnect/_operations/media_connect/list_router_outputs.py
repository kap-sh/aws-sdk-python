"""Generated from Smithy shape ``com.amazonaws.mediaconnect#ListRouterOutputs``."""
...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.list_router_outputs_response.ListRouterOutputsResponse = aws_sdk_mediaconnect.types.list_router_outputs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.list_router_outputs_request.ListRouterOutputsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/routerOutputs"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mediaconnect.types.list_router_outputs_request.serialize_json(input_)
    ).encode()
...
async def async_list_router_outputs(
