...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.start_router_output_response.StartRouterOutputResponse = aws_sdk_mediaconnect.types.start_router_output_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.start_router_output_request.StartRouterOutputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
