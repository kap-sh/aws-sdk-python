...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.remove_flow_output_response.RemoveFlowOutputResponse = aws_sdk_mediaconnect.types.remove_flow_output_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.remove_flow_output_request.RemoveFlowOutputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
