...
def handle_response(
    ...
    out: aws_sdk_mediaconnect.types.delete_router_input_response.DeleteRouterInputResponse = aws_sdk_mediaconnect.types.delete_router_input_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_mediaconnect.types.delete_router_input_request.DeleteRouterInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
