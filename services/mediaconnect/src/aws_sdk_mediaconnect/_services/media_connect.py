...
from aws_sdk_mediaconnect._resources.media_connect.bridge_resource import BridgeResource
...
from aws_sdk_mediaconnect._resources.media_connect.flow_resource import FlowResource
...
from aws_sdk_mediaconnect._services._aws_config import aws_config
...
class MediaConnectClientConfig(TypedDict, total=False):
...
class MediaConnectClient:
    ...
    def list_entitlements(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediaconnect.types.list_entitlements_request.ListEntitlementsRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediaconnect.types.list_entitlements_response.ListEntitlementsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediaconnect._operations.media_connect.list_entitlements.list_entitlements(
    ...
    def iter_list_entitlements(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "Iterator[aws_sdk_mediaconnect.types.listed_entitlement.ListedEntitlement]":
        _token = next_token
        while True:
    ...
    def list_tags_for_global_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediaconnect.types.list_tags_for_global_resource_request.ListTagsForGlobalResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediaconnect.types.list_tags_for_global_resource_response.ListTagsForGlobalResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediaconnect._operations.media_connect.list_tags_for_global_resource.list_tags_for_global_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediaconnect.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediaconnect.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_mediaconnect._operations.media_connect.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_global_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediaconnect.types.tag_global_resource_request.TagGlobalResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_mediaconnect._operations.media_connect.tag_global_resource

            output, http_response = (
                aws_sdk_mediaconnect._operations.media_connect.tag_global_resource.tag_global_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediaconnect.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_mediaconnect._operations.media_connect.tag_resource

            output, http_response = (
                aws_sdk_mediaconnect._operations.media_connect.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_global_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediaconnect.types.untag_global_resource_request.UntagGlobalResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_mediaconnect._operations.media_connect.untag_global_resource

            output, http_response = (
                aws_sdk_mediaconnect._operations.media_connect.untag_global_resource.untag_global_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediaconnect.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_mediaconnect._operations.media_connect.untag_resource

            output, http_response = (
                aws_sdk_mediaconnect._operations.media_connect.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
