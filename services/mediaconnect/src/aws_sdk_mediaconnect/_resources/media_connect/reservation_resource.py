...
if TYPE_CHECKING:
    import aws_sdk_mediaconnect.types.describe_reservation_request
    import aws_sdk_mediaconnect.types.describe_reservation_response
    import aws_sdk_mediaconnect.types.list_reservations_request
    import aws_sdk_mediaconnect.types.list_reservations_response
    import aws_sdk_mediaconnect.types.max_results
    import aws_sdk_mediaconnect.types.purchase_offering_request
    import aws_sdk_mediaconnect.types.purchase_offering_response
...
class ReservationResource:
    ...
    def create(
        ...
        *,
        ...
        "aws_sdk_mediaconnect.types.purchase_offering_response.PurchaseOfferingResponse"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediaconnect.types.purchase_offering_request.PurchaseOfferingRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediaconnect.types.purchase_offering_response.PurchaseOfferingResponse"
        ]:
            import aws_sdk_mediaconnect._operations.media_connect.purchase_offering

            output, http_response = (
                aws_sdk_mediaconnect._operations.media_connect.purchase_offering.purchase_offering(
    ...
    def read(
        ...
        *,
        config_overrides: Optional[MediaConnectClientConfig] = None,
    ) -> "aws_sdk_mediaconnect.types.describe_reservation_response.DescribeReservationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediaconnect.types.describe_reservation_request.DescribeReservationRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediaconnect.types.describe_reservation_response.DescribeReservationResponse"
        ]:
            import aws_sdk_mediaconnect._operations.media_connect.describe_reservation

            output, http_response = (
                aws_sdk_mediaconnect._operations.media_connect.describe_reservation.describe_reservation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
        ...
        "aws_sdk_mediaconnect.types.list_reservations_response.ListReservationsResponse"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_mediaconnect.types.list_reservations_request.ListReservationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_mediaconnect.types.list_reservations_response.ListReservationsResponse"
        ]:
            import aws_sdk_mediaconnect._operations.media_connect.list_reservations

            output, http_response = (
                aws_sdk_mediaconnect._operations.media_connect.list_reservations.list_reservations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncReservationResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mediaconnect.types.purchase_offering_request.PurchaseOfferingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mediaconnect.types.purchase_offering_response.PurchaseOfferingResponse"
        ]:
            import aws_sdk_mediaconnect._operations.media_connect.purchase_offering
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mediaconnect._operations.media_connect.purchase_offering.async_purchase_offering(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mediaconnect.types.describe_reservation_request.DescribeReservationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mediaconnect.types.describe_reservation_response.DescribeReservationResponse"
        ]:
            import aws_sdk_mediaconnect._operations.media_connect.describe_reservation
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mediaconnect._operations.media_connect.describe_reservation.async_describe_reservation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mediaconnect.types.list_reservations_request.ListReservationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mediaconnect.types.list_reservations_response.ListReservationsResponse"
        ]:
            import aws_sdk_mediaconnect._operations.media_connect.list_reservations
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mediaconnect._operations.media_connect.list_reservations.async_list_reservations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
