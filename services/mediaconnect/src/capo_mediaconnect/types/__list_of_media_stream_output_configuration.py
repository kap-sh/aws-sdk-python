...
if TYPE_CHECKING:
    import capo_mediaconnect.types.media_stream_output_configuration

__listOfMediaStreamOutputConfiguration: TypeAlias = list[
    "capo_mediaconnect.types.media_stream_output_configuration.MediaStreamOutputConfiguration"
]
...
def serialize_json(value: __listOfMediaStreamOutputConfiguration) -> list:
    ...
    for item in value:
        out.append(
            capo_mediaconnect.types.media_stream_output_configuration.serialize_json(
                item
            )
        )
    return out
