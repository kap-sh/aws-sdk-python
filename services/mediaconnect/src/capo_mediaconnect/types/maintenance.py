...
class Maintenance(TypedDict, closed=True):
    maintenance_day: NotRequired[
        "capo_mediaconnect.types.maintenance_day.MaintenanceDay"
    ]
...
def serialize_json(value: Maintenance) -> dict:
    ...
    if "maintenance_day" in value:
        ...
        out["maintenanceDay"] = capo_mediaconnect.types.maintenance_day.serialize_json(
...
def deserialize_json(data: dict) -> Maintenance:
    ...
    if "maintenanceDay" in data:
        ...
        out["maintenance_day"] = (
            capo_mediaconnect.types.maintenance_day.deserialize_json(
                data["maintenanceDay"]
            )
        )
