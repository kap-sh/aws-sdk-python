...
class EncodingConfig(TypedDict, closed=True):
    encoding_profile: NotRequired[
        "capo_mediaconnect.types.encoding_profile.EncodingProfile"
    ]
...
def serialize_json(value: EncodingConfig) -> dict:
    ...
    if "encoding_profile" in value:
        ...
        out["encodingProfile"] = (
            capo_mediaconnect.types.encoding_profile.serialize_json(
...
def deserialize_json(data: dict) -> EncodingConfig:
    ...
    if "encodingProfile" in data:
        ...
        out["encoding_profile"] = (
            capo_mediaconnect.types.encoding_profile.deserialize_json(
