...
class ListGatewayInstancesResponse(TypedDict, closed=True):
    instances: NotRequired[
        "capo_mediaconnect.types.__list_of_listed_gateway_instance.__listOfListedGatewayInstance"
    ]
...
def serialize_json(value: ListGatewayInstancesResponse) -> dict:
    ...
    if "instances" in value:
        ...
        out["instances"] = (
            capo_mediaconnect.types.__list_of_listed_gateway_instance.serialize_json(
                value["instances"]
            )
        )
...
def deserialize_json(data: dict) -> ListGatewayInstancesResponse:
    ...
    if "instances" in data:
        ...
        out["instances"] = (
            capo_mediaconnect.types.__list_of_listed_gateway_instance.deserialize_json(
                data["instances"]
            )
        )
