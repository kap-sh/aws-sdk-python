...
class Offering(TypedDict, closed=True):
    ...
    duration_units: NotRequired["capo_mediaconnect.types.duration_units.DurationUnits"]
    ...
    price_units: NotRequired["capo_mediaconnect.types.price_units.PriceUnits"]
    ...
    resource_specification: NotRequired[
        "capo_mediaconnect.types.resource_specification.ResourceSpecification"
    ]
...
def serialize_json(value: Offering) -> dict:
    ...
    if "duration_units" in value:
        ...
        out["durationUnits"] = capo_mediaconnect.types.duration_units.serialize_json(
    ...
    if "price_units" in value:
        ...
        out["priceUnits"] = capo_mediaconnect.types.price_units.serialize_json(
            value["price_units"]
        )
    if "resource_specification" in value:
        ...
        out["resourceSpecification"] = (
            capo_mediaconnect.types.resource_specification.serialize_json(
...
def deserialize_json(data: dict) -> Offering:
    ...
    if "resourceSpecification" in data:
        ...
        out["resource_specification"] = (
            capo_mediaconnect.types.resource_specification.deserialize_json(
