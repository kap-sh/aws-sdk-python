"""Generated from Smithy shape ``com.amazonaws.mediaconnect#ListBridgesRequest``."""
...
class ListBridgesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListBridgesRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListBridgesRequest:
    out: ListBridgesRequest = {}  # type: ignore[typeddict-item]
    return out
