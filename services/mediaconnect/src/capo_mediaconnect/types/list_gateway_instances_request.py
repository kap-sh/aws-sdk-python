...
class ListGatewayInstancesRequest(TypedDict, closed=True):
    ...
    max_results: NotRequired["capo_mediaconnect.types.max_results.MaxResults"]
...
# --- restJson1 ser/de ---
def serialize_json(value: ListGatewayInstancesRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListGatewayInstancesRequest:
    out: ListGatewayInstancesRequest = {}  # type: ignore[typeddict-item]
    return out
