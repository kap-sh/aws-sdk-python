...
if TYPE_CHECKING:
    import capo_mediaconnect.types.media_stream_source_configuration_request

__listOfMediaStreamSourceConfigurationRequest: TypeAlias = list[
    "capo_mediaconnect.types.media_stream_source_configuration_request.MediaStreamSourceConfigurationRequest"
]
...
def serialize_json(value: __listOfMediaStreamSourceConfigurationRequest) -> list:
    ...
    for item in value:
        out.append(
            capo_mediaconnect.types.media_stream_source_configuration_request.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> __listOfMediaStreamSourceConfigurationRequest:
    ...
    for item in data:
        out.append(
            capo_mediaconnect.types.media_stream_source_configuration_request.deserialize_json(
                item
            )
        )
    return out
