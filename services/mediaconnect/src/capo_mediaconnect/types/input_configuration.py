...
if TYPE_CHECKING:
    import capo_mediaconnect.types.interface
...
class InputConfiguration(TypedDict, closed=True):
    ...
    interface: NotRequired["capo_mediaconnect.types.interface.Interface"]
...
def serialize_json(value: InputConfiguration) -> dict:
    ...
    if "interface" in value:
        ...
        out["interface"] = capo_mediaconnect.types.interface.serialize_json(
            value["interface"]
        )
    return out
...
def deserialize_json(data: dict) -> InputConfiguration:
    ...
    if "interface" in data:
        ...
        out["interface"] = capo_mediaconnect.types.interface.deserialize_json(
            data["interface"]
        )
    return out
