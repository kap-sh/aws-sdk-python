...
if TYPE_CHECKING:
    import capo_mediaconnect.types.__list_of_destination_configuration_request
    import capo_mediaconnect.types.encoding_name
    import capo_mediaconnect.types.encoding_parameters_request


class MediaStreamOutputConfigurationRequest(TypedDict, closed=True):
    destination_configurations: NotRequired[
        "capo_mediaconnect.types.__list_of_destination_configuration_request.__listOfDestinationConfigurationRequest"
    ]
    ...
    encoding_parameters: NotRequired[
        "capo_mediaconnect.types.encoding_parameters_request.EncodingParametersRequest"
    ]
...
def serialize_json(value: MediaStreamOutputConfigurationRequest) -> dict:
    ...
    if "destination_configurations" in value:
        ...
        out["destinationConfigurations"] = (
            capo_mediaconnect.types.__list_of_destination_configuration_request.serialize_json(
    ...
    if "encoding_parameters" in value:
        ...
        out["encodingParameters"] = (
            capo_mediaconnect.types.encoding_parameters_request.serialize_json(
...
def deserialize_json(data: dict) -> MediaStreamOutputConfigurationRequest:
    ...
    if "destinationConfigurations" in data:
        ...
        out["destination_configurations"] = (
            capo_mediaconnect.types.__list_of_destination_configuration_request.deserialize_json(
    ...
    if "encodingParameters" in data:
        ...
        out["encoding_parameters"] = (
            capo_mediaconnect.types.encoding_parameters_request.deserialize_json(
