...
class MediaConnectError(Exception):
    """Base class for all MediaConnect service errors."""


class ServiceError(MediaConnectError):
...
class SerializationError(MediaConnectError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MediaConnectError):
...
class WaiterFailedError(MediaConnectError):
...
class WaiterTimeoutError(MediaConnectError):
