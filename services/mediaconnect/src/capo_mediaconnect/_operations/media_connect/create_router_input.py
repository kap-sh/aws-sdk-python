...
import capo_mediaconnect.errors.router_input_service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RouterInputServiceQuotaExceededException":
            raise capo_mediaconnect.errors.router_input_service_quota_exceeded_exception.RouterInputServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_mediaconnect.types.create_router_input_response.CreateRouterInputResponse = capo_mediaconnect.types.create_router_input_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.create_router_input_request.serialize_json(input_)
    ).encode()
