"""Generated from Smithy shape ``com.amazonaws.mediaconnect#DeleteRouterNetworkInterface``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.delete_router_network_interface_response.DeleteRouterNetworkInterfaceResponse = capo_mediaconnect.types.delete_router_network_interface_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/routerNetworkInterface/{Arn}"
...
async def async_delete_router_network_interface(
