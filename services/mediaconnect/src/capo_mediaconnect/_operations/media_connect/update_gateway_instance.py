"""Generated from Smithy shape ``com.amazonaws.mediaconnect#UpdateGatewayInstance``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.update_gateway_instance_response.UpdateGatewayInstanceResponse = capo_mediaconnect.types.update_gateway_instance_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.update_gateway_instance_request.serialize_json(input_)
    ).encode()
...
async def async_update_gateway_instance(
