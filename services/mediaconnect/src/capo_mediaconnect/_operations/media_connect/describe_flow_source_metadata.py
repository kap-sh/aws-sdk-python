...
def handle_response(
    ...
    out: capo_mediaconnect.types.describe_flow_source_metadata_response.DescribeFlowSourceMetadataResponse = capo_mediaconnect.types.describe_flow_source_metadata_response.deserialize_json(
