...
import capo_mediaconnect.types.__list_of_listed_entitlement
...
def handle_response(
    ...
    out: capo_mediaconnect.types.list_entitlements_response.ListEntitlementsResponse = (
        capo_mediaconnect.types.list_entitlements_response.deserialize_json(
