"""Generated from Smithy shape ``com.amazonaws.mediaconnect#DeleteRouterInput``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.delete_router_input_response.DeleteRouterInputResponse = capo_mediaconnect.types.delete_router_input_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/routerInput/{Arn}"
...
async def async_delete_router_input(
