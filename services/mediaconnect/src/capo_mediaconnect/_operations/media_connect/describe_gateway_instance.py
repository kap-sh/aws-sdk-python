...
def handle_response(
    ...
    out: capo_mediaconnect.types.describe_gateway_instance_response.DescribeGatewayInstanceResponse = capo_mediaconnect.types.describe_gateway_instance_response.deserialize_json(
