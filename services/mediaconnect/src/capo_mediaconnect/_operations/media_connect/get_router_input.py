"""Generated from Smithy shape ``com.amazonaws.mediaconnect#GetRouterInput``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.get_router_input_response.GetRouterInputResponse = (
        capo_mediaconnect.types.get_router_input_response.deserialize_json(
...
async def async_get_router_input(
