"""Generated from Smithy shape ``com.amazonaws.mediaconnect#ListGateways``."""
...
import capo_mediaconnect.types.__list_of_listed_gateway
...
def handle_response(
    ...
    out: capo_mediaconnect.types.list_gateways_response.ListGatewaysResponse = (
        capo_mediaconnect.types.list_gateways_response.deserialize_json(
...
def list_gateways(
    ...
    capo_mediaconnect.types.list_gateways_response.ListGatewaysResponse, zapros.Response
]:
