...
def handle_response(
    ...
    out: capo_mediaconnect.types.update_flow_entitlement_response.UpdateFlowEntitlementResponse = capo_mediaconnect.types.update_flow_entitlement_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.update_flow_entitlement_request.serialize_json(input_)
    ).encode()
