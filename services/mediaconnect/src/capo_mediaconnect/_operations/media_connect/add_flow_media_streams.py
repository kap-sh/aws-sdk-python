...
def handle_response(
    ...
    out: capo_mediaconnect.types.add_flow_media_streams_response.AddFlowMediaStreamsResponse = capo_mediaconnect.types.add_flow_media_streams_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.add_flow_media_streams_request.serialize_json(input_)
    ).encode()
