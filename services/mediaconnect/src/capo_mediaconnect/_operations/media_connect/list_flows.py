...
def handle_response(
    ...
    out: capo_mediaconnect.types.list_flows_response.ListFlowsResponse = (
        capo_mediaconnect.types.list_flows_response.deserialize_json(
...
def list_flows(
    ...
    capo_mediaconnect.types.list_flows_response.ListFlowsResponse, zapros.Response
]:
