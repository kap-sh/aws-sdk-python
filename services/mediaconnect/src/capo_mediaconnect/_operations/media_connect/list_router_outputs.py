...
def handle_response(
    ...
    out: capo_mediaconnect.types.list_router_outputs_response.ListRouterOutputsResponse = capo_mediaconnect.types.list_router_outputs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.list_router_outputs_request.serialize_json(input_)
    ).encode()
