...
import capo_mediaconnect.types.listed_router_network_interface_list
...
def handle_response(
    ...
    out: capo_mediaconnect.types.list_router_network_interfaces_response.ListRouterNetworkInterfacesResponse = capo_mediaconnect.types.list_router_network_interfaces_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.list_router_network_interfaces_request.serialize_json(
            input_
        )
    ).encode()
