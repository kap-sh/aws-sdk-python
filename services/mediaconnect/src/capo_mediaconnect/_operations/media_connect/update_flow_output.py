...
def handle_response(
    ...
    out: capo_mediaconnect.types.update_flow_output_response.UpdateFlowOutputResponse = capo_mediaconnect.types.update_flow_output_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.update_flow_output_request.serialize_json(input_)
    ).encode()
