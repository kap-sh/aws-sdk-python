...
def handle_response(
    ...
    out: capo_mediaconnect.types.batch_get_router_network_interface_response.BatchGetRouterNetworkInterfaceResponse = capo_mediaconnect.types.batch_get_router_network_interface_response.deserialize_json(
