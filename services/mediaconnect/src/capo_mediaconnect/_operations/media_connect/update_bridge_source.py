"""Generated from Smithy shape ``com.amazonaws.mediaconnect#UpdateBridgeSource``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.update_bridge_source_response.UpdateBridgeSourceResponse = capo_mediaconnect.types.update_bridge_source_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.update_bridge_source_request.serialize_json(input_)
    ).encode()
...
async def async_update_bridge_source(
