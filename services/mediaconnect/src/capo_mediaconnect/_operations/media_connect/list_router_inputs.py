"""Generated from Smithy shape ``com.amazonaws.mediaconnect#ListRouterInputs``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.list_router_inputs_response.ListRouterInputsResponse = capo_mediaconnect.types.list_router_inputs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/routerInputs"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.list_router_inputs_request.serialize_json(input_)
    ).encode()
...
async def async_list_router_inputs(
