...
def handle_response(
    ...
    out: capo_mediaconnect.types.delete_flow_response.DeleteFlowResponse = (
        capo_mediaconnect.types.delete_flow_response.deserialize_json(
...
def delete_flow(
    ...
    capo_mediaconnect.types.delete_flow_response.DeleteFlowResponse, zapros.Response
]:
