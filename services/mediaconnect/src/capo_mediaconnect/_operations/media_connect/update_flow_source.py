...
def handle_response(
    ...
    out: capo_mediaconnect.types.update_flow_source_response.UpdateFlowSourceResponse = capo_mediaconnect.types.update_flow_source_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.update_flow_source_request.serialize_json(input_)
    ).encode()
