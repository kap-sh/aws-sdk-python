"""Generated from Smithy shape ``com.amazonaws.mediaconnect#StopRouterInput``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.stop_router_input_response.StopRouterInputResponse = (
        capo_mediaconnect.types.stop_router_input_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/routerInput/stop/{Arn}"
...
async def async_stop_router_input(
