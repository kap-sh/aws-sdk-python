"""Generated from Smithy shape ``com.amazonaws.mediaconnect#RemoveFlowMediaStream``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.remove_flow_media_stream_response.RemoveFlowMediaStreamResponse = capo_mediaconnect.types.remove_flow_media_stream_response.deserialize_json(
...
async def async_remove_flow_media_stream(
