...
import capo_mediaconnect.types.__list_of_listed_gateway_instance
...
def handle_response(
    ...
    out: capo_mediaconnect.types.list_gateway_instances_response.ListGatewayInstancesResponse = capo_mediaconnect.types.list_gateway_instances_response.deserialize_json(
