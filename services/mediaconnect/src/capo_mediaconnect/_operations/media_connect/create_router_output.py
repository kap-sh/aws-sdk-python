"""Generated from Smithy shape ``com.amazonaws.mediaconnect#CreateRouterOutput``."""
...
import capo_mediaconnect.errors.router_output_service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RouterOutputServiceQuotaExceededException":
            raise capo_mediaconnect.errors.router_output_service_quota_exceeded_exception.RouterOutputServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_mediaconnect.types.create_router_output_response.CreateRouterOutputResponse = capo_mediaconnect.types.create_router_output_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.create_router_output_request.serialize_json(input_)
    ).encode()
...
async def async_create_router_output(
