"""Generated from Smithy shape ``com.amazonaws.mediaconnect#GetRouterInputThumbnail``."""
...
import capo_mediaconnect.types.router_input_thumbnail_details
...
def handle_response(
    ...
    out: capo_mediaconnect.types.get_router_input_thumbnail_response.GetRouterInputThumbnailResponse = capo_mediaconnect.types.get_router_input_thumbnail_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/routerInput/{Arn}/thumbnail"
...
async def async_get_router_input_thumbnail(
