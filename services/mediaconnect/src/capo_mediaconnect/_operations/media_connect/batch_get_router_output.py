...
def handle_response(
    ...
    out: capo_mediaconnect.types.batch_get_router_output_response.BatchGetRouterOutputResponse = capo_mediaconnect.types.batch_get_router_output_response.deserialize_json(
