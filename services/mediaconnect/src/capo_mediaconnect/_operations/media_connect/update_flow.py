"""Generated from Smithy shape ``com.amazonaws.mediaconnect#UpdateFlow``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.update_flow_response.UpdateFlowResponse = (
        capo_mediaconnect.types.update_flow_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.update_flow_request.serialize_json(input_)
    ).encode()
...
def update_flow(
    ...
    capo_mediaconnect.types.update_flow_response.UpdateFlowResponse, zapros.Response
]:
