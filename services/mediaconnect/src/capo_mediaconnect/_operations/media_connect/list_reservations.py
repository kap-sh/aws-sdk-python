...
import capo_mediaconnect.types.__list_of_reservation
...
def handle_response(
    ...
    out: capo_mediaconnect.types.list_reservations_response.ListReservationsResponse = (
        capo_mediaconnect.types.list_reservations_response.deserialize_json(
