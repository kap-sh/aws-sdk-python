...
```
pip install aws-sdk-ecr-public
```

## Usage

```python
from aws_sdk_ecr_public import AsyncECRPUBLICClient


async def main():
    async with AsyncECRPUBLICClient() as s3:
...
```python
from aws_sdk_ecr_public import AsyncECRPUBLICClient
from aws_sdk_ecr_public.error import InvalidParameterException
