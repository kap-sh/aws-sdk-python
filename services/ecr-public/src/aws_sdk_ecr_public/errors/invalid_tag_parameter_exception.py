"""Generated from Smithy shape ``com.amazonaws.ecrpublic#InvalidTagParameterException``."""
...
class InvalidTagParameterException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ecrpublic#InvalidTagParameterException``."""
