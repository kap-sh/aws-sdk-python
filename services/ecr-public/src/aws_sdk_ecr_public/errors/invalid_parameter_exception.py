"""Generated from Smithy shape ``com.amazonaws.ecrpublic#InvalidParameterException``."""
...
class InvalidParameterException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ecrpublic#InvalidParameterException``."""
