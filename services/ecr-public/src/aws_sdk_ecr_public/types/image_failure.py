...
if TYPE_CHECKING:
    import aws_sdk_ecr_public.types.image_failure_code
    import aws_sdk_ecr_public.types.image_failure_reason
...
class ImageFailure(TypedDict):
    ...
    failure_code: NotRequired[
        "aws_sdk_ecr_public.types.image_failure_code.ImageFailureCode"
    ]
    """<p>The code that's associated with the failure.</p>"""
    failure_reason: NotRequired[
        "aws_sdk_ecr_public.types.image_failure_reason.ImageFailureReason"
    ]
...
def serialize_aws_json_1_1(value: ImageFailure) -> dict:
    ...
    if "failure_code" in value:
        ...
        out["failureCode"] = (
            aws_sdk_ecr_public.types.image_failure_code.serialize_aws_json_1_1(
                value["failure_code"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ImageFailure:
    ...
    if "failureCode" in data:
        ...
        out["failure_code"] = (
            aws_sdk_ecr_public.types.image_failure_code.deserialize_aws_json_1_1(
                data["failureCode"]
            )
        )
