"""Generated from Smithy shape ``com.amazonaws.ecrpublic#DescribeImageTagsRequest``."""
...
class DescribeImageTagsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeImageTagsRequest) -> dict:
    out: dict = {}
