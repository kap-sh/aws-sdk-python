...
class DescribeImageTagsResponse(TypedDict):
    image_tag_details: NotRequired[
        "aws_sdk_ecr_public.types.image_tag_detail_list.ImageTagDetailList"
    ]
...
def serialize_aws_json_1_1(value: DescribeImageTagsResponse) -> dict:
    ...
    if "image_tag_details" in value:
        ...
        out["imageTagDetails"] = (
            aws_sdk_ecr_public.types.image_tag_detail_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeImageTagsResponse:
    ...
    if "imageTagDetails" in data:
        ...
        out["image_tag_details"] = (
            aws_sdk_ecr_public.types.image_tag_detail_list.deserialize_aws_json_1_1(
