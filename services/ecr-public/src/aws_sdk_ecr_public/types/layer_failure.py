...
if TYPE_CHECKING:
    ...
    import aws_sdk_ecr_public.types.layer_failure_code
...
class LayerFailure(TypedDict):
    ...
    failure_code: NotRequired[
        "aws_sdk_ecr_public.types.layer_failure_code.LayerFailureCode"
    ]
    """<p>The failure code that's associated with the failure.</p>"""
    failure_reason: NotRequired[
        "aws_sdk_ecr_public.types.layer_failure_reason.LayerFailureReason"
    ]
...
def serialize_aws_json_1_1(value: LayerFailure) -> dict:
    ...
    if "failure_code" in value:
        ...
        out["failureCode"] = (
            aws_sdk_ecr_public.types.layer_failure_code.serialize_aws_json_1_1(
                value["failure_code"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> LayerFailure:
    ...
    if "failureCode" in data:
        ...
        out["failure_code"] = (
            aws_sdk_ecr_public.types.layer_failure_code.deserialize_aws_json_1_1(
                data["failureCode"]
            )
        )
