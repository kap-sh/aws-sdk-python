...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.get_repository_catalog_data_request.GetRepositoryCatalogDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.get_repository_catalog_data_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
