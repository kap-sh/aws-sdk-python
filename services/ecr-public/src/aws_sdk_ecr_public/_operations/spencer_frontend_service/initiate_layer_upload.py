...
def handle_response(
    ...
    out: aws_sdk_ecr_public.types.initiate_layer_upload_response.InitiateLayerUploadResponse = aws_sdk_ecr_public.types.initiate_layer_upload_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.initiate_layer_upload_request.InitiateLayerUploadRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.initiate_layer_upload_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
