...
def handle_response(
    ...
    out: aws_sdk_ecr_public.types.put_repository_catalog_data_response.PutRepositoryCatalogDataResponse = aws_sdk_ecr_public.types.put_repository_catalog_data_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.put_repository_catalog_data_request.PutRepositoryCatalogDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.put_repository_catalog_data_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
