...
def handle_response(
    ...
    out: aws_sdk_ecr_public.types.batch_check_layer_availability_response.BatchCheckLayerAvailabilityResponse = aws_sdk_ecr_public.types.batch_check_layer_availability_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.batch_check_layer_availability_request.BatchCheckLayerAvailabilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
