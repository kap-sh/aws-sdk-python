...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RepositoryNotEmptyException":
            import aws_sdk_ecr_public.errors.repository_not_empty_exception

            raise aws_sdk_ecr_public.errors.repository_not_empty_exception.RepositoryNotEmptyException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ecr_public.types.delete_repository_response.DeleteRepositoryResponse = aws_sdk_ecr_public.types.delete_repository_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_ecr_public.types.delete_repository_request.DeleteRepositoryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.delete_repository_request.serialize_aws_json_1_1(input)
    ).encode()
