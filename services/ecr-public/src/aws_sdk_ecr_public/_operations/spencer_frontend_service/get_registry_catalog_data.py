"""Generated from Smithy shape ``com.amazonaws.ecrpublic#GetRegistryCatalogData``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr_public.types.get_registry_catalog_data_response.GetRegistryCatalogDataResponse = aws_sdk_ecr_public.types.get_registry_catalog_data_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.get_registry_catalog_data_request.GetRegistryCatalogDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SpencerFrontendService.GetRegistryCatalogData"
    body: bytes | None = b""
...
async def async_get_registry_catalog_data(
