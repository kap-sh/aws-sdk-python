...
def build_request(
    ...
    input: aws_sdk_ecr_public.types.upload_layer_part_request.UploadLayerPartRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.upload_layer_part_request.serialize_aws_json_1_1(input)
    ).encode()
