...
import aws_sdk_ecr_public.types.image_failure_list
...
def handle_response(
    ...
    out: aws_sdk_ecr_public.types.batch_delete_image_response.BatchDeleteImageResponse = aws_sdk_ecr_public.types.batch_delete_image_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.batch_delete_image_request.BatchDeleteImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.batch_delete_image_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
