"""Generated from Smithy shape ``com.amazonaws.ecrpublic#DescribeRegistries``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr_public.types.describe_registries_response.DescribeRegistriesResponse = aws_sdk_ecr_public.types.describe_registries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.describe_registries_request.DescribeRegistriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SpencerFrontendService.DescribeRegistries"
    import aws_sdk_ecr_public.types.describe_registries_request

    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.describe_registries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_registries(
