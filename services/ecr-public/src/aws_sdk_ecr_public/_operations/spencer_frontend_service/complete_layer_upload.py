...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.complete_layer_upload_request.CompleteLayerUploadRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.complete_layer_upload_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
