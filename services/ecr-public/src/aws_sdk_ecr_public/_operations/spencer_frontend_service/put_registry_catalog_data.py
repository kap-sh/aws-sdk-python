"""Generated from Smithy shape ``com.amazonaws.ecrpublic#PutRegistryCatalogData``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr_public.types.put_registry_catalog_data_response.PutRegistryCatalogDataResponse = aws_sdk_ecr_public.types.put_registry_catalog_data_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.put_registry_catalog_data_request.PutRegistryCatalogDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SpencerFrontendService.PutRegistryCatalogData"
    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.put_registry_catalog_data_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_registry_catalog_data(
