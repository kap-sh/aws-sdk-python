...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RepositoryPolicyNotFoundException":
            import aws_sdk_ecr_public.errors.repository_policy_not_found_exception

            raise aws_sdk_ecr_public.errors.repository_policy_not_found_exception.RepositoryPolicyNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ecr_public.types.delete_repository_policy_response.DeleteRepositoryPolicyResponse = aws_sdk_ecr_public.types.delete_repository_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.delete_repository_policy_request.DeleteRepositoryPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.delete_repository_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
