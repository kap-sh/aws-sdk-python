"""Generated from Smithy shape ``com.amazonaws.ecrpublic#DescribeRepositories``."""
...
def handle_response(
    ...
    out: aws_sdk_ecr_public.types.describe_repositories_response.DescribeRepositoriesResponse = aws_sdk_ecr_public.types.describe_repositories_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.describe_repositories_request.DescribeRepositoriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_repositories(
