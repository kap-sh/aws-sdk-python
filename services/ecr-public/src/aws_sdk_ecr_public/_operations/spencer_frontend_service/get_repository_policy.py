...
def handle_response(
    ...
    out: aws_sdk_ecr_public.types.get_repository_policy_response.GetRepositoryPolicyResponse = aws_sdk_ecr_public.types.get_repository_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.get_repository_policy_request.GetRepositoryPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.get_repository_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
