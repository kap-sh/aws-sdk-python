"""Generated from Smithy shape ``com.amazonaws.ecrpublic#DescribeImageTags``."""
...
import aws_sdk_ecr_public.types.image_tag_detail_list
...
def handle_response(
    ...
    out: aws_sdk_ecr_public.types.describe_image_tags_response.DescribeImageTagsResponse = aws_sdk_ecr_public.types.describe_image_tags_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.describe_image_tags_request.DescribeImageTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SpencerFrontendService.DescribeImageTags"
    import aws_sdk_ecr_public.types.describe_image_tags_request

    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.describe_image_tags_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_image_tags(
