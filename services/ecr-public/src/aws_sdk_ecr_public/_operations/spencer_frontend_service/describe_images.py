...
def build_request(
    ...
    input: aws_sdk_ecr_public.types.describe_images_request.DescribeImagesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.describe_images_request.serialize_aws_json_1_1(input)
    ).encode()
