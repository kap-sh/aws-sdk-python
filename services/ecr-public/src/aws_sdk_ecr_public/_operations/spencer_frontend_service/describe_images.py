...
import aws_sdk_ecr_public.errors.image_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ImageNotFoundException":
            raise aws_sdk_ecr_public.errors.image_not_found_exception.ImageNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ecr_public.types.describe_images_response.DescribeImagesResponse = (
        aws_sdk_ecr_public.types.describe_images_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ecr_public.types.describe_images_request.DescribeImagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ecr_public.types.describe_images_request.serialize_aws_json_1_1(input_)
    ).encode()
