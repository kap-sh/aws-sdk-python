"""Generated from Smithy shape ``com.amazonaws.ecrpublic#ReferencedImagesNotFoundException``."""
...
class ReferencedImagesNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ecrpublic#ReferencedImagesNotFoundException``."""
