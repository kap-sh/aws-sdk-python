"""Generated from Smithy shape ``com.amazonaws.ecrpublic#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ecrpublic#LimitExceededException``."""
