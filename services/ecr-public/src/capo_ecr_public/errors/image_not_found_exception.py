"""Generated from Smithy shape ``com.amazonaws.ecrpublic#ImageNotFoundException``."""
...
class ImageNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ecrpublic#ImageNotFoundException``."""
