...
def serialize_aws_json_1_1(value: DescribeImagesResponse) -> dict:
    ...
    if "image_details" in value:
        ...
        out["imageDetails"] = (
            capo_ecr_public.types.image_detail_list.serialize_aws_json_1_1(
                value["image_details"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeImagesResponse:
    ...
    if "imageDetails" in data:
        ...
        out["image_details"] = (
            capo_ecr_public.types.image_detail_list.deserialize_aws_json_1_1(
                data["imageDetails"]
            )
        )
