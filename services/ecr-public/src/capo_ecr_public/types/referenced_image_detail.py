...
if TYPE_CHECKING:
    ...
    import capo_ecr_public.types.image_size_in_bytes
...
class ReferencedImageDetail(TypedDict, closed=True):
    ...
    image_size_in_bytes: NotRequired[
        "capo_ecr_public.types.image_size_in_bytes.ImageSizeInBytes"
    ]
    ...
    image_pushed_at: NotRequired["capo_ecr_public.types.push_timestamp.PushTimestamp"]
    ...
    artifact_media_type: NotRequired["capo_ecr_public.types.media_type.MediaType"]
...
def serialize_aws_json_1_1(value: ReferencedImageDetail) -> dict:
    ...
    if "image_pushed_at" in value:
        ...
        out["imagePushedAt"] = (
            capo_ecr_public.types.push_timestamp.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ReferencedImageDetail:
    ...
    if "imagePushedAt" in data:
        ...
        out["image_pushed_at"] = (
            capo_ecr_public.types.push_timestamp.deserialize_aws_json_1_1(
                data["imagePushedAt"]
            )
        )
