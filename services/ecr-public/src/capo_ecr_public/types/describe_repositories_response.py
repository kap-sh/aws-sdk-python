...
if TYPE_CHECKING:
    ...
    import capo_ecr_public.types.repository_list


class DescribeRepositoriesResponse(TypedDict, closed=True):
    repositories: NotRequired["capo_ecr_public.types.repository_list.RepositoryList"]
...
def serialize_aws_json_1_1(value: DescribeRepositoriesResponse) -> dict:
    ...
    if "repositories" in value:
        ...
        out["repositories"] = (
            capo_ecr_public.types.repository_list.serialize_aws_json_1_1(
                value["repositories"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeRepositoriesResponse:
    ...
    if "repositories" in data:
        ...
        out["repositories"] = (
            capo_ecr_public.types.repository_list.deserialize_aws_json_1_1(
                data["repositories"]
            )
        )
