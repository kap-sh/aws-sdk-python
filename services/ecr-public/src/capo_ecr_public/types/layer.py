...
if TYPE_CHECKING:
    import capo_ecr_public.types.layer_availability
    import capo_ecr_public.types.layer_digest
    import capo_ecr_public.types.layer_size_in_bytes
    import capo_ecr_public.types.media_type


class Layer(TypedDict, closed=True):
    layer_digest: NotRequired["capo_ecr_public.types.layer_digest.LayerDigest"]
    """<p>The <code>sha256</code> digest of the image layer.</p>"""
    layer_availability: NotRequired[
        "capo_ecr_public.types.layer_availability.LayerAvailability"
    ]
    """<p>The availability status of the image layer.</p>"""
    layer_size: NotRequired[
        "capo_ecr_public.types.layer_size_in_bytes.LayerSizeInBytes"
    ]
    """<p>The size, in bytes, of the image layer.</p>"""
    media_type: NotRequired["capo_ecr_public.types.media_type.MediaType"]
...
def serialize_aws_json_1_1(value: Layer) -> dict:
    ...
    if "layer_availability" in value:
        ...
        out["layerAvailability"] = (
            capo_ecr_public.types.layer_availability.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Layer:
    ...
    if "layerAvailability" in data:
        ...
        out["layer_availability"] = (
            capo_ecr_public.types.layer_availability.deserialize_aws_json_1_1(
