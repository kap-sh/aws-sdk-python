...
def handle_response(
    ...
    out: aws_sdk_interconnect.types.accept_connection_proposal_response.AcceptConnectionProposalResponse = aws_sdk_interconnect.types.accept_connection_proposal_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_interconnect.types.accept_connection_proposal_request.AcceptConnectionProposalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_interconnect.types.accept_connection_proposal_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
