...
def handle_response(
    ...
    out: aws_sdk_interconnect.types.list_attach_points_response.ListAttachPointsResponse = aws_sdk_interconnect.types.list_attach_points_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_interconnect.types.list_attach_points_request.ListAttachPointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
