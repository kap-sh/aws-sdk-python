...
def build_request(
    ...
    input: aws_sdk_interconnect.types.get_connection_request.GetConnectionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_interconnect.types.get_connection_request.serialize_aws_json_1_0(input)
    ).encode()
