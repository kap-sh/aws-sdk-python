...
def build_request(
    ...
    input_: aws_sdk_interconnect.types.get_environment_request.GetEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_interconnect.types.get_environment_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
