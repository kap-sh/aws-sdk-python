"""Generated from Smithy shape ``com.amazonaws.interconnect#GetEnvironment``."""
...
def handle_response(
    ...
    out: aws_sdk_interconnect.types.get_environment_response.GetEnvironmentResponse = (
        aws_sdk_interconnect.types.get_environment_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_interconnect.types.get_environment_request.GetEnvironmentRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "Interconnect.GetEnvironment"
    import aws_sdk_interconnect.types.get_environment_request

    body: bytes | None = json.dumps(
        aws_sdk_interconnect.types.get_environment_request.serialize_aws_json_1_0(input)
    ).encode()
