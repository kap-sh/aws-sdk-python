"""Generated from Smithy shape ``com.amazonaws.interconnect#ListConnections``."""
...
def handle_response(
    ...
    out: aws_sdk_interconnect.types.list_connections_response.ListConnectionsResponse = aws_sdk_interconnect.types.list_connections_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_interconnect.types.list_connections_request.ListConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Interconnect.ListConnections"
    body: bytes | None = json.dumps(
        aws_sdk_interconnect.types.list_connections_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
