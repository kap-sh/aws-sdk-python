"""Generated from Smithy shape ``com.amazonaws.interconnect#ListEnvironments``."""
...
def handle_response(
    ...
    out: aws_sdk_interconnect.types.list_environments_response.ListEnvironmentsResponse = aws_sdk_interconnect.types.list_environments_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_interconnect.types.list_environments_request.ListEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Interconnect.ListEnvironments"
    import aws_sdk_interconnect.types.list_environments_request

    body: bytes | None = json.dumps(
        aws_sdk_interconnect.types.list_environments_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
