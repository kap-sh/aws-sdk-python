"""Generated from Smithy shape ``com.amazonaws.interconnect#DeleteConnection``."""
...
def build_request(
    ...
    input_: aws_sdk_interconnect.types.delete_connection_request.DeleteConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Interconnect.DeleteConnection"
    import aws_sdk_interconnect.types.delete_connection_request

    body: bytes | None = json.dumps(
        aws_sdk_interconnect.types.delete_connection_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
