"""Generated from Smithy shape ``com.amazonaws.interconnect#DescribeConnectionProposal``."""
...
def handle_response(
    ...
    out: aws_sdk_interconnect.types.describe_connection_proposal_response.DescribeConnectionProposalResponse = aws_sdk_interconnect.types.describe_connection_proposal_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_interconnect.types.describe_connection_proposal_request.DescribeConnectionProposalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Interconnect.DescribeConnectionProposal"
    body: bytes | None = json.dumps(
        aws_sdk_interconnect.types.describe_connection_proposal_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_describe_connection_proposal(
