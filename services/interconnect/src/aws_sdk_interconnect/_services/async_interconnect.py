...
from aws_sdk_interconnect._services._aws_config import aaws_config
...
class AsyncInterconnectClientConfig(TypedDict, total=False):
...
class AsyncInterconnectClient:
    ...
    async def accept_connection_proposal(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_interconnect.types.accept_connection_proposal_request.AcceptConnectionProposalRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_interconnect.types.accept_connection_proposal_response.AcceptConnectionProposalResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_interconnect._operations.interconnect.accept_connection_proposal.async_accept_connection_proposal(
    ...
    async def describe_connection_proposal(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_interconnect.types.describe_connection_proposal_request.DescribeConnectionProposalRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_interconnect.types.describe_connection_proposal_response.DescribeConnectionProposalResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_interconnect._operations.interconnect.describe_connection_proposal.async_describe_connection_proposal(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_attach_points(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_interconnect.types.list_attach_points_request.ListAttachPointsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_interconnect.types.list_attach_points_response.ListAttachPointsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_interconnect._operations.interconnect.list_attach_points.async_list_attach_points(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_attach_points(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_interconnect.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_interconnect.types.attach_point_descriptor.AttachPointDescriptor]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_interconnect.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_interconnect.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_interconnect._operations.interconnect.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_interconnect.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_interconnect.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_interconnect._operations.interconnect.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_interconnect.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_interconnect.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_interconnect._operations.interconnect.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
