...
class InterconnectError(Exception):
    """Base class for all Interconnect service errors."""


class ServiceError(InterconnectError):
...
class SerializationError(InterconnectError):
    """Raised when a value cannot be serialized."""


class DeserializationError(InterconnectError):
...
class WaiterFailedError(InterconnectError):
...
class WaiterTimeoutError(InterconnectError):
