...
from capo_interconnect._services._aws_config import aws_config
...
class InterconnectClientConfig(TypedDict, total=False, closed=True):
...
class InterconnectClient:
    ...
    def accept_connection_proposal(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_interconnect.types.accept_connection_proposal_request.AcceptConnectionProposalRequest]",
        ) -> OperationResponse[
            "capo_interconnect.types.accept_connection_proposal_response.AcceptConnectionProposalResponse"
        ]:
            ...
            output, http_response = (
                capo_interconnect._operations.interconnect.accept_connection_proposal.accept_connection_proposal(
    ...
    def describe_connection_proposal(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_interconnect.types.describe_connection_proposal_request.DescribeConnectionProposalRequest]",
        ) -> OperationResponse[
            "capo_interconnect.types.describe_connection_proposal_response.DescribeConnectionProposalResponse"
        ]:
            ...
            output, http_response = (
                capo_interconnect._operations.interconnect.describe_connection_proposal.describe_connection_proposal(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_attach_points(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_interconnect.types.list_attach_points_request.ListAttachPointsRequest]",
        ) -> OperationResponse[
            "capo_interconnect.types.list_attach_points_response.ListAttachPointsResponse"
        ]:
            ...
            output, http_response = (
                capo_interconnect._operations.interconnect.list_attach_points.list_attach_points(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_attach_points(
        ...
        *,
        ...
        max_results: Optional["capo_interconnect.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_interconnect.types.next_token.NextToken"] = None,
    ) -> "Iterator[capo_interconnect.types.attach_point_descriptor.AttachPointDescriptor]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_interconnect.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_interconnect.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_interconnect._operations.interconnect.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_interconnect.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_interconnect.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_interconnect._operations.interconnect.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_interconnect.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_interconnect.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_interconnect._operations.interconnect.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
