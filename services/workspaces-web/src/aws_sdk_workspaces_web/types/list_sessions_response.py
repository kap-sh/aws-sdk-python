...
class ListSessionsResponse(TypedDict):
    sessions: "aws_sdk_workspaces_web.types.session_summary_list.SessionSummaryList"
...
def serialize_json(value: ListSessionsResponse) -> dict:
    ...
    out["sessions"] = aws_sdk_workspaces_web.types.session_summary_list.serialize_json(
        value["sessions"]
    )
...
def deserialize_json(data: dict) -> ListSessionsResponse:
    ...
    if "sessions" in data:
        ...
        out["sessions"] = (
            aws_sdk_workspaces_web.types.session_summary_list.deserialize_json(
                data["sessions"]
            )
        )
    else:
