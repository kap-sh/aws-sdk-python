...
class AssociateDataProtectionSettingsResponse(TypedDict):
...
def deserialize_json(data: dict) -> AssociateDataProtectionSettingsResponse:
    ...
    if "portalArn" in data:
        ...
        raise DeserializationError("AssociateDataProtectionSettingsResponse.portal_arn required")
    if "dataProtectionSettingsArn" in data:
        out["data_protection_settings_arn"] = data["dataProtectionSettingsArn"]
    else:
        raise DeserializationError("AssociateDataProtectionSettingsResponse.data_protection_settings_arn required")
    return out