...
if TYPE_CHECKING:
    import aws_sdk_workspaces_web.types.built_in_pattern_id
    import aws_sdk_workspaces_web.types.confidence_level
    import aws_sdk_workspaces_web.types.custom_pattern
    import aws_sdk_workspaces_web.types.inline_redaction_urls
    import aws_sdk_workspaces_web.types.redaction_place_holder


class InlineRedactionPattern(TypedDict):
    built_in_pattern_id: NotRequired[
        "aws_sdk_workspaces_web.types.built_in_pattern_id.BuiltInPatternId"
    ]
    ...
    custom_pattern: NotRequired[
        "aws_sdk_workspaces_web.types.custom_pattern.CustomPattern"
    ]
    """<p>&gt;The configuration for a custom pattern. Either a customPattern or builtInPatternId is required.</p>"""
    redaction_place_holder: (
        "aws_sdk_workspaces_web.types.redaction_place_holder.RedactionPlaceHolder"
    )
    ...
    enforced_urls: NotRequired[
        "aws_sdk_workspaces_web.types.inline_redaction_urls.InlineRedactionUrls"
    ]
    ...
    confidence_level: NotRequired[
        "aws_sdk_workspaces_web.types.confidence_level.ConfidenceLevel"
    ]
...
def serialize_json(value: InlineRedactionPattern) -> dict:
    ...
    if "custom_pattern" in value:
        ...
        out["customPattern"] = (
            aws_sdk_workspaces_web.types.custom_pattern.serialize_json(
    ...
    out["redactionPlaceHolder"] = (
        aws_sdk_workspaces_web.types.redaction_place_holder.serialize_json(
    ...
    if "enforced_urls" in value:
        ...
        out["enforcedUrls"] = (
            aws_sdk_workspaces_web.types.inline_redaction_urls.serialize_json(
                value["enforced_urls"]
            )
        )
...
def deserialize_json(data: dict) -> InlineRedactionPattern:
    ...
    if "customPattern" in data:
        ...
        out["custom_pattern"] = (
            aws_sdk_workspaces_web.types.custom_pattern.deserialize_json(
                data["customPattern"]
            )
        )
    if "redactionPlaceHolder" in data:
        ...
        out["redaction_place_holder"] = (
            aws_sdk_workspaces_web.types.redaction_place_holder.deserialize_json(
    ...
    if "enforcedUrls" in data:
        ...
        out["enforced_urls"] = (
            aws_sdk_workspaces_web.types.inline_redaction_urls.deserialize_json(
                data["enforcedUrls"]
            )
        )
