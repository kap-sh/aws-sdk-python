"""Generated from Smithy shape ``com.amazonaws.workspacesweb#Portal``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_workspaces_web.types.browser_type
    ...
    import aws_sdk_workspaces_web.types.portal_status
    import aws_sdk_workspaces_web.types.renderer_type
    import aws_sdk_workspaces_web.types.status_reason
    import aws_sdk_workspaces_web.types.timestamp


class Portal(TypedDict, closed=True):
    portal_arn: "aws_sdk_workspaces_web.types.arn.ARN"
    """<p>The ARN of the web portal.</p>"""
    renderer_type: NotRequired[
        "aws_sdk_workspaces_web.types.renderer_type.RendererType"
    ]
    """<p>The renderer that is used in streaming sessions.</p>"""
    browser_type: NotRequired["aws_sdk_workspaces_web.types.browser_type.BrowserType"]
    """<p>The browser that users see when using a streaming session.</p>"""
    portal_status: NotRequired[
        "aws_sdk_workspaces_web.types.portal_status.PortalStatus"
    ]
    """<p>The status of the web portal.</p>"""
    portal_endpoint: NotRequired[
        "aws_sdk_workspaces_web.types.portal_endpoint.PortalEndpoint"
    ]
    ...
    browser_settings_arn: NotRequired["aws_sdk_workspaces_web.types.arn.ARN"]
    """<p>The ARN of the browser settings that is associated with this web portal.</p>"""
    data_protection_settings_arn: NotRequired["aws_sdk_workspaces_web.types.arn.ARN"]
    """<p>The ARN of the data protection settings.</p>"""
    user_settings_arn: NotRequired["aws_sdk_workspaces_web.types.arn.ARN"]
    """<p>The ARN of the user settings that is associated with the web portal.</p>"""
    network_settings_arn: NotRequired["aws_sdk_workspaces_web.types.arn.ARN"]
    """<p>The ARN of the network settings that is associated with the web portal.</p>"""
    session_logger_arn: NotRequired["aws_sdk_workspaces_web.types.arn.ARN"]
    ...
    status_reason: NotRequired[
        "aws_sdk_workspaces_web.types.status_reason.StatusReason"
    ]
    """<p>A message that explains why the web portal is in its current status.</p>"""
    user_access_logging_settings_arn: NotRequired[
        "aws_sdk_workspaces_web.types.arn.ARN"
    ]
    ...
    ip_access_settings_arn: NotRequired["aws_sdk_workspaces_web.types.arn.ARN"]
...
# --- restJson1 ser/de ---
def serialize_json(value: Portal) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> Portal:
    out: Portal = {}  # type: ignore[typeddict-item]
    if "portalArn" in data:
        out["portal_arn"] = data["portalArn"]
    else:
        raise DeserializationError("Portal.portal_arn required")
