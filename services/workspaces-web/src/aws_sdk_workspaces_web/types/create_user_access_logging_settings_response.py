...
class CreateUserAccessLoggingSettingsResponse(TypedDict):
...
def deserialize_json(data: dict) -> CreateUserAccessLoggingSettingsResponse:
    ...
    if "userAccessLoggingSettingsArn" in data:
        ...
        raise DeserializationError("CreateUserAccessLoggingSettingsResponse.user_access_logging_settings_arn required")
    return out