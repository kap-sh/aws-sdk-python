...
class AssociateNetworkSettingsResponse(TypedDict):
...
def deserialize_json(data: dict) -> AssociateNetworkSettingsResponse:
    ...
    if "portalArn" in data:
        ...
        raise DeserializationError("AssociateNetworkSettingsResponse.portal_arn required")
    if "networkSettingsArn" in data:
        out["network_settings_arn"] = data["networkSettingsArn"]
    else:
        raise DeserializationError("AssociateNetworkSettingsResponse.network_settings_arn required")
    return out