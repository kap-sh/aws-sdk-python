...
def deserialize_json(data: dict) -> AssociateIpAccessSettingsResponse:
    ...
    if "portalArn" in data:
        ...
        raise DeserializationError("AssociateIpAccessSettingsResponse.portal_arn required")
    if "ipAccessSettingsArn" in data:
        out["ip_access_settings_arn"] = data["ipAccessSettingsArn"]
    else:
        raise DeserializationError("AssociateIpAccessSettingsResponse.ip_access_settings_arn required")
    return out