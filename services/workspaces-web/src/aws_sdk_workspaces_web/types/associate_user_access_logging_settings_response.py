...
class AssociateUserAccessLoggingSettingsResponse(TypedDict):
...
def deserialize_json(data: dict) -> AssociateUserAccessLoggingSettingsResponse:
    ...
    if "portalArn" in data:
        ...
        raise DeserializationError("AssociateUserAccessLoggingSettingsResponse.portal_arn required")
    if "userAccessLoggingSettingsArn" in data:
        out["user_access_logging_settings_arn"] = data["userAccessLoggingSettingsArn"]
    else:
        raise DeserializationError("AssociateUserAccessLoggingSettingsResponse.user_access_logging_settings_arn required")
    return out