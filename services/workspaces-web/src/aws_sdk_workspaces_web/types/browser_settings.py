...
def serialize_json(value: BrowserSettings) -> dict:
    ...
    if "associated_portal_arns" in value:
        import aws_sdk_workspaces_web.types.arn_list
        out["associatedPortalArns"] = aws_sdk_workspaces_web.types.arn_list.serialize_json(value["associated_portal_arns"])
...
def deserialize_json(data: dict) -> BrowserSettings:
    ...
    if "associatedPortalArns" in data:
        import aws_sdk_workspaces_web.types.arn_list
        out["associated_portal_arns"] = aws_sdk_workspaces_web.types.arn_list.deserialize_json(data["associatedPortalArns"])
