"""Generated from Smithy shape ``com.amazonaws.workspacesweb#UpdateBrowserSettingsRequest``."""
...
class UpdateBrowserSettingsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateBrowserSettingsRequest) -> dict:
    out: dict = {}
