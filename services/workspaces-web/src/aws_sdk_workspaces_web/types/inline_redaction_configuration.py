...
if TYPE_CHECKING:
    ...
    import aws_sdk_workspaces_web.types.global_inline_redaction_urls
    import aws_sdk_workspaces_web.types.inline_redaction_patterns


class InlineRedactionConfiguration(TypedDict):
    inline_redaction_patterns: (
        "aws_sdk_workspaces_web.types.inline_redaction_patterns.InlineRedactionPatterns"
    )
    """<p>The inline redaction patterns to be enabled for the inline redaction configuration.</p>"""
    global_enforced_urls: NotRequired[
        "aws_sdk_workspaces_web.types.global_inline_redaction_urls.GlobalInlineRedactionUrls"
    ]
...
def serialize_json(value: InlineRedactionConfiguration) -> dict:
    ...
    out["inlineRedactionPatterns"] = (
        aws_sdk_workspaces_web.types.inline_redaction_patterns.serialize_json(
    ...
    if "global_enforced_urls" in value:
        ...
        out["globalEnforcedUrls"] = (
            aws_sdk_workspaces_web.types.global_inline_redaction_urls.serialize_json(
...
def deserialize_json(data: dict) -> InlineRedactionConfiguration:
    ...
    if "inlineRedactionPatterns" in data:
        ...
        out["inline_redaction_patterns"] = (
            aws_sdk_workspaces_web.types.inline_redaction_patterns.deserialize_json(
    ...
    if "globalEnforcedUrls" in data:
        ...
        out["global_enforced_urls"] = (
            aws_sdk_workspaces_web.types.global_inline_redaction_urls.deserialize_json(
