...
DataProtectionSettingsList: TypeAlias = list[
    "aws_sdk_workspaces_web.types.data_protection_settings_summary.DataProtectionSettingsSummary"
]
...
def serialize_json(value: DataProtectionSettingsList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_workspaces_web.types.data_protection_settings_summary.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> DataProtectionSettingsList:
    ...
    for item in data:
        out.append(
            aws_sdk_workspaces_web.types.data_protection_settings_summary.deserialize_json(
                item
            )
        )
    return out
