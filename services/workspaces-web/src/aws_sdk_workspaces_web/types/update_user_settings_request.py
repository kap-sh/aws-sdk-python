...
def serialize_json(value: UpdateUserSettingsRequest) -> dict:
    ...
    if "branding_configuration_input" in value:
        ...
        out["brandingConfigurationInput"] = (
            aws_sdk_workspaces_web.types.branding_configuration_update_input.serialize_json(
...
def deserialize_json(data: dict) -> UpdateUserSettingsRequest:
    ...
    if "brandingConfigurationInput" in data:
        ...
        out["branding_configuration_input"] = (
            aws_sdk_workspaces_web.types.branding_configuration_update_input.deserialize_json(
