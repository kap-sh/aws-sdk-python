...
class AssociateDataProtectionSettingsRequest(TypedDict, closed=True):
...
def deserialize_json(data: dict) -> AssociateDataProtectionSettingsRequest:
    out: AssociateDataProtectionSettingsRequest = {}  # type: ignore[typeddict-item]
    return out
