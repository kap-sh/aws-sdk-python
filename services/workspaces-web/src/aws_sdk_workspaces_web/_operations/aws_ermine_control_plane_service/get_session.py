"""Generated from Smithy shape ``com.amazonaws.workspacesweb#GetSession``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_workspaces_web.types.get_session_response.GetSessionResponse:
    import aws_sdk_workspaces_web.types.get_session_response
    out: aws_sdk_workspaces_web.types.get_session_response.GetSessionResponse = aws_sdk_workspaces_web.types.get_session_response.deserialize_json(json.loads(response.read()))
    return out
