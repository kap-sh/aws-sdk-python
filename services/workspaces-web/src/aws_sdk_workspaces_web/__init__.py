...
from ._services.async_work_spaces_web import (
    AsyncWorkSpacesWebClient as AsyncWorkSpacesWebClient,
)
from ._services.work_spaces_web import WorkSpacesWebClient as WorkSpacesWebClient
