...
class WorkSpacesWebError(Exception):
    """Base class for all WorkSpacesWeb service errors."""

class ServiceError(WorkSpacesWebError):
...
class SerializationError(WorkSpacesWebError):
    """Raised when a value cannot be serialized."""

class DeserializationError(WorkSpacesWebError):
...
class WaiterFailedError(WorkSpacesWebError):
...
class WaiterTimeoutError(WorkSpacesWebError):
