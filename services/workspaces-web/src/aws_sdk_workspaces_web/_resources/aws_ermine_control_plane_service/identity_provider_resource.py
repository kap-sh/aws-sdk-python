...
class IdentityProviderResource:
    ...
    def create(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces_web.types.create_identity_provider_response.CreateIdentityProviderResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_web.types.create_identity_provider_request.CreateIdentityProviderRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_web.types.create_identity_provider_response.CreateIdentityProviderResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.create_identity_provider.create_identity_provider(
    ...
    def read(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_web.types.get_identity_provider_request.GetIdentityProviderRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_web.types.get_identity_provider_response.GetIdentityProviderResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.get_identity_provider.get_identity_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
    ...
    ) -> "aws_sdk_workspaces_web.types.update_identity_provider_response.UpdateIdentityProviderResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_web.types.update_identity_provider_request.UpdateIdentityProviderRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_web.types.update_identity_provider_response.UpdateIdentityProviderResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.update_identity_provider.update_identity_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_web.types.delete_identity_provider_request.DeleteIdentityProviderRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_web.types.delete_identity_provider_response.DeleteIdentityProviderResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.delete_identity_provider.delete_identity_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_web.types.list_identity_providers_request.ListIdentityProvidersRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_web.types.list_identity_providers_response.ListIdentityProvidersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.list_identity_providers.list_identity_providers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncIdentityProviderResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_web.types.create_identity_provider_request.CreateIdentityProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_web.types.create_identity_provider_response.CreateIdentityProviderResponse"
        ]:
            import aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.create_identity_provider
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.create_identity_provider.async_create_identity_provider(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_web.types.get_identity_provider_request.GetIdentityProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_web.types.get_identity_provider_response.GetIdentityProviderResponse"
        ]:
            import aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.get_identity_provider
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.get_identity_provider.async_get_identity_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_web.types.update_identity_provider_request.UpdateIdentityProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_web.types.update_identity_provider_response.UpdateIdentityProviderResponse"
        ]:
            import aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.update_identity_provider
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.update_identity_provider.async_update_identity_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_web.types.delete_identity_provider_request.DeleteIdentityProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_web.types.delete_identity_provider_response.DeleteIdentityProviderResponse"
        ]:
            import aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.delete_identity_provider
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.delete_identity_provider.async_delete_identity_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_workspaces_web.types.list_identity_providers_request.ListIdentityProvidersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_workspaces_web.types.list_identity_providers_response.ListIdentityProvidersResponse"
        ]:
            import aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.list_identity_providers
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_workspaces_web._operations.aws_ermine_control_plane_service.list_identity_providers.async_list_identity_providers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
