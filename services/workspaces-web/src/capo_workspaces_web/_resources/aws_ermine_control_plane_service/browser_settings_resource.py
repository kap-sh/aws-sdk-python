...
class AsyncBrowserSettingsResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.create_browser_settings_request.CreateBrowserSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.create_browser_settings_response.CreateBrowserSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.create_browser_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.create_browser_settings.async_create_browser_settings(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.get_browser_settings_request.GetBrowserSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.get_browser_settings_response.GetBrowserSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.get_browser_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.get_browser_settings.async_get_browser_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.update_browser_settings_request.UpdateBrowserSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.update_browser_settings_response.UpdateBrowserSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.update_browser_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.update_browser_settings.async_update_browser_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.delete_browser_settings_request.DeleteBrowserSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.delete_browser_settings_response.DeleteBrowserSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.delete_browser_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.delete_browser_settings.async_delete_browser_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.list_browser_settings_request.ListBrowserSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.list_browser_settings_response.ListBrowserSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.list_browser_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.list_browser_settings.async_list_browser_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
