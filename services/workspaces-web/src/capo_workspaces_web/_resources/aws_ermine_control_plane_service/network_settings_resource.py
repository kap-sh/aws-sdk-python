...
class AsyncNetworkSettingsResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.create_network_settings_request.CreateNetworkSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.create_network_settings_response.CreateNetworkSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.create_network_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.create_network_settings.async_create_network_settings(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.get_network_settings_request.GetNetworkSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.get_network_settings_response.GetNetworkSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.get_network_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.get_network_settings.async_get_network_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.update_network_settings_request.UpdateNetworkSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.update_network_settings_response.UpdateNetworkSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.update_network_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.update_network_settings.async_update_network_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.delete_network_settings_request.DeleteNetworkSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.delete_network_settings_response.DeleteNetworkSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.delete_network_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.delete_network_settings.async_delete_network_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.list_network_settings_request.ListNetworkSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.list_network_settings_response.ListNetworkSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.list_network_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.list_network_settings.async_list_network_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
