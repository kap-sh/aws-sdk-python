...
class AsyncIpAccessSettingsResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.create_ip_access_settings_request.CreateIpAccessSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.create_ip_access_settings_response.CreateIpAccessSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.create_ip_access_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.create_ip_access_settings.async_create_ip_access_settings(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.get_ip_access_settings_request.GetIpAccessSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.get_ip_access_settings_response.GetIpAccessSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.get_ip_access_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.get_ip_access_settings.async_get_ip_access_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.update_ip_access_settings_request.UpdateIpAccessSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.update_ip_access_settings_response.UpdateIpAccessSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.update_ip_access_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.update_ip_access_settings.async_update_ip_access_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.delete_ip_access_settings_request.DeleteIpAccessSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.delete_ip_access_settings_response.DeleteIpAccessSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.delete_ip_access_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.delete_ip_access_settings.async_delete_ip_access_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.list_ip_access_settings_request.ListIpAccessSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.list_ip_access_settings_response.ListIpAccessSettingsResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.list_ip_access_settings
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.list_ip_access_settings.async_list_ip_access_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
