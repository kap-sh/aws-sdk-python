"""Generated from Smithy shape ``com.amazonaws.workspacesweb#DeleteUserSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.delete_user_settings_response.DeleteUserSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_user_settings(
