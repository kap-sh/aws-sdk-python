"""Generated from Smithy shape ``com.amazonaws.workspacesweb#GetUserSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.get_user_settings_response.GetUserSettingsResponse = capo_workspaces_web.types.get_user_settings_response.deserialize_json(
...
async def async_get_user_settings(
