...
def handle_response(
    ...
    out: capo_workspaces_web.types.create_portal_response.CreatePortalResponse = (
        capo_workspaces_web.types.create_portal_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.create_portal_request.serialize_json(input_)
    ).encode()
