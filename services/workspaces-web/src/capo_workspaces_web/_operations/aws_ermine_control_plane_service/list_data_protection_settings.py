"""Generated from Smithy shape ``com.amazonaws.workspacesweb#ListDataProtectionSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.list_data_protection_settings_response.ListDataProtectionSettingsResponse = capo_workspaces_web.types.list_data_protection_settings_response.deserialize_json(
...
async def async_list_data_protection_settings(
