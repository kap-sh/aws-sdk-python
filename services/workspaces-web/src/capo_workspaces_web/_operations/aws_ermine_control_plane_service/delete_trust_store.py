"""Generated from Smithy shape ``com.amazonaws.workspacesweb#DeleteTrustStore``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.delete_trust_store_response.DeleteTrustStoreResponse = {}  # type: ignore[typeddict-item]
    return out
