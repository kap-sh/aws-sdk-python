...
def handle_response(
    ...
    out: capo_workspaces_web.types.list_browser_settings_response.ListBrowserSettingsResponse = capo_workspaces_web.types.list_browser_settings_response.deserialize_json(
