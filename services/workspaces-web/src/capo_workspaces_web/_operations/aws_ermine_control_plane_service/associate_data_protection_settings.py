"""Generated from Smithy shape ``com.amazonaws.workspacesweb#AssociateDataProtectionSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.associate_data_protection_settings_response.AssociateDataProtectionSettingsResponse = capo_workspaces_web.types.associate_data_protection_settings_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "data_protection_settings_arn" in input_:
        params["dataProtectionSettingsArn"] = str(
            input_["data_protection_settings_arn"]
        )
...
async def async_associate_data_protection_settings(
