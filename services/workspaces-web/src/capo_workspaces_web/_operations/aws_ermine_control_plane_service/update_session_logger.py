...
def handle_response(
    ...
    out: capo_workspaces_web.types.update_session_logger_response.UpdateSessionLoggerResponse = capo_workspaces_web.types.update_session_logger_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.update_session_logger_request.serialize_json(input_)
    ).encode()
