...
import capo_workspaces_web.types.trust_store_summary_list
...
def handle_response(
    ...
    out: capo_workspaces_web.types.list_trust_stores_response.ListTrustStoresResponse = capo_workspaces_web.types.list_trust_stores_response.deserialize_json(
