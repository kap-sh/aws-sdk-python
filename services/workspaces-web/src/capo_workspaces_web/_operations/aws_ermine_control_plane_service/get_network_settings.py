...
def handle_response(
    ...
    out: capo_workspaces_web.types.get_network_settings_response.GetNetworkSettingsResponse = capo_workspaces_web.types.get_network_settings_response.deserialize_json(
