...
def handle_response(
    ...
    out: capo_workspaces_web.types.get_session_response.GetSessionResponse = (
        capo_workspaces_web.types.get_session_response.deserialize_json(
...
def get_session(
    ...
    capo_workspaces_web.types.get_session_response.GetSessionResponse, zapros.Response
]:
