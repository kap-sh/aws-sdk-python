...
def handle_response(
    ...
    out: capo_workspaces_web.types.get_identity_provider_response.GetIdentityProviderResponse = capo_workspaces_web.types.get_identity_provider_response.deserialize_json(
