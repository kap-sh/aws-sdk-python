...
def handle_response(
    ...
    out: capo_workspaces_web.types.get_user_access_logging_settings_response.GetUserAccessLoggingSettingsResponse = capo_workspaces_web.types.get_user_access_logging_settings_response.deserialize_json(
