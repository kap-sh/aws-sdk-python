"""Generated from Smithy shape ``com.amazonaws.workspacesweb#GetBrowserSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.get_browser_settings_response.GetBrowserSettingsResponse = capo_workspaces_web.types.get_browser_settings_response.deserialize_json(
...
async def async_get_browser_settings(
