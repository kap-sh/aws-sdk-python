...
import capo_workspaces_web.types.network_settings_list
...
def handle_response(
    ...
    out: capo_workspaces_web.types.list_network_settings_response.ListNetworkSettingsResponse = capo_workspaces_web.types.list_network_settings_response.deserialize_json(
