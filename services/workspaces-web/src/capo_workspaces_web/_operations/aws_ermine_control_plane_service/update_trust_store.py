...
import capo_workspaces_web.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_workspaces_web.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_workspaces_web.types.update_trust_store_response.UpdateTrustStoreResponse = capo_workspaces_web.types.update_trust_store_response.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_workspaces_web._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.update_trust_store_request.serialize_json(input_)
    ).encode()
