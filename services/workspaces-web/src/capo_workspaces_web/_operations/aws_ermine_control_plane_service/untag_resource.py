"""Generated from Smithy shape ``com.amazonaws.workspacesweb#UntagResource``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
