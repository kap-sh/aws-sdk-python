"""Generated from Smithy shape ``com.amazonaws.workspacesweb#DisassociateBrowserSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.disassociate_browser_settings_response.DisassociateBrowserSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disassociate_browser_settings(
