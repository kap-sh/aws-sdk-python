...
def handle_response(
    ...
    out: capo_workspaces_web.types.create_session_logger_response.CreateSessionLoggerResponse = capo_workspaces_web.types.create_session_logger_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.create_session_logger_request.serialize_json(input_)
    ).encode()
