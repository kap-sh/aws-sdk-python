"""Generated from Smithy shape ``com.amazonaws.workspacesweb#GetSessionLogger``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.get_session_logger_response.GetSessionLoggerResponse = capo_workspaces_web.types.get_session_logger_response.deserialize_json(
...
async def async_get_session_logger(
