"""Generated from Smithy shape ``com.amazonaws.workspacesweb#DeleteDataProtectionSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.delete_data_protection_settings_response.DeleteDataProtectionSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_data_protection_settings(
