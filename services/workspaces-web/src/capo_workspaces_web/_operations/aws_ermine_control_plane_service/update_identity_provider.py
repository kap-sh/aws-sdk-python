"""Generated from Smithy shape ``com.amazonaws.workspacesweb#UpdateIdentityProvider``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.update_identity_provider_response.UpdateIdentityProviderResponse = capo_workspaces_web.types.update_identity_provider_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.update_identity_provider_request.serialize_json(
            input_
        )
    ).encode()
