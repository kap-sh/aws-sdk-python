...
def handle_response(
    ...
    out: capo_workspaces_web.types.list_trust_store_certificates_response.ListTrustStoreCertificatesResponse = capo_workspaces_web.types.list_trust_store_certificates_response.deserialize_json(
