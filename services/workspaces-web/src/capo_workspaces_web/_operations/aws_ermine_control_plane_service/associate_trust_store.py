...
def handle_response(
    ...
    out: capo_workspaces_web.types.associate_trust_store_response.AssociateTrustStoreResponse = capo_workspaces_web.types.associate_trust_store_response.deserialize_json(
