"""Generated from Smithy shape ``com.amazonaws.workspacesweb#ListUserSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.list_user_settings_response.ListUserSettingsResponse = capo_workspaces_web.types.list_user_settings_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/userSettings"
    params: dict[str, str] = {}
...
async def async_list_user_settings(
