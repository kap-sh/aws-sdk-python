...
def handle_response(
    ...
    out: capo_workspaces_web.types.update_ip_access_settings_response.UpdateIpAccessSettingsResponse = capo_workspaces_web.types.update_ip_access_settings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.update_ip_access_settings_request.serialize_json(
            input_
        )
    ).encode()
