...
def handle_response(
    ...
    out: capo_workspaces_web.types.update_portal_response.UpdatePortalResponse = (
        capo_workspaces_web.types.update_portal_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.update_portal_request.serialize_json(input_)
    ).encode()
