...
def handle_response(
    ...
    out: capo_workspaces_web.types.create_trust_store_response.CreateTrustStoreResponse = capo_workspaces_web.types.create_trust_store_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.create_trust_store_request.serialize_json(input_)
    ).encode()
