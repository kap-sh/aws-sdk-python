"""Generated from Smithy shape ``com.amazonaws.workspacesweb#UpdateDataProtectionSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.update_data_protection_settings_response.UpdateDataProtectionSettingsResponse = capo_workspaces_web.types.update_data_protection_settings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.update_data_protection_settings_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_data_protection_settings(
