...
def handle_response(
    ...
    out: capo_workspaces_web.types.get_portal_response.GetPortalResponse = (
        capo_workspaces_web.types.get_portal_response.deserialize_json(
...
def get_portal(
    ...
    capo_workspaces_web.types.get_portal_response.GetPortalResponse, zapros.Response
]:
