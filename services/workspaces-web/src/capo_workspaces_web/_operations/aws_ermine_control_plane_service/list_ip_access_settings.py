...
def handle_response(
    ...
    out: capo_workspaces_web.types.list_ip_access_settings_response.ListIpAccessSettingsResponse = capo_workspaces_web.types.list_ip_access_settings_response.deserialize_json(
