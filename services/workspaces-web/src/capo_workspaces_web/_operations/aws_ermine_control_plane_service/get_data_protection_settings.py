...
def handle_response(
    ...
    out: capo_workspaces_web.types.get_data_protection_settings_response.GetDataProtectionSettingsResponse = capo_workspaces_web.types.get_data_protection_settings_response.deserialize_json(
