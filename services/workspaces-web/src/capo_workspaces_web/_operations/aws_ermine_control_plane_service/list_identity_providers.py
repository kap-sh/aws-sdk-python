...
def handle_response(
    ...
    out: capo_workspaces_web.types.list_identity_providers_response.ListIdentityProvidersResponse = capo_workspaces_web.types.list_identity_providers_response.deserialize_json(
