...
```
pip install aws-sdk-workspaces-web
```

## Usage

```python
from aws_sdk_workspaces_web import AsyncWorkSpacesWebClient
...
```python
from aws_sdk_workspaces_web import AsyncWorkSpacesWebClient
from aws_sdk_workspaces_web.error import AccessDeniedException
