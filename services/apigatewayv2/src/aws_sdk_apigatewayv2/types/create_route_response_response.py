"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateRouteResponseResponse``."""
...
class CreateRouteResponseResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateRouteResponseResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateRouteResponseResponse:
    out: CreateRouteResponseResponse = {}  # type: ignore[typeddict-item]
