...
if TYPE_CHECKING:
    ...
    import aws_sdk_apigatewayv2.types.__string_min3_max255
...
class PortalContent(TypedDict, closed=True):
    ...
    display_name: NotRequired[
        "aws_sdk_apigatewayv2.types.__string_min3_max255.__stringMin3Max255"
    ]
    """<p>The display name for the portal.</p>"""
    theme: NotRequired["aws_sdk_apigatewayv2.types.portal_theme.PortalTheme"]
...
def serialize_json(value: PortalContent) -> dict:
    ...
    if "theme" in value:
        ...
        out["theme"] = aws_sdk_apigatewayv2.types.portal_theme.serialize_json(
            value["theme"]
        )
    return out
...
def deserialize_json(data: dict) -> PortalContent:
    ...
    if "theme" in data:
        ...
        out["theme"] = aws_sdk_apigatewayv2.types.portal_theme.deserialize_json(
            data["theme"]
        )
    return out
