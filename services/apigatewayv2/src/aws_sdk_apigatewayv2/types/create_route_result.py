"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateRouteResult``."""
...
class CreateRouteResult(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateRouteResult) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateRouteResult:
    out: CreateRouteResult = {}  # type: ignore[typeddict-item]
