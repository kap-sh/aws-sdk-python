"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateApiMappingResponse``."""
...
class CreateApiMappingResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateApiMappingResponse) -> dict:
    out: dict = {}
    if "api_id" in value:
...
def deserialize_json(data: dict) -> CreateApiMappingResponse:
    out: CreateApiMappingResponse = {}  # type: ignore[typeddict-item]
    if "apiId" in data:
