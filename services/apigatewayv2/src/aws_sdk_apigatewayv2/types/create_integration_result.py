...
if TYPE_CHECKING:
    ...
    import aws_sdk_apigatewayv2.types.tls_config
...
class CreateIntegrationResult(TypedDict, closed=True):
    ...
    integration_id: NotRequired["aws_sdk_apigatewayv2.types.id.Id"]
    ...
    tls_config: NotRequired["aws_sdk_apigatewayv2.types.tls_config.TlsConfig"]
...
def serialize_json(value: CreateIntegrationResult) -> dict:
    ...
    if "tls_config" in value:
        ...
        out["tlsConfig"] = aws_sdk_apigatewayv2.types.tls_config.serialize_json(
            value["tls_config"]
        )
    return out
...
def deserialize_json(data: dict) -> CreateIntegrationResult:
    ...
    if "tlsConfig" in data:
        ...
        out["tls_config"] = aws_sdk_apigatewayv2.types.tls_config.deserialize_json(
            data["tlsConfig"]
        )
    return out
