"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#ApiMapping``."""
...
class ApiMapping(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ApiMapping) -> dict:
    out: dict = {}
    if "api_id" in value:
...
def deserialize_json(data: dict) -> ApiMapping:
    out: ApiMapping = {}  # type: ignore[typeddict-item]
    if "apiId" in data:
