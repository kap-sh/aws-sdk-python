"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateDomainNameResponse``."""
...
class CreateDomainNameResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateDomainNameResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateDomainNameResponse:
    out: CreateDomainNameResponse = {}  # type: ignore[typeddict-item]
