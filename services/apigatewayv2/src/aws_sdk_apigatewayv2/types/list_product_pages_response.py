...
def serialize_json(value: ListProductPagesResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = (
            aws_sdk_apigatewayv2.types.__list_of_product_page_summary_no_body.serialize_json(
                value["items"]
            )
        )
...
def deserialize_json(data: dict) -> ListProductPagesResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_apigatewayv2.types.__list_of_product_page_summary_no_body.deserialize_json(
                data["items"]
            )
        )
