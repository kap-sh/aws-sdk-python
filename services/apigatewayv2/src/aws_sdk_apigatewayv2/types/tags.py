...
if TYPE_CHECKING:
    ...
    import aws_sdk_apigatewayv2.types.string_with_length_between1_and1600

Tags: TypeAlias = dict[
    "aws_sdk_apigatewayv2.types.__string.__string",
    "aws_sdk_apigatewayv2.types.string_with_length_between1_and1600.StringWithLengthBetween1And1600",
]
