...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.update_authorizer_response.UpdateAuthorizerResponse = aws_sdk_apigatewayv2.types.update_authorizer_response.deserialize_json(
