...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.update_product_rest_endpoint_page_response.UpdateProductRestEndpointPageResponse = aws_sdk_apigatewayv2.types.update_product_rest_endpoint_page_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.update_product_rest_endpoint_page_request.UpdateProductRestEndpointPageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.update_product_rest_endpoint_page_request.serialize_json(
            input_
        )
    ).encode()
