...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.update_api_response.UpdateApiResponse = (
        aws_sdk_apigatewayv2.types.update_api_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.update_api_request.UpdateApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.update_api_request.serialize_json(input_)
    ).encode()
...
def update_api(
    ...
    aws_sdk_apigatewayv2.types.update_api_response.UpdateApiResponse, zapros.Response
]:
