"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetApiMapping``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_api_mapping_response.GetApiMappingResponse = (
        aws_sdk_apigatewayv2.types.get_api_mapping_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_api_mapping_request.GetApiMappingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_api_mapping(
