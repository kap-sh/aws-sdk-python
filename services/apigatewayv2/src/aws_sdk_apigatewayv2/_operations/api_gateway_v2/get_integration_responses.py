"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetIntegrationResponses``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_integration_responses_response.GetIntegrationResponsesResponse = aws_sdk_apigatewayv2.types.get_integration_responses_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.get_integration_responses_request.GetIntegrationResponsesRequest,
) -> zapros.Request:
...
async def async_get_integration_responses(
