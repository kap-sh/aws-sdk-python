...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.update_product_page_response.UpdateProductPageResponse = aws_sdk_apigatewayv2.types.update_product_page_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.update_product_page_request.UpdateProductPageRequest,
) -> zapros.Request:
    ...
    url = url.replace("{ProductPageId}", quote(str(input["product_page_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_apigatewayv2.types.update_product_page_request

    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.update_product_page_request.serialize_json(input)
    ).encode()
