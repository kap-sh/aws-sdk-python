...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.update_product_page_request.UpdateProductPageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.update_product_page_request.serialize_json(input_)
    ).encode()
