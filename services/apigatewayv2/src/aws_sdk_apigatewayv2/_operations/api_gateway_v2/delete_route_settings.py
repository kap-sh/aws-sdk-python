"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#DeleteRouteSettings``."""
...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.delete_route_settings_request.DeleteRouteSettingsRequest,
) -> zapros.Request:
    ...
    url = url.replace("{RouteKey}", quote(str(input["route_key"]), safe=""))
...
async def async_delete_route_settings(
