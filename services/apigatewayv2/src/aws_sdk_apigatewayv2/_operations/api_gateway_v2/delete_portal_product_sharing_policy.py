"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#DeletePortalProductSharingPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.delete_portal_product_sharing_policy_request.DeletePortalProductSharingPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_portal_product_sharing_policy(
