...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_integration_response_response.GetIntegrationResponseResponse = aws_sdk_apigatewayv2.types.get_integration_response_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_integration_response_request.GetIntegrationResponseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
