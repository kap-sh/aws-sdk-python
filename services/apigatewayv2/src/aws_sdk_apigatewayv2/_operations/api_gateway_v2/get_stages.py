"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetStages``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_stages_response.GetStagesResponse = (
        aws_sdk_apigatewayv2.types.get_stages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_stages_request.GetStagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_stages(
    ...
    aws_sdk_apigatewayv2.types.get_stages_response.GetStagesResponse, zapros.Response
]:
