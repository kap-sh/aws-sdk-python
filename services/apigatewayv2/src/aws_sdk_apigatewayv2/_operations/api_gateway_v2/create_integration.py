...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_integration_result.CreateIntegrationResult = aws_sdk_apigatewayv2.types.create_integration_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.create_integration_request.CreateIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_integration_request.serialize_json(input_)
    ).encode()
