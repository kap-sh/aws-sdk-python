...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.create_integration_request.CreateIntegrationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_integration_request.serialize_json(input)
    ).encode()
