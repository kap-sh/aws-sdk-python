"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetProductRestEndpointPage``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_product_rest_endpoint_page_response.GetProductRestEndpointPageResponse = aws_sdk_apigatewayv2.types.get_product_rest_endpoint_page_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_product_rest_endpoint_page_request.GetProductRestEndpointPageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["product_rest_endpoint_page_id"]), safe=""),
    )
    params: dict[str, str] = {}
    if "include_raw_display_content" in input_:
        params["includeRawDisplayContent"] = str(input_["include_raw_display_content"])
...
async def async_get_product_rest_endpoint_page(
