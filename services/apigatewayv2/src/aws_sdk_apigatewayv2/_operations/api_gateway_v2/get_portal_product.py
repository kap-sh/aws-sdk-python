"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetPortalProduct``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_portal_product_response.GetPortalProductResponse = aws_sdk_apigatewayv2.types.get_portal_product_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_portal_product_request.GetPortalProductRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_portal_product(
