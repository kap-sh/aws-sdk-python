"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateStage``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_stage_response.CreateStageResponse = (
        aws_sdk_apigatewayv2.types.create_stage_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.create_stage_request.CreateStageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/apis/{ApiId}/stages"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_stage_request.serialize_json(input_)
    ).encode()
