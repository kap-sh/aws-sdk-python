...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_product_rest_endpoint_page_response.CreateProductRestEndpointPageResponse = aws_sdk_apigatewayv2.types.create_product_rest_endpoint_page_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.create_product_rest_endpoint_page_request.CreateProductRestEndpointPageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_product_rest_endpoint_page_request.serialize_json(
            input_
        )
    ).encode()
