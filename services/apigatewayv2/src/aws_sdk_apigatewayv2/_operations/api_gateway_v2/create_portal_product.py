"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreatePortalProduct``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_portal_product_response.CreatePortalProductResponse = aws_sdk_apigatewayv2.types.create_portal_product_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.create_portal_product_request.CreatePortalProductRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/portalproducts"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_apigatewayv2.types.create_portal_product_request

    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_portal_product_request.serialize_json(input_)
    ).encode()
...
async def async_create_portal_product(
