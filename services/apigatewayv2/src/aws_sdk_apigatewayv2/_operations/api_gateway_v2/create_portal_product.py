...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.create_portal_product_request.CreatePortalProductRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_portal_product_request.serialize_json(input)
    ).encode()
