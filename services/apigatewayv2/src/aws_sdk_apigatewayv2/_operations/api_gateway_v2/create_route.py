...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_route_result.CreateRouteResult = (
        aws_sdk_apigatewayv2.types.create_route_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.create_route_request.CreateRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_route_request.serialize_json(input_)
    ).encode()
...
def create_route(
    ...
    aws_sdk_apigatewayv2.types.create_route_result.CreateRouteResult, zapros.Response
]:
