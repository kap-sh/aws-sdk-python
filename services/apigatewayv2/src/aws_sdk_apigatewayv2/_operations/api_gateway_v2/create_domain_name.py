...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.create_domain_name_request.CreateDomainNameRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_domain_name_request.serialize_json(input)
    ).encode()
