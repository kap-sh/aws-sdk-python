"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#ListRoutingRules``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.list_routing_rules_response.ListRoutingRulesResponse = aws_sdk_apigatewayv2.types.list_routing_rules_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.list_routing_rules_request.ListRoutingRulesRequest,
) -> zapros.Request:
...
async def async_list_routing_rules(
