"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#PreviewPortal``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.preview_portal_response.PreviewPortalResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.preview_portal_request.PreviewPortalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/portals/{PortalId}/preview"
...
async def async_preview_portal(
