...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.update_deployment_response.UpdateDeploymentResponse = aws_sdk_apigatewayv2.types.update_deployment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.update_deployment_request.UpdateDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.update_deployment_request.serialize_json(input_)
    ).encode()
