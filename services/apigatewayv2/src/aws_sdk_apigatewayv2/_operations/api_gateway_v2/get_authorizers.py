"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetAuthorizers``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_authorizers_response.GetAuthorizersResponse = (
        aws_sdk_apigatewayv2.types.get_authorizers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_authorizers_request.GetAuthorizersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
