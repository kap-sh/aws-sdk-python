...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.list_product_pages_response.ListProductPagesResponse = aws_sdk_apigatewayv2.types.list_product_pages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.list_product_pages_request.ListProductPagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
