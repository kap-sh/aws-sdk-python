"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetModel``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_model_response.GetModelResponse = (
        aws_sdk_apigatewayv2.types.get_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_model_request.GetModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_model(
    ...
    aws_sdk_apigatewayv2.types.get_model_response.GetModelResponse, zapros.Response
]:
