"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#DeleteAuthorizer``."""
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.delete_authorizer_request.DeleteAuthorizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
