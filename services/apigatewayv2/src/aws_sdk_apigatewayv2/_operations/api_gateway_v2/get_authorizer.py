...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_authorizer_response.GetAuthorizerResponse = (
        aws_sdk_apigatewayv2.types.get_authorizer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_authorizer_request.GetAuthorizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
