...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_api_mapping_response.CreateApiMappingResponse = aws_sdk_apigatewayv2.types.create_api_mapping_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.create_api_mapping_request.CreateApiMappingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_api_mapping_request.serialize_json(input)
    ).encode()
