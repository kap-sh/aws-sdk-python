"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateModel``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_model_response.CreateModelResponse = (
        aws_sdk_apigatewayv2.types.create_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.create_model_request.CreateModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_model_request.serialize_json(input_)
    ).encode()
