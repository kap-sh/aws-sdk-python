...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_routes_response.GetRoutesResponse = (
        aws_sdk_apigatewayv2.types.get_routes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_routes_request.GetRoutesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_routes(
    ...
    aws_sdk_apigatewayv2.types.get_routes_response.GetRoutesResponse, zapros.Response
]:
