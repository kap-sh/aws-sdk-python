...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.update_domain_name_response.UpdateDomainNameResponse = aws_sdk_apigatewayv2.types.update_domain_name_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.update_domain_name_request.UpdateDomainNameRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.update_domain_name_request.serialize_json(input_)
    ).encode()
