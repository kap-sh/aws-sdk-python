...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.update_domain_name_request.UpdateDomainNameRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.update_domain_name_request.serialize_json(input)
    ).encode()
