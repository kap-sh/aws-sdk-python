...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_vpc_link_response.GetVpcLinkResponse = (
        aws_sdk_apigatewayv2.types.get_vpc_link_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_vpc_link_request.GetVpcLinkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_vpc_link(
    ...
    aws_sdk_apigatewayv2.types.get_vpc_link_response.GetVpcLinkResponse, zapros.Response
]:
