"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetPortalProductSharingPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_portal_product_sharing_policy_response.GetPortalProductSharingPolicyResponse = aws_sdk_apigatewayv2.types.get_portal_product_sharing_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_portal_product_sharing_policy_request.GetPortalProductSharingPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/v2/portalproducts/{PortalProductId}/sharingpolicy"
    )
    url = url.replace(
...
async def async_get_portal_product_sharing_policy(
