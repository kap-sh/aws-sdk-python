"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#ListPortalProducts``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.list_portal_products_response.ListPortalProductsResponse = aws_sdk_apigatewayv2.types.list_portal_products_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.list_portal_products_request.ListPortalProductsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_portal_products(
