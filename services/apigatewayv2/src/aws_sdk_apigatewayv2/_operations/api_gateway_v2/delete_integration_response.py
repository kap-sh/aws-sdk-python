"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#DeleteIntegrationResponse``."""
...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.delete_integration_response_request.DeleteIntegrationResponseRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{IntegrationResponseId}", quote(str(input["integration_response_id"]), safe="")
    )
    params: dict[str, str] = {}
