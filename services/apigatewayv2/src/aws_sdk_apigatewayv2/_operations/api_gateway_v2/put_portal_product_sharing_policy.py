...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.put_portal_product_sharing_policy_response.PutPortalProductSharingPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.put_portal_product_sharing_policy_request.PutPortalProductSharingPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.put_portal_product_sharing_policy_request.serialize_json(
            input_
        )
    ).encode()
