...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.import_api_request.ImportApiRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.import_api_request.serialize_json(input)
    ).encode()
...
def import_api(
    ...
    aws_sdk_apigatewayv2.types.import_api_response.ImportApiResponse, zapros.Response
]:
