"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#DeleteIntegration``."""
...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.delete_integration_request.DeleteIntegrationRequest,
) -> zapros.Request:
