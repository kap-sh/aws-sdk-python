...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_product_page_response.GetProductPageResponse = (
        aws_sdk_apigatewayv2.types.get_product_page_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.get_product_page_request.GetProductPageRequest,
) -> zapros.Request:
