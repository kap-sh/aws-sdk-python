...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_integrations_response.GetIntegrationsResponse = aws_sdk_apigatewayv2.types.get_integrations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_integrations_request.GetIntegrationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
