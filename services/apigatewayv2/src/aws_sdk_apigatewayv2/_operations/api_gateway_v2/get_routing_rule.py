...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_routing_rule_response.GetRoutingRuleResponse = (
        aws_sdk_apigatewayv2.types.get_routing_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_routing_rule_request.GetRoutingRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
