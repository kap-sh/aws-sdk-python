...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_route_result.GetRouteResult = (
        aws_sdk_apigatewayv2.types.get_route_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_route_request.GetRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_route(
    ...
    input_: aws_sdk_apigatewayv2.types.get_route_request.GetRouteRequest,
) -> tuple[aws_sdk_apigatewayv2.types.get_route_result.GetRouteResult, zapros.Response]:
