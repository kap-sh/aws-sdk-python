...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_vpc_link_response.CreateVpcLinkResponse = (
        aws_sdk_apigatewayv2.types.create_vpc_link_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.create_vpc_link_request.CreateVpcLinkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_vpc_link_request.serialize_json(input_)
    ).encode()
