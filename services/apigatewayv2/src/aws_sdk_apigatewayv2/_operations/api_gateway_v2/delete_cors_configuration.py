"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#DeleteCorsConfiguration``."""
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.delete_cors_configuration_request.DeleteCorsConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/apis/{ApiId}/cors"
...
async def async_delete_cors_configuration(
