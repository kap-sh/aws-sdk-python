"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#DeletePortal``."""
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.delete_portal_request.DeletePortalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/portals/{PortalId}"
