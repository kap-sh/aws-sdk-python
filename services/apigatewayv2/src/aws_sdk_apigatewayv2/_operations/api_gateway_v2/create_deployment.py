"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateDeployment``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_deployment_response.CreateDeploymentResponse = aws_sdk_apigatewayv2.types.create_deployment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.create_deployment_request.CreateDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_deployment_request.serialize_json(input_)
    ).encode()
