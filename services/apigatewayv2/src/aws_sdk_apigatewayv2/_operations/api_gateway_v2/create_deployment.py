...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.create_deployment_request.CreateDeploymentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_deployment_request.serialize_json(input)
    ).encode()
