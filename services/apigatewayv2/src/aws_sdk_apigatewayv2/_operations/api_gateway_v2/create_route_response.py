...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_route_response_response.CreateRouteResponseResponse = aws_sdk_apigatewayv2.types.create_route_response_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.create_route_response_request.CreateRouteResponseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_route_response_request.serialize_json(input_)
    ).encode()
