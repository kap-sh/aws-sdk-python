...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.create_route_response_request.CreateRouteResponseRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_route_response_request.serialize_json(input)
    ).encode()
