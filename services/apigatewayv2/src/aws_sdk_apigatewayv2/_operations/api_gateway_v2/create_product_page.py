...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.create_product_page_request.CreateProductPageRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_product_page_request.serialize_json(input)
    ).encode()
