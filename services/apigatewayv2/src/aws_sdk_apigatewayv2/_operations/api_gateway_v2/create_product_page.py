...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_product_page_response.CreateProductPageResponse = aws_sdk_apigatewayv2.types.create_product_page_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.create_product_page_request.CreateProductPageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_product_page_request.serialize_json(input_)
    ).encode()
