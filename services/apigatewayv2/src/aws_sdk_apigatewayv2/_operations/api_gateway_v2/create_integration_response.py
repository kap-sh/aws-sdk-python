"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateIntegrationResponse``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_integration_response_response.CreateIntegrationResponseResponse = aws_sdk_apigatewayv2.types.create_integration_response_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.create_integration_response_request.CreateIntegrationResponseRequest,
) -> zapros.Request:
    ...
    url = url.replace("{IntegrationId}", quote(str(input["integration_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_apigatewayv2.types.create_integration_response_request

    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_integration_response_request.serialize_json(
            input
        )
    ).encode()
...
async def async_create_integration_response(
