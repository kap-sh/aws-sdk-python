...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.create_authorizer_request.CreateAuthorizerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_authorizer_request.serialize_json(input)
    ).encode()
