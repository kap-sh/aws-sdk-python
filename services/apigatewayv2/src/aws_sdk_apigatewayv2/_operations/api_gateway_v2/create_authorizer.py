...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_authorizer_response.CreateAuthorizerResponse = aws_sdk_apigatewayv2.types.create_authorizer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.create_authorizer_request.CreateAuthorizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_authorizer_request.serialize_json(input_)
    ).encode()
