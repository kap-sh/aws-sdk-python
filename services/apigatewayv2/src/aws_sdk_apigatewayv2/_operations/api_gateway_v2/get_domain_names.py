"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetDomainNames``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_domain_names_response.GetDomainNamesResponse = (
        aws_sdk_apigatewayv2.types.get_domain_names_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_domain_names_request.GetDomainNamesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
