"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#ListProductRestEndpointPages``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.list_product_rest_endpoint_pages_response.ListProductRestEndpointPagesResponse = aws_sdk_apigatewayv2.types.list_product_rest_endpoint_pages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.list_product_rest_endpoint_pages_request.ListProductRestEndpointPagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_product_rest_endpoint_pages(
