"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#DeleteAccessLogSettings``."""
...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.delete_access_log_settings_request.DeleteAccessLogSettingsRequest,
) -> zapros.Request:
...
async def async_delete_access_log_settings(
