"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#UpdateModel``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.update_model_response.UpdateModelResponse = (
        aws_sdk_apigatewayv2.types.update_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.update_model_request.UpdateModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/apis/{ApiId}/models/{ModelId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.update_model_request.serialize_json(input_)
    ).encode()
