...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_portal_response.GetPortalResponse = (
        aws_sdk_apigatewayv2.types.get_portal_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_portal_request.GetPortalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_portal(
    ...
    aws_sdk_apigatewayv2.types.get_portal_response.GetPortalResponse, zapros.Response
]:
