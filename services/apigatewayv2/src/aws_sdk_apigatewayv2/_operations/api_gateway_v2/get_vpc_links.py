...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_vpc_links_response.GetVpcLinksResponse = (
        aws_sdk_apigatewayv2.types.get_vpc_links_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_vpc_links_request.GetVpcLinksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
