...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_api_response.CreateApiResponse = (
        aws_sdk_apigatewayv2.types.create_api_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.create_api_request.CreateApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_api_request.serialize_json(input_)
    ).encode()
...
def create_api(
    ...
    aws_sdk_apigatewayv2.types.create_api_response.CreateApiResponse, zapros.Response
]:
