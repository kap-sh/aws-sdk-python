...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_deployment_response.GetDeploymentResponse = (
        aws_sdk_apigatewayv2.types.get_deployment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_deployment_request.GetDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
