...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_stage_response.GetStageResponse = (
        aws_sdk_apigatewayv2.types.get_stage_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.get_stage_request.GetStageRequest,
) -> zapros.Request:
...
def get_stage(
    ...
    aws_sdk_apigatewayv2.types.get_stage_response.GetStageResponse, zapros.Response
]:
