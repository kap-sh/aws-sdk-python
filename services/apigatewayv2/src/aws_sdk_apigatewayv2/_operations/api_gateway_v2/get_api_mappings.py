...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_api_mappings_response.GetApiMappingsResponse = (
        aws_sdk_apigatewayv2.types.get_api_mappings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_api_mappings_request.GetApiMappingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
