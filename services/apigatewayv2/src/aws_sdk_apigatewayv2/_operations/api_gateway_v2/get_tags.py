...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_tags_response.GetTagsResponse = (
        aws_sdk_apigatewayv2.types.get_tags_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_tags_request.GetTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_tags(
    ...
    aws_sdk_apigatewayv2.types.get_tags_response.GetTagsResponse, zapros.Response
]:
