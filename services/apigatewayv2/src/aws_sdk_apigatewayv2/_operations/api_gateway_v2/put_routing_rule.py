...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.put_routing_rule_request.PutRoutingRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.put_routing_rule_request.serialize_json(input_)
    ).encode()
