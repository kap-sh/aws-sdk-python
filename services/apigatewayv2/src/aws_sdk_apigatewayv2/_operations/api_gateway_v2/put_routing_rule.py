"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#PutRoutingRule``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.put_routing_rule_response.PutRoutingRuleResponse = (
        aws_sdk_apigatewayv2.types.put_routing_rule_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.put_routing_rule_request.PutRoutingRuleRequest,
) -> zapros.Request:
    ...
    url = url.replace("{RoutingRuleId}", quote(str(input["routing_rule_id"]), safe=""))
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.put_routing_rule_request.serialize_json(input)
    ).encode()
...
async def async_put_routing_rule(
