...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.update_route_result.UpdateRouteResult = (
        aws_sdk_apigatewayv2.types.update_route_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.update_route_request.UpdateRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.update_route_request.serialize_json(input_)
    ).encode()
...
def update_route(
    ...
    aws_sdk_apigatewayv2.types.update_route_result.UpdateRouteResult, zapros.Response
]:
