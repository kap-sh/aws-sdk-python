...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_deployments_response.GetDeploymentsResponse = (
        aws_sdk_apigatewayv2.types.get_deployments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_deployments_request.GetDeploymentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
