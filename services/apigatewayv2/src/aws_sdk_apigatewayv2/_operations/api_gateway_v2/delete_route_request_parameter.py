...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.delete_route_request_parameter_request.DeleteRouteRequestParameterRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{RequestParameterKey}", quote(str(input["request_parameter_key"]), safe="")
    )
