"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#DeleteApi``."""
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.delete_api_request.DeleteApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
