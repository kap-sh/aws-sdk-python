...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.update_stage_response.UpdateStageResponse = (
        aws_sdk_apigatewayv2.types.update_stage_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.update_stage_request.UpdateStageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.update_stage_request.serialize_json(input_)
    ).encode()
