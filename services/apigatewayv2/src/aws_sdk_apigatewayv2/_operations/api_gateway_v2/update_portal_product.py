...
def build_request(
    ...
    input: aws_sdk_apigatewayv2.types.update_portal_product_request.UpdatePortalProductRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.update_portal_product_request.serialize_json(input)
    ).encode()
