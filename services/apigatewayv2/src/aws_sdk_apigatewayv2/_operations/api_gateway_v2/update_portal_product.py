...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.update_portal_product_response.UpdatePortalProductResponse = aws_sdk_apigatewayv2.types.update_portal_product_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.update_portal_product_request.UpdatePortalProductRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.update_portal_product_request.serialize_json(input_)
    ).encode()
