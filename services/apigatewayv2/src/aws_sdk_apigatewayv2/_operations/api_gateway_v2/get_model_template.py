...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_model_template_response.GetModelTemplateResponse = aws_sdk_apigatewayv2.types.get_model_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_model_template_request.GetModelTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
