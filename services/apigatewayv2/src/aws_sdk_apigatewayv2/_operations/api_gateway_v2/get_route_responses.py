"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetRouteResponses``."""
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_route_responses_response.GetRouteResponsesResponse = aws_sdk_apigatewayv2.types.get_route_responses_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_route_responses_request.GetRouteResponsesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/apis/{ApiId}/routes/{RouteId}/routeresponses"
...
async def async_get_route_responses(
