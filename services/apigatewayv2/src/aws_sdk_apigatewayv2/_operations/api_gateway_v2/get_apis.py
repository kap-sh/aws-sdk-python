...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_apis_response.GetApisResponse = (
        aws_sdk_apigatewayv2.types.get_apis_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_apis_request.GetApisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_apis(
    ...
    aws_sdk_apigatewayv2.types.get_apis_response.GetApisResponse, zapros.Response
]:
