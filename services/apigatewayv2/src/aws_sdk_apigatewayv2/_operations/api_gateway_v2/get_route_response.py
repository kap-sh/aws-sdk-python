...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_route_response_response.GetRouteResponseResponse = aws_sdk_apigatewayv2.types.get_route_response_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_route_response_request.GetRouteResponseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
