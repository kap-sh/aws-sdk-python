...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.update_api_mapping_response.UpdateApiMappingResponse = aws_sdk_apigatewayv2.types.update_api_mapping_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.update_api_mapping_request.UpdateApiMappingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.update_api_mapping_request.serialize_json(input_)
    ).encode()
