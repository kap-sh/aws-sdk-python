"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#ListPortals``."""
...
import aws_sdk_apigatewayv2.types.__list_of_portal_summary
...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.list_portals_response.ListPortalsResponse = (
        aws_sdk_apigatewayv2.types.list_portals_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.list_portals_request.ListPortalsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
