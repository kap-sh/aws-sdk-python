...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.get_models_response.GetModelsResponse = (
        aws_sdk_apigatewayv2.types.get_models_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.get_models_request.GetModelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_models(
    ...
    aws_sdk_apigatewayv2.types.get_models_response.GetModelsResponse, zapros.Response
]:
