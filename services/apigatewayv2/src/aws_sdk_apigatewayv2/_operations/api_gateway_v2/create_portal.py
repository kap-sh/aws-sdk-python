...
def handle_response(
    ...
    out: aws_sdk_apigatewayv2.types.create_portal_response.CreatePortalResponse = (
        aws_sdk_apigatewayv2.types.create_portal_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_apigatewayv2.types.create_portal_request.CreatePortalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_apigatewayv2.types.create_portal_request.serialize_json(input_)
    ).encode()
