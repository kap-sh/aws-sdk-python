...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateIntegrationResponseResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateIntegrationResponseResponse:
    out: UpdateIntegrationResponseResponse = {}  # type: ignore[typeddict-item]
