"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreatePortalProductResponse``."""
...
class CreatePortalProductResponse(TypedDict, closed=True):
    ...
    display_order: NotRequired["capo_apigatewayv2.types.display_order.DisplayOrder"]
...
# --- restJson1 ser/de ---
def serialize_json(value: CreatePortalProductResponse) -> dict:
    out: dict = {}
    ...
    if "display_order" in value:
        ...
        out["displayOrder"] = capo_apigatewayv2.types.display_order.serialize_json(
            value["display_order"]
        )
