...
if TYPE_CHECKING:
    ...
    import capo_apigatewayv2.types.__double
    import capo_apigatewayv2.types.__integer
    import capo_apigatewayv2.types.logging_level


class RouteSettings(TypedDict, closed=True):
    data_trace_enabled: NotRequired["capo_apigatewayv2.types.__boolean.__boolean"]
    ...
    detailed_metrics_enabled: NotRequired["capo_apigatewayv2.types.__boolean.__boolean"]
    """<p>Specifies whether detailed metrics are enabled.</p>"""
    logging_level: NotRequired["capo_apigatewayv2.types.logging_level.LoggingLevel"]
    ...
    throttling_burst_limit: NotRequired["capo_apigatewayv2.types.__integer.__integer"]
    """<p>Specifies the throttling burst limit.</p>"""
    throttling_rate_limit: NotRequired["capo_apigatewayv2.types.__double.__double"]
...
def serialize_json(value: RouteSettings) -> dict:
    ...
    if "logging_level" in value:
        ...
        out["loggingLevel"] = capo_apigatewayv2.types.logging_level.serialize_json(
            value["logging_level"]
        )
