"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#UpdateModelResponse``."""
...
class UpdateModelResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateModelResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateModelResponse:
    out: UpdateModelResponse = {}  # type: ignore[typeddict-item]
