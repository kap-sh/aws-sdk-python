"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#UpdateProductRestEndpointPageResponse``."""
...
class UpdateProductRestEndpointPageResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateProductRestEndpointPageResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateProductRestEndpointPageResponse:
    out: UpdateProductRestEndpointPageResponse = {}  # type: ignore[typeddict-item]
