...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteApiMappingRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DeleteApiMappingRequest:
    out: DeleteApiMappingRequest = {}  # type: ignore[typeddict-item]
    return out
