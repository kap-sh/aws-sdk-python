"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateIntegrationResponseRequest``."""
...
class CreateIntegrationResponseRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateIntegrationResponseRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateIntegrationResponseRequest:
    out: CreateIntegrationResponseRequest = {}  # type: ignore[typeddict-item]
