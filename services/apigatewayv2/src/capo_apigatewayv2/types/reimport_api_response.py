"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#ReimportApiResponse``."""
...
class ReimportApiResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ReimportApiResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ReimportApiResponse:
    out: ReimportApiResponse = {}  # type: ignore[typeddict-item]
