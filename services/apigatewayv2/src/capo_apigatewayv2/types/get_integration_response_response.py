"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetIntegrationResponseResponse``."""
...
class GetIntegrationResponseResponse(TypedDict, closed=True):
    ...
    integration_response_id: NotRequired["capo_apigatewayv2.types.id.Id"]
...
# --- restJson1 ser/de ---
def serialize_json(value: GetIntegrationResponseResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetIntegrationResponseResponse:
    out: GetIntegrationResponseResponse = {}  # type: ignore[typeddict-item]
