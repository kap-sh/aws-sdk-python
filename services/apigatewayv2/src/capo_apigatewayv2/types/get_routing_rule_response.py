...
class GetRoutingRuleResponse(TypedDict, closed=True):
    actions: NotRequired[
    ...
    routing_rule_arn: NotRequired["capo_apigatewayv2.types.arn.Arn"]
    """<p>The routing rule ARN.</p>"""
    routing_rule_id: NotRequired["capo_apigatewayv2.types.id.Id"]
