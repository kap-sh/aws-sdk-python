"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetDomainNameResponse``."""
...
class GetDomainNameResponse(TypedDict, closed=True):
    ...
    domain_name_arn: NotRequired["capo_apigatewayv2.types.arn.Arn"]
    ...
    mutual_tls_authentication: NotRequired[
        "capo_apigatewayv2.types.mutual_tls_authentication.MutualTlsAuthentication"
    ]
    """<p>The mutual TLS authentication configuration for a custom domain name.</p>"""
    routing_mode: NotRequired["capo_apigatewayv2.types.routing_mode.RoutingMode"]
...
def serialize_json(value: GetDomainNameResponse) -> dict:
    ...
    if "domain_name_configurations" in value:
        ...
        out["domainNameConfigurations"] = (
            capo_apigatewayv2.types.domain_name_configurations.serialize_json(
    ...
    if "mutual_tls_authentication" in value:
        ...
        out["mutualTlsAuthentication"] = (
            capo_apigatewayv2.types.mutual_tls_authentication.serialize_json(
    ...
    if "routing_mode" in value:
        ...
        out["routingMode"] = capo_apigatewayv2.types.routing_mode.serialize_json(
            value["routing_mode"]
        )
    if "tags" in value:
        import capo_apigatewayv2.types.tags
...
def deserialize_json(data: dict) -> GetDomainNameResponse:
    ...
    if "domainNameConfigurations" in data:
        ...
        out["domain_name_configurations"] = (
            capo_apigatewayv2.types.domain_name_configurations.deserialize_json(
    ...
    if "mutualTlsAuthentication" in data:
        ...
        out["mutual_tls_authentication"] = (
            capo_apigatewayv2.types.mutual_tls_authentication.deserialize_json(
