"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetVpcLinkResponse``."""
...
class GetVpcLinkResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetVpcLinkResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetVpcLinkResponse:
    out: GetVpcLinkResponse = {}  # type: ignore[typeddict-item]
