"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateProductPageResponse``."""
...
class CreateProductPageResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateProductPageResponse) -> dict:
    out: dict = {}
