"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#UpdateDeploymentResponse``."""
...
class UpdateDeploymentResponse(TypedDict, closed=True):
    auto_deployed: NotRequired["capo_apigatewayv2.types.__boolean.__boolean"]
    ...
    deployment_status: NotRequired[
        "capo_apigatewayv2.types.deployment_status.DeploymentStatus"
    ]
    """<p>The status of the deployment: PENDING, FAILED, or SUCCEEDED.</p>"""
    deployment_status_message: NotRequired["capo_apigatewayv2.types.__string.__string"]
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateDeploymentResponse) -> dict:
    out: dict = {}
    ...
    if "deployment_status" in value:
        ...
        out["deploymentStatus"] = (
            capo_apigatewayv2.types.deployment_status.serialize_json(
...
def deserialize_json(data: dict) -> UpdateDeploymentResponse:
    ...
    if "deploymentStatus" in data:
        ...
        out["deployment_status"] = (
            capo_apigatewayv2.types.deployment_status.deserialize_json(
