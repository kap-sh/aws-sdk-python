...
if TYPE_CHECKING:
    ...
    import capo_apigatewayv2.types.__string_min1_max1024
...
class ProductRestEndpointPageSummaryNoBody(TypedDict, closed=True):
    endpoint: NotRequired[
        "capo_apigatewayv2.types.__string_min1_max1024.__stringMin1Max1024"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: ProductRestEndpointPageSummaryNoBody) -> dict:
    out: dict = {}
