"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#UpdateRouteResult``."""
...
class UpdateRouteResult(TypedDict, closed=True):
    ...
    route_id: NotRequired["capo_apigatewayv2.types.id.Id"]
    """<p>The route ID.</p>"""
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateRouteResult) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateRouteResult:
    out: UpdateRouteResult = {}  # type: ignore[typeddict-item]
