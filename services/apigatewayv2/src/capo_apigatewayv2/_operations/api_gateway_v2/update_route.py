"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#UpdateRoute``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.update_route_result.UpdateRouteResult = (
        capo_apigatewayv2.types.update_route_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/apis/{ApiId}/routes/{RouteId}"
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.update_route_request.serialize_json(input_)
    ).encode()
...
def update_route(
    ...
    capo_apigatewayv2.types.update_route_result.UpdateRouteResult, zapros.Response
]:
