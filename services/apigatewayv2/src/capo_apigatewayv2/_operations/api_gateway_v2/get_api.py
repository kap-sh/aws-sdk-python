"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetApi``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_api_response.GetApiResponse = (
        capo_apigatewayv2.types.get_api_response.deserialize_json(
...
def get_api(
    ...
    input_: capo_apigatewayv2.types.get_api_request.GetApiRequest,
) -> tuple[capo_apigatewayv2.types.get_api_response.GetApiResponse, zapros.Response]:
