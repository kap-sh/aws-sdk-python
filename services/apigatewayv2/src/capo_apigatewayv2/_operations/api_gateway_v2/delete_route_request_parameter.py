"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#DeleteRouteRequestParameter``."""
...
def build_request(
    ...
    url = url.replace(
        "{RequestParameterKey}", quote(str(input_["request_parameter_key"]), safe="")
    )
...
async def async_delete_route_request_parameter(
