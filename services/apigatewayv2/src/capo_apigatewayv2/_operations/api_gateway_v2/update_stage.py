"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#UpdateStage``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.update_stage_response.UpdateStageResponse = (
        capo_apigatewayv2.types.update_stage_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/apis/{ApiId}/stages/{StageName}"
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.update_stage_request.serialize_json(input_)
    ).encode()
...
def update_stage(
    ...
    capo_apigatewayv2.types.update_stage_response.UpdateStageResponse, zapros.Response
]:
