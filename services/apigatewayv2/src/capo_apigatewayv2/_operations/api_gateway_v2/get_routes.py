"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetRoutes``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_routes_response.GetRoutesResponse = (
        capo_apigatewayv2.types.get_routes_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/apis/{ApiId}/routes"
...
def get_routes(
    ...
    capo_apigatewayv2.types.get_routes_response.GetRoutesResponse, zapros.Response
]:
