"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetProductPage``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_product_page_response.GetProductPageResponse = (
        capo_apigatewayv2.types.get_product_page_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{ProductPageId}", quote(str(input_["product_page_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_get_product_page(
