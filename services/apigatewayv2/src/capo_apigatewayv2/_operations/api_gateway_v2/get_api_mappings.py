"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetApiMappings``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_api_mappings_response.GetApiMappingsResponse = (
        capo_apigatewayv2.types.get_api_mappings_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/domainnames/{DomainName}/apimappings"
...
async def async_get_api_mappings(
