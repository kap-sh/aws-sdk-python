"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetModelTemplate``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_model_template_response.GetModelTemplateResponse = capo_apigatewayv2.types.get_model_template_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/apis/{ApiId}/models/{ModelId}/template"
