"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetDeployments``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_deployments_response.GetDeploymentsResponse = (
        capo_apigatewayv2.types.get_deployments_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/apis/{ApiId}/deployments"
