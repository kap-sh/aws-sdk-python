"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetVpcLink``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_vpc_link_response.GetVpcLinkResponse = (
        capo_apigatewayv2.types.get_vpc_link_response.deserialize_json(
...
def get_vpc_link(
    ...
    capo_apigatewayv2.types.get_vpc_link_response.GetVpcLinkResponse, zapros.Response
]:
