"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetIntegrations``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_integrations_response.GetIntegrationsResponse = (
        capo_apigatewayv2.types.get_integrations_response.deserialize_json(
