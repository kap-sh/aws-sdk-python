"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetIntegration``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_integration_result.GetIntegrationResult = (
        capo_apigatewayv2.types.get_integration_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/apis/{ApiId}/integrations/{IntegrationId}"
...
def get_integration(
    ...
    capo_apigatewayv2.types.get_integration_result.GetIntegrationResult, zapros.Response
]:
