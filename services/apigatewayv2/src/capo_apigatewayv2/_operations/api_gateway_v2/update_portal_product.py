"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#UpdatePortalProduct``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.update_portal_product_response.UpdatePortalProductResponse = capo_apigatewayv2.types.update_portal_product_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/portalproducts/{PortalProductId}"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.update_portal_product_request.serialize_json(input_)
    ).encode()
...
async def async_update_portal_product(
