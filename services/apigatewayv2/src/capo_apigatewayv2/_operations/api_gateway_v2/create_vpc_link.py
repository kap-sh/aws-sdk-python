"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateVpcLink``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.create_vpc_link_response.CreateVpcLinkResponse = (
        capo_apigatewayv2.types.create_vpc_link_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.create_vpc_link_request.serialize_json(input_)
    ).encode()
