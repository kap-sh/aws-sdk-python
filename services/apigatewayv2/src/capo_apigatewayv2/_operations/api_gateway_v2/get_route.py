"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetRoute``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_route_result.GetRouteResult = (
        capo_apigatewayv2.types.get_route_result.deserialize_json(
...
def get_route(
    ...
    input_: capo_apigatewayv2.types.get_route_request.GetRouteRequest,
) -> tuple[capo_apigatewayv2.types.get_route_result.GetRouteResult, zapros.Response]:
