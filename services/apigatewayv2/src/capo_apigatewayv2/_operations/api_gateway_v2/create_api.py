"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateApi``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.create_api_response.CreateApiResponse = (
        capo_apigatewayv2.types.create_api_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.create_api_request.serialize_json(input_)
    ).encode()
...
def create_api(
    ...
    capo_apigatewayv2.types.create_api_response.CreateApiResponse, zapros.Response
]:
