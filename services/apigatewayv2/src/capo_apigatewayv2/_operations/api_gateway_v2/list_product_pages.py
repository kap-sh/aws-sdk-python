"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#ListProductPages``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.list_product_pages_response.ListProductPagesResponse = capo_apigatewayv2.types.list_product_pages_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/portalproducts/{PortalProductId}/productpages"
    url = url.replace(
    ...
    if "resource_owner_account_id" in input_:
        params["resourceOwnerAccountId"] = str(input_["resource_owner_account_id"])
...
async def async_list_product_pages(
