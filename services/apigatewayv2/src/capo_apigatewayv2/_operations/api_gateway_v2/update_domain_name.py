"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#UpdateDomainName``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.update_domain_name_response.UpdateDomainNameResponse = capo_apigatewayv2.types.update_domain_name_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.update_domain_name_request.serialize_json(input_)
    ).encode()
