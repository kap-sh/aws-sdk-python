"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetRoutingRule``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_routing_rule_response.GetRoutingRuleResponse = (
        capo_apigatewayv2.types.get_routing_rule_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{RoutingRuleId}", quote(str(input_["routing_rule_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_get_routing_rule(
