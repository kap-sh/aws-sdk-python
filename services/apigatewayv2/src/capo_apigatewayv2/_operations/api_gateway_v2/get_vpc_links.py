"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetVpcLinks``."""
...
import capo_apigatewayv2.types.__list_of_vpc_link
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_vpc_links_response.GetVpcLinksResponse = (
        capo_apigatewayv2.types.get_vpc_links_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/vpclinks"
    params: dict[str, str] = {}
...
def get_vpc_links(
    ...
    capo_apigatewayv2.types.get_vpc_links_response.GetVpcLinksResponse, zapros.Response
]:
