"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetDeployment``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_deployment_response.GetDeploymentResponse = (
        capo_apigatewayv2.types.get_deployment_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/apis/{ApiId}/deployments/{DeploymentId}"
