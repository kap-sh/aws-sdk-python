"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetStage``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_stage_response.GetStageResponse = (
        capo_apigatewayv2.types.get_stage_response.deserialize_json(
...
def get_stage(
    ...
    capo_apigatewayv2.types.get_stage_response.GetStageResponse, zapros.Response
]:
