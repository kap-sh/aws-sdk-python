...
class ApiGatewayV2Error(Exception):
    """Base class for all ApiGatewayV2 service errors."""


class ServiceError(ApiGatewayV2Error):
...
class SerializationError(ApiGatewayV2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(ApiGatewayV2Error):
...
class WaiterFailedError(ApiGatewayV2Error):
...
class WaiterTimeoutError(ApiGatewayV2Error):
