"""Generated from Smithy shape ``com.amazonaws.directoryservicedata#DeleteGroupRequest``."""
...
def deserialize_json(data: dict) -> DeleteGroupRequest:
    ...
    if "SAMAccountName" in data:
        ...
        raise DeserializationError("DeleteGroupRequest.sam_account_name required")
