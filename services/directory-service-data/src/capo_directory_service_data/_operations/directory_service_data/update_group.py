...
def handle_response(
    ...
    out: capo_directory_service_data.types.update_group_result.UpdateGroupResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service_data.types.update_group_request.serialize_json(input_)
    ).encode()
