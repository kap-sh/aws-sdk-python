"""Generated from Smithy shape ``com.amazonaws.directoryservicedata#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.directoryservicedata#ConflictException``."""
