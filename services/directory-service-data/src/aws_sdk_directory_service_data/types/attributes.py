...
if TYPE_CHECKING:
    import aws_sdk_directory_service_data.types.attribute_value
...
Attributes: TypeAlias = dict[
    ...
    "aws_sdk_directory_service_data.types.attribute_value.AttributeValue",
]
...
def serialize_json(input_to_serialize: Attributes) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_directory_service_data.types.attribute_value.serialize_json(
            value
        )
    return out
...
def deserialize_json(data: dict) -> Attributes:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            aws_sdk_directory_service_data.types.attribute_value.deserialize_json(value)
        )
    return out
