"""Generated from Smithy shape ``com.amazonaws.directoryservicedata#ListGroupsResult``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_directory_service_data.types.group_summary_list
    import aws_sdk_directory_service_data.types.next_token
    import aws_sdk_directory_service_data.types.realm


class ListGroupsResult(TypedDict, closed=True):
    ...
    groups: NotRequired[
        "aws_sdk_directory_service_data.types.group_summary_list.GroupSummaryList"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: ListGroupsResult) -> dict:
    out: dict = {}
    ...
    if "groups" in value:
        ...
        out["Groups"] = (
            aws_sdk_directory_service_data.types.group_summary_list.serialize_json(
                value["groups"]
            )
        )
...
def deserialize_json(data: dict) -> ListGroupsResult:
    out: ListGroupsResult = {}  # type: ignore[typeddict-item]
    ...
    if "Groups" in data:
        ...
        out["groups"] = (
            aws_sdk_directory_service_data.types.group_summary_list.deserialize_json(
                data["Groups"]
            )
        )
