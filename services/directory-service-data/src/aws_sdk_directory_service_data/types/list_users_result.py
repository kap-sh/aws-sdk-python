...
if TYPE_CHECKING:
    ...
    import aws_sdk_directory_service_data.types.user_summary_list
...
class ListUsersResult(TypedDict):
    ...
    users: NotRequired[
        "aws_sdk_directory_service_data.types.user_summary_list.UserSummaryList"
    ]
...
def serialize_json(value: ListUsersResult) -> dict:
    ...
    if "users" in value:
        ...
        out["Users"] = (
            aws_sdk_directory_service_data.types.user_summary_list.serialize_json(
                value["users"]
            )
        )
...
def deserialize_json(data: dict) -> ListUsersResult:
    ...
    if "Users" in data:
        ...
        out["users"] = (
            aws_sdk_directory_service_data.types.user_summary_list.deserialize_json(
                data["Users"]
            )
        )
