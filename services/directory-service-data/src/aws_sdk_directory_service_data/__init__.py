...
from ._services.async_directory_service_data import (
    AsyncDirectoryServiceDataClient as AsyncDirectoryServiceDataClient,
)
from ._services.directory_service_data import (
    DirectoryServiceDataClient as DirectoryServiceDataClient,
)
