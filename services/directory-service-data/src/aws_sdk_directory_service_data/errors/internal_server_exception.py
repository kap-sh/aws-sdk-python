"""Generated from Smithy shape ``com.amazonaws.directoryservicedata#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.directoryservicedata#InternalServerException``."""
