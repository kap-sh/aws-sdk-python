...
from aws_sdk_directory_service_data.errors import DeserializationError, ServiceError
...
class ThrottlingException_(TypedDict):
    message: "aws_sdk_directory_service_data.types.exception_message.ExceptionMessage"
