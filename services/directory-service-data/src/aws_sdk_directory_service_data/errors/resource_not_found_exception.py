"""Generated from Smithy shape ``com.amazonaws.directoryservicedata#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.directoryservicedata#ResourceNotFoundException``."""
