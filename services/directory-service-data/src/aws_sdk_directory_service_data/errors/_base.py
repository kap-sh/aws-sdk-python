...
class DirectoryServiceDataError(Exception):
    """Base class for all DirectoryServiceData service errors."""


class ServiceError(DirectoryServiceDataError):
...
class SerializationError(DirectoryServiceDataError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DirectoryServiceDataError):
...
class WaiterFailedError(DirectoryServiceDataError):
...
class WaiterTimeoutError(DirectoryServiceDataError):
