...
```
pip install aws-sdk-directory-service-data
```

## Usage

```python
from aws_sdk_directory_service_data import AsyncDirectoryServiceDataClient
...
```python
from aws_sdk_directory_service_data import AsyncDirectoryServiceDataClient
from aws_sdk_directory_service_data.error import AccessDeniedException
