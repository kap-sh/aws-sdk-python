...
import capo_managedblockchain_query.errors.resource_not_found_exception
...
import capo_managedblockchain_query.types.get_asset_contract_input
import capo_managedblockchain_query.types.get_asset_contract_output
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_managedblockchain_query.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    capo_managedblockchain_query.types.get_asset_contract_output.GetAssetContractOutput
):
    out: capo_managedblockchain_query.types.get_asset_contract_output.GetAssetContractOutput = capo_managedblockchain_query.types.get_asset_contract_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_managedblockchain_query.types.get_asset_contract_input.serialize_json(
            input_
        )
    ).encode()
