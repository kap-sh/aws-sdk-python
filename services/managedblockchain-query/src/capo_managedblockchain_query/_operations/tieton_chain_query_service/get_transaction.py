...
import capo_managedblockchain_query.types.get_transaction_input
import capo_managedblockchain_query.types.get_transaction_output
...
def handle_response(
    ...
    out: capo_managedblockchain_query.types.get_transaction_output.GetTransactionOutput = capo_managedblockchain_query.types.get_transaction_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_managedblockchain_query.types.get_transaction_input.serialize_json(input_)
    ).encode()
