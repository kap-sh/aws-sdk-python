...
class ManagedBlockchainQueryError(Exception):
    """Base class for all ManagedBlockchainQuery service errors."""


class ServiceError(ManagedBlockchainQueryError):
...
class SerializationError(ManagedBlockchainQueryError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ManagedBlockchainQueryError):
...
class WaiterFailedError(ManagedBlockchainQueryError):
...
class WaiterTimeoutError(ManagedBlockchainQueryError):
