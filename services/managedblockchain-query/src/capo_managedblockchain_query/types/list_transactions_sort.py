...
if TYPE_CHECKING:
    import capo_managedblockchain_query.types.list_transactions_sort_by
    import capo_managedblockchain_query.types.sort_order


class ListTransactionsSort(TypedDict, closed=True):
    sort_by: NotRequired[
        "capo_managedblockchain_query.types.list_transactions_sort_by.ListTransactionsSortBy"
    ]
    """<p>Defaults to the value <code>TRANSACTION_TIMESTAMP</code>.</p>"""
    sort_order: NotRequired["capo_managedblockchain_query.types.sort_order.SortOrder"]
