...
from aws_sdk_managedblockchain_query._services._aws_config import aaws_config
...
class AsyncManagedBlockchainQueryClientConfig(TypedDict, total=False, closed=True):
...
class AsyncManagedBlockchainQueryClient:
    ...
    def __init__(
        ...
        self._config = AsyncManagedBlockchainQueryClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncManagedBlockchainQueryClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncManagedBlockchainQueryClientConfig = config_overrides or {}
    ...
    async def batch_get_token_balance(
        self,
        *,
        config_overrides: Optional[AsyncManagedBlockchainQueryClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_managedblockchain_query.types.batch_get_token_balance_input.BatchGetTokenBalanceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_managedblockchain_query.types.batch_get_token_balance_output.BatchGetTokenBalanceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_managedblockchain_query._operations.tieton_chain_query_service.batch_get_token_balance.async_batch_get_token_balance(
    ...
    async def get_asset_contract(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_managedblockchain_query.types.get_asset_contract_input.GetAssetContractInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_managedblockchain_query.types.get_asset_contract_output.GetAssetContractOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_managedblockchain_query._operations.tieton_chain_query_service.get_asset_contract.async_get_asset_contract(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_token_balance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_managedblockchain_query.types.get_token_balance_input.GetTokenBalanceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_managedblockchain_query.types.get_token_balance_output.GetTokenBalanceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_managedblockchain_query._operations.tieton_chain_query_service.get_token_balance.async_get_token_balance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_transaction(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_managedblockchain_query.types.get_transaction_input.GetTransactionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_managedblockchain_query.types.get_transaction_output.GetTransactionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_managedblockchain_query._operations.tieton_chain_query_service.get_transaction.async_get_transaction(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_asset_contracts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_managedblockchain_query.types.list_asset_contracts_input.ListAssetContractsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_managedblockchain_query.types.list_asset_contracts_output.ListAssetContractsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_managedblockchain_query._operations.tieton_chain_query_service.list_asset_contracts.async_list_asset_contracts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_asset_contracts(
        self,
        contract_filter: "aws_sdk_managedblockchain_query.types.contract_filter.ContractFilter",
        *,
        config_overrides: Optional[AsyncManagedBlockchainQueryClientConfig] = None,
        ...
        max_results: Optional[int] = None,
    ) -> "AsyncIterator[aws_sdk_managedblockchain_query.types.asset_contract.AssetContract]":
        _token = next_token
        while True:
            _response = await self.list_asset_contracts(
                contract_filter,
    ...
    async def list_filtered_transaction_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_managedblockchain_query.types.list_filtered_transaction_events_input.ListFilteredTransactionEventsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_managedblockchain_query.types.list_filtered_transaction_events_output.ListFilteredTransactionEventsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_managedblockchain_query._operations.tieton_chain_query_service.list_filtered_transaction_events.async_list_filtered_transaction_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_filtered_transaction_events(
        self,
        network: str,
        address_identifier_filter: "aws_sdk_managedblockchain_query.types.address_identifier_filter.AddressIdentifierFilter",
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "AsyncIterator[aws_sdk_managedblockchain_query.types.transaction_event.TransactionEvent]":
        _token = next_token
        while True:
            _response = await self.list_filtered_transaction_events(
                network,
    ...
    async def list_token_balances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_managedblockchain_query.types.list_token_balances_input.ListTokenBalancesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_managedblockchain_query.types.list_token_balances_output.ListTokenBalancesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_managedblockchain_query._operations.tieton_chain_query_service.list_token_balances.async_list_token_balances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_token_balances(
        self,
        token_filter: "aws_sdk_managedblockchain_query.types.token_filter.TokenFilter",
        *,
        config_overrides: Optional[AsyncManagedBlockchainQueryClientConfig] = None,
        ...
        max_results: Optional[int] = None,
    ) -> "AsyncIterator[aws_sdk_managedblockchain_query.types.token_balance.TokenBalance]":
        _token = next_token
        while True:
            _response = await self.list_token_balances(
                token_filter,
                config_overrides=config_overrides,
    ...
    async def list_transaction_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_managedblockchain_query.types.list_transaction_events_input.ListTransactionEventsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_managedblockchain_query.types.list_transaction_events_output.ListTransactionEventsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_managedblockchain_query._operations.tieton_chain_query_service.list_transaction_events.async_list_transaction_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_transaction_events(
        self,
        network: "aws_sdk_managedblockchain_query.types.query_network.QueryNetwork",
        *,
        config_overrides: Optional[AsyncManagedBlockchainQueryClientConfig] = None,
        ...
        _token = next_token
        while True:
            _response = await self.list_transaction_events(
                network,
                config_overrides=config_overrides,
    ...
    async def list_transactions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_managedblockchain_query.types.list_transactions_input.ListTransactionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_managedblockchain_query.types.list_transactions_output.ListTransactionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_managedblockchain_query._operations.tieton_chain_query_service.list_transactions.async_list_transactions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_managedblockchain_query.types.transaction_output_item.TransactionOutputItem]":
        _token = next_token
        while True:
