...
def deserialize_json(data: dict) -> BatchGetTokenBalanceInputItem:
    ...
    if "tokenIdentifier" in data:
        ...
        raise DeserializationError("BatchGetTokenBalanceInputItem.token_identifier required")
    if "ownerIdentifier" in data:
        ...
        raise DeserializationError("BatchGetTokenBalanceInputItem.owner_identifier required")
