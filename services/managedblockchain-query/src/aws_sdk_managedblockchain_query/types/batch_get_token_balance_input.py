...
class BatchGetTokenBalanceInput(TypedDict):
    get_token_balance_inputs: NotRequired["aws_sdk_managedblockchain_query.types.get_token_balance_input_list.GetTokenBalanceInputList"]
...
def serialize_json(value: BatchGetTokenBalanceInput) -> dict:
    ...
    if "get_token_balance_inputs" in value:
        import aws_sdk_managedblockchain_query.types.get_token_balance_input_list
        out["getTokenBalanceInputs"] = aws_sdk_managedblockchain_query.types.get_token_balance_input_list.serialize_json(value["get_token_balance_inputs"])
    return out
...
def deserialize_json(data: dict) -> BatchGetTokenBalanceInput:
    ...
    if "getTokenBalanceInputs" in data:
        import aws_sdk_managedblockchain_query.types.get_token_balance_input_list
        out["get_token_balance_inputs"] = aws_sdk_managedblockchain_query.types.get_token_balance_input_list.deserialize_json(data["getTokenBalanceInputs"])
    return out