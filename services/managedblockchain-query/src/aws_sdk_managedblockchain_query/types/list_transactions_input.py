...
def serialize_json(value: ListTransactionsInput) -> dict:
    ...
    if "sort" in value:
        ...
        out["sort"] = (
            aws_sdk_managedblockchain_query.types.list_transactions_sort.serialize_json(
                value["sort"]
            )
        )
...
def deserialize_json(data: dict) -> ListTransactionsInput:
    ...
    if "sort" in data:
        ...
        out["sort"] = (
            aws_sdk_managedblockchain_query.types.list_transactions_sort.deserialize_json(
                data["sort"]
            )
        )
