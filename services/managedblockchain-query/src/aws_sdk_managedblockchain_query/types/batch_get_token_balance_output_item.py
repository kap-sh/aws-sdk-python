...
class BatchGetTokenBalanceOutputItem(TypedDict):
    ...
    at_blockchain_instant: "aws_sdk_managedblockchain_query.types.blockchain_instant.BlockchainInstant"
    last_updated_time: NotRequired["aws_sdk_managedblockchain_query.types.blockchain_instant.BlockchainInstant"]
...
def serialize_json(value: BatchGetTokenBalanceOutputItem) -> dict:
    ...
    if "last_updated_time" in value:
        import aws_sdk_managedblockchain_query.types.blockchain_instant
        out["lastUpdatedTime"] = aws_sdk_managedblockchain_query.types.blockchain_instant.serialize_json(value["last_updated_time"])
    return out
...
def deserialize_json(data: dict) -> BatchGetTokenBalanceOutputItem:
    ...
    if "atBlockchainInstant" in data:
        ...
        raise DeserializationError("BatchGetTokenBalanceOutputItem.at_blockchain_instant required")
    if "lastUpdatedTime" in data:
        import aws_sdk_managedblockchain_query.types.blockchain_instant
        out["last_updated_time"] = aws_sdk_managedblockchain_query.types.blockchain_instant.deserialize_json(data["lastUpdatedTime"])
    return out