...
```
pip install aws-sdk-managedblockchain-query
```

## Usage

```python
from aws_sdk_managedblockchain_query import AsyncManagedBlockchainQueryClient
...
```python
from aws_sdk_managedblockchain_query import AsyncManagedBlockchainQueryClient
from aws_sdk_managedblockchain_query.error import AccessDeniedException
