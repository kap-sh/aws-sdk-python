...
ObjectConfiguration: TypeAlias = dict[
    "capo_appintegrations.types.non_blank_string.NonBlankString",
    "capo_appintegrations.types.fields_map.FieldsMap",
]
...
def serialize_json(input_to_serialize: ObjectConfiguration) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = capo_appintegrations.types.fields_map.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> ObjectConfiguration:
    ...
    for key, value in data.items():
        ...
        out[key] = capo_appintegrations.types.fields_map.deserialize_json(value)
    return out
