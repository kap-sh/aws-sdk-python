"""Generated from Smithy shape ``com.amazonaws.appintegrations#ListApplicationAssociations``."""
...
def handle_response(
    ...
    out: capo_appintegrations.types.list_application_associations_response.ListApplicationAssociationsResponse = capo_appintegrations.types.list_application_associations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{ApplicationId}/associations"
...
async def async_list_application_associations(
