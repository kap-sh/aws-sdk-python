"""Generated from Smithy shape ``com.amazonaws.appintegrations#CreateApplication``."""
...
import capo_appintegrations.errors.duplicate_resource_exception
...
import capo_appintegrations.errors.unsupported_operation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DuplicateResourceException":
            raise capo_appintegrations.errors.duplicate_resource_exception.DuplicateResourceException.from_json(
                data
            )
        ...
        case "UnsupportedOperationException":
            raise capo_appintegrations.errors.unsupported_operation_exception.UnsupportedOperationException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_appintegrations.types.create_application_response.CreateApplicationResponse = capo_appintegrations.types.create_application_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appintegrations.types.create_application_request.serialize_json(input_)
    ).encode()
