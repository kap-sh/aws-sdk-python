"""Generated from Smithy shape ``com.amazonaws.appintegrations#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_appintegrations.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_appintegrations.types.list_tags_for_resource_response.deserialize_json(
