"""Generated from Smithy shape ``com.amazonaws.appintegrations#ListEventIntegrations``."""
...
def handle_response(
    ...
    out: capo_appintegrations.types.list_event_integrations_response.ListEventIntegrationsResponse = capo_appintegrations.types.list_event_integrations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/eventIntegrations"
    params: dict[str, str] = {}
...
async def async_list_event_integrations(
