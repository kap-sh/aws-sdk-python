...
def handle_response(
    ...
    out: capo_appintegrations.types.update_data_integration_response.UpdateDataIntegrationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appintegrations.types.update_data_integration_request.serialize_json(
            input_
        )
    ).encode()
