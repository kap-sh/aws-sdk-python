"""Generated from Smithy shape ``com.amazonaws.appintegrations#UpdateEventIntegration``."""
...
def handle_response(
    ...
    out: capo_appintegrations.types.update_event_integration_response.UpdateEventIntegrationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appintegrations.types.update_event_integration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_event_integration(
