...
import capo_appintegrations.types.data_integrations_list
...
def handle_response(
    ...
    out: capo_appintegrations.types.list_data_integrations_response.ListDataIntegrationsResponse = capo_appintegrations.types.list_data_integrations_response.deserialize_json(
