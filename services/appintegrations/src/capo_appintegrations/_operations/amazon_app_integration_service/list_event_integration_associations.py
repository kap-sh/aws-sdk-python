...
def handle_response(
    ...
    out: capo_appintegrations.types.list_event_integration_associations_response.ListEventIntegrationAssociationsResponse = capo_appintegrations.types.list_event_integration_associations_response.deserialize_json(
