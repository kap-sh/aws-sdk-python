...
def handle_response(
    ...
    out: capo_appintegrations.types.get_event_integration_response.GetEventIntegrationResponse = capo_appintegrations.types.get_event_integration_response.deserialize_json(
