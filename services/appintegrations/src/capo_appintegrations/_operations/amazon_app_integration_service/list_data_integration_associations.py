"""Generated from Smithy shape ``com.amazonaws.appintegrations#ListDataIntegrationAssociations``."""
...
import capo_appintegrations.types.data_integration_associations_list
...
def handle_response(
    ...
    out: capo_appintegrations.types.list_data_integration_associations_response.ListDataIntegrationAssociationsResponse = capo_appintegrations.types.list_data_integration_associations_response.deserialize_json(
...
async def async_list_data_integration_associations(
