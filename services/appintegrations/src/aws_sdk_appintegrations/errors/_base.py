...
class AppIntegrationsError(Exception):
    """Base class for all AppIntegrations service errors."""

class ServiceError(AppIntegrationsError):
...
class SerializationError(AppIntegrationsError):
    """Raised when a value cannot be serialized."""

class DeserializationError(AppIntegrationsError):
...
class WaiterFailedError(AppIntegrationsError):
...
class WaiterTimeoutError(AppIntegrationsError):
