...
def handle_response(
    ...
    out: aws_sdk_appintegrations.types.list_applications_response.ListApplicationsResponse = aws_sdk_appintegrations.types.list_applications_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_appintegrations.types.list_applications_request.ListApplicationsRequest,
) -> zapros.Request:
    ...
    if "application_type" in input:
        params["applicationType"] = str(input["application_type"])
