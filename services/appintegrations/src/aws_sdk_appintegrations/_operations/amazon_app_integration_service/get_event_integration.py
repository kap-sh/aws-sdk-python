...
def handle_response(
    ...
    out: aws_sdk_appintegrations.types.get_event_integration_response.GetEventIntegrationResponse = aws_sdk_appintegrations.types.get_event_integration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appintegrations.types.get_event_integration_request.GetEventIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_event_integration(
