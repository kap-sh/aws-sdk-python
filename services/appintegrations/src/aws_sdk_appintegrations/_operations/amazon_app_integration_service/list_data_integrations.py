...
def handle_response(
    ...
    out: aws_sdk_appintegrations.types.list_data_integrations_response.ListDataIntegrationsResponse = aws_sdk_appintegrations.types.list_data_integrations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appintegrations.types.list_data_integrations_request.ListDataIntegrationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_data_integrations(
