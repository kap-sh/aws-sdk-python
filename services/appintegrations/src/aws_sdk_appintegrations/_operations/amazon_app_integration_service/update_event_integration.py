...
def build_request(
    ...
    input_: aws_sdk_appintegrations.types.update_event_integration_request.UpdateEventIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appintegrations.types.update_event_integration_request.serialize_json(
            input_
        )
    ).encode()
