...
def handle_response(
    ...
    out: aws_sdk_appintegrations.types.create_data_integration_response.CreateDataIntegrationResponse = aws_sdk_appintegrations.types.create_data_integration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appintegrations.types.create_data_integration_request.CreateDataIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appintegrations.types.create_data_integration_request.serialize_json(
            input_
        )
    ).encode()
