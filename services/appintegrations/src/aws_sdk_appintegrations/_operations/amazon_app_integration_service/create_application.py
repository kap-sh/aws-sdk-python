...
def build_request(
    ...
    input: aws_sdk_appintegrations.types.create_application_request.CreateApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appintegrations.types.create_application_request.serialize_json(input)
    ).encode()
