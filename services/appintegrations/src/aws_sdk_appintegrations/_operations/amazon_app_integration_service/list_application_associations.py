...
def handle_response(
    ...
    out: aws_sdk_appintegrations.types.list_application_associations_response.ListApplicationAssociationsResponse = aws_sdk_appintegrations.types.list_application_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appintegrations.types.list_application_associations_request.ListApplicationAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
