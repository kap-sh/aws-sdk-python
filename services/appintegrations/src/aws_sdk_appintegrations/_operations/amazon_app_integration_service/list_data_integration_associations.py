...
def handle_response(
    ...
    out: aws_sdk_appintegrations.types.list_data_integration_associations_response.ListDataIntegrationAssociationsResponse = aws_sdk_appintegrations.types.list_data_integration_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appintegrations.types.list_data_integration_associations_request.ListDataIntegrationAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
