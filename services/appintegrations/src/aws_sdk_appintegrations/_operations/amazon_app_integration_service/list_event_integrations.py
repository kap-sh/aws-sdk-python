...
def handle_response(
    ...
    out: aws_sdk_appintegrations.types.list_event_integrations_response.ListEventIntegrationsResponse = aws_sdk_appintegrations.types.list_event_integrations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appintegrations.types.list_event_integrations_request.ListEventIntegrationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
