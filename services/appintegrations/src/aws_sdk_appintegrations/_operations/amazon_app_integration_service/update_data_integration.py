...
def build_request(
    ...
    input_: aws_sdk_appintegrations.types.update_data_integration_request.UpdateDataIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appintegrations.types.update_data_integration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_data_integration(
