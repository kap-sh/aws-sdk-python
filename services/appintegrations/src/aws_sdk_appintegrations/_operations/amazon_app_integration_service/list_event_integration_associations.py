...
def handle_response(
    ...
    out: aws_sdk_appintegrations.types.list_event_integration_associations_response.ListEventIntegrationAssociationsResponse = aws_sdk_appintegrations.types.list_event_integration_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appintegrations.types.list_event_integration_associations_request.ListEventIntegrationAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{EventIntegrationName}", quote(str(input_["event_integration_name"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_list_event_integration_associations(
