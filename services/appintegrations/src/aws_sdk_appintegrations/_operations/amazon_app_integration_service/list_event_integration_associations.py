...
def build_request(
    ...
    input: aws_sdk_appintegrations.types.list_event_integration_associations_request.ListEventIntegrationAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{EventIntegrationName}", quote(str(input["event_integration_name"]), safe="")
    )
    params: dict[str, str] = {}
