...
def handle_response(
    ...
    out: aws_sdk_appintegrations.types.get_data_integration_response.GetDataIntegrationResponse = aws_sdk_appintegrations.types.get_data_integration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appintegrations.types.get_data_integration_request.GetDataIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
