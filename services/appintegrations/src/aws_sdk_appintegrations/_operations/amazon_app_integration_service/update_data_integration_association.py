...
def build_request(
    ...
    input: aws_sdk_appintegrations.types.update_data_integration_association_request.UpdateDataIntegrationAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input["data_integration_association_identifier"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appintegrations.types.update_data_integration_association_request.serialize_json(
            input
        )
    ).encode()
