...
class ListDataIntegrationsResponse(TypedDict):
    data_integrations: NotRequired["aws_sdk_appintegrations.types.data_integrations_list.DataIntegrationsList"]
...
def serialize_json(value: ListDataIntegrationsResponse) -> dict:
    ...
    if "data_integrations" in value:
        import aws_sdk_appintegrations.types.data_integrations_list
        out["DataIntegrations"] = aws_sdk_appintegrations.types.data_integrations_list.serialize_json(value["data_integrations"])
...
def deserialize_json(data: dict) -> ListDataIntegrationsResponse:
    ...
    if "DataIntegrations" in data:
        import aws_sdk_appintegrations.types.data_integrations_list
        out["data_integrations"] = aws_sdk_appintegrations.types.data_integrations_list.deserialize_json(data["DataIntegrations"])
