...
class ListDataIntegrationAssociationsResponse(TypedDict):
    data_integration_associations: NotRequired["aws_sdk_appintegrations.types.data_integration_associations_list.DataIntegrationAssociationsList"]
...
def serialize_json(value: ListDataIntegrationAssociationsResponse) -> dict:
    ...
    if "data_integration_associations" in value:
        import aws_sdk_appintegrations.types.data_integration_associations_list
        out["DataIntegrationAssociations"] = aws_sdk_appintegrations.types.data_integration_associations_list.serialize_json(value["data_integration_associations"])
...
def deserialize_json(data: dict) -> ListDataIntegrationAssociationsResponse:
    ...
    if "DataIntegrationAssociations" in data:
        import aws_sdk_appintegrations.types.data_integration_associations_list
        out["data_integration_associations"] = aws_sdk_appintegrations.types.data_integration_associations_list.deserialize_json(data["DataIntegrationAssociations"])
