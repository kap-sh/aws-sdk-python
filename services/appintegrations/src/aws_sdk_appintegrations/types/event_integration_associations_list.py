...
EventIntegrationAssociationsList: TypeAlias = list[
    "aws_sdk_appintegrations.types.event_integration_association.EventIntegrationAssociation"
]
...
def serialize_json(value: EventIntegrationAssociationsList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_appintegrations.types.event_integration_association.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> EventIntegrationAssociationsList:
    ...
    for item in data:
        out.append(
            aws_sdk_appintegrations.types.event_integration_association.deserialize_json(
                item
            )
        )
    return out
