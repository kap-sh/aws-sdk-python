...
ApplicationAssociationsList: TypeAlias = list[
    "aws_sdk_appintegrations.types.application_association_summary.ApplicationAssociationSummary"
]
...
def serialize_json(value: ApplicationAssociationsList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_appintegrations.types.application_association_summary.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> ApplicationAssociationsList:
    ...
    for item in data:
        out.append(
            aws_sdk_appintegrations.types.application_association_summary.deserialize_json(
                item
            )
        )
    return out
