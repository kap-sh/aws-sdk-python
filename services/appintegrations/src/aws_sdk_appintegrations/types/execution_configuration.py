...
class ExecutionConfiguration(TypedDict):
    ...
    on_demand_configuration: NotRequired["aws_sdk_appintegrations.types.on_demand_configuration.OnDemandConfiguration"]
...
def serialize_json(value: ExecutionConfiguration) -> dict:
    out: dict = {}
    import aws_sdk_appintegrations.types.execution_mode
    out["ExecutionMode"] = aws_sdk_appintegrations.types.execution_mode.serialize_json(value["execution_mode"])
    if "on_demand_configuration" in value:
        import aws_sdk_appintegrations.types.on_demand_configuration
        out["OnDemandConfiguration"] = aws_sdk_appintegrations.types.on_demand_configuration.serialize_json(value["on_demand_configuration"])
...
def deserialize_json(data: dict) -> ExecutionConfiguration:
    ...
    if "ExecutionMode" in data:
        import aws_sdk_appintegrations.types.execution_mode
        out["execution_mode"] = aws_sdk_appintegrations.types.execution_mode.deserialize_json(data["ExecutionMode"])
    else:
        raise DeserializationError("ExecutionConfiguration.execution_mode required")
    if "OnDemandConfiguration" in data:
        import aws_sdk_appintegrations.types.on_demand_configuration
        out["on_demand_configuration"] = aws_sdk_appintegrations.types.on_demand_configuration.deserialize_json(data["OnDemandConfiguration"])
