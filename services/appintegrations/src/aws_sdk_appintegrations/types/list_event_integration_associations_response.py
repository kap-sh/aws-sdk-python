...
class ListEventIntegrationAssociationsResponse(TypedDict):
    event_integration_associations: NotRequired["aws_sdk_appintegrations.types.event_integration_associations_list.EventIntegrationAssociationsList"]
...
def serialize_json(value: ListEventIntegrationAssociationsResponse) -> dict:
    ...
    if "event_integration_associations" in value:
        import aws_sdk_appintegrations.types.event_integration_associations_list
        out["EventIntegrationAssociations"] = aws_sdk_appintegrations.types.event_integration_associations_list.serialize_json(value["event_integration_associations"])
...
def deserialize_json(data: dict) -> ListEventIntegrationAssociationsResponse:
    ...
    if "EventIntegrationAssociations" in data:
        import aws_sdk_appintegrations.types.event_integration_associations_list
        out["event_integration_associations"] = aws_sdk_appintegrations.types.event_integration_associations_list.deserialize_json(data["EventIntegrationAssociations"])
