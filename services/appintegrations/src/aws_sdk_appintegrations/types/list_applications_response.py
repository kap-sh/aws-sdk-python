...
class ListApplicationsResponse(TypedDict):
    applications: NotRequired["aws_sdk_appintegrations.types.applications_list.ApplicationsList"]
...
def serialize_json(value: ListApplicationsResponse) -> dict:
    ...
    if "applications" in value:
        import aws_sdk_appintegrations.types.applications_list
        out["Applications"] = aws_sdk_appintegrations.types.applications_list.serialize_json(value["applications"])
...
def deserialize_json(data: dict) -> ListApplicationsResponse:
    ...
    if "Applications" in data:
        import aws_sdk_appintegrations.types.applications_list
        out["applications"] = aws_sdk_appintegrations.types.applications_list.deserialize_json(data["Applications"])
