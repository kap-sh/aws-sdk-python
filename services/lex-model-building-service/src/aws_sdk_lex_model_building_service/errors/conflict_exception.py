"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.lexmodelbuildingservice#ConflictException``."""
