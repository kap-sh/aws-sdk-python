...
class LexModelBuildingServiceError(Exception):
    """Base class for all LexModelBuildingService service errors."""


class ServiceError(LexModelBuildingServiceError):
...
class SerializationError(LexModelBuildingServiceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(LexModelBuildingServiceError):
...
class WaiterFailedError(LexModelBuildingServiceError):
...
class WaiterTimeoutError(LexModelBuildingServiceError):
