"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#PreconditionFailedException``."""
...
class PreconditionFailedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.lexmodelbuildingservice#PreconditionFailedException``."""
