...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_intent_versions_response.GetIntentVersionsResponse = aws_sdk_lex_model_building_service.types.get_intent_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_intent_versions_request.GetIntentVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
