"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#DeleteIntentVersion``."""
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.delete_intent_version_request.DeleteIntentVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/intents/{name}/versions/{version}"
...
async def async_delete_intent_version(
