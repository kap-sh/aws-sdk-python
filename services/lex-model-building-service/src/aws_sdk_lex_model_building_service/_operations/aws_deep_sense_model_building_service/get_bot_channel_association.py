...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_bot_channel_association_response.GetBotChannelAssociationResponse = aws_sdk_lex_model_building_service.types.get_bot_channel_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_bot_channel_association_request.GetBotChannelAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
