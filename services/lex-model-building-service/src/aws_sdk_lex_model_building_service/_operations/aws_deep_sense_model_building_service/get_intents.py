...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_intents_response.GetIntentsResponse = aws_sdk_lex_model_building_service.types.get_intents_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_intents_request.GetIntentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
