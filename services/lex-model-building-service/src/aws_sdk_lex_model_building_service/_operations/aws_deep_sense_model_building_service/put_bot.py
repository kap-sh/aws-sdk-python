...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.put_bot_response.PutBotResponse = (
        aws_sdk_lex_model_building_service.types.put_bot_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lex_model_building_service.types.put_bot_request.PutBotRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_model_building_service.types.put_bot_request.serialize_json(input)
    ).encode()
