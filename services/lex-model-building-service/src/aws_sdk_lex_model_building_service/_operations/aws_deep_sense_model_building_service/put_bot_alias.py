...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.put_bot_alias_response.PutBotAliasResponse = aws_sdk_lex_model_building_service.types.put_bot_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.put_bot_alias_request.PutBotAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_model_building_service.types.put_bot_alias_request.serialize_json(
            input_
        )
    ).encode()
