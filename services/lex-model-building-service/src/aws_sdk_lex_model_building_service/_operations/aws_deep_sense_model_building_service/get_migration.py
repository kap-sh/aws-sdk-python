...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_migration_response.GetMigrationResponse = aws_sdk_lex_model_building_service.types.get_migration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_migration_request.GetMigrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{migrationId}", quote(str(input_["migration_id"]), safe=""))
    params: dict[str, str] = {}
