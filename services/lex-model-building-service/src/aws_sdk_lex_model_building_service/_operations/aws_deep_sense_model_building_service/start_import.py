"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#StartImport``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.start_import_response.StartImportResponse = aws_sdk_lex_model_building_service.types.start_import_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.start_import_request.StartImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_model_building_service.types.start_import_request.serialize_json(
            input_
        )
    ).encode()
