...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_bot_response.GetBotResponse = (
        aws_sdk_lex_model_building_service.types.get_bot_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_bot_request.GetBotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
