"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#CreateIntentVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.create_intent_version_response.CreateIntentVersionResponse = aws_sdk_lex_model_building_service.types.create_intent_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.create_intent_version_request.CreateIntentVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/intents/{name}/versions"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_model_building_service.types.create_intent_version_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_intent_version(
