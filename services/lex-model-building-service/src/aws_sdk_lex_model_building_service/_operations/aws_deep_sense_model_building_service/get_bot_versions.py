...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_bot_versions_response.GetBotVersionsResponse = aws_sdk_lex_model_building_service.types.get_bot_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_bot_versions_request.GetBotVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
