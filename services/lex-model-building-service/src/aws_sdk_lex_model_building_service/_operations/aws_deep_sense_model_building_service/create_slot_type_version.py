...
import aws_sdk_lex_model_building_service.errors.precondition_failed_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PreconditionFailedException":
            raise aws_sdk_lex_model_building_service.errors.precondition_failed_exception.PreconditionFailedException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.create_slot_type_version_response.CreateSlotTypeVersionResponse = aws_sdk_lex_model_building_service.types.create_slot_type_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.create_slot_type_version_request.CreateSlotTypeVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_model_building_service.types.create_slot_type_version_request.serialize_json(
            input_
        )
    ).encode()
