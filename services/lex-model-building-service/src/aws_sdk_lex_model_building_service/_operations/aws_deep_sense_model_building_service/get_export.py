...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_export_response.GetExportResponse = aws_sdk_lex_model_building_service.types.get_export_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_export_request.GetExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
