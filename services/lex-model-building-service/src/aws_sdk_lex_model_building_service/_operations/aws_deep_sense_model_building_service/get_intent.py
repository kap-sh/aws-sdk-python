...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_intent_response.GetIntentResponse = aws_sdk_lex_model_building_service.types.get_intent_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_intent_request.GetIntentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
