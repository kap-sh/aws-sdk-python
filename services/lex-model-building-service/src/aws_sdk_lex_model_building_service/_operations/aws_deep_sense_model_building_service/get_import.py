...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_import_response.GetImportResponse = aws_sdk_lex_model_building_service.types.get_import_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_import_request.GetImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
