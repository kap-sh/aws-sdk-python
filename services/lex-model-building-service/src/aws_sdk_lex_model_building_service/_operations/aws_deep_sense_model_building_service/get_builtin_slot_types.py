...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_builtin_slot_types_response.GetBuiltinSlotTypesResponse = aws_sdk_lex_model_building_service.types.get_builtin_slot_types_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_builtin_slot_types_request.GetBuiltinSlotTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
