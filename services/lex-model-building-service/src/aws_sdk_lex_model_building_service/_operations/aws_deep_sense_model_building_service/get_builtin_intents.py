...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_builtin_intents_request.GetBuiltinIntentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "signature_contains" in input_:
        params["signatureContains"] = str(input_["signature_contains"])
