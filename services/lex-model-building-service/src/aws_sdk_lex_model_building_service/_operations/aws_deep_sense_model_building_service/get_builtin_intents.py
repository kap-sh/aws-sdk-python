"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetBuiltinIntents``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_builtin_intents_response.GetBuiltinIntentsResponse = aws_sdk_lex_model_building_service.types.get_builtin_intents_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lex_model_building_service.types.get_builtin_intents_request.GetBuiltinIntentsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/builtins/intents"
    params: dict[str, str] = {}
    if "locale" in input:
        params["locale"] = str(input["locale"])
    if "signature_contains" in input:
        params["signatureContains"] = str(input["signature_contains"])
...
async def async_get_builtin_intents(
