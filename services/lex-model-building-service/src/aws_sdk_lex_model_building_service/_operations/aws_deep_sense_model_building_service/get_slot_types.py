...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_slot_types_response.GetSlotTypesResponse = aws_sdk_lex_model_building_service.types.get_slot_types_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_slot_types_request.GetSlotTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
