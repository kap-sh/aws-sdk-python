...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_bot_alias_response.GetBotAliasResponse = aws_sdk_lex_model_building_service.types.get_bot_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_bot_alias_request.GetBotAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
