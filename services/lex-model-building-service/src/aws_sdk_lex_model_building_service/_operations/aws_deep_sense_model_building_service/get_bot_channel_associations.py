...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_bot_channel_associations_response.GetBotChannelAssociationsResponse = aws_sdk_lex_model_building_service.types.get_bot_channel_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_bot_channel_associations_request.GetBotChannelAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
