...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_slot_type_versions_response.GetSlotTypeVersionsResponse = aws_sdk_lex_model_building_service.types.get_slot_type_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_slot_type_versions_request.GetSlotTypeVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
