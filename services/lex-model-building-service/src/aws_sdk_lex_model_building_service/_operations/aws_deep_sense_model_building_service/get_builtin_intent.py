...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_builtin_intent_response.GetBuiltinIntentResponse = aws_sdk_lex_model_building_service.types.get_builtin_intent_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_builtin_intent_request.GetBuiltinIntentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{signature}", quote(str(input_["signature"]), safe=""))
    params: dict[str, str] = {}
