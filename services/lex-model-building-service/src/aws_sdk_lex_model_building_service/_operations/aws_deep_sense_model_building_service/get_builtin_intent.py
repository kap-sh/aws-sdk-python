...
def build_request(
    ...
    input: aws_sdk_lex_model_building_service.types.get_builtin_intent_request.GetBuiltinIntentRequest,
) -> zapros.Request:
    ...
    url = url.replace("{signature}", quote(str(input["signature"]), safe=""))
    params: dict[str, str] = {}
