"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetBots``."""
...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_bots_response.GetBotsResponse = (
        aws_sdk_lex_model_building_service.types.get_bots_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_bots_request.GetBotsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
