...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_utterances_view_response.GetUtterancesViewResponse = aws_sdk_lex_model_building_service.types.get_utterances_view_response.deserialize_json(
