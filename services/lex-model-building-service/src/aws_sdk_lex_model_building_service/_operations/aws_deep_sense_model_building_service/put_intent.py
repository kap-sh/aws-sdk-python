...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.put_intent_response.PutIntentResponse = aws_sdk_lex_model_building_service.types.put_intent_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.put_intent_request.PutIntentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_model_building_service.types.put_intent_request.serialize_json(
            input_
        )
    ).encode()
