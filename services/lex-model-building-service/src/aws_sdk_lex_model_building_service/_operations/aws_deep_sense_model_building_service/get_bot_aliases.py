...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_bot_aliases_response.GetBotAliasesResponse = aws_sdk_lex_model_building_service.types.get_bot_aliases_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_bot_aliases_request.GetBotAliasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
