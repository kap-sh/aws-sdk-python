...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.get_slot_type_response.GetSlotTypeResponse = aws_sdk_lex_model_building_service.types.get_slot_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.get_slot_type_request.GetSlotTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
