...
def handle_response(
    ...
    out: aws_sdk_lex_model_building_service.types.create_bot_version_response.CreateBotVersionResponse = aws_sdk_lex_model_building_service.types.create_bot_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_model_building_service.types.create_bot_version_request.CreateBotVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_model_building_service.types.create_bot_version_request.serialize_json(
            input_
        )
    ).encode()
