...
if TYPE_CHECKING:
    import aws_sdk_lex_model_building_service.types.context_time_to_live_in_seconds
    import aws_sdk_lex_model_building_service.types.context_turns_to_live
    import aws_sdk_lex_model_building_service.types.output_context_name


class OutputContext(TypedDict):
    name: (
        "aws_sdk_lex_model_building_service.types.output_context_name.OutputContextName"
    )
    """<p>The name of the context.</p>"""
    time_to_live_in_seconds: "aws_sdk_lex_model_building_service.types.context_time_to_live_in_seconds.ContextTimeToLiveInSeconds"
    ...
    turns_to_live: "aws_sdk_lex_model_building_service.types.context_turns_to_live.ContextTurnsToLive"
