...
if TYPE_CHECKING:
    ...
    import aws_sdk_lex_model_building_service.types.channel_configuration_map
    import aws_sdk_lex_model_building_service.types.channel_status
    import aws_sdk_lex_model_building_service.types.channel_type
...
class GetBotChannelAssociationResponse(TypedDict):
    name: NotRequired[
    ...
    type: NotRequired[
        "aws_sdk_lex_model_building_service.types.channel_type.ChannelType"
    ]
    """<p>The type of the messaging platform.</p>"""
    bot_configuration: NotRequired[
        "aws_sdk_lex_model_building_service.types.channel_configuration_map.ChannelConfigurationMap"
    ]
    """<p>Provides information that the messaging platform needs to communicate with the Amazon Lex bot.</p>"""
    status: NotRequired[
        "aws_sdk_lex_model_building_service.types.channel_status.ChannelStatus"
    ]
...
def serialize_json(value: GetBotChannelAssociationResponse) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = (
            aws_sdk_lex_model_building_service.types.channel_type.serialize_json(
                value["type"]
            )
        )
    if "bot_configuration" in value:
        ...
        out["botConfiguration"] = (
            aws_sdk_lex_model_building_service.types.channel_configuration_map.serialize_json(
    ...
    if "status" in value:
        ...
        out["status"] = (
            aws_sdk_lex_model_building_service.types.channel_status.serialize_json(
                value["status"]
            )
        )
...
def deserialize_json(data: dict) -> GetBotChannelAssociationResponse:
    ...
    if "type" in data:
        ...
        out["type"] = (
            aws_sdk_lex_model_building_service.types.channel_type.deserialize_json(
                data["type"]
            )
        )
    if "botConfiguration" in data:
        ...
        out["bot_configuration"] = (
            aws_sdk_lex_model_building_service.types.channel_configuration_map.deserialize_json(
    ...
    if "status" in data:
        ...
        out["status"] = (
            aws_sdk_lex_model_building_service.types.channel_status.deserialize_json(
                data["status"]
            )
        )
