...
if TYPE_CHECKING:
    import aws_sdk_lex_model_building_service.types.kendra_index_arn
    import aws_sdk_lex_model_building_service.types.query_filter_string
    import aws_sdk_lex_model_building_service.types.role_arn


class KendraConfiguration(TypedDict, closed=True):
    kendra_index: (
        "aws_sdk_lex_model_building_service.types.kendra_index_arn.KendraIndexArn"
    )
