...
def serialize_json(value: GetBotAliasesResponse) -> dict:
    ...
    if "bot_aliases" in value:
        ...
        out["BotAliases"] = (
            aws_sdk_lex_model_building_service.types.bot_alias_metadata_list.serialize_json(
                value["bot_aliases"]
            )
        )
...
def deserialize_json(data: dict) -> GetBotAliasesResponse:
    ...
    if "BotAliases" in data:
        ...
        out["bot_aliases"] = (
            aws_sdk_lex_model_building_service.types.bot_alias_metadata_list.deserialize_json(
                data["BotAliases"]
            )
        )
