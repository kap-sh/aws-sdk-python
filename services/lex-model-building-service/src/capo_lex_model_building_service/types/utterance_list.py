...
if TYPE_CHECKING:
    import capo_lex_model_building_service.types.list_of_utterance
...
class UtteranceList(TypedDict, closed=True):
    ...
    utterances: NotRequired[
        "capo_lex_model_building_service.types.list_of_utterance.ListOfUtterance"
    ]
...
def serialize_json(value: UtteranceList) -> dict:
    ...
    if "utterances" in value:
        ...
        out["utterances"] = (
            capo_lex_model_building_service.types.list_of_utterance.serialize_json(
                value["utterances"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> UtteranceList:
    ...
    if "utterances" in data:
        ...
        out["utterances"] = (
            capo_lex_model_building_service.types.list_of_utterance.deserialize_json(
                data["utterances"]
            )
        )
    return out
