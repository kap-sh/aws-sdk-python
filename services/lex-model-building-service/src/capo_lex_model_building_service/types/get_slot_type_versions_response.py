...
class GetSlotTypeVersionsResponse(TypedDict, closed=True):
    slot_types: NotRequired[
        "capo_lex_model_building_service.types.slot_type_metadata_list.SlotTypeMetadataList"
    ]
...
def serialize_json(value: GetSlotTypeVersionsResponse) -> dict:
    ...
    if "slot_types" in value:
        ...
        out["slotTypes"] = (
            capo_lex_model_building_service.types.slot_type_metadata_list.serialize_json(
                value["slot_types"]
            )
        )
...
def deserialize_json(data: dict) -> GetSlotTypeVersionsResponse:
    ...
    if "slotTypes" in data:
        ...
        out["slot_types"] = (
            capo_lex_model_building_service.types.slot_type_metadata_list.deserialize_json(
                data["slotTypes"]
            )
        )
