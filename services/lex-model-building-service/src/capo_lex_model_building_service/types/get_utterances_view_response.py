...
class GetUtterancesViewResponse(TypedDict, closed=True):
    ...
    utterances: NotRequired[
        "capo_lex_model_building_service.types.lists_of_utterances.ListsOfUtterances"
    ]
...
def serialize_json(value: GetUtterancesViewResponse) -> dict:
    ...
    if "utterances" in value:
        ...
        out["utterances"] = (
            capo_lex_model_building_service.types.lists_of_utterances.serialize_json(
                value["utterances"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> GetUtterancesViewResponse:
    ...
    if "utterances" in data:
        ...
        out["utterances"] = (
            capo_lex_model_building_service.types.lists_of_utterances.deserialize_json(
                data["utterances"]
            )
        )
    return out
