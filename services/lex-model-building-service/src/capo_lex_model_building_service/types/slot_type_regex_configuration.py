...
if TYPE_CHECKING:
    import capo_lex_model_building_service.types.regex_pattern


class SlotTypeRegexConfiguration(TypedDict, closed=True):
    pattern: "capo_lex_model_building_service.types.regex_pattern.RegexPattern"
