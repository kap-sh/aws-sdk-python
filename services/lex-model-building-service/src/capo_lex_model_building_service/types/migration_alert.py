...
if TYPE_CHECKING:
    ...
    import capo_lex_model_building_service.types.migration_alert_message
...
class MigrationAlert(TypedDict, closed=True):
    type: NotRequired[
        "capo_lex_model_building_service.types.migration_alert_type.MigrationAlertType"
    ]
    ...
    message: NotRequired[
        "capo_lex_model_building_service.types.migration_alert_message.MigrationAlertMessage"
    ]
    """<p>A message that describes why the alert was issued.</p>"""
    details: NotRequired[
        "capo_lex_model_building_service.types.migration_alert_details.MigrationAlertDetails"
    ]
    """<p>Additional details about the alert.</p>"""
    reference_ur_ls: NotRequired[
        "capo_lex_model_building_service.types.migration_alert_reference_ur_ls.MigrationAlertReferenceURLs"
    ]
...
def serialize_json(value: MigrationAlert) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = (
            capo_lex_model_building_service.types.migration_alert_type.serialize_json(
                value["type"]
            )
        )
    if "message" in value:
    ...
    if "details" in value:
        ...
        out["details"] = (
            capo_lex_model_building_service.types.migration_alert_details.serialize_json(
                value["details"]
            )
        )
    if "reference_ur_ls" in value:
        ...
        out["referenceURLs"] = (
            capo_lex_model_building_service.types.migration_alert_reference_ur_ls.serialize_json(
...
def deserialize_json(data: dict) -> MigrationAlert:
    ...
    if "type" in data:
        ...
        out["type"] = (
            capo_lex_model_building_service.types.migration_alert_type.deserialize_json(
                data["type"]
            )
        )
    if "message" in data:
    ...
    if "details" in data:
        ...
        out["details"] = (
            capo_lex_model_building_service.types.migration_alert_details.deserialize_json(
                data["details"]
            )
        )
    if "referenceURLs" in data:
        ...
        out["reference_ur_ls"] = (
            capo_lex_model_building_service.types.migration_alert_reference_ur_ls.deserialize_json(
                data["referenceURLs"]
            )
        )
    return out
