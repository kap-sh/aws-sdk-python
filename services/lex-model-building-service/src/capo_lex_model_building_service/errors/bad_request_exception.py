"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#BadRequestException``."""
...
class BadRequestException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.lexmodelbuildingservice#BadRequestException``."""
