"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetIntents``."""
...
import capo_lex_model_building_service.types.intent_metadata_list
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_intents_response.GetIntentsResponse = capo_lex_model_building_service.types.get_intents_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/intents"
    params: dict[str, str] = {}
