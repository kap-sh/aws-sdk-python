"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#StartMigration``."""
...
import capo_lex_model_building_service.errors.access_denied_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_lex_model_building_service.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.start_migration_response.StartMigrationResponse = capo_lex_model_building_service.types.start_migration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_model_building_service.types.start_migration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_migration(
