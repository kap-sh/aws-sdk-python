"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetSlotTypeVersions``."""
...
import capo_lex_model_building_service.types.slot_type_metadata_list
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_slot_type_versions_response.GetSlotTypeVersionsResponse = capo_lex_model_building_service.types.get_slot_type_versions_response.deserialize_json(
...
async def async_get_slot_type_versions(
