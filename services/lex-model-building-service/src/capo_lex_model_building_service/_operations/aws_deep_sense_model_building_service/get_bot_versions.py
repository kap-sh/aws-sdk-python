"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetBotVersions``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_bot_versions_response.GetBotVersionsResponse = capo_lex_model_building_service.types.get_bot_versions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/bots/{name}/versions"
...
async def async_get_bot_versions(
