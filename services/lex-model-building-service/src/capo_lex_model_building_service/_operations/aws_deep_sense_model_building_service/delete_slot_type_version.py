"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#DeleteSlotTypeVersion``."""
...
import capo_lex_model_building_service.errors.resource_in_use_exception
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/slottypes/{name}/version/{version}"
...
async def async_delete_slot_type_version(
