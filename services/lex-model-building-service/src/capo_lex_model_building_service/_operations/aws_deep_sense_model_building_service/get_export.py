"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetExport``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_export_response.GetExportResponse = (
        capo_lex_model_building_service.types.get_export_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/exports"
    params: dict[str, str] = {}
    if "name" in input_:
    ...
    if "export_type" in input_:
        params["exportType"] = str(input_["export_type"])
