"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetSlotType``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_slot_type_response.GetSlotTypeResponse = capo_lex_model_building_service.types.get_slot_type_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/slottypes/{name}/versions/{version}"
