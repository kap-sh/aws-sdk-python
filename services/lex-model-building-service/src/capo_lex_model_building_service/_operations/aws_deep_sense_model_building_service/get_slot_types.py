"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetSlotTypes``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_slot_types_response.GetSlotTypesResponse = capo_lex_model_building_service.types.get_slot_types_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/slottypes"
    params: dict[str, str] = {}
...
async def async_get_slot_types(
