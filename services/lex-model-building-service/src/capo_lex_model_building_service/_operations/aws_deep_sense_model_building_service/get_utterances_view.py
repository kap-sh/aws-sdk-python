"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetUtterancesView``."""
...
import capo_lex_model_building_service.types.lists_of_utterances
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_utterances_view_response.GetUtterancesViewResponse = capo_lex_model_building_service.types.get_utterances_view_response.deserialize_json(
