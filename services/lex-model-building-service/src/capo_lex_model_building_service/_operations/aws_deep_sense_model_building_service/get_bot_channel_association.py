"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetBotChannelAssociation``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_bot_channel_association_response.GetBotChannelAssociationResponse = capo_lex_model_building_service.types.get_bot_channel_association_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/bots/{botName}/aliases/{botAlias}/channels/{name}"
    )
...
async def async_get_bot_channel_association(
