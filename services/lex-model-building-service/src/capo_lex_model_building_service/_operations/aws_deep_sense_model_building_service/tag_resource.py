"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#TagResource``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_model_building_service.types.tag_resource_request.serialize_json(
            input_
        )
    ).encode()
