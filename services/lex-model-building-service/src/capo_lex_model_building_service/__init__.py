...
from ._services.async_lex_model_building_service import (
    AsyncLexModelBuildingServiceClient as AsyncLexModelBuildingServiceClient,
)
from ._services.lex_model_building_service import (
    LexModelBuildingServiceClient as LexModelBuildingServiceClient,
)
