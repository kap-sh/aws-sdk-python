...
class KinesisVideoSignalingError(Exception):
    """Base class for all KinesisVideoSignaling service errors."""


class ServiceError(KinesisVideoSignalingError):
...
class SerializationError(KinesisVideoSignalingError):
    """Raised when a value cannot be serialized."""


class DeserializationError(KinesisVideoSignalingError):
...
class WaiterFailedError(KinesisVideoSignalingError):
...
class WaiterTimeoutError(KinesisVideoSignalingError):
