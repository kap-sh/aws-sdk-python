...
from capo_kinesis_video_signaling._services._aws_config import aws_config
...
class KinesisVideoSignalingClientConfig(TypedDict, total=False, closed=True):
...
class KinesisVideoSignalingClient:
    ...
    def get_ice_server_config(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_kinesis_video_signaling.types.get_ice_server_config_request.GetIceServerConfigRequest]",
        ) -> OperationResponse[
            "capo_kinesis_video_signaling.types.get_ice_server_config_response.GetIceServerConfigResponse"
        ]:
            ...
            output, http_response = (
                capo_kinesis_video_signaling._operations.aws_acuity_signaling_service.get_ice_server_config.get_ice_server_config(
    ...
    def send_alexa_offer_to_master(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_kinesis_video_signaling.types.send_alexa_offer_to_master_request.SendAlexaOfferToMasterRequest]",
        ) -> OperationResponse[
            "capo_kinesis_video_signaling.types.send_alexa_offer_to_master_response.SendAlexaOfferToMasterResponse"
        ]:
            ...
            output, http_response = (
                capo_kinesis_video_signaling._operations.aws_acuity_signaling_service.send_alexa_offer_to_master.send_alexa_offer_to_master(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
