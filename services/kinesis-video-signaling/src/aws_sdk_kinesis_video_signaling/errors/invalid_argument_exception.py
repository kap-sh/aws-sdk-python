"""Generated from Smithy shape ``com.amazonaws.kinesisvideosignaling#InvalidArgumentException``."""
...
class InvalidArgumentException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisvideosignaling#InvalidArgumentException``."""
