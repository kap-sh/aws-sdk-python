...
from aws_sdk_cost_and_usage_report_service._services._aws_config import aws_config
...
class CostandUsageReportServiceClientConfig(TypedDict, total=False):
...
class CostandUsageReportServiceClient:
    ...
    def delete_report_definition(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cost_and_usage_report_service.types.delete_report_definition_request.DeleteReportDefinitionRequest]",
        ) -> OperationResponse[
            "aws_sdk_cost_and_usage_report_service.types.delete_report_definition_response.DeleteReportDefinitionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cost_and_usage_report_service._operations.aws_origami_service_gateway_service.delete_report_definition.delete_report_definition(
    ...
    def describe_report_definitions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cost_and_usage_report_service.types.describe_report_definitions_request.DescribeReportDefinitionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_cost_and_usage_report_service.types.describe_report_definitions_response.DescribeReportDefinitionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cost_and_usage_report_service._operations.aws_origami_service_gateway_service.describe_report_definitions.describe_report_definitions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cost_and_usage_report_service.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_cost_and_usage_report_service.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cost_and_usage_report_service._operations.aws_origami_service_gateway_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_report_definition(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cost_and_usage_report_service.types.modify_report_definition_request.ModifyReportDefinitionRequest]",
        ) -> OperationResponse[
            "aws_sdk_cost_and_usage_report_service.types.modify_report_definition_response.ModifyReportDefinitionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cost_and_usage_report_service._operations.aws_origami_service_gateway_service.modify_report_definition.modify_report_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_report_definition(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cost_and_usage_report_service.types.put_report_definition_request.PutReportDefinitionRequest]",
        ) -> OperationResponse[
            "aws_sdk_cost_and_usage_report_service.types.put_report_definition_response.PutReportDefinitionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cost_and_usage_report_service._operations.aws_origami_service_gateway_service.put_report_definition.put_report_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cost_and_usage_report_service.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_cost_and_usage_report_service.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cost_and_usage_report_service._operations.aws_origami_service_gateway_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_cost_and_usage_report_service.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_cost_and_usage_report_service.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_cost_and_usage_report_service._operations.aws_origami_service_gateway_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
