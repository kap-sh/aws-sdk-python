...
class ReportStatus(TypedDict, closed=True):
    ...
    last_status: NotRequired[
        "aws_sdk_cost_and_usage_report_service.types.last_status.LastStatus"
    ]
...
def serialize_aws_json_1_1(value: ReportStatus) -> dict:
    ...
    if "last_status" in value:
        ...
        out["lastStatus"] = (
            aws_sdk_cost_and_usage_report_service.types.last_status.serialize_aws_json_1_1(
                value["last_status"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ReportStatus:
    ...
    if "lastStatus" in data:
        ...
        out["last_status"] = (
            aws_sdk_cost_and_usage_report_service.types.last_status.deserialize_aws_json_1_1(
                data["lastStatus"]
            )
        )
    return out
