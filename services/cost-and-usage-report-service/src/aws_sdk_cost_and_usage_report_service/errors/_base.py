...
class CostandUsageReportServiceError(Exception):
    """Base class for all CostandUsageReportService service errors."""


class ServiceError(CostandUsageReportServiceError):
...
class SerializationError(CostandUsageReportServiceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CostandUsageReportServiceError):
...
class WaiterFailedError(CostandUsageReportServiceError):
...
class WaiterTimeoutError(CostandUsageReportServiceError):
