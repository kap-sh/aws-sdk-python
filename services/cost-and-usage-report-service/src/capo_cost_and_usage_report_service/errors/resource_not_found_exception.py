"""Generated from Smithy shape ``com.amazonaws.costandusagereportservice#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.costandusagereportservice#ResourceNotFoundException``."""
