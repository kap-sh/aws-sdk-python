"""Generated from Smithy shape ``com.amazonaws.costandusagereportservice#InternalErrorException``."""
...
class InternalErrorException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.costandusagereportservice#InternalErrorException``."""
