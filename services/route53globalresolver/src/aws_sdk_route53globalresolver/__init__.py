...
from ._services.async_route53_global_resolver import (
    AsyncRoute53GlobalResolverClient as AsyncRoute53GlobalResolverClient,
)
from ._services.route53_global_resolver import (
    Route53GlobalResolverClient as Route53GlobalResolverClient,
)
