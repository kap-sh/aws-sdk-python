...
if TYPE_CHECKING:
    ...
    import aws_sdk_route53globalresolver.types.create_access_token_input
    import aws_sdk_route53globalresolver.types.create_access_token_output
    import aws_sdk_route53globalresolver.types.delete_access_token_input
    import aws_sdk_route53globalresolver.types.delete_access_token_output
    import aws_sdk_route53globalresolver.types.filters
    import aws_sdk_route53globalresolver.types.get_access_token_input
    import aws_sdk_route53globalresolver.types.get_access_token_output
    import aws_sdk_route53globalresolver.types.iso8601_time_string
    import aws_sdk_route53globalresolver.types.list_access_tokens_input
    import aws_sdk_route53globalresolver.types.list_access_tokens_output
    ...
    import aws_sdk_route53globalresolver.types.update_access_token_output
...
class AccessToken:
    ...
    def create(
        ...
        *,
    ...
    ) -> "aws_sdk_route53globalresolver.types.create_access_token_output.CreateAccessTokenOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53globalresolver.types.create_access_token_input.CreateAccessTokenInput]",
        ) -> OperationResponse[
            "aws_sdk_route53globalresolver.types.create_access_token_output.CreateAccessTokenOutput"
        ]:
            import aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.create_access_token

            output, http_response = (
                aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.create_access_token.create_access_token(
    ...
    def read(
        ...
        *,
        config_overrides: Optional[Route53GlobalResolverClientConfig] = None,
    ) -> "aws_sdk_route53globalresolver.types.get_access_token_output.GetAccessTokenOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53globalresolver.types.get_access_token_input.GetAccessTokenInput]",
        ) -> OperationResponse[
            "aws_sdk_route53globalresolver.types.get_access_token_output.GetAccessTokenOutput"
        ]:
            import aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.get_access_token

            output, http_response = (
                aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.get_access_token.get_access_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
        config_overrides: Optional[Route53GlobalResolverClientConfig] = None,
    ) -> "aws_sdk_route53globalresolver.types.update_access_token_output.UpdateAccessTokenOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53globalresolver.types.update_access_token_input.UpdateAccessTokenInput]",
        ) -> OperationResponse[
            "aws_sdk_route53globalresolver.types.update_access_token_output.UpdateAccessTokenOutput"
        ]:
            import aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.update_access_token

            output, http_response = (
                aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.update_access_token.update_access_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        config_overrides: Optional[Route53GlobalResolverClientConfig] = None,
    ) -> "aws_sdk_route53globalresolver.types.delete_access_token_output.DeleteAccessTokenOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53globalresolver.types.delete_access_token_input.DeleteAccessTokenInput]",
        ) -> OperationResponse[
            "aws_sdk_route53globalresolver.types.delete_access_token_output.DeleteAccessTokenOutput"
        ]:
            import aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.delete_access_token

            output, http_response = (
                aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.delete_access_token.delete_access_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_route53globalresolver.types.list_access_tokens_output.ListAccessTokensOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53globalresolver.types.list_access_tokens_input.ListAccessTokensInput]",
        ) -> OperationResponse[
            "aws_sdk_route53globalresolver.types.list_access_tokens_output.ListAccessTokensOutput"
        ]:
            import aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.list_access_tokens

            output, http_response = (
                aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.list_access_tokens.list_access_tokens(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncAccessToken:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route53globalresolver.types.create_access_token_input.CreateAccessTokenInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route53globalresolver.types.create_access_token_output.CreateAccessTokenOutput"
        ]:
            import aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.create_access_token
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.create_access_token.async_create_access_token(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route53globalresolver.types.get_access_token_input.GetAccessTokenInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route53globalresolver.types.get_access_token_output.GetAccessTokenOutput"
        ]:
            import aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.get_access_token
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.get_access_token.async_get_access_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route53globalresolver.types.update_access_token_input.UpdateAccessTokenInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route53globalresolver.types.update_access_token_output.UpdateAccessTokenOutput"
        ]:
            import aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.update_access_token
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.update_access_token.async_update_access_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route53globalresolver.types.delete_access_token_input.DeleteAccessTokenInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route53globalresolver.types.delete_access_token_output.DeleteAccessTokenOutput"
        ]:
            import aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.delete_access_token
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.delete_access_token.async_delete_access_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_route53globalresolver.types.list_access_tokens_input.ListAccessTokensInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_route53globalresolver.types.list_access_tokens_output.ListAccessTokensOutput"
        ]:
            import aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.list_access_tokens
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_route53globalresolver._operations.ec2_dns_global_resolver_customer_api.list_access_tokens.async_list_access_tokens(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
