...
class ListFirewallRulesOutput(TypedDict):
    ...
    firewall_rules: "aws_sdk_route53globalresolver.types.firewall_rules.FirewallRules"
...
def serialize_json(value: ListFirewallRulesOutput) -> dict:
    ...
    out["firewallRules"] = (
        aws_sdk_route53globalresolver.types.firewall_rules.serialize_json(
...
def deserialize_json(data: dict) -> ListFirewallRulesOutput:
    ...
    if "firewallRules" in data:
        ...
        out["firewall_rules"] = (
            aws_sdk_route53globalresolver.types.firewall_rules.deserialize_json(
                data["firewallRules"]
            )
        )
    else:
