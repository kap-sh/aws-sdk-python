"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#UpdateGlobalResolverOutput``."""
...
class UpdateGlobalResolverOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateGlobalResolverOutput) -> dict:
    out: dict = {}
    out["id"] = value["id"]
    out["arn"] = value["arn"]
