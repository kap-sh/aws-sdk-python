...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.delete_firewall_rule_output.DeleteFirewallRuleOutput = aws_sdk_route53globalresolver.types.delete_firewall_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.delete_firewall_rule_input.DeleteFirewallRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
