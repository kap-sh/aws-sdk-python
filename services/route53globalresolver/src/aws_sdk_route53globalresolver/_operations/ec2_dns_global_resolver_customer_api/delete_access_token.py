...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.delete_access_token_output.DeleteAccessTokenOutput = aws_sdk_route53globalresolver.types.delete_access_token_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.delete_access_token_input.DeleteAccessTokenInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
