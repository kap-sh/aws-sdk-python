"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#ListFirewallRules``."""
...
import aws_sdk_route53globalresolver.types.firewall_rules
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.list_firewall_rules_output.ListFirewallRulesOutput = aws_sdk_route53globalresolver.types.list_firewall_rules_output.deserialize_json(
