...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.get_firewall_rule_output.GetFirewallRuleOutput = aws_sdk_route53globalresolver.types.get_firewall_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.get_firewall_rule_input.GetFirewallRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
