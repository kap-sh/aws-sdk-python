"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#CreateFirewallDomainList``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.create_firewall_domain_list_output.CreateFirewallDomainListOutput = aws_sdk_route53globalresolver.types.create_firewall_domain_list_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.create_firewall_domain_list_input.CreateFirewallDomainListInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/firewall-domain-lists/{globalResolverId}"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53globalresolver.types.create_firewall_domain_list_input.serialize_json(
            input_
        )
    ).encode()
