"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#ListAccessTokens``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.list_access_tokens_output.ListAccessTokensOutput = aws_sdk_route53globalresolver.types.list_access_tokens_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.list_access_tokens_input.ListAccessTokensInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/tokens/dns-view/{dnsViewId}"
    url = url.replace("{dnsViewId}", quote(str(input["dns_view_id"]), safe=""))
    params: dict[str, str] = {}
