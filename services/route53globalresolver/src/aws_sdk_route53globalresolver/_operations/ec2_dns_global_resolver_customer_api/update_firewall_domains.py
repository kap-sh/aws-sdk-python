...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.update_firewall_domains_output.UpdateFirewallDomainsOutput = aws_sdk_route53globalresolver.types.update_firewall_domains_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.update_firewall_domains_input.UpdateFirewallDomainsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53globalresolver.types.update_firewall_domains_input.serialize_json(
            input_
        )
    ).encode()
