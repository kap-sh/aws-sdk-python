...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.batch_create_firewall_rule_output.BatchCreateFirewallRuleOutput = aws_sdk_route53globalresolver.types.batch_create_firewall_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.batch_create_firewall_rule_input.BatchCreateFirewallRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
