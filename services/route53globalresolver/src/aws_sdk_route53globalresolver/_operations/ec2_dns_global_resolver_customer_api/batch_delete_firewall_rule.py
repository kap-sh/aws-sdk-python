"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#BatchDeleteFirewallRule``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.batch_delete_firewall_rule_output.BatchDeleteFirewallRuleOutput = aws_sdk_route53globalresolver.types.batch_delete_firewall_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.batch_delete_firewall_rule_input.BatchDeleteFirewallRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/firewall-rules/batch-delete"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_route53globalresolver.types.batch_delete_firewall_rule_input

    body: bytes | None = json.dumps(
        aws_sdk_route53globalresolver.types.batch_delete_firewall_rule_input.serialize_json(
            input_
        )
    ).encode()
