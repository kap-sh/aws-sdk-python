...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.create_access_source_output.CreateAccessSourceOutput = aws_sdk_route53globalresolver.types.create_access_source_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.create_access_source_input.CreateAccessSourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53globalresolver.types.create_access_source_input.serialize_json(
            input_
        )
    ).encode()
