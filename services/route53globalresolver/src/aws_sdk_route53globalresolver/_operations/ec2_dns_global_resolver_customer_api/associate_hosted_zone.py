...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.associate_hosted_zone_output.AssociateHostedZoneOutput = aws_sdk_route53globalresolver.types.associate_hosted_zone_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.associate_hosted_zone_input.AssociateHostedZoneInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
