"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#GetHostedZoneAssociation``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.get_hosted_zone_association_output.GetHostedZoneAssociationOutput = aws_sdk_route53globalresolver.types.get_hosted_zone_association_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.get_hosted_zone_association_input.GetHostedZoneAssociationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_hosted_zone_association(
