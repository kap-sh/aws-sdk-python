...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53globalresolver.types.tag_resource_request.serialize_json(input)
    ).encode()
