"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#DeleteFirewallDomainList``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.delete_firewall_domain_list_output.DeleteFirewallDomainListOutput = aws_sdk_route53globalresolver.types.delete_firewall_domain_list_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.delete_firewall_domain_list_input.DeleteFirewallDomainListInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/firewall-domain-lists/{firewallDomainListId}"
    url = url.replace(
        "{firewallDomainListId}", quote(str(input_["firewall_domain_list_id"]), safe="")
    )
    params: dict[str, str] = {}
