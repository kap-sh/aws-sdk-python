...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.delete_firewall_domain_list_input.DeleteFirewallDomainListInput,
) -> zapros.Request:
    ...
    url = url.replace(
        "{firewallDomainListId}", quote(str(input["firewall_domain_list_id"]), safe="")
    )
    params: dict[str, str] = {}
