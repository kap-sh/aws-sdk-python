"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#ListFirewallDomainLists``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.list_firewall_domain_lists_output.ListFirewallDomainListsOutput = aws_sdk_route53globalresolver.types.list_firewall_domain_lists_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.list_firewall_domain_lists_input.ListFirewallDomainListsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/firewall-domain-lists"
    params: dict[str, str] = {}
    if "max_results" in input_:
        params["max_results"] = str(input_["max_results"])
    if "next_token" in input_:
        params["next_token"] = str(input_["next_token"])
    if "global_resolver_id" in input_:
        params["global_resolver_id"] = str(input_["global_resolver_id"])
