...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.list_firewall_domain_lists_input.ListFirewallDomainListsInput,
) -> zapros.Request:
    ...
    if "global_resolver_id" in input:
        params["global_resolver_id"] = str(input["global_resolver_id"])
