...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.list_access_sources_output.ListAccessSourcesOutput = aws_sdk_route53globalresolver.types.list_access_sources_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.list_access_sources_input.ListAccessSourcesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
