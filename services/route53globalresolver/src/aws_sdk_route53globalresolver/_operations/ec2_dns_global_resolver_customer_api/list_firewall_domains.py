"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#ListFirewallDomains``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.list_firewall_domains_output.ListFirewallDomainsOutput = aws_sdk_route53globalresolver.types.list_firewall_domains_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.list_firewall_domains_input.ListFirewallDomainsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
