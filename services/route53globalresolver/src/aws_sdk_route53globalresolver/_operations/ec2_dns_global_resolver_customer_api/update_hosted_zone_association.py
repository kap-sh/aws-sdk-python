...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.update_hosted_zone_association_input.UpdateHostedZoneAssociationInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["hosted_zone_association_id"]), safe=""),
    )
    params: dict[str, str] = {}
