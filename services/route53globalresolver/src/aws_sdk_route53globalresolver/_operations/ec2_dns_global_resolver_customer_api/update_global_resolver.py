"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#UpdateGlobalResolver``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.update_global_resolver_output.UpdateGlobalResolverOutput = aws_sdk_route53globalresolver.types.update_global_resolver_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.update_global_resolver_input.UpdateGlobalResolverInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53globalresolver.types.update_global_resolver_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_global_resolver(
