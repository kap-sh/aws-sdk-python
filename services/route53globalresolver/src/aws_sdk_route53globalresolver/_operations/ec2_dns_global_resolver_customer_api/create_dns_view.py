...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.create_dns_view_output.CreateDNSViewOutput = aws_sdk_route53globalresolver.types.create_dns_view_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.create_dns_view_input.CreateDNSViewInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53globalresolver.types.create_dns_view_input.serialize_json(input_)
    ).encode()
