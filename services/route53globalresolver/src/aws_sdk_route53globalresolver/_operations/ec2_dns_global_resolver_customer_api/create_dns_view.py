...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.create_dns_view_input.CreateDNSViewInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53globalresolver.types.create_dns_view_input.serialize_json(input)
    ).encode()
