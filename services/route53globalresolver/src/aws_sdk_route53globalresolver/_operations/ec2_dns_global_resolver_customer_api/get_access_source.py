"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#GetAccessSource``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.get_access_source_output.GetAccessSourceOutput = aws_sdk_route53globalresolver.types.get_access_source_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.get_access_source_input.GetAccessSourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_access_source(
