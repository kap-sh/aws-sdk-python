...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.list_dns_views_output.ListDNSViewsOutput = aws_sdk_route53globalresolver.types.list_dns_views_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.list_dns_views_input.ListDNSViewsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
