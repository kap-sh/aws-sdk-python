...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.create_firewall_rule_output.CreateFirewallRuleOutput = aws_sdk_route53globalresolver.types.create_firewall_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.create_firewall_rule_input.CreateFirewallRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53globalresolver.types.create_firewall_rule_input.serialize_json(
            input_
        )
    ).encode()
