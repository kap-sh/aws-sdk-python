...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.get_access_token_output.GetAccessTokenOutput = aws_sdk_route53globalresolver.types.get_access_token_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.get_access_token_input.GetAccessTokenInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
