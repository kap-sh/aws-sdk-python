"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#DisableDNSView``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.disable_dns_view_output.DisableDNSViewOutput = aws_sdk_route53globalresolver.types.disable_dns_view_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.disable_dns_view_input.DisableDNSViewInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/dns-views/{dnsViewId}/disable"
...
async def async_disable_dns_view(
