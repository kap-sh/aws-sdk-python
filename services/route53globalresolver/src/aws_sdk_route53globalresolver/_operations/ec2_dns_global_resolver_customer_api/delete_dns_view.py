"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#DeleteDNSView``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.delete_dns_view_output.DeleteDNSViewOutput = aws_sdk_route53globalresolver.types.delete_dns_view_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.delete_dns_view_input.DeleteDNSViewInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/dns-views/{dnsViewId}"
...
async def async_delete_dns_view(
