"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#ListHostedZoneAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.list_hosted_zone_associations_output.ListHostedZoneAssociationsOutput = aws_sdk_route53globalresolver.types.list_hosted_zone_associations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.list_hosted_zone_associations_input.ListHostedZoneAssociationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_hosted_zone_associations(
