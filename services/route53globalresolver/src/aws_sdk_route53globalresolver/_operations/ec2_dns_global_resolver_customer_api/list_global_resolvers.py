...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.list_global_resolvers_output.ListGlobalResolversOutput = aws_sdk_route53globalresolver.types.list_global_resolvers_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.list_global_resolvers_input.ListGlobalResolversInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
