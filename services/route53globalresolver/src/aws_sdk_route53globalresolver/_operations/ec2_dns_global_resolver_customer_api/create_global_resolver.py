...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.create_global_resolver_input.CreateGlobalResolverInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53globalresolver.types.create_global_resolver_input.serialize_json(
            input_
        )
    ).encode()
