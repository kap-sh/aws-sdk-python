"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#GetDNSView``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.get_dns_view_output.GetDNSViewOutput = (
        aws_sdk_route53globalresolver.types.get_dns_view_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.get_dns_view_input.GetDNSViewInput,
) -> zapros.Request:
