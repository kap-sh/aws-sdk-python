...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.get_managed_firewall_domain_list_output.GetManagedFirewallDomainListOutput = aws_sdk_route53globalresolver.types.get_managed_firewall_domain_list_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.get_managed_firewall_domain_list_input.GetManagedFirewallDomainListInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["managed_firewall_domain_list_id"]), safe=""),
    )
    params: dict[str, str] = {}
