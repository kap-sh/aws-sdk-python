...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.enable_dns_view_output.EnableDNSViewOutput = aws_sdk_route53globalresolver.types.enable_dns_view_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.enable_dns_view_input.EnableDNSViewInput,
) -> zapros.Request:
