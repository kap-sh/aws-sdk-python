...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.list_managed_firewall_domain_lists_output.ListManagedFirewallDomainListsOutput = aws_sdk_route53globalresolver.types.list_managed_firewall_domain_lists_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.list_managed_firewall_domain_lists_input.ListManagedFirewallDomainListsInput,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["managed_firewall_domain_list_type"]), safe=""),
    )
    params: dict[str, str] = {}
