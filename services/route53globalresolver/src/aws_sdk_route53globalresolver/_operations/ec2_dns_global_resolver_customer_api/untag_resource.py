"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#UntagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53globalresolver.types.untag_resource_request.serialize_json(input)
    ).encode()
