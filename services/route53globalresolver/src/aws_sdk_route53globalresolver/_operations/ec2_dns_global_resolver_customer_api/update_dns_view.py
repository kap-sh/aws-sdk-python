...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.update_dns_view_output.UpdateDNSViewOutput = aws_sdk_route53globalresolver.types.update_dns_view_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_route53globalresolver.types.update_dns_view_input.UpdateDNSViewInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53globalresolver.types.update_dns_view_input.serialize_json(input)
    ).encode()
