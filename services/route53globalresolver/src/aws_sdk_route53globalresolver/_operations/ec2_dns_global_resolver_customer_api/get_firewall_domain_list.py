...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.get_firewall_domain_list_output.GetFirewallDomainListOutput = aws_sdk_route53globalresolver.types.get_firewall_domain_list_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53globalresolver.types.get_firewall_domain_list_input.GetFirewallDomainListInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
