"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#DisassociateHostedZone``."""
...
def handle_response(
    ...
    out: aws_sdk_route53globalresolver.types.disassociate_hosted_zone_output.DisassociateHostedZoneOutput = aws_sdk_route53globalresolver.types.disassociate_hosted_zone_output.deserialize_json(
