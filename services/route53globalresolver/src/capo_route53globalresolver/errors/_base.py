...
class Route53GlobalResolverError(Exception):
    """Base class for all Route53GlobalResolver service errors."""


class ServiceError(Route53GlobalResolverError):
...
class SerializationError(Route53GlobalResolverError):
    """Raised when a value cannot be serialized."""


class DeserializationError(Route53GlobalResolverError):
...
class WaiterFailedError(Route53GlobalResolverError):
...
class WaiterTimeoutError(Route53GlobalResolverError):
