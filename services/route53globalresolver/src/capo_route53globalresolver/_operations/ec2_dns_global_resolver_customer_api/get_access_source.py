...
def handle_response(
    ...
    out: capo_route53globalresolver.types.get_access_source_output.GetAccessSourceOutput = capo_route53globalresolver.types.get_access_source_output.deserialize_json(
