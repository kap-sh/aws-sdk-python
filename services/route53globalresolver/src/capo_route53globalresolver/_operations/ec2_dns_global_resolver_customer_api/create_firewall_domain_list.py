...
def handle_response(
    ...
    out: capo_route53globalresolver.types.create_firewall_domain_list_output.CreateFirewallDomainListOutput = capo_route53globalresolver.types.create_firewall_domain_list_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53globalresolver.types.create_firewall_domain_list_input.serialize_json(
            input_
        )
    ).encode()
