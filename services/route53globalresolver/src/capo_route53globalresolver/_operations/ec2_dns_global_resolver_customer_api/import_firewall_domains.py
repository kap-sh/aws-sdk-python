"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#ImportFirewallDomains``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.import_firewall_domains_output.ImportFirewallDomainsOutput = capo_route53globalresolver.types.import_firewall_domains_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53globalresolver.types.import_firewall_domains_input.serialize_json(
            input_
        )
    ).encode()
