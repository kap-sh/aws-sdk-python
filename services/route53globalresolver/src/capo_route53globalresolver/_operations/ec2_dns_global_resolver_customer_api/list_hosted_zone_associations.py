...
def handle_response(
    ...
    out: capo_route53globalresolver.types.list_hosted_zone_associations_output.ListHostedZoneAssociationsOutput = capo_route53globalresolver.types.list_hosted_zone_associations_output.deserialize_json(
