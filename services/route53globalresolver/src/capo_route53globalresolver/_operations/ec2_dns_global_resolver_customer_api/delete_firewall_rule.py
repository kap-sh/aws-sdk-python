"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#DeleteFirewallRule``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.delete_firewall_rule_output.DeleteFirewallRuleOutput = capo_route53globalresolver.types.delete_firewall_rule_output.deserialize_json(
