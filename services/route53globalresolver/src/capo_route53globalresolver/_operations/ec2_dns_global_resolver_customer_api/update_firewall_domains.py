"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#UpdateFirewallDomains``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.update_firewall_domains_output.UpdateFirewallDomainsOutput = capo_route53globalresolver.types.update_firewall_domains_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53globalresolver.types.update_firewall_domains_input.serialize_json(
            input_
        )
    ).encode()
