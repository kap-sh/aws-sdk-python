...
def handle_response(
    ...
    out: capo_route53globalresolver.types.delete_firewall_domain_list_output.DeleteFirewallDomainListOutput = capo_route53globalresolver.types.delete_firewall_domain_list_output.deserialize_json(
