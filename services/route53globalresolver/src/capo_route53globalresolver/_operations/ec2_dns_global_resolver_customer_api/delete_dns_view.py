...
def handle_response(
    ...
    out: capo_route53globalresolver.types.delete_dns_view_output.DeleteDNSViewOutput = (
        capo_route53globalresolver.types.delete_dns_view_output.deserialize_json(
