...
def handle_response(
    ...
    out: capo_route53globalresolver.types.delete_access_source_output.DeleteAccessSourceOutput = capo_route53globalresolver.types.delete_access_source_output.deserialize_json(
