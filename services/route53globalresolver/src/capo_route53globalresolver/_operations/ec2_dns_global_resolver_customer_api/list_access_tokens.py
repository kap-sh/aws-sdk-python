...
import capo_route53globalresolver.types.access_tokens
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.list_access_tokens_output.ListAccessTokensOutput = capo_route53globalresolver.types.list_access_tokens_output.deserialize_json(
