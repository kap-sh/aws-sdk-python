"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#ListManagedFirewallDomainLists``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.list_managed_firewall_domain_lists_output.ListManagedFirewallDomainListsOutput = capo_route53globalresolver.types.list_managed_firewall_domain_lists_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["managed_firewall_domain_list_type"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_list_managed_firewall_domain_lists(
