"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#GetAccessToken``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.get_access_token_output.GetAccessTokenOutput = capo_route53globalresolver.types.get_access_token_output.deserialize_json(
