"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#ListDNSViews``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.list_dns_views_output.ListDNSViewsOutput = (
        capo_route53globalresolver.types.list_dns_views_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/dns-views/resolver/{globalResolverId}"
    url = url.replace(
...
async def async_list_dns_views(
