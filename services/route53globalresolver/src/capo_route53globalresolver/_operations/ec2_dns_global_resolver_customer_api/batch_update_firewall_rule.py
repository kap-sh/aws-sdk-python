...
def handle_response(
    ...
    out: capo_route53globalresolver.types.batch_update_firewall_rule_output.BatchUpdateFirewallRuleOutput = capo_route53globalresolver.types.batch_update_firewall_rule_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53globalresolver.types.batch_update_firewall_rule_input.serialize_json(
            input_
        )
    ).encode()
