"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#BatchCreateFirewallRule``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.batch_create_firewall_rule_output.BatchCreateFirewallRuleOutput = capo_route53globalresolver.types.batch_create_firewall_rule_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53globalresolver.types.batch_create_firewall_rule_input.serialize_json(
            input_
        )
    ).encode()
