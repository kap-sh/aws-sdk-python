...
def handle_response(
    ...
    out: capo_route53globalresolver.types.list_firewall_rules_output.ListFirewallRulesOutput = capo_route53globalresolver.types.list_firewall_rules_output.deserialize_json(
