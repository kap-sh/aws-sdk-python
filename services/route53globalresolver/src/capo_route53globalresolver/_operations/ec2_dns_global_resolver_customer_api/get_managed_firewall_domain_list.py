"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#GetManagedFirewallDomainList``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.get_managed_firewall_domain_list_output.GetManagedFirewallDomainListOutput = capo_route53globalresolver.types.get_managed_firewall_domain_list_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["managed_firewall_domain_list_id"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_get_managed_firewall_domain_list(
