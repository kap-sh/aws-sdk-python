...
if TYPE_CHECKING:
    import capo_neptunedata.types.edge_labels
    import capo_neptunedata.types.edge_structures
    import capo_neptunedata.types.long_valued_map_list
    import capo_neptunedata.types.node_labels
    import capo_neptunedata.types.node_structures
...
class PropertygraphSummary(TypedDict, closed=True):
    ...
    node_labels: NotRequired["capo_neptunedata.types.node_labels.NodeLabels"]
    """<p>A list of the distinct node labels in the graph.</p>"""
    edge_labels: NotRequired["capo_neptunedata.types.edge_labels.EdgeLabels"]
    ...
    node_structures: NotRequired[
        "capo_neptunedata.types.node_structures.NodeStructures"
    ]
    ...
    edge_structures: NotRequired[
        "capo_neptunedata.types.edge_structures.EdgeStructures"
    ]
...
def serialize_json(value: PropertygraphSummary) -> dict:
    ...
    if "node_labels" in value:
        ...
        out["nodeLabels"] = capo_neptunedata.types.node_labels.serialize_json(
            value["node_labels"]
        )
    if "edge_labels" in value:
        import capo_neptunedata.types.edge_labels

        out["edgeLabels"] = capo_neptunedata.types.edge_labels.serialize_json(
            value["edge_labels"]
        )
    ...
    if "node_properties" in value:
        ...
        out["nodeProperties"] = (
            capo_neptunedata.types.long_valued_map_list.serialize_json(
    ...
    if "node_structures" in value:
        ...
        out["nodeStructures"] = capo_neptunedata.types.node_structures.serialize_json(
            value["node_structures"]
        )
    if "edge_structures" in value:
        import capo_neptunedata.types.edge_structures

        out["edgeStructures"] = capo_neptunedata.types.edge_structures.serialize_json(
...
def deserialize_json(data: dict) -> PropertygraphSummary:
    ...
    if "nodeLabels" in data:
        ...
        out["node_labels"] = capo_neptunedata.types.node_labels.deserialize_json(
            data["nodeLabels"]
        )
    if "edgeLabels" in data:
        import capo_neptunedata.types.edge_labels

        out["edge_labels"] = capo_neptunedata.types.edge_labels.deserialize_json(
            data["edgeLabels"]
        )
    ...
    if "nodeStructures" in data:
        ...
        out["node_structures"] = (
            capo_neptunedata.types.node_structures.deserialize_json(
                data["nodeStructures"]
            )
        )
    if "edgeStructures" in data:
        ...
        out["edge_structures"] = (
            capo_neptunedata.types.edge_structures.deserialize_json(
                data["edgeStructures"]
            )
        )
    return out
