...
import capo_neptunedata.types.gremlin_queries
...
def handle_response(
    ...
    out: capo_neptunedata.types.list_gremlin_queries_output.ListGremlinQueriesOutput = (
        capo_neptunedata.types.list_gremlin_queries_output.deserialize_json(
...
async def async_list_gremlin_queries(
