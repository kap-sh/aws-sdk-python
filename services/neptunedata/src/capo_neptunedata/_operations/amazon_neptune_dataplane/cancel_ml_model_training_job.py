"""Generated from Smithy shape ``com.amazonaws.neptunedata#CancelMLModelTrainingJob``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.cancel_ml_model_training_job_output.CancelMLModelTrainingJobOutput = capo_neptunedata.types.cancel_ml_model_training_job_output.deserialize_json(
...
async def async_cancel_ml_model_training_job(
