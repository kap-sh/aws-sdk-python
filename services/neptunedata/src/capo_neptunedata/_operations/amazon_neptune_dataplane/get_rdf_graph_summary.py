"""Generated from Smithy shape ``com.amazonaws.neptunedata#GetRDFGraphSummary``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.get_rdf_graph_summary_output.GetRDFGraphSummaryOutput = capo_neptunedata.types.get_rdf_graph_summary_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/rdf/statistics/summary"
    params: dict[str, str] = {}
...
async def async_get_rdf_graph_summary(
