"""Generated from Smithy shape ``com.amazonaws.neptunedata#ListMLEndpoints``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.list_ml_endpoints_output.ListMLEndpointsOutput = (
        capo_neptunedata.types.list_ml_endpoints_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ml/endpoints"
    params: dict[str, str] = {}
...
async def async_list_ml_endpoints(
