...
def handle_response(
    ...
    out: capo_neptunedata.types.start_ml_model_training_job_output.StartMLModelTrainingJobOutput = capo_neptunedata.types.start_ml_model_training_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptunedata.types.start_ml_model_training_job_input.serialize_json(input_)
    ).encode()
...
async def async_start_ml_model_training_job(
