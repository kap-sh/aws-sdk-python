...
def handle_response(
    ...
    out: capo_neptunedata.types.cancel_ml_model_transform_job_output.CancelMLModelTransformJobOutput = capo_neptunedata.types.cancel_ml_model_transform_job_output.deserialize_json(
