...
def handle_response(
    ...
    out: capo_neptunedata.types.get_ml_data_processing_job_output.GetMLDataProcessingJobOutput = capo_neptunedata.types.get_ml_data_processing_job_output.deserialize_json(
