"""Generated from Smithy shape ``com.amazonaws.neptunedata#GetLoaderJobStatus``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.get_loader_job_status_output.GetLoaderJobStatusOutput = capo_neptunedata.types.get_loader_job_status_output.deserialize_json(
...
def build_request(
    ...
    if "details" in input_:
        params["details"] = str(input_["details"])
    if "errors" in input_:
        params["errors"] = str(input_["errors"])
    if "page" in input_:
        params["page"] = str(input_["page"])
    if "errors_per_page" in input_:
        params["errorsPerPage"] = str(input_["errors_per_page"])
...
async def async_get_loader_job_status(
