"""Generated from Smithy shape ``com.amazonaws.neptunedata#GetPropertygraphStatistics``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.get_propertygraph_statistics_output.GetPropertygraphStatisticsOutput = capo_neptunedata.types.get_propertygraph_statistics_output.deserialize_json(
...
async def async_get_propertygraph_statistics(
