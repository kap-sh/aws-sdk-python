...
def handle_response(
    ...
    out: capo_neptunedata.types.cancel_ml_data_processing_job_output.CancelMLDataProcessingJobOutput = capo_neptunedata.types.cancel_ml_data_processing_job_output.deserialize_json(
...
async def async_cancel_ml_data_processing_job(
