...
def handle_response(
    ...
    out: capo_neptunedata.types.cancel_gremlin_query_output.CancelGremlinQueryOutput = (
        capo_neptunedata.types.cancel_gremlin_query_output.deserialize_json(
...
async def async_cancel_gremlin_query(
