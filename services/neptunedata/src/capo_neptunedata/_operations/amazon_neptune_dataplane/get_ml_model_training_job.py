...
def handle_response(
    ...
    out: capo_neptunedata.types.get_ml_model_training_job_output.GetMLModelTrainingJobOutput = capo_neptunedata.types.get_ml_model_training_job_output.deserialize_json(
...
async def async_get_ml_model_training_job(
