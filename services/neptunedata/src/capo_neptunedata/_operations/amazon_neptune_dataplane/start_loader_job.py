"""Generated from Smithy shape ``com.amazonaws.neptunedata#StartLoaderJob``."""
...
import capo_neptunedata.errors.s3_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "S3Exception":
            raise capo_neptunedata.errors.s3_exception.S3Exception.from_json(data)
...
def handle_response(
    ...
    out: capo_neptunedata.types.start_loader_job_output.StartLoaderJobOutput = (
        capo_neptunedata.types.start_loader_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptunedata.types.start_loader_job_input.serialize_json(input_)
    ).encode()
...
def start_loader_job(
    ...
    capo_neptunedata.types.start_loader_job_output.StartLoaderJobOutput, zapros.Response
]:
...
async def async_start_loader_job(
