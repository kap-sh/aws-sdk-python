"""Generated from Smithy shape ``com.amazonaws.neptunedata#StartMLModelTransformJob``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.start_ml_model_transform_job_output.StartMLModelTransformJobOutput = capo_neptunedata.types.start_ml_model_transform_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptunedata.types.start_ml_model_transform_job_input.serialize_json(input_)
    ).encode()
...
async def async_start_ml_model_transform_job(
