"""Generated from Smithy shape ``com.amazonaws.neptunedata#GetMLModelTransformJob``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.get_ml_model_transform_job_output.GetMLModelTransformJobOutput = capo_neptunedata.types.get_ml_model_transform_job_output.deserialize_json(
...
async def async_get_ml_model_transform_job(
