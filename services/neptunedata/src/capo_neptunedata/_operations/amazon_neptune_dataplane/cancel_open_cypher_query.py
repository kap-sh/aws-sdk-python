...
def handle_response(
    ...
    out: capo_neptunedata.types.cancel_open_cypher_query_output.CancelOpenCypherQueryOutput = capo_neptunedata.types.cancel_open_cypher_query_output.deserialize_json(
