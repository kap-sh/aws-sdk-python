...
def handle_response(
    ...
    out: capo_neptunedata.types.list_ml_model_transform_jobs_output.ListMLModelTransformJobsOutput = capo_neptunedata.types.list_ml_model_transform_jobs_output.deserialize_json(
...
async def async_list_ml_model_transform_jobs(
