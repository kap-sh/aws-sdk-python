...
def handle_response(
    ...
    out: capo_neptunedata.types.get_ml_endpoint_output.GetMLEndpointOutput = (
        capo_neptunedata.types.get_ml_endpoint_output.deserialize_json(
...
def get_ml_endpoint(
    ...
    capo_neptunedata.types.get_ml_endpoint_output.GetMLEndpointOutput, zapros.Response
]:
...
async def async_get_ml_endpoint(
