...
if TYPE_CHECKING:
    import aws_sdk_neptunedata.types.sparql_data
...
def serialize_json(value: SparqlRecord) -> dict:
    ...
    out["data"] = aws_sdk_neptunedata.types.sparql_data.serialize_json(value["data"])
    out["op"] = value["op"]
...
def deserialize_json(data: dict) -> SparqlRecord:
    ...
    if "data" in data:
        ...
        out["data"] = aws_sdk_neptunedata.types.sparql_data.deserialize_json(
            data["data"]
        )
    else:
