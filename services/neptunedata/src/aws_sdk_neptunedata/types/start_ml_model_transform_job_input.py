...
class StartMLModelTransformJobInput(TypedDict):
    id: NotRequired["str"]
...
def serialize_json(value: StartMLModelTransformJobInput) -> dict:
    ...
    if "custom_model_transform_parameters" in value:
        ...
        out["customModelTransformParameters"] = (
            aws_sdk_neptunedata.types.custom_model_transform_parameters.serialize_json(
...
def deserialize_json(data: dict) -> StartMLModelTransformJobInput:
    ...
    if "customModelTransformParameters" in data:
        ...
        out["custom_model_transform_parameters"] = (
            aws_sdk_neptunedata.types.custom_model_transform_parameters.deserialize_json(
