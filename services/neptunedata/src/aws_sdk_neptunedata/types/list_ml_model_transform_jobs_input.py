"""Generated from Smithy shape ``com.amazonaws.neptunedata#ListMLModelTransformJobsInput``."""
...
class ListMLModelTransformJobsInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListMLModelTransformJobsInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListMLModelTransformJobsInput:
    out: ListMLModelTransformJobsInput = {}  # type: ignore[typeddict-item]
    return out
