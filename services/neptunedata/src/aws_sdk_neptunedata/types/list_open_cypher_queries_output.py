...
class ListOpenCypherQueriesOutput(TypedDict):
    ...
    queries: NotRequired[
        "aws_sdk_neptunedata.types.open_cypher_queries.OpenCypherQueries"
    ]
...
def serialize_json(value: ListOpenCypherQueriesOutput) -> dict:
    ...
    if "queries" in value:
        ...
        out["queries"] = aws_sdk_neptunedata.types.open_cypher_queries.serialize_json(
            value["queries"]
        )
    return out
...
def deserialize_json(data: dict) -> ListOpenCypherQueriesOutput:
    ...
    if "queries" in data:
        ...
        out["queries"] = aws_sdk_neptunedata.types.open_cypher_queries.deserialize_json(
            data["queries"]
        )
    return out
