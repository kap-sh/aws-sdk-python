...
if TYPE_CHECKING:
    ...
    import aws_sdk_neptunedata.types.statistics_summary
...
class Statistics(TypedDict):
    ...
    signature_info: NotRequired[
        "aws_sdk_neptunedata.types.statistics_summary.StatisticsSummary"
    ]
...
def serialize_json(value: Statistics) -> dict:
    ...
    if "date" in value:
        ...
        out["date"] = aws_sdk_neptunedata.types._prelude.timestamp.serialize_json(
            value["date"]
        )
    if "note" in value:
        out["note"] = value["note"]
    if "signature_info" in value:
        ...
        out["signatureInfo"] = (
            aws_sdk_neptunedata.types.statistics_summary.serialize_json(
...
def deserialize_json(data: dict) -> Statistics:
    ...
    if "date" in data:
        ...
        out["date"] = aws_sdk_neptunedata.types._prelude.timestamp.deserialize_json(
            data["date"]
        )
    if "note" in data:
        out["note"] = data["note"]
    if "signatureInfo" in data:
        ...
        out["signature_info"] = (
            aws_sdk_neptunedata.types.statistics_summary.deserialize_json(
                data["signatureInfo"]
            )
        )
    return out
