...
class GetMLModelTrainingJobOutput(TypedDict):
    ...
    ml_models: NotRequired["aws_sdk_neptunedata.types.ml_models.MlModels"]
...
def serialize_json(value: GetMLModelTrainingJobOutput) -> dict:
    ...
    if "hpo_job" in value:
        ...
        out["hpoJob"] = aws_sdk_neptunedata.types.ml_resource_definition.serialize_json(
            value["hpo_job"]
        )
    ...
    if "ml_models" in value:
        ...
        out["mlModels"] = aws_sdk_neptunedata.types.ml_models.serialize_json(
            value["ml_models"]
        )
    return out
...
def deserialize_json(data: dict) -> GetMLModelTrainingJobOutput:
    ...
    if "mlModels" in data:
        ...
        out["ml_models"] = aws_sdk_neptunedata.types.ml_models.deserialize_json(
            data["mlModels"]
        )
    return out
