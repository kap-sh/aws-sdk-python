...
class DeleteSparqlStatisticsOutput(TypedDict):
    ...
    payload: NotRequired["aws_sdk_neptunedata.types.delete_statistics_value_map.DeleteStatisticsValueMap"]
...
def serialize_json(value: DeleteSparqlStatisticsOutput) -> dict:
    ...
    if "payload" in value:
        import aws_sdk_neptunedata.types.delete_statistics_value_map
        out["payload"] = aws_sdk_neptunedata.types.delete_statistics_value_map.serialize_json(value["payload"])
    return out
...
def deserialize_json(data: dict) -> DeleteSparqlStatisticsOutput:
    ...
    if "payload" in data:
        import aws_sdk_neptunedata.types.delete_statistics_value_map
        out["payload"] = aws_sdk_neptunedata.types.delete_statistics_value_map.deserialize_json(data["payload"])
    return out