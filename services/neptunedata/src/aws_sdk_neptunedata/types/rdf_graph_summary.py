...
if TYPE_CHECKING:
    import aws_sdk_neptunedata.types.classes
    import aws_sdk_neptunedata.types.long_valued_map_list
    import aws_sdk_neptunedata.types.subject_structures


class RDFGraphSummary(TypedDict):
    ...
    classes: NotRequired["aws_sdk_neptunedata.types.classes.Classes"]
...
def serialize_json(value: RDFGraphSummary) -> dict:
    ...
    if "classes" in value:
        ...
        out["classes"] = aws_sdk_neptunedata.types.classes.serialize_json(
            value["classes"]
        )
    ...
    if "subject_structures" in value:
        ...
        out["subjectStructures"] = (
            aws_sdk_neptunedata.types.subject_structures.serialize_json(
...
def deserialize_json(data: dict) -> RDFGraphSummary:
    ...
    if "classes" in data:
        ...
        out["classes"] = aws_sdk_neptunedata.types.classes.deserialize_json(
            data["classes"]
        )
    ...
    if "subjectStructures" in data:
        ...
        out["subject_structures"] = (
            aws_sdk_neptunedata.types.subject_structures.deserialize_json(
