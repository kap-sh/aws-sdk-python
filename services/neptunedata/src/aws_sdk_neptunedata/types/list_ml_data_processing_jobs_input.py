...
# --- restJson1 ser/de ---
def serialize_json(value: ListMLDataProcessingJobsInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListMLDataProcessingJobsInput:
    out: ListMLDataProcessingJobsInput = {}  # type: ignore[typeddict-item]
    return out
