...
class GetMLModelTransformJobOutput(TypedDict):
    ...
    models: NotRequired["aws_sdk_neptunedata.types.models.Models"]
...
def serialize_json(value: GetMLModelTransformJobOutput) -> dict:
    ...
    if "models" in value:
        ...
        out["models"] = aws_sdk_neptunedata.types.models.serialize_json(value["models"])
    return out
...
def deserialize_json(data: dict) -> GetMLModelTransformJobOutput:
    ...
    if "models" in data:
        ...
        out["models"] = aws_sdk_neptunedata.types.models.deserialize_json(
            data["models"]
        )
    return out
