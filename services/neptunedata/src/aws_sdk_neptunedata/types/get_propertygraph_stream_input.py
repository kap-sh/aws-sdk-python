"""Generated from Smithy shape ``com.amazonaws.neptunedata#GetPropertygraphStreamInput``."""
...
class GetPropertygraphStreamInput(TypedDict, closed=True):
    ...
    encoding: NotRequired["aws_sdk_neptunedata.types.encoding.Encoding"]
    """<p>If set to TRUE, Neptune compresses the response using gzip encoding.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: GetPropertygraphStreamInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetPropertygraphStreamInput:
    out: GetPropertygraphStreamInput = {}  # type: ignore[typeddict-item]
    return out
