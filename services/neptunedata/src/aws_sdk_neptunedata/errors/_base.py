...
class neptunedataError(Exception):
    """Base class for all neptunedata service errors."""

class ServiceError(neptunedataError):
...
class SerializationError(neptunedataError):
    """Raised when a value cannot be serialized."""

class DeserializationError(neptunedataError):
...
class WaiterFailedError(neptunedataError):
...
class WaiterTimeoutError(neptunedataError):
