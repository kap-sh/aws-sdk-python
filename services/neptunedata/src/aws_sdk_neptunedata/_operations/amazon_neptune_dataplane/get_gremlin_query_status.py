...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.get_gremlin_query_status_output.GetGremlinQueryStatusOutput = aws_sdk_neptunedata.types.get_gremlin_query_status_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.get_gremlin_query_status_input.GetGremlinQueryStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
