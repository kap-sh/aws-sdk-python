...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.get_gremlin_query_status_output.GetGremlinQueryStatusOutput:
    import aws_sdk_neptunedata.types.get_gremlin_query_status_output
    out: aws_sdk_neptunedata.types.get_gremlin_query_status_output.GetGremlinQueryStatusOutput = aws_sdk_neptunedata.types.get_gremlin_query_status_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_gremlin_query_status_input.GetGremlinQueryStatusInput) -> zapros.Request:
...
def get_gremlin_query_status(options: OperationOptions, input: aws_sdk_neptunedata.types.get_gremlin_query_status_input.GetGremlinQueryStatusInput) -> tuple[aws_sdk_neptunedata.types.get_gremlin_query_status_output.GetGremlinQueryStatusOutput, zapros.Response]:
...
async def async_get_gremlin_query_status(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_gremlin_query_status_input.GetGremlinQueryStatusInput) -> tuple[aws_sdk_neptunedata.types.get_gremlin_query_status_output.GetGremlinQueryStatusOutput, zapros.Response]:
