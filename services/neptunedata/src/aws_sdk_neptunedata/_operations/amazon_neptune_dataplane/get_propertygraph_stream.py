...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ExpiredStreamException":
            ...
            raise aws_sdk_neptunedata.errors.expired_stream_exception.ExpiredStreamException.from_json(data)
        ...
        case "StreamRecordsNotFoundException":
            ...
            raise aws_sdk_neptunedata.errors.stream_records_not_found_exception.StreamRecordsNotFoundException.from_json(data)
        case "ThrottlingException":
            import aws_sdk_neptunedata.errors.throttling_exception
            raise aws_sdk_neptunedata.errors.throttling_exception.ThrottlingException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.get_propertygraph_stream_output.GetPropertygraphStreamOutput:
    import aws_sdk_neptunedata.types.get_propertygraph_stream_output
    out: aws_sdk_neptunedata.types.get_propertygraph_stream_output.GetPropertygraphStreamOutput = aws_sdk_neptunedata.types.get_propertygraph_stream_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_propertygraph_stream_input.GetPropertygraphStreamInput) -> zapros.Request:
...
def get_propertygraph_stream(options: OperationOptions, input: aws_sdk_neptunedata.types.get_propertygraph_stream_input.GetPropertygraphStreamInput) -> tuple[aws_sdk_neptunedata.types.get_propertygraph_stream_output.GetPropertygraphStreamOutput, zapros.Response]:
...
async def async_get_propertygraph_stream(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_propertygraph_stream_input.GetPropertygraphStreamInput) -> tuple[aws_sdk_neptunedata.types.get_propertygraph_stream_output.GetPropertygraphStreamOutput, zapros.Response]:
