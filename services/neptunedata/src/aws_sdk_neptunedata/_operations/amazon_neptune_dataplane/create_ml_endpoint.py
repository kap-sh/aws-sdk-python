...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.create_ml_endpoint_output.CreateMLEndpointOutput = (
        aws_sdk_neptunedata.types.create_ml_endpoint_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.create_ml_endpoint_input.CreateMLEndpointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptunedata.types.create_ml_endpoint_input.serialize_json(input_)
    ).encode()
