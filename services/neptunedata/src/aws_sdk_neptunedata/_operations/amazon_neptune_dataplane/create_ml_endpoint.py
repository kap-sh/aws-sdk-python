...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.create_ml_endpoint_output.CreateMLEndpointOutput:
    import aws_sdk_neptunedata.types.create_ml_endpoint_output
    out: aws_sdk_neptunedata.types.create_ml_endpoint_output.CreateMLEndpointOutput = aws_sdk_neptunedata.types.create_ml_endpoint_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.create_ml_endpoint_input.CreateMLEndpointInput) -> zapros.Request:
    ...
    import aws_sdk_neptunedata.types.create_ml_endpoint_input
    body: bytes | None = json.dumps(aws_sdk_neptunedata.types.create_ml_endpoint_input.serialize_json(input)).encode()
...
def create_ml_endpoint(options: OperationOptions, input: aws_sdk_neptunedata.types.create_ml_endpoint_input.CreateMLEndpointInput) -> tuple[aws_sdk_neptunedata.types.create_ml_endpoint_output.CreateMLEndpointOutput, zapros.Response]:
...
async def async_create_ml_endpoint(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.create_ml_endpoint_input.CreateMLEndpointInput) -> tuple[aws_sdk_neptunedata.types.create_ml_endpoint_output.CreateMLEndpointOutput, zapros.Response]:
