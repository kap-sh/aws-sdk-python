"""Generated from Smithy shape ``com.amazonaws.neptunedata#StartMLModelTrainingJob``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.start_ml_model_training_job_output.StartMLModelTrainingJobOutput:
    import aws_sdk_neptunedata.types.start_ml_model_training_job_output
    out: aws_sdk_neptunedata.types.start_ml_model_training_job_output.StartMLModelTrainingJobOutput = aws_sdk_neptunedata.types.start_ml_model_training_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.start_ml_model_training_job_input.StartMLModelTrainingJobInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/ml/modeltraining"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_neptunedata.types.start_ml_model_training_job_input
    body: bytes | None = json.dumps(aws_sdk_neptunedata.types.start_ml_model_training_job_input.serialize_json(input)).encode()
...
def start_ml_model_training_job(options: OperationOptions, input: aws_sdk_neptunedata.types.start_ml_model_training_job_input.StartMLModelTrainingJobInput) -> tuple[aws_sdk_neptunedata.types.start_ml_model_training_job_output.StartMLModelTrainingJobOutput, zapros.Response]:
...
async def async_start_ml_model_training_job(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.start_ml_model_training_job_input.StartMLModelTrainingJobInput) -> tuple[aws_sdk_neptunedata.types.start_ml_model_training_job_output.StartMLModelTrainingJobOutput, zapros.Response]:
