...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.start_ml_model_training_job_output.StartMLModelTrainingJobOutput = aws_sdk_neptunedata.types.start_ml_model_training_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.start_ml_model_training_job_input.StartMLModelTrainingJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptunedata.types.start_ml_model_training_job_input.serialize_json(
            input_
        )
    ).encode()
