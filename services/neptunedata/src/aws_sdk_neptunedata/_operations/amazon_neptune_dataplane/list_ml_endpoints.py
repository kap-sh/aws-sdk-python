...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.list_ml_endpoints_output.ListMLEndpointsOutput:
    import aws_sdk_neptunedata.types.list_ml_endpoints_output
    out: aws_sdk_neptunedata.types.list_ml_endpoints_output.ListMLEndpointsOutput = aws_sdk_neptunedata.types.list_ml_endpoints_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.list_ml_endpoints_input.ListMLEndpointsInput) -> zapros.Request:
...
def list_ml_endpoints(options: OperationOptions, input: aws_sdk_neptunedata.types.list_ml_endpoints_input.ListMLEndpointsInput) -> tuple[aws_sdk_neptunedata.types.list_ml_endpoints_output.ListMLEndpointsOutput, zapros.Response]:
...
async def async_list_ml_endpoints(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.list_ml_endpoints_input.ListMLEndpointsInput) -> tuple[aws_sdk_neptunedata.types.list_ml_endpoints_output.ListMLEndpointsOutput, zapros.Response]:
