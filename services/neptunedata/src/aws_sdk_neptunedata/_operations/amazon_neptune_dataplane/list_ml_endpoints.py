...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.list_ml_endpoints_output.ListMLEndpointsOutput = (
        aws_sdk_neptunedata.types.list_ml_endpoints_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.list_ml_endpoints_input.ListMLEndpointsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
