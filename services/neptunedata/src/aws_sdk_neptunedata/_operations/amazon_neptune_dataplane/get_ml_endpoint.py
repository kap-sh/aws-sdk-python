"""Generated from Smithy shape ``com.amazonaws.neptunedata#GetMLEndpoint``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.get_ml_endpoint_output.GetMLEndpointOutput:
    import aws_sdk_neptunedata.types.get_ml_endpoint_output
    out: aws_sdk_neptunedata.types.get_ml_endpoint_output.GetMLEndpointOutput = aws_sdk_neptunedata.types.get_ml_endpoint_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_ml_endpoint_input.GetMLEndpointInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/ml/endpoints/{id}"
...
def get_ml_endpoint(options: OperationOptions, input: aws_sdk_neptunedata.types.get_ml_endpoint_input.GetMLEndpointInput) -> tuple[aws_sdk_neptunedata.types.get_ml_endpoint_output.GetMLEndpointOutput, zapros.Response]:
...
async def async_get_ml_endpoint(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_ml_endpoint_input.GetMLEndpointInput) -> tuple[aws_sdk_neptunedata.types.get_ml_endpoint_output.GetMLEndpointOutput, zapros.Response]:
