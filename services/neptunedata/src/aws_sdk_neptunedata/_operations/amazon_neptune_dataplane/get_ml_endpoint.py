...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.get_ml_endpoint_output.GetMLEndpointOutput = (
        aws_sdk_neptunedata.types.get_ml_endpoint_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.get_ml_endpoint_input.GetMLEndpointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
