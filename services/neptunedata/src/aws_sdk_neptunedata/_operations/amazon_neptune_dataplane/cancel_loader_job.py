"""Generated from Smithy shape ``com.amazonaws.neptunedata#CancelLoaderJob``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BulkLoadIdNotFoundException":
            import aws_sdk_neptunedata.errors.bulk_load_id_not_found_exception
            raise aws_sdk_neptunedata.errors.bulk_load_id_not_found_exception.BulkLoadIdNotFoundException.from_json(data)
        ...
        case "InternalFailureException":
            import aws_sdk_neptunedata.errors.internal_failure_exception
            raise aws_sdk_neptunedata.errors.internal_failure_exception.InternalFailureException.from_json(data)
        ...
        case "LoadUrlAccessDeniedException":
            import aws_sdk_neptunedata.errors.load_url_access_denied_exception
            raise aws_sdk_neptunedata.errors.load_url_access_denied_exception.LoadUrlAccessDeniedException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.cancel_loader_job_output.CancelLoaderJobOutput:
    import aws_sdk_neptunedata.types.cancel_loader_job_output
    out: aws_sdk_neptunedata.types.cancel_loader_job_output.CancelLoaderJobOutput = aws_sdk_neptunedata.types.cancel_loader_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.cancel_loader_job_input.CancelLoaderJobInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/loader/{loadId}"
    url = url.replace("{loadId}", quote(str(input["load_id"]), safe=""))
    params: dict[str, str] = {}
...
def cancel_loader_job(options: OperationOptions, input: aws_sdk_neptunedata.types.cancel_loader_job_input.CancelLoaderJobInput) -> tuple[aws_sdk_neptunedata.types.cancel_loader_job_output.CancelLoaderJobOutput, zapros.Response]:
...
async def async_cancel_loader_job(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.cancel_loader_job_input.CancelLoaderJobInput) -> tuple[aws_sdk_neptunedata.types.cancel_loader_job_output.CancelLoaderJobOutput, zapros.Response]:
