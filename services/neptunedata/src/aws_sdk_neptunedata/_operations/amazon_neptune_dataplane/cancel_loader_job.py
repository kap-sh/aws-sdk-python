...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BulkLoadIdNotFoundException":
            ...
            raise aws_sdk_neptunedata.errors.bulk_load_id_not_found_exception.BulkLoadIdNotFoundException.from_json(
                data
            )
        ...
        case "InternalFailureException":
            ...
            raise aws_sdk_neptunedata.errors.internal_failure_exception.InternalFailureException.from_json(
                data
            )
        ...
        case "LoadUrlAccessDeniedException":
            ...
            raise aws_sdk_neptunedata.errors.load_url_access_denied_exception.LoadUrlAccessDeniedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.cancel_loader_job_output.CancelLoaderJobOutput = (
        aws_sdk_neptunedata.types.cancel_loader_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.cancel_loader_job_input.CancelLoaderJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{loadId}", quote(str(input_["load_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_cancel_loader_job(
