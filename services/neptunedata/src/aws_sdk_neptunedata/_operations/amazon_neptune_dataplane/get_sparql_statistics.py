...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.get_sparql_statistics_output.GetSparqlStatisticsOutput = aws_sdk_neptunedata.types.get_sparql_statistics_output.deserialize_json(
