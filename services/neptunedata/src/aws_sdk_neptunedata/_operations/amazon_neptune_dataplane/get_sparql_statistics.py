...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.get_sparql_statistics_output.GetSparqlStatisticsOutput:
    import aws_sdk_neptunedata.types.get_sparql_statistics_output
    out: aws_sdk_neptunedata.types.get_sparql_statistics_output.GetSparqlStatisticsOutput = aws_sdk_neptunedata.types.get_sparql_statistics_output.deserialize_json(json.loads(response.read()))
    return out
...
def get_sparql_statistics(options: OperationOptions) -> tuple[aws_sdk_neptunedata.types.get_sparql_statistics_output.GetSparqlStatisticsOutput, zapros.Response]:
...
async def async_get_sparql_statistics(options: AsyncOperationOptions) -> tuple[aws_sdk_neptunedata.types.get_sparql_statistics_output.GetSparqlStatisticsOutput, zapros.Response]:
