...
import aws_sdk_neptunedata.types.open_cypher_queries
...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.list_open_cypher_queries_output.ListOpenCypherQueriesOutput = aws_sdk_neptunedata.types.list_open_cypher_queries_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.list_open_cypher_queries_input.ListOpenCypherQueriesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
