...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.list_open_cypher_queries_output.ListOpenCypherQueriesOutput:
    import aws_sdk_neptunedata.types.list_open_cypher_queries_output
    out: aws_sdk_neptunedata.types.list_open_cypher_queries_output.ListOpenCypherQueriesOutput = aws_sdk_neptunedata.types.list_open_cypher_queries_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.list_open_cypher_queries_input.ListOpenCypherQueriesInput) -> zapros.Request:
...
def list_open_cypher_queries(options: OperationOptions, input: aws_sdk_neptunedata.types.list_open_cypher_queries_input.ListOpenCypherQueriesInput) -> tuple[aws_sdk_neptunedata.types.list_open_cypher_queries_output.ListOpenCypherQueriesOutput, zapros.Response]:
...
async def async_list_open_cypher_queries(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.list_open_cypher_queries_input.ListOpenCypherQueriesInput) -> tuple[aws_sdk_neptunedata.types.list_open_cypher_queries_output.ListOpenCypherQueriesOutput, zapros.Response]:
