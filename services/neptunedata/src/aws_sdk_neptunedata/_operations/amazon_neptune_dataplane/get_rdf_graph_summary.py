...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.get_rdf_graph_summary_output.GetRDFGraphSummaryOutput:
    import aws_sdk_neptunedata.types.get_rdf_graph_summary_output
    out: aws_sdk_neptunedata.types.get_rdf_graph_summary_output.GetRDFGraphSummaryOutput = aws_sdk_neptunedata.types.get_rdf_graph_summary_output.deserialize_json(json.loads(response.read()))
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_rdf_graph_summary_input.GetRDFGraphSummaryInput) -> zapros.Request:
...
def get_rdf_graph_summary(options: OperationOptions, input: aws_sdk_neptunedata.types.get_rdf_graph_summary_input.GetRDFGraphSummaryInput) -> tuple[aws_sdk_neptunedata.types.get_rdf_graph_summary_output.GetRDFGraphSummaryOutput, zapros.Response]:
...
async def async_get_rdf_graph_summary(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_rdf_graph_summary_input.GetRDFGraphSummaryInput) -> tuple[aws_sdk_neptunedata.types.get_rdf_graph_summary_output.GetRDFGraphSummaryOutput, zapros.Response]:
