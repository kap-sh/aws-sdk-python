...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.get_rdf_graph_summary_output.GetRDFGraphSummaryOutput = aws_sdk_neptunedata.types.get_rdf_graph_summary_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.get_rdf_graph_summary_input.GetRDFGraphSummaryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
