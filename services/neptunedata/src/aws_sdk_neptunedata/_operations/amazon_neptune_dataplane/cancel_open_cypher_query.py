"""Generated from Smithy shape ``com.amazonaws.neptunedata#CancelOpenCypherQuery``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.cancel_open_cypher_query_output.CancelOpenCypherQueryOutput:
    import aws_sdk_neptunedata.types.cancel_open_cypher_query_output
    out: aws_sdk_neptunedata.types.cancel_open_cypher_query_output.CancelOpenCypherQueryOutput = aws_sdk_neptunedata.types.cancel_open_cypher_query_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.cancel_open_cypher_query_input.CancelOpenCypherQueryInput) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "silent" in input:
        params["silent"] = str(input["silent"])
...
def cancel_open_cypher_query(options: OperationOptions, input: aws_sdk_neptunedata.types.cancel_open_cypher_query_input.CancelOpenCypherQueryInput) -> tuple[aws_sdk_neptunedata.types.cancel_open_cypher_query_output.CancelOpenCypherQueryOutput, zapros.Response]:
...
async def async_cancel_open_cypher_query(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.cancel_open_cypher_query_input.CancelOpenCypherQueryInput) -> tuple[aws_sdk_neptunedata.types.cancel_open_cypher_query_output.CancelOpenCypherQueryOutput, zapros.Response]:
