...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.cancel_open_cypher_query_output.CancelOpenCypherQueryOutput = aws_sdk_neptunedata.types.cancel_open_cypher_query_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.cancel_open_cypher_query_input.CancelOpenCypherQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "silent" in input_:
        params["silent"] = str(input_["silent"])
...
async def async_cancel_open_cypher_query(
