...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.get_propertygraph_statistics_output.GetPropertygraphStatisticsOutput = aws_sdk_neptunedata.types.get_propertygraph_statistics_output.deserialize_json(
