...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.get_propertygraph_statistics_output.GetPropertygraphStatisticsOutput:
    import aws_sdk_neptunedata.types.get_propertygraph_statistics_output
    out: aws_sdk_neptunedata.types.get_propertygraph_statistics_output.GetPropertygraphStatisticsOutput = aws_sdk_neptunedata.types.get_propertygraph_statistics_output.deserialize_json(json.loads(response.read()))
    return out
...
def get_propertygraph_statistics(options: OperationOptions) -> tuple[aws_sdk_neptunedata.types.get_propertygraph_statistics_output.GetPropertygraphStatisticsOutput, zapros.Response]:
...
async def async_get_propertygraph_statistics(options: AsyncOperationOptions) -> tuple[aws_sdk_neptunedata.types.get_propertygraph_statistics_output.GetPropertygraphStatisticsOutput, zapros.Response]:
