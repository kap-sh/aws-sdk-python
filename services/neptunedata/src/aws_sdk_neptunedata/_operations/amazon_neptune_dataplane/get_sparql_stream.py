...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.get_sparql_stream_output.GetSparqlStreamOutput:
    import aws_sdk_neptunedata.types.get_sparql_stream_output
    out: aws_sdk_neptunedata.types.get_sparql_stream_output.GetSparqlStreamOutput = aws_sdk_neptunedata.types.get_sparql_stream_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_sparql_stream_input.GetSparqlStreamInput) -> zapros.Request:
...
def get_sparql_stream(options: OperationOptions, input: aws_sdk_neptunedata.types.get_sparql_stream_input.GetSparqlStreamInput) -> tuple[aws_sdk_neptunedata.types.get_sparql_stream_output.GetSparqlStreamOutput, zapros.Response]:
...
async def async_get_sparql_stream(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_sparql_stream_input.GetSparqlStreamInput) -> tuple[aws_sdk_neptunedata.types.get_sparql_stream_output.GetSparqlStreamOutput, zapros.Response]:
