...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.get_open_cypher_query_status_output.GetOpenCypherQueryStatusOutput = aws_sdk_neptunedata.types.get_open_cypher_query_status_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.get_open_cypher_query_status_input.GetOpenCypherQueryStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_open_cypher_query_status(
