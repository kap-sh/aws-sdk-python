"""Generated from Smithy shape ``com.amazonaws.neptunedata#GetOpenCypherQueryStatus``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.get_open_cypher_query_status_output.GetOpenCypherQueryStatusOutput:
    import aws_sdk_neptunedata.types.get_open_cypher_query_status_output
    out: aws_sdk_neptunedata.types.get_open_cypher_query_status_output.GetOpenCypherQueryStatusOutput = aws_sdk_neptunedata.types.get_open_cypher_query_status_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_open_cypher_query_status_input.GetOpenCypherQueryStatusInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/opencypher/status/{queryId}"
...
def get_open_cypher_query_status(options: OperationOptions, input: aws_sdk_neptunedata.types.get_open_cypher_query_status_input.GetOpenCypherQueryStatusInput) -> tuple[aws_sdk_neptunedata.types.get_open_cypher_query_status_output.GetOpenCypherQueryStatusOutput, zapros.Response]:
...
async def async_get_open_cypher_query_status(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_open_cypher_query_status_input.GetOpenCypherQueryStatusInput) -> tuple[aws_sdk_neptunedata.types.get_open_cypher_query_status_output.GetOpenCypherQueryStatusOutput, zapros.Response]:
