...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.list_ml_model_training_jobs_output.ListMLModelTrainingJobsOutput:
    import aws_sdk_neptunedata.types.list_ml_model_training_jobs_output
    out: aws_sdk_neptunedata.types.list_ml_model_training_jobs_output.ListMLModelTrainingJobsOutput = aws_sdk_neptunedata.types.list_ml_model_training_jobs_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.list_ml_model_training_jobs_input.ListMLModelTrainingJobsInput) -> zapros.Request:
...
def list_ml_model_training_jobs(options: OperationOptions, input: aws_sdk_neptunedata.types.list_ml_model_training_jobs_input.ListMLModelTrainingJobsInput) -> tuple[aws_sdk_neptunedata.types.list_ml_model_training_jobs_output.ListMLModelTrainingJobsOutput, zapros.Response]:
...
async def async_list_ml_model_training_jobs(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.list_ml_model_training_jobs_input.ListMLModelTrainingJobsInput) -> tuple[aws_sdk_neptunedata.types.list_ml_model_training_jobs_output.ListMLModelTrainingJobsOutput, zapros.Response]:
