...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.list_ml_model_training_jobs_output.ListMLModelTrainingJobsOutput = aws_sdk_neptunedata.types.list_ml_model_training_jobs_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.list_ml_model_training_jobs_input.ListMLModelTrainingJobsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
