...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.manage_propertygraph_statistics_output.ManagePropertygraphStatisticsOutput = aws_sdk_neptunedata.types.manage_propertygraph_statistics_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.manage_propertygraph_statistics_input.ManagePropertygraphStatisticsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptunedata.types.manage_propertygraph_statistics_input.serialize_json(
            input_
        )
    ).encode()
