...
def build_request(
    ...
    input: aws_sdk_neptunedata.types.execute_gremlin_query_input.ExecuteGremlinQueryInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptunedata.types.execute_gremlin_query_input.serialize_json(input)
    ).encode()
