...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.execute_gremlin_query_output.ExecuteGremlinQueryOutput:
    import aws_sdk_neptunedata.types.execute_gremlin_query_output
    out: aws_sdk_neptunedata.types.execute_gremlin_query_output.ExecuteGremlinQueryOutput = aws_sdk_neptunedata.types.execute_gremlin_query_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.execute_gremlin_query_input.ExecuteGremlinQueryInput) -> zapros.Request:
    ...
    if "serializer" in input:
        headers["accept"] = str(input["serializer"])
    import aws_sdk_neptunedata.types.execute_gremlin_query_input
    body: bytes | None = json.dumps(aws_sdk_neptunedata.types.execute_gremlin_query_input.serialize_json(input)).encode()
...
def execute_gremlin_query(options: OperationOptions, input: aws_sdk_neptunedata.types.execute_gremlin_query_input.ExecuteGremlinQueryInput) -> tuple[aws_sdk_neptunedata.types.execute_gremlin_query_output.ExecuteGremlinQueryOutput, zapros.Response]:
...
async def async_execute_gremlin_query(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.execute_gremlin_query_input.ExecuteGremlinQueryInput) -> tuple[aws_sdk_neptunedata.types.execute_gremlin_query_output.ExecuteGremlinQueryOutput, zapros.Response]:
