...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.delete_propertygraph_statistics_output.DeletePropertygraphStatisticsOutput:
    import aws_sdk_neptunedata.types.delete_propertygraph_statistics_output
    out: aws_sdk_neptunedata.types.delete_propertygraph_statistics_output.DeletePropertygraphStatisticsOutput = aws_sdk_neptunedata.types.delete_propertygraph_statistics_output.deserialize_json(json.loads(response.read()))
...
def delete_propertygraph_statistics(options: OperationOptions) -> tuple[aws_sdk_neptunedata.types.delete_propertygraph_statistics_output.DeletePropertygraphStatisticsOutput, zapros.Response]:
...
async def async_delete_propertygraph_statistics(options: AsyncOperationOptions) -> tuple[aws_sdk_neptunedata.types.delete_propertygraph_statistics_output.DeletePropertygraphStatisticsOutput, zapros.Response]:
