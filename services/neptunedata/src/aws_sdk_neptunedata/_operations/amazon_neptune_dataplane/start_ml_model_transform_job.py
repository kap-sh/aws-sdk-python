...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.start_ml_model_transform_job_output.StartMLModelTransformJobOutput = aws_sdk_neptunedata.types.start_ml_model_transform_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.start_ml_model_transform_job_input.StartMLModelTransformJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptunedata.types.start_ml_model_transform_job_input.serialize_json(
            input_
        )
    ).encode()
