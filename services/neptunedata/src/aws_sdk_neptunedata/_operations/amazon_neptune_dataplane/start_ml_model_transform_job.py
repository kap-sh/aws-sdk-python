...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.start_ml_model_transform_job_output.StartMLModelTransformJobOutput:
    import aws_sdk_neptunedata.types.start_ml_model_transform_job_output
    out: aws_sdk_neptunedata.types.start_ml_model_transform_job_output.StartMLModelTransformJobOutput = aws_sdk_neptunedata.types.start_ml_model_transform_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.start_ml_model_transform_job_input.StartMLModelTransformJobInput) -> zapros.Request:
    ...
    import aws_sdk_neptunedata.types.start_ml_model_transform_job_input
    body: bytes | None = json.dumps(aws_sdk_neptunedata.types.start_ml_model_transform_job_input.serialize_json(input)).encode()
...
def start_ml_model_transform_job(options: OperationOptions, input: aws_sdk_neptunedata.types.start_ml_model_transform_job_input.StartMLModelTransformJobInput) -> tuple[aws_sdk_neptunedata.types.start_ml_model_transform_job_output.StartMLModelTransformJobOutput, zapros.Response]:
...
async def async_start_ml_model_transform_job(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.start_ml_model_transform_job_input.StartMLModelTransformJobInput) -> tuple[aws_sdk_neptunedata.types.start_ml_model_transform_job_output.StartMLModelTransformJobOutput, zapros.Response]:
