...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.delete_ml_endpoint_output.DeleteMLEndpointOutput = (
        aws_sdk_neptunedata.types.delete_ml_endpoint_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.delete_ml_endpoint_input.DeleteMLEndpointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
