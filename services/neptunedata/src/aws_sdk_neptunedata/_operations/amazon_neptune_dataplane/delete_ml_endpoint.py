...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.delete_ml_endpoint_output.DeleteMLEndpointOutput:
    import aws_sdk_neptunedata.types.delete_ml_endpoint_output
    out: aws_sdk_neptunedata.types.delete_ml_endpoint_output.DeleteMLEndpointOutput = aws_sdk_neptunedata.types.delete_ml_endpoint_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.delete_ml_endpoint_input.DeleteMLEndpointInput) -> zapros.Request:
...
def delete_ml_endpoint(options: OperationOptions, input: aws_sdk_neptunedata.types.delete_ml_endpoint_input.DeleteMLEndpointInput) -> tuple[aws_sdk_neptunedata.types.delete_ml_endpoint_output.DeleteMLEndpointOutput, zapros.Response]:
...
async def async_delete_ml_endpoint(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.delete_ml_endpoint_input.DeleteMLEndpointInput) -> tuple[aws_sdk_neptunedata.types.delete_ml_endpoint_output.DeleteMLEndpointOutput, zapros.Response]:
