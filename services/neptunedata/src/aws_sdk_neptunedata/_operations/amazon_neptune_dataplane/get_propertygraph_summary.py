"""Generated from Smithy shape ``com.amazonaws.neptunedata#GetPropertygraphSummary``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "StatisticsNotAvailableException":
            ...
            raise aws_sdk_neptunedata.errors.statistics_not_available_exception.StatisticsNotAvailableException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.get_propertygraph_summary_output.GetPropertygraphSummaryOutput:
    import aws_sdk_neptunedata.types.get_propertygraph_summary_output
    out: aws_sdk_neptunedata.types.get_propertygraph_summary_output.GetPropertygraphSummaryOutput = aws_sdk_neptunedata.types.get_propertygraph_summary_output.deserialize_json(json.loads(response.read()))
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_propertygraph_summary_input.GetPropertygraphSummaryInput) -> zapros.Request:
...
def get_propertygraph_summary(options: OperationOptions, input: aws_sdk_neptunedata.types.get_propertygraph_summary_input.GetPropertygraphSummaryInput) -> tuple[aws_sdk_neptunedata.types.get_propertygraph_summary_output.GetPropertygraphSummaryOutput, zapros.Response]:
...
async def async_get_propertygraph_summary(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_propertygraph_summary_input.GetPropertygraphSummaryInput) -> tuple[aws_sdk_neptunedata.types.get_propertygraph_summary_output.GetPropertygraphSummaryOutput, zapros.Response]:
