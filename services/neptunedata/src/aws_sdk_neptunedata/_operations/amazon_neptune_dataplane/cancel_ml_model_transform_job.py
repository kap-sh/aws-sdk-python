...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.cancel_ml_model_transform_job_output.CancelMLModelTransformJobOutput:
    import aws_sdk_neptunedata.types.cancel_ml_model_transform_job_output
    out: aws_sdk_neptunedata.types.cancel_ml_model_transform_job_output.CancelMLModelTransformJobOutput = aws_sdk_neptunedata.types.cancel_ml_model_transform_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.cancel_ml_model_transform_job_input.CancelMLModelTransformJobInput) -> zapros.Request:
...
def cancel_ml_model_transform_job(options: OperationOptions, input: aws_sdk_neptunedata.types.cancel_ml_model_transform_job_input.CancelMLModelTransformJobInput) -> tuple[aws_sdk_neptunedata.types.cancel_ml_model_transform_job_output.CancelMLModelTransformJobOutput, zapros.Response]:
...
async def async_cancel_ml_model_transform_job(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.cancel_ml_model_transform_job_input.CancelMLModelTransformJobInput) -> tuple[aws_sdk_neptunedata.types.cancel_ml_model_transform_job_output.CancelMLModelTransformJobOutput, zapros.Response]:
