...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.manage_sparql_statistics_output.ManageSparqlStatisticsOutput = aws_sdk_neptunedata.types.manage_sparql_statistics_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_neptunedata.types.manage_sparql_statistics_input.ManageSparqlStatisticsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptunedata.types.manage_sparql_statistics_input.serialize_json(input)
    ).encode()
