...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.manage_sparql_statistics_output.ManageSparqlStatisticsOutput:
    import aws_sdk_neptunedata.types.manage_sparql_statistics_output
    out: aws_sdk_neptunedata.types.manage_sparql_statistics_output.ManageSparqlStatisticsOutput = aws_sdk_neptunedata.types.manage_sparql_statistics_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.manage_sparql_statistics_input.ManageSparqlStatisticsInput) -> zapros.Request:
    ...
    import aws_sdk_neptunedata.types.manage_sparql_statistics_input
    body: bytes | None = json.dumps(aws_sdk_neptunedata.types.manage_sparql_statistics_input.serialize_json(input)).encode()
...
def manage_sparql_statistics(options: OperationOptions, input: aws_sdk_neptunedata.types.manage_sparql_statistics_input.ManageSparqlStatisticsInput) -> tuple[aws_sdk_neptunedata.types.manage_sparql_statistics_output.ManageSparqlStatisticsOutput, zapros.Response]:
...
async def async_manage_sparql_statistics(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.manage_sparql_statistics_input.ManageSparqlStatisticsInput) -> tuple[aws_sdk_neptunedata.types.manage_sparql_statistics_output.ManageSparqlStatisticsOutput, zapros.Response]:
