...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.list_ml_model_transform_jobs_output.ListMLModelTransformJobsOutput = aws_sdk_neptunedata.types.list_ml_model_transform_jobs_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.list_ml_model_transform_jobs_input.ListMLModelTransformJobsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
