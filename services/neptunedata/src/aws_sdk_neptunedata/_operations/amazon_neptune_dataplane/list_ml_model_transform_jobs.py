"""Generated from Smithy shape ``com.amazonaws.neptunedata#ListMLModelTransformJobs``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.list_ml_model_transform_jobs_output.ListMLModelTransformJobsOutput:
    import aws_sdk_neptunedata.types.list_ml_model_transform_jobs_output
    out: aws_sdk_neptunedata.types.list_ml_model_transform_jobs_output.ListMLModelTransformJobsOutput = aws_sdk_neptunedata.types.list_ml_model_transform_jobs_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.list_ml_model_transform_jobs_input.ListMLModelTransformJobsInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/ml/modeltransform"
    params: dict[str, str] = {}
...
def list_ml_model_transform_jobs(options: OperationOptions, input: aws_sdk_neptunedata.types.list_ml_model_transform_jobs_input.ListMLModelTransformJobsInput) -> tuple[aws_sdk_neptunedata.types.list_ml_model_transform_jobs_output.ListMLModelTransformJobsOutput, zapros.Response]:
...
async def async_list_ml_model_transform_jobs(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.list_ml_model_transform_jobs_input.ListMLModelTransformJobsInput) -> tuple[aws_sdk_neptunedata.types.list_ml_model_transform_jobs_output.ListMLModelTransformJobsOutput, zapros.Response]:
