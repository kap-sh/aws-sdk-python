...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.get_loader_job_status_output.GetLoaderJobStatusOutput:
    import aws_sdk_neptunedata.types.get_loader_job_status_output
    out: aws_sdk_neptunedata.types.get_loader_job_status_output.GetLoaderJobStatusOutput = aws_sdk_neptunedata.types.get_loader_job_status_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_loader_job_status_input.GetLoaderJobStatusInput) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "details" in input:
        params["details"] = str(input["details"])
    if "errors" in input:
        params["errors"] = str(input["errors"])
    if "page" in input:
        params["page"] = str(input["page"])
    if "errors_per_page" in input:
        params["errorsPerPage"] = str(input["errors_per_page"])
...
def get_loader_job_status(options: OperationOptions, input: aws_sdk_neptunedata.types.get_loader_job_status_input.GetLoaderJobStatusInput) -> tuple[aws_sdk_neptunedata.types.get_loader_job_status_output.GetLoaderJobStatusOutput, zapros.Response]:
...
async def async_get_loader_job_status(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_loader_job_status_input.GetLoaderJobStatusInput) -> tuple[aws_sdk_neptunedata.types.get_loader_job_status_output.GetLoaderJobStatusOutput, zapros.Response]:
