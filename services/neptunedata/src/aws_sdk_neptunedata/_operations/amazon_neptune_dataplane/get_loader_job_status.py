...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.get_loader_job_status_output.GetLoaderJobStatusOutput = aws_sdk_neptunedata.types.get_loader_job_status_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_neptunedata.types.get_loader_job_status_input.GetLoaderJobStatusInput,
) -> zapros.Request:
