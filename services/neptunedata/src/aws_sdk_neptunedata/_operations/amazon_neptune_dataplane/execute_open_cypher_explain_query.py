...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.execute_open_cypher_explain_query_output.ExecuteOpenCypherExplainQueryOutput = {
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.execute_open_cypher_explain_query_input.ExecuteOpenCypherExplainQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptunedata.types.execute_open_cypher_explain_query_input.serialize_json(
            input_
        )
    ).encode()
