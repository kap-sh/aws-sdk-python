...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.execute_open_cypher_explain_query_output.ExecuteOpenCypherExplainQueryOutput:
    out: aws_sdk_neptunedata.types.execute_open_cypher_explain_query_output.ExecuteOpenCypherExplainQueryOutput = {"results": response.read()}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.execute_open_cypher_explain_query_input.ExecuteOpenCypherExplainQueryInput) -> zapros.Request:
    ...
    import aws_sdk_neptunedata.types.execute_open_cypher_explain_query_input
    body: bytes | None = json.dumps(aws_sdk_neptunedata.types.execute_open_cypher_explain_query_input.serialize_json(input)).encode()
...
def execute_open_cypher_explain_query(options: OperationOptions, input: aws_sdk_neptunedata.types.execute_open_cypher_explain_query_input.ExecuteOpenCypherExplainQueryInput) -> tuple[aws_sdk_neptunedata.types.execute_open_cypher_explain_query_output.ExecuteOpenCypherExplainQueryOutput, zapros.Response]:
...
async def async_execute_open_cypher_explain_query(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.execute_open_cypher_explain_query_input.ExecuteOpenCypherExplainQueryInput) -> tuple[aws_sdk_neptunedata.types.execute_open_cypher_explain_query_output.ExecuteOpenCypherExplainQueryOutput, zapros.Response]:
