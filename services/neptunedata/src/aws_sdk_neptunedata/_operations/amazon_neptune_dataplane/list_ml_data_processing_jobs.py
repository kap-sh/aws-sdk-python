...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.list_ml_data_processing_jobs_output.ListMLDataProcessingJobsOutput:
    import aws_sdk_neptunedata.types.list_ml_data_processing_jobs_output
    out: aws_sdk_neptunedata.types.list_ml_data_processing_jobs_output.ListMLDataProcessingJobsOutput = aws_sdk_neptunedata.types.list_ml_data_processing_jobs_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.list_ml_data_processing_jobs_input.ListMLDataProcessingJobsInput) -> zapros.Request:
...
def list_ml_data_processing_jobs(options: OperationOptions, input: aws_sdk_neptunedata.types.list_ml_data_processing_jobs_input.ListMLDataProcessingJobsInput) -> tuple[aws_sdk_neptunedata.types.list_ml_data_processing_jobs_output.ListMLDataProcessingJobsOutput, zapros.Response]:
...
async def async_list_ml_data_processing_jobs(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.list_ml_data_processing_jobs_input.ListMLDataProcessingJobsInput) -> tuple[aws_sdk_neptunedata.types.list_ml_data_processing_jobs_output.ListMLDataProcessingJobsOutput, zapros.Response]:
