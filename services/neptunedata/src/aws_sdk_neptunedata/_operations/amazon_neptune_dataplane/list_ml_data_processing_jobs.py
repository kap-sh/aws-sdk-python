...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.list_ml_data_processing_jobs_output.ListMLDataProcessingJobsOutput = aws_sdk_neptunedata.types.list_ml_data_processing_jobs_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.list_ml_data_processing_jobs_input.ListMLDataProcessingJobsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
