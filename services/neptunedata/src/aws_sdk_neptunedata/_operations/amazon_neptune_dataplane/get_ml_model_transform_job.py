...
import aws_sdk_neptunedata.types.models
...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.get_ml_model_transform_job_output.GetMLModelTransformJobOutput = aws_sdk_neptunedata.types.get_ml_model_transform_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.get_ml_model_transform_job_input.GetMLModelTransformJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
