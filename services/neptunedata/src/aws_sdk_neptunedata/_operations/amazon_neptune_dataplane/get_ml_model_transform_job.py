...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.get_ml_model_transform_job_output.GetMLModelTransformJobOutput:
    import aws_sdk_neptunedata.types.get_ml_model_transform_job_output
    out: aws_sdk_neptunedata.types.get_ml_model_transform_job_output.GetMLModelTransformJobOutput = aws_sdk_neptunedata.types.get_ml_model_transform_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_ml_model_transform_job_input.GetMLModelTransformJobInput) -> zapros.Request:
...
def get_ml_model_transform_job(options: OperationOptions, input: aws_sdk_neptunedata.types.get_ml_model_transform_job_input.GetMLModelTransformJobInput) -> tuple[aws_sdk_neptunedata.types.get_ml_model_transform_job_output.GetMLModelTransformJobOutput, zapros.Response]:
...
async def async_get_ml_model_transform_job(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_ml_model_transform_job_input.GetMLModelTransformJobInput) -> tuple[aws_sdk_neptunedata.types.get_ml_model_transform_job_output.GetMLModelTransformJobOutput, zapros.Response]:
