"""Generated from Smithy shape ``com.amazonaws.neptunedata#ExecuteGremlinProfileQuery``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.execute_gremlin_profile_query_output.ExecuteGremlinProfileQueryOutput:
    import aws_sdk_neptunedata.types.report_as_text
    out: aws_sdk_neptunedata.types.execute_gremlin_profile_query_output.ExecuteGremlinProfileQueryOutput = {"output": aws_sdk_neptunedata.types.report_as_text.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.execute_gremlin_profile_query_input.ExecuteGremlinProfileQueryInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/gremlin/profile"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_neptunedata.types.execute_gremlin_profile_query_input
    body: bytes | None = json.dumps(aws_sdk_neptunedata.types.execute_gremlin_profile_query_input.serialize_json(input)).encode()
...
def execute_gremlin_profile_query(options: OperationOptions, input: aws_sdk_neptunedata.types.execute_gremlin_profile_query_input.ExecuteGremlinProfileQueryInput) -> tuple[aws_sdk_neptunedata.types.execute_gremlin_profile_query_output.ExecuteGremlinProfileQueryOutput, zapros.Response]:
...
async def async_execute_gremlin_profile_query(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.execute_gremlin_profile_query_input.ExecuteGremlinProfileQueryInput) -> tuple[aws_sdk_neptunedata.types.execute_gremlin_profile_query_output.ExecuteGremlinProfileQueryOutput, zapros.Response]:
