...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.execute_gremlin_profile_query_output.ExecuteGremlinProfileQueryOutput = {
        "output": aws_sdk_neptunedata.types.report_as_text.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.execute_gremlin_profile_query_input.ExecuteGremlinProfileQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptunedata.types.execute_gremlin_profile_query_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_execute_gremlin_profile_query(
