...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "S3Exception":
            import aws_sdk_neptunedata.errors.s3_exception
            raise aws_sdk_neptunedata.errors.s3_exception.S3Exception.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.start_loader_job_output.StartLoaderJobOutput:
    import aws_sdk_neptunedata.types.start_loader_job_output
    out: aws_sdk_neptunedata.types.start_loader_job_output.StartLoaderJobOutput = aws_sdk_neptunedata.types.start_loader_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.start_loader_job_input.StartLoaderJobInput) -> zapros.Request:
    ...
    import aws_sdk_neptunedata.types.start_loader_job_input
    body: bytes | None = json.dumps(aws_sdk_neptunedata.types.start_loader_job_input.serialize_json(input)).encode()
...
def start_loader_job(options: OperationOptions, input: aws_sdk_neptunedata.types.start_loader_job_input.StartLoaderJobInput) -> tuple[aws_sdk_neptunedata.types.start_loader_job_output.StartLoaderJobOutput, zapros.Response]:
...
async def async_start_loader_job(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.start_loader_job_input.StartLoaderJobInput) -> tuple[aws_sdk_neptunedata.types.start_loader_job_output.StartLoaderJobOutput, zapros.Response]:
