"""Generated from Smithy shape ``com.amazonaws.neptunedata#CancelGremlinQuery``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.cancel_gremlin_query_output.CancelGremlinQueryOutput:
    import aws_sdk_neptunedata.types.cancel_gremlin_query_output
    out: aws_sdk_neptunedata.types.cancel_gremlin_query_output.CancelGremlinQueryOutput = aws_sdk_neptunedata.types.cancel_gremlin_query_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.cancel_gremlin_query_input.CancelGremlinQueryInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/gremlin/status/{queryId}"
...
def cancel_gremlin_query(options: OperationOptions, input: aws_sdk_neptunedata.types.cancel_gremlin_query_input.CancelGremlinQueryInput) -> tuple[aws_sdk_neptunedata.types.cancel_gremlin_query_output.CancelGremlinQueryOutput, zapros.Response]:
...
async def async_cancel_gremlin_query(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.cancel_gremlin_query_input.CancelGremlinQueryInput) -> tuple[aws_sdk_neptunedata.types.cancel_gremlin_query_output.CancelGremlinQueryOutput, zapros.Response]:
