...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.cancel_gremlin_query_output.CancelGremlinQueryOutput = aws_sdk_neptunedata.types.cancel_gremlin_query_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.cancel_gremlin_query_input.CancelGremlinQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
