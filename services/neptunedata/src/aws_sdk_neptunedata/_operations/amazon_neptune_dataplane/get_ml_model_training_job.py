"""Generated from Smithy shape ``com.amazonaws.neptunedata#GetMLModelTrainingJob``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.get_ml_model_training_job_output.GetMLModelTrainingJobOutput:
    import aws_sdk_neptunedata.types.get_ml_model_training_job_output
    out: aws_sdk_neptunedata.types.get_ml_model_training_job_output.GetMLModelTrainingJobOutput = aws_sdk_neptunedata.types.get_ml_model_training_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_ml_model_training_job_input.GetMLModelTrainingJobInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/ml/modeltraining/{id}"
...
def get_ml_model_training_job(options: OperationOptions, input: aws_sdk_neptunedata.types.get_ml_model_training_job_input.GetMLModelTrainingJobInput) -> tuple[aws_sdk_neptunedata.types.get_ml_model_training_job_output.GetMLModelTrainingJobOutput, zapros.Response]:
...
async def async_get_ml_model_training_job(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.get_ml_model_training_job_input.GetMLModelTrainingJobInput) -> tuple[aws_sdk_neptunedata.types.get_ml_model_training_job_output.GetMLModelTrainingJobOutput, zapros.Response]:
