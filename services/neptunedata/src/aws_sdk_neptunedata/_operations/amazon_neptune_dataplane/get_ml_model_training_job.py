...
import aws_sdk_neptunedata.types.ml_models
...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.get_ml_model_training_job_output.GetMLModelTrainingJobOutput = aws_sdk_neptunedata.types.get_ml_model_training_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.get_ml_model_training_job_input.GetMLModelTrainingJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
