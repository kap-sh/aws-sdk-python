...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.execute_gremlin_explain_query_output.ExecuteGremlinExplainQueryOutput:
    import aws_sdk_neptunedata.types.report_as_text
    out: aws_sdk_neptunedata.types.execute_gremlin_explain_query_output.ExecuteGremlinExplainQueryOutput = {"output": aws_sdk_neptunedata.types.report_as_text.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.execute_gremlin_explain_query_input.ExecuteGremlinExplainQueryInput) -> zapros.Request:
    ...
    import aws_sdk_neptunedata.types.execute_gremlin_explain_query_input
    body: bytes | None = json.dumps(aws_sdk_neptunedata.types.execute_gremlin_explain_query_input.serialize_json(input)).encode()
...
def execute_gremlin_explain_query(options: OperationOptions, input: aws_sdk_neptunedata.types.execute_gremlin_explain_query_input.ExecuteGremlinExplainQueryInput) -> tuple[aws_sdk_neptunedata.types.execute_gremlin_explain_query_output.ExecuteGremlinExplainQueryOutput, zapros.Response]:
...
async def async_execute_gremlin_explain_query(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.execute_gremlin_explain_query_input.ExecuteGremlinExplainQueryInput) -> tuple[aws_sdk_neptunedata.types.execute_gremlin_explain_query_output.ExecuteGremlinExplainQueryOutput, zapros.Response]:
