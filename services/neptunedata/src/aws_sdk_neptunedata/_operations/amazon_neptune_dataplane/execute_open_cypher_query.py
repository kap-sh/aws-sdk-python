...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNumericDataException":
            ...
            raise aws_sdk_neptunedata.errors.invalid_numeric_data_exception.InvalidNumericDataException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.execute_open_cypher_query_output.ExecuteOpenCypherQueryOutput = aws_sdk_neptunedata.types.execute_open_cypher_query_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.execute_open_cypher_query_input.ExecuteOpenCypherQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptunedata.types.execute_open_cypher_query_input.serialize_json(input_)
    ).encode()
...
async def async_execute_open_cypher_query(
