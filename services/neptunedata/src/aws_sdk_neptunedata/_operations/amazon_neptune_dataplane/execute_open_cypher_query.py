...
def build_request(
    ...
    input: aws_sdk_neptunedata.types.execute_open_cypher_query_input.ExecuteOpenCypherQueryInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptunedata.types.execute_open_cypher_query_input.serialize_json(input)
    ).encode()
