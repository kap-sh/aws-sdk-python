"""Generated from Smithy shape ``com.amazonaws.neptunedata#ExecuteOpenCypherQuery``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CancelledByUserException":
            ...
            raise aws_sdk_neptunedata.errors.cancelled_by_user_exception.CancelledByUserException.from_json(data)
        ...
        case "ConcurrentModificationException":
            ...
            raise aws_sdk_neptunedata.errors.concurrent_modification_exception.ConcurrentModificationException.from_json(data)
        ...
        case "FailureByQueryException":
            ...
            raise aws_sdk_neptunedata.errors.failure_by_query_exception.FailureByQueryException.from_json(data)
        ...
        case "InvalidNumericDataException":
            import aws_sdk_neptunedata.errors.invalid_numeric_data_exception
            raise aws_sdk_neptunedata.errors.invalid_numeric_data_exception.InvalidNumericDataException.from_json(data)
        ...
        case "MalformedQueryException":
            ...
            raise aws_sdk_neptunedata.errors.malformed_query_exception.MalformedQueryException.from_json(data)
        case "MemoryLimitExceededException":
            import aws_sdk_neptunedata.errors.memory_limit_exceeded_exception
            raise aws_sdk_neptunedata.errors.memory_limit_exceeded_exception.MemoryLimitExceededException.from_json(data)
        ...
        case "ParsingException":
            ...
            raise aws_sdk_neptunedata.errors.parsing_exception.ParsingException.from_json(data)
        ...
        case "QueryLimitExceededException":
            ...
            raise aws_sdk_neptunedata.errors.query_limit_exceeded_exception.QueryLimitExceededException.from_json(data)
        case "QueryLimitException":
            import aws_sdk_neptunedata.errors.query_limit_exception
            raise aws_sdk_neptunedata.errors.query_limit_exception.QueryLimitException.from_json(data)
        case "QueryTooLargeException":
            import aws_sdk_neptunedata.errors.query_too_large_exception
            raise aws_sdk_neptunedata.errors.query_too_large_exception.QueryTooLargeException.from_json(data)
        case "TimeLimitExceededException":
            import aws_sdk_neptunedata.errors.time_limit_exceeded_exception
            raise aws_sdk_neptunedata.errors.time_limit_exceeded_exception.TimeLimitExceededException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.execute_open_cypher_query_output.ExecuteOpenCypherQueryOutput:
    import aws_sdk_neptunedata.types.execute_open_cypher_query_output
    out: aws_sdk_neptunedata.types.execute_open_cypher_query_output.ExecuteOpenCypherQueryOutput = aws_sdk_neptunedata.types.execute_open_cypher_query_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.execute_open_cypher_query_input.ExecuteOpenCypherQueryInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/opencypher"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_neptunedata.types.execute_open_cypher_query_input
    body: bytes | None = json.dumps(aws_sdk_neptunedata.types.execute_open_cypher_query_input.serialize_json(input)).encode()
...
def execute_open_cypher_query(options: OperationOptions, input: aws_sdk_neptunedata.types.execute_open_cypher_query_input.ExecuteOpenCypherQueryInput) -> tuple[aws_sdk_neptunedata.types.execute_open_cypher_query_output.ExecuteOpenCypherQueryOutput, zapros.Response]:
...
async def async_execute_open_cypher_query(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.execute_open_cypher_query_input.ExecuteOpenCypherQueryInput) -> tuple[aws_sdk_neptunedata.types.execute_open_cypher_query_output.ExecuteOpenCypherQueryOutput, zapros.Response]:
