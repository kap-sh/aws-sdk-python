...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.list_gremlin_queries_output.ListGremlinQueriesOutput = aws_sdk_neptunedata.types.list_gremlin_queries_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_neptunedata.types.list_gremlin_queries_input.ListGremlinQueriesInput,
) -> zapros.Request:
