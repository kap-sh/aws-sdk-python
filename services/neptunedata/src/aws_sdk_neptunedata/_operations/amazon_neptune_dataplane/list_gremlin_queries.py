"""Generated from Smithy shape ``com.amazonaws.neptunedata#ListGremlinQueries``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.list_gremlin_queries_output.ListGremlinQueriesOutput:
    import aws_sdk_neptunedata.types.list_gremlin_queries_output
    out: aws_sdk_neptunedata.types.list_gremlin_queries_output.ListGremlinQueriesOutput = aws_sdk_neptunedata.types.list_gremlin_queries_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.list_gremlin_queries_input.ListGremlinQueriesInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/gremlin/status"
    params: dict[str, str] = {}
    if "include_waiting" in input:
        params["includeWaiting"] = str(input["include_waiting"])
...
def list_gremlin_queries(options: OperationOptions, input: aws_sdk_neptunedata.types.list_gremlin_queries_input.ListGremlinQueriesInput) -> tuple[aws_sdk_neptunedata.types.list_gremlin_queries_output.ListGremlinQueriesOutput, zapros.Response]:
...
async def async_list_gremlin_queries(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.list_gremlin_queries_input.ListGremlinQueriesInput) -> tuple[aws_sdk_neptunedata.types.list_gremlin_queries_output.ListGremlinQueriesOutput, zapros.Response]:
