...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.cancel_ml_model_training_job_output.CancelMLModelTrainingJobOutput = aws_sdk_neptunedata.types.cancel_ml_model_training_job_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.cancel_ml_model_training_job_input.CancelMLModelTrainingJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
