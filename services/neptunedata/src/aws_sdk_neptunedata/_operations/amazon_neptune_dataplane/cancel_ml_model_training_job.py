...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.cancel_ml_model_training_job_output.CancelMLModelTrainingJobOutput:
    import aws_sdk_neptunedata.types.cancel_ml_model_training_job_output
    out: aws_sdk_neptunedata.types.cancel_ml_model_training_job_output.CancelMLModelTrainingJobOutput = aws_sdk_neptunedata.types.cancel_ml_model_training_job_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_neptunedata.types.cancel_ml_model_training_job_input.CancelMLModelTrainingJobInput) -> zapros.Request:
...
def cancel_ml_model_training_job(options: OperationOptions, input: aws_sdk_neptunedata.types.cancel_ml_model_training_job_input.CancelMLModelTrainingJobInput) -> tuple[aws_sdk_neptunedata.types.cancel_ml_model_training_job_output.CancelMLModelTrainingJobOutput, zapros.Response]:
...
async def async_cancel_ml_model_training_job(options: AsyncOperationOptions, input: aws_sdk_neptunedata.types.cancel_ml_model_training_job_input.CancelMLModelTrainingJobInput) -> tuple[aws_sdk_neptunedata.types.cancel_ml_model_training_job_output.CancelMLModelTrainingJobOutput, zapros.Response]:
