...
def handle_response(
    ...
    out: aws_sdk_neptunedata.types.delete_sparql_statistics_output.DeleteSparqlStatisticsOutput = aws_sdk_neptunedata.types.delete_sparql_statistics_output.deserialize_json(
