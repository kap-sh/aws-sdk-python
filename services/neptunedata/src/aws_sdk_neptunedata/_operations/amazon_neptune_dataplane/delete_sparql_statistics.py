...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.delete_sparql_statistics_output.DeleteSparqlStatisticsOutput:
    import aws_sdk_neptunedata.types.delete_sparql_statistics_output
    out: aws_sdk_neptunedata.types.delete_sparql_statistics_output.DeleteSparqlStatisticsOutput = aws_sdk_neptunedata.types.delete_sparql_statistics_output.deserialize_json(json.loads(response.read()))
...
def delete_sparql_statistics(options: OperationOptions) -> tuple[aws_sdk_neptunedata.types.delete_sparql_statistics_output.DeleteSparqlStatisticsOutput, zapros.Response]:
...
async def async_delete_sparql_statistics(options: AsyncOperationOptions) -> tuple[aws_sdk_neptunedata.types.delete_sparql_statistics_output.DeleteSparqlStatisticsOutput, zapros.Response]:
