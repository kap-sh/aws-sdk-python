...
def build_request(
    ...
    input_: aws_sdk_neptunedata.types.execute_fast_reset_input.ExecuteFastResetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_neptunedata.types.execute_fast_reset_input.serialize_json(input_)
    ).encode()
