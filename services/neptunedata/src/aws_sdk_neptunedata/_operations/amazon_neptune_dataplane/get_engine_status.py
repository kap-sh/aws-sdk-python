...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_neptunedata.types.get_engine_status_output.GetEngineStatusOutput:
    import aws_sdk_neptunedata.types.get_engine_status_output
    out: aws_sdk_neptunedata.types.get_engine_status_output.GetEngineStatusOutput = aws_sdk_neptunedata.types.get_engine_status_output.deserialize_json(json.loads(response.read()))
    return out
...
def get_engine_status(options: OperationOptions) -> tuple[aws_sdk_neptunedata.types.get_engine_status_output.GetEngineStatusOutput, zapros.Response]:
...
async def async_get_engine_status(options: AsyncOperationOptions) -> tuple[aws_sdk_neptunedata.types.get_engine_status_output.GetEngineStatusOutput, zapros.Response]:
