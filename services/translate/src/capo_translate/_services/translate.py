...
class TranslateClient:
    ...
    def create_parallel_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.create_parallel_data_request.CreateParallelDataRequest]",
        ) -> OperationResponse[
            "capo_translate.types.create_parallel_data_response.CreateParallelDataResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.create_parallel_data.create_parallel_data(
    ...
    def delete_parallel_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.delete_parallel_data_request.DeleteParallelDataRequest]",
        ) -> OperationResponse[
            "capo_translate.types.delete_parallel_data_response.DeleteParallelDataResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.delete_parallel_data.delete_parallel_data(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_terminology(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.delete_terminology_request.DeleteTerminologyRequest]",
        ) -> OperationResponse[None]:
            import capo_translate._operations.aws_shine_frontend_service_20170701.delete_terminology

            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.delete_terminology.delete_terminology(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_text_translation_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.describe_text_translation_job_request.DescribeTextTranslationJobRequest]",
        ) -> OperationResponse[
            "capo_translate.types.describe_text_translation_job_response.DescribeTextTranslationJobResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.describe_text_translation_job.describe_text_translation_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_parallel_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.get_parallel_data_request.GetParallelDataRequest]",
        ) -> OperationResponse[
            "capo_translate.types.get_parallel_data_response.GetParallelDataResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.get_parallel_data.get_parallel_data(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_terminology(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.get_terminology_request.GetTerminologyRequest]",
        ) -> OperationResponse[
            "capo_translate.types.get_terminology_response.GetTerminologyResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.get_terminology.get_terminology(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def import_terminology(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.import_terminology_request.ImportTerminologyRequest]",
        ) -> OperationResponse[
            "capo_translate.types.import_terminology_response.ImportTerminologyResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.import_terminology.import_terminology(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_languages(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.list_languages_request.ListLanguagesRequest]",
        ) -> OperationResponse[
            "capo_translate.types.list_languages_response.ListLanguagesResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.list_languages.list_languages(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_parallel_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.list_parallel_data_request.ListParallelDataRequest]",
        ) -> OperationResponse[
            "capo_translate.types.list_parallel_data_response.ListParallelDataResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.list_parallel_data.list_parallel_data(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_translate.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_terminologies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.list_terminologies_request.ListTerminologiesRequest]",
        ) -> OperationResponse[
            "capo_translate.types.list_terminologies_response.ListTerminologiesResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.list_terminologies.list_terminologies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_text_translation_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.list_text_translation_jobs_request.ListTextTranslationJobsRequest]",
        ) -> OperationResponse[
            "capo_translate.types.list_text_translation_jobs_response.ListTextTranslationJobsResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.list_text_translation_jobs.list_text_translation_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_text_translation_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.start_text_translation_job_request.StartTextTranslationJobRequest]",
        ) -> OperationResponse[
            "capo_translate.types.start_text_translation_job_response.StartTextTranslationJobResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.start_text_translation_job.start_text_translation_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_text_translation_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.stop_text_translation_job_request.StopTextTranslationJobRequest]",
        ) -> OperationResponse[
            "capo_translate.types.stop_text_translation_job_response.StopTextTranslationJobResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.stop_text_translation_job.stop_text_translation_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_translate.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def translate_document(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.translate_document_request.TranslateDocumentRequest]",
        ) -> OperationResponse[
            "capo_translate.types.translate_document_response.TranslateDocumentResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.translate_document.translate_document(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def translate_text(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.translate_text_request.TranslateTextRequest]",
        ) -> OperationResponse[
            "capo_translate.types.translate_text_response.TranslateTextResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.translate_text.translate_text(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_translate.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_parallel_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_translate.types.update_parallel_data_request.UpdateParallelDataRequest]",
        ) -> OperationResponse[
            "capo_translate.types.update_parallel_data_response.UpdateParallelDataResponse"
        ]:
            ...
            output, http_response = (
                capo_translate._operations.aws_shine_frontend_service_20170701.update_parallel_data.update_parallel_data(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
