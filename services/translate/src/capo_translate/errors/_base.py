...
class TranslateError(Exception):
    """Base class for all Translate service errors."""
...
class SerializationError(TranslateError):
    """Raised when a value cannot be serialized."""


class DeserializationError(TranslateError):
...
class WaiterFailedError(TranslateError):
...
class WaiterTimeoutError(TranslateError):
