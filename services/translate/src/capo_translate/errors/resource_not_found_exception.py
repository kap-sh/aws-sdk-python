"""Generated from Smithy shape ``com.amazonaws.translate#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.translate#ResourceNotFoundException``."""
