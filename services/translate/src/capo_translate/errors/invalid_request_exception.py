"""Generated from Smithy shape ``com.amazonaws.translate#InvalidRequestException``."""
...
class InvalidRequestException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.translate#InvalidRequestException``."""
