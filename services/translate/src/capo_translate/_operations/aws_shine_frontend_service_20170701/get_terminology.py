...
def handle_response(
    ...
    out: capo_translate.types.get_terminology_response.GetTerminologyResponse = (
        capo_translate.types.get_terminology_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_translate.types.get_terminology_request.serialize_aws_json_1_1(input_)
    ).encode()
