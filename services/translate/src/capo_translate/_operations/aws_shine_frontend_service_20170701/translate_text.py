...
import capo_translate.errors.detected_language_low_confidence_exception
...
import capo_translate.errors.text_size_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DetectedLanguageLowConfidenceException":
            raise capo_translate.errors.detected_language_low_confidence_exception.DetectedLanguageLowConfidenceException.from_aws_json_1_1(
                data
            )
        ...
        case "TextSizeLimitExceededException":
            raise capo_translate.errors.text_size_limit_exceeded_exception.TextSizeLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_translate.types.translate_text_response.TranslateTextResponse = (
        capo_translate.types.translate_text_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_translate.types.translate_text_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def translate_text(
    ...
    capo_translate.types.translate_text_response.TranslateTextResponse, zapros.Response
]:
