"""Generated from Smithy shape ``com.amazonaws.translate#StartTextTranslationJob``."""
...
def handle_response(
    ...
    out: capo_translate.types.start_text_translation_job_response.StartTextTranslationJobResponse = capo_translate.types.start_text_translation_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_translate.types.start_text_translation_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_text_translation_job(
