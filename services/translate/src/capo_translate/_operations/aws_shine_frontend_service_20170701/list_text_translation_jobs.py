...
import capo_translate.errors.invalid_filter_exception
...
import capo_translate.types.text_translation_job_properties_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidFilterException":
            raise capo_translate.errors.invalid_filter_exception.InvalidFilterException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_translate.types.list_text_translation_jobs_response.ListTextTranslationJobsResponse = capo_translate.types.list_text_translation_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_translate.types.list_text_translation_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
