...
def handle_response(
    ...
    out: capo_translate.types.describe_text_translation_job_response.DescribeTextTranslationJobResponse = capo_translate.types.describe_text_translation_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_translate.types.describe_text_translation_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
