"""Generated from Smithy shape ``com.amazonaws.translate#ListTerminologies``."""
...
def handle_response(
    ...
    out: capo_translate.types.list_terminologies_response.ListTerminologiesResponse = (
        capo_translate.types.list_terminologies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_translate.types.list_terminologies_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_terminologies(
