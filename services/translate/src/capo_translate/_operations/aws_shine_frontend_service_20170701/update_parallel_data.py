...
import capo_translate.errors.concurrent_modification_exception
import capo_translate.errors.conflict_exception
import capo_translate.errors.internal_server_exception
import capo_translate.errors.invalid_parameter_value_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentModificationException":
            raise capo_translate.errors.concurrent_modification_exception.ConcurrentModificationException.from_aws_json_1_1(
                data
            )
        case "ConflictException":
            raise capo_translate.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidParameterValueException":
            raise capo_translate.errors.invalid_parameter_value_exception.InvalidParameterValueException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_translate.types.update_parallel_data_response.UpdateParallelDataResponse = capo_translate.types.update_parallel_data_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_translate._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_translate.types.update_parallel_data_request.serialize_aws_json_1_1(input_)
    ).encode()
