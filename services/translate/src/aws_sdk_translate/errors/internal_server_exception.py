"""Generated from Smithy shape ``com.amazonaws.translate#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.translate#InternalServerException``."""
