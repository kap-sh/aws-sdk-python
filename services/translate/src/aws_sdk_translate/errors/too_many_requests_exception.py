"""Generated from Smithy shape ``com.amazonaws.translate#TooManyRequestsException``."""
...
class TooManyRequestsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.translate#TooManyRequestsException``."""
