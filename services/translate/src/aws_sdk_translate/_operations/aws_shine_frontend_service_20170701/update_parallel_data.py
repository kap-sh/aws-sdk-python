"""Generated from Smithy shape ``com.amazonaws.translate#UpdateParallelData``."""
...
import aws_sdk_translate.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_translate.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_translate.types.update_parallel_data_response.UpdateParallelDataResponse = aws_sdk_translate.types.update_parallel_data_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_translate.types.update_parallel_data_request.UpdateParallelDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSShineFrontendService_20170701.UpdateParallelData"
    body: bytes | None = json.dumps(
        aws_sdk_translate.types.update_parallel_data_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_parallel_data(
