"""Generated from Smithy shape ``com.amazonaws.translate#CreateParallelData``."""
...
def handle_response(
    ...
    out: aws_sdk_translate.types.create_parallel_data_response.CreateParallelDataResponse = aws_sdk_translate.types.create_parallel_data_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_translate.types.create_parallel_data_request.CreateParallelDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSShineFrontendService_20170701.CreateParallelData"
    import aws_sdk_translate.types.create_parallel_data_request

    body: bytes | None = json.dumps(
        aws_sdk_translate.types.create_parallel_data_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_parallel_data(
