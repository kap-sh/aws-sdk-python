"""Generated from Smithy shape ``com.amazonaws.translate#ListLanguages``."""
...
import aws_sdk_translate.errors.unsupported_display_language_code_exception
import aws_sdk_translate.types.display_language_code
import aws_sdk_translate.types.languages_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnsupportedDisplayLanguageCodeException":
            raise aws_sdk_translate.errors.unsupported_display_language_code_exception.UnsupportedDisplayLanguageCodeException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_translate.types.list_languages_response.ListLanguagesResponse = (
        aws_sdk_translate.types.list_languages_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_translate.types.list_languages_request.ListLanguagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSShineFrontendService_20170701.ListLanguages"
    import aws_sdk_translate.types.list_languages_request

    body: bytes | None = json.dumps(
        aws_sdk_translate.types.list_languages_request.serialize_aws_json_1_1(input_)
    ).encode()
