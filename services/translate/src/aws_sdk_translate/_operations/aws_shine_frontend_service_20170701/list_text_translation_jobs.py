"""Generated from Smithy shape ``com.amazonaws.translate#ListTextTranslationJobs``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidFilterException":
            import aws_sdk_translate.errors.invalid_filter_exception

            raise aws_sdk_translate.errors.invalid_filter_exception.InvalidFilterException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_translate.types.list_text_translation_jobs_response.ListTextTranslationJobsResponse = aws_sdk_translate.types.list_text_translation_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_translate.types.list_text_translation_jobs_request.ListTextTranslationJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_translate.types.list_text_translation_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_text_translation_jobs(
