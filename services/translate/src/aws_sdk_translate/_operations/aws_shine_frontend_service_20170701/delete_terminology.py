...
def build_request(
    ...
    input_: aws_sdk_translate.types.delete_terminology_request.DeleteTerminologyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_translate.types.delete_terminology_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
