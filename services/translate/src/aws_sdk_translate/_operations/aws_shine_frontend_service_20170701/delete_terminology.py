"""Generated from Smithy shape ``com.amazonaws.translate#DeleteTerminology``."""
...
def build_request(
    ...
    input: aws_sdk_translate.types.delete_terminology_request.DeleteTerminologyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_translate.types.delete_terminology_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_delete_terminology(
