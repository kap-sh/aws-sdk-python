...
def handle_response(
    ...
    out: aws_sdk_translate.types.start_text_translation_job_response.StartTextTranslationJobResponse = aws_sdk_translate.types.start_text_translation_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_translate.types.start_text_translation_job_request.StartTextTranslationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_translate.types.start_text_translation_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
