...
def handle_response(
    ...
    out: aws_sdk_translate.types.translate_document_response.TranslateDocumentResponse = aws_sdk_translate.types.translate_document_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_translate.types.translate_document_request.TranslateDocumentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_translate.types.translate_document_request.serialize_aws_json_1_1(input)
    ).encode()
