...
def handle_response(
    ...
    out: aws_sdk_translate.types.list_terminologies_response.ListTerminologiesResponse = aws_sdk_translate.types.list_terminologies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_translate.types.list_terminologies_request.ListTerminologiesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_translate.types.list_terminologies_request.serialize_aws_json_1_1(input)
    ).encode()
