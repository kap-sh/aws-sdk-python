...
def build_request(
    ...
    input_: aws_sdk_translate.types.list_terminologies_request.ListTerminologiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_translate.types.list_terminologies_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
