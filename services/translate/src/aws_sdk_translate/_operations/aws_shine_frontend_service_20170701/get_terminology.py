"""Generated from Smithy shape ``com.amazonaws.translate#GetTerminology``."""
...
def handle_response(
    ...
    out: aws_sdk_translate.types.get_terminology_response.GetTerminologyResponse = (
        aws_sdk_translate.types.get_terminology_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_translate.types.get_terminology_request.GetTerminologyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_translate.types.get_terminology_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_terminology(
