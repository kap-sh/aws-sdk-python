"""Generated from Smithy shape ``com.amazonaws.translate#StopTextTranslationJob``."""
...
def handle_response(
    ...
    out: aws_sdk_translate.types.stop_text_translation_job_response.StopTextTranslationJobResponse = aws_sdk_translate.types.stop_text_translation_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_translate.types.stop_text_translation_job_request.StopTextTranslationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_translate.types.stop_text_translation_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_text_translation_job(
