...
def build_request(
    ...
    input: aws_sdk_translate.types.import_terminology_request.ImportTerminologyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_translate.types.import_terminology_request.serialize_aws_json_1_1(input)
    ).encode()
