...
def handle_response(
    ...
    out: aws_sdk_translate.types.delete_parallel_data_response.DeleteParallelDataResponse = aws_sdk_translate.types.delete_parallel_data_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_translate.types.delete_parallel_data_request.DeleteParallelDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_translate.types.delete_parallel_data_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
