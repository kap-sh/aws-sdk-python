"""Generated from Smithy shape ``com.amazonaws.translate#DescribeTextTranslationJob``."""
...
def handle_response(
    ...
    out: aws_sdk_translate.types.describe_text_translation_job_response.DescribeTextTranslationJobResponse = aws_sdk_translate.types.describe_text_translation_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_translate.types.describe_text_translation_job_request.DescribeTextTranslationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_text_translation_job(
