...
def build_request(
    ...
    input: aws_sdk_translate.types.list_parallel_data_request.ListParallelDataRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_translate.types.list_parallel_data_request.serialize_aws_json_1_1(input)
    ).encode()
