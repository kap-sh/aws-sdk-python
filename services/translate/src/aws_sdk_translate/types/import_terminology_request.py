...
def serialize_aws_json_1_1(value: ImportTerminologyRequest) -> dict:
    ...
    out["MergeStrategy"] = (
        aws_sdk_translate.types.merge_strategy.serialize_aws_json_1_1(
    ...
    out["TerminologyData"] = (
        aws_sdk_translate.types.terminology_data.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ImportTerminologyRequest:
    ...
    if "MergeStrategy" in data:
        ...
        out["merge_strategy"] = (
            aws_sdk_translate.types.merge_strategy.deserialize_aws_json_1_1(
                data["MergeStrategy"]
            )
        )
    else:
    ...
    if "TerminologyData" in data:
        ...
        out["terminology_data"] = (
            aws_sdk_translate.types.terminology_data.deserialize_aws_json_1_1(
