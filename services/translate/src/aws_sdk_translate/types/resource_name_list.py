"""Generated from Smithy shape ``com.amazonaws.translate#ResourceNameList``."""
...
ResourceNameList: TypeAlias = list["aws_sdk_translate.types.resource_name.ResourceName"]
