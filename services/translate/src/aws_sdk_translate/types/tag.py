...
if TYPE_CHECKING:
    import aws_sdk_translate.types.tag_key
    import aws_sdk_translate.types.tag_value


class Tag(TypedDict):
    key: "aws_sdk_translate.types.tag_key.TagKey"
    """<p>The initial part of a key-value pair that forms a tag associated with a given resource. </p>"""
    value: "aws_sdk_translate.types.tag_value.TagValue"
