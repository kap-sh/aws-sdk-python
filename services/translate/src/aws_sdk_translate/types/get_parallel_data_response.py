...
class GetParallelDataResponse(TypedDict):
    ...
    data_location: NotRequired[
        "aws_sdk_translate.types.parallel_data_data_location.ParallelDataDataLocation"
    ]
...
def serialize_aws_json_1_1(value: GetParallelDataResponse) -> dict:
    ...
    if "data_location" in value:
        ...
        out["DataLocation"] = (
            aws_sdk_translate.types.parallel_data_data_location.serialize_aws_json_1_1(
                value["data_location"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetParallelDataResponse:
    ...
    if "DataLocation" in data:
        ...
        out["data_location"] = (
            aws_sdk_translate.types.parallel_data_data_location.deserialize_aws_json_1_1(
                data["DataLocation"]
            )
        )
