...
if TYPE_CHECKING:
    ...
    import aws_sdk_translate.types.formality
...
class TranslationSettings(TypedDict, closed=True):
    ...
    brevity: NotRequired["aws_sdk_translate.types.brevity.Brevity"]
...
def serialize_aws_json_1_1(value: TranslationSettings) -> dict:
    ...
    if "formality" in value:
        ...
        out["Formality"] = aws_sdk_translate.types.formality.serialize_aws_json_1_1(
            value["formality"]
        )
    if "profanity" in value:
        import aws_sdk_translate.types.profanity

        out["Profanity"] = aws_sdk_translate.types.profanity.serialize_aws_json_1_1(
            value["profanity"]
        )
    if "brevity" in value:
        import aws_sdk_translate.types.brevity

        out["Brevity"] = aws_sdk_translate.types.brevity.serialize_aws_json_1_1(
            value["brevity"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> TranslationSettings:
    ...
    if "Formality" in data:
        ...
        out["formality"] = aws_sdk_translate.types.formality.deserialize_aws_json_1_1(
            data["Formality"]
        )
    if "Profanity" in data:
        import aws_sdk_translate.types.profanity

        out["profanity"] = aws_sdk_translate.types.profanity.deserialize_aws_json_1_1(
            data["Profanity"]
        )
    if "Brevity" in data:
        import aws_sdk_translate.types.brevity

        out["brevity"] = aws_sdk_translate.types.brevity.deserialize_aws_json_1_1(
            data["Brevity"]
        )
    return out
