...
def serialize_aws_json_1_1(value: ListLanguagesResponse) -> dict:
    ...
    if "languages" in value:
        ...
        out["Languages"] = (
            aws_sdk_translate.types.languages_list.serialize_aws_json_1_1(
                value["languages"]
            )
        )
    if "display_language_code" in value:
        ...
        out["DisplayLanguageCode"] = (
            aws_sdk_translate.types.display_language_code.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListLanguagesResponse:
    ...
    if "Languages" in data:
        ...
        out["languages"] = (
            aws_sdk_translate.types.languages_list.deserialize_aws_json_1_1(
                data["Languages"]
            )
        )
    if "DisplayLanguageCode" in data:
        ...
        out["display_language_code"] = (
            aws_sdk_translate.types.display_language_code.deserialize_aws_json_1_1(
