...
class Cloud9Error(Exception):
    """Base class for all Cloud9 service errors."""


class ServiceError(Cloud9Error):
...
class SerializationError(Cloud9Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(Cloud9Error):
...
class WaiterFailedError(Cloud9Error):
...
class WaiterTimeoutError(Cloud9Error):
