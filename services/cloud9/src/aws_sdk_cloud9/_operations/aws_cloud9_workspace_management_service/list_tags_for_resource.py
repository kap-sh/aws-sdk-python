...
def handle_response(
    ...
    out: aws_sdk_cloud9.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_cloud9.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloud9.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloud9.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
