...
def handle_response(
    ...
    out: aws_sdk_cloud9.types.list_environments_result.ListEnvironmentsResult = (
        aws_sdk_cloud9.types.list_environments_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloud9.types.list_environments_request.ListEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloud9.types.list_environments_request.serialize_aws_json_1_1(input_)
    ).encode()
