...
def build_request(
    ...
    input: aws_sdk_cloud9.types.list_environments_request.ListEnvironmentsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloud9.types.list_environments_request.serialize_aws_json_1_1(input)
    ).encode()
