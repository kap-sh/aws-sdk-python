...
def handle_response(
    ...
    out: aws_sdk_cloud9.types.describe_environment_memberships_result.DescribeEnvironmentMembershipsResult = aws_sdk_cloud9.types.describe_environment_memberships_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloud9.types.describe_environment_memberships_request.DescribeEnvironmentMembershipsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloud9.types.describe_environment_memberships_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
