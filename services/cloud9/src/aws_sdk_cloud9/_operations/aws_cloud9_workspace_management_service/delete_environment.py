...
def build_request(
    ...
    input: aws_sdk_cloud9.types.delete_environment_request.DeleteEnvironmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloud9.types.delete_environment_request.serialize_aws_json_1_1(input)
    ).encode()
