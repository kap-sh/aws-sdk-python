...
def handle_response(
    ...
    out: aws_sdk_cloud9.types.delete_environment_result.DeleteEnvironmentResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloud9.types.delete_environment_request.DeleteEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloud9.types.delete_environment_request.serialize_aws_json_1_1(input_)
    ).encode()
