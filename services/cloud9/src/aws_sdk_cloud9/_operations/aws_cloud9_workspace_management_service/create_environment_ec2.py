...
def handle_response(
    ...
    out: aws_sdk_cloud9.types.create_environment_ec2_result.CreateEnvironmentEC2Result = aws_sdk_cloud9.types.create_environment_ec2_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloud9.types.create_environment_ec2_request.CreateEnvironmentEC2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloud9.types.create_environment_ec2_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
