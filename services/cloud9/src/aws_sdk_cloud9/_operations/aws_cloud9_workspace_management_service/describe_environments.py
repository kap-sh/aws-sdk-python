...
def build_request(
    ...
    input_: aws_sdk_cloud9.types.describe_environments_request.DescribeEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloud9.types.describe_environments_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
