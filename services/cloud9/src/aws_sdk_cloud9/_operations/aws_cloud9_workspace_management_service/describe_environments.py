...
def handle_response(
    ...
    out: aws_sdk_cloud9.types.describe_environments_result.DescribeEnvironmentsResult = aws_sdk_cloud9.types.describe_environments_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_cloud9.types.describe_environments_request.DescribeEnvironmentsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloud9.types.describe_environments_request.serialize_aws_json_1_1(input)
    ).encode()
