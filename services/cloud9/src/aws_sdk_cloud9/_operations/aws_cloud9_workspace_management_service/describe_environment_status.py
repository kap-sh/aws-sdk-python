"""Generated from Smithy shape ``com.amazonaws.cloud9#DescribeEnvironmentStatus``."""
...
import aws_sdk_cloud9.types.environment_status
...
def handle_response(
    ...
    out: aws_sdk_cloud9.types.describe_environment_status_result.DescribeEnvironmentStatusResult = aws_sdk_cloud9.types.describe_environment_status_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloud9.types.describe_environment_status_request.DescribeEnvironmentStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_environment_status(
