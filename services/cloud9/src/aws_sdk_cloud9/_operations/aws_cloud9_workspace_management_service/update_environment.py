...
def build_request(
    ...
    input: aws_sdk_cloud9.types.update_environment_request.UpdateEnvironmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloud9.types.update_environment_request.serialize_aws_json_1_1(input)
    ).encode()
