"""Generated from Smithy shape ``com.amazonaws.cloud9#UpdateEnvironment``."""
...
def handle_response(
    ...
    out: aws_sdk_cloud9.types.update_environment_result.UpdateEnvironmentResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloud9.types.update_environment_request.UpdateEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSCloud9WorkspaceManagementService.UpdateEnvironment"
    body: bytes | None = json.dumps(
        aws_sdk_cloud9.types.update_environment_request.serialize_aws_json_1_1(input_)
    ).encode()
