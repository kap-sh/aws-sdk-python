...
def handle_response(
    ...
    out: aws_sdk_cloud9.types.delete_environment_membership_result.DeleteEnvironmentMembershipResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloud9.types.delete_environment_membership_request.DeleteEnvironmentMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
