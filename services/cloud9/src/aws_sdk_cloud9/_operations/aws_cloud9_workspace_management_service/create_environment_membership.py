...
def handle_response(
    ...
    out: aws_sdk_cloud9.types.create_environment_membership_result.CreateEnvironmentMembershipResult = aws_sdk_cloud9.types.create_environment_membership_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloud9.types.create_environment_membership_request.CreateEnvironmentMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloud9.types.create_environment_membership_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
