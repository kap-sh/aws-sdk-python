...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloud9.types.environment_lifecycle
    import aws_sdk_cloud9.types.environment_name
    import aws_sdk_cloud9.types.environment_type
    import aws_sdk_cloud9.types.managed_credentials_status
    import aws_sdk_cloud9.types.string


class Environment(TypedDict):
    id: NotRequired["aws_sdk_cloud9.types.environment_id.EnvironmentId"]
    ...
    type: "aws_sdk_cloud9.types.environment_type.EnvironmentType"
    ...
    arn: "aws_sdk_cloud9.types.string.String"
    """<p>The Amazon Resource Name (ARN) of the environment.</p>"""
    owner_arn: "aws_sdk_cloud9.types.string.String"
    """<p>The Amazon Resource Name (ARN) of the environment owner.</p>"""
    lifecycle: NotRequired[
        "aws_sdk_cloud9.types.environment_lifecycle.EnvironmentLifecycle"
    ]
    """<p>The state of the environment in its creation or deletion lifecycle.</p>"""
    managed_credentials_status: NotRequired[
        "aws_sdk_cloud9.types.managed_credentials_status.ManagedCredentialsStatus"
    ]
...
def serialize_aws_json_1_1(value: Environment) -> dict:
    ...
    out["type"] = aws_sdk_cloud9.types.environment_type.serialize_aws_json_1_1(
        value["type"]
    )
    if "connection_type" in value:
        ...
        out["connectionType"] = (
            aws_sdk_cloud9.types.connection_type.serialize_aws_json_1_1(
    ...
    if "lifecycle" in value:
        ...
        out["lifecycle"] = (
            aws_sdk_cloud9.types.environment_lifecycle.serialize_aws_json_1_1(
                value["lifecycle"]
            )
        )
    if "managed_credentials_status" in value:
        ...
        out["managedCredentialsStatus"] = (
            aws_sdk_cloud9.types.managed_credentials_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Environment:
    ...
    if "type" in data:
        ...
        out["type"] = aws_sdk_cloud9.types.environment_type.deserialize_aws_json_1_1(
            data["type"]
        )
    else:
    ...
    if "connectionType" in data:
        ...
        out["connection_type"] = (
            aws_sdk_cloud9.types.connection_type.deserialize_aws_json_1_1(
                data["connectionType"]
            )
        )
    if "arn" in data:
    ...
    if "lifecycle" in data:
        ...
        out["lifecycle"] = (
            aws_sdk_cloud9.types.environment_lifecycle.deserialize_aws_json_1_1(
                data["lifecycle"]
            )
        )
    if "managedCredentialsStatus" in data:
        ...
        out["managed_credentials_status"] = (
            aws_sdk_cloud9.types.managed_credentials_status.deserialize_aws_json_1_1(
