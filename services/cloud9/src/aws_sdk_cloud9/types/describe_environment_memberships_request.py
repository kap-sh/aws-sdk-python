...
class DescribeEnvironmentMembershipsRequest(TypedDict):
    user_arn: NotRequired["aws_sdk_cloud9.types.user_arn.UserArn"]
    ...
    permissions: NotRequired["aws_sdk_cloud9.types.permissions_list.PermissionsList"]
...
def serialize_aws_json_1_1(value: DescribeEnvironmentMembershipsRequest) -> dict:
    ...
    if "permissions" in value:
        ...
        out["permissions"] = (
            aws_sdk_cloud9.types.permissions_list.serialize_aws_json_1_1(
                value["permissions"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeEnvironmentMembershipsRequest:
    ...
    if "permissions" in data:
        ...
        out["permissions"] = (
            aws_sdk_cloud9.types.permissions_list.deserialize_aws_json_1_1(
                data["permissions"]
            )
        )
