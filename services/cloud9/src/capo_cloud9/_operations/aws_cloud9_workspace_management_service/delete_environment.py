"""Generated from Smithy shape ``com.amazonaws.cloud9#DeleteEnvironment``."""
...
def handle_response(
    ...
    out: capo_cloud9.types.delete_environment_result.DeleteEnvironmentResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSCloud9WorkspaceManagementService.DeleteEnvironment"
    body: bytes | None = json.dumps(
        capo_cloud9.types.delete_environment_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_environment(
    ...
    capo_cloud9.types.delete_environment_result.DeleteEnvironmentResult, zapros.Response
]:
