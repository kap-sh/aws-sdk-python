"""Generated from Smithy shape ``com.amazonaws.cloud9#TagResource``."""
...
def handle_response(
    ...
    out: capo_cloud9.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSCloud9WorkspaceManagementService.TagResource"
    body: bytes | None = json.dumps(
        capo_cloud9.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_cloud9.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
