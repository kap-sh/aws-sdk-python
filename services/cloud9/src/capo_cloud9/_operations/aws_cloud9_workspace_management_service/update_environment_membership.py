...
def handle_response(
    ...
    out: capo_cloud9.types.update_environment_membership_result.UpdateEnvironmentMembershipResult = capo_cloud9.types.update_environment_membership_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloud9.types.update_environment_membership_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
