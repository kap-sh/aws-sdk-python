"""Generated from Smithy shape ``com.amazonaws.cloud9#ListEnvironments``."""
...
def handle_response(
    ...
    out: capo_cloud9.types.list_environments_result.ListEnvironmentsResult = (
        capo_cloud9.types.list_environments_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSCloud9WorkspaceManagementService.ListEnvironments"
    body: bytes | None = json.dumps(
        capo_cloud9.types.list_environments_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_environments(
    ...
    capo_cloud9.types.list_environments_result.ListEnvironmentsResult, zapros.Response
]:
