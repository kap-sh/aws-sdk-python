"""Generated from Smithy shape ``com.amazonaws.cloud9#DeleteEnvironmentMembership``."""
...
def handle_response(
    ...
    out: capo_cloud9.types.delete_environment_membership_result.DeleteEnvironmentMembershipResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloud9.types.delete_environment_membership_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_environment_membership(
