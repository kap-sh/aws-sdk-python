"""Generated from Smithy shape ``com.amazonaws.cloud9#DescribeEnvironments``."""
...
def handle_response(
    ...
    out: capo_cloud9.types.describe_environments_result.DescribeEnvironmentsResult = (
        capo_cloud9.types.describe_environments_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSCloud9WorkspaceManagementService.DescribeEnvironments"
    body: bytes | None = json.dumps(
        capo_cloud9.types.describe_environments_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_environments(
