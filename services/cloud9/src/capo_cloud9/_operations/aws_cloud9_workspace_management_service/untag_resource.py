"""Generated from Smithy shape ``com.amazonaws.cloud9#UntagResource``."""
...
import capo_cloud9.errors.concurrent_access_exception
...
from capo_cloud9._services._pipeline import AsyncOperationOptions, OperationOptions
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConcurrentAccessException":
            raise capo_cloud9.errors.concurrent_access_exception.ConcurrentAccessException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_cloud9.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_cloud9._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSCloud9WorkspaceManagementService.UntagResource"
    body: bytes | None = json.dumps(
        capo_cloud9.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def untag_resource(
    ...
    capo_cloud9.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
