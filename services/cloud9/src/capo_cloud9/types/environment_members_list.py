...
EnvironmentMembersList: TypeAlias = list[
    "capo_cloud9.types.environment_member.EnvironmentMember"
]
...
def serialize_aws_json_1_1(value: EnvironmentMembersList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_cloud9.types.environment_member.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> EnvironmentMembersList:
    ...
    for item in data:
        out.append(capo_cloud9.types.environment_member.deserialize_aws_json_1_1(item))
    return out
