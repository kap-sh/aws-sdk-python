...
ServiceInstanceSummaryList: TypeAlias = list[
    "aws_sdk_proton.types.service_instance_summary.ServiceInstanceSummary"
]
...
def serialize_aws_json_1_0(value: ServiceInstanceSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_proton.types.service_instance_summary.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ServiceInstanceSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_proton.types.service_instance_summary.deserialize_aws_json_1_0(item)
        )
    return out
