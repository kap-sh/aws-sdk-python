...
class CancelComponentDeploymentOutput(TypedDict):
...
def serialize_aws_json_1_0(value: CancelComponentDeploymentOutput) -> dict:
    out: dict = {}
    import aws_sdk_proton.types.component
    out["component"] = aws_sdk_proton.types.component.serialize_aws_json_1_0(value["component"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> CancelComponentDeploymentOutput:
    ...
    if "component" in data:
        import aws_sdk_proton.types.component
        out["component"] = aws_sdk_proton.types.component.deserialize_aws_json_1_0(data["component"])
    else:
