...
if TYPE_CHECKING:
    import aws_sdk_proton.types.environment_template_filter

EnvironmentTemplateFilterList: TypeAlias = list[
    "aws_sdk_proton.types.environment_template_filter.EnvironmentTemplateFilter"
]
...
def serialize_aws_json_1_0(value: EnvironmentTemplateFilterList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_proton.types.environment_template_filter.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> EnvironmentTemplateFilterList:
    ...
    for item in data:
        out.append(
            aws_sdk_proton.types.environment_template_filter.deserialize_aws_json_1_0(
                item
            )
        )
    return out
