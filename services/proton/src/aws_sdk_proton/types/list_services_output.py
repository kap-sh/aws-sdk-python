...
class ListServicesOutput(TypedDict):
    ...
    services: "aws_sdk_proton.types.service_summary_list.ServiceSummaryList"
...
def serialize_aws_json_1_0(value: ListServicesOutput) -> dict:
    ...
    out["services"] = aws_sdk_proton.types.service_summary_list.serialize_aws_json_1_0(
        value["services"]
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ListServicesOutput:
    ...
    if "services" in data:
        ...
        out["services"] = (
            aws_sdk_proton.types.service_summary_list.deserialize_aws_json_1_0(
                data["services"]
            )
        )
    else:
