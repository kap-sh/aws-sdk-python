...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: CreateTemplateSyncConfigOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> CreateTemplateSyncConfigOutput:
    out: CreateTemplateSyncConfigOutput = {}  # type: ignore[typeddict-item]
