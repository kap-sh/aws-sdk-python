...
class CancelEnvironmentDeploymentOutput(TypedDict):
...
def serialize_aws_json_1_0(value: CancelEnvironmentDeploymentOutput) -> dict:
    out: dict = {}
    import aws_sdk_proton.types.environment
    out["environment"] = aws_sdk_proton.types.environment.serialize_aws_json_1_0(value["environment"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> CancelEnvironmentDeploymentOutput:
    ...
    if "environment" in data:
        import aws_sdk_proton.types.environment
        out["environment"] = aws_sdk_proton.types.environment.deserialize_aws_json_1_0(data["environment"])
    else:
        raise DeserializationError("CancelEnvironmentDeploymentOutput.environment required")
    return out