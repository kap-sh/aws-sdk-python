...
if TYPE_CHECKING:
    import aws_sdk_proton.types.service_template_supported_component_source_type

ServiceTemplateSupportedComponentSourceInputList: TypeAlias = list[
    "aws_sdk_proton.types.service_template_supported_component_source_type.ServiceTemplateSupportedComponentSourceType"
]
