...
class CancelServiceInstanceDeploymentOutput(TypedDict):
...
def serialize_aws_json_1_0(value: CancelServiceInstanceDeploymentOutput) -> dict:
    out: dict = {}
    import aws_sdk_proton.types.service_instance
    out["serviceInstance"] = aws_sdk_proton.types.service_instance.serialize_aws_json_1_0(value["service_instance"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> CancelServiceInstanceDeploymentOutput:
    ...
    if "serviceInstance" in data:
        import aws_sdk_proton.types.service_instance
        out["service_instance"] = aws_sdk_proton.types.service_instance.deserialize_aws_json_1_0(data["serviceInstance"])
    else:
        raise DeserializationError("CancelServiceInstanceDeploymentOutput.service_instance required")
    return out