...
if TYPE_CHECKING:
    ...
    import aws_sdk_proton.types.deployment_state
...
class Deployment(TypedDict):
    ...
    initial_state: NotRequired["aws_sdk_proton.types.deployment_state.DeploymentState"]
    """<p>The initial state of the target resource at the time of the deployment.</p>"""
    target_state: NotRequired["aws_sdk_proton.types.deployment_state.DeploymentState"]
...
def serialize_aws_json_1_0(value: Deployment) -> dict:
    ...
    if "initial_state" in value:
        ...
        out["initialState"] = (
            aws_sdk_proton.types.deployment_state.serialize_aws_json_1_0(
                value["initial_state"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> Deployment:
    ...
    if "initialState" in data:
        ...
        out["initial_state"] = (
            aws_sdk_proton.types.deployment_state.deserialize_aws_json_1_0(
                data["initialState"]
            )
        )
