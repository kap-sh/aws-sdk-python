...
def deserialize_aws_json_1_0(data: dict) -> CancelServiceInstanceDeploymentInput:
    ...
    if "serviceInstanceName" in data:
        ...
        raise DeserializationError("CancelServiceInstanceDeploymentInput.service_instance_name required")
    if "serviceName" in data:
        out["service_name"] = data["serviceName"]
    else:
        raise DeserializationError("CancelServiceInstanceDeploymentInput.service_name required")
    return out