...
def serialize_aws_json_1_0(value: ListEnvironmentAccountConnectionsInput) -> dict:
    ...
    if "statuses" in value:
        ...
        out["statuses"] = (
            aws_sdk_proton.types.environment_account_connection_status_list.serialize_aws_json_1_0(
                value["statuses"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListEnvironmentAccountConnectionsInput:
    ...
    if "statuses" in data:
        ...
        out["statuses"] = (
            aws_sdk_proton.types.environment_account_connection_status_list.deserialize_aws_json_1_0(
                data["statuses"]
            )
        )
