...
CompatibleEnvironmentTemplateList: TypeAlias = list[
    "aws_sdk_proton.types.compatible_environment_template.CompatibleEnvironmentTemplate"
]
...
def serialize_aws_json_1_0(value: CompatibleEnvironmentTemplateList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_proton.types.compatible_environment_template.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> CompatibleEnvironmentTemplateList:
    ...
    for item in data:
        out.append(
            aws_sdk_proton.types.compatible_environment_template.deserialize_aws_json_1_0(
                item
            )
        )
    return out
