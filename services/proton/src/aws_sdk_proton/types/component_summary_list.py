...
ComponentSummaryList: TypeAlias = list[
    "aws_sdk_proton.types.component_summary.ComponentSummary"
]
...
def serialize_aws_json_1_0(value: ComponentSummaryList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_proton.types.component_summary.serialize_aws_json_1_0(item))
    return out
...
def deserialize_aws_json_1_0(data: list) -> ComponentSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_proton.types.component_summary.deserialize_aws_json_1_0(item)
        )
    return out
