...
class ListDeploymentsOutput(TypedDict, closed=True):
    ...
    deployments: "aws_sdk_proton.types.deployment_summary_list.DeploymentSummaryList"
...
def serialize_aws_json_1_0(value: ListDeploymentsOutput) -> dict:
    ...
    out["deployments"] = (
        aws_sdk_proton.types.deployment_summary_list.serialize_aws_json_1_0(
            value["deployments"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ListDeploymentsOutput:
    ...
    if "deployments" in data:
        ...
        out["deployments"] = (
            aws_sdk_proton.types.deployment_summary_list.deserialize_aws_json_1_0(
                data["deployments"]
            )
        )
    else:
