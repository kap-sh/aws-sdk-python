...
if TYPE_CHECKING:
    ...
    import aws_sdk_proton.types.environment_arn
...
class Environment(TypedDict):
    ...
    arn: "aws_sdk_proton.types.environment_arn.EnvironmentArn"
    ...
    environment_account_id: NotRequired[
        "aws_sdk_proton.types.aws_account_id.AwsAccountId"
    ]
    ...
    provisioning_repository: NotRequired[
        "aws_sdk_proton.types.repository_branch.RepositoryBranch"
    ]
    r"""<p>The linked repository that you use to host your rendered infrastructure templates for self-managed provisioning. A linked repository is a repository that has been registered with Proton. For more information, see <a href=\"https://docs.aws.amazon.com/proton/latest/APIReference/API_CreateRepository.html\">CreateRepository</a>.</p>"""
...
def serialize_aws_json_1_0(value: Environment) -> dict:
    ...
    if "provisioning_repository" in value:
        ...
        out["provisioningRepository"] = (
            aws_sdk_proton.types.repository_branch.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Environment:
    ...
    if "provisioningRepository" in data:
        ...
        out["provisioning_repository"] = (
            aws_sdk_proton.types.repository_branch.deserialize_aws_json_1_0(
