...
CompatibleEnvironmentTemplateInputList: TypeAlias = list["aws_sdk_proton.types.compatible_environment_template_input.CompatibleEnvironmentTemplateInput"]
...
def serialize_aws_json_1_0(value: CompatibleEnvironmentTemplateInputList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_proton.types.compatible_environment_template_input.serialize_aws_json_1_0(item))
    return out
...
def deserialize_aws_json_1_0(data: list) -> CompatibleEnvironmentTemplateInputList:
    ...
    for item in data:
        out.append(aws_sdk_proton.types.compatible_environment_template_input.deserialize_aws_json_1_0(item))
    return out