...
class ServiceSyncConfigResource:
    ...
    def put(
        ...
        *,
    ...
    ) -> "aws_sdk_proton.types.create_service_sync_config_output.CreateServiceSyncConfigOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.create_service_sync_config_input.CreateServiceSyncConfigInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.create_service_sync_config_output.CreateServiceSyncConfigOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.create_service_sync_config.create_service_sync_config(
    ...
    def read(
        ...
        *,
        ...
        "aws_sdk_proton.types.get_service_sync_config_output.GetServiceSyncConfigOutput"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.get_service_sync_config_input.GetServiceSyncConfigInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.get_service_sync_config_output.GetServiceSyncConfigOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.get_service_sync_config.get_service_sync_config(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
        config_overrides: Optional[ProtonClientConfig] = None,
    ) -> "aws_sdk_proton.types.update_service_sync_config_output.UpdateServiceSyncConfigOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.update_service_sync_config_input.UpdateServiceSyncConfigInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.update_service_sync_config_output.UpdateServiceSyncConfigOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.update_service_sync_config.update_service_sync_config(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        config_overrides: Optional[ProtonClientConfig] = None,
    ) -> "aws_sdk_proton.types.delete_service_sync_config_output.DeleteServiceSyncConfigOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.delete_service_sync_config_input.DeleteServiceSyncConfigInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.delete_service_sync_config_output.DeleteServiceSyncConfigOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.delete_service_sync_config.delete_service_sync_config(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncServiceSyncConfigResource:
    ...
    async def put(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_proton.types.create_service_sync_config_input.CreateServiceSyncConfigInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_proton.types.create_service_sync_config_output.CreateServiceSyncConfigOutput"
        ]:
            import aws_sdk_proton._operations.aws_proton20200720.create_service_sync_config
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_proton._operations.aws_proton20200720.create_service_sync_config.async_create_service_sync_config(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_proton.types.get_service_sync_config_input.GetServiceSyncConfigInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_proton.types.get_service_sync_config_output.GetServiceSyncConfigOutput"
        ]:
            import aws_sdk_proton._operations.aws_proton20200720.get_service_sync_config
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_proton._operations.aws_proton20200720.get_service_sync_config.async_get_service_sync_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_proton.types.update_service_sync_config_input.UpdateServiceSyncConfigInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_proton.types.update_service_sync_config_output.UpdateServiceSyncConfigOutput"
        ]:
            import aws_sdk_proton._operations.aws_proton20200720.update_service_sync_config
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_proton._operations.aws_proton20200720.update_service_sync_config.async_update_service_sync_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_proton.types.delete_service_sync_config_input.DeleteServiceSyncConfigInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_proton.types.delete_service_sync_config_output.DeleteServiceSyncConfigOutput"
        ]:
            import aws_sdk_proton._operations.aws_proton20200720.delete_service_sync_config
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_proton._operations.aws_proton20200720.delete_service_sync_config.async_delete_service_sync_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
