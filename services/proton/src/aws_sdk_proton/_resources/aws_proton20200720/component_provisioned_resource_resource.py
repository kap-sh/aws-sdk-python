...
class ComponentProvisionedResourceResource:
    ...
    def list(self, component_name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[ProtonClientConfig] = None, next_token: Optional["aws_sdk_proton.types.empty_next_token.EmptyNextToken"] = None) -> "aws_sdk_proton.types.list_component_provisioned_resources_output.ListComponentProvisionedResourcesOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_proton.types.list_component_provisioned_resources_input.ListComponentProvisionedResourcesInput]') -> OperationResponse["aws_sdk_proton.types.list_component_provisioned_resources_output.ListComponentProvisionedResourcesOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.list_component_provisioned_resources
            output, http_response = aws_sdk_proton._operations.aws_proton20200720.list_component_provisioned_resources.list_component_provisioned_resources(req.options, req.input)
            return OperationResponse(output=output, response=http_response)

        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_proton.types.list_component_provisioned_resources_input.ListComponentProvisionedResourcesInput = {}  # type: ignore[typeddict-item]
...
class AsyncComponentProvisionedResourceResource:
    def __init__(self, service: AsyncProtonClient) -> None:
        self._service = service
    async def list(self, component_name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[AsyncProtonClientConfig] = None, next_token: Optional["aws_sdk_proton.types.empty_next_token.EmptyNextToken"] = None) -> "aws_sdk_proton.types.list_component_provisioned_resources_output.ListComponentProvisionedResourcesOutput":
        """<p>List provisioned resources for a component with details.</p> <p>For more information about components, see <a href=\"https://docs.aws.amazon.com/proton/latest/userguide/ag-components.html\">Proton components</a> in the <i>Proton User Guide</i>.</p>
        ...
        Args:
            ...
            next_token: <p>A token that indicates the location of the next provisioned resource in the array of provisioned resources, after the list of provisioned resources that was previously requested.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.list_component_provisioned_resources_input.ListComponentProvisionedResourcesInput]') -> AsyncOperationResponse["aws_sdk_proton.types.list_component_provisioned_resources_output.ListComponentProvisionedResourcesOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.list_component_provisioned_resources
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.list_component_provisioned_resources.async_list_component_provisioned_resources(req.options, req.input)
