...
class ServicePipelineResource:
    ...
    def update(self, service_name: "aws_sdk_proton.types.resource_name.ResourceName", spec: "aws_sdk_proton.types.spec_contents.SpecContents", deployment_type: "aws_sdk_proton.types.deployment_update_type.DeploymentUpdateType", *, config_overrides: Optional[ProtonClientConfig] = None, template_major_version: Optional["aws_sdk_proton.types.template_version_part.TemplateVersionPart"] = None, template_minor_version: Optional["aws_sdk_proton.types.template_version_part.TemplateVersionPart"] = None) -> "aws_sdk_proton.types.update_service_pipeline_output.UpdateServicePipelineOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_proton.types.update_service_pipeline_input.UpdateServicePipelineInput]') -> OperationResponse["aws_sdk_proton.types.update_service_pipeline_output.UpdateServicePipelineOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.update_service_pipeline
            output, http_response = aws_sdk_proton._operations.aws_proton20200720.update_service_pipeline.update_service_pipeline(req.options, req.input)
...
class AsyncServicePipelineResource:
    ...
    async def update(self, service_name: "aws_sdk_proton.types.resource_name.ResourceName", spec: "aws_sdk_proton.types.spec_contents.SpecContents", deployment_type: "aws_sdk_proton.types.deployment_update_type.DeploymentUpdateType", *, config_overrides: Optional[AsyncProtonClientConfig] = None, template_major_version: Optional["aws_sdk_proton.types.template_version_part.TemplateVersionPart"] = None, template_minor_version: Optional["aws_sdk_proton.types.template_version_part.TemplateVersionPart"] = None) -> "aws_sdk_proton.types.update_service_pipeline_output.UpdateServicePipelineOutput":
        ...
        Args:
            ...
            template_minor_version: <p>The minor version of the service template that was used to create the service that the pipeline is associated with.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.update_service_pipeline_input.UpdateServicePipelineInput]') -> AsyncOperationResponse["aws_sdk_proton.types.update_service_pipeline_output.UpdateServicePipelineOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.update_service_pipeline
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.update_service_pipeline.async_update_service_pipeline(req.options, req.input)
