...
class ServicePipelineOutputResource:
    ...
    def list(self, service_name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[ProtonClientConfig] = None, next_token: Optional["aws_sdk_proton.types.empty_next_token.EmptyNextToken"] = None, deployment_id: Optional["aws_sdk_proton.types.deployment_id.DeploymentId"] = None) -> "aws_sdk_proton.types.list_service_pipeline_outputs_output.ListServicePipelineOutputsOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_proton.types.list_service_pipeline_outputs_input.ListServicePipelineOutputsInput]') -> OperationResponse["aws_sdk_proton.types.list_service_pipeline_outputs_output.ListServicePipelineOutputsOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.list_service_pipeline_outputs
            output, http_response = aws_sdk_proton._operations.aws_proton20200720.list_service_pipeline_outputs.list_service_pipeline_outputs(req.options, req.input)
...
class AsyncServicePipelineOutputResource:
    def __init__(self, service: AsyncProtonClient) -> None:
        self._service = service
    async def list(self, service_name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[AsyncProtonClientConfig] = None, next_token: Optional["aws_sdk_proton.types.empty_next_token.EmptyNextToken"] = None, deployment_id: Optional["aws_sdk_proton.types.deployment_id.DeploymentId"] = None) -> "aws_sdk_proton.types.list_service_pipeline_outputs_output.ListServicePipelineOutputsOutput":
        """<p>Get a list of service pipeline Infrastructure as Code (IaC) outputs.</p>
        ...
        Args:
            ...
            deployment_id: <p>The ID of the deployment you want the outputs for.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.list_service_pipeline_outputs_input.ListServicePipelineOutputsInput]') -> AsyncOperationResponse["aws_sdk_proton.types.list_service_pipeline_outputs_output.ListServicePipelineOutputsOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.list_service_pipeline_outputs
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.list_service_pipeline_outputs.async_list_service_pipeline_outputs(req.options, req.input)
