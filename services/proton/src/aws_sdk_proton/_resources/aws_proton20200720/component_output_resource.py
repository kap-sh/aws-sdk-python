...
class ComponentOutputResource:
    ...
    def list(self, component_name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[ProtonClientConfig] = None, next_token: Optional["aws_sdk_proton.types.empty_next_token.EmptyNextToken"] = None, deployment_id: Optional["aws_sdk_proton.types.deployment_id.DeploymentId"] = None) -> "aws_sdk_proton.types.list_component_outputs_output.ListComponentOutputsOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_proton.types.list_component_outputs_input.ListComponentOutputsInput]') -> OperationResponse["aws_sdk_proton.types.list_component_outputs_output.ListComponentOutputsOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.list_component_outputs
            output, http_response = aws_sdk_proton._operations.aws_proton20200720.list_component_outputs.list_component_outputs(req.options, req.input)
            return OperationResponse(output=output, response=http_response)

        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_proton.types.list_component_outputs_input.ListComponentOutputsInput = {}  # type: ignore[typeddict-item]
...
class AsyncComponentOutputResource:
    def __init__(self, service: AsyncProtonClient) -> None:
        self._service = service
    async def list(self, component_name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[AsyncProtonClientConfig] = None, next_token: Optional["aws_sdk_proton.types.empty_next_token.EmptyNextToken"] = None, deployment_id: Optional["aws_sdk_proton.types.deployment_id.DeploymentId"] = None) -> "aws_sdk_proton.types.list_component_outputs_output.ListComponentOutputsOutput":
        """<p>Get a list of component Infrastructure as Code (IaC) outputs.</p> <p>For more information about components, see <a href=\"https://docs.aws.amazon.com/proton/latest/userguide/ag-components.html\">Proton components</a> in the <i>Proton User Guide</i>.</p>
        ...
        Args:
            ...
            deployment_id: <p>The ID of the deployment whose outputs you want.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.list_component_outputs_input.ListComponentOutputsInput]') -> AsyncOperationResponse["aws_sdk_proton.types.list_component_outputs_output.ListComponentOutputsOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.list_component_outputs
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.list_component_outputs.async_list_component_outputs(req.options, req.input)
