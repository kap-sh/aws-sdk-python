...
class EnvironmentTemplateResource:
    ...
    def put(self, name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[ProtonClientConfig] = None, display_name: Optional["aws_sdk_proton.types.display_name.DisplayName"] = None, description: Optional["aws_sdk_proton.types.description.Description"] = None, encryption_key: Optional["aws_sdk_proton.types.arn.Arn"] = None, provisioning: Optional["aws_sdk_proton.types.provisioning.Provisioning"] = None, tags: Optional["aws_sdk_proton.types.tag_list.TagList"] = None) -> "aws_sdk_proton.types.create_environment_template_output.CreateEnvironmentTemplateOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_proton.types.create_environment_template_input.CreateEnvironmentTemplateInput]') -> OperationResponse["aws_sdk_proton.types.create_environment_template_output.CreateEnvironmentTemplateOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.create_environment_template
            output, http_response = aws_sdk_proton._operations.aws_proton20200720.create_environment_template.create_environment_template(req.options, req.input)
    ...
    def read(self, name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[ProtonClientConfig] = None) -> "aws_sdk_proton.types.get_environment_template_output.GetEnvironmentTemplateOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_proton.types.get_environment_template_input.GetEnvironmentTemplateInput]') -> OperationResponse["aws_sdk_proton.types.get_environment_template_output.GetEnvironmentTemplateOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.get_environment_template
            output, http_response = aws_sdk_proton._operations.aws_proton20200720.get_environment_template.get_environment_template(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def update(self, name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[ProtonClientConfig] = None, display_name: Optional["aws_sdk_proton.types.display_name.DisplayName"] = None, description: Optional["aws_sdk_proton.types.description.Description"] = None) -> "aws_sdk_proton.types.update_environment_template_output.UpdateEnvironmentTemplateOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_proton.types.update_environment_template_input.UpdateEnvironmentTemplateInput]') -> OperationResponse["aws_sdk_proton.types.update_environment_template_output.UpdateEnvironmentTemplateOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.update_environment_template
            output, http_response = aws_sdk_proton._operations.aws_proton20200720.update_environment_template.update_environment_template(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete(self, name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[ProtonClientConfig] = None) -> "aws_sdk_proton.types.delete_environment_template_output.DeleteEnvironmentTemplateOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_proton.types.delete_environment_template_input.DeleteEnvironmentTemplateInput]') -> OperationResponse["aws_sdk_proton.types.delete_environment_template_output.DeleteEnvironmentTemplateOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.delete_environment_template
            output, http_response = aws_sdk_proton._operations.aws_proton20200720.delete_environment_template.delete_environment_template(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def list(self, *, config_overrides: Optional[ProtonClientConfig] = None, next_token: Optional["aws_sdk_proton.types.next_token.NextToken"] = None, max_results: Optional["aws_sdk_proton.types.max_page_results.MaxPageResults"] = None) -> "aws_sdk_proton.types.list_environment_templates_output.ListEnvironmentTemplatesOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_proton.types.list_environment_templates_input.ListEnvironmentTemplatesInput]') -> OperationResponse["aws_sdk_proton.types.list_environment_templates_output.ListEnvironmentTemplatesOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.list_environment_templates
            output, http_response = aws_sdk_proton._operations.aws_proton20200720.list_environment_templates.list_environment_templates(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
...
class AsyncEnvironmentTemplateResource:
    ...
    async def put(self, name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[AsyncProtonClientConfig] = None, display_name: Optional["aws_sdk_proton.types.display_name.DisplayName"] = None, description: Optional["aws_sdk_proton.types.description.Description"] = None, encryption_key: Optional["aws_sdk_proton.types.arn.Arn"] = None, provisioning: Optional["aws_sdk_proton.types.provisioning.Provisioning"] = None, tags: Optional["aws_sdk_proton.types.tag_list.TagList"] = None) -> "aws_sdk_proton.types.create_environment_template_output.CreateEnvironmentTemplateOutput":
        ...
        Args:
            ...
            tags: <p>An optional list of metadata items that you can associate with the Proton environment template. A tag is a key-value pair.</p> <p>For more information, see <a href=\"https://docs.aws.amazon.com/proton/latest/userguide/resources.html\">Proton resources and tagging</a> in the <i>Proton User Guide</i>.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.create_environment_template_input.CreateEnvironmentTemplateInput]') -> AsyncOperationResponse["aws_sdk_proton.types.create_environment_template_output.CreateEnvironmentTemplateOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.create_environment_template
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.create_environment_template.async_create_environment_template(req.options, req.input)
        ...
        return response.output
    async def read(self, name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[AsyncProtonClientConfig] = None) -> "aws_sdk_proton.types.get_environment_template_output.GetEnvironmentTemplateOutput":
        """<p>Get detailed data for an environment template.</p>

        Args:
            name: <p>The name of the environment template that you want to get the detailed data for.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.get_environment_template_input.GetEnvironmentTemplateInput]') -> AsyncOperationResponse["aws_sdk_proton.types.get_environment_template_output.GetEnvironmentTemplateOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.get_environment_template
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.get_environment_template.async_get_environment_template(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(self, name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[AsyncProtonClientConfig] = None, display_name: Optional["aws_sdk_proton.types.display_name.DisplayName"] = None, description: Optional["aws_sdk_proton.types.description.Description"] = None) -> "aws_sdk_proton.types.update_environment_template_output.UpdateEnvironmentTemplateOutput":
        ...
        Args:
            ...
            description: <p>A description of the environment template update.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.update_environment_template_input.UpdateEnvironmentTemplateInput]') -> AsyncOperationResponse["aws_sdk_proton.types.update_environment_template_output.UpdateEnvironmentTemplateOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.update_environment_template
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.update_environment_template.async_update_environment_template(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete(self, name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[AsyncProtonClientConfig] = None) -> "aws_sdk_proton.types.delete_environment_template_output.DeleteEnvironmentTemplateOutput":
        """<p>If no other major or minor versions of an environment template exist, delete the environment template.</p>

        Args:
            name: <p>The name of the environment template to delete.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.delete_environment_template_input.DeleteEnvironmentTemplateInput]') -> AsyncOperationResponse["aws_sdk_proton.types.delete_environment_template_output.DeleteEnvironmentTemplateOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.delete_environment_template
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.delete_environment_template.async_delete_environment_template(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(self, *, config_overrides: Optional[AsyncProtonClientConfig] = None, next_token: Optional["aws_sdk_proton.types.next_token.NextToken"] = None, max_results: Optional["aws_sdk_proton.types.max_page_results.MaxPageResults"] = None) -> "aws_sdk_proton.types.list_environment_templates_output.ListEnvironmentTemplatesOutput":
        ...
        Args:
            ...
            max_results: <p>The maximum number of environment templates to list.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.list_environment_templates_input.ListEnvironmentTemplatesInput]') -> AsyncOperationResponse["aws_sdk_proton.types.list_environment_templates_output.ListEnvironmentTemplatesOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.list_environment_templates
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.list_environment_templates.async_list_environment_templates(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
