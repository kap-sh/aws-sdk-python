...
from aws_sdk_proton._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_proton._async import anysleep
import time
...
class AsyncProtonClient:
    ...
    def __init__(self, http_handler: AsyncBaseHandler | None = None, operation_interceptors: Iterable[AsyncInterceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, region: str | None = None, use_dual_stack: bool | None = None, use_fips: bool | None = None, endpoint: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = AsyncProtonClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "region": region, "use_dual_stack": use_dual_stack, "use_fips": use_fips, "endpoint": endpoint, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[AsyncProtonClientConfig] = None) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
    ...
    async def cancel_component_deployment(self, component_name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[AsyncProtonClientConfig] = None) -> "aws_sdk_proton.types.cancel_component_deployment_output.CancelComponentDeploymentOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.cancel_component_deployment_input.CancelComponentDeploymentInput]') -> AsyncOperationResponse["aws_sdk_proton.types.cancel_component_deployment_output.CancelComponentDeploymentOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.cancel_component_deployment
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.cancel_component_deployment.async_cancel_component_deployment(req.options, req.input)
    ...
    async def cancel_environment_deployment(self, environment_name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[AsyncProtonClientConfig] = None) -> "aws_sdk_proton.types.cancel_environment_deployment_output.CancelEnvironmentDeploymentOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.cancel_environment_deployment_input.CancelEnvironmentDeploymentInput]') -> AsyncOperationResponse["aws_sdk_proton.types.cancel_environment_deployment_output.CancelEnvironmentDeploymentOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.cancel_environment_deployment
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.cancel_environment_deployment.async_cancel_environment_deployment(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_service_instance_deployment(self, service_instance_name: "aws_sdk_proton.types.resource_name.ResourceName", service_name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[AsyncProtonClientConfig] = None) -> "aws_sdk_proton.types.cancel_service_instance_deployment_output.CancelServiceInstanceDeploymentOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.cancel_service_instance_deployment_input.CancelServiceInstanceDeploymentInput]') -> AsyncOperationResponse["aws_sdk_proton.types.cancel_service_instance_deployment_output.CancelServiceInstanceDeploymentOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.cancel_service_instance_deployment
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.cancel_service_instance_deployment.async_cancel_service_instance_deployment(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def cancel_service_pipeline_deployment(self, service_name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[AsyncProtonClientConfig] = None) -> "aws_sdk_proton.types.cancel_service_pipeline_deployment_output.CancelServicePipelineDeploymentOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.cancel_service_pipeline_deployment_input.CancelServicePipelineDeploymentInput]') -> AsyncOperationResponse["aws_sdk_proton.types.cancel_service_pipeline_deployment_output.CancelServicePipelineDeploymentOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.cancel_service_pipeline_deployment
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.cancel_service_pipeline_deployment.async_cancel_service_pipeline_deployment(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_repository_sync_status(self, repository_name: "aws_sdk_proton.types.repository_name.RepositoryName", repository_provider: "aws_sdk_proton.types.repository_provider.RepositoryProvider", branch: "aws_sdk_proton.types.git_branch_name.GitBranchName", sync_type: "aws_sdk_proton.types.sync_type.SyncType", *, config_overrides: Optional[AsyncProtonClientConfig] = None) -> "aws_sdk_proton.types.get_repository_sync_status_output.GetRepositorySyncStatusOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.get_repository_sync_status_input.GetRepositorySyncStatusInput]') -> AsyncOperationResponse["aws_sdk_proton.types.get_repository_sync_status_output.GetRepositorySyncStatusOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.get_repository_sync_status
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.get_repository_sync_status.async_get_repository_sync_status(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_resources_summary(self, *, config_overrides: Optional[AsyncProtonClientConfig] = None) -> "aws_sdk_proton.types.get_resources_summary_output.GetResourcesSummaryOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.get_resources_summary_input.GetResourcesSummaryInput]') -> AsyncOperationResponse["aws_sdk_proton.types.get_resources_summary_output.GetResourcesSummaryOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.get_resources_summary
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.get_resources_summary.async_get_resources_summary(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_service_instance_sync_status(self, service_name: "aws_sdk_proton.types.resource_name.ResourceName", service_instance_name: "aws_sdk_proton.types.resource_name.ResourceName", *, config_overrides: Optional[AsyncProtonClientConfig] = None) -> "aws_sdk_proton.types.get_service_instance_sync_status_output.GetServiceInstanceSyncStatusOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.get_service_instance_sync_status_input.GetServiceInstanceSyncStatusInput]') -> AsyncOperationResponse["aws_sdk_proton.types.get_service_instance_sync_status_output.GetServiceInstanceSyncStatusOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.get_service_instance_sync_status
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.get_service_instance_sync_status.async_get_service_instance_sync_status(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_template_sync_status(self, template_name: "aws_sdk_proton.types.resource_name.ResourceName", template_type: "aws_sdk_proton.types.template_type.TemplateType", template_version: "aws_sdk_proton.types.template_version_part.TemplateVersionPart", *, config_overrides: Optional[AsyncProtonClientConfig] = None) -> "aws_sdk_proton.types.get_template_sync_status_output.GetTemplateSyncStatusOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.get_template_sync_status_input.GetTemplateSyncStatusInput]') -> AsyncOperationResponse["aws_sdk_proton.types.get_template_sync_status_output.GetTemplateSyncStatusOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.get_template_sync_status
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.get_template_sync_status.async_get_template_sync_status(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def list_repository_sync_definitions(self, repository_name: "aws_sdk_proton.types.repository_name.RepositoryName", repository_provider: "aws_sdk_proton.types.repository_provider.RepositoryProvider", sync_type: "aws_sdk_proton.types.sync_type.SyncType", *, config_overrides: Optional[AsyncProtonClientConfig] = None, next_token: Optional["aws_sdk_proton.types.empty_next_token.EmptyNextToken"] = None) -> "aws_sdk_proton.types.list_repository_sync_definitions_output.ListRepositorySyncDefinitionsOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.list_repository_sync_definitions_input.ListRepositorySyncDefinitionsInput]') -> AsyncOperationResponse["aws_sdk_proton.types.list_repository_sync_definitions_output.ListRepositorySyncDefinitionsOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.list_repository_sync_definitions
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.list_repository_sync_definitions.async_list_repository_sync_definitions(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_repository_sync_definitions(self, repository_name: "aws_sdk_proton.types.repository_name.RepositoryName", repository_provider: "aws_sdk_proton.types.repository_provider.RepositoryProvider", sync_type: "aws_sdk_proton.types.sync_type.SyncType", *, config_overrides: Optional[AsyncProtonClientConfig] = None, next_token: Optional["aws_sdk_proton.types.empty_next_token.EmptyNextToken"] = None) -> "AsyncIterator[aws_sdk_proton.types.repository_sync_definition.RepositorySyncDefinition]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    async def list_tags_for_resource(self, resource_arn: "aws_sdk_proton.types.arn.Arn", *, config_overrides: Optional[AsyncProtonClientConfig] = None, next_token: Optional[str] = None, max_results: Optional["aws_sdk_proton.types.max_page_results.MaxPageResults"] = None) -> "aws_sdk_proton.types.list_tags_for_resource_output.ListTagsForResourceOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.list_tags_for_resource_input.ListTagsForResourceInput]') -> AsyncOperationResponse["aws_sdk_proton.types.list_tags_for_resource_output.ListTagsForResourceOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.list_tags_for_resource
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.list_tags_for_resource.async_list_tags_for_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_tags_for_resource(self, resource_arn: "aws_sdk_proton.types.arn.Arn", *, config_overrides: Optional[AsyncProtonClientConfig] = None, next_token: Optional[str] = None, max_results: Optional["aws_sdk_proton.types.max_page_results.MaxPageResults"] = None) -> "AsyncIterator[aws_sdk_proton.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    async def notify_resource_deployment_status_change(self, resource_arn: "aws_sdk_proton.types.arn.Arn", *, config_overrides: Optional[AsyncProtonClientConfig] = None, status: Optional["aws_sdk_proton.types.resource_deployment_status.ResourceDeploymentStatus"] = None, outputs: Optional["aws_sdk_proton.types.outputs_list.OutputsList"] = None, deployment_id: Optional["aws_sdk_proton.types.deployment_id.DeploymentId"] = None, status_message: Optional["aws_sdk_proton.types.status_message.StatusMessage"] = None) -> "aws_sdk_proton.types.notify_resource_deployment_status_change_output.NotifyResourceDeploymentStatusChangeOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.notify_resource_deployment_status_change_input.NotifyResourceDeploymentStatusChangeInput]') -> AsyncOperationResponse["aws_sdk_proton.types.notify_resource_deployment_status_change_output.NotifyResourceDeploymentStatusChangeOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.notify_resource_deployment_status_change
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.notify_resource_deployment_status_change.async_notify_resource_deployment_status_change(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def tag_resource(self, resource_arn: "aws_sdk_proton.types.arn.Arn", tags: "aws_sdk_proton.types.tag_list.TagList", *, config_overrides: Optional[AsyncProtonClientConfig] = None) -> "aws_sdk_proton.types.tag_resource_output.TagResourceOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.tag_resource_input.TagResourceInput]') -> AsyncOperationResponse["aws_sdk_proton.types.tag_resource_output.TagResourceOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.tag_resource
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.tag_resource.async_tag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_resource(self, resource_arn: "aws_sdk_proton.types.arn.Arn", tag_keys: "aws_sdk_proton.types.tag_key_list.TagKeyList", *, config_overrides: Optional[AsyncProtonClientConfig] = None) -> "aws_sdk_proton.types.untag_resource_output.UntagResourceOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_proton.types.untag_resource_input.UntagResourceInput]') -> AsyncOperationResponse["aws_sdk_proton.types.untag_resource_output.UntagResourceOutput"]:
            import aws_sdk_proton._operations.aws_proton20200720.untag_resource
            output, http_response = await aws_sdk_proton._operations.aws_proton20200720.untag_resource.async_untag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
