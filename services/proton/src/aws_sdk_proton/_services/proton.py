...
from aws_sdk_proton._services._aws_config import aws_config
...
class ProtonClient:
    ...
    def cancel_component_deployment(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.cancel_component_deployment_input.CancelComponentDeploymentInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.cancel_component_deployment_output.CancelComponentDeploymentOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.cancel_component_deployment.cancel_component_deployment(
    ...
    def cancel_environment_deployment(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.cancel_environment_deployment_input.CancelEnvironmentDeploymentInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.cancel_environment_deployment_output.CancelEnvironmentDeploymentOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.cancel_environment_deployment.cancel_environment_deployment(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def cancel_service_instance_deployment(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.cancel_service_instance_deployment_input.CancelServiceInstanceDeploymentInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.cancel_service_instance_deployment_output.CancelServiceInstanceDeploymentOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.cancel_service_instance_deployment.cancel_service_instance_deployment(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def cancel_service_pipeline_deployment(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.cancel_service_pipeline_deployment_input.CancelServicePipelineDeploymentInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.cancel_service_pipeline_deployment_output.CancelServicePipelineDeploymentOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.cancel_service_pipeline_deployment.cancel_service_pipeline_deployment(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_repository_sync_status(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.get_repository_sync_status_input.GetRepositorySyncStatusInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.get_repository_sync_status_output.GetRepositorySyncStatusOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.get_repository_sync_status.get_repository_sync_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resources_summary(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.get_resources_summary_input.GetResourcesSummaryInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.get_resources_summary_output.GetResourcesSummaryOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.get_resources_summary.get_resources_summary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_service_instance_sync_status(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.get_service_instance_sync_status_input.GetServiceInstanceSyncStatusInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.get_service_instance_sync_status_output.GetServiceInstanceSyncStatusOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.get_service_instance_sync_status.get_service_instance_sync_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_template_sync_status(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.get_template_sync_status_input.GetTemplateSyncStatusInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.get_template_sync_status_output.GetTemplateSyncStatusOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.get_template_sync_status.get_template_sync_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_repository_sync_definitions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.list_repository_sync_definitions_input.ListRepositorySyncDefinitionsInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.list_repository_sync_definitions_output.ListRepositorySyncDefinitionsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.list_repository_sync_definitions.list_repository_sync_definitions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_proton.types.repository_sync_definition.RepositorySyncDefinition]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_proton.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    def notify_resource_deployment_status_change(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.notify_resource_deployment_status_change_input.NotifyResourceDeploymentStatusChangeInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.notify_resource_deployment_status_change_output.NotifyResourceDeploymentStatusChangeOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.notify_resource_deployment_status_change.notify_resource_deployment_status_change(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_proton.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_proton.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_proton._operations.aws_proton20200720.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
