...
class ProtonError(Exception):
    """Base class for all Proton service errors."""


class ServiceError(ProtonError):
...
class SerializationError(ProtonError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ProtonError):
...
class WaiterFailedError(ProtonError):
...
class WaiterTimeoutError(ProtonError):
