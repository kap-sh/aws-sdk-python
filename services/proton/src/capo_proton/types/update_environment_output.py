"""Generated from Smithy shape ``com.amazonaws.proton#UpdateEnvironmentOutput``."""
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: UpdateEnvironmentOutput) -> dict:
    out: dict = {}
    import capo_proton.types.environment
...
def deserialize_aws_json_1_0(data: dict) -> UpdateEnvironmentOutput:
    ...
    if "environment" in data:
        ...
        raise DeserializationError("UpdateEnvironmentOutput.environment required")
    return out
