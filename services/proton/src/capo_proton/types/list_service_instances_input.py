...
class ListServiceInstancesInput(TypedDict, closed=True):
    ...
    sort_order: NotRequired["capo_proton.types.sort_order.SortOrder"]
...
def serialize_aws_json_1_0(value: ListServiceInstancesInput) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            capo_proton.types.list_service_instances_filter_list.serialize_aws_json_1_0(
                value["filters"]
            )
        )
    if "sort_by" in value:
...
def deserialize_aws_json_1_0(data: dict) -> ListServiceInstancesInput:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            capo_proton.types.list_service_instances_filter_list.deserialize_aws_json_1_0(
                data["filters"]
            )
        )
    if "sortBy" in data:
