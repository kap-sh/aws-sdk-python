"""Generated from Smithy shape ``com.amazonaws.proton#RejectEnvironmentAccountConnectionOutput``."""
...
class RejectEnvironmentAccountConnectionOutput(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: RejectEnvironmentAccountConnectionOutput) -> dict:
    out: dict = {}
    import capo_proton.types.environment_account_connection
...
def deserialize_aws_json_1_0(data: dict) -> RejectEnvironmentAccountConnectionOutput:
    out: RejectEnvironmentAccountConnectionOutput = {}  # type: ignore[typeddict-item]
    if "environmentAccountConnection" in data:
        ...
        raise DeserializationError(
            "RejectEnvironmentAccountConnectionOutput.environment_account_connection required"
        )
    return out
