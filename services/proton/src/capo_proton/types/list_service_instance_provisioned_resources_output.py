"""Generated from Smithy shape ``com.amazonaws.proton#ListServiceInstanceProvisionedResourcesOutput``."""
...
class ListServiceInstanceProvisionedResourcesOutput(TypedDict, closed=True):
...
def serialize_aws_json_1_0(
    value: ListServiceInstanceProvisionedResourcesOutput,
) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(
    ...
    out: ListServiceInstanceProvisionedResourcesOutput = {}  # type: ignore[typeddict-item]
    ...
    if "provisionedResources" in data:
        ...
        raise DeserializationError(
            "ListServiceInstanceProvisionedResourcesOutput.provisioned_resources required"
        )
    return out
