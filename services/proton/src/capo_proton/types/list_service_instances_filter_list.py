...
if TYPE_CHECKING:
    import capo_proton.types.list_service_instances_filter

ListServiceInstancesFilterList: TypeAlias = list[
    "capo_proton.types.list_service_instances_filter.ListServiceInstancesFilter"
]
...
def serialize_aws_json_1_0(value: ListServiceInstancesFilterList) -> list:
    ...
    for item in value:
        out.append(
            capo_proton.types.list_service_instances_filter.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ListServiceInstancesFilterList:
    ...
    for item in data:
        out.append(
            capo_proton.types.list_service_instances_filter.deserialize_aws_json_1_0(
                item
            )
        )
    return out
