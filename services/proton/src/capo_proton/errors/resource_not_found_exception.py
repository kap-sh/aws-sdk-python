"""Generated from Smithy shape ``com.amazonaws.proton#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.proton#ResourceNotFoundException``."""
