"""Generated from Smithy shape ``com.amazonaws.cloudsearch#LiteralOptions``."""
...
class LiteralOptions(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: LiteralOptions, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> LiteralOptions:
    out: LiteralOptions = {}  # type: ignore[typeddict-item]
