...
if TYPE_CHECKING:
    import capo_cloudsearch.types.availability_options_status


class UpdateAvailabilityOptionsResponse(TypedDict, closed=True):
    availability_options: NotRequired[
        "capo_cloudsearch.types.availability_options_status.AvailabilityOptionsStatus"
    ]
...
def serialize_query(
    ...
    if "availability_options" in value:
        ...
        capo_cloudsearch.types.availability_options_status.serialize_query(
            value["availability_options"], pairs, f"{key_prefix}AvailabilityOptions"
        )
...
def deserialize_query(el: Element) -> UpdateAvailabilityOptionsResponse:
    ...
    if child_availability_options is not None:
        ...
        out["availability_options"] = (
            capo_cloudsearch.types.availability_options_status.deserialize_query(
