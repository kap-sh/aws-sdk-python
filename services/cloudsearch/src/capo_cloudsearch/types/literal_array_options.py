"""Generated from Smithy shape ``com.amazonaws.cloudsearch#LiteralArrayOptions``."""
...
class LiteralArrayOptions(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: LiteralArrayOptions, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> LiteralArrayOptions:
    out: LiteralArrayOptions = {}  # type: ignore[typeddict-item]
