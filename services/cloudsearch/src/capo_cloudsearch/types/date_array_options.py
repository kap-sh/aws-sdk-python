...
# --- awsQuery ser/de ---
def serialize_query(
    value: DateArrayOptions, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DateArrayOptions:
    out: DateArrayOptions = {}  # type: ignore[typeddict-item]
