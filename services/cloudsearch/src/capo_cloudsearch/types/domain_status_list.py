...
DomainStatusList: TypeAlias = list["capo_cloudsearch.types.domain_status.DomainStatus"]
...
def deserialize_query(el: Element) -> DomainStatusList:
    ...
    for child in el.findall("member"):
        out.append(capo_cloudsearch.types.domain_status.deserialize_query(child))
    return out
