"""Generated from Smithy shape ``com.amazonaws.cloudsearch#DateOptions``."""
...
class DateOptions(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> DateOptions:
    out: DateOptions = {}  # type: ignore[typeddict-item]
