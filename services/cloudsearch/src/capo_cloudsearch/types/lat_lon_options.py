"""Generated from Smithy shape ``com.amazonaws.cloudsearch#LatLonOptions``."""
...
class LatLonOptions(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: LatLonOptions, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> LatLonOptions:
    out: LatLonOptions = {}  # type: ignore[typeddict-item]
