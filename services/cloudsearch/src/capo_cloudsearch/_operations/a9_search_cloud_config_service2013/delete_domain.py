...
def handle_response(
    ...
    out: capo_cloudsearch.types.delete_domain_response.DeleteDomainResponse = (
        capo_cloudsearch.types.delete_domain_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.delete_domain_request.serialize_query(input_, pairs, "")
...
def delete_domain(
    ...
    capo_cloudsearch.types.delete_domain_response.DeleteDomainResponse, zapros.Response
]:
