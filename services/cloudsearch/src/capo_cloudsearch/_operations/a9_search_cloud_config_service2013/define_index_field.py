...
def handle_response(
    ...
    out: capo_cloudsearch.types.define_index_field_response.DefineIndexFieldResponse = (
        capo_cloudsearch.types.define_index_field_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.define_index_field_request.serialize_query(input_, pairs, "")
