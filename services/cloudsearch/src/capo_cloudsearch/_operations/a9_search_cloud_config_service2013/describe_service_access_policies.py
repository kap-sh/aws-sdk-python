...
def handle_response(
    ...
    out: capo_cloudsearch.types.describe_service_access_policies_response.DescribeServiceAccessPoliciesResponse = capo_cloudsearch.types.describe_service_access_policies_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.describe_service_access_policies_request.serialize_query(
        input_, pairs, ""
    )
