...
def handle_response(
    ...
    out: capo_cloudsearch.types.define_expression_response.DefineExpressionResponse = (
        capo_cloudsearch.types.define_expression_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.define_expression_request.serialize_query(input_, pairs, "")
