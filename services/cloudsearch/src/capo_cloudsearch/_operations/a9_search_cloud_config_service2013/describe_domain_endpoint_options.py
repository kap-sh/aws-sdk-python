"""Generated from Smithy shape ``com.amazonaws.cloudsearch#DescribeDomainEndpointOptions``."""
...
import capo_cloudsearch.errors.disabled_operation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DisabledOperationException":
            raise capo_cloudsearch.errors.disabled_operation_exception.DisabledOperationException.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeDomainEndpointOptionsResult")
    out: capo_cloudsearch.types.describe_domain_endpoint_options_response.DescribeDomainEndpointOptionsResponse = capo_cloudsearch.types.describe_domain_endpoint_options_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeDomainEndpointOptions"))
    pairs.append(("Version", "2013-01-01"))
    capo_cloudsearch.types.describe_domain_endpoint_options_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_domain_endpoint_options(
