...
def handle_response(
    ...
    out: capo_cloudsearch.types.update_scaling_parameters_response.UpdateScalingParametersResponse = capo_cloudsearch.types.update_scaling_parameters_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.update_scaling_parameters_request.serialize_query(
        input_, pairs, ""
    )
