"""Generated from Smithy shape ``com.amazonaws.cloudsearch#DescribeIndexFields``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeIndexFieldsResult")
    out: capo_cloudsearch.types.describe_index_fields_response.DescribeIndexFieldsResponse = capo_cloudsearch.types.describe_index_fields_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeIndexFields"))
    pairs.append(("Version", "2013-01-01"))
    capo_cloudsearch.types.describe_index_fields_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_index_fields(
