...
def handle_response(
    ...
    out: capo_cloudsearch.types.delete_analysis_scheme_response.DeleteAnalysisSchemeResponse = capo_cloudsearch.types.delete_analysis_scheme_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.delete_analysis_scheme_request.serialize_query(
        input_, pairs, ""
    )
