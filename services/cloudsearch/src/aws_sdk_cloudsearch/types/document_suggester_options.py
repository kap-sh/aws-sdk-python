...
class DocumentSuggesterOptions(TypedDict):
    ...
    fuzzy_matching: NotRequired[
        "aws_sdk_cloudsearch.types.suggester_fuzzy_matching.SuggesterFuzzyMatching"
    ]
    ...
    sort_expression: NotRequired["aws_sdk_cloudsearch.types.string.String"]
...
def serialize_query(
    ...
    if "fuzzy_matching" in value:
        ...
        aws_sdk_cloudsearch.types.suggester_fuzzy_matching.serialize_query(
...
def deserialize_query(el: Element) -> DocumentSuggesterOptions:
    ...
    if child_fuzzy_matching is not None:
        ...
        out["fuzzy_matching"] = (
            aws_sdk_cloudsearch.types.suggester_fuzzy_matching.deserialize_query(
