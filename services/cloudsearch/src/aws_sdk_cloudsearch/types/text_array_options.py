...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudsearch.types.word


class TextArrayOptions(TypedDict):
    ...
    highlight_enabled: NotRequired["aws_sdk_cloudsearch.types.boolean.Boolean"]
    """<p>Whether highlights can be returned for the field.</p>"""
    analysis_scheme: NotRequired["aws_sdk_cloudsearch.types.word.Word"]
