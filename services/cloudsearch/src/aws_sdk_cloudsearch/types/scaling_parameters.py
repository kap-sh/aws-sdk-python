...
def serialize_query(
    ...
    if "desired_instance_type" in value:
        ...
        aws_sdk_cloudsearch.types.partition_instance_type.serialize_query(
...
def deserialize_query(el: Element) -> ScalingParameters:
    ...
    if child_desired_instance_type is not None:
        ...
        out["desired_instance_type"] = (
            aws_sdk_cloudsearch.types.partition_instance_type.deserialize_query(
