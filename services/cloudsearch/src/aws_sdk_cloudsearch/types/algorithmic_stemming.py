"""Generated from Smithy shape ``com.amazonaws.cloudsearch#AlgorithmicStemming``."""
...
def serialize_query(
    value: AlgorithmicStemming, pairs: list[tuple[str, str]], prefix: str
) -> None:
    pairs.append((prefix, to_query_text(value)))


def deserialize_query(el: Element) -> AlgorithmicStemming:
