...
if TYPE_CHECKING:
    import aws_sdk_cloudsearch.types.date_array_options
    import aws_sdk_cloudsearch.types.date_options
    import aws_sdk_cloudsearch.types.double_array_options
    import aws_sdk_cloudsearch.types.double_options
    import aws_sdk_cloudsearch.types.dynamic_field_name
    import aws_sdk_cloudsearch.types.index_field_type
    import aws_sdk_cloudsearch.types.int_array_options
    import aws_sdk_cloudsearch.types.int_options
    import aws_sdk_cloudsearch.types.lat_lon_options
    import aws_sdk_cloudsearch.types.literal_array_options
    import aws_sdk_cloudsearch.types.literal_options
    import aws_sdk_cloudsearch.types.text_array_options
    import aws_sdk_cloudsearch.types.text_options


class IndexField(TypedDict):
    ...
    index_field_type: "aws_sdk_cloudsearch.types.index_field_type.IndexFieldType"
    int_options: NotRequired["aws_sdk_cloudsearch.types.int_options.IntOptions"]
    double_options: NotRequired[
        "aws_sdk_cloudsearch.types.double_options.DoubleOptions"
    ]
    literal_options: NotRequired[
        "aws_sdk_cloudsearch.types.literal_options.LiteralOptions"
    ]
    text_options: NotRequired["aws_sdk_cloudsearch.types.text_options.TextOptions"]
    date_options: NotRequired["aws_sdk_cloudsearch.types.date_options.DateOptions"]
    lat_lon_options: NotRequired[
        "aws_sdk_cloudsearch.types.lat_lon_options.LatLonOptions"
    ]
    int_array_options: NotRequired[
        "aws_sdk_cloudsearch.types.int_array_options.IntArrayOptions"
    ]
    double_array_options: NotRequired[
        "aws_sdk_cloudsearch.types.double_array_options.DoubleArrayOptions"
    ]
    literal_array_options: NotRequired[
        "aws_sdk_cloudsearch.types.literal_array_options.LiteralArrayOptions"
    ]
    text_array_options: NotRequired[
        "aws_sdk_cloudsearch.types.text_array_options.TextArrayOptions"
    ]
    date_array_options: NotRequired[
        "aws_sdk_cloudsearch.types.date_array_options.DateArrayOptions"
    ]
...
def deserialize_query(el: Element) -> IndexField:
    ...
    if child_index_field_type is not None:
        ...
        out["index_field_type"] = (
            aws_sdk_cloudsearch.types.index_field_type.deserialize_query(
    ...
    if child_int_options is not None:
        ...
        out["int_options"] = aws_sdk_cloudsearch.types.int_options.deserialize_query(
            child_int_options
        )
    ...
    if child_double_options is not None:
        ...
        out["double_options"] = (
            aws_sdk_cloudsearch.types.double_options.deserialize_query(
    ...
    if child_literal_options is not None:
        ...
        out["literal_options"] = (
            aws_sdk_cloudsearch.types.literal_options.deserialize_query(
    ...
    if child_text_options is not None:
        ...
        out["text_options"] = aws_sdk_cloudsearch.types.text_options.deserialize_query(
            child_text_options
        )
    ...
    if child_date_options is not None:
        ...
        out["date_options"] = aws_sdk_cloudsearch.types.date_options.deserialize_query(
            child_date_options
        )
    ...
    if child_lat_lon_options is not None:
        ...
        out["lat_lon_options"] = (
            aws_sdk_cloudsearch.types.lat_lon_options.deserialize_query(
    ...
    if child_int_array_options is not None:
        ...
        out["int_array_options"] = (
            aws_sdk_cloudsearch.types.int_array_options.deserialize_query(
    ...
    if child_double_array_options is not None:
        ...
        out["double_array_options"] = (
            aws_sdk_cloudsearch.types.double_array_options.deserialize_query(
    ...
    if child_literal_array_options is not None:
        ...
        out["literal_array_options"] = (
            aws_sdk_cloudsearch.types.literal_array_options.deserialize_query(
    ...
    if child_text_array_options is not None:
        ...
        out["text_array_options"] = (
            aws_sdk_cloudsearch.types.text_array_options.deserialize_query(
    ...
    if child_date_array_options is not None:
        ...
        out["date_array_options"] = (
            aws_sdk_cloudsearch.types.date_array_options.deserialize_query(
