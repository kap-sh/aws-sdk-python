"""Generated from Smithy shape ``com.amazonaws.cloudsearch#DeleteDomain``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteDomainResult")
    out: aws_sdk_cloudsearch.types.delete_domain_response.DeleteDomainResponse = (
        aws_sdk_cloudsearch.types.delete_domain_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_cloudsearch.types.delete_domain_request.DeleteDomainRequest,
) -> zapros.Request:
    ...
    aws_sdk_cloudsearch.types.delete_domain_request.serialize_query(input, pairs, "")
