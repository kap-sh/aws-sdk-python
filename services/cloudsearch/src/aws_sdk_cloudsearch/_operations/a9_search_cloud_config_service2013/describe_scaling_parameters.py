...
def handle_response(
    ...
    out: aws_sdk_cloudsearch.types.describe_scaling_parameters_response.DescribeScalingParametersResponse = aws_sdk_cloudsearch.types.describe_scaling_parameters_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_cloudsearch.types.describe_scaling_parameters_request.DescribeScalingParametersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
