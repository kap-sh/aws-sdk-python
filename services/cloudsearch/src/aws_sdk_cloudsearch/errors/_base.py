...
class CloudSearchError(Exception):
    """Base class for all CloudSearch service errors."""


class ServiceError(CloudSearchError):
...
class SerializationError(CloudSearchError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CloudSearchError):
...
class WaiterFailedError(CloudSearchError):
...
class WaiterTimeoutError(CloudSearchError):
