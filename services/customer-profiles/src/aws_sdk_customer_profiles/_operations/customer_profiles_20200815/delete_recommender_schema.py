...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_recommender_schema_response.DeleteRecommenderSchemaResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.delete_recommender_schema_request.DeleteRecommenderSchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
