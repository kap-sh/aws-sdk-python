...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.update_domain_layout_request.UpdateDomainLayoutRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{LayoutDefinitionName}", quote(str(input["layout_definition_name"]), safe="")
    )
    params: dict[str, str] = {}
