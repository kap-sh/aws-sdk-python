"""Generated from Smithy shape ``com.amazonaws.customerprofiles#UpdateDomainLayout``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.update_domain_layout_response.UpdateDomainLayoutResponse = aws_sdk_customer_profiles.types.update_domain_layout_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.update_domain_layout_request.UpdateDomainLayoutRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.update_domain_layout_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_domain_layout(
