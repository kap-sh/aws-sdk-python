...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.create_recommender_filter_response.CreateRecommenderFilterResponse = aws_sdk_customer_profiles.types.create_recommender_filter_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.create_recommender_filter_request.CreateRecommenderFilterRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{RecommenderFilterName}", quote(str(input["recommender_filter_name"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_recommender_filter_request.serialize_json(
            input
        )
    ).encode()
