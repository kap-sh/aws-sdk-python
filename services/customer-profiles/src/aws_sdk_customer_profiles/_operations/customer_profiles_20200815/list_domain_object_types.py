...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_domain_object_types_response.ListDomainObjectTypesResponse = aws_sdk_customer_profiles.types.list_domain_object_types_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_domain_object_types_request.ListDomainObjectTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
