"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListProfileHistoryRecords``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_profile_history_records_response.ListProfileHistoryRecordsResponse = aws_sdk_customer_profiles.types.list_profile_history_records_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_profile_history_records_request.ListProfileHistoryRecordsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/profiles/history-records"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.list_profile_history_records_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_profile_history_records(
