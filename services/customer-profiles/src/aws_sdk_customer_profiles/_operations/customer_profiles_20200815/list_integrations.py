...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_integrations_response.ListIntegrationsResponse = aws_sdk_customer_profiles.types.list_integrations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.list_integrations_request.ListIntegrationsRequest,
) -> zapros.Request:
