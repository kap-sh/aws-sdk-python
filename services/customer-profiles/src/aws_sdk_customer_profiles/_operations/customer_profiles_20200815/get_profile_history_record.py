...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_profile_history_record_response.GetProfileHistoryRecordResponse = aws_sdk_customer_profiles.types.get_profile_history_record_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_profile_history_record_request.GetProfileHistoryRecordRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
