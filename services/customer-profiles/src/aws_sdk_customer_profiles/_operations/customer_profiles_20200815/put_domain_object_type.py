"""Generated from Smithy shape ``com.amazonaws.customerprofiles#PutDomainObjectType``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.put_domain_object_type_response.PutDomainObjectTypeResponse = aws_sdk_customer_profiles.types.put_domain_object_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.put_domain_object_type_request.PutDomainObjectTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.put_domain_object_type_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_domain_object_type(
