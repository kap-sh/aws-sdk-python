...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_domain_layouts_response.ListDomainLayoutsResponse = aws_sdk_customer_profiles.types.list_domain_layouts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_domain_layouts_request.ListDomainLayoutsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
