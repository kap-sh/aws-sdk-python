...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.delete_profile_key_request.DeleteProfileKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.delete_profile_key_request.serialize_json(
            input_
        )
    ).encode()
