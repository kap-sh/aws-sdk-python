...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_profile_key_response.DeleteProfileKeyResponse = aws_sdk_customer_profiles.types.delete_profile_key_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.delete_profile_key_request.DeleteProfileKeyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.delete_profile_key_request.serialize_json(input)
    ).encode()
