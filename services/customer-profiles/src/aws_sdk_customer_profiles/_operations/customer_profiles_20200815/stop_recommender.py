"""Generated from Smithy shape ``com.amazonaws.customerprofiles#StopRecommender``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.stop_recommender_response.StopRecommenderResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.stop_recommender_request.StopRecommenderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
