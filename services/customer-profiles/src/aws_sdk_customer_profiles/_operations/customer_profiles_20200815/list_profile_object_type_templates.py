...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_profile_object_type_templates_response.ListProfileObjectTypeTemplatesResponse = aws_sdk_customer_profiles.types.list_profile_object_type_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_profile_object_type_templates_request.ListProfileObjectTypeTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
