"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetProfileRecommendations``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_profile_recommendations_response.GetProfileRecommendationsResponse = aws_sdk_customer_profiles.types.get_profile_recommendations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.get_profile_recommendations_request.GetProfileRecommendationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.get_profile_recommendations_request.serialize_json(
            input
        )
    ).encode()
...
async def async_get_profile_recommendations(
