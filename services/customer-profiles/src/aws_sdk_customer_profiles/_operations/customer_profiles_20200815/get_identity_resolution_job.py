"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetIdentityResolutionJob``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_identity_resolution_job_response.GetIdentityResolutionJobResponse = aws_sdk_customer_profiles.types.get_identity_resolution_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_identity_resolution_job_request.GetIdentityResolutionJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_identity_resolution_job(
