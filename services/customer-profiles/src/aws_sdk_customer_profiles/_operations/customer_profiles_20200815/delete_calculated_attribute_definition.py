...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_calculated_attribute_definition_response.DeleteCalculatedAttributeDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.delete_calculated_attribute_definition_request.DeleteCalculatedAttributeDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
