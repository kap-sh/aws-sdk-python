"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListRecommenders``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_recommenders_response.ListRecommendersResponse = aws_sdk_customer_profiles.types.list_recommenders_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_recommenders_request.ListRecommendersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/recommenders"
