"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListCalculatedAttributesForProfile``."""
...
import aws_sdk_customer_profiles.types.calculated_attributes_for_profile_list
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_calculated_attributes_for_profile_response.ListCalculatedAttributesForProfileResponse = aws_sdk_customer_profiles.types.list_calculated_attributes_for_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_calculated_attributes_for_profile_request.ListCalculatedAttributesForProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_calculated_attributes_for_profile(
