...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_segment_definition_response.GetSegmentDefinitionResponse = aws_sdk_customer_profiles.types.get_segment_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_segment_definition_request.GetSegmentDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
