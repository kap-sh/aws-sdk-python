...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.batch_get_profile_response.BatchGetProfileResponse = aws_sdk_customer_profiles.types.batch_get_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.batch_get_profile_request.BatchGetProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.batch_get_profile_request.serialize_json(input_)
    ).encode()
