...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.batch_get_profile_request.BatchGetProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.batch_get_profile_request.serialize_json(input)
    ).encode()
