...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_recommender_schemas_response.ListRecommenderSchemasResponse = aws_sdk_customer_profiles.types.list_recommender_schemas_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_recommender_schemas_request.ListRecommenderSchemasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
