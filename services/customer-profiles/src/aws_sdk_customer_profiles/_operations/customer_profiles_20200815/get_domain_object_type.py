...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_domain_object_type_response.GetDomainObjectTypeResponse = aws_sdk_customer_profiles.types.get_domain_object_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_domain_object_type_request.GetDomainObjectTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
