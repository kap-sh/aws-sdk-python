...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_calculated_attribute_definition_response.GetCalculatedAttributeDefinitionResponse = aws_sdk_customer_profiles.types.get_calculated_attribute_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_calculated_attribute_definition_request.GetCalculatedAttributeDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
