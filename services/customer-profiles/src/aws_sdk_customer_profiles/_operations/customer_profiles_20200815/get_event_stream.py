...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_event_stream_response.GetEventStreamResponse = aws_sdk_customer_profiles.types.get_event_stream_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_event_stream_request.GetEventStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
