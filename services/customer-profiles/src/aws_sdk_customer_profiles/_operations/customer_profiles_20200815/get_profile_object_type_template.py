...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_profile_object_type_template_response.GetProfileObjectTypeTemplateResponse = aws_sdk_customer_profiles.types.get_profile_object_type_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_profile_object_type_template_request.GetProfileObjectTypeTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
