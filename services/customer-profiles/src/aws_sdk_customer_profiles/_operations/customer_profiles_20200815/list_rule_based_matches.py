...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_rule_based_matches_response.ListRuleBasedMatchesResponse = aws_sdk_customer_profiles.types.list_rule_based_matches_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_rule_based_matches_request.ListRuleBasedMatchesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
