"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetUploadJob``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_upload_job_response.GetUploadJobResponse = aws_sdk_customer_profiles.types.get_upload_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_upload_job_request.GetUploadJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/upload-jobs/{JobId}"
...
async def async_get_upload_job(
