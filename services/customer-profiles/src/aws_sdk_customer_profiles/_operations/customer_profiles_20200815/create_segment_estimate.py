...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.create_segment_estimate_response.CreateSegmentEstimateResponse = aws_sdk_customer_profiles.types.create_segment_estimate_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.create_segment_estimate_request.CreateSegmentEstimateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_segment_estimate_request.serialize_json(
            input_
        )
    ).encode()
