...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.merge_profiles_request.MergeProfilesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.merge_profiles_request.serialize_json(input)
    ).encode()
