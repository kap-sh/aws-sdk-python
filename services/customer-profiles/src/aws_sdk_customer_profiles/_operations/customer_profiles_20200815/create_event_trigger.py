...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.create_event_trigger_response.CreateEventTriggerResponse = aws_sdk_customer_profiles.types.create_event_trigger_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.create_event_trigger_request.CreateEventTriggerRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{EventTriggerName}", quote(str(input["event_trigger_name"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_event_trigger_request.serialize_json(
            input
        )
    ).encode()
