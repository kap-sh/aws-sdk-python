"""Generated from Smithy shape ``com.amazonaws.customerprofiles#StartUploadJob``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.start_upload_job_response.StartUploadJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.start_upload_job_request.StartUploadJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_start_upload_job(
