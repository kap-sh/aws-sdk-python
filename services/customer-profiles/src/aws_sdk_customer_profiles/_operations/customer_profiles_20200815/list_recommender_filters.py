...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_recommender_filters_response.ListRecommenderFiltersResponse = aws_sdk_customer_profiles.types.list_recommender_filters_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_recommender_filters_request.ListRecommenderFiltersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
