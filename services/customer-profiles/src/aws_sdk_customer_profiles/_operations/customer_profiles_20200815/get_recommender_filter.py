...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_recommender_filter_response.GetRecommenderFilterResponse = aws_sdk_customer_profiles.types.get_recommender_filter_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_recommender_filter_request.GetRecommenderFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
