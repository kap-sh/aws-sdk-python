...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_profile_objects_response.ListProfileObjectsResponse = aws_sdk_customer_profiles.types.list_profile_objects_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_profile_objects_request.ListProfileObjectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
