...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_object_type_attributes_response.ListObjectTypeAttributesResponse = aws_sdk_customer_profiles.types.list_object_type_attributes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_object_type_attributes_request.ListObjectTypeAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
