...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_object_type_attribute_values_response.ListObjectTypeAttributeValuesResponse = aws_sdk_customer_profiles.types.list_object_type_attribute_values_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_object_type_attribute_values_request.ListObjectTypeAttributeValuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
