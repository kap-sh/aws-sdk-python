...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_event_trigger_response.GetEventTriggerResponse = aws_sdk_customer_profiles.types.get_event_trigger_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.get_event_trigger_request.GetEventTriggerRequest,
) -> zapros.Request:
