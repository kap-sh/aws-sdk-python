...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_segment_definitions_response.ListSegmentDefinitionsResponse = aws_sdk_customer_profiles.types.list_segment_definitions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_segment_definitions_request.ListSegmentDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
