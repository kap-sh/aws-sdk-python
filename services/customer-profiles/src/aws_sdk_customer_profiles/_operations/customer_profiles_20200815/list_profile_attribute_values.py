"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListProfileAttributeValues``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.profile_attribute_values_response.ProfileAttributeValuesResponse = aws_sdk_customer_profiles.types.profile_attribute_values_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.profile_attribute_values_request.ProfileAttributeValuesRequest,
) -> zapros.Request:
...
async def async_list_profile_attribute_values(
