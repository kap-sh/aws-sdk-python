...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_event_stream_response.DeleteEventStreamResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.delete_event_stream_request.DeleteEventStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
