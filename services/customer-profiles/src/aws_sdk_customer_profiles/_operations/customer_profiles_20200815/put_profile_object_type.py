"""Generated from Smithy shape ``com.amazonaws.customerprofiles#PutProfileObjectType``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.put_profile_object_type_response.PutProfileObjectTypeResponse = aws_sdk_customer_profiles.types.put_profile_object_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.put_profile_object_type_request.PutProfileObjectTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.put_profile_object_type_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_profile_object_type(
