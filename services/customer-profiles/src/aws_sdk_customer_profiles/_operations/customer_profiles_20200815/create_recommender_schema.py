...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.create_recommender_schema_response.CreateRecommenderSchemaResponse = aws_sdk_customer_profiles.types.create_recommender_schema_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.create_recommender_schema_request.CreateRecommenderSchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_recommender_schema_request.serialize_json(
            input_
        )
    ).encode()
