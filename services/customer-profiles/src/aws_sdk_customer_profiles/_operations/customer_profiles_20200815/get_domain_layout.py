...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_domain_layout_response.GetDomainLayoutResponse = aws_sdk_customer_profiles.types.get_domain_layout_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_domain_layout_request.GetDomainLayoutRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
