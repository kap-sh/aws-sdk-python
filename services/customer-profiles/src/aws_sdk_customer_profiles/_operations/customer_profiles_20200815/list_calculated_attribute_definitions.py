...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_calculated_attribute_definitions_response.ListCalculatedAttributeDefinitionsResponse = aws_sdk_customer_profiles.types.list_calculated_attribute_definitions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_calculated_attribute_definitions_request.ListCalculatedAttributeDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
