"""Generated from Smithy shape ``com.amazonaws.customerprofiles#BatchGetCalculatedAttributeForProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.batch_get_calculated_attribute_for_profile_response.BatchGetCalculatedAttributeForProfileResponse = aws_sdk_customer_profiles.types.batch_get_calculated_attribute_for_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.batch_get_calculated_attribute_for_profile_request.BatchGetCalculatedAttributeForProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_batch_get_calculated_attribute_for_profile(
