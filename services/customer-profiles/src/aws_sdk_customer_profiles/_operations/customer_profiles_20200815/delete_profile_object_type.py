...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_profile_object_type_response.DeleteProfileObjectTypeResponse = aws_sdk_customer_profiles.types.delete_profile_object_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.delete_profile_object_type_request.DeleteProfileObjectTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
