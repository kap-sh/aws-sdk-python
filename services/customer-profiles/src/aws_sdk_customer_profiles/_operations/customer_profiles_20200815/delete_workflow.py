"""Generated from Smithy shape ``com.amazonaws.customerprofiles#DeleteWorkflow``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_workflow_response.DeleteWorkflowResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.delete_workflow_request.DeleteWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
