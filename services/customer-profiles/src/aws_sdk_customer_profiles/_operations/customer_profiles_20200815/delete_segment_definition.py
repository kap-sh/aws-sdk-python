...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_segment_definition_response.DeleteSegmentDefinitionResponse = aws_sdk_customer_profiles.types.delete_segment_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.delete_segment_definition_request.DeleteSegmentDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
