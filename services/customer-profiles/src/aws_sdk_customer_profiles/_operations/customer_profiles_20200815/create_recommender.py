"""Generated from Smithy shape ``com.amazonaws.customerprofiles#CreateRecommender``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.create_recommender_response.CreateRecommenderResponse = aws_sdk_customer_profiles.types.create_recommender_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.create_recommender_request.CreateRecommenderRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{RecommenderName}", quote(str(input["recommender_name"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_recommender_request.serialize_json(input)
    ).encode()
...
async def async_create_recommender(
