...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.search_profiles_request.SearchProfilesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.search_profiles_request.serialize_json(input)
    ).encode()
