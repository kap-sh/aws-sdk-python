"""Generated from Smithy shape ``com.amazonaws.customerprofiles#SearchProfiles``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.search_profiles_response.SearchProfilesResponse = aws_sdk_customer_profiles.types.search_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.search_profiles_request.SearchProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/profiles/search"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.search_profiles_request.serialize_json(input_)
    ).encode()
...
async def async_search_profiles(
