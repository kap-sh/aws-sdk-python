"""Generated from Smithy shape ``com.amazonaws.customerprofiles#CreateSegmentSnapshot``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.create_segment_snapshot_response.CreateSegmentSnapshotResponse = aws_sdk_customer_profiles.types.create_segment_snapshot_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.create_segment_snapshot_request.CreateSegmentSnapshotRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_segment_snapshot_request.serialize_json(
            input
        )
    ).encode()
...
async def async_create_segment_snapshot(
