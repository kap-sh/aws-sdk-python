...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_domain_object_type_response.DeleteDomainObjectTypeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.delete_domain_object_type_request.DeleteDomainObjectTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
