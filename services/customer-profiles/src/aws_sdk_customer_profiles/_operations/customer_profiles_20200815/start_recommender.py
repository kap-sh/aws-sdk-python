...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.start_recommender_response.StartRecommenderResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.start_recommender_request.StartRecommenderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
