"""Generated from Smithy shape ``com.amazonaws.customerprofiles#CreateSegmentDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.create_segment_definition_response.CreateSegmentDefinitionResponse = aws_sdk_customer_profiles.types.create_segment_definition_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.create_segment_definition_request.CreateSegmentDefinitionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{SegmentDefinitionName}", quote(str(input["segment_definition_name"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_segment_definition_request.serialize_json(
            input
        )
    ).encode()
...
async def async_create_segment_definition(
