...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.put_integration_response.PutIntegrationResponse = aws_sdk_customer_profiles.types.put_integration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.put_integration_request.PutIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.put_integration_request.serialize_json(input_)
    ).encode()
