...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.put_integration_request.PutIntegrationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.put_integration_request.serialize_json(input)
    ).encode()
