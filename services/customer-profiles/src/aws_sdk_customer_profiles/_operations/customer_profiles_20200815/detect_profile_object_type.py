"""Generated from Smithy shape ``com.amazonaws.customerprofiles#DetectProfileObjectType``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.detect_profile_object_type_response.DetectProfileObjectTypeResponse = aws_sdk_customer_profiles.types.detect_profile_object_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.detect_profile_object_type_request.DetectProfileObjectTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/detect/object-types"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.detect_profile_object_type_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_detect_profile_object_type(
