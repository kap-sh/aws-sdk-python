"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetCalculatedAttributeForProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_calculated_attribute_for_profile_response.GetCalculatedAttributeForProfileResponse = aws_sdk_customer_profiles.types.get_calculated_attribute_for_profile_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.get_calculated_attribute_for_profile_request.GetCalculatedAttributeForProfileRequest,
) -> zapros.Request:
...
async def async_get_calculated_attribute_for_profile(
