...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.create_domain_request.CreateDomainRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_domain_request.serialize_json(input)
    ).encode()
