...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_profile_object_type_response.GetProfileObjectTypeResponse = aws_sdk_customer_profiles.types.get_profile_object_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_profile_object_type_request.GetProfileObjectTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
