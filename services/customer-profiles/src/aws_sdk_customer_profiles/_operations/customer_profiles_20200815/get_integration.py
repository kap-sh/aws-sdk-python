"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetIntegration``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_integration_response.GetIntegrationResponse = aws_sdk_customer_profiles.types.get_integration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_integration_request.GetIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.get_integration_request.serialize_json(input_)
    ).encode()
