...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.get_integration_request.GetIntegrationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.get_integration_request.serialize_json(input)
    ).encode()
