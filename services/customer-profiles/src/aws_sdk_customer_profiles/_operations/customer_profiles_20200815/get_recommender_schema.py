...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_recommender_schema_response.GetRecommenderSchemaResponse = aws_sdk_customer_profiles.types.get_recommender_schema_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.get_recommender_schema_request.GetRecommenderSchemaRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{RecommenderSchemaName}", quote(str(input["recommender_schema_name"]), safe="")
    )
    params: dict[str, str] = {}
