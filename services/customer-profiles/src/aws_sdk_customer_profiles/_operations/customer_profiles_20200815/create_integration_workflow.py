...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.create_integration_workflow_response.CreateIntegrationWorkflowResponse = aws_sdk_customer_profiles.types.create_integration_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.create_integration_workflow_request.CreateIntegrationWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_integration_workflow_request.serialize_json(
            input_
        )
    ).encode()
