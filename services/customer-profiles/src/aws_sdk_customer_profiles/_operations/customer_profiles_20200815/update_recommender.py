"""Generated from Smithy shape ``com.amazonaws.customerprofiles#UpdateRecommender``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.update_recommender_response.UpdateRecommenderResponse = aws_sdk_customer_profiles.types.update_recommender_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.update_recommender_request.UpdateRecommenderRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.update_recommender_request.serialize_json(input)
    ).encode()
