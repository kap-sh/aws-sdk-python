...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.update_recommender_request.UpdateRecommenderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.update_recommender_request.serialize_json(
            input_
        )
    ).encode()
