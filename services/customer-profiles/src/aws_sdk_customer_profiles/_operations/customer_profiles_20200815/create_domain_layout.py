...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.create_domain_layout_response.CreateDomainLayoutResponse = aws_sdk_customer_profiles.types.create_domain_layout_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.create_domain_layout_request.CreateDomainLayoutRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_domain_layout_request.serialize_json(
            input_
        )
    ).encode()
