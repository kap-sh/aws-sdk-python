...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_identity_resolution_jobs_response.ListIdentityResolutionJobsResponse = aws_sdk_customer_profiles.types.list_identity_resolution_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_identity_resolution_jobs_request.ListIdentityResolutionJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
