...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_upload_jobs_response.ListUploadJobsResponse = aws_sdk_customer_profiles.types.list_upload_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_upload_jobs_request.ListUploadJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
