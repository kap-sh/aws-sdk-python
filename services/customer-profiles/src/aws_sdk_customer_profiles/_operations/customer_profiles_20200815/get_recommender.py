...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.get_recommender_request.GetRecommenderRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "training_metrics_count" in input:
        params["training-metrics-count"] = str(input["training_metrics_count"])
