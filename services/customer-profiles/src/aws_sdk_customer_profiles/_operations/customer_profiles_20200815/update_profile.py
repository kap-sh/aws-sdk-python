...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.update_profile_request.UpdateProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.update_profile_request.serialize_json(input)
    ).encode()
