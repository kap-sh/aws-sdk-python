...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_profile_object_types_response.ListProfileObjectTypesResponse = aws_sdk_customer_profiles.types.list_profile_object_types_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_profile_object_types_request.ListProfileObjectTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
