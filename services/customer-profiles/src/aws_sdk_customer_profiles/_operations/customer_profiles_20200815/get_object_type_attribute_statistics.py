...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_object_type_attribute_statistics_response.GetObjectTypeAttributeStatisticsResponse = aws_sdk_customer_profiles.types.get_object_type_attribute_statistics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_object_type_attribute_statistics_request.GetObjectTypeAttributeStatisticsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
