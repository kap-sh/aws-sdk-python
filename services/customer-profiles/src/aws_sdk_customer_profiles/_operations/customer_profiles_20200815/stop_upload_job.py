...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.stop_upload_job_response.StopUploadJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.stop_upload_job_request.StopUploadJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
