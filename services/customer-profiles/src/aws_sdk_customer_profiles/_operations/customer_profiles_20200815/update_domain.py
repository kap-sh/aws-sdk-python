...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.update_domain_response.UpdateDomainResponse = (
        aws_sdk_customer_profiles.types.update_domain_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.update_domain_request.UpdateDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.update_domain_request.serialize_json(input_)
    ).encode()
