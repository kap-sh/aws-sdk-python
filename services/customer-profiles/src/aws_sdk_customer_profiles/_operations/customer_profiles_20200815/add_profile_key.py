...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.add_profile_key_request.AddProfileKeyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.add_profile_key_request.serialize_json(input)
    ).encode()
