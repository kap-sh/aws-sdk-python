...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.add_profile_key_response.AddProfileKeyResponse = aws_sdk_customer_profiles.types.add_profile_key_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.add_profile_key_request.AddProfileKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.add_profile_key_request.serialize_json(input_)
    ).encode()
