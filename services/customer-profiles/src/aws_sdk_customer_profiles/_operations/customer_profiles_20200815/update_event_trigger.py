...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.update_event_trigger_response.UpdateEventTriggerResponse = aws_sdk_customer_profiles.types.update_event_trigger_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.update_event_trigger_request.UpdateEventTriggerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.update_event_trigger_request.serialize_json(
            input
        )
    ).encode()
