...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.create_event_stream_response.CreateEventStreamResponse = aws_sdk_customer_profiles.types.create_event_stream_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.create_event_stream_request.CreateEventStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_event_stream_request.serialize_json(
            input_
        )
    ).encode()
