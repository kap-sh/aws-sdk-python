...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_domain_layout_response.DeleteDomainLayoutResponse = aws_sdk_customer_profiles.types.delete_domain_layout_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.delete_domain_layout_request.DeleteDomainLayoutRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
