...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_profile_object_response.DeleteProfileObjectResponse = aws_sdk_customer_profiles.types.delete_profile_object_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.delete_profile_object_request.DeleteProfileObjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.delete_profile_object_request.serialize_json(
            input_
        )
    ).encode()
