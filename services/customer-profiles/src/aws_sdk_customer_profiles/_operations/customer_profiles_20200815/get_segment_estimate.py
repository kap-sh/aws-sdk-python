...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_segment_estimate_response.GetSegmentEstimateResponse = aws_sdk_customer_profiles.types.get_segment_estimate_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.get_segment_estimate_request.GetSegmentEstimateRequest,
) -> zapros.Request:
    ...
    url = url.replace("{EstimateId}", quote(str(input["estimate_id"]), safe=""))
    params: dict[str, str] = {}
