...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.list_workflows_request.ListWorkflowsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.list_workflows_request.serialize_json(input)
    ).encode()
