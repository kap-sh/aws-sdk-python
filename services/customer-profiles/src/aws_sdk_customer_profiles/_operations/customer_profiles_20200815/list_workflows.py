...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_workflows_response.ListWorkflowsResponse = aws_sdk_customer_profiles.types.list_workflows_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_workflows_request.ListWorkflowsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.list_workflows_request.serialize_json(input_)
    ).encode()
