...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_event_streams_response.ListEventStreamsResponse = aws_sdk_customer_profiles.types.list_event_streams_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_event_streams_request.ListEventStreamsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
