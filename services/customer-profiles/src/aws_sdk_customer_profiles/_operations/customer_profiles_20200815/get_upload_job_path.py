"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetUploadJobPath``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_upload_job_path_response.GetUploadJobPathResponse = aws_sdk_customer_profiles.types.get_upload_job_path_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_upload_job_path_request.GetUploadJobPathRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/upload-jobs/{JobId}/path"
...
async def async_get_upload_job_path(
