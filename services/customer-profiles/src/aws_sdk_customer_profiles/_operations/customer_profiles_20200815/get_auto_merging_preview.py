...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_auto_merging_preview_response.GetAutoMergingPreviewResponse = aws_sdk_customer_profiles.types.get_auto_merging_preview_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_auto_merging_preview_request.GetAutoMergingPreviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.get_auto_merging_preview_request.serialize_json(
            input_
        )
    ).encode()
