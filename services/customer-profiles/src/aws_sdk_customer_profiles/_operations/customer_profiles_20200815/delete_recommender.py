...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_recommender_response.DeleteRecommenderResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.delete_recommender_request.DeleteRecommenderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
