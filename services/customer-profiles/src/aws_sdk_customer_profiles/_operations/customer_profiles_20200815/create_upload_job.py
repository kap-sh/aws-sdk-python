"""Generated from Smithy shape ``com.amazonaws.customerprofiles#CreateUploadJob``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.create_upload_job_response.CreateUploadJobResponse = aws_sdk_customer_profiles.types.create_upload_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.create_upload_job_request.CreateUploadJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_upload_job_request.serialize_json(input_)
    ).encode()
...
async def async_create_upload_job(
