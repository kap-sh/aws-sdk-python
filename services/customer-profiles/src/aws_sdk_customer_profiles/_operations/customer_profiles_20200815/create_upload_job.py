...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.create_upload_job_request.CreateUploadJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_upload_job_request.serialize_json(input)
    ).encode()
