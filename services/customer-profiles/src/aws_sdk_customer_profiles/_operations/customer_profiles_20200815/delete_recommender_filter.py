...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_recommender_filter_response.DeleteRecommenderFilterResponse = aws_sdk_customer_profiles.types.delete_recommender_filter_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.delete_recommender_filter_request.DeleteRecommenderFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
