...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_workflow_steps_response.GetWorkflowStepsResponse = aws_sdk_customer_profiles.types.get_workflow_steps_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_workflow_steps_request.GetWorkflowStepsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
