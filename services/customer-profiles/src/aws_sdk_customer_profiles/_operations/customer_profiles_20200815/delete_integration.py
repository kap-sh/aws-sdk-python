...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_integration_response.DeleteIntegrationResponse = aws_sdk_customer_profiles.types.delete_integration_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.delete_integration_request.DeleteIntegrationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.delete_integration_request.serialize_json(input)
    ).encode()
