"""Generated from Smithy shape ``com.amazonaws.customerprofiles#PutProfileObject``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.put_profile_object_response.PutProfileObjectResponse = aws_sdk_customer_profiles.types.put_profile_object_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.put_profile_object_request.PutProfileObjectRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.put_profile_object_request.serialize_json(input)
    ).encode()
...
async def async_put_profile_object(
