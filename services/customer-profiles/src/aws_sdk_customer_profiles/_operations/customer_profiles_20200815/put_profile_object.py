...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.put_profile_object_request.PutProfileObjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.put_profile_object_request.serialize_json(
            input_
        )
    ).encode()
