...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_matches_response.GetMatchesResponse = (
        aws_sdk_customer_profiles.types.get_matches_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_matches_request.GetMatchesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
