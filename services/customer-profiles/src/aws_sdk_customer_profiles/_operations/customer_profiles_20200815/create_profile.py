...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.create_profile_response.CreateProfileResponse = aws_sdk_customer_profiles.types.create_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.create_profile_request.CreateProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.create_profile_request.serialize_json(input_)
    ).encode()
