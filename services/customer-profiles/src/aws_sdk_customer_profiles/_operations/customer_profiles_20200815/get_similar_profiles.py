"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetSimilarProfiles``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_similar_profiles_response.GetSimilarProfilesResponse = aws_sdk_customer_profiles.types.get_similar_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_similar_profiles_request.GetSimilarProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/matches"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.get_similar_profiles_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_similar_profiles(
