...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.update_calculated_attribute_definition_response.UpdateCalculatedAttributeDefinitionResponse = aws_sdk_customer_profiles.types.update_calculated_attribute_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.update_calculated_attribute_definition_request.UpdateCalculatedAttributeDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.update_calculated_attribute_definition_request.serialize_json(
            input_
        )
    ).encode()
