...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.update_calculated_attribute_definition_request.UpdateCalculatedAttributeDefinitionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["calculated_attribute_name"]), safe=""),
    )
    params: dict[str, str] = {}
