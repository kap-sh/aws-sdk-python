"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetSegmentMembership``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_segment_membership_response.GetSegmentMembershipResponse = aws_sdk_customer_profiles.types.get_segment_membership_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.get_segment_membership_request.GetSegmentMembershipRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_customer_profiles.types.get_segment_membership_request.serialize_json(
            input
        )
    ).encode()
...
async def async_get_segment_membership(
