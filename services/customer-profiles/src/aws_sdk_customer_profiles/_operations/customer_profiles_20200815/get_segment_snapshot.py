"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetSegmentSnapshot``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_segment_snapshot_response.GetSegmentSnapshotResponse = aws_sdk_customer_profiles.types.get_segment_snapshot_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.get_segment_snapshot_request.GetSegmentSnapshotRequest,
) -> zapros.Request:
...
async def async_get_segment_snapshot(
