...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.delete_event_trigger_response.DeleteEventTriggerResponse = aws_sdk_customer_profiles.types.delete_event_trigger_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_customer_profiles.types.delete_event_trigger_request.DeleteEventTriggerRequest,
) -> zapros.Request:
