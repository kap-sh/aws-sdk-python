"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetDomain``."""
...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.get_domain_response.GetDomainResponse = (
        aws_sdk_customer_profiles.types.get_domain_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.get_domain_request.GetDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
