...
def handle_response(
    ...
    out: aws_sdk_customer_profiles.types.list_recommender_recipes_response.ListRecommenderRecipesResponse = aws_sdk_customer_profiles.types.list_recommender_recipes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_customer_profiles.types.list_recommender_recipes_request.ListRecommenderRecipesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
