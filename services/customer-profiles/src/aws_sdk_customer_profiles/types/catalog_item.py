...
class CatalogItem(TypedDict):
    ...
    updated_at: NotRequired["aws_sdk_customer_profiles.types.timestamp.timestamp"]
...
def serialize_json(value: CatalogItem) -> dict:
    ...
    if "updated_at" in value:
        ...
        out["UpdatedAt"] = aws_sdk_customer_profiles.types.timestamp.serialize_json(
            value["updated_at"]
        )
    if "price" in value:
...
def deserialize_json(data: dict) -> CatalogItem:
    ...
    if "UpdatedAt" in data:
        ...
        out["updated_at"] = aws_sdk_customer_profiles.types.timestamp.deserialize_json(
            data["UpdatedAt"]
        )
    if "Price" in data:
