...
class UpdateProfileRequest(TypedDict):
    ...
    address: NotRequired["aws_sdk_customer_profiles.types.update_address.UpdateAddress"]
...
def serialize_json(value: UpdateProfileRequest) -> dict:
    ...
    if "address" in value:
        ...
        out["Address"] = aws_sdk_customer_profiles.types.update_address.serialize_json(
            value["address"]
        )
    if "shipping_address" in value:
        ...
        out["ShippingAddress"] = (
            aws_sdk_customer_profiles.types.update_address.serialize_json(
    ...
    if "attributes" in value:
        ...
        out["Attributes"] = (
            aws_sdk_customer_profiles.types.update_attributes.serialize_json(
                value["attributes"]
            )
        )
...
def deserialize_json(data: dict) -> UpdateProfileRequest:
    ...
    if "Address" in data:
        ...
        out["address"] = (
            aws_sdk_customer_profiles.types.update_address.deserialize_json(
                data["Address"]
            )
        )
    ...
    if "Attributes" in data:
        ...
        out["attributes"] = (
            aws_sdk_customer_profiles.types.update_attributes.deserialize_json(
                data["Attributes"]
            )
        )
