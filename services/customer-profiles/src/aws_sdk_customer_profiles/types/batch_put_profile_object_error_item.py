...
if TYPE_CHECKING:
    ...
    import aws_sdk_customer_profiles.types.response_code
    import aws_sdk_customer_profiles.types.text


class BatchPutProfileObjectErrorItem(TypedDict):
    id: "aws_sdk_customer_profiles.types.name.name"
    """<p>The unique identifier of the item in the batch request that failed.</p>"""
    code: "aws_sdk_customer_profiles.types.response_code.responseCode"
