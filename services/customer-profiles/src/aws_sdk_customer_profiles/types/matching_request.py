"""Generated from Smithy shape ``com.amazonaws.customerprofiles#MatchingRequest``."""
...
class MatchingRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: MatchingRequest) -> dict:
    out: dict = {}
