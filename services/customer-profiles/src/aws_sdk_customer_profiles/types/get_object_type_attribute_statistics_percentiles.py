...
class GetObjectTypeAttributeStatisticsPercentiles(TypedDict):
    p5: "aws_sdk_customer_profiles.types.double.Double"
    """<p>The 5th percentile value of the attribute.</p>"""
    p25: "aws_sdk_customer_profiles.types.double.Double"
    """<p>The 25th percentile value of the attribute.</p>"""
    p50: "aws_sdk_customer_profiles.types.double.Double"
    """<p>The 50th percentile (median) value of the attribute.</p>"""
    p75: "aws_sdk_customer_profiles.types.double.Double"
    """<p>The 75th percentile value of the attribute.</p>"""
    p95: "aws_sdk_customer_profiles.types.double.Double"
