...
if TYPE_CHECKING:
    import aws_sdk_customer_profiles.types.events_config
    import aws_sdk_customer_profiles.types.included_columns
    import aws_sdk_customer_profiles.types.inference_config
    import aws_sdk_customer_profiles.types.recommender_config_training_frequency_integer


class RecommenderConfig(TypedDict):
    events_config: NotRequired[
        "aws_sdk_customer_profiles.types.events_config.EventsConfig"
    ]
    """<p>Configuration settings for how the recommender processes and uses events.</p>"""
    training_frequency: NotRequired[
        "aws_sdk_customer_profiles.types.recommender_config_training_frequency_integer.RecommenderConfigTrainingFrequencyInteger"
    ]
    ...
    inference_config: NotRequired[
        "aws_sdk_customer_profiles.types.inference_config.InferenceConfig"
    ]
    """<p>Configuration settings for how the recommender handles inference requests.</p>"""
    included_columns: NotRequired[
        "aws_sdk_customer_profiles.types.included_columns.IncludedColumns"
    ]
...
def serialize_json(value: RecommenderConfig) -> dict:
    ...
    if "events_config" in value:
        ...
        out["EventsConfig"] = (
            aws_sdk_customer_profiles.types.events_config.serialize_json(
                value["events_config"]
            )
        )
    ...
    if "inference_config" in value:
        ...
        out["InferenceConfig"] = (
            aws_sdk_customer_profiles.types.inference_config.serialize_json(
    ...
    if "included_columns" in value:
        ...
        out["IncludedColumns"] = (
            aws_sdk_customer_profiles.types.included_columns.serialize_json(
...
def deserialize_json(data: dict) -> RecommenderConfig:
    ...
    if "EventsConfig" in data:
        ...
        out["events_config"] = (
            aws_sdk_customer_profiles.types.events_config.deserialize_json(
                data["EventsConfig"]
            )
        )
    ...
    if "InferenceConfig" in data:
        ...
        out["inference_config"] = (
            aws_sdk_customer_profiles.types.inference_config.deserialize_json(
    ...
    if "IncludedColumns" in data:
        ...
        out["included_columns"] = (
            aws_sdk_customer_profiles.types.included_columns.deserialize_json(
