...
class ListCalculatedAttributesForProfileResponse(TypedDict):
    items: NotRequired[
        "aws_sdk_customer_profiles.types.calculated_attributes_for_profile_list.CalculatedAttributesForProfileList"
    ]
...
def serialize_json(value: ListCalculatedAttributesForProfileResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["Items"] = (
            aws_sdk_customer_profiles.types.calculated_attributes_for_profile_list.serialize_json(
                value["items"]
            )
        )
...
def deserialize_json(data: dict) -> ListCalculatedAttributesForProfileResponse:
    ...
    if "Items" in data:
        ...
        out["items"] = (
            aws_sdk_customer_profiles.types.calculated_attributes_for_profile_list.deserialize_json(
                data["Items"]
            )
        )
