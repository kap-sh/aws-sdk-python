...
if TYPE_CHECKING:
    ...
    import aws_sdk_customer_profiles.types.found_by_list
...
def serialize_json(value: Profile) -> dict:
    ...
    if "found_by_items" in value:
        ...
        out["FoundByItems"] = (
            aws_sdk_customer_profiles.types.found_by_list.serialize_json(
...
def deserialize_json(data: dict) -> Profile:
    ...
    if "FoundByItems" in data:
        import aws_sdk_customer_profiles.types.found_by_list

        out["found_by_items"] = (
            aws_sdk_customer_profiles.types.found_by_list.deserialize_json(
                data["FoundByItems"]
            )
        )
