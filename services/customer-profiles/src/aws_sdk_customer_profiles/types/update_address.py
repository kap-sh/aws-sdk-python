...
class UpdateAddress(TypedDict):
    ...
    address3: NotRequired["aws_sdk_customer_profiles.types.string0_to255.string0To255"]
    """<p>The third line of a customer address.</p>"""
    address4: NotRequired["aws_sdk_customer_profiles.types.string0_to255.string0To255"]
    """<p>The fourth line of a customer address.</p>"""
    city: NotRequired["aws_sdk_customer_profiles.types.string0_to255.string0To255"]
    """<p>The city in which a customer lives.</p>"""
    county: NotRequired["aws_sdk_customer_profiles.types.string0_to255.string0To255"]
    """<p>The county in which a customer lives.</p>"""
    state: NotRequired["aws_sdk_customer_profiles.types.string0_to255.string0To255"]
    """<p>The state in which a customer lives.</p>"""
    province: NotRequired["aws_sdk_customer_profiles.types.string0_to255.string0To255"]
    """<p>The province in which a customer lives.</p>"""
    country: NotRequired["aws_sdk_customer_profiles.types.string0_to255.string0To255"]
