...
if TYPE_CHECKING:
    import aws_sdk_customer_profiles.types.flow_name
...
class AppflowIntegrationWorkflowStep(TypedDict, closed=True):
    ...
    execution_message: "aws_sdk_customer_profiles.types.string1_to255.string1To255"
    ...
    batch_records_end_time: "aws_sdk_customer_profiles.types.string1_to255.string1To255"
