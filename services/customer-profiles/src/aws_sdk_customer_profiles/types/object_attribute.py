...
if TYPE_CHECKING:
    import aws_sdk_customer_profiles.types.comparison_operator
    import aws_sdk_customer_profiles.types.event_trigger_values
...
class ObjectAttribute(TypedDict):
    ...
    field_name: NotRequired["aws_sdk_customer_profiles.types.field_name.fieldName"]
    """<p>A field defined within an object type.</p>"""
    comparison_operator: (
        "aws_sdk_customer_profiles.types.comparison_operator.ComparisonOperator"
    )
    """<p>The operator used to compare an attribute against a list of values.</p>"""
    values: "aws_sdk_customer_profiles.types.event_trigger_values.EventTriggerValues"
...
def serialize_json(value: ObjectAttribute) -> dict:
    ...
    out["ComparisonOperator"] = (
        aws_sdk_customer_profiles.types.comparison_operator.serialize_json(
            value["comparison_operator"]
        )
    )
    import aws_sdk_customer_profiles.types.event_trigger_values

    out["Values"] = aws_sdk_customer_profiles.types.event_trigger_values.serialize_json(
        value["values"]
    )
    return out
...
def deserialize_json(data: dict) -> ObjectAttribute:
    ...
    if "ComparisonOperator" in data:
        ...
        out["comparison_operator"] = (
            aws_sdk_customer_profiles.types.comparison_operator.deserialize_json(
    ...
    if "Values" in data:
        ...
        out["values"] = (
            aws_sdk_customer_profiles.types.event_trigger_values.deserialize_json(
                data["Values"]
            )
        )
    else:
