"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetDomainResponse``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_customer_profiles.types.domain_stats
...
class GetDomainResponse(TypedDict, closed=True):
    ...
    stats: NotRequired["aws_sdk_customer_profiles.types.domain_stats.DomainStats"]
...
def serialize_json(value: GetDomainResponse) -> dict:
    ...
    if "stats" in value:
        ...
        out["Stats"] = aws_sdk_customer_profiles.types.domain_stats.serialize_json(
            value["stats"]
        )
...
def deserialize_json(data: dict) -> GetDomainResponse:
    ...
    if "DomainName" in data:
        ...
        raise DeserializationError("GetDomainResponse.domain_name required")
    ...
    if "Stats" in data:
        ...
        out["stats"] = aws_sdk_customer_profiles.types.domain_stats.deserialize_json(
            data["Stats"]
        )
    if "Matching" in data:
        import aws_sdk_customer_profiles.types.matching_response
    ...
    if "CreatedAt" in data:
        ...
        raise DeserializationError("GetDomainResponse.created_at required")
    if "LastUpdatedAt" in data:
        ...
        raise DeserializationError("GetDomainResponse.last_updated_at required")
    if "Tags" in data:
        import aws_sdk_customer_profiles.types.tag_map
