...
class Address(TypedDict):
    address1: NotRequired["aws_sdk_customer_profiles.types.string1_to255.string1To255"]
    """<p>The first line of a customer address.</p>"""
    address2: NotRequired["aws_sdk_customer_profiles.types.string1_to255.string1To255"]
    """<p>The second line of a customer address.</p>"""
    address3: NotRequired["aws_sdk_customer_profiles.types.string1_to255.string1To255"]
    """<p>The third line of a customer address.</p>"""
    address4: NotRequired["aws_sdk_customer_profiles.types.string1_to255.string1To255"]
    """<p>The fourth line of a customer address.</p>"""
    city: NotRequired["aws_sdk_customer_profiles.types.string1_to255.string1To255"]
    """<p>The city in which a customer lives.</p>"""
    county: NotRequired["aws_sdk_customer_profiles.types.string1_to255.string1To255"]
    """<p>The county in which a customer lives.</p>"""
    state: NotRequired["aws_sdk_customer_profiles.types.string1_to255.string1To255"]
    """<p>The state in which a customer lives.</p>"""
    province: NotRequired["aws_sdk_customer_profiles.types.string1_to255.string1To255"]
    """<p>The province in which a customer lives.</p>"""
    country: NotRequired["aws_sdk_customer_profiles.types.string1_to255.string1To255"]
