...
from ._services.async_customer_profiles import (
    AsyncCustomerProfilesClient as AsyncCustomerProfilesClient,
)
from ._services.customer_profiles import (
    CustomerProfilesClient as CustomerProfilesClient,
)
