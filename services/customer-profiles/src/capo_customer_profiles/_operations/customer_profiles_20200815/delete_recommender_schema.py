"""Generated from Smithy shape ``com.amazonaws.customerprofiles#DeleteRecommenderSchema``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.delete_recommender_schema_response.DeleteRecommenderSchemaResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_recommender_schema(
