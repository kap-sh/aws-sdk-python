...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_upload_job_path_response.GetUploadJobPathResponse = capo_customer_profiles.types.get_upload_job_path_response.deserialize_json(
