"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetEventStream``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_event_stream_response.GetEventStreamResponse = capo_customer_profiles.types.get_event_stream_response.deserialize_json(
