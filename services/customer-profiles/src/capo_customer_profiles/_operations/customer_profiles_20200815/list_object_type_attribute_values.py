"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListObjectTypeAttributeValues``."""
...
import capo_customer_profiles.types.list_object_type_attribute_values_list
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_object_type_attribute_values_response.ListObjectTypeAttributeValuesResponse = capo_customer_profiles.types.list_object_type_attribute_values_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{ObjectTypeName}", quote(str(input_["object_type_name"]), safe="")
    )
...
async def async_list_object_type_attribute_values(
