"""Generated from Smithy shape ``com.amazonaws.customerprofiles#DeleteEventTrigger``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.delete_event_trigger_response.DeleteEventTriggerResponse = capo_customer_profiles.types.delete_event_trigger_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{EventTriggerName}", quote(str(input_["event_trigger_name"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_delete_event_trigger(
