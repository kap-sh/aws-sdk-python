"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListObjectTypeAttributes``."""
...
import capo_customer_profiles.types.list_object_type_attributes_list
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_object_type_attributes_response.ListObjectTypeAttributesResponse = capo_customer_profiles.types.list_object_type_attributes_response.deserialize_json(
...
async def async_list_object_type_attributes(
