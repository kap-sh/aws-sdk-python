"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListRecommenderSchemas``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_recommender_schemas_response.ListRecommenderSchemasResponse = capo_customer_profiles.types.list_recommender_schemas_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/recommender-schemas"
...
async def async_list_recommender_schemas(
