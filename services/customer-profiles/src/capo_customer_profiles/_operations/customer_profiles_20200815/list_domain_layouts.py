"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListDomainLayouts``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_domain_layouts_response.ListDomainLayoutsResponse = capo_customer_profiles.types.list_domain_layouts_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/layouts"
...
async def async_list_domain_layouts(
