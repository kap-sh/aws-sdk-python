"""Generated from Smithy shape ``com.amazonaws.customerprofiles#CreateCalculatedAttributeDefinition``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.create_calculated_attribute_definition_response.CreateCalculatedAttributeDefinitionResponse = capo_customer_profiles.types.create_calculated_attribute_definition_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["calculated_attribute_name"]), safe=""),
    )
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.create_calculated_attribute_definition_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_calculated_attribute_definition(
