"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetRecommenderSchema``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_recommender_schema_response.GetRecommenderSchemaResponse = capo_customer_profiles.types.get_recommender_schema_response.deserialize_json(
...
async def async_get_recommender_schema(
