"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListUploadJobs``."""
...
import capo_customer_profiles.types.upload_jobs_list
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_upload_jobs_response.ListUploadJobsResponse = capo_customer_profiles.types.list_upload_jobs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/upload-jobs"
...
async def async_list_upload_jobs(
