"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetObjectTypeAttributeStatistics``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_object_type_attribute_statistics_response.GetObjectTypeAttributeStatisticsResponse = capo_customer_profiles.types.get_object_type_attribute_statistics_response.deserialize_json(
...
async def async_get_object_type_attribute_statistics(
