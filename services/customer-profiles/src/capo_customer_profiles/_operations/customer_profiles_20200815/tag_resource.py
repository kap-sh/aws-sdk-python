"""Generated from Smithy shape ``com.amazonaws.customerprofiles#TagResource``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.tag_resource_request.serialize_json(input_)
    ).encode()
