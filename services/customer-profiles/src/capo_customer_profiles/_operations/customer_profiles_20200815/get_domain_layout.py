"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetDomainLayout``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_domain_layout_response.GetDomainLayoutResponse = capo_customer_profiles.types.get_domain_layout_response.deserialize_json(
...
async def async_get_domain_layout(
