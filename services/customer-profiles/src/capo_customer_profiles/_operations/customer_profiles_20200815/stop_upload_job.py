"""Generated from Smithy shape ``com.amazonaws.customerprofiles#StopUploadJob``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.stop_upload_job_response.StopUploadJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/upload-jobs/{JobId}/stop"
...
async def async_stop_upload_job(
