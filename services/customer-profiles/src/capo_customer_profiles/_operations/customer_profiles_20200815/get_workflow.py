"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetWorkflow``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_workflow_response.GetWorkflowResponse = (
        capo_customer_profiles.types.get_workflow_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/workflows/{WorkflowId}"
