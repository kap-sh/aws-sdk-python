...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_event_triggers_response.ListEventTriggersResponse = capo_customer_profiles.types.list_event_triggers_response.deserialize_json(
