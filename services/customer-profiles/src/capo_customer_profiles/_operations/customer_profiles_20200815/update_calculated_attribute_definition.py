"""Generated from Smithy shape ``com.amazonaws.customerprofiles#UpdateCalculatedAttributeDefinition``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.update_calculated_attribute_definition_response.UpdateCalculatedAttributeDefinitionResponse = capo_customer_profiles.types.update_calculated_attribute_definition_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.update_calculated_attribute_definition_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_calculated_attribute_definition(
