"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetProfileObjectType``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_profile_object_type_response.GetProfileObjectTypeResponse = capo_customer_profiles.types.get_profile_object_type_response.deserialize_json(
...
async def async_get_profile_object_type(
