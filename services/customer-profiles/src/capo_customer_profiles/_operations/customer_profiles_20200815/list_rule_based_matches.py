"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListRuleBasedMatches``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_rule_based_matches_response.ListRuleBasedMatchesResponse = capo_customer_profiles.types.list_rule_based_matches_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/profiles/ruleBasedMatches"
...
async def async_list_rule_based_matches(
