"""Generated from Smithy shape ``com.amazonaws.customerprofiles#DeleteCalculatedAttributeDefinition``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.delete_calculated_attribute_definition_response.DeleteCalculatedAttributeDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_calculated_attribute_definition(
