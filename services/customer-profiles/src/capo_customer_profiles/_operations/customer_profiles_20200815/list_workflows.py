"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListWorkflows``."""
...
import capo_customer_profiles.types.workflow_list
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_workflows_response.ListWorkflowsResponse = (
        capo_customer_profiles.types.list_workflows_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/workflows"
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.list_workflows_request.serialize_json(input_)
    ).encode()
