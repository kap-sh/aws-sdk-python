"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetAutoMergingPreview``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_auto_merging_preview_response.GetAutoMergingPreviewResponse = capo_customer_profiles.types.get_auto_merging_preview_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.get_auto_merging_preview_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_auto_merging_preview(
