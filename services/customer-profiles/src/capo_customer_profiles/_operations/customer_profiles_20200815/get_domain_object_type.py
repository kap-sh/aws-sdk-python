"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetDomainObjectType``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_domain_object_type_response.GetDomainObjectTypeResponse = capo_customer_profiles.types.get_domain_object_type_response.deserialize_json(
...
async def async_get_domain_object_type(
