"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetCalculatedAttributeDefinition``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_calculated_attribute_definition_response.GetCalculatedAttributeDefinitionResponse = capo_customer_profiles.types.get_calculated_attribute_definition_response.deserialize_json(
...
async def async_get_calculated_attribute_definition(
