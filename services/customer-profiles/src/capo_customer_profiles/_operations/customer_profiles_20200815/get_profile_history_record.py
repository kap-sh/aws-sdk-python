"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetProfileHistoryRecord``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_profile_history_record_response.GetProfileHistoryRecordResponse = capo_customer_profiles.types.get_profile_history_record_response.deserialize_json(
...
async def async_get_profile_history_record(
