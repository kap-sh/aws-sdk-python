"""Generated from Smithy shape ``com.amazonaws.customerprofiles#DeleteDomainObjectType``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.delete_domain_object_type_response.DeleteDomainObjectTypeResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_domain_object_type(
