...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_customer_profiles.types.list_tags_for_resource_response.deserialize_json(
