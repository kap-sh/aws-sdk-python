"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListRecommenderFilters``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_recommender_filters_response.ListRecommenderFiltersResponse = capo_customer_profiles.types.list_recommender_filters_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/recommender-filters"
...
async def async_list_recommender_filters(
