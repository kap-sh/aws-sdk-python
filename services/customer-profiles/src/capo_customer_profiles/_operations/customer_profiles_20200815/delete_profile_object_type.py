"""Generated from Smithy shape ``com.amazonaws.customerprofiles#DeleteProfileObjectType``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.delete_profile_object_type_response.DeleteProfileObjectTypeResponse = capo_customer_profiles.types.delete_profile_object_type_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/domains/{DomainName}/object-types/{ObjectTypeName}"
    )
...
async def async_delete_profile_object_type(
