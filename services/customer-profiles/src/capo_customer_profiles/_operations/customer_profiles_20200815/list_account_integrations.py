...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_account_integrations_response.ListAccountIntegrationsResponse = capo_customer_profiles.types.list_account_integrations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.list_account_integrations_request.serialize_json(
            input_
        )
    ).encode()
