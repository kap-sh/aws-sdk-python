"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetProfileObjectTypeTemplate``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_profile_object_type_template_response.GetProfileObjectTypeTemplateResponse = capo_customer_profiles.types.get_profile_object_type_template_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/templates/{TemplateId}"
...
async def async_get_profile_object_type_template(
