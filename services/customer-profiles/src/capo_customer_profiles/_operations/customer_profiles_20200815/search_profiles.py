...
def handle_response(
    ...
    out: capo_customer_profiles.types.search_profiles_response.SearchProfilesResponse = capo_customer_profiles.types.search_profiles_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.search_profiles_request.serialize_json(input_)
    ).encode()
