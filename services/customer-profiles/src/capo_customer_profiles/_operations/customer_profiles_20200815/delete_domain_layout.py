"""Generated from Smithy shape ``com.amazonaws.customerprofiles#DeleteDomainLayout``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.delete_domain_layout_response.DeleteDomainLayoutResponse = capo_customer_profiles.types.delete_domain_layout_response.deserialize_json(
...
async def async_delete_domain_layout(
