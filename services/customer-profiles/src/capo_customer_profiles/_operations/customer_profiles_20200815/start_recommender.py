"""Generated from Smithy shape ``com.amazonaws.customerprofiles#StartRecommender``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.start_recommender_response.StartRecommenderResponse = {}  # type: ignore[typeddict-item]
    return out
