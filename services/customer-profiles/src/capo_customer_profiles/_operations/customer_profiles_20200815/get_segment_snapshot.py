...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_segment_snapshot_response.GetSegmentSnapshotResponse = capo_customer_profiles.types.get_segment_snapshot_response.deserialize_json(
