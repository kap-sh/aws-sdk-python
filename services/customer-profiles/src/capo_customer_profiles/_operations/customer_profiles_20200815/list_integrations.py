"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListIntegrations``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_integrations_response.ListIntegrationsResponse = capo_customer_profiles.types.list_integrations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/integrations"
