...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_similar_profiles_response.GetSimilarProfilesResponse = capo_customer_profiles.types.get_similar_profiles_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.get_similar_profiles_request.serialize_json(input_)
    ).encode()
