"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetWorkflowSteps``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_workflow_steps_response.GetWorkflowStepsResponse = capo_customer_profiles.types.get_workflow_steps_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/domains/{DomainName}/workflows/{WorkflowId}/steps"
    )
...
async def async_get_workflow_steps(
