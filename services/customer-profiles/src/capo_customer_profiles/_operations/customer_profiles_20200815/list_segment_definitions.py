"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListSegmentDefinitions``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_segment_definitions_response.ListSegmentDefinitionsResponse = capo_customer_profiles.types.list_segment_definitions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/segment-definitions"
...
async def async_list_segment_definitions(
