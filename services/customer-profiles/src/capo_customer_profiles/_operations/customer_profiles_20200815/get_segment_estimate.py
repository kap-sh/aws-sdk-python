"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetSegmentEstimate``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_segment_estimate_response.GetSegmentEstimateResponse = capo_customer_profiles.types.get_segment_estimate_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{EstimateId}", quote(str(input_["estimate_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_get_segment_estimate(
