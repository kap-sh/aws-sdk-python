"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListProfileObjectTypes``."""
...
import capo_customer_profiles.types.profile_object_type_list
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_profile_object_types_response.ListProfileObjectTypesResponse = capo_customer_profiles.types.list_profile_object_types_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/object-types"
...
async def async_list_profile_object_types(
