"""Generated from Smithy shape ``com.amazonaws.customerprofiles#DeleteEventStream``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.delete_event_stream_response.DeleteEventStreamResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_event_stream(
