"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListEventStreams``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_event_streams_response.ListEventStreamsResponse = capo_customer_profiles.types.list_event_streams_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/event-streams"
...
async def async_list_event_streams(
