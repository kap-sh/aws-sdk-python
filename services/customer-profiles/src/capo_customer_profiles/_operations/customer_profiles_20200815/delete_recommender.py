"""Generated from Smithy shape ``com.amazonaws.customerprofiles#DeleteRecommender``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.delete_recommender_response.DeleteRecommenderResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_recommender(
