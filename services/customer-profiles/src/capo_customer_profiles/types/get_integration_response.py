"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetIntegrationResponse``."""
...
class GetIntegrationResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetIntegrationResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetIntegrationResponse:
    out: GetIntegrationResponse = {}  # type: ignore[typeddict-item]
    if "DomainName" in data:
        out["domain_name"] = data["DomainName"]
    else:
        raise DeserializationError("GetIntegrationResponse.domain_name required")
    if "Uri" in data:
        out["uri"] = data["Uri"]
    else:
        raise DeserializationError("GetIntegrationResponse.uri required")
    ...
    if "CreatedAt" in data:
        ...
        raise DeserializationError("GetIntegrationResponse.created_at required")
    if "LastUpdatedAt" in data:
        ...
        raise DeserializationError("GetIntegrationResponse.last_updated_at required")
    if "Tags" in data:
        import capo_customer_profiles.types.tag_map
