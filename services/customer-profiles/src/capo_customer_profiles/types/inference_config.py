...
if TYPE_CHECKING:
    import capo_customer_profiles.types.inference_config_min_provisioned_tps_integer


class InferenceConfig(TypedDict, closed=True):
    min_provisioned_tps: NotRequired[
        "capo_customer_profiles.types.inference_config_min_provisioned_tps_integer.InferenceConfigMinProvisionedTPSInteger"
    ]
