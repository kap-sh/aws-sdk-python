...
class ProfileAttributes(TypedDict, closed=True):
    ...
    additional_information: NotRequired[
        "capo_customer_profiles.types.extra_length_value_profile_dimension.ExtraLengthValueProfileDimension"
    ]
    ...
    birth_date: NotRequired["capo_customer_profiles.types.date_dimension.DateDimension"]
    ...
    address: NotRequired[
        "capo_customer_profiles.types.address_dimension.AddressDimension"
    ]
    ...
    attributes: NotRequired[
        "capo_customer_profiles.types.custom_attributes.CustomAttributes"
    ]
    """<p>A field to describe values to segment on within attributes.</p>"""
    profile_type: NotRequired[
        "capo_customer_profiles.types.profile_type_dimension.ProfileTypeDimension"
    ]
...
def serialize_json(value: ProfileAttributes) -> dict:
    ...
    if "additional_information" in value:
        ...
        out["AdditionalInformation"] = (
            capo_customer_profiles.types.extra_length_value_profile_dimension.serialize_json(
    ...
    if "last_name" in value:
        ...
        out["LastName"] = capo_customer_profiles.types.profile_dimension.serialize_json(
            value["last_name"]
        )
    ...
    if "birth_date" in value:
        ...
        out["BirthDate"] = capo_customer_profiles.types.date_dimension.serialize_json(
            value["birth_date"]
        )
    ...
    if "address" in value:
        ...
        out["Address"] = capo_customer_profiles.types.address_dimension.serialize_json(
            value["address"]
        )
    if "shipping_address" in value:
        ...
        out["ShippingAddress"] = (
            capo_customer_profiles.types.address_dimension.serialize_json(
    ...
    if "attributes" in value:
        ...
        out["Attributes"] = (
            capo_customer_profiles.types.custom_attributes.serialize_json(
                value["attributes"]
            )
        )
    if "profile_type" in value:
        ...
        out["ProfileType"] = (
            capo_customer_profiles.types.profile_type_dimension.serialize_json(
                value["profile_type"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ProfileAttributes:
    ...
    if "AdditionalInformation" in data:
        ...
        out["additional_information"] = (
            capo_customer_profiles.types.extra_length_value_profile_dimension.deserialize_json(
    ...
    if "BirthDate" in data:
        ...
        out["birth_date"] = (
            capo_customer_profiles.types.date_dimension.deserialize_json(
                data["BirthDate"]
            )
        )
    ...
    if "Address" in data:
        ...
        out["address"] = (
            capo_customer_profiles.types.address_dimension.deserialize_json(
                data["Address"]
            )
        )
    ...
    if "Attributes" in data:
        ...
        out["attributes"] = (
            capo_customer_profiles.types.custom_attributes.deserialize_json(
                data["Attributes"]
            )
        )
    if "ProfileType" in data:
        ...
        out["profile_type"] = (
            capo_customer_profiles.types.profile_type_dimension.deserialize_json(
                data["ProfileType"]
            )
        )
    return out
