"""Generated from Smithy shape ``com.amazonaws.customerprofiles#UpdateCalculatedAttributeDefinitionResponse``."""
...
class UpdateCalculatedAttributeDefinitionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateCalculatedAttributeDefinitionResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateCalculatedAttributeDefinitionResponse:
    out: UpdateCalculatedAttributeDefinitionResponse = {}  # type: ignore[typeddict-item]
