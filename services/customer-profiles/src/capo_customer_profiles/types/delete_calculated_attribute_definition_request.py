...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteCalculatedAttributeDefinitionRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DeleteCalculatedAttributeDefinitionRequest:
    out: DeleteCalculatedAttributeDefinitionRequest = {}  # type: ignore[typeddict-item]
    return out
