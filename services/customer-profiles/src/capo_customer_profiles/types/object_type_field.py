...
class ObjectTypeField(TypedDict, closed=True):
    ...
    target: NotRequired["capo_customer_profiles.types.text.text"]
    ...
    content_type: NotRequired[
        "capo_customer_profiles.types.field_content_type.FieldContentType"
    ]
...
def serialize_json(value: ObjectTypeField) -> dict:
    ...
    if "content_type" in value:
        ...
        out["ContentType"] = (
            capo_customer_profiles.types.field_content_type.serialize_json(
                value["content_type"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ObjectTypeField:
    ...
    if "ContentType" in data:
        ...
        out["content_type"] = (
            capo_customer_profiles.types.field_content_type.deserialize_json(
                data["ContentType"]
            )
        )
    return out
