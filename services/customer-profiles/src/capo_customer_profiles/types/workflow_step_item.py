...
if TYPE_CHECKING:
    import capo_customer_profiles.types.appflow_integration_workflow_step


class WorkflowStepItem(TypedDict, closed=True):
    appflow_integration: NotRequired[
        "capo_customer_profiles.types.appflow_integration_workflow_step.AppflowIntegrationWorkflowStep"
    ]
...
def serialize_json(value: WorkflowStepItem) -> dict:
    ...
    if "appflow_integration" in value:
        ...
        out["AppflowIntegration"] = (
            capo_customer_profiles.types.appflow_integration_workflow_step.serialize_json(
...
def deserialize_json(data: dict) -> WorkflowStepItem:
    ...
    if "AppflowIntegration" in data:
        ...
        out["appflow_integration"] = (
            capo_customer_profiles.types.appflow_integration_workflow_step.deserialize_json(
