...
class CustomerProfilesError(Exception):
    """Base class for all CustomerProfiles service errors."""


class ServiceError(CustomerProfilesError):
...
class SerializationError(CustomerProfilesError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CustomerProfilesError):
...
class WaiterFailedError(CustomerProfilesError):
...
class WaiterTimeoutError(CustomerProfilesError):
