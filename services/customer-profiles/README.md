...
```
pip install aws-sdk-customer-profiles
```

## Usage

```python
from aws_sdk_customer_profiles import AsyncCustomerProfilesClient
...
```python
from aws_sdk_customer_profiles import AsyncCustomerProfilesClient
from aws_sdk_customer_profiles.error import AccessDeniedException
