...
class AssociateRepositoryRequest(TypedDict):
...
def serialize_json(value: AssociateRepositoryRequest) -> dict:
    ...
    out["Repository"] = aws_sdk_codeguru_reviewer.types.repository.serialize_json(
        value["repository"]
    )
...
def deserialize_json(data: dict) -> AssociateRepositoryRequest:
    ...
    if "Repository" in data:
        ...
        out["repository"] = aws_sdk_codeguru_reviewer.types.repository.deserialize_json(
            data["Repository"]
        )
    else:
