...
class S3RepositoryDetails(TypedDict):
    ...
    code_artifacts: NotRequired[
        "aws_sdk_codeguru_reviewer.types.code_artifacts.CodeArtifacts"
    ]
...
def serialize_json(value: S3RepositoryDetails) -> dict:
    ...
    if "code_artifacts" in value:
        ...
        out["CodeArtifacts"] = (
            aws_sdk_codeguru_reviewer.types.code_artifacts.serialize_json(
...
def deserialize_json(data: dict) -> S3RepositoryDetails:
    ...
    if "CodeArtifacts" in data:
        ...
        out["code_artifacts"] = (
            aws_sdk_codeguru_reviewer.types.code_artifacts.deserialize_json(
                data["CodeArtifacts"]
            )
        )
    return out
