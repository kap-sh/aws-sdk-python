...
if TYPE_CHECKING:
    ...
    import aws_sdk_codeguru_reviewer.types.request_id
    import aws_sdk_codeguru_reviewer.types.requester
...
def serialize_json(value: RequestMetadata) -> dict:
    ...
    if "event_info" in value:
        ...
        out["EventInfo"] = aws_sdk_codeguru_reviewer.types.event_info.serialize_json(
            value["event_info"]
        )
    if "vendor_name" in value:
        import aws_sdk_codeguru_reviewer.types.vendor_name

        out["VendorName"] = aws_sdk_codeguru_reviewer.types.vendor_name.serialize_json(
            value["vendor_name"]
        )
    return out
...
def deserialize_json(data: dict) -> RequestMetadata:
    ...
    if "EventInfo" in data:
        ...
        out["event_info"] = aws_sdk_codeguru_reviewer.types.event_info.deserialize_json(
            data["EventInfo"]
        )
    if "VendorName" in data:
        ...
        out["vendor_name"] = (
            aws_sdk_codeguru_reviewer.types.vendor_name.deserialize_json(
                data["VendorName"]
            )
        )
    return out
