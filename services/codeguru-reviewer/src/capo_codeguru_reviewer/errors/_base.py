...
class CodeGuruReviewerError(Exception):
    """Base class for all CodeGuruReviewer service errors."""


class ServiceError(CodeGuruReviewerError):
...
class SerializationError(CodeGuruReviewerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CodeGuruReviewerError):
...
class WaiterFailedError(CodeGuruReviewerError):
...
class WaiterTimeoutError(CodeGuruReviewerError):
