...
if TYPE_CHECKING:
    import capo_codeguru_reviewer.types.findings_count
    import capo_codeguru_reviewer.types.lines_of_code_count


class MetricsSummary(TypedDict, closed=True):
    metered_lines_of_code_count: NotRequired[
        "capo_codeguru_reviewer.types.lines_of_code_count.LinesOfCodeCount"
    ]
    ...
    findings_count: NotRequired[
        "capo_codeguru_reviewer.types.findings_count.FindingsCount"
    ]
