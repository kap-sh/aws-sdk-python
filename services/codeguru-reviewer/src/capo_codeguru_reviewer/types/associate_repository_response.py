"""Generated from Smithy shape ``com.amazonaws.codegurureviewer#AssociateRepositoryResponse``."""
...
class AssociateRepositoryResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: AssociateRepositoryResponse) -> dict:
    out: dict = {}
