...
if TYPE_CHECKING:
    ...
    import capo_codeguru_reviewer.types.metrics_summary
...
class CodeReviewSummary(TypedDict, closed=True):
    ...
    metrics_summary: NotRequired[
        "capo_codeguru_reviewer.types.metrics_summary.MetricsSummary"
    ]
...
def serialize_json(value: CodeReviewSummary) -> dict:
    ...
    if "metrics_summary" in value:
        ...
        out["MetricsSummary"] = (
            capo_codeguru_reviewer.types.metrics_summary.serialize_json(
...
def deserialize_json(data: dict) -> CodeReviewSummary:
    ...
    if "MetricsSummary" in data:
        ...
        out["metrics_summary"] = (
            capo_codeguru_reviewer.types.metrics_summary.deserialize_json(
                data["MetricsSummary"]
            )
        )
