...
from aws_sdk_lex_runtime_service._iter import ensure_sync_iterator
...
class LexRuntimeServiceClientConfig(TypedDict, total=False):
...
class LexRuntimeServiceClient:
    ...
    def delete_session(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lex_runtime_service.types.delete_session_request.DeleteSessionRequest]",
        ) -> OperationResponse[
            "aws_sdk_lex_runtime_service.types.delete_session_response.DeleteSessionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lex_runtime_service._operations.aws_deep_sense_run_time_service.delete_session.delete_session(
    ...
    def get_session(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lex_runtime_service.types.get_session_request.GetSessionRequest]",
        ) -> OperationResponse[
            "aws_sdk_lex_runtime_service.types.get_session_response.GetSessionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lex_runtime_service._operations.aws_deep_sense_run_time_service.get_session.get_session(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def post_content(
        ...
        *,
    ...
    ) -> "Generator[aws_sdk_lex_runtime_service.types.post_content_response.PostContentResponse]":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lex_runtime_service.types.post_content_request.PostContentRequest]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                aws_sdk_lex_runtime_service._operations.aws_deep_sense_run_time_service.post_content.post_content(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def post_text(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lex_runtime_service.types.post_text_request.PostTextRequest]",
        ) -> OperationResponse[
            "aws_sdk_lex_runtime_service.types.post_text_response.PostTextResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_lex_runtime_service._operations.aws_deep_sense_run_time_service.post_text.post_text(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_session(
        ...
        *,
    ...
    ) -> "Generator[aws_sdk_lex_runtime_service.types.put_session_response.PutSessionResponse]":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_lex_runtime_service.types.put_session_request.PutSessionRequest]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                aws_sdk_lex_runtime_service._operations.aws_deep_sense_run_time_service.put_session.put_session(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
