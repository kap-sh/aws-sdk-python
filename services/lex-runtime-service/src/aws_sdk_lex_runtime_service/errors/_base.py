...
class LexRuntimeServiceError(Exception):
    """Base class for all LexRuntimeService service errors."""


class ServiceError(LexRuntimeServiceError):
...
class SerializationError(LexRuntimeServiceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(LexRuntimeServiceError):
...
class WaiterFailedError(LexRuntimeServiceError):
...
class WaiterTimeoutError(LexRuntimeServiceError):
