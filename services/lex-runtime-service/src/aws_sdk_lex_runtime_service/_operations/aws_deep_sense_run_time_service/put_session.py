...
def handle_response(
    ...
    out: aws_sdk_lex_runtime_service.types.put_session_response.PutSessionResponse = {
        "audio_stream": _iter
    }
...
def build_request(
    ...
    input: aws_sdk_lex_runtime_service.types.put_session_request.PutSessionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_runtime_service.types.put_session_request.serialize_json(input)
    ).encode()
