...
def handle_response(
    ...
    out: aws_sdk_lex_runtime_service.types.get_session_response.GetSessionResponse = (
        aws_sdk_lex_runtime_service.types.get_session_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lex_runtime_service.types.get_session_request.GetSessionRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "checkpoint_label_filter" in input:
        params["checkpointLabelFilter"] = str(input["checkpoint_label_filter"])
