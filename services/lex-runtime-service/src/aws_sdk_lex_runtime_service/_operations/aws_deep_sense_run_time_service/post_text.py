"""Generated from Smithy shape ``com.amazonaws.lexruntimeservice#PostText``."""
...
import aws_sdk_lex_runtime_service.types.intent_list
...
import aws_sdk_lex_runtime_service.types.response_card
import aws_sdk_lex_runtime_service.types.sentiment_response
...
def handle_response(
    ...
    out: aws_sdk_lex_runtime_service.types.post_text_response.PostTextResponse = (
        aws_sdk_lex_runtime_service.types.post_text_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_runtime_service.types.post_text_request.PostTextRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/bot/{botName}/alias/{botAlias}/user/{userId}/text"
    )
