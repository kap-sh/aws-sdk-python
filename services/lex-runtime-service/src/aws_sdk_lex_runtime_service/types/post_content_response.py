...
if TYPE_CHECKING:
    ...
    import aws_sdk_lex_runtime_service.types.sensitive_string_unbounded
...
class PostContentResponse(TypedDict):
    ...
    sentiment_response: NotRequired["aws_sdk_lex_runtime_service.types.string.String"]
    ...
    input_transcript: NotRequired["aws_sdk_lex_runtime_service.types.string.String"]
    ...
    encoded_input_transcript: NotRequired[
        "aws_sdk_lex_runtime_service.types.sensitive_string_unbounded.SensitiveStringUnbounded"
    ]
