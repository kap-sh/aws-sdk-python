...
if TYPE_CHECKING:
    ...
    import aws_sdk_lex_runtime_service.types.bot_version
...
class PostTextResponse(TypedDict):
    ...
    alternative_intents: NotRequired[
        "aws_sdk_lex_runtime_service.types.intent_list.IntentList"
    ]
    ...
    sentiment_response: NotRequired[
        "aws_sdk_lex_runtime_service.types.sentiment_response.SentimentResponse"
    ]
    ...
    response_card: NotRequired[
        "aws_sdk_lex_runtime_service.types.response_card.ResponseCard"
    ]
    ...
    bot_version: NotRequired["aws_sdk_lex_runtime_service.types.bot_version.BotVersion"]
...
def serialize_json(value: PostTextResponse) -> dict:
    ...
    if "alternative_intents" in value:
        ...
        out["alternativeIntents"] = (
            aws_sdk_lex_runtime_service.types.intent_list.serialize_json(
    ...
    if "sentiment_response" in value:
        ...
        out["sentimentResponse"] = (
            aws_sdk_lex_runtime_service.types.sentiment_response.serialize_json(
    ...
    if "dialog_state" in value:
        ...
        out["dialogState"] = (
            aws_sdk_lex_runtime_service.types.dialog_state.serialize_json(
                value["dialog_state"]
            )
        )
    ...
    if "response_card" in value:
        ...
        out["responseCard"] = (
            aws_sdk_lex_runtime_service.types.response_card.serialize_json(
                value["response_card"]
            )
        )
...
def deserialize_json(data: dict) -> PostTextResponse:
    ...
    if "alternativeIntents" in data:
        ...
        out["alternative_intents"] = (
            aws_sdk_lex_runtime_service.types.intent_list.deserialize_json(
    ...
    if "sentimentResponse" in data:
        ...
        out["sentiment_response"] = (
            aws_sdk_lex_runtime_service.types.sentiment_response.deserialize_json(
    ...
    if "responseCard" in data:
        ...
        out["response_card"] = (
            aws_sdk_lex_runtime_service.types.response_card.deserialize_json(
                data["responseCard"]
            )
        )
