...
if TYPE_CHECKING:
    import capo_lex_runtime_service.types.generic_attachment

genericAttachmentList: TypeAlias = list[
    "capo_lex_runtime_service.types.generic_attachment.GenericAttachment"
]
...
def serialize_json(value: genericAttachmentList) -> list:
    ...
    for item in value:
        out.append(
            capo_lex_runtime_service.types.generic_attachment.serialize_json(item)
        )
    return out
