...
if TYPE_CHECKING:
    import capo_lex_runtime_service.types.active_context_time_to_live_in_seconds
    import capo_lex_runtime_service.types.active_context_turns_to_live


class ActiveContextTimeToLive(TypedDict, closed=True):
    time_to_live_in_seconds: NotRequired[
        "capo_lex_runtime_service.types.active_context_time_to_live_in_seconds.ActiveContextTimeToLiveInSeconds"
    ]
