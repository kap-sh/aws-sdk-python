...
def handle_response(
    ...
    out: capo_lex_runtime_service.types.post_text_response.PostTextResponse = (
        capo_lex_runtime_service.types.post_text_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_runtime_service.types.post_text_request.serialize_json(input_)
    ).encode()
...
def post_text(
    ...
    capo_lex_runtime_service.types.post_text_response.PostTextResponse, zapros.Response
]:
