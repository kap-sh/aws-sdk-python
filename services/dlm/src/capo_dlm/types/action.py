...
if TYPE_CHECKING:
    import capo_dlm.types.action_name
    import capo_dlm.types.cross_region_copy_action_list


class Action(TypedDict, closed=True):
    name: NotRequired["capo_dlm.types.action_name.ActionName"]
    """<p>A descriptive name for the action.</p>"""
    cross_region_copy: NotRequired[
        "capo_dlm.types.cross_region_copy_action_list.CrossRegionCopyActionList"
    ]
...
def serialize_json(value: Action) -> dict:
    ...
    if "cross_region_copy" in value:
        ...
        out["CrossRegionCopy"] = (
            capo_dlm.types.cross_region_copy_action_list.serialize_json(
...
def deserialize_json(data: dict) -> Action:
    ...
    if "CrossRegionCopy" in data:
        ...
        out["cross_region_copy"] = (
            capo_dlm.types.cross_region_copy_action_list.deserialize_json(
