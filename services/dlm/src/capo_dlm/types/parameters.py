...
if TYPE_CHECKING:
    import capo_dlm.types.exclude_boot_volume
    import capo_dlm.types.exclude_data_volume_tag_list
    import capo_dlm.types.no_reboot


class Parameters(TypedDict, closed=True):
    exclude_boot_volume: NotRequired[
        "capo_dlm.types.exclude_boot_volume.ExcludeBootVolume"
    ]
    ...
    no_reboot: NotRequired["capo_dlm.types.no_reboot.NoReboot"]
    ...
    exclude_data_volume_tags: NotRequired[
        "capo_dlm.types.exclude_data_volume_tag_list.ExcludeDataVolumeTagList"
    ]
...
def serialize_json(value: Parameters) -> dict:
    ...
    if "exclude_data_volume_tags" in value:
        ...
        out["ExcludeDataVolumeTags"] = (
            capo_dlm.types.exclude_data_volume_tag_list.serialize_json(
...
def deserialize_json(data: dict) -> Parameters:
    ...
    if "ExcludeDataVolumeTags" in data:
        ...
        out["exclude_data_volume_tags"] = (
            capo_dlm.types.exclude_data_volume_tag_list.deserialize_json(
