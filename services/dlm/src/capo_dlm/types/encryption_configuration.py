...
if TYPE_CHECKING:
    import capo_dlm.types.cmk_arn
    import capo_dlm.types.encrypted


class EncryptionConfiguration(TypedDict, closed=True):
    encrypted: NotRequired["capo_dlm.types.encrypted.Encrypted"]
    ...
    cmk_arn: NotRequired["capo_dlm.types.cmk_arn.CmkArn"]
