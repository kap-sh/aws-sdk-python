"""Generated from Smithy shape ``com.amazonaws.dlm#GetLifecyclePolicy``."""
...
def handle_response(
    ...
    out: capo_dlm.types.get_lifecycle_policy_response.GetLifecyclePolicyResponse = (
        capo_dlm.types.get_lifecycle_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/policies/{PolicyId}"
