"""Generated from Smithy shape ``com.amazonaws.dlm#UntagResource``."""
...
def handle_response(
    ...
    out: capo_dlm.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_dlm.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
