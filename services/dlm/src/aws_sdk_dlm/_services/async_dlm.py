...
from aws_sdk_dlm._auth._identity import Credentials
from aws_sdk_dlm._auth._providers import (
    CredentialsProvider,
    IdentityProvider,
...
from aws_sdk_dlm._services._aws_config import aaws_config
...
if TYPE_CHECKING:
    ...
    import aws_sdk_dlm.types.delete_lifecycle_policy_request
    import aws_sdk_dlm.types.delete_lifecycle_policy_response
    ...
    import aws_sdk_dlm.types.get_lifecycle_policy_request
    import aws_sdk_dlm.types.get_lifecycle_policy_response
    import aws_sdk_dlm.types.gettable_policy_state_values
    import aws_sdk_dlm.types.list_tags_for_resource_request
    import aws_sdk_dlm.types.list_tags_for_resource_response
    ...
    import aws_sdk_dlm.types.tag_key_list
    ...
    import aws_sdk_dlm.types.untag_resource_request
    import aws_sdk_dlm.types.untag_resource_response
    import aws_sdk_dlm.types.update_lifecycle_policy_request
    import aws_sdk_dlm.types.update_lifecycle_policy_response


class AsyncDLMClientConfig(TypedDict, total=False):
...
class AsyncDLMClient:
    ...
    async def create_lifecycle_policy(
        self,
        execution_role_arn: "aws_sdk_dlm.types.execution_role_arn.ExecutionRoleArn",
        description: "aws_sdk_dlm.types.policy_description.PolicyDescription",
        state: "aws_sdk_dlm.types.settable_policy_state_values.SettablePolicyStateValues",
        *,
        config_overrides: Optional[AsyncDLMClientConfig] = None,
        policy_details: Optional[
            "aws_sdk_dlm.types.policy_details.PolicyDetails"
        ] = None,
        tags: Optional["aws_sdk_dlm.types.tag_map.TagMap"] = None,
        default_policy: Optional[
            "aws_sdk_dlm.types.default_policy_type_values.DefaultPolicyTypeValues"
        ] = None,
        create_interval: Optional[
            "aws_sdk_dlm.types.create_interval.CreateInterval"
        ] = None,
        retain_interval: Optional[
            "aws_sdk_dlm.types.retain_interval.RetainInterval"
        ] = None,
        copy_tags: Optional[
            "aws_sdk_dlm.types.copy_tags_nullable.CopyTagsNullable"
        ] = None,
        extend_deletion: Optional[
            "aws_sdk_dlm.types.extend_deletion.ExtendDeletion"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_dlm.types.create_lifecycle_policy_request.CreateLifecyclePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_dlm.types.create_lifecycle_policy_response.CreateLifecyclePolicyResponse"
        ]:
            import aws_sdk_dlm._operations.dlm_20180112.create_lifecycle_policy

            (
                output,
                http_response,
            ) = await aws_sdk_dlm._operations.dlm_20180112.create_lifecycle_policy.async_create_lifecycle_policy(
    ...
    async def delete_lifecycle_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_dlm.types.delete_lifecycle_policy_request.DeleteLifecyclePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_dlm.types.delete_lifecycle_policy_response.DeleteLifecyclePolicyResponse"
        ]:
            import aws_sdk_dlm._operations.dlm_20180112.delete_lifecycle_policy

            (
                output,
                http_response,
            ) = await aws_sdk_dlm._operations.dlm_20180112.delete_lifecycle_policy.async_delete_lifecycle_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_lifecycle_policies(
        ...
        *,
        config_overrides: Optional[AsyncDLMClientConfig] = None,
        policy_ids: Optional["aws_sdk_dlm.types.policy_id_list.PolicyIdList"] = None,
        state: Optional[
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_dlm.types.get_lifecycle_policies_request.GetLifecyclePoliciesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_dlm.types.get_lifecycle_policies_response.GetLifecyclePoliciesResponse"
        ]:
            import aws_sdk_dlm._operations.dlm_20180112.get_lifecycle_policies

            (
                output,
                http_response,
            ) = await aws_sdk_dlm._operations.dlm_20180112.get_lifecycle_policies.async_get_lifecycle_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_lifecycle_policy(
        ...
        *,
        config_overrides: Optional[AsyncDLMClientConfig] = None,
    ) -> "aws_sdk_dlm.types.get_lifecycle_policy_response.GetLifecyclePolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_dlm.types.get_lifecycle_policy_request.GetLifecyclePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_dlm.types.get_lifecycle_policy_response.GetLifecyclePolicyResponse"
        ]:
            import aws_sdk_dlm._operations.dlm_20180112.get_lifecycle_policy

            (
                output,
                http_response,
            ) = await aws_sdk_dlm._operations.dlm_20180112.get_lifecycle_policy.async_get_lifecycle_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        "aws_sdk_dlm.types.list_tags_for_resource_response.ListTagsForResourceResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_dlm.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_dlm.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_dlm._operations.dlm_20180112.list_tags_for_resource

            (
                output,
                http_response,
            ) = await aws_sdk_dlm._operations.dlm_20180112.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        self,
        resource_arn: "aws_sdk_dlm.types.policy_arn.PolicyArn",
        tags: "aws_sdk_dlm.types.tag_map.TagMap",
        *,
        config_overrides: Optional[AsyncDLMClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_dlm.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_dlm.types.tag_resource_response.TagResourceResponse"
        ]:
            import aws_sdk_dlm._operations.dlm_20180112.tag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_dlm._operations.dlm_20180112.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        self,
        resource_arn: "aws_sdk_dlm.types.policy_arn.PolicyArn",
        tag_keys: "aws_sdk_dlm.types.tag_key_list.TagKeyList",
        *,
        config_overrides: Optional[AsyncDLMClientConfig] = None,
    ) -> "aws_sdk_dlm.types.untag_resource_response.UntagResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_dlm.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_dlm.types.untag_resource_response.UntagResourceResponse"
        ]:
            import aws_sdk_dlm._operations.dlm_20180112.untag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_dlm._operations.dlm_20180112.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_lifecycle_policy(
        ...
        *,
        ...
        description: Optional[
            "aws_sdk_dlm.types.policy_description.PolicyDescription"
        ] = None,
        policy_details: Optional[
            "aws_sdk_dlm.types.policy_details.PolicyDetails"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_dlm.types.update_lifecycle_policy_request.UpdateLifecyclePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_dlm.types.update_lifecycle_policy_response.UpdateLifecyclePolicyResponse"
        ]:
            import aws_sdk_dlm._operations.dlm_20180112.update_lifecycle_policy

            (
                output,
                http_response,
            ) = await aws_sdk_dlm._operations.dlm_20180112.update_lifecycle_policy.async_update_lifecycle_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
