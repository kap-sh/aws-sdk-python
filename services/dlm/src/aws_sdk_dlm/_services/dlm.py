...
from aws_sdk_dlm._services._aws_config import aws_config
...
class DLMClientConfig(TypedDict, total=False):
...
class DLMClient:
    ...
    def create_lifecycle_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dlm.types.create_lifecycle_policy_request.CreateLifecyclePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_dlm.types.create_lifecycle_policy_response.CreateLifecyclePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dlm._operations.dlm_20180112.create_lifecycle_policy.create_lifecycle_policy(
    ...
    def delete_lifecycle_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dlm.types.delete_lifecycle_policy_request.DeleteLifecyclePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_dlm.types.delete_lifecycle_policy_response.DeleteLifecyclePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dlm._operations.dlm_20180112.delete_lifecycle_policy.delete_lifecycle_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_lifecycle_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dlm.types.get_lifecycle_policies_request.GetLifecyclePoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_dlm.types.get_lifecycle_policies_response.GetLifecyclePoliciesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dlm._operations.dlm_20180112.get_lifecycle_policies.get_lifecycle_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_lifecycle_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dlm.types.get_lifecycle_policy_request.GetLifecyclePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_dlm.types.get_lifecycle_policy_response.GetLifecyclePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dlm._operations.dlm_20180112.get_lifecycle_policy.get_lifecycle_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dlm.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_dlm.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dlm._operations.dlm_20180112.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dlm.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_dlm.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dlm._operations.dlm_20180112.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dlm.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_dlm.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dlm._operations.dlm_20180112.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_lifecycle_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_dlm.types.update_lifecycle_policy_request.UpdateLifecyclePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_dlm.types.update_lifecycle_policy_response.UpdateLifecyclePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_dlm._operations.dlm_20180112.update_lifecycle_policy.update_lifecycle_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
