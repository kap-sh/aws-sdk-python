...
if TYPE_CHECKING:
    ...
    import aws_sdk_dlm.types.event_source
    import aws_sdk_dlm.types.exclusions
    import aws_sdk_dlm.types.extend_deletion
    import aws_sdk_dlm.types.parameters
    import aws_sdk_dlm.types.policy_language_values
    import aws_sdk_dlm.types.policy_type_values
    import aws_sdk_dlm.types.resource_location_list
    ...
    import aws_sdk_dlm.types.schedule_list
...
class PolicyDetails(TypedDict):
    ...
    resource_locations: NotRequired[
        "aws_sdk_dlm.types.resource_location_list.ResourceLocationList"
    ]
    ...
    target_tags: NotRequired["aws_sdk_dlm.types.target_tag_list.TargetTagList"]
    """<p> <b>[Custom snapshot and AMI policies only]</b> The single tag that identifies targeted resources for this policy.</p>"""
    schedules: NotRequired["aws_sdk_dlm.types.schedule_list.ScheduleList"]
    ...
    parameters: NotRequired["aws_sdk_dlm.types.parameters.Parameters"]
    ...
    event_source: NotRequired["aws_sdk_dlm.types.event_source.EventSource"]
    """<p> <b>[Event-based policies only]</b> The event that activates the event-based policy.</p>"""
    actions: NotRequired["aws_sdk_dlm.types.action_list.ActionList"]
    ...
    policy_language: NotRequired[
        "aws_sdk_dlm.types.policy_language_values.PolicyLanguageValues"
    ]
...
def serialize_json(value: PolicyDetails) -> dict:
    ...
    if "resource_types" in value:
        ...
        out["ResourceTypes"] = (
            aws_sdk_dlm.types.resource_type_values_list.serialize_json(
    ...
    if "resource_locations" in value:
        ...
        out["ResourceLocations"] = (
            aws_sdk_dlm.types.resource_location_list.serialize_json(
    ...
    if "target_tags" in value:
        ...
        out["TargetTags"] = aws_sdk_dlm.types.target_tag_list.serialize_json(
            value["target_tags"]
        )
    if "schedules" in value:
        import aws_sdk_dlm.types.schedule_list

        out["Schedules"] = aws_sdk_dlm.types.schedule_list.serialize_json(
            value["schedules"]
        )
    if "parameters" in value:
        import aws_sdk_dlm.types.parameters

        out["Parameters"] = aws_sdk_dlm.types.parameters.serialize_json(
            value["parameters"]
        )
    if "event_source" in value:
        import aws_sdk_dlm.types.event_source

        out["EventSource"] = aws_sdk_dlm.types.event_source.serialize_json(
            value["event_source"]
        )
    if "actions" in value:
        import aws_sdk_dlm.types.action_list

        out["Actions"] = aws_sdk_dlm.types.action_list.serialize_json(value["actions"])
    if "policy_language" in value:
        import aws_sdk_dlm.types.policy_language_values

        out["PolicyLanguage"] = aws_sdk_dlm.types.policy_language_values.serialize_json(
            value["policy_language"]
        )
    if "resource_type" in value:
        import aws_sdk_dlm.types.resource_type_values

        out["ResourceType"] = aws_sdk_dlm.types.resource_type_values.serialize_json(
            value["resource_type"]
        )
...
def deserialize_json(data: dict) -> PolicyDetails:
    ...
    if "ResourceTypes" in data:
        ...
        out["resource_types"] = (
            aws_sdk_dlm.types.resource_type_values_list.deserialize_json(
                data["ResourceTypes"]
            )
        )
    if "ResourceLocations" in data:
        ...
        out["resource_locations"] = (
            aws_sdk_dlm.types.resource_location_list.deserialize_json(
    ...
    if "TargetTags" in data:
        ...
        out["target_tags"] = aws_sdk_dlm.types.target_tag_list.deserialize_json(
            data["TargetTags"]
        )
    if "Schedules" in data:
        import aws_sdk_dlm.types.schedule_list

        out["schedules"] = aws_sdk_dlm.types.schedule_list.deserialize_json(
            data["Schedules"]
        )
    if "Parameters" in data:
        import aws_sdk_dlm.types.parameters

        out["parameters"] = aws_sdk_dlm.types.parameters.deserialize_json(
            data["Parameters"]
        )
    if "EventSource" in data:
        import aws_sdk_dlm.types.event_source

        out["event_source"] = aws_sdk_dlm.types.event_source.deserialize_json(
            data["EventSource"]
        )
    if "Actions" in data:
        import aws_sdk_dlm.types.action_list

        out["actions"] = aws_sdk_dlm.types.action_list.deserialize_json(data["Actions"])
    if "PolicyLanguage" in data:
        import aws_sdk_dlm.types.policy_language_values

        out["policy_language"] = (
            aws_sdk_dlm.types.policy_language_values.deserialize_json(
                data["PolicyLanguage"]
            )
        )
    if "ResourceType" in data:
        ...
        out["resource_type"] = aws_sdk_dlm.types.resource_type_values.deserialize_json(
            data["ResourceType"]
        )
