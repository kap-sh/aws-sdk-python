...
if TYPE_CHECKING:
    ...
    import aws_sdk_dlm.types.execution_handler
    import aws_sdk_dlm.types.execution_handler_service_values
    import aws_sdk_dlm.types.script_execution_timeout
    import aws_sdk_dlm.types.script_maximum_retry_count
...
class Script(TypedDict):
    ...
    execution_handler_service: NotRequired[
        "aws_sdk_dlm.types.execution_handler_service_values.ExecutionHandlerServiceValues"
    ]
    ...
    execution_handler: NotRequired[
        "aws_sdk_dlm.types.execution_handler.ExecutionHandler"
    ]
    ...
    execute_operation_on_script_failure: NotRequired[
        "aws_sdk_dlm.types.execute_operation_on_script_failure.ExecuteOperationOnScriptFailure"
    ]
    ...
    execution_timeout: NotRequired[
        "aws_sdk_dlm.types.script_execution_timeout.ScriptExecutionTimeout"
    ]
    ...
    maximum_retry_count: NotRequired[
        "aws_sdk_dlm.types.script_maximum_retry_count.ScriptMaximumRetryCount"
    ]
...
def serialize_json(value: Script) -> dict:
    ...
    if "stages" in value:
        ...
        out["Stages"] = aws_sdk_dlm.types.stages_list.serialize_json(value["stages"])
    if "execution_handler_service" in value:
        import aws_sdk_dlm.types.execution_handler_service_values

        out["ExecutionHandlerService"] = (
            aws_sdk_dlm.types.execution_handler_service_values.serialize_json(
...
def deserialize_json(data: dict) -> Script:
    ...
    if "Stages" in data:
        ...
        out["stages"] = aws_sdk_dlm.types.stages_list.deserialize_json(data["Stages"])
    if "ExecutionHandlerService" in data:
        import aws_sdk_dlm.types.execution_handler_service_values

        out["execution_handler_service"] = (
            aws_sdk_dlm.types.execution_handler_service_values.deserialize_json(
