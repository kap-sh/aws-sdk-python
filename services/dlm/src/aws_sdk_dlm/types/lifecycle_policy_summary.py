...
if TYPE_CHECKING:
    ...
    import aws_sdk_dlm.types.policy_type_values
...
def serialize_json(value: LifecyclePolicySummary) -> dict:
    ...
    if "policy_type" in value:
        ...
        out["PolicyType"] = aws_sdk_dlm.types.policy_type_values.serialize_json(
            value["policy_type"]
        )
...
def deserialize_json(data: dict) -> LifecyclePolicySummary:
    ...
    if "PolicyType" in data:
        ...
        out["policy_type"] = aws_sdk_dlm.types.policy_type_values.deserialize_json(
            data["PolicyType"]
        )
