...
if TYPE_CHECKING:
    ...
    import aws_sdk_dlm.types.share_target_account_list


class ShareRule(TypedDict):
    target_accounts: NotRequired[
        "aws_sdk_dlm.types.share_target_account_list.ShareTargetAccountList"
    ]
    """<p>The IDs of the Amazon Web Services accounts with which to share the snapshots.</p>"""
    unshare_interval: NotRequired["aws_sdk_dlm.types.interval.Interval"]
...
def serialize_json(value: ShareRule) -> dict:
    ...
    if "target_accounts" in value:
        ...
        out["TargetAccounts"] = (
            aws_sdk_dlm.types.share_target_account_list.serialize_json(
...
def deserialize_json(data: dict) -> ShareRule:
    ...
    if "TargetAccounts" in data:
        ...
        out["target_accounts"] = (
            aws_sdk_dlm.types.share_target_account_list.deserialize_json(
                data["TargetAccounts"]
            )
        )
