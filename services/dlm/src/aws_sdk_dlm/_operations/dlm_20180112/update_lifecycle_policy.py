...
def handle_response(
    ...
    out: aws_sdk_dlm.types.update_lifecycle_policy_response.UpdateLifecyclePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_dlm.types.update_lifecycle_policy_request.UpdateLifecyclePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dlm.types.update_lifecycle_policy_request.serialize_json(input_)
    ).encode()
