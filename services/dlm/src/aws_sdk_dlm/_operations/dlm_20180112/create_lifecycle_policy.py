...
def build_request(
    ...
    input: aws_sdk_dlm.types.create_lifecycle_policy_request.CreateLifecyclePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_dlm.types.create_lifecycle_policy_request.serialize_json(input)
    ).encode()
