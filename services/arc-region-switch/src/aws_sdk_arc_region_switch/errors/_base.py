...
class ARCRegionswitchError(Exception):
    """Base class for all ARCRegionswitch service errors."""


class ServiceError(ARCRegionswitchError):
...
class SerializationError(ARCRegionswitchError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ARCRegionswitchError):
...
class WaiterFailedError(ARCRegionswitchError):
...
class WaiterTimeoutError(ARCRegionswitchError):
