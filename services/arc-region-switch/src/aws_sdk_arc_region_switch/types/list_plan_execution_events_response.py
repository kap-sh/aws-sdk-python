...
if TYPE_CHECKING:
    import aws_sdk_arc_region_switch.types.execution_event_list


class ListPlanExecutionEventsResponse(TypedDict):
    items: NotRequired[
        "aws_sdk_arc_region_switch.types.execution_event_list.ExecutionEventList"
    ]
...
def serialize_aws_json_1_0(value: ListPlanExecutionEventsResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = (
            aws_sdk_arc_region_switch.types.execution_event_list.serialize_aws_json_1_0(
                value["items"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListPlanExecutionEventsResponse:
    ...
    if "items" in data:
        ...
        out["items"] = (
            aws_sdk_arc_region_switch.types.execution_event_list.deserialize_aws_json_1_0(
                data["items"]
            )
        )
