...
if TYPE_CHECKING:
    ...
    import aws_sdk_arc_region_switch.types.region_aurora_instance_arn_map


class AuroraProvisionedScalingConfiguration(TypedDict):
    timeout_minutes: "int"
    ...
    instance_arns: "aws_sdk_arc_region_switch.types.region_aurora_instance_arn_map.RegionAuroraInstanceArnMap"
...
def serialize_aws_json_1_0(value: AuroraProvisionedScalingConfiguration) -> dict:
    ...
    out["instanceArns"] = (
        aws_sdk_arc_region_switch.types.region_aurora_instance_arn_map.serialize_aws_json_1_0(
            value["instance_arns"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> AuroraProvisionedScalingConfiguration:
    ...
    if "instanceArns" in data:
        ...
        out["instance_arns"] = (
            aws_sdk_arc_region_switch.types.region_aurora_instance_arn_map.deserialize_aws_json_1_0(
                data["instanceArns"]
            )
        )
    else:
