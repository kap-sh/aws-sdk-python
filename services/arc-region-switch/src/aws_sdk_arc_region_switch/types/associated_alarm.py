...
if TYPE_CHECKING:
    import aws_sdk_arc_region_switch.types.alarm_type
    import aws_sdk_arc_region_switch.types.iam_role_arn


class AssociatedAlarm(TypedDict):
    ...
    alarm_type: "aws_sdk_arc_region_switch.types.alarm_type.AlarmType"
...
def serialize_aws_json_1_0(value: AssociatedAlarm) -> dict:
    ...
    out["alarmType"] = (
        aws_sdk_arc_region_switch.types.alarm_type.serialize_aws_json_1_0(
            value["alarm_type"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> AssociatedAlarm:
    ...
    if "alarmType" in data:
        ...
        out["alarm_type"] = (
            aws_sdk_arc_region_switch.types.alarm_type.deserialize_aws_json_1_0(
                data["alarmType"]
            )
        )
    else:
