...
if TYPE_CHECKING:
    ...
    import aws_sdk_arc_region_switch.types.trigger_condition_list
...
class Trigger(TypedDict):
    ...
    target_region: "aws_sdk_arc_region_switch.types.region.Region"
    ...
    conditions: (
        "aws_sdk_arc_region_switch.types.trigger_condition_list.TriggerConditionList"
    )
...
def serialize_aws_json_1_0(value: Trigger) -> dict:
    ...
    out["conditions"] = (
        aws_sdk_arc_region_switch.types.trigger_condition_list.serialize_aws_json_1_0(
            value["conditions"]
        )
    )
...
def deserialize_aws_json_1_0(data: dict) -> Trigger:
    ...
    if "conditions" in data:
        ...
        out["conditions"] = (
            aws_sdk_arc_region_switch.types.trigger_condition_list.deserialize_aws_json_1_0(
                data["conditions"]
            )
        )
    else:
