...
ExecutionEventList: TypeAlias = list[
    "aws_sdk_arc_region_switch.types.execution_event.ExecutionEvent"
]
...
def serialize_aws_json_1_0(value: ExecutionEventList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_arc_region_switch.types.execution_event.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ExecutionEventList:
    ...
    for item in data:
        out.append(
            aws_sdk_arc_region_switch.types.execution_event.deserialize_aws_json_1_0(
                item
            )
        )
    return out
