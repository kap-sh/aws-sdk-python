...
def serialize_aws_json_1_0(value: LambdaEventSourceMappingUngraceful) -> dict:
    ...
    out["behavior"] = (
        aws_sdk_arc_region_switch.types.lambda_event_source_mapping_ungraceful_behavior.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> LambdaEventSourceMappingUngraceful:
    ...
    if "behavior" in data:
        ...
        out["behavior"] = (
            aws_sdk_arc_region_switch.types.lambda_event_source_mapping_ungraceful_behavior.deserialize_aws_json_1_0(
                data["behavior"]
            )
        )
    else:
