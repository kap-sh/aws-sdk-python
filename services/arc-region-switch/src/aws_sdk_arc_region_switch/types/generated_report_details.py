...
if TYPE_CHECKING:
    import aws_sdk_arc_region_switch.types.generated_report

GeneratedReportDetails: TypeAlias = list[
    "aws_sdk_arc_region_switch.types.generated_report.GeneratedReport"
]
...
def serialize_aws_json_1_0(value: GeneratedReportDetails) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_arc_region_switch.types.generated_report.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> GeneratedReportDetails:
    ...
    for item in data:
        out.append(
            aws_sdk_arc_region_switch.types.generated_report.deserialize_aws_json_1_0(
                item
            )
        )
    return out
