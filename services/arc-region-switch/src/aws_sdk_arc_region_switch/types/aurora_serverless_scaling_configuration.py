...
if TYPE_CHECKING:
    ...
    import aws_sdk_arc_region_switch.types.region_aurora_cluster_map


class AuroraServerlessScalingConfiguration(TypedDict):
    timeout_minutes: "int"
    ...
    region_database_cluster_arns: "aws_sdk_arc_region_switch.types.region_aurora_cluster_map.RegionAuroraClusterMap"
...
def serialize_aws_json_1_0(value: AuroraServerlessScalingConfiguration) -> dict:
    ...
    out["regionDatabaseClusterArns"] = (
        aws_sdk_arc_region_switch.types.region_aurora_cluster_map.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> AuroraServerlessScalingConfiguration:
    ...
    if "regionDatabaseClusterArns" in data:
        ...
        out["region_database_cluster_arns"] = (
            aws_sdk_arc_region_switch.types.region_aurora_cluster_map.deserialize_aws_json_1_0(
