...
if TYPE_CHECKING:
    ...
    import aws_sdk_arc_region_switch.types.ecs_service_arn
...
class Service(TypedDict):
    ...
    cluster_arn: NotRequired[
        "aws_sdk_arc_region_switch.types.ecs_cluster_arn.EcsClusterArn"
    ]
    """<p>The cluster Amazon Resource Name (ARN) for a service.</p>"""
    service_arn: NotRequired[
        "aws_sdk_arc_region_switch.types.ecs_service_arn.EcsServiceArn"
    ]
