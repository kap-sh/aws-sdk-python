...
Route53HealthCheckList: TypeAlias = list[
    "aws_sdk_arc_region_switch.types.route53_health_check.Route53HealthCheck"
]
...
def serialize_aws_json_1_0(value: Route53HealthCheckList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_arc_region_switch.types.route53_health_check.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> Route53HealthCheckList:
    ...
    for item in data:
        out.append(
            aws_sdk_arc_region_switch.types.route53_health_check.deserialize_aws_json_1_0(
                item
            )
        )
    return out
