...
if TYPE_CHECKING:
    ...
    import aws_sdk_arc_region_switch.types.execution_event_type
    import aws_sdk_arc_region_switch.types.resources
...
class ExecutionEvent(TypedDict):
    ...
    type: NotRequired[
        "aws_sdk_arc_region_switch.types.execution_event_type.ExecutionEventType"
    ]
    ...
    resources: NotRequired["aws_sdk_arc_region_switch.types.resources.Resources"]
...
def serialize_aws_json_1_0(value: ExecutionEvent) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = (
            aws_sdk_arc_region_switch.types.execution_event_type.serialize_aws_json_1_0(
                value["type"]
            )
        )
    ...
    if "resources" in value:
        ...
        out["resources"] = (
            aws_sdk_arc_region_switch.types.resources.serialize_aws_json_1_0(
                value["resources"]
            )
        )
    if "error" in value:
...
def deserialize_aws_json_1_0(data: dict) -> ExecutionEvent:
    ...
    if "type" in data:
        ...
        out["type"] = (
            aws_sdk_arc_region_switch.types.execution_event_type.deserialize_aws_json_1_0(
                data["type"]
            )
        )
    if "stepName" in data:
    ...
    if "resources" in data:
        ...
        out["resources"] = (
            aws_sdk_arc_region_switch.types.resources.deserialize_aws_json_1_0(
                data["resources"]
            )
        )
    if "error" in data:
