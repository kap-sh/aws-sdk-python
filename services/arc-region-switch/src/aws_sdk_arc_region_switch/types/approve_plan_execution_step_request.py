...
class ApprovePlanExecutionStepRequest(TypedDict):
...
def serialize_aws_json_1_0(value: ApprovePlanExecutionStepRequest) -> dict:
    ...
    out["approval"] = aws_sdk_arc_region_switch.types.approval.serialize_aws_json_1_0(
        value["approval"]
    )
    if "comment" in value:
...
def deserialize_aws_json_1_0(data: dict) -> ApprovePlanExecutionStepRequest:
    ...
    if "approval" in data:
        ...
        out["approval"] = (
            aws_sdk_arc_region_switch.types.approval.deserialize_aws_json_1_0(
                data["approval"]
            )
        )
    else:
