...
if TYPE_CHECKING:
    ...
    import aws_sdk_arc_region_switch.types.route53_health_check_id
    import aws_sdk_arc_region_switch.types.route53_health_check_status
    import aws_sdk_arc_region_switch.types.route53_hosted_zone_id
    import aws_sdk_arc_region_switch.types.route53_record_name


class Route53HealthCheck(TypedDict):
    hosted_zone_id: (
    ...
    health_check_id: NotRequired[
        "aws_sdk_arc_region_switch.types.route53_health_check_id.Route53HealthCheckId"
    ]
    """<p>The Amazon Route 53 health check ID.</p>"""
    status: NotRequired[
        "aws_sdk_arc_region_switch.types.route53_health_check_status.Route53HealthCheckStatus"
    ]
    """<p>The Amazon Route 53 health check status.</p>"""
    region: "aws_sdk_arc_region_switch.types.region.Region"
...
def serialize_aws_json_1_0(value: Route53HealthCheck) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = (
            aws_sdk_arc_region_switch.types.route53_health_check_status.serialize_aws_json_1_0(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> Route53HealthCheck:
    ...
    if "status" in data:
        ...
        out["status"] = (
            aws_sdk_arc_region_switch.types.route53_health_check_status.deserialize_aws_json_1_0(
                data["status"]
            )
        )
    if "region" in data:
