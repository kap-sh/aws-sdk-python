...
def handle_response(
    ...
    out: aws_sdk_arc_region_switch.types.create_plan_response.CreatePlanResponse = (
        aws_sdk_arc_region_switch.types.create_plan_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_arc_region_switch.types.create_plan_request.CreatePlanRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_arc_region_switch.types.create_plan_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
