...
def handle_response(
    ...
    out: aws_sdk_arc_region_switch.types.approve_plan_execution_step_response.ApprovePlanExecutionStepResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_arc_region_switch.types.approve_plan_execution_step_request.ApprovePlanExecutionStepRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_arc_region_switch.types.approve_plan_execution_step_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
