"""Generated from Smithy shape ``com.amazonaws.arcregionswitch#GetPlanExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_arc_region_switch.types.get_plan_execution_response.GetPlanExecutionResponse = aws_sdk_arc_region_switch.types.get_plan_execution_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_arc_region_switch.types.get_plan_execution_request.GetPlanExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ArcRegionSwitch.GetPlanExecution"
    body: bytes | None = json.dumps(
        aws_sdk_arc_region_switch.types.get_plan_execution_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_plan_execution(
