...
def build_request(
    ...
    input: aws_sdk_arc_region_switch.types.list_plans_request.ListPlansRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_arc_region_switch.types.list_plans_request.serialize_aws_json_1_0(input)
    ).encode()
