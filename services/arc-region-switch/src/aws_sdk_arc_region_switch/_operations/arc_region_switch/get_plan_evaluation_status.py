"""Generated from Smithy shape ``com.amazonaws.arcregionswitch#GetPlanEvaluationStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_arc_region_switch.types.get_plan_evaluation_status_response.GetPlanEvaluationStatusResponse = aws_sdk_arc_region_switch.types.get_plan_evaluation_status_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ArcRegionSwitch.GetPlanEvaluationStatus"
    import aws_sdk_arc_region_switch.types.get_plan_evaluation_status_request
