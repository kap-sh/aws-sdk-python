...
from aws_sdk_arc_region_switch._services._aws_config import aaws_config
...
class AsyncARCRegionswitchClientConfig(TypedDict, total=False):
...
class AsyncARCRegionswitchClient:
    ...
    async def approve_plan_execution_step(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_region_switch.types.approve_plan_execution_step_request.ApprovePlanExecutionStepRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_region_switch.types.approve_plan_execution_step_response.ApprovePlanExecutionStepResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_region_switch._operations.arc_region_switch.approve_plan_execution_step.async_approve_plan_execution_step(
    ...
    async def cancel_plan_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_region_switch.types.cancel_plan_execution_request.CancelPlanExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_region_switch.types.cancel_plan_execution_response.CancelPlanExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_region_switch._operations.arc_region_switch.cancel_plan_execution.async_cancel_plan_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_plan_evaluation_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_region_switch.types.get_plan_evaluation_status_request.GetPlanEvaluationStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_region_switch.types.get_plan_evaluation_status_response.GetPlanEvaluationStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_region_switch._operations.arc_region_switch.get_plan_evaluation_status.async_get_plan_evaluation_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_arc_region_switch.types.resource_warning.ResourceWarning]":
        _token = next_token
        while True:
    ...
    async def get_plan_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_region_switch.types.get_plan_execution_request.GetPlanExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_region_switch.types.get_plan_execution_response.GetPlanExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_region_switch._operations.arc_region_switch.get_plan_execution.async_get_plan_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_plan_execution(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_arc_region_switch.types.step_state.StepState]":
        _token = next_token
        while True:
    ...
    async def get_plan_in_region(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_region_switch.types.get_plan_in_region_request.GetPlanInRegionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_region_switch.types.get_plan_in_region_response.GetPlanInRegionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_region_switch._operations.arc_region_switch.get_plan_in_region.async_get_plan_in_region(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_plan_execution_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_region_switch.types.list_plan_execution_events_request.ListPlanExecutionEventsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_region_switch.types.list_plan_execution_events_response.ListPlanExecutionEventsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_region_switch._operations.arc_region_switch.list_plan_execution_events.async_list_plan_execution_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_plan_execution_events(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_arc_region_switch.types.execution_event.ExecutionEvent]"
    ):
        _token = next_token
        while True:
    ...
    async def list_plan_executions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_region_switch.types.list_plan_executions_request.ListPlanExecutionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_region_switch.types.list_plan_executions_response.ListPlanExecutionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_region_switch._operations.arc_region_switch.list_plan_executions.async_list_plan_executions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_arc_region_switch.types.abbreviated_execution.AbbreviatedExecution]":
        _token = next_token
        while True:
    ...
    async def list_plans_in_region(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_region_switch.types.list_plans_in_region_request.ListPlansInRegionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_region_switch.types.list_plans_in_region_response.ListPlansInRegionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_region_switch._operations.arc_region_switch.list_plans_in_region.async_list_plans_in_region(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_arc_region_switch.types.abbreviated_plan.AbbreviatedPlan]":
        _token = next_token
        while True:
    ...
    async def list_route53_health_checks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_region_switch.types.list_route53_health_checks_request.ListRoute53HealthChecksRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_region_switch.types.list_route53_health_checks_response.ListRoute53HealthChecksResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_region_switch._operations.arc_region_switch.list_route53_health_checks.async_list_route53_health_checks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_arc_region_switch.types.route53_health_check.Route53HealthCheck]":
        _token = next_token
        while True:
    ...
    async def list_route53_health_checks_in_region(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_region_switch.types.list_route53_health_checks_in_region_request.ListRoute53HealthChecksInRegionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_region_switch.types.list_route53_health_checks_in_region_response.ListRoute53HealthChecksInRegionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_region_switch._operations.arc_region_switch.list_route53_health_checks_in_region.async_list_route53_health_checks_in_region(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_plan_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_region_switch.types.start_plan_execution_request.StartPlanExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_region_switch.types.start_plan_execution_response.StartPlanExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_region_switch._operations.arc_region_switch.start_plan_execution.async_start_plan_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_plan_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_region_switch.types.update_plan_execution_request.UpdatePlanExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_region_switch.types.update_plan_execution_response.UpdatePlanExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_region_switch._operations.arc_region_switch.update_plan_execution.async_update_plan_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_plan_execution_step(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_region_switch.types.update_plan_execution_step_request.UpdatePlanExecutionStepRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_region_switch.types.update_plan_execution_step_response.UpdatePlanExecutionStepResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_region_switch._operations.arc_region_switch.update_plan_execution_step.async_update_plan_execution_step(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
