"""Generated from Smithy shape ``com.amazonaws.arcregionswitch#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.arcregionswitch#ResourceNotFoundException``."""
