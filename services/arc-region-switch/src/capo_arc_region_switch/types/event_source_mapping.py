...
if TYPE_CHECKING:
    import capo_arc_region_switch.types.event_source_mapping_arn
    import capo_arc_region_switch.types.iam_role_arn


class EventSourceMapping(TypedDict, closed=True):
    ...
    arn: "capo_arc_region_switch.types.event_source_mapping_arn.EventSourceMappingArn"
