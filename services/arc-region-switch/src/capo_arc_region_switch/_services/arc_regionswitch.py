...
from capo_arc_region_switch._services._aws_config import aws_config
...
class ARCRegionswitchClientConfig(TypedDict, total=False, closed=True):
...
class ARCRegionswitchClient:
    ...
    def __init__(
        ...
        self._config = ARCRegionswitchClientConfig(
            {
    ...
    def approve_plan_execution_step(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_arc_region_switch.types.approve_plan_execution_step_request.ApprovePlanExecutionStepRequest]",
        ) -> OperationResponse[
            "capo_arc_region_switch.types.approve_plan_execution_step_response.ApprovePlanExecutionStepResponse"
        ]:
            ...
            output, http_response = (
                capo_arc_region_switch._operations.arc_region_switch.approve_plan_execution_step.approve_plan_execution_step(
    ...
    def cancel_plan_execution(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_arc_region_switch.types.cancel_plan_execution_request.CancelPlanExecutionRequest]",
        ) -> OperationResponse[
            "capo_arc_region_switch.types.cancel_plan_execution_response.CancelPlanExecutionResponse"
        ]:
            ...
            output, http_response = (
                capo_arc_region_switch._operations.arc_region_switch.cancel_plan_execution.cancel_plan_execution(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_plan_evaluation_status(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_arc_region_switch.types.get_plan_evaluation_status_request.GetPlanEvaluationStatusRequest]",
        ) -> OperationResponse[
            "capo_arc_region_switch.types.get_plan_evaluation_status_response.GetPlanEvaluationStatusResponse"
        ]:
            ...
            output, http_response = (
                capo_arc_region_switch._operations.arc_region_switch.get_plan_evaluation_status.get_plan_evaluation_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_arc_region_switch.types.resource_warning.ResourceWarning]":
        _token = next_token
        while True:
    ...
    def get_plan_execution(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_arc_region_switch.types.get_plan_execution_request.GetPlanExecutionRequest]",
        ) -> OperationResponse[
            "capo_arc_region_switch.types.get_plan_execution_response.GetPlanExecutionResponse"
        ]:
            ...
            output, http_response = (
                capo_arc_region_switch._operations.arc_region_switch.get_plan_execution.get_plan_execution(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_get_plan_execution(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_arc_region_switch.types.step_state.StepState]":
        _token = next_token
        while True:
    ...
    def get_plan_in_region(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_arc_region_switch.types.get_plan_in_region_request.GetPlanInRegionRequest]",
        ) -> OperationResponse[
            "capo_arc_region_switch.types.get_plan_in_region_response.GetPlanInRegionResponse"
        ]:
            ...
            output, http_response = (
                capo_arc_region_switch._operations.arc_region_switch.get_plan_in_region.get_plan_in_region(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_plan_execution_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_arc_region_switch.types.list_plan_execution_events_request.ListPlanExecutionEventsRequest]",
        ) -> OperationResponse[
            "capo_arc_region_switch.types.list_plan_execution_events_response.ListPlanExecutionEventsResponse"
        ]:
            ...
            output, http_response = (
                capo_arc_region_switch._operations.arc_region_switch.list_plan_execution_events.list_plan_execution_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_plan_execution_events(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        name: Optional["capo_arc_region_switch.types.step_name.StepName"] = None,
    ) -> "Iterator[capo_arc_region_switch.types.execution_event.ExecutionEvent]":
        _token = next_token
        while True:
    ...
    def list_plan_executions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_arc_region_switch.types.list_plan_executions_request.ListPlanExecutionsRequest]",
        ) -> OperationResponse[
            "capo_arc_region_switch.types.list_plan_executions_response.ListPlanExecutionsResponse"
        ]:
            ...
            output, http_response = (
                capo_arc_region_switch._operations.arc_region_switch.list_plan_executions.list_plan_executions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_arc_region_switch.types.abbreviated_execution.AbbreviatedExecution]":
        _token = next_token
        while True:
    ...
    def list_plans_in_region(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_arc_region_switch.types.list_plans_in_region_request.ListPlansInRegionRequest]",
        ) -> OperationResponse[
            "capo_arc_region_switch.types.list_plans_in_region_response.ListPlansInRegionResponse"
        ]:
            ...
            output, http_response = (
                capo_arc_region_switch._operations.arc_region_switch.list_plans_in_region.list_plans_in_region(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_arc_region_switch.types.abbreviated_plan.AbbreviatedPlan]":
        _token = next_token
        while True:
    ...
    def list_route53_health_checks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_arc_region_switch.types.list_route53_health_checks_request.ListRoute53HealthChecksRequest]",
        ) -> OperationResponse[
            "capo_arc_region_switch.types.list_route53_health_checks_response.ListRoute53HealthChecksResponse"
        ]:
            ...
            output, http_response = (
                capo_arc_region_switch._operations.arc_region_switch.list_route53_health_checks.list_route53_health_checks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_route53_health_checks(
        ...
        *,
        ...
        "Iterator[capo_arc_region_switch.types.route53_health_check.Route53HealthCheck]"
    ):
        _token = next_token
        while True:
    ...
    def list_route53_health_checks_in_region(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_arc_region_switch.types.list_route53_health_checks_in_region_request.ListRoute53HealthChecksInRegionRequest]",
        ) -> OperationResponse[
            "capo_arc_region_switch.types.list_route53_health_checks_in_region_response.ListRoute53HealthChecksInRegionResponse"
        ]:
            ...
            output, http_response = (
                capo_arc_region_switch._operations.arc_region_switch.list_route53_health_checks_in_region.list_route53_health_checks_in_region(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_plan_execution(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_arc_region_switch.types.start_plan_execution_request.StartPlanExecutionRequest]",
        ) -> OperationResponse[
            "capo_arc_region_switch.types.start_plan_execution_response.StartPlanExecutionResponse"
        ]:
            ...
            output, http_response = (
                capo_arc_region_switch._operations.arc_region_switch.start_plan_execution.start_plan_execution(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_plan_execution(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_arc_region_switch.types.update_plan_execution_request.UpdatePlanExecutionRequest]",
        ) -> OperationResponse[
            "capo_arc_region_switch.types.update_plan_execution_response.UpdatePlanExecutionResponse"
        ]:
            ...
            output, http_response = (
                capo_arc_region_switch._operations.arc_region_switch.update_plan_execution.update_plan_execution(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_plan_execution_step(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_arc_region_switch.types.update_plan_execution_step_request.UpdatePlanExecutionStepRequest]",
        ) -> OperationResponse[
            "capo_arc_region_switch.types.update_plan_execution_step_response.UpdatePlanExecutionStepResponse"
        ]:
            ...
            output, http_response = (
                capo_arc_region_switch._operations.arc_region_switch.update_plan_execution_step.update_plan_execution_step(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
