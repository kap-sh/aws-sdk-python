"""Generated from Smithy shape ``com.amazonaws.arcregionswitch#GetPlan``."""
...
def handle_response(
    ...
    out: capo_arc_region_switch.types.get_plan_response.GetPlanResponse = (
        capo_arc_region_switch.types.get_plan_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ArcRegionSwitch.GetPlan"
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.get_plan_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_plan(
    ...
    capo_arc_region_switch.types.get_plan_response.GetPlanResponse, zapros.Response
]:
