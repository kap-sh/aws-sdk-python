...
def handle_response(
    ...
    out: capo_arc_region_switch.types.list_plans_in_region_response.ListPlansInRegionResponse = capo_arc_region_switch.types.list_plans_in_region_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.list_plans_in_region_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
