...
def handle_response(
    ...
    out: capo_arc_region_switch.types.get_plan_execution_response.GetPlanExecutionResponse = capo_arc_region_switch.types.get_plan_execution_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.get_plan_execution_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
