...
import capo_arc_region_switch.errors.internal_server_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InternalServerException":
            raise capo_arc_region_switch.errors.internal_server_exception.InternalServerException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_arc_region_switch.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.tag_resource_request.serialize_aws_json_1_0(input_)
    ).encode()
