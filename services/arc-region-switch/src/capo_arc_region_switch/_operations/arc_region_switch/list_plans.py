"""Generated from Smithy shape ``com.amazonaws.arcregionswitch#ListPlans``."""
...
def handle_response(
    ...
    out: capo_arc_region_switch.types.list_plans_response.ListPlansResponse = (
        capo_arc_region_switch.types.list_plans_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ArcRegionSwitch.ListPlans"
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.list_plans_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_plans(
    ...
    capo_arc_region_switch.types.list_plans_response.ListPlansResponse, zapros.Response
]:
