"""Generated from Smithy shape ``com.amazonaws.arcregionswitch#ListPlanExecutionEvents``."""
...
def handle_response(
    ...
    out: capo_arc_region_switch.types.list_plan_execution_events_response.ListPlanExecutionEventsResponse = capo_arc_region_switch.types.list_plan_execution_events_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ArcRegionSwitch.ListPlanExecutionEvents"
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.list_plan_execution_events_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_plan_execution_events(
