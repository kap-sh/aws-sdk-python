"""Generated from Smithy shape ``com.amazonaws.arcregionswitch#GetPlanInRegion``."""
...
def handle_response(
    ...
    out: capo_arc_region_switch.types.get_plan_in_region_response.GetPlanInRegionResponse = capo_arc_region_switch.types.get_plan_in_region_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ArcRegionSwitch.GetPlanInRegion"
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.get_plan_in_region_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_plan_in_region(
