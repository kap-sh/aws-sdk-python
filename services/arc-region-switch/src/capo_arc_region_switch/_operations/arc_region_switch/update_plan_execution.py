"""Generated from Smithy shape ``com.amazonaws.arcregionswitch#UpdatePlanExecution``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IllegalStateException":
            raise capo_arc_region_switch.errors.illegal_state_exception.IllegalStateException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_arc_region_switch.types.update_plan_execution_response.UpdatePlanExecutionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ArcRegionSwitch.UpdatePlanExecution"
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.update_plan_execution_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_plan_execution(
