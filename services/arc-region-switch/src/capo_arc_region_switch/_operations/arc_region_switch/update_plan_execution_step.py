"""Generated from Smithy shape ``com.amazonaws.arcregionswitch#UpdatePlanExecutionStep``."""
...
def handle_response(
    ...
    out: capo_arc_region_switch.types.update_plan_execution_step_response.UpdatePlanExecutionStepResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ArcRegionSwitch.UpdatePlanExecutionStep"
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.update_plan_execution_step_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_plan_execution_step(
