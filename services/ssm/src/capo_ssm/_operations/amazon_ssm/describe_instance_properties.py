...
import capo_ssm.errors.invalid_instance_property_filter_value
...
def handle_response(
    ...
    out: capo_ssm.types.describe_instance_properties_result.DescribeInstancePropertiesResult = capo_ssm.types.describe_instance_properties_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_instance_properties_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
