...
import capo_ssm.errors.status_unchanged
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "StatusUnchanged":
            raise capo_ssm.errors.status_unchanged.StatusUnchanged.from_aws_json_1_1(
                data, message
            )
        case "TooManyUpdates":
...
def handle_response(
    ...
    out: capo_ssm.types.update_association_status_result.UpdateAssociationStatusResult = capo_ssm.types.update_association_status_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.update_association_status_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
