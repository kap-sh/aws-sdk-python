"""Generated from Smithy shape ``com.amazonaws.ssm#RegisterTargetWithMaintenanceWindow``."""
...
def handle_response(
    ...
    out: capo_ssm.types.register_target_with_maintenance_window_result.RegisterTargetWithMaintenanceWindowResult = capo_ssm.types.register_target_with_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.register_target_with_maintenance_window_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_register_target_with_maintenance_window(
