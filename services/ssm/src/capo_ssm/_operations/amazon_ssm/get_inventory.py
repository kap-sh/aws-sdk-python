...
import capo_ssm.errors.invalid_inventory_group_exception
import capo_ssm.errors.invalid_next_token
import capo_ssm.errors.invalid_result_attribute_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidInventoryGroupException":
            raise capo_ssm.errors.invalid_inventory_group_exception.InvalidInventoryGroupException.from_aws_json_1_1(
                data, message
            )
        ...
        case "InvalidResultAttributeException":
            raise capo_ssm.errors.invalid_result_attribute_exception.InvalidResultAttributeException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ssm.types.get_inventory_result.GetInventoryResult = (
        capo_ssm.types.get_inventory_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_inventory_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_inventory(
    ...
    input_: capo_ssm.types.get_inventory_request.GetInventoryRequest,
) -> tuple[capo_ssm.types.get_inventory_result.GetInventoryResult, zapros.Response]:
