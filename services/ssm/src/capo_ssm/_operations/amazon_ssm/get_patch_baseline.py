"""Generated from Smithy shape ``com.amazonaws.ssm#GetPatchBaseline``."""
...
def handle_response(
    ...
    out: capo_ssm.types.get_patch_baseline_result.GetPatchBaselineResult = (
        capo_ssm.types.get_patch_baseline_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_patch_baseline_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_patch_baseline(
    ...
    capo_ssm.types.get_patch_baseline_result.GetPatchBaselineResult, zapros.Response
]:
...
async def async_get_patch_baseline(
