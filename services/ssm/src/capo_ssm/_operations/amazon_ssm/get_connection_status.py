...
def handle_response(
    ...
    out: capo_ssm.types.get_connection_status_response.GetConnectionStatusResponse = (
        capo_ssm.types.get_connection_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_connection_status_request.serialize_aws_json_1_1(input_)
    ).encode()
