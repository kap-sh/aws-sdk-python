...
def handle_response(
    ...
    out: capo_ssm.types.describe_maintenance_window_executions_result.DescribeMaintenanceWindowExecutionsResult = capo_ssm.types.describe_maintenance_window_executions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_maintenance_window_executions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
