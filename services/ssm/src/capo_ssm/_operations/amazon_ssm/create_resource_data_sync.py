...
import capo_ssm.errors.resource_data_sync_already_exists_exception
import capo_ssm.errors.resource_data_sync_count_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceDataSyncAlreadyExistsException":
            raise capo_ssm.errors.resource_data_sync_already_exists_exception.ResourceDataSyncAlreadyExistsException.from_aws_json_1_1(
                data, message
            )
        case "ResourceDataSyncCountExceededException":
            raise capo_ssm.errors.resource_data_sync_count_exceeded_exception.ResourceDataSyncCountExceededException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ssm.types.create_resource_data_sync_result.CreateResourceDataSyncResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.create_resource_data_sync_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
