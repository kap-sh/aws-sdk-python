...
def handle_response(
    ...
    out: capo_ssm.types.describe_effective_patches_for_patch_baseline_result.DescribeEffectivePatchesForPatchBaselineResult = capo_ssm.types.describe_effective_patches_for_patch_baseline_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_effective_patches_for_patch_baseline_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
