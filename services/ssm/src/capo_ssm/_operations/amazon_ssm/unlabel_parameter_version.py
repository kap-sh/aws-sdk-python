"""Generated from Smithy shape ``com.amazonaws.ssm#UnlabelParameterVersion``."""
...
def handle_response(
    ...
    out: capo_ssm.types.unlabel_parameter_version_result.UnlabelParameterVersionResult = capo_ssm.types.unlabel_parameter_version_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.UnlabelParameterVersion"
    body: bytes | None = json.dumps(
        capo_ssm.types.unlabel_parameter_version_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_unlabel_parameter_version(
