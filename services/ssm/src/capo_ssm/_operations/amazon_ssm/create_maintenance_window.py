"""Generated from Smithy shape ``com.amazonaws.ssm#CreateMaintenanceWindow``."""
...
def handle_response(
    ...
    out: capo_ssm.types.create_maintenance_window_result.CreateMaintenanceWindowResult = capo_ssm.types.create_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.create_maintenance_window_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_maintenance_window(
