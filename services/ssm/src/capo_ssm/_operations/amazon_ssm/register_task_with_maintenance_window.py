...
import capo_ssm.errors.feature_not_available_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FeatureNotAvailableException":
            raise capo_ssm.errors.feature_not_available_exception.FeatureNotAvailableException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ssm.types.register_task_with_maintenance_window_result.RegisterTaskWithMaintenanceWindowResult = capo_ssm.types.register_task_with_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.register_task_with_maintenance_window_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
