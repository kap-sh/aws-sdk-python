"""Generated from Smithy shape ``com.amazonaws.ssm#ListDocumentMetadataHistory``."""
...
def handle_response(
    ...
    out: capo_ssm.types.list_document_metadata_history_response.ListDocumentMetadataHistoryResponse = capo_ssm.types.list_document_metadata_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.ListDocumentMetadataHistory"
    body: bytes | None = json.dumps(
        capo_ssm.types.list_document_metadata_history_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_document_metadata_history(
