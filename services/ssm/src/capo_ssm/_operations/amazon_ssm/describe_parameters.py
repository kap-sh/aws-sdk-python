"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeParameters``."""
...
import capo_ssm.errors.invalid_filter_option
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidFilterOption":
            raise capo_ssm.errors.invalid_filter_option.InvalidFilterOption.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ssm.types.describe_parameters_result.DescribeParametersResult = (
        capo_ssm.types.describe_parameters_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_parameters_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_parameters(
    ...
    capo_ssm.types.describe_parameters_result.DescribeParametersResult, zapros.Response
]:
...
async def async_describe_parameters(
