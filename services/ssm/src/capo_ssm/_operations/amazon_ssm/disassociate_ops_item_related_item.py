...
import capo_ssm.errors.ops_item_related_item_association_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OpsItemRelatedItemAssociationNotFoundException":
            raise capo_ssm.errors.ops_item_related_item_association_not_found_exception.OpsItemRelatedItemAssociationNotFoundException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ssm.types.disassociate_ops_item_related_item_response.DisassociateOpsItemRelatedItemResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.disassociate_ops_item_related_item_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
