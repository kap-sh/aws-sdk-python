"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeInstanceAssociationsStatus``."""
...
def handle_response(
    ...
    out: capo_ssm.types.describe_instance_associations_status_result.DescribeInstanceAssociationsStatusResult = capo_ssm.types.describe_instance_associations_status_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_instance_associations_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_instance_associations_status(
