"""Generated from Smithy shape ``com.amazonaws.ssm#ResumeSession``."""
...
def handle_response(
    ...
    out: capo_ssm.types.resume_session_response.ResumeSessionResponse = (
        capo_ssm.types.resume_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.resume_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def resume_session(
    ...
    capo_ssm.types.resume_session_response.ResumeSessionResponse, zapros.Response
]:
