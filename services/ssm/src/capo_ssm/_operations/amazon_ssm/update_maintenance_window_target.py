...
def handle_response(
    ...
    out: capo_ssm.types.update_maintenance_window_target_result.UpdateMaintenanceWindowTargetResult = capo_ssm.types.update_maintenance_window_target_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.update_maintenance_window_target_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
