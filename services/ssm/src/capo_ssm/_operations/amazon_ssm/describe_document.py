"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeDocument``."""
...
def handle_response(
    ...
    out: capo_ssm.types.describe_document_result.DescribeDocumentResult = (
        capo_ssm.types.describe_document_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_document_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_document(
    ...
    capo_ssm.types.describe_document_result.DescribeDocumentResult, zapros.Response
]:
...
async def async_describe_document(
