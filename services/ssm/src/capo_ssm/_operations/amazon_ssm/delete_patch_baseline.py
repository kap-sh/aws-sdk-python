"""Generated from Smithy shape ``com.amazonaws.ssm#DeletePatchBaseline``."""
...
import capo_ssm.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise capo_ssm.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ssm.types.delete_patch_baseline_result.DeletePatchBaselineResult = (
        capo_ssm.types.delete_patch_baseline_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.delete_patch_baseline_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_patch_baseline(
