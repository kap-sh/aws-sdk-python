...
import capo_ssm.types.node_list
...
def handle_response(
    ...
    out: capo_ssm.types.list_nodes_result.ListNodesResult = (
        capo_ssm.types.list_nodes_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.list_nodes_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_nodes(
    ...
    input_: capo_ssm.types.list_nodes_request.ListNodesRequest,
) -> tuple[capo_ssm.types.list_nodes_result.ListNodesResult, zapros.Response]:
