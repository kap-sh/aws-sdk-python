"""Generated from Smithy shape ``com.amazonaws.ssm#RegisterPatchBaselineForPatchGroup``."""
...
import capo_ssm.errors.already_exists_exception
...
import capo_ssm.errors.resource_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AlreadyExistsException":
            raise capo_ssm.errors.already_exists_exception.AlreadyExistsException.from_aws_json_1_1(
                data, message
            )
        ...
        case "ResourceLimitExceededException":
            raise capo_ssm.errors.resource_limit_exceeded_exception.ResourceLimitExceededException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ssm.types.register_patch_baseline_for_patch_group_result.RegisterPatchBaselineForPatchGroupResult = capo_ssm.types.register_patch_baseline_for_patch_group_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.register_patch_baseline_for_patch_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_register_patch_baseline_for_patch_group(
