"""Generated from Smithy shape ``com.amazonaws.ssm#GetParameters``."""
...
def handle_response(
    ...
    out: capo_ssm.types.get_parameters_result.GetParametersResult = (
        capo_ssm.types.get_parameters_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_parameters_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_parameters(
    ...
    input_: capo_ssm.types.get_parameters_request.GetParametersRequest,
) -> tuple[capo_ssm.types.get_parameters_result.GetParametersResult, zapros.Response]:
