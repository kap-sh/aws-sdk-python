...
import capo_ssm.errors.invalid_plugin_name
import capo_ssm.errors.invocation_does_not_exist
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPluginName":
            raise capo_ssm.errors.invalid_plugin_name.InvalidPluginName.from_aws_json_1_1(
                data, message
            )
        case "InvocationDoesNotExist":
            raise capo_ssm.errors.invocation_does_not_exist.InvocationDoesNotExist.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ssm.types.get_command_invocation_result.GetCommandInvocationResult = (
        capo_ssm.types.get_command_invocation_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_command_invocation_request.serialize_aws_json_1_1(input_)
    ).encode()
