"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeAssociation``."""
...
def handle_response(
    ...
    out: capo_ssm.types.describe_association_result.DescribeAssociationResult = (
        capo_ssm.types.describe_association_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_association_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_describe_association(
