"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeMaintenanceWindowTargets``."""
...
def handle_response(
    ...
    out: capo_ssm.types.describe_maintenance_window_targets_result.DescribeMaintenanceWindowTargetsResult = capo_ssm.types.describe_maintenance_window_targets_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_maintenance_window_targets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_maintenance_window_targets(
