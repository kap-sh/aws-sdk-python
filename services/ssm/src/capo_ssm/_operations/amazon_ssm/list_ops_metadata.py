...
def handle_response(
    ...
    out: capo_ssm.types.list_ops_metadata_result.ListOpsMetadataResult = (
        capo_ssm.types.list_ops_metadata_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.list_ops_metadata_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_ops_metadata(
    ...
    capo_ssm.types.list_ops_metadata_result.ListOpsMetadataResult, zapros.Response
]:
