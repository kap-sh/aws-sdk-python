...
def handle_response(
    ...
    out: capo_ssm.types.describe_sessions_response.DescribeSessionsResponse = (
        capo_ssm.types.describe_sessions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_sessions_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_sessions(
    ...
    capo_ssm.types.describe_sessions_response.DescribeSessionsResponse, zapros.Response
]:
