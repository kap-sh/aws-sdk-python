...
import capo_ssm.errors.document_limit_exceeded
import capo_ssm.errors.document_permission_limit
import capo_ssm.errors.internal_server_error
import capo_ssm.errors.invalid_document
import capo_ssm.errors.invalid_permission_type
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DocumentPermissionLimit":
            raise capo_ssm.errors.document_permission_limit.DocumentPermissionLimit.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidPermissionType":
            raise capo_ssm.errors.invalid_permission_type.InvalidPermissionType.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_ssm.types.modify_document_permission_response.ModifyDocumentPermissionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.modify_document_permission_request.serialize_aws_json_1_1(input_)
    ).encode()
