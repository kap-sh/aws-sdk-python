"""Generated from Smithy shape ``com.amazonaws.ssm#ListDocumentVersions``."""
...
def handle_response(
    ...
    out: capo_ssm.types.list_document_versions_result.ListDocumentVersionsResult = (
        capo_ssm.types.list_document_versions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.list_document_versions_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_document_versions(
