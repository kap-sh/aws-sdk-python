"""Generated from Smithy shape ``com.amazonaws.ssm#DeregisterTaskFromMaintenanceWindow``."""
...
def handle_response(
    ...
    out: capo_ssm.types.deregister_task_from_maintenance_window_result.DeregisterTaskFromMaintenanceWindowResult = capo_ssm.types.deregister_task_from_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.deregister_task_from_maintenance_window_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_deregister_task_from_maintenance_window(
