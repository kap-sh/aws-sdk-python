"""Generated from Smithy shape ``com.amazonaws.ssm#DeleteInventory``."""
...
import capo_ssm.errors.invalid_delete_inventory_parameters_exception
import capo_ssm.errors.invalid_inventory_request_exception
import capo_ssm.errors.invalid_option_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDeleteInventoryParametersException":
            raise capo_ssm.errors.invalid_delete_inventory_parameters_exception.InvalidDeleteInventoryParametersException.from_aws_json_1_1(
                data, message
            )
        case "InvalidInventoryRequestException":
            raise capo_ssm.errors.invalid_inventory_request_exception.InvalidInventoryRequestException.from_aws_json_1_1(
                data, message
            )
        case "InvalidOptionException":
            raise capo_ssm.errors.invalid_option_exception.InvalidOptionException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ssm.types.delete_inventory_result.DeleteInventoryResult = (
        capo_ssm.types.delete_inventory_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.delete_inventory_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_inventory(
    ...
    capo_ssm.types.delete_inventory_result.DeleteInventoryResult, zapros.Response
]:
