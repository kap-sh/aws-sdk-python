...
def handle_response(
    ...
    out: capo_ssm.types.get_ops_summary_result.GetOpsSummaryResult = (
        capo_ssm.types.get_ops_summary_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_ops_summary_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_ops_summary(
    ...
    input_: capo_ssm.types.get_ops_summary_request.GetOpsSummaryRequest,
) -> tuple[capo_ssm.types.get_ops_summary_result.GetOpsSummaryResult, zapros.Response]:
