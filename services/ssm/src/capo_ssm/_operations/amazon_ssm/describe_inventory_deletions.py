...
import capo_ssm.errors.invalid_deletion_id_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDeletionIdException":
            raise capo_ssm.errors.invalid_deletion_id_exception.InvalidDeletionIdException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ssm.types.describe_inventory_deletions_result.DescribeInventoryDeletionsResult = capo_ssm.types.describe_inventory_deletions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_inventory_deletions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
