"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeAutomationExecutions``."""
...
def handle_response(
    ...
    out: capo_ssm.types.describe_automation_executions_result.DescribeAutomationExecutionsResult = capo_ssm.types.describe_automation_executions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_automation_executions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_automation_executions(
