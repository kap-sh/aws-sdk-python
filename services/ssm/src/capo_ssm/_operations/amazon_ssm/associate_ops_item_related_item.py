...
import capo_ssm.errors.ops_item_related_item_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OpsItemRelatedItemAlreadyExistsException":
            raise capo_ssm.errors.ops_item_related_item_already_exists_exception.OpsItemRelatedItemAlreadyExistsException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ssm.types.associate_ops_item_related_item_response.AssociateOpsItemRelatedItemResponse = capo_ssm.types.associate_ops_item_related_item_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.associate_ops_item_related_item_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
