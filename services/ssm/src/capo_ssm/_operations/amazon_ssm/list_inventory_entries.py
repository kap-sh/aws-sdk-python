"""Generated from Smithy shape ``com.amazonaws.ssm#ListInventoryEntries``."""
...
def handle_response(
    ...
    out: capo_ssm.types.list_inventory_entries_result.ListInventoryEntriesResult = (
        capo_ssm.types.list_inventory_entries_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.list_inventory_entries_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_inventory_entries(
