"""Generated from Smithy shape ``com.amazonaws.ssm#ListResourceComplianceSummaries``."""
...
def handle_response(
    ...
    out: capo_ssm.types.list_resource_compliance_summaries_result.ListResourceComplianceSummariesResult = capo_ssm.types.list_resource_compliance_summaries_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.list_resource_compliance_summaries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_resource_compliance_summaries(
