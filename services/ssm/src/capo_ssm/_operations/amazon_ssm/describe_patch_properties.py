"""Generated from Smithy shape ``com.amazonaws.ssm#DescribePatchProperties``."""
...
def handle_response(
    ...
    out: capo_ssm.types.describe_patch_properties_result.DescribePatchPropertiesResult = capo_ssm.types.describe_patch_properties_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_patch_properties_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_describe_patch_properties(
