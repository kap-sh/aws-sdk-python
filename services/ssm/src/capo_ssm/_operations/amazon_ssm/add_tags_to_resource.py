...
import capo_ssm.errors.too_many_tags_error
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsError":
            raise capo_ssm.errors.too_many_tags_error.TooManyTagsError.from_aws_json_1_1(
                data, message
            )
        case "TooManyUpdates":
...
def handle_response(
    ...
    out: capo_ssm.types.add_tags_to_resource_result.AddTagsToResourceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.add_tags_to_resource_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def add_tags_to_resource(
    ...
    capo_ssm.types.add_tags_to_resource_result.AddTagsToResourceResult, zapros.Response
]:
