...
def handle_response(
    ...
    out: capo_ssm.types.cancel_command_result.CancelCommandResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.cancel_command_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def cancel_command(
    ...
    input_: capo_ssm.types.cancel_command_request.CancelCommandRequest,
) -> tuple[capo_ssm.types.cancel_command_result.CancelCommandResult, zapros.Response]:
