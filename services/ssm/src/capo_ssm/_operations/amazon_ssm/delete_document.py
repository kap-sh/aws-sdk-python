...
import capo_ssm.errors.associated_instances
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AssociatedInstances":
            raise capo_ssm.errors.associated_instances.AssociatedInstances.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_ssm.types.delete_document_result.DeleteDocumentResult = {}  # type: ignore[typeddict-item]
    return out
...
def delete_document(
    ...
    input_: capo_ssm.types.delete_document_request.DeleteDocumentRequest,
) -> tuple[capo_ssm.types.delete_document_result.DeleteDocumentResult, zapros.Response]:
