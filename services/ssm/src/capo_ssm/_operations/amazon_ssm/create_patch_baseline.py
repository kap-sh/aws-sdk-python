"""Generated from Smithy shape ``com.amazonaws.ssm#CreatePatchBaseline``."""
...
def handle_response(
    ...
    out: capo_ssm.types.create_patch_baseline_result.CreatePatchBaselineResult = (
        capo_ssm.types.create_patch_baseline_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.create_patch_baseline_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_patch_baseline(
