...
def handle_response(
    ...
    out: capo_ssm.types.describe_document_permission_response.DescribeDocumentPermissionResponse = capo_ssm.types.describe_document_permission_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_document_permission_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
