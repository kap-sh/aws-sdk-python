"""Generated from Smithy shape ``com.amazonaws.ssm#LabelParameterVersion``."""
...
import capo_ssm.errors.parameter_not_found
import capo_ssm.errors.parameter_version_label_limit_exceeded
import capo_ssm.errors.parameter_version_not_found
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ParameterNotFound":
            raise capo_ssm.errors.parameter_not_found.ParameterNotFound.from_aws_json_1_1(
                data, message
            )
        case "ParameterVersionLabelLimitExceeded":
            raise capo_ssm.errors.parameter_version_label_limit_exceeded.ParameterVersionLabelLimitExceeded.from_aws_json_1_1(
                data, message
            )
        case "ParameterVersionNotFound":
            raise capo_ssm.errors.parameter_version_not_found.ParameterVersionNotFound.from_aws_json_1_1(
                data, message
            )
        case "TooManyUpdates":
...
def handle_response(
    ...
    out: capo_ssm.types.label_parameter_version_result.LabelParameterVersionResult = (
        capo_ssm.types.label_parameter_version_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.label_parameter_version_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_label_parameter_version(
