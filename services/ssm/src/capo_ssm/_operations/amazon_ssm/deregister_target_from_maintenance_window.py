...
import capo_ssm.errors.target_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TargetInUseException":
            raise capo_ssm.errors.target_in_use_exception.TargetInUseException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ssm.types.deregister_target_from_maintenance_window_result.DeregisterTargetFromMaintenanceWindowResult = capo_ssm.types.deregister_target_from_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.deregister_target_from_maintenance_window_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
