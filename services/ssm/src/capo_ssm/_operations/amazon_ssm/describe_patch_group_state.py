...
def handle_response(
    ...
    out: capo_ssm.types.describe_patch_group_state_result.DescribePatchGroupStateResult = capo_ssm.types.describe_patch_group_state_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_patch_group_state_request.serialize_aws_json_1_1(input_)
    ).encode()
