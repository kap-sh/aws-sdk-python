"""Generated from Smithy shape ``com.amazonaws.ssm#DeleteActivation``."""
...
import capo_ssm.errors.invalid_activation
import capo_ssm.errors.invalid_activation_id
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidActivation":
            raise capo_ssm.errors.invalid_activation.InvalidActivation.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ssm.types.delete_activation_result.DeleteActivationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.delete_activation_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_activation(
    ...
    capo_ssm.types.delete_activation_result.DeleteActivationResult, zapros.Response
]:
...
async def async_delete_activation(
