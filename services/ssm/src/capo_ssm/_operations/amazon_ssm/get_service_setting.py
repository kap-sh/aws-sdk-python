...
def handle_response(
    ...
    out: capo_ssm.types.get_service_setting_result.GetServiceSettingResult = (
        capo_ssm.types.get_service_setting_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_service_setting_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_service_setting(
    ...
    capo_ssm.types.get_service_setting_result.GetServiceSettingResult, zapros.Response
]:
