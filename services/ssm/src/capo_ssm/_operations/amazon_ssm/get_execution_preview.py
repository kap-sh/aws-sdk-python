"""Generated from Smithy shape ``com.amazonaws.ssm#GetExecutionPreview``."""
...
def handle_response(
    ...
    out: capo_ssm.types.get_execution_preview_response.GetExecutionPreviewResponse = (
        capo_ssm.types.get_execution_preview_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.GetExecutionPreview"
    body: bytes | None = json.dumps(
        capo_ssm.types.get_execution_preview_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_execution_preview(
