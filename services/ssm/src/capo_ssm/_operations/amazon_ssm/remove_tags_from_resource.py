"""Generated from Smithy shape ``com.amazonaws.ssm#RemoveTagsFromResource``."""
...
def handle_response(
    ...
    out: capo_ssm.types.remove_tags_from_resource_result.RemoveTagsFromResourceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.remove_tags_from_resource_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
