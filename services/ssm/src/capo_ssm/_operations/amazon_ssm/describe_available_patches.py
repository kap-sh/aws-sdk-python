"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeAvailablePatches``."""
...
def handle_response(
    ...
    out: capo_ssm.types.describe_available_patches_result.DescribeAvailablePatchesResult = capo_ssm.types.describe_available_patches_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_available_patches_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_available_patches(
