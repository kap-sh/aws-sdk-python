...
import capo_ssm.errors.target_not_connected
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TargetNotConnected":
            raise capo_ssm.errors.target_not_connected.TargetNotConnected.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ssm.types.start_session_response.StartSessionResponse = (
        capo_ssm.types.start_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.start_session_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def start_session(
    ...
    input_: capo_ssm.types.start_session_request.StartSessionRequest,
) -> tuple[capo_ssm.types.start_session_response.StartSessionResponse, zapros.Response]:
