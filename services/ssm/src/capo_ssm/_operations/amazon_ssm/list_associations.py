...
def handle_response(
    ...
    out: capo_ssm.types.list_associations_result.ListAssociationsResult = (
        capo_ssm.types.list_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.list_associations_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_associations(
    ...
    capo_ssm.types.list_associations_result.ListAssociationsResult, zapros.Response
]:
