"""Generated from Smithy shape ``com.amazonaws.ssm#ListCommands``."""
...
def handle_response(
    ...
    out: capo_ssm.types.list_commands_result.ListCommandsResult = (
        capo_ssm.types.list_commands_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.list_commands_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_commands(
    ...
    input_: capo_ssm.types.list_commands_request.ListCommandsRequest,
) -> tuple[capo_ssm.types.list_commands_result.ListCommandsResult, zapros.Response]:
