...
def handle_response(
    ...
    out: capo_ssm.types.delete_ops_item_response.DeleteOpsItemResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.delete_ops_item_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_ops_item(
    ...
    capo_ssm.types.delete_ops_item_response.DeleteOpsItemResponse, zapros.Response
]:
