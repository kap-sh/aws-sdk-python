...
def handle_response(
    ...
    out: capo_ssm.types.describe_effective_instance_associations_result.DescribeEffectiveInstanceAssociationsResult = capo_ssm.types.describe_effective_instance_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_effective_instance_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
