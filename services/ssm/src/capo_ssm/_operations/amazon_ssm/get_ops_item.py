"""Generated from Smithy shape ``com.amazonaws.ssm#GetOpsItem``."""
...
def handle_response(
    ...
    out: capo_ssm.types.get_ops_item_response.GetOpsItemResponse = (
        capo_ssm.types.get_ops_item_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_ops_item_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_ops_item(
    ...
    input_: capo_ssm.types.get_ops_item_request.GetOpsItemRequest,
) -> tuple[capo_ssm.types.get_ops_item_response.GetOpsItemResponse, zapros.Response]:
