"""Generated from Smithy shape ``com.amazonaws.ssm#StopAutomationExecution``."""
...
import capo_ssm.errors.invalid_automation_status_update_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidAutomationStatusUpdateException":
            raise capo_ssm.errors.invalid_automation_status_update_exception.InvalidAutomationStatusUpdateException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ssm.types.stop_automation_execution_result.StopAutomationExecutionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.stop_automation_execution_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_stop_automation_execution(
