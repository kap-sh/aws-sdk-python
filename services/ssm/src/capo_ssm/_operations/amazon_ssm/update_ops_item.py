"""Generated from Smithy shape ``com.amazonaws.ssm#UpdateOpsItem``."""
...
import capo_ssm.errors.ops_item_access_denied_exception
import capo_ssm.errors.ops_item_already_exists_exception
import capo_ssm.errors.ops_item_conflict_exception
import capo_ssm.errors.ops_item_invalid_parameter_exception
import capo_ssm.errors.ops_item_limit_exceeded_exception
import capo_ssm.errors.ops_item_not_found_exception
...
def handle_response(
    ...
    out: capo_ssm.types.update_ops_item_response.UpdateOpsItemResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.update_ops_item_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_ops_item(
    ...
    capo_ssm.types.update_ops_item_response.UpdateOpsItemResponse, zapros.Response
]:
...
async def async_update_ops_item(
