"""Generated from Smithy shape ``com.amazonaws.ssm#GetMaintenanceWindowExecutionTask``."""
...
import capo_ssm.types.maintenance_window_task_parameters_list
...
def handle_response(
    ...
    out: capo_ssm.types.get_maintenance_window_execution_task_result.GetMaintenanceWindowExecutionTaskResult = capo_ssm.types.get_maintenance_window_execution_task_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_maintenance_window_execution_task_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_maintenance_window_execution_task(
