"""Generated from Smithy shape ``com.amazonaws.ssm#UpdatePatchBaseline``."""
...
def handle_response(
    ...
    out: capo_ssm.types.update_patch_baseline_result.UpdatePatchBaselineResult = (
        capo_ssm.types.update_patch_baseline_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.update_patch_baseline_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_patch_baseline(
