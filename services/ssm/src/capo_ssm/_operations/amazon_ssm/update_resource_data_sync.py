...
import capo_ssm.errors.resource_data_sync_conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceDataSyncConflictException":
            raise capo_ssm.errors.resource_data_sync_conflict_exception.ResourceDataSyncConflictException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ssm.types.update_resource_data_sync_result.UpdateResourceDataSyncResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.update_resource_data_sync_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
