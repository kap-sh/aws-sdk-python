...
def handle_response(
    ...
    out: capo_ssm.types.create_activation_result.CreateActivationResult = (
        capo_ssm.types.create_activation_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.create_activation_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_activation(
    ...
    capo_ssm.types.create_activation_result.CreateActivationResult, zapros.Response
]:
