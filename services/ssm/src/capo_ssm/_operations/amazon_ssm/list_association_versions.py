"""Generated from Smithy shape ``com.amazonaws.ssm#ListAssociationVersions``."""
...
def handle_response(
    ...
    out: capo_ssm.types.list_association_versions_result.ListAssociationVersionsResult = capo_ssm.types.list_association_versions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.list_association_versions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_association_versions(
