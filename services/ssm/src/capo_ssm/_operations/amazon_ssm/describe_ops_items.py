...
def handle_response(
    ...
    out: capo_ssm.types.describe_ops_items_response.DescribeOpsItemsResponse = (
        capo_ssm.types.describe_ops_items_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_ops_items_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_ops_items(
    ...
    capo_ssm.types.describe_ops_items_response.DescribeOpsItemsResponse, zapros.Response
]:
