"""Generated from Smithy shape ``com.amazonaws.ssm#GetParametersByPath``."""
...
def handle_response(
    ...
    out: capo_ssm.types.get_parameters_by_path_result.GetParametersByPathResult = (
        capo_ssm.types.get_parameters_by_path_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_parameters_by_path_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_parameters_by_path(
