"""Generated from Smithy shape ``com.amazonaws.ssm#ListComplianceItems``."""
...
import capo_ssm.errors.invalid_resource_type
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResourceType":
            raise capo_ssm.errors.invalid_resource_type.InvalidResourceType.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_ssm.types.list_compliance_items_result.ListComplianceItemsResult = (
        capo_ssm.types.list_compliance_items_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.list_compliance_items_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_compliance_items(
