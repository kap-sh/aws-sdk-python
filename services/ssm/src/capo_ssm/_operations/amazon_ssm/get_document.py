"""Generated from Smithy shape ``com.amazonaws.ssm#GetDocument``."""
...
def handle_response(
    ...
    out: capo_ssm.types.get_document_result.GetDocumentResult = (
        capo_ssm.types.get_document_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_ssm.types.get_document_request.GetDocumentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_document_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_document(
    ...
    input_: capo_ssm.types.get_document_request.GetDocumentRequest,
) -> tuple[capo_ssm.types.get_document_result.GetDocumentResult, zapros.Response]:
