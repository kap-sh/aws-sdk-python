"""Generated from Smithy shape ``com.amazonaws.ssm#UpdateMaintenanceWindow``."""
...
def handle_response(
    ...
    out: capo_ssm.types.update_maintenance_window_result.UpdateMaintenanceWindowResult = capo_ssm.types.update_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.update_maintenance_window_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_maintenance_window(
