"""Generated from Smithy shape ``com.amazonaws.ssm#StartExecutionPreview``."""
...
def handle_response(
    ...
    out: capo_ssm.types.start_execution_preview_response.StartExecutionPreviewResponse = capo_ssm.types.start_execution_preview_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.StartExecutionPreview"
    body: bytes | None = json.dumps(
        capo_ssm.types.start_execution_preview_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_start_execution_preview(
