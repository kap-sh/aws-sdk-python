...
import capo_ssm.errors.association_execution_does_not_exist
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AssociationExecutionDoesNotExist":
            raise capo_ssm.errors.association_execution_does_not_exist.AssociationExecutionDoesNotExist.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ssm.types.describe_association_execution_targets_result.DescribeAssociationExecutionTargetsResult = capo_ssm.types.describe_association_execution_targets_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_association_execution_targets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
