"""Generated from Smithy shape ``com.amazonaws.ssm#DeleteParameter``."""
...
def handle_response(
    ...
    out: capo_ssm.types.delete_parameter_result.DeleteParameterResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.delete_parameter_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_parameter(
    ...
    capo_ssm.types.delete_parameter_result.DeleteParameterResult, zapros.Response
]:
...
async def async_delete_parameter(
