...
import capo_ssm.errors.automation_step_not_found_exception
import capo_ssm.errors.internal_server_error
import capo_ssm.errors.invalid_automation_signal_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AutomationStepNotFoundException":
            raise capo_ssm.errors.automation_step_not_found_exception.AutomationStepNotFoundException.from_aws_json_1_1(
                data, message
            )
        ...
        case "InvalidAutomationSignalException":
            raise capo_ssm.errors.invalid_automation_signal_exception.InvalidAutomationSignalException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ssm.types.send_automation_signal_result.SendAutomationSignalResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.send_automation_signal_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
