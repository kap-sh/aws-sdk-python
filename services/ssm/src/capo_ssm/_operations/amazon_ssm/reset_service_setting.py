...
def handle_response(
    ...
    out: capo_ssm.types.reset_service_setting_result.ResetServiceSettingResult = (
        capo_ssm.types.reset_service_setting_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.reset_service_setting_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
