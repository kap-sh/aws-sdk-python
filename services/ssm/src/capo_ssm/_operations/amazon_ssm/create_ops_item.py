...
def handle_response(
    ...
    out: capo_ssm.types.create_ops_item_response.CreateOpsItemResponse = (
        capo_ssm.types.create_ops_item_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.create_ops_item_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_ops_item(
    ...
    capo_ssm.types.create_ops_item_response.CreateOpsItemResponse, zapros.Response
]:
