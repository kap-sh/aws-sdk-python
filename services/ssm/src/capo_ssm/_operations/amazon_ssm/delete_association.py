...
def handle_response(
    ...
    out: capo_ssm.types.delete_association_result.DeleteAssociationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.delete_association_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_association(
    ...
    capo_ssm.types.delete_association_result.DeleteAssociationResult, zapros.Response
]:
