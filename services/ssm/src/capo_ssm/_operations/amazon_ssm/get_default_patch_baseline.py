...
def handle_response(
    ...
    out: capo_ssm.types.get_default_patch_baseline_result.GetDefaultPatchBaselineResult = capo_ssm.types.get_default_patch_baseline_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_default_patch_baseline_request.serialize_aws_json_1_1(input_)
    ).encode()
