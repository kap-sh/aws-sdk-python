...
def handle_response(
    ...
    out: capo_ssm.types.get_parameter_result.GetParameterResult = (
        capo_ssm.types.get_parameter_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_parameter_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_parameter(
    ...
    input_: capo_ssm.types.get_parameter_request.GetParameterRequest,
) -> tuple[capo_ssm.types.get_parameter_result.GetParameterResult, zapros.Response]:
