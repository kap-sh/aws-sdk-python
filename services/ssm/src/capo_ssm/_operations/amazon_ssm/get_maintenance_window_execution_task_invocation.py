...
def handle_response(
    ...
    out: capo_ssm.types.get_maintenance_window_execution_task_invocation_result.GetMaintenanceWindowExecutionTaskInvocationResult = capo_ssm.types.get_maintenance_window_execution_task_invocation_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_maintenance_window_execution_task_invocation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
