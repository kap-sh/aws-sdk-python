"""Generated from Smithy shape ``com.amazonaws.ssm#GetResourcePolicies``."""
...
import capo_ssm.errors.resource_policy_invalid_parameter_exception
...
def handle_response(
    ...
    out: capo_ssm.types.get_resource_policies_response.GetResourcePoliciesResponse = (
        capo_ssm.types.get_resource_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.GetResourcePolicies"
    body: bytes | None = json.dumps(
        capo_ssm.types.get_resource_policies_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
