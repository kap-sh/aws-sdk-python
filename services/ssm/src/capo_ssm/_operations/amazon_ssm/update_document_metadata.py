"""Generated from Smithy shape ``com.amazonaws.ssm#UpdateDocumentMetadata``."""
...
import capo_ssm.errors.invalid_document_operation
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDocumentOperation":
            raise capo_ssm.errors.invalid_document_operation.InvalidDocumentOperation.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ssm.types.update_document_metadata_response.UpdateDocumentMetadataResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.UpdateDocumentMetadata"
    body: bytes | None = json.dumps(
        capo_ssm.types.update_document_metadata_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
