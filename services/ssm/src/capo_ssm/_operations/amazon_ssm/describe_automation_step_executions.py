"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeAutomationStepExecutions``."""
...
import capo_ssm.errors.automation_execution_not_found_exception
import capo_ssm.errors.internal_server_error
import capo_ssm.errors.invalid_filter_key
import capo_ssm.errors.invalid_filter_value
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AutomationExecutionNotFoundException":
            raise capo_ssm.errors.automation_execution_not_found_exception.AutomationExecutionNotFoundException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidFilterValue":
            raise capo_ssm.errors.invalid_filter_value.InvalidFilterValue.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_ssm.types.describe_automation_step_executions_result.DescribeAutomationStepExecutionsResult = capo_ssm.types.describe_automation_step_executions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_automation_step_executions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_automation_step_executions(
