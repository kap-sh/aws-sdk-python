...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidAssociation":
            raise capo_ssm.errors.invalid_association.InvalidAssociation.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ssm.types.start_associations_once_result.StartAssociationsOnceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.start_associations_once_request.serialize_aws_json_1_1(input_)
    ).encode()
