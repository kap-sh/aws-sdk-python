"""Generated from Smithy shape ``com.amazonaws.ssm#GetParameterHistory``."""
...
def handle_response(
    ...
    out: capo_ssm.types.get_parameter_history_result.GetParameterHistoryResult = (
        capo_ssm.types.get_parameter_history_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_parameter_history_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_parameter_history(
