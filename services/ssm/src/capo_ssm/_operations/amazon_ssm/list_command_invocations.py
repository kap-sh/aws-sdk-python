"""Generated from Smithy shape ``com.amazonaws.ssm#ListCommandInvocations``."""
...
import capo_ssm.errors.invalid_command_id
...
import capo_ssm.types.command_invocation_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidCommandId":
            raise capo_ssm.errors.invalid_command_id.InvalidCommandId.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ssm.types.list_command_invocations_result.ListCommandInvocationsResult = (
        capo_ssm.types.list_command_invocations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.list_command_invocations_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_command_invocations(
