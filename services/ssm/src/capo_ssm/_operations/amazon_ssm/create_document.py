...
import capo_ssm.errors.document_already_exists
...
def handle_response(
    ...
    out: capo_ssm.types.create_document_result.CreateDocumentResult = (
        capo_ssm.types.create_document_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.create_document_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_document(
    ...
    input_: capo_ssm.types.create_document_request.CreateDocumentRequest,
) -> tuple[capo_ssm.types.create_document_result.CreateDocumentResult, zapros.Response]:
