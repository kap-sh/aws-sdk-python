"""Generated from Smithy shape ``com.amazonaws.ssm#ListResourceDataSync``."""
...
import capo_ssm.types.resource_data_sync_item_list
...
def handle_response(
    ...
    out: capo_ssm.types.list_resource_data_sync_result.ListResourceDataSyncResult = (
        capo_ssm.types.list_resource_data_sync_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.list_resource_data_sync_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_resource_data_sync(
