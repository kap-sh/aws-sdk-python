...
import capo_ssm.errors.invalid_instance_information_filter_value
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidInstanceInformationFilterValue":
            raise capo_ssm.errors.invalid_instance_information_filter_value.InvalidInstanceInformationFilterValue.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ssm.types.describe_instance_information_result.DescribeInstanceInformationResult = capo_ssm.types.describe_instance_information_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_instance_information_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
