"""Generated from Smithy shape ``com.amazonaws.ssm#UpdateDocumentDefaultVersion``."""
...
import capo_ssm.errors.invalid_document_schema_version
...
def handle_response(
    ...
    out: capo_ssm.types.update_document_default_version_result.UpdateDocumentDefaultVersionResult = capo_ssm.types.update_document_default_version_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.update_document_default_version_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_document_default_version(
