...
def handle_response(
    ...
    out: capo_ssm.types.deregister_managed_instance_result.DeregisterManagedInstanceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.deregister_managed_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
