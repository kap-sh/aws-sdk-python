...
import capo_ssm.errors.invalid_document_content
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DocumentVersionLimitExceeded":
            raise capo_ssm.errors.document_version_limit_exceeded.DocumentVersionLimitExceeded.from_aws_json_1_1(
                data, message
            )
        case "DuplicateDocumentContent":
            raise capo_ssm.errors.duplicate_document_content.DuplicateDocumentContent.from_aws_json_1_1(
                data, message
            )
        case "DuplicateDocumentVersionName":
            raise capo_ssm.errors.duplicate_document_version_name.DuplicateDocumentVersionName.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ssm.types.update_document_result.UpdateDocumentResult = (
        capo_ssm.types.update_document_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.update_document_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_document(
    ...
    input_: capo_ssm.types.update_document_request.UpdateDocumentRequest,
) -> tuple[capo_ssm.types.update_document_result.UpdateDocumentResult, zapros.Response]:
