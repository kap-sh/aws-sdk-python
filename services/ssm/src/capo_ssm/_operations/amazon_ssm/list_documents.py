"""Generated from Smithy shape ``com.amazonaws.ssm#ListDocuments``."""
...
def handle_response(
    ...
    out: capo_ssm.types.list_documents_result.ListDocumentsResult = (
        capo_ssm.types.list_documents_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.list_documents_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_documents(
    ...
    input_: capo_ssm.types.list_documents_request.ListDocumentsRequest,
) -> tuple[capo_ssm.types.list_documents_result.ListDocumentsResult, zapros.Response]:
