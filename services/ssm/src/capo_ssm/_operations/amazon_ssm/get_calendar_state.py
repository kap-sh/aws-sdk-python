...
import capo_ssm.errors.invalid_document_type
import capo_ssm.errors.unsupported_calendar_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDocumentType":
            raise capo_ssm.errors.invalid_document_type.InvalidDocumentType.from_aws_json_1_1(
                data, message
            )
        case "UnsupportedCalendarException":
            raise capo_ssm.errors.unsupported_calendar_exception.UnsupportedCalendarException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_ssm.types.get_calendar_state_response.GetCalendarStateResponse = (
        capo_ssm.types.get_calendar_state_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_calendar_state_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_calendar_state(
    ...
    capo_ssm.types.get_calendar_state_response.GetCalendarStateResponse, zapros.Response
]:
