"""Generated from Smithy shape ``com.amazonaws.ssm#ListOpsItemEvents``."""
...
def handle_response(
    ...
    out: capo_ssm.types.list_ops_item_events_response.ListOpsItemEventsResponse = (
        capo_ssm.types.list_ops_item_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.ListOpsItemEvents"
    body: bytes | None = json.dumps(
        capo_ssm.types.list_ops_item_events_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_ops_item_events(
