"""Generated from Smithy shape ``com.amazonaws.ssm#GetPatchBaselineForPatchGroup``."""
...
def handle_response(
    ...
    out: capo_ssm.types.get_patch_baseline_for_patch_group_result.GetPatchBaselineForPatchGroupResult = capo_ssm.types.get_patch_baseline_for_patch_group_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_patch_baseline_for_patch_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_patch_baseline_for_patch_group(
