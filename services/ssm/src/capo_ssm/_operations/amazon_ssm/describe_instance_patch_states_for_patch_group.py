"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeInstancePatchStatesForPatchGroup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidFilter":
            raise capo_ssm.errors.invalid_filter.InvalidFilter.from_aws_json_1_1(data)
...
def handle_response(
    ...
    out: capo_ssm.types.describe_instance_patch_states_for_patch_group_result.DescribeInstancePatchStatesForPatchGroupResult = capo_ssm.types.describe_instance_patch_states_for_patch_group_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.DescribeInstancePatchStatesForPatchGroup"
    body: bytes | None = json.dumps(
        capo_ssm.types.describe_instance_patch_states_for_patch_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_instance_patch_states_for_patch_group(
