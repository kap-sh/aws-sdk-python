...
def handle_response(
    ...
    out: capo_ssm.types.list_ops_item_related_items_response.ListOpsItemRelatedItemsResponse = capo_ssm.types.list_ops_item_related_items_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.list_ops_item_related_items_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
