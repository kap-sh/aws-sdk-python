"""Generated from Smithy shape ``com.amazonaws.ssm#GetMaintenanceWindowExecution``."""
...
def handle_response(
    ...
    out: capo_ssm.types.get_maintenance_window_execution_result.GetMaintenanceWindowExecutionResult = capo_ssm.types.get_maintenance_window_execution_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.get_maintenance_window_execution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_maintenance_window_execution(
