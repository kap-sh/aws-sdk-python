...
import capo_ssm.errors.malformed_resource_policy_document_exception
import capo_ssm.errors.resource_not_found_exception
import capo_ssm.errors.resource_policy_conflict_exception
import capo_ssm.errors.resource_policy_invalid_parameter_exception
import capo_ssm.errors.resource_policy_limit_exceeded_exception
...
def handle_response(
    ...
    out: capo_ssm.types.put_resource_policy_response.PutResourcePolicyResponse = (
        capo_ssm.types.put_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.put_resource_policy_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
