...
import capo_ssm.errors.automation_definition_not_approved_exception
...
import capo_ssm.errors.no_longer_supported_exception
...
def handle_response(
    ...
    out: capo_ssm.types.start_change_request_execution_result.StartChangeRequestExecutionResult = capo_ssm.types.start_change_request_execution_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.start_change_request_execution_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
