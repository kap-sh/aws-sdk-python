...
def handle_response(
    ...
    out: capo_ssm.types.delete_parameters_result.DeleteParametersResult = (
        capo_ssm.types.delete_parameters_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.delete_parameters_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_parameters(
    ...
    capo_ssm.types.delete_parameters_result.DeleteParametersResult, zapros.Response
]:
