...
def handle_response(
    ...
    out: capo_ssm.types.delete_maintenance_window_result.DeleteMaintenanceWindowResult = capo_ssm.types.delete_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm.types.delete_maintenance_window_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
