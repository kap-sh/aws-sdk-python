"""Generated from Smithy shape ``com.amazonaws.ssm#UpdateManagedInstanceRole``."""
...
def handle_response(
    ...
    out: capo_ssm.types.update_managed_instance_role_result.UpdateManagedInstanceRoleResult = {}  # type: ignore[typeddict-item]
    return out
...
async def async_update_managed_instance_role(
