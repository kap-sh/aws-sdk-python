...
class ProgressCounters(TypedDict, closed=True):
    total_steps: "capo_ssm.types.integer.Integer"
    ...
    success_steps: "capo_ssm.types.integer.Integer"
    ...
    failed_steps: "capo_ssm.types.integer.Integer"
    ...
    cancelled_steps: "capo_ssm.types.integer.Integer"
    ...
    timed_out_steps: "capo_ssm.types.integer.Integer"
