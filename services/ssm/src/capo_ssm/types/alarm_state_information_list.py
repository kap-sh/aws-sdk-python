...
if TYPE_CHECKING:
    import capo_ssm.types.alarm_state_information

AlarmStateInformationList: TypeAlias = list[
    "capo_ssm.types.alarm_state_information.AlarmStateInformation"
]
...
def serialize_aws_json_1_1(value: AlarmStateInformationList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_ssm.types.alarm_state_information.serialize_aws_json_1_1(item))
    return out
