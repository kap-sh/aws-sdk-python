...
ResourceDataSyncItemList: TypeAlias = list[
    "capo_ssm.types.resource_data_sync_item.ResourceDataSyncItem"
]
...
def serialize_aws_json_1_1(value: ResourceDataSyncItemList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_ssm.types.resource_data_sync_item.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> ResourceDataSyncItemList:
    ...
    for item in data:
        out.append(
            capo_ssm.types.resource_data_sync_item.deserialize_aws_json_1_1(item)
        )
    return out
