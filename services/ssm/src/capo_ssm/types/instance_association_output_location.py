...
if TYPE_CHECKING:
    import capo_ssm.types.s3_output_location


class InstanceAssociationOutputLocation(TypedDict, closed=True):
    s3_location: NotRequired["capo_ssm.types.s3_output_location.S3OutputLocation"]
...
def serialize_aws_json_1_1(value: InstanceAssociationOutputLocation) -> dict:
    ...
    if "s3_location" in value:
        ...
        out["S3Location"] = capo_ssm.types.s3_output_location.serialize_aws_json_1_1(
            value["s3_location"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> InstanceAssociationOutputLocation:
    ...
    if "S3Location" in data:
        ...
        out["s3_location"] = capo_ssm.types.s3_output_location.deserialize_aws_json_1_1(
            data["S3Location"]
        )
    return out
