...
DocumentIdentifierList: TypeAlias = list[
    "capo_ssm.types.document_identifier.DocumentIdentifier"
]
...
def serialize_aws_json_1_1(value: DocumentIdentifierList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_ssm.types.document_identifier.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> DocumentIdentifierList:
    ...
    for item in data:
        out.append(capo_ssm.types.document_identifier.deserialize_aws_json_1_1(item))
    return out
