...
if TYPE_CHECKING:
    import capo_ssm.types.instances_count
    import capo_ssm.types.integer


class DescribePatchGroupStateResult(TypedDict, closed=True):
    instances: "capo_ssm.types.integer.Integer"
    """<p>The number of managed nodes in the patch group.</p>"""
    instances_with_installed_patches: "capo_ssm.types.integer.Integer"
    """<p>The number of managed nodes with installed patches.</p>"""
    instances_with_installed_other_patches: "capo_ssm.types.integer.Integer"
    ...
    instances_with_installed_pending_reboot_patches: NotRequired[
        "capo_ssm.types.instances_count.InstancesCount"
    ]
    ...
    instances_with_missing_patches: "capo_ssm.types.integer.Integer"
    """<p>The number of managed nodes with missing patches from the patch baseline.</p>"""
    instances_with_failed_patches: "capo_ssm.types.integer.Integer"
    """<p>The number of managed nodes with patches from the patch baseline that failed to install.</p>"""
    instances_with_not_applicable_patches: "capo_ssm.types.integer.Integer"
    ...
    instances_with_unreported_not_applicable_patches: NotRequired[
        "capo_ssm.types.integer.Integer"
    ]
