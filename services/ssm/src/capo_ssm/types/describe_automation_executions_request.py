...
class DescribeAutomationExecutionsRequest(TypedDict, closed=True):
    filters: NotRequired[
...
def serialize_aws_json_1_1(value: DescribeAutomationExecutionsRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            capo_ssm.types.automation_execution_filter_list.serialize_aws_json_1_1(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeAutomationExecutionsRequest:
    ...
    if data.get("Filters") is not None:
        ...
        out["filters"] = (
            capo_ssm.types.automation_execution_filter_list.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
