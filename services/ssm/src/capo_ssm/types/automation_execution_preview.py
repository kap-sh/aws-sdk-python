...
class AutomationExecutionPreview(TypedDict, closed=True):
    step_previews: NotRequired["capo_ssm.types.step_preview_map.StepPreviewMap"]
...
def serialize_aws_json_1_1(value: AutomationExecutionPreview) -> dict:
    ...
    if "step_previews" in value:
        ...
        out["StepPreviews"] = capo_ssm.types.step_preview_map.serialize_aws_json_1_1(
            value["step_previews"]
        )
    if "regions" in value:
        import capo_ssm.types.region_list

        out["Regions"] = capo_ssm.types.region_list.serialize_aws_json_1_1(
            value["regions"]
        )
    if "target_previews" in value:
        ...
        out["TargetPreviews"] = (
            capo_ssm.types.target_preview_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AutomationExecutionPreview:
    ...
    if data.get("TargetPreviews") is not None:
        ...
        out["target_previews"] = (
            capo_ssm.types.target_preview_list.deserialize_aws_json_1_1(
                data["TargetPreviews"]
            )
        )
