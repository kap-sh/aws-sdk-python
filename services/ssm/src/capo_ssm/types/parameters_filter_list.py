...
if TYPE_CHECKING:
    import capo_ssm.types.parameters_filter

ParametersFilterList: TypeAlias = list[
    "capo_ssm.types.parameters_filter.ParametersFilter"
]
...
def serialize_aws_json_1_1(value: ParametersFilterList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_ssm.types.parameters_filter.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> ParametersFilterList:
    ...
    for item in data:
        out.append(capo_ssm.types.parameters_filter.deserialize_aws_json_1_1(item))
    return out
