...
if TYPE_CHECKING:
    import capo_ssm.types.cloud_watch_log_group_name
    import capo_ssm.types.cloud_watch_output_enabled


class CloudWatchOutputConfig(TypedDict, closed=True):
    cloud_watch_log_group_name: NotRequired[
        "capo_ssm.types.cloud_watch_log_group_name.CloudWatchLogGroupName"
    ]
    ...
    cloud_watch_output_enabled: (
        "capo_ssm.types.cloud_watch_output_enabled.CloudWatchOutputEnabled"
    )
