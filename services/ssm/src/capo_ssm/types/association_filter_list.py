...
if TYPE_CHECKING:
    import capo_ssm.types.association_filter

AssociationFilterList: TypeAlias = list[
    "capo_ssm.types.association_filter.AssociationFilter"
]
...
def serialize_aws_json_1_1(value: AssociationFilterList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_ssm.types.association_filter.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> AssociationFilterList:
    ...
    for item in data:
        out.append(capo_ssm.types.association_filter.deserialize_aws_json_1_1(item))
    return out
