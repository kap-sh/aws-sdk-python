...
if TYPE_CHECKING:
    import capo_ssm.types.association_execution_filter

AssociationExecutionFilterList: TypeAlias = list[
    "capo_ssm.types.association_execution_filter.AssociationExecutionFilter"
]
...
def serialize_aws_json_1_1(value: AssociationExecutionFilterList) -> list:
    ...
    for item in value:
        out.append(
            capo_ssm.types.association_execution_filter.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AssociationExecutionFilterList:
    ...
    for item in data:
        out.append(
            capo_ssm.types.association_execution_filter.deserialize_aws_json_1_1(item)
        )
    return out
