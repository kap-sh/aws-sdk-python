...
class AssociationOverview(TypedDict, closed=True):
    ...
    association_status_aggregated_count: NotRequired[
        "capo_ssm.types.association_status_aggregated_count.AssociationStatusAggregatedCount"
    ]
...
def serialize_aws_json_1_1(value: AssociationOverview) -> dict:
    ...
    if "association_status_aggregated_count" in value:
        ...
        out["AssociationStatusAggregatedCount"] = (
            capo_ssm.types.association_status_aggregated_count.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AssociationOverview:
    ...
    if data.get("AssociationStatusAggregatedCount") is not None:
        ...
        out["association_status_aggregated_count"] = (
            capo_ssm.types.association_status_aggregated_count.deserialize_aws_json_1_1(
