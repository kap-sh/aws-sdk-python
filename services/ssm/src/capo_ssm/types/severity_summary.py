...
class SeveritySummary(TypedDict, closed=True):
    critical_count: "capo_ssm.types.compliance_summary_count.ComplianceSummaryCount"
    ...
    high_count: "capo_ssm.types.compliance_summary_count.ComplianceSummaryCount"
    ...
    medium_count: "capo_ssm.types.compliance_summary_count.ComplianceSummaryCount"
    ...
    low_count: "capo_ssm.types.compliance_summary_count.ComplianceSummaryCount"
    ...
    unspecified_count: "capo_ssm.types.compliance_summary_count.ComplianceSummaryCount"
