...
class UpdateDocumentDefaultVersionResult(TypedDict, closed=True):
    description: NotRequired[
        "capo_ssm.types.document_default_version_description.DocumentDefaultVersionDescription"
    ]
...
def serialize_aws_json_1_1(value: UpdateDocumentDefaultVersionResult) -> dict:
    ...
    if "description" in value:
        ...
        out["Description"] = (
            capo_ssm.types.document_default_version_description.serialize_aws_json_1_1(
                value["description"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UpdateDocumentDefaultVersionResult:
    ...
    if "Description" in data:
        ...
        out["description"] = (
            capo_ssm.types.document_default_version_description.deserialize_aws_json_1_1(
                data["Description"]
            )
        )
    return out
