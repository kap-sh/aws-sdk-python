...
if TYPE_CHECKING:
    import capo_ssm.types.activation_list
    import capo_ssm.types.next_token


class DescribeActivationsResult(TypedDict, closed=True):
    activation_list: NotRequired["capo_ssm.types.activation_list.ActivationList"]
...
def serialize_aws_json_1_1(value: DescribeActivationsResult) -> dict:
    ...
    if "activation_list" in value:
        ...
        out["ActivationList"] = capo_ssm.types.activation_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeActivationsResult:
    ...
    if data.get("ActivationList") is not None:
        import capo_ssm.types.activation_list

        out["activation_list"] = (
            capo_ssm.types.activation_list.deserialize_aws_json_1_1(
                data["ActivationList"]
            )
        )
