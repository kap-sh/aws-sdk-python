...
if TYPE_CHECKING:
    import capo_ssm.types.session_manager_cloud_watch_output_url
    import capo_ssm.types.session_manager_s3_output_url


class SessionManagerOutputUrl(TypedDict, closed=True):
    s3_output_url: NotRequired[
        "capo_ssm.types.session_manager_s3_output_url.SessionManagerS3OutputUrl"
    ]
    """<p>Reserved for future use.</p>"""
    cloud_watch_output_url: NotRequired[
        "capo_ssm.types.session_manager_cloud_watch_output_url.SessionManagerCloudWatchOutputUrl"
    ]
    """<p>Reserved for future use.</p>"""
