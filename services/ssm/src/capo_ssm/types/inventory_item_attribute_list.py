...
if TYPE_CHECKING:
    import capo_ssm.types.inventory_item_attribute

InventoryItemAttributeList: TypeAlias = list[
    "capo_ssm.types.inventory_item_attribute.InventoryItemAttribute"
]
...
def serialize_aws_json_1_1(value: InventoryItemAttributeList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_ssm.types.inventory_item_attribute.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> InventoryItemAttributeList:
    ...
    for item in data:
        out.append(
            capo_ssm.types.inventory_item_attribute.deserialize_aws_json_1_1(item)
        )
    return out
