...
if TYPE_CHECKING:
    import capo_ssm.types.resource_data_sync_organizational_unit_id


class ResourceDataSyncOrganizationalUnit(TypedDict, closed=True):
    organizational_unit_id: NotRequired[
        "capo_ssm.types.resource_data_sync_organizational_unit_id.ResourceDataSyncOrganizationalUnitId"
    ]
