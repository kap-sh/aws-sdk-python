...
class PatchStatus(TypedDict, closed=True):
    deployment_status: NotRequired[
        "capo_ssm.types.patch_deployment_status.PatchDeploymentStatus"
    ]
    ...
    approval_date: NotRequired["capo_ssm.types.date_time.DateTime"]
...
def serialize_aws_json_1_1(value: PatchStatus) -> dict:
    ...
    if "deployment_status" in value:
        ...
        out["DeploymentStatus"] = (
            capo_ssm.types.patch_deployment_status.serialize_aws_json_1_1(
    ...
    if "approval_date" in value:
        ...
        out["ApprovalDate"] = capo_ssm.types.date_time.serialize_aws_json_1_1(
            value["approval_date"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> PatchStatus:
    ...
    if "DeploymentStatus" in data:
        ...
        out["deployment_status"] = (
            capo_ssm.types.patch_deployment_status.deserialize_aws_json_1_1(
