...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm.types.install_override_list
    import aws_sdk_ssm.types.instance_id
    import aws_sdk_ssm.types.owner_information
    import aws_sdk_ssm.types.patch_available_security_update_count
    import aws_sdk_ssm.types.patch_critical_non_compliant_count
    import aws_sdk_ssm.types.patch_failed_count
    import aws_sdk_ssm.types.patch_group
    import aws_sdk_ssm.types.patch_installed_count
    import aws_sdk_ssm.types.patch_installed_other_count
    import aws_sdk_ssm.types.patch_installed_pending_reboot_count
    import aws_sdk_ssm.types.patch_installed_rejected_count
    import aws_sdk_ssm.types.patch_missing_count
    import aws_sdk_ssm.types.patch_not_applicable_count
    import aws_sdk_ssm.types.patch_operation_type
    import aws_sdk_ssm.types.patch_other_non_compliant_count
    import aws_sdk_ssm.types.patch_security_non_compliant_count
    import aws_sdk_ssm.types.patch_unreported_not_applicable_count
    import aws_sdk_ssm.types.reboot_option
...
class InstancePatchState(TypedDict):
    ...
    installed_count: "aws_sdk_ssm.types.patch_installed_count.PatchInstalledCount"
    """<p>The number of patches from the patch baseline that are installed on the managed node.</p>"""
    installed_other_count: (
        "aws_sdk_ssm.types.patch_installed_other_count.PatchInstalledOtherCount"
    )
    ...
    installed_pending_reboot_count: NotRequired[
        "aws_sdk_ssm.types.patch_installed_pending_reboot_count.PatchInstalledPendingRebootCount"
    ]
    ...
    installed_rejected_count: NotRequired[
        "aws_sdk_ssm.types.patch_installed_rejected_count.PatchInstalledRejectedCount"
    ]
    ...
    missing_count: "aws_sdk_ssm.types.patch_missing_count.PatchMissingCount"
    ...
    failed_count: "aws_sdk_ssm.types.patch_failed_count.PatchFailedCount"
    ...
    unreported_not_applicable_count: NotRequired[
        "aws_sdk_ssm.types.patch_unreported_not_applicable_count.PatchUnreportedNotApplicableCount"
    ]
    ...
    not_applicable_count: (
        "aws_sdk_ssm.types.patch_not_applicable_count.PatchNotApplicableCount"
    )
    ...
    available_security_update_count: NotRequired[
        "aws_sdk_ssm.types.patch_available_security_update_count.PatchAvailableSecurityUpdateCount"
    ]
    ...
    operation_start_time: "aws_sdk_ssm.types.date_time.DateTime"
    """<p>The time the most recent patching operation was started on the managed node.</p>"""
    operation_end_time: "aws_sdk_ssm.types.date_time.DateTime"
    """<p>The time the most recent patching operation completed on the managed node.</p>"""
    operation: "aws_sdk_ssm.types.patch_operation_type.PatchOperationType"
    ...
    reboot_option: NotRequired["aws_sdk_ssm.types.reboot_option.RebootOption"]
    ...
    critical_non_compliant_count: NotRequired[
        "aws_sdk_ssm.types.patch_critical_non_compliant_count.PatchCriticalNonCompliantCount"
    ]
    ...
    security_non_compliant_count: NotRequired[
        "aws_sdk_ssm.types.patch_security_non_compliant_count.PatchSecurityNonCompliantCount"
    ]
    ...
    other_non_compliant_count: NotRequired[
        "aws_sdk_ssm.types.patch_other_non_compliant_count.PatchOtherNonCompliantCount"
    ]
...
def serialize_aws_json_1_1(value: InstancePatchState) -> dict:
    ...
    out["OperationStartTime"] = aws_sdk_ssm.types.date_time.serialize_aws_json_1_1(
        value["operation_start_time"]
    )
    import aws_sdk_ssm.types.date_time

    out["OperationEndTime"] = aws_sdk_ssm.types.date_time.serialize_aws_json_1_1(
        value["operation_end_time"]
    )
    import aws_sdk_ssm.types.patch_operation_type

    out["Operation"] = aws_sdk_ssm.types.patch_operation_type.serialize_aws_json_1_1(
        value["operation"]
    )
    ...
    if "reboot_option" in value:
        ...
        out["RebootOption"] = aws_sdk_ssm.types.reboot_option.serialize_aws_json_1_1(
            value["reboot_option"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> InstancePatchState:
    ...
    if "Operation" in data:
        ...
        out["operation"] = (
            aws_sdk_ssm.types.patch_operation_type.deserialize_aws_json_1_1(
                data["Operation"]
            )
        )
    else:
    ...
    if "RebootOption" in data:
        ...
        out["reboot_option"] = aws_sdk_ssm.types.reboot_option.deserialize_aws_json_1_1(
            data["RebootOption"]
        )
