...
class CreateActivationRequest(TypedDict):
...
def serialize_aws_json_1_1(value: CreateActivationRequest) -> dict:
    ...
    if "registration_metadata" in value:
        ...
        out["RegistrationMetadata"] = (
            aws_sdk_ssm.types.registration_metadata_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CreateActivationRequest:
    ...
    if "RegistrationMetadata" in data:
        ...
        out["registration_metadata"] = (
            aws_sdk_ssm.types.registration_metadata_list.deserialize_aws_json_1_1(
