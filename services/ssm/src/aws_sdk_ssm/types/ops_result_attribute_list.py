...
if TYPE_CHECKING:
    import aws_sdk_ssm.types.ops_result_attribute

OpsResultAttributeList: TypeAlias = list[
    "aws_sdk_ssm.types.ops_result_attribute.OpsResultAttribute"
]
...
def serialize_aws_json_1_1(value: OpsResultAttributeList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_ssm.types.ops_result_attribute.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> OpsResultAttributeList:
    ...
    for item in data:
        out.append(
            aws_sdk_ssm.types.ops_result_attribute.deserialize_aws_json_1_1(item)
        )
    return out
