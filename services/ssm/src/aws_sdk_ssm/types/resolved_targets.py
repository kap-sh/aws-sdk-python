...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm.types.target_parameter_list


class ResolvedTargets(TypedDict):
    parameter_values: NotRequired[
        "aws_sdk_ssm.types.target_parameter_list.TargetParameterList"
    ]
    """<p>A list of parameter values sent to targets that resolved during the Automation execution.</p>"""
    truncated: "aws_sdk_ssm.types.boolean.Boolean"
...
def serialize_aws_json_1_1(value: ResolvedTargets) -> dict:
    ...
    if "parameter_values" in value:
        ...
        out["ParameterValues"] = (
            aws_sdk_ssm.types.target_parameter_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ResolvedTargets:
    ...
    if "ParameterValues" in data:
        ...
        out["parameter_values"] = (
            aws_sdk_ssm.types.target_parameter_list.deserialize_aws_json_1_1(
