...
if TYPE_CHECKING:
    import aws_sdk_ssm.types.document_filter_key
    import aws_sdk_ssm.types.document_filter_value


class DocumentFilter(TypedDict, closed=True):
    key: "aws_sdk_ssm.types.document_filter_key.DocumentFilterKey"
    """<p>The name of the filter.</p>"""
    value: "aws_sdk_ssm.types.document_filter_value.DocumentFilterValue"
...
def serialize_aws_json_1_1(value: DocumentFilter) -> dict:
    ...
    out["key"] = aws_sdk_ssm.types.document_filter_key.serialize_aws_json_1_1(
        value["key"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> DocumentFilter:
    ...
    if "key" in data:
        ...
        out["key"] = aws_sdk_ssm.types.document_filter_key.deserialize_aws_json_1_1(
            data["key"]
        )
    else:
