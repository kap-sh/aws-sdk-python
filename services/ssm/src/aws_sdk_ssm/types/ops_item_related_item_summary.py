...
class OpsItemRelatedItemSummary(TypedDict):
    ...
    resource_type: NotRequired[
        "aws_sdk_ssm.types.ops_item_related_item_association_resource_type.OpsItemRelatedItemAssociationResourceType"
    ]
    """<p>The resource type.</p>"""
    association_type: NotRequired[
        "aws_sdk_ssm.types.ops_item_related_item_association_type.OpsItemRelatedItemAssociationType"
    ]
    ...
    last_modified_by: NotRequired["aws_sdk_ssm.types.ops_item_identity.OpsItemIdentity"]
...
def serialize_aws_json_1_1(value: OpsItemRelatedItemSummary) -> dict:
    ...
    if "last_modified_by" in value:
        ...
        out["LastModifiedBy"] = (
            aws_sdk_ssm.types.ops_item_identity.serialize_aws_json_1_1(
