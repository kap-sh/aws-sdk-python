...
class InstanceInformation(TypedDict):
    ...
    is_latest_version: NotRequired["aws_sdk_ssm.types.boolean.Boolean"]
    ...
    platform_name: NotRequired["aws_sdk_ssm.types.string.String"]
    """<p>The name of the operating system platform running on your managed node. </p>"""
    platform_version: NotRequired["aws_sdk_ssm.types.string.String"]
    ...
    name: NotRequired["aws_sdk_ssm.types.string.String"]
