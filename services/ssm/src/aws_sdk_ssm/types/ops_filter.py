...
if TYPE_CHECKING:
    import aws_sdk_ssm.types.ops_filter_key
    import aws_sdk_ssm.types.ops_filter_operator_type
...
class OpsFilter(TypedDict, closed=True):
    ...
    type: NotRequired[
        "aws_sdk_ssm.types.ops_filter_operator_type.OpsFilterOperatorType"
    ]
...
def serialize_aws_json_1_1(value: OpsFilter) -> dict:
    ...
    out["Values"] = aws_sdk_ssm.types.ops_filter_value_list.serialize_aws_json_1_1(
        value["values"]
    )
    if "type" in value:
        import aws_sdk_ssm.types.ops_filter_operator_type

        out["Type"] = aws_sdk_ssm.types.ops_filter_operator_type.serialize_aws_json_1_1(
            value["type"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> OpsFilter:
    ...
    if "Values" in data:
        ...
        out["values"] = (
            aws_sdk_ssm.types.ops_filter_value_list.deserialize_aws_json_1_1(
                data["Values"]
            )
        )
    else:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_ssm.types.ops_filter_operator_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    return out
