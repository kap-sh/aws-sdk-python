...
class CreateAssociationBatchRequest(TypedDict):
...
def serialize_aws_json_1_1(value: CreateAssociationBatchRequest) -> dict:
    ...
    out["Entries"] = (
        aws_sdk_ssm.types.create_association_batch_request_entries.serialize_aws_json_1_1(
            value["entries"]
        )
    )
...
def deserialize_aws_json_1_1(data: dict) -> CreateAssociationBatchRequest:
    ...
    if "Entries" in data:
        ...
        out["entries"] = (
            aws_sdk_ssm.types.create_association_batch_request_entries.deserialize_aws_json_1_1(
                data["Entries"]
            )
        )
    else:
