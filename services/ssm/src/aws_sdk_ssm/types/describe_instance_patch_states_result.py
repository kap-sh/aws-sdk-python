...
class DescribeInstancePatchStatesResult(TypedDict):
    instance_patch_states: NotRequired[
        "aws_sdk_ssm.types.instance_patch_state_list.InstancePatchStateList"
    ]
...
def serialize_aws_json_1_1(value: DescribeInstancePatchStatesResult) -> dict:
    ...
    if "instance_patch_states" in value:
        ...
        out["InstancePatchStates"] = (
            aws_sdk_ssm.types.instance_patch_state_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeInstancePatchStatesResult:
    ...
    if "InstancePatchStates" in data:
        ...
        out["instance_patch_states"] = (
            aws_sdk_ssm.types.instance_patch_state_list.deserialize_aws_json_1_1(
