...
class DocumentKeyValuesFilter(TypedDict, closed=True):
    ...
    values: NotRequired[
        "aws_sdk_ssm.types.document_key_values_filter_values.DocumentKeyValuesFilterValues"
    ]
...
def serialize_aws_json_1_1(value: DocumentKeyValuesFilter) -> dict:
    ...
    if "values" in value:
        ...
        out["Values"] = (
            aws_sdk_ssm.types.document_key_values_filter_values.serialize_aws_json_1_1(
                value["values"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DocumentKeyValuesFilter:
    ...
    if "Values" in data:
        ...
        out["values"] = (
            aws_sdk_ssm.types.document_key_values_filter_values.deserialize_aws_json_1_1(
                data["Values"]
            )
        )
    return out
