...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm.types.resource_compliance_summary_item_list


class ListResourceComplianceSummariesResult(TypedDict):
    resource_compliance_summary_items: NotRequired[
        "aws_sdk_ssm.types.resource_compliance_summary_item_list.ResourceComplianceSummaryItemList"
    ]
...
def serialize_aws_json_1_1(value: ListResourceComplianceSummariesResult) -> dict:
    ...
    if "resource_compliance_summary_items" in value:
        ...
        out["ResourceComplianceSummaryItems"] = (
            aws_sdk_ssm.types.resource_compliance_summary_item_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListResourceComplianceSummariesResult:
    ...
    if "ResourceComplianceSummaryItems" in data:
        ...
        out["resource_compliance_summary_items"] = (
            aws_sdk_ssm.types.resource_compliance_summary_item_list.deserialize_aws_json_1_1(
