...
class StartChangeRequestExecutionRequest(TypedDict, closed=True):
    ...
    auto_approve: "aws_sdk_ssm.types.boolean.Boolean"
    ...
    scheduled_end_time: NotRequired["aws_sdk_ssm.types.date_time.DateTime"]
...
def serialize_aws_json_1_1(value: StartChangeRequestExecutionRequest) -> dict:
    ...
    if "scheduled_end_time" in value:
        ...
        out["ScheduledEndTime"] = aws_sdk_ssm.types.date_time.serialize_aws_json_1_1(
