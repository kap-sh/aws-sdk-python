...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm.types.association_overview
...
class AssociationDescription(TypedDict):
    ...
    date: NotRequired["aws_sdk_ssm.types.date_time.DateTime"]
    """<p>The date when the association was made.</p>"""
    last_update_association_date: NotRequired["aws_sdk_ssm.types.date_time.DateTime"]
    """<p>The date when the association was last updated.</p>"""
    status: NotRequired["aws_sdk_ssm.types.association_status.AssociationStatus"]
    """<p>The association status.</p>"""
    overview: NotRequired["aws_sdk_ssm.types.association_overview.AssociationOverview"]
    ...
    last_successful_execution_date: NotRequired["aws_sdk_ssm.types.date_time.DateTime"]
...
def serialize_aws_json_1_1(value: AssociationDescription) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = aws_sdk_ssm.types.association_status.serialize_aws_json_1_1(
            value["status"]
        )
    if "overview" in value:
        import aws_sdk_ssm.types.association_overview

        out["Overview"] = aws_sdk_ssm.types.association_overview.serialize_aws_json_1_1(
            value["overview"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> AssociationDescription:
    ...
    if "Status" in data:
        ...
        out["status"] = aws_sdk_ssm.types.association_status.deserialize_aws_json_1_1(
            data["Status"]
        )
    if "Overview" in data:
        import aws_sdk_ssm.types.association_overview
        ...
        out["overview"] = (
            aws_sdk_ssm.types.association_overview.deserialize_aws_json_1_1(
                data["Overview"]
            )
        )
