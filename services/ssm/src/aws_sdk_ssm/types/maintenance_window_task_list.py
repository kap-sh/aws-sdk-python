...
MaintenanceWindowTaskList: TypeAlias = list[
    "aws_sdk_ssm.types.maintenance_window_task.MaintenanceWindowTask"
]
...
def serialize_aws_json_1_1(value: MaintenanceWindowTaskList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_ssm.types.maintenance_window_task.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> MaintenanceWindowTaskList:
    ...
    for item in data:
        out.append(
            aws_sdk_ssm.types.maintenance_window_task.deserialize_aws_json_1_1(item)
        )
    return out
