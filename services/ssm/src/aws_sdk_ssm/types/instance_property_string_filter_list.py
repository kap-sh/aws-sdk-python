...
if TYPE_CHECKING:
    import aws_sdk_ssm.types.instance_property_string_filter

InstancePropertyStringFilterList: TypeAlias = list[
    "aws_sdk_ssm.types.instance_property_string_filter.InstancePropertyStringFilter"
]
...
def serialize_aws_json_1_1(value: InstancePropertyStringFilterList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_ssm.types.instance_property_string_filter.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> InstancePropertyStringFilterList:
    ...
    for item in data:
        out.append(
            aws_sdk_ssm.types.instance_property_string_filter.deserialize_aws_json_1_1(
                item
            )
        )
    return out
