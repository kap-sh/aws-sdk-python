...
InstanceProperties: TypeAlias = list[
    "aws_sdk_ssm.types.instance_property.InstanceProperty"
]
...
def serialize_aws_json_1_1(value: InstanceProperties) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_ssm.types.instance_property.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> InstanceProperties:
    ...
    for item in data:
        out.append(aws_sdk_ssm.types.instance_property.deserialize_aws_json_1_1(item))
    return out
