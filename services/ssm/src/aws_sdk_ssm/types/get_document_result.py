...
class GetDocumentResult(TypedDict):
    ...
    attachments_content: NotRequired[
        "aws_sdk_ssm.types.attachment_content_list.AttachmentContentList"
    ]
...
def serialize_aws_json_1_1(value: GetDocumentResult) -> dict:
    ...
    if "attachments_content" in value:
        ...
        out["AttachmentsContent"] = (
            aws_sdk_ssm.types.attachment_content_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetDocumentResult:
    ...
    if "AttachmentsContent" in data:
        import aws_sdk_ssm.types.attachment_content_list

        out["attachments_content"] = (
            aws_sdk_ssm.types.attachment_content_list.deserialize_aws_json_1_1(
