...
if TYPE_CHECKING:
    import aws_sdk_ssm.types.node_account_id
    import aws_sdk_ssm.types.node_organizational_unit_id
    import aws_sdk_ssm.types.node_organizational_unit_path


class NodeOwnerInfo(TypedDict):
    account_id: NotRequired["aws_sdk_ssm.types.node_account_id.NodeAccountId"]
    """<p>The ID of the Amazon Web Services account that owns the managed node.</p>"""
    organizational_unit_id: NotRequired[
        "aws_sdk_ssm.types.node_organizational_unit_id.NodeOrganizationalUnitId"
    ]
    """<p>The ID of the organization unit (OU) that the account is part of.</p>"""
    organizational_unit_path: NotRequired[
        "aws_sdk_ssm.types.node_organizational_unit_path.NodeOrganizationalUnitPath"
    ]
