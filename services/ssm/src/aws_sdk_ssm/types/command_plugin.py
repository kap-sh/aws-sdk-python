...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm.types.command_plugin_output
    import aws_sdk_ssm.types.command_plugin_status
...
class CommandPlugin(TypedDict):
    ...
    response_start_date_time: NotRequired["aws_sdk_ssm.types.date_time.DateTime"]
    """<p>The time the plugin started running. </p>"""
    response_finish_date_time: NotRequired["aws_sdk_ssm.types.date_time.DateTime"]
    """<p>The time the plugin stopped running. Could stop prematurely if, for example, a cancel command was sent. </p>"""
    output: NotRequired["aws_sdk_ssm.types.command_plugin_output.CommandPluginOutput"]
...
def serialize_aws_json_1_1(value: CommandPlugin) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = aws_sdk_ssm.types.command_plugin_status.serialize_aws_json_1_1(
            value["status"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> CommandPlugin:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_ssm.types.command_plugin_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
