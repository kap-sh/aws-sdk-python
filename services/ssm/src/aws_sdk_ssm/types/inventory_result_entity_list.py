...
InventoryResultEntityList: TypeAlias = list[
    "aws_sdk_ssm.types.inventory_result_entity.InventoryResultEntity"
]
...
def serialize_aws_json_1_1(value: InventoryResultEntityList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_ssm.types.inventory_result_entity.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> InventoryResultEntityList:
    ...
    for item in data:
        out.append(
            aws_sdk_ssm.types.inventory_result_entity.deserialize_aws_json_1_1(item)
        )
    return out
