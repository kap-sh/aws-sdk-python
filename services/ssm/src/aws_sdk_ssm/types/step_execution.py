...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm.types.failure_details
    import aws_sdk_ssm.types.integer
    import aws_sdk_ssm.types.long
    import aws_sdk_ssm.types.normal_string_map
    import aws_sdk_ssm.types.parent_step_details
...
class StepExecution(TypedDict):
    ...
    timeout_seconds: NotRequired["aws_sdk_ssm.types.long.Long"]
    """<p>The timeout seconds of the step.</p>"""
    on_failure: NotRequired["aws_sdk_ssm.types.string.String"]
    """<p>The action to take if the step fails. The default value is <code>Abort</code>.</p>"""
    max_attempts: NotRequired["aws_sdk_ssm.types.integer.Integer"]
    ...
    response_code: NotRequired["aws_sdk_ssm.types.string.String"]
    """<p>The response code returned by the execution of the step.</p>"""
    inputs: NotRequired["aws_sdk_ssm.types.normal_string_map.NormalStringMap"]
    ...
    response: NotRequired["aws_sdk_ssm.types.string.String"]
    ...
    failure_details: NotRequired["aws_sdk_ssm.types.failure_details.FailureDetails"]
    ...
    is_end: NotRequired["aws_sdk_ssm.types.boolean.Boolean"]
    """<p>The flag which can be used to end automation no matter whether the step succeeds or fails.</p>"""
    next_step: NotRequired["aws_sdk_ssm.types.string.String"]
    """<p>The next step after the step succeeds.</p>"""
    is_critical: NotRequired["aws_sdk_ssm.types.boolean.Boolean"]
    ...
    valid_next_steps: NotRequired[
        "aws_sdk_ssm.types.valid_next_step_list.ValidNextStepList"
    ]
    ...
    target_location: NotRequired["aws_sdk_ssm.types.target_location.TargetLocation"]
    ...
    parent_step_details: NotRequired[
        "aws_sdk_ssm.types.parent_step_details.ParentStepDetails"
    ]
...
def serialize_aws_json_1_1(value: StepExecution) -> dict:
    ...
    if "inputs" in value:
        ...
        out["Inputs"] = aws_sdk_ssm.types.normal_string_map.serialize_aws_json_1_1(
            value["inputs"]
        )
    if "outputs" in value:
        import aws_sdk_ssm.types.automation_parameter_map
    ...
    if "failure_details" in value:
        ...
        out["FailureDetails"] = (
            aws_sdk_ssm.types.failure_details.serialize_aws_json_1_1(
    ...
    if "valid_next_steps" in value:
        ...
        out["ValidNextSteps"] = (
            aws_sdk_ssm.types.valid_next_step_list.serialize_aws_json_1_1(
    ...
    if "target_location" in value:
        ...
        out["TargetLocation"] = (
            aws_sdk_ssm.types.target_location.serialize_aws_json_1_1(
    ...
    if "parent_step_details" in value:
        ...
        out["ParentStepDetails"] = (
            aws_sdk_ssm.types.parent_step_details.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> StepExecution:
    ...
    if "Inputs" in data:
        ...
        out["inputs"] = aws_sdk_ssm.types.normal_string_map.deserialize_aws_json_1_1(
            data["Inputs"]
        )
    if "Outputs" in data:
        import aws_sdk_ssm.types.automation_parameter_map
    ...
    if "FailureDetails" in data:
        ...
        out["failure_details"] = (
            aws_sdk_ssm.types.failure_details.deserialize_aws_json_1_1(
                data["FailureDetails"]
            )
        )
    ...
    if "ValidNextSteps" in data:
        ...
        out["valid_next_steps"] = (
            aws_sdk_ssm.types.valid_next_step_list.deserialize_aws_json_1_1(
                data["ValidNextSteps"]
            )
        )
    if "Targets" in data:
    ...
    if "TargetLocation" in data:
        ...
        out["target_location"] = (
            aws_sdk_ssm.types.target_location.deserialize_aws_json_1_1(
                data["TargetLocation"]
            )
        )
    ...
    if "ParentStepDetails" in data:
        ...
        out["parent_step_details"] = (
            aws_sdk_ssm.types.parent_step_details.deserialize_aws_json_1_1(
