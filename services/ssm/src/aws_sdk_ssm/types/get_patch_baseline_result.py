...
class GetPatchBaselineResult(TypedDict):
    ...
    patch_groups: NotRequired["aws_sdk_ssm.types.patch_group_list.PatchGroupList"]
...
def serialize_aws_json_1_1(value: GetPatchBaselineResult) -> dict:
    ...
    if "patch_groups" in value:
        ...
        out["PatchGroups"] = aws_sdk_ssm.types.patch_group_list.serialize_aws_json_1_1(
            value["patch_groups"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetPatchBaselineResult:
    ...
    if "PatchGroups" in data:
        ...
        out["patch_groups"] = (
            aws_sdk_ssm.types.patch_group_list.deserialize_aws_json_1_1(
                data["PatchGroups"]
            )
        )
