...
class GetInventorySchemaRequest(TypedDict):
    ...
    aggregator: "aws_sdk_ssm.types.aggregator_schema_only.AggregatorSchemaOnly"
    ...
    sub_type: NotRequired["aws_sdk_ssm.types.is_sub_type_schema.IsSubTypeSchema"]
