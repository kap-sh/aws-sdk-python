...
class DescribeInstanceInformationRequest(TypedDict):
...
def serialize_aws_json_1_1(value: DescribeInstanceInformationRequest) -> dict:
    ...
    if "instance_information_filter_list" in value:
        ...
        out["InstanceInformationFilterList"] = (
            aws_sdk_ssm.types.instance_information_filter_list.serialize_aws_json_1_1(
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            aws_sdk_ssm.types.instance_information_string_filter_list.serialize_aws_json_1_1(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeInstanceInformationRequest:
    ...
    if "InstanceInformationFilterList" in data:
        import aws_sdk_ssm.types.instance_information_filter_list

        out["instance_information_filter_list"] = (
            aws_sdk_ssm.types.instance_information_filter_list.deserialize_aws_json_1_1(
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_ssm.types.instance_information_string_filter_list.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
