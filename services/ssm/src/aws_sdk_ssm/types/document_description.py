...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm.types.category_enum_list
    import aws_sdk_ssm.types.category_list
    import aws_sdk_ssm.types.date_time
    import aws_sdk_ssm.types.description_in_document
    ...
    import aws_sdk_ssm.types.review_information_list
...
class DocumentDescription(TypedDict):
    ...
    hash_type: NotRequired["aws_sdk_ssm.types.document_hash_type.DocumentHashType"]
    ...
    description: NotRequired[
        "aws_sdk_ssm.types.description_in_document.DescriptionInDocument"
    ]
    """<p>A description of the document. </p>"""
    parameters: NotRequired[
        "aws_sdk_ssm.types.document_parameter_list.DocumentParameterList"
    ]
    ...
    latest_version: NotRequired["aws_sdk_ssm.types.document_version.DocumentVersion"]
    ...
    attachments_information: NotRequired[
        "aws_sdk_ssm.types.attachment_information_list.AttachmentInformationList"
    ]
    ...
    review_information: NotRequired[
        "aws_sdk_ssm.types.review_information_list.ReviewInformationList"
    ]
    """<p>Details about the review of a document.</p>"""
    approved_version: NotRequired["aws_sdk_ssm.types.document_version.DocumentVersion"]
    ...
    category: NotRequired["aws_sdk_ssm.types.category_list.CategoryList"]
    """<p>The classification of a document to help you identify and categorize its use.</p>"""
    category_enum: NotRequired["aws_sdk_ssm.types.category_enum_list.CategoryEnumList"]
...
def serialize_aws_json_1_1(value: DocumentDescription) -> dict:
    ...
    if "hash_type" in value:
        ...
        out["HashType"] = aws_sdk_ssm.types.document_hash_type.serialize_aws_json_1_1(
            value["hash_type"]
        )
    if "name" in value:
        out["Name"] = value["name"]
    ...
    if "parameters" in value:
        ...
        out["Parameters"] = (
            aws_sdk_ssm.types.document_parameter_list.serialize_aws_json_1_1(
                value["parameters"]
            )
        )
    ...
    if "attachments_information" in value:
        ...
        out["AttachmentsInformation"] = (
            aws_sdk_ssm.types.attachment_information_list.serialize_aws_json_1_1(
    ...
    if "review_information" in value:
        ...
        out["ReviewInformation"] = (
            aws_sdk_ssm.types.review_information_list.serialize_aws_json_1_1(
    ...
    if "category" in value:
        ...
        out["Category"] = aws_sdk_ssm.types.category_list.serialize_aws_json_1_1(
            value["category"]
        )
    if "category_enum" in value:
        ...
        out["CategoryEnum"] = (
            aws_sdk_ssm.types.category_enum_list.serialize_aws_json_1_1(
                value["category_enum"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DocumentDescription:
    ...
    if "Parameters" in data:
        ...
        out["parameters"] = (
            aws_sdk_ssm.types.document_parameter_list.deserialize_aws_json_1_1(
                data["Parameters"]
            )
        )
    ...
    if "AttachmentsInformation" in data:
        ...
        out["attachments_information"] = (
            aws_sdk_ssm.types.attachment_information_list.deserialize_aws_json_1_1(
    ...
    if "ReviewInformation" in data:
        ...
        out["review_information"] = (
            aws_sdk_ssm.types.review_information_list.deserialize_aws_json_1_1(
    ...
    if "Category" in data:
        ...
        out["category"] = aws_sdk_ssm.types.category_list.deserialize_aws_json_1_1(
            data["Category"]
        )
    if "CategoryEnum" in data:
        ...
        out["category_enum"] = (
            aws_sdk_ssm.types.category_enum_list.deserialize_aws_json_1_1(
                data["CategoryEnum"]
            )
        )
    return out
