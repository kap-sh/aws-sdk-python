...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm.types.resource_data_sync_state


class ResourceDataSyncSourceWithState(TypedDict):
    ...
    source_regions: NotRequired[
        "aws_sdk_ssm.types.resource_data_sync_source_region_list.ResourceDataSyncSourceRegionList"
    ]
    ...
    state: NotRequired[
        "aws_sdk_ssm.types.resource_data_sync_state.ResourceDataSyncState"
    ]
