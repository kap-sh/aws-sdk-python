"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeMaintenanceWindowsRequest``."""
...
class DescribeMaintenanceWindowsRequest(TypedDict, closed=True):
    filters: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeMaintenanceWindowsRequest) -> dict:
    out: dict = {}
    if "filters" in value:
        import aws_sdk_ssm.types.maintenance_window_filter_list
...
def deserialize_aws_json_1_1(data: dict) -> DescribeMaintenanceWindowsRequest:
    out: DescribeMaintenanceWindowsRequest = {}  # type: ignore[typeddict-item]
    if "Filters" in data:
        import aws_sdk_ssm.types.maintenance_window_filter_list
