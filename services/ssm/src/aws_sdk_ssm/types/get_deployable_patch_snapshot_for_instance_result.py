...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm.types.product
    import aws_sdk_ssm.types.snapshot_download_url
    import aws_sdk_ssm.types.snapshot_id


class GetDeployablePatchSnapshotForInstanceResult(TypedDict):
    instance_id: NotRequired["aws_sdk_ssm.types.instance_id.InstanceId"]
    """<p>The managed node ID.</p>"""
    snapshot_id: NotRequired["aws_sdk_ssm.types.snapshot_id.SnapshotId"]
    """<p>The user-defined snapshot ID.</p>"""
    snapshot_download_url: NotRequired[
        "aws_sdk_ssm.types.snapshot_download_url.SnapshotDownloadUrl"
    ]
    """<p>A pre-signed Amazon Simple Storage Service (Amazon S3) URL that can be used to download the patch snapshot.</p>"""
    product: NotRequired["aws_sdk_ssm.types.product.Product"]
