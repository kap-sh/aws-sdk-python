...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm.types.patch_advisory_id_list
    import aws_sdk_ssm.types.patch_arch
    import aws_sdk_ssm.types.patch_bugzilla_id_list
    import aws_sdk_ssm.types.patch_classification
    import aws_sdk_ssm.types.patch_content_url
    import aws_sdk_ssm.types.patch_cve_id_list
    import aws_sdk_ssm.types.patch_description
    import aws_sdk_ssm.types.patch_epoch
    import aws_sdk_ssm.types.patch_id
    import aws_sdk_ssm.types.patch_kb_number
    import aws_sdk_ssm.types.patch_language
    import aws_sdk_ssm.types.patch_msrc_number
    import aws_sdk_ssm.types.patch_msrc_severity
    import aws_sdk_ssm.types.patch_name
    import aws_sdk_ssm.types.patch_product
    import aws_sdk_ssm.types.patch_product_family
    import aws_sdk_ssm.types.patch_release
    import aws_sdk_ssm.types.patch_repository
    import aws_sdk_ssm.types.patch_severity
    import aws_sdk_ssm.types.patch_title
    import aws_sdk_ssm.types.patch_vendor
...
class Patch(TypedDict, closed=True):
    ...
    title: NotRequired["aws_sdk_ssm.types.patch_title.PatchTitle"]
    """<p>The title of the patch.</p>"""
    description: NotRequired["aws_sdk_ssm.types.patch_description.PatchDescription"]
    """<p>The description of the patch.</p>"""
    content_url: NotRequired["aws_sdk_ssm.types.patch_content_url.PatchContentUrl"]
    """<p>The URL where more information can be obtained about the patch.</p>"""
    vendor: NotRequired["aws_sdk_ssm.types.patch_vendor.PatchVendor"]
    """<p>The name of the vendor providing the patch.</p>"""
    product_family: NotRequired[
        "aws_sdk_ssm.types.patch_product_family.PatchProductFamily"
    ]
    """<p>The product family the patch is applicable for. For example, <code>Windows</code> or <code>Amazon Linux 2</code>.</p>"""
    product: NotRequired["aws_sdk_ssm.types.patch_product.PatchProduct"]
    ...
    classification: NotRequired[
        "aws_sdk_ssm.types.patch_classification.PatchClassification"
    ]
    """<p>The classification of the patch. For example, <code>SecurityUpdates</code>, <code>Updates</code>, or <code>CriticalUpdates</code>.</p>"""
    msrc_severity: NotRequired[
        "aws_sdk_ssm.types.patch_msrc_severity.PatchMsrcSeverity"
    ]
    ...
    kb_number: NotRequired["aws_sdk_ssm.types.patch_kb_number.PatchKbNumber"]
    """<p>The Microsoft Knowledge Base ID of the patch. Applies to Windows patches only.</p>"""
    msrc_number: NotRequired["aws_sdk_ssm.types.patch_msrc_number.PatchMsrcNumber"]
    ...
    language: NotRequired["aws_sdk_ssm.types.patch_language.PatchLanguage"]
    """<p>The language of the patch if it's language-specific.</p>"""
    advisory_ids: NotRequired[
        "aws_sdk_ssm.types.patch_advisory_id_list.PatchAdvisoryIdList"
    ]
    ...
    bugzilla_ids: NotRequired[
        "aws_sdk_ssm.types.patch_bugzilla_id_list.PatchBugzillaIdList"
    ]
    """<p>The Bugzilla ID of the patch. For example, <code>1600646</code>. Applies to Linux-based managed nodes only.</p>"""
    cve_ids: NotRequired["aws_sdk_ssm.types.patch_cve_id_list.PatchCVEIdList"]
    ...
    name: NotRequired["aws_sdk_ssm.types.patch_name.PatchName"]
    """<p>The name of the patch. Applies to Linux-based managed nodes only.</p>"""
    epoch: "aws_sdk_ssm.types.patch_epoch.PatchEpoch"
    ...
    version: NotRequired["aws_sdk_ssm.types.patch_version.PatchVersion"]
    ...
    release: NotRequired["aws_sdk_ssm.types.patch_release.PatchRelease"]
    ...
    arch: NotRequired["aws_sdk_ssm.types.patch_arch.PatchArch"]
    ...
    severity: NotRequired["aws_sdk_ssm.types.patch_severity.PatchSeverity"]
    """<p>The severity level of the patch. For example, <code>CRITICAL</code> or <code>MODERATE</code>.</p>"""
    repository: NotRequired["aws_sdk_ssm.types.patch_repository.PatchRepository"]
...
def serialize_aws_json_1_1(value: Patch) -> dict:
    ...
    if "release_date" in value:
        ...
        out["ReleaseDate"] = aws_sdk_ssm.types.date_time.serialize_aws_json_1_1(
            value["release_date"]
        )
    if "title" in value:
    ...
    if "advisory_ids" in value:
        ...
        out["AdvisoryIds"] = (
            aws_sdk_ssm.types.patch_advisory_id_list.serialize_aws_json_1_1(
                value["advisory_ids"]
            )
        )
    if "bugzilla_ids" in value:
        ...
        out["BugzillaIds"] = (
            aws_sdk_ssm.types.patch_bugzilla_id_list.serialize_aws_json_1_1(
                value["bugzilla_ids"]
            )
        )
    if "cve_ids" in value:
        ...
        out["CVEIds"] = aws_sdk_ssm.types.patch_cve_id_list.serialize_aws_json_1_1(
            value["cve_ids"]
        )
    if "name" in value:
        out["Name"] = value["name"]
...
def deserialize_aws_json_1_1(data: dict) -> Patch:
    ...
    if "ReleaseDate" in data:
        ...
        out["release_date"] = aws_sdk_ssm.types.date_time.deserialize_aws_json_1_1(
            data["ReleaseDate"]
        )
    if "Title" in data:
    ...
    if "AdvisoryIds" in data:
        ...
        out["advisory_ids"] = (
            aws_sdk_ssm.types.patch_advisory_id_list.deserialize_aws_json_1_1(
                data["AdvisoryIds"]
            )
        )
    if "BugzillaIds" in data:
        ...
        out["bugzilla_ids"] = (
            aws_sdk_ssm.types.patch_bugzilla_id_list.deserialize_aws_json_1_1(
                data["BugzillaIds"]
            )
        )
    if "CVEIds" in data:
        ...
        out["cve_ids"] = aws_sdk_ssm.types.patch_cve_id_list.deserialize_aws_json_1_1(
            data["CVEIds"]
        )
    if "Name" in data:
        out["name"] = data["Name"]
