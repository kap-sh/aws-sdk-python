...
OpsItemRelatedItemSummaries: TypeAlias = list[
    "aws_sdk_ssm.types.ops_item_related_item_summary.OpsItemRelatedItemSummary"
]
...
def serialize_aws_json_1_1(value: OpsItemRelatedItemSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_ssm.types.ops_item_related_item_summary.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> OpsItemRelatedItemSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_ssm.types.ops_item_related_item_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
