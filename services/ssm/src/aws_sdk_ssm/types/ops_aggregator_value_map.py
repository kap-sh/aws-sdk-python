...
if TYPE_CHECKING:
    import aws_sdk_ssm.types.ops_aggregator_value
    import aws_sdk_ssm.types.ops_aggregator_value_key

OpsAggregatorValueMap: TypeAlias = dict[
    "aws_sdk_ssm.types.ops_aggregator_value_key.OpsAggregatorValueKey",
    "aws_sdk_ssm.types.ops_aggregator_value.OpsAggregatorValue",
]
