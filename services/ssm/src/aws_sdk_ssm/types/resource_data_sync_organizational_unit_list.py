...
if TYPE_CHECKING:
    import aws_sdk_ssm.types.resource_data_sync_organizational_unit

ResourceDataSyncOrganizationalUnitList: TypeAlias = list[
    "aws_sdk_ssm.types.resource_data_sync_organizational_unit.ResourceDataSyncOrganizationalUnit"
]
...
def serialize_aws_json_1_1(value: ResourceDataSyncOrganizationalUnitList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_ssm.types.resource_data_sync_organizational_unit.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ResourceDataSyncOrganizationalUnitList:
    ...
    for item in data:
        out.append(
            aws_sdk_ssm.types.resource_data_sync_organizational_unit.deserialize_aws_json_1_1(
                item
            )
        )
    return out
