...
if TYPE_CHECKING:
    import aws_sdk_ssm.types.patch_filter_key
...
def serialize_aws_json_1_1(value: PatchFilter) -> dict:
    ...
    out["Key"] = aws_sdk_ssm.types.patch_filter_key.serialize_aws_json_1_1(value["key"])
    import aws_sdk_ssm.types.patch_filter_value_list

    out["Values"] = aws_sdk_ssm.types.patch_filter_value_list.serialize_aws_json_1_1(
        value["values"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> PatchFilter:
    ...
    if "Key" in data:
        ...
        out["key"] = aws_sdk_ssm.types.patch_filter_key.deserialize_aws_json_1_1(
            data["Key"]
        )
    else:
    ...
    if "Values" in data:
        ...
        out["values"] = (
            aws_sdk_ssm.types.patch_filter_value_list.deserialize_aws_json_1_1(
                data["Values"]
            )
        )
    else:
