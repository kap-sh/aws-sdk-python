...
ComplianceSummaryItemList: TypeAlias = list[
    "aws_sdk_ssm.types.compliance_summary_item.ComplianceSummaryItem"
]
...
def serialize_aws_json_1_1(value: ComplianceSummaryItemList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_ssm.types.compliance_summary_item.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ComplianceSummaryItemList:
    ...
    for item in data:
        out.append(
            aws_sdk_ssm.types.compliance_summary_item.deserialize_aws_json_1_1(item)
        )
    return out
