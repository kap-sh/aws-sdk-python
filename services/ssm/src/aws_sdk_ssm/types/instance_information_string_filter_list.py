...
if TYPE_CHECKING:
    import aws_sdk_ssm.types.instance_information_string_filter

InstanceInformationStringFilterList: TypeAlias = list[
    "aws_sdk_ssm.types.instance_information_string_filter.InstanceInformationStringFilter"
]
...
def serialize_aws_json_1_1(value: InstanceInformationStringFilterList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_ssm.types.instance_information_string_filter.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> InstanceInformationStringFilterList:
    ...
    for item in data:
        out.append(
            aws_sdk_ssm.types.instance_information_string_filter.deserialize_aws_json_1_1(
                item
            )
        )
    return out
