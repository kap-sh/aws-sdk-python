...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm.types.architecture
    import aws_sdk_ssm.types.computer_name
    import aws_sdk_ssm.types.date_time
    import aws_sdk_ssm.types.iam_role
    import aws_sdk_ssm.types.instance_aggregated_association_overview
    import aws_sdk_ssm.types.instance_id
    import aws_sdk_ssm.types.instance_name
    import aws_sdk_ssm.types.instance_role
    import aws_sdk_ssm.types.instance_state
    import aws_sdk_ssm.types.instance_type
    import aws_sdk_ssm.types.ip_address
    import aws_sdk_ssm.types.key_name
    import aws_sdk_ssm.types.ping_status
    import aws_sdk_ssm.types.platform_name
    import aws_sdk_ssm.types.platform_type
    import aws_sdk_ssm.types.platform_version
    import aws_sdk_ssm.types.source_id
    import aws_sdk_ssm.types.source_type
...
class InstanceProperty(TypedDict, closed=True):
    ...
    instance_type: NotRequired["aws_sdk_ssm.types.instance_type.InstanceType"]
    """<p>The instance type of the managed node. For example, t3.large.</p>"""
    instance_role: NotRequired["aws_sdk_ssm.types.instance_role.InstanceRole"]
    """<p>The instance profile attached to the node. If an instance profile isn't attached to the node, this value is blank.</p>"""
    key_name: NotRequired["aws_sdk_ssm.types.key_name.KeyName"]
    """<p>The name of the key pair associated with the node. If a key pair isnt't associated with the node, this value is blank.</p>"""
    instance_state: NotRequired["aws_sdk_ssm.types.instance_state.InstanceState"]
    """<p>The current state of the node.</p>"""
    architecture: NotRequired["aws_sdk_ssm.types.architecture.Architecture"]
    ...
    launch_time: NotRequired["aws_sdk_ssm.types.date_time.DateTime"]
    ...
    last_ping_date_time: NotRequired["aws_sdk_ssm.types.date_time.DateTime"]
    """<p>The date and time when the SSM Agent last pinged the Systems Manager service.</p>"""
    agent_version: NotRequired["aws_sdk_ssm.types.version.Version"]
    ...
    registration_date: NotRequired["aws_sdk_ssm.types.date_time.DateTime"]
    ...
    association_status: NotRequired["aws_sdk_ssm.types.status_name.StatusName"]
    """<p>The status of the State Manager association applied to the managed node.</p>"""
    last_association_execution_date: NotRequired["aws_sdk_ssm.types.date_time.DateTime"]
    """<p>The date the association was last run.</p>"""
    last_successful_association_execution_date: NotRequired[
        "aws_sdk_ssm.types.date_time.DateTime"
    ]
    """<p>The last date the association was successfully run.</p>"""
    association_overview: NotRequired[
        "aws_sdk_ssm.types.instance_aggregated_association_overview.InstanceAggregatedAssociationOverview"
    ]
    source_id: NotRequired["aws_sdk_ssm.types.source_id.SourceId"]
    """<p>The ID of the source resource.</p>"""
    source_type: NotRequired["aws_sdk_ssm.types.source_type.SourceType"]
...
def serialize_aws_json_1_1(value: InstanceProperty) -> dict:
    ...
    if "launch_time" in value:
        ...
        out["LaunchTime"] = aws_sdk_ssm.types.date_time.serialize_aws_json_1_1(
            value["launch_time"]
        )
    if "ping_status" in value:
        import aws_sdk_ssm.types.ping_status

        out["PingStatus"] = aws_sdk_ssm.types.ping_status.serialize_aws_json_1_1(
            value["ping_status"]
        )
    if "last_ping_date_time" in value:
        import aws_sdk_ssm.types.date_time

        out["LastPingDateTime"] = aws_sdk_ssm.types.date_time.serialize_aws_json_1_1(
    ...
    if "registration_date" in value:
        ...
        out["RegistrationDate"] = aws_sdk_ssm.types.date_time.serialize_aws_json_1_1(
    ...
    if "last_association_execution_date" in value:
        ...
        out["LastAssociationExecutionDate"] = (
            aws_sdk_ssm.types.date_time.serialize_aws_json_1_1(
    ...
    if "association_overview" in value:
        ...
        out["AssociationOverview"] = (
            aws_sdk_ssm.types.instance_aggregated_association_overview.serialize_aws_json_1_1(
    ...
    if "source_type" in value:
        ...
        out["SourceType"] = aws_sdk_ssm.types.source_type.serialize_aws_json_1_1(
            value["source_type"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> InstanceProperty:
    ...
    if "LaunchTime" in data:
        ...
        out["launch_time"] = aws_sdk_ssm.types.date_time.deserialize_aws_json_1_1(
            data["LaunchTime"]
        )
    if "PingStatus" in data:
        import aws_sdk_ssm.types.ping_status

        out["ping_status"] = aws_sdk_ssm.types.ping_status.deserialize_aws_json_1_1(
            data["PingStatus"]
        )
    if "LastPingDateTime" in data:
        import aws_sdk_ssm.types.date_time

        out["last_ping_date_time"] = (
    ...
    if "RegistrationDate" in data:
        ...
        out["registration_date"] = aws_sdk_ssm.types.date_time.deserialize_aws_json_1_1(
    ...
    if "AssociationOverview" in data:
        ...
        out["association_overview"] = (
            aws_sdk_ssm.types.instance_aggregated_association_overview.deserialize_aws_json_1_1(
    ...
    if "SourceType" in data:
        ...
        out["source_type"] = aws_sdk_ssm.types.source_type.deserialize_aws_json_1_1(
            data["SourceType"]
        )
    return out
