...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm.types.response_code
    import aws_sdk_ssm.types.standard_error_content
    import aws_sdk_ssm.types.standard_output_content
    import aws_sdk_ssm.types.status_details
    import aws_sdk_ssm.types.string_date_time
...
class GetCommandInvocationResult(TypedDict):
    ...
    response_code: "aws_sdk_ssm.types.response_code.ResponseCode"
    ...
    execution_start_date_time: NotRequired[
        "aws_sdk_ssm.types.string_date_time.StringDateTime"
    ]
    ...
    standard_output_content: NotRequired[
        "aws_sdk_ssm.types.standard_output_content.StandardOutputContent"
    ]
    ...
    standard_error_content: NotRequired[
        "aws_sdk_ssm.types.standard_error_content.StandardErrorContent"
    ]
