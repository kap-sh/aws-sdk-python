...
AssociationExecutionsList: TypeAlias = list[
    "aws_sdk_ssm.types.association_execution.AssociationExecution"
]
...
def serialize_aws_json_1_1(value: AssociationExecutionsList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_ssm.types.association_execution.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> AssociationExecutionsList:
    ...
    for item in data:
        out.append(
            aws_sdk_ssm.types.association_execution.deserialize_aws_json_1_1(item)
        )
    return out
