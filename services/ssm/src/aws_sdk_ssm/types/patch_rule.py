...
if TYPE_CHECKING:
    import aws_sdk_ssm.types.approve_after_days
    ...
    import aws_sdk_ssm.types.patch_string_date_time


class PatchRule(TypedDict):
    patch_filter_group: "aws_sdk_ssm.types.patch_filter_group.PatchFilterGroup"
