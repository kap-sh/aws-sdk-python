...
if TYPE_CHECKING:
    import aws_sdk_ssm.types.parameter_string_filter_key
    import aws_sdk_ssm.types.parameter_string_filter_value_list
...
class ParameterStringFilter(TypedDict):
    ...
    values: NotRequired[
        "aws_sdk_ssm.types.parameter_string_filter_value_list.ParameterStringFilterValueList"
    ]
...
def serialize_aws_json_1_1(value: ParameterStringFilter) -> dict:
    ...
    if "values" in value:
        ...
        out["Values"] = (
            aws_sdk_ssm.types.parameter_string_filter_value_list.serialize_aws_json_1_1(
                value["values"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ParameterStringFilter:
    ...
    if "Values" in data:
        ...
        out["values"] = (
            aws_sdk_ssm.types.parameter_string_filter_value_list.deserialize_aws_json_1_1(
                data["Values"]
            )
        )
    return out
