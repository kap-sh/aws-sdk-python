...
if TYPE_CHECKING:
    ...
    import aws_sdk_ssm.types.command_status
    import aws_sdk_ssm.types.comment
    import aws_sdk_ssm.types.completed_count
    import aws_sdk_ssm.types.date_time
    import aws_sdk_ssm.types.delivery_timed_out_count
    import aws_sdk_ssm.types.document_name
    import aws_sdk_ssm.types.document_version
    import aws_sdk_ssm.types.error_count
    ...
    import aws_sdk_ssm.types.target_count
...
class Command(TypedDict):
    ...
    expires_after: NotRequired["aws_sdk_ssm.types.date_time.DateTime"]
    ...
    status: NotRequired["aws_sdk_ssm.types.command_status.CommandStatus"]
    ...
    target_count: "aws_sdk_ssm.types.target_count.TargetCount"
    """<p>The number of targets for the command.</p>"""
    completed_count: "aws_sdk_ssm.types.completed_count.CompletedCount"
    ...
    error_count: "aws_sdk_ssm.types.error_count.ErrorCount"
    """<p>The number of targets for which the status is Failed or Execution Timed Out.</p>"""
    delivery_timed_out_count: (
        "aws_sdk_ssm.types.delivery_timed_out_count.DeliveryTimedOutCount"
    )
...
def serialize_aws_json_1_1(value: Command) -> dict:
    ...
    if "expires_after" in value:
        ...
        out["ExpiresAfter"] = aws_sdk_ssm.types.date_time.serialize_aws_json_1_1(
            value["expires_after"]
        )
    ...
    if "status" in value:
        ...
        out["Status"] = aws_sdk_ssm.types.command_status.serialize_aws_json_1_1(
            value["status"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> Command:
    ...
    if "ExpiresAfter" in data:
        ...
        out["expires_after"] = aws_sdk_ssm.types.date_time.deserialize_aws_json_1_1(
            data["ExpiresAfter"]
        )
    ...
    if "Status" in data:
        ...
        out["status"] = aws_sdk_ssm.types.command_status.deserialize_aws_json_1_1(
            data["Status"]
        )
