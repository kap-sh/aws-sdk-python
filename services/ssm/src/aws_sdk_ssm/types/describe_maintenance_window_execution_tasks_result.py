...
def serialize_aws_json_1_1(
    ...
    if "window_execution_task_identities" in value:
        ...
        out["WindowExecutionTaskIdentities"] = (
            aws_sdk_ssm.types.maintenance_window_execution_task_identity_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "WindowExecutionTaskIdentities" in data:
        ...
        out["window_execution_task_identities"] = (
            aws_sdk_ssm.types.maintenance_window_execution_task_identity_list.deserialize_aws_json_1_1(
