...
ResourceComplianceSummaryItemList: TypeAlias = list[
    "aws_sdk_ssm.types.resource_compliance_summary_item.ResourceComplianceSummaryItem"
]
...
def serialize_aws_json_1_1(value: ResourceComplianceSummaryItemList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_ssm.types.resource_compliance_summary_item.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ResourceComplianceSummaryItemList:
    ...
    for item in data:
        out.append(
            aws_sdk_ssm.types.resource_compliance_summary_item.deserialize_aws_json_1_1(
                item
            )
        )
    return out
