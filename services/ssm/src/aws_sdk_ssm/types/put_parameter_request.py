...
class PutParameterRequest(TypedDict):
    ...
    overwrite: NotRequired["aws_sdk_ssm.types.boolean.Boolean"]
    ...
    policies: NotRequired["aws_sdk_ssm.types.parameter_policies.ParameterPolicies"]
