...
class InvalidInventoryItemContextException_(TypedDict):
...
class InvalidInventoryItemContextException(ServiceError):
    ...
    def __init__(self, data: InvalidInventoryItemContextException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "InvalidInventoryItemContextException":
