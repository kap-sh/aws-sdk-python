...
class InvalidAllowedPatternException_(TypedDict):
...
class InvalidAllowedPatternException(ServiceError):
    ...
    def __init__(self, data: InvalidAllowedPatternException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "InvalidAllowedPatternException":
