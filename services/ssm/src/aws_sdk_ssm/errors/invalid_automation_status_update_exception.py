...
class InvalidAutomationStatusUpdateException_(TypedDict):
...
class InvalidAutomationStatusUpdateException(ServiceError):
    ...
    def __init__(self, data: InvalidAutomationStatusUpdateException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "InvalidAutomationStatusUpdateException":
