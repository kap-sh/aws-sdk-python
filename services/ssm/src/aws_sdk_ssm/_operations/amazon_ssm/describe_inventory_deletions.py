"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeInventoryDeletions``."""
...
import aws_sdk_ssm.errors.invalid_deletion_id_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDeletionIdException":
            raise aws_sdk_ssm.errors.invalid_deletion_id_exception.InvalidDeletionIdException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_inventory_deletions_result.DescribeInventoryDeletionsResult = aws_sdk_ssm.types.describe_inventory_deletions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_inventory_deletions_request.DescribeInventoryDeletionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_inventory_deletions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_inventory_deletions(
