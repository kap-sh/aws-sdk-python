...
def handle_response(
    ...
    out: aws_sdk_ssm.types.start_execution_preview_response.StartExecutionPreviewResponse = aws_sdk_ssm.types.start_execution_preview_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.start_execution_preview_request.StartExecutionPreviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.start_execution_preview_request.serialize_aws_json_1_1(input_)
    ).encode()
