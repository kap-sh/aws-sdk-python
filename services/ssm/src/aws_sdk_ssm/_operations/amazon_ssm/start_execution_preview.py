...
def build_request(
    ...
    input: aws_sdk_ssm.types.start_execution_preview_request.StartExecutionPreviewRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.start_execution_preview_request.serialize_aws_json_1_1(input)
    ).encode()
