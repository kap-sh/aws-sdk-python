...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_documents_result.ListDocumentsResult = (
        aws_sdk_ssm.types.list_documents_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_documents_request.ListDocumentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_documents_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_documents(
    ...
    aws_sdk_ssm.types.list_documents_result.ListDocumentsResult, zapros.Response
]:
