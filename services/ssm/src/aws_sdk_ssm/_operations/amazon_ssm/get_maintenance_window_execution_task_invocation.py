"""Generated from Smithy shape ``com.amazonaws.ssm#GetMaintenanceWindowExecutionTaskInvocation``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_maintenance_window_execution_task_invocation_result.GetMaintenanceWindowExecutionTaskInvocationResult = aws_sdk_ssm.types.get_maintenance_window_execution_task_invocation_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_maintenance_window_execution_task_invocation_request.GetMaintenanceWindowExecutionTaskInvocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.GetMaintenanceWindowExecutionTaskInvocation"
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_maintenance_window_execution_task_invocation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_maintenance_window_execution_task_invocation(
