"""Generated from Smithy shape ``com.amazonaws.ssm#GetServiceSetting``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_service_setting_result.GetServiceSettingResult = (
        aws_sdk_ssm.types.get_service_setting_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_service_setting_request.GetServiceSettingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_service_setting_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_service_setting(
