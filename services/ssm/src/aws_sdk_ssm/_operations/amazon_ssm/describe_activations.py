"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeActivations``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_activations_result.DescribeActivationsResult = (
        aws_sdk_ssm.types.describe_activations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_activations_request.DescribeActivationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_activations_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_activations(
