"""Generated from Smithy shape ``com.amazonaws.ssm#AssociateOpsItemRelatedItem``."""
...
import aws_sdk_ssm.errors.ops_item_conflict_exception
...
import aws_sdk_ssm.errors.ops_item_not_found_exception
import aws_sdk_ssm.errors.ops_item_related_item_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OpsItemConflictException":
            raise aws_sdk_ssm.errors.ops_item_conflict_exception.OpsItemConflictException.from_aws_json_1_1(
                data
            )
        ...
        case "OpsItemNotFoundException":
            raise aws_sdk_ssm.errors.ops_item_not_found_exception.OpsItemNotFoundException.from_aws_json_1_1(
                data
            )
        case "OpsItemRelatedItemAlreadyExistsException":
            raise aws_sdk_ssm.errors.ops_item_related_item_already_exists_exception.OpsItemRelatedItemAlreadyExistsException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.associate_ops_item_related_item_response.AssociateOpsItemRelatedItemResponse = aws_sdk_ssm.types.associate_ops_item_related_item_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.associate_ops_item_related_item_request.AssociateOpsItemRelatedItemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.AssociateOpsItemRelatedItem"
    import aws_sdk_ssm.types.associate_ops_item_related_item_request

    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.associate_ops_item_related_item_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_ops_item_related_item(
