...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnsupportedFeatureRequiredException":
            import aws_sdk_ssm.errors.unsupported_feature_required_exception

            raise aws_sdk_ssm.errors.unsupported_feature_required_exception.UnsupportedFeatureRequiredException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_deployable_patch_snapshot_for_instance_result.GetDeployablePatchSnapshotForInstanceResult = aws_sdk_ssm.types.get_deployable_patch_snapshot_for_instance_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_deployable_patch_snapshot_for_instance_request.GetDeployablePatchSnapshotForInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
