"""Generated from Smithy shape ``com.amazonaws.ssm#CancelCommand``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.cancel_command_result.CancelCommandResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.cancel_command_request.CancelCommandRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.cancel_command_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def cancel_command(
    ...
    aws_sdk_ssm.types.cancel_command_result.CancelCommandResult, zapros.Response
]:
