...
import aws_sdk_ssm.types.attachment_content_list
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_document_result.GetDocumentResult = (
        aws_sdk_ssm.types.get_document_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_document_request.GetDocumentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_document_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_document(
    ...
    input_: aws_sdk_ssm.types.get_document_request.GetDocumentRequest,
) -> tuple[aws_sdk_ssm.types.get_document_result.GetDocumentResult, zapros.Response]:
