...
def handle_response(
    ...
    out: aws_sdk_ssm.types.update_document_default_version_result.UpdateDocumentDefaultVersionResult = aws_sdk_ssm.types.update_document_default_version_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.update_document_default_version_request.UpdateDocumentDefaultVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.update_document_default_version_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
