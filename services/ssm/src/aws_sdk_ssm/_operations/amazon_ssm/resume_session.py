...
def handle_response(
    ...
    out: aws_sdk_ssm.types.resume_session_response.ResumeSessionResponse = (
        aws_sdk_ssm.types.resume_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.resume_session_request.ResumeSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.resume_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def resume_session(
    ...
    aws_sdk_ssm.types.resume_session_response.ResumeSessionResponse, zapros.Response
]:
