"""Generated from Smithy shape ``com.amazonaws.ssm#DeleteDocument``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AssociatedInstances":
            import aws_sdk_ssm.errors.associated_instances

            raise aws_sdk_ssm.errors.associated_instances.AssociatedInstances.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.delete_document_result.DeleteDocumentResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.delete_document_request.DeleteDocumentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.delete_document_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_document(
    ...
    aws_sdk_ssm.types.delete_document_result.DeleteDocumentResult, zapros.Response
]:
