"""Generated from Smithy shape ``com.amazonaws.ssm#GetMaintenanceWindow``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_maintenance_window_result.GetMaintenanceWindowResult = (
        aws_sdk_ssm.types.get_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_maintenance_window_request.GetMaintenanceWindowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_maintenance_window_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_maintenance_window(
