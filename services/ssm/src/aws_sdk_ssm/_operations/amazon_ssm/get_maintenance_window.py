...
def build_request(
    ...
    input: aws_sdk_ssm.types.get_maintenance_window_request.GetMaintenanceWindowRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_maintenance_window_request.serialize_aws_json_1_1(input)
    ).encode()
