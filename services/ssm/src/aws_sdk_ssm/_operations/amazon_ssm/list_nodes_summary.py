...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidAggregatorException":
            import aws_sdk_ssm.errors.invalid_aggregator_exception

            raise aws_sdk_ssm.errors.invalid_aggregator_exception.InvalidAggregatorException.from_aws_json_1_1(
                data
            )
        case "InvalidFilter":
            import aws_sdk_ssm.errors.invalid_filter

            raise aws_sdk_ssm.errors.invalid_filter.InvalidFilter.from_aws_json_1_1(
                data
            )
        ...
        case "ResourceDataSyncNotFoundException":
            import aws_sdk_ssm.errors.resource_data_sync_not_found_exception

            raise aws_sdk_ssm.errors.resource_data_sync_not_found_exception.ResourceDataSyncNotFoundException.from_aws_json_1_1(
                data
            )
        case "UnsupportedOperationException":
            import aws_sdk_ssm.errors.unsupported_operation_exception

            raise aws_sdk_ssm.errors.unsupported_operation_exception.UnsupportedOperationException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_nodes_summary_result.ListNodesSummaryResult = (
        aws_sdk_ssm.types.list_nodes_summary_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_nodes_summary_request.ListNodesSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_nodes_summary_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_nodes_summary(
    ...
    aws_sdk_ssm.types.list_nodes_summary_result.ListNodesSummaryResult, zapros.Response
]:
