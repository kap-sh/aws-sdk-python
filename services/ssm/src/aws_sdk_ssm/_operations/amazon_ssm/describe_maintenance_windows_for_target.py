"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeMaintenanceWindowsForTarget``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_maintenance_windows_for_target_result.DescribeMaintenanceWindowsForTargetResult = aws_sdk_ssm.types.describe_maintenance_windows_for_target_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_maintenance_windows_for_target_request.DescribeMaintenanceWindowsForTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_maintenance_windows_for_target_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_maintenance_windows_for_target(
