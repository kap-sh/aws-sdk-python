...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_maintenance_window_targets_result.DescribeMaintenanceWindowTargetsResult = aws_sdk_ssm.types.describe_maintenance_window_targets_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_maintenance_window_targets_request.DescribeMaintenanceWindowTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_maintenance_window_targets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
