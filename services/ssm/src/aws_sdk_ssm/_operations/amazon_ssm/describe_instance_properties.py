"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeInstanceProperties``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidActivationId":
            import aws_sdk_ssm.errors.invalid_activation_id

            raise aws_sdk_ssm.errors.invalid_activation_id.InvalidActivationId.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidInstancePropertyFilterValue":
            import aws_sdk_ssm.errors.invalid_instance_property_filter_value

            raise aws_sdk_ssm.errors.invalid_instance_property_filter_value.InvalidInstancePropertyFilterValue.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_instance_properties_result.DescribeInstancePropertiesResult = aws_sdk_ssm.types.describe_instance_properties_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_instance_properties_request.DescribeInstancePropertiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_instance_properties_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_instance_properties(
