...
def build_request(
    ...
    input: aws_sdk_ssm.types.get_command_invocation_request.GetCommandInvocationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_command_invocation_request.serialize_aws_json_1_1(input)
    ).encode()
