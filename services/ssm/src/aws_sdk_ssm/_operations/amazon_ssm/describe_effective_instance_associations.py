"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeEffectiveInstanceAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_effective_instance_associations_result.DescribeEffectiveInstanceAssociationsResult = aws_sdk_ssm.types.describe_effective_instance_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_effective_instance_associations_request.DescribeEffectiveInstanceAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_effective_instance_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_effective_instance_associations(
