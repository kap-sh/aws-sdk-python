...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_automation_execution_request.GetAutomationExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_automation_execution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
