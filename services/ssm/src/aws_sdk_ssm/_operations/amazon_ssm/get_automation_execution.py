"""Generated from Smithy shape ``com.amazonaws.ssm#GetAutomationExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_automation_execution_result.GetAutomationExecutionResult = aws_sdk_ssm.types.get_automation_execution_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_ssm.types.get_automation_execution_request.GetAutomationExecutionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_automation_execution_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_get_automation_execution(
