"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeMaintenanceWindowExecutionTaskInvocations``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_maintenance_window_execution_task_invocations_result.DescribeMaintenanceWindowExecutionTaskInvocationsResult = aws_sdk_ssm.types.describe_maintenance_window_execution_task_invocations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_maintenance_window_execution_task_invocations_request.DescribeMaintenanceWindowExecutionTaskInvocationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_maintenance_window_execution_task_invocations(
