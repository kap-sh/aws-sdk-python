...
def build_request(
    ...
    input: aws_sdk_ssm.types.delete_patch_baseline_request.DeletePatchBaselineRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.delete_patch_baseline_request.serialize_aws_json_1_1(input)
    ).encode()
