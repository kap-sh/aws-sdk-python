...
import aws_sdk_ssm.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise aws_sdk_ssm.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.delete_patch_baseline_result.DeletePatchBaselineResult = (
        aws_sdk_ssm.types.delete_patch_baseline_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.delete_patch_baseline_request.DeletePatchBaselineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.delete_patch_baseline_request.serialize_aws_json_1_1(input_)
    ).encode()
