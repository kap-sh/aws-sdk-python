...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_resource_compliance_summaries_result.ListResourceComplianceSummariesResult = aws_sdk_ssm.types.list_resource_compliance_summaries_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_resource_compliance_summaries_request.ListResourceComplianceSummariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_resource_compliance_summaries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
