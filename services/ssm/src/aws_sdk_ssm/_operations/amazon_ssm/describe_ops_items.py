"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeOpsItems``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_ops_items_response.DescribeOpsItemsResponse = (
        aws_sdk_ssm.types.describe_ops_items_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_ops_items_request.DescribeOpsItemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_ops_items_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_ops_items(
