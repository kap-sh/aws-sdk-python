...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDeleteInventoryParametersException":
            import aws_sdk_ssm.errors.invalid_delete_inventory_parameters_exception

            raise aws_sdk_ssm.errors.invalid_delete_inventory_parameters_exception.InvalidDeleteInventoryParametersException.from_aws_json_1_1(
                data
            )
        case "InvalidInventoryRequestException":
            import aws_sdk_ssm.errors.invalid_inventory_request_exception

            raise aws_sdk_ssm.errors.invalid_inventory_request_exception.InvalidInventoryRequestException.from_aws_json_1_1(
                data
            )
        case "InvalidOptionException":
            import aws_sdk_ssm.errors.invalid_option_exception

            raise aws_sdk_ssm.errors.invalid_option_exception.InvalidOptionException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.delete_inventory_result.DeleteInventoryResult = (
        aws_sdk_ssm.types.delete_inventory_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.delete_inventory_request.DeleteInventoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.delete_inventory_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_inventory(
    ...
    aws_sdk_ssm.types.delete_inventory_result.DeleteInventoryResult, zapros.Response
]:
