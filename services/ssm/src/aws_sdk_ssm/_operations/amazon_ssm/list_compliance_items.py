...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_compliance_items_result.ListComplianceItemsResult = (
        aws_sdk_ssm.types.list_compliance_items_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_compliance_items_request.ListComplianceItemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_compliance_items_request.serialize_aws_json_1_1(input_)
    ).encode()
