...
def build_request(
    ...
    input_: aws_sdk_ssm.types.create_patch_baseline_request.CreatePatchBaselineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.create_patch_baseline_request.serialize_aws_json_1_1(input_)
    ).encode()
