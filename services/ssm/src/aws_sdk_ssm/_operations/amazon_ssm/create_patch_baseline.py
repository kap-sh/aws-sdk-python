...
def build_request(
    ...
    input: aws_sdk_ssm.types.create_patch_baseline_request.CreatePatchBaselineRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.create_patch_baseline_request.serialize_aws_json_1_1(input)
    ).encode()
