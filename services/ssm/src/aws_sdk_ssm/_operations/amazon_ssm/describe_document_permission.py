"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeDocumentPermission``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_document_permission_response.DescribeDocumentPermissionResponse = aws_sdk_ssm.types.describe_document_permission_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_document_permission_request.DescribeDocumentPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_document_permission_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_document_permission(
