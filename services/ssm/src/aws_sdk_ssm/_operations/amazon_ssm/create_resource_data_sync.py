"""Generated from Smithy shape ``com.amazonaws.ssm#CreateResourceDataSync``."""
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.create_resource_data_sync_request.CreateResourceDataSyncRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.create_resource_data_sync_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_resource_data_sync(
