"""Generated from Smithy shape ``com.amazonaws.ssm#GetConnectionStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_connection_status_response.GetConnectionStatusResponse = aws_sdk_ssm.types.get_connection_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_connection_status_request.GetConnectionStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_connection_status_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_connection_status(
