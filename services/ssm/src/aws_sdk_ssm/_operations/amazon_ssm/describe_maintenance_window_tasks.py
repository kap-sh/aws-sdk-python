"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeMaintenanceWindowTasks``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_maintenance_window_tasks_result.DescribeMaintenanceWindowTasksResult = aws_sdk_ssm.types.describe_maintenance_window_tasks_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_maintenance_window_tasks_request.DescribeMaintenanceWindowTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_maintenance_window_tasks_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_maintenance_window_tasks(
