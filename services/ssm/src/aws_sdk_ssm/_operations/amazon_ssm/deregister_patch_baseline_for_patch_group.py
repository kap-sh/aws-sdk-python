...
def handle_response(
    ...
    out: aws_sdk_ssm.types.deregister_patch_baseline_for_patch_group_result.DeregisterPatchBaselineForPatchGroupResult = aws_sdk_ssm.types.deregister_patch_baseline_for_patch_group_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.deregister_patch_baseline_for_patch_group_request.DeregisterPatchBaselineForPatchGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
