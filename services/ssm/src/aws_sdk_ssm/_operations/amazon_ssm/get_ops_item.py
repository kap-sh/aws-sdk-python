...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_ops_item_response.GetOpsItemResponse = (
        aws_sdk_ssm.types.get_ops_item_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_ops_item_request.GetOpsItemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_ops_item_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_ops_item(
    ...
    input_: aws_sdk_ssm.types.get_ops_item_request.GetOpsItemRequest,
) -> tuple[aws_sdk_ssm.types.get_ops_item_response.GetOpsItemResponse, zapros.Response]:
