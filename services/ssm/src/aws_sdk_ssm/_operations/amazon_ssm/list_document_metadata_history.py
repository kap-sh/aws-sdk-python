...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_document_metadata_history_response.ListDocumentMetadataHistoryResponse = aws_sdk_ssm.types.list_document_metadata_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_document_metadata_history_request.ListDocumentMetadataHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_document_metadata_history_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
