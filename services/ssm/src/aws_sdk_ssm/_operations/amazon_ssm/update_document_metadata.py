...
def handle_response(
    ...
    out: aws_sdk_ssm.types.update_document_metadata_response.UpdateDocumentMetadataResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_ssm.types.update_document_metadata_request.UpdateDocumentMetadataRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.update_document_metadata_request.serialize_aws_json_1_1(input)
    ).encode()
