...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_association_versions_result.ListAssociationVersionsResult = aws_sdk_ssm.types.list_association_versions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_association_versions_request.ListAssociationVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_association_versions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
