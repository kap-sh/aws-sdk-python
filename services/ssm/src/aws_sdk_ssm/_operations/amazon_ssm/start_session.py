"""Generated from Smithy shape ``com.amazonaws.ssm#StartSession``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TargetNotConnected":
            import aws_sdk_ssm.errors.target_not_connected

            raise aws_sdk_ssm.errors.target_not_connected.TargetNotConnected.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.start_session_response.StartSessionResponse = (
        aws_sdk_ssm.types.start_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.start_session_request.StartSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.start_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_session(
    ...
    aws_sdk_ssm.types.start_session_response.StartSessionResponse, zapros.Response
]:
