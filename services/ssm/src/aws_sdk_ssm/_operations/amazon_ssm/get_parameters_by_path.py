...
def build_request(
    ...
    input: aws_sdk_ssm.types.get_parameters_by_path_request.GetParametersByPathRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_parameters_by_path_request.serialize_aws_json_1_1(input)
    ).encode()
