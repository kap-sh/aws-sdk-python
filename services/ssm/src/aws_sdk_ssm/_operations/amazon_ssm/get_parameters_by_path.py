...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_parameters_by_path_request.GetParametersByPathRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_parameters_by_path_request.serialize_aws_json_1_1(input_)
    ).encode()
