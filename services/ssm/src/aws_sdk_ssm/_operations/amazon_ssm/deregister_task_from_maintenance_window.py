...
def handle_response(
    ...
    out: aws_sdk_ssm.types.deregister_task_from_maintenance_window_result.DeregisterTaskFromMaintenanceWindowResult = aws_sdk_ssm.types.deregister_task_from_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.deregister_task_from_maintenance_window_request.DeregisterTaskFromMaintenanceWindowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.deregister_task_from_maintenance_window_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
