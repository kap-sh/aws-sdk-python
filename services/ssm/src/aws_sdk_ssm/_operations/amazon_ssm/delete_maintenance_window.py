"""Generated from Smithy shape ``com.amazonaws.ssm#DeleteMaintenanceWindow``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.delete_maintenance_window_result.DeleteMaintenanceWindowResult = aws_sdk_ssm.types.delete_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.delete_maintenance_window_request.DeleteMaintenanceWindowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.delete_maintenance_window_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_maintenance_window(
