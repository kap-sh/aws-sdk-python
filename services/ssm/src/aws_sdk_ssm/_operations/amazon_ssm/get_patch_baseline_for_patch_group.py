...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_patch_baseline_for_patch_group_result.GetPatchBaselineForPatchGroupResult = aws_sdk_ssm.types.get_patch_baseline_for_patch_group_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_patch_baseline_for_patch_group_request.GetPatchBaselineForPatchGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_patch_baseline_for_patch_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
