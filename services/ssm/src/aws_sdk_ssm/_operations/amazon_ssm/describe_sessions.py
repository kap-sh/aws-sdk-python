"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeSessions``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_sessions_response.DescribeSessionsResponse = (
        aws_sdk_ssm.types.describe_sessions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_sessions_request.DescribeSessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_sessions_request.serialize_aws_json_1_1(input_)
    ).encode()
