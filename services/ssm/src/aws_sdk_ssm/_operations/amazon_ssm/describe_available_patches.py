...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_available_patches_result.DescribeAvailablePatchesResult = aws_sdk_ssm.types.describe_available_patches_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_available_patches_request.DescribeAvailablePatchesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_available_patches_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
