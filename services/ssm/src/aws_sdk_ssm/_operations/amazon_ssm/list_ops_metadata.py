"""Generated from Smithy shape ``com.amazonaws.ssm#ListOpsMetadata``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_ops_metadata_result.ListOpsMetadataResult = (
        aws_sdk_ssm.types.list_ops_metadata_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_ops_metadata_request.ListOpsMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.ListOpsMetadata"
    import aws_sdk_ssm.types.list_ops_metadata_request

    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_ops_metadata_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_ops_metadata(
    ...
    aws_sdk_ssm.types.list_ops_metadata_result.ListOpsMetadataResult, zapros.Response
]:
...
async def async_list_ops_metadata(
