...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_document_result.DescribeDocumentResult = (
        aws_sdk_ssm.types.describe_document_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_document_request.DescribeDocumentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_document_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_document(
    ...
    aws_sdk_ssm.types.describe_document_result.DescribeDocumentResult, zapros.Response
]:
