...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_command_invocations_result.ListCommandInvocationsResult = aws_sdk_ssm.types.list_command_invocations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_ssm.types.list_command_invocations_request.ListCommandInvocationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_command_invocations_request.serialize_aws_json_1_1(input)
    ).encode()
