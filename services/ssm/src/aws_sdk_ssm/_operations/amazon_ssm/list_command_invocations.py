...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_command_invocations_request.ListCommandInvocationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_command_invocations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
