...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_execution_preview_response.GetExecutionPreviewResponse = aws_sdk_ssm.types.get_execution_preview_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_execution_preview_request.GetExecutionPreviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_execution_preview_request.serialize_aws_json_1_1(input_)
    ).encode()
