...
def build_request(
    ...
    input: aws_sdk_ssm.types.get_execution_preview_request.GetExecutionPreviewRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_execution_preview_request.serialize_aws_json_1_1(input)
    ).encode()
