"""Generated from Smithy shape ``com.amazonaws.ssm#DeleteOpsItem``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.delete_ops_item_response.DeleteOpsItemResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.delete_ops_item_request.DeleteOpsItemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.DeleteOpsItem"
    import aws_sdk_ssm.types.delete_ops_item_request

    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.delete_ops_item_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_ops_item(
    ...
    aws_sdk_ssm.types.delete_ops_item_response.DeleteOpsItemResponse, zapros.Response
]:
...
async def async_delete_ops_item(
