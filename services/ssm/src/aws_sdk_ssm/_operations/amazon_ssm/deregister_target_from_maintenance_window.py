"""Generated from Smithy shape ``com.amazonaws.ssm#DeregisterTargetFromMaintenanceWindow``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TargetInUseException":
            import aws_sdk_ssm.errors.target_in_use_exception

            raise aws_sdk_ssm.errors.target_in_use_exception.TargetInUseException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.deregister_target_from_maintenance_window_result.DeregisterTargetFromMaintenanceWindowResult = aws_sdk_ssm.types.deregister_target_from_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.deregister_target_from_maintenance_window_request.DeregisterTargetFromMaintenanceWindowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.deregister_target_from_maintenance_window_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_deregister_target_from_maintenance_window(
