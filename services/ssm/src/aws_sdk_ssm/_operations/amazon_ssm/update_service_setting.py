...
def handle_response(
    ...
    out: aws_sdk_ssm.types.update_service_setting_result.UpdateServiceSettingResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.update_service_setting_request.UpdateServiceSettingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.update_service_setting_request.serialize_aws_json_1_1(input_)
    ).encode()
