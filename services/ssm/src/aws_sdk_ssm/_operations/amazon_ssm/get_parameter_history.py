...
def build_request(
    ...
    input: aws_sdk_ssm.types.get_parameter_history_request.GetParameterHistoryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_parameter_history_request.serialize_aws_json_1_1(input)
    ).encode()
