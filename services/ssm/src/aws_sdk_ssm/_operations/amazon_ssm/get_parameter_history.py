...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_parameter_history_result.GetParameterHistoryResult = (
        aws_sdk_ssm.types.get_parameter_history_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_parameter_history_request.GetParameterHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_parameter_history_request.serialize_aws_json_1_1(input_)
    ).encode()
