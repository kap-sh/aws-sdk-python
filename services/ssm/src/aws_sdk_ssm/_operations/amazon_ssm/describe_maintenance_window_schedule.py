"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeMaintenanceWindowSchedule``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_maintenance_window_schedule_result.DescribeMaintenanceWindowScheduleResult = aws_sdk_ssm.types.describe_maintenance_window_schedule_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_maintenance_window_schedule_request.DescribeMaintenanceWindowScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_maintenance_window_schedule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_maintenance_window_schedule(
