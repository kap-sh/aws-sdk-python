"""Generated from Smithy shape ``com.amazonaws.ssm#ModifyDocumentPermission``."""
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.modify_document_permission_request.ModifyDocumentPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.modify_document_permission_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_modify_document_permission(
