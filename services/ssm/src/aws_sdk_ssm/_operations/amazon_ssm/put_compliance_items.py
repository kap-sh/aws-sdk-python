...
def build_request(
    ...
    input_: aws_sdk_ssm.types.put_compliance_items_request.PutComplianceItemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.put_compliance_items_request.serialize_aws_json_1_1(input_)
    ).encode()
