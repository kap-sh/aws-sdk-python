...
def build_request(
    ...
    input: aws_sdk_ssm.types.put_compliance_items_request.PutComplianceItemsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.put_compliance_items_request.serialize_aws_json_1_1(input)
    ).encode()
