"""Generated from Smithy shape ``com.amazonaws.ssm#CreateDocument``."""
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.create_document_request.CreateDocumentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.create_document_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_document(
    ...
    aws_sdk_ssm.types.create_document_result.CreateDocumentResult, zapros.Response
]:
