"""Generated from Smithy shape ``com.amazonaws.ssm#TerminateSession``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.terminate_session_response.TerminateSessionResponse = (
        aws_sdk_ssm.types.terminate_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.terminate_session_request.TerminateSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.terminate_session_request.serialize_aws_json_1_1(input_)
    ).encode()
