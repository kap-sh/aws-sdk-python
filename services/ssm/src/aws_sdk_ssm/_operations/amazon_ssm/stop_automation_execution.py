...
import aws_sdk_ssm.errors.invalid_automation_status_update_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidAutomationStatusUpdateException":
            raise aws_sdk_ssm.errors.invalid_automation_status_update_exception.InvalidAutomationStatusUpdateException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.stop_automation_execution_result.StopAutomationExecutionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.stop_automation_execution_request.StopAutomationExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.stop_automation_execution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
