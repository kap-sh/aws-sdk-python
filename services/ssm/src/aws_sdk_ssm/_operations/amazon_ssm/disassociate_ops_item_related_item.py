"""Generated from Smithy shape ``com.amazonaws.ssm#DisassociateOpsItemRelatedItem``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OpsItemRelatedItemAssociationNotFoundException":
            import aws_sdk_ssm.errors.ops_item_related_item_association_not_found_exception

            raise aws_sdk_ssm.errors.ops_item_related_item_association_not_found_exception.OpsItemRelatedItemAssociationNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.disassociate_ops_item_related_item_response.DisassociateOpsItemRelatedItemResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.disassociate_ops_item_related_item_request.DisassociateOpsItemRelatedItemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.DisassociateOpsItemRelatedItem"
    import aws_sdk_ssm.types.disassociate_ops_item_related_item_request

    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.disassociate_ops_item_related_item_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_ops_item_related_item(
