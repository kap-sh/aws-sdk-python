"""Generated from Smithy shape ``com.amazonaws.ssm#UpdateResourceDataSync``."""
...
import aws_sdk_ssm.errors.resource_data_sync_conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceDataSyncConflictException":
            raise aws_sdk_ssm.errors.resource_data_sync_conflict_exception.ResourceDataSyncConflictException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.update_resource_data_sync_result.UpdateResourceDataSyncResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.update_resource_data_sync_request.UpdateResourceDataSyncRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.update_resource_data_sync_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_resource_data_sync(
