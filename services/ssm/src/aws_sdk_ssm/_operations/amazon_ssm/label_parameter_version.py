...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ParameterVersionLabelLimitExceeded":
            import aws_sdk_ssm.errors.parameter_version_label_limit_exceeded

            raise aws_sdk_ssm.errors.parameter_version_label_limit_exceeded.ParameterVersionLabelLimitExceeded.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.label_parameter_version_result.LabelParameterVersionResult = aws_sdk_ssm.types.label_parameter_version_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.label_parameter_version_request.LabelParameterVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.label_parameter_version_request.serialize_aws_json_1_1(input_)
    ).encode()
