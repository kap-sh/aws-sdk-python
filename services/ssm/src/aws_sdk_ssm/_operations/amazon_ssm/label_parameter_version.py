...
def build_request(
    ...
    input: aws_sdk_ssm.types.label_parameter_version_request.LabelParameterVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.label_parameter_version_request.serialize_aws_json_1_1(input)
    ).encode()
