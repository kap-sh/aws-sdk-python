...
def build_request(
    ...
    input: aws_sdk_ssm.types.list_document_versions_request.ListDocumentVersionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_document_versions_request.serialize_aws_json_1_1(input)
    ).encode()
