...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_document_versions_request.ListDocumentVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_document_versions_request.serialize_aws_json_1_1(input_)
    ).encode()
