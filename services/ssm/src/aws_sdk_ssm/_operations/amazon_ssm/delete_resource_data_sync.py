...
def handle_response(
    ...
    out: aws_sdk_ssm.types.delete_resource_data_sync_result.DeleteResourceDataSyncResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.delete_resource_data_sync_request.DeleteResourceDataSyncRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.delete_resource_data_sync_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
