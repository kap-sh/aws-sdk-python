"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeAssociationExecutions``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_association_executions_result.DescribeAssociationExecutionsResult = aws_sdk_ssm.types.describe_association_executions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_association_executions_request.DescribeAssociationExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_association_executions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_association_executions(
