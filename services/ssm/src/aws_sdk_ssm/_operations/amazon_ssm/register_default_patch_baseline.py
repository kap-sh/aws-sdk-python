...
def handle_response(
    ...
    out: aws_sdk_ssm.types.register_default_patch_baseline_result.RegisterDefaultPatchBaselineResult = aws_sdk_ssm.types.register_default_patch_baseline_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.register_default_patch_baseline_request.RegisterDefaultPatchBaselineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.register_default_patch_baseline_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
