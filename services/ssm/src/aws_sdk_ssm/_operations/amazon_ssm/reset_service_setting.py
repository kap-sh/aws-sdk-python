...
def build_request(
    ...
    input: aws_sdk_ssm.types.reset_service_setting_request.ResetServiceSettingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.reset_service_setting_request.serialize_aws_json_1_1(input)
    ).encode()
