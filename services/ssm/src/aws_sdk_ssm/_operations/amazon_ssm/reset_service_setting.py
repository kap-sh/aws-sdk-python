"""Generated from Smithy shape ``com.amazonaws.ssm#ResetServiceSetting``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceSettingNotFound":
            import aws_sdk_ssm.errors.service_setting_not_found

            raise aws_sdk_ssm.errors.service_setting_not_found.ServiceSettingNotFound.from_aws_json_1_1(
                data
            )
        case "TooManyUpdates":
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.reset_service_setting_result.ResetServiceSettingResult = (
        aws_sdk_ssm.types.reset_service_setting_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.reset_service_setting_request.ResetServiceSettingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.reset_service_setting_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_reset_service_setting(
