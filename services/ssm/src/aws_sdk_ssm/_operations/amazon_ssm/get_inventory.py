"""Generated from Smithy shape ``com.amazonaws.ssm#GetInventory``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidInventoryGroupException":
            import aws_sdk_ssm.errors.invalid_inventory_group_exception

            raise aws_sdk_ssm.errors.invalid_inventory_group_exception.InvalidInventoryGroupException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidResultAttributeException":
            import aws_sdk_ssm.errors.invalid_result_attribute_exception

            raise aws_sdk_ssm.errors.invalid_result_attribute_exception.InvalidResultAttributeException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_inventory_result.GetInventoryResult = (
        aws_sdk_ssm.types.get_inventory_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_inventory_request.GetInventoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_inventory_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_inventory(
    ...
    input_: aws_sdk_ssm.types.get_inventory_request.GetInventoryRequest,
) -> tuple[aws_sdk_ssm.types.get_inventory_result.GetInventoryResult, zapros.Response]:
