...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidActivation":
            import aws_sdk_ssm.errors.invalid_activation

            raise aws_sdk_ssm.errors.invalid_activation.InvalidActivation.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.delete_activation_result.DeleteActivationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.delete_activation_request.DeleteActivationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.delete_activation_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_activation(
    ...
    aws_sdk_ssm.types.delete_activation_result.DeleteActivationResult, zapros.Response
]:
