...
def handle_response(
    ...
    out: aws_sdk_ssm.types.delete_parameter_result.DeleteParameterResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.delete_parameter_request.DeleteParameterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.delete_parameter_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_parameter(
    ...
    aws_sdk_ssm.types.delete_parameter_result.DeleteParameterResult, zapros.Response
]:
