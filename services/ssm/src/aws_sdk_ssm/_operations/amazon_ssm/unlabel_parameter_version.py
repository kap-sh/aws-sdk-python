...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ParameterNotFound":
            import aws_sdk_ssm.errors.parameter_not_found

            raise aws_sdk_ssm.errors.parameter_not_found.ParameterNotFound.from_aws_json_1_1(
                data
            )
        case "ParameterVersionNotFound":
            import aws_sdk_ssm.errors.parameter_version_not_found

            raise aws_sdk_ssm.errors.parameter_version_not_found.ParameterVersionNotFound.from_aws_json_1_1(
                data
            )
        case "TooManyUpdates":
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.unlabel_parameter_version_result.UnlabelParameterVersionResult = aws_sdk_ssm.types.unlabel_parameter_version_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.unlabel_parameter_version_request.UnlabelParameterVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.unlabel_parameter_version_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
