"""Generated from Smithy shape ``com.amazonaws.ssm#GetParameter``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_parameter_result.GetParameterResult = (
        aws_sdk_ssm.types.get_parameter_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_parameter_request.GetParameterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_parameter_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_parameter(
    ...
    input_: aws_sdk_ssm.types.get_parameter_request.GetParameterRequest,
) -> tuple[aws_sdk_ssm.types.get_parameter_result.GetParameterResult, zapros.Response]:
