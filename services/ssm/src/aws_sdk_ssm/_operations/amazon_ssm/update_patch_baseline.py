...
def handle_response(
    ...
    out: aws_sdk_ssm.types.update_patch_baseline_result.UpdatePatchBaselineResult = (
        aws_sdk_ssm.types.update_patch_baseline_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.update_patch_baseline_request.UpdatePatchBaselineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.update_patch_baseline_request.serialize_aws_json_1_1(input_)
    ).encode()
