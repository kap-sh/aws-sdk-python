...
def build_request(
    ...
    input: aws_sdk_ssm.types.update_patch_baseline_request.UpdatePatchBaselineRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.update_patch_baseline_request.serialize_aws_json_1_1(input)
    ).encode()
