"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeInstanceInformation``."""
...
import aws_sdk_ssm.errors.invalid_instance_information_filter_value
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidInstanceInformationFilterValue":
            raise aws_sdk_ssm.errors.invalid_instance_information_filter_value.InvalidInstanceInformationFilterValue.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_instance_information_result.DescribeInstanceInformationResult = aws_sdk_ssm.types.describe_instance_information_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_instance_information_request.DescribeInstanceInformationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_instance_information_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_instance_information(
