"""Generated from Smithy shape ``com.amazonaws.ssm#DeregisterManagedInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.deregister_managed_instance_result.DeregisterManagedInstanceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.deregister_managed_instance_request.DeregisterManagedInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.deregister_managed_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_deregister_managed_instance(
