"""Generated from Smithy shape ``com.amazonaws.ssm#ListOpsItemRelatedItems``."""
...
import aws_sdk_ssm.types.ops_item_related_item_summaries
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_ops_item_related_items_response.ListOpsItemRelatedItemsResponse = aws_sdk_ssm.types.list_ops_item_related_items_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_ops_item_related_items_request.ListOpsItemRelatedItemsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.ListOpsItemRelatedItems"
    import aws_sdk_ssm.types.list_ops_item_related_items_request

    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_ops_item_related_items_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_ops_item_related_items(
