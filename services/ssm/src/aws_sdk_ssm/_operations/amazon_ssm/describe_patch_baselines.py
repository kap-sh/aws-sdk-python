...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_patch_baselines_request.DescribePatchBaselinesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_patch_baselines_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
