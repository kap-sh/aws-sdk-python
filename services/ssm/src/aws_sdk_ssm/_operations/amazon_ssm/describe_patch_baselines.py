...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_patch_baselines_result.DescribePatchBaselinesResult = aws_sdk_ssm.types.describe_patch_baselines_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_ssm.types.describe_patch_baselines_request.DescribePatchBaselinesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_patch_baselines_request.serialize_aws_json_1_1(input)
    ).encode()
