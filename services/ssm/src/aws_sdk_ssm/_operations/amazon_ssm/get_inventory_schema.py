...
def build_request(
    ...
    input: aws_sdk_ssm.types.get_inventory_schema_request.GetInventorySchemaRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_inventory_schema_request.serialize_aws_json_1_1(input)
    ).encode()
