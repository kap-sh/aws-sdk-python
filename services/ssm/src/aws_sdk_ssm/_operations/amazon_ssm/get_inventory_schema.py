...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_inventory_schema_result.GetInventorySchemaResult = (
        aws_sdk_ssm.types.get_inventory_schema_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_inventory_schema_request.GetInventorySchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_inventory_schema_request.serialize_aws_json_1_1(input_)
    ).encode()
