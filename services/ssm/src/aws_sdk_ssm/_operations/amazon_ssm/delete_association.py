"""Generated from Smithy shape ``com.amazonaws.ssm#DeleteAssociation``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.delete_association_result.DeleteAssociationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.delete_association_request.DeleteAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.delete_association_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_association(
    ...
    aws_sdk_ssm.types.delete_association_result.DeleteAssociationResult, zapros.Response
]:
