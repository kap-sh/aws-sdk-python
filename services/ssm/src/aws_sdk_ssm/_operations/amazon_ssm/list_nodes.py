"""Generated from Smithy shape ``com.amazonaws.ssm#ListNodes``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_nodes_result.ListNodesResult = (
        aws_sdk_ssm.types.list_nodes_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_nodes_request.ListNodesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.ListNodes"
    import aws_sdk_ssm.types.list_nodes_request

    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_nodes_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_nodes(
    ...
    input_: aws_sdk_ssm.types.list_nodes_request.ListNodesRequest,
) -> tuple[aws_sdk_ssm.types.list_nodes_result.ListNodesResult, zapros.Response]:
