"""Generated from Smithy shape ``com.amazonaws.ssm#CreateActivation``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.create_activation_result.CreateActivationResult = (
        aws_sdk_ssm.types.create_activation_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.create_activation_request.CreateActivationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.create_activation_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_activation(
    ...
    aws_sdk_ssm.types.create_activation_result.CreateActivationResult, zapros.Response
]:
...
async def async_create_activation(
