...
def handle_response(
    ...
    out: aws_sdk_ssm.types.update_maintenance_window_result.UpdateMaintenanceWindowResult = aws_sdk_ssm.types.update_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.update_maintenance_window_request.UpdateMaintenanceWindowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.update_maintenance_window_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
