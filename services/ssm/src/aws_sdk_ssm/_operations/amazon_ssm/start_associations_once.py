...
def build_request(
    ...
    input: aws_sdk_ssm.types.start_associations_once_request.StartAssociationsOnceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.start_associations_once_request.serialize_aws_json_1_1(input)
    ).encode()
