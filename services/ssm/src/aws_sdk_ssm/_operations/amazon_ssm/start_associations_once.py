"""Generated from Smithy shape ``com.amazonaws.ssm#StartAssociationsOnce``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidAssociation":
            import aws_sdk_ssm.errors.invalid_association

            raise aws_sdk_ssm.errors.invalid_association.InvalidAssociation.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.start_associations_once_result.StartAssociationsOnceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.start_associations_once_request.StartAssociationsOnceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.start_associations_once_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_start_associations_once(
