...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_ops_item_events_response.ListOpsItemEventsResponse = (
        aws_sdk_ssm.types.list_ops_item_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_ops_item_events_request.ListOpsItemEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_ops_item_events_request.serialize_aws_json_1_1(input_)
    ).encode()
