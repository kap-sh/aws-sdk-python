...
def build_request(
    ...
    input: aws_sdk_ssm.types.list_ops_item_events_request.ListOpsItemEventsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_ops_item_events_request.serialize_aws_json_1_1(input)
    ).encode()
