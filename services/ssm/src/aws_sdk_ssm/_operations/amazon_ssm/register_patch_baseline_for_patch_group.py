...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AlreadyExistsException":
            import aws_sdk_ssm.errors.already_exists_exception

            raise aws_sdk_ssm.errors.already_exists_exception.AlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.register_patch_baseline_for_patch_group_result.RegisterPatchBaselineForPatchGroupResult = aws_sdk_ssm.types.register_patch_baseline_for_patch_group_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.register_patch_baseline_for_patch_group_request.RegisterPatchBaselineForPatchGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.register_patch_baseline_for_patch_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
