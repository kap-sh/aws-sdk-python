...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_maintenance_window_execution_result.GetMaintenanceWindowExecutionResult = aws_sdk_ssm.types.get_maintenance_window_execution_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_maintenance_window_execution_request.GetMaintenanceWindowExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_maintenance_window_execution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
