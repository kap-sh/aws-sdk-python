...
def build_request(
    ...
    input: aws_sdk_ssm.types.list_inventory_entries_request.ListInventoryEntriesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_inventory_entries_request.serialize_aws_json_1_1(input)
    ).encode()
