...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_inventory_entries_result.ListInventoryEntriesResult = (
        aws_sdk_ssm.types.list_inventory_entries_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_inventory_entries_request.ListInventoryEntriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_inventory_entries_request.serialize_aws_json_1_1(input_)
    ).encode()
