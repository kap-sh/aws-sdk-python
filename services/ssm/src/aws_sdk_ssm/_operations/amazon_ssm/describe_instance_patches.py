"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeInstancePatches``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_instance_patches_result.DescribeInstancePatchesResult = aws_sdk_ssm.types.describe_instance_patches_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_instance_patches_request.DescribeInstancePatchesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_instance_patches_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_instance_patches(
