...
def build_request(
    ...
    input: aws_sdk_ssm.types.describe_patch_groups_request.DescribePatchGroupsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_patch_groups_request.serialize_aws_json_1_1(input)
    ).encode()
