"""Generated from Smithy shape ``com.amazonaws.ssm#SendAutomationSignal``."""
...
import aws_sdk_ssm.errors.automation_step_not_found_exception
import aws_sdk_ssm.errors.internal_server_error
import aws_sdk_ssm.errors.invalid_automation_signal_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AutomationStepNotFoundException":
            raise aws_sdk_ssm.errors.automation_step_not_found_exception.AutomationStepNotFoundException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidAutomationSignalException":
            raise aws_sdk_ssm.errors.invalid_automation_signal_exception.InvalidAutomationSignalException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.send_automation_signal_result.SendAutomationSignalResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.send_automation_signal_request.SendAutomationSignalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.send_automation_signal_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_send_automation_signal(
