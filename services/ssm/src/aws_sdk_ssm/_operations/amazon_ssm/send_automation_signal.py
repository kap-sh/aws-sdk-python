...
def build_request(
    ...
    input: aws_sdk_ssm.types.send_automation_signal_request.SendAutomationSignalRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.send_automation_signal_request.serialize_aws_json_1_1(input)
    ).encode()
