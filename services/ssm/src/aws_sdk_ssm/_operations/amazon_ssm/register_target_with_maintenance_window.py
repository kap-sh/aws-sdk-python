...
def handle_response(
    ...
    out: aws_sdk_ssm.types.register_target_with_maintenance_window_result.RegisterTargetWithMaintenanceWindowResult = aws_sdk_ssm.types.register_target_with_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.register_target_with_maintenance_window_request.RegisterTargetWithMaintenanceWindowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.register_target_with_maintenance_window_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
