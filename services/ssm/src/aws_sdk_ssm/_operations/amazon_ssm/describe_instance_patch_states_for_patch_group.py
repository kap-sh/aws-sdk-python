...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_instance_patch_states_for_patch_group_result.DescribeInstancePatchStatesForPatchGroupResult = aws_sdk_ssm.types.describe_instance_patch_states_for_patch_group_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_instance_patch_states_for_patch_group_request.DescribeInstancePatchStatesForPatchGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_instance_patch_states_for_patch_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
