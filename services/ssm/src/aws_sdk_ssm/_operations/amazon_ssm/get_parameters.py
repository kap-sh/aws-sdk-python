...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_parameters_result.GetParametersResult = (
        aws_sdk_ssm.types.get_parameters_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_parameters_request.GetParametersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_parameters_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_parameters(
    ...
    aws_sdk_ssm.types.get_parameters_result.GetParametersResult, zapros.Response
]:
