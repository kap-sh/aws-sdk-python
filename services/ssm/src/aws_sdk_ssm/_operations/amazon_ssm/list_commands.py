...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_commands_result.ListCommandsResult = (
        aws_sdk_ssm.types.list_commands_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_commands_request.ListCommandsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_commands_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_commands(
    ...
    input_: aws_sdk_ssm.types.list_commands_request.ListCommandsRequest,
) -> tuple[aws_sdk_ssm.types.list_commands_result.ListCommandsResult, zapros.Response]:
