...
def build_request(
    ...
    input: aws_sdk_ssm.types.create_association_batch_request.CreateAssociationBatchRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.create_association_batch_request.serialize_aws_json_1_1(input)
    ).encode()
