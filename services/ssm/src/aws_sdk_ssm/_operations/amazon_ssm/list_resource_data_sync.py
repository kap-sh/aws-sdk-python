...
def build_request(
    ...
    input: aws_sdk_ssm.types.list_resource_data_sync_request.ListResourceDataSyncRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_resource_data_sync_request.serialize_aws_json_1_1(input)
    ).encode()
