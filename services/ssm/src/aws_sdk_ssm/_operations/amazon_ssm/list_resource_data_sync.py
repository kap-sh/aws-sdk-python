...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_resource_data_sync_result.ListResourceDataSyncResult = (
        aws_sdk_ssm.types.list_resource_data_sync_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_resource_data_sync_request.ListResourceDataSyncRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_resource_data_sync_request.serialize_aws_json_1_1(input_)
    ).encode()
