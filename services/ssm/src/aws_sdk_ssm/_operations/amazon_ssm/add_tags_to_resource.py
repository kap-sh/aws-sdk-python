...
def build_request(
    ...
    input: aws_sdk_ssm.types.add_tags_to_resource_request.AddTagsToResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.add_tags_to_resource_request.serialize_aws_json_1_1(input)
    ).encode()
