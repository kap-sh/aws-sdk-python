...
import aws_sdk_ssm.types.patch_group_list
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_patch_baseline_result.GetPatchBaselineResult = (
        aws_sdk_ssm.types.get_patch_baseline_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_patch_baseline_request.GetPatchBaselineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_patch_baseline_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_patch_baseline(
    ...
    aws_sdk_ssm.types.get_patch_baseline_result.GetPatchBaselineResult, zapros.Response
]:
