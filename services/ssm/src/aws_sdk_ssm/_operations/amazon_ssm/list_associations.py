"""Generated from Smithy shape ``com.amazonaws.ssm#ListAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.list_associations_result.ListAssociationsResult = (
        aws_sdk_ssm.types.list_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.list_associations_request.ListAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.list_associations_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_associations(
    ...
    aws_sdk_ssm.types.list_associations_result.ListAssociationsResult, zapros.Response
]:
