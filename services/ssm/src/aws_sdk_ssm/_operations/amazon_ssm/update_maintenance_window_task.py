"""Generated from Smithy shape ``com.amazonaws.ssm#UpdateMaintenanceWindowTask``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.update_maintenance_window_task_result.UpdateMaintenanceWindowTaskResult = aws_sdk_ssm.types.update_maintenance_window_task_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.update_maintenance_window_task_request.UpdateMaintenanceWindowTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.update_maintenance_window_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_maintenance_window_task(
