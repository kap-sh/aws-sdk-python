"""Generated from Smithy shape ``com.amazonaws.ssm#GetOpsMetadata``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OpsMetadataNotFoundException":
            import aws_sdk_ssm.errors.ops_metadata_not_found_exception

            raise aws_sdk_ssm.errors.ops_metadata_not_found_exception.OpsMetadataNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_ops_metadata_result.GetOpsMetadataResult = (
        aws_sdk_ssm.types.get_ops_metadata_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_ops_metadata_request.GetOpsMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonSSM.GetOpsMetadata"
    import aws_sdk_ssm.types.get_ops_metadata_request

    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_ops_metadata_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_ops_metadata(
    ...
    aws_sdk_ssm.types.get_ops_metadata_result.GetOpsMetadataResult, zapros.Response
]:
...
async def async_get_ops_metadata(
