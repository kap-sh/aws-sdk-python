"""Generated from Smithy shape ``com.amazonaws.ssm#RegisterTaskWithMaintenanceWindow``."""
...
import aws_sdk_ssm.errors.feature_not_available_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FeatureNotAvailableException":
            raise aws_sdk_ssm.errors.feature_not_available_exception.FeatureNotAvailableException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.register_task_with_maintenance_window_result.RegisterTaskWithMaintenanceWindowResult = aws_sdk_ssm.types.register_task_with_maintenance_window_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.register_task_with_maintenance_window_request.RegisterTaskWithMaintenanceWindowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.register_task_with_maintenance_window_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_register_task_with_maintenance_window(
