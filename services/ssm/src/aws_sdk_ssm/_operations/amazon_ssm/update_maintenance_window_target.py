"""Generated from Smithy shape ``com.amazonaws.ssm#UpdateMaintenanceWindowTarget``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.update_maintenance_window_target_result.UpdateMaintenanceWindowTargetResult = aws_sdk_ssm.types.update_maintenance_window_target_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.update_maintenance_window_target_request.UpdateMaintenanceWindowTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.update_maintenance_window_target_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_maintenance_window_target(
