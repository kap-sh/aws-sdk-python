...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_parameters_result.DescribeParametersResult = (
        aws_sdk_ssm.types.describe_parameters_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_parameters_request.DescribeParametersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_parameters_request.serialize_aws_json_1_1(input_)
    ).encode()
