...
def build_request(
    ...
    input: aws_sdk_ssm.types.describe_parameters_request.DescribeParametersRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_parameters_request.serialize_aws_json_1_1(input)
    ).encode()
