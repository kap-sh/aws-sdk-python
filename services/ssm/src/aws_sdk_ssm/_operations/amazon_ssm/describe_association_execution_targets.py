"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeAssociationExecutionTargets``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AssociationExecutionDoesNotExist":
            import aws_sdk_ssm.errors.association_execution_does_not_exist

            raise aws_sdk_ssm.errors.association_execution_does_not_exist.AssociationExecutionDoesNotExist.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_association_execution_targets_result.DescribeAssociationExecutionTargetsResult = aws_sdk_ssm.types.describe_association_execution_targets_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_association_execution_targets_request.DescribeAssociationExecutionTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_association_execution_targets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_association_execution_targets(
