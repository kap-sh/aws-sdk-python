"""Generated from Smithy shape ``com.amazonaws.ssm#DeleteParameters``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.delete_parameters_result.DeleteParametersResult = (
        aws_sdk_ssm.types.delete_parameters_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.delete_parameters_request.DeleteParametersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.delete_parameters_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_parameters(
    ...
    aws_sdk_ssm.types.delete_parameters_result.DeleteParametersResult, zapros.Response
]:
...
async def async_delete_parameters(
