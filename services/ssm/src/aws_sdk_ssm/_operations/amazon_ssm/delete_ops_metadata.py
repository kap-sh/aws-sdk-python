...
def handle_response(
    ...
    out: aws_sdk_ssm.types.delete_ops_metadata_result.DeleteOpsMetadataResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.delete_ops_metadata_request.DeleteOpsMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.delete_ops_metadata_request.serialize_aws_json_1_1(input_)
    ).encode()
