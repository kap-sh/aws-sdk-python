...
def build_request(
    ...
    input: aws_sdk_ssm.types.delete_ops_metadata_request.DeleteOpsMetadataRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.delete_ops_metadata_request.serialize_aws_json_1_1(input)
    ).encode()
