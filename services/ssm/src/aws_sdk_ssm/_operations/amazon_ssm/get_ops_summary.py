"""Generated from Smithy shape ``com.amazonaws.ssm#GetOpsSummary``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_ops_summary_result.GetOpsSummaryResult = (
        aws_sdk_ssm.types.get_ops_summary_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_ops_summary_request.GetOpsSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_ops_summary_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_ops_summary(
    ...
    aws_sdk_ssm.types.get_ops_summary_result.GetOpsSummaryResult, zapros.Response
]:
...
async def async_get_ops_summary(
