"""Generated from Smithy shape ``com.amazonaws.ssm#GetMaintenanceWindowTask``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.get_maintenance_window_task_result.GetMaintenanceWindowTaskResult = aws_sdk_ssm.types.get_maintenance_window_task_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.get_maintenance_window_task_request.GetMaintenanceWindowTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.get_maintenance_window_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_maintenance_window_task(
