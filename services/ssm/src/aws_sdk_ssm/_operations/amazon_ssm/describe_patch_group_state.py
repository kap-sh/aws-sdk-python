"""Generated from Smithy shape ``com.amazonaws.ssm#DescribePatchGroupState``."""
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_patch_group_state_result.DescribePatchGroupStateResult = aws_sdk_ssm.types.describe_patch_group_state_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_patch_group_state_request.DescribePatchGroupStateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_patch_group_state_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_patch_group_state(
