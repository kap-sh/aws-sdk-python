...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_automation_executions_result.DescribeAutomationExecutionsResult = aws_sdk_ssm.types.describe_automation_executions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_automation_executions_request.DescribeAutomationExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_automation_executions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
