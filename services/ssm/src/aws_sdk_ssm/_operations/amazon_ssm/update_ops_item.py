...
def handle_response(
    ...
    out: aws_sdk_ssm.types.update_ops_item_response.UpdateOpsItemResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.update_ops_item_request.UpdateOpsItemRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.update_ops_item_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_ops_item(
    ...
    aws_sdk_ssm.types.update_ops_item_response.UpdateOpsItemResponse, zapros.Response
]:
