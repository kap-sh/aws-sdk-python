"""Generated from Smithy shape ``com.amazonaws.ssm#UpdateAssociationStatus``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "StatusUnchanged":
            import aws_sdk_ssm.errors.status_unchanged

            raise aws_sdk_ssm.errors.status_unchanged.StatusUnchanged.from_aws_json_1_1(
                data
            )
        case "TooManyUpdates":
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.update_association_status_result.UpdateAssociationStatusResult = aws_sdk_ssm.types.update_association_status_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.update_association_status_request.UpdateAssociationStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.update_association_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_association_status(
