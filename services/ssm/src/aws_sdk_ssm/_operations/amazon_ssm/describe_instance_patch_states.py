"""Generated from Smithy shape ``com.amazonaws.ssm#DescribeInstancePatchStates``."""
...
import aws_sdk_ssm.types.instance_patch_state_list
...
def handle_response(
    ...
    out: aws_sdk_ssm.types.describe_instance_patch_states_result.DescribeInstancePatchStatesResult = aws_sdk_ssm.types.describe_instance_patch_states_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_ssm.types.describe_instance_patch_states_request.DescribeInstancePatchStatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ssm.types.describe_instance_patch_states_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_instance_patch_states(
