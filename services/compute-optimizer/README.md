...
```
pip install aws-sdk-compute-optimizer
```

## Usage

```python
from aws_sdk_compute_optimizer import AsyncComputeOptimizerClient
...
```python
from aws_sdk_compute_optimizer import AsyncComputeOptimizerClient
from aws_sdk_compute_optimizer.error import AccessDeniedException
