...
from capo_compute_optimizer._services._aws_config import aaws_config
...
class AsyncComputeOptimizerClient:
    ...
    async def delete_recommendation_preferences(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.delete_recommendation_preferences_request.DeleteRecommendationPreferencesRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.delete_recommendation_preferences_response.DeleteRecommendationPreferencesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.delete_recommendation_preferences.async_delete_recommendation_preferences(
    ...
    async def describe_recommendation_export_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.describe_recommendation_export_jobs_request.DescribeRecommendationExportJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.describe_recommendation_export_jobs_response.DescribeRecommendationExportJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.describe_recommendation_export_jobs.async_describe_recommendation_export_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_compute_optimizer.types.recommendation_export_job.RecommendationExportJob]":
        _token = next_token
        while True:
    ...
    async def export_auto_scaling_group_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.export_auto_scaling_group_recommendations_request.ExportAutoScalingGroupRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.export_auto_scaling_group_recommendations_response.ExportAutoScalingGroupRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.export_auto_scaling_group_recommendations.async_export_auto_scaling_group_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def export_ebs_volume_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.export_ebs_volume_recommendations_request.ExportEBSVolumeRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.export_ebs_volume_recommendations_response.ExportEBSVolumeRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.export_ebs_volume_recommendations.async_export_ebs_volume_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def export_ec2_instance_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.export_ec2_instance_recommendations_request.ExportEC2InstanceRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.export_ec2_instance_recommendations_response.ExportEC2InstanceRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.export_ec2_instance_recommendations.async_export_ec2_instance_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def export_ecs_service_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.export_ecs_service_recommendations_request.ExportECSServiceRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.export_ecs_service_recommendations_response.ExportECSServiceRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.export_ecs_service_recommendations.async_export_ecs_service_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def export_idle_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.export_idle_recommendations_request.ExportIdleRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.export_idle_recommendations_response.ExportIdleRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.export_idle_recommendations.async_export_idle_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def export_lambda_function_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.export_lambda_function_recommendations_request.ExportLambdaFunctionRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.export_lambda_function_recommendations_response.ExportLambdaFunctionRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.export_lambda_function_recommendations.async_export_lambda_function_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def export_license_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.export_license_recommendations_request.ExportLicenseRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.export_license_recommendations_response.ExportLicenseRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.export_license_recommendations.async_export_license_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def export_rds_database_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.export_rds_database_recommendations_request.ExportRDSDatabaseRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.export_rds_database_recommendations_response.ExportRDSDatabaseRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.export_rds_database_recommendations.async_export_rds_database_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_auto_scaling_group_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_auto_scaling_group_recommendations_request.GetAutoScalingGroupRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_auto_scaling_group_recommendations_response.GetAutoScalingGroupRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_auto_scaling_group_recommendations.async_get_auto_scaling_group_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_ebs_volume_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_ebs_volume_recommendations_request.GetEBSVolumeRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_ebs_volume_recommendations_response.GetEBSVolumeRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_ebs_volume_recommendations.async_get_ebs_volume_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_ec2_instance_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_ec2_instance_recommendations_request.GetEC2InstanceRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_ec2_instance_recommendations_response.GetEC2InstanceRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_ec2_instance_recommendations.async_get_ec2_instance_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_ec2_recommendation_projected_metrics(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_ec2_recommendation_projected_metrics_request.GetEC2RecommendationProjectedMetricsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_ec2_recommendation_projected_metrics_response.GetEC2RecommendationProjectedMetricsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_ec2_recommendation_projected_metrics.async_get_ec2_recommendation_projected_metrics(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_ecs_service_recommendation_projected_metrics(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_ecs_service_recommendation_projected_metrics_request.GetECSServiceRecommendationProjectedMetricsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_ecs_service_recommendation_projected_metrics_response.GetECSServiceRecommendationProjectedMetricsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_ecs_service_recommendation_projected_metrics.async_get_ecs_service_recommendation_projected_metrics(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_ecs_service_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_ecs_service_recommendations_request.GetECSServiceRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_ecs_service_recommendations_response.GetECSServiceRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_ecs_service_recommendations.async_get_ecs_service_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_effective_recommendation_preferences(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_effective_recommendation_preferences_request.GetEffectiveRecommendationPreferencesRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_effective_recommendation_preferences_response.GetEffectiveRecommendationPreferencesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_effective_recommendation_preferences.async_get_effective_recommendation_preferences(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_enrollment_status(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_enrollment_status_request.GetEnrollmentStatusRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_enrollment_status_response.GetEnrollmentStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_enrollment_status.async_get_enrollment_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_enrollment_statuses_for_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_enrollment_statuses_for_organization_request.GetEnrollmentStatusesForOrganizationRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_enrollment_statuses_for_organization_response.GetEnrollmentStatusesForOrganizationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_enrollment_statuses_for_organization.async_get_enrollment_statuses_for_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_compute_optimizer.types.account_enrollment_status.AccountEnrollmentStatus]":
        _token = next_token
        while True:
    ...
    async def get_idle_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_idle_recommendations_request.GetIdleRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_idle_recommendations_response.GetIdleRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_idle_recommendations.async_get_idle_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_lambda_function_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_lambda_function_recommendations_request.GetLambdaFunctionRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_lambda_function_recommendations_response.GetLambdaFunctionRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_lambda_function_recommendations.async_get_lambda_function_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_compute_optimizer.types.lambda_function_recommendation.LambdaFunctionRecommendation]":
        _token = next_token
        while True:
    ...
    async def get_license_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_license_recommendations_request.GetLicenseRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_license_recommendations_response.GetLicenseRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_license_recommendations.async_get_license_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_rds_database_recommendation_projected_metrics(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_rds_database_recommendation_projected_metrics_request.GetRDSDatabaseRecommendationProjectedMetricsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_rds_database_recommendation_projected_metrics_response.GetRDSDatabaseRecommendationProjectedMetricsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_rds_database_recommendation_projected_metrics.async_get_rds_database_recommendation_projected_metrics(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_rds_database_recommendations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_rds_database_recommendations_request.GetRDSDatabaseRecommendationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_rds_database_recommendations_response.GetRDSDatabaseRecommendationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_rds_database_recommendations.async_get_rds_database_recommendations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_recommendation_preferences(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_recommendation_preferences_request.GetRecommendationPreferencesRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_recommendation_preferences_response.GetRecommendationPreferencesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_recommendation_preferences.async_get_recommendation_preferences(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_compute_optimizer.types.recommendation_preferences_detail.RecommendationPreferencesDetail]":
        _token = next_token
        while True:
    ...
    async def get_recommendation_summaries(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.get_recommendation_summaries_request.GetRecommendationSummariesRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.get_recommendation_summaries_response.GetRecommendationSummariesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.get_recommendation_summaries.async_get_recommendation_summaries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_compute_optimizer.types.recommendation_summary.RecommendationSummary]":
        _token = next_token
        while True:
    ...
    async def put_recommendation_preferences(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.put_recommendation_preferences_request.PutRecommendationPreferencesRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.put_recommendation_preferences_response.PutRecommendationPreferencesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.put_recommendation_preferences.async_put_recommendation_preferences(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_enrollment_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_compute_optimizer.types.update_enrollment_status_request.UpdateEnrollmentStatusRequest]",
        ) -> AsyncOperationResponse[
            "capo_compute_optimizer.types.update_enrollment_status_response.UpdateEnrollmentStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_compute_optimizer._operations.compute_optimizer_service.update_enrollment_status.async_update_enrollment_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
