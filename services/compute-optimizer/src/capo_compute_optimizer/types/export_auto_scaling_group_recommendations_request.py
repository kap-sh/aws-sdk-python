"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#ExportAutoScalingGroupRecommendationsRequest``."""
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ExportAutoScalingGroupRecommendationsRequest) -> dict:
    out: dict = {}
    ...
    if "fields_to_export" in value:
        ...
        out["fieldsToExport"] = (
            capo_compute_optimizer.types.exportable_auto_scaling_group_fields.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(
    ...
    if "fieldsToExport" in data:
        ...
        out["fields_to_export"] = (
            capo_compute_optimizer.types.exportable_auto_scaling_group_fields.deserialize_aws_json_1_0(
                data["fieldsToExport"]
            )
        )
