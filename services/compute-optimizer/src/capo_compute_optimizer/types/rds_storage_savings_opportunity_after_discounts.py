"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#RDSStorageSavingsOpportunityAfterDiscounts``."""
...
if TYPE_CHECKING:
    import capo_compute_optimizer.types.rds_storage_estimated_monthly_savings
    import capo_compute_optimizer.types.savings_opportunity_percentage


class RDSStorageSavingsOpportunityAfterDiscounts(TypedDict, closed=True):
    ...
    estimated_monthly_savings: NotRequired[
        "capo_compute_optimizer.types.rds_storage_estimated_monthly_savings.RDSStorageEstimatedMonthlySavings"
    ]
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: RDSStorageSavingsOpportunityAfterDiscounts) -> dict:
    out: dict = {}
    ...
    if "estimated_monthly_savings" in value:
        ...
        out["estimatedMonthlySavings"] = (
            capo_compute_optimizer.types.rds_storage_estimated_monthly_savings.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> RDSStorageSavingsOpportunityAfterDiscounts:
    out: RDSStorageSavingsOpportunityAfterDiscounts = {}  # type: ignore[typeddict-item]
    ...
    if "estimatedMonthlySavings" in data:
        ...
        out["estimated_monthly_savings"] = (
            capo_compute_optimizer.types.rds_storage_estimated_monthly_savings.deserialize_aws_json_1_0(
