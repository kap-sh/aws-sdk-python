...
class ExportECSServiceRecommendationsRequest(TypedDict, closed=True):
...
def serialize_aws_json_1_0(value: ExportECSServiceRecommendationsRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            capo_compute_optimizer.types.ecs_service_recommendation_filters.serialize_aws_json_1_0(
                value["filters"]
            )
        )
    if "fields_to_export" in value:
        ...
        out["fieldsToExport"] = (
            capo_compute_optimizer.types.exportable_ecs_service_fields.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ExportECSServiceRecommendationsRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            capo_compute_optimizer.types.ecs_service_recommendation_filters.deserialize_aws_json_1_0(
                data["filters"]
            )
        )
    if "fieldsToExport" in data:
        ...
        out["fields_to_export"] = (
            capo_compute_optimizer.types.exportable_ecs_service_fields.deserialize_aws_json_1_0(
                data["fieldsToExport"]
            )
        )
