...
class IdleUtilizationMetric(TypedDict, closed=True):
    name: NotRequired["capo_compute_optimizer.types.idle_metric_name.IdleMetricName"]
    ...
    dimensions: NotRequired[
        "capo_compute_optimizer.types.idle_dimensions.IdleDimensions"
    ]
...
def serialize_aws_json_1_0(value: IdleUtilizationMetric) -> dict:
    ...
    if "name" in value:
        ...
        out["name"] = (
            capo_compute_optimizer.types.idle_metric_name.serialize_aws_json_1_0(
                value["name"]
            )
        )
    ...
    if "dimensions" in value:
        ...
        out["dimensions"] = (
            capo_compute_optimizer.types.idle_dimensions.serialize_aws_json_1_0(
                value["dimensions"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> IdleUtilizationMetric:
    ...
    if "name" in data:
        ...
        out["name"] = (
            capo_compute_optimizer.types.idle_metric_name.deserialize_aws_json_1_0(
                data["name"]
            )
        )
    ...
    if "dimensions" in data:
        ...
        out["dimensions"] = (
            capo_compute_optimizer.types.idle_dimensions.deserialize_aws_json_1_0(
                data["dimensions"]
            )
        )
    return out
