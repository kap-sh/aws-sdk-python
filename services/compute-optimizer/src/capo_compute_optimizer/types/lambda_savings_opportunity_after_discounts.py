...
if TYPE_CHECKING:
    import capo_compute_optimizer.types.lambda_estimated_monthly_savings
    import capo_compute_optimizer.types.savings_opportunity_percentage


class LambdaSavingsOpportunityAfterDiscounts(TypedDict, closed=True):
    ...
    estimated_monthly_savings: NotRequired[
        "capo_compute_optimizer.types.lambda_estimated_monthly_savings.LambdaEstimatedMonthlySavings"
    ]
...
def serialize_aws_json_1_0(value: LambdaSavingsOpportunityAfterDiscounts) -> dict:
    ...
    if "estimated_monthly_savings" in value:
        ...
        out["estimatedMonthlySavings"] = (
            capo_compute_optimizer.types.lambda_estimated_monthly_savings.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> LambdaSavingsOpportunityAfterDiscounts:
    ...
    if "estimatedMonthlySavings" in data:
        ...
        out["estimated_monthly_savings"] = (
            capo_compute_optimizer.types.lambda_estimated_monthly_savings.deserialize_aws_json_1_0(
