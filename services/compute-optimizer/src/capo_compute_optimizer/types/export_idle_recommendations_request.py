"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#ExportIdleRecommendationsRequest``."""
...
class ExportIdleRecommendationsRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ExportIdleRecommendationsRequest) -> dict:
    out: dict = {}
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            capo_compute_optimizer.types.idle_recommendation_filters.serialize_aws_json_1_0(
                value["filters"]
            )
        )
    if "fields_to_export" in value:
        ...
        out["fieldsToExport"] = (
            capo_compute_optimizer.types.exportable_idle_fields.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ExportIdleRecommendationsRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            capo_compute_optimizer.types.idle_recommendation_filters.deserialize_aws_json_1_0(
                data["filters"]
            )
        )
    if "fieldsToExport" in data:
        ...
        out["fields_to_export"] = (
            capo_compute_optimizer.types.exportable_idle_fields.deserialize_aws_json_1_0(
                data["fieldsToExport"]
            )
        )
