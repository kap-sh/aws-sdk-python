...
from ._services.async_compute_optimizer import (
    AsyncComputeOptimizerClient as AsyncComputeOptimizerClient,
)
from ._services.compute_optimizer import (
    ComputeOptimizerClient as ComputeOptimizerClient,
)
