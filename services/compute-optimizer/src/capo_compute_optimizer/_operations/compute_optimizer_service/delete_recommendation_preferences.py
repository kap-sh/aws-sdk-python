"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#DeleteRecommendationPreferences``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer.types.delete_recommendation_preferences_response.DeleteRecommendationPreferencesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerService.DeleteRecommendationPreferences"
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.delete_recommendation_preferences_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_recommendation_preferences(
