"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetECSServiceRecommendationProjectedMetrics``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer.types.get_ecs_service_recommendation_projected_metrics_response.GetECSServiceRecommendationProjectedMetricsResponse = capo_compute_optimizer.types.get_ecs_service_recommendation_projected_metrics_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.get_ecs_service_recommendation_projected_metrics_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_ecs_service_recommendation_projected_metrics(
