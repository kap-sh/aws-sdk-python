"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#DescribeRecommendationExportJobs``."""
...
import capo_compute_optimizer.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_compute_optimizer.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_compute_optimizer.types.describe_recommendation_export_jobs_response.DescribeRecommendationExportJobsResponse = capo_compute_optimizer.types.describe_recommendation_export_jobs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerService.DescribeRecommendationExportJobs"
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.describe_recommendation_export_jobs_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_describe_recommendation_export_jobs(
