"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#UpdateEnrollmentStatus``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer.types.update_enrollment_status_response.UpdateEnrollmentStatusResponse = capo_compute_optimizer.types.update_enrollment_status_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.update_enrollment_status_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
