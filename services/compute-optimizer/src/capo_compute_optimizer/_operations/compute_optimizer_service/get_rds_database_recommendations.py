"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetRDSDatabaseRecommendations``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer.types.get_rds_database_recommendations_response.GetRDSDatabaseRecommendationsResponse = capo_compute_optimizer.types.get_rds_database_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerService.GetRDSDatabaseRecommendations"
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.get_rds_database_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_rds_database_recommendations(
