...
def handle_response(
    ...
    out: capo_compute_optimizer.types.export_ecs_service_recommendations_response.ExportECSServiceRecommendationsResponse = capo_compute_optimizer.types.export_ecs_service_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.export_ecs_service_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
