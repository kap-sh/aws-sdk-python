"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#ExportIdleRecommendations``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer.types.export_idle_recommendations_response.ExportIdleRecommendationsResponse = capo_compute_optimizer.types.export_idle_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerService.ExportIdleRecommendations"
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.export_idle_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_export_idle_recommendations(
