"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetLicenseRecommendations``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer.types.get_license_recommendations_response.GetLicenseRecommendationsResponse = capo_compute_optimizer.types.get_license_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.get_license_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_license_recommendations(
