"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetLambdaFunctionRecommendations``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer.types.get_lambda_function_recommendations_response.GetLambdaFunctionRecommendationsResponse = capo_compute_optimizer.types.get_lambda_function_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerService.GetLambdaFunctionRecommendations"
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.get_lambda_function_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_lambda_function_recommendations(
