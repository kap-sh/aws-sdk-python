"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetEnrollmentStatus``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer.types.get_enrollment_status_response.GetEnrollmentStatusResponse = capo_compute_optimizer.types.get_enrollment_status_response.deserialize_aws_json_1_0(
...
async def async_get_enrollment_status(
