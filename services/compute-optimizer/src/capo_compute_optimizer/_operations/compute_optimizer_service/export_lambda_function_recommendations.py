...
def handle_response(
    ...
    out: capo_compute_optimizer.types.export_lambda_function_recommendations_response.ExportLambdaFunctionRecommendationsResponse = capo_compute_optimizer.types.export_lambda_function_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.export_lambda_function_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
