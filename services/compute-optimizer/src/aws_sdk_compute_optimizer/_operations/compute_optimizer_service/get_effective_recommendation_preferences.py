"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetEffectiveRecommendationPreferences``."""
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.get_effective_recommendation_preferences_response.GetEffectiveRecommendationPreferencesResponse = aws_sdk_compute_optimizer.types.get_effective_recommendation_preferences_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.get_effective_recommendation_preferences_request.GetEffectiveRecommendationPreferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_effective_recommendation_preferences(
