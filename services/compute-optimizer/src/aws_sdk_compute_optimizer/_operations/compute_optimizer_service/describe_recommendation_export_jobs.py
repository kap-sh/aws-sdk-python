...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.describe_recommendation_export_jobs_response.DescribeRecommendationExportJobsResponse = aws_sdk_compute_optimizer.types.describe_recommendation_export_jobs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.describe_recommendation_export_jobs_request.DescribeRecommendationExportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.describe_recommendation_export_jobs_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
