"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetRecommendationPreferences``."""
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.get_recommendation_preferences_response.GetRecommendationPreferencesResponse = aws_sdk_compute_optimizer.types.get_recommendation_preferences_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.get_recommendation_preferences_request.GetRecommendationPreferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_recommendation_preferences(
