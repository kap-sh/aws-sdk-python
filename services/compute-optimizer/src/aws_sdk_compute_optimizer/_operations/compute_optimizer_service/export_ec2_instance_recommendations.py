"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#ExportEC2InstanceRecommendations``."""
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.export_ec2_instance_recommendations_response.ExportEC2InstanceRecommendationsResponse = aws_sdk_compute_optimizer.types.export_ec2_instance_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.export_ec2_instance_recommendations_request.ExportEC2InstanceRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerService.ExportEC2InstanceRecommendations"
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.export_ec2_instance_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_export_ec2_instance_recommendations(
