...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.update_enrollment_status_response.UpdateEnrollmentStatusResponse = aws_sdk_compute_optimizer.types.update_enrollment_status_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.update_enrollment_status_request.UpdateEnrollmentStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.update_enrollment_status_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
