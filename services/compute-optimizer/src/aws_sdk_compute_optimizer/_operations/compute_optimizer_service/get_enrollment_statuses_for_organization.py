"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetEnrollmentStatusesForOrganization``."""
...
import aws_sdk_compute_optimizer.types.account_enrollment_statuses
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.get_enrollment_statuses_for_organization_response.GetEnrollmentStatusesForOrganizationResponse = aws_sdk_compute_optimizer.types.get_enrollment_statuses_for_organization_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.get_enrollment_statuses_for_organization_request.GetEnrollmentStatusesForOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_enrollment_statuses_for_organization(
