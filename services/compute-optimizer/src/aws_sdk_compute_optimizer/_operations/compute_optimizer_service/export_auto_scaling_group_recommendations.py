"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#ExportAutoScalingGroupRecommendations``."""
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.export_auto_scaling_group_recommendations_response.ExportAutoScalingGroupRecommendationsResponse = aws_sdk_compute_optimizer.types.export_auto_scaling_group_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.export_auto_scaling_group_recommendations_request.ExportAutoScalingGroupRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_export_auto_scaling_group_recommendations(
