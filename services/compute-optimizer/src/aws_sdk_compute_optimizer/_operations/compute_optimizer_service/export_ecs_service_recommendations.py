"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#ExportECSServiceRecommendations``."""
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.export_ecs_service_recommendations_response.ExportECSServiceRecommendationsResponse = aws_sdk_compute_optimizer.types.export_ecs_service_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.export_ecs_service_recommendations_request.ExportECSServiceRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerService.ExportECSServiceRecommendations"
    import aws_sdk_compute_optimizer.types.export_ecs_service_recommendations_request

    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.export_ecs_service_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_export_ecs_service_recommendations(
