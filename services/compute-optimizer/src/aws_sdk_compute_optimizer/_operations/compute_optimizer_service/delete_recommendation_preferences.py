...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.delete_recommendation_preferences_response.DeleteRecommendationPreferencesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.delete_recommendation_preferences_request.DeleteRecommendationPreferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.delete_recommendation_preferences_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
