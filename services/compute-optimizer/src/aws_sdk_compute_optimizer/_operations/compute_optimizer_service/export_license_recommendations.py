"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#ExportLicenseRecommendations``."""
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.export_license_recommendations_response.ExportLicenseRecommendationsResponse = aws_sdk_compute_optimizer.types.export_license_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.export_license_recommendations_request.ExportLicenseRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerService.ExportLicenseRecommendations"
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.export_license_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_export_license_recommendations(
