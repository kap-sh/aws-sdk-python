...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.get_ec2_recommendation_projected_metrics_response.GetEC2RecommendationProjectedMetricsResponse = aws_sdk_compute_optimizer.types.get_ec2_recommendation_projected_metrics_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.get_ec2_recommendation_projected_metrics_request.GetEC2RecommendationProjectedMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.get_ec2_recommendation_projected_metrics_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
