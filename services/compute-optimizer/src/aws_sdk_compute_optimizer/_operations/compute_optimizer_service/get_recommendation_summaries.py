"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetRecommendationSummaries``."""
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.get_recommendation_summaries_response.GetRecommendationSummariesResponse = aws_sdk_compute_optimizer.types.get_recommendation_summaries_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.get_recommendation_summaries_request.GetRecommendationSummariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.get_recommendation_summaries_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_recommendation_summaries(
