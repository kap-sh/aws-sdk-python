"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#ExportEBSVolumeRecommendations``."""
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.export_ebs_volume_recommendations_response.ExportEBSVolumeRecommendationsResponse = aws_sdk_compute_optimizer.types.export_ebs_volume_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.export_ebs_volume_recommendations_request.ExportEBSVolumeRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerService.ExportEBSVolumeRecommendations"
    import aws_sdk_compute_optimizer.types.export_ebs_volume_recommendations_request

    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.export_ebs_volume_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_export_ebs_volume_recommendations(
