"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetECSServiceRecommendations``."""
...
import aws_sdk_compute_optimizer.types.ecs_service_recommendations
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.get_ecs_service_recommendations_response.GetECSServiceRecommendationsResponse = aws_sdk_compute_optimizer.types.get_ecs_service_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.get_ecs_service_recommendations_request.GetECSServiceRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerService.GetECSServiceRecommendations"
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.get_ecs_service_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_ecs_service_recommendations(
