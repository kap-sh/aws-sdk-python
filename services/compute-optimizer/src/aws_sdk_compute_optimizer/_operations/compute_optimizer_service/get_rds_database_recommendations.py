...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.get_rds_database_recommendations_response.GetRDSDatabaseRecommendationsResponse = aws_sdk_compute_optimizer.types.get_rds_database_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.get_rds_database_recommendations_request.GetRDSDatabaseRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.get_rds_database_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
