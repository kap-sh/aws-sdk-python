...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.get_enrollment_status_response.GetEnrollmentStatusResponse = aws_sdk_compute_optimizer.types.get_enrollment_status_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.get_enrollment_status_request.GetEnrollmentStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
