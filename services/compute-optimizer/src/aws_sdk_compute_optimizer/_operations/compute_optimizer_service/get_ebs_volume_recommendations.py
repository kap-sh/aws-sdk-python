...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.get_ebs_volume_recommendations_response.GetEBSVolumeRecommendationsResponse = aws_sdk_compute_optimizer.types.get_ebs_volume_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.get_ebs_volume_recommendations_request.GetEBSVolumeRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.get_ebs_volume_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
