"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetRDSDatabaseRecommendationProjectedMetrics``."""
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.get_rds_database_recommendation_projected_metrics_response.GetRDSDatabaseRecommendationProjectedMetricsResponse = aws_sdk_compute_optimizer.types.get_rds_database_recommendation_projected_metrics_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.get_rds_database_recommendation_projected_metrics_request.GetRDSDatabaseRecommendationProjectedMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.get_rds_database_recommendation_projected_metrics_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_rds_database_recommendation_projected_metrics(
