"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetIdleRecommendations``."""
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.get_idle_recommendations_response.GetIdleRecommendationsResponse = aws_sdk_compute_optimizer.types.get_idle_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.get_idle_recommendations_request.GetIdleRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerService.GetIdleRecommendations"
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.get_idle_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_idle_recommendations(
