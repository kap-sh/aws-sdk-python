...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer.types.export_idle_recommendations_response.ExportIdleRecommendationsResponse = aws_sdk_compute_optimizer.types.export_idle_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer.types.export_idle_recommendations_request.ExportIdleRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer.types.export_idle_recommendations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
