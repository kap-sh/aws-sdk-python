...
class ComputeOptimizerError(Exception):
    """Base class for all ComputeOptimizer service errors."""


class ServiceError(ComputeOptimizerError):
...
class SerializationError(ComputeOptimizerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ComputeOptimizerError):
...
class WaiterFailedError(ComputeOptimizerError):
...
class WaiterTimeoutError(ComputeOptimizerError):
