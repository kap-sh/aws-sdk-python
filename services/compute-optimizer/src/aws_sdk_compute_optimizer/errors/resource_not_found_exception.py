"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.computeoptimizer#ResourceNotFoundException``."""
