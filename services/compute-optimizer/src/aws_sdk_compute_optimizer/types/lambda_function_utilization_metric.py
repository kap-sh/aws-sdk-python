...
if TYPE_CHECKING:
    import aws_sdk_compute_optimizer.types.lambda_function_metric_name
    import aws_sdk_compute_optimizer.types.lambda_function_metric_statistic
    import aws_sdk_compute_optimizer.types.metric_value


class LambdaFunctionUtilizationMetric(TypedDict):
    name: NotRequired[
        "aws_sdk_compute_optimizer.types.lambda_function_metric_name.LambdaFunctionMetricName"
    ]
    ...
    statistic: NotRequired[
        "aws_sdk_compute_optimizer.types.lambda_function_metric_statistic.LambdaFunctionMetricStatistic"
    ]
...
def serialize_aws_json_1_0(value: LambdaFunctionUtilizationMetric) -> dict:
    ...
    if "name" in value:
        ...
        out["name"] = (
            aws_sdk_compute_optimizer.types.lambda_function_metric_name.serialize_aws_json_1_0(
                value["name"]
            )
        )
    if "statistic" in value:
        ...
        out["statistic"] = (
            aws_sdk_compute_optimizer.types.lambda_function_metric_statistic.serialize_aws_json_1_0(
                value["statistic"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> LambdaFunctionUtilizationMetric:
    ...
    if "name" in data:
        ...
        out["name"] = (
            aws_sdk_compute_optimizer.types.lambda_function_metric_name.deserialize_aws_json_1_0(
                data["name"]
            )
        )
    if "statistic" in data:
        ...
        out["statistic"] = (
            aws_sdk_compute_optimizer.types.lambda_function_metric_statistic.deserialize_aws_json_1_0(
                data["statistic"]
            )
        )
    if "value" in data:
