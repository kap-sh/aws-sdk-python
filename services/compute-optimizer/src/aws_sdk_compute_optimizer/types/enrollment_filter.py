...
def serialize_aws_json_1_0(value: EnrollmentFilter) -> dict:
    ...
    if "name" in value:
        ...
        out["name"] = (
            aws_sdk_compute_optimizer.types.enrollment_filter_name.serialize_aws_json_1_0(
                value["name"]
            )
        )
    if "values" in value:
...
def deserialize_aws_json_1_0(data: dict) -> EnrollmentFilter:
    ...
    if "name" in data:
        ...
        out["name"] = (
            aws_sdk_compute_optimizer.types.enrollment_filter_name.deserialize_aws_json_1_0(
                data["name"]
            )
        )
    if "values" in data:
