...
if TYPE_CHECKING:
    ...
    import aws_sdk_compute_optimizer.types.low
    import aws_sdk_compute_optimizer.types.medium
...
class CurrentPerformanceRiskRatings(TypedDict):
    ...
    low: "aws_sdk_compute_optimizer.types.low.Low"
    """<p>A count of the applicable resource types with a low performance risk rating.</p>"""
    very_low: "aws_sdk_compute_optimizer.types.very_low.VeryLow"
