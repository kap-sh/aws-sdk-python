...
def serialize_aws_json_1_0(value: ExportRDSDatabaseRecommendationsRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            aws_sdk_compute_optimizer.types.rdsdb_recommendation_filters.serialize_aws_json_1_0(
                value["filters"]
            )
        )
    if "fields_to_export" in value:
        ...
        out["fieldsToExport"] = (
            aws_sdk_compute_optimizer.types.exportable_rdsdb_fields.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ExportRDSDatabaseRecommendationsRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            aws_sdk_compute_optimizer.types.rdsdb_recommendation_filters.deserialize_aws_json_1_0(
                data["filters"]
            )
        )
    if "fieldsToExport" in data:
        ...
        out["fields_to_export"] = (
            aws_sdk_compute_optimizer.types.exportable_rdsdb_fields.deserialize_aws_json_1_0(
                data["fieldsToExport"]
            )
        )
