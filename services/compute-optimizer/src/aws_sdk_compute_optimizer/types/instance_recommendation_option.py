...
if TYPE_CHECKING:
    ...
    import aws_sdk_compute_optimizer.types.instance_savings_opportunity_after_discounts
    ...
    import aws_sdk_compute_optimizer.types.platform_differences
...
class InstanceRecommendationOption(TypedDict):
    ...
    platform_differences: NotRequired[
        "aws_sdk_compute_optimizer.types.platform_differences.PlatformDifferences"
    ]
    ...
    savings_opportunity_after_discounts: NotRequired[
        "aws_sdk_compute_optimizer.types.instance_savings_opportunity_after_discounts.InstanceSavingsOpportunityAfterDiscounts"
    ]
...
def serialize_aws_json_1_0(value: InstanceRecommendationOption) -> dict:
    ...
    if "platform_differences" in value:
        ...
        out["platformDifferences"] = (
            aws_sdk_compute_optimizer.types.platform_differences.serialize_aws_json_1_0(
    ...
    if "savings_opportunity_after_discounts" in value:
        ...
        out["savingsOpportunityAfterDiscounts"] = (
            aws_sdk_compute_optimizer.types.instance_savings_opportunity_after_discounts.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> InstanceRecommendationOption:
    ...
    if "platformDifferences" in data:
        ...
        out["platform_differences"] = (
            aws_sdk_compute_optimizer.types.platform_differences.deserialize_aws_json_1_0(
    ...
    if "savingsOpportunityAfterDiscounts" in data:
        ...
        out["savings_opportunity_after_discounts"] = (
            aws_sdk_compute_optimizer.types.instance_savings_opportunity_after_discounts.deserialize_aws_json_1_0(
