...
if TYPE_CHECKING:
    ...
    import aws_sdk_compute_optimizer.types.rdsdb_metric_statistic


class RDSDBUtilizationMetric(TypedDict):
    name: NotRequired[
    ...
    statistic: NotRequired[
        "aws_sdk_compute_optimizer.types.rdsdb_metric_statistic.RDSDBMetricStatistic"
    ]
...
def serialize_aws_json_1_0(value: RDSDBUtilizationMetric) -> dict:
    ...
    if "statistic" in value:
        ...
        out["statistic"] = (
            aws_sdk_compute_optimizer.types.rdsdb_metric_statistic.serialize_aws_json_1_0(
                value["statistic"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> RDSDBUtilizationMetric:
    ...
    if "statistic" in data:
        ...
        out["statistic"] = (
            aws_sdk_compute_optimizer.types.rdsdb_metric_statistic.deserialize_aws_json_1_0(
                data["statistic"]
            )
        )
    if "value" in data:
