...
if TYPE_CHECKING:
    ...
    import aws_sdk_compute_optimizer.types.volume_baseline_iops
    import aws_sdk_compute_optimizer.types.volume_baseline_throughput
    import aws_sdk_compute_optimizer.types.volume_burst_iops
    import aws_sdk_compute_optimizer.types.volume_burst_throughput
    import aws_sdk_compute_optimizer.types.volume_size
...
class VolumeConfiguration(TypedDict, closed=True):
    ...
    volume_baseline_iops: (
        "aws_sdk_compute_optimizer.types.volume_baseline_iops.VolumeBaselineIOPS"
    )
    """<p>The baseline IOPS of the volume.</p>"""
    volume_burst_iops: (
        "aws_sdk_compute_optimizer.types.volume_burst_iops.VolumeBurstIOPS"
    )
    """<p>The burst IOPS of the volume.</p>"""
    volume_baseline_throughput: "aws_sdk_compute_optimizer.types.volume_baseline_throughput.VolumeBaselineThroughput"
    """<p>The baseline throughput of the volume.</p>"""
    volume_burst_throughput: (
        "aws_sdk_compute_optimizer.types.volume_burst_throughput.VolumeBurstThroughput"
    )
    """<p>The burst throughput of the volume.</p>"""
    root_volume: NotRequired["aws_sdk_compute_optimizer.types.root_volume.RootVolume"]
