...
if TYPE_CHECKING:
    import aws_sdk_compute_optimizer.types.ebs_savings_estimation_mode
    import aws_sdk_compute_optimizer.types.look_back_period_preference


class EBSEffectiveRecommendationPreferences(TypedDict):
    savings_estimation_mode: NotRequired[
        "aws_sdk_compute_optimizer.types.ebs_savings_estimation_mode.EBSSavingsEstimationMode"
    ]
...
def serialize_aws_json_1_0(value: EBSEffectiveRecommendationPreferences) -> dict:
    ...
    if "savings_estimation_mode" in value:
        ...
        out["savingsEstimationMode"] = (
            aws_sdk_compute_optimizer.types.ebs_savings_estimation_mode.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> EBSEffectiveRecommendationPreferences:
    ...
    if "savingsEstimationMode" in data:
        ...
        out["savings_estimation_mode"] = (
            aws_sdk_compute_optimizer.types.ebs_savings_estimation_mode.deserialize_aws_json_1_0(
