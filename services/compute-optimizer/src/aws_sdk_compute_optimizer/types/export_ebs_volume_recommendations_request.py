...
class ExportEBSVolumeRecommendationsRequest(TypedDict):
...
def serialize_aws_json_1_0(value: ExportEBSVolumeRecommendationsRequest) -> dict:
    ...
    if "fields_to_export" in value:
        ...
        out["fieldsToExport"] = (
            aws_sdk_compute_optimizer.types.exportable_volume_fields.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ExportEBSVolumeRecommendationsRequest:
    ...
    if "fieldsToExport" in data:
        ...
        out["fields_to_export"] = (
            aws_sdk_compute_optimizer.types.exportable_volume_fields.deserialize_aws_json_1_0(
                data["fieldsToExport"]
            )
        )
