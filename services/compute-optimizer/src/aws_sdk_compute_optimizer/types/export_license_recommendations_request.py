...
class ExportLicenseRecommendationsRequest(TypedDict):
    ...
    """<p>The format of the export file.</p> <p>A CSV file is the only export format currently supported.</p>"""
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ExportLicenseRecommendationsRequest) -> dict:
    out: dict = {}
    ...
    if "fields_to_export" in value:
        ...
        out["fieldsToExport"] = (
            aws_sdk_compute_optimizer.types.exportable_license_fields.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ExportLicenseRecommendationsRequest:
    out: ExportLicenseRecommendationsRequest = {}  # type: ignore[typeddict-item]
    ...
    if "fieldsToExport" in data:
        ...
        out["fields_to_export"] = (
            aws_sdk_compute_optimizer.types.exportable_license_fields.deserialize_aws_json_1_0(
                data["fieldsToExport"]
            )
        )
    if "s3DestinationConfig" in data:
        ...
        raise DeserializationError(
            "ExportLicenseRecommendationsRequest.s3_destination_config required"
        )
