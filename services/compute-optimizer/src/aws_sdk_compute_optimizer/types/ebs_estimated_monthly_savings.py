"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#EBSEstimatedMonthlySavings``."""
...
class EBSEstimatedMonthlySavings(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: EBSEstimatedMonthlySavings) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> EBSEstimatedMonthlySavings:
    out: EBSEstimatedMonthlySavings = {}  # type: ignore[typeddict-item]
    if "currency" in data:
        import aws_sdk_compute_optimizer.types.currency
