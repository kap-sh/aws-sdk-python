...
if TYPE_CHECKING:
    import aws_sdk_compute_optimizer.types.ecs_estimated_monthly_savings
    import aws_sdk_compute_optimizer.types.savings_opportunity_percentage


class ECSSavingsOpportunityAfterDiscounts(TypedDict):
    ...
    estimated_monthly_savings: NotRequired[
        "aws_sdk_compute_optimizer.types.ecs_estimated_monthly_savings.ECSEstimatedMonthlySavings"
    ]
...
def serialize_aws_json_1_0(value: ECSSavingsOpportunityAfterDiscounts) -> dict:
    ...
    if "estimated_monthly_savings" in value:
        ...
        out["estimatedMonthlySavings"] = (
            aws_sdk_compute_optimizer.types.ecs_estimated_monthly_savings.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ECSSavingsOpportunityAfterDiscounts:
    ...
    if "estimatedMonthlySavings" in data:
        ...
        out["estimated_monthly_savings"] = (
            aws_sdk_compute_optimizer.types.ecs_estimated_monthly_savings.deserialize_aws_json_1_0(
