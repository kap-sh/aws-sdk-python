...
class ExportAutoScalingGroupRecommendationsRequest(TypedDict):
...
def serialize_aws_json_1_0(value: ExportAutoScalingGroupRecommendationsRequest) -> dict:
    ...
    if "fields_to_export" in value:
        ...
        out["fieldsToExport"] = (
            aws_sdk_compute_optimizer.types.exportable_auto_scaling_group_fields.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(
    ...
    if "fieldsToExport" in data:
        ...
        out["fields_to_export"] = (
            aws_sdk_compute_optimizer.types.exportable_auto_scaling_group_fields.deserialize_aws_json_1_0(
                data["fieldsToExport"]
            )
        )
