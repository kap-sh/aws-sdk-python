...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ExportIdleRecommendationsResponse) -> dict:
    out: dict = {}
    if "job_id" in value:
...
def deserialize_aws_json_1_0(data: dict) -> ExportIdleRecommendationsResponse:
    out: ExportIdleRecommendationsResponse = {}  # type: ignore[typeddict-item]
    if "jobId" in data:
