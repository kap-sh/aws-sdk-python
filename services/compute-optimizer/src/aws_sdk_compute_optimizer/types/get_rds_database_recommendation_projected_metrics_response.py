...
def serialize_aws_json_1_0(
    ...
    if "recommended_option_projected_metrics" in value:
        ...
        out["recommendedOptionProjectedMetrics"] = (
            aws_sdk_compute_optimizer.types.rds_database_recommended_option_projected_metrics.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(
    ...
    if "recommendedOptionProjectedMetrics" in data:
        ...
        out["recommended_option_projected_metrics"] = (
            aws_sdk_compute_optimizer.types.rds_database_recommended_option_projected_metrics.deserialize_aws_json_1_0(
