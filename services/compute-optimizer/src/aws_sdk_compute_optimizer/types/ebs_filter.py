...
if TYPE_CHECKING:
    import aws_sdk_compute_optimizer.types.ebs_filter_name
    import aws_sdk_compute_optimizer.types.filter_values


class EBSFilter(TypedDict):
    name: NotRequired["aws_sdk_compute_optimizer.types.ebs_filter_name.EBSFilterName"]
...
def serialize_aws_json_1_0(value: EBSFilter) -> dict:
    ...
    if "name" in value:
        ...
        out["name"] = (
            aws_sdk_compute_optimizer.types.ebs_filter_name.serialize_aws_json_1_0(
                value["name"]
            )
        )
    if "values" in value:
...
def deserialize_aws_json_1_0(data: dict) -> EBSFilter:
    ...
    if "name" in data:
        ...
        out["name"] = (
            aws_sdk_compute_optimizer.types.ebs_filter_name.deserialize_aws_json_1_0(
                data["name"]
            )
        )
    if "values" in data:
