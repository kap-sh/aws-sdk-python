...
```
pip install aws-sdk-docdb-elastic
```

## Usage

```python
from aws_sdk_docdb_elastic import AsyncDocDBElasticClient
...
```python
from aws_sdk_docdb_elastic import AsyncDocDBElasticClient
from aws_sdk_docdb_elastic.error import AccessDeniedException
