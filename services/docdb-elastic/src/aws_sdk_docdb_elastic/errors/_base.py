...
class DocDBElasticError(Exception):
    """Base class for all DocDBElastic service errors."""


class ServiceError(DocDBElasticError):
...
class SerializationError(DocDBElasticError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DocDBElasticError):
...
class WaiterFailedError(DocDBElasticError):
...
class WaiterTimeoutError(DocDBElasticError):
