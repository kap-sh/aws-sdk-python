"""Generated from Smithy shape ``com.amazonaws.docdbelastic#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdbelastic#InternalServerException``."""
