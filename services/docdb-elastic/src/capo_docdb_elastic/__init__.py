...
from ._services.async_doc_db_elastic import (
    AsyncDocDBElasticClient as AsyncDocDBElasticClient,
)
from ._services.doc_db_elastic import DocDBElasticClient as DocDBElasticClient
