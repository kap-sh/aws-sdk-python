...
from capo_groundstation._resources.ground_station.agent import Agent
from capo_groundstation._resources.ground_station.config import Config
from capo_groundstation._resources.ground_station.contact import Contact
...
from capo_groundstation._resources.ground_station.ephemeris import Ephemeris
from capo_groundstation._resources.ground_station.ground_station_resource import (
    GroundStationResource,
)
from capo_groundstation._resources.ground_station.mission_profile import MissionProfile
from capo_groundstation._resources.ground_station.satellite import Satellite
from capo_groundstation._services._aws_config import aws_config
...
class GroundStationClientConfig(TypedDict, total=False, closed=True):
...
class GroundStationClient:
    ...
    def get_agent_task_response_url(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_groundstation.types.get_agent_task_response_url_request.GetAgentTaskResponseUrlRequest]",
        ) -> OperationResponse[
            "capo_groundstation.types.get_agent_task_response_url_response.GetAgentTaskResponseUrlResponse"
        ]:
            ...
            output, http_response = (
                capo_groundstation._operations.ground_station.get_agent_task_response_url.get_agent_task_response_url(
        ...
        input_: capo_groundstation.types.get_agent_task_response_url_request.GetAgentTaskResponseUrlRequest = {}  # type: ignore[typeddict-item]
    ...
    def get_minute_usage(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_groundstation.types.get_minute_usage_request.GetMinuteUsageRequest]",
        ) -> OperationResponse[
            "capo_groundstation.types.get_minute_usage_response.GetMinuteUsageResponse"
        ]:
            ...
            output, http_response = (
                capo_groundstation._operations.ground_station.get_minute_usage.get_minute_usage(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_groundstation.types.get_minute_usage_request.GetMinuteUsageRequest = {}  # type: ignore[typeddict-item]
        input_["month"] = month
        input_["year"] = year
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_groundstation.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_groundstation.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_groundstation._operations.ground_station.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_groundstation.types.list_tags_for_resource_request.ListTagsForResourceRequest = {}  # type: ignore[typeddict-item]
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_groundstation.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_groundstation.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_groundstation._operations.ground_station.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_groundstation.types.tag_resource_request.TagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        input_["tags"] = tags
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_groundstation.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_groundstation.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_groundstation._operations.ground_station.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_groundstation.types.untag_resource_request.UntagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
