...
def handle_response(
    ...
    out: capo_groundstation.types.dataflow_endpoint_group_id_response.DataflowEndpointGroupIdResponse = capo_groundstation.types.dataflow_endpoint_group_id_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_groundstation.types.create_dataflow_endpoint_group_request.serialize_json(
            input_
        )
    ).encode()
