...
import capo_groundstation.errors.resource_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceLimitExceededException":
            raise capo_groundstation.errors.resource_limit_exceeded_exception.ResourceLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_groundstation.types.contact_id_response.ContactIdResponse = (
        capo_groundstation.types.contact_id_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_groundstation.types.reserve_contact_request.serialize_json(input_)
    ).encode()
...
def reserve_contact(
    ...
    capo_groundstation.types.contact_id_response.ContactIdResponse, zapros.Response
]:
