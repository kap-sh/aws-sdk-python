"""Generated from Smithy shape ``com.amazonaws.groundstation#ListAntennas``."""
...
import capo_groundstation.types.antenna_list
...
def handle_response(
    ...
    out: capo_groundstation.types.list_antennas_response.ListAntennasResponse = (
        capo_groundstation.types.list_antennas_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/groundstation/{groundStationId}/antenna"
    url = url.replace(
