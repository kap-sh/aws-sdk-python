"""Generated from Smithy shape ``com.amazonaws.groundstation#CreateConfig``."""
...
def handle_response(
    ...
    out: capo_groundstation.types.config_id_response.ConfigIdResponse = (
        capo_groundstation.types.config_id_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_groundstation.types.create_config_request.serialize_json(input_)
    ).encode()
...
def create_config(
    ...
    capo_groundstation.types.config_id_response.ConfigIdResponse, zapros.Response
]:
