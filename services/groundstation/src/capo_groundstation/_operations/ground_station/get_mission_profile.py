"""Generated from Smithy shape ``com.amazonaws.groundstation#GetMissionProfile``."""
...
def handle_response(
    ...
    out: capo_groundstation.types.get_mission_profile_response.GetMissionProfileResponse = capo_groundstation.types.get_mission_profile_response.deserialize_json(
...
async def async_get_mission_profile(
