...
import capo_groundstation.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise capo_groundstation.errors.resource_in_use_exception.ResourceInUseException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_groundstation.types.ephemeris_id_response.EphemerisIdResponse = (
        capo_groundstation.types.ephemeris_id_response.deserialize_json(
...
def delete_ephemeris(
    ...
    capo_groundstation.types.ephemeris_id_response.EphemerisIdResponse, zapros.Response
]:
