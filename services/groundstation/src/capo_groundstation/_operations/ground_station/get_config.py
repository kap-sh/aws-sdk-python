"""Generated from Smithy shape ``com.amazonaws.groundstation#GetConfig``."""
...
def handle_response(
    ...
    out: capo_groundstation.types.get_config_response.GetConfigResponse = (
        capo_groundstation.types.get_config_response.deserialize_json(
...
def get_config(
    ...
    capo_groundstation.types.get_config_response.GetConfigResponse, zapros.Response
]:
