"""Generated from Smithy shape ``com.amazonaws.groundstation#GetDataflowEndpointGroup``."""
...
def handle_response(
    ...
    out: capo_groundstation.types.get_dataflow_endpoint_group_response.GetDataflowEndpointGroupResponse = capo_groundstation.types.get_dataflow_endpoint_group_response.deserialize_json(
...
async def async_get_dataflow_endpoint_group(
