...
def handle_response(
    ...
    out: capo_groundstation.types.list_ephemerides_response.ListEphemeridesResponse = (
        capo_groundstation.types.list_ephemerides_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_groundstation.types.list_ephemerides_request.serialize_json(input_)
    ).encode()
