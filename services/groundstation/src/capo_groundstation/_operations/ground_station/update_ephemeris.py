"""Generated from Smithy shape ``com.amazonaws.groundstation#UpdateEphemeris``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_groundstation.types.update_ephemeris_request.serialize_json(input_)
    ).encode()
...
async def async_update_ephemeris(
