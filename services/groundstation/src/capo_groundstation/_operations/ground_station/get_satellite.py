"""Generated from Smithy shape ``com.amazonaws.groundstation#GetSatellite``."""
...
def handle_response(
    ...
    out: capo_groundstation.types.get_satellite_response.GetSatelliteResponse = (
        capo_groundstation.types.get_satellite_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/satellite/{satelliteId}"
    url = url.replace("{satelliteId}", quote(str(input_["satellite_id"]), safe=""))
    params: dict[str, str] = {}
