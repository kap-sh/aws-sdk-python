...
class GroundStationError(Exception):
    """Base class for all GroundStation service errors."""


class ServiceError(GroundStationError):
...
class SerializationError(GroundStationError):
    """Raised when a value cannot be serialized."""


class DeserializationError(GroundStationError):
...
class WaiterFailedError(GroundStationError):
...
class WaiterTimeoutError(GroundStationError):
