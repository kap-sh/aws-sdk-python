...
class AgentDetails(TypedDict, closed=True):
    ...
    reserved_cpu_cores: NotRequired[
        "aws_sdk_groundstation.types.agent_cpu_cores_list.AgentCpuCoresList"
    ]
    ...
    component_versions: (
        "aws_sdk_groundstation.types.component_version_list.ComponentVersionList"
    )
...
def serialize_json(value: AgentDetails) -> dict:
    ...
    if "reserved_cpu_cores" in value:
        ...
        out["reservedCpuCores"] = (
            aws_sdk_groundstation.types.agent_cpu_cores_list.serialize_json(
    ...
    out["componentVersions"] = (
        aws_sdk_groundstation.types.component_version_list.serialize_json(
...
def deserialize_json(data: dict) -> AgentDetails:
    ...
    if "reservedCpuCores" in data:
        ...
        out["reserved_cpu_cores"] = (
            aws_sdk_groundstation.types.agent_cpu_cores_list.deserialize_json(
    ...
    if "componentVersions" in data:
        ...
        out["component_versions"] = (
            aws_sdk_groundstation.types.component_version_list.deserialize_json(
