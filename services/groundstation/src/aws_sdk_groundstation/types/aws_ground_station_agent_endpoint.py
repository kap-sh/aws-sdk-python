...
class AwsGroundStationAgentEndpoint(TypedDict):
    ...
    ingress_address: "aws_sdk_groundstation.types.ranged_connection_details.RangedConnectionDetails"
...
def serialize_json(value: AwsGroundStationAgentEndpoint) -> dict:
    ...
    out["name"] = value["name"]
    import aws_sdk_groundstation.types.connection_details
    out["egressAddress"] = aws_sdk_groundstation.types.connection_details.serialize_json(value["egress_address"])
    import aws_sdk_groundstation.types.ranged_connection_details
    out["ingressAddress"] = aws_sdk_groundstation.types.ranged_connection_details.serialize_json(value["ingress_address"])
    if "agent_status" in value:
        import aws_sdk_groundstation.types.agent_status
        out["agentStatus"] = aws_sdk_groundstation.types.agent_status.serialize_json(value["agent_status"])
    if "audit_results" in value:
        import aws_sdk_groundstation.types.audit_results
        out["auditResults"] = aws_sdk_groundstation.types.audit_results.serialize_json(value["audit_results"])
    return out
...
def deserialize_json(data: dict) -> AwsGroundStationAgentEndpoint:
    ...
    if "egressAddress" in data:
        import aws_sdk_groundstation.types.connection_details
        out["egress_address"] = aws_sdk_groundstation.types.connection_details.deserialize_json(data["egressAddress"])
    else:
        raise DeserializationError("AwsGroundStationAgentEndpoint.egress_address required")
    if "ingressAddress" in data:
        import aws_sdk_groundstation.types.ranged_connection_details
        out["ingress_address"] = aws_sdk_groundstation.types.ranged_connection_details.deserialize_json(data["ingressAddress"])
    else:
        raise DeserializationError("AwsGroundStationAgentEndpoint.ingress_address required")
    if "agentStatus" in data:
        import aws_sdk_groundstation.types.agent_status
        out["agent_status"] = aws_sdk_groundstation.types.agent_status.deserialize_json(data["agentStatus"])
    if "auditResults" in data:
        import aws_sdk_groundstation.types.audit_results
        out["audit_results"] = aws_sdk_groundstation.types.audit_results.deserialize_json(data["auditResults"])
    return out