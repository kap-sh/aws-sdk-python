...
if TYPE_CHECKING:
    ...
    import aws_sdk_groundstation.types.tle_data_list


class TLEEphemeris(TypedDict):
    ...
    tle_data: NotRequired["aws_sdk_groundstation.types.tle_data_list.TLEDataList"]
...
def serialize_json(value: TLEEphemeris) -> dict:
    ...
    if "tle_data" in value:
        ...
        out["tleData"] = aws_sdk_groundstation.types.tle_data_list.serialize_json(
            value["tle_data"]
        )
    return out
...
def deserialize_json(data: dict) -> TLEEphemeris:
    ...
    if "tleData" in data:
        ...
        out["tle_data"] = aws_sdk_groundstation.types.tle_data_list.deserialize_json(
            data["tleData"]
        )
    return out
