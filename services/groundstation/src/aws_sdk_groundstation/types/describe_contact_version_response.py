"""Generated from Smithy shape ``com.amazonaws.groundstation#DescribeContactVersionResponse``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_groundstation.types.dataflow_list
...
class DescribeContactVersionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeContactVersionResponse) -> dict:
    out: dict = {}
    ...
    if "dataflow_list" in value:
        ...
        out["dataflowList"] = aws_sdk_groundstation.types.dataflow_list.serialize_json(
            value["dataflow_list"]
        )
...
def deserialize_json(data: dict) -> DescribeContactVersionResponse:
    ...
    if "dataflowList" in data:
        ...
        out["dataflow_list"] = (
            aws_sdk_groundstation.types.dataflow_list.deserialize_json(
                data["dataflowList"]
            )
        )
