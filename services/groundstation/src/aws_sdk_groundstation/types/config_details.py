...
if TYPE_CHECKING:
    import aws_sdk_groundstation.types.antenna_demod_decode_details
...
def serialize_json(value: ConfigDetails) -> dict:
    if "endpointDetails" in value:
        ...
        return {
            "endpointDetails": aws_sdk_groundstation.types.endpoint_details.serialize_json(
        ...
        return {
            "antennaDemodDecodeDetails": aws_sdk_groundstation.types.antenna_demod_decode_details.serialize_json(
        ...
        return {
            "s3RecordingDetails": aws_sdk_groundstation.types.s3_recording_details.serialize_json(
...
def deserialize_json(data: dict) -> ConfigDetails:
    if "endpointDetails" in data:
        ...
        return {
            "endpointDetails": aws_sdk_groundstation.types.endpoint_details.deserialize_json(
        ...
        return {
            "antennaDemodDecodeDetails": aws_sdk_groundstation.types.antenna_demod_decode_details.deserialize_json(
        ...
        return {
            "s3RecordingDetails": aws_sdk_groundstation.types.s3_recording_details.deserialize_json(
