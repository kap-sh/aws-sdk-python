...
class AntennaDownlinkDemodDecodeConfig(TypedDict):
    ...
    demodulation_config: "aws_sdk_groundstation.types.demodulation_config.DemodulationConfig"
...
def serialize_json(value: AntennaDownlinkDemodDecodeConfig) -> dict:
    ...
    import aws_sdk_groundstation.types.demodulation_config
    out["demodulationConfig"] = aws_sdk_groundstation.types.demodulation_config.serialize_json(value["demodulation_config"])
    import aws_sdk_groundstation.types.decode_config
    out["decodeConfig"] = aws_sdk_groundstation.types.decode_config.serialize_json(value["decode_config"])
    return out
...
def deserialize_json(data: dict) -> AntennaDownlinkDemodDecodeConfig:
    ...
    if "spectrumConfig" in data:
        ...
        raise DeserializationError("AntennaDownlinkDemodDecodeConfig.spectrum_config required")
    if "demodulationConfig" in data:
        import aws_sdk_groundstation.types.demodulation_config
        out["demodulation_config"] = aws_sdk_groundstation.types.demodulation_config.deserialize_json(data["demodulationConfig"])
    else:
        raise DeserializationError("AntennaDownlinkDemodDecodeConfig.demodulation_config required")
    if "decodeConfig" in data:
        import aws_sdk_groundstation.types.decode_config
        out["decode_config"] = aws_sdk_groundstation.types.decode_config.deserialize_json(data["decodeConfig"])
    else:
        raise DeserializationError("AntennaDownlinkDemodDecodeConfig.decode_config required")
    return out