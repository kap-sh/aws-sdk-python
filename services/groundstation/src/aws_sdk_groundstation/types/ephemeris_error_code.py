"""Generated from Smithy shape ``com.amazonaws.groundstation#EphemerisErrorCode``."""

from typing import Literal, TypeAlias, cast

from aws_sdk_groundstation.errors import DeserializationError

EphemerisErrorCode: TypeAlias = Literal[
    "INTERNAL_ERROR",
...
def serialize_json(value: EphemerisErrorCode) -> str:
    return value


def deserialize_json(data: str) -> EphemerisErrorCode:
    if data not in _VALUES:
        raise DeserializationError(f"unknown EphemerisErrorCode value: {data!r}")
    return cast(EphemerisErrorCode, data)
