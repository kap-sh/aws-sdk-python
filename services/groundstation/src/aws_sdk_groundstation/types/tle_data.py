...
if TYPE_CHECKING:
    import aws_sdk_groundstation.types.time_range
    import aws_sdk_groundstation.types.tle_line_one
...
class TLEData(TypedDict):
    ...
    valid_time_range: "aws_sdk_groundstation.types.time_range.TimeRange"
...
def serialize_json(value: TLEData) -> dict:
    ...
    out["validTimeRange"] = aws_sdk_groundstation.types.time_range.serialize_json(
...
def deserialize_json(data: dict) -> TLEData:
    ...
    if "validTimeRange" in data:
        ...
        out["valid_time_range"] = (
            aws_sdk_groundstation.types.time_range.deserialize_json(
                data["validTimeRange"]
            )
        )
    else:
