...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_groundstation.errors.service_quota_exceeded_exception

            raise aws_sdk_groundstation.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.create_dataflow_endpoint_group_v2_response.CreateDataflowEndpointGroupV2Response = aws_sdk_groundstation.types.create_dataflow_endpoint_group_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.create_dataflow_endpoint_group_v2_request.CreateDataflowEndpointGroupV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.create_dataflow_endpoint_group_v2_request.serialize_json(
            input_
        )
    ).encode()
