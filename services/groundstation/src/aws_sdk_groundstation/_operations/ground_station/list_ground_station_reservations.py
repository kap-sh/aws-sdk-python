"""Generated from Smithy shape ``com.amazonaws.groundstation#ListGroundStationReservations``."""
...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.list_ground_station_reservations_response.ListGroundStationReservationsResponse = aws_sdk_groundstation.types.list_ground_station_reservations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.list_ground_station_reservations_request.ListGroundStationReservationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/groundstation/{groundStationId}/reservation"
    url = url.replace(
        "{groundStationId}", quote(str(input_["ground_station_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    if "reservation_types" in input_:
        params["reservationTypes"] = str(input_["reservation_types"])
...
async def async_list_ground_station_reservations(
