...
def build_request(
    ...
    input: aws_sdk_groundstation.types.list_ground_station_reservations_request.ListGroundStationReservationsRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{groundStationId}", quote(str(input["ground_station_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    if "reservation_types" in input:
        params["reservationTypes"] = str(input["reservation_types"])
