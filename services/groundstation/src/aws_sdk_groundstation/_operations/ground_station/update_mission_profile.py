"""Generated from Smithy shape ``com.amazonaws.groundstation#UpdateMissionProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.mission_profile_id_response.MissionProfileIdResponse = aws_sdk_groundstation.types.mission_profile_id_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_groundstation.types.update_mission_profile_request.UpdateMissionProfileRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/missionprofile/{missionProfileId}"
    url = url.replace(
        "{missionProfileId}", quote(str(input["mission_profile_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.update_mission_profile_request.serialize_json(input)
    ).encode()
...
async def async_update_mission_profile(
