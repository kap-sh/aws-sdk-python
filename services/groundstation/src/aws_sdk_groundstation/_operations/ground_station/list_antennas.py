...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.list_antennas_response.ListAntennasResponse = (
        aws_sdk_groundstation.types.list_antennas_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.list_antennas_request.ListAntennasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
