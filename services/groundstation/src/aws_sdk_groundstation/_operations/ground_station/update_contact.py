"""Generated from Smithy shape ``com.amazonaws.groundstation#UpdateContact``."""
...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.update_contact_response.UpdateContactResponse = (
        aws_sdk_groundstation.types.update_contact_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_groundstation.types.update_contact_request.UpdateContactRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/contact/{contactId}/versions"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.update_contact_request.serialize_json(input)
    ).encode()
