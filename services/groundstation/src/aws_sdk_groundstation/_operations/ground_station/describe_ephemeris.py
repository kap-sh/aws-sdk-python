...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.describe_ephemeris_response.DescribeEphemerisResponse = aws_sdk_groundstation.types.describe_ephemeris_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.describe_ephemeris_request.DescribeEphemerisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
