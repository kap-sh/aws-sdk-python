"""Generated from Smithy shape ``com.amazonaws.groundstation#CreateDataflowEndpointGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.dataflow_endpoint_group_id_response.DataflowEndpointGroupIdResponse = aws_sdk_groundstation.types.dataflow_endpoint_group_id_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.create_dataflow_endpoint_group_request.CreateDataflowEndpointGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/dataflowEndpointGroup"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_groundstation.types.create_dataflow_endpoint_group_request

    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.create_dataflow_endpoint_group_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_dataflow_endpoint_group(
