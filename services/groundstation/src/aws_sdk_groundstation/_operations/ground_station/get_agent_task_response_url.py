"""Generated from Smithy shape ``com.amazonaws.groundstation#GetAgentTaskResponseUrl``."""
...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.get_agent_task_response_url_response.GetAgentTaskResponseUrlResponse = aws_sdk_groundstation.types.get_agent_task_response_url_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_groundstation.types.get_agent_task_response_url_request.GetAgentTaskResponseUrlRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/agentResponseUrl/{agentId}/{taskId}"
...
async def async_get_agent_task_response_url(
