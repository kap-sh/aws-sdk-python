...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.list_dataflow_endpoint_groups_response.ListDataflowEndpointGroupsResponse = aws_sdk_groundstation.types.list_dataflow_endpoint_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.list_dataflow_endpoint_groups_request.ListDataflowEndpointGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
