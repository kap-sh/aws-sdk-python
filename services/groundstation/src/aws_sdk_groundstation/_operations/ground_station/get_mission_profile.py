...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.get_mission_profile_response.GetMissionProfileResponse = aws_sdk_groundstation.types.get_mission_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.get_mission_profile_request.GetMissionProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
