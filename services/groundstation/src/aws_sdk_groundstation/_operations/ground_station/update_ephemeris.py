...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.update_ephemeris_request.UpdateEphemerisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.update_ephemeris_request.serialize_json(input_)
    ).encode()
