...
def build_request(
    ...
    input: aws_sdk_groundstation.types.update_ephemeris_request.UpdateEphemerisRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.update_ephemeris_request.serialize_json(input)
    ).encode()
