...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.get_dataflow_endpoint_group_response.GetDataflowEndpointGroupResponse = aws_sdk_groundstation.types.get_dataflow_endpoint_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.get_dataflow_endpoint_group_request.GetDataflowEndpointGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
