...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.list_satellites_response.ListSatellitesResponse = (
        aws_sdk_groundstation.types.list_satellites_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.list_satellites_request.ListSatellitesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
