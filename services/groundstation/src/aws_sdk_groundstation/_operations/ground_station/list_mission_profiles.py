"""Generated from Smithy shape ``com.amazonaws.groundstation#ListMissionProfiles``."""
...
import aws_sdk_groundstation.types.mission_profile_list
...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.list_mission_profiles_response.ListMissionProfilesResponse = aws_sdk_groundstation.types.list_mission_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.list_mission_profiles_request.ListMissionProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/missionprofile"
    params: dict[str, str] = {}
...
async def async_list_mission_profiles(
