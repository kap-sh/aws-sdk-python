...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.list_configs_response.ListConfigsResponse = (
        aws_sdk_groundstation.types.list_configs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.list_configs_request.ListConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
