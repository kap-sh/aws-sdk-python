...
def build_request(
    ...
    input: aws_sdk_groundstation.types.create_ephemeris_request.CreateEphemerisRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.create_ephemeris_request.serialize_json(input)
    ).encode()
