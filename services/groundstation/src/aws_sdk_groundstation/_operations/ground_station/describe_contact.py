...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.describe_contact_response.DescribeContactResponse = aws_sdk_groundstation.types.describe_contact_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.describe_contact_request.DescribeContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
