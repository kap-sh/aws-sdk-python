"""Generated from Smithy shape ``com.amazonaws.groundstation#ListGroundStations``."""
...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.list_ground_stations_response.ListGroundStationsResponse = aws_sdk_groundstation.types.list_ground_stations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.list_ground_stations_request.ListGroundStationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/groundstation"
    params: dict[str, str] = {}
    if "satellite_id" in input_:
        params["satelliteId"] = str(input_["satellite_id"])
...
async def async_list_ground_stations(
