...
def build_request(
    ...
    input: aws_sdk_groundstation.types.list_ground_stations_request.ListGroundStationsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "satellite_id" in input:
        params["satelliteId"] = str(input["satellite_id"])
