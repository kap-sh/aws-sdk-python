...
def build_request(
    ...
    input: aws_sdk_groundstation.types.delete_dataflow_endpoint_group_request.DeleteDataflowEndpointGroupRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["dataflow_endpoint_group_id"]), safe=""),
    )
    params: dict[str, str] = {}
