...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.list_contact_versions_response.ListContactVersionsResponse = aws_sdk_groundstation.types.list_contact_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.list_contact_versions_request.ListContactVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
