...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.get_config_response.GetConfigResponse = (
        aws_sdk_groundstation.types.get_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.get_config_request.GetConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_config(
    ...
    aws_sdk_groundstation.types.get_config_response.GetConfigResponse, zapros.Response
]:
