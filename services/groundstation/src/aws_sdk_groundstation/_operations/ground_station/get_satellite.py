...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.get_satellite_response.GetSatelliteResponse = (
        aws_sdk_groundstation.types.get_satellite_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_groundstation.types.get_satellite_request.GetSatelliteRequest,
) -> zapros.Request:
    ...
    url = url.replace("{satelliteId}", quote(str(input["satellite_id"]), safe=""))
    params: dict[str, str] = {}
