"""Generated from Smithy shape ``com.amazonaws.groundstation#DeleteEphemeris``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            import aws_sdk_groundstation.errors.resource_in_use_exception

            raise aws_sdk_groundstation.errors.resource_in_use_exception.ResourceInUseException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.ephemeris_id_response.EphemerisIdResponse = (
        aws_sdk_groundstation.types.ephemeris_id_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.delete_ephemeris_request.DeleteEphemerisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ephemeris/{ephemerisId}"
    url = url.replace("{ephemerisId}", quote(str(input_["ephemeris_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_delete_ephemeris(
