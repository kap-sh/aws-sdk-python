...
def build_request(
    ...
    input: aws_sdk_groundstation.types.list_ephemerides_request.ListEphemeridesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.list_ephemerides_request.serialize_json(input)
    ).encode()
