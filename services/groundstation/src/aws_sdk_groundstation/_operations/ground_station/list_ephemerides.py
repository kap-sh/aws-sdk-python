"""Generated from Smithy shape ``com.amazonaws.groundstation#ListEphemerides``."""
...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.list_ephemerides_response.ListEphemeridesResponse = aws_sdk_groundstation.types.list_ephemerides_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.list_ephemerides_request.ListEphemeridesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ephemerides"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.list_ephemerides_request.serialize_json(input_)
    ).encode()
...
async def async_list_ephemerides(
