"""Generated from Smithy shape ``com.amazonaws.groundstation#ReserveContact``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceLimitExceededException":
            import aws_sdk_groundstation.errors.resource_limit_exceeded_exception

            raise aws_sdk_groundstation.errors.resource_limit_exceeded_exception.ResourceLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.contact_id_response.ContactIdResponse = (
        aws_sdk_groundstation.types.contact_id_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.reserve_contact_request.ReserveContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/contact"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_groundstation.types.reserve_contact_request

    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.reserve_contact_request.serialize_json(input_)
    ).encode()
...
def reserve_contact(
    ...
    aws_sdk_groundstation.types.contact_id_response.ContactIdResponse, zapros.Response
]:
...
async def async_reserve_contact(
