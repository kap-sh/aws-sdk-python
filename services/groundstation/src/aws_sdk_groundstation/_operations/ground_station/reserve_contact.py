...
def build_request(
    ...
    input: aws_sdk_groundstation.types.reserve_contact_request.ReserveContactRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.reserve_contact_request.serialize_json(input)
    ).encode()
