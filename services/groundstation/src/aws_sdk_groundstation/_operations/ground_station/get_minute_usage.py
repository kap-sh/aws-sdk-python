...
def build_request(
    ...
    input: aws_sdk_groundstation.types.get_minute_usage_request.GetMinuteUsageRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.get_minute_usage_request.serialize_json(input)
    ).encode()
