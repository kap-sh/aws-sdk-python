"""Generated from Smithy shape ``com.amazonaws.groundstation#GetMinuteUsage``."""
...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.get_minute_usage_response.GetMinuteUsageResponse = aws_sdk_groundstation.types.get_minute_usage_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.get_minute_usage_request.GetMinuteUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/minute-usage"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_groundstation.types.get_minute_usage_request

    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.get_minute_usage_request.serialize_json(input_)
    ).encode()
...
async def async_get_minute_usage(
