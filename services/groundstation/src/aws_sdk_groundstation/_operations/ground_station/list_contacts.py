...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.list_contacts_response.ListContactsResponse = (
        aws_sdk_groundstation.types.list_contacts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.list_contacts_request.ListContactsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.list_contacts_request.serialize_json(input_)
    ).encode()
