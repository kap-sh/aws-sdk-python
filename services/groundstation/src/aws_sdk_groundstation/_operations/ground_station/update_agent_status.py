...
def build_request(
    ...
    input: aws_sdk_groundstation.types.update_agent_status_request.UpdateAgentStatusRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.update_agent_status_request.serialize_json(input)
    ).encode()
