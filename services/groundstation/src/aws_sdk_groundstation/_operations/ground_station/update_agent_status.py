...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.update_agent_status_response.UpdateAgentStatusResponse = aws_sdk_groundstation.types.update_agent_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.update_agent_status_request.UpdateAgentStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.update_agent_status_request.serialize_json(input_)
    ).encode()
