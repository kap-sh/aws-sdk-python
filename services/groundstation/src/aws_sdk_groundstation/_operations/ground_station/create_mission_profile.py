...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.create_mission_profile_request.CreateMissionProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.create_mission_profile_request.serialize_json(
            input_
        )
    ).encode()
