...
def build_request(
    ...
    input: aws_sdk_groundstation.types.create_mission_profile_request.CreateMissionProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_groundstation.types.create_mission_profile_request.serialize_json(input)
    ).encode()
