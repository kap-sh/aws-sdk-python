...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.describe_contact_version_response.DescribeContactVersionResponse = aws_sdk_groundstation.types.describe_contact_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.describe_contact_version_request.DescribeContactVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
