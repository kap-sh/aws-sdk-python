...
def handle_response(
    ...
    out: aws_sdk_groundstation.types.get_agent_configuration_response.GetAgentConfigurationResponse = aws_sdk_groundstation.types.get_agent_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_groundstation.types.get_agent_configuration_request.GetAgentConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
