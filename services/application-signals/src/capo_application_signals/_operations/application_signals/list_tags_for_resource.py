"""Generated from Smithy shape ``com.amazonaws.applicationsignals#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_application_signals.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_application_signals.types.list_tags_for_resource_response.deserialize_json(
