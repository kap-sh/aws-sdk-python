"""Generated from Smithy shape ``com.amazonaws.applicationsignals#ListServiceLevelObjectiveExclusionWindows``."""
...
def handle_response(
    ...
    out: capo_application_signals.types.list_service_level_objective_exclusion_windows_output.ListServiceLevelObjectiveExclusionWindowsOutput = capo_application_signals.types.list_service_level_objective_exclusion_windows_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/slo/{Id}/exclusion-windows"
...
async def async_list_service_level_objective_exclusion_windows(
