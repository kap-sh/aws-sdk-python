...
def handle_response(
    ...
    out: capo_application_signals.types.list_service_operations_output.ListServiceOperationsOutput = capo_application_signals.types.list_service_operations_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_signals.types.list_service_operations_input.serialize_json(
            input_
        )
    ).encode()
