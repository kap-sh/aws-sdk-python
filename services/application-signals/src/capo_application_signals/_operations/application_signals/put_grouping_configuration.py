...
def handle_response(
    ...
    out: capo_application_signals.types.put_grouping_configuration_output.PutGroupingConfigurationOutput = capo_application_signals.types.put_grouping_configuration_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_signals.types.put_grouping_configuration_input.serialize_json(
            input_
        )
    ).encode()
