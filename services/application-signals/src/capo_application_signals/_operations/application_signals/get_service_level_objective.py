"""Generated from Smithy shape ``com.amazonaws.applicationsignals#GetServiceLevelObjective``."""
...
def handle_response(
    ...
    out: capo_application_signals.types.get_service_level_objective_output.GetServiceLevelObjectiveOutput = capo_application_signals.types.get_service_level_objective_output.deserialize_json(
...
async def async_get_service_level_objective(
