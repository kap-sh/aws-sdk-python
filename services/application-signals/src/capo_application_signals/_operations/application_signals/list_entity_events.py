...
def handle_response(
    ...
    out: capo_application_signals.types.list_entity_events_output.ListEntityEventsOutput = capo_application_signals.types.list_entity_events_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_signals.types.list_entity_events_input.serialize_json(input_)
    ).encode()
