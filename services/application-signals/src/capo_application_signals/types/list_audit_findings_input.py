...
class ListAuditFindingsInput(TypedDict, closed=True):
    ...
    auditors: NotRequired["capo_application_signals.types.auditors.Auditors"]
    ...
    detail_level: NotRequired["capo_application_signals.types.detail_level.DetailLevel"]
...
def serialize_json(value: ListAuditFindingsInput) -> dict:
    ...
    if "auditors" in value:
        ...
        out["Auditors"] = capo_application_signals.types.auditors.serialize_json(
            value["auditors"]
        )
    import capo_application_signals.types.audit_targets

    out["AuditTargets"] = capo_application_signals.types.audit_targets.serialize_json(
        value["audit_targets"]
    )
    if "detail_level" in value:
        import capo_application_signals.types.detail_level

        out["DetailLevel"] = capo_application_signals.types.detail_level.serialize_json(
            value["detail_level"]
        )
...
def deserialize_json(data: dict) -> ListAuditFindingsInput:
    ...
    if "AuditTargets" in data:
        ...
        out["audit_targets"] = (
            capo_application_signals.types.audit_targets.deserialize_json(
                data["AuditTargets"]
            )
        )
    else:
    ...
    if "DetailLevel" in data:
        ...
        out["detail_level"] = (
            capo_application_signals.types.detail_level.deserialize_json(
                data["DetailLevel"]
            )
        )
