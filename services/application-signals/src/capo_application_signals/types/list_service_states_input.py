...
class ListServiceStatesInput(TypedDict, closed=True):
    ...
    max_results: "capo_application_signals.types.list_service_states_max_results.ListServiceStatesMaxResults"
