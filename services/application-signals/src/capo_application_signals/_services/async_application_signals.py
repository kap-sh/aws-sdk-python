...
from capo_application_signals._services._aws_config import aaws_config
...
class AsyncApplicationSignalsClient:
    ...
    def __init__(
        ...
        self._config = AsyncApplicationSignalsClientConfig(
            {
    ...
    async def batch_get_service_level_objective_budget_report(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.batch_get_service_level_objective_budget_report_input.BatchGetServiceLevelObjectiveBudgetReportInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.batch_get_service_level_objective_budget_report_output.BatchGetServiceLevelObjectiveBudgetReportOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.batch_get_service_level_objective_budget_report.async_batch_get_service_level_objective_budget_report(
    ...
    async def batch_update_exclusion_windows(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.batch_update_exclusion_windows_input.BatchUpdateExclusionWindowsInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.batch_update_exclusion_windows_output.BatchUpdateExclusionWindowsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.batch_update_exclusion_windows.async_batch_update_exclusion_windows(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_grouping_configuration(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.delete_grouping_configuration.async_delete_grouping_configuration(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.get_service_input.GetServiceInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.get_service_output.GetServiceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.get_service.async_get_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_audit_findings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.list_audit_findings_input.ListAuditFindingsInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.list_audit_findings_output.ListAuditFindingsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.list_audit_findings.async_list_audit_findings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_entity_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.list_entity_events_input.ListEntityEventsInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.list_entity_events_output.ListEntityEventsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.list_entity_events.async_list_entity_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_application_signals.types.change_event.ChangeEvent]":
        _token = next_token
        while True:
    ...
    async def list_grouping_attribute_definitions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.list_grouping_attribute_definitions_input.ListGroupingAttributeDefinitionsInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.list_grouping_attribute_definitions_output.ListGroupingAttributeDefinitionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.list_grouping_attribute_definitions.async_list_grouping_attribute_definitions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_service_dependencies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.list_service_dependencies_input.ListServiceDependenciesInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.list_service_dependencies_output.ListServiceDependenciesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.list_service_dependencies.async_list_service_dependencies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_application_signals.types.service_dependency.ServiceDependency]":
        _token = next_token
        while True:
    ...
    async def list_service_dependents(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.list_service_dependents_input.ListServiceDependentsInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.list_service_dependents_output.ListServiceDependentsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.list_service_dependents.async_list_service_dependents(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_application_signals.types.service_dependent.ServiceDependent]":
        _token = next_token
        while True:
    ...
    async def list_service_level_objective_exclusion_windows(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.list_service_level_objective_exclusion_windows_input.ListServiceLevelObjectiveExclusionWindowsInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.list_service_level_objective_exclusion_windows_output.ListServiceLevelObjectiveExclusionWindowsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.list_service_level_objective_exclusion_windows.async_list_service_level_objective_exclusion_windows(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_service_level_objective_exclusion_windows(
        ...
        *,
        ...
        "AsyncIterator[capo_application_signals.types.exclusion_window.ExclusionWindow]"
    ):
        _token = next_token
        while True:
    ...
    async def list_service_operations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.list_service_operations_input.ListServiceOperationsInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.list_service_operations_output.ListServiceOperationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.list_service_operations.async_list_service_operations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_application_signals.types.service_operation.ServiceOperation]":
        _token = next_token
        while True:
    ...
    async def list_services(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.list_services_input.ListServicesInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.list_services_output.ListServicesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.list_services.async_list_services(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_application_signals.types.service_summary.ServiceSummary]":
        _token = next_token
        while True:
    ...
    async def list_service_states(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.list_service_states_input.ListServiceStatesInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.list_service_states_output.ListServiceStatesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.list_service_states.async_list_service_states(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_application_signals.types.service_state.ServiceState]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_grouping_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.put_grouping_configuration_input.PutGroupingConfigurationInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.put_grouping_configuration_output.PutGroupingConfigurationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.put_grouping_configuration.async_put_grouping_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_discovery(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.start_discovery_input.StartDiscoveryInput]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.start_discovery_output.StartDiscoveryOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.start_discovery.async_start_discovery(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_application_signals.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_application_signals.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_application_signals._operations.application_signals.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
