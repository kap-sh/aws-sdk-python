...
def handle_response(
    ...
    out: aws_sdk_application_signals.types.list_service_level_objectives_output.ListServiceLevelObjectivesOutput = aws_sdk_application_signals.types.list_service_level_objectives_output.deserialize_json(
