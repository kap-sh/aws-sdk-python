...
def handle_response(
    ...
    out: aws_sdk_application_signals.types.list_service_dependencies_output.ListServiceDependenciesOutput = aws_sdk_application_signals.types.list_service_dependencies_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_application_signals.types.list_service_dependencies_input.ListServiceDependenciesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_signals.types.list_service_dependencies_input.serialize_json(
            input_
        )
    ).encode()
