...
def handle_response(
    ...
    out: aws_sdk_application_signals.types.batch_update_exclusion_windows_output.BatchUpdateExclusionWindowsOutput = aws_sdk_application_signals.types.batch_update_exclusion_windows_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_application_signals.types.batch_update_exclusion_windows_input.BatchUpdateExclusionWindowsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_signals.types.batch_update_exclusion_windows_input.serialize_json(
            input_
        )
    ).encode()
