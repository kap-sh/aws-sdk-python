...
def handle_response(
    ...
    out: aws_sdk_application_signals.types.get_service_level_objective_output.GetServiceLevelObjectiveOutput = aws_sdk_application_signals.types.get_service_level_objective_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_application_signals.types.get_service_level_objective_input.GetServiceLevelObjectiveInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
