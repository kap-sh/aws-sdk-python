...
def build_request(
    ...
    input: aws_sdk_application_signals.types.list_entity_events_input.ListEntityEventsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_signals.types.list_entity_events_input.serialize_json(input)
    ).encode()
