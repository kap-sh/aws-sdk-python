...
def build_request(
    ...
    input_: aws_sdk_application_signals.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_signals.types.untag_resource_request.serialize_json(input_)
    ).encode()
