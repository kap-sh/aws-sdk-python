...
def handle_response(
    ...
    out: aws_sdk_application_signals.types.list_service_operations_output.ListServiceOperationsOutput = aws_sdk_application_signals.types.list_service_operations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_application_signals.types.list_service_operations_input.ListServiceOperationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_signals.types.list_service_operations_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_service_operations(
