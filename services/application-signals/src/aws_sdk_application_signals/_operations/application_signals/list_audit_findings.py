...
def handle_response(
    ...
    out: aws_sdk_application_signals.types.list_audit_findings_output.ListAuditFindingsOutput = aws_sdk_application_signals.types.list_audit_findings_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_application_signals.types.list_audit_findings_input.ListAuditFindingsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_signals.types.list_audit_findings_input.serialize_json(
            input_
        )
    ).encode()
