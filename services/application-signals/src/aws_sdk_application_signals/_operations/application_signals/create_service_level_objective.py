...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_application_signals.errors.conflict_exception.ConflictException.from_json(
                data
            )
        case "ServiceQuotaExceededException":
            raise aws_sdk_application_signals.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_application_signals.types.create_service_level_objective_output.CreateServiceLevelObjectiveOutput = aws_sdk_application_signals.types.create_service_level_objective_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_application_signals.types.create_service_level_objective_input.CreateServiceLevelObjectiveInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_signals.types.create_service_level_objective_input.serialize_json(
            input_
        )
    ).encode()
