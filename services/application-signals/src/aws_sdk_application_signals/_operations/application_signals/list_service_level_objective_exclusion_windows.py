...
def handle_response(
    ...
    out: aws_sdk_application_signals.types.list_service_level_objective_exclusion_windows_output.ListServiceLevelObjectiveExclusionWindowsOutput = aws_sdk_application_signals.types.list_service_level_objective_exclusion_windows_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_application_signals.types.list_service_level_objective_exclusion_windows_input.ListServiceLevelObjectiveExclusionWindowsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
