...
def handle_response(
    ...
    out: aws_sdk_application_signals.types.list_service_states_output.ListServiceStatesOutput = aws_sdk_application_signals.types.list_service_states_output.deserialize_json(
