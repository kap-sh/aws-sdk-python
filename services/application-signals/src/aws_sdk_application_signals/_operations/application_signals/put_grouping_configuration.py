...
def handle_response(
    ...
    out: aws_sdk_application_signals.types.put_grouping_configuration_output.PutGroupingConfigurationOutput = aws_sdk_application_signals.types.put_grouping_configuration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_application_signals.types.put_grouping_configuration_input.PutGroupingConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_signals.types.put_grouping_configuration_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_grouping_configuration(
