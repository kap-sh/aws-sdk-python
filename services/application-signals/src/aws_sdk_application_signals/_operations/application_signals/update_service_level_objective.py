...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ResourceNotFoundException":
            raise aws_sdk_application_signals.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_application_signals.types.update_service_level_objective_output.UpdateServiceLevelObjectiveOutput = aws_sdk_application_signals.types.update_service_level_objective_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_application_signals.types.update_service_level_objective_input.UpdateServiceLevelObjectiveInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_signals.types.update_service_level_objective_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_service_level_objective(
