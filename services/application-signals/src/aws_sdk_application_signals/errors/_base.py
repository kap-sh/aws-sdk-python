...
class ApplicationSignalsError(Exception):
    """Base class for all ApplicationSignals service errors."""

class ServiceError(ApplicationSignalsError):
...
class SerializationError(ApplicationSignalsError):
    """Raised when a value cannot be serialized."""

class DeserializationError(ApplicationSignalsError):
...
class WaiterFailedError(ApplicationSignalsError):
...
class WaiterTimeoutError(ApplicationSignalsError):
