...
AttributeMaps: TypeAlias = list["aws_sdk_application_signals.types.attribute_map.AttributeMap"]
...
def deserialize_json(data: list) -> AttributeMaps:
    ...
    out: AttributeMaps = []
    for item in data:
        out.append(aws_sdk_application_signals.types.attribute_map.deserialize_json(item))
    return out