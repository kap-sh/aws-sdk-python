...
if TYPE_CHECKING:
    ...
    import aws_sdk_application_signals.types.interval
...
class Goal(TypedDict, closed=True):
    ...
    attainment_goal: NotRequired[
        "aws_sdk_application_signals.types.attainment_goal.AttainmentGoal"
    ]
    ...
    warning_threshold: NotRequired[
        "aws_sdk_application_signals.types.warning_threshold.WarningThreshold"
    ]
...
def serialize_json(value: Goal) -> dict:
    ...
    if "interval" in value:
        ...
        out["Interval"] = aws_sdk_application_signals.types.interval.serialize_json(
            value["interval"]
        )
...
def deserialize_json(data: dict) -> Goal:
    ...
    if "Interval" in data:
        ...
        out["interval"] = aws_sdk_application_signals.types.interval.deserialize_json(
            data["Interval"]
        )
