...
if TYPE_CHECKING:
    import aws_sdk_application_signals.types.request_based_service_level_indicator_metric
...
class RequestBasedServiceLevelIndicator(TypedDict, closed=True):
    ...
    metric_threshold: NotRequired[
        "aws_sdk_application_signals.types.service_level_indicator_metric_threshold.ServiceLevelIndicatorMetricThreshold"
    ]
    ...
    comparison_operator: NotRequired[
        "aws_sdk_application_signals.types.service_level_indicator_comparison_operator.ServiceLevelIndicatorComparisonOperator"
    ]
...
def serialize_json(value: RequestBasedServiceLevelIndicator) -> dict:
    ...
    out["RequestBasedSliMetric"] = (
        aws_sdk_application_signals.types.request_based_service_level_indicator_metric.serialize_json(
...
def deserialize_json(data: dict) -> RequestBasedServiceLevelIndicator:
    ...
    if "RequestBasedSliMetric" in data:
        ...
        out["request_based_sli_metric"] = (
            aws_sdk_application_signals.types.request_based_service_level_indicator_metric.deserialize_json(
