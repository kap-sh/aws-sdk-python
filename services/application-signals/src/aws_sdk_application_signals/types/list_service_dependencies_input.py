"""Generated from Smithy shape ``com.amazonaws.applicationsignals#ListServiceDependenciesInput``."""
...
class ListServiceDependenciesInput(TypedDict, closed=True):
    ...
    max_results: "aws_sdk_application_signals.types.list_service_dependencies_max_results.ListServiceDependenciesMaxResults"
...
# --- restJson1 ser/de ---
def serialize_json(value: ListServiceDependenciesInput) -> dict:
    out: dict = {}
    import aws_sdk_application_signals.types.attributes
...
def deserialize_json(data: dict) -> ListServiceDependenciesInput:
    out: ListServiceDependenciesInput = {}  # type: ignore[typeddict-item]
    if "KeyAttributes" in data:
        ...
        raise DeserializationError(
            "ListServiceDependenciesInput.key_attributes required"
        )
    return out
