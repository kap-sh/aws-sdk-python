...
class ChangeEvent(TypedDict):
    ...
    change_event_type: (
        "aws_sdk_application_signals.types.change_event_type.ChangeEventType"
    )
...
def serialize_json(value: ChangeEvent) -> dict:
    ...
    out["ChangeEventType"] = (
        aws_sdk_application_signals.types.change_event_type.serialize_json(
...
def deserialize_json(data: dict) -> ChangeEvent:
    ...
    if "ChangeEventType" in data:
        ...
        out["change_event_type"] = (
            aws_sdk_application_signals.types.change_event_type.deserialize_json(
