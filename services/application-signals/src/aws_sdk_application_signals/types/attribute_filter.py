...
class AttributeFilter(TypedDict):
    attribute_filter_name: (
        "aws_sdk_application_signals.types.attribute_filter_name.AttributeFilterName"
    )
...
def serialize_json(value: AttributeFilter) -> dict:
    ...
    out["AttributeFilterValues"] = (
        aws_sdk_application_signals.types.attribute_filter_values.serialize_json(
...
def deserialize_json(data: dict) -> AttributeFilter:
    ...
    if "AttributeFilterValues" in data:
        ...
        out["attribute_filter_values"] = (
            aws_sdk_application_signals.types.attribute_filter_values.deserialize_json(
