...
if TYPE_CHECKING:
    import aws_sdk_application_signals.types.request_based_service_level_indicator_metric_config
...
class RequestBasedServiceLevelIndicatorConfig(TypedDict):
    request_based_sli_metric_config: "aws_sdk_application_signals.types.request_based_service_level_indicator_metric_config.RequestBasedServiceLevelIndicatorMetricConfig"
...
def serialize_json(value: RequestBasedServiceLevelIndicatorConfig) -> dict:
    ...
    out["RequestBasedSliMetricConfig"] = (
        aws_sdk_application_signals.types.request_based_service_level_indicator_metric_config.serialize_json(
...
def deserialize_json(data: dict) -> RequestBasedServiceLevelIndicatorConfig:
    ...
    if "RequestBasedSliMetricConfig" in data:
        ...
        out["request_based_sli_metric_config"] = (
            aws_sdk_application_signals.types.request_based_service_level_indicator_metric_config.deserialize_json(
