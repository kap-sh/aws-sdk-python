...
if TYPE_CHECKING:
    import aws_sdk_application_signals.types.grouping_source_key_string_list
    import aws_sdk_application_signals.types.grouping_string


class GroupingAttributeDefinition(TypedDict):
    grouping_name: "aws_sdk_application_signals.types.grouping_string.GroupingString"
...
def serialize_json(value: GroupingAttributeDefinition) -> dict:
    ...
    if "grouping_source_keys" in value:
        ...
        out["GroupingSourceKeys"] = (
            aws_sdk_application_signals.types.grouping_source_key_string_list.serialize_json(
...
def deserialize_json(data: dict) -> GroupingAttributeDefinition:
    ...
    if "GroupingSourceKeys" in data:
        ...
        out["grouping_source_keys"] = (
            aws_sdk_application_signals.types.grouping_source_key_string_list.deserialize_json(
