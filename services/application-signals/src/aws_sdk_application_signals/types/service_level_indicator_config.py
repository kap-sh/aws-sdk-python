...
if TYPE_CHECKING:
    ...
    import aws_sdk_application_signals.types.service_level_indicator_metric_config
...
def serialize_json(value: ServiceLevelIndicatorConfig) -> dict:
    ...
    out["SliMetricConfig"] = (
        aws_sdk_application_signals.types.service_level_indicator_metric_config.serialize_json(
...
def deserialize_json(data: dict) -> ServiceLevelIndicatorConfig:
    ...
    if "SliMetricConfig" in data:
        ...
        out["sli_metric_config"] = (
            aws_sdk_application_signals.types.service_level_indicator_metric_config.deserialize_json(
