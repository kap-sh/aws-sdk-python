...
```
pip install aws-sdk-application-signals
```

## Usage

```python
from aws_sdk_application_signals import AsyncApplicationSignalsClient
...
```python
from aws_sdk_application_signals import AsyncApplicationSignalsClient
from aws_sdk_application_signals.error import ThrottlingException
