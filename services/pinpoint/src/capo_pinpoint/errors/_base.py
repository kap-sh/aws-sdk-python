...
class PinpointError(Exception):
    """Base class for all Pinpoint service errors."""


class ServiceError(PinpointError):
...
class SerializationError(PinpointError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PinpointError):
...
class WaiterFailedError(PinpointError):
...
class WaiterTimeoutError(PinpointError):
