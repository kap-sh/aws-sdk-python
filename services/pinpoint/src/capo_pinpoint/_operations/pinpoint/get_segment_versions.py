...
def handle_response(
    ...
    out: capo_pinpoint.types.get_segment_versions_response.GetSegmentVersionsResponse = {
        "segments_response": capo_pinpoint.types.segments_response.deserialize_json(
