...
def handle_response(
    ...
    out: capo_pinpoint.types.get_in_app_template_response.GetInAppTemplateResponse = {
        "in_app_template_response": capo_pinpoint.types.in_app_template_response.deserialize_json(
