"""Generated from Smithy shape ``com.amazonaws.pinpoint#SendUsersMessages``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.send_users_messages_response.SendUsersMessagesResponse = {
        "send_users_message_response": capo_pinpoint.types.send_users_message_response.deserialize_json(
...
async def async_send_users_messages(
