...
def handle_response(
    ...
    out: capo_pinpoint.types.update_campaign_response.UpdateCampaignResponse = {
        "campaign_response": capo_pinpoint.types.campaign_response.deserialize_json(
...
def build_request(
    ...
    if "write_campaign_request" in input_:
        body: bytes | None = json.dumps(
            capo_pinpoint.types.write_campaign_request.serialize_json(
...
def update_campaign(
    ...
    capo_pinpoint.types.update_campaign_response.UpdateCampaignResponse, zapros.Response
]:
