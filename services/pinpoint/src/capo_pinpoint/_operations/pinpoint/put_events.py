...
def handle_response(
    ...
    out: capo_pinpoint.types.put_events_response.PutEventsResponse = {
        "events_response": capo_pinpoint.types.events_response.deserialize_json(
...
def build_request(
    ...
    if "events_request" in input_:
        body: bytes | None = json.dumps(
            capo_pinpoint.types.events_request.serialize_json(input_["events_request"])
        ).encode()
...
def put_events(
    ...
    input_: capo_pinpoint.types.put_events_request.PutEventsRequest,
) -> tuple[capo_pinpoint.types.put_events_response.PutEventsResponse, zapros.Response]:
