"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetSegmentImportJobs``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_segment_import_jobs_response.GetSegmentImportJobsResponse = {
        "import_jobs_response": capo_pinpoint.types.import_jobs_response.deserialize_json(
...
async def async_get_segment_import_jobs(
