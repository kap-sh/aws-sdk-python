"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetInAppMessages``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_in_app_messages_response.GetInAppMessagesResponse = {
        "in_app_messages_response": capo_pinpoint.types.in_app_messages_response.deserialize_json(
...
async def async_get_in_app_messages(
