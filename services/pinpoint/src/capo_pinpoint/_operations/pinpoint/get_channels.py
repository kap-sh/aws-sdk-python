"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetChannels``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_channels_response.GetChannelsResponse = {
        "channels_response": capo_pinpoint.types.channels_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/channels"
...
def get_channels(
    ...
    capo_pinpoint.types.get_channels_response.GetChannelsResponse, zapros.Response
]:
