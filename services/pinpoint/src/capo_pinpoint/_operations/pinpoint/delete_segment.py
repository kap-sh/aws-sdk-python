"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteSegment``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_segment_response.DeleteSegmentResponse = {
...
def delete_segment(
    ...
    capo_pinpoint.types.delete_segment_response.DeleteSegmentResponse, zapros.Response
]:
...
async def async_delete_segment(
