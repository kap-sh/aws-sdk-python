"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteApnsSandboxChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_apns_sandbox_channel_response.DeleteApnsSandboxChannelResponse = {
...
async def async_delete_apns_sandbox_channel(
