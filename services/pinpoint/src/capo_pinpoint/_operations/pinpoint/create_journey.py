"""Generated from Smithy shape ``com.amazonaws.pinpoint#CreateJourney``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.create_journey_response.CreateJourneyResponse = {
...
def create_journey(
    ...
    capo_pinpoint.types.create_journey_response.CreateJourneyResponse, zapros.Response
]:
...
async def async_create_journey(
