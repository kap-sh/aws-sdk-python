...
def handle_response(
    ...
    out: capo_pinpoint.types.get_apps_response.GetAppsResponse = {
        "applications_response": capo_pinpoint.types.applications_response.deserialize_json(
...
def get_apps(
    ...
    input_: capo_pinpoint.types.get_apps_request.GetAppsRequest,
) -> tuple[capo_pinpoint.types.get_apps_response.GetAppsResponse, zapros.Response]:
