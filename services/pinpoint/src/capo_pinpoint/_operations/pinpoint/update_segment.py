"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateSegment``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.update_segment_response.UpdateSegmentResponse = {
        "segment_response": capo_pinpoint.types.segment_response.deserialize_json(
...
def update_segment(
    ...
    capo_pinpoint.types.update_segment_response.UpdateSegmentResponse, zapros.Response
]:
...
async def async_update_segment(
