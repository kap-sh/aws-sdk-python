...
def handle_response(
    ...
    out: capo_pinpoint.types.update_apns_channel_response.UpdateApnsChannelResponse = {
        "apns_channel_response": capo_pinpoint.types.apns_channel_response.deserialize_json(
