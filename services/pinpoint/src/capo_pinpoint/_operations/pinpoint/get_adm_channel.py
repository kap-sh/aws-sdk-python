"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetAdmChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_adm_channel_response.GetAdmChannelResponse = {
        "adm_channel_response": capo_pinpoint.types.adm_channel_response.deserialize_json(
...
def get_adm_channel(
    ...
    capo_pinpoint.types.get_adm_channel_response.GetAdmChannelResponse, zapros.Response
]:
...
async def async_get_adm_channel(
