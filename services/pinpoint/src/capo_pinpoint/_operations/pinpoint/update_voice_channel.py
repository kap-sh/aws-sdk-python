...
def handle_response(
    ...
    out: capo_pinpoint.types.update_voice_channel_response.UpdateVoiceChannelResponse = {
        "voice_channel_response": capo_pinpoint.types.voice_channel_response.deserialize_json(
