...
def handle_response(
    ...
    out: capo_pinpoint.types.update_apns_sandbox_channel_response.UpdateApnsSandboxChannelResponse = {
        "apns_sandbox_channel_response": capo_pinpoint.types.apns_sandbox_channel_response.deserialize_json(
...
def build_request(
    ...
    if "apns_sandbox_channel_request" in input_:
        body: bytes | None = json.dumps(
            capo_pinpoint.types.apns_sandbox_channel_request.serialize_json(
