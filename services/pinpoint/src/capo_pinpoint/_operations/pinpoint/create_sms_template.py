"""Generated from Smithy shape ``com.amazonaws.pinpoint#CreateSmsTemplate``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.create_sms_template_response.CreateSmsTemplateResponse = {
...
async def async_create_sms_template(
