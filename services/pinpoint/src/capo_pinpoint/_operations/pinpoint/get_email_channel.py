...
def handle_response(
    ...
    out: capo_pinpoint.types.get_email_channel_response.GetEmailChannelResponse = {
        "email_channel_response": capo_pinpoint.types.email_channel_response.deserialize_json(
