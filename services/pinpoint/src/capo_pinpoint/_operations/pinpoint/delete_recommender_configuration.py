"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteRecommenderConfiguration``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_recommender_configuration_response.DeleteRecommenderConfigurationResponse = {
...
async def async_delete_recommender_configuration(
