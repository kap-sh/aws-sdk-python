...
def handle_response(
    ...
    out: capo_pinpoint.types.get_journey_runs_response.GetJourneyRunsResponse = {
        "journey_runs_response": capo_pinpoint.types.journey_runs_response.deserialize_json(
