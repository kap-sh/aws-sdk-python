"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteEmailTemplate``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_email_template_response.DeleteEmailTemplateResponse = {
...
async def async_delete_email_template(
