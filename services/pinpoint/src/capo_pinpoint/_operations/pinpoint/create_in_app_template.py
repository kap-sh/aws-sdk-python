...
def handle_response(
    ...
    out: capo_pinpoint.types.create_in_app_template_response.CreateInAppTemplateResponse = {
        "template_create_message_body": capo_pinpoint.types.template_create_message_body.deserialize_json(
