"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetExportJob``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_export_job_response.GetExportJobResponse = {
        "export_job_response": capo_pinpoint.types.export_job_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/jobs/export/{JobId}"
...
def get_export_job(
    ...
    capo_pinpoint.types.get_export_job_response.GetExportJobResponse, zapros.Response
]:
...
async def async_get_export_job(
