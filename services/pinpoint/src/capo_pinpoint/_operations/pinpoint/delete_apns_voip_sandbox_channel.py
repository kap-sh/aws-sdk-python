"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteApnsVoipSandboxChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_apns_voip_sandbox_channel_response.DeleteApnsVoipSandboxChannelResponse = {
        "apns_voip_sandbox_channel_response": capo_pinpoint.types.apns_voip_sandbox_channel_response.deserialize_json(
...
async def async_delete_apns_voip_sandbox_channel(
