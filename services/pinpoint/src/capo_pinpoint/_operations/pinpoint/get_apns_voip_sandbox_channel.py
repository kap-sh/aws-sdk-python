"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetApnsVoipSandboxChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_apns_voip_sandbox_channel_response.GetApnsVoipSandboxChannelResponse = {
...
async def async_get_apns_voip_sandbox_channel(
