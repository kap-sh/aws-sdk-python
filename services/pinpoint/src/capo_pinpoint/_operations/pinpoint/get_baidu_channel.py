"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetBaiduChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_baidu_channel_response.GetBaiduChannelResponse = {
...
async def async_get_baidu_channel(
