...
import capo_pinpoint.types.campaign_date_range_kpi_response
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_campaign_date_range_kpi_response.GetCampaignDateRangeKpiResponse = {
        "campaign_date_range_kpi_response": capo_pinpoint.types.campaign_date_range_kpi_response.deserialize_json(
