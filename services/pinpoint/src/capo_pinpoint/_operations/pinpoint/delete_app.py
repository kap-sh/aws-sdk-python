"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteApp``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_app_response.DeleteAppResponse = {
...
def delete_app(
    ...
    input_: capo_pinpoint.types.delete_app_request.DeleteAppRequest,
) -> tuple[capo_pinpoint.types.delete_app_response.DeleteAppResponse, zapros.Response]:
