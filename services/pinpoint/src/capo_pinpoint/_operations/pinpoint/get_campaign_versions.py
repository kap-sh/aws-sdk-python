...
def handle_response(
    ...
    out: capo_pinpoint.types.get_campaign_versions_response.GetCampaignVersionsResponse = {
        "campaigns_response": capo_pinpoint.types.campaigns_response.deserialize_json(
