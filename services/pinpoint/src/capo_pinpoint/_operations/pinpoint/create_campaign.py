...
def handle_response(
    ...
    out: capo_pinpoint.types.create_campaign_response.CreateCampaignResponse = {
...
def create_campaign(
    ...
    capo_pinpoint.types.create_campaign_response.CreateCampaignResponse, zapros.Response
]:
