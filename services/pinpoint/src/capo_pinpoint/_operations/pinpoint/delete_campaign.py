...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_campaign_response.DeleteCampaignResponse = {
...
def delete_campaign(
    ...
    capo_pinpoint.types.delete_campaign_response.DeleteCampaignResponse, zapros.Response
]:
