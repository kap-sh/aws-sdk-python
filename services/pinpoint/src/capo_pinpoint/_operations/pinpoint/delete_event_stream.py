"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteEventStream``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_event_stream_response.DeleteEventStreamResponse = {
        "event_stream": capo_pinpoint.types.event_stream.deserialize_json(
