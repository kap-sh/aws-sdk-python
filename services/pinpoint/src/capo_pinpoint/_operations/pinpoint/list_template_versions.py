...
def handle_response(
    ...
    out: capo_pinpoint.types.list_template_versions_response.ListTemplateVersionsResponse = {
        "template_versions_response": capo_pinpoint.types.template_versions_response.deserialize_json(
