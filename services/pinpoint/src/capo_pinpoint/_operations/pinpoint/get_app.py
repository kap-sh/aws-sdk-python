...
def handle_response(
    ...
    out: capo_pinpoint.types.get_app_response.GetAppResponse = {
        "application_response": capo_pinpoint.types.application_response.deserialize_json(
...
def get_app(
    options: OperationOptions, input_: capo_pinpoint.types.get_app_request.GetAppRequest
) -> tuple[capo_pinpoint.types.get_app_response.GetAppResponse, zapros.Response]:
