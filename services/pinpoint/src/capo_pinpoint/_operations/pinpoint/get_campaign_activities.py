"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetCampaignActivities``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_campaign_activities_response.GetCampaignActivitiesResponse = {
        "activities_response": capo_pinpoint.types.activities_response.deserialize_json(
...
async def async_get_campaign_activities(
