"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetSmsTemplate``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_sms_template_response.GetSmsTemplateResponse = {
        "sms_template_response": capo_pinpoint.types.sms_template_response.deserialize_json(
...
async def async_get_sms_template(
