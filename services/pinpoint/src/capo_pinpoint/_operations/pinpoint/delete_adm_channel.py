"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteAdmChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_adm_channel_response.DeleteAdmChannelResponse = {
...
async def async_delete_adm_channel(
