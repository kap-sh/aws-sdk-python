"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetCampaignVersion``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_campaign_version_response.GetCampaignVersionResponse = {
...
async def async_get_campaign_version(
