...
def handle_response(
    ...
    out: capo_pinpoint.types.create_email_template_response.CreateEmailTemplateResponse = {
        "create_template_message_body": capo_pinpoint.types.create_template_message_body.deserialize_json(
...
def build_request(
    ...
    if "email_template_request" in input_:
        body: bytes | None = json.dumps(
            capo_pinpoint.types.email_template_request.serialize_json(
