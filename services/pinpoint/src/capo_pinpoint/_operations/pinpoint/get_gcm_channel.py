...
def handle_response(
    ...
    out: capo_pinpoint.types.get_gcm_channel_response.GetGcmChannelResponse = {
        "gcm_channel_response": capo_pinpoint.types.gcm_channel_response.deserialize_json(
...
def get_gcm_channel(
    ...
    capo_pinpoint.types.get_gcm_channel_response.GetGcmChannelResponse, zapros.Response
]:
