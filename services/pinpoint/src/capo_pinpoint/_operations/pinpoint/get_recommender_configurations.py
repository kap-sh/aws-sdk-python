...
def handle_response(
    ...
    out: capo_pinpoint.types.get_recommender_configurations_response.GetRecommenderConfigurationsResponse = {
        "list_recommender_configurations_response": capo_pinpoint.types.list_recommender_configurations_response.deserialize_json(
