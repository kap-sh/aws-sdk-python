"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteBaiduChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_baidu_channel_response.DeleteBaiduChannelResponse = {
        "baidu_channel_response": capo_pinpoint.types.baidu_channel_response.deserialize_json(
...
async def async_delete_baidu_channel(
