...
def handle_response(
    ...
    out: capo_pinpoint.types.get_journey_execution_metrics_response.GetJourneyExecutionMetricsResponse = {
        "journey_execution_metrics_response": capo_pinpoint.types.journey_execution_metrics_response.deserialize_json(
