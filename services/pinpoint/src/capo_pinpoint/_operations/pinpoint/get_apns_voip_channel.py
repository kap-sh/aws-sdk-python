"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetApnsVoipChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_apns_voip_channel_response.GetApnsVoipChannelResponse = {
        "apns_voip_channel_response": capo_pinpoint.types.apns_voip_channel_response.deserialize_json(
...
async def async_get_apns_voip_channel(
