"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetSegmentExportJobs``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_segment_export_jobs_response.GetSegmentExportJobsResponse = {
        "export_jobs_response": capo_pinpoint.types.export_jobs_response.deserialize_json(
...
async def async_get_segment_export_jobs(
