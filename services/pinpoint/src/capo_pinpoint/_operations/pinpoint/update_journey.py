"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateJourney``."""
...
import capo_pinpoint.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_pinpoint.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_pinpoint.types.update_journey_response.UpdateJourneyResponse = {
        "journey_response": capo_pinpoint.types.journey_response.deserialize_json(
...
def update_journey(
    ...
    capo_pinpoint.types.update_journey_response.UpdateJourneyResponse, zapros.Response
]:
...
async def async_update_journey(
