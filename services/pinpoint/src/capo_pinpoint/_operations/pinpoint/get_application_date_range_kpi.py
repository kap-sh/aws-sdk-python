"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetApplicationDateRangeKpi``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_application_date_range_kpi_response.GetApplicationDateRangeKpiResponse = {
        "application_date_range_kpi_response": capo_pinpoint.types.application_date_range_kpi_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/kpis/daterange/{KpiName}"
...
async def async_get_application_date_range_kpi(
