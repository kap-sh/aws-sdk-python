"""Generated from Smithy shape ``com.amazonaws.pinpoint#APNSVoipSandboxChannelRequest``."""
...
class APNSVoipSandboxChannelRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: APNSVoipSandboxChannelRequest) -> dict:
    out: dict = {}
