"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateSmsTemplateRequest``."""
...
class UpdateSmsTemplateRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateSmsTemplateRequest) -> dict:
    out: dict = {}
