"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetSegmentVersionsResponse``."""
...
class GetSegmentVersionsResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetSegmentVersionsResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetSegmentVersionsResponse:
    out: GetSegmentVersionsResponse = {}  # type: ignore[typeddict-item]
