"""Generated from Smithy shape ``com.amazonaws.pinpoint#APNSSandboxChannelRequest``."""
...
class APNSSandboxChannelRequest(TypedDict, closed=True):
    bundle_id: NotRequired["capo_pinpoint.types.__string.__string"]
    """<p>The bundle identifier that's assigned to your iOS app. This identifier is used for APNs tokens.</p>"""
    certificate: NotRequired["capo_pinpoint.types.__string.__string"]
    ...
    private_key: NotRequired["capo_pinpoint.types.__string.__string"]
    ...
    team_id: NotRequired["capo_pinpoint.types.__string.__string"]
    """<p>The identifier that's assigned to your Apple developer account team. This identifier is used for APNs tokens.</p>"""
    token_key: NotRequired["capo_pinpoint.types.__string.__string"]
    """<p>The authentication key to use for APNs tokens.</p>"""
    token_key_id: NotRequired["capo_pinpoint.types.__string.__string"]
...
# --- restJson1 ser/de ---
def serialize_json(value: APNSSandboxChannelRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> APNSSandboxChannelRequest:
    out: APNSSandboxChannelRequest = {}  # type: ignore[typeddict-item]
    if "BundleId" in data:
