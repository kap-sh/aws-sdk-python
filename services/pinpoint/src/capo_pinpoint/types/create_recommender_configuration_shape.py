"""Generated from Smithy shape ``com.amazonaws.pinpoint#CreateRecommenderConfigurationShape``."""
...
class CreateRecommenderConfigurationShape(TypedDict, closed=True):
    attributes: NotRequired["capo_pinpoint.types.map_of__string.MapOf__string"]
    ...
    recommendation_provider_uri: NotRequired["capo_pinpoint.types.__string.__string"]
    ...
    recommendation_transformer_uri: NotRequired["capo_pinpoint.types.__string.__string"]
    ...
    recommendations_display_name: NotRequired["capo_pinpoint.types.__string.__string"]
    ...
    recommendations_per_message: NotRequired["capo_pinpoint.types.__integer.__integer"]
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateRecommenderConfigurationShape) -> dict:
    out: dict = {}
    if "attributes" in value:
        import capo_pinpoint.types.map_of__string

        out["Attributes"] = capo_pinpoint.types.map_of__string.serialize_json(
            value["attributes"]
        )
...
def deserialize_json(data: dict) -> CreateRecommenderConfigurationShape:
    out: CreateRecommenderConfigurationShape = {}  # type: ignore[typeddict-item]
