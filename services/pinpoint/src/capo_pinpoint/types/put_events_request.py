...
class PutEventsRequest(TypedDict, closed=True):
    ...
    events_request: NotRequired["capo_pinpoint.types.events_request.EventsRequest"]
...
def serialize_json(value: PutEventsRequest) -> dict:
    ...
    if "events_request" in value:
        ...
        out["EventsRequest"] = capo_pinpoint.types.events_request.serialize_json(
...
def deserialize_json(data: dict) -> PutEventsRequest:
    ...
    if "EventsRequest" in data:
        ...
        out["events_request"] = capo_pinpoint.types.events_request.deserialize_json(
            data["EventsRequest"]
        )
    return out
