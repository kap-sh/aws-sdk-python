"""Generated from Smithy shape ``com.amazonaws.pinpoint#APNSChannelResponse``."""
...
class APNSChannelResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: APNSChannelResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> APNSChannelResponse:
    out: APNSChannelResponse = {}  # type: ignore[typeddict-item]
