"""Generated from Smithy shape ``com.amazonaws.pinpoint#APNSSandboxChannelResponse``."""
...
class APNSSandboxChannelResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: APNSSandboxChannelResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> APNSSandboxChannelResponse:
    out: APNSSandboxChannelResponse = {}  # type: ignore[typeddict-item]
