"""Generated from Smithy shape ``com.amazonaws.pinpoint#ADMChannelResponse``."""
...
class ADMChannelResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ADMChannelResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ADMChannelResponse:
    out: ADMChannelResponse = {}  # type: ignore[typeddict-item]
