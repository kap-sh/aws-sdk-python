...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint.types.list_of_template_response


class TemplatesResponse(TypedDict):
    item: NotRequired[
        "aws_sdk_pinpoint.types.list_of_template_response.ListOfTemplateResponse"
    ]
...
def serialize_json(value: TemplatesResponse) -> dict:
    ...
    if "item" in value:
        ...
        out["Item"] = aws_sdk_pinpoint.types.list_of_template_response.serialize_json(
            value["item"]
        )
...
def deserialize_json(data: dict) -> TemplatesResponse:
    ...
    if "Item" in data:
        ...
        out["item"] = aws_sdk_pinpoint.types.list_of_template_response.deserialize_json(
            data["Item"]
        )
