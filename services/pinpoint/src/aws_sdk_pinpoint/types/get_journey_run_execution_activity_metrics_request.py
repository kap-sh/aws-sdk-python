"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetJourneyRunExecutionActivityMetricsRequest``."""
...
class GetJourneyRunExecutionActivityMetricsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetJourneyRunExecutionActivityMetricsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetJourneyRunExecutionActivityMetricsRequest:
    out: GetJourneyRunExecutionActivityMetricsRequest = {}  # type: ignore[typeddict-item]
    return out
