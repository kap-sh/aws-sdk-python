"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteVoiceChannelResponse``."""
...
class DeleteVoiceChannelResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteVoiceChannelResponse) -> dict:
    out: dict = {}
