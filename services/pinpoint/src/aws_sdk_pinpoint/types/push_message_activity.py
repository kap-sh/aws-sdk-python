...
def serialize_json(value: PushMessageActivity) -> dict:
    ...
    if "message_config" in value:
        ...
        out["MessageConfig"] = (
            aws_sdk_pinpoint.types.journey_push_message.serialize_json(
...
def deserialize_json(data: dict) -> PushMessageActivity:
    ...
    if "MessageConfig" in data:
        ...
        out["message_config"] = (
            aws_sdk_pinpoint.types.journey_push_message.deserialize_json(
                data["MessageConfig"]
            )
        )
