...
class NumberValidateResponse(TypedDict):
    ...
    cleansed_phone_number_e164: NotRequired["aws_sdk_pinpoint.types.__string.__string"]
    """<p>The cleansed phone number, in E.164 format, for the location where the phone number was originally registered.</p>"""
    cleansed_phone_number_national: NotRequired[
    ...
    country_code_iso2: NotRequired["aws_sdk_pinpoint.types.__string.__string"]
    ...
    country_code_numeric: NotRequired["aws_sdk_pinpoint.types.__string.__string"]
    """<p>The numeric code for the country or region where the phone number was originally registered.</p>"""
    county: NotRequired["aws_sdk_pinpoint.types.__string.__string"]
    """<p>The name of the county where the phone number was originally registered.</p>"""
    original_country_code_iso2: NotRequired["aws_sdk_pinpoint.types.__string.__string"]
    """<p>The two-character code, in ISO 3166-1 alpha-2 format, that was sent in the request body.</p>"""
    original_phone_number: NotRequired["aws_sdk_pinpoint.types.__string.__string"]
    """<p>The phone number that was sent in the request body.</p>"""
    phone_type: NotRequired["aws_sdk_pinpoint.types.__string.__string"]
    """<p>The description of the phone type. Valid values are: MOBILE, LANDLINE, VOIP, INVALID, PREPAID, and OTHER.</p>"""
    phone_type_code: NotRequired["aws_sdk_pinpoint.types.__integer.__integer"]
    ...
    zip_code: NotRequired["aws_sdk_pinpoint.types.__string.__string"]
