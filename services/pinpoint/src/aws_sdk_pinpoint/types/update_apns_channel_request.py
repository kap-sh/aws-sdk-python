...
class UpdateApnsChannelRequest(TypedDict):
    apns_channel_request: NotRequired[
        "aws_sdk_pinpoint.types.apns_channel_request.APNSChannelRequest"
    ]
...
def deserialize_json(data: dict) -> UpdateApnsChannelRequest:
    ...
    if "APNSChannelRequest" in data:
        ...
        out["apns_channel_request"] = (
            aws_sdk_pinpoint.types.apns_channel_request.deserialize_json(
