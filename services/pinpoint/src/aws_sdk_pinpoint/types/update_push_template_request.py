"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdatePushTemplateRequest``."""
...
class UpdatePushTemplateRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdatePushTemplateRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdatePushTemplateRequest:
    out: UpdatePushTemplateRequest = {}  # type: ignore[typeddict-item]
