...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint.types.journey_custom_message
    import aws_sdk_pinpoint.types.list_of__endpoint_types_element


class CustomMessageActivity(TypedDict):
    ...
    message_config: NotRequired[
        "aws_sdk_pinpoint.types.journey_custom_message.JourneyCustomMessage"
    ]
...
def serialize_json(value: CustomMessageActivity) -> dict:
    ...
    if "message_config" in value:
        ...
        out["MessageConfig"] = (
            aws_sdk_pinpoint.types.journey_custom_message.serialize_json(
...
def deserialize_json(data: dict) -> CustomMessageActivity:
    ...
    if "MessageConfig" in data:
        ...
        out["message_config"] = (
            aws_sdk_pinpoint.types.journey_custom_message.deserialize_json(
                data["MessageConfig"]
            )
        )
