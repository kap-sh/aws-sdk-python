"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteSegmentResponse``."""
...
class DeleteSegmentResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteSegmentResponse) -> dict:
    out: dict = {}
