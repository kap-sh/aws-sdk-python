"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateBaiduChannelResponse``."""
...
class UpdateBaiduChannelResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateBaiduChannelResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateBaiduChannelResponse:
    out: UpdateBaiduChannelResponse = {}  # type: ignore[typeddict-item]
