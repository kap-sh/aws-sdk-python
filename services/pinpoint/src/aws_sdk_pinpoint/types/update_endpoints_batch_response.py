"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateEndpointsBatchResponse``."""
...
class UpdateEndpointsBatchResponse(TypedDict, closed=True):
    message_body: NotRequired["aws_sdk_pinpoint.types.message_body.MessageBody"]


# --- restJson1 ser/de ---
def serialize_json(value: UpdateEndpointsBatchResponse) -> dict:
    out: dict = {}
