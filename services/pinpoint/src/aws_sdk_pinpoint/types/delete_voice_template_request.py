...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteVoiceTemplateRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DeleteVoiceTemplateRequest:
    out: DeleteVoiceTemplateRequest = {}  # type: ignore[typeddict-item]
    return out
