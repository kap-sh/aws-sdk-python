...
def serialize_json(value: ResultRow) -> dict:
    ...
    if "grouped_bys" in value:
        ...
        out["GroupedBys"] = (
            aws_sdk_pinpoint.types.list_of_result_row_value.serialize_json(
                value["grouped_bys"]
            )
        )
    if "values" in value:
        ...
        out["Values"] = aws_sdk_pinpoint.types.list_of_result_row_value.serialize_json(
            value["values"]
        )
    return out
...
def deserialize_json(data: dict) -> ResultRow:
    ...
    if "GroupedBys" in data:
        ...
        out["grouped_bys"] = (
            aws_sdk_pinpoint.types.list_of_result_row_value.deserialize_json(
                data["GroupedBys"]
            )
        )
    if "Values" in data:
