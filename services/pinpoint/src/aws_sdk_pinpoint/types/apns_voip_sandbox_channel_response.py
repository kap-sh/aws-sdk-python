"""Generated from Smithy shape ``com.amazonaws.pinpoint#APNSVoipSandboxChannelResponse``."""
...
class APNSVoipSandboxChannelResponse(TypedDict, closed=True):
    ...
    has_token_key: NotRequired["aws_sdk_pinpoint.types.__boolean.__boolean"]
...
# --- restJson1 ser/de ---
def serialize_json(value: APNSVoipSandboxChannelResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> APNSVoipSandboxChannelResponse:
    out: APNSVoipSandboxChannelResponse = {}  # type: ignore[typeddict-item]
