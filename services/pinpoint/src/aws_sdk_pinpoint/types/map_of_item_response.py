...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint.types.item_response

MapOfItemResponse: TypeAlias = dict[
    "aws_sdk_pinpoint.types.__string.__string",
    "aws_sdk_pinpoint.types.item_response.ItemResponse",
]
...
def serialize_json(input_to_serialize: MapOfItemResponse) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_pinpoint.types.item_response.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> MapOfItemResponse:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_pinpoint.types.item_response.deserialize_json(value)
    return out
