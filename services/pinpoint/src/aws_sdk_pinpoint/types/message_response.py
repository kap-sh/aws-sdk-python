...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint.types.map_of_message_result
...
class MessageResponse(TypedDict, closed=True):
    ...
    result: NotRequired[
        "aws_sdk_pinpoint.types.map_of_message_result.MapOfMessageResult"
    ]
...
def serialize_json(value: MessageResponse) -> dict:
    ...
    if "endpoint_result" in value:
        ...
        out["EndpointResult"] = (
            aws_sdk_pinpoint.types.map_of_endpoint_message_result.serialize_json(
    ...
    if "result" in value:
        ...
        out["Result"] = aws_sdk_pinpoint.types.map_of_message_result.serialize_json(
            value["result"]
        )
    return out
...
def deserialize_json(data: dict) -> MessageResponse:
    ...
    if "Result" in data:
        ...
        out["result"] = aws_sdk_pinpoint.types.map_of_message_result.deserialize_json(
            data["Result"]
        )
    return out
