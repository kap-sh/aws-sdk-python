"""Generated from Smithy shape ``com.amazonaws.pinpoint#APNSChannelRequest``."""
...
class APNSChannelRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: APNSChannelRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> APNSChannelRequest:
    out: APNSChannelRequest = {}  # type: ignore[typeddict-item]
    if "BundleId" in data:
