...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint.types.address_configuration

MapOfAddressConfiguration: TypeAlias = dict[
    "aws_sdk_pinpoint.types.__string.__string",
    "aws_sdk_pinpoint.types.address_configuration.AddressConfiguration",
]
...
def serialize_json(input_to_serialize: MapOfAddressConfiguration) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_pinpoint.types.address_configuration.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> MapOfAddressConfiguration:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_pinpoint.types.address_configuration.deserialize_json(value)
    return out
