"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteApnsVoipSandboxChannelResponse``."""
...
class DeleteApnsVoipSandboxChannelResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteApnsVoipSandboxChannelResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DeleteApnsVoipSandboxChannelResponse:
    out: DeleteApnsVoipSandboxChannelResponse = {}  # type: ignore[typeddict-item]
