...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint.types.import_job_resource
...
class ImportJobResponse(TypedDict):
    ...
    definition: NotRequired[
        "aws_sdk_pinpoint.types.import_job_resource.ImportJobResource"
    ]
...
def serialize_json(value: ImportJobResponse) -> dict:
    ...
    if "definition" in value:
        ...
        out["Definition"] = aws_sdk_pinpoint.types.import_job_resource.serialize_json(
            value["definition"]
        )
...
def deserialize_json(data: dict) -> ImportJobResponse:
    ...
    if "Definition" in data:
        ...
        out["definition"] = aws_sdk_pinpoint.types.import_job_resource.deserialize_json(
            data["Definition"]
        )
