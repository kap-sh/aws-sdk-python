...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint.types.message_result

MapOfMessageResult: TypeAlias = dict[
    "aws_sdk_pinpoint.types.__string.__string",
    "aws_sdk_pinpoint.types.message_result.MessageResult",
]
...
def serialize_json(input_to_serialize: MapOfMessageResult) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_pinpoint.types.message_result.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> MapOfMessageResult:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_pinpoint.types.message_result.deserialize_json(value)
    return out
