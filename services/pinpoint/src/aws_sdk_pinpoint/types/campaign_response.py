...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint.types.campaign_state
    import aws_sdk_pinpoint.types.custom_delivery_configuration
    import aws_sdk_pinpoint.types.list_of_treatment_resource
...
class CampaignResponse(TypedDict):
    additional_treatments: NotRequired[
        "aws_sdk_pinpoint.types.list_of_treatment_resource.ListOfTreatmentResource"
    ]
    ...
    default_state: NotRequired["aws_sdk_pinpoint.types.campaign_state.CampaignState"]
    ...
    state: NotRequired["aws_sdk_pinpoint.types.campaign_state.CampaignState"]
...
def serialize_json(value: CampaignResponse) -> dict:
    ...
    if "additional_treatments" in value:
        ...
        out["AdditionalTreatments"] = (
            aws_sdk_pinpoint.types.list_of_treatment_resource.serialize_json(
    ...
    if "default_state" in value:
        ...
        out["DefaultState"] = aws_sdk_pinpoint.types.campaign_state.serialize_json(
            value["default_state"]
        )
    ...
    if "state" in value:
        ...
        out["State"] = aws_sdk_pinpoint.types.campaign_state.serialize_json(
            value["state"]
        )
    if "tags" in value:
        import aws_sdk_pinpoint.types.map_of__string
...
def deserialize_json(data: dict) -> CampaignResponse:
    ...
    if "AdditionalTreatments" in data:
        ...
        out["additional_treatments"] = (
            aws_sdk_pinpoint.types.list_of_treatment_resource.deserialize_json(
    ...
    if "DefaultState" in data:
        ...
        out["default_state"] = aws_sdk_pinpoint.types.campaign_state.deserialize_json(
            data["DefaultState"]
        )
    ...
    if "State" in data:
        ...
        out["state"] = aws_sdk_pinpoint.types.campaign_state.deserialize_json(
            data["State"]
        )
    if "tags" in data:
        import aws_sdk_pinpoint.types.map_of__string
