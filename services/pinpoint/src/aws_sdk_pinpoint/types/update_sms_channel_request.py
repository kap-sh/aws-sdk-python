...
def deserialize_json(data: dict) -> UpdateSmsChannelRequest:
    ...
    if "SMSChannelRequest" in data:
        ...
        out["sms_channel_request"] = (
            aws_sdk_pinpoint.types.sms_channel_request.deserialize_json(
