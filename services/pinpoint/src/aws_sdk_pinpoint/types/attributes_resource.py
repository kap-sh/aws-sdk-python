...
class AttributesResource(TypedDict):
    application_id: NotRequired["aws_sdk_pinpoint.types.__string.__string"]
    """<p>The unique identifier for the application.</p>"""
    attribute_type: NotRequired["aws_sdk_pinpoint.types.__string.__string"]
    ...
    attributes: NotRequired["aws_sdk_pinpoint.types.list_of__string.ListOf__string"]
...
def serialize_json(value: AttributesResource) -> dict:
    ...
    if "attributes" in value:
        ...
        out["Attributes"] = aws_sdk_pinpoint.types.list_of__string.serialize_json(
            value["attributes"]
        )
    return out
...
def deserialize_json(data: dict) -> AttributesResource:
    ...
    if "Attributes" in data:
        ...
        out["attributes"] = aws_sdk_pinpoint.types.list_of__string.deserialize_json(
            data["Attributes"]
        )
    return out
