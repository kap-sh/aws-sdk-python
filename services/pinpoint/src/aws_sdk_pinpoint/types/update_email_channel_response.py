"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateEmailChannelResponse``."""
...
class UpdateEmailChannelResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateEmailChannelResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateEmailChannelResponse:
    out: UpdateEmailChannelResponse = {}  # type: ignore[typeddict-item]
