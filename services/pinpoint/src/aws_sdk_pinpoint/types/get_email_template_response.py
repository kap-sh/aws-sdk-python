...
if TYPE_CHECKING:
    import aws_sdk_pinpoint.types.email_template_response


class GetEmailTemplateResponse(TypedDict):
    email_template_response: NotRequired[
        "aws_sdk_pinpoint.types.email_template_response.EmailTemplateResponse"
    ]
...
def serialize_json(value: GetEmailTemplateResponse) -> dict:
    ...
    if "email_template_response" in value:
        ...
        out["EmailTemplateResponse"] = (
            aws_sdk_pinpoint.types.email_template_response.serialize_json(
...
def deserialize_json(data: dict) -> GetEmailTemplateResponse:
    ...
    if "EmailTemplateResponse" in data:
        ...
        out["email_template_response"] = (
            aws_sdk_pinpoint.types.email_template_response.deserialize_json(
