...
class MultiConditionalBranch(TypedDict):
    condition: NotRequired["aws_sdk_pinpoint.types.simple_condition.SimpleCondition"]
...
def serialize_json(value: MultiConditionalBranch) -> dict:
    ...
    if "condition" in value:
        ...
        out["Condition"] = aws_sdk_pinpoint.types.simple_condition.serialize_json(
            value["condition"]
        )
...
def deserialize_json(data: dict) -> MultiConditionalBranch:
    ...
    if "Condition" in data:
        ...
        out["condition"] = aws_sdk_pinpoint.types.simple_condition.deserialize_json(
            data["Condition"]
        )
