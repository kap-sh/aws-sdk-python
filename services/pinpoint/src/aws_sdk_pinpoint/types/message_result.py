"""Generated from Smithy shape ``com.amazonaws.pinpoint#MessageResult``."""
...
class MessageResult(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: MessageResult) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> MessageResult:
    out: MessageResult = {}  # type: ignore[typeddict-item]
