"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetApplicationDateRangeKpiRequest``."""
...
class GetApplicationDateRangeKpiRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetApplicationDateRangeKpiRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetApplicationDateRangeKpiRequest:
    out: GetApplicationDateRangeKpiRequest = {}  # type: ignore[typeddict-item]
    return out
