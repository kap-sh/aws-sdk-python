"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetExportJobsResponse``."""
...
class GetExportJobsResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetExportJobsResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetExportJobsResponse:
    out: GetExportJobsResponse = {}  # type: ignore[typeddict-item]
