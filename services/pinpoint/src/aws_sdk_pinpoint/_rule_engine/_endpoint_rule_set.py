    ...
    if p.Region is not None:
        ...
        if _locals["PartitionResult"] is not None:
            ...
            if string_equals(p.Region, interpolate("us-east-1", p, _locals)):
                return Endpoint(
                    url=interpolate(
                        "https://pinpoint.us-east-1.amazonaws.com", p, _locals
                    ),
                    properties={},
                    headers={},
                )
            if string_equals(p.Region, interpolate("us-west-2", p, _locals)):
                return Endpoint(
                    url=interpolate(
                        "https://pinpoint.us-west-2.amazonaws.com", p, _locals
                    ),
                    properties={},
                    headers={},
                )
            if string_equals(p.Region, interpolate("us-gov-west-1", p, _locals)):
                return Endpoint(
                    url=interpolate(
                        "https://pinpoint.us-gov-west-1.amazonaws.com", p, _locals
                    ),
                    properties={},
                    headers={},
                )
            if string_equals(
                ...
                return Endpoint(
                    url=interpolate(
                        "https://pinpoint.{Region}.amazonaws.com", p, _locals
                    ),
                    properties={},
                    headers={},
                )
            ...
            return Endpoint(
                url=interpolate(
                    "https://pinpoint.{Region}.{PartitionResult#dnsSuffix}", p, _locals
                ),
                properties={},
                headers={},
            )
