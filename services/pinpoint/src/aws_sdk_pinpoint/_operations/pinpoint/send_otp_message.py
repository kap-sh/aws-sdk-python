...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.send_otp_message_response.SendOTPMessageResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.send_otp_message_request.SendOTPMessageRequest,
) -> zapros.Request:
    ...
    if "send_otp_message_request_parameters" in input:
