...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.create_voice_template_response.CreateVoiceTemplateResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.create_voice_template_request.CreateVoiceTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
