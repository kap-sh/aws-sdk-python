...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.update_template_active_version_request.UpdateTemplateActiveVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace("{TemplateType}", quote(str(input["template_type"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    if "template_active_version_request" in input:
