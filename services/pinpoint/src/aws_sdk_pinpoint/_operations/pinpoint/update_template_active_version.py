"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateTemplateActiveVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_template_active_version_response.UpdateTemplateActiveVersionResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.update_template_active_version_request.UpdateTemplateActiveVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{TemplateType}", quote(str(input_["template_type"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    if "template_active_version_request" in input_:
        ...
        body: bytes | None = json.dumps(
            aws_sdk_pinpoint.types.template_active_version_request.serialize_json(
                input_["template_active_version_request"]
            )
        ).encode()
...
async def async_update_template_active_version(
