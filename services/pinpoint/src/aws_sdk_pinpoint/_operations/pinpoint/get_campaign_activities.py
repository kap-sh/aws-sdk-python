...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_campaign_activities_response.GetCampaignActivitiesResponse = {
        "activities_response": aws_sdk_pinpoint.types.activities_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_campaign_activities_request.GetCampaignActivitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
