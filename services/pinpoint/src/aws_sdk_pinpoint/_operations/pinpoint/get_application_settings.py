"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetApplicationSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_application_settings_response.GetApplicationSettingsResponse = {
        "application_settings_resource": aws_sdk_pinpoint.types.application_settings_resource.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_application_settings_request.GetApplicationSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_application_settings(
