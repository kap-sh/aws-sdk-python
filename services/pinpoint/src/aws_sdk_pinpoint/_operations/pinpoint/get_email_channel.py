"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetEmailChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_email_channel_response.GetEmailChannelResponse = {
        "email_channel_response": aws_sdk_pinpoint.types.email_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_email_channel_request.GetEmailChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/channels/email"
...
async def async_get_email_channel(
