...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_journey_run_execution_activity_metrics_response.GetJourneyRunExecutionActivityMetricsResponse = {
        "journey_run_execution_activity_metrics_response": aws_sdk_pinpoint.types.journey_run_execution_activity_metrics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_journey_run_execution_activity_metrics_request.GetJourneyRunExecutionActivityMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
