...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_recommender_configuration_response.DeleteRecommenderConfigurationResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.delete_recommender_configuration_request.DeleteRecommenderConfigurationRequest,
) -> zapros.Request:
