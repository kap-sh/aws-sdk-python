"""Generated from Smithy shape ``com.amazonaws.pinpoint#CreateInAppTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.create_in_app_template_response.CreateInAppTemplateResponse = {
        "template_create_message_body": aws_sdk_pinpoint.types.template_create_message_body.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.create_in_app_template_request.CreateInAppTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_in_app_template(
