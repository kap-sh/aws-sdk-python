"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetSegmentVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_segment_version_response.GetSegmentVersionResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_segment_version_request.GetSegmentVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_segment_version(
