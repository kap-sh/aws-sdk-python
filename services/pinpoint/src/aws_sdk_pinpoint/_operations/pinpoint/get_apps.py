"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetApps``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_apps_response.GetAppsResponse = {
        "applications_response": aws_sdk_pinpoint.types.applications_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_apps_request.GetAppsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps"
    params: dict[str, str] = {}
...
def get_apps(
    ...
    input_: aws_sdk_pinpoint.types.get_apps_request.GetAppsRequest,
) -> tuple[aws_sdk_pinpoint.types.get_apps_response.GetAppsResponse, zapros.Response]:
