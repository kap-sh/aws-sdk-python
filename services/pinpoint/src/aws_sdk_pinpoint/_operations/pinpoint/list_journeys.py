"""Generated from Smithy shape ``com.amazonaws.pinpoint#ListJourneys``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.list_journeys_response.ListJourneysResponse = {
        "journeys_response": aws_sdk_pinpoint.types.journeys_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.list_journeys_request.ListJourneysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/journeys"
...
def list_journeys(
    ...
    aws_sdk_pinpoint.types.list_journeys_response.ListJourneysResponse, zapros.Response
]:
