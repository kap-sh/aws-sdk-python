"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateVoiceTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_voice_template_response.UpdateVoiceTemplateResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.update_voice_template_request.UpdateVoiceTemplateRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/templates/{TemplateName}/voice"
...
async def async_update_voice_template(
