...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.update_voice_template_request.UpdateVoiceTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
