...
def handle_response(
    ...
    import aws_sdk_pinpoint.types.number_validate_response

    out: aws_sdk_pinpoint.types.phone_number_validate_response.PhoneNumberValidateResponse = {
        "number_validate_response": aws_sdk_pinpoint.types.number_validate_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.phone_number_validate_request.PhoneNumberValidateRequest,
) -> zapros.Request:
