...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    ...
    if "tags_model" in input:
        import aws_sdk_pinpoint.types.tags_model

        body: bytes | None = json.dumps(
            aws_sdk_pinpoint.types.tags_model.serialize_json(input["tags_model"])
        ).encode()
