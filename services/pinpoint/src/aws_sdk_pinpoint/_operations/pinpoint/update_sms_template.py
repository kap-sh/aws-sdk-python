...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_sms_template_response.UpdateSmsTemplateResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.update_sms_template_request.UpdateSmsTemplateRequest,
) -> zapros.Request:
