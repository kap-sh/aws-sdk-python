"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetEventStream``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_event_stream_response.GetEventStreamResponse = {
        "event_stream": aws_sdk_pinpoint.types.event_stream.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_event_stream_request.GetEventStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/eventstream"
...
async def async_get_event_stream(
