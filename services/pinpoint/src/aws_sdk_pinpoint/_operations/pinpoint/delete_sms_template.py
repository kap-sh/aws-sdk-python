"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteSmsTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_sms_template_response.DeleteSmsTemplateResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.delete_sms_template_request.DeleteSmsTemplateRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/templates/{TemplateName}/sms"
...
async def async_delete_sms_template(
