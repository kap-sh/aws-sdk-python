"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetJourney``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_journey_response.GetJourneyResponse = {
        "journey_response": aws_sdk_pinpoint.types.journey_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_journey_request.GetJourneyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/journeys/{JourneyId}"
...
def get_journey(
    ...
    aws_sdk_pinpoint.types.get_journey_response.GetJourneyResponse, zapros.Response
]:
