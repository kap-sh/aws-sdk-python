...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_baidu_channel_response.DeleteBaiduChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_baidu_channel_request.DeleteBaiduChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
