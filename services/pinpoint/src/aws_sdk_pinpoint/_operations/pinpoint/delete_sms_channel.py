"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteSmsChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_sms_channel_response.DeleteSmsChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_sms_channel_request.DeleteSmsChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_sms_channel(
