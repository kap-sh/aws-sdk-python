...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_user_endpoints_response.GetUserEndpointsResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_user_endpoints_request.GetUserEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
