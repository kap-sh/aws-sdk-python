"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteApnsChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_apns_channel_response.DeleteApnsChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_apns_channel_request.DeleteApnsChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_apns_channel(
