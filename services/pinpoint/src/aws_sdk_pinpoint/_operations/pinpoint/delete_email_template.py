...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_email_template_response.DeleteEmailTemplateResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_email_template_request.DeleteEmailTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
