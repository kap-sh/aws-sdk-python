"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetCampaignVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_campaign_versions_response.GetCampaignVersionsResponse = {
        "campaigns_response": aws_sdk_pinpoint.types.campaigns_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_campaign_versions_request.GetCampaignVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_campaign_versions(
