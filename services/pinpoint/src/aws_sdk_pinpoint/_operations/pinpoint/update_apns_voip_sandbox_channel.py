...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.update_apns_voip_sandbox_channel_request.UpdateApnsVoipSandboxChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "apns_voip_sandbox_channel_request" in input_:
