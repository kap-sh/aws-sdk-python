...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_apns_sandbox_channel_response.DeleteApnsSandboxChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_apns_sandbox_channel_request.DeleteApnsSandboxChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
