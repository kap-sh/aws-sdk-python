"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetApp``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_app_response.GetAppResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_app_request.GetAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}"
...
def get_app(
    ...
    input_: aws_sdk_pinpoint.types.get_app_request.GetAppRequest,
) -> tuple[aws_sdk_pinpoint.types.get_app_response.GetAppResponse, zapros.Response]:
