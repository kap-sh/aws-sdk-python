"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateVoiceChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_voice_channel_response.UpdateVoiceChannelResponse = {
        "voice_channel_response": aws_sdk_pinpoint.types.voice_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.update_voice_channel_request.UpdateVoiceChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_voice_channel(
