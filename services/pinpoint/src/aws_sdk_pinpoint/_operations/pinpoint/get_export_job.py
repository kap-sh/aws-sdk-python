...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_export_job_response.GetExportJobResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_export_job_request.GetExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_export_job(
    ...
    aws_sdk_pinpoint.types.get_export_job_response.GetExportJobResponse, zapros.Response
]:
