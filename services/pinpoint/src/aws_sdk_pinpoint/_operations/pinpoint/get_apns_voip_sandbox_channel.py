...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_apns_voip_sandbox_channel_response.GetApnsVoipSandboxChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_apns_voip_sandbox_channel_request.GetApnsVoipSandboxChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
