...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_event_stream_response.DeleteEventStreamResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_event_stream_request.DeleteEventStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
