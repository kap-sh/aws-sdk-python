"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteCampaign``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_campaign_response.DeleteCampaignResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_campaign_request.DeleteCampaignRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
