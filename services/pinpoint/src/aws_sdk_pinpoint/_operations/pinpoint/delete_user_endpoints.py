"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteUserEndpoints``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_user_endpoints_response.DeleteUserEndpointsResponse = {
        "endpoints_response": aws_sdk_pinpoint.types.endpoints_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_user_endpoints_request.DeleteUserEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/users/{UserId}"
...
async def async_delete_user_endpoints(
