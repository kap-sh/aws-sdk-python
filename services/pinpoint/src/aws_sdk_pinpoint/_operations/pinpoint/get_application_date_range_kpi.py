...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_application_date_range_kpi_response.GetApplicationDateRangeKpiResponse = {
        "application_date_range_kpi_response": aws_sdk_pinpoint.types.application_date_range_kpi_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_application_date_range_kpi_request.GetApplicationDateRangeKpiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
