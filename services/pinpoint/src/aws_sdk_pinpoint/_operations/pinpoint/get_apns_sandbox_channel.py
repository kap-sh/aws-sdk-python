...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_apns_sandbox_channel_response.GetApnsSandboxChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_apns_sandbox_channel_request.GetApnsSandboxChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
