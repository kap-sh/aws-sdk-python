...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_in_app_messages_response.GetInAppMessagesResponse = {
        "in_app_messages_response": aws_sdk_pinpoint.types.in_app_messages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_in_app_messages_request.GetInAppMessagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
