...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_application_settings_response.UpdateApplicationSettingsResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.update_application_settings_request.UpdateApplicationSettingsRequest,
) -> zapros.Request:
    ...
    if "write_application_settings_request" in input:
        ...
        body: bytes | None = json.dumps(
            aws_sdk_pinpoint.types.write_application_settings_request.serialize_json(
                input["write_application_settings_request"]
            )
        ).encode()
