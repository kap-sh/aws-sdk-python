...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_endpoint_response.GetEndpointResponse = {
        "endpoint_response": aws_sdk_pinpoint.types.endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_endpoint_request.GetEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_endpoint(
    ...
    aws_sdk_pinpoint.types.get_endpoint_response.GetEndpointResponse, zapros.Response
]:
