"""Generated from Smithy shape ``com.amazonaws.pinpoint#CreatePushTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.create_push_template_response.CreatePushTemplateResponse = {
        "create_template_message_body": aws_sdk_pinpoint.types.create_template_message_body.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.create_push_template_request.CreatePushTemplateRequest,
) -> zapros.Request:
...
async def async_create_push_template(
