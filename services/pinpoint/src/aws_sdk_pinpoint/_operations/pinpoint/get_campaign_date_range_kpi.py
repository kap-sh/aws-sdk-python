"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetCampaignDateRangeKpi``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_campaign_date_range_kpi_response.GetCampaignDateRangeKpiResponse = {
        "campaign_date_range_kpi_response": aws_sdk_pinpoint.types.campaign_date_range_kpi_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_campaign_date_range_kpi_request.GetCampaignDateRangeKpiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_campaign_date_range_kpi(
