"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateAdmChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_adm_channel_response.UpdateAdmChannelResponse = {
        "adm_channel_response": aws_sdk_pinpoint.types.adm_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.update_adm_channel_request.UpdateAdmChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_adm_channel(
