"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetRecommenderConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_recommender_configurations_response.GetRecommenderConfigurationsResponse = {
        "list_recommender_configurations_response": aws_sdk_pinpoint.types.list_recommender_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_recommender_configurations_request.GetRecommenderConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/recommenders"
    params: dict[str, str] = {}
    if "page_size" in input_:
        params["page-size"] = str(input_["page_size"])
    if "token" in input_:
        params["token"] = str(input_["token"])
...
async def async_get_recommender_configurations(
