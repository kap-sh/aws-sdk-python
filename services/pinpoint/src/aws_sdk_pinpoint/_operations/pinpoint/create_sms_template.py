...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.create_sms_template_response.CreateSmsTemplateResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.create_sms_template_request.CreateSmsTemplateRequest,
) -> zapros.Request:
