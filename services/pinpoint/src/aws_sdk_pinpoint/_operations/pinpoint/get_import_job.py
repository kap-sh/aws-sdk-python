...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_import_job_response.GetImportJobResponse = {
        "import_job_response": aws_sdk_pinpoint.types.import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_import_job_request.GetImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_import_job(
    ...
    aws_sdk_pinpoint.types.get_import_job_response.GetImportJobResponse, zapros.Response
]:
