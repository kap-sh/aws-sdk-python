...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_apns_voip_channel_response.GetApnsVoipChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_apns_voip_channel_request.GetApnsVoipChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
