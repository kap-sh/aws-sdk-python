"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetCampaigns``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_campaigns_response.GetCampaignsResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_campaigns_request.GetCampaignsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_campaigns(
    ...
    aws_sdk_pinpoint.types.get_campaigns_response.GetCampaignsResponse, zapros.Response
]:
