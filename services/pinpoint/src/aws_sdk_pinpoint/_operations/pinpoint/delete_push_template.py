...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_push_template_response.DeletePushTemplateResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_push_template_request.DeletePushTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
