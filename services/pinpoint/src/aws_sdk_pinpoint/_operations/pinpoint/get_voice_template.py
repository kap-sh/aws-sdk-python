"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetVoiceTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_voice_template_response.GetVoiceTemplateResponse = {
        "voice_template_response": aws_sdk_pinpoint.types.voice_template_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.get_voice_template_request.GetVoiceTemplateRequest,
) -> zapros.Request:
...
async def async_get_voice_template(
