...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_campaign_version_response.GetCampaignVersionResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_campaign_version_request.GetCampaignVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
