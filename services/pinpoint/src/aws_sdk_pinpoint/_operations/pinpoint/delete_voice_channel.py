"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteVoiceChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_voice_channel_response.DeleteVoiceChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_voice_channel_request.DeleteVoiceChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_voice_channel(
