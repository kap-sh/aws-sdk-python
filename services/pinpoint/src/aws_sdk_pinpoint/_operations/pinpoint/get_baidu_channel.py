...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_baidu_channel_response.GetBaiduChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_baidu_channel_request.GetBaiduChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
