"""Generated from Smithy shape ``com.amazonaws.pinpoint#CreateSegment``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.create_segment_response.CreateSegmentResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.create_segment_request.CreateSegmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_segment(
