...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_email_channel_response.DeleteEmailChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_email_channel_request.DeleteEmailChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
