"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetJourneyDateRangeKpi``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_journey_date_range_kpi_response.GetJourneyDateRangeKpiResponse = {
        "journey_date_range_kpi_response": aws_sdk_pinpoint.types.journey_date_range_kpi_response.deserialize_json(
