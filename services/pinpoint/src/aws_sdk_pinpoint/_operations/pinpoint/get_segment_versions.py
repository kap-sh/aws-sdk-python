"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetSegmentVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_segment_versions_response.GetSegmentVersionsResponse = {
        "segments_response": aws_sdk_pinpoint.types.segments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_segment_versions_request.GetSegmentVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_segment_versions(
