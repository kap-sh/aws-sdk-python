"""Generated from Smithy shape ``com.amazonaws.pinpoint#CreateEmailTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.create_email_template_response.CreateEmailTemplateResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.create_email_template_request.CreateEmailTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_email_template(
