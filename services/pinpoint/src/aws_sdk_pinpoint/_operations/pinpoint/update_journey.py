...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_pinpoint.errors.conflict_exception

            raise aws_sdk_pinpoint.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_journey_response.UpdateJourneyResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.update_journey_request.UpdateJourneyRequest,
) -> zapros.Request:
