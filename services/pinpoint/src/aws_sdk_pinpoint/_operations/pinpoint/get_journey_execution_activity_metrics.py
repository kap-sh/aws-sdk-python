"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetJourneyExecutionActivityMetrics``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_journey_execution_activity_metrics_response.GetJourneyExecutionActivityMetricsResponse = {
        "journey_execution_activity_metrics_response": aws_sdk_pinpoint.types.journey_execution_activity_metrics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_journey_execution_activity_metrics_request.GetJourneyExecutionActivityMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{JourneyActivityId}", quote(str(input_["journey_activity_id"]), safe="")
    )
...
async def async_get_journey_execution_activity_metrics(
