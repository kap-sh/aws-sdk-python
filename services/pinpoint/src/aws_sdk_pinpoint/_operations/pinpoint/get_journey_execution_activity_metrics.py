...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.get_journey_execution_activity_metrics_request.GetJourneyExecutionActivityMetricsRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{JourneyActivityId}", quote(str(input["journey_activity_id"]), safe="")
    )
