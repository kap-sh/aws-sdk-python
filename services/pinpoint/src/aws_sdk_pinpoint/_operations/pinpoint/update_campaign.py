"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateCampaign``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_campaign_response.UpdateCampaignResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.update_campaign_request.UpdateCampaignRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
