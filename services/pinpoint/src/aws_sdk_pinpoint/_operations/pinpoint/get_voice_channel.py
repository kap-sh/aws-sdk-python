...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_voice_channel_response.GetVoiceChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_voice_channel_request.GetVoiceChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
