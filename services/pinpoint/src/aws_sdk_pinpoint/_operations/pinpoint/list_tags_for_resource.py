"""Generated from Smithy shape ``com.amazonaws.pinpoint#ListTagsForResource``."""
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
