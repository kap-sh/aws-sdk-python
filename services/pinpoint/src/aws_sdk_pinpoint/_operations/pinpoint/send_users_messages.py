...
def handle_response(
    ...
    import aws_sdk_pinpoint.types.send_users_message_response

    out: aws_sdk_pinpoint.types.send_users_messages_response.SendUsersMessagesResponse = {
        "send_users_message_response": aws_sdk_pinpoint.types.send_users_message_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.send_users_messages_request.SendUsersMessagesRequest,
) -> zapros.Request:
    ...
    if "send_users_message_request" in input:
        ...
        body: bytes | None = json.dumps(
            aws_sdk_pinpoint.types.send_users_message_request.serialize_json(
                input["send_users_message_request"]
            )
        ).encode()
