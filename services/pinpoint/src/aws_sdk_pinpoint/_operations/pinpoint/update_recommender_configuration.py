...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_recommender_configuration_response.UpdateRecommenderConfigurationResponse = {
        "recommender_configuration_response": aws_sdk_pinpoint.types.recommender_configuration_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.update_recommender_configuration_request.UpdateRecommenderConfigurationRequest,
) -> zapros.Request:
    ...
    url = url.replace("{RecommenderId}", quote(str(input["recommender_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    if "update_recommender_configuration" in input:
        import aws_sdk_pinpoint.types.update_recommender_configuration_shape

        body: bytes | None = json.dumps(
            aws_sdk_pinpoint.types.update_recommender_configuration_shape.serialize_json(
