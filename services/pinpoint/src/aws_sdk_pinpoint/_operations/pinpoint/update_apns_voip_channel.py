...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_apns_voip_channel_response.UpdateApnsVoipChannelResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.update_apns_voip_channel_request.UpdateApnsVoipChannelRequest,
) -> zapros.Request:
    ...
    if "apns_voip_channel_request" in input:
