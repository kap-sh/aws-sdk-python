...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.create_app_request.CreateAppRequest,
) -> zapros.Request:
    ...
    if "create_application_request" in input:
        ...
        body: bytes | None = json.dumps(
            aws_sdk_pinpoint.types.create_application_request.serialize_json(
                input["create_application_request"]
            )
        ).encode()
...
def create_app(
    ...
    aws_sdk_pinpoint.types.create_app_response.CreateAppResponse, zapros.Response
]:
