"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetInAppTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_in_app_template_response.GetInAppTemplateResponse = {
        "in_app_template_response": aws_sdk_pinpoint.types.in_app_template_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.get_in_app_template_request.GetInAppTemplateRequest,
) -> zapros.Request:
...
async def async_get_in_app_template(
