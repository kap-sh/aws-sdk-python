"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteGcmChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_gcm_channel_response.DeleteGcmChannelResponse = {
        "gcm_channel_response": aws_sdk_pinpoint.types.gcm_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_gcm_channel_request.DeleteGcmChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/channels/gcm"
...
async def async_delete_gcm_channel(
