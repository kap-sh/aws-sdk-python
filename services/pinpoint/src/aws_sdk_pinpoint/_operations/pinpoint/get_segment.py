"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetSegment``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_segment_response.GetSegmentResponse = {
        "segment_response": aws_sdk_pinpoint.types.segment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_segment_request.GetSegmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/segments/{SegmentId}"
    url = url.replace("{ApplicationId}", quote(str(input_["application_id"]), safe=""))
    url = url.replace("{SegmentId}", quote(str(input_["segment_id"]), safe=""))
    params: dict[str, str] = {}
...
def get_segment(
    ...
    aws_sdk_pinpoint.types.get_segment_response.GetSegmentResponse, zapros.Response
]:
