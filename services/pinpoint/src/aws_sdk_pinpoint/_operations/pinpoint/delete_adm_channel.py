...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_adm_channel_response.DeleteAdmChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_adm_channel_request.DeleteAdmChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
