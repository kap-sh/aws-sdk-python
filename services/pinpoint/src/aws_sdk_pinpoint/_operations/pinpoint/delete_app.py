...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_app_response.DeleteAppResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_app_request.DeleteAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_app(
    ...
    aws_sdk_pinpoint.types.delete_app_response.DeleteAppResponse, zapros.Response
]:
