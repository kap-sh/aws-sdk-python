"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetApnsChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_apns_channel_response.GetApnsChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_apns_channel_request.GetApnsChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_apns_channel(
