...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_segments_response.GetSegmentsResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_segments_request.GetSegmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_segments(
    ...
    aws_sdk_pinpoint.types.get_segments_response.GetSegmentsResponse, zapros.Response
]:
