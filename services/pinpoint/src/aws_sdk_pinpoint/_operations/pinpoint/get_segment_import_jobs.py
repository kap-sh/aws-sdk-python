...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_segment_import_jobs_response.GetSegmentImportJobsResponse = {
        "import_jobs_response": aws_sdk_pinpoint.types.import_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_segment_import_jobs_request.GetSegmentImportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
