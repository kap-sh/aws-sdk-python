...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.list_templates_response.ListTemplatesResponse = {
        "templates_response": aws_sdk_pinpoint.types.templates_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.list_templates_request.ListTemplatesRequest,
) -> zapros.Request:
    ...
    if "template_type" in input:
        params["template-type"] = str(input["template_type"])
