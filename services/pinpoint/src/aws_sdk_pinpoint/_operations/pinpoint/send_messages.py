...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.send_messages_response.SendMessagesResponse = {
        "message_response": aws_sdk_pinpoint.types.message_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.send_messages_request.SendMessagesRequest,
) -> zapros.Request:
    ...
    if "message_request" in input:
        import aws_sdk_pinpoint.types.message_request

        body: bytes | None = json.dumps(
            aws_sdk_pinpoint.types.message_request.serialize_json(
...
def send_messages(
    ...
    aws_sdk_pinpoint.types.send_messages_response.SendMessagesResponse, zapros.Response
]:
