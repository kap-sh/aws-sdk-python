...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.put_event_stream_response.PutEventStreamResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.put_event_stream_request.PutEventStreamRequest,
) -> zapros.Request:
