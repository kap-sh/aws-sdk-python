...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_gcm_channel_response.UpdateGcmChannelResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.update_gcm_channel_request.UpdateGcmChannelRequest,
) -> zapros.Request:
