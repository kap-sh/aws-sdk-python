"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteApnsVoipChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_apns_voip_channel_response.DeleteApnsVoipChannelResponse = {
        "apns_voip_channel_response": aws_sdk_pinpoint.types.apns_voip_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_apns_voip_channel_request.DeleteApnsVoipChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/channels/apns_voip"
...
async def async_delete_apns_voip_channel(
