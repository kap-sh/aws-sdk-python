"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateSmsChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_sms_channel_response.UpdateSmsChannelResponse = {
        "sms_channel_response": aws_sdk_pinpoint.types.sms_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.update_sms_channel_request.UpdateSmsChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "sms_channel_request" in input_:
        import aws_sdk_pinpoint.types.sms_channel_request

        body: bytes | None = json.dumps(
            aws_sdk_pinpoint.types.sms_channel_request.serialize_json(
                input_["sms_channel_request"]
            )
        ).encode()
...
async def async_update_sms_channel(
