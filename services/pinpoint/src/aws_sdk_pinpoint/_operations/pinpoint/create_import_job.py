...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.create_import_job_response.CreateImportJobResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.create_import_job_request.CreateImportJobRequest,
) -> zapros.Request:
    ...
    if "import_job_request" in input:
