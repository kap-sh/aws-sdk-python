"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetCampaign``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_campaign_response.GetCampaignResponse = {
        "campaign_response": aws_sdk_pinpoint.types.campaign_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_campaign_request.GetCampaignRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/campaigns/{CampaignId}"
...
def get_campaign(
    ...
    aws_sdk_pinpoint.types.get_campaign_response.GetCampaignResponse, zapros.Response
]:
