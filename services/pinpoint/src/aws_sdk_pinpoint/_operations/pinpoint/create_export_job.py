"""Generated from Smithy shape ``com.amazonaws.pinpoint#CreateExportJob``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.create_export_job_response.CreateExportJobResponse = {
        "export_job_response": aws_sdk_pinpoint.types.export_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.create_export_job_request.CreateExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_export_job(
