...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_push_template_response.GetPushTemplateResponse = {
        "push_notification_template_response": aws_sdk_pinpoint.types.push_notification_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_push_template_request.GetPushTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
