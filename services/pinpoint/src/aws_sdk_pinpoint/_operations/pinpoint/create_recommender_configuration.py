...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.create_recommender_configuration_response.CreateRecommenderConfigurationResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.create_recommender_configuration_request.CreateRecommenderConfigurationRequest,
) -> zapros.Request:
    ...
    if "create_recommender_configuration" in input:
