...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_sms_template_response.GetSmsTemplateResponse = {
        "sms_template_response": aws_sdk_pinpoint.types.sms_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_sms_template_request.GetSmsTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
