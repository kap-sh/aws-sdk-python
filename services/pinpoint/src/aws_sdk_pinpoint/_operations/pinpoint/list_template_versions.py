"""Generated from Smithy shape ``com.amazonaws.pinpoint#ListTemplateVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.list_template_versions_response.ListTemplateVersionsResponse = {
        "template_versions_response": aws_sdk_pinpoint.types.template_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.list_template_versions_request.ListTemplateVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_template_versions(
