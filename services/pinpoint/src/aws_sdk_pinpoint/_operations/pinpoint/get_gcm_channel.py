"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetGcmChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_gcm_channel_response.GetGcmChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_gcm_channel_request.GetGcmChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_gcm_channel(
