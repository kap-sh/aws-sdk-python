"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteVoiceTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_voice_template_response.DeleteVoiceTemplateResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.delete_voice_template_request.DeleteVoiceTemplateRequest,
) -> zapros.Request:
...
async def async_delete_voice_template(
