...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.update_email_template_request.UpdateEmailTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
