"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateEmailTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_email_template_response.UpdateEmailTemplateResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.update_email_template_request.UpdateEmailTemplateRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/templates/{TemplateName}/email"
...
async def async_update_email_template(
