"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetExportJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_export_jobs_response.GetExportJobsResponse = {
        "export_jobs_response": aws_sdk_pinpoint.types.export_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_export_jobs_request.GetExportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_export_jobs(
