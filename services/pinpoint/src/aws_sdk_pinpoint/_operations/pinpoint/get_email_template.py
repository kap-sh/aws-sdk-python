...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_email_template_response.GetEmailTemplateResponse = {
        "email_template_response": aws_sdk_pinpoint.types.email_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_email_template_request.GetEmailTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
