...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_recommender_configuration_response.GetRecommenderConfigurationResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.get_recommender_configuration_request.GetRecommenderConfigurationRequest,
) -> zapros.Request:
