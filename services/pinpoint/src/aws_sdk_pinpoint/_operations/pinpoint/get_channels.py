...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_channels_response.GetChannelsResponse = {
        "channels_response": aws_sdk_pinpoint.types.channels_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_channels_request.GetChannelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_channels(
    ...
    aws_sdk_pinpoint.types.get_channels_response.GetChannelsResponse, zapros.Response
]:
