...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_email_channel_response.UpdateEmailChannelResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.update_email_channel_request.UpdateEmailChannelRequest,
) -> zapros.Request:
