"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetJourneyRuns``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_journey_runs_response.GetJourneyRunsResponse = {
        "journey_runs_response": aws_sdk_pinpoint.types.journey_runs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_journey_runs_request.GetJourneyRunsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/journeys/{JourneyId}/runs"
    )
...
async def async_get_journey_runs(
