...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_journey_state_response.UpdateJourneyStateResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.update_journey_state_request.UpdateJourneyStateRequest,
) -> zapros.Request:
