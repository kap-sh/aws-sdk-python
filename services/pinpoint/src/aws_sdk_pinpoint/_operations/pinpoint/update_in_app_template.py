"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateInAppTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_in_app_template_response.UpdateInAppTemplateResponse = {
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.update_in_app_template_request.UpdateInAppTemplateRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/templates/{TemplateName}/inapp"
...
async def async_update_in_app_template(
