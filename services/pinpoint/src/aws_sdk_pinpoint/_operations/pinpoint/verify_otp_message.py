...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.verify_otp_message_response.VerifyOTPMessageResponse = {
        "verification_response": aws_sdk_pinpoint.types.verification_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_pinpoint.types.verify_otp_message_request.VerifyOTPMessageRequest,
) -> zapros.Request:
    ...
    if "verify_otp_message_request_parameters" in input:
