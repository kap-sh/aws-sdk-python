"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetJourneyExecutionMetrics``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_journey_execution_metrics_response.GetJourneyExecutionMetricsResponse = {
        "journey_execution_metrics_response": aws_sdk_pinpoint.types.journey_execution_metrics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_journey_execution_metrics_request.GetJourneyExecutionMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_journey_execution_metrics(
