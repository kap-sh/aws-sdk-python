...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_in_app_template_response.DeleteInAppTemplateResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_in_app_template_request.DeleteInAppTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
