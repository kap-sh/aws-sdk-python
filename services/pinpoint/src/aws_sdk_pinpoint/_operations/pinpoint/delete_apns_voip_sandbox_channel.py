...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.delete_apns_voip_sandbox_channel_response.DeleteApnsVoipSandboxChannelResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.delete_apns_voip_sandbox_channel_request.DeleteApnsVoipSandboxChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
