"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateEndpointsBatch``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.update_endpoints_batch_response.UpdateEndpointsBatchResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.update_endpoints_batch_request.UpdateEndpointsBatchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_endpoints_batch(
