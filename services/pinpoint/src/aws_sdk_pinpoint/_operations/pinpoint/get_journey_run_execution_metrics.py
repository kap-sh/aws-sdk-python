"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetJourneyRunExecutionMetrics``."""
...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_journey_run_execution_metrics_response.GetJourneyRunExecutionMetricsResponse = {
        "journey_run_execution_metrics_response": aws_sdk_pinpoint.types.journey_run_execution_metrics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_journey_run_execution_metrics_request.GetJourneyRunExecutionMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_journey_run_execution_metrics(
