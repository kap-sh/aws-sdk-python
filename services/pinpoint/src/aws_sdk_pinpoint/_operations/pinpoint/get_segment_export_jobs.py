...
def handle_response(
    ...
    out: aws_sdk_pinpoint.types.get_segment_export_jobs_response.GetSegmentExportJobsResponse = {
...
def build_request(
    ...
    input_: aws_sdk_pinpoint.types.get_segment_export_jobs_request.GetSegmentExportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
