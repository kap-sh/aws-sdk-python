...
class DeployActionExecutionTarget(TypedDict, closed=True):
    ...
    events: NotRequired[
        "aws_sdk_codepipeline.types.deploy_target_event_list.DeployTargetEventList"
    ]
...
def serialize_aws_json_1_1(value: DeployActionExecutionTarget) -> dict:
    ...
    if "events" in value:
        ...
        out["events"] = (
            aws_sdk_codepipeline.types.deploy_target_event_list.serialize_aws_json_1_1(
                value["events"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DeployActionExecutionTarget:
    ...
    if "events" in data:
        ...
        out["events"] = (
            aws_sdk_codepipeline.types.deploy_target_event_list.deserialize_aws_json_1_1(
                data["events"]
            )
        )
    return out
