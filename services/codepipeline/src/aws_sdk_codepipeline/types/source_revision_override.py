...
class SourceRevisionOverride(TypedDict, closed=True):
    ...
    revision_value: "aws_sdk_codepipeline.types.revision.Revision"
...
def serialize_aws_json_1_1(value: SourceRevisionOverride) -> dict:
    ...
    out["revisionType"] = (
        aws_sdk_codepipeline.types.source_revision_type.serialize_aws_json_1_1(
            value["revision_type"]
        )
    )
...
def deserialize_aws_json_1_1(data: dict) -> SourceRevisionOverride:
    ...
    if "revisionType" in data:
        ...
        out["revision_type"] = (
            aws_sdk_codepipeline.types.source_revision_type.deserialize_aws_json_1_1(
                data["revisionType"]
            )
        )
    else:
