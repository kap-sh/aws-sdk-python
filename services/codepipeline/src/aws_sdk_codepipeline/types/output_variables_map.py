...
if TYPE_CHECKING:
    import aws_sdk_codepipeline.types.output_variables_key
    import aws_sdk_codepipeline.types.output_variables_value

OutputVariablesMap: TypeAlias = dict[
    "aws_sdk_codepipeline.types.output_variables_key.OutputVariablesKey",
    "aws_sdk_codepipeline.types.output_variables_value.OutputVariablesValue",
]
