...
if TYPE_CHECKING:
    import aws_sdk_codepipeline.types.condition_execution
    import aws_sdk_codepipeline.types.rule_state_list


class ConditionState(TypedDict, closed=True):
    latest_execution: NotRequired[
        "aws_sdk_codepipeline.types.condition_execution.ConditionExecution"
    ]
    """<p>The state of the latest run of the rule.</p>"""
    rule_states: NotRequired["aws_sdk_codepipeline.types.rule_state_list.RuleStateList"]
...
def serialize_aws_json_1_1(value: ConditionState) -> dict:
    ...
    if "latest_execution" in value:
        ...
        out["latestExecution"] = (
            aws_sdk_codepipeline.types.condition_execution.serialize_aws_json_1_1(
    ...
    if "rule_states" in value:
        ...
        out["ruleStates"] = (
            aws_sdk_codepipeline.types.rule_state_list.serialize_aws_json_1_1(
                value["rule_states"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ConditionState:
    ...
    if "latestExecution" in data:
        ...
        out["latest_execution"] = (
            aws_sdk_codepipeline.types.condition_execution.deserialize_aws_json_1_1(
    ...
    if "ruleStates" in data:
        ...
        out["rule_states"] = (
            aws_sdk_codepipeline.types.rule_state_list.deserialize_aws_json_1_1(
                data["ruleStates"]
            )
        )
    return out
