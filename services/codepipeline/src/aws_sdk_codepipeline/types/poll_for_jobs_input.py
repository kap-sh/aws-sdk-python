...
class PollForJobsInput(TypedDict):
    ...
    query_param: NotRequired["aws_sdk_codepipeline.types.query_param_map.QueryParamMap"]
...
def serialize_aws_json_1_1(value: PollForJobsInput) -> dict:
    ...
    if "query_param" in value:
        ...
        out["queryParam"] = (
            aws_sdk_codepipeline.types.query_param_map.serialize_aws_json_1_1(
                value["query_param"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> PollForJobsInput:
    ...
    if "queryParam" in data:
        ...
        out["query_param"] = (
            aws_sdk_codepipeline.types.query_param_map.deserialize_aws_json_1_1(
                data["queryParam"]
            )
        )
    return out
