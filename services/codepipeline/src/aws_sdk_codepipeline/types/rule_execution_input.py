...
if TYPE_CHECKING:
    ...
    import aws_sdk_codepipeline.types.resolved_rule_configuration_map
    import aws_sdk_codepipeline.types.role_arn
    import aws_sdk_codepipeline.types.rule_configuration_map
...
class RuleExecutionInput(TypedDict):
    ...
    resolved_configuration: NotRequired[
        "aws_sdk_codepipeline.types.resolved_rule_configuration_map.ResolvedRuleConfigurationMap"
    ]
...
def serialize_aws_json_1_1(value: RuleExecutionInput) -> dict:
    ...
    if "rule_type_id" in value:
        ...
        out["ruleTypeId"] = (
            aws_sdk_codepipeline.types.rule_type_id.serialize_aws_json_1_1(
                value["rule_type_id"]
            )
        )
    if "configuration" in value:
        ...
        out["configuration"] = (
            aws_sdk_codepipeline.types.rule_configuration_map.serialize_aws_json_1_1(
                value["configuration"]
            )
        )
    if "resolved_configuration" in value:
        ...
        out["resolvedConfiguration"] = (
            aws_sdk_codepipeline.types.resolved_rule_configuration_map.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RuleExecutionInput:
    ...
    if "ruleTypeId" in data:
        ...
        out["rule_type_id"] = (
            aws_sdk_codepipeline.types.rule_type_id.deserialize_aws_json_1_1(
                data["ruleTypeId"]
            )
        )
    if "configuration" in data:
        ...
        out["configuration"] = (
            aws_sdk_codepipeline.types.rule_configuration_map.deserialize_aws_json_1_1(
                data["configuration"]
            )
        )
    if "resolvedConfiguration" in data:
        ...
        out["resolved_configuration"] = (
            aws_sdk_codepipeline.types.resolved_rule_configuration_map.deserialize_aws_json_1_1(
