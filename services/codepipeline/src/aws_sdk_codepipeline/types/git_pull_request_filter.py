...
if TYPE_CHECKING:
    ...
    import aws_sdk_codepipeline.types.git_pull_request_event_type_list


class GitPullRequestFilter(TypedDict):
    events: NotRequired[
        "aws_sdk_codepipeline.types.git_pull_request_event_type_list.GitPullRequestEventTypeList"
    ]
...
def serialize_aws_json_1_1(value: GitPullRequestFilter) -> dict:
    ...
    if "events" in value:
        ...
        out["events"] = (
            aws_sdk_codepipeline.types.git_pull_request_event_type_list.serialize_aws_json_1_1(
                value["events"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GitPullRequestFilter:
    ...
    if "events" in data:
        ...
        out["events"] = (
            aws_sdk_codepipeline.types.git_pull_request_event_type_list.deserialize_aws_json_1_1(
                data["events"]
            )
        )
    if "branches" in data:
