...
class ListActionTypesOutput(TypedDict):
    action_types: "aws_sdk_codepipeline.types.action_type_list.ActionTypeList"
...
def serialize_aws_json_1_1(value: ListActionTypesOutput) -> dict:
    ...
    out["actionTypes"] = (
        aws_sdk_codepipeline.types.action_type_list.serialize_aws_json_1_1(
            value["action_types"]
        )
    )
...
def deserialize_aws_json_1_1(data: dict) -> ListActionTypesOutput:
    ...
    if "actionTypes" in data:
        ...
        out["action_types"] = (
            aws_sdk_codepipeline.types.action_type_list.deserialize_aws_json_1_1(
                data["actionTypes"]
            )
        )
    else:
