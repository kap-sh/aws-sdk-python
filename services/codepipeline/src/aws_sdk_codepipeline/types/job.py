...
if TYPE_CHECKING:
    import aws_sdk_codepipeline.types.account_id
    import aws_sdk_codepipeline.types.job_data
    import aws_sdk_codepipeline.types.job_id
    import aws_sdk_codepipeline.types.nonce


class Job(TypedDict, closed=True):
    id: NotRequired["aws_sdk_codepipeline.types.job_id.JobId"]
    """<p>The unique system-generated ID of the job.</p>"""
    data: NotRequired["aws_sdk_codepipeline.types.job_data.JobData"]
    ...
    account_id: NotRequired["aws_sdk_codepipeline.types.account_id.AccountId"]
...
def serialize_aws_json_1_1(value: Job) -> dict:
    ...
    if "data" in value:
        ...
        out["data"] = aws_sdk_codepipeline.types.job_data.serialize_aws_json_1_1(
            value["data"]
        )
    if "nonce" in value:
...
def deserialize_aws_json_1_1(data: dict) -> Job:
    ...
    if "data" in data:
        ...
        out["data"] = aws_sdk_codepipeline.types.job_data.deserialize_aws_json_1_1(
            data["data"]
        )
    if "nonce" in data:
