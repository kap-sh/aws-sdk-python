...
if TYPE_CHECKING:
    ...
    import aws_sdk_codepipeline.types.action_configuration_queryable_value

QueryParamMap: TypeAlias = dict[
    "aws_sdk_codepipeline.types.action_configuration_key.ActionConfigurationKey",
    "aws_sdk_codepipeline.types.action_configuration_queryable_value.ActionConfigurationQueryableValue",
]
