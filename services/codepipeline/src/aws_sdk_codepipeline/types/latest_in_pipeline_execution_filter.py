...
class LatestInPipelineExecutionFilter(TypedDict, closed=True):
    ...
    start_time_range: "aws_sdk_codepipeline.types.start_time_range.StartTimeRange"
...
def serialize_aws_json_1_1(value: LatestInPipelineExecutionFilter) -> dict:
    ...
    out["startTimeRange"] = (
        aws_sdk_codepipeline.types.start_time_range.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LatestInPipelineExecutionFilter:
    ...
    if "startTimeRange" in data:
        ...
        out["start_time_range"] = (
            aws_sdk_codepipeline.types.start_time_range.deserialize_aws_json_1_1(
                data["startTimeRange"]
            )
        )
    else:
