...
def serialize_aws_json_1_1(value: GetPipelineOutput) -> dict:
    ...
    if "metadata" in value:
        ...
        out["metadata"] = (
            aws_sdk_codepipeline.types.pipeline_metadata.serialize_aws_json_1_1(
                value["metadata"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetPipelineOutput:
    ...
    if "metadata" in data:
        ...
        out["metadata"] = (
            aws_sdk_codepipeline.types.pipeline_metadata.deserialize_aws_json_1_1(
                data["metadata"]
            )
        )
    return out
