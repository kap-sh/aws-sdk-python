...
def serialize_aws_json_1_1(value: ListDeployActionExecutionTargetsOutput) -> dict:
    ...
    if "targets" in value:
        ...
        out["targets"] = (
            aws_sdk_codepipeline.types.deploy_action_execution_target_list.serialize_aws_json_1_1(
                value["targets"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListDeployActionExecutionTargetsOutput:
    ...
    if "targets" in data:
        ...
        out["targets"] = (
            aws_sdk_codepipeline.types.deploy_action_execution_target_list.deserialize_aws_json_1_1(
                data["targets"]
            )
        )
