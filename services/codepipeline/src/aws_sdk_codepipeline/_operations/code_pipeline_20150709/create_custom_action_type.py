...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.create_custom_action_type_output.CreateCustomActionTypeOutput = aws_sdk_codepipeline.types.create_custom_action_type_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.create_custom_action_type_input.CreateCustomActionTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.create_custom_action_type_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
