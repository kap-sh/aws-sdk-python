...
def build_request(
    ...
    input: aws_sdk_codepipeline.types.update_pipeline_input.UpdatePipelineInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.update_pipeline_input.serialize_aws_json_1_1(input)
    ).encode()
