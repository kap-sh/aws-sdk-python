...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.update_pipeline_output.UpdatePipelineOutput = (
        aws_sdk_codepipeline.types.update_pipeline_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.update_pipeline_input.UpdatePipelineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.update_pipeline_input.serialize_aws_json_1_1(input_)
    ).encode()
