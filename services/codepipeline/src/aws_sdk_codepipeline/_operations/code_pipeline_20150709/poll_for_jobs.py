...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.poll_for_jobs_output.PollForJobsOutput = (
        aws_sdk_codepipeline.types.poll_for_jobs_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.poll_for_jobs_input.PollForJobsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.poll_for_jobs_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def poll_for_jobs(
    ...
    aws_sdk_codepipeline.types.poll_for_jobs_output.PollForJobsOutput, zapros.Response
]:
