"""Generated from Smithy shape ``com.amazonaws.codepipeline#OverrideStageCondition``."""
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.override_stage_condition_input.OverrideStageConditionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodePipeline_20150709.OverrideStageCondition"
    import aws_sdk_codepipeline.types.override_stage_condition_input

    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.override_stage_condition_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_override_stage_condition(
