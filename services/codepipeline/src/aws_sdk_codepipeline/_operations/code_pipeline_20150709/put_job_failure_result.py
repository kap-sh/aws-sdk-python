...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.put_job_failure_result_input.PutJobFailureResultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.put_job_failure_result_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
