"""Generated from Smithy shape ``com.amazonaws.codepipeline#DeletePipeline``."""
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.delete_pipeline_input.DeletePipelineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.delete_pipeline_input.serialize_aws_json_1_1(input_)
    ).encode()
