...
def build_request(
    ...
    input: aws_sdk_codepipeline.types.acknowledge_job_input.AcknowledgeJobInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.acknowledge_job_input.serialize_aws_json_1_1(input)
    ).encode()
