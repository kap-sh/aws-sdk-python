"""Generated from Smithy shape ``com.amazonaws.codepipeline#AcknowledgeJob``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidNonceException":
            import aws_sdk_codepipeline.errors.invalid_nonce_exception

            raise aws_sdk_codepipeline.errors.invalid_nonce_exception.InvalidNonceException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.acknowledge_job_output.AcknowledgeJobOutput = (
        aws_sdk_codepipeline.types.acknowledge_job_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.acknowledge_job_input.AcknowledgeJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.acknowledge_job_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_acknowledge_job(
