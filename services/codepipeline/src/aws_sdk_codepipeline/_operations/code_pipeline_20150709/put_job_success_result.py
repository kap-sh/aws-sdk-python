"""Generated from Smithy shape ``com.amazonaws.codepipeline#PutJobSuccessResult``."""
...
import aws_sdk_codepipeline.errors.output_variables_size_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OutputVariablesSizeExceededException":
            raise aws_sdk_codepipeline.errors.output_variables_size_exceeded_exception.OutputVariablesSizeExceededException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.put_job_success_result_input.PutJobSuccessResultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.put_job_success_result_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_job_success_result(
