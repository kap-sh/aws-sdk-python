...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ActionNotFoundException":
            import aws_sdk_codepipeline.errors.action_not_found_exception

            raise aws_sdk_codepipeline.errors.action_not_found_exception.ActionNotFoundException.from_aws_json_1_1(
                data
            )
        case "ApprovalAlreadyCompletedException":
            import aws_sdk_codepipeline.errors.approval_already_completed_exception

            raise aws_sdk_codepipeline.errors.approval_already_completed_exception.ApprovalAlreadyCompletedException.from_aws_json_1_1(
                data
            )
        case "InvalidApprovalTokenException":
            import aws_sdk_codepipeline.errors.invalid_approval_token_exception

            raise aws_sdk_codepipeline.errors.invalid_approval_token_exception.InvalidApprovalTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.put_approval_result_output.PutApprovalResultOutput = aws_sdk_codepipeline.types.put_approval_result_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.put_approval_result_input.PutApprovalResultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.put_approval_result_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
