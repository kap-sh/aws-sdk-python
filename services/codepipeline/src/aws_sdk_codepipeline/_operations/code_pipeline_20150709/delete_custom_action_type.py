...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.delete_custom_action_type_input.DeleteCustomActionTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.delete_custom_action_type_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
