...
def build_request(
    ...
    input: aws_sdk_codepipeline.types.get_job_details_input.GetJobDetailsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.get_job_details_input.serialize_aws_json_1_1(input)
    ).encode()
