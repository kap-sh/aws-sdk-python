"""Generated from Smithy shape ``com.amazonaws.codepipeline#TagResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidArnException":
            import aws_sdk_codepipeline.errors.invalid_arn_exception

            raise aws_sdk_codepipeline.errors.invalid_arn_exception.InvalidArnException.from_aws_json_1_1(
                data
            )
        ...
        case "ResourceNotFoundException":
            import aws_sdk_codepipeline.errors.resource_not_found_exception

            raise aws_sdk_codepipeline.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.tag_resource_input.TagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.tag_resource_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_codepipeline.types.tag_resource_output.TagResourceOutput, zapros.Response
]:
