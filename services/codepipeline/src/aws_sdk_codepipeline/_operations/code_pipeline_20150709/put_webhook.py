"""Generated from Smithy shape ``com.amazonaws.codepipeline#PutWebhook``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidWebhookAuthenticationParametersException":
            import aws_sdk_codepipeline.errors.invalid_webhook_authentication_parameters_exception

            raise aws_sdk_codepipeline.errors.invalid_webhook_authentication_parameters_exception.InvalidWebhookAuthenticationParametersException.from_aws_json_1_1(
                data
            )
        case "InvalidWebhookFilterPatternException":
            import aws_sdk_codepipeline.errors.invalid_webhook_filter_pattern_exception

            raise aws_sdk_codepipeline.errors.invalid_webhook_filter_pattern_exception.InvalidWebhookFilterPatternException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.put_webhook_output.PutWebhookOutput = (
        aws_sdk_codepipeline.types.put_webhook_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.put_webhook_input.PutWebhookInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.put_webhook_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_webhook(
    ...
    aws_sdk_codepipeline.types.put_webhook_output.PutWebhookOutput, zapros.Response
]:
