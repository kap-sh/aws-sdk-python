"""Generated from Smithy shape ``com.amazonaws.codepipeline#ListActionTypes``."""
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.list_action_types_output.ListActionTypesOutput = (
        aws_sdk_codepipeline.types.list_action_types_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_codepipeline.types.list_action_types_input.ListActionTypesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.list_action_types_input.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_list_action_types(
