...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.get_pipeline_execution_output.GetPipelineExecutionOutput = aws_sdk_codepipeline.types.get_pipeline_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.get_pipeline_execution_input.GetPipelineExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.get_pipeline_execution_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
