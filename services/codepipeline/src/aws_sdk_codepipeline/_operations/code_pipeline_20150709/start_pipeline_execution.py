...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.start_pipeline_execution_input.StartPipelineExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.start_pipeline_execution_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
