...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.acknowledge_third_party_job_output.AcknowledgeThirdPartyJobOutput = aws_sdk_codepipeline.types.acknowledge_third_party_job_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.acknowledge_third_party_job_input.AcknowledgeThirdPartyJobInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.acknowledge_third_party_job_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
