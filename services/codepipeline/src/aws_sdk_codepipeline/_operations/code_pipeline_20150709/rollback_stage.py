...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PipelineExecutionOutdatedException":
            import aws_sdk_codepipeline.errors.pipeline_execution_outdated_exception

            raise aws_sdk_codepipeline.errors.pipeline_execution_outdated_exception.PipelineExecutionOutdatedException.from_aws_json_1_1(
                data
            )
        ...
        case "UnableToRollbackStageException":
            import aws_sdk_codepipeline.errors.unable_to_rollback_stage_exception

            raise aws_sdk_codepipeline.errors.unable_to_rollback_stage_exception.UnableToRollbackStageException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.rollback_stage_output.RollbackStageOutput = (
        aws_sdk_codepipeline.types.rollback_stage_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_codepipeline.types.rollback_stage_input.RollbackStageInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.rollback_stage_input.serialize_aws_json_1_1(input)
    ).encode()
