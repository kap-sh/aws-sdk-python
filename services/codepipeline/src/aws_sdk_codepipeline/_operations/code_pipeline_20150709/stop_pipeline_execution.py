...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DuplicatedStopRequestException":
            import aws_sdk_codepipeline.errors.duplicated_stop_request_exception

            raise aws_sdk_codepipeline.errors.duplicated_stop_request_exception.DuplicatedStopRequestException.from_aws_json_1_1(
                data
            )
        case "PipelineExecutionNotStoppableException":
            import aws_sdk_codepipeline.errors.pipeline_execution_not_stoppable_exception

            raise aws_sdk_codepipeline.errors.pipeline_execution_not_stoppable_exception.PipelineExecutionNotStoppableException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.stop_pipeline_execution_output.StopPipelineExecutionOutput = aws_sdk_codepipeline.types.stop_pipeline_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.stop_pipeline_execution_input.StopPipelineExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.stop_pipeline_execution_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
