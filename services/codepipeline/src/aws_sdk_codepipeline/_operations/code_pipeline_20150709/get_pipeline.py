"""Generated from Smithy shape ``com.amazonaws.codepipeline#GetPipeline``."""
...
import aws_sdk_codepipeline.errors.pipeline_version_not_found_exception
...
import aws_sdk_codepipeline.types.pipeline_metadata
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PipelineVersionNotFoundException":
            raise aws_sdk_codepipeline.errors.pipeline_version_not_found_exception.PipelineVersionNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.get_pipeline_output.GetPipelineOutput = (
        aws_sdk_codepipeline.types.get_pipeline_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.get_pipeline_input.GetPipelineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.get_pipeline_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_pipeline(
    ...
    aws_sdk_codepipeline.types.get_pipeline_output.GetPipelineOutput, zapros.Response
]:
