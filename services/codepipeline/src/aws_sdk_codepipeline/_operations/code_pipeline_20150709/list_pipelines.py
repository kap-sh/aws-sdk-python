...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.list_pipelines_output.ListPipelinesOutput = (
        aws_sdk_codepipeline.types.list_pipelines_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.list_pipelines_input.ListPipelinesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.list_pipelines_input.serialize_aws_json_1_1(input_)
    ).encode()
