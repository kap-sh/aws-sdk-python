"""Generated from Smithy shape ``com.amazonaws.codepipeline#RetryStageExecution``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "StageNotRetryableException":
            import aws_sdk_codepipeline.errors.stage_not_retryable_exception

            raise aws_sdk_codepipeline.errors.stage_not_retryable_exception.StageNotRetryableException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.retry_stage_execution_output.RetryStageExecutionOutput = aws_sdk_codepipeline.types.retry_stage_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.retry_stage_execution_input.RetryStageExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.retry_stage_execution_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_retry_stage_execution(
