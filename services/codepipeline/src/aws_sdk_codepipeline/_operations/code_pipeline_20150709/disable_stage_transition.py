...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.disable_stage_transition_input.DisableStageTransitionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.disable_stage_transition_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
