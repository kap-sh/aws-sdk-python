"""Generated from Smithy shape ``com.amazonaws.codepipeline#ListActionExecutions``."""
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.list_action_executions_output.ListActionExecutionsOutput = aws_sdk_codepipeline.types.list_action_executions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.list_action_executions_input.ListActionExecutionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.list_action_executions_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_action_executions(
