...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.poll_for_third_party_jobs_output.PollForThirdPartyJobsOutput = aws_sdk_codepipeline.types.poll_for_third_party_jobs_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.poll_for_third_party_jobs_input.PollForThirdPartyJobsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.poll_for_third_party_jobs_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
