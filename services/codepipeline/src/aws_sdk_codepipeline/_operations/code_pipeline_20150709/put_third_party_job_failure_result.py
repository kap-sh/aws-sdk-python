"""Generated from Smithy shape ``com.amazonaws.codepipeline#PutThirdPartyJobFailureResult``."""
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.put_third_party_job_failure_result_input.PutThirdPartyJobFailureResultInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.put_third_party_job_failure_result_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_third_party_job_failure_result(
