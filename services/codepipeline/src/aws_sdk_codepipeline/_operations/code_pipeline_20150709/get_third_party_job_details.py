...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidJobException":
            import aws_sdk_codepipeline.errors.invalid_job_exception

            raise aws_sdk_codepipeline.errors.invalid_job_exception.InvalidJobException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.get_third_party_job_details_output.GetThirdPartyJobDetailsOutput = aws_sdk_codepipeline.types.get_third_party_job_details_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.get_third_party_job_details_input.GetThirdPartyJobDetailsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.get_third_party_job_details_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
