...
import aws_sdk_codepipeline.types.pipeline_execution_summary_list
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.list_pipeline_executions_output.ListPipelineExecutionsOutput = aws_sdk_codepipeline.types.list_pipeline_executions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.list_pipeline_executions_input.ListPipelineExecutionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.list_pipeline_executions_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
