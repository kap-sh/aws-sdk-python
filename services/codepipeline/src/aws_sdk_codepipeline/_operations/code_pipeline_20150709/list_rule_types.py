...
def build_request(
    ...
    input: aws_sdk_codepipeline.types.list_rule_types_input.ListRuleTypesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.list_rule_types_input.serialize_aws_json_1_1(input)
    ).encode()
