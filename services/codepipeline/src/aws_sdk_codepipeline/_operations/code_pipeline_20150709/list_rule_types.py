...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.list_rule_types_output.ListRuleTypesOutput = (
        aws_sdk_codepipeline.types.list_rule_types_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.list_rule_types_input.ListRuleTypesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.list_rule_types_input.serialize_aws_json_1_1(input_)
    ).encode()
