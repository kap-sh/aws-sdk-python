"""Generated from Smithy shape ``com.amazonaws.codepipeline#GetActionType``."""
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.get_action_type_output.GetActionTypeOutput = (
        aws_sdk_codepipeline.types.get_action_type_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.get_action_type_input.GetActionTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodePipeline_20150709.GetActionType"
    import aws_sdk_codepipeline.types.get_action_type_input

    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.get_action_type_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_action_type(
