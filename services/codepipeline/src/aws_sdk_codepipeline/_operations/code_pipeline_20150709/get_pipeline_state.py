"""Generated from Smithy shape ``com.amazonaws.codepipeline#GetPipelineState``."""
...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.get_pipeline_state_output.GetPipelineStateOutput = (
        aws_sdk_codepipeline.types.get_pipeline_state_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.get_pipeline_state_input.GetPipelineStateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codepipeline.types.get_pipeline_state_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_pipeline_state(
