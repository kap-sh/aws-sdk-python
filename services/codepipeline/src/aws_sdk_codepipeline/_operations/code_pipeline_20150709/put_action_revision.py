...
def handle_response(
    ...
    out: aws_sdk_codepipeline.types.put_action_revision_output.PutActionRevisionOutput = aws_sdk_codepipeline.types.put_action_revision_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codepipeline.types.put_action_revision_input.PutActionRevisionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
