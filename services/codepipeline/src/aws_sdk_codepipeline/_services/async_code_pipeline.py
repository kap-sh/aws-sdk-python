...
from aws_sdk_codepipeline._auth._zapros_handler import AuthMiddleware
from aws_sdk_codepipeline._pagination import resolve_path as _resolve_path
from aws_sdk_codepipeline._services._aws_config import aaws_config
...
if TYPE_CHECKING:
    import aws_sdk_codepipeline.types.acknowledge_job_input
    import aws_sdk_codepipeline.types.acknowledge_job_output
    import aws_sdk_codepipeline.types.acknowledge_third_party_job_input
    import aws_sdk_codepipeline.types.acknowledge_third_party_job_output
    ...
    import aws_sdk_codepipeline.types.approval_result
    import aws_sdk_codepipeline.types.approval_token
    ...
    import aws_sdk_codepipeline.types.create_custom_action_type_input
    import aws_sdk_codepipeline.types.create_custom_action_type_output
    ...
    import aws_sdk_codepipeline.types.delete_custom_action_type_input
    ...
    import aws_sdk_codepipeline.types.deregister_webhook_with_third_party_input
    import aws_sdk_codepipeline.types.deregister_webhook_with_third_party_output
    import aws_sdk_codepipeline.types.disable_stage_transition_input
    import aws_sdk_codepipeline.types.disabled_reason
    import aws_sdk_codepipeline.types.enable_stage_transition_input
    import aws_sdk_codepipeline.types.execution_details
    import aws_sdk_codepipeline.types.failure_details
    import aws_sdk_codepipeline.types.get_action_type_input
    import aws_sdk_codepipeline.types.get_action_type_output
    import aws_sdk_codepipeline.types.get_job_details_input
    import aws_sdk_codepipeline.types.get_job_details_output
    import aws_sdk_codepipeline.types.get_pipeline_execution_input
    import aws_sdk_codepipeline.types.get_pipeline_execution_output
    import aws_sdk_codepipeline.types.get_pipeline_input
    import aws_sdk_codepipeline.types.get_pipeline_output
    import aws_sdk_codepipeline.types.get_pipeline_state_input
    import aws_sdk_codepipeline.types.get_pipeline_state_output
    import aws_sdk_codepipeline.types.get_third_party_job_details_input
    import aws_sdk_codepipeline.types.get_third_party_job_details_output
    import aws_sdk_codepipeline.types.job_id
    import aws_sdk_codepipeline.types.list_action_executions_input
    import aws_sdk_codepipeline.types.list_action_executions_output
    import aws_sdk_codepipeline.types.list_action_types_input
    import aws_sdk_codepipeline.types.list_action_types_output
    import aws_sdk_codepipeline.types.list_deploy_action_execution_targets_input
    import aws_sdk_codepipeline.types.list_deploy_action_execution_targets_output
    import aws_sdk_codepipeline.types.list_pipeline_executions_input
    import aws_sdk_codepipeline.types.list_pipeline_executions_output
    import aws_sdk_codepipeline.types.list_pipelines_input
    import aws_sdk_codepipeline.types.list_pipelines_output
    import aws_sdk_codepipeline.types.list_rule_executions_input
    import aws_sdk_codepipeline.types.list_rule_executions_output
    import aws_sdk_codepipeline.types.list_rule_types_input
    import aws_sdk_codepipeline.types.list_rule_types_output
    import aws_sdk_codepipeline.types.list_tags_for_resource_input
    import aws_sdk_codepipeline.types.list_tags_for_resource_output
    import aws_sdk_codepipeline.types.list_webhook_item
    import aws_sdk_codepipeline.types.list_webhooks_input
    import aws_sdk_codepipeline.types.list_webhooks_output
    ...
    import aws_sdk_codepipeline.types.pipeline_execution_summary
    ...
    import aws_sdk_codepipeline.types.poll_for_jobs_input
    import aws_sdk_codepipeline.types.poll_for_jobs_output
    import aws_sdk_codepipeline.types.poll_for_third_party_jobs_input
    import aws_sdk_codepipeline.types.poll_for_third_party_jobs_output
    import aws_sdk_codepipeline.types.put_action_revision_input
    import aws_sdk_codepipeline.types.put_action_revision_output
    import aws_sdk_codepipeline.types.put_approval_result_input
    import aws_sdk_codepipeline.types.put_approval_result_output
    import aws_sdk_codepipeline.types.put_job_failure_result_input
    import aws_sdk_codepipeline.types.put_job_success_result_input
    ...
    import aws_sdk_codepipeline.types.put_webhook_input
    import aws_sdk_codepipeline.types.put_webhook_output
    import aws_sdk_codepipeline.types.query_param_map
    import aws_sdk_codepipeline.types.register_webhook_with_third_party_input
    import aws_sdk_codepipeline.types.register_webhook_with_third_party_output
    import aws_sdk_codepipeline.types.resource_arn
    import aws_sdk_codepipeline.types.retry_stage_execution_input
    import aws_sdk_codepipeline.types.retry_stage_execution_output
    import aws_sdk_codepipeline.types.rollback_stage_input
    import aws_sdk_codepipeline.types.rollback_stage_output
    ...
    import aws_sdk_codepipeline.types.stop_pipeline_execution_input
    import aws_sdk_codepipeline.types.stop_pipeline_execution_output
    import aws_sdk_codepipeline.types.stop_pipeline_execution_reason
    import aws_sdk_codepipeline.types.tag
    import aws_sdk_codepipeline.types.tag_key_list
    import aws_sdk_codepipeline.types.tag_list
    import aws_sdk_codepipeline.types.tag_resource_input
    import aws_sdk_codepipeline.types.tag_resource_output
    import aws_sdk_codepipeline.types.target_filter_list
    import aws_sdk_codepipeline.types.third_party_job_id
    import aws_sdk_codepipeline.types.untag_resource_input
    import aws_sdk_codepipeline.types.untag_resource_output
    import aws_sdk_codepipeline.types.update_action_type_input
    import aws_sdk_codepipeline.types.update_pipeline_input
    import aws_sdk_codepipeline.types.update_pipeline_output
...
class AsyncCodePipelineClientConfig(TypedDict, total=False, closed=True):
...
class AsyncCodePipelineClient:
    ...
    def __init__(
        ...
        self._config = AsyncCodePipelineClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncCodePipelineClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncCodePipelineClientConfig = config_overrides or {}
    ...
    async def acknowledge_job(
        ...
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> "aws_sdk_codepipeline.types.acknowledge_job_output.AcknowledgeJobOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.acknowledge_job_input.AcknowledgeJobInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.acknowledge_job_output.AcknowledgeJobOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.acknowledge_job

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.acknowledge_job.async_acknowledge_job(
    ...
    async def acknowledge_third_party_job(
        ...
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> "aws_sdk_codepipeline.types.acknowledge_third_party_job_output.AcknowledgeThirdPartyJobOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.acknowledge_third_party_job_input.AcknowledgeThirdPartyJobInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.acknowledge_third_party_job_output.AcknowledgeThirdPartyJobOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.acknowledge_third_party_job

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.acknowledge_third_party_job.async_acknowledge_third_party_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_custom_action_type(
        ...
        input_artifact_details: "aws_sdk_codepipeline.types.artifact_details.ArtifactDetails",
        output_artifact_details: "aws_sdk_codepipeline.types.artifact_details.ArtifactDetails",
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
        settings: Optional[
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.create_custom_action_type_input.CreateCustomActionTypeInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.create_custom_action_type_output.CreateCustomActionTypeOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.create_custom_action_type

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.create_custom_action_type.async_create_custom_action_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_pipeline(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.create_pipeline_input.CreatePipelineInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.create_pipeline_output.CreatePipelineOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.create_pipeline

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.create_pipeline.async_create_pipeline(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_custom_action_type(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.delete_custom_action_type_input.DeleteCustomActionTypeInput]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.delete_custom_action_type

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.delete_custom_action_type.async_delete_custom_action_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_pipeline(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.delete_pipeline_input.DeletePipelineInput]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.delete_pipeline

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.delete_pipeline.async_delete_pipeline(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_webhook(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.delete_webhook_input.DeleteWebhookInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.delete_webhook_output.DeleteWebhookOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.delete_webhook

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.delete_webhook.async_delete_webhook(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_webhook_with_third_party(
        ...
        *,
        ...
        webhook_name: Optional[
            "aws_sdk_codepipeline.types.webhook_name.WebhookName"
        ] = None,
    ) -> "aws_sdk_codepipeline.types.deregister_webhook_with_third_party_output.DeregisterWebhookWithThirdPartyOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.deregister_webhook_with_third_party_input.DeregisterWebhookWithThirdPartyInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.deregister_webhook_with_third_party_output.DeregisterWebhookWithThirdPartyOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.deregister_webhook_with_third_party

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.deregister_webhook_with_third_party.async_deregister_webhook_with_third_party(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_stage_transition(
        ...
        transition_type: "aws_sdk_codepipeline.types.stage_transition_type.StageTransitionType",
        reason: "aws_sdk_codepipeline.types.disabled_reason.DisabledReason",
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.disable_stage_transition_input.DisableStageTransitionInput]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.disable_stage_transition

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.disable_stage_transition.async_disable_stage_transition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_stage_transition(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.enable_stage_transition_input.EnableStageTransitionInput]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.enable_stage_transition

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.enable_stage_transition.async_enable_stage_transition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_action_type(
        ...
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> "aws_sdk_codepipeline.types.get_action_type_output.GetActionTypeOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.get_action_type_input.GetActionTypeInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.get_action_type_output.GetActionTypeOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.get_action_type

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.get_action_type.async_get_action_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_job_details(
        ...
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> "aws_sdk_codepipeline.types.get_job_details_output.GetJobDetailsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.get_job_details_input.GetJobDetailsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.get_job_details_output.GetJobDetailsOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.get_job_details

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.get_job_details.async_get_job_details(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_pipeline(
        ...
        *,
    ...
    ) -> "aws_sdk_codepipeline.types.get_pipeline_output.GetPipelineOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.get_pipeline_input.GetPipelineInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.get_pipeline_output.GetPipelineOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.get_pipeline

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.get_pipeline.async_get_pipeline(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_pipeline_execution(
        self,
        pipeline_name: "aws_sdk_codepipeline.types.pipeline_name.PipelineName",
        pipeline_execution_id: "aws_sdk_codepipeline.types.pipeline_execution_id.PipelineExecutionId",
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> "aws_sdk_codepipeline.types.get_pipeline_execution_output.GetPipelineExecutionOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.get_pipeline_execution_input.GetPipelineExecutionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.get_pipeline_execution_output.GetPipelineExecutionOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.get_pipeline_execution

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.get_pipeline_execution.async_get_pipeline_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_pipeline_state(
        ...
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> "aws_sdk_codepipeline.types.get_pipeline_state_output.GetPipelineStateOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.get_pipeline_state_input.GetPipelineStateInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.get_pipeline_state_output.GetPipelineStateOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.get_pipeline_state

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.get_pipeline_state.async_get_pipeline_state(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_third_party_job_details(
        ...
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> "aws_sdk_codepipeline.types.get_third_party_job_details_output.GetThirdPartyJobDetailsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.get_third_party_job_details_input.GetThirdPartyJobDetailsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.get_third_party_job_details_output.GetThirdPartyJobDetailsOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.get_third_party_job_details

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.get_third_party_job_details.async_get_third_party_job_details(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_action_executions(
        ...
        *,
        ...
        max_results: Optional[
            "aws_sdk_codepipeline.types.max_results.MaxResults"
        ] = None,
        next_token: Optional["aws_sdk_codepipeline.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_codepipeline.types.list_action_executions_output.ListActionExecutionsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.list_action_executions_input.ListActionExecutionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.list_action_executions_output.ListActionExecutionsOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.list_action_executions

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.list_action_executions.async_list_action_executions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_action_executions(
        self,
        pipeline_name: "aws_sdk_codepipeline.types.pipeline_name.PipelineName",
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
        ...
        next_token: Optional["aws_sdk_codepipeline.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_codepipeline.types.action_execution_detail.ActionExecutionDetail]":
        _token = next_token
        while True:
            _response = await self.list_action_executions(
                pipeline_name,
    ...
    async def list_action_types(
        ...
        *,
    ...
    ) -> "aws_sdk_codepipeline.types.list_action_types_output.ListActionTypesOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.list_action_types_input.ListActionTypesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.list_action_types_output.ListActionTypesOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.list_action_types

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.list_action_types.async_list_action_types(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_action_types(
        self,
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
        action_owner_filter: Optional[
    ...
    ) -> "AsyncIterator[aws_sdk_codepipeline.types.action_type.ActionType]":
        _token = next_token
        while True:
            _response = await self.list_action_types(
                config_overrides=config_overrides,
    ...
    async def list_deploy_action_execution_targets(
        self,
        action_execution_id: "aws_sdk_codepipeline.types.action_execution_id.ActionExecutionId",
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
        pipeline_name: Optional[
            "aws_sdk_codepipeline.types.pipeline_name.PipelineName"
        ] = None,
        filters: Optional[
            "aws_sdk_codepipeline.types.target_filter_list.TargetFilterList"
        ] = None,
        max_results: Optional[
            "aws_sdk_codepipeline.types.max_results.MaxResults"
        ] = None,
        next_token: Optional["aws_sdk_codepipeline.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_codepipeline.types.list_deploy_action_execution_targets_output.ListDeployActionExecutionTargetsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.list_deploy_action_execution_targets_input.ListDeployActionExecutionTargetsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.list_deploy_action_execution_targets_output.ListDeployActionExecutionTargetsOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.list_deploy_action_execution_targets

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.list_deploy_action_execution_targets.async_list_deploy_action_execution_targets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_deploy_action_execution_targets(
        self,
        action_execution_id: "aws_sdk_codepipeline.types.action_execution_id.ActionExecutionId",
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
        ...
        next_token: Optional["aws_sdk_codepipeline.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_codepipeline.types.deploy_action_execution_target.DeployActionExecutionTarget]":
        _token = next_token
        while True:
            _response = await self.list_deploy_action_execution_targets(
                action_execution_id,
                config_overrides=config_overrides,
    ...
    async def list_pipeline_executions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_codepipeline.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_codepipeline.types.list_pipeline_executions_output.ListPipelineExecutionsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.list_pipeline_executions_input.ListPipelineExecutionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.list_pipeline_executions_output.ListPipelineExecutionsOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.list_pipeline_executions

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.list_pipeline_executions.async_list_pipeline_executions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_pipeline_executions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_codepipeline.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_codepipeline.types.pipeline_execution_summary.PipelineExecutionSummary]":
        _token = next_token
        while True:
    ...
    async def list_pipelines(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_codepipeline.types.next_token.NextToken"] = None,
        max_results: Optional[
            "aws_sdk_codepipeline.types.max_pipelines.MaxPipelines"
        ] = None,
    ) -> "aws_sdk_codepipeline.types.list_pipelines_output.ListPipelinesOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.list_pipelines_input.ListPipelinesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.list_pipelines_output.ListPipelinesOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.list_pipelines

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.list_pipelines.async_list_pipelines(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_codepipeline.types.pipeline_summary.PipelineSummary]":
        _token = next_token
        while True:
    ...
    async def list_rule_executions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_codepipeline.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_codepipeline.types.list_rule_executions_output.ListRuleExecutionsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.list_rule_executions_input.ListRuleExecutionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.list_rule_executions_output.ListRuleExecutionsOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.list_rule_executions

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.list_rule_executions.async_list_rule_executions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_rule_executions(
        self,
        pipeline_name: "aws_sdk_codepipeline.types.pipeline_name.PipelineName",
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
        ...
        next_token: Optional["aws_sdk_codepipeline.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_codepipeline.types.rule_execution_detail.RuleExecutionDetail]":
        _token = next_token
        while True:
            _response = await self.list_rule_executions(
                pipeline_name,
                config_overrides=config_overrides,
                filter=filter,
                max_results=max_results,
    ...
    async def list_rule_types(
        ...
        *,
        ...
        rule_owner_filter: Optional[
            "aws_sdk_codepipeline.types.rule_owner.RuleOwner"
        ] = None,
        region_filter: Optional[
            "aws_sdk_codepipeline.types.aws_region_name.AWSRegionName"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.list_rule_types_input.ListRuleTypesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.list_rule_types_output.ListRuleTypesOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.list_rule_types

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.list_rule_types.async_list_rule_types(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
    ...
    ) -> "aws_sdk_codepipeline.types.list_tags_for_resource_output.ListTagsForResourceOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.list_tags_for_resource

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_codepipeline.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    async def list_webhooks(
        ...
        *,
    ...
    ) -> "aws_sdk_codepipeline.types.list_webhooks_output.ListWebhooksOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.list_webhooks_input.ListWebhooksInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.list_webhooks_output.ListWebhooksOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.list_webhooks

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.list_webhooks.async_list_webhooks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_codepipeline.types.list_webhook_item.ListWebhookItem]":
        _token = next_token
        while True:
            _response = await self.list_webhooks(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    async def override_stage_condition(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.override_stage_condition_input.OverrideStageConditionInput]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.override_stage_condition

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.override_stage_condition.async_override_stage_condition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def poll_for_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.poll_for_jobs_input.PollForJobsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.poll_for_jobs_output.PollForJobsOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.poll_for_jobs

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.poll_for_jobs.async_poll_for_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def poll_for_third_party_jobs(
        ...
        *,
    ...
    ) -> "aws_sdk_codepipeline.types.poll_for_third_party_jobs_output.PollForThirdPartyJobsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.poll_for_third_party_jobs_input.PollForThirdPartyJobsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.poll_for_third_party_jobs_output.PollForThirdPartyJobsOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.poll_for_third_party_jobs

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.poll_for_third_party_jobs.async_poll_for_third_party_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_action_revision(
        ...
        *,
        ...
        "aws_sdk_codepipeline.types.put_action_revision_output.PutActionRevisionOutput"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.put_action_revision_input.PutActionRevisionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.put_action_revision_output.PutActionRevisionOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.put_action_revision

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.put_action_revision.async_put_action_revision(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_approval_result(
        ...
        stage_name: "aws_sdk_codepipeline.types.stage_name.StageName",
        action_name: "aws_sdk_codepipeline.types.action_name.ActionName",
        result: "aws_sdk_codepipeline.types.approval_result.ApprovalResult",
        token: "aws_sdk_codepipeline.types.approval_token.ApprovalToken",
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> (
        "aws_sdk_codepipeline.types.put_approval_result_output.PutApprovalResultOutput"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.put_approval_result_input.PutApprovalResultInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.put_approval_result_output.PutApprovalResultOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.put_approval_result

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.put_approval_result.async_put_approval_result(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_job_failure_result(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.put_job_failure_result_input.PutJobFailureResultInput]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.put_job_failure_result

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.put_job_failure_result.async_put_job_failure_result(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_job_success_result(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.put_job_success_result_input.PutJobSuccessResultInput]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.put_job_success_result

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.put_job_success_result.async_put_job_success_result(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_third_party_job_failure_result(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.put_third_party_job_failure_result_input.PutThirdPartyJobFailureResultInput]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.put_third_party_job_failure_result

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.put_third_party_job_failure_result.async_put_third_party_job_failure_result(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_third_party_job_success_result(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.put_third_party_job_success_result_input.PutThirdPartyJobSuccessResultInput]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.put_third_party_job_success_result

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.put_third_party_job_success_result.async_put_third_party_job_success_result(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_webhook(
        ...
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
        tags: Optional["aws_sdk_codepipeline.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_codepipeline.types.put_webhook_output.PutWebhookOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.put_webhook_input.PutWebhookInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.put_webhook_output.PutWebhookOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.put_webhook

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.put_webhook.async_put_webhook(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_webhook_with_third_party(
        ...
        *,
    ...
    ) -> "aws_sdk_codepipeline.types.register_webhook_with_third_party_output.RegisterWebhookWithThirdPartyOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.register_webhook_with_third_party_input.RegisterWebhookWithThirdPartyInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.register_webhook_with_third_party_output.RegisterWebhookWithThirdPartyOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.register_webhook_with_third_party

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.register_webhook_with_third_party.async_register_webhook_with_third_party(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def retry_stage_execution(
        ...
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> "aws_sdk_codepipeline.types.retry_stage_execution_output.RetryStageExecutionOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.retry_stage_execution_input.RetryStageExecutionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.retry_stage_execution_output.RetryStageExecutionOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.retry_stage_execution

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.retry_stage_execution.async_retry_stage_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def rollback_stage(
        ...
        pipeline_name: "aws_sdk_codepipeline.types.pipeline_name.PipelineName",
        stage_name: "aws_sdk_codepipeline.types.stage_name.StageName",
        target_pipeline_execution_id: "aws_sdk_codepipeline.types.pipeline_execution_id.PipelineExecutionId",
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> "aws_sdk_codepipeline.types.rollback_stage_output.RollbackStageOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.rollback_stage_input.RollbackStageInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.rollback_stage_output.RollbackStageOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.rollback_stage

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.rollback_stage.async_rollback_stage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_pipeline_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.start_pipeline_execution_input.StartPipelineExecutionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.start_pipeline_execution_output.StartPipelineExecutionOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.start_pipeline_execution

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.start_pipeline_execution.async_start_pipeline_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_pipeline_execution(
        ...
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
        abandon: Optional["aws_sdk_codepipeline.types.boolean.Boolean"] = None,
        reason: Optional[
            "aws_sdk_codepipeline.types.stop_pipeline_execution_reason.StopPipelineExecutionReason"
        ] = None,
    ) -> "aws_sdk_codepipeline.types.stop_pipeline_execution_output.StopPipelineExecutionOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.stop_pipeline_execution_input.StopPipelineExecutionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.stop_pipeline_execution_output.StopPipelineExecutionOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.stop_pipeline_execution

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.stop_pipeline_execution.async_stop_pipeline_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> "aws_sdk_codepipeline.types.tag_resource_output.TagResourceOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.tag_resource_input.TagResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.tag_resource_output.TagResourceOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.tag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> "aws_sdk_codepipeline.types.untag_resource_output.UntagResourceOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.untag_resource_output.UntagResourceOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.untag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_action_type(
        self,
        action_type: "aws_sdk_codepipeline.types.action_type_declaration.ActionTypeDeclaration",
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.update_action_type_input.UpdateActionTypeInput]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.update_action_type

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.update_action_type.async_update_action_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_pipeline(
        ...
        *,
        config_overrides: Optional[AsyncCodePipelineClientConfig] = None,
    ) -> "aws_sdk_codepipeline.types.update_pipeline_output.UpdatePipelineOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_codepipeline.types.update_pipeline_input.UpdatePipelineInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_codepipeline.types.update_pipeline_output.UpdatePipelineOutput"
        ]:
            import aws_sdk_codepipeline._operations.code_pipeline_20150709.update_pipeline

            (
                output,
                http_response,
            ) = await aws_sdk_codepipeline._operations.code_pipeline_20150709.update_pipeline.async_update_pipeline(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
