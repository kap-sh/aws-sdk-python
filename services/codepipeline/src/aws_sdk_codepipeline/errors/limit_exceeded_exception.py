"""Generated from Smithy shape ``com.amazonaws.codepipeline#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codepipeline#LimitExceededException``."""
