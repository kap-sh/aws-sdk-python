"""Generated from Smithy shape ``com.amazonaws.codepipeline#InvalidStructureException``."""
...
class InvalidStructureException_(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: InvalidStructureException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class InvalidStructureException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codepipeline#InvalidStructureException``."""
