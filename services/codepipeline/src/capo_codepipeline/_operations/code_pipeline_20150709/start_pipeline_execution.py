"""Generated from Smithy shape ``com.amazonaws.codepipeline#StartPipelineExecution``."""
...
import capo_codepipeline.errors.concurrent_pipeline_executions_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentPipelineExecutionsLimitExceededException":
            raise capo_codepipeline.errors.concurrent_pipeline_executions_limit_exceeded_exception.ConcurrentPipelineExecutionsLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codepipeline.types.start_pipeline_execution_output.StartPipelineExecutionOutput = capo_codepipeline.types.start_pipeline_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.start_pipeline_execution_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_pipeline_execution(
