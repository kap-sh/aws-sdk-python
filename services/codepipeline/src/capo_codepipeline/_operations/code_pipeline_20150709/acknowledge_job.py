...
import capo_codepipeline.errors.invalid_nonce_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidNonceException":
            raise capo_codepipeline.errors.invalid_nonce_exception.InvalidNonceException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codepipeline.types.acknowledge_job_output.AcknowledgeJobOutput = (
        capo_codepipeline.types.acknowledge_job_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.acknowledge_job_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def acknowledge_job(
    ...
    capo_codepipeline.types.acknowledge_job_output.AcknowledgeJobOutput, zapros.Response
]:
