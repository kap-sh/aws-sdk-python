"""Generated from Smithy shape ``com.amazonaws.codepipeline#UntagResource``."""
...
import capo_codepipeline.errors.invalid_arn_exception
import capo_codepipeline.errors.invalid_tags_exception
import capo_codepipeline.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidArnException":
            raise capo_codepipeline.errors.invalid_arn_exception.InvalidArnException.from_aws_json_1_1(
                data
            )
        ...
        case "ResourceNotFoundException":
            raise capo_codepipeline.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codepipeline.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.untag_resource_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def untag_resource(
    ...
    capo_codepipeline.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
