...
def handle_response(
    ...
    out: capo_codepipeline.types.list_action_types_output.ListActionTypesOutput = (
        capo_codepipeline.types.list_action_types_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.list_action_types_input.serialize_aws_json_1_1(input_)
    ).encode()
