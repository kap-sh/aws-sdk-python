"""Generated from Smithy shape ``com.amazonaws.codepipeline#DeleteCustomActionType``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.delete_custom_action_type_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_custom_action_type(
