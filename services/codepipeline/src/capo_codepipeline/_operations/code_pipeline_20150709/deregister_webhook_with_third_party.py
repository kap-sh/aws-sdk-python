"""Generated from Smithy shape ``com.amazonaws.codepipeline#DeregisterWebhookWithThirdParty``."""
...
import capo_codepipeline.errors.webhook_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WebhookNotFoundException":
            raise capo_codepipeline.errors.webhook_not_found_exception.WebhookNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_codepipeline.types.deregister_webhook_with_third_party_output.DeregisterWebhookWithThirdPartyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.deregister_webhook_with_third_party_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_deregister_webhook_with_third_party(
