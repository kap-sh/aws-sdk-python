...
import capo_codepipeline.errors.output_variables_size_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OutputVariablesSizeExceededException":
            raise capo_codepipeline.errors.output_variables_size_exceeded_exception.OutputVariablesSizeExceededException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.put_job_success_result_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
