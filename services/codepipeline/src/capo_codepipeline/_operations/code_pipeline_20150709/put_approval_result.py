"""Generated from Smithy shape ``com.amazonaws.codepipeline#PutApprovalResult``."""
...
import capo_codepipeline.errors.action_not_found_exception
import capo_codepipeline.errors.approval_already_completed_exception
import capo_codepipeline.errors.invalid_approval_token_exception
import capo_codepipeline.errors.pipeline_not_found_exception
import capo_codepipeline.errors.stage_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ActionNotFoundException":
            raise capo_codepipeline.errors.action_not_found_exception.ActionNotFoundException.from_aws_json_1_1(
                data
            )
        case "ApprovalAlreadyCompletedException":
            raise capo_codepipeline.errors.approval_already_completed_exception.ApprovalAlreadyCompletedException.from_aws_json_1_1(
                data
            )
        case "InvalidApprovalTokenException":
            raise capo_codepipeline.errors.invalid_approval_token_exception.InvalidApprovalTokenException.from_aws_json_1_1(
                data
            )
        case "PipelineNotFoundException":
            raise capo_codepipeline.errors.pipeline_not_found_exception.PipelineNotFoundException.from_aws_json_1_1(
                data
            )
        case "StageNotFoundException":
            raise capo_codepipeline.errors.stage_not_found_exception.StageNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codepipeline.types.put_approval_result_output.PutApprovalResultOutput = (
        capo_codepipeline.types.put_approval_result_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.put_approval_result_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_put_approval_result(
