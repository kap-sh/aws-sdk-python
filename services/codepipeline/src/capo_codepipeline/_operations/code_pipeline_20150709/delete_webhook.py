...
def handle_response(
    ...
    out: capo_codepipeline.types.delete_webhook_output.DeleteWebhookOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.delete_webhook_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_webhook(
    ...
    capo_codepipeline.types.delete_webhook_output.DeleteWebhookOutput, zapros.Response
]:
