"""Generated from Smithy shape ``com.amazonaws.codepipeline#PollForJobs``."""
...
def handle_response(
    ...
    out: capo_codepipeline.types.poll_for_jobs_output.PollForJobsOutput = (
        capo_codepipeline.types.poll_for_jobs_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.poll_for_jobs_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def poll_for_jobs(
    ...
    capo_codepipeline.types.poll_for_jobs_output.PollForJobsOutput, zapros.Response
]:
