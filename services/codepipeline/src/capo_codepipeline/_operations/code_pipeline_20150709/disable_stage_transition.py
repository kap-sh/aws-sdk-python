"""Generated from Smithy shape ``com.amazonaws.codepipeline#DisableStageTransition``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.disable_stage_transition_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disable_stage_transition(
