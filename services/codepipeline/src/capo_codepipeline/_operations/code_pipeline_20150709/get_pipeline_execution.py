"""Generated from Smithy shape ``com.amazonaws.codepipeline#GetPipelineExecution``."""
...
import capo_codepipeline.types.pipeline_execution
...
def handle_response(
    ...
    out: capo_codepipeline.types.get_pipeline_execution_output.GetPipelineExecutionOutput = capo_codepipeline.types.get_pipeline_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.get_pipeline_execution_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_pipeline_execution(
