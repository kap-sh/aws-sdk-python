...
import capo_codepipeline.errors.action_type_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ActionTypeNotFoundException":
            raise capo_codepipeline.errors.action_type_not_found_exception.ActionTypeNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codepipeline.types.get_action_type_output.GetActionTypeOutput = (
        capo_codepipeline.types.get_action_type_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.get_action_type_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_action_type(
    ...
    capo_codepipeline.types.get_action_type_output.GetActionTypeOutput, zapros.Response
]:
