"""Generated from Smithy shape ``com.amazonaws.codepipeline#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_codepipeline.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_codepipeline.types.list_tags_for_resource_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.list_tags_for_resource_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
