"""Generated from Smithy shape ``com.amazonaws.codepipeline#GetThirdPartyJobDetails``."""
...
import capo_codepipeline.errors.invalid_client_token_exception
import capo_codepipeline.errors.invalid_job_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidClientTokenException":
            raise capo_codepipeline.errors.invalid_client_token_exception.InvalidClientTokenException.from_aws_json_1_1(
                data
            )
        case "InvalidJobException":
            raise capo_codepipeline.errors.invalid_job_exception.InvalidJobException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codepipeline.types.get_third_party_job_details_output.GetThirdPartyJobDetailsOutput = capo_codepipeline.types.get_third_party_job_details_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.get_third_party_job_details_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_third_party_job_details(
