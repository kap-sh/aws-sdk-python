"""Generated from Smithy shape ``com.amazonaws.codepipeline#UpdateActionType``."""
...
import capo_codepipeline.errors.request_failed_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RequestFailedException":
            raise capo_codepipeline.errors.request_failed_exception.RequestFailedException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodePipeline_20150709.UpdateActionType"
    body: bytes | None = json.dumps(
        capo_codepipeline.types.update_action_type_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_action_type(
