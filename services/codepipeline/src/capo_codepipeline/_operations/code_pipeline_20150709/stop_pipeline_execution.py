"""Generated from Smithy shape ``com.amazonaws.codepipeline#StopPipelineExecution``."""
...
import capo_codepipeline.errors.conflict_exception
import capo_codepipeline.errors.duplicated_stop_request_exception
import capo_codepipeline.errors.pipeline_execution_not_stoppable_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            raise capo_codepipeline.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
        case "DuplicatedStopRequestException":
            raise capo_codepipeline.errors.duplicated_stop_request_exception.DuplicatedStopRequestException.from_aws_json_1_1(
                data
            )
        case "PipelineExecutionNotStoppableException":
            raise capo_codepipeline.errors.pipeline_execution_not_stoppable_exception.PipelineExecutionNotStoppableException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codepipeline.types.stop_pipeline_execution_output.StopPipelineExecutionOutput = capo_codepipeline.types.stop_pipeline_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.stop_pipeline_execution_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_pipeline_execution(
