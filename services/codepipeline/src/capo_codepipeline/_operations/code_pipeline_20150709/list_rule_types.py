"""Generated from Smithy shape ``com.amazonaws.codepipeline#ListRuleTypes``."""
...
def handle_response(
    ...
    out: capo_codepipeline.types.list_rule_types_output.ListRuleTypesOutput = (
        capo_codepipeline.types.list_rule_types_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodePipeline_20150709.ListRuleTypes"
    body: bytes | None = json.dumps(
        capo_codepipeline.types.list_rule_types_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_rule_types(
    ...
    capo_codepipeline.types.list_rule_types_output.ListRuleTypesOutput, zapros.Response
]:
...
async def async_list_rule_types(
