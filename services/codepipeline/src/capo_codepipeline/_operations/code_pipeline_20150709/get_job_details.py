"""Generated from Smithy shape ``com.amazonaws.codepipeline#GetJobDetails``."""
...
def handle_response(
    ...
    out: capo_codepipeline.types.get_job_details_output.GetJobDetailsOutput = (
        capo_codepipeline.types.get_job_details_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.get_job_details_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_job_details(
    ...
    capo_codepipeline.types.get_job_details_output.GetJobDetailsOutput, zapros.Response
]:
...
async def async_get_job_details(
