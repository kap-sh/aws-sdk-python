...
import capo_codepipeline.errors.pipeline_execution_not_found_exception
import capo_codepipeline.errors.pipeline_not_found_exception
import capo_codepipeline.errors.validation_exception
import capo_codepipeline.types.action_execution_detail_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PipelineExecutionNotFoundException":
            raise capo_codepipeline.errors.pipeline_execution_not_found_exception.PipelineExecutionNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codepipeline.types.list_action_executions_output.ListActionExecutionsOutput = capo_codepipeline.types.list_action_executions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.list_action_executions_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
