...
if TYPE_CHECKING:
    import capo_codepipeline.types.lambda_function_arn


class LambdaExecutorConfiguration(TypedDict, closed=True):
    lambda_function_arn: "capo_codepipeline.types.lambda_function_arn.LambdaFunctionArn"
