...
if TYPE_CHECKING:
    import capo_codepipeline.types.rule_configuration_property

RuleConfigurationPropertyList: TypeAlias = list[
    "capo_codepipeline.types.rule_configuration_property.RuleConfigurationProperty"
]
...
def serialize_aws_json_1_1(value: RuleConfigurationPropertyList) -> list:
    ...
    for item in value:
        out.append(
            capo_codepipeline.types.rule_configuration_property.serialize_aws_json_1_1(
                item
            )
        )
    return out
