"""Generated from Smithy shape ``com.amazonaws.codepipeline#InvalidNonceException``."""
...
class InvalidNonceException_(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: InvalidNonceException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class InvalidNonceException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codepipeline#InvalidNonceException``."""
