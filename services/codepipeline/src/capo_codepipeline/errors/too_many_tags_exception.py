"""Generated from Smithy shape ``com.amazonaws.codepipeline#TooManyTagsException``."""
...
class TooManyTagsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codepipeline#TooManyTagsException``."""
