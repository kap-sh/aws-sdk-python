...
class CodePipelineError(Exception):
    """Base class for all CodePipeline service errors."""


class ServiceError(CodePipelineError):
...
class SerializationError(CodePipelineError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CodePipelineError):
...
class WaiterFailedError(CodePipelineError):
...
class WaiterTimeoutError(CodePipelineError):
