...
class PhysicalNetworkInterface(TypedDict):
    ...
    physical_connector_type: NotRequired[
        "aws_sdk_snow_device_management.types.physical_connector_type.PhysicalConnectorType"
    ]
    """<p>The physical connector type.</p>"""
    ip_address_assignment: NotRequired[
        "aws_sdk_snow_device_management.types.ip_address_assignment.IpAddressAssignment"
    ]
