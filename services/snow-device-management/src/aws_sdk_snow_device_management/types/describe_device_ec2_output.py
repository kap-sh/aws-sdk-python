...
class DescribeDeviceEc2Output(TypedDict):
    instances: NotRequired[
        "aws_sdk_snow_device_management.types.instance_summary_list.InstanceSummaryList"
    ]
...
def serialize_json(value: DescribeDeviceEc2Output) -> dict:
    ...
    if "instances" in value:
        ...
        out["instances"] = (
            aws_sdk_snow_device_management.types.instance_summary_list.serialize_json(
                value["instances"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> DescribeDeviceEc2Output:
    ...
    if "instances" in data:
        ...
        out["instances"] = (
            aws_sdk_snow_device_management.types.instance_summary_list.deserialize_json(
                data["instances"]
            )
        )
    return out
