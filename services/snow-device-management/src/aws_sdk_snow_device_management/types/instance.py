...
if TYPE_CHECKING:
    ...
    import aws_sdk_snow_device_management.types.cpu_options
    import aws_sdk_snow_device_management.types.instance_block_device_mapping_list
    import aws_sdk_snow_device_management.types.instance_state
    import aws_sdk_snow_device_management.types.security_group_identifier_list
...
class Instance(TypedDict, closed=True):
    ...
    state: NotRequired[
        "aws_sdk_snow_device_management.types.instance_state.InstanceState"
    ]
    ...
    block_device_mappings: NotRequired[
        "aws_sdk_snow_device_management.types.instance_block_device_mapping_list.InstanceBlockDeviceMappingList"
    ]
    """<p>Any block device mapping entries for the instance.</p>"""
    security_groups: NotRequired[
        "aws_sdk_snow_device_management.types.security_group_identifier_list.SecurityGroupIdentifierList"
    ]
    """<p>The security groups for the instance.</p>"""
    cpu_options: NotRequired[
        "aws_sdk_snow_device_management.types.cpu_options.CpuOptions"
    ]
...
def serialize_json(value: Instance) -> dict:
    ...
    if "state" in value:
        ...
        out["state"] = (
            aws_sdk_snow_device_management.types.instance_state.serialize_json(
                value["state"]
            )
        )
    ...
    if "block_device_mappings" in value:
        ...
        out["blockDeviceMappings"] = (
            aws_sdk_snow_device_management.types.instance_block_device_mapping_list.serialize_json(
    ...
    if "security_groups" in value:
        ...
        out["securityGroups"] = (
            aws_sdk_snow_device_management.types.security_group_identifier_list.serialize_json(
    ...
    if "cpu_options" in value:
        ...
        out["cpuOptions"] = (
            aws_sdk_snow_device_management.types.cpu_options.serialize_json(
                value["cpu_options"]
            )
        )
...
def deserialize_json(data: dict) -> Instance:
    ...
    if "state" in data:
        ...
        out["state"] = (
            aws_sdk_snow_device_management.types.instance_state.deserialize_json(
                data["state"]
            )
        )
    ...
    if "blockDeviceMappings" in data:
        ...
        out["block_device_mappings"] = (
            aws_sdk_snow_device_management.types.instance_block_device_mapping_list.deserialize_json(
    ...
    if "securityGroups" in data:
        ...
        out["security_groups"] = (
            aws_sdk_snow_device_management.types.security_group_identifier_list.deserialize_json(
                data["securityGroups"]
            )
        )
    if "cpuOptions" in data:
        ...
        out["cpu_options"] = (
            aws_sdk_snow_device_management.types.cpu_options.deserialize_json(
                data["cpuOptions"]
            )
        )
