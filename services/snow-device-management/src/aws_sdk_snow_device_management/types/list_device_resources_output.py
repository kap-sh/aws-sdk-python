...
class ListDeviceResourcesOutput(TypedDict):
    resources: NotRequired[
        "aws_sdk_snow_device_management.types.resource_summary_list.ResourceSummaryList"
    ]
...
def serialize_json(value: ListDeviceResourcesOutput) -> dict:
    ...
    if "resources" in value:
        ...
        out["resources"] = (
            aws_sdk_snow_device_management.types.resource_summary_list.serialize_json(
                value["resources"]
            )
        )
...
def deserialize_json(data: dict) -> ListDeviceResourcesOutput:
    ...
    if "resources" in data:
        ...
        out["resources"] = (
            aws_sdk_snow_device_management.types.resource_summary_list.deserialize_json(
                data["resources"]
            )
        )
