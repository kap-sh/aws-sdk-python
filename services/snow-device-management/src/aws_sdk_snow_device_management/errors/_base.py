...
class SnowDeviceManagementError(Exception):
    """Base class for all SnowDeviceManagement service errors."""


class ServiceError(SnowDeviceManagementError):
...
class SerializationError(SnowDeviceManagementError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SnowDeviceManagementError):
...
class WaiterFailedError(SnowDeviceManagementError):
...
class WaiterTimeoutError(SnowDeviceManagementError):
