...
def handle_response(
    ...
    out: capo_snow_device_management.types.list_executions_output.ListExecutionsOutput = capo_snow_device_management.types.list_executions_output.deserialize_json(
