"""Generated from Smithy shape ``com.amazonaws.snowdevicemanagement#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_snow_device_management.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_snow_device_management.types.list_tags_for_resource_output.deserialize_json(
