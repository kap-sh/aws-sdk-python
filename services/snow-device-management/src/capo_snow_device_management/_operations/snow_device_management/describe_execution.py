"""Generated from Smithy shape ``com.amazonaws.snowdevicemanagement#DescribeExecution``."""
...
def handle_response(
    ...
    out: capo_snow_device_management.types.describe_execution_output.DescribeExecutionOutput = capo_snow_device_management.types.describe_execution_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/task/{taskId}/execution/{managedDeviceId}"
...
async def async_describe_execution(
