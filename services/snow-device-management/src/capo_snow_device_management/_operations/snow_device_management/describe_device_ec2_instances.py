...
def handle_response(
    ...
    out: capo_snow_device_management.types.describe_device_ec2_output.DescribeDeviceEc2Output = capo_snow_device_management.types.describe_device_ec2_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snow_device_management.types.describe_device_ec2_input.serialize_json(
            input_
        )
    ).encode()
