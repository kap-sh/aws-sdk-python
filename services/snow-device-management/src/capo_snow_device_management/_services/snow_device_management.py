...
class SnowDeviceManagementClient:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        input_: capo_snow_device_management.types.list_tags_for_resource_input.ListTagsForResourceInput = {}  # type: ignore[typeddict-item]
    ...
    def tag_resource(
        ...
        *,
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_snow_device_management.types.tag_resource_input.TagResourceInput = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        input_["tags"] = tags
    ...
    def untag_resource(
        ...
        *,
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_snow_device_management.types.untag_resource_input.UntagResourceInput = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
