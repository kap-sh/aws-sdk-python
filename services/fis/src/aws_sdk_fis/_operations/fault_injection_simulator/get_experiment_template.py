...
def handle_response(
    ...
    out: aws_sdk_fis.types.get_experiment_template_response.GetExperimentTemplateResponse = aws_sdk_fis.types.get_experiment_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.get_experiment_template_request.GetExperimentTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
