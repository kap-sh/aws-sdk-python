...
def handle_response(
    ...
    out: aws_sdk_fis.types.delete_target_account_configuration_response.DeleteTargetAccountConfigurationResponse = aws_sdk_fis.types.delete_target_account_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.delete_target_account_configuration_request.DeleteTargetAccountConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
