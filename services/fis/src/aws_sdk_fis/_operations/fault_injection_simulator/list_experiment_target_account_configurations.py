...
def handle_response(
    ...
    out: aws_sdk_fis.types.list_experiment_target_account_configurations_response.ListExperimentTargetAccountConfigurationsResponse = aws_sdk_fis.types.list_experiment_target_account_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.list_experiment_target_account_configurations_request.ListExperimentTargetAccountConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
