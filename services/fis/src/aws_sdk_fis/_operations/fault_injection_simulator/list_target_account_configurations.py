"""Generated from Smithy shape ``com.amazonaws.fis#ListTargetAccountConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_fis.types.list_target_account_configurations_response.ListTargetAccountConfigurationsResponse = aws_sdk_fis.types.list_target_account_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.list_target_account_configurations_request.ListTargetAccountConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_target_account_configurations(
