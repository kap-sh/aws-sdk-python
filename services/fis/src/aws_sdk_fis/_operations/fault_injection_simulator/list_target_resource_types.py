...
def handle_response(
    ...
    out: aws_sdk_fis.types.list_target_resource_types_response.ListTargetResourceTypesResponse = aws_sdk_fis.types.list_target_resource_types_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.list_target_resource_types_request.ListTargetResourceTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
