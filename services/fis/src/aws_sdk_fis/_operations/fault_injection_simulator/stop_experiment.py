...
def handle_response(
    ...
    out: aws_sdk_fis.types.stop_experiment_response.StopExperimentResponse = (
        aws_sdk_fis.types.stop_experiment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.stop_experiment_request.StopExperimentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def stop_experiment(
    ...
    aws_sdk_fis.types.stop_experiment_response.StopExperimentResponse, zapros.Response
]:
