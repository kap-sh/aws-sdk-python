...
def handle_response(
    ...
    out: aws_sdk_fis.types.get_experiment_target_account_configuration_response.GetExperimentTargetAccountConfigurationResponse = aws_sdk_fis.types.get_experiment_target_account_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.get_experiment_target_account_configuration_request.GetExperimentTargetAccountConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
