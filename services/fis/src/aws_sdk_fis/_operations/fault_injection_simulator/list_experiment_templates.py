"""Generated from Smithy shape ``com.amazonaws.fis#ListExperimentTemplates``."""
...
def handle_response(
    ...
    out: aws_sdk_fis.types.list_experiment_templates_response.ListExperimentTemplatesResponse = aws_sdk_fis.types.list_experiment_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.list_experiment_templates_request.ListExperimentTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_experiment_templates(
