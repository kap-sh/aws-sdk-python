"""Generated from Smithy shape ``com.amazonaws.fis#ListExperimentResolvedTargets``."""
...
def handle_response(
    ...
    out: aws_sdk_fis.types.list_experiment_resolved_targets_response.ListExperimentResolvedTargetsResponse = aws_sdk_fis.types.list_experiment_resolved_targets_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_fis.types.list_experiment_resolved_targets_request.ListExperimentResolvedTargetsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/experiments/{experimentId}/resolvedTargets"
    url = url.replace("{experimentId}", quote(str(input["experiment_id"]), safe=""))
    params: dict[str, str] = {}
    if "max_results" in input:
        params["maxResults"] = str(input["max_results"])
    if "next_token" in input:
        params["nextToken"] = str(input["next_token"])
    if "target_name" in input:
        params["targetName"] = str(input["target_name"])
...
async def async_list_experiment_resolved_targets(
