...
def handle_response(
    ...
    out: aws_sdk_fis.types.delete_experiment_template_response.DeleteExperimentTemplateResponse = aws_sdk_fis.types.delete_experiment_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.delete_experiment_template_request.DeleteExperimentTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
