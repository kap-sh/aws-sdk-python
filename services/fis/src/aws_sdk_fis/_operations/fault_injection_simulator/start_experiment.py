"""Generated from Smithy shape ``com.amazonaws.fis#StartExperiment``."""
...
def handle_response(
    ...
    out: aws_sdk_fis.types.start_experiment_response.StartExperimentResponse = (
        aws_sdk_fis.types.start_experiment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.start_experiment_request.StartExperimentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/experiments"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_fis.types.start_experiment_request

    body: bytes | None = json.dumps(
        aws_sdk_fis.types.start_experiment_request.serialize_json(input_)
    ).encode()
...
def start_experiment(
    ...
    aws_sdk_fis.types.start_experiment_response.StartExperimentResponse, zapros.Response
]:
