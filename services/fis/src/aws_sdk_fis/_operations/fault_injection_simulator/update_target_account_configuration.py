...
def handle_response(
    ...
    out: aws_sdk_fis.types.update_target_account_configuration_response.UpdateTargetAccountConfigurationResponse = aws_sdk_fis.types.update_target_account_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.update_target_account_configuration_request.UpdateTargetAccountConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fis.types.update_target_account_configuration_request.serialize_json(
            input_
        )
    ).encode()
