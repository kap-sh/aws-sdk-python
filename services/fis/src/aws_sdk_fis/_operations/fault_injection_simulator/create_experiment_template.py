"""Generated from Smithy shape ``com.amazonaws.fis#CreateExperimentTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_fis.types.create_experiment_template_response.CreateExperimentTemplateResponse = aws_sdk_fis.types.create_experiment_template_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_fis.types.create_experiment_template_request.CreateExperimentTemplateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fis.types.create_experiment_template_request.serialize_json(input)
    ).encode()
...
async def async_create_experiment_template(
