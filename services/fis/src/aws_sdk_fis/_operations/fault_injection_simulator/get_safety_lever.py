...
def handle_response(
    ...
    out: aws_sdk_fis.types.get_safety_lever_response.GetSafetyLeverResponse = (
        aws_sdk_fis.types.get_safety_lever_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.get_safety_lever_request.GetSafetyLeverRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_safety_lever(
    ...
    aws_sdk_fis.types.get_safety_lever_response.GetSafetyLeverResponse, zapros.Response
]:
