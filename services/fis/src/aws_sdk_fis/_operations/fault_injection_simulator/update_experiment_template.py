...
def build_request(
    ...
    input_: aws_sdk_fis.types.update_experiment_template_request.UpdateExperimentTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fis.types.update_experiment_template_request.serialize_json(input_)
    ).encode()
