...
def build_request(
    ...
    input: aws_sdk_fis.types.update_experiment_template_request.UpdateExperimentTemplateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fis.types.update_experiment_template_request.serialize_json(input)
    ).encode()
