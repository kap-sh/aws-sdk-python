...
def handle_response(
    ...
    out: aws_sdk_fis.types.get_experiment_response.GetExperimentResponse = (
        aws_sdk_fis.types.get_experiment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.get_experiment_request.GetExperimentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_experiment(
    ...
    aws_sdk_fis.types.get_experiment_response.GetExperimentResponse, zapros.Response
]:
