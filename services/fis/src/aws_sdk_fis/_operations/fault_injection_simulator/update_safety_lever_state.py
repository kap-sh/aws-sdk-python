...
def handle_response(
    ...
    out: aws_sdk_fis.types.update_safety_lever_state_response.UpdateSafetyLeverStateResponse = aws_sdk_fis.types.update_safety_lever_state_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_fis.types.update_safety_lever_state_request.UpdateSafetyLeverStateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fis.types.update_safety_lever_state_request.serialize_json(input)
    ).encode()
