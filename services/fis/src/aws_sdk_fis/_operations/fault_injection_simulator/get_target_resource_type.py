...
def handle_response(
    ...
    out: aws_sdk_fis.types.get_target_resource_type_response.GetTargetResourceTypeResponse = aws_sdk_fis.types.get_target_resource_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_fis.types.get_target_resource_type_request.GetTargetResourceTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
