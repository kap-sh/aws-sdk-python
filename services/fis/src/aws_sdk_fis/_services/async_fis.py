...
from aws_sdk_fis._services._aws_config import aaws_config
...
class AsyncfisClientConfig(TypedDict, total=False):
...
class AsyncfisClient:
    ...
    async def create_experiment_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.create_experiment_template_request.CreateExperimentTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.create_experiment_template_response.CreateExperimentTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.create_experiment_template.async_create_experiment_template(
    ...
    async def create_target_account_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.create_target_account_configuration_request.CreateTargetAccountConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.create_target_account_configuration_response.CreateTargetAccountConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.create_target_account_configuration.async_create_target_account_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_experiment_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.delete_experiment_template_request.DeleteExperimentTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.delete_experiment_template_response.DeleteExperimentTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.delete_experiment_template.async_delete_experiment_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_target_account_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.delete_target_account_configuration_request.DeleteTargetAccountConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.delete_target_account_configuration_response.DeleteTargetAccountConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.delete_target_account_configuration.async_delete_target_account_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_action(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.get_action_request.GetActionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.get_action_response.GetActionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.get_action.async_get_action(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_experiment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.get_experiment_request.GetExperimentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.get_experiment_response.GetExperimentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.get_experiment.async_get_experiment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_experiment_target_account_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.get_experiment_target_account_configuration_request.GetExperimentTargetAccountConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.get_experiment_target_account_configuration_response.GetExperimentTargetAccountConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.get_experiment_target_account_configuration.async_get_experiment_target_account_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_experiment_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.get_experiment_template_request.GetExperimentTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.get_experiment_template_response.GetExperimentTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.get_experiment_template.async_get_experiment_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_safety_lever(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.get_safety_lever_request.GetSafetyLeverRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.get_safety_lever_response.GetSafetyLeverResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.get_safety_lever.async_get_safety_lever(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_target_account_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.get_target_account_configuration_request.GetTargetAccountConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.get_target_account_configuration_response.GetTargetAccountConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.get_target_account_configuration.async_get_target_account_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_target_resource_type(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.get_target_resource_type_request.GetTargetResourceTypeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.get_target_resource_type_response.GetTargetResourceTypeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.get_target_resource_type.async_get_target_resource_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_actions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.list_actions_request.ListActionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.list_actions_response.ListActionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.list_actions.async_list_actions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_actions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_fis.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_fis.types.action_summary.ActionSummary]":
        _token = next_token
        while True:
    ...
    async def list_experiment_resolved_targets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.list_experiment_resolved_targets_request.ListExperimentResolvedTargetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.list_experiment_resolved_targets_response.ListExperimentResolvedTargetsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.list_experiment_resolved_targets.async_list_experiment_resolved_targets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_experiment_resolved_targets(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_fis.types.next_token.NextToken"] = None,
        target_name: Optional["aws_sdk_fis.types.target_name.TargetName"] = None,
    ) -> "AsyncIterator[aws_sdk_fis.types.resolved_target.ResolvedTarget]":
        _token = next_token
        while True:
    ...
    async def list_experiments(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.list_experiments_request.ListExperimentsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.list_experiments_response.ListExperimentsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.list_experiments.async_list_experiments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_fis.types.experiment_summary.ExperimentSummary]":
        _token = next_token
        while True:
    ...
    async def list_experiment_target_account_configurations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.list_experiment_target_account_configurations_request.ListExperimentTargetAccountConfigurationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.list_experiment_target_account_configurations_response.ListExperimentTargetAccountConfigurationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.list_experiment_target_account_configurations.async_list_experiment_target_account_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_experiment_templates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.list_experiment_templates_request.ListExperimentTemplatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.list_experiment_templates_response.ListExperimentTemplatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.list_experiment_templates.async_list_experiment_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_experiment_templates(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_fis.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_fis.types.experiment_template_summary.ExperimentTemplateSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_target_account_configurations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.list_target_account_configurations_request.ListTargetAccountConfigurationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.list_target_account_configurations_response.ListTargetAccountConfigurationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.list_target_account_configurations.async_list_target_account_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_target_account_configurations(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_fis.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_fis.types.target_account_configuration_summary.TargetAccountConfigurationSummary]":
        _token = next_token
        while True:
    ...
    async def list_target_resource_types(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.list_target_resource_types_request.ListTargetResourceTypesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.list_target_resource_types_response.ListTargetResourceTypesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.list_target_resource_types.async_list_target_resource_types(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_target_resource_types(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_fis.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_fis.types.target_resource_type_summary.TargetResourceTypeSummary]":
        _token = next_token
        while True:
    ...
    async def start_experiment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.start_experiment_request.StartExperimentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.start_experiment_response.StartExperimentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.start_experiment.async_start_experiment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_experiment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.stop_experiment_request.StopExperimentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.stop_experiment_response.StopExperimentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.stop_experiment.async_stop_experiment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_experiment_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.update_experiment_template_request.UpdateExperimentTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.update_experiment_template_response.UpdateExperimentTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.update_experiment_template.async_update_experiment_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_safety_lever_state(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.update_safety_lever_state_request.UpdateSafetyLeverStateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.update_safety_lever_state_response.UpdateSafetyLeverStateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.update_safety_lever_state.async_update_safety_lever_state(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_target_account_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_fis.types.update_target_account_configuration_request.UpdateTargetAccountConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_fis.types.update_target_account_configuration_response.UpdateTargetAccountConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_fis._operations.fault_injection_simulator.update_target_account_configuration.async_update_target_account_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
