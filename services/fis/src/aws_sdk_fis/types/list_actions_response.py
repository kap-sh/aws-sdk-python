...
class ListActionsResponse(TypedDict, closed=True):
    actions: NotRequired["aws_sdk_fis.types.action_summary_list.ActionSummaryList"]
    """<p>The actions.</p>"""
...
def serialize_json(value: ListActionsResponse) -> dict:
    ...
    if "actions" in value:
        ...
        out["actions"] = aws_sdk_fis.types.action_summary_list.serialize_json(
            value["actions"]
        )
...
def deserialize_json(data: dict) -> ListActionsResponse:
    ...
    if "actions" in data:
        ...
        out["actions"] = aws_sdk_fis.types.action_summary_list.deserialize_json(
            data["actions"]
        )
