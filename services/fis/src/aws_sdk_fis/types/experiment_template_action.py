"""Generated from Smithy shape ``com.amazonaws.fis#ExperimentTemplateAction``."""
...
class ExperimentTemplateAction(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ExperimentTemplateAction) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ExperimentTemplateAction:
    out: ExperimentTemplateAction = {}  # type: ignore[typeddict-item]
    if "actionId" in data:
