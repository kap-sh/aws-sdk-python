...
if TYPE_CHECKING:
    import aws_sdk_fis.types.experiment_template_report_configuration_data_sources
    import aws_sdk_fis.types.experiment_template_report_configuration_outputs
    import aws_sdk_fis.types.report_configuration_duration


class ExperimentTemplateReportConfiguration(TypedDict):
    outputs: NotRequired[
        "aws_sdk_fis.types.experiment_template_report_configuration_outputs.ExperimentTemplateReportConfigurationOutputs"
    ]
    """<p>Describes the output destinations of the experiment report.</p>"""
    data_sources: NotRequired[
        "aws_sdk_fis.types.experiment_template_report_configuration_data_sources.ExperimentTemplateReportConfigurationDataSources"
    ]
...
def serialize_json(value: ExperimentTemplateReportConfiguration) -> dict:
    ...
    if "outputs" in value:
        ...
        out["outputs"] = (
            aws_sdk_fis.types.experiment_template_report_configuration_outputs.serialize_json(
                value["outputs"]
            )
        )
    if "data_sources" in value:
        ...
        out["dataSources"] = (
            aws_sdk_fis.types.experiment_template_report_configuration_data_sources.serialize_json(
                value["data_sources"]
            )
        )
...
def deserialize_json(data: dict) -> ExperimentTemplateReportConfiguration:
    ...
    if "outputs" in data:
        ...
        out["outputs"] = (
            aws_sdk_fis.types.experiment_template_report_configuration_outputs.deserialize_json(
                data["outputs"]
            )
        )
    if "dataSources" in data:
        ...
        out["data_sources"] = (
            aws_sdk_fis.types.experiment_template_report_configuration_data_sources.deserialize_json(
                data["dataSources"]
            )
        )
