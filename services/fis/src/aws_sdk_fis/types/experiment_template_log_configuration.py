...
if TYPE_CHECKING:
    import aws_sdk_fis.types.experiment_template_cloud_watch_logs_log_configuration
    import aws_sdk_fis.types.experiment_template_s3_log_configuration
    import aws_sdk_fis.types.log_schema_version


class ExperimentTemplateLogConfiguration(TypedDict):
    cloud_watch_logs_configuration: NotRequired[
        "aws_sdk_fis.types.experiment_template_cloud_watch_logs_log_configuration.ExperimentTemplateCloudWatchLogsLogConfiguration"
    ]
    """<p>The configuration for experiment logging to Amazon CloudWatch Logs.</p>"""
    s3_configuration: NotRequired[
        "aws_sdk_fis.types.experiment_template_s3_log_configuration.ExperimentTemplateS3LogConfiguration"
    ]
...
def serialize_json(value: ExperimentTemplateLogConfiguration) -> dict:
    ...
    if "cloud_watch_logs_configuration" in value:
        ...
        out["cloudWatchLogsConfiguration"] = (
            aws_sdk_fis.types.experiment_template_cloud_watch_logs_log_configuration.serialize_json(
    ...
    if "s3_configuration" in value:
        ...
        out["s3Configuration"] = (
            aws_sdk_fis.types.experiment_template_s3_log_configuration.serialize_json(
...
def deserialize_json(data: dict) -> ExperimentTemplateLogConfiguration:
    ...
    if "cloudWatchLogsConfiguration" in data:
        ...
        out["cloud_watch_logs_configuration"] = (
            aws_sdk_fis.types.experiment_template_cloud_watch_logs_log_configuration.deserialize_json(
    ...
    if "s3Configuration" in data:
        ...
        out["s3_configuration"] = (
            aws_sdk_fis.types.experiment_template_s3_log_configuration.deserialize_json(
