...
TargetAccountConfigurationList: TypeAlias = list[
    "aws_sdk_fis.types.target_account_configuration_summary.TargetAccountConfigurationSummary"
]
...
def serialize_json(value: TargetAccountConfigurationList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_fis.types.target_account_configuration_summary.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> TargetAccountConfigurationList:
    ...
    for item in data:
        out.append(
            aws_sdk_fis.types.target_account_configuration_summary.deserialize_json(
                item
            )
        )
    return out
