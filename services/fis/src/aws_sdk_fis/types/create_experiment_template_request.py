...
class CreateExperimentTemplateRequest(TypedDict):
...
def serialize_json(value: CreateExperimentTemplateRequest) -> dict:
    ...
    out["stopConditions"] = (
        aws_sdk_fis.types.create_experiment_template_stop_condition_input_list.serialize_json(
    ...
    if "targets" in value:
        ...
        out["targets"] = (
            aws_sdk_fis.types.create_experiment_template_target_input_map.serialize_json(
                value["targets"]
            )
        )
    import aws_sdk_fis.types.create_experiment_template_action_input_map
    ...
    out["actions"] = (
        aws_sdk_fis.types.create_experiment_template_action_input_map.serialize_json(
            value["actions"]
        )
    )
    ...
    if "log_configuration" in value:
        ...
        out["logConfiguration"] = (
            aws_sdk_fis.types.create_experiment_template_log_configuration_input.serialize_json(
    ...
    if "experiment_options" in value:
        ...
        out["experimentOptions"] = (
            aws_sdk_fis.types.create_experiment_template_experiment_options_input.serialize_json(
    ...
    if "experiment_report_configuration" in value:
        ...
        out["experimentReportConfiguration"] = (
            aws_sdk_fis.types.create_experiment_template_report_configuration_input.serialize_json(
...
def deserialize_json(data: dict) -> CreateExperimentTemplateRequest:
    ...
    if "stopConditions" in data:
        ...
        out["stop_conditions"] = (
            aws_sdk_fis.types.create_experiment_template_stop_condition_input_list.deserialize_json(
                data["stopConditions"]
            )
        )
    else:
    ...
    if "targets" in data:
        ...
        out["targets"] = (
            aws_sdk_fis.types.create_experiment_template_target_input_map.deserialize_json(
                data["targets"]
            )
        )
    if "actions" in data:
        ...
        out["actions"] = (
            aws_sdk_fis.types.create_experiment_template_action_input_map.deserialize_json(
                data["actions"]
            )
        )
    else:
    ...
    if "logConfiguration" in data:
        ...
        out["log_configuration"] = (
            aws_sdk_fis.types.create_experiment_template_log_configuration_input.deserialize_json(
    ...
    if "experimentOptions" in data:
        ...
        out["experiment_options"] = (
            aws_sdk_fis.types.create_experiment_template_experiment_options_input.deserialize_json(
    ...
    if "experimentReportConfiguration" in data:
        ...
        out["experiment_report_configuration"] = (
            aws_sdk_fis.types.create_experiment_template_report_configuration_input.deserialize_json(
