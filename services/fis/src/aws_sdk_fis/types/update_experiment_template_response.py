"""Generated from Smithy shape ``com.amazonaws.fis#UpdateExperimentTemplateResponse``."""
...
class UpdateExperimentTemplateResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateExperimentTemplateResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateExperimentTemplateResponse:
    out: UpdateExperimentTemplateResponse = {}  # type: ignore[typeddict-item]
