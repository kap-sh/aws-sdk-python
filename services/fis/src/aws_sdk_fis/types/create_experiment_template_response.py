"""Generated from Smithy shape ``com.amazonaws.fis#CreateExperimentTemplateResponse``."""
...
class CreateExperimentTemplateResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateExperimentTemplateResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateExperimentTemplateResponse:
    out: CreateExperimentTemplateResponse = {}  # type: ignore[typeddict-item]
