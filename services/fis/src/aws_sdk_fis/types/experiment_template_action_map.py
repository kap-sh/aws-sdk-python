...
if TYPE_CHECKING:
    import aws_sdk_fis.types.experiment_template_action
...
ExperimentTemplateActionMap: TypeAlias = dict[
    ...
    "aws_sdk_fis.types.experiment_template_action.ExperimentTemplateAction",
]
...
def serialize_json(input_to_serialize: ExperimentTemplateActionMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_fis.types.experiment_template_action.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> ExperimentTemplateActionMap:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_fis.types.experiment_template_action.deserialize_json(value)
    return out
