...
class TargetResourceType(TypedDict):
    ...
    parameters: NotRequired[
        "aws_sdk_fis.types.target_resource_type_parameter_map.TargetResourceTypeParameterMap"
    ]
...
def serialize_json(value: TargetResourceType) -> dict:
    ...
    if "parameters" in value:
        ...
        out["parameters"] = (
            aws_sdk_fis.types.target_resource_type_parameter_map.serialize_json(
                value["parameters"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> TargetResourceType:
    ...
    if "parameters" in data:
        ...
        out["parameters"] = (
            aws_sdk_fis.types.target_resource_type_parameter_map.deserialize_json(
                data["parameters"]
            )
        )
    return out
