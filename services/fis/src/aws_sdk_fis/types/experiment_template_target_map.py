...
if TYPE_CHECKING:
    import aws_sdk_fis.types.experiment_template_target
...
ExperimentTemplateTargetMap: TypeAlias = dict[
    ...
    "aws_sdk_fis.types.experiment_template_target.ExperimentTemplateTarget",
]
...
def serialize_json(input_to_serialize: ExperimentTemplateTargetMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_fis.types.experiment_template_target.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> ExperimentTemplateTargetMap:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_fis.types.experiment_template_target.deserialize_json(value)
    return out
