...
if TYPE_CHECKING:
    import capo_fis.types.experiment_template_target_parameter_name
    import capo_fis.types.experiment_template_target_parameter_value

ExperimentTemplateTargetParameterMap: TypeAlias = dict[
    "capo_fis.types.experiment_template_target_parameter_name.ExperimentTemplateTargetParameterName",
    "capo_fis.types.experiment_template_target_parameter_value.ExperimentTemplateTargetParameterValue",
]
