...
# --- restJson1 ser/de ---
def serialize_json(value: ReportConfigurationS3OutputInput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ReportConfigurationS3OutputInput:
    out: ReportConfigurationS3OutputInput = {}  # type: ignore[typeddict-item]
