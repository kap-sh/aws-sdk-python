...
if TYPE_CHECKING:
    import capo_fis.types.experiment_report_s3_report_arn
    import capo_fis.types.experiment_report_s3_report_type


class ExperimentReportS3Report(TypedDict, closed=True):
    arn: NotRequired[
        "capo_fis.types.experiment_report_s3_report_arn.ExperimentReportS3ReportArn"
    ]
    """<p>The Amazon Resource Name (ARN) of the generated report.</p>"""
    report_type: NotRequired[
        "capo_fis.types.experiment_report_s3_report_type.ExperimentReportS3ReportType"
    ]
