...
if TYPE_CHECKING:
    import capo_fis.types.experiment_cloud_watch_logs_log_configuration
    import capo_fis.types.experiment_s3_log_configuration
...
class ExperimentLogConfiguration(TypedDict, closed=True):
    cloud_watch_logs_configuration: NotRequired[
        "capo_fis.types.experiment_cloud_watch_logs_log_configuration.ExperimentCloudWatchLogsLogConfiguration"
    ]
    """<p>The configuration for experiment logging to Amazon CloudWatch Logs.</p>"""
    s3_configuration: NotRequired[
        "capo_fis.types.experiment_s3_log_configuration.ExperimentS3LogConfiguration"
    ]
...
def serialize_json(value: ExperimentLogConfiguration) -> dict:
    ...
    if "cloud_watch_logs_configuration" in value:
        ...
        out["cloudWatchLogsConfiguration"] = (
            capo_fis.types.experiment_cloud_watch_logs_log_configuration.serialize_json(
    ...
    if "s3_configuration" in value:
        ...
        out["s3Configuration"] = (
            capo_fis.types.experiment_s3_log_configuration.serialize_json(
...
def deserialize_json(data: dict) -> ExperimentLogConfiguration:
    ...
    if "cloudWatchLogsConfiguration" in data:
        ...
        out["cloud_watch_logs_configuration"] = (
            capo_fis.types.experiment_cloud_watch_logs_log_configuration.deserialize_json(
    ...
    if "s3Configuration" in data:
        ...
        out["s3_configuration"] = (
            capo_fis.types.experiment_s3_log_configuration.deserialize_json(
