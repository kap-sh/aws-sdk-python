"""Generated from Smithy shape ``com.amazonaws.fis#TargetAccountConfigurationSummary``."""
...
class TargetAccountConfigurationSummary(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: TargetAccountConfigurationSummary) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> TargetAccountConfigurationSummary:
    out: TargetAccountConfigurationSummary = {}  # type: ignore[typeddict-item]
    if "roleArn" in data:
