...
if TYPE_CHECKING:
    import capo_fis.types.experiment_template_target_filter_value

ExperimentTemplateTargetFilterValues: TypeAlias = list[
    "capo_fis.types.experiment_template_target_filter_value.ExperimentTemplateTargetFilterValue"
]
