...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.get_metadata_transfer_job_response.GetMetadataTransferJobResponse = aws_sdk_iottwinmaker.types.get_metadata_transfer_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.get_metadata_transfer_job_request.GetMetadataTransferJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
