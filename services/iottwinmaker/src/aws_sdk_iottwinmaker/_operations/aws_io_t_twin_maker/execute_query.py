...
import aws_sdk_iottwinmaker.errors.query_timeout_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "QueryTimeoutException":
            raise aws_sdk_iottwinmaker.errors.query_timeout_exception.QueryTimeoutException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.execute_query_response.ExecuteQueryResponse = (
        aws_sdk_iottwinmaker.types.execute_query_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.execute_query_request.ExecuteQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.execute_query_request.serialize_json(input_)
    ).encode()
