"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#ListComponents``."""
...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.list_components_response.ListComponentsResponse = (
        aws_sdk_iottwinmaker.types.list_components_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iottwinmaker.types.list_components_request.ListComponentsRequest,
) -> zapros.Request:
    ...
    url = url.replace("{entityId}", quote(str(input["entity_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iottwinmaker.types.list_components_request

    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.list_components_request.serialize_json(input)
    ).encode()
