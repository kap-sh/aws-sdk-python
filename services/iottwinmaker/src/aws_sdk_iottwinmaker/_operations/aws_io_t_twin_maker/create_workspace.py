...
def build_request(
    ...
    input: aws_sdk_iottwinmaker.types.create_workspace_request.CreateWorkspaceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.create_workspace_request.serialize_json(input)
    ).encode()
