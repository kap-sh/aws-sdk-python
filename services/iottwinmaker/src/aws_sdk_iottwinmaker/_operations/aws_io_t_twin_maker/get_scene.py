...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.get_scene_response.GetSceneResponse = (
        aws_sdk_iottwinmaker.types.get_scene_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.get_scene_request.GetSceneRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_scene(
    ...
    aws_sdk_iottwinmaker.types.get_scene_response.GetSceneResponse, zapros.Response
]:
