...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.get_workspace_response.GetWorkspaceResponse = (
        aws_sdk_iottwinmaker.types.get_workspace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.get_workspace_request.GetWorkspaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
