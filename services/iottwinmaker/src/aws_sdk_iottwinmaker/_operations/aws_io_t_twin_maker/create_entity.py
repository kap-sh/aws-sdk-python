...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.create_entity_response.CreateEntityResponse = (
        aws_sdk_iottwinmaker.types.create_entity_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.create_entity_request.CreateEntityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.create_entity_request.serialize_json(input_)
    ).encode()
