...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.cancel_metadata_transfer_job_response.CancelMetadataTransferJobResponse = aws_sdk_iottwinmaker.types.cancel_metadata_transfer_job_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iottwinmaker.types.cancel_metadata_transfer_job_request.CancelMetadataTransferJobRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["metadata_transfer_job_id"]), safe=""),
    )
    params: dict[str, str] = {}
