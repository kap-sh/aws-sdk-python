"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#DeleteWorkspace``."""
...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.delete_workspace_response.DeleteWorkspaceResponse = aws_sdk_iottwinmaker.types.delete_workspace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.delete_workspace_request.DeleteWorkspaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
