"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#DeleteSyncJob``."""
...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.delete_sync_job_response.DeleteSyncJobResponse = (
        aws_sdk_iottwinmaker.types.delete_sync_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.delete_sync_job_request.DeleteSyncJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_sync_job(
