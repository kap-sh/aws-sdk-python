...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.get_sync_job_response.GetSyncJobResponse = (
        aws_sdk_iottwinmaker.types.get_sync_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.get_sync_job_request.GetSyncJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_sync_job(
    ...
    aws_sdk_iottwinmaker.types.get_sync_job_response.GetSyncJobResponse, zapros.Response
]:
