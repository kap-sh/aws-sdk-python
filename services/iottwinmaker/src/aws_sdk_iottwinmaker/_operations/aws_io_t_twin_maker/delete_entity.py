...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.delete_entity_response.DeleteEntityResponse = (
        aws_sdk_iottwinmaker.types.delete_entity_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iottwinmaker.types.delete_entity_request.DeleteEntityRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "is_recursive" in input:
        params["isRecursive"] = str(input["is_recursive"])
