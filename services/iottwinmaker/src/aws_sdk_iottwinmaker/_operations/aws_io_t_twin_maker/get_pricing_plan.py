...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.get_pricing_plan_response.GetPricingPlanResponse = (
        aws_sdk_iottwinmaker.types.get_pricing_plan_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.get_pricing_plan_request.GetPricingPlanRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
