...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.create_metadata_transfer_job_response.CreateMetadataTransferJobResponse = aws_sdk_iottwinmaker.types.create_metadata_transfer_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.create_metadata_transfer_job_request.CreateMetadataTransferJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.create_metadata_transfer_job_request.serialize_json(
            input_
        )
    ).encode()
