"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#ListTagsForResource``."""
...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_iottwinmaker.types.list_tags_for_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/tags-list"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iottwinmaker.types.list_tags_for_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.list_tags_for_resource_request.serialize_json(input_)
    ).encode()
