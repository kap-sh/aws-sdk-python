"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#ListComponentTypes``."""
...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.list_component_types_response.ListComponentTypesResponse = aws_sdk_iottwinmaker.types.list_component_types_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.list_component_types_request.ListComponentTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}/component-types-list"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.list_component_types_request.serialize_json(input_)
    ).encode()
...
async def async_list_component_types(
