...
def build_request(
    ...
    input: aws_sdk_iottwinmaker.types.list_component_types_request.ListComponentTypesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.list_component_types_request.serialize_json(input)
    ).encode()
