...
def build_request(
    ...
    input: aws_sdk_iottwinmaker.types.list_sync_resources_request.ListSyncResourcesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.list_sync_resources_request.serialize_json(input)
    ).encode()
