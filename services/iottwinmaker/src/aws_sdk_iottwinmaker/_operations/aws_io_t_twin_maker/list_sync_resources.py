...
import aws_sdk_iottwinmaker.types.sync_resource_summaries
...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.list_sync_resources_response.ListSyncResourcesResponse = aws_sdk_iottwinmaker.types.list_sync_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.list_sync_resources_request.ListSyncResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.list_sync_resources_request.serialize_json(input_)
    ).encode()
