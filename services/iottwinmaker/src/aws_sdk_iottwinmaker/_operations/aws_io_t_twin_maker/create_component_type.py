...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.create_component_type_request.CreateComponentTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.create_component_type_request.serialize_json(input_)
    ).encode()
