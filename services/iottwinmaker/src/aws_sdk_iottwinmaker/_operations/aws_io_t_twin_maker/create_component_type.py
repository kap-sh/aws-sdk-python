...
def build_request(
    ...
    input: aws_sdk_iottwinmaker.types.create_component_type_request.CreateComponentTypeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.create_component_type_request.serialize_json(input)
    ).encode()
