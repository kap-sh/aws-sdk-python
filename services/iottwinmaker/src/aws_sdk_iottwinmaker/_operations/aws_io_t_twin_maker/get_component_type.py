"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#GetComponentType``."""
...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.get_component_type_response.GetComponentTypeResponse = aws_sdk_iottwinmaker.types.get_component_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.get_component_type_request.GetComponentTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_component_type(
