...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.batch_put_property_values_response.BatchPutPropertyValuesResponse = aws_sdk_iottwinmaker.types.batch_put_property_values_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.batch_put_property_values_request.BatchPutPropertyValuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.batch_put_property_values_request.serialize_json(
            input_
        )
    ).encode()
