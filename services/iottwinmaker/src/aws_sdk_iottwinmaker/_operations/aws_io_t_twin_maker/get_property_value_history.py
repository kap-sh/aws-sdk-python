...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.get_property_value_history_response.GetPropertyValueHistoryResponse = aws_sdk_iottwinmaker.types.get_property_value_history_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.get_property_value_history_request.GetPropertyValueHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.get_property_value_history_request.serialize_json(
            input_
        )
    ).encode()
