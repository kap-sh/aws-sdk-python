...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.list_sync_jobs_response.ListSyncJobsResponse = (
        aws_sdk_iottwinmaker.types.list_sync_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.list_sync_jobs_request.ListSyncJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.list_sync_jobs_request.serialize_json(input_)
    ).encode()
