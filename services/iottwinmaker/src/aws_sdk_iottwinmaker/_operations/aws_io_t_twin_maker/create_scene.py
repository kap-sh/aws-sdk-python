...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.create_scene_response.CreateSceneResponse = (
        aws_sdk_iottwinmaker.types.create_scene_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.create_scene_request.CreateSceneRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.create_scene_request.serialize_json(input_)
    ).encode()
