...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.get_entity_response.GetEntityResponse = (
        aws_sdk_iottwinmaker.types.get_entity_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.get_entity_request.GetEntityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_entity(
    ...
    aws_sdk_iottwinmaker.types.get_entity_response.GetEntityResponse, zapros.Response
]:
