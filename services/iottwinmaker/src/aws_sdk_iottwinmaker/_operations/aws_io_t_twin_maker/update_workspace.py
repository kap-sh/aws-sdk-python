...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.update_workspace_response.UpdateWorkspaceResponse = aws_sdk_iottwinmaker.types.update_workspace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.update_workspace_request.UpdateWorkspaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.update_workspace_request.serialize_json(input_)
    ).encode()
