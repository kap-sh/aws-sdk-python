...
def build_request(
    ...
    input: aws_sdk_iottwinmaker.types.update_workspace_request.UpdateWorkspaceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.update_workspace_request.serialize_json(input)
    ).encode()
