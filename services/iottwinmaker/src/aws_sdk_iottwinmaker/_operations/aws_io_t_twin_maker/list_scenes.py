"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#ListScenes``."""
...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.list_scenes_response.ListScenesResponse = (
        aws_sdk_iottwinmaker.types.list_scenes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.list_scenes_request.ListScenesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}/scenes-list"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.list_scenes_request.serialize_json(input_)
    ).encode()
...
def list_scenes(
    ...
    aws_sdk_iottwinmaker.types.list_scenes_response.ListScenesResponse, zapros.Response
]:
