"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#ListProperties``."""
...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.list_properties_response.ListPropertiesResponse = (
        aws_sdk_iottwinmaker.types.list_properties_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.list_properties_request.ListPropertiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}/properties-list"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.list_properties_request.serialize_json(input_)
    ).encode()
...
async def async_list_properties(
