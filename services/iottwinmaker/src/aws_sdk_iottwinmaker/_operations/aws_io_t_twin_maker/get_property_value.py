...
def build_request(
    ...
    input: aws_sdk_iottwinmaker.types.get_property_value_request.GetPropertyValueRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.get_property_value_request.serialize_json(input)
    ).encode()
