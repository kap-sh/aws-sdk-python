...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.list_entities_response.ListEntitiesResponse = (
        aws_sdk_iottwinmaker.types.list_entities_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iottwinmaker.types.list_entities_request.ListEntitiesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.list_entities_request.serialize_json(input)
    ).encode()
