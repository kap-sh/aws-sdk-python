"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#UntagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
