...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.list_workspaces_response.ListWorkspacesResponse = (
        aws_sdk_iottwinmaker.types.list_workspaces_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.list_workspaces_request.ListWorkspacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.list_workspaces_request.serialize_json(input_)
    ).encode()
