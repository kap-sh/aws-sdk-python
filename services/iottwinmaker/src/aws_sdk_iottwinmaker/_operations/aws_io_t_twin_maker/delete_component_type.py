"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#DeleteComponentType``."""
...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.delete_component_type_response.DeleteComponentTypeResponse = aws_sdk_iottwinmaker.types.delete_component_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.delete_component_type_request.DeleteComponentTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_component_type(
