...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.delete_scene_response.DeleteSceneResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.delete_scene_request.DeleteSceneRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
