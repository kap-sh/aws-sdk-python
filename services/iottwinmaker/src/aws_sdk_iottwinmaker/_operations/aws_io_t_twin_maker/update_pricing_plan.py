...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.update_pricing_plan_response.UpdatePricingPlanResponse = aws_sdk_iottwinmaker.types.update_pricing_plan_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.update_pricing_plan_request.UpdatePricingPlanRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.update_pricing_plan_request.serialize_json(input_)
    ).encode()
