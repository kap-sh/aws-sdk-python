...
def build_request(
    ...
    input: aws_sdk_iottwinmaker.types.update_pricing_plan_request.UpdatePricingPlanRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.update_pricing_plan_request.serialize_json(input)
    ).encode()
