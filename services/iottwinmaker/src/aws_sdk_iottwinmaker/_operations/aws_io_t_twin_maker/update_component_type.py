...
def build_request(
    ...
    input: aws_sdk_iottwinmaker.types.update_component_type_request.UpdateComponentTypeRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{componentTypeId}", quote(str(input["component_type_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.update_component_type_request.serialize_json(input)
    ).encode()
