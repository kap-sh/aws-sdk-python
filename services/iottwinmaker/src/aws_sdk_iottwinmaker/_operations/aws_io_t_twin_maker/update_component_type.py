"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#UpdateComponentType``."""
...
def handle_response(
    ...
    out: aws_sdk_iottwinmaker.types.update_component_type_response.UpdateComponentTypeResponse = aws_sdk_iottwinmaker.types.update_component_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iottwinmaker.types.update_component_type_request.UpdateComponentTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iottwinmaker.types.update_component_type_request.serialize_json(input_)
    ).encode()
...
async def async_update_component_type(
