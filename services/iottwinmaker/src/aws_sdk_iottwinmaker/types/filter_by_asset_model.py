...
class FilterByAssetModel(TypedDict):
    asset_model_id: NotRequired["aws_sdk_iottwinmaker.types.uuid.Uuid"]
    ...
    include_assets: NotRequired["aws_sdk_iottwinmaker.types.boolean.Boolean"]
