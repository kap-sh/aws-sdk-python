...
# --- restJson1 ser/de ---
def serialize_json(value: CompositeComponentUpdateRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CompositeComponentUpdateRequest:
    out: CompositeComponentUpdateRequest = {}  # type: ignore[typeddict-item]
