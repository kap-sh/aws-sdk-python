...
class SyncJobSummary(TypedDict, closed=True):
    ...
    """<p>The sync source.</p>"""
    status: NotRequired["aws_sdk_iottwinmaker.types.sync_job_status.SyncJobStatus"]
    """<p>The SyncJob summaries status.</p>"""
    creation_date_time: NotRequired["aws_sdk_iottwinmaker.types.timestamp.Timestamp"]
