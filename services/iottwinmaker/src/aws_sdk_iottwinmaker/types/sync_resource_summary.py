...
if TYPE_CHECKING:
    ...
    import aws_sdk_iottwinmaker.types.sync_resource_status
    import aws_sdk_iottwinmaker.types.sync_resource_type
    import aws_sdk_iottwinmaker.types.timestamp


class SyncResourceSummary(TypedDict):
    resource_type: NotRequired[
        "aws_sdk_iottwinmaker.types.sync_resource_type.SyncResourceType"
    ]
    """<p>The resource type.</p>"""
    external_id: NotRequired["aws_sdk_iottwinmaker.types.id.Id"]
    """<p>The external ID.</p>"""
    resource_id: NotRequired["aws_sdk_iottwinmaker.types.id.Id"]
    """<p>The resource ID.</p>"""
    status: NotRequired[
        "aws_sdk_iottwinmaker.types.sync_resource_status.SyncResourceStatus"
    ]
    """<p>The sync resource summary status.</p>"""
    update_date_time: NotRequired["aws_sdk_iottwinmaker.types.timestamp.Timestamp"]
...
def serialize_json(value: SyncResourceSummary) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = aws_sdk_iottwinmaker.types.sync_resource_status.serialize_json(
            value["status"]
        )
...
def deserialize_json(data: dict) -> SyncResourceSummary:
    ...
    if "status" in data:
        ...
        out["status"] = (
            aws_sdk_iottwinmaker.types.sync_resource_status.deserialize_json(
                data["status"]
            )
        )
