"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iottwinmaker#ServiceQuotaExceededException``."""
