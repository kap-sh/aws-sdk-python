"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#TooManyTagsException``."""
...
if TYPE_CHECKING:
    import capo_iottwinmaker.types.exception_message


class TooManyTagsException_(TypedDict, closed=True):
    message: NotRequired["capo_iottwinmaker.types.exception_message.ExceptionMessage"]
...
class TooManyTagsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iottwinmaker#TooManyTagsException``."""
