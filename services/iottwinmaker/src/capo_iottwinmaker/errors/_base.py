...
class IoTTwinMakerError(Exception):
    """Base class for all IoTTwinMaker service errors."""


class ServiceError(IoTTwinMakerError):
...
class SerializationError(IoTTwinMakerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IoTTwinMakerError):
...
class WaiterFailedError(IoTTwinMakerError):
...
class WaiterTimeoutError(IoTTwinMakerError):
