"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iottwinmaker#InternalServerException``."""
