...
class MetadataTransferJobProgress(TypedDict, closed=True):
    total_count: NotRequired["capo_iottwinmaker.types.integer.Integer"]
    """<p>The total count. [of what]</p>"""
    succeeded_count: NotRequired["capo_iottwinmaker.types.integer.Integer"]
    """<p>The succeeded count.</p>"""
    skipped_count: NotRequired["capo_iottwinmaker.types.integer.Integer"]
    """<p>The skipped count.</p>"""
    failed_count: NotRequired["capo_iottwinmaker.types.integer.Integer"]
