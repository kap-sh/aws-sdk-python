...
class UpdateEntityRequest(TypedDict, closed=True):
    ...
    entity_name: NotRequired["capo_iottwinmaker.types.entity_name.EntityName"]
...
def serialize_json(value: UpdateEntityRequest) -> dict:
    ...
    if "component_updates" in value:
        ...
        out["componentUpdates"] = (
            capo_iottwinmaker.types.component_updates_map_request.serialize_json(
    ...
    if "composite_component_updates" in value:
        ...
        out["compositeComponentUpdates"] = (
            capo_iottwinmaker.types.composite_component_updates_map_request.serialize_json(
    ...
    if "parent_entity_update" in value:
        ...
        out["parentEntityUpdate"] = (
            capo_iottwinmaker.types.parent_entity_update_request.serialize_json(
...
def deserialize_json(data: dict) -> UpdateEntityRequest:
    ...
    if "componentUpdates" in data:
        ...
        out["component_updates"] = (
            capo_iottwinmaker.types.component_updates_map_request.deserialize_json(
    ...
    if "compositeComponentUpdates" in data:
        ...
        out["composite_component_updates"] = (
            capo_iottwinmaker.types.composite_component_updates_map_request.deserialize_json(
    ...
    if "parentEntityUpdate" in data:
        ...
        out["parent_entity_update"] = (
            capo_iottwinmaker.types.parent_entity_update_request.deserialize_json(
