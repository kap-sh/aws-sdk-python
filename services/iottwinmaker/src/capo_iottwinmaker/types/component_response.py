...
class ComponentResponse(TypedDict, closed=True):
    ...
    properties: NotRequired[
        "capo_iottwinmaker.types.property_responses.PropertyResponses"
    ]
    ...
    are_all_properties_returned: NotRequired["capo_iottwinmaker.types.boolean.Boolean"]
    ...
    composite_components: NotRequired[
        "capo_iottwinmaker.types.composite_component_response.CompositeComponentResponse"
    ]
...
def serialize_json(value: ComponentResponse) -> dict:
    ...
    if "properties" in value:
        ...
        out["properties"] = capo_iottwinmaker.types.property_responses.serialize_json(
            value["properties"]
        )
    ...
    if "composite_components" in value:
        ...
        out["compositeComponents"] = (
            capo_iottwinmaker.types.composite_component_response.serialize_json(
...
def deserialize_json(data: dict) -> ComponentResponse:
    ...
    if "compositeComponents" in data:
        ...
        out["composite_components"] = (
            capo_iottwinmaker.types.composite_component_response.deserialize_json(
