...
if TYPE_CHECKING:
    import capo_iottwinmaker.types.column_name
    import capo_iottwinmaker.types.column_type


class ColumnDescription(TypedDict, closed=True):
    name: NotRequired["capo_iottwinmaker.types.column_name.ColumnName"]
    """<p>The name of the column description.</p>"""
    type: NotRequired["capo_iottwinmaker.types.column_type.ColumnType"]
