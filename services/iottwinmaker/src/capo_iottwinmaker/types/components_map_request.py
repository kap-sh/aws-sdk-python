...
if TYPE_CHECKING:
    import capo_iottwinmaker.types.component_request
    import capo_iottwinmaker.types.name

ComponentsMapRequest: TypeAlias = dict[
    "capo_iottwinmaker.types.name.Name",
    "capo_iottwinmaker.types.component_request.ComponentRequest",
]
...
def serialize_json(input_to_serialize: ComponentsMapRequest) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = capo_iottwinmaker.types.component_request.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> ComponentsMapRequest:
    ...
    for key, value in data.items():
        ...
        out[key] = capo_iottwinmaker.types.component_request.deserialize_json(value)
    return out
