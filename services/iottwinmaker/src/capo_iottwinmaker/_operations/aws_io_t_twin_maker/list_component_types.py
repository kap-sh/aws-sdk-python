...
import capo_iottwinmaker.types.component_type_summaries
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.list_component_types_response.ListComponentTypesResponse = capo_iottwinmaker.types.list_component_types_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.list_component_types_request.serialize_json(input_)
    ).encode()
