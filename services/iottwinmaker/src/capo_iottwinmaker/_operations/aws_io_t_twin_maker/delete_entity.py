"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#DeleteEntity``."""
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.delete_entity_response.DeleteEntityResponse = (
        capo_iottwinmaker.types.delete_entity_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "is_recursive" in input_:
        params["isRecursive"] = str(input_["is_recursive"])
...
def delete_entity(
    ...
    capo_iottwinmaker.types.delete_entity_response.DeleteEntityResponse, zapros.Response
]:
