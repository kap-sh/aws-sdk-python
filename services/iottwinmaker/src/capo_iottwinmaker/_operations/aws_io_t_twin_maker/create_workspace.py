"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#CreateWorkspace``."""
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.create_workspace_response.CreateWorkspaceResponse = (
        capo_iottwinmaker.types.create_workspace_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.create_workspace_request.serialize_json(input_)
    ).encode()
