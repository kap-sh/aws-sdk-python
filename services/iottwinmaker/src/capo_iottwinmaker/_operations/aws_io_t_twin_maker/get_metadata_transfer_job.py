"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#GetMetadataTransferJob``."""
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.get_metadata_transfer_job_response.GetMetadataTransferJobResponse = capo_iottwinmaker.types.get_metadata_transfer_job_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/metadata-transfer-jobs/{metadataTransferJobId}"
    url = url.replace(
...
async def async_get_metadata_transfer_job(
