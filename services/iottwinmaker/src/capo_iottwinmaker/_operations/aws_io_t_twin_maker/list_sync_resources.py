"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#ListSyncResources``."""
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.list_sync_resources_response.ListSyncResourcesResponse = capo_iottwinmaker.types.list_sync_resources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.list_sync_resources_request.serialize_json(input_)
    ).encode()
...
async def async_list_sync_resources(
