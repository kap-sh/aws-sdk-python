...
def handle_response(
    ...
    out: capo_iottwinmaker.types.update_entity_response.UpdateEntityResponse = (
        capo_iottwinmaker.types.update_entity_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.update_entity_request.serialize_json(input_)
    ).encode()
...
def update_entity(
    ...
    capo_iottwinmaker.types.update_entity_response.UpdateEntityResponse, zapros.Response
]:
