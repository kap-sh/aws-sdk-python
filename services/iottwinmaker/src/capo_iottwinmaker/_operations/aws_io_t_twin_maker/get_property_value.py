...
import capo_iottwinmaker.errors.connector_failure_exception
import capo_iottwinmaker.errors.connector_timeout_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConnectorFailureException":
            raise capo_iottwinmaker.errors.connector_failure_exception.ConnectorFailureException.from_json(
                data
            )
        case "ConnectorTimeoutException":
            raise capo_iottwinmaker.errors.connector_timeout_exception.ConnectorTimeoutException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.get_property_value_response.GetPropertyValueResponse = capo_iottwinmaker.types.get_property_value_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.get_property_value_request.serialize_json(input_)
    ).encode()
