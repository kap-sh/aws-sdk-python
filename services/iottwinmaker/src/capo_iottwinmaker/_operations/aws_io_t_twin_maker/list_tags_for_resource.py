...
def handle_response(
    ...
    out: capo_iottwinmaker.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_iottwinmaker.types.list_tags_for_resource_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.list_tags_for_resource_request.serialize_json(input_)
    ).encode()
