"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#ExecuteQuery``."""
...
import capo_iottwinmaker.errors.query_timeout_exception
import capo_iottwinmaker.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "QueryTimeoutException":
            raise capo_iottwinmaker.errors.query_timeout_exception.QueryTimeoutException.from_json(
                data
            )
        case "ServiceQuotaExceededException":
            raise capo_iottwinmaker.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.execute_query_response.ExecuteQueryResponse = (
        capo_iottwinmaker.types.execute_query_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.execute_query_request.serialize_json(input_)
    ).encode()
...
def execute_query(
    ...
    capo_iottwinmaker.types.execute_query_response.ExecuteQueryResponse, zapros.Response
]:
