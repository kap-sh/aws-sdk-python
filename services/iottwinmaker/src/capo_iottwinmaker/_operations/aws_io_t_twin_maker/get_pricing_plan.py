"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#GetPricingPlan``."""
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.get_pricing_plan_response.GetPricingPlanResponse = (
        capo_iottwinmaker.types.get_pricing_plan_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/pricingplan"
    params: dict[str, str] = {}
...
async def async_get_pricing_plan(
