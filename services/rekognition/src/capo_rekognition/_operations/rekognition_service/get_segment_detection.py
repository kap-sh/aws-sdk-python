"""Generated from Smithy shape ``com.amazonaws.rekognition#GetSegmentDetection``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.get_segment_detection_response.GetSegmentDetectionResponse = capo_rekognition.types.get_segment_detection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.GetSegmentDetection"
    body: bytes | None = json.dumps(
        capo_rekognition.types.get_segment_detection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_segment_detection(
