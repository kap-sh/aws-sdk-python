"""Generated from Smithy shape ``com.amazonaws.rekognition#IndexFaces``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.index_faces_response.IndexFacesResponse = (
        capo_rekognition.types.index_faces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.index_faces_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def index_faces(
    ...
    capo_rekognition.types.index_faces_response.IndexFacesResponse, zapros.Response
]:
