"""Generated from Smithy shape ``com.amazonaws.rekognition#RecognizeCelebrities``."""
...
import capo_rekognition.types.celebrity_list
import capo_rekognition.types.compared_face_list
...
def handle_response(
    ...
    out: capo_rekognition.types.recognize_celebrities_response.RecognizeCelebritiesResponse = capo_rekognition.types.recognize_celebrities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.recognize_celebrities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_recognize_celebrities(
