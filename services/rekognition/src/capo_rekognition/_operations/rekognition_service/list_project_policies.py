"""Generated from Smithy shape ``com.amazonaws.rekognition#ListProjectPolicies``."""
...
import capo_rekognition.types.project_policies
...
def handle_response(
    ...
    out: capo_rekognition.types.list_project_policies_response.ListProjectPoliciesResponse = capo_rekognition.types.list_project_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.ListProjectPolicies"
    body: bytes | None = json.dumps(
        capo_rekognition.types.list_project_policies_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_project_policies(
