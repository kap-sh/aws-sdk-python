"""Generated from Smithy shape ``com.amazonaws.rekognition#SearchFacesByImage``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.search_faces_by_image_response.SearchFacesByImageResponse = capo_rekognition.types.search_faces_by_image_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.search_faces_by_image_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_search_faces_by_image(
