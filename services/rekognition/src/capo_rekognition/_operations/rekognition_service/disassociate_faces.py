"""Generated from Smithy shape ``com.amazonaws.rekognition#DisassociateFaces``."""
...
import capo_rekognition.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_rekognition.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_rekognition.types.disassociate_faces_response.DisassociateFacesResponse = capo_rekognition.types.disassociate_faces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.DisassociateFaces"
    body: bytes | None = json.dumps(
        capo_rekognition.types.disassociate_faces_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_disassociate_faces(
