"""Generated from Smithy shape ``com.amazonaws.rekognition#CopyProjectVersion``."""
...
import capo_rekognition.errors.resource_in_use_exception
import capo_rekognition.errors.resource_not_found_exception
import capo_rekognition.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise capo_rekognition.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_rekognition.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_rekognition.types.copy_project_version_response.CopyProjectVersionResponse = capo_rekognition.types.copy_project_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.CopyProjectVersion"
    body: bytes | None = json.dumps(
        capo_rekognition.types.copy_project_version_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_copy_project_version(
