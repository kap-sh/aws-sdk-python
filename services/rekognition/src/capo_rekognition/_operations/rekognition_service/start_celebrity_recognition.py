"""Generated from Smithy shape ``com.amazonaws.rekognition#StartCelebrityRecognition``."""
...
import capo_rekognition.errors.idempotent_parameter_mismatch_exception
...
import capo_rekognition.errors.video_too_large_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IdempotentParameterMismatchException":
            raise capo_rekognition.errors.idempotent_parameter_mismatch_exception.IdempotentParameterMismatchException.from_aws_json_1_1(
                data
            )
        ...
        case "VideoTooLargeException":
            raise capo_rekognition.errors.video_too_large_exception.VideoTooLargeException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_rekognition.types.start_celebrity_recognition_response.StartCelebrityRecognitionResponse = capo_rekognition.types.start_celebrity_recognition_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_rekognition._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.start_celebrity_recognition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_celebrity_recognition(
