"""Generated from Smithy shape ``com.amazonaws.rekognition#ListFaces``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.list_faces_response.ListFacesResponse = (
        capo_rekognition.types.list_faces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.list_faces_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_faces(
    ...
    capo_rekognition.types.list_faces_response.ListFacesResponse, zapros.Response
]:
