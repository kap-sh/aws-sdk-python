"""Generated from Smithy shape ``com.amazonaws.rekognition#StopStreamProcessor``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.stop_stream_processor_response.StopStreamProcessorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.stop_stream_processor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_stream_processor(
