"""Generated from Smithy shape ``com.amazonaws.rekognition#CreateProject``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.create_project_response.CreateProjectResponse = (
        capo_rekognition.types.create_project_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.create_project_request.serialize_aws_json_1_1(input_)
    ).encode()
