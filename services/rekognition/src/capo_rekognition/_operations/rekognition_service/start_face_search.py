"""Generated from Smithy shape ``com.amazonaws.rekognition#StartFaceSearch``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.start_face_search_response.StartFaceSearchResponse = (
        capo_rekognition.types.start_face_search_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.start_face_search_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_start_face_search(
