"""Generated from Smithy shape ``com.amazonaws.rekognition#GetCelebrityInfo``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.get_celebrity_info_response.GetCelebrityInfoResponse = (
        capo_rekognition.types.get_celebrity_info_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.get_celebrity_info_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_celebrity_info(
