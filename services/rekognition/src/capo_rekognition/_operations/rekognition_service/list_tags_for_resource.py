"""Generated from Smithy shape ``com.amazonaws.rekognition#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_rekognition.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.ListTagsForResource"
    body: bytes | None = json.dumps(
        capo_rekognition.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
