"""Generated from Smithy shape ``com.amazonaws.rekognition#StartFaceDetection``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.start_face_detection_response.StartFaceDetectionResponse = capo_rekognition.types.start_face_detection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.start_face_detection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_face_detection(
