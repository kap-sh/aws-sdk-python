"""Generated from Smithy shape ``com.amazonaws.rekognition#CreateProjectVersion``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.create_project_version_response.CreateProjectVersionResponse = capo_rekognition.types.create_project_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.create_project_version_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_project_version(
