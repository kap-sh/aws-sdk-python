"""Generated from Smithy shape ``com.amazonaws.rekognition#UntagResource``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.UntagResource"
    body: bytes | None = json.dumps(
        capo_rekognition.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
