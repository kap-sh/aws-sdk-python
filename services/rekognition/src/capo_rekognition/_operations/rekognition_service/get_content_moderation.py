"""Generated from Smithy shape ``com.amazonaws.rekognition#GetContentModeration``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.get_content_moderation_response.GetContentModerationResponse = capo_rekognition.types.get_content_moderation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.get_content_moderation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_content_moderation(
