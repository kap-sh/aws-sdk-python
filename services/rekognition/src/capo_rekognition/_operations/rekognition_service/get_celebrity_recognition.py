...
def handle_response(
    ...
    out: capo_rekognition.types.get_celebrity_recognition_response.GetCelebrityRecognitionResponse = capo_rekognition.types.get_celebrity_recognition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.get_celebrity_recognition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
