"""Generated from Smithy shape ``com.amazonaws.rekognition#StartTextDetection``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.start_text_detection_response.StartTextDetectionResponse = capo_rekognition.types.start_text_detection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.StartTextDetection"
    body: bytes | None = json.dumps(
        capo_rekognition.types.start_text_detection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_text_detection(
