"""Generated from Smithy shape ``com.amazonaws.rekognition#StartContentModeration``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.start_content_moderation_response.StartContentModerationResponse = capo_rekognition.types.start_content_moderation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.start_content_moderation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_content_moderation(
