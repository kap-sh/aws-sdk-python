"""Generated from Smithy shape ``com.amazonaws.rekognition#GetTextDetection``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.get_text_detection_response.GetTextDetectionResponse = (
        capo_rekognition.types.get_text_detection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.GetTextDetection"
    body: bytes | None = json.dumps(
        capo_rekognition.types.get_text_detection_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_text_detection(
