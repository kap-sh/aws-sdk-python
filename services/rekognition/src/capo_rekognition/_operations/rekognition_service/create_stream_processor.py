"""Generated from Smithy shape ``com.amazonaws.rekognition#CreateStreamProcessor``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.create_stream_processor_response.CreateStreamProcessorResponse = capo_rekognition.types.create_stream_processor_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.create_stream_processor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_stream_processor(
