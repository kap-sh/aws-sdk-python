"""Generated from Smithy shape ``com.amazonaws.rekognition#DeleteStreamProcessor``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.delete_stream_processor_response.DeleteStreamProcessorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.delete_stream_processor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_stream_processor(
