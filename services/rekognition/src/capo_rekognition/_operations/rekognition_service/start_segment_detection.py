...
def handle_response(
    ...
    out: capo_rekognition.types.start_segment_detection_response.StartSegmentDetectionResponse = capo_rekognition.types.start_segment_detection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.start_segment_detection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
