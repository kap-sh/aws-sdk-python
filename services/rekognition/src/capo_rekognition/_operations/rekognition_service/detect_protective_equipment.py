"""Generated from Smithy shape ``com.amazonaws.rekognition#DetectProtectiveEquipment``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.detect_protective_equipment_response.DetectProtectiveEquipmentResponse = capo_rekognition.types.detect_protective_equipment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.DetectProtectiveEquipment"
    body: bytes | None = json.dumps(
        capo_rekognition.types.detect_protective_equipment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_detect_protective_equipment(
