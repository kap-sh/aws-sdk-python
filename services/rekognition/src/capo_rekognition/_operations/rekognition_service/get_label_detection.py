"""Generated from Smithy shape ``com.amazonaws.rekognition#GetLabelDetection``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.get_label_detection_response.GetLabelDetectionResponse = capo_rekognition.types.get_label_detection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.get_label_detection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_label_detection(
