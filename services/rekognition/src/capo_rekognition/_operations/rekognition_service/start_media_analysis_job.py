"""Generated from Smithy shape ``com.amazonaws.rekognition#StartMediaAnalysisJob``."""
...
import capo_rekognition.errors.invalid_manifest_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidManifestException":
            raise capo_rekognition.errors.invalid_manifest_exception.InvalidManifestException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_rekognition.types.start_media_analysis_job_response.StartMediaAnalysisJobResponse = capo_rekognition.types.start_media_analysis_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.StartMediaAnalysisJob"
    body: bytes | None = json.dumps(
        capo_rekognition.types.start_media_analysis_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_media_analysis_job(
