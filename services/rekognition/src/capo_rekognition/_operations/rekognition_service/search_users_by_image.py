"""Generated from Smithy shape ``com.amazonaws.rekognition#SearchUsersByImage``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.search_users_by_image_response.SearchUsersByImageResponse = capo_rekognition.types.search_users_by_image_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.SearchUsersByImage"
    body: bytes | None = json.dumps(
        capo_rekognition.types.search_users_by_image_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_search_users_by_image(
