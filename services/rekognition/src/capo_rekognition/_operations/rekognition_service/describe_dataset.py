"""Generated from Smithy shape ``com.amazonaws.rekognition#DescribeDataset``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.describe_dataset_response.DescribeDatasetResponse = (
        capo_rekognition.types.describe_dataset_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.DescribeDataset"
    body: bytes | None = json.dumps(
        capo_rekognition.types.describe_dataset_request.serialize_aws_json_1_1(input_)
    ).encode()
