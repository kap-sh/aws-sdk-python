"""Generated from Smithy shape ``com.amazonaws.rekognition#StartPersonTracking``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.start_person_tracking_response.StartPersonTrackingResponse = capo_rekognition.types.start_person_tracking_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.start_person_tracking_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_person_tracking(
