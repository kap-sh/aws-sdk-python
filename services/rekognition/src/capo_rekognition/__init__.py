...
from ._services.async_rekognition import (
    AsyncRekognitionClient as AsyncRekognitionClient,
)
from ._services.rekognition import RekognitionClient as RekognitionClient
