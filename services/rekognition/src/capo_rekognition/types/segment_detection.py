...
class SegmentDetection(TypedDict, closed=True):
    ...
    end_timestamp_millis: "capo_rekognition.types.timestamp.Timestamp"
    ...
    start_timecode_smpte: NotRequired["capo_rekognition.types.timecode.Timecode"]
    ...
    end_timecode_smpte: NotRequired["capo_rekognition.types.timecode.Timecode"]
...
def serialize_aws_json_1_1(value: SegmentDetection) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = capo_rekognition.types.segment_type.serialize_aws_json_1_1(
            value["type"]
        )
    ...
    if "technical_cue_segment" in value:
        ...
        out["TechnicalCueSegment"] = (
            capo_rekognition.types.technical_cue_segment.serialize_aws_json_1_1(
    ...
    if "shot_segment" in value:
        ...
        out["ShotSegment"] = capo_rekognition.types.shot_segment.serialize_aws_json_1_1(
            value["shot_segment"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> SegmentDetection:
    ...
    if "TechnicalCueSegment" in data:
        ...
        out["technical_cue_segment"] = (
            capo_rekognition.types.technical_cue_segment.deserialize_aws_json_1_1(
    ...
    if "ShotSegment" in data:
        ...
        out["shot_segment"] = (
            capo_rekognition.types.shot_segment.deserialize_aws_json_1_1(
                data["ShotSegment"]
            )
        )
