...
if TYPE_CHECKING:
    import capo_rekognition.types.detect_labels_max_dominant_colors


class DetectLabelsImagePropertiesSettings(TypedDict, closed=True):
    max_dominant_colors: "capo_rekognition.types.detect_labels_max_dominant_colors.DetectLabelsMaxDominantColors"
