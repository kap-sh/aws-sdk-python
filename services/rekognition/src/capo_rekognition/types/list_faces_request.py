...
class ListFacesRequest(TypedDict, closed=True):
    ...
    max_results: NotRequired["capo_rekognition.types.page_size.PageSize"]
    ...
    face_ids: NotRequired["capo_rekognition.types.face_id_list.FaceIdList"]
