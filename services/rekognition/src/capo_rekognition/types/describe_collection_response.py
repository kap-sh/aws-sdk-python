...
class DescribeCollectionResponse(TypedDict, closed=True):
    face_count: NotRequired["capo_rekognition.types.u_long.ULong"]
    ...
    collection_arn: NotRequired["capo_rekognition.types.string.String"]
    ...
    user_count: NotRequired["capo_rekognition.types.u_long.ULong"]
