...
class MediaAnalysisOperationsConfig(TypedDict, closed=True):
    detect_moderation_labels: NotRequired[
        "capo_rekognition.types.media_analysis_detect_moderation_labels_config.MediaAnalysisDetectModerationLabelsConfig"
    ]
...
def serialize_aws_json_1_1(value: MediaAnalysisOperationsConfig) -> dict:
    ...
    if "detect_moderation_labels" in value:
        ...
        out["DetectModerationLabels"] = (
            capo_rekognition.types.media_analysis_detect_moderation_labels_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> MediaAnalysisOperationsConfig:
    ...
    if "DetectModerationLabels" in data:
        ...
        out["detect_moderation_labels"] = (
            capo_rekognition.types.media_analysis_detect_moderation_labels_config.deserialize_aws_json_1_1(
