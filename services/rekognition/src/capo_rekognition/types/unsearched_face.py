...
if TYPE_CHECKING:
    ...
    import capo_rekognition.types.unsearched_face_reasons


class UnsearchedFace(TypedDict, closed=True):
    face_details: NotRequired["capo_rekognition.types.face_detail.FaceDetail"]
    reasons: NotRequired[
        "capo_rekognition.types.unsearched_face_reasons.UnsearchedFaceReasons"
    ]
...
def serialize_aws_json_1_1(value: UnsearchedFace) -> dict:
    ...
    if "face_details" in value:
        ...
        out["FaceDetails"] = capo_rekognition.types.face_detail.serialize_aws_json_1_1(
            value["face_details"]
        )
    if "reasons" in value:
        import capo_rekognition.types.unsearched_face_reasons
        ...
        out["Reasons"] = (
            capo_rekognition.types.unsearched_face_reasons.serialize_aws_json_1_1(
                value["reasons"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UnsearchedFace:
    ...
    if "Reasons" in data:
        ...
        out["reasons"] = (
            capo_rekognition.types.unsearched_face_reasons.deserialize_aws_json_1_1(
                data["Reasons"]
            )
        )
    return out
