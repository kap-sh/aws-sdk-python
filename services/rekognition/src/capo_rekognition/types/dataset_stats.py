...
class DatasetStats(TypedDict, closed=True):
    labeled_entries: NotRequired["capo_rekognition.types.u_integer.UInteger"]
    """<p> The total number of images in the dataset that have labels. </p>"""
    total_entries: NotRequired["capo_rekognition.types.u_integer.UInteger"]
    """<p> The total number of images in the dataset. </p>"""
    total_labels: NotRequired["capo_rekognition.types.u_integer.UInteger"]
    """<p> The total number of labels declared in the dataset. </p>"""
    error_entries: NotRequired["capo_rekognition.types.u_integer.UInteger"]
