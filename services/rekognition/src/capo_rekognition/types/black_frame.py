...
if TYPE_CHECKING:
    import capo_rekognition.types.max_pixel_threshold
    import capo_rekognition.types.min_coverage_percentage


class BlackFrame(TypedDict, closed=True):
    max_pixel_threshold: NotRequired[
        "capo_rekognition.types.max_pixel_threshold.MaxPixelThreshold"
    ]
    ...
    min_coverage_percentage: NotRequired[
        "capo_rekognition.types.min_coverage_percentage.MinCoveragePercentage"
    ]
