...
if TYPE_CHECKING:
    ...
    import capo_rekognition.types.reasons


class UnindexedFace(TypedDict, closed=True):
    reasons: NotRequired["capo_rekognition.types.reasons.Reasons"]
...
def serialize_aws_json_1_1(value: UnindexedFace) -> dict:
    ...
    if "reasons" in value:
        ...
        out["Reasons"] = capo_rekognition.types.reasons.serialize_aws_json_1_1(
            value["reasons"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> UnindexedFace:
    ...
    if "Reasons" in data:
        ...
        out["reasons"] = capo_rekognition.types.reasons.deserialize_aws_json_1_1(
            data["Reasons"]
        )
