...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.describe_project_versions_response.DescribeProjectVersionsResponse = aws_sdk_rekognition.types.describe_project_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.describe_project_versions_request.DescribeProjectVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.describe_project_versions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
