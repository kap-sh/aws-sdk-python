"""Generated from Smithy shape ``com.amazonaws.rekognition#GetMediaAnalysisJob``."""
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.get_media_analysis_job_response.GetMediaAnalysisJobResponse = aws_sdk_rekognition.types.get_media_analysis_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.get_media_analysis_job_request.GetMediaAnalysisJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RekognitionService.GetMediaAnalysisJob"
    import aws_sdk_rekognition.types.get_media_analysis_job_request

    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.get_media_analysis_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_media_analysis_job(
