"""Generated from Smithy shape ``com.amazonaws.rekognition#DistributeDatasetEntries``."""
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.distribute_dataset_entries_response.DistributeDatasetEntriesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.distribute_dataset_entries_request.DistributeDatasetEntriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RekognitionService.DistributeDatasetEntries"
    import aws_sdk_rekognition.types.distribute_dataset_entries_request

    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.distribute_dataset_entries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_distribute_dataset_entries(
