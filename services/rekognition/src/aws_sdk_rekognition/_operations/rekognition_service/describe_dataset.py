...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.describe_dataset_request.DescribeDatasetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.describe_dataset_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
