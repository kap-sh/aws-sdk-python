...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.describe_dataset_response.DescribeDatasetResponse = (
        aws_sdk_rekognition.types.describe_dataset_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_rekognition.types.describe_dataset_request.DescribeDatasetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.describe_dataset_request.serialize_aws_json_1_1(input)
    ).encode()
