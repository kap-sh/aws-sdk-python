...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.create_dataset_response.CreateDatasetResponse = (
        aws_sdk_rekognition.types.create_dataset_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.create_dataset_request.CreateDatasetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.create_dataset_request.serialize_aws_json_1_1(input_)
    ).encode()
