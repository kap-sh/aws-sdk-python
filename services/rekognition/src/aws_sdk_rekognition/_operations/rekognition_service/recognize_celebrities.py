...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.recognize_celebrities_response.RecognizeCelebritiesResponse = aws_sdk_rekognition.types.recognize_celebrities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.recognize_celebrities_request.RecognizeCelebritiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.recognize_celebrities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
