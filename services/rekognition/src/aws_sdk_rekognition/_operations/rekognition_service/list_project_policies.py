...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.list_project_policies_response.ListProjectPoliciesResponse = aws_sdk_rekognition.types.list_project_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.list_project_policies_request.ListProjectPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.list_project_policies_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
