...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.detect_custom_labels_request.DetectCustomLabelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.detect_custom_labels_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
