...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.start_celebrity_recognition_response.StartCelebrityRecognitionResponse = aws_sdk_rekognition.types.start_celebrity_recognition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.start_celebrity_recognition_request.StartCelebrityRecognitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.start_celebrity_recognition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
