"""Generated from Smithy shape ``com.amazonaws.rekognition#GetPersonTracking``."""
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.get_person_tracking_response.GetPersonTrackingResponse = aws_sdk_rekognition.types.get_person_tracking_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.get_person_tracking_request.GetPersonTrackingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.get_person_tracking_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_person_tracking(
