...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.update_stream_processor_response.UpdateStreamProcessorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.update_stream_processor_request.UpdateStreamProcessorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.update_stream_processor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
