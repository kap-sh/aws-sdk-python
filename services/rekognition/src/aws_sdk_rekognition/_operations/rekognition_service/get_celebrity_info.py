...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.get_celebrity_info_response.GetCelebrityInfoResponse = aws_sdk_rekognition.types.get_celebrity_info_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.get_celebrity_info_request.GetCelebrityInfoRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.get_celebrity_info_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
