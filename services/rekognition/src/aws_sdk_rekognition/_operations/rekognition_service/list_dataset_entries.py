"""Generated from Smithy shape ``com.amazonaws.rekognition#ListDatasetEntries``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPaginationTokenException":
            import aws_sdk_rekognition.errors.invalid_pagination_token_exception

            raise aws_sdk_rekognition.errors.invalid_pagination_token_exception.InvalidPaginationTokenException.from_aws_json_1_1(
                data
            )
        ...
        case "ResourceInUseException":
            import aws_sdk_rekognition.errors.resource_in_use_exception

            raise aws_sdk_rekognition.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.list_dataset_entries_response.ListDatasetEntriesResponse = aws_sdk_rekognition.types.list_dataset_entries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.list_dataset_entries_request.ListDatasetEntriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RekognitionService.ListDatasetEntries"
    import aws_sdk_rekognition.types.list_dataset_entries_request

    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.list_dataset_entries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_dataset_entries(
