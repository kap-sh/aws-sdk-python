...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.update_dataset_entries_response.UpdateDatasetEntriesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.update_dataset_entries_request.UpdateDatasetEntriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.update_dataset_entries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
