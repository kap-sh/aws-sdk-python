...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.create_face_liveness_session_response.CreateFaceLivenessSessionResponse = aws_sdk_rekognition.types.create_face_liveness_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.create_face_liveness_session_request.CreateFaceLivenessSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.create_face_liveness_session_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
