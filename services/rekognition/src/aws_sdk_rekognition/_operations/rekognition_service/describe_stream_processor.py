...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.describe_stream_processor_response.DescribeStreamProcessorResponse = aws_sdk_rekognition.types.describe_stream_processor_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.describe_stream_processor_request.DescribeStreamProcessorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.describe_stream_processor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
