...
import aws_sdk_rekognition.errors.malformed_policy_document_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MalformedPolicyDocumentException":
            raise aws_sdk_rekognition.errors.malformed_policy_document_exception.MalformedPolicyDocumentException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.put_project_policy_response.PutProjectPolicyResponse = aws_sdk_rekognition.types.put_project_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.put_project_policy_request.PutProjectPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.put_project_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
