...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.search_users_by_image_response.SearchUsersByImageResponse = aws_sdk_rekognition.types.search_users_by_image_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.search_users_by_image_request.SearchUsersByImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.search_users_by_image_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
