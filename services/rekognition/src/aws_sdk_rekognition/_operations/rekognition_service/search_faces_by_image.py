...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.search_faces_by_image_response.SearchFacesByImageResponse = aws_sdk_rekognition.types.search_faces_by_image_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.search_faces_by_image_request.SearchFacesByImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
