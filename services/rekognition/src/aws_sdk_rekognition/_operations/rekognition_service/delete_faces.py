"""Generated from Smithy shape ``com.amazonaws.rekognition#DeleteFaces``."""
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.delete_faces_response.DeleteFacesResponse = (
        aws_sdk_rekognition.types.delete_faces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.delete_faces_request.DeleteFacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.delete_faces_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_faces(
    ...
    aws_sdk_rekognition.types.delete_faces_response.DeleteFacesResponse, zapros.Response
]:
