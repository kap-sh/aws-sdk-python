"""Generated from Smithy shape ``com.amazonaws.rekognition#DeleteDataset``."""
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.delete_dataset_response.DeleteDatasetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.delete_dataset_request.DeleteDatasetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RekognitionService.DeleteDataset"
    import aws_sdk_rekognition.types.delete_dataset_request

    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.delete_dataset_request.serialize_aws_json_1_1(input_)
    ).encode()
