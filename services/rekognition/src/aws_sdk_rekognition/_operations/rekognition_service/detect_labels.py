"""Generated from Smithy shape ``com.amazonaws.rekognition#DetectLabels``."""
...
import aws_sdk_rekognition.types.labels
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.detect_labels_response.DetectLabelsResponse = (
        aws_sdk_rekognition.types.detect_labels_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.detect_labels_request.DetectLabelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.detect_labels_request.serialize_aws_json_1_1(input_)
    ).encode()
