"""Generated from Smithy shape ``com.amazonaws.rekognition#SearchUsers``."""
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.search_users_response.SearchUsersResponse = (
        aws_sdk_rekognition.types.search_users_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.search_users_request.SearchUsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RekognitionService.SearchUsers"
    import aws_sdk_rekognition.types.search_users_request

    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.search_users_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def search_users(
    ...
    aws_sdk_rekognition.types.search_users_response.SearchUsersResponse, zapros.Response
]:
