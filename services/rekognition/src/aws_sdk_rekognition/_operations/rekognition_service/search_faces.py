...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.search_faces_response.SearchFacesResponse = (
        aws_sdk_rekognition.types.search_faces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.search_faces_request.SearchFacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.search_faces_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def search_faces(
    ...
    aws_sdk_rekognition.types.search_faces_response.SearchFacesResponse, zapros.Response
]:
