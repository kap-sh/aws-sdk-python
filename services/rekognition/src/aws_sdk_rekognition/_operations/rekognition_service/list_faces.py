...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.list_faces_response.ListFacesResponse = (
        aws_sdk_rekognition.types.list_faces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.list_faces_request.ListFacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.list_faces_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_faces(
    ...
    aws_sdk_rekognition.types.list_faces_response.ListFacesResponse, zapros.Response
]:
