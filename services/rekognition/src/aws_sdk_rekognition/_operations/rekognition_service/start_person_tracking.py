...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.start_person_tracking_response.StartPersonTrackingResponse = aws_sdk_rekognition.types.start_person_tracking_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.start_person_tracking_request.StartPersonTrackingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.start_person_tracking_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
