...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.stop_stream_processor_response.StopStreamProcessorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.stop_stream_processor_request.StopStreamProcessorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.stop_stream_processor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
