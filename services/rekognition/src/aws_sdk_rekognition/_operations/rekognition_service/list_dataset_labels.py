...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.list_dataset_labels_response.ListDatasetLabelsResponse = aws_sdk_rekognition.types.list_dataset_labels_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.list_dataset_labels_request.ListDatasetLabelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.list_dataset_labels_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
