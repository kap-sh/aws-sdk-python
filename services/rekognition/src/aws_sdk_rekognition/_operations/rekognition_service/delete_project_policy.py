"""Generated from Smithy shape ``com.amazonaws.rekognition#DeleteProjectPolicy``."""
...
import aws_sdk_rekognition.errors.invalid_policy_revision_id_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPolicyRevisionIdException":
            raise aws_sdk_rekognition.errors.invalid_policy_revision_id_exception.InvalidPolicyRevisionIdException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.delete_project_policy_response.DeleteProjectPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.delete_project_policy_request.DeleteProjectPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RekognitionService.DeleteProjectPolicy"
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.delete_project_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_project_policy(
