...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "HumanLoopQuotaExceededException":
            import aws_sdk_rekognition.errors.human_loop_quota_exceeded_exception

            raise aws_sdk_rekognition.errors.human_loop_quota_exceeded_exception.HumanLoopQuotaExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.detect_moderation_labels_response.DetectModerationLabelsResponse = aws_sdk_rekognition.types.detect_moderation_labels_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.detect_moderation_labels_request.DetectModerationLabelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.detect_moderation_labels_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
