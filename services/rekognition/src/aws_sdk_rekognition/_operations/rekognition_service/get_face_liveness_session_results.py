...
import aws_sdk_rekognition.errors.session_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SessionNotFoundException":
            raise aws_sdk_rekognition.errors.session_not_found_exception.SessionNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.get_face_liveness_session_results_response.GetFaceLivenessSessionResultsResponse = aws_sdk_rekognition.types.get_face_liveness_session_results_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.get_face_liveness_session_results_request.GetFaceLivenessSessionResultsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.get_face_liveness_session_results_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
