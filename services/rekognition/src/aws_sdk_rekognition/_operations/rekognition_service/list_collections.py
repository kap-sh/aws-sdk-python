...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.list_collections_response.ListCollectionsResponse = (
        aws_sdk_rekognition.types.list_collections_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_rekognition.types.list_collections_request.ListCollectionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.list_collections_request.serialize_aws_json_1_1(input)
    ).encode()
