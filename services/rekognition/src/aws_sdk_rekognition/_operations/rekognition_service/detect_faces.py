"""Generated from Smithy shape ``com.amazonaws.rekognition#DetectFaces``."""
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.detect_faces_response.DetectFacesResponse = (
        aws_sdk_rekognition.types.detect_faces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.detect_faces_request.DetectFacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.detect_faces_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def detect_faces(
    ...
    aws_sdk_rekognition.types.detect_faces_response.DetectFacesResponse, zapros.Response
]:
