...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.index_faces_response.IndexFacesResponse = (
        aws_sdk_rekognition.types.index_faces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.index_faces_request.IndexFacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.index_faces_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def index_faces(
    ...
    aws_sdk_rekognition.types.index_faces_response.IndexFacesResponse, zapros.Response
]:
