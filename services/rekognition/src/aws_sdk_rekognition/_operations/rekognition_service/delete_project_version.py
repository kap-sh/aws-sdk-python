"""Generated from Smithy shape ``com.amazonaws.rekognition#DeleteProjectVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.delete_project_version_response.DeleteProjectVersionResponse = aws_sdk_rekognition.types.delete_project_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.delete_project_version_request.DeleteProjectVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RekognitionService.DeleteProjectVersion"
    import aws_sdk_rekognition.types.delete_project_version_request

    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.delete_project_version_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_project_version(
