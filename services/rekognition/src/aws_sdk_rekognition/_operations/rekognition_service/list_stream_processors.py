...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.list_stream_processors_response.ListStreamProcessorsResponse = aws_sdk_rekognition.types.list_stream_processors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.list_stream_processors_request.ListStreamProcessorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.list_stream_processors_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
