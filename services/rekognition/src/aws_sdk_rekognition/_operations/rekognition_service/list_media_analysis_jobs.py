...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.list_media_analysis_jobs_response.ListMediaAnalysisJobsResponse = aws_sdk_rekognition.types.list_media_analysis_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.list_media_analysis_jobs_request.ListMediaAnalysisJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.list_media_analysis_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
