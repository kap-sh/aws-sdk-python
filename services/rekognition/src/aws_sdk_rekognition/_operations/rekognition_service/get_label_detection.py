...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.get_label_detection_response.GetLabelDetectionResponse = aws_sdk_rekognition.types.get_label_detection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.get_label_detection_request.GetLabelDetectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.get_label_detection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
