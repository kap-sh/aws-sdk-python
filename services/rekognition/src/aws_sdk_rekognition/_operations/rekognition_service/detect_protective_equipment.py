...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.detect_protective_equipment_response.DetectProtectiveEquipmentResponse = aws_sdk_rekognition.types.detect_protective_equipment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.detect_protective_equipment_request.DetectProtectiveEquipmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.detect_protective_equipment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
