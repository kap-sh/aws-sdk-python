"""Generated from Smithy shape ``com.amazonaws.rekognition#StartStreamProcessor``."""
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.start_stream_processor_response.StartStreamProcessorResponse = aws_sdk_rekognition.types.start_stream_processor_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.start_stream_processor_request.StartStreamProcessorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.start_stream_processor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_stream_processor(
