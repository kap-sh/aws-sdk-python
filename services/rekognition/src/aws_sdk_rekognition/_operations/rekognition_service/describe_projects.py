...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.describe_projects_response.DescribeProjectsResponse = aws_sdk_rekognition.types.describe_projects_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.describe_projects_request.DescribeProjectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.describe_projects_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
