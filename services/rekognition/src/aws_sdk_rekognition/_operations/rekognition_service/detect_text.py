...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.detect_text_response.DetectTextResponse = (
        aws_sdk_rekognition.types.detect_text_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.detect_text_request.DetectTextRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.detect_text_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def detect_text(
    ...
    aws_sdk_rekognition.types.detect_text_response.DetectTextResponse, zapros.Response
]:
