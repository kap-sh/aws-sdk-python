...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.create_collection_request.CreateCollectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.create_collection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
