...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.delete_collection_response.DeleteCollectionResponse = aws_sdk_rekognition.types.delete_collection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.delete_collection_request.DeleteCollectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.delete_collection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
