...
def build_request(
    ...
    input: aws_sdk_rekognition.types.get_face_search_request.GetFaceSearchRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.get_face_search_request.serialize_aws_json_1_1(input)
    ).encode()
