...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.get_face_search_response.GetFaceSearchResponse = (
        aws_sdk_rekognition.types.get_face_search_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.get_face_search_request.GetFaceSearchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.get_face_search_request.serialize_aws_json_1_1(input_)
    ).encode()
