...
def build_request(
    ...
    input: aws_sdk_rekognition.types.create_project_request.CreateProjectRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.create_project_request.serialize_aws_json_1_1(input)
    ).encode()
