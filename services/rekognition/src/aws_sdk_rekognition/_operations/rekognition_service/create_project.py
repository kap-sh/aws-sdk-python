...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.create_project_response.CreateProjectResponse = (
        aws_sdk_rekognition.types.create_project_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.create_project_request.CreateProjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.create_project_request.serialize_aws_json_1_1(input_)
    ).encode()
