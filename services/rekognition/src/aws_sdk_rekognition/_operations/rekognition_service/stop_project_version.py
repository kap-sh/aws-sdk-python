"""Generated from Smithy shape ``com.amazonaws.rekognition#StopProjectVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.stop_project_version_response.StopProjectVersionResponse = aws_sdk_rekognition.types.stop_project_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.stop_project_version_request.StopProjectVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.stop_project_version_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_project_version(
