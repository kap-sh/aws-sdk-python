"""Generated from Smithy shape ``com.amazonaws.rekognition#GetCelebrityRecognition``."""
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.get_celebrity_recognition_response.GetCelebrityRecognitionResponse = aws_sdk_rekognition.types.get_celebrity_recognition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.get_celebrity_recognition_request.GetCelebrityRecognitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.get_celebrity_recognition_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_celebrity_recognition(
