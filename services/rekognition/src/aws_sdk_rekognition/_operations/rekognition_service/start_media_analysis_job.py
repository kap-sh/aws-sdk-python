...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidManifestException":
            import aws_sdk_rekognition.errors.invalid_manifest_exception

            raise aws_sdk_rekognition.errors.invalid_manifest_exception.InvalidManifestException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.start_media_analysis_job_response.StartMediaAnalysisJobResponse = aws_sdk_rekognition.types.start_media_analysis_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.start_media_analysis_job_request.StartMediaAnalysisJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.start_media_analysis_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
