"""Generated from Smithy shape ``com.amazonaws.rekognition#CompareFaces``."""
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.compare_faces_request.CompareFacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.compare_faces_request.serialize_aws_json_1_1(input_)
    ).encode()
