"""Generated from Smithy shape ``com.amazonaws.rekognition#AssociateFaces``."""
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.associate_faces_response.AssociateFacesResponse = (
        aws_sdk_rekognition.types.associate_faces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.associate_faces_request.AssociateFacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RekognitionService.AssociateFaces"
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.associate_faces_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_associate_faces(
