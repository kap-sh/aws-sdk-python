...
def build_request(
    ...
    input: aws_sdk_rekognition.types.associate_faces_request.AssociateFacesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.associate_faces_request.serialize_aws_json_1_1(input)
    ).encode()
