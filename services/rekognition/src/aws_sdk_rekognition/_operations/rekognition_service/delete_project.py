"""Generated from Smithy shape ``com.amazonaws.rekognition#DeleteProject``."""
...
def handle_response(
    ...
    out: aws_sdk_rekognition.types.delete_project_response.DeleteProjectResponse = (
        aws_sdk_rekognition.types.delete_project_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_rekognition.types.delete_project_request.DeleteProjectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "RekognitionService.DeleteProject"
    import aws_sdk_rekognition.types.delete_project_request

    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.delete_project_request.serialize_aws_json_1_1(input_)
    ).encode()
