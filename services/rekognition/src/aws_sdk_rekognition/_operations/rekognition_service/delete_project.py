...
def build_request(
    ...
    input: aws_sdk_rekognition.types.delete_project_request.DeleteProjectRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rekognition.types.delete_project_request.serialize_aws_json_1_1(input)
    ).encode()
