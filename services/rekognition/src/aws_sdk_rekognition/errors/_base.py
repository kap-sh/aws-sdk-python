...
class RekognitionError(Exception):
    """Base class for all Rekognition service errors."""


class ServiceError(RekognitionError):
...
class SerializationError(RekognitionError):
    """Raised when a value cannot be serialized."""


class DeserializationError(RekognitionError):
...
class WaiterFailedError(RekognitionError):
...
class WaiterTimeoutError(RekognitionError):
