"""Generated from Smithy shape ``com.amazonaws.rekognition#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rekognition#LimitExceededException``."""
