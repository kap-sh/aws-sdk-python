...
ProjectDescriptions: TypeAlias = list[
    "aws_sdk_rekognition.types.project_description.ProjectDescription"
]
...
def serialize_aws_json_1_1(value: ProjectDescriptions) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_rekognition.types.project_description.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ProjectDescriptions:
    ...
    for item in data:
        out.append(
            aws_sdk_rekognition.types.project_description.deserialize_aws_json_1_1(item)
        )
    return out
