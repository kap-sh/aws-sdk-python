...
class StartTextDetectionRequest(TypedDict):
...
def serialize_aws_json_1_1(value: StartTextDetectionRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            aws_sdk_rekognition.types.start_text_detection_filters.serialize_aws_json_1_1(
                value["filters"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> StartTextDetectionRequest:
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_rekognition.types.start_text_detection_filters.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
    return out
