...
DatasetLabelDescriptions: TypeAlias = list[
    "aws_sdk_rekognition.types.dataset_label_description.DatasetLabelDescription"
]
...
def serialize_aws_json_1_1(value: DatasetLabelDescriptions) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_rekognition.types.dataset_label_description.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> DatasetLabelDescriptions:
    ...
    for item in data:
        out.append(
            aws_sdk_rekognition.types.dataset_label_description.deserialize_aws_json_1_1(
                item
            )
        )
    return out
