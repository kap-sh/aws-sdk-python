...
if TYPE_CHECKING:
    import aws_sdk_rekognition.types.unsearched_face

UnsearchedFacesList: TypeAlias = list[
    "aws_sdk_rekognition.types.unsearched_face.UnsearchedFace"
]
...
def serialize_aws_json_1_1(value: UnsearchedFacesList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_rekognition.types.unsearched_face.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> UnsearchedFacesList:
    ...
    for item in data:
        out.append(
            aws_sdk_rekognition.types.unsearched_face.deserialize_aws_json_1_1(item)
        )
    return out
