...
if TYPE_CHECKING:
    ...
    import aws_sdk_rekognition.types.evaluation_result
    ...
    import aws_sdk_rekognition.types.testing_data_result
    import aws_sdk_rekognition.types.training_data_result
    import aws_sdk_rekognition.types.u_long
    import aws_sdk_rekognition.types.version_description


class ProjectVersionDescription(TypedDict):
    ...
    billable_training_time_in_seconds: NotRequired[
        "aws_sdk_rekognition.types.u_long.ULong"
    ]
    ...
    training_end_timestamp: NotRequired["aws_sdk_rekognition.types.date_time.DateTime"]
    """<p>The Unix date and time that training of the model ended.</p>"""
    output_config: NotRequired["aws_sdk_rekognition.types.output_config.OutputConfig"]
    """<p>The location where training results are saved.</p>"""
    training_data_result: NotRequired[
        "aws_sdk_rekognition.types.training_data_result.TrainingDataResult"
    ]
    """<p>Contains information about the training results.</p>"""
    testing_data_result: NotRequired[
        "aws_sdk_rekognition.types.testing_data_result.TestingDataResult"
    ]
    """<p>Contains information about the testing results.</p>"""
    evaluation_result: NotRequired[
        "aws_sdk_rekognition.types.evaluation_result.EvaluationResult"
    ]
    ...
    base_model_version: NotRequired["aws_sdk_rekognition.types.string.String"]
...
def serialize_aws_json_1_1(value: ProjectVersionDescription) -> dict:
    ...
    if "training_data_result" in value:
        ...
        out["TrainingDataResult"] = (
            aws_sdk_rekognition.types.training_data_result.serialize_aws_json_1_1(
    ...
    if "testing_data_result" in value:
        ...
        out["TestingDataResult"] = (
            aws_sdk_rekognition.types.testing_data_result.serialize_aws_json_1_1(
    ...
    if "evaluation_result" in value:
        ...
        out["EvaluationResult"] = (
            aws_sdk_rekognition.types.evaluation_result.serialize_aws_json_1_1(
    ...
    if "feature_config" in value:
        ...
        out["FeatureConfig"] = (
            aws_sdk_rekognition.types.customization_feature_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ProjectVersionDescription:
    ...
    if "TrainingDataResult" in data:
        ...
        out["training_data_result"] = (
            aws_sdk_rekognition.types.training_data_result.deserialize_aws_json_1_1(
    ...
    if "TestingDataResult" in data:
        ...
        out["testing_data_result"] = (
            aws_sdk_rekognition.types.testing_data_result.deserialize_aws_json_1_1(
    ...
    if "EvaluationResult" in data:
        ...
        out["evaluation_result"] = (
            aws_sdk_rekognition.types.evaluation_result.deserialize_aws_json_1_1(
    ...
    if "FeatureConfig" in data:
        ...
        out["feature_config"] = (
            aws_sdk_rekognition.types.customization_feature_config.deserialize_aws_json_1_1(
                data["FeatureConfig"]
            )
        )
    return out
