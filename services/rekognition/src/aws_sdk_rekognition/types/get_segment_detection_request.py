"""Generated from Smithy shape ``com.amazonaws.rekognition#GetSegmentDetectionRequest``."""
...
class GetSegmentDetectionRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetSegmentDetectionRequest) -> dict:
    out: dict = {}
