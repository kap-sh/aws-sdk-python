...
if TYPE_CHECKING:
    import aws_sdk_rekognition.types.face_record_list
    import aws_sdk_rekognition.types.orientation_correction
    import aws_sdk_rekognition.types.string
    import aws_sdk_rekognition.types.unindexed_faces


class IndexFacesResponse(TypedDict):
    face_records: NotRequired[
        "aws_sdk_rekognition.types.face_record_list.FaceRecordList"
    ]
    ...
    unindexed_faces: NotRequired[
        "aws_sdk_rekognition.types.unindexed_faces.UnindexedFaces"
    ]
...
def serialize_aws_json_1_1(value: IndexFacesResponse) -> dict:
    ...
    if "face_records" in value:
        ...
        out["FaceRecords"] = (
            aws_sdk_rekognition.types.face_record_list.serialize_aws_json_1_1(
                value["face_records"]
            )
        )
    ...
    if "unindexed_faces" in value:
        ...
        out["UnindexedFaces"] = (
            aws_sdk_rekognition.types.unindexed_faces.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> IndexFacesResponse:
    ...
    if "FaceRecords" in data:
        ...
        out["face_records"] = (
            aws_sdk_rekognition.types.face_record_list.deserialize_aws_json_1_1(
                data["FaceRecords"]
            )
        )
    ...
    if "UnindexedFaces" in data:
        ...
        out["unindexed_faces"] = (
            aws_sdk_rekognition.types.unindexed_faces.deserialize_aws_json_1_1(
                data["UnindexedFaces"]
            )
        )
    return out
