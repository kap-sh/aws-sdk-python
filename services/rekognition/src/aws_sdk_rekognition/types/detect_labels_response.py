...
class DetectLabelsResponse(TypedDict, closed=True):
    ...
    image_properties: NotRequired[
        "aws_sdk_rekognition.types.detect_labels_image_properties.DetectLabelsImageProperties"
    ]
...
def serialize_aws_json_1_1(value: DetectLabelsResponse) -> dict:
    ...
    if "labels" in value:
        ...
        out["Labels"] = aws_sdk_rekognition.types.labels.serialize_aws_json_1_1(
            value["labels"]
        )
    ...
    if "image_properties" in value:
        ...
        out["ImageProperties"] = (
            aws_sdk_rekognition.types.detect_labels_image_properties.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DetectLabelsResponse:
    ...
    if "Labels" in data:
        ...
        out["labels"] = aws_sdk_rekognition.types.labels.deserialize_aws_json_1_1(
            data["Labels"]
        )
    ...
    if "ImageProperties" in data:
        ...
        out["image_properties"] = (
            aws_sdk_rekognition.types.detect_labels_image_properties.deserialize_aws_json_1_1(
