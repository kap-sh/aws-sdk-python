...
def serialize_aws_json_1_1(value: GetCelebrityRecognitionRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            aws_sdk_rekognition.types.celebrity_recognition_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetCelebrityRecognitionRequest:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_rekognition.types.celebrity_recognition_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
    return out
