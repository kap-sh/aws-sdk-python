...
if TYPE_CHECKING:
    import aws_sdk_rekognition.types.associated_face

AssociatedFacesList: TypeAlias = list[
    "aws_sdk_rekognition.types.associated_face.AssociatedFace"
]
...
def serialize_aws_json_1_1(value: AssociatedFacesList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_rekognition.types.associated_face.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AssociatedFacesList:
    ...
    for item in data:
        out.append(
            aws_sdk_rekognition.types.associated_face.deserialize_aws_json_1_1(item)
        )
    return out
