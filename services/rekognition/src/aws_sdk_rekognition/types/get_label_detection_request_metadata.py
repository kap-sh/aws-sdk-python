...
class GetLabelDetectionRequestMetadata(TypedDict):
    sort_by: NotRequired[
...
def serialize_aws_json_1_1(value: GetLabelDetectionRequestMetadata) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            aws_sdk_rekognition.types.label_detection_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
    if "aggregate_by" in value:
        ...
        out["AggregateBy"] = (
            aws_sdk_rekognition.types.label_detection_aggregate_by.serialize_aws_json_1_1(
                value["aggregate_by"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetLabelDetectionRequestMetadata:
    ...
    if "SortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_rekognition.types.label_detection_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
    if "AggregateBy" in data:
        ...
        out["aggregate_by"] = (
            aws_sdk_rekognition.types.label_detection_aggregate_by.deserialize_aws_json_1_1(
                data["AggregateBy"]
            )
        )
    return out
