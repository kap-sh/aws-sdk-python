...
class CreateProjectVersionRequest(TypedDict):
    ...
    training_data: NotRequired["aws_sdk_rekognition.types.training_data.TrainingData"]
    ...
    testing_data: NotRequired["aws_sdk_rekognition.types.testing_data.TestingData"]
...
def serialize_aws_json_1_1(value: CreateProjectVersionRequest) -> dict:
    ...
    if "training_data" in value:
        ...
        out["TrainingData"] = (
            aws_sdk_rekognition.types.training_data.serialize_aws_json_1_1(
                value["training_data"]
            )
        )
    if "testing_data" in value:
        ...
        out["TestingData"] = (
            aws_sdk_rekognition.types.testing_data.serialize_aws_json_1_1(
                value["testing_data"]
            )
        )
    if "tags" in value:
...
def deserialize_aws_json_1_1(data: dict) -> CreateProjectVersionRequest:
    ...
    if "TestingData" in data:
        ...
        out["testing_data"] = (
            aws_sdk_rekognition.types.testing_data.deserialize_aws_json_1_1(
                data["TestingData"]
            )
        )
    if "Tags" in data:
