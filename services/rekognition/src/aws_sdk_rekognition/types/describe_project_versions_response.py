...
if TYPE_CHECKING:
    ...
    import aws_sdk_rekognition.types.project_version_descriptions


class DescribeProjectVersionsResponse(TypedDict):
    project_version_descriptions: NotRequired[
        "aws_sdk_rekognition.types.project_version_descriptions.ProjectVersionDescriptions"
    ]
...
def serialize_aws_json_1_1(value: DescribeProjectVersionsResponse) -> dict:
    ...
    if "project_version_descriptions" in value:
        ...
        out["ProjectVersionDescriptions"] = (
            aws_sdk_rekognition.types.project_version_descriptions.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeProjectVersionsResponse:
    ...
    if "ProjectVersionDescriptions" in data:
        ...
        out["project_version_descriptions"] = (
            aws_sdk_rekognition.types.project_version_descriptions.deserialize_aws_json_1_1(
