"""Generated from Smithy shape ``com.amazonaws.rekognition#StartFaceSearchResponse``."""
...
class StartFaceSearchResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StartFaceSearchResponse) -> dict:
    out: dict = {}
    if "job_id" in value:
