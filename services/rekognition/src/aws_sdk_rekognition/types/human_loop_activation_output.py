"""Generated from Smithy shape ``com.amazonaws.rekognition#HumanLoopActivationOutput``."""
...
if TYPE_CHECKING:
    import aws_sdk_rekognition.types.human_loop_activation_reasons
    import aws_sdk_rekognition.types.human_loop_arn
    import aws_sdk_rekognition.types.synthesized_json_human_loop_activation_conditions_evaluation_results


class HumanLoopActivationOutput(TypedDict, closed=True):
    human_loop_arn: NotRequired["aws_sdk_rekognition.types.human_loop_arn.HumanLoopArn"]
    """<p>The Amazon Resource Name (ARN) of the HumanLoop created.</p>"""
    human_loop_activation_reasons: NotRequired[
        "aws_sdk_rekognition.types.human_loop_activation_reasons.HumanLoopActivationReasons"
    ]
    """<p>Shows if and why human review was needed.</p>"""
    human_loop_activation_conditions_evaluation_results: NotRequired[
        "aws_sdk_rekognition.types.synthesized_json_human_loop_activation_conditions_evaluation_results.SynthesizedJsonHumanLoopActivationConditionsEvaluationResults"
    ]
...
def serialize_aws_json_1_1(value: HumanLoopActivationOutput) -> dict:
    ...
    if "human_loop_activation_reasons" in value:
        ...
        out["HumanLoopActivationReasons"] = (
            aws_sdk_rekognition.types.human_loop_activation_reasons.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> HumanLoopActivationOutput:
    ...
    if "HumanLoopActivationReasons" in data:
        ...
        out["human_loop_activation_reasons"] = (
            aws_sdk_rekognition.types.human_loop_activation_reasons.deserialize_aws_json_1_1(
