"""Generated from Smithy shape ``com.amazonaws.rekognition#Mustache``."""
...
class Mustache(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: Mustache) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> Mustache:
    out: Mustache = {}  # type: ignore[typeddict-item]
    if "Value" in data:
