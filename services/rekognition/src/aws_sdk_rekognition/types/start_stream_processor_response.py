...
if TYPE_CHECKING:
    import aws_sdk_rekognition.types.start_stream_processor_session_id


class StartStreamProcessorResponse(TypedDict):
    session_id: NotRequired[
        "aws_sdk_rekognition.types.start_stream_processor_session_id.StartStreamProcessorSessionId"
    ]
