...
if TYPE_CHECKING:
    import aws_sdk_rekognition.types.tag_key
    import aws_sdk_rekognition.types.tag_value

TagMap: TypeAlias = dict[
    "aws_sdk_rekognition.types.tag_key.TagKey",
    "aws_sdk_rekognition.types.tag_value.TagValue",
]
