...
class DetectTextRequest(TypedDict):
...
def serialize_aws_json_1_1(value: DetectTextRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            aws_sdk_rekognition.types.detect_text_filters.serialize_aws_json_1_1(
                value["filters"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DetectTextRequest:
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_rekognition.types.detect_text_filters.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
    return out
