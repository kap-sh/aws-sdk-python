...
```
pip install aws-sdk-workspaces-instances
```

## Usage

```python
from aws_sdk_workspaces_instances import AsyncWorkspacesInstancesClient
...
```python
from aws_sdk_workspaces_instances import AsyncWorkspacesInstancesClient
from aws_sdk_workspaces_instances.error import AccessDeniedException
