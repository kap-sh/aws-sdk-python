...
from aws_sdk_workspaces_instances._auth._signers import SigV4Signer
from aws_sdk_workspaces_instances._auth._sigv4 import presign_sigv4
...
from aws_sdk_workspaces_instances._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
from aws_sdk_workspaces_instances.errors import ServiceError, WaiterFailedError, WaiterTimeoutError
import warnings
from aws_sdk_workspaces_instances._auth._identity import Credentials
from aws_sdk_workspaces_instances._auth._providers import CredentialsProvider, StaticAwsCredentialsProvider
if TYPE_CHECKING:
...
class WorkspacesInstancesClientConfig(TypedDict, total=False):
...
class WorkspacesInstancesClient:
    ...
    def __init__(self, http_handler: BaseHandler | None = None, operation_interceptors: Iterable[Interceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, use_fips: bool | None = None, endpoint: str | None = None, region: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = WorkspacesInstancesClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "use_fips": use_fips, "endpoint": endpoint, "region": region, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[WorkspacesInstancesClientConfig] = None) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
    ...
    def associate_volume(self, workspace_instance_id: "aws_sdk_workspaces_instances.types.workspace_instance_id.WorkspaceInstanceId", volume_id: "aws_sdk_workspaces_instances.types.volume_id.VolumeId", device: "aws_sdk_workspaces_instances.types.device_name.DeviceName", *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None) -> "aws_sdk_workspaces_instances.types.associate_volume_response.AssociateVolumeResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces_instances.types.associate_volume_request.AssociateVolumeRequest]') -> OperationResponse["aws_sdk_workspaces_instances.types.associate_volume_response.AssociateVolumeResponse"]:
            import aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.associate_volume
            output, http_response = aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.associate_volume.associate_volume(req.options, req.input)
    ...
    def create_volume(self, availability_zone: "aws_sdk_workspaces_instances.types.string64.String64", *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None, client_token: Optional["aws_sdk_workspaces_instances.types.client_token.ClientToken"] = None, encrypted: Optional[bool] = None, iops: Optional["aws_sdk_workspaces_instances.types.non_negative_integer.NonNegativeInteger"] = None, kms_key_id: Optional["aws_sdk_workspaces_instances.types.kms_key_id.KmsKeyId"] = None, size_in_gb: Optional["aws_sdk_workspaces_instances.types.non_negative_integer.NonNegativeInteger"] = None, snapshot_id: Optional["aws_sdk_workspaces_instances.types.snapshot_id.SnapshotId"] = None, tag_specifications: Optional["aws_sdk_workspaces_instances.types.tag_specifications.TagSpecifications"] = None, throughput: Optional["aws_sdk_workspaces_instances.types.non_negative_integer.NonNegativeInteger"] = None, volume_type: Optional["aws_sdk_workspaces_instances.types.volume_type_enum.VolumeTypeEnum"] = None) -> "aws_sdk_workspaces_instances.types.create_volume_response.CreateVolumeResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces_instances.types.create_volume_request.CreateVolumeRequest]') -> OperationResponse["aws_sdk_workspaces_instances.types.create_volume_response.CreateVolumeResponse"]:
            import aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.create_volume
            output, http_response = aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.create_volume.create_volume(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def create_workspace_instance(self, managed_instance: "aws_sdk_workspaces_instances.types.managed_instance_request.ManagedInstanceRequest", *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None, client_token: Optional["aws_sdk_workspaces_instances.types.client_token.ClientToken"] = None, tags: Optional["aws_sdk_workspaces_instances.types.tag_list.TagList"] = None, billing_configuration: Optional["aws_sdk_workspaces_instances.types.billing_configuration.BillingConfiguration"] = None) -> "aws_sdk_workspaces_instances.types.create_workspace_instance_response.CreateWorkspaceInstanceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces_instances.types.create_workspace_instance_request.CreateWorkspaceInstanceRequest]') -> OperationResponse["aws_sdk_workspaces_instances.types.create_workspace_instance_response.CreateWorkspaceInstanceResponse"]:
            import aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.create_workspace_instance
            output, http_response = aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.create_workspace_instance.create_workspace_instance(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_volume(self, volume_id: "aws_sdk_workspaces_instances.types.volume_id.VolumeId", *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None) -> "aws_sdk_workspaces_instances.types.delete_volume_response.DeleteVolumeResponse":
        """<p>Deletes a specified volume.</p>

        Args:
            volume_id: <p>Identifier of the volume to delete.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces_instances.types.delete_volume_request.DeleteVolumeRequest]') -> OperationResponse["aws_sdk_workspaces_instances.types.delete_volume_response.DeleteVolumeResponse"]:
            import aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.delete_volume
            output, http_response = aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.delete_volume.delete_volume(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_workspace_instance(self, workspace_instance_id: "aws_sdk_workspaces_instances.types.workspace_instance_id.WorkspaceInstanceId", *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None) -> "aws_sdk_workspaces_instances.types.delete_workspace_instance_response.DeleteWorkspaceInstanceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces_instances.types.delete_workspace_instance_request.DeleteWorkspaceInstanceRequest]') -> OperationResponse["aws_sdk_workspaces_instances.types.delete_workspace_instance_response.DeleteWorkspaceInstanceResponse"]:
            import aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.delete_workspace_instance
            output, http_response = aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.delete_workspace_instance.delete_workspace_instance(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def disassociate_volume(self, workspace_instance_id: "aws_sdk_workspaces_instances.types.workspace_instance_id.WorkspaceInstanceId", volume_id: "aws_sdk_workspaces_instances.types.volume_id.VolumeId", *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None, device: Optional["aws_sdk_workspaces_instances.types.device_name.DeviceName"] = None, disassociate_mode: Optional["aws_sdk_workspaces_instances.types.disassociate_mode_enum.DisassociateModeEnum"] = None) -> "aws_sdk_workspaces_instances.types.disassociate_volume_response.DisassociateVolumeResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces_instances.types.disassociate_volume_request.DisassociateVolumeRequest]') -> OperationResponse["aws_sdk_workspaces_instances.types.disassociate_volume_response.DisassociateVolumeResponse"]:
            import aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.disassociate_volume
            output, http_response = aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.disassociate_volume.disassociate_volume(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_workspace_instance(self, workspace_instance_id: "aws_sdk_workspaces_instances.types.workspace_instance_id.WorkspaceInstanceId", *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None) -> "aws_sdk_workspaces_instances.types.get_workspace_instance_response.GetWorkspaceInstanceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces_instances.types.get_workspace_instance_request.GetWorkspaceInstanceRequest]') -> OperationResponse["aws_sdk_workspaces_instances.types.get_workspace_instance_response.GetWorkspaceInstanceResponse"]:
            import aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.get_workspace_instance
            output, http_response = aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.get_workspace_instance.get_workspace_instance(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def list_instance_types(self, *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None, max_results: Optional["aws_sdk_workspaces_instances.types.list_instance_types_max_results.ListInstanceTypesMaxResults"] = None, next_token: Optional["aws_sdk_workspaces_instances.types.next_token.NextToken"] = None, instance_configuration_filter: Optional["aws_sdk_workspaces_instances.types.instance_configuration_filter.InstanceConfigurationFilter"] = None) -> "aws_sdk_workspaces_instances.types.list_instance_types_response.ListInstanceTypesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces_instances.types.list_instance_types_request.ListInstanceTypesRequest]') -> OperationResponse["aws_sdk_workspaces_instances.types.list_instance_types_response.ListInstanceTypesResponse"]:
            import aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.list_instance_types
            output, http_response = aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.list_instance_types.list_instance_types(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_instance_types(self, *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None, max_results: Optional["aws_sdk_workspaces_instances.types.list_instance_types_max_results.ListInstanceTypesMaxResults"] = None, next_token: Optional["aws_sdk_workspaces_instances.types.next_token.NextToken"] = None, instance_configuration_filter: Optional["aws_sdk_workspaces_instances.types.instance_configuration_filter.InstanceConfigurationFilter"] = None) -> "Iterator[aws_sdk_workspaces_instances.types.instance_type_info.InstanceTypeInfo]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def list_regions(self, *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None, max_results: Optional["aws_sdk_workspaces_instances.types.max_results.MaxResults"] = None, next_token: Optional["aws_sdk_workspaces_instances.types.next_token.NextToken"] = None) -> "aws_sdk_workspaces_instances.types.list_regions_response.ListRegionsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces_instances.types.list_regions_request.ListRegionsRequest]') -> OperationResponse["aws_sdk_workspaces_instances.types.list_regions_response.ListRegionsResponse"]:
            import aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.list_regions
            output, http_response = aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.list_regions.list_regions(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_regions(self, *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None, max_results: Optional["aws_sdk_workspaces_instances.types.max_results.MaxResults"] = None, next_token: Optional["aws_sdk_workspaces_instances.types.next_token.NextToken"] = None) -> "Iterator[aws_sdk_workspaces_instances.types.region.Region]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def list_tags_for_resource(self, workspace_instance_id: "aws_sdk_workspaces_instances.types.workspace_instance_id.WorkspaceInstanceId", *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None) -> "aws_sdk_workspaces_instances.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        """<p>Retrieves tags for a WorkSpace Instance.</p>

        Args:
            workspace_instance_id: <p>Unique identifier of the WorkSpace Instance.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces_instances.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> OperationResponse["aws_sdk_workspaces_instances.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.list_tags_for_resource
            output, http_response = aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def list_workspace_instances(self, *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None, provision_states: Optional["aws_sdk_workspaces_instances.types.provision_states.ProvisionStates"] = None, max_results: Optional["aws_sdk_workspaces_instances.types.max_results.MaxResults"] = None, next_token: Optional["aws_sdk_workspaces_instances.types.next_token.NextToken"] = None) -> "aws_sdk_workspaces_instances.types.list_workspace_instances_response.ListWorkspaceInstancesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces_instances.types.list_workspace_instances_request.ListWorkspaceInstancesRequest]') -> OperationResponse["aws_sdk_workspaces_instances.types.list_workspace_instances_response.ListWorkspaceInstancesResponse"]:
            import aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.list_workspace_instances
            output, http_response = aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.list_workspace_instances.list_workspace_instances(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_workspace_instances(self, *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None, provision_states: Optional["aws_sdk_workspaces_instances.types.provision_states.ProvisionStates"] = None, max_results: Optional["aws_sdk_workspaces_instances.types.max_results.MaxResults"] = None, next_token: Optional["aws_sdk_workspaces_instances.types.next_token.NextToken"] = None) -> "Iterator[aws_sdk_workspaces_instances.types.workspace_instance.WorkspaceInstance]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def tag_resource(self, workspace_instance_id: "aws_sdk_workspaces_instances.types.workspace_instance_id.WorkspaceInstanceId", tags: "aws_sdk_workspaces_instances.types.tag_list.TagList", *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None) -> "aws_sdk_workspaces_instances.types.tag_resource_response.TagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces_instances.types.tag_resource_request.TagResourceRequest]') -> OperationResponse["aws_sdk_workspaces_instances.types.tag_resource_response.TagResourceResponse"]:
            import aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.tag_resource
            output, http_response = aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, workspace_instance_id: "aws_sdk_workspaces_instances.types.workspace_instance_id.WorkspaceInstanceId", tag_keys: "aws_sdk_workspaces_instances.types.tag_key_list.TagKeyList", *, config_overrides: Optional[WorkspacesInstancesClientConfig] = None) -> "aws_sdk_workspaces_instances.types.untag_resource_response.UntagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_workspaces_instances.types.untag_resource_request.UntagResourceRequest]') -> OperationResponse["aws_sdk_workspaces_instances.types.untag_resource_response.UntagResourceResponse"]:
            import aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.untag_resource
            output, http_response = aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
