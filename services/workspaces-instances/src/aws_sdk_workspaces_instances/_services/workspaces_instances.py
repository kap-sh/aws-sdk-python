...
from aws_sdk_workspaces_instances._services._aws_config import aws_config
...
class WorkspacesInstancesClient:
    ...
    def associate_volume(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_instances.types.associate_volume_request.AssociateVolumeRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_instances.types.associate_volume_response.AssociateVolumeResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.associate_volume.associate_volume(
    ...
    def create_volume(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_instances.types.create_volume_request.CreateVolumeRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_instances.types.create_volume_response.CreateVolumeResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.create_volume.create_volume(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_workspace_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_instances.types.create_workspace_instance_request.CreateWorkspaceInstanceRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_instances.types.create_workspace_instance_response.CreateWorkspaceInstanceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.create_workspace_instance.create_workspace_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_volume(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_instances.types.delete_volume_request.DeleteVolumeRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_instances.types.delete_volume_response.DeleteVolumeResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.delete_volume.delete_volume(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_workspace_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_instances.types.delete_workspace_instance_request.DeleteWorkspaceInstanceRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_instances.types.delete_workspace_instance_response.DeleteWorkspaceInstanceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.delete_workspace_instance.delete_workspace_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_volume(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_instances.types.disassociate_volume_request.DisassociateVolumeRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_instances.types.disassociate_volume_response.DisassociateVolumeResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.disassociate_volume.disassociate_volume(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_workspace_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_instances.types.get_workspace_instance_request.GetWorkspaceInstanceRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_instances.types.get_workspace_instance_response.GetWorkspaceInstanceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.get_workspace_instance.get_workspace_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_instance_types(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_instances.types.list_instance_types_request.ListInstanceTypesRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_instances.types.list_instance_types_response.ListInstanceTypesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.list_instance_types.list_instance_types(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_workspaces_instances.types.instance_type_info.InstanceTypeInfo]":
        _token = next_token
        while True:
    ...
    def list_regions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_instances.types.list_regions_request.ListRegionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_instances.types.list_regions_response.ListRegionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.list_regions.list_regions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_workspaces_instances.types.region.Region]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_instances.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_instances.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_workspace_instances(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_instances.types.list_workspace_instances_request.ListWorkspaceInstancesRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_instances.types.list_workspace_instances_response.ListWorkspaceInstancesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.list_workspace_instances.list_workspace_instances(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_workspaces_instances.types.workspace_instance.WorkspaceInstance]":
        _token = next_token
        while True:
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_instances.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_instances.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_workspaces_instances.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_workspaces_instances.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_workspaces_instances._operations.eucmi_frontend_api_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
