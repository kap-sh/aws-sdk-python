...
from ._services.async_workspaces_instances import (
    AsyncWorkspacesInstancesClient as AsyncWorkspacesInstancesClient,
)
from ._services.workspaces_instances import (
    WorkspacesInstancesClient as WorkspacesInstancesClient,
)
