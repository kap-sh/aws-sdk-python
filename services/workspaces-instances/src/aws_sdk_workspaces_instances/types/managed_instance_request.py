...
class ManagedInstanceRequest(TypedDict):
    block_device_mappings: NotRequired[
        "aws_sdk_workspaces_instances.types.block_device_mappings.BlockDeviceMappings"
    ]
    """<p>Configures block device mappings for storage.</p>"""
    capacity_reservation_specification: NotRequired[
        "aws_sdk_workspaces_instances.types.capacity_reservation_specification.CapacityReservationSpecification"
    ]
    """<p>Specifies capacity reservation preferences.</p>"""
    cpu_options: NotRequired[
        "aws_sdk_workspaces_instances.types.cpu_options_request.CpuOptionsRequest"
    ]
    """<p>Configures CPU-specific settings.</p>"""
    credit_specification: NotRequired[
        "aws_sdk_workspaces_instances.types.credit_specification_request.CreditSpecificationRequest"
    ]
    ...
    enclave_options: NotRequired[
        "aws_sdk_workspaces_instances.types.enclave_options_request.EnclaveOptionsRequest"
    ]
    """<p>Configures AWS Nitro Enclave settings.</p>"""
    hibernation_options: NotRequired[
        "aws_sdk_workspaces_instances.types.hibernation_options_request.HibernationOptionsRequest"
    ]
    """<p>Configures instance hibernation capabilities.</p>"""
    iam_instance_profile: NotRequired[
        "aws_sdk_workspaces_instances.types.iam_instance_profile_specification.IamInstanceProfileSpecification"
    ]
    ...
    instance_market_options: NotRequired[
        "aws_sdk_workspaces_instances.types.instance_market_options_request.InstanceMarketOptionsRequest"
    ]
    ...
    license_specifications: NotRequired[
        "aws_sdk_workspaces_instances.types.license_specifications.LicenseSpecifications"
    ]
    """<p>Configures license-related settings.</p>"""
    maintenance_options: NotRequired[
        "aws_sdk_workspaces_instances.types.instance_maintenance_options_request.InstanceMaintenanceOptionsRequest"
    ]
    """<p>Defines automatic maintenance settings.</p>"""
    metadata_options: NotRequired[
        "aws_sdk_workspaces_instances.types.instance_metadata_options_request.InstanceMetadataOptionsRequest"
    ]
    """<p>Configures instance metadata service settings.</p>"""
    monitoring: NotRequired[
        "aws_sdk_workspaces_instances.types.run_instances_monitoring_enabled.RunInstancesMonitoringEnabled"
    ]
    """<p>Enables or disables detailed instance monitoring.</p>"""
    network_interfaces: NotRequired[
        "aws_sdk_workspaces_instances.types.network_interfaces.NetworkInterfaces"
    ]
    """<p>Configures network interface settings.</p>"""
    network_performance_options: NotRequired[
        "aws_sdk_workspaces_instances.types.instance_network_performance_options_request.InstanceNetworkPerformanceOptionsRequest"
    ]
    ...
    private_dns_name_options: NotRequired[
        "aws_sdk_workspaces_instances.types.private_dns_name_options_request.PrivateDnsNameOptionsRequest"
    ]
    ...
    security_groups: NotRequired[
        "aws_sdk_workspaces_instances.types.security_group_names.SecurityGroupNames"
    ]
...
def serialize_aws_json_1_0(value: ManagedInstanceRequest) -> dict:
    ...
    if "block_device_mappings" in value:
        ...
        out["BlockDeviceMappings"] = (
            aws_sdk_workspaces_instances.types.block_device_mappings.serialize_aws_json_1_0(
    ...
    if "capacity_reservation_specification" in value:
        ...
        out["CapacityReservationSpecification"] = (
            aws_sdk_workspaces_instances.types.capacity_reservation_specification.serialize_aws_json_1_0(
    ...
    if "cpu_options" in value:
        ...
        out["CpuOptions"] = (
            aws_sdk_workspaces_instances.types.cpu_options_request.serialize_aws_json_1_0(
                value["cpu_options"]
            )
        )
    if "credit_specification" in value:
        ...
        out["CreditSpecification"] = (
            aws_sdk_workspaces_instances.types.credit_specification_request.serialize_aws_json_1_0(
    ...
    if "enclave_options" in value:
        ...
        out["EnclaveOptions"] = (
            aws_sdk_workspaces_instances.types.enclave_options_request.serialize_aws_json_1_0(
    ...
    if "iam_instance_profile" in value:
        ...
        out["IamInstanceProfile"] = (
            aws_sdk_workspaces_instances.types.iam_instance_profile_specification.serialize_aws_json_1_0(
    ...
    if "instance_market_options" in value:
        ...
        out["InstanceMarketOptions"] = (
            aws_sdk_workspaces_instances.types.instance_market_options_request.serialize_aws_json_1_0(
    ...
    if "license_specifications" in value:
        ...
        out["LicenseSpecifications"] = (
            aws_sdk_workspaces_instances.types.license_specifications.serialize_aws_json_1_0(
    ...
    if "maintenance_options" in value:
        ...
        out["MaintenanceOptions"] = (
            aws_sdk_workspaces_instances.types.instance_maintenance_options_request.serialize_aws_json_1_0(
    ...
    if "metadata_options" in value:
        ...
        out["MetadataOptions"] = (
            aws_sdk_workspaces_instances.types.instance_metadata_options_request.serialize_aws_json_1_0(
    ...
    if "monitoring" in value:
        ...
        out["Monitoring"] = (
            aws_sdk_workspaces_instances.types.run_instances_monitoring_enabled.serialize_aws_json_1_0(
                value["monitoring"]
            )
        )
    if "network_interfaces" in value:
        ...
        out["NetworkInterfaces"] = (
            aws_sdk_workspaces_instances.types.network_interfaces.serialize_aws_json_1_0(
    ...
    if "network_performance_options" in value:
        ...
        out["NetworkPerformanceOptions"] = (
            aws_sdk_workspaces_instances.types.instance_network_performance_options_request.serialize_aws_json_1_0(
    ...
    if "placement" in value:
        ...
        out["Placement"] = (
            aws_sdk_workspaces_instances.types.placement.serialize_aws_json_1_0(
                value["placement"]
            )
        )
    if "private_dns_name_options" in value:
        ...
        out["PrivateDnsNameOptions"] = (
            aws_sdk_workspaces_instances.types.private_dns_name_options_request.serialize_aws_json_1_0(
    ...
    if "security_groups" in value:
        ...
        out["SecurityGroups"] = (
            aws_sdk_workspaces_instances.types.security_group_names.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ManagedInstanceRequest:
    ...
    if "BlockDeviceMappings" in data:
        ...
        out["block_device_mappings"] = (
            aws_sdk_workspaces_instances.types.block_device_mappings.deserialize_aws_json_1_0(
    ...
    if "CapacityReservationSpecification" in data:
        ...
        out["capacity_reservation_specification"] = (
            aws_sdk_workspaces_instances.types.capacity_reservation_specification.deserialize_aws_json_1_0(
    ...
    if "CpuOptions" in data:
        ...
        out["cpu_options"] = (
            aws_sdk_workspaces_instances.types.cpu_options_request.deserialize_aws_json_1_0(
                data["CpuOptions"]
            )
        )
    if "CreditSpecification" in data:
        ...
        out["credit_specification"] = (
            aws_sdk_workspaces_instances.types.credit_specification_request.deserialize_aws_json_1_0(
    ...
    if "EnclaveOptions" in data:
        ...
        out["enclave_options"] = (
            aws_sdk_workspaces_instances.types.enclave_options_request.deserialize_aws_json_1_0(
                data["EnclaveOptions"]
            )
        )
    if "HibernationOptions" in data:
        ...
        out["hibernation_options"] = (
            aws_sdk_workspaces_instances.types.hibernation_options_request.deserialize_aws_json_1_0(
    ...
    if "IamInstanceProfile" in data:
        ...
        out["iam_instance_profile"] = (
            aws_sdk_workspaces_instances.types.iam_instance_profile_specification.deserialize_aws_json_1_0(
    ...
    if "InstanceMarketOptions" in data:
        ...
        out["instance_market_options"] = (
            aws_sdk_workspaces_instances.types.instance_market_options_request.deserialize_aws_json_1_0(
    ...
    if "LicenseSpecifications" in data:
        ...
        out["license_specifications"] = (
            aws_sdk_workspaces_instances.types.license_specifications.deserialize_aws_json_1_0(
    ...
    if "MaintenanceOptions" in data:
        ...
        out["maintenance_options"] = (
            aws_sdk_workspaces_instances.types.instance_maintenance_options_request.deserialize_aws_json_1_0(
    ...
    if "MetadataOptions" in data:
        ...
        out["metadata_options"] = (
            aws_sdk_workspaces_instances.types.instance_metadata_options_request.deserialize_aws_json_1_0(
    ...
    if "Monitoring" in data:
        ...
        out["monitoring"] = (
            aws_sdk_workspaces_instances.types.run_instances_monitoring_enabled.deserialize_aws_json_1_0(
                data["Monitoring"]
            )
        )
    if "NetworkInterfaces" in data:
        ...
        out["network_interfaces"] = (
            aws_sdk_workspaces_instances.types.network_interfaces.deserialize_aws_json_1_0(
    ...
    if "NetworkPerformanceOptions" in data:
        ...
        out["network_performance_options"] = (
            aws_sdk_workspaces_instances.types.instance_network_performance_options_request.deserialize_aws_json_1_0(
    ...
    if "Placement" in data:
        ...
        out["placement"] = (
            aws_sdk_workspaces_instances.types.placement.deserialize_aws_json_1_0(
                data["Placement"]
            )
        )
    if "PrivateDnsNameOptions" in data:
        ...
        out["private_dns_name_options"] = (
            aws_sdk_workspaces_instances.types.private_dns_name_options_request.deserialize_aws_json_1_0(
    ...
    if "SecurityGroups" in data:
        ...
        out["security_groups"] = (
            aws_sdk_workspaces_instances.types.security_group_names.deserialize_aws_json_1_0(
                data["SecurityGroups"]
            )
        )
    if "SubnetId" in data:
