...
class CreditSpecificationRequest(TypedDict, closed=True):
    cpu_credits: NotRequired[
        "aws_sdk_workspaces_instances.types.cpu_credits_enum.CpuCreditsEnum"
    ]
...
def serialize_aws_json_1_0(value: CreditSpecificationRequest) -> dict:
    ...
    if "cpu_credits" in value:
        ...
        out["CpuCredits"] = (
            aws_sdk_workspaces_instances.types.cpu_credits_enum.serialize_aws_json_1_0(
                value["cpu_credits"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> CreditSpecificationRequest:
    ...
    if "CpuCredits" in data:
        ...
        out["cpu_credits"] = (
            aws_sdk_workspaces_instances.types.cpu_credits_enum.deserialize_aws_json_1_0(
                data["CpuCredits"]
            )
        )
    return out
