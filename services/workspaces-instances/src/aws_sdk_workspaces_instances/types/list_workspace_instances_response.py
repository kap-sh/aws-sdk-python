...
class ListWorkspaceInstancesResponse(TypedDict):
    workspace_instances: "aws_sdk_workspaces_instances.types.workspace_instances.WorkspaceInstances"
...
def serialize_aws_json_1_0(value: ListWorkspaceInstancesResponse) -> dict:
    out: dict = {}
    import aws_sdk_workspaces_instances.types.workspace_instances
    out["WorkspaceInstances"] = aws_sdk_workspaces_instances.types.workspace_instances.serialize_aws_json_1_0(value["workspace_instances"])
...
def deserialize_aws_json_1_0(data: dict) -> ListWorkspaceInstancesResponse:
    ...
    if "WorkspaceInstances" in data:
        import aws_sdk_workspaces_instances.types.workspace_instances
        out["workspace_instances"] = aws_sdk_workspaces_instances.types.workspace_instances.deserialize_aws_json_1_0(data["WorkspaceInstances"])
    else:
        raise DeserializationError("ListWorkspaceInstancesResponse.workspace_instances required")
