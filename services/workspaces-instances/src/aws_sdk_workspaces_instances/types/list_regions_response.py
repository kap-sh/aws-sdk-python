...
def serialize_aws_json_1_0(value: ListRegionsResponse) -> dict:
    out: dict = {}
    import aws_sdk_workspaces_instances.types.region_list
    out["Regions"] = aws_sdk_workspaces_instances.types.region_list.serialize_aws_json_1_0(value["regions"])
...
def deserialize_aws_json_1_0(data: dict) -> ListRegionsResponse:
    ...
    if "Regions" in data:
        import aws_sdk_workspaces_instances.types.region_list
        out["regions"] = aws_sdk_workspaces_instances.types.region_list.deserialize_aws_json_1_0(data["Regions"])
    else:
