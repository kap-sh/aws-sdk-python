...
Ipv6Addresses: TypeAlias = list[
    "aws_sdk_workspaces_instances.types.instance_ipv6_address.InstanceIpv6Address"
]
...
def serialize_aws_json_1_0(value: Ipv6Addresses) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_workspaces_instances.types.instance_ipv6_address.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> Ipv6Addresses:
    ...
    for item in data:
        out.append(
            aws_sdk_workspaces_instances.types.instance_ipv6_address.deserialize_aws_json_1_0(
                item
            )
        )
    return out
