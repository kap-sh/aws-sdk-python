...
class ListWorkspaceInstancesRequest(TypedDict):
    provision_states: NotRequired["aws_sdk_workspaces_instances.types.provision_states.ProvisionStates"]
...
def serialize_aws_json_1_0(value: ListWorkspaceInstancesRequest) -> dict:
    ...
    if "provision_states" in value:
        import aws_sdk_workspaces_instances.types.provision_states
        out["ProvisionStates"] = aws_sdk_workspaces_instances.types.provision_states.serialize_aws_json_1_0(value["provision_states"])
...
def deserialize_aws_json_1_0(data: dict) -> ListWorkspaceInstancesRequest:
    ...
    if "ProvisionStates" in data:
        import aws_sdk_workspaces_instances.types.provision_states
        out["provision_states"] = aws_sdk_workspaces_instances.types.provision_states.deserialize_aws_json_1_0(data["ProvisionStates"])
