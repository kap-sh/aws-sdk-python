...
def serialize_aws_json_1_0(value: ListInstanceTypesResponse) -> dict:
    out: dict = {}
    import aws_sdk_workspaces_instances.types.instance_types
    out["InstanceTypes"] = aws_sdk_workspaces_instances.types.instance_types.serialize_aws_json_1_0(value["instance_types"])
...
def deserialize_aws_json_1_0(data: dict) -> ListInstanceTypesResponse:
    ...
    if "InstanceTypes" in data:
        import aws_sdk_workspaces_instances.types.instance_types
        out["instance_types"] = aws_sdk_workspaces_instances.types.instance_types.deserialize_aws_json_1_0(data["InstanceTypes"])
    else:
