...
class InstanceMaintenanceOptionsRequest(TypedDict):
    auto_recovery: NotRequired["aws_sdk_workspaces_instances.types.auto_recovery_enum.AutoRecoveryEnum"]
...
def serialize_aws_json_1_0(value: InstanceMaintenanceOptionsRequest) -> dict:
    ...
    if "auto_recovery" in value:
        import aws_sdk_workspaces_instances.types.auto_recovery_enum
        out["AutoRecovery"] = aws_sdk_workspaces_instances.types.auto_recovery_enum.serialize_aws_json_1_0(value["auto_recovery"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> InstanceMaintenanceOptionsRequest:
    ...
    if "AutoRecovery" in data:
        import aws_sdk_workspaces_instances.types.auto_recovery_enum
        out["auto_recovery"] = aws_sdk_workspaces_instances.types.auto_recovery_enum.deserialize_aws_json_1_0(data["AutoRecovery"])
    return out