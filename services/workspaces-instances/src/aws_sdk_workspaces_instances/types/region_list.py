...
def serialize_aws_json_1_0(value: RegionList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_workspaces_instances.types.region.serialize_aws_json_1_0(item))
    return out
...
def deserialize_aws_json_1_0(data: list) -> RegionList:
    ...
    out: RegionList = []
    for item in data:
        out.append(aws_sdk_workspaces_instances.types.region.deserialize_aws_json_1_0(item))
    return out