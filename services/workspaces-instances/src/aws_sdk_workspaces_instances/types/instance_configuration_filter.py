...
class InstanceConfigurationFilter(TypedDict):
    ...
    platform_type: "aws_sdk_workspaces_instances.types.platform_type_enum.PlatformTypeEnum"
...
def serialize_aws_json_1_0(value: InstanceConfigurationFilter) -> dict:
    out: dict = {}
    import aws_sdk_workspaces_instances.types.billing_mode
    out["BillingMode"] = aws_sdk_workspaces_instances.types.billing_mode.serialize_aws_json_1_0(value["billing_mode"])
    import aws_sdk_workspaces_instances.types.platform_type_enum
    out["PlatformType"] = aws_sdk_workspaces_instances.types.platform_type_enum.serialize_aws_json_1_0(value["platform_type"])
    import aws_sdk_workspaces_instances.types.instance_configuration_tenancy_enum
    out["Tenancy"] = aws_sdk_workspaces_instances.types.instance_configuration_tenancy_enum.serialize_aws_json_1_0(value["tenancy"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> InstanceConfigurationFilter:
    ...
    if "BillingMode" in data:
        import aws_sdk_workspaces_instances.types.billing_mode
        out["billing_mode"] = aws_sdk_workspaces_instances.types.billing_mode.deserialize_aws_json_1_0(data["BillingMode"])
    else:
        raise DeserializationError("InstanceConfigurationFilter.billing_mode required")
    if "PlatformType" in data:
        import aws_sdk_workspaces_instances.types.platform_type_enum
        out["platform_type"] = aws_sdk_workspaces_instances.types.platform_type_enum.deserialize_aws_json_1_0(data["PlatformType"])
    else:
        raise DeserializationError("InstanceConfigurationFilter.platform_type required")
    if "Tenancy" in data:
        import aws_sdk_workspaces_instances.types.instance_configuration_tenancy_enum
        out["tenancy"] = aws_sdk_workspaces_instances.types.instance_configuration_tenancy_enum.deserialize_aws_json_1_0(data["Tenancy"])
    else:
