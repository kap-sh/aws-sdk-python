...
class InstanceNetworkPerformanceOptionsRequest(TypedDict):
    bandwidth_weighting: NotRequired["aws_sdk_workspaces_instances.types.bandwidth_weighting_enum.BandwidthWeightingEnum"]
...
def serialize_aws_json_1_0(value: InstanceNetworkPerformanceOptionsRequest) -> dict:
    ...
    if "bandwidth_weighting" in value:
        import aws_sdk_workspaces_instances.types.bandwidth_weighting_enum
        out["BandwidthWeighting"] = aws_sdk_workspaces_instances.types.bandwidth_weighting_enum.serialize_aws_json_1_0(value["bandwidth_weighting"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> InstanceNetworkPerformanceOptionsRequest:
    ...
    if "BandwidthWeighting" in data:
        import aws_sdk_workspaces_instances.types.bandwidth_weighting_enum
        out["bandwidth_weighting"] = aws_sdk_workspaces_instances.types.bandwidth_weighting_enum.deserialize_aws_json_1_0(data["BandwidthWeighting"])
    return out