...
class BlockDeviceMappingRequest(TypedDict, closed=True):
    ...
    ebs: NotRequired[
        "aws_sdk_workspaces_instances.types.ebs_block_device.EbsBlockDevice"
    ]
    ...
    virtual_name: NotRequired[
        "aws_sdk_workspaces_instances.types.virtual_name.VirtualName"
    ]
...
def serialize_aws_json_1_0(value: BlockDeviceMappingRequest) -> dict:
    ...
    if "ebs" in value:
        ...
        out["Ebs"] = (
            aws_sdk_workspaces_instances.types.ebs_block_device.serialize_aws_json_1_0(
                value["ebs"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> BlockDeviceMappingRequest:
    ...
    if "Ebs" in data:
        ...
        out["ebs"] = (
            aws_sdk_workspaces_instances.types.ebs_block_device.deserialize_aws_json_1_0(
                data["Ebs"]
            )
        )
    if "NoDevice" in data:
