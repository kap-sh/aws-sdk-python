...
class PrivateDnsNameOptionsRequest(TypedDict):
    hostname_type: NotRequired["aws_sdk_workspaces_instances.types.hostname_type_enum.HostnameTypeEnum"]
...
def serialize_aws_json_1_0(value: PrivateDnsNameOptionsRequest) -> dict:
    ...
    if "hostname_type" in value:
        import aws_sdk_workspaces_instances.types.hostname_type_enum
        out["HostnameType"] = aws_sdk_workspaces_instances.types.hostname_type_enum.serialize_aws_json_1_0(value["hostname_type"])
    ...
    if "enable_resource_name_dns_aaaa_record" in value:
        out["EnableResourceNameDnsAAAARecord"] = value["enable_resource_name_dns_aaaa_record"]
    return out
...
def deserialize_aws_json_1_0(data: dict) -> PrivateDnsNameOptionsRequest:
    ...
    if "HostnameType" in data:
        import aws_sdk_workspaces_instances.types.hostname_type_enum
        out["hostname_type"] = aws_sdk_workspaces_instances.types.hostname_type_enum.deserialize_aws_json_1_0(data["HostnameType"])
    ...
    if "EnableResourceNameDnsAAAARecord" in data:
        out["enable_resource_name_dns_aaaa_record"] = data["EnableResourceNameDnsAAAARecord"]
    return out