...
def serialize_aws_json_1_0(value: CreateWorkspaceInstanceRequest) -> dict:
    ...
    out["ManagedInstance"] = (
        aws_sdk_workspaces_instances.types.managed_instance_request.serialize_aws_json_1_0(
    ...
    if "billing_configuration" in value:
        ...
        out["BillingConfiguration"] = (
            aws_sdk_workspaces_instances.types.billing_configuration.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> CreateWorkspaceInstanceRequest:
    ...
    if "ManagedInstance" in data:
        ...
        out["managed_instance"] = (
            aws_sdk_workspaces_instances.types.managed_instance_request.deserialize_aws_json_1_0(
    ...
    if "BillingConfiguration" in data:
        ...
        out["billing_configuration"] = (
            aws_sdk_workspaces_instances.types.billing_configuration.deserialize_aws_json_1_0(
