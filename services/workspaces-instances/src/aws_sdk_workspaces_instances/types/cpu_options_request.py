...
class CpuOptionsRequest(TypedDict):
    amd_sev_snp: NotRequired[
        "aws_sdk_workspaces_instances.types.amd_sev_snp_enum.AmdSevSnpEnum"
    ]
...
def serialize_aws_json_1_0(value: CpuOptionsRequest) -> dict:
    ...
    if "amd_sev_snp" in value:
        ...
        out["AmdSevSnp"] = (
            aws_sdk_workspaces_instances.types.amd_sev_snp_enum.serialize_aws_json_1_0(
                value["amd_sev_snp"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> CpuOptionsRequest:
    ...
    if "AmdSevSnp" in data:
        ...
        out["amd_sev_snp"] = (
            aws_sdk_workspaces_instances.types.amd_sev_snp_enum.deserialize_aws_json_1_0(
                data["AmdSevSnp"]
            )
        )
