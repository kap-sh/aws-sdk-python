...
class GetWorkspaceInstanceResponse(TypedDict, closed=True):
    workspace_instance_errors: NotRequired[
        "aws_sdk_workspaces_instances.types.workspace_instance_errors.WorkspaceInstanceErrors"
    ]
    """<p>Captures any errors specific to the WorkSpace Instance lifecycle.</p>"""
    ec2_instance_errors: NotRequired[
        "aws_sdk_workspaces_instances.types.ec2_instance_errors.EC2InstanceErrors"
    ]
...
def serialize_aws_json_1_0(value: GetWorkspaceInstanceResponse) -> dict:
    ...
    if "workspace_instance_errors" in value:
        ...
        out["WorkspaceInstanceErrors"] = (
            aws_sdk_workspaces_instances.types.workspace_instance_errors.serialize_aws_json_1_0(
    ...
    if "ec2_instance_errors" in value:
        ...
        out["EC2InstanceErrors"] = (
            aws_sdk_workspaces_instances.types.ec2_instance_errors.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> GetWorkspaceInstanceResponse:
    ...
    if "WorkspaceInstanceErrors" in data:
        ...
        out["workspace_instance_errors"] = (
            aws_sdk_workspaces_instances.types.workspace_instance_errors.deserialize_aws_json_1_0(
    ...
    if "EC2InstanceErrors" in data:
        ...
        out["ec2_instance_errors"] = (
            aws_sdk_workspaces_instances.types.ec2_instance_errors.deserialize_aws_json_1_0(
