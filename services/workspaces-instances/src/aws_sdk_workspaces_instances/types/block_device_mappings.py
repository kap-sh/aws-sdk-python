...
BlockDeviceMappings: TypeAlias = list[
    "aws_sdk_workspaces_instances.types.block_device_mapping_request.BlockDeviceMappingRequest"
]
...
def serialize_aws_json_1_0(value: BlockDeviceMappings) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_workspaces_instances.types.block_device_mapping_request.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> BlockDeviceMappings:
    ...
    for item in data:
        out.append(
            aws_sdk_workspaces_instances.types.block_device_mapping_request.deserialize_aws_json_1_0(
                item
            )
        )
    return out
