...
NetworkInterfaces: TypeAlias = list[
    "aws_sdk_workspaces_instances.types.instance_network_interface_specification.InstanceNetworkInterfaceSpecification"
]
...
def serialize_aws_json_1_0(value: NetworkInterfaces) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_workspaces_instances.types.instance_network_interface_specification.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> NetworkInterfaces:
    ...
    for item in data:
        out.append(
            aws_sdk_workspaces_instances.types.instance_network_interface_specification.deserialize_aws_json_1_0(
                item
            )
        )
    return out
