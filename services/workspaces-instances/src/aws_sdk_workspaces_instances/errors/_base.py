...
class WorkspacesInstancesError(Exception):
    """Base class for all WorkspacesInstances service errors."""

class ServiceError(WorkspacesInstancesError):
...
class SerializationError(WorkspacesInstancesError):
    """Raised when a value cannot be serialized."""

class DeserializationError(WorkspacesInstancesError):
...
class WaiterFailedError(WorkspacesInstancesError):
...
class WaiterTimeoutError(WorkspacesInstancesError):
