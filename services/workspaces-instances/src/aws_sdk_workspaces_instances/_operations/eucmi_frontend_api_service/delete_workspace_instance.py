...
def build_request(
    ...
    input_: aws_sdk_workspaces_instances.types.delete_workspace_instance_request.DeleteWorkspaceInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces_instances.types.delete_workspace_instance_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
