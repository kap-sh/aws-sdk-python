...
def handle_response(
    ...
    out: aws_sdk_workspaces_instances.types.list_instance_types_response.ListInstanceTypesResponse = aws_sdk_workspaces_instances.types.list_instance_types_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_workspaces_instances.types.list_instance_types_request.ListInstanceTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
