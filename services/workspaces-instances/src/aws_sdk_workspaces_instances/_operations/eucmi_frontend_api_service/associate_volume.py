...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            ...
            raise aws_sdk_workspaces_instances.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_0(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_workspaces_instances.types.associate_volume_request.AssociateVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces_instances.types.associate_volume_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_associate_volume(
