...
def handle_response(
    ...
    out: aws_sdk_workspaces_instances.types.create_volume_response.CreateVolumeResponse = aws_sdk_workspaces_instances.types.create_volume_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_workspaces_instances.types.create_volume_request.CreateVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces_instances.types.create_volume_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
