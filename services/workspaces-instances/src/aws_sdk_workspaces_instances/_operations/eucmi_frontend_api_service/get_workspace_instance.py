...
def handle_response(
    ...
    out: aws_sdk_workspaces_instances.types.get_workspace_instance_response.GetWorkspaceInstanceResponse = aws_sdk_workspaces_instances.types.get_workspace_instance_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_workspaces_instances.types.get_workspace_instance_request.GetWorkspaceInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
