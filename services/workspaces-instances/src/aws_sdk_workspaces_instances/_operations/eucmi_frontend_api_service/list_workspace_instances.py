...
def handle_response(
    ...
    out: aws_sdk_workspaces_instances.types.list_workspace_instances_response.ListWorkspaceInstancesResponse = aws_sdk_workspaces_instances.types.list_workspace_instances_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_workspaces_instances.types.list_workspace_instances_request.ListWorkspaceInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workspaces_instances.types.list_workspace_instances_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_workspace_instances(
