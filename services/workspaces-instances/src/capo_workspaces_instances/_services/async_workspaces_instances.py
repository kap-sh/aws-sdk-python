...
from capo_workspaces_instances._services._aws_config import aaws_config
...
class AsyncWorkspacesInstancesClientConfig(TypedDict, total=False, closed=True):
...
class AsyncWorkspacesInstancesClient:
    ...
    async def associate_volume(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_instances.types.associate_volume_request.AssociateVolumeRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_instances.types.associate_volume_response.AssociateVolumeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_instances._operations.eucmi_frontend_api_service.associate_volume.async_associate_volume(
    ...
    async def create_volume(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_instances.types.create_volume_request.CreateVolumeRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_instances.types.create_volume_response.CreateVolumeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_instances._operations.eucmi_frontend_api_service.create_volume.async_create_volume(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_workspace_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_instances.types.create_workspace_instance_request.CreateWorkspaceInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_instances.types.create_workspace_instance_response.CreateWorkspaceInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_instances._operations.eucmi_frontend_api_service.create_workspace_instance.async_create_workspace_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_volume(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_instances.types.delete_volume_request.DeleteVolumeRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_instances.types.delete_volume_response.DeleteVolumeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_instances._operations.eucmi_frontend_api_service.delete_volume.async_delete_volume(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_workspace_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_instances.types.delete_workspace_instance_request.DeleteWorkspaceInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_instances.types.delete_workspace_instance_response.DeleteWorkspaceInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_instances._operations.eucmi_frontend_api_service.delete_workspace_instance.async_delete_workspace_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_volume(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_instances.types.disassociate_volume_request.DisassociateVolumeRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_instances.types.disassociate_volume_response.DisassociateVolumeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_instances._operations.eucmi_frontend_api_service.disassociate_volume.async_disassociate_volume(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_workspace_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_instances.types.get_workspace_instance_request.GetWorkspaceInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_instances.types.get_workspace_instance_response.GetWorkspaceInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_instances._operations.eucmi_frontend_api_service.get_workspace_instance.async_get_workspace_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_instance_types(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_instances.types.list_instance_types_request.ListInstanceTypesRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_instances.types.list_instance_types_response.ListInstanceTypesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_instances._operations.eucmi_frontend_api_service.list_instance_types.async_list_instance_types(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_workspaces_instances.types.instance_type_info.InstanceTypeInfo]":
        _token = next_token
        while True:
    ...
    async def list_regions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_instances.types.list_regions_request.ListRegionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_instances.types.list_regions_response.ListRegionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_instances._operations.eucmi_frontend_api_service.list_regions.async_list_regions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_workspaces_instances.types.region.Region]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_instances.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_instances.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_instances._operations.eucmi_frontend_api_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_workspace_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_instances.types.list_workspace_instances_request.ListWorkspaceInstancesRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_instances.types.list_workspace_instances_response.ListWorkspaceInstancesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_instances._operations.eucmi_frontend_api_service.list_workspace_instances.async_list_workspace_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_workspaces_instances.types.workspace_instance.WorkspaceInstance]":
        _token = next_token
        while True:
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_instances.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_instances.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_instances._operations.eucmi_frontend_api_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_instances.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_instances.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_instances._operations.eucmi_frontend_api_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
