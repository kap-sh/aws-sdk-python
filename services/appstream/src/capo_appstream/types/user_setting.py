...
def serialize_aws_json_1_1(value: UserSetting) -> dict:
    ...
    if "action" in value:
        ...
        out["Action"] = capo_appstream.types.action.serialize_aws_json_1_1(
            value["action"]
        )
