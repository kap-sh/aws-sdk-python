"""Generated from Smithy shape ``com.amazonaws.appstream#AppBlockBuilderAppBlockAssociation``."""
...
class AppBlockBuilderAppBlockAssociation(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AppBlockBuilderAppBlockAssociation) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> AppBlockBuilderAppBlockAssociation:
    out: AppBlockBuilderAppBlockAssociation = {}  # type: ignore[typeddict-item]
