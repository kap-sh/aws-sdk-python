"""Generated from Smithy shape ``com.amazonaws.appstream#AssociateFleet``."""
...
def handle_response(
    ...
    out: capo_appstream.types.associate_fleet_result.AssociateFleetResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.associate_fleet_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def associate_fleet(
    ...
    capo_appstream.types.associate_fleet_result.AssociateFleetResult, zapros.Response
]:
...
async def async_associate_fleet(
