"""Generated from Smithy shape ``com.amazonaws.appstream#CreateDirectoryConfig``."""
...
def handle_response(
    ...
    out: capo_appstream.types.create_directory_config_result.CreateDirectoryConfigResult = capo_appstream.types.create_directory_config_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.create_directory_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_directory_config(
