"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeImages``."""
...
def handle_response(
    ...
    out: capo_appstream.types.describe_images_result.DescribeImagesResult = (
        capo_appstream.types.describe_images_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.describe_images_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_images(
    ...
    capo_appstream.types.describe_images_result.DescribeImagesResult, zapros.Response
]:
...
async def async_describe_images(
