"""Generated from Smithy shape ``com.amazonaws.appstream#DisassociateApplicationFromEntitlement``."""
...
def handle_response(
    ...
    out: capo_appstream.types.disassociate_application_from_entitlement_result.DisassociateApplicationFromEntitlementResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.disassociate_application_from_entitlement_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_application_from_entitlement(
