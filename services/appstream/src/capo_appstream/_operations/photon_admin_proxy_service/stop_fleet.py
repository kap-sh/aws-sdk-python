"""Generated from Smithy shape ``com.amazonaws.appstream#StopFleet``."""
...
def handle_response(
    ...
    out: capo_appstream.types.stop_fleet_result.StopFleetResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.stop_fleet_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_fleet(
    ...
    input_: capo_appstream.types.stop_fleet_request.StopFleetRequest,
) -> tuple[capo_appstream.types.stop_fleet_result.StopFleetResult, zapros.Response]:
