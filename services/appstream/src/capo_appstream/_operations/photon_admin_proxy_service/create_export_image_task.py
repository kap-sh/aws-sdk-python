"""Generated from Smithy shape ``com.amazonaws.appstream#CreateExportImageTask``."""
...
def handle_response(
    ...
    out: capo_appstream.types.create_export_image_task_result.CreateExportImageTaskResult = capo_appstream.types.create_export_image_task_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.CreateExportImageTask"
    body: bytes | None = json.dumps(
        capo_appstream.types.create_export_image_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_export_image_task(
