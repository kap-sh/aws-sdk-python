"""Generated from Smithy shape ``com.amazonaws.appstream#DeleteDirectoryConfig``."""
...
def handle_response(
    ...
    out: capo_appstream.types.delete_directory_config_result.DeleteDirectoryConfigResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.delete_directory_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_directory_config(
