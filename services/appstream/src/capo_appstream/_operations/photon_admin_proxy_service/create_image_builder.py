"""Generated from Smithy shape ``com.amazonaws.appstream#CreateImageBuilder``."""
...
import capo_appstream.errors.concurrent_modification_exception
import capo_appstream.errors.incompatible_image_exception
import capo_appstream.errors.invalid_account_status_exception
import capo_appstream.errors.invalid_parameter_combination_exception
import capo_appstream.errors.invalid_role_exception
import capo_appstream.errors.limit_exceeded_exception
import capo_appstream.errors.operation_not_permitted_exception
import capo_appstream.errors.request_limit_exceeded_exception
import capo_appstream.errors.resource_already_exists_exception
import capo_appstream.errors.resource_not_available_exception
import capo_appstream.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentModificationException":
            raise capo_appstream.errors.concurrent_modification_exception.ConcurrentModificationException.from_aws_json_1_1(
                data
            )
        case "IncompatibleImageException":
            raise capo_appstream.errors.incompatible_image_exception.IncompatibleImageException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidParameterCombinationException":
            raise capo_appstream.errors.invalid_parameter_combination_exception.InvalidParameterCombinationException.from_aws_json_1_1(
                data
            )
        ...
        case "OperationNotPermittedException":
            raise capo_appstream.errors.operation_not_permitted_exception.OperationNotPermittedException.from_aws_json_1_1(
                data
            )
        case "RequestLimitExceededException":
            raise capo_appstream.errors.request_limit_exceeded_exception.RequestLimitExceededException.from_aws_json_1_1(
                data
            )
        case "ResourceAlreadyExistsException":
            raise capo_appstream.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_aws_json_1_1(
                data
            )
        case "ResourceNotAvailableException":
            raise capo_appstream.errors.resource_not_available_exception.ResourceNotAvailableException.from_aws_json_1_1(
                data
            )
        case "ResourceNotFoundException":
            raise capo_appstream.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_appstream.types.create_image_builder_result.CreateImageBuilderResult = (
        capo_appstream.types.create_image_builder_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.create_image_builder_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_create_image_builder(
