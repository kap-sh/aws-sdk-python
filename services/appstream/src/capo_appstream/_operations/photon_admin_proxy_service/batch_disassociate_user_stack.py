"""Generated from Smithy shape ``com.amazonaws.appstream#BatchDisassociateUserStack``."""
...
def handle_response(
    ...
    out: capo_appstream.types.batch_disassociate_user_stack_result.BatchDisassociateUserStackResult = capo_appstream.types.batch_disassociate_user_stack_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.batch_disassociate_user_stack_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_disassociate_user_stack(
