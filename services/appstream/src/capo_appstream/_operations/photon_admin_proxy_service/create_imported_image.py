"""Generated from Smithy shape ``com.amazonaws.appstream#CreateImportedImage``."""
...
import capo_appstream.errors.dry_run_operation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DryRunOperationException":
            raise capo_appstream.errors.dry_run_operation_exception.DryRunOperationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_appstream.types.create_imported_image_result.CreateImportedImageResult = (
        capo_appstream.types.create_imported_image_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.CreateImportedImage"
    body: bytes | None = json.dumps(
        capo_appstream.types.create_imported_image_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
