"""Generated from Smithy shape ``com.amazonaws.appstream#AssociateApplicationToEntitlement``."""
...
def handle_response(
    ...
    out: capo_appstream.types.associate_application_to_entitlement_result.AssociateApplicationToEntitlementResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.associate_application_to_entitlement_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_application_to_entitlement(
