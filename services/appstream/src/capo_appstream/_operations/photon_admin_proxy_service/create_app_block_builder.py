"""Generated from Smithy shape ``com.amazonaws.appstream#CreateAppBlockBuilder``."""
...
def handle_response(
    ...
    out: capo_appstream.types.create_app_block_builder_result.CreateAppBlockBuilderResult = capo_appstream.types.create_app_block_builder_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.CreateAppBlockBuilder"
    body: bytes | None = json.dumps(
        capo_appstream.types.create_app_block_builder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_app_block_builder(
