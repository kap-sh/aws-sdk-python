"""Generated from Smithy shape ``com.amazonaws.appstream#DisableUser``."""
...
def handle_response(
    ...
    out: capo_appstream.types.disable_user_result.DisableUserResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.disable_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def disable_user(
    ...
    input_: capo_appstream.types.disable_user_request.DisableUserRequest,
) -> tuple[capo_appstream.types.disable_user_result.DisableUserResult, zapros.Response]:
