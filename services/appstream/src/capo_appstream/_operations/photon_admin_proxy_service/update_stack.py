"""Generated from Smithy shape ``com.amazonaws.appstream#UpdateStack``."""
...
import capo_appstream.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise capo_appstream.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_appstream.types.update_stack_result.UpdateStackResult = (
        capo_appstream.types.update_stack_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.update_stack_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_stack(
    ...
    input_: capo_appstream.types.update_stack_request.UpdateStackRequest,
) -> tuple[capo_appstream.types.update_stack_result.UpdateStackResult, zapros.Response]:
