"""Generated from Smithy shape ``com.amazonaws.appstream#StartImageBuilder``."""
...
def handle_response(
    ...
    out: capo_appstream.types.start_image_builder_result.StartImageBuilderResult = (
        capo_appstream.types.start_image_builder_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.start_image_builder_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_start_image_builder(
