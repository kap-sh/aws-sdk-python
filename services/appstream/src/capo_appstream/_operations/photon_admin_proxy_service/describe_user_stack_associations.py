"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeUserStackAssociations``."""
...
def handle_response(
    ...
    out: capo_appstream.types.describe_user_stack_associations_result.DescribeUserStackAssociationsResult = capo_appstream.types.describe_user_stack_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.describe_user_stack_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_user_stack_associations(
