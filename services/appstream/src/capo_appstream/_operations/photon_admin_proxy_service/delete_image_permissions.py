"""Generated from Smithy shape ``com.amazonaws.appstream#DeleteImagePermissions``."""
...
def handle_response(
    ...
    out: capo_appstream.types.delete_image_permissions_result.DeleteImagePermissionsResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.delete_image_permissions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_image_permissions(
