"""Generated from Smithy shape ``com.amazonaws.appstream#DeleteUser``."""
...
def handle_response(
    ...
    out: capo_appstream.types.delete_user_result.DeleteUserResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.delete_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_user(
    ...
    input_: capo_appstream.types.delete_user_request.DeleteUserRequest,
) -> tuple[capo_appstream.types.delete_user_result.DeleteUserResult, zapros.Response]:
