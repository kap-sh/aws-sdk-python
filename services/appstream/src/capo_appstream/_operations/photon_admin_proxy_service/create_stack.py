"""Generated from Smithy shape ``com.amazonaws.appstream#CreateStack``."""
...
def handle_response(
    ...
    out: capo_appstream.types.create_stack_result.CreateStackResult = (
        capo_appstream.types.create_stack_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.create_stack_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_stack(
    ...
    input_: capo_appstream.types.create_stack_request.CreateStackRequest,
) -> tuple[capo_appstream.types.create_stack_result.CreateStackResult, zapros.Response]:
