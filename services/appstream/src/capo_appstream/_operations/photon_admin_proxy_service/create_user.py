"""Generated from Smithy shape ``com.amazonaws.appstream#CreateUser``."""
...
def handle_response(
    ...
    out: capo_appstream.types.create_user_result.CreateUserResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.create_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_user(
    ...
    input_: capo_appstream.types.create_user_request.CreateUserRequest,
) -> tuple[capo_appstream.types.create_user_result.CreateUserResult, zapros.Response]:
