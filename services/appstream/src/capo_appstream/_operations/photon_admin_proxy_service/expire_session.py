"""Generated from Smithy shape ``com.amazonaws.appstream#ExpireSession``."""
...
def handle_response(
    ...
    out: capo_appstream.types.expire_session_result.ExpireSessionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.expire_session_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def expire_session(
    ...
    capo_appstream.types.expire_session_result.ExpireSessionResult, zapros.Response
]:
