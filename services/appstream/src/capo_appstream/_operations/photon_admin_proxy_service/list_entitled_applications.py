"""Generated from Smithy shape ``com.amazonaws.appstream#ListEntitledApplications``."""
...
def handle_response(
    ...
    out: capo_appstream.types.list_entitled_applications_result.ListEntitledApplicationsResult = capo_appstream.types.list_entitled_applications_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.ListEntitledApplications"
    body: bytes | None = json.dumps(
        capo_appstream.types.list_entitled_applications_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_entitled_applications(
