"""Generated from Smithy shape ``com.amazonaws.appstream#CreateEntitlement``."""
...
import capo_appstream.errors.entitlement_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "EntitlementAlreadyExistsException":
            raise capo_appstream.errors.entitlement_already_exists_exception.EntitlementAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_appstream.types.create_entitlement_result.CreateEntitlementResult = (
        capo_appstream.types.create_entitlement_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.CreateEntitlement"
    body: bytes | None = json.dumps(
        capo_appstream.types.create_entitlement_request.serialize_aws_json_1_1(input_)
    ).encode()
