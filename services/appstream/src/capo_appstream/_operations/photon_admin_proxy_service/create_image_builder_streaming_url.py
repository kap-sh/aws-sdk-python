"""Generated from Smithy shape ``com.amazonaws.appstream#CreateImageBuilderStreamingURL``."""
...
def handle_response(
    ...
    out: capo_appstream.types.create_image_builder_streaming_url_result.CreateImageBuilderStreamingURLResult = capo_appstream.types.create_image_builder_streaming_url_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.create_image_builder_streaming_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_image_builder_streaming_url(
