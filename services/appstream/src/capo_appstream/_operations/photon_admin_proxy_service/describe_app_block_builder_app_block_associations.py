"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeAppBlockBuilderAppBlockAssociations``."""
...
def handle_response(
    ...
    out: capo_appstream.types.describe_app_block_builder_app_block_associations_result.DescribeAppBlockBuilderAppBlockAssociationsResult = capo_appstream.types.describe_app_block_builder_app_block_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.describe_app_block_builder_app_block_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_app_block_builder_app_block_associations(
