"""Generated from Smithy shape ``com.amazonaws.appstream#UpdateThemeForStack``."""
...
def handle_response(
    ...
    out: capo_appstream.types.update_theme_for_stack_result.UpdateThemeForStackResult = capo_appstream.types.update_theme_for_stack_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.UpdateThemeForStack"
    body: bytes | None = json.dumps(
        capo_appstream.types.update_theme_for_stack_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_theme_for_stack(
