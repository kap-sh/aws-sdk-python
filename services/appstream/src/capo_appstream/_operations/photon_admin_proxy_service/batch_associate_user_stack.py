"""Generated from Smithy shape ``com.amazonaws.appstream#BatchAssociateUserStack``."""
...
def handle_response(
    ...
    out: capo_appstream.types.batch_associate_user_stack_result.BatchAssociateUserStackResult = capo_appstream.types.batch_associate_user_stack_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.batch_associate_user_stack_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_associate_user_stack(
