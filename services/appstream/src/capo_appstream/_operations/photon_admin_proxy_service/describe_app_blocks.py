"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeAppBlocks``."""
...
def handle_response(
    ...
    out: capo_appstream.types.describe_app_blocks_result.DescribeAppBlocksResult = (
        capo_appstream.types.describe_app_blocks_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.describe_app_blocks_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_app_blocks(
