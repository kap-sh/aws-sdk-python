...
def handle_response(
    ...
    out: capo_appstream.types.list_associated_fleets_result.ListAssociatedFleetsResult = capo_appstream.types.list_associated_fleets_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.list_associated_fleets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
