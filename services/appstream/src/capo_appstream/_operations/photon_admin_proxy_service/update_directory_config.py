"""Generated from Smithy shape ``com.amazonaws.appstream#UpdateDirectoryConfig``."""
...
def handle_response(
    ...
    out: capo_appstream.types.update_directory_config_result.UpdateDirectoryConfigResult = capo_appstream.types.update_directory_config_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.update_directory_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_directory_config(
