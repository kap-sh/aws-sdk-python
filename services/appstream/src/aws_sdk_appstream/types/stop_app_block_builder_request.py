...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StopAppBlockBuilderRequest) -> dict:
    out: dict = {}
    if "name" in value:
        out["Name"] = value["name"]
    return out
...
def deserialize_aws_json_1_1(data: dict) -> StopAppBlockBuilderRequest:
    out: StopAppBlockBuilderRequest = {}  # type: ignore[typeddict-item]
    if "Name" in data:
        out["name"] = data["Name"]
    return out
