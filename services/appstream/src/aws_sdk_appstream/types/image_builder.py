...
if TYPE_CHECKING:
    ...
    import aws_sdk_appstream.types.image_builder_state
    import aws_sdk_appstream.types.image_builder_state_change_reason
    import aws_sdk_appstream.types.latest_appstream_agent_version
    import aws_sdk_appstream.types.network_access_configuration
    import aws_sdk_appstream.types.platform_type
    import aws_sdk_appstream.types.resource_errors
...
class ImageBuilder(TypedDict):
    ...
    state: NotRequired["aws_sdk_appstream.types.image_builder_state.ImageBuilderState"]
    """<p>The state of the image builder.</p>"""
    state_change_reason: NotRequired[
        "aws_sdk_appstream.types.image_builder_state_change_reason.ImageBuilderStateChangeReason"
    ]
    ...
    image_builder_errors: NotRequired[
        "aws_sdk_appstream.types.resource_errors.ResourceErrors"
    ]
    ...
    latest_appstream_agent_version: NotRequired[
        "aws_sdk_appstream.types.latest_appstream_agent_version.LatestAppstreamAgentVersion"
    ]
...
def serialize_aws_json_1_1(value: ImageBuilder) -> dict:
    ...
    if "state" in value:
        ...
        out["State"] = (
            aws_sdk_appstream.types.image_builder_state.serialize_aws_json_1_1(
                value["state"]
            )
        )
    if "state_change_reason" in value:
        ...
        out["StateChangeReason"] = (
            aws_sdk_appstream.types.image_builder_state_change_reason.serialize_aws_json_1_1(
    ...
    if "image_builder_errors" in value:
        ...
        out["ImageBuilderErrors"] = (
            aws_sdk_appstream.types.resource_errors.serialize_aws_json_1_1(
    ...
    if "latest_appstream_agent_version" in value:
        ...
        out["LatestAppstreamAgentVersion"] = (
            aws_sdk_appstream.types.latest_appstream_agent_version.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ImageBuilder:
    ...
    if "State" in data:
        ...
        out["state"] = (
            aws_sdk_appstream.types.image_builder_state.deserialize_aws_json_1_1(
                data["State"]
            )
        )
    if "StateChangeReason" in data:
        ...
        out["state_change_reason"] = (
            aws_sdk_appstream.types.image_builder_state_change_reason.deserialize_aws_json_1_1(
    ...
    if "ImageBuilderErrors" in data:
        ...
        out["image_builder_errors"] = (
            aws_sdk_appstream.types.resource_errors.deserialize_aws_json_1_1(
    ...
    if "LatestAppstreamAgentVersion" in data:
        ...
        out["latest_appstream_agent_version"] = (
            aws_sdk_appstream.types.latest_appstream_agent_version.deserialize_aws_json_1_1(
