...
if TYPE_CHECKING:
    ...
    import aws_sdk_appstream.types.app_block_builder_state
    import aws_sdk_appstream.types.app_block_builder_state_change_reason
...
class AppBlockBuilder(TypedDict, closed=True):
    ...
    state: NotRequired[
        "aws_sdk_appstream.types.app_block_builder_state.AppBlockBuilderState"
    ]
    ...
    state_change_reason: NotRequired[
        "aws_sdk_appstream.types.app_block_builder_state_change_reason.AppBlockBuilderStateChangeReason"
    ]
...
def serialize_aws_json_1_1(value: AppBlockBuilder) -> dict:
    ...
    if "state" in value:
        ...
        out["State"] = (
            aws_sdk_appstream.types.app_block_builder_state.serialize_aws_json_1_1(
                value["state"]
            )
        )
    ...
    if "state_change_reason" in value:
        ...
        out["StateChangeReason"] = (
            aws_sdk_appstream.types.app_block_builder_state_change_reason.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AppBlockBuilder:
    ...
    if "State" in data:
        ...
        out["state"] = (
            aws_sdk_appstream.types.app_block_builder_state.deserialize_aws_json_1_1(
                data["State"]
            )
        )
    ...
    if "StateChangeReason" in data:
        ...
        out["state_change_reason"] = (
            aws_sdk_appstream.types.app_block_builder_state_change_reason.deserialize_aws_json_1_1(
