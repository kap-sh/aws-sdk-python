...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateStreamingURLResult) -> dict:
    out: dict = {}
    ...
    if "expires" in value:
        ...
        out["Expires"] = aws_sdk_appstream.types.timestamp.serialize_aws_json_1_1(
            value["expires"]
        )
    return out


def deserialize_aws_json_1_1(data: dict) -> CreateStreamingURLResult:
    out: CreateStreamingURLResult = {}  # type: ignore[typeddict-item]
    if "StreamingURL" in data:
        out["streaming_url"] = data["StreamingURL"]
    if "Expires" in data:
        import aws_sdk_appstream.types.timestamp

        out["expires"] = aws_sdk_appstream.types.timestamp.deserialize_aws_json_1_1(
            data["Expires"]
        )
    return out
