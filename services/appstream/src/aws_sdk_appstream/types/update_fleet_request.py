...
class UpdateFleetRequest(TypedDict):
    ...
    delete_vpc_config: NotRequired["aws_sdk_appstream.types.boolean.Boolean"]
...
def serialize_aws_json_1_1(value: UpdateFleetRequest) -> dict:
    ...
    if "attributes_to_delete" in value:
        ...
        out["AttributesToDelete"] = (
            aws_sdk_appstream.types.fleet_attributes.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateFleetRequest:
    ...
    if "AttributesToDelete" in data:
        ...
        out["attributes_to_delete"] = (
            aws_sdk_appstream.types.fleet_attributes.deserialize_aws_json_1_1(
