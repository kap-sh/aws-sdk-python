...
if TYPE_CHECKING:
    ...
    import aws_sdk_appstream.types.dynamic_app_providers_enabled
    import aws_sdk_appstream.types.image_permissions
    import aws_sdk_appstream.types.image_shared_with_others
    import aws_sdk_appstream.types.image_state
    import aws_sdk_appstream.types.image_state_change_reason
    import aws_sdk_appstream.types.image_type
...
class Image(TypedDict, closed=True):
    ...
    base_image_arn: NotRequired["aws_sdk_appstream.types.arn.Arn"]
    ...
    state: NotRequired["aws_sdk_appstream.types.image_state.ImageState"]
    ...
    visibility: NotRequired["aws_sdk_appstream.types.visibility_type.VisibilityType"]
    """<p>Indicates whether the image is public or private.</p>"""
    image_builder_supported: NotRequired["aws_sdk_appstream.types.boolean.Boolean"]
    """<p>Indicates whether an image builder can be launched from this image.</p>"""
    image_builder_name: NotRequired["aws_sdk_appstream.types.string.String"]
    ...
    state_change_reason: NotRequired[
        "aws_sdk_appstream.types.image_state_change_reason.ImageStateChangeReason"
    ]
    ...
    image_errors: NotRequired["aws_sdk_appstream.types.resource_errors.ResourceErrors"]
    ...
    dynamic_app_providers_enabled: NotRequired[
        "aws_sdk_appstream.types.dynamic_app_providers_enabled.DynamicAppProvidersEnabled"
    ]
    ...
    image_shared_with_others: NotRequired[
        "aws_sdk_appstream.types.image_shared_with_others.ImageSharedWithOthers"
    ]
...
def serialize_aws_json_1_1(value: Image) -> dict:
    ...
    if "state" in value:
        ...
        out["State"] = aws_sdk_appstream.types.image_state.serialize_aws_json_1_1(
            value["state"]
        )
    if "visibility" in value:
        ...
        out["Visibility"] = (
            aws_sdk_appstream.types.visibility_type.serialize_aws_json_1_1(
                value["visibility"]
            )
        )
    ...
    if "state_change_reason" in value:
        ...
        out["StateChangeReason"] = (
            aws_sdk_appstream.types.image_state_change_reason.serialize_aws_json_1_1(
    ...
    if "dynamic_app_providers_enabled" in value:
        ...
        out["DynamicAppProvidersEnabled"] = (
            aws_sdk_appstream.types.dynamic_app_providers_enabled.serialize_aws_json_1_1(
    ...
    if "image_shared_with_others" in value:
        ...
        out["ImageSharedWithOthers"] = (
            aws_sdk_appstream.types.image_shared_with_others.serialize_aws_json_1_1(
    ...
    if "image_type" in value:
        ...
        out["ImageType"] = aws_sdk_appstream.types.image_type.serialize_aws_json_1_1(
            value["image_type"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Image:
    ...
    if "State" in data:
        ...
        out["state"] = aws_sdk_appstream.types.image_state.deserialize_aws_json_1_1(
            data["State"]
        )
    if "Visibility" in data:
        ...
        out["visibility"] = (
            aws_sdk_appstream.types.visibility_type.deserialize_aws_json_1_1(
                data["Visibility"]
            )
        )
    ...
    if "StateChangeReason" in data:
        ...
        out["state_change_reason"] = (
            aws_sdk_appstream.types.image_state_change_reason.deserialize_aws_json_1_1(
    ...
    if "DynamicAppProvidersEnabled" in data:
        ...
        out["dynamic_app_providers_enabled"] = (
            aws_sdk_appstream.types.dynamic_app_providers_enabled.deserialize_aws_json_1_1(
    ...
    if "ImageSharedWithOthers" in data:
        ...
        out["image_shared_with_others"] = (
            aws_sdk_appstream.types.image_shared_with_others.deserialize_aws_json_1_1(
    ...
    if "ImageType" in data:
        ...
        out["image_type"] = aws_sdk_appstream.types.image_type.deserialize_aws_json_1_1(
            data["ImageType"]
        )
    return out
