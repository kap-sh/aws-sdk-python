"""Generated from Smithy shape ``com.amazonaws.appstream#CreateEntitlementRequest``."""
...
class CreateEntitlementRequest(TypedDict):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateEntitlementRequest) -> dict:
    out: dict = {}
    if "name" in value:
        out["Name"] = value["name"]
...
def deserialize_aws_json_1_1(data: dict) -> CreateEntitlementRequest:
