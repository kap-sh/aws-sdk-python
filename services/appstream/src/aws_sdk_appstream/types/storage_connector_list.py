...
if TYPE_CHECKING:
    import aws_sdk_appstream.types.storage_connector

StorageConnectorList: TypeAlias = list[
    "aws_sdk_appstream.types.storage_connector.StorageConnector"
]
...
def serialize_aws_json_1_1(value: StorageConnectorList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_appstream.types.storage_connector.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> StorageConnectorList:
    ...
    for item in data:
        out.append(
            aws_sdk_appstream.types.storage_connector.deserialize_aws_json_1_1(item)
        )
    return out
