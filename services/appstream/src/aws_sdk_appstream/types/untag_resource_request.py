...
class UntagResourceRequest(TypedDict, closed=True):
    ...
    tag_keys: NotRequired["aws_sdk_appstream.types.tag_key_list.TagKeyList"]
...
def serialize_aws_json_1_1(value: UntagResourceRequest) -> dict:
    ...
    if "tag_keys" in value:
        ...
        out["TagKeys"] = aws_sdk_appstream.types.tag_key_list.serialize_aws_json_1_1(
            value["tag_keys"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UntagResourceRequest:
    ...
    if "TagKeys" in data:
        ...
        out["tag_keys"] = aws_sdk_appstream.types.tag_key_list.deserialize_aws_json_1_1(
            data["TagKeys"]
        )
    return out
