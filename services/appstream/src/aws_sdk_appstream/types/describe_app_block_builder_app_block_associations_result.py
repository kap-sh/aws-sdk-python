...
class DescribeAppBlockBuilderAppBlockAssociationsResult(TypedDict):
    app_block_builder_app_block_associations: NotRequired[
        "aws_sdk_appstream.types.app_block_builder_app_block_associations_list.AppBlockBuilderAppBlockAssociationsList"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "app_block_builder_app_block_associations" in value:
        ...
        out["AppBlockBuilderAppBlockAssociations"] = (
            aws_sdk_appstream.types.app_block_builder_app_block_associations_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "AppBlockBuilderAppBlockAssociations" in data:
        ...
        out["app_block_builder_app_block_associations"] = (
            aws_sdk_appstream.types.app_block_builder_app_block_associations_list.deserialize_aws_json_1_1(
