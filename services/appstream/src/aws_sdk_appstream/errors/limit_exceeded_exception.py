"""Generated from Smithy shape ``com.amazonaws.appstream#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.appstream#LimitExceededException``."""
