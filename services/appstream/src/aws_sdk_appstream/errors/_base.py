...
class AppStreamError(Exception):
    """Base class for all AppStream service errors."""


class ServiceError(AppStreamError):
...
class SerializationError(AppStreamError):
    """Raised when a value cannot be serialized."""


class DeserializationError(AppStreamError):
...
class WaiterFailedError(AppStreamError):
...
class WaiterTimeoutError(AppStreamError):
