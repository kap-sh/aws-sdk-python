"""Generated from Smithy shape ``com.amazonaws.appstream#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.appstream#ResourceNotFoundException``."""
