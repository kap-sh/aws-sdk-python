"""Generated from Smithy shape ``com.amazonaws.appstream#DisassociateApplicationFleet``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.disassociate_application_fleet_result.DisassociateApplicationFleetResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.disassociate_application_fleet_request.DisassociateApplicationFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.DisassociateApplicationFleet"
    import aws_sdk_appstream.types.disassociate_application_fleet_request

    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.disassociate_application_fleet_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_application_fleet(
