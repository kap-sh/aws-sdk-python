...
def handle_response(
    ...
    out: aws_sdk_appstream.types.create_updated_image_result.CreateUpdatedImageResult = aws_sdk_appstream.types.create_updated_image_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.create_updated_image_request.CreateUpdatedImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.create_updated_image_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
