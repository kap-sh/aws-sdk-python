...
def handle_response(
    ...
    out: aws_sdk_appstream.types.delete_entitlement_result.DeleteEntitlementResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_appstream.types.delete_entitlement_request.DeleteEntitlementRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.delete_entitlement_request.serialize_aws_json_1_1(input)
    ).encode()
