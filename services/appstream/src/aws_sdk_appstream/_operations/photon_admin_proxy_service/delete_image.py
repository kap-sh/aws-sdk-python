...
def handle_response(
    ...
    out: aws_sdk_appstream.types.delete_image_result.DeleteImageResult = (
        aws_sdk_appstream.types.delete_image_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.delete_image_request.DeleteImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.delete_image_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_image(
    ...
    aws_sdk_appstream.types.delete_image_result.DeleteImageResult, zapros.Response
]:
