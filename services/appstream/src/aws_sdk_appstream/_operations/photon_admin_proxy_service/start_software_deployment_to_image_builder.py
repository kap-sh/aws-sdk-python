...
def handle_response(
    ...
    out: aws_sdk_appstream.types.start_software_deployment_to_image_builder_result.StartSoftwareDeploymentToImageBuilderResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.start_software_deployment_to_image_builder_request.StartSoftwareDeploymentToImageBuilderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
