...
def handle_response(
    ...
    out: aws_sdk_appstream.types.associate_software_to_image_builder_result.AssociateSoftwareToImageBuilderResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.associate_software_to_image_builder_request.AssociateSoftwareToImageBuilderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
