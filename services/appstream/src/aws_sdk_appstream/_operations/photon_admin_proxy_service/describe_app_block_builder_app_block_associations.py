...
import aws_sdk_appstream.types.app_block_builder_app_block_associations_list
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_app_block_builder_app_block_associations_result.DescribeAppBlockBuilderAppBlockAssociationsResult = aws_sdk_appstream.types.describe_app_block_builder_app_block_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_app_block_builder_app_block_associations_request.DescribeAppBlockBuilderAppBlockAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_app_block_builder_app_block_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
