...
def handle_response(
    ...
    out: aws_sdk_appstream.types.delete_user_result.DeleteUserResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.delete_user_request.DeleteUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.delete_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_user(
    ...
    aws_sdk_appstream.types.delete_user_result.DeleteUserResult, zapros.Response
]:
