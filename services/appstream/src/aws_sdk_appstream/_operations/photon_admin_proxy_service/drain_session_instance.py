...
def handle_response(
    ...
    out: aws_sdk_appstream.types.drain_session_instance_result.DrainSessionInstanceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.drain_session_instance_request.DrainSessionInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.drain_session_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
