...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_stacks_result.DescribeStacksResult = (
        aws_sdk_appstream.types.describe_stacks_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_stacks_request.DescribeStacksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_stacks_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_stacks(
    ...
    aws_sdk_appstream.types.describe_stacks_result.DescribeStacksResult, zapros.Response
]:
