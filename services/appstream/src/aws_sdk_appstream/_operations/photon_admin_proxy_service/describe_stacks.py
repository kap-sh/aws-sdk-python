...
def build_request(
    ...
    input: aws_sdk_appstream.types.describe_stacks_request.DescribeStacksRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_stacks_request.serialize_aws_json_1_1(input)
    ).encode()
