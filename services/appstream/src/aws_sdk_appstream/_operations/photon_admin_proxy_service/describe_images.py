...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_images_result.DescribeImagesResult = (
        aws_sdk_appstream.types.describe_images_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_images_request.DescribeImagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_images_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_images(
    ...
    aws_sdk_appstream.types.describe_images_result.DescribeImagesResult, zapros.Response
]:
