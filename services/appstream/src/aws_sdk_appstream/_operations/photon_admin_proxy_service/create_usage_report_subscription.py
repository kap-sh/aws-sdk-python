...
def handle_response(
    ...
    out: aws_sdk_appstream.types.create_usage_report_subscription_result.CreateUsageReportSubscriptionResult = aws_sdk_appstream.types.create_usage_report_subscription_result.deserialize_aws_json_1_1(
