...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_app_blocks_result.DescribeAppBlocksResult = (
        aws_sdk_appstream.types.describe_app_blocks_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_app_blocks_request.DescribeAppBlocksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
