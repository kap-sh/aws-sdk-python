...
def handle_response(
    ...
    out: aws_sdk_appstream.types.delete_fleet_result.DeleteFleetResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.delete_fleet_request.DeleteFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.delete_fleet_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_fleet(
    ...
    aws_sdk_appstream.types.delete_fleet_result.DeleteFleetResult, zapros.Response
]:
