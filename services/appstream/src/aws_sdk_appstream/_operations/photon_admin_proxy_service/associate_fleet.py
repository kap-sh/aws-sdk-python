...
def handle_response(
    ...
    out: aws_sdk_appstream.types.associate_fleet_result.AssociateFleetResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.associate_fleet_request.AssociateFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.associate_fleet_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def associate_fleet(
    ...
    aws_sdk_appstream.types.associate_fleet_result.AssociateFleetResult, zapros.Response
]:
