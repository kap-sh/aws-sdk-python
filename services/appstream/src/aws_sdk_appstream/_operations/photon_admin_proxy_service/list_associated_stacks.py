...
def handle_response(
    ...
    out: aws_sdk_appstream.types.list_associated_stacks_result.ListAssociatedStacksResult = aws_sdk_appstream.types.list_associated_stacks_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.list_associated_stacks_request.ListAssociatedStacksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
