"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeSoftwareAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_software_associations_result.DescribeSoftwareAssociationsResult = aws_sdk_appstream.types.describe_software_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_software_associations_request.DescribeSoftwareAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.DescribeSoftwareAssociations"
    import aws_sdk_appstream.types.describe_software_associations_request

    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_software_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_software_associations(
