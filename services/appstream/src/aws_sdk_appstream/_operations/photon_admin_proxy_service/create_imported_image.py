...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DryRunOperationException":
            import aws_sdk_appstream.errors.dry_run_operation_exception

            raise aws_sdk_appstream.errors.dry_run_operation_exception.DryRunOperationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.create_imported_image_result.CreateImportedImageResult = aws_sdk_appstream.types.create_imported_image_result.deserialize_aws_json_1_1(
