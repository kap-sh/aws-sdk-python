"""Generated from Smithy shape ``com.amazonaws.appstream#AssociateApplicationFleet``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.associate_application_fleet_result.AssociateApplicationFleetResult = aws_sdk_appstream.types.associate_application_fleet_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.associate_application_fleet_request.AssociateApplicationFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.AssociateApplicationFleet"
    import aws_sdk_appstream.types.associate_application_fleet_request

    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.associate_application_fleet_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_application_fleet(
