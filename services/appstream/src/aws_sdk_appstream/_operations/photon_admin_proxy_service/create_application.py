"""Generated from Smithy shape ``com.amazonaws.appstream#CreateApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.create_application_result.CreateApplicationResult = (
        aws_sdk_appstream.types.create_application_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_appstream.types.create_application_request.CreateApplicationRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.CreateApplication"
    import aws_sdk_appstream.types.create_application_request

    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.create_application_request.serialize_aws_json_1_1(input)
    ).encode()
