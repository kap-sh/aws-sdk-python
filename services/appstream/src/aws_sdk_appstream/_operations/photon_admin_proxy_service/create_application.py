...
def build_request(
    ...
    input_: aws_sdk_appstream.types.create_application_request.CreateApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.create_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
