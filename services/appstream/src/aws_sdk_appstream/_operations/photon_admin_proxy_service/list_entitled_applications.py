...
def handle_response(
    ...
    out: aws_sdk_appstream.types.list_entitled_applications_result.ListEntitledApplicationsResult = aws_sdk_appstream.types.list_entitled_applications_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.list_entitled_applications_request.ListEntitledApplicationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.list_entitled_applications_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
