...
def handle_response(
    ...
    out: aws_sdk_appstream.types.create_export_image_task_result.CreateExportImageTaskResult = aws_sdk_appstream.types.create_export_image_task_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.create_export_image_task_request.CreateExportImageTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.create_export_image_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
