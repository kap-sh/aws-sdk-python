...
def handle_response(
    ...
    out: aws_sdk_appstream.types.disassociate_app_block_builder_app_block_result.DisassociateAppBlockBuilderAppBlockResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.disassociate_app_block_builder_app_block_request.DisassociateAppBlockBuilderAppBlockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
