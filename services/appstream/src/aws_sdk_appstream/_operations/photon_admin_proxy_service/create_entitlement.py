...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "EntitlementAlreadyExistsException":
            import aws_sdk_appstream.errors.entitlement_already_exists_exception

            raise aws_sdk_appstream.errors.entitlement_already_exists_exception.EntitlementAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.create_entitlement_result.CreateEntitlementResult = (
        aws_sdk_appstream.types.create_entitlement_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_appstream.types.create_entitlement_request.CreateEntitlementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.create_entitlement_request.serialize_aws_json_1_1(input)
    ).encode()
