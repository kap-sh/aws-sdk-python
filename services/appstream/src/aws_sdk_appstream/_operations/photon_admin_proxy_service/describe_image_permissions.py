"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeImagePermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_image_permissions_result.DescribeImagePermissionsResult = aws_sdk_appstream.types.describe_image_permissions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_image_permissions_request.DescribeImagePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_image_permissions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_image_permissions(
