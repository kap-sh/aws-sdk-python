"""Generated from Smithy shape ``com.amazonaws.appstream#EnableUser``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.enable_user_result.EnableUserResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.enable_user_request.EnableUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.enable_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def enable_user(
    ...
    aws_sdk_appstream.types.enable_user_result.EnableUserResult, zapros.Response
]:
