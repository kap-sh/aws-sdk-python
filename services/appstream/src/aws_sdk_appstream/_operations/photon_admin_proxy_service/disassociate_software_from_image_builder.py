...
def handle_response(
    ...
    out: aws_sdk_appstream.types.disassociate_software_from_image_builder_result.DisassociateSoftwareFromImageBuilderResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.disassociate_software_from_image_builder_request.DisassociateSoftwareFromImageBuilderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.disassociate_software_from_image_builder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
