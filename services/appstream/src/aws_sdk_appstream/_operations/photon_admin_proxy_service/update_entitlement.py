...
def handle_response(
    ...
    out: aws_sdk_appstream.types.update_entitlement_result.UpdateEntitlementResult = (
        aws_sdk_appstream.types.update_entitlement_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_appstream.types.update_entitlement_request.UpdateEntitlementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.update_entitlement_request.serialize_aws_json_1_1(input)
    ).encode()
