...
def handle_response(
    ...
    out: aws_sdk_appstream.types.disassociate_application_from_entitlement_result.DisassociateApplicationFromEntitlementResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.disassociate_application_from_entitlement_request.DisassociateApplicationFromEntitlementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
