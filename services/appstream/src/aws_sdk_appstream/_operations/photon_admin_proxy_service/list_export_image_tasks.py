...
def handle_response(
    ...
    out: aws_sdk_appstream.types.list_export_image_tasks_result.ListExportImageTasksResult = aws_sdk_appstream.types.list_export_image_tasks_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.list_export_image_tasks_request.ListExportImageTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.list_export_image_tasks_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
