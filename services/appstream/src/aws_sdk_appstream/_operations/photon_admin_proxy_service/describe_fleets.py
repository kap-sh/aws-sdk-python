...
def build_request(
    ...
    input: aws_sdk_appstream.types.describe_fleets_request.DescribeFleetsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_fleets_request.serialize_aws_json_1_1(input)
    ).encode()
