...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_fleets_result.DescribeFleetsResult = (
        aws_sdk_appstream.types.describe_fleets_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_fleets_request.DescribeFleetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_fleets_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_fleets(
    ...
    aws_sdk_appstream.types.describe_fleets_result.DescribeFleetsResult, zapros.Response
]:
