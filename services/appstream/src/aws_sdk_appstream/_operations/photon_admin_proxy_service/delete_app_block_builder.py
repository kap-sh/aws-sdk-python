...
def handle_response(
    ...
    out: aws_sdk_appstream.types.delete_app_block_builder_result.DeleteAppBlockBuilderResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.delete_app_block_builder_request.DeleteAppBlockBuilderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.delete_app_block_builder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
