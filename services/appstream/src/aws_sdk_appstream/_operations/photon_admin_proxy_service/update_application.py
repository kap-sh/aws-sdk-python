...
def handle_response(
    ...
    out: aws_sdk_appstream.types.update_application_result.UpdateApplicationResult = (
        aws_sdk_appstream.types.update_application_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_appstream.types.update_application_request.UpdateApplicationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.update_application_request.serialize_aws_json_1_1(input)
    ).encode()
