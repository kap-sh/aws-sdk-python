...
def build_request(
    ...
    input_: aws_sdk_appstream.types.update_application_request.UpdateApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.update_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
