...
def handle_response(
    ...
    out: aws_sdk_appstream.types.start_app_block_builder_result.StartAppBlockBuilderResult = aws_sdk_appstream.types.start_app_block_builder_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.start_app_block_builder_request.StartAppBlockBuilderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.start_app_block_builder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
