...
def handle_response(
    ...
    out: aws_sdk_appstream.types.associate_application_to_entitlement_result.AssociateApplicationToEntitlementResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.associate_application_to_entitlement_request.AssociateApplicationToEntitlementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.associate_application_to_entitlement_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
