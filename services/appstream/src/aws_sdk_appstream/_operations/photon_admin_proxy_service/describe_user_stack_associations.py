...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_user_stack_associations_result.DescribeUserStackAssociationsResult = aws_sdk_appstream.types.describe_user_stack_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_user_stack_associations_request.DescribeUserStackAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_user_stack_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
