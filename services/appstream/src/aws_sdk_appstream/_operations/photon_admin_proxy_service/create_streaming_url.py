...
def handle_response(
    ...
    out: aws_sdk_appstream.types.create_streaming_url_result.CreateStreamingURLResult = aws_sdk_appstream.types.create_streaming_url_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.create_streaming_url_request.CreateStreamingURLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.create_streaming_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
