...
def handle_response(
    ...
    out: aws_sdk_appstream.types.stop_fleet_result.StopFleetResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.stop_fleet_request.StopFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.stop_fleet_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_fleet(
    ...
    input_: aws_sdk_appstream.types.stop_fleet_request.StopFleetRequest,
) -> tuple[aws_sdk_appstream.types.stop_fleet_result.StopFleetResult, zapros.Response]:
