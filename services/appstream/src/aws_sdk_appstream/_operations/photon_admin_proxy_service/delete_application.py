...
def handle_response(
    ...
    out: aws_sdk_appstream.types.delete_application_result.DeleteApplicationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_appstream.types.delete_application_request.DeleteApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.delete_application_request.serialize_aws_json_1_1(input)
    ).encode()
