...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_image_builders_result.DescribeImageBuildersResult = aws_sdk_appstream.types.describe_image_builders_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_image_builders_request.DescribeImageBuildersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_image_builders_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
