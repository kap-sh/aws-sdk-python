...
def handle_response(
    ...
    out: aws_sdk_appstream.types.stop_app_block_builder_result.StopAppBlockBuilderResult = aws_sdk_appstream.types.stop_app_block_builder_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.stop_app_block_builder_request.StopAppBlockBuilderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.stop_app_block_builder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
