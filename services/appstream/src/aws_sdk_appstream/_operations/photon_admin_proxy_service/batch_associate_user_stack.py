...
def handle_response(
    ...
    out: aws_sdk_appstream.types.batch_associate_user_stack_result.BatchAssociateUserStackResult = aws_sdk_appstream.types.batch_associate_user_stack_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.batch_associate_user_stack_request.BatchAssociateUserStackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.batch_associate_user_stack_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
