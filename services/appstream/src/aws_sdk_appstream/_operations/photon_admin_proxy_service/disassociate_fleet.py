...
def handle_response(
    ...
    out: aws_sdk_appstream.types.disassociate_fleet_result.DisassociateFleetResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_appstream.types.disassociate_fleet_request.DisassociateFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.disassociate_fleet_request.serialize_aws_json_1_1(input)
    ).encode()
