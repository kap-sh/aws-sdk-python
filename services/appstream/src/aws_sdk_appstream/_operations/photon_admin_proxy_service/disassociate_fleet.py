...
def build_request(
    ...
    input_: aws_sdk_appstream.types.disassociate_fleet_request.DisassociateFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.disassociate_fleet_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
