...
def handle_response(
    ...
    out: aws_sdk_appstream.types.disable_user_result.DisableUserResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.disable_user_request.DisableUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.disable_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def disable_user(
    ...
    aws_sdk_appstream.types.disable_user_result.DisableUserResult, zapros.Response
]:
