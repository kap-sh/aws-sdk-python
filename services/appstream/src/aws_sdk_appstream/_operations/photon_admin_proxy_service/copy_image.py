...
def handle_response(
    ...
    out: aws_sdk_appstream.types.copy_image_response.CopyImageResponse = (
        aws_sdk_appstream.types.copy_image_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.copy_image_request.CopyImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.copy_image_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def copy_image(
    ...
    aws_sdk_appstream.types.copy_image_response.CopyImageResponse, zapros.Response
]:
