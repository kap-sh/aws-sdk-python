"""Generated from Smithy shape ``com.amazonaws.appstream#UpdateFleet``."""
...
import aws_sdk_appstream.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise aws_sdk_appstream.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.update_fleet_result.UpdateFleetResult = (
        aws_sdk_appstream.types.update_fleet_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.update_fleet_request.UpdateFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.update_fleet_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_fleet(
    ...
    aws_sdk_appstream.types.update_fleet_result.UpdateFleetResult, zapros.Response
]:
