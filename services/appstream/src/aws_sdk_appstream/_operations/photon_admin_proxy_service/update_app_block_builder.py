...
def handle_response(
    ...
    out: aws_sdk_appstream.types.update_app_block_builder_result.UpdateAppBlockBuilderResult = aws_sdk_appstream.types.update_app_block_builder_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.update_app_block_builder_request.UpdateAppBlockBuilderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.update_app_block_builder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
