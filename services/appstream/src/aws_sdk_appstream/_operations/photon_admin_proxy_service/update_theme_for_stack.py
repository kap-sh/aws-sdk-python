...
def handle_response(
    ...
    out: aws_sdk_appstream.types.update_theme_for_stack_result.UpdateThemeForStackResult = aws_sdk_appstream.types.update_theme_for_stack_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.update_theme_for_stack_request.UpdateThemeForStackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.update_theme_for_stack_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
