"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeUsageReportSubscriptions``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_usage_report_subscriptions_result.DescribeUsageReportSubscriptionsResult = aws_sdk_appstream.types.describe_usage_report_subscriptions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_usage_report_subscriptions_request.DescribeUsageReportSubscriptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_usage_report_subscriptions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_usage_report_subscriptions(
