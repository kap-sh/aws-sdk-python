...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_app_license_usage_result.DescribeAppLicenseUsageResult = aws_sdk_appstream.types.describe_app_license_usage_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_app_license_usage_request.DescribeAppLicenseUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_app_license_usage_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
