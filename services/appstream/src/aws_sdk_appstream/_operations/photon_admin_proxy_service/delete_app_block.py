...
def build_request(
    ...
    input: aws_sdk_appstream.types.delete_app_block_request.DeleteAppBlockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.delete_app_block_request.serialize_aws_json_1_1(input)
    ).encode()
