"""Generated from Smithy shape ``com.amazonaws.appstream#StartFleet``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.start_fleet_result.StartFleetResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.start_fleet_request.StartFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.start_fleet_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_fleet(
    ...
    aws_sdk_appstream.types.start_fleet_result.StartFleetResult, zapros.Response
]:
