"""Generated from Smithy shape ``com.amazonaws.appstream#GetExportImageTask``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.get_export_image_task_result.GetExportImageTaskResult = aws_sdk_appstream.types.get_export_image_task_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.get_export_image_task_request.GetExportImageTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.GetExportImageTask"
    import aws_sdk_appstream.types.get_export_image_task_request

    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.get_export_image_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_export_image_task(
