"""Generated from Smithy shape ``com.amazonaws.appstream#DeleteImageBuilder``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.delete_image_builder_result.DeleteImageBuilderResult = aws_sdk_appstream.types.delete_image_builder_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.delete_image_builder_request.DeleteImageBuilderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.delete_image_builder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_image_builder(
