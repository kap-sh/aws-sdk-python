"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeThemeForStack``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_theme_for_stack_result.DescribeThemeForStackResult = aws_sdk_appstream.types.describe_theme_for_stack_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_theme_for_stack_request.DescribeThemeForStackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.DescribeThemeForStack"
    import aws_sdk_appstream.types.describe_theme_for_stack_request

    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_theme_for_stack_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_theme_for_stack(
