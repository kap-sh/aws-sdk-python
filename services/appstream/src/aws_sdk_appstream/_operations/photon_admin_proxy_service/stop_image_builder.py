...
def handle_response(
    ...
    out: aws_sdk_appstream.types.stop_image_builder_result.StopImageBuilderResult = (
        aws_sdk_appstream.types.stop_image_builder_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_appstream.types.stop_image_builder_request.StopImageBuilderRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.stop_image_builder_request.serialize_aws_json_1_1(input)
    ).encode()
