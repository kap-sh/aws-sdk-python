...
def build_request(
    ...
    input_: aws_sdk_appstream.types.create_app_block_builder_request.CreateAppBlockBuilderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.create_app_block_builder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
