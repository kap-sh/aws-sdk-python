"""Generated from Smithy shape ``com.amazonaws.appstream#ListAssociatedFleets``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.list_associated_fleets_result.ListAssociatedFleetsResult = aws_sdk_appstream.types.list_associated_fleets_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.list_associated_fleets_request.ListAssociatedFleetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.list_associated_fleets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_associated_fleets(
