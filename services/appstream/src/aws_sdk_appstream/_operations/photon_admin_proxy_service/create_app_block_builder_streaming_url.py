"""Generated from Smithy shape ``com.amazonaws.appstream#CreateAppBlockBuilderStreamingURL``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.create_app_block_builder_streaming_url_result.CreateAppBlockBuilderStreamingURLResult = aws_sdk_appstream.types.create_app_block_builder_streaming_url_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.create_app_block_builder_streaming_url_request.CreateAppBlockBuilderStreamingURLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_app_block_builder_streaming_url(
