"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeEntitlements``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "EntitlementNotFoundException":
            import aws_sdk_appstream.errors.entitlement_not_found_exception

            raise aws_sdk_appstream.errors.entitlement_not_found_exception.EntitlementNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_entitlements_result.DescribeEntitlementsResult = aws_sdk_appstream.types.describe_entitlements_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_entitlements_request.DescribeEntitlementsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.DescribeEntitlements"
    import aws_sdk_appstream.types.describe_entitlements_request

    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_entitlements_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_entitlements(
