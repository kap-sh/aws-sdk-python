...
def handle_response(
    ...
    out: aws_sdk_appstream.types.associate_app_block_builder_app_block_result.AssociateAppBlockBuilderAppBlockResult = aws_sdk_appstream.types.associate_app_block_builder_app_block_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.associate_app_block_builder_app_block_request.AssociateAppBlockBuilderAppBlockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.associate_app_block_builder_app_block_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
