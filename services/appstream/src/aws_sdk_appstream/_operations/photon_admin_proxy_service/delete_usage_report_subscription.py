"""Generated from Smithy shape ``com.amazonaws.appstream#DeleteUsageReportSubscription``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.delete_usage_report_subscription_result.DeleteUsageReportSubscriptionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.delete_usage_report_subscription_request.DeleteUsageReportSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_usage_report_subscription(
