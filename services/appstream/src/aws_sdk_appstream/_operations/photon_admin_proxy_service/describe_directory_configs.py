"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeDirectoryConfigs``."""
...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_directory_configs_result.DescribeDirectoryConfigsResult = aws_sdk_appstream.types.describe_directory_configs_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_directory_configs_request.DescribeDirectoryConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_directory_configs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_directory_configs(
