...
def handle_response(
    ...
    out: aws_sdk_appstream.types.create_image_builder_streaming_url_result.CreateImageBuilderStreamingURLResult = aws_sdk_appstream.types.create_image_builder_streaming_url_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.create_image_builder_streaming_url_request.CreateImageBuilderStreamingURLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.create_image_builder_streaming_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
