...
def handle_response(
    ...
    out: aws_sdk_appstream.types.update_stack_result.UpdateStackResult = (
        aws_sdk_appstream.types.update_stack_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.update_stack_request.UpdateStackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.update_stack_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_stack(
    ...
    aws_sdk_appstream.types.update_stack_result.UpdateStackResult, zapros.Response
]:
