...
def handle_response(
    ...
    out: aws_sdk_appstream.types.describe_application_fleet_associations_result.DescribeApplicationFleetAssociationsResult = aws_sdk_appstream.types.describe_application_fleet_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.describe_application_fleet_associations_request.DescribeApplicationFleetAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.describe_application_fleet_associations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
