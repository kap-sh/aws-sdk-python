...
def handle_response(
    ...
    out: aws_sdk_appstream.types.create_directory_config_result.CreateDirectoryConfigResult = aws_sdk_appstream.types.create_directory_config_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_appstream.types.create_directory_config_request.CreateDirectoryConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.create_directory_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
