...
def build_request(
    ...
    input: aws_sdk_appstream.types.create_app_block_request.CreateAppBlockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appstream.types.create_app_block_request.serialize_aws_json_1_1(input)
    ).encode()
