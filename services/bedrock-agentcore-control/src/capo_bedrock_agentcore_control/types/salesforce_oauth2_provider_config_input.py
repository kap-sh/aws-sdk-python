"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#SalesforceOauth2ProviderConfigInput``."""
...
class SalesforceOauth2ProviderConfigInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: SalesforceOauth2ProviderConfigInput) -> dict:
    out: dict = {}
