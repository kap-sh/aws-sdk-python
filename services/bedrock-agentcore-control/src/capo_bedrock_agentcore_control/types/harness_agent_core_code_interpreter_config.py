...
if TYPE_CHECKING:
    import capo_bedrock_agentcore_control.types.harness_code_interpreter_arn


class HarnessAgentCoreCodeInterpreterConfig(TypedDict, closed=True):
    code_interpreter_arn: NotRequired[
        "capo_bedrock_agentcore_control.types.harness_code_interpreter_arn.HarnessCodeInterpreterArn"
    ]
