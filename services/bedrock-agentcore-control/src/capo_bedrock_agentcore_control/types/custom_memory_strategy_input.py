...
if TYPE_CHECKING:
    import capo_bedrock_agentcore_control.types.custom_configuration_input
...
class CustomMemoryStrategyInput(TypedDict, closed=True):
    ...
    configuration: NotRequired[
        "capo_bedrock_agentcore_control.types.custom_configuration_input.CustomConfigurationInput"
    ]
...
def serialize_json(value: CustomMemoryStrategyInput) -> dict:
    ...
    if "configuration" in value:
        ...
        out["configuration"] = (
            capo_bedrock_agentcore_control.types.custom_configuration_input.serialize_json(
                value["configuration"]
            )
        )
...
def deserialize_json(data: dict) -> CustomMemoryStrategyInput:
    ...
    if data.get("configuration") is not None:
        ...
        out["configuration"] = (
            capo_bedrock_agentcore_control.types.custom_configuration_input.deserialize_json(
                data["configuration"]
            )
        )
