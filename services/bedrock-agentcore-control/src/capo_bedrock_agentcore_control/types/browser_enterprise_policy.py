...
class BrowserEnterprisePolicy(TypedDict, closed=True):
    location: "capo_bedrock_agentcore_control.types.resource_location.ResourceLocation"
    """<p>The location of the enterprise policy file.</p>"""
    type: NotRequired[
        "capo_bedrock_agentcore_control.types.browser_enterprise_policy_type.BrowserEnterprisePolicyType"
    ]
...
def serialize_json(value: BrowserEnterprisePolicy) -> dict:
    ...
    out["location"] = (
        capo_bedrock_agentcore_control.types.resource_location.serialize_json(
            value["location"]
        )
    )
    if "type" in value:
        ...
        out["type"] = (
            capo_bedrock_agentcore_control.types.browser_enterprise_policy_type.serialize_json(
                value["type"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> BrowserEnterprisePolicy:
    ...
    if data.get("location") is not None:
        ...
        out["location"] = (
            capo_bedrock_agentcore_control.types.resource_location.deserialize_json(
                data["location"]
            )
        )
    else:
    ...
    if data.get("type") is not None:
        ...
        out["type"] = (
            capo_bedrock_agentcore_control.types.browser_enterprise_policy_type.deserialize_json(
                data["type"]
            )
        )
    return out
