...
class RegistryRecordCredentialProviderConfiguration(TypedDict, closed=True):
    credential_provider_type: "capo_bedrock_agentcore_control.types.registry_record_credential_provider_type.RegistryRecordCredentialProviderType"
    ...
    credential_provider: "capo_bedrock_agentcore_control.types.registry_record_credential_provider_union.RegistryRecordCredentialProviderUnion"
...
def serialize_json(value: RegistryRecordCredentialProviderConfiguration) -> dict:
    ...
    out["credentialProviderType"] = (
        capo_bedrock_agentcore_control.types.registry_record_credential_provider_type.serialize_json(
    ...
    out["credentialProvider"] = (
        capo_bedrock_agentcore_control.types.registry_record_credential_provider_union.serialize_json(
...
def deserialize_json(data: dict) -> RegistryRecordCredentialProviderConfiguration:
    ...
    if "credentialProviderType" in data:
        ...
        out["credential_provider_type"] = (
            capo_bedrock_agentcore_control.types.registry_record_credential_provider_type.deserialize_json(
    ...
    if "credentialProvider" in data:
        ...
        out["credential_provider"] = (
            capo_bedrock_agentcore_control.types.registry_record_credential_provider_union.deserialize_json(
