"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#SlackOauth2ProviderConfigInput``."""
...
class SlackOauth2ProviderConfigInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: SlackOauth2ProviderConfigInput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> SlackOauth2ProviderConfigInput:
    out: SlackOauth2ProviderConfigInput = {}  # type: ignore[typeddict-item]
    if data.get("clientId") is not None:
        out["client_id"] = data["clientId"]
    else:
        raise DeserializationError("SlackOauth2ProviderConfigInput.client_id required")
