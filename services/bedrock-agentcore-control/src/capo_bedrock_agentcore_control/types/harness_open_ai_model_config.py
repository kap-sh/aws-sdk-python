...
if TYPE_CHECKING:
    ...
    import capo_bedrock_agentcore_control.types.harness_open_ai_api_format
...
class HarnessOpenAiModelConfig(TypedDict, closed=True):
    ...
    api_format: NotRequired[
        "capo_bedrock_agentcore_control.types.harness_open_ai_api_format.HarnessOpenAiApiFormat"
    ]
...
def serialize_json(value: HarnessOpenAiModelConfig) -> dict:
    ...
    if "api_format" in value:
        ...
        out["apiFormat"] = (
            capo_bedrock_agentcore_control.types.harness_open_ai_api_format.serialize_json(
                value["api_format"]
            )
        )
...
def deserialize_json(data: dict) -> HarnessOpenAiModelConfig:
    ...
    if "apiFormat" in data:
        ...
        out["api_format"] = (
            capo_bedrock_agentcore_control.types.harness_open_ai_api_format.deserialize_json(
                data["apiFormat"]
            )
        )
