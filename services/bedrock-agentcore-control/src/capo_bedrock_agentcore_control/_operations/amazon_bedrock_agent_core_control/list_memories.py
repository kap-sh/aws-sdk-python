...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_memories_output.ListMemoriesOutput = capo_bedrock_agentcore_control.types.list_memories_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.list_memories_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
