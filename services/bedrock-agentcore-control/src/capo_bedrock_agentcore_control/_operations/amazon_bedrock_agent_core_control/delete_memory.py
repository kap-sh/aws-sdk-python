...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_memory_output.DeleteMemoryOutput = capo_bedrock_agentcore_control.types.delete_memory_output.deserialize_json(
