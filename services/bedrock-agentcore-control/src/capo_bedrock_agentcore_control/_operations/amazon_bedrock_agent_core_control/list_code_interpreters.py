...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_code_interpreters_response.ListCodeInterpretersResponse = capo_bedrock_agentcore_control.types.list_code_interpreters_response.deserialize_json(
...
def build_request(
    ...
    if "type" in input_:
        params.append(
            (
                "type",
                capo_bedrock_agentcore_control.types.resource_type.serialize_json(
                    input_["type"]
                ),
            )
        )
