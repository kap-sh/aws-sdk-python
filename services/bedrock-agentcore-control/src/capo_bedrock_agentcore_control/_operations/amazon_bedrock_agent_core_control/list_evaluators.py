...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_evaluators_response.ListEvaluatorsResponse = capo_bedrock_agentcore_control.types.list_evaluators_response.deserialize_json(
