"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#GetPaymentManager``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_payment_manager_response.GetPaymentManagerResponse = capo_bedrock_agentcore_control.types.get_payment_manager_response.deserialize_json(
...
async def async_get_payment_manager(
