...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_browser_profile_response.DeleteBrowserProfileResponse = capo_bedrock_agentcore_control.types.delete_browser_profile_response.deserialize_json(
