...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_policy_summaries_response.ListPolicySummariesResponse = capo_bedrock_agentcore_control.types.list_policy_summaries_response.deserialize_json(
