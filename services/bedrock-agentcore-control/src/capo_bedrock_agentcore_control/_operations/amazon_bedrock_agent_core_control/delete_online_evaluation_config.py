"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#DeleteOnlineEvaluationConfig``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_online_evaluation_config_response.DeleteOnlineEvaluationConfigResponse = capo_bedrock_agentcore_control.types.delete_online_evaluation_config_response.deserialize_json(
...
async def async_delete_online_evaluation_config(
