...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_gateway_response.DeleteGatewayResponse = capo_bedrock_agentcore_control.types.delete_gateway_response.deserialize_json(
