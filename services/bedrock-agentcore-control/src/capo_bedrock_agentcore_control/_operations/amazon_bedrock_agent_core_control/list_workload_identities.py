...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_workload_identities_response.ListWorkloadIdentitiesResponse = capo_bedrock_agentcore_control.types.list_workload_identities_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.list_workload_identities_request.serialize_json(
            input_
        )
    ).encode()
