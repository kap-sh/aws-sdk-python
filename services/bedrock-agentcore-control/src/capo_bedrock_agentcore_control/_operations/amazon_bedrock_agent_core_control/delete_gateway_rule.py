...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_gateway_rule_response.DeleteGatewayRuleResponse = capo_bedrock_agentcore_control.types.delete_gateway_rule_response.deserialize_json(
