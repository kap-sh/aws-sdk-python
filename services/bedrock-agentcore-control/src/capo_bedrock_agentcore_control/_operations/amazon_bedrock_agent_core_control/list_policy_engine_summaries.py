...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_policy_engine_summaries_response.ListPolicyEngineSummariesResponse = capo_bedrock_agentcore_control.types.list_policy_engine_summaries_response.deserialize_json(
