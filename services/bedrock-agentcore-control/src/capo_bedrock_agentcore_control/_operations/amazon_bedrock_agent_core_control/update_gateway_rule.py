...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.update_gateway_rule_response.UpdateGatewayRuleResponse = capo_bedrock_agentcore_control.types.update_gateway_rule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.update_gateway_rule_request.serialize_json(
            input_
        )
    ).encode()
