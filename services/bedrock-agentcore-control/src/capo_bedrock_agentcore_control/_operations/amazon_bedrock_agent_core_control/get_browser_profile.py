...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_browser_profile_response.GetBrowserProfileResponse = capo_bedrock_agentcore_control.types.get_browser_profile_response.deserialize_json(
