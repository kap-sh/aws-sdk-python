...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_browser_response.DeleteBrowserResponse = capo_bedrock_agentcore_control.types.delete_browser_response.deserialize_json(
