...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_payment_managers_response.ListPaymentManagersResponse = capo_bedrock_agentcore_control.types.list_payment_managers_response.deserialize_json(
