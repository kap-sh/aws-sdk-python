"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#DeleteDataset``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_dataset_response.DeleteDatasetResponse = capo_bedrock_agentcore_control.types.delete_dataset_response.deserialize_json(
