...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.update_agent_runtime_response.UpdateAgentRuntimeResponse = capo_bedrock_agentcore_control.types.update_agent_runtime_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.update_agent_runtime_request.serialize_json(
            input_
        )
    ).encode()
