...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_agent_runtime_endpoint_response.DeleteAgentRuntimeEndpointResponse = capo_bedrock_agentcore_control.types.delete_agent_runtime_endpoint_response.deserialize_json(
