...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_registry_records_response.ListRegistryRecordsResponse = capo_bedrock_agentcore_control.types.list_registry_records_response.deserialize_json(
