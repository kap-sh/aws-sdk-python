...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_policy_summary_response.GetPolicySummaryResponse = capo_bedrock_agentcore_control.types.get_policy_summary_response.deserialize_json(
