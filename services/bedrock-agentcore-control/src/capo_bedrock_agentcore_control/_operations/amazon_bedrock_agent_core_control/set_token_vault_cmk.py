"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#SetTokenVaultCMK``."""
...
import capo_bedrock_agentcore_control.errors.concurrent_modification_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConcurrentModificationException":
            raise capo_bedrock_agentcore_control.errors.concurrent_modification_exception.ConcurrentModificationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.set_token_vault_cmk_response.SetTokenVaultCMKResponse = capo_bedrock_agentcore_control.types.set_token_vault_cmk_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.set_token_vault_cmk_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_set_token_vault_cmk(
