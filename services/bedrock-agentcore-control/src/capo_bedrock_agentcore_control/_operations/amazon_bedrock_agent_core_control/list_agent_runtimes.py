"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#ListAgentRuntimes``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_agent_runtimes_response.ListAgentRuntimesResponse = capo_bedrock_agentcore_control.types.list_agent_runtimes_response.deserialize_json(
...
async def async_list_agent_runtimes(
