...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_token_vault_response.GetTokenVaultResponse = capo_bedrock_agentcore_control.types.get_token_vault_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.get_token_vault_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
