...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_agent_runtime_endpoint_response.GetAgentRuntimeEndpointResponse = capo_bedrock_agentcore_control.types.get_agent_runtime_endpoint_response.deserialize_json(
