...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_dataset_response.GetDatasetResponse = capo_bedrock_agentcore_control.types.get_dataset_response.deserialize_json(
