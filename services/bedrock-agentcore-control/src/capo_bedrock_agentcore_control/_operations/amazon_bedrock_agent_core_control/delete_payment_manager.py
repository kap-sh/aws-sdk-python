"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#DeletePaymentManager``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_payment_manager_response.DeletePaymentManagerResponse = capo_bedrock_agentcore_control.types.delete_payment_manager_response.deserialize_json(
...
async def async_delete_payment_manager(
