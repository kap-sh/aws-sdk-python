"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#DeleteAgentRuntime``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_agent_runtime_response.DeleteAgentRuntimeResponse = capo_bedrock_agentcore_control.types.delete_agent_runtime_response.deserialize_json(
...
async def async_delete_agent_runtime(
