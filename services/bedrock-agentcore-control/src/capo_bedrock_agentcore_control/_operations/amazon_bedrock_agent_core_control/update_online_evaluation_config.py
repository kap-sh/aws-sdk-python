"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#UpdateOnlineEvaluationConfig``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.update_online_evaluation_config_response.UpdateOnlineEvaluationConfigResponse = capo_bedrock_agentcore_control.types.update_online_evaluation_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.update_online_evaluation_config_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_online_evaluation_config(
