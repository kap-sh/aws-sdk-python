...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_resource_policy_response.GetResourcePolicyResponse = capo_bedrock_agentcore_control.types.get_resource_policy_response.deserialize_json(
