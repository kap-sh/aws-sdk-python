...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_registries_response.ListRegistriesResponse = capo_bedrock_agentcore_control.types.list_registries_response.deserialize_json(
...
def build_request(
    ...
    if "status" in input_:
        params.append(
            (
                "status",
                capo_bedrock_agentcore_control.types.registry_status.serialize_json(
                    input_["status"]
                ),
            )
        )
