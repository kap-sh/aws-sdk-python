...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_harness_response.GetHarnessResponse = capo_bedrock_agentcore_control.types.get_harness_response.deserialize_json(
