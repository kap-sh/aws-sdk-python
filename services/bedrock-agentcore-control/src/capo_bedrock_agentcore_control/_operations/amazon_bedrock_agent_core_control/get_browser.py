"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#GetBrowser``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_browser_response.GetBrowserResponse = capo_bedrock_agentcore_control.types.get_browser_response.deserialize_json(
