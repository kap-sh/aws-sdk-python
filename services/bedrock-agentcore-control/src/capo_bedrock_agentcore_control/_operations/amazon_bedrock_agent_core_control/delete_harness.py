"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#DeleteHarness``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_harness_response.DeleteHarnessResponse = capo_bedrock_agentcore_control.types.delete_harness_response.deserialize_json(
...
async def async_delete_harness(
