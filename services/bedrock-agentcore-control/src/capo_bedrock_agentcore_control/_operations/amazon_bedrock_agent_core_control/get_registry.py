...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_registry_response.GetRegistryResponse = capo_bedrock_agentcore_control.types.get_registry_response.deserialize_json(
