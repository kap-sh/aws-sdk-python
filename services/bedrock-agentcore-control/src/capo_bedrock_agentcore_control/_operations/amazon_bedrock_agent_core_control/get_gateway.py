...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_gateway_response.GetGatewayResponse = capo_bedrock_agentcore_control.types.get_gateway_response.deserialize_json(
