...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_code_interpreter_response.DeleteCodeInterpreterResponse = capo_bedrock_agentcore_control.types.delete_code_interpreter_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{codeInterpreterId}", quote(input_["code_interpreter_id"], safe="")
    )
