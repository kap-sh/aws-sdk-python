...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_code_interpreter_response.GetCodeInterpreterResponse = capo_bedrock_agentcore_control.types.get_code_interpreter_response.deserialize_json(
