...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_dataset_examples_response.ListDatasetExamplesResponse = capo_bedrock_agentcore_control.types.list_dataset_examples_response.deserialize_json(
