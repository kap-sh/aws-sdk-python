...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.update_payment_connector_response.UpdatePaymentConnectorResponse = capo_bedrock_agentcore_control.types.update_payment_connector_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.update_payment_connector_request.serialize_json(
            input_
        )
    ).encode()
