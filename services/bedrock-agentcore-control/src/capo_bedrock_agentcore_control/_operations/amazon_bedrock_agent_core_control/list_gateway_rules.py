...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_gateway_rules_response.ListGatewayRulesResponse = capo_bedrock_agentcore_control.types.list_gateway_rules_response.deserialize_json(
