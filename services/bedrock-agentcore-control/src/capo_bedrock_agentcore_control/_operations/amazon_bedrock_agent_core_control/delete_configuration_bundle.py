...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_configuration_bundle_response.DeleteConfigurationBundleResponse = capo_bedrock_agentcore_control.types.delete_configuration_bundle_response.deserialize_json(
