"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#DeleteGatewayTarget``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_gateway_target_response.DeleteGatewayTargetResponse = capo_bedrock_agentcore_control.types.delete_gateway_target_response.deserialize_json(
...
async def async_delete_gateway_target(
