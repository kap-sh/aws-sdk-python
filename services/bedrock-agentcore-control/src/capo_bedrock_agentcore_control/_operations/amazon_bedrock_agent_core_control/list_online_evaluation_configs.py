...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_online_evaluation_configs_response.ListOnlineEvaluationConfigsResponse = capo_bedrock_agentcore_control.types.list_online_evaluation_configs_response.deserialize_json(
