...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_browsers_response.ListBrowsersResponse = capo_bedrock_agentcore_control.types.list_browsers_response.deserialize_json(
