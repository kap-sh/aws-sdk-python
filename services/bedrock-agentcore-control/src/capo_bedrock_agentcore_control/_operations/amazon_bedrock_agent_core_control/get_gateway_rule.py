...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_gateway_rule_response.GetGatewayRuleResponse = capo_bedrock_agentcore_control.types.get_gateway_rule_response.deserialize_json(
