"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#GetPolicyGeneration``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_policy_generation_response.GetPolicyGenerationResponse = capo_bedrock_agentcore_control.types.get_policy_generation_response.deserialize_json(
...
async def async_get_policy_generation(
