...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_payment_connector_response.DeletePaymentConnectorResponse = capo_bedrock_agentcore_control.types.delete_payment_connector_response.deserialize_json(
