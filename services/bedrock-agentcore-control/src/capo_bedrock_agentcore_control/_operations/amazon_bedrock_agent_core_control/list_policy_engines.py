...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_policy_engines_response.ListPolicyEnginesResponse = capo_bedrock_agentcore_control.types.list_policy_engines_response.deserialize_json(
