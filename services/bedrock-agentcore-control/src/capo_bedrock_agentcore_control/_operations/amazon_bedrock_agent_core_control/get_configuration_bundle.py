"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#GetConfigurationBundle``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_configuration_bundle_response.GetConfigurationBundleResponse = capo_bedrock_agentcore_control.types.get_configuration_bundle_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "branch_name" in input_:
        params["branchName"] = str(input_["branch_name"])
...
async def async_get_configuration_bundle(
