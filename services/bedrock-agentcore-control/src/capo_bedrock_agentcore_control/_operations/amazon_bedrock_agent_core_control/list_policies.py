"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#ListPolicies``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_policies_response.ListPoliciesResponse = capo_bedrock_agentcore_control.types.list_policies_response.deserialize_json(
...
def build_request(
    ...
    if "target_resource_scope" in input_:
        params.append(("targetResourceScope", input_["target_resource_scope"]))
