...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_policy_generation_assets_response.ListPolicyGenerationAssetsResponse = capo_bedrock_agentcore_control.types.list_policy_generation_assets_response.deserialize_json(
