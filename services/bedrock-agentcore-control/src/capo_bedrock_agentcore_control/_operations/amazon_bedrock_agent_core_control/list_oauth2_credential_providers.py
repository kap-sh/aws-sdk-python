...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_oauth2_credential_providers_response.ListOauth2CredentialProvidersResponse = capo_bedrock_agentcore_control.types.list_oauth2_credential_providers_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.list_oauth2_credential_providers_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
