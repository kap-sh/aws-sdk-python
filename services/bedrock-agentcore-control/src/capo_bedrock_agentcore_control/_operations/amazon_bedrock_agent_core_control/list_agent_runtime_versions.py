...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_agent_runtime_versions_response.ListAgentRuntimeVersionsResponse = capo_bedrock_agentcore_control.types.list_agent_runtime_versions_response.deserialize_json(
