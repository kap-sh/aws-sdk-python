...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.create_dataset_response.CreateDatasetResponse = capo_bedrock_agentcore_control.types.create_dataset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.create_dataset_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
