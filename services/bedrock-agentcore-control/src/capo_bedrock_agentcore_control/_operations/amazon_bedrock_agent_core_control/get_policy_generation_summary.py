"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#GetPolicyGenerationSummary``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_policy_generation_summary_response.GetPolicyGenerationSummaryResponse = capo_bedrock_agentcore_control.types.get_policy_generation_summary_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/policy-engines/{policyEngineId}/policy-generation-summaries/{policyGenerationId}"
    )
    url = url.replace(
...
async def async_get_policy_generation_summary(
