...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_gateway_target_response.GetGatewayTargetResponse = capo_bedrock_agentcore_control.types.get_gateway_target_response.deserialize_json(
