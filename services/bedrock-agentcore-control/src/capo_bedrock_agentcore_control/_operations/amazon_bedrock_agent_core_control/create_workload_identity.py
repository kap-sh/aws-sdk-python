...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.create_workload_identity_response.CreateWorkloadIdentityResponse = capo_bedrock_agentcore_control.types.create_workload_identity_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.create_workload_identity_request.serialize_json(
            input_
        )
    ).encode()
