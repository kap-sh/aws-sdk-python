"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#TagResource``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.tag_resource_request.serialize_json(input_)
    ).encode()
