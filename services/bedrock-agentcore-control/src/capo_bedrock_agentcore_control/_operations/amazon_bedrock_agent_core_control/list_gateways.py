"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#ListGateways``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_gateways_response.ListGatewaysResponse = capo_bedrock_agentcore_control.types.list_gateways_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/gateways/"
