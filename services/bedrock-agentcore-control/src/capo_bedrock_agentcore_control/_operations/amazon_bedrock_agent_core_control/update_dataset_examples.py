...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.update_dataset_examples_response.UpdateDatasetExamplesResponse = capo_bedrock_agentcore_control.types.update_dataset_examples_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.update_dataset_examples_request.serialize_json(
            input_
        )
    ).encode()
