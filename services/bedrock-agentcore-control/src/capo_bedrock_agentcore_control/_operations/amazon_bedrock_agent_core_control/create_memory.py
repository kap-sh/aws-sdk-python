...
import capo_bedrock_agentcore_control.errors.throttled_exception
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.create_memory_output.CreateMemoryOutput = capo_bedrock_agentcore_control.types.create_memory_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.create_memory_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
