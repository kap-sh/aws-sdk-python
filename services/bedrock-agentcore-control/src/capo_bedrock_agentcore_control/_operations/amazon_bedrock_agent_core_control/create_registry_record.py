...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.create_registry_record_response.CreateRegistryRecordResponse = capo_bedrock_agentcore_control.types.create_registry_record_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.create_registry_record_request.serialize_json(
            input_
        )
    ).encode()
