"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#CreatePolicyEngine``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.create_policy_engine_response.CreatePolicyEngineResponse = capo_bedrock_agentcore_control.types.create_policy_engine_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.create_policy_engine_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_policy_engine(
