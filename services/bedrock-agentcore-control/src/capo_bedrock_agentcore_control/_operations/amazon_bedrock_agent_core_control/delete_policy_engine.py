"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#DeletePolicyEngine``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_policy_engine_response.DeletePolicyEngineResponse = capo_bedrock_agentcore_control.types.delete_policy_engine_response.deserialize_json(
...
async def async_delete_policy_engine(
