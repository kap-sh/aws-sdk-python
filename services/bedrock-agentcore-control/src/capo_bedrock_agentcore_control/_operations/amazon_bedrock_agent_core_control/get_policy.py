...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_policy_response.GetPolicyResponse = (
        capo_bedrock_agentcore_control.types.get_policy_response.deserialize_json(
