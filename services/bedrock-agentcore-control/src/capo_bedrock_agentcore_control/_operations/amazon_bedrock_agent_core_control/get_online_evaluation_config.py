...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_online_evaluation_config_response.GetOnlineEvaluationConfigResponse = capo_bedrock_agentcore_control.types.get_online_evaluation_config_response.deserialize_json(
