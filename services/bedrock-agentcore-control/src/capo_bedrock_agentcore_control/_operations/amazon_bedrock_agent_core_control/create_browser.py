"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#CreateBrowser``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.create_browser_response.CreateBrowserResponse = capo_bedrock_agentcore_control.types.create_browser_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.create_browser_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
