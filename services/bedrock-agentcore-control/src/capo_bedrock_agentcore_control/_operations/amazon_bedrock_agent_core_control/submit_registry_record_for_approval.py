...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.submit_registry_record_for_approval_response.SubmitRegistryRecordForApprovalResponse = capo_bedrock_agentcore_control.types.submit_registry_record_for_approval_response.deserialize_json(
