...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.create_dataset_version_response.CreateDatasetVersionResponse = capo_bedrock_agentcore_control.types.create_dataset_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.create_dataset_version_request.serialize_json(
            input_
        )
    ).encode()
