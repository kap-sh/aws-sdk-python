...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_configuration_bundle_versions_response.ListConfigurationBundleVersionsResponse = capo_bedrock_agentcore_control.types.list_configuration_bundle_versions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.list_configuration_bundle_versions_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
