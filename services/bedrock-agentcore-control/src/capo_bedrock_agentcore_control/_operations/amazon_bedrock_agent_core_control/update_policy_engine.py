"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#UpdatePolicyEngine``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.update_policy_engine_response.UpdatePolicyEngineResponse = capo_bedrock_agentcore_control.types.update_policy_engine_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.update_policy_engine_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_policy_engine(
