"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#CreatePaymentConnector``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.create_payment_connector_response.CreatePaymentConnectorResponse = capo_bedrock_agentcore_control.types.create_payment_connector_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/payments/managers/{paymentManagerId}/connectors"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.create_payment_connector_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_payment_connector(
