"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#UpdatePaymentManager``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.update_payment_manager_response.UpdatePaymentManagerResponse = capo_bedrock_agentcore_control.types.update_payment_manager_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/payments/managers/{paymentManagerId}"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.update_payment_manager_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_payment_manager(
