...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_datasets_response.ListDatasetsResponse = capo_bedrock_agentcore_control.types.list_datasets_response.deserialize_json(
