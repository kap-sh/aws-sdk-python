...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.create_harness_response.CreateHarnessResponse = capo_bedrock_agentcore_control.types.create_harness_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.create_harness_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
