...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_oauth2_credential_provider_response.DeleteOauth2CredentialProviderResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.delete_oauth2_credential_provider_request.serialize_json(
            input_
        )
    ).encode()
