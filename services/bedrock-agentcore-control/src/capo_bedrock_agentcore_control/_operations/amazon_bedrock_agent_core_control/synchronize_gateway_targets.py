...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.synchronize_gateway_targets_response.SynchronizeGatewayTargetsResponse = capo_bedrock_agentcore_control.types.synchronize_gateway_targets_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.synchronize_gateway_targets_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
