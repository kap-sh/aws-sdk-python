...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.update_agent_runtime_endpoint_response.UpdateAgentRuntimeEndpointResponse = capo_bedrock_agentcore_control.types.update_agent_runtime_endpoint_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.update_agent_runtime_endpoint_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
