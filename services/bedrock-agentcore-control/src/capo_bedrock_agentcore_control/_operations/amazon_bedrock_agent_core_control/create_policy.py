"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#CreatePolicy``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.create_policy_response.CreatePolicyResponse = capo_bedrock_agentcore_control.types.create_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/policy-engines/{policyEngineId}/policies"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.create_policy_request.serialize_json(
            input_
        )
    ).encode()
