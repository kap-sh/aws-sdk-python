...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.put_resource_policy_response.PutResourcePolicyResponse = capo_bedrock_agentcore_control.types.put_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.put_resource_policy_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
