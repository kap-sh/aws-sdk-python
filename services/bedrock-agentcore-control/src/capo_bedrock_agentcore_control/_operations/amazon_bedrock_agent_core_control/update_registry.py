"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#UpdateRegistry``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.update_registry_response.UpdateRegistryResponse = capo_bedrock_agentcore_control.types.update_registry_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.update_registry_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_registry(
