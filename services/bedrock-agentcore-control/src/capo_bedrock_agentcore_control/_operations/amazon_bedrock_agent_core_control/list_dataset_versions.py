"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#ListDatasetVersions``."""
...
import capo_bedrock_agentcore_control.types.dataset_version_summary_list
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_dataset_versions_response.ListDatasetVersionsResponse = capo_bedrock_agentcore_control.types.list_dataset_versions_response.deserialize_json(
...
async def async_list_dataset_versions(
