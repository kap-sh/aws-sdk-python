...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.create_code_interpreter_response.CreateCodeInterpreterResponse = capo_bedrock_agentcore_control.types.create_code_interpreter_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.create_code_interpreter_request.serialize_json(
            input_
        )
    ).encode()
