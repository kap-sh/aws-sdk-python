"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#GetPaymentConnector``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_payment_connector_response.GetPaymentConnectorResponse = capo_bedrock_agentcore_control.types.get_payment_connector_response.deserialize_json(
...
async def async_get_payment_connector(
