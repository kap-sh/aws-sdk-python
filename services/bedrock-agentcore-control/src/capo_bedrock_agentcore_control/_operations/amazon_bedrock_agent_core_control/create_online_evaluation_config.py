...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.create_online_evaluation_config_response.CreateOnlineEvaluationConfigResponse = capo_bedrock_agentcore_control.types.create_online_evaluation_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.create_online_evaluation_config_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
