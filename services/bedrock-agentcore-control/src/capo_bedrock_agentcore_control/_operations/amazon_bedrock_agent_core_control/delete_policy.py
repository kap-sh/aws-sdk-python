...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_policy_response.DeletePolicyResponse = capo_bedrock_agentcore_control.types.delete_policy_response.deserialize_json(
