...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_policy_engine_response.GetPolicyEngineResponse = capo_bedrock_agentcore_control.types.get_policy_engine_response.deserialize_json(
