"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#UpdateDataset``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.update_dataset_response.UpdateDatasetResponse = capo_bedrock_agentcore_control.types.update_dataset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.update_dataset_request.serialize_json(
            input_
        )
    ).encode()
