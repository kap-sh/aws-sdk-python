...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_agent_runtime_response.GetAgentRuntimeResponse = capo_bedrock_agentcore_control.types.get_agent_runtime_response.deserialize_json(
