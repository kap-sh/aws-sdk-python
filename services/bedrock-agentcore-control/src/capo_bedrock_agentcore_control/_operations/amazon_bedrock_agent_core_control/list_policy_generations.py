...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_policy_generations_response.ListPolicyGenerationsResponse = capo_bedrock_agentcore_control.types.list_policy_generations_response.deserialize_json(
