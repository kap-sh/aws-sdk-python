...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_configuration_bundles_response.ListConfigurationBundlesResponse = capo_bedrock_agentcore_control.types.list_configuration_bundles_response.deserialize_json(
