...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_payment_connectors_response.ListPaymentConnectorsResponse = capo_bedrock_agentcore_control.types.list_payment_connectors_response.deserialize_json(
