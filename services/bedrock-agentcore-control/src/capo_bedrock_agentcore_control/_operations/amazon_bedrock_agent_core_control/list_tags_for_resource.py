...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_bedrock_agentcore_control.types.list_tags_for_resource_response.deserialize_json(
