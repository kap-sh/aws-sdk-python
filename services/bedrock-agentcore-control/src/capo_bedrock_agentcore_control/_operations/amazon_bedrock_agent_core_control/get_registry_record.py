...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_registry_record_response.GetRegistryRecordResponse = capo_bedrock_agentcore_control.types.get_registry_record_response.deserialize_json(
