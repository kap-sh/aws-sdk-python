"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#ListAgentRuntimeEndpoints``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_agent_runtime_endpoints_response.ListAgentRuntimeEndpointsResponse = capo_bedrock_agentcore_control.types.list_agent_runtime_endpoints_response.deserialize_json(
...
async def async_list_agent_runtime_endpoints(
