"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#ListBrowserProfiles``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_browser_profiles_response.ListBrowserProfilesResponse = capo_bedrock_agentcore_control.types.list_browser_profiles_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/browser-profiles"
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.list_browser_profiles_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_browser_profiles(
