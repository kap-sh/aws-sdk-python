...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.delete_evaluator_response.DeleteEvaluatorResponse = capo_bedrock_agentcore_control.types.delete_evaluator_response.deserialize_json(
