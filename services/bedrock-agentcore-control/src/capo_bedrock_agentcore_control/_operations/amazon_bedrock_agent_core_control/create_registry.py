"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#CreateRegistry``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.create_registry_response.CreateRegistryResponse = capo_bedrock_agentcore_control.types.create_registry_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.create_registry_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
