"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#GetPolicyEngineSummary``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_policy_engine_summary_response.GetPolicyEngineSummaryResponse = capo_bedrock_agentcore_control.types.get_policy_engine_summary_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/policy-engine-summaries/{policyEngineId}"
    url = url.replace(
...
async def async_get_policy_engine_summary(
