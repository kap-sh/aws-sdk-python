...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.update_gateway_response.UpdateGatewayResponse = capo_bedrock_agentcore_control.types.update_gateway_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_agentcore_control.types.update_gateway_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
