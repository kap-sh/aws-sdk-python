"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#GetEvaluator``."""
...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.get_evaluator_response.GetEvaluatorResponse = capo_bedrock_agentcore_control.types.get_evaluator_response.deserialize_json(
