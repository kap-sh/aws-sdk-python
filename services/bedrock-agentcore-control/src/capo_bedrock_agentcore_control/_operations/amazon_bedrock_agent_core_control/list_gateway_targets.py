...
def handle_response(
    ...
    out: capo_bedrock_agentcore_control.types.list_gateway_targets_response.ListGatewayTargetsResponse = capo_bedrock_agentcore_control.types.list_gateway_targets_response.deserialize_json(
