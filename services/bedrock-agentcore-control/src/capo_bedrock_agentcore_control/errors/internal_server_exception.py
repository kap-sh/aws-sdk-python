"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockagentcorecontrol#InternalServerException``."""
