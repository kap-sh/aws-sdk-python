"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockagentcorecontrol#ServiceQuotaExceededException``."""
