...
class BedrockAgentCoreControlError(Exception):
    """Base class for all BedrockAgentCoreControl service errors."""

class ServiceError(BedrockAgentCoreControlError):
...
class SerializationError(BedrockAgentCoreControlError):
    """Raised when a value cannot be serialized."""

class DeserializationError(BedrockAgentCoreControlError):
...
class WaiterFailedError(BedrockAgentCoreControlError):
...
class WaiterTimeoutError(BedrockAgentCoreControlError):
