...
from ._services.async_bedrock_agent_core_control import (
    AsyncBedrockAgentCoreControlClient as AsyncBedrockAgentCoreControlClient,
)
from ._services.bedrock_agent_core_control import (
    BedrockAgentCoreControlClient as BedrockAgentCoreControlClient,
)
