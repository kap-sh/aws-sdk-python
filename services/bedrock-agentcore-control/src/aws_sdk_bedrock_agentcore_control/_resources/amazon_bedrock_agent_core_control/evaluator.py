...
class Evaluator:
    ...
    def create(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agentcore_control.types.create_evaluator_response.CreateEvaluatorResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.create_evaluator_request.CreateEvaluatorRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.create_evaluator_response.CreateEvaluatorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.create_evaluator.create_evaluator(
        ...
        input_: aws_sdk_bedrock_agentcore_control.types.create_evaluator_request.CreateEvaluatorRequest = {}  # type: ignore[typeddict-item]
    ...
    def read(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agentcore_control.types.get_evaluator_response.GetEvaluatorResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.get_evaluator_request.GetEvaluatorRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.get_evaluator_response.GetEvaluatorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.get_evaluator.get_evaluator(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_bedrock_agentcore_control.types.get_evaluator_request.GetEvaluatorRequest = {}  # type: ignore[typeddict-item]
    ...
    def update(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agentcore_control.types.update_evaluator_response.UpdateEvaluatorResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.update_evaluator_request.UpdateEvaluatorRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.update_evaluator_response.UpdateEvaluatorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.update_evaluator.update_evaluator(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_bedrock_agentcore_control.types.update_evaluator_request.UpdateEvaluatorRequest = {}  # type: ignore[typeddict-item]
        if client_token is not None:
            input_["client_token"] = client_token
        input_["evaluator_id"] = evaluator_id
        if description is not None:
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.delete_evaluator_request.DeleteEvaluatorRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.delete_evaluator_response.DeleteEvaluatorResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.delete_evaluator.delete_evaluator(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_bedrock_agentcore_control.types.delete_evaluator_request.DeleteEvaluatorRequest = {}  # type: ignore[typeddict-item]
        input_["evaluator_id"] = evaluator_id
    ...
    def list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.list_evaluators_request.ListEvaluatorsRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.list_evaluators_response.ListEvaluatorsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.list_evaluators.list_evaluators(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_bedrock_agentcore_control.types.list_evaluators_request.ListEvaluatorsRequest = {}  # type: ignore[typeddict-item]
...
class AsyncEvaluator:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.create_evaluator_request.CreateEvaluatorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.create_evaluator_response.CreateEvaluatorResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.create_evaluator
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.create_evaluator.async_create_evaluator(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.get_evaluator_request.GetEvaluatorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.get_evaluator_response.GetEvaluatorResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.get_evaluator
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.get_evaluator.async_get_evaluator(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.update_evaluator_request.UpdateEvaluatorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.update_evaluator_response.UpdateEvaluatorResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.update_evaluator
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.update_evaluator.async_update_evaluator(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.delete_evaluator_request.DeleteEvaluatorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.delete_evaluator_response.DeleteEvaluatorResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.delete_evaluator
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.delete_evaluator.async_delete_evaluator(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.list_evaluators_request.ListEvaluatorsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.list_evaluators_response.ListEvaluatorsResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.list_evaluators
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.list_evaluators.async_list_evaluators(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
