...
class HarnessResource:
    ...
    def create_harness(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agentcore_control.types.create_harness_response.CreateHarnessResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.create_harness_request.CreateHarnessRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.create_harness_response.CreateHarnessResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.create_harness.create_harness(
        ...
        input_: aws_sdk_bedrock_agentcore_control.types.create_harness_request.CreateHarnessRequest = {}  # type: ignore[typeddict-item]
    ...
    def delete_harness(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agentcore_control.types.delete_harness_response.DeleteHarnessResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.delete_harness_request.DeleteHarnessRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.delete_harness_response.DeleteHarnessResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.delete_harness.delete_harness(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_bedrock_agentcore_control.types.delete_harness_request.DeleteHarnessRequest = {}  # type: ignore[typeddict-item]
    ...
    def get_harness(
        ...
        *,
        config_overrides: Optional[BedrockAgentCoreControlClientConfig] = None,
    ) -> "aws_sdk_bedrock_agentcore_control.types.get_harness_response.GetHarnessResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.get_harness_request.GetHarnessRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.get_harness_response.GetHarnessResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.get_harness.get_harness(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_bedrock_agentcore_control.types.get_harness_request.GetHarnessRequest = {}  # type: ignore[typeddict-item]
        input_["harness_id"] = harness_id
    ...
    def list_harnesses(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock_agentcore_control.types.list_harnesses_response.ListHarnessesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.list_harnesses_request.ListHarnessesRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.list_harnesses_response.ListHarnessesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.list_harnesses.list_harnesses(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_bedrock_agentcore_control.types.list_harnesses_request.ListHarnessesRequest = {}  # type: ignore[typeddict-item]
    ...
    def update_harness(
        ...
        *,
        ...
        environment_artifact: Optional[
            "aws_sdk_bedrock_agentcore_control.types.updated_harness_environment_artifact.UpdatedHarnessEnvironmentArtifact"
        ] = None,
        environment_variables: Optional[
            "aws_sdk_bedrock_agentcore_control.types.environment_variables_map.EnvironmentVariablesMap"
        ] = None,
        ...
        memory: Optional[
            "aws_sdk_bedrock_agentcore_control.types.updated_harness_memory_configuration.UpdatedHarnessMemoryConfiguration"
        ] = None,
        truncation: Optional[
            "aws_sdk_bedrock_agentcore_control.types.harness_truncation_configuration.HarnessTruncationConfiguration"
        ] = None,
        ...
        max_tokens: Optional[int] = None,
        timeout_seconds: Optional[int] = None,
    ) -> "aws_sdk_bedrock_agentcore_control.types.update_harness_response.UpdateHarnessResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.update_harness_request.UpdateHarnessRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.update_harness_response.UpdateHarnessResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.update_harness.update_harness(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_bedrock_agentcore_control.types.update_harness_request.UpdateHarnessRequest = {}  # type: ignore[typeddict-item]
        input_["harness_id"] = harness_id
        if client_token is not None:
            input_["client_token"] = client_token
...
class AsyncHarnessResource:
    ...
    async def create_harness(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.create_harness_request.CreateHarnessRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.create_harness_response.CreateHarnessResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.create_harness
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.create_harness.async_create_harness(
                req.options, req.input
            )
    ...
    async def delete_harness(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.delete_harness_request.DeleteHarnessRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.delete_harness_response.DeleteHarnessResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.delete_harness
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.delete_harness.async_delete_harness(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_harness(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.get_harness_request.GetHarnessRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.get_harness_response.GetHarnessResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.get_harness
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.get_harness.async_get_harness(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_harnesses(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.list_harnesses_request.ListHarnessesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.list_harnesses_response.ListHarnessesResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.list_harnesses
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.list_harnesses.async_list_harnesses(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_harness(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.update_harness_request.UpdateHarnessRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.update_harness_response.UpdateHarnessResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.update_harness
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.update_harness.async_update_harness(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
