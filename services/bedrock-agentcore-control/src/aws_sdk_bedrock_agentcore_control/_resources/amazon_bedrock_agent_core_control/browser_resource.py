...
class BrowserResource:
    ...
    def create(
        ...
        *,
        ...
        browser_signing: Optional[
            "aws_sdk_bedrock_agentcore_control.types.browser_signing_config_input.BrowserSigningConfigInput"
        ] = None,
    ...
    ) -> "aws_sdk_bedrock_agentcore_control.types.create_browser_response.CreateBrowserResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.create_browser_request.CreateBrowserRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.create_browser_response.CreateBrowserResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.create_browser.create_browser(
        ...
        input_: aws_sdk_bedrock_agentcore_control.types.create_browser_request.CreateBrowserRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
    ...
    def read(
        ...
        *,
        config_overrides: Optional[BedrockAgentCoreControlClientConfig] = None,
    ) -> "aws_sdk_bedrock_agentcore_control.types.get_browser_response.GetBrowserResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.get_browser_request.GetBrowserRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.get_browser_response.GetBrowserResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.get_browser.get_browser(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_bedrock_agentcore_control.types.get_browser_request.GetBrowserRequest = {}  # type: ignore[typeddict-item]
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.delete_browser_request.DeleteBrowserRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.delete_browser_response.DeleteBrowserResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.delete_browser.delete_browser(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_bedrock_agentcore_control.types.delete_browser_request.DeleteBrowserRequest = {}  # type: ignore[typeddict-item]
        input_["browser_id"] = browser_id
        if client_token is not None:
            input_["client_token"] = client_token
    ...
    def list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock_agentcore_control.types.list_browsers_request.ListBrowsersRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.list_browsers_response.ListBrowsersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.list_browsers.list_browsers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_bedrock_agentcore_control.types.list_browsers_request.ListBrowsersRequest = {}  # type: ignore[typeddict-item]
...
class AsyncBrowserResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.create_browser_request.CreateBrowserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.create_browser_response.CreateBrowserResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.create_browser
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.create_browser.async_create_browser(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.get_browser_request.GetBrowserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.get_browser_response.GetBrowserResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.get_browser
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.get_browser.async_get_browser(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.delete_browser_request.DeleteBrowserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.delete_browser_response.DeleteBrowserResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.delete_browser
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.delete_browser.async_delete_browser(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_agentcore_control.types.list_browsers_request.ListBrowsersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_agentcore_control.types.list_browsers_response.ListBrowsersResponse"
        ]:
            import aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.list_browsers
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_agentcore_control._operations.amazon_bedrock_agent_core_control.list_browsers.async_list_browsers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
