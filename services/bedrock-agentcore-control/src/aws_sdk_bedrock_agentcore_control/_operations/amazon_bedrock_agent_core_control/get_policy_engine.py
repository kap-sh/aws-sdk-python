...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_policy_engine_response.GetPolicyEngineResponse = aws_sdk_bedrock_agentcore_control.types.get_policy_engine_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_policy_engine_request.GetPolicyEngineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_policy_engine(
