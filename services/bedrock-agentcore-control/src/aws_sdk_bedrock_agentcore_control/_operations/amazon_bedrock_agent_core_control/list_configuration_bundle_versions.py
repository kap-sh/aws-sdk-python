...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_configuration_bundle_versions_response.ListConfigurationBundleVersionsResponse = aws_sdk_bedrock_agentcore_control.types.list_configuration_bundle_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_configuration_bundle_versions_request.ListConfigurationBundleVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.list_configuration_bundle_versions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_configuration_bundle_versions(
