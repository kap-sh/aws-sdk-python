...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.update_harness_response.UpdateHarnessResponse = aws_sdk_bedrock_agentcore_control.types.update_harness_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.update_harness_request.UpdateHarnessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.update_harness_request.serialize_json(
            input_
        )
    ).encode()
