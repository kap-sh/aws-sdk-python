...
) -> aws_sdk_bedrock_agentcore_control.types.delete_browser_response.DeleteBrowserResponse:
    import aws_sdk_bedrock_agentcore_control.types.delete_browser_response

    out: aws_sdk_bedrock_agentcore_control.types.delete_browser_response.DeleteBrowserResponse = aws_sdk_bedrock_agentcore_control.types.delete_browser_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_browser_request.DeleteBrowserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{browserId}", quote(str(input_["browser_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_delete_browser(
