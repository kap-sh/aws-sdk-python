...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_agent_runtime_endpoint_response.GetAgentRuntimeEndpointResponse = aws_sdk_bedrock_agentcore_control.types.get_agent_runtime_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_agent_runtime_endpoint_request.GetAgentRuntimeEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_agent_runtime_endpoint(
