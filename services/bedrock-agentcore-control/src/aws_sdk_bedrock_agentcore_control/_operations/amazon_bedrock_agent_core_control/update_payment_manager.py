...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.update_payment_manager_response.UpdatePaymentManagerResponse = aws_sdk_bedrock_agentcore_control.types.update_payment_manager_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.update_payment_manager_request.UpdatePaymentManagerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.update_payment_manager_request.serialize_json(
            input_
        )
    ).encode()
