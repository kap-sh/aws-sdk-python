...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_gateway_rule_response.CreateGatewayRuleResponse = aws_sdk_bedrock_agentcore_control.types.create_gateway_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_gateway_rule_request.CreateGatewayRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_gateway_rule(
