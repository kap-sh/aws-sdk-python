...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_registries_response.ListRegistriesResponse = aws_sdk_bedrock_agentcore_control.types.list_registries_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_registries_request.ListRegistriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "authorizer_type" in input_:
        params["authorizerType"] = str(input_["authorizer_type"])
