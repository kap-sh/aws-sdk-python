...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.delete_registry_response.DeleteRegistryResponse = aws_sdk_bedrock_agentcore_control.types.delete_registry_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_registry_request.DeleteRegistryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_registry(
