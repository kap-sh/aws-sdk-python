...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.delete_code_interpreter_response.DeleteCodeInterpreterResponse = aws_sdk_bedrock_agentcore_control.types.delete_code_interpreter_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_code_interpreter_request.DeleteCodeInterpreterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{codeInterpreterId}", quote(str(input_["code_interpreter_id"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_delete_code_interpreter(
