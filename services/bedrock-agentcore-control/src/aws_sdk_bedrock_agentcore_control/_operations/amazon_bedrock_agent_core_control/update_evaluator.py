...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.update_evaluator_response.UpdateEvaluatorResponse = aws_sdk_bedrock_agentcore_control.types.update_evaluator_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.update_evaluator_request.UpdateEvaluatorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
