...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_evaluator_response.GetEvaluatorResponse = aws_sdk_bedrock_agentcore_control.types.get_evaluator_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_evaluator_request.GetEvaluatorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
