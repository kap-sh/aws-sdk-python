...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_harness_response.GetHarnessResponse = aws_sdk_bedrock_agentcore_control.types.get_harness_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_harness_request.GetHarnessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
