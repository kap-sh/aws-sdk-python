...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.update_gateway_rule_response.UpdateGatewayRuleResponse = aws_sdk_bedrock_agentcore_control.types.update_gateway_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.update_gateway_rule_request.UpdateGatewayRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.update_gateway_rule_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_gateway_rule(
