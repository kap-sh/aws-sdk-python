...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_registry_response.GetRegistryResponse = aws_sdk_bedrock_agentcore_control.types.get_registry_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_registry_request.GetRegistryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
