...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_workload_identities_response.ListWorkloadIdentitiesResponse = aws_sdk_bedrock_agentcore_control.types.list_workload_identities_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_workload_identities_request.ListWorkloadIdentitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.list_workload_identities_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_workload_identities(
