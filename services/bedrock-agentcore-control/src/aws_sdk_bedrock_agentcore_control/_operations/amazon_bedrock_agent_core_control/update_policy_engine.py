...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.update_policy_engine_response.UpdatePolicyEngineResponse = aws_sdk_bedrock_agentcore_control.types.update_policy_engine_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.update_policy_engine_request.UpdatePolicyEngineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.update_policy_engine_request.serialize_json(
            input_
        )
    ).encode()
