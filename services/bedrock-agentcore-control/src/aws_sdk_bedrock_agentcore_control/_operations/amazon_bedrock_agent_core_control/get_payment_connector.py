...
) -> aws_sdk_bedrock_agentcore_control.types.get_payment_connector_response.GetPaymentConnectorResponse:
    out: aws_sdk_bedrock_agentcore_control.types.get_payment_connector_response.GetPaymentConnectorResponse = aws_sdk_bedrock_agentcore_control.types.get_payment_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_payment_connector_request.GetPaymentConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
