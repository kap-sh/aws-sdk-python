...
def handle_response(
    ...
    aws_sdk_bedrock_agentcore_control.types.update_policy_response.UpdatePolicyResponse
):
    import aws_sdk_bedrock_agentcore_control.types.update_policy_response

    out: aws_sdk_bedrock_agentcore_control.types.update_policy_response.UpdatePolicyResponse = aws_sdk_bedrock_agentcore_control.types.update_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.update_policy_request.UpdatePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
