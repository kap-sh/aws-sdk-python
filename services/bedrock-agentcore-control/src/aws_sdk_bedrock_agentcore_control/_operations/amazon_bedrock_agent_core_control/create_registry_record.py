...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_registry_record_response.CreateRegistryRecordResponse = aws_sdk_bedrock_agentcore_control.types.create_registry_record_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_registry_record_request.CreateRegistryRecordRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{registryId}", quote(str(input_["registry_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_registry_record_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_registry_record(
