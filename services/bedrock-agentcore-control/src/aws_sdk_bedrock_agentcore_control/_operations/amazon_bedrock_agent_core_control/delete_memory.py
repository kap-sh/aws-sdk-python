...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.delete_memory_output.DeleteMemoryOutput = aws_sdk_bedrock_agentcore_control.types.delete_memory_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_memory_input.DeleteMemoryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
