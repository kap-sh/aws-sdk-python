...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.delete_gateway_target_response.DeleteGatewayTargetResponse = aws_sdk_bedrock_agentcore_control.types.delete_gateway_target_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_gateway_target_request.DeleteGatewayTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
