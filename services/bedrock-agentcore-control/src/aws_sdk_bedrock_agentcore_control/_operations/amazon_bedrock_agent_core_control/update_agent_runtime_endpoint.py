...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.update_agent_runtime_endpoint_response.UpdateAgentRuntimeEndpointResponse = aws_sdk_bedrock_agentcore_control.types.update_agent_runtime_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.update_agent_runtime_endpoint_request.UpdateAgentRuntimeEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.update_agent_runtime_endpoint_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_agent_runtime_endpoint(
