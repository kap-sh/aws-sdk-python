...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_policy_generation_response.GetPolicyGenerationResponse = aws_sdk_bedrock_agentcore_control.types.get_policy_generation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_policy_generation_request.GetPolicyGenerationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
