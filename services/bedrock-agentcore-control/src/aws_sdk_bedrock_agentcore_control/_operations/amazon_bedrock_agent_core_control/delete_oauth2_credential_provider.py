...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_oauth2_credential_provider_request.DeleteOauth2CredentialProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.delete_oauth2_credential_provider_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_delete_oauth2_credential_provider(
