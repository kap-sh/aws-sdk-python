...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.delete_harness_response.DeleteHarnessResponse = aws_sdk_bedrock_agentcore_control.types.delete_harness_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_harness_request.DeleteHarnessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
