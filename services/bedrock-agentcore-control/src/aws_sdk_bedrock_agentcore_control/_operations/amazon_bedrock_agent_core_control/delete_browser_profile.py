...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.delete_browser_profile_response.DeleteBrowserProfileResponse = aws_sdk_bedrock_agentcore_control.types.delete_browser_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_browser_profile_request.DeleteBrowserProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_browser_profile(
