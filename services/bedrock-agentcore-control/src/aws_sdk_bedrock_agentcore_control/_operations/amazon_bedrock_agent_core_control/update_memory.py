...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.update_memory_output.UpdateMemoryOutput = aws_sdk_bedrock_agentcore_control.types.update_memory_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.update_memory_input.UpdateMemoryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.update_memory_input.serialize_json(
            input_
        )
    ).encode()
