...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.start_policy_generation_response.StartPolicyGenerationResponse = aws_sdk_bedrock_agentcore_control.types.start_policy_generation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.start_policy_generation_request.StartPolicyGenerationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/policy-engines/{policyEngineId}/policy-generations"
    )
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.start_policy_generation_request.serialize_json(
            input_
        )
    ).encode()
