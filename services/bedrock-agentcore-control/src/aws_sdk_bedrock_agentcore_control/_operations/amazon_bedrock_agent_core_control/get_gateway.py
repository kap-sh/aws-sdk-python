...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_gateway_response.GetGatewayResponse = aws_sdk_bedrock_agentcore_control.types.get_gateway_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_gateway_request.GetGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
