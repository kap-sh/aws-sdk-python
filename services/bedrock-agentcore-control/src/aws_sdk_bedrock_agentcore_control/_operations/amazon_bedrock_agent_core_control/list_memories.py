...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_memories_output.ListMemoriesOutput = aws_sdk_bedrock_agentcore_control.types.list_memories_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_memories_input.ListMemoriesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.list_memories_input.serialize_json(
            input_
        )
    ).encode()
