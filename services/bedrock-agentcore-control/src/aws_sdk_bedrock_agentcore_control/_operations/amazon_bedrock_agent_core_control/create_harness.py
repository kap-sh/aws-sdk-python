...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_harness_response.CreateHarnessResponse = aws_sdk_bedrock_agentcore_control.types.create_harness_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_harness_request.CreateHarnessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_harness_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_harness(
