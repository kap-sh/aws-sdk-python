...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_memory_output.GetMemoryOutput = (
        aws_sdk_bedrock_agentcore_control.types.get_memory_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_memory_input.GetMemoryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
