...
) -> aws_sdk_bedrock_agentcore_control.types.list_evaluators_response.ListEvaluatorsResponse:
    import aws_sdk_bedrock_agentcore_control.types.list_evaluators_response

    out: aws_sdk_bedrock_agentcore_control.types.list_evaluators_response.ListEvaluatorsResponse = aws_sdk_bedrock_agentcore_control.types.list_evaluators_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_evaluators_request.ListEvaluatorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_evaluators(
