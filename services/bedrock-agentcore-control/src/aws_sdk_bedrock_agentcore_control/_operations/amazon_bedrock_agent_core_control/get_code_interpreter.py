...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_code_interpreter_response.GetCodeInterpreterResponse = aws_sdk_bedrock_agentcore_control.types.get_code_interpreter_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_code_interpreter_request.GetCodeInterpreterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_code_interpreter(
