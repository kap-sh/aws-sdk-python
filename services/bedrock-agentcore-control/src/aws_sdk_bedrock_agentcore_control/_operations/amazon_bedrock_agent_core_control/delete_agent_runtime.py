...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.delete_agent_runtime_response.DeleteAgentRuntimeResponse = aws_sdk_bedrock_agentcore_control.types.delete_agent_runtime_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_agent_runtime_request.DeleteAgentRuntimeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
