...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.update_registry_record_response.UpdateRegistryRecordResponse = aws_sdk_bedrock_agentcore_control.types.update_registry_record_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.update_registry_record_request.UpdateRegistryRecordRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.update_registry_record_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_registry_record(
