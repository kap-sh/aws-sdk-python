...
def handle_response(
    ...
    aws_sdk_bedrock_agentcore_control.types.list_datasets_response.ListDatasetsResponse
):
    import aws_sdk_bedrock_agentcore_control.types.list_datasets_response

    out: aws_sdk_bedrock_agentcore_control.types.list_datasets_response.ListDatasetsResponse = aws_sdk_bedrock_agentcore_control.types.list_datasets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_datasets_request.ListDatasetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
