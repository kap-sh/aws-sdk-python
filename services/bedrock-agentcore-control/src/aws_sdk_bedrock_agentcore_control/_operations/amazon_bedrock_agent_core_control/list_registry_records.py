...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_registry_records_response.ListRegistryRecordsResponse = aws_sdk_bedrock_agentcore_control.types.list_registry_records_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_registry_records_request.ListRegistryRecordsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "descriptor_type" in input_:
        params["descriptorType"] = str(input_["descriptor_type"])
...
async def async_list_registry_records(
