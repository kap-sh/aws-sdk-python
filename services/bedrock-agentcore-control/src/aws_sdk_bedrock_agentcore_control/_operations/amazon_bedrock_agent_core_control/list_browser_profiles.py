...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_browser_profiles_response.ListBrowserProfilesResponse = aws_sdk_bedrock_agentcore_control.types.list_browser_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_browser_profiles_request.ListBrowserProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.list_browser_profiles_request.serialize_json(
            input_
        )
    ).encode()
