...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_agent_runtime_response.CreateAgentRuntimeResponse = aws_sdk_bedrock_agentcore_control.types.create_agent_runtime_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_agent_runtime_request.CreateAgentRuntimeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_agent_runtime_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_agent_runtime(
