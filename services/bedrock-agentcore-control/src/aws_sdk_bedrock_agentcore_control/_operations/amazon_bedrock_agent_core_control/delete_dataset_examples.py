...
) -> aws_sdk_bedrock_agentcore_control.types.delete_dataset_examples_response.DeleteDatasetExamplesResponse:
    import aws_sdk_bedrock_agentcore_control.types.delete_dataset_examples_response

    out: aws_sdk_bedrock_agentcore_control.types.delete_dataset_examples_response.DeleteDatasetExamplesResponse = aws_sdk_bedrock_agentcore_control.types.delete_dataset_examples_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_dataset_examples_request.DeleteDatasetExamplesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.delete_dataset_examples_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_delete_dataset_examples(
