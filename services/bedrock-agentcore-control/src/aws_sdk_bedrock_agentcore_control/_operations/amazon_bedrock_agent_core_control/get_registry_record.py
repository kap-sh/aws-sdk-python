...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_registry_record_response.GetRegistryRecordResponse = aws_sdk_bedrock_agentcore_control.types.get_registry_record_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_registry_record_request.GetRegistryRecordRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_registry_record(
