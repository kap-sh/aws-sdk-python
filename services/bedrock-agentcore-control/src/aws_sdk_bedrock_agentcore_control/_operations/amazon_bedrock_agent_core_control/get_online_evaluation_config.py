...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_online_evaluation_config_response.GetOnlineEvaluationConfigResponse = aws_sdk_bedrock_agentcore_control.types.get_online_evaluation_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_online_evaluation_config_request.GetOnlineEvaluationConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["online_evaluation_config_id"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_get_online_evaluation_config(
