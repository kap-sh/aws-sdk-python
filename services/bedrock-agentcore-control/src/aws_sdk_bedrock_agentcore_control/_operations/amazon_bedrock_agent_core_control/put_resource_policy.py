...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.put_resource_policy_response.PutResourcePolicyResponse = aws_sdk_bedrock_agentcore_control.types.put_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.put_resource_policy_request.PutResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.put_resource_policy_request.serialize_json(
            input_
        )
    ).encode()
