...
import aws_sdk_bedrock_agentcore_control.types.policy_summary_list
...
) -> aws_sdk_bedrock_agentcore_control.types.list_policy_summaries_response.ListPolicySummariesResponse:
    out: aws_sdk_bedrock_agentcore_control.types.list_policy_summaries_response.ListPolicySummariesResponse = aws_sdk_bedrock_agentcore_control.types.list_policy_summaries_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_policy_summaries_request.ListPolicySummariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "target_resource_scope" in input_:
        params["targetResourceScope"] = str(input_["target_resource_scope"])
...
async def async_list_policy_summaries(
