...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_payment_credential_providers_response.ListPaymentCredentialProvidersResponse = aws_sdk_bedrock_agentcore_control.types.list_payment_credential_providers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_payment_credential_providers_request.ListPaymentCredentialProvidersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.list_payment_credential_providers_request.serialize_json(
            input_
        )
    ).encode()
