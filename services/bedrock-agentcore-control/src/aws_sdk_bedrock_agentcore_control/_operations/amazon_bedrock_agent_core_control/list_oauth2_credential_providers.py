...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_oauth2_credential_providers_response.ListOauth2CredentialProvidersResponse = aws_sdk_bedrock_agentcore_control.types.list_oauth2_credential_providers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_oauth2_credential_providers_request.ListOauth2CredentialProvidersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.list_oauth2_credential_providers_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_oauth2_credential_providers(
