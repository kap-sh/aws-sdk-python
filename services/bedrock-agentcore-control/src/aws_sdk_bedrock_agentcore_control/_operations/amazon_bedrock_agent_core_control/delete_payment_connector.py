...
) -> aws_sdk_bedrock_agentcore_control.types.delete_payment_connector_response.DeletePaymentConnectorResponse:
    out: aws_sdk_bedrock_agentcore_control.types.delete_payment_connector_response.DeletePaymentConnectorResponse = aws_sdk_bedrock_agentcore_control.types.delete_payment_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_payment_connector_request.DeletePaymentConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_payment_connector(
