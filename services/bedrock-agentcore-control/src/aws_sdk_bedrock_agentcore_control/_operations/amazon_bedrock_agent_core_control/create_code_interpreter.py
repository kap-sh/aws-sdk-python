...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_code_interpreter_response.CreateCodeInterpreterResponse = aws_sdk_bedrock_agentcore_control.types.create_code_interpreter_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_code_interpreter_request.CreateCodeInterpreterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_code_interpreter(
