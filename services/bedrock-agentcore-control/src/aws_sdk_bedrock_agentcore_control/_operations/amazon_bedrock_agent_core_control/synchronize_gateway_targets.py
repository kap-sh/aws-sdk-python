...
import aws_sdk_bedrock_agentcore_control.types.gateway_target_list
...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.synchronize_gateway_targets_response.SynchronizeGatewayTargetsResponse = aws_sdk_bedrock_agentcore_control.types.synchronize_gateway_targets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.synchronize_gateway_targets_request.SynchronizeGatewayTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.synchronize_gateway_targets_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_synchronize_gateway_targets(
