...
import aws_sdk_bedrock_agentcore_control.types.code_interpreter_summaries
...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_code_interpreters_response.ListCodeInterpretersResponse = aws_sdk_bedrock_agentcore_control.types.list_code_interpreters_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_code_interpreters_request.ListCodeInterpretersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_code_interpreters(
