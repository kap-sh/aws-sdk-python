...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_policy_generation_summary_response.GetPolicyGenerationSummaryResponse = aws_sdk_bedrock_agentcore_control.types.get_policy_generation_summary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_policy_generation_summary_request.GetPolicyGenerationSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
