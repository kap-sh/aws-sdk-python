...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_configuration_bundle_version_response.GetConfigurationBundleVersionResponse = aws_sdk_bedrock_agentcore_control.types.get_configuration_bundle_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_configuration_bundle_version_request.GetConfigurationBundleVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/configuration-bundles/{bundleId}/versions/{versionId}"
    )
    url = url.replace("{bundleId}", quote(str(input_["bundle_id"]), safe=""))
...
async def async_get_configuration_bundle_version(
