...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_gateway_rule_response.GetGatewayRuleResponse = aws_sdk_bedrock_agentcore_control.types.get_gateway_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_gateway_rule_request.GetGatewayRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_gateway_rule(
