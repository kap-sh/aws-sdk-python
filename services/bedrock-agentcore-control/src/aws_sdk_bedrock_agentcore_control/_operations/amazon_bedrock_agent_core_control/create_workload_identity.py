...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_workload_identity_response.CreateWorkloadIdentityResponse = aws_sdk_bedrock_agentcore_control.types.create_workload_identity_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_workload_identity_request.CreateWorkloadIdentityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_workload_identity_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_workload_identity(
