...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_dataset_response.GetDatasetResponse = aws_sdk_bedrock_agentcore_control.types.get_dataset_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_dataset_request.GetDatasetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
