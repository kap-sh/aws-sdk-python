...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.delete_gateway_rule_response.DeleteGatewayRuleResponse = aws_sdk_bedrock_agentcore_control.types.delete_gateway_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_gateway_rule_request.DeleteGatewayRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_gateway_rule(
