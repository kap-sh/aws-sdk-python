...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_configuration_bundle_response.CreateConfigurationBundleResponse = aws_sdk_bedrock_agentcore_control.types.create_configuration_bundle_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_configuration_bundle_request.CreateConfigurationBundleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_configuration_bundle_request.serialize_json(
            input_
        )
    ).encode()
