...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_api_key_credential_provider_response.GetApiKeyCredentialProviderResponse = aws_sdk_bedrock_agentcore_control.types.get_api_key_credential_provider_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_api_key_credential_provider_request.GetApiKeyCredentialProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.get_api_key_credential_provider_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_api_key_credential_provider(
