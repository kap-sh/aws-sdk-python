...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_policy_engine_summaries_response.ListPolicyEngineSummariesResponse = aws_sdk_bedrock_agentcore_control.types.list_policy_engine_summaries_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_policy_engine_summaries_request.ListPolicyEngineSummariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_policy_engine_summaries(
