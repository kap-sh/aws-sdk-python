...
) -> aws_sdk_bedrock_agentcore_control.types.delete_evaluator_response.DeleteEvaluatorResponse:
    import aws_sdk_bedrock_agentcore_control.types.delete_evaluator_response

    out: aws_sdk_bedrock_agentcore_control.types.delete_evaluator_response.DeleteEvaluatorResponse = aws_sdk_bedrock_agentcore_control.types.delete_evaluator_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_evaluator_request.DeleteEvaluatorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_evaluator(
