...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_dataset_versions_response.ListDatasetVersionsResponse = aws_sdk_bedrock_agentcore_control.types.list_dataset_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_dataset_versions_request.ListDatasetVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
