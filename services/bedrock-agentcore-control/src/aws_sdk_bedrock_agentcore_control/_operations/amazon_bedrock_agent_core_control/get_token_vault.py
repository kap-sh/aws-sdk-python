...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_token_vault_response.GetTokenVaultResponse = aws_sdk_bedrock_agentcore_control.types.get_token_vault_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_token_vault_request.GetTokenVaultRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.get_token_vault_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_token_vault(
