...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_payment_credential_provider_response.GetPaymentCredentialProviderResponse = aws_sdk_bedrock_agentcore_control.types.get_payment_credential_provider_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_payment_credential_provider_request.GetPaymentCredentialProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.get_payment_credential_provider_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_payment_credential_provider(
