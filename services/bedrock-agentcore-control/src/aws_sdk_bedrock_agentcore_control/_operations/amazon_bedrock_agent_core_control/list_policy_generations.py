...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_policy_generations_response.ListPolicyGenerationsResponse = aws_sdk_bedrock_agentcore_control.types.list_policy_generations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_policy_generations_request.ListPolicyGenerationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
