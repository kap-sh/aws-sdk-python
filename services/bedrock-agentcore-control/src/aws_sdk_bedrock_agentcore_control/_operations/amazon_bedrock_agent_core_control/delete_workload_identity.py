...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_workload_identity_request.DeleteWorkloadIdentityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.delete_workload_identity_request.serialize_json(
            input_
        )
    ).encode()
