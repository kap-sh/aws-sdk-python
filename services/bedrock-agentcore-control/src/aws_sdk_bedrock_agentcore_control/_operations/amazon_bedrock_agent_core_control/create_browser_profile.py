...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_browser_profile_response.CreateBrowserProfileResponse = aws_sdk_bedrock_agentcore_control.types.create_browser_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_browser_profile_request.CreateBrowserProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_browser_profile_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_browser_profile(
