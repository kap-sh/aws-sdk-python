...
def handle_response(
    ...
    aws_sdk_bedrock_agentcore_control.types.list_browsers_response.ListBrowsersResponse
):
    import aws_sdk_bedrock_agentcore_control.types.list_browsers_response

    out: aws_sdk_bedrock_agentcore_control.types.list_browsers_response.ListBrowsersResponse = aws_sdk_bedrock_agentcore_control.types.list_browsers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_browsers_request.ListBrowsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
