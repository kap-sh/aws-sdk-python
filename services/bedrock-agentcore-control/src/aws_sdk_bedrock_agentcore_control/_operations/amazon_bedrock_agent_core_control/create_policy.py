...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_policy_response.CreatePolicyResponse = aws_sdk_bedrock_agentcore_control.types.create_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_policy_request.CreatePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_policy_request.serialize_json(
            input_
        )
    ).encode()
