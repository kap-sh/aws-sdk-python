...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_harnesses_response.ListHarnessesResponse = aws_sdk_bedrock_agentcore_control.types.list_harnesses_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_harnesses_request.ListHarnessesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
