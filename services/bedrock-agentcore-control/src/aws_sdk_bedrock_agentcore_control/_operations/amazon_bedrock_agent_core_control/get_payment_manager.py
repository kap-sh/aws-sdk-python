...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_payment_manager_response.GetPaymentManagerResponse = aws_sdk_bedrock_agentcore_control.types.get_payment_manager_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_payment_manager_request.GetPaymentManagerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
