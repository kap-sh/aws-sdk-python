...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_oauth2_credential_provider_response.CreateOauth2CredentialProviderResponse = aws_sdk_bedrock_agentcore_control.types.create_oauth2_credential_provider_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_oauth2_credential_provider_request.CreateOauth2CredentialProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_oauth2_credential_provider_request.serialize_json(
            input_
        )
    ).encode()
