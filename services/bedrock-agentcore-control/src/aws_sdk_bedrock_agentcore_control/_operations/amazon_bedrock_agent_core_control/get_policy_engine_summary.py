...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_policy_engine_summary_response.GetPolicyEngineSummaryResponse = aws_sdk_bedrock_agentcore_control.types.get_policy_engine_summary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_policy_engine_summary_request.GetPolicyEngineSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
