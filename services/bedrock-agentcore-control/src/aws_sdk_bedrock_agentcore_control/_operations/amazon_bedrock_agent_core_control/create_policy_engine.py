...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_policy_engine_response.CreatePolicyEngineResponse = aws_sdk_bedrock_agentcore_control.types.create_policy_engine_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_policy_engine_request.CreatePolicyEngineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
