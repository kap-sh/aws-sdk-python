...
) -> aws_sdk_bedrock_agentcore_control.types.get_policy_summary_response.GetPolicySummaryResponse:
    import aws_sdk_bedrock_agentcore_control.types.get_policy_summary_response

    out: aws_sdk_bedrock_agentcore_control.types.get_policy_summary_response.GetPolicySummaryResponse = aws_sdk_bedrock_agentcore_control.types.get_policy_summary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_policy_summary_request.GetPolicySummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_policy_summary(
