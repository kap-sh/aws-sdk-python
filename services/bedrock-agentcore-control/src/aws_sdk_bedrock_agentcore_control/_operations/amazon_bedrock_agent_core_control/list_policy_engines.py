...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_policy_engines_response.ListPolicyEnginesResponse = aws_sdk_bedrock_agentcore_control.types.list_policy_engines_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_policy_engines_request.ListPolicyEnginesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_policy_engines(
