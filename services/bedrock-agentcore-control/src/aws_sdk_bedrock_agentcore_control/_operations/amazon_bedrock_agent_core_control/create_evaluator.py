...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_evaluator_response.CreateEvaluatorResponse = aws_sdk_bedrock_agentcore_control.types.create_evaluator_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_evaluator_request.CreateEvaluatorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_evaluator_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_evaluator(
