...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_browser_response.GetBrowserResponse = aws_sdk_bedrock_agentcore_control.types.get_browser_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_browser_request.GetBrowserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
