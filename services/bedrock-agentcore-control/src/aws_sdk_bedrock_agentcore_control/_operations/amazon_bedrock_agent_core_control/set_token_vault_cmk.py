...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConcurrentModificationException":
            ...
            raise aws_sdk_bedrock_agentcore_control.errors.concurrent_modification_exception.ConcurrentModificationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.set_token_vault_cmk_response.SetTokenVaultCMKResponse = aws_sdk_bedrock_agentcore_control.types.set_token_vault_cmk_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.set_token_vault_cmk_request.SetTokenVaultCMKRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
