...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.update_online_evaluation_config_response.UpdateOnlineEvaluationConfigResponse = aws_sdk_bedrock_agentcore_control.types.update_online_evaluation_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.update_online_evaluation_config_request.UpdateOnlineEvaluationConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.update_online_evaluation_config_request.serialize_json(
            input_
        )
    ).encode()
