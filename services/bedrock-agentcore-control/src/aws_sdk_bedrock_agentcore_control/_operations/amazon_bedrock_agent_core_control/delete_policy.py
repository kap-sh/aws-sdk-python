...
def handle_response(
    ...
    aws_sdk_bedrock_agentcore_control.types.delete_policy_response.DeletePolicyResponse
):
    import aws_sdk_bedrock_agentcore_control.types.delete_policy_response

    out: aws_sdk_bedrock_agentcore_control.types.delete_policy_response.DeletePolicyResponse = aws_sdk_bedrock_agentcore_control.types.delete_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_policy_request.DeletePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
