...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.add_dataset_examples_response.AddDatasetExamplesResponse = aws_sdk_bedrock_agentcore_control.types.add_dataset_examples_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.add_dataset_examples_request.AddDatasetExamplesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.add_dataset_examples_request.serialize_json(
            input_
        )
    ).encode()
