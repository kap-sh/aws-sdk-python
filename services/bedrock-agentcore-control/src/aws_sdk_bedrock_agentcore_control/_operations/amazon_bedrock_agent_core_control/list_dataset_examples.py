...
) -> aws_sdk_bedrock_agentcore_control.types.list_dataset_examples_response.ListDatasetExamplesResponse:
    import aws_sdk_bedrock_agentcore_control.types.list_dataset_examples_response

    out: aws_sdk_bedrock_agentcore_control.types.list_dataset_examples_response.ListDatasetExamplesResponse = aws_sdk_bedrock_agentcore_control.types.list_dataset_examples_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_dataset_examples_request.ListDatasetExamplesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "dataset_version" in input_:
        params["datasetVersion"] = str(input_["dataset_version"])
...
async def async_list_dataset_examples(
