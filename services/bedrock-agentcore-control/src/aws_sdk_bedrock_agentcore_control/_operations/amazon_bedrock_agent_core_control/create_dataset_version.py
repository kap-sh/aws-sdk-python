...
) -> aws_sdk_bedrock_agentcore_control.types.create_dataset_version_response.CreateDatasetVersionResponse:
    out: aws_sdk_bedrock_agentcore_control.types.create_dataset_version_response.CreateDatasetVersionResponse = aws_sdk_bedrock_agentcore_control.types.create_dataset_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_dataset_version_request.CreateDatasetVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_dataset_version_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_dataset_version(
