...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.delete_configuration_bundle_response.DeleteConfigurationBundleResponse = aws_sdk_bedrock_agentcore_control.types.delete_configuration_bundle_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_configuration_bundle_request.DeleteConfigurationBundleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_configuration_bundle(
