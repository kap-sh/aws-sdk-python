...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_agent_runtime_response.GetAgentRuntimeResponse = aws_sdk_bedrock_agentcore_control.types.get_agent_runtime_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_agent_runtime_request.GetAgentRuntimeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "agent_runtime_version" in input_:
        params["version"] = str(input_["agent_runtime_version"])
...
async def async_get_agent_runtime(
