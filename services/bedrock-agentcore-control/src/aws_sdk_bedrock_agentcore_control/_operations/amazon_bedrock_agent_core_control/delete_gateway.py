...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.delete_gateway_response.DeleteGatewayResponse = aws_sdk_bedrock_agentcore_control.types.delete_gateway_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_gateway_request.DeleteGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
