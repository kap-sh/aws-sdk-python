...
) -> aws_sdk_bedrock_agentcore_control.types.create_payment_connector_response.CreatePaymentConnectorResponse:
    out: aws_sdk_bedrock_agentcore_control.types.create_payment_connector_response.CreatePaymentConnectorResponse = aws_sdk_bedrock_agentcore_control.types.create_payment_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_payment_connector_request.CreatePaymentConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_payment_connector_request.serialize_json(
            input_
        )
    ).encode()
