...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceException":
            ...
            raise aws_sdk_bedrock_agentcore_control.errors.service_exception.ServiceException.from_json(
                data
            )
        ...
        case "ThrottledException":
            ...
            raise aws_sdk_bedrock_agentcore_control.errors.throttled_exception.ThrottledException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_memory_output.CreateMemoryOutput = aws_sdk_bedrock_agentcore_control.types.create_memory_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_memory_input.CreateMemoryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_memory_input.serialize_json(
            input_
        )
    ).encode()
