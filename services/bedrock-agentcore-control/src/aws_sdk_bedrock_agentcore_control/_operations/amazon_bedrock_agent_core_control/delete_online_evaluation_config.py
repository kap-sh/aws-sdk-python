...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.delete_online_evaluation_config_response.DeleteOnlineEvaluationConfigResponse = aws_sdk_bedrock_agentcore_control.types.delete_online_evaluation_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_online_evaluation_config_request.DeleteOnlineEvaluationConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
