...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_gateway_targets_response.ListGatewayTargetsResponse = aws_sdk_bedrock_agentcore_control.types.list_gateway_targets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_gateway_targets_request.ListGatewayTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_gateway_targets(
