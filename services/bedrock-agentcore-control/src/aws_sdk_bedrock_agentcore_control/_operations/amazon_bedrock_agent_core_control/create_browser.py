...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_browser_response.CreateBrowserResponse = aws_sdk_bedrock_agentcore_control.types.create_browser_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_browser_request.CreateBrowserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_browser_request.serialize_json(
            input_
        )
    ).encode()
