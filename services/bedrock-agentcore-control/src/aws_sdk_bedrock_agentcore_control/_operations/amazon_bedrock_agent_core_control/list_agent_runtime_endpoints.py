...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_agent_runtime_endpoints_response.ListAgentRuntimeEndpointsResponse = aws_sdk_bedrock_agentcore_control.types.list_agent_runtime_endpoints_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_agent_runtime_endpoints_request.ListAgentRuntimeEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
