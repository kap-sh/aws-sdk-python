...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.delete_policy_engine_response.DeletePolicyEngineResponse = aws_sdk_bedrock_agentcore_control.types.delete_policy_engine_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_policy_engine_request.DeletePolicyEngineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
