...
import aws_sdk_bedrock_agentcore_control.types.payment_connector_summaries
...
) -> aws_sdk_bedrock_agentcore_control.types.list_payment_connectors_response.ListPaymentConnectorsResponse:
    out: aws_sdk_bedrock_agentcore_control.types.list_payment_connectors_response.ListPaymentConnectorsResponse = aws_sdk_bedrock_agentcore_control.types.list_payment_connectors_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_payment_connectors_request.ListPaymentConnectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/payments/managers/{paymentManagerId}/connectors-list"
    )
    url = url.replace(
...
async def async_list_payment_connectors(
