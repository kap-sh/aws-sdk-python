...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_dataset_response.CreateDatasetResponse = aws_sdk_bedrock_agentcore_control.types.create_dataset_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_dataset_request.CreateDatasetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_dataset_request.serialize_json(
            input_
        )
    ).encode()
