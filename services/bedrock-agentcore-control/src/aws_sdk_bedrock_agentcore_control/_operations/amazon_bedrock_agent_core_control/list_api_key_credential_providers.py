...
import aws_sdk_bedrock_agentcore_control.types.api_key_credential_providers
...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_api_key_credential_providers_response.ListApiKeyCredentialProvidersResponse = aws_sdk_bedrock_agentcore_control.types.list_api_key_credential_providers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_api_key_credential_providers_request.ListApiKeyCredentialProvidersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.list_api_key_credential_providers_request.serialize_json(
            input_
        )
    ).encode()
