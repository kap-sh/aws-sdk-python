...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.create_gateway_target_response.CreateGatewayTargetResponse = aws_sdk_bedrock_agentcore_control.types.create_gateway_target_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.create_gateway_target_request.CreateGatewayTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.create_gateway_target_request.serialize_json(
            input_
        )
    ).encode()
