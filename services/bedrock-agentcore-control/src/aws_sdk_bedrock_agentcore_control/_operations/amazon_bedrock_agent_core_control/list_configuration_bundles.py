...
import aws_sdk_bedrock_agentcore_control.types.configuration_bundle_summary_list
...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_configuration_bundles_response.ListConfigurationBundlesResponse = aws_sdk_bedrock_agentcore_control.types.list_configuration_bundles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_configuration_bundles_request.ListConfigurationBundlesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_configuration_bundles(
