...
import aws_sdk_bedrock_agentcore_control.types.policy_generation_summary_list
...
) -> aws_sdk_bedrock_agentcore_control.types.list_policy_generation_summaries_response.ListPolicyGenerationSummariesResponse:
    out: aws_sdk_bedrock_agentcore_control.types.list_policy_generation_summaries_response.ListPolicyGenerationSummariesResponse = aws_sdk_bedrock_agentcore_control.types.list_policy_generation_summaries_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_policy_generation_summaries_request.ListPolicyGenerationSummariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
