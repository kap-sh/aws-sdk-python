...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_browser_profile_response.GetBrowserProfileResponse = aws_sdk_bedrock_agentcore_control.types.get_browser_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_browser_profile_request.GetBrowserProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_browser_profile(
