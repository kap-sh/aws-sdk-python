...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_configuration_bundle_response.GetConfigurationBundleResponse = aws_sdk_bedrock_agentcore_control.types.get_configuration_bundle_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_configuration_bundle_request.GetConfigurationBundleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
