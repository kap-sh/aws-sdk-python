...
import aws_sdk_bedrock_agentcore_control.types.gateway_summaries
...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_gateways_response.ListGatewaysResponse = aws_sdk_bedrock_agentcore_control.types.list_gateways_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_gateways_request.ListGatewaysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
