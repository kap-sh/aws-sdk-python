...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.update_dataset_examples_response.UpdateDatasetExamplesResponse = aws_sdk_bedrock_agentcore_control.types.update_dataset_examples_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.update_dataset_examples_request.UpdateDatasetExamplesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.update_dataset_examples_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_dataset_examples(
