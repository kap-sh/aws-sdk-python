...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.delete_payment_manager_response.DeletePaymentManagerResponse = aws_sdk_bedrock_agentcore_control.types.delete_payment_manager_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.delete_payment_manager_request.DeletePaymentManagerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
