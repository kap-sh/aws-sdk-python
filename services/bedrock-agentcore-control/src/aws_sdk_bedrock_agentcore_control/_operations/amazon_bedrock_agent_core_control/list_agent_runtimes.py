...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_agent_runtimes_response.ListAgentRuntimesResponse = aws_sdk_bedrock_agentcore_control.types.list_agent_runtimes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_agent_runtimes_request.ListAgentRuntimesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
