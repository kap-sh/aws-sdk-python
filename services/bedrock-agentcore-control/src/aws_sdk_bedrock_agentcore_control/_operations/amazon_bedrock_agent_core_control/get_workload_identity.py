...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.get_workload_identity_response.GetWorkloadIdentityResponse = aws_sdk_bedrock_agentcore_control.types.get_workload_identity_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.get_workload_identity_request.GetWorkloadIdentityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.get_workload_identity_request.serialize_json(
            input_
        )
    ).encode()
