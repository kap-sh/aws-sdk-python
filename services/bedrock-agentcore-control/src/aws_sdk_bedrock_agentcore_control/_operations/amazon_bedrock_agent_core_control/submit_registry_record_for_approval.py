...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.submit_registry_record_for_approval_response.SubmitRegistryRecordForApprovalResponse = aws_sdk_bedrock_agentcore_control.types.submit_registry_record_for_approval_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.submit_registry_record_for_approval_request.SubmitRegistryRecordForApprovalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/registries/{registryId}/records/{recordId}/submit-for-approval"
    )
...
async def async_submit_registry_record_for_approval(
