...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.list_payment_managers_response.ListPaymentManagersResponse = aws_sdk_bedrock_agentcore_control.types.list_payment_managers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.list_payment_managers_request.ListPaymentManagersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_payment_managers(
