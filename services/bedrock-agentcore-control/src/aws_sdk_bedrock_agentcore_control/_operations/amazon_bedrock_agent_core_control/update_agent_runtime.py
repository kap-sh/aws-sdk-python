...
def handle_response(
    ...
    out: aws_sdk_bedrock_agentcore_control.types.update_agent_runtime_response.UpdateAgentRuntimeResponse = aws_sdk_bedrock_agentcore_control.types.update_agent_runtime_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock_agentcore_control.types.update_agent_runtime_request.UpdateAgentRuntimeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock_agentcore_control.types.update_agent_runtime_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_agent_runtime(
