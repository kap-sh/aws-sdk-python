...
def serialize_json(value: CustomConsolidationConfigurationInput) -> dict:
    if "semanticConsolidationOverride" in value:
        ...
        return {
            "semanticConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.semantic_override_consolidation_configuration_input.serialize_json(
        ...
        return {
            "summaryConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.summary_override_consolidation_configuration_input.serialize_json(
        ...
        return {
            "userPreferenceConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.user_preference_override_consolidation_configuration_input.serialize_json(
        ...
        return {
            "episodicConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.episodic_override_consolidation_configuration_input.serialize_json(
...
def deserialize_json(data: dict) -> CustomConsolidationConfigurationInput:
    if "semanticConsolidationOverride" in data:
        ...
        return {
            "semanticConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.semantic_override_consolidation_configuration_input.deserialize_json(
        ...
        return {
            "summaryConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.summary_override_consolidation_configuration_input.deserialize_json(
        ...
        return {
            "userPreferenceConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.user_preference_override_consolidation_configuration_input.deserialize_json(
        ...
        return {
            "episodicConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.episodic_override_consolidation_configuration_input.deserialize_json(
