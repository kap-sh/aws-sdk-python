...
class GetApiKeyCredentialProviderResponse(TypedDict):
...
def deserialize_json(data: dict) -> GetApiKeyCredentialProviderResponse:
    ...
    if "apiKeySecretArn" in data:
        ...
        raise DeserializationError("GetApiKeyCredentialProviderResponse.api_key_secret_arn required")
    ...
    if "credentialProviderArn" in data:
        ...
        raise DeserializationError("GetApiKeyCredentialProviderResponse.credential_provider_arn required")
    if "createdTime" in data:
        import aws_sdk_bedrock_agentcore_control.types._prelude.timestamp
        out["created_time"] = aws_sdk_bedrock_agentcore_control.types._prelude.timestamp.deserialize_json(data["createdTime"])
    else:
        raise DeserializationError("GetApiKeyCredentialProviderResponse.created_time required")
    if "lastUpdatedTime" in data:
        ...
        raise DeserializationError("GetApiKeyCredentialProviderResponse.last_updated_time required")
    return out