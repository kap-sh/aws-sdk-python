...
def serialize_json(value: BrowserNetworkConfiguration) -> dict:
    out: dict = {}
    import aws_sdk_bedrock_agentcore_control.types.browser_network_mode
    out["networkMode"] = aws_sdk_bedrock_agentcore_control.types.browser_network_mode.serialize_json(value.get("network_mode", 'PUBLIC'))
...
def deserialize_json(data: dict) -> BrowserNetworkConfiguration:
    ...
    if "networkMode" in data:
        import aws_sdk_bedrock_agentcore_control.types.browser_network_mode
        out["network_mode"] = aws_sdk_bedrock_agentcore_control.types.browser_network_mode.deserialize_json(data["networkMode"])
    else:
