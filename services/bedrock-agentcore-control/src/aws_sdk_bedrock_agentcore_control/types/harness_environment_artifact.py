...
HarnessEnvironmentArtifact: TypeAlias = _HarnessEnvironmentArtifact_containerConfiguration
...
def deserialize_json(data: dict) -> HarnessEnvironmentArtifact:
    if "containerConfiguration" in data:
        ...
        raise DeserializationError("HarnessEnvironmentArtifact: no recognized variant key")