"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#ListAgentRuntimeEndpointsRequest``."""
...
class ListAgentRuntimeEndpointsRequest(TypedDict, closed=True):
    agent_runtime_id: (
...
# --- restJson1 ser/de ---
def serialize_json(value: ListAgentRuntimeEndpointsRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListAgentRuntimeEndpointsRequest:
    out: ListAgentRuntimeEndpointsRequest = {}  # type: ignore[typeddict-item]
    return out
