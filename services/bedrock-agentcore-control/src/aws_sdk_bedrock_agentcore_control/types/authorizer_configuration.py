...
def serialize_json(value: AuthorizerConfiguration) -> dict:
    if "customJWTAuthorizer" in value:
        ...
        return {
            "customJWTAuthorizer": aws_sdk_bedrock_agentcore_control.types.custom_jwt_authorizer_configuration.serialize_json(
...
def deserialize_json(data: dict) -> AuthorizerConfiguration:
    if "customJWTAuthorizer" in data:
        ...
        return {
            "customJWTAuthorizer": aws_sdk_bedrock_agentcore_control.types.custom_jwt_authorizer_configuration.deserialize_json(
