...
def serialize_json(value: GatewayPolicyEngineConfiguration) -> dict:
    ...
    out["arn"] = value["arn"]
    import aws_sdk_bedrock_agentcore_control.types.gateway_policy_engine_mode
    out["mode"] = aws_sdk_bedrock_agentcore_control.types.gateway_policy_engine_mode.serialize_json(value["mode"])
    return out
...
def deserialize_json(data: dict) -> GatewayPolicyEngineConfiguration:
    ...
    if "mode" in data:
        import aws_sdk_bedrock_agentcore_control.types.gateway_policy_engine_mode
        out["mode"] = aws_sdk_bedrock_agentcore_control.types.gateway_policy_engine_mode.deserialize_json(data["mode"])
    else:
