...
class CreatePolicyEngineResponse(TypedDict):
...
def deserialize_json(data: dict) -> CreatePolicyEngineResponse:
    ...
    if "policyEngineId" in data:
        ...
        raise DeserializationError("CreatePolicyEngineResponse.policy_engine_id required")
    if "name" in data:
        out["name"] = data["name"]
    else:
    ...
    if "policyEngineArn" in data:
        ...
        raise DeserializationError("CreatePolicyEngineResponse.policy_engine_arn required")
    if "status" in data:
        import aws_sdk_bedrock_agentcore_control.types.policy_engine_status
