"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#GetRegistryResponse``."""
...
# --- restJson1 ser/de ---
def serialize_json(value: GetRegistryResponse) -> dict:
    out: dict = {}
    out["name"] = value["name"]
    ...
    import aws_sdk_bedrock_agentcore_control.types.registry_status
    out["status"] = aws_sdk_bedrock_agentcore_control.types.registry_status.serialize_json(value["status"])
...
def deserialize_json(data: dict) -> GetRegistryResponse:
    out: GetRegistryResponse = {}  # type: ignore[typeddict-item]
    if "name" in data:
        out["name"] = data["name"]
    else:
        raise DeserializationError("GetRegistryResponse.name required")
    if "description" in data:
        out["description"] = data["description"]
    if "registryId" in data:
        out["registry_id"] = data["registryId"]
    else:
        raise DeserializationError("GetRegistryResponse.registry_id required")
    if "registryArn" in data:
        out["registry_arn"] = data["registryArn"]
    else:
        raise DeserializationError("GetRegistryResponse.registry_arn required")
    ...
    if "status" in data:
        import aws_sdk_bedrock_agentcore_control.types.registry_status
        out["status"] = aws_sdk_bedrock_agentcore_control.types.registry_status.deserialize_json(data["status"])
    else:
        raise DeserializationError("GetRegistryResponse.status required")
    ...
    if "createdAt" in data:
        ...
        raise DeserializationError("GetRegistryResponse.created_at required")
    if "updatedAt" in data:
        import aws_sdk_bedrock_agentcore_control.types.date_timestamp
        out["updated_at"] = aws_sdk_bedrock_agentcore_control.types.date_timestamp.deserialize_json(data["updatedAt"])
    else:
        raise DeserializationError("GetRegistryResponse.updated_at required")
    return out