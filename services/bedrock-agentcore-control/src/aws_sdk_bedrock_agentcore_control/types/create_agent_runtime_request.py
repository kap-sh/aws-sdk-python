...
class CreateAgentRuntimeRequest(TypedDict):
    ...
    lifecycle_configuration: NotRequired["aws_sdk_bedrock_agentcore_control.types.lifecycle_configuration.LifecycleConfiguration"]
...
def deserialize_json(data: dict) -> CreateAgentRuntimeRequest:
    ...
    if "agentRuntimeName" in data:
        ...
        raise DeserializationError("CreateAgentRuntimeRequest.agent_runtime_name required")
    if "agentRuntimeArtifact" in data:
        ...
        raise DeserializationError("CreateAgentRuntimeRequest.agent_runtime_artifact required")
    if "roleArn" in data:
    ...
    if "networkConfiguration" in data:
        ...
        raise DeserializationError("CreateAgentRuntimeRequest.network_configuration required")
