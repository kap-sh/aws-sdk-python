...
class CreateAgentRuntimeRequest(TypedDict):
    agent_runtime_name: (
...
def serialize_json(value: CreateAgentRuntimeRequest) -> dict:
    ...
    out["agentRuntimeArtifact"] = (
        aws_sdk_bedrock_agentcore_control.types.agent_runtime_artifact.serialize_json(
    ...
    if "request_header_configuration" in value:
        ...
        out["requestHeaderConfiguration"] = (
            aws_sdk_bedrock_agentcore_control.types.request_header_configuration.serialize_json(
    ...
    if "protocol_configuration" in value:
        ...
        out["protocolConfiguration"] = (
            aws_sdk_bedrock_agentcore_control.types.protocol_configuration.serialize_json(
...
def deserialize_json(data: dict) -> CreateAgentRuntimeRequest:
    ...
    if "agentRuntimeArtifact" in data:
        ...
        out["agent_runtime_artifact"] = (
            aws_sdk_bedrock_agentcore_control.types.agent_runtime_artifact.deserialize_json(
    ...
    if "requestHeaderConfiguration" in data:
        ...
        out["request_header_configuration"] = (
            aws_sdk_bedrock_agentcore_control.types.request_header_configuration.deserialize_json(
    ...
    if "protocolConfiguration" in data:
        ...
        out["protocol_configuration"] = (
            aws_sdk_bedrock_agentcore_control.types.protocol_configuration.deserialize_json(
