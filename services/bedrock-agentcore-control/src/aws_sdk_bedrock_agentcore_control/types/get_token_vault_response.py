...
class GetTokenVaultResponse(TypedDict):
    token_vault_id: "aws_sdk_bedrock_agentcore_control.types.token_vault_id_type.TokenVaultIdType"
...
def serialize_json(value: GetTokenVaultResponse) -> dict:
    ...
    import aws_sdk_bedrock_agentcore_control.types.kms_configuration
    out["kmsConfiguration"] = aws_sdk_bedrock_agentcore_control.types.kms_configuration.serialize_json(value["kms_configuration"])
    import aws_sdk_bedrock_agentcore_control.types._prelude.timestamp
    out["lastModifiedDate"] = aws_sdk_bedrock_agentcore_control.types._prelude.timestamp.serialize_json(value["last_modified_date"])
    return out
...
def deserialize_json(data: dict) -> GetTokenVaultResponse:
    ...
    if "kmsConfiguration" in data:
        import aws_sdk_bedrock_agentcore_control.types.kms_configuration
        out["kms_configuration"] = aws_sdk_bedrock_agentcore_control.types.kms_configuration.deserialize_json(data["kmsConfiguration"])
    else:
        raise DeserializationError("GetTokenVaultResponse.kms_configuration required")
    if "lastModifiedDate" in data:
        import aws_sdk_bedrock_agentcore_control.types._prelude.timestamp
        out["last_modified_date"] = aws_sdk_bedrock_agentcore_control.types._prelude.timestamp.deserialize_json(data["lastModifiedDate"])
    else:
