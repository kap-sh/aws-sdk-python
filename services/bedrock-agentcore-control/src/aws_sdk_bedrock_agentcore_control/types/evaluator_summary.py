...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agentcore_control.types.evaluator_type
    import aws_sdk_bedrock_agentcore_control.types.kms_key_arn
    import datetime

class EvaluatorSummary(TypedDict):
    ...
    evaluator_type: "aws_sdk_bedrock_agentcore_control.types.evaluator_type.EvaluatorType"
    ...
    level: NotRequired["aws_sdk_bedrock_agentcore_control.types.evaluator_level.EvaluatorLevel"]
...
def serialize_json(value: EvaluatorSummary) -> dict:
    ...
    import aws_sdk_bedrock_agentcore_control.types.evaluator_type
    out["evaluatorType"] = aws_sdk_bedrock_agentcore_control.types.evaluator_type.serialize_json(value["evaluator_type"])
    if "level" in value:
        import aws_sdk_bedrock_agentcore_control.types.evaluator_level
...
def deserialize_json(data: dict) -> EvaluatorSummary:
    ...
    if "evaluatorType" in data:
        import aws_sdk_bedrock_agentcore_control.types.evaluator_type
        out["evaluator_type"] = aws_sdk_bedrock_agentcore_control.types.evaluator_type.deserialize_json(data["evaluatorType"])
    else:
