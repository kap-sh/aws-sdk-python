...
class EvaluatorSummary(TypedDict):
    ...
    evaluator_type: (
        "aws_sdk_bedrock_agentcore_control.types.evaluator_type.EvaluatorType"
    )
...
def serialize_json(value: EvaluatorSummary) -> dict:
    ...
    out["evaluatorType"] = (
        aws_sdk_bedrock_agentcore_control.types.evaluator_type.serialize_json(
...
def deserialize_json(data: dict) -> EvaluatorSummary:
    ...
    if "evaluatorType" in data:
        ...
        out["evaluator_type"] = (
            aws_sdk_bedrock_agentcore_control.types.evaluator_type.deserialize_json(
                data["evaluatorType"]
            )
        )
    else:
