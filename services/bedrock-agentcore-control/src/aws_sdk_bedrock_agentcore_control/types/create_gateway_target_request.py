...
class CreateGatewayTargetRequest(TypedDict):
    ...
    credential_provider_configurations: NotRequired["aws_sdk_bedrock_agentcore_control.types.credential_provider_configurations.CredentialProviderConfigurations"]
...
def deserialize_json(data: dict) -> CreateGatewayTargetRequest:
    ...
    if "targetConfiguration" in data:
        ...
        raise DeserializationError("CreateGatewayTargetRequest.target_configuration required")
