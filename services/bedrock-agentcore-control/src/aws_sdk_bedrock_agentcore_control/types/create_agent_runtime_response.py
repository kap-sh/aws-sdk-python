...
class CreateAgentRuntimeResponse(TypedDict):
...
def deserialize_json(data: dict) -> CreateAgentRuntimeResponse:
    ...
    if "agentRuntimeArn" in data:
        ...
        raise DeserializationError("CreateAgentRuntimeResponse.agent_runtime_arn required")
    ...
    if "agentRuntimeId" in data:
        ...
        raise DeserializationError("CreateAgentRuntimeResponse.agent_runtime_id required")
    if "agentRuntimeVersion" in data:
        out["agent_runtime_version"] = data["agentRuntimeVersion"]
    else:
        raise DeserializationError("CreateAgentRuntimeResponse.agent_runtime_version required")
