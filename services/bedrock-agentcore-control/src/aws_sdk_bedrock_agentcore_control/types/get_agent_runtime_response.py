...
class GetAgentRuntimeResponse(TypedDict, closed=True):
    ...
    agent_runtime_artifact: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.agent_runtime_artifact.AgentRuntimeArtifact"
    ]
...
def serialize_json(value: GetAgentRuntimeResponse) -> dict:
    ...
    if "metadata_configuration" in value:
        ...
        out["metadataConfiguration"] = (
            aws_sdk_bedrock_agentcore_control.types.runtime_metadata_configuration.serialize_json(
...
def deserialize_json(data: dict) -> GetAgentRuntimeResponse:
    ...
    if "metadataConfiguration" in data:
        ...
        out["metadata_configuration"] = (
            aws_sdk_bedrock_agentcore_control.types.runtime_metadata_configuration.deserialize_json(
