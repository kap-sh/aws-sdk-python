"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#HarnessSkillS3Source``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agentcore_control.types.harness_skill_s3_uri


class HarnessSkillS3Source(TypedDict):
    uri: (
        "aws_sdk_bedrock_agentcore_control.types.harness_skill_s3_uri.HarnessSkillS3Uri"
    )
