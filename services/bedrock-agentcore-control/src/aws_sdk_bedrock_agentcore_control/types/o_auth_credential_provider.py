...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agentcore_control.types.o_auth_credential_provider_arn
    import aws_sdk_bedrock_agentcore_control.types.o_auth_custom_parameters
    import aws_sdk_bedrock_agentcore_control.types.o_auth_default_return_url
    import aws_sdk_bedrock_agentcore_control.types.o_auth_grant_type
    import aws_sdk_bedrock_agentcore_control.types.o_auth_scopes


class OAuthCredentialProvider(TypedDict):
    provider_arn: "aws_sdk_bedrock_agentcore_control.types.o_auth_credential_provider_arn.OAuthCredentialProviderArn"
    ...
    scopes: "aws_sdk_bedrock_agentcore_control.types.o_auth_scopes.OAuthScopes"
    ...
    custom_parameters: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.o_auth_custom_parameters.OAuthCustomParameters"
    ]
    ...
    grant_type: (
        "aws_sdk_bedrock_agentcore_control.types.o_auth_grant_type.OAuthGrantType"
    )
    ...
    default_return_url: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.o_auth_default_return_url.OAuthDefaultReturnUrl"
    ]
...
def serialize_json(value: OAuthCredentialProvider) -> dict:
    ...
    out["scopes"] = (
        aws_sdk_bedrock_agentcore_control.types.o_auth_scopes.serialize_json(
            value["scopes"]
        )
    )
    if "custom_parameters" in value:
        ...
        out["customParameters"] = (
            aws_sdk_bedrock_agentcore_control.types.o_auth_custom_parameters.serialize_json(
    ...
    out["grantType"] = (
        aws_sdk_bedrock_agentcore_control.types.o_auth_grant_type.serialize_json(
...
def deserialize_json(data: dict) -> OAuthCredentialProvider:
    ...
    if "scopes" in data:
        ...
        out["scopes"] = (
            aws_sdk_bedrock_agentcore_control.types.o_auth_scopes.deserialize_json(
                data["scopes"]
            )
        )
    else:
    ...
    if "customParameters" in data:
        ...
        out["custom_parameters"] = (
            aws_sdk_bedrock_agentcore_control.types.o_auth_custom_parameters.deserialize_json(
    ...
    if "grantType" in data:
        ...
        out["grant_type"] = (
            aws_sdk_bedrock_agentcore_control.types.o_auth_grant_type.deserialize_json(
                data["grantType"]
            )
        )
    else:
