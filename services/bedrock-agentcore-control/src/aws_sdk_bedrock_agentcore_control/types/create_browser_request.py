...
class CreateBrowserRequest(TypedDict):
    ...
    browser_signing: NotRequired["aws_sdk_bedrock_agentcore_control.types.browser_signing_config_input.BrowserSigningConfigInput"]
...
def serialize_json(value: CreateBrowserRequest) -> dict:
    ...
    if "browser_signing" in value:
        import aws_sdk_bedrock_agentcore_control.types.browser_signing_config_input
        out["browserSigning"] = aws_sdk_bedrock_agentcore_control.types.browser_signing_config_input.serialize_json(value["browser_signing"])
...
def deserialize_json(data: dict) -> CreateBrowserRequest:
    ...
    if "networkConfiguration" in data:
        ...
        raise DeserializationError("CreateBrowserRequest.network_configuration required")
    ...
    if "browserSigning" in data:
        import aws_sdk_bedrock_agentcore_control.types.browser_signing_config_input
        out["browser_signing"] = aws_sdk_bedrock_agentcore_control.types.browser_signing_config_input.deserialize_json(data["browserSigning"])
