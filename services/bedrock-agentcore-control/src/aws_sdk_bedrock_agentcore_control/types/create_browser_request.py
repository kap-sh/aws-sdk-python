...
def serialize_json(value: CreateBrowserRequest) -> dict:
    ...
    if "browser_signing" in value:
        ...
        out["browserSigning"] = (
            aws_sdk_bedrock_agentcore_control.types.browser_signing_config_input.serialize_json(
...
def deserialize_json(data: dict) -> CreateBrowserRequest:
    ...
    if "browserSigning" in data:
        ...
        out["browser_signing"] = (
            aws_sdk_bedrock_agentcore_control.types.browser_signing_config_input.deserialize_json(
                data["browserSigning"]
            )
        )
