...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agentcore_control.types.custom_consolidation_configuration_input


class _ModifyConsolidationConfiguration_customConsolidationConfiguration(TypedDict):
    customConsolidationConfiguration: "aws_sdk_bedrock_agentcore_control.types.custom_consolidation_configuration_input.CustomConsolidationConfigurationInput"
...
def serialize_json(value: ModifyConsolidationConfiguration) -> dict:
    if "customConsolidationConfiguration" in value:
        ...
        return {
            "customConsolidationConfiguration": aws_sdk_bedrock_agentcore_control.types.custom_consolidation_configuration_input.serialize_json(
...
def deserialize_json(data: dict) -> ModifyConsolidationConfiguration:
    if "customConsolidationConfiguration" in data:
        ...
        return {
            "customConsolidationConfiguration": aws_sdk_bedrock_agentcore_control.types.custom_consolidation_configuration_input.deserialize_json(
