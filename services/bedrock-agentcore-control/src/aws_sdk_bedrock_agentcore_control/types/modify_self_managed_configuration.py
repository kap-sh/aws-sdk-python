...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agentcore_control.types.modify_invocation_configuration_input
    import aws_sdk_bedrock_agentcore_control.types.trigger_condition_input_list


class ModifySelfManagedConfiguration(TypedDict):
    ...
    invocation_configuration: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.modify_invocation_configuration_input.ModifyInvocationConfigurationInput"
    ]
...
def serialize_json(value: ModifySelfManagedConfiguration) -> dict:
    ...
    if "invocation_configuration" in value:
        ...
        out["invocationConfiguration"] = (
            aws_sdk_bedrock_agentcore_control.types.modify_invocation_configuration_input.serialize_json(
...
def deserialize_json(data: dict) -> ModifySelfManagedConfiguration:
    ...
    if "invocationConfiguration" in data:
        ...
        out["invocation_configuration"] = (
            aws_sdk_bedrock_agentcore_control.types.modify_invocation_configuration_input.deserialize_json(
