...
class CreateApiKeyCredentialProviderRequest(TypedDict):
    ...
    api_key: "aws_sdk_bedrock_agentcore_control.types.default_api_key_type.DefaultApiKeyType"
...
def deserialize_json(data: dict) -> CreateApiKeyCredentialProviderRequest:
    ...
    if "name" in data:
        ...
        raise DeserializationError("CreateApiKeyCredentialProviderRequest.name required")
    if "apiKey" in data:
