...
def deserialize_json(data: dict) -> GetWorkloadIdentityResponse:
    ...
    if "workloadIdentityArn" in data:
        ...
        raise DeserializationError("GetWorkloadIdentityResponse.workload_identity_arn required")
    ...
    if "lastUpdatedTime" in data:
        ...
        raise DeserializationError("GetWorkloadIdentityResponse.last_updated_time required")
    return out