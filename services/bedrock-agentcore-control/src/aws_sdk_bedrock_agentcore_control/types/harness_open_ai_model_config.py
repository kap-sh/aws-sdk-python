"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#HarnessOpenAiModelConfig``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agentcore_control.types.harness_open_ai_api_format
...
class HarnessOpenAiModelConfig(TypedDict):
    ...
    api_format: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.harness_open_ai_api_format.HarnessOpenAiApiFormat"
    ]
...
def serialize_json(value: HarnessOpenAiModelConfig) -> dict:
    ...
    if "api_format" in value:
        ...
        out["apiFormat"] = (
            aws_sdk_bedrock_agentcore_control.types.harness_open_ai_api_format.serialize_json(
                value["api_format"]
            )
        )
...
def deserialize_json(data: dict) -> HarnessOpenAiModelConfig:
    ...
    if "apiFormat" in data:
        ...
        out["api_format"] = (
            aws_sdk_bedrock_agentcore_control.types.harness_open_ai_api_format.deserialize_json(
                data["apiFormat"]
            )
        )
