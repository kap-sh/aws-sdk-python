...
# --- restJson1 ser/de ---
def serialize_json(value: DeletePaymentManagerRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DeletePaymentManagerRequest:
    out: DeletePaymentManagerRequest = {}  # type: ignore[typeddict-item]
    return out
