...
class IncludedOauth2ProviderConfigInput(TypedDict):
    ...
    issuer: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.issuer_url_type.IssuerUrlType"
    ]
    ...
    authorization_endpoint: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.authorization_endpoint_type.AuthorizationEndpointType"
    ]
