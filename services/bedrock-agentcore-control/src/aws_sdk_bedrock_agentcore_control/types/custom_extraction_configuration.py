...
def serialize_json(value: CustomExtractionConfiguration) -> dict:
    if "semanticExtractionOverride" in value:
        ...
        return {
            "semanticExtractionOverride": aws_sdk_bedrock_agentcore_control.types.semantic_extraction_override.serialize_json(
        ...
        return {
            "userPreferenceExtractionOverride": aws_sdk_bedrock_agentcore_control.types.user_preference_extraction_override.serialize_json(
        ...
        return {
            "episodicExtractionOverride": aws_sdk_bedrock_agentcore_control.types.episodic_extraction_override.serialize_json(
...
def deserialize_json(data: dict) -> CustomExtractionConfiguration:
    if "semanticExtractionOverride" in data:
        ...
        return {
            "semanticExtractionOverride": aws_sdk_bedrock_agentcore_control.types.semantic_extraction_override.deserialize_json(
        ...
        return {
            "userPreferenceExtractionOverride": aws_sdk_bedrock_agentcore_control.types.user_preference_extraction_override.deserialize_json(
        ...
        return {
            "episodicExtractionOverride": aws_sdk_bedrock_agentcore_control.types.episodic_extraction_override.deserialize_json(
