...
def serialize_json(value: StringValidation) -> dict:
    ...
    out["allowedValues"] = (
        aws_sdk_bedrock_agentcore_control.types.allowed_string_values_list.serialize_json(
...
def deserialize_json(data: dict) -> StringValidation:
    ...
    if "allowedValues" in data:
        ...
        out["allowed_values"] = (
            aws_sdk_bedrock_agentcore_control.types.allowed_string_values_list.deserialize_json(
                data["allowedValues"]
            )
        )
    else:
