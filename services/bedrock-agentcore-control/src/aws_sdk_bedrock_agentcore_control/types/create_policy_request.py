...
def serialize_json(value: CreatePolicyRequest) -> dict:
    ...
    import aws_sdk_bedrock_agentcore_control.types.policy_validation_mode
    out["validationMode"] = aws_sdk_bedrock_agentcore_control.types.policy_validation_mode.serialize_json(value.get("validation_mode", 'FAIL_ON_ANY_FINDINGS'))
...
def deserialize_json(data: dict) -> CreatePolicyRequest:
    ...
    if "validationMode" in data:
        import aws_sdk_bedrock_agentcore_control.types.policy_validation_mode
        out["validation_mode"] = aws_sdk_bedrock_agentcore_control.types.policy_validation_mode.deserialize_json(data["validationMode"])
    else:
