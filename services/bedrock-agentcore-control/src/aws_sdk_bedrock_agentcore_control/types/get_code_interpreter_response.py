...
def deserialize_json(data: dict) -> GetCodeInterpreterResponse:
    ...
    if "codeInterpreterId" in data:
        ...
        raise DeserializationError("GetCodeInterpreterResponse.code_interpreter_id required")
    if "codeInterpreterArn" in data:
        out["code_interpreter_arn"] = data["codeInterpreterArn"]
    else:
        raise DeserializationError("GetCodeInterpreterResponse.code_interpreter_arn required")
    if "name" in data:
        out["name"] = data["name"]
    else:
    ...
    if "networkConfiguration" in data:
        ...
        raise DeserializationError("GetCodeInterpreterResponse.network_configuration required")
    if "status" in data:
        import aws_sdk_bedrock_agentcore_control.types.code_interpreter_status
    ...
    if "lastUpdatedAt" in data:
        ...
        raise DeserializationError("GetCodeInterpreterResponse.last_updated_at required")
    return out