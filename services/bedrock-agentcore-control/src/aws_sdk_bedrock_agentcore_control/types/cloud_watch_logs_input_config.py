...
class CloudWatchLogsInputConfig(TypedDict):
    ...
    service_names: (
        "aws_sdk_bedrock_agentcore_control.types.service_names_list.ServiceNamesList"
    )
...
def serialize_json(value: CloudWatchLogsInputConfig) -> dict:
    ...
    out["logGroupNames"] = (
        aws_sdk_bedrock_agentcore_control.types.log_group_names_list.serialize_json(
    ...
    out["serviceNames"] = (
        aws_sdk_bedrock_agentcore_control.types.service_names_list.serialize_json(
            value["service_names"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> CloudWatchLogsInputConfig:
    ...
    if "logGroupNames" in data:
        ...
        out["log_group_names"] = (
            aws_sdk_bedrock_agentcore_control.types.log_group_names_list.deserialize_json(
                data["logGroupNames"]
            )
        )
    else:
    ...
    if "serviceNames" in data:
        ...
        out["service_names"] = (
            aws_sdk_bedrock_agentcore_control.types.service_names_list.deserialize_json(
                data["serviceNames"]
            )
        )
    else:
