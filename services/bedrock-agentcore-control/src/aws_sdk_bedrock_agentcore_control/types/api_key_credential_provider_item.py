...
def deserialize_json(data: dict) -> ApiKeyCredentialProviderItem:
    ...
    if "credentialProviderArn" in data:
        ...
        raise DeserializationError("ApiKeyCredentialProviderItem.credential_provider_arn required")
    ...
    if "lastUpdatedTime" in data:
        ...
        raise DeserializationError("ApiKeyCredentialProviderItem.last_updated_time required")
    return out