...
class CustomJWTAuthorizerConfiguration(TypedDict):
    ...
    allowed_audience: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.allowed_audience_list.AllowedAudienceList"
    ]
    ...
    allowed_clients: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.allowed_clients_list.AllowedClientsList"
    ]
    ...
    allowed_scopes: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.allowed_scopes_type.AllowedScopesType"
    ]
    """<p>An array of scopes that are allowed to access the token.</p>"""
    custom_claims: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.custom_claim_validations_type.CustomClaimValidationsType"
    ]
...
def serialize_json(value: CustomJWTAuthorizerConfiguration) -> dict:
    ...
    if "allowed_audience" in value:
        ...
        out["allowedAudience"] = (
            aws_sdk_bedrock_agentcore_control.types.allowed_audience_list.serialize_json(
    ...
    if "allowed_clients" in value:
        ...
        out["allowedClients"] = (
            aws_sdk_bedrock_agentcore_control.types.allowed_clients_list.serialize_json(
    ...
    if "allowed_scopes" in value:
        ...
        out["allowedScopes"] = (
            aws_sdk_bedrock_agentcore_control.types.allowed_scopes_type.serialize_json(
    ...
    if "custom_claims" in value:
        ...
        out["customClaims"] = (
            aws_sdk_bedrock_agentcore_control.types.custom_claim_validations_type.serialize_json(
                value["custom_claims"]
            )
        )
...
def deserialize_json(data: dict) -> CustomJWTAuthorizerConfiguration:
    ...
    if "allowedAudience" in data:
        ...
        out["allowed_audience"] = (
            aws_sdk_bedrock_agentcore_control.types.allowed_audience_list.deserialize_json(
    ...
    if "allowedClients" in data:
        ...
        out["allowed_clients"] = (
            aws_sdk_bedrock_agentcore_control.types.allowed_clients_list.deserialize_json(
                data["allowedClients"]
            )
        )
    if "allowedScopes" in data:
        ...
        out["allowed_scopes"] = (
            aws_sdk_bedrock_agentcore_control.types.allowed_scopes_type.deserialize_json(
                data["allowedScopes"]
            )
        )
    if "customClaims" in data:
        ...
        out["custom_claims"] = (
            aws_sdk_bedrock_agentcore_control.types.custom_claim_validations_type.deserialize_json(
                data["customClaims"]
            )
        )
