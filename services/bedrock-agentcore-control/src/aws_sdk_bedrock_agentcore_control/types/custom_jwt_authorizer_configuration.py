...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agentcore_control.types.allowed_audience_list
    import aws_sdk_bedrock_agentcore_control.types.allowed_clients_list
    import aws_sdk_bedrock_agentcore_control.types.allowed_scopes_type
    import aws_sdk_bedrock_agentcore_control.types.custom_claim_validations_type
    import aws_sdk_bedrock_agentcore_control.types.discovery_url
...
class CustomJWTAuthorizerConfiguration(TypedDict):
    discovery_url: "aws_sdk_bedrock_agentcore_control.types.discovery_url.DiscoveryUrl"
    ...
    allowed_audience: NotRequired["aws_sdk_bedrock_agentcore_control.types.allowed_audience_list.AllowedAudienceList"]
    """<p>Represents individual audience values that are validated in the incoming JWT token validation process.</p>"""
    allowed_clients: NotRequired["aws_sdk_bedrock_agentcore_control.types.allowed_clients_list.AllowedClientsList"]
    """<p>Represents individual client IDs that are validated in the incoming JWT token validation process.</p>"""
    allowed_scopes: NotRequired["aws_sdk_bedrock_agentcore_control.types.allowed_scopes_type.AllowedScopesType"]
    """<p>An array of scopes that are allowed to access the token.</p>"""
    custom_claims: NotRequired["aws_sdk_bedrock_agentcore_control.types.custom_claim_validations_type.CustomClaimValidationsType"]
...
def serialize_json(value: CustomJWTAuthorizerConfiguration) -> dict:
    ...
    if "allowed_audience" in value:
        import aws_sdk_bedrock_agentcore_control.types.allowed_audience_list
        out["allowedAudience"] = aws_sdk_bedrock_agentcore_control.types.allowed_audience_list.serialize_json(value["allowed_audience"])
    if "allowed_clients" in value:
        import aws_sdk_bedrock_agentcore_control.types.allowed_clients_list
        out["allowedClients"] = aws_sdk_bedrock_agentcore_control.types.allowed_clients_list.serialize_json(value["allowed_clients"])
    if "allowed_scopes" in value:
        import aws_sdk_bedrock_agentcore_control.types.allowed_scopes_type
        out["allowedScopes"] = aws_sdk_bedrock_agentcore_control.types.allowed_scopes_type.serialize_json(value["allowed_scopes"])
    if "custom_claims" in value:
        import aws_sdk_bedrock_agentcore_control.types.custom_claim_validations_type
        out["customClaims"] = aws_sdk_bedrock_agentcore_control.types.custom_claim_validations_type.serialize_json(value["custom_claims"])
...
def deserialize_json(data: dict) -> CustomJWTAuthorizerConfiguration:
    ...
    if "discoveryUrl" in data:
        ...
        raise DeserializationError("CustomJWTAuthorizerConfiguration.discovery_url required")
    if "allowedAudience" in data:
        import aws_sdk_bedrock_agentcore_control.types.allowed_audience_list
        out["allowed_audience"] = aws_sdk_bedrock_agentcore_control.types.allowed_audience_list.deserialize_json(data["allowedAudience"])
    if "allowedClients" in data:
        import aws_sdk_bedrock_agentcore_control.types.allowed_clients_list
        out["allowed_clients"] = aws_sdk_bedrock_agentcore_control.types.allowed_clients_list.deserialize_json(data["allowedClients"])
    if "allowedScopes" in data:
        import aws_sdk_bedrock_agentcore_control.types.allowed_scopes_type
        out["allowed_scopes"] = aws_sdk_bedrock_agentcore_control.types.allowed_scopes_type.deserialize_json(data["allowedScopes"])
    if "customClaims" in data:
        import aws_sdk_bedrock_agentcore_control.types.custom_claim_validations_type
        out["custom_claims"] = aws_sdk_bedrock_agentcore_control.types.custom_claim_validations_type.deserialize_json(data["customClaims"])
