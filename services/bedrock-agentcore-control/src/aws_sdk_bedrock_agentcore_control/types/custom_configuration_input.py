...
def serialize_json(value: CustomConfigurationInput) -> dict:
    if "semanticOverride" in value:
        ...
        return {
            "semanticOverride": aws_sdk_bedrock_agentcore_control.types.semantic_override_configuration_input.serialize_json(
        ...
        return {
            "summaryOverride": aws_sdk_bedrock_agentcore_control.types.summary_override_configuration_input.serialize_json(
        ...
        return {
            "userPreferenceOverride": aws_sdk_bedrock_agentcore_control.types.user_preference_override_configuration_input.serialize_json(
        ...
        return {
            "episodicOverride": aws_sdk_bedrock_agentcore_control.types.episodic_override_configuration_input.serialize_json(
        ...
        return {
            "selfManagedConfiguration": aws_sdk_bedrock_agentcore_control.types.self_managed_configuration_input.serialize_json(
...
def deserialize_json(data: dict) -> CustomConfigurationInput:
    if "semanticOverride" in data:
        ...
        return {
            "semanticOverride": aws_sdk_bedrock_agentcore_control.types.semantic_override_configuration_input.deserialize_json(
        ...
        return {
            "summaryOverride": aws_sdk_bedrock_agentcore_control.types.summary_override_configuration_input.deserialize_json(
        ...
        return {
            "userPreferenceOverride": aws_sdk_bedrock_agentcore_control.types.user_preference_override_configuration_input.deserialize_json(
        ...
        return {
            "episodicOverride": aws_sdk_bedrock_agentcore_control.types.episodic_override_configuration_input.deserialize_json(
        ...
        return {
            "selfManagedConfiguration": aws_sdk_bedrock_agentcore_control.types.self_managed_configuration_input.deserialize_json(
