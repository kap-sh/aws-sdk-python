...
class ListPolicyGenerationSummariesResponse(TypedDict):
    policy_generations: "aws_sdk_bedrock_agentcore_control.types.policy_generation_summary_list.PolicyGenerationSummaryList"
...
def serialize_json(value: ListPolicyGenerationSummariesResponse) -> dict:
    ...
    out["policyGenerations"] = (
        aws_sdk_bedrock_agentcore_control.types.policy_generation_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListPolicyGenerationSummariesResponse:
    ...
    if "policyGenerations" in data:
        ...
        out["policy_generations"] = (
            aws_sdk_bedrock_agentcore_control.types.policy_generation_summary_list.deserialize_json(
