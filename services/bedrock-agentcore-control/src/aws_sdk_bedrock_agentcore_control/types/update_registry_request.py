...
def serialize_json(value: UpdateRegistryRequest) -> dict:
    ...
    if "approval_configuration" in value:
        ...
        out["approvalConfiguration"] = (
            aws_sdk_bedrock_agentcore_control.types.updated_approval_configuration.serialize_json(
...
def deserialize_json(data: dict) -> UpdateRegistryRequest:
    ...
    if "approvalConfiguration" in data:
        ...
        out["approval_configuration"] = (
            aws_sdk_bedrock_agentcore_control.types.updated_approval_configuration.deserialize_json(
