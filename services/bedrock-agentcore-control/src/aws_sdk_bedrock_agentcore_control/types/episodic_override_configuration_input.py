...
class EpisodicOverrideConfigurationInput(TypedDict):
    extraction: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.episodic_override_extraction_configuration_input.EpisodicOverrideExtractionConfigurationInput"
    ]
    """<p>Contains configurations for overriding the extraction step of the episodic memory strategy.</p>"""
    consolidation: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.episodic_override_consolidation_configuration_input.EpisodicOverrideConsolidationConfigurationInput"
    ]
    """<p>Contains configurations for overriding the consolidation step of the episodic memory strategy.</p>"""
    reflection: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.episodic_override_reflection_configuration_input.EpisodicOverrideReflectionConfigurationInput"
    ]
...
def serialize_json(value: EpisodicOverrideConfigurationInput) -> dict:
    ...
    if "extraction" in value:
        ...
        out["extraction"] = (
            aws_sdk_bedrock_agentcore_control.types.episodic_override_extraction_configuration_input.serialize_json(
                value["extraction"]
            )
        )
    if "consolidation" in value:
        ...
        out["consolidation"] = (
            aws_sdk_bedrock_agentcore_control.types.episodic_override_consolidation_configuration_input.serialize_json(
                value["consolidation"]
            )
        )
    if "reflection" in value:
        ...
        out["reflection"] = (
            aws_sdk_bedrock_agentcore_control.types.episodic_override_reflection_configuration_input.serialize_json(
                value["reflection"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> EpisodicOverrideConfigurationInput:
    ...
    if "extraction" in data:
        ...
        out["extraction"] = (
            aws_sdk_bedrock_agentcore_control.types.episodic_override_extraction_configuration_input.deserialize_json(
                data["extraction"]
            )
        )
    if "consolidation" in data:
        ...
        out["consolidation"] = (
            aws_sdk_bedrock_agentcore_control.types.episodic_override_consolidation_configuration_input.deserialize_json(
                data["consolidation"]
            )
        )
    if "reflection" in data:
        ...
        out["reflection"] = (
            aws_sdk_bedrock_agentcore_control.types.episodic_override_reflection_configuration_input.deserialize_json(
                data["reflection"]
            )
        )
    return out
