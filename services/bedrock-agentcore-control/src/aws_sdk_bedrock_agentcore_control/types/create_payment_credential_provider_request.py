...
def serialize_json(value: CreatePaymentCredentialProviderRequest) -> dict:
    ...
    import aws_sdk_bedrock_agentcore_control.types.payment_provider_configuration_input
    out["providerConfigurationInput"] = aws_sdk_bedrock_agentcore_control.types.payment_provider_configuration_input.serialize_json(value["provider_configuration_input"])
    if "tags" in value:
        import aws_sdk_bedrock_agentcore_control.types.tags_map
...
def deserialize_json(data: dict) -> CreatePaymentCredentialProviderRequest:
    ...
    if "name" in data:
        ...
        raise DeserializationError("CreatePaymentCredentialProviderRequest.name required")
    if "credentialProviderVendor" in data:
        ...
        raise DeserializationError("CreatePaymentCredentialProviderRequest.credential_provider_vendor required")
    if "providerConfigurationInput" in data:
        import aws_sdk_bedrock_agentcore_control.types.payment_provider_configuration_input
        out["provider_configuration_input"] = aws_sdk_bedrock_agentcore_control.types.payment_provider_configuration_input.deserialize_json(data["providerConfigurationInput"])
    else:
        raise DeserializationError("CreatePaymentCredentialProviderRequest.provider_configuration_input required")
    if "tags" in data:
        import aws_sdk_bedrock_agentcore_control.types.tags_map
