...
class CoinbaseCdpConfigurationOutput(TypedDict):
    ...
    wallet_secret_json_key: NotRequired["aws_sdk_bedrock_agentcore_control.types.secret_json_key_type.SecretJsonKeyType"]
...
def serialize_json(value: CoinbaseCdpConfigurationOutput) -> dict:
    ...
    import aws_sdk_bedrock_agentcore_control.types.secret
    out["walletSecretArn"] = aws_sdk_bedrock_agentcore_control.types.secret.serialize_json(value["wallet_secret_arn"])
...
def deserialize_json(data: dict) -> CoinbaseCdpConfigurationOutput:
    ...
    if "apiKeySecretArn" in data:
        ...
        raise DeserializationError("CoinbaseCdpConfigurationOutput.api_key_secret_arn required")
    ...
    if "walletSecretArn" in data:
        import aws_sdk_bedrock_agentcore_control.types.secret
        out["wallet_secret_arn"] = aws_sdk_bedrock_agentcore_control.types.secret.deserialize_json(data["walletSecretArn"])
    else:
        raise DeserializationError("CoinbaseCdpConfigurationOutput.wallet_secret_arn required")
