...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agentcore_control.types.harness_agent_core_memory_configuration


class _HarnessMemoryConfiguration_agentCoreMemoryConfiguration(TypedDict):
    agentCoreMemoryConfiguration: "aws_sdk_bedrock_agentcore_control.types.harness_agent_core_memory_configuration.HarnessAgentCoreMemoryConfiguration"
...
def serialize_json(value: HarnessMemoryConfiguration) -> dict:
    if "agentCoreMemoryConfiguration" in value:
        ...
        return {
            "agentCoreMemoryConfiguration": aws_sdk_bedrock_agentcore_control.types.harness_agent_core_memory_configuration.serialize_json(
...
def deserialize_json(data: dict) -> HarnessMemoryConfiguration:
    if "agentCoreMemoryConfiguration" in data:
        ...
        return {
            "agentCoreMemoryConfiguration": aws_sdk_bedrock_agentcore_control.types.harness_agent_core_memory_configuration.deserialize_json(
