...
class GetPaymentManagerResponse(TypedDict):
...
def deserialize_json(data: dict) -> GetPaymentManagerResponse:
    ...
    if "paymentManagerArn" in data:
        ...
        raise DeserializationError("GetPaymentManagerResponse.payment_manager_arn required")
    if "paymentManagerId" in data:
        out["payment_manager_id"] = data["paymentManagerId"]
    else:
        raise DeserializationError("GetPaymentManagerResponse.payment_manager_id required")
    if "name" in data:
        out["name"] = data["name"]
    else:
