...
class ListPaymentConnectorsResponse(TypedDict):
    payment_connectors: "aws_sdk_bedrock_agentcore_control.types.payment_connector_summaries.PaymentConnectorSummaries"
...
def serialize_json(value: ListPaymentConnectorsResponse) -> dict:
    ...
    out["paymentConnectors"] = (
        aws_sdk_bedrock_agentcore_control.types.payment_connector_summaries.serialize_json(
...
def deserialize_json(data: dict) -> ListPaymentConnectorsResponse:
    ...
    if "paymentConnectors" in data:
        ...
        out["payment_connectors"] = (
            aws_sdk_bedrock_agentcore_control.types.payment_connector_summaries.deserialize_json(
