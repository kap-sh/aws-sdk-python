...
class GetBrowserResponse(TypedDict):
    ...
    recording: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.recording_config.RecordingConfig"
    ]
    browser_signing: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.browser_signing_config_output.BrowserSigningConfigOutput"
    ]
    ...
    enterprise_policies: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.browser_enterprise_policies.BrowserEnterprisePolicies"
    ]
...
def serialize_json(value: GetBrowserResponse) -> dict:
    ...
    out["networkConfiguration"] = (
        aws_sdk_bedrock_agentcore_control.types.browser_network_configuration.serialize_json(
    ...
    if "recording" in value:
        ...
        out["recording"] = (
            aws_sdk_bedrock_agentcore_control.types.recording_config.serialize_json(
                value["recording"]
            )
        )
    if "browser_signing" in value:
        ...
        out["browserSigning"] = (
            aws_sdk_bedrock_agentcore_control.types.browser_signing_config_output.serialize_json(
    ...
    if "enterprise_policies" in value:
        ...
        out["enterprisePolicies"] = (
            aws_sdk_bedrock_agentcore_control.types.browser_enterprise_policies.serialize_json(
...
def deserialize_json(data: dict) -> GetBrowserResponse:
    ...
    if "networkConfiguration" in data:
        ...
        out["network_configuration"] = (
            aws_sdk_bedrock_agentcore_control.types.browser_network_configuration.deserialize_json(
    ...
    if "recording" in data:
        ...
        out["recording"] = (
            aws_sdk_bedrock_agentcore_control.types.recording_config.deserialize_json(
                data["recording"]
            )
        )
    if "browserSigning" in data:
        ...
        out["browser_signing"] = (
            aws_sdk_bedrock_agentcore_control.types.browser_signing_config_output.deserialize_json(
                data["browserSigning"]
            )
        )
    if "enterprisePolicies" in data:
        ...
        out["enterprise_policies"] = (
            aws_sdk_bedrock_agentcore_control.types.browser_enterprise_policies.deserialize_json(
