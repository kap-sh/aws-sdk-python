...
class DeletePaymentConnectorResponse(TypedDict):
    ...
    payment_connector_id: NotRequired["aws_sdk_bedrock_agentcore_control.types.payment_connector_id.PaymentConnectorId"]
