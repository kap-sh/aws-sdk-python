...
FilesystemConfigurations: TypeAlias = list[
    "aws_sdk_bedrock_agentcore_control.types.filesystem_configuration.FilesystemConfiguration"
]
...
def serialize_json(value: FilesystemConfigurations) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_bedrock_agentcore_control.types.filesystem_configuration.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> FilesystemConfigurations:
    ...
    for item in data:
        out.append(
            aws_sdk_bedrock_agentcore_control.types.filesystem_configuration.deserialize_json(
                item
            )
        )
    return out
