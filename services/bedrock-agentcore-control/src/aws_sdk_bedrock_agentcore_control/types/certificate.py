...
def serialize_json(value: Certificate) -> dict:
    out: dict = {}
    import aws_sdk_bedrock_agentcore_control.types.certificate_location
    out["location"] = aws_sdk_bedrock_agentcore_control.types.certificate_location.serialize_json(value["location"])
    return out
...
def deserialize_json(data: dict) -> Certificate:
    ...
    if "location" in data:
        import aws_sdk_bedrock_agentcore_control.types.certificate_location
        out["location"] = aws_sdk_bedrock_agentcore_control.types.certificate_location.deserialize_json(data["location"])
    else:
