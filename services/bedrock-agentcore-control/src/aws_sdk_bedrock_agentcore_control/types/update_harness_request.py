...
class UpdateHarnessRequest(TypedDict):
...
def serialize_json(value: UpdateHarnessRequest) -> dict:
    ...
    if "environment_artifact" in value:
        ...
        out["environmentArtifact"] = (
            aws_sdk_bedrock_agentcore_control.types.updated_harness_environment_artifact.serialize_json(
    ...
    if "authorizer_configuration" in value:
        ...
        out["authorizerConfiguration"] = (
            aws_sdk_bedrock_agentcore_control.types.updated_authorizer_configuration.serialize_json(
    ...
    if "memory" in value:
        ...
        out["memory"] = (
            aws_sdk_bedrock_agentcore_control.types.updated_harness_memory_configuration.serialize_json(
                value["memory"]
            )
        )
...
def deserialize_json(data: dict) -> UpdateHarnessRequest:
    ...
    if "environmentArtifact" in data:
        ...
        out["environment_artifact"] = (
            aws_sdk_bedrock_agentcore_control.types.updated_harness_environment_artifact.deserialize_json(
    ...
    if "authorizerConfiguration" in data:
        ...
        out["authorizer_configuration"] = (
            aws_sdk_bedrock_agentcore_control.types.updated_authorizer_configuration.deserialize_json(
    ...
    if "memory" in data:
        ...
        out["memory"] = (
            aws_sdk_bedrock_agentcore_control.types.updated_harness_memory_configuration.deserialize_json(
                data["memory"]
            )
        )
