...
class ApiGatewayToolConfiguration(TypedDict):
    tool_overrides: NotRequired["aws_sdk_bedrock_agentcore_control.types.api_gateway_tool_overrides.ApiGatewayToolOverrides"]
...
def serialize_json(value: ApiGatewayToolConfiguration) -> dict:
    ...
    if "tool_overrides" in value:
        import aws_sdk_bedrock_agentcore_control.types.api_gateway_tool_overrides
        out["toolOverrides"] = aws_sdk_bedrock_agentcore_control.types.api_gateway_tool_overrides.serialize_json(value["tool_overrides"])
    import aws_sdk_bedrock_agentcore_control.types.api_gateway_tool_filters
    out["toolFilters"] = aws_sdk_bedrock_agentcore_control.types.api_gateway_tool_filters.serialize_json(value["tool_filters"])
    return out
...
def deserialize_json(data: dict) -> ApiGatewayToolConfiguration:
    ...
    if "toolOverrides" in data:
        import aws_sdk_bedrock_agentcore_control.types.api_gateway_tool_overrides
        out["tool_overrides"] = aws_sdk_bedrock_agentcore_control.types.api_gateway_tool_overrides.deserialize_json(data["toolOverrides"])
    if "toolFilters" in data:
        import aws_sdk_bedrock_agentcore_control.types.api_gateway_tool_filters
        out["tool_filters"] = aws_sdk_bedrock_agentcore_control.types.api_gateway_tool_filters.deserialize_json(data["toolFilters"])
    else:
