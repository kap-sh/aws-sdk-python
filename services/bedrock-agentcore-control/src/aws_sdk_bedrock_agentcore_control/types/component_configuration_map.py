...
ComponentConfigurationMap: TypeAlias = dict[
    "aws_sdk_bedrock_agentcore_control.types.component_identifier.ComponentIdentifier",
    "aws_sdk_bedrock_agentcore_control.types.component_configuration.ComponentConfiguration",
]
...
def serialize_json(input_to_serialize: ComponentConfigurationMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = (
            aws_sdk_bedrock_agentcore_control.types.component_configuration.serialize_json(
                value
            )
        )
    return out
...
def deserialize_json(data: dict) -> ComponentConfigurationMap:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            aws_sdk_bedrock_agentcore_control.types.component_configuration.deserialize_json(
                value
            )
        )
    return out
