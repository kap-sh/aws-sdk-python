...
def serialize_json(value: OutputConfig) -> dict:
    ...
    out["cloudWatchConfig"] = (
        aws_sdk_bedrock_agentcore_control.types.cloud_watch_output_config.serialize_json(
...
def deserialize_json(data: dict) -> OutputConfig:
    ...
    if "cloudWatchConfig" in data:
        ...
        out["cloud_watch_config"] = (
            aws_sdk_bedrock_agentcore_control.types.cloud_watch_output_config.deserialize_json(
