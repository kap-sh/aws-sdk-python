...
class ListApiKeyCredentialProvidersResponse(TypedDict):
    credential_providers: "aws_sdk_bedrock_agentcore_control.types.api_key_credential_providers.ApiKeyCredentialProviders"
...
def serialize_json(value: ListApiKeyCredentialProvidersResponse) -> dict:
    ...
    out["credentialProviders"] = (
        aws_sdk_bedrock_agentcore_control.types.api_key_credential_providers.serialize_json(
...
def deserialize_json(data: dict) -> ListApiKeyCredentialProvidersResponse:
    ...
    if "credentialProviders" in data:
        ...
        out["credential_providers"] = (
            aws_sdk_bedrock_agentcore_control.types.api_key_credential_providers.deserialize_json(
