...
class CodeInterpreterSummary(TypedDict):
...
def deserialize_json(data: dict) -> CodeInterpreterSummary:
    ...
    if "codeInterpreterId" in data:
        ...
        raise DeserializationError("CodeInterpreterSummary.code_interpreter_id required")
    if "codeInterpreterArn" in data:
        out["code_interpreter_arn"] = data["codeInterpreterArn"]
    else:
        raise DeserializationError("CodeInterpreterSummary.code_interpreter_arn required")
    if "name" in data:
        out["name"] = data["name"]
