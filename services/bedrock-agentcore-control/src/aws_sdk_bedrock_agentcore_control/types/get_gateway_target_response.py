...
def deserialize_json(data: dict) -> GetGatewayTargetResponse:
    ...
    if "targetConfiguration" in data:
        ...
        raise DeserializationError("GetGatewayTargetResponse.target_configuration required")
    if "credentialProviderConfigurations" in data:
        ...
        raise DeserializationError("GetGatewayTargetResponse.credential_provider_configurations required")
