...
class CreateConfigurationBundleRequest(TypedDict):
    ...
    created_by: NotRequired["aws_sdk_bedrock_agentcore_control.types.version_created_by_source.VersionCreatedBySource"]
...
def serialize_json(value: CreateConfigurationBundleRequest) -> dict:
    ...
    if "created_by" in value:
        import aws_sdk_bedrock_agentcore_control.types.version_created_by_source
        out["createdBy"] = aws_sdk_bedrock_agentcore_control.types.version_created_by_source.serialize_json(value["created_by"])
    if "tags" in value:
        import aws_sdk_bedrock_agentcore_control.types.tags_map
...
def deserialize_json(data: dict) -> CreateConfigurationBundleRequest:
    ...
    if "bundleName" in data:
        ...
        raise DeserializationError("CreateConfigurationBundleRequest.bundle_name required")
    ...
    if "components" in data:
        ...
        raise DeserializationError("CreateConfigurationBundleRequest.components required")
    ...
    if "createdBy" in data:
        import aws_sdk_bedrock_agentcore_control.types.version_created_by_source
        out["created_by"] = aws_sdk_bedrock_agentcore_control.types.version_created_by_source.deserialize_json(data["createdBy"])
    if "tags" in data:
        import aws_sdk_bedrock_agentcore_control.types.tags_map
