...
def deserialize_json(data: dict) -> CreatePaymentCredentialProviderResponse:
    ...
    if "name" in data:
        ...
        raise DeserializationError("CreatePaymentCredentialProviderResponse.name required")
    if "credentialProviderVendor" in data:
        ...
        raise DeserializationError("CreatePaymentCredentialProviderResponse.credential_provider_vendor required")
    if "credentialProviderArn" in data:
        out["credential_provider_arn"] = data["credentialProviderArn"]
    else:
        raise DeserializationError("CreatePaymentCredentialProviderResponse.credential_provider_arn required")
    if "providerConfigurationOutput" in data:
        ...
        raise DeserializationError("CreatePaymentCredentialProviderResponse.provider_configuration_output required")
    return out