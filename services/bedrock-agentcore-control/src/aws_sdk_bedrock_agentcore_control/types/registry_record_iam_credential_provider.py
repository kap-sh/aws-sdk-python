...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agentcore_control.types.iam_role_arn
    import aws_sdk_bedrock_agentcore_control.types.iam_signing_region
    import aws_sdk_bedrock_agentcore_control.types.iam_signing_service_name


class RegistryRecordIamCredentialProvider(TypedDict):
    role_arn: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.iam_role_arn.IamRoleArn"
    ]
    """<p>The Amazon Resource Name (ARN) of the IAM role to assume for SigV4 signing.</p>"""
    service: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.iam_signing_service_name.IamSigningServiceName"
    ]
    """<p>The SigV4 signing service name (for example, <code>execute-api</code> or <code>bedrock-agentcore</code>).</p>"""
    region: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.iam_signing_region.IamSigningRegion"
    ]
