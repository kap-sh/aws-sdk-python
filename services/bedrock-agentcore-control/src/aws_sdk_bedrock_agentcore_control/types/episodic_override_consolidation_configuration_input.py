...
def deserialize_json(data: dict) -> EpisodicOverrideConsolidationConfigurationInput:
    ...
    if "appendToPrompt" in data:
        ...
        raise DeserializationError("EpisodicOverrideConsolidationConfigurationInput.append_to_prompt required")
    if "modelId" in data:
        out["model_id"] = data["modelId"]
    else:
        raise DeserializationError("EpisodicOverrideConsolidationConfigurationInput.model_id required")
    return out