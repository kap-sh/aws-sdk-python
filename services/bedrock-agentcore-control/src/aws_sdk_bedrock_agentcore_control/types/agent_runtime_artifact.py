...
class _AgentRuntimeArtifact_codeConfiguration(TypedDict):
    codeConfiguration: "aws_sdk_bedrock_agentcore_control.types.code_configuration.CodeConfiguration"

AgentRuntimeArtifact: TypeAlias = _AgentRuntimeArtifact_containerConfiguration | _AgentRuntimeArtifact_codeConfiguration

# --- restJson1 ser/de ---
def serialize_json(value: AgentRuntimeArtifact) -> dict:
    if "containerConfiguration" in value:
        import aws_sdk_bedrock_agentcore_control.types.container_configuration
        return {"containerConfiguration": aws_sdk_bedrock_agentcore_control.types.container_configuration.serialize_json(value["containerConfiguration"])}
    elif "codeConfiguration" in value:
        import aws_sdk_bedrock_agentcore_control.types.code_configuration
        return {"codeConfiguration": aws_sdk_bedrock_agentcore_control.types.code_configuration.serialize_json(value["codeConfiguration"])}
    else:
...
def deserialize_json(data: dict) -> AgentRuntimeArtifact:
    if "containerConfiguration" in data:
        import aws_sdk_bedrock_agentcore_control.types.container_configuration
        return {"containerConfiguration": aws_sdk_bedrock_agentcore_control.types.container_configuration.deserialize_json(data["containerConfiguration"])}
    elif "codeConfiguration" in data:
        import aws_sdk_bedrock_agentcore_control.types.code_configuration
        return {"codeConfiguration": aws_sdk_bedrock_agentcore_control.types.code_configuration.deserialize_json(data["codeConfiguration"])}
    else:
