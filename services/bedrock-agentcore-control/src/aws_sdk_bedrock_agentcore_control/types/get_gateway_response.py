...
class GetGatewayResponse(TypedDict):
    ...
    gateway_url: NotRequired["aws_sdk_bedrock_agentcore_control.types.gateway_url.GatewayUrl"]
    ...
    description: NotRequired["aws_sdk_bedrock_agentcore_control.types.gateway_description.GatewayDescription"]
    ...
    protocol_configuration: NotRequired["aws_sdk_bedrock_agentcore_control.types.gateway_protocol_configuration.GatewayProtocolConfiguration"]
    ...
    interceptor_configurations: NotRequired["aws_sdk_bedrock_agentcore_control.types.gateway_interceptor_configurations.GatewayInterceptorConfigurations"]
    """<p>The interceptors configured on the gateway.</p>"""
    policy_engine_configuration: NotRequired["aws_sdk_bedrock_agentcore_control.types.gateway_policy_engine_configuration.GatewayPolicyEngineConfiguration"]
    ...
    exception_level: NotRequired["aws_sdk_bedrock_agentcore_control.types.exception_level.ExceptionLevel"]
...
def serialize_json(value: GetGatewayResponse) -> dict:
    ...
    import aws_sdk_bedrock_agentcore_control.types.gateway_protocol_type
    out["protocolType"] = aws_sdk_bedrock_agentcore_control.types.gateway_protocol_type.serialize_json(value.get("protocol_type", 'MCP'))
    if "protocol_configuration" in value:
        import aws_sdk_bedrock_agentcore_control.types.gateway_protocol_configuration
        out["protocolConfiguration"] = aws_sdk_bedrock_agentcore_control.types.gateway_protocol_configuration.serialize_json(value["protocol_configuration"])
    import aws_sdk_bedrock_agentcore_control.types.authorizer_type
    out["authorizerType"] = aws_sdk_bedrock_agentcore_control.types.authorizer_type.serialize_json(value["authorizer_type"])
    ...
    if "interceptor_configurations" in value:
        import aws_sdk_bedrock_agentcore_control.types.gateway_interceptor_configurations
        out["interceptorConfigurations"] = aws_sdk_bedrock_agentcore_control.types.gateway_interceptor_configurations.serialize_json(value["interceptor_configurations"])
    if "policy_engine_configuration" in value:
        import aws_sdk_bedrock_agentcore_control.types.gateway_policy_engine_configuration
        out["policyEngineConfiguration"] = aws_sdk_bedrock_agentcore_control.types.gateway_policy_engine_configuration.serialize_json(value["policy_engine_configuration"])
    ...
    if "exception_level" in value:
        import aws_sdk_bedrock_agentcore_control.types.exception_level
        out["exceptionLevel"] = aws_sdk_bedrock_agentcore_control.types.exception_level.serialize_json(value["exception_level"])
    return out
...
def deserialize_json(data: dict) -> GetGatewayResponse:
    ...
    if "protocolType" in data:
        import aws_sdk_bedrock_agentcore_control.types.gateway_protocol_type
        out["protocol_type"] = aws_sdk_bedrock_agentcore_control.types.gateway_protocol_type.deserialize_json(data["protocolType"])
    else:
        out["protocol_type"] = 'MCP'
    if "protocolConfiguration" in data:
        import aws_sdk_bedrock_agentcore_control.types.gateway_protocol_configuration
        out["protocol_configuration"] = aws_sdk_bedrock_agentcore_control.types.gateway_protocol_configuration.deserialize_json(data["protocolConfiguration"])
    if "authorizerType" in data:
        import aws_sdk_bedrock_agentcore_control.types.authorizer_type
        out["authorizer_type"] = aws_sdk_bedrock_agentcore_control.types.authorizer_type.deserialize_json(data["authorizerType"])
    else:
    ...
    if "interceptorConfigurations" in data:
        import aws_sdk_bedrock_agentcore_control.types.gateway_interceptor_configurations
        out["interceptor_configurations"] = aws_sdk_bedrock_agentcore_control.types.gateway_interceptor_configurations.deserialize_json(data["interceptorConfigurations"])
    if "policyEngineConfiguration" in data:
        import aws_sdk_bedrock_agentcore_control.types.gateway_policy_engine_configuration
        out["policy_engine_configuration"] = aws_sdk_bedrock_agentcore_control.types.gateway_policy_engine_configuration.deserialize_json(data["policyEngineConfiguration"])
    ...
    if "exceptionLevel" in data:
        import aws_sdk_bedrock_agentcore_control.types.exception_level
        out["exception_level"] = aws_sdk_bedrock_agentcore_control.types.exception_level.deserialize_json(data["exceptionLevel"])
    return out