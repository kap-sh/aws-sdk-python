...
class GetPaymentConnectorResponse(TypedDict):
...
def deserialize_json(data: dict) -> GetPaymentConnectorResponse:
    ...
    if "paymentConnectorId" in data:
        ...
        raise DeserializationError("GetPaymentConnectorResponse.payment_connector_id required")
    if "name" in data:
        out["name"] = data["name"]
    else:
    ...
    if "credentialProviderConfigurations" in data:
        ...
        raise DeserializationError("GetPaymentConnectorResponse.credential_provider_configurations required")
    ...
    if "lastUpdatedAt" in data:
        ...
        raise DeserializationError("GetPaymentConnectorResponse.last_updated_at required")
    if "status" in data:
        import aws_sdk_bedrock_agentcore_control.types.payment_connector_status
