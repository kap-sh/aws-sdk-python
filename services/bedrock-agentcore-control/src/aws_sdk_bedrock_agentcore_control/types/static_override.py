"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#StaticOverride``."""
...
class StaticOverride(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: StaticOverride) -> dict:
    out: dict = {}
