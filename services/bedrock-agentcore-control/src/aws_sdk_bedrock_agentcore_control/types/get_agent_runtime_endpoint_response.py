...
def deserialize_json(data: dict) -> GetAgentRuntimeEndpointResponse:
    ...
    if "agentRuntimeEndpointArn" in data:
        ...
        raise DeserializationError("GetAgentRuntimeEndpointResponse.agent_runtime_endpoint_arn required")
    if "agentRuntimeArn" in data:
        out["agent_runtime_arn"] = data["agentRuntimeArn"]
    else:
        raise DeserializationError("GetAgentRuntimeEndpointResponse.agent_runtime_arn required")
    ...
    if "createdAt" in data:
        ...
        raise DeserializationError("GetAgentRuntimeEndpointResponse.created_at required")
    if "lastUpdatedAt" in data:
        import aws_sdk_bedrock_agentcore_control.types.date_timestamp
        out["last_updated_at"] = aws_sdk_bedrock_agentcore_control.types.date_timestamp.deserialize_json(data["lastUpdatedAt"])
    else:
        raise DeserializationError("GetAgentRuntimeEndpointResponse.last_updated_at required")
