...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agentcore_control.types.listing_mode
    import aws_sdk_bedrock_agentcore_control.types.mcp_tool_schema_configuration
    import aws_sdk_bedrock_agentcore_control.types.target_resource_priority


class McpServerTargetConfiguration(TypedDict):
    endpoint: "str"
    """<p>The endpoint for the MCP server target configuration.</p>"""
    mcp_tool_schema: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.mcp_tool_schema_configuration.McpToolSchemaConfiguration"
    ]
    ...
    listing_mode: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.listing_mode.ListingMode"
    ]
...
def serialize_json(value: McpServerTargetConfiguration) -> dict:
    ...
    if "mcp_tool_schema" in value:
        ...
        out["mcpToolSchema"] = (
            aws_sdk_bedrock_agentcore_control.types.mcp_tool_schema_configuration.serialize_json(
    ...
    if "listing_mode" in value:
        ...
        out["listingMode"] = (
            aws_sdk_bedrock_agentcore_control.types.listing_mode.serialize_json(
                value["listing_mode"]
            )
        )
...
def deserialize_json(data: dict) -> McpServerTargetConfiguration:
    ...
    if "mcpToolSchema" in data:
        ...
        out["mcp_tool_schema"] = (
            aws_sdk_bedrock_agentcore_control.types.mcp_tool_schema_configuration.deserialize_json(
                data["mcpToolSchema"]
            )
        )
    if "listingMode" in data:
        ...
        out["listing_mode"] = (
            aws_sdk_bedrock_agentcore_control.types.listing_mode.deserialize_json(
                data["listingMode"]
            )
        )
