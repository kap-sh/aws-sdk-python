...
if TYPE_CHECKING:
    import aws_sdk_bedrock_agentcore_control.types.http_target_configuration
...
def serialize_json(value: TargetConfiguration) -> dict:
    if "mcp" in value:
        ...
        return {
            "mcp": aws_sdk_bedrock_agentcore_control.types.mcp_target_configuration.serialize_json(
                value["mcp"]
            )
        }
    elif "http" in value:
        ...
        return {
            "http": aws_sdk_bedrock_agentcore_control.types.http_target_configuration.serialize_json(
                value["http"]
            )
        }
    else:
...
def deserialize_json(data: dict) -> TargetConfiguration:
    if "mcp" in data:
        ...
        return {
            "mcp": aws_sdk_bedrock_agentcore_control.types.mcp_target_configuration.deserialize_json(
                data["mcp"]
            )
        }
    elif "http" in data:
        ...
        return {
            "http": aws_sdk_bedrock_agentcore_control.types.http_target_configuration.deserialize_json(
                data["http"]
            )
        }
    else:
