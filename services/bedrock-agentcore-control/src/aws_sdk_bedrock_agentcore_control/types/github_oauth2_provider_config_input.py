"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#GithubOauth2ProviderConfigInput``."""
...
class GithubOauth2ProviderConfigInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GithubOauth2ProviderConfigInput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GithubOauth2ProviderConfigInput:
    out: GithubOauth2ProviderConfigInput = {}  # type: ignore[typeddict-item]
    if "clientId" in data:
        out["client_id"] = data["clientId"]
    else:
        raise DeserializationError("GithubOauth2ProviderConfigInput.client_id required")
