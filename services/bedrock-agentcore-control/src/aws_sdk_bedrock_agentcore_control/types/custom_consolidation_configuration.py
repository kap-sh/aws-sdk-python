...
CustomConsolidationConfiguration: TypeAlias = _CustomConsolidationConfiguration_semanticConsolidationOverride | _CustomConsolidationConfiguration_summaryConsolidationOverride | _CustomConsolidationConfiguration_userPreferenceConsolidationOverride | _CustomConsolidationConfiguration_episodicConsolidationOverride

# --- restJson1 ser/de ---
def serialize_json(value: CustomConsolidationConfiguration) -> dict:
    if "semanticConsolidationOverride" in value:
        import aws_sdk_bedrock_agentcore_control.types.semantic_consolidation_override
        return {"semanticConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.semantic_consolidation_override.serialize_json(value["semanticConsolidationOverride"])}
    elif "summaryConsolidationOverride" in value:
        import aws_sdk_bedrock_agentcore_control.types.summary_consolidation_override
        return {"summaryConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.summary_consolidation_override.serialize_json(value["summaryConsolidationOverride"])}
    elif "userPreferenceConsolidationOverride" in value:
        import aws_sdk_bedrock_agentcore_control.types.user_preference_consolidation_override
        return {"userPreferenceConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.user_preference_consolidation_override.serialize_json(value["userPreferenceConsolidationOverride"])}
    elif "episodicConsolidationOverride" in value:
        import aws_sdk_bedrock_agentcore_control.types.episodic_consolidation_override
        return {"episodicConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.episodic_consolidation_override.serialize_json(value["episodicConsolidationOverride"])}
    else:
...
def deserialize_json(data: dict) -> CustomConsolidationConfiguration:
    if "semanticConsolidationOverride" in data:
        import aws_sdk_bedrock_agentcore_control.types.semantic_consolidation_override
        return {"semanticConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.semantic_consolidation_override.deserialize_json(data["semanticConsolidationOverride"])}
    elif "summaryConsolidationOverride" in data:
        import aws_sdk_bedrock_agentcore_control.types.summary_consolidation_override
        return {"summaryConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.summary_consolidation_override.deserialize_json(data["summaryConsolidationOverride"])}
    elif "userPreferenceConsolidationOverride" in data:
        import aws_sdk_bedrock_agentcore_control.types.user_preference_consolidation_override
        return {"userPreferenceConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.user_preference_consolidation_override.deserialize_json(data["userPreferenceConsolidationOverride"])}
    elif "episodicConsolidationOverride" in data:
        import aws_sdk_bedrock_agentcore_control.types.episodic_consolidation_override
        return {"episodicConsolidationOverride": aws_sdk_bedrock_agentcore_control.types.episodic_consolidation_override.deserialize_json(data["episodicConsolidationOverride"])}
    else:
        raise DeserializationError("CustomConsolidationConfiguration: no recognized variant key")