...
ContentConfigurationList: TypeAlias = list[
    "aws_sdk_bedrock_agentcore_control.types.content_configuration.ContentConfiguration"
]
...
def serialize_json(value: ContentConfigurationList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_bedrock_agentcore_control.types.content_configuration.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> ContentConfigurationList:
    ...
    for item in data:
        out.append(
            aws_sdk_bedrock_agentcore_control.types.content_configuration.deserialize_json(
                item
            )
        )
    return out
