...
class CreateOauth2CredentialProviderResponse(TypedDict):
    ...
    oauth2_provider_config_output: NotRequired["aws_sdk_bedrock_agentcore_control.types.oauth2_provider_config_output.Oauth2ProviderConfigOutput"]
...
def deserialize_json(data: dict) -> CreateOauth2CredentialProviderResponse:
    ...
    if "clientSecretArn" in data:
        ...
        raise DeserializationError("CreateOauth2CredentialProviderResponse.client_secret_arn required")
    ...
    if "name" in data:
        ...
        raise DeserializationError("CreateOauth2CredentialProviderResponse.name required")
    if "credentialProviderArn" in data:
        out["credential_provider_arn"] = data["credentialProviderArn"]
    else:
        raise DeserializationError("CreateOauth2CredentialProviderResponse.credential_provider_arn required")
