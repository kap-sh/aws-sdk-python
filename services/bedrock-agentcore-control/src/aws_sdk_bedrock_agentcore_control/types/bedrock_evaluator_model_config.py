...
class BedrockEvaluatorModelConfig(TypedDict, closed=True):
    ...
    inference_config: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.inference_configuration.InferenceConfiguration"
    ]
    ...
    additional_model_request_fields: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.additional_model_request_fields.AdditionalModelRequestFields"
    ]
...
def serialize_json(value: BedrockEvaluatorModelConfig) -> dict:
    ...
    if "inference_config" in value:
        ...
        out["inferenceConfig"] = (
            aws_sdk_bedrock_agentcore_control.types.inference_configuration.serialize_json(
...
def deserialize_json(data: dict) -> BedrockEvaluatorModelConfig:
    ...
    if "inferenceConfig" in data:
        ...
        out["inference_config"] = (
            aws_sdk_bedrock_agentcore_control.types.inference_configuration.deserialize_json(
