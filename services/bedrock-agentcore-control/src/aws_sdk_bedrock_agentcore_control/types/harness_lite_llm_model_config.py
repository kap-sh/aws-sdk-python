...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock_agentcore_control.types.harness_lite_llm_api_base
...
class HarnessLiteLlmModelConfig(TypedDict, closed=True):
    ...
    api_key_arn: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.api_key_arn.ApiKeyArn"
    ]
    """<p>The ARN of the API key in AgentCore Identity for authenticating with the model provider.</p>"""
    api_base: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.harness_lite_llm_api_base.HarnessLiteLlmApiBase"
    ]
