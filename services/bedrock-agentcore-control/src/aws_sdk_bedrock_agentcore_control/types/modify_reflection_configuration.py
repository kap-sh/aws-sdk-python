...
class _ModifyReflectionConfiguration_episodicReflectionConfiguration(TypedDict):
...
class _ModifyReflectionConfiguration_customReflectionConfiguration(TypedDict):
