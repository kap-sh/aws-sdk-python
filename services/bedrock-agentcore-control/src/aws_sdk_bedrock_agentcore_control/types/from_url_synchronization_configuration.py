...
class FromUrlSynchronizationConfiguration(TypedDict, closed=True):
    ...
    credential_provider_configurations: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.registry_record_credential_provider_configuration_list.RegistryRecordCredentialProviderConfigurationList"
    ]
...
def serialize_json(value: FromUrlSynchronizationConfiguration) -> dict:
    ...
    if "credential_provider_configurations" in value:
        ...
        out["credentialProviderConfigurations"] = (
            aws_sdk_bedrock_agentcore_control.types.registry_record_credential_provider_configuration_list.serialize_json(
...
def deserialize_json(data: dict) -> FromUrlSynchronizationConfiguration:
    ...
    if "credentialProviderConfigurations" in data:
        ...
        out["credential_provider_configurations"] = (
            aws_sdk_bedrock_agentcore_control.types.registry_record_credential_provider_configuration_list.deserialize_json(
