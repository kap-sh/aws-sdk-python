...
def serialize_json(value: Action) -> dict:
    if "configurationBundle" in value:
        import aws_sdk_bedrock_agentcore_control.types.configuration_bundle_action
        return {"configurationBundle": aws_sdk_bedrock_agentcore_control.types.configuration_bundle_action.serialize_json(value["configurationBundle"])}
    elif "routeToTarget" in value:
        import aws_sdk_bedrock_agentcore_control.types.route_to_target_action
        return {"routeToTarget": aws_sdk_bedrock_agentcore_control.types.route_to_target_action.serialize_json(value["routeToTarget"])}
    else:
...
def deserialize_json(data: dict) -> Action:
    if "configurationBundle" in data:
        import aws_sdk_bedrock_agentcore_control.types.configuration_bundle_action
        return {"configurationBundle": aws_sdk_bedrock_agentcore_control.types.configuration_bundle_action.deserialize_json(data["configurationBundle"])}
    elif "routeToTarget" in data:
        import aws_sdk_bedrock_agentcore_control.types.route_to_target_action
        return {"routeToTarget": aws_sdk_bedrock_agentcore_control.types.route_to_target_action.deserialize_json(data["routeToTarget"])}
    else:
