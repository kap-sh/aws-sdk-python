...
AgentRuntimeEndpointStatus: TypeAlias = Literal["CREATING", "CREATE_FAILED", "UPDATING", "UPDATE_FAILED", "READY", "DELETING",]
...
def deserialize_json(data: str) -> AgentRuntimeEndpointStatus:
    if data not in _VALUES:
        raise DeserializationError(f"unknown AgentRuntimeEndpointStatus value: {data!r}")
