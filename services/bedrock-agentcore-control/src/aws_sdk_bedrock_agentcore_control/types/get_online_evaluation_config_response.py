...
class GetOnlineEvaluationConfigResponse(TypedDict):
    ...
    evaluation_execution_role_arn: NotRequired["aws_sdk_bedrock_agentcore_control.types.role_arn.RoleArn"]
...
def deserialize_json(data: dict) -> GetOnlineEvaluationConfigResponse:
    ...
    if "onlineEvaluationConfigArn" in data:
        ...
        raise DeserializationError("GetOnlineEvaluationConfigResponse.online_evaluation_config_arn required")
    if "onlineEvaluationConfigId" in data:
        out["online_evaluation_config_id"] = data["onlineEvaluationConfigId"]
    else:
        raise DeserializationError("GetOnlineEvaluationConfigResponse.online_evaluation_config_id required")
    if "onlineEvaluationConfigName" in data:
        out["online_evaluation_config_name"] = data["onlineEvaluationConfigName"]
    else:
        raise DeserializationError("GetOnlineEvaluationConfigResponse.online_evaluation_config_name required")
    ...
    if "dataSourceConfig" in data:
        ...
        raise DeserializationError("GetOnlineEvaluationConfigResponse.data_source_config required")
    if "evaluators" in data:
        ...
        raise DeserializationError("GetOnlineEvaluationConfigResponse.evaluators required")
    ...
    if "executionStatus" in data:
        ...
        raise DeserializationError("GetOnlineEvaluationConfigResponse.execution_status required")
    if "createdAt" in data:
        import aws_sdk_bedrock_agentcore_control.types._prelude.timestamp
        out["created_at"] = aws_sdk_bedrock_agentcore_control.types._prelude.timestamp.deserialize_json(data["createdAt"])
    else:
        raise DeserializationError("GetOnlineEvaluationConfigResponse.created_at required")
    if "updatedAt" in data:
        import aws_sdk_bedrock_agentcore_control.types._prelude.timestamp
        out["updated_at"] = aws_sdk_bedrock_agentcore_control.types._prelude.timestamp.deserialize_json(data["updatedAt"])
    else:
        raise DeserializationError("GetOnlineEvaluationConfigResponse.updated_at required")
