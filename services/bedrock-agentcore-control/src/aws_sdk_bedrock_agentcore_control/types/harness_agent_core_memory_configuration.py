...
class HarnessAgentCoreMemoryConfiguration(TypedDict, closed=True):
    ...
    retrieval_config: NotRequired[
        "aws_sdk_bedrock_agentcore_control.types.harness_agent_core_memory_retrieval_configs.HarnessAgentCoreMemoryRetrievalConfigs"
    ]
...
def serialize_json(value: HarnessAgentCoreMemoryConfiguration) -> dict:
    ...
    if "retrieval_config" in value:
        ...
        out["retrievalConfig"] = (
            aws_sdk_bedrock_agentcore_control.types.harness_agent_core_memory_retrieval_configs.serialize_json(
...
def deserialize_json(data: dict) -> HarnessAgentCoreMemoryConfiguration:
    ...
    if "retrievalConfig" in data:
        ...
        out["retrieval_config"] = (
            aws_sdk_bedrock_agentcore_control.types.harness_agent_core_memory_retrieval_configs.deserialize_json(
