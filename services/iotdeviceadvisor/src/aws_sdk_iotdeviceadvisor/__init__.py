...
from ._services.async_iot_device_advisor import (
    AsyncIotDeviceAdvisorClient as AsyncIotDeviceAdvisorClient,
)
from ._services.iot_device_advisor import (
    IotDeviceAdvisorClient as IotDeviceAdvisorClient,
)
