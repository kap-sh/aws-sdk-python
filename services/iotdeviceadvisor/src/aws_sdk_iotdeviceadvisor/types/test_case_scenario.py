...
if TYPE_CHECKING:
    ...
    import aws_sdk_iotdeviceadvisor.types.system_message
    import aws_sdk_iotdeviceadvisor.types.test_case_scenario_id
    import aws_sdk_iotdeviceadvisor.types.test_case_scenario_status
...
class TestCaseScenario(TypedDict):
    ...
    test_case_scenario_type: NotRequired[
        "aws_sdk_iotdeviceadvisor.types.test_case_scenario_type.TestCaseScenarioType"
    ]
    """<p>Provides test case scenario type. Type is one of the following:</p> <ul> <li> <p>Advanced</p> </li> <li> <p>Basic</p> </li> </ul>"""
    status: NotRequired[
        "aws_sdk_iotdeviceadvisor.types.test_case_scenario_status.TestCaseScenarioStatus"
    ]
    ...
    system_message: NotRequired[
        "aws_sdk_iotdeviceadvisor.types.system_message.SystemMessage"
    ]
...
def serialize_json(value: TestCaseScenario) -> dict:
    ...
    if "test_case_scenario_type" in value:
        ...
        out["testCaseScenarioType"] = (
            aws_sdk_iotdeviceadvisor.types.test_case_scenario_type.serialize_json(
    ...
    if "status" in value:
        ...
        out["status"] = (
            aws_sdk_iotdeviceadvisor.types.test_case_scenario_status.serialize_json(
                value["status"]
            )
        )
    if "failure" in value:
...
def deserialize_json(data: dict) -> TestCaseScenario:
    ...
    if "testCaseScenarioType" in data:
        ...
        out["test_case_scenario_type"] = (
            aws_sdk_iotdeviceadvisor.types.test_case_scenario_type.deserialize_json(
    ...
    if "status" in data:
        ...
        out["status"] = (
            aws_sdk_iotdeviceadvisor.types.test_case_scenario_status.deserialize_json(
                data["status"]
            )
        )
    if "failure" in data:
