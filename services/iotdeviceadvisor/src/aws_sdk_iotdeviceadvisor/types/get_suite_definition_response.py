...
class GetSuiteDefinitionResponse(TypedDict, closed=True):
    ...
    last_modified_at: NotRequired["aws_sdk_iotdeviceadvisor.types.timestamp.Timestamp"]
...
def serialize_json(value: GetSuiteDefinitionResponse) -> dict:
    ...
    if "last_modified_at" in value:
        ...
        out["lastModifiedAt"] = aws_sdk_iotdeviceadvisor.types.timestamp.serialize_json(
