...
class IotDeviceAdvisorError(Exception):
    """Base class for all IotDeviceAdvisor service errors."""


class ServiceError(IotDeviceAdvisorError):
...
class SerializationError(IotDeviceAdvisorError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IotDeviceAdvisorError):
...
class WaiterFailedError(IotDeviceAdvisorError):
...
class WaiterTimeoutError(IotDeviceAdvisorError):
