...
from aws_sdk_iotdeviceadvisor._services._aws_config import aws_config
...
class IotDeviceAdvisorClientConfig(TypedDict, total=False):
...
class IotDeviceAdvisorClient:
    ...
    def create_suite_definition(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.create_suite_definition_request.CreateSuiteDefinitionRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.create_suite_definition_response.CreateSuiteDefinitionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.create_suite_definition.create_suite_definition(
    ...
    def delete_suite_definition(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.delete_suite_definition_request.DeleteSuiteDefinitionRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.delete_suite_definition_response.DeleteSuiteDefinitionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.delete_suite_definition.delete_suite_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_endpoint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.get_endpoint_request.GetEndpointRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.get_endpoint_response.GetEndpointResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.get_endpoint.get_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_suite_definition(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.get_suite_definition_request.GetSuiteDefinitionRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.get_suite_definition_response.GetSuiteDefinitionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.get_suite_definition.get_suite_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_suite_run(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.get_suite_run_request.GetSuiteRunRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.get_suite_run_response.GetSuiteRunResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.get_suite_run.get_suite_run(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_suite_run_report(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.get_suite_run_report_request.GetSuiteRunReportRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.get_suite_run_report_response.GetSuiteRunReportResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.get_suite_run_report.get_suite_run_report(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_suite_definitions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.list_suite_definitions_request.ListSuiteDefinitionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.list_suite_definitions_response.ListSuiteDefinitionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.list_suite_definitions.list_suite_definitions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_suite_runs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.list_suite_runs_request.ListSuiteRunsRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.list_suite_runs_response.ListSuiteRunsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.list_suite_runs.list_suite_runs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_suite_run(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.start_suite_run_request.StartSuiteRunRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.start_suite_run_response.StartSuiteRunResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.start_suite_run.start_suite_run(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_suite_run(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.stop_suite_run_request.StopSuiteRunRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.stop_suite_run_response.StopSuiteRunResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.stop_suite_run.stop_suite_run(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_suite_definition(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_iotdeviceadvisor.types.update_suite_definition_request.UpdateSuiteDefinitionRequest]",
        ) -> OperationResponse[
            "aws_sdk_iotdeviceadvisor.types.update_suite_definition_response.UpdateSuiteDefinitionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_iotdeviceadvisor._operations.iot_senate_service.update_suite_definition.update_suite_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
