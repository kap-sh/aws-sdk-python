"""Generated from Smithy shape ``com.amazonaws.iotdeviceadvisor#StartSuiteRun``."""
...
import capo_iotdeviceadvisor.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            raise capo_iotdeviceadvisor.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_iotdeviceadvisor.types.start_suite_run_response.StartSuiteRunResponse = (
        capo_iotdeviceadvisor.types.start_suite_run_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/suiteDefinitions/{suiteDefinitionId}/suiteRuns"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_iotdeviceadvisor.types.start_suite_run_request.serialize_json(input_)
    ).encode()
...
async def async_start_suite_run(
