"""Generated from Smithy shape ``com.amazonaws.iotdeviceadvisor#GetSuiteRun``."""
...
def handle_response(
    ...
    out: capo_iotdeviceadvisor.types.get_suite_run_response.GetSuiteRunResponse = (
        capo_iotdeviceadvisor.types.get_suite_run_response.deserialize_json(
