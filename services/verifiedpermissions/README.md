...
```
pip install aws-sdk-verifiedpermissions
```

## Usage

```python
from aws_sdk_verifiedpermissions import AsyncVerifiedPermissionsClient


async def main():
    async with AsyncVerifiedPermissionsClient() as s3:
...
```python
from aws_sdk_verifiedpermissions import AsyncVerifiedPermissionsClient
from aws_sdk_verifiedpermissions.error import AccessDeniedException
