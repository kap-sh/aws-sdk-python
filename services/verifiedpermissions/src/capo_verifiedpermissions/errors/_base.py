...
class VerifiedPermissionsError(Exception):
    """Base class for all VerifiedPermissions service errors."""


class ServiceError(VerifiedPermissionsError):
...
class SerializationError(VerifiedPermissionsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(VerifiedPermissionsError):
...
class WaiterFailedError(VerifiedPermissionsError):
...
class WaiterTimeoutError(VerifiedPermissionsError):
