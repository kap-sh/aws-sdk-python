...
from ._services.async_verified_permissions import (
    AsyncVerifiedPermissionsClient as AsyncVerifiedPermissionsClient,
)
from ._services.verified_permissions import (
    VerifiedPermissionsClient as VerifiedPermissionsClient,
)
