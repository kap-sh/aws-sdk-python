"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#GetPolicyTemplate``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.get_policy_template_output.GetPolicyTemplateOutput = capo_verifiedpermissions.types.get_policy_template_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.GetPolicyTemplate"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.get_policy_template_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_policy_template(
