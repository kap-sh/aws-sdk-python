...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.put_schema_output.PutSchemaOutput = (
        capo_verifiedpermissions.types.put_schema_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.put_schema_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def put_schema(
    ...
    capo_verifiedpermissions.types.put_schema_output.PutSchemaOutput, zapros.Response
]:
