...
import capo_verifiedpermissions.types.batch_is_authorized_output_list
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.batch_is_authorized_output.BatchIsAuthorizedOutput = capo_verifiedpermissions.types.batch_is_authorized_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.batch_is_authorized_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
