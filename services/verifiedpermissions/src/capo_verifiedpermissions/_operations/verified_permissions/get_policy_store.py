"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#GetPolicyStore``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.get_policy_store_output.GetPolicyStoreOutput = (
        capo_verifiedpermissions.types.get_policy_store_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.GetPolicyStore"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.get_policy_store_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_policy_store(
