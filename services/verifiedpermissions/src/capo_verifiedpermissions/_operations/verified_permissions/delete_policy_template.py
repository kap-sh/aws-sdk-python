"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#DeletePolicyTemplate``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.delete_policy_template_output.DeletePolicyTemplateOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.DeletePolicyTemplate"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.delete_policy_template_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_policy_template(
