"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#UpdatePolicyTemplate``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.update_policy_template_output.UpdatePolicyTemplateOutput = capo_verifiedpermissions.types.update_policy_template_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.UpdatePolicyTemplate"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.update_policy_template_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_policy_template(
