"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#GetPolicyStoreAlias``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.get_policy_store_alias_output.GetPolicyStoreAliasOutput = capo_verifiedpermissions.types.get_policy_store_alias_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.GetPolicyStoreAlias"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.get_policy_store_alias_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_policy_store_alias(
