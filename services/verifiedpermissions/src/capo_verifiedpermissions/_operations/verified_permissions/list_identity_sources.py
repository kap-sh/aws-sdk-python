...
import capo_verifiedpermissions.types.identity_sources
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.list_identity_sources_output.ListIdentitySourcesOutput = capo_verifiedpermissions.types.list_identity_sources_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.list_identity_sources_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
