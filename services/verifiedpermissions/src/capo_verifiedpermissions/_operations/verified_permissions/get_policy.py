"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#GetPolicy``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.get_policy_output.GetPolicyOutput = (
        capo_verifiedpermissions.types.get_policy_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.GetPolicy"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.get_policy_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_policy(
    ...
    capo_verifiedpermissions.types.get_policy_output.GetPolicyOutput, zapros.Response
]:
