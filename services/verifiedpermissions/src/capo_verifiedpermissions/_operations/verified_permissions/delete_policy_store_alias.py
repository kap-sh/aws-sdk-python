"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#DeletePolicyStoreAlias``."""
...
import capo_verifiedpermissions.errors.invalid_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidStateException":
            raise capo_verifiedpermissions.errors.invalid_state_exception.InvalidStateException.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.delete_policy_store_alias_output.DeletePolicyStoreAliasOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.DeletePolicyStoreAlias"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.delete_policy_store_alias_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_policy_store_alias(
