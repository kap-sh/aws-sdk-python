"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#ListPolicyTemplates``."""
...
import capo_verifiedpermissions.types.policy_templates_list
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.list_policy_templates_output.ListPolicyTemplatesOutput = capo_verifiedpermissions.types.list_policy_templates_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.ListPolicyTemplates"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.list_policy_templates_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_policy_templates(
