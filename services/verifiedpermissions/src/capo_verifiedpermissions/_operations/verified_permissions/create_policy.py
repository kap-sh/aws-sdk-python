"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#CreatePolicy``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.create_policy_output.CreatePolicyOutput = (
        capo_verifiedpermissions.types.create_policy_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.CreatePolicy"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.create_policy_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
