...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.is_authorized_with_token_output.IsAuthorizedWithTokenOutput = capo_verifiedpermissions.types.is_authorized_with_token_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.is_authorized_with_token_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
