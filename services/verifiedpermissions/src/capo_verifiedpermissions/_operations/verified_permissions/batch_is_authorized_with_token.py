"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#BatchIsAuthorizedWithToken``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.batch_is_authorized_with_token_output.BatchIsAuthorizedWithTokenOutput = capo_verifiedpermissions.types.batch_is_authorized_with_token_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.BatchIsAuthorizedWithToken"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.batch_is_authorized_with_token_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_batch_is_authorized_with_token(
