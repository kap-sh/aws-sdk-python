...
import capo_verifiedpermissions.types.policy_store_alias_list
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.list_policy_store_aliases_output.ListPolicyStoreAliasesOutput = capo_verifiedpermissions.types.list_policy_store_aliases_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.list_policy_store_aliases_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
