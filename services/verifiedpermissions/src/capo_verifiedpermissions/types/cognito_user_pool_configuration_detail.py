...
if TYPE_CHECKING:
    ...
    import capo_verifiedpermissions.types.cognito_group_configuration_detail
...
class CognitoUserPoolConfigurationDetail(TypedDict, closed=True):
    ...
    group_configuration: NotRequired[
        "capo_verifiedpermissions.types.cognito_group_configuration_detail.CognitoGroupConfigurationDetail"
    ]
...
def serialize_aws_json_1_0(value: CognitoUserPoolConfigurationDetail) -> dict:
    ...
    if "group_configuration" in value:
        ...
        out["groupConfiguration"] = (
            capo_verifiedpermissions.types.cognito_group_configuration_detail.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> CognitoUserPoolConfigurationDetail:
    ...
    if "groupConfiguration" in data:
        ...
        out["group_configuration"] = (
            capo_verifiedpermissions.types.cognito_group_configuration_detail.deserialize_aws_json_1_0(
