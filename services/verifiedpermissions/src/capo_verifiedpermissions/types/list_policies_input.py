...
class ListPoliciesInput(TypedDict, closed=True):
    ...
    filter: NotRequired["capo_verifiedpermissions.types.policy_filter.PolicyFilter"]
...
def serialize_aws_json_1_0(value: ListPoliciesInput) -> dict:
    ...
    if "filter" in value:
        ...
        out["filter"] = (
            capo_verifiedpermissions.types.policy_filter.serialize_aws_json_1_0(
                value["filter"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ListPoliciesInput:
    ...
    if "filter" in data:
        ...
        out["filter"] = (
            capo_verifiedpermissions.types.policy_filter.deserialize_aws_json_1_0(
                data["filter"]
            )
        )
    return out
