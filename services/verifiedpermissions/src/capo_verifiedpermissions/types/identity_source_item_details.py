...
if TYPE_CHECKING:
    ...
    import capo_verifiedpermissions.types.discovery_url
...
class IdentitySourceItemDetails(TypedDict, closed=True):
    ...
    open_id_issuer: NotRequired[
        "capo_verifiedpermissions.types.open_id_issuer.OpenIdIssuer"
    ]
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: IdentitySourceItemDetails) -> dict:
    out: dict = {}
    ...
    if "open_id_issuer" in value:
        ...
        out["openIdIssuer"] = (
            capo_verifiedpermissions.types.open_id_issuer.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> IdentitySourceItemDetails:
    ...
    if "openIdIssuer" in data:
        ...
        out["open_id_issuer"] = (
            capo_verifiedpermissions.types.open_id_issuer.deserialize_aws_json_1_0(
                data["openIdIssuer"]
            )
        )
    return out
