...
class UpdateOpenIdConnectConfiguration(TypedDict, closed=True):
    ...
    group_configuration: NotRequired[
        "capo_verifiedpermissions.types.update_open_id_connect_group_configuration.UpdateOpenIdConnectGroupConfiguration"
    ]
    ...
    token_selection: "capo_verifiedpermissions.types.update_open_id_connect_token_selection.UpdateOpenIdConnectTokenSelection"
...
def serialize_aws_json_1_0(value: UpdateOpenIdConnectConfiguration) -> dict:
    ...
    if "group_configuration" in value:
        ...
        out["groupConfiguration"] = (
            capo_verifiedpermissions.types.update_open_id_connect_group_configuration.serialize_aws_json_1_0(
    ...
    out["tokenSelection"] = (
        capo_verifiedpermissions.types.update_open_id_connect_token_selection.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> UpdateOpenIdConnectConfiguration:
    ...
    if "groupConfiguration" in data:
        ...
        out["group_configuration"] = (
            capo_verifiedpermissions.types.update_open_id_connect_group_configuration.deserialize_aws_json_1_0(
    ...
    if "tokenSelection" in data:
        ...
        out["token_selection"] = (
            capo_verifiedpermissions.types.update_open_id_connect_token_selection.deserialize_aws_json_1_0(
                data["tokenSelection"]
            )
        )
    else:
