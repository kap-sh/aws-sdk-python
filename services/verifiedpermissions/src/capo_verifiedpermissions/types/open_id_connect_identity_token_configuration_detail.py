"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#OpenIdConnectIdentityTokenConfigurationDetail``."""
...
class OpenIdConnectIdentityTokenConfigurationDetail(TypedDict, closed=True):
...
def deserialize_aws_json_1_0(
    ...
    out: OpenIdConnectIdentityTokenConfigurationDetail = {}  # type: ignore[typeddict-item]
