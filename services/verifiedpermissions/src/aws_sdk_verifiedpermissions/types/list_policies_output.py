...
class ListPoliciesOutput(TypedDict):
    ...
    policies: "aws_sdk_verifiedpermissions.types.policy_list.PolicyList"
...
def serialize_aws_json_1_0(value: ListPoliciesOutput) -> dict:
    ...
    out["policies"] = (
        aws_sdk_verifiedpermissions.types.policy_list.serialize_aws_json_1_0(
            value["policies"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ListPoliciesOutput:
    ...
    if "policies" in data:
        ...
        out["policies"] = (
            aws_sdk_verifiedpermissions.types.policy_list.deserialize_aws_json_1_0(
                data["policies"]
            )
        )
    else:
