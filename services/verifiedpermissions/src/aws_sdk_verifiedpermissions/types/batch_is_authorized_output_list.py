...
BatchIsAuthorizedOutputList: TypeAlias = list[
    "aws_sdk_verifiedpermissions.types.batch_is_authorized_output_item.BatchIsAuthorizedOutputItem"
]
...
def serialize_aws_json_1_0(value: BatchIsAuthorizedOutputList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_verifiedpermissions.types.batch_is_authorized_output_item.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> BatchIsAuthorizedOutputList:
    ...
    for item in data:
        out.append(
            aws_sdk_verifiedpermissions.types.batch_is_authorized_output_item.deserialize_aws_json_1_0(
                item
            )
        )
    return out
