...
def serialize_aws_json_1_0(value: ListPolicyStoreAliasesInput) -> dict:
    ...
    if "filter" in value:
        ...
        out["filter"] = (
            aws_sdk_verifiedpermissions.types.policy_store_alias_filter.serialize_aws_json_1_0(
                value["filter"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ListPolicyStoreAliasesInput:
    ...
    if "filter" in data:
        ...
        out["filter"] = (
            aws_sdk_verifiedpermissions.types.policy_store_alias_filter.deserialize_aws_json_1_0(
                data["filter"]
            )
        )
    return out
