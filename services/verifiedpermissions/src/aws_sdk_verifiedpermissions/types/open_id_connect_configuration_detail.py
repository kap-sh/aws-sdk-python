...
if TYPE_CHECKING:
    ...
    import aws_sdk_verifiedpermissions.types.open_id_connect_group_configuration_detail
    import aws_sdk_verifiedpermissions.types.open_id_connect_token_selection_detail


class OpenIdConnectConfigurationDetail(TypedDict):
    ...
    group_configuration: NotRequired[
        "aws_sdk_verifiedpermissions.types.open_id_connect_group_configuration_detail.OpenIdConnectGroupConfigurationDetail"
    ]
    ...
    token_selection: "aws_sdk_verifiedpermissions.types.open_id_connect_token_selection_detail.OpenIdConnectTokenSelectionDetail"
...
def serialize_aws_json_1_0(value: OpenIdConnectConfigurationDetail) -> dict:
    ...
    if "group_configuration" in value:
        ...
        out["groupConfiguration"] = (
            aws_sdk_verifiedpermissions.types.open_id_connect_group_configuration_detail.serialize_aws_json_1_0(
    ...
    out["tokenSelection"] = (
        aws_sdk_verifiedpermissions.types.open_id_connect_token_selection_detail.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> OpenIdConnectConfigurationDetail:
    ...
    if "groupConfiguration" in data:
        ...
        out["group_configuration"] = (
            aws_sdk_verifiedpermissions.types.open_id_connect_group_configuration_detail.deserialize_aws_json_1_0(
    ...
    if "tokenSelection" in data:
        ...
        out["token_selection"] = (
            aws_sdk_verifiedpermissions.types.open_id_connect_token_selection_detail.deserialize_aws_json_1_0(
                data["tokenSelection"]
            )
        )
    else:
