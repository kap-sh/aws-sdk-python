...
def serialize_aws_json_1_0(value: BatchIsAuthorizedOutput) -> dict:
    out: dict = {}
    import aws_sdk_verifiedpermissions.types.batch_is_authorized_output_list
    out["results"] = aws_sdk_verifiedpermissions.types.batch_is_authorized_output_list.serialize_aws_json_1_0(value["results"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> BatchIsAuthorizedOutput:
    ...
    if "results" in data:
        import aws_sdk_verifiedpermissions.types.batch_is_authorized_output_list
        out["results"] = aws_sdk_verifiedpermissions.types.batch_is_authorized_output_list.deserialize_aws_json_1_0(data["results"])
    else:
