...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: OpenIdConnectIdentityTokenConfiguration) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> OpenIdConnectIdentityTokenConfiguration:
    out: OpenIdConnectIdentityTokenConfiguration = {}  # type: ignore[typeddict-item]
