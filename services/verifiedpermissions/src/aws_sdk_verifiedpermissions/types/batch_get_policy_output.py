...
def serialize_aws_json_1_0(value: BatchGetPolicyOutput) -> dict:
    out: dict = {}
    import aws_sdk_verifiedpermissions.types.batch_get_policy_output_list
    out["results"] = aws_sdk_verifiedpermissions.types.batch_get_policy_output_list.serialize_aws_json_1_0(value["results"])
    import aws_sdk_verifiedpermissions.types.batch_get_policy_error_list
    out["errors"] = aws_sdk_verifiedpermissions.types.batch_get_policy_error_list.serialize_aws_json_1_0(value["errors"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> BatchGetPolicyOutput:
    ...
    if "results" in data:
        import aws_sdk_verifiedpermissions.types.batch_get_policy_output_list
        out["results"] = aws_sdk_verifiedpermissions.types.batch_get_policy_output_list.deserialize_aws_json_1_0(data["results"])
    else:
        raise DeserializationError("BatchGetPolicyOutput.results required")
    if "errors" in data:
        import aws_sdk_verifiedpermissions.types.batch_get_policy_error_list
        out["errors"] = aws_sdk_verifiedpermissions.types.batch_get_policy_error_list.deserialize_aws_json_1_0(data["errors"])
    else:
