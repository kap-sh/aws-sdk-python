...
BatchGetPolicyInputList: TypeAlias = list[
    "aws_sdk_verifiedpermissions.types.batch_get_policy_input_item.BatchGetPolicyInputItem"
]
...
def serialize_aws_json_1_0(value: BatchGetPolicyInputList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_verifiedpermissions.types.batch_get_policy_input_item.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> BatchGetPolicyInputList:
    ...
    for item in data:
        out.append(
            aws_sdk_verifiedpermissions.types.batch_get_policy_input_item.deserialize_aws_json_1_0(
                item
            )
        )
    return out
