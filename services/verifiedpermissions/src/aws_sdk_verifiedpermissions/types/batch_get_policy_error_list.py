...
BatchGetPolicyErrorList: TypeAlias = list[
    "aws_sdk_verifiedpermissions.types.batch_get_policy_error_item.BatchGetPolicyErrorItem"
]
...
def serialize_aws_json_1_0(value: BatchGetPolicyErrorList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_verifiedpermissions.types.batch_get_policy_error_item.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> BatchGetPolicyErrorList:
    ...
    for item in data:
        out.append(
            aws_sdk_verifiedpermissions.types.batch_get_policy_error_item.deserialize_aws_json_1_0(
                item
            )
        )
    return out
