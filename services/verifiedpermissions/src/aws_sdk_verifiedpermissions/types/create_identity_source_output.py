...
class CreateIdentitySourceOutput(TypedDict):
    ...
    identity_source_id: "aws_sdk_verifiedpermissions.types.identity_source_id.IdentitySourceId"
...
def deserialize_aws_json_1_0(data: dict) -> CreateIdentitySourceOutput:
    ...
    if "identitySourceId" in data:
        ...
        raise DeserializationError("CreateIdentitySourceOutput.identity_source_id required")
    if "lastUpdatedDate" in data:
        ...
        raise DeserializationError("CreateIdentitySourceOutput.last_updated_date required")
    if "policyStoreId" in data:
        out["policy_store_id"] = data["policyStoreId"]
    else:
        raise DeserializationError("CreateIdentitySourceOutput.policy_store_id required")
    return out