...
def deserialize_aws_json_1_0(data: dict) -> CreatePolicyTemplateOutput:
    ...
    if "policyStoreId" in data:
        ...
        raise DeserializationError("CreatePolicyTemplateOutput.policy_store_id required")
    if "policyTemplateId" in data:
        out["policy_template_id"] = data["policyTemplateId"]
    else:
        raise DeserializationError("CreatePolicyTemplateOutput.policy_template_id required")
    ...
    if "lastUpdatedDate" in data:
        ...
        raise DeserializationError("CreatePolicyTemplateOutput.last_updated_date required")
    return out