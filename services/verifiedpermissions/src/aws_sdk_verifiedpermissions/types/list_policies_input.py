"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#ListPoliciesInput``."""
...
class ListPoliciesInput(TypedDict, closed=True):
    ...
    filter: NotRequired["aws_sdk_verifiedpermissions.types.policy_filter.PolicyFilter"]
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListPoliciesInput) -> dict:
    out: dict = {}
    ...
    if "filter" in value:
        ...
        out["filter"] = (
            aws_sdk_verifiedpermissions.types.policy_filter.serialize_aws_json_1_0(
                value["filter"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ListPoliciesInput:
    ...
    if "filter" in data:
        ...
        out["filter"] = (
            aws_sdk_verifiedpermissions.types.policy_filter.deserialize_aws_json_1_0(
                data["filter"]
            )
        )
    return out
