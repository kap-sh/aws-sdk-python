...
class PutSchemaInput(TypedDict):
...
def serialize_aws_json_1_0(value: PutSchemaInput) -> dict:
    ...
    out["definition"] = (
        aws_sdk_verifiedpermissions.types.schema_definition.serialize_aws_json_1_0(
            value["definition"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> PutSchemaInput:
    ...
    if "definition" in data:
        ...
        out["definition"] = (
            aws_sdk_verifiedpermissions.types.schema_definition.deserialize_aws_json_1_0(
                data["definition"]
            )
        )
    else:
