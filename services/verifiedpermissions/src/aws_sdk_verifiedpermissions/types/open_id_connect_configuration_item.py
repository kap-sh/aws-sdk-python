...
if TYPE_CHECKING:
    ...
    import aws_sdk_verifiedpermissions.types.open_id_connect_group_configuration_item
    import aws_sdk_verifiedpermissions.types.open_id_connect_token_selection_item


class OpenIdConnectConfigurationItem(TypedDict):
    ...
    group_configuration: NotRequired[
        "aws_sdk_verifiedpermissions.types.open_id_connect_group_configuration_item.OpenIdConnectGroupConfigurationItem"
    ]
    ...
    token_selection: "aws_sdk_verifiedpermissions.types.open_id_connect_token_selection_item.OpenIdConnectTokenSelectionItem"
...
def serialize_aws_json_1_0(value: OpenIdConnectConfigurationItem) -> dict:
    ...
    if "group_configuration" in value:
        ...
        out["groupConfiguration"] = (
            aws_sdk_verifiedpermissions.types.open_id_connect_group_configuration_item.serialize_aws_json_1_0(
    ...
    out["tokenSelection"] = (
        aws_sdk_verifiedpermissions.types.open_id_connect_token_selection_item.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> OpenIdConnectConfigurationItem:
    ...
    if "groupConfiguration" in data:
        ...
        out["group_configuration"] = (
            aws_sdk_verifiedpermissions.types.open_id_connect_group_configuration_item.deserialize_aws_json_1_0(
    ...
    if "tokenSelection" in data:
        ...
        out["token_selection"] = (
            aws_sdk_verifiedpermissions.types.open_id_connect_token_selection_item.deserialize_aws_json_1_0(
                data["tokenSelection"]
            )
        )
    else:
