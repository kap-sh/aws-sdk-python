...
class _Configuration_cognitoUserPoolConfiguration(TypedDict, closed=True):
...
class _Configuration_openIdConnectConfiguration(TypedDict, closed=True):
...
Configuration: TypeAlias = (
    _Configuration_cognitoUserPoolConfiguration
    | _Configuration_openIdConnectConfiguration
)
...
def serialize_aws_json_1_0(value: Configuration) -> dict:
    if "cognitoUserPoolConfiguration" in value:
        ...
        return {
            "cognitoUserPoolConfiguration": aws_sdk_verifiedpermissions.types.cognito_user_pool_configuration.serialize_aws_json_1_0(
        ...
        return {
            "openIdConnectConfiguration": aws_sdk_verifiedpermissions.types.open_id_connect_configuration.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Configuration:
    if "cognitoUserPoolConfiguration" in data:
        ...
        return {
            "cognitoUserPoolConfiguration": aws_sdk_verifiedpermissions.types.cognito_user_pool_configuration.deserialize_aws_json_1_0(
        ...
        return {
            "openIdConnectConfiguration": aws_sdk_verifiedpermissions.types.open_id_connect_configuration.deserialize_aws_json_1_0(
