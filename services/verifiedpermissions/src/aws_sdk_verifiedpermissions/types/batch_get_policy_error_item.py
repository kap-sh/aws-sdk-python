...
def serialize_aws_json_1_0(value: BatchGetPolicyErrorItem) -> dict:
    out: dict = {}
    import aws_sdk_verifiedpermissions.types.batch_get_policy_error_code
    out["code"] = aws_sdk_verifiedpermissions.types.batch_get_policy_error_code.serialize_aws_json_1_0(value["code"])
...
def deserialize_aws_json_1_0(data: dict) -> BatchGetPolicyErrorItem:
    ...
    if "code" in data:
        import aws_sdk_verifiedpermissions.types.batch_get_policy_error_code
        out["code"] = aws_sdk_verifiedpermissions.types.batch_get_policy_error_code.deserialize_aws_json_1_0(data["code"])
    else:
