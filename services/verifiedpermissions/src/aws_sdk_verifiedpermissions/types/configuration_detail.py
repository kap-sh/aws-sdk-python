...
ConfigurationDetail: TypeAlias = _ConfigurationDetail_cognitoUserPoolConfiguration | _ConfigurationDetail_openIdConnectConfiguration

# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ConfigurationDetail) -> dict:
    if "cognitoUserPoolConfiguration" in value:
        import aws_sdk_verifiedpermissions.types.cognito_user_pool_configuration_detail
        return {"cognitoUserPoolConfiguration": aws_sdk_verifiedpermissions.types.cognito_user_pool_configuration_detail.serialize_aws_json_1_0(value["cognitoUserPoolConfiguration"])}
    elif "openIdConnectConfiguration" in value:
        import aws_sdk_verifiedpermissions.types.open_id_connect_configuration_detail
        return {"openIdConnectConfiguration": aws_sdk_verifiedpermissions.types.open_id_connect_configuration_detail.serialize_aws_json_1_0(value["openIdConnectConfiguration"])}
    else:
...
def deserialize_aws_json_1_0(data: dict) -> ConfigurationDetail:
    if "cognitoUserPoolConfiguration" in data:
        import aws_sdk_verifiedpermissions.types.cognito_user_pool_configuration_detail
        return {"cognitoUserPoolConfiguration": aws_sdk_verifiedpermissions.types.cognito_user_pool_configuration_detail.deserialize_aws_json_1_0(data["cognitoUserPoolConfiguration"])}
    elif "openIdConnectConfiguration" in data:
        import aws_sdk_verifiedpermissions.types.open_id_connect_configuration_detail
        return {"openIdConnectConfiguration": aws_sdk_verifiedpermissions.types.open_id_connect_configuration_detail.deserialize_aws_json_1_0(data["openIdConnectConfiguration"])}
    else:
