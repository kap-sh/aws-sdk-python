...
if TYPE_CHECKING:
    import aws_sdk_verifiedpermissions.types.validation_mode


class ValidationSettings(TypedDict):
    mode: "aws_sdk_verifiedpermissions.types.validation_mode.ValidationMode"
...
def serialize_aws_json_1_0(value: ValidationSettings) -> dict:
    ...
    out["mode"] = (
        aws_sdk_verifiedpermissions.types.validation_mode.serialize_aws_json_1_0(
            value["mode"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ValidationSettings:
    ...
    if "mode" in data:
        ...
        out["mode"] = (
            aws_sdk_verifiedpermissions.types.validation_mode.deserialize_aws_json_1_0(
                data["mode"]
            )
        )
    else:
