...
def serialize_aws_json_1_0(value: BatchIsAuthorizedOutputItem) -> dict:
    ...
    out["request"] = (
        aws_sdk_verifiedpermissions.types.batch_is_authorized_input_item.serialize_aws_json_1_0(
            value["request"]
        )
    )
    import aws_sdk_verifiedpermissions.types.decision
...
def deserialize_aws_json_1_0(data: dict) -> BatchIsAuthorizedOutputItem:
    ...
    if "request" in data:
        ...
        out["request"] = (
            aws_sdk_verifiedpermissions.types.batch_is_authorized_input_item.deserialize_aws_json_1_0(
                data["request"]
            )
        )
    else:
