"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#UpdateOpenIdConnectConfiguration``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_verifiedpermissions.types.update_open_id_connect_group_configuration
    import aws_sdk_verifiedpermissions.types.update_open_id_connect_token_selection


class UpdateOpenIdConnectConfiguration(TypedDict, closed=True):
    ...
    group_configuration: NotRequired[
        "aws_sdk_verifiedpermissions.types.update_open_id_connect_group_configuration.UpdateOpenIdConnectGroupConfiguration"
    ]
    ...
    token_selection: "aws_sdk_verifiedpermissions.types.update_open_id_connect_token_selection.UpdateOpenIdConnectTokenSelection"
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: UpdateOpenIdConnectConfiguration) -> dict:
    out: dict = {}
    ...
    if "group_configuration" in value:
        ...
        out["groupConfiguration"] = (
            aws_sdk_verifiedpermissions.types.update_open_id_connect_group_configuration.serialize_aws_json_1_0(
    ...
    out["tokenSelection"] = (
        aws_sdk_verifiedpermissions.types.update_open_id_connect_token_selection.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> UpdateOpenIdConnectConfiguration:
    ...
    if "groupConfiguration" in data:
        ...
        out["group_configuration"] = (
            aws_sdk_verifiedpermissions.types.update_open_id_connect_group_configuration.deserialize_aws_json_1_0(
    ...
    if "tokenSelection" in data:
        ...
        out["token_selection"] = (
            aws_sdk_verifiedpermissions.types.update_open_id_connect_token_selection.deserialize_aws_json_1_0(
                data["tokenSelection"]
            )
        )
    else:
        raise DeserializationError(
            "UpdateOpenIdConnectConfiguration.token_selection required"
        )
    return out
