...
if TYPE_CHECKING:
    import aws_sdk_verifiedpermissions.types.kms_encryption_settings


class _EncryptionSettings_kmsEncryptionSettings(TypedDict):
    kmsEncryptionSettings: "aws_sdk_verifiedpermissions.types.kms_encryption_settings.KmsEncryptionSettings"


class _EncryptionSettings_default(TypedDict):
    default: "None"
...
def serialize_aws_json_1_0(value: EncryptionSettings) -> dict:
    if "kmsEncryptionSettings" in value:
        ...
        return {
            "kmsEncryptionSettings": aws_sdk_verifiedpermissions.types.kms_encryption_settings.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> EncryptionSettings:
    if "kmsEncryptionSettings" in data:
        ...
        return {
            "kmsEncryptionSettings": aws_sdk_verifiedpermissions.types.kms_encryption_settings.deserialize_aws_json_1_0(
