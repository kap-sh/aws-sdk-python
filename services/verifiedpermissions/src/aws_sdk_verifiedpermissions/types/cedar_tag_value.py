...
def serialize_aws_json_1_0(value: CedarTagValue) -> dict:
    if "boolean" in value:
        ...
        return {
            "entityIdentifier": aws_sdk_verifiedpermissions.types.entity_identifier.serialize_aws_json_1_0(
        ...
        return {
            "set": aws_sdk_verifiedpermissions.types.cedar_tag_set_attribute.serialize_aws_json_1_0(
                value["set"]
            )
        }
        ...
        return {
            "record": aws_sdk_verifiedpermissions.types.cedar_tag_record_attribute.serialize_aws_json_1_0(
                value["record"]
            )
        }
...
def deserialize_aws_json_1_0(data: dict) -> CedarTagValue:
    if "boolean" in data:
        ...
        return {
            "entityIdentifier": aws_sdk_verifiedpermissions.types.entity_identifier.deserialize_aws_json_1_0(
        ...
        return {
            "set": aws_sdk_verifiedpermissions.types.cedar_tag_set_attribute.deserialize_aws_json_1_0(
                data["set"]
            )
        }
    elif "record" in data:
        ...
        return {
            "record": aws_sdk_verifiedpermissions.types.cedar_tag_record_attribute.deserialize_aws_json_1_0(
                data["record"]
            )
        }
    elif "ipaddr" in data:
