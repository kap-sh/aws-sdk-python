...
CedarTagSetAttribute: TypeAlias = list["aws_sdk_verifiedpermissions.types.cedar_tag_value.CedarTagValue"]
...
def serialize_aws_json_1_0(value: CedarTagSetAttribute) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_verifiedpermissions.types.cedar_tag_value.serialize_aws_json_1_0(item))
    return out
...
def deserialize_aws_json_1_0(data: list) -> CedarTagSetAttribute:
    ...
    for item in data:
        out.append(aws_sdk_verifiedpermissions.types.cedar_tag_value.deserialize_aws_json_1_0(item))
    return out