...
ContextDefinition: TypeAlias = _ContextDefinition_contextMap | _ContextDefinition_cedarJson

# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ContextDefinition) -> dict:
    if "contextMap" in value:
        import aws_sdk_verifiedpermissions.types.context_map
        return {"contextMap": aws_sdk_verifiedpermissions.types.context_map.serialize_aws_json_1_0(value["contextMap"])}
...
def deserialize_aws_json_1_0(data: dict) -> ContextDefinition:
    if "contextMap" in data:
        import aws_sdk_verifiedpermissions.types.context_map
        return {"contextMap": aws_sdk_verifiedpermissions.types.context_map.deserialize_aws_json_1_0(data["contextMap"])}
