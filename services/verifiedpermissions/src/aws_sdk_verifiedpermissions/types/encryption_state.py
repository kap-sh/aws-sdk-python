...
def serialize_aws_json_1_0(value: EncryptionState) -> dict:
    if "kmsEncryptionState" in value:
        ...
        return {
            "kmsEncryptionState": aws_sdk_verifiedpermissions.types.kms_encryption_state.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> EncryptionState:
    if "kmsEncryptionState" in data:
        ...
        return {
            "kmsEncryptionState": aws_sdk_verifiedpermissions.types.kms_encryption_state.deserialize_aws_json_1_0(
