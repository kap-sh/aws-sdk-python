...
class BatchIsAuthorizedWithTokenInput(TypedDict):
    ...
    identity_token: NotRequired["aws_sdk_verifiedpermissions.types.token.Token"]
    ...
    access_token: NotRequired["aws_sdk_verifiedpermissions.types.token.Token"]
    ...
    entities: NotRequired["aws_sdk_verifiedpermissions.types.entities_definition.EntitiesDefinition"]
...
def serialize_aws_json_1_0(value: BatchIsAuthorizedWithTokenInput) -> dict:
    ...
    if "entities" in value:
        import aws_sdk_verifiedpermissions.types.entities_definition
        out["entities"] = aws_sdk_verifiedpermissions.types.entities_definition.serialize_aws_json_1_0(value["entities"])
    import aws_sdk_verifiedpermissions.types.batch_is_authorized_with_token_input_list
    out["requests"] = aws_sdk_verifiedpermissions.types.batch_is_authorized_with_token_input_list.serialize_aws_json_1_0(value["requests"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> BatchIsAuthorizedWithTokenInput:
    ...
    if "policyStoreId" in data:
        ...
        raise DeserializationError("BatchIsAuthorizedWithTokenInput.policy_store_id required")
    ...
    if "entities" in data:
        import aws_sdk_verifiedpermissions.types.entities_definition
        out["entities"] = aws_sdk_verifiedpermissions.types.entities_definition.deserialize_aws_json_1_0(data["entities"])
    if "requests" in data:
        import aws_sdk_verifiedpermissions.types.batch_is_authorized_with_token_input_list
        out["requests"] = aws_sdk_verifiedpermissions.types.batch_is_authorized_with_token_input_list.deserialize_aws_json_1_0(data["requests"])
    else:
