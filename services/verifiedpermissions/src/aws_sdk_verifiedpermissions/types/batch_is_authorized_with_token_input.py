...
def serialize_aws_json_1_0(value: BatchIsAuthorizedWithTokenInput) -> dict:
    ...
    out["requests"] = (
        aws_sdk_verifiedpermissions.types.batch_is_authorized_with_token_input_list.serialize_aws_json_1_0(
            value["requests"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> BatchIsAuthorizedWithTokenInput:
    ...
    if "requests" in data:
        ...
        out["requests"] = (
            aws_sdk_verifiedpermissions.types.batch_is_authorized_with_token_input_list.deserialize_aws_json_1_0(
                data["requests"]
            )
        )
    else:
