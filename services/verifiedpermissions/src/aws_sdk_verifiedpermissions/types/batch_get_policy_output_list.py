...
BatchGetPolicyOutputList: TypeAlias = list[
    "aws_sdk_verifiedpermissions.types.batch_get_policy_output_item.BatchGetPolicyOutputItem"
]
...
def serialize_aws_json_1_0(value: BatchGetPolicyOutputList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_verifiedpermissions.types.batch_get_policy_output_item.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> BatchGetPolicyOutputList:
    ...
    for item in data:
        out.append(
            aws_sdk_verifiedpermissions.types.batch_get_policy_output_item.deserialize_aws_json_1_0(
                item
            )
        )
    return out
