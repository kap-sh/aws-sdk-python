...
class CognitoUserPoolConfigurationDetail(TypedDict):
    ...
    group_configuration: NotRequired["aws_sdk_verifiedpermissions.types.cognito_group_configuration_detail.CognitoGroupConfigurationDetail"]
...
def serialize_aws_json_1_0(value: CognitoUserPoolConfigurationDetail) -> dict:
    ...
    if "group_configuration" in value:
        import aws_sdk_verifiedpermissions.types.cognito_group_configuration_detail
        out["groupConfiguration"] = aws_sdk_verifiedpermissions.types.cognito_group_configuration_detail.serialize_aws_json_1_0(value["group_configuration"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> CognitoUserPoolConfigurationDetail:
    ...
    if "userPoolArn" in data:
        ...
        raise DeserializationError("CognitoUserPoolConfigurationDetail.user_pool_arn required")
    if "clientIds" in data:
        import aws_sdk_verifiedpermissions.types.client_ids
        out["client_ids"] = aws_sdk_verifiedpermissions.types.client_ids.deserialize_aws_json_1_0(data["clientIds"])
    else:
        raise DeserializationError("CognitoUserPoolConfigurationDetail.client_ids required")
    if "issuer" in data:
    ...
    if "groupConfiguration" in data:
        import aws_sdk_verifiedpermissions.types.cognito_group_configuration_detail
        out["group_configuration"] = aws_sdk_verifiedpermissions.types.cognito_group_configuration_detail.deserialize_aws_json_1_0(data["groupConfiguration"])
    return out