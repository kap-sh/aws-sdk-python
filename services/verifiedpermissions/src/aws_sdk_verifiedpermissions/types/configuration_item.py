...
class _ConfigurationItem_cognitoUserPoolConfiguration(TypedDict, closed=True):
...
class _ConfigurationItem_openIdConnectConfiguration(TypedDict, closed=True):
...
ConfigurationItem: TypeAlias = (
    _ConfigurationItem_cognitoUserPoolConfiguration
    | _ConfigurationItem_openIdConnectConfiguration
)
...
def serialize_aws_json_1_0(value: ConfigurationItem) -> dict:
    if "cognitoUserPoolConfiguration" in value:
        ...
        return {
            "cognitoUserPoolConfiguration": aws_sdk_verifiedpermissions.types.cognito_user_pool_configuration_item.serialize_aws_json_1_0(
        ...
        return {
            "openIdConnectConfiguration": aws_sdk_verifiedpermissions.types.open_id_connect_configuration_item.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ConfigurationItem:
    if "cognitoUserPoolConfiguration" in data:
        ...
        return {
            "cognitoUserPoolConfiguration": aws_sdk_verifiedpermissions.types.cognito_user_pool_configuration_item.deserialize_aws_json_1_0(
        ...
        return {
            "openIdConnectConfiguration": aws_sdk_verifiedpermissions.types.open_id_connect_configuration_item.deserialize_aws_json_1_0(
