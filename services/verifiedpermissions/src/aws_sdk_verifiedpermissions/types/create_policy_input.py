...
def serialize_aws_json_1_0(value: CreatePolicyInput) -> dict:
    ...
    out["definition"] = (
        aws_sdk_verifiedpermissions.types.policy_definition.serialize_aws_json_1_0(
            value["definition"]
        )
    )
    if "name" in value:
...
def deserialize_aws_json_1_0(data: dict) -> CreatePolicyInput:
    ...
    if "definition" in data:
        ...
        out["definition"] = (
            aws_sdk_verifiedpermissions.types.policy_definition.deserialize_aws_json_1_0(
                data["definition"]
            )
        )
    else:
