...
if TYPE_CHECKING:
    ...
    import aws_sdk_verifiedpermissions.types.policy_definition
...
class CreatePolicyInput(TypedDict):
    ...
    definition: "aws_sdk_verifiedpermissions.types.policy_definition.PolicyDefinition"
...
def serialize_aws_json_1_0(value: CreatePolicyInput) -> dict:
    ...
    import aws_sdk_verifiedpermissions.types.policy_definition
    out["definition"] = aws_sdk_verifiedpermissions.types.policy_definition.serialize_aws_json_1_0(value["definition"])
    if "name" in value:
        out["name"] = value["name"]
    return out
...
def deserialize_aws_json_1_0(data: dict) -> CreatePolicyInput:
    ...
    if "definition" in data:
        import aws_sdk_verifiedpermissions.types.policy_definition
        out["definition"] = aws_sdk_verifiedpermissions.types.policy_definition.deserialize_aws_json_1_0(data["definition"])
    else:
