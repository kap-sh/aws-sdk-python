...
class BatchGetPolicyOutputItem(TypedDict):
...
def serialize_aws_json_1_0(value: BatchGetPolicyOutputItem) -> dict:
    ...
    import aws_sdk_verifiedpermissions.types.policy_type
    out["policyType"] = aws_sdk_verifiedpermissions.types.policy_type.serialize_aws_json_1_0(value["policy_type"])
    import aws_sdk_verifiedpermissions.types.policy_definition_detail
    out["definition"] = aws_sdk_verifiedpermissions.types.policy_definition_detail.serialize_aws_json_1_0(value["definition"])
    import aws_sdk_verifiedpermissions.types.timestamp_format
...
def deserialize_aws_json_1_0(data: dict) -> BatchGetPolicyOutputItem:
    ...
    if "policyType" in data:
        import aws_sdk_verifiedpermissions.types.policy_type
        out["policy_type"] = aws_sdk_verifiedpermissions.types.policy_type.deserialize_aws_json_1_0(data["policyType"])
    else:
        raise DeserializationError("BatchGetPolicyOutputItem.policy_type required")
    if "definition" in data:
        import aws_sdk_verifiedpermissions.types.policy_definition_detail
        out["definition"] = aws_sdk_verifiedpermissions.types.policy_definition_detail.deserialize_aws_json_1_0(data["definition"])
    else:
    ...
    if "lastUpdatedDate" in data:
        ...
        raise DeserializationError("BatchGetPolicyOutputItem.last_updated_date required")
    if "name" in data:
        out["name"] = data["name"]
    return out