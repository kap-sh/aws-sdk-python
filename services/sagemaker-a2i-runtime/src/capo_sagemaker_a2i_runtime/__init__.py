...
from ._services.async_sage_maker_a2_i_runtime import (
    AsyncSageMakerA2IRuntimeClient as AsyncSageMakerA2IRuntimeClient,
)
from ._services.sage_maker_a2_i_runtime import (
    SageMakerA2IRuntimeClient as SageMakerA2IRuntimeClient,
)
