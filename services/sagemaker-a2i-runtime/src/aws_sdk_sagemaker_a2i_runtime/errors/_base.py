...
class SageMakerA2IRuntimeError(Exception):
    """Base class for all SageMakerA2IRuntime service errors."""


class ServiceError(SageMakerA2IRuntimeError):
...
class SerializationError(SageMakerA2IRuntimeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SageMakerA2IRuntimeError):
...
class WaiterFailedError(SageMakerA2IRuntimeError):
...
class WaiterTimeoutError(SageMakerA2IRuntimeError):
