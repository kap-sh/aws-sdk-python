...
class StartHumanLoopRequest(TypedDict):
    ...
    human_loop_input: NotRequired[
        "aws_sdk_sagemaker_a2i_runtime.types.human_loop_input.HumanLoopInput"
    ]
...
def serialize_json(value: StartHumanLoopRequest) -> dict:
    ...
    if "human_loop_input" in value:
        ...
        out["HumanLoopInput"] = (
            aws_sdk_sagemaker_a2i_runtime.types.human_loop_input.serialize_json(
    ...
    if "data_attributes" in value:
        ...
        out["DataAttributes"] = (
            aws_sdk_sagemaker_a2i_runtime.types.human_loop_data_attributes.serialize_json(
...
def deserialize_json(data: dict) -> StartHumanLoopRequest:
    ...
    if "HumanLoopInput" in data:
        ...
        out["human_loop_input"] = (
            aws_sdk_sagemaker_a2i_runtime.types.human_loop_input.deserialize_json(
                data["HumanLoopInput"]
            )
        )
    if "DataAttributes" in data:
        ...
        out["data_attributes"] = (
            aws_sdk_sagemaker_a2i_runtime.types.human_loop_data_attributes.deserialize_json(
                data["DataAttributes"]
            )
        )
    return out
