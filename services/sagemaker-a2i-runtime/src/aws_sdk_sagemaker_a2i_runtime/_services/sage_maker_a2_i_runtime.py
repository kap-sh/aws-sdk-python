...
from aws_sdk_sagemaker_a2i_runtime._services._aws_config import aws_config
...
class SageMakerA2IRuntimeClientConfig(TypedDict, total=False):
...
class SageMakerA2IRuntimeClient:
    ...
    def delete_human_loop(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sagemaker_a2i_runtime.types.delete_human_loop_request.DeleteHumanLoopRequest]",
        ) -> OperationResponse[
            "aws_sdk_sagemaker_a2i_runtime.types.delete_human_loop_response.DeleteHumanLoopResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sagemaker_a2i_runtime._operations.amazon_sage_maker_a2_i_runtime.delete_human_loop.delete_human_loop(
    ...
    def describe_human_loop(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sagemaker_a2i_runtime.types.describe_human_loop_request.DescribeHumanLoopRequest]",
        ) -> OperationResponse[
            "aws_sdk_sagemaker_a2i_runtime.types.describe_human_loop_response.DescribeHumanLoopResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sagemaker_a2i_runtime._operations.amazon_sage_maker_a2_i_runtime.describe_human_loop.describe_human_loop(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_human_loops(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sagemaker_a2i_runtime.types.list_human_loops_request.ListHumanLoopsRequest]",
        ) -> OperationResponse[
            "aws_sdk_sagemaker_a2i_runtime.types.list_human_loops_response.ListHumanLoopsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sagemaker_a2i_runtime._operations.amazon_sage_maker_a2_i_runtime.list_human_loops.list_human_loops(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_sagemaker_a2i_runtime.types.human_loop_summary.HumanLoopSummary]":
        _token = next_token
        while True:
    ...
    def start_human_loop(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sagemaker_a2i_runtime.types.start_human_loop_request.StartHumanLoopRequest]",
        ) -> OperationResponse[
            "aws_sdk_sagemaker_a2i_runtime.types.start_human_loop_response.StartHumanLoopResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sagemaker_a2i_runtime._operations.amazon_sage_maker_a2_i_runtime.start_human_loop.start_human_loop(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_human_loop(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sagemaker_a2i_runtime.types.stop_human_loop_request.StopHumanLoopRequest]",
        ) -> OperationResponse[
            "aws_sdk_sagemaker_a2i_runtime.types.stop_human_loop_response.StopHumanLoopResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sagemaker_a2i_runtime._operations.amazon_sage_maker_a2_i_runtime.stop_human_loop.stop_human_loop(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
