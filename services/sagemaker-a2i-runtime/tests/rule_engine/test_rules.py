import pytest
from capo_sagemaker_a2i_runtime._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_sagemaker_a2i_runtime._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
