...
class Macie2Error(Exception):
    """Base class for all Macie2 service errors."""


class ServiceError(Macie2Error):
...
class SerializationError(Macie2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(Macie2Error):
...
class WaiterFailedError(Macie2Error):
...
class WaiterTimeoutError(Macie2Error):
