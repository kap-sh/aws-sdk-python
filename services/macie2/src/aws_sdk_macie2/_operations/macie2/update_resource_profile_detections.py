...
def handle_response(
    ...
    out: aws_sdk_macie2.types.update_resource_profile_detections_response.UpdateResourceProfileDetectionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.update_resource_profile_detections_request.UpdateResourceProfileDetectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.update_resource_profile_detections_request.serialize_json(
            input_
        )
    ).encode()
