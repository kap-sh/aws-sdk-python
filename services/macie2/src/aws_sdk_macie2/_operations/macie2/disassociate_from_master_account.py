...
def handle_response(
    ...
    out: aws_sdk_macie2.types.disassociate_from_master_account_response.DisassociateFromMasterAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.disassociate_from_master_account_request.DisassociateFromMasterAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
