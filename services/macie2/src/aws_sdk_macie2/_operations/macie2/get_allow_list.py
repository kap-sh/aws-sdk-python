"""Generated from Smithy shape ``com.amazonaws.macie2#GetAllowList``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_allow_list_response.GetAllowListResponse = (
        aws_sdk_macie2.types.get_allow_list_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_allow_list_request.GetAllowListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_allow_list(
    ...
    aws_sdk_macie2.types.get_allow_list_response.GetAllowListResponse, zapros.Response
]:
...
async def async_get_allow_list(
