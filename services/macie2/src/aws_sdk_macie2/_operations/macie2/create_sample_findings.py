...
def handle_response(
    ...
    out: aws_sdk_macie2.types.create_sample_findings_response.CreateSampleFindingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.create_sample_findings_request.CreateSampleFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.create_sample_findings_request.serialize_json(input_)
    ).encode()
