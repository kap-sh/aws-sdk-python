...
def build_request(
    ...
    input: aws_sdk_macie2.types.create_sample_findings_request.CreateSampleFindingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.create_sample_findings_request.serialize_json(input)
    ).encode()
