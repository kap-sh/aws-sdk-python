...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_bucket_statistics_response.GetBucketStatisticsResponse = aws_sdk_macie2.types.get_bucket_statistics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_bucket_statistics_request.GetBucketStatisticsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.get_bucket_statistics_request.serialize_json(input_)
    ).encode()
