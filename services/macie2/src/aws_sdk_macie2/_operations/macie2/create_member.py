"""Generated from Smithy shape ``com.amazonaws.macie2#CreateMember``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.create_member_response.CreateMemberResponse = (
        aws_sdk_macie2.types.create_member_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.create_member_request.CreateMemberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.create_member_request.serialize_json(input_)
    ).encode()
...
def create_member(
    ...
    aws_sdk_macie2.types.create_member_response.CreateMemberResponse, zapros.Response
]:
