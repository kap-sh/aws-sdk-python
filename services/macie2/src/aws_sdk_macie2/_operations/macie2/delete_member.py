...
def handle_response(
    ...
    out: aws_sdk_macie2.types.delete_member_response.DeleteMemberResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.delete_member_request.DeleteMemberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_member(
    ...
    aws_sdk_macie2.types.delete_member_response.DeleteMemberResponse, zapros.Response
]:
