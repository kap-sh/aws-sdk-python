"""Generated from Smithy shape ``com.amazonaws.macie2#PutClassificationExportConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.put_classification_export_configuration_response.PutClassificationExportConfigurationResponse = aws_sdk_macie2.types.put_classification_export_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.put_classification_export_configuration_request.PutClassificationExportConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/classification-export-configuration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_macie2.types.put_classification_export_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.put_classification_export_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_classification_export_configuration(
