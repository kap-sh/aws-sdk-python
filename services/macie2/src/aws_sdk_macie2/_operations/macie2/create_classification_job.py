...
def handle_response(
    ...
    out: aws_sdk_macie2.types.create_classification_job_response.CreateClassificationJobResponse = aws_sdk_macie2.types.create_classification_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.create_classification_job_request.CreateClassificationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.create_classification_job_request.serialize_json(input_)
    ).encode()
