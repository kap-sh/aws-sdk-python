...
def build_request(
    ...
    input: aws_sdk_macie2.types.create_classification_job_request.CreateClassificationJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.create_classification_job_request.serialize_json(input)
    ).encode()
