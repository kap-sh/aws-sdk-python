...
def handle_response(
    ...
    out: aws_sdk_macie2.types.delete_custom_data_identifier_response.DeleteCustomDataIdentifierResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.delete_custom_data_identifier_request.DeleteCustomDataIdentifierRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
