...
def handle_response(
    ...
    out: aws_sdk_macie2.types.describe_organization_configuration_response.DescribeOrganizationConfigurationResponse = aws_sdk_macie2.types.describe_organization_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.describe_organization_configuration_request.DescribeOrganizationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
