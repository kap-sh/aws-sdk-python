...
def build_request(
    ...
    input: aws_sdk_macie2.types.list_classification_jobs_request.ListClassificationJobsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.list_classification_jobs_request.serialize_json(input)
    ).encode()
