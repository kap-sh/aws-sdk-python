"""Generated from Smithy shape ``com.amazonaws.macie2#ListClassificationJobs``."""
...
import aws_sdk_macie2.types.__list_of_job_summary
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.list_classification_jobs_response.ListClassificationJobsResponse = aws_sdk_macie2.types.list_classification_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.list_classification_jobs_request.ListClassificationJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/jobs/list"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_macie2.types.list_classification_jobs_request

    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.list_classification_jobs_request.serialize_json(input_)
    ).encode()
...
async def async_list_classification_jobs(
