...
def build_request(
    ...
    input: aws_sdk_macie2.types.test_custom_data_identifier_request.TestCustomDataIdentifierRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.test_custom_data_identifier_request.serialize_json(input)
    ).encode()
