...
def handle_response(
    ...
    out: aws_sdk_macie2.types.test_custom_data_identifier_response.TestCustomDataIdentifierResponse = aws_sdk_macie2.types.test_custom_data_identifier_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.test_custom_data_identifier_request.TestCustomDataIdentifierRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.test_custom_data_identifier_request.serialize_json(input_)
    ).encode()
