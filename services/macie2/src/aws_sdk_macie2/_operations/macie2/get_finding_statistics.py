...
def build_request(
    ...
    input: aws_sdk_macie2.types.get_finding_statistics_request.GetFindingStatisticsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.get_finding_statistics_request.serialize_json(input)
    ).encode()
