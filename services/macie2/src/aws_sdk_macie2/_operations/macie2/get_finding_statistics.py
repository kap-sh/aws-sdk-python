...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_finding_statistics_response.GetFindingStatisticsResponse = aws_sdk_macie2.types.get_finding_statistics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_finding_statistics_request.GetFindingStatisticsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.get_finding_statistics_request.serialize_json(input_)
    ).encode()
