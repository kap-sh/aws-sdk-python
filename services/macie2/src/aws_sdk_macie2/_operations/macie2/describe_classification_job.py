...
def handle_response(
    ...
    out: aws_sdk_macie2.types.describe_classification_job_response.DescribeClassificationJobResponse = aws_sdk_macie2.types.describe_classification_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.describe_classification_job_request.DescribeClassificationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
