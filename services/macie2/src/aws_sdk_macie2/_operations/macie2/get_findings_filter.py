...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_findings_filter_response.GetFindingsFilterResponse = (
        aws_sdk_macie2.types.get_findings_filter_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_findings_filter_request.GetFindingsFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
