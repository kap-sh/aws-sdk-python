...
def build_request(
    ...
    input_: aws_sdk_macie2.types.list_custom_data_identifiers_request.ListCustomDataIdentifiersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.list_custom_data_identifiers_request.serialize_json(input_)
    ).encode()
