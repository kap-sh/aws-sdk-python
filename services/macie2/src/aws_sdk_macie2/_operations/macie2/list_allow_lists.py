"""Generated from Smithy shape ``com.amazonaws.macie2#ListAllowLists``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.list_allow_lists_response.ListAllowListsResponse = (
        aws_sdk_macie2.types.list_allow_lists_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.list_allow_lists_request.ListAllowListsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_allow_lists(
