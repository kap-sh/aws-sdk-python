"""Generated from Smithy shape ``com.amazonaws.macie2#UpdateFindingsFilter``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.update_findings_filter_response.UpdateFindingsFilterResponse = aws_sdk_macie2.types.update_findings_filter_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.update_findings_filter_request.UpdateFindingsFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/findingsfilters/{id}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.update_findings_filter_request.serialize_json(input_)
    ).encode()
...
async def async_update_findings_filter(
