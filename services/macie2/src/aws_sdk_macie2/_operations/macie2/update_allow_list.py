...
def handle_response(
    ...
    out: aws_sdk_macie2.types.update_allow_list_response.UpdateAllowListResponse = (
        aws_sdk_macie2.types.update_allow_list_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.update_allow_list_request.UpdateAllowListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.update_allow_list_request.serialize_json(input_)
    ).encode()
