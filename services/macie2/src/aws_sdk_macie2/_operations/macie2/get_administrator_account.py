...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_administrator_account_response.GetAdministratorAccountResponse = aws_sdk_macie2.types.get_administrator_account_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_administrator_account_request.GetAdministratorAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
