...
def handle_response(
    ...
    out: aws_sdk_macie2.types.list_members_response.ListMembersResponse = (
        aws_sdk_macie2.types.list_members_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.list_members_request.ListMembersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_members(
    ...
    aws_sdk_macie2.types.list_members_response.ListMembersResponse, zapros.Response
]:
