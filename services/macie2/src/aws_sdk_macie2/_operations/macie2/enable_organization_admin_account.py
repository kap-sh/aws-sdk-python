"""Generated from Smithy shape ``com.amazonaws.macie2#EnableOrganizationAdminAccount``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.enable_organization_admin_account_response.EnableOrganizationAdminAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.enable_organization_admin_account_request.EnableOrganizationAdminAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.enable_organization_admin_account_request.serialize_json(
            input_
        )
    ).encode()
