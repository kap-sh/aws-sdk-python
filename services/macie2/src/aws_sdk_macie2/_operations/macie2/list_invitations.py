"""Generated from Smithy shape ``com.amazonaws.macie2#ListInvitations``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.list_invitations_response.ListInvitationsResponse = (
        aws_sdk_macie2.types.list_invitations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.list_invitations_request.ListInvitationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
