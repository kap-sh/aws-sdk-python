...
def handle_response(
    ...
    out: aws_sdk_macie2.types.accept_invitation_response.AcceptInvitationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.accept_invitation_request.AcceptInvitationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.accept_invitation_request.serialize_json(input_)
    ).encode()
