...
import aws_sdk_macie2.types.__list_of_managed_data_identifier_summary
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.list_managed_data_identifiers_request.ListManagedDataIdentifiersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
