"""Generated from Smithy shape ``com.amazonaws.macie2#ListManagedDataIdentifiers``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.list_managed_data_identifiers_response.ListManagedDataIdentifiersResponse = aws_sdk_macie2.types.list_managed_data_identifiers_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_macie2.types.list_managed_data_identifiers_request.ListManagedDataIdentifiersRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.list_managed_data_identifiers_request.serialize_json(input)
    ).encode()
...
async def async_list_managed_data_identifiers(
