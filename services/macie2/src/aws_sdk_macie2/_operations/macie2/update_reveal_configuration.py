...
def handle_response(
    ...
    out: aws_sdk_macie2.types.update_reveal_configuration_response.UpdateRevealConfigurationResponse = aws_sdk_macie2.types.update_reveal_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.update_reveal_configuration_request.UpdateRevealConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.update_reveal_configuration_request.serialize_json(input_)
    ).encode()
