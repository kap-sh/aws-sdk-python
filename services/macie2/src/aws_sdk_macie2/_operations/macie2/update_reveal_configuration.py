...
def build_request(
    ...
    input: aws_sdk_macie2.types.update_reveal_configuration_request.UpdateRevealConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.update_reveal_configuration_request.serialize_json(input)
    ).encode()
