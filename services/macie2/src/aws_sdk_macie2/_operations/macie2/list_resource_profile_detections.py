...
def handle_response(
    ...
    out: aws_sdk_macie2.types.list_resource_profile_detections_response.ListResourceProfileDetectionsResponse = aws_sdk_macie2.types.list_resource_profile_detections_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.list_resource_profile_detections_request.ListResourceProfileDetectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
