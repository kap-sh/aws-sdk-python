...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_member_response.GetMemberResponse = (
        aws_sdk_macie2.types.get_member_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_member_request.GetMemberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_member(
    ...
    input_: aws_sdk_macie2.types.get_member_request.GetMemberRequest,
) -> tuple[aws_sdk_macie2.types.get_member_response.GetMemberResponse, zapros.Response]:
