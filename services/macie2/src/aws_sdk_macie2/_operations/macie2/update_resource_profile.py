...
def build_request(
    ...
    input: aws_sdk_macie2.types.update_resource_profile_request.UpdateResourceProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.update_resource_profile_request.serialize_json(input)
    ).encode()
