"""Generated from Smithy shape ``com.amazonaws.macie2#UpdateResourceProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.update_resource_profile_response.UpdateResourceProfileResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.update_resource_profile_request.UpdateResourceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/resource-profiles"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.update_resource_profile_request.serialize_json(input_)
    ).encode()
...
async def async_update_resource_profile(
