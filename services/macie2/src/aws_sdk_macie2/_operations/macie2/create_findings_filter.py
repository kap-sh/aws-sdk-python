...
def build_request(
    ...
    input: aws_sdk_macie2.types.create_findings_filter_request.CreateFindingsFilterRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.create_findings_filter_request.serialize_json(input)
    ).encode()
