...
def handle_response(
    ...
    out: aws_sdk_macie2.types.create_findings_filter_response.CreateFindingsFilterResponse = aws_sdk_macie2.types.create_findings_filter_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.create_findings_filter_request.CreateFindingsFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.create_findings_filter_request.serialize_json(input_)
    ).encode()
