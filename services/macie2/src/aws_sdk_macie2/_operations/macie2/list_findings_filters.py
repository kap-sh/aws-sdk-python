...
def handle_response(
    ...
    out: aws_sdk_macie2.types.list_findings_filters_response.ListFindingsFiltersResponse = aws_sdk_macie2.types.list_findings_filters_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.list_findings_filters_request.ListFindingsFiltersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
