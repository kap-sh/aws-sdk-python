...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_findings_publication_configuration_response.GetFindingsPublicationConfigurationResponse = aws_sdk_macie2.types.get_findings_publication_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_findings_publication_configuration_request.GetFindingsPublicationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
