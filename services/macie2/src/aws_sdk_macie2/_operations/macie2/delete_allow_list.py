...
def handle_response(
    ...
    out: aws_sdk_macie2.types.delete_allow_list_response.DeleteAllowListResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_macie2.types.delete_allow_list_request.DeleteAllowListRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "ignore_job_checks" in input:
        params["ignoreJobChecks"] = str(input["ignore_job_checks"])
