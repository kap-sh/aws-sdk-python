...
def handle_response(
    ...
    out: aws_sdk_macie2.types.create_invitations_response.CreateInvitationsResponse = (
        aws_sdk_macie2.types.create_invitations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.create_invitations_request.CreateInvitationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.create_invitations_request.serialize_json(input_)
    ).encode()
