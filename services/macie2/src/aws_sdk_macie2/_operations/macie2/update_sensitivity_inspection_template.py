...
def handle_response(
    ...
    out: aws_sdk_macie2.types.update_sensitivity_inspection_template_response.UpdateSensitivityInspectionTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.update_sensitivity_inspection_template_request.UpdateSensitivityInspectionTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.update_sensitivity_inspection_template_request.serialize_json(
            input_
        )
    ).encode()
