...
def handle_response(
    ...
    out: aws_sdk_macie2.types.delete_invitations_response.DeleteInvitationsResponse = (
        aws_sdk_macie2.types.delete_invitations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.delete_invitations_request.DeleteInvitationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.delete_invitations_request.serialize_json(input_)
    ).encode()
