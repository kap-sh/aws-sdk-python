...
def handle_response(
    ...
    out: aws_sdk_macie2.types.delete_findings_filter_response.DeleteFindingsFilterResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.delete_findings_filter_request.DeleteFindingsFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
