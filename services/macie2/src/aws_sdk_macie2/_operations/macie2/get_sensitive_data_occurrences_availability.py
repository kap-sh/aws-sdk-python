...
def build_request(
    ...
    input: aws_sdk_macie2.types.get_sensitive_data_occurrences_availability_request.GetSensitiveDataOccurrencesAvailabilityRequest,
) -> zapros.Request:
    ...
    url = url.replace("{findingId}", quote(str(input["finding_id"]), safe=""))
    params: dict[str, str] = {}
