"""Generated from Smithy shape ``com.amazonaws.macie2#GetSensitiveDataOccurrencesAvailability``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_sensitive_data_occurrences_availability_response.GetSensitiveDataOccurrencesAvailabilityResponse = aws_sdk_macie2.types.get_sensitive_data_occurrences_availability_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_sensitive_data_occurrences_availability_request.GetSensitiveDataOccurrencesAvailabilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/findings/{findingId}/reveal/availability"
    url = url.replace("{findingId}", quote(str(input_["finding_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_get_sensitive_data_occurrences_availability(
