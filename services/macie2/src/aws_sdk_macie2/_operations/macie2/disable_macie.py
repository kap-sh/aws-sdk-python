...
def handle_response(
    ...
    out: aws_sdk_macie2.types.disable_macie_response.DisableMacieResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.disable_macie_request.DisableMacieRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def disable_macie(
    ...
    aws_sdk_macie2.types.disable_macie_response.DisableMacieResponse, zapros.Response
]:
