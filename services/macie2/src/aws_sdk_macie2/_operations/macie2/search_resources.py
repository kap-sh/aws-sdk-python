"""Generated from Smithy shape ``com.amazonaws.macie2#SearchResources``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.search_resources_response.SearchResourcesResponse = (
        aws_sdk_macie2.types.search_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.search_resources_request.SearchResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/datasources/search-resources"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_macie2.types.search_resources_request

    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.search_resources_request.serialize_json(input_)
    ).encode()
