...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_reveal_configuration_response.GetRevealConfigurationResponse = aws_sdk_macie2.types.get_reveal_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_reveal_configuration_request.GetRevealConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
