"""Generated from Smithy shape ``com.amazonaws.macie2#GetCustomDataIdentifier``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_custom_data_identifier_response.GetCustomDataIdentifierResponse = aws_sdk_macie2.types.get_custom_data_identifier_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_custom_data_identifier_request.GetCustomDataIdentifierRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_custom_data_identifier(
