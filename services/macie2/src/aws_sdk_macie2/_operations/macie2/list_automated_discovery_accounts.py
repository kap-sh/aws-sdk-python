...
def handle_response(
    ...
    out: aws_sdk_macie2.types.list_automated_discovery_accounts_response.ListAutomatedDiscoveryAccountsResponse = aws_sdk_macie2.types.list_automated_discovery_accounts_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_macie2.types.list_automated_discovery_accounts_request.ListAutomatedDiscoveryAccountsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "account_ids" in input:
        params["accountIds"] = str(input["account_ids"])
