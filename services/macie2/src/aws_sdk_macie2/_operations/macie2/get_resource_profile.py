...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_resource_profile_response.GetResourceProfileResponse = aws_sdk_macie2.types.get_resource_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_resource_profile_request.GetResourceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
