...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_classification_scope_response.GetClassificationScopeResponse = aws_sdk_macie2.types.get_classification_scope_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_classification_scope_request.GetClassificationScopeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
