...
def build_request(
    ...
    input: aws_sdk_macie2.types.get_usage_statistics_request.GetUsageStatisticsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.get_usage_statistics_request.serialize_json(input)
    ).encode()
