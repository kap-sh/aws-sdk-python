...
def handle_response(
    ...
    out: aws_sdk_macie2.types.update_classification_scope_response.UpdateClassificationScopeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_macie2.types.update_classification_scope_request.UpdateClassificationScopeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.update_classification_scope_request.serialize_json(input)
    ).encode()
