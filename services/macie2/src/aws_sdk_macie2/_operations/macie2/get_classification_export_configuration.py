...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_classification_export_configuration_response.GetClassificationExportConfigurationResponse = aws_sdk_macie2.types.get_classification_export_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_classification_export_configuration_request.GetClassificationExportConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
