...
def handle_response(
    ...
    out: aws_sdk_macie2.types.enable_macie_response.EnableMacieResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.enable_macie_request.EnableMacieRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.enable_macie_request.serialize_json(input_)
    ).encode()
...
def enable_macie(
    ...
    aws_sdk_macie2.types.enable_macie_response.EnableMacieResponse, zapros.Response
]:
