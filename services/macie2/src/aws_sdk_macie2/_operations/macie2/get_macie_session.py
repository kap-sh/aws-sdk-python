"""Generated from Smithy shape ``com.amazonaws.macie2#GetMacieSession``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_macie_session_response.GetMacieSessionResponse = (
        aws_sdk_macie2.types.get_macie_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_macie_session_request.GetMacieSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_macie_session(
