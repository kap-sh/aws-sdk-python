...
def handle_response(
    ...
    out: aws_sdk_macie2.types.update_classification_job_response.UpdateClassificationJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.update_classification_job_request.UpdateClassificationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.update_classification_job_request.serialize_json(input_)
    ).encode()
