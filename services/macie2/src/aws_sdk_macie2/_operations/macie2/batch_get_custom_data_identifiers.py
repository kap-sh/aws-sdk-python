...
def handle_response(
    ...
    out: aws_sdk_macie2.types.batch_get_custom_data_identifiers_response.BatchGetCustomDataIdentifiersResponse = aws_sdk_macie2.types.batch_get_custom_data_identifiers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.batch_get_custom_data_identifiers_request.BatchGetCustomDataIdentifiersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.batch_get_custom_data_identifiers_request.serialize_json(
            input_
        )
    ).encode()
