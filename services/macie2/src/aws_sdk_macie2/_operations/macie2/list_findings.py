"""Generated from Smithy shape ``com.amazonaws.macie2#ListFindings``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.list_findings_response.ListFindingsResponse = (
        aws_sdk_macie2.types.list_findings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.list_findings_request.ListFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/findings"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_macie2.types.list_findings_request

    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.list_findings_request.serialize_json(input_)
    ).encode()
...
def list_findings(
    ...
    aws_sdk_macie2.types.list_findings_response.ListFindingsResponse, zapros.Response
]:
