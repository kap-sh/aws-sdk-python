...
def handle_response(
    ...
    out: aws_sdk_macie2.types.list_organization_admin_accounts_response.ListOrganizationAdminAccountsResponse = aws_sdk_macie2.types.list_organization_admin_accounts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.list_organization_admin_accounts_request.ListOrganizationAdminAccountsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
