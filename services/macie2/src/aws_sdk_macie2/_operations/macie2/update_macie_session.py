"""Generated from Smithy shape ``com.amazonaws.macie2#UpdateMacieSession``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.update_macie_session_response.UpdateMacieSessionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.update_macie_session_request.UpdateMacieSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.update_macie_session_request.serialize_json(input_)
    ).encode()
...
async def async_update_macie_session(
