...
def build_request(
    ...
    input: aws_sdk_macie2.types.update_macie_session_request.UpdateMacieSessionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.update_macie_session_request.serialize_json(input)
    ).encode()
