...
def handle_response(
    ...
    out: aws_sdk_macie2.types.list_sensitivity_inspection_templates_response.ListSensitivityInspectionTemplatesResponse = aws_sdk_macie2.types.list_sensitivity_inspection_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.list_sensitivity_inspection_templates_request.ListSensitivityInspectionTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
