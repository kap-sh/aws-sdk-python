...
def handle_response(
    ...
    out: aws_sdk_macie2.types.describe_buckets_response.DescribeBucketsResponse = (
        aws_sdk_macie2.types.describe_buckets_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_macie2.types.describe_buckets_request.DescribeBucketsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.describe_buckets_request.serialize_json(input)
    ).encode()
