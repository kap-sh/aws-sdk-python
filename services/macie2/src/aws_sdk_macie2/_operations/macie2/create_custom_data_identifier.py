...
def build_request(
    ...
    input_: aws_sdk_macie2.types.create_custom_data_identifier_request.CreateCustomDataIdentifierRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.create_custom_data_identifier_request.serialize_json(
            input_
        )
    ).encode()
