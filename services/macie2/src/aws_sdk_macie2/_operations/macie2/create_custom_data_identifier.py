"""Generated from Smithy shape ``com.amazonaws.macie2#CreateCustomDataIdentifier``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.create_custom_data_identifier_response.CreateCustomDataIdentifierResponse = aws_sdk_macie2.types.create_custom_data_identifier_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_macie2.types.create_custom_data_identifier_request.CreateCustomDataIdentifierRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/custom-data-identifiers"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_macie2.types.create_custom_data_identifier_request

    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.create_custom_data_identifier_request.serialize_json(input)
    ).encode()
...
async def async_create_custom_data_identifier(
