...
import aws_sdk_macie2.errors.unprocessable_entity_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnprocessableEntityException":
            raise aws_sdk_macie2.errors.unprocessable_entity_exception.UnprocessableEntityException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_sensitive_data_occurrences_response.GetSensitiveDataOccurrencesResponse = aws_sdk_macie2.types.get_sensitive_data_occurrences_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_sensitive_data_occurrences_request.GetSensitiveDataOccurrencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
