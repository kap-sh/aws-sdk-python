"""Generated from Smithy shape ``com.amazonaws.macie2#ListClassificationScopes``."""
...
import aws_sdk_macie2.types.__list_of_classification_scope_summary
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.list_classification_scopes_response.ListClassificationScopesResponse = aws_sdk_macie2.types.list_classification_scopes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.list_classification_scopes_request.ListClassificationScopesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/classification-scopes"
    params: dict[str, str] = {}
    if "name" in input_:
...
async def async_list_classification_scopes(
