...
def handle_response(
    ...
    out: aws_sdk_macie2.types.list_resource_profile_artifacts_response.ListResourceProfileArtifactsResponse = aws_sdk_macie2.types.list_resource_profile_artifacts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.list_resource_profile_artifacts_request.ListResourceProfileArtifactsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
