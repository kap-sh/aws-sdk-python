...
def build_request(
    ...
    input: aws_sdk_macie2.types.update_member_session_request.UpdateMemberSessionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_macie2.types.update_member_session_request.serialize_json(input)
    ).encode()
