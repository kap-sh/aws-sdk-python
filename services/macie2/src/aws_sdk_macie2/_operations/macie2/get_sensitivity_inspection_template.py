...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_sensitivity_inspection_template_response.GetSensitivityInspectionTemplateResponse = aws_sdk_macie2.types.get_sensitivity_inspection_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_sensitivity_inspection_template_request.GetSensitivityInspectionTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
