"""Generated from Smithy shape ``com.amazonaws.macie2#GetAutomatedDiscoveryConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_macie2.types.get_automated_discovery_configuration_response.GetAutomatedDiscoveryConfigurationResponse = aws_sdk_macie2.types.get_automated_discovery_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_macie2.types.get_automated_discovery_configuration_request.GetAutomatedDiscoveryConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_automated_discovery_configuration(
