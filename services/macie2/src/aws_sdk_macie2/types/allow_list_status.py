...
if TYPE_CHECKING:
    ...
    import aws_sdk_macie2.types.allow_list_status_code


class AllowListStatus(TypedDict):
    code: NotRequired["aws_sdk_macie2.types.allow_list_status_code.AllowListStatusCode"]
...
def serialize_json(value: AllowListStatus) -> dict:
    ...
    if "code" in value:
        ...
        out["code"] = aws_sdk_macie2.types.allow_list_status_code.serialize_json(
            value["code"]
        )
...
def deserialize_json(data: dict) -> AllowListStatus:
    ...
    if "code" in data:
        ...
        out["code"] = aws_sdk_macie2.types.allow_list_status_code.deserialize_json(
            data["code"]
        )
