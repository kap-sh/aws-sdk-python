...
if TYPE_CHECKING:
    import aws_sdk_macie2.types.__list_of_detected_data_details
    import aws_sdk_macie2.types.__string

SensitiveDataOccurrences: TypeAlias = dict[
    "aws_sdk_macie2.types.__string.__string",
    "aws_sdk_macie2.types.__list_of_detected_data_details.__listOfDetectedDataDetails",
]
...
def serialize_json(input_to_serialize: SensitiveDataOccurrences) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_macie2.types.__list_of_detected_data_details.serialize_json(
            value
        )
    return out
...
def deserialize_json(data: dict) -> SensitiveDataOccurrences:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            aws_sdk_macie2.types.__list_of_detected_data_details.deserialize_json(value)
        )
    return out
