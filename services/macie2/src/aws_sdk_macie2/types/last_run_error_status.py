...
if TYPE_CHECKING:
    import aws_sdk_macie2.types.last_run_error_status_code


class LastRunErrorStatus(TypedDict):
    code: NotRequired[
        "aws_sdk_macie2.types.last_run_error_status_code.LastRunErrorStatusCode"
    ]
...
def serialize_json(value: LastRunErrorStatus) -> dict:
    ...
    if "code" in value:
        ...
        out["code"] = aws_sdk_macie2.types.last_run_error_status_code.serialize_json(
            value["code"]
        )
    return out
...
def deserialize_json(data: dict) -> LastRunErrorStatus:
    ...
    if "code" in data:
        ...
        out["code"] = aws_sdk_macie2.types.last_run_error_status_code.deserialize_json(
            data["code"]
        )
    return out
