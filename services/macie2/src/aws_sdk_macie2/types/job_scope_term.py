...
class JobScopeTerm(TypedDict):
    ...
    tag_scope_term: NotRequired["aws_sdk_macie2.types.tag_scope_term.TagScopeTerm"]
...
def serialize_json(value: JobScopeTerm) -> dict:
    ...
    if "simple_scope_term" in value:
        ...
        out["simpleScopeTerm"] = aws_sdk_macie2.types.simple_scope_term.serialize_json(
            value["simple_scope_term"]
        )
    if "tag_scope_term" in value:
        import aws_sdk_macie2.types.tag_scope_term

        out["tagScopeTerm"] = aws_sdk_macie2.types.tag_scope_term.serialize_json(
...
def deserialize_json(data: dict) -> JobScopeTerm:
    ...
    if "simpleScopeTerm" in data:
        ...
        out["simple_scope_term"] = (
            aws_sdk_macie2.types.simple_scope_term.deserialize_json(
    ...
    if "tagScopeTerm" in data:
        ...
        out["tag_scope_term"] = aws_sdk_macie2.types.tag_scope_term.deserialize_json(
            data["tagScopeTerm"]
        )
    return out
