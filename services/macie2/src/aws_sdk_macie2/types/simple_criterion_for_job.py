...
if TYPE_CHECKING:
    ...
    import aws_sdk_macie2.types.simple_criterion_key_for_job


class SimpleCriterionForJob(TypedDict):
    ...
    key: NotRequired[
        "aws_sdk_macie2.types.simple_criterion_key_for_job.SimpleCriterionKeyForJob"
    ]
...
def serialize_json(value: SimpleCriterionForJob) -> dict:
    ...
    if "key" in value:
        ...
        out["key"] = aws_sdk_macie2.types.simple_criterion_key_for_job.serialize_json(
            value["key"]
        )
    if "values" in value:
        import aws_sdk_macie2.types.__list_of__string
...
def deserialize_json(data: dict) -> SimpleCriterionForJob:
    ...
    if "key" in data:
        ...
        out["key"] = aws_sdk_macie2.types.simple_criterion_key_for_job.deserialize_json(
            data["key"]
        )
    if "values" in data:
        import aws_sdk_macie2.types.__list_of__string
