...
if TYPE_CHECKING:
    ...
    import aws_sdk_macie2.types.s3_bucket_criteria_for_job
...
class S3JobDefinition(TypedDict, closed=True):
    ...
    bucket_definitions: NotRequired[
        "aws_sdk_macie2.types.__list_of_s3_bucket_definition_for_job.__listOfS3BucketDefinitionForJob"
    ]
    ...
    scoping: NotRequired["aws_sdk_macie2.types.scoping.Scoping"]
...
def serialize_json(value: S3JobDefinition) -> dict:
    ...
    if "bucket_criteria" in value:
        ...
        out["bucketCriteria"] = (
            aws_sdk_macie2.types.s3_bucket_criteria_for_job.serialize_json(
    ...
    if "bucket_definitions" in value:
        ...
        out["bucketDefinitions"] = (
            aws_sdk_macie2.types.__list_of_s3_bucket_definition_for_job.serialize_json(
    ...
    if "scoping" in value:
        ...
        out["scoping"] = aws_sdk_macie2.types.scoping.serialize_json(value["scoping"])
    return out
...
def deserialize_json(data: dict) -> S3JobDefinition:
    ...
    if "bucketCriteria" in data:
        ...
        out["bucket_criteria"] = (
            aws_sdk_macie2.types.s3_bucket_criteria_for_job.deserialize_json(
                data["bucketCriteria"]
            )
        )
    if "bucketDefinitions" in data:
        ...
        out["bucket_definitions"] = (
            aws_sdk_macie2.types.__list_of_s3_bucket_definition_for_job.deserialize_json(
    ...
    if "scoping" in data:
        ...
        out["scoping"] = aws_sdk_macie2.types.scoping.deserialize_json(data["scoping"])
    return out
