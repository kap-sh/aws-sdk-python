...
class S3ClassificationScopeExclusionUpdate(TypedDict, closed=True):
    ...
    operation: NotRequired[
        "aws_sdk_macie2.types.classification_scope_update_operation.ClassificationScopeUpdateOperation"
    ]
...
def serialize_json(value: S3ClassificationScopeExclusionUpdate) -> dict:
    ...
    if "operation" in value:
        ...
        out["operation"] = (
            aws_sdk_macie2.types.classification_scope_update_operation.serialize_json(
                value["operation"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> S3ClassificationScopeExclusionUpdate:
    ...
    if "operation" in data:
        ...
        out["operation"] = (
            aws_sdk_macie2.types.classification_scope_update_operation.deserialize_json(
                data["operation"]
            )
        )
    return out
