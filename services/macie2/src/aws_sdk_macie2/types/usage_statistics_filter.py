...
if TYPE_CHECKING:
    ...
    import aws_sdk_macie2.types.usage_statistics_filter_comparator
    import aws_sdk_macie2.types.usage_statistics_filter_key


class UsageStatisticsFilter(TypedDict):
    comparator: NotRequired[
        "aws_sdk_macie2.types.usage_statistics_filter_comparator.UsageStatisticsFilterComparator"
    ]
    ...
    key: NotRequired[
        "aws_sdk_macie2.types.usage_statistics_filter_key.UsageStatisticsFilterKey"
    ]
...
def serialize_json(value: UsageStatisticsFilter) -> dict:
    ...
    if "comparator" in value:
        ...
        out["comparator"] = (
            aws_sdk_macie2.types.usage_statistics_filter_comparator.serialize_json(
                value["comparator"]
            )
        )
    if "key" in value:
        ...
        out["key"] = aws_sdk_macie2.types.usage_statistics_filter_key.serialize_json(
            value["key"]
        )
    if "values" in value:
        import aws_sdk_macie2.types.__list_of__string
...
def deserialize_json(data: dict) -> UsageStatisticsFilter:
    ...
    if "comparator" in data:
        ...
        out["comparator"] = (
            aws_sdk_macie2.types.usage_statistics_filter_comparator.deserialize_json(
                data["comparator"]
            )
        )
    if "key" in data:
        ...
        out["key"] = aws_sdk_macie2.types.usage_statistics_filter_key.deserialize_json(
            data["key"]
        )
    if "values" in data:
        import aws_sdk_macie2.types.__list_of__string
