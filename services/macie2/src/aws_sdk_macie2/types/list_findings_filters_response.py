...
if TYPE_CHECKING:
    import aws_sdk_macie2.types.__list_of_findings_filter_list_item
    import aws_sdk_macie2.types.__string


class ListFindingsFiltersResponse(TypedDict):
    findings_filter_list_items: NotRequired[
        "aws_sdk_macie2.types.__list_of_findings_filter_list_item.__listOfFindingsFilterListItem"
    ]
...
def serialize_json(value: ListFindingsFiltersResponse) -> dict:
    ...
    if "findings_filter_list_items" in value:
        ...
        out["findingsFilterListItems"] = (
            aws_sdk_macie2.types.__list_of_findings_filter_list_item.serialize_json(
...
def deserialize_json(data: dict) -> ListFindingsFiltersResponse:
    ...
    if "findingsFilterListItems" in data:
        ...
        out["findings_filter_list_items"] = (
            aws_sdk_macie2.types.__list_of_findings_filter_list_item.deserialize_json(
