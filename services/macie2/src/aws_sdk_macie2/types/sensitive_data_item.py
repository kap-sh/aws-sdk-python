...
if TYPE_CHECKING:
    ...
    import aws_sdk_macie2.types.default_detections
    import aws_sdk_macie2.types.sensitive_data_item_category


class SensitiveDataItem(TypedDict):
    ...
    detections: NotRequired["aws_sdk_macie2.types.default_detections.DefaultDetections"]
...
def serialize_json(value: SensitiveDataItem) -> dict:
    ...
    if "detections" in value:
        ...
        out["detections"] = aws_sdk_macie2.types.default_detections.serialize_json(
            value["detections"]
        )
...
def deserialize_json(data: dict) -> SensitiveDataItem:
    ...
    if "detections" in data:
        ...
        out["detections"] = aws_sdk_macie2.types.default_detections.deserialize_json(
            data["detections"]
        )
