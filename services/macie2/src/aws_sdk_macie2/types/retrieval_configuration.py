...
if TYPE_CHECKING:
    ...
    import aws_sdk_macie2.types.__string_min1_max64_pattern_w
...
class RetrievalConfiguration(TypedDict):
    ...
    role_name: NotRequired[
        "aws_sdk_macie2.types.__string_min1_max64_pattern_w.__stringMin1Max64PatternW"
    ]
...
def serialize_json(value: RetrievalConfiguration) -> dict:
    ...
    if "retrieval_mode" in value:
        ...
        out["retrievalMode"] = aws_sdk_macie2.types.retrieval_mode.serialize_json(
...
def deserialize_json(data: dict) -> RetrievalConfiguration:
    ...
    if "retrievalMode" in data:
        ...
        out["retrieval_mode"] = aws_sdk_macie2.types.retrieval_mode.deserialize_json(
            data["retrievalMode"]
        )
    if "roleName" in data:
