...
class SeverityLevel(TypedDict):
    ...
    severity: NotRequired[
        "aws_sdk_macie2.types.data_identifier_severity.DataIdentifierSeverity"
    ]
...
def serialize_json(value: SeverityLevel) -> dict:
    ...
    if "severity" in value:
        ...
        out["severity"] = aws_sdk_macie2.types.data_identifier_severity.serialize_json(
            value["severity"]
        )
    return out
...
def deserialize_json(data: dict) -> SeverityLevel:
    ...
    if "severity" in data:
        ...
        out["severity"] = (
            aws_sdk_macie2.types.data_identifier_severity.deserialize_json(
                data["severity"]
            )
        )
    return out
