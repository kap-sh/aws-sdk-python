...
class GetSensitiveDataOccurrencesAvailabilityResponse(TypedDict):
    ...
    reasons: NotRequired[
        "aws_sdk_macie2.types.__list_of_unavailability_reason_code.__listOfUnavailabilityReasonCode"
    ]
...
def serialize_json(value: GetSensitiveDataOccurrencesAvailabilityResponse) -> dict:
    ...
    if "code" in value:
        ...
        out["code"] = aws_sdk_macie2.types.availability_code.serialize_json(
            value["code"]
        )
    if "reasons" in value:
        import aws_sdk_macie2.types.__list_of_unavailability_reason_code
        ...
        out["reasons"] = (
            aws_sdk_macie2.types.__list_of_unavailability_reason_code.serialize_json(
                value["reasons"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> GetSensitiveDataOccurrencesAvailabilityResponse:
    ...
    if "code" in data:
        ...
        out["code"] = aws_sdk_macie2.types.availability_code.deserialize_json(
            data["code"]
        )
    if "reasons" in data:
        import aws_sdk_macie2.types.__list_of_unavailability_reason_code
        ...
        out["reasons"] = (
            aws_sdk_macie2.types.__list_of_unavailability_reason_code.deserialize_json(
                data["reasons"]
            )
        )
    return out
