...
class BatchUpdateAutomatedDiscoveryAccountsResponse(TypedDict):
    errors: NotRequired[
        "aws_sdk_macie2.types.__list_of_automated_discovery_account_update_error.__listOfAutomatedDiscoveryAccountUpdateError"
    ]
...
def serialize_json(value: BatchUpdateAutomatedDiscoveryAccountsResponse) -> dict:
    ...
    if "errors" in value:
        ...
        out["errors"] = (
            aws_sdk_macie2.types.__list_of_automated_discovery_account_update_error.serialize_json(
                value["errors"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> BatchUpdateAutomatedDiscoveryAccountsResponse:
    ...
    if "errors" in data:
        ...
        out["errors"] = (
            aws_sdk_macie2.types.__list_of_automated_discovery_account_update_error.deserialize_json(
                data["errors"]
            )
        )
    return out
