...
class SearchResourcesRequest(TypedDict):
...
def serialize_json(value: SearchResourcesRequest) -> dict:
    ...
    if "bucket_criteria" in value:
        ...
        out["bucketCriteria"] = (
            aws_sdk_macie2.types.search_resources_bucket_criteria.serialize_json(
    ...
    if "sort_criteria" in value:
        ...
        out["sortCriteria"] = (
            aws_sdk_macie2.types.search_resources_sort_criteria.serialize_json(
                value["sort_criteria"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> SearchResourcesRequest:
    ...
    if "bucketCriteria" in data:
        ...
        out["bucket_criteria"] = (
            aws_sdk_macie2.types.search_resources_bucket_criteria.deserialize_json(
                data["bucketCriteria"]
            )
        )
    ...
    if "sortCriteria" in data:
        ...
        out["sort_criteria"] = (
            aws_sdk_macie2.types.search_resources_sort_criteria.deserialize_json(
                data["sortCriteria"]
            )
        )
    return out
