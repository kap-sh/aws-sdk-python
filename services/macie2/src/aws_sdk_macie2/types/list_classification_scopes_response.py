...
if TYPE_CHECKING:
    ...
    import aws_sdk_macie2.types.next_token


class ListClassificationScopesResponse(TypedDict):
    classification_scopes: NotRequired[
        "aws_sdk_macie2.types.__list_of_classification_scope_summary.__listOfClassificationScopeSummary"
    ]
    """<p>An array that specifies the unique identifier and name of the classification scope for the account.</p>"""
    next_token: NotRequired["aws_sdk_macie2.types.next_token.NextToken"]
...
def serialize_json(value: ListClassificationScopesResponse) -> dict:
    ...
    if "classification_scopes" in value:
        ...
        out["classificationScopes"] = (
            aws_sdk_macie2.types.__list_of_classification_scope_summary.serialize_json(
...
def deserialize_json(data: dict) -> ListClassificationScopesResponse:
    ...
    if "classificationScopes" in data:
        ...
        out["classification_scopes"] = (
            aws_sdk_macie2.types.__list_of_classification_scope_summary.deserialize_json(
