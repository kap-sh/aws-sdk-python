...
class S3Object(TypedDict):
    ...
    path: NotRequired["aws_sdk_macie2.types.__string.__string"]
    """<p>The full path to the affected object, including the name of the affected bucket and the object's name (key).</p>"""
    public_access: NotRequired["aws_sdk_macie2.types.__boolean.__boolean"]
    ...
    size: NotRequired["aws_sdk_macie2.types.__long.__long"]
    """<p>The total storage size, in bytes, of the object.</p>"""
    storage_class: NotRequired["aws_sdk_macie2.types.storage_class.StorageClass"]
    ...
    version_id: NotRequired["aws_sdk_macie2.types.__string.__string"]
...
def serialize_json(value: S3Object) -> dict:
    ...
    if "last_modified" in value:
        ...
        out["lastModified"] = aws_sdk_macie2.types.__timestamp_iso8601.serialize_json(
            value["last_modified"]
        )
    if "path" in value:
        out["path"] = value["path"]
    ...
    if "storage_class" in value:
        ...
        out["storageClass"] = aws_sdk_macie2.types.storage_class.serialize_json(
            value["storage_class"]
        )
    if "tags" in value:
        import aws_sdk_macie2.types.key_value_pair_list
...
def deserialize_json(data: dict) -> S3Object:
    ...
    if "storageClass" in data:
        ...
        out["storage_class"] = aws_sdk_macie2.types.storage_class.deserialize_json(
            data["storageClass"]
        )
    if "tags" in data:
        import aws_sdk_macie2.types.key_value_pair_list
