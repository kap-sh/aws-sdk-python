"""Generated from Smithy shape ``com.amazonaws.macie2#ListFindingsFilters``."""
...
def handle_response(
    ...
    out: capo_macie2.types.list_findings_filters_response.ListFindingsFiltersResponse = capo_macie2.types.list_findings_filters_response.deserialize_json(
...
async def async_list_findings_filters(
