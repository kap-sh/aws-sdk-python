...
def handle_response(
    ...
    out: capo_macie2.types.batch_update_automated_discovery_accounts_response.BatchUpdateAutomatedDiscoveryAccountsResponse = capo_macie2.types.batch_update_automated_discovery_accounts_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.batch_update_automated_discovery_accounts_request.serialize_json(
            input_
        )
    ).encode()
