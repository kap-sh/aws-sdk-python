"""Generated from Smithy shape ``com.amazonaws.macie2#DisableMacie``."""
...
def handle_response(
    ...
    out: capo_macie2.types.disable_macie_response.DisableMacieResponse = {}  # type: ignore[typeddict-item]
    return out
...
def disable_macie(
    ...
    capo_macie2.types.disable_macie_response.DisableMacieResponse, zapros.Response
]:
