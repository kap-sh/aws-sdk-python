...
def handle_response(
    ...
    out: capo_macie2.types.list_classification_jobs_response.ListClassificationJobsResponse = capo_macie2.types.list_classification_jobs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.list_classification_jobs_request.serialize_json(input_)
    ).encode()
