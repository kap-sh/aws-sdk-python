"""Generated from Smithy shape ``com.amazonaws.macie2#GetFindingsPublicationConfiguration``."""
...
def handle_response(
    ...
    out: capo_macie2.types.get_findings_publication_configuration_response.GetFindingsPublicationConfigurationResponse = capo_macie2.types.get_findings_publication_configuration_response.deserialize_json(
...
async def async_get_findings_publication_configuration(
