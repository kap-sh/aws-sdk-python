"""Generated from Smithy shape ``com.amazonaws.macie2#GetClassificationExportConfiguration``."""
...
def handle_response(
    ...
    out: capo_macie2.types.get_classification_export_configuration_response.GetClassificationExportConfigurationResponse = capo_macie2.types.get_classification_export_configuration_response.deserialize_json(
...
async def async_get_classification_export_configuration(
