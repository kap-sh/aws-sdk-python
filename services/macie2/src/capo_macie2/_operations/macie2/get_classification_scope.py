"""Generated from Smithy shape ``com.amazonaws.macie2#GetClassificationScope``."""
...
def handle_response(
    ...
    out: capo_macie2.types.get_classification_scope_response.GetClassificationScopeResponse = capo_macie2.types.get_classification_scope_response.deserialize_json(
...
async def async_get_classification_scope(
