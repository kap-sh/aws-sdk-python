"""Generated from Smithy shape ``com.amazonaws.macie2#CreateClassificationJob``."""
...
def handle_response(
    ...
    out: capo_macie2.types.create_classification_job_response.CreateClassificationJobResponse = capo_macie2.types.create_classification_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.create_classification_job_request.serialize_json(input_)
    ).encode()
...
async def async_create_classification_job(
