"""Generated from Smithy shape ``com.amazonaws.macie2#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_macie2.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_macie2.types.list_tags_for_resource_response.deserialize_json(
