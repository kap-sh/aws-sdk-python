"""Generated from Smithy shape ``com.amazonaws.macie2#DisableOrganizationAdminAccount``."""
...
def handle_response(
    ...
    out: capo_macie2.types.disable_organization_admin_account_response.DisableOrganizationAdminAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/admin"
    params: dict[str, str] = {}
    if "admin_account_id" in input_:
        params["adminAccountId"] = str(input_["admin_account_id"])
