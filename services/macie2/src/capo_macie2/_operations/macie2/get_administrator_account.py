"""Generated from Smithy shape ``com.amazonaws.macie2#GetAdministratorAccount``."""
...
def handle_response(
    ...
    out: capo_macie2.types.get_administrator_account_response.GetAdministratorAccountResponse = capo_macie2.types.get_administrator_account_response.deserialize_json(
...
async def async_get_administrator_account(
