"""Generated from Smithy shape ``com.amazonaws.macie2#DeleteFindingsFilter``."""
...
def handle_response(
    ...
    out: capo_macie2.types.delete_findings_filter_response.DeleteFindingsFilterResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_findings_filter(
