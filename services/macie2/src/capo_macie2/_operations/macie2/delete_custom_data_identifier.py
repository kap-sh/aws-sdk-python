"""Generated from Smithy shape ``com.amazonaws.macie2#DeleteCustomDataIdentifier``."""
...
def handle_response(
    ...
    out: capo_macie2.types.delete_custom_data_identifier_response.DeleteCustomDataIdentifierResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/custom-data-identifiers/{id}"
...
async def async_delete_custom_data_identifier(
