"""Generated from Smithy shape ``com.amazonaws.macie2#DeleteMember``."""
...
def handle_response(
    ...
    out: capo_macie2.types.delete_member_response.DeleteMemberResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: capo_macie2.types.delete_member_request.DeleteMemberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/members/{id}"
...
def delete_member(
    ...
    capo_macie2.types.delete_member_response.DeleteMemberResponse, zapros.Response
]:
