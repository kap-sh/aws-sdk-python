"""Generated from Smithy shape ``com.amazonaws.macie2#GetUsageTotals``."""
...
def handle_response(
    ...
    out: capo_macie2.types.get_usage_totals_response.GetUsageTotalsResponse = (
        capo_macie2.types.get_usage_totals_response.deserialize_json(
...
def get_usage_totals(
    ...
    capo_macie2.types.get_usage_totals_response.GetUsageTotalsResponse, zapros.Response
]:
