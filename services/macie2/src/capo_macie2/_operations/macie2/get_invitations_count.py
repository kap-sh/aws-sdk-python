"""Generated from Smithy shape ``com.amazonaws.macie2#GetInvitationsCount``."""
...
def handle_response(
    ...
    out: capo_macie2.types.get_invitations_count_response.GetInvitationsCountResponse = capo_macie2.types.get_invitations_count_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/invitations/count"
    params: dict[str, str] = {}
...
async def async_get_invitations_count(
