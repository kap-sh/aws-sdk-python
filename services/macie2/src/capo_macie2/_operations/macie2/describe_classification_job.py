"""Generated from Smithy shape ``com.amazonaws.macie2#DescribeClassificationJob``."""
...
def handle_response(
    ...
    out: capo_macie2.types.describe_classification_job_response.DescribeClassificationJobResponse = capo_macie2.types.describe_classification_job_response.deserialize_json(
...
async def async_describe_classification_job(
