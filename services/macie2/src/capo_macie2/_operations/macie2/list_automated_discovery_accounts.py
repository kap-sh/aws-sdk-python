"""Generated from Smithy shape ``com.amazonaws.macie2#ListAutomatedDiscoveryAccounts``."""
...
import capo_macie2.types.__list_of_automated_discovery_account
...
from capo_macie2._services._pipeline import AsyncOperationOptions, OperationOptions
...
def handle_response(
    ...
    out: capo_macie2.types.list_automated_discovery_accounts_response.ListAutomatedDiscoveryAccountsResponse = capo_macie2.types.list_automated_discovery_accounts_response.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_macie2._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "account_ids" in input_:
        params["accountIds"] = str(input_["account_ids"])
...
async def async_list_automated_discovery_accounts(
