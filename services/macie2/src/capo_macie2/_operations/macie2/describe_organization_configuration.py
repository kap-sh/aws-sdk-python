"""Generated from Smithy shape ``com.amazonaws.macie2#DescribeOrganizationConfiguration``."""
...
def handle_response(
    ...
    out: capo_macie2.types.describe_organization_configuration_response.DescribeOrganizationConfigurationResponse = capo_macie2.types.describe_organization_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/admin/configuration"
    params: dict[str, str] = {}
