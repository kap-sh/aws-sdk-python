"""Generated from Smithy shape ``com.amazonaws.macie2#UpdateOrganizationConfiguration``."""
...
def handle_response(
    ...
    out: capo_macie2.types.update_organization_configuration_response.UpdateOrganizationConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.update_organization_configuration_request.serialize_json(
            input_
        )
    ).encode()
