"""Generated from Smithy shape ``com.amazonaws.macie2#GetFindingsFilter``."""
...
def handle_response(
    ...
    out: capo_macie2.types.get_findings_filter_response.GetFindingsFilterResponse = (
        capo_macie2.types.get_findings_filter_response.deserialize_json(
...
async def async_get_findings_filter(
