"""Generated from Smithy shape ``com.amazonaws.macie2#DescribeBuckets``."""
...
def handle_response(
    ...
    out: capo_macie2.types.describe_buckets_response.DescribeBucketsResponse = (
        capo_macie2.types.describe_buckets_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.describe_buckets_request.serialize_json(input_)
    ).encode()
...
def describe_buckets(
    ...
    capo_macie2.types.describe_buckets_response.DescribeBucketsResponse, zapros.Response
]:
...
async def async_describe_buckets(
