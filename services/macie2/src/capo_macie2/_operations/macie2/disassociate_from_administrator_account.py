"""Generated from Smithy shape ``com.amazonaws.macie2#DisassociateFromAdministratorAccount``."""
...
def handle_response(
    ...
    out: capo_macie2.types.disassociate_from_administrator_account_response.DisassociateFromAdministratorAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/administrator/disassociate"
    params: dict[str, str] = {}
