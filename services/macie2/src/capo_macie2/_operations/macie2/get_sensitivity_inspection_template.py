"""Generated from Smithy shape ``com.amazonaws.macie2#GetSensitivityInspectionTemplate``."""
...
def handle_response(
    ...
    out: capo_macie2.types.get_sensitivity_inspection_template_response.GetSensitivityInspectionTemplateResponse = capo_macie2.types.get_sensitivity_inspection_template_response.deserialize_json(
...
async def async_get_sensitivity_inspection_template(
