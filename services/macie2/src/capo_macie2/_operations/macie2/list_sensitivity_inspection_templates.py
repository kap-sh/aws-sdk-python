"""Generated from Smithy shape ``com.amazonaws.macie2#ListSensitivityInspectionTemplates``."""
...
def handle_response(
    ...
    out: capo_macie2.types.list_sensitivity_inspection_templates_response.ListSensitivityInspectionTemplatesResponse = capo_macie2.types.list_sensitivity_inspection_templates_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/templates/sensitivity-inspections"
    params: dict[str, str] = {}
...
async def async_list_sensitivity_inspection_templates(
