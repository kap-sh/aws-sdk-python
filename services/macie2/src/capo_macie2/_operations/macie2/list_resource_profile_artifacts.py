"""Generated from Smithy shape ``com.amazonaws.macie2#ListResourceProfileArtifacts``."""
...
import capo_macie2.types.__list_of_resource_profile_artifact
...
def handle_response(
    ...
    out: capo_macie2.types.list_resource_profile_artifacts_response.ListResourceProfileArtifactsResponse = capo_macie2.types.list_resource_profile_artifacts_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/resource-profiles/artifacts"
    params: dict[str, str] = {}
...
async def async_list_resource_profile_artifacts(
