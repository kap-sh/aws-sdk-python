...
class S3Destination(TypedDict, closed=True):
    bucket_name: NotRequired["capo_macie2.types.__string.__string"]
    """<p>The name of the bucket. This must be the name of an existing general purpose bucket.</p>"""
    expected_bucket_owner: NotRequired["capo_macie2.types.__string.__string"]
    ...
    key_prefix: NotRequired["capo_macie2.types.__string.__string"]
    ...
    kms_key_arn: NotRequired["capo_macie2.types.__string.__string"]
