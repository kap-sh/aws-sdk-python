...
if TYPE_CHECKING:
    import capo_macie2.types.__list_of_detection
    import capo_macie2.types.__string


class ListResourceProfileDetectionsResponse(TypedDict, closed=True):
    detections: NotRequired["capo_macie2.types.__list_of_detection.__listOfDetection"]
...
def serialize_json(value: ListResourceProfileDetectionsResponse) -> dict:
    ...
    if "detections" in value:
        ...
        out["detections"] = capo_macie2.types.__list_of_detection.serialize_json(
            value["detections"]
        )
...
def deserialize_json(data: dict) -> ListResourceProfileDetectionsResponse:
    ...
    if "detections" in data:
        ...
        out["detections"] = capo_macie2.types.__list_of_detection.deserialize_json(
            data["detections"]
        )
