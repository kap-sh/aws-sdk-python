...
class JobDetails(TypedDict, closed=True):
    is_defined_in_job: NotRequired["capo_macie2.types.is_defined_in_job.IsDefinedInJob"]
    ...
    is_monitored_by_job: NotRequired[
        "capo_macie2.types.is_monitored_by_job.IsMonitoredByJob"
    ]
    ...
    last_job_id: NotRequired["capo_macie2.types.__string.__string"]
...
def serialize_json(value: JobDetails) -> dict:
    ...
    if "is_defined_in_job" in value:
        ...
        out["isDefinedInJob"] = capo_macie2.types.is_defined_in_job.serialize_json(
            value["is_defined_in_job"]
        )
    if "is_monitored_by_job" in value:
        import capo_macie2.types.is_monitored_by_job

        out["isMonitoredByJob"] = capo_macie2.types.is_monitored_by_job.serialize_json(
    ...
    if "last_job_run_time" in value:
        ...
        out["lastJobRunTime"] = capo_macie2.types.__timestamp_iso8601.serialize_json(
...
def deserialize_json(data: dict) -> JobDetails:
    ...
    if "isMonitoredByJob" in data:
        ...
        out["is_monitored_by_job"] = (
            capo_macie2.types.is_monitored_by_job.deserialize_json(
    ...
    if "lastJobRunTime" in data:
        ...
        out["last_job_run_time"] = (
            capo_macie2.types.__timestamp_iso8601.deserialize_json(
                data["lastJobRunTime"]
            )
        )
    return out
