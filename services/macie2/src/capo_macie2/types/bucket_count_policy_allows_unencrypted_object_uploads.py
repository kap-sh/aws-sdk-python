...
class BucketCountPolicyAllowsUnencryptedObjectUploads(TypedDict, closed=True):
    allows_unencrypted_object_uploads: NotRequired["capo_macie2.types.__long.__long"]
    ...
    denies_unencrypted_object_uploads: NotRequired["capo_macie2.types.__long.__long"]
