...
def serialize_json(value: ListClassificationJobsRequest) -> dict:
    ...
    if "filter_criteria" in value:
        ...
        out["filterCriteria"] = (
            capo_macie2.types.list_jobs_filter_criteria.serialize_json(
    ...
    if "sort_criteria" in value:
        ...
        out["sortCriteria"] = capo_macie2.types.list_jobs_sort_criteria.serialize_json(
            value["sort_criteria"]
        )
    return out
...
def deserialize_json(data: dict) -> ListClassificationJobsRequest:
    ...
    if "filterCriteria" in data:
        ...
        out["filter_criteria"] = (
            capo_macie2.types.list_jobs_filter_criteria.deserialize_json(
                data["filterCriteria"]
            )
        )
    ...
    if "sortCriteria" in data:
        ...
        out["sort_criteria"] = (
            capo_macie2.types.list_jobs_sort_criteria.deserialize_json(
                data["sortCriteria"]
            )
        )
    return out
