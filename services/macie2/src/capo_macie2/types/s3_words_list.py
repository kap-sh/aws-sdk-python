...
if TYPE_CHECKING:
    ...
    import capo_macie2.types.__string_min3_max255_pattern_a_za_z093255


class S3WordsList(TypedDict, closed=True):
    bucket_name: NotRequired[
        "capo_macie2.types.__string_min3_max255_pattern_a_za_z093255.__stringMin3Max255PatternAZaZ093255"
    ]
