...
if TYPE_CHECKING:
    import capo_macie2.types.__list_of_member
    import capo_macie2.types.__string


class ListMembersResponse(TypedDict, closed=True):
    members: NotRequired["capo_macie2.types.__list_of_member.__listOfMember"]
...
def serialize_json(value: ListMembersResponse) -> dict:
    ...
    if "members" in value:
        ...
        out["members"] = capo_macie2.types.__list_of_member.serialize_json(
            value["members"]
        )
...
def deserialize_json(data: dict) -> ListMembersResponse:
    ...
    if "members" in data:
        ...
        out["members"] = capo_macie2.types.__list_of_member.deserialize_json(
            data["members"]
        )
