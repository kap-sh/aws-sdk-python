...
class ObjectLevelStatistics(TypedDict, closed=True):
    file_type: NotRequired["capo_macie2.types.__long.__long"]
    ...
    storage_class: NotRequired["capo_macie2.types.__long.__long"]
    ...
    total: NotRequired["capo_macie2.types.__long.__long"]
