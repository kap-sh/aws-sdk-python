...
class CriteriaForJob(TypedDict, closed=True):
    simple_criterion: NotRequired[
        "capo_macie2.types.simple_criterion_for_job.SimpleCriterionForJob"
    ]
    ...
    tag_criterion: NotRequired[
        "capo_macie2.types.tag_criterion_for_job.TagCriterionForJob"
    ]
...
def serialize_json(value: CriteriaForJob) -> dict:
    ...
    if "simple_criterion" in value:
        ...
        out["simpleCriterion"] = (
            capo_macie2.types.simple_criterion_for_job.serialize_json(
    ...
    if "tag_criterion" in value:
        ...
        out["tagCriterion"] = capo_macie2.types.tag_criterion_for_job.serialize_json(
            value["tag_criterion"]
        )
    return out
...
def deserialize_json(data: dict) -> CriteriaForJob:
    ...
    if "simpleCriterion" in data:
        ...
        out["simple_criterion"] = (
            capo_macie2.types.simple_criterion_for_job.deserialize_json(
