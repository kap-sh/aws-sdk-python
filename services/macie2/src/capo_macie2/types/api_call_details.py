...
def serialize_json(value: ApiCallDetails) -> dict:
    ...
    if "first_seen" in value:
        ...
        out["firstSeen"] = capo_macie2.types.__timestamp_iso8601.serialize_json(
            value["first_seen"]
        )
    if "last_seen" in value:
        import capo_macie2.types.__timestamp_iso8601

        out["lastSeen"] = capo_macie2.types.__timestamp_iso8601.serialize_json(
            value["last_seen"]
        )
    return out
