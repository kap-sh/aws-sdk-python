...
class ResourceStatistics(TypedDict, closed=True):
    total_bytes_classified: NotRequired["capo_macie2.types.__long.__long"]
    """<p>The total amount of data, in bytes, that Amazon Macie has analyzed in the bucket.</p>"""
    total_detections: NotRequired["capo_macie2.types.__long.__long"]
    ...
    total_detections_suppressed: NotRequired["capo_macie2.types.__long.__long"]
    ...
    total_items_classified: NotRequired["capo_macie2.types.__long.__long"]
    """<p>The total number of objects that Amazon Macie has analyzed in the bucket.</p>"""
    total_items_sensitive: NotRequired["capo_macie2.types.__long.__long"]
    """<p>The total number of the bucket's objects that Amazon Macie has found sensitive data in.</p>"""
    total_items_skipped: NotRequired["capo_macie2.types.__long.__long"]
    ...
    total_items_skipped_invalid_encryption: NotRequired[
        "capo_macie2.types.__long.__long"
    ]
    ...
    total_items_skipped_invalid_kms: NotRequired["capo_macie2.types.__long.__long"]
