"""Generated from Smithy shape ``com.amazonaws.memorydb#ClusterQuotaForCustomerExceededFault``."""
...
class ClusterQuotaForCustomerExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.memorydb#ClusterQuotaForCustomerExceededFault``."""
