"""Generated from Smithy shape ``com.amazonaws.memorydb#ServiceLinkedRoleNotFoundFault``."""
...
class ServiceLinkedRoleNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.memorydb#ServiceLinkedRoleNotFoundFault``."""
