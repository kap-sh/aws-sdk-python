"""Generated from Smithy shape ``com.amazonaws.memorydb#SubnetQuotaExceededFault``."""
...
class SubnetQuotaExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.memorydb#SubnetQuotaExceededFault``."""
