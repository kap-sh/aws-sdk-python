"""Generated from Smithy shape ``com.amazonaws.memorydb#ParameterGroupNotFoundFault``."""
...
class ParameterGroupNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.memorydb#ParameterGroupNotFoundFault``."""
