        ...
        if _locals["PartitionResult"] is not None:
                ...
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            return Endpoint(
                                url=interpolate(
                                    "https://memory-db-fips.{Region}.{PartitionResult#dualStackDnsSuffix}",
                                    p,
                                    _locals,
                                ),
                                properties={},
            ...
            if p.UseFIPS is True:
                if (
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://memory-db-fips.{Region}.{PartitionResult#dnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            if p.UseDualStack is True:
                if True is get_attr(
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://memory-db.{Region}.{PartitionResult#dualStackDnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            if string_equals(p.Region, interpolate("fips", p, _locals)):
                return Endpoint(
                    url=interpolate(
                        "https://memory-db-fips.us-west-1.amazonaws.com", p, _locals
                    ),
                    properties={
                        "authSchemes": [
                            {
                                "name": interpolate("sigv4", p, _locals),
                                "signingName": interpolate("memorydb", p, _locals),
                                "signingRegion": interpolate("us-west-1", p, _locals),
                            }
                        ]
                    },
                    headers={},
            ...
            return Endpoint(
                url=interpolate(
                    "https://memory-db.{Region}.{PartitionResult#dnsSuffix}", p, _locals
                ),
                properties={},
                headers={},
            )
