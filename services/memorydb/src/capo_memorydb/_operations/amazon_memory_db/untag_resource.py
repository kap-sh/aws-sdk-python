"""Generated from Smithy shape ``com.amazonaws.memorydb#UntagResource``."""
...
import capo_memorydb.errors.invalid_arn_fault
...
import capo_memorydb.errors.multi_region_parameter_group_not_found_fault
...
import capo_memorydb.errors.snapshot_not_found_fault
import capo_memorydb.errors.subnet_group_not_found_fault
import capo_memorydb.errors.tag_not_found_fault
import capo_memorydb.errors.user_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidARNFault":
            raise capo_memorydb.errors.invalid_arn_fault.InvalidARNFault.from_aws_json_1_1(
                data
            )
        ...
        case "MultiRegionParameterGroupNotFoundFault":
            raise capo_memorydb.errors.multi_region_parameter_group_not_found_fault.MultiRegionParameterGroupNotFoundFault.from_aws_json_1_1(
                data
            )
        ...
        case "SnapshotNotFoundFault":
            raise capo_memorydb.errors.snapshot_not_found_fault.SnapshotNotFoundFault.from_aws_json_1_1(
                data
            )
        ...
        case "TagNotFoundFault":
            raise capo_memorydb.errors.tag_not_found_fault.TagNotFoundFault.from_aws_json_1_1(
                data
            )
        case "UserNotFoundFault":
            raise capo_memorydb.errors.user_not_found_fault.UserNotFoundFault.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_memorydb.types.untag_resource_response.UntagResourceResponse = (
        capo_memorydb.types.untag_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.UntagResource"
    body: bytes | None = json.dumps(
        capo_memorydb.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def untag_resource(
    ...
    capo_memorydb.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
