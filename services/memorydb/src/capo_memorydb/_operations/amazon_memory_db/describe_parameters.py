...
def handle_response(
    ...
    out: capo_memorydb.types.describe_parameters_response.DescribeParametersResponse = (
        capo_memorydb.types.describe_parameters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.describe_parameters_request.serialize_aws_json_1_1(input_)
    ).encode()
