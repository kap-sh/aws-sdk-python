"""Generated from Smithy shape ``com.amazonaws.memorydb#UpdateUser``."""
...
import capo_memorydb.errors.invalid_user_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidUserStateFault":
            raise capo_memorydb.errors.invalid_user_state_fault.InvalidUserStateFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_memorydb.types.update_user_response.UpdateUserResponse = (
        capo_memorydb.types.update_user_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.UpdateUser"
    body: bytes | None = json.dumps(
        capo_memorydb.types.update_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_user(
    ...
    capo_memorydb.types.update_user_response.UpdateUserResponse, zapros.Response
]:
