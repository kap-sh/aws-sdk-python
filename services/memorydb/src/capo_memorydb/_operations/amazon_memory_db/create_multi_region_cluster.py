"""Generated from Smithy shape ``com.amazonaws.memorydb#CreateMultiRegionCluster``."""
...
import capo_memorydb.errors.multi_region_cluster_already_exists_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MultiRegionClusterAlreadyExistsFault":
            raise capo_memorydb.errors.multi_region_cluster_already_exists_fault.MultiRegionClusterAlreadyExistsFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_memorydb.types.create_multi_region_cluster_response.CreateMultiRegionClusterResponse = capo_memorydb.types.create_multi_region_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.CreateMultiRegionCluster"
    body: bytes | None = json.dumps(
        capo_memorydb.types.create_multi_region_cluster_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_multi_region_cluster(
