...
def handle_response(
    ...
    out: capo_memorydb.types.reset_parameter_group_response.ResetParameterGroupResponse = capo_memorydb.types.reset_parameter_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.reset_parameter_group_request.serialize_aws_json_1_1(input_)
    ).encode()
