"""Generated from Smithy shape ``com.amazonaws.memorydb#CreateUser``."""
...
import capo_memorydb.errors.user_already_exists_fault
import capo_memorydb.errors.user_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UserAlreadyExistsFault":
            raise capo_memorydb.errors.user_already_exists_fault.UserAlreadyExistsFault.from_aws_json_1_1(
                data
            )
        case "UserQuotaExceededFault":
            raise capo_memorydb.errors.user_quota_exceeded_fault.UserQuotaExceededFault.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_memorydb.types.create_user_response.CreateUserResponse = (
        capo_memorydb.types.create_user_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.CreateUser"
    body: bytes | None = json.dumps(
        capo_memorydb.types.create_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_user(
    ...
    capo_memorydb.types.create_user_response.CreateUserResponse, zapros.Response
]:
