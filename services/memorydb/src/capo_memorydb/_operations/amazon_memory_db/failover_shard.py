...
import capo_memorydb.errors.api_call_rate_for_customer_exceeded_fault
...
import capo_memorydb.errors.shard_not_found_fault
import capo_memorydb.errors.test_failover_not_available_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "APICallRateForCustomerExceededFault":
            raise capo_memorydb.errors.api_call_rate_for_customer_exceeded_fault.APICallRateForCustomerExceededFault.from_aws_json_1_1(
                data
            )
        ...
        case "ShardNotFoundFault":
            raise capo_memorydb.errors.shard_not_found_fault.ShardNotFoundFault.from_aws_json_1_1(
                data
            )
        case "TestFailoverNotAvailableFault":
            raise capo_memorydb.errors.test_failover_not_available_fault.TestFailoverNotAvailableFault.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_memorydb.types.failover_shard_response.FailoverShardResponse = (
        capo_memorydb.types.failover_shard_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.failover_shard_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def failover_shard(
    ...
    capo_memorydb.types.failover_shard_response.FailoverShardResponse, zapros.Response
]:
