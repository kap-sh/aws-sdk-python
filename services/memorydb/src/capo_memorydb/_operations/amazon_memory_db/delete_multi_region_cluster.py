...
def handle_response(
    ...
    out: capo_memorydb.types.delete_multi_region_cluster_response.DeleteMultiRegionClusterResponse = capo_memorydb.types.delete_multi_region_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.delete_multi_region_cluster_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
