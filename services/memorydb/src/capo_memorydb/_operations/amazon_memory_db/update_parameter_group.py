"""Generated from Smithy shape ``com.amazonaws.memorydb#UpdateParameterGroup``."""
...
import capo_memorydb.errors.invalid_parameter_group_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidParameterGroupStateFault":
            raise capo_memorydb.errors.invalid_parameter_group_state_fault.InvalidParameterGroupStateFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_memorydb.types.update_parameter_group_response.UpdateParameterGroupResponse = capo_memorydb.types.update_parameter_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.UpdateParameterGroup"
    body: bytes | None = json.dumps(
        capo_memorydb.types.update_parameter_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
