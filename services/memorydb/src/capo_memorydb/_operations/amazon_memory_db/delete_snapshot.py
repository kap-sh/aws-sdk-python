"""Generated from Smithy shape ``com.amazonaws.memorydb#DeleteSnapshot``."""
...
def handle_response(
    ...
    out: capo_memorydb.types.delete_snapshot_response.DeleteSnapshotResponse = (
        capo_memorydb.types.delete_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DeleteSnapshot"
    body: bytes | None = json.dumps(
        capo_memorydb.types.delete_snapshot_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_snapshot(
    ...
    capo_memorydb.types.delete_snapshot_response.DeleteSnapshotResponse, zapros.Response
]:
