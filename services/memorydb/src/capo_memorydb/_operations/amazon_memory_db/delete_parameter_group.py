"""Generated from Smithy shape ``com.amazonaws.memorydb#DeleteParameterGroup``."""
...
def handle_response(
    ...
    out: capo_memorydb.types.delete_parameter_group_response.DeleteParameterGroupResponse = capo_memorydb.types.delete_parameter_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DeleteParameterGroup"
    body: bytes | None = json.dumps(
        capo_memorydb.types.delete_parameter_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
