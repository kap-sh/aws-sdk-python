"""Generated from Smithy shape ``com.amazonaws.memorydb#DescribeClusters``."""
...
def handle_response(
    ...
    out: capo_memorydb.types.describe_clusters_response.DescribeClustersResponse = (
        capo_memorydb.types.describe_clusters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.describe_clusters_request.serialize_aws_json_1_1(input_)
    ).encode()
