"""Generated from Smithy shape ``com.amazonaws.memorydb#CreateSnapshot``."""
...
def handle_response(
    ...
    out: capo_memorydb.types.create_snapshot_response.CreateSnapshotResponse = (
        capo_memorydb.types.create_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.CreateSnapshot"
    body: bytes | None = json.dumps(
        capo_memorydb.types.create_snapshot_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_snapshot(
    ...
    capo_memorydb.types.create_snapshot_response.CreateSnapshotResponse, zapros.Response
]:
