"""Generated from Smithy shape ``com.amazonaws.memorydb#DescribeReservedNodesOfferings``."""
...
import capo_memorydb.errors.reserved_nodes_offering_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ReservedNodesOfferingNotFoundFault":
            raise capo_memorydb.errors.reserved_nodes_offering_not_found_fault.ReservedNodesOfferingNotFoundFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_memorydb.types.describe_reserved_nodes_offerings_response.DescribeReservedNodesOfferingsResponse = capo_memorydb.types.describe_reserved_nodes_offerings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DescribeReservedNodesOfferings"
    body: bytes | None = json.dumps(
        capo_memorydb.types.describe_reserved_nodes_offerings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_reserved_nodes_offerings(
