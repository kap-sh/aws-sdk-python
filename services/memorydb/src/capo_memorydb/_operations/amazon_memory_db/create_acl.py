"""Generated from Smithy shape ``com.amazonaws.memorydb#CreateACL``."""
...
import capo_memorydb.errors.acl_already_exists_fault
import capo_memorydb.errors.acl_quota_exceeded_fault
import capo_memorydb.errors.default_user_required
import capo_memorydb.errors.duplicate_user_name_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ACLAlreadyExistsFault":
            raise capo_memorydb.errors.acl_already_exists_fault.ACLAlreadyExistsFault.from_aws_json_1_1(
                data
            )
        case "ACLQuotaExceededFault":
            raise capo_memorydb.errors.acl_quota_exceeded_fault.ACLQuotaExceededFault.from_aws_json_1_1(
                data
            )
        case "DefaultUserRequired":
            raise capo_memorydb.errors.default_user_required.DefaultUserRequired.from_aws_json_1_1(
                data
            )
        case "DuplicateUserNameFault":
            raise capo_memorydb.errors.duplicate_user_name_fault.DuplicateUserNameFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_memorydb.types.create_acl_response.CreateACLResponse = (
        capo_memorydb.types.create_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.CreateACL"
    body: bytes | None = json.dumps(
        capo_memorydb.types.create_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_acl(
    ...
    input_: capo_memorydb.types.create_acl_request.CreateACLRequest,
) -> tuple[capo_memorydb.types.create_acl_response.CreateACLResponse, zapros.Response]:
