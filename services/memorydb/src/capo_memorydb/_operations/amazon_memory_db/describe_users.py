"""Generated from Smithy shape ``com.amazonaws.memorydb#DescribeUsers``."""
...
import capo_memorydb.types.user_list
...
def handle_response(
    ...
    out: capo_memorydb.types.describe_users_response.DescribeUsersResponse = (
        capo_memorydb.types.describe_users_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DescribeUsers"
    body: bytes | None = json.dumps(
        capo_memorydb.types.describe_users_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_users(
    ...
    capo_memorydb.types.describe_users_response.DescribeUsersResponse, zapros.Response
]:
