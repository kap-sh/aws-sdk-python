"""Generated from Smithy shape ``com.amazonaws.memorydb#CopySnapshot``."""
...
import capo_memorydb.errors.invalid_snapshot_state_fault
import capo_memorydb.errors.service_linked_role_not_found_fault
import capo_memorydb.errors.snapshot_already_exists_fault
import capo_memorydb.errors.snapshot_not_found_fault
import capo_memorydb.errors.snapshot_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidSnapshotStateFault":
            raise capo_memorydb.errors.invalid_snapshot_state_fault.InvalidSnapshotStateFault.from_aws_json_1_1(
                data
            )
        ...
        case "SnapshotAlreadyExistsFault":
            raise capo_memorydb.errors.snapshot_already_exists_fault.SnapshotAlreadyExistsFault.from_aws_json_1_1(
                data
            )
        ...
        case "SnapshotQuotaExceededFault":
            raise capo_memorydb.errors.snapshot_quota_exceeded_fault.SnapshotQuotaExceededFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_memorydb.types.copy_snapshot_response.CopySnapshotResponse = (
        capo_memorydb.types.copy_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.CopySnapshot"
    body: bytes | None = json.dumps(
        capo_memorydb.types.copy_snapshot_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def copy_snapshot(
    ...
    capo_memorydb.types.copy_snapshot_response.CopySnapshotResponse, zapros.Response
]:
