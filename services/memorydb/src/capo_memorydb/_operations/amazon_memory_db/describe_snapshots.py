"""Generated from Smithy shape ``com.amazonaws.memorydb#DescribeSnapshots``."""
...
def handle_response(
    ...
    out: capo_memorydb.types.describe_snapshots_response.DescribeSnapshotsResponse = (
        capo_memorydb.types.describe_snapshots_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DescribeSnapshots"
    body: bytes | None = json.dumps(
        capo_memorydb.types.describe_snapshots_request.serialize_aws_json_1_1(input_)
    ).encode()
