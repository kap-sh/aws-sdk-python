...
class ReservedNode(TypedDict, closed=True):
    reservation_id: NotRequired["capo_memorydb.types.string.String"]
    ...
    node_count: "capo_memorydb.types.integer.Integer"
    ...
    state: NotRequired["capo_memorydb.types.string.String"]
