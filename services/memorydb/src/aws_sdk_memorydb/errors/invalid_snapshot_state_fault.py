"""Generated from Smithy shape ``com.amazonaws.memorydb#InvalidSnapshotStateFault``."""
...
class InvalidSnapshotStateFault_(TypedDict):
    message: NotRequired["aws_sdk_memorydb.types.exception_message.ExceptionMessage"]


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: InvalidSnapshotStateFault_) -> dict:
    out: dict = {}
    if "message" in value:
...
def deserialize_aws_json_1_1(data: dict) -> InvalidSnapshotStateFault_:
...
class InvalidSnapshotStateFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.memorydb#InvalidSnapshotStateFault``."""
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "InvalidSnapshotStateFault":
