...
class MemoryDBError(Exception):
    """Base class for all MemoryDB service errors."""


class ServiceError(MemoryDBError):
...
class SerializationError(MemoryDBError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MemoryDBError):
...
class WaiterFailedError(MemoryDBError):
...
class WaiterTimeoutError(MemoryDBError):
