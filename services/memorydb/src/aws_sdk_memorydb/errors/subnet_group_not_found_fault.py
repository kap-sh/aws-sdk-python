"""Generated from Smithy shape ``com.amazonaws.memorydb#SubnetGroupNotFoundFault``."""
...
class SubnetGroupNotFoundFault_(TypedDict):
...
class SubnetGroupNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.memorydb#SubnetGroupNotFoundFault``."""
