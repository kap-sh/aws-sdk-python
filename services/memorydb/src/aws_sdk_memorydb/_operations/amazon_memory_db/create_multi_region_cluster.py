...
import aws_sdk_memorydb.errors.multi_region_cluster_already_exists_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MultiRegionClusterAlreadyExistsFault":
            raise aws_sdk_memorydb.errors.multi_region_cluster_already_exists_fault.MultiRegionClusterAlreadyExistsFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.create_multi_region_cluster_response.CreateMultiRegionClusterResponse = aws_sdk_memorydb.types.create_multi_region_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.create_multi_region_cluster_request.CreateMultiRegionClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.create_multi_region_cluster_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
