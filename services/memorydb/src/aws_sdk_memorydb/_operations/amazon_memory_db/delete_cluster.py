...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.delete_cluster_response.DeleteClusterResponse = (
        aws_sdk_memorydb.types.delete_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.delete_cluster_request.DeleteClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.delete_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
