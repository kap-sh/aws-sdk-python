"""Generated from Smithy shape ``com.amazonaws.memorydb#DescribeParameters``."""
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.describe_parameters_response.DescribeParametersResponse = aws_sdk_memorydb.types.describe_parameters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_memorydb.types.describe_parameters_request.DescribeParametersRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DescribeParameters"
    import aws_sdk_memorydb.types.describe_parameters_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.describe_parameters_request.serialize_aws_json_1_1(input)
    ).encode()
