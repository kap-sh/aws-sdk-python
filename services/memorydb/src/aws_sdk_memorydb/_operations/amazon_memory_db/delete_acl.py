"""Generated from Smithy shape ``com.amazonaws.memorydb#DeleteACL``."""
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.delete_acl_response.DeleteACLResponse = (
        aws_sdk_memorydb.types.delete_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.delete_acl_request.DeleteACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DeleteACL"
    import aws_sdk_memorydb.types.delete_acl_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.delete_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_acl(
    ...
    aws_sdk_memorydb.types.delete_acl_response.DeleteACLResponse, zapros.Response
]:
