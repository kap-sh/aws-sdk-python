...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.describe_users_response.DescribeUsersResponse = (
        aws_sdk_memorydb.types.describe_users_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.describe_users_request.DescribeUsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.describe_users_request.serialize_aws_json_1_1(input_)
    ).encode()
