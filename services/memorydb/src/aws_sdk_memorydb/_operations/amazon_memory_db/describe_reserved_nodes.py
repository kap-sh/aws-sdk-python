"""Generated from Smithy shape ``com.amazonaws.memorydb#DescribeReservedNodes``."""
...
import aws_sdk_memorydb.errors.reserved_node_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ReservedNodeNotFoundFault":
            raise aws_sdk_memorydb.errors.reserved_node_not_found_fault.ReservedNodeNotFoundFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.describe_reserved_nodes_response.DescribeReservedNodesResponse = aws_sdk_memorydb.types.describe_reserved_nodes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.describe_reserved_nodes_request.DescribeReservedNodesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DescribeReservedNodes"
    import aws_sdk_memorydb.types.describe_reserved_nodes_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.describe_reserved_nodes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_reserved_nodes(
