...
import aws_sdk_memorydb.errors.invalid_user_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidUserStateFault":
            raise aws_sdk_memorydb.errors.invalid_user_state_fault.InvalidUserStateFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.update_user_response.UpdateUserResponse = (
        aws_sdk_memorydb.types.update_user_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.update_user_request.UpdateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.update_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_user(
    ...
    aws_sdk_memorydb.types.update_user_response.UpdateUserResponse, zapros.Response
]:
