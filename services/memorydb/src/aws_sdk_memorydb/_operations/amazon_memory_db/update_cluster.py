...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNodeStateFault":
            import aws_sdk_memorydb.errors.invalid_node_state_fault

            raise aws_sdk_memorydb.errors.invalid_node_state_fault.InvalidNodeStateFault.from_aws_json_1_1(
                data
            )
        ...
        case "NoOperationFault":
            import aws_sdk_memorydb.errors.no_operation_fault

            raise aws_sdk_memorydb.errors.no_operation_fault.NoOperationFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.update_cluster_response.UpdateClusterResponse = (
        aws_sdk_memorydb.types.update_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.update_cluster_request.UpdateClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.update_cluster_request.serialize_aws_json_1_1(input_)
    ).encode()
