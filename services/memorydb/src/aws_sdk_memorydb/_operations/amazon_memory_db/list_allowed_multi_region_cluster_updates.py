"""Generated from Smithy shape ``com.amazonaws.memorydb#ListAllowedMultiRegionClusterUpdates``."""
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.list_allowed_multi_region_cluster_updates_response.ListAllowedMultiRegionClusterUpdatesResponse = aws_sdk_memorydb.types.list_allowed_multi_region_cluster_updates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.list_allowed_multi_region_cluster_updates_request.ListAllowedMultiRegionClusterUpdatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.ListAllowedMultiRegionClusterUpdates"
    import aws_sdk_memorydb.types.list_allowed_multi_region_cluster_updates_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.list_allowed_multi_region_cluster_updates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_allowed_multi_region_cluster_updates(
