"""Generated from Smithy shape ``com.amazonaws.memorydb#TagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.tag_resource_response.TagResourceResponse = (
        aws_sdk_memorydb.types.tag_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.TagResource"
    import aws_sdk_memorydb.types.tag_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_memorydb.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
