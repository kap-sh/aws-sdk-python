"""Generated from Smithy shape ``com.amazonaws.memorydb#DeleteSubnetGroup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetGroupInUseFault":
            import aws_sdk_memorydb.errors.subnet_group_in_use_fault

            raise aws_sdk_memorydb.errors.subnet_group_in_use_fault.SubnetGroupInUseFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.delete_subnet_group_response.DeleteSubnetGroupResponse = aws_sdk_memorydb.types.delete_subnet_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_memorydb.types.delete_subnet_group_request.DeleteSubnetGroupRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DeleteSubnetGroup"
    import aws_sdk_memorydb.types.delete_subnet_group_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.delete_subnet_group_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_delete_subnet_group(
