...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.delete_subnet_group_request.DeleteSubnetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.delete_subnet_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
