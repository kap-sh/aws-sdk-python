...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.describe_service_updates_request.DescribeServiceUpdatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.describe_service_updates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
