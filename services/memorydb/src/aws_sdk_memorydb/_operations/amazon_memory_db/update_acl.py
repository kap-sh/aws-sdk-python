...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.update_acl_response.UpdateACLResponse = (
        aws_sdk_memorydb.types.update_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.update_acl_request.UpdateACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.update_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_acl(
    ...
    aws_sdk_memorydb.types.update_acl_response.UpdateACLResponse, zapros.Response
]:
