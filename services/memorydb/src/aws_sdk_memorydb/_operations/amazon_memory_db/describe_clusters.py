...
def build_request(
    ...
    input: aws_sdk_memorydb.types.describe_clusters_request.DescribeClustersRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.describe_clusters_request.serialize_aws_json_1_1(input)
    ).encode()
