"""Generated from Smithy shape ``com.amazonaws.memorydb#DescribeMultiRegionParameterGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.describe_multi_region_parameter_groups_response.DescribeMultiRegionParameterGroupsResponse = aws_sdk_memorydb.types.describe_multi_region_parameter_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.describe_multi_region_parameter_groups_request.DescribeMultiRegionParameterGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DescribeMultiRegionParameterGroups"
    import aws_sdk_memorydb.types.describe_multi_region_parameter_groups_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.describe_multi_region_parameter_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_multi_region_parameter_groups(
