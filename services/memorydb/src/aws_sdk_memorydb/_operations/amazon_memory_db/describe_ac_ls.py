"""Generated from Smithy shape ``com.amazonaws.memorydb#DescribeACLs``."""
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.describe_ac_ls_response.DescribeACLsResponse = (
        aws_sdk_memorydb.types.describe_ac_ls_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.describe_ac_ls_request.DescribeACLsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DescribeACLs"
    import aws_sdk_memorydb.types.describe_ac_ls_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.describe_ac_ls_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_ac_ls(
    ...
    aws_sdk_memorydb.types.describe_ac_ls_response.DescribeACLsResponse, zapros.Response
]:
...
async def async_describe_ac_ls(
