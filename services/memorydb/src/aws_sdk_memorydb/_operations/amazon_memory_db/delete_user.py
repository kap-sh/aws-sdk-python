"""Generated from Smithy shape ``com.amazonaws.memorydb#DeleteUser``."""
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.delete_user_response.DeleteUserResponse = (
        aws_sdk_memorydb.types.delete_user_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.delete_user_request.DeleteUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DeleteUser"
    import aws_sdk_memorydb.types.delete_user_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.delete_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_user(
    ...
    aws_sdk_memorydb.types.delete_user_response.DeleteUserResponse, zapros.Response
]:
