...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidSnapshotStateFault":
            import aws_sdk_memorydb.errors.invalid_snapshot_state_fault

            raise aws_sdk_memorydb.errors.invalid_snapshot_state_fault.InvalidSnapshotStateFault.from_aws_json_1_1(
                data
            )
        ...
        case "SnapshotAlreadyExistsFault":
            import aws_sdk_memorydb.errors.snapshot_already_exists_fault

            raise aws_sdk_memorydb.errors.snapshot_already_exists_fault.SnapshotAlreadyExistsFault.from_aws_json_1_1(
                data
            )
        ...
        case "SnapshotQuotaExceededFault":
            import aws_sdk_memorydb.errors.snapshot_quota_exceeded_fault

            raise aws_sdk_memorydb.errors.snapshot_quota_exceeded_fault.SnapshotQuotaExceededFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.copy_snapshot_response.CopySnapshotResponse = (
        aws_sdk_memorydb.types.copy_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.copy_snapshot_request.CopySnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.copy_snapshot_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def copy_snapshot(
    ...
    aws_sdk_memorydb.types.copy_snapshot_response.CopySnapshotResponse, zapros.Response
]:
