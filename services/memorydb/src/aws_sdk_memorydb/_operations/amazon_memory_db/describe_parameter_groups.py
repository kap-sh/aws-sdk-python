"""Generated from Smithy shape ``com.amazonaws.memorydb#DescribeParameterGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.describe_parameter_groups_response.DescribeParameterGroupsResponse = aws_sdk_memorydb.types.describe_parameter_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.describe_parameter_groups_request.DescribeParameterGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DescribeParameterGroups"
    import aws_sdk_memorydb.types.describe_parameter_groups_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.describe_parameter_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_parameter_groups(
