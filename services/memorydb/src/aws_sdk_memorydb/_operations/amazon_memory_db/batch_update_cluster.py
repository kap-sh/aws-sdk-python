"""Generated from Smithy shape ``com.amazonaws.memorydb#BatchUpdateCluster``."""
...
import aws_sdk_memorydb.errors.service_update_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceUpdateNotFoundFault":
            raise aws_sdk_memorydb.errors.service_update_not_found_fault.ServiceUpdateNotFoundFault.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.batch_update_cluster_response.BatchUpdateClusterResponse = aws_sdk_memorydb.types.batch_update_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.batch_update_cluster_request.BatchUpdateClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.BatchUpdateCluster"
    import aws_sdk_memorydb.types.batch_update_cluster_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.batch_update_cluster_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_update_cluster(
