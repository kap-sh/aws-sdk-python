...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.describe_multi_region_parameters_response.DescribeMultiRegionParametersResponse = aws_sdk_memorydb.types.describe_multi_region_parameters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.describe_multi_region_parameters_request.DescribeMultiRegionParametersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.describe_multi_region_parameters_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
