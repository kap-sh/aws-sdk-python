...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.list_allowed_node_type_updates_response.ListAllowedNodeTypeUpdatesResponse = aws_sdk_memorydb.types.list_allowed_node_type_updates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.list_allowed_node_type_updates_request.ListAllowedNodeTypeUpdatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.list_allowed_node_type_updates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
