"""Generated from Smithy shape ``com.amazonaws.memorydb#DescribeEvents``."""
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.describe_events_response.DescribeEventsResponse = (
        aws_sdk_memorydb.types.describe_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.describe_events_request.DescribeEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DescribeEvents"
    import aws_sdk_memorydb.types.describe_events_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.describe_events_request.serialize_aws_json_1_1(input_)
    ).encode()
