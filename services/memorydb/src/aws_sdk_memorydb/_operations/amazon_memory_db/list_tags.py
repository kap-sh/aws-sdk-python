"""Generated from Smithy shape ``com.amazonaws.memorydb#ListTags``."""
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.list_tags_request.ListTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.ListTags"
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.list_tags_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_tags(
    ...
    input_: aws_sdk_memorydb.types.list_tags_request.ListTagsRequest,
) -> tuple[aws_sdk_memorydb.types.list_tags_response.ListTagsResponse, zapros.Response]:
