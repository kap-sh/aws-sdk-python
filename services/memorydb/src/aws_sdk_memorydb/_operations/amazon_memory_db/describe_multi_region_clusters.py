...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.describe_multi_region_clusters_response.DescribeMultiRegionClustersResponse = aws_sdk_memorydb.types.describe_multi_region_clusters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.describe_multi_region_clusters_request.DescribeMultiRegionClustersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.describe_multi_region_clusters_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
