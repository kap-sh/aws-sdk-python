"""Generated from Smithy shape ``com.amazonaws.memorydb#DeleteMultiRegionCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.delete_multi_region_cluster_response.DeleteMultiRegionClusterResponse = aws_sdk_memorydb.types.delete_multi_region_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.delete_multi_region_cluster_request.DeleteMultiRegionClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DeleteMultiRegionCluster"
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.delete_multi_region_cluster_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_multi_region_cluster(
