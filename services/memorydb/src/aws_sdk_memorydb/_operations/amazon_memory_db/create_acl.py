...
import aws_sdk_memorydb.errors.acl_already_exists_fault
import aws_sdk_memorydb.errors.acl_quota_exceeded_fault
import aws_sdk_memorydb.errors.default_user_required
import aws_sdk_memorydb.errors.duplicate_user_name_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ACLAlreadyExistsFault":
            raise aws_sdk_memorydb.errors.acl_already_exists_fault.ACLAlreadyExistsFault.from_aws_json_1_1(
                data
            )
        case "ACLQuotaExceededFault":
            raise aws_sdk_memorydb.errors.acl_quota_exceeded_fault.ACLQuotaExceededFault.from_aws_json_1_1(
                data
            )
        case "DefaultUserRequired":
            raise aws_sdk_memorydb.errors.default_user_required.DefaultUserRequired.from_aws_json_1_1(
                data
            )
        case "DuplicateUserNameFault":
            raise aws_sdk_memorydb.errors.duplicate_user_name_fault.DuplicateUserNameFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.create_acl_response.CreateACLResponse = (
        aws_sdk_memorydb.types.create_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.create_acl_request.CreateACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.create_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_acl(
    ...
    aws_sdk_memorydb.types.create_acl_response.CreateACLResponse, zapros.Response
]:
