"""Generated from Smithy shape ``com.amazonaws.memorydb#DescribeEngineVersions``."""
...
import aws_sdk_memorydb.types.engine_version_info_list
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.describe_engine_versions_response.DescribeEngineVersionsResponse = aws_sdk_memorydb.types.describe_engine_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.describe_engine_versions_request.DescribeEngineVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DescribeEngineVersions"
    import aws_sdk_memorydb.types.describe_engine_versions_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.describe_engine_versions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
