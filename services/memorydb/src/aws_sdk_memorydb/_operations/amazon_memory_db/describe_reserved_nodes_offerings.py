...
import aws_sdk_memorydb.types.reserved_nodes_offering_list
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.describe_reserved_nodes_offerings_response.DescribeReservedNodesOfferingsResponse = aws_sdk_memorydb.types.describe_reserved_nodes_offerings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.describe_reserved_nodes_offerings_request.DescribeReservedNodesOfferingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.describe_reserved_nodes_offerings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
