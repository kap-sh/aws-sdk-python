"""Generated from Smithy shape ``com.amazonaws.memorydb#CreateParameterGroup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ParameterGroupAlreadyExistsFault":
            import aws_sdk_memorydb.errors.parameter_group_already_exists_fault

            raise aws_sdk_memorydb.errors.parameter_group_already_exists_fault.ParameterGroupAlreadyExistsFault.from_aws_json_1_1(
                data
            )
        case "ParameterGroupQuotaExceededFault":
            import aws_sdk_memorydb.errors.parameter_group_quota_exceeded_fault

            raise aws_sdk_memorydb.errors.parameter_group_quota_exceeded_fault.ParameterGroupQuotaExceededFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.create_parameter_group_response.CreateParameterGroupResponse = aws_sdk_memorydb.types.create_parameter_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.create_parameter_group_request.CreateParameterGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.CreateParameterGroup"
    import aws_sdk_memorydb.types.create_parameter_group_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.create_parameter_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
