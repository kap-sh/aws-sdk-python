"""Generated from Smithy shape ``com.amazonaws.memorydb#FailoverShard``."""
...
import aws_sdk_memorydb.errors.api_call_rate_for_customer_exceeded_fault
import aws_sdk_memorydb.errors.cluster_not_found_fault
import aws_sdk_memorydb.errors.invalid_cluster_state_fault
import aws_sdk_memorydb.errors.invalid_kms_key_fault
...
import aws_sdk_memorydb.errors.shard_not_found_fault
import aws_sdk_memorydb.errors.test_failover_not_available_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "APICallRateForCustomerExceededFault":
            raise aws_sdk_memorydb.errors.api_call_rate_for_customer_exceeded_fault.APICallRateForCustomerExceededFault.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidKMSKeyFault":
            raise aws_sdk_memorydb.errors.invalid_kms_key_fault.InvalidKMSKeyFault.from_aws_json_1_1(
                data
            )
        ...
        case "ShardNotFoundFault":
            raise aws_sdk_memorydb.errors.shard_not_found_fault.ShardNotFoundFault.from_aws_json_1_1(
                data
            )
        case "TestFailoverNotAvailableFault":
            raise aws_sdk_memorydb.errors.test_failover_not_available_fault.TestFailoverNotAvailableFault.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.failover_shard_response.FailoverShardResponse = (
        aws_sdk_memorydb.types.failover_shard_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.failover_shard_request.FailoverShardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.FailoverShard"
    import aws_sdk_memorydb.types.failover_shard_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.failover_shard_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_failover_shard(
