"""Generated from Smithy shape ``com.amazonaws.memorydb#UpdateSubnetGroup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetInUse":
            import aws_sdk_memorydb.errors.subnet_in_use

            raise aws_sdk_memorydb.errors.subnet_in_use.SubnetInUse.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.update_subnet_group_response.UpdateSubnetGroupResponse = aws_sdk_memorydb.types.update_subnet_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_memorydb.types.update_subnet_group_request.UpdateSubnetGroupRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.UpdateSubnetGroup"
    import aws_sdk_memorydb.types.update_subnet_group_request

    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.update_subnet_group_request.serialize_aws_json_1_1(input)
    ).encode()
