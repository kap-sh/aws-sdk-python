...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.update_subnet_group_request.UpdateSubnetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.update_subnet_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
