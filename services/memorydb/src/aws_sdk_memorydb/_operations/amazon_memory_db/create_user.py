...
import aws_sdk_memorydb.errors.user_already_exists_fault
import aws_sdk_memorydb.errors.user_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UserAlreadyExistsFault":
            raise aws_sdk_memorydb.errors.user_already_exists_fault.UserAlreadyExistsFault.from_aws_json_1_1(
                data
            )
        case "UserQuotaExceededFault":
            raise aws_sdk_memorydb.errors.user_quota_exceeded_fault.UserQuotaExceededFault.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.create_user_response.CreateUserResponse = (
        aws_sdk_memorydb.types.create_user_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.create_user_request.CreateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.create_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_user(
    ...
    aws_sdk_memorydb.types.create_user_response.CreateUserResponse, zapros.Response
]:
