...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TagNotFoundFault":
            import aws_sdk_memorydb.errors.tag_not_found_fault

            raise aws_sdk_memorydb.errors.tag_not_found_fault.TagNotFoundFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_memorydb.types.untag_resource_response.UntagResourceResponse = (
        aws_sdk_memorydb.types.untag_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_memorydb.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_memorydb.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
