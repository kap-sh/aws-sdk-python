...
if TYPE_CHECKING:
    ...
    import aws_sdk_memorydb.types.subnet_list
...
class SubnetGroup(TypedDict, closed=True):
    ...
    subnets: NotRequired["aws_sdk_memorydb.types.subnet_list.SubnetList"]
...
def serialize_aws_json_1_1(value: SubnetGroup) -> dict:
    ...
    if "subnets" in value:
        ...
        out["Subnets"] = aws_sdk_memorydb.types.subnet_list.serialize_aws_json_1_1(
            value["subnets"]
        )
    if "arn" in value:
        out["ARN"] = value["arn"]
...
def deserialize_aws_json_1_1(data: dict) -> SubnetGroup:
    ...
    if "Subnets" in data:
        ...
        out["subnets"] = aws_sdk_memorydb.types.subnet_list.deserialize_aws_json_1_1(
            data["Subnets"]
        )
    if "ARN" in data:
        out["arn"] = data["ARN"]
