...
ReservedNodeList: TypeAlias = list["aws_sdk_memorydb.types.reserved_node.ReservedNode"]
...
def serialize_aws_json_1_1(value: ReservedNodeList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_memorydb.types.reserved_node.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> ReservedNodeList:
    ...
    for item in data:
        out.append(aws_sdk_memorydb.types.reserved_node.deserialize_aws_json_1_1(item))
    return out
