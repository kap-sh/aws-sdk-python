...
if TYPE_CHECKING:
    ...
    import aws_sdk_memorydb.types.az_status
    import aws_sdk_memorydb.types.boolean_optional
    import aws_sdk_memorydb.types.cluster_pending_updates
    import aws_sdk_memorydb.types.data_tiering_status
    ...
    import aws_sdk_memorydb.types.security_group_membership_list
    import aws_sdk_memorydb.types.shard_list
...
class Cluster(TypedDict):
    ...
    pending_updates: NotRequired[
        "aws_sdk_memorydb.types.cluster_pending_updates.ClusterPendingUpdates"
    ]
    ...
    shards: NotRequired["aws_sdk_memorydb.types.shard_list.ShardList"]
    """<p>A list of shards that are members of the cluster.</p>"""
    availability_mode: NotRequired["aws_sdk_memorydb.types.az_status.AZStatus"]
    """<p>Indicates if the cluster has a Multi-AZ configuration (multiaz) or not (singleaz).</p>"""
    cluster_endpoint: NotRequired["aws_sdk_memorydb.types.endpoint.Endpoint"]
    ...
    parameter_group_status: NotRequired["aws_sdk_memorydb.types.string.String"]
    """<p>The status of the parameter group used by the cluster, for example 'active' or 'applying'.</p>"""
    security_groups: NotRequired[
        "aws_sdk_memorydb.types.security_group_membership_list.SecurityGroupMembershipList"
    ]
...
def serialize_aws_json_1_1(value: Cluster) -> dict:
    ...
    if "pending_updates" in value:
        ...
        out["PendingUpdates"] = (
            aws_sdk_memorydb.types.cluster_pending_updates.serialize_aws_json_1_1(
    ...
    if "shards" in value:
        ...
        out["Shards"] = aws_sdk_memorydb.types.shard_list.serialize_aws_json_1_1(
            value["shards"]
        )
    if "availability_mode" in value:
        import aws_sdk_memorydb.types.az_status

        out["AvailabilityMode"] = (
            aws_sdk_memorydb.types.az_status.serialize_aws_json_1_1(
    ...
    if "cluster_endpoint" in value:
        ...
        out["ClusterEndpoint"] = aws_sdk_memorydb.types.endpoint.serialize_aws_json_1_1(
    ...
    if "security_groups" in value:
        ...
        out["SecurityGroups"] = (
            aws_sdk_memorydb.types.security_group_membership_list.serialize_aws_json_1_1(
    ...
    if "data_tiering" in value:
        ...
        out["DataTiering"] = (
            aws_sdk_memorydb.types.data_tiering_status.serialize_aws_json_1_1(
                value["data_tiering"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> Cluster:
    ...
    if "PendingUpdates" in data:
        ...
        out["pending_updates"] = (
            aws_sdk_memorydb.types.cluster_pending_updates.deserialize_aws_json_1_1(
                data["PendingUpdates"]
            )
        )
    ...
    if "Shards" in data:
        ...
        out["shards"] = aws_sdk_memorydb.types.shard_list.deserialize_aws_json_1_1(
            data["Shards"]
        )
    if "AvailabilityMode" in data:
        ...
        out["availability_mode"] = (
            aws_sdk_memorydb.types.az_status.deserialize_aws_json_1_1(
    ...
    if "ClusterEndpoint" in data:
        ...
        out["cluster_endpoint"] = (
            aws_sdk_memorydb.types.endpoint.deserialize_aws_json_1_1(
    ...
    if "SecurityGroups" in data:
        ...
        out["security_groups"] = (
            aws_sdk_memorydb.types.security_group_membership_list.deserialize_aws_json_1_1(
                data["SecurityGroups"]
            )
        )
    ...
    if "DataTiering" in data:
        ...
        out["data_tiering"] = (
            aws_sdk_memorydb.types.data_tiering_status.deserialize_aws_json_1_1(
                data["DataTiering"]
            )
        )
