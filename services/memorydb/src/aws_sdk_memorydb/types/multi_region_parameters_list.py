...
if TYPE_CHECKING:
    import aws_sdk_memorydb.types.multi_region_parameter

MultiRegionParametersList: TypeAlias = list[
    "aws_sdk_memorydb.types.multi_region_parameter.MultiRegionParameter"
]
...
def serialize_aws_json_1_1(value: MultiRegionParametersList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_memorydb.types.multi_region_parameter.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> MultiRegionParametersList:
    ...
    for item in data:
        out.append(
            aws_sdk_memorydb.types.multi_region_parameter.deserialize_aws_json_1_1(item)
        )
    return out
