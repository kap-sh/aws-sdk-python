...
class UpdateMultiRegionClusterRequest(TypedDict):
...
def serialize_aws_json_1_1(value: UpdateMultiRegionClusterRequest) -> dict:
    ...
    if "update_strategy" in value:
        ...
        out["UpdateStrategy"] = (
            aws_sdk_memorydb.types.update_strategy.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateMultiRegionClusterRequest:
    ...
    if "UpdateStrategy" in data:
        ...
        out["update_strategy"] = (
            aws_sdk_memorydb.types.update_strategy.deserialize_aws_json_1_1(
                data["UpdateStrategy"]
            )
        )
    return out
