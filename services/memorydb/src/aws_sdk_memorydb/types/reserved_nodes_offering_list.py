...
ReservedNodesOfferingList: TypeAlias = list[
    "aws_sdk_memorydb.types.reserved_nodes_offering.ReservedNodesOffering"
]
...
def serialize_aws_json_1_1(value: ReservedNodesOfferingList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_memorydb.types.reserved_nodes_offering.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ReservedNodesOfferingList:
    ...
    for item in data:
        out.append(
            aws_sdk_memorydb.types.reserved_nodes_offering.deserialize_aws_json_1_1(
                item
            )
        )
    return out
