...
class DescribeEngineVersionsResponse(TypedDict, closed=True):
    ...
    engine_versions: NotRequired[
        "aws_sdk_memorydb.types.engine_version_info_list.EngineVersionInfoList"
    ]
...
def serialize_aws_json_1_1(value: DescribeEngineVersionsResponse) -> dict:
    ...
    if "engine_versions" in value:
        ...
        out["EngineVersions"] = (
            aws_sdk_memorydb.types.engine_version_info_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeEngineVersionsResponse:
    ...
    if "EngineVersions" in data:
        ...
        out["engine_versions"] = (
            aws_sdk_memorydb.types.engine_version_info_list.deserialize_aws_json_1_1(
                data["EngineVersions"]
            )
        )
    return out
