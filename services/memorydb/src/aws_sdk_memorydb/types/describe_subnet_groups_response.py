...
class DescribeSubnetGroupsResponse(TypedDict):
    ...
    subnet_groups: NotRequired[
        "aws_sdk_memorydb.types.subnet_group_list.SubnetGroupList"
    ]
...
def serialize_aws_json_1_1(value: DescribeSubnetGroupsResponse) -> dict:
    ...
    if "subnet_groups" in value:
        ...
        out["SubnetGroups"] = (
            aws_sdk_memorydb.types.subnet_group_list.serialize_aws_json_1_1(
                value["subnet_groups"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeSubnetGroupsResponse:
    ...
    if "SubnetGroups" in data:
        ...
        out["subnet_groups"] = (
            aws_sdk_memorydb.types.subnet_group_list.deserialize_aws_json_1_1(
                data["SubnetGroups"]
            )
        )
    return out
