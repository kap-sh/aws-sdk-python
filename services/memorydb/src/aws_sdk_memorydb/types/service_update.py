...
if TYPE_CHECKING:
    ...
    import aws_sdk_memorydb.types.service_update_type
    import aws_sdk_memorydb.types.string
    import aws_sdk_memorydb.types.t_stamp


class ServiceUpdate(TypedDict):
    ...
    release_date: NotRequired["aws_sdk_memorydb.types.t_stamp.TStamp"]
    ...
    type: NotRequired["aws_sdk_memorydb.types.service_update_type.ServiceUpdateType"]
    ...
    nodes_updated: NotRequired["aws_sdk_memorydb.types.string.String"]
    """<p>A list of nodes updated by the service update</p>"""
    auto_update_start_date: NotRequired["aws_sdk_memorydb.types.t_stamp.TStamp"]
...
def serialize_aws_json_1_1(value: ServiceUpdate) -> dict:
    ...
    if "release_date" in value:
        ...
        out["ReleaseDate"] = aws_sdk_memorydb.types.t_stamp.serialize_aws_json_1_1(
            value["release_date"]
        )
    ...
    if "type" in value:
        ...
        out["Type"] = aws_sdk_memorydb.types.service_update_type.serialize_aws_json_1_1(
            value["type"]
        )
    if "engine" in value:
...
def deserialize_aws_json_1_1(data: dict) -> ServiceUpdate:
    ...
    if "ReleaseDate" in data:
        ...
        out["release_date"] = aws_sdk_memorydb.types.t_stamp.deserialize_aws_json_1_1(
            data["ReleaseDate"]
        )
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_memorydb.types.service_update_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    if "Engine" in data:
