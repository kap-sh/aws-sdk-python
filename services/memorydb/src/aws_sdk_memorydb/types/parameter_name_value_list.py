...
if TYPE_CHECKING:
    import aws_sdk_memorydb.types.parameter_name_value

ParameterNameValueList: TypeAlias = list[
    "aws_sdk_memorydb.types.parameter_name_value.ParameterNameValue"
]
...
def serialize_aws_json_1_1(value: ParameterNameValueList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_memorydb.types.parameter_name_value.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ParameterNameValueList:
    ...
    for item in data:
        out.append(
            aws_sdk_memorydb.types.parameter_name_value.deserialize_aws_json_1_1(item)
        )
    return out
