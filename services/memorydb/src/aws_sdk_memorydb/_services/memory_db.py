...
from aws_sdk_memorydb._services._aws_config import aws_config
...
class MemoryDBClientConfig(TypedDict, total=False, closed=True):
...
class MemoryDBClient:
    ...
    def __init__(
        ...
        self._config = MemoryDBClientConfig(
            {
