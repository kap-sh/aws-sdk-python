...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.describe_groups_response.DescribeGroupsResponse = (
        aws_sdk_workdocs.types.describe_groups_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_workdocs.types.describe_groups_request.DescribeGroupsRequest,
) -> zapros.Request:
    ...
    if "search_query" in input:
        params["searchQuery"] = str(input["search_query"])
