"""Generated from Smithy shape ``com.amazonaws.workdocs#GetCurrentUser``."""
...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.get_current_user_response.GetCurrentUserResponse = (
        aws_sdk_workdocs.types.get_current_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.get_current_user_request.GetCurrentUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/api/v1/me"
    params: dict[str, str] = {}
