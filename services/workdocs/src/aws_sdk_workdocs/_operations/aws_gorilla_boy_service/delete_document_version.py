...
def build_request(
    ...
    input: aws_sdk_workdocs.types.delete_document_version_request.DeleteDocumentVersionRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    params["deletePriorVersions"] = str(input.get("delete_prior_versions", False))
