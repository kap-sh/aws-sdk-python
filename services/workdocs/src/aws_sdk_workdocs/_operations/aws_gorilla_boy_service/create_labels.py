...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyLabelsException":
            import aws_sdk_workdocs.errors.too_many_labels_exception

            raise aws_sdk_workdocs.errors.too_many_labels_exception.TooManyLabelsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.create_labels_response.CreateLabelsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.create_labels_request.CreateLabelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workdocs.types.create_labels_request.serialize_json(input_)
    ).encode()
...
def create_labels(
    ...
    aws_sdk_workdocs.types.create_labels_response.CreateLabelsResponse, zapros.Response
]:
