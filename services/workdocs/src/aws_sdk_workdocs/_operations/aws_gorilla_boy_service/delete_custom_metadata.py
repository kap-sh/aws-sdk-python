...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.delete_custom_metadata_response.DeleteCustomMetadataResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.delete_custom_metadata_request.DeleteCustomMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
