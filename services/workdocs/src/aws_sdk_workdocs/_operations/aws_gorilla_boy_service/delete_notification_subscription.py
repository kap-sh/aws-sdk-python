"""Generated from Smithy shape ``com.amazonaws.workdocs#DeleteNotificationSubscription``."""
...
def build_request(
    ...
    input: aws_sdk_workdocs.types.delete_notification_subscription_request.DeleteNotificationSubscriptionRequest,
) -> zapros.Request:
    ...
    url = url.replace("{OrganizationId}", quote(str(input["organization_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_delete_notification_subscription(
