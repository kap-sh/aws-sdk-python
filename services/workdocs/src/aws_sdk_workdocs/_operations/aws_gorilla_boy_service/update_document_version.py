...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.update_document_version_request.UpdateDocumentVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workdocs.types.update_document_version_request.serialize_json(input_)
    ).encode()
