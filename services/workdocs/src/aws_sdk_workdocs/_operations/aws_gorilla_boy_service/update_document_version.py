...
def build_request(
    ...
    input: aws_sdk_workdocs.types.update_document_version_request.UpdateDocumentVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workdocs.types.update_document_version_request.serialize_json(input)
    ).encode()
