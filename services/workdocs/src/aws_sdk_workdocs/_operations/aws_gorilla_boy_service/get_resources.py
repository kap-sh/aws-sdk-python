...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.get_resources_response.GetResourcesResponse = (
        aws_sdk_workdocs.types.get_resources_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_workdocs.types.get_resources_request.GetResourcesRequest,
) -> zapros.Request:
    ...
    if "collection_type" in input:
        params["collectionType"] = str(input["collection_type"])
    if "limit" in input:
...
def get_resources(
    ...
    aws_sdk_workdocs.types.get_resources_response.GetResourcesResponse, zapros.Response
]:
