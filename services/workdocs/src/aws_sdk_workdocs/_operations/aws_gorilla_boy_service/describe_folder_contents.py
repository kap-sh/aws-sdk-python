...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.describe_folder_contents_response.DescribeFolderContentsResponse = aws_sdk_workdocs.types.describe_folder_contents_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.describe_folder_contents_request.DescribeFolderContentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
