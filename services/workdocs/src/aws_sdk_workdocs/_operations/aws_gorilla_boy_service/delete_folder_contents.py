"""Generated from Smithy shape ``com.amazonaws.workdocs#DeleteFolderContents``."""
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.delete_folder_contents_request.DeleteFolderContentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_folder_contents(
