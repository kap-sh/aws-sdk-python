...
import aws_sdk_workdocs.errors.requested_entity_too_large_exception
...
import aws_sdk_workdocs.types.organization_user_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RequestedEntityTooLargeException":
            raise aws_sdk_workdocs.errors.requested_entity_too_large_exception.RequestedEntityTooLargeException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.describe_users_response.DescribeUsersResponse = (
        aws_sdk_workdocs.types.describe_users_response.deserialize_json(
