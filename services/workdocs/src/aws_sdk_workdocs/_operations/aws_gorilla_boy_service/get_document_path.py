...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.get_document_path_response.GetDocumentPathResponse = (
        aws_sdk_workdocs.types.get_document_path_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.get_document_path_request.GetDocumentPathRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
