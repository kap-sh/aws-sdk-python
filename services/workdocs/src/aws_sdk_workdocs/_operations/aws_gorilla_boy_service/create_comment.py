...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidCommentOperationException":
            import aws_sdk_workdocs.errors.invalid_comment_operation_exception

            raise aws_sdk_workdocs.errors.invalid_comment_operation_exception.InvalidCommentOperationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.create_comment_response.CreateCommentResponse = (
        aws_sdk_workdocs.types.create_comment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.create_comment_request.CreateCommentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workdocs.types.create_comment_request.serialize_json(input_)
    ).encode()
