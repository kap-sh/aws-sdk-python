"""Generated from Smithy shape ``com.amazonaws.workdocs#AddResourcePermissions``."""
...
import aws_sdk_workdocs.types.share_results_list
...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.add_resource_permissions_response.AddResourcePermissionsResponse = aws_sdk_workdocs.types.add_resource_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.add_resource_permissions_request.AddResourcePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/api/v1/resources/{ResourceId}/permissions"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workdocs.types.add_resource_permissions_request.serialize_json(input_)
    ).encode()
...
async def async_add_resource_permissions(
