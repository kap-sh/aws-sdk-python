...
def build_request(
    ...
    input: aws_sdk_workdocs.types.add_resource_permissions_request.AddResourcePermissionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workdocs.types.add_resource_permissions_request.serialize_json(input)
    ).encode()
