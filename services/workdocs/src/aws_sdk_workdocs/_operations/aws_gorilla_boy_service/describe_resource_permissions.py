...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.describe_resource_permissions_response.DescribeResourcePermissionsResponse = aws_sdk_workdocs.types.describe_resource_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.describe_resource_permissions_request.DescribeResourcePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
