...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.get_folder_response.GetFolderResponse = (
        aws_sdk_workdocs.types.get_folder_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.get_folder_request.GetFolderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_folder(
    ...
    aws_sdk_workdocs.types.get_folder_response.GetFolderResponse, zapros.Response
]:
