"""Generated from Smithy shape ``com.amazonaws.workdocs#ActivateUser``."""
...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.activate_user_response.ActivateUserResponse = (
        aws_sdk_workdocs.types.activate_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.activate_user_request.ActivateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def activate_user(
    ...
    aws_sdk_workdocs.types.activate_user_response.ActivateUserResponse, zapros.Response
]:
