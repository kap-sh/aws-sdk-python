"""Generated from Smithy shape ``com.amazonaws.workdocs#DeleteLabels``."""
...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.delete_labels_response.DeleteLabelsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.delete_labels_request.DeleteLabelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "labels" in input_:
        params["labels"] = str(input_["labels"])
    params["deleteAll"] = str(input_.get("delete_all", False))
...
def delete_labels(
    ...
    aws_sdk_workdocs.types.delete_labels_response.DeleteLabelsResponse, zapros.Response
]:
