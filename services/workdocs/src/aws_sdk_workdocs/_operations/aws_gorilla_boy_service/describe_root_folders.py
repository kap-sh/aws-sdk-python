"""Generated from Smithy shape ``com.amazonaws.workdocs#DescribeRootFolders``."""
...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.describe_root_folders_response.DescribeRootFoldersResponse = aws_sdk_workdocs.types.describe_root_folders_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.describe_root_folders_request.DescribeRootFoldersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/api/v1/me/root"
    params: dict[str, str] = {}
    if "limit" in input_:
...
async def async_describe_root_folders(
