...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.create_notification_subscription_request.CreateNotificationSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workdocs.types.create_notification_subscription_request.serialize_json(
            input_
        )
    ).encode()
