"""Generated from Smithy shape ``com.amazonaws.workdocs#CreateCustomMetadata``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CustomMetadataLimitExceededException":
            import aws_sdk_workdocs.errors.custom_metadata_limit_exceeded_exception

            raise aws_sdk_workdocs.errors.custom_metadata_limit_exceeded_exception.CustomMetadataLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.create_custom_metadata_response.CreateCustomMetadataResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.create_custom_metadata_request.CreateCustomMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/api/v1/resources/{ResourceId}/customMetadata"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workdocs.types.create_custom_metadata_request.serialize_json(input_)
    ).encode()
...
async def async_create_custom_metadata(
