...
def build_request(
    ...
    input: aws_sdk_workdocs.types.create_custom_metadata_request.CreateCustomMetadataRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workdocs.types.create_custom_metadata_request.serialize_json(input)
    ).encode()
