...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.search_resources_response.SearchResourcesResponse = (
        aws_sdk_workdocs.types.search_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.search_resources_request.SearchResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workdocs.types.search_resources_request.serialize_json(input_)
    ).encode()
