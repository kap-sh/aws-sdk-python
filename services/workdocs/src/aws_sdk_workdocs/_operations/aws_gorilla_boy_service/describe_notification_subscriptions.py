...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.describe_notification_subscriptions_response.DescribeNotificationSubscriptionsResponse = aws_sdk_workdocs.types.describe_notification_subscriptions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.describe_notification_subscriptions_request.DescribeNotificationSubscriptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
