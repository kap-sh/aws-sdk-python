...
def build_request(
    ...
    input: aws_sdk_workdocs.types.remove_resource_permission_request.RemoveResourcePermissionRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "principal_type" in input:
        params["type"] = str(input["principal_type"])
