"""Generated from Smithy shape ``com.amazonaws.workdocs#CreateUser``."""
...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.create_user_response.CreateUserResponse = (
        aws_sdk_workdocs.types.create_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.create_user_request.CreateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_workdocs.types.create_user_request.serialize_json(input_)
    ).encode()
...
def create_user(
    ...
    aws_sdk_workdocs.types.create_user_response.CreateUserResponse, zapros.Response
]:
