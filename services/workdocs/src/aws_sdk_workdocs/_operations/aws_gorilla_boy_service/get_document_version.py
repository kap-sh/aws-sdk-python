...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.get_document_version_response.GetDocumentVersionResponse = aws_sdk_workdocs.types.get_document_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.get_document_version_request.GetDocumentVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
