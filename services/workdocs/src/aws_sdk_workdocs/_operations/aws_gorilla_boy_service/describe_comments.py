"""Generated from Smithy shape ``com.amazonaws.workdocs#DescribeComments``."""
...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.describe_comments_response.DescribeCommentsResponse = (
        aws_sdk_workdocs.types.describe_comments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.describe_comments_request.DescribeCommentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_comments(
