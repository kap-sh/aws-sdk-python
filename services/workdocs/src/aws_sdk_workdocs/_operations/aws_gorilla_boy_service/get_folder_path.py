"""Generated from Smithy shape ``com.amazonaws.workdocs#GetFolderPath``."""
...
def handle_response(
    ...
    out: aws_sdk_workdocs.types.get_folder_path_response.GetFolderPathResponse = (
        aws_sdk_workdocs.types.get_folder_path_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_workdocs.types.get_folder_path_request.GetFolderPathRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/api/v1/folders/{FolderId}/path"
...
async def async_get_folder_path(
