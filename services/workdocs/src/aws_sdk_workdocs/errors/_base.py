...
class WorkDocsError(Exception):
    """Base class for all WorkDocs service errors."""


class ServiceError(WorkDocsError):
...
class SerializationError(WorkDocsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(WorkDocsError):
...
class WaiterFailedError(WorkDocsError):
...
class WaiterTimeoutError(WorkDocsError):
