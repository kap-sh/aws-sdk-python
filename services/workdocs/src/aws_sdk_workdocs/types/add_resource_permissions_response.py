...
class AddResourcePermissionsResponse(TypedDict):
    share_results: NotRequired[
        "aws_sdk_workdocs.types.share_results_list.ShareResultsList"
    ]
...
def serialize_json(value: AddResourcePermissionsResponse) -> dict:
    ...
    if "share_results" in value:
        ...
        out["ShareResults"] = aws_sdk_workdocs.types.share_results_list.serialize_json(
            value["share_results"]
        )
    return out
...
def deserialize_json(data: dict) -> AddResourcePermissionsResponse:
    ...
    if "ShareResults" in data:
        ...
        out["share_results"] = (
            aws_sdk_workdocs.types.share_results_list.deserialize_json(
                data["ShareResults"]
            )
        )
    return out
