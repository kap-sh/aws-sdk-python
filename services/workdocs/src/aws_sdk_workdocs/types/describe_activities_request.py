...
class DescribeActivitiesRequest(TypedDict, closed=True):
    ...
    start_time: NotRequired["aws_sdk_workdocs.types.timestamp_type.TimestampType"]
    ...
    end_time: NotRequired["aws_sdk_workdocs.types.timestamp_type.TimestampType"]
    ...
    resource_id: NotRequired["aws_sdk_workdocs.types.id_type.IdType"]
    ...
    include_indirect_activities: "aws_sdk_workdocs.types.boolean_type.BooleanType"
