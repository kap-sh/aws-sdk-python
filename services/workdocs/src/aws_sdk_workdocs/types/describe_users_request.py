...
class DescribeUsersRequest(TypedDict, closed=True):
    ...
    r"""<p>A comma-separated list of values. Specify \"STORAGE_METADATA\" to include the user storage quota and utilization information.</p>"""
