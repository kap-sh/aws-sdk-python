...
def handle_response(
    ...
    out: capo_workdocs.types.delete_labels_response.DeleteLabelsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_labels(
    ...
    capo_workdocs.types.delete_labels_response.DeleteLabelsResponse, zapros.Response
]:
