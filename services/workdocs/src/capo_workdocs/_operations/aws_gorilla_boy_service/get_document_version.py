"""Generated from Smithy shape ``com.amazonaws.workdocs#GetDocumentVersion``."""
...
def handle_response(
    ...
    out: capo_workdocs.types.get_document_version_response.GetDocumentVersionResponse = capo_workdocs.types.get_document_version_response.deserialize_json(
...
async def async_get_document_version(
