...
def handle_response(
    ...
    out: capo_workdocs.types.get_document_response.GetDocumentResponse = (
        capo_workdocs.types.get_document_response.deserialize_json(
...
def get_document(
    ...
    capo_workdocs.types.get_document_response.GetDocumentResponse, zapros.Response
]:
