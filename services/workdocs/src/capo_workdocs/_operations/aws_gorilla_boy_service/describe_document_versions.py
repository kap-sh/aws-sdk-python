...
def handle_response(
    ...
    out: capo_workdocs.types.describe_document_versions_response.DescribeDocumentVersionsResponse = capo_workdocs.types.describe_document_versions_response.deserialize_json(
