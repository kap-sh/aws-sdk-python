...
import capo_workdocs.errors.custom_metadata_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CustomMetadataLimitExceededException":
            raise capo_workdocs.errors.custom_metadata_limit_exceeded_exception.CustomMetadataLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_workdocs.types.create_custom_metadata_response.CreateCustomMetadataResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workdocs.types.create_custom_metadata_request.serialize_json(input_)
    ).encode()
