...
def handle_response(
    ...
    out: capo_workdocs.types.add_resource_permissions_response.AddResourcePermissionsResponse = capo_workdocs.types.add_resource_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workdocs.types.add_resource_permissions_request.serialize_json(input_)
    ).encode()
