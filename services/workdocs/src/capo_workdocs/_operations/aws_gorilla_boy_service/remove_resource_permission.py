"""Generated from Smithy shape ``com.amazonaws.workdocs#RemoveResourcePermission``."""
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "principal_type" in input_:
        params["type"] = str(input_["principal_type"])
...
async def async_remove_resource_permission(
