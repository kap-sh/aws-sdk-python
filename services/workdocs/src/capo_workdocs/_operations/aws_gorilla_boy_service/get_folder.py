"""Generated from Smithy shape ``com.amazonaws.workdocs#GetFolder``."""
...
def handle_response(
    ...
    out: capo_workdocs.types.get_folder_response.GetFolderResponse = (
        capo_workdocs.types.get_folder_response.deserialize_json(
...
def get_folder(
    ...
    input_: capo_workdocs.types.get_folder_request.GetFolderRequest,
) -> tuple[capo_workdocs.types.get_folder_response.GetFolderResponse, zapros.Response]:
