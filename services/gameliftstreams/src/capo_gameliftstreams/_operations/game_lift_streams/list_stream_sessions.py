...
def handle_response(
    ...
    out: capo_gameliftstreams.types.list_stream_sessions_output.ListStreamSessionsOutput = capo_gameliftstreams.types.list_stream_sessions_output.deserialize_json(
