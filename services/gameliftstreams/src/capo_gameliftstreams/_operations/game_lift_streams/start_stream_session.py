...
def handle_response(
    ...
    out: capo_gameliftstreams.types.start_stream_session_output.StartStreamSessionOutput = capo_gameliftstreams.types.start_stream_session_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gameliftstreams.types.start_stream_session_input.serialize_json(input_)
    ).encode()
