"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#GetApplication``."""
...
def handle_response(
    ...
    out: capo_gameliftstreams.types.get_application_output.GetApplicationOutput = (
        capo_gameliftstreams.types.get_application_output.deserialize_json(
