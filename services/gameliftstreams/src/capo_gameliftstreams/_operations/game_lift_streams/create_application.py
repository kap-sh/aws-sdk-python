...
def handle_response(
    ...
    out: capo_gameliftstreams.types.create_application_output.CreateApplicationOutput = capo_gameliftstreams.types.create_application_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gameliftstreams.types.create_application_input.serialize_json(input_)
    ).encode()
