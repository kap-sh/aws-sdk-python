...
def handle_response(
    ...
    out: capo_gameliftstreams.types.export_stream_session_files_output.ExportStreamSessionFilesOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gameliftstreams.types.export_stream_session_files_input.serialize_json(
            input_
        )
    ).encode()
