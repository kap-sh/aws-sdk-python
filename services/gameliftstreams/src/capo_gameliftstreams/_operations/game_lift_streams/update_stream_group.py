"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#UpdateStreamGroup``."""
...
def handle_response(
    ...
    out: capo_gameliftstreams.types.update_stream_group_output.UpdateStreamGroupOutput = capo_gameliftstreams.types.update_stream_group_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gameliftstreams.types.update_stream_group_input.serialize_json(input_)
    ).encode()
...
async def async_update_stream_group(
