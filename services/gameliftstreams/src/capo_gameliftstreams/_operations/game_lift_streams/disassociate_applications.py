...
def handle_response(
    ...
    out: capo_gameliftstreams.types.disassociate_applications_output.DisassociateApplicationsOutput = capo_gameliftstreams.types.disassociate_applications_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gameliftstreams.types.disassociate_applications_input.serialize_json(
            input_
        )
    ).encode()
