"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#CreateStreamGroup``."""
...
def handle_response(
    ...
    out: capo_gameliftstreams.types.create_stream_group_output.CreateStreamGroupOutput = capo_gameliftstreams.types.create_stream_group_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gameliftstreams.types.create_stream_group_input.serialize_json(input_)
    ).encode()
...
async def async_create_stream_group(
