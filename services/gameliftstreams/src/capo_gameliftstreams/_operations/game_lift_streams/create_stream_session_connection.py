"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#CreateStreamSessionConnection``."""
...
import capo_gameliftstreams.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_gameliftstreams.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_gameliftstreams.types.create_stream_session_connection_output.CreateStreamSessionConnectionOutput = capo_gameliftstreams.types.create_stream_session_connection_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gameliftstreams.types.create_stream_session_connection_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_stream_session_connection(
