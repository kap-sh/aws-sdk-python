...
def serialize_json(value: AddStreamGroupLocationsOutput) -> dict:
    ...
    out["Locations"] = capo_gameliftstreams.types.location_states.serialize_json(
        value["locations"]
    )
    return out
