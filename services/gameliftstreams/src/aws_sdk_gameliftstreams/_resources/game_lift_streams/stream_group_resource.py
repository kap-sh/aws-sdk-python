...
if TYPE_CHECKING:
    ...
    import aws_sdk_gameliftstreams.types.create_stream_group_input
    import aws_sdk_gameliftstreams.types.create_stream_group_output
    import aws_sdk_gameliftstreams.types.delete_stream_group_input
    import aws_sdk_gameliftstreams.types.description
    import aws_sdk_gameliftstreams.types.get_stream_group_input
    import aws_sdk_gameliftstreams.types.get_stream_group_output
    ...
    import aws_sdk_gameliftstreams.types.update_stream_group_input
    import aws_sdk_gameliftstreams.types.update_stream_group_output
...
class StreamGroupResource:
    ...
    def create(
        ...
        *,
    ...
    ) -> "aws_sdk_gameliftstreams.types.create_stream_group_output.CreateStreamGroupOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gameliftstreams.types.create_stream_group_input.CreateStreamGroupInput]",
        ) -> OperationResponse[
            "aws_sdk_gameliftstreams.types.create_stream_group_output.CreateStreamGroupOutput"
        ]:
            import aws_sdk_gameliftstreams._operations.game_lift_streams.create_stream_group

            output, http_response = (
                aws_sdk_gameliftstreams._operations.game_lift_streams.create_stream_group.create_stream_group(
    ...
    def read(
        ...
        *,
        config_overrides: Optional[GameLiftStreamsClientConfig] = None,
    ) -> "aws_sdk_gameliftstreams.types.get_stream_group_output.GetStreamGroupOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gameliftstreams.types.get_stream_group_input.GetStreamGroupInput]",
        ) -> OperationResponse[
            "aws_sdk_gameliftstreams.types.get_stream_group_output.GetStreamGroupOutput"
        ]:
            import aws_sdk_gameliftstreams._operations.game_lift_streams.get_stream_group

            output, http_response = (
                aws_sdk_gameliftstreams._operations.game_lift_streams.get_stream_group.get_stream_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
    ...
    ) -> "aws_sdk_gameliftstreams.types.update_stream_group_output.UpdateStreamGroupOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gameliftstreams.types.update_stream_group_input.UpdateStreamGroupInput]",
        ) -> OperationResponse[
            "aws_sdk_gameliftstreams.types.update_stream_group_output.UpdateStreamGroupOutput"
        ]:
            import aws_sdk_gameliftstreams._operations.game_lift_streams.update_stream_group

            output, http_response = (
                aws_sdk_gameliftstreams._operations.game_lift_streams.update_stream_group.update_stream_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gameliftstreams.types.delete_stream_group_input.DeleteStreamGroupInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_gameliftstreams._operations.game_lift_streams.delete_stream_group

            output, http_response = (
                aws_sdk_gameliftstreams._operations.game_lift_streams.delete_stream_group.delete_stream_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_gameliftstreams.types.list_stream_groups_input.ListStreamGroupsInput]",
        ) -> OperationResponse[
            "aws_sdk_gameliftstreams.types.list_stream_groups_output.ListStreamGroupsOutput"
        ]:
            import aws_sdk_gameliftstreams._operations.game_lift_streams.list_stream_groups

            output, http_response = (
                aws_sdk_gameliftstreams._operations.game_lift_streams.list_stream_groups.list_stream_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncStreamGroupResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.create_stream_group_input.CreateStreamGroupInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.create_stream_group_output.CreateStreamGroupOutput"
        ]:
            import aws_sdk_gameliftstreams._operations.game_lift_streams.create_stream_group
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.create_stream_group.async_create_stream_group(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.get_stream_group_input.GetStreamGroupInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.get_stream_group_output.GetStreamGroupOutput"
        ]:
            import aws_sdk_gameliftstreams._operations.game_lift_streams.get_stream_group
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.get_stream_group.async_get_stream_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.update_stream_group_input.UpdateStreamGroupInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.update_stream_group_output.UpdateStreamGroupOutput"
        ]:
            import aws_sdk_gameliftstreams._operations.game_lift_streams.update_stream_group
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.update_stream_group.async_update_stream_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.delete_stream_group_input.DeleteStreamGroupInput]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.delete_stream_group.async_delete_stream_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.list_stream_groups_input.ListStreamGroupsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.list_stream_groups_output.ListStreamGroupsOutput"
        ]:
            import aws_sdk_gameliftstreams._operations.game_lift_streams.list_stream_groups
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.list_stream_groups.async_list_stream_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
