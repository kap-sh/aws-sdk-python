...
from ._services.async_game_lift_streams import (
    AsyncGameLiftStreamsClient as AsyncGameLiftStreamsClient,
)
from ._services.game_lift_streams import GameLiftStreamsClient as GameLiftStreamsClient
