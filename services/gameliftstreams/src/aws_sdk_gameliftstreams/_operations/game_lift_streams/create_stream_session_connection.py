...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.create_stream_session_connection_output.CreateStreamSessionConnectionOutput = aws_sdk_gameliftstreams.types.create_stream_session_connection_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.create_stream_session_connection_input.CreateStreamSessionConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gameliftstreams.types.create_stream_session_connection_input.serialize_json(
            input_
        )
    ).encode()
