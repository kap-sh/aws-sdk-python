...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.create_stream_group_output.CreateStreamGroupOutput = aws_sdk_gameliftstreams.types.create_stream_group_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.create_stream_group_input.CreateStreamGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gameliftstreams.types.create_stream_group_input.serialize_json(input_)
    ).encode()
