...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.list_applications_output.ListApplicationsOutput = aws_sdk_gameliftstreams.types.list_applications_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.list_applications_input.ListApplicationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
