...
def build_request(
    ...
    input: aws_sdk_gameliftstreams.types.create_application_input.CreateApplicationInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gameliftstreams.types.create_application_input.serialize_json(input)
    ).encode()
