"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#CreateApplication``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_gameliftstreams.errors.service_quota_exceeded_exception

            raise aws_sdk_gameliftstreams.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.create_application_output.CreateApplicationOutput = aws_sdk_gameliftstreams.types.create_application_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.create_application_input.CreateApplicationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gameliftstreams.types.create_application_input.serialize_json(input_)
    ).encode()
