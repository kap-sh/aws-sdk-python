"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#DisassociateApplications``."""
...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.disassociate_applications_output.DisassociateApplicationsOutput = aws_sdk_gameliftstreams.types.disassociate_applications_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.disassociate_applications_input.DisassociateApplicationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/streamgroups/{Identifier}/disassociations"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gameliftstreams.types.disassociate_applications_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_disassociate_applications(
