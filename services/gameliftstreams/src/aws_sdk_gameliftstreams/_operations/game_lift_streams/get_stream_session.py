"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#GetStreamSession``."""
...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.get_stream_session_output.GetStreamSessionOutput = aws_sdk_gameliftstreams.types.get_stream_session_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.get_stream_session_input.GetStreamSessionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_stream_session(
