"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#DeleteStreamGroup``."""
...
if TYPE_CHECKING:
    import aws_sdk_gameliftstreams.types.delete_stream_group_input
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.delete_stream_group_input.DeleteStreamGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/streamgroups/{Identifier}"
...
async def async_delete_stream_group(
