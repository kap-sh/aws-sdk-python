...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.add_stream_group_locations_output.AddStreamGroupLocationsOutput = aws_sdk_gameliftstreams.types.add_stream_group_locations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.add_stream_group_locations_input.AddStreamGroupLocationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gameliftstreams.types.add_stream_group_locations_input.serialize_json(
            input_
        )
    ).encode()
