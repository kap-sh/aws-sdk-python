"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#TerminateStreamSession``."""
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.terminate_stream_session_input.TerminateStreamSessionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_terminate_stream_session(
