"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#ListStreamSessions``."""
...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.list_stream_sessions_output.ListStreamSessionsOutput = aws_sdk_gameliftstreams.types.list_stream_sessions_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.list_stream_sessions_input.ListStreamSessionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "export_files_status" in input_:
        params["ExportFilesStatus"] = str(input_["export_files_status"])
...
async def async_list_stream_sessions(
