...
def build_request(
    ...
    input: aws_sdk_gameliftstreams.types.update_application_input.UpdateApplicationInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gameliftstreams.types.update_application_input.serialize_json(input)
    ).encode()
