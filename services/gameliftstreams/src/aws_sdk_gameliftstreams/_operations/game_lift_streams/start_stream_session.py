"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#StartStreamSession``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_gameliftstreams.errors.conflict_exception

            raise aws_sdk_gameliftstreams.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ResourceNotFoundException":
            import aws_sdk_gameliftstreams.errors.resource_not_found_exception

            raise aws_sdk_gameliftstreams.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.start_stream_session_output.StartStreamSessionOutput = aws_sdk_gameliftstreams.types.start_stream_session_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_gameliftstreams.types.start_stream_session_input.StartStreamSessionInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/streamgroups/{Identifier}/streamsessions"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gameliftstreams.types.start_stream_session_input.serialize_json(input)
    ).encode()
...
async def async_start_stream_session(
