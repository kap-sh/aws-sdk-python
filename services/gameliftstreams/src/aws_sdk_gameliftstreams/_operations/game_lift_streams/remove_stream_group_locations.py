...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.remove_stream_group_locations_input.RemoveStreamGroupLocationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "locations" in input_:
        params["locations"] = str(input_["locations"])
