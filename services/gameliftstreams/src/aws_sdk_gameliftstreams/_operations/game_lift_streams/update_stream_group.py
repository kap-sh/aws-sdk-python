...
def build_request(
    ...
    input: aws_sdk_gameliftstreams.types.update_stream_group_input.UpdateStreamGroupInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gameliftstreams.types.update_stream_group_input.serialize_json(input)
    ).encode()
