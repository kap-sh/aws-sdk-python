...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.update_stream_group_output.UpdateStreamGroupOutput = aws_sdk_gameliftstreams.types.update_stream_group_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.update_stream_group_input.UpdateStreamGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gameliftstreams.types.update_stream_group_input.serialize_json(input_)
    ).encode()
