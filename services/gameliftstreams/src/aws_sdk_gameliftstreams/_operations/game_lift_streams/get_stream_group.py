...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.get_stream_group_output.GetStreamGroupOutput = (
        aws_sdk_gameliftstreams.types.get_stream_group_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.get_stream_group_input.GetStreamGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
