...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.list_stream_sessions_by_account_output.ListStreamSessionsByAccountOutput = aws_sdk_gameliftstreams.types.list_stream_sessions_by_account_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.list_stream_sessions_by_account_input.ListStreamSessionsByAccountInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
