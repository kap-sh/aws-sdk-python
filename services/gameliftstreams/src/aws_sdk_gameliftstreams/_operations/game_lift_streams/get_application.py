...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.get_application_output.GetApplicationOutput = (
        aws_sdk_gameliftstreams.types.get_application_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.get_application_input.GetApplicationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
