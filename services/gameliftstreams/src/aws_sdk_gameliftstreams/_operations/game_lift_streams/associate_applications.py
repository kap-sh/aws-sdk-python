...
def build_request(
    ...
    input_: aws_sdk_gameliftstreams.types.associate_applications_input.AssociateApplicationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gameliftstreams.types.associate_applications_input.serialize_json(
            input_
        )
    ).encode()
