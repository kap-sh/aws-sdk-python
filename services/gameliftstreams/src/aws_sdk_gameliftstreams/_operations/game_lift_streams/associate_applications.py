...
def handle_response(
    ...
    out: aws_sdk_gameliftstreams.types.associate_applications_output.AssociateApplicationsOutput = aws_sdk_gameliftstreams.types.associate_applications_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_gameliftstreams.types.associate_applications_input.AssociateApplicationsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_gameliftstreams.types.associate_applications_input.serialize_json(input)
    ).encode()
