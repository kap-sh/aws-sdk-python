"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.gameliftstreams#InternalServerException``."""
