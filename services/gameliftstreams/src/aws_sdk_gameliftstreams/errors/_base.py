...
class GameLiftStreamsError(Exception):
    """Base class for all GameLiftStreams service errors."""


class ServiceError(GameLiftStreamsError):
...
class SerializationError(GameLiftStreamsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(GameLiftStreamsError):
...
class WaiterFailedError(GameLiftStreamsError):
...
class WaiterTimeoutError(GameLiftStreamsError):
