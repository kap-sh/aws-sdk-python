...
from aws_sdk_gameliftstreams._services._aws_config import aaws_config
...
class AsyncGameLiftStreamsClientConfig(TypedDict, total=False):
...
class AsyncGameLiftStreamsClient:
    ...
    async def add_stream_group_locations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.add_stream_group_locations_input.AddStreamGroupLocationsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.add_stream_group_locations_output.AddStreamGroupLocationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.add_stream_group_locations.async_add_stream_group_locations(
    ...
    async def associate_applications(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.associate_applications_input.AssociateApplicationsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.associate_applications_output.AssociateApplicationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.associate_applications.async_associate_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_stream_session_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.create_stream_session_connection_input.CreateStreamSessionConnectionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.create_stream_session_connection_output.CreateStreamSessionConnectionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.create_stream_session_connection.async_create_stream_session_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_applications(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.disassociate_applications_input.DisassociateApplicationsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.disassociate_applications_output.DisassociateApplicationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.disassociate_applications.async_disassociate_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def export_stream_session_files(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.export_stream_session_files_input.ExportStreamSessionFilesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.export_stream_session_files_output.ExportStreamSessionFilesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.export_stream_session_files.async_export_stream_session_files(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_stream_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.get_stream_session_input.GetStreamSessionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.get_stream_session_output.GetStreamSessionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.get_stream_session.async_get_stream_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_stream_sessions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.list_stream_sessions_input.ListStreamSessionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.list_stream_sessions_output.ListStreamSessionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.list_stream_sessions.async_list_stream_sessions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_gameliftstreams.types.stream_session_summary.StreamSessionSummary]":
        _token = next_token
        while True:
    ...
    async def list_stream_sessions_by_account(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.list_stream_sessions_by_account_input.ListStreamSessionsByAccountInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.list_stream_sessions_by_account_output.ListStreamSessionsByAccountOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.list_stream_sessions_by_account.async_list_stream_sessions_by_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_stream_group_locations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.remove_stream_group_locations_input.RemoveStreamGroupLocationsInput]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.remove_stream_group_locations.async_remove_stream_group_locations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_stream_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.start_stream_session_input.StartStreamSessionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.start_stream_session_output.StartStreamSessionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.start_stream_session.async_start_stream_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def terminate_stream_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.terminate_stream_session_input.TerminateStreamSessionInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.terminate_stream_session.async_terminate_stream_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_gameliftstreams.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_gameliftstreams.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_gameliftstreams._operations.game_lift_streams.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
