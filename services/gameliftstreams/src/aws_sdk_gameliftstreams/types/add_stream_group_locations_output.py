...
def serialize_json(value: AddStreamGroupLocationsOutput) -> dict:
    ...
    import aws_sdk_gameliftstreams.types.location_states
    out["Locations"] = aws_sdk_gameliftstreams.types.location_states.serialize_json(value["locations"])
    return out
...
def deserialize_json(data: dict) -> AddStreamGroupLocationsOutput:
    ...
    if "Locations" in data:
        import aws_sdk_gameliftstreams.types.location_states
        out["locations"] = aws_sdk_gameliftstreams.types.location_states.deserialize_json(data["Locations"])
    else:
