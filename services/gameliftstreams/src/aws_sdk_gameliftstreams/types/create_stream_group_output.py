...
class CreateStreamGroupOutput(TypedDict, closed=True):
    ...
    location_states: NotRequired[
        "aws_sdk_gameliftstreams.types.location_states.LocationStates"
    ]
    ...
    status_reason: NotRequired[
        "aws_sdk_gameliftstreams.types.stream_group_status_reason.StreamGroupStatusReason"
    ]
...
def serialize_json(value: CreateStreamGroupOutput) -> dict:
    ...
    if "location_states" in value:
        ...
        out["LocationStates"] = (
            aws_sdk_gameliftstreams.types.location_states.serialize_json(
    ...
    if "status_reason" in value:
        ...
        out["StatusReason"] = (
            aws_sdk_gameliftstreams.types.stream_group_status_reason.serialize_json(
                value["status_reason"]
            )
        )
...
def deserialize_json(data: dict) -> CreateStreamGroupOutput:
    ...
    if "StatusReason" in data:
        ...
        out["status_reason"] = (
            aws_sdk_gameliftstreams.types.stream_group_status_reason.deserialize_json(
                data["StatusReason"]
            )
        )
