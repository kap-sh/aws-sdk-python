...
```
pip install aws-sdk-gameliftstreams
```

## Usage

```python
from aws_sdk_gameliftstreams import AsyncGameLiftStreamsClient
...
```python
from aws_sdk_gameliftstreams import AsyncGameLiftStreamsClient
from aws_sdk_gameliftstreams.error import AccessDeniedException
