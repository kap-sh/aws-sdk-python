...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.create_s3_table_integration_output.CreateS3TableIntegrationOutput = aws_sdk_observabilityadmin.types.create_s3_table_integration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.create_s3_table_integration_input.CreateS3TableIntegrationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
