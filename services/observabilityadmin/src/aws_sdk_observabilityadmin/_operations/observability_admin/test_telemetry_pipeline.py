"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#TestTelemetryPipeline``."""
...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.test_telemetry_pipeline_output.TestTelemetryPipelineOutput = aws_sdk_observabilityadmin.types.test_telemetry_pipeline_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.test_telemetry_pipeline_input.TestTelemetryPipelineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/TestTelemetryPipeline"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_observabilityadmin.types.test_telemetry_pipeline_input

    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.test_telemetry_pipeline_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_test_telemetry_pipeline(
