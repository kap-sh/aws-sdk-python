...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.list_telemetry_rules_output.ListTelemetryRulesOutput = aws_sdk_observabilityadmin.types.list_telemetry_rules_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.list_telemetry_rules_input.ListTelemetryRulesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.list_telemetry_rules_input.serialize_json(
            input_
        )
    ).encode()
