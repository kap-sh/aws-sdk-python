"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#GetTelemetryRuleForOrganization``."""
...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.get_telemetry_rule_for_organization_output.GetTelemetryRuleForOrganizationOutput = aws_sdk_observabilityadmin.types.get_telemetry_rule_for_organization_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.get_telemetry_rule_for_organization_input.GetTelemetryRuleForOrganizationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetTelemetryRuleForOrganization"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_observabilityadmin.types.get_telemetry_rule_for_organization_input

    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.get_telemetry_rule_for_organization_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_telemetry_rule_for_organization(
