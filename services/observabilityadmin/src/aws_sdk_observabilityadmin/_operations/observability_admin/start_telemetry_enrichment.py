...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.start_telemetry_enrichment_output.StartTelemetryEnrichmentOutput = aws_sdk_observabilityadmin.types.start_telemetry_enrichment_output.deserialize_json(
