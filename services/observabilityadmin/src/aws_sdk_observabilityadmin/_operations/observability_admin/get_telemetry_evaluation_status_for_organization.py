...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.get_telemetry_evaluation_status_for_organization_output.GetTelemetryEvaluationStatusForOrganizationOutput = aws_sdk_observabilityadmin.types.get_telemetry_evaluation_status_for_organization_output.deserialize_json(
