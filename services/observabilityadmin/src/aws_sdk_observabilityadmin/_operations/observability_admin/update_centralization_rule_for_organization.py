...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.update_centralization_rule_for_organization_output.UpdateCentralizationRuleForOrganizationOutput = aws_sdk_observabilityadmin.types.update_centralization_rule_for_organization_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.update_centralization_rule_for_organization_input.UpdateCentralizationRuleForOrganizationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.update_centralization_rule_for_organization_input.serialize_json(
            input_
        )
    ).encode()
