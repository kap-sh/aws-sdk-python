...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.create_centralization_rule_for_organization_output.CreateCentralizationRuleForOrganizationOutput = aws_sdk_observabilityadmin.types.create_centralization_rule_for_organization_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.create_centralization_rule_for_organization_input.CreateCentralizationRuleForOrganizationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
