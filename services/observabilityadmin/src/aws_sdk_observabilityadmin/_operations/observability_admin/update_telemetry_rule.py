"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#UpdateTelemetryRule``."""
...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.update_telemetry_rule_output.UpdateTelemetryRuleOutput = aws_sdk_observabilityadmin.types.update_telemetry_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.update_telemetry_rule_input.UpdateTelemetryRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/UpdateTelemetryRule"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_observabilityadmin.types.update_telemetry_rule_input

    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.update_telemetry_rule_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_telemetry_rule(
