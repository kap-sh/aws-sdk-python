"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#GetTelemetryEnrichmentStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.get_telemetry_enrichment_status_output.GetTelemetryEnrichmentStatusOutput = aws_sdk_observabilityadmin.types.get_telemetry_enrichment_status_output.deserialize_json(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/GetTelemetryEnrichmentStatus"
    params: dict[str, str] = {}
...
async def async_get_telemetry_enrichment_status(
