...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.create_telemetry_pipeline_output.CreateTelemetryPipelineOutput = aws_sdk_observabilityadmin.types.create_telemetry_pipeline_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.create_telemetry_pipeline_input.CreateTelemetryPipelineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.create_telemetry_pipeline_input.serialize_json(
            input_
        )
    ).encode()
