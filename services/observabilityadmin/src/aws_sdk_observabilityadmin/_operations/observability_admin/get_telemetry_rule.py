...
def build_request(
    ...
    input: aws_sdk_observabilityadmin.types.get_telemetry_rule_input.GetTelemetryRuleInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.get_telemetry_rule_input.serialize_json(input)
    ).encode()
