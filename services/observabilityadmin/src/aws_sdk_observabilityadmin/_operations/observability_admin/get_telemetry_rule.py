...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.get_telemetry_rule_output.GetTelemetryRuleOutput = aws_sdk_observabilityadmin.types.get_telemetry_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.get_telemetry_rule_input.GetTelemetryRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.get_telemetry_rule_input.serialize_json(input_)
    ).encode()
