...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.get_telemetry_evaluation_status_output.GetTelemetryEvaluationStatusOutput = aws_sdk_observabilityadmin.types.get_telemetry_evaluation_status_output.deserialize_json(
