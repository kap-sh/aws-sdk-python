...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.create_telemetry_rule_output.CreateTelemetryRuleOutput = aws_sdk_observabilityadmin.types.create_telemetry_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.create_telemetry_rule_input.CreateTelemetryRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.create_telemetry_rule_input.serialize_json(
            input_
        )
    ).encode()
