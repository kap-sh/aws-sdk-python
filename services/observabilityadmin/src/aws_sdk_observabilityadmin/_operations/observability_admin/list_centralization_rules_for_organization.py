...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.list_centralization_rules_for_organization_output.ListCentralizationRulesForOrganizationOutput = aws_sdk_observabilityadmin.types.list_centralization_rules_for_organization_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.list_centralization_rules_for_organization_input.ListCentralizationRulesForOrganizationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.list_centralization_rules_for_organization_input.serialize_json(
            input_
        )
    ).encode()
