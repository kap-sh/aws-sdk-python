"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#ValidateTelemetryPipelineConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.validate_telemetry_pipeline_configuration_output.ValidateTelemetryPipelineConfigurationOutput = aws_sdk_observabilityadmin.types.validate_telemetry_pipeline_configuration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.validate_telemetry_pipeline_configuration_input.ValidateTelemetryPipelineConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ValidateTelemetryPipelineConfiguration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_observabilityadmin.types.validate_telemetry_pipeline_configuration_input

    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.validate_telemetry_pipeline_configuration_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_validate_telemetry_pipeline_configuration(
