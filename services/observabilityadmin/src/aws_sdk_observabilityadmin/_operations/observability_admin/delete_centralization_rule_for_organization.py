"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#DeleteCentralizationRuleForOrganization``."""
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.delete_centralization_rule_for_organization_input.DeleteCentralizationRuleForOrganizationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteCentralizationRuleForOrganization"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_observabilityadmin.types.delete_centralization_rule_for_organization_input

    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.delete_centralization_rule_for_organization_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_delete_centralization_rule_for_organization(
