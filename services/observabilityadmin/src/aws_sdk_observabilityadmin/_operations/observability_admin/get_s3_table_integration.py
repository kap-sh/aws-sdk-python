"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#GetS3TableIntegration``."""
...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.get_s3_table_integration_output.GetS3TableIntegrationOutput = aws_sdk_observabilityadmin.types.get_s3_table_integration_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.get_s3_table_integration_input.GetS3TableIntegrationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetS3TableIntegration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.get_s3_table_integration_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_s3_table_integration(
