"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#ListTagsForResource``."""
...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.list_tags_for_resource_output.ListTagsForResourceOutput = aws_sdk_observabilityadmin.types.list_tags_for_resource_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.list_tags_for_resource_input.ListTagsForResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.list_tags_for_resource_input.serialize_json(
            input_
        )
    ).encode()
