...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.delete_telemetry_pipeline_output.DeleteTelemetryPipelineOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.delete_telemetry_pipeline_input.DeleteTelemetryPipelineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.delete_telemetry_pipeline_input.serialize_json(
            input_
        )
    ).encode()
