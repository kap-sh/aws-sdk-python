"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#CreateTelemetryRuleForOrganization``."""
...
import aws_sdk_observabilityadmin.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_observabilityadmin.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.create_telemetry_rule_for_organization_output.CreateTelemetryRuleForOrganizationOutput = aws_sdk_observabilityadmin.types.create_telemetry_rule_for_organization_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.create_telemetry_rule_for_organization_input.CreateTelemetryRuleForOrganizationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/CreateTelemetryRuleForOrganization"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.create_telemetry_rule_for_organization_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_telemetry_rule_for_organization(
