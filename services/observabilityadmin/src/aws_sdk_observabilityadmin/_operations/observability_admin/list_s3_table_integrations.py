...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.list_s3_table_integrations_output.ListS3TableIntegrationsOutput = aws_sdk_observabilityadmin.types.list_s3_table_integrations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.list_s3_table_integrations_input.ListS3TableIntegrationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.list_s3_table_integrations_input.serialize_json(
            input_
        )
    ).encode()
