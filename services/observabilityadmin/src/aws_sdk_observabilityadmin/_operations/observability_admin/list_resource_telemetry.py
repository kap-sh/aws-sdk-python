"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#ListResourceTelemetry``."""
...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.list_resource_telemetry_output.ListResourceTelemetryOutput = aws_sdk_observabilityadmin.types.list_resource_telemetry_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.list_resource_telemetry_input.ListResourceTelemetryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListResourceTelemetry"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_observabilityadmin.types.list_resource_telemetry_input

    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.list_resource_telemetry_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_resource_telemetry(
