...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.delete_telemetry_rule_for_organization_input.DeleteTelemetryRuleForOrganizationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.delete_telemetry_rule_for_organization_input.serialize_json(
            input_
        )
    ).encode()
