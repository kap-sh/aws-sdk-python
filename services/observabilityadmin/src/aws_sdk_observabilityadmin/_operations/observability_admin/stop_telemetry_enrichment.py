...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.stop_telemetry_enrichment_output.StopTelemetryEnrichmentOutput = aws_sdk_observabilityadmin.types.stop_telemetry_enrichment_output.deserialize_json(
