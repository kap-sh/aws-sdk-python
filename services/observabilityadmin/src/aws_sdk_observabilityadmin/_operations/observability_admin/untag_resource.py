...
def build_request(
    ...
    input: aws_sdk_observabilityadmin.types.untag_resource_input.UntagResourceInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.untag_resource_input.serialize_json(input)
    ).encode()
