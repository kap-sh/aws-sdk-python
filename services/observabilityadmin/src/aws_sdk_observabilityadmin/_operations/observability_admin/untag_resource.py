...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.untag_resource_input.UntagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.untag_resource_input.serialize_json(input_)
    ).encode()
