...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.delete_s3_table_integration_input.DeleteS3TableIntegrationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.delete_s3_table_integration_input.serialize_json(
            input_
        )
    ).encode()
