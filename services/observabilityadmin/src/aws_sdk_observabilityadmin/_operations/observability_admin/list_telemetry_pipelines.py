"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#ListTelemetryPipelines``."""
...
import aws_sdk_observabilityadmin.types.telemetry_pipeline_summaries
...
def handle_response(
    ...
    out: aws_sdk_observabilityadmin.types.list_telemetry_pipelines_output.ListTelemetryPipelinesOutput = aws_sdk_observabilityadmin.types.list_telemetry_pipelines_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_observabilityadmin.types.list_telemetry_pipelines_input.ListTelemetryPipelinesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListTelemetryPipelines"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_observabilityadmin.types.list_telemetry_pipelines_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_telemetry_pipelines(
