...
from aws_sdk_observabilityadmin._services._aws_config import aaws_config
...
class AsyncObservabilityAdminClientConfig(TypedDict, total=False):
...
class AsyncObservabilityAdminClient:
    ...
    async def create_centralization_rule_for_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.create_centralization_rule_for_organization_input.CreateCentralizationRuleForOrganizationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.create_centralization_rule_for_organization_output.CreateCentralizationRuleForOrganizationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.create_centralization_rule_for_organization.async_create_centralization_rule_for_organization(
    ...
    async def create_s3_table_integration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.create_s3_table_integration_input.CreateS3TableIntegrationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.create_s3_table_integration_output.CreateS3TableIntegrationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.create_s3_table_integration.async_create_s3_table_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_telemetry_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.create_telemetry_rule_input.CreateTelemetryRuleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.create_telemetry_rule_output.CreateTelemetryRuleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.create_telemetry_rule.async_create_telemetry_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_telemetry_rule_for_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.create_telemetry_rule_for_organization_input.CreateTelemetryRuleForOrganizationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.create_telemetry_rule_for_organization_output.CreateTelemetryRuleForOrganizationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.create_telemetry_rule_for_organization.async_create_telemetry_rule_for_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_centralization_rule_for_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.delete_centralization_rule_for_organization_input.DeleteCentralizationRuleForOrganizationInput]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.delete_centralization_rule_for_organization.async_delete_centralization_rule_for_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_s3_table_integration(
        ...
        *,
        ...
        Raises:
            aws_sdk_observabilityadmin.errors.access_denied_exception.AccessDeniedException: <p> Indicates you don't have permissions to perform the requested operation. The user or role that is making the request must have at least one IAM permissions policy attached that grants the required permissions. For more information, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/access.html\">Access management for Amazon Web Services resources</a> in the IAM user guide. </p>
            aws_sdk_observabilityadmin.errors.internal_server_exception.InternalServerException: <p> Indicates the request has failed to process because of an unknown server error, exception, or failure. </p>
            aws_sdk_observabilityadmin.errors.invalid_state_exception.InvalidStateException: <p> The requested operation cannot be completed on the specified resource in the current state. </p>
            aws_sdk_observabilityadmin.errors.service_quota_exceeded_exception.ServiceQuotaExceededException: <p> The requested operation would exceed the allowed quota for the specified resource type. </p>
            aws_sdk_observabilityadmin.errors.too_many_requests_exception.TooManyRequestsException: <p> The request throughput limit was exceeded. </p>
            aws_sdk_observabilityadmin.errors.validation_exception.ValidationException: <p> Indicates input validation failed. Check your request parameters and retry the request. </p>
            aws_sdk_observabilityadmin.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.delete_s3_table_integration_input.DeleteS3TableIntegrationInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.delete_s3_table_integration.async_delete_s3_table_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_telemetry_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.delete_telemetry_rule_input.DeleteTelemetryRuleInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.delete_telemetry_rule.async_delete_telemetry_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_telemetry_rule_for_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.delete_telemetry_rule_for_organization_input.DeleteTelemetryRuleForOrganizationInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.delete_telemetry_rule_for_organization.async_delete_telemetry_rule_for_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_centralization_rule_for_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.get_centralization_rule_for_organization_input.GetCentralizationRuleForOrganizationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.get_centralization_rule_for_organization_output.GetCentralizationRuleForOrganizationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.get_centralization_rule_for_organization.async_get_centralization_rule_for_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_s3_table_integration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.get_s3_table_integration_input.GetS3TableIntegrationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.get_s3_table_integration_output.GetS3TableIntegrationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.get_s3_table_integration.async_get_s3_table_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_telemetry_enrichment_status(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.get_telemetry_enrichment_status.async_get_telemetry_enrichment_status(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_telemetry_evaluation_status(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.get_telemetry_evaluation_status.async_get_telemetry_evaluation_status(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_telemetry_evaluation_status_for_organization(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.get_telemetry_evaluation_status_for_organization.async_get_telemetry_evaluation_status_for_organization(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_telemetry_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.get_telemetry_rule_input.GetTelemetryRuleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.get_telemetry_rule_output.GetTelemetryRuleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.get_telemetry_rule.async_get_telemetry_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_telemetry_rule_for_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.get_telemetry_rule_for_organization_input.GetTelemetryRuleForOrganizationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.get_telemetry_rule_for_organization_output.GetTelemetryRuleForOrganizationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.get_telemetry_rule_for_organization.async_get_telemetry_rule_for_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_centralization_rules_for_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.list_centralization_rules_for_organization_input.ListCentralizationRulesForOrganizationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.list_centralization_rules_for_organization_output.ListCentralizationRulesForOrganizationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.list_centralization_rules_for_organization.async_list_centralization_rules_for_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_observabilityadmin.types.centralization_rule_summary.CentralizationRuleSummary]":
        _token = next_token
        while True:
    ...
    async def list_resource_telemetry(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.list_resource_telemetry_input.ListResourceTelemetryInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.list_resource_telemetry_output.ListResourceTelemetryOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.list_resource_telemetry.async_list_resource_telemetry(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_observabilityadmin.types.telemetry_configuration.TelemetryConfiguration]":
        _token = next_token
        while True:
    ...
    async def list_resource_telemetry_for_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.list_resource_telemetry_for_organization_input.ListResourceTelemetryForOrganizationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.list_resource_telemetry_for_organization_output.ListResourceTelemetryForOrganizationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.list_resource_telemetry_for_organization.async_list_resource_telemetry_for_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_s3_table_integrations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.list_s3_table_integrations_input.ListS3TableIntegrationsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.list_s3_table_integrations_output.ListS3TableIntegrationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.list_s3_table_integrations.async_list_s3_table_integrations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_observabilityadmin.types.integration_summary.IntegrationSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_telemetry_rules(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.list_telemetry_rules_input.ListTelemetryRulesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.list_telemetry_rules_output.ListTelemetryRulesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.list_telemetry_rules.async_list_telemetry_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_observabilityadmin.types.telemetry_rule_summary.TelemetryRuleSummary]":
        _token = next_token
        while True:
    ...
    async def list_telemetry_rules_for_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.list_telemetry_rules_for_organization_input.ListTelemetryRulesForOrganizationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.list_telemetry_rules_for_organization_output.ListTelemetryRulesForOrganizationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.list_telemetry_rules_for_organization.async_list_telemetry_rules_for_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_telemetry_enrichment(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.start_telemetry_enrichment.async_start_telemetry_enrichment(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_telemetry_evaluation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.start_telemetry_evaluation_input.StartTelemetryEvaluationInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.start_telemetry_evaluation.async_start_telemetry_evaluation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_telemetry_evaluation_for_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.start_telemetry_evaluation_for_organization_input.StartTelemetryEvaluationForOrganizationInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.start_telemetry_evaluation_for_organization.async_start_telemetry_evaluation_for_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_telemetry_enrichment(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.stop_telemetry_enrichment.async_stop_telemetry_enrichment(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_telemetry_evaluation(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.stop_telemetry_evaluation.async_stop_telemetry_evaluation(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_telemetry_evaluation_for_organization(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.stop_telemetry_evaluation_for_organization.async_stop_telemetry_evaluation_for_organization(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.tag_resource_input.TagResourceInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def test_telemetry_pipeline(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.test_telemetry_pipeline_input.TestTelemetryPipelineInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.test_telemetry_pipeline_output.TestTelemetryPipelineOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.test_telemetry_pipeline.async_test_telemetry_pipeline(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_centralization_rule_for_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.update_centralization_rule_for_organization_input.UpdateCentralizationRuleForOrganizationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.update_centralization_rule_for_organization_output.UpdateCentralizationRuleForOrganizationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.update_centralization_rule_for_organization.async_update_centralization_rule_for_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_telemetry_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.update_telemetry_rule_input.UpdateTelemetryRuleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.update_telemetry_rule_output.UpdateTelemetryRuleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.update_telemetry_rule.async_update_telemetry_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_telemetry_rule_for_organization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.update_telemetry_rule_for_organization_input.UpdateTelemetryRuleForOrganizationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.update_telemetry_rule_for_organization_output.UpdateTelemetryRuleForOrganizationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.update_telemetry_rule_for_organization.async_update_telemetry_rule_for_organization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def validate_telemetry_pipeline_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_observabilityadmin.types.validate_telemetry_pipeline_configuration_input.ValidateTelemetryPipelineConfigurationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_observabilityadmin.types.validate_telemetry_pipeline_configuration_output.ValidateTelemetryPipelineConfigurationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_observabilityadmin._operations.observability_admin.validate_telemetry_pipeline_configuration.async_validate_telemetry_pipeline_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
