...
if TYPE_CHECKING:
    import aws_sdk_observabilityadmin.types.organization_unit_identifier

OrganizationUnitIdentifiers: TypeAlias = list[
    "aws_sdk_observabilityadmin.types.organization_unit_identifier.OrganizationUnitIdentifier"
]
