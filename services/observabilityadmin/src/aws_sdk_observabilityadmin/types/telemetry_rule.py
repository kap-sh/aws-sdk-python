...
if TYPE_CHECKING:
    ...
    import aws_sdk_observabilityadmin.types.telemetry_destination_configuration
    import aws_sdk_observabilityadmin.types.telemetry_source_types
    import aws_sdk_observabilityadmin.types.telemetry_type


class TelemetryRule(TypedDict):
    ...
    telemetry_source_types: NotRequired[
        "aws_sdk_observabilityadmin.types.telemetry_source_types.TelemetrySourceTypes"
    ]
    ...
    destination_configuration: NotRequired[
        "aws_sdk_observabilityadmin.types.telemetry_destination_configuration.TelemetryDestinationConfiguration"
    ]
...
def serialize_json(value: TelemetryRule) -> dict:
    ...
    out["TelemetryType"] = (
        aws_sdk_observabilityadmin.types.telemetry_type.serialize_json(
    ...
    if "telemetry_source_types" in value:
        ...
        out["TelemetrySourceTypes"] = (
            aws_sdk_observabilityadmin.types.telemetry_source_types.serialize_json(
    ...
    if "destination_configuration" in value:
        ...
        out["DestinationConfiguration"] = (
            aws_sdk_observabilityadmin.types.telemetry_destination_configuration.serialize_json(
...
def deserialize_json(data: dict) -> TelemetryRule:
    ...
    if "TelemetryType" in data:
        ...
        out["telemetry_type"] = (
            aws_sdk_observabilityadmin.types.telemetry_type.deserialize_json(
                data["TelemetryType"]
            )
        )
    else:
    ...
    if "TelemetrySourceTypes" in data:
        ...
        out["telemetry_source_types"] = (
            aws_sdk_observabilityadmin.types.telemetry_source_types.deserialize_json(
    ...
    if "DestinationConfiguration" in data:
        ...
        out["destination_configuration"] = (
            aws_sdk_observabilityadmin.types.telemetry_destination_configuration.deserialize_json(
