...
if TYPE_CHECKING:
    import aws_sdk_observabilityadmin.types.encryption_conflict_resolution_strategy
    import aws_sdk_observabilityadmin.types.encryption_strategy
    import aws_sdk_observabilityadmin.types.resource_arn


class LogsEncryptionConfiguration(TypedDict):
    encryption_strategy: (
        "aws_sdk_observabilityadmin.types.encryption_strategy.EncryptionStrategy"
    )
    ...
    encryption_conflict_resolution_strategy: NotRequired[
        "aws_sdk_observabilityadmin.types.encryption_conflict_resolution_strategy.EncryptionConflictResolutionStrategy"
    ]
...
def serialize_json(value: LogsEncryptionConfiguration) -> dict:
    ...
    out["EncryptionStrategy"] = (
        aws_sdk_observabilityadmin.types.encryption_strategy.serialize_json(
    ...
    if "encryption_conflict_resolution_strategy" in value:
        ...
        out["EncryptionConflictResolutionStrategy"] = (
            aws_sdk_observabilityadmin.types.encryption_conflict_resolution_strategy.serialize_json(
...
def deserialize_json(data: dict) -> LogsEncryptionConfiguration:
    ...
    if "EncryptionStrategy" in data:
        ...
        out["encryption_strategy"] = (
            aws_sdk_observabilityadmin.types.encryption_strategy.deserialize_json(
    ...
    if "EncryptionConflictResolutionStrategy" in data:
        ...
        out["encryption_conflict_resolution_strategy"] = (
            aws_sdk_observabilityadmin.types.encryption_conflict_resolution_strategy.deserialize_json(
