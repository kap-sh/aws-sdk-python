...
if TYPE_CHECKING:
    import aws_sdk_observabilityadmin.types.tag_key
    import aws_sdk_observabilityadmin.types.tag_value

TagMapInput: TypeAlias = dict[
    "aws_sdk_observabilityadmin.types.tag_key.TagKey",
    "aws_sdk_observabilityadmin.types.tag_value.TagValue",
]
