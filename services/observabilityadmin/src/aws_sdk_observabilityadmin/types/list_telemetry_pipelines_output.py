...
class ListTelemetryPipelinesOutput(TypedDict):
    pipeline_summaries: NotRequired[
        "aws_sdk_observabilityadmin.types.telemetry_pipeline_summaries.TelemetryPipelineSummaries"
    ]
...
def serialize_json(value: ListTelemetryPipelinesOutput) -> dict:
    ...
    if "pipeline_summaries" in value:
        ...
        out["PipelineSummaries"] = (
            aws_sdk_observabilityadmin.types.telemetry_pipeline_summaries.serialize_json(
...
def deserialize_json(data: dict) -> ListTelemetryPipelinesOutput:
    ...
    if "PipelineSummaries" in data:
        ...
        out["pipeline_summaries"] = (
            aws_sdk_observabilityadmin.types.telemetry_pipeline_summaries.deserialize_json(
