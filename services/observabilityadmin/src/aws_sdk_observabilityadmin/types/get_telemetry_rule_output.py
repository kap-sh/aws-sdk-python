"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#GetTelemetryRuleOutput``."""
...
class GetTelemetryRuleOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetTelemetryRuleOutput) -> dict:
    out: dict = {}
