...
class ObservabilityAdminError(Exception):
    """Base class for all ObservabilityAdmin service errors."""


class ServiceError(ObservabilityAdminError):
...
class SerializationError(ObservabilityAdminError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ObservabilityAdminError):
...
class WaiterFailedError(ObservabilityAdminError):
...
class WaiterTimeoutError(ObservabilityAdminError):
