...
from capo_observabilityadmin._services._aws_config import aws_config
...
class ObservabilityAdminClientConfig(TypedDict, total=False, closed=True):
...
class ObservabilityAdminClient:
    ...
    def create_centralization_rule_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.create_centralization_rule_for_organization_input.CreateCentralizationRuleForOrganizationInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.create_centralization_rule_for_organization_output.CreateCentralizationRuleForOrganizationOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.create_centralization_rule_for_organization.create_centralization_rule_for_organization(
    ...
    def create_s3_table_integration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.create_s3_table_integration_input.CreateS3TableIntegrationInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.create_s3_table_integration_output.CreateS3TableIntegrationOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.create_s3_table_integration.create_s3_table_integration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_telemetry_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.create_telemetry_rule_input.CreateTelemetryRuleInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.create_telemetry_rule_output.CreateTelemetryRuleOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.create_telemetry_rule.create_telemetry_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_telemetry_rule_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.create_telemetry_rule_for_organization_input.CreateTelemetryRuleForOrganizationInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.create_telemetry_rule_for_organization_output.CreateTelemetryRuleForOrganizationOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.create_telemetry_rule_for_organization.create_telemetry_rule_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_centralization_rule_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.delete_centralization_rule_for_organization_input.DeleteCentralizationRuleForOrganizationInput]",
        ) -> OperationResponse[None]:
            import capo_observabilityadmin._operations.observability_admin.delete_centralization_rule_for_organization

            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.delete_centralization_rule_for_organization.delete_centralization_rule_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_s3_table_integration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.delete_s3_table_integration_input.DeleteS3TableIntegrationInput]",
        ) -> OperationResponse[None]:
            import capo_observabilityadmin._operations.observability_admin.delete_s3_table_integration

            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.delete_s3_table_integration.delete_s3_table_integration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_telemetry_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.delete_telemetry_rule_input.DeleteTelemetryRuleInput]",
        ) -> OperationResponse[None]:
            import capo_observabilityadmin._operations.observability_admin.delete_telemetry_rule

            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.delete_telemetry_rule.delete_telemetry_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_telemetry_rule_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.delete_telemetry_rule_for_organization_input.DeleteTelemetryRuleForOrganizationInput]",
        ) -> OperationResponse[None]:
            import capo_observabilityadmin._operations.observability_admin.delete_telemetry_rule_for_organization

            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.delete_telemetry_rule_for_organization.delete_telemetry_rule_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_centralization_rule_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.get_centralization_rule_for_organization_input.GetCentralizationRuleForOrganizationInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.get_centralization_rule_for_organization_output.GetCentralizationRuleForOrganizationOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.get_centralization_rule_for_organization.get_centralization_rule_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_s3_table_integration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.get_s3_table_integration_input.GetS3TableIntegrationInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.get_s3_table_integration_output.GetS3TableIntegrationOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.get_s3_table_integration.get_s3_table_integration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_telemetry_enrichment_status(
        ...
        def _handler(
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.get_telemetry_enrichment_status.get_telemetry_enrichment_status(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_telemetry_evaluation_status(
        ...
        def _handler(
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.get_telemetry_evaluation_status.get_telemetry_evaluation_status(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_telemetry_evaluation_status_for_organization(
        ...
        def _handler(
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.get_telemetry_evaluation_status_for_organization.get_telemetry_evaluation_status_for_organization(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_telemetry_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.get_telemetry_rule_input.GetTelemetryRuleInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.get_telemetry_rule_output.GetTelemetryRuleOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.get_telemetry_rule.get_telemetry_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_telemetry_rule_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.get_telemetry_rule_for_organization_input.GetTelemetryRuleForOrganizationInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.get_telemetry_rule_for_organization_output.GetTelemetryRuleForOrganizationOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.get_telemetry_rule_for_organization.get_telemetry_rule_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_centralization_rules_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.list_centralization_rules_for_organization_input.ListCentralizationRulesForOrganizationInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.list_centralization_rules_for_organization_output.ListCentralizationRulesForOrganizationOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.list_centralization_rules_for_organization.list_centralization_rules_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_observabilityadmin.types.centralization_rule_summary.CentralizationRuleSummary]":
        _token = next_token
        while True:
    ...
    def list_resource_telemetry(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.list_resource_telemetry_input.ListResourceTelemetryInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.list_resource_telemetry_output.ListResourceTelemetryOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.list_resource_telemetry.list_resource_telemetry(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_observabilityadmin.types.telemetry_configuration.TelemetryConfiguration]":
        _token = next_token
        while True:
    ...
    def list_resource_telemetry_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.list_resource_telemetry_for_organization_input.ListResourceTelemetryForOrganizationInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.list_resource_telemetry_for_organization_output.ListResourceTelemetryForOrganizationOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.list_resource_telemetry_for_organization.list_resource_telemetry_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_s3_table_integrations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.list_s3_table_integrations_input.ListS3TableIntegrationsInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.list_s3_table_integrations_output.ListS3TableIntegrationsOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.list_s3_table_integrations.list_s3_table_integrations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_s3_table_integrations(
        ...
        *,
        ...
        "Iterator[capo_observabilityadmin.types.integration_summary.IntegrationSummary]"
    ):
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_telemetry_rules(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.list_telemetry_rules_input.ListTelemetryRulesInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.list_telemetry_rules_output.ListTelemetryRulesOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.list_telemetry_rules.list_telemetry_rules(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_observabilityadmin.types.telemetry_rule_summary.TelemetryRuleSummary]":
        _token = next_token
        while True:
    ...
    def list_telemetry_rules_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.list_telemetry_rules_for_organization_input.ListTelemetryRulesForOrganizationInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.list_telemetry_rules_for_organization_output.ListTelemetryRulesForOrganizationOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.list_telemetry_rules_for_organization.list_telemetry_rules_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_telemetry_enrichment(
        ...
        def _handler(
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.start_telemetry_enrichment.start_telemetry_enrichment(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_telemetry_evaluation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.start_telemetry_evaluation_input.StartTelemetryEvaluationInput]",
        ) -> OperationResponse[None]:
            import capo_observabilityadmin._operations.observability_admin.start_telemetry_evaluation

            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.start_telemetry_evaluation.start_telemetry_evaluation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_telemetry_evaluation_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.start_telemetry_evaluation_for_organization_input.StartTelemetryEvaluationForOrganizationInput]",
        ) -> OperationResponse[None]:
            import capo_observabilityadmin._operations.observability_admin.start_telemetry_evaluation_for_organization

            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.start_telemetry_evaluation_for_organization.start_telemetry_evaluation_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_telemetry_enrichment(
        ...
        def _handler(
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.stop_telemetry_enrichment.stop_telemetry_enrichment(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_telemetry_evaluation(
        ...
        def _handler(req: "OperationRequest[None]") -> OperationResponse[None]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.stop_telemetry_evaluation.stop_telemetry_evaluation(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_telemetry_evaluation_for_organization(
        ...
        def _handler(req: "OperationRequest[None]") -> OperationResponse[None]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.stop_telemetry_evaluation_for_organization.stop_telemetry_evaluation_for_organization(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[None]:
            import capo_observabilityadmin._operations.observability_admin.tag_resource

            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def test_telemetry_pipeline(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.test_telemetry_pipeline_input.TestTelemetryPipelineInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.test_telemetry_pipeline_output.TestTelemetryPipelineOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.test_telemetry_pipeline.test_telemetry_pipeline(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[None]:
            import capo_observabilityadmin._operations.observability_admin.untag_resource

            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_centralization_rule_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.update_centralization_rule_for_organization_input.UpdateCentralizationRuleForOrganizationInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.update_centralization_rule_for_organization_output.UpdateCentralizationRuleForOrganizationOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.update_centralization_rule_for_organization.update_centralization_rule_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_telemetry_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.update_telemetry_rule_input.UpdateTelemetryRuleInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.update_telemetry_rule_output.UpdateTelemetryRuleOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.update_telemetry_rule.update_telemetry_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_telemetry_rule_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.update_telemetry_rule_for_organization_input.UpdateTelemetryRuleForOrganizationInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.update_telemetry_rule_for_organization_output.UpdateTelemetryRuleForOrganizationOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.update_telemetry_rule_for_organization.update_telemetry_rule_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def validate_telemetry_pipeline_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_observabilityadmin.types.validate_telemetry_pipeline_configuration_input.ValidateTelemetryPipelineConfigurationInput]",
        ) -> OperationResponse[
            "capo_observabilityadmin.types.validate_telemetry_pipeline_configuration_output.ValidateTelemetryPipelineConfigurationOutput"
        ]:
            ...
            output, http_response = (
                capo_observabilityadmin._operations.observability_admin.validate_telemetry_pipeline_configuration.validate_telemetry_pipeline_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
