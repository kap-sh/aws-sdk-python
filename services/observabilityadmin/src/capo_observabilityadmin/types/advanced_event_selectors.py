...
if TYPE_CHECKING:
    import capo_observabilityadmin.types.advanced_event_selector

AdvancedEventSelectors: TypeAlias = list[
    "capo_observabilityadmin.types.advanced_event_selector.AdvancedEventSelector"
]
...
def serialize_json(value: AdvancedEventSelectors) -> list:
    ...
    for item in value:
        out.append(
            capo_observabilityadmin.types.advanced_event_selector.serialize_json(item)
        )
    return out
