...
if TYPE_CHECKING:
    import capo_observabilityadmin.types.is_replicated
...
class GetTelemetryRuleForOrganizationOutput(TypedDict, closed=True):
    ...
    telemetry_rule: NotRequired[
        "capo_observabilityadmin.types.telemetry_rule.TelemetryRule"
    ]
    """<p> The configuration details of the organization telemetry rule. </p>"""
    home_region: NotRequired["capo_observabilityadmin.types.region.Region"]
    ...
    is_replicated: NotRequired[
        "capo_observabilityadmin.types.is_replicated.IsReplicated"
    ]
    ...
    region_statuses: NotRequired[
        "capo_observabilityadmin.types.region_statuses.RegionStatuses"
    ]
...
def serialize_json(value: GetTelemetryRuleForOrganizationOutput) -> dict:
    ...
    if "telemetry_rule" in value:
        ...
        out["TelemetryRule"] = (
            capo_observabilityadmin.types.telemetry_rule.serialize_json(
    ...
    if "region_statuses" in value:
        ...
        out["RegionStatuses"] = (
            capo_observabilityadmin.types.region_statuses.serialize_json(
...
def deserialize_json(data: dict) -> GetTelemetryRuleForOrganizationOutput:
    ...
    if "TelemetryRule" in data:
        ...
        out["telemetry_rule"] = (
            capo_observabilityadmin.types.telemetry_rule.deserialize_json(
                data["TelemetryRule"]
            )
        )
    ...
    if "RegionStatuses" in data:
        ...
        out["region_statuses"] = (
            capo_observabilityadmin.types.region_statuses.deserialize_json(
                data["RegionStatuses"]
            )
        )
    return out
