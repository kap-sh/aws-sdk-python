"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#StopTelemetryEvaluation``."""
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/StopTelemetryEvaluation"
    params: dict[str, str] = {}
...
async def async_stop_telemetry_evaluation(
