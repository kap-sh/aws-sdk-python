...
def handle_response(
    ...
    out: capo_observabilityadmin.types.list_telemetry_pipelines_output.ListTelemetryPipelinesOutput = capo_observabilityadmin.types.list_telemetry_pipelines_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.list_telemetry_pipelines_input.serialize_json(
            input_
        )
    ).encode()
