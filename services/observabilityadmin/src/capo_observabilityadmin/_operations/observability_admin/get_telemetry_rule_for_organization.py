...
def handle_response(
    ...
    out: capo_observabilityadmin.types.get_telemetry_rule_for_organization_output.GetTelemetryRuleForOrganizationOutput = capo_observabilityadmin.types.get_telemetry_rule_for_organization_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.get_telemetry_rule_for_organization_input.serialize_json(
            input_
        )
    ).encode()
