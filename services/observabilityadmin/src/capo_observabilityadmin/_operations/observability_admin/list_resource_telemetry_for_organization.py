"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#ListResourceTelemetryForOrganization``."""
...
def handle_response(
    ...
    out: capo_observabilityadmin.types.list_resource_telemetry_for_organization_output.ListResourceTelemetryForOrganizationOutput = capo_observabilityadmin.types.list_resource_telemetry_for_organization_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.list_resource_telemetry_for_organization_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_resource_telemetry_for_organization(
