...
def handle_response(
    ...
    out: capo_observabilityadmin.types.validate_telemetry_pipeline_configuration_output.ValidateTelemetryPipelineConfigurationOutput = capo_observabilityadmin.types.validate_telemetry_pipeline_configuration_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.validate_telemetry_pipeline_configuration_input.serialize_json(
            input_
        )
    ).encode()
