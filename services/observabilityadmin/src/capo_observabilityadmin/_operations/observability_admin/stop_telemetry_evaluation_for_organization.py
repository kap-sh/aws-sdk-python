"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#StopTelemetryEvaluationForOrganization``."""
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/StopTelemetryEvaluationForOrganization"
    params: dict[str, str] = {}
...
async def async_stop_telemetry_evaluation_for_organization(
