...
def handle_response(
    ...
    out: capo_observabilityadmin.types.list_resource_telemetry_output.ListResourceTelemetryOutput = capo_observabilityadmin.types.list_resource_telemetry_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.list_resource_telemetry_input.serialize_json(
            input_
        )
    ).encode()
