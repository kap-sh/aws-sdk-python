"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#StartTelemetryEnrichment``."""
...
def handle_response(
    ...
    out: capo_observabilityadmin.types.start_telemetry_enrichment_output.StartTelemetryEnrichmentOutput = capo_observabilityadmin.types.start_telemetry_enrichment_output.deserialize_json(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/StartTelemetryEnrichment"
    params: dict[str, str] = {}
...
async def async_start_telemetry_enrichment(
