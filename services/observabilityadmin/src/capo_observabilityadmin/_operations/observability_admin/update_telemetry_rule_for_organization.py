"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#UpdateTelemetryRuleForOrganization``."""
...
def handle_response(
    ...
    out: capo_observabilityadmin.types.update_telemetry_rule_for_organization_output.UpdateTelemetryRuleForOrganizationOutput = capo_observabilityadmin.types.update_telemetry_rule_for_organization_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/UpdateTelemetryRuleForOrganization"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.update_telemetry_rule_for_organization_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_telemetry_rule_for_organization(
