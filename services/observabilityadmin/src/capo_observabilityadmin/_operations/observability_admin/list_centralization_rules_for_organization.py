"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#ListCentralizationRulesForOrganization``."""
...
def handle_response(
    ...
    out: capo_observabilityadmin.types.list_centralization_rules_for_organization_output.ListCentralizationRulesForOrganizationOutput = capo_observabilityadmin.types.list_centralization_rules_for_organization_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ListCentralizationRulesForOrganization"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.list_centralization_rules_for_organization_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_centralization_rules_for_organization(
