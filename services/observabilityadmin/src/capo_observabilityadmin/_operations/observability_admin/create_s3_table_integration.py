"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#CreateS3TableIntegration``."""
...
def handle_response(
    ...
    out: capo_observabilityadmin.types.create_s3_table_integration_output.CreateS3TableIntegrationOutput = capo_observabilityadmin.types.create_s3_table_integration_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.create_s3_table_integration_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_s3_table_integration(
