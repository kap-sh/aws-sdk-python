"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#GetTelemetryEvaluationStatus``."""
...
def handle_response(
    ...
    out: capo_observabilityadmin.types.get_telemetry_evaluation_status_output.GetTelemetryEvaluationStatusOutput = capo_observabilityadmin.types.get_telemetry_evaluation_status_output.deserialize_json(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/GetTelemetryEvaluationStatus"
    params: dict[str, str] = {}
...
async def async_get_telemetry_evaluation_status(
