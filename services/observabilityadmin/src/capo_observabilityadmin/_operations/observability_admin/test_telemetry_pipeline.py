...
def handle_response(
    ...
    out: capo_observabilityadmin.types.test_telemetry_pipeline_output.TestTelemetryPipelineOutput = capo_observabilityadmin.types.test_telemetry_pipeline_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.test_telemetry_pipeline_input.serialize_json(
            input_
        )
    ).encode()
