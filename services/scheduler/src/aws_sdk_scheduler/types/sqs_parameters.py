"""Generated from Smithy shape ``com.amazonaws.scheduler#SqsParameters``."""
...
if TYPE_CHECKING:
    import aws_sdk_scheduler.types.message_group_id


class SqsParameters(TypedDict):
    message_group_id: NotRequired[
        "aws_sdk_scheduler.types.message_group_id.MessageGroupId"
    ]
    """<p>The FIFO message group ID to use as the target.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: SqsParameters) -> dict:
    out: dict = {}
