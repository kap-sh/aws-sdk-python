...
if TYPE_CHECKING:
    import aws_sdk_scheduler.types.placement_constraint_expression
    import aws_sdk_scheduler.types.placement_constraint_type


class PlacementConstraint(TypedDict):
    type: NotRequired[
        "aws_sdk_scheduler.types.placement_constraint_type.PlacementConstraintType"
    ]
