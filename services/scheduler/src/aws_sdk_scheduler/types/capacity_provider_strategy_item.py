"""Generated from Smithy shape ``com.amazonaws.scheduler#CapacityProviderStrategyItem``."""
...
if TYPE_CHECKING:
    import aws_sdk_scheduler.types.capacity_provider
    import aws_sdk_scheduler.types.capacity_provider_strategy_item_base
    import aws_sdk_scheduler.types.capacity_provider_strategy_item_weight


class CapacityProviderStrategyItem(TypedDict):
    capacity_provider: "aws_sdk_scheduler.types.capacity_provider.CapacityProvider"
    """<p>The short name of the capacity provider.</p>"""
    weight: "aws_sdk_scheduler.types.capacity_provider_strategy_item_weight.CapacityProviderStrategyItemWeight"
    ...
    base: "aws_sdk_scheduler.types.capacity_provider_strategy_item_base.CapacityProviderStrategyItemBase"
