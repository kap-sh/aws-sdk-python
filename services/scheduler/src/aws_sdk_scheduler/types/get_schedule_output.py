...
class GetScheduleOutput(TypedDict):
    ...
    schedule_expression: NotRequired[
        "aws_sdk_scheduler.types.schedule_expression.ScheduleExpression"
    ]
    ...
    start_date: NotRequired["aws_sdk_scheduler.types.start_date.StartDate"]
    ...
    end_date: NotRequired["aws_sdk_scheduler.types.end_date.EndDate"]
    ...
    description: NotRequired["aws_sdk_scheduler.types.description.Description"]
    ...
    kms_key_arn: NotRequired["aws_sdk_scheduler.types.kms_key_arn.KmsKeyArn"]
    """<p>The ARN for a customer managed KMS Key that is be used to encrypt and decrypt your data.</p>"""
    target: NotRequired["aws_sdk_scheduler.types.target.Target"]
    """<p>The schedule target.</p>"""
    flexible_time_window: NotRequired[
        "aws_sdk_scheduler.types.flexible_time_window.FlexibleTimeWindow"
    ]
...
def serialize_json(value: GetScheduleOutput) -> dict:
    ...
    if "start_date" in value:
        ...
        out["StartDate"] = aws_sdk_scheduler.types.start_date.serialize_json(
            value["start_date"]
        )
    if "end_date" in value:
        import aws_sdk_scheduler.types.end_date

        out["EndDate"] = aws_sdk_scheduler.types.end_date.serialize_json(
            value["end_date"]
        )
    ...
    if "target" in value:
        ...
        out["Target"] = aws_sdk_scheduler.types.target.serialize_json(value["target"])
    if "flexible_time_window" in value:
        import aws_sdk_scheduler.types.flexible_time_window

        out["FlexibleTimeWindow"] = (
            aws_sdk_scheduler.types.flexible_time_window.serialize_json(
...
def deserialize_json(data: dict) -> GetScheduleOutput:
    ...
    if "StartDate" in data:
        ...
        out["start_date"] = aws_sdk_scheduler.types.start_date.deserialize_json(
            data["StartDate"]
        )
    if "EndDate" in data:
        import aws_sdk_scheduler.types.end_date

        out["end_date"] = aws_sdk_scheduler.types.end_date.deserialize_json(
            data["EndDate"]
        )
    ...
    if "Target" in data:
        ...
        out["target"] = aws_sdk_scheduler.types.target.deserialize_json(data["Target"])
    if "FlexibleTimeWindow" in data:
        import aws_sdk_scheduler.types.flexible_time_window

        out["flexible_time_window"] = (
            aws_sdk_scheduler.types.flexible_time_window.deserialize_json(
