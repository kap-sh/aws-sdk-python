...
if TYPE_CHECKING:
    import aws_sdk_scheduler.types.action_after_completion
    import aws_sdk_scheduler.types.client_token
    import aws_sdk_scheduler.types.create_schedule_input
    import aws_sdk_scheduler.types.create_schedule_output
    import aws_sdk_scheduler.types.delete_schedule_input
    import aws_sdk_scheduler.types.delete_schedule_output
    import aws_sdk_scheduler.types.description
    import aws_sdk_scheduler.types.end_date
    import aws_sdk_scheduler.types.flexible_time_window
    import aws_sdk_scheduler.types.get_schedule_input
    import aws_sdk_scheduler.types.get_schedule_output
    import aws_sdk_scheduler.types.kms_key_arn
    import aws_sdk_scheduler.types.list_schedules_input
    import aws_sdk_scheduler.types.list_schedules_output
    import aws_sdk_scheduler.types.max_results
    import aws_sdk_scheduler.types.name
    import aws_sdk_scheduler.types.name_prefix
    import aws_sdk_scheduler.types.next_token
    import aws_sdk_scheduler.types.schedule_expression
    import aws_sdk_scheduler.types.schedule_expression_timezone
    ...
    import aws_sdk_scheduler.types.start_date
    import aws_sdk_scheduler.types.target
    import aws_sdk_scheduler.types.update_schedule_input
    import aws_sdk_scheduler.types.update_schedule_output
...
class Schedule:
    ...
    def put(
        ...
        schedule_expression: "aws_sdk_scheduler.types.schedule_expression.ScheduleExpression",
        target: "aws_sdk_scheduler.types.target.Target",
        flexible_time_window: "aws_sdk_scheduler.types.flexible_time_window.FlexibleTimeWindow",
        *,
        config_overrides: Optional[SchedulerClientConfig] = None,
        group_name: Optional[
            "aws_sdk_scheduler.types.schedule_group_name.ScheduleGroupName"
        ] = None,
        start_date: Optional["aws_sdk_scheduler.types.start_date.StartDate"] = None,
        end_date: Optional["aws_sdk_scheduler.types.end_date.EndDate"] = None,
        description: Optional["aws_sdk_scheduler.types.description.Description"] = None,
        schedule_expression_timezone: Optional[
            "aws_sdk_scheduler.types.schedule_expression_timezone.ScheduleExpressionTimezone"
        ] = None,
        state: Optional["aws_sdk_scheduler.types.schedule_state.ScheduleState"] = None,
        kms_key_arn: Optional["aws_sdk_scheduler.types.kms_key_arn.KmsKeyArn"] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_scheduler.types.create_schedule_input.CreateScheduleInput]",
        ) -> OperationResponse[
            "aws_sdk_scheduler.types.create_schedule_output.CreateScheduleOutput"
        ]:
            import aws_sdk_scheduler._operations.aws_chronos_service.create_schedule

            output, http_response = (
                aws_sdk_scheduler._operations.aws_chronos_service.create_schedule.create_schedule(
    ...
    def read(
        ...
        *,
    ...
    ) -> "aws_sdk_scheduler.types.get_schedule_output.GetScheduleOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_scheduler.types.get_schedule_input.GetScheduleInput]",
        ) -> OperationResponse[
            "aws_sdk_scheduler.types.get_schedule_output.GetScheduleOutput"
        ]:
            import aws_sdk_scheduler._operations.aws_chronos_service.get_schedule

            output, http_response = (
                aws_sdk_scheduler._operations.aws_chronos_service.get_schedule.get_schedule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_scheduler.types.update_schedule_input.UpdateScheduleInput]",
        ) -> OperationResponse[
            "aws_sdk_scheduler.types.update_schedule_output.UpdateScheduleOutput"
        ]:
            import aws_sdk_scheduler._operations.aws_chronos_service.update_schedule

            output, http_response = (
                aws_sdk_scheduler._operations.aws_chronos_service.update_schedule.update_schedule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
    ...
    ) -> "aws_sdk_scheduler.types.delete_schedule_output.DeleteScheduleOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_scheduler.types.delete_schedule_input.DeleteScheduleInput]",
        ) -> OperationResponse[
            "aws_sdk_scheduler.types.delete_schedule_output.DeleteScheduleOutput"
        ]:
            import aws_sdk_scheduler._operations.aws_chronos_service.delete_schedule

            output, http_response = (
                aws_sdk_scheduler._operations.aws_chronos_service.delete_schedule.delete_schedule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
        ...
        name_prefix: Optional["aws_sdk_scheduler.types.name_prefix.NamePrefix"] = None,
        state: Optional["aws_sdk_scheduler.types.schedule_state.ScheduleState"] = None,
    ...
    ) -> "aws_sdk_scheduler.types.list_schedules_output.ListSchedulesOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_scheduler.types.list_schedules_input.ListSchedulesInput]",
        ) -> OperationResponse[
            "aws_sdk_scheduler.types.list_schedules_output.ListSchedulesOutput"
        ]:
            import aws_sdk_scheduler._operations.aws_chronos_service.list_schedules

            output, http_response = (
                aws_sdk_scheduler._operations.aws_chronos_service.list_schedules.list_schedules(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncSchedule:
    ...
    async def put(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_scheduler.types.create_schedule_input.CreateScheduleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_scheduler.types.create_schedule_output.CreateScheduleOutput"
        ]:
            import aws_sdk_scheduler._operations.aws_chronos_service.create_schedule
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_scheduler._operations.aws_chronos_service.create_schedule.async_create_schedule(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_scheduler.types.get_schedule_input.GetScheduleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_scheduler.types.get_schedule_output.GetScheduleOutput"
        ]:
            import aws_sdk_scheduler._operations.aws_chronos_service.get_schedule
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_scheduler._operations.aws_chronos_service.get_schedule.async_get_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_scheduler.types.update_schedule_input.UpdateScheduleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_scheduler.types.update_schedule_output.UpdateScheduleOutput"
        ]:
            import aws_sdk_scheduler._operations.aws_chronos_service.update_schedule
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_scheduler._operations.aws_chronos_service.update_schedule.async_update_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_scheduler.types.delete_schedule_input.DeleteScheduleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_scheduler.types.delete_schedule_output.DeleteScheduleOutput"
        ]:
            import aws_sdk_scheduler._operations.aws_chronos_service.delete_schedule
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_scheduler._operations.aws_chronos_service.delete_schedule.async_delete_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_scheduler.types.list_schedules_input.ListSchedulesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_scheduler.types.list_schedules_output.ListSchedulesOutput"
        ]:
            import aws_sdk_scheduler._operations.aws_chronos_service.list_schedules
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_scheduler._operations.aws_chronos_service.list_schedules.async_list_schedules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
