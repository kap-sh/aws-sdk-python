...
class SchedulerError(Exception):
    """Base class for all Scheduler service errors."""


class ServiceError(SchedulerError):
...
class SerializationError(SchedulerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SchedulerError):
...
class WaiterFailedError(SchedulerError):
...
class WaiterTimeoutError(SchedulerError):
