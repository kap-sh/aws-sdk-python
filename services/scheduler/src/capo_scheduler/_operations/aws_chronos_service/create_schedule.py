...
def handle_response(
    ...
    out: capo_scheduler.types.create_schedule_output.CreateScheduleOutput = (
        capo_scheduler.types.create_schedule_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_scheduler.types.create_schedule_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_schedule(
    ...
    capo_scheduler.types.create_schedule_output.CreateScheduleOutput, zapros.Response
]:
