...
def handle_response(
    ...
    out: capo_scheduler.types.get_schedule_output.GetScheduleOutput = (
        capo_scheduler.types.get_schedule_output.deserialize_json(
...
def get_schedule(
    ...
    input_: capo_scheduler.types.get_schedule_input.GetScheduleInput,
) -> tuple[capo_scheduler.types.get_schedule_output.GetScheduleOutput, zapros.Response]:
