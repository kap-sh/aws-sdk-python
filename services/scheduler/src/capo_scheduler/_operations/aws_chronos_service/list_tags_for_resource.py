"""Generated from Smithy shape ``com.amazonaws.scheduler#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_scheduler.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_scheduler.types.list_tags_for_resource_output.deserialize_json(
