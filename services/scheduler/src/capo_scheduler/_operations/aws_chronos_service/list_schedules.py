"""Generated from Smithy shape ``com.amazonaws.scheduler#ListSchedules``."""
...
def handle_response(
    ...
    out: capo_scheduler.types.list_schedules_output.ListSchedulesOutput = (
        capo_scheduler.types.list_schedules_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/schedules"
    params: list[tuple[str, str]] = []
    if "group_name" in input_:
        params.append(("ScheduleGroup", input_["group_name"]))
...
def list_schedules(
    ...
    capo_scheduler.types.list_schedules_output.ListSchedulesOutput, zapros.Response
]:
...
async def async_list_schedules(
