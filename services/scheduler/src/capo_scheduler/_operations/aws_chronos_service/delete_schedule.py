...
def handle_response(
    ...
    out: capo_scheduler.types.delete_schedule_output.DeleteScheduleOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_schedule(
    ...
    capo_scheduler.types.delete_schedule_output.DeleteScheduleOutput, zapros.Response
]:
