"""Generated from Smithy shape ``com.amazonaws.scheduler#ListScheduleGroups``."""
...
def handle_response(
    ...
    out: capo_scheduler.types.list_schedule_groups_output.ListScheduleGroupsOutput = (
        capo_scheduler.types.list_schedule_groups_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/schedule-groups"
...
async def async_list_schedule_groups(
