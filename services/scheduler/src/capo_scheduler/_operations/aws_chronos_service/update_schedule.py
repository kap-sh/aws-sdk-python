"""Generated from Smithy shape ``com.amazonaws.scheduler#UpdateSchedule``."""
...
import capo_scheduler.errors.resource_not_found_exception
...
def handle_response(
    ...
    out: capo_scheduler.types.update_schedule_output.UpdateScheduleOutput = (
        capo_scheduler.types.update_schedule_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_scheduler.types.update_schedule_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_schedule(
    ...
    capo_scheduler.types.update_schedule_output.UpdateScheduleOutput, zapros.Response
]:
