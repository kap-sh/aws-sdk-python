"""Generated from Smithy shape ``com.amazonaws.scheduler#PlacementStrategy``."""
...
if TYPE_CHECKING:
    import capo_scheduler.types.placement_strategy_field
    import capo_scheduler.types.placement_strategy_type


class PlacementStrategy(TypedDict, closed=True):
    type: NotRequired[
        "capo_scheduler.types.placement_strategy_type.PlacementStrategyType"
    ]
    ...
    field: NotRequired[
        "capo_scheduler.types.placement_strategy_field.PlacementStrategyField"
    ]
