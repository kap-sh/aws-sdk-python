...
if TYPE_CHECKING:
    import capo_scheduler.types.maximum_event_age_in_seconds
    import capo_scheduler.types.maximum_retry_attempts
...
class RetryPolicy(TypedDict, closed=True):
    ...
    maximum_retry_attempts: NotRequired[
        "capo_scheduler.types.maximum_retry_attempts.MaximumRetryAttempts"
    ]
