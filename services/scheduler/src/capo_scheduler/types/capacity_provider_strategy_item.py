...
if TYPE_CHECKING:
    import capo_scheduler.types.capacity_provider
    import capo_scheduler.types.capacity_provider_strategy_item_base
    import capo_scheduler.types.capacity_provider_strategy_item_weight


class CapacityProviderStrategyItem(TypedDict, closed=True):
    capacity_provider: "capo_scheduler.types.capacity_provider.CapacityProvider"
    """<p>The short name of the capacity provider.</p>"""
    weight: "capo_scheduler.types.capacity_provider_strategy_item_weight.CapacityProviderStrategyItemWeight"
    ...
    base: "capo_scheduler.types.capacity_provider_strategy_item_base.CapacityProviderStrategyItemBase"
