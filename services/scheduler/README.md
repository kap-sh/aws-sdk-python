...
```
pip install aws-sdk-scheduler
```

## Usage

```python
from aws_sdk_scheduler import AsyncSchedulerClient


async def main():
    async with AsyncSchedulerClient() as s3:
...
```python
from aws_sdk_scheduler import AsyncSchedulerClient
from aws_sdk_scheduler.error import InternalServerException
