...
if TYPE_CHECKING:
    ...
    import aws_sdk_wafv2.types.request_inspection
...
class AWSManagedRulesATPRuleSet(TypedDict):
    ...
    request_inspection: NotRequired[
        "aws_sdk_wafv2.types.request_inspection.RequestInspection"
    ]
...
def serialize_aws_json_1_1(value: AWSManagedRulesATPRuleSet) -> dict:
    ...
    if "request_inspection" in value:
        ...
        out["RequestInspection"] = (
            aws_sdk_wafv2.types.request_inspection.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AWSManagedRulesATPRuleSet:
    ...
    if "RequestInspection" in data:
        ...
        out["request_inspection"] = (
            aws_sdk_wafv2.types.request_inspection.deserialize_aws_json_1_1(
