...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: JA3Fingerprint) -> dict:
    out: dict = {}
    import aws_sdk_wafv2.types.fallback_behavior
...
def deserialize_aws_json_1_1(data: dict) -> JA3Fingerprint:
    out: JA3Fingerprint = {}  # type: ignore[typeddict-item]
    if "FallbackBehavior" in data:
        ...
        raise DeserializationError("JA3Fingerprint.fallback_behavior required")
    return out
