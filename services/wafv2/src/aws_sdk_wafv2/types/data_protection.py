...
if TYPE_CHECKING:
    ...
    import aws_sdk_wafv2.types.data_protection_action
    import aws_sdk_wafv2.types.field_to_protect


class DataProtection(TypedDict):
    field: "aws_sdk_wafv2.types.field_to_protect.FieldToProtect"
    """<p>Specifies the field type and optional keys to apply the protection behavior to. </p>"""
    action: "aws_sdk_wafv2.types.data_protection_action.DataProtectionAction"
    ...
    exclude_rule_match_details: "aws_sdk_wafv2.types.boolean.Boolean"
    ...
    exclude_rate_based_details: "aws_sdk_wafv2.types.boolean.Boolean"
...
def serialize_aws_json_1_1(value: DataProtection) -> dict:
    ...
    out["Field"] = aws_sdk_wafv2.types.field_to_protect.serialize_aws_json_1_1(
        value["field"]
    )
    import aws_sdk_wafv2.types.data_protection_action

    out["Action"] = aws_sdk_wafv2.types.data_protection_action.serialize_aws_json_1_1(
        value["action"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> DataProtection:
    ...
    if "Field" in data:
        ...
        out["field"] = aws_sdk_wafv2.types.field_to_protect.deserialize_aws_json_1_1(
            data["Field"]
        )
    else:
    ...
    if "Action" in data:
        ...
        out["action"] = (
            aws_sdk_wafv2.types.data_protection_action.deserialize_aws_json_1_1(
                data["Action"]
            )
        )
    else:
