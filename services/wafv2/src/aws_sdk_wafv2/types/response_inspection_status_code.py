...
if TYPE_CHECKING:
    import aws_sdk_wafv2.types.response_inspection_status_code_failure_codes
...
def serialize_aws_json_1_1(value: ResponseInspectionStatusCode) -> dict:
    ...
    out["SuccessCodes"] = (
        aws_sdk_wafv2.types.response_inspection_status_code_success_codes.serialize_aws_json_1_1(
            value["success_codes"]
        )
    )
    import aws_sdk_wafv2.types.response_inspection_status_code_failure_codes
    ...
    out["FailureCodes"] = (
        aws_sdk_wafv2.types.response_inspection_status_code_failure_codes.serialize_aws_json_1_1(
            value["failure_codes"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ResponseInspectionStatusCode:
    ...
    if "SuccessCodes" in data:
        ...
        out["success_codes"] = (
            aws_sdk_wafv2.types.response_inspection_status_code_success_codes.deserialize_aws_json_1_1(
                data["SuccessCodes"]
            )
        )
    else:
    ...
    if "FailureCodes" in data:
        ...
        out["failure_codes"] = (
            aws_sdk_wafv2.types.response_inspection_status_code_failure_codes.deserialize_aws_json_1_1(
                data["FailureCodes"]
            )
        )
    else:
