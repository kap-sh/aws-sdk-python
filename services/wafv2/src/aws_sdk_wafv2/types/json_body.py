...
if TYPE_CHECKING:
    import aws_sdk_wafv2.types.body_parsing_fallback_behavior
    import aws_sdk_wafv2.types.json_match_pattern
    import aws_sdk_wafv2.types.json_match_scope
    import aws_sdk_wafv2.types.oversize_handling


class JsonBody(TypedDict, closed=True):
    match_pattern: "aws_sdk_wafv2.types.json_match_pattern.JsonMatchPattern"
    ...
    match_scope: "aws_sdk_wafv2.types.json_match_scope.JsonMatchScope"
    ...
    invalid_fallback_behavior: NotRequired[
        "aws_sdk_wafv2.types.body_parsing_fallback_behavior.BodyParsingFallbackBehavior"
    ]
    ...
    oversize_handling: NotRequired[
        "aws_sdk_wafv2.types.oversize_handling.OversizeHandling"
    ]
...
def serialize_aws_json_1_1(value: JsonBody) -> dict:
    ...
    out["MatchPattern"] = aws_sdk_wafv2.types.json_match_pattern.serialize_aws_json_1_1(
        value["match_pattern"]
    )
    import aws_sdk_wafv2.types.json_match_scope

    out["MatchScope"] = aws_sdk_wafv2.types.json_match_scope.serialize_aws_json_1_1(
        value["match_scope"]
    )
    if "invalid_fallback_behavior" in value:
        ...
        out["InvalidFallbackBehavior"] = (
            aws_sdk_wafv2.types.body_parsing_fallback_behavior.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> JsonBody:
    ...
    if "MatchPattern" in data:
        ...
        out["match_pattern"] = (
            aws_sdk_wafv2.types.json_match_pattern.deserialize_aws_json_1_1(
                data["MatchPattern"]
            )
        )
    else:
    ...
    if "MatchScope" in data:
        ...
        out["match_scope"] = (
            aws_sdk_wafv2.types.json_match_scope.deserialize_aws_json_1_1(
                data["MatchScope"]
            )
        )
    else:
    ...
    if "InvalidFallbackBehavior" in data:
        ...
        out["invalid_fallback_behavior"] = (
            aws_sdk_wafv2.types.body_parsing_fallback_behavior.deserialize_aws_json_1_1(
