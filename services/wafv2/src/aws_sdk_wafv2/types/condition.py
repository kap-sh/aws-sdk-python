...
if TYPE_CHECKING:
    import aws_sdk_wafv2.types.action_condition
    import aws_sdk_wafv2.types.label_name_condition


class Condition(TypedDict, closed=True):
    action_condition: NotRequired[
        "aws_sdk_wafv2.types.action_condition.ActionCondition"
    ]
    ...
    label_name_condition: NotRequired[
        "aws_sdk_wafv2.types.label_name_condition.LabelNameCondition"
    ]
...
def serialize_aws_json_1_1(value: Condition) -> dict:
    ...
    if "action_condition" in value:
        ...
        out["ActionCondition"] = (
            aws_sdk_wafv2.types.action_condition.serialize_aws_json_1_1(
    ...
    if "label_name_condition" in value:
        ...
        out["LabelNameCondition"] = (
            aws_sdk_wafv2.types.label_name_condition.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Condition:
    ...
    if "ActionCondition" in data:
        ...
        out["action_condition"] = (
            aws_sdk_wafv2.types.action_condition.deserialize_aws_json_1_1(
    ...
    if "LabelNameCondition" in data:
        ...
        out["label_name_condition"] = (
            aws_sdk_wafv2.types.label_name_condition.deserialize_aws_json_1_1(
