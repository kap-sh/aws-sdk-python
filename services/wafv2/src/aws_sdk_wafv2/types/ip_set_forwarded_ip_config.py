...
if TYPE_CHECKING:
    ...
    import aws_sdk_wafv2.types.forwarded_ip_header_name
...
class IPSetForwardedIPConfig(TypedDict):
    ...
    position: "aws_sdk_wafv2.types.forwarded_ip_position.ForwardedIPPosition"
...
def serialize_aws_json_1_1(value: IPSetForwardedIPConfig) -> dict:
    ...
    out["Position"] = aws_sdk_wafv2.types.forwarded_ip_position.serialize_aws_json_1_1(
        value["position"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> IPSetForwardedIPConfig:
    ...
    if "Position" in data:
        ...
        out["position"] = (
            aws_sdk_wafv2.types.forwarded_ip_position.deserialize_aws_json_1_1(
                data["Position"]
            )
        )
    else:
