...
if TYPE_CHECKING:
    ...
    import aws_sdk_wafv2.types.version_to_publish

VersionsToPublish: TypeAlias = dict[
    "aws_sdk_wafv2.types.version_key_string.VersionKeyString",
    "aws_sdk_wafv2.types.version_to_publish.VersionToPublish",
]
...
def serialize_aws_json_1_1(input_to_serialize: VersionsToPublish) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_wafv2.types.version_to_publish.serialize_aws_json_1_1(value)
    return out
...
def deserialize_aws_json_1_1(data: dict) -> VersionsToPublish:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_wafv2.types.version_to_publish.deserialize_aws_json_1_1(
            value
        )
    return out
