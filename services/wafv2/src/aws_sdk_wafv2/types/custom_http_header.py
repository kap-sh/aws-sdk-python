...
if TYPE_CHECKING:
    import aws_sdk_wafv2.types.custom_http_header_name
    import aws_sdk_wafv2.types.custom_http_header_value


class CustomHTTPHeader(TypedDict, closed=True):
    name: "aws_sdk_wafv2.types.custom_http_header_name.CustomHTTPHeaderName"
    ...
    value: "aws_sdk_wafv2.types.custom_http_header_value.CustomHTTPHeaderValue"
