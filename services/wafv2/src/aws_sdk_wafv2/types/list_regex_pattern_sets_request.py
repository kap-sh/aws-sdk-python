"""Generated from Smithy shape ``com.amazonaws.wafv2#ListRegexPatternSetsRequest``."""
...
class ListRegexPatternSetsRequest(TypedDict):
...
def deserialize_aws_json_1_1(data: dict) -> ListRegexPatternSetsRequest:
    ...
    if "Scope" in data:
        ...
        raise DeserializationError("ListRegexPatternSetsRequest.scope required")
