...
def serialize_aws_json_1_1(input_to_serialize: CustomResponseBodies) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_wafv2.types.custom_response_body.serialize_aws_json_1_1(
            value
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CustomResponseBodies:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_wafv2.types.custom_response_body.deserialize_aws_json_1_1(
            value
        )
    return out
