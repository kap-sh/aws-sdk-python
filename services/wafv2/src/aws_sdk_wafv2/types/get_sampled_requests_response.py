"""Generated from Smithy shape ``com.amazonaws.wafv2#GetSampledRequestsResponse``."""
...
if TYPE_CHECKING:
    import aws_sdk_wafv2.types.population_size
    import aws_sdk_wafv2.types.sampled_http_requests
    import aws_sdk_wafv2.types.time_window


class GetSampledRequestsResponse(TypedDict):
    sampled_requests: NotRequired[
        "aws_sdk_wafv2.types.sampled_http_requests.SampledHTTPRequests"
    ]
    """<p>A complex type that contains detailed information about each of the requests in the sample.</p>"""
    population_size: "aws_sdk_wafv2.types.population_size.PopulationSize"
    ...
    time_window: NotRequired["aws_sdk_wafv2.types.time_window.TimeWindow"]
...
def serialize_aws_json_1_1(value: GetSampledRequestsResponse) -> dict:
    ...
    if "sampled_requests" in value:
        ...
        out["SampledRequests"] = (
            aws_sdk_wafv2.types.sampled_http_requests.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetSampledRequestsResponse:
    ...
    if "SampledRequests" in data:
        ...
        out["sampled_requests"] = (
            aws_sdk_wafv2.types.sampled_http_requests.deserialize_aws_json_1_1(
