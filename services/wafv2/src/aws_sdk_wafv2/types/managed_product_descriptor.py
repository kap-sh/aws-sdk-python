...
if TYPE_CHECKING:
    ...
    import aws_sdk_wafv2.types.product_description
    import aws_sdk_wafv2.types.product_id
    import aws_sdk_wafv2.types.product_link
    import aws_sdk_wafv2.types.product_title
...
class ManagedProductDescriptor(TypedDict):
    ...
    product_id: NotRequired["aws_sdk_wafv2.types.product_id.ProductId"]
    """<p>A unique identifier for the rule group. This ID is returned in the responses to create and list commands. You provide it to operations like update and delete.</p>"""
    product_link: NotRequired["aws_sdk_wafv2.types.product_link.ProductLink"]
    """<p>For Amazon Web Services Marketplace managed rule groups only, the link to the rule group product page. </p>"""
    product_title: NotRequired["aws_sdk_wafv2.types.product_title.ProductTitle"]
    ...
    product_description: NotRequired[
        "aws_sdk_wafv2.types.product_description.ProductDescription"
    ]
