...
if TYPE_CHECKING:
    import aws_sdk_wafv2.types.cookie_match_pattern
...
def serialize_aws_json_1_1(value: Cookies) -> dict:
    ...
    out["MatchPattern"] = (
        aws_sdk_wafv2.types.cookie_match_pattern.serialize_aws_json_1_1(
            value["match_pattern"]
        )
    )
    import aws_sdk_wafv2.types.map_match_scope
...
def deserialize_aws_json_1_1(data: dict) -> Cookies:
    ...
    if "MatchPattern" in data:
        ...
        out["match_pattern"] = (
            aws_sdk_wafv2.types.cookie_match_pattern.deserialize_aws_json_1_1(
                data["MatchPattern"]
            )
        )
    else:
