"""Generated from Smithy shape ``com.amazonaws.wafv2#UpdateWebACLRequest``."""
...
def deserialize_aws_json_1_1(data: dict) -> UpdateWebACLRequest:
    ...
    if "Name" in data:
        ...
        raise DeserializationError("UpdateWebACLRequest.name required")
    if "Scope" in data:
        import aws_sdk_wafv2.types.scope

        out["scope"] = aws_sdk_wafv2.types.scope.deserialize_aws_json_1_1(data["Scope"])
    else:
        raise DeserializationError("UpdateWebACLRequest.scope required")
    if "Id" in data:
        out["id"] = data["Id"]
    else:
        raise DeserializationError("UpdateWebACLRequest.id required")
    if "DefaultAction" in data:
        ...
        raise DeserializationError("UpdateWebACLRequest.default_action required")
    ...
    if "VisibilityConfig" in data:
        ...
        raise DeserializationError("UpdateWebACLRequest.visibility_config required")
    ...
    if "LockToken" in data:
        ...
        raise DeserializationError("UpdateWebACLRequest.lock_token required")
