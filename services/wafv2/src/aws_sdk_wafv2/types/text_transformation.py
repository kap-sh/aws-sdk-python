...
if TYPE_CHECKING:
    import aws_sdk_wafv2.types.text_transformation_priority
...
def serialize_aws_json_1_1(value: TextTransformation) -> dict:
    ...
    out["Type"] = aws_sdk_wafv2.types.text_transformation_type.serialize_aws_json_1_1(
        value["type"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> TextTransformation:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_wafv2.types.text_transformation_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    else:
