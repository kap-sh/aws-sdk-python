...
if TYPE_CHECKING:
    import aws_sdk_wafv2.types.bot_statistics_list
    import aws_sdk_wafv2.types.filter_source
    import aws_sdk_wafv2.types.path_string
    import aws_sdk_wafv2.types.percentage_value
...
class PathStatistics(TypedDict, closed=True):
    ...
    percentage: "aws_sdk_wafv2.types.percentage_value.PercentageValue"
    """<p>The percentage of total requests that were made to this path.</p>"""
    top_bots: NotRequired["aws_sdk_wafv2.types.bot_statistics_list.BotStatisticsList"]
...
def serialize_aws_json_1_1(value: PathStatistics) -> dict:
    ...
    if "source" in value:
        ...
        out["Source"] = aws_sdk_wafv2.types.filter_source.serialize_aws_json_1_1(
            value["source"]
        )
    out["Path"] = value["path"]
    ...
    if "top_bots" in value:
        ...
        out["TopBots"] = aws_sdk_wafv2.types.bot_statistics_list.serialize_aws_json_1_1(
            value["top_bots"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> PathStatistics:
    ...
    if "Source" in data:
        ...
        out["source"] = aws_sdk_wafv2.types.filter_source.deserialize_aws_json_1_1(
            data["Source"]
        )
    if "Path" in data:
        out["path"] = data["Path"]
    ...
    if "TopBots" in data:
        ...
        out["top_bots"] = (
            aws_sdk_wafv2.types.bot_statistics_list.deserialize_aws_json_1_1(
                data["TopBots"]
            )
        )
    return out
