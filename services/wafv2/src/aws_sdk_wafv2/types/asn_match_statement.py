...
if TYPE_CHECKING:
    import aws_sdk_wafv2.types.asn_list
...
def serialize_aws_json_1_1(value: AsnMatchStatement) -> dict:
    ...
    out["AsnList"] = aws_sdk_wafv2.types.asn_list.serialize_aws_json_1_1(
        value["asn_list"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> AsnMatchStatement:
    ...
    if "AsnList" in data:
        ...
        out["asn_list"] = aws_sdk_wafv2.types.asn_list.deserialize_aws_json_1_1(
            data["AsnList"]
        )
    else:
