...
if TYPE_CHECKING:
    import aws_sdk_wafv2.types.client_side_action_config
    import aws_sdk_wafv2.types.sensitivity_to_act


class AWSManagedRulesAntiDDoSRuleSet(TypedDict):
    client_side_action_config: (
        "aws_sdk_wafv2.types.client_side_action_config.ClientSideActionConfig"
    )
    ...
    sensitivity_to_block: NotRequired[
        "aws_sdk_wafv2.types.sensitivity_to_act.SensitivityToAct"
    ]
...
def serialize_aws_json_1_1(value: AWSManagedRulesAntiDDoSRuleSet) -> dict:
    ...
    out["ClientSideActionConfig"] = (
        aws_sdk_wafv2.types.client_side_action_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AWSManagedRulesAntiDDoSRuleSet:
    ...
    if "ClientSideActionConfig" in data:
        ...
        out["client_side_action_config"] = (
            aws_sdk_wafv2.types.client_side_action_config.deserialize_aws_json_1_1(
