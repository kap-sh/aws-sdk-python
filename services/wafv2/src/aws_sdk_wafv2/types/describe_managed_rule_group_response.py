...
if TYPE_CHECKING:
    ...
    import aws_sdk_wafv2.types.rule_summaries
    import aws_sdk_wafv2.types.version_key_string


class DescribeManagedRuleGroupResponse(TypedDict):
    ...
    rules: NotRequired["aws_sdk_wafv2.types.rule_summaries.RuleSummaries"]
    """<p></p>"""
...
def serialize_aws_json_1_1(value: DescribeManagedRuleGroupResponse) -> dict:
    ...
    if "rules" in value:
        ...
        out["Rules"] = aws_sdk_wafv2.types.rule_summaries.serialize_aws_json_1_1(
            value["rules"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeManagedRuleGroupResponse:
    ...
    if "Rules" in data:
        ...
        out["rules"] = aws_sdk_wafv2.types.rule_summaries.deserialize_aws_json_1_1(
            data["Rules"]
        )
