...
if TYPE_CHECKING:
    import aws_sdk_wafv2.types.response_content
...
def serialize_aws_json_1_1(value: CustomResponseBody) -> dict:
    ...
    out["ContentType"] = (
        aws_sdk_wafv2.types.response_content_type.serialize_aws_json_1_1(
            value["content_type"]
        )
    )
...
def deserialize_aws_json_1_1(data: dict) -> CustomResponseBody:
    ...
    if "ContentType" in data:
        ...
        out["content_type"] = (
            aws_sdk_wafv2.types.response_content_type.deserialize_aws_json_1_1(
                data["ContentType"]
            )
        )
    else:
