...
if TYPE_CHECKING:
    ...
    import aws_sdk_wafv2.types.excluded_rules
    import aws_sdk_wafv2.types.managed_rule_group_configs
    import aws_sdk_wafv2.types.rule_action_overrides
    import aws_sdk_wafv2.types.statement
    import aws_sdk_wafv2.types.vendor_name
    import aws_sdk_wafv2.types.version_key_string


class ManagedRuleGroupStatement(TypedDict):
    ...
    version: NotRequired["aws_sdk_wafv2.types.version_key_string.VersionKeyString"]
    ...
    excluded_rules: NotRequired["aws_sdk_wafv2.types.excluded_rules.ExcludedRules"]
    ...
    managed_rule_group_configs: NotRequired[
        "aws_sdk_wafv2.types.managed_rule_group_configs.ManagedRuleGroupConfigs"
    ]
    ...
    rule_action_overrides: NotRequired[
        "aws_sdk_wafv2.types.rule_action_overrides.RuleActionOverrides"
    ]
...
def serialize_aws_json_1_1(value: ManagedRuleGroupStatement) -> dict:
    ...
    if "excluded_rules" in value:
        ...
        out["ExcludedRules"] = (
            aws_sdk_wafv2.types.excluded_rules.serialize_aws_json_1_1(
    ...
    if "managed_rule_group_configs" in value:
        ...
        out["ManagedRuleGroupConfigs"] = (
            aws_sdk_wafv2.types.managed_rule_group_configs.serialize_aws_json_1_1(
    ...
    if "rule_action_overrides" in value:
        ...
        out["RuleActionOverrides"] = (
            aws_sdk_wafv2.types.rule_action_overrides.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ManagedRuleGroupStatement:
    ...
    if "ExcludedRules" in data:
        ...
        out["excluded_rules"] = (
            aws_sdk_wafv2.types.excluded_rules.deserialize_aws_json_1_1(
                data["ExcludedRules"]
            )
        )
    ...
    if "ManagedRuleGroupConfigs" in data:
        ...
        out["managed_rule_group_configs"] = (
            aws_sdk_wafv2.types.managed_rule_group_configs.deserialize_aws_json_1_1(
    ...
    if "RuleActionOverrides" in data:
        ...
        out["rule_action_overrides"] = (
            aws_sdk_wafv2.types.rule_action_overrides.deserialize_aws_json_1_1(
