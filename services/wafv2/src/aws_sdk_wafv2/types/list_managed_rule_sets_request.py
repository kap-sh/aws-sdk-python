"""Generated from Smithy shape ``com.amazonaws.wafv2#ListManagedRuleSetsRequest``."""
...
class ListManagedRuleSetsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListManagedRuleSetsRequest) -> dict:
    out: dict = {}
    import aws_sdk_wafv2.types.scope
