...
RuleGroupSummaries: TypeAlias = list[
    "aws_sdk_wafv2.types.rule_group_summary.RuleGroupSummary"
]
...
def serialize_aws_json_1_1(value: RuleGroupSummaries) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_wafv2.types.rule_group_summary.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> RuleGroupSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_wafv2.types.rule_group_summary.deserialize_aws_json_1_1(item)
        )
    return out
