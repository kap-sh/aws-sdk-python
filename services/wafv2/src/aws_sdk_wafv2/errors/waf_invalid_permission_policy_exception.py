"""Generated from Smithy shape ``com.amazonaws.wafv2#WAFInvalidPermissionPolicyException``."""
...
class WAFInvalidPermissionPolicyException_(TypedDict):
...
class WAFInvalidPermissionPolicyException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.wafv2#WAFInvalidPermissionPolicyException``."""

    code: str | None = "WAFInvalidPermissionPolicyException"

    def __init__(self, data: WAFInvalidPermissionPolicyException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "WAFInvalidPermissionPolicyException":
