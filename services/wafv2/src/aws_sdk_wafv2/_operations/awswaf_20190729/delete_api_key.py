...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.delete_api_key_response.DeleteAPIKeyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.delete_api_key_request.DeleteAPIKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.delete_api_key_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_api_key(
    ...
    aws_sdk_wafv2.types.delete_api_key_response.DeleteAPIKeyResponse, zapros.Response
]:
