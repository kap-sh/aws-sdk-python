...
def build_request(
    ...
    input: aws_sdk_wafv2.types.put_permission_policy_request.PutPermissionPolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.put_permission_policy_request.serialize_aws_json_1_1(input)
    ).encode()
