"""Generated from Smithy shape ``com.amazonaws.wafv2#CreateRuleGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.create_rule_group_response.CreateRuleGroupResponse = (
        aws_sdk_wafv2.types.create_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.create_rule_group_request.CreateRuleGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.create_rule_group_request.serialize_aws_json_1_1(input_)
    ).encode()
