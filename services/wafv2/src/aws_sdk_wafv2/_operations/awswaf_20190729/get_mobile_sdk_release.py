...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.get_mobile_sdk_release_request.GetMobileSdkReleaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.get_mobile_sdk_release_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
