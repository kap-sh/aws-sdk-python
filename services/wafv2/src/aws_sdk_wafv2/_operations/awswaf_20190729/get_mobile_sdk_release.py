"""Generated from Smithy shape ``com.amazonaws.wafv2#GetMobileSdkRelease``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.get_mobile_sdk_release_response.GetMobileSdkReleaseResponse = aws_sdk_wafv2.types.get_mobile_sdk_release_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_wafv2.types.get_mobile_sdk_release_request.GetMobileSdkReleaseRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.GetMobileSdkRelease"
    import aws_sdk_wafv2.types.get_mobile_sdk_release_request

    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.get_mobile_sdk_release_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_get_mobile_sdk_release(
