"""Generated from Smithy shape ``com.amazonaws.wafv2#ListLoggingConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.list_logging_configurations_response.ListLoggingConfigurationsResponse = aws_sdk_wafv2.types.list_logging_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.list_logging_configurations_request.ListLoggingConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.list_logging_configurations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
