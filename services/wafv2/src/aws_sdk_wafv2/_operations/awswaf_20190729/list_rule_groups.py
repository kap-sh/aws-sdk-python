...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.list_rule_groups_response.ListRuleGroupsResponse = (
        aws_sdk_wafv2.types.list_rule_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.list_rule_groups_request.ListRuleGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.list_rule_groups_request.serialize_aws_json_1_1(input_)
    ).encode()
