"""Generated from Smithy shape ``com.amazonaws.wafv2#ListAPIKeys``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.list_api_keys_response.ListAPIKeysResponse = (
        aws_sdk_wafv2.types.list_api_keys_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.list_api_keys_request.ListAPIKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.ListAPIKeys"
    import aws_sdk_wafv2.types.list_api_keys_request

    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.list_api_keys_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_api_keys(
    ...
    aws_sdk_wafv2.types.list_api_keys_response.ListAPIKeysResponse, zapros.Response
]:
