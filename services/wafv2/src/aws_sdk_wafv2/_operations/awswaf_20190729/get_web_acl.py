"""Generated from Smithy shape ``com.amazonaws.wafv2#GetWebACL``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.get_web_acl_response.GetWebACLResponse = (
        aws_sdk_wafv2.types.get_web_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.get_web_acl_request.GetWebACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.get_web_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_web_acl(
    ...
    input_: aws_sdk_wafv2.types.get_web_acl_request.GetWebACLRequest,
) -> tuple[aws_sdk_wafv2.types.get_web_acl_response.GetWebACLResponse, zapros.Response]:
