"""Generated from Smithy shape ``com.amazonaws.wafv2#ListRegexPatternSets``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.list_regex_pattern_sets_response.ListRegexPatternSetsResponse = aws_sdk_wafv2.types.list_regex_pattern_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.list_regex_pattern_sets_request.ListRegexPatternSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.list_regex_pattern_sets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
