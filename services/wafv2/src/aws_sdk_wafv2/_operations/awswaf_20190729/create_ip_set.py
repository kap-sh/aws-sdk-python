...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.create_ip_set_request.CreateIPSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.create_ip_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_ip_set(
    ...
    aws_sdk_wafv2.types.create_ip_set_response.CreateIPSetResponse, zapros.Response
]:
