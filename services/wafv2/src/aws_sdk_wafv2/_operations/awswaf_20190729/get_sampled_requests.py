"""Generated from Smithy shape ``com.amazonaws.wafv2#GetSampledRequests``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.get_sampled_requests_response.GetSampledRequestsResponse = aws_sdk_wafv2.types.get_sampled_requests_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.get_sampled_requests_request.GetSampledRequestsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.get_sampled_requests_request.serialize_aws_json_1_1(input_)
    ).encode()
