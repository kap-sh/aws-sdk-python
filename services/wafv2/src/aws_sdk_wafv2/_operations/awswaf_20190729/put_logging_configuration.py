...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFLogDestinationPermissionIssueException":
            import aws_sdk_wafv2.errors.waf_log_destination_permission_issue_exception

            raise aws_sdk_wafv2.errors.waf_log_destination_permission_issue_exception.WAFLogDestinationPermissionIssueException.from_aws_json_1_1(
                data
            )
        ...
        case "WAFServiceLinkedRoleErrorException":
            import aws_sdk_wafv2.errors.waf_service_linked_role_error_exception

            raise aws_sdk_wafv2.errors.waf_service_linked_role_error_exception.WAFServiceLinkedRoleErrorException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.put_logging_configuration_response.PutLoggingConfigurationResponse = aws_sdk_wafv2.types.put_logging_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.put_logging_configuration_request.PutLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
