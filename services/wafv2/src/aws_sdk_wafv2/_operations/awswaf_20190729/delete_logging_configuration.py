"""Generated from Smithy shape ``com.amazonaws.wafv2#DeleteLoggingConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.delete_logging_configuration_response.DeleteLoggingConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.delete_logging_configuration_request.DeleteLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.delete_logging_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
