"""Generated from Smithy shape ``com.amazonaws.wafv2#DeleteRegexPatternSet``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.delete_regex_pattern_set_response.DeleteRegexPatternSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.delete_regex_pattern_set_request.DeleteRegexPatternSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.delete_regex_pattern_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
