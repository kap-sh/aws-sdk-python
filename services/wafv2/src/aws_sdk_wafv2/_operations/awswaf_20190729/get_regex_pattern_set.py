...
def build_request(
    ...
    input: aws_sdk_wafv2.types.get_regex_pattern_set_request.GetRegexPatternSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.get_regex_pattern_set_request.serialize_aws_json_1_1(input)
    ).encode()
