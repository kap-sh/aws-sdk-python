"""Generated from Smithy shape ``com.amazonaws.wafv2#ListWebACLs``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.list_web_ac_ls_response.ListWebACLsResponse = (
        aws_sdk_wafv2.types.list_web_ac_ls_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.list_web_ac_ls_request.ListWebACLsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.list_web_ac_ls_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_web_ac_ls(
    ...
    aws_sdk_wafv2.types.list_web_ac_ls_response.ListWebACLsResponse, zapros.Response
]:
