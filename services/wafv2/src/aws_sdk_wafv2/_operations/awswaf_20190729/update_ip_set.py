...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.update_ip_set_response.UpdateIPSetResponse = (
        aws_sdk_wafv2.types.update_ip_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.update_ip_set_request.UpdateIPSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.update_ip_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_ip_set(
    ...
    aws_sdk_wafv2.types.update_ip_set_response.UpdateIPSetResponse, zapros.Response
]:
