...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.list_mobile_sdk_releases_response.ListMobileSdkReleasesResponse = aws_sdk_wafv2.types.list_mobile_sdk_releases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.list_mobile_sdk_releases_request.ListMobileSdkReleasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.list_mobile_sdk_releases_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
