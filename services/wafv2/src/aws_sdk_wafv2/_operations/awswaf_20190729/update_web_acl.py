...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.update_web_acl_response.UpdateWebACLResponse = (
        aws_sdk_wafv2.types.update_web_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.update_web_acl_request.UpdateWebACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.update_web_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_web_acl(
    ...
    aws_sdk_wafv2.types.update_web_acl_response.UpdateWebACLResponse, zapros.Response
]:
