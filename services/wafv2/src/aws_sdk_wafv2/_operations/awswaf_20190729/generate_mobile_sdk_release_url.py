"""Generated from Smithy shape ``com.amazonaws.wafv2#GenerateMobileSdkReleaseUrl``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.generate_mobile_sdk_release_url_response.GenerateMobileSdkReleaseUrlResponse = aws_sdk_wafv2.types.generate_mobile_sdk_release_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.generate_mobile_sdk_release_url_request.GenerateMobileSdkReleaseUrlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.GenerateMobileSdkReleaseUrl"
    import aws_sdk_wafv2.types.generate_mobile_sdk_release_url_request

    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.generate_mobile_sdk_release_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_generate_mobile_sdk_release_url(
