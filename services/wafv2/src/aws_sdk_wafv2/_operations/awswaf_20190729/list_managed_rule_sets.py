...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.list_managed_rule_sets_response.ListManagedRuleSetsResponse = aws_sdk_wafv2.types.list_managed_rule_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_wafv2.types.list_managed_rule_sets_request.ListManagedRuleSetsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.list_managed_rule_sets_request.serialize_aws_json_1_1(input)
    ).encode()
