...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.list_managed_rule_sets_request.ListManagedRuleSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.list_managed_rule_sets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
