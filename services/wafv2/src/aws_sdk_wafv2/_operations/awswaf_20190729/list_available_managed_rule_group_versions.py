"""Generated from Smithy shape ``com.amazonaws.wafv2#ListAvailableManagedRuleGroupVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.list_available_managed_rule_group_versions_response.ListAvailableManagedRuleGroupVersionsResponse = aws_sdk_wafv2.types.list_available_managed_rule_group_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.list_available_managed_rule_group_versions_request.ListAvailableManagedRuleGroupVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.ListAvailableManagedRuleGroupVersions"
    import aws_sdk_wafv2.types.list_available_managed_rule_group_versions_request

    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.list_available_managed_rule_group_versions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_available_managed_rule_group_versions(
