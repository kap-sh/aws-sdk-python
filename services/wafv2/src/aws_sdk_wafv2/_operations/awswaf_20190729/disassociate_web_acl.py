...
def build_request(
    ...
    input: aws_sdk_wafv2.types.disassociate_web_acl_request.DisassociateWebACLRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.disassociate_web_acl_request.serialize_aws_json_1_1(input)
    ).encode()
