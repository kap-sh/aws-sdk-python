...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.get_ip_set_response.GetIPSetResponse = (
        aws_sdk_wafv2.types.get_ip_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.get_ip_set_request.GetIPSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.get_ip_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_ip_set(
    ...
    input_: aws_sdk_wafv2.types.get_ip_set_request.GetIPSetRequest,
) -> tuple[aws_sdk_wafv2.types.get_ip_set_response.GetIPSetResponse, zapros.Response]:
