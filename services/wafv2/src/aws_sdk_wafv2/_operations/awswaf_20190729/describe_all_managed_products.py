...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.describe_all_managed_products_response.DescribeAllManagedProductsResponse = aws_sdk_wafv2.types.describe_all_managed_products_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.describe_all_managed_products_request.DescribeAllManagedProductsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.describe_all_managed_products_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
