...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.describe_managed_rule_group_response.DescribeManagedRuleGroupResponse = aws_sdk_wafv2.types.describe_managed_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.describe_managed_rule_group_request.DescribeManagedRuleGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.describe_managed_rule_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
