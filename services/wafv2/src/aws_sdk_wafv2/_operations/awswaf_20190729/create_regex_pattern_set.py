...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.create_regex_pattern_set_response.CreateRegexPatternSetResponse = aws_sdk_wafv2.types.create_regex_pattern_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.create_regex_pattern_set_request.CreateRegexPatternSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.create_regex_pattern_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
