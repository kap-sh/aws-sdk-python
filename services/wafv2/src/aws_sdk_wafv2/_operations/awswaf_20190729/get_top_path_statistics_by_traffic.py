...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.get_top_path_statistics_by_traffic_response.GetTopPathStatisticsByTrafficResponse = aws_sdk_wafv2.types.get_top_path_statistics_by_traffic_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.get_top_path_statistics_by_traffic_request.GetTopPathStatisticsByTrafficRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.get_top_path_statistics_by_traffic_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
