"""Generated from Smithy shape ``com.amazonaws.wafv2#AssociateWebACL``."""
...
import aws_sdk_wafv2.errors.waf_feature_not_included_in_pricing_plan_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "WAFFeatureNotIncludedInPricingPlanException":
            raise aws_sdk_wafv2.errors.waf_feature_not_included_in_pricing_plan_exception.WAFFeatureNotIncludedInPricingPlanException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.associate_web_acl_response.AssociateWebACLResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.associate_web_acl_request.AssociateWebACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.associate_web_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
