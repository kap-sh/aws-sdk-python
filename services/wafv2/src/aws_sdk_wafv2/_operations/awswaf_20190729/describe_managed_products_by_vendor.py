"""Generated from Smithy shape ``com.amazonaws.wafv2#DescribeManagedProductsByVendor``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.describe_managed_products_by_vendor_response.DescribeManagedProductsByVendorResponse = aws_sdk_wafv2.types.describe_managed_products_by_vendor_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.describe_managed_products_by_vendor_request.DescribeManagedProductsByVendorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.DescribeManagedProductsByVendor"
    import aws_sdk_wafv2.types.describe_managed_products_by_vendor_request

    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.describe_managed_products_by_vendor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_managed_products_by_vendor(
