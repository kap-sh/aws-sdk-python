"""Generated from Smithy shape ``com.amazonaws.wafv2#DeleteRuleGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.delete_rule_group_response.DeleteRuleGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.delete_rule_group_request.DeleteRuleGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.delete_rule_group_request.serialize_aws_json_1_1(input_)
    ).encode()
