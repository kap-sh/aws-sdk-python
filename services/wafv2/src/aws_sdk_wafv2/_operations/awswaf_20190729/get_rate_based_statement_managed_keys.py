...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFUnsupportedAggregateKeyTypeException":
            import aws_sdk_wafv2.errors.waf_unsupported_aggregate_key_type_exception

            raise aws_sdk_wafv2.errors.waf_unsupported_aggregate_key_type_exception.WAFUnsupportedAggregateKeyTypeException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.get_rate_based_statement_managed_keys_response.GetRateBasedStatementManagedKeysResponse = aws_sdk_wafv2.types.get_rate_based_statement_managed_keys_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.get_rate_based_statement_managed_keys_request.GetRateBasedStatementManagedKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.get_rate_based_statement_managed_keys_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
