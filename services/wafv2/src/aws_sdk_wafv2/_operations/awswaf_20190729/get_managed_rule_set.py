...
def build_request(
    ...
    input: aws_sdk_wafv2.types.get_managed_rule_set_request.GetManagedRuleSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.get_managed_rule_set_request.serialize_aws_json_1_1(input)
    ).encode()
