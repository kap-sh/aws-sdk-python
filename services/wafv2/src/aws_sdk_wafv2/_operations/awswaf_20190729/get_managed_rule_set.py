...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.get_managed_rule_set_response.GetManagedRuleSetResponse = (
        aws_sdk_wafv2.types.get_managed_rule_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.get_managed_rule_set_request.GetManagedRuleSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.get_managed_rule_set_request.serialize_aws_json_1_1(input_)
    ).encode()
