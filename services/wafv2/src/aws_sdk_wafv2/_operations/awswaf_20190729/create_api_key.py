"""Generated from Smithy shape ``com.amazonaws.wafv2#CreateAPIKey``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.create_api_key_response.CreateAPIKeyResponse = (
        aws_sdk_wafv2.types.create_api_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.create_api_key_request.CreateAPIKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.CreateAPIKey"
    import aws_sdk_wafv2.types.create_api_key_request

    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.create_api_key_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_api_key(
    ...
    aws_sdk_wafv2.types.create_api_key_response.CreateAPIKeyResponse, zapros.Response
]:
