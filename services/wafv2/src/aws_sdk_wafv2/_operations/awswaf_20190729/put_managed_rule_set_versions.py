"""Generated from Smithy shape ``com.amazonaws.wafv2#PutManagedRuleSetVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.put_managed_rule_set_versions_response.PutManagedRuleSetVersionsResponse = aws_sdk_wafv2.types.put_managed_rule_set_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.put_managed_rule_set_versions_request.PutManagedRuleSetVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.PutManagedRuleSetVersions"
    import aws_sdk_wafv2.types.put_managed_rule_set_versions_request

    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.put_managed_rule_set_versions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_managed_rule_set_versions(
