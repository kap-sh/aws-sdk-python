"""Generated from Smithy shape ``com.amazonaws.wafv2#CheckCapacity``."""
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.check_capacity_request.CheckCapacityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.check_capacity_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def check_capacity(
    ...
    aws_sdk_wafv2.types.check_capacity_response.CheckCapacityResponse, zapros.Response
]:
...
async def async_check_capacity(
