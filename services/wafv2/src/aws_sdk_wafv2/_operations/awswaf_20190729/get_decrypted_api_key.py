...
def build_request(
    ...
    input: aws_sdk_wafv2.types.get_decrypted_api_key_request.GetDecryptedAPIKeyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.get_decrypted_api_key_request.serialize_aws_json_1_1(input)
    ).encode()
