"""Generated from Smithy shape ``com.amazonaws.wafv2#GetDecryptedAPIKey``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.get_decrypted_api_key_response.GetDecryptedAPIKeyResponse = aws_sdk_wafv2.types.get_decrypted_api_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.get_decrypted_api_key_request.GetDecryptedAPIKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.GetDecryptedAPIKey"
    import aws_sdk_wafv2.types.get_decrypted_api_key_request

    body: bytes | None = json.dumps(
        aws_sdk_wafv2.types.get_decrypted_api_key_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_decrypted_api_key(
