"""Generated from Smithy shape ``com.amazonaws.wafv2#DeleteFirewallManagerRuleGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_wafv2.types.delete_firewall_manager_rule_groups_response.DeleteFirewallManagerRuleGroupsResponse = aws_sdk_wafv2.types.delete_firewall_manager_rule_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_wafv2.types.delete_firewall_manager_rule_groups_request.DeleteFirewallManagerRuleGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_firewall_manager_rule_groups(
