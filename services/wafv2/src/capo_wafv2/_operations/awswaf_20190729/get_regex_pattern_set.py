"""Generated from Smithy shape ``com.amazonaws.wafv2#GetRegexPatternSet``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.get_regex_pattern_set_response.GetRegexPatternSetResponse = (
        capo_wafv2.types.get_regex_pattern_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.get_regex_pattern_set_request.serialize_aws_json_1_1(input_)
    ).encode()
