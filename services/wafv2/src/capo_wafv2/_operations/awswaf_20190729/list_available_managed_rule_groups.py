"""Generated from Smithy shape ``com.amazonaws.wafv2#ListAvailableManagedRuleGroups``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.list_available_managed_rule_groups_response.ListAvailableManagedRuleGroupsResponse = capo_wafv2.types.list_available_managed_rule_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.list_available_managed_rule_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_available_managed_rule_groups(
