...
def handle_response(
    ...
    out: capo_wafv2.types.create_api_key_response.CreateAPIKeyResponse = (
        capo_wafv2.types.create_api_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.create_api_key_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_api_key(
    ...
    capo_wafv2.types.create_api_key_response.CreateAPIKeyResponse, zapros.Response
]:
