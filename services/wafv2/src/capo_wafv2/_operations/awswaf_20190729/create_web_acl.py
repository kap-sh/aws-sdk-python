...
import capo_wafv2.errors.waf_tag_operation_exception
import capo_wafv2.errors.waf_tag_operation_internal_error_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFTagOperationException":
            raise capo_wafv2.errors.waf_tag_operation_exception.WAFTagOperationException.from_aws_json_1_1(
                data
            )
        case "WAFTagOperationInternalErrorException":
            raise capo_wafv2.errors.waf_tag_operation_internal_error_exception.WAFTagOperationInternalErrorException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_wafv2.types.create_web_acl_response.CreateWebACLResponse = (
        capo_wafv2.types.create_web_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.create_web_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_web_acl(
    ...
    capo_wafv2.types.create_web_acl_response.CreateWebACLResponse, zapros.Response
]:
