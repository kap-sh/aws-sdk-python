"""Generated from Smithy shape ``com.amazonaws.wafv2#UpdateRegexPatternSet``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.update_regex_pattern_set_response.UpdateRegexPatternSetResponse = capo_wafv2.types.update_regex_pattern_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.update_regex_pattern_set_request.serialize_aws_json_1_1(input_)
    ).encode()
