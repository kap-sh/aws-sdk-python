...
def handle_response(
    ...
    out: capo_wafv2.types.list_regex_pattern_sets_response.ListRegexPatternSetsResponse = capo_wafv2.types.list_regex_pattern_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.list_regex_pattern_sets_request.serialize_aws_json_1_1(input_)
    ).encode()
