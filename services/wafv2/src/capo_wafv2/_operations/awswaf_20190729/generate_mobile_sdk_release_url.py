...
def handle_response(
    ...
    out: capo_wafv2.types.generate_mobile_sdk_release_url_response.GenerateMobileSdkReleaseUrlResponse = capo_wafv2.types.generate_mobile_sdk_release_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.generate_mobile_sdk_release_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
