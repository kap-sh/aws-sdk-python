"""Generated from Smithy shape ``com.amazonaws.wafv2#ListTagsForResource``."""
...
import capo_wafv2.types.tag_info_for_resource
...
def handle_response(
    ...
    out: capo_wafv2.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_wafv2.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.list_tags_for_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
