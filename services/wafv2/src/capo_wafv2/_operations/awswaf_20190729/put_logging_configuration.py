"""Generated from Smithy shape ``com.amazonaws.wafv2#PutLoggingConfiguration``."""
...
import capo_wafv2.errors.waf_feature_not_included_in_pricing_plan_exception
...
import capo_wafv2.errors.waf_log_destination_permission_issue_exception
import capo_wafv2.errors.waf_nonexistent_item_exception
import capo_wafv2.errors.waf_optimistic_lock_exception
import capo_wafv2.errors.waf_service_linked_role_error_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "WAFFeatureNotIncludedInPricingPlanException":
            raise capo_wafv2.errors.waf_feature_not_included_in_pricing_plan_exception.WAFFeatureNotIncludedInPricingPlanException.from_aws_json_1_1(
                data
            )
        ...
        case "WAFLogDestinationPermissionIssueException":
            raise capo_wafv2.errors.waf_log_destination_permission_issue_exception.WAFLogDestinationPermissionIssueException.from_aws_json_1_1(
                data
            )
        ...
        case "WAFServiceLinkedRoleErrorException":
            raise capo_wafv2.errors.waf_service_linked_role_error_exception.WAFServiceLinkedRoleErrorException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_wafv2.types.put_logging_configuration_response.PutLoggingConfigurationResponse = capo_wafv2.types.put_logging_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.put_logging_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_logging_configuration(
