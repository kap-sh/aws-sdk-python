"""Generated from Smithy shape ``com.amazonaws.wafv2#GetRateBasedStatementManagedKeys``."""
...
import capo_wafv2.errors.waf_unsupported_aggregate_key_type_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFUnsupportedAggregateKeyTypeException":
            raise capo_wafv2.errors.waf_unsupported_aggregate_key_type_exception.WAFUnsupportedAggregateKeyTypeException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_wafv2.types.get_rate_based_statement_managed_keys_response.GetRateBasedStatementManagedKeysResponse = capo_wafv2.types.get_rate_based_statement_managed_keys_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.get_rate_based_statement_managed_keys_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_rate_based_statement_managed_keys(
