"""Generated from Smithy shape ``com.amazonaws.wafv2#ListMobileSdkReleases``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.list_mobile_sdk_releases_response.ListMobileSdkReleasesResponse = capo_wafv2.types.list_mobile_sdk_releases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.ListMobileSdkReleases"
    body: bytes | None = json.dumps(
        capo_wafv2.types.list_mobile_sdk_releases_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_mobile_sdk_releases(
