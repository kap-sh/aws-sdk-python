...
import capo_wafv2.errors.waf_invalid_permission_policy_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFInvalidPermissionPolicyException":
            raise capo_wafv2.errors.waf_invalid_permission_policy_exception.WAFInvalidPermissionPolicyException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_wafv2.types.put_permission_policy_response.PutPermissionPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.put_permission_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
