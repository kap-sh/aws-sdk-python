...
import capo_wafv2.types.logging_configurations
...
def handle_response(
    ...
    out: capo_wafv2.types.list_logging_configurations_response.ListLoggingConfigurationsResponse = capo_wafv2.types.list_logging_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.list_logging_configurations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
