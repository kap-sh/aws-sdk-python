"""Generated from Smithy shape ``com.amazonaws.wafv2#CreateIPSet``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.create_ip_set_response.CreateIPSetResponse = (
        capo_wafv2.types.create_ip_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.create_ip_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_ip_set(
    ...
    capo_wafv2.types.create_ip_set_response.CreateIPSetResponse, zapros.Response
]:
