"""Generated from Smithy shape ``com.amazonaws.wafv2#GetIPSet``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.get_ip_set_response.GetIPSetResponse = (
        capo_wafv2.types.get_ip_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.get_ip_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_ip_set(
    ...
    input_: capo_wafv2.types.get_ip_set_request.GetIPSetRequest,
) -> tuple[capo_wafv2.types.get_ip_set_response.GetIPSetResponse, zapros.Response]:
