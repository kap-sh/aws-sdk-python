...
def handle_response(
    ...
    out: capo_wafv2.types.disassociate_web_acl_response.DisassociateWebACLResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.disassociate_web_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
