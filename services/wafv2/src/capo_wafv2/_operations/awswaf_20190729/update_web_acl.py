"""Generated from Smithy shape ``com.amazonaws.wafv2#UpdateWebACL``."""
...
import capo_wafv2.errors.waf_expired_managed_rule_group_version_exception
...
import capo_wafv2.errors.waf_invalid_resource_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFExpiredManagedRuleGroupVersionException":
            raise capo_wafv2.errors.waf_expired_managed_rule_group_version_exception.WAFExpiredManagedRuleGroupVersionException.from_aws_json_1_1(
                data
            )
        ...
        case "WAFInvalidResourceException":
            raise capo_wafv2.errors.waf_invalid_resource_exception.WAFInvalidResourceException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_wafv2.types.update_web_acl_response.UpdateWebACLResponse = (
        capo_wafv2.types.update_web_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.update_web_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_web_acl(
    ...
    capo_wafv2.types.update_web_acl_response.UpdateWebACLResponse, zapros.Response
]:
