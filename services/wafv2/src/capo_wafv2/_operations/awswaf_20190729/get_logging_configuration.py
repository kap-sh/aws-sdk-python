...
def handle_response(
    ...
    out: capo_wafv2.types.get_logging_configuration_response.GetLoggingConfigurationResponse = capo_wafv2.types.get_logging_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.get_logging_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
