...
def handle_response(
    ...
    out: capo_wafv2.types.get_web_acl_response.GetWebACLResponse = (
        capo_wafv2.types.get_web_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.get_web_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_web_acl(
    ...
    input_: capo_wafv2.types.get_web_acl_request.GetWebACLRequest,
) -> tuple[capo_wafv2.types.get_web_acl_response.GetWebACLResponse, zapros.Response]:
