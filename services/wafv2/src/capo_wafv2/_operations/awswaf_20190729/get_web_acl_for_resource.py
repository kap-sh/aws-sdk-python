...
def handle_response(
    ...
    out: capo_wafv2.types.get_web_acl_for_resource_response.GetWebACLForResourceResponse = capo_wafv2.types.get_web_acl_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.get_web_acl_for_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
