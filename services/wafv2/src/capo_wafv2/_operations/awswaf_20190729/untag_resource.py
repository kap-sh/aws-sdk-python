...
def handle_response(
    ...
    out: capo_wafv2.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def untag_resource(
    ...
    capo_wafv2.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
