"""Generated from Smithy shape ``com.amazonaws.wafv2#GetRuleGroup``."""
...
import capo_wafv2.types.rule_group
...
def handle_response(
    ...
    out: capo_wafv2.types.get_rule_group_response.GetRuleGroupResponse = (
        capo_wafv2.types.get_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.get_rule_group_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_rule_group(
    ...
    capo_wafv2.types.get_rule_group_response.GetRuleGroupResponse, zapros.Response
]:
