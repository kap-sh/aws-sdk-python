"""Generated from Smithy shape ``com.amazonaws.wafv2#GetManagedRuleSet``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.get_managed_rule_set_response.GetManagedRuleSetResponse = (
        capo_wafv2.types.get_managed_rule_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.GetManagedRuleSet"
    body: bytes | None = json.dumps(
        capo_wafv2.types.get_managed_rule_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_managed_rule_set(
