...
import capo_wafv2.types.ip_set_summaries
...
def handle_response(
    ...
    out: capo_wafv2.types.list_ip_sets_response.ListIPSetsResponse = (
        capo_wafv2.types.list_ip_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.list_ip_sets_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_ip_sets(
    ...
    input_: capo_wafv2.types.list_ip_sets_request.ListIPSetsRequest,
) -> tuple[capo_wafv2.types.list_ip_sets_response.ListIPSetsResponse, zapros.Response]:
