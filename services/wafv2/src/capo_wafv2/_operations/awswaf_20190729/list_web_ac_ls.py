...
import capo_wafv2.types.web_acl_summaries
...
def handle_response(
    ...
    out: capo_wafv2.types.list_web_ac_ls_response.ListWebACLsResponse = (
        capo_wafv2.types.list_web_ac_ls_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.list_web_ac_ls_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_web_ac_ls(
    ...
    capo_wafv2.types.list_web_ac_ls_response.ListWebACLsResponse, zapros.Response
]:
