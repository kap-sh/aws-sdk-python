...
def handle_response(
    ...
    out: capo_wafv2.types.get_mobile_sdk_release_response.GetMobileSdkReleaseResponse = capo_wafv2.types.get_mobile_sdk_release_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.get_mobile_sdk_release_request.serialize_aws_json_1_1(input_)
    ).encode()
