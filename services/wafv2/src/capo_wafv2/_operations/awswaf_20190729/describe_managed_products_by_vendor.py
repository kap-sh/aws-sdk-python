...
def handle_response(
    ...
    out: capo_wafv2.types.describe_managed_products_by_vendor_response.DescribeManagedProductsByVendorResponse = capo_wafv2.types.describe_managed_products_by_vendor_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.describe_managed_products_by_vendor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
