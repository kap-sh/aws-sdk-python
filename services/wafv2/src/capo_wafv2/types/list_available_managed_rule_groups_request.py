"""Generated from Smithy shape ``com.amazonaws.wafv2#ListAvailableManagedRuleGroupsRequest``."""
...
class ListAvailableManagedRuleGroupsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListAvailableManagedRuleGroupsRequest) -> dict:
    out: dict = {}
    import capo_wafv2.types.scope
...
def deserialize_aws_json_1_1(data: dict) -> ListAvailableManagedRuleGroupsRequest:
    out: ListAvailableManagedRuleGroupsRequest = {}  # type: ignore[typeddict-item]
    if "Scope" in data:
        import capo_wafv2.types.scope
        ...
        raise DeserializationError(
            "ListAvailableManagedRuleGroupsRequest.scope required"
        )
