...
if TYPE_CHECKING:
    import capo_wafv2.types.pricing_plan_feature_name
    import capo_wafv2.types.required_pricing_plan_name


class DisallowedFeature(TypedDict, closed=True):
    feature: NotRequired[
        "capo_wafv2.types.pricing_plan_feature_name.PricingPlanFeatureName"
    ]
    """<p>The name of the disallowed WAF feature.</p>"""
    required_pricing_plan: NotRequired[
        "capo_wafv2.types.required_pricing_plan_name.RequiredPricingPlanName"
    ]
