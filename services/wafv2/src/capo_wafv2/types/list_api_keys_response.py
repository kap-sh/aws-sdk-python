...
if TYPE_CHECKING:
    ...
    import capo_wafv2.types.output_url
...
class ListAPIKeysResponse(TypedDict, closed=True):
    ...
    api_key_summaries: NotRequired["capo_wafv2.types.api_key_summaries.APIKeySummaries"]
    """<p>The array of key summaries. If you specified a <code>Limit</code> in your request, this might not be the full list. </p>"""
    application_integration_url: NotRequired["capo_wafv2.types.output_url.OutputUrl"]
...
def serialize_aws_json_1_1(value: ListAPIKeysResponse) -> dict:
    ...
    if "api_key_summaries" in value:
        ...
        out["APIKeySummaries"] = (
            capo_wafv2.types.api_key_summaries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListAPIKeysResponse:
    ...
    if "APIKeySummaries" in data:
        ...
        out["api_key_summaries"] = (
            capo_wafv2.types.api_key_summaries.deserialize_aws_json_1_1(
