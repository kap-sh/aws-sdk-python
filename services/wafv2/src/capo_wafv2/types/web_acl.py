...
if TYPE_CHECKING:
    ...
    import capo_wafv2.types.consumed_capacity
...
class WebACL(TypedDict, closed=True):
    ...
    capacity: "capo_wafv2.types.consumed_capacity.ConsumedCapacity"
    ...
    pre_process_firewall_manager_rule_groups: NotRequired[
        "capo_wafv2.types.firewall_manager_rule_groups.FirewallManagerRuleGroups"
    ]
    ...
    managed_by_firewall_manager: "capo_wafv2.types.boolean.Boolean"
    ...
    retrofitted_by_firewall_manager: "capo_wafv2.types.boolean.Boolean"
...
def serialize_aws_json_1_1(value: WebACL) -> dict:
    ...
    if "pre_process_firewall_manager_rule_groups" in value:
        ...
        out["PreProcessFirewallManagerRuleGroups"] = (
            capo_wafv2.types.firewall_manager_rule_groups.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> WebACL:
    ...
    if "PreProcessFirewallManagerRuleGroups" in data:
        ...
        out["pre_process_firewall_manager_rule_groups"] = (
            capo_wafv2.types.firewall_manager_rule_groups.deserialize_aws_json_1_1(
