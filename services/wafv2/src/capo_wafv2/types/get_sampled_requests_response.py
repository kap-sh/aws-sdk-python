...
if TYPE_CHECKING:
    import capo_wafv2.types.population_size
    import capo_wafv2.types.sampled_http_requests
    import capo_wafv2.types.time_window


class GetSampledRequestsResponse(TypedDict, closed=True):
    sampled_requests: NotRequired[
        "capo_wafv2.types.sampled_http_requests.SampledHTTPRequests"
    ]
    """<p>A complex type that contains detailed information about each of the requests in the sample.</p>"""
    population_size: "capo_wafv2.types.population_size.PopulationSize"
    ...
    time_window: NotRequired["capo_wafv2.types.time_window.TimeWindow"]
...
def serialize_aws_json_1_1(value: GetSampledRequestsResponse) -> dict:
    ...
    if "sampled_requests" in value:
        ...
        out["SampledRequests"] = (
            capo_wafv2.types.sampled_http_requests.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetSampledRequestsResponse:
    ...
    if "SampledRequests" in data:
        ...
        out["sampled_requests"] = (
            capo_wafv2.types.sampled_http_requests.deserialize_aws_json_1_1(
