"""Generated from Smithy shape ``com.amazonaws.wafv2#RateLimitQueryString``."""
...
class RateLimitQueryString(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: RateLimitQueryString) -> dict:
    out: dict = {}
    import capo_wafv2.types.text_transformations
...
def deserialize_aws_json_1_1(data: dict) -> RateLimitQueryString:
    ...
    if "TextTransformations" in data:
        ...
        raise DeserializationError("RateLimitQueryString.text_transformations required")
    return out
