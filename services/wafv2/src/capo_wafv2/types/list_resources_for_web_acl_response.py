...
if TYPE_CHECKING:
    import capo_wafv2.types.resource_arns


class ListResourcesForWebACLResponse(TypedDict, closed=True):
    resource_arns: NotRequired["capo_wafv2.types.resource_arns.ResourceArns"]
...
def serialize_aws_json_1_1(value: ListResourcesForWebACLResponse) -> dict:
    ...
    if "resource_arns" in value:
        ...
        out["ResourceArns"] = capo_wafv2.types.resource_arns.serialize_aws_json_1_1(
            value["resource_arns"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListResourcesForWebACLResponse:
    ...
    if "ResourceArns" in data:
        ...
        out["resource_arns"] = capo_wafv2.types.resource_arns.deserialize_aws_json_1_1(
            data["ResourceArns"]
        )
    return out
