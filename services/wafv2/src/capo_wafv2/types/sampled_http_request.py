...
if TYPE_CHECKING:
    import capo_wafv2.types.action
    ...
    import capo_wafv2.types.response_status_code
    import capo_wafv2.types.sample_weight
    import capo_wafv2.types.timestamp


class SampledHTTPRequest(TypedDict, closed=True):
    request: "capo_wafv2.types.http_request.HTTPRequest"
    """<p>A complex type that contains detailed information about the request.</p>"""
    weight: "capo_wafv2.types.sample_weight.SampleWeight"
    ...
    action: NotRequired["capo_wafv2.types.action.Action"]
    """<p>The action that WAF applied to the request.</p>"""
    rule_name_within_rule_group: NotRequired["capo_wafv2.types.entity_name.EntityName"]
    ...
    request_headers_inserted: NotRequired["capo_wafv2.types.http_headers.HTTPHeaders"]
    ...
    response_code_sent: NotRequired[
        "capo_wafv2.types.response_status_code.ResponseStatusCode"
    ]
    """<p>The response code that was sent for the request.</p>"""
    labels: NotRequired["capo_wafv2.types.labels.Labels"]
    ...
    captcha_response: NotRequired["capo_wafv2.types.captcha_response.CaptchaResponse"]
    """<p>The <code>CAPTCHA</code> response for the request.</p>"""
    challenge_response: NotRequired[
        "capo_wafv2.types.challenge_response.ChallengeResponse"
    ]
    """<p>The <code>Challenge</code> response for the request.</p>"""
    overridden_action: NotRequired["capo_wafv2.types.action.Action"]
...
def serialize_aws_json_1_1(value: SampledHTTPRequest) -> dict:
    ...
    out["Request"] = capo_wafv2.types.http_request.serialize_aws_json_1_1(
        value["request"]
    )
    ...
    if "request_headers_inserted" in value:
        ...
        out["RequestHeadersInserted"] = (
            capo_wafv2.types.http_headers.serialize_aws_json_1_1(
    ...
    if "labels" in value:
        ...
        out["Labels"] = capo_wafv2.types.labels.serialize_aws_json_1_1(value["labels"])
    if "captcha_response" in value:
        import capo_wafv2.types.captcha_response

        out["CaptchaResponse"] = (
            capo_wafv2.types.captcha_response.serialize_aws_json_1_1(
    ...
    if "challenge_response" in value:
        ...
        out["ChallengeResponse"] = (
            capo_wafv2.types.challenge_response.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SampledHTTPRequest:
    ...
    if "RequestHeadersInserted" in data:
        ...
        out["request_headers_inserted"] = (
            capo_wafv2.types.http_headers.deserialize_aws_json_1_1(
    ...
    if "CaptchaResponse" in data:
        ...
        out["captcha_response"] = (
            capo_wafv2.types.captcha_response.deserialize_aws_json_1_1(
    ...
    if "ChallengeResponse" in data:
        ...
        out["challenge_response"] = (
            capo_wafv2.types.challenge_response.deserialize_aws_json_1_1(
