...
class WAFV2Error(Exception):
    """Base class for all WAFV2 service errors."""


class ServiceError(WAFV2Error):
...
class SerializationError(WAFV2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(WAFV2Error):
...
class WaiterFailedError(WAFV2Error):
...
class WaiterTimeoutError(WAFV2Error):
