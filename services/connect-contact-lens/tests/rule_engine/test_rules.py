import pytest
from capo_connect_contact_lens._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_connect_contact_lens._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
