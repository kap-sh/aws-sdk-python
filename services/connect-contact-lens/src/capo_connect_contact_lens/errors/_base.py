...
class ConnectContactLensError(Exception):
    """Base class for all ConnectContactLens service errors."""


class ServiceError(ConnectContactLensError):
...
class SerializationError(ConnectContactLensError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ConnectContactLensError):
...
class WaiterFailedError(ConnectContactLensError):
...
class WaiterTimeoutError(ConnectContactLensError):
