...
if TYPE_CHECKING:
    import aws_sdk_connect_contact_lens.types.character_offsets


class IssueDetected(TypedDict, closed=True):
    character_offsets: NotRequired[
        "aws_sdk_connect_contact_lens.types.character_offsets.CharacterOffsets"
    ]
...
def serialize_json(value: IssueDetected) -> dict:
    ...
    if "character_offsets" in value:
        ...
        out["CharacterOffsets"] = (
            aws_sdk_connect_contact_lens.types.character_offsets.serialize_json(
...
def deserialize_json(data: dict) -> IssueDetected:
    ...
    if "CharacterOffsets" in data:
        ...
        out["character_offsets"] = (
            aws_sdk_connect_contact_lens.types.character_offsets.deserialize_json(
