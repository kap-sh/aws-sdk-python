...
if TYPE_CHECKING:
    import aws_sdk_connect_contact_lens.types.post_contact_summary_content
    import aws_sdk_connect_contact_lens.types.post_contact_summary_failure_code
    import aws_sdk_connect_contact_lens.types.post_contact_summary_status


class PostContactSummary(TypedDict):
    content: NotRequired[
        "aws_sdk_connect_contact_lens.types.post_contact_summary_content.PostContactSummaryContent"
    ]
    """<p>The content of the summary.</p>"""
    status: NotRequired[
        "aws_sdk_connect_contact_lens.types.post_contact_summary_status.PostContactSummaryStatus"
    ]
    """<p>Whether the summary was successfully COMPLETED or FAILED to be generated.</p>"""
    failure_code: NotRequired[
        "aws_sdk_connect_contact_lens.types.post_contact_summary_failure_code.PostContactSummaryFailureCode"
    ]
...
def serialize_json(value: PostContactSummary) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_connect_contact_lens.types.post_contact_summary_status.serialize_json(
                value["status"]
            )
        )
    if "failure_code" in value:
        ...
        out["FailureCode"] = (
            aws_sdk_connect_contact_lens.types.post_contact_summary_failure_code.serialize_json(
                value["failure_code"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> PostContactSummary:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_connect_contact_lens.types.post_contact_summary_status.deserialize_json(
                data["Status"]
            )
        )
    if "FailureCode" in data:
        ...
        out["failure_code"] = (
            aws_sdk_connect_contact_lens.types.post_contact_summary_failure_code.deserialize_json(
                data["FailureCode"]
            )
        )
    return out
