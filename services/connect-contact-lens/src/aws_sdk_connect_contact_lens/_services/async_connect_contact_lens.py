...
from aws_sdk_connect_contact_lens._services._aws_config import aaws_config
...
class AsyncConnectContactLensClientConfig(TypedDict, total=False):
...
class AsyncConnectContactLensClient:
    ...
    async def list_realtime_contact_analysis_segments(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_connect_contact_lens.types.list_realtime_contact_analysis_segments_request.ListRealtimeContactAnalysisSegmentsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_connect_contact_lens.types.list_realtime_contact_analysis_segments_response.ListRealtimeContactAnalysisSegmentsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_connect_contact_lens._operations.amazon_connect_contact_lens.list_realtime_contact_analysis_segments.async_list_realtime_contact_analysis_segments(
