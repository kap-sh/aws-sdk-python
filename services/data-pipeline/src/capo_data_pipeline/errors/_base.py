...
class DataPipelineError(Exception):
    """Base class for all DataPipeline service errors."""


class ServiceError(DataPipelineError):
...
class SerializationError(DataPipelineError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DataPipelineError):
...
class WaiterFailedError(DataPipelineError):
...
class WaiterTimeoutError(DataPipelineError):
