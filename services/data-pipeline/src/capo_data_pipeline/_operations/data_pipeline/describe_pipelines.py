"""Generated from Smithy shape ``com.amazonaws.datapipeline#DescribePipelines``."""
...
import capo_data_pipeline.types.pipeline_description_list
...
def handle_response(
    ...
    out: capo_data_pipeline.types.describe_pipelines_output.DescribePipelinesOutput = (
        capo_data_pipeline.types.describe_pipelines_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_data_pipeline.types.describe_pipelines_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_pipelines(
