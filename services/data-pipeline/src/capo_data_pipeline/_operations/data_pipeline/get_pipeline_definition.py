...
def handle_response(
    ...
    out: capo_data_pipeline.types.get_pipeline_definition_output.GetPipelineDefinitionOutput = capo_data_pipeline.types.get_pipeline_definition_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_data_pipeline.types.get_pipeline_definition_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
