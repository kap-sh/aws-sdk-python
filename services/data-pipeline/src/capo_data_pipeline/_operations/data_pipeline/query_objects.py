...
def handle_response(
    ...
    out: capo_data_pipeline.types.query_objects_output.QueryObjectsOutput = (
        capo_data_pipeline.types.query_objects_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_data_pipeline.types.query_objects_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def query_objects(
    ...
    capo_data_pipeline.types.query_objects_output.QueryObjectsOutput, zapros.Response
]:
