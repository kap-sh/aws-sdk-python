...
def handle_response(
    ...
    out: capo_data_pipeline.types.add_tags_output.AddTagsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_data_pipeline.types.add_tags_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def add_tags(
    ...
    input_: capo_data_pipeline.types.add_tags_input.AddTagsInput,
) -> tuple[capo_data_pipeline.types.add_tags_output.AddTagsOutput, zapros.Response]:
