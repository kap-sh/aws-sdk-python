"""Generated from Smithy shape ``com.amazonaws.datapipeline#ListPipelines``."""
...
import capo_data_pipeline.types.pipeline_list
...
def handle_response(
    ...
    out: capo_data_pipeline.types.list_pipelines_output.ListPipelinesOutput = (
        capo_data_pipeline.types.list_pipelines_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_data_pipeline.types.list_pipelines_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_pipelines(
    ...
    capo_data_pipeline.types.list_pipelines_output.ListPipelinesOutput, zapros.Response
]:
