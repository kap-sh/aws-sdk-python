"""Generated from Smithy shape ``com.amazonaws.datapipeline#DescribeObjects``."""
...
def handle_response(
    ...
    out: capo_data_pipeline.types.describe_objects_output.DescribeObjectsOutput = (
        capo_data_pipeline.types.describe_objects_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_data_pipeline.types.describe_objects_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_objects(
