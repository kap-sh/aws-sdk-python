...
def handle_response(
    ...
    out: capo_data_pipeline.types.set_task_status_output.SetTaskStatusOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_data_pipeline.types.set_task_status_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def set_task_status(
    ...
    capo_data_pipeline.types.set_task_status_output.SetTaskStatusOutput, zapros.Response
]:
