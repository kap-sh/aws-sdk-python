...
def handle_response(
    ...
    out: capo_data_pipeline.types.report_task_runner_heartbeat_output.ReportTaskRunnerHeartbeatOutput = capo_data_pipeline.types.report_task_runner_heartbeat_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_data_pipeline.types.report_task_runner_heartbeat_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
