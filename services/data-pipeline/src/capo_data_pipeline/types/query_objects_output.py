...
class QueryObjectsOutput(TypedDict, closed=True):
    ids: NotRequired["capo_data_pipeline.types.id_list.idList"]
...
def serialize_aws_json_1_1(value: QueryObjectsOutput) -> dict:
    ...
    if "ids" in value:
        ...
        out["ids"] = capo_data_pipeline.types.id_list.serialize_aws_json_1_1(
            value["ids"]
        )
    if "marker" in value:
