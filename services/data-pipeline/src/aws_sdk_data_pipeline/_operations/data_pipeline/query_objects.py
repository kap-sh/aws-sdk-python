"""Generated from Smithy shape ``com.amazonaws.datapipeline#QueryObjects``."""
...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.query_objects_output.QueryObjectsOutput = (
        aws_sdk_data_pipeline.types.query_objects_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.query_objects_input.QueryObjectsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.query_objects_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def query_objects(
    ...
    aws_sdk_data_pipeline.types.query_objects_output.QueryObjectsOutput, zapros.Response
]:
