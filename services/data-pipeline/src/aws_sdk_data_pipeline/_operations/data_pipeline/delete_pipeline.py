...
def build_request(
    ...
    input: aws_sdk_data_pipeline.types.delete_pipeline_input.DeletePipelineInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.delete_pipeline_input.serialize_aws_json_1_1(input)
    ).encode()
