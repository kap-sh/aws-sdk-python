...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.put_pipeline_definition_output.PutPipelineDefinitionOutput = aws_sdk_data_pipeline.types.put_pipeline_definition_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.put_pipeline_definition_input.PutPipelineDefinitionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.put_pipeline_definition_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
