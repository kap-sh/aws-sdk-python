...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.evaluate_expression_output.EvaluateExpressionOutput = aws_sdk_data_pipeline.types.evaluate_expression_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.evaluate_expression_input.EvaluateExpressionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.evaluate_expression_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
