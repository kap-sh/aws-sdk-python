...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.poll_for_task_output.PollForTaskOutput = (
        aws_sdk_data_pipeline.types.poll_for_task_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.poll_for_task_input.PollForTaskInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.poll_for_task_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def poll_for_task(
    ...
    aws_sdk_data_pipeline.types.poll_for_task_output.PollForTaskOutput, zapros.Response
]:
