...
def build_request(
    ...
    input: aws_sdk_data_pipeline.types.create_pipeline_input.CreatePipelineInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.create_pipeline_input.serialize_aws_json_1_1(input)
    ).encode()
