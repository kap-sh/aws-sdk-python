"""Generated from Smithy shape ``com.amazonaws.datapipeline#SetStatus``."""
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.set_status_input.SetStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.set_status_input.serialize_aws_json_1_1(input_)
    ).encode()
