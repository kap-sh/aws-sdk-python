"""Generated from Smithy shape ``com.amazonaws.datapipeline#GetPipelineDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.get_pipeline_definition_output.GetPipelineDefinitionOutput = aws_sdk_data_pipeline.types.get_pipeline_definition_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.get_pipeline_definition_input.GetPipelineDefinitionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.get_pipeline_definition_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_pipeline_definition(
