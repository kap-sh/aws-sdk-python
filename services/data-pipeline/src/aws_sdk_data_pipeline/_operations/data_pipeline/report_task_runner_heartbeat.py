"""Generated from Smithy shape ``com.amazonaws.datapipeline#ReportTaskRunnerHeartbeat``."""
...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.report_task_runner_heartbeat_output.ReportTaskRunnerHeartbeatOutput = aws_sdk_data_pipeline.types.report_task_runner_heartbeat_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.report_task_runner_heartbeat_input.ReportTaskRunnerHeartbeatInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.report_task_runner_heartbeat_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_report_task_runner_heartbeat(
