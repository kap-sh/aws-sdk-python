...
def build_request(
    ...
    input: aws_sdk_data_pipeline.types.set_task_status_input.SetTaskStatusInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.set_task_status_input.serialize_aws_json_1_1(input)
    ).encode()
