"""Generated from Smithy shape ``com.amazonaws.datapipeline#SetTaskStatus``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TaskNotFoundException":
            import aws_sdk_data_pipeline.errors.task_not_found_exception

            raise aws_sdk_data_pipeline.errors.task_not_found_exception.TaskNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.set_task_status_output.SetTaskStatusOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.set_task_status_input.SetTaskStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.set_task_status_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_set_task_status(
