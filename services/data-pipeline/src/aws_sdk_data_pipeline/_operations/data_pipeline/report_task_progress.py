...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.report_task_progress_output.ReportTaskProgressOutput = aws_sdk_data_pipeline.types.report_task_progress_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.report_task_progress_input.ReportTaskProgressInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.report_task_progress_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
