"""Generated from Smithy shape ``com.amazonaws.datapipeline#ValidatePipelineDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.validate_pipeline_definition_output.ValidatePipelineDefinitionOutput = aws_sdk_data_pipeline.types.validate_pipeline_definition_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.validate_pipeline_definition_input.ValidatePipelineDefinitionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.validate_pipeline_definition_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_validate_pipeline_definition(
