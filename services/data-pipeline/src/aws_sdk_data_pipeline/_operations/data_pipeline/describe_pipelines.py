...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.describe_pipelines_output.DescribePipelinesOutput = aws_sdk_data_pipeline.types.describe_pipelines_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.describe_pipelines_input.DescribePipelinesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
