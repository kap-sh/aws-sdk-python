"""Generated from Smithy shape ``com.amazonaws.datapipeline#ActivatePipeline``."""
...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.activate_pipeline_output.ActivatePipelineOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.activate_pipeline_input.ActivatePipelineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.activate_pipeline_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_activate_pipeline(
