"""Generated from Smithy shape ``com.amazonaws.datapipeline#AddTags``."""
...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.add_tags_output.AddTagsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.add_tags_input.AddTagsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.add_tags_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def add_tags(
    ...
    input_: aws_sdk_data_pipeline.types.add_tags_input.AddTagsInput,
) -> tuple[aws_sdk_data_pipeline.types.add_tags_output.AddTagsOutput, zapros.Response]:
