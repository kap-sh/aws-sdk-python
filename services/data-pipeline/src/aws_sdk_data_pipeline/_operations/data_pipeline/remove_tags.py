"""Generated from Smithy shape ``com.amazonaws.datapipeline#RemoveTags``."""
...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.remove_tags_output.RemoveTagsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_data_pipeline.types.remove_tags_input.RemoveTagsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.remove_tags_input.serialize_aws_json_1_1(input)
    ).encode()
...
def remove_tags(
    ...
    aws_sdk_data_pipeline.types.remove_tags_output.RemoveTagsOutput, zapros.Response
]:
