"""Generated from Smithy shape ``com.amazonaws.datapipeline#DeactivatePipeline``."""
...
def build_request(
    ...
    input_: aws_sdk_data_pipeline.types.deactivate_pipeline_input.DeactivatePipelineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.deactivate_pipeline_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_deactivate_pipeline(
