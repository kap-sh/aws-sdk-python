...
def handle_response(
    ...
    out: aws_sdk_data_pipeline.types.describe_objects_output.DescribeObjectsOutput = (
        aws_sdk_data_pipeline.types.describe_objects_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_data_pipeline.types.describe_objects_input.DescribeObjectsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_data_pipeline.types.describe_objects_input.serialize_aws_json_1_1(input)
    ).encode()
