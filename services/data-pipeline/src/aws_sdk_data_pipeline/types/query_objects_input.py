...
class QueryObjectsInput(TypedDict):
    pipeline_id: "aws_sdk_data_pipeline.types.id.id"
    """<p>The ID of the pipeline.</p>"""
    query: NotRequired["aws_sdk_data_pipeline.types.query.Query"]
    ...
    limit: NotRequired["aws_sdk_data_pipeline.types.int.int"]
...
def serialize_aws_json_1_1(value: QueryObjectsInput) -> dict:
    ...
    if "query" in value:
        ...
        out["query"] = aws_sdk_data_pipeline.types.query.serialize_aws_json_1_1(
            value["query"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> QueryObjectsInput:
    ...
    if "query" in data:
        ...
        out["query"] = aws_sdk_data_pipeline.types.query.deserialize_aws_json_1_1(
            data["query"]
        )
    if "sphere" in data:
