...
from aws_sdk_data_pipeline._services._aws_config import aaws_config
...
class AsyncDataPipelineClientConfig(TypedDict, total=False):
...
class AsyncDataPipelineClient:
    ...
    async def activate_pipeline(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.activate_pipeline_input.ActivatePipelineInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.activate_pipeline_output.ActivatePipelineOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.activate_pipeline.async_activate_pipeline(
    ...
    async def add_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.add_tags_input.AddTagsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.add_tags_output.AddTagsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.add_tags.async_add_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_pipeline(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.create_pipeline_input.CreatePipelineInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.create_pipeline_output.CreatePipelineOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.create_pipeline.async_create_pipeline(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deactivate_pipeline(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.deactivate_pipeline_input.DeactivatePipelineInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.deactivate_pipeline_output.DeactivatePipelineOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.deactivate_pipeline.async_deactivate_pipeline(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_pipeline(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.delete_pipeline_input.DeletePipelineInput]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.delete_pipeline.async_delete_pipeline(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_objects(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.describe_objects_input.DescribeObjectsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.describe_objects_output.DescribeObjectsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.describe_objects.async_describe_objects(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_objects(
        ...
        *,
        ...
        marker: Optional["aws_sdk_data_pipeline.types.string.string"] = None,
    ) -> "AsyncIterator[aws_sdk_data_pipeline.types.pipeline_object.PipelineObject]":
        _token = marker
        while True:
    ...
    async def describe_pipelines(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.describe_pipelines_input.DescribePipelinesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.describe_pipelines_output.DescribePipelinesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.describe_pipelines.async_describe_pipelines(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def evaluate_expression(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.evaluate_expression_input.EvaluateExpressionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.evaluate_expression_output.EvaluateExpressionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.evaluate_expression.async_evaluate_expression(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_pipeline_definition(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.get_pipeline_definition_input.GetPipelineDefinitionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.get_pipeline_definition_output.GetPipelineDefinitionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.get_pipeline_definition.async_get_pipeline_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_pipelines(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.list_pipelines_input.ListPipelinesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.list_pipelines_output.ListPipelinesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.list_pipelines.async_list_pipelines(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_pipelines(
        ...
        *,
        config_overrides: Optional[AsyncDataPipelineClientConfig] = None,
        marker: Optional["aws_sdk_data_pipeline.types.string.string"] = None,
    ) -> "AsyncIterator[aws_sdk_data_pipeline.types.pipeline_id_name.PipelineIdName]":
        _token = marker
        while True:
    ...
    async def poll_for_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.poll_for_task_input.PollForTaskInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.poll_for_task_output.PollForTaskOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.poll_for_task.async_poll_for_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_pipeline_definition(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.put_pipeline_definition_input.PutPipelineDefinitionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.put_pipeline_definition_output.PutPipelineDefinitionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.put_pipeline_definition.async_put_pipeline_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def query_objects(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.query_objects_input.QueryObjectsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.query_objects_output.QueryObjectsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.query_objects.async_query_objects(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_query_objects(
        ...
        *,
        ...
        marker: Optional["aws_sdk_data_pipeline.types.string.string"] = None,
        limit: Optional["aws_sdk_data_pipeline.types.int.int"] = None,
    ) -> "AsyncIterator[aws_sdk_data_pipeline.types.id.id]":
        _token = marker
        while True:
    ...
    async def remove_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.remove_tags_input.RemoveTagsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.remove_tags_output.RemoveTagsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.remove_tags.async_remove_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def report_task_progress(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.report_task_progress_input.ReportTaskProgressInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.report_task_progress_output.ReportTaskProgressOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.report_task_progress.async_report_task_progress(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def report_task_runner_heartbeat(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.report_task_runner_heartbeat_input.ReportTaskRunnerHeartbeatInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.report_task_runner_heartbeat_output.ReportTaskRunnerHeartbeatOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.report_task_runner_heartbeat.async_report_task_runner_heartbeat(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.set_status_input.SetStatusInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.set_status.async_set_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_task_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.set_task_status_input.SetTaskStatusInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.set_task_status_output.SetTaskStatusOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.set_task_status.async_set_task_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def validate_pipeline_definition(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_data_pipeline.types.validate_pipeline_definition_input.ValidatePipelineDefinitionInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_data_pipeline.types.validate_pipeline_definition_output.ValidatePipelineDefinitionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_data_pipeline._operations.data_pipeline.validate_pipeline_definition.async_validate_pipeline_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
